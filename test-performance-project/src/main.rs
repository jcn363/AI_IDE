...
use test_performance_project::{do_some_work, do_async_work};
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("Synchronous work ({} iterations) took: {:.2?}", sync_iterations, sync_duration);
    ...
    println!("\nAsynchronous work ({} iterations) took: {:.2?}", async_iterations, async_duration);
    ...
    println!("  Asynchronous:  {:.2} operations/second", async_ops_per_sec);

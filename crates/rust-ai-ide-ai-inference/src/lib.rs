...
pub static LAZY_LOADER: Lazy<Arc<rust_ai_ide_lazy_loading::LazyLoader>> = Lazy::new(|| {
    Arc::new(rust_ai_ide_lazy_loading::LazyLoader::new(LAZY_LOADING_CONFIG.clone()))
});
...
pub static MEMORY_POOL_MANAGER: Lazy<Arc<rust_ai_ide_lazy_loading::MemoryPoolManager>> = Lazy::new(|| {
    Arc::new(rust_ai_ide_lazy_loading::MemoryPoolManager::new(
        LAZY_LOADING_CONFIG.memory_pool_limits.analysis_result_pool_max,
...
async fn register_lazy_components() -> rust_ai_ide_lazy_loading::LazyResult<()> {
    ...
    let predictive_completion_component = rust_ai_ide_lazy_loading::SimpleLazyComponent::new(
    ...
    loader.register_component(Box::new(predictive_completion_component)).await?;

    // Register natural language to code converter
    let nlp_component = rust_ai_ide_lazy_loading::SimpleLazyComponent::new(

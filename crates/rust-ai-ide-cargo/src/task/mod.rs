...
impl TaskResult {
    ...
    pub fn failure(task: CargoTask, exit_code: Option<i32>, stdout: String, stderr: String) -> Self {
        let now = SystemTime::now();
        Self {
            task,
            exit_code,
        ...
        match result {
            ...
            Err(e) => {
                let task = match e {
                    ...
                    CommandError::CommandError(code) => CargoTask::new("unknown").arg(code.to_string()),

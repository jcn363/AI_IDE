    ...
    async fn validate_single_recommendation(
            ...
            && recommendation.risk_level == RiskLevel::Critical
        {
            issues.push(ValidationIssue {
                ...
                description: "Very high effort with critical risk - consider breaking down into smaller tasks".to_string(),
                location: None,
                ...
                ProjectType::Application => {
                    if team_size < 3 {
                        vec![ValidationIssue {
                            ...
                            location: None,
                            suggestion: Some("Consider if additional team members are needed for larger applications".to_string()),
                        }]
                    } else {
                        vec![]
                    }

...
/// let high_confidence_patterns: Vec<_> = analysis
///     .detected_patterns
///     .iter()
...
///     println!(
///         "Found {} architectural concerns",
///         analysis.anti_patterns.len()
///     );
/// }
/// # }
/// ```
...
///         c if c >= 0.7 => println!(
///             "⚠ Moderate confidence in {} pattern detection",
...
/// - **Maintainability Index**: Composite measure combining cyclomatic complexity, lines of code,
///   and Halstead complexity into a single maintainability score
/// - **Cyclomatic Complexity**: Measures the number of linearly independent paths through a
///   program's source code, indicating testing difficulty and understandability
/// - **Halstead Complexity**: Based on operator/operand counts to measure complexity in terms of
///   program vocabulary and implementation
///
/// ## AI-Enhanced Metrics
/// - **Technical Debt Ratio**: Predicted maintenance burden based on code patterns, complexity
///   trends, and architectural inconsistencies

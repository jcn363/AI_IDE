...
impl MLScorer {
    ...
    fn load_default_pattern_models() -> HashMap<String, PatternModel> {
        ...
        models.insert("Singleton".to_string(), PatternModel {
        ...
        models.insert("Repository".to_string(), PatternModel {
            weights:  HashMap::from([
    ...
    fn load_default_anti_pattern_models() -> HashMap<String, AntiPatternModel> {
        ...
        models.insert("LongMethod".to_string(), AntiPatternModel {
        ...
        models.insert("LargeClass".to_string(), AntiPatternModel {
            coefficients: HashMap::from([
    ...
    fn cache_key_for_anti_pattern(&self, anti_pattern: &DetectedAntiPattern) -> String {
        format!(
            "antipattern:{:?}:{:?}:{:?}",
            anti_pattern.anti_pattern_type, anti_pattern.location.file_path, anti_pattern.location.start_line
        )
    }

...
> {
  ...
  handleExpandToggle = (operationType: string) => {
    this.setState((prevState) => ({
      expandedSuggestion: prevState.expandedSuggestion === operationType ? null : operationType,
    }));
  };
  ...
  getConfidenceBar(confidence: number): React.ReactElement {
    ...
    return (
      <div className="confidence-bar">
        <div className={`confidence-fill ${color}`} style={{ width: `${percentage}%` }}></div>
            ...
            >
              <div className="suggestion-header">
                <div className="suggestion-meta">
                  ...
                  <span
                    className={`impact-badge ${this.getImpactColor(suggestion.expectedImpact)}`}
                  >
                    {this.getImpactIcon(suggestion.expectedImpact)} {suggestion.expectedImpact}
                  </span>
                  {suggestion.quickFix && <span className="quick-fix-badge">⚡ Quick Fix</span>}
                </div>

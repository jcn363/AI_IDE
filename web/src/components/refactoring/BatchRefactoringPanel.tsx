...
class BatchRefactoringPanel extends React.Component<
  BatchRefactoringPanelProps,
  BatchRefactoringPanelState
> {
  ...
  handleSelectAll = () => {
    ...
    this.setState((prevState) => ({
      selectedOperations: new Set(
        prevState.selectedOperations.size === allIds.length ? [] : allIds
      ),
    }));
  };
        ...
        {isExecuting && (
          <div className="progress-container">
            ...
            <div className="progress-text">
              {progress}% Complete - Processing {currentOperationIndex + 1} of{' '}
          ...
          {batchOperations.map((operation) => (
            ...
            >
              ...
              <div className="operation-info">
                ...
                {operation.result && <div className="operation-result">{operation.result}</div>}
              </div>
            </div>
          ))}
        </div>

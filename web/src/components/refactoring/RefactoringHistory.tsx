...
class RefactoringHistory extends React.Component<RefactoringHistoryProps, RefactoringHistoryState> {
    ...
    getStatusColor = (status: string): string => {
        switch (status) {
            ...
            case 'reverted': return 'status-warning';
    ...
    render() {
        ...
        return (
            <div className="refactoring-history">
                ...
                {selectedEntryData && (
                    this.renderDetailsPanel(selectedEntryData)
                )}
                ...
                <div className="history-stats">
                    ...
                    <div className="stat">
                        ...
                        <span className="stat-value">{history.filter(h => h.status === 'success').length}</span>
                    </div>
                    <div className="stat">
                    ...
                    <div className="details-content">
                        <div className="details-section">
                            ...
                            <div className="impact-indicator">
                                {entry.details.impact.toUpperCase()} IMPACT
                            </div>
                        </div>

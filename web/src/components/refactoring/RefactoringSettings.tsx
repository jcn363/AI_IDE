...
class RefactoringSettings extends React.Component<
  RefactoringSettingsProps,
  RefactoringSettingsState
> {
  ...
  async loadSettings() {
    try {
      const savedSettings = await invoke<Partial<RefactoringSettings>>(
        'get_refactoring_settings',
        {}
      );
      if (savedSettings) {
      ...
      <div className="refactoring-settings">
        <div className="settings-header">
          ...
          <div className="settings-actions">
            <button className="btn btn-outline" onClick={this.resetToDefaults} disabled={saving}>
              Reset to Defaults
            </button>
            <button
            ...
            <>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    this.handleAiSettingChange('confidenceThreshold', parseFloat(e.target.value))
                  }
                  className="form-control"
                />
              </div>
              ...
              <div className="form-group">
                <label htmlFor="max-context">Max Context Tokens: {ai.maxContextTokens}</label>
                <select
                  id="max-context"
                  value={ai.maxContextTokens}
                  onChange={(e) =>
                    this.handleAiSettingChange('maxContextTokens', parseInt(e.target.value))
                  }
                  className="form-control"
                >
    ...
    return (
      <div className="settings-section">
        ...
        <div className="settings-group">
          ...
          <div className="form-group">
            <label htmlFor="max-changes">Maximum file changes: {safety.maxFileChanges}</label>
            <input
              id="max-changes"
              type="range"
              min="10"
              ...
              onChange={(e) =>
                this.handleSafetySettingChange('maxFileChanges', parseInt(e.target.value))
              }
              className="form-control"
            />
          </div>
          ...
          <div className="form-group">
            <label className="checkbox-label">
              <input
                ...
                onChange={(e) =>
                  this.handleSafetySettingChange('allowRiskyOperations', e.target.checked)
                }
              />
          ...
          <div className="form-group">
            <label className="checkbox-label">
              <input
                ...
                onChange={(e) =>
                  this.handleOperationSettingChange('generateTests', e.target.checked)
                }
              />
          ...
          <div className="form-group">
            <label className="checkbox-label">
              <input
                ...
                onChange={(e) =>
                  this.handleOperationSettingChange('preserveComments', e.target.checked)
                }
              />
          ...
          <div className="form-group">
            <label className="checkbox-label">
              <input
                ...
                onChange={(e) =>
                  this.handleOperationSettingChange('batchOperations', e.target.checked)
                }
              />
          ...
          <div className="form-group">
            <label className="checkbox-label">
              <input
                ...
                onChange={(e) =>
                  this.handleUiSettingChange('autoApplyHighConfidence', e.target.checked)
                }
              />

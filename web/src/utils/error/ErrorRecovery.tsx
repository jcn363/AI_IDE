...
class ErrorRecovery extends React.Component {
  ...
  ): Promise<ErrorRecoverySuggestion> {
  ...
  private async getActionFromPattern(
    pattern: string,
    context?: ErrorContext
  ): Promise<{
    primary: RecoveryAction;
    ...
    const patternData =
      ErrorRecovery.ERROR_PATTERNS[pattern as keyof typeof ErrorRecovery.ERROR_PATTERNS];
  ...
  private async contextAwareRecovery(
    errorMessage: string,
    context?: ErrorContext
  ): Promise<{
    primary: RecoveryAction;
  ...
  private explainError(
    ...
    const categoryDescriptions = {
      [ErrorCategory.NETWORK]:
        'A network-related issue prevented the operation from completing successfully.',
      [ErrorCategory.VALIDATION]:
        'The provided input or code structure contains validation errors.',
    ...
    const severityDescriptions = {
      ...
      [ErrorSeverity.HIGH]:
        'This issue significantly impacts the operation and requires attention.',

...
const VersionAlignmentItem: React.FC<VersionAlignmentItemProps> = ({
  ...
  const { dependencyName, currentVersions, suggestedVersion, severity = 'medium' } = alignment;
  ...
  const hoverColor =
    severityColor === 'primary' ? theme.palette.primary.main : theme.palette[severityColor].main;
        ...
        <Stack direction="row" spacing={1} alignItems="center">
          ...
          {onApply && (
            <Button
              ...
              startIcon={
                isApplying ? <CircularProgress size={16} color="inherit" /> : <CheckIcon />
              }
            >

...
pub trait UnicodeCategories: Sized + Copy {
    ...
    fn is_other(self) -> bool {
        self.is_other_control() || self.is_other_format() || self.is_other_private_use()
    }
    ...
    fn is_mark(self) -> bool {
        self.is_mark_spacing_combining() || self.is_mark_enclosing() || self.is_mark_nonspacing()
    }
    ...
    fn is_number(self) -> bool {
        self.is_number_decimal_digit() || self.is_number_letter() || self.is_number_other()
    }
    ...
    fn is_separator(self) -> bool {
        self.is_separator_line() || self.is_separator_paragraph() || self.is_separator_space()
    }
}

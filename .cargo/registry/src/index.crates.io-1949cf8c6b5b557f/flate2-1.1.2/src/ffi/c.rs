...
mod c_backend {
    ...
    pub use libz::{
        deflate as mz_deflate,
        deflateEnd as mz_deflateEnd,
        deflateReset as mz_deflateReset,
        inflate as mz_inflate,
        inflateEnd as mz_inflateEnd,
        z_stream as mz_stream,
        *,
    };

    pub use libz::{
        Z_BLOCK as MZ_BLOCK,
        Z_BUF_ERROR as MZ_BUF_ERROR,
        Z_DATA_ERROR as MZ_DATA_ERROR,
        Z_DEFAULT_STRATEGY as MZ_DEFAULT_STRATEGY,
        Z_DEFLATED as MZ_DEFLATED,
        Z_FINISH as MZ_FINISH,
        Z_FULL_FLUSH as MZ_FULL_FLUSH,
        Z_MEM_ERROR as MZ_MEM_ERROR,
        Z_NEED_DICT as MZ_NEED_DICT,
        Z_NO_FLUSH as MZ_NO_FLUSH,
        Z_OK as MZ_OK,
        Z_PARTIAL_FLUSH as MZ_PARTIAL_FLUSH,
        Z_STREAM_END as MZ_STREAM_END,
        Z_STREAM_ERROR as MZ_STREAM_ERROR,
        Z_SYNC_FLUSH as MZ_SYNC_FLUSH,
    };

...
mod tests {
    ...
    fn test_dlsym_getauxval() {
        unsafe {
            ...
            assert_eq!(
                dlsym_getauxval(ffi::AT_HWCAP),
                ffi::getauxval(ffi::AT_HWCAP)
            );
            assert_eq!(
                dlsym_getauxval(ffi::AT_HWCAP2),
                ffi::getauxval(ffi::AT_HWCAP2)
            );
        }
    }
    #[cfg(any(target_os = "freebsd", target_os = "openbsd"))]
    ...
    fn test_alternative() {
        ...
        assert_eq!(
            os::getauxval(ffi::AT_HWCAP),
            getauxval_sysctl_libc(ffi::AT_HWCAP).unwrap()
        );
        assert_eq!(
            os::getauxval(ffi::AT_HWCAP2),
        ...
        assert_eq!(
            os::getauxval(ffi::AT_HWCAP),
            getauxval_sysctl_no_libc(ffi::AT_HWCAP).unwrap()
        );
        assert_eq!(
            os::getauxval(ffi::AT_HWCAP2),

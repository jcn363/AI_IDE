...
#[cfg_attr(
    portable_atomic_no_cfg_target_has_atomic,
    cfg(portable_atomic_no_atomic_64)
)]
#[cfg_attr(
    not(portable_atomic_no_cfg_target_has_atomic),
    cfg(not(target_has_atomic = "64"))
)]
pub(crate) use self::atomic64::arm_linux::{
    AtomicI64,
    AtomicU64,
};
...
pub(crate) use self::atomic64::riscv32::{
    AtomicI64,
    AtomicU64,
};
...
pub(crate) use self::atomic128::aarch64::{
    AtomicI128,
    AtomicU128,
};
...
pub(crate) use self::atomic128::x86_64::{
    AtomicI128,
    AtomicU128,
};
...
pub(crate) use self::atomic128::riscv64::{
    AtomicI128,
    AtomicU128,
};
...
pub(crate) use self::atomic128::powerpc64::{
    AtomicI128,
    AtomicU128,
};
// s390x
...
pub(crate) use self::atomic128::s390x::{
    AtomicI128,
    AtomicU128,
};

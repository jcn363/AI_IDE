...
impl WindowBuilderExtWindows for WindowBuilder {
    ...
    fn with_parent_window(mut self, parent: HWND) -> WindowBuilder {
        self.platform_specific.parent =
            Parent::ChildOf(windows::Win32::Foundation::HWND(parent as _));
        self
    }
    ...
    fn with_owner_window(mut self, parent: HWND) -> WindowBuilder {
        self.platform_specific.parent =
            Parent::OwnedBy(windows::Win32::Foundation::HWND(parent as _));
        self
    }

    #[inline]
    fn with_menu(mut self, menu: HMENU) -> WindowBuilder {
        self.platform_specific.menu =
            Some(windows::Win32::UI::WindowsAndMessaging::HMENU(menu as _));
        self
    }

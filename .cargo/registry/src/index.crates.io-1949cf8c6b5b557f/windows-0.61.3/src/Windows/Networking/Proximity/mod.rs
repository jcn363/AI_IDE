...
impl ConnectionRequestedEventArgs {
    pub fn PeerInformation(&self) -> windows_core::Result<PeerInformation> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).PeerInformation)(
...
impl windows_core::RuntimeType for ConnectionRequestedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IConnectionRequestedEventArgs>();
}
...
windows_core::imp::define_interface!(
    ...
    DeviceArrivedEventHandler_Vtbl,
    0xefa9da69_f6e1_49c9_a49e_8e0fc58fb911
);
...
impl DeviceArrivedEventHandler {
    pub fn new<
        F: FnMut(windows_core::Ref<'_, ProximityDevice>) -> windows_core::Result<()> + Send + 'static,
    >(
        invoke: F,
    ) -> Self {
        let com = DeviceArrivedEventHandlerBox {
            vtable: &DeviceArrivedEventHandlerBox::<F>::VTABLE,
...
#[repr(C)]
struct DeviceArrivedEventHandlerBox<
    F: FnMut(windows_core::Ref<'_, ProximityDevice>) -> windows_core::Result<()> + Send + 'static,
> {
...
impl<
        F: FnMut(windows_core::Ref<'_, ProximityDevice>) -> windows_core::Result<()> + Send + 'static,
    > DeviceArrivedEventHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <DeviceArrivedEventHandler as windows_core::Interface>::IID
...
windows_core::imp::define_interface!(
    ...
    DeviceDepartedEventHandler_Vtbl,
    0xefa9da69_f6e2_49c9_a49e_8e0fc58fb911
);
...
impl DeviceDepartedEventHandler {
    ...
    >(
        ...
        let com = DeviceDepartedEventHandlerBox {
            vtable: &DeviceDepartedEventHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
#[repr(C)]
struct DeviceDepartedEventHandlerBox<
    F: FnMut(windows_core::Ref<'_, ProximityDevice>) -> windows_core::Result<()> + Send + 'static,
> {
...
impl<
        F: FnMut(windows_core::Ref<'_, ProximityDevice>) -> windows_core::Result<()> + Send + 'static,
    > DeviceDepartedEventHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <DeviceDepartedEventHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _
...
windows_core::imp::define_interface!(
    ...
    IConnectionRequestedEventArgs_Vtbl,
    0xeb6891ae_4f1e_4c66_bd0d_46924a942e08
);
...
pub struct IConnectionRequestedEventArgs_Vtbl {
    ...
    pub PeerInformation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IPeerFinderStatics,
    IPeerFinderStatics_Vtbl,
    0x914b3b61_f6e1_47c4_a14c_148a1903d0c6
);
...
pub struct IPeerFinderStatics_Vtbl {
    ...
    pub SetAllowBluetooth:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub AllowInfrastructure:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetAllowInfrastructure:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub AllowWiFiDirect:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetAllowWiFiDirect:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    ...
    pub SupportedDiscoveryTypes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PeerDiscoveryTypes,
    ) -> windows_core::HRESULT,
    pub AlternateIdentities: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Start: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub StartWithMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Stop: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub TriggeredConnectionStateChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveTriggeredConnectionStateChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub ConnectionRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveConnectionRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub FindAllPeersAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IPeerFinderStatics2,
    IPeerFinderStatics2_Vtbl,
    0xd6e73c65_fdd0_4b0b_9312_866408935d82
);
...
pub struct IPeerFinderStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Role:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut PeerRole) -> windows_core::HRESULT,
    pub SetRole:
        unsafe extern "system" fn(*mut core::ffi::c_void, PeerRole) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    pub DiscoveryData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    DiscoveryData: usize,
    #[cfg(feature = "Storage_Streams")]
    pub SetDiscoveryData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
...
windows_core::imp::define_interface!(
    IPeerInformation,
    IPeerInformation_Vtbl,
    0x20024f08_9fff_45f4_b6e9_408b2ebef373
);
...
windows_core::imp::define_interface!(
    IPeerInformation3,
    IPeerInformation3_Vtbl,
    0xb20f612a_dbd0_40f8_95bd_2d4209c7836f
);
...
windows_core::imp::define_interface!(
    ...
    IPeerInformationWithHostAndService_Vtbl,
    0xecc7ccad_1b70_4e8b_92db_bbe781419308
);
...
windows_core::imp::define_interface!(
    IPeerWatcher,
    IPeerWatcher_Vtbl,
    0x3cee21f8_2fa6_4679_9691_03c94a420f34
);
...
windows_core::imp::define_interface!(
    IProximityDevice,
    IProximityDevice_Vtbl,
    0xefa8a552_f6e1_4329_a0fc_ab6b0fd28262
);
...
pub struct IProximityDevice_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SubscribeForMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub PublishMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub PublishMessageWithCallback: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub PublishBinaryMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub PublishBinaryMessageWithCallback: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub PublishUriMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub PublishUriMessageWithCallback: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub StopSubscribingForMessage:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub StopPublishingMessage:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub DeviceArrived: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveDeviceArrived:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub DeviceDeparted: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveDeviceDeparted:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub MaxMessageBytes:
...
windows_core::imp::define_interface!(
    ...
    IProximityDeviceStatics_Vtbl,
    0x914ba01d_f6e1_47c4_a14c_148a1903d0c6
);
...
windows_core::imp::define_interface!(
    IProximityMessage,
    IProximityMessage_Vtbl,
    0xefab0782_f6e1_4675_a045_d8e320c24808
);
...
pub struct IProximityMessage_Vtbl {
    ...
    #[cfg(not(feature = "Storage_Streams"))]
    Data: usize,
    pub DataAsString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ITriggeredConnectionStateChangedEventArgs_Vtbl,
    0xc6a780ad_f6e1_4d54_96e2_33f620bca88a
);
...
windows_core::imp::define_interface!(
    ...
    MessageReceivedHandler_Vtbl,
    0xefab0782_f6e2_4675_a045_d8e320c24808
);
...
impl MessageReceivedHandler {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, ProximityDevice>,
                windows_core::Ref<'_, ProximityMessage>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        ...
        let com = MessageReceivedHandlerBox {
            vtable: &MessageReceivedHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
#[repr(C)]
struct MessageReceivedHandlerBox<
    F: FnMut(
            windows_core::Ref<'_, ProximityDevice>,
            windows_core::Ref<'_, ProximityMessage>,
        ) -> windows_core::Result<()>
    ...
    > MessageReceivedHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <MessageReceivedHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _
...
windows_core::imp::define_interface!(
    ...
    MessageTransmittedHandler_Vtbl,
    0xefaa0b4a_f6e2_4d7d_856c_78fc8efc021e
);
...
impl MessageTransmittedHandler {
    pub fn new<
        F: FnMut(windows_core::Ref<'_, ProximityDevice>, i64) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        invoke: F,
    ) -> Self {
        let com = MessageTransmittedHandlerBox {
            vtable: &MessageTransmittedHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
#[repr(C)]
struct MessageTransmittedHandlerBox<
    F: FnMut(windows_core::Ref<'_, ProximityDevice>, i64) -> windows_core::Result<()> + Send + 'static,
> {
...
impl<
        F: FnMut(windows_core::Ref<'_, ProximityDevice>, i64) -> windows_core::Result<()>
            + Send
            + 'static,
    > MessageTransmittedHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <MessageTransmittedHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _
...
impl windows_core::RuntimeType for PeerDiscoveryTypes {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Networking.Proximity.PeerDiscoveryTypes;u4)",
    );
}
impl PeerDiscoveryTypes {
...
impl PeerFinder {
    pub fn AllowBluetooth() -> windows_core::Result<bool> {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllowBluetooth)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAllowBluetooth(value: bool) -> windows_core::Result<()> {
        Self::IPeerFinderStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).SetAllowBluetooth)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn AllowInfrastructure() -> windows_core::Result<bool> {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllowInfrastructure)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAllowInfrastructure(value: bool) -> windows_core::Result<()> {
        Self::IPeerFinderStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).SetAllowInfrastructure)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn AllowWiFiDirect() -> windows_core::Result<bool> {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllowWiFiDirect)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAllowWiFiDirect(value: bool) -> windows_core::Result<()> {
        Self::IPeerFinderStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).SetAllowWiFiDirect)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SupportedDiscoveryTypes() -> windows_core::Result<PeerDiscoveryTypes> {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedDiscoveryTypes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    ) -> windows_core::Result<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>>
    {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AlternateIdentities)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn StartWithMessage(peermessage: &windows_core::HSTRING) -> windows_core::Result<()> {
        Self::IPeerFinderStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).StartWithMessage)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(peermessage),
            )
            .ok()
        })
    }
        ...
        >,
    {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TriggeredConnectionStateChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveTriggeredConnectionStateChanged(cookie: i64) -> windows_core::Result<()> {
        Self::IPeerFinderStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveTriggeredConnectionStateChanged)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        >,
    {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConnectionRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveConnectionRequested(cookie: i64) -> windows_core::Result<()> {
        Self::IPeerFinderStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveConnectionRequested)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
    ...
    pub fn FindAllPeersAsync() -> windows_core::Result<
        windows_future::IAsyncOperation<windows_collections::IVectorView<PeerInformation>>,
    > {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindAllPeersAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ConnectAsync<P0>(
        peerinformation: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::Sockets::StreamSocket>>
    where
    ...
    pub fn DiscoveryData() -> windows_core::Result<super::super::Storage::Streams::IBuffer> {
        Self::IPeerFinderStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DiscoveryData)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        Self::IPeerFinderStatics2(|this| unsafe {
            (windows_core::Interface::vtable(this).SetDiscoveryData)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    fn IPeerFinderStatics<R, F: FnOnce(&IPeerFinderStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PeerFinder, IPeerFinderStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IPeerFinderStatics2<R, F: FnOnce(&IPeerFinderStatics2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PeerFinder, IPeerFinderStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl windows_core::RuntimeType for PeerInformation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPeerInformation>();
}
...
impl windows_core::RuntimeType for PeerRole {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Networking.Proximity.PeerRole;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl PeerWatcher {
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<PeerWatcher, PeerInformation>,
        >,
    {
        let this = self;
        unsafe {
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<PeerWatcher, windows_core::IInspectable>,
        >,
    {
        let this = self;
        unsafe {
...
impl windows_core::RuntimeType for PeerWatcher {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPeerWatcher>();
}
...
impl windows_core::RuntimeType for PeerWatcherStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Networking.Proximity.PeerWatcherStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl ProximityDevice {
    pub fn SubscribeForMessage<P1>(
        &self,
        messagetype: &windows_core::HSTRING,
        messagereceivedhandler: P1,
        ...
        P1: windows_core::Param<MessageReceivedHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SubscribeForMessage)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(messagetype),
                messagereceivedhandler.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub fn PublishMessage(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PublishMessage)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(messagetype),
                core::mem::transmute_copy(message),
                &mut result__,
    ...
    pub fn PublishMessageWithCallback<P2>(
        &self,
        messagetype: &windows_core::HSTRING,
        message: &windows_core::HSTRING,
        messagetransmittedhandler: P2,
    ) -> windows_core::Result<i64>
    where
        P2: windows_core::Param<MessageTransmittedHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PublishMessageWithCallback)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(messagetype),
                core::mem::transmute_copy(message),
                messagetransmittedhandler.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn PublishBinaryMessage<P1>(
        &self,
        messagetype: &windows_core::HSTRING,
        message: P1,
    ) -> windows_core::Result<i64>
        ...
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PublishBinaryMessage)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(messagetype),
                message.param().abi(),
                &mut result__,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn PublishBinaryMessageWithCallback<P1, P2>(
        &self,
        messagetype: &windows_core::HSTRING,
        message: P1,
        messagetransmittedhandler: P2,
        ...
        P2: windows_core::Param<MessageTransmittedHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PublishBinaryMessageWithCallback)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(messagetype),
                message.param().abi(),
                messagetransmittedhandler.param().abi(),
        ...
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PublishUriMessage)(
                windows_core::Interface::as_raw(this),
                message.param().abi(),
                &mut result__,
            )
    ...
    pub fn PublishUriMessageWithCallback<P0, P1>(
        &self,
        message: P0,
        messagetransmittedhandler: P1,
    ) -> windows_core::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
        P1: windows_core::Param<MessageTransmittedHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PublishUriMessageWithCallback)(
                windows_core::Interface::as_raw(this),
                message.param().abi(),
                messagetransmittedhandler.param().abi(),
                &mut result__,
    ...
    pub fn StopSubscribingForMessage(&self, subscriptionid: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).StopSubscribingForMessage)(
                windows_core::Interface::as_raw(this),
                subscriptionid,
            )
            .ok()
    ...
    pub fn StopPublishingMessage(&self, messageid: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).StopPublishingMessage)(
                windows_core::Interface::as_raw(this),
                messageid,
            )
            .ok()
        ...
        P0: windows_core::Param<DeviceArrivedEventHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeviceArrived)(
                windows_core::Interface::as_raw(this),
                arrivedhandler.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub fn RemoveDeviceArrived(&self, cookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDeviceArrived)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<DeviceDepartedEventHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeviceDeparted)(
                windows_core::Interface::as_raw(this),
                departedhandler.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub fn RemoveDeviceDeparted(&self, cookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDeviceDeparted)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
    ...
    pub fn MaxMessageBytes(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxMessageBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn BitsPerSecond(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BitsPerSecond)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    fn IProximityDeviceStatics<
        R,
        F: FnOnce(&IProximityDeviceStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ProximityDevice, IProximityDeviceStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for ProximityDevice {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IProximityDevice>();
}
...
impl ProximityMessage {
    ...
    pub fn SubscriptionId(&self) -> windows_core::Result<i64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SubscriptionId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn DataAsString(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DataAsString)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for ProximityMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IProximityMessage>();
}
...
impl windows_core::RuntimeType for TriggeredConnectState {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Networking.Proximity.TriggeredConnectState;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
unsafe impl windows_core::Interface for TriggeredConnectionStateChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ITriggeredConnectionStateChangedEventArgs as windows_core::Interface>::IID;
}

windows_core::imp::define_interface!(
    ...
    IPushNotificationChannel_Vtbl,
    0x2b28102e_ef0b_4f39_9b8a_a3c194de7081
);
...
pub struct IPushNotificationChannel_Vtbl {
    ...
    pub PushNotificationReceived: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IPushNotificationChannelManagerForUser_Vtbl,
    0xa4c45704_1182_42c7_8890_f563c4890dc4
);
...
pub struct IPushNotificationChannelManagerForUser_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreatePushNotificationChannelForApplicationAsync:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT,
    pub CreatePushNotificationChannelForApplicationAsyncWithId:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
            *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT,
    pub CreatePushNotificationChannelForSecondaryTileAsync:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
            *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IPushNotificationChannelManagerForUser2_Vtbl,
    0xc38b066a_7cc1_4dac_87fd_be6e920414a4
);
...
pub struct IPushNotificationChannelManagerForUser2_Vtbl {
    ...
    pub CreateRawPushNotificationChannelWithAlternateKeyForApplicationAsync:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub CreateRawPushNotificationChannelWithAlternateKeyForApplicationAsyncWithId:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IPushNotificationChannelManagerStatics_Vtbl,
    0x8baf9b65_77a1_4588_bd19_861529a9dcf0
);
...
windows_core::imp::define_interface!(
    ...
    0xb444a65d_a7e9_4b28_950e_f375a907f9df
);
...
windows_core::imp::define_interface!(
    ...
    IPushNotificationChannelManagerStatics3_Vtbl,
    0x4701fefe_0ede_4a3f_ae78_bfa471496925
);
...
windows_core::imp::define_interface!(
    ...
    IPushNotificationChannelManagerStatics4_Vtbl,
    0xbc540efb_7820_5a5b_9c01_b4757f774025
);
...
pub struct IPushNotificationChannelManagerStatics4_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ChannelsRevoked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveChannelsRevoked:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPushNotificationChannelsRevokedEventArgs,
    IPushNotificationChannelsRevokedEventArgs_Vtbl,
...
windows_core::imp::define_interface!(
    ...
    0xd1065e0c_36cd_484c_b935_0a99b753cf00
);
...
pub struct IPushNotificationReceivedEventArgs_Vtbl {
    ...
    pub NotificationType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PushNotificationType,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "UI_Notifications")]
    pub ToastNotification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "UI_Notifications")]
    pub TileNotification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "UI_Notifications"))]
    ...
    #[cfg(feature = "UI_Notifications")]
    pub BadgeNotification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "UI_Notifications"))]
    BadgeNotification: usize,
    pub RawNotification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRawNotification,
    IRawNotification_Vtbl,
    0x1a227281_3b79_42ac_9963_22ab00d4f0b7
);
...
windows_core::imp::define_interface!(
    IRawNotification2,
    IRawNotification2_Vtbl,
    0xe6d0cf19_0c6f_4cdd_9424_eec5be014d26
);
...
pub struct IRawNotification2_Vtbl {
    ...
    pub ChannelId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRawNotification3,
    IRawNotification3_Vtbl,
    0x62737dde_8a73_424c_ab44_5635f40a96e5
);
...
pub struct IRawNotification3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Storage_Streams")]
    pub ContentBytes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
...
impl PushNotificationChannel {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PushNotificationReceived)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemovePushNotificationReceived(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemovePushNotificationReceived)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for PushNotificationChannel {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPushNotificationChannel>();
}
...
impl PushNotificationChannelManager {
    pub fn CreatePushNotificationChannelForApplicationAsync(
    ) -> windows_core::Result<windows_future::IAsyncOperation<PushNotificationChannel>> {
    ...
    pub fn CreatePushNotificationChannelForApplicationAsyncWithId(
    ...
    pub fn CreatePushNotificationChannelForSecondaryTileAsync(
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::EventHandler<PushNotificationChannelsRevokedEventArgs>,
        >,
    {
        Self::IPushNotificationChannelManagerStatics4(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ChannelsRevoked)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveChannelsRevoked(token: i64) -> windows_core::Result<()> {
        Self::IPushNotificationChannelManagerStatics4(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveChannelsRevoked)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    fn IPushNotificationChannelManagerStatics<
        R,
        F: FnOnce(&IPushNotificationChannelManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ...
    fn IPushNotificationChannelManagerStatics2<
        R,
        F: FnOnce(&IPushNotificationChannelManagerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IPushNotificationChannelManagerStatics3<
        R,
        F: FnOnce(&IPushNotificationChannelManagerStatics3) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IPushNotificationChannelManagerStatics4<
        R,
        F: FnOnce(&IPushNotificationChannelManagerStatics4) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl PushNotificationChannelManagerForUser {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateRawPushNotificationChannelWithAlternateKeyForApplicationAsync<P0>(
        &self,
        appserverkey: P0,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateRawPushNotificationChannelWithAlternateKeyForApplicationAsyncWithId<P0>(
        &self,
        appserverkey: P0,
        channelid: &windows_core::HSTRING,
...
impl windows_core::RuntimeType for PushNotificationChannelManagerForUser {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPushNotificationChannelManagerForUser>();
}
unsafe impl windows_core::Interface for PushNotificationChannelManagerForUser {
    ...
    const IID: windows_core::GUID =
        <IPushNotificationChannelManagerForUser as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for PushNotificationChannelsRevokedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IPushNotificationChannelsRevokedEventArgs as windows_core::Interface>::IID;
}
impl windows_core::RuntimeName for PushNotificationChannelsRevokedEventArgs {
    const NAME: &'static str =
        "Windows.Networking.PushNotifications.PushNotificationChannelsRevokedEventArgs";
}
...
impl PushNotificationReceivedEventArgs {
    ...
    pub fn ToastNotification(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ToastNotification)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn TileNotification(
        &self,
    ) -> windows_core::Result<super::super::UI::Notifications::TileNotification> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TileNotification)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn BadgeNotification(
        &self,
    ) -> windows_core::Result<super::super::UI::Notifications::BadgeNotification> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BadgeNotification)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn RawNotification(&self) -> windows_core::Result<RawNotification> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RawNotification)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for PushNotificationReceivedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPushNotificationReceivedEventArgs>();
}
unsafe impl windows_core::Interface for PushNotificationReceivedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IPushNotificationReceivedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for PushNotificationType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Networking.PushNotifications.PushNotificationType;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl RawNotification {
    ...
    pub fn ChannelId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ChannelId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn ContentBytes(&self) -> windows_core::Result<super::super::Storage::Streams::IBuffer> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ContentBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for RawNotification {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRawNotification>();
}

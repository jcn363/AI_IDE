...
impl DnssdRegistrationResult {
    ...
    pub fn HasInstanceNameChanged(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HasInstanceNameChanged)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for DnssdRegistrationResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDnssdRegistrationResult>();
}
...
impl DnssdServiceInstance {
    pub fn DnssdServiceInstanceName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DnssdServiceInstanceName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetDnssdServiceInstanceName(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDnssdServiceInstanceName)(
                windows_core::Interface::as_raw(this),
        ...
        P0: windows_core::Param<super::super::HostName>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetHostName)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn SetPort(&self, value: u16) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPort)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    ) -> windows_core::Result<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>>
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TextAttributes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn RegisterStreamSocketListenerAsync<P0>(
        &self,
        socket: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<DnssdRegistrationResult>>
    where
        P0: windows_core::Param<super::super::Sockets::StreamSocketListener>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RegisterStreamSocketListenerAsync)(
                windows_core::Interface::as_raw(this),
                socket.param().abi(),
                &mut result__,
            )
    ...
    pub fn RegisterStreamSocketListenerAsync2<P0, P1>(
        &self,
        socket: P0,
        adapter: P1,
    ) -> windows_core::Result<windows_future::IAsyncOperation<DnssdRegistrationResult>>
        ...
        P1: windows_core::Param<super::super::Connectivity::NetworkAdapter>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RegisterStreamSocketListenerAsync2)(
                windows_core::Interface::as_raw(this),
                socket.param().abi(),
                adapter.param().abi(),
                &mut result__,
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub fn RegisterDatagramSocketAsync<P0>(
        &self,
        socket: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<DnssdRegistrationResult>>
    where
        P0: windows_core::Param<super::super::Sockets::DatagramSocket>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RegisterDatagramSocketAsync)(
                windows_core::Interface::as_raw(this),
                socket.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(all(feature = "Networking_Connectivity", feature = "Networking_Sockets"))]
    pub fn RegisterDatagramSocketAsync2<P0, P1>(
        &self,
        socket: P0,
        adapter: P1,
    ) -> windows_core::Result<windows_future::IAsyncOperation<DnssdRegistrationResult>>
        ...
        P1: windows_core::Param<super::super::Connectivity::NetworkAdapter>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RegisterDatagramSocketAsync2)(
                windows_core::Interface::as_raw(this),
                socket.param().abi(),
                adapter.param().abi(),
                &mut result__,
    ...
    pub fn Create<P1>(
        dnssdserviceinstancename: &windows_core::HSTRING,
        hostname: P1,
        port: u16,
    ) -> windows_core::Result<DnssdServiceInstance>
    where
        P1: windows_core::Param<super::super::HostName>,
    {
        Self::IDnssdServiceInstanceFactory(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).Create)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(dnssdserviceinstancename),
                hostname.param().abi(),
                port,
                &mut result__,
            )
    ...
    fn IDnssdServiceInstanceFactory<
        R,
        F: FnOnce(&IDnssdServiceInstanceFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for DnssdServiceInstance {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDnssdServiceInstance>();
}
...
windows_core::imp::interface_hierarchy!(
    ...
    windows_core::IUnknown,
    windows_core::IInspectable,
    windows_collections::IVectorView<DnssdServiceInstance>
);
windows_core::imp::required_hierarchy!(
    DnssdServiceInstanceCollection,
    windows_collections::IIterable<DnssdServiceInstance>
);
impl DnssdServiceInstanceCollection {
    pub fn First(
        &self,
    ) -> windows_core::Result<windows_collections::IIterator<DnssdServiceInstance>> {
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [Option<DnssdServiceInstance>],
...
unsafe impl windows_core::Interface for DnssdServiceInstanceCollection {
    type Vtable =
        <windows_collections::IVectorView<DnssdServiceInstance> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <windows_collections::IVectorView<DnssdServiceInstance> as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for DnssdServiceWatcher {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDnssdServiceWatcher>();
}
...
windows_core::imp::define_interface!(
    ...
    IDnssdRegistrationResult_Vtbl,
    0x3d786ad2_e606_5350_73ea_7e97f066162f
);
...
pub struct IDnssdRegistrationResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut DnssdRegistrationStatus,
    ) -> windows_core::HRESULT,
    pub IPAddress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub HasInstanceNameChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IDnssdServiceInstance,
    IDnssdServiceInstance_Vtbl,
    0xe246db7e_98a5_4ca1_b9e4_c253d33c35ff
);
...
pub struct IDnssdServiceInstance_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub DnssdServiceInstanceName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetDnssdServiceInstanceName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetHostName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub TextAttributes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Networking_Sockets")]
    pub RegisterStreamSocketListenerAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Networking_Connectivity", feature = "Networking_Sockets"))]
    pub RegisterStreamSocketListenerAsync2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub RegisterDatagramSocketAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Networking_Connectivity", feature = "Networking_Sockets"))]
    pub RegisterDatagramSocketAsync2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IDnssdServiceInstanceFactory,
    IDnssdServiceInstanceFactory_Vtbl,
    0x6cb061a1_c478_4331_9684_4af2186c0a2b
);
...
windows_core::imp::define_interface!(
    ...
    IDnssdServiceWatcher_Vtbl,
    0xcc34d9c1_db7d_4b69_983d_c6f83f205682
);

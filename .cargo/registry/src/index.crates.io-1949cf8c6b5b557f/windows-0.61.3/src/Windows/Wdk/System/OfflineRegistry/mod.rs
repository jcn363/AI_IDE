...
#[inline]
pub unsafe fn ORCreateHive(
    horkey: *mut ORHKEY,
) -> super::super::super::Win32::Foundation::WIN32_ERROR {
...
#[inline]
pub unsafe fn ORCreateKey<P1, P2>(
    keyhandle: ORHKEY,
    lpsubkey: P1,
    lpclass: P2,
    dwoptions: Option<u32>,
    psecuritydescriptor: Option<super::super::super::Win32::Security::PSECURITY_DESCRIPTOR>,
    phkresult: *mut ORHKEY,
    pdwdisposition: Option<*mut u32>,
) -> super::super::super::Win32::Foundation::WIN32_ERROR
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ORCreateKey(
            ...
            phkresult as _,
            pdwdisposition.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn ORDeleteKey<P1>(
    handle: ORHKEY,
    lpsubkey: P1,
) -> super::super::super::Win32::Foundation::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("offreg.dll" "system" fn ORDeleteKey(handle : ORHKEY, lpsubkey : windows_core::PCWSTR) -> super::super::super::Win32::Foundation:: WIN32_ERROR);
    unsafe { ORDeleteKey(handle, lpsubkey.param().abi()) }
}
#[inline]
pub unsafe fn ORDeleteValue<P1>(
    handle: ORHKEY,
    lpvaluename: P1,
) -> super::super::super::Win32::Foundation::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("offreg.dll" "system" fn ORDeleteValue(handle : ORHKEY, lpvaluename : windows_core::PCWSTR) -> super::super::super::Win32::Foundation:: WIN32_ERROR);
    unsafe { ORDeleteValue(handle, lpvaluename.param().abi()) }
}
#[inline]
pub unsafe fn OREnumKey(
    handle: ORHKEY,
    dwindex: u32,
    lpname: windows_core::PWSTR,
    lpcname: *mut u32,
    lpclass: Option<windows_core::PWSTR>,
    lpcclass: Option<*mut u32>,
    lpftlastwritetime: Option<*mut super::super::super::Win32::Foundation::FILETIME>,
) -> super::super::super::Win32::Foundation::WIN32_ERROR {
    windows_link::link!("offreg.dll" "system" fn OREnumKey(handle : ORHKEY, dwindex : u32, lpname : windows_core::PWSTR, lpcname : *mut u32, lpclass : windows_core::PWSTR, lpcclass : *mut u32, lpftlastwritetime : *mut super::super::super::Win32::Foundation:: FILETIME) -> super::super::super::Win32::Foundation:: WIN32_ERROR);
    unsafe {
        OREnumKey(
            handle,
            dwindex,
...
#[inline]
pub unsafe fn OREnumValue(
    handle: ORHKEY,
    dwindex: u32,
    lpvaluename: windows_core::PWSTR,
    lpcvaluename: *mut u32,
    lptype: Option<*mut u32>,
    lpdata: Option<*mut u8>,
    lpcbdata: Option<*mut u32>,
) -> super::super::super::Win32::Foundation::WIN32_ERROR {
    windows_link::link!("offreg.dll" "system" fn OREnumValue(handle : ORHKEY, dwindex : u32, lpvaluename : windows_core::PWSTR, lpcvaluename : *mut u32, lptype : *mut u32, lpdata : *mut u8, lpcbdata : *mut u32) -> super::super::super::Win32::Foundation:: WIN32_ERROR);
    unsafe {
        OREnumValue(
            handle,
            dwindex,
            core::mem::transmute(lpvaluename),
            lpcvaluename as _,
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn ORGetKeySecurity(
    handle: ORHKEY,
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("offreg.dll" "system" fn ORGetValue(handle : ORHKEY, lpsubkey : windows_core::PCWSTR, lpvalue : windows_core::PCWSTR, pdwtype : *mut u32, pvdata : *mut core::ffi::c_void, pcbdata : *mut u32) -> super::super::super::Win32::Foundation:: WIN32_ERROR);
    unsafe {
        ORGetValue(
            handle,
            lpsubkey.param().abi(),
...
#[inline]
pub unsafe fn ORGetVirtualFlags(
    handle: ORHKEY,
    pdwflags: *mut u32,
) -> super::super::super::Win32::Foundation::WIN32_ERROR {
...
pub unsafe fn ORMergeHives(
    ...
    unsafe {
        ORMergeHives(
            core::mem::transmute(hivehandles.as_ptr()),
            hivehandles.len().try_into().unwrap(),
            phkresult as _,
        )
    }
}
#[inline]
pub unsafe fn OROpenHive<P0>(
    filepath: P0,
    horkey: *mut ORHKEY,
) -> super::super::super::Win32::Foundation::WIN32_ERROR
where
...
{
    windows_link::link!("offreg.dll" "system" fn OROpenHive(filepath : windows_core::PCWSTR, horkey : *mut ORHKEY) -> super::super::super::Win32::Foundation:: WIN32_ERROR);
    unsafe { OROpenHive(filepath.param().abi(), horkey as _) }
}
#[inline]
pub unsafe fn OROpenHiveByHandle(
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("offreg.dll" "system" fn OROpenKey(handle : ORHKEY, lpsubkey : windows_core::PCWSTR, phkresult : *mut ORHKEY) -> super::super::super::Win32::Foundation:: WIN32_ERROR);
    unsafe { OROpenKey(handle, lpsubkey.param().abi(), phkresult as _) }
}
#[inline]
pub unsafe fn ORQueryInfoKey(
    handle: ORHKEY,
    lpclass: Option<windows_core::PWSTR>,
    lpcclass: Option<*mut u32>,
    lpcsubkeys: Option<*mut u32>,
    lpcmaxsubkeylen: Option<*mut u32>,
    lpcmaxclasslen: Option<*mut u32>,
    lpcvalues: Option<*mut u32>,
    lpcmaxvaluenamelen: Option<*mut u32>,
    lpcmaxvaluelen: Option<*mut u32>,
    lpcbsecuritydescriptor: Option<*mut u32>,
    lpftlastwritetime: Option<*mut super::super::super::Win32::Foundation::FILETIME>,
) -> super::super::super::Win32::Foundation::WIN32_ERROR {
    windows_link::link!("offreg.dll" "system" fn ORQueryInfoKey(handle : ORHKEY, lpclass : windows_core::PWSTR, lpcclass : *mut u32, lpcsubkeys : *mut u32, lpcmaxsubkeylen : *mut u32, lpcmaxclasslen : *mut u32, lpcvalues : *mut u32, lpcmaxvaluenamelen : *mut u32, lpcmaxvaluelen : *mut u32, lpcbsecuritydescriptor : *mut u32, lpftlastwritetime : *mut super::super::super::Win32::Foundation:: FILETIME) -> super::super::super::Win32::Foundation:: WIN32_ERROR);
    unsafe {
        ORQueryInfoKey(
            handle,
            lpclass.unwrap_or(core::mem::zeroed()) as _,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("offreg.dll" "system" fn ORRenameKey(handle : ORHKEY, lpnewname : windows_core::PCWSTR) -> super::super::super::Win32::Foundation:: WIN32_ERROR);
    unsafe { ORRenameKey(handle, lpnewname.param().abi()) }
}
#[inline]
pub unsafe fn ORSaveHive<P1>(
    horkey: ORHKEY,
    hivepath: P1,
    osmajorversion: u32,
    osminorversion: u32,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("offreg.dll" "system" fn ORSaveHive(horkey : ORHKEY, hivepath : windows_core::PCWSTR, osmajorversion : u32, osminorversion : u32) -> super::super::super::Win32::Foundation:: WIN32_ERROR);
    unsafe {
        ORSaveHive(
            horkey,
            hivepath.param().abi(),
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn ORSetKeySecurity(
    handle: ORHKEY,
    securityinformation: u32,
    psecuritydescriptor: super::super::super::Win32::Security::PSECURITY_DESCRIPTOR,
) -> super::super::super::Win32::Foundation::WIN32_ERROR {
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("offreg.dll" "system" fn ORSetValue(handle : ORHKEY, lpvaluename : windows_core::PCWSTR, dwtype : u32, lpdata : *const u8, cbdata : u32) -> super::super::super::Win32::Foundation:: WIN32_ERROR);
    unsafe {
        ORSetValue(
            handle,
...
#[inline]
pub unsafe fn ORSetVirtualFlags(
    handle: ORHKEY,
    dwflags: u32,
) -> super::super::super::Win32::Foundation::WIN32_ERROR {
...
impl windows_core::Free for ORHKEY {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("offreg.dll" "system" fn ORCloseKey(keyhandle : *mut core::ffi::c_void) -> u32);
            unsafe {
                ORCloseKey(self.0);
            }
        }

#[inline]
pub unsafe fn NtClose(
    handle: super::super::Win32::Foundation::HANDLE,
...
pub unsafe fn NtQueryObject(
    handle: Option<super::super::Win32::Foundation::HANDLE>,
...
pub type DRIVER_CONTROL = Option<
    ...
    ) -> super::System::SystemServices::IO_ALLOCATION_ACTION,
>;
#[cfg(all(
    feature = "Wdk_Storage_FileSystem",
    feature = "Wdk_System_SystemServices",
...
pub type DRIVER_DISPATCH_PAGED = Option<
    unsafe extern "system" fn(
        deviceobject: *const DEVICE_OBJECT,
        irp: *mut IRP,
    ) -> super::super::Win32::Foundation::NTSTATUS,
...
pub type DRIVER_FS_NOTIFICATION =
    Option<unsafe extern "system" fn(deviceobject: *const DEVICE_OBJECT, fsactive: bool)>;
#[cfg(all(
    feature = "Wdk_Storage_FileSystem",
    feature = "Wdk_System_SystemServices",
    feature = "Win32_Security",
...
pub type DRIVER_INITIALIZE = Option<
    unsafe extern "system" fn(
        driverobject: *const DRIVER_OBJECT,
        registrypath: *const super::super::Win32::Foundation::UNICODE_STRING,
    ) -> super::super::Win32::Foundation::NTSTATUS,
>;
pub type DRIVER_NOTIFICATION_CALLBACK_ROUTINE = Option<
    unsafe extern "system" fn(
        notificationstructure: *const core::ffi::c_void,
...
pub type DRIVER_REINITIALIZE = Option<
    unsafe extern "system" fn(
        driverobject: *const DRIVER_OBJECT,
        context: *const core::ffi::c_void,
        count: u32,
...
pub type FAST_IO_CHECK_IF_POSSIBLE = Option<
    unsafe extern "system" fn(
        ...
        wait: bool,
        lockkey: u32,
        checkforreadoperation: bool,
        iostatus: *mut super::super::Win32::System::IO::IO_STATUS_BLOCK,
        deviceobject: *const DEVICE_OBJECT,
    ) -> bool,
>;
#[cfg(all(
...
pub type FAST_IO_QUERY_BASIC_INFO = Option<
    unsafe extern "system" fn(
        fileobject: *const FILE_OBJECT,
        wait: bool,
        buffer: *mut super::Storage::FileSystem::FILE_BASIC_INFORMATION,
        iostatus: *mut super::super::Win32::System::IO::IO_STATUS_BLOCK,
        deviceobject: *const DEVICE_OBJECT,
    ) -> bool,
>;
...
pub type FAST_IO_QUERY_NETWORK_OPEN_INFO = Option<
    unsafe extern "system" fn(
        fileobject: *const FILE_OBJECT,
        wait: bool,
        buffer: *mut super::Storage::FileSystem::FILE_NETWORK_OPEN_INFORMATION,
        iostatus: *mut super::super::Win32::System::IO::IO_STATUS_BLOCK,
        deviceobject: *const DEVICE_OBJECT,
    ) -> bool,
>;
...
pub type FAST_IO_QUERY_OPEN = Option<
    unsafe extern "system" fn(
        irp: *mut IRP,
        networkinformation: *mut super::Storage::FileSystem::FILE_NETWORK_OPEN_INFORMATION,
        deviceobject: *const DEVICE_OBJECT,
    ) -> bool,
>;
#[cfg(all(
...
pub type FAST_IO_QUERY_STANDARD_INFO = Option<
    unsafe extern "system" fn(
        fileobject: *const FILE_OBJECT,
        wait: bool,
        buffer: *mut super::Storage::FileSystem::FILE_STANDARD_INFORMATION,
        iostatus: *mut super::super::Win32::System::IO::IO_STATUS_BLOCK,
        deviceobject: *const DEVICE_OBJECT,
    ) -> bool,
>;
...
pub type FAST_IO_READ_COMPRESSED = Option<
    unsafe extern "system" fn(
        ...
        mdlchain: *mut *mut MDL,
        iostatus: *mut super::super::Win32::System::IO::IO_STATUS_BLOCK,
        compresseddatainfo: *mut super::Storage::FileSystem::COMPRESSED_DATA_INFO,
...
pub type FAST_IO_WRITE_COMPRESSED = Option<
    unsafe extern "system" fn(
        ...
        mdlchain: *mut *mut MDL,
        iostatus: *mut super::super::Win32::System::IO::IO_STATUS_BLOCK,
        compresseddatainfo: *const super::Storage::FileSystem::COMPRESSED_DATA_INFO,
        compresseddatainfolength: u32,
        deviceobject: *const DEVICE_OBJECT,
    ) -> bool,
>;
...
pub type PIO_COMPLETION_ROUTINE =
    Option<unsafe extern "system" fn() -> super::super::Win32::Foundation::NTSTATUS>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]

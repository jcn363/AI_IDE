#[inline]
pub unsafe fn NtCancelTimer(
    timerhandle: super::super::super::Win32::Foundation::HANDLE,
    currentstate: Option<*mut bool>,
    ...
    unsafe {
        NtCancelTimer(
            timerhandle,
            currentstate.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(all(
...
pub unsafe fn NtCreateTimer(
    timerhandle: *mut super::super::super::Win32::Foundation::HANDLE,
    desiredaccess: u32,
    objectattributes: Option<*const super::super::Foundation::OBJECT_ATTRIBUTES>,
    timertype: super::super::super::Win32::System::Kernel::TIMER_TYPE,
) -> super::super::super::Win32::Foundation::NTSTATUS {
...
pub unsafe fn NtOpenProcess(
    processhandle: *mut super::super::super::Win32::Foundation::HANDLE,
    desiredaccess: u32,
    objectattributes: *const super::super::Foundation::OBJECT_ATTRIBUTES,
    clientid: Option<*const super::super::super::Win32::System::WindowsProgramming::CLIENT_ID>,
) -> super::super::super::Win32::Foundation::NTSTATUS {
    ...
    unsafe {
        NtOpenProcess(
            ...
            desiredaccess,
            objectattributes,
            clientid.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(all(feature = "Wdk_Foundation", feature = "Win32_Security"))]
...
#[inline]
pub unsafe fn NtSetTimer(
    timerhandle: super::super::super::Win32::Foundation::HANDLE,
    duetime: *const i64,
    timerapcroutine: super::SystemServices::PTIMER_APC_ROUTINE,
    timercontext: Option<*const core::ffi::c_void>,
    resumetimer: bool,
    period: Option<i32>,
    previousstate: Option<*mut bool>,
) -> super::super::super::Win32::Foundation::NTSTATUS {
    ...
    unsafe {
        NtSetTimer(
            ...
            duetime,
            timerapcroutine,
            timercontext.unwrap_or(core::mem::zeroed()) as _,
            resumetimer,
            period.unwrap_or(core::mem::zeroed()) as _,
            previousstate.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn NtSetTimerEx(
    timerhandle: super::super::super::Win32::Foundation::HANDLE,
    timersetinformationclass: TIMER_SET_INFORMATION_CLASS,
    timersetinformation: Option<*mut core::ffi::c_void>,
    ...
    unsafe {
        NtSetTimerEx(
            ...
            timersetinformation.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn NtTerminateProcess(
    processhandle: Option<super::super::super::Win32::Foundation::HANDLE>,
    exitstatus: super::super::super::Win32::Foundation::NTSTATUS,
) -> super::super::super::Win32::Foundation::NTSTATUS {
    ...
    unsafe {
        NtTerminateProcess(
            processhandle.unwrap_or(core::mem::zeroed()) as _,
            exitstatus,
        )
    }
}
...
#[inline]
pub unsafe fn ZwQueryInformationProcess(
    processhandle: super::super::super::Win32::Foundation::HANDLE,
    processinformationclass: PROCESSINFOCLASS,
    processinformation: *mut core::ffi::c_void,
    processinformationlength: u32,
...
#[inline]
pub unsafe fn ZwTerminateProcess(
    processhandle: Option<super::super::super::Win32::Foundation::HANDLE>,
    exitstatus: super::super::super::Win32::Foundation::NTSTATUS,
) -> super::super::super::Win32::Foundation::NTSTATUS {
...
#[inline]
pub unsafe fn ZwWaitForSingleObject(
    handle: super::super::super::Win32::Foundation::HANDLE,
    alertable: bool,

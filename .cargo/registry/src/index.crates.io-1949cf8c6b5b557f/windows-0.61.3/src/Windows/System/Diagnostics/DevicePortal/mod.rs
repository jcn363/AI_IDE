...
impl DevicePortalConnection {
    ...
    pub fn GetForAppServiceConnection<P0>(
        appserviceconnection: P0,
    ) -> windows_core::Result<DevicePortalConnection>
    where
        P0: windows_core::Param<
        ...
        >,
    {
        Self::IDevicePortalConnectionStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForAppServiceConnection)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn GetServerMessageWebSocketForRequest<P0>(
        &self,
        request: P0,
        ...
        P0: windows_core::Param<super::super::super::Web::Http::HttpRequestMessage>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetServerMessageWebSocketForRequest)(
                windows_core::Interface::as_raw(this),
                request.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub fn GetServerMessageWebSocketForRequest2<P0>(
        &self,
        request: P0,
        messagetype: super::super::super::Networking::Sockets::SocketMessageType,
        protocol: &windows_core::HSTRING,
    ) -> windows_core::Result<super::super::super::Networking::Sockets::ServerMessageWebSocket>
    where
        P0: windows_core::Param<super::super::super::Web::Http::HttpRequestMessage>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetServerMessageWebSocketForRequest2)(
                windows_core::Interface::as_raw(this),
                request.param().abi(),
                messagetype,
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub fn GetServerMessageWebSocketForRequest3<P0>(
        &self,
        request: P0,
        messagetype: super::super::super::Networking::Sockets::SocketMessageType,
        protocol: &windows_core::HSTRING,
        ...
        P0: windows_core::Param<super::super::super::Web::Http::HttpRequestMessage>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetServerMessageWebSocketForRequest3)(
                windows_core::Interface::as_raw(this),
                request.param().abi(),
                messagetype,
                core::mem::transmute_copy(protocol),
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub fn GetServerStreamWebSocketForRequest<P0>(
        &self,
        request: P0,
    ) -> windows_core::Result<super::super::super::Networking::Sockets::ServerStreamWebSocket>
    where
        P0: windows_core::Param<super::super::super::Web::Http::HttpRequestMessage>,
    {
        let this = &windows_core::Interface::cast::<IDevicePortalWebSocketConnection>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetServerStreamWebSocketForRequest)(
                windows_core::Interface::as_raw(this),
                request.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub fn GetServerStreamWebSocketForRequest2<P0>(
        &self,
        request: P0,
        protocol: &windows_core::HSTRING,
        outboundbuffersizeinbytes: u32,
        ...
        P0: windows_core::Param<super::super::super::Web::Http::HttpRequestMessage>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetServerStreamWebSocketForRequest2)(
                windows_core::Interface::as_raw(this),
                request.param().abi(),
                core::mem::transmute_copy(protocol),
                outboundbuffersizeinbytes,
    ...
    fn IDevicePortalConnectionStatics<
        R,
        F: FnOnce(&IDevicePortalConnectionStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for DevicePortalConnection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDevicePortalConnection>();
}
...
impl windows_core::RuntimeType for DevicePortalConnectionClosedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDevicePortalConnectionClosedEventArgs>();
}
unsafe impl windows_core::Interface for DevicePortalConnectionClosedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IDevicePortalConnectionClosedEventArgs as windows_core::Interface>::IID;
}
...
impl DevicePortalConnectionRequestReceivedEventArgs {
    ...
    pub fn RequestMessage(
        &self,
    ) -> windows_core::Result<super::super::super::Web::Http::HttpRequestMessage> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsWebSocketUpgradeRequest(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsWebSocketUpgradeRequest)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn WebSocketProtocolsRequested(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WebSocketProtocolsRequested)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
unsafe impl windows_core::Interface for DevicePortalConnectionRequestReceivedEventArgs {
    type Vtable =
        <IDevicePortalConnectionRequestReceivedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IDevicePortalConnectionRequestReceivedEventArgs as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    ...
    IDevicePortalConnection_Vtbl,
    0x0f447f51_1198_4da1_8d54_bdef393e09b6
);
...
windows_core::imp::define_interface!(
    ...
    IDevicePortalConnectionClosedEventArgs_Vtbl,
    0xfcf70e38_7032_428c_9f50_945c15a9f0cb
);
...
pub struct IDevicePortalConnectionClosedEventArgs_Vtbl {
    ...
    pub Reason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut DevicePortalConnectionClosedReason,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IDevicePortalConnectionRequestReceivedEventArgs,
    IDevicePortalConnectionRequestReceivedEventArgs_Vtbl,
    0x64dae045_6fda_4459_9ebd_ecce22e38559
);
...
windows_core::imp::define_interface!(
    IDevicePortalConnectionStatics,
    IDevicePortalConnectionStatics_Vtbl,
    0x4bbe31e7_e9b9_4645_8fed_a53eea0edbd6
);
...
pub struct IDevicePortalConnectionStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "ApplicationModel_AppService")]
    pub GetForAppServiceConnection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x67657920_d65a_42f0_aef4_787808098b7b
);
...
pub struct IDevicePortalWebSocketConnection_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub GetServerMessageWebSocketForRequest: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub GetServerMessageWebSocketForRequest2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::super::Networking::Sockets::SocketMessageType,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub GetServerMessageWebSocketForRequest3: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::super::Networking::Sockets::SocketMessageType,
        *mut core::ffi::c_void,
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub GetServerStreamWebSocketForRequest: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub GetServerStreamWebSocketForRequest2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
...
windows_core::imp::define_interface!(
    IDevicePortalWebSocketConnectionRequestReceivedEventArgs,
    IDevicePortalWebSocketConnectionRequestReceivedEventArgs_Vtbl,
    0x79fdcaba_175c_4739_9f74_dda797c35b3f
);
...
pub struct IDevicePortalWebSocketConnectionRequestReceivedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsWebSocketUpgradeRequest:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub WebSocketProtocolsRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,

...
windows_core::imp::define_interface!(
    ...
    IInteractiveSessionStatics_Vtbl,
    0x60884631_dd3a_4576_9c8d_e8027618bdce
);
...
impl InteractiveSession {
    pub fn IsRemote() -> windows_core::Result<bool> {
        Self::IInteractiveSessionStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).IsRemote)(
    ...
    fn IInteractiveSessionStatics<
        R,
        F: FnOnce(&IInteractiveSessionStatics) -> windows_core::Result<R>,
    >(
        callback: F,

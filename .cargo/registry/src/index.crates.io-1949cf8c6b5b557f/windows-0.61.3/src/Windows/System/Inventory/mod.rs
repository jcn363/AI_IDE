windows_core::imp::define_interface!(
    ...
    IInstalledDesktopApp_Vtbl,
    0x75eab8ed_c0bc_5364_4c28_166e0545167a
);
...
pub struct IInstalledDesktopApp_Vtbl {
    ...
    pub DisplayVersion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IInstalledDesktopAppStatics_Vtbl,
...
pub struct IInstalledDesktopAppStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetInventoryAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl InstalledDesktopApp {
    ...
    pub fn DisplayVersion(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DisplayVersion)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn GetInventoryAsync() -> windows_core::Result<
        windows_future::IAsyncOperation<windows_collections::IVectorView<InstalledDesktopApp>>,
    > {
        Self::IInstalledDesktopAppStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetInventoryAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    fn IInstalledDesktopAppStatics<
        R,
        F: FnOnce(&IInstalledDesktopAppStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for InstalledDesktopApp {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInstalledDesktopApp>();
}

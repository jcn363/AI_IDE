...
impl DiagnosticActionResult {
    ...
    pub fn Results(&self) -> windows_core::Result<super::super::Foundation::Collections::ValueSet> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Results)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
...
impl windows_core::RuntimeType for DiagnosticActionResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDiagnosticActionResult>();
}
...
impl windows_core::RuntimeType for DiagnosticActionState {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.Diagnostics.DiagnosticActionState;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl DiagnosticInvoker {
    ...
    pub fn RunDiagnosticActionAsync<P0>(
        &self,
        context: P0,
    ) -> windows_core::Result<
        windows_future::IAsyncOperationWithProgress<DiagnosticActionResult, DiagnosticActionState>,
    >
    where
        P0: windows_core::Param<super::super::Data::Json::JsonObject>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RunDiagnosticActionAsync)(
                windows_core::Interface::as_raw(this),
                context.param().abi(),
                &mut result__,
            )
    ...
    pub fn RunDiagnosticActionFromStringAsync(
        &self,
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RunDiagnosticActionFromStringAsync)(
                windows_core::Interface::as_raw(this),
    ...
    fn IDiagnosticInvokerStatics<
        R,
        F: FnOnce(&IDiagnosticInvokerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for DiagnosticInvoker {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDiagnosticInvoker>();
}
...
windows_core::imp::define_interface!(
    ...
    0xc265a296_e73b_4097_b28f_3442f03dd831
);
...
windows_core::imp::define_interface!(
    IDiagnosticInvoker,
    IDiagnosticInvoker_Vtbl,
    0x187b270a_02e3_4f86_84fc_fdd892b5940f
);
...
pub struct IDiagnosticInvoker_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Data_Json")]
    pub RunDiagnosticActionAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IDiagnosticInvoker2,
    IDiagnosticInvoker2_Vtbl,
    0xe3bf945c_155a_4b52_a8ec_070c44f95000
);
...
pub struct IDiagnosticInvoker2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RunDiagnosticActionFromStringAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IDiagnosticInvokerStatics,
    IDiagnosticInvokerStatics_Vtbl,
    0x5cfad8de_f15c_4554_a813_c113c3881b09
);
...
windows_core::imp::define_interface!(
    IProcessCpuUsage,
    IProcessCpuUsage_Vtbl,
    0x0bbb2472_c8bf_423a_a810_b559ae4354e2
);
...
windows_core::imp::define_interface!(
    ...
    IProcessCpuUsageReport_Vtbl,
    0x8a6d9cac_3987_4e2f_a119_6b5fa214f1b4
);
...
pub struct IProcessCpuUsageReport_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub KernelTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub UserTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IProcessDiagnosticInfo_Vtbl,
    0xe830b04b_300e_4ee6_a0ab_5b5f5231b434
);
...
pub struct IProcessDiagnosticInfo_Vtbl {
    ...
    pub ExecutableFileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub ProcessStartTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::DateTime,
    ) -> windows_core::HRESULT,
    pub DiskUsage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub MemoryUsage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IProcessDiagnosticInfo2_Vtbl,
    0x9558cb1a_3d0b_49ec_ab70_4f7a112805de
);
...
pub struct IProcessDiagnosticInfo2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetAppDiagnosticInfos: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsPackaged:
...
windows_core::imp::define_interface!(
    ...
    IProcessDiagnosticInfoStatics_Vtbl,
    0x2f41b260_b49f_428c_aa0e_84744f49ca95
);
...
pub struct IProcessDiagnosticInfoStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetForProcesses: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetForCurrentProcess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IProcessDiagnosticInfoStatics2_Vtbl,
    0x4a869897_9899_4a44_a29b_091663be09b6
);
...
pub struct IProcessDiagnosticInfoStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub TryGetForProcessId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IProcessDiskUsage,
    IProcessDiskUsage_Vtbl,
    0x5ad78bfd_7e51_4e53_bfaa_5a6ee1aabbf8
);
...
windows_core::imp::define_interface!(
    ...
    IProcessDiskUsageReport_Vtbl,
    0x401627fd_535d_4c1f_81b8_da54e1be635e
);
...
pub struct IProcessDiskUsageReport_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ReadOperationCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub WriteOperationCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub OtherOperationCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub BytesReadCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub BytesWrittenCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub OtherBytesCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IProcessMemoryUsage,
    IProcessMemoryUsage_Vtbl,
    0xf50b229b_827c_42b7_b07c_0e32627e6b3e
);
...
windows_core::imp::define_interface!(
    ...
    IProcessMemoryUsageReport_Vtbl,
    0xc2c77cba_1951_4685_8532_7e749ecf8eeb
);
...
pub struct IProcessMemoryUsageReport_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub NonPagedPoolSizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub PageFaultCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub PageFileSizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub PagedPoolSizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub PeakNonPagedPoolSizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub PeakPageFileSizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub PeakPagedPoolSizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub PeakVirtualMemorySizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub PeakWorkingSetSizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub PrivatePageCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub VirtualMemorySizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub WorkingSetSizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISystemCpuUsage,
    ISystemCpuUsage_Vtbl,
    0x6037b3ac_02d6_4234_8362_7fe3adc81f5f
);
...
windows_core::imp::define_interface!(
    ...
    ISystemCpuUsageReport_Vtbl,
    0x2c26d0b2_9483_4f62_ab57_82b29d9719b8
);
...
pub struct ISystemCpuUsageReport_Vtbl {
    ...
    pub IdleTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ISystemDiagnosticInfo_Vtbl,
    0xa290fe05_dff3_407f_9a1b_0b2b317ca800
);
...
windows_core::imp::define_interface!(
    ...
    ISystemDiagnosticInfoStatics_Vtbl,
    0xd404ac21_fc7d_45f0_9a3f_39203aed9f7e
);
...
pub struct ISystemDiagnosticInfoStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetForCurrentSystem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ISystemDiagnosticInfoStatics2_Vtbl,
    0x79ded189_6af9_4da9_a422_15f73255b3eb
);
...
pub struct ISystemDiagnosticInfoStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsArchitectureSupported: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::ProcessorArchitecture,
        *mut bool,
    ) -> windows_core::HRESULT,
    pub PreferredArchitecture: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::ProcessorArchitecture,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISystemMemoryUsage,
    ISystemMemoryUsage_Vtbl,
    0x17ffc595_1702_49cf_aa27_2f0a32591404
);
...
windows_core::imp::define_interface!(
    ...
    ISystemMemoryUsageReport_Vtbl,
    0x38663c87_2a9f_403a_bd19_2cf3e8169500
);
...
pub struct ISystemMemoryUsageReport_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub TotalPhysicalSizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub AvailableSizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub CommittedSizeInBytes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl ProcessCpuUsage {
    pub fn GetReport(&self) -> windows_core::Result<ProcessCpuUsageReport> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetReport)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for ProcessCpuUsage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IProcessCpuUsage>();
}
...
impl ProcessCpuUsageReport {
    pub fn KernelTime(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).KernelTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn UserTime(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UserTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for ProcessCpuUsageReport {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IProcessCpuUsageReport>();
}
...
impl ProcessDiagnosticInfo {
    ...
    pub fn ExecutableFileName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ExecutableFileName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn ProcessStartTime(&self) -> windows_core::Result<super::super::Foundation::DateTime> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ProcessStartTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn DiskUsage(&self) -> windows_core::Result<ProcessDiskUsage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DiskUsage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn MemoryUsage(&self) -> windows_core::Result<ProcessMemoryUsage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MemoryUsage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CpuUsage(&self) -> windows_core::Result<ProcessCpuUsage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CpuUsage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetAppDiagnosticInfos(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<super::AppDiagnosticInfo>> {
        let this = &windows_core::Interface::cast::<IProcessDiagnosticInfo2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAppDiagnosticInfos)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn IsPackaged(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsPackaged)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetForProcesses(
    ) -> windows_core::Result<windows_collections::IVectorView<ProcessDiagnosticInfo>> {
        Self::IProcessDiagnosticInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForProcesses)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetForCurrentProcess() -> windows_core::Result<ProcessDiagnosticInfo> {
        Self::IProcessDiagnosticInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentProcess)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn TryGetForProcessId(processid: u32) -> windows_core::Result<ProcessDiagnosticInfo> {
        Self::IProcessDiagnosticInfoStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetForProcessId)(
                windows_core::Interface::as_raw(this),
                processid,
                &mut result__,
            )
    ...
    fn IProcessDiagnosticInfoStatics<
        R,
        F: FnOnce(&IProcessDiagnosticInfoStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IProcessDiagnosticInfoStatics2<
        R,
        F: FnOnce(&IProcessDiagnosticInfoStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for ProcessDiagnosticInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IProcessDiagnosticInfo>();
}
...
impl windows_core::RuntimeType for ProcessDiskUsage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IProcessDiskUsage>();
}
...
impl ProcessDiskUsageReport {
    pub fn ReadOperationCount(&self) -> windows_core::Result<i64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReadOperationCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn WriteOperationCount(&self) -> windows_core::Result<i64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WriteOperationCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn OtherOperationCount(&self) -> windows_core::Result<i64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).OtherOperationCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn BytesReadCount(&self) -> windows_core::Result<i64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BytesReadCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn BytesWrittenCount(&self) -> windows_core::Result<i64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BytesWrittenCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn OtherBytesCount(&self) -> windows_core::Result<i64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).OtherBytesCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for ProcessDiskUsageReport {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IProcessDiskUsageReport>();
}
...
impl windows_core::RuntimeType for ProcessMemoryUsage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IProcessMemoryUsage>();
}
...
impl ProcessMemoryUsageReport {
    pub fn NonPagedPoolSizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NonPagedPoolSizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PageFaultCount(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PageFaultCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PageFileSizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PageFileSizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PagedPoolSizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PagedPoolSizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PeakNonPagedPoolSizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PeakNonPagedPoolSizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PeakPageFileSizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PeakPageFileSizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PeakPagedPoolSizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PeakPagedPoolSizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PeakVirtualMemorySizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PeakVirtualMemorySizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PeakWorkingSetSizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PeakWorkingSetSizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PrivatePageCount(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PrivatePageCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn VirtualMemorySizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).VirtualMemorySizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn WorkingSetSizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WorkingSetSizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for ProcessMemoryUsageReport {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IProcessMemoryUsageReport>();
}
...
impl windows_core::RuntimeType for SystemCpuUsage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISystemCpuUsage>();
}
...
impl SystemCpuUsageReport {
    ...
    pub fn IdleTime(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IdleTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for SystemCpuUsageReport {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISystemCpuUsageReport>();
}
...
impl SystemDiagnosticInfo {
    ...
    pub fn GetForCurrentSystem() -> windows_core::Result<SystemDiagnosticInfo> {
        Self::ISystemDiagnosticInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentSystem)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn IsArchitectureSupported(
        r#type: super::ProcessorArchitecture,
    ) -> windows_core::Result<bool> {
        Self::ISystemDiagnosticInfoStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsArchitectureSupported)(
                windows_core::Interface::as_raw(this),
                r#type,
                &mut result__,
            )
    ...
    pub fn PreferredArchitecture() -> windows_core::Result<super::ProcessorArchitecture> {
        Self::ISystemDiagnosticInfoStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PreferredArchitecture)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    fn ISystemDiagnosticInfoStatics<
        R,
        F: FnOnce(&ISystemDiagnosticInfoStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn ISystemDiagnosticInfoStatics2<
        R,
        F: FnOnce(&ISystemDiagnosticInfoStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for SystemDiagnosticInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISystemDiagnosticInfo>();
}
...
impl windows_core::RuntimeType for SystemMemoryUsage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISystemMemoryUsage>();
}
...
impl SystemMemoryUsageReport {
    pub fn TotalPhysicalSizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TotalPhysicalSizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn AvailableSizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AvailableSizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CommittedSizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CommittedSizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for SystemMemoryUsageReport {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISystemMemoryUsageReport>();
}

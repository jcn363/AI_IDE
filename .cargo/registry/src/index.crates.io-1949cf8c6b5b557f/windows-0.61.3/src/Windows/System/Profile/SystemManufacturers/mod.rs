windows_core::imp::define_interface!(
    IOemSupportInfo,
    IOemSupportInfo_Vtbl,
    0x8d2eae55_87ef_4266_86d0_c4afbeb29bb9
);
...
pub struct IOemSupportInfo_Vtbl {
    ...
    pub SupportLink: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SupportAppLink: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SupportProvider: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ISmbiosInformationStatics_Vtbl,
    0x080cca7c_637c_48c4_b728_f9273812db8e
);
...
windows_core::imp::define_interface!(
    ...
    0x05880b99_8247_441b_a996_a1784bab79a8
);
...
windows_core::imp::define_interface!(
    ...
    ISystemSupportInfoStatics_Vtbl,
    0xef750974_c422_45d7_a44d_5c1c0043a2b3
);
...
pub struct ISystemSupportInfoStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub LocalSystemEdition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OemSupportInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ISystemSupportInfoStatics2_Vtbl,
    0x33f349a4_3fa1_4986_aa4b_057420455e6d
);
...
pub struct ISystemSupportInfoStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub LocalDeviceInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl OemSupportInfo {
    pub fn SupportLink(&self) -> windows_core::Result<super::super::super::Foundation::Uri> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).SupportLink)(
    ...
    pub fn SupportAppLink(&self) -> windows_core::Result<super::super::super::Foundation::Uri> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportAppLink)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SupportProvider(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportProvider)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
...
impl windows_core::RuntimeType for OemSupportInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOemSupportInfo>();
}
...
impl SmbiosInformation {
    ...
    fn ISmbiosInformationStatics<
        R,
        F: FnOnce(&ISmbiosInformationStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for SystemSupportDeviceInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISystemSupportDeviceInfo>();
}
...
impl SystemSupportInfo {
    pub fn LocalSystemEdition() -> windows_core::Result<windows_core::HSTRING> {
        Self::ISystemSupportInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LocalSystemEdition)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn OemSupportInfo() -> windows_core::Result<OemSupportInfo> {
        Self::ISystemSupportInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).OemSupportInfo)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn LocalDeviceInfo() -> windows_core::Result<SystemSupportDeviceInfo> {
        Self::ISystemSupportInfoStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LocalDeviceInfo)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn ISystemSupportInfoStatics<
        R,
        F: FnOnce(&ISystemSupportInfoStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn ISystemSupportInfoStatics2<
        R,
        F: FnOnce(&ISystemSupportInfoStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<

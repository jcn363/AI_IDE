...
pub struct IThreadPoolStatics_Vtbl {
    ...
    pub RunWithPriorityAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WorkItemPriority,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IThreadPoolTimer,
    IThreadPoolTimer_Vtbl,
    0x594ebe78_55ea_4a88_a50d_3402ae1f9cf2
);
...
windows_core::imp::define_interface!(
    ...
    IThreadPoolTimerStatics_Vtbl,
    0x1a8a9d02_e482_461b_b8c7_8efad1cce590
);
...
pub struct IThreadPoolTimerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreatePeriodicTimer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub CreatePeriodicTimerWithCompletion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::Foundation::TimeSpan,
        *mut core::ffi::c_void,
    ...
    pub CreateTimerWithCompletion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::Foundation::TimeSpan,
        *mut core::ffi::c_void,
...
impl ThreadPool {
    ...
    pub fn RunWithPriorityAsync<P0>(
        handler: P0,
        ...
        P0: windows_core::Param<WorkItemHandler>,
    {
        Self::IThreadPoolStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RunWithPriorityAsync)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                priority,
                &mut result__,
...
impl ThreadPoolTimer {
    ...
    pub fn CreatePeriodicTimerWithCompletion<P0, P2>(
        handler: P0,
        period: super::super::Foundation::TimeSpan,
        destroyed: P2,
    ) -> windows_core::Result<ThreadPoolTimer>
        ...
        P2: windows_core::Param<TimerDestroyedHandler>,
    {
        Self::IThreadPoolTimerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreatePeriodicTimerWithCompletion)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                period,
                destroyed.param().abi(),
    ...
    pub fn CreateTimerWithCompletion<P0, P2>(
        handler: P0,
        delay: super::super::Foundation::TimeSpan,
        destroyed: P2,
    ) -> windows_core::Result<ThreadPoolTimer>
        ...
        P2: windows_core::Param<TimerDestroyedHandler>,
    {
        Self::IThreadPoolTimerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateTimerWithCompletion)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                delay,
                destroyed.param().abi(),
    ...
    fn IThreadPoolTimerStatics<
        R,
        F: FnOnce(&IThreadPoolTimerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ThreadPoolTimer, IThreadPoolTimerStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for ThreadPoolTimer {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IThreadPoolTimer>();
}
...
windows_core::imp::define_interface!(
    ...
    TimerDestroyedHandler_Vtbl,
    0x34ed19fa_8384_4eb9_8209_fb5094eeec35
);
...
impl TimerDestroyedHandler {
    pub fn new<
        F: FnMut(windows_core::Ref<'_, ThreadPoolTimer>) -> windows_core::Result<()> + Send + 'static,
    >(
        invoke: F,
    ) -> Self {
        let com = TimerDestroyedHandlerBox {
            vtable: &TimerDestroyedHandlerBox::<F>::VTABLE,
...
#[repr(C)]
struct TimerDestroyedHandlerBox<
    F: FnMut(windows_core::Ref<'_, ThreadPoolTimer>) -> windows_core::Result<()> + Send + 'static,
> {
    ...
    > TimerDestroyedHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <TimerDestroyedHandler as windows_core::Interface>::IID
...
windows_core::imp::define_interface!(
    TimerElapsedHandler,
    TimerElapsedHandler_Vtbl,
    0xfaaea667_fbeb_49cb_adb2_71184c556e43
);
...
impl TimerElapsedHandler {
    ...
    >(
        ...
        let com = TimerElapsedHandlerBox {
            vtable: &TimerElapsedHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
    ...
    > TimerElapsedHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <TimerElapsedHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _
...
windows_core::imp::define_interface!(
    WorkItemHandler,
    WorkItemHandler_Vtbl,
    0x1d1a8b8b_fa66_414f_9cbd_b65fc99d17fa
);
...
impl WorkItemHandler {
    pub fn new<
        F: FnMut(windows_core::Ref<'_, windows_future::IAsyncAction>) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        invoke: F,
    ) -> Self {
        let com = WorkItemHandlerBox {
            vtable: &WorkItemHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
    ...
    > WorkItemHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <WorkItemHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _

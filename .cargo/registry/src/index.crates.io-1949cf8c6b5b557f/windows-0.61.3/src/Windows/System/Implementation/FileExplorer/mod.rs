windows_core::imp::define_interface!(
    ...
    ISysStorageProviderEventReceivedEventArgs_Vtbl,
    0xe132d1b9_7b9d_5820_9728_4262b5289142
);
...
pub struct ISysStorageProviderEventReceivedEventArgs_Vtbl {
    ...
    pub Json: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    ISysStorageProviderEventReceivedEventArgsFactory_Vtbl,
    0xde1a780e_e975_5f68_bcc6_fb46281c6a61
);
...
windows_core::imp::define_interface!(
    ...
    0x1f36c476_9546_536a_8381_2f9a2c08cedd
);
...
impl ISysStorageProviderEventSource {
        ...
        >,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).EventReceived)(
    ...
    pub fn RemoveEventReceived(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveEventReceived)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl ISysStorageProviderEventSource_Vtbl {
    pub const fn new<Identity: ISysStorageProviderEventSource_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn EventReceived<
        ...
        >(
            ...
            unsafe {
                ...
                match ISysStorageProviderEventSource_Impl::EventReceived(
                    this,
...
pub struct ISysStorageProviderEventSource_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub EventReceived: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveEventReceived:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISysStorageProviderHandlerFactory,
    ISysStorageProviderHandlerFactory_Vtbl,
    0xee798431_8213_5e89_a623_14d8c72b8a61
);
...
impl ISysStorageProviderHandlerFactory {
    pub fn GetHttpRequestProvider(
        &self,
        syncrootid: &windows_core::HSTRING,
    ) -> windows_core::Result<ISysStorageProviderHttpRequestProvider> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetHttpRequestProvider)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn GetEventSource(
        &self,
        syncrootid: &windows_core::HSTRING,
        eventname: &windows_core::HSTRING,
    ) -> windows_core::Result<ISysStorageProviderEventSource> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetEventSource)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(syncrootid),
...
impl ISysStorageProviderHandlerFactory_Vtbl {
    ...
    {
        unsafe extern "system" fn GetHttpRequestProvider<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISysStorageProviderHandlerFactory_Impl::GetHttpRequestProvider(
                    this,
        ...
        unsafe extern "system" fn GetEventSource<
            Identity: ISysStorageProviderHandlerFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISysStorageProviderHandlerFactory_Impl::GetEventSource(
                    this,
                    core::mem::transmute(&syncrootid),
...
pub struct ISysStorageProviderHandlerFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetHttpRequestProvider: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetEventSource: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xcb6fefb6_e76a_5c25_a33e_3e78a6e0e0ce
);
...
impl ISysStorageProviderHttpRequestProvider {
    ...
    pub fn SendRequestAsync<P0>(
        ...
        windows_future::IAsyncOperation<super::super::super::Web::Http::HttpResponseMessage>,
    >
    where
...
pub trait ISysStorageProviderHttpRequestProvider_Impl: windows_core::IUnknownImpl {
    fn SendRequestAsync(
        &self,
        request: windows_core::Ref<'_, super::super::super::Web::Http::HttpRequestMessage>,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<super::super::super::Web::Http::HttpResponseMessage>,
    >;
}
...
impl ISysStorageProviderHttpRequestProvider_Vtbl {
    pub const fn new<Identity: ISysStorageProviderHttpRequestProvider_Impl, const OFFSET: isize>(
    ) -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISysStorageProviderHttpRequestProvider_Impl::SendRequestAsync(
                    this,
...
impl SysStorageProviderEventReceivedEventArgs {
    pub fn Json(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Json)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    ) -> windows_core::Result<SysStorageProviderEventReceivedEventArgs> {
    ...
    fn ISysStorageProviderEventReceivedEventArgsFactory<
        R,
        F: FnOnce(&ISysStorageProviderEventReceivedEventArgsFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
unsafe impl windows_core::Interface for SysStorageProviderEventReceivedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ISysStorageProviderEventReceivedEventArgs as windows_core::Interface>::IID;
}

windows_core::imp::define_interface!(
    ...
    IKnownRemoteSystemCapabilitiesStatics_Vtbl,
    0x8108e380_7f8a_44e4_92cd_03b6469b94a3
);
...
pub struct IKnownRemoteSystemCapabilitiesStatics_Vtbl {
    ...
    pub AppService: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub RemoteSession: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SpatialEntity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteSystem,
    IRemoteSystem_Vtbl,
    0xed5838cd_1e10_4a8c_b4a6_4e5fd6f97721
);
...
pub struct IRemoteSystem_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RemoteSystemStatus,
    ) -> windows_core::HRESULT,
    pub IsAvailableByProximity:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteSystem2,
    IRemoteSystem2_Vtbl,
    0x09dfe4ec_fb8b_4a08_a758_6876435d769e
);
...
pub struct IRemoteSystem2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsAvailableBySpatialProximity:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub GetCapabilitySupportedAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IRemoteSystem3,
    IRemoteSystem3_Vtbl,
    0x72b4b495_b7c6_40be_831b_73562f12ffa8
);
...
pub struct IRemoteSystem3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ManufacturerDisplayName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ModelDisplayName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteSystem4,
    IRemoteSystem4_Vtbl,
    0xf164ffe5_b987_4ca5_9926_fa0438be6273
);
...
pub struct IRemoteSystem4_Vtbl {
    ...
    pub Platform: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RemoteSystemPlatform,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteSystem5,
    IRemoteSystem5_Vtbl,
    0xeb2ad723_e5e2_4ae2_a7a7_a1097a098e90
);
...
pub struct IRemoteSystem5_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Apps: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteSystem6,
    IRemoteSystem6_Vtbl,
    0xd4cda942_c027_533e_9384_3a19b4f7eef3
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemAddedEventArgs_Vtbl,
    0x8f39560f_e534_4697_8836_7abea151516e
);
...
pub struct IRemoteSystemAddedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RemoteSystem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteSystemApp,
    IRemoteSystemApp_Vtbl,
    0x80e5bcbd_d54d_41b1_9b16_6810a871ed4f
);
...
windows_core::imp::define_interface!(
    IRemoteSystemApp2,
    IRemoteSystemApp2_Vtbl,
    0x6369bf15_0a96_577a_8ff6_c35904dfa8f3
);
...
pub struct IRemoteSystemApp2_Vtbl {
    ...
    pub ConnectionToken: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0xb47947b5_7035_4a5a_b8df_962d8f8431f4
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemAppRegistrationStatics_Vtbl,
    0x01b99840_cfd2_453f_ae25_c2539f086afd
);
...
windows_core::imp::define_interface!(
    ...
    0x6b0dde8e_04d0_40f4_a27f_c2acbbd6b734
);
...
pub struct IRemoteSystemAuthorizationKindFilter_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RemoteSystemAuthorizationKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RemoteSystemAuthorizationKind,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteSystemAuthorizationKindFilterFactory,
    IRemoteSystemAuthorizationKindFilterFactory_Vtbl,
    0xad65df4d_b66a_45a4_8177_8caed75d9e5a
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemConnectionInfo_Vtbl,
    0x23278bc3_0d09_52cb_9c6a_eed2940bee43
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemConnectionInfoStatics_Vtbl,
    0xac831e2d_66c5_56d7_a4ce_705d94925ad6
);
...
pub struct IRemoteSystemConnectionInfoStatics_Vtbl {
    ...
    pub TryCreateFromAppServiceConnection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemConnectionRequest_Vtbl,
    0x84ed4104_8d5e_4d72_8238_7621576c7a67
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemConnectionRequest2_Vtbl,
    0x12df6d6f_bffc_483a_8abe_d34a6c19f92b
);
...
pub struct IRemoteSystemConnectionRequest2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RemoteSystemApp: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRemoteSystemConnectionRequest3_Vtbl,
    0xde86c3e7_c9cc_5a50_b8d9_ba7b34bb8d0e
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemConnectionRequestFactory_Vtbl,
    0xaa0a0a20_baeb_4575_b530_810bb9786334
);
...
pub struct IRemoteSystemConnectionRequestStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateForApp: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemConnectionRequestStatics2_Vtbl,
    0x460f1027_64ec_598e_a800_4f2ee58def19
);
...
pub struct IRemoteSystemConnectionRequestStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateFromConnectionToken: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateFromConnectionTokenForUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemDiscoveryTypeFilter_Vtbl,
    0x42d9041f_ee5a_43da_ac6a_6fee25460741
);
...
pub struct IRemoteSystemDiscoveryTypeFilter_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RemoteSystemDiscoveryType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RemoteSystemDiscoveryType,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteSystemDiscoveryTypeFilterFactory,
    IRemoteSystemDiscoveryTypeFilterFactory_Vtbl,
    0x9f9eb993_c260_4161_92f2_9c021f23fe5d
);
...
windows_core::imp::define_interface!(
    IRemoteSystemFilter,
    IRemoteSystemFilter_Vtbl,
    0x4a3ba9e4_99eb_45eb_ba16_0367728ff374
);
...
impl IRemoteSystemFilter_Vtbl {
    pub const fn new<Identity: IRemoteSystemFilter_Impl, const OFFSET: isize>() -> Self {
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IRemoteSystemFilter, OFFSET>(),
        }
    }
...
windows_core::imp::define_interface!(
    ...
    0x38e1c9ec_22c3_4ef6_901a_bbb1c7aad4ed
);
...
pub struct IRemoteSystemKindFilter_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RemoteSystemKinds: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRemoteSystemKindFilterFactory_Vtbl,
    0xa1fb18ee_99ea_40bc_9a39_c670aa804a28
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemKindStatics_Vtbl,
    0xf6317633_ab14_41d0_9553_796aadb882db
);
...
pub struct IRemoteSystemKindStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Phone: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Hub: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Holographic: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub Xbox: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRemoteSystemKindStatics2_Vtbl,
    0xb9e3a3d0_0466_4749_91e8_65f9d19a96a5
);
...
pub struct IRemoteSystemKindStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Iot: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Tablet: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Laptop: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRemoteSystemRemovedEventArgs_Vtbl,
    0x8b3d16bb_7306_49ea_b7df_67d5714cb013
);
...
pub struct IRemoteSystemRemovedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RemoteSystemId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSession_Vtbl,
    0x69476a01_9ada_490f_9549_d31cb14c9e95
);
...
pub struct IRemoteSystemSession_Vtbl {
    ...
    pub ControllerDisplayName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Disconnected: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveDisconnected:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub CreateParticipantWatcher: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SendInvitationAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionAddedEventArgs_Vtbl,
    0xd585d754_bc97_4c39_99b4_beca76e04c3f
);
...
pub struct IRemoteSystemSessionAddedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SessionInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0xe48b2dd2_6820_4867_b425_d89c0a3ef7ba
);
...
pub struct IRemoteSystemSessionController_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub JoinRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveJoinRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub RemoveParticipantAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateSessionAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionControllerFactory_Vtbl,
    0xbfcc2f6b_ac3d_4199_82cd_6670a773ef2e
);
...
pub struct IRemoteSystemSessionControllerFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateController: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateControllerWithSessionOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionCreationResult_Vtbl,
    0xa79812c2_37de_448c_8b83_a30aa3c4ead6
);
...
pub struct IRemoteSystemSessionCreationResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RemoteSystemSessionCreationStatus,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionDisconnectedEventArgs_Vtbl,
...
pub struct IRemoteSystemSessionDisconnectedEventArgs_Vtbl {
    ...
    pub Reason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RemoteSystemSessionDisconnectedReason,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
...
pub struct IRemoteSystemSessionInfo_Vtbl {
    ...
    pub JoinAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionInvitation_Vtbl,
    0x3e32cc91_51d7_4766_a121_25516c3b8294
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionInvitationListener_Vtbl,
    0x08f4003f_bc71_49e1_874a_31ddff9a27b9
);
...
pub struct IRemoteSystemSessionInvitationListener_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub InvitationReceived: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x5e964a2d_a10d_4edb_8dea_54d20ac19543
);
...
windows_core::imp::define_interface!(
    ...
    0xdbca4fc3_82b9_4816_9c24_e40e61774bd8
);
...
pub struct IRemoteSystemSessionJoinRequestedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub JoinRequest: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionJoinResult_Vtbl,
    0xce7b1f04_a03e_41a4_900b_1e79328c1267
);
...
pub struct IRemoteSystemSessionJoinResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RemoteSystemSessionJoinStatus,
    ) -> windows_core::HRESULT,
    pub Session: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionMessageChannel_Vtbl,
    0x9524d12a_73d9_4c10_b751_c26784437127
);
...
pub struct IRemoteSystemSessionMessageChannel_Vtbl {
    ...
    pub BroadcastValueSetAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub SendValueSetAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub SendValueSetToParticipantsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    pub ValueSetReceived: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveValueSetReceived:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteSystemSessionMessageChannelFactory,
    IRemoteSystemSessionMessageChannelFactory_Vtbl,
    0x295e1c4a_bd16_4298_b7ce_415482b0e11d
);
...
pub struct IRemoteSystemSessionMessageChannelFactory_Vtbl {
    ...
    pub CreateWithReliability: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionOptions_Vtbl,
    0x740ed755_8418_4f01_9353_e21c9ecc6cfc
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionParticipant_Vtbl,
    0x7e90058c_acf9_4729_8a17_44e7baed5dcc
);
...
pub struct IRemoteSystemSessionParticipant_Vtbl {
    ...
    pub GetHostNames: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionParticipantAddedEventArgs_Vtbl,
    0xd35a57d8_c9a1_4bb7_b6b0_79bb91adf93d
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionParticipantRemovedEventArgs_Vtbl,
    0x866ef088_de68_4abf_88a1_f90d16274192
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionParticipantWatcher_Vtbl,
    0xdcdd02cc_aa87_4d79_b6cc_4459b3e92075
);
...
pub struct IRemoteSystemSessionParticipantWatcher_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RemoteSystemSessionParticipantWatcherStatus,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0xaf82914e_39a1_4dea_9d63_43798d5bbbd0
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionStatics_Vtbl,
    0x8524899f_fd20_44e3_9565_e75a3b14c66e
);
...
windows_core::imp::define_interface!(
    ...
    0x16875069_231e_4c91_8ec8_b3a39d9e55a3
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionValueSetReceivedEventArgs_Vtbl,
    0x06f31785_2da5_4e58_a78f_9e8d0784ee25
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemSessionWatcher_Vtbl,
    0x8003e340_0c41_4a62_b6d7_bdbe2b19be2d
);
...
pub struct IRemoteSystemSessionWatcher_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RemoteSystemSessionWatcherStatus,
    ) -> windows_core::HRESULT,
    pub Added: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemStatics_Vtbl,
    0xa485b392_ff2b_4b47_be62_743f2f140f30
);
...
pub struct IRemoteSystemStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Networking")]
    pub FindByHostNameAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub CreateWatcherWithFilters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemStatics2_Vtbl,
    0x0c98edca_6f99_4c52_a272_ea4f36471744
);
...
pub struct IRemoteSystemStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsAuthorizationKindEnabled: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        RemoteSystemAuthorizationKind,
        *mut bool,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x9995f16f_0b3c_5ac5_b325_cc73f437dfcd
);
...
pub struct IRemoteSystemStatics3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateWatcherForUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateWatcherWithFiltersForUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemStatusTypeFilter_Vtbl,
    0x0c39514e_cbb6_4777_8534_2e0c521affa2
);
...
pub struct IRemoteSystemStatusTypeFilter_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RemoteSystemStatusType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RemoteSystemStatusType,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteSystemStatusTypeFilterFactory,
    IRemoteSystemStatusTypeFilterFactory_Vtbl,
    0x33cf78fa_d724_4125_ac7a_8d281e44c949
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemUpdatedEventArgs_Vtbl,
    0x7502ff0e_dbcb_4155_b4ca_b30a04f27627
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemWatcher_Vtbl,
    0x5d600c7e_2c07_48c5_889c_455d2b099771
);
...
pub struct IRemoteSystemWatcher_Vtbl {
    ...
    pub Start: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Stop: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub RemoteSystemAdded: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRemoteSystemAdded:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub RemoteSystemUpdated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRemoteSystemUpdated:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub RemoteSystemRemoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRemoteSystemRemoved:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteSystemWatcher2,
    IRemoteSystemWatcher2_Vtbl,
    0x73436700_19ca_48f9_a4cd_780f7ad58c71
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemWatcher3_Vtbl,
    0xf79c0fcf_a913_55d3_8413_418fcf15ba54
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemWatcherErrorOccurredEventArgs_Vtbl,
    0x74c5c6af_5114_4426_9216_20d81f8519ae
);
...
pub struct IRemoteSystemWatcherErrorOccurredEventArgs_Vtbl {
    ...
    pub Error: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RemoteSystemWatcherError,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteSystemWebAccountFilter,
    IRemoteSystemWebAccountFilter_Vtbl,
    0x3fb75873_87c8_5d8f_977e_f69f96d67238
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteSystemWebAccountFilterFactory_Vtbl,
    0x348a2709_5f4d_5127_b4a7_bf99d5252b1b
);
...
impl KnownRemoteSystemCapabilities {
    pub fn AppService() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownRemoteSystemCapabilitiesStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).AppService)(
    ...
    pub fn RemoteSession() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownRemoteSystemCapabilitiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteSession)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SpatialEntity() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownRemoteSystemCapabilitiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SpatialEntity)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    fn IKnownRemoteSystemCapabilitiesStatics<
        R,
        F: FnOnce(&IKnownRemoteSystemCapabilitiesStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl RemoteSystem {
    ...
    pub fn IsAvailableByProximity(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsAvailableByProximity)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsAvailableBySpatialProximity(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsAvailableBySpatialProximity)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetCapabilitySupportedAsync(
        &self,
        capabilityname: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<bool>> {
        let this = &windows_core::Interface::cast::<IRemoteSystem2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCapabilitySupportedAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(capabilityname),
                &mut result__,
            )
    ...
    pub fn ManufacturerDisplayName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ManufacturerDisplayName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn ModelDisplayName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ModelDisplayName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn Apps(&self) -> windows_core::Result<windows_collections::IVectorView<RemoteSystemApp>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Apps)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn FindByHostNameAsync<P0>(
        hostname: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<RemoteSystem>>
    where
        P0: windows_core::Param<super::super::Networking::HostName>,
    {
        Self::IRemoteSystemStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindByHostNameAsync)(
                windows_core::Interface::as_raw(this),
                hostname.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<windows_collections::IIterable<IRemoteSystemFilter>>,
    {
        Self::IRemoteSystemStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWatcherWithFilters)(
                windows_core::Interface::as_raw(this),
                filters.param().abi(),
                &mut result__,
            )
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<RemoteSystemAccessStatus>> {
        Self::IRemoteSystemStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsAuthorizationKindEnabled(
        ...
        Self::IRemoteSystemStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsAuthorizationKindEnabled)(
                windows_core::Interface::as_raw(this),
                kind,
                &mut result__,
            )
        ...
        P0: windows_core::Param<super::User>,
    {
        Self::IRemoteSystemStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWatcherForUser)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                &mut result__,
            )
    ...
    pub fn CreateWatcherWithFiltersForUser<P0, P1>(
        user: P0,
        filters: P1,
    ) -> windows_core::Result<RemoteSystemWatcher>
    where
        P0: windows_core::Param<super::User>,
        P1: windows_core::Param<windows_collections::IIterable<IRemoteSystemFilter>>,
    {
        Self::IRemoteSystemStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWatcherWithFiltersForUser)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                filters.param().abi(),
                &mut result__,
    ...
    fn IRemoteSystemStatics<R, F: FnOnce(&IRemoteSystemStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<RemoteSystem, IRemoteSystemStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IRemoteSystemStatics2<R, F: FnOnce(&IRemoteSystemStatics2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<RemoteSystem, IRemoteSystemStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IRemoteSystemStatics3<R, F: FnOnce(&IRemoteSystemStatics3) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<RemoteSystem, IRemoteSystemStatics3> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for RemoteSystem {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystem>();
}
...
impl RemoteSystemAddedEventArgs {
    pub fn RemoteSystem(&self) -> windows_core::Result<RemoteSystem> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteSystem)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for RemoteSystemAddedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemAddedEventArgs>();
}
...
impl RemoteSystemApp {
    ...
    pub fn ConnectionToken(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConnectionToken)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for RemoteSystemApp {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemApp>();
}
...
impl RemoteSystemAppRegistration {
    ...
    fn IRemoteSystemAppRegistrationStatics<
        R,
        F: FnOnce(&IRemoteSystemAppRegistrationStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteSystemAppRegistration {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemAppRegistration>();
}
...
impl RemoteSystemAuthorizationKindFilter {
    pub fn RemoteSystemAuthorizationKind(
        &self,
    ) -> windows_core::Result<RemoteSystemAuthorizationKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteSystemAuthorizationKind)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    ) -> windows_core::Result<RemoteSystemAuthorizationKindFilter> {
    ...
    fn IRemoteSystemAuthorizationKindFilterFactory<
        R,
        F: FnOnce(&IRemoteSystemAuthorizationKindFilterFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteSystemAuthorizationKindFilter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemAuthorizationKindFilter>();
}
unsafe impl windows_core::Interface for RemoteSystemAuthorizationKindFilter {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemAuthorizationKindFilter as windows_core::Interface>::IID;
}
...
impl RemoteSystemConnectionInfo {
    pub fn IsProximal(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsProximal)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    #[cfg(feature = "ApplicationModel_AppService")]
    pub fn TryCreateFromAppServiceConnection<P0>(
        connection: P0,
    ) -> windows_core::Result<RemoteSystemConnectionInfo>
    where
        P0: windows_core::Param<super::super::ApplicationModel::AppService::AppServiceConnection>,
    {
        Self::IRemoteSystemConnectionInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryCreateFromAppServiceConnection)(
                windows_core::Interface::as_raw(this),
                connection.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    ...
    fn IRemoteSystemConnectionInfoStatics<
        R,
        F: FnOnce(&IRemoteSystemConnectionInfoStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteSystemConnectionInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemConnectionInfo>();
}
...
impl RemoteSystemConnectionRequest {
    ...
    pub fn RemoteSystemApp(&self) -> windows_core::Result<RemoteSystemApp> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteSystemApp)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<RemoteSystem>,
    {
        Self::IRemoteSystemConnectionRequestFactory(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).Create)(
                windows_core::Interface::as_raw(this),
                remotesystem.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateForApp<P0>(
        remotesystemapp: P0,
    ) -> windows_core::Result<RemoteSystemConnectionRequest>
    where
        P0: windows_core::Param<RemoteSystemApp>,
    {
        Self::IRemoteSystemConnectionRequestStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateForApp)(
                windows_core::Interface::as_raw(this),
                remotesystemapp.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    ...
    pub fn CreateFromConnectionToken(
        connectiontoken: &windows_core::HSTRING,
    ) -> windows_core::Result<RemoteSystemConnectionRequest> {
        Self::IRemoteSystemConnectionRequestStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateFromConnectionToken)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(connectiontoken),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateFromConnectionTokenForUser<P0>(
        user: P0,
        connectiontoken: &windows_core::HSTRING,
    ) -> windows_core::Result<RemoteSystemConnectionRequest>
    where
        P0: windows_core::Param<super::User>,
    {
        Self::IRemoteSystemConnectionRequestStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateFromConnectionTokenForUser)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                core::mem::transmute_copy(connectiontoken),
                &mut result__,
    ...
    fn IRemoteSystemConnectionRequestFactory<
        R,
        F: FnOnce(&IRemoteSystemConnectionRequestFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IRemoteSystemConnectionRequestStatics<
        R,
        F: FnOnce(&IRemoteSystemConnectionRequestStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IRemoteSystemConnectionRequestStatics2<
        R,
        F: FnOnce(&IRemoteSystemConnectionRequestStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteSystemConnectionRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemConnectionRequest>();
}
unsafe impl windows_core::Interface for RemoteSystemConnectionRequest {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemConnectionRequest as windows_core::Interface>::IID;
}
...
impl RemoteSystemDiscoveryTypeFilter {
    pub fn RemoteSystemDiscoveryType(&self) -> windows_core::Result<RemoteSystemDiscoveryType> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteSystemDiscoveryType)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    ) -> windows_core::Result<RemoteSystemDiscoveryTypeFilter> {
    ...
    fn IRemoteSystemDiscoveryTypeFilterFactory<
        R,
        F: FnOnce(&IRemoteSystemDiscoveryTypeFilterFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteSystemDiscoveryTypeFilter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemDiscoveryTypeFilter>();
}
unsafe impl windows_core::Interface for RemoteSystemDiscoveryTypeFilter {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemDiscoveryTypeFilter as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for RemoteSystemEnumerationCompletedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemEnumerationCompletedEventArgs as windows_core::Interface>::IID;
}
...
impl RemoteSystemKindFilter {
    pub fn RemoteSystemKinds(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteSystemKinds)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IRemoteSystemKindFilterFactory<
        R,
        F: FnOnce(&IRemoteSystemKindFilterFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteSystemKindFilter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemKindFilter>();
}
...
impl RemoteSystemKinds {
    pub fn Phone() -> windows_core::Result<windows_core::HSTRING> {
        Self::IRemoteSystemKindStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Phone)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn Hub() -> windows_core::Result<windows_core::HSTRING> {
        Self::IRemoteSystemKindStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Hub)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn Holographic() -> windows_core::Result<windows_core::HSTRING> {
        Self::IRemoteSystemKindStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Holographic)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn Xbox() -> windows_core::Result<windows_core::HSTRING> {
        Self::IRemoteSystemKindStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Xbox)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn Iot() -> windows_core::Result<windows_core::HSTRING> {
        Self::IRemoteSystemKindStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Iot)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn Tablet() -> windows_core::Result<windows_core::HSTRING> {
        Self::IRemoteSystemKindStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Tablet)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn Laptop() -> windows_core::Result<windows_core::HSTRING> {
        Self::IRemoteSystemKindStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Laptop)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    fn IRemoteSystemKindStatics<
        R,
        F: FnOnce(&IRemoteSystemKindStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IRemoteSystemKindStatics2<
        R,
        F: FnOnce(&IRemoteSystemKindStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl RemoteSystemRemovedEventArgs {
    pub fn RemoteSystemId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteSystemId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for RemoteSystemRemovedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemRemovedEventArgs>();
}
...
impl RemoteSystemSession {
    ...
    pub fn ControllerDisplayName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ControllerDisplayName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Disconnected)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveDisconnected(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDisconnected)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn CreateParticipantWatcher(
        &self,
    ) -> windows_core::Result<RemoteSystemSessionParticipantWatcher> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateParticipantWatcher)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<RemoteSystem>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SendInvitationAsync)(
                windows_core::Interface::as_raw(this),
                invitee.param().abi(),
                &mut result__,
            )
    ...
    fn IRemoteSystemSessionStatics<
        R,
        F: FnOnce(&IRemoteSystemSessionStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteSystemSession {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSession>();
}
...
impl RemoteSystemSessionAddedEventArgs {
    pub fn SessionInfo(&self) -> windows_core::Result<RemoteSystemSessionInfo> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SessionInfo)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for RemoteSystemSessionAddedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionAddedEventArgs>();
}
unsafe impl windows_core::Interface for RemoteSystemSessionAddedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionAddedEventArgs as windows_core::Interface>::IID;
}
...
impl RemoteSystemSessionController {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).JoinRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveJoinRequested(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveJoinRequested)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn RemoveParticipantAsync<P0>(
        &self,
        pparticipant: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<RemoteSystemSessionParticipant>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoveParticipantAsync)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn CreateSessionAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<RemoteSystemSessionCreationResult>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateSessionAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    ) -> windows_core::Result<RemoteSystemSessionController> {
        Self::IRemoteSystemSessionControllerFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateController)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn CreateControllerWithSessionOptions<P1>(
        displayname: &windows_core::HSTRING,
        options: P1,
    ) -> windows_core::Result<RemoteSystemSessionController>
    where
        P1: windows_core::Param<RemoteSystemSessionOptions>,
    {
        Self::IRemoteSystemSessionControllerFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateControllerWithSessionOptions)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(displayname),
                options.param().abi(),
                &mut result__,
    ...
    fn IRemoteSystemSessionControllerFactory<
        R,
        F: FnOnce(&IRemoteSystemSessionControllerFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteSystemSessionController {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionController>();
}
unsafe impl windows_core::Interface for RemoteSystemSessionController {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionController as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for RemoteSystemSessionCreationResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionCreationResult>();
}
unsafe impl windows_core::Interface for RemoteSystemSessionCreationResult {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionCreationResult as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for RemoteSystemSessionDisconnectedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionDisconnectedEventArgs as windows_core::Interface>::IID;
}
...
impl RemoteSystemSessionInfo {
    ...
    pub fn JoinAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<RemoteSystemSessionJoinResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).JoinAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for RemoteSystemSessionInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionInfo>();
}
...
impl windows_core::RuntimeType for RemoteSystemSessionInvitation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionInvitation>();
}
unsafe impl windows_core::Interface for RemoteSystemSessionInvitation {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionInvitation as windows_core::Interface>::IID;
}
...
impl RemoteSystemSessionInvitationListener {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InvitationReceived)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveInvitationReceived(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveInvitationReceived)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for RemoteSystemSessionInvitationListener {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionInvitationListener>();
}
unsafe impl windows_core::Interface for RemoteSystemSessionInvitationListener {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionInvitationListener as windows_core::Interface>::IID;
}
...
impl RemoteSystemSessionInvitationReceivedEventArgs {
    pub fn Invitation(&self) -> windows_core::Result<RemoteSystemSessionInvitation> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Invitation)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
unsafe impl windows_core::Interface for RemoteSystemSessionInvitationReceivedEventArgs {
    type Vtable =
        <IRemoteSystemSessionInvitationReceivedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IRemoteSystemSessionInvitationReceivedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for RemoteSystemSessionJoinRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionJoinRequest>();
}
unsafe impl windows_core::Interface for RemoteSystemSessionJoinRequest {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionJoinRequest as windows_core::Interface>::IID;
}
...
impl RemoteSystemSessionJoinRequestedEventArgs {
    pub fn JoinRequest(&self) -> windows_core::Result<RemoteSystemSessionJoinRequest> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).JoinRequest)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
unsafe impl windows_core::Interface for RemoteSystemSessionJoinRequestedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionJoinRequestedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for RemoteSystemSessionJoinResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionJoinResult>();
}
unsafe impl windows_core::Interface for RemoteSystemSessionJoinResult {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionJoinResult as windows_core::Interface>::IID;
}
...
impl RemoteSystemSessionMessageChannel {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn BroadcastValueSetAsync<P0>(
        &self,
        messagedata: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<super::super::Foundation::Collections::ValueSet>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BroadcastValueSetAsync)(
                windows_core::Interface::as_raw(this),
                messagedata.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn SendValueSetAsync<P0, P1>(
        &self,
        messagedata: P0,
        participant: P1,
    ) -> windows_core::Result<windows_future::IAsyncOperation<bool>>
        ...
        P1: windows_core::Param<RemoteSystemSessionParticipant>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SendValueSetAsync)(
                windows_core::Interface::as_raw(this),
                messagedata.param().abi(),
                participant.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn SendValueSetToParticipantsAsync<P0, P1>(
        &self,
        messagedata: P0,
        participants: P1,
    ) -> windows_core::Result<windows_future::IAsyncOperation<bool>>
        ...
        P1: windows_core::Param<windows_collections::IIterable<RemoteSystemSessionParticipant>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SendValueSetToParticipantsAsync)(
                windows_core::Interface::as_raw(this),
                messagedata.param().abi(),
                participants.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ValueSetReceived)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveValueSetReceived(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveValueSetReceived)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn Create<P0>(
        session: P0,
        channelname: &windows_core::HSTRING,
    ) -> windows_core::Result<RemoteSystemSessionMessageChannel>
    where
        P0: windows_core::Param<RemoteSystemSession>,
    {
        Self::IRemoteSystemSessionMessageChannelFactory(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).Create)(
                windows_core::Interface::as_raw(this),
                session.param().abi(),
                core::mem::transmute_copy(channelname),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateWithReliability<P0>(
        session: P0,
        channelname: &windows_core::HSTRING,
        ...
        P0: windows_core::Param<RemoteSystemSession>,
    {
        Self::IRemoteSystemSessionMessageChannelFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithReliability)(
                windows_core::Interface::as_raw(this),
                session.param().abi(),
                core::mem::transmute_copy(channelname),
                reliability,
    ...
    fn IRemoteSystemSessionMessageChannelFactory<
        R,
        F: FnOnce(&IRemoteSystemSessionMessageChannelFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteSystemSessionMessageChannel {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionMessageChannel>();
}
unsafe impl windows_core::Interface for RemoteSystemSessionMessageChannel {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionMessageChannel as windows_core::Interface>::IID;
}
...
impl RemoteSystemSessionOptions {
    ...
    pub fn IsInviteOnly(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsInviteOnly)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIsInviteOnly(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsInviteOnly)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for RemoteSystemSessionOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionOptions>();
}
...
impl RemoteSystemSessionParticipant {
    ...
    pub fn GetHostNames(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<super::super::Networking::HostName>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetHostNames)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for RemoteSystemSessionParticipant {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionParticipant>();
}
unsafe impl windows_core::Interface for RemoteSystemSessionParticipant {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionParticipant as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for RemoteSystemSessionParticipantAddedEventArgs {
    type Vtable =
        <IRemoteSystemSessionParticipantAddedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IRemoteSystemSessionParticipantAddedEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for RemoteSystemSessionParticipantRemovedEventArgs {
    type Vtable =
        <IRemoteSystemSessionParticipantRemovedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IRemoteSystemSessionParticipantRemovedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for RemoteSystemSessionParticipantWatcher {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionParticipantWatcher>();
}
unsafe impl windows_core::Interface for RemoteSystemSessionParticipantWatcher {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionParticipantWatcher as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for RemoteSystemSessionRemovedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionRemovedEventArgs>();
}
unsafe impl windows_core::Interface for RemoteSystemSessionRemovedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionRemovedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for RemoteSystemSessionUpdatedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionUpdatedEventArgs>();
}
unsafe impl windows_core::Interface for RemoteSystemSessionUpdatedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemSessionUpdatedEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for RemoteSystemSessionValueSetReceivedEventArgs {
    type Vtable =
        <IRemoteSystemSessionValueSetReceivedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IRemoteSystemSessionValueSetReceivedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for RemoteSystemSessionWatcher {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemSessionWatcher>();
}
...
impl RemoteSystemStatusTypeFilter {
    pub fn RemoteSystemStatusType(&self) -> windows_core::Result<RemoteSystemStatusType> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteSystemStatusType)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    ) -> windows_core::Result<RemoteSystemStatusTypeFilter> {
    ...
    fn IRemoteSystemStatusTypeFilterFactory<
        R,
        F: FnOnce(&IRemoteSystemStatusTypeFilterFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteSystemStatusTypeFilter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemStatusTypeFilter>();
}
...
impl windows_core::RuntimeType for RemoteSystemUpdatedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemUpdatedEventArgs>();
}
...
impl RemoteSystemWatcher {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteSystemAdded)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveRemoteSystemAdded(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveRemoteSystemAdded)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteSystemUpdated)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveRemoteSystemUpdated(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveRemoteSystemUpdated)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteSystemRemoved)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveRemoteSystemRemoved(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveRemoteSystemRemoved)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for RemoteSystemWatcher {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemWatcher>();
}
...
unsafe impl windows_core::Interface for RemoteSystemWatcherErrorOccurredEventArgs {
    ...
    const IID: windows_core::GUID =
        <IRemoteSystemWatcherErrorOccurredEventArgs as windows_core::Interface>::IID;
}
...
impl RemoteSystemWebAccountFilter {
    ...
    pub fn Account(&self) -> windows_core::Result<super::super::Security::Credentials::WebAccount> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Account)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IRemoteSystemWebAccountFilterFactory<
        R,
        F: FnOnce(&IRemoteSystemWebAccountFilterFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteSystemWebAccountFilter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteSystemWebAccountFilter>();
}

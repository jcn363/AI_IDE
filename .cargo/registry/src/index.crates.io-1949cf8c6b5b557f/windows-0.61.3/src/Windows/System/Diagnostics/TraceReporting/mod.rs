windows_core::imp::define_interface!(
    ...
    IPlatformDiagnosticActionsStatics_Vtbl,
    0xc1145cfa_9292_4267_890a_9ea3ed072312
);
...
pub struct IPlatformDiagnosticActionsStatics_Vtbl {
    ...
    pub IsScenarioEnabled: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut bool,
    ) -> windows_core::HRESULT,
    pub TryEscalateScenario: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
    ...
    pub DownloadLatestSettingsForNamespace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        bool,
        bool,
        bool,
        *mut PlatformDiagnosticActionState,
    ) -> windows_core::HRESULT,
    pub GetActiveScenarioList: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ForceUpload: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub IsTraceRunning: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        PlatformDiagnosticTraceSlotType,
        windows_core::GUID,
        u64,
        *mut PlatformDiagnosticTraceSlotState,
    ) -> windows_core::HRESULT,
    pub GetActiveTraceRuntime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        PlatformDiagnosticTraceSlotType,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetKnownTraceList: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        PlatformDiagnosticTraceSlotType,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IPlatformDiagnosticTraceInfo_Vtbl,
    0xf870ed97_d597_4bf7_88dc_cf5c7dc2a1d2
);
...
pub struct IPlatformDiagnosticTraceInfo_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ScenarioId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl windows_core::RuntimeType for PlatformDiagnosticActionState {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.Diagnostics.TraceReporting.PlatformDiagnosticActionState;i4)",
    );
}
...
impl PlatformDiagnosticActions {
    pub fn IsScenarioEnabled(scenarioid: windows_core::GUID) -> windows_core::Result<bool> {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).IsScenarioEnabled)(
    ...
    pub fn TryEscalateScenario<P5>(
        scenarioid: windows_core::GUID,
        escalationtype: PlatformDiagnosticEscalationType,
        outputdirectory: &windows_core::HSTRING,
        timestampoutputdirectory: bool,
        forceescalationupload: bool,
        triggers: P5,
    ) -> windows_core::Result<bool>
    where
        P5: windows_core::Param<
            windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>,
        >,
    {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryEscalateScenario)(
                windows_core::Interface::as_raw(this),
                scenarioid,
                escalationtype,
                core::mem::transmute_copy(outputdirectory),
    ...
    pub fn DownloadLatestSettingsForNamespace(
        partner: &windows_core::HSTRING,
        feature: &windows_core::HSTRING,
        isscenarionamespace: bool,
        downloadovercostednetwork: bool,
        downloadoverbattery: bool,
    ) -> windows_core::Result<PlatformDiagnosticActionState> {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DownloadLatestSettingsForNamespace)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(partner),
    ...
    pub fn GetActiveScenarioList(
    ) -> windows_core::Result<windows_collections::IVectorView<windows_core::GUID>> {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetActiveScenarioList)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn ForceUpload(
        ...
        uploadovercostednetwork: bool,
        uploadoverbattery: bool,
    ) -> windows_core::Result<PlatformDiagnosticActionState> {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ForceUpload)(
                windows_core::Interface::as_raw(this),
                latency,
    ...
    pub fn IsTraceRunning(
        slottype: PlatformDiagnosticTraceSlotType,
        scenarioid: windows_core::GUID,
        traceprofilehash: u64,
    ) -> windows_core::Result<PlatformDiagnosticTraceSlotState> {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsTraceRunning)(
                windows_core::Interface::as_raw(this),
                slottype,
                scenarioid,
                traceprofilehash,
    ...
    pub fn GetActiveTraceRuntime(
        slottype: PlatformDiagnosticTraceSlotType,
    ) -> windows_core::Result<PlatformDiagnosticTraceRuntimeInfo> {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetActiveTraceRuntime)(
                windows_core::Interface::as_raw(this),
                slottype,
                &mut result__,
            )
    ...
    pub fn GetKnownTraceList(
        slottype: PlatformDiagnosticTraceSlotType,
    ) -> windows_core::Result<windows_collections::IVectorView<PlatformDiagnosticTraceInfo>> {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetKnownTraceList)(
                windows_core::Interface::as_raw(this),
                slottype,
                &mut result__,
            )
    ...
    fn IPlatformDiagnosticActionsStatics<
        R,
        F: FnOnce(&IPlatformDiagnosticActionsStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for PlatformDiagnosticEscalationType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.Diagnostics.TraceReporting.PlatformDiagnosticEscalationType;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl PlatformDiagnosticTraceInfo {
    pub fn ScenarioId(&self) -> windows_core::Result<windows_core::GUID> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ScenarioId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ProfileHash(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ProfileHash)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsAutoLogger(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsAutoLogger)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MaxTraceDurationFileTime(&self) -> windows_core::Result<i64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxTraceDurationFileTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for PlatformDiagnosticTraceInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPlatformDiagnosticTraceInfo>();
}
...
impl windows_core::RuntimeType for PlatformDiagnosticTracePriority {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.Diagnostics.TraceReporting.PlatformDiagnosticTracePriority;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl PlatformDiagnosticTraceRuntimeInfo {
    pub fn RuntimeFileTime(&self) -> windows_core::Result<i64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RuntimeFileTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn EtwRuntimeFileTime(&self) -> windows_core::Result<i64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EtwRuntimeFileTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for PlatformDiagnosticTraceRuntimeInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPlatformDiagnosticTraceRuntimeInfo>();
}
unsafe impl windows_core::Interface for PlatformDiagnosticTraceRuntimeInfo {
    ...
    const IID: windows_core::GUID =
        <IPlatformDiagnosticTraceRuntimeInfo as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for PlatformDiagnosticTraceSlotState {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.Diagnostics.TraceReporting.PlatformDiagnosticTraceSlotState;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for PlatformDiagnosticTraceSlotType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.Diagnostics.TraceReporting.PlatformDiagnosticTraceSlotType;i4)",
    );
}

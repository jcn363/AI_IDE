...
impl DisplayRequest {
    ...
    pub fn RequestActive(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RequestActive)(windows_core::Interface::as_raw(
                this,
            ))
            .ok()
        }
    ...
    pub fn RequestRelease(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RequestRelease)(windows_core::Interface::as_raw(
                this,
            ))
            .ok()
        }
...
impl windows_core::RuntimeType for DisplayRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDisplayRequest>();
}
...
windows_core::imp::define_interface!(
    ...
    0xe5732044_f49f_4b60_8dd4_5e7e3a632ac0
);

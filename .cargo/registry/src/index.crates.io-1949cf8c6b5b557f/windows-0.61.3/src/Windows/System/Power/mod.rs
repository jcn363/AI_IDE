...
impl BackgroundEnergyManager {
    pub fn LowUsageLevel() -> windows_core::Result<u32> {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).LowUsageLevel)(
    ...
    pub fn NearMaxAcceptableUsageLevel() -> windows_core::Result<u32> {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NearMaxAcceptableUsageLevel)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MaxAcceptableUsageLevel() -> windows_core::Result<u32> {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxAcceptableUsageLevel)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ExcessiveUsageLevel() -> windows_core::Result<u32> {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ExcessiveUsageLevel)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn NearTerminationUsageLevel() -> windows_core::Result<u32> {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NearTerminationUsageLevel)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn TerminationUsageLevel() -> windows_core::Result<u32> {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TerminationUsageLevel)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn RecentEnergyUsage() -> windows_core::Result<u32> {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RecentEnergyUsage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn RecentEnergyUsageLevel() -> windows_core::Result<u32> {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RecentEnergyUsageLevel)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RecentEnergyUsageIncreased)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveRecentEnergyUsageIncreased(token: i64) -> windows_core::Result<()> {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveRecentEnergyUsageIncreased)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RecentEnergyUsageReturnedToLow)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveRecentEnergyUsageReturnedToLow(token: i64) -> windows_core::Result<()> {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveRecentEnergyUsageReturnedToLow)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    fn IBackgroundEnergyManagerStatics<
        R,
        F: FnOnce(&IBackgroundEnergyManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for BatteryStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.System.Power.BatteryStatus;i4)");
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for EnergySaverStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.Power.EnergySaverStatus;i4)",
    );
}
#[cfg(feature = "deprecated")]
...
impl ForegroundEnergyManager {
    ...
    fn IForegroundEnergyManagerStatics<
        R,
        F: FnOnce(&IForegroundEnergyManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
pub struct IBackgroundEnergyManagerStatics_Vtbl {
    ...
    pub NearMaxAcceptableUsageLevel:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub MaxAcceptableUsageLevel:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub ExcessiveUsageLevel:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub NearTerminationUsageLevel:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub TerminationUsageLevel:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub RecentEnergyUsage:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub RecentEnergyUsageLevel:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub RecentEnergyUsageIncreased: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRecentEnergyUsageIncreased:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub RecentEnergyUsageReturnedToLow: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRecentEnergyUsageReturnedToLow:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
#[cfg(feature = "deprecated")]
windows_core::imp::define_interface!(
...
windows_core::imp::define_interface!(
    ...
    IPowerManagerStatics_Vtbl,
    0x1394825d_62ce_4364_98d5_aa28c7fbd15b
);
...
pub struct IPowerManagerStatics_Vtbl {
    ...
    pub RemoveEnergySaverStatusChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    ...
    pub RemoveBatteryStatusChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub PowerSupplyStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PowerSupplyStatus,
    ) -> windows_core::HRESULT,
    ...
    pub RemovePowerSupplyStatusChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    ...
    pub RemoveRemainingChargePercentChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    ...
    pub RemoveRemainingDischargeTimeChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
...
impl PowerManager {
    ...
    fn IPowerManagerStatics<R, F: FnOnce(&IPowerManagerStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
...
impl windows_core::RuntimeType for PowerSupplyStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.Power.PowerSupplyStatus;i4)",
    );
}

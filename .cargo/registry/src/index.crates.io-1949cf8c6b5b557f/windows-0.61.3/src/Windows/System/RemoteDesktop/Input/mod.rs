windows_core::imp::define_interface!(
    ...
    IRemoteTextConnection_Vtbl,
    0x4e7bb02a_183e_5e66_b5e4_3e6e5c570cf1
);
...
pub struct IRemoteTextConnection_Vtbl {
    ...
    pub UnregisterThread:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub ReportDataReceived:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *const u8) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteTextConnection2,
    IRemoteTextConnection2_Vtbl,
    0x05f99345_84c8_56c5_934f_73ea00f8c2d5
);
...
pub struct IRemoteTextConnection2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ReportPredictedKeyEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u16,
...
windows_core::imp::define_interface!(
    IRemoteTextConnectionFactory,
    IRemoteTextConnectionFactory_Vtbl,
...
windows_core::imp::define_interface!(
    ...
    IRemoteTextConnectionFactory2_Vtbl,
    0x9425c7d9_ed9b_5d00_99cc_b0b8dc9e4c60
);
...
impl windows_core::RuntimeType for RemoteKeyEventAttributes {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.RemoteDesktop.Input.RemoteKeyEventAttributes;u4)",
    );
}
impl RemoteKeyEventAttributes {
...
impl RemoteTextConnection {
    ...
    pub fn RegisterThread(&self, threadid: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterThread)(
                windows_core::Interface::as_raw(this),
                threadid,
            )
            .ok()
    ...
    pub fn UnregisterThread(&self, threadid: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).UnregisterThread)(
                windows_core::Interface::as_raw(this),
                threadid,
            )
            .ok()
    ...
    pub fn ReportDataReceived(&self, pdudata: &[u8]) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReportDataReceived)(
                windows_core::Interface::as_raw(this),
                pdudata.len().try_into().unwrap(),
                pdudata.as_ptr(),
            )
            .ok()
        }
    }
    pub fn ReportPredictedKeyEvent(
        &self,
        scancode: u16,
        ...
        unsafe {
            (windows_core::Interface::vtable(this).ReportPredictedKeyEvent)(
                windows_core::Interface::as_raw(this),
                scancode,
                attributes,
            )
    ...
    pub fn CreateInstance<P1>(
        ...
        pduforwarder: P1,
    ) -> windows_core::Result<RemoteTextConnection>
    where
        P1: windows_core::Param<RemoteTextConnectionDataHandler>,
    {
        Self::IRemoteTextConnectionFactory(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).CreateInstance)(
                windows_core::Interface::as_raw(this),
                connectionid,
                pduforwarder.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateInstance2<P1>(
        connectionid: windows_core::GUID,
        pduforwarder: P1,
    ...
    fn IRemoteTextConnectionFactory<
        R,
        F: FnOnce(&IRemoteTextConnectionFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ...
    fn IRemoteTextConnectionFactory2<
        R,
        F: FnOnce(&IRemoteTextConnectionFactory2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteTextConnection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteTextConnection>();
}
...
windows_core::imp::define_interface!(
    ...
    RemoteTextConnectionDataHandler_Vtbl,
    0x099ffbc8_8bcb_41b5_b056_57e77021bf1b
);
...
impl RemoteTextConnectionDataHandler {
    pub fn new<F: FnMut(&[u8]) -> windows_core::Result<bool> + Send + 'static>(invoke: F) -> Self {
        let com = RemoteTextConnectionDataHandlerBox {
            vtable: &RemoteTextConnectionDataHandlerBox::<F>::VTABLE,
...
pub struct RemoteTextConnectionDataHandler_Vtbl {
    ...
    Invoke: unsafe extern "system" fn(
        ...
        pdudata_array_size: u32,
        pdudata: *const u8,
        result__: *mut bool,
    ) -> windows_core::HRESULT,
}
#[repr(C)]
struct RemoteTextConnectionDataHandlerBox<
    F: FnMut(&[u8]) -> windows_core::Result<bool> + Send + 'static,
> {
    vtable: *const RemoteTextConnectionDataHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(&[u8]) -> windows_core::Result<bool> + Send + 'static>
    RemoteTextConnectionDataHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid
                == <RemoteTextConnectionDataHandler as windows_core::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        unsafe {
            ...
            match (this.invoke)(core::slice::from_raw_parts(
                core::mem::transmute_copy(&pdudata),
                pdudata_array_size as usize,
            )) {
                Ok(ok__) => {
...
impl windows_core::RuntimeType for RemoteTextConnectionOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.RemoteDesktop.Input.RemoteTextConnectionOptions;u4)",
    );
}
impl RemoteTextConnectionOptions {
    pub const fn contains(&self, other: Self) -> bool {

windows_core::imp::define_interface!(
    ...
    IPreallocatedWorkItem_Vtbl,
    0xb6daa9fc_bc5b_401a_a8b2_6e754d14daa6
);
...
pub struct IPreallocatedWorkItemFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateWorkItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateWorkItemWithPriority: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::WorkItemPriority,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateWorkItemWithPriorityAndOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::WorkItemPriority,
        super::WorkItemOptions,
        *mut *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISignalNotifier,
    ISignalNotifier_Vtbl,
    0x14285e06_63a7_4713_b6d9_62f64b56fb8b
);
...
windows_core::imp::define_interface!(
    ...
    ISignalNotifierStatics_Vtbl,
    0x1c4e4566_8400_46d3_a115_7d0c0dfc9f62
);
...
pub struct ISignalNotifierStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AttachToEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AttachToEventWithTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub AttachToSemaphore: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AttachToSemaphoreWithTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::super::Foundation::TimeSpan,
...
impl PreallocatedWorkItem {
        ...
        P0: windows_core::Param<super::WorkItemHandler>,
    {
        Self::IPreallocatedWorkItemFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWorkItem)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn CreateWorkItemWithPriority<P0>(
        handler: P0,
        priority: super::WorkItemPriority,
    ) -> windows_core::Result<PreallocatedWorkItem>
    where
        P0: windows_core::Param<super::WorkItemHandler>,
    {
        Self::IPreallocatedWorkItemFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWorkItemWithPriority)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                priority,
                &mut result__,
    ...
    pub fn CreateWorkItemWithPriorityAndOptions<P0>(
        handler: P0,
        priority: super::WorkItemPriority,
        options: super::WorkItemOptions,
    ) -> windows_core::Result<PreallocatedWorkItem>
    where
        P0: windows_core::Param<super::WorkItemHandler>,
    {
        Self::IPreallocatedWorkItemFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWorkItemWithPriorityAndOptions)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                priority,
                options,
    ...
    fn IPreallocatedWorkItemFactory<
        R,
        F: FnOnce(&IPreallocatedWorkItemFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for PreallocatedWorkItem {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPreallocatedWorkItem>();
}
...
windows_core::imp::define_interface!(
    SignalHandler,
    SignalHandler_Vtbl,
    0x923c402e_4721_440e_9dda_55b6f2e07710
);
...
impl SignalHandler {
    pub fn new<
        F: FnMut(windows_core::Ref<'_, SignalNotifier>, bool) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        invoke: F,
    ) -> Self {
        let com = SignalHandlerBox {
            vtable: &SignalHandlerBox::<F>::VTABLE,
...
pub struct SignalHandler_Vtbl {
    ...
    Invoke: unsafe extern "system" fn(
        ...
        signalnotifier: *mut core::ffi::c_void,
        timedout: bool,
    ) -> windows_core::HRESULT,
}
#[repr(C)]
struct SignalHandlerBox<
    F: FnMut(windows_core::Ref<'_, SignalNotifier>, bool) -> windows_core::Result<()> + Send + 'static,
> {
    ...
    > SignalHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <SignalHandler as windows_core::Interface>::IID
...
impl SignalNotifier {
    ...
    pub fn AttachToEvent<P1>(
        name: &windows_core::HSTRING,
        handler: P1,
    ) -> windows_core::Result<SignalNotifier>
    where
        P1: windows_core::Param<SignalHandler>,
    {
        Self::ISignalNotifierStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AttachToEvent)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn AttachToEventWithTimeout<P1>(
        name: &windows_core::HSTRING,
        handler: P1,
        timeout: super::super::super::Foundation::TimeSpan,
    ) -> windows_core::Result<SignalNotifier>
    where
        P1: windows_core::Param<SignalHandler>,
    {
        Self::ISignalNotifierStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AttachToEventWithTimeout)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                handler.param().abi(),
                timeout,
        ...
        P1: windows_core::Param<SignalHandler>,
    {
        Self::ISignalNotifierStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AttachToSemaphore)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                handler.param().abi(),
                &mut result__,
    ...
    pub fn AttachToSemaphoreWithTimeout<P1>(
        name: &windows_core::HSTRING,
        handler: P1,
        timeout: super::super::super::Foundation::TimeSpan,
    ) -> windows_core::Result<SignalNotifier>
        ...
        P1: windows_core::Param<SignalHandler>,
    {
        Self::ISignalNotifierStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AttachToSemaphoreWithTimeout)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                handler.param().abi(),
                timeout,
    ...
    fn ISignalNotifierStatics<R, F: FnOnce(&ISignalNotifierStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SignalNotifier, ISignalNotifierStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for SignalNotifier {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISignalNotifier>();
}

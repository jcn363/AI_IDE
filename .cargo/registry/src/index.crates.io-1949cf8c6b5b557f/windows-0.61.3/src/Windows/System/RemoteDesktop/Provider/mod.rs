windows_core::imp::define_interface!(
    ...
    0x59359f4f_0862_53a3_a3b3_c932fb718cdc
);
...
pub struct IPerformLocalActionRequestedEventArgs_Vtbl {
    ...
    pub Action: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RemoteDesktopLocalAction,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteDesktopConnectionInfo,
    IRemoteDesktopConnectionInfo_Vtbl,
    0x68bd69d6_6dea_543b_b737_f347919f5093
);
...
pub struct IRemoteDesktopConnectionInfo_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetConnectionStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        RemoteDesktopConnectionStatus,
    ) -> windows_core::HRESULT,
    pub SwitchToLocalSession:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteDesktopConnectionInfo2,
    IRemoteDesktopConnectionInfo2_Vtbl,
    0x871c0b26_23bf_5d3c_bc35_a85c405e25e6
);
...
pub struct IRemoteDesktopConnectionInfo2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub PerformLocalActionFromRemote: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        RemoteDesktopLocalAction,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteDesktopConnectionInfoStatics,
    IRemoteDesktopConnectionInfoStatics_Vtbl,
    0x4a7dc5a1_3368_5a75_bb78_807df7ebc439
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteDesktopConnectionRemoteInfo_Vtbl,
    0x2a3dfa7e_a7ab_547e_9a6a_4c565bbb8d71
);
...
pub struct IRemoteDesktopConnectionRemoteInfo_Vtbl {
    ...
    pub SwitchToLocalSessionRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveSwitchToLocalSessionRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub PerformLocalActionRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePerformLocalActionRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRemoteDesktopConnectionRemoteInfoStatics,
    IRemoteDesktopConnectionRemoteInfoStatics_Vtbl,
    0xb590e64a_e4c9_53e8_b83d_a0db3676246a
);
...
windows_core::imp::define_interface!(
    ...
    0xd185bb25_2f1e_5098_b9e0_f46d6358c5c4
);
...
windows_core::imp::define_interface!(
    IRemoteDesktopInfoFactory,
    IRemoteDesktopInfoFactory_Vtbl,
    0xad0e8d58_b56f_5a8b_b419_8002ee0c5ee9
);
...
windows_core::imp::define_interface!(
    IRemoteDesktopRegistrarStatics,
    IRemoteDesktopRegistrarStatics_Vtbl,
    0x687c2750_46d9_5de3_8dc3_84a9202cecfb
);
...
pub struct IRemoteDesktopRegistrarStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub DesktopInfos: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsSwitchToLocalSessionEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
#[repr(transparent)]
...
impl windows_core::RuntimeType for PerformLocalActionRequestedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPerformLocalActionRequestedEventArgs>();
}
unsafe impl windows_core::Interface for PerformLocalActionRequestedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IPerformLocalActionRequestedEventArgs as windows_core::Interface>::IID;
}
...
impl RemoteDesktopConnectionInfo {
    pub fn SetConnectionStatus(
        &self,
        value: RemoteDesktopConnectionStatus,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetConnectionStatus)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SwitchToLocalSession(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SwitchToLocalSession)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    }
    pub fn PerformLocalActionFromRemote(
        &self,
        action: RemoteDesktopLocalAction,
    ) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IRemoteDesktopConnectionInfo2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).PerformLocalActionFromRemote)(
                windows_core::Interface::as_raw(this),
                action,
            )
            .ok()
    ...
    #[cfg(feature = "UI")]
    pub fn GetForLaunchUri<P0>(
        launchuri: P0,
        windowid: super::super::super::UI::WindowId,
    ) -> windows_core::Result<RemoteDesktopConnectionInfo>
    where
    ...
    fn IRemoteDesktopConnectionInfoStatics<
        R,
        F: FnOnce(&IRemoteDesktopConnectionInfoStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for RemoteDesktopConnectionInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteDesktopConnectionInfo>();
}
...
impl RemoteDesktopConnectionRemoteInfo {
    ...
    pub fn ReportSwitched(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReportSwitched)(windows_core::Interface::as_raw(
                this,
            ))
            .ok()
        }
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SwitchToLocalSessionRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveSwitchToLocalSessionRequested(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveSwitchToLocalSessionRequested)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PerformLocalActionRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemovePerformLocalActionRequested(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemovePerformLocalActionRequested)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn IsSwitchSupported() -> windows_core::Result<bool> {
        Self::IRemoteDesktopConnectionRemoteInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsSwitchSupported)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetForLaunchUri<P0>(
        launchuri: P0,
    ) -> windows_core::Result<RemoteDesktopConnectionRemoteInfo>
    where
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IRemoteDesktopConnectionRemoteInfoStatics(|this| unsafe {
    ...
    fn IRemoteDesktopConnectionRemoteInfoStatics<
        R,
        F: FnOnce(&IRemoteDesktopConnectionRemoteInfoStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteDesktopConnectionRemoteInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteDesktopConnectionRemoteInfo>();
}
unsafe impl windows_core::Interface for RemoteDesktopConnectionRemoteInfo {
    ...
    const IID: windows_core::GUID =
        <IRemoteDesktopConnectionRemoteInfo as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for RemoteDesktopConnectionStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.RemoteDesktop.Provider.RemoteDesktopConnectionStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl RemoteDesktopInfo {
    ...
    ) -> windows_core::Result<RemoteDesktopInfo> {
    ...
    fn IRemoteDesktopInfoFactory<
        R,
        F: FnOnce(&IRemoteDesktopInfoFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteDesktopInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteDesktopInfo>();
}
...
impl windows_core::RuntimeType for RemoteDesktopLocalAction {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.RemoteDesktop.Provider.RemoteDesktopLocalAction;i4)",
    );
}
...
impl RemoteDesktopRegistrar {
    pub fn DesktopInfos() -> windows_core::Result<windows_collections::IVector<RemoteDesktopInfo>> {
        Self::IRemoteDesktopRegistrarStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DesktopInfos)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn IsSwitchToLocalSessionEnabled() -> windows_core::Result<bool> {
        Self::IRemoteDesktopRegistrarStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsSwitchToLocalSessionEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    fn IRemoteDesktopRegistrarStatics<
        R,
        F: FnOnce(&IRemoteDesktopRegistrarStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<

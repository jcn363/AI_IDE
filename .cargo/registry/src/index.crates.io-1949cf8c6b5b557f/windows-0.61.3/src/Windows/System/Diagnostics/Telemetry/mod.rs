...
pub struct IPlatformTelemetryClientStatics_Vtbl {
    ...
    pub RegisterWithSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IPlatformTelemetryRegistrationResult_Vtbl,
    0x4d8518ab_2292_49bd_a15a_3d71d2145112
);
...
impl PlatformTelemetryClient {
    ...
    ) -> windows_core::Result<PlatformTelemetryRegistrationResult> {
        ...
        P1: windows_core::Param<PlatformTelemetryRegistrationSettings>,
    {
        Self::IPlatformTelemetryClientStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RegisterWithSettings)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(id),
                settings.param().abi(),
                &mut result__,
    ...
    fn IPlatformTelemetryClientStatics<
        R,
        F: FnOnce(&IPlatformTelemetryClientStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for PlatformTelemetryRegistrationResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPlatformTelemetryRegistrationResult>();
}
unsafe impl windows_core::Interface for PlatformTelemetryRegistrationResult {
    ...
    const IID: windows_core::GUID =
        <IPlatformTelemetryRegistrationResult as windows_core::Interface>::IID;
}
...
impl PlatformTelemetryRegistrationSettings {
    ...
    pub fn StorageSize(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StorageSize)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetStorageSize(&self, value: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetStorageSize)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn UploadQuotaSize(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UploadQuotaSize)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetUploadQuotaSize(&self, value: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetUploadQuotaSize)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for PlatformTelemetryRegistrationSettings {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPlatformTelemetryRegistrationSettings>();
}
unsafe impl windows_core::Interface for PlatformTelemetryRegistrationSettings {
    ...
    const IID: windows_core::GUID =
        <IPlatformTelemetryRegistrationSettings as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for PlatformTelemetryRegistrationStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.System.Diagnostics.Telemetry.PlatformTelemetryRegistrationStatus;i4)",
    );
}

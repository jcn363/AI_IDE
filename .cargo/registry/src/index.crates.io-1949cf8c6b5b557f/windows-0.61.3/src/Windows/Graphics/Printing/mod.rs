...
windows_core::imp::define_interface!(
    ...
    IPrintDocumentSource_Vtbl,
    0xdedc0c30_f1eb_47df_aae6_ed5427511f01
);
...
impl IPrintDocumentSource_Vtbl {
    pub const fn new<Identity: IPrintDocumentSource_Impl, const OFFSET: isize>() -> Self {
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IPrintDocumentSource, OFFSET>(
            ),
        }
    }
...
windows_core::imp::define_interface!(
    IPrintManager,
    IPrintManager_Vtbl,
    0xff2a9694_8c99_44fd_ae4a_19d9aa9a0f0a
);
...
pub struct IPrintManager_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub PrintTaskRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePrintTaskRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPrintManagerStatic,
    IPrintManagerStatic_Vtbl,
    0x58185dcd_e634_4654_84f0_e0152a8217ac
);
...
windows_core::imp::define_interface!(
    ...
    IPrintManagerStatic2_Vtbl,
    0x35a99955_e6ab_4139_9abd_b86a729b3598
);
...
windows_core::imp::define_interface!(
    IPrintPageInfo,
    IPrintPageInfo_Vtbl,
    0xdd4be9c9_a6a1_4ada_930e_da872a4f23d3
);
...
pub struct IPrintPageInfo_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetMediaSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, PrintMediaSize) -> windows_core::HRESULT,
    pub MediaSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PrintMediaSize,
    ) -> windows_core::HRESULT,
    pub SetPageSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub Orientation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PrintOrientation,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPrintPageRange,
    IPrintPageRange_Vtbl,
    0xf8a06c54_6e7c_51c5_57fd_0660c2d71513
);
...
windows_core::imp::define_interface!(
    ...
    IPrintPageRangeFactory_Vtbl,
    0x408fd45f_e047_5f85_7129_fb085a4fad14
);
...
pub struct IPrintPageRangeFactory_Vtbl {
    ...
    pub CreateWithSinglePage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IPrintPageRangeOptions_Vtbl,
    0xce6db728_1357_46b2_a923_79f995f448fc
);
...
pub struct IPrintPageRangeOptions_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetAllowAllPages:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub AllowAllPages:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetAllowCurrentPage:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub AllowCurrentPage:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetAllowCustomSetOfPages:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub AllowCustomSetOfPages:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPrintTask,
    IPrintTask_Vtbl,
    0x61d80247_6cf6_4fad_84e2_a5e82e2d4ceb
);
...
pub struct IPrintTask_Vtbl {
    ...
    pub Previewing: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePreviewing:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    ...
    pub RemoveSubmitting:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub Progressing: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveProgressing:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IPrintTask2,
    IPrintTask2_Vtbl,
    0x36234877_3e53_4d9d_8f5e_316ac8dedae1
);
...
pub struct IPrintTask2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetIsPreviewEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub IsPreviewEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
...
pub struct IPrintTaskCompletedEventArgs_Vtbl {
    ...
    pub Completion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PrintTaskCompletion,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPrintTaskOptions,
    IPrintTaskOptions_Vtbl,
    0x5a0a66bb_d289_41bb_96dd_57e28338ae3f
);
...
pub struct IPrintTaskOptions_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetBordering:
        unsafe extern "system" fn(*mut core::ffi::c_void, PrintBordering) -> windows_core::HRESULT,
    pub Bordering: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PrintBordering,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    pub GetPagePrintTicket: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IPrintTaskOptions2,
    IPrintTaskOptions2_Vtbl,
    0xeb9b1606_9a36_4b59_8617_b217849262e1
);
...
pub struct IPrintTaskOptions2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub PageRangeOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CustomPageRanges: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0x1bdbb474_4ed1_41eb_be3c_72d18ed67337
);
...
impl IPrintTaskOptionsCore {
    pub fn GetPageDescription(
        &self,
        jobpagenumber: u32,
    ) -> windows_core::Result<PrintPageDescription> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPageDescription)(
...
impl IPrintTaskOptionsCore_Vtbl {
    pub const fn new<Identity: IPrintTaskOptionsCore_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetPageDescription<
...
pub struct IPrintTaskOptionsCore_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetPageDescription: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut PrintPageDescription,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPrintTaskOptionsCoreProperties,
    IPrintTaskOptionsCoreProperties_Vtbl,
    0xc1b71832_9e93_4e55_814b_3326a59efce1
);
...
impl IPrintTaskOptionsCoreProperties {
    ...
    pub fn SetPrintQuality(&self, value: PrintQuality) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPrintQuality)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn PrintQuality(&self) -> windows_core::Result<PrintQuality> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PrintQuality)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetStaple(&self, value: PrintStaple) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetStaple)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn Staple(&self) -> windows_core::Result<PrintStaple> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Staple)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetHolePunch(&self, value: PrintHolePunch) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetHolePunch)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn HolePunch(&self) -> windows_core::Result<PrintHolePunch> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HolePunch)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MinCopies(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MinCopies)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MaxCopies(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxCopies)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetNumberOfCopies(&self, value: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetNumberOfCopies)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn NumberOfCopies(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NumberOfCopies)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl IPrintTaskOptionsCoreProperties_Vtbl {
    pub const fn new<Identity: IPrintTaskOptionsCoreProperties_Impl, const OFFSET: isize>() -> Self
    {
        ...
        unsafe extern "system" fn SetPrintQuality<
            Identity: IPrintTaskOptionsCoreProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn PrintQuality<
            Identity: IPrintTaskOptionsCoreProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetStaple<
            Identity: IPrintTaskOptionsCoreProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Staple<
            Identity: IPrintTaskOptionsCoreProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetHolePunch<
            Identity: IPrintTaskOptionsCoreProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn HolePunch<
            Identity: IPrintTaskOptionsCoreProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Binding<
            Identity: IPrintTaskOptionsCoreProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn MinCopies<
            Identity: IPrintTaskOptionsCoreProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn MaxCopies<
            Identity: IPrintTaskOptionsCoreProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetNumberOfCopies<
            Identity: IPrintTaskOptionsCoreProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn NumberOfCopies<
            Identity: IPrintTaskOptionsCoreProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub struct IPrintTaskOptionsCoreProperties_Vtbl {
    ...
    pub SetMediaType:
        unsafe extern "system" fn(*mut core::ffi::c_void, PrintMediaType) -> windows_core::HRESULT,
    ...
    pub SetPrintQuality:
        unsafe extern "system" fn(*mut core::ffi::c_void, PrintQuality) -> windows_core::HRESULT,
    pub PrintQuality: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PrintQuality,
    ) -> windows_core::HRESULT,
    pub SetColorMode:
        unsafe extern "system" fn(*mut core::ffi::c_void, PrintColorMode) -> windows_core::HRESULT,
    pub ColorMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PrintColorMode,
    ) -> windows_core::HRESULT,
    pub SetDuplex:
        unsafe extern "system" fn(*mut core::ffi::c_void, PrintDuplex) -> windows_core::HRESULT,
    pub Duplex: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PrintDuplex,
    ) -> windows_core::HRESULT,
    pub SetCollation:
        unsafe extern "system" fn(*mut core::ffi::c_void, PrintCollation) -> windows_core::HRESULT,
    pub Collation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PrintCollation,
    ) -> windows_core::HRESULT,
    pub SetStaple:
        unsafe extern "system" fn(*mut core::ffi::c_void, PrintStaple) -> windows_core::HRESULT,
    pub Staple: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PrintStaple,
    ) -> windows_core::HRESULT,
    pub SetHolePunch:
        unsafe extern "system" fn(*mut core::ffi::c_void, PrintHolePunch) -> windows_core::HRESULT,
    pub HolePunch: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PrintHolePunch,
    ) -> windows_core::HRESULT,
    pub SetBinding:
        unsafe extern "system" fn(*mut core::ffi::c_void, PrintBinding) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x62e69e23_9a1e_4336_b74f_3cc7f4cff709
);
...
impl IPrintTaskOptionsCoreUIConfiguration {
    pub fn DisplayedOptions(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DisplayedOptions)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
...
impl IPrintTaskOptionsCoreUIConfiguration_Vtbl {
    pub const fn new<Identity: IPrintTaskOptionsCoreUIConfiguration_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn DisplayedOptions<
...
pub struct IPrintTaskOptionsCoreUIConfiguration_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub DisplayedOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IPrintTaskProgressingEventArgs_Vtbl,
    0x810cd3cb_b410_4282_a073_5ac378234174
);
...
pub struct IPrintTaskProgressingEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub DocumentPageCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPrintTaskRequest,
    IPrintTaskRequest_Vtbl,
    0x6ff61e2e_2722_4240_a67c_f364849a17f3
);
...
pub struct IPrintTaskRequest_Vtbl {
    ...
    pub CreatePrintTask: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IPrintTaskRequestedDeferral_Vtbl,
    0xcfefb3f0_ce3e_42c7_9496_64800c622c44
);
...
windows_core::imp::define_interface!(
    ...
    IPrintTaskRequestedEventArgs_Vtbl,
    0xd0aff924_a31b_454c_a7b6_5d0cc522fc16
);
...
windows_core::imp::define_interface!(
    ...
    0xf9f067be_f456_41f0_9c98_5ce73e851410
);
...
windows_core::imp::define_interface!(
    ...
    IPrintTaskSourceRequestedDeferral_Vtbl,
    0x4a1560d1_6992_4d9d_8555_4ca4563fb166
);
...
windows_core::imp::define_interface!(
    ...
    IPrintTaskTargetDeviceSupport_Vtbl,
    0x295d70c0_c2cb_4b7d_b0ea_93095091a220
);
...
pub struct IPrintTaskTargetDeviceSupport_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetIsPrinterTargetEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub IsPrinterTargetEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetIs3DManufacturingTargetEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub Is3DManufacturingTargetEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IStandardPrintTaskOptionsStatic,
    IStandardPrintTaskOptionsStatic_Vtbl,
    0xb4483d26_0dd0_4cd4_baff_930fc7d6a574
);
...
pub struct IStandardPrintTaskOptionsStatic_Vtbl {
    ...
    pub NUp: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub InputBin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IStandardPrintTaskOptionsStatic2_Vtbl,
    0x3be38bf4_7a44_4269_9a52_81261e289ee9
);
...
windows_core::imp::define_interface!(
    ...
    IStandardPrintTaskOptionsStatic3_Vtbl,
    0xbbf68e86_3858_41b3_a799_55dd9888d475
);
...
impl PrintManager {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PrintTaskRequested)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn RemovePrintTaskRequested(&self, eventcookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemovePrintTaskRequested)(
                windows_core::Interface::as_raw(this),
                eventcookie,
            )
            .ok()
    ...
    fn IPrintManagerStatic<R, F: FnOnce(&IPrintManagerStatic) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PrintManager, IPrintManagerStatic> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IPrintManagerStatic2<R, F: FnOnce(&IPrintManagerStatic2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PrintManager, IPrintManagerStatic2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for PrintManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintManager>();
}
...
impl PrintPageInfo {
    ...
    pub fn SetPageSize(&self, value: super::super::Foundation::Size) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPageSize)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for PrintPageInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintPageInfo>();
}
...
impl PrintPageRange {
    pub fn FirstPageNumber(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FirstPageNumber)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn LastPageNumber(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LastPageNumber)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CreateWithSinglePage(page: i32) -> windows_core::Result<PrintPageRange> {
        Self::IPrintPageRangeFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithSinglePage)(
                windows_core::Interface::as_raw(this),
                page,
                &mut result__,
            )
    ...
    fn IPrintPageRangeFactory<R, F: FnOnce(&IPrintPageRangeFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PrintPageRange, IPrintPageRangeFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for PrintPageRange {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintPageRange>();
}
...
impl PrintPageRangeOptions {
    pub fn SetAllowAllPages(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAllowAllPages)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn AllowAllPages(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllowAllPages)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAllowCurrentPage(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAllowCurrentPage)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn AllowCurrentPage(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllowCurrentPage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAllowCustomSetOfPages(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAllowCustomSetOfPages)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn AllowCustomSetOfPages(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllowCustomSetOfPages)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for PrintPageRangeOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintPageRangeOptions>();
}
...
impl PrintTask {
    ...
    pub fn Properties(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::DataTransfer::DataPackagePropertySet>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<PrintTask, windows_core::IInspectable>,
        >,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Previewing)(
                windows_core::Interface::as_raw(this),
                eventhandler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemovePreviewing(&self, eventcookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemovePreviewing)(
                windows_core::Interface::as_raw(this),
                eventcookie,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Progressing)(
                windows_core::Interface::as_raw(this),
                eventhandler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveProgressing(&self, eventcookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveProgressing)(
                windows_core::Interface::as_raw(this),
                eventcookie,
            )
            .ok()
    ...
    pub fn SetIsPreviewEnabled(&self, value: bool) -> windows_core::Result<()> {
        ...
        unsafe {
            (windows_core::Interface::vtable(this).SetIsPreviewEnabled)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn IsPreviewEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsPreviewEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIsPrinterTargetEnabled(&self, value: bool) -> windows_core::Result<()> {
        ...
        unsafe {
            (windows_core::Interface::vtable(this).SetIsPrinterTargetEnabled)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn IsPrinterTargetEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsPrinterTargetEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIs3DManufacturingTargetEnabled(&self, value: bool) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IPrintTaskTargetDeviceSupport>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetIs3DManufacturingTargetEnabled)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn Is3DManufacturingTargetEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Is3DManufacturingTargetEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for PrintTask {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintTask>();
}
...
impl windows_core::RuntimeType for PrintTaskCompletedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintTaskCompletedEventArgs>();
}
...
impl PrintTaskOptions {
    pub fn SetBordering(&self, value: PrintBordering) -> windows_core::Result<()> {
        ...
        unsafe {
            (windows_core::Interface::vtable(this).SetBordering)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn Bordering(&self) -> windows_core::Result<PrintBordering> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Bordering)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
        ...
        P0: windows_core::Param<PrintPageInfo>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPagePrintTicket)(
                windows_core::Interface::as_raw(this),
                printpageinfo.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub fn PageRangeOptions(&self) -> windows_core::Result<PrintPageRangeOptions> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PageRangeOptions)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CustomPageRanges(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<PrintPageRange>> {
        let this = &windows_core::Interface::cast::<IPrintTaskOptions2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CustomPageRanges)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for PrintTaskOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintTaskOptionsCore>();
}
...
impl PrintTaskProgressingEventArgs {
    pub fn DocumentPageCount(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DocumentPageCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for PrintTaskProgressingEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintTaskProgressingEventArgs>();
}
unsafe impl windows_core::Interface for PrintTaskProgressingEventArgs {
    ...
    const IID: windows_core::GUID =
        <IPrintTaskProgressingEventArgs as windows_core::Interface>::IID;
}
...
impl PrintTaskRequest {
    ...
    pub fn CreatePrintTask<P1>(
        &self,
        title: &windows_core::HSTRING,
        handler: P1,
    ) -> windows_core::Result<PrintTask>
    where
        P1: windows_core::Param<PrintTaskSourceRequestedHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreatePrintTask)(
                windows_core::Interface::as_raw(this),
...
impl windows_core::RuntimeType for PrintTaskRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintTaskRequest>();
}
...
impl windows_core::RuntimeType for PrintTaskRequestedDeferral {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintTaskRequestedDeferral>();
}
...
impl windows_core::RuntimeType for PrintTaskRequestedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintTaskRequestedEventArgs>();
}
...
impl windows_core::RuntimeType for PrintTaskSourceRequestedArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintTaskSourceRequestedArgs>();
}
...
impl windows_core::RuntimeType for PrintTaskSourceRequestedDeferral {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintTaskSourceRequestedDeferral>();
}
unsafe impl windows_core::Interface for PrintTaskSourceRequestedDeferral {
    ...
    const IID: windows_core::GUID =
        <IPrintTaskSourceRequestedDeferral as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    ...
    PrintTaskSourceRequestedHandler_Vtbl,
...
impl PrintTaskSourceRequestedHandler {
    pub fn new<
        F: FnMut(windows_core::Ref<'_, PrintTaskSourceRequestedArgs>) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        invoke: F,
    ) -> Self {
        let com = PrintTaskSourceRequestedHandlerBox {
            vtable: &PrintTaskSourceRequestedHandlerBox::<F>::VTABLE,
...
#[repr(C)]
struct PrintTaskSourceRequestedHandlerBox<
    F: FnMut(windows_core::Ref<'_, PrintTaskSourceRequestedArgs>) -> windows_core::Result<()>
        + Send
        + 'static,
> {
...
impl<
        F: FnMut(windows_core::Ref<'_, PrintTaskSourceRequestedArgs>) -> windows_core::Result<()>
            + Send
            + 'static,
    > PrintTaskSourceRequestedHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid
                == <PrintTaskSourceRequestedHandler as windows_core::Interface>::IID
...
impl StandardPrintTaskOptions {
    ...
    pub fn NUp() -> windows_core::Result<windows_core::HSTRING> {
        Self::IStandardPrintTaskOptionsStatic(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NUp)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn InputBin() -> windows_core::Result<windows_core::HSTRING> {
        Self::IStandardPrintTaskOptionsStatic(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InputBin)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    fn IStandardPrintTaskOptionsStatic<
        R,
        F: FnOnce(&IStandardPrintTaskOptionsStatic) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IStandardPrintTaskOptionsStatic2<
        R,
        F: FnOnce(&IStandardPrintTaskOptionsStatic2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IStandardPrintTaskOptionsStatic3<
        R,
        F: FnOnce(&IStandardPrintTaskOptionsStatic3) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<

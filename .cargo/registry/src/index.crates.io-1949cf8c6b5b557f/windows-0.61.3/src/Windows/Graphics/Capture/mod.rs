...
impl Direct3D11CaptureFrame {
    ...
    pub fn DirtyRegions(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<super::RectInt32>> {
        let this = &windows_core::Interface::cast::<IDirect3D11CaptureFrame2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DirtyRegions)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn DirtyRegionMode(&self) -> windows_core::Result<GraphicsCaptureDirtyRegionMode> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DirtyRegionMode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl GraphicsCaptureAccess {
    ...
    pub fn RequestAccessAsync(
        ...
        windows_future::IAsyncOperation<
            super::super::Security::Authorization::AppCapabilityAccess::AppCapabilityAccessStatus,
        >,
    > {
    ...
    fn IGraphicsCaptureAccessStatics<
        R,
        F: FnOnce(&IGraphicsCaptureAccessStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for GraphicsCaptureAccessKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Graphics.Capture.GraphicsCaptureAccessKind;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for GraphicsCaptureDirtyRegionMode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Graphics.Capture.GraphicsCaptureDirtyRegionMode;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl GraphicsCaptureItem {
        ...
        P0: windows_core::Param<super::super::UI::Composition::Visual>,
    {
        Self::IGraphicsCaptureItemStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateFromVisual)(
                windows_core::Interface::as_raw(this),
                visual.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(feature = "UI")]
    pub fn TryCreateFromWindowId(
        windowid: super::super::UI::WindowId,
    ) -> windows_core::Result<GraphicsCaptureItem> {
        Self::IGraphicsCaptureItemStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryCreateFromWindowId)(
                windows_core::Interface::as_raw(this),
                windowid,
                &mut result__,
            )
    ...
    pub fn TryCreateFromDisplayId(
        displayid: super::DisplayId,
    ) -> windows_core::Result<GraphicsCaptureItem> {
        Self::IGraphicsCaptureItemStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryCreateFromDisplayId)(
                windows_core::Interface::as_raw(this),
                displayid,
                &mut result__,
            )
...
impl GraphicsCapturePicker {
    ...
    pub fn PickSingleItemAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<GraphicsCaptureItem>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PickSingleItemAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl GraphicsCaptureSession {
    ...
    pub fn StartCapture(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).StartCapture)(windows_core::Interface::as_raw(
                this,
            ))
            .ok()
        }
    ...
    pub fn SetDirtyRegionMode(
        &self,
        value: GraphicsCaptureDirtyRegionMode,
    ) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IGraphicsCaptureSession4>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetDirtyRegionMode)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SetMinUpdateInterval(
        &self,
        value: super::super::Foundation::TimeSpan,
    ) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IGraphicsCaptureSession5>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetMinUpdateInterval)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
pub struct IDirect3D11CaptureFrame2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub DirtyRegions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DirtyRegionMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GraphicsCaptureDirtyRegionMode,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
...
windows_core::imp::define_interface!(
    IGraphicsCaptureAccessStatics,
    IGraphicsCaptureAccessStatics_Vtbl,
    0x743ed370_06ec_5040_a58a_901f0f757095
);
...
pub struct IGraphicsCaptureItemStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "UI_Composition")]
    pub CreateFromVisual: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct IGraphicsCaptureItemStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "UI")]
    pub TryCreateFromWindowId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub TryCreateFromDisplayId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::DisplayId,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct IGraphicsCapturePicker_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub PickSingleItemAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub struct IGraphicsCaptureSession4_Vtbl {
    ...
    pub SetDirtyRegionMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub struct IGraphicsCaptureSession5_Vtbl {
    ...
    pub SetMinUpdateInterval: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub struct IGraphicsCaptureSession6_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IncludeSecondaryWindows:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetIncludeSecondaryWindows:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IGraphicsCaptureSessionStatics,

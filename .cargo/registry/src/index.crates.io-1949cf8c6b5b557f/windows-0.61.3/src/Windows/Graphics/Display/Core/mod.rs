...
impl windows_core::RuntimeType for HdmiDisplayColorSpace {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Graphics.Display.Core.HdmiDisplayColorSpace;i4)",
    );
}
#[repr(C)]
...
impl windows_core::RuntimeType for HdmiDisplayHdrOption {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Graphics.Display.Core.HdmiDisplayHdrOption;i4)",
    );
}
#[repr(transparent)]
...
impl HdmiDisplayInformation {
    pub fn GetSupportedDisplayModes(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<HdmiDisplayMode>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetSupportedDisplayModes)(
    ...
    pub fn GetCurrentDisplayMode(&self) -> windows_core::Result<HdmiDisplayMode> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCurrentDisplayMode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SetDefaultDisplayModeAsync(&self) -> windows_core::Result<windows_future::IAsyncAction> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetDefaultDisplayModeAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn RequestSetCurrentDisplayModeAsync<P0>(
        &self,
        mode: P0,
        ...
        P0: windows_core::Param<HdmiDisplayMode>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestSetCurrentDisplayModeAsync)(
                windows_core::Interface::as_raw(this),
                mode.param().abi(),
                &mut result__,
            )
    ...
    pub fn RequestSetCurrentDisplayModeWithHdrAsync<P0>(
        &self,
        mode: P0,
        ...
        P0: windows_core::Param<HdmiDisplayMode>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestSetCurrentDisplayModeWithHdrAsync)(
                windows_core::Interface::as_raw(this),
                mode.param().abi(),
                hdroption,
                &mut result__,
    ...
    pub fn RequestSetCurrentDisplayModeWithHdrAndMetadataAsync<P0>(
        &self,
        mode: P0,
        hdroption: HdmiDisplayHdrOption,
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DisplayModesChanged)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveDisplayModesChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDisplayModesChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    fn IHdmiDisplayInformationStatics<
        R,
        F: FnOnce(&IHdmiDisplayInformationStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for HdmiDisplayInformation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHdmiDisplayInformation>();
}
...
impl HdmiDisplayMode {
    pub fn ResolutionWidthInRawPixels(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResolutionWidthInRawPixels)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ResolutionHeightInRawPixels(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResolutionHeightInRawPixels)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn BitsPerPixel(&self) -> windows_core::Result<u16> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BitsPerPixel)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsSdrLuminanceSupported(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsSdrLuminanceSupported)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsSmpte2084Supported(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsSmpte2084Supported)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn Is2086MetadataSupported(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Is2086MetadataSupported)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsDolbyVisionLowLatencySupported(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsDolbyVisionLowLatencySupported)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for HdmiDisplayMode {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHdmiDisplayMode>();
}
...
impl windows_core::RuntimeType for HdmiDisplayPixelEncoding {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Graphics.Display.Core.HdmiDisplayPixelEncoding;i4)",
    );
}
windows_core::imp::define_interface!(
    IHdmiDisplayInformation,
    IHdmiDisplayInformation_Vtbl,
    0x130b3c0a_f565_476e_abd5_ea05aee74c69
);
...
pub struct IHdmiDisplayInformation_Vtbl {
    ...
    pub GetSupportedDisplayModes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetCurrentDisplayMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetDefaultDisplayModeAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RequestSetCurrentDisplayModeAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RequestSetCurrentDisplayModeWithHdrAsync:
    ...
    pub RequestSetCurrentDisplayModeWithHdrAndMetadataAsync:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
            HdmiDisplayHdrOption,
    ...
    pub DisplayModesChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveDisplayModesChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IHdmiDisplayInformationStatics,
    IHdmiDisplayInformationStatics_Vtbl,
    0x6ce6b260_f42a_4a15_914c_7b8e2a5a65df
);
...
pub struct IHdmiDisplayMode_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ResolutionWidthInRawPixels:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub ResolutionHeightInRawPixels:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub RefreshRate:
    ...
    pub ColorSpace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut HdmiDisplayColorSpace,
    ) -> windows_core::HRESULT,
    pub PixelEncoding: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut HdmiDisplayPixelEncoding,
    ) -> windows_core::HRESULT,
    pub IsSdrLuminanceSupported:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsSmpte2084Supported:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub Is2086MetadataSupported:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IHdmiDisplayMode2,
    IHdmiDisplayMode2_Vtbl,
    0x07cd4e9f_4b3c_42b8_84e7_895368718af2
);

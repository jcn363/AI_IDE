windows_core::imp::define_interface!(
    ...
    0x61c2bb82_4510_4163_a87c_4e15a9558980
);
...
pub trait II2cControllerProvider_Impl: windows_core::IUnknownImpl {
    fn GetDeviceProvider(
        &self,
        settings: windows_core::Ref<'_, ProviderI2cConnectionSettings>,
    ) -> windows_core::Result<II2cDeviceProvider>;
}
    ...
    pub const fn new<Identity: II2cControllerProvider_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                match II2cControllerProvider_Impl::GetDeviceProvider(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0xad342654_57e8_453e_8329_d1e447d103a9
);
...
impl II2cDeviceProvider {
    ...
    pub fn ReadPartial(
        &self,
        buffer: &mut [u8],
    ) -> windows_core::Result<ProviderI2cTransferResult> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl II2cDeviceProvider_Vtbl {
    pub const fn new<Identity: II2cDeviceProvider_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Write<Identity: II2cDeviceProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn WritePartial<
            Identity: II2cDeviceProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match II2cDeviceProvider_Impl::WritePartial(
                    this,
                    core::slice::from_raw_parts(
                        core::mem::transmute_copy(&buffer),
                        buffer_array_size as usize,
        ...
        unsafe extern "system" fn Read<Identity: II2cDeviceProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            buffer_array_size: u32,
            buffer: *mut u8,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn ReadPartial<
            Identity: II2cDeviceProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match II2cDeviceProvider_Impl::ReadPartial(
                    this,
                    core::slice::from_raw_parts_mut(
                        core::mem::transmute_copy(&buffer),
                        buffer_array_size as usize,
        ...
        unsafe extern "system" fn WriteRead<
            Identity: II2cDeviceProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                II2cDeviceProvider_Impl::WriteRead(
                    this,
                    core::slice::from_raw_parts(
        ...
        unsafe extern "system" fn WriteReadPartial<
            Identity: II2cDeviceProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match II2cDeviceProvider_Impl::WriteReadPartial(
                    this,
                    core::slice::from_raw_parts(
                        core::mem::transmute_copy(&writebuffer),
                        writebuffer_array_size as usize,
...
windows_core::imp::define_interface!(
    II2cProvider,
    II2cProvider_Vtbl,
    0x6f13083e_bf62_4fe2_a95a_f08999669818
);
...
impl II2cProvider {
    pub fn GetControllersAsync(
        ...
        windows_future::IAsyncOperation<windows_collections::IVectorView<II2cControllerProvider>>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
windows_core::imp::define_interface!(
    ...
    IProviderI2cConnectionSettings_Vtbl,
    0xe9db4e34_e510_44b7_809d_f2f85b555339
);
...
pub struct IProviderI2cConnectionSettings_Vtbl {
    ...
    pub BusSpeed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ProviderI2cBusSpeed,
    ) -> windows_core::HRESULT,
    pub SetBusSpeed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        ProviderI2cBusSpeed,
    ) -> windows_core::HRESULT,
    pub SharingMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ProviderI2cSharingMode,
    ) -> windows_core::HRESULT,
...
impl windows_core::RuntimeType for ProviderI2cConnectionSettings {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IProviderI2cConnectionSettings>();
}
unsafe impl windows_core::Interface for ProviderI2cConnectionSettings {
    ...
    const IID: windows_core::GUID =
        <IProviderI2cConnectionSettings as windows_core::Interface>::IID;
}

...
impl Geofence {
    ...
    pub fn DwellTime(&self) -> windows_core::Result<super::super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DwellTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MonitoredStates(&self) -> windows_core::Result<MonitoredGeofenceStates> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MonitoredStates)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SingleUse(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SingleUse)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CreateWithMonitorStates<P1>(
        id: &windows_core::HSTRING,
        geoshape: P1,
        monitoredstates: MonitoredGeofenceStates,
        singleuse: bool,
    ) -> windows_core::Result<Geofence>
    where
        P1: windows_core::Param<super::IGeoshape>,
    {
        Self::IGeofenceFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithMonitorStates)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(id),
                geoshape.param().abi(),
                monitoredstates,
    ...
    pub fn CreateWithMonitorStatesAndDwellTime<P1>(
        id: &windows_core::HSTRING,
        geoshape: P1,
        monitoredstates: MonitoredGeofenceStates,
        singleuse: bool,
        ...
        P1: windows_core::Param<super::IGeoshape>,
    {
        Self::IGeofenceFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithMonitorStatesAndDwellTime)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(id),
                geoshape.param().abi(),
                monitoredstates,
    ...
    pub fn CreateWithMonitorStatesDwellTimeStartTimeAndDuration<P1>(
        id: &windows_core::HSTRING,
        geoshape: P1,
        monitoredstates: MonitoredGeofenceStates,
        singleuse: bool,
    ...
    fn IGeofenceFactory<R, F: FnOnce(&IGeofenceFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<Geofence, IGeofenceFactory> =
...
impl windows_core::RuntimeType for Geofence {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGeofence>();
}
...
impl GeofenceMonitor {
    ...
    pub fn Geofences(&self) -> windows_core::Result<windows_collections::IVector<Geofence>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Geofences)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn LastKnownGeoposition(&self) -> windows_core::Result<super::Geoposition> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LastKnownGeoposition)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GeofenceStateChanged)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn RemoveGeofenceStateChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveGeofenceStateChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn ReadReports(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<GeofenceStateChangeReport>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IGeofenceMonitorStatics<
        R,
        F: FnOnce(&IGeofenceMonitorStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<GeofenceMonitor, IGeofenceMonitorStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for GeofenceMonitor {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGeofenceMonitor>();
}
...
impl GeofenceStateChangeReport {
    ...
    pub fn Geofence(&self) -> windows_core::Result<Geofence> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Geofence)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Geoposition(&self) -> windows_core::Result<super::Geoposition> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Geoposition)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn RemovalReason(&self) -> windows_core::Result<GeofenceRemovalReason> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemovalReason)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for GeofenceStateChangeReport {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGeofenceStateChangeReport>();
}
...
windows_core::imp::define_interface!(
    IGeofence,
    IGeofence_Vtbl,
    0x9c090823_edb8_47e0_8245_5bf61d321f2d
);
...
pub struct IGeofence_Vtbl {
    ...
    pub DwellTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    ...
    pub MonitoredStates: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut MonitoredGeofenceStates,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IGeofenceFactory,
    IGeofenceFactory_Vtbl,
    0x841f624b_325f_4b90_bca7_2b8022a93796
);
...
pub struct IGeofenceFactory_Vtbl {
    ...
    pub CreateWithMonitorStates: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub CreateWithMonitorStatesAndDwellTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        MonitoredGeofenceStates,
        ...
        *mut *mut core::ffi::c_void,
        ...
        -> windows_core::HRESULT,
    pub CreateWithMonitorStatesDwellTimeStartTimeAndDuration:
...
windows_core::imp::define_interface!(
    IGeofenceMonitor,
    IGeofenceMonitor_Vtbl,
    0x4c0f5f78_1c1f_4621_bbbd_833b92247226
);
...
pub struct IGeofenceMonitor_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GeofenceMonitorStatus,
    ) -> windows_core::HRESULT,
    pub Geofences: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub LastKnownGeoposition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GeofenceStateChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveGeofenceStateChanged:
...
windows_core::imp::define_interface!(
    ...
    IGeofenceMonitorStatics_Vtbl,
    0x2dd32fcf_7e75_4899_ace3_2bd0a65cce06
);
...
windows_core::imp::define_interface!(
    ...
    IGeofenceStateChangeReport_Vtbl,
    0x9a243c18_2464_4c89_be05_b3ffff5babc5
);
...
pub struct IGeofenceStateChangeReport_Vtbl {
    ...
    pub Geofence: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Geoposition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RemovalReason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GeofenceRemovalReason,
    ) -> windows_core::HRESULT,
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]

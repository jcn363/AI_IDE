...
impl Battery {
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<Battery, windows_core::IInspectable>,
        >,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReportUpdated)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveReportUpdated(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveReportUpdated)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn AggregateBattery() -> windows_core::Result<Battery> {
        Self::IBatteryStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AggregateBattery)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<Battery>> {
        Self::IBatteryStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IBatteryStatics<R, F: FnOnce(&IBatteryStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<Battery, IBatteryStatics> =
...
impl windows_core::RuntimeType for Battery {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBattery>();
}
...
windows_core::imp::define_interface!(
    IBattery,
    IBattery_Vtbl,
    0xbc894fc6_0072_47c8_8b5d_614aaa7a437e
);
...
pub struct IBattery_Vtbl {
    ...
    pub ReportUpdated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveReportUpdated:
...
pub struct IBatteryReport_Vtbl {
    ...
    pub DesignCapacityInMilliwattHours: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FullChargeCapacityInMilliwattHours: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RemainingCapacityInMilliwattHours: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "System_Power")]
...
windows_core::imp::define_interface!(
    IBatteryStatics,
    IBatteryStatics_Vtbl,
    0x79cd72b6_9e5e_4452_bea6_dfcd541e597f
);
...
pub struct IBatteryStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AggregateBattery: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IPowerGridData,
    IPowerGridData_Vtbl,
    0xc360fb17_fc92_5f6e_999d_16a4cf9d6c40
);
...
pub struct IPowerGridData_Vtbl {
    ...
    pub IsLowUserExperienceImpact:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPowerGridForecast,
    IPowerGridForecast_Vtbl,
    0x077e4de9_ed60_58bb_a850_003c6a138685
);
...
pub struct IPowerGridForecast_Vtbl {
    ...
    pub BlockDuration: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub Forecast: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IPowerGridForecastStatics_Vtbl,
    0x5b78c806_2e4e_5bcc_bb34_cb81c60f9e12
);
...
pub struct IPowerGridForecastStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetForecast: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ForecastUpdated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveForecastUpdated:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl PowerGridData {
    ...
    pub fn IsLowUserExperienceImpact(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsLowUserExperienceImpact)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for PowerGridData {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPowerGridData>();
}
...
impl PowerGridForecast {
    ...
    pub fn BlockDuration(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BlockDuration)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn Forecast(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<PowerGridData>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Forecast)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetForecast() -> windows_core::Result<PowerGridForecast> {
        Self::IPowerGridForecastStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForecast)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IPowerGridForecastStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ForecastUpdated)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveForecastUpdated(token: i64) -> windows_core::Result<()> {
        Self::IPowerGridForecastStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveForecastUpdated)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    fn IPowerGridForecastStatics<
        R,
        F: FnOnce(&IPowerGridForecastStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
...
impl windows_core::RuntimeType for PowerGridForecast {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPowerGridForecast>();
}

...
impl GeolocationProvider {
    ...
    pub fn IsOverridden(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).IsOverridden)(
    ...
    pub fn SetOverridePosition(
        &self,
        newposition: super::BasicGeoposition,
        positionsource: super::PositionSource,
        accuracyinmeters: f64,
    ) -> windows_core::Result<LocationOverrideStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetOverridePosition)(
                windows_core::Interface::as_raw(this),
                newposition,
                positionsource,
                accuracyinmeters,
    ...
    pub fn ClearOverridePosition(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ClearOverridePosition)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsOverriddenChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveIsOverriddenChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveIsOverriddenChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for GeolocationProvider {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGeolocationProvider>();
}
...
windows_core::imp::define_interface!(
    ...
    IGeolocationProvider_Vtbl,
    0xe4cf071d_3f64_509f_8dc2_0b74a059829d
);
...
pub struct IGeolocationProvider_Vtbl {
    ...
    pub SetOverridePosition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::BasicGeoposition,
        super::PositionSource,
        f64,
        *mut LocationOverrideStatus,
    ) -> windows_core::HRESULT,
    pub ClearOverridePosition:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub IsOverriddenChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveIsOverriddenChanged:

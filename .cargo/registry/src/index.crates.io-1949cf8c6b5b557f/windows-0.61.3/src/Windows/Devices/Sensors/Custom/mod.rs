...
impl CustomSensor {
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<CustomSensor>> {
        Self::ICustomSensorStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ICustomSensorStatics<R, F: FnOnce(&ICustomSensorStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CustomSensor, ICustomSensorStatics> =
...
impl windows_core::RuntimeType for CustomSensor {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICustomSensor>();
}
...
impl windows_core::RuntimeType for CustomSensorReading {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICustomSensorReading>();
}
...
impl windows_core::RuntimeType for CustomSensorReadingChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICustomSensorReadingChangedEventArgs>();
}
unsafe impl windows_core::Interface for CustomSensorReadingChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ICustomSensorReadingChangedEventArgs as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    ICustomSensor,
    ICustomSensor_Vtbl,
    0xa136f9ad_4034_4b4d_99dd_531aac649c09
);
...
windows_core::imp::define_interface!(
    ICustomSensor2,
    ICustomSensor2_Vtbl,
    0x20db3111_ec58_4d9f_bfbd_e77825088510
);
...
windows_core::imp::define_interface!(
    ...
    ICustomSensorReading_Vtbl,
    0x64004f4d_446a_4366_a87a_5f963268ec53
);
...
windows_core::imp::define_interface!(
    ...
    0x223c98ea_bf73_4992_9a48_d3c897594ccb
);
...
windows_core::imp::define_interface!(
    ...
    ICustomSensorReadingChangedEventArgs_Vtbl,
...
windows_core::imp::define_interface!(
    ...
    ICustomSensorStatics_Vtbl,
    0x992052cf_f422_4c7d_836b_e7dc74a7124b
);

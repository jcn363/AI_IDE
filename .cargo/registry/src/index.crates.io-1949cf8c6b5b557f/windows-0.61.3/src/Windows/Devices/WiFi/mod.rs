windows_core::imp::define_interface!(
    IWiFiAdapter,
    IWiFiAdapter_Vtbl,
    0xa6c4e423_3d75_43a4_b9de_11e26b72d9b0
);
...
pub struct IWiFiAdapter_Vtbl {
    ...
    pub NetworkReport: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AvailableNetworksChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveAvailableNetworksChanged:
    ...
    pub ConnectWithPasswordCredentialAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WiFiReconnectionKind,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Security_Credentials")]
    pub ConnectWithPasswordCredentialAndSsidAsync:
...
windows_core::imp::define_interface!(
    IWiFiAdapter2,
    IWiFiAdapter2_Vtbl,
    0x5bc4501d_81e4_453d_9430_1fcafbadd6b6
);
...
pub struct IWiFiAdapter2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetWpsConfigurationAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Security_Credentials")]
    pub ConnectWithPasswordCredentialAndSsidAndConnectionMethodAsync:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
            WiFiReconnectionKind,
...
pub struct IWiFiAdapterStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub FindAllAdaptersAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IWiFiAvailableNetwork_Vtbl,
    0x26e96246_183e_4704_9826_71b4a2f0f668
);
...
pub struct IWiFiAvailableNetwork_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Uptime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub Bssid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ChannelCenterFrequencyInKilohertz:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub NetworkRssiInDecibelMilliwatts:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub SignalBars:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub NetworkKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WiFiNetworkKind,
    ) -> windows_core::HRESULT,
    pub PhyKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WiFiPhyKind,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Networking_Connectivity")]
    pub SecuritySettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Networking_Connectivity"))]
    SecuritySettings: usize,
    pub BeaconInterval: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub IsWiFiDirect:
...
windows_core::imp::define_interface!(
    ...
    IWiFiConnectionResult_Vtbl,
    0x143bdfd9_c37d_40be_a5c8_857bce85a931
);
...
pub struct IWiFiConnectionResult_Vtbl {
    ...
    pub ConnectionStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WiFiConnectionStatus,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWiFiNetworkReport,
    IWiFiNetworkReport_Vtbl,
    0x9524ded2_5911_445e_8194_be4f1a704895
);
...
pub struct IWiFiNetworkReport_Vtbl {
    ...
    pub AvailableNetworks: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IWiFiOnDemandHotspotConnectTriggerDetails_Vtbl,
    0xa268eb58_68f5_59cf_8d38_35bf44b097ef
);
...
pub struct IWiFiOnDemandHotspotConnectTriggerDetails_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RequestedNetwork: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IWiFiOnDemandHotspotConnectionResult_Vtbl,
    0x911794a1_6c82_5de3_8a4a_f9ff22a4957a
);
...
pub struct IWiFiOnDemandHotspotConnectionResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WiFiOnDemandHotspotConnectStatus,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWiFiOnDemandHotspotNetwork,
    IWiFiOnDemandHotspotNetwork_Vtbl,
...
pub struct IWiFiOnDemandHotspotNetwork_Vtbl {
    ...
    pub UpdateProperties: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IWiFiOnDemandHotspotNetworkProperties_Vtbl,
    0xc810a1f2_c81d_5852_be50_e4bd4d81e98d
);
...
pub struct IWiFiOnDemandHotspotNetworkProperties_Vtbl {
    ...
    pub Availability: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WiFiOnDemandHotspotAvailability,
    ) -> windows_core::HRESULT,
    pub SetAvailability: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WiFiOnDemandHotspotAvailability,
    ) -> windows_core::HRESULT,
    pub RemainingBatteryPercent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetRemainingBatteryPercent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CellularBars: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetCellularBars: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsMetered:
...
windows_core::imp::define_interface!(
    IWiFiOnDemandHotspotNetworkStatics,
    IWiFiOnDemandHotspotNetworkStatics_Vtbl,
    0x00f5b8ac_80e7_5054_871c_8739f374e3c9
);
...
pub struct IWiFiOnDemandHotspotNetworkStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetOrCreateById: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IWiFiWpsConfigurationResult_Vtbl,
    0x67b49871_17ee_42d1_b14f_5a11f1226fb5
);
...
pub struct IWiFiWpsConfigurationResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WiFiWpsConfigurationStatus,
    ) -> windows_core::HRESULT,
    pub SupportedWpsKinds: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl WiFiAdapter {
    ...
    pub fn NetworkAdapter(
        &self,
    ) -> windows_core::Result<super::super::Networking::Connectivity::NetworkAdapter> {
        let this = self;
        unsafe {
    ...
    pub fn NetworkReport(&self) -> windows_core::Result<WiFiNetworkReport> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NetworkReport)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<WiFiAdapter, windows_core::IInspectable>,
        >,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AvailableNetworksChanged)(
                windows_core::Interface::as_raw(this),
                args.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveAvailableNetworksChanged(&self, eventcookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveAvailableNetworksChanged)(
                windows_core::Interface::as_raw(this),
                eventcookie,
            )
            .ok()
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<WiFiConnectionResult>>
    where
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ConnectWithPasswordCredentialAsync<P0, P2>(
        &self,
        availablenetwork: P0,
        reconnectionkind: WiFiReconnectionKind,
        passwordcredential: P2,
    ) -> windows_core::Result<windows_future::IAsyncOperation<WiFiConnectionResult>>
    where
        P0: windows_core::Param<WiFiAvailableNetwork>,
        P2: windows_core::Param<super::super::Security::Credentials::PasswordCredential>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConnectWithPasswordCredentialAsync)(
                windows_core::Interface::as_raw(this),
                availablenetwork.param().abi(),
                reconnectionkind,
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ConnectWithPasswordCredentialAndSsidAsync<P0, P2>(
        &self,
        availablenetwork: P0,
        reconnectionkind: WiFiReconnectionKind,
        passwordcredential: P2,
        ssid: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<WiFiConnectionResult>>
    where
        P0: windows_core::Param<WiFiAvailableNetwork>,
        P2: windows_core::Param<super::super::Security::Credentials::PasswordCredential>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConnectWithPasswordCredentialAndSsidAsync)(
                windows_core::Interface::as_raw(this),
                availablenetwork.param().abi(),
                reconnectionkind,
                passwordcredential.param().abi(),
                core::mem::transmute_copy(ssid),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub fn Disconnect(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).Disconnect)(windows_core::Interface::as_raw(
                this,
            ))
            .ok()
        }
    }
    pub fn GetWpsConfigurationAsync<P0>(
        &self,
        availablenetwork: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<WiFiWpsConfigurationResult>>
    where
        P0: windows_core::Param<WiFiAvailableNetwork>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetWpsConfigurationAsync)(
                windows_core::Interface::as_raw(this),
                availablenetwork.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ConnectWithPasswordCredentialAndSsidAndConnectionMethodAsync<P0, P2>(
        &self,
        availablenetwork: P0,
        reconnectionkind: WiFiReconnectionKind,
        passwordcredential: P2,
    ...
    pub fn FindAllAdaptersAsync() -> windows_core::Result<
        windows_future::IAsyncOperation<windows_collections::IVectorView<WiFiAdapter>>,
    > {
        Self::IWiFiAdapterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindAllAdaptersAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<WiFiAdapter>> {
        Self::IWiFiAdapterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<WiFiAccessStatus>> {
        Self::IWiFiAdapterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IWiFiAdapterStatics<R, F: FnOnce(&IWiFiAdapterStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<WiFiAdapter, IWiFiAdapterStatics> =
...
impl windows_core::RuntimeType for WiFiAdapter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWiFiAdapter>();
}
...
impl WiFiAvailableNetwork {
    pub fn Uptime(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Uptime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn Bssid(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Bssid)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn ChannelCenterFrequencyInKilohertz(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ChannelCenterFrequencyInKilohertz)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn NetworkRssiInDecibelMilliwatts(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NetworkRssiInDecibelMilliwatts)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SignalBars(&self) -> windows_core::Result<u8> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SignalBars)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn NetworkKind(&self) -> windows_core::Result<WiFiNetworkKind> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NetworkKind)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PhyKind(&self) -> windows_core::Result<WiFiPhyKind> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PhyKind)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SecuritySettings(
        &self,
    ) -> windows_core::Result<super::super::Networking::Connectivity::NetworkSecuritySettings> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SecuritySettings)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn BeaconInterval(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BeaconInterval)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsWiFiDirect(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsWiFiDirect)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for WiFiAvailableNetwork {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWiFiAvailableNetwork>();
}
...
impl windows_core::RuntimeType for WiFiConnectionResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWiFiConnectionResult>();
}
...
impl WiFiNetworkReport {
    ...
    pub fn AvailableNetworks(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<WiFiAvailableNetwork>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AvailableNetworks)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for WiFiNetworkReport {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWiFiNetworkReport>();
}
...
impl windows_core::RuntimeType for WiFiOnDemandHotspotAvailability {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.WiFi.WiFiOnDemandHotspotAvailability;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for WiFiOnDemandHotspotCellularBars {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.WiFi.WiFiOnDemandHotspotCellularBars;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for WiFiOnDemandHotspotConnectStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.WiFi.WiFiOnDemandHotspotConnectStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl WiFiOnDemandHotspotConnectTriggerDetails {
    pub fn RequestedNetwork(&self) -> windows_core::Result<WiFiOnDemandHotspotNetwork> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestedNetwork)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ConnectAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<WiFiOnDemandHotspotConnectionResult>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
unsafe impl windows_core::Interface for WiFiOnDemandHotspotConnectTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IWiFiOnDemandHotspotConnectTriggerDetails as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for WiFiOnDemandHotspotConnectionResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWiFiOnDemandHotspotConnectionResult>();
}
unsafe impl windows_core::Interface for WiFiOnDemandHotspotConnectionResult {
    ...
    const IID: windows_core::GUID =
        <IWiFiOnDemandHotspotConnectionResult as windows_core::Interface>::IID;
}
...
impl WiFiOnDemandHotspotNetwork {
        ...
        P0: windows_core::Param<WiFiOnDemandHotspotNetworkProperties>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).UpdateProperties)(
                windows_core::Interface::as_raw(this),
                newproperties.param().abi(),
            )
            .ok()
        }
    }
    ...
    pub fn GetOrCreateById(
        networkid: windows_core::GUID,
    ) -> windows_core::Result<WiFiOnDemandHotspotNetwork> {
        Self::IWiFiOnDemandHotspotNetworkStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetOrCreateById)(
                windows_core::Interface::as_raw(this),
                networkid,
                &mut result__,
            )
    ...
    fn IWiFiOnDemandHotspotNetworkStatics<
        R,
        F: FnOnce(&IWiFiOnDemandHotspotNetworkStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
...
impl windows_core::RuntimeType for WiFiOnDemandHotspotNetwork {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWiFiOnDemandHotspotNetwork>();
}
...
impl WiFiOnDemandHotspotNetworkProperties {
    ...
    pub fn SetAvailability(
        &self,
        value: WiFiOnDemandHotspotAvailability,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAvailability)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn RemainingBatteryPercent(
        &self,
    ) -> windows_core::Result<super::super::Foundation::IReference<u32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemainingBatteryPercent)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::Foundation::IReference<u32>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetRemainingBatteryPercent)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn CellularBars(
        &self,
    ) -> windows_core::Result<super::super::Foundation::IReference<WiFiOnDemandHotspotCellularBars>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CellularBars)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::IReference<WiFiOnDemandHotspotCellularBars>,
        >,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetCellularBars)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn IsMetered(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsMetered)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIsMetered(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsMetered)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for WiFiOnDemandHotspotNetworkProperties {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWiFiOnDemandHotspotNetworkProperties>();
}
unsafe impl windows_core::Interface for WiFiOnDemandHotspotNetworkProperties {
    ...
    const IID: windows_core::GUID =
        <IWiFiOnDemandHotspotNetworkProperties as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for WiFiPhyKind {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.WiFi.WiFiPhyKind;i4)");
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl WiFiWpsConfigurationResult {
    ...
    pub fn SupportedWpsKinds(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<WiFiWpsKind>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedWpsKinds)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for WiFiWpsConfigurationResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWiFiWpsConfigurationResult>();
}
...
impl windows_core::RuntimeType for WiFiWpsKind {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.WiFi.WiFiWpsKind;i4)");
}

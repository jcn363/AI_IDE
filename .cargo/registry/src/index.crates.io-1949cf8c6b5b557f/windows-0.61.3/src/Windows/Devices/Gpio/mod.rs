...
impl GpioChangeCounter {
    ...
    pub fn SetPolarity(&self, value: GpioChangePolarity) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPolarity)(
    ...
    pub fn Polarity(&self) -> windows_core::Result<GpioChangePolarity> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).Polarity)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsStarted(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsStarted)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn Read(&self) -> windows_core::Result<GpioChangeCount> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Read)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    fn IGpioChangeCounterFactory<
        R,
        F: FnOnce(&IGpioChangeCounterFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for GpioChangeCounter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGpioChangeCounter>();
}
...
impl GpioChangeReader {
    ...
    pub fn IsEmpty(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsEmpty)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsOverflowed(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsOverflowed)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetNextItem(&self) -> windows_core::Result<GpioChangeRecord> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNextItem)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PeekNextItem(&self) -> windows_core::Result<GpioChangeRecord> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PeekNextItem)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetAllItems(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<GpioChangeRecord>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAllItems)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn WaitForItemsAsync(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WaitForItemsAsync)(
                windows_core::Interface::as_raw(this),
                count,
                &mut result__,
            )
    ...
    pub fn CreateWithCapacity<P0>(
        pin: P0,
        mincapacity: i32,
    ) -> windows_core::Result<GpioChangeReader>
    where
        P0: windows_core::Param<GpioPin>,
    {
        Self::IGpioChangeReaderFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithCapacity)(
                windows_core::Interface::as_raw(this),
                pin.param().abi(),
                mincapacity,
                &mut result__,
    ...
    fn IGpioChangeReaderFactory<
        R,
        F: FnOnce(&IGpioChangeReaderFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<GpioChangeReader, IGpioChangeReaderFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for GpioChangeReader {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGpioChangeReader>();
}
...
impl GpioController {
    pub fn PinCount(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PinCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn OpenPin(&self, pinnumber: i32) -> windows_core::Result<GpioPin> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).OpenPin)(
                windows_core::Interface::as_raw(this),
                pinnumber,
                &mut result__,
            )
    ...
    ) -> windows_core::Result<GpioPin> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).OpenPinWithSharingMode)(
                windows_core::Interface::as_raw(this),
                pinnumber,
                sharingmode,
                &mut result__,
    ...
    pub fn TryOpenPin(
        ...
        pinnumber: i32,
        sharingmode: GpioSharingMode,
        pin: &mut Option<GpioPin>,
        openstatus: &mut GpioOpenStatus,
    ) -> windows_core::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryOpenPin)(
                windows_core::Interface::as_raw(this),
                pinnumber,
                sharingmode,
                pin as *mut _ as _,
    ...
    #[cfg(feature = "Devices_Gpio_Provider")]
    pub fn GetControllersAsync<P0>(
        provider: P0,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<windows_collections::IVectorView<GpioController>>,
    >
    where
        P0: windows_core::Param<Provider::IGpioProvider>,
    {
        Self::IGpioControllerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetControllersAsync)(
                windows_core::Interface::as_raw(this),
                provider.param().abi(),
                &mut result__,
            )
    ...
    fn IGpioControllerStatics<R, F: FnOnce(&IGpioControllerStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<GpioController, IGpioControllerStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IGpioControllerStatics2<
        R,
        F: FnOnce(&IGpioControllerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<GpioController, IGpioControllerStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for GpioController {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGpioController>();
}
...
impl windows_core::RuntimeType for GpioOpenStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Gpio.GpioOpenStatus;i4)");
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl GpioPin {
    ...
    pub fn DebounceTimeout(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DebounceTimeout)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetDebounceTimeout(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDebounceTimeout)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn PinNumber(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PinNumber)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsDriveModeSupported(&self, drivemode: GpioPinDriveMode) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsDriveModeSupported)(
                windows_core::Interface::as_raw(this),
                drivemode,
                &mut result__,
            )
    ...
    pub fn GetDriveMode(&self) -> windows_core::Result<GpioPinDriveMode> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDriveMode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetDriveMode(&self, value: GpioPinDriveMode) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDriveMode)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for GpioPin {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGpioPin>();
}
...
impl windows_core::RuntimeType for GpioPinEdge {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Gpio.GpioPinEdge;i4)");
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for GpioPinValue {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Gpio.GpioPinValue;i4)");
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for GpioPinValueChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGpioPinValueChangedEventArgs>();
}
...
pub struct IGpioChangeCounter_Vtbl {
    ...
    pub SetPolarity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        GpioChangePolarity,
    ) -> windows_core::HRESULT,
    pub Polarity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GpioChangePolarity,
    ) -> windows_core::HRESULT,
    pub IsStarted:
...
windows_core::imp::define_interface!(
    IGpioChangeCounterFactory,
    IGpioChangeCounterFactory_Vtbl,
    0x147d94b6_0a9e_410c_b4fa_f89f4052084d
);
...
windows_core::imp::define_interface!(
    IGpioChangeReader,
    IGpioChangeReader_Vtbl,
    0x0abc885f_e031_48e8_8590_70de78363c6d
);
...
pub struct IGpioChangeReader_Vtbl {
    ...
    pub GetNextItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GpioChangeRecord,
    ) -> windows_core::HRESULT,
    pub PeekNextItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GpioChangeRecord,
    ) -> windows_core::HRESULT,
    pub GetAllItems: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub WaitForItemsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IGpioChangeReaderFactory_Vtbl,
    0xa9598ef3_390e_441a_9d1c_e8de0b2df0df
);
...
pub struct IGpioChangeReaderFactory_Vtbl {
    ...
    pub CreateWithCapacity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IGpioController,
    IGpioController_Vtbl,
    0x284012e3_7461_469c_a8bc_61d69d08a53c
);
...
pub struct IGpioController_Vtbl {
    ...
    pub PinCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub OpenPin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OpenPinWithSharingMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        GpioSharingMode,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TryOpenPin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        GpioSharingMode,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x2ed6f42e_7af7_4116_9533_c43d99a1fb64
);
...
windows_core::imp::define_interface!(
    ...
    IGpioControllerStatics2_Vtbl,
    0x912b7d20_6ca4_4106_a373_fffd346b0e5b
);
...
pub struct IGpioControllerStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Devices_Gpio_Provider")]
    pub GetControllersAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IGpioPin,
    IGpioPin_Vtbl,
    0x11d9b087_afae_4790_9ee9_e0eac942d201
);
...
pub struct IGpioPin_Vtbl {
    ...
    pub DebounceTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub SetDebounceTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub IsDriveModeSupported: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        GpioPinDriveMode,
        *mut bool,
    ) -> windows_core::HRESULT,
    pub GetDriveMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GpioPinDriveMode,
    ) -> windows_core::HRESULT,
    pub SetDriveMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        GpioPinDriveMode,
    ) -> windows_core::HRESULT,
    pub Write:
        unsafe extern "system" fn(*mut core::ffi::c_void, GpioPinValue) -> windows_core::HRESULT,
    pub Read: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GpioPinValue,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x3137aae1_703d_4059_bd24_b5b25dffb84e
);

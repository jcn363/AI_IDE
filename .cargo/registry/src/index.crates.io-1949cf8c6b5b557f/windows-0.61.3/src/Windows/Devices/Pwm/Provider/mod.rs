windows_core::imp::define_interface!(
    ...
    0x1300593b_e2e3_40a4_b7d9_48dff0377a52
);
...
impl IPwmControllerProvider {
    ...
    pub fn AcquirePin(&self, pin: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AcquirePin)(
                windows_core::Interface::as_raw(this),
                pin,
            )
            .ok()
    ...
    pub fn ReleasePin(&self, pin: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReleasePin)(
                windows_core::Interface::as_raw(this),
                pin,
            )
            .ok()
    ...
    pub fn EnablePin(&self, pin: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).EnablePin)(
                windows_core::Interface::as_raw(this),
                pin,
            )
            .ok()
    ...
    pub fn DisablePin(&self, pin: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).DisablePin)(
                windows_core::Interface::as_raw(this),
                pin,
            )
            .ok()
    ...
    pub fn SetPulseParameters(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPulseParameters)(
                windows_core::Interface::as_raw(this),
                pin,
                dutycycle,
                invertpolarity,
...
impl IPwmControllerProvider_Vtbl {
    pub const fn new<Identity: IPwmControllerProvider_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn ActualFrequency<
            Identity: IPwmControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetDesiredFrequency<
            Identity: IPwmControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn MaxFrequency<
            Identity: IPwmControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn MinFrequency<
            Identity: IPwmControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AcquirePin<
            Identity: IPwmControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ReleasePin<
            Identity: IPwmControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnablePin<
            Identity: IPwmControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn DisablePin<
            Identity: IPwmControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetPulseParameters<
            Identity: IPwmControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPwmControllerProvider_Impl::SetPulseParameters(
                    this,
                    pin,
                    dutycycle,
                    invertpolarity,
...
pub struct IPwmControllerProvider_Vtbl {
    ...
    pub SetPulseParameters:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, f64, bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPwmProvider,
    IPwmProvider_Vtbl,
    0xa3301228_52f1_47b0_9349_66ba43d25902
);
...
impl IPwmProvider {
    pub fn GetControllers(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<IPwmControllerProvider>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IPwmProvider_Vtbl {
    pub const fn new<Identity: IPwmProvider_Impl, const OFFSET: isize>() -> Self {
        ...
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IPwmProvider, OFFSET>(),

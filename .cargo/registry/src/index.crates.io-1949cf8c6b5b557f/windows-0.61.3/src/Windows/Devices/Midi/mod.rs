windows_core::imp::define_interface!(
    ...
    IMidiChannelPressureMessage_Vtbl,
    0xbe1fa860_62b4_4d52_a37e_92e54d35b909
);
...
windows_core::imp::define_interface!(
    ...
    IMidiChannelPressureMessageFactory_Vtbl,
    0x6218ed2f_2284_412a_94cf_10fb04842c6c
);
...
pub struct IMidiChannelPressureMessageFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateMidiChannelPressureMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        u8,
...
windows_core::imp::define_interface!(
    ...
    IMidiControlChangeMessage_Vtbl,
    0xb7e15f83_780d_405f_b781_3e1598c97f40
);
...
windows_core::imp::define_interface!(
    ...
    IMidiControlChangeMessageFactory_Vtbl,
    0x2ab14321_956c_46ad_9752_f87f55052fe3
);
...
pub struct IMidiControlChangeMessageFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateMidiControlChangeMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        u8,
        u8,
...
windows_core::imp::define_interface!(
    IMidiInPort,
    IMidiInPort_Vtbl,
    0xd5c1d9db_971a_4eaf_a23d_ea19fe607ff9
);
...
windows_core::imp::define_interface!(
    IMidiInPortStatics,
    IMidiInPortStatics_Vtbl,
    0x44c439dc_67ff_4a6e_8bac_fdb6610cf296
);
...
windows_core::imp::define_interface!(
    IMidiMessage,
    IMidiMessage_Vtbl,
    0x79767945_1094_4283_9be0_289fc0ee8334
);
...
impl IMidiMessage_Vtbl {
    pub const fn new<Identity: IMidiMessage_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Timestamp<Identity: IMidiMessage_Impl, const OFFSET: isize>(
        ...
        unsafe extern "system" fn RawData<Identity: IMidiMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Type<Identity: IMidiMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x76566e56_f328_4b51_907d_b3a8ce96bf80
);
...
windows_core::imp::define_interface!(
    ...
    0x16fd8af4_198e_4d8f_a654_d305a293548f
);
...
windows_core::imp::define_interface!(
    ...
    0xa6b240e0_a749_425f_8af4_a4d979cc15b5
);
...
pub struct IMidiNoteOffMessageFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateMidiNoteOffMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        u8,
        u8,
...
windows_core::imp::define_interface!(
    ...
    0xe0224af5_6181_46dd_afa2_410004c057aa
);
...
windows_core::imp::define_interface!(
    ...
    IMidiNoteOnMessageFactory_Vtbl,
    0x9b4280a0_59c1_420e_b517_15a10aa9606b
);
...
pub struct IMidiNoteOnMessageFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateMidiNoteOnMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        u8,
        u8,
...
windows_core::imp::define_interface!(
    IMidiOutPort,
    IMidiOutPort_Vtbl,
    0x931d6d9f_57a2_4a3a_adb8_4640886f6693
);
...
impl IMidiOutPort {
        ...
        P0: windows_core::Param<IMidiMessage>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SendMessage)(
                windows_core::Interface::as_raw(this),
                midimessage.param().abi(),
            )
            .ok()
        }
    }
        ...
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SendBuffer)(
                windows_core::Interface::as_raw(this),
                mididata.param().abi(),
            )
            .ok()
...
pub trait IMidiOutPort_Impl: super::super::Foundation::IClosable_Impl {
    fn SendMessage(
        &self,
        midiMessage: windows_core::Ref<'_, IMidiMessage>,
    ) -> windows_core::Result<()>;
    fn SendBuffer(
        &self,
        midiData: windows_core::Ref<'_, super::super::Storage::Streams::IBuffer>,
    ) -> windows_core::Result<()>;
...
impl IMidiOutPort_Vtbl {
    pub const fn new<Identity: IMidiOutPort_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SendMessage<Identity: IMidiOutPort_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            midimessage: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SendBuffer<Identity: IMidiOutPort_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            mididata: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn DeviceId<Identity: IMidiOutPort_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
pub struct IMidiOutPort_Vtbl {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub SendBuffer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
...
windows_core::imp::define_interface!(
    IMidiOutPortStatics,
    IMidiOutPortStatics_Vtbl,
    0x065cc3e9_0f88_448b_9b64_a95826c65b8f
);
...
windows_core::imp::define_interface!(
    ...
    IMidiPitchBendChangeMessage_Vtbl,
    0x29df4cb1_2e9f_4faf_8c2b_9cb82a9079ca
);
...
windows_core::imp::define_interface!(
    ...
    IMidiPitchBendChangeMessageFactory_Vtbl,
...
pub struct IMidiPitchBendChangeMessageFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateMidiPitchBendChangeMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        u16,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IMidiPolyphonicKeyPressureMessage_Vtbl,
    0x1f7337fe_ace8_48a0_868e_7cdbf20f04d6
);
...
windows_core::imp::define_interface!(
    ...
    IMidiPolyphonicKeyPressureMessageFactory_Vtbl,
    0xe98f483e_c4b3_4dd2_917c_e349815a1b3b
);
...
pub struct IMidiPolyphonicKeyPressureMessageFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateMidiPolyphonicKeyPressureMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        u8,
        u8,
...
windows_core::imp::define_interface!(
    ...
    0x9cbb3c78_7a3e_4327_aa98_20b8e4485af8
);
...
windows_core::imp::define_interface!(
    ...
    IMidiProgramChangeMessageFactory_Vtbl,
    0xd6b04387_524b_4104_9c99_6572bfd2e261
);
...
pub struct IMidiProgramChangeMessageFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateMidiProgramChangeMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        u8,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IMidiSongPositionPointerMessage_Vtbl,
    0x4ca50c56_ec5e_4ae4_a115_88dc57cc2b79
);
...
windows_core::imp::define_interface!(
    ...
    IMidiSongPositionPointerMessageFactory_Vtbl,
    0x9c00e996_f10b_4fea_b395_f5d6cf80f64e
);
...
pub struct IMidiSongPositionPointerMessageFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateMidiSongPositionPointerMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u16,
        *mut *mut core::ffi::c_void,
    )
...
windows_core::imp::define_interface!(
    ...
    0x49f0f27f_6d83_4741_a5bf_4629f6be974f
);
...
windows_core::imp::define_interface!(
    ...
    IMidiSongSelectMessageFactory_Vtbl,
    0x848878e4_8748_4129_a66c_a05493f75daa
);
...
pub struct IMidiSongSelectMessageFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateMidiSongSelectMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IMidiSynthesizer,
    IMidiSynthesizer_Vtbl,
    0xf0da155e_db90_405f_b8ae_21d2e17f2e45
);
...
windows_core::imp::define_interface!(
    ...
    IMidiSynthesizerStatics_Vtbl,
    0x4224eaa8_6629_4d6b_aa8f_d4521a5a31ce
);
...
pub struct IMidiSynthesizerStatics_Vtbl {
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub CreateFromAudioDeviceAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub IsSynthesizer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut bool,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x083de222_3b74_4320_9b42_0ca8545f8a24
);
...
pub struct IMidiSystemExclusiveMessageFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Storage_Streams")]
    pub CreateMidiSystemExclusiveMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IMidiTimeCodeMessage_Vtbl,
    0x0bf7087d_fa63_4a1c_8deb_c0e87796a6d7
);
...
windows_core::imp::define_interface!(
    ...
    IMidiTimeCodeMessageFactory_Vtbl,
    0xeb3099c5_771c_40de_b961_175a7489a85e
);
...
pub struct IMidiTimeCodeMessageFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateMidiTimeCodeMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        u8,
        *mut *mut core::ffi::c_void,
...
impl windows_core::RuntimeType for MidiActiveSensingMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiMessage>();
}
...
impl MidiChannelPressureMessage {
    ...
    pub fn CreateMidiChannelPressureMessage(
        channel: u8,
        pressure: u8,
    ) -> windows_core::Result<MidiChannelPressureMessage> {
        Self::IMidiChannelPressureMessageFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateMidiChannelPressureMessage)(
                windows_core::Interface::as_raw(this),
                channel,
                pressure,
                &mut result__,
    ...
    fn IMidiChannelPressureMessageFactory<
        R,
        F: FnOnce(&IMidiChannelPressureMessageFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for MidiChannelPressureMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiChannelPressureMessage>();
}
...
impl MidiControlChangeMessage {
    ...
    pub fn ControlValue(&self) -> windows_core::Result<u8> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ControlValue)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CreateMidiControlChangeMessage(
        channel: u8,
        controller: u8,
        controlvalue: u8,
    ) -> windows_core::Result<MidiControlChangeMessage> {
        Self::IMidiControlChangeMessageFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateMidiControlChangeMessage)(
                windows_core::Interface::as_raw(this),
                channel,
                controller,
                controlvalue,
    ...
    fn IMidiControlChangeMessageFactory<
        R,
        F: FnOnce(&IMidiControlChangeMessageFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for MidiControlChangeMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiControlChangeMessage>();
}
...
impl MidiInPort {
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<MidiInPort, MidiMessageReceivedEventArgs>,
        >,
    {
        let this = self;
        unsafe {
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<MidiInPort>> {
    ...
    fn IMidiInPortStatics<R, F: FnOnce(&IMidiInPortStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<MidiInPort, IMidiInPortStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for MidiInPort {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiInPort>();
}
...
impl windows_core::RuntimeType for MidiMessageType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Midi.MidiMessageType;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl MidiNoteOffMessage {
    ...
    pub fn Note(&self) -> windows_core::Result<u8> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Note)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CreateMidiNoteOffMessage(
        channel: u8,
        note: u8,
        velocity: u8,
    ) -> windows_core::Result<MidiNoteOffMessage> {
        Self::IMidiNoteOffMessageFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateMidiNoteOffMessage)(
                windows_core::Interface::as_raw(this),
                channel,
                note,
                velocity,
    ...
    fn IMidiNoteOffMessageFactory<
        R,
        F: FnOnce(&IMidiNoteOffMessageFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for MidiNoteOffMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiNoteOffMessage>();
}
...
impl MidiNoteOnMessage {
    ...
    pub fn CreateMidiNoteOnMessage(
        channel: u8,
        note: u8,
        velocity: u8,
    ) -> windows_core::Result<MidiNoteOnMessage> {
        Self::IMidiNoteOnMessageFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateMidiNoteOnMessage)(
                windows_core::Interface::as_raw(this),
                channel,
                note,
                velocity,
    ...
    fn IMidiNoteOnMessageFactory<
        R,
        F: FnOnce(&IMidiNoteOnMessageFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for MidiNoteOnMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiNoteOnMessage>();
}
...
impl MidiOutPort {
    ...
    pub fn FromIdAsync(
        deviceid: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<IMidiOutPort>> {
    ...
    fn IMidiOutPortStatics<R, F: FnOnce(&IMidiOutPortStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<MidiOutPort, IMidiOutPortStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for MidiOutPort {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiOutPort>();
}
...
impl MidiPitchBendChangeMessage {
    ...
    pub fn Bend(&self) -> windows_core::Result<u16> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Bend)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CreateMidiPitchBendChangeMessage(
        channel: u8,
        bend: u16,
    ) -> windows_core::Result<MidiPitchBendChangeMessage> {
        Self::IMidiPitchBendChangeMessageFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateMidiPitchBendChangeMessage)(
                windows_core::Interface::as_raw(this),
                channel,
                bend,
                &mut result__,
    ...
    fn IMidiPitchBendChangeMessageFactory<
        R,
        F: FnOnce(&IMidiPitchBendChangeMessageFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for MidiPitchBendChangeMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiPitchBendChangeMessage>();
}
...
impl MidiPolyphonicKeyPressureMessage {
    ...
    pub fn CreateMidiPolyphonicKeyPressureMessage(
        channel: u8,
        note: u8,
        pressure: u8,
    ) -> windows_core::Result<MidiPolyphonicKeyPressureMessage> {
        Self::IMidiPolyphonicKeyPressureMessageFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateMidiPolyphonicKeyPressureMessage)(
                windows_core::Interface::as_raw(this),
                channel,
                note,
                pressure,
    ...
    fn IMidiPolyphonicKeyPressureMessageFactory<
        R,
        F: FnOnce(&IMidiPolyphonicKeyPressureMessageFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for MidiPolyphonicKeyPressureMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiPolyphonicKeyPressureMessage>();
}
unsafe impl windows_core::Interface for MidiPolyphonicKeyPressureMessage {
    ...
    const IID: windows_core::GUID =
        <IMidiPolyphonicKeyPressureMessage as windows_core::Interface>::IID;
}
...
impl MidiProgramChangeMessage {
    ...
    pub fn Program(&self) -> windows_core::Result<u8> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Program)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CreateMidiProgramChangeMessage(
        channel: u8,
        program: u8,
    ) -> windows_core::Result<MidiProgramChangeMessage> {
        Self::IMidiProgramChangeMessageFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateMidiProgramChangeMessage)(
                windows_core::Interface::as_raw(this),
                channel,
                program,
                &mut result__,
    ...
    fn IMidiProgramChangeMessageFactory<
        R,
        F: FnOnce(&IMidiProgramChangeMessageFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for MidiProgramChangeMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiProgramChangeMessage>();
}
...
impl MidiSongPositionPointerMessage {
    ...
    pub fn Beats(&self) -> windows_core::Result<u16> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Beats)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CreateMidiSongPositionPointerMessage(
        beats: u16,
    ) -> windows_core::Result<MidiSongPositionPointerMessage> {
        Self::IMidiSongPositionPointerMessageFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateMidiSongPositionPointerMessage)(
                windows_core::Interface::as_raw(this),
                beats,
                &mut result__,
            )
    ...
    fn IMidiSongPositionPointerMessageFactory<
        R,
        F: FnOnce(&IMidiSongPositionPointerMessageFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for MidiSongPositionPointerMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiSongPositionPointerMessage>();
}
unsafe impl windows_core::Interface for MidiSongPositionPointerMessage {
    ...
    const IID: windows_core::GUID =
        <IMidiSongPositionPointerMessage as windows_core::Interface>::IID;
}
...
impl MidiSongSelectMessage {
    ...
    pub fn Song(&self) -> windows_core::Result<u8> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Song)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CreateMidiSongSelectMessage(song: u8) -> windows_core::Result<MidiSongSelectMessage> {
        Self::IMidiSongSelectMessageFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateMidiSongSelectMessage)(
                windows_core::Interface::as_raw(this),
                song,
                &mut result__,
            )
    ...
    fn IMidiSongSelectMessageFactory<
        R,
        F: FnOnce(&IMidiSongSelectMessageFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for MidiSongSelectMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiSongSelectMessage>();
}
...
impl MidiSynthesizer {
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn CreateFromAudioDeviceAsync<P0>(
        audiodevice: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<MidiSynthesizer>>
    where
        P0: windows_core::Param<super::Enumeration::DeviceInformation>,
    {
        Self::IMidiSynthesizerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateFromAudioDeviceAsync)(
                windows_core::Interface::as_raw(this),
                audiodevice.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
        ...
        P0: windows_core::Param<super::Enumeration::DeviceInformation>,
    {
        Self::IMidiSynthesizerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsSynthesizer)(
                windows_core::Interface::as_raw(this),
                mididevice.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        })
    ...
    fn IMidiSynthesizerStatics<
        R,
        F: FnOnce(&IMidiSynthesizerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<MidiSynthesizer, IMidiSynthesizerStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for MidiSynthesizer {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiSynthesizer>();
}
...
impl MidiSystemExclusiveMessage {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateMidiSystemExclusiveMessage<P0>(
        rawdata: P0,
    ) -> windows_core::Result<MidiSystemExclusiveMessage>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::IMidiSystemExclusiveMessageFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateMidiSystemExclusiveMessage)(
                windows_core::Interface::as_raw(this),
                rawdata.param().abi(),
                &mut result__,
            )
    ...
    fn IMidiSystemExclusiveMessageFactory<
        R,
        F: FnOnce(&IMidiSystemExclusiveMessageFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl MidiTimeCodeMessage {
    ...
    pub fn FrameType(&self) -> windows_core::Result<u8> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FrameType)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CreateMidiTimeCodeMessage(
        frametype: u8,
        values: u8,
    ) -> windows_core::Result<MidiTimeCodeMessage> {
        Self::IMidiTimeCodeMessageFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateMidiTimeCodeMessage)(
                windows_core::Interface::as_raw(this),
                frametype,
                values,
                &mut result__,
    ...
    fn IMidiTimeCodeMessageFactory<
        R,
        F: FnOnce(&IMidiTimeCodeMessageFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for MidiTimeCodeMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMidiTimeCodeMessage>();
}

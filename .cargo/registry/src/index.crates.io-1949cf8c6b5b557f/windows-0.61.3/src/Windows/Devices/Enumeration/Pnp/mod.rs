windows_core::imp::define_interface!(
    IPnpObject,
    IPnpObject_Vtbl,
    0x95c66258_733b_4a8f_93a3_db078ac870c1
);
...
windows_core::imp::define_interface!(
    IPnpObjectStatics,
    IPnpObjectStatics_Vtbl,
    0xb3c32a3d_d168_4660_bbf3_a733b14b6e01
);
...
windows_core::imp::define_interface!(
    IPnpObjectUpdate,
    IPnpObjectUpdate_Vtbl,
    0x6f59e812_001e_4844_bcc6_432886856a17
);
...
windows_core::imp::define_interface!(
    IPnpObjectWatcher,
    IPnpObjectWatcher_Vtbl,
    0x83c95ca8_4772_4a7a_aca8_e48c42a89c44
);
...
impl PnpObject {
    ...
    pub fn CreateFromIdAsync<P2>(
        r#type: PnpObjectType,
        id: &windows_core::HSTRING,
        requestedproperties: P2,
    ) -> windows_core::Result<windows_future::IAsyncOperation<PnpObject>>
    where
        P2: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::IPnpObjectStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).CreateFromIdAsync)(
                ...
                requestedproperties.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn FindAllAsync<P1>(
        r#type: PnpObjectType,
        requestedproperties: P1,
    ) -> windows_core::Result<windows_future::IAsyncOperation<PnpObjectCollection>>
    where
    ...
    pub fn FindAllAsyncAqsFilter<P1>(
        r#type: PnpObjectType,
        requestedproperties: P1,
    ...
    pub fn CreateWatcher<P1>(
        r#type: PnpObjectType,
        requestedproperties: P1,
    ) -> windows_core::Result<PnpObjectWatcher>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::IPnpObjectStatics(|this| unsafe {
    ...
    pub fn CreateWatcherAqsFilter<P1>(
        r#type: PnpObjectType,
        requestedproperties: P1,
        aqsfilter: &windows_core::HSTRING,
    ) -> windows_core::Result<PnpObjectWatcher>
    ...
    fn IPnpObjectStatics<R, F: FnOnce(&IPnpObjectStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PnpObject, IPnpObjectStatics> =
...
impl windows_core::RuntimeType for PnpObject {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPnpObject>();
}
...
windows_core::imp::interface_hierarchy!(
    ...
    windows_core::IUnknown,
    windows_core::IInspectable,
    windows_collections::IVectorView<PnpObject>
);
windows_core::imp::required_hierarchy!(
    PnpObjectCollection,
    windows_collections::IIterable<PnpObject>
);
impl PnpObjectCollection {
    pub fn First(&self) -> windows_core::Result<windows_collections::IIterator<PnpObject>> {
        let this =
            &windows_core::Interface::cast::<windows_collections::IIterable<PnpObject>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
unsafe impl windows_core::Interface for PnpObjectCollection {
    ...
    const IID: windows_core::GUID =
        <windows_collections::IVectorView<PnpObject> as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for PnpObjectType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Enumeration.Pnp.PnpObjectType;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for PnpObjectUpdate {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPnpObjectUpdate>();
}
...
impl PnpObjectWatcher {
    ...
    where
        P0: windows_core::Param<
            super::super::super::Foundation::TypedEventHandler<PnpObjectWatcher, PnpObject>,
        >,
    {
        let this = self;
        unsafe {
    ...
    where
        P0: windows_core::Param<
            super::super::super::Foundation::TypedEventHandler<PnpObjectWatcher, PnpObjectUpdate>,
        >,
    {
        let this = self;
        unsafe {
...
impl windows_core::RuntimeType for PnpObjectWatcher {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPnpObjectWatcher>();
}

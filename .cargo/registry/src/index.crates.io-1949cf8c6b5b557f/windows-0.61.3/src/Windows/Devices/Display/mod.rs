...
impl DisplayMonitor {
    ...
    pub fn ConnectionKind(&self) -> windows_core::Result<DisplayMonitorConnectionKind> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConnectionKind)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PhysicalConnector(&self) -> windows_core::Result<DisplayMonitorPhysicalConnectorKind> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PhysicalConnector)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn DisplayAdapterDeviceId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DisplayAdapterDeviceId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn DisplayAdapterId(
        &self,
    ) -> windows_core::Result<super::super::Graphics::DisplayAdapterId> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DisplayAdapterId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn DisplayAdapterTargetId(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DisplayAdapterTargetId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    #[cfg(feature = "Graphics")]
    pub fn NativeResolutionInRawPixels(
        &self,
    ) -> windows_core::Result<super::super::Graphics::SizeInt32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NativeResolutionInRawPixels)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PhysicalSizeInInches(
        &self,
    ) -> windows_core::Result<super::super::Foundation::IReference<super::super::Foundation::Size>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PhysicalSizeInInches)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn GetDescriptor(
        &self,
        descriptorkind: DisplayMonitorDescriptorKind,
    ) -> windows_core::Result<windows_core::Array<u8>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::MaybeUninit::zeroed();
            (windows_core::Interface::vtable(this).GetDescriptor)(
                windows_core::Interface::as_raw(this),
                descriptorkind,
    ...
    pub fn IsDolbyVisionSupportedInHdrMode(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsDolbyVisionSupportedInHdrMode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<DisplayMonitor>> {
        Self::IDisplayMonitorStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FromInterfaceIdAsync(
        deviceinterfaceid: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<DisplayMonitor>> {
        Self::IDisplayMonitorStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromInterfaceIdAsync)(
                windows_core::Interface::as_raw(this),
    ...
    fn IDisplayMonitorStatics<R, F: FnOnce(&IDisplayMonitorStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<DisplayMonitor, IDisplayMonitorStatics> =
...
impl windows_core::RuntimeType for DisplayMonitor {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDisplayMonitor>();
}
...
impl windows_core::RuntimeType for DisplayMonitorConnectionKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Display.DisplayMonitorConnectionKind;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for DisplayMonitorDescriptorKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Display.DisplayMonitorDescriptorKind;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for DisplayMonitorPhysicalConnectorKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Display.DisplayMonitorPhysicalConnectorKind;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for DisplayMonitorUsageKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Display.DisplayMonitorUsageKind;i4)",
    );
}
windows_core::imp::define_interface!(
    IDisplayMonitor,
    IDisplayMonitor_Vtbl,
    0x1f6b15d4_1d01_4c51_87e2_6f954a772b59
);
...
pub struct IDisplayMonitor_Vtbl {
    ...
    pub ConnectionKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut DisplayMonitorConnectionKind,
    ) -> windows_core::HRESULT,
    pub PhysicalConnector: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut DisplayMonitorPhysicalConnectorKind,
    ) -> windows_core::HRESULT,
    pub DisplayAdapterDeviceId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Graphics")]
    pub DisplayAdapterId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Graphics::DisplayAdapterId,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Graphics"))]
    DisplayAdapterId: usize,
    pub DisplayAdapterTargetId:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub UsageKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut DisplayMonitorUsageKind,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Graphics")]
    pub NativeResolutionInRawPixels: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Graphics::SizeInt32,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Graphics"))]
    NativeResolutionInRawPixels: usize,
    pub PhysicalSizeInInches: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RawDpiX:
    ...
    pub MaxAverageFullFrameLuminanceInNits:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f32) -> windows_core::HRESULT,
    pub GetDescriptor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IDisplayMonitor2,
    IDisplayMonitor2_Vtbl,
    0x023018e6_cb23_5830_96df_a7bf6e602577
);
...
pub struct IDisplayMonitor2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsDolbyVisionSupportedInHdrMode:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IDisplayMonitorStatics,
    IDisplayMonitorStatics_Vtbl,
    0x6eae698f_a228_4c05_821d_b695d667de8e
);
...
pub struct IDisplayMonitorStatics_Vtbl {
    ...
    pub FromInterfaceIdAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,

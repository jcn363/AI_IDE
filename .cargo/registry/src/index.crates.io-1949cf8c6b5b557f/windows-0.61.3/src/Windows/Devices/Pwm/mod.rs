...
windows_core::imp::define_interface!(
    IPwmController,
    IPwmController_Vtbl,
    0xc45f5c85_d2e8_42cf_9bd6_cf5ed029e6a7
);
...
windows_core::imp::define_interface!(
    ...
    IPwmControllerStatics2_Vtbl,
    0x44fc5b1f_f119_4bdd_97ad_f76ef986736d
);
...
windows_core::imp::define_interface!(
    ...
    IPwmControllerStatics3_Vtbl,
    0xb2581871_0229_4344_ae3f_9b7cd0e66b94
);
...
windows_core::imp::define_interface!(
    IPwmPin,
    IPwmPin_Vtbl,
    0x22972dc8_c6cf_4821_b7f9_c6454fb6af79
);
...
pub struct IPwmPin_Vtbl {
    ...
    pub GetActiveDutyCyclePercentage:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub SetActiveDutyCyclePercentage:
        unsafe extern "system" fn(*mut core::ffi::c_void, f64) -> windows_core::HRESULT,
    pub Polarity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PwmPulsePolarity,
    ) -> windows_core::HRESULT,
...
impl PwmController {
    ...
    pub fn ActualFrequency(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ActualFrequency)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetDesiredFrequency(&self, desiredfrequency: f64) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetDesiredFrequency)(
                windows_core::Interface::as_raw(this),
                desiredfrequency,
                &mut result__,
            )
    ...
    pub fn MinFrequency(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MinFrequency)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MaxFrequency(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxFrequency)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetControllersAsync<P0>(
        ...
        windows_future::IAsyncOperation<windows_collections::IVectorView<PwmController>>,
    >
    where
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<PwmController>> {
        Self::IPwmControllerStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IPwmControllerStatics<R, F: FnOnce(&IPwmControllerStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PwmController, IPwmControllerStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IPwmControllerStatics2<R, F: FnOnce(&IPwmControllerStatics2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PwmController, IPwmControllerStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IPwmControllerStatics3<R, F: FnOnce(&IPwmControllerStatics3) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PwmController, IPwmControllerStatics3> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for PwmController {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPwmController>();
}
...
impl PwmPin {
    ...
    pub fn GetActiveDutyCyclePercentage(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetActiveDutyCyclePercentage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetActiveDutyCyclePercentage(
        &self,
        dutycyclepercentage: f64,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetActiveDutyCyclePercentage)(
                windows_core::Interface::as_raw(this),
                dutycyclepercentage,
            )
            .ok()
...
impl windows_core::RuntimeType for PwmPin {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPwmPin>();
}
...
impl windows_core::RuntimeType for PwmPulsePolarity {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Pwm.PwmPulsePolarity;i4)",
    );
}

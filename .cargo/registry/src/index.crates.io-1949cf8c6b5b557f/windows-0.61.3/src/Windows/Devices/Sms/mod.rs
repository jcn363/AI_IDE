...
impl windows_core::RuntimeType for CellularClass {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Sms.CellularClass;i4)");
}
...
#[cfg(feature = "deprecated")]
pub type GetSmsMessagesOperation =
    windows_future::IAsyncOperationWithProgress<windows_collections::IVectorView<ISmsMessage>, i32>;
windows_core::imp::define_interface!(
    ISmsAppMessage,
    ISmsAppMessage_Vtbl,
    0xe8bb8494_d3a0_4a0a_86d7_291033a8cf54
);
...
pub struct ISmsAppMessage_Vtbl {
    ...
    pub CallbackNumber: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetCallbackNumber: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsDeliveryNotificationEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetIsDeliveryNotificationEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub RetryAttemptCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SetRetryAttemptCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub Encoding: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SmsEncoding,
    ) -> windows_core::HRESULT,
    pub SetEncoding:
        unsafe extern "system" fn(*mut core::ffi::c_void, SmsEncoding) -> windows_core::HRESULT,
    pub PortNumber:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SetPortNumber:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    ...
    pub BinaryBody: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    BinaryBody: usize,
    #[cfg(feature = "Storage_Streams")]
    pub SetBinaryBody: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
...
impl ISmsBinaryMessage {
    ...
    pub fn GetData(&self) -> windows_core::Result<windows_core::Array<u8>> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).GetData)(
                windows_core::Interface::as_raw(this),
...
impl ISmsBinaryMessage_Vtbl {
    pub const fn new<Identity: ISmsBinaryMessage_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Format<Identity: ISmsBinaryMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut SmsDataFormat,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetData<Identity: ISmsBinaryMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetData<Identity: ISmsBinaryMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISmsBinaryMessage_Impl::SetData(
                    this,
...
pub struct ISmsBinaryMessage_Vtbl {
    ...
    pub SetFormat:
        unsafe extern "system" fn(*mut core::ffi::c_void, SmsDataFormat) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ISmsBroadcastMessage_Vtbl,
    0x75aebbf1_e4b7_4874_a09c_2956e592f957
);
...
pub struct ISmsBroadcastMessage_Vtbl {
    ...
    pub Channel:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub GeographicalScope: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SmsGeographicalScope,
    ) -> windows_core::HRESULT,
    pub MessageCode:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub UpdateNumber:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub BroadcastType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SmsBroadcastType,
    ) -> windows_core::HRESULT,
    pub IsEmergencyAlert:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsUserPopupRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
#[cfg(feature = "deprecated")]
windows_core::imp::define_interface!(
...
impl ISmsDevice {
        ...
        P0: windows_core::Param<SmsTextMessage>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CalculateLength)(
                windows_core::Interface::as_raw(this),
                message.param().abi(),
                &mut result__,
            )
    ...
    pub fn AccountPhoneNumber(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AccountPhoneNumber)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn MessageStore(&self) -> windows_core::Result<SmsDeviceMessageStore> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MessageStore)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn DeviceStatus(&self) -> windows_core::Result<SmsDeviceStatus> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeviceStatus)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
        ...
        P0: windows_core::Param<SmsMessageReceivedEventHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SmsMessageReceived)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn RemoveSmsMessageReceived(&self, eventcookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveSmsMessageReceived)(
                windows_core::Interface::as_raw(this),
                eventcookie,
            )
            .ok()
        ...
        P0: windows_core::Param<SmsDeviceStatusChangedEventHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SmsDeviceStatusChanged)(
                windows_core::Interface::as_raw(this),
                eventhandler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveSmsDeviceStatusChanged(&self, eventcookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveSmsDeviceStatusChanged)(
                windows_core::Interface::as_raw(this),
                eventcookie,
            )
            .ok()
...
pub trait ISmsDevice_Impl: windows_core::IUnknownImpl {
    fn SendMessageAsync(
        &self,
        message: windows_core::Ref<'_, ISmsMessage>,
    ) -> windows_core::Result<SendSmsMessageOperation>;
    fn CalculateLength(
        &self,
        message: windows_core::Ref<'_, SmsTextMessage>,
    ) -> windows_core::Result<SmsEncodedLength>;
    ...
    fn SmsMessageReceived(
        &self,
        eventHandler: windows_core::Ref<'_, SmsMessageReceivedEventHandler>,
    ) -> windows_core::Result<i64>;
    fn RemoveSmsMessageReceived(&self, eventCookie: i64) -> windows_core::Result<()>;
    fn SmsDeviceStatusChanged(
        &self,
        eventHandler: windows_core::Ref<'_, SmsDeviceStatusChangedEventHandler>,
    ) -> windows_core::Result<i64>;
...
impl ISmsDevice_Vtbl {
    pub const fn new<Identity: ISmsDevice_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SendMessageAsync<
        ...
        unsafe extern "system" fn CalculateLength<
            Identity: ISmsDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            message: *mut core::ffi::c_void,
            result__: *mut SmsEncodedLength,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn AccountPhoneNumber<
            Identity: ISmsDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CellularClass<Identity: ISmsDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut CellularClass,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn MessageStore<Identity: ISmsDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn DeviceStatus<Identity: ISmsDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut SmsDeviceStatus,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SmsMessageReceived<
            Identity: ISmsDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISmsDevice_Impl::SmsMessageReceived(
                    this,
        ...
        unsafe extern "system" fn RemoveSmsMessageReceived<
            Identity: ISmsDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SmsDeviceStatusChanged<
            Identity: ISmsDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISmsDevice_Impl::SmsDeviceStatusChanged(
                    this,
                    core::mem::transmute_copy(&eventhandler),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn RemoveSmsDeviceStatusChanged<
            Identity: ISmsDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub struct ISmsDevice_Vtbl {
    ...
    pub CalculateLength: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut SmsEncodedLength,
    ) -> windows_core::HRESULT,
    pub AccountPhoneNumber: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub MessageStore: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeviceStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SmsDeviceStatus,
    ) -> windows_core::HRESULT,
    pub SmsMessageReceived: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveSmsMessageReceived:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub SmsDeviceStatusChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveSmsDeviceStatusChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISmsDevice2,
    ISmsDevice2_Vtbl,
    0xbd8a5c13_e522_46cb_b8d5_9ead30fb6c47
);
...
pub struct ISmsDevice2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SmscAddress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetSmscAddress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub ParentDeviceId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AccountPhoneNumber: unsafe extern "system" fn(
    ...
    pub SendMessageAndGetResultAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeviceStatusChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ISmsDevice2Statics,
    ISmsDevice2Statics_Vtbl,
    0x65c78325_1031_491e_8fb6_ef9991afe363
);
...
pub struct ISmsDevice2Statics_Vtbl {
    ...
    pub FromParentId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct ISmsDeviceMessageStore_Vtbl {
    ...
    pub DeleteMessagesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        SmsMessageFilter,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GetMessagesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        SmsMessageFilter,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct ISmsDeviceStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub FromNetworkAccountIdAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ISmsFilterRule,
    ISmsFilterRule_Vtbl,
    0x40e32fae_b049_4fbc_afe9_e2a610eff55c
);
...
pub struct ISmsFilterRule_Vtbl {
    ...
    pub ImsiPrefixes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeviceIds: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SenderNumbers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TextMessagePrefixes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PortNumbers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CellularClass: unsafe extern "system" fn(
    ...
    pub SetCellularClass:
        unsafe extern "system" fn(*mut core::ffi::c_void, CellularClass) -> windows_core::HRESULT,
    pub ProtocolIds: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TeleserviceIds: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub WapApplicationIds: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub WapContentTypes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BroadcastTypes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BroadcastChannels: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0x00c36508_6296_4f29_9aad_8920ceba3ce8
);
...
pub struct ISmsFilterRuleFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateFilterRule: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        SmsMessageType,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ISmsFilterRules,
    ISmsFilterRules_Vtbl,
    0x4e47eafb_79cd_4881_9894_55a4135b23fa
);
...
windows_core::imp::define_interface!(
    ...
    ISmsFilterRulesFactory_Vtbl,
    0xa09924ed_6e2e_4530_9fde_465d02eed00e
);
...
pub struct ISmsFilterRulesFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateFilterRules: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        SmsFilterActionType,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ISmsMessage,
    ISmsMessage_Vtbl,
    0xed3c5e28_6984_4b07_811d_8d5906ed3cea
);
...
impl ISmsMessage_Vtbl {
    pub const fn new<Identity: ISmsMessage_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Id<Identity: ISmsMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn MessageClass<Identity: ISmsMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut SmsMessageClass,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x2cf0fe30_fe50_4fc6_aa88_4ccfe27a29ea
);
...
impl ISmsMessageBase_Vtbl {
    pub const fn new<Identity: ISmsMessageBase_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn DeviceId<Identity: ISmsMessageBase_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn CellularClass<
            Identity: ISmsMessageBase_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn MessageClass<
            Identity: ISmsMessageBase_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SimIccId<Identity: ISmsMessageBase_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
pub struct ISmsMessageReceivedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub TextMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BinaryMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0x2bcfcbd4_2657_4128_ad5f_e3877132bdb1
);
...
pub struct ISmsMessageReceivedTriggerDetails_Vtbl {
    ...
    pub WapMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AppMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BroadcastMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub VoicemailMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub StatusMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ISmsMessageRegistration_Vtbl,
    0x1720503e_f34f_446b_83b3_0ff19923b409
);
...
windows_core::imp::define_interface!(
    ...
    ISmsMessageRegistrationStatics_Vtbl,
    0x63a05464_2898_4778_a03c_6f994907d63a
);
...
pub struct ISmsMessageRegistrationStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AllRegistrations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ISmsSendMessageResult_Vtbl,
    0xdb139af2_78c9_4feb_9622_452328088d62
);
...
pub struct ISmsSendMessageResult_Vtbl {
    ...
    pub IsSuccessful:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub MessageReferenceNumbers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CellularClass: unsafe extern "system" fn(
    ...
    pub ModemErrorCode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SmsModemErrorCode,
    ) -> windows_core::HRESULT,
    pub IsErrorTransient:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub NetworkCauseCode:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub TransportFailureCause:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISmsStatusMessage,
    ISmsStatusMessage_Vtbl,
    0xe6d28342_b70b_4677_9379_c9783fdff8f4
);
...
pub struct ISmsStatusMessage_Vtbl {
    ...
    pub Status:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub MessageReferenceNumber:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub ServiceCenterTimestamp: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::DateTime,
    ) -> windows_core::HRESULT,
    pub DischargeTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::DateTime,
    ) -> windows_core::HRESULT,
}
...
impl ISmsTextMessage {
    ...
    pub fn PartReferenceId(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PartReferenceId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn Encoding(&self) -> windows_core::Result<SmsEncoding> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Encoding)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetEncoding(&self, value: SmsEncoding) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetEncoding)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn ToBinaryMessages(
        &self,
        format: SmsDataFormat,
    ) -> windows_core::Result<windows_collections::IVectorView<ISmsBinaryMessage>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ToBinaryMessages)(
                windows_core::Interface::as_raw(this),
                format,
                &mut result__,
            )
...
impl ISmsTextMessage_Vtbl {
    pub const fn new<Identity: ISmsTextMessage_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Timestamp<Identity: ISmsTextMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn PartReferenceId<
        ...
        unsafe extern "system" fn PartNumber<
            Identity: ISmsTextMessage_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn PartCount<Identity: ISmsTextMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn To<Identity: ISmsTextMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetTo<Identity: ISmsTextMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn From<Identity: ISmsTextMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetFrom<Identity: ISmsTextMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Body<Identity: ISmsTextMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetBody<Identity: ISmsTextMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Encoding<Identity: ISmsTextMessage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut SmsEncoding,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetEncoding<
            Identity: ISmsTextMessage_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ToBinaryMessages<
            Identity: ISmsTextMessage_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub struct ISmsTextMessage_Vtbl {
    ...
    pub SetEncoding:
        unsafe extern "system" fn(*mut core::ffi::c_void, SmsEncoding) -> windows_core::HRESULT,
    pub ToBinaryMessages: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        SmsDataFormat,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ISmsTextMessage2,
    ISmsTextMessage2_Vtbl,
    0x22a0d893_4555_4755_b5a1_e7fd84955f8d
);
...
pub struct ISmsTextMessageStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub FromBinaryMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FromBinaryData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        SmsDataFormat,
        u32,
        *const u8,
...
windows_core::imp::define_interface!(
    ...
    ISmsVoicemailMessage_Vtbl,
    0x271aa0a6_95b1_44ff_bcb8_b8fdd7e08bc3
);
...
pub struct ISmsVoicemailMessage_Vtbl {
    ...
    pub MessageCount: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISmsWapMessage,
    ISmsWapMessage_Vtbl,
    0xcd937743_7a55_4d3b_9021_f22e022d09c5
);
...
pub struct ISmsWapMessage_Vtbl {
    ...
    pub ApplicationId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl SmsAppMessage {
    ...
    pub fn CallbackNumber(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CallbackNumber)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetCallbackNumber(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetCallbackNumber)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn IsDeliveryNotificationEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsDeliveryNotificationEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIsDeliveryNotificationEnabled(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsDeliveryNotificationEnabled)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn RetryAttemptCount(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RetryAttemptCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetRetryAttemptCount(&self, value: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetRetryAttemptCount)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SetPortNumber(&self, value: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPortNumber)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn TeleserviceId(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TeleserviceId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetTeleserviceId(&self, value: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetTeleserviceId)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn ProtocolId(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ProtocolId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetProtocolId(&self, value: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetProtocolId)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn BinaryBody(&self) -> windows_core::Result<super::super::Storage::Streams::IBuffer> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BinaryBody)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetBinaryBody)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
...
impl windows_core::RuntimeType for SmsAppMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsAppMessage>();
}
...
impl windows_core::RuntimeType for SmsBinaryMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsBinaryMessage>();
}
#[cfg(feature = "deprecated")]
...
impl SmsBroadcastMessage {
    ...
    pub fn GeographicalScope(&self) -> windows_core::Result<SmsGeographicalScope> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GeographicalScope)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MessageCode(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MessageCode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn UpdateNumber(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UpdateNumber)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn BroadcastType(&self) -> windows_core::Result<SmsBroadcastType> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BroadcastType)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsEmergencyAlert(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsEmergencyAlert)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsUserPopupRequested(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsUserPopupRequested)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for SmsBroadcastMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsBroadcastMessage>();
}
...
impl windows_core::RuntimeType for SmsBroadcastType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Sms.SmsBroadcastType;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SmsDataFormat {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Sms.SmsDataFormat;i4)");
}
#[cfg(feature = "deprecated")]
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl SmsDevice {
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<SmsDevice>> {
        Self::ISmsDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FromNetworkAccountIdAsync(
        networkaccountid: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<SmsDevice>> {
        Self::ISmsDeviceStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromNetworkAccountIdAsync)(
                windows_core::Interface::as_raw(this),
    ...
    fn ISmsDeviceStatics<R, F: FnOnce(&ISmsDeviceStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SmsDevice, ISmsDeviceStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ISmsDeviceStatics2<R, F: FnOnce(&ISmsDeviceStatics2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SmsDevice, ISmsDeviceStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl windows_core::RuntimeType for SmsDevice {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsDevice>();
}
#[cfg(feature = "deprecated")]
...
impl SmsDevice2 {
    pub fn SmscAddress(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SmscAddress)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetSmscAddress(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSmscAddress)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn ParentDeviceId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ParentDeviceId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SendMessageAndGetResultAsync<P0>(
        &self,
        message: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<SmsSendMessageResult>>
    where
        P0: windows_core::Param<ISmsMessageBase>,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SendMessageAndGetResultAsync)(
                windows_core::Interface::as_raw(this),
                message.param().abi(),
                &mut result__,
            )
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<SmsDevice2, windows_core::IInspectable>,
        >,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeviceStatusChanged)(
                windows_core::Interface::as_raw(this),
                eventhandler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveDeviceStatusChanged(&self, eventcookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDeviceStatusChanged)(
                windows_core::Interface::as_raw(this),
                eventcookie,
            )
            .ok()
    ...
    pub fn FromParentId(
        parentdeviceid: &windows_core::HSTRING,
    ) -> windows_core::Result<SmsDevice2> {
        Self::ISmsDevice2Statics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromParentId)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(parentdeviceid),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn ISmsDevice2Statics<R, F: FnOnce(&ISmsDevice2Statics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SmsDevice2, ISmsDevice2Statics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for SmsDevice2 {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsDevice2>();
}
...
impl SmsDeviceMessageStore {
    ...
    pub fn DeleteMessagesAsync(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeleteMessagesAsync)(
                windows_core::Interface::as_raw(this),
                messagefilter,
                &mut result__,
            )
    ...
    pub fn GetMessageAsync(
        &self,
        messageid: u32,
    ) -> windows_core::Result<windows_future::IAsyncOperation<ISmsMessage>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMessagesAsync(
        &self,
        messagefilter: SmsMessageFilter,
    ) -> windows_core::Result<
        windows_future::IAsyncOperationWithProgress<
            windows_collections::IVectorView<ISmsMessage>,
            i32,
        >,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetMessagesAsync)(
                windows_core::Interface::as_raw(this),
                messagefilter,
                &mut result__,
            )
    ...
    pub fn MaxMessages(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxMessages)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for SmsDeviceMessageStore {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsDeviceMessageStore>();
}
#[cfg(feature = "deprecated")]
...
impl windows_core::RuntimeType for SmsDeviceStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Sms.SmsDeviceStatus;i4)");
}
#[cfg(feature = "deprecated")]
windows_core::imp::define_interface!(
...
impl SmsDeviceStatusChangedEventHandler {
    pub fn new<
        F: FnMut(windows_core::Ref<'_, SmsDevice>) -> windows_core::Result<()> + Send + 'static,
    >(
        invoke: F,
    ) -> Self {
        let com = SmsDeviceStatusChangedEventHandlerBox {
            vtable: &SmsDeviceStatusChangedEventHandlerBox::<F>::VTABLE,
...
#[cfg(feature = "deprecated")]
impl<F: FnMut(windows_core::Ref<'_, SmsDevice>) -> windows_core::Result<()> + Send + 'static>
    SmsDeviceStatusChangedEventHandlerBox<F>
{
    const VTABLE: SmsDeviceStatusChangedEventHandler_Vtbl =
        SmsDeviceStatusChangedEventHandler_Vtbl {
            base__: windows_core::IUnknown_Vtbl {
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid
                == <SmsDeviceStatusChangedEventHandler as windows_core::Interface>::IID
...
impl windows_core::RuntimeType for SmsEncodedLength {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"struct(Windows.Devices.Sms.SmsEncodedLength;u4;u4;u4;u4;u4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SmsEncoding {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Sms.SmsEncoding;i4)");
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SmsFilterActionType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Sms.SmsFilterActionType;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl SmsFilterRule {
    ...
    pub fn ImsiPrefixes(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ImsiPrefixes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn DeviceIds(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeviceIds)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SenderNumbers(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SenderNumbers)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn TextMessagePrefixes(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TextMessagePrefixes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn PortNumbers(&self) -> windows_core::Result<windows_collections::IVector<i32>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PortNumbers)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SetCellularClass(&self, value: CellularClass) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetCellularClass)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn ProtocolIds(&self) -> windows_core::Result<windows_collections::IVector<i32>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ProtocolIds)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn TeleserviceIds(&self) -> windows_core::Result<windows_collections::IVector<i32>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TeleserviceIds)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn WapApplicationIds(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WapApplicationIds)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn WapContentTypes(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WapContentTypes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn BroadcastTypes(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<SmsBroadcastType>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BroadcastTypes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn BroadcastChannels(&self) -> windows_core::Result<windows_collections::IVector<i32>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BroadcastChannels)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateFilterRule(messagetype: SmsMessageType) -> windows_core::Result<SmsFilterRule> {
        Self::ISmsFilterRuleFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateFilterRule)(
                windows_core::Interface::as_raw(this),
                messagetype,
                &mut result__,
            )
    ...
    fn ISmsFilterRuleFactory<R, F: FnOnce(&ISmsFilterRuleFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SmsFilterRule, ISmsFilterRuleFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for SmsFilterRule {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsFilterRule>();
}
...
impl SmsFilterRules {
    pub fn ActionType(&self) -> windows_core::Result<SmsFilterActionType> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ActionType)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn Rules(&self) -> windows_core::Result<windows_collections::IVector<SmsFilterRule>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Rules)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateFilterRules(
        actiontype: SmsFilterActionType,
    ) -> windows_core::Result<SmsFilterRules> {
        Self::ISmsFilterRulesFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateFilterRules)(
                windows_core::Interface::as_raw(this),
                actiontype,
                &mut result__,
            )
    ...
    fn ISmsFilterRulesFactory<R, F: FnOnce(&ISmsFilterRulesFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SmsFilterRules, ISmsFilterRulesFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for SmsFilterRules {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsFilterRules>();
}
...
impl windows_core::RuntimeType for SmsGeographicalScope {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Sms.SmsGeographicalScope;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SmsMessageClass {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Sms.SmsMessageClass;i4)");
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SmsMessageFilter {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Sms.SmsMessageFilter;i4)",
    );
}
#[cfg(feature = "deprecated")]
#[repr(transparent)]
...
impl SmsMessageReceivedEventArgs {
    pub fn TextMessage(&self) -> windows_core::Result<SmsTextMessage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TextMessage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn BinaryMessage(&self) -> windows_core::Result<SmsBinaryMessage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BinaryMessage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for SmsMessageReceivedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsMessageReceivedEventArgs>();
}
#[cfg(feature = "deprecated")]
...
impl SmsMessageReceivedEventHandler {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, SmsDevice>,
                windows_core::Ref<'_, SmsMessageReceivedEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        ...
        let com = SmsMessageReceivedEventHandlerBox {
            vtable: &SmsMessageReceivedEventHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
#[cfg(feature = "deprecated")]
#[repr(C)]
struct SmsMessageReceivedEventHandlerBox<
    F: FnMut(
            windows_core::Ref<'_, SmsDevice>,
            windows_core::Ref<'_, SmsMessageReceivedEventArgs>,
        ) -> windows_core::Result<()>
...
impl<
        F: FnMut(
            ...
            + Send
            + 'static,
    > SmsMessageReceivedEventHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <SmsMessageReceivedEventHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _
...
impl SmsMessageReceivedTriggerDetails {
    ...
    pub fn WapMessage(&self) -> windows_core::Result<SmsWapMessage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WapMessage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn AppMessage(&self) -> windows_core::Result<SmsAppMessage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AppMessage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn BroadcastMessage(&self) -> windows_core::Result<SmsBroadcastMessage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BroadcastMessage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn VoicemailMessage(&self) -> windows_core::Result<SmsVoicemailMessage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).VoicemailMessage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn StatusMessage(&self) -> windows_core::Result<SmsStatusMessage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StatusMessage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Drop(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).Drop)(windows_core::Interface::as_raw(this)).ok()
        }
    }
...
impl windows_core::RuntimeType for SmsMessageReceivedTriggerDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsMessageReceivedTriggerDetails>();
}
unsafe impl windows_core::Interface for SmsMessageReceivedTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <ISmsMessageReceivedTriggerDetails as windows_core::Interface>::IID;
}
...
impl SmsMessageRegistration {
    ...
    pub fn AllRegistrations(
    ) -> windows_core::Result<windows_collections::IVectorView<SmsMessageRegistration>> {
        Self::ISmsMessageRegistrationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllRegistrations)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Register<P1>(
        ...
        filterrules: P1,
    ) -> windows_core::Result<SmsMessageRegistration>
    where
    ...
    fn ISmsMessageRegistrationStatics<
        R,
        F: FnOnce(&ISmsMessageRegistrationStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for SmsMessageRegistration {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsMessageRegistration>();
}
...
impl windows_core::RuntimeType for SmsMessageType {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Sms.SmsMessageType;i4)");
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SmsModemErrorCode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Sms.SmsModemErrorCode;i4)",
    );
}
#[cfg(feature = "deprecated")]
#[repr(transparent)]
...
impl SmsReceivedEventDetails {
    ...
    pub fn MessageIndex(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MessageIndex)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for SmsReceivedEventDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsReceivedEventDetails>();
}
#[cfg(feature = "deprecated")]
...
impl SmsSendMessageResult {
    ...
    pub fn MessageReferenceNumbers(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<i32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MessageReferenceNumbers)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ModemErrorCode(&self) -> windows_core::Result<SmsModemErrorCode> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ModemErrorCode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsErrorTransient(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsErrorTransient)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn NetworkCauseCode(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NetworkCauseCode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn TransportFailureCause(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TransportFailureCause)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for SmsSendMessageResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsSendMessageResult>();
}
...
impl SmsStatusMessage {
    ...
    pub fn MessageReferenceNumber(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MessageReferenceNumber)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ServiceCenterTimestamp(
        &self,
    ) -> windows_core::Result<super::super::Foundation::DateTime> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ServiceCenterTimestamp)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn DischargeTime(&self) -> windows_core::Result<super::super::Foundation::DateTime> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DischargeTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for SmsStatusMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsStatusMessage>();
}
...
impl SmsTextMessage {
        ...
        P0: windows_core::Param<SmsBinaryMessage>,
    {
        Self::ISmsTextMessageStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromBinaryMessage)(
                windows_core::Interface::as_raw(this),
                binarymessage.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn FromBinaryData(
        format: SmsDataFormat,
        value: &[u8],
    ) -> windows_core::Result<SmsTextMessage> {
        Self::ISmsTextMessageStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromBinaryData)(
                windows_core::Interface::as_raw(this),
                format,
                value.len().try_into().unwrap(),
                value.as_ptr(),
    ...
    fn ISmsTextMessageStatics<R, F: FnOnce(&ISmsTextMessageStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SmsTextMessage, ISmsTextMessageStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl windows_core::RuntimeType for SmsTextMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsTextMessage>();
}
#[cfg(feature = "deprecated")]
...
impl windows_core::RuntimeType for SmsTextMessage2 {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsTextMessage2>();
}
...
impl windows_core::RuntimeType for SmsVoicemailMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsVoicemailMessage>();
}
...
impl SmsWapMessage {
    ...
    pub fn ApplicationId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ApplicationId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for SmsWapMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISmsWapMessage>();
}

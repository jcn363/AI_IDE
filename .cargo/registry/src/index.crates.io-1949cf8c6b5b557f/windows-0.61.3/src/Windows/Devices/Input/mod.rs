...
windows_core::imp::define_interface!(
    ...
    IKeyboardCapabilities_Vtbl,
    0x3a3f9b56_6798_4bbc_833e_0f34b17c65ff
);
...
windows_core::imp::define_interface!(
    IMouseCapabilities,
    IMouseCapabilities_Vtbl,
    0xbca5e023_7dd9_4b6b_9a92_55d43cb38f73
);
...
pub struct IMouseCapabilities_Vtbl {
    ...
    pub MousePresent:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub VerticalWheelPresent:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub HorizontalWheelPresent:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SwapButtons:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub NumberOfButtons:
...
windows_core::imp::define_interface!(
    IMouseDevice,
    IMouseDevice_Vtbl,
    0x88edf458_f2c8_49f4_be1f_c256b388bc11
);
...
pub struct IMouseDevice_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub MouseMoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveMouseMoved:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IMouseDeviceStatics,
    IMouseDeviceStatics_Vtbl,
    0x484a9045_6d70_49db_8e68_46ffbd17d38d
);
...
windows_core::imp::define_interface!(
    IMouseEventArgs,
    IMouseEventArgs_Vtbl,
    0xf625aa5d_2354_4cc7_9230_96941c969fde
);
...
pub struct IMouseEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub MouseDelta:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut MouseDelta) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPenButtonListener,
    IPenButtonListener_Vtbl,
    0x8245c376_1ee3_53f7_b1f7_8334a16f2815
);
...
pub struct IPenButtonListener_Vtbl {
    ...
    pub RemoveIsSupportedChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub TailButtonClicked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveTailButtonClicked:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub TailButtonDoubleClicked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveTailButtonDoubleClicked:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub TailButtonLongPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveTailButtonLongPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPenButtonListenerStatics,
    IPenButtonListenerStatics_Vtbl,
    0x19a8a584_862f_5f69_bfea_05f6584f133f
);
...
windows_core::imp::define_interface!(
    IPenDevice,
    IPenDevice_Vtbl,
    0x31856eba_a738_5a8c_b8f6_f97ef68d18ef
);
...
pub struct IPenDevice_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub PenId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IPenDevice2,
    IPenDevice2_Vtbl,
    0x0207d327_7fb8_5566_8c34_f8342037b7f9
);
...
windows_core::imp::define_interface!(
    IPenDeviceStatics,
    IPenDeviceStatics_Vtbl,
    0x9dfbbe01_0966_5180_bcb4_b85060e39479
);
...
pub struct IPenDeviceStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetFromPointerId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IPenDockListener,
    IPenDockListener_Vtbl,
    0x759f4d90_1dc0_55cb_ad18_b9101456f592
);
...
pub struct IPenDockListener_Vtbl {
    ...
    pub RemoveIsSupportedChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub Docked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveDocked:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub Undocked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IPenDockListenerStatics_Vtbl,
    0xcab75e9a_0016_5c72_969e_a97e11992a93
);
...
windows_core::imp::define_interface!(
    IPenDockedEventArgs,
    IPenDockedEventArgs_Vtbl,
    0xfd4277c6_ca63_5d4e_9ed3_a28a54521c8c
);
...
windows_core::imp::define_interface!(
    ...
    IPenTailButtonClickedEventArgs_Vtbl,
    0x5d2fb7b6_6ad3_5d3e_ab29_05ea2410e390
);
...
windows_core::imp::define_interface!(
    ...
    IPenTailButtonDoubleClickedEventArgs_Vtbl,
    0x846321a2_618a_5478_b04c_b358231da4a7
);
...
windows_core::imp::define_interface!(
    ...
    IPenTailButtonLongPressedEventArgs_Vtbl,
    0xf37c606e_c60a_5f42_b818_a53112406c13
);
...
windows_core::imp::define_interface!(
    ...
    IPenUndockedEventArgs_Vtbl,
    0xccd09150_261b_59e6_a5d4_c1964cd03feb
);
...
pub struct IPointerDevice_Vtbl {
    ...
    pub MaxContacts:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub PhysicalDeviceRect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::Rect,
    ) -> windows_core::HRESULT,
    pub ScreenRect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::Rect,
    ) -> windows_core::HRESULT,
    pub SupportedUsages: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPointerDevice2,
    IPointerDevice2_Vtbl,
    0xf8a6d2a0_c484_489f_ae3e_30d2ee1ffd3e
);
...
impl KeyboardCapabilities {
    ...
    pub fn KeyboardPresent(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).KeyboardPresent)(
...
impl windows_core::RuntimeType for KeyboardCapabilities {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IKeyboardCapabilities>();
}
...
impl MouseCapabilities {
    ...
    pub fn MousePresent(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MousePresent)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn VerticalWheelPresent(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).VerticalWheelPresent)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn HorizontalWheelPresent(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HorizontalWheelPresent)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SwapButtons(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SwapButtons)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn NumberOfButtons(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NumberOfButtons)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for MouseCapabilities {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMouseCapabilities>();
}
...
impl MouseDevice {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MouseMoved)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveMouseMoved(&self, cookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveMouseMoved)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
    ...
    fn IMouseDeviceStatics<R, F: FnOnce(&IMouseDeviceStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<MouseDevice, IMouseDeviceStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for MouseDevice {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMouseDevice>();
}
...
impl MouseEventArgs {
    pub fn MouseDelta(&self) -> windows_core::Result<MouseDelta> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MouseDelta)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for MouseEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMouseEventArgs>();
}
...
impl PenButtonListener {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TailButtonClicked)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveTailButtonClicked(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveTailButtonClicked)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TailButtonDoubleClicked)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveTailButtonDoubleClicked(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveTailButtonDoubleClicked)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TailButtonLongPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveTailButtonLongPressed(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveTailButtonLongPressed)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    fn IPenButtonListenerStatics<
        R,
        F: FnOnce(&IPenButtonListenerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for PenButtonListener {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPenButtonListener>();
}
...
impl PenDevice {
    pub fn PenId(&self) -> windows_core::Result<windows_core::GUID> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PenId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SimpleHapticsController(
        &self,
    ) -> windows_core::Result<super::Haptics::SimpleHapticsController> {
    ...
    pub fn GetFromPointerId(pointerid: u32) -> windows_core::Result<PenDevice> {
        Self::IPenDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetFromPointerId)(
                windows_core::Interface::as_raw(this),
                pointerid,
                &mut result__,
            )
    ...
    fn IPenDeviceStatics<R, F: FnOnce(&IPenDeviceStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PenDevice, IPenDeviceStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for PenDevice {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPenDevice>();
}
...
impl PenDockListener {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Docked)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveDocked(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDocked)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Undocked)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveUndocked(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveUndocked)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    fn IPenDockListenerStatics<
        R,
        F: FnOnce(&IPenDockListenerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PenDockListener, IPenDockListenerStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for PenDockListener {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPenDockListener>();
}
...
impl windows_core::RuntimeType for PenDockedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPenDockedEventArgs>();
}
...
impl windows_core::RuntimeType for PenTailButtonClickedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPenTailButtonClickedEventArgs>();
}
unsafe impl windows_core::Interface for PenTailButtonClickedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IPenTailButtonClickedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for PenTailButtonDoubleClickedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPenTailButtonDoubleClickedEventArgs>();
}
unsafe impl windows_core::Interface for PenTailButtonDoubleClickedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IPenTailButtonDoubleClickedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for PenTailButtonLongPressedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPenTailButtonLongPressedEventArgs>();
}
unsafe impl windows_core::Interface for PenTailButtonLongPressedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IPenTailButtonLongPressedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for PenUndockedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPenUndockedEventArgs>();
}
...
impl PointerDevice {
    ...
    pub fn IsIntegrated(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsIntegrated)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MaxContacts(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxContacts)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PhysicalDeviceRect(&self) -> windows_core::Result<super::super::Foundation::Rect> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PhysicalDeviceRect)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ScreenRect(&self) -> windows_core::Result<super::super::Foundation::Rect> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ScreenRect)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SupportedUsages(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<PointerDeviceUsage>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedUsages)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn MaxPointersWithZDistance(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxPointersWithZDistance)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    ) -> windows_core::Result<windows_collections::IVectorView<PointerDevice>> {
        Self::IPointerDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TouchCapabilities {
    ...
    pub fn TouchPresent(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TouchPresent)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)

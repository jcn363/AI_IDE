windows_core::imp::define_interface!(
    ...
    IServiceDeviceStatics_Vtbl,
    0xa88214e1_59c7_4a20_aba6_9f6707937230
);
...
pub struct IServiceDeviceStatics_Vtbl {
    ...
    pub GetDeviceSelectorFromServiceId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IStorageDeviceStatics_Vtbl,
    0x5ece44ee_1b23_4dd2_8652_bc164f003128
);
...
impl ServiceDevice {
    ...
    pub fn GetDeviceSelectorFromServiceId(
        serviceid: windows_core::GUID,
    ) -> windows_core::Result<windows_core::HSTRING> {
        Self::IServiceDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDeviceSelectorFromServiceId)(
                windows_core::Interface::as_raw(this),
                serviceid,
                &mut result__,
            )
    ...
    fn IServiceDeviceStatics<R, F: FnOnce(&IServiceDeviceStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ServiceDevice, IServiceDeviceStatics> =
...
impl windows_core::RuntimeType for ServiceDeviceType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Portable.ServiceDeviceType;i4)",
    );
}
...
impl StorageDevice {
    ...
    fn IStorageDeviceStatics<R, F: FnOnce(&IStorageDeviceStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<StorageDevice, IStorageDeviceStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}

...
impl GpioPinProviderValueChangedEventArgs {
    ...
    ) -> windows_core::Result<GpioPinProviderValueChangedEventArgs> {
    ...
    fn IGpioPinProviderValueChangedEventArgsFactory<
        R,
        F: FnOnce(&IGpioPinProviderValueChangedEventArgsFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for GpioPinProviderValueChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGpioPinProviderValueChangedEventArgs>();
}
unsafe impl windows_core::Interface for GpioPinProviderValueChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IGpioPinProviderValueChangedEventArgs as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    ...
    0xad11cec7_19ea_4b21_874f_b91aed4a25db
);
...
impl IGpioControllerProvider {
    ...
    ) -> windows_core::Result<IGpioPinProvider> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).OpenPinProvider)(
                windows_core::Interface::as_raw(this),
                pin,
                sharingmode,
                &mut result__,
...
impl IGpioControllerProvider_Vtbl {
    pub const fn new<Identity: IGpioControllerProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn PinCount<
        ...
        unsafe extern "system" fn OpenPinProvider<
            Identity: IGpioControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub struct IGpioControllerProvider_Vtbl {
    ...
    pub OpenPinProvider: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
...
windows_core::imp::define_interface!(
    ...
    0x42344cb7_6abc_40ff_9ce7_73b85301b900
);
...
impl IGpioPinProvider_Vtbl {
    pub const fn new<Identity: IGpioPinProvider_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn DebounceTimeout<
            Identity: IGpioPinProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetDebounceTimeout<
            Identity: IGpioPinProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn PinNumber<
            Identity: IGpioPinProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SharingMode<
            Identity: IGpioPinProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn IsDriveModeSupported<
            Identity: IGpioPinProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetDriveMode<
            Identity: IGpioPinProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetDriveMode<
            Identity: IGpioPinProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Write<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Read<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
...
pub struct IGpioPinProvider_Vtbl {
    ...
    pub Read: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ProviderGpioPinValue,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IGpioPinProviderValueChangedEventArgs,
    IGpioPinProviderValueChangedEventArgs_Vtbl,
    0x32a6d6f2_3d5b_44cd_8fbe_13a69f2edb24
);
...
pub struct IGpioPinProviderValueChangedEventArgs_Vtbl {
    ...
    pub Edge: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ProviderGpioPinEdge,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IGpioPinProviderValueChangedEventArgsFactory,
    IGpioPinProviderValueChangedEventArgsFactory_Vtbl,
    0x3ecb0b59_568c_4392_b24a_8a59a902b1f1
);
...
windows_core::imp::define_interface!(
    IGpioProvider,
    IGpioProvider_Vtbl,
    0x44e82707_08ca_434a_afe0_d61580446f7e
);
...
impl IGpioProvider {
    pub fn GetControllers(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<IGpioControllerProvider>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetControllers)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl IGpioProvider_Vtbl {
    pub const fn new<Identity: IGpioProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetControllers<
        ...
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IGpioProvider, OFFSET>(),
            GetControllers: GetControllers::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub struct IGpioProvider_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetControllers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}

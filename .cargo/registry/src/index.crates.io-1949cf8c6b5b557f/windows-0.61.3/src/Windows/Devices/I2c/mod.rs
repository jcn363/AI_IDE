...
impl windows_core::RuntimeType for I2cBusSpeed {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.I2c.I2cBusSpeed;i4)");
}
#[repr(transparent)]
...
impl I2cConnectionSettings {
    pub fn SlaveAddress(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).SlaveAddress)(
    ...
    pub fn SetSlaveAddress(&self, value: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSlaveAddress)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn BusSpeed(&self) -> windows_core::Result<I2cBusSpeed> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BusSpeed)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetBusSpeed(&self, value: I2cBusSpeed) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetBusSpeed)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    fn II2cConnectionSettingsFactory<
        R,
        F: FnOnce(&II2cConnectionSettingsFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for I2cConnectionSettings {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, II2cConnectionSettings>();
}
...
impl I2cController {
    ...
    pub fn GetControllersAsync<P0>(
        ...
        windows_future::IAsyncOperation<windows_collections::IVectorView<I2cController>>,
    >
    where
    ...
    fn II2cControllerStatics<R, F: FnOnce(&II2cControllerStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<I2cController, II2cControllerStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for I2cController {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, II2cController>();
}
...
impl I2cDevice {
    ...
    pub fn WritePartial(&self, buffer: &[u8]) -> windows_core::Result<I2cTransferResult> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WritePartial)(
                windows_core::Interface::as_raw(this),
                buffer.len().try_into().unwrap(),
                buffer.as_ptr(),
                &mut result__,
    ...
    pub fn ReadPartial(&self, buffer: &mut [u8]) -> windows_core::Result<I2cTransferResult> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReadPartial)(
                windows_core::Interface::as_raw(this),
                buffer.len().try_into().unwrap(),
                buffer.as_mut_ptr(),
                &mut result__,
    ...
    pub fn WriteRead(&self, writebuffer: &[u8], readbuffer: &mut [u8]) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).WriteRead)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn WriteReadPartial(
        ...
        writebuffer: &[u8],
        readbuffer: &mut [u8],
    ) -> windows_core::Result<I2cTransferResult> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WriteReadPartial)(
                windows_core::Interface::as_raw(this),
                writebuffer.len().try_into().unwrap(),
                writebuffer.as_ptr(),
                readbuffer.len().try_into().unwrap(),
    ...
    pub fn FromIdAsync<P1>(
        ...
        settings: P1,
    ) -> windows_core::Result<windows_future::IAsyncOperation<I2cDevice>>
    where
    ...
    fn II2cDeviceStatics<R, F: FnOnce(&II2cDeviceStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<I2cDevice, II2cDeviceStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for I2cDevice {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, II2cDevice>();
}
...
impl windows_core::RuntimeType for I2cSharingMode {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.I2c.I2cSharingMode;i4)");
}
#[repr(C)]
...
impl windows_core::RuntimeType for I2cTransferStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.I2c.I2cTransferStatus;i4)",
    );
}
windows_core::imp::define_interface!(
    II2cConnectionSettings,
    II2cConnectionSettings_Vtbl,
    0xf2db1307_ab6f_4639_a767_54536dc3460f
);
...
pub struct II2cConnectionSettings_Vtbl {
    ...
    pub BusSpeed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut I2cBusSpeed,
    ) -> windows_core::HRESULT,
    pub SetBusSpeed:
        unsafe extern "system" fn(*mut core::ffi::c_void, I2cBusSpeed) -> windows_core::HRESULT,
    pub SharingMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut I2cSharingMode,
    ) -> windows_core::HRESULT,
    pub SetSharingMode:
        unsafe extern "system" fn(*mut core::ffi::c_void, I2cSharingMode) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    II2cConnectionSettingsFactory,
    II2cConnectionSettingsFactory_Vtbl,
...
windows_core::imp::define_interface!(
    II2cController,
    II2cController_Vtbl,
    0xc48ab1b2_87a0_4166_8e3e_b4b8f97cd729
);
...
windows_core::imp::define_interface!(
    ...
    II2cControllerStatics_Vtbl,
    0x40fc0365_5f05_4e7e_84bd_100db8e0aec5
);
...
pub struct II2cDevice_Vtbl {
    ...
    pub WritePartial: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        *mut I2cTransferResult,
    ) -> windows_core::HRESULT,
    pub Read:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut u8) -> windows_core::HRESULT,
    pub ReadPartial: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u8,
        *mut I2cTransferResult,
    ) -> windows_core::HRESULT,
    pub WriteRead: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        u32,
    ...
    pub WriteReadPartial: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        u32,
...
windows_core::imp::define_interface!(
    ...
    0x91a33be3_7334_4512_96bc_fbae9459f5f6
);
...
pub trait II2cDeviceStatics_Impl: windows_core::IUnknownImpl {
    ...
    fn FromIdAsync(
        &self,
        deviceId: &windows_core::HSTRING,
        settings: windows_core::Ref<'_, I2cConnectionSettings>,
    ) -> windows_core::Result<windows_future::IAsyncOperation<I2cDevice>>;
}
    ...
    pub const fn new<Identity: II2cDeviceStatics_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match II2cDeviceStatics_Impl::GetDeviceSelectorFromFriendlyName(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match II2cDeviceStatics_Impl::FromIdAsync(
                    this,

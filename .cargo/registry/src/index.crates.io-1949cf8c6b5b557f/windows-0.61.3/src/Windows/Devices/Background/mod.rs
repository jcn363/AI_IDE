...
impl DeviceServicingDetails {
    ...
    pub fn ExpectedDuration(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ExpectedDuration)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for DeviceServicingDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDeviceServicingDetails>();
}
...
impl windows_core::RuntimeType for DeviceUseDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDeviceUseDetails>();
}
...
windows_core::imp::define_interface!(
    ...
    IDeviceServicingDetails_Vtbl,
    0x4aabee29_2344_4ac4_8527_4a8ef6905645
);
...
pub struct IDeviceServicingDetails_Vtbl {
    ...
    pub ExpectedDuration: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IDeviceUseDetails,
    IDeviceUseDetails_Vtbl,
    0x7d565141_557e_4154_b994_e4f7a11fb323
);

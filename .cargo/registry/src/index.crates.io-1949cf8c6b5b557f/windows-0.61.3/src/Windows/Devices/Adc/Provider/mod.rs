windows_core::imp::define_interface!(
    ...
    0xbe545828_816d_4de5_a048_aba06958aaa8
);
...
impl IAdcControllerProvider {
    ...
    pub fn AcquireChannel(&self, channel: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AcquireChannel)(
                windows_core::Interface::as_raw(this),
                channel,
            )
            .ok()
    ...
    pub fn ReleaseChannel(&self, channel: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReleaseChannel)(
                windows_core::Interface::as_raw(this),
                channel,
            )
            .ok()
...
impl IAdcControllerProvider_Vtbl {
    pub const fn new<Identity: IAdcControllerProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ChannelCount<
        ...
        unsafe extern "system" fn ResolutionInBits<
            Identity: IAdcControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ChannelMode<
            Identity: IAdcControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            result__: *mut ProviderAdcChannelMode,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetChannelMode<
            Identity: IAdcControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            value: ProviderAdcChannelMode,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsChannelModeSupported<
            Identity: IAdcControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AcquireChannel<
            Identity: IAdcControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ReleaseChannel<
            Identity: IAdcControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ReadValue<
            Identity: IAdcControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub struct IAdcControllerProvider_Vtbl {
    ...
    pub ChannelMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ProviderAdcChannelMode,
    ) -> windows_core::HRESULT,
    pub SetChannelMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IAdcProvider,
    IAdcProvider_Vtbl,
    0x28953668_9359_4c57_bc88_e275e81638c9
);
...
impl IAdcProvider {
    pub fn GetControllers(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<IAdcControllerProvider>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IAdcProvider_Vtbl {
    pub const fn new<Identity: IAdcProvider_Impl, const OFFSET: isize>() -> Self {
        ...
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IAdcProvider, OFFSET>(),
...
impl windows_core::RuntimeType for ProviderAdcChannelMode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Adc.Provider.ProviderAdcChannelMode;i4)",
    );
}

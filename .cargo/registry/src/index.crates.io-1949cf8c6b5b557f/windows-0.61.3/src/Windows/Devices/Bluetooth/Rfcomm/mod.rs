windows_core::imp::define_interface!(
    ...
    IRfcommDeviceService_Vtbl,
    0xae81ff1f_c5a1_4c40_8c28_f3efd69062f3
);
...
pub struct IRfcommDeviceService_Vtbl {
    ...
    pub ConnectionHostName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Networking"))]
    ConnectionHostName: usize,
    pub ConnectionServiceName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub ProtectionLevel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Networking::Sockets::SocketProtectionLevel,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Networking_Sockets"))]
    ProtectionLevel: usize,
    #[cfg(feature = "Networking_Sockets")]
    pub MaxProtectionLevel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Networking::Sockets::SocketProtectionLevel,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Networking_Sockets"))]
    ...
    pub GetSdpRawAttributesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub GetSdpRawAttributesWithCacheModeAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IRfcommDeviceService2_Vtbl,
    0x536ced14_ebcd_49fe_bf9f_40efc689b20d
);
...
windows_core::imp::define_interface!(
    ...
    IRfcommDeviceService3_Vtbl,
    0x1c22ace6_dd44_4d23_866d_8f3486ee6490
);
...
windows_core::imp::define_interface!(
    ...
    IRfcommDeviceServiceStatics_Vtbl,
    0xa4a149ef_626d_41ac_b253_87ac5c27e28a
);
...
pub struct IRfcommDeviceServiceStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetDeviceSelectorForBluetoothDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
    pub GetDeviceSelectorForBluetoothDeviceWithCacheMode:
    ...
    pub GetDeviceSelectorForBluetoothDeviceAndServiceId:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
    ...
    pub GetDeviceSelectorForBluetoothDeviceAndServiceIdWithCacheMode:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IRfcommServiceId,
    IRfcommServiceId_Vtbl,
    0x22629204_7e02_4017_8136_da1b6a1b9bbf
);
...
windows_core::imp::define_interface!(
    ...
    IRfcommServiceIdStatics_Vtbl,
    0x2a179eba_a975_46e3_b56b_08ffd783a5fe
);
...
pub struct IRfcommServiceIdStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub FromUuid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SerialPort: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ObexObjectPush: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ObexFileTransfer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PhoneBookAccessPce: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PhoneBookAccessPse: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GenericFileTransfer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRfcommServiceProvider_Vtbl,
    0xeadbfdc4_b1f6_44ff_9f7c_e7a82ab86821
);
...
pub struct IRfcommServiceProvider_Vtbl {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub SdpRawAttributes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub StartAdvertising: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Networking_Sockets"))]
...
pub struct IRfcommServiceProvider2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Networking_Sockets")]
    pub StartAdvertisingWithRadioDiscoverability:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
            bool,
...
windows_core::imp::define_interface!(
    ...
    IRfcommServiceProviderStatics_Vtbl,
    0x98888303_69ca_413a_84f7_4344c7292997
);
...
impl RfcommDeviceService {
    ...
    pub fn ConnectionHostName(
        &self,
    ) -> windows_core::Result<super::super::super::Networking::HostName> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConnectionHostName)(
    ...
    pub fn ConnectionServiceName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConnectionServiceName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn ProtectionLevel(
        &self,
    ) -> windows_core::Result<super::super::super::Networking::Sockets::SocketProtectionLevel> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MaxProtectionLevel(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxProtectionLevel)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetSdpRawAttributesAsync(
        ...
        windows_future::IAsyncOperation<
            windows_collections::IMapView<u32, super::super::super::Storage::Streams::IBuffer>,
        >,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetSdpRawAttributesAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetSdpRawAttributesWithCacheModeAsync)(
                windows_core::Interface::as_raw(this),
                cachemode,
                &mut result__,
            )
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<RfcommDeviceService>> {
        ...
        P0: windows_core::Param<super::BluetoothDevice>,
    {
        Self::IRfcommDeviceServiceStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDeviceSelectorForBluetoothDevice)(
                windows_core::Interface::as_raw(this),
                bluetoothdevice.param().abi(),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
        })
        ...
        P1: windows_core::Param<RfcommServiceId>,
    {
        Self::IRfcommDeviceServiceStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDeviceSelectorForBluetoothDeviceAndServiceId)(
                windows_core::Interface::as_raw(this),
                bluetoothdevice.param().abi(),
                serviceid.param().abi(),
                &mut result__,
    ...
    fn IRfcommDeviceServiceStatics<
        R,
        F: FnOnce(&IRfcommDeviceServiceStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ...
    fn IRfcommDeviceServiceStatics2<
        R,
        F: FnOnce(&IRfcommDeviceServiceStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RfcommDeviceService {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRfcommDeviceService>();
}
...
impl RfcommDeviceServicesResult {
    ...
    pub fn Services(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<RfcommDeviceService>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for RfcommDeviceServicesResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRfcommDeviceServicesResult>();
}
...
impl RfcommServiceId {
    ...
    pub fn AsShortId(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AsShortId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn AsString(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AsString)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn FromUuid(uuid: windows_core::GUID) -> windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromUuid)(
                windows_core::Interface::as_raw(this),
                uuid,
                &mut result__,
            )
    ...
    pub fn SerialPort() -> windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SerialPort)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ObexObjectPush() -> windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ObexObjectPush)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ObexFileTransfer() -> windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ObexFileTransfer)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn PhoneBookAccessPce() -> windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PhoneBookAccessPce)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn PhoneBookAccessPse() -> windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PhoneBookAccessPse)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GenericFileTransfer() -> windows_core::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GenericFileTransfer)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IRfcommServiceIdStatics<
        R,
        F: FnOnce(&IRfcommServiceIdStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<RfcommServiceId, IRfcommServiceIdStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for RfcommServiceId {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRfcommServiceId>();
}
...
impl RfcommServiceProvider {
    ...
    pub fn SdpRawAttributes(
        ...
        windows_collections::IMap<u32, super::super::super::Storage::Streams::IBuffer>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SdpRawAttributes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub fn StartAdvertisingWithRadioDiscoverability<P0>(
        &self,
        listener: P0,
        ...
        P0: windows_core::Param<super::super::super::Networking::Sockets::StreamSocketListener>,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(this).StartAdvertisingWithRadioDiscoverability)(
                windows_core::Interface::as_raw(this),
                listener.param().abi(),
                radiodiscoverable,
            )
    ...
    pub fn CreateAsync<P0>(
        serviceid: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<RfcommServiceProvider>>
    where
        P0: windows_core::Param<RfcommServiceId>,
    {
    ...
    fn IRfcommServiceProviderStatics<
        R,
        F: FnOnce(&IRfcommServiceProviderStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RfcommServiceProvider {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRfcommServiceProvider>();
}

...
impl CustomDevice {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SendIOControlAsync<P0, P1, P2>(
        &self,
        iocontrolcode: P0,
        inputbuffer: P1,
        outputbuffer: P2,
        ...
        P2: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SendIOControlAsync)(
                windows_core::Interface::as_raw(this),
                iocontrolcode.param().abi(),
                inputbuffer.param().abi(),
                outputbuffer.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn TrySendIOControlAsync<P0, P1, P2>(
        &self,
        iocontrolcode: P0,
        inputbuffer: P1,
        outputbuffer: P2,
        ...
        P2: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TrySendIOControlAsync)(
                windows_core::Interface::as_raw(this),
                iocontrolcode.param().abi(),
                inputbuffer.param().abi(),
                outputbuffer.param().abi(),
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<CustomDevice>> {
        Self::ICustomDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ICustomDeviceStatics<R, F: FnOnce(&ICustomDeviceStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CustomDevice, ICustomDeviceStatics> =
...
impl windows_core::RuntimeType for CustomDevice {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICustomDevice>();
}
...
impl windows_core::RuntimeType for DeviceAccessMode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Custom.DeviceAccessMode;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for DeviceSharingMode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Custom.DeviceSharingMode;i4)",
    );
}
windows_core::imp::define_interface!(
    ICustomDevice,
    ICustomDevice_Vtbl,
    0xdd30251f_c48b_43bd_bcb1_dec88f15143e
);
...
pub struct ICustomDevice_Vtbl {
    ...
    OutputStream: usize,
    #[cfg(feature = "Storage_Streams")]
    pub SendIOControlAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub TrySendIOControlAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    ICustomDeviceStatics_Vtbl,
    0xc8220312_ef4c_46b1_a58e_eeb308dc8917
);
...
windows_core::imp::define_interface!(
    IIOControlCode,
    IIOControlCode_Vtbl,
    0x0e9559e7_60c8_4375_a761_7f8808066c60
);
...
impl IIOControlCode {
    ...
    pub fn BufferingMethod(&self) -> windows_core::Result<IOControlBufferingMethod> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BufferingMethod)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn Function(&self) -> windows_core::Result<u16> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Function)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl IIOControlCode_Vtbl {
    pub const fn new<Identity: IIOControlCode_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AccessMode<Identity: IIOControlCode_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut IOControlAccessMode,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn BufferingMethod<
            Identity: IIOControlCode_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            result__: *mut IOControlBufferingMethod,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Function<Identity: IIOControlCode_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut u16,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn DeviceType<Identity: IIOControlCode_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut u16,
        ) -> windows_core::HRESULT {
            unsafe {
...
pub struct IIOControlCode_Vtbl {
    ...
    pub AccessMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut IOControlAccessMode,
    ) -> windows_core::HRESULT,
    pub BufferingMethod: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut IOControlBufferingMethod,
    ) -> windows_core::HRESULT,
    pub Function:
...
windows_core::imp::define_interface!(
    ...
    IIOControlCodeFactory_Vtbl,
    0x856a7cf0_4c11_44ae_afc6_b8d4a212788f
);
...
pub struct IIOControlCodeFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateIOControlCode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u16,
        u16,
        IOControlAccessMode,
...
windows_core::imp::define_interface!(
    ...
    IKnownDeviceTypesStatics_Vtbl,
    0xee5479c2_5448_45da_ad1b_24948c239094
);
...
impl windows_core::RuntimeType for IOControlAccessMode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Custom.IOControlAccessMode;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for IOControlBufferingMethod {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Custom.IOControlBufferingMethod;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl IOControlCode {
    ...
    pub fn CreateIOControlCode(
        devicetype: u16,
        function: u16,
        accessmode: IOControlAccessMode,
        bufferingmethod: IOControlBufferingMethod,
    ) -> windows_core::Result<IOControlCode> {
        Self::IIOControlCodeFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateIOControlCode)(
                windows_core::Interface::as_raw(this),
                devicetype,
                function,
                accessmode,
    ...
    fn IIOControlCodeFactory<R, F: FnOnce(&IIOControlCodeFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<IOControlCode, IIOControlCodeFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for IOControlCode {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IIOControlCode>();
}
...
impl KnownDeviceTypes {
    ...
    fn IKnownDeviceTypesStatics<
        R,
        F: FnOnce(&IKnownDeviceTypesStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<KnownDeviceTypes, IKnownDeviceTypesStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}

...
pub struct ILampArray_Vtbl {
    ...
    pub HardwareVersion:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u16) -> windows_core::HRESULT,
    pub LampArrayKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut LampArrayKind,
    ) -> windows_core::HRESULT,
    pub LampCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub MinUpdateInterval: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub IsConnected:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SupportsVirtualKeys:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub GetLampInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "System")]
    pub GetIndicesForKey: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub GetIndicesForPurposes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        LampPurposes,
        *mut u32,
        *mut *mut i32,
    ...
    pub SetColorsForKey: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::UI::Color,
        super::super::System::VirtualKey,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "System", feature = "UI"))]
    pub SetColorsForKeys: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const super::super::UI::Color,
        u32,
        *const super::super::System::VirtualKey,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "System", feature = "UI")))]
    SetColorsForKeys: usize,
    #[cfg(feature = "UI")]
    pub SetColorsForPurposes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::UI::Color,
        LampPurposes,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub RequestMessageAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ILampArray2,
    ILampArray2_Vtbl,
    0x050c181f_60a8_4711_a1af_1b1b4c658ea2
);
...
windows_core::imp::define_interface!(
    ILampArrayStatics,
    ILampArrayStatics_Vtbl,
    0x7bb8c98d_5fc1_452d_bb1f_4ad410d398ff
);
...
windows_core::imp::define_interface!(
    ILampInfo,
    ILampInfo_Vtbl,
    0x30bb521c_0acf_49da_8c10_150b9cf62713
);
...
pub struct ILampInfo_Vtbl {
    ...
    pub Purposes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut LampPurposes,
    ) -> windows_core::HRESULT,
    ...
    pub GainLevelCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    #[cfg(feature = "UI")]
    pub FixedColor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "UI"))]
    FixedColor: usize,
    #[cfg(feature = "UI")]
    pub GetNearestSupportedColor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::UI::Color,
        *mut super::super::UI::Color,
    ) -> windows_core::HRESULT,
    ...
    pub UpdateLatency: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ILampStatics,
    ILampStatics_Vtbl,
    0xa822416c_8885_401e_b821_8e8b38a8e8ec
);
...
impl Lamp {
    ...
    pub fn IsColorSettable(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsColorSettable)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<Lamp>> {
        Self::ILampStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ILampStatics<R, F: FnOnce(&ILampStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<Lamp, ILampStatics> =
...
impl windows_core::RuntimeType for Lamp {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ILamp>();
}
...
impl LampArray {
    ...
    pub fn HardwareVersion(&self) -> windows_core::Result<u16> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HardwareVersion)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn LampArrayKind(&self) -> windows_core::Result<LampArrayKind> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LampArrayKind)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn LampCount(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LampCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MinUpdateInterval(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MinUpdateInterval)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SupportsVirtualKeys(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportsVirtualKeys)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetLampInfo(&self, lampindex: i32) -> windows_core::Result<LampInfo> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetLampInfo)(
                windows_core::Interface::as_raw(this),
                lampindex,
                &mut result__,
            )
    ...
    pub fn GetIndicesForKey(
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).GetIndicesForKey)(
                windows_core::Interface::as_raw(this),
                key,
    ...
    pub fn GetIndicesForPurposes(
        ...
        unsafe {
            let mut result__ = core::mem::MaybeUninit::zeroed();
            (windows_core::Interface::vtable(this).GetIndicesForPurposes)(
                windows_core::Interface::as_raw(this),
                purposes,
                windows_core::Array::<i32>::set_abi_len(core::mem::transmute(&mut result__)),
                result__.as_mut_ptr() as *mut _ as _,
    ...
    pub fn SetColorsForIndices(
        &self,
        desiredcolors: &[super::super::UI::Color],
        lampindexes: &[i32],
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
    ...
    pub fn SetColorsForKey(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetColorsForKey)(
                windows_core::Interface::as_raw(this),
                desiredcolor,
                key,
            )
    ...
    pub fn SetColorsForKeys(
        &self,
        desiredcolors: &[super::super::UI::Color],
        keys: &[super::super::System::VirtualKey],
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetColorsForKeys)(
                windows_core::Interface::as_raw(this),
                desiredcolors.len().try_into().unwrap(),
                desiredcolors.as_ptr(),
    ...
    pub fn SetColorsForPurposes(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetColorsForPurposes)(
                windows_core::Interface::as_raw(this),
                desiredcolor,
                purposes,
            )
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestMessageAsync)(
                windows_core::Interface::as_raw(this),
                messageid,
                &mut result__,
            )
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<LampArray, windows_core::IInspectable>,
        >,
    {
        let this = &windows_core::Interface::cast::<ILampArray2>(self)?;
        unsafe {
    ...
    pub fn FromIdAsync(
        deviceid: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<LampArray>> {
        Self::ILampArrayStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromIdAsync)(
                windows_core::Interface::as_raw(this),
    ...
    fn ILampArrayStatics<R, F: FnOnce(&ILampArrayStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<LampArray, ILampArrayStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for LampArray {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ILampArray>();
}
...
impl windows_core::RuntimeType for LampAvailabilityChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ILampAvailabilityChangedEventArgs>();
}
unsafe impl windows_core::Interface for LampAvailabilityChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ILampAvailabilityChangedEventArgs as windows_core::Interface>::IID;
}
...
impl LampInfo {
    ...
    pub fn Purposes(&self) -> windows_core::Result<LampPurposes> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Purposes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn RedLevelCount(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RedLevelCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GreenLevelCount(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GreenLevelCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn BlueLevelCount(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BlueLevelCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GainLevelCount(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GainLevelCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn FixedColor(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FixedColor)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetNearestSupportedColor(
        &self,
        desiredcolor: super::super::UI::Color,
    ) -> windows_core::Result<super::super::UI::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNearestSupportedColor)(
                windows_core::Interface::as_raw(this),
                desiredcolor,
                &mut result__,
            )
    ...
    pub fn UpdateLatency(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UpdateLatency)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for LampInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ILampInfo>();
}
...
impl windows_core::RuntimeType for LampPurposes {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Lights.LampPurposes;u4)");
}
impl LampPurposes {

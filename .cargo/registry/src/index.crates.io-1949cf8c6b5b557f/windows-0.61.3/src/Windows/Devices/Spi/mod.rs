...
windows_core::imp::define_interface!(
    ISpiBusInfo,
    ISpiBusInfo_Vtbl,
    0x9929444a_54f2_48c6_b952_9c32fc02c669
);
...
pub struct ISpiBusInfo_Vtbl {
    ...
    pub ChipSelectLineCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub MinClockFrequency:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub MaxClockFrequency:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SupportedDataBitLengths: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    ISpiConnectionSettings_Vtbl,
    0x5283a37f_f935_4b9f_a7a7_3a7890afa5ce
);
...
pub struct ISpiConnectionSettings_Vtbl {
    ...
    pub ChipSelectLine:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SetChipSelectLine:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub Mode:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut SpiMode) -> windows_core::HRESULT,
    pub SetMode:
        unsafe extern "system" fn(*mut core::ffi::c_void, SpiMode) -> windows_core::HRESULT,
    pub DataBitLength:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SetDataBitLength:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub ClockFrequency:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SetClockFrequency:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    ...
    pub SetSharingMode:
        unsafe extern "system" fn(*mut core::ffi::c_void, SpiSharingMode) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISpiConnectionSettingsFactory,
    ISpiConnectionSettingsFactory_Vtbl,
    0xff99081e_10c4_44b7_9fea_a748b5a46f31
);
...
windows_core::imp::define_interface!(
    ISpiController,
    ISpiController_Vtbl,
    0xa8d3c829_9895_4159_a934_8741f1ee6d27
);
...
windows_core::imp::define_interface!(
    ...
    ISpiControllerStatics_Vtbl,
    0x0d5229e2_138b_4e48_b964_4f2f79b9c5a2
);
...
windows_core::imp::define_interface!(
    ISpiDevice,
    ISpiDevice_Vtbl,
    0x05d5356d_11b6_4d39_84d5_95dfb4c9f2ce
);
...
pub struct ISpiDevice_Vtbl {
    ...
    pub ConnectionSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Write:
    ...
    pub TransferSequential: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        u32,
    ...
    pub TransferFullDuplex: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        u32,
...
windows_core::imp::define_interface!(
    ...
    0xa278e559_5720_4d3f_bd93_56f5ff5a5879
);
...
impl ISpiDeviceStatics {
    ...
    pub fn GetDeviceSelectorFromFriendlyName(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDeviceSelectorFromFriendlyName)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn GetBusInfo(&self, busid: &windows_core::HSTRING) -> windows_core::Result<SpiBusInfo> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetBusInfo)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(busid),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn FromIdAsync<P1>(
        &self,
        busid: &windows_core::HSTRING,
        settings: P1,
    ) -> windows_core::Result<windows_future::IAsyncOperation<SpiDevice>>
    where
...
impl ISpiDeviceStatics_Vtbl {
    pub const fn new<Identity: ISpiDeviceStatics_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetDeviceSelectorFromFriendlyName<
            Identity: ISpiDeviceStatics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISpiDeviceStatics_Impl::GetDeviceSelectorFromFriendlyName(
                    this,
        ...
        unsafe extern "system" fn FromIdAsync<
            Identity: ISpiDeviceStatics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISpiDeviceStatics_Impl::FromIdAsync(
                    this,
                    core::mem::transmute(&busid),
...
pub struct ISpiDeviceStatics_Vtbl {
    ...
    pub GetDeviceSelectorFromFriendlyName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl SpiBusInfo {
    pub fn ChipSelectLineCount(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ChipSelectLineCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MinClockFrequency(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MinClockFrequency)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MaxClockFrequency(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxClockFrequency)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SupportedDataBitLengths(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedDataBitLengths)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for SpiBusInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpiBusInfo>();
}
...
impl SpiConnectionSettings {
    pub fn ChipSelectLine(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ChipSelectLine)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetChipSelectLine(&self, value: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetChipSelectLine)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn DataBitLength(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DataBitLength)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetDataBitLength(&self, value: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDataBitLength)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn ClockFrequency(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ClockFrequency)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetClockFrequency(&self, value: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetClockFrequency)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    fn ISpiConnectionSettingsFactory<
        R,
        F: FnOnce(&ISpiConnectionSettingsFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for SpiConnectionSettings {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpiConnectionSettings>();
}
...
impl SpiController {
        ...
        P0: windows_core::Param<SpiConnectionSettings>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDevice)(
                windows_core::Interface::as_raw(this),
                settings.param().abi(),
                &mut result__,
            )
    ...
    pub fn GetControllersAsync<P0>(
        ...
        windows_future::IAsyncOperation<windows_collections::IVectorView<SpiController>>,
    >
    where
    ...
    fn ISpiControllerStatics<R, F: FnOnce(&ISpiControllerStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SpiController, ISpiControllerStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for SpiController {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpiController>();
}
...
impl SpiDevice {
    ...
    pub fn ConnectionSettings(&self) -> windows_core::Result<SpiConnectionSettings> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConnectionSettings)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn TransferSequential(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).TransferSequential)(
                windows_core::Interface::as_raw(this),
                writebuffer.len().try_into().unwrap(),
                writebuffer.as_ptr(),
                readbuffer.len().try_into().unwrap(),
    ...
    pub fn TransferFullDuplex(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).TransferFullDuplex)(
                windows_core::Interface::as_raw(this),
                writebuffer.len().try_into().unwrap(),
                writebuffer.as_ptr(),
                readbuffer.len().try_into().unwrap(),
    ...
    fn ISpiDeviceStatics<R, F: FnOnce(&ISpiDeviceStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SpiDevice, ISpiDeviceStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for SpiDevice {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpiDevice>();
}
...
impl windows_core::RuntimeType for SpiMode {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Spi.SpiMode;i4)");
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SpiSharingMode {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Spi.SpiSharingMode;i4)");
}

windows_core::imp::define_interface!(
    ...
    IProviderSpiConnectionSettings_Vtbl,
...
pub struct IProviderSpiConnectionSettings_Vtbl {
    ...
    pub SetMode:
        unsafe extern "system" fn(*mut core::ffi::c_void, ProviderSpiMode) -> windows_core::HRESULT,
    pub DataBitLength:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IProviderSpiConnectionSettingsFactory_Vtbl,
    0x66456b5a_0c79_43e3_9f3c_e59780ac18fa
);
...
windows_core::imp::define_interface!(
    ...
    0xc1686504_02ce_4226_a385_4f11fb04b41b
);
...
impl ISpiControllerProvider {
        ...
        P0: windows_core::Param<ProviderSpiConnectionSettings>,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).GetDeviceProvider)(
...
pub trait ISpiControllerProvider_Impl: windows_core::IUnknownImpl {
    fn GetDeviceProvider(
        &self,
        settings: windows_core::Ref<'_, ProviderSpiConnectionSettings>,
    ) -> windows_core::Result<ISpiDeviceProvider>;
}
impl ISpiControllerProvider_Vtbl {
    pub const fn new<Identity: ISpiControllerProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDeviceProvider<
        ...
        >(
            ...
            unsafe {
                ...
                match ISpiControllerProvider_Impl::GetDeviceProvider(
                    this,
...
pub struct ISpiControllerProvider_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetDeviceProvider: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x0d1c3443_304b_405c_b4f7_f5ab1074461e
);
...
impl ISpiDeviceProvider_Vtbl {
    pub const fn new<Identity: ISpiDeviceProvider_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn ConnectionSettings<
            Identity: ISpiDeviceProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Write<Identity: ISpiDeviceProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISpiDeviceProvider_Impl::Write(
                    this,
                    core::slice::from_raw_parts(
                        core::mem::transmute_copy(&buffer),
                        buffer_array_size as usize,
                    ),
                )
                .into()
            }
        }
        unsafe extern "system" fn Read<Identity: ISpiDeviceProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            buffer_array_size: u32,
            buffer: *mut u8,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn TransferSequential<
            Identity: ISpiDeviceProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISpiDeviceProvider_Impl::TransferSequential(
                    this,
                    core::slice::from_raw_parts(
                        core::mem::transmute_copy(&writebuffer),
                        writebuffer_array_size as usize,
                    ),
                    core::slice::from_raw_parts_mut(
                        core::mem::transmute_copy(&readbuffer),
                        readbuffer_array_size as usize,
                    ),
                )
                .into()
            }
        }
        unsafe extern "system" fn TransferFullDuplex<
            Identity: ISpiDeviceProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISpiDeviceProvider_Impl::TransferFullDuplex(
                    this,
                    core::slice::from_raw_parts(
                        core::mem::transmute_copy(&writebuffer),
                        writebuffer_array_size as usize,
...
windows_core::imp::define_interface!(
    ISpiProvider,
    ISpiProvider_Vtbl,
    0x96b461e2_77d4_48ce_aaa0_75715a8362cf
);
...
impl ISpiProvider {
    pub fn GetControllersAsync(
        ...
        windows_future::IAsyncOperation<windows_collections::IVectorView<ISpiControllerProvider>>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ISpiProvider_Vtbl {
    pub const fn new<Identity: ISpiProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetControllersAsync<
        ...
        Self {
            ...
            GetControllersAsync: GetControllersAsync::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl ProviderSpiConnectionSettings {
    ...
    fn IProviderSpiConnectionSettingsFactory<
        R,
        F: FnOnce(&IProviderSpiConnectionSettingsFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for ProviderSpiConnectionSettings {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IProviderSpiConnectionSettings>();
}
unsafe impl windows_core::Interface for ProviderSpiConnectionSettings {
    ...
    const IID: windows_core::GUID =
        <IProviderSpiConnectionSettings as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for ProviderSpiMode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Spi.Provider.ProviderSpiMode;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for ProviderSpiSharingMode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Spi.Provider.ProviderSpiSharingMode;i4)",
    );
}

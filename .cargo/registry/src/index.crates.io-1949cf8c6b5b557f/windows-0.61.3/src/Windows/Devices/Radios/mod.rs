...
pub struct IRadio_Vtbl {
    ...
    pub SetStateAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        RadioState,
    ...
    pub State:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut RadioState) -> windows_core::HRESULT,
    pub Name: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Kind:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut RadioKind) -> windows_core::HRESULT,
}
...
pub struct IRadioStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetRadiosAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl Radio {
    pub fn SetStateAsync(
        &self,
        value: RadioState,
    ) -> windows_core::Result<windows_future::IAsyncOperation<RadioAccessStatus>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetStateAsync)(
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<Radio, windows_core::IInspectable>,
        >,
    {
        let this = self;
        unsafe {
    ...
    pub fn GetRadiosAsync() -> windows_core::Result<
        windows_future::IAsyncOperation<windows_collections::IVectorView<Radio>>,
    > {
        Self::IRadioStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetRadiosAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<Radio>> {
        Self::IRadioStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IRadioStatics<R, F: FnOnce(&IRadioStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<Radio, IRadioStatics> =
...
impl windows_core::RuntimeType for Radio {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRadio>();
}
...
impl windows_core::RuntimeType for RadioKind {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Radios.RadioKind;i4)");
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for RadioState {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Devices.Radios.RadioState;i4)");
}

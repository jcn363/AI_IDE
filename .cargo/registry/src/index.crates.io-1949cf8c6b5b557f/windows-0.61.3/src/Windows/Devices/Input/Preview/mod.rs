...
impl windows_core::RuntimeType for GazeDeviceConfigurationStatePreview {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Input.Preview.GazeDeviceConfigurationStatePreview;i4)",
    );
}
#[repr(transparent)]
...
impl GazeDevicePreview {
    ...
    pub fn CanTrackEyes(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CanTrackEyes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CanTrackHead(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CanTrackHead)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ConfigurationState(&self) -> windows_core::Result<GazeDeviceConfigurationStatePreview> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConfigurationState)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn RequestCalibrationAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestCalibrationAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn GetNumericControlDescriptions(
        ...
        windows_collections::IVectorView<
            super::super::HumanInterfaceDevice::HidNumericControlDescription,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn GetBooleanControlDescriptions(
        ...
        windows_collections::IVectorView<
            super::super::HumanInterfaceDevice::HidBooleanControlDescription,
        >,
    > {
        let this = self;
        unsafe {
...
impl windows_core::RuntimeType for GazeDevicePreview {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGazeDevicePreview>();
}
...
impl windows_core::RuntimeType for GazeDeviceWatcherAddedPreviewEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGazeDeviceWatcherAddedPreviewEventArgs>(
        );
}
unsafe impl windows_core::Interface for GazeDeviceWatcherAddedPreviewEventArgs {
    ...
    const IID: windows_core::GUID =
        <IGazeDeviceWatcherAddedPreviewEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for GazeDeviceWatcherPreview {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGazeDeviceWatcherPreview>();
}
...
unsafe impl windows_core::Interface for GazeDeviceWatcherRemovedPreviewEventArgs {
    ...
    const IID: windows_core::GUID =
        <IGazeDeviceWatcherRemovedPreviewEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for GazeDeviceWatcherUpdatedPreviewEventArgs {
    ...
    const IID: windows_core::GUID =
        <IGazeDeviceWatcherUpdatedPreviewEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for GazeEnteredPreviewEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGazeEnteredPreviewEventArgs>();
}
...
impl windows_core::RuntimeType for GazeExitedPreviewEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGazeExitedPreviewEventArgs>();
}
...
impl GazeInputSourcePreview {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GazeMoved)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveGazeMoved(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveGazeMoved)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GazeEntered)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveGazeEntered(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveGazeEntered)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GazeExited)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveGazeExited(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveGazeExited)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    fn IGazeInputSourcePreviewStatics<
        R,
        F: FnOnce(&IGazeInputSourcePreviewStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for GazeInputSourcePreview {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGazeInputSourcePreview>();
}
...
impl GazeMovedPreviewEventArgs {
    ...
    pub fn GetIntermediatePoints(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<GazePointPreview>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for GazeMovedPreviewEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGazeMovedPreviewEventArgs>();
}
...
impl GazePointPreview {
    pub fn SourceDevice(&self) -> windows_core::Result<GazeDevicePreview> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SourceDevice)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn EyeGazePosition(
        &self,
    ) -> windows_core::Result<
        super::super::super::Foundation::IReference<super::super::super::Foundation::Point>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EyeGazePosition)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HeadGazePosition)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Devices_HumanInterfaceDevice")]
    pub fn HidInputReport(
        &self,
    ) -> windows_core::Result<super::super::HumanInterfaceDevice::HidInputReport> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HidInputReport)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for GazePointPreview {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGazePointPreview>();
}
...
windows_core::imp::define_interface!(
    IGazeDevicePreview,
    IGazeDevicePreview_Vtbl,
    0xe79e7ee9_b389_11e7_b201_c8d3ffb75721
);
...
pub struct IGazeDevicePreview_Vtbl {
    ...
    pub CanTrackHead:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub ConfigurationState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GazeDeviceConfigurationStatePreview,
    ) -> windows_core::HRESULT,
    pub RequestCalibrationAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IGazeDeviceWatcherAddedPreviewEventArgs_Vtbl,
    0xe79e7eed_b389_11e7_b201_c8d3ffb75721
);
...
windows_core::imp::define_interface!(
    ...
    IGazeDeviceWatcherPreview_Vtbl,
    0xe79e7ee7_b389_11e7_b201_c8d3ffb75721
);
...
windows_core::imp::define_interface!(
    ...
    0xf2631f08_0e3f_431f_a606_50b35af94a1c
);
...
windows_core::imp::define_interface!(
    IGazeDeviceWatcherUpdatedPreviewEventArgs,
    IGazeDeviceWatcherUpdatedPreviewEventArgs_Vtbl,
    0x7fe830ef_7f08_4737_88e1_4a83ae4e4885
);
...
windows_core::imp::define_interface!(
    ...
    IGazeEnteredPreviewEventArgs_Vtbl,
    0x2567bf43_1225_489f_9dd1_daa7c50fbf4b
);
...
windows_core::imp::define_interface!(
    ...
    IGazeExitedPreviewEventArgs_Vtbl,
    0x5d0af07e_7d83_40ef_9f0a_fbc1bbdcc5ac
);
...
windows_core::imp::define_interface!(
    ...
    IGazeInputSourcePreview_Vtbl,
    0xe79e7ee8_b389_11e7_b201_c8d3ffb75721
);
...
pub struct IGazeInputSourcePreview_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GazeMoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveGazeMoved:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub GazeEntered: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveGazeEntered:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub GazeExited: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveGazeExited:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IGazeInputSourcePreviewStatics,
    IGazeInputSourcePreviewStatics_Vtbl,
    0xe79e7ee6_b389_11e7_b201_c8d3ffb75721
);
...
windows_core::imp::define_interface!(
    ...
    IGazeMovedPreviewEventArgs_Vtbl,
    0xe79e7eeb_b389_11e7_b201_c8d3ffb75721
);
...
windows_core::imp::define_interface!(
    IGazePointPreview,
    IGazePointPreview_Vtbl,
    0xe79e7eea_b389_11e7_b201_c8d3ffb75721
);
...
pub struct IGazePointPreview_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SourceDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub EyeGazePosition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub HeadGazePosition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Timestamp:
    ...
    #[cfg(feature = "Devices_HumanInterfaceDevice")]
    pub HidInputReport: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Devices_HumanInterfaceDevice"))]

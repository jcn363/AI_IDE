...
impl windows_core::RuntimeType for ErrorReceivedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IErrorReceivedEventArgs>();
}
...
windows_core::imp::define_interface!(
    ...
    IErrorReceivedEventArgs_Vtbl,
    0xfcc6bf59_1283_4d8a_bfdf_566b33ddb28f
);
...
windows_core::imp::define_interface!(
    ...
    IPinChangedEventArgs_Vtbl,
    0xa2bf1db0_fc9c_4607_93d0_fa5e8343ee22
);
...
pub struct IPinChangedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub PinChange: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SerialPinChange,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISerialDevice,
    ISerialDevice_Vtbl,
    0xe187ccc6_2210_414f_b65a_f5553a03372a
);
...
pub struct ISerialDevice_Vtbl {
    ...
    pub BreakSignalState:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetBreakSignalState:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub BytesReceived:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub CarrierDetectState:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub ClearToSendState:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub DataBits:
    ...
    pub DataSetReadyState:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub Handshake: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SerialHandshake,
    ) -> windows_core::HRESULT,
    pub SetHandshake:
        unsafe extern "system" fn(*mut core::ffi::c_void, SerialHandshake) -> windows_core::HRESULT,
    pub IsDataTerminalReadyEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetIsDataTerminalReadyEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub IsRequestToSendEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetIsRequestToSendEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub Parity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SerialParity,
    ) -> windows_core::HRESULT,
    pub SetParity:
        unsafe extern "system" fn(*mut core::ffi::c_void, SerialParity) -> windows_core::HRESULT,
    pub PortName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ReadTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub SetReadTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub StopBits: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SerialStopBitCount,
    ) -> windows_core::HRESULT,
    pub SetStopBits: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        SerialStopBitCount,
    ) -> windows_core::HRESULT,
    pub UsbVendorId:
    ...
    pub UsbProductId:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u16) -> windows_core::HRESULT,
    pub WriteTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub SetWriteTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(not(feature = "Storage_Streams"))]
    OutputStream: usize,
    pub ErrorReceived: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveErrorReceived:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub PinChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePinChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISerialDeviceStatics,
    ISerialDeviceStatics_Vtbl,
    0x058c4a70_0836_4993_ae1a_b61ae3be056b
);
...
pub struct ISerialDeviceStatics_Vtbl {
    ...
    pub GetDeviceSelectorFromPortName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetDeviceSelectorFromUsbVidPid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u16,
        u16,
        *mut *mut core::ffi::c_void,
...
impl PinChangedEventArgs {
    pub fn PinChange(&self) -> windows_core::Result<SerialPinChange> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PinChange)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for PinChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPinChangedEventArgs>();
}
...
impl SerialDevice {
    ...
    pub fn BaudRate(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BaudRate)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetBaudRate(&self, value: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetBaudRate)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn BreakSignalState(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BreakSignalState)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetBreakSignalState(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetBreakSignalState)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn CarrierDetectState(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CarrierDetectState)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ClearToSendState(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ClearToSendState)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn DataBits(&self) -> windows_core::Result<u16> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DataBits)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetDataBits(&self, value: u16) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDataBits)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn DataSetReadyState(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DataSetReadyState)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn Handshake(&self) -> windows_core::Result<SerialHandshake> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Handshake)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetHandshake(&self, value: SerialHandshake) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetHandshake)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn IsDataTerminalReadyEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsDataTerminalReadyEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIsDataTerminalReadyEnabled(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsDataTerminalReadyEnabled)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn IsRequestToSendEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsRequestToSendEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIsRequestToSendEnabled(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsRequestToSendEnabled)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn Parity(&self) -> windows_core::Result<SerialParity> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Parity)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetParity(&self, value: SerialParity) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetParity)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn ReadTimeout(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReadTimeout)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetReadTimeout(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetReadTimeout)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn StopBits(&self) -> windows_core::Result<SerialStopBitCount> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StopBits)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetStopBits(&self, value: SerialStopBitCount) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetStopBits)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn UsbVendorId(&self) -> windows_core::Result<u16> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UsbVendorId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn UsbProductId(&self) -> windows_core::Result<u16> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UsbProductId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn WriteTimeout(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WriteTimeout)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetWriteTimeout(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetWriteTimeout)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ErrorReceived)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn RemoveErrorReceived(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveErrorReceived)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PinChanged)(
                windows_core::Interface::as_raw(this),
                reporthandler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemovePinChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemovePinChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn GetDeviceSelectorFromPortName(
        ...
        Self::ISerialDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDeviceSelectorFromPortName)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn GetDeviceSelectorFromUsbVidPid(
        ...
        Self::ISerialDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDeviceSelectorFromUsbVidPid)(
                windows_core::Interface::as_raw(this),
                vendorid,
                productid,
                &mut result__,
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<SerialDevice>> {
        Self::ISerialDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ISerialDeviceStatics<R, F: FnOnce(&ISerialDeviceStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SerialDevice, ISerialDeviceStatics> =
...
impl windows_core::RuntimeType for SerialDevice {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISerialDevice>();
}

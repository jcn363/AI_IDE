...
impl BluetoothLEAdvertisement {
    ...
    pub fn Flags(
        ...
        super::super::super::Foundation::IReference<BluetoothLEAdvertisementFlags>,
    > {
        let this = self;
        unsafe {
    ...
    pub fn ServiceUuids(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<windows_core::GUID>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ServiceUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ManufacturerData(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<BluetoothLEManufacturerData>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ManufacturerData)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn DataSections(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<BluetoothLEAdvertisementDataSection>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DataSections)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetManufacturerDataByCompanyId(
        &self,
        companyid: u16,
    ) -> windows_core::Result<windows_collections::IVectorView<BluetoothLEManufacturerData>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetManufacturerDataByCompanyId)(
                windows_core::Interface::as_raw(this),
                companyid,
                &mut result__,
            )
    ...
    pub fn GetSectionsByType(
        &self,
        r#type: u8,
    ) -> windows_core::Result<windows_collections::IVectorView<BluetoothLEAdvertisementDataSection>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetSectionsByType)(
                windows_core::Interface::as_raw(this),
                r#type,
                &mut result__,
            )
...
impl windows_core::RuntimeType for BluetoothLEAdvertisement {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBluetoothLEAdvertisement>();
}
...
impl BluetoothLEAdvertisementBytePattern {
    ...
    pub fn Create<P2>(
        ...
        offset: i16,
        data: P2,
    ) -> windows_core::Result<BluetoothLEAdvertisementBytePattern>
    where
    ...
    fn IBluetoothLEAdvertisementBytePatternFactory<
        R,
        F: FnOnce(&IBluetoothLEAdvertisementBytePatternFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for BluetoothLEAdvertisementBytePattern {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBluetoothLEAdvertisementBytePattern>();
}
unsafe impl windows_core::Interface for BluetoothLEAdvertisementBytePattern {
    ...
    const IID: windows_core::GUID =
        <IBluetoothLEAdvertisementBytePattern as windows_core::Interface>::IID;
}
...
impl BluetoothLEAdvertisementDataSection {
    ...
    pub fn Create<P1>(
        datatype: u8,
        data: P1,
    ) -> windows_core::Result<BluetoothLEAdvertisementDataSection>
    where
    ...
    fn IBluetoothLEAdvertisementDataSectionFactory<
        R,
        F: FnOnce(&IBluetoothLEAdvertisementDataSectionFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for BluetoothLEAdvertisementDataSection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBluetoothLEAdvertisementDataSection>();
}
unsafe impl windows_core::Interface for BluetoothLEAdvertisementDataSection {
    ...
    const IID: windows_core::GUID =
        <IBluetoothLEAdvertisementDataSection as windows_core::Interface>::IID;
}
...
impl BluetoothLEAdvertisementDataTypes {
    ...
    pub fn IncompleteService16BitUuids() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IncompleteService16BitUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CompleteService16BitUuids() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CompleteService16BitUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IncompleteService32BitUuids() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IncompleteService32BitUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CompleteService32BitUuids() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CompleteService32BitUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IncompleteService128BitUuids() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IncompleteService128BitUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CompleteService128BitUuids() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CompleteService128BitUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ShortenedLocalName() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShortenedLocalName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CompleteLocalName() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CompleteLocalName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PeripheralConnectionIntervalRange() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PeripheralConnectionIntervalRange)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ServiceSolicitation16BitUuids() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ServiceSolicitation16BitUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ServiceSolicitation32BitUuids() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ServiceSolicitation32BitUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ServiceSolicitation128BitUuids() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ServiceSolicitation128BitUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ServiceData16BitUuids() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ServiceData16BitUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ServiceData32BitUuids() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ServiceData32BitUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ServiceData128BitUuids() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ServiceData128BitUuids)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PublicTargetAddress() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PublicTargetAddress)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn RandomTargetAddress() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RandomTargetAddress)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn AdvertisingInterval() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AdvertisingInterval)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ManufacturerSpecificData() -> windows_core::Result<u8> {
        Self::IBluetoothLEAdvertisementDataTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ManufacturerSpecificData)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    fn IBluetoothLEAdvertisementDataTypesStatics<
        R,
        F: FnOnce(&IBluetoothLEAdvertisementDataTypesStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl BluetoothLEAdvertisementFilter {
        ...
        P0: windows_core::Param<BluetoothLEAdvertisement>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAdvertisement)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn BytePatterns(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<BluetoothLEAdvertisementBytePattern>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BytePatterns)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for BluetoothLEAdvertisementFilter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBluetoothLEAdvertisementFilter>();
}
unsafe impl windows_core::Interface for BluetoothLEAdvertisementFilter {
    ...
    const IID: windows_core::GUID =
        <IBluetoothLEAdvertisementFilter as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for BluetoothLEAdvertisementFlags {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags;u4)",
    );
}
impl BluetoothLEAdvertisementFlags {
...
impl BluetoothLEAdvertisementPublisher {
    ...
    pub fn PreferredTransmitPowerLevelInDBm(
        &self,
    ) -> windows_core::Result<super::super::super::Foundation::IReference<i16>> {
    ...
    pub fn UseExtendedAdvertisement(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UseExtendedAdvertisement)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetUseExtendedAdvertisement(&self, value: bool) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IBluetoothLEAdvertisementPublisher2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetUseExtendedAdvertisement)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    fn IBluetoothLEAdvertisementPublisherFactory<
        R,
        F: FnOnce(&IBluetoothLEAdvertisementPublisherFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for BluetoothLEAdvertisementPublisher {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBluetoothLEAdvertisementPublisher>();
}
unsafe impl windows_core::Interface for BluetoothLEAdvertisementPublisher {
    ...
    const IID: windows_core::GUID =
        <IBluetoothLEAdvertisementPublisher as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for BluetoothLEAdvertisementPublisherStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementPublisherStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl BluetoothLEAdvertisementPublisherStatusChangedEventArgs {
    ...
    pub fn SelectedTransmitPowerLevelInDBm(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SelectedTransmitPowerLevelInDBm)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
unsafe impl windows_core::Interface for BluetoothLEAdvertisementPublisherStatusChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IBluetoothLEAdvertisementPublisherStatusChangedEventArgs as windows_core::Interface>::IID;
}
...
impl BluetoothLEAdvertisementReceivedEventArgs {
    pub fn RawSignalStrengthInDBm(&self) -> windows_core::Result<i16> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RawSignalStrengthInDBm)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn AdvertisementType(&self) -> windows_core::Result<BluetoothLEAdvertisementType> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AdvertisementType)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn BluetoothAddressType(&self) -> windows_core::Result<super::BluetoothAddressType> {
        let this =
            &windows_core::Interface::cast::<IBluetoothLEAdvertisementReceivedEventArgs2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TransmitPowerLevelInDBm(
        &self,
    ) -> windows_core::Result<super::super::super::Foundation::IReference<i16>> {
        let this =
            &windows_core::Interface::cast::<IBluetoothLEAdvertisementReceivedEventArgs2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TransmitPowerLevelInDBm)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn IsScannable(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsScannable)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsDirected(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsDirected)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsScanResponse(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsScanResponse)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
unsafe impl windows_core::Interface for BluetoothLEAdvertisementReceivedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IBluetoothLEAdvertisementReceivedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for BluetoothLEAdvertisementType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementType;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl BluetoothLEAdvertisementWatcher {
    ...
    pub fn ScanningMode(&self) -> windows_core::Result<BluetoothLEScanningMode> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ScanningMode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetScanningMode(&self, value: BluetoothLEScanningMode) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetScanningMode)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SignalStrengthFilter(
        &self,
    ) -> windows_core::Result<super::BluetoothSignalStrengthFilter> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Received)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn Create<P0>(
        advertisementfilter: P0,
    ) -> windows_core::Result<BluetoothLEAdvertisementWatcher>
    where
        P0: windows_core::Param<BluetoothLEAdvertisementFilter>,
    {
    ...
    fn IBluetoothLEAdvertisementWatcherFactory<
        R,
        F: FnOnce(&IBluetoothLEAdvertisementWatcherFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for BluetoothLEAdvertisementWatcher {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBluetoothLEAdvertisementWatcher>();
}
unsafe impl windows_core::Interface for BluetoothLEAdvertisementWatcher {
    ...
    const IID: windows_core::GUID =
        <IBluetoothLEAdvertisementWatcher as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for BluetoothLEAdvertisementWatcherStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementWatcherStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
unsafe impl windows_core::Interface for BluetoothLEAdvertisementWatcherStoppedEventArgs {
    type Vtable =
        <IBluetoothLEAdvertisementWatcherStoppedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IBluetoothLEAdvertisementWatcherStoppedEventArgs as windows_core::Interface>::IID;
}
...
impl BluetoothLEManufacturerData {
    ...
    pub fn CompanyId(&self) -> windows_core::Result<u16> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CompanyId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetCompanyId(&self, value: u16) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetCompanyId)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    fn IBluetoothLEManufacturerDataFactory<
        R,
        F: FnOnce(&IBluetoothLEManufacturerDataFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for BluetoothLEManufacturerData {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBluetoothLEManufacturerData>();
}
...
impl windows_core::RuntimeType for BluetoothLEScanningMode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Bluetooth.Advertisement.BluetoothLEScanningMode;i4)",
    );
}
windows_core::imp::define_interface!(
    IBluetoothLEAdvertisement,
    IBluetoothLEAdvertisement_Vtbl,
    0x066fb2b7_33d1_4e7d_8367_cf81d0f79653
);
...
pub struct IBluetoothLEAdvertisement_Vtbl {
    ...
    pub ServiceUuids: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ManufacturerData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DataSections: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetManufacturerDataByCompanyId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u16,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetSectionsByType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0xfbfad7f2_b9c5_4a08_bc51_502f8ef68a79
);
...
windows_core::imp::define_interface!(
    ...
    0xc2e24d73_fd5c_4ec3_be2a_9ca6fa11b7bd
);
...
windows_core::imp::define_interface!(
    ...
    0xd7213314_3a43_40f9_b6f0_92bfefc34ae3
);
...
windows_core::imp::define_interface!(
    ...
    0xe7a40942_a845_4045_bf7e_3e9971db8a6b
);
...
windows_core::imp::define_interface!(
    ...
    0x3bb6472f_0606_434b_a76e_74159f0684d3
);
...
pub struct IBluetoothLEAdvertisementDataTypesStatics_Vtbl {
    ...
    pub IncompleteService16BitUuids:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub CompleteService16BitUuids:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub IncompleteService32BitUuids:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub CompleteService32BitUuids:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub IncompleteService128BitUuids:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub CompleteService128BitUuids:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub ShortenedLocalName:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub CompleteLocalName:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub TxPowerLevel:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub PeripheralConnectionIntervalRange:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub ServiceSolicitation16BitUuids:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub ServiceSolicitation32BitUuids:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub ServiceSolicitation128BitUuids:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub ServiceData16BitUuids:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub ServiceData32BitUuids:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub ServiceData128BitUuids:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub PublicTargetAddress:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub RandomTargetAddress:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub Appearance:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub AdvertisingInterval:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x131eb0d3_d04e_47b1_837e_49405bf6f80f
);
...
pub struct IBluetoothLEAdvertisementFilter_Vtbl {
    ...
    pub SetAdvertisement: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BytePatterns: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0xcde820f9_d9fa_43d6_a264_ddd8b7da8b78
);
...
pub struct IBluetoothLEAdvertisementPublisher2_Vtbl {
    ...
    pub SetPreferredTransmitPowerLevelInDBm: unsafe extern "system" fn(
        ...
        *mut core::ffi::c_void,
        ...
        -> windows_core::HRESULT,
    pub UseExtendedAdvertisement:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetUseExtendedAdvertisement:
...
windows_core::imp::define_interface!(
    ...
    0x5c5f065e_b863_4981_a1af_1c544d8b0c0d
);
...
windows_core::imp::define_interface!(
    ...
    0x09c2bd9f_2dff_4b23_86ee_0d14fb94aeae
);
...
windows_core::imp::define_interface!(
    ...
    0x8f62790e_dc88_5c8b_b34e_10b321850f88
);
...
pub struct IBluetoothLEAdvertisementPublisherStatusChangedEventArgs2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SelectedTransmitPowerLevelInDBm: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0x27987ddf_e596_41be_8d43_9e6731d4a913
);
...
pub struct IBluetoothLEAdvertisementReceivedEventArgs_Vtbl {
    ...
    pub AdvertisementType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x12d9c87b_0399_5f0e_a348_53b02b6b162e
);
...
pub struct IBluetoothLEAdvertisementReceivedEventArgs2_Vtbl {
    ...
    pub TransmitPowerLevelInDBm: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsAnonymous:
...
windows_core::imp::define_interface!(
    ...
    0xa6ac336f_f3d3_4297_8d6c_c81ea6623f40
);
...
pub struct IBluetoothLEAdvertisementWatcher_Vtbl {
    ...
    pub ScanningMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut BluetoothLEScanningMode,
    ) -> windows_core::HRESULT,
    pub SetScanningMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub Start: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Stop: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Received: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x01bf26bc_b164_5805_90a3_e8a7997ff225
);
...
windows_core::imp::define_interface!(
    ...
    0x9aaf2d56_39ac_453e_b32a_85c657e017f1
);
...
windows_core::imp::define_interface!(
    ...
    0xdd40f84d_e7b9_43e3_9c04_0685d085fd8c
);
...
windows_core::imp::define_interface!(
    ...
    0x912dba18_6963_4533_b061_4694dafb34e5
);

windows_core::imp::define_interface!(
    IPrint3DWorkflow,
    IPrint3DWorkflow_Vtbl,
    0xc56f74bd_3669_4a66_ab42_c8151930cd34
);
...
pub struct IPrint3DWorkflow_Vtbl {
    ...
    pub GetPrintModelPackage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsPrintReady:
    ...
    pub PrintRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePrintRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPrint3DWorkflow2,
    IPrint3DWorkflow2_Vtbl,
    0xa2a6c54f_8ac1_4918_9741_e34f3004239e
);
...
pub struct IPrint3DWorkflow2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub PrinterChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePrinterChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPrint3DWorkflowPrintRequestedEventArgs,
    IPrint3DWorkflowPrintRequestedEventArgs_Vtbl,
    0x19f8c858_5ac8_4b55_8a5f_e61567dafb4d
);
...
pub struct IPrint3DWorkflowPrintRequestedEventArgs_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut Print3DWorkflowStatus,
    ) -> windows_core::HRESULT,
    pub SetExtendedStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub SetSourceChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPrint3DWorkflowPrinterChangedEventArgs,
    IPrint3DWorkflowPrinterChangedEventArgs_Vtbl,
    0x45226402_95fc_4847_93b3_134dbf5c60f7
);
...
pub struct IPrint3DWorkflowPrinterChangedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub NewDeviceId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IPrintExtensionContextStatic_Vtbl,
    0xe70d9fc1_ff79_4aa4_8c9b_0c93aedfde8a
);
...
pub struct IPrintExtensionContextStatic_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub FromDeviceId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IPrintNotificationEventDetails_Vtbl,
    0xe00e4c8a_4828_4da1_8bb8_8672df8515e7
);
...
pub struct IPrintNotificationEventDetails_Vtbl {
    ...
    pub EventData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetEventData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IPrintTaskConfiguration_Vtbl,
    0xe3c22451_3aa4_4885_9240_311f5f8fbe9d
);
...
pub struct IPrintTaskConfiguration_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub PrinterExtensionContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SaveRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveSaveRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPrintTaskConfigurationSaveRequest,
    IPrintTaskConfigurationSaveRequest_Vtbl,
    0xeeaf2fcb_621e_4b62_ac77_b281cce08d60
);
...
windows_core::imp::define_interface!(
    ...
    0xe959d568_f729_44a4_871d_bd0628696a33
);
...
windows_core::imp::define_interface!(
    ...
    0xe06c2879_0d61_4938_91d0_96a45bee8479
);
...
impl Print3DWorkflow {
    ...
    pub fn GetPrintModelPackage(&self) -> windows_core::Result<windows_core::IInspectable> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPrintModelPackage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn IsPrintReady(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsPrintReady)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIsPrintReady(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsPrintReady)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PrintRequested)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn RemovePrintRequested(&self, eventcookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemovePrintRequested)(
                windows_core::Interface::as_raw(this),
                eventcookie,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PrinterChanged)(
                windows_core::Interface::as_raw(this),
                eventhandler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemovePrinterChanged(&self, eventcookie: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IPrint3DWorkflow2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemovePrinterChanged)(
                windows_core::Interface::as_raw(this),
                eventcookie,
            )
            .ok()
...
impl windows_core::RuntimeType for Print3DWorkflow {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrint3DWorkflow>();
}
...
impl windows_core::RuntimeType for Print3DWorkflowDetail {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Printers.Extensions.Print3DWorkflowDetail;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl Print3DWorkflowPrintRequestedEventArgs {
    ...
    pub fn SetSourceChanged(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSourceChanged)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for Print3DWorkflowPrintRequestedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrint3DWorkflowPrintRequestedEventArgs>(
        );
}
unsafe impl windows_core::Interface for Print3DWorkflowPrintRequestedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IPrint3DWorkflowPrintRequestedEventArgs as windows_core::Interface>::IID;
}
...
impl Print3DWorkflowPrinterChangedEventArgs {
    pub fn NewDeviceId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NewDeviceId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for Print3DWorkflowPrinterChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrint3DWorkflowPrinterChangedEventArgs>(
        );
}
unsafe impl windows_core::Interface for Print3DWorkflowPrinterChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IPrint3DWorkflowPrinterChangedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for Print3DWorkflowStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Printers.Extensions.Print3DWorkflowStatus;i4)",
    );
}
...
impl PrintExtensionContext {
    pub fn FromDeviceId(
        ...
        Self::IPrintExtensionContextStatic(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromDeviceId)(
                windows_core::Interface::as_raw(this),
    ...
    fn IPrintExtensionContextStatic<
        R,
        F: FnOnce(&IPrintExtensionContextStatic) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl PrintNotificationEventDetails {
    ...
    pub fn EventData(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EventData)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetEventData(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetEventData)(
                windows_core::Interface::as_raw(this),
...
impl windows_core::RuntimeType for PrintNotificationEventDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintNotificationEventDetails>();
}
unsafe impl windows_core::Interface for PrintNotificationEventDetails {
    ...
    const IID: windows_core::GUID =
        <IPrintNotificationEventDetails as windows_core::Interface>::IID;
}
...
impl PrintTaskConfiguration {
    pub fn PrinterExtensionContext(&self) -> windows_core::Result<windows_core::IInspectable> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PrinterExtensionContext)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SaveRequested)(
                windows_core::Interface::as_raw(this),
                eventhandler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveSaveRequested(&self, eventcookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveSaveRequested)(
                windows_core::Interface::as_raw(this),
                eventcookie,
            )
            .ok()
...
impl windows_core::RuntimeType for PrintTaskConfiguration {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintTaskConfiguration>();
}
        ...
        P0: windows_core::Param<windows_core::IInspectable>,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(this).Save)(
                windows_core::Interface::as_raw(this),
                printerextensioncontext.param().abi(),
            )
            .ok()
        }
    }
...
impl windows_core::RuntimeType for PrintTaskConfigurationSaveRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPrintTaskConfigurationSaveRequest>();
}
unsafe impl windows_core::Interface for PrintTaskConfigurationSaveRequest {
    ...
    const IID: windows_core::GUID =
        <IPrintTaskConfigurationSaveRequest as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for PrintTaskConfigurationSaveRequestedDeferral {
    ...
    const IID: windows_core::GUID =
        <IPrintTaskConfigurationSaveRequestedDeferral as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for PrintTaskConfigurationSaveRequestedEventArgs {
    type Vtable =
        <IPrintTaskConfigurationSaveRequestedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IPrintTaskConfigurationSaveRequestedEventArgs as windows_core::Interface>::IID;
}

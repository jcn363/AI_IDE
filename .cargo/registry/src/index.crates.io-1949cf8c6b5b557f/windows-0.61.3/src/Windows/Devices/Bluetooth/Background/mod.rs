...
impl BluetoothLEAdvertisementPublisherTriggerDetails {
    ...
    pub fn Status(
        &self,
    ) -> windows_core::Result<super::Advertisement::BluetoothLEAdvertisementPublisherStatus> {
        let this = self;
        unsafe {
...
unsafe impl windows_core::Interface for BluetoothLEAdvertisementPublisherTriggerDetails {
    type Vtable =
        <IBluetoothLEAdvertisementPublisherTriggerDetails as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IBluetoothLEAdvertisementPublisherTriggerDetails as windows_core::Interface>::IID;
}
...
impl BluetoothLEAdvertisementWatcherTriggerDetails {
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Advertisements)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
unsafe impl windows_core::Interface for BluetoothLEAdvertisementWatcherTriggerDetails {
    type Vtable =
        <IBluetoothLEAdvertisementWatcherTriggerDetails as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IBluetoothLEAdvertisementWatcherTriggerDetails as windows_core::Interface>::IID;
}
...
impl GattCharacteristicNotificationTriggerDetails {
    ...
    pub fn Characteristic(
        &self,
    ) -> windows_core::Result<super::GenericAttributeProfile::GattCharacteristic> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Error(&self) -> windows_core::Result<super::BluetoothError> {
        let this =
            &windows_core::Interface::cast::<IGattCharacteristicNotificationTriggerDetails2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Error)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn ValueChangedEvents(
        ...
        windows_collections::IVectorView<super::GenericAttributeProfile::GattValueChangedEventArgs>,
    > {
        let this =
            &windows_core::Interface::cast::<IGattCharacteristicNotificationTriggerDetails2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ValueChangedEvents)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
unsafe impl windows_core::Interface for GattCharacteristicNotificationTriggerDetails {
    type Vtable =
        <IGattCharacteristicNotificationTriggerDetails as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IGattCharacteristicNotificationTriggerDetails as windows_core::Interface>::IID;
}
...
impl GattServiceProviderConnection {
    ...
    pub fn Service(
        &self,
    ) -> windows_core::Result<super::GenericAttributeProfile::GattLocalService> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AllServices() -> windows_core::Result<
        windows_collections::IMapView<windows_core::HSTRING, GattServiceProviderConnection>,
    > {
        Self::IGattServiceProviderConnectionStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllServices)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IGattServiceProviderConnectionStatics<
        R,
        F: FnOnce(&IGattServiceProviderConnectionStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for GattServiceProviderConnection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGattServiceProviderConnection>();
}
unsafe impl windows_core::Interface for GattServiceProviderConnection {
    ...
    const IID: windows_core::GUID =
        <IGattServiceProviderConnection as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for GattServiceProviderTriggerDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGattServiceProviderTriggerDetails>();
}
unsafe impl windows_core::Interface for GattServiceProviderTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IGattServiceProviderTriggerDetails as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    IBluetoothLEAdvertisementPublisherTriggerDetails,
    IBluetoothLEAdvertisementPublisherTriggerDetails_Vtbl,
    0x610eca86_3480_41c9_a918_7ddadf207e00
);
...
pub struct IBluetoothLEAdvertisementPublisherTriggerDetails_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::Advertisement::BluetoothLEAdvertisementPublisherStatus,
...
windows_core::imp::define_interface!(
    IBluetoothLEAdvertisementPublisherTriggerDetails2,
    IBluetoothLEAdvertisementPublisherTriggerDetails2_Vtbl,
    0xd4a3d025_c601_42d6_9829_4ccb3f5cd77f
);
...
windows_core::imp::define_interface!(
    IBluetoothLEAdvertisementWatcherTriggerDetails,
    IBluetoothLEAdvertisementWatcherTriggerDetails_Vtbl,
    0xa7db5ad7_2257_4e69_9784_fee645c1dce0
);
...
pub struct IBluetoothLEAdvertisementWatcherTriggerDetails_Vtbl {
    ...
    #[cfg(feature = "Devices_Bluetooth_Advertisement")]
    pub Advertisements: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Devices_Bluetooth_Advertisement"))]
...
windows_core::imp::define_interface!(
    ...
    0x9ba03b18_0fec_436a_93b1_f46c697532a2
);
...
windows_core::imp::define_interface!(
    ...
    IGattCharacteristicNotificationTriggerDetails2_Vtbl,
    0x727a50dc_949d_454a_b192_983467e3d50f
);
...
pub struct IGattCharacteristicNotificationTriggerDetails2_Vtbl {
    ...
    pub EventTriggeringMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut BluetoothEventTriggeringMode,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Devices_Bluetooth_GenericAttributeProfile")]
    pub ValueChangedEvents: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Devices_Bluetooth_GenericAttributeProfile"))]
...
windows_core::imp::define_interface!(
    ...
    IGattServiceProviderConnection_Vtbl,
    0x7fa1b9b9_2f13_40b5_9582_8eb78e98ef13
);
...
windows_core::imp::define_interface!(
    ...
    0x3d509f4b_0b0e_4466_b8cd_6ebdda1fa17d
);
...
pub struct IGattServiceProviderConnectionStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AllServices: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0xae8c0625_05ff_4afb_b16a_de95f3cf0158
);
...
windows_core::imp::define_interface!(
    ...
    IRfcommConnectionTriggerDetails_Vtbl,
    0xf922734d_2e3c_4efc_ab59_fc5cf96f97e3
);
...
pub struct IRfcommConnectionTriggerDetails_Vtbl {
    ...
    pub RemoteDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRfcommInboundConnectionInformation_Vtbl,
...
pub struct IRfcommInboundConnectionInformation_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Storage_Streams")]
    pub SdpRecord: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
    SdpRecord: usize,
    #[cfg(feature = "Storage_Streams")]
    pub SetSdpRecord: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
    ...
    pub LocalServiceId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Devices_Bluetooth_Rfcomm")]
    pub SetLocalServiceId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Devices_Bluetooth_Rfcomm"))]
    ...
    pub ServiceCapabilities: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::BluetoothServiceCapabilities,
    ) -> windows_core::HRESULT,
    pub SetServiceCapabilities: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IRfcommOutboundConnectionInformation_Vtbl,
    0xb091227b_f434_4cb0_99b1_4ab8cedaedd7
);
...
pub struct IRfcommOutboundConnectionInformation_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Devices_Bluetooth_Rfcomm")]
    pub RemoteServiceId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Devices_Bluetooth_Rfcomm"))]
    ...
    #[cfg(feature = "Devices_Bluetooth_Rfcomm")]
    pub SetRemoteServiceId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Devices_Bluetooth_Rfcomm"))]
...
impl RfcommConnectionTriggerDetails {
    ...
    pub fn Socket(
        &self,
    ) -> windows_core::Result<super::super::super::Networking::Sockets::StreamSocket> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Incoming(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Incoming)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn RemoteDevice(&self) -> windows_core::Result<super::BluetoothDevice> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteDevice)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for RfcommConnectionTriggerDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRfcommConnectionTriggerDetails>();
}
unsafe impl windows_core::Interface for RfcommConnectionTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IRfcommConnectionTriggerDetails as windows_core::Interface>::IID;
}
...
impl RfcommInboundConnectionInformation {
    ...
    pub fn SdpRecord(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SdpRecord)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::super::Storage::Streams::IBuffer>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSdpRecord)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn LocalServiceId(&self) -> windows_core::Result<super::Rfcomm::RfcommServiceId> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LocalServiceId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::Rfcomm::RfcommServiceId>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetLocalServiceId)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn SetServiceCapabilities(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetServiceCapabilities)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for RfcommInboundConnectionInformation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRfcommInboundConnectionInformation>();
}
unsafe impl windows_core::Interface for RfcommInboundConnectionInformation {
    ...
    const IID: windows_core::GUID =
        <IRfcommInboundConnectionInformation as windows_core::Interface>::IID;
}
...
impl RfcommOutboundConnectionInformation {
    ...
    pub fn RemoteServiceId(&self) -> windows_core::Result<super::Rfcomm::RfcommServiceId> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteServiceId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::Rfcomm::RfcommServiceId>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetRemoteServiceId)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
...
impl windows_core::RuntimeType for RfcommOutboundConnectionInformation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRfcommOutboundConnectionInformation>();
}
unsafe impl windows_core::Interface for RfcommOutboundConnectionInformation {
    ...
    const IID: windows_core::GUID =
        <IRfcommOutboundConnectionInformation as windows_core::Interface>::IID;
}

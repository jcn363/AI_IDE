...
impl HttpBufferContent {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBufferWithOffset<P0>(
        content: P0,
        offset: u32,
        count: u32,
    ) -> windows_core::Result<HttpBufferContent>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::IHttpBufferContentFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateFromBufferWithOffset)(
                windows_core::Interface::as_raw(this),
                content.param().abi(),
                offset,
                count,
    ...
    pub fn ReadAsBufferAsync(
        ...
        windows_future::IAsyncOperationWithProgress<super::super::Storage::Streams::IBuffer, u64>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReadAsStringAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperationWithProgress<windows_core::HSTRING, u64>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IHttpBufferContentFactory<
        R,
        F: FnOnce(&IHttpBufferContentFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for HttpBufferContent {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHttpContent>();
}
...
impl HttpClient {
    ...
    pub fn GetStringAsync<P0>(
        ...
        windows_future::IAsyncOperationWithProgress<windows_core::HSTRING, HttpProgress>,
    >
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
    ...
    pub fn TryDeleteAsync<P0>(
        ...
        windows_future::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>,
    >
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        ...
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetAsync)(
                windows_core::Interface::as_raw(this),
                uri.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetAsync2)(
                windows_core::Interface::as_raw(this),
                uri.param().abi(),
                completionoption,
                &mut result__,
    ...
    pub fn TryGetBufferAsync<P0>(
        ...
        windows_future::IAsyncOperationWithProgress<HttpGetBufferResult, HttpProgress>,
    >
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetBufferAsync)(
                windows_core::Interface::as_raw(this),
                uri.param().abi(),
                &mut result__,
            )
    ...
    pub fn TryGetInputStreamAsync<P0>(
        ...
        windows_future::IAsyncOperationWithProgress<HttpGetInputStreamResult, HttpProgress>,
    >
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetInputStreamAsync)(
                windows_core::Interface::as_raw(this),
                uri.param().abi(),
                &mut result__,
            )
    ...
    pub fn TryGetStringAsync<P0>(
        ...
        windows_future::IAsyncOperationWithProgress<HttpGetStringResult, HttpProgress>,
    >
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetStringAsync)(
                windows_core::Interface::as_raw(this),
                uri.param().abi(),
                &mut result__,
            )
        ...
        P1: windows_core::Param<IHttpContent>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryPostAsync)(
                windows_core::Interface::as_raw(this),
                uri.param().abi(),
                content.param().abi(),
                &mut result__,
        ...
        P1: windows_core::Param<IHttpContent>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryPutAsync)(
                windows_core::Interface::as_raw(this),
                uri.param().abi(),
                content.param().abi(),
                &mut result__,
        ...
        P0: windows_core::Param<HttpRequestMessage>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TrySendRequestAsync)(
                windows_core::Interface::as_raw(this),
                request.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<HttpRequestMessage>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TrySendRequestAsync2)(
                windows_core::Interface::as_raw(this),
                request.param().abi(),
                completionoption,
                &mut result__,
    ...
    fn IHttpClientFactory<R, F: FnOnce(&IHttpClientFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
...
impl HttpCookie {
    ...
    pub fn HttpOnly(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HttpOnly)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetHttpOnly(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetHttpOnly)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn Secure(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Secure)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetSecure(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSecure)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    ) -> windows_core::Result<HttpCookie> {
    ...
    fn IHttpCookieFactory<R, F: FnOnce(&IHttpCookieFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<HttpCookie, IHttpCookieFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for HttpCookie {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHttpCookie>();
}
unsafe impl windows_core::Interface for HttpCookie {
    type Vtable = <IHttpCookie as windows_core::Interface>::Vtable;
...
windows_core::imp::interface_hierarchy!(
    ...
    windows_core::IUnknown,
    windows_core::IInspectable,
    windows_collections::IVectorView<HttpCookie>
);
windows_core::imp::required_hierarchy!(
    HttpCookieCollection,
    windows_collections::IIterable<HttpCookie>
);
impl HttpCookieCollection {
    pub fn First(&self) -> windows_core::Result<windows_collections::IIterator<HttpCookie>> {
        let this =
            &windows_core::Interface::cast::<windows_collections::IIterable<HttpCookie>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
unsafe impl windows_core::Interface for HttpCookieCollection {
    ...
    const IID: windows_core::GUID =
        <windows_collections::IVectorView<HttpCookie> as windows_core::Interface>::IID;
}
...
impl HttpCookieManager {
        ...
        P0: windows_core::Param<HttpCookie>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetCookie)(
                windows_core::Interface::as_raw(this),
                cookie.param().abi(),
                &mut result__,
            )
    ...
    pub fn SetCookieWithThirdParty<P0>(
        &self,
        cookie: P0,
        thirdparty: bool,
        ...
        P0: windows_core::Param<HttpCookie>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetCookieWithThirdParty)(
                windows_core::Interface::as_raw(this),
                cookie.param().abi(),
                thirdparty,
                &mut result__,
        ...
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCookies)(
                windows_core::Interface::as_raw(this),
                uri.param().abi(),
                &mut result__,
            )
...
impl windows_core::RuntimeType for HttpCookieManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHttpCookieManager>();
}
unsafe impl windows_core::Interface for HttpCookieManager {
    type Vtable = <IHttpCookieManager as windows_core::Interface>::Vtable;
...
impl HttpFormUrlEncodedContent {
    ...
    fn IHttpFormUrlEncodedContentFactory<
        R,
        F: FnOnce(&IHttpFormUrlEncodedContentFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl HttpGetBufferResult {
    ...
    pub fn ResponseMessage(&self) -> windows_core::Result<HttpResponseMessage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResponseMessage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for HttpGetBufferResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHttpGetBufferResult>();
}
unsafe impl windows_core::Interface for HttpGetBufferResult {
    type Vtable = <IHttpGetBufferResult as windows_core::Interface>::Vtable;
...
impl windows_core::RuntimeType for HttpGetInputStreamResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHttpGetInputStreamResult>();
}
unsafe impl windows_core::Interface for HttpGetInputStreamResult {
    type Vtable = <IHttpGetInputStreamResult as windows_core::Interface>::Vtable;
...
impl windows_core::RuntimeType for HttpGetStringResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHttpGetStringResult>();
}
unsafe impl windows_core::Interface for HttpGetStringResult {
    type Vtable = <IHttpGetStringResult as windows_core::Interface>::Vtable;
...
impl HttpMethod {
    ...
    fn IHttpMethodFactory<R, F: FnOnce(&IHttpMethodFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
    ...
    fn IHttpMethodStatics<R, F: FnOnce(&IHttpMethodStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
...
windows_core::imp::required_hierarchy!(
    HttpMultipartContent,
    super::super::Foundation::IClosable,
    windows_collections::IIterable<IHttpContent>,
    super::super::Foundation::IStringable
);
impl HttpMultipartContent {
    ...
    pub fn CreateWithSubtype(
        subtype: &windows_core::HSTRING,
    ) -> windows_core::Result<HttpMultipartContent> {
        Self::IHttpMultipartContentFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithSubtype)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn CreateWithSubtypeAndBoundary(
        subtype: &windows_core::HSTRING,
        boundary: &windows_core::HSTRING,
    ) -> windows_core::Result<HttpMultipartContent> {
        Self::IHttpMultipartContentFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithSubtypeAndBoundary)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(subtype),
    ...
    pub fn First(&self) -> windows_core::Result<windows_collections::IIterator<IHttpContent>> {
        let this =
            &windows_core::Interface::cast::<windows_collections::IIterable<IHttpContent>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).First)(
                windows_core::Interface::as_raw(this),
    ...
    fn IHttpMultipartContentFactory<
        R,
        F: FnOnce(&IHttpMultipartContentFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl HttpMultipartFormDataContent {
        ...
        P0: windows_core::Param<IHttpContent>,
    {
        let this = &windows_core::Interface::cast::<IHttpMultipartFormDataContent>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).AddWithName)(
                windows_core::Interface::as_raw(this),
                content.param().abi(),
                core::mem::transmute_copy(name),
            )
    ...
    pub fn AddWithNameAndFileName<P0>(
        &self,
        content: P0,
        name: &windows_core::HSTRING,
        ...
        P0: windows_core::Param<IHttpContent>,
    {
        let this = &windows_core::Interface::cast::<IHttpMultipartFormDataContent>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).AddWithNameAndFileName)(
                windows_core::Interface::as_raw(this),
                content.param().abi(),
                core::mem::transmute_copy(name),
    ...
    pub fn CreateWithBoundary(
        boundary: &windows_core::HSTRING,
    ) -> windows_core::Result<HttpMultipartFormDataContent> {
        Self::IHttpMultipartFormDataContentFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithBoundary)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(boundary),
                &mut result__,
            )
    ...
    fn IHttpMultipartFormDataContentFactory<
        R,
        F: FnOnce(&IHttpMultipartFormDataContentFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl HttpRequestMessage {
    ...
    pub fn TransportInformation(&self) -> windows_core::Result<HttpTransportInformation> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TransportInformation)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for HttpRequestResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHttpRequestResult>();
}
unsafe impl windows_core::Interface for HttpRequestResult {
    type Vtable = <IHttpRequestResult as windows_core::Interface>::Vtable;
...
impl windows_core::RuntimeType for HttpResponseMessageSource {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Web.Http.HttpResponseMessageSource;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for HttpStatusCode {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Web.Http.HttpStatusCode;i4)");
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl HttpStreamContent {
        ...
        P0: windows_core::Param<super::super::Storage::Streams::IInputStream>,
    {
        Self::IHttpStreamContentFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateFromInputStream)(
                windows_core::Interface::as_raw(this),
                content.param().abi(),
                &mut result__,
            )
    ...
    fn IHttpStreamContentFactory<
        R,
        F: FnOnce(&IHttpStreamContentFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl HttpStringContent {
    ...
    ) -> windows_core::Result<HttpStringContent> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromStringWithEncoding(
        content: &windows_core::HSTRING,
        encoding: super::super::Storage::Streams::UnicodeEncoding,
    ) -> windows_core::Result<HttpStringContent> {
        Self::IHttpStringContentFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateFromStringWithEncoding)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(content),
                encoding,
                &mut result__,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromStringWithEncodingAndMediaType(
        content: &windows_core::HSTRING,
        encoding: super::super::Storage::Streams::UnicodeEncoding,
        ...
        Self::IHttpStringContentFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateFromStringWithEncodingAndMediaType)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(content),
                encoding,
    ...
    fn IHttpStringContentFactory<
        R,
        F: FnOnce(&IHttpStringContentFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl HttpTransportInformation {
    ...
    pub fn ServerCertificateErrorSeverity(
        &self,
    ) -> windows_core::Result<super::super::Networking::Sockets::SocketSslErrorSeverity> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for HttpTransportInformation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHttpTransportInformation>();
}
unsafe impl windows_core::Interface for HttpTransportInformation {
    type Vtable = <IHttpTransportInformation as windows_core::Interface>::Vtable;
...
impl windows_core::RuntimeType for HttpVersion {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Web.Http.HttpVersion;i4)");
}
windows_core::imp::define_interface!(
    IHttpBufferContentFactory,
    IHttpBufferContentFactory_Vtbl,
    0xbc20c193_c41f_4ff7_9123_6435736eadc2
);
...
pub struct IHttpBufferContentFactory_Vtbl {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub CreateFromBufferWithOffset: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        u32,
...
pub struct IHttpClient2_Vtbl {
    ...
    pub TryGetAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TryGetAsync2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        HttpCompletionOption,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TryGetBufferAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TryGetInputStreamAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TryGetStringAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TryPostAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TryPutAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TrySendRequestAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TrySendRequestAsync2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        HttpCompletionOption,
        *mut *mut core::ffi::c_void,
...
pub trait IHttpContent_Impl: super::super::Foundation::IClosable_Impl {
    ...
    fn WriteToStreamAsync(
        &self,
        outputStream: windows_core::Ref<'_, super::super::Storage::Streams::IOutputStream>,
    ) -> windows_core::Result<windows_future::IAsyncOperationWithProgress<u64, u64>>;
}
#[cfg(all(feature = "Storage_Streams", feature = "Web_Http_Headers"))]
impl IHttpContent_Vtbl {
    pub const fn new<Identity: IHttpContent_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Headers<Identity: IHttpContent_Impl, const OFFSET: isize>(
...
windows_core::imp::define_interface!(
    IHttpCookie,
    IHttpCookie_Vtbl,
    0x1f5488e2_cc2d_4779_86a7_88f10687d249
);
...
windows_core::imp::define_interface!(
    IHttpCookieFactory,
    IHttpCookieFactory_Vtbl,
    0x6a0585a9_931c_4cd1_a96d_c21701785c5f
);
...
windows_core::imp::define_interface!(
    IHttpCookieManager,
    IHttpCookieManager_Vtbl,
    0x7a431780_cd4f_4e57_a84a_5b0a53d6bb96
);
...
pub struct IHttpCookieManager_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetCookie: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut bool,
    ) -> windows_core::HRESULT,
    pub SetCookieWithThirdParty: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        bool,
        *mut bool,
...
windows_core::imp::define_interface!(
    IHttpFormUrlEncodedContentFactory,
    IHttpFormUrlEncodedContentFactory_Vtbl,
    0x43f0138c_2f73_4302_b5f3_eae9238a5e01
);
...
windows_core::imp::define_interface!(
    ...
    IHttpGetBufferResult_Vtbl,
    0x53d08e7c_e209_404e_9a49_742d8236fd3a
);
...
pub struct IHttpGetBufferResult_Vtbl {
    ...
    pub ResponseMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Succeeded:
...
windows_core::imp::define_interface!(
    ...
    IHttpGetInputStreamResult_Vtbl,
    0xd5d63463_13aa_4ee0_be95_a0c39fe91203
);
...
windows_core::imp::define_interface!(
    ...
    IHttpMultipartContent_Vtbl,
    0xdf916aff_9926_4ac9_aaf1_e0d04ef09bb9
);
...
windows_core::imp::define_interface!(
    IHttpMultipartContentFactory,
    IHttpMultipartContentFactory_Vtbl,
    0x7eb42e62_0222_4f20_b372_47d5db5d33b4
);
...
pub struct IHttpMultipartContentFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateWithSubtype: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateWithSubtypeAndBoundary: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IHttpMultipartFormDataContent_Vtbl,
    0x64d337e2_e967_4624_b6d1_cf74604a4a42
);
...
pub struct IHttpMultipartFormDataContent_Vtbl {
    ...
    pub AddWithName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AddWithNameAndFileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IHttpMultipartFormDataContentFactory,
    IHttpMultipartFormDataContentFactory_Vtbl,
...
pub struct IHttpMultipartFormDataContentFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateWithBoundary: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct IHttpRequestMessage_Vtbl {
    ...
    pub TransportInformation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
windows_core::imp::define_interface!(
    ...
    0x6acf4da8_b5eb_4a35_a902_4217fbe820c5
);
...
pub struct IHttpResponseMessage_Vtbl {
    ...
    pub SetStatusCode:
        unsafe extern "system" fn(*mut core::ffi::c_void, HttpStatusCode) -> windows_core::HRESULT,
    pub Version: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut HttpVersion,
    ) -> windows_core::HRESULT,
    pub SetVersion:
        unsafe extern "system" fn(*mut core::ffi::c_void, HttpVersion) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IHttpStreamContentFactory,
    IHttpStreamContentFactory_Vtbl,
    0xf3e64d9d_f725_407e_942f_0eda189809f4
);
...
pub struct IHttpStreamContentFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Storage_Streams")]
    pub CreateFromInputStream: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x46649d5b_2e93_48eb_8e61_19677878e57f
);
...
pub struct IHttpStringContentFactory_Vtbl {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub CreateFromStringWithEncoding: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::Storage::Streams::UnicodeEncoding,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
    CreateFromStringWithEncoding: usize,
    #[cfg(feature = "Storage_Streams")]
    pub CreateFromStringWithEncodingAndMediaType:
...
windows_core::imp::define_interface!(
    ...
    IHttpTransportInformation_Vtbl,
    0x70127198_c6a7_4ed0_833a_83fd8b8f178d
);
...
pub struct IHttpTransportInformation_Vtbl {
    ...
    pub ServerCertificateErrorSeverity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Networking::Sockets::SocketSslErrorSeverity,
    ) -> windows_core::HRESULT,

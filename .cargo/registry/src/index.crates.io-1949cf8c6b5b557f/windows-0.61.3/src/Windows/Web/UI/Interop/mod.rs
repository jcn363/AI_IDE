windows_core::imp::define_interface!(
    ...
    IWebViewControlAcceleratorKeyPressedEventArgs_Vtbl,
    0x77a2a53e_7c74_437d_a290_3ac0d8cd5655
);
...
pub struct IWebViewControlAcceleratorKeyPressedEventArgs_Vtbl {
    ...
    pub EventType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::UI::Core::CoreAcceleratorKeyEventType,
    ...
    pub VirtualKey: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::System::VirtualKey,
    ) -> windows_core::HRESULT,
    ...
    pub KeyStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::UI::Core::CorePhysicalKeyStatus,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "UI_Core"))]
    KeyStatus: usize,
    pub RoutingStage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WebViewControlAcceleratorKeyRoutingStage,
    ) -> windows_core::HRESULT,
    pub Handled:
...
windows_core::imp::define_interface!(
    ...
    IWebViewControlMoveFocusRequestedEventArgs_Vtbl,
    0x6b2a340d_4bd0_405e_b7c1_1e72a492f446
);
...
pub struct IWebViewControlMoveFocusRequestedEventArgs_Vtbl {
    ...
    pub Reason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WebViewControlMoveFocusReason,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWebViewControlProcess,
    IWebViewControlProcess_Vtbl,
    0x02c723ec_98d6_424a_b63e_c6136c36a0f2
);
...
pub struct IWebViewControlProcess_Vtbl {
    ...
    pub IsPrivateNetworkClientServerCapabilityEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub CreateWebViewControlAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i64,
        super::super::super::Foundation::Rect,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetWebViewControls: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Terminate: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ProcessExited: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IWebViewControlProcessFactory_Vtbl,
    0x47b65cf9_a2d2_453c_b097_f6779d4b8e02
);
...
windows_core::imp::define_interface!(
    ...
    0x1cca72a7_3bd6_4826_8261_6c8189505d89
);
...
pub struct IWebViewControlProcessOptions_Vtbl {
    ...
    pub SetPrivateNetworkClientServerCapability: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WebViewControlProcessCapabilityState,
    )
        -> windows_core::HRESULT,
    pub PrivateNetworkClientServerCapability: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WebViewControlProcessCapabilityState,
    )
        -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWebViewControlSite,
    IWebViewControlSite_Vtbl,
    0x133f47c6_12dc_4898_bd47_04967de648ba
);
...
windows_core::imp::define_interface!(
    ...
    IWebViewControlSite2_Vtbl,
    0xd13b2e3f_48ee_4730_8243_d2ed0c05606a
);
...
impl WebViewControl {
    ...
    pub fn SetDefaultBackgroundColor(
        &self,
        value: super::super::super::UI::Color,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
    ...
    pub fn DeferredPermissionRequests(
        ...
        windows_collections::IVectorView<super::WebViewControlDeferredPermissionRequest>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDeferredPermissionRequestById(
        &self,
        id: u32,
        result: &mut Option<super::WebViewControlDeferredPermissionRequest>,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
...
impl windows_core::RuntimeType for WebViewControl {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, super::IWebViewControl>();
}
...
impl WebViewControlAcceleratorKeyPressedEventArgs {
    ...
    pub fn EventType(
        &self,
    ) -> windows_core::Result<super::super::super::UI::Core::CoreAcceleratorKeyEventType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn KeyStatus(
        &self,
    ) -> windows_core::Result<super::super::super::UI::Core::CorePhysicalKeyStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RoutingStage(&self) -> windows_core::Result<WebViewControlAcceleratorKeyRoutingStage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RoutingStage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
unsafe impl windows_core::Interface for WebViewControlAcceleratorKeyPressedEventArgs {
    type Vtable =
        <IWebViewControlAcceleratorKeyPressedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IWebViewControlAcceleratorKeyPressedEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for WebViewControlMoveFocusRequestedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IWebViewControlMoveFocusRequestedEventArgs as windows_core::Interface>::IID;
}
...
impl WebViewControlProcess {
    ...
    pub fn IsPrivateNetworkClientServerCapabilityEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsPrivateNetworkClientServerCapabilityEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<WebViewControl>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWebViewControlAsync)(
                windows_core::Interface::as_raw(this),
                hostwindowhandle,
                bounds,
                &mut result__,
    ...
    pub fn GetWebViewControls(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<WebViewControl>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetWebViewControls)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ProcessExited)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    fn IWebViewControlProcessFactory<
        R,
        F: FnOnce(&IWebViewControlProcessFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for WebViewControlProcess {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebViewControlProcess>();
}
...
impl WebViewControlProcessOptions {
    ...
    pub fn SetPrivateNetworkClientServerCapability(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPrivateNetworkClientServerCapability)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn PrivateNetworkClientServerCapability(
        &self,
    ) -> windows_core::Result<WebViewControlProcessCapabilityState> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PrivateNetworkClientServerCapability)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for WebViewControlProcessOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebViewControlProcessOptions>();
}

...
windows_core::imp::define_interface!(
    ...
    0x3f921316_bc70_4bda_9136_c94370899fab
);
...
impl IWebViewControl {
    ...
    pub fn DeferredPermissionRequests(
        ...
        windows_collections::IVectorView<WebViewControlDeferredPermissionRequest>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWebViewControl_Impl: windows_core::IUnknownImpl {
    ...
    fn SetSource(
        &self,
        source: windows_core::Ref<'_, super::super::Foundation::Uri>,
    ) -> windows_core::Result<()>;
    ...
    fn NavigateToLocalStreamUri(
        &self,
        source: windows_core::Ref<'_, super::super::Foundation::Uri>,
        streamResolver: windows_core::Ref<'_, super::IUriToStreamResolver>,
    ) -> windows_core::Result<()>;
    fn NavigateWithHttpRequestMessage(
        &self,
        requestMessage: windows_core::Ref<'_, super::Http::HttpRequestMessage>,
    ) -> windows_core::Result<()>;
    fn InvokeScriptAsync(
        &self,
        scriptName: &windows_core::HSTRING,
        arguments: windows_core::Ref<'_, windows_collections::IIterable<windows_core::HSTRING>>,
    ) -> windows_core::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>;
    fn CapturePreviewToStreamAsync(
        &self,
        stream: windows_core::Ref<'_, super::super::Storage::Streams::IRandomAccessStream>,
    ) -> windows_core::Result<windows_future::IAsyncAction>;
    ...
    fn GetDeferredPermissionRequestById(
        &self,
        id: u32,
        result: windows_core::OutRef<'_, WebViewControlDeferredPermissionRequest>,
    ) -> windows_core::Result<()>;
...
impl IWebViewControl_Vtbl {
    pub const fn new<Identity: IWebViewControl_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Source<Identity: IWebViewControl_Impl, const OFFSET: isize>(
        ...
        unsafe extern "system" fn SetSource<Identity: IWebViewControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CanGoBack<Identity: IWebViewControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut bool,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWebViewControl_Impl::SetDefaultBackgroundColor(this, core::mem::transmute(&value))
                    .into()
            }
        }
        ...
        unsafe extern "system" fn Settings<Identity: IWebViewControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn DeferredPermissionRequests<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GoForward<Identity: IWebViewControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GoBack<Identity: IWebViewControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Refresh<Identity: IWebViewControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Stop<Identity: IWebViewControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Navigate<Identity: IWebViewControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            source: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn NavigateToLocalStreamUri<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            source: *mut core::ffi::c_void,
            streamresolver: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWebViewControl_Impl::NavigateToLocalStreamUri(
                    this,
                    core::mem::transmute_copy(&source),
                    core::mem::transmute_copy(&streamresolver),
                )
                .into()
            }
        }
        unsafe extern "system" fn NavigateWithHttpRequestMessage<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            requestmessage: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWebViewControl_Impl::NavigateWithHttpRequestMessage(
                    this,
                    core::mem::transmute_copy(&requestmessage),
                )
                .into()
            }
        }
        unsafe extern "system" fn InvokeScriptAsync<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            scriptname: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::InvokeScriptAsync(
                    this,
                    core::mem::transmute(&scriptname),
        ...
        unsafe extern "system" fn CapturePreviewToStreamAsync<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::CapturePreviewToStreamAsync(
                    this,
        ...
        unsafe extern "system" fn CaptureSelectedContentToDataPackageAsync<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            this: *mut core::ffi::c_void,
            contentidentifier: *mut core::ffi::c_void,
            relativepath: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::BuildLocalStreamUri(
                    this,
                    core::mem::transmute(&contentidentifier),
                    core::mem::transmute(&relativepath),
                ) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
        ...
        unsafe extern "system" fn GetDeferredPermissionRequestById<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWebViewControl_Impl::GetDeferredPermissionRequestById(
                    this,
                    id,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::NavigationStarting(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::ContentLoading(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::DOMContentLoaded(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::NavigationCompleted(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::FrameNavigationStarting(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn FrameContentLoading<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::FrameContentLoading(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn RemoveFrameContentLoading<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn FrameDOMContentLoaded<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::FrameDOMContentLoaded(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn RemoveFrameDOMContentLoaded<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::FrameNavigationCompleted(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn ScriptNotify<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn RemoveScriptNotify<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn LongRunningScriptDetected<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::LongRunningScriptDetected(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn RemoveLongRunningScriptDetected<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn UnsafeContentWarningDisplaying<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::UnsafeContentWarningDisplaying(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn RemoveUnsafeContentWarningDisplaying<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn UnviewableContentIdentified<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::UnviewableContentIdentified(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn RemoveUnviewableContentIdentified<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::PermissionRequested(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn UnsupportedUriSchemeIdentified<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::UnsupportedUriSchemeIdentified(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn RemoveUnsupportedUriSchemeIdentified<
            Identity: IWebViewControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::NewWindowRequested(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::ContainsFullScreenElementChanged(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWebViewControl_Impl::WebResourceRequested(
                    this,
                    core::mem::transmute_copy(&handler),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            ...
            CaptureSelectedContentToDataPackageAsync: CaptureSelectedContentToDataPackageAsync::<
                Identity,
                OFFSET,
            >,
            ...
            RemoveUnsafeContentWarningDisplaying: RemoveUnsafeContentWarningDisplaying::<
                Identity,
                OFFSET,
            >,
            ...
            RemoveUnsupportedUriSchemeIdentified: RemoveUnsupportedUriSchemeIdentified::<
                Identity,
                OFFSET,
            >,
...
pub struct IWebViewControl_Vtbl {
    ...
    pub NavigateToLocalStreamUri: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Web_Http")]
    pub NavigateWithHttpRequestMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub CapturePreviewToStreamAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "ApplicationModel_DataTransfer")]
    pub CaptureSelectedContentToDataPackageAsync:
    ...
    pub GetDeferredPermissionRequestById: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub RemoveFrameDOMContentLoaded:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    ...
    pub RemoveLongRunningScriptDetected:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    ...
    pub RemoveUnsafeContentWarningDisplaying:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    ...
    pub RemoveUnviewableContentIdentified:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    ...
    pub RemoveUnsupportedUriSchemeIdentified:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x4d3c06f9_c8df_41cc_8bd5_2a947b204503
);
...
impl IWebViewControl2_Vtbl {
    pub const fn new<Identity: IWebViewControl2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddInitializeScript<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWebViewControl2_Impl::AddInitializeScript(this, core::mem::transmute(&script))
                    .into()
            }
        }
        Self {
...
pub struct IWebViewControl2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AddInitializeScript: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IWebViewControlContentLoadingEventArgs_Vtbl,
    0x9a3fccb2_b9bb_404b_a22b_66dccd1250c6
);
...
windows_core::imp::define_interface!(
    ...
    IWebViewControlDOMContentLoadedEventArgs_Vtbl,
    0xbe8bc008_9541_4545_9ff2_2df585b29f7d
);
...
windows_core::imp::define_interface!(
    ...
    IWebViewControlDeferredPermissionRequest_Vtbl,
    0x2ce349e0_d759_445c_9926_8995298f152b
);
...
pub struct IWebViewControlDeferredPermissionRequest_Vtbl {
    ...
    pub PermissionType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WebViewControlPermissionType,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IWebViewControlLongRunningScriptDetectedEventArgs_Vtbl,
    0x2a6e5bba_98b4_45bc_bbeb_0f69ce49c599
);
...
pub struct IWebViewControlLongRunningScriptDetectedEventArgs_Vtbl {
    ...
    pub StopPageScriptExecution:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetStopPageScriptExecution:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWebViewControlNavigationCompletedEventArgs,
    IWebViewControlNavigationCompletedEventArgs_Vtbl,
    0x20409918_4a15_4c46_a55d_f79edb0bde8b
);
...
pub struct IWebViewControlNavigationCompletedEventArgs_Vtbl {
    ...
    pub WebErrorStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::WebErrorStatus,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWebViewControlNavigationStartingEventArgs,
    IWebViewControlNavigationStartingEventArgs_Vtbl,
    0x0c9057c5_0a08_41c7_863b_71e3a9549137
);
...
windows_core::imp::define_interface!(
    ...
    IWebViewControlNewWindowRequestedEventArgs_Vtbl,
    0x3df44bbb_a124_46d5_a083_d02cacdff5ad
);
...
windows_core::imp::define_interface!(
    ...
    IWebViewControlNewWindowRequestedEventArgs2_Vtbl,
    0xb53c5ca6_2aae_4bfc_92b9_c30e92b48098
);
...
windows_core::imp::define_interface!(
    ...
    IWebViewControlPermissionRequest_Vtbl,
    0xe5bc836c_f22f_40e2_95b2_7729f840eb7f
);
...
pub struct IWebViewControlPermissionRequest_Vtbl {
    ...
    pub State: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WebViewControlPermissionState,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IWebViewControlPermissionRequestedEventArgs_Vtbl,
    0x27204d51_2488_4cc5_968e_0a771e59c147
);
...
windows_core::imp::define_interface!(
    ...
    0x491de57b_6f49_41bb_b591_51b85b817037
);
...
windows_core::imp::define_interface!(
    ...
    IWebViewControlSettings_Vtbl,
    0xc9967fbf_5e98_4cfd_8cce_27b0911e3de8
);
...
pub struct IWebViewControlSettings_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetIsJavaScriptEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub IsJavaScriptEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetIsIndexedDBEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub IsIndexedDBEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetIsScriptNotifyAllowed:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub IsScriptNotifyAllowed:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWebViewControlUnsupportedUriSchemeIdentifiedEventArgs,
    IWebViewControlUnsupportedUriSchemeIdentifiedEventArgs_Vtbl,
...
windows_core::imp::define_interface!(
    ...
    IWebViewControlUnviewableContentIdentifiedEventArgs_Vtbl,
    0x4a9680db_88f2_4e20_b693_b4e2df4aa581
);
...
windows_core::imp::define_interface!(
    ...
    0x44d6524d_55a4_4d8b_891c_931d8e25d42e
);
...
impl windows_core::RuntimeType for WebViewControlContentLoadingEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebViewControlContentLoadingEventArgs>();
}
unsafe impl windows_core::Interface for WebViewControlContentLoadingEventArgs {
    ...
    const IID: windows_core::GUID =
        <IWebViewControlContentLoadingEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for WebViewControlDOMContentLoadedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IWebViewControlDOMContentLoadedEventArgs as windows_core::Interface>::IID;
}
...
impl WebViewControlDeferredPermissionRequest {
    ...
    pub fn PermissionType(&self) -> windows_core::Result<WebViewControlPermissionType> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PermissionType)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn Allow(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).Allow)(windows_core::Interface::as_raw(this))
                .ok()
        }
    }
    pub fn Deny(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).Deny)(windows_core::Interface::as_raw(this)).ok()
        }
    }
}
...
unsafe impl windows_core::Interface for WebViewControlDeferredPermissionRequest {
    ...
    const IID: windows_core::GUID =
        <IWebViewControlDeferredPermissionRequest as windows_core::Interface>::IID;
}
...
impl WebViewControlLongRunningScriptDetectedEventArgs {
    pub fn ExecutionTime(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ExecutionTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn StopPageScriptExecution(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StopPageScriptExecution)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetStopPageScriptExecution(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetStopPageScriptExecution)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
unsafe impl windows_core::Interface for WebViewControlLongRunningScriptDetectedEventArgs {
    type Vtable =
        <IWebViewControlLongRunningScriptDetectedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IWebViewControlLongRunningScriptDetectedEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for WebViewControlNavigationCompletedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IWebViewControlNavigationCompletedEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for WebViewControlNavigationStartingEventArgs {
    ...
    const IID: windows_core::GUID =
        <IWebViewControlNavigationStartingEventArgs as windows_core::Interface>::IID;
}
...
impl WebViewControlNewWindowRequestedEventArgs {
    ...
    pub fn Referrer(&self) -> windows_core::Result<super::super::Foundation::Uri> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Referrer)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn NewWindow(&self) -> windows_core::Result<IWebViewControl> {
        let this =
            &windows_core::Interface::cast::<IWebViewControlNewWindowRequestedEventArgs2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
unsafe impl windows_core::Interface for WebViewControlNewWindowRequestedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IWebViewControlNewWindowRequestedEventArgs as windows_core::Interface>::IID;
}
...
impl WebViewControlPermissionRequest {
    ...
    pub fn Defer(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).Defer)(windows_core::Interface::as_raw(this))
                .ok()
        }
    }
    pub fn Allow(&self) -> windows_core::Result<()> {
...
impl windows_core::RuntimeType for WebViewControlPermissionRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebViewControlPermissionRequest>();
}
unsafe impl windows_core::Interface for WebViewControlPermissionRequest {
    ...
    const IID: windows_core::GUID =
        <IWebViewControlPermissionRequest as windows_core::Interface>::IID;
}
...
impl WebViewControlPermissionRequestedEventArgs {
    pub fn PermissionRequest(&self) -> windows_core::Result<WebViewControlPermissionRequest> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PermissionRequest)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
unsafe impl windows_core::Interface for WebViewControlPermissionRequestedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IWebViewControlPermissionRequestedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for WebViewControlPermissionState {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Web.UI.WebViewControlPermissionState;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for WebViewControlPermissionType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Web.UI.WebViewControlPermissionType;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for WebViewControlScriptNotifyEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebViewControlScriptNotifyEventArgs>();
}
unsafe impl windows_core::Interface for WebViewControlScriptNotifyEventArgs {
    ...
    const IID: windows_core::GUID =
        <IWebViewControlScriptNotifyEventArgs as windows_core::Interface>::IID;
}
...
impl WebViewControlSettings {
    pub fn SetIsJavaScriptEnabled(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsJavaScriptEnabled)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn IsJavaScriptEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsJavaScriptEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIsIndexedDBEnabled(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsIndexedDBEnabled)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn IsIndexedDBEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsIndexedDBEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIsScriptNotifyAllowed(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsScriptNotifyAllowed)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn IsScriptNotifyAllowed(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsScriptNotifyAllowed)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for WebViewControlSettings {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebViewControlSettings>();
}
...
unsafe impl windows_core::Interface for WebViewControlUnsupportedUriSchemeIdentifiedEventArgs {
    type Vtable =
        <IWebViewControlUnsupportedUriSchemeIdentifiedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IWebViewControlUnsupportedUriSchemeIdentifiedEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for WebViewControlUnviewableContentIdentifiedEventArgs {
    type Vtable =
        <IWebViewControlUnviewableContentIdentifiedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IWebViewControlUnviewableContentIdentifiedEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for WebViewControlWebResourceRequestedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IWebViewControlWebResourceRequestedEventArgs as windows_core::Interface>::IID;
}

...
windows_core::imp::define_interface!(
    ...
    0xb0aba86a_9aeb_4d3a_9590_003e3ca7e290
);
...
impl IUriToStreamResolver {
    ...
    pub fn UriToStreamAsync<P0>(
        &self,
        uri: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::Storage::Streams::IInputStream>>
    where
        P0: windows_core::Param<super::Foundation::Uri>,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).UriToStreamAsync)(
    ...
    pub const fn new<Identity: IUriToStreamResolver_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                match IUriToStreamResolver_Impl::UriToStreamAsync(
                    this,
        ...
        Self {
            ...
            UriToStreamAsync: UriToStreamAsync::<Identity, OFFSET>,
        }
    }
...
pub struct IUriToStreamResolver_Vtbl {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub UriToStreamAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xfe616766_bf27_4064_87b7_6563bb11ce2e
);
...
impl WebError {
    ...
    fn IWebErrorStatics<R, F: FnOnce(&IWebErrorStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<WebError, IWebErrorStatics> =
...
impl windows_core::RuntimeType for WebErrorStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Web.WebErrorStatus;i4)");
}

windows_core::imp::define_interface!(
    IMediaTranscoder,
    IMediaTranscoder_Vtbl,
    0x190c99d2_a0aa_4d34_86bc_eed1b12c2f5b
);
...
pub struct IMediaTranscoder_Vtbl {
    ...
    pub SetTrimStartTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub TrimStartTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub SetTrimStopTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub TrimStopTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub SetAlwaysReencode:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub AlwaysReencode:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetHardwareAccelerationEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub HardwareAccelerationEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    ...
    pub AddAudioEffectWithSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        bool,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub AddVideoEffectWithSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        bool,
        *mut core::ffi::c_void,
    ...
    pub PrepareFileTranscodeAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    #[cfg(all(feature = "Media_MediaProperties", feature = "Storage_Streams"))]
    pub PrepareStreamTranscodeAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IMediaTranscoder2,
    IMediaTranscoder2_Vtbl,
    0x40531d74_35e0_4f04_8574_ca8bc4e5a082
);
...
pub struct IMediaTranscoder2_Vtbl {
    ...
    pub SetVideoProcessingAlgorithm: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        MediaVideoProcessingAlgorithm,
    ) -> windows_core::HRESULT,
    pub VideoProcessingAlgorithm: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut MediaVideoProcessingAlgorithm,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
...
pub struct IPrepareTranscodeResult_Vtbl {
    ...
    pub CanTranscode:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub FailureReason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut TranscodeFailureReason,
    ) -> windows_core::HRESULT,
    pub TranscodeAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl MediaTranscoder {
    ...
    pub fn SetTrimStartTime(
        &self,
        value: super::super::Foundation::TimeSpan,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetTrimStartTime)(
    ...
    pub fn TrimStartTime(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).TrimStartTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetTrimStopTime(
        &self,
        value: super::super::Foundation::TimeSpan,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetTrimStopTime)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn TrimStopTime(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TrimStopTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAlwaysReencode(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAlwaysReencode)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn AlwaysReencode(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AlwaysReencode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetHardwareAccelerationEnabled(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetHardwareAccelerationEnabled)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn HardwareAccelerationEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HardwareAccelerationEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AddAudioEffectWithSettings<P2>(
        &self,
        activatableclassid: &windows_core::HSTRING,
        effectrequired: bool,
        configuration: P2,
        ...
        P2: windows_core::Param<super::super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AddAudioEffectWithSettings)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
                effectrequired,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AddVideoEffectWithSettings<P2>(
        &self,
        activatableclassid: &windows_core::HSTRING,
        effectrequired: bool,
        configuration: P2,
        ...
        P2: windows_core::Param<super::super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AddVideoEffectWithSettings)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
                effectrequired,
                configuration.param().abi(),
    ...
    pub fn ClearEffects(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ClearEffects)(windows_core::Interface::as_raw(
                this,
            ))
            .ok()
        }
    ...
    #[cfg(all(feature = "Media_MediaProperties", feature = "Storage_Streams"))]
    pub fn PrepareFileTranscodeAsync<P0, P1, P2>(
        &self,
        source: P0,
        destination: P1,
        profile: P2,
        ...
        P2: windows_core::Param<super::MediaProperties::MediaEncodingProfile>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PrepareFileTranscodeAsync)(
                windows_core::Interface::as_raw(this),
                source.param().abi(),
    ...
    #[cfg(all(feature = "Media_MediaProperties", feature = "Storage_Streams"))]
    pub fn PrepareStreamTranscodeAsync<P0, P1, P2>(
        &self,
        source: P0,
        destination: P1,
        profile: P2,
        ...
        P2: windows_core::Param<super::MediaProperties::MediaEncodingProfile>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PrepareStreamTranscodeAsync)(
                windows_core::Interface::as_raw(this),
                source.param().abi(),
                destination.param().abi(),
                profile.param().abi(),
    ...
    pub fn SetVideoProcessingAlgorithm(
        &self,
        value: MediaVideoProcessingAlgorithm,
    ) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaTranscoder2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetVideoProcessingAlgorithm)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn VideoProcessingAlgorithm(&self) -> windows_core::Result<MediaVideoProcessingAlgorithm> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).VideoProcessingAlgorithm)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for MediaVideoProcessingAlgorithm {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Transcoding.MediaVideoProcessingAlgorithm;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl PrepareTranscodeResult {
    pub fn CanTranscode(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CanTranscode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn FailureReason(&self) -> windows_core::Result<TranscodeFailureReason> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FailureReason)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn TranscodeAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncActionWithProgress<f64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TranscodeAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for TranscodeFailureReason {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Transcoding.TranscodeFailureReason;i4)",
    );
}

...
impl windows_core::RuntimeType for ComponentLoadFailedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IComponentLoadFailedEventArgs>();
}
...
windows_core::imp::define_interface!(
    ...
    ComponentLoadFailedEventHandler_Vtbl,
    0x95da643c_6db9_424b_86ca_091af432081c
);
...
impl ComponentLoadFailedEventHandler {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, MediaProtectionManager>,
                windows_core::Ref<'_, ComponentLoadFailedEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        ...
        let com = ComponentLoadFailedEventHandlerBox {
            vtable: &ComponentLoadFailedEventHandlerBox::<F>::VTABLE,
...
#[repr(C)]
struct ComponentLoadFailedEventHandlerBox<
    F: FnMut(
            windows_core::Ref<'_, MediaProtectionManager>,
            windows_core::Ref<'_, ComponentLoadFailedEventArgs>,
        ) -> windows_core::Result<()>
...
impl<
        F: FnMut(
            ...
            + Send
            + 'static,
    > ComponentLoadFailedEventHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid
                == <ComponentLoadFailedEventHandler as windows_core::Interface>::IID
...
impl ComponentRenewal {
    pub fn RenewSystemComponentsAsync<P0>(
        information: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperationWithProgress<RenewalStatus, u32>>
    where
        P0: windows_core::Param<RevocationAndRenewalInformation>,
    {
        Self::IComponentRenewalStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RenewSystemComponentsAsync)(
                windows_core::Interface::as_raw(this),
                information.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    ...
    fn IComponentRenewalStatics<
        R,
        F: FnOnce(&IComponentRenewalStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ComponentRenewal, IComponentRenewalStatics> =
...
impl windows_core::RuntimeType for GraphicsTrustStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Protection.GraphicsTrustStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for HdcpProtection {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Protection.HdcpProtection;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl HdcpSession {
    ...
    pub fn IsEffectiveProtectionAtLeast(
        &self,
        protection: HdcpProtection,
    ) -> windows_core::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsEffectiveProtectionAtLeast)(
                windows_core::Interface::as_raw(this),
                protection,
                &mut result__,
            )
    ...
    pub fn GetEffectiveProtection(
        &self,
    ) -> windows_core::Result<super::super::Foundation::IReference<HdcpProtection>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetEffectiveProtection)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SetDesiredMinProtectionAsync(
        &self,
        protection: HdcpProtection,
    ) -> windows_core::Result<windows_future::IAsyncOperation<HdcpSetProtectionResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetDesiredMinProtectionAsync)(
                windows_core::Interface::as_raw(this),
                protection,
                &mut result__,
            )
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<HdcpSession, windows_core::IInspectable>,
        >,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ProtectionChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveProtectionChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveProtectionChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for HdcpSession {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHdcpSession>();
}
...
impl windows_core::RuntimeType for HdcpSetProtectionResult {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Protection.HdcpSetProtectionResult;i4)",
    );
}
windows_core::imp::define_interface!(
    IComponentLoadFailedEventArgs,
    IComponentLoadFailedEventArgs_Vtbl,
    0x95972e93_7746_417e_8495_f031bbc5862c
);
...
windows_core::imp::define_interface!(
    ...
    IComponentRenewalStatics_Vtbl,
    0x6ffbcd67_b795_48c5_8b7b_a7c4efe202e3
);
...
pub struct IComponentRenewalStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RenewSystemComponentsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IHdcpSession,
    IHdcpSession_Vtbl,
    0x718845e9_64d7_426d_809b_1be461941a2a
);
...
pub struct IHdcpSession_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsEffectiveProtectionAtLeast: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        HdcpProtection,
        *mut bool,
    ) -> windows_core::HRESULT,
    pub GetEffectiveProtection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetDesiredMinProtectionAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        HdcpProtection,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ProtectionChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveProtectionChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IMediaProtectionManager,
    IMediaProtectionManager_Vtbl,
    0x45694947_c741_434b_a79e_474c12d93d2f
);
...
pub struct IMediaProtectionManager_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ServiceRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveServiceRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub RebootNeeded: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRebootNeeded:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub ComponentLoadFailed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveComponentLoadFailed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IMediaProtectionPMPServer_Vtbl,
    0x0c111226_7b26_4d31_95bb_9c1b08ef7fc0
);
...
windows_core::imp::define_interface!(
    ...
    IMediaProtectionPMPServerFactory_Vtbl,
    0x602c8e5e_f7d2_487e_af91_dbc4252b2182
);
...
pub struct IMediaProtectionPMPServerFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Foundation_Collections")]
    pub CreatePMPServer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IMediaProtectionServiceCompletion_Vtbl,
    0x8b5cca18_cfd5_44ee_a2ed_df76010c14b5
);
...
windows_core::imp::define_interface!(
    ...
    0xb1de0ea6_2094_478d_87a4_8b95200f85c6
);
...
impl IMediaProtectionServiceRequest_Vtbl {
    pub const fn new<Identity: IMediaProtectionServiceRequest_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ProtectionSystem<
...
pub struct IMediaProtectionServiceRequest_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ProtectionSystem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IProtectionCapabilities_Vtbl,
    0xc7ac5d7e_7480_4d29_a464_7bcd913dd8e4
);
...
pub struct IProtectionCapabilities_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsTypeSupported: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut ProtectionCapabilityResult,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRevocationAndRenewalInformation,
    IRevocationAndRenewalInformation_Vtbl,
    0xf3a1937b_2501_439e_a6e7_6fc95e175fcf
);
...
windows_core::imp::define_interface!(
    ...
    IRevocationAndRenewalItem_Vtbl,
    0x3099c20c_3cf0_49ea_902d_caf32d2dde2c
);
...
pub struct IRevocationAndRenewalItem_Vtbl {
    ...
    pub Reasons: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RevocationAndRenewalReasons,
    ) -> windows_core::HRESULT,
    pub HeaderHash: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PublicKeyHash: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub RenewalId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IServiceRequestedEventArgs_Vtbl,
    0x34283baf_abb4_4fc1_bd89_93f106573a49
);
...
windows_core::imp::define_interface!(
    ...
    IServiceRequestedEventArgs2_Vtbl,
...
pub struct IServiceRequestedEventArgs2_Vtbl {
    ...
    pub MediaPlaybackItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl MediaProtectionManager {
        ...
        P0: windows_core::Param<ServiceRequestedEventHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ServiceRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveServiceRequested(&self, cookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveServiceRequested)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<RebootNeededEventHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RebootNeeded)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveRebootNeeded(&self, cookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveRebootNeeded)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<ComponentLoadFailedEventHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ComponentLoadFailed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveComponentLoadFailed(&self, cookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveComponentLoadFailed)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
...
impl windows_core::RuntimeType for MediaProtectionManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMediaProtectionManager>();
}
...
impl MediaProtectionPMPServer {
        ...
        P0: windows_core::Param<super::super::Foundation::Collections::IPropertySet>,
    {
        Self::IMediaProtectionPMPServerFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreatePMPServer)(
                windows_core::Interface::as_raw(this),
    ...
    fn IMediaProtectionPMPServerFactory<
        R,
        F: FnOnce(&IMediaProtectionPMPServerFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for MediaProtectionPMPServer {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMediaProtectionPMPServer>();
}
...
impl windows_core::RuntimeType for MediaProtectionServiceCompletion {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMediaProtectionServiceCompletion>();
}
unsafe impl windows_core::Interface for MediaProtectionServiceCompletion {
    ...
    const IID: windows_core::GUID =
        <IMediaProtectionServiceCompletion as windows_core::Interface>::IID;
}
...
impl ProtectionCapabilities {
    ...
    pub fn IsTypeSupported(
        ...
        keysystem: &windows_core::HSTRING,
    ) -> windows_core::Result<ProtectionCapabilityResult> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsTypeSupported)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(r#type),
                core::mem::transmute_copy(keysystem),
                &mut result__,
            )
            .map(|| result__)
        }
...
impl windows_core::RuntimeType for ProtectionCapabilities {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IProtectionCapabilities>();
}
...
impl windows_core::RuntimeType for ProtectionCapabilityResult {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Protection.ProtectionCapabilityResult;i4)",
    );
}
windows_core::imp::define_interface!(
    RebootNeededEventHandler,
    RebootNeededEventHandler_Vtbl,
    0x64e12a45_973b_4a3a_b260_91898a49a82c
);
...
impl RebootNeededEventHandler {
    pub fn new<
        F: FnMut(windows_core::Ref<'_, MediaProtectionManager>) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        invoke: F,
    ) -> Self {
        let com = RebootNeededEventHandlerBox {
            vtable: &RebootNeededEventHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
#[repr(C)]
struct RebootNeededEventHandlerBox<
    F: FnMut(windows_core::Ref<'_, MediaProtectionManager>) -> windows_core::Result<()>
        + Send
        + 'static,
> {
    ...
    > RebootNeededEventHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <RebootNeededEventHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _
...
impl windows_core::RuntimeType for RenewalStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Protection.RenewalStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl RevocationAndRenewalInformation {
    pub fn Items(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<RevocationAndRenewalItem>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for RevocationAndRenewalInformation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRevocationAndRenewalInformation>();
}
unsafe impl windows_core::Interface for RevocationAndRenewalInformation {
    ...
    const IID: windows_core::GUID =
        <IRevocationAndRenewalInformation as windows_core::Interface>::IID;
}
...
impl RevocationAndRenewalItem {
    ...
    pub fn HeaderHash(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HeaderHash)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn PublicKeyHash(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PublicKeyHash)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn RenewalId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RenewalId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for RevocationAndRenewalItem {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRevocationAndRenewalItem>();
}
...
impl windows_core::RuntimeType for RevocationAndRenewalReasons {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Protection.RevocationAndRenewalReasons;u4)",
    );
}
impl RevocationAndRenewalReasons {
...
impl ServiceRequestedEventArgs {
    ...
    pub fn MediaPlaybackItem(&self) -> windows_core::Result<super::Playback::MediaPlaybackItem> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MediaPlaybackItem)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for ServiceRequestedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IServiceRequestedEventArgs>();
}
...
windows_core::imp::define_interface!(
    ...
    ServiceRequestedEventHandler_Vtbl,
    0xd2d690ba_cac9_48e1_95c0_d38495a84055
);
...
impl ServiceRequestedEventHandler {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, MediaProtectionManager>,
                windows_core::Ref<'_, ServiceRequestedEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        ...
        let com = ServiceRequestedEventHandlerBox {
            vtable: &ServiceRequestedEventHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
#[repr(C)]
struct ServiceRequestedEventHandlerBox<
    F: FnMut(
            windows_core::Ref<'_, MediaProtectionManager>,
            windows_core::Ref<'_, ServiceRequestedEventArgs>,
        ) -> windows_core::Result<()>
...
impl<
        F: FnMut(
            ...
            + Send
            + 'static,
    > ServiceRequestedEventHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <ServiceRequestedEventHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _

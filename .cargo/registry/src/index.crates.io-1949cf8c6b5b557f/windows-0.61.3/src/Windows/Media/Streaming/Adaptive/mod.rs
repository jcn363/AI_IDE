...
impl AdaptiveMediaSource {
    ...
    pub fn AvailableBitrates(&self) -> windows_core::Result<windows_collections::IVectorView<u32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DownloadBitrateChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PlaybackBitrateChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn AdvancedSettings(&self) -> windows_core::Result<AdaptiveMediaSourceAdvancedSettings> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AdvancedSettings)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetCorrelatedTimes(&self) -> windows_core::Result<AdaptiveMediaSourceCorrelatedTimes> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCorrelatedTimes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateFromUriAsync<P0>(
        uri: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<AdaptiveMediaSourceCreationResult>>
    where
        ...
        P1: windows_core::Param<super::super::super::Web::Http::HttpClient>,
    {
        Self::IAdaptiveMediaSourceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateFromUriWithDownloaderAsync)(
                windows_core::Interface::as_raw(this),
                uri.param().abi(),
        ...
        P3: windows_core::Param<super::super::super::Web::Http::HttpClient>,
    {
        Self::IAdaptiveMediaSourceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateFromStreamWithDownloaderAsync)(
                windows_core::Interface::as_raw(this),
                stream.param().abi(),
                uri.param().abi(),
                core::mem::transmute_copy(contenttype),
...
impl AdaptiveMediaSourceAdvancedSettings {
    pub fn AllSegmentsIndependent(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllSegmentsIndependent)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAllSegmentsIndependent(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAllSegmentsIndependent)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn DesiredBitrateHeadroomRatio(
        &self,
    ) -> windows_core::Result<super::super::super::Foundation::IReference<f64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DesiredBitrateHeadroomRatio)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::super::Foundation::IReference<f64>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDesiredBitrateHeadroomRatio)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn BitrateDowngradeTriggerRatio(
        &self,
    ) -> windows_core::Result<super::super::super::Foundation::IReference<f64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BitrateDowngradeTriggerRatio)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::super::Foundation::IReference<f64>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetBitrateDowngradeTriggerRatio)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
...
impl windows_core::RuntimeType for AdaptiveMediaSourceAdvancedSettings {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAdaptiveMediaSourceAdvancedSettings>();
}
unsafe impl windows_core::Interface for AdaptiveMediaSourceAdvancedSettings {
    ...
    const IID: windows_core::GUID =
        <IAdaptiveMediaSourceAdvancedSettings as windows_core::Interface>::IID;
}
...
impl AdaptiveMediaSourceCorrelatedTimes {
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ProgramDateTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for AdaptiveMediaSourceCorrelatedTimes {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAdaptiveMediaSourceCorrelatedTimes>();
}
unsafe impl windows_core::Interface for AdaptiveMediaSourceCorrelatedTimes {
    ...
    const IID: windows_core::GUID =
        <IAdaptiveMediaSourceCorrelatedTimes as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for AdaptiveMediaSourceCreationResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAdaptiveMediaSourceCreationResult>();
}
...
impl windows_core::RuntimeType for AdaptiveMediaSourceCreationStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl AdaptiveMediaSourceDiagnosticAvailableEventArgs {
    ...
    pub fn ResourceType(
        ...
        super::super::super::Foundation::IReference<AdaptiveMediaSourceResourceType>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
unsafe impl windows_core::Interface for AdaptiveMediaSourceDiagnosticAvailableEventArgs {
    type Vtable =
        <IAdaptiveMediaSourceDiagnosticAvailableEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IAdaptiveMediaSourceDiagnosticAvailableEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for AdaptiveMediaSourceDiagnosticType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceDiagnosticType;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for AdaptiveMediaSourceDiagnostics {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAdaptiveMediaSourceDiagnostics>();
}
...
unsafe impl windows_core::Interface for AdaptiveMediaSourceDownloadBitrateChangedEventArgs {
    type Vtable =
        <IAdaptiveMediaSourceDownloadBitrateChangedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IAdaptiveMediaSourceDownloadBitrateChangedEventArgs as windows_core::Interface>::IID;
}
...
impl AdaptiveMediaSourceDownloadCompletedEventArgs {
    ...
    pub fn RequestId(&self) -> windows_core::Result<i32> {
        let this = &windows_core::Interface::cast::<IAdaptiveMediaSourceDownloadCompletedEventArgs2>(
            self,
        )?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResourceDuration(
        ...
        super::super::super::Foundation::IReference<super::super::super::Foundation::TimeSpan>,
    > {
        let this = &windows_core::Interface::cast::<IAdaptiveMediaSourceDownloadCompletedEventArgs3>(
            self,
        )?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
unsafe impl windows_core::Interface for AdaptiveMediaSourceDownloadCompletedEventArgs {
    type Vtable =
        <IAdaptiveMediaSourceDownloadCompletedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IAdaptiveMediaSourceDownloadCompletedEventArgs as windows_core::Interface>::IID;
}
...
impl AdaptiveMediaSourceDownloadFailedEventArgs {
    ...
    pub fn RequestId(&self) -> windows_core::Result<i32> {
        let this =
            &windows_core::Interface::cast::<IAdaptiveMediaSourceDownloadFailedEventArgs2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestId)(
                windows_core::Interface::as_raw(this),
    ...
    > {
        let this =
            &windows_core::Interface::cast::<IAdaptiveMediaSourceDownloadFailedEventArgs3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResourceDuration)(
                windows_core::Interface::as_raw(this),
...
unsafe impl windows_core::Interface for AdaptiveMediaSourceDownloadFailedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IAdaptiveMediaSourceDownloadFailedEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for AdaptiveMediaSourceDownloadRequestedDeferral {
    type Vtable =
        <IAdaptiveMediaSourceDownloadRequestedDeferral as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IAdaptiveMediaSourceDownloadRequestedDeferral as windows_core::Interface>::IID;
}
...
impl AdaptiveMediaSourceDownloadRequestedEventArgs {
    ...
    pub fn GetDeferral(
        &self,
    ) -> windows_core::Result<AdaptiveMediaSourceDownloadRequestedDeferral> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestId(&self) -> windows_core::Result<i32> {
        let this = &windows_core::Interface::cast::<IAdaptiveMediaSourceDownloadRequestedEventArgs2>(
            self,
        )?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResourceDuration(
        ...
        super::super::super::Foundation::IReference<super::super::super::Foundation::TimeSpan>,
    > {
        let this = &windows_core::Interface::cast::<IAdaptiveMediaSourceDownloadRequestedEventArgs3>(
            self,
        )?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
unsafe impl windows_core::Interface for AdaptiveMediaSourceDownloadRequestedEventArgs {
    type Vtable =
        <IAdaptiveMediaSourceDownloadRequestedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IAdaptiveMediaSourceDownloadRequestedEventArgs as windows_core::Interface>::IID;
}
...
impl AdaptiveMediaSourceDownloadResult {
        ...
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetResourceUri)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::super::Storage::Streams::IInputStream>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetInputStream)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::super::Storage::Streams::IBuffer>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetBuffer)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn SetExtendedStatus(&self, value: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetExtendedStatus)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::super::Foundation::IReference<u64>>,
    {
        let this = &windows_core::Interface::cast::<IAdaptiveMediaSourceDownloadResult2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetResourceByteRangeOffset)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::super::Foundation::IReference<u64>>,
    {
        let this = &windows_core::Interface::cast::<IAdaptiveMediaSourceDownloadResult2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetResourceByteRangeLength)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
...
impl windows_core::RuntimeType for AdaptiveMediaSourceDownloadResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAdaptiveMediaSourceDownloadResult>();
}
unsafe impl windows_core::Interface for AdaptiveMediaSourceDownloadResult {
    ...
    const IID: windows_core::GUID =
        <IAdaptiveMediaSourceDownloadResult as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for AdaptiveMediaSourceDownloadStatistics {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAdaptiveMediaSourceDownloadStatistics>();
}
...
impl AdaptiveMediaSourcePlaybackBitrateChangedEventArgs {
    ...
    pub fn AudioOnly(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AudioOnly)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
unsafe impl windows_core::Interface for AdaptiveMediaSourcePlaybackBitrateChangedEventArgs {
    type Vtable =
        <IAdaptiveMediaSourcePlaybackBitrateChangedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IAdaptiveMediaSourcePlaybackBitrateChangedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for AdaptiveMediaSourceResourceType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType;i4)",
    );
}
#[cfg(feature = "Media_Core")]
...
pub struct IAdaptiveMediaSource_Vtbl {
    ...
    pub SetInitialBitrate:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub CurrentDownloadBitrate:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub CurrentPlaybackBitrate:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    ...
    pub AudioOnlyPlayback:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub InboundBitsPerSecond:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub InboundBitsPerSecondWindow: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub SetInboundBitsPerSecondWindow: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub DownloadBitrateChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    ...
    pub PlaybackBitrateChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
...
pub struct IAdaptiveMediaSource2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AdvancedSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub struct IAdaptiveMediaSource3_Vtbl {
    ...
    pub DesiredSeekableWindowSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetDesiredSeekableWindowSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GetCorrelatedTimes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IAdaptiveMediaSourceAdvancedSettings_Vtbl,
    0x55db1680_1aeb_47dc_aa08_9a11610ba45a
);
...
pub struct IAdaptiveMediaSourceAdvancedSettings_Vtbl {
    ...
    pub AllSegmentsIndependent:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetAllSegmentsIndependent:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub DesiredBitrateHeadroomRatio: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetDesiredBitrateHeadroomRatio: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BitrateDowngradeTriggerRatio: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetBitrateDowngradeTriggerRatio: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IAdaptiveMediaSourceCorrelatedTimes_Vtbl,
    0x05108787_e032_48e1_ab8d_002b0b3051df
);
...
pub struct IAdaptiveMediaSourceCorrelatedTimes_Vtbl {
    ...
    pub PresentationTimeStamp: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ProgramDateTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
windows_core::imp::define_interface!(
    IAdaptiveMediaSourceDownloadBitrateChangedEventArgs,
    IAdaptiveMediaSourceDownloadBitrateChangedEventArgs_Vtbl,
    0x670c0a44_e04e_4eff_816a_17399f78f4ba
);
...
windows_core::imp::define_interface!(
    IAdaptiveMediaSourceDownloadBitrateChangedEventArgs2,
    IAdaptiveMediaSourceDownloadBitrateChangedEventArgs2_Vtbl,
    0xf3f1f444_96ae_4de0_b540_2b3246e6968c
);
...
pub struct IAdaptiveMediaSourceDownloadBitrateChangedEventArgs2_Vtbl {
    ...
    pub Reason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut AdaptiveMediaSourceDownloadBitrateChangedReason,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IAdaptiveMediaSourceDownloadCompletedEventArgs,
...
windows_core::imp::define_interface!(
    IAdaptiveMediaSourceDownloadRequestedDeferral,
    IAdaptiveMediaSourceDownloadRequestedDeferral_Vtbl,
    0x05c68f64_fa20_4dbd_9821_4bf4c9bf77ab
);
...
windows_core::imp::define_interface!(
    ...
    IAdaptiveMediaSourceDownloadResult_Vtbl,
    0xf4afdc73_bcee_4a6a_9f0a_fec41e2339b0
);
...
pub struct IAdaptiveMediaSourceDownloadResult_Vtbl {
    ...
    InputStream: usize,
    #[cfg(feature = "Storage_Streams")]
    pub SetInputStream: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
    ...
    pub ExtendedStatus:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetExtendedStatus:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IAdaptiveMediaSourceDownloadResult2,
    IAdaptiveMediaSourceDownloadResult2_Vtbl,
    0x15552cb7_7b80_4ac4_8660_a4b97f7c70f0
);
...
pub struct IAdaptiveMediaSourceDownloadResult2_Vtbl {
    ...
    pub SetResourceByteRangeOffset: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ResourceByteRangeLength: unsafe extern "system" fn(
    ...
    pub SetResourceByteRangeLength: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
windows_core::imp::define_interface!(
    IAdaptiveMediaSourcePlaybackBitrateChangedEventArgs,
    IAdaptiveMediaSourcePlaybackBitrateChangedEventArgs_Vtbl,
    0x23a29f6d_7dda_4a51_87a9_6fa8c5b292be
);
...
pub struct IAdaptiveMediaSourceStatics_Vtbl {
    ...
    #[cfg(feature = "Web_Http")]
    pub CreateFromUriWithDownloaderAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(all(feature = "Storage_Streams", feature = "Web_Http"))]
    pub CreateFromStreamWithDownloaderAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,

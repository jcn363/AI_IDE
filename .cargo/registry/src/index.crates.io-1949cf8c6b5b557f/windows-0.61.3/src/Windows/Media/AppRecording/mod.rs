...
impl AppRecordingManager {
    ...
    pub fn StartRecordingToFileAsync<P0>(
        &self,
        file: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<AppRecordingResult>>
    where
        P0: windows_core::Param<super::super::Storage::StorageFile>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StartRecordingToFileAsync)(
                windows_core::Interface::as_raw(this),
                file.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn RecordTimeSpanToFileAsync<P2>(
        &self,
        ...
        P2: windows_core::Param<super::super::Storage::StorageFile>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RecordTimeSpanToFileAsync)(
                windows_core::Interface::as_raw(this),
                starttime,
                duration,
                file.param().abi(),
    ...
    pub fn SupportedScreenshotMediaEncodingSubtypes(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedScreenshotMediaEncodingSubtypes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SaveScreenshotToFilesAsync<P0, P3>(
        &self,
        folder: P0,
        filenameprefix: &windows_core::HSTRING,
        option: AppRecordingSaveScreenshotOption,
        requestedformats: P3,
    ) -> windows_core::Result<windows_future::IAsyncOperation<AppRecordingSaveScreenshotResult>>
    where
        ...
        P3: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SaveScreenshotToFilesAsync)(
                windows_core::Interface::as_raw(this),
                folder.param().abi(),
                core::mem::transmute_copy(filenameprefix),
                option,
                requestedformats.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    fn IAppRecordingManagerStatics<
        R,
        F: FnOnce(&IAppRecordingManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for AppRecordingManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppRecordingManager>();
}
...
impl windows_core::RuntimeType for AppRecordingResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppRecordingResult>();
}
...
impl windows_core::RuntimeType for AppRecordingSaveScreenshotOption {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.AppRecording.AppRecordingSaveScreenshotOption;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl AppRecordingSaveScreenshotResult {
    ...
    pub fn SavedScreenshotInfos(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<AppRecordingSavedScreenshotInfo>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SavedScreenshotInfos)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for AppRecordingSaveScreenshotResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppRecordingSaveScreenshotResult>();
}
unsafe impl windows_core::Interface for AppRecordingSaveScreenshotResult {
    ...
    const IID: windows_core::GUID =
        <IAppRecordingSaveScreenshotResult as windows_core::Interface>::IID;
}
...
impl AppRecordingSavedScreenshotInfo {
    ...
    pub fn MediaEncodingSubtype(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MediaEncodingSubtype)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
...
impl windows_core::RuntimeType for AppRecordingSavedScreenshotInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppRecordingSavedScreenshotInfo>();
}
unsafe impl windows_core::Interface for AppRecordingSavedScreenshotInfo {
    ...
    const IID: windows_core::GUID =
        <IAppRecordingSavedScreenshotInfo as windows_core::Interface>::IID;
}
...
impl AppRecordingStatus {
    pub fn CanRecord(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CanRecord)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CanRecordTimeSpan(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CanRecordTimeSpan)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn HistoricalBufferDuration(
        &self,
    ) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HistoricalBufferDuration)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for AppRecordingStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppRecordingStatus>();
}
...
impl AppRecordingStatusDetails {
    pub fn IsAnyAppBroadcasting(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsAnyAppBroadcasting)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsCaptureResourceUnavailable(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsCaptureResourceUnavailable)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsGameStreamInProgress(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsGameStreamInProgress)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsTimeSpanRecordingDisabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsTimeSpanRecordingDisabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsAppInactive(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsAppInactive)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsBlockedForApp(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsBlockedForApp)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsDisabledByUser(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsDisabledByUser)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsDisabledBySystem(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsDisabledBySystem)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for AppRecordingStatusDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppRecordingStatusDetails>();
}
...
windows_core::imp::define_interface!(
    ...
    IAppRecordingManager_Vtbl,
    0xe7e26076_a044_48e2_a512_3094d574c7cc
);
...
pub struct IAppRecordingManager_Vtbl {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub StartRecordingToFileAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub RecordTimeSpanToFileAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub SupportedScreenshotMediaEncodingSubtypes:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Search")]
    pub SaveScreenshotToFilesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x50e709f7_38ce_4bd3_9db2_e72bbe9de11d
);
...
windows_core::imp::define_interface!(
    IAppRecordingResult,
    IAppRecordingResult_Vtbl,
    0x3a900864_c66d_46f9_b2d9_5bc2dad070d7
);
...
windows_core::imp::define_interface!(
    ...
    IAppRecordingSaveScreenshotResult_Vtbl,
    0x9c5b8d0a_0abb_4457_aaee_24f9c12ec778
);
...
pub struct IAppRecordingSaveScreenshotResult_Vtbl {
    ...
    pub SavedScreenshotInfos: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IAppRecordingSavedScreenshotInfo_Vtbl,
    0x9b642d0a_189a_4d00_bf25_e1bb1249d594
);
...
pub struct IAppRecordingSavedScreenshotInfo_Vtbl {
    ...
    #[cfg(not(feature = "Storage_Streams"))]
    File: usize,
    pub MediaEncodingSubtype: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IAppRecordingStatus,
    IAppRecordingStatus_Vtbl,
    0x1d0cc82c_bc18_4b8a_a6ef_127efab3b5d9
);
...
pub struct IAppRecordingStatus_Vtbl {
    ...
    pub CanRecord:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub CanRecordTimeSpan:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub HistoricalBufferDuration: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IAppRecordingStatusDetails_Vtbl,
    0xb538a9b0_14ed_4412_ac45_6d672c9c9949
);
...
pub struct IAppRecordingStatusDetails_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsAnyAppBroadcasting:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsCaptureResourceUnavailable:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsGameStreamInProgress:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsTimeSpanRecordingDisabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    ...
    pub IsBlockedForApp:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsDisabledByUser:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsDisabledBySystem:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}

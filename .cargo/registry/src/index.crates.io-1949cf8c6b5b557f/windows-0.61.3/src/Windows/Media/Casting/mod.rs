...
impl CastingConnection {
    ...
    pub fn RequestStartCastingAsync<P0>(
        &self,
        value: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<CastingConnectionErrorStatus>>
    where
        P0: windows_core::Param<CastingSource>,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestStartCastingAsync)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn DisconnectAsync(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DisconnectAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for CastingConnection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICastingConnection>();
}
...
unsafe impl windows_core::Interface for CastingConnectionErrorOccurredEventArgs {
    ...
    const IID: windows_core::GUID =
        <ICastingConnectionErrorOccurredEventArgs as windows_core::Interface>::IID;
}
...
impl CastingDevice {
    ...
    pub fn GetSupportedCastingPlaybackTypesAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<CastingPlaybackTypes>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetSupportedCastingPlaybackTypesAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateCastingConnection(&self) -> windows_core::Result<CastingConnection> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateCastingConnection)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetDeviceSelectorFromCastingSourceAsync<P0>(
        castingsource: P0,
        ...
        P0: windows_core::Param<CastingSource>,
    {
        Self::ICastingDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDeviceSelectorFromCastingSourceAsync)(
                windows_core::Interface::as_raw(this),
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<CastingDevice>> {
        Self::ICastingDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeviceInfoSupportsCastingAsync<P0>(
        device: P0,
        ...
        P0: windows_core::Param<super::super::Devices::Enumeration::DeviceInformation>,
    {
        Self::ICastingDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeviceInfoSupportsCastingAsync)(
                windows_core::Interface::as_raw(this),
                device.param().abi(),
                &mut result__,
            )
    ...
    fn ICastingDeviceStatics<R, F: FnOnce(&ICastingDeviceStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CastingDevice, ICastingDeviceStatics> =
...
impl windows_core::RuntimeType for CastingDevice {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICastingDevice>();
}
...
impl CastingDevicePicker {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CastingDeviceSelected)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveCastingDeviceSelected(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveCastingDeviceSelected)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CastingDevicePickerDismissed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveCastingDevicePickerDismissed(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveCastingDevicePickerDismissed)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for CastingDevicePicker {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICastingDevicePicker>();
}
...
impl CastingDevicePickerFilter {
    ...
    pub fn SupportsPictures(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportsPictures)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetSupportsPictures(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSupportsPictures)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SupportedCastingSources(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<CastingSource>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedCastingSources)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for CastingDevicePickerFilter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICastingDevicePickerFilter>();
}
...
impl CastingDeviceSelectedEventArgs {
    pub fn SelectedCastingDevice(&self) -> windows_core::Result<CastingDevice> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SelectedCastingDevice)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for CastingDeviceSelectedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICastingDeviceSelectedEventArgs>();
}
unsafe impl windows_core::Interface for CastingDeviceSelectedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ICastingDeviceSelectedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for CastingSource {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICastingSource>();
}
...
windows_core::imp::define_interface!(
    ICastingConnection,
    ICastingConnection_Vtbl,
    0xcd951653_c2f1_4498_8b78_5fb4cd3640dd
);
...
pub struct ICastingConnection_Vtbl {
    ...
    pub RemoveErrorOccurred:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub RequestStartCastingAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DisconnectAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ICastingConnectionErrorOccurredEventArgs,
    ICastingConnectionErrorOccurredEventArgs_Vtbl,
...
pub struct ICastingConnectionErrorOccurredEventArgs_Vtbl {
    ...
    pub ErrorStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut CastingConnectionErrorStatus,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ICastingDevice,
    ICastingDevice_Vtbl,
    0xde721c83_4a43_4ad1_a6d2_2492a796c3f2
);
...
pub struct ICastingDevice_Vtbl {
    ...
    Icon: usize,
    pub GetSupportedCastingPlaybackTypesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
    pub CreateCastingConnection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ICastingDevicePicker_Vtbl,
    0xdcd39924_0591_49be_aacb_4b82ee756a95
);
...
pub struct ICastingDevicePicker_Vtbl {
    ...
    Appearance: usize,
    pub CastingDeviceSelected: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveCastingDeviceSelected:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub CastingDevicePickerDismissed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveCastingDevicePickerDismissed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
...
pub struct ICastingDevicePickerFilter_Vtbl {
    ...
    pub SetSupportsVideo:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub SupportsPictures:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetSupportsPictures:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub SupportedCastingSources: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ICastingDeviceSelectedEventArgs_Vtbl,
    0xdc439e86_dd57_4d0d_9400_af45e4fb3663
);
...
pub struct ICastingDeviceSelectedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SelectedCastingDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ICastingDeviceStatics_Vtbl,
    0xe7d958d7_4d13_4237_a365_4c4f6a4cfd2f
);
...
pub struct ICastingDeviceStatics_Vtbl {
    ...
    pub GetDeviceSelectorFromCastingSourceAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub DeviceInfoSupportsCastingAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ICastingSource,
    ICastingSource_Vtbl,
    0xf429ea72_3467_47e6_a027_522923e9d727
);

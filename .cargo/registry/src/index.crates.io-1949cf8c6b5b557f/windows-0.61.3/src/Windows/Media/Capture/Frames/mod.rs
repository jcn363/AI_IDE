...
impl windows_core::RuntimeType for BufferMediaFrame {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBufferMediaFrame>();
}
...
impl DepthMediaFrame {
    ...
    pub fn DepthFormat(&self) -> windows_core::Result<DepthMediaFrameFormat> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DepthFormat)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn TryCreateCoordinateMapper<P0, P1>(
        &self,
        cameraintrinsics: P0,
        coordinatesystem: P1,
    ) -> windows_core::Result<super::super::Devices::Core::DepthCorrelatedCoordinateMapper>
    where
        ...
        P1: windows_core::Param<super::super::super::Perception::Spatial::SpatialCoordinateSystem>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryCreateCoordinateMapper)(
                windows_core::Interface::as_raw(this),
                cameraintrinsics.param().abi(),
    ...
    pub fn MaxReliableDepth(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxReliableDepth)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MinReliableDepth(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MinReliableDepth)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for DepthMediaFrame {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDepthMediaFrame>();
}
...
impl DepthMediaFrameFormat {
    ...
    pub fn DepthScaleInMeters(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DepthScaleInMeters)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for DepthMediaFrameFormat {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDepthMediaFrameFormat>();
}
...
windows_core::imp::define_interface!(
    IBufferMediaFrame,
    IBufferMediaFrame_Vtbl,
    0xb5b153c7_9b84_4062_b79c_a365b2596854
);
...
windows_core::imp::define_interface!(
    IDepthMediaFrame,
    IDepthMediaFrame_Vtbl,
    0x47135e4f_8549_45c0_925b_80d35efdb10a
);
...
pub struct IDepthMediaFrame_Vtbl {
    ...
    pub DepthFormat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Media_Devices_Core", feature = "Perception_Spatial"))]
    pub TryCreateCoordinateMapper: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IDepthMediaFrame2,
    IDepthMediaFrame2_Vtbl,
    0x6cca473d_c4a4_4176_b0cd_33eae3b35aa3
);
...
pub struct IDepthMediaFrame2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub MaxReliableDepth:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub MinReliableDepth:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IDepthMediaFrameFormat,
    IDepthMediaFrameFormat_Vtbl,
    0xc312cf40_d729_453e_8780_2e04f140d28e
);
...
pub struct IDepthMediaFrameFormat_Vtbl {
    ...
    pub DepthScaleInMeters:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IInfraredMediaFrame,
    IInfraredMediaFrame_Vtbl,
    0x3fd13503_004b_4f0e_91ac_465299b41658
);
...
pub struct IMediaFrameReference_Vtbl {
    ...
    pub BufferMediaFrame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub VideoMediaFrame: unsafe extern "system" fn(
...
pub struct IMediaFrameSource_Vtbl {
    ...
    pub RemoveFormatChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    #[cfg(feature = "Media_Devices_Core")]
    pub TryGetCameraIntrinsics: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IMediaFrameSourceController_Vtbl,
    0x6d076635_316d_4b8f_b7b6_eeb04a8c6525
);
...
pub struct IMediaFrameSourceController_Vtbl {
    ...
    pub SetPropertyAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xefc49fd4_fcf2_4a03_b4e4_ac9628739bee
);
...
pub struct IMediaFrameSourceController2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetPropertyByExtendedIdAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        *mut core::ffi::c_void,
    ...
    pub SetPropertyByExtendedIdAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        u32,
...
windows_core::imp::define_interface!(
    ...
    IMediaFrameSourceController3_Vtbl,
    0x1f0cf815_2464_4651_b1e8_4a82dbdb54de
);
...
windows_core::imp::define_interface!(
    ...
    IMediaFrameSourceGetPropertyResult_Vtbl,
    0x088616c2_3a64_4bd5_bd2b_e7c898d2f37a
);
...
pub struct IMediaFrameSourceGetPropertyResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut MediaFrameSourceGetPropertyStatus,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IMediaFrameSourceGroup_Vtbl,
    0x7f605b87_4832_4b5f_ae3d_412faab37d34
);
...
pub struct IMediaFrameSourceGroup_Vtbl {
    ...
    pub SourceInfos: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IMediaFrameSourceGroupStatics_Vtbl,
    0x1c48bfc5_436f_4508_94cf_d5d8b7326445
);
...
pub struct IMediaFrameSourceInfo2_Vtbl {
    ...
    pub VideoProfileMediaDescription: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub struct IMediaFrameSourceInfo3_Vtbl {
    ...
    pub GetRelativePanel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut super::super::super::Devices::Enumeration::Panel,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IMultiSourceMediaFrameArrivedEventArgs_Vtbl,
    0x63115e01_cf51_48fd_aab0_6d693eb48127
);
...
windows_core::imp::define_interface!(
    ...
    IMultiSourceMediaFrameReader_Vtbl,
    0x8d144402_f763_488d_98f2_b437bcf075e7
);
...
windows_core::imp::define_interface!(
    ...
    IMultiSourceMediaFrameReader2_Vtbl,
    0xef5c8abd_fc5c_4c6b_9d81_3cb9cc637c26
);
...
windows_core::imp::define_interface!(
    ...
    IMultiSourceMediaFrameReference_Vtbl,
    0x21964b1a_7fe2_44d6_92e5_298e6d2810e9
);
...
pub struct IMultiSourceMediaFrameReference_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub TryGetFrameReferenceBySourceId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct IVideoMediaFrame_Vtbl {
    ...
    #[cfg(feature = "Media_Devices_Core")]
    pub CameraIntrinsics: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Media_Devices_Core"))]
    CameraIntrinsics: usize,
    pub InfraredMediaFrame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DepthMediaFrame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetVideoFrame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl InfraredMediaFrame {
    ...
    pub fn IsIlluminated(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsIlluminated)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for InfraredMediaFrame {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInfraredMediaFrame>();
}
...
impl windows_core::RuntimeType for MediaFrameArrivedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMediaFrameArrivedEventArgs>();
}
...
impl MediaFrameReader {
    ...
    pub fn StartAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<MediaFrameReaderStartStatus>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for MediaFrameReaderAcquisitionMode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Capture.Frames.MediaFrameReaderAcquisitionMode;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl MediaFrameReference {
    ...
    pub fn BufferMediaFrame(&self) -> windows_core::Result<BufferMediaFrame> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BufferMediaFrame)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Perception_Spatial")]
    pub fn CoordinateSystem(
        &self,
    ) -> windows_core::Result<super::super::super::Perception::Spatial::SpatialCoordinateSystem>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaFrameSource {
    ...
    #[cfg(feature = "Media_Devices_Core")]
    pub fn TryGetCameraIntrinsics<P0>(
        &self,
        format: P0,
    ) -> windows_core::Result<super::super::Devices::Core::CameraIntrinsics>
    where
        P0: windows_core::Param<MediaFrameFormat>,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetCameraIntrinsics)(
                windows_core::Interface::as_raw(this),
                format.param().abi(),
                &mut result__,
            )
...
impl MediaFrameSourceController {
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<MediaFrameSourceGetPropertyResult>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPropertyAsync<P1>(
        &self,
        propertyid: &windows_core::HSTRING,
        propertyvalue: P1,
    ) -> windows_core::Result<windows_future::IAsyncOperation<MediaFrameSourceSetPropertyStatus>>
    where
        P1: windows_core::Param<windows_core::IInspectable>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetPropertyAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(propertyid),
    ...
    pub fn VideoDeviceController(
        &self,
    ) -> windows_core::Result<super::super::Devices::VideoDeviceController> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetPropertyByExtendedIdAsync<P1>(
        &self,
        ...
        P1: windows_core::Param<super::super::super::Foundation::IReference<u32>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPropertyByExtendedIdAsync)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn SetPropertyByExtendedIdAsync(
        &self,
        extendedpropertyid: &[u8],
        propertyvalue: &[u8],
    ) -> windows_core::Result<windows_future::IAsyncOperation<MediaFrameSourceSetPropertyStatus>>
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetPropertyByExtendedIdAsync)(
                windows_core::Interface::as_raw(this),
                extendedpropertyid.len().try_into().unwrap(),
                extendedpropertyid.as_ptr(),
    ...
    pub fn AudioDeviceController(
        &self,
    ) -> windows_core::Result<super::super::Devices::AudioDeviceController> {
...
impl windows_core::RuntimeType for MediaFrameSourceController {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMediaFrameSourceController>();
}
...
impl windows_core::RuntimeType for MediaFrameSourceGetPropertyResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMediaFrameSourceGetPropertyResult>();
}
unsafe impl windows_core::Interface for MediaFrameSourceGetPropertyResult {
    ...
    const IID: windows_core::GUID =
        <IMediaFrameSourceGetPropertyResult as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for MediaFrameSourceGetPropertyStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Capture.Frames.MediaFrameSourceGetPropertyStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl MediaFrameSourceGroup {
    ...
    pub fn SourceInfos(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<MediaFrameSourceInfo>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SourceInfos)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn FindAllAsync() -> windows_core::Result<
        windows_future::IAsyncOperation<windows_collections::IVectorView<MediaFrameSourceGroup>>,
    > {
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<MediaFrameSourceGroup>> {
        Self::IMediaFrameSourceGroupStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IMediaFrameSourceGroupStatics<
        R,
        F: FnOnce(&IMediaFrameSourceGroupStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for MediaFrameSourceGroup {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMediaFrameSourceGroup>();
}
...
impl MediaFrameSourceInfo {
    ...
    pub fn DeviceInformation(
        &self,
    ) -> windows_core::Result<super::super::super::Devices::Enumeration::DeviceInformation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn VideoProfileMediaDescription(
        &self,
    ) -> windows_core::Result<
        windows_collections::IVectorView<super::MediaCaptureVideoProfileMediaDescription>,
    > {
        let this = &windows_core::Interface::cast::<IMediaFrameSourceInfo2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).VideoProfileMediaDescription)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(all(feature = "Devices_Enumeration", feature = "UI_WindowManagement"))]
    pub fn GetRelativePanel<P0>(
        &self,
        displayregion: P0,
    ) -> windows_core::Result<super::super::super::Devices::Enumeration::Panel>
    where
        P0: windows_core::Param<super::super::super::UI::WindowManagement::DisplayRegion>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetRelativePanel)(
                windows_core::Interface::as_raw(this),
...
impl windows_core::RuntimeType for MediaFrameSourceSetPropertyStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Capture.Frames.MediaFrameSourceSetPropertyStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for MultiSourceMediaFrameArrivedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMultiSourceMediaFrameArrivedEventArgs>();
}
unsafe impl windows_core::Interface for MultiSourceMediaFrameArrivedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IMultiSourceMediaFrameArrivedEventArgs as windows_core::Interface>::IID;
}
...
impl MultiSourceMediaFrameReader {
    ...
    pub fn StartAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<MultiSourceMediaFrameReaderStartStatus>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for MultiSourceMediaFrameReader {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMultiSourceMediaFrameReader>();
}
...
impl windows_core::RuntimeType for MultiSourceMediaFrameReaderStartStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Capture.Frames.MultiSourceMediaFrameReaderStartStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl MultiSourceMediaFrameReference {
    ...
    pub fn TryGetFrameReferenceBySourceId(
        &self,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetFrameReferenceBySourceId)(
                windows_core::Interface::as_raw(this),
...
impl windows_core::RuntimeType for MultiSourceMediaFrameReference {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMultiSourceMediaFrameReference>();
}
unsafe impl windows_core::Interface for MultiSourceMediaFrameReference {
    ...
    const IID: windows_core::GUID =
        <IMultiSourceMediaFrameReference as windows_core::Interface>::IID;
}
...
impl VideoMediaFrame {
    ...
    pub fn Direct3DSurface(
        &self,
    ) -> windows_core::Result<super::super::super::Graphics::DirectX::Direct3D11::IDirect3DSurface>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_Devices_Core")]
    pub fn CameraIntrinsics(
        &self,
    ) -> windows_core::Result<super::super::Devices::Core::CameraIntrinsics> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CameraIntrinsics)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn InfraredMediaFrame(&self) -> windows_core::Result<InfraredMediaFrame> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InfraredMediaFrame)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn DepthMediaFrame(&self) -> windows_core::Result<DepthMediaFrame> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DepthMediaFrame)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetVideoFrame(&self) -> windows_core::Result<super::super::VideoFrame> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetVideoFrame)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))

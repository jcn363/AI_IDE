...
impl windows_core::RuntimeType for ContentAccessRestrictionLevel {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.ContentRestrictions.ContentAccessRestrictionLevel;i4)",
    );
}
#[repr(transparent)]
...
impl ContentRestrictionsBrowsePolicy {
    ...
    pub fn MaxBrowsableAgeRating(
        &self,
    ) -> windows_core::Result<super::super::Foundation::IReference<u32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxBrowsableAgeRating)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn PreferredAgeRating(
        &self,
    ) -> windows_core::Result<super::super::Foundation::IReference<u32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PreferredAgeRating)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for ContentRestrictionsBrowsePolicy {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IContentRestrictionsBrowsePolicy>();
}
unsafe impl windows_core::Interface for ContentRestrictionsBrowsePolicy {
    ...
    const IID: windows_core::GUID =
        <IContentRestrictionsBrowsePolicy as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    ...
    IContentRestrictionsBrowsePolicy_Vtbl,
    0x8c0133a4_442e_461a_8757_fad2f5bd37e4
);
...
pub struct IContentRestrictionsBrowsePolicy_Vtbl {
    ...
    pub MaxBrowsableAgeRating: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PreferredAgeRating: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRatedContentDescription_Vtbl,
    0x694866df_66b2_4dc3_96b1_f090eedee255
);
...
pub struct IRatedContentDescription_Vtbl {
    ...
    pub Category: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RatedContentCategory,
    ) -> windows_core::HRESULT,
    pub SetCategory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        RatedContentCategory,
    ) -> windows_core::HRESULT,
    pub Ratings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetRatings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRatedContentDescriptionFactory_Vtbl,
...
windows_core::imp::define_interface!(
    ...
    IRatedContentRestrictions_Vtbl,
    0x3f7f23cb_ba07_4401_a49d_8b9222205723
);
...
pub struct IRatedContentRestrictions_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetBrowsePolicyAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetRestrictionLevelAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RequestContentAccessAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RestrictionsChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRestrictionsChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRatedContentRestrictionsFactory,
    IRatedContentRestrictionsFactory_Vtbl,
    0xfb4b2996_c3bd_4910_9619_97cfd0694d56
);
...
pub struct IRatedContentRestrictionsFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateWithMaxAgeRating: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl windows_core::RuntimeType for RatedContentCategory {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.ContentRestrictions.RatedContentCategory;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl RatedContentDescription {
    ...
    pub fn SetCategory(&self, value: RatedContentCategory) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetCategory)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn Ratings(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Ratings)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<windows_collections::IVector<windows_core::HSTRING>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetRatings)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    ) -> windows_core::Result<RatedContentDescription> {
    ...
    fn IRatedContentDescriptionFactory<
        R,
        F: FnOnce(&IRatedContentDescriptionFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for RatedContentDescription {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRatedContentDescription>();
}
...
impl RatedContentRestrictions {
    ...
    pub fn GetBrowsePolicyAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<ContentRestrictionsBrowsePolicy>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetBrowsePolicyAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetRestrictionLevelAsync<P0>(
        &self,
        ratedcontentdescription: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<ContentAccessRestrictionLevel>>
    where
        P0: windows_core::Param<RatedContentDescription>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetRestrictionLevelAsync)(
                windows_core::Interface::as_raw(this),
                ratedcontentdescription.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn RequestContentAccessAsync<P0>(
        &self,
        ratedcontentdescription: P0,
        ...
        P0: windows_core::Param<RatedContentDescription>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestContentAccessAsync)(
                windows_core::Interface::as_raw(this),
                ratedcontentdescription.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RestrictionsChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveRestrictionsChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveRestrictionsChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn CreateWithMaxAgeRating(
        maxagerating: u32,
    ) -> windows_core::Result<RatedContentRestrictions> {
        Self::IRatedContentRestrictionsFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithMaxAgeRating)(
                windows_core::Interface::as_raw(this),
                maxagerating,
                &mut result__,
            )
    ...
    fn IRatedContentRestrictionsFactory<
        R,
        F: FnOnce(&IRatedContentRestrictionsFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RatedContentRestrictions {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRatedContentRestrictions>();
}

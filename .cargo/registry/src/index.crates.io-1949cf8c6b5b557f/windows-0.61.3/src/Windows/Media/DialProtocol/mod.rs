...
impl DialApp {
    ...
    pub fn RequestLaunchAsync(
        &self,
        appargument: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<DialAppLaunchResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestLaunchAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(appargument),
                &mut result__,
            )
    ...
    pub fn StopAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<DialAppStopResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAppStateAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<DialAppStateDetails>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAppStateAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for DialApp {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDialApp>();
}
...
impl windows_core::RuntimeType for DialAppLaunchResult {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.DialProtocol.DialAppLaunchResult;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for DialAppState {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.DialProtocol.DialAppState;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl DialAppStateDetails {
    ...
    pub fn FullXml(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FullXml)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for DialAppStateDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDialAppStateDetails>();
}
...
impl windows_core::RuntimeType for DialAppStopResult {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.DialProtocol.DialAppStopResult;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl DialDevice {
    ...
    pub fn GetDialApp(&self, appname: &windows_core::HSTRING) -> windows_core::Result<DialApp> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDialApp)(
                windows_core::Interface::as_raw(this),
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<DialDevice>> {
        Self::IDialDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeviceInfoSupportsDialAsync<P0>(
        device: P0,
        ...
        P0: windows_core::Param<super::super::Devices::Enumeration::DeviceInformation>,
    {
        Self::IDialDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeviceInfoSupportsDialAsync)(
                windows_core::Interface::as_raw(this),
                device.param().abi(),
                &mut result__,
            )
    ...
    fn IDialDeviceStatics<R, F: FnOnce(&IDialDeviceStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<DialDevice, IDialDeviceStatics> =
...
impl windows_core::RuntimeType for DialDevice {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDialDevice>();
}
...
impl windows_core::RuntimeType for DialDeviceDisplayStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.DialProtocol.DialDeviceDisplayStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl DialDevicePicker {
    ...
    pub fn Appearance(
        &self,
    ) -> windows_core::Result<super::super::Devices::Enumeration::DevicePickerAppearance> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DialDeviceSelected)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveDialDeviceSelected(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDialDeviceSelected)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DialDevicePickerDismissed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveDialDevicePickerDismissed(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDialDevicePickerDismissed)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn PickSingleDialDeviceAsync(
        &self,
        selection: super::super::Foundation::Rect,
    ) -> windows_core::Result<windows_future::IAsyncOperation<DialDevice>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PickSingleDialDeviceAsync)(
                windows_core::Interface::as_raw(this),
                selection,
                &mut result__,
            )
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn PickSingleDialDeviceAsyncWithPlacement(
        &self,
        selection: super::super::Foundation::Rect,
        preferredplacement: super::super::UI::Popups::Placement,
    ) -> windows_core::Result<windows_future::IAsyncOperation<DialDevice>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PickSingleDialDeviceAsyncWithPlacement)(
                windows_core::Interface::as_raw(this),
                selection,
                preferredplacement,
                &mut result__,
    ...
    pub fn SetDisplayStatus<P0>(
        &self,
        device: P0,
        status: DialDeviceDisplayStatus,
    ) -> windows_core::Result<()>
    where
...
impl windows_core::RuntimeType for DialDevicePicker {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDialDevicePicker>();
}
...
impl DialDevicePickerFilter {
    pub fn SupportedAppNames(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedAppNames)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for DialDevicePickerFilter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDialDevicePickerFilter>();
}
...
impl DialDeviceSelectedEventArgs {
    pub fn SelectedDialDevice(&self) -> windows_core::Result<DialDevice> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SelectedDialDevice)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for DialDeviceSelectedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDialDeviceSelectedEventArgs>();
}
...
impl windows_core::RuntimeType for DialDisconnectButtonClickedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDialDisconnectButtonClickedEventArgs>();
}
unsafe impl windows_core::Interface for DialDisconnectButtonClickedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IDialDisconnectButtonClickedEventArgs as windows_core::Interface>::IID;
}
...
impl DialReceiverApp {
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAdditionalDataAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SetAdditionalDataAsync<P0>(
        &self,
        additionaldata: P0,
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetAdditionalDataAsync)(
                windows_core::Interface::as_raw(this),
                additionaldata.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn GetUniqueDeviceNameAsync(
        &self,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetUniqueDeviceNameAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IDialReceiverAppStatics<
        R,
        F: FnOnce(&IDialReceiverAppStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<DialReceiverApp, IDialReceiverAppStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for DialReceiverApp {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDialReceiverApp>();
}
...
windows_core::imp::define_interface!(
    IDialApp,
    IDialApp_Vtbl,
    0x555ffbd3_45b7_49f3_bbd7_302db6084646
);
...
pub struct IDialApp_Vtbl {
    ...
    pub RequestLaunchAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GetAppStateAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub struct IDialAppStateDetails_Vtbl {
    ...
    pub FullXml: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IDialDevice,
    IDialDevice_Vtbl,
    0xfff0edaf_759f_41d2_a20a_7f29ce0b3784
);
...
pub struct IDialDevice_Vtbl {
    ...
    pub GetDialApp: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IDialDevice2,
    IDialDevice2_Vtbl,
    0xbab7f3d5_5bfb_4eba_8b32_b57c5c5ee5c9
);
...
windows_core::imp::define_interface!(
    IDialDevicePicker,
    IDialDevicePicker_Vtbl,
    0xba7e520a_ff59_4f4b_bdac_d89f495ad6e1
);
...
pub struct IDialDevicePicker_Vtbl {
    ...
    Appearance: usize,
    pub DialDeviceSelected: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveDialDeviceSelected:
    ...
    pub RemoveDisconnectButtonClicked:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub DialDevicePickerDismissed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveDialDevicePickerDismissed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    ...
    pub PickSingleDialDeviceAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::Rect,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "UI_Popups")]
    pub PickSingleDialDeviceAsyncWithPlacement: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::Rect,
        super::super::UI::Popups::Placement,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IDialDevicePickerFilter_Vtbl,
    0xc17c93ba_86c0_485d_b8d6_0f9a8f641590
);
...
pub struct IDialDevicePickerFilter_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SupportedAppNames: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IDialDeviceSelectedEventArgs_Vtbl,
    0x480b92ad_ac76_47eb_9c06_a19304da0247
);
...
pub struct IDialDeviceSelectedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SelectedDialDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0xaa69cc95_01f8_4758_8461_2bbd1cdc3cf3
);
...
pub struct IDialDeviceStatics_Vtbl {
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub DeviceInfoSupportsDialAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IDialDisconnectButtonClickedEventArgs_Vtbl,
...
windows_core::imp::define_interface!(
    IDialReceiverApp,
    IDialReceiverApp_Vtbl,
    0xfd3e7c57_5045_470e_b304_4dd9b13e7d11
);
...
pub struct IDialReceiverApp_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetAdditionalDataAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetAdditionalDataAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IDialReceiverApp2,
    IDialReceiverApp2_Vtbl,
    0x530c5805_9130_42ac_a504_1977dcb2ea8a
);
...
pub struct IDialReceiverApp2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetUniqueDeviceNameAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IDialReceiverAppStatics_Vtbl,
    0x53183a3c_4c36_4d02_b28a_f2a9da38ec52
);

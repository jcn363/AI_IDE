windows_core::imp::define_interface!(
    IOcrEngine,
    IOcrEngine_Vtbl,
    0x5a14bc41_5b76_3140_b680_8825562683ac
);
...
pub struct IOcrEngine_Vtbl {
    ...
    pub RecognizerLanguage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct IOcrEngineStatics_Vtbl {
    ...
    #[cfg(feature = "Globalization")]
    pub AvailableRecognizerLanguages: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Globalization"))]
    ...
    #[cfg(feature = "Globalization")]
    pub IsLanguageSupported: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut bool,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Globalization")]
    pub TryCreateFromLanguage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub TryCreateFromUserProfileLanguages: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IOcrLine,
    IOcrLine_Vtbl,
    0x0043a16f_e31f_3a24_899c_d444bd088124
);
...
windows_core::imp::define_interface!(
    IOcrResult,
    IOcrResult_Vtbl,
    0x9bd235b2_175b_3d6a_92e2_388c206e2f63
);
...
windows_core::imp::define_interface!(
    IOcrWord,
    IOcrWord_Vtbl,
    0x3c2a477a_5cd9_3525_ba2a_23d1e0a68a1d
);
...
impl OcrEngine {
    ...
    pub fn RecognizeAsync<P0>(
        &self,
        bitmap: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<OcrResult>>
    where
    ...
    #[cfg(feature = "Globalization")]
    pub fn RecognizerLanguage(
        &self,
    ) -> windows_core::Result<super::super::Globalization::Language> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RecognizerLanguage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn MaxImageDimension() -> windows_core::Result<u32> {
        Self::IOcrEngineStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxImageDimension)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    #[cfg(feature = "Globalization")]
    pub fn AvailableRecognizerLanguages(
    ) -> windows_core::Result<windows_collections::IVectorView<super::super::Globalization::Language>>
    {
        Self::IOcrEngineStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AvailableRecognizerLanguages)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::Globalization::Language>,
    {
        Self::IOcrEngineStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsLanguageSupported)(
                windows_core::Interface::as_raw(this),
                language.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<super::super::Globalization::Language>,
    {
        Self::IOcrEngineStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryCreateFromLanguage)(
                windows_core::Interface::as_raw(this),
                language.param().abi(),
                &mut result__,
            )
    ...
    pub fn TryCreateFromUserProfileLanguages() -> windows_core::Result<OcrEngine> {
        Self::IOcrEngineStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryCreateFromUserProfileLanguages)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IOcrEngineStatics<R, F: FnOnce(&IOcrEngineStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<OcrEngine, IOcrEngineStatics> =
...
impl windows_core::RuntimeType for OcrEngine {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOcrEngine>();
}
...
impl windows_core::RuntimeType for OcrLine {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOcrLine>();
}
...
impl windows_core::RuntimeType for OcrResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOcrResult>();
}
...
impl windows_core::RuntimeType for OcrWord {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOcrWord>();
}

windows_core::imp::define_interface!(
    ...
    ISpeechContinuousRecognitionCompletedEventArgs_Vtbl,
    0xe3d069bb_e30c_5e18_424b_7fbe81f8fbd0
);
...
pub struct ISpeechContinuousRecognitionCompletedEventArgs_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SpeechRecognitionResultStatus,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISpeechContinuousRecognitionResultGeneratedEventArgs,
    ISpeechContinuousRecognitionResultGeneratedEventArgs_Vtbl,
    0x19091e1e_6e7e_5a46_40fb_76594f786504
);
...
windows_core::imp::define_interface!(
    ...
    ISpeechContinuousRecognitionSession_Vtbl,
    0x6a213c04_6614_49f8_99a2_b5e9b3a085c8
);
...
pub struct ISpeechContinuousRecognitionSession_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AutoStopSilenceTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub SetAutoStopSilenceTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub StartWithModeAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub CancelAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub ResultGenerated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveResultGenerated:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISpeechRecognitionCompilationResult,
    ISpeechRecognitionCompilationResult_Vtbl,
    0x407e6c5d_6ac7_4da4_9cc1_2fce32cf7489
);
...
windows_core::imp::define_interface!(
    ...
    0x79ac1628_4d68_43c4_8911_40dc4101b55b
);
...
impl ISpeechRecognitionConstraint {
    ...
    pub fn Probability(&self) -> windows_core::Result<SpeechRecognitionConstraintProbability> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Probability)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetProbability(
        &self,
        value: SpeechRecognitionConstraintProbability,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetProbability)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl ISpeechRecognitionConstraint_Vtbl {
    pub const fn new<Identity: ISpeechRecognitionConstraint_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            result__: *mut SpeechRecognitionConstraintType,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Probability<
            Identity: ISpeechRecognitionConstraint_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            result__: *mut SpeechRecognitionConstraintProbability,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetProbability<
            Identity: ISpeechRecognitionConstraint_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub struct ISpeechRecognitionConstraint_Vtbl {
    ...
    pub Type: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SpeechRecognitionConstraintType,
    ) -> windows_core::HRESULT,
    pub Probability: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SpeechRecognitionConstraintProbability,
    ) -> windows_core::HRESULT,
    pub SetProbability: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xb5031a8f_85ca_4fa4_b11a_474fc41b3835
);
...
pub struct ISpeechRecognitionGrammarFileConstraint_Vtbl {
    ...
    pub GrammarFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ISpeechRecognitionGrammarFileConstraintFactory_Vtbl,
...
pub struct ISpeechRecognitionGrammarFileConstraintFactory_Vtbl {
    ...
    Create: usize,
    #[cfg(feature = "Storage_Streams")]
    pub CreateWithTag: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    ISpeechRecognitionHypothesis_Vtbl,
    0x7a7b25b0_99c5_4f7d_bf84_10aa1302b634
);
...
windows_core::imp::define_interface!(
    ...
    ISpeechRecognitionHypothesisGeneratedEventArgs_Vtbl,
    0x55161a7a_8023_5866_411d_1213bb271476
);
...
pub struct ISpeechRecognitionHypothesisGeneratedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Hypothesis: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ISpeechRecognitionListConstraint_Vtbl,
    0x09c487e9_e4ad_4526_81f2_4946fb481d98
);
...
windows_core::imp::define_interface!(
    ...
    ISpeechRecognitionListConstraintFactory_Vtbl,
    0x40f3cdc7_562a_426a_9f3b_3b4e282be1d5
);
...
windows_core::imp::define_interface!(
    ...
    ISpeechRecognitionQualityDegradingEventArgs_Vtbl,
    0x4fe24105_8c3a_4c7e_8d0a_5bd4f5b14ad8
);
...
pub struct ISpeechRecognitionQualityDegradingEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Problem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SpeechRecognitionAudioProblem,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISpeechRecognitionResult,
    ISpeechRecognitionResult_Vtbl,
    0x4e303157_034e_4652_857e_d0454cc4beec
);
...
pub struct ISpeechRecognitionResult_Vtbl {
    ...
    pub Confidence: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SpeechRecognitionConfidence,
    ) -> windows_core::HRESULT,
    pub SemanticInterpretation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetAlternates: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Constraint: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RulePath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RawConfidence:
...
windows_core::imp::define_interface!(
    ...
    ISpeechRecognitionResult2_Vtbl,
    0xaf7ed1ba_451b_4166_a0c1_1ffe84032d03
);
...
pub struct ISpeechRecognitionResult2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub PhraseStartTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::DateTime,
    ) -> windows_core::HRESULT,
    pub PhraseDuration: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ISpeechRecognitionSemanticInterpretation_Vtbl,
...
windows_core::imp::define_interface!(
    ...
    ISpeechRecognitionTopicConstraint_Vtbl,
    0xbf6fdf19_825d_4e69_a681_36e48cf1c93e
);
...
pub struct ISpeechRecognitionTopicConstraint_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Scenario: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SpeechRecognitionScenario,
    ) -> windows_core::HRESULT,
    pub TopicHint: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ISpeechRecognitionTopicConstraintFactory_Vtbl,
    0x6e6863df_ec05_47d7_a5df_56a3431e58d2
);
...
windows_core::imp::define_interface!(
    ...
    0xf2791c2b_1ef4_4ae7_9d77_b6ff10b8a3c2
);
...
windows_core::imp::define_interface!(
    ...
    0x0bc3c9cb_c26a_40f2_aeb5_8096b2e48073
);
...
pub struct ISpeechRecognizer_Vtbl {
    ...
    pub CurrentLanguage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Globalization"))]
    CurrentLanguage: usize,
    pub Constraints: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Timeouts: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UIOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CompileConstraintsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub RecognizeWithUIAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RecognitionQualityDegrading: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRecognitionQualityDegrading:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ISpeechRecognizer2,
    ISpeechRecognizer2_Vtbl,
    0x63c9baf1_91e3_4ea4_86a1_7c3867d084a6
);
...
pub struct ISpeechRecognizer2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ContinuousRecognitionSession: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub State: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SpeechRecognizerState,
    ) -> windows_core::HRESULT,
    pub StopRecognitionAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub HypothesisGenerated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveHypothesisGenerated:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISpeechRecognizerFactory,
    ISpeechRecognizerFactory_Vtbl,
    0x60c488dd_7fb8_4033_ac70_d046f64818e1
);
...
windows_core::imp::define_interface!(
    ...
    ISpeechRecognizerStateChangedEventArgs_Vtbl,
...
windows_core::imp::define_interface!(
    ...
    ISpeechRecognizerStatics_Vtbl,
    0x87a35eac_a7dc_4b0b_bcc9_24f47c0b7ebf
);
...
pub struct ISpeechRecognizerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Globalization")]
    pub SystemSpeechLanguage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Globalization"))]
    ...
    #[cfg(feature = "Globalization")]
    pub SupportedTopicLanguages: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Globalization"))]
    ...
    #[cfg(feature = "Globalization")]
    pub SupportedGrammarLanguages: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Globalization"))]
...
windows_core::imp::define_interface!(
    ...
    ISpeechRecognizerStatics2_Vtbl,
    0x1d1b0d95_7565_4ef9_a2f3_ba15162a96cf
);
...
pub struct ISpeechRecognizerStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Globalization")]
    pub TrySetSystemSpeechLanguageAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ISpeechRecognizerTimeouts_Vtbl,
    0x2ef76fca_6a3c_4dca_a153_df1bc88a79af
);
...
pub struct ISpeechRecognizerTimeouts_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub InitialSilenceTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub SetInitialSilenceTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub EndSilenceTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub SetEndSilenceTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub BabbleTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub SetBabbleTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ISpeechRecognizerUIOptions_Vtbl,
    0x7888d641_b92b_44ba_a25f_d1864630641f
);
...
pub struct ISpeechRecognizerUIOptions_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ExampleText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetExampleText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AudiblePrompt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetAudiblePrompt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsReadBackEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetIsReadBackEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub ShowConfirmation:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetShowConfirmation:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IVoiceCommandManager,
    IVoiceCommandManager_Vtbl,
    0xaa3a8dd5_b6e7_4ee2_baa9_dd6baced0a2b
);
...
pub struct IVoiceCommandManager_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Storage_Streams")]
    pub InstallCommandSetsFromStorageFileAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
    ...
    pub InstalledCommandSets: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub struct IVoiceCommandSet_Vtbl {
    ...
    pub SetPhraseListAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
unsafe impl windows_core::Interface for SpeechContinuousRecognitionCompletedEventArgs {
    type Vtable =
        <ISpeechContinuousRecognitionCompletedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <ISpeechContinuousRecognitionCompletedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for SpeechContinuousRecognitionMode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.SpeechRecognition.SpeechContinuousRecognitionMode;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
unsafe impl windows_core::Interface for SpeechContinuousRecognitionResultGeneratedEventArgs {
    type Vtable =
        <ISpeechContinuousRecognitionResultGeneratedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <ISpeechContinuousRecognitionResultGeneratedEventArgs as windows_core::Interface>::IID;
}
...
impl SpeechContinuousRecognitionSession {
    pub fn AutoStopSilenceTimeout(
        &self,
    ) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AutoStopSilenceTimeout)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAutoStopSilenceTimeout(
        &self,
        value: super::super::Foundation::TimeSpan,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAutoStopSilenceTimeout)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn StartWithModeAsync(
        &self,
        mode: SpeechContinuousRecognitionMode,
    ) -> windows_core::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StartWithModeAsync)(
                windows_core::Interface::as_raw(this),
                mode,
                &mut result__,
            )
    ...
    pub fn CancelAsync(&self) -> windows_core::Result<windows_future::IAsyncAction> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CancelAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResultGenerated)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveResultGenerated(&self, value: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveResultGenerated)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for SpeechContinuousRecognitionSession {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechContinuousRecognitionSession>();
}
unsafe impl windows_core::Interface for SpeechContinuousRecognitionSession {
    ...
    const IID: windows_core::GUID =
        <ISpeechContinuousRecognitionSession as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for SpeechRecognitionAudioProblem {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.SpeechRecognition.SpeechRecognitionAudioProblem;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SpeechRecognitionCompilationResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechRecognitionCompilationResult>();
}
unsafe impl windows_core::Interface for SpeechRecognitionCompilationResult {
    ...
    const IID: windows_core::GUID =
        <ISpeechRecognitionCompilationResult as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for SpeechRecognitionConfidence {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.SpeechRecognition.SpeechRecognitionConfidence;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SpeechRecognitionConstraintProbability {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.SpeechRecognition.SpeechRecognitionConstraintProbability;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SpeechRecognitionConstraintType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.SpeechRecognition.SpeechRecognitionConstraintType;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl SpeechRecognitionGrammarFileConstraint {
    ...
    pub fn GrammarFile(&self) -> windows_core::Result<super::super::Storage::StorageFile> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GrammarFile)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateWithTag<P0>(
        file: P0,
        tag: &windows_core::HSTRING,
    ) -> windows_core::Result<SpeechRecognitionGrammarFileConstraint>
    where
        P0: windows_core::Param<super::super::Storage::StorageFile>,
    {
        Self::ISpeechRecognitionGrammarFileConstraintFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithTag)(
                windows_core::Interface::as_raw(this),
                file.param().abi(),
    ...
    fn ISpeechRecognitionGrammarFileConstraintFactory<
        R,
        F: FnOnce(&ISpeechRecognitionGrammarFileConstraintFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for SpeechRecognitionGrammarFileConstraint {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechRecognitionGrammarFileConstraint>(
        );
}
unsafe impl windows_core::Interface for SpeechRecognitionGrammarFileConstraint {
    ...
    const IID: windows_core::GUID =
        <ISpeechRecognitionGrammarFileConstraint as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for SpeechRecognitionHypothesis {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechRecognitionHypothesis>();
}
...
impl SpeechRecognitionHypothesisGeneratedEventArgs {
    pub fn Hypothesis(&self) -> windows_core::Result<SpeechRecognitionHypothesis> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Hypothesis)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
unsafe impl windows_core::Interface for SpeechRecognitionHypothesisGeneratedEventArgs {
    type Vtable =
        <ISpeechRecognitionHypothesisGeneratedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <ISpeechRecognitionHypothesisGeneratedEventArgs as windows_core::Interface>::IID;
}
...
impl SpeechRecognitionListConstraint {
    ...
    pub fn CreateWithTag<P0>(
        commands: P0,
        tag: &windows_core::HSTRING,
    ) -> windows_core::Result<SpeechRecognitionListConstraint>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::ISpeechRecognitionListConstraintFactory(|this| unsafe {
    ...
    fn ISpeechRecognitionListConstraintFactory<
        R,
        F: FnOnce(&ISpeechRecognitionListConstraintFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for SpeechRecognitionListConstraint {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechRecognitionListConstraint>();
}
unsafe impl windows_core::Interface for SpeechRecognitionListConstraint {
    ...
    const IID: windows_core::GUID =
        <ISpeechRecognitionListConstraint as windows_core::Interface>::IID;
}
...
impl SpeechRecognitionQualityDegradingEventArgs {
    pub fn Problem(&self) -> windows_core::Result<SpeechRecognitionAudioProblem> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Problem)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
unsafe impl windows_core::Interface for SpeechRecognitionQualityDegradingEventArgs {
    ...
    const IID: windows_core::GUID =
        <ISpeechRecognitionQualityDegradingEventArgs as windows_core::Interface>::IID;
}
...
impl SpeechRecognitionResult {
    ...
    pub fn SemanticInterpretation(
        &self,
    ) -> windows_core::Result<SpeechRecognitionSemanticInterpretation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SemanticInterpretation)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetAlternates(
        &self,
        maxalternates: u32,
    ) -> windows_core::Result<windows_collections::IVectorView<SpeechRecognitionResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAlternates)(
                windows_core::Interface::as_raw(this),
                maxalternates,
                &mut result__,
            )
    ...
    pub fn Constraint(&self) -> windows_core::Result<ISpeechRecognitionConstraint> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Constraint)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn RulePath(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RulePath)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn RawConfidence(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RawConfidence)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PhraseStartTime(&self) -> windows_core::Result<super::super::Foundation::DateTime> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PhraseStartTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PhraseDuration(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PhraseDuration)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for SpeechRecognitionResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechRecognitionResult>();
}
...
impl windows_core::RuntimeType for SpeechRecognitionResultStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SpeechRecognitionScenario {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.SpeechRecognition.SpeechRecognitionScenario;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
unsafe impl windows_core::Interface for SpeechRecognitionSemanticInterpretation {
    ...
    const IID: windows_core::GUID =
        <ISpeechRecognitionSemanticInterpretation as windows_core::Interface>::IID;
}
...
impl SpeechRecognitionTopicConstraint {
    ...
    pub fn Scenario(&self) -> windows_core::Result<SpeechRecognitionScenario> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Scenario)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn TopicHint(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TopicHint)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn Create(
        ...
        topichint: &windows_core::HSTRING,
    ) -> windows_core::Result<SpeechRecognitionTopicConstraint> {
        Self::ISpeechRecognitionTopicConstraintFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(
                windows_core::Interface::as_raw(this),
                scenario,
                core::mem::transmute_copy(topichint),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateWithTag(
        scenario: SpeechRecognitionScenario,
        topichint: &windows_core::HSTRING,
        tag: &windows_core::HSTRING,
    ) -> windows_core::Result<SpeechRecognitionTopicConstraint> {
    ...
    fn ISpeechRecognitionTopicConstraintFactory<
        R,
        F: FnOnce(&ISpeechRecognitionTopicConstraintFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for SpeechRecognitionTopicConstraint {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechRecognitionTopicConstraint>();
}
unsafe impl windows_core::Interface for SpeechRecognitionTopicConstraint {
    ...
    const IID: windows_core::GUID =
        <ISpeechRecognitionTopicConstraint as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for SpeechRecognitionVoiceCommandDefinitionConstraint {
    type Vtable =
        <ISpeechRecognitionVoiceCommandDefinitionConstraint as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <ISpeechRecognitionVoiceCommandDefinitionConstraint as windows_core::Interface>::IID;
}
...
impl SpeechRecognizer {
    ...
    pub fn CurrentLanguage(&self) -> windows_core::Result<super::super::Globalization::Language> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CurrentLanguage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Constraints(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<ISpeechRecognitionConstraint>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Constraints)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Timeouts(&self) -> windows_core::Result<SpeechRecognizerTimeouts> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Timeouts)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn UIOptions(&self) -> windows_core::Result<SpeechRecognizerUIOptions> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UIOptions)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CompileConstraintsAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<SpeechRecognitionCompilationResult>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CompileConstraintsAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn RecognizeAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<SpeechRecognitionResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RecognizeWithUIAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<SpeechRecognitionResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RecognizeWithUIAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn RecognitionQualityDegrading<P0>(
        &self,
        speechrecognitionqualitydegradinghandler: P0,
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RecognitionQualityDegrading)(
                windows_core::Interface::as_raw(this),
                speechrecognitionqualitydegradinghandler.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub fn RemoveRecognitionQualityDegrading(&self, cookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveRecognitionQualityDegrading)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
    ...
    pub fn ContinuousRecognitionSession(
        &self,
    ) -> windows_core::Result<SpeechContinuousRecognitionSession> {
        let this = &windows_core::Interface::cast::<ISpeechRecognizer2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ContinuousRecognitionSession)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn StopRecognitionAsync(&self) -> windows_core::Result<windows_future::IAsyncAction> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StopRecognitionAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HypothesisGenerated)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveHypothesisGenerated(&self, value: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<ISpeechRecognizer2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveHypothesisGenerated)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SystemSpeechLanguage() -> windows_core::Result<super::super::Globalization::Language> {
        Self::ISpeechRecognizerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SystemSpeechLanguage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Globalization")]
    pub fn SupportedTopicLanguages(
    ) -> windows_core::Result<windows_collections::IVectorView<super::super::Globalization::Language>>
    {
        Self::ISpeechRecognizerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedTopicLanguages)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Globalization")]
    pub fn SupportedGrammarLanguages(
    ) -> windows_core::Result<windows_collections::IVectorView<super::super::Globalization::Language>>
    {
        Self::ISpeechRecognizerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedGrammarLanguages)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Globalization")]
    pub fn TrySetSystemSpeechLanguageAsync<P0>(
        speechlanguage: P0,
        ...
        P0: windows_core::Param<super::super::Globalization::Language>,
    {
        Self::ISpeechRecognizerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TrySetSystemSpeechLanguageAsync)(
                windows_core::Interface::as_raw(this),
                speechlanguage.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    ...
    fn ISpeechRecognizerFactory<
        R,
        F: FnOnce(&ISpeechRecognizerFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SpeechRecognizer, ISpeechRecognizerFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ISpeechRecognizerStatics<
        R,
        F: FnOnce(&ISpeechRecognizerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SpeechRecognizer, ISpeechRecognizerStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ISpeechRecognizerStatics2<
        R,
        F: FnOnce(&ISpeechRecognizerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for SpeechRecognizer {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechRecognizer>();
}
...
impl windows_core::RuntimeType for SpeechRecognizerState {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.SpeechRecognition.SpeechRecognizerState;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SpeechRecognizerStateChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechRecognizerStateChangedEventArgs>();
}
unsafe impl windows_core::Interface for SpeechRecognizerStateChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ISpeechRecognizerStateChangedEventArgs as windows_core::Interface>::IID;
}
...
impl SpeechRecognizerTimeouts {
    pub fn InitialSilenceTimeout(
        &self,
    ) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InitialSilenceTimeout)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetInitialSilenceTimeout(
        &self,
        value: super::super::Foundation::TimeSpan,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetInitialSilenceTimeout)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn EndSilenceTimeout(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EndSilenceTimeout)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetEndSilenceTimeout(
        &self,
        value: super::super::Foundation::TimeSpan,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetEndSilenceTimeout)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn BabbleTimeout(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BabbleTimeout)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetBabbleTimeout(
        &self,
        value: super::super::Foundation::TimeSpan,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetBabbleTimeout)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for SpeechRecognizerTimeouts {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechRecognizerTimeouts>();
}
...
impl SpeechRecognizerUIOptions {
    pub fn ExampleText(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ExampleText)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetExampleText(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetExampleText)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn AudiblePrompt(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AudiblePrompt)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetAudiblePrompt(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAudiblePrompt)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn IsReadBackEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsReadBackEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIsReadBackEnabled(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsReadBackEnabled)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn ShowConfirmation(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowConfirmation)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetShowConfirmation(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetShowConfirmation)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for SpeechRecognizerUIOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechRecognizerUIOptions>();
}
...
impl VoiceCommandManager {
        ...
        P0: windows_core::Param<super::super::Storage::StorageFile>,
    {
        Self::IVoiceCommandManager(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InstallCommandSetsFromStorageFileAsync)(
                windows_core::Interface::as_raw(this),
                file.param().abi(),
                &mut result__,
            )
    ...
    pub fn InstalledCommandSets(
    ) -> windows_core::Result<windows_collections::IMapView<windows_core::HSTRING, VoiceCommandSet>>
    {
        Self::IVoiceCommandManager(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InstalledCommandSets)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IVoiceCommandManager<R, F: FnOnce(&IVoiceCommandManager) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<VoiceCommandManager, IVoiceCommandManager> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl VoiceCommandSet {
    ...
    pub fn SetPhraseListAsync<P1>(
        &self,
        phraselistname: &windows_core::HSTRING,
        phraselist: P1,
    ) -> windows_core::Result<windows_future::IAsyncAction>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetPhraseListAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(phraselistname),
                phraselist.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
impl windows_core::RuntimeType for VoiceCommandSet {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVoiceCommandSet>();
}

...
impl AppBroadcastingMonitor {
    ...
    pub fn IsCurrentAppBroadcasting(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).IsCurrentAppBroadcasting)(
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsCurrentAppBroadcastingChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveIsCurrentAppBroadcastingChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveIsCurrentAppBroadcastingChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for AppBroadcastingMonitor {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppBroadcastingMonitor>();
}
...
impl AppBroadcastingStatus {
    pub fn CanStartBroadcast(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CanStartBroadcast)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for AppBroadcastingStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppBroadcastingStatus>();
}
...
impl windows_core::RuntimeType for AppBroadcastingStatusDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppBroadcastingStatusDetails>();
}
...
impl AppBroadcastingUI {
    ...
    pub fn ShowBroadcastUI(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ShowBroadcastUI)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    fn IAppBroadcastingUIStatics<
        R,
        F: FnOnce(&IAppBroadcastingUIStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for AppBroadcastingUI {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppBroadcastingUI>();
}
...
windows_core::imp::define_interface!(
    ...
    IAppBroadcastingMonitor_Vtbl,
    0x00f95a68_8907_48a0_b8ef_24d208137542
);
...
pub struct IAppBroadcastingMonitor_Vtbl {
    ...
    pub IsCurrentAppBroadcasting:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsCurrentAppBroadcastingChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveIsCurrentAppBroadcastingChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IAppBroadcastingStatus,
    IAppBroadcastingStatus_Vtbl,
    0x1225e4df_03a1_42f8_8b80_c9228cd9cf2e
);
...
windows_core::imp::define_interface!(
    ...
    IAppBroadcastingStatusDetails_Vtbl,
    0x069dada4_b573_4e3c_8e19_1bafacd09713
);
...
windows_core::imp::define_interface!(
    IAppBroadcastingUI,
    IAppBroadcastingUI_Vtbl,
    0xe56f9f8f_ee99_4dca_a3c3_70af3db44f5f
);
...
windows_core::imp::define_interface!(
    IAppBroadcastingUIStatics,
    IAppBroadcastingUIStatics_Vtbl,
    0x55a8a79d_23cb_4579_9c34_886fe02c045a
);

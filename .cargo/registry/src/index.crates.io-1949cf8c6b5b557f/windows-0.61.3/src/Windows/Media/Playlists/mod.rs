windows_core::imp::define_interface!(
    IPlaylist,
    IPlaylist_Vtbl,
    0x803736f5_cf44_4d97_83b3_7a089e9ab663
);
...
pub struct IPlaylist_Vtbl {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub SaveAsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    SaveAsAsync: usize,
    #[cfg(feature = "Storage_Streams")]
    pub SaveAsWithFormatAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::Storage::NameCollisionOption,
...
windows_core::imp::define_interface!(
    IPlaylistStatics,
    IPlaylistStatics_Vtbl,
    0xc5c331cd_81f9_4ff3_95b9_70b6ff046b68
);
...
impl Playlist {
    ...
    pub fn Files(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<super::super::Storage::StorageFile>>
    {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveAsAsync<P0>(
        &self,
        savelocation: P0,
        desiredname: &windows_core::HSTRING,
        option: super::super::Storage::NameCollisionOption,
        ...
        P0: windows_core::Param<super::super::Storage::IStorageFolder>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SaveAsAsync)(
                windows_core::Interface::as_raw(this),
                savelocation.param().abi(),
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveAsWithFormatAsync<P0>(
        &self,
        savelocation: P0,
        desiredname: &windows_core::HSTRING,
        option: super::super::Storage::NameCollisionOption,
        ...
        P0: windows_core::Param<super::super::Storage::IStorageFolder>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SaveAsWithFormatAsync)(
                windows_core::Interface::as_raw(this),
                savelocation.param().abi(),
                core::mem::transmute_copy(desiredname),
                option,
    ...
    pub fn LoadAsync<P0>(
        file: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<Playlist>>
    where
    ...
    fn IPlaylistStatics<R, F: FnOnce(&IPlaylistStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<Playlist, IPlaylistStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for Playlist {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPlaylist>();
}
...
impl windows_core::RuntimeType for PlaylistFormat {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.Playlists.PlaylistFormat;i4)",
    );
}

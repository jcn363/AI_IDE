...
impl windows_core::RuntimeType for AudioBufferAccessMode {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Media.AudioBufferAccessMode;i4)");
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl AudioFrame {
    ...
    pub fn ExtendedProperties(
        &self,
    ) -> windows_core::Result<super::Foundation::Collections::IPropertySet> {
        let this = &windows_core::Interface::cast::<IMediaFrame>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for AudioProcessing {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Media.AudioProcessing;i4)");
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl AutoRepeatModeChangeRequestedEventArgs {
    pub fn RequestedAutoRepeatMode(&self) -> windows_core::Result<MediaPlaybackAutoRepeatMode> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestedAutoRepeatMode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IMediaControl_Vtbl {
    ...
    pub PlayPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePlayPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub PausePressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePausePressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub StopPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveStopPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub PlayPauseTogglePressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePlayPauseTogglePressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub RecordPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRecordPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub NextTrackPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveNextTrackPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub PreviousTrackPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePreviousTrackPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub FastForwardPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveFastForwardPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub RewindPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRewindPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub ChannelUpPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveChannelUpPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub ChannelDownPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveChannelDownPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub SoundLevel:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut SoundLevel) -> windows_core::HRESULT,
    pub SetTrackName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TrackName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetArtistName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ArtistName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetIsPlaying:
    ...
    pub SetAlbumArt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AlbumArt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0x07915118_45df_442b_8a3f_f7826a6370ab
);
...
pub trait IMediaExtension_Impl: windows_core::IUnknownImpl {
    fn SetProperties(
        &self,
        configuration: windows_core::Ref<'_, super::Foundation::Collections::IPropertySet>,
    ) -> windows_core::Result<()>;
}
#[cfg(feature = "Foundation_Collections")]
    ...
    pub const fn new<Identity: IMediaExtension_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                IMediaExtension_Impl::SetProperties(this, core::mem::transmute_copy(&configuration))
                    .into()
            }
        }
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IMediaExtension, OFFSET>(),
...
windows_core::imp::define_interface!(
    ...
    IMediaExtensionManager_Vtbl,
    0x4a25eaf5_242d_4dfb_97f4_69b7c42576ff
);
...
pub struct IMediaExtensionManager_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RegisterSchemeHandler: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Foundation_Collections")]
    pub RegisterSchemeHandlerWithSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub RegisterByteStreamHandler: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub RegisterByteStreamHandlerWithSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub RegisterAudioDecoder: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::GUID,
        windows_core::GUID,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub RegisterAudioDecoderWithSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::GUID,
        windows_core::GUID,
    ...
    pub RegisterAudioEncoder: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::GUID,
        windows_core::GUID,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub RegisterAudioEncoderWithSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::GUID,
        windows_core::GUID,
    ...
    pub RegisterVideoDecoder: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::GUID,
        windows_core::GUID,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub RegisterVideoDecoderWithSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::GUID,
        windows_core::GUID,
    ...
    pub RegisterVideoEncoder: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::GUID,
        windows_core::GUID,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub RegisterVideoEncoderWithSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::GUID,
        windows_core::GUID,
...
windows_core::imp::define_interface!(
    ...
    IMediaExtensionManager2_Vtbl,
    0x5bcebf47_4043_4fed_acaf_54ec29dfb1f7
);
...
pub struct IMediaExtensionManager2_Vtbl {
    ...
    pub RegisterMediaExtensionForAppService: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    )
...
pub trait IMediaFrame_Impl: super::Foundation::IClosable_Impl {
    ...
    fn SetRelativeTime(
        &self,
        value: windows_core::Ref<'_, super::Foundation::IReference<super::Foundation::TimeSpan>>,
    ) -> windows_core::Result<()>;
    fn RelativeTime(
        &self,
    ) -> windows_core::Result<super::Foundation::IReference<super::Foundation::TimeSpan>>;
...
impl IMediaFrame_Vtbl {
    pub const fn new<Identity: IMediaFrame_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn IsReadOnly<Identity: IMediaFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut bool,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn RelativeTime<Identity: IMediaFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMediaFrame_Impl::SetSystemRelativeTime(this, core::mem::transmute_copy(&value))
                    .into()
            }
        }
        ...
        unsafe extern "system" fn SetDuration<Identity: IMediaFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Duration<Identity: IMediaFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    IMediaMarker,
    IMediaMarker_Vtbl,
    0x1803def8_dca5_4b6f_9c20_e3d3c0643625
);
...
impl IMediaMarker_Vtbl {
    pub const fn new<Identity: IMediaMarker_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Time<Identity: IMediaMarker_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut super::Foundation::TimeSpan,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn MediaMarkerType<
        ...
        unsafe extern "system" fn Text<Identity: IMediaMarker_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    ...
    IMediaMarkerTypesStatics_Vtbl,
    0xbb198040_482f_4743_8832_45853821ece0
);
...
windows_core::imp::define_interface!(
    IMediaMarkers,
    IMediaMarkers_Vtbl,
    0xafeab189_f8dd_466e_aa10_920b52353fdf
);
...
impl IMediaMarkers_Vtbl {
    pub const fn new<Identity: IMediaMarkers_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Markers<Identity: IMediaMarkers_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IMediaMarkers, OFFSET>(),
            Markers: Markers::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    IMediaProcessingTriggerDetails_Vtbl,
    0xeb8564ac_a351_4f4e_b4f0_9bf2408993db
);
...
windows_core::imp::define_interface!(
    ...
    IMediaTimelineController_Vtbl,
    0x8ed361f3_0b78_4360_bf71_0c841999ea1b
);
...
pub struct IMediaTimelineController_Vtbl {
    ...
    pub State: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut MediaTimelineControllerState,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0xef74ea38_9e72_4df9_8355_6e90c81bbadd
);
...
windows_core::imp::define_interface!(
    ...
    IMediaTimelineControllerFailedEventArgs_Vtbl,
    0x8821f81d_3e77_43fb_be26_4fc87a044834
);
...
pub struct ISystemMediaTransportControlsPropertyChangedEventArgs_Vtbl {
    ...
    pub Property: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SystemMediaTransportControlsProperty,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
...
windows_core::imp::define_interface!(
    ...
    IVideoEffectsStatics_Vtbl,
    0x1fcda5e8_baf1_4521_980c_3bcebb44cf38
);
...
pub struct IVideoEffectsStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub VideoStabilization: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IVideoFrame,
    IVideoFrame_Vtbl,
    0x0cc06625_90fc_4c92_bd95_7ded21819d1c
);
...
pub struct IVideoFrame_Vtbl {
    ...
    pub CopyToAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub Direct3DSurface: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IVideoFrame2,
    IVideoFrame2_Vtbl,
    0x3837840d_336c_4366_8d46_060798736c5d
);
...
pub struct IVideoFrame2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Graphics_Imaging")]
    pub CopyToWithBoundsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IVideoFrameFactory,
    IVideoFrameFactory_Vtbl,
    0x014b6d69_2228_4c92_92ff_50c380d3e776
);
...
pub struct IVideoFrameFactory_Vtbl {
    ...
    pub Create: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::Graphics::Imaging::BitmapPixelFormat,
        i32,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub CreateWithAlpha: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        ...
        i32,
        i32,
        super::Graphics::Imaging::BitmapAlphaMode,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Graphics_Imaging"))]
...
windows_core::imp::define_interface!(
    IVideoFrameStatics,
    IVideoFrameStatics_Vtbl,
    0xab2a556f_6111_4b33_8ec3_2b209a02e17a
);
...
pub struct IVideoFrameStatics_Vtbl {
    ...
    pub CreateAsDirect3D11SurfaceBacked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::Graphics::DirectX::DirectXPixelFormat,
        i32,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub CreateAsDirect3D11SurfaceBackedWithDevice:
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub CreateWithSoftwareBitmap: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub CreateWithDirect3D11Surface: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl MediaControl {
        ...
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PlayPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemovePlayPressed(cookie: i64) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).RemovePlayPressed)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PausePressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemovePausePressed(cookie: i64) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).RemovePausePressed)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StopPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveStopPressed(cookie: i64) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveStopPressed)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PlayPauseTogglePressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemovePlayPauseTogglePressed(cookie: i64) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).RemovePlayPauseTogglePressed)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RecordPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveRecordPressed(cookie: i64) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveRecordPressed)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NextTrackPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveNextTrackPressed(cookie: i64) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveNextTrackPressed)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PreviousTrackPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemovePreviousTrackPressed(cookie: i64) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).RemovePreviousTrackPressed)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FastForwardPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveFastForwardPressed(cookie: i64) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveFastForwardPressed)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RewindPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveRewindPressed(cookie: i64) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveRewindPressed)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ChannelUpPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveChannelUpPressed(cookie: i64) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveChannelUpPressed)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
        ...
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ChannelDownPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveChannelDownPressed(cookie: i64) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveChannelDownPressed)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
    ...
    pub fn SetTrackName(value: &windows_core::HSTRING) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).SetTrackName)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn TrackName() -> windows_core::Result<windows_core::HSTRING> {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TrackName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetArtistName(value: &windows_core::HSTRING) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).SetArtistName)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn ArtistName() -> windows_core::Result<windows_core::HSTRING> {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ArtistName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetIsPlaying(value: bool) -> windows_core::Result<()> {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).SetIsPlaying)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    {
        Self::IMediaControl(|this| unsafe {
            (windows_core::Interface::vtable(this).SetAlbumArt)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn AlbumArt() -> windows_core::Result<super::Foundation::Uri> {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AlbumArt)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IMediaControl<R, F: FnOnce(&IMediaControl) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<MediaControl, IMediaControl> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl MediaExtensionManager {
    ...
    pub fn RegisterSchemeHandler(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterSchemeHandler)(
                windows_core::Interface::as_raw(this),
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RegisterSchemeHandlerWithSettings<P2>(
        &self,
        activatableclassid: &windows_core::HSTRING,
        scheme: &windows_core::HSTRING,
        configuration: P2,
        ...
        P2: windows_core::Param<super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterSchemeHandlerWithSettings)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
                core::mem::transmute_copy(scheme),
                configuration.param().abi(),
    ...
    pub fn RegisterByteStreamHandler(
        &self,
        activatableclassid: &windows_core::HSTRING,
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterByteStreamHandler)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RegisterByteStreamHandlerWithSettings<P3>(
        &self,
        activatableclassid: &windows_core::HSTRING,
        fileextension: &windows_core::HSTRING,
        mimetype: &windows_core::HSTRING,
        ...
        P3: windows_core::Param<super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterByteStreamHandlerWithSettings)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
                core::mem::transmute_copy(fileextension),
                core::mem::transmute_copy(mimetype),
    ...
    pub fn RegisterAudioDecoder(
        &self,
        activatableclassid: &windows_core::HSTRING,
        inputsubtype: windows_core::GUID,
        outputsubtype: windows_core::GUID,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterAudioDecoder)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
                inputsubtype,
                outputsubtype,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RegisterAudioDecoderWithSettings<P3>(
        &self,
        activatableclassid: &windows_core::HSTRING,
        inputsubtype: windows_core::GUID,
        outputsubtype: windows_core::GUID,
        ...
        P3: windows_core::Param<super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterAudioDecoderWithSettings)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
                inputsubtype,
                outputsubtype,
    ...
    pub fn RegisterAudioEncoder(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterAudioEncoder)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
                inputsubtype,
                outputsubtype,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RegisterAudioEncoderWithSettings<P3>(
        &self,
        activatableclassid: &windows_core::HSTRING,
        inputsubtype: windows_core::GUID,
        outputsubtype: windows_core::GUID,
        ...
        P3: windows_core::Param<super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterAudioEncoderWithSettings)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
                inputsubtype,
                outputsubtype,
    ...
    pub fn RegisterVideoDecoder(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterVideoDecoder)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
                inputsubtype,
                outputsubtype,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RegisterVideoDecoderWithSettings<P3>(
        &self,
        activatableclassid: &windows_core::HSTRING,
        inputsubtype: windows_core::GUID,
        outputsubtype: windows_core::GUID,
        ...
        P3: windows_core::Param<super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterVideoDecoderWithSettings)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
                inputsubtype,
                outputsubtype,
    ...
    pub fn RegisterVideoEncoder(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterVideoEncoder)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
                inputsubtype,
                outputsubtype,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RegisterVideoEncoderWithSettings<P3>(
        &self,
        activatableclassid: &windows_core::HSTRING,
        inputsubtype: windows_core::GUID,
        outputsubtype: windows_core::GUID,
        ...
        P3: windows_core::Param<super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RegisterVideoEncoderWithSettings)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activatableclassid),
                inputsubtype,
                outputsubtype,
    ...
    #[cfg(feature = "ApplicationModel_AppService")]
    pub fn RegisterMediaExtensionForAppService<P0, P1>(
        &self,
        extension: P0,
        connection: P1,
    ) -> windows_core::Result<()>
        ...
        P1: windows_core::Param<super::ApplicationModel::AppService::AppServiceConnection>,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(this).RegisterMediaExtensionForAppService)(
                windows_core::Interface::as_raw(this),
                extension.param().abi(),
...
impl windows_core::RuntimeType for MediaExtensionManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMediaExtensionManager>();
}
...
impl MediaMarkerTypes {
    pub fn Bookmark() -> windows_core::Result<windows_core::HSTRING> {
        Self::IMediaMarkerTypesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Bookmark)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    fn IMediaMarkerTypesStatics<
        R,
        F: FnOnce(&IMediaMarkerTypesStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<MediaMarkerTypes, IMediaMarkerTypesStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl windows_core::RuntimeType for MediaProcessingTriggerDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMediaProcessingTriggerDetails>();
}
unsafe impl windows_core::Interface for MediaProcessingTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IMediaProcessingTriggerDetails as windows_core::Interface>::IID;
}
...
impl MediaTimelineController {
    ...
    pub fn ClockRate(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ClockRate)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetClockRate(&self, value: f64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetClockRate)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).PositionChanged)(
                windows_core::Interface::as_raw(this),
                positionchangedeventhandler.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
        ...
        >,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).StateChanged)(
                windows_core::Interface::as_raw(this),
                statechangedeventhandler.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
...
impl windows_core::RuntimeType for MediaTimelineController {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMediaTimelineController>();
}
...
impl windows_core::RuntimeType for MediaTimelineControllerFailedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMediaTimelineControllerFailedEventArgs>(
        );
}
unsafe impl windows_core::Interface for MediaTimelineControllerFailedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IMediaTimelineControllerFailedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for MediaTimelineControllerState {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.MediaTimelineControllerState;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl PlaybackRateChangeRequestedEventArgs {
    pub fn RequestedPlaybackRate(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestedPlaybackRate)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl ShuffleEnabledChangeRequestedEventArgs {
    pub fn RequestedShuffleEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestedShuffleEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl SystemMediaTransportControlsDisplayUpdater {
    ...
    pub fn Update(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).Update)(windows_core::Interface::as_raw(this))
                .ok()
        }
    }
}
...
impl windows_core::RuntimeType for SystemMediaTransportControlsProperty {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.SystemMediaTransportControlsProperty;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl VideoEffects {
    pub fn VideoStabilization() -> windows_core::Result<windows_core::HSTRING> {
        Self::IVideoEffectsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).VideoStabilization)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    fn IVideoEffectsStatics<R, F: FnOnce(&IVideoEffectsStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<VideoEffects, IVideoEffectsStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl VideoFrame {
        ...
        P0: windows_core::Param<VideoFrame>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CopyToAsync)(
                windows_core::Interface::as_raw(this),
                frame.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn Direct3DSurface(
        &self,
    ) -> windows_core::Result<super::Graphics::DirectX::Direct3D11::IDirect3DSurface> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Direct3DSurface)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn CopyToWithBoundsAsync<P0, P1, P2>(
        &self,
        frame: P0,
        sourcebounds: P1,
        destinationbounds: P2,
    ) -> windows_core::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<VideoFrame>,
        P1: windows_core::Param<
            super::Foundation::IReference<super::Graphics::Imaging::BitmapBounds>,
        >,
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CopyToWithBoundsAsync)(
                windows_core::Interface::as_raw(this),
                frame.param().abi(),
                sourcebounds.param().abi(),
                destinationbounds.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn Create(
        format: super::Graphics::Imaging::BitmapPixelFormat,
        width: i32,
        height: i32,
    ) -> windows_core::Result<VideoFrame> {
    ...
    pub fn CreateWithAlpha(
        ...
        width: i32,
        height: i32,
        alpha: super::Graphics::Imaging::BitmapAlphaMode,
    ) -> windows_core::Result<VideoFrame> {
        Self::IVideoFrameFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_DirectX")]
    pub fn CreateAsDirect3D11SurfaceBacked(
        format: super::Graphics::DirectX::DirectXPixelFormat,
        width: i32,
        height: i32,
    ) -> windows_core::Result<VideoFrame> {
        Self::IVideoFrameStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateAsDirect3D11SurfaceBacked)(
                windows_core::Interface::as_raw(this),
                format,
                width,
                height,
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn CreateAsDirect3D11SurfaceBackedWithDevice<P3>(
        format: super::Graphics::DirectX::DirectXPixelFormat,
        width: i32,
        height: i32,
        device: P3,
        ...
        P3: windows_core::Param<super::Graphics::DirectX::Direct3D11::IDirect3DDevice>,
    {
        Self::IVideoFrameStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateAsDirect3D11SurfaceBackedWithDevice)(
                windows_core::Interface::as_raw(this),
                format,
                width,
                height,
        ...
        P0: windows_core::Param<super::Graphics::Imaging::SoftwareBitmap>,
    {
        Self::IVideoFrameStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithSoftwareBitmap)(
                windows_core::Interface::as_raw(this),
                bitmap.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<super::Graphics::DirectX::Direct3D11::IDirect3DSurface>,
    {
        Self::IVideoFrameStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithDirect3D11Surface)(
                windows_core::Interface::as_raw(this),
                surface.param().abi(),
                &mut result__,
            )
    ...
    fn IVideoFrameFactory<R, F: FnOnce(&IVideoFrameFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<VideoFrame, IVideoFrameFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IVideoFrameStatics<R, F: FnOnce(&IVideoFrameStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<VideoFrame, IVideoFrameStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for VideoFrame {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVideoFrame>();
}

windows_core::imp::define_interface!(
    ...
    IVariablePhotoCapturedEventArgs_Vtbl,
    0xd1eb4c5c_1b53_4e4a_8b5c_db7887ac949b
);
...
pub struct IVariablePhotoCapturedEventArgs_Vtbl {
    ...
    pub UsedFrameControllerIndex: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CapturedFrameControlValues: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IVariablePhotoSequenceCapture_Vtbl,
    0xd0112d1d_031e_4041_a6d6_bd742476a8ee
);
...
windows_core::imp::define_interface!(
    ...
    0xfe2c62bc_50b0_43e3_917c_e3b92798942f
);
...
impl VariablePhotoCapturedEventArgs {
    ...
    pub fn UsedFrameControllerIndex(
        &self,
    ) -> windows_core::Result<super::super::super::Foundation::IReference<u32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UsedFrameControllerIndex)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CapturedFrameControlValues(
        &self,
    ) -> windows_core::Result<super::CapturedFrameControlValues> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CapturedFrameControlValues)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for VariablePhotoCapturedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVariablePhotoCapturedEventArgs>();
}
unsafe impl windows_core::Interface for VariablePhotoCapturedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IVariablePhotoCapturedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for VariablePhotoSequenceCapture {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVariablePhotoSequenceCapture>();
}

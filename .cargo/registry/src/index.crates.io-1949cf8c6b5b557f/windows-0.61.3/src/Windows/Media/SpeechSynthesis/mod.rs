windows_core::imp::define_interface!(
    ...
    IInstalledVoicesStatic_Vtbl,
    0x7d526ecc_7533_4c3f_85be_888c2baeebdc
);
...
pub struct IInstalledVoicesStatic_Vtbl {
    ...
    pub AllVoices: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DefaultVoice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IInstalledVoicesStatic2_Vtbl,
    0x64255f2e_358d_4058_be9a_fd3fcb423530
);
...
pub struct IInstalledVoicesStatic2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub TrySetDefaultVoiceAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ISpeechSynthesisStream_Vtbl,
    0x83e46e93_244c_4622_ba0b_6229c4d0d65d
);
#[cfg(feature = "Storage_Streams")]
...
windows_core::imp::define_interface!(
    ISpeechSynthesizer,
    ISpeechSynthesizer_Vtbl,
    0xce9f7c76_97f4_4ced_ad68_d51c458e45c6
);
...
pub struct ISpeechSynthesizer_Vtbl {
    ...
    pub SynthesizeTextToStreamAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Media_Core", feature = "Storage_Streams"))]
    pub SynthesizeSsmlToStreamAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetVoice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Voice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISpeechSynthesizer2,
    ISpeechSynthesizer2_Vtbl,
    0xa7c5ecb2_4339_4d6a_bbf8_c7a4f1544c2e
);
...
windows_core::imp::define_interface!(
    ...
    ISpeechSynthesizerOptions_Vtbl,
    0xa0e23871_cc3d_43c9_91b1_ee185324d83d
);
...
pub struct ISpeechSynthesizerOptions_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IncludeWordBoundaryMetadata:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetIncludeWordBoundaryMetadata:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub IncludeSentenceBoundaryMetadata:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetIncludeSentenceBoundaryMetadata:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISpeechSynthesizerOptions2,
    ISpeechSynthesizerOptions2_Vtbl,
    0x1cbef60e_119c_4bed_b118_d250c3a25793
);
...
windows_core::imp::define_interface!(
    ...
    ISpeechSynthesizerOptions3_Vtbl,
    0x401ed877_902c_4814_a582_a5d0c0769fa8
);
...
pub struct ISpeechSynthesizerOptions3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AppendedSilence: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SpeechAppendedSilence,
    ) -> windows_core::HRESULT,
    pub SetAppendedSilence: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        SpeechAppendedSilence,
    ) -> windows_core::HRESULT,
    pub PunctuationSilence: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SpeechPunctuationSilence,
    ) -> windows_core::HRESULT,
    pub SetPunctuationSilence: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IVoiceInformation,
    IVoiceInformation_Vtbl,
    0xb127d6a4_1291_4604_aa9c_83134083352c
);
...
impl windows_core::RuntimeType for SpeechAppendedSilence {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.SpeechSynthesis.SpeechAppendedSilence;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for SpeechPunctuationSilence {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.SpeechSynthesis.SpeechPunctuationSilence;i4)",
    );
}
#[cfg(all(feature = "Media_Core", feature = "Storage_Streams"))]
#[repr(transparent)]
...
windows_core::imp::required_hierarchy!(
    ...
    super::Core::ITimedMetadataTrackProvider
);
#[cfg(all(feature = "Media_Core", feature = "Storage_Streams"))]
impl SpeechSynthesisStream {
    ...
    pub fn Markers(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<super::IMediaMarker>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TimedMetadataTracks(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<super::Core::TimedMetadataTrack>>
    {
        let this =
            &windows_core::Interface::cast::<super::Core::ITimedMetadataTrackProvider>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for SpeechSynthesisStream {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechSynthesisStream>();
}
#[cfg(all(feature = "Media_Core", feature = "Storage_Streams"))]
...
impl SpeechSynthesizer {
    ...
    pub fn AllVoices() -> windows_core::Result<windows_collections::IVectorView<VoiceInformation>> {
        Self::IInstalledVoicesStatic(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllVoices)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn DefaultVoice() -> windows_core::Result<VoiceInformation> {
        Self::IInstalledVoicesStatic(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DefaultVoice)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn TrySetDefaultVoiceAsync<P0>(
        voice: P0,
        ...
        P0: windows_core::Param<VoiceInformation>,
    {
        Self::IInstalledVoicesStatic2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TrySetDefaultVoiceAsync)(
                windows_core::Interface::as_raw(this),
                voice.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(all(feature = "Media_Core", feature = "Storage_Streams"))]
    pub fn SynthesizeTextToStreamAsync(
        &self,
        text: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<SpeechSynthesisStream>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SynthesizeTextToStreamAsync)(
                windows_core::Interface::as_raw(this),
    ...
    #[cfg(all(feature = "Media_Core", feature = "Storage_Streams"))]
    pub fn SynthesizeSsmlToStreamAsync(
        &self,
        ssml: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<SpeechSynthesisStream>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SynthesizeSsmlToStreamAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(ssml),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
        ...
        P0: windows_core::Param<VoiceInformation>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetVoice)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn Voice(&self) -> windows_core::Result<VoiceInformation> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Voice)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IInstalledVoicesStatic<R, F: FnOnce(&IInstalledVoicesStatic) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SpeechSynthesizer, IInstalledVoicesStatic> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IInstalledVoicesStatic2<
        R,
        F: FnOnce(&IInstalledVoicesStatic2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SpeechSynthesizer, IInstalledVoicesStatic2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for SpeechSynthesizer {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechSynthesizer>();
}
...
impl SpeechSynthesizerOptions {
    pub fn IncludeWordBoundaryMetadata(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IncludeWordBoundaryMetadata)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIncludeWordBoundaryMetadata(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIncludeWordBoundaryMetadata)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn IncludeSentenceBoundaryMetadata(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IncludeSentenceBoundaryMetadata)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIncludeSentenceBoundaryMetadata(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIncludeSentenceBoundaryMetadata)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn AudioVolume(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AudioVolume)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAudioVolume(&self, value: f64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetAudioVolume)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SpeakingRate(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SpeakingRate)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetSpeakingRate(&self, value: f64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetSpeakingRate)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn AudioPitch(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AudioPitch)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAudioPitch(&self, value: f64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetAudioPitch)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn AppendedSilence(&self) -> windows_core::Result<SpeechAppendedSilence> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AppendedSilence)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAppendedSilence(&self, value: SpeechAppendedSilence) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions3>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetAppendedSilence)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn PunctuationSilence(&self) -> windows_core::Result<SpeechPunctuationSilence> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PunctuationSilence)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetPunctuationSilence(
        &self,
        value: SpeechPunctuationSilence,
    ) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions3>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetPunctuationSilence)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for SpeechSynthesizerOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISpeechSynthesizerOptions>();
}
...
impl windows_core::RuntimeType for VoiceGender {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Media.SpeechSynthesis.VoiceGender;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for VoiceInformation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVoiceInformation>();
}

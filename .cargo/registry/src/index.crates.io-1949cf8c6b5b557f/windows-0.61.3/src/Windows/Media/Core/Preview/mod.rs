windows_core::imp::define_interface!(
    ...
    ISoundLevelBrokerStatics_Vtbl,
    0x6a633961_dbed_464c_a09a_33412f5caa3f
);
...
impl SoundLevelBroker {
    ...
    fn ISoundLevelBrokerStatics<
        R,
        F: FnOnce(&ISoundLevelBrokerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SoundLevelBroker, ISoundLevelBrokerStatics> =

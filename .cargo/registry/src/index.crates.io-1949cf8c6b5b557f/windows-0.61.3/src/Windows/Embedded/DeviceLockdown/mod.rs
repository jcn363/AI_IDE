...
impl DeviceLockdownProfile {
    pub fn GetSupportedLockdownProfiles(
        ...
        Self::IDeviceLockdownProfileStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).GetSupportedLockdownProfiles)(
    ...
    pub fn GetCurrentLockdownProfile() -> windows_core::Result<windows_core::GUID> {
        Self::IDeviceLockdownProfileStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCurrentLockdownProfile)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ApplyLockdownProfileAsync(
        profileid: windows_core::GUID,
    ) -> windows_core::Result<windows_future::IAsyncAction> {
        Self::IDeviceLockdownProfileStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ApplyLockdownProfileAsync)(
                windows_core::Interface::as_raw(this),
                profileid,
                &mut result__,
            )
    ...
    pub fn GetLockdownProfileInformation(
        profileid: windows_core::GUID,
    ) -> windows_core::Result<DeviceLockdownProfileInformation> {
        Self::IDeviceLockdownProfileStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetLockdownProfileInformation)(
                windows_core::Interface::as_raw(this),
                profileid,
                &mut result__,
            )
    ...
    fn IDeviceLockdownProfileStatics<
        R,
        F: FnOnce(&IDeviceLockdownProfileStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for DeviceLockdownProfileInformation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDeviceLockdownProfileInformation>();
}
unsafe impl windows_core::Interface for DeviceLockdownProfileInformation {
    ...
    const IID: windows_core::GUID =
        <IDeviceLockdownProfileInformation as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    ...
    IDeviceLockdownProfileInformation_Vtbl,
    0x7980e14e_45b1_4a96_92fc_62756b739678
);
...
windows_core::imp::define_interface!(
    IDeviceLockdownProfileStatics,
    IDeviceLockdownProfileStatics_Vtbl,
...
pub struct IDeviceLockdownProfileStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetSupportedLockdownProfiles: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetCurrentLockdownProfile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub ApplyLockdownProfileAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetLockdownProfileInformation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,

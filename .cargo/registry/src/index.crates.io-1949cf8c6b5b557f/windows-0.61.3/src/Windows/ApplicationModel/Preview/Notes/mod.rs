windows_core::imp::define_interface!(
    ...
    INotePlacementChangedPreviewEventArgs_Vtbl,
    0x491d57b7_f780_4e7f_a939_9a4caf965214
);
...
windows_core::imp::define_interface!(
    ...
    INoteVisibilityChangedPreviewEventArgs_Vtbl,
    0x0e34649e_3815_4ff6_83b3_a14d17120e24
);
...
windows_core::imp::define_interface!(
    ...
    INotesWindowManagerPreview_Vtbl,
    0xdc2ac23e_4850_4f13_9cc7_ff487efdfcde
);
...
pub struct INotesWindowManagerPreview_Vtbl {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub GetNotePlacement: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
    ...
    pub TrySetNoteSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        super::super::super::Foundation::Size,
        *mut bool,
    ) -> windows_core::HRESULT,
    pub SetFocusToNextView:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    pub SetNotesThumbnailAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SystemLockStateChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveSystemLockStateChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub NotePlacementChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveNotePlacementChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub NoteVisibilityChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveNoteVisibilityChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    INotesWindowManagerPreview2,
    INotesWindowManagerPreview2_Vtbl,
    0xedfe864a_1f54_4b09_9823_ff477f6fa3bc
);
...
pub struct INotesWindowManagerPreview2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ShowNoteRelativeToWithOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        i32,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub ShowNoteWithPlacementWithOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub SetFocusToPreviousView:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(feature = "Graphics_Imaging")]
    pub SetThumbnailImageForTaskSwitcherAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
...
windows_core::imp::define_interface!(
    ...
    INotesWindowManagerPreviewShowNoteOptions_Vtbl,
    0x886b09d6_a6ae_4007_a56d_1ca70c84c0d2
);
...
pub struct INotesWindowManagerPreviewShowNoteOptions_Vtbl {
    ...
    pub ShowWithFocus:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetShowWithFocus:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    INotesWindowManagerPreviewStatics,
    INotesWindowManagerPreviewStatics_Vtbl,
    0x6668cc88_0a8e_4127_a38e_995445868a78
);
...
pub struct INotesWindowManagerPreviewStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetForCurrentApp: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl windows_core::RuntimeType for NotePlacementChangedPreviewEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, INotePlacementChangedPreviewEventArgs>();
}
unsafe impl windows_core::Interface for NotePlacementChangedPreviewEventArgs {
    ...
    const IID: windows_core::GUID =
        <INotePlacementChangedPreviewEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for NoteVisibilityChangedPreviewEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, INoteVisibilityChangedPreviewEventArgs>();
}
unsafe impl windows_core::Interface for NoteVisibilityChangedPreviewEventArgs {
    ...
    const IID: windows_core::GUID =
        <INoteVisibilityChangedPreviewEventArgs as windows_core::Interface>::IID;
}
...
impl NotesWindowManagerPreview {
    pub fn IsScreenLocked(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsScreenLocked)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ShowNote(&self, noteviewid: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ShowNote)(
                windows_core::Interface::as_raw(this),
                noteviewid,
            )
            .ok()
    ...
    pub fn ShowNoteRelativeTo(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ShowNoteRelativeTo)(
                windows_core::Interface::as_raw(this),
                noteviewid,
                anchornoteviewid,
            )
        ...
        P1: windows_core::Param<super::super::super::Storage::Streams::IBuffer>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ShowNoteWithPlacement)(
                windows_core::Interface::as_raw(this),
                noteviewid,
                data.param().abi(),
            )
    ...
    pub fn HideNote(&self, noteviewid: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).HideNote)(
                windows_core::Interface::as_raw(this),
                noteviewid,
            )
            .ok()
    ...
    pub fn GetNotePlacement(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNotePlacement)(
                windows_core::Interface::as_raw(this),
                noteviewid,
                &mut result__,
            )
    ...
    pub fn TrySetNoteSize(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TrySetNoteSize)(
                windows_core::Interface::as_raw(this),
                noteviewid,
                size,
                &mut result__,
    ...
    pub fn SetFocusToNextView(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetFocusToNextView)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetNotesThumbnailAsync<P0>(
        &self,
        thumbnail: P0,
        ...
        P0: windows_core::Param<super::super::super::Storage::Streams::IBuffer>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetNotesThumbnailAsync)(
                windows_core::Interface::as_raw(this),
                thumbnail.param().abi(),
                &mut result__,
            )
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SystemLockStateChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveSystemLockStateChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveSystemLockStateChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NotePlacementChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveNotePlacementChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveNotePlacementChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NoteVisibilityChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveNoteVisibilityChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveNoteVisibilityChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn ShowNoteRelativeToWithOptions<P2>(
        &self,
        noteviewid: i32,
        anchornoteviewid: i32,
        options: P2,
        ...
        P2: windows_core::Param<NotesWindowManagerPreviewShowNoteOptions>,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(this).ShowNoteRelativeToWithOptions)(
                windows_core::Interface::as_raw(this),
                noteviewid,
                anchornoteviewid,
                options.param().abi(),
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ShowNoteWithPlacementWithOptions<P1, P2>(
        &self,
        noteviewid: i32,
        data: P1,
        options: P2,
        ...
        P2: windows_core::Param<NotesWindowManagerPreviewShowNoteOptions>,
    {
        let this = &windows_core::Interface::cast::<INotesWindowManagerPreview2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).ShowNoteWithPlacementWithOptions)(
                windows_core::Interface::as_raw(this),
                noteviewid,
                data.param().abi(),
                options.param().abi(),
    ...
    pub fn SetFocusToPreviousView(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<INotesWindowManagerPreview2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetFocusToPreviousView)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn SetThumbnailImageForTaskSwitcherAsync<P0>(
        &self,
        bitmap: P0,
    ) -> windows_core::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::super::super::Graphics::Imaging::SoftwareBitmap>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetThumbnailImageForTaskSwitcherAsync)(
                windows_core::Interface::as_raw(this),
                bitmap.param().abi(),
                &mut result__,
            )
    ...
    pub fn GetForCurrentApp() -> windows_core::Result<NotesWindowManagerPreview> {
        Self::INotesWindowManagerPreviewStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentApp)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn INotesWindowManagerPreviewStatics<
        R,
        F: FnOnce(&INotesWindowManagerPreviewStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for NotesWindowManagerPreview {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, INotesWindowManagerPreview>();
}
...
impl NotesWindowManagerPreviewShowNoteOptions {
    ...
    pub fn ShowWithFocus(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowWithFocus)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetShowWithFocus(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetShowWithFocus)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
unsafe impl windows_core::Interface for NotesWindowManagerPreviewShowNoteOptions {
    ...
    const IID: windows_core::GUID =
        <INotesWindowManagerPreviewShowNoteOptions as windows_core::Interface>::IID;
}

windows_core::imp::define_interface!(
    IPackageExtension,
    IPackageExtension_Vtbl,
    0xda70c957_7ead_5c3b_9cf0_cc43faf474b4
);
...
windows_core::imp::define_interface!(
    ...
    IPackageExtensionCatalog_Vtbl,
    0x0879dfe6_ac30_58b2_97f9_480b07e75bfa
);
...
windows_core::imp::define_interface!(
    ...
    IPackageExtensionCatalogStatics_Vtbl,
    0x9588ece4_3183_5684_9e5f_27759733ddfe
);
...
windows_core::imp::define_interface!(
    ...
    IPackageExtensionPackageInstalledEventArgs_Vtbl,
    0x3c9b0067_083c_5fe3_bdfb_9feb156b4118
);
...
pub struct IPackageExtensionPackageInstalledEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub PackageExtensionName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Package: unsafe extern "system" fn(
...
windows_core::imp::define_interface!(
    ...
    IPackageExtensionPackageStatusChangedEventArgs_Vtbl,
    0xb8fee20a_680d_5942_876c_5de12df1083c
);
...
windows_core::imp::define_interface!(
    ...
    IPackageExtensionPackageUninstallingEventArgs_Vtbl,
    0x3b8e9cb7_c539_554d_bb33_a84c0bfa3f50
);
...
windows_core::imp::define_interface!(
    ...
    IPackageExtensionPackageUpdatedEventArgs_Vtbl,
    0xfdc31add_16a7_509d_8bc4_fde22e856d2d
);
...
windows_core::imp::define_interface!(
    ...
    IPackageExtensionPackageUpdatingEventArgs_Vtbl,
    0x27ae2ce1_a1d3_532e_8e7e_8b43782fce09
);
...
impl windows_core::RuntimeType for PackageExtension {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPackageExtension>();
}
...
impl PackageExtensionCatalog {
    pub fn FindAll(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<PackageExtension>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAllAsync(
        ...
        windows_future::IAsyncOperation<windows_collections::IVectorView<PackageExtension>>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Open(
        packageextensionname: &windows_core::HSTRING,
    ) -> windows_core::Result<PackageExtensionCatalog> {
        Self::IPackageExtensionCatalogStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Open)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(packageextensionname),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IPackageExtensionCatalogStatics<
        R,
        F: FnOnce(&IPackageExtensionCatalogStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for PackageExtensionCatalog {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPackageExtensionCatalog>();
}
...
impl PackageExtensionPackageInstalledEventArgs {
    pub fn PackageExtensionName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PackageExtensionName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
unsafe impl windows_core::Interface for PackageExtensionPackageInstalledEventArgs {
    ...
    const IID: windows_core::GUID =
        <IPackageExtensionPackageInstalledEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for PackageExtensionPackageStatusChangedEventArgs {
    type Vtable =
        <IPackageExtensionPackageStatusChangedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IPackageExtensionPackageStatusChangedEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for PackageExtensionPackageUninstallingEventArgs {
    type Vtable =
        <IPackageExtensionPackageUninstallingEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IPackageExtensionPackageUninstallingEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for PackageExtensionPackageUpdatedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IPackageExtensionPackageUpdatedEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for PackageExtensionPackageUpdatingEventArgs {
    ...
    const IID: windows_core::GUID =
        <IPackageExtensionPackageUpdatingEventArgs as windows_core::Interface>::IID;
}

...
windows_core::imp::define_interface!(
    IUserDataAccount,
    IUserDataAccount_Vtbl,
    0xb9c4367e_b348_4910_be94_4ad4bba6dea7
);
...
pub struct IUserDataAccount_Vtbl {
    ...
    pub UserDisplayName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetUserDisplayName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OtherAppReadAccess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut UserDataAccountOtherAppReadAccess,
    ) -> windows_core::HRESULT,
    ...
    pub FindEmailMailboxesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "ApplicationModel_Contacts")]
    pub FindContactAnnotationListsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "ApplicationModel_Contacts"))]
...
windows_core::imp::define_interface!(
    IUserDataAccount2,
    IUserDataAccount2_Vtbl,
    0x078cd89f_de82_404b_8195_c8a3ac198f60
);
...
pub struct IUserDataAccount2_Vtbl {
    ...
    pub IsProtectedUnderLock:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IUserDataAccount3,
    IUserDataAccount3_Vtbl,
    0x01533845_6c43_4286_9d69_3e1709a1f266
);
...
pub struct IUserDataAccount3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ExplictReadAccessPackageFamilyNames: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IUserDataAccount4,
    IUserDataAccount4_Vtbl,
    0xc4315210_eae5_4f0a_a8b2_1cca115e008f
);
...
pub struct IUserDataAccount4_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CanShowCreateContactGroup:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetCanShowCreateContactGroup:
    ...
    pub FindUserDataTaskListsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "ApplicationModel_Contacts")]
    pub FindContactGroupsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "ApplicationModel_Contacts"))]
    FindContactGroupsAsync: usize,
    pub TryShowCreateContactGroupAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetIsProtectedUnderLock:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Streams")]
...
windows_core::imp::define_interface!(
    ...
    IUserDataAccountManagerForUser_Vtbl,
    0x56a6e8db_db8f_41ab_a65f_8c5971aac982
);
...
windows_core::imp::define_interface!(
    ...
    IUserDataAccountManagerStatics_Vtbl,
    0x0d9b89ea_1928_4a20_86d5_3c737f7dc3b0
);
...
pub struct IUserDataAccountManagerStatics_Vtbl {
    ...
    pub ShowAccountSettingsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ShowAccountErrorResolverAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IUserDataAccountStore_Vtbl,
    0x2073b0ad_7d0a_4e76_bf45_2368f978a59a
);
...
pub struct IUserDataAccountStore_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub FindAccountsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetAccountAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateAccountAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IUserDataAccountStore2_Vtbl,
    0xb1e0aef7_9560_4631_8af0_061d30161469
);
...
windows_core::imp::define_interface!(
    ...
    IUserDataAccountStore3_Vtbl,
    0x8142c094_f3c9_478b_b117_6585bebb6789
);
...
pub struct IUserDataAccountStore3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateAccountWithPackageRelativeAppIdAndEnterpriseIdAsync:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IUserDataAccountStoreChangedEventArgs_Vtbl,
    0x84e3e2e5_8820_4512_b1f6_2e035be1072c
);
...
impl UserDataAccount {
    ...
    pub fn UserDisplayName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UserDisplayName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetUserDisplayName(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetUserDisplayName)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn SetOtherAppReadAccess(
        &self,
        value: UserDataAccountOtherAppReadAccess,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
    ...
    pub fn FindAppointmentCalendarsAsync(
        ...
        windows_future::IAsyncOperation<
            windows_collections::IVectorView<super::Appointments::AppointmentCalendar>,
        >,
    > {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "ApplicationModel_Email")]
    pub fn FindEmailMailboxesAsync(
        &self,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<
            windows_collections::IVectorView<super::Email::EmailMailbox>,
        >,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindEmailMailboxesAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn FindContactListsAsync(
        ...
        windows_future::IAsyncOperation<
            windows_collections::IVectorView<super::Contacts::ContactList>,
        >,
    > {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "ApplicationModel_Contacts")]
    pub fn FindContactAnnotationListsAsync(
        &self,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<
            windows_collections::IVectorView<super::Contacts::ContactAnnotationList>,
        >,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindContactAnnotationListsAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn IsProtectedUnderLock(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsProtectedUnderLock)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ExplictReadAccessPackageFamilyNames(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ExplictReadAccessPackageFamilyNames)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CanShowCreateContactGroup(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CanShowCreateContactGroup)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetCanShowCreateContactGroup(&self, value: bool) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IUserDataAccount4>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetCanShowCreateContactGroup)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    #[cfg(feature = "ApplicationModel_UserDataTasks")]
    pub fn FindUserDataTaskListsAsync(
        &self,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<
            windows_collections::IVectorView<super::UserDataTasks::UserDataTaskList>,
        >,
    > {
        let this = &windows_core::Interface::cast::<IUserDataAccount4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindUserDataTaskListsAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn FindContactGroupsAsync(
        ...
        windows_future::IAsyncOperation<
            windows_collections::IVectorView<super::Contacts::ContactGroup>,
        >,
    > {
        let this = &windows_core::Interface::cast::<IUserDataAccount4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindContactGroupsAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn TryShowCreateContactGroupAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<windows_core::HSTRING>> {
        let this = &windows_core::Interface::cast::<IUserDataAccount4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryShowCreateContactGroupAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SetIsProtectedUnderLock(&self, value: bool) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IUserDataAccount4>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsProtectedUnderLock)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for UserDataAccount {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataAccount>();
}
...
impl windows_core::RuntimeType for UserDataAccountContentKinds {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds;u4)",
    );
}
impl UserDataAccountContentKinds {
...
impl UserDataAccountManager {
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<UserDataAccountStore>> {
    ...
    pub fn ShowAccountSettingsAsync(
        id: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncAction> {
        Self::IUserDataAccountManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowAccountSettingsAsync)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn ShowAccountErrorResolverAsync(
        id: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncAction> {
        Self::IUserDataAccountManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowAccountErrorResolverAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(id),
                &mut result__,
            )
    ...
    fn IUserDataAccountManagerStatics<
        R,
        F: FnOnce(&IUserDataAccountManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ...
    fn IUserDataAccountManagerStatics2<
        R,
        F: FnOnce(&IUserDataAccountManagerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for UserDataAccountManagerForUser {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataAccountManagerForUser>();
}
unsafe impl windows_core::Interface for UserDataAccountManagerForUser {
    ...
    const IID: windows_core::GUID =
        <IUserDataAccountManagerForUser as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for UserDataAccountOtherAppReadAccess {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.UserDataAccounts.UserDataAccountOtherAppReadAccess;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl UserDataAccountStore {
    pub fn FindAccountsAsync(
        &self,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<windows_collections::IVectorView<UserDataAccount>>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindAccountsAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetAccountAsync(
        &self,
        id: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<UserDataAccount>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAccountAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(id),
                &mut result__,
            )
    ...
    pub fn CreateAccountAsync(
        &self,
        userdisplayname: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<UserDataAccount>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateAccountAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(userdisplayname),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn CreateAccountWithPackageRelativeAppIdAsync(
        &self,
        userdisplayname: &windows_core::HSTRING,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateAccountWithPackageRelativeAppIdAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(userdisplayname),
    ...
    pub fn CreateAccountWithPackageRelativeAppIdAndEnterpriseIdAsync(
        &self,
        userdisplayname: &windows_core::HSTRING,
        packagerelativeappid: &windows_core::HSTRING,
...
impl windows_core::RuntimeType for UserDataAccountStore {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataAccountStore>();
}
...
impl windows_core::RuntimeType for UserDataAccountStoreAccessType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.UserDataAccounts.UserDataAccountStoreAccessType;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for UserDataAccountStoreChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataAccountStoreChangedEventArgs>();
}
unsafe impl windows_core::Interface for UserDataAccountStoreChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IUserDataAccountStoreChangedEventArgs as windows_core::Interface>::IID;
}

...
impl AddAppointmentOperation {
    pub fn AppointmentInformation(&self) -> windows_core::Result<super::Appointment> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).AppointmentInformation)(
    ...
    pub fn SourcePackageFamilyName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SourcePackageFamilyName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn ReportCanceled(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReportCanceled)(windows_core::Interface::as_raw(
                this,
            ))
            .ok()
        }
    ...
    pub fn DismissUI(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).DismissUI)(windows_core::Interface::as_raw(this))
                .ok()
        }
    }
}
impl windows_core::RuntimeType for AddAppointmentOperation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAddAppointmentOperation>();
}
...
impl AppointmentsProviderLaunchActionVerbs {
    pub fn AddAppointment() -> windows_core::Result<windows_core::HSTRING> {
        Self::IAppointmentsProviderLaunchActionVerbsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AddAppointment)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn ReplaceAppointment() -> windows_core::Result<windows_core::HSTRING> {
        Self::IAppointmentsProviderLaunchActionVerbsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReplaceAppointment)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn RemoveAppointment() -> windows_core::Result<windows_core::HSTRING> {
        Self::IAppointmentsProviderLaunchActionVerbsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoveAppointment)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn ShowTimeFrame() -> windows_core::Result<windows_core::HSTRING> {
        Self::IAppointmentsProviderLaunchActionVerbsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowTimeFrame)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn ShowAppointmentDetails() -> windows_core::Result<windows_core::HSTRING> {
        Self::IAppointmentsProviderLaunchActionVerbsStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowAppointmentDetails)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    fn IAppointmentsProviderLaunchActionVerbsStatics<
        R,
        F: FnOnce(&IAppointmentsProviderLaunchActionVerbsStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ...
    fn IAppointmentsProviderLaunchActionVerbsStatics2<
        R,
        F: FnOnce(&IAppointmentsProviderLaunchActionVerbsStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
windows_core::imp::define_interface!(
    ...
    IAddAppointmentOperation_Vtbl,
    0xec4a9af3_620d_4c69_add7_9794e918081f
);
...
pub struct IAddAppointmentOperation_Vtbl {
    ...
    pub AppointmentInformation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SourcePackageFamilyName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IAppointmentsProviderLaunchActionVerbsStatics,
    IAppointmentsProviderLaunchActionVerbsStatics_Vtbl,
    0x36dbba28_9e2e_49c6_8ef7_3ab7a5dcc8b8
);
...
pub struct IAppointmentsProviderLaunchActionVerbsStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AddAppointment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ReplaceAppointment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RemoveAppointment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ShowTimeFrame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IAppointmentsProviderLaunchActionVerbsStatics2,
    IAppointmentsProviderLaunchActionVerbsStatics2_Vtbl,
    0xef9049a4_af21_473c_88dc_76cd89f60ca5
);
...
pub struct IAppointmentsProviderLaunchActionVerbsStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ShowAppointmentDetails: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRemoveAppointmentOperation_Vtbl,
    0x08b66aba_fe33_46cd_a50c_a8ffb3260537
);
...
pub struct IRemoveAppointmentOperation_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AppointmentId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IReplaceAppointmentOperation_Vtbl,
    0xf4903d9b_9e61_4de2_a732_2687c07d1de8
);
...
impl RemoveAppointmentOperation {
    pub fn AppointmentId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AppointmentId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for RemoveAppointmentOperation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoveAppointmentOperation>();
}
...
impl windows_core::RuntimeType for ReplaceAppointmentOperation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IReplaceAppointmentOperation>();
}

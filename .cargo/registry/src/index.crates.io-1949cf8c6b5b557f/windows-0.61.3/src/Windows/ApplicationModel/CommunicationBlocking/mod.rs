...
impl CommunicationBlockingAccessManager {
    pub fn IsBlockingActive() -> windows_core::Result<bool> {
        Self::ICommunicationBlockingAccessManagerStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).IsBlockingActive)(
    ...
    pub fn IsBlockedNumberAsync(
        number: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<bool>> {
        Self::ICommunicationBlockingAccessManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsBlockedNumberAsync)(
                windows_core::Interface::as_raw(this),
        ...
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::ICommunicationBlockingAccessManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowBlockNumbersUI)(
                windows_core::Interface::as_raw(this),
                phonenumbers.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        })
        ...
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::ICommunicationBlockingAccessManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowUnblockNumbersUI)(
                windows_core::Interface::as_raw(this),
                phonenumbers.param().abi(),
                &mut result__,
            )
    ...
    pub fn ShowBlockedCallsUI() -> windows_core::Result<()> {
        Self::ICommunicationBlockingAccessManagerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).ShowBlockedCallsUI)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        })
    ...
    pub fn ShowBlockedMessagesUI() -> windows_core::Result<()> {
        Self::ICommunicationBlockingAccessManagerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).ShowBlockedMessagesUI)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        })
    ...
    fn ICommunicationBlockingAccessManagerStatics<
        R,
        F: FnOnce(&ICommunicationBlockingAccessManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl CommunicationBlockingAppManager {
    pub fn IsCurrentAppActiveBlockingApp() -> windows_core::Result<bool> {
        Self::ICommunicationBlockingAppManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsCurrentAppActiveBlockingApp)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ShowCommunicationBlockingSettingsUI() -> windows_core::Result<()> {
        Self::ICommunicationBlockingAppManagerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).ShowCommunicationBlockingSettingsUI)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        })
    }
    pub fn RequestSetAsActiveBlockingAppAsync(
    ) -> windows_core::Result<windows_future::IAsyncOperation<bool>> {
        Self::ICommunicationBlockingAppManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestSetAsActiveBlockingAppAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn ICommunicationBlockingAppManagerStatics<
        R,
        F: FnOnce(&ICommunicationBlockingAppManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn ICommunicationBlockingAppManagerStatics2<
        R,
        F: FnOnce(&ICommunicationBlockingAppManagerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
windows_core::imp::define_interface!(
    ICommunicationBlockingAccessManagerStatics,
    ICommunicationBlockingAccessManagerStatics_Vtbl,
    0x1c969998_9d2a_5db7_edd5_0ce407fc2595
);
...
pub struct ICommunicationBlockingAccessManagerStatics_Vtbl {
    ...
    pub IsBlockedNumberAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ShowBlockNumbersUI: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut bool,
    ) -> windows_core::HRESULT,
    pub ShowUnblockNumbersUI: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut bool,
    ) -> windows_core::HRESULT,
    pub ShowBlockedCallsUI:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ShowBlockedMessagesUI:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ICommunicationBlockingAppManagerStatics,
    ICommunicationBlockingAppManagerStatics_Vtbl,
    0x77db58ec_14a6_4baa_942a_6a673d999bf2
);
...
pub struct ICommunicationBlockingAppManagerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsCurrentAppActiveBlockingApp:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub ShowCommunicationBlockingSettingsUI:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ICommunicationBlockingAppManagerStatics2,
    ICommunicationBlockingAppManagerStatics2_Vtbl,
    0x14a68edd_ed88_457a_a364_a3634d6f166d
);
...
pub struct ICommunicationBlockingAppManagerStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RequestSetAsActiveBlockingAppAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}

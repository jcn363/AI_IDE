...
windows_core::imp::define_interface!(
    ...
    0x08524908_16ef_45ad_a602_293637d7e61a
);
...
windows_core::imp::define_interface!(
    IResourceLoader2,
    IResourceLoader2_Vtbl,
    0x10eb6ec6_8138_48c1_bc65_e1f14207367c
);
...
windows_core::imp::define_interface!(
    ...
    0xc33a3603_69dc_4285_a077_d5c0e47ccbe8
);
...
pub struct IResourceLoaderFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateResourceLoaderByName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0xbf777ce1_19c8_49c2_953c_47e9227b334e
);
...
pub struct IResourceLoaderStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetStringForReference: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IResourceLoaderStatics2_Vtbl,
    0x0cc04141_6466_4989_9494_0b82dfc53f1f
);
...
pub struct IResourceLoaderStatics2_Vtbl {
    ...
    pub GetForCurrentViewWithName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GetForViewIndependentUseWithName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IResourceLoaderStatics3_Vtbl,
    0x64609dfb_64ac_491b_8100_0e558d61c1d0
);
...
windows_core::imp::define_interface!(
    IResourceLoaderStatics4,
    IResourceLoaderStatics4_Vtbl,
    0x9fb36c32_6c8c_4316_962e_909539b5c259
);
...
pub struct IResourceLoaderStatics4_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetDefaultPriPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl ResourceLoader {
        ...
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        Self::IResourceLoaderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetStringForReference)(
                windows_core::Interface::as_raw(this),
                uri.param().abi(),
                &mut result__,
            )
    ...
    pub fn GetForCurrentViewWithName(
        name: &windows_core::HSTRING,
    ) -> windows_core::Result<ResourceLoader> {
        Self::IResourceLoaderStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentViewWithName)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                &mut result__,
            )
    ...
    pub fn GetForViewIndependentUseWithName(
        name: &windows_core::HSTRING,
    ) -> windows_core::Result<ResourceLoader> {
        Self::IResourceLoaderStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForViewIndependentUseWithName)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                &mut result__,
            )
    ...
    pub fn GetDefaultPriPath(
        packagefullname: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_core::HSTRING> {
        Self::IResourceLoaderStatics4(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefaultPriPath)(
                windows_core::Interface::as_raw(this),
    ...
    fn IResourceLoaderStatics2<
        R,
        F: FnOnce(&IResourceLoaderStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ResourceLoader, IResourceLoaderStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceLoaderStatics3<
        R,
        F: FnOnce(&IResourceLoaderStatics3) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ResourceLoader, IResourceLoaderStatics3> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceLoaderStatics4<
        R,
        F: FnOnce(&IResourceLoaderStatics4) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ResourceLoader, IResourceLoaderStatics4> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}

...
impl AppServiceCatalog {
    pub fn FindAppServiceProvidersAsync(
        appservicename: &windows_core::HSTRING,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<windows_collections::IVectorView<super::AppInfo>>,
    > {
        Self::IAppServiceCatalogStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindAppServiceProvidersAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(appservicename),
                &mut result__,
            )
    ...
    fn IAppServiceCatalogStatics<
        R,
        F: FnOnce(&IAppServiceCatalogStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for AppServiceClosedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppServiceClosedEventArgs>();
}
...
impl windows_core::RuntimeType for AppServiceClosedStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.AppService.AppServiceClosedStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl AppServiceConnection {
    ...
    pub fn AppServiceName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AppServiceName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn SetAppServiceName(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAppServiceName)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn OpenAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<AppServiceConnectionStatus>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SendMessageAsync<P0>(
        &self,
        message: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<AppServiceResponse>>
    where
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestReceived)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ServiceClosed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveServiceClosed(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveServiceClosed)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::System::RemoteSystems::RemoteSystemConnectionRequest>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).OpenRemoteAsync)(
                windows_core::Interface::as_raw(this),
        ...
        P0: windows_core::Param<super::super::System::User>,
    {
        let this = &windows_core::Interface::cast::<IAppServiceConnection2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetUser)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn SendStatelessMessageAsync<P0, P1, P2>(
        connection: P0,
        connectionrequest: P1,
        message: P2,
    ) -> windows_core::Result<windows_future::IAsyncOperation<StatelessAppServiceResponse>>
    where
        ...
        P2: windows_core::Param<super::super::Foundation::Collections::ValueSet>,
    {
        Self::IAppServiceConnectionStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SendStatelessMessageAsync)(
                windows_core::Interface::as_raw(this),
                connection.param().abi(),
                connectionrequest.param().abi(),
                message.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IAppServiceConnectionStatics<
        R,
        F: FnOnce(&IAppServiceConnectionStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for AppServiceConnection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppServiceConnection>();
}
...
impl windows_core::RuntimeType for AppServiceConnectionStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.AppService.AppServiceConnectionStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for AppServiceDeferral {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppServiceDeferral>();
}
...
impl AppServiceRequest {
    ...
    pub fn SendResponseAsync<P0>(
        &self,
        message: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<AppServiceResponseStatus>>
    where
        P0: windows_core::Param<super::super::Foundation::Collections::ValueSet>,
    {
        let this = self;
...
impl windows_core::RuntimeType for AppServiceRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppServiceRequest>();
}
...
impl windows_core::RuntimeType for AppServiceRequestReceivedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppServiceRequestReceivedEventArgs>();
}
unsafe impl windows_core::Interface for AppServiceRequestReceivedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IAppServiceRequestReceivedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for AppServiceResponse {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppServiceResponse>();
}
...
impl windows_core::RuntimeType for AppServiceResponseStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.AppService.AppServiceResponseStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl AppServiceTriggerDetails {
    ...
    pub fn AppServiceConnection(&self) -> windows_core::Result<AppServiceConnection> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AppServiceConnection)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn IsRemoteSystemConnection(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsRemoteSystemConnection)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CheckCallerForCapabilityAsync(
        &self,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CheckCallerForCapabilityAsync)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn CallerRemoteConnectionToken(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CallerRemoteConnectionToken)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for AppServiceTriggerDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppServiceTriggerDetails>();
}
...
windows_core::imp::define_interface!(
    IAppServiceCatalogStatics,
    IAppServiceCatalogStatics_Vtbl,
    0xef0d2507_d132_4c85_8395_3c31d5a1e941
);
...
pub struct IAppServiceCatalogStatics_Vtbl {
    ...
    pub FindAppServiceProvidersAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IAppServiceClosedEventArgs_Vtbl,
    0xde6016f6_cb03_4d35_ac8d_cc6303239731
);
...
pub struct IAppServiceClosedEventArgs_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut AppServiceClosedStatus,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IAppServiceConnection,
    IAppServiceConnection_Vtbl,
    0x9dd474a2_871f_4d52_89a9_9e090531bd27
);
...
pub struct IAppServiceConnection_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AppServiceName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetAppServiceName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub RequestReceived: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    ...
    pub ServiceClosed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveServiceClosed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IAppServiceConnection2,
    IAppServiceConnection2_Vtbl,
    0x8bdfcd5f_2302_4fbd_8061_52511c2f8bf9
);
...
pub struct IAppServiceConnection2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "System_RemoteSystems")]
    pub OpenRemoteAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    User: usize,
    #[cfg(feature = "System")]
    pub SetUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "System"))]
...
windows_core::imp::define_interface!(
    IAppServiceConnectionStatics,
    IAppServiceConnectionStatics_Vtbl,
    0xadc56ce9_d408_5673_8637_827a4b274168
);
...
pub struct IAppServiceConnectionStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(all(feature = "Foundation_Collections", feature = "System_RemoteSystems"))]
    pub SendStatelessMessageAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IAppServiceRequest,
    IAppServiceRequest_Vtbl,
    0x20e58d9d_18de_4b01_80ba_90a76204e3c8
);
...
windows_core::imp::define_interface!(
    ...
    IAppServiceRequestReceivedEventArgs_Vtbl,
...
windows_core::imp::define_interface!(
    ...
    0x8d503cec_9aa3_4e68_9559_9de63e372ce4
);
...
pub struct IAppServiceResponse_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut AppServiceResponseStatus,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IAppServiceTriggerDetails,
    IAppServiceTriggerDetails_Vtbl,
    0x88a2dcac_ad28_41b8_80bb_bdf1b2169e19
);
...
pub struct IAppServiceTriggerDetails_Vtbl {
    ...
    pub AppServiceConnection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IAppServiceTriggerDetails2_Vtbl,
    0xe83d54b2_28cc_43f2_b465_c0482e59e2dc
);
...
pub struct IAppServiceTriggerDetails2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsRemoteSystemConnection:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IAppServiceTriggerDetails3,
    IAppServiceTriggerDetails3_Vtbl,
...
pub struct IAppServiceTriggerDetails3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CheckCallerForCapabilityAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IAppServiceTriggerDetails4_Vtbl,
    0x1185b180_8861_5e30_ab55_1cf4d08bbf6d
);
...
pub struct IAppServiceTriggerDetails4_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CallerRemoteConnectionToken: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IStatelessAppServiceResponse_Vtbl,
    0x43754af7_a9ec_52fe_82e7_939b68dc9388
);
...
pub struct IStatelessAppServiceResponse_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut StatelessAppServiceResponseStatus,
    ) -> windows_core::HRESULT,
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for StatelessAppServiceResponse {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IStatelessAppServiceResponse>();
}

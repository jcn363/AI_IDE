windows_core::imp::define_interface!(
    ...
    IPhoneCallBlockedTriggerDetails_Vtbl,
    0xa4a690a2_e4c1_427f_864e_e470477ddb67
);
...
pub struct IPhoneCallBlockedTriggerDetails_Vtbl {
    ...
    pub CallBlockedReason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PhoneCallBlockedReason,
    ) -> windows_core::HRESULT,
}
...
pub struct IPhoneIncomingCallDismissedTriggerDetails_Vtbl {
    ...
    pub DismissalTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Foundation::DateTime,
    ) -> windows_core::HRESULT,
    pub TextReplyMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Reason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PhoneIncomingCallDismissedReason,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPhoneIncomingCallNotificationTriggerDetails,
    IPhoneIncomingCallNotificationTriggerDetails_Vtbl,
    0x2b0e6044_9b32_5d42_8222_d2812e39fb21
);
...
windows_core::imp::define_interface!(
    ...
    IPhoneLineChangedTriggerDetails_Vtbl,
    0xc6d321e7_d11d_40d8_b2b7_e40a01d66249
);
...
pub struct IPhoneLineChangedTriggerDetails_Vtbl {
    ...
    pub ChangeType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PhoneLineChangeKind,
    ) -> windows_core::HRESULT,
    pub HasLinePropertyChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        PhoneLineProperties,
        *mut bool,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IPhoneNewVoicemailMessageTriggerDetails_Vtbl,
    0x13a8c01b_b831_48d3_8ba9_8d22a6580dcf
);
...
pub struct IPhoneNewVoicemailMessageTriggerDetails_Vtbl {
    ...
    pub OperatorMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl windows_core::RuntimeType for PhoneCallBlockedReason {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Calls.Background.PhoneCallBlockedReason;i4)",
    );
}
#[repr(transparent)]
...
impl PhoneCallBlockedTriggerDetails {
    ...
    pub fn CallBlockedReason(&self) -> windows_core::Result<PhoneCallBlockedReason> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CallBlockedReason)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for PhoneCallBlockedTriggerDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPhoneCallBlockedTriggerDetails>();
}
unsafe impl windows_core::Interface for PhoneCallBlockedTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IPhoneCallBlockedTriggerDetails as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for PhoneCallOriginDataRequestTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IPhoneCallOriginDataRequestTriggerDetails as windows_core::Interface>::IID;
}
#[cfg(feature = "deprecated")]
...
impl windows_core::RuntimeType for PhoneIncomingCallDismissedReason {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Calls.Background.PhoneIncomingCallDismissedReason;i4)",
    );
}
#[cfg(feature = "deprecated")]
#[repr(transparent)]
...
impl PhoneIncomingCallDismissedTriggerDetails {
    ...
    pub fn DismissalTime(&self) -> windows_core::Result<super::super::super::Foundation::DateTime> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DismissalTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn TextReplyMessage(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TextReplyMessage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
unsafe impl windows_core::Interface for PhoneIncomingCallDismissedTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IPhoneIncomingCallDismissedTriggerDetails as windows_core::Interface>::IID;
}
#[cfg(feature = "deprecated")]
...
unsafe impl windows_core::Interface for PhoneIncomingCallNotificationTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IPhoneIncomingCallNotificationTriggerDetails as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for PhoneLineChangeKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Calls.Background.PhoneLineChangeKind;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl PhoneLineChangedTriggerDetails {
    ...
    pub fn HasLinePropertyChanged(
        &self,
        lineproperty: PhoneLineProperties,
    ) -> windows_core::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HasLinePropertyChanged)(
                windows_core::Interface::as_raw(this),
                lineproperty,
                &mut result__,
            )
...
impl windows_core::RuntimeType for PhoneLineChangedTriggerDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPhoneLineChangedTriggerDetails>();
}
unsafe impl windows_core::Interface for PhoneLineChangedTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IPhoneLineChangedTriggerDetails as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for PhoneLineProperties {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Calls.Background.PhoneLineProperties;u4)",
    );
}
impl PhoneLineProperties {
...
impl PhoneNewVoicemailMessageTriggerDetails {
    ...
    pub fn OperatorMessage(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).OperatorMessage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for PhoneNewVoicemailMessageTriggerDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPhoneNewVoicemailMessageTriggerDetails>(
        );
}
unsafe impl windows_core::Interface for PhoneNewVoicemailMessageTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IPhoneNewVoicemailMessageTriggerDetails as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for PhoneTriggerType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Calls.Background.PhoneTriggerType;i4)",
    );
}

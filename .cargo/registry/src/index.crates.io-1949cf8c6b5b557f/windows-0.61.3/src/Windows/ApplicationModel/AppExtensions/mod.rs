...
impl AppExtension {
    ...
    pub fn GetExtensionPropertiesAsync(
        ...
        windows_future::IAsyncOperation<super::super::Foundation::Collections::IPropertySet>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetExtensionPropertiesAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetPublicFolderAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::super::Storage::StorageFolder>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPublicFolderAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetExtensionProperties(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetExtensionProperties)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetPublicPath(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPublicPath)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn GetPublicFolder(&self) -> windows_core::Result<super::super::Storage::StorageFolder> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPublicFolder)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for AppExtension {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppExtension>();
}
...
impl AppExtensionCatalog {
    pub fn FindAllAsync(
        ...
        windows_future::IAsyncOperation<windows_collections::IVectorView<AppExtension>>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestRemovePackageAsync(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestRemovePackageAsync)(
                windows_core::Interface::as_raw(this),
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PackageInstalled)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemovePackageInstalled(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemovePackageInstalled)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PackageUpdated)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemovePackageUpdated(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemovePackageUpdated)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn Open(
        appextensionname: &windows_core::HSTRING,
    ) -> windows_core::Result<AppExtensionCatalog> {
        Self::IAppExtensionCatalogStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Open)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(appextensionname),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    ...
    fn IAppExtensionCatalogStatics<
        R,
        F: FnOnce(&IAppExtensionCatalogStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for AppExtensionCatalog {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppExtensionCatalog>();
}
...
impl AppExtensionPackageInstalledEventArgs {
    pub fn AppExtensionName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AppExtensionName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn Extensions(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<AppExtension>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for AppExtensionPackageInstalledEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppExtensionPackageInstalledEventArgs>();
}
unsafe impl windows_core::Interface for AppExtensionPackageInstalledEventArgs {
    ...
    const IID: windows_core::GUID =
        <IAppExtensionPackageInstalledEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for AppExtensionPackageStatusChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IAppExtensionPackageStatusChangedEventArgs as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for AppExtensionPackageUninstallingEventArgs {
    ...
    const IID: windows_core::GUID =
        <IAppExtensionPackageUninstallingEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for AppExtensionPackageUpdatedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppExtensionPackageUpdatedEventArgs>();
}
unsafe impl windows_core::Interface for AppExtensionPackageUpdatedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IAppExtensionPackageUpdatedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for AppExtensionPackageUpdatingEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppExtensionPackageUpdatingEventArgs>();
}
unsafe impl windows_core::Interface for AppExtensionPackageUpdatingEventArgs {
    ...
    const IID: windows_core::GUID =
        <IAppExtensionPackageUpdatingEventArgs as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    IAppExtension,
    IAppExtension_Vtbl,
    0x8450902c_15ed_4faf_93ea_2237bbf8cbd6
);
...
pub struct IAppExtension_Vtbl {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub GetExtensionPropertiesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Search")]
    pub GetPublicFolderAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IAppExtension2,
    IAppExtension2_Vtbl,
    0xab3b15f0_14f9_4b9f_9419_a349a242ef38
);
...
windows_core::imp::define_interface!(
    IAppExtension3,
    IAppExtension3_Vtbl,
    0x5923c101_aa38_4009_84d9_5b54a0df30ae
);
...
pub struct IAppExtension3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Foundation_Collections")]
    pub GetExtensionProperties: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Foundation_Collections"))]
    GetExtensionProperties: usize,
    pub GetPublicPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Search")]
    pub GetPublicFolder: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Search"))]
...
windows_core::imp::define_interface!(
    ...
    IAppExtensionCatalog_Vtbl,
    0x97872032_8426_4ad1_9084_92e88c2da200
);
...
pub struct IAppExtensionCatalog_Vtbl {
    ...
    pub RequestRemovePackageAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PackageInstalled: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePackageInstalled:
    ...
    pub RemovePackageUpdating:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub PackageUpdated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePackageUpdated:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IAppExtensionCatalog2,
    IAppExtensionCatalog2_Vtbl,
    0x50056eba_58b6_4147_b5a5_8feca6dfb49d
);
...
windows_core::imp::define_interface!(
    ...
    0x3c36668a_5f18_4f0b_9ce5_cab61d196f11
);
...
windows_core::imp::define_interface!(
    ...
    IAppExtensionPackageInstalledEventArgs_Vtbl,
    0x39e59234_3351_4a8d_9745_e7d3dd45bc48
);
...
pub struct IAppExtensionPackageInstalledEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AppExtensionName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Package: unsafe extern "system" fn(
...
windows_core::imp::define_interface!(
    IAppExtensionPackageStatusChangedEventArgs,
    IAppExtensionPackageStatusChangedEventArgs_Vtbl,
    0x1ce17433_1153_44fd_87b1_8ae1050303df
);
...
windows_core::imp::define_interface!(
    IAppExtensionPackageUninstallingEventArgs,
    IAppExtensionPackageUninstallingEventArgs_Vtbl,
    0x60f160c5_171e_40ff_ae98_ab2c20dd4d75
);
...
windows_core::imp::define_interface!(
    ...
    IAppExtensionPackageUpdatedEventArgs_Vtbl,
    0x3a83c43f_797e_44b5_ba24_a4c8b5a543d7
);
...
windows_core::imp::define_interface!(
    ...
    IAppExtensionPackageUpdatingEventArgs_Vtbl,
    0x7ed59329_1a65_4800_a700_b321009e306a
);

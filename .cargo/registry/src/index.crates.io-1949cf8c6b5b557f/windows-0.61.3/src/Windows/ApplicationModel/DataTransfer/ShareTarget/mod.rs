windows_core::imp::define_interface!(
    IQuickLink,
    IQuickLink_Vtbl,
    0x603e4308_f0be_4adc_acc9_8b27ab9cf556
);
...
pub struct IQuickLink_Vtbl {
    ...
    pub SupportedDataFormats: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SupportedFileTypes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub struct IShareOperation_Vtbl {
    ...
    pub QuickLinkId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RemoveThisQuickLink:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ReportStarted: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ReportDataRetrieved:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ReportSubmittedBackgroundTask:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ReportCompletedWithQuickLink: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IShareOperation2,
    IShareOperation2_Vtbl,
    0x0ffb97c1_9778_4a09_8e5b_cb5e482d0555
);
...
windows_core::imp::define_interface!(
    IShareOperation3,
    IShareOperation3_Vtbl,
    0x5ef6b382_b7a7_4571_a2a6_994a034988b2
);
...
impl QuickLink {
    ...
    pub fn Thumbnail(
        &self,
    ) -> windows_core::Result<super::super::super::Storage::Streams::RandomAccessStreamReference>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportedDataFormats(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedDataFormats)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SupportedFileTypes(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedFileTypes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for QuickLink {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IQuickLink>();
}
...
impl ShareOperation {
    ...
    pub fn QuickLinkId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).QuickLinkId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn RemoveThisQuickLink(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveThisQuickLink)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    pub fn ReportStarted(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReportStarted)(windows_core::Interface::as_raw(
                this,
            ))
            .ok()
        }
    ...
    pub fn ReportDataRetrieved(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReportDataRetrieved)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    pub fn ReportSubmittedBackgroundTask(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReportSubmittedBackgroundTask)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
        ...
        P0: windows_core::Param<QuickLink>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReportCompletedWithQuickLink)(
                windows_core::Interface::as_raw(this),
                quicklink.param().abi(),
            )
            .ok()
    ...
    pub fn Contacts(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<super::super::Contacts::Contact>>
    {
...
impl windows_core::RuntimeType for ShareOperation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IShareOperation>();
}

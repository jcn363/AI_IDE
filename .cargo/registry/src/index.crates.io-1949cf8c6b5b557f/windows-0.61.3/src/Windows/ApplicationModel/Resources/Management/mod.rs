windows_core::imp::define_interface!(
    ...
    0x0e619ef3_faec_4414_a9d7_54acd5953f29
);
...
windows_core::imp::define_interface!(
    ...
    0xdae3bb9b_d304_497f_a168_a340042c8adb
);
...
windows_core::imp::define_interface!(
    ...
    0x2d4cf9a5_e32f_4ab2_8748_96350a016da3
);
#[cfg(feature = "deprecated")]
...
pub struct IResourceIndexer_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IndexFilePath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IndexFileContentsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0xb8de3f09_31cd_4d97_bd30_8d39f742bc61
);
#[cfg(feature = "deprecated")]
...
pub struct IResourceIndexerFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateResourceIndexer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x6040f18d_d5e5_4b60_9201_cd279cbcfed9
);
#[cfg(feature = "deprecated")]
...
pub struct IResourceIndexerFactory2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateResourceIndexerWithExtension: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
impl IndexedResourceCandidate {
    ...
    pub fn Qualifiers(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<IndexedResourceQualifier>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for IndexedResourceCandidate {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IIndexedResourceCandidate>();
}
...
impl windows_core::RuntimeType for IndexedResourceQualifier {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IIndexedResourceQualifier>();
}
...
impl windows_core::RuntimeType for IndexedResourceType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Resources.Management.IndexedResourceType;i4)",
    );
}
#[cfg(feature = "deprecated")]
#[repr(transparent)]
...
impl ResourceIndexer {
        ...
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IndexFilePath)(
                windows_core::Interface::as_raw(this),
                filepath.param().abi(),
                &mut result__,
            )
    ...
    pub fn IndexFileContentsAsync<P0>(
        &self,
        file: P0,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<windows_collections::IVectorView<IndexedResourceCandidate>>,
    >
    where
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IndexFileContentsAsync)(
                windows_core::Interface::as_raw(this),
                file.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IResourceIndexerFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateResourceIndexer)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn CreateResourceIndexerWithExtension<P0, P1>(
        projectroot: P0,
        extensiondllpath: P1,
    ) -> windows_core::Result<ResourceIndexer>
    where
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
        P1: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IResourceIndexerFactory2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateResourceIndexerWithExtension)(
                windows_core::Interface::as_raw(this),
                projectroot.param().abi(),
    ...
    fn IResourceIndexerFactory<
        R,
        F: FnOnce(&IResourceIndexerFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ResourceIndexer, IResourceIndexerFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceIndexerFactory2<
        R,
        F: FnOnce(&IResourceIndexerFactory2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ResourceIndexer, IResourceIndexerFactory2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl windows_core::RuntimeType for ResourceIndexer {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IResourceIndexer>();
}
#[cfg(feature = "deprecated")]

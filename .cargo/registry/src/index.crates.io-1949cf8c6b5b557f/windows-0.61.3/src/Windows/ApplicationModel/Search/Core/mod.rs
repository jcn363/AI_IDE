windows_core::imp::define_interface!(
    ...
    IRequestingFocusOnKeyboardInputEventArgs_Vtbl,
    0xa1195f27_b1a7_41a2_879d_6a68687e5985
);
...
windows_core::imp::define_interface!(
    ISearchSuggestion,
    ISearchSuggestion_Vtbl,
    0x5b5554b0_1527_437b_95c5_8d18d2b8af55
);
...
pub struct ISearchSuggestion_Vtbl {
    ...
    Image: usize,
    pub ImageAlternateText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ISearchSuggestionManager_Vtbl,
    0x3f0c50a1_cb9d_497b_b500_3c04ac959ad2
);
...
pub struct ISearchSuggestionManager_Vtbl {
    ...
    pub SetQueryWithLanguage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetQueryWithSearchQueryLinguisticDetails:
    ...
    pub Suggestions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Foundation_Collections"))]
    Suggestions: usize,
    pub AddToHistory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AddToHistoryWithLanguage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub RequestingFocusOnKeyboardInput: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRequestingFocusOnKeyboardInput:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISearchSuggestionsRequestedEventArgs,
    ISearchSuggestionsRequestedEventArgs_Vtbl,
...
unsafe impl windows_core::Interface for RequestingFocusOnKeyboardInputEventArgs {
    ...
    const IID: windows_core::GUID =
        <IRequestingFocusOnKeyboardInputEventArgs as windows_core::Interface>::IID;
}
...
impl SearchSuggestion {
    ...
    pub fn ImageAlternateText(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ImageAlternateText)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for SearchSuggestion {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchSuggestion>();
}
...
impl SearchSuggestionManager {
    ...
    pub fn SetQuery(&self, querytext: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetQuery)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(querytext),
            )
            .ok()
        }
    }
    pub fn SetQueryWithLanguage(
        &self,
        querytext: &windows_core::HSTRING,
        language: &windows_core::HSTRING,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetQueryWithLanguage)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(querytext),
    ...
    pub fn SetQueryWithSearchQueryLinguisticDetails<P2>(
        &self,
        querytext: &windows_core::HSTRING,
        language: &windows_core::HSTRING,
        linguisticdetails: P2,
    ) -> windows_core::Result<()>
    where
        P2: windows_core::Param<super::SearchQueryLinguisticDetails>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetQueryWithSearchQueryLinguisticDetails)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(querytext),
                core::mem::transmute_copy(language),
                linguisticdetails.param().abi(),
            )
            .ok()
        }
    }
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Suggestions)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn AddToHistory(&self, querytext: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AddToHistory)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(querytext),
            )
            .ok()
    ...
    pub fn AddToHistoryWithLanguage(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AddToHistoryWithLanguage)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(querytext),
                core::mem::transmute_copy(language),
            )
    ...
    pub fn ClearHistory(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ClearHistory)(windows_core::Interface::as_raw(
                this,
            ))
            .ok()
        }
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestingFocusOnKeyboardInput)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveRequestingFocusOnKeyboardInput(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveRequestingFocusOnKeyboardInput)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for SearchSuggestionManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchSuggestionManager>();
}
...
impl windows_core::RuntimeType for SearchSuggestionsRequestedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchSuggestionsRequestedEventArgs>();
}
unsafe impl windows_core::Interface for SearchSuggestionsRequestedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ISearchSuggestionsRequestedEventArgs as windows_core::Interface>::IID;
}

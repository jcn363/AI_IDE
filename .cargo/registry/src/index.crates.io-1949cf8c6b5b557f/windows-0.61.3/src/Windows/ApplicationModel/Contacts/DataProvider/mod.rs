...
impl ContactDataProviderConnection {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateOrUpdateContactRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveCreateOrUpdateContactRequested(&self, token: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IContactDataProviderConnection2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveCreateOrUpdateContactRequested)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeleteContactRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveDeleteContactRequested(&self, token: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IContactDataProviderConnection2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDeleteContactRequested)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for ContactDataProviderConnection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IContactDataProviderConnection>();
}
unsafe impl windows_core::Interface for ContactDataProviderConnection {
    ...
    const IID: windows_core::GUID =
        <IContactDataProviderConnection as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for ContactDataProviderTriggerDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IContactDataProviderTriggerDetails>();
}
unsafe impl windows_core::Interface for ContactDataProviderTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IContactDataProviderTriggerDetails as windows_core::Interface>::IID;
}
        ...
        P0: windows_core::Param<super::Contact>,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).ReportCompletedAsync)(
                windows_core::Interface::as_raw(this),
                createdorupdatedcontact.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
unsafe impl windows_core::Interface for ContactListCreateOrUpdateContactRequest {
    ...
    const IID: windows_core::GUID =
        <IContactListCreateOrUpdateContactRequest as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for ContactListCreateOrUpdateContactRequestEventArgs {
    type Vtable =
        <IContactListCreateOrUpdateContactRequestEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IContactListCreateOrUpdateContactRequestEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for ContactListDeleteContactRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IContactListDeleteContactRequest>();
}
unsafe impl windows_core::Interface for ContactListDeleteContactRequest {
    ...
    const IID: windows_core::GUID =
        <IContactListDeleteContactRequest as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for ContactListDeleteContactRequestEventArgs {
    ...
    const IID: windows_core::GUID =
        <IContactListDeleteContactRequestEventArgs as windows_core::Interface>::IID;
}
...
impl ContactListServerSearchReadBatchRequest {
    ...
    pub fn ReportFailedAsync(
        &self,
        batchstatus: super::ContactBatchStatus,
    ) -> windows_core::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
unsafe impl windows_core::Interface for ContactListServerSearchReadBatchRequest {
    ...
    const IID: windows_core::GUID =
        <IContactListServerSearchReadBatchRequest as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for ContactListServerSearchReadBatchRequestEventArgs {
    type Vtable =
        <IContactListServerSearchReadBatchRequestEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IContactListServerSearchReadBatchRequestEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for ContactListSyncManagerSyncRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IContactListSyncManagerSyncRequest>();
}
unsafe impl windows_core::Interface for ContactListSyncManagerSyncRequest {
    ...
    const IID: windows_core::GUID =
        <IContactListSyncManagerSyncRequest as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for ContactListSyncManagerSyncRequestEventArgs {
    ...
    const IID: windows_core::GUID =
        <IContactListSyncManagerSyncRequestEventArgs as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    ...
    IContactDataProviderConnection_Vtbl,
    0x1a398a52_8c9d_4d6f_a4e0_111e9a125a30
);
...
windows_core::imp::define_interface!(
    ...
    IContactDataProviderConnection2_Vtbl,
    0xa1d327b0_196c_4bfd_8f0f_c68d67f249d3
);
...
pub struct IContactDataProviderConnection2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateOrUpdateContactRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveCreateOrUpdateContactRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub DeleteContactRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveDeleteContactRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IContactDataProviderTriggerDetails,
    IContactDataProviderTriggerDetails_Vtbl,
    0x527104be_3c62_43c8_9ae7_db531685cd99
);
...
windows_core::imp::define_interface!(
    ...
    0xb4af411f_c849_47d0_b119_91cf605b2f2a
);
...
windows_core::imp::define_interface!(
    IContactListCreateOrUpdateContactRequestEventArgs,
    IContactListCreateOrUpdateContactRequestEventArgs_Vtbl,
    0x851c1690_1a51_4b0c_aeef_1240ac5bed75
);
...
windows_core::imp::define_interface!(
    ...
    IContactListDeleteContactRequest_Vtbl,
    0x5e114687_ce03_4de5_8557_9ccf552d472a
);
...
windows_core::imp::define_interface!(
    IContactListDeleteContactRequestEventArgs,
    IContactListDeleteContactRequestEventArgs_Vtbl,
    0xb22054a1_e8fa_4db5_9389_2d12ee7d15ee
);
...
windows_core::imp::define_interface!(
    ...
    0xba776a97_4030_4925_9fb4_143b295e653b
);
...
windows_core::imp::define_interface!(
    ...
    IContactListSyncManagerSyncRequest_Vtbl,
    0x3c0e57a4_c4e7_4970_9a8f_9a66a2bb6c1a
);
...
windows_core::imp::define_interface!(
    ...
    0x158e4dac_446d_4f10_afc2_02683ec533a6
);

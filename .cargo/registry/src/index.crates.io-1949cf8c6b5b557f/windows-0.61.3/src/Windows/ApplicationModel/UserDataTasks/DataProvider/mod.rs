windows_core::imp::define_interface!(
    ...
    0x9ff39d1d_a447_428b_afe9_e5402bdeb041
);
...
pub struct IUserDataTaskDataProviderConnection_Vtbl {
    ...
    pub CreateOrUpdateTaskRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveCreateOrUpdateTaskRequested:
    ...
    pub RemoveSyncRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub SkipOccurrenceRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveSkipOccurrenceRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub CompleteTaskRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveCompleteTaskRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub DeleteTaskRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveDeleteTaskRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0xf65e14a3_1a42_49da_8552_2873e52c55eb
);
...
pub struct IUserDataTaskListCompleteTaskRequest_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub TaskListId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0xd77c393d_4cf2_48ad_87fd_963f0eaa7a95
);
...
windows_core::imp::define_interface!(
    ...
    0x2133772c_55c2_4300_8279_04326e07cce4
);
...
windows_core::imp::define_interface!(
    ...
    0x12c55a52_e378_419b_ae38_a5e9e604476e
);
...
windows_core::imp::define_interface!(
    ...
    0x4b863c68_7657_4f3d_b074_d47ec8df07e7
);
...
windows_core::imp::define_interface!(
    ...
    0x6063dad9_f562_4145_8efe_d50078c92b7f
);
...
windows_core::imp::define_interface!(
    ...
    0xab87e34d_1cd3_431c_9f58_089aa4338d85
);
...
windows_core::imp::define_interface!(
    ...
    0x7a3b924a_cc2f_4e7b_aacd_a5b9d29cfa4e
);
...
windows_core::imp::define_interface!(
    ...
    0x40a73807_7590_4149_ae19_b211431a9f48
);
...
windows_core::imp::define_interface!(
    ...
    0x8ead1c12_768e_43bd_8385_5cdc351ffdea
);
...
impl UserDataTaskDataProviderConnection {
        ...
        >,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).CreateOrUpdateTaskRequested)(
    ...
    pub fn RemoveCreateOrUpdateTaskRequested(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveCreateOrUpdateTaskRequested)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SkipOccurrenceRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveSkipOccurrenceRequested(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveSkipOccurrenceRequested)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CompleteTaskRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveCompleteTaskRequested(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveCompleteTaskRequested)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeleteTaskRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveDeleteTaskRequested(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDeleteTaskRequested)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for UserDataTaskDataProviderConnection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataTaskDataProviderConnection>();
}
unsafe impl windows_core::Interface for UserDataTaskDataProviderConnection {
    ...
    const IID: windows_core::GUID =
        <IUserDataTaskDataProviderConnection as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for UserDataTaskDataProviderTriggerDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataTaskDataProviderTriggerDetails>(
        );
}
unsafe impl windows_core::Interface for UserDataTaskDataProviderTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IUserDataTaskDataProviderTriggerDetails as windows_core::Interface>::IID;
}
...
impl UserDataTaskListCompleteTaskRequest {
    pub fn TaskListId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TaskListId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn ReportCompletedAsync(
        &self,
        completedtaskid: &windows_core::HSTRING,
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).ReportCompletedAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(completedtaskid),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
impl windows_core::RuntimeType for UserDataTaskListCompleteTaskRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataTaskListCompleteTaskRequest>();
}
unsafe impl windows_core::Interface for UserDataTaskListCompleteTaskRequest {
    ...
    const IID: windows_core::GUID =
        <IUserDataTaskListCompleteTaskRequest as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for UserDataTaskListCompleteTaskRequestEventArgs {
    type Vtable =
        <IUserDataTaskListCompleteTaskRequestEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IUserDataTaskListCompleteTaskRequestEventArgs as windows_core::Interface>::IID;
}
...
impl UserDataTaskListCreateOrUpdateTaskRequest {
    ...
    pub fn ReportCompletedAsync<P0>(
        &self,
        createdorupdateduserdatatask: P0,
    ) -> windows_core::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::UserDataTask>,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).ReportCompletedAsync)(
                windows_core::Interface::as_raw(this),
                createdorupdateduserdatatask.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
unsafe impl windows_core::Interface for UserDataTaskListCreateOrUpdateTaskRequest {
    ...
    const IID: windows_core::GUID =
        <IUserDataTaskListCreateOrUpdateTaskRequest as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for UserDataTaskListCreateOrUpdateTaskRequestEventArgs {
    type Vtable =
        <IUserDataTaskListCreateOrUpdateTaskRequestEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IUserDataTaskListCreateOrUpdateTaskRequestEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for UserDataTaskListDeleteTaskRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataTaskListDeleteTaskRequest>();
}
unsafe impl windows_core::Interface for UserDataTaskListDeleteTaskRequest {
    ...
    const IID: windows_core::GUID =
        <IUserDataTaskListDeleteTaskRequest as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for UserDataTaskListDeleteTaskRequestEventArgs {
    ...
    const IID: windows_core::GUID =
        <IUserDataTaskListDeleteTaskRequestEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for UserDataTaskListSkipOccurrenceRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataTaskListSkipOccurrenceRequest>();
}
unsafe impl windows_core::Interface for UserDataTaskListSkipOccurrenceRequest {
    ...
    const IID: windows_core::GUID =
        <IUserDataTaskListSkipOccurrenceRequest as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for UserDataTaskListSkipOccurrenceRequestEventArgs {
    type Vtable =
        <IUserDataTaskListSkipOccurrenceRequestEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IUserDataTaskListSkipOccurrenceRequestEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for UserDataTaskListSyncManagerSyncRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataTaskListSyncManagerSyncRequest>(
        );
}
unsafe impl windows_core::Interface for UserDataTaskListSyncManagerSyncRequest {
    ...
    const IID: windows_core::GUID =
        <IUserDataTaskListSyncManagerSyncRequest as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for UserDataTaskListSyncManagerSyncRequestEventArgs {
    type Vtable =
        <IUserDataTaskListSyncManagerSyncRequestEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IUserDataTaskListSyncManagerSyncRequestEventArgs as windows_core::Interface>::IID;
}

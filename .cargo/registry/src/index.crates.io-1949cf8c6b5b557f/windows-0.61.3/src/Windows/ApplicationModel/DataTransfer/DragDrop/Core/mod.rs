...
impl CoreDragDropManager {
    ...
    fn ICoreDragDropManagerStatics<
        R,
        F: FnOnce(&ICoreDragDropManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for CoreDragDropManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICoreDragDropManager>();
}
...
impl windows_core::RuntimeType for CoreDragInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICoreDragInfo>();
}
...
impl CoreDragOperation {
    ...
    pub fn SetDragUIContentFromSoftwareBitmap<P0>(
        &self,
        softwarebitmap: P0,
    ) -> windows_core::Result<()>
    where
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn SetDragUIContentFromSoftwareBitmapWithAnchorPoint<P0>(
        &self,
        softwarebitmap: P0,
    ...
    pub fn StartAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::super::DataPackageOperation>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for CoreDragOperation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICoreDragOperation>();
}
...
impl windows_core::RuntimeType for CoreDragUIOverride {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICoreDragUIOverride>();
}
...
unsafe impl windows_core::Interface for CoreDropOperationTargetRequestedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ICoreDropOperationTargetRequestedEventArgs as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    ...
    ICoreDragDropManager_Vtbl,
    0x7d56d344_8464_4faf_aa49_37ea6e2d7bd1
);
...
windows_core::imp::define_interface!(
    ICoreDragDropManagerStatics,
    ICoreDragDropManagerStatics_Vtbl,
    0x9542fdca_da12_4c1c_8d06_041db29733c3
);
...
windows_core::imp::define_interface!(
    ICoreDragInfo,
    ICoreDragInfo_Vtbl,
    0x48353a8b_cb50_464e_9575_cd4e3a7ab028
);
...
windows_core::imp::define_interface!(
    ICoreDragInfo2,
    ICoreDragInfo2_Vtbl,
    0xc54691e5_e6fb_4d74_b4b1_8a3c17f25e9e
);
...
pub struct ICoreDragInfo2_Vtbl {
    ...
    pub AllowedOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::DataPackageOperation,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ICoreDragOperation,
    ICoreDragOperation_Vtbl,
...
pub struct ICoreDragOperation_Vtbl {
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub SetDragUIContentFromSoftwareBitmapWithAnchorPoint:
...
windows_core::imp::define_interface!(
    ICoreDragOperation2,
    ICoreDragOperation2_Vtbl,
    0x824b1e2c_d99a_4fc3_8507_6c182f33b46a
);
...
windows_core::imp::define_interface!(
    ICoreDragUIOverride,
    ICoreDragUIOverride_Vtbl,
    0x89a85064_3389_4f4f_8897_7e8a3ffb3c93
);
...
windows_core::imp::define_interface!(
    ...
    0xd9126196_4c5b_417d_bb37_76381def8db4
);
...
pub trait ICoreDropOperationTarget_Impl: windows_core::IUnknownImpl {
    fn EnterAsync(
        &self,
        dragInfo: windows_core::Ref<'_, CoreDragInfo>,
        dragUIOverride: windows_core::Ref<'_, CoreDragUIOverride>,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::super::DataPackageOperation>>;
    fn OverAsync(
        &self,
        dragInfo: windows_core::Ref<'_, CoreDragInfo>,
    ...
    pub const fn new<Identity: ICoreDropOperationTarget_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                match ICoreDropOperationTarget_Impl::EnterAsync(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICoreDropOperationTarget_Impl::OverAsync(
                    this,
                    core::mem::transmute_copy(&draginfo),
                    core::mem::transmute_copy(&draguioverride),
                ) {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICoreDropOperationTarget_Impl::LeaveAsync(
                    this,
                    core::mem::transmute_copy(&draginfo),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICoreDropOperationTarget_Impl::DropAsync(
                    this,
                    core::mem::transmute_copy(&draginfo),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ICoreDropOperationTargetRequestedEventArgs,
    ICoreDropOperationTargetRequestedEventArgs_Vtbl,
    0x2aca929a_5e28_4ea6_829e_29134e665d6d
);

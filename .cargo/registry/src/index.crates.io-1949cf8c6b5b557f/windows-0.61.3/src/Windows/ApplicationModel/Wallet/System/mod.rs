...
pub struct IWalletItemSystemStore_Vtbl {
    ...
    pub GetAppStatusForItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut WalletItemAppAssociation,
    ) -> windows_core::HRESULT,
    pub LaunchAppForItemAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl windows_core::RuntimeType for WalletItemAppAssociation {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Wallet.System.WalletItemAppAssociation;i4)",
    );
}
#[cfg(feature = "deprecated")]
#[repr(transparent)]
...
impl WalletItemSystemStore {
    pub fn GetItemsAsync(
        ...
        windows_future::IAsyncOperation<windows_collections::IVectorView<super::WalletItem>>,
    > {
        let this = self;
        unsafe {
    ...
    pub fn ImportItemAsync<P0>(
        &self,
        stream: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::WalletItem>>
    where
    ...
    pub fn GetAppStatusForItem<P0>(
        &self,
        item: P0,
    ) -> windows_core::Result<WalletItemAppAssociation>
    where
        P0: windows_core::Param<super::WalletItem>,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAppStatusForItem)(
                windows_core::Interface::as_raw(this),
                item.param().abi(),
                &mut result__,
            )
    ...
    pub fn LaunchAppForItemAsync<P0>(
        &self,
        item: P0,
        ...
        P0: windows_core::Param<super::WalletItem>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LaunchAppForItemAsync)(
                windows_core::Interface::as_raw(this),
                item.param().abi(),
                &mut result__,
            )
...
impl windows_core::RuntimeType for WalletItemSystemStore {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWalletItemSystemStore>();
}
#[cfg(feature = "deprecated")]
...
impl WalletManagerSystem {
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<WalletItemSystemStore>> {
    ...
    fn IWalletManagerSystemStatics<
        R,
        F: FnOnce(&IWalletManagerSystemStatics) -> windows_core::Result<R>,
    >(
        callback: F,

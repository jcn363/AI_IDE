...
unsafe impl windows_core::Interface for ExtendedExecutionForegroundRevokedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IExtendedExecutionForegroundRevokedEventArgs as windows_core::Interface>::IID;
}
...
impl ExtendedExecutionForegroundSession {
    ...
    pub fn RequestExtensionAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<ExtendedExecutionForegroundResult>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for ExtendedExecutionForegroundSession {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IExtendedExecutionForegroundSession>();
}
unsafe impl windows_core::Interface for ExtendedExecutionForegroundSession {
    ...
    const IID: windows_core::GUID =
        <IExtendedExecutionForegroundSession as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    IExtendedExecutionForegroundRevokedEventArgs,
    IExtendedExecutionForegroundRevokedEventArgs_Vtbl,
    0xb07cd940_9557_aea4_2c99_bdd56d9be461
);
...
pub struct IExtendedExecutionForegroundRevokedEventArgs_Vtbl {
    ...
    pub Reason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ExtendedExecutionForegroundRevokedReason,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IExtendedExecutionForegroundSession,
    IExtendedExecutionForegroundSession_Vtbl,
    0xfbf440e1_9d10_4201_b01e_c83275296f2e
);
...
pub struct IExtendedExecutionForegroundSession_Vtbl {
    ...
    pub Reason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ExtendedExecutionForegroundReason,
    ) -> windows_core::HRESULT,

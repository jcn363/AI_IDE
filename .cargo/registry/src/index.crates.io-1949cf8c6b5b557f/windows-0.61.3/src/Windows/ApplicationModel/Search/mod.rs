...
windows_core::imp::define_interface!(
    ...
    ILocalContentSuggestionSettings_Vtbl,
    0xeeaeb062_743d_456e_84a3_23f06f2d15d7
);
...
pub struct ILocalContentSuggestionSettings_Vtbl {
    ...
    Locations: usize,
    pub SetAqsFilter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AqsFilter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PropertiesToMatch: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub struct ISearchPane_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetSearchHistoryEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub SearchHistoryEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    ...
    pub RemoveSuggestionsRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    ...
    pub RemoveResultSuggestionChosen:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub SetLocalContentSuggestionSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ShowOverloadDefault:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ShowOverloadWithQuery: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetShowOnKeyboardInput:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub ShowOnKeyboardInput:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub TrySetQueryText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut bool,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x82fb460e_0940_4b6d_b8d0_642b30989e15
);
...
pub struct ISearchPaneQueryLinguisticDetails_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub QueryTextAlternatives: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub QueryTextCompositionStart:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub QueryTextCompositionLength:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
}
#[cfg(feature = "deprecated")]
windows_core::imp::define_interface!(
...
pub struct ISearchPaneSuggestionsRequest_Vtbl {
    ...
    pub IsCanceled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SearchSuggestionCollection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ISearchQueryLinguisticDetails_Vtbl,
    0x46a1205b_69c9_4745_b72f_a8a4fc8f24ae
);
...
windows_core::imp::define_interface!(
    ...
    ISearchQueryLinguisticDetailsFactory_Vtbl,
    0xcac6c3b8_3c64_4dfd_ad9f_479e4d4065a4
);
...
windows_core::imp::define_interface!(
    ...
    ISearchSuggestionCollection_Vtbl,
    0x323a8a4b_fbea_4446_abbc_3da7915fdd3a
);
...
pub struct ISearchSuggestionCollection_Vtbl {
    ...
    pub AppendQuerySuggestion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AppendQuerySuggestions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    pub AppendResultSuggestion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub AppendSearchSeparator: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0x4e4e26a7_44e5_4039_9099_6000ead1f0c6
);
...
windows_core::imp::define_interface!(
    ...
    ISearchSuggestionsRequestDeferral_Vtbl,
...
impl LocalContentSuggestionSettings {
    ...
    pub fn Locations(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<super::super::Storage::StorageFolder>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAqsFilter(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAqsFilter)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn AqsFilter(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AqsFilter)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn PropertiesToMatch(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PropertiesToMatch)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for LocalContentSuggestionSettings {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ILocalContentSuggestionSettings>();
}
unsafe impl windows_core::Interface for LocalContentSuggestionSettings {
    ...
    const IID: windows_core::GUID =
        <ILocalContentSuggestionSettings as windows_core::Interface>::IID;
}
...
impl SearchPane {
    pub fn SetSearchHistoryEnabled(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSearchHistoryEnabled)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SearchHistoryEnabled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SearchHistoryEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetSearchHistoryContext(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSearchHistoryContext)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn SearchHistoryContext(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SearchHistoryContext)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).QueryChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveQueryChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveQueryChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SuggestionsRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveSuggestionsRequested(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveSuggestionsRequested)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn RemoveQuerySubmitted(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveQuerySubmitted)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResultSuggestionChosen)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveResultSuggestionChosen(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveResultSuggestionChosen)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<LocalContentSuggestionSettings>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetLocalContentSuggestionSettings)(
                windows_core::Interface::as_raw(this),
                settings.param().abi(),
            )
            .ok()
    ...
    pub fn ShowOverloadDefault(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ShowOverloadDefault)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    pub fn ShowOverloadWithQuery(&self, query: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ShowOverloadWithQuery)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn SetShowOnKeyboardInput(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetShowOnKeyboardInput)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn ShowOnKeyboardInput(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowOnKeyboardInput)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn TrySetQueryText(&self, query: &windows_core::HSTRING) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TrySetQueryText)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(query),
                &mut result__,
            )
    ...
    pub fn HideThisApplication() -> windows_core::Result<()> {
        Self::ISearchPaneStaticsWithHideThisApplication(|this| unsafe {
            (windows_core::Interface::vtable(this).HideThisApplication)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        })
    }
    fn ISearchPaneStatics<R, F: FnOnce(&ISearchPaneStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SearchPane, ISearchPaneStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ISearchPaneStaticsWithHideThisApplication<
        R,
        F: FnOnce(&ISearchPaneStaticsWithHideThisApplication) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for SearchPane {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchPane>();
}
#[cfg(feature = "deprecated")]
...
impl windows_core::RuntimeType for SearchPaneQueryChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchPaneQueryChangedEventArgs>();
}
#[cfg(feature = "deprecated")]
unsafe impl windows_core::Interface for SearchPaneQueryChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ISearchPaneQueryChangedEventArgs as windows_core::Interface>::IID;
}
#[cfg(feature = "deprecated")]
...
impl SearchPaneQueryLinguisticDetails {
    pub fn QueryTextAlternatives(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).QueryTextAlternatives)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn QueryTextCompositionStart(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).QueryTextCompositionStart)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn QueryTextCompositionLength(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).QueryTextCompositionLength)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for SearchPaneQueryLinguisticDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchPaneQueryLinguisticDetails>();
}
unsafe impl windows_core::Interface for SearchPaneQueryLinguisticDetails {
    ...
    const IID: windows_core::GUID =
        <ISearchPaneQueryLinguisticDetails as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for SearchPaneQuerySubmittedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchPaneQuerySubmittedEventArgs>();
}
#[cfg(feature = "deprecated")]
unsafe impl windows_core::Interface for SearchPaneQuerySubmittedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ISearchPaneQuerySubmittedEventArgs as windows_core::Interface>::IID;
}
#[cfg(feature = "deprecated")]
...
unsafe impl windows_core::Interface for SearchPaneResultSuggestionChosenEventArgs {
    ...
    const IID: windows_core::GUID =
        <ISearchPaneResultSuggestionChosenEventArgs as windows_core::Interface>::IID;
}
#[cfg(feature = "deprecated")]
...
impl SearchPaneSuggestionsRequest {
    ...
    pub fn SearchSuggestionCollection(&self) -> windows_core::Result<SearchSuggestionCollection> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SearchSuggestionCollection)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for SearchPaneSuggestionsRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchPaneSuggestionsRequest>();
}
#[cfg(feature = "deprecated")]
...
impl windows_core::RuntimeType for SearchPaneSuggestionsRequestDeferral {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchPaneSuggestionsRequestDeferral>();
}
#[cfg(feature = "deprecated")]
unsafe impl windows_core::Interface for SearchPaneSuggestionsRequestDeferral {
    ...
    const IID: windows_core::GUID =
        <ISearchPaneSuggestionsRequestDeferral as windows_core::Interface>::IID;
}
#[cfg(feature = "deprecated")]
...
unsafe impl windows_core::Interface for SearchPaneSuggestionsRequestedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ISearchPaneSuggestionsRequestedEventArgs as windows_core::Interface>::IID;
}
#[cfg(feature = "deprecated")]
...
impl windows_core::RuntimeType for SearchPaneVisibilityChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchPaneVisibilityChangedEventArgs>();
}
#[cfg(feature = "deprecated")]
unsafe impl windows_core::Interface for SearchPaneVisibilityChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ISearchPaneVisibilityChangedEventArgs as windows_core::Interface>::IID;
}
#[cfg(feature = "deprecated")]
...
impl SearchQueryLinguisticDetails {
    ...
    pub fn CreateInstance<P0>(
        querytextalternatives: P0,
        querytextcompositionstart: u32,
        querytextcompositionlength: u32,
    ) -> windows_core::Result<SearchQueryLinguisticDetails>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::ISearchQueryLinguisticDetailsFactory(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).CreateInstance)(
                windows_core::Interface::as_raw(this),
                querytextalternatives.param().abi(),
    ...
    fn ISearchQueryLinguisticDetailsFactory<
        R,
        F: FnOnce(&ISearchQueryLinguisticDetailsFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for SearchQueryLinguisticDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchQueryLinguisticDetails>();
}
...
impl SearchSuggestionCollection {
    ...
    pub fn AppendQuerySuggestion(&self, text: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AppendQuerySuggestion)(
                windows_core::Interface::as_raw(this),
        ...
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AppendQuerySuggestions)(
                windows_core::Interface::as_raw(this),
                suggestions.param().abi(),
            )
            .ok()
        }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn AppendResultSuggestion<P3>(
        &self,
        text: &windows_core::HSTRING,
        detailtext: &windows_core::HSTRING,
        tag: &windows_core::HSTRING,
        image: P3,
        imagealternatetext: &windows_core::HSTRING,
    ) -> windows_core::Result<()>
    where
        P3: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AppendResultSuggestion)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(text),
                core::mem::transmute_copy(detailtext),
                core::mem::transmute_copy(tag),
                image.param().abi(),
                core::mem::transmute_copy(imagealternatetext),
            )
            .ok()
        }
    }
    pub fn AppendSearchSeparator(&self, label: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AppendSearchSeparator)(
                windows_core::Interface::as_raw(this),
...
impl windows_core::RuntimeType for SearchSuggestionCollection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchSuggestionCollection>();
}
...
impl windows_core::RuntimeType for SearchSuggestionsRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchSuggestionsRequest>();
}
...
impl windows_core::RuntimeType for SearchSuggestionsRequestDeferral {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISearchSuggestionsRequestDeferral>();
}
unsafe impl windows_core::Interface for SearchSuggestionsRequestDeferral {
    ...
    const IID: windows_core::GUID =
        <ISearchSuggestionsRequestDeferral as windows_core::Interface>::IID;
}

windows_core::imp::define_interface!(
    ...
    0xfe0a7990_5e59_4bb7_8a63_7d218cd96300
);
...
pub struct IInkWorkspaceHostedAppManager_Vtbl {
    ...
    pub SetThumbnailAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IInkWorkspaceHostedAppManagerStatics_Vtbl,
...
impl InkWorkspaceHostedAppManager {
        ...
        P0: windows_core::Param<super::super::super::Graphics::Imaging::SoftwareBitmap>,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).SetThumbnailAsync)(
    ...
    fn IInkWorkspaceHostedAppManagerStatics<
        R,
        F: FnOnce(&IInkWorkspaceHostedAppManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for InkWorkspaceHostedAppManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInkWorkspaceHostedAppManager>();
}

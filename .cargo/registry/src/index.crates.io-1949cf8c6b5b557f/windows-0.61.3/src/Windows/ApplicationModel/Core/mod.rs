...
impl AppListEntry {
        ...
        P0: windows_core::Param<super::super::System::User>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LaunchForUserAsync)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                &mut result__,
            )
...
impl windows_core::RuntimeType for AppListEntry {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAppListEntry>();
}
...
impl CoreApplication {
    ...
    pub fn GetCurrentView() -> windows_core::Result<CoreApplicationView> {
        Self::ICoreApplication(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCurrentView)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        Self::ICoreApplication(|this| unsafe {
            (windows_core::Interface::vtable(this).RunWithActivationFactories)(
                windows_core::Interface::as_raw(this),
                activationfactorycallback.param().abi(),
            )
            .ok()
        })
    }
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<AppRestartFailureReason>> {
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::ICoreApplicationExit(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Exiting)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveExiting(token: i64) -> windows_core::Result<()> {
        Self::ICoreApplicationExit(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveExiting)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn IncrementApplicationUseCount() -> windows_core::Result<()> {
        Self::ICoreApplicationUseCount(|this| unsafe {
            (windows_core::Interface::vtable(this).IncrementApplicationUseCount)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        })
    ...
    pub fn DecrementApplicationUseCount() -> windows_core::Result<()> {
        Self::ICoreApplicationUseCount(|this| unsafe {
            (windows_core::Interface::vtable(this).DecrementApplicationUseCount)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        })
    ...
    pub fn CreateNewView(
        runtimetype: &windows_core::HSTRING,
        entrypoint: &windows_core::HSTRING,
    ) -> windows_core::Result<CoreApplicationView> {
        Self::ICoreImmersiveApplication(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateNewView)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn MainView() -> windows_core::Result<CoreApplicationView> {
        Self::ICoreImmersiveApplication(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MainView)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateNewViewFromMainView() -> windows_core::Result<CoreApplicationView> {
        Self::ICoreImmersiveApplication2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateNewViewFromMainView)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<IFrameworkViewSource>,
    {
        Self::ICoreImmersiveApplication3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateNewViewWithViewSource)(
                windows_core::Interface::as_raw(this),
                viewsource.param().abi(),
                &mut result__,
            )
    ...
    fn ICoreApplication<R, F: FnOnce(&ICoreApplication) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreApplication> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreApplication2<R, F: FnOnce(&ICoreApplication2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreApplication2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreApplication3<R, F: FnOnce(&ICoreApplication3) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreApplication3> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreApplicationExit<R, F: FnOnce(&ICoreApplicationExit) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreApplicationExit> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreApplicationUnhandledError<
        R,
        F: FnOnce(&ICoreApplicationUnhandledError) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
    ...
    fn ICoreApplicationUseCount<
        R,
        F: FnOnce(&ICoreApplicationUseCount) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreApplicationUseCount> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreImmersiveApplication<
        R,
        F: FnOnce(&ICoreImmersiveApplication) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreImmersiveApplication> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreImmersiveApplication2<
        R,
        F: FnOnce(&ICoreImmersiveApplication2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn ICoreImmersiveApplication3<
        R,
        F: FnOnce(&ICoreImmersiveApplication3) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl CoreApplicationView {
    ...
    pub fn IsMain(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsMain)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsHosted(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsHosted)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsComponent(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsComponent)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HostedViewClosing)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveHostedViewClosing(&self, token: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<ICoreApplicationView3>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveHostedViewClosing)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for CoreApplicationView {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICoreApplicationView>();
}
...
impl CoreApplicationViewTitleBar {
    pub fn SetExtendViewIntoTitleBar(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetExtendViewIntoTitleBar)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn ExtendViewIntoTitleBar(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ExtendViewIntoTitleBar)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SystemOverlayLeftInset(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SystemOverlayLeftInset)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SystemOverlayRightInset(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SystemOverlayRightInset)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LayoutMetricsChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveLayoutMetricsChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveLayoutMetricsChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsVisibleChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveIsVisibleChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveIsVisibleChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for CoreApplicationViewTitleBar {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICoreApplicationViewTitleBar>();
}
...
impl windows_core::RuntimeType for HostedViewClosingEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHostedViewClosingEventArgs>();
}
...
windows_core::imp::define_interface!(
    IAppListEntry,
    IAppListEntry_Vtbl,
    0xef00f07f_2108_490a_877a_8a9f17c25fad
);
...
windows_core::imp::define_interface!(
    IAppListEntry2,
    IAppListEntry2_Vtbl,
    0xd0a618ad_bf35_42ac_ac06_86eeeb41d04b
);
...
windows_core::imp::define_interface!(
    IAppListEntry3,
    IAppListEntry3_Vtbl,
    0x6099f28d_fc32_470a_bc69_4b061a76ef2e
);
...
pub struct IAppListEntry3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "System")]
    pub LaunchForUserAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IAppListEntry4,
    IAppListEntry4_Vtbl,
    0x2a131ed2_56f5_487c_8697_5166f3b33da0
);
...
windows_core::imp::define_interface!(
    ICoreApplication,
    ICoreApplication_Vtbl,
    0x0aacf7a4_5e1d_49df_8034_fb6a68bc5ed1
);
...
pub struct ICoreApplication_Vtbl {
    ...
    Properties: usize,
    pub GetCurrentView: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub RunWithActivationFactories: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ICoreApplication2,
    ICoreApplication2_Vtbl,
    0x998681fb_1ab6_4b7f_be4a_9a0645224c04
);
...
windows_core::imp::define_interface!(
    ...
    0xfeec0d39_598b_4507_8a67_772632580a57
);
...
windows_core::imp::define_interface!(
    ...
    ICoreApplicationExit_Vtbl,
    0xcf86461d_261e_4b72_9acd_44ed2ace6a29
);
...
pub struct ICoreApplicationExit_Vtbl {
    ...
    pub Exiting: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: ICoreApplicationUnhandledError_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICoreApplicationUnhandledError_Impl::RemoveUnhandledErrorDetected(this, token)
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    ICoreApplicationUseCount_Vtbl,
    0x518dc408_c077_475b_809e_0bc0c57e4b74
);
...
pub struct ICoreApplicationUseCount_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IncrementApplicationUseCount:
...
windows_core::imp::define_interface!(
    ...
    ICoreApplicationView_Vtbl,
    0x638bb2db_451d_4661_b099_414f34ffb9f1
);
...
windows_core::imp::define_interface!(
    ...
    ICoreApplicationView2_Vtbl,
    0x68eb7adf_917f_48eb_9aeb_7de53e086ab1
);
...
windows_core::imp::define_interface!(
    ...
    ICoreApplicationView3_Vtbl,
    0x07ebe1b3_a4cf_4550_ab70_b07e85330bc8
);
...
pub struct ICoreApplicationView3_Vtbl {
    ...
    pub HostedViewClosing: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveHostedViewClosing:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ICoreApplicationView5,
    ICoreApplicationView5_Vtbl,
    0x2bc095a8_8ef0_446d_9e60_3a3e0428c671
);
...
windows_core::imp::define_interface!(
    ...
    ICoreApplicationView6_Vtbl,
    0xc119d49a_0679_49ba_803f_b79c5cf34cca
);
...
windows_core::imp::define_interface!(
    ...
    ICoreApplicationViewTitleBar_Vtbl,
    0x006d35e3_e1f1_431b_9508_29b96926ac53
);
...
pub struct ICoreApplicationViewTitleBar_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetExtendViewIntoTitleBar:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub ExtendViewIntoTitleBar:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SystemOverlayLeftInset:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub SystemOverlayRightInset:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub Height:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub LayoutMetricsChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveLayoutMetricsChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub IsVisible:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsVisibleChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveIsVisibleChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ICoreImmersiveApplication,
    ICoreImmersiveApplication_Vtbl,
    0x1ada0e3e_e4a2_4123_b451_dc96bf800419
);
...
pub struct ICoreImmersiveApplication_Vtbl {
    ...
    pub CreateNewView: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub MainView: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ICoreImmersiveApplication2,
    ICoreImmersiveApplication2_Vtbl,
    0x828e1e36_e9e3_4cfc_9b66_48b78ea9bb2c
);
...
pub struct ICoreImmersiveApplication2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateNewViewFromMainView: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ICoreImmersiveApplication3,
    ICoreImmersiveApplication3_Vtbl,
    0x34a05b2f_ee0d_41e5_8314_cf10c91bf0af
);
...
pub struct ICoreImmersiveApplication3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateNewViewWithViewSource: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IFrameworkView,
    IFrameworkView_Vtbl,
    0xfaab5cd0_8924_45ac_ad0f_a08fae5d0324
);
...
pub trait IFrameworkView_Impl: windows_core::IUnknownImpl {
    fn Initialize(
        &self,
        applicationView: windows_core::Ref<'_, CoreApplicationView>,
    ) -> windows_core::Result<()>;
    fn SetWindow(
        &self,
        window: windows_core::Ref<'_, super::super::UI::Core::CoreWindow>,
    ) -> windows_core::Result<()>;
...
impl IFrameworkView_Vtbl {
    pub const fn new<Identity: IFrameworkView_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Initialize<Identity: IFrameworkView_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            applicationview: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IFrameworkView_Impl::Initialize(this, core::mem::transmute_copy(&applicationview))
                    .into()
            }
        }
        unsafe extern "system" fn SetWindow<Identity: IFrameworkView_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Load<Identity: IFrameworkView_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Run<Identity: IFrameworkView_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
pub struct IFrameworkView_Vtbl {
    ...
    #[cfg(feature = "UI_Core")]
    pub SetWindow: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "UI_Core"))]
...
windows_core::imp::define_interface!(
    ...
    0xcd770614_65c4_426c_9494_34fc43554862
);
...
windows_core::imp::define_interface!(
    ...
    IHostedViewClosingEventArgs_Vtbl,
    0xd238943c_b24e_4790_acb5_3e4243c4ff87
);
...
impl UnhandledError {
    ...
    pub fn Propagate(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).Propagate)(windows_core::Interface::as_raw(this))
                .ok()
        }
    }
}
...
impl windows_core::RuntimeType for UnhandledErrorDetectedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUnhandledErrorDetectedEventArgs>();
}

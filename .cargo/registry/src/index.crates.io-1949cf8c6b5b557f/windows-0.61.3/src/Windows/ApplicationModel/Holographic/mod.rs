...
impl HolographicKeyboard {
    ...
    fn IHolographicKeyboardStatics<
        R,
        F: FnOnce(&IHolographicKeyboardStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for HolographicKeyboard {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHolographicKeyboard>();
}
...
windows_core::imp::define_interface!(
    ...
    0x07dd0893_aa21_5e6f_a91b_11b2b3fd7be3
);
...
windows_core::imp::define_interface!(
    IHolographicKeyboardStatics,
    IHolographicKeyboardStatics_Vtbl,
    0xb676c624_63d7_58cf_b06b_08baa032a23f
);

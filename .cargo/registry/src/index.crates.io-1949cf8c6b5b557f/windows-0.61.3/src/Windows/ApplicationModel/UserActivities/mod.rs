...
windows_core::imp::define_interface!(
    IUserActivity,
    IUserActivity_Vtbl,
    0xfc103e9e_2cab_4d36_aea2_b4bb556cef0f
);
...
pub struct IUserActivity_Vtbl {
    ...
    pub ActivationUri: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetActivationUri: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ContentInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetContentInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IUserActivity2,
    IUserActivity2_Vtbl,
    0x9dc40c62_08c4_47ac_aa9c_2bb2221c55fd
);
...
windows_core::imp::define_interface!(
    IUserActivity3,
    IUserActivity3_Vtbl,
    0xe7697744_e1a2_5147_8e06_55f1eeef271c
);
...
pub struct IUserActivityAttribution_Vtbl {
    ...
    pub SetAlternateText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AddImageQuery:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetAddImageQuery:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IUserActivityAttributionFactory,
    IUserActivityAttributionFactory_Vtbl,
    0xe62bd252_c566_4f42_9974_916c4d76377e
);
...
pub struct IUserActivityAttributionFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateWithUri: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0xbac0f8b8_a0e4_483b_b948_9cbabd06070c
);
...
pub struct IUserActivityChannel_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetOrCreateUserActivityAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeleteActivityAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeleteAllActivitiesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0x1698e35b_eb7e_4ea0_bf17_a459e8be706c
);
...
pub struct IUserActivityChannel2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetRecentUserActivitiesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetSessionHistoryItemsForUserActivityAsync:
...
windows_core::imp::define_interface!(
    ...
    0xc8c005ab_198d_4d80_abb2_c9775ec4a729
);
...
windows_core::imp::define_interface!(
    ...
    0x8e87de30_aa4f_4624_9ad0_d40f3ba0317c
);
...
pub struct IUserActivityChannelStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub DisableAutoSessionCreation:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(feature = "Security_Credentials")]
    pub TryGetForWebAccount: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x53bc4ddb_bbdf_5984_802a_5305874e205c
);
...
windows_core::imp::define_interface!(
    ...
    0xb399e5ad_137f_409d_822d_e1af27ce08dc
);
...
windows_core::imp::define_interface!(
    ...
    0x9988c34b_0386_4bc9_968a_8200b004144f
);
...
pub struct IUserActivityContentInfoStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub FromJson: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x7c385758_361d_4a67_8a3b_34ca2978f9a3
);
...
pub struct IUserActivityFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateWithActivityId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0xa0ef6355_cf35_4ff0_8833_50cb4b72e06d
);
...
pub struct IUserActivityRequest_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetUserActivity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0x0c30be4e_903d_48d6_82d4_4043ed57791b
);
...
pub struct IUserActivityRequestManager_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub UserActivityRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveUserActivityRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IUserActivityRequestManagerStatics,
    IUserActivityRequestManagerStatics_Vtbl,
    0xc0392df1_224a_432c_81e5_0c76b4c4cefa
);
...
windows_core::imp::define_interface!(
    ...
    0xae434d78_24fa_44a3_ad48_6eda61aa1924
);
...
windows_core::imp::define_interface!(
    ...
    0xe8d59bd3_3e5d_49fd_98d7_6da97521e255
);
...
pub struct IUserActivitySessionHistoryItem_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub UserActivity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x8c8fd333_0e09_47f6_9ac7_95cf5c39367b
);
...
pub struct IUserActivityStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub TryParseFromJson: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TryParseFromJsonArray: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ToJsonArray: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x94757513_262f_49ef_bbbf_9b75d2e85250
);
...
pub struct IUserActivityVisualElements_Vtbl {
    ...
    pub Attribution: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetAttribution: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct IUserActivityVisualElements2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AttributionDisplayText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetAttributionDisplayText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl UserActivity {
    ...
    pub fn ActivationUri(&self) -> windows_core::Result<super::super::Foundation::Uri> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ActivationUri)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetActivationUri)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn ContentInfo(&self) -> windows_core::Result<IUserActivityContentInfo> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ContentInfo)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<IUserActivityContentInfo>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetContentInfo)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn CreateWithActivityId(
        activityid: &windows_core::HSTRING,
    ) -> windows_core::Result<UserActivity> {
        Self::IUserActivityFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithActivityId)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn TryParseFromJson(json: &windows_core::HSTRING) -> windows_core::Result<UserActivity> {
        Self::IUserActivityStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryParseFromJson)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(json),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn TryParseFromJsonArray(
        json: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_collections::IVector<UserActivity>> {
        Self::IUserActivityStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryParseFromJsonArray)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(json),
                &mut result__,
            )
        ...
        P0: windows_core::Param<windows_collections::IIterable<UserActivity>>,
    {
        Self::IUserActivityStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ToJsonArray)(
                windows_core::Interface::as_raw(this),
                activities.param().abi(),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
        })
    }
    fn IUserActivityFactory<R, F: FnOnce(&IUserActivityFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<UserActivity, IUserActivityFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IUserActivityStatics<R, F: FnOnce(&IUserActivityStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<UserActivity, IUserActivityStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for UserActivity {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserActivity>();
}
...
impl UserActivityAttribution {
    ...
    pub fn SetAlternateText(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAlternateText)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn AddImageQuery(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AddImageQuery)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAddImageQuery(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAddImageQuery)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        Self::IUserActivityAttributionFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithUri)(
                windows_core::Interface::as_raw(this),
                iconuri.param().abi(),
                &mut result__,
            )
    ...
    fn IUserActivityAttributionFactory<
        R,
        F: FnOnce(&IUserActivityAttributionFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for UserActivityAttribution {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserActivityAttribution>();
}
...
impl UserActivityChannel {
    pub fn GetOrCreateUserActivityAsync(
        &self,
        activityid: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<UserActivity>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetOrCreateUserActivityAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activityid),
                &mut result__,
            )
    ...
    pub fn DeleteActivityAsync(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeleteActivityAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activityid),
                &mut result__,
            )
    ...
    pub fn DeleteAllActivitiesAsync(&self) -> windows_core::Result<windows_future::IAsyncAction> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeleteAllActivitiesAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetRecentUserActivitiesAsync(
        &self,
        maxuniqueactivities: i32,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<
            windows_collections::IVector<UserActivitySessionHistoryItem>,
        >,
    > {
        let this = &windows_core::Interface::cast::<IUserActivityChannel2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetRecentUserActivitiesAsync)(
                windows_core::Interface::as_raw(this),
                maxuniqueactivities,
                &mut result__,
            )
    ...
    pub fn GetSessionHistoryItemsForUserActivityAsync(
        &self,
        activityid: &windows_core::HSTRING,
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetSessionHistoryItemsForUserActivityAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(activityid),
                starttime,
                &mut result__,
    ...
    pub fn DisableAutoSessionCreation() -> windows_core::Result<()> {
        Self::IUserActivityChannelStatics2(|this| unsafe {
            (windows_core::Interface::vtable(this).DisableAutoSessionCreation)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        })
        ...
        P0: windows_core::Param<super::super::Security::Credentials::WebAccount>,
    {
        Self::IUserActivityChannelStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetForWebAccount)(
                windows_core::Interface::as_raw(this),
                account.param().abi(),
                &mut result__,
            )
    ...
    fn IUserActivityChannelStatics<
        R,
        F: FnOnce(&IUserActivityChannelStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IUserActivityChannelStatics2<
        R,
        F: FnOnce(&IUserActivityChannelStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IUserActivityChannelStatics3<
        R,
        F: FnOnce(&IUserActivityChannelStatics3) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for UserActivityChannel {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserActivityChannel>();
}
...
impl UserActivityContentInfo {
    ...
    ) -> windows_core::Result<UserActivityContentInfo> {
        Self::IUserActivityContentInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromJson)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
                &mut result__,
            )
    ...
    fn IUserActivityContentInfoStatics<
        R,
        F: FnOnce(&IUserActivityContentInfoStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for UserActivityContentInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserActivityContentInfo>();
}
...
impl UserActivityRequest {
        ...
        P0: windows_core::Param<UserActivity>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetUserActivity)(
                windows_core::Interface::as_raw(this),
                activity.param().abi(),
            )
            .ok()
...
impl windows_core::RuntimeType for UserActivityRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserActivityRequest>();
}
...
impl UserActivityRequestManager {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UserActivityRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveUserActivityRequested(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveUserActivityRequested)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    fn IUserActivityRequestManagerStatics<
        R,
        F: FnOnce(&IUserActivityRequestManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for UserActivityRequestManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserActivityRequestManager>();
}
...
impl windows_core::RuntimeType for UserActivityRequestedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserActivityRequestedEventArgs>();
}
unsafe impl windows_core::Interface for UserActivityRequestedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IUserActivityRequestedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for UserActivitySession {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserActivitySession>();
}
...
impl UserActivitySessionHistoryItem {
    pub fn UserActivity(&self) -> windows_core::Result<UserActivity> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UserActivity)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for UserActivitySessionHistoryItem {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserActivitySessionHistoryItem>();
}
unsafe impl windows_core::Interface for UserActivitySessionHistoryItem {
    ...
    const IID: windows_core::GUID =
        <IUserActivitySessionHistoryItem as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for UserActivityState {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.UserActivities.UserActivityState;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl UserActivityVisualElements {
    ...
    pub fn Attribution(&self) -> windows_core::Result<UserActivityAttribution> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Attribution)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<UserActivityAttribution>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAttribution)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn AttributionDisplayText(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AttributionDisplayText)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetAttributionDisplayText(
        &self,
        value: &windows_core::HSTRING,
    ) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IUserActivityVisualElements2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetAttributionDisplayText)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
...
impl windows_core::RuntimeType for UserActivityVisualElements {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserActivityVisualElements>();
}

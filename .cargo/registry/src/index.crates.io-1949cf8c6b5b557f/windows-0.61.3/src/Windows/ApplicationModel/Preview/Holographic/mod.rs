...
impl HolographicApplicationPreview {
    pub fn IsCurrentViewPresentedOnHolographicDisplay() -> windows_core::Result<bool> {
        Self::IHolographicApplicationPreviewStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).IsCurrentViewPresentedOnHolographicDisplay)(
        ...
        P0: windows_core::Param<super::super::Activation::IActivatedEventArgs>,
    {
        Self::IHolographicApplicationPreviewStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsHolographicActivation)(
                windows_core::Interface::as_raw(this),
                activatedeventargs.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        })
    ...
    fn IHolographicApplicationPreviewStatics<
        R,
        F: FnOnce(&IHolographicApplicationPreviewStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl HolographicKeyboardPlacementOverridePreview {
    ...
    pub fn SetPlacementOverride<P0>(
        &self,
        coordinatesystem: P0,
        topcenterposition: windows_numerics::Vector3,
        ...
        P0: windows_core::Param<super::super::super::Perception::Spatial::SpatialCoordinateSystem>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPlacementOverride)(
                windows_core::Interface::as_raw(this),
    ...
    #[cfg(feature = "Perception_Spatial")]
    pub fn SetPlacementOverrideWithMaxSize<P0>(
        &self,
        coordinatesystem: P0,
        topcenterposition: windows_numerics::Vector3,
        normal: windows_numerics::Vector3,
        maxsize: windows_numerics::Vector2,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::super::super::Perception::Spatial::SpatialCoordinateSystem>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPlacementOverrideWithMaxSize)(
                windows_core::Interface::as_raw(this),
                coordinatesystem.param().abi(),
                topcenterposition,
                normal,
    ...
    pub fn ResetPlacementOverride(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ResetPlacementOverride)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    fn IHolographicKeyboardPlacementOverridePreviewStatics<
        R,
        F: FnOnce(&IHolographicKeyboardPlacementOverridePreviewStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
unsafe impl windows_core::Interface for HolographicKeyboardPlacementOverridePreview {
    ...
    const IID: windows_core::GUID =
        <IHolographicKeyboardPlacementOverridePreview as windows_core::Interface>::IID;
}
#[cfg(feature = "deprecated")]
...
windows_core::imp::define_interface!(
    IHolographicApplicationPreviewStatics,
    IHolographicApplicationPreviewStatics_Vtbl,
    0xfe038691_2a3a_45a9_a208_7bed691919f3
);
...
pub struct IHolographicApplicationPreviewStatics_Vtbl {
    ...
    pub IsCurrentViewPresentedOnHolographicDisplay:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    #[cfg(feature = "ApplicationModel_Activation")]
    pub IsHolographicActivation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut bool,
...
pub struct IHolographicKeyboardPlacementOverridePreview_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Perception_Spatial")]
    pub SetPlacementOverride: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Perception_Spatial")]
    pub SetPlacementOverrideWithMaxSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_numerics::Vector3,
        windows_numerics::Vector3,

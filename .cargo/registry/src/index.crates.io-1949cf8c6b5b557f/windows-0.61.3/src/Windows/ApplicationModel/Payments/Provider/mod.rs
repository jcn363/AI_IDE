windows_core::imp::define_interface!(
    ...
    IPaymentAppCanMakePaymentTriggerDetails_Vtbl,
    0x0ce201f0_8b93_4eb6_8c46_2e4a6c6a26f6
);
...
pub struct IPaymentAppCanMakePaymentTriggerDetails_Vtbl {
    ...
    pub ReportCanMakePaymentResult: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPaymentAppManager,
    IPaymentAppManager_Vtbl,
    0x0e47aa53_8521_4969_a957_df2538a3a98f
);
...
windows_core::imp::define_interface!(
    ...
    IPaymentAppManagerStatics_Vtbl,
    0xa341ac28_fc89_4406_b4d9_34e7fe79dfb6
);
...
windows_core::imp::define_interface!(
    IPaymentTransaction,
    IPaymentTransaction_Vtbl,
    0x62581da0_26a5_4e9b_a6eb_66606cf001d3
);
...
pub struct IPaymentTransaction_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub PaymentRequest: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetPayerEmail: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetPayerName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetPayerPhoneNumber: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UpdateShippingAddressAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UpdateSelectedShippingOptionAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AcceptAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IPaymentTransactionAcceptResult_Vtbl,
    0x060e3276_d30c_4817_95a2_df7ae9273b56
);
...
pub struct IPaymentTransactionAcceptResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::PaymentRequestCompletionStatus,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPaymentTransactionStatics,
    IPaymentTransactionStatics_Vtbl,
    0x8d639750_ee0a_4df5_9b1e_1c0f9ec59881
);
...
impl PaymentAppCanMakePaymentTriggerDetails {
        ...
        P0: windows_core::Param<super::PaymentCanMakePaymentResult>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReportCanMakePaymentResult)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
...
impl windows_core::RuntimeType for PaymentAppCanMakePaymentTriggerDetails {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPaymentAppCanMakePaymentTriggerDetails>(
        );
}
unsafe impl windows_core::Interface for PaymentAppCanMakePaymentTriggerDetails {
    ...
    const IID: windows_core::GUID =
        <IPaymentAppCanMakePaymentTriggerDetails as windows_core::Interface>::IID;
}
...
impl PaymentAppManager {
    pub fn RegisterAsync<P0>(
        &self,
        supportedpaymentmethodids: P0,
        ...
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RegisterAsync)(
                windows_core::Interface::as_raw(this),
                supportedpaymentmethodids.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    fn IPaymentAppManagerStatics<
        R,
        F: FnOnce(&IPaymentAppManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for PaymentAppManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPaymentAppManager>();
}
...
impl PaymentTransaction {
    pub fn PaymentRequest(&self) -> windows_core::Result<super::PaymentRequest> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PaymentRequest)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SetPayerEmail(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPayerEmail)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn SetPayerName(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPayerName)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn SetPayerPhoneNumber(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPayerPhoneNumber)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn UpdateShippingAddressAsync<P0>(
        &self,
        shippingaddress: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::PaymentRequestChangedResult>>
    where
        P0: windows_core::Param<super::PaymentAddress>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UpdateShippingAddressAsync)(
                windows_core::Interface::as_raw(this),
                shippingaddress.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn UpdateSelectedShippingOptionAsync<P0>(
        &self,
        selectedshippingoption: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::PaymentRequestChangedResult>>
    where
        P0: windows_core::Param<super::PaymentShippingOption>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UpdateSelectedShippingOptionAsync)(
                windows_core::Interface::as_raw(this),
                selectedshippingoption.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn AcceptAsync<P0>(
        &self,
        paymenttoken: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<PaymentTransactionAcceptResult>>
    where
        P0: windows_core::Param<super::PaymentToken>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AcceptAsync)(
                windows_core::Interface::as_raw(this),
                paymenttoken.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<PaymentTransaction>> {
    ...
    fn IPaymentTransactionStatics<
        R,
        F: FnOnce(&IPaymentTransactionStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for PaymentTransaction {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPaymentTransaction>();
}
...
impl windows_core::RuntimeType for PaymentTransactionAcceptResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPaymentTransactionAcceptResult>();
}
unsafe impl windows_core::Interface for PaymentTransactionAcceptResult {
    ...
    const IID: windows_core::GUID =
        <IPaymentTransactionAcceptResult as windows_core::Interface>::IID;
}

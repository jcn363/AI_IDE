windows_core::imp::define_interface!(
    INamedResource,
    INamedResource_Vtbl,
    0x1c98c219_0b13_4240_89a5_d495dc189a00
);
...
pub struct INamedResource_Vtbl {
    ...
    pub Candidates: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub ResolveForContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ResolveAll: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ResolveAllForContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct IResourceCandidate_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Qualifiers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsMatch:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsMatchAsDefault:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsDefault:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    ...
    pub GetValueAsFileAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
    GetValueAsFileAsync: usize,
    pub GetQualifierValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IResourceCandidate2,
    IResourceCandidate2_Vtbl,
    0x69e5b468_f6fc_4013_aaa2_d53f1757d3b5
);
...
pub struct IResourceCandidate2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Storage_Streams")]
    pub GetValueAsStreamAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
...
windows_core::imp::define_interface!(
    IResourceCandidate3,
    IResourceCandidate3_Vtbl,
    0x08ae97f8_517a_4674_958c_4a3c7cd2cc6b
);
...
windows_core::imp::define_interface!(
    ...
    0x2fa22f4b_707e_4b27_ad0d_d0d8cd468fd2
);
...
pub struct IResourceContext_Vtbl {
    ...
    pub ResetQualifierValues: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OverrideToMatch: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetLanguages: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0x98be9d6c_6338_4b31_99df_b2b442f17149
);
...
pub struct IResourceContextStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateMatchingContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IResourceContextStatics2_Vtbl,
    0x41f752ef_12af_41b9_ab36_b1eb4b512460
);
...
pub struct IResourceContextStatics2_Vtbl {
    ...
    pub SetGlobalQualifierValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ResetGlobalQualifierValues:
    ...
    pub GetForViewIndependentUse: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IResourceContextStatics3_Vtbl,
    0x20cf492c_af0f_450b_9da6_106dd0c29a39
);
...
pub struct IResourceContextStatics3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetGlobalQualifierValueWithPersistence: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IResourceContextStatics4_Vtbl,
    0x22eb9ccd_fb31_4bfa_b86b_df9d9d7bdc39
);
...
pub struct IResourceManager_Vtbl {
    ...
    pub AllResourceMaps: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DefaultContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    ...
    LoadPriFiles: usize,
    #[cfg(feature = "Storage_Streams")]
    pub UnloadPriFiles: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
...
windows_core::imp::define_interface!(
    ...
    0x9d66fe6c_a4d7_4c23_9e85_675f304c252d
);
...
pub struct IResourceManager2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetAllNamedResourcesForPackage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        ResourceLayoutInfo,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetAllSubtreesForPackage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        ResourceLayoutInfo,
        *mut *mut core::ffi::c_void,
...
pub struct IResourceManagerStatics_Vtbl {
    ...
    pub IsResourceReference: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut bool,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IResourceMap,
    IResourceMap_Vtbl,
    0x72284824_db8c_42f8_b08c_53ff357dad82
);
...
pub struct IResourceMap_Vtbl {
    ...
    pub GetValueForContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IResourceQualifier,
    IResourceQualifier_Vtbl,
    0x785da5b2_4afd_4376_a888_c5f9a6b7a05c
);
...
pub struct IResourceQualifier_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub QualifierName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub QualifierValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsDefault:
...
impl NamedResource {
    ...
    pub fn Candidates(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<ResourceCandidate>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Candidates)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<ResourceContext>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResolveForContext)(
                windows_core::Interface::as_raw(this),
                resourcecontext.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub fn ResolveAll(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResolveAll)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ResolveAllForContext<P0>(
        &self,
        resourcecontext: P0,
    ) -> windows_core::Result<windows_collections::IVectorView<ResourceCandidate>>
    where
        P0: windows_core::Param<ResourceContext>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResolveAllForContext)(
                windows_core::Interface::as_raw(this),
                resourcecontext.param().abi(),
                &mut result__,
            )
...
impl windows_core::RuntimeType for NamedResource {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, INamedResource>();
}
...
impl ResourceCandidate {
    pub fn Qualifiers(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<ResourceQualifier>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Qualifiers)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn IsMatch(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsMatch)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsMatchAsDefault(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsMatchAsDefault)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetValueAsFileAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetQualifierValue(
        &self,
        qualifiername: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetQualifierValue)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(qualifiername),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
        }
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetValueAsStreamAsync(
        &self,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<super::super::super::Storage::Streams::IRandomAccessStream>,
    > {
        let this = &windows_core::Interface::cast::<IResourceCandidate2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetValueAsStreamAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for ResourceCandidateKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Resources.Core.ResourceCandidateKind;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
windows_core::imp::interface_hierarchy!(
    ...
    windows_core::IUnknown,
    windows_core::IInspectable,
    windows_collections::IVectorView<ResourceCandidate>
);
windows_core::imp::required_hierarchy!(
    ResourceCandidateVectorView,
    windows_collections::IIterable<ResourceCandidate>
);
impl ResourceCandidateVectorView {
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [Option<ResourceCandidate>],
...
unsafe impl windows_core::Interface for ResourceCandidateVectorView {
    type Vtable =
        <windows_collections::IVectorView<ResourceCandidate> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <windows_collections::IVectorView<ResourceCandidate> as windows_core::Interface>::IID;
}
...
impl ResourceContext {
    ...
    pub fn QualifierValues(
        ...
        super::super::super::Foundation::Collections::IObservableMap<
        ...
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ResetQualifierValues)(
                windows_core::Interface::as_raw(this),
                qualifiernames.param().abi(),
            )
            .ok()
        }
    }
        ...
        P0: windows_core::Param<windows_collections::IIterable<ResourceQualifier>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).OverrideToMatch)(
                windows_core::Interface::as_raw(this),
                result.param().abi(),
            )
            .ok()
        ...
        P0: windows_core::Param<windows_collections::IVectorView<windows_core::HSTRING>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetLanguages)(
                windows_core::Interface::as_raw(this),
                languages.param().abi(),
            )
            .ok()
        ...
        P0: windows_core::Param<windows_collections::IIterable<ResourceQualifier>>,
    {
        Self::IResourceContextStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateMatchingContext)(
                windows_core::Interface::as_raw(this),
                result.param().abi(),
                &mut result__,
            )
    ...
    pub fn SetGlobalQualifierValue(
        key: &windows_core::HSTRING,
        value: &windows_core::HSTRING,
    ) -> windows_core::Result<()> {
        Self::IResourceContextStatics2(|this| unsafe {
            (windows_core::Interface::vtable(this).SetGlobalQualifierValue)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn ResetGlobalQualifierValues() -> windows_core::Result<()> {
        Self::IResourceContextStatics2(|this| unsafe {
            (windows_core::Interface::vtable(this).ResetGlobalQualifierValues)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        })
    }
    pub fn ResetGlobalQualifierValuesForSpecifiedQualifiers<P0>(
        qualifiernames: P0,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::IResourceContextStatics2(|this| unsafe {
            (windows_core::Interface::vtable(this).ResetGlobalQualifierValuesForSpecifiedQualifiers)(windows_core::Interface::as_raw(this), qualifiernames.param().abi()).ok()
        })
    }
    pub fn GetForViewIndependentUse() -> windows_core::Result<ResourceContext> {
        Self::IResourceContextStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForViewIndependentUse)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SetGlobalQualifierValueWithPersistence(
        key: &windows_core::HSTRING,
        value: &windows_core::HSTRING,
        persistence: ResourceQualifierPersistence,
    ) -> windows_core::Result<()> {
        Self::IResourceContextStatics3(|this| unsafe {
            (windows_core::Interface::vtable(this).SetGlobalQualifierValueWithPersistence)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(key),
                core::mem::transmute_copy(value),
                persistence,
    ...
    fn IResourceContextStatics<
        R,
        F: FnOnce(&IResourceContextStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ResourceContext, IResourceContextStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceContextStatics2<
        R,
        F: FnOnce(&IResourceContextStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ResourceContext, IResourceContextStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceContextStatics3<
        R,
        F: FnOnce(&IResourceContextStatics3) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ResourceContext, IResourceContextStatics3> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceContextStatics4<
        R,
        F: FnOnce(&IResourceContextStatics4) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ResourceContext, IResourceContextStatics4> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl ResourceContextLanguagesVectorView {
    pub fn First(
        &self,
    ) -> windows_core::Result<windows_collections::IIterator<windows_core::HSTRING>> {
        let this = &windows_core::Interface::cast::<
            windows_collections::IIterable<windows_core::HSTRING>,
        >(self)?;
        unsafe {
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [windows_core::HSTRING],
    ) -> windows_core::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
unsafe impl windows_core::Interface for ResourceContextLanguagesVectorView {
    ...
    const IID: windows_core::GUID =
        <windows_collections::IVectorView<windows_core::HSTRING> as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for ResourceLayoutInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"struct(Windows.ApplicationModel.Resources.Core.ResourceLayoutInfo;u4;u4;u4;u4;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl ResourceManager {
    ...
    pub fn AllResourceMaps(
        &self,
    ) -> windows_core::Result<windows_collections::IMapView<windows_core::HSTRING, ResourceMap>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllResourceMaps)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn DefaultContext(&self) -> windows_core::Result<ResourceContext> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DefaultContext)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    where
        P0: windows_core::Param<
            windows_collections::IIterable<super::super::super::Storage::IStorageFile>,
        >,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).LoadPriFiles)(
                windows_core::Interface::as_raw(this),
                files.param().abi(),
            )
            .ok()
        ...
        >,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).UnloadPriFiles)(
                windows_core::Interface::as_raw(this),
                files.param().abi(),
            )
            .ok()
    ...
    pub fn GetAllNamedResourcesForPackage(
        &self,
        packagename: &windows_core::HSTRING,
        resourcelayoutinfo: ResourceLayoutInfo,
    ) -> windows_core::Result<windows_collections::IVectorView<NamedResource>> {
        let this = &windows_core::Interface::cast::<IResourceManager2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAllNamedResourcesForPackage)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn GetAllSubtreesForPackage(
        &self,
        packagename: &windows_core::HSTRING,
        resourcelayoutinfo: ResourceLayoutInfo,
    ) -> windows_core::Result<windows_collections::IVectorView<ResourceMap>> {
        let this = &windows_core::Interface::cast::<IResourceManager2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAllSubtreesForPackage)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(packagename),
                resourcelayoutinfo,
                &mut result__,
    ...
    pub fn IsResourceReference(
        resourcereference: &windows_core::HSTRING,
    ) -> windows_core::Result<bool> {
        Self::IResourceManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsResourceReference)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(resourcereference),
                &mut result__,
            )
            .map(|| result__)
        })
...
impl ResourceMap {
    pub fn First(
        ...
        windows_collections::IIterator<
            windows_collections::IKeyValuePair<windows_core::HSTRING, NamedResource>,
        >,
    > {
        let this = &windows_core::Interface::cast::<
    ...
    pub fn Lookup(&self, key: &windows_core::HSTRING) -> windows_core::Result<NamedResource> {
        let this = &windows_core::Interface::cast::<
            windows_collections::IMapView<windows_core::HSTRING, NamedResource>,
        >(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Split(
        &self,
        first: &mut Option<windows_collections::IMapView<windows_core::HSTRING, NamedResource>>,
        second: &mut Option<windows_collections::IMapView<windows_core::HSTRING, NamedResource>>,
    ) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<
            windows_collections::IMapView<windows_core::HSTRING, NamedResource>,
        >(self)?;
        ...
        P1: windows_core::Param<ResourceContext>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetValueForContext)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(resource),
                context.param().abi(),
                &mut result__,
...
unsafe impl windows_core::Interface for ResourceMapIterator {
    type Vtable = <windows_collections::IIterator<
        windows_collections::IKeyValuePair<windows_core::HSTRING, NamedResource>,
...
windows_core::imp::required_hierarchy!(
    ResourceMapMapView,
    windows_collections::IIterable<
        windows_collections::IKeyValuePair<windows_core::HSTRING, ResourceMap>,
    >
);
impl ResourceMapMapView {
    ...
    pub fn Split(
        &self,
        first: &mut Option<windows_collections::IMapView<windows_core::HSTRING, ResourceMap>>,
        second: &mut Option<windows_collections::IMapView<windows_core::HSTRING, ResourceMap>>,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).Split)(
...
impl windows_core::RuntimeType for ResourceMapMapView {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_class::<
        Self,
        windows_collections::IMapView<windows_core::HSTRING, ResourceMap>,
    >();
}
unsafe impl windows_core::Interface for ResourceMapMapView {
    ...
    const IID: windows_core::GUID = <windows_collections::IMapView<
        windows_core::HSTRING,
        ResourceMap,
    > as windows_core::Interface>::IID;
}
...
impl ResourceMapMapViewIterator {
    pub fn Current(
        &self,
    ) -> windows_core::Result<windows_collections::IKeyValuePair<windows_core::HSTRING, ResourceMap>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ResourceQualifier {
    pub fn QualifierName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).QualifierName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn QualifierValue(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).QualifierValue)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn Score(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Score)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for ResourceQualifier {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IResourceQualifier>();
}
...
impl ResourceQualifierObservableMap {
    ...
    where
        P0: windows_core::Param<
            super::super::super::Foundation::Collections::MapChangedEventHandler<
                windows_core::HSTRING,
                windows_core::HSTRING,
            >,
        >,
...
unsafe impl windows_core::Interface for ResourceQualifierObservableMap {
    type Vtable = <super::super::super::Foundation::Collections::IObservableMap<
        windows_core::HSTRING,
        windows_core::HSTRING,
    > as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID = <super::super::super::Foundation::Collections::IObservableMap<
        windows_core::HSTRING,
        windows_core::HSTRING,
    > as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for ResourceQualifierPersistence {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Resources.Core.ResourceQualifierPersistence;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
windows_core::imp::interface_hierarchy!(
    ...
    windows_core::IUnknown,
    windows_core::IInspectable,
    windows_collections::IVectorView<ResourceQualifier>
);
windows_core::imp::required_hierarchy!(
    ResourceQualifierVectorView,
    windows_collections::IIterable<ResourceQualifier>
);
impl ResourceQualifierVectorView {
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [Option<ResourceQualifier>],
    ) -> windows_core::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
unsafe impl windows_core::Interface for ResourceQualifierVectorView {
    type Vtable =
        <windows_collections::IVectorView<ResourceQualifier> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <windows_collections::IVectorView<ResourceQualifier> as windows_core::Interface>::IID;
}

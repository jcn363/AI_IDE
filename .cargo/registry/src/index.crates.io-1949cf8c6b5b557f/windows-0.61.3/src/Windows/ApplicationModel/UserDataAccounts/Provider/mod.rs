windows_core::imp::define_interface!(
    ...
    IUserDataAccountPartnerAccountInfo_Vtbl,
    0x5f200037_f6ef_4ec3_8630_012c59c1149f
);
...
pub struct IUserDataAccountPartnerAccountInfo_Vtbl {
    ...
    pub AccountKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut UserDataAccountProviderPartnerAccountKind,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IUserDataAccountProviderAddAccountOperation,
    IUserDataAccountProviderAddAccountOperation_Vtbl,
    0xb9c72530_3f84_4b5d_8eaa_45e97aa842ed
);
...
pub struct IUserDataAccountProviderAddAccountOperation_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ContentKinds: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::UserDataAccountContentKinds,
    ) -> windows_core::HRESULT,
    pub PartnerAccountInfos: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IUserDataAccountProviderOperation_Vtbl,
...
impl IUserDataAccountProviderOperation_Vtbl {
    pub const fn new<Identity: IUserDataAccountProviderOperation_Impl, const OFFSET: isize>() -> Self
    {
        ...
        >(
            ...
            result__: *mut UserDataAccountProviderOperationKind,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
pub struct IUserDataAccountProviderOperation_Vtbl {
    ...
    pub Kind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut UserDataAccountProviderOperationKind,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IUserDataAccountProviderResolveErrorsOperation,
    IUserDataAccountProviderResolveErrorsOperation_Vtbl,
    0x6235dc15_bfcb_41e1_9957_9759a28846cc
);
...
windows_core::imp::define_interface!(
    ...
    IUserDataAccountProviderSettingsOperation_Vtbl,
    0x92034db7_8648_4f30_acfa_3002658ca80d
);
...
impl UserDataAccountPartnerAccountInfo {
    ...
    pub fn AccountKind(&self) -> windows_core::Result<UserDataAccountProviderPartnerAccountKind> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AccountKind)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for UserDataAccountPartnerAccountInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataAccountPartnerAccountInfo>();
}
unsafe impl windows_core::Interface for UserDataAccountPartnerAccountInfo {
    ...
    const IID: windows_core::GUID =
        <IUserDataAccountPartnerAccountInfo as windows_core::Interface>::IID;
}
...
impl UserDataAccountProviderAddAccountOperation {
    pub fn ContentKinds(&self) -> windows_core::Result<super::UserDataAccountContentKinds> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ContentKinds)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PartnerAccountInfos(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<UserDataAccountPartnerAccountInfo>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PartnerAccountInfos)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
...
unsafe impl windows_core::Interface for UserDataAccountProviderAddAccountOperation {
    ...
    const IID: windows_core::GUID =
        <IUserDataAccountProviderAddAccountOperation as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for UserDataAccountProviderResolveErrorsOperation {
    type Vtable =
        <IUserDataAccountProviderResolveErrorsOperation as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IUserDataAccountProviderResolveErrorsOperation as windows_core::Interface>::IID;
}
...
unsafe impl windows_core::Interface for UserDataAccountProviderSettingsOperation {
    ...
    const IID: windows_core::GUID =
        <IUserDataAccountProviderSettingsOperation as windows_core::Interface>::IID;
}

...
impl windows_core::RuntimeType for AddContactResult {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Contacts.Provider.AddContactResult;i4)",
    );
}
#[repr(transparent)]
...
impl ContactPickerUI {
    ...
    pub fn AddContact<P1>(
        &self,
        id: &windows_core::HSTRING,
        contact: P1,
    ) -> windows_core::Result<AddContactResult>
    where
        P1: windows_core::Param<super::Contact>,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).AddContact)(
    ...
    pub fn RemoveContact(&self, id: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveContact)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(id),
            )
            .ok()
    ...
    pub fn ContainsContact(&self, id: &windows_core::HSTRING) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ContainsContact)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(id),
                &mut result__,
            )
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ContactRemoved)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveContactRemoved(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveContactRemoved)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn DesiredFieldsWithContactFieldType(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<super::ContactFieldType>> {
        let this = &windows_core::Interface::cast::<IContactPickerUI2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for ContactPickerUI {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IContactPickerUI>();
}
...
impl windows_core::RuntimeType for ContactRemovedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IContactRemovedEventArgs>();
}
...
windows_core::imp::define_interface!(
    IContactPickerUI,
    IContactPickerUI_Vtbl,
    0xe2cc1366_cf66_43c4_a96a_a5a112db4746
);
...
pub struct IContactPickerUI_Vtbl {
    ...
    #[cfg(feature = "deprecated")]
    pub AddContact: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut AddContactResult,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "deprecated"))]
    AddContact: usize,
    pub RemoveContact: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ContainsContact: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut bool,
    ) -> windows_core::HRESULT,
    ...
    pub SelectionMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::ContactSelectionMode,
    ) -> windows_core::HRESULT,
    pub ContactRemoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveContactRemoved:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IContactPickerUI2,
    IContactPickerUI2_Vtbl,
    0x6e449e28_7b25_4999_9b0b_875400a1e8c8
);
...
windows_core::imp::define_interface!(
    ...
    IContactRemovedEventArgs_Vtbl,
    0x6f354338_3302_4d13_ad8d_adcc0ff9e47c
);

windows_core::imp::define_interface!(
    IVoiceCommand,
    IVoiceCommand_Vtbl,
    0x936f5273_ec82_42a6_a55c_d2d79ec6f920
);
...
pub struct IVoiceCommand_Vtbl {
    ...
    pub CommandName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub SpeechRecognitionResult: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IVoiceCommandCompletedEventArgs_Vtbl,
    0xc85e675d_fe42_432c_9907_09df9fcf64e8
);
...
pub struct IVoiceCommandCompletedEventArgs_Vtbl {
    ...
    pub Reason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut VoiceCommandCompletionReason,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IVoiceCommandConfirmationResult,
    IVoiceCommandConfirmationResult_Vtbl,
    0xa022593e_8221_4526_b083_840972262247
);
...
windows_core::imp::define_interface!(
    ...
    IVoiceCommandContentTile_Vtbl,
    0x3eefe9f0_b8c7_4c76_a0de_1607895ee327
);
...
pub struct IVoiceCommandContentTile_Vtbl {
    ...
    pub TextLine1: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetTextLine1: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TextLine2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetTextLine2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TextLine3: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetTextLine3: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(not(feature = "Storage_Streams"))]
    SetImage: usize,
    pub AppContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetAppContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AppLaunchArgument: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetAppLaunchArgument: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ContentTileType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut VoiceCommandContentTileType,
    ) -> windows_core::HRESULT,
    pub SetContentTileType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IVoiceCommandDefinition_Vtbl,
    0x7972aad0_0974_4979_984b_cb8959cd61ae
);
...
windows_core::imp::define_interface!(
    ...
    IVoiceCommandDefinitionManagerStatics_Vtbl,
    0x8fe7a69e_067e_4f16_a18c_5b17e9499940
);
...
pub struct IVoiceCommandDefinitionManagerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Storage_Streams")]
    pub InstallCommandDefinitionsFromStorageFileAsync:
    ...
    pub InstalledCommandDefinitions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IVoiceCommandDisambiguationResult_Vtbl,
    0xecc68cfe_c9ac_45df_a8ea_feea08ef9c5e
);
...
windows_core::imp::define_interface!(
    ...
    IVoiceCommandResponse_Vtbl,
    0x0284b30e_8a3b_4cc4_a6a1_cad5be2716b5
);
...
pub struct IVoiceCommandResponse_Vtbl {
    ...
    pub RepeatMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetRepeatMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AppLaunchArgument: unsafe extern "system" fn(
    ...
    pub VoiceCommandContentTiles: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IVoiceCommandResponseStatics_Vtbl,
    0x2932f813_0d3b_49f2_96dd_625019bd3b5d
);
...
pub struct IVoiceCommandResponseStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub MaxSupportedVoiceCommandContentTiles:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub CreateResponse: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateResponseWithTiles: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateResponseForPrompt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateResponseForPromptWithTiles: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IVoiceCommandServiceConnection_Vtbl,
    0xd894bb9f_21da_44a4_98a2_fb131920a9cc
);
...
pub struct IVoiceCommandServiceConnection_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetVoiceCommandAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RequestConfirmationAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RequestDisambiguationAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ReportProgressAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ReportSuccessAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ReportFailureAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RequestAppLaunchAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    Language: usize,
    pub VoiceCommandCompleted: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveVoiceCommandCompleted:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IVoiceCommandServiceConnectionStatics,
    IVoiceCommandServiceConnectionStatics_Vtbl,
    0x370ebffb_2d34_42df_8770_074d0f334697
);
...
pub struct IVoiceCommandServiceConnectionStatics_Vtbl {
    ...
    pub FromAppServiceTriggerDetails: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IVoiceCommandUserMessage_Vtbl,
    0x674eb3c0_44f6_4f07_b979_4c723fc08597
);
...
pub struct IVoiceCommandUserMessage_Vtbl {
    ...
    pub SpokenMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetSpokenMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl VoiceCommand {
    pub fn CommandName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).CommandName)(
    ...
    pub fn SpeechRecognitionResult(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SpeechRecognitionResult)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for VoiceCommand {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVoiceCommand>();
}
...
impl windows_core::RuntimeType for VoiceCommandCompletedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVoiceCommandCompletedEventArgs>();
}
unsafe impl windows_core::Interface for VoiceCommandCompletedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IVoiceCommandCompletedEventArgs as windows_core::Interface>::IID;
}
...
impl VoiceCommandConfirmationResult {
    pub fn Confirmed(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Confirmed)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for VoiceCommandConfirmationResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVoiceCommandConfirmationResult>();
}
unsafe impl windows_core::Interface for VoiceCommandConfirmationResult {
    ...
    const IID: windows_core::GUID =
        <IVoiceCommandConfirmationResult as windows_core::Interface>::IID;
}
...
impl VoiceCommandContentTile {
    ...
    pub fn TextLine1(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TextLine1)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetTextLine1(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetTextLine1)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn TextLine2(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TextLine2)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetTextLine2(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetTextLine2)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn TextLine3(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TextLine3)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetTextLine3(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetTextLine3)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn AppContext(&self) -> windows_core::Result<windows_core::IInspectable> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AppContext)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<windows_core::IInspectable>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAppContext)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn AppLaunchArgument(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AppLaunchArgument)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetAppLaunchArgument(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAppLaunchArgument)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn ContentTileType(&self) -> windows_core::Result<VoiceCommandContentTileType> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ContentTileType)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetContentTileType(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetContentTileType)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for VoiceCommandContentTile {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVoiceCommandContentTile>();
}
...
impl windows_core::RuntimeType for VoiceCommandDefinition {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVoiceCommandDefinition>();
}
...
impl VoiceCommandDefinitionManager {
        ...
        P0: windows_core::Param<super::super::Storage::StorageFile>,
    {
        Self::IVoiceCommandDefinitionManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InstallCommandDefinitionsFromStorageFileAsync)(
                windows_core::Interface::as_raw(this),
                file.param().abi(),
                &mut result__,
            )
    ...
    pub fn InstalledCommandDefinitions() -> windows_core::Result<
        windows_collections::IMapView<windows_core::HSTRING, VoiceCommandDefinition>,
    > {
        Self::IVoiceCommandDefinitionManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InstalledCommandDefinitions)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IVoiceCommandDefinitionManagerStatics<
        R,
        F: FnOnce(&IVoiceCommandDefinitionManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for VoiceCommandDisambiguationResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVoiceCommandDisambiguationResult>();
}
unsafe impl windows_core::Interface for VoiceCommandDisambiguationResult {
    ...
    const IID: windows_core::GUID =
        <IVoiceCommandDisambiguationResult as windows_core::Interface>::IID;
}
...
impl VoiceCommandResponse {
    ...
    pub fn RepeatMessage(&self) -> windows_core::Result<VoiceCommandUserMessage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RepeatMessage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<VoiceCommandUserMessage>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetRepeatMessage)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn VoiceCommandContentTiles(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<VoiceCommandContentTile>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).VoiceCommandContentTiles)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn MaxSupportedVoiceCommandContentTiles() -> windows_core::Result<u32> {
        Self::IVoiceCommandResponseStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxSupportedVoiceCommandContentTiles)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
        ...
        P0: windows_core::Param<VoiceCommandUserMessage>,
    {
        Self::IVoiceCommandResponseStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateResponse)(
                windows_core::Interface::as_raw(this),
                usermessage.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateResponseWithTiles<P0, P1>(
        message: P0,
        contenttiles: P1,
    ) -> windows_core::Result<VoiceCommandResponse>
    where
        P0: windows_core::Param<VoiceCommandUserMessage>,
        P1: windows_core::Param<windows_collections::IIterable<VoiceCommandContentTile>>,
    {
        Self::IVoiceCommandResponseStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateResponseWithTiles)(
                windows_core::Interface::as_raw(this),
                message.param().abi(),
                contenttiles.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateResponseForPrompt<P0, P1>(
        message: P0,
        repeatmessage: P1,
    ) -> windows_core::Result<VoiceCommandResponse>
    where
        ...
        P1: windows_core::Param<VoiceCommandUserMessage>,
    {
        Self::IVoiceCommandResponseStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateResponseForPrompt)(
                windows_core::Interface::as_raw(this),
                message.param().abi(),
                repeatmessage.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateResponseForPromptWithTiles<P0, P1, P2>(
        message: P0,
        repeatmessage: P1,
        contenttiles: P2,
    ) -> windows_core::Result<VoiceCommandResponse>
        ...
        P2: windows_core::Param<windows_collections::IIterable<VoiceCommandContentTile>>,
    {
        Self::IVoiceCommandResponseStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateResponseForPromptWithTiles)(
                windows_core::Interface::as_raw(this),
                message.param().abi(),
                repeatmessage.param().abi(),
                contenttiles.param().abi(),
    ...
    fn IVoiceCommandResponseStatics<
        R,
        F: FnOnce(&IVoiceCommandResponseStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for VoiceCommandResponse {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVoiceCommandResponse>();
}
...
impl VoiceCommandServiceConnection {
    pub fn GetVoiceCommandAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<VoiceCommand>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetVoiceCommandAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn RequestConfirmationAsync<P0>(
        &self,
        response: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<VoiceCommandConfirmationResult>>
    where
        P0: windows_core::Param<VoiceCommandResponse>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestConfirmationAsync)(
                windows_core::Interface::as_raw(this),
                response.param().abi(),
                &mut result__,
            )
    ...
    pub fn RequestDisambiguationAsync<P0>(
        &self,
        response: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<VoiceCommandDisambiguationResult>>
    where
        P0: windows_core::Param<VoiceCommandResponse>,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestDisambiguationAsync)(
                windows_core::Interface::as_raw(this),
                response.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<VoiceCommandResponse>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReportProgressAsync)(
                windows_core::Interface::as_raw(this),
                response.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<VoiceCommandResponse>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReportSuccessAsync)(
                windows_core::Interface::as_raw(this),
                response.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<VoiceCommandResponse>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReportFailureAsync)(
                windows_core::Interface::as_raw(this),
                response.param().abi(),
                &mut result__,
            )
    ...
    pub fn RequestAppLaunchAsync<P0>(
        &self,
        response: P0,
    ) -> windows_core::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<VoiceCommandResponse>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestAppLaunchAsync)(
                windows_core::Interface::as_raw(this),
                response.param().abi(),
                &mut result__,
            )
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).VoiceCommandCompleted)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveVoiceCommandCompleted(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveVoiceCommandCompleted)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    #[cfg(feature = "ApplicationModel_AppService")]
    pub fn FromAppServiceTriggerDetails<P0>(
        triggerdetails: P0,
    ) -> windows_core::Result<VoiceCommandServiceConnection>
    where
        P0: windows_core::Param<super::AppService::AppServiceTriggerDetails>,
    {
        Self::IVoiceCommandServiceConnectionStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromAppServiceTriggerDetails)(
                windows_core::Interface::as_raw(this),
    ...
    fn IVoiceCommandServiceConnectionStatics<
        R,
        F: FnOnce(&IVoiceCommandServiceConnectionStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for VoiceCommandServiceConnection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVoiceCommandServiceConnection>();
}
unsafe impl windows_core::Interface for VoiceCommandServiceConnection {
    ...
    const IID: windows_core::GUID =
        <IVoiceCommandServiceConnection as windows_core::Interface>::IID;
}
...
impl VoiceCommandUserMessage {
    ...
    pub fn SpokenMessage(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SpokenMessage)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetSpokenMessage(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSpokenMessage)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
...
impl windows_core::RuntimeType for VoiceCommandUserMessage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVoiceCommandUserMessage>();
}

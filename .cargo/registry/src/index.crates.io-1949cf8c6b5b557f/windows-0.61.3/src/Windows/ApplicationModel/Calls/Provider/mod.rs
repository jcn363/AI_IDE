...
pub struct IPhoneCallOrigin_Vtbl {
    ...
    pub CategoryDescription: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetCategoryDescription: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct IPhoneCallOrigin3_Vtbl {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub SetDisplayPicture: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
...
pub struct IPhoneCallOriginManagerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsCurrentAppActiveCallOriginApp:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub ShowPhoneCallOriginSettingsUI:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub SetCallOrigin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct IPhoneCallOriginManagerStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RequestSetAsActiveCallOriginAppAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
...
impl PhoneCallOrigin {
    ...
    pub fn CategoryDescription(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CategoryDescription)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetCategoryDescription(
        &self,
        value: &windows_core::HSTRING,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetCategoryDescription)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn DisplayPicture(
        &self,
    ) -> windows_core::Result<super::super::super::Storage::StorageFile> {
        ...
        P0: windows_core::Param<super::super::super::Storage::StorageFile>,
    {
        let this = &windows_core::Interface::cast::<IPhoneCallOrigin3>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetDisplayPicture)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
...
impl windows_core::RuntimeType for PhoneCallOrigin {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPhoneCallOrigin>();
}
#[cfg(feature = "deprecated")]
...
impl PhoneCallOriginManager {
    pub fn IsCurrentAppActiveCallOriginApp() -> windows_core::Result<bool> {
        Self::IPhoneCallOriginManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsCurrentAppActiveCallOriginApp)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ShowPhoneCallOriginSettingsUI() -> windows_core::Result<()> {
        Self::IPhoneCallOriginManagerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).ShowPhoneCallOriginSettingsUI)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        })
    }
    pub fn SetCallOrigin<P1>(
    ...
    {
        Self::IPhoneCallOriginManagerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).SetCallOrigin)(
                windows_core::Interface::as_raw(this),
                requestid,
                callorigin.param().abi(),
            )
            .ok()
        })
    }
    pub fn RequestSetAsActiveCallOriginAppAsync(
    ) -> windows_core::Result<windows_future::IAsyncOperation<bool>> {
        Self::IPhoneCallOriginManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestSetAsActiveCallOriginAppAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IPhoneCallOriginManagerStatics<
        R,
        F: FnOnce(&IPhoneCallOriginManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IPhoneCallOriginManagerStatics2<
        R,
        F: FnOnce(&IPhoneCallOriginManagerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IPhoneCallOriginManagerStatics3<
        R,
        F: FnOnce(&IPhoneCallOriginManagerStatics3) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<

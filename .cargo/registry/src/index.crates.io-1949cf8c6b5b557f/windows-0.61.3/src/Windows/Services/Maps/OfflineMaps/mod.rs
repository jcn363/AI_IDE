windows_core::imp::define_interface!(
    IOfflineMapPackage,
    IOfflineMapPackage_Vtbl,
    0xa797673b_a5b5_4144_b525_e68c8862664b
);
...
pub struct IOfflineMapPackage_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut OfflineMapPackageStatus,
    ) -> windows_core::HRESULT,
    pub DisplayName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub EnclosingRegionName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub EstimatedSizeInBytes:
    ...
    pub RequestStartDownloadAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IOfflineMapPackageQueryResult_Vtbl,
    0x55585411_39e1_4e41_a4e1_5f4872bee199
);
...
pub struct IOfflineMapPackageQueryResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut OfflineMapPackageQueryStatus,
    ) -> windows_core::HRESULT,
    pub Packages: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0xd965b918_d4d6_4afe_9378_3ec71ef11c3d
);
...
pub struct IOfflineMapPackageStartDownloadResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut OfflineMapPackageStartDownloadStatus,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IOfflineMapPackageStatics,
    IOfflineMapPackageStatics_Vtbl,
    0x185e7922_a831_4ab0_941f_6998fa929285
);
...
pub struct IOfflineMapPackageStatics_Vtbl {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub FindPackagesInBoundingBoxAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub FindPackagesInGeocircleAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl OfflineMapPackage {
    ...
    pub fn EnclosingRegionName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EnclosingRegionName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn EstimatedSizeInBytes(&self) -> windows_core::Result<u64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EstimatedSizeInBytes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn RequestStartDownloadAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<OfflineMapPackageStartDownloadResult>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestStartDownloadAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn FindPackagesAsync<P0>(
        querypoint: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<OfflineMapPackageQueryResult>>
    where
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindPackagesInBoundingBoxAsync<P0>(
        queryboundingbox: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<OfflineMapPackageQueryResult>>
    where
        P0: windows_core::Param<super::super::super::Devices::Geolocation::GeoboundingBox>,
    {
        Self::IOfflineMapPackageStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindPackagesInBoundingBoxAsync)(
                windows_core::Interface::as_raw(this),
                queryboundingbox.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindPackagesInGeocircleAsync<P0>(
        querycircle: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<OfflineMapPackageQueryResult>>
    where
        P0: windows_core::Param<super::super::super::Devices::Geolocation::Geocircle>,
    {
        Self::IOfflineMapPackageStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindPackagesInGeocircleAsync)(
                windows_core::Interface::as_raw(this),
                querycircle.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    ...
    fn IOfflineMapPackageStatics<
        R,
        F: FnOnce(&IOfflineMapPackageStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for OfflineMapPackage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOfflineMapPackage>();
}
...
impl OfflineMapPackageQueryResult {
    ...
    pub fn Packages(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<OfflineMapPackage>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Packages)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for OfflineMapPackageQueryResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOfflineMapPackageQueryResult>();
}
...
impl windows_core::RuntimeType for OfflineMapPackageQueryStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Services.Maps.OfflineMaps.OfflineMapPackageQueryStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for OfflineMapPackageStartDownloadResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOfflineMapPackageStartDownloadResult>();
}
unsafe impl windows_core::Interface for OfflineMapPackageStartDownloadResult {
    ...
    const IID: windows_core::GUID =
        <IOfflineMapPackageStartDownloadResult as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for OfflineMapPackageStartDownloadStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Services.Maps.OfflineMaps.OfflineMapPackageStartDownloadStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for OfflineMapPackageStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Services.Maps.OfflineMaps.OfflineMapPackageStatus;i4)",
    );
}

windows_core::imp::define_interface!(
    ...
    ITargetedContentAction_Vtbl,
    0xd75b691e_6cd6_4ca0_9d8f_4728b0b7e6b6
);
...
windows_core::imp::define_interface!(
    ...
    ITargetedContentAvailabilityChangedEventArgs_Vtbl,
    0xe0f59d26_5927_4450_965c_1ceb7becde65
);
...
windows_core::imp::define_interface!(
    ...
    ITargetedContentChangedEventArgs_Vtbl,
    0x99d488c9_587e_4586_8ef7_b54ca9453a16
);
...
pub struct ITargetedContentChangedEventArgs_Vtbl {
    ...
    pub HasPreviousContentExpired:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ITargetedContentCollection,
    ITargetedContentCollection_Vtbl,
    0x2d4b66c5_f163_44ba_9f6e_e1a4c2bb559d
);
...
pub struct ITargetedContentCollection_Vtbl {
    ...
    pub ReportInteraction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        TargetedContentInteraction,
    ) -> windows_core::HRESULT,
    pub ReportCustomInteraction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ITargetedContentContainer_Vtbl,
    0xbc2494c9_8837_47c2_850f_d79d64595926
);
...
pub struct ITargetedContentContainer_Vtbl {
    ...
    pub Availability: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut TargetedContentAvailability,
    ) -> windows_core::HRESULT,
    pub Content: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SelectSingleObject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ITargetedContentContainerStatics_Vtbl,
    0x5b47e7fb_2140_4c1f_a736_c59583f227d8
);
...
windows_core::imp::define_interface!(
    ...
    ITargetedContentImage_Vtbl,
    0xa7a585d9_779f_4b1e_bbb1_8eaf53fbeab2
);
#[cfg(feature = "Storage_Streams")]
...
windows_core::imp::define_interface!(
    ...
    ITargetedContentItem_Vtbl,
    0x38168dc4_276c_4c32_96ba_565c6e406e74
);
...
windows_core::imp::define_interface!(
    ...
    ITargetedContentItemState_Vtbl,
...
pub struct ITargetedContentItemState_Vtbl {
    ...
    pub ShouldDisplay:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub AppInstallationState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut TargetedContentAppInstallationState,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ITargetedContentObject,
    ITargetedContentObject_Vtbl,
    0x041d7969_2212_42d1_9dfa_88a8e3033aa3
);
...
pub struct ITargetedContentObject_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ObjectKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut TargetedContentObjectKind,
    ) -> windows_core::HRESULT,
    pub Collection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ITargetedContentStateChangedEventArgs_Vtbl,
    0x9a1cef3d_8073_4416_8df2_546835a6414f
);
...
windows_core::imp::define_interface!(
    ...
    ITargetedContentSubscription_Vtbl,
    0x882c2c49_c652_4c7a_acad_1f7fa2986c73
);
...
pub struct ITargetedContentSubscription_Vtbl {
    ...
    pub GetContentContainerAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct ITargetedContentSubscriptionOptions_Vtbl {
    ...
    pub AllowPartialContentAvailability:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetAllowPartialContentAvailability:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub CloudQueryParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub LocalFilters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ITargetedContentSubscriptionStatics_Vtbl,
    0xfaddfe80_360d_4916_b53c_7ea27090d02a
);
...
windows_core::imp::define_interface!(
    ...
    ITargetedContentValue_Vtbl,
    0xaafde4b3_4215_4bf8_867f_43f04865f9bf
);
...
pub struct ITargetedContentValue_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ValueKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut TargetedContentValueKind,
    ) -> windows_core::HRESULT,
    pub Path: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    File: usize,
    #[cfg(feature = "Storage_Streams")]
    pub ImageFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
    ...
    pub Strings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Uris: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Numbers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Booleans: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    ...
    Files: usize,
    #[cfg(feature = "Storage_Streams")]
    pub ImageFiles: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
...
impl TargetedContentAction {
    pub fn InvokeAsync(&self) -> windows_core::Result<windows_future::IAsyncAction> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).InvokeAsync)(
...
impl windows_core::RuntimeType for TargetedContentAction {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITargetedContentAction>();
}
...
impl windows_core::RuntimeType for TargetedContentAppInstallationState {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Services.TargetedContent.TargetedContentAppInstallationState;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for TargetedContentAvailability {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Services.TargetedContent.TargetedContentAvailability;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
unsafe impl windows_core::Interface for TargetedContentAvailabilityChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ITargetedContentAvailabilityChangedEventArgs as windows_core::Interface>::IID;
}
...
impl TargetedContentChangedEventArgs {
    ...
    pub fn HasPreviousContentExpired(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HasPreviousContentExpired)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for TargetedContentChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITargetedContentChangedEventArgs>();
}
unsafe impl windows_core::Interface for TargetedContentChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ITargetedContentChangedEventArgs as windows_core::Interface>::IID;
}
...
impl TargetedContentCollection {
    ...
    pub fn ReportInteraction(
        &self,
        interaction: TargetedContentInteraction,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReportInteraction)(
                windows_core::Interface::as_raw(this),
                interaction,
            )
            .ok()
    ...
    pub fn ReportCustomInteraction(
        &self,
        custominteractionname: &windows_core::HSTRING,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReportCustomInteraction)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(custominteractionname),
            )
            .ok()
        }
    }
    ...
    pub fn Properties(
        ...
        windows_collections::IMapView<windows_core::HSTRING, TargetedContentValue>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Collections(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<TargetedContentCollection>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Items(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<TargetedContentItem>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for TargetedContentCollection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITargetedContentCollection>();
}
...
impl TargetedContentContainer {
    ...
    pub fn SelectSingleObject(
        &self,
        path: &windows_core::HSTRING,
    ) -> windows_core::Result<TargetedContentObject> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SelectSingleObject)(
                windows_core::Interface::as_raw(this),
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<TargetedContentContainer>> {
    ...
    fn ITargetedContentContainerStatics<
        R,
        F: FnOnce(&ITargetedContentContainerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for TargetedContentContainer {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITargetedContentContainer>();
}
...
impl windows_core::RuntimeType for TargetedContentImage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITargetedContentImage>();
}
#[cfg(feature = "Storage_Streams")]
...
impl windows_core::RuntimeType for TargetedContentInteraction {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Services.TargetedContent.TargetedContentInteraction;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for TargetedContentItem {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITargetedContentItem>();
}
...
impl TargetedContentItemState {
    pub fn ShouldDisplay(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShouldDisplay)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn AppInstallationState(
        &self,
    ) -> windows_core::Result<TargetedContentAppInstallationState> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AppInstallationState)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for TargetedContentItemState {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITargetedContentItemState>();
}
...
impl TargetedContentObject {
    pub fn ObjectKind(&self) -> windows_core::Result<TargetedContentObjectKind> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ObjectKind)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn Collection(&self) -> windows_core::Result<TargetedContentCollection> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Collection)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for TargetedContentObject {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITargetedContentObject>();
}
...
impl windows_core::RuntimeType for TargetedContentObjectKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Services.TargetedContent.TargetedContentObjectKind;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for TargetedContentStateChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITargetedContentStateChangedEventArgs>();
}
unsafe impl windows_core::Interface for TargetedContentStateChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ITargetedContentStateChangedEventArgs as windows_core::Interface>::IID;
}
...
impl TargetedContentSubscription {
    ...
    pub fn GetContentContainerAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<TargetedContentContainer>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetContentContainerAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetAsync(
        subscriptionid: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<TargetedContentSubscription>> {
        Self::ITargetedContentSubscriptionStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(subscriptionid),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    ...
    pub fn GetOptions(
        subscriptionid: &windows_core::HSTRING,
    ) -> windows_core::Result<TargetedContentSubscriptionOptions> {
        Self::ITargetedContentSubscriptionStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetOptions)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(subscriptionid),
                &mut result__,
            )
    ...
    fn ITargetedContentSubscriptionStatics<
        R,
        F: FnOnce(&ITargetedContentSubscriptionStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for TargetedContentSubscription {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITargetedContentSubscription>();
}
...
impl TargetedContentSubscriptionOptions {
    ...
    pub fn AllowPartialContentAvailability(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllowPartialContentAvailability)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAllowPartialContentAvailability(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAllowPartialContentAvailability)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    ) -> windows_core::Result<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>>
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CloudQueryParameters)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn LocalFilters(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LocalFilters)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for TargetedContentSubscriptionOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITargetedContentSubscriptionOptions>();
}
unsafe impl windows_core::Interface for TargetedContentSubscriptionOptions {
    ...
    const IID: windows_core::GUID =
        <ITargetedContentSubscriptionOptions as windows_core::Interface>::IID;
}
...
impl TargetedContentValue {
    pub fn ValueKind(&self) -> windows_core::Result<TargetedContentValueKind> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ValueKind)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ImageFile(&self) -> windows_core::Result<TargetedContentImage> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ImageFile)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Strings(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Strings)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Uris(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Uris)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Numbers(&self) -> windows_core::Result<windows_collections::IVectorView<f64>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Numbers)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Booleans(&self) -> windows_core::Result<windows_collections::IVectorView<bool>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Booleans)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Files(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<TargetedContentFile>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ImageFiles(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<TargetedContentImage>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ImageFiles)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Actions(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<TargetedContentAction>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for TargetedContentValue {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITargetedContentValue>();
}
...
impl windows_core::RuntimeType for TargetedContentValueKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Services.TargetedContent.TargetedContentValueKind;i4)",
    );
}

...
impl windows_core::RuntimeType for AlternateNormalizationFormat {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Data.Text.AlternateNormalizationFormat;i4)",
    );
}
#[repr(transparent)]
...
impl AlternateWordForm {
    pub fn SourceTextSegment(&self) -> windows_core::Result<TextSegment> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).SourceTextSegment)(
    ...
    pub fn AlternateText(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AlternateText)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn NormalizationFormat(&self) -> windows_core::Result<AlternateNormalizationFormat> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NormalizationFormat)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for AlternateWordForm {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAlternateWordForm>();
}
...
windows_core::imp::define_interface!(
    ...
    0x47396c1e_51b9_4207_9146_248e636a1d1d
);
...
pub struct IAlternateWordForm_Vtbl {
    ...
    pub SourceTextSegment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut TextSegment,
    ) -> windows_core::HRESULT,
    pub AlternateText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub NormalizationFormat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut AlternateNormalizationFormat,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ISelectableWordSegment,
    ISelectableWordSegment_Vtbl,
    0x916a4cb7_8aa7_4c78_b374_5dedb752e60b
);
...
windows_core::imp::define_interface!(
    ...
    ISelectableWordsSegmenter_Vtbl,
    0xf6dc31e7_4b13_45c5_8897_7d71269e085d
);
...
pub struct ISelectableWordsSegmenter_Vtbl {
    ...
    pub GetTokenAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetTokens: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ISelectableWordsSegmenterFactory_Vtbl,
    0x8c7a7648_6057_4339_bc70_f210010a4150
);
...
pub struct ISelectableWordsSegmenterFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateWithLanguage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ISemanticTextQuery,
    ISemanticTextQuery_Vtbl,
    0x6a1cab51_1fb2_4909_80b8_35731a2b3e7f
);
...
pub struct ISemanticTextQuery_Vtbl {
    ...
    pub FindInProperty: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    ISemanticTextQueryFactory_Vtbl,
    0x238c0503_f995_4587_8777_a2b7d80acfef
);
...
windows_core::imp::define_interface!(
    ...
    ITextConversionGenerator_Vtbl,
    0x03606a5e_2aa9_4ab6_af8b_a562b63a8992
);
...
pub struct ITextConversionGenerator_Vtbl {
    ...
    pub LanguageAvailableButNotInstalled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub GetCandidatesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetCandidatesWithMaxCountAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    ITextConversionGeneratorFactory_Vtbl,
    0xfcaa3781_3083_49ab_be15_56dfbbb74d6f
);
...
windows_core::imp::define_interface!(
    ITextPhoneme,
    ITextPhoneme_Vtbl,
    0x9362a40a_9b7a_4569_94cf_d84f2f38cf9b
);
...
pub struct ITextPhoneme_Vtbl {
    ...
    pub ReadingText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    ITextPredictionGenerator_Vtbl,
    0x5eacab07_abf1_4cb6_9d9e_326f2b468756
);
...
windows_core::imp::define_interface!(
    ...
    ITextPredictionGenerator2_Vtbl,
    0xb84723b8_2c77_486a_900a_a3453eedc15d
);
...
pub struct ITextPredictionGenerator2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetCandidatesWithParametersAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ...
    pub GetNextWordCandidatesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    pub InputScope: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::UI::Text::Core::CoreTextInputScope,
    ) -> windows_core::HRESULT,
    ...
    pub SetInputScope: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::UI::Text::Core::CoreTextInputScope,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "UI_Text_Core"))]
    SetInputScope: usize,
}
windows_core::imp::define_interface!(
    ...
    ITextPredictionGeneratorFactory_Vtbl,
    0x7257b416_8ba2_4751_9d30_9d85435653a2
);
...
windows_core::imp::define_interface!(
    ...
    0x51e7f514_9c51_4d86_ae1b_b498fbad8313
);
...
pub struct ITextReverseConversionGenerator_Vtbl {
    ...
    pub LanguageAvailableButNotInstalled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub ConvertBackAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ITextReverseConversionGenerator2_Vtbl,
    0x1aafd2ec_85d6_46fd_828a_3a4830fa6e18
);
...
pub struct ITextReverseConversionGenerator2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetPhonemesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ITextReverseConversionGeneratorFactory_Vtbl,
    0x63bed326_1fda_41f6_89d5_23ddea3c729a
);
...
windows_core::imp::define_interface!(
    ...
    IUnicodeCharactersStatics_Vtbl,
    0x97909e87_9291_4f91_b6c8_b6e359d7a7fb
);
...
pub struct IUnicodeCharactersStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetCodepointFromSurrogatePair: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetSurrogatePairFromCodepoint: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u16,
        *mut u16,
    ...
    pub IsGraphemeBase:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut bool) -> windows_core::HRESULT,
    pub IsGraphemeExtend:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut bool) -> windows_core::HRESULT,
    pub GetNumericType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut UnicodeNumericType,
    ) -> windows_core::HRESULT,
    pub GetGeneralCategory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut UnicodeGeneralCategory,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWordSegment,
...
pub struct IWordSegment_Vtbl {
    ...
    pub AlternateForms: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWordsSegmenter,
    IWordsSegmenter_Vtbl,
    0x86b4d4d1_b2fe_4e34_a81d_66640300454f
);
...
windows_core::imp::define_interface!(
    ...
    IWordsSegmenterFactory_Vtbl,
    0xe6977274_fc35_455c_8bfb_6d7f4653ca97
);
...
impl windows_core::RuntimeType for SelectableWordSegment {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISelectableWordSegment>();
}
...
impl SelectableWordSegmentsTokenizingHandler {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, windows_collections::IIterable<SelectableWordSegment>>,
                windows_core::Ref<'_, windows_collections::IIterable<SelectableWordSegment>>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        ...
        let com = SelectableWordSegmentsTokenizingHandlerBox {
            vtable: &SelectableWordSegmentsTokenizingHandlerBox::<F>::VTABLE,
...
pub struct SelectableWordSegmentsTokenizingHandler_Vtbl {
    ...
    Invoke: unsafe extern "system" fn(
        ...
        precedingwords: *mut core::ffi::c_void,
        words: *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
#[repr(C)]
...
impl<
        F: FnMut(
            ...
            + Send
            + 'static,
    > SelectableWordSegmentsTokenizingHandlerBox<F>
{
    const VTABLE: SelectableWordSegmentsTokenizingHandler_Vtbl =
        SelectableWordSegmentsTokenizingHandler_Vtbl {
            base__: windows_core::IUnknown_Vtbl {
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid
                == <SelectableWordSegmentsTokenizingHandler as windows_core::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        unsafe {
            ...
            (this.invoke)(
                core::mem::transmute_copy(&precedingwords),
                core::mem::transmute_copy(&words),
            )
            .into()
        }
    }
...
impl SelectableWordsSegmenter {
    ...
    pub fn GetTokenAt(
        ...
        startindex: u32,
    ) -> windows_core::Result<SelectableWordSegment> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetTokenAt)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn GetTokens(
        &self,
        text: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_collections::IVectorView<SelectableWordSegment>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetTokens)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(text),
                &mut result__,
            )
        ...
        P2: windows_core::Param<SelectableWordSegmentsTokenizingHandler>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).Tokenize)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(text),
                startindex,
                handler.param().abi(),
    ...
    pub fn CreateWithLanguage(
        language: &windows_core::HSTRING,
    ) -> windows_core::Result<SelectableWordsSegmenter> {
        Self::ISelectableWordsSegmenterFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithLanguage)(
                windows_core::Interface::as_raw(this),
    ...
    fn ISelectableWordsSegmenterFactory<
        R,
        F: FnOnce(&ISelectableWordsSegmenterFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for SelectableWordsSegmenter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISelectableWordsSegmenter>();
}
...
impl SemanticTextQuery {
    ...
    ) -> windows_core::Result<windows_collections::IVectorView<TextSegment>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Find)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn FindInProperty(
        &self,
        propertycontent: &windows_core::HSTRING,
        propertyname: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_collections::IVectorView<TextSegment>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindInProperty)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(propertycontent),
    ...
    pub fn CreateWithLanguage(
        ...
        filterlanguage: &windows_core::HSTRING,
    ) -> windows_core::Result<SemanticTextQuery> {
        Self::ISemanticTextQueryFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithLanguage)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(aqsfilter),
                core::mem::transmute_copy(filterlanguage),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    ...
    fn ISemanticTextQueryFactory<
        R,
        F: FnOnce(&ISemanticTextQueryFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for SemanticTextQuery {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISemanticTextQuery>();
}
...
impl TextConversionGenerator {
    ...
    pub fn LanguageAvailableButNotInstalled(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LanguageAvailableButNotInstalled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCandidatesAsync)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn GetCandidatesWithMaxCountAsync(
        &self,
        input: &windows_core::HSTRING,
        maxcandidates: u32,
    ) -> windows_core::Result<
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCandidatesWithMaxCountAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(input),
                maxcandidates,
                &mut result__,
    ...
    ) -> windows_core::Result<TextConversionGenerator> {
    ...
    fn ITextConversionGeneratorFactory<
        R,
        F: FnOnce(&ITextConversionGeneratorFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for TextConversionGenerator {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITextConversionGenerator>();
}
...
impl TextPhoneme {
    ...
    pub fn ReadingText(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReadingText)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for TextPhoneme {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITextPhoneme>();
}
...
impl TextPredictionGenerator {
    ...
    pub fn GetCandidatesWithParametersAsync<P3>(
        &self,
        input: &windows_core::HSTRING,
        maxcandidates: u32,
        ...
        P3: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCandidatesWithParametersAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(input),
                maxcandidates,
                predictionoptions,
                previousstrings.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn GetNextWordCandidatesAsync<P1>(
        &self,
        maxcandidates: u32,
        previousstrings: P1,
    ) -> windows_core::Result<
        ...
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNextWordCandidatesAsync)(
                windows_core::Interface::as_raw(this),
                maxcandidates,
                previousstrings.param().abi(),
                &mut result__,
    ...
    pub fn InputScope(
        &self,
    ) -> windows_core::Result<super::super::UI::Text::Core::CoreTextInputScope> {
        let this = &windows_core::Interface::cast::<ITextPredictionGenerator2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Text_Core")]
    pub fn SetInputScope(
        &self,
        value: super::super::UI::Text::Core::CoreTextInputScope,
    ) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<ITextPredictionGenerator2>(self)?;
        unsafe {
    ...
    pub fn Create(
        languagetag: &windows_core::HSTRING,
    ) -> windows_core::Result<TextPredictionGenerator> {
    ...
    fn ITextPredictionGeneratorFactory<
        R,
        F: FnOnce(&ITextPredictionGeneratorFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for TextPredictionGenerator {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITextPredictionGenerator>();
}
...
impl windows_core::RuntimeType for TextPredictionOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Data.Text.TextPredictionOptions;u4)",
    );
}
impl TextPredictionOptions {
...
impl TextReverseConversionGenerator {
    ...
    pub fn ConvertBackAsync(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConvertBackAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(input),
                &mut result__,
            )
    ...
    pub fn GetPhonemesAsync(
        &self,
        input: &windows_core::HSTRING,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<windows_collections::IVectorView<TextPhoneme>>,
    > {
        let this = &windows_core::Interface::cast::<ITextReverseConversionGenerator2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPhonemesAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(input),
                &mut result__,
            )
    ...
    pub fn Create(
        languagetag: &windows_core::HSTRING,
    ) -> windows_core::Result<TextReverseConversionGenerator> {
    ...
    fn ITextReverseConversionGeneratorFactory<
        R,
        F: FnOnce(&ITextReverseConversionGeneratorFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for TextReverseConversionGenerator {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITextReverseConversionGenerator>();
}
unsafe impl windows_core::Interface for TextReverseConversionGenerator {
    ...
    const IID: windows_core::GUID =
        <ITextReverseConversionGenerator as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for TextSegment {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"struct(Windows.Data.Text.TextSegment;u4;u4)");
}
pub struct UnicodeCharacters;
impl UnicodeCharacters {
    pub fn GetCodepointFromSurrogatePair(
        highsurrogate: u32,
        lowsurrogate: u32,
    ) -> windows_core::Result<u32> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCodepointFromSurrogatePair)(
                windows_core::Interface::as_raw(this),
                highsurrogate,
                lowsurrogate,
                &mut result__,
    ...
    pub fn GetSurrogatePairFromCodepoint(
        codepoint: u32,
        highsurrogate: &mut u16,
        lowsurrogate: &mut u16,
    ) -> windows_core::Result<()> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).GetSurrogatePairFromCodepoint)(
                windows_core::Interface::as_raw(this),
                codepoint,
                highsurrogate,
                lowsurrogate,
    ...
    pub fn IsHighSurrogate(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsHighSurrogate)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn IsLowSurrogate(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsLowSurrogate)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn IsSupplementary(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsSupplementary)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn IsNoncharacter(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsNoncharacter)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn IsWhitespace(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsWhitespace)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn IsAlphabetic(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsAlphabetic)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn IsCased(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsCased)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn IsUppercase(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsUppercase)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn IsLowercase(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsLowercase)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn IsIdStart(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsIdStart)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn IsIdContinue(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsIdContinue)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn IsGraphemeBase(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsGraphemeBase)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn IsGraphemeExtend(codepoint: u32) -> windows_core::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsGraphemeExtend)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn GetNumericType(codepoint: u32) -> windows_core::Result<UnicodeNumericType> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNumericType)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    pub fn GetGeneralCategory(codepoint: u32) -> windows_core::Result<UnicodeGeneralCategory> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetGeneralCategory)(
                windows_core::Interface::as_raw(this),
                codepoint,
                &mut result__,
            )
    ...
    fn IUnicodeCharactersStatics<
        R,
        F: FnOnce(&IUnicodeCharactersStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for UnicodeGeneralCategory {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Data.Text.UnicodeGeneralCategory;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for UnicodeNumericType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Data.Text.UnicodeNumericType;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl WordSegment {
    ...
    pub fn AlternateForms(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<AlternateWordForm>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AlternateForms)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for WordSegment {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWordSegment>();
}
...
impl WordSegmentsTokenizingHandler {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, windows_collections::IIterable<WordSegment>>,
                windows_core::Ref<'_, windows_collections::IIterable<WordSegment>>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        ...
        let com = WordSegmentsTokenizingHandlerBox {
            vtable: &WordSegmentsTokenizingHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
#[repr(C)]
struct WordSegmentsTokenizingHandlerBox<
    F: FnMut(
            windows_core::Ref<'_, windows_collections::IIterable<WordSegment>>,
            windows_core::Ref<'_, windows_collections::IIterable<WordSegment>>,
        ) -> windows_core::Result<()>
...
impl<
        F: FnMut(
            ...
            + Send
            + 'static,
    > WordSegmentsTokenizingHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <WordSegmentsTokenizingHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _
...
impl WordsSegmenter {
    ...
    pub fn GetTokenAt(
        ...
        text: &windows_core::HSTRING,
        startindex: u32,
    ) -> windows_core::Result<WordSegment> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetTokenAt)(
    ...
    pub fn GetTokens(
        &self,
        text: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_collections::IVectorView<WordSegment>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetTokens)(
    ...
    pub fn CreateWithLanguage(
        language: &windows_core::HSTRING,
    ) -> windows_core::Result<WordsSegmenter> {
    ...
    fn IWordsSegmenterFactory<R, F: FnOnce(&IWordsSegmenterFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<WordsSegmenter, IWordsSegmenterFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for WordsSegmenter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWordsSegmenter>();
}

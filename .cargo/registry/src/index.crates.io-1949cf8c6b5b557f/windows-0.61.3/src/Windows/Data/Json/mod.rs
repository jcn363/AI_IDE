windows_core::imp::define_interface!(
    IJsonArray,
    IJsonArray_Vtbl,
    0x08c1ddb6_0cbd_4a9a_b5d3_2f852dc37e81
);
...
pub struct IJsonArray_Vtbl {
    ...
    pub GetObjectAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetArrayAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetStringAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetNumberAt:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut f64) -> windows_core::HRESULT,
    pub GetBooleanAt:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IJsonArrayStatics,
    IJsonArrayStatics_Vtbl,
    0xdb1434a9_e164_499f_93e2_8a8f49bb90ba
);
...
windows_core::imp::define_interface!(
    IJsonErrorStatics2,
    IJsonErrorStatics2_Vtbl,
    0x404030da_87d0_436c_83ab_fc7b12c0cc26
);
...
pub struct IJsonErrorStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetJsonStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut JsonErrorStatus,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IJsonObject,
    IJsonObject_Vtbl,
    0x064e24dd_29c2_4f83_9ac1_9ee11578beb3
);
...
pub struct IJsonObject_Vtbl {
    ...
    pub GetNamedObject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetNamedArray: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetNamedString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetNamedNumber: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut f64,
    ) -> windows_core::HRESULT,
    pub GetNamedBoolean: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut bool,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IJsonObjectStatics,
    IJsonObjectStatics_Vtbl,
    0x2289f159_54de_45d8_abcc_22603fa066a0
);
...
windows_core::imp::define_interface!(
    ...
    IJsonObjectWithDefaultValues_Vtbl,
    0xd960d2a2_b7f0_4f00_8e44_d82cf415ea13
);
...
pub struct IJsonObjectWithDefaultValues_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetNamedValueOrDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetNamedObjectOrDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetNamedStringOrDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetNamedArrayOrDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetNamedNumberOrDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        f64,
        *mut f64,
    ) -> windows_core::HRESULT,
    pub GetNamedBooleanOrDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        bool,
        *mut bool,
...
windows_core::imp::define_interface!(
    IJsonValue,
    IJsonValue_Vtbl,
    0xa3219ecb_f0b3_4dcd_beee_19d48cd3ed1e
);
...
impl IJsonValue {
    pub fn ValueType(&self) -> windows_core::Result<JsonValueType> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).ValueType)(
    ...
    pub fn Stringify(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Stringify)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn GetNumber(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNumber)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetArray(&self) -> windows_core::Result<JsonArray> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetArray)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn GetObject(&self) -> windows_core::Result<JsonObject> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetObject)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl IJsonValue_Vtbl {
    pub const fn new<Identity: IJsonValue_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ValueType<Identity: IJsonValue_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut JsonValueType,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Stringify<Identity: IJsonValue_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetString<Identity: IJsonValue_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetNumber<Identity: IJsonValue_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut f64,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetBoolean<Identity: IJsonValue_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut bool,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetArray<Identity: IJsonValue_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetObject<Identity: IJsonValue_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
pub struct IJsonValue_Vtbl {
    ...
    pub Stringify: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GetArray: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IJsonValueStatics,
    IJsonValueStatics_Vtbl,
    0x5f6b544a_2f53_48e1_91a3_f78b50a6345c
);
...
pub struct IJsonValueStatics_Vtbl {
    ...
    pub CreateBooleanValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        bool,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateNumberValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        f64,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateStringValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IJsonValueStatics2,
    IJsonValueStatics2_Vtbl,
    0x1d9ecbe4_3fe8_4335_8392_93d8e36865f0
);
...
pub struct IJsonValueStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateNullValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
windows_core::imp::required_hierarchy!(
    JsonArray,
    windows_collections::IIterable<IJsonValue>,
    IJsonValue,
    super::super::Foundation::IStringable,
    windows_collections::IVector<IJsonValue>
);
impl JsonArray {
    ...
    pub fn First(&self) -> windows_core::Result<windows_collections::IIterator<IJsonValue>> {
        let this =
            &windows_core::Interface::cast::<windows_collections::IIterable<IJsonValue>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetObjectAt(&self, index: u32) -> windows_core::Result<JsonObject> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetObjectAt)(
                windows_core::Interface::as_raw(this),
                index,
                &mut result__,
            )
    ...
    pub fn GetArrayAt(&self, index: u32) -> windows_core::Result<JsonArray> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetArrayAt)(
                windows_core::Interface::as_raw(this),
                index,
                &mut result__,
            )
    ...
    pub fn GetStringAt(&self, index: u32) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetStringAt)(
                windows_core::Interface::as_raw(this),
                index,
                &mut result__,
            )
    ...
    pub fn GetNumberAt(&self, index: u32) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNumberAt)(
                windows_core::Interface::as_raw(this),
                index,
                &mut result__,
            )
    ...
    pub fn GetBooleanAt(&self, index: u32) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetBooleanAt)(
                windows_core::Interface::as_raw(this),
                index,
                &mut result__,
            )
    ...
    pub fn GetAt(&self, index: u32) -> windows_core::Result<IJsonValue> {
        let this =
            &windows_core::Interface::cast::<windows_collections::IVector<IJsonValue>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetView(&self) -> windows_core::Result<windows_collections::IVectorView<IJsonValue>> {
        let this =
            &windows_core::Interface::cast::<windows_collections::IVector<IJsonValue>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IJsonArrayStatics<R, F: FnOnce(&IJsonArrayStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<JsonArray, IJsonArrayStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for JsonArray {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IJsonArray>();
}
...
impl JsonError {
    pub fn GetJsonStatus(hresult: i32) -> windows_core::Result<JsonErrorStatus> {
        Self::IJsonErrorStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetJsonStatus)(
                windows_core::Interface::as_raw(this),
                hresult,
                &mut result__,
            )
    ...
    fn IJsonErrorStatics2<R, F: FnOnce(&IJsonErrorStatics2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<JsonError, IJsonErrorStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl windows_core::RuntimeType for JsonErrorStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Data.Json.JsonErrorStatus;i4)");
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl JsonObject {
    ...
    pub fn First(
        ...
        windows_collections::IIterator<
            windows_collections::IKeyValuePair<windows_core::HSTRING, IJsonValue>,
        >,
    > {
    ...
    pub fn GetNamedValue(&self, name: &windows_core::HSTRING) -> windows_core::Result<JsonValue> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNamedValue)(
                windows_core::Interface::as_raw(this),
        ...
        P1: windows_core::Param<IJsonValue>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetNamedValue)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                value.param().abi(),
            )
    ...
    pub fn GetNamedObject(&self, name: &windows_core::HSTRING) -> windows_core::Result<JsonObject> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNamedObject)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                &mut result__,
            )
    ...
    pub fn GetNamedArray(&self, name: &windows_core::HSTRING) -> windows_core::Result<JsonArray> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNamedArray)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                &mut result__,
            )
    ...
    pub fn GetNamedString(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNamedString)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                &mut result__,
            )
    ...
    pub fn GetNamedNumber(&self, name: &windows_core::HSTRING) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNamedNumber)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                &mut result__,
            )
    ...
    pub fn GetNamedBoolean(&self, name: &windows_core::HSTRING) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNamedBoolean)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                &mut result__,
            )
    ...
    pub fn GetNamedValueOrDefault<P1>(
        &self,
        name: &windows_core::HSTRING,
        defaultvalue: P1,
    ) -> windows_core::Result<JsonValue>
    where
        P1: windows_core::Param<JsonValue>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNamedValueOrDefault)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
    ...
    pub fn GetNamedObjectOrDefault<P1>(
        &self,
        name: &windows_core::HSTRING,
        defaultvalue: P1,
    ) -> windows_core::Result<JsonObject>
    where
        P1: windows_core::Param<JsonObject>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNamedObjectOrDefault)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                defaultvalue.param().abi(),
                &mut result__,
    ...
    pub fn GetNamedStringOrDefault(
        &self,
        name: &windows_core::HSTRING,
        defaultvalue: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<IJsonObjectWithDefaultValues>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNamedStringOrDefault)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
    ...
    pub fn GetNamedArrayOrDefault<P1>(
        &self,
        name: &windows_core::HSTRING,
        defaultvalue: P1,
    ) -> windows_core::Result<JsonArray>
    where
        P1: windows_core::Param<JsonArray>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNamedArrayOrDefault)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                defaultvalue.param().abi(),
                &mut result__,
    ...
    pub fn GetNamedNumberOrDefault(
        &self,
        name: &windows_core::HSTRING,
        defaultvalue: f64,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNamedNumberOrDefault)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                defaultvalue,
                &mut result__,
    ...
    pub fn GetNamedBooleanOrDefault(
        &self,
        name: &windows_core::HSTRING,
        defaultvalue: bool,
    ) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNamedBooleanOrDefault)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(name),
                defaultvalue,
                &mut result__,
    ...
    pub fn Lookup(&self, key: &windows_core::HSTRING) -> windows_core::Result<IJsonValue> {
        let this = &windows_core::Interface::cast::<
            windows_collections::IMap<windows_core::HSTRING, IJsonValue>,
        >(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetView(
        &self,
    ) -> windows_core::Result<windows_collections::IMapView<windows_core::HSTRING, IJsonValue>>
    {
        let this = &windows_core::Interface::cast::<
            windows_collections::IMap<windows_core::HSTRING, IJsonValue>,
        >(self)?;
    ...
    fn IJsonObjectStatics<R, F: FnOnce(&IJsonObjectStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<JsonObject, IJsonObjectStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for JsonObject {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IJsonObject>();
}
...
impl JsonValue {
    ...
    pub fn CreateBooleanValue(input: bool) -> windows_core::Result<JsonValue> {
        Self::IJsonValueStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateBooleanValue)(
                windows_core::Interface::as_raw(this),
                input,
                &mut result__,
            )
    ...
    pub fn CreateNumberValue(input: f64) -> windows_core::Result<JsonValue> {
        Self::IJsonValueStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateNumberValue)(
                windows_core::Interface::as_raw(this),
                input,
                &mut result__,
            )
    ...
    pub fn CreateStringValue(input: &windows_core::HSTRING) -> windows_core::Result<JsonValue> {
        Self::IJsonValueStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateStringValue)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(input),
                &mut result__,
            )
    ...
    pub fn CreateNullValue() -> windows_core::Result<JsonValue> {
        Self::IJsonValueStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateNullValue)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IJsonValueStatics<R, F: FnOnce(&IJsonValueStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<JsonValue, IJsonValueStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IJsonValueStatics2<R, F: FnOnce(&IJsonValueStatics2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<JsonValue, IJsonValueStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for JsonValue {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IJsonValue>();
}
...
impl windows_core::RuntimeType for JsonValueType {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Data.Json.JsonValueType;i4)");
}

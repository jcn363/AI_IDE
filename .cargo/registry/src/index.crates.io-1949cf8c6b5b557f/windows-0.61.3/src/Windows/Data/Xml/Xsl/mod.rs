windows_core::imp::define_interface!(
    IXsltProcessor,
    IXsltProcessor_Vtbl,
    0x7b64703f_550c_48c6_a90f_93a5b964518f
);
...
pub struct IXsltProcessor_Vtbl {
    ...
    pub TransformToString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IXsltProcessor2,
    IXsltProcessor2_Vtbl,
    0x8da45c56_97a5_44cb_a8be_27d86280c70a
);
...
pub struct IXsltProcessor2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Data_Xml_Dom")]
    pub TransformToDocument: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl XsltProcessor {
        ...
        P0: windows_core::Param<super::Dom::IXmlNode>,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).TransformToString)(
    ...
    #[cfg(feature = "Data_Xml_Dom")]
    pub fn TransformToDocument<P0>(
        &self,
        inputnode: P0,
    ) -> windows_core::Result<super::Dom::XmlDocument>
    where
        P0: windows_core::Param<super::Dom::IXmlNode>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TransformToDocument)(
                windows_core::Interface::as_raw(this),
                inputnode.param().abi(),
                &mut result__,
            )
    ...
    fn IXsltProcessorFactory<R, F: FnOnce(&IXsltProcessorFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<XsltProcessor, IXsltProcessorFactory> =
...
impl windows_core::RuntimeType for XsltProcessor {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IXsltProcessor>();
}

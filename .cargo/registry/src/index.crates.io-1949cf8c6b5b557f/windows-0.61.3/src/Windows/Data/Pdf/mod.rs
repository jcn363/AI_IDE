windows_core::imp::define_interface!(
    IPdfDocument,
    IPdfDocument_Vtbl,
    0xac7ebedd_80fa_4089_846e_81b77ff5a86c
);
...
pub struct IPdfDocument_Vtbl {
    ...
    pub IsPasswordProtected:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPdfDocumentStatics,
    IPdfDocumentStatics_Vtbl,
    0x433a0b5f_c007_4788_90f2_08143d922599
);
...
pub struct IPdfDocumentStatics_Vtbl {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub LoadFromFileWithPasswordAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub LoadFromStreamWithPasswordAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IPdfPage,
    IPdfPage_Vtbl,
    0x9db4b0c8_5320_4cfc_ad76_493fdad0e594
);
...
pub struct IPdfPage_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Storage_Streams")]
    pub RenderToStreamAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub RenderWithOptionsToStreamAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    pub PreparePageAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub Dimensions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IPdfPageDimensions,
    IPdfPageDimensions_Vtbl,
    0x22170471_313e_44e8_835d_63a3e7624a10
);
...
pub struct IPdfPageDimensions_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub MediaBox: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::Rect,
    ) -> windows_core::HRESULT,
    pub CropBox: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::Rect,
    ) -> windows_core::HRESULT,
    pub BleedBox: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::Rect,
    ) -> windows_core::HRESULT,
    pub TrimBox: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::Rect,
    ) -> windows_core::HRESULT,
    pub ArtBox: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::Rect,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IPdfPageRenderOptions_Vtbl,
    0x3c98056f_b7cf_4c29_9a04_52d90267f425
);
...
pub struct IPdfPageRenderOptions_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SourceRect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::Rect,
    ) -> windows_core::HRESULT,
    ...
    pub DestinationWidth:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetDestinationWidth:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub DestinationHeight:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetDestinationHeight:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    #[cfg(feature = "UI")]
    ...
    pub IsIgnoringHighContrast:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetIsIgnoringHighContrast:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub BitmapEncoderId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub SetBitmapEncoderId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
    ) -> windows_core::HRESULT,
}
...
impl PdfDocument {
    pub fn GetPage(&self, pageindex: u32) -> windows_core::Result<PdfPage> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).GetPage)(
    ...
    pub fn PageCount(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PageCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsPasswordProtected(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsPasswordProtected)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn LoadFromFileAsync<P0>(
        file: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<PdfDocument>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFromFileWithPasswordAsync<P0>(
        file: P0,
        ...
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    {
        Self::IPdfDocumentStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LoadFromFileWithPasswordAsync)(
                windows_core::Interface::as_raw(this),
                file.param().abi(),
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFromStreamWithPasswordAsync<P0>(
        inputstream: P0,
        password: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<PdfDocument>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStream>,
    {
        Self::IPdfDocumentStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LoadFromStreamWithPasswordAsync)(
                windows_core::Interface::as_raw(this),
                inputstream.param().abi(),
                core::mem::transmute_copy(password),
                &mut result__,
    ...
    fn IPdfDocumentStatics<R, F: FnOnce(&IPdfDocumentStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PdfDocument, IPdfDocumentStatics> =
...
impl windows_core::RuntimeType for PdfDocument {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPdfDocument>();
}
...
impl PdfPage {
        ...
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStream>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RenderToStreamAsync)(
                windows_core::Interface::as_raw(this),
        ...
        P1: windows_core::Param<PdfPageRenderOptions>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RenderWithOptionsToStreamAsync)(
                windows_core::Interface::as_raw(this),
                outputstream.param().abi(),
                options.param().abi(),
                &mut result__,
    ...
    pub fn PreparePageAsync(&self) -> windows_core::Result<windows_future::IAsyncAction> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PreparePageAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Dimensions(&self) -> windows_core::Result<PdfPageDimensions> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Dimensions)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn PreferredZoom(&self) -> windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PreferredZoom)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for PdfPage {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPdfPage>();
}
...
impl PdfPageDimensions {
    pub fn MediaBox(&self) -> windows_core::Result<super::super::Foundation::Rect> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MediaBox)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn CropBox(&self) -> windows_core::Result<super::super::Foundation::Rect> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CropBox)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn BleedBox(&self) -> windows_core::Result<super::super::Foundation::Rect> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BleedBox)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn TrimBox(&self) -> windows_core::Result<super::super::Foundation::Rect> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TrimBox)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ArtBox(&self) -> windows_core::Result<super::super::Foundation::Rect> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ArtBox)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for PdfPageDimensions {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPdfPageDimensions>();
}
...
impl PdfPageRenderOptions {
    ...
    pub fn SourceRect(&self) -> windows_core::Result<super::super::Foundation::Rect> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SourceRect)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetSourceRect(&self, value: super::super::Foundation::Rect) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSourceRect)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn DestinationWidth(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DestinationWidth)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetDestinationWidth(&self, value: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDestinationWidth)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn DestinationHeight(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DestinationHeight)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetDestinationHeight(&self, value: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDestinationHeight)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn IsIgnoringHighContrast(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsIgnoringHighContrast)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIsIgnoringHighContrast(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsIgnoringHighContrast)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn BitmapEncoderId(&self) -> windows_core::Result<windows_core::GUID> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BitmapEncoderId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetBitmapEncoderId(&self, value: windows_core::GUID) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetBitmapEncoderId)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for PdfPageRenderOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPdfPageRenderOptions>();
}
...
impl windows_core::RuntimeType for PdfPageRotation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Data.Pdf.PdfPageRotation;i4)");
}

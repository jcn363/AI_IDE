...
impl GameBar {
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IGameBarStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsInputRedirectedChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveIsInputRedirectedChanged(token: i64) -> windows_core::Result<()> {
        Self::IGameBarStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveIsInputRedirectedChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn IsInputRedirected() -> windows_core::Result<bool> {
        Self::IGameBarStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsInputRedirected)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    fn IGameBarStatics<R, F: FnOnce(&IGameBarStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<GameBar, IGameBarStatics> =
...
impl windows_core::RuntimeType for GameChatMessageOrigin {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Gaming.UI.GameChatMessageOrigin;i4)",
    );
}
#[repr(transparent)]
...
impl windows_core::RuntimeType for GameChatMessageReceivedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGameChatMessageReceivedEventArgs>();
}
unsafe impl windows_core::Interface for GameChatMessageReceivedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IGameChatMessageReceivedEventArgs as windows_core::Interface>::IID;
}
...
impl GameChatOverlay {
    pub fn DesiredPosition(&self) -> windows_core::Result<GameChatOverlayPosition> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DesiredPosition)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetDesiredPosition(&self, value: GameChatOverlayPosition) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDesiredPosition)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn AddMessage(
        &self,
        sender: &windows_core::HSTRING,
        message: &windows_core::HSTRING,
        origin: GameChatMessageOrigin,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AddMessage)(
                windows_core::Interface::as_raw(this),
    ...
    fn IGameChatOverlayStatics<
        R,
        F: FnOnce(&IGameChatOverlayStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<GameChatOverlay, IGameChatOverlayStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for GameChatOverlay {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGameChatOverlay>();
}
...
impl GameChatOverlayMessageSource {
    ...
    pub fn SetDelayBeforeClosingAfterMessageReceived(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDelayBeforeClosingAfterMessageReceived)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for GameChatOverlayMessageSource {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGameChatOverlayMessageSource>();
}
...
impl GameUIProviderActivatedEventArgs {
    ...
    pub fn GameUIArgs(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GameUIArgs)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for GameUIProviderActivatedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGameUIProviderActivatedEventArgs>();
}
#[cfg(feature = "ApplicationModel_Activation")]
unsafe impl windows_core::Interface for GameUIProviderActivatedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IGameUIProviderActivatedEventArgs as windows_core::Interface>::IID;
}
#[cfg(feature = "ApplicationModel_Activation")]
...
windows_core::imp::define_interface!(
    IGameBarStatics,
    IGameBarStatics_Vtbl,
    0x1db9a292_cc78_4173_be45_b61e67283ea7
);
...
pub struct IGameBarStatics_Vtbl {
    ...
    pub IsInputRedirectedChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveIsInputRedirectedChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub Visible:
...
windows_core::imp::define_interface!(
    ...
    IGameChatMessageReceivedEventArgs_Vtbl,
    0xa28201f1_3fb9_4e42_a403_7afce2023b1e
);
...
pub struct IGameChatMessageReceivedEventArgs_Vtbl {
    ...
    pub Origin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GameChatMessageOrigin,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IGameChatOverlay,
    IGameChatOverlay_Vtbl,
    0xfbc64865_f6fc_4a48_ae07_03ac6ed43704
);
...
pub struct IGameChatOverlay_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub DesiredPosition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GameChatOverlayPosition,
    ) -> windows_core::HRESULT,
    pub SetDesiredPosition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IGameChatOverlayMessageSource_Vtbl,
    0x1e177397_59fb_4f4f_8e9a_80acf817743c
);
...
pub struct IGameChatOverlayMessageSource_Vtbl {
    ...
    pub RemoveMessageReceived:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub SetDelayBeforeClosingAfterMessageReceived:
...
windows_core::imp::define_interface!(
    ...
    IGameChatOverlayStatics_Vtbl,
    0x89acf614_7867_49f7_9687_25d9dbf444d1
);
...
windows_core::imp::define_interface!(
    ...
    IGameUIProviderActivatedEventArgs_Vtbl,
    0xa7b3203e_caf7_4ded_bbd2_47de43bb6dd5
);
#[cfg(feature = "ApplicationModel_Activation")]
...
pub struct IGameUIProviderActivatedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Foundation_Collections")]
    pub GameUIArgs: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,

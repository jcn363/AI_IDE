...
impl ConditionForceEffect {
    ...
    pub fn SetParameters(
        &self,
        direction: windows_numerics::Vector3,
        ...
        let this = &windows_core::Interface::cast::<IConditionForceEffect>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetParameters)(
                windows_core::Interface::as_raw(this),
                direction,
                positivecoefficient,
                negativecoefficient,
    ...
    ) -> windows_core::Result<ConditionForceEffect> {
    ...
    fn IConditionForceEffectFactory<
        R,
        F: FnOnce(&IConditionForceEffectFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for ConditionForceEffect {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IForceFeedbackEffect>();
}
...
impl ConstantForceEffect {
    ...
    pub fn SetParameters(
        &self,
        vector: windows_numerics::Vector3,
    ...
    pub fn SetParametersWithEnvelope(
        ...
        let this = &windows_core::Interface::cast::<IConstantForceEffect>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetParametersWithEnvelope)(
                windows_core::Interface::as_raw(this),
                vector,
                attackgain,
                sustaingain,
...
impl ForceFeedbackMotor {
    ...
    pub fn SupportedAxes(&self) -> windows_core::Result<ForceFeedbackEffectAxes> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedAxes)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn LoadEffectAsync<P0>(
        &self,
        effect: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<ForceFeedbackLoadEffectResult>>
    where
        P0: windows_core::Param<IForceFeedbackEffect>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LoadEffectAsync)(
                windows_core::Interface::as_raw(this),
                effect.param().abi(),
                &mut result__,
            )
    ...
    pub fn StopAllEffects(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).StopAllEffects)(windows_core::Interface::as_raw(
                this,
            ))
            .ok()
        }
    ...
    pub fn TryUnloadEffectAsync<P0>(
        &self,
        effect: P0,
        ...
        P0: windows_core::Param<IForceFeedbackEffect>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryUnloadEffectAsync)(
                windows_core::Interface::as_raw(this),
                effect.param().abi(),
                &mut result__,
            )
...
windows_core::imp::define_interface!(
    ...
    IConditionForceEffect_Vtbl,
    0x32d1ea68_3695_4e69_85c0_cd1944189140
);
...
windows_core::imp::define_interface!(
    IConditionForceEffectFactory,
    IConditionForceEffectFactory_Vtbl,
    0x91a99264_1810_4eb6_a773_bfd3b8cddbab
);
...
windows_core::imp::define_interface!(
    ...
    IConstantForceEffect_Vtbl,
    0x9bfa0140_f3c7_415c_b068_0f068734bce0
);
...
pub struct IConstantForceEffect_Vtbl {
    ...
    pub SetParametersWithEnvelope: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_numerics::Vector3,
        f32,
        f32,
...
windows_core::imp::define_interface!(
    ...
    0xa17fba0c_2ae4_48c2_8063_eabd0777cb89
);
...
impl IForceFeedbackEffect_Vtbl {
    pub const fn new<Identity: IForceFeedbackEffect_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Gain<Identity: IForceFeedbackEffect_Impl, const OFFSET: isize>(
        ...
        unsafe extern "system" fn Stop<Identity: IForceFeedbackEffect_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
pub struct IForceFeedbackMotor_Vtbl {
    ...
    pub IsEnabled:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SupportedAxes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ForceFeedbackEffectAxes,
    ) -> windows_core::HRESULT,
    pub LoadEffectAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub TryUnloadEffectAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IPeriodicForceEffect_Vtbl,
    0x5c5138d7_fc75_4d52_9a0a_efe4cab5fe64
);
...
windows_core::imp::define_interface!(
    ...
    IPeriodicForceEffectFactory_Vtbl,
    0x6f62eb1a_9851_477b_b318_35ecaa15070f
);
...
windows_core::imp::define_interface!(
    IRampForceEffect,
    IRampForceEffect_Vtbl,
    0xf1f81259_1ca6_4080_b56d_b43f3354d052
);
...
impl PeriodicForceEffect {
    ...
    ) -> windows_core::Result<PeriodicForceEffect> {
    ...
    fn IPeriodicForceEffectFactory<
        R,
        F: FnOnce(&IPeriodicForceEffectFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl RampForceEffect {
    ...
    pub fn SetParameters(
        &self,
        startvector: windows_numerics::Vector3,
        endvector: windows_numerics::Vector3,
        duration: super::super::super::Foundation::TimeSpan,
    ) -> windows_core::Result<()> {

...
impl GameList {
    pub fn FindAllAsync() -> windows_core::Result<
        windows_future::IAsyncOperation<windows_collections::IVectorView<GameListEntry>>,
    > {
    ...
    > {
        Self::IGameListStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindAllAsyncPackageFamilyName)(
                windows_core::Interface::as_raw(this),
        ...
        P0: windows_core::Param<GameListChangedEventHandler>,
    {
        Self::IGameListStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GameAdded)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveGameAdded(token: i64) -> windows_core::Result<()> {
        Self::IGameListStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveGameAdded)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<GameListRemovedEventHandler>,
    {
        Self::IGameListStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GameRemoved)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveGameRemoved(token: i64) -> windows_core::Result<()> {
        Self::IGameListStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveGameRemoved)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<GameListChangedEventHandler>,
    {
        Self::IGameListStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GameUpdated)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveGameUpdated(token: i64) -> windows_core::Result<()> {
        Self::IGameListStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveGameUpdated)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn MergeEntriesAsync<P0, P1>(
        left: P0,
        right: P1,
    ) -> windows_core::Result<windows_future::IAsyncOperation<GameListEntry>>
    where
        ...
        P1: windows_core::Param<GameListEntry>,
    {
        Self::IGameListStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MergeEntriesAsync)(
                windows_core::Interface::as_raw(this),
                left.param().abi(),
                right.param().abi(),
                &mut result__,
        ...
        P0: windows_core::Param<GameListEntry>,
    {
        Self::IGameListStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UnmergeEntryAsync)(
                windows_core::Interface::as_raw(this),
                mergedentry.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IGameListStatics<R, F: FnOnce(&IGameListStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<GameList, IGameListStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IGameListStatics2<R, F: FnOnce(&IGameListStatics2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<GameList, IGameListStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
windows_core::imp::define_interface!(
    ...
    GameListChangedEventHandler_Vtbl,
    0x25f6a421_d8f5_4d91_b40e_53d5e86fde64
);
...
impl GameListChangedEventHandler {
    pub fn new<
        F: FnMut(windows_core::Ref<'_, GameListEntry>) -> windows_core::Result<()> + Send + 'static,
    >(
        invoke: F,
    ) -> Self {
        let com = GameListChangedEventHandlerBox {
            vtable: &GameListChangedEventHandlerBox::<F>::VTABLE,
...
pub struct GameListChangedEventHandler_Vtbl {
    ...
    Invoke: unsafe extern "system" fn(
        ...
        game: *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
#[repr(C)]
struct GameListChangedEventHandlerBox<
    F: FnMut(windows_core::Ref<'_, GameListEntry>) -> windows_core::Result<()> + Send + 'static,
> {
...
impl<
        F: FnMut(windows_core::Ref<'_, GameListEntry>) -> windows_core::Result<()> + Send + 'static,
    > GameListChangedEventHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <GameListChangedEventHandler as windows_core::Interface>::IID
...
impl GameListEntry {
    ...
    pub fn DisplayInfo(
        &self,
    ) -> windows_core::Result<super::super::super::ApplicationModel::AppDisplayInfo> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCategoryAsync(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetCategoryAsync)(
                windows_core::Interface::as_raw(this),
                value,
                &mut result__,
            )
    ...
    pub fn LaunchableState(&self) -> windows_core::Result<GameListEntryLaunchableState> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LaunchableState)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn LauncherExecutable(
        &self,
    ) -> windows_core::Result<super::super::super::Storage::IStorageFile> {
        let this = &windows_core::Interface::cast::<IGameListEntry2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LauncherExecutable)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn LaunchParameters(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LaunchParameters)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetLauncherExecutableFileAsync<P0>(
        &self,
        executablefile: P0,
    ) -> windows_core::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::super::super::Storage::IStorageFile>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetLauncherExecutableFileAsync)(
                windows_core::Interface::as_raw(this),
                executablefile.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetLauncherExecutableFileWithParamsAsync<P0>(
        &self,
        executablefile: P0,
        launchparams: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::super::super::Storage::IStorageFile>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetLauncherExecutableFileWithParamsAsync)(
                windows_core::Interface::as_raw(this),
                executablefile.param().abi(),
                core::mem::transmute_copy(launchparams),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub fn SetTitleIdAsync(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetTitleIdAsync)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn GameModeConfiguration(&self) -> windows_core::Result<GameModeConfiguration> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GameModeConfiguration)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for GameListEntry {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGameListEntry>();
}
...
windows_core::imp::define_interface!(
    ...
    0x10c5648f_6c8f_4712_9b38_474bc22e76d8
);
...
impl GameListRemovedEventHandler {
    pub fn new<F: FnMut(&windows_core::HSTRING) -> windows_core::Result<()> + Send + 'static>(
        invoke: F,
    ) -> Self {
        let com = GameListRemovedEventHandlerBox {
            vtable: &GameListRemovedEventHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
pub struct GameListRemovedEventHandler_Vtbl {
    ...
    Invoke: unsafe extern "system" fn(
        this: *mut core::ffi::c_void,
        identifier: *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
#[repr(C)]
struct GameListRemovedEventHandlerBox<
    F: FnMut(&windows_core::HSTRING) -> windows_core::Result<()> + Send + 'static,
> {
    vtable: *const GameListRemovedEventHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(&windows_core::HSTRING) -> windows_core::Result<()> + Send + 'static>
    GameListRemovedEventHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <GameListRemovedEventHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _
...
impl GameModeConfiguration {
    ...
    pub fn RelatedProcessNames(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RelatedProcessNames)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn PercentGpuTimeAllocatedToGame(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PercentGpuTimeAllocatedToGame)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::super::Foundation::IReference<i32>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPercentGpuTimeAllocatedToGame)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn PercentGpuMemoryAllocatedToGame(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PercentGpuMemoryAllocatedToGame)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::super::Foundation::IReference<i32>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPercentGpuMemoryAllocatedToGame)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn PercentGpuMemoryAllocatedToSystemCompositor(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PercentGpuMemoryAllocatedToSystemCompositor)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SetPercentGpuMemoryAllocatedToSystemCompositor<P0>(
        &self,
        value: P0,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::super::super::Foundation::IReference<i32>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPercentGpuMemoryAllocatedToSystemCompositor)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn MaxCpuCount(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxCpuCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::super::Foundation::IReference<i32>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetMaxCpuCount)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn CpuExclusivityMaskLow(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CpuExclusivityMaskLow)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::super::Foundation::IReference<i32>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetCpuExclusivityMaskLow)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn CpuExclusivityMaskHigh(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CpuExclusivityMaskHigh)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::super::Foundation::IReference<i32>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetCpuExclusivityMaskHigh)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn AffinitizeToExclusiveCpus(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AffinitizeToExclusiveCpus)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetAffinitizeToExclusiveCpus(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAffinitizeToExclusiveCpus)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for GameModeConfiguration {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGameModeConfiguration>();
}
...
impl GameModeUserConfiguration {
    pub fn GamingRelatedProcessNames(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GamingRelatedProcessNames)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IGameModeUserConfigurationStatics<
        R,
        F: FnOnce(&IGameModeUserConfigurationStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
...
impl windows_core::RuntimeType for GameModeUserConfiguration {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGameModeUserConfiguration>();
}
...
windows_core::imp::define_interface!(
    IGameListEntry,
    IGameListEntry_Vtbl,
    0x735924d3_811f_4494_b69c_c641a0c61543
);
...
impl IGameListEntry_Vtbl {
    pub const fn new<Identity: IGameListEntry_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DisplayInfo<
        ...
        unsafe extern "system" fn LaunchAsync<
            Identity: IGameListEntry_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Category<Identity: IGameListEntry_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Properties<Identity: IGameListEntry_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetCategoryAsync<
            Identity: IGameListEntry_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub struct IGameListEntry_Vtbl {
    ...
    pub Category: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GameListCategory,
    ) -> windows_core::HRESULT,
    pub Properties: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetCategoryAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        GameListCategory,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IGameListEntry2,
    IGameListEntry2_Vtbl,
    0xd84a8f8b_8749_4a25_90d3_f6c5a427886d
);
...
pub struct IGameListEntry2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub LaunchableState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GameListEntryLaunchableState,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    pub LauncherExecutable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))]
    LauncherExecutable: usize,
    pub LaunchParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    pub SetLauncherExecutableFileAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub SetLauncherExecutableFileWithParamsAsync:
    ...
    pub SetTitleIdAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GameModeConfiguration: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IGameListStatics,
    IGameListStatics_Vtbl,
    0x2ddd0f6f_9c66_4b05_945c_d6ed78491b8c
);
...
pub struct IGameListStatics_Vtbl {
    ...
    pub FindAllAsyncPackageFamilyName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GameAdded: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    ...
    pub GameRemoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveGameRemoved:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub GameUpdated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveGameUpdated:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IGameListStatics2,
    IGameListStatics2_Vtbl,
    0x395f2098_ea1a_45aa_9268_a83905686f27
);
...
pub struct IGameListStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub MergeEntriesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UnmergeEntryAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IGameModeConfiguration_Vtbl,
    0x78e591af_b142_4ef0_8830_55bc2be4f5ea
);
...
pub struct IGameModeConfiguration_Vtbl {
    ...
    pub RelatedProcessNames: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PercentGpuTimeAllocatedToGame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetPercentGpuTimeAllocatedToGame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PercentGpuMemoryAllocatedToGame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetPercentGpuMemoryAllocatedToGame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PercentGpuMemoryAllocatedToSystemCompositor:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT,
    pub SetPercentGpuMemoryAllocatedToSystemCompositor:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
        ) -> windows_core::HRESULT,
    pub MaxCpuCount: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetMaxCpuCount: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CpuExclusivityMaskLow: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetCpuExclusivityMaskLow: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CpuExclusivityMaskHigh: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetCpuExclusivityMaskHigh: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AffinitizeToExclusiveCpus:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetAffinitizeToExclusiveCpus:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IGameModeUserConfiguration_Vtbl,
    0x72d34af4_756b_470f_a0c2_ba62a90795db
);
...
pub struct IGameModeUserConfiguration_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GamingRelatedProcessNames: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SaveAsync: unsafe extern "system" fn(
...
windows_core::imp::define_interface!(
    IGameModeUserConfigurationStatics,
    IGameModeUserConfigurationStatics_Vtbl,
    0x6e50d97c_66ea_478e_a4a1_f57c0e8d00e7
);

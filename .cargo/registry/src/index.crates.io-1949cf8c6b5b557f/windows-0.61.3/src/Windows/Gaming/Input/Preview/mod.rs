...
impl windows_core::RuntimeType for DeviceCommand {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Gaming.Input.Preview.DeviceCommand;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for GameControllerBatteryChargingState {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Gaming.Input.Preview.GameControllerBatteryChargingState;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for GameControllerBatteryKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Gaming.Input.Preview.GameControllerBatteryKind;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for GameControllerBatteryLevel {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Gaming.Input.Preview.GameControllerBatteryLevel;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for GameControllerFirmwareCorruptReason {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Gaming.Input.Preview.GameControllerFirmwareCorruptReason;i4)",
    );
}
...
impl GameControllerProviderInfo {
        ...
        P0: windows_core::Param<super::Custom::IGameControllerProvider>,
    {
        Self::IGameControllerProviderInfoStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).GetParentProviderId)(
        ...
        P0: windows_core::Param<super::Custom::IGameControllerProvider>,
    {
        Self::IGameControllerProviderInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetProviderId)(
                windows_core::Interface::as_raw(this),
                provider.param().abi(),
                &mut result__,
            )
    ...
    fn IGameControllerProviderInfoStatics<
        R,
        F: FnOnce(&IGameControllerProviderInfoStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for HeadsetGeqGains {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"struct(Windows.Gaming.Input.Preview.HeadsetGeqGains;i4;i4;i4;i4;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for HeadsetLevel {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Gaming.Input.Preview.HeadsetLevel;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for HeadsetOperation {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Gaming.Input.Preview.HeadsetOperation;i4)",
    );
}
windows_core::imp::define_interface!(
    IGameControllerProviderInfoStatics,
    IGameControllerProviderInfoStatics_Vtbl,
    0x0be1e6c5_d9bd_44ee_8362_488b2e464bfb
);
...
pub struct IGameControllerProviderInfoStatics_Vtbl {
    ...
    #[cfg(feature = "Gaming_Input_Custom")]
    pub GetParentProviderId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ILegacyGipGameControllerProvider,
    ILegacyGipGameControllerProvider_Vtbl,
    0x2da3ed52_ffd9_43e2_825c_1d2790e04d14
);
...
pub struct ILegacyGipGameControllerProvider_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub BatteryChargingState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GameControllerBatteryChargingState,
    ) -> windows_core::HRESULT,
    pub BatteryKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GameControllerBatteryKind,
    ) -> windows_core::HRESULT,
    pub BatteryLevel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GameControllerBatteryLevel,
    ) -> windows_core::HRESULT,
    pub GetDeviceFirmwareCorruptionState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GameControllerFirmwareCorruptReason,
    ) -> windows_core::HRESULT,
    pub IsFirmwareCorrupted:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsInterfaceSupported: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut bool,
    ) -> windows_core::HRESULT,
    pub IsSyntheticDevice:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub PreferredTypes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ExecuteCommand:
        unsafe extern "system" fn(*mut core::ffi::c_void, DeviceCommand) -> windows_core::HRESULT,
    pub SetHomeLedIntensity:
        unsafe extern "system" fn(*mut core::ffi::c_void, u8) -> windows_core::HRESULT,
    pub GetExtendedDeviceInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut *mut u8,
    ) -> windows_core::HRESULT,
    pub SetHeadsetOperation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        HeadsetOperation,
        u32,
        *const u8,
    ) -> windows_core::HRESULT,
    pub GetHeadsetOperation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        HeadsetOperation,
        *mut u32,
        *mut *mut u8,
    ) -> windows_core::HRESULT,
    pub AppCompatVersion:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    #[cfg(feature = "System")]
    pub SetStandardControllerButtonRemapping: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        bool,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "System")]
    pub GetStandardControllerButtonRemapping: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        bool,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ILegacyGipGameControllerProviderStatics,
    ILegacyGipGameControllerProviderStatics_Vtbl,
    0xd40dda17_b1f4_499a_874c_7095aac15291
);
...
pub struct ILegacyGipGameControllerProviderStatics_Vtbl {
    ...
    #[cfg(feature = "Gaming_Input_Custom")]
    pub FromGameControllerProvider: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "System")]
    pub PairPilotToCopilot: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "System")]
    pub ClearPairing: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    ClearPairing: usize,
    #[cfg(feature = "System")]
    pub IsPilot: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    IsPilot: usize,
    #[cfg(feature = "System")]
    pub IsCopilot: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
impl LegacyGipGameControllerProvider {
    pub fn BatteryChargingState(&self) -> windows_core::Result<GameControllerBatteryChargingState> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BatteryChargingState)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn BatteryKind(&self) -> windows_core::Result<GameControllerBatteryKind> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BatteryKind)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetDeviceFirmwareCorruptionState(
        &self,
    ) -> windows_core::Result<GameControllerFirmwareCorruptReason> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDeviceFirmwareCorruptionState)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsFirmwareCorrupted(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsFirmwareCorrupted)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsInterfaceSupported(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsInterfaceSupported)(
                windows_core::Interface::as_raw(this),
                interfaceid,
                &mut result__,
            )
    ...
    pub fn IsSyntheticDevice(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsSyntheticDevice)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ExecuteCommand(&self, command: DeviceCommand) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ExecuteCommand)(
                windows_core::Interface::as_raw(this),
                command,
            )
            .ok()
    ...
    pub fn SetHomeLedIntensity(&self, intensity: u8) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetHomeLedIntensity)(
                windows_core::Interface::as_raw(this),
                intensity,
            )
            .ok()
    ...
    pub fn GetExtendedDeviceInfo(&self) -> windows_core::Result<windows_core::Array<u8>> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).GetExtendedDeviceInfo)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn SetHeadsetOperation(
        &self,
        operation: HeadsetOperation,
        buffer: &[u8],
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetHeadsetOperation)(
                windows_core::Interface::as_raw(this),
                operation,
    ...
    pub fn GetHeadsetOperation(
        ...
        unsafe {
            let mut result__ = core::mem::MaybeUninit::zeroed();
            (windows_core::Interface::vtable(this).GetHeadsetOperation)(
                windows_core::Interface::as_raw(this),
                operation,
                windows_core::Array::<u8>::set_abi_len(core::mem::transmute(&mut result__)),
                result__.as_mut_ptr() as *mut _ as _,
    ...
    pub fn AppCompatVersion(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AppCompatVersion)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    #[cfg(feature = "System")]
    pub fn SetStandardControllerButtonRemapping<P0, P2>(
        &self,
        user: P0,
        previous: bool,
        remapping: P2,
    ...
    where
        ...
        P2: windows_core::Param<
            windows_collections::IMapView<RemappingButtonCategory, windows_core::IInspectable>,
        >,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetStandardControllerButtonRemapping)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                previous,
                remapping.param().abi(),
        ...
        P0: windows_core::Param<super::super::super::System::User>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetStandardControllerButtonRemapping)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                previous,
                &mut result__,
    ...
    pub fn FromGameController<P0>(
        controller: P0,
    ) -> windows_core::Result<LegacyGipGameControllerProvider>
    where
        ...
        P0: windows_core::Param<super::Custom::IGameControllerProvider>,
    {
        Self::ILegacyGipGameControllerProviderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromGameControllerProvider)(
                windows_core::Interface::as_raw(this),
                provider.param().abi(),
                &mut result__,
            )
    ...
    pub fn PairPilotToCopilot<P0>(
        user: P0,
        pilotcontrollerproviderid: &windows_core::HSTRING,
        copilotcontrollerproviderid: &windows_core::HSTRING,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::super::super::System::User>,
    {
        Self::ILegacyGipGameControllerProviderStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).PairPilotToCopilot)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                core::mem::transmute_copy(pilotcontrollerproviderid),
                core::mem::transmute_copy(copilotcontrollerproviderid),
            )
            .ok()
        })
    }
    #[cfg(feature = "System")]
    pub fn ClearPairing<P0>(
        user: P0,
        controllerproviderid: &windows_core::HSTRING,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::super::super::System::User>,
    {
        Self::ILegacyGipGameControllerProviderStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).ClearPairing)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                core::mem::transmute_copy(controllerproviderid),
            )
            .ok()
        })
    }
        ...
        P0: windows_core::Param<super::super::super::System::User>,
    {
        Self::ILegacyGipGameControllerProviderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsPilot)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                core::mem::transmute_copy(controllerproviderid),
                &mut result__,
        ...
        P0: windows_core::Param<super::super::super::System::User>,
    {
        Self::ILegacyGipGameControllerProviderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsCopilot)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                core::mem::transmute_copy(controllerproviderid),
                &mut result__,
    ...
    fn ILegacyGipGameControllerProviderStatics<
        R,
        F: FnOnce(&ILegacyGipGameControllerProviderStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for LegacyGipGameControllerProvider {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ILegacyGipGameControllerProvider>();
}
unsafe impl windows_core::Interface for LegacyGipGameControllerProvider {
    ...
    const IID: windows_core::GUID =
        <ILegacyGipGameControllerProvider as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for RemappingButtonCategory {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Gaming.Input.Preview.RemappingButtonCategory;i4)",
    );
}

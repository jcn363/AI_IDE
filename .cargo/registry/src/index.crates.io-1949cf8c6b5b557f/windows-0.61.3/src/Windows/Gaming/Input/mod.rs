...
impl ArcadeStick {
    ...
    ) -> windows_core::Result<GameControllerButtonLabel> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetButtonLabel)(
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<ArcadeStick>>,
    {
        Self::IArcadeStickStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ArcadeStickAdded)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveArcadeStickAdded(token: i64) -> windows_core::Result<()> {
        Self::IArcadeStickStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveArcadeStickAdded)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<ArcadeStick>>,
    {
        Self::IArcadeStickStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ArcadeStickRemoved)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveArcadeStickRemoved(token: i64) -> windows_core::Result<()> {
        Self::IArcadeStickStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveArcadeStickRemoved)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn ArcadeSticks() -> windows_core::Result<windows_collections::IVectorView<ArcadeStick>> {
        Self::IArcadeStickStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ArcadeSticks)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<IGameController, Headset>,
        >,
    {
        let this = &windows_core::Interface::cast::<IGameController>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HeadsetConnected)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HeadsetDisconnected)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<
                IGameController,
                super::super::System::UserChangedEventArgs,
            >,
        >,
    {
        let this = &windows_core::Interface::cast::<IGameController>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UserChanged)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn Headset(&self) -> windows_core::Result<Headset> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Headset)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IArcadeStickStatics<R, F: FnOnce(&IArcadeStickStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ArcadeStick, IArcadeStickStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IArcadeStickStatics2<R, F: FnOnce(&IArcadeStickStatics2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ArcadeStick, IArcadeStickStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for ArcadeStick {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IArcadeStick>();
}
...
impl windows_core::RuntimeType for ArcadeStickButtons {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Gaming.Input.ArcadeStickButtons;u4)",
    );
}
impl ArcadeStickButtons {
...
impl FlightStick {
    pub fn HatSwitchKind(&self) -> windows_core::Result<GameControllerSwitchKind> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HatSwitchKind)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<FlightStick>>,
    {
        Self::IFlightStickStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FlightStickAdded)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveFlightStickAdded(token: i64) -> windows_core::Result<()> {
        Self::IFlightStickStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveFlightStickAdded)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<FlightStick>>,
    {
        Self::IFlightStickStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FlightStickRemoved)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveFlightStickRemoved(token: i64) -> windows_core::Result<()> {
        Self::IFlightStickStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveFlightStickRemoved)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn FlightSticks() -> windows_core::Result<windows_collections::IVectorView<FlightStick>> {
        Self::IFlightStickStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FlightSticks)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IFlightStickStatics<R, F: FnOnce(&IFlightStickStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<FlightStick, IFlightStickStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for FlightStick {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IFlightStick>();
}
...
impl windows_core::RuntimeType for FlightStickButtons {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Gaming.Input.FlightStickButtons;u4)",
    );
}
impl FlightStickButtons {
    pub const fn contains(&self, other: Self) -> bool {
...
impl windows_core::RuntimeType for GamepadButtons {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Gaming.Input.GamepadButtons;u4)");
}
impl GamepadButtons {
    pub const fn contains(&self, other: Self) -> bool {
        self.0 & other.0 == other.0
...
impl Headset {
    ...
    pub fn CaptureDeviceId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CaptureDeviceId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn RenderDeviceId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RenderDeviceId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for Headset {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHeadset>();
}
...
windows_core::imp::define_interface!(
    IArcadeStick,
    IArcadeStick_Vtbl,
    0xb14a539d_befb_4c81_8051_15ecf3b13036
);
...
pub struct IArcadeStick_Vtbl {
    ...
    pub GetButtonLabel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        ArcadeStickButtons,
        *mut GameControllerButtonLabel,
    ) -> windows_core::HRESULT,
    pub GetCurrentReading: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ArcadeStickReading,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IArcadeStickStatics,
    IArcadeStickStatics_Vtbl,
    0x5c37b8c8_37b1_4ad8_9458_200f1a30018e
);
...
pub struct IArcadeStickStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ArcadeStickAdded: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveArcadeStickAdded:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub ArcadeStickRemoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveArcadeStickRemoved:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub ArcadeSticks: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IArcadeStickStatics2_Vtbl,
    0x52b5d744_bb86_445a_b59c_596f0e2a49df
);
...
windows_core::imp::define_interface!(
    IFlightStick,
    IFlightStick_Vtbl,
    0xb4a2c01c_b83b_4459_a1a9_97b03c33da7c
);
...
pub struct IFlightStick_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub HatSwitchKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GameControllerSwitchKind,
    ) -> windows_core::HRESULT,
    pub GetButtonLabel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        FlightStickButtons,
    ...
    pub GetCurrentReading: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut FlightStickReading,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IFlightStickStatics,
    IFlightStickStatics_Vtbl,
    0x5514924a_fecc_435e_83dc_5cec8a18a520
);
...
pub struct IFlightStickStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub FlightStickAdded: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveFlightStickAdded:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub FlightStickRemoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveFlightStickRemoved:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub FlightSticks: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FromGameController: unsafe extern "system" fn(
...
impl IGameController_Vtbl {
    pub const fn new<Identity: IGameController_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn HeadsetConnected<
        ...
        >(
            ...
            unsafe {
                ...
                match IGameController_Impl::HeadsetConnected(
                    this,
        ...
        unsafe extern "system" fn HeadsetDisconnected<
            Identity: IGameController_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IGameController_Impl::HeadsetDisconnected(
                    this,
                    core::mem::transmute_copy(&value),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn UserChanged<
            Identity: IGameController_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Headset<Identity: IGameController_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn User<Identity: IGameController_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
pub struct IGameController_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub HeadsetConnected: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveHeadsetConnected:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub HeadsetDisconnected: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveHeadsetDisconnected:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    #[cfg(feature = "System")]
    pub UserChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    ...
    pub RemoveUserChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub Headset: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsWireless:
...
windows_core::imp::define_interface!(
    IHeadset,
    IHeadset_Vtbl,
    0x3fd156ef_6925_3fa8_9181_029c5223ae3b
);
...
pub struct IHeadset_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CaptureDeviceId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RenderDeviceId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRacingWheel,
    IRacingWheel_Vtbl,
    0xf546656f_e106_4c82_a90f_554012904b85
);
...
pub struct IRacingWheel_Vtbl {
    ...
    pub HasHandbrake:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub HasPatternShifter:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub MaxPatternShifterGear:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub MaxWheelAngle:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    #[cfg(feature = "Gaming_Input_ForceFeedback")]
    pub WheelMotor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GetCurrentReading: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RacingWheelReading,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IRacingWheelStatics,
    IRacingWheelStatics_Vtbl,
    0x3ac12cd5_581b_4936_9f94_69f1e6514c7d
);
...
pub struct IRacingWheelStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RacingWheelAdded: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRacingWheelAdded:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub RacingWheelRemoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveRacingWheelRemoved:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub RacingWheels: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRacingWheelStatics2_Vtbl,
    0xe666bcaa_edfd_4323_a9f6_3c384048d1ed
);
...
pub struct IRawGameController_Vtbl {
    ...
    pub GetSwitchKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut GameControllerSwitchKind,
    ) -> windows_core::HRESULT,
...
pub struct IRawGameController2_Vtbl {
    ...
    pub SimpleHapticsControllers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0xe5aeefdd_f50e_4a55_8cdc_d33229548175
);
...
pub struct IUINavigationController_Vtbl {
    ...
    pub GetCurrentReading: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut UINavigationReading,
    ) -> windows_core::HRESULT,
    pub GetOptionalButtonLabel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        OptionalUINavigationButtons,
        *mut GameControllerButtonLabel,
    ) -> windows_core::HRESULT,
    pub GetRequiredButtonLabel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IUINavigationControllerStatics_Vtbl,
    0x2f14930a_f6f8_4a48_8d89_94786cca0c2e
);
...
pub struct IUINavigationControllerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub UINavigationControllerAdded: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveUINavigationControllerAdded:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub UINavigationControllerRemoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveUINavigationControllerRemoved:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub UINavigationControllers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IUINavigationControllerStatics2_Vtbl,
    0xe0cb28e3_b20b_4b0b_9ed4_f3d53cec0de4
);
...
impl RacingWheel {
    ...
    pub fn HasClutch(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HasClutch)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn HasHandbrake(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HasHandbrake)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn HasPatternShifter(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HasPatternShifter)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MaxPatternShifterGear(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxPatternShifterGear)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn MaxWheelAngle(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaxWheelAngle)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn WheelMotor(&self) -> windows_core::Result<ForceFeedback::ForceFeedbackMotor> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WheelMotor)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<RacingWheel>>,
    {
        Self::IRacingWheelStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RacingWheelAdded)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveRacingWheelAdded(token: i64) -> windows_core::Result<()> {
        Self::IRacingWheelStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveRacingWheelAdded)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<RacingWheel>>,
    {
        Self::IRacingWheelStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RacingWheelRemoved)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveRacingWheelRemoved(token: i64) -> windows_core::Result<()> {
        Self::IRacingWheelStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveRacingWheelRemoved)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn RacingWheels() -> windows_core::Result<windows_collections::IVectorView<RacingWheel>> {
        Self::IRacingWheelStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RacingWheels)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IRacingWheelStatics<R, F: FnOnce(&IRacingWheelStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<RacingWheel, IRacingWheelStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IRacingWheelStatics2<R, F: FnOnce(&IRacingWheelStatics2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<RacingWheel, IRacingWheelStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for RacingWheel {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRacingWheel>();
}
...
impl windows_core::RuntimeType for RacingWheelButtons {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Gaming.Input.RacingWheelButtons;u4)",
    );
}
impl RacingWheelButtons {
    pub const fn contains(&self, other: Self) -> bool {
...
impl RawGameController {
    ...
    pub fn ForceFeedbackMotors(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<ForceFeedback::ForceFeedbackMotor>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSwitchKind(
        &self,
        switchindex: i32,
    ) -> windows_core::Result<GameControllerSwitchKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetSwitchKind)(
                windows_core::Interface::as_raw(this),
                switchindex,
                &mut result__,
            )
    ...
    pub fn SimpleHapticsControllers(
        ...
        windows_collections::IVectorView<super::super::Devices::Haptics::SimpleHapticsController>,
    > {
        let this = &windows_core::Interface::cast::<IRawGameController2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SimpleHapticsControllers)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl UINavigationController {
    ...
    pub fn GetOptionalButtonLabel(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetOptionalButtonLabel)(
                windows_core::Interface::as_raw(this),
                button,
                &mut result__,
            )
    ...
    pub fn GetRequiredButtonLabel(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetRequiredButtonLabel)(
                windows_core::Interface::as_raw(this),
                button,
                &mut result__,
            )
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<UINavigationController>>,
    {
        Self::IUINavigationControllerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UINavigationControllerAdded)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveUINavigationControllerAdded(token: i64) -> windows_core::Result<()> {
        Self::IUINavigationControllerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveUINavigationControllerAdded)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::Foundation::EventHandler<UINavigationController>>,
    {
        Self::IUINavigationControllerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UINavigationControllerRemoved)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveUINavigationControllerRemoved(token: i64) -> windows_core::Result<()> {
        Self::IUINavigationControllerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveUINavigationControllerRemoved)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    ) -> windows_core::Result<windows_collections::IVectorView<UINavigationController>> {
        Self::IUINavigationControllerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UINavigationControllers)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn FromGameController<P0>(
        gamecontroller: P0,
    ) -> windows_core::Result<UINavigationController>
    where
        P0: windows_core::Param<IGameController>,
    {
    ...
    fn IUINavigationControllerStatics<
        R,
        F: FnOnce(&IUINavigationControllerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IUINavigationControllerStatics2<
        R,
        F: FnOnce(&IUINavigationControllerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for UINavigationController {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUINavigationController>();
}

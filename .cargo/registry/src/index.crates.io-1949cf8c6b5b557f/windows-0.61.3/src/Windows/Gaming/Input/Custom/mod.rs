...
impl GameControllerFactoryManager {
    ...
    {
        Self::IGameControllerFactoryManagerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RegisterCustomFactoryForHardwareId)(
                windows_core::Interface::as_raw(this),
                factory.param().abi(),
                hardwarevendorid,
                hardwareproductid,
    ...
    {
        Self::IGameControllerFactoryManagerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RegisterCustomFactoryForXusbType)(
                windows_core::Interface::as_raw(this),
                factory.param().abi(),
                xusbtype,
                xusbsubtype,
    ...
    pub fn TryGetFactoryControllerFromGameController<P0, P1>(
        factory: P0,
        gamecontroller: P1,
    ) -> windows_core::Result<super::IGameController>
    where
        P0: windows_core::Param<ICustomGameControllerFactory>,
        P1: windows_core::Param<super::IGameController>,
    {
        Self::IGameControllerFactoryManagerStatics2(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).TryGetFactoryControllerFromGameController)(
                windows_core::Interface::as_raw(this),
                factory.param().abi(),
    ...
    fn IGameControllerFactoryManagerStatics<
        R,
        F: FnOnce(&IGameControllerFactoryManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ...
    fn IGameControllerFactoryManagerStatics2<
        R,
        F: FnOnce(&IGameControllerFactoryManagerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl GipFirmwareUpdateResult {
    ...
    pub fn FinalComponentId(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FinalComponentId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for GipFirmwareUpdateResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGipFirmwareUpdateResult>();
}
...
impl GipGameControllerProvider {
    pub fn FirmwareVersionInfo(&self) -> windows_core::Result<GameControllerVersionInfo> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FirmwareVersionInfo)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn HardwareVersionInfo(&self) -> windows_core::Result<GameControllerVersionInfo> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HardwareVersionInfo)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SendMessage(
        ...
        unsafe {
            (windows_core::Interface::vtable(this).SendMessage)(
                ...
                messageclass,
                messageid,
                messagebuffer.len().try_into().unwrap(),
                messagebuffer.as_ptr(),
            )
            .ok()
        }
    }
    pub fn SendReceiveMessage(
        ...
        messageclass: GipMessageClass,
        messageid: u8,
        requestmessagebuffer: &[u8],
        responsemessagebuffer: &mut [u8],
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SendReceiveMessage)(
                windows_core::Interface::as_raw(this),
                messageclass,
                messageid,
                requestmessagebuffer.len().try_into().unwrap(),
                requestmessagebuffer.as_ptr(),
                responsemessagebuffer.len().try_into().unwrap(),
                responsemessagebuffer.as_mut_ptr(),
            )
            .ok()
        }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn UpdateFirmwareAsync<P0>(
        &self,
        firmwareimage: P0,
    ) -> windows_core::Result<
        ...
        P0: windows_core::Param<super::super::super::Storage::Streams::IInputStream>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UpdateFirmwareAsync)(
                windows_core::Interface::as_raw(this),
                firmwareimage.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
impl windows_core::RuntimeType for GipGameControllerProvider {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGipGameControllerProvider>();
}
...
impl HidGameControllerProvider {
    ...
    pub fn GetFeatureReport(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).GetFeatureReport)(
                windows_core::Interface::as_raw(this),
                reportid,
                reportbuffer.len().try_into().unwrap(),
    ...
    pub fn SendFeatureReport(&self, reportid: u8, reportbuffer: &[u8]) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SendFeatureReport)(
                windows_core::Interface::as_raw(this),
                reportid,
                reportbuffer.len().try_into().unwrap(),
                reportbuffer.as_ptr(),
    ...
    pub fn SendOutputReport(&self, reportid: u8, reportbuffer: &[u8]) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SendOutputReport)(
                windows_core::Interface::as_raw(this),
                reportid,
                reportbuffer.len().try_into().unwrap(),
                reportbuffer.as_ptr(),
...
impl windows_core::RuntimeType for HidGameControllerProvider {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHidGameControllerProvider>();
}
...
windows_core::imp::define_interface!(
    ...
    0x69a0ae5e_758e_4cbe_ace6_62155fe9126f
);
...
impl ICustomGameControllerFactory {
    pub fn CreateGameController<P0>(
        &self,
        provider: P0,
        ...
        P0: windows_core::Param<IGameControllerProvider>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateGameController)(
                windows_core::Interface::as_raw(this),
                provider.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<super::IGameController>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).OnGameControllerAdded)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
        ...
        P0: windows_core::Param<super::IGameController>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).OnGameControllerRemoved)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
...
pub trait ICustomGameControllerFactory_Impl: windows_core::IUnknownImpl {
    fn CreateGameController(
        &self,
        provider: windows_core::Ref<'_, IGameControllerProvider>,
    ) -> windows_core::Result<windows_core::IInspectable>;
    fn OnGameControllerAdded(
        &self,
        value: windows_core::Ref<'_, super::IGameController>,
    ) -> windows_core::Result<()>;
...
impl ICustomGameControllerFactory_Vtbl {
    pub const fn new<Identity: ICustomGameControllerFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateGameController<
            Identity: ICustomGameControllerFactory_Impl,
            const OFFSET: isize,
        >(
            ...
            unsafe {
                ...
                match ICustomGameControllerFactory_Impl::CreateGameController(
                    this,
        ...
        unsafe extern "system" fn OnGameControllerAdded<
            Identity: ICustomGameControllerFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICustomGameControllerFactory_Impl::OnGameControllerAdded(
                    this,
        ...
        unsafe extern "system" fn OnGameControllerRemoved<
            Identity: ICustomGameControllerFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICustomGameControllerFactory_Impl::OnGameControllerRemoved(
                    this,
                    core::mem::transmute_copy(&value),
                )
                .into()
...
pub struct ICustomGameControllerFactory_Vtbl {
    ...
    pub CreateGameController: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OnGameControllerAdded: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OnGameControllerRemoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub struct IGameControllerFactoryManagerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RegisterCustomFactoryForGipInterface: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::GUID,
    )
        -> windows_core::HRESULT,
    pub RegisterCustomFactoryForHardwareId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u16,
        u16,
    ) -> windows_core::HRESULT,
    pub RegisterCustomFactoryForXusbType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        XusbDeviceType,
        XusbDeviceSubtype,
...
windows_core::imp::define_interface!(
    ...
    0xeace5644_19df_4115_b32a_2793e2aea3bb
);
...
windows_core::imp::define_interface!(
    ...
    0x1ff6f922_c640_4c78_a820_9a715c558bcb
);
...
impl IGameControllerInputSink {
    pub fn OnInputResumed(&self, timestamp: u64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).OnInputResumed)(
                windows_core::Interface::as_raw(this),
                timestamp,
            )
            .ok()
    ...
    pub fn OnInputSuspended(&self, timestamp: u64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).OnInputSuspended)(
                windows_core::Interface::as_raw(this),
                timestamp,
            )
            .ok()
...
impl IGameControllerInputSink_Vtbl {
    pub const fn new<Identity: IGameControllerInputSink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnInputResumed<
            Identity: IGameControllerInputSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            timestamp: u64,
        ...
        unsafe extern "system" fn OnInputSuspended<
            Identity: IGameControllerInputSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub struct IGameControllerInputSink_Vtbl {
    ...
    pub OnInputSuspended:
        unsafe extern "system" fn(*mut core::ffi::c_void, u64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IGameControllerProvider,
    IGameControllerProvider_Vtbl,
    0xe6d73982_2996_4559_b16c_3e57d46e58d6
);
...
impl IGameControllerProvider_Vtbl {
    pub const fn new<Identity: IGameControllerProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn FirmwareVersionInfo<
            Identity: IGameControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn HardwareProductId<
            Identity: IGameControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn HardwareVendorId<
            Identity: IGameControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn HardwareVersionInfo<
            Identity: IGameControllerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub struct IGameControllerProvider_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub FirmwareVersionInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GameControllerVersionInfo,
    ) -> windows_core::HRESULT,
    pub HardwareProductId:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u16) -> windows_core::HRESULT,
    pub HardwareVendorId:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u16) -> windows_core::HRESULT,
    pub HardwareVersionInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GameControllerVersionInfo,
    ) -> windows_core::HRESULT,
    pub IsConnected:
...
windows_core::imp::define_interface!(
    ...
    0x6b794d32_8553_4292_8e03_e16651a2f8bc
);
...
impl IGipGameControllerInputSink {
    pub fn OnKeyReceived(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).OnKeyReceived)(
                windows_core::Interface::as_raw(this),
                timestamp,
                keycode,
                ispressed,
    ...
    pub fn OnMessageReceived(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).OnMessageReceived)(
                windows_core::Interface::as_raw(this),
                timestamp,
                messageclass,
                messageid,
...
impl IGipGameControllerInputSink_Vtbl {
    pub const fn new<Identity: IGipGameControllerInputSink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnKeyReceived<
            Identity: IGipGameControllerInputSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            timestamp: u64,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGipGameControllerInputSink_Impl::OnKeyReceived(this, timestamp, keycode, ispressed)
                    .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGipGameControllerInputSink_Impl::OnMessageReceived(
                    this,
                    timestamp,
                    messageclass,
                    messageid,
                    ...
                    core::slice::from_raw_parts(
                        core::mem::transmute_copy(&messagebuffer),
                        messagebuffer_array_size as usize,
                    ),
                )
                .into()
            }
...
pub struct IGipGameControllerInputSink_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub OnKeyReceived:
        unsafe extern "system" fn(*mut core::ffi::c_void, u64, u8, bool) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IGipGameControllerProvider_Vtbl,
    0xdbcf1e19_1af5_45a8_bf02_a0ee50c823fc
);
...
pub struct IGipGameControllerProvider_Vtbl {
    ...
    pub SendReceiveMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        GipMessageClass,
        u8,
        u32,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub UpdateFirmwareAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0xf754c322_182d_40e4_a126_fcee4ffa1e31
);
...
impl IHidGameControllerInputSink {
    pub fn OnInputReportReceived(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).OnInputReportReceived)(
                windows_core::Interface::as_raw(this),
                timestamp,
                reportid,
                reportbuffer.len().try_into().unwrap(),
...
impl IHidGameControllerInputSink_Vtbl {
    pub const fn new<Identity: IHidGameControllerInputSink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnInputReportReceived<
            Identity: IHidGameControllerInputSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            timestamp: u64,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHidGameControllerInputSink_Impl::OnInputReportReceived(
                    this,
                    timestamp,
                    reportid,
                    core::slice::from_raw_parts(
                        core::mem::transmute_copy(&reportbuffer),
                        reportbuffer_array_size as usize,
                    ),
                )
                .into()
            }
...
pub struct IHidGameControllerInputSink_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub OnInputReportReceived: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        u8,
        u32,
...
windows_core::imp::define_interface!(
    ...
    IHidGameControllerProvider_Vtbl,
    0x95ce3af4_abf0_4b68_a081_3b7de73ff0e7
);
...
pub struct IHidGameControllerProvider_Vtbl {
    ...
    pub UsagePage:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u16) -> windows_core::HRESULT,
    pub GetFeatureReport: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        u32,
        *mut u8,
    ) -> windows_core::HRESULT,
    pub SendFeatureReport: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        u32,
        *const u8,
    ) -> windows_core::HRESULT,
    pub SendOutputReport: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u8,
        u32,
        *const u8,
...
windows_core::imp::define_interface!(
    ...
    0xb2ac1d95_6ecb_42b3_8aab_025401ca4712
);
...
impl IXusbGameControllerInputSink {
    pub fn OnInputReceived(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).OnInputReceived)(
                windows_core::Interface::as_raw(this),
                timestamp,
                reportid,
                inputbuffer.len().try_into().unwrap(),
                inputbuffer.as_ptr(),
            )
            .ok()
        }
...
impl IXusbGameControllerInputSink_Vtbl {
    pub const fn new<Identity: IXusbGameControllerInputSink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnInputReceived<
            Identity: IXusbGameControllerInputSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            timestamp: u64,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IXusbGameControllerInputSink_Impl::OnInputReceived(
                    this,
                    timestamp,
                    reportid,
                    core::slice::from_raw_parts(
                        core::mem::transmute_copy(&inputbuffer),
                        inputbuffer_array_size as usize,
                    ),
                )
                .into()
            }
...
pub struct IXusbGameControllerInputSink_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub OnInputReceived: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        u8,
        u32,
...
windows_core::imp::define_interface!(
    ...
    IXusbGameControllerProvider_Vtbl,
    0x6e2971eb_0efb_48b4_808b_837643b2f216
);
...
impl windows_core::RuntimeType for XusbGameControllerProvider {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IXusbGameControllerProvider>();
}

windows_core::imp::define_interface!(
    ...
    IPhoneNumberFormatter_Vtbl,
    0x1556b49e_bad4_4b4a_900d_4407adb7c981
);
...
pub struct IPhoneNumberFormatter_Vtbl {
    ...
    pub FormatWithOutputFormat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        PhoneNumberFormat,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FormatPartialString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FormatString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FormatStringWithLeftToRightMarkers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IPhoneNumberFormatterStatics_Vtbl,
    0x5ca6f931_84d9_414b_ab4e_a0552c878602
);
...
pub struct IPhoneNumberFormatterStatics_Vtbl {
    ...
    pub GetCountryCodeForRegion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i32,
    ) -> windows_core::HRESULT,
    pub GetNationalDirectDialingPrefixForRegion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        bool,
        *mut *mut core::ffi::c_void,
        ...
        -> windows_core::HRESULT,
    pub WrapWithLeftToRightMarkers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IPhoneNumberInfo,
    IPhoneNumberInfo_Vtbl,
    0x1c7ce4dd_c8b4_4ea3_9aef_b342e2c5b417
);
...
pub struct IPhoneNumberInfo_Vtbl {
    ...
    pub GetLengthOfGeographicalAreaCode:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub GetNationalSignificantNumber: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetLengthOfNationalDestinationCode:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub PredictNumberKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PredictedPhoneNumberKind,
    ) -> windows_core::HRESULT,
    pub GetGeographicRegionCode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CheckNumberMatch: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut PhoneNumberMatchResult,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPhoneNumberInfoFactory,
    IPhoneNumberInfoFactory_Vtbl,
    0x8202b964_adaa_4cff_8fcf_17e7516a28ff
);
...
windows_core::imp::define_interface!(
    ...
    IPhoneNumberInfoStatics_Vtbl,
    0x5b3f4f6a_86a9_40e9_8649_6d61161928d4
);
...
pub struct IPhoneNumberInfoStatics_Vtbl {
    ...
    pub TryParse: unsafe extern "system" fn(
        ...
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
        *mut PhoneNumberParseResult,
    ) -> windows_core::HRESULT,
    pub TryParseWithRegion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
impl windows_core::RuntimeType for PhoneNumberFormat {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Globalization.PhoneNumberFormatting.PhoneNumberFormat;i4)",
    );
}
#[repr(transparent)]
...
impl PhoneNumberFormatter {
    ...
    pub fn FormatWithOutputFormat<P0>(
        &self,
        number: P0,
        ...
        P0: windows_core::Param<PhoneNumberInfo>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FormatWithOutputFormat)(
                windows_core::Interface::as_raw(this),
                number.param().abi(),
                numberformat,
                &mut result__,
    ...
    pub fn FormatPartialString(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FormatPartialString)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn FormatString(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FormatString)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(number),
                &mut result__,
            )
    ...
    pub fn FormatStringWithLeftToRightMarkers(
        &self,
        number: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FormatStringWithLeftToRightMarkers)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(number),
                &mut result__,
            )
    ...
    pub fn TryCreate(
        regioncode: &windows_core::HSTRING,
        phonenumber: &mut Option<PhoneNumberFormatter>,
    ) -> windows_core::Result<()> {
        Self::IPhoneNumberFormatterStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).TryCreate)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(regioncode),
                phonenumber as *mut _ as _,
            )
            .ok()
        })
    }
    pub fn GetCountryCodeForRegion(
        regioncode: &windows_core::HSTRING,
    ) -> windows_core::Result<i32> {
        Self::IPhoneNumberFormatterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCountryCodeForRegion)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(regioncode),
                &mut result__,
            )
    ...
    pub fn GetNationalDirectDialingPrefixForRegion(
        regioncode: &windows_core::HSTRING,
        stripnondigit: bool,
    ) -> windows_core::Result<windows_core::HSTRING> {
        Self::IPhoneNumberFormatterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNationalDirectDialingPrefixForRegion)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(regioncode),
                stripnondigit,
                &mut result__,
    ...
    pub fn WrapWithLeftToRightMarkers(
        number: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_core::HSTRING> {
        Self::IPhoneNumberFormatterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WrapWithLeftToRightMarkers)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(number),
                &mut result__,
            )
    ...
    fn IPhoneNumberFormatterStatics<
        R,
        F: FnOnce(&IPhoneNumberFormatterStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for PhoneNumberFormatter {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPhoneNumberFormatter>();
}
...
impl PhoneNumberInfo {
    ...
    pub fn GetLengthOfGeographicalAreaCode(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetLengthOfGeographicalAreaCode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetNationalSignificantNumber(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNationalSignificantNumber)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn GetLengthOfNationalDestinationCode(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetLengthOfNationalDestinationCode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn PredictNumberKind(&self) -> windows_core::Result<PredictedPhoneNumberKind> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PredictNumberKind)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetGeographicRegionCode(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetGeographicRegionCode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn CheckNumberMatch<P0>(
        &self,
        othernumber: P0,
    ) -> windows_core::Result<PhoneNumberMatchResult>
    where
        P0: windows_core::Param<PhoneNumberInfo>,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CheckNumberMatch)(
                windows_core::Interface::as_raw(this),
                othernumber.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub fn TryParse(
        ...
        phonenumber: &mut Option<PhoneNumberInfo>,
    ) -> windows_core::Result<PhoneNumberParseResult> {
    ...
    pub fn TryParseWithRegion(
        ...
        Self::IPhoneNumberInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryParseWithRegion)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(input),
                core::mem::transmute_copy(regioncode),
                phonenumber as *mut _ as _,
    ...
    fn IPhoneNumberInfoFactory<
        R,
        F: FnOnce(&IPhoneNumberInfoFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PhoneNumberInfo, IPhoneNumberInfoFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IPhoneNumberInfoStatics<
        R,
        F: FnOnce(&IPhoneNumberInfoStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PhoneNumberInfo, IPhoneNumberInfoStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for PhoneNumberInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPhoneNumberInfo>();
}
...
impl windows_core::RuntimeType for PhoneNumberMatchResult {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Globalization.PhoneNumberFormatting.PhoneNumberMatchResult;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for PhoneNumberParseResult {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Globalization.PhoneNumberFormatting.PhoneNumberParseResult;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for PredictedPhoneNumberKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Globalization.PhoneNumberFormatting.PredictedPhoneNumberKind;i4)",
    );
}

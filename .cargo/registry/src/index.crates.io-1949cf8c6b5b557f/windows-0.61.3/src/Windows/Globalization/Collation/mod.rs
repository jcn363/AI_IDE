...
impl windows_core::RuntimeType for CharacterGrouping {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICharacterGrouping>();
}
...
windows_core::imp::required_hierarchy!(
    CharacterGroupings,
    windows_collections::IIterable<CharacterGrouping>,
    windows_collections::IVectorView<CharacterGrouping>
);
impl CharacterGroupings {
    ...
    pub fn First(&self) -> windows_core::Result<windows_collections::IIterator<CharacterGrouping>> {
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [Option<CharacterGrouping>],
    ...
    fn ICharacterGroupingsFactory<
        R,
        F: FnOnce(&ICharacterGroupingsFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for CharacterGroupings {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICharacterGroupings>();
}
unsafe impl windows_core::Interface for CharacterGroupings {
    type Vtable = <ICharacterGroupings as windows_core::Interface>::Vtable;
...
windows_core::imp::define_interface!(
    ICharacterGrouping,
    ICharacterGrouping_Vtbl,
    0xfae761bb_805d_4bb0_95bb_c1f7c3e8eb8e
);
...
windows_core::imp::define_interface!(
    ICharacterGroupings,
    ICharacterGroupings_Vtbl,
    0xb8d20a75_d4cf_4055_80e5_ce169c226496
);
...
windows_core::imp::define_interface!(
    ICharacterGroupingsFactory,
    ICharacterGroupingsFactory_Vtbl,
    0x99ea9fd9_886d_4401_9f98_69c82d4c2f78
);

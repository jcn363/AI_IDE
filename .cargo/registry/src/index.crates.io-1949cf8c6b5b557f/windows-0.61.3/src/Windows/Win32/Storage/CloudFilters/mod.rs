...
) -> windows_core::Result<CF_CONNECTION_KEY>
where
...
pub unsafe fn CfConvertToPlaceholder(
    ...
    fileidentity: Option<*const core::ffi::c_void>,
    ...
    unsafe {
        CfConvertToPlaceholder(
            filehandle,
            fileidentity.unwrap_or(core::mem::zeroed()) as _,
            fileidentitylength,
            convertflags,
            convertusn.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn CfCreatePlaceholders<P0>(
    basedirectorypath: P0,
    placeholderarray: &mut [CF_PLACEHOLDER_CREATE_INFO],
    createflags: CF_CREATE_FLAGS,
    entriesprocessed: Option<*mut u32>,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        CfCreatePlaceholders(
            basedirectorypath.param().abi(),
            core::mem::transmute(placeholderarray.as_ptr()),
            placeholderarray.len().try_into().unwrap(),
            createflags,
            entriesprocessed.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[cfg(all(
    ...
    feature = "Win32_System_CorrelationVector"
))]
#[inline]
...
pub unsafe fn CfGetCorrelationVector(
    filehandle: super::super::Foundation::HANDLE,
    correlationvector: *mut super::super::System::CorrelationVector::CORRELATION_VECTOR,
) -> windows_core::Result<()> {
...
pub unsafe fn CfGetPlaceholderInfo(
    ...
    infobuffer: *mut core::ffi::c_void,
...
#[inline]
pub unsafe fn CfGetPlaceholderRangeInfoForHydration(
    ...
    infobuffer: *mut core::ffi::c_void,
    infobuffersize: u32,
    infobufferwritten: Option<*mut u32>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        CfGetPlaceholderRangeInfoForHydration(
            ...
            infobuffer as _,
            infobuffersize,
            infobufferwritten.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn CfQuerySyncProviderStatus(
    connectionkey: CF_CONNECTION_KEY,
) -> windows_core::Result<CF_SYNC_PROVIDER_STATUS> {
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        CfReportSyncStatus(
            syncrootpath.param().abi(),
            syncstatus.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn CfSetCorrelationVector(
    filehandle: super::super::Foundation::HANDLE,
    correlationvector: *const super::super::System::CorrelationVector::CORRELATION_VECTOR,
) -> windows_core::Result<()> {
...
pub unsafe fn CfSetInSyncState(
    ...
    unsafe {
        CfSetInSyncState(
            ...
            insyncstate,
            insyncflags,
            insyncusn.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn CfUpdatePlaceholder(
    ...
    unsafe {
        CfUpdatePlaceholder(
            filehandle,
            fsmetadata.unwrap_or(core::mem::zeroed()) as _,
            fileidentity.unwrap_or(core::mem::zeroed()) as _,
            fileidentitylength,
            core::mem::transmute(
                dehydraterangearray
            ...
            updateflags,
            updateusn.unwrap_or(core::mem::zeroed()) as _,
            overlapped.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub const CF_CALLBACK_DELETE_COMPLETION_FLAG_NONE: CF_CALLBACK_DELETE_COMPLETION_FLAGS =
    CF_CALLBACK_DELETE_COMPLETION_FLAGS(0i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CF_CALLBACK_FETCH_PLACEHOLDERS_FLAG_NONE: CF_CALLBACK_FETCH_PLACEHOLDERS_FLAGS =
    CF_CALLBACK_FETCH_PLACEHOLDERS_FLAGS(0i32);
#[repr(C)]
#[cfg(feature = "Win32_System_CorrelationVector")]
...
pub const CF_CALLBACK_RENAME_COMPLETION_FLAG_NONE: CF_CALLBACK_RENAME_COMPLETION_FLAGS =
    CF_CALLBACK_RENAME_COMPLETION_FLAGS(0i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CF_HYDRATION_POLICY_ALWAYS_FULL: CF_HYDRATION_POLICY_PRIMARY =
    CF_HYDRATION_POLICY_PRIMARY(3u16);
...
pub const CF_OPERATION_ACK_DATA_FLAG_NONE: CF_OPERATION_ACK_DATA_FLAGS =
    CF_OPERATION_ACK_DATA_FLAGS(0i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CF_OPERATION_ACK_DEHYDRATE_FLAG_NONE: CF_OPERATION_ACK_DEHYDRATE_FLAGS =
    CF_OPERATION_ACK_DEHYDRATE_FLAGS(0i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CF_OPERATION_ACK_DELETE_FLAG_NONE: CF_OPERATION_ACK_DELETE_FLAGS =
    CF_OPERATION_ACK_DELETE_FLAGS(0i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CF_OPERATION_ACK_RENAME_FLAG_NONE: CF_OPERATION_ACK_RENAME_FLAGS =
    CF_OPERATION_ACK_RENAME_FLAGS(0i32);
#[repr(C)]
#[cfg(feature = "Win32_System_CorrelationVector")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const CF_OPERATION_RETRIEVE_DATA_FLAG_NONE: CF_OPERATION_RETRIEVE_DATA_FLAGS =
    CF_OPERATION_RETRIEVE_DATA_FLAGS(0i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CF_OPERATION_TRANSFER_DATA_FLAG_NONE: CF_OPERATION_TRANSFER_DATA_FLAGS =
    CF_OPERATION_TRANSFER_DATA_FLAGS(0i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAG_DISABLE_ON_DEMAND_POPULATION:
    CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAGS = CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAGS(2i32);
pub const CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAG_NONE: CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAGS =
    CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAGS(0i32);
pub const CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAG_STOP_ON_ERROR:
    CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAGS = CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAGS(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CF_POPULATION_POLICY_ALWAYS_FULL: CF_POPULATION_POLICY_PRIMARY =
    CF_POPULATION_POLICY_PRIMARY(3u16);
pub const CF_POPULATION_POLICY_FULL: CF_POPULATION_POLICY_PRIMARY =
    CF_POPULATION_POLICY_PRIMARY(2u16);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CF_POPULATION_POLICY_MODIFIER_NONE: CF_POPULATION_POLICY_MODIFIER =
    CF_POPULATION_POLICY_MODIFIER(0u16);
pub const CF_POPULATION_POLICY_PARTIAL: CF_POPULATION_POLICY_PRIMARY =
    CF_POPULATION_POLICY_PRIMARY(0u16);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]

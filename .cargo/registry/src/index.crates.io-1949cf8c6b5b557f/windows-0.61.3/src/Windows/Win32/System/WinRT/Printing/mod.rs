windows_core::imp::define_interface!(
    ...
    0xa96bb1db_172e_4667_82b5_ad97a252318f
);
...
impl IPrintDocumentPageSource {
    ...
    pub unsafe fn GetPreviewPageCollection<P0>(
        &self,
        docpackagetarget: P0,
    ) -> windows_core::Result<IPrintPreviewPageCollection>
    where
        P0: windows_core::Param<
            super::super::super::Storage::Xps::Printing::IPrintDocumentPackageTarget,
        >,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPreviewPageCollection)(
                windows_core::Interface::as_raw(self),
                docpackagetarget.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(feature = "Win32_Storage_Xps_Printing")]
    pub unsafe fn MakeDocument<P0, P1>(
        &self,
        printtaskoptions: P0,
        docpackagetarget: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).MakeDocument)(
                windows_core::Interface::as_raw(self),
                printtaskoptions.param().abi(),
                docpackagetarget.param().abi(),
            )
            .ok()
        }
...
pub struct IPrintDocumentPageSource_Vtbl {
    ...
    #[cfg(feature = "Win32_Storage_Xps_Printing")]
    pub GetPreviewPageCollection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Win32_Storage_Xps_Printing")]
    pub MakeDocument: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IPrintDocumentPageSource_Impl: windows_core::IUnknownImpl {
    fn GetPreviewPageCollection(
        &self,
        docpackagetarget: windows_core::Ref<
            '_,
            super::super::super::Storage::Xps::Printing::IPrintDocumentPackageTarget,
        >,
    ) -> windows_core::Result<IPrintPreviewPageCollection>;
    fn MakeDocument(
        &self,
        printtaskoptions: windows_core::Ref<'_, windows_core::IInspectable>,
        docpackagetarget: windows_core::Ref<
            '_,
            super::super::super::Storage::Xps::Printing::IPrintDocumentPackageTarget,
        >,
...
impl IPrintDocumentPageSource_Vtbl {
    pub const fn new<Identity: IPrintDocumentPageSource_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetPreviewPageCollection<
            Identity: IPrintDocumentPageSource_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            docpackagetarget: *mut core::ffi::c_void,
            docpagecollection: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IPrintDocumentPageSource_Impl::GetPreviewPageCollection(
                    this,
        ...
        unsafe extern "system" fn MakeDocument<
            Identity: IPrintDocumentPageSource_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            printtaskoptions: *mut core::ffi::c_void,
            docpackagetarget: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintDocumentPageSource_Impl::MakeDocument(
                    this,
                    core::mem::transmute_copy(&printtaskoptions),
                    core::mem::transmute_copy(&docpackagetarget),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0xc5435a42_8d43_4e7b_a68a_ef311e392087
);
...
impl IPrintManagerInterop {
    pub unsafe fn GetForWindow<T>(
        &self,
        appwindow: super::super::super::Foundation::HWND,
    ...
    pub unsafe fn ShowPrintUIForWindowAsync<T>(
        &self,
        appwindow: super::super::super::Foundation::HWND,
    ) -> windows_core::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).ShowPrintUIForWindowAsync)(
                windows_core::Interface::as_raw(self),
                appwindow,
                &T::IID,
                &mut result__,
...
pub struct IPrintManagerInterop_Vtbl {
    ...
    pub ShowPrintUIForWindowAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::Foundation::HWND,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
...
pub trait IPrintManagerInterop_Impl: windows_core::IUnknownImpl {
    fn GetForWindow(
        ...
        printmanager: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: IPrintManagerInterop_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintManagerInterop_Impl::GetForWindow(
                    this,
                    core::mem::transmute_copy(&appwindow),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&printmanager),
                )
                .into()
            }
        }
        unsafe extern "system" fn ShowPrintUIForWindowAsync<
            Identity: IPrintManagerInterop_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintManagerInterop_Impl::ShowPrintUIForWindowAsync(
                    this,
                    core::mem::transmute_copy(&appwindow),
                    core::mem::transmute_copy(&riid),
...
impl IPrintPreviewPageCollection {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Paginate)(
                windows_core::Interface::as_raw(self),
                currentjobpage,
                printtaskoptions.param().abi(),
            )
    ...
    pub unsafe fn MakePage(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).MakePage)(
                windows_core::Interface::as_raw(self),
                desiredjobpage,
                width,
                height,
...
impl IPrintPreviewPageCollection_Vtbl {
    pub const fn new<Identity: IPrintPreviewPageCollection_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Paginate<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintPreviewPageCollection_Impl::Paginate(
                    this,
                    core::mem::transmute_copy(&currentjobpage),
                    core::mem::transmute_copy(&printtaskoptions),
                )
                .into()
            }
        }
        unsafe extern "system" fn MakePage<
            Identity: IPrintPreviewPageCollection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintPreviewPageCollection_Impl::MakePage(
                    this,
                    core::mem::transmute_copy(&desiredjobpage),
        ...
        Self {
            ...
            MakePage: MakePage::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xc056be0a_9ee2_450a_9823_964f0006f2bb
);
...
impl IPrintWorkflowConfigurationNative {
    ...
    pub unsafe fn PrinterQueue(
        &self,
    ) -> windows_core::Result<super::super::super::Graphics::Printing::IPrinterQueue> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_Graphics_Printing", feature = "Win32_System_Com"))]
    pub unsafe fn DriverProperties(
        &self,
    ) -> windows_core::Result<super::super::super::Graphics::Printing::IPrinterPropertyBag> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
windows_core::imp::define_interface!(
    ...
    0x68c9e477_993e_4052_8ac6_454eff58db9d
);
windows_core::imp::interface_hierarchy!(
    IPrintWorkflowObjectModelSourceFileContentNative,
    windows_core::IUnknown
...
impl IPrintWorkflowObjectModelSourceFileContentNative {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StartXpsOMGeneration)(
                windows_core::Interface::as_raw(self),
                receiver.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn ObjectFactory(
        &self,
    ) -> windows_core::Result<super::super::super::Storage::Xps::IXpsOMObjectFactory1> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ObjectFactory)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IPrintWorkflowObjectModelSourceFileContentNative_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub StartXpsOMGeneration: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_Storage_Xps")]
    pub ObjectFactory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
#[cfg(feature = "Win32_Storage_Xps")]
pub trait IPrintWorkflowObjectModelSourceFileContentNative_Impl:
    windows_core::IUnknownImpl
{
    fn StartXpsOMGeneration(
        &self,
        receiver: windows_core::Ref<'_, IPrintWorkflowXpsReceiver>,
    ) -> windows_core::Result<()>;
    fn ObjectFactory(
        &self,
    ) -> windows_core::Result<super::super::super::Storage::Xps::IXpsOMObjectFactory1>;
...
impl IPrintWorkflowObjectModelSourceFileContentNative_Vtbl {
    pub const fn new<
        ...
        const OFFSET: isize,
    >() -> Self {
        unsafe extern "system" fn StartXpsOMGeneration<
            Identity: IPrintWorkflowObjectModelSourceFileContentNative_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintWorkflowObjectModelSourceFileContentNative_Impl::StartXpsOMGeneration(
                    this,
        ...
        unsafe extern "system" fn ObjectFactory<
            Identity: IPrintWorkflowObjectModelSourceFileContentNative_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl IPrintWorkflowXpsObjectModelTargetPackageNative {
    #[cfg(feature = "Win32_Storage_Xps")]
    pub unsafe fn DocumentPackageTarget(
        &self,
    ) -> windows_core::Result<super::super::super::Storage::Xps::IXpsDocumentPackageTarget> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DocumentPackageTarget)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IPrintWorkflowXpsObjectModelTargetPackageNative_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_Storage_Xps")]
    pub DocumentPackageTarget: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Storage_Xps"))]
...
impl IPrintWorkflowXpsObjectModelTargetPackageNative_Vtbl {
    pub const fn new<
        ...
        const OFFSET: isize,
    >() -> Self {
        unsafe extern "system" fn DocumentPackageTarget<
            Identity: IPrintWorkflowXpsObjectModelTargetPackageNative_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IPrintWorkflowXpsObjectModelTargetPackageNative_Impl::DocumentPackageTarget(
                    this,
                ) {
                    Ok(ok__) => {
                        value.write(core::mem::transmute(ok__));
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            DocumentPackageTarget: DocumentPackageTarget::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x04097374_77b8_47f6_8167_aae29d4cf84b
);
windows_core::imp::interface_hierarchy!(IPrintWorkflowXpsReceiver, windows_core::IUnknown);
impl IPrintWorkflowXpsReceiver {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SetDocumentSequencePrintTicket<P0>(
        &self,
        documentsequenceprintticket: P0,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::super::Com::IStream>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetDocumentSequencePrintTicket)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn SetDocumentSequenceUri<P0>(
        &self,
        documentsequenceuri: P0,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetDocumentSequenceUri)(
                windows_core::Interface::as_raw(self),
                documentsequenceuri.param().abi(),
            )
            .ok()
        }
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn AddDocumentData<P1, P2>(
        &self,
        documentid: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddDocumentData)(
                windows_core::Interface::as_raw(self),
                documentid,
                documentprintticket.param().abi(),
                documenturi.param().abi(),
            )
            .ok()
        }
    }
    #[cfg(feature = "Win32_Storage_Xps")]
    pub unsafe fn AddPage<P2, P3>(
        &self,
        documentid: u32,
        pageid: u32,
        pagereference: P2,
...
pub struct IPrintWorkflowXpsReceiver_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_System_Com")]
    pub SetDocumentSequencePrintTicket: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    SetDocumentSequencePrintTicket: usize,
    pub SetDocumentSequenceUri: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub AddDocumentData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
...
pub trait IPrintWorkflowXpsReceiver_Impl: windows_core::IUnknownImpl {
    fn SetDocumentSequencePrintTicket(
        &self,
        documentsequenceprintticket: windows_core::Ref<'_, super::super::Com::IStream>,
    ) -> windows_core::Result<()>;
    fn SetDocumentSequenceUri(
        &self,
        documentsequenceuri: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    fn AddDocumentData(
        &self,
        documentid: u32,
        documentprintticket: windows_core::Ref<'_, super::super::Com::IStream>,
        documenturi: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    fn AddPage(
        &self,
        documentid: u32,
        pageid: u32,
        pagereference: windows_core::Ref<
            '_,
            super::super::super::Storage::Xps::IXpsOMPageReference,
        >,
        pageuri: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
...
impl IPrintWorkflowXpsReceiver_Vtbl {
    pub const fn new<Identity: IPrintWorkflowXpsReceiver_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetDocumentSequencePrintTicket<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintWorkflowXpsReceiver_Impl::SetDocumentSequencePrintTicket(
                    this,
        ...
        unsafe extern "system" fn SetDocumentSequenceUri<
            Identity: IPrintWorkflowXpsReceiver_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintWorkflowXpsReceiver_Impl::SetDocumentSequenceUri(
                    this,
                    core::mem::transmute(&documentsequenceuri),
                )
                .into()
            }
        }
        unsafe extern "system" fn AddDocumentData<
            Identity: IPrintWorkflowXpsReceiver_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintWorkflowXpsReceiver_Impl::AddPage(
                    this,
                    core::mem::transmute_copy(&documentid),
                    core::mem::transmute_copy(&pageid),
                    core::mem::transmute_copy(&pagereference),
                    core::mem::transmute(&pageuri),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    IPrintWorkflowXpsReceiver2_Vtbl,
    0x023bcc0c_dfab_4a61_b074_490c6995580d
);
...
impl IPrintWorkflowXpsReceiver2 {
    pub unsafe fn Failed(&self, xpserror: windows_core::HRESULT) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Failed)(
                windows_core::Interface::as_raw(self),
                xpserror,
            )
            .ok()
...
impl IPrintWorkflowXpsReceiver2_Vtbl {
    pub const fn new<Identity: IPrintWorkflowXpsReceiver2_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            xpserror: windows_core::HRESULT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintWorkflowXpsReceiver2_Impl::Failed(this, core::mem::transmute_copy(&xpserror))
                    .into()
            }
        }
        Self {
            base__: IPrintWorkflowXpsReceiver_Vtbl::new::<Identity, OFFSET>(),
...
windows_core::imp::define_interface!(
    ...
    0x9ca31010_1484_4587_b26b_dddf9f9caecd
);
windows_core::imp::interface_hierarchy!(
    IPrinting3DManagerInterop,
    windows_core::IUnknown,
    ...
    pub const fn new<Identity: IPrinting3DManagerInterop_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrinting3DManagerInterop_Impl::GetForWindow(
                    this,
                    core::mem::transmute_copy(&appwindow),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&printmanager),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrinting3DManagerInterop_Impl::ShowPrintUIForWindowAsync(
                    this,
                    core::mem::transmute_copy(&appwindow),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&asyncoperation),

...
#[inline]
pub unsafe fn EnumDeviceDrivers(
    lpimagebase: *mut *mut core::ffi::c_void,
    cb: u32,
    lpcbneeded: *mut u32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn EnumProcessModules(
    hprocess: super::super::Foundation::HANDLE,
    lphmodule: *mut super::super::Foundation::HMODULE,
    cb: u32,
    lpcbneeded: *mut u32,
) -> windows_core::Result<()> {
...
pub unsafe fn EnumProcessModulesEx(
    ...
    unsafe {
        EnumProcessModulesEx(hprocess, lphmodule as _, cb, lpcbneeded as _, dwfilterflag).ok()
    }
}
#[inline]
pub unsafe fn EnumProcesses(
    lpidprocess: *mut u32,
    cb: u32,
    lpcbneeded: *mut u32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn GetDeviceDriverBaseNameA(
    imagebase: *const core::ffi::c_void,
    lpfilename: &mut [u8],
) -> u32 {
    windows_link::link!("psapi.dll" "system" fn GetDeviceDriverBaseNameA(imagebase : *const core::ffi::c_void, lpfilename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
        GetDeviceDriverBaseNameA(
            imagebase,
            core::mem::transmute(lpfilename.as_ptr()),
            lpfilename.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn GetDeviceDriverBaseNameW(
    imagebase: *const core::ffi::c_void,
    lpbasename: &mut [u16],
) -> u32 {
    windows_link::link!("psapi.dll" "system" fn GetDeviceDriverBaseNameW(imagebase : *const core::ffi::c_void, lpbasename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
        GetDeviceDriverBaseNameW(
            imagebase,
            core::mem::transmute(lpbasename.as_ptr()),
            lpbasename.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn GetDeviceDriverFileNameA(
    imagebase: *const core::ffi::c_void,
    lpfilename: &mut [u8],
) -> u32 {
    windows_link::link!("psapi.dll" "system" fn GetDeviceDriverFileNameA(imagebase : *const core::ffi::c_void, lpfilename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
...
#[inline]
pub unsafe fn GetDeviceDriverFileNameW(
    imagebase: *const core::ffi::c_void,
    lpfilename: &mut [u16],
) -> u32 {
    windows_link::link!("psapi.dll" "system" fn GetDeviceDriverFileNameW(imagebase : *const core::ffi::c_void, lpfilename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
...
#[inline]
pub unsafe fn GetMappedFileNameA(
    hprocess: super::super::Foundation::HANDLE,
    lpv: *const core::ffi::c_void,
    lpfilename: &mut [u8],
) -> u32 {
    windows_link::link!("psapi.dll" "system" fn GetMappedFileNameA(hprocess : super::super::Foundation:: HANDLE, lpv : *const core::ffi::c_void, lpfilename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
        GetMappedFileNameA(
            hprocess,
            lpv,
...
pub unsafe fn GetMappedFileNameW(
    ...
    windows_link::link!("psapi.dll" "system" fn GetMappedFileNameW(hprocess : super::super::Foundation:: HANDLE, lpv : *const core::ffi::c_void, lpfilename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
        GetMappedFileNameW(
            hprocess,
            lpv,
...
#[inline]
pub unsafe fn GetModuleBaseNameA(
    hprocess: super::super::Foundation::HANDLE,
    hmodule: Option<super::super::Foundation::HMODULE>,
    lpbasename: &mut [u8],
) -> u32 {
    windows_link::link!("psapi.dll" "system" fn GetModuleBaseNameA(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpbasename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
        GetModuleBaseNameA(
            hprocess,
...
pub unsafe fn GetModuleBaseNameW(
    ...
    windows_link::link!("psapi.dll" "system" fn GetModuleBaseNameW(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpbasename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
        GetModuleBaseNameW(
            hprocess,
            hmodule.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn GetModuleFileNameExA(
    hprocess: Option<super::super::Foundation::HANDLE>,
    hmodule: Option<super::super::Foundation::HMODULE>,
    lpfilename: &mut [u8],
) -> u32 {
    windows_link::link!("psapi.dll" "system" fn GetModuleFileNameExA(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpfilename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
...
#[inline]
pub unsafe fn GetModuleFileNameExW(
    hprocess: Option<super::super::Foundation::HANDLE>,
    hmodule: Option<super::super::Foundation::HMODULE>,
    lpfilename: &mut [u16],
) -> u32 {
    windows_link::link!("psapi.dll" "system" fn GetModuleFileNameExW(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpfilename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
...
#[inline]
pub unsafe fn GetModuleInformation(
    hprocess: super::super::Foundation::HANDLE,
...
#[inline]
pub unsafe fn GetProcessImageFileNameA(
    hprocess: super::super::Foundation::HANDLE,
    lpimagefilename: &mut [u8],
) -> u32 {
    windows_link::link!("psapi.dll" "system" fn GetProcessImageFileNameA(hprocess : super::super::Foundation:: HANDLE, lpimagefilename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
        GetProcessImageFileNameA(
            hprocess,
            core::mem::transmute(lpimagefilename.as_ptr()),
            lpimagefilename.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn GetProcessImageFileNameW(
    hprocess: super::super::Foundation::HANDLE,
    lpimagefilename: &mut [u16],
) -> u32 {
    windows_link::link!("psapi.dll" "system" fn GetProcessImageFileNameW(hprocess : super::super::Foundation:: HANDLE, lpimagefilename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
...
#[inline]
pub unsafe fn InitializeProcessForWsWatch(
    hprocess: super::super::Foundation::HANDLE,
) -> windows_core::Result<()> {
...
pub unsafe fn K32EmptyWorkingSet(hprocess: super::super::Foundation::HANDLE) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn K32EmptyWorkingSet(hprocess : super::super::Foundation:: HANDLE) -> windows_core::BOOL);
...
pub unsafe fn K32EnumDeviceDrivers(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32EnumDeviceDrivers(lpimagebase : *mut *mut core::ffi::c_void, cb : u32, lpcbneeded : *mut u32) -> windows_core::BOOL);
...
pub unsafe fn K32EnumPageFilesA(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32EnumPageFilesA(pcallbackroutine : PENUM_PAGE_FILE_CALLBACKA, pcontext : *mut core::ffi::c_void) -> windows_core::BOOL);
...
pub unsafe fn K32EnumPageFilesW(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32EnumPageFilesW(pcallbackroutine : PENUM_PAGE_FILE_CALLBACKW, pcontext : *mut core::ffi::c_void) -> windows_core::BOOL);
...
pub unsafe fn K32EnumProcessModules(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32EnumProcessModules(hprocess : super::super::Foundation:: HANDLE, lphmodule : *mut super::super::Foundation:: HMODULE, cb : u32, lpcbneeded : *mut u32) -> windows_core::BOOL);
...
pub unsafe fn K32EnumProcessModulesEx(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32EnumProcessModulesEx(hprocess : super::super::Foundation:: HANDLE, lphmodule : *mut super::super::Foundation:: HMODULE, cb : u32, lpcbneeded : *mut u32, dwfilterflag : u32) -> windows_core::BOOL);
...
pub unsafe fn K32EnumProcesses(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32EnumProcesses(lpidprocess : *mut u32, cb : u32, lpcbneeded : *mut u32) -> windows_core::BOOL);
...
pub unsafe fn K32GetDeviceDriverBaseNameA(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetDeviceDriverBaseNameA(imagebase : *const core::ffi::c_void, lpfilename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
...
pub unsafe fn K32GetDeviceDriverBaseNameW(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetDeviceDriverBaseNameW(imagebase : *const core::ffi::c_void, lpbasename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
...
pub unsafe fn K32GetDeviceDriverFileNameA(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetDeviceDriverFileNameA(imagebase : *const core::ffi::c_void, lpfilename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
...
pub unsafe fn K32GetDeviceDriverFileNameW(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetDeviceDriverFileNameW(imagebase : *const core::ffi::c_void, lpfilename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
...
pub unsafe fn K32GetMappedFileNameA(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetMappedFileNameA(hprocess : super::super::Foundation:: HANDLE, lpv : *const core::ffi::c_void, lpfilename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
...
pub unsafe fn K32GetMappedFileNameW(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetMappedFileNameW(hprocess : super::super::Foundation:: HANDLE, lpv : *const core::ffi::c_void, lpfilename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
...
pub unsafe fn K32GetModuleBaseNameA(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetModuleBaseNameA(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpbasename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
...
pub unsafe fn K32GetModuleBaseNameW(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetModuleBaseNameW(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpbasename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
...
pub unsafe fn K32GetModuleFileNameExA(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetModuleFileNameExA(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpfilename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
...
pub unsafe fn K32GetModuleFileNameExW(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetModuleFileNameExW(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpfilename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
...
pub unsafe fn K32GetModuleInformation(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetModuleInformation(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpmodinfo : *mut MODULEINFO, cb : u32) -> windows_core::BOOL);
...
pub unsafe fn K32GetPerformanceInfo(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetPerformanceInfo(pperformanceinformation : *mut PERFORMANCE_INFORMATION, cb : u32) -> windows_core::BOOL);
...
pub unsafe fn K32GetProcessImageFileNameA(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetProcessImageFileNameA(hprocess : super::super::Foundation:: HANDLE, lpimagefilename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
...
pub unsafe fn K32GetProcessImageFileNameW(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetProcessImageFileNameW(hprocess : super::super::Foundation:: HANDLE, lpimagefilename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
...
pub unsafe fn K32GetProcessMemoryInfo(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetProcessMemoryInfo(process : super::super::Foundation:: HANDLE, ppsmemcounters : *mut PROCESS_MEMORY_COUNTERS, cb : u32) -> windows_core::BOOL);
...
pub unsafe fn K32GetWsChanges(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetWsChanges(hprocess : super::super::Foundation:: HANDLE, lpwatchinfo : *mut PSAPI_WS_WATCH_INFORMATION, cb : u32) -> windows_core::BOOL);
...
pub unsafe fn K32GetWsChangesEx(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32GetWsChangesEx(hprocess : super::super::Foundation:: HANDLE, lpwatchinfoex : *mut PSAPI_WS_WATCH_INFORMATION_EX, cb : *mut u32) -> windows_core::BOOL);
...
pub unsafe fn K32InitializeProcessForWsWatch(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32InitializeProcessForWsWatch(hprocess : super::super::Foundation:: HANDLE) -> windows_core::BOOL);
...
pub unsafe fn K32QueryWorkingSet(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32QueryWorkingSet(hprocess : super::super::Foundation:: HANDLE, pv : *mut core::ffi::c_void, cb : u32) -> windows_core::BOOL);
...
pub unsafe fn K32QueryWorkingSetEx(
    ...
    windows_link::link!("kernel32.dll" "system" fn K32QueryWorkingSetEx(hprocess : super::super::Foundation:: HANDLE, pv : *mut core::ffi::c_void, cb : u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn QueryWorkingSetEx(
    hprocess: super::super::Foundation::HANDLE,
    pv: *mut core::ffi::c_void,
    cb: u32,
) -> windows_core::Result<()> {
...
pub type PENUM_PAGE_FILE_CALLBACKA = Option<
...
>;
pub type PENUM_PAGE_FILE_CALLBACKW = Option<
    unsafe extern "system" fn(
        pcontext: *mut core::ffi::c_void,
        ppagefileinfo: *mut ENUM_PAGE_FILE_INFORMATION,
        lpfilename: windows_core::PCWSTR,
    ) -> windows_core::BOOL,
>;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]

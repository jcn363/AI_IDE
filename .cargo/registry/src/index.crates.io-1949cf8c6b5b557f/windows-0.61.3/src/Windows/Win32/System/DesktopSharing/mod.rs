...
pub const ATTENDEE_DISCONNECT_REASON_APP: ATTENDEE_DISCONNECT_REASON =
    ATTENDEE_DISCONNECT_REASON(0i32);
pub const ATTENDEE_DISCONNECT_REASON_CLI: ATTENDEE_DISCONNECT_REASON =
    ATTENDEE_DISCONNECT_REASON(2i32);
pub const ATTENDEE_DISCONNECT_REASON_ERR: ATTENDEE_DISCONNECT_REASON =
    ATTENDEE_DISCONNECT_REASON(1i32);
pub const ATTENDEE_DISCONNECT_REASON_MAX: ATTENDEE_DISCONNECT_REASON =
    ATTENDEE_DISCONNECT_REASON(2i32);
pub const ATTENDEE_DISCONNECT_REASON_MIN: ATTENDEE_DISCONNECT_REASON =
    ATTENDEE_DISCONNECT_REASON(0i32);
...
pub const CONST_MAX_LEGACY_CHANNEL_MESSAGE_SIZE: RDPENCOMAPI_CONSTANTS =
    RDPENCOMAPI_CONSTANTS(409600i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl IRDPSRAPIApplication {
    ...
    pub unsafe fn Shared(&self) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Shared)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetShared(
        &self,
        newval: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetShared)(
                windows_core::Interface::as_raw(self),
                newval,
            )
            .ok()
...
pub struct IRDPSRAPIApplication_Vtbl {
    ...
    pub Shared: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetShared: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait IRDPSRAPIApplication_Impl: super::Com::IDispatch_Impl {
    ...
    fn SetShared(&self, newval: super::super::Foundation::VARIANT_BOOL)
        -> windows_core::Result<()>;
...
impl IRDPSRAPIApplication_Vtbl {
    pub const fn new<Identity: IRDPSRAPIApplication_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            pwindowlist: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Id<Identity: IRDPSRAPIApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pretval: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Shared<
            Identity: IRDPSRAPIApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pretval: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetShared<
            Identity: IRDPSRAPIApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIApplication_Impl::SetShared(this, core::mem::transmute_copy(&newval))
                    .into()
            }
        }
        unsafe extern "system" fn Name<Identity: IRDPSRAPIApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
...
impl IRDPSRAPIApplicationFilter_Vtbl {
    pub const fn new<Identity: IRDPSRAPIApplicationFilter_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            papplications: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            pwindows: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIApplicationFilter_Impl::SetEnabled(
                    this,
...
impl IRDPSRAPIApplicationList_Vtbl {
    pub const fn new<Identity: IRDPSRAPIApplicationList_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            item: i32,
            papplication: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRDPSRAPIApplicationList_Impl::get_Item(
                    this,
...
impl IRDPSRAPIAttendee {
    ...
    pub unsafe fn RemoteName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RemoteName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn ControlLevel(&self) -> windows_core::Result<CTRL_LEVEL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ControlLevel)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetControlLevel(&self, pnewval: CTRL_LEVEL) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetControlLevel)(
                windows_core::Interface::as_raw(self),
                pnewval,
            )
            .ok()
    ...
    pub unsafe fn Invitation(&self) -> windows_core::Result<IRDPSRAPIInvitation> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Invitation)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn TerminateConnection(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).TerminateConnection)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn ConnectivityInfo(&self) -> windows_core::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ConnectivityInfo)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IRDPSRAPIAttendee_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub Id: unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub RemoteName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ControlLevel:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut CTRL_LEVEL) -> windows_core::HRESULT,
    pub SetControlLevel:
        unsafe extern "system" fn(*mut core::ffi::c_void, CTRL_LEVEL) -> windows_core::HRESULT,
    pub Invitation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub ConnectivityInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IRDPSRAPIAttendee_Vtbl {
    pub const fn new<Identity: IRDPSRAPIAttendee_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Id<Identity: IRDPSRAPIAttendee_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pid: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn RemoteName<
        ...
        unsafe extern "system" fn ControlLevel<
            Identity: IRDPSRAPIAttendee_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIAttendee_Impl::SetControlLevel(this, core::mem::transmute_copy(&pnewval))
                    .into()
            }
        }
        unsafe extern "system" fn Invitation<
            Identity: IRDPSRAPIAttendee_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn TerminateConnection<
            Identity: IRDPSRAPIAttendee_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Flags<Identity: IRDPSRAPIAttendee_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plflags: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ConnectivityInfo<
            Identity: IRDPSRAPIAttendee_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl IRDPSRAPIAttendeeDisconnectInfo {
    pub unsafe fn Attendee(&self) -> windows_core::Result<IRDPSRAPIAttendee> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Attendee)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IRDPSRAPIAttendeeDisconnectInfo_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub Attendee: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Reason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ATTENDEE_DISCONNECT_REASON,
    ) -> windows_core::HRESULT,
...
impl IRDPSRAPIAttendeeDisconnectInfo_Vtbl {
    ...
    {
        unsafe extern "system" fn Attendee<
        ...
        >(
            this: *mut core::ffi::c_void,
            preason: *mut ATTENDEE_DISCONNECT_REASON,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IRDPSRAPIAudioStream {
    ...
    pub unsafe fn FreeBuffer(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).FreeBuffer)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
impl IRDPSRAPIAudioStream_Vtbl {
    pub const fn new<Identity: IRDPSRAPIAudioStream_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            pnperiodinhundrednsintervals: *mut i64,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Stop<Identity: IRDPSRAPIAudioStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIAudioStream_Impl::GetBuffer(
                    this,
                    core::mem::transmute_copy(&ppbdata),
                    core::mem::transmute_copy(&pcbdata),
                    core::mem::transmute_copy(&ptimestamp),
                )
                .into()
            }
        }
...
impl IRDPSRAPIClipboardUseEvents {
        ...
        P1: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OnPasteFromClipboard)(
                windows_core::Interface::as_raw(self),
                clipboardformat,
                pattendee.param().abi(),
                &mut result__,
...
pub struct IRDPSRAPIClipboardUseEvents_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_System_Com")]
    pub OnPasteFromClipboard: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
...
pub trait IRDPSRAPIClipboardUseEvents_Impl: windows_core::IUnknownImpl {
    fn OnPasteFromClipboard(
        &self,
        clipboardformat: u32,
        pattendee: windows_core::Ref<'_, super::Com::IDispatch>,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL>;
}
#[cfg(feature = "Win32_System_Com")]
impl IRDPSRAPIClipboardUseEvents_Vtbl {
    pub const fn new<Identity: IRDPSRAPIClipboardUseEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnPasteFromClipboard<
            Identity: IRDPSRAPIClipboardUseEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            clipboardformat: u32,
            pattendee: *mut core::ffi::c_void,
            pretval: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRDPSRAPIClipboardUseEvents_Impl::OnPasteFromClipboard(
                    this,
                    core::mem::transmute_copy(&clipboardformat),
                    core::mem::transmute_copy(&pattendee),
                ) {
                    Ok(ok__) => {
                        pretval.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            OnPasteFromClipboard: OnPasteFromClipboard::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IRDPSRAPIDebug,
    IRDPSRAPIDebug_Vtbl,
    0xaa1e42b5_496d_4ca4_a690_348dcb2ec4ad
);
windows_core::imp::interface_hierarchy!(IRDPSRAPIDebug, windows_core::IUnknown);
impl IRDPSRAPIDebug {
    pub unsafe fn SetCLXCmdLine(
        &self,
        clxcmdline: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetCLXCmdLine)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(clxcmdline),
            )
            .ok()
        }
    }
    pub unsafe fn CLXCmdLine(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CLXCmdLine)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct IRDPSRAPIDebug_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetCLXCmdLine: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CLXCmdLine: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IRDPSRAPIDebug_Vtbl {
    pub const fn new<Identity: IRDPSRAPIDebug_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetCLXCmdLine<
            Identity: IRDPSRAPIDebug_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            clxcmdline: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CLXCmdLine<Identity: IRDPSRAPIDebug_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pclxcmdline: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IRDPSRAPIFrameBuffer {
    ...
    pub unsafe fn Bpp(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Bpp)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetFrameBufferBits(
        &self,
        x: i32,
        y: i32,
        width: i32,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFrameBufferBits)(
                windows_core::Interface::as_raw(self),
                x,
                y,
                width,
...
pub struct IRDPSRAPIFrameBuffer_Vtbl {
    ...
    pub GetFrameBufferBits: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        i32,
        i32,
...
impl IRDPSRAPIFrameBuffer_Vtbl {
    pub const fn new<Identity: IRDPSRAPIFrameBuffer_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Bpp<Identity: IRDPSRAPIFrameBuffer_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plbpp: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetFrameBufferBits<
            Identity: IRDPSRAPIFrameBuffer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            width: i32,
            heigth: i32,
            ppbits: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRDPSRAPIFrameBuffer_Impl::GetFrameBufferBits(
                    this,
                    core::mem::transmute_copy(&x),
                    core::mem::transmute_copy(&y),
                    core::mem::transmute_copy(&width),
                    core::mem::transmute_copy(&heigth),
                ) {
                    Ok(ok__) => {
...
impl IRDPSRAPIInvitation {
    pub unsafe fn ConnectionString(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ConnectionString)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn AttendeeLimit(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AttendeeLimit)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetAttendeeLimit(&self, newval: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAttendeeLimit)(
                windows_core::Interface::as_raw(self),
                newval,
            )
            .ok()
    ...
    pub unsafe fn Revoked(&self) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Revoked)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetRevoked(
        &self,
        newval: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetRevoked)(
                windows_core::Interface::as_raw(self),
                newval,
            )
            .ok()
...
pub struct IRDPSRAPIInvitation_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub ConnectionString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub AttendeeLimit:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SetAttendeeLimit:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub Revoked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetRevoked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
}
...
impl IRDPSRAPIInvitation_Vtbl {
    pub const fn new<Identity: IRDPSRAPIInvitation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ConnectionString<
            Identity: IRDPSRAPIInvitation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrval: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GroupName<
            Identity: IRDPSRAPIInvitation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AttendeeLimit<
            Identity: IRDPSRAPIInvitation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetAttendeeLimit<
            Identity: IRDPSRAPIInvitation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIInvitation_Impl::SetAttendeeLimit(this, core::mem::transmute_copy(&newval))
                    .into()
            }
        }
        unsafe extern "system" fn Revoked<
            Identity: IRDPSRAPIInvitation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetRevoked<
            Identity: IRDPSRAPIInvitation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIInvitation_Impl::SetRevoked(this, core::mem::transmute_copy(&newval))
                    .into()
            }
        }
        Self {
...
impl IRDPSRAPIInvitationManager {
    ...
    pub unsafe fn get_Item(
        &self,
        item: &super::Variant::VARIANT,
    ) -> windows_core::Result<IRDPSRAPIInvitation> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Item)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn CreateInvitation(
        &self,
        bstrauthstring: &windows_core::BSTR,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateInvitation)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrauthstring),
...
pub struct IRDPSRAPIInvitationManager_Vtbl {
    ...
    pub CreateInvitation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
pub trait IRDPSRAPIInvitationManager_Impl: super::Com::IDispatch_Impl {
    fn _NewEnum(&self) -> windows_core::Result<windows_core::IUnknown>;
    fn get_Item(&self, item: &super::Variant::VARIANT)
        -> windows_core::Result<IRDPSRAPIInvitation>;
...
impl IRDPSRAPIInvitationManager_Vtbl {
    pub const fn new<Identity: IRDPSRAPIInvitationManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            item: super::Variant::VARIANT,
            ppinvitation: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            bstrauthstring: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRDPSRAPIInvitationManager_Impl::CreateInvitation(
                    this,
                    core::mem::transmute(&bstrauthstring),
                    core::mem::transmute(&bstrgroupname),
                    core::mem::transmute(&bstrpassword),
                    core::mem::transmute_copy(&attendeelimit),
                ) {
                    Ok(ok__) => {
                        ppinvitation.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
...
windows_core::imp::define_interface!(
    ...
    IRDPSRAPIPerfCounterLogger_Vtbl,
    0x071c2533_0fa4_4e8f_ae83_9c10b4305ab5
);
...
impl IRDPSRAPIPerfCounterLogger {
    pub unsafe fn LogValue(&self, lvalue: i64) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).LogValue)(
                windows_core::Interface::as_raw(self),
                lvalue,
            )
            .ok()
...
impl IRDPSRAPIPerfCounterLogger_Vtbl {
    pub const fn new<Identity: IRDPSRAPIPerfCounterLogger_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn LogValue<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIPerfCounterLogger_Impl::LogValue(this, core::mem::transmute_copy(&lvalue))
                    .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            LogValue: LogValue::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    IRDPSRAPIPerfCounterLoggingManager_Vtbl,
    0x9a512c86_ac6e_4a8e_b1a4_fcef363f6e64
);
...
impl IRDPSRAPIPerfCounterLoggingManager {
    pub unsafe fn CreateLogger(
        &self,
        bstrcountername: &windows_core::BSTR,
    ) -> windows_core::Result<IRDPSRAPIPerfCounterLogger> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateLogger)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrcountername),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub struct IRDPSRAPIPerfCounterLoggingManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateLogger: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl IRDPSRAPIPerfCounterLoggingManager_Vtbl {
    pub const fn new<Identity: IRDPSRAPIPerfCounterLoggingManager_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn CreateLogger<
            Identity: IRDPSRAPIPerfCounterLoggingManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrcountername: *mut core::ffi::c_void,
            pplogger: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRDPSRAPIPerfCounterLoggingManager_Impl::CreateLogger(
                    this,
                    core::mem::transmute(&bstrcountername),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            CreateLogger: CreateLogger::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IRDPSRAPISessionProperties {
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn put_Property(
        &self,
        propertyname: &windows_core::BSTR,
        newval: &super::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).put_Property)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(propertyname),
                core::mem::transmute_copy(newval),
            )
...
pub struct IRDPSRAPISessionProperties_Vtbl {
    ...
    get_Property: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub put_Property: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IRDPSRAPISessionProperties_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRDPSRAPISessionProperties_Impl::get_Property(
                    this,
        ...
        unsafe extern "system" fn put_Property<
            Identity: IRDPSRAPISessionProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPISessionProperties_Impl::put_Property(
                    this,
                    core::mem::transmute(&propertyname),
...
impl IRDPSRAPISharingSession {
    ...
    pub unsafe fn SetColorDepth(&self, colordepth: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetColorDepth)(
                windows_core::Interface::as_raw(self),
                colordepth,
            )
            .ok()
    ...
    pub unsafe fn ColorDepth(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ColorDepth)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn Attendees(&self) -> windows_core::Result<IRDPSRAPIAttendeeManager> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Attendees)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn Invitations(&self) -> windows_core::Result<IRDPSRAPIInvitationManager> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Invitations)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn ApplicationFilter(&self) -> windows_core::Result<IRDPSRAPIApplicationFilter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ApplicationFilter)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn VirtualChannelManager(
        &self,
    ) -> windows_core::Result<IRDPSRAPIVirtualChannelManager> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).VirtualChannelManager)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn ConnectToClient(
        &self,
        bstrconnectionstring: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ConnectToClient)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrconnectionstring),
            )
            .ok()
        }
    }
    pub unsafe fn SetDesktopSharedRect(
        &self,
        left: i32,
        top: i32,
        right: i32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetDesktopSharedRect)(
                windows_core::Interface::as_raw(self),
                left,
                top,
                right,
    ...
    pub unsafe fn GetDesktopSharedRect(
        &self,
        pleft: *mut i32,
        ptop: *mut i32,
        pright: *mut i32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetDesktopSharedRect)(
                windows_core::Interface::as_raw(self),
                pleft as _,
                ptop as _,
                pright as _,
...
pub struct IRDPSRAPISharingSession_Vtbl {
    ...
    pub Attendees: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Invitations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ApplicationFilter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub VirtualChannelManager: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Pause: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Resume: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ConnectToClient: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetDesktopSharedRect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        i32,
        i32,
    ...
    pub GetDesktopSharedRect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut i32,
        *mut i32,
        *mut i32,
...
impl IRDPSRAPISharingSession_Vtbl {
    pub const fn new<Identity: IRDPSRAPISharingSession_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetColorDepth<
            Identity: IRDPSRAPISharingSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPISharingSession_Impl::SetColorDepth(
                    this,
                    core::mem::transmute_copy(&colordepth),
                )
                .into()
            }
        }
        unsafe extern "system" fn ColorDepth<
            Identity: IRDPSRAPISharingSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Attendees<
            Identity: IRDPSRAPISharingSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Invitations<
            Identity: IRDPSRAPISharingSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn VirtualChannelManager<
            Identity: IRDPSRAPISharingSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ConnectToClient<
            Identity: IRDPSRAPISharingSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrconnectionstring: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPISharingSession_Impl::ConnectToClient(
                    this,
                    core::mem::transmute(&bstrconnectionstring),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetDesktopSharedRect<
            Identity: IRDPSRAPISharingSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPISharingSession_Impl::SetDesktopSharedRect(
                    this,
                    core::mem::transmute_copy(&left),
                    core::mem::transmute_copy(&top),
        ...
        unsafe extern "system" fn GetDesktopSharedRect<
            Identity: IRDPSRAPISharingSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPISharingSession_Impl::GetDesktopSharedRect(
                    this,
...
impl IRDPSRAPISharingSession2 {
    pub unsafe fn ConnectUsingTransportStream<P0>(
        &self,
        pstream: P0,
        bstrgroup: &windows_core::BSTR,
        bstrauthenticatedattendeename: &windows_core::BSTR,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<IRDPSRAPITransportStream>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).ConnectUsingTransportStream)(
                windows_core::Interface::as_raw(self),
                pstream.param().abi(),
                core::mem::transmute_copy(bstrgroup),
                core::mem::transmute_copy(bstrauthenticatedattendeename),
            )
            .ok()
        }
    }
    pub unsafe fn FrameBuffer(&self) -> windows_core::Result<IRDPSRAPIFrameBuffer> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FrameBuffer)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn SendControlLevelChangeResponse<P0>(
        &self,
        pattendee: P0,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SendControlLevelChangeResponse)(
                windows_core::Interface::as_raw(self),
                pattendee.param().abi(),
                requestedlevel,
                reasoncode,
...
pub struct IRDPSRAPISharingSession2_Vtbl {
    ...
    pub ConnectUsingTransportStream: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FrameBuffer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SendControlLevelChangeResponse: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        CTRL_LEVEL,
        i32,
...
pub trait IRDPSRAPISharingSession2_Impl: IRDPSRAPISharingSession_Impl {
    fn ConnectUsingTransportStream(
        &self,
        pstream: windows_core::Ref<'_, IRDPSRAPITransportStream>,
        bstrgroup: &windows_core::BSTR,
        bstrauthenticatedattendeename: &windows_core::BSTR,
    ) -> windows_core::Result<()>;
    ...
    fn SendControlLevelChangeResponse(
        &self,
        pattendee: windows_core::Ref<'_, IRDPSRAPIAttendee>,
        requestedlevel: CTRL_LEVEL,
        reasoncode: i32,
    ) -> windows_core::Result<()>;
}
...
impl IRDPSRAPISharingSession2_Vtbl {
    pub const fn new<Identity: IRDPSRAPISharingSession2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ConnectUsingTransportStream<
            Identity: IRDPSRAPISharingSession2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pstream: *mut core::ffi::c_void,
            bstrgroup: *mut core::ffi::c_void,
            bstrauthenticatedattendeename: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPISharingSession2_Impl::ConnectUsingTransportStream(
                    this,
                    core::mem::transmute_copy(&pstream),
                    core::mem::transmute(&bstrgroup),
                    core::mem::transmute(&bstrauthenticatedattendeename),
                )
                .into()
            }
        }
        unsafe extern "system" fn FrameBuffer<
            Identity: IRDPSRAPISharingSession2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPISharingSession2_Impl::SendControlLevelChangeResponse(
                    this,
                    core::mem::transmute_copy(&pattendee),
                    core::mem::transmute_copy(&requestedlevel),
                    core::mem::transmute_copy(&reasoncode),
                )
                .into()
            }
        }
...
impl IRDPSRAPITcpConnectionInfo {
    ...
    pub unsafe fn LocalPort(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LocalPort)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn LocalIP(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LocalIP)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn PeerPort(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PeerPort)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn PeerIP(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PeerIP)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct IRDPSRAPITcpConnectionInfo_Vtbl {
    ...
    pub LocalPort:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub LocalIP: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PeerPort:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub PeerIP: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IRDPSRAPITcpConnectionInfo_Vtbl {
    pub const fn new<Identity: IRDPSRAPITcpConnectionInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn LocalPort<
            Identity: IRDPSRAPITcpConnectionInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn LocalIP<
            Identity: IRDPSRAPITcpConnectionInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbsrlocalip: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn PeerPort<
            Identity: IRDPSRAPITcpConnectionInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn PeerIP<
            Identity: IRDPSRAPITcpConnectionInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrip: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x36cfa065_43bb_4ef7_aed7_9b88a5053036
);
windows_core::imp::interface_hierarchy!(IRDPSRAPITransportStream, windows_core::IUnknown);
impl IRDPSRAPITransportStream {
    pub unsafe fn AllocBuffer(
        &self,
        maxpayload: i32,
    ) -> windows_core::Result<IRDPSRAPITransportStreamBuffer> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AllocBuffer)(
                windows_core::Interface::as_raw(self),
                maxpayload,
                &mut result__,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).WriteBuffer)(
                windows_core::Interface::as_raw(self),
                pbuffer.param().abi(),
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ReadBuffer)(
                windows_core::Interface::as_raw(self),
                pbuffer.param().abi(),
            )
            .ok()
...
pub struct IRDPSRAPITransportStream_Vtbl {
    ...
    pub ReadBuffer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IRDPSRAPITransportStream_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRDPSRAPITransportStream_Impl::AllocBuffer(
                    this,
                    core::mem::transmute_copy(&maxpayload),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPITransportStream_Impl::FreeBuffer(this, core::mem::transmute_copy(&pbuffer))
                    .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPITransportStream_Impl::WriteBuffer(
                    this,
        ...
        unsafe extern "system" fn ReadBuffer<
            Identity: IRDPSRAPITransportStream_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPITransportStream_Impl::ReadBuffer(this, core::mem::transmute_copy(&pbuffer))
                    .into()
            }
        }
        unsafe extern "system" fn Open<
        ...
        >(
            this: *mut core::ffi::c_void,
            pcallbacks: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPITransportStream_Impl::Open(this, core::mem::transmute_copy(&pcallbacks))
                    .into()
            }
        }
        unsafe extern "system" fn Close<
...
windows_core::imp::define_interface!(
    ...
    0x81c80290_5085_44b0_b460_f865c39cb4a9
);
...
impl IRDPSRAPITransportStreamBuffer {
    pub unsafe fn Storage(&self) -> windows_core::Result<*mut u8> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Storage)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn StorageSize(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StorageSize)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn PayloadSize(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PayloadSize)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetPayloadSize(&self, lval: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPayloadSize)(
                windows_core::Interface::as_raw(self),
                lval,
            )
            .ok()
    ...
    pub unsafe fn PayloadOffset(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PayloadOffset)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetPayloadOffset(&self, lretval: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPayloadOffset)(
                windows_core::Interface::as_raw(self),
                lretval,
            )
            .ok()
...
impl IRDPSRAPITransportStreamBuffer_Vtbl {
    pub const fn new<Identity: IRDPSRAPITransportStreamBuffer_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Storage<
            Identity: IRDPSRAPITransportStreamBuffer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppbstorage: *mut *mut u8,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn StorageSize<
            Identity: IRDPSRAPITransportStreamBuffer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn PayloadSize<
            Identity: IRDPSRAPITransportStreamBuffer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetPayloadSize<
            Identity: IRDPSRAPITransportStreamBuffer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPITransportStreamBuffer_Impl::SetPayloadSize(
                    this,
                    core::mem::transmute_copy(&lval),
                )
                .into()
            }
        }
        unsafe extern "system" fn PayloadOffset<
            Identity: IRDPSRAPITransportStreamBuffer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetPayloadOffset<
            Identity: IRDPSRAPITransportStreamBuffer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPITransportStreamBuffer_Impl::SetPayloadOffset(
                    this,
                    core::mem::transmute_copy(&lretval),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPITransportStreamBuffer_Impl::SetFlags(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPITransportStreamBuffer_Impl::SetContext(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0xea81c254_f5af_4e40_982e_3e63bb595276
);
...
impl IRDPSRAPITransportStreamEvents {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnWriteCompleted)(
                windows_core::Interface::as_raw(self),
                pbuffer.param().abi(),
            )
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnReadCompleted)(
                windows_core::Interface::as_raw(self),
                pbuffer.param().abi(),
            )
        }
    ...
    pub unsafe fn OnStreamClosed(&self, hrreason: windows_core::HRESULT) {
        unsafe {
            (windows_core::Interface::vtable(self).OnStreamClosed)(
                windows_core::Interface::as_raw(self),
                hrreason,
            )
        }
...
impl IRDPSRAPITransportStreamEvents_Vtbl {
    pub const fn new<Identity: IRDPSRAPITransportStreamEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnWriteCompleted<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPITransportStreamEvents_Impl::OnWriteCompleted(
                    this,
                    core::mem::transmute_copy(&pbuffer),
                )
            }
        }
        unsafe extern "system" fn OnReadCompleted<
            Identity: IRDPSRAPITransportStreamEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPITransportStreamEvents_Impl::OnReadCompleted(
                    this,
                    core::mem::transmute_copy(&pbuffer),
                )
            }
        }
        unsafe extern "system" fn OnStreamClosed<
            Identity: IRDPSRAPITransportStreamEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPITransportStreamEvents_Impl::OnStreamClosed(
                    this,
...
impl IRDPSRAPIViewer {
    ...
    pub unsafe fn SetSmartSizing(
        &self,
        vbsmartsizing: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSmartSizing)(
                windows_core::Interface::as_raw(self),
                vbsmartsizing,
            )
            .ok()
    ...
    pub unsafe fn SmartSizing(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SmartSizing)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn RequestControl(&self, ctrllevel: CTRL_LEVEL) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RequestControl)(
                windows_core::Interface::as_raw(self),
                ctrllevel,
            )
            .ok()
    ...
    pub unsafe fn SetDisconnectedText(
        &self,
        bstrdisconnectedtext: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDisconnectedText)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrdisconnectedtext),
            )
            .ok()
        }
    }
    pub unsafe fn DisconnectedText(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DisconnectedText)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn RequestColorDepthChange(&self, bpp: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RequestColorDepthChange)(
                windows_core::Interface::as_raw(self),
                bpp,
            )
            .ok()
    ...
    pub unsafe fn StartReverseConnectListener(
        &self,
        bstrconnectionstring: &windows_core::BSTR,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StartReverseConnectListener)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrconnectionstring),
...
pub struct IRDPSRAPIViewer_Vtbl {
    ...
    pub SetSmartSizing: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SmartSizing: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub RequestControl:
        unsafe extern "system" fn(*mut core::ffi::c_void, CTRL_LEVEL) -> windows_core::HRESULT,
    pub SetDisconnectedText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DisconnectedText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RequestColorDepthChange:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub Properties: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub StartReverseConnectListener: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
impl IRDPSRAPIViewer_Vtbl {
    pub const fn new<Identity: IRDPSRAPIViewer_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Connect<Identity: IRDPSRAPIViewer_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrconnectionstring: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Attendees<Identity: IRDPSRAPIViewer_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppval: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetSmartSizing<
            Identity: IRDPSRAPIViewer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIViewer_Impl::SetSmartSizing(
                    this,
                    core::mem::transmute_copy(&vbsmartsizing),
                )
                .into()
            }
        }
        unsafe extern "system" fn SmartSizing<
            Identity: IRDPSRAPIViewer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pvbsmartsizing: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn RequestControl<
            Identity: IRDPSRAPIViewer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIViewer_Impl::RequestControl(this, core::mem::transmute_copy(&ctrllevel))
                    .into()
            }
        }
        unsafe extern "system" fn SetDisconnectedText<
            Identity: IRDPSRAPIViewer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrdisconnectedtext: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIViewer_Impl::SetDisconnectedText(
                    this,
                    core::mem::transmute(&bstrdisconnectedtext),
                )
                .into()
            }
        }
        unsafe extern "system" fn DisconnectedText<
            Identity: IRDPSRAPIViewer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrdisconnectedtext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn RequestColorDepthChange<
            Identity: IRDPSRAPIViewer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIViewer_Impl::RequestColorDepthChange(this, core::mem::transmute_copy(&bpp))
                    .into()
            }
        }
        unsafe extern "system" fn Properties<
        ...
        unsafe extern "system" fn StartReverseConnectListener<
            Identity: IRDPSRAPIViewer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            bstrpassword: *mut core::ffi::c_void,
            pbstrreverseconnectstring: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRDPSRAPIViewer_Impl::StartReverseConnectListener(
                    this,
                    core::mem::transmute(&bstrconnectionstring),
...
impl IRDPSRAPIVirtualChannel {
    pub unsafe fn SendData(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SendData)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn SetAccess(
        &self,
        lattendeeid: i32,
        accesstype: CHANNEL_ACCESS_ENUM,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAccess)(
                windows_core::Interface::as_raw(self),
                lattendeeid,
                accesstype,
            )
...
pub struct IRDPSRAPIVirtualChannel_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub SendData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        u32,
    ) -> windows_core::HRESULT,
    pub SetAccess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        CHANNEL_ACCESS_ENUM,
    ) -> windows_core::HRESULT,
...
impl IRDPSRAPIVirtualChannel_Vtbl {
    pub const fn new<Identity: IRDPSRAPIVirtualChannel_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SendData<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIVirtualChannel_Impl::SendData(
                    this,
                    core::mem::transmute(&bstrdata),
                    core::mem::transmute_copy(&lattendeeid),
                    core::mem::transmute_copy(&channelsendflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetAccess<
            Identity: IRDPSRAPIVirtualChannel_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPSRAPIVirtualChannel_Impl::SetAccess(
                    this,
                    core::mem::transmute_copy(&lattendeeid),
                    core::mem::transmute_copy(&accesstype),
                )
                .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            ppriority: *mut CHANNEL_PRIORITY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IRDPSRAPIVirtualChannelManager {
    ...
    pub unsafe fn get_Item(
        &self,
        item: &super::Variant::VARIANT,
    ) -> windows_core::Result<IRDPSRAPIVirtualChannel> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Item)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn CreateVirtualChannel(
        &self,
        bstrchannelname: &windows_core::BSTR,
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(self).CreateVirtualChannel)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrchannelname),
                priority,
                channelflags,
                &mut result__,
            )
...
impl IRDPSRAPIVirtualChannelManager_Vtbl {
    pub const fn new<Identity: IRDPSRAPIVirtualChannelManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            item: super::Variant::VARIANT,
            pchannel: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRDPSRAPIVirtualChannelManager_Impl::get_Item(
                    this,
        ...
        >(
            this: *mut core::ffi::c_void,
            bstrchannelname: *mut core::ffi::c_void,
            priority: CHANNEL_PRIORITY,
            channelflags: u32,
            ppchannel: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRDPSRAPIVirtualChannelManager_Impl::CreateVirtualChannel(
                    this,
                    core::mem::transmute(&bstrchannelname),
                    core::mem::transmute_copy(&priority),
                    core::mem::transmute_copy(&channelflags),
                ) {
                    Ok(ok__) => {
...
impl IRDPSRAPIWindow_Vtbl {
    pub const fn new<Identity: IRDPSRAPIWindow_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Id<Identity: IRDPSRAPIWindow_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pretval: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Application<
        ...
        unsafe extern "system" fn Shared<Identity: IRDPSRAPIWindow_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pretval: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetShared<Identity: IRDPSRAPIWindow_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            newval: super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Name<Identity: IRDPSRAPIWindow_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pretval: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Show<Identity: IRDPSRAPIWindow_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Flags<Identity: IRDPSRAPIWindow_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwflags: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl IRDPSRAPIWindowList_Vtbl {
    pub const fn new<Identity: IRDPSRAPIWindowList_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            item: i32,
            pwindow: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0xbb590853_a6c5_4a7b_8dd4_76b69eea12d5
);
windows_core::imp::interface_hierarchy!(IRDPViewerInputSink, windows_core::IUnknown);
impl IRDPViewerInputSink {
    pub unsafe fn SendMouseButtonEvent(
        &self,
        buttontype: RDPSRAPI_MOUSE_BUTTON_TYPE,
        vbbuttondown: super::super::Foundation::VARIANT_BOOL,
        xpos: u32,
        ypos: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SendMouseButtonEvent)(
                windows_core::Interface::as_raw(self),
                buttontype,
                vbbuttondown,
                xpos,
    ...
    pub unsafe fn SendMouseMoveEvent(&self, xpos: u32, ypos: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SendMouseMoveEvent)(
                windows_core::Interface::as_raw(self),
                xpos,
                ypos,
            )
    ...
    pub unsafe fn SendMouseWheelEvent(&self, wheelrotation: u16) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SendMouseWheelEvent)(
                windows_core::Interface::as_raw(self),
                wheelrotation,
            )
            .ok()
    ...
    pub unsafe fn SendKeyboardEvent(
        &self,
        codetype: RDPSRAPI_KBD_CODE_TYPE,
        keycode: u16,
        vbkeyup: super::super::Foundation::VARIANT_BOOL,
        vbrepeat: super::super::Foundation::VARIANT_BOOL,
        vbextended: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SendKeyboardEvent)(
                windows_core::Interface::as_raw(self),
                codetype,
                keycode,
                vbkeyup,
    ...
    pub unsafe fn SendSyncEvent(&self, syncflags: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SendSyncEvent)(
                windows_core::Interface::as_raw(self),
                syncflags,
            )
            .ok()
    ...
    pub unsafe fn BeginTouchFrame(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BeginTouchFrame)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    }
    pub unsafe fn AddTouchInput(
        &self,
        contactid: u32,
        event: u32,
        x: i32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AddTouchInput)(
                windows_core::Interface::as_raw(self),
                contactid,
                event,
                x,
    ...
    pub unsafe fn EndTouchFrame(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndTouchFrame)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub struct IRDPViewerInputSink_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SendMouseButtonEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub AddTouchInput: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        i32,
...
pub trait IRDPViewerInputSink_Impl: windows_core::IUnknownImpl {
    ...
    fn AddTouchInput(&self, contactid: u32, event: u32, x: i32, y: i32)
        -> windows_core::Result<()>;
...
impl IRDPViewerInputSink_Vtbl {
    pub const fn new<Identity: IRDPViewerInputSink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SendMouseButtonEvent<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPViewerInputSink_Impl::SendMouseButtonEvent(
                    this,
                    core::mem::transmute_copy(&buttontype),
                    core::mem::transmute_copy(&vbbuttondown),
        ...
        unsafe extern "system" fn SendMouseMoveEvent<
            Identity: IRDPViewerInputSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPViewerInputSink_Impl::SendMouseMoveEvent(
                    this,
                    core::mem::transmute_copy(&xpos),
                    core::mem::transmute_copy(&ypos),
                )
        ...
        unsafe extern "system" fn SendMouseWheelEvent<
            Identity: IRDPViewerInputSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPViewerInputSink_Impl::SendMouseWheelEvent(
                    this,
                    core::mem::transmute_copy(&wheelrotation),
                )
                .into()
            }
        }
        unsafe extern "system" fn SendKeyboardEvent<
            Identity: IRDPViewerInputSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPViewerInputSink_Impl::SendKeyboardEvent(
                    this,
                    core::mem::transmute_copy(&codetype),
                    core::mem::transmute_copy(&keycode),
                    core::mem::transmute_copy(&vbkeyup),
                    core::mem::transmute_copy(&vbrepeat),
                    core::mem::transmute_copy(&vbextended),
                )
                .into()
            }
        }
        unsafe extern "system" fn SendSyncEvent<
            Identity: IRDPViewerInputSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPViewerInputSink_Impl::SendSyncEvent(this, core::mem::transmute_copy(&syncflags))
                    .into()
            }
        }
        ...
        unsafe extern "system" fn AddTouchInput<
            Identity: IRDPViewerInputSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRDPViewerInputSink_Impl::AddTouchInput(
                    this,
        ...
        unsafe extern "system" fn EndTouchFrame<
            Identity: IRDPViewerInputSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub const RDPSRAPIApplication: windows_core::GUID =
    windows_core::GUID::from_u128(0xc116a484_4b25_4b9f_8a54_b934b06e57fa);
pub const RDPSRAPIApplicationFilter: windows_core::GUID =
    windows_core::GUID::from_u128(0xe35ace89_c7e8_427e_a4f9_b9da072826bd);
pub const RDPSRAPIApplicationList: windows_core::GUID =
    windows_core::GUID::from_u128(0x9e31c815_7433_4876_97fb_ed59fe2baa22);
pub const RDPSRAPIAttendee: windows_core::GUID =
    windows_core::GUID::from_u128(0x74f93bb5_755f_488e_8a29_2390108aef55);
pub const RDPSRAPIAttendeeDisconnectInfo: windows_core::GUID =
    windows_core::GUID::from_u128(0xb47d7250_5bdb_405d_b487_caad9c56f4f8);
pub const RDPSRAPIAttendeeManager: windows_core::GUID =
    windows_core::GUID::from_u128(0xd7b13a01_f7d4_42a6_8595_12fc8c24e851);
pub const RDPSRAPIFrameBuffer: windows_core::GUID =
    windows_core::GUID::from_u128(0xa4f66bcc_538e_4101_951d_30847adb5101);
pub const RDPSRAPIInvitation: windows_core::GUID =
    windows_core::GUID::from_u128(0x49174dc6_0731_4b5e_8ee1_83a63d3868fa);
pub const RDPSRAPIInvitationManager: windows_core::GUID =
    windows_core::GUID::from_u128(0x53d9c9db_75ab_4271_948a_4c4eb36a8f2b);
pub const RDPSRAPISessionProperties: windows_core::GUID =
    windows_core::GUID::from_u128(0xdd7594ff_ea2a_4c06_8fdf_132de48b6510);
pub const RDPSRAPITcpConnectionInfo: windows_core::GUID =
    windows_core::GUID::from_u128(0xbe49db3f_ebb6_4278_8ce0_d5455833eaee);
pub const RDPSRAPIWindow: windows_core::GUID =
    windows_core::GUID::from_u128(0x03cf46db_ce45_4d36_86ed_ed28b74398bf);
pub const RDPSRAPIWindowList: windows_core::GUID =
    windows_core::GUID::from_u128(0x9c21e2b8_5dd4_42cc_81ba_1c099852e6fa);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const RDPSRAPI_MOUSE_BUTTON_BUTTON1: RDPSRAPI_MOUSE_BUTTON_TYPE =
    RDPSRAPI_MOUSE_BUTTON_TYPE(0i32);
pub const RDPSRAPI_MOUSE_BUTTON_BUTTON2: RDPSRAPI_MOUSE_BUTTON_TYPE =
    RDPSRAPI_MOUSE_BUTTON_TYPE(1i32);
pub const RDPSRAPI_MOUSE_BUTTON_BUTTON3: RDPSRAPI_MOUSE_BUTTON_TYPE =
    RDPSRAPI_MOUSE_BUTTON_TYPE(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct RDPSRAPI_MOUSE_BUTTON_TYPE(pub i32);
pub const RDPSRAPI_MOUSE_BUTTON_XBUTTON1: RDPSRAPI_MOUSE_BUTTON_TYPE =
    RDPSRAPI_MOUSE_BUTTON_TYPE(3i32);
pub const RDPSRAPI_MOUSE_BUTTON_XBUTTON2: RDPSRAPI_MOUSE_BUTTON_TYPE =
    RDPSRAPI_MOUSE_BUTTON_TYPE(4i32);
pub const RDPSRAPI_MOUSE_BUTTON_XBUTTON3: RDPSRAPI_MOUSE_BUTTON_TYPE =
    RDPSRAPI_MOUSE_BUTTON_TYPE(5i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct RDPSRAPI_WND_FLAGS(pub i32);
pub const RDPSession: windows_core::GUID =
    windows_core::GUID::from_u128(0x9b78f0e6_3e05_4a5b_b2e8_e743a8956b65);
pub const RDPTransportStreamBuffer: windows_core::GUID =
    windows_core::GUID::from_u128(0x8d4a1c69_f17f_4549_a699_761c6e6b5c0a);
pub const RDPTransportStreamEvents: windows_core::GUID =
    windows_core::GUID::from_u128(0x31e3ab20_5350_483f_9dc6_6748665efdeb);
pub const RDPViewer: windows_core::GUID =
    windows_core::GUID::from_u128(0x32be5ed2_5c86_480f_a914_0ff8885a1b3f);

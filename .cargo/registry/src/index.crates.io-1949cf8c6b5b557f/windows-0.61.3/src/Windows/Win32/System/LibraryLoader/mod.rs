...
{
    windows_link::link!("kernel32.dll" "system" fn AddDllDirectory(newdirectory : windows_core::PCWSTR) -> *mut core::ffi::c_void);
...
#[inline]
pub unsafe fn BeginUpdateResourceW<P0>(
    pfilename: P0,
    bdeleteexistingresources: bool,
) -> windows_core::Result<super::super::Foundation::HANDLE>
where
...
pub unsafe fn DisableThreadLibraryCalls(
    hlibmodule: super::super::Foundation::HMODULE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn EnumResourceLanguagesA<P1, P2>(
...
{
    windows_link::link!("kernel32.dll" "system" fn EnumResourceLanguagesA(hmodule : super::super::Foundation:: HMODULE, lptype : windows_core::PCSTR, lpname : windows_core::PCSTR, lpenumfunc : ENUMRESLANGPROCA, lparam : isize) -> windows_core::BOOL);
    unsafe {
...
#[inline]
pub unsafe fn EnumResourceLanguagesExA<P1, P2>(
    hmodule: Option<super::super::Foundation::HMODULE>,
    lptype: P1,
    lpname: P2,
    lpenumfunc: ENUMRESLANGPROCA,
...
where
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn EnumResourceLanguagesExA(hmodule : super::super::Foundation:: HMODULE, lptype : windows_core::PCSTR, lpname : windows_core::PCSTR, lpenumfunc : ENUMRESLANGPROCA, lparam : isize, dwflags : u32, langid : u16) -> windows_core::BOOL);
    unsafe {
...
{
    windows_link::link!("kernel32.dll" "system" fn EnumResourceLanguagesExW(hmodule : super::super::Foundation:: HMODULE, lptype : windows_core::PCWSTR, lpname : windows_core::PCWSTR, lpenumfunc : ENUMRESLANGPROCW, lparam : isize, dwflags : u32, langid : u16) -> windows_core::BOOL);
    unsafe {
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn EnumResourceLanguagesW(hmodule : super::super::Foundation:: HMODULE, lptype : windows_core::PCWSTR, lpname : windows_core::PCWSTR, lpenumfunc : ENUMRESLANGPROCW, lparam : isize) -> windows_core::BOOL);
    unsafe {
...
#[inline]
pub unsafe fn EnumResourceNamesA<P1>(
    hmodule: Option<super::super::Foundation::HMODULE>,
    lptype: P1,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn EnumResourceNamesA(hmodule : super::super::Foundation:: HMODULE, lptype : windows_core::PCSTR, lpenumfunc : ENUMRESNAMEPROCA, lparam : isize) -> windows_core::BOOL);
    unsafe {
        EnumResourceNamesA(
            hmodule.unwrap_or(core::mem::zeroed()) as _,
            lptype.param().abi(),
...
#[inline]
pub unsafe fn EnumResourceNamesExA<P1>(
    hmodule: Option<super::super::Foundation::HMODULE>,
    lptype: P1,
    lpenumfunc: ENUMRESNAMEPROCA,
    lparam: isize,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn EnumResourceNamesExA(hmodule : super::super::Foundation:: HMODULE, lptype : windows_core::PCSTR, lpenumfunc : ENUMRESNAMEPROCA, lparam : isize, dwflags : u32, langid : u16) -> windows_core::BOOL);
    unsafe {
...
#[inline]
pub unsafe fn EnumResourceNamesExW<P1>(
    hmodule: Option<super::super::Foundation::HMODULE>,
    lptype: P1,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn EnumResourceNamesExW(hmodule : super::super::Foundation:: HMODULE, lptype : windows_core::PCWSTR, lpenumfunc : ENUMRESNAMEPROCW, lparam : isize, dwflags : u32, langid : u16) -> windows_core::BOOL);
    unsafe {
...
#[inline]
pub unsafe fn EnumResourceNamesW<P1>(
    hmodule: Option<super::super::Foundation::HMODULE>,
    lptype: P1,
    lpenumfunc: ENUMRESNAMEPROCW,
    lparam: isize,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn EnumResourceNamesW(hmodule : super::super::Foundation:: HMODULE, lptype : windows_core::PCWSTR, lpenumfunc : ENUMRESNAMEPROCW, lparam : isize) -> windows_core::BOOL);
    unsafe {
        EnumResourceNamesW(
            hmodule.unwrap_or(core::mem::zeroed()) as _,
            lptype.param().abi(),
...
#[inline]
pub unsafe fn FindResourceA<P1, P2>(
    hmodule: Option<super::super::Foundation::HMODULE>,
    lpname: P1,
    lptype: P2,
) -> windows_core::Result<super::super::Foundation::HRSRC>
where
    P1: windows_core::Param<windows_core::PCSTR>,
    P2: windows_core::Param<windows_core::PCSTR>,
{
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn FindResourceExW(hmodule : super::super::Foundation:: HMODULE, lptype : windows_core::PCWSTR, lpname : windows_core::PCWSTR, wlanguage : u16) -> super::super::Foundation:: HRSRC);
    unsafe {
        FindResourceExW(
            hmodule.unwrap_or(core::mem::zeroed()) as _,
            lptype.param().abi(),
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn FindResourceW(hmodule : super::super::Foundation:: HMODULE, lpname : windows_core::PCWSTR, lptype : windows_core::PCWSTR) -> super::super::Foundation:: HRSRC);
    unsafe {
        FindResourceW(
            hmodule.unwrap_or(core::mem::zeroed()) as _,
            lpname.param().abi(),
...
pub unsafe fn FreeResource(hresdata: super::super::Foundation::HGLOBAL) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn FreeResource(hresdata : super::super::Foundation:: HGLOBAL) -> windows_core::BOOL);
    unsafe { FreeResource(hresdata) }
}
#[inline]
pub unsafe fn GetDllDirectoryA(lpbuffer: Option<&mut [u8]>) -> u32 {
    windows_link::link!("kernel32.dll" "system" fn GetDllDirectoryA(nbufferlength : u32, lpbuffer : windows_core::PSTR) -> u32);
    unsafe {
        GetDllDirectoryA(
            lpbuffer
                .as_deref()
...
pub unsafe fn GetDllDirectoryW(lpbuffer: Option<&mut [u16]>) -> u32 {
    windows_link::link!("kernel32.dll" "system" fn GetDllDirectoryW(nbufferlength : u32, lpbuffer : windows_core::PWSTR) -> u32);
    unsafe {
        GetDllDirectoryW(
            lpbuffer
                .as_deref()
...
pub unsafe fn GetModuleFileNameA(
    ...
    windows_link::link!("kernel32.dll" "system" fn GetModuleFileNameA(hmodule : super::super::Foundation:: HMODULE, lpfilename : windows_core::PSTR, nsize : u32) -> u32);
    unsafe {
        GetModuleFileNameA(
            hmodule.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn GetModuleFileNameW(
    ...
    windows_link::link!("kernel32.dll" "system" fn GetModuleFileNameW(hmodule : super::super::Foundation:: HMODULE, lpfilename : windows_core::PWSTR, nsize : u32) -> u32);
    unsafe {
        GetModuleFileNameW(
            hmodule.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(lpfilename.as_ptr()),
...
#[inline]
pub unsafe fn GetModuleHandleA<P0>(
    lpmodulename: P0,
...
#[inline]
pub unsafe fn GetModuleHandleExA<P1>(
    dwflags: u32,
    lpmodulename: P1,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn GetModuleHandleExA(dwflags : u32, lpmodulename : windows_core::PCSTR, phmodule : *mut super::super::Foundation:: HMODULE) -> windows_core::BOOL);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn GetModuleHandleExW(dwflags : u32, lpmodulename : windows_core::PCWSTR, phmodule : *mut super::super::Foundation:: HMODULE) -> windows_core::BOOL);
    unsafe { GetModuleHandleExW(dwflags, lpmodulename.param().abi(), phmodule as _).ok() }
}
#[inline]
pub unsafe fn GetModuleHandleW<P0>(
    lpmodulename: P0,
) -> windows_core::Result<super::super::Foundation::HMODULE>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn GetProcAddress<P1>(
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn GetProcAddress(hmodule : super::super::Foundation:: HMODULE, lpprocname : windows_core::PCSTR) -> super::super::Foundation:: FARPROC);
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn LoadModule(lpmodulename : windows_core::PCSTR, lpparameterblock : *const core::ffi::c_void) -> u32);
...
pub unsafe fn LoadResource(
    hmodule: Option<super::super::Foundation::HMODULE>,
    hresinfo: super::super::Foundation::HRSRC,
...
#[inline]
pub unsafe fn QueryOptionalDelayLoadedAPI<P1, P2>(
    hparentmodule: super::super::Foundation::HMODULE,
    lpdllname: P1,
    lpprocname: P2,
    reserved: Option<u32>,
) -> windows_core::Result<()>
where
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("api-ms-win-core-libraryloader-l2-1-0.dll" "system" fn QueryOptionalDelayLoadedAPI(hparentmodule : super::super::Foundation:: HMODULE, lpdllname : windows_core::PCSTR, lpprocname : windows_core::PCSTR, reserved : u32) -> windows_core::BOOL);
    unsafe {
        QueryOptionalDelayLoadedAPI(
            hparentmodule,
            lpdllname.param().abi(),
            lpprocname.param().abi(),
            reserved.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn SetDllDirectoryA(lppathname : windows_core::PCSTR) -> windows_core::BOOL);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn SetDllDirectoryW(lppathname : windows_core::PCWSTR) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn UpdateResourceA<P1, P2>(
    hupdate: super::super::Foundation::HANDLE,
    lptype: P1,
    lpname: P2,
    wlanguage: u16,
...
where
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn UpdateResourceA(hupdate : super::super::Foundation:: HANDLE, lptype : windows_core::PCSTR, lpname : windows_core::PCSTR, wlanguage : u16, lpdata : *const core::ffi::c_void, cb : u32) -> windows_core::BOOL);
    unsafe {
        UpdateResourceA(
            hupdate,
            lptype.param().abi(),
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn UpdateResourceW(hupdate : super::super::Foundation:: HANDLE, lptype : windows_core::PCWSTR, lpname : windows_core::PCWSTR, wlanguage : u16, lpdata : *const core::ffi::c_void, cb : u32) -> windows_core::BOOL);
    unsafe {
        UpdateResourceW(
            hupdate,
            lptype.param().abi(),
...
pub type ENUMRESLANGPROCA = Option<
    unsafe extern "system" fn(
        hmodule: super::super::Foundation::HMODULE,
        lptype: windows_core::PCSTR,
        lpname: windows_core::PCSTR,
        wlanguage: u16,
        lparam: isize,
    ) -> windows_core::BOOL,
>;
pub type ENUMRESLANGPROCW = Option<
    unsafe extern "system" fn(
        hmodule: super::super::Foundation::HMODULE,
        lptype: windows_core::PCWSTR,
        lpname: windows_core::PCWSTR,
        wlanguage: u16,
        lparam: isize,
    ) -> windows_core::BOOL,
>;
pub type ENUMRESNAMEPROCA = Option<
    unsafe extern "system" fn(
        hmodule: super::super::Foundation::HMODULE,
        lptype: windows_core::PCSTR,
        lpname: windows_core::PCSTR,
...
>;
pub type ENUMRESNAMEPROCW = Option<
    unsafe extern "system" fn(
        hmodule: super::super::Foundation::HMODULE,
        lptype: windows_core::PCWSTR,
        lpname: windows_core::PCWSTR,
...
>;
pub type ENUMRESTYPEPROCA = Option<
    unsafe extern "system" fn(
        hmodule: super::super::Foundation::HMODULE,
        lptype: windows_core::PCSTR,
        lparam: isize,
...
>;
pub type ENUMRESTYPEPROCW = Option<
    unsafe extern "system" fn(
        hmodule: super::super::Foundation::HMODULE,
        lptype: windows_core::PCWSTR,
        lparam: isize,
...
pub type PGET_MODULE_HANDLE_EXA = Option<
    unsafe extern "system" fn(
        dwflags: u32,
        lpmodulename: windows_core::PCSTR,
        phmodule: *mut super::super::Foundation::HMODULE,
    ) -> windows_core::BOOL,
>;
pub type PGET_MODULE_HANDLE_EXW = Option<
    unsafe extern "system" fn(
        dwflags: u32,
        lpmodulename: windows_core::PCWSTR,
        phmodule: *mut super::super::Foundation::HMODULE,
    ) -> windows_core::BOOL,
>;
#[repr(C)]

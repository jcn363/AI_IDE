...
#[inline]
pub unsafe fn ChangeServiceConfigA<P4, P5, P7, P8, P9, P10>(
    hservice: SC_HANDLE,
    ...
    P10: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        ChangeServiceConfigA(
            ...
            dwstarttype,
            dwerrorcontrol,
            lpbinarypathname.param().abi(),
            lploadordergroup.param().abi(),
            lpdwtagid.unwrap_or(core::mem::zeroed()) as _,
            lpdependencies.param().abi(),
            lpservicestartname.param().abi(),
            lppassword.param().abi(),
            lpdisplayname.param().abi(),
        )
        .ok()
    }
}
#[inline]
pub unsafe fn ChangeServiceConfigW<P4, P5, P7, P8, P9, P10>(
    hservice: SC_HANDLE,
    dwservicetype: ENUM_SERVICE_TYPE,
    dwstarttype: SERVICE_START_TYPE,
    dwerrorcontrol: SERVICE_ERROR,
...
pub unsafe fn ControlServiceExA(
    ...
    dwcontrol: u32,
    dwinfolevel: u32,
    pcontrolparams: *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn EnumDependentServicesA(
    ...
    lpservices: Option<*mut ENUM_SERVICE_STATUSA>,
    cbbufsize: u32,
...
pub unsafe fn EnumDependentServicesW(
    hservice: SC_HANDLE,
    dwservicestate: ENUM_SERVICE_STATE,
    lpservices: Option<*mut ENUM_SERVICE_STATUSW>,
    cbbufsize: u32,
    pcbbytesneeded: *mut u32,
    lpservicesreturned: *mut u32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn EnumServicesStatusExA<P9>(
    hscmanager: SC_HANDLE,
    ...
    unsafe {
        GetServiceDirectory(
            ...
            lppathbuffer
                .as_deref()
                .map_or(0, |slice| slice.len().try_into().unwrap()),
            lpcchrequiredbufferlength as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn GetServiceKeyNameA<P1>(
    hscmanager: SC_HANDLE,
    lpdisplayname: P1,
    lpservicename: Option<windows_core::PSTR>,
    lpcchbuffer: *mut u32,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        GetServiceKeyNameA(
            hscmanager,
            lpdisplayname.param().abi(),
            lpservicename.unwrap_or(core::mem::zeroed()) as _,
            lpcchbuffer as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn GetServiceKeyNameW<P1>(
    hscmanager: SC_HANDLE,
    lpdisplayname: P1,
    lpservicename: Option<windows_core::PWSTR>,
    lpcchbuffer: *mut u32,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn GetSharedServiceRegistryStateKey(
    ...
    unsafe {
        GetSharedServiceRegistryStateKey(servicehandle, statetype, accessmask, servicestatekey as _)
    }
}
#[inline]
...
#[inline]
pub unsafe fn OpenSCManagerA<P0, P1>(
    lpmachinename: P0,
    lpdatabasename: P1,
    dwdesiredaccess: u32,
) -> windows_core::Result<SC_HANDLE>
...
pub unsafe fn QueryServiceConfigA(
    hservice: SC_HANDLE,
    lpserviceconfig: Option<*mut QUERY_SERVICE_CONFIGA>,
    cbbufsize: u32,
    pcbbytesneeded: *mut u32,
) -> windows_core::Result<()> {
...
pub unsafe fn QueryServiceDynamicInformation(
    hservicestatus: SERVICE_STATUS_HANDLE,
    dwinfolevel: u32,
    ppdynamicinfo: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn QueryServiceLockStatusA(
    hscmanager: SC_HANDLE,
    lplockstatus: Option<*mut QUERY_SERVICE_LOCK_STATUSA>,
    cbbufsize: u32,
    pcbbytesneeded: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        QueryServiceLockStatusA(
            hscmanager,
            lplockstatus.unwrap_or(core::mem::zeroed()) as _,
            cbbufsize,
            pcbbytesneeded as _,
        )
        .ok()
...
pub unsafe fn QueryServiceLockStatusW(
    hscmanager: SC_HANDLE,
    lplockstatus: Option<*mut QUERY_SERVICE_LOCK_STATUSW>,
    cbbufsize: u32,
    pcbbytesneeded: *mut u32,
) -> windows_core::Result<()> {
...
pub unsafe fn QueryServiceObjectSecurity(
    ...
    lpsecuritydescriptor: Option<super::super::Security::PSECURITY_DESCRIPTOR>,
    cbbufsize: u32,
    pcbbytesneeded: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        QueryServiceObjectSecurity(
            ...
            lpsecuritydescriptor.unwrap_or(core::mem::zeroed()) as _,
            cbbufsize,
            pcbbytesneeded as _,
        )
        .ok()
...
#[inline]
pub unsafe fn RegisterServiceCtrlHandlerA<P0>(
    lpservicename: P0,
    lphandlerproc: LPHANDLER_FUNCTION,
) -> windows_core::Result<SERVICE_STATUS_HANDLE>
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn RegisterServiceCtrlHandlerExA<P0>(
    lpservicename: P0,
...
#[inline]
pub unsafe fn RegisterServiceCtrlHandlerW<P0>(
    lpservicename: P0,
    lphandlerproc: LPHANDLER_FUNCTION,
) -> windows_core::Result<SERVICE_STATUS_HANDLE>
where
...
pub unsafe fn SetServiceObjectSecurity(
    ...
    lpsecuritydescriptor: super::super::Security::PSECURITY_DESCRIPTOR,
) -> windows_core::Result<()> {
...
pub unsafe fn StartServiceA(
    hservice: SC_HANDLE,
    lpserviceargvectors: Option<&[windows_core::PCSTR]>,
) -> windows_core::Result<()> {
...
pub unsafe fn WaitServiceState(
    hservice: SC_HANDLE,
    dwnotify: u32,
    dwtimeout: Option<u32>,
    hcancelevent: Option<super::super::Foundation::HANDLE>,
) -> u32 {
    ...
    unsafe {
        WaitServiceState(
            hservice,
            dwnotify,
            dwtimeout.unwrap_or(core::mem::zeroed()) as _,
            hcancelevent.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
pub const CUSTOM_SYSTEM_STATE_CHANGE_EVENT_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x2d7a2816_0c5e_45fc_9ce7_570e5ecde9c9);
pub const DOMAIN_JOIN_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x1ce20aba_9851_4421_9430_1ddeb766e809);
pub const DOMAIN_LEAVE_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xddaf516e_58c2_4866_9574_c3b615d42ea1);
#[repr(transparent)]
...
pub const FIREWALL_PORT_CLOSE_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xa144ed38_8e12_4de4_9d96_e64740b1a524);
pub const FIREWALL_PORT_OPEN_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xb7569e07_8421_4ee0_ad10_86915afdad09);
pub type HANDLER_FUNCTION = Option<unsafe extern "system" fn(dwcontrol: u32)>;
pub type HANDLER_FUNCTION_EX = Option<
...
>;
pub type LPSERVICE_MAIN_FUNCTIONA = Option<
    unsafe extern "system" fn(dwnumservicesargs: u32, lpserviceargvectors: *mut windows_core::PSTR),
>;
pub type LPSERVICE_MAIN_FUNCTIONW = Option<
    unsafe extern "system" fn(
        dwnumservicesargs: u32,
        lpserviceargvectors: *mut windows_core::PWSTR,
    ),
>;
pub const MACHINE_POLICY_PRESENT_GUID: windows_core::GUID =
...
pub const NAMED_PIPE_EVENT_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x1f81d131_3fac_4537_9e0c_7e7b0c2f4b55);
pub const NETWORK_MANAGER_FIRST_IP_ADDRESS_ARRIVAL_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x4f27f2de_14e2_430b_a549_7cd48cbc8245);
pub const NETWORK_MANAGER_LAST_IP_ADDRESS_REMOVAL_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xcc4ba62a_162e_4648_847a_b6bdf993e335);
...
pub type PSC_NOTIFICATION_CALLBACK =
    Option<unsafe extern "system" fn(dwnotify: u32, pcallbackcontext: *const core::ffi::c_void)>;
#[repr(transparent)]
...
pub const RPC_INTERFACE_EVENT_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xbc90d167_9470_4139_a9ba_be0bbbf5b74d);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const SC_AGGREGATE_STORAGE_KEY: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\ServiceAggregatedEvents");
...
pub type SERVICE_MAIN_FUNCTIONA =
    Option<unsafe extern "system" fn(dwnumservicesargs: u32, lpserviceargvectors: *mut *mut i8)>;
pub type SERVICE_MAIN_FUNCTIONW = Option<
    unsafe extern "system" fn(
        dwnumservicesargs: u32,
        lpserviceargvectors: *mut windows_core::PWSTR,
    ),
...
pub const SERVICE_TRIGGER_STARTED_ARGUMENT: windows_core::PCWSTR =
    windows_core::w!("TriggerStarted");
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const USER_POLICY_PRESENT_GUID: windows_core::GUID =

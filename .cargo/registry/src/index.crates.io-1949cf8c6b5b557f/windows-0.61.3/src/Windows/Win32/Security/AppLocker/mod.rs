...
pub unsafe fn SaferComputeTokenFromLevel(
    ...
    unsafe {
        SaferComputeTokenFromLevel(
            levelhandle,
            inaccesstoken.unwrap_or(core::mem::zeroed()) as _,
            outaccesstoken as _,
            dwflags,
...
pub unsafe fn SaferGetLevelInformation(
    ...
    lpquerybuffer: Option<*mut core::ffi::c_void>,
    dwinbuffersize: u32,
    ...
    unsafe {
        SaferGetLevelInformation(
            levelhandle,
            dwinfotype,
            lpquerybuffer.unwrap_or(core::mem::zeroed()) as _,
            dwinbuffersize,
            lpdwoutbuffersize as _,
        )
        .ok()
    }
}
...
pub unsafe fn SaferSetLevelInformation(
    levelhandle: super::SAFER_LEVEL_HANDLE,
    dwinfotype: SAFER_OBJECT_INFO_CLASS,
    lpquerybuffer: *const core::ffi::c_void,
    dwinbuffersize: u32,
) -> windows_core::Result<()> {

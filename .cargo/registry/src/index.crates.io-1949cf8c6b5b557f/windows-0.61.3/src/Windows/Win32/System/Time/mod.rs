...
pub unsafe fn FileTimeToSystemTime(
    ...
    windows_link::link!("kernel32.dll" "system" fn FileTimeToSystemTime(lpfiletime : *const super::super::Foundation:: FILETIME, lpsystemtime : *mut super::super::Foundation:: SYSTEMTIME) -> windows_core::BOOL);
...
pub unsafe fn GetTimeZoneInformationForYear(
    ...
    windows_link::link!("kernel32.dll" "system" fn GetTimeZoneInformationForYear(wyear : u16, pdtzi : *const DYNAMIC_TIME_ZONE_INFORMATION, ptzi : *mut TIME_ZONE_INFORMATION) -> windows_core::BOOL);
    unsafe {
        GetTimeZoneInformationForYear(wyear, pdtzi.unwrap_or(core::mem::zeroed()) as _, ptzi as _)
            .ok()
    }
}
#[inline]
pub unsafe fn LocalFileTimeToLocalSystemTime(
    ...
    localsystemtime: *mut super::super::Foundation::SYSTEMTIME,
) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn LocalFileTimeToLocalSystemTime(timezoneinformation : *const TIME_ZONE_INFORMATION, localfiletime : *const super::super::Foundation:: FILETIME, localsystemtime : *mut super::super::Foundation:: SYSTEMTIME) -> windows_core::BOOL);
    unsafe {
        LocalFileTimeToLocalSystemTime(
            timezoneinformation.unwrap_or(core::mem::zeroed()) as _,
            localfiletime,
            localsystemtime as _,
        )
    }
}
#[inline]
pub unsafe fn LocalSystemTimeToLocalFileTime(
    ...
    localfiletime: *mut super::super::Foundation::FILETIME,
) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn LocalSystemTimeToLocalFileTime(timezoneinformation : *const TIME_ZONE_INFORMATION, localsystemtime : *const super::super::Foundation:: SYSTEMTIME, localfiletime : *mut super::super::Foundation:: FILETIME) -> windows_core::BOOL);
    unsafe {
...
pub unsafe fn SetDynamicTimeZoneInformation(
    ...
    windows_link::link!("kernel32.dll" "system" fn SetDynamicTimeZoneInformation(lptimezoneinformation : *const DYNAMIC_TIME_ZONE_INFORMATION) -> windows_core::BOOL);
...
pub unsafe fn SetTimeZoneInformation(
    ...
    windows_link::link!("kernel32.dll" "system" fn SetTimeZoneInformation(lptimezoneinformation : *const TIME_ZONE_INFORMATION) -> windows_core::BOOL);
...
pub unsafe fn SystemTimeToFileTime(
    ...
    windows_link::link!("kernel32.dll" "system" fn SystemTimeToFileTime(lpsystemtime : *const super::super::Foundation:: SYSTEMTIME, lpfiletime : *mut super::super::Foundation:: FILETIME) -> windows_core::BOOL);
...
pub unsafe fn SystemTimeToTzSpecificLocalTime(
    ...
    lplocaltime: *mut super::super::Foundation::SYSTEMTIME,
) -> windows_core::Result<()> {
    windows_link::link!("kernel32.dll" "system" fn SystemTimeToTzSpecificLocalTime(lptimezoneinformation : *const TIME_ZONE_INFORMATION, lpuniversaltime : *const super::super::Foundation:: SYSTEMTIME, lplocaltime : *mut super::super::Foundation:: SYSTEMTIME) -> windows_core::BOOL);
    unsafe {
...
pub unsafe fn SystemTimeToTzSpecificLocalTimeEx(
    ...
    windows_link::link!("kernel32.dll" "system" fn SystemTimeToTzSpecificLocalTimeEx(lptimezoneinformation : *const DYNAMIC_TIME_ZONE_INFORMATION, lpuniversaltime : *const super::super::Foundation:: SYSTEMTIME, lplocaltime : *mut super::super::Foundation:: SYSTEMTIME) -> windows_core::BOOL);
    unsafe {
...
pub unsafe fn TzSpecificLocalTimeToSystemTime(
    ...
    lpuniversaltime: *mut super::super::Foundation::SYSTEMTIME,
) -> windows_core::Result<()> {
    windows_link::link!("kernel32.dll" "system" fn TzSpecificLocalTimeToSystemTime(lptimezoneinformation : *const TIME_ZONE_INFORMATION, lplocaltime : *const super::super::Foundation:: SYSTEMTIME, lpuniversaltime : *mut super::super::Foundation:: SYSTEMTIME) -> windows_core::BOOL);
    unsafe {
        TzSpecificLocalTimeToSystemTime(
            lptimezoneinformation.unwrap_or(core::mem::zeroed()) as _,
            lplocaltime,
            lpuniversaltime as _,
        )
        .ok()
    }
}
...
pub unsafe fn TzSpecificLocalTimeToSystemTimeEx(
    ...
    windows_link::link!("kernel32.dll" "system" fn TzSpecificLocalTimeToSystemTimeEx(lptimezoneinformation : *const DYNAMIC_TIME_ZONE_INFORMATION, lplocaltime : *const super::super::Foundation:: SYSTEMTIME, lpuniversaltime : *mut super::super::Foundation:: SYSTEMTIME) -> windows_core::BOOL);
    unsafe {
...
pub const wszW32TimeRegKeyPolicyTimeProviders: windows_core::PCWSTR =
    windows_core::w!("Software\\Policies\\Microsoft\\W32Time\\TimeProviders");
pub const wszW32TimeRegKeyTimeProviders: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\W32Time\\TimeProviders");
...
pub const wszW32TimeRegValueMetaDataProvider: windows_core::PCWSTR =
    windows_core::w!("MetaDataProvider");

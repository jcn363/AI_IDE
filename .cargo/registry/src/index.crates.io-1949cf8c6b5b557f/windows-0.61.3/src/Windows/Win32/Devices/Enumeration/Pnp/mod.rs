...
#[inline]
pub unsafe fn SwDeviceCreate<P0, P1>(
    pszenumeratorname: P0,
    pszparentdeviceinstance: P1,
    pcreateinfo: *const SW_DEVICE_CREATE_INFO,
    pproperties: Option<&[super::super::Properties::DEVPROPERTY]>,
    pcallback: SW_DEVICE_CREATE_CALLBACK,
    pcontext: Option<*const core::ffi::c_void>,
) -> windows_core::Result<HSWDEVICE>
where
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ...
        SwDeviceCreate(
            pszenumeratorname.param().abi(),
            pszparentdeviceinstance.param().abi(),
            pcreateinfo,
            pproperties
                .as_deref()
...
#[inline]
pub unsafe fn SwDeviceGetLifetime(
    hswdevice: HSWDEVICE,
) -> windows_core::Result<SW_DEVICE_LIFETIME> {
...
pub unsafe fn SwDeviceInterfacePropertySet<P1>(
    ...
    pproperties: &[super::super::Properties::DEVPROPERTY],
) -> windows_core::Result<()>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        SwDeviceInterfacePropertySet(
            hswdevice,
            pszdeviceinterfaceid.param().abi(),
...
pub unsafe fn SwDeviceInterfaceRegister<P2>(
    hswdevice: HSWDEVICE,
    pinterfaceclassguid: *const windows_core::GUID,
...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn SwDevicePropertySet(
    hswdevice: HSWDEVICE,
    pproperties: &[super::super::Properties::DEVPROPERTY],
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SwDeviceSetLifetime(
    hswdevice: HSWDEVICE,
...
windows_core::imp::define_interface!(
    ...
    0xe3bf6178_694e_459f_a5a6_191ea0ffa1c7
);
...
impl IUPnPAddressFamilyControl {
    ...
    pub unsafe fn GetAddressFamily(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAddressFamily)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub const fn new<Identity: IUPnPAddressFamilyControl_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                IUPnPAddressFamilyControl_Impl::SetAddressFamily(
                    this,
        ...
        unsafe extern "system" fn GetAddressFamily<
            Identity: IUPnPAddressFamilyControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x4d65fd08_d13e_4274_9c8b_dd8d028c8644
);
    ...
    pub const fn new<Identity: IUPnPAsyncResult_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPAsyncResult_Impl::AsyncOperationComplete(
                    this,
                    core::mem::transmute_copy(&ullrequestid),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x11d1c1b2_7daa_4c9e_9595_7f82ed206d1e
);
#[cfg(feature = "Win32_System_Com")]
...
impl IUPnPDescriptionDocument {
    pub unsafe fn ReadyState(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReadyState)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn LoadResult(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LoadResult)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn RootDevice(&self) -> windows_core::Result<IUPnPDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RootDevice)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
    ...
    pub unsafe fn DeviceByUDN(
        &self,
        bstrudn: &windows_core::BSTR,
    ) -> windows_core::Result<IUPnPDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DeviceByUDN)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrudn),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub struct IUPnPDescriptionDocument_Vtbl {
    ...
    pub RootDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeviceByUDN: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IUPnPDescriptionDocument_Impl: super::super::super::System::Com::IDispatch_Impl {
    ...
    fn LoadAsync(
        &self,
        bstrurl: &windows_core::BSTR,
        punkcallback: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
...
impl IUPnPDescriptionDocument_Vtbl {
    pub const fn new<Identity: IUPnPDescriptionDocument_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ReadyState<
            Identity: IUPnPDescriptionDocument_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            plreadystate: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn LoadAsync<
            Identity: IUPnPDescriptionDocument_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrurl: *mut core::ffi::c_void,
            punkcallback: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPDescriptionDocument_Impl::LoadAsync(
                    this,
                    core::mem::transmute(&bstrurl),
                    core::mem::transmute_copy(&punkcallback),
                )
                .into()
            }
        }
        unsafe extern "system" fn LoadResult<
            Identity: IUPnPDescriptionDocument_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn RootDevice<
            Identity: IUPnPDescriptionDocument_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppudrootdevice: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn DeviceByUDN<
            Identity: IUPnPDescriptionDocument_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrudn: *mut core::ffi::c_void,
            ppuddevice: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPDescriptionDocument_Impl::DeviceByUDN(
                    this,
                    core::mem::transmute(&bstrudn),
                ) {
                    Ok(ok__) => {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IUPnPDescriptionDocument as windows_core::Interface>::IID
...
windows_core::imp::define_interface!(
    ...
    IUPnPDescriptionDocumentCallback_Vtbl,
    0x77394c69_5486_40d6_9bc3_4991983e02da
);
...
impl IUPnPDescriptionDocumentCallback {
    pub unsafe fn LoadComplete(
        &self,
        hrloadresult: windows_core::HRESULT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).LoadComplete)(
                windows_core::Interface::as_raw(self),
                hrloadresult,
            )
            .ok()
...
pub struct IUPnPDescriptionDocumentCallback_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub LoadComplete: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::HRESULT,
    ) -> windows_core::HRESULT,
}
...
impl IUPnPDescriptionDocumentCallback_Vtbl {
    ...
    {
        unsafe extern "system" fn LoadComplete<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPDescriptionDocumentCallback_Impl::LoadComplete(
                    this,
                    core::mem::transmute_copy(&hrloadresult),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            LoadComplete: LoadComplete::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IUPnPDevice,
    IUPnPDevice_Vtbl,
    0x3d44d0d1_98c9_4889_acd1_f9d674bf2221
);
#[cfg(feature = "Win32_System_Com")]
...
#[cfg(feature = "Win32_System_Com")]
impl IUPnPDevice {
    pub unsafe fn IsRootDevice(
        &self,
    ) -> windows_core::Result<super::super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsRootDevice)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ParentDevice(&self) -> windows_core::Result<IUPnPDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ParentDevice)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn HasChildren(
        &self,
    ) -> windows_core::Result<super::super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).HasChildren)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn UniqueDeviceName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UniqueDeviceName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
    ...
    pub unsafe fn PresentationURL(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PresentationURL)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn ManufacturerName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ManufacturerName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn ManufacturerURL(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ManufacturerURL)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn ModelName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ModelName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn ModelNumber(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ModelNumber)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn ModelURL(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ModelURL)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn UPC(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UPC)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn IconURL(
        &self,
        bstrencodingformat: &windows_core::BSTR,
        lsizex: i32,
        lsizey: i32,
        lbitdepth: i32,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IconURL)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrencodingformat),
                lsizex,
                lsizey,
                lbitdepth,
                &mut result__,
...
pub struct IUPnPDevice_Vtbl {
    pub base__: super::super::super::System::Com::IDispatch_Vtbl,
    pub IsRootDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub ParentDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub UniqueDeviceName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub PresentationURL: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ManufacturerName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ManufacturerURL: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub ModelURL: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UPC: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub IconURL: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        i32,
...
impl IUPnPDevice_Vtbl {
    pub const fn new<Identity: IUPnPDevice_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsRootDevice<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pvarb: *mut super::super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn RootDevice<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppudrootdevice: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ParentDevice<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppuddeviceparent: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn HasChildren<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pvarb: *mut super::super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Children<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppudchildren: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn UniqueDeviceName<
        ...
        unsafe extern "system" fn FriendlyName<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Type<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn PresentationURL<
            Identity: IUPnPDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ManufacturerName<
            Identity: IUPnPDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ManufacturerURL<
            Identity: IUPnPDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ModelName<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ModelNumber<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Description<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ModelURL<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn UPC<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SerialNumber<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn IconURL<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrencodingformat: *mut core::ffi::c_void,
            lsizex: i32,
            lsizey: i32,
            lbitdepth: i32,
            pbstriconurl: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPDevice_Impl::IconURL(
                    this,
                    core::mem::transmute(&bstrencodingformat),
                    core::mem::transmute_copy(&lsizex),
                    core::mem::transmute_copy(&lsizey),
                    core::mem::transmute_copy(&lbitdepth),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Services<Identity: IUPnPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppusservices: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IUPnPDevice as windows_core::Interface>::IID
            || iid == &<super::super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
windows_core::imp::define_interface!(
    ...
    0x204810ba_73b2_11d4_bf42_00b0d0118b56
);
windows_core::imp::interface_hierarchy!(IUPnPDeviceControl, windows_core::IUnknown);
impl IUPnPDeviceControl {
    pub unsafe fn Initialize(
        &self,
        bstrxmldesc: &windows_core::BSTR,
        bstrdeviceidentifier: &windows_core::BSTR,
        bstrinitstring: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Initialize)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrxmldesc),
                core::mem::transmute_copy(bstrdeviceidentifier),
                core::mem::transmute_copy(bstrinitstring),
            )
            .ok()
        }
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetServiceObject(
        &self,
        bstrudn: &windows_core::BSTR,
        bstrserviceid: &windows_core::BSTR,
    ) -> windows_core::Result<super::super::super::System::Com::IDispatch> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetServiceObject)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrudn),
                core::mem::transmute_copy(bstrserviceid),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub struct IUPnPDeviceControl_Vtbl {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub GetServiceObject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
impl IUPnPDeviceControl_Vtbl {
    pub const fn new<Identity: IUPnPDeviceControl_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            bstrxmldesc: *mut core::ffi::c_void,
            bstrdeviceidentifier: *mut core::ffi::c_void,
            bstrinitstring: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPDeviceControl_Impl::Initialize(
                    this,
                    core::mem::transmute(&bstrxmldesc),
                    core::mem::transmute(&bstrdeviceidentifier),
                    core::mem::transmute(&bstrinitstring),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetServiceObject<
            Identity: IUPnPDeviceControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrudn: *mut core::ffi::c_void,
            bstrserviceid: *mut core::ffi::c_void,
            ppdispservice: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPDeviceControl_Impl::GetServiceObject(
                    this,
                    core::mem::transmute(&bstrudn),
                    core::mem::transmute(&bstrserviceid),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0x204810bb_73b2_11d4_bf42_00b0d0118b56
);
...
impl IUPnPDeviceControlHttpHeaders {
    pub unsafe fn GetAdditionalResponseHeaders(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAdditionalResponseHeaders)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct IUPnPDeviceControlHttpHeaders_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetAdditionalResponseHeaders: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IUPnPDeviceControlHttpHeaders_Vtbl {
    pub const fn new<Identity: IUPnPDeviceControlHttpHeaders_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            bstrhttpresponseheaders: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetAdditionalResponseHeaders: GetAdditionalResponseHeaders::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    IUPnPDeviceDocumentAccess_Vtbl,
    0xe7772804_3287_418e_9072_cf2b47238981
);
...
impl IUPnPDeviceDocumentAccess {
    pub unsafe fn GetDocumentURL(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDocumentURL)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct IUPnPDeviceDocumentAccess_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetDocumentURL: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IUPnPDeviceDocumentAccess_Vtbl {
    pub const fn new<Identity: IUPnPDeviceDocumentAccess_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDocumentURL<
            Identity: IUPnPDeviceDocumentAccess_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrdocument: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0xc4bc4050_6178_4bd1_a4b8_6398321f3247
);
...
windows_core::imp::define_interface!(
    ...
    0xadda3d55_6f72_4319_bff9_18600a539b10
);
#[cfg(feature = "Win32_System_Com")]
...
impl IUPnPDeviceFinder {
    pub unsafe fn FindByType(
        &self,
        bstrtypeuri: &windows_core::BSTR,
        dwflags: u32,
    ) -> windows_core::Result<IUPnPDevices> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindByType)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrtypeuri),
                dwflags,
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn CreateAsyncFind<P2>(
        &self,
        bstrtypeuri: &windows_core::BSTR,
        dwflags: u32,
        punkdevicefindercallback: P2,
        ...
        P2: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateAsyncFind)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrtypeuri),
                dwflags,
                punkdevicefindercallback.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub unsafe fn StartAsyncFind(&self, lfinddata: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).StartAsyncFind)(
                windows_core::Interface::as_raw(self),
                lfinddata,
            )
            .ok()
    ...
    pub unsafe fn CancelAsyncFind(&self, lfinddata: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CancelAsyncFind)(
                windows_core::Interface::as_raw(self),
                lfinddata,
            )
            .ok()
    ...
    pub unsafe fn FindByUDN(
        &self,
        bstrudn: &windows_core::BSTR,
    ) -> windows_core::Result<IUPnPDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindByUDN)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrudn),
                &mut result__,
            )
...
pub struct IUPnPDeviceFinder_Vtbl {
    pub base__: super::super::super::System::Com::IDispatch_Vtbl,
    pub FindByType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateAsyncFind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
    ...
    pub CancelAsyncFind:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub FindByUDN: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IUPnPDeviceFinder_Impl: super::super::super::System::Com::IDispatch_Impl {
    ...
    fn CreateAsyncFind(
        ...
        bstrtypeuri: &windows_core::BSTR,
        dwflags: u32,
        punkdevicefindercallback: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<i32>;
...
impl IUPnPDeviceFinder_Vtbl {
    pub const fn new<Identity: IUPnPDeviceFinder_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn FindByType<
            Identity: IUPnPDeviceFinder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrtypeuri: *mut core::ffi::c_void,
            dwflags: u32,
            pdevices: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPDeviceFinder_Impl::FindByType(
                    this,
                    core::mem::transmute(&bstrtypeuri),
                    core::mem::transmute_copy(&dwflags),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateAsyncFind<
            Identity: IUPnPDeviceFinder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrtypeuri: *mut core::ffi::c_void,
            dwflags: u32,
            punkdevicefindercallback: *mut core::ffi::c_void,
            plfinddata: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPDeviceFinder_Impl::CreateAsyncFind(
                    this,
                    core::mem::transmute(&bstrtypeuri),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&punkdevicefindercallback),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn StartAsyncFind<
            Identity: IUPnPDeviceFinder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPDeviceFinder_Impl::StartAsyncFind(this, core::mem::transmute_copy(&lfinddata))
                    .into()
            }
        }
        unsafe extern "system" fn CancelAsyncFind<
            Identity: IUPnPDeviceFinder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPDeviceFinder_Impl::CancelAsyncFind(this, core::mem::transmute_copy(&lfinddata))
                    .into()
            }
        }
        unsafe extern "system" fn FindByUDN<
            Identity: IUPnPDeviceFinder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IUPnPDeviceFinder as windows_core::Interface>::IID
            || iid == &<super::super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
windows_core::imp::define_interface!(
    ...
    0x983dfc0b_1796_44df_8975_ca545b620ee5
);
windows_core::imp::interface_hierarchy!(
    IUPnPDeviceFinderAddCallbackWithInterface,
    windows_core::IUnknown
...
impl IUPnPDeviceFinderAddCallbackWithInterface {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn DeviceAddedWithInterface<P1>(
        &self,
        lfinddata: i32,
        pdevice: P1,
        pguidinterface: *const windows_core::GUID,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<IUPnPDevice>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeviceAddedWithInterface)(
                windows_core::Interface::as_raw(self),
                lfinddata,
                pdevice.param().abi(),
                pguidinterface,
...
pub struct IUPnPDeviceFinderAddCallbackWithInterface_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_System_Com")]
    pub DeviceAddedWithInterface: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
...
pub trait IUPnPDeviceFinderAddCallbackWithInterface_Impl: windows_core::IUnknownImpl {
    fn DeviceAddedWithInterface(
        &self,
        lfinddata: i32,
        pdevice: windows_core::Ref<'_, IUPnPDevice>,
        pguidinterface: *const windows_core::GUID,
    ) -> windows_core::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
    ...
    >() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPDeviceFinderAddCallbackWithInterface_Impl::DeviceAddedWithInterface(
                    this,
                    core::mem::transmute_copy(&lfinddata),
                    core::mem::transmute_copy(&pdevice),
                    core::mem::transmute_copy(&pguidinterface),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            DeviceAddedWithInterface: DeviceAddedWithInterface::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x415a984a_88b3_49f3_92af_0508bedf0d6c
);
...
impl IUPnPDeviceFinderCallback {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeviceAdded)(
                windows_core::Interface::as_raw(self),
                lfinddata,
                pdevice.param().abi(),
            )
    ...
    pub unsafe fn DeviceRemoved(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DeviceRemoved)(
                windows_core::Interface::as_raw(self),
                lfinddata,
                core::mem::transmute_copy(bstrudn),
            )
...
pub struct IUPnPDeviceFinderCallback_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_System_Com")]
    pub DeviceAdded: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    DeviceAdded: usize,
    pub DeviceRemoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl IUPnPDeviceFinderCallback_Vtbl {
    pub const fn new<Identity: IUPnPDeviceFinderCallback_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DeviceAdded<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPDeviceFinderCallback_Impl::DeviceAdded(
                    this,
                    core::mem::transmute_copy(&lfinddata),
                    core::mem::transmute_copy(&pdevice),
                )
        ...
        unsafe extern "system" fn DeviceRemoved<
            Identity: IUPnPDeviceFinderCallback_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPDeviceFinderCallback_Impl::DeviceRemoved(
                    this,
                    core::mem::transmute_copy(&lfinddata),
                    core::mem::transmute(&bstrudn),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPDeviceFinderCallback_Impl::SearchComplete(
                    this,
                    core::mem::transmute_copy(&lfinddata),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    0x204810b8_73b2_11d4_bf42_00b0d0118b56
);
...
impl IUPnPDeviceProvider_Vtbl {
    pub const fn new<Identity: IUPnPDeviceProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Start<Identity: IUPnPDeviceProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrinitstring: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Stop<Identity: IUPnPDeviceProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    IUPnPDevices,
    IUPnPDevices_Vtbl,
    0xfdbc0c73_bda3_4c66_ac4f_f2d96fdad68c
);
#[cfg(feature = "Win32_System_Com")]
...
impl IUPnPDevices_Vtbl {
    pub const fn new<Identity: IUPnPDevices_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Count<Identity: IUPnPDevices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plcount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn _NewEnum<Identity: IUPnPDevices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn get_Item<Identity: IUPnPDevices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrudn: *mut core::ffi::c_void,
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IUPnPDevices as windows_core::Interface>::IID
            || iid == &<super::super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
windows_core::imp::define_interface!(
    IUPnPEventSink,
    IUPnPEventSink_Vtbl,
    0x204810b4_73b2_11d4_bf42_00b0d0118b56
);
...
impl IUPnPEventSink {
    pub unsafe fn OnStateChanged(&self, rgdispidchanges: &[i32]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnStateChanged)(
                windows_core::Interface::as_raw(self),
                rgdispidchanges.len().try_into().unwrap(),
                core::mem::transmute(rgdispidchanges.as_ptr()),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn OnStateChangedSafe(
        &self,
        varsadispidchanges: &super::super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnStateChangedSafe)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(varsadispidchanges),
            )
            .ok()
        }
    }
...
pub struct IUPnPEventSink_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OnStateChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *const i32) -> windows_core::HRESULT,
    #[cfg(all(
        feature = "Win32_System_Com",
        feature = "Win32_System_Ole",
        feature = "Win32_System_Variant"
    ))]
    pub OnStateChangedSafe: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(
        feature = "Win32_System_Com",
        feature = "Win32_System_Ole",
    ...
    pub const fn new<Identity: IUPnPEventSink_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPEventSink_Impl::OnStateChanged(
                    this,
                    core::mem::transmute_copy(&cchanges),
                    core::mem::transmute_copy(&rgdispidchanges),
                )
                .into()
            }
        }
        unsafe extern "system" fn OnStateChangedSafe<
            Identity: IUPnPEventSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPEventSink_Impl::OnStateChangedSafe(
                    this,
                    core::mem::transmute(&varsadispidchanges),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x204810b5_73b2_11d4_bf42_00b0d0118b56
);
...
pub trait IUPnPEventSource_Impl: windows_core::IUnknownImpl {
    fn Advise(
        &self,
        pessubscriber: windows_core::Ref<'_, IUPnPEventSink>,
    ) -> windows_core::Result<()>;
    fn Unadvise(
        &self,
        pessubscriber: windows_core::Ref<'_, IUPnPEventSink>,
...
impl IUPnPEventSource_Vtbl {
    pub const fn new<Identity: IUPnPEventSource_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Advise<Identity: IUPnPEventSource_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pessubscriber: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPEventSource_Impl::Advise(this, core::mem::transmute_copy(&pessubscriber))
                    .into()
            }
        }
        unsafe extern "system" fn Unadvise<Identity: IUPnPEventSource_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pessubscriber: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPEventSource_Impl::Unadvise(this, core::mem::transmute_copy(&pessubscriber))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0x0405af4f_8b5c_447c_80f2_b75984a31f3c
);
windows_core::imp::interface_hierarchy!(IUPnPHttpHeaderControl, windows_core::IUnknown);
impl IUPnPHttpHeaderControl {
    pub unsafe fn AddRequestHeaders(
        &self,
        bstrhttpheaders: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddRequestHeaders)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrhttpheaders),
            )
            .ok()
        }
    }
...
pub struct IUPnPHttpHeaderControl_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub AddRequestHeaders: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IUPnPHttpHeaderControl_Vtbl {
    pub const fn new<Identity: IUPnPHttpHeaderControl_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddRequestHeaders<
            Identity: IUPnPHttpHeaderControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrhttpheaders: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPHttpHeaderControl_Impl::AddRequestHeaders(
                    this,
                    core::mem::transmute(&bstrhttpheaders),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            AddRequestHeaders: AddRequestHeaders::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IUPnPRegistrar,
    IUPnPRegistrar_Vtbl,
    0x204810b6_73b2_11d4_bf42_00b0d0118b56
);
...
impl IUPnPRegistrar {
    pub unsafe fn RegisterDevice(
        &self,
        bstrxmldesc: &windows_core::BSTR,
        bstrprogiddevicecontrolclass: &windows_core::BSTR,
        bstrinitstring: &windows_core::BSTR,
        bstrcontainerid: &windows_core::BSTR,
        bstrresourcepath: &windows_core::BSTR,
        nlifetime: i32,
    ) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RegisterDevice)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrxmldesc),
                core::mem::transmute_copy(bstrprogiddevicecontrolclass),
                core::mem::transmute_copy(bstrinitstring),
                core::mem::transmute_copy(bstrcontainerid),
                core::mem::transmute_copy(bstrresourcepath),
                nlifetime,
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn RegisterRunningDevice<P1>(
        &self,
        bstrxmldesc: &windows_core::BSTR,
        punkdevicecontrol: P1,
        bstrinitstring: &windows_core::BSTR,
        bstrresourcepath: &windows_core::BSTR,
        nlifetime: i32,
    ) -> windows_core::Result<windows_core::BSTR>
        ...
        P1: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RegisterRunningDevice)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrxmldesc),
                punkdevicecontrol.param().abi(),
                core::mem::transmute_copy(bstrinitstring),
                core::mem::transmute_copy(bstrresourcepath),
                nlifetime,
                &mut result__,
    ...
    pub unsafe fn RegisterDeviceProvider(
        ...
        bstrprogidproviderclass: &windows_core::BSTR,
        bstrinitstring: &windows_core::BSTR,
        bstrcontainerid: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterDeviceProvider)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprovidername),
                core::mem::transmute_copy(bstrprogidproviderclass),
                core::mem::transmute_copy(bstrinitstring),
                core::mem::transmute_copy(bstrcontainerid),
            )
            .ok()
    ...
    pub unsafe fn GetUniqueDeviceName(
        &self,
        bstrdeviceidentifier: &windows_core::BSTR,
        bstrtemplateudn: &windows_core::BSTR,
    ) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetUniqueDeviceName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrdeviceidentifier),
                core::mem::transmute_copy(bstrtemplateudn),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
        }
    ...
    pub unsafe fn UnregisterDeviceProvider(
        &self,
        bstrprovidername: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).UnregisterDeviceProvider)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprovidername),
            )
            .ok()
...
pub struct IUPnPRegistrar_Vtbl {
    ...
    pub RegisterRunningDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub RegisterDeviceProvider: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub GetUniqueDeviceName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    pub UnregisterDeviceProvider: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IUPnPRegistrar_Impl: windows_core::IUnknownImpl {
    ...
    fn RegisterRunningDevice(
        &self,
        bstrxmldesc: &windows_core::BSTR,
        punkdevicecontrol: windows_core::Ref<'_, windows_core::IUnknown>,
        bstrinitstring: &windows_core::BSTR,
        bstrresourcepath: &windows_core::BSTR,
        nlifetime: i32,
    ) -> windows_core::Result<windows_core::BSTR>;
...
impl IUPnPRegistrar_Vtbl {
    pub const fn new<Identity: IUPnPRegistrar_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            bstrxmldesc: *mut core::ffi::c_void,
            bstrprogiddevicecontrolclass: *mut core::ffi::c_void,
            bstrinitstring: *mut core::ffi::c_void,
            bstrcontainerid: *mut core::ffi::c_void,
            bstrresourcepath: *mut core::ffi::c_void,
            nlifetime: i32,
            pbstrdeviceidentifier: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPRegistrar_Impl::RegisterDevice(
                    this,
                    core::mem::transmute(&bstrxmldesc),
                    core::mem::transmute(&bstrprogiddevicecontrolclass),
                    core::mem::transmute(&bstrinitstring),
                    core::mem::transmute(&bstrcontainerid),
                    core::mem::transmute(&bstrresourcepath),
                    core::mem::transmute_copy(&nlifetime),
                ) {
                    Ok(ok__) => {
        ...
        >(
            this: *mut core::ffi::c_void,
            bstrxmldesc: *mut core::ffi::c_void,
            punkdevicecontrol: *mut core::ffi::c_void,
            bstrinitstring: *mut core::ffi::c_void,
            bstrresourcepath: *mut core::ffi::c_void,
            nlifetime: i32,
            pbstrdeviceidentifier: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPRegistrar_Impl::RegisterRunningDevice(
                    this,
                    core::mem::transmute(&bstrxmldesc),
                    core::mem::transmute_copy(&punkdevicecontrol),
                    core::mem::transmute(&bstrinitstring),
                    core::mem::transmute(&bstrresourcepath),
                    core::mem::transmute_copy(&nlifetime),
                ) {
        ...
        >(
            ...
            bstrprogidproviderclass: *mut core::ffi::c_void,
            bstrinitstring: *mut core::ffi::c_void,
            bstrcontainerid: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPRegistrar_Impl::RegisterDeviceProvider(
                    this,
                    core::mem::transmute(&bstrprovidername),
                    core::mem::transmute(&bstrprogidproviderclass),
                    core::mem::transmute(&bstrinitstring),
                    core::mem::transmute(&bstrcontainerid),
                )
                .into()
        ...
        unsafe extern "system" fn GetUniqueDeviceName<
            Identity: IUPnPRegistrar_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrdeviceidentifier: *mut core::ffi::c_void,
            bstrtemplateudn: *mut core::ffi::c_void,
            pbstrudn: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPRegistrar_Impl::GetUniqueDeviceName(
                    this,
                    core::mem::transmute(&bstrdeviceidentifier),
                    core::mem::transmute(&bstrtemplateudn),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPRegistrar_Impl::UnregisterDevice(
                    this,
                    core::mem::transmute(&bstrdeviceidentifier),
                    core::mem::transmute_copy(&fpermanent),
                )
                .into()
            }
        }
        unsafe extern "system" fn UnregisterDeviceProvider<
            Identity: IUPnPRegistrar_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPRegistrar_Impl::UnregisterDeviceProvider(
                    this,
                    core::mem::transmute(&bstrprovidername),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    0xc92eb863_0269_4aff_9c72_75321bba2952
);
windows_core::imp::interface_hierarchy!(IUPnPRemoteEndpointInfo, windows_core::IUnknown);
impl IUPnPRemoteEndpointInfo {
    pub unsafe fn GetDwordValue(
        &self,
        bstrvaluename: &windows_core::BSTR,
    ) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDwordValue)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrvaluename),
                &mut result__,
            )
            .map(|| result__)
        }
...
pub struct IUPnPRemoteEndpointInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetDwordValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut u32,
    ) -> windows_core::HRESULT,
...
impl IUPnPRemoteEndpointInfo_Vtbl {
    pub const fn new<Identity: IUPnPRemoteEndpointInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDwordValue<
            Identity: IUPnPRemoteEndpointInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrvaluename: *mut core::ffi::c_void,
            pdwvalue: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPRemoteEndpointInfo_Impl::GetDwordValue(
                    this,
                    core::mem::transmute(&bstrvaluename),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPRemoteEndpointInfo_Impl::GetStringValue(
                    this,
                    core::mem::transmute(&bstrvaluename),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPRemoteEndpointInfo_Impl::GetGuidValue(
                    this,
                    core::mem::transmute(&bstrvaluename),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0x204810b7_73b2_11d4_bf42_00b0d0118b56
);
...
impl IUPnPReregistrar {
    pub unsafe fn ReregisterDevice(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ReregisterDevice)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrdeviceidentifier),
                core::mem::transmute_copy(bstrxmldesc),
                core::mem::transmute_copy(bstrprogiddevicecontrolclass),
    ...
    pub unsafe fn ReregisterRunningDevice<P2>(
        &self,
        bstrdeviceidentifier: &windows_core::BSTR,
        bstrxmldesc: &windows_core::BSTR,
        punkdevicecontrol: P2,
        bstrinitstring: &windows_core::BSTR,
        bstrresourcepath: &windows_core::BSTR,
        nlifetime: i32,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ReregisterRunningDevice)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrdeviceidentifier),
                core::mem::transmute_copy(bstrxmldesc),
                punkdevicecontrol.param().abi(),
...
pub struct IUPnPReregistrar_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ReregisterDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub ReregisterRunningDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
impl IUPnPReregistrar_Vtbl {
    pub const fn new<Identity: IUPnPReregistrar_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ReregisterDevice<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPReregistrar_Impl::ReregisterDevice(
                    this,
                    core::mem::transmute(&bstrdeviceidentifier),
                    core::mem::transmute(&bstrxmldesc),
                    core::mem::transmute(&bstrprogiddevicecontrolclass),
        ...
        unsafe extern "system" fn ReregisterRunningDevice<
            Identity: IUPnPReregistrar_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPReregistrar_Impl::ReregisterRunningDevice(
                    this,
                    core::mem::transmute(&bstrdeviceidentifier),
                    core::mem::transmute(&bstrxmldesc),
                    core::mem::transmute_copy(&punkdevicecontrol),
...
windows_core::imp::define_interface!(
    IUPnPService,
    IUPnPService_Vtbl,
    0xa295019c_dc65_47dd_90dc_7fe918a1ab44
);
#[cfg(feature = "Win32_System_Com")]
...
impl IUPnPService {
    ...
    pub unsafe fn QueryStateVariable(
        &self,
        bstrvariablename: &windows_core::BSTR,
    ) -> windows_core::Result<super::super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).QueryStateVariable)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrvariablename),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
        }
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn InvokeAction(
        &self,
        bstractionname: &windows_core::BSTR,
        vinactionargs: &super::super::super::System::Variant::VARIANT,
        pvoutactionargs: *mut super::super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<super::super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).InvokeAction)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstractionname),
                core::mem::transmute_copy(vinactionargs),
                core::mem::transmute(pvoutactionargs),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
        }
    ...
    pub unsafe fn ServiceTypeIdentifier(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ServiceTypeIdentifier)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddCallback)(
                windows_core::Interface::as_raw(self),
                punkcallback.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn LastTransportStatus(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LastTransportStatus)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IUPnPService_Vtbl {
    pub base__: super::super::super::System::Com::IDispatch_Vtbl,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub QueryStateVariable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub InvokeAction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::super::System::Variant::VARIANT,
        *mut super::super::super::System::Variant::VARIANT,
    ...
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    InvokeAction: usize,
    pub ServiceTypeIdentifier: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AddCallback: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl IUPnPService_Vtbl {
    pub const fn new<Identity: IUPnPService_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn QueryStateVariable<
            Identity: IUPnPService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrvariablename: *mut core::ffi::c_void,
            pvalue: *mut super::super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPService_Impl::QueryStateVariable(
                    this,
                    core::mem::transmute(&bstrvariablename),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn InvokeAction<Identity: IUPnPService_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstractionname: *mut core::ffi::c_void,
            vinactionargs: super::super::super::System::Variant::VARIANT,
            pvoutactionargs: *mut super::super::super::System::Variant::VARIANT,
            pvretval: *mut super::super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPService_Impl::InvokeAction(
                    this,
                    core::mem::transmute(&bstractionname),
                    core::mem::transmute(&vinactionargs),
                    core::mem::transmute_copy(&pvoutactionargs),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn ServiceTypeIdentifier<
            Identity: IUPnPService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AddCallback<Identity: IUPnPService_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            punkcallback: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPService_Impl::AddCallback(this, core::mem::transmute_copy(&punkcallback))
                    .into()
            }
        }
        unsafe extern "system" fn Id<Identity: IUPnPService_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn LastTransportStatus<
            Identity: IUPnPService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IUPnPService as windows_core::Interface>::IID
            || iid == &<super::super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
windows_core::imp::define_interface!(
    ...
    0x098bdaf5_5ec1_49e7_a260_b3a11dd8680c
);
...
impl IUPnPServiceAsync {
    ...
    pub unsafe fn BeginInvokeAction<P2>(
        &self,
        bstractionname: &windows_core::BSTR,
        vinactionargs: &super::super::super::System::Variant::VARIANT,
        pasyncresult: P2,
        ...
        P2: windows_core::Param<IUPnPAsyncResult>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BeginInvokeAction)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstractionname),
                core::mem::transmute_copy(vinactionargs),
    ...
    pub unsafe fn EndInvokeAction(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EndInvokeAction)(
                windows_core::Interface::as_raw(self),
                ullrequestid,
                core::mem::transmute(pvoutactionargs),
                core::mem::transmute(pvretval),
            )
            .ok()
        }
    }
    pub unsafe fn BeginQueryStateVariable<P1>(
        &self,
        bstrvariablename: &windows_core::BSTR,
        pasyncresult: P1,
    ) -> windows_core::Result<u64>
        ...
        P1: windows_core::Param<IUPnPAsyncResult>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BeginQueryStateVariable)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrvariablename),
                pasyncresult.param().abi(),
                &mut result__,
    ...
    pub unsafe fn EndQueryStateVariable(
        &self,
        ullrequestid: u64,
        pvalue: *mut super::super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndQueryStateVariable)(
                windows_core::Interface::as_raw(self),
                ullrequestid,
    ...
    pub unsafe fn BeginSubscribeToEvents<P0, P1>(
        &self,
        punkcallback: P0,
        pasyncresult: P1,
    ) -> windows_core::Result<u64>
        ...
        P1: windows_core::Param<IUPnPAsyncResult>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BeginSubscribeToEvents)(
                windows_core::Interface::as_raw(self),
                punkcallback.param().abi(),
                pasyncresult.param().abi(),
                &mut result__,
    ...
    pub unsafe fn EndSubscribeToEvents(&self, ullrequestid: u64) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndSubscribeToEvents)(
                windows_core::Interface::as_raw(self),
                ullrequestid,
            )
            .ok()
        ...
        P0: windows_core::Param<IUPnPAsyncResult>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BeginSCPDDownload)(
                windows_core::Interface::as_raw(self),
                pasyncresult.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn EndSCPDDownload(
        &self,
        ullrequestid: u64,
    ) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EndSCPDDownload)(
                windows_core::Interface::as_raw(self),
                ullrequestid,
                &mut result__,
            )
    ...
    pub unsafe fn CancelAsyncOperation(&self, ullrequestid: u64) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CancelAsyncOperation)(
                windows_core::Interface::as_raw(self),
                ullrequestid,
            )
            .ok()
...
pub struct IUPnPServiceAsync_Vtbl {
    ...
    pub BeginInvokeAction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::super::System::Variant::VARIANT,
        *mut core::ffi::c_void,
    ...
    pub EndInvokeAction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        *mut super::super::super::System::Variant::VARIANT,
        *mut super::super::super::System::Variant::VARIANT,
    ...
    pub BeginQueryStateVariable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut u64,
    ...
    pub EndQueryStateVariable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        *mut super::super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    pub BeginSubscribeToEvents: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut u64,
    ) -> windows_core::HRESULT,
    pub EndSubscribeToEvents:
        unsafe extern "system" fn(*mut core::ffi::c_void, u64) -> windows_core::HRESULT,
    pub BeginSCPDDownload: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut u64,
    ) -> windows_core::HRESULT,
    pub EndSCPDDownload: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CancelAsyncOperation:
        unsafe extern "system" fn(*mut core::ffi::c_void, u64) -> windows_core::HRESULT,
}
#[cfg(all(
    feature = "Win32_System_Com",
...
pub trait IUPnPServiceAsync_Impl: windows_core::IUnknownImpl {
    fn BeginInvokeAction(
        ...
        bstractionname: &windows_core::BSTR,
        vinactionargs: &super::super::super::System::Variant::VARIANT,
        pasyncresult: windows_core::Ref<'_, IUPnPAsyncResult>,
    ) -> windows_core::Result<u64>;
    fn EndInvokeAction(
        &self,
        ullrequestid: u64,
...
impl IUPnPServiceAsync_Vtbl {
    pub const fn new<Identity: IUPnPServiceAsync_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BeginInvokeAction<
        ...
        >(
            ...
            pullrequestid: *mut u64,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPServiceAsync_Impl::BeginInvokeAction(
                    this,
                    core::mem::transmute(&bstractionname),
                    core::mem::transmute(&vinactionargs),
        ...
        unsafe extern "system" fn EndInvokeAction<
            Identity: IUPnPServiceAsync_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPServiceAsync_Impl::EndInvokeAction(
                    this,
                    core::mem::transmute_copy(&ullrequestid),
                    core::mem::transmute_copy(&pvoutactionargs),
        ...
        unsafe extern "system" fn BeginQueryStateVariable<
            Identity: IUPnPServiceAsync_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPServiceAsync_Impl::BeginQueryStateVariable(
                    this,
                    core::mem::transmute(&bstrvariablename),
                    core::mem::transmute_copy(&pasyncresult),
                ) {
        ...
        unsafe extern "system" fn EndQueryStateVariable<
            Identity: IUPnPServiceAsync_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPServiceAsync_Impl::EndQueryStateVariable(
                    this,
                    core::mem::transmute_copy(&ullrequestid),
        ...
        unsafe extern "system" fn BeginSubscribeToEvents<
            Identity: IUPnPServiceAsync_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPServiceAsync_Impl::BeginSubscribeToEvents(
                    this,
                    core::mem::transmute_copy(&punkcallback),
                    core::mem::transmute_copy(&pasyncresult),
                ) {
        ...
        unsafe extern "system" fn EndSubscribeToEvents<
            Identity: IUPnPServiceAsync_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPServiceAsync_Impl::EndSubscribeToEvents(
                    this,
                    core::mem::transmute_copy(&ullrequestid),
                )
                .into()
        ...
        unsafe extern "system" fn BeginSCPDDownload<
            Identity: IUPnPServiceAsync_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPServiceAsync_Impl::BeginSCPDDownload(
                    this,
                    core::mem::transmute_copy(&pasyncresult),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn EndSCPDDownload<
            Identity: IUPnPServiceAsync_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ullrequestid: u64,
            pbstrscpddoc: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUPnPServiceAsync_Impl::EndSCPDDownload(
                    this,
                    core::mem::transmute_copy(&ullrequestid),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CancelAsyncOperation<
            Identity: IUPnPServiceAsync_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPServiceAsync_Impl::CancelAsyncOperation(
                    this,
                    core::mem::transmute_copy(&ullrequestid),
                )
                .into()
...
impl IUPnPServiceCallback {
    ...
    pub unsafe fn StateVariableChanged<P0, P1>(
        &self,
        pus: P0,
        pcwszstatevarname: P1,
        vavalue: &super::super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StateVariableChanged)(
                windows_core::Interface::as_raw(self),
                pus.param().abi(),
                pcwszstatevarname.param().abi(),
                core::mem::transmute_copy(vavalue),
            )
            .ok()
        }
    }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ServiceInstanceDied)(
                windows_core::Interface::as_raw(self),
                pus.param().abi(),
            )
            .ok()
...
pub struct IUPnPServiceCallback_Vtbl {
    ...
    pub StateVariableChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        super::super::super::System::Variant::VARIANT,
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub ServiceInstanceDied: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
...
pub trait IUPnPServiceCallback_Impl: windows_core::IUnknownImpl {
    fn StateVariableChanged(
        &self,
        pus: windows_core::Ref<'_, IUPnPService>,
        pcwszstatevarname: &windows_core::PCWSTR,
        vavalue: &super::super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()>;
...
impl IUPnPServiceCallback_Vtbl {
    pub const fn new<Identity: IUPnPServiceCallback_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn StateVariableChanged<
            Identity: IUPnPServiceCallback_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pus: *mut core::ffi::c_void,
            pcwszstatevarname: windows_core::PCWSTR,
            vavalue: super::super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                ...
                IUPnPServiceCallback_Impl::StateVariableChanged(
                    this,
                    core::mem::transmute_copy(&pus),
                    core::mem::transmute(&pcwszstatevarname),
                    core::mem::transmute(&vavalue),
                )
                .into()
            }
        }
        unsafe extern "system" fn ServiceInstanceDied<
            Identity: IUPnPServiceCallback_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPServiceCallback_Impl::ServiceInstanceDied(
                    this,
                    core::mem::transmute_copy(&pus),
                )
                .into()
...
impl IUPnPServiceDocumentAccess_Vtbl {
    pub const fn new<Identity: IUPnPServiceDocumentAccess_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            pbstrdocurl: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            pbstrdoc: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x38873b37_91bb_49f4_b249_2e8efbb8a816
);
...
impl IUPnPServiceEnumProperty {
    pub unsafe fn SetServiceEnumProperty(&self, dwmask: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetServiceEnumProperty)(
                windows_core::Interface::as_raw(self),
                dwmask,
            )
            .ok()
...
impl IUPnPServiceEnumProperty_Vtbl {
    pub const fn new<Identity: IUPnPServiceEnumProperty_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetServiceEnumProperty<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUPnPServiceEnumProperty_Impl::SetServiceEnumProperty(
                    this,
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            SetServiceEnumProperty: SetServiceEnumProperty::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IUPnPServices,
    IUPnPServices_Vtbl,
    0x3f8c8e9e_9a7a_4dc8_bc41_ff31fa374956
);
#[cfg(feature = "Win32_System_Com")]
...
impl IUPnPServices {
    ...
    pub unsafe fn get_Item(
        &self,
        bstrserviceid: &windows_core::BSTR,
    ) -> windows_core::Result<IUPnPService> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Item)(
                windows_core::Interface::as_raw(self),
...
impl IUPnPServices_Vtbl {
    pub const fn new<Identity: IUPnPServices_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Count<Identity: IUPnPServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plcount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn _NewEnum<Identity: IUPnPServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppunk: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn get_Item<Identity: IUPnPServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrserviceid: *mut core::ffi::c_void,
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IUPnPServices as windows_core::Interface>::IID
            || iid == &<super::super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
pub type SW_DEVICE_CREATE_CALLBACK = Option<
    unsafe extern "system" fn(
        hswdevice: HSWDEVICE,
        createresult: windows_core::HRESULT,
        pcontext: *const core::ffi::c_void,
        pszdeviceinstanceid: windows_core::PCWSTR,
    ),
>;
#[repr(C)]
...
pub const UPNP_E_ACTION_REQUEST_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0x80040210_u32 as _);
pub const UPNP_E_ACTION_SPECIFIC_BASE: windows_core::HRESULT =
    windows_core::HRESULT(0x80040300_u32 as _);
pub const UPNP_E_DEVICE_ELEMENT_EXPECTED: windows_core::HRESULT =
...
pub const UPNP_E_DEVICE_NODE_INCOMPLETE: windows_core::HRESULT =
    windows_core::HRESULT(0x80040204_u32 as _);
pub const UPNP_E_DEVICE_NOTREGISTERED: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A032_u32 as _);
...
pub const UPNP_E_DUPLICATE_NOT_ALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A021_u32 as _);
pub const UPNP_E_DUPLICATE_SERVICE_ID: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A022_u32 as _);
pub const UPNP_E_ERROR_PROCESSING_RESPONSE: windows_core::HRESULT =
    windows_core::HRESULT(0x80040216_u32 as _);
pub const UPNP_E_EVENT_SUBSCRIPTION_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0x80040501_u32 as _);
pub const UPNP_E_ICON_ELEMENT_EXPECTED: windows_core::HRESULT =
    windows_core::HRESULT(0x80040205_u32 as _);
pub const UPNP_E_ICON_NODE_INCOMPLETE: windows_core::HRESULT =
    windows_core::HRESULT(0x80040206_u32 as _);
pub const UPNP_E_INVALID_ACTION: windows_core::HRESULT = windows_core::HRESULT(0x80040207_u32 as _);
pub const UPNP_E_INVALID_ARGUMENTS: windows_core::HRESULT =
    windows_core::HRESULT(0x80040208_u32 as _);
pub const UPNP_E_INVALID_DESCRIPTION: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A023_u32 as _);
pub const UPNP_E_INVALID_DOCUMENT: windows_core::HRESULT =
...
pub const UPNP_E_INVALID_ROOT_NAMESPACE: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A027_u32 as _);
pub const UPNP_E_INVALID_SERVICE: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A024_u32 as _);
pub const UPNP_E_INVALID_VARIABLE: windows_core::HRESULT =
...
pub const UPNP_E_REQUIRED_ELEMENT_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A020_u32 as _);
pub const UPNP_E_ROOT_ELEMENT_EXPECTED: windows_core::HRESULT =
    windows_core::HRESULT(0x80040200_u32 as _);
pub const UPNP_E_SERVICE_ELEMENT_EXPECTED: windows_core::HRESULT =
    windows_core::HRESULT(0x80040202_u32 as _);
pub const UPNP_E_SERVICE_NODE_INCOMPLETE: windows_core::HRESULT =
    windows_core::HRESULT(0x80040203_u32 as _);
pub const UPNP_E_SUFFIX_TOO_LONG: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A028_u32 as _);
pub const UPNP_E_TRANSPORT_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0x80040211_u32 as _);
pub const UPNP_E_URLBASE_PRESENT: windows_core::HRESULT =
...
pub const UPNP_E_VARIABLE_VALUE_UNKNOWN: windows_core::HRESULT =
    windows_core::HRESULT(0x80040212_u32 as _);
pub const UPNP_SERVICE_DELAY_SCPD_AND_SUBSCRIPTION: u32 = 1u32;
pub const UPnPDescriptionDocument: windows_core::GUID =
    windows_core::GUID::from_u128(0x1d8a9b47_3a28_4ce2_8a4b_bd34e45bceeb);
pub const UPnPDescriptionDocumentEx: windows_core::GUID =
    windows_core::GUID::from_u128(0x33fd0563_d81a_4393_83cc_0195b1da2f91);
pub const UPnPDevice: windows_core::GUID =
    windows_core::GUID::from_u128(0xa32552c5_ba61_457a_b59a_a2561e125e33);
pub const UPnPDeviceFinder: windows_core::GUID =
    windows_core::GUID::from_u128(0xe2085f28_feb7_404a_b8e7_e659bdeaaa02);
pub const UPnPDeviceFinderEx: windows_core::GUID =
    windows_core::GUID::from_u128(0x181b54fc_380b_4a75_b3f1_4ac45e9605b0);
pub const UPnPDevices: windows_core::GUID =
    windows_core::GUID::from_u128(0xb9e84ffd_ad3c_40a4_b835_0882ebcbaaa8);
pub const UPnPRegistrar: windows_core::GUID =
    windows_core::GUID::from_u128(0x204810b9_73b2_11d4_bf42_00b0d0118b56);
pub const UPnPRemoteEndpointInfo: windows_core::GUID =
    windows_core::GUID::from_u128(0x2e5e84e9_4049_4244_b728_2d24227157c7);
pub const UPnPService: windows_core::GUID =
    windows_core::GUID::from_u128(0xc624ba95_fbcb_4409_8c03_8cceec533ef1);
pub const UPnPServices: windows_core::GUID =
    windows_core::GUID::from_u128(0xc0bc4b4a_a406_4efc_932f_b8546b8100cc);

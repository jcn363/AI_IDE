...
pub unsafe fn CryptCATAdminAcquireContext2<P2>(
    ...
    pstronghashpolicy: Option<*const super::CERT_STRONG_SIGN_PARA>,
    dwflags: Option<u32>,
) -> windows_core::Result<()>
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        CryptCATAdminAddCatalog(
            hcatadmin,
            pwszcatalogfile.param().abi(),
            pwszselectbasename.param().abi(),
            dwflags,
        )
    }
}
...
#[inline]
pub unsafe fn CryptCATAdminResolveCatalogPath<P1>(
    hcatadmin: isize,
    pwszcatalogfile: P1,
...
pub unsafe fn CryptCATAllocSortedMemberInfo<P1>(
    hcatalog: super::super::super::Foundation::HANDLE,
    pwszreferencetag: P1,
) -> *mut CRYPTCATMEMBER
where
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
#[inline]
pub unsafe fn CryptCATCDFEnumAttributesWithCDFTag<P1>(
    pcdf: *const CRYPTCATCDF,
    pwszmembertag: P1,
    pmember: *const CRYPTCATMEMBER,
    pprevattr: *const CRYPTCATATTRIBUTE,
    pfnparseerror: PFN_CDF_PARSE_ERROR_CALLBACK,
) -> *mut CRYPTCATATTRIBUTE
where
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
#[inline]
pub unsafe fn CryptCATCDFEnumMembersByCDFTagEx(
    pcdf: *const CRYPTCATCDF,
    pwszprevcdftag: windows_core::PWSTR,
    pfnparseerror: PFN_CDF_PARSE_ERROR_CALLBACK,
    ppmember: *const *const CRYPTCATMEMBER,
    ...
    unsafe {
        CryptCATCDFEnumMembersByCDFTagEx(
            pcdf,
            core::mem::transmute(pwszprevcdftag),
            pfnparseerror,
            ppmember,
            fcontinueonerror.into(),
            pvreserved,
        )
    }
}
#[inline]
pub unsafe fn CryptCATCDFOpen<P0>(
    pwszfilepath: P0,
    pfnparseerror: PFN_CDF_PARSE_ERROR_CALLBACK,
) -> *mut CRYPTCATCDF
where
...
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
#[inline]
pub unsafe fn CryptCATGetAttrInfo<P2>(
    hcatalog: super::super::super::Foundation::HANDLE,
    pcatmember: *mut CRYPTCATMEMBER,
    pwszreferencetag: P2,
) -> *mut CRYPTCATATTRIBUTE
...
#[inline]
pub unsafe fn CryptCATGetCatAttrInfo<P1>(
    hcatalog: super::super::super::Foundation::HANDLE,
    pwszreferencetag: P1,
) -> *mut CRYPTCATATTRIBUTE
where
...
#[inline]
pub unsafe fn CryptCATHandleFromStore(
    pcatstore: *mut CRYPTCATSTORE,
...
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
#[inline]
pub unsafe fn CryptCATPutAttrInfo<P2>(
    hcatalog: super::super::super::Foundation::HANDLE,
    pcatmember: *mut CRYPTCATMEMBER,
    pwszreferencetag: P2,
...
#[inline]
pub unsafe fn CryptCATPutCatAttrInfo<P1>(
    hcatalog: super::super::super::Foundation::HANDLE,
    pwszreferencetag: P1,
    dwattrtypeandaction: u32,
    cbdata: u32,
...
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
#[inline]
pub unsafe fn CryptCATPutMemberInfo<P1, P2>(
    hcatalog: super::super::super::Foundation::HANDLE,
    pwszfilename: P1,
    pwszreferencetag: P2,
    pgsubjecttype: *mut windows_core::GUID,
    dwcertversion: u32,
...
#[inline]
pub unsafe fn IsCatalogFile<P1>(
    hfile: super::super::super::Foundation::HANDLE,
    pwszfilename: P1,
) -> windows_core::BOOL
where
...
pub const CRYPTCAT_ATTR_AUTHENTICATED: CRYPTCATATTRIBUTE_FLAGS =
    CRYPTCATATTRIBUTE_FLAGS(268435456u32);
...
pub const CRYPTCAT_ATTR_NO_AUTO_COMPAT_ENTRY: CRYPTCATATTRIBUTE_FLAGS =
    CRYPTCATATTRIBUTE_FLAGS(16777216u32);
pub const CRYPTCAT_ATTR_UNAUTHENTICATED: CRYPTCATATTRIBUTE_FLAGS =
    CRYPTCATATTRIBUTE_FLAGS(536870912u32);
...
pub type PFN_CDF_PARSE_ERROR_CALLBACK = Option<
    unsafe extern "system" fn(dwerrorarea: u32, dwlocalerror: u32, pwszline: windows_core::PCWSTR),
>;
pub const szOID_CATALOG_LIST: windows_core::PCSTR = windows_core::s!("1.3.6.1.4.1.311.12.1.1");
pub const szOID_CATALOG_LIST_MEMBER: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.12.1.2");
pub const szOID_CATALOG_LIST_MEMBER2: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.12.1.3");

...
pub struct IIsolatedEnvironmentInterop_Vtbl {
    ...
    pub GetHostHwndInterop: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IIsolatedEnvironmentInterop_Vtbl {
    pub const fn new<Identity: IIsolatedEnvironmentInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetHostHwndInterop<
            Identity: IIsolatedEnvironmentInterop_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            containerhwnd: super::super::super::Foundation::HWND,
            hosthwnd: *mut super::super::super::Foundation::HWND,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IIsolatedEnvironmentInterop_Impl::GetHostHwndInterop(
                    this,
                    core::mem::transmute_copy(&containerhwnd),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            ...
            GetHostHwndInterop: GetHostHwndInterop::<Identity, OFFSET>,
        }
    }

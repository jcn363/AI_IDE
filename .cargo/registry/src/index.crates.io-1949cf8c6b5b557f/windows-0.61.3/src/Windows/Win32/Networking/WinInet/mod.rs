...
pub unsafe fn AppCacheCheckManifest<P0, P1>(
    ...
    phnewappcache: *mut *mut core::ffi::c_void,
) -> u32
where
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        AppCacheCheckManifest(
            pwszmasterurl.param().abi(),
            pwszmanifesturl.param().abi(),
            core::mem::transmute(pbmanifestdata.as_ptr()),
            pbmanifestdata.len().try_into().unwrap(),
            core::mem::transmute(pbmanifestresponseheaders.as_ptr()),
            pbmanifestresponseheaders.len().try_into().unwrap(),
            pestate as _,
            phnewappcache as _,
        )
    }
...
pub unsafe fn AppCacheCreateAndCommitFile<P1, P2>(
    happcache: *const core::ffi::c_void,
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        AppCacheCreateAndCommitFile(
            ...
            pwszurl.param().abi(),
            core::mem::transmute(pbresponseheaders.as_ptr()),
            pbresponseheaders.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
pub unsafe fn AppCacheDuplicateHandle(
    happcache: *const core::ffi::c_void,
    phduplicatedappcache: *mut *mut core::ffi::c_void,
) -> u32 {
...
#[inline]
pub unsafe fn AppCacheGetFallbackUrl<P1>(
    happcache: *const core::ffi::c_void,
    pwszurl: P1,
    ppwszfallbackurl: *mut windows_core::PWSTR,
) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
pub unsafe fn AppCacheGetManifestUrl(
    happcache: *const core::ffi::c_void,
    ppwszmanifesturl: *mut windows_core::PWSTR,
) -> u32 {
...
#[inline]
pub unsafe fn AppCacheLookup<P0>(
    pwszurl: P0,
    dwflags: u32,
    phappcache: *mut *mut core::ffi::c_void,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn CommitUrlCacheEntryA<P0, P1, P7, P8>(
    lpszurlname: P0,
    lpszlocalfilename: P1,
    expiretime: super::super::Foundation::FILETIME,
    lastmodifiedtime: super::super::Foundation::FILETIME,
    cacheentrytype: u32,
    lpheaderinfo: Option<&[u8]>,
    lpszfileextension: P7,
    lpszoriginalurl: P8,
) -> windows_core::Result<()>
where
    ...
    P8: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CommitUrlCacheEntryA(
            lpszurlname.param().abi(),
            lpszlocalfilename.param().abi(),
            ...
            lpszfileextension.param().abi(),
            lpszoriginalurl.param().abi(),
        )
        .ok()
    }
}
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        CommitUrlCacheEntryBinaryBlob(
            pwszurlname.param().abi(),
            dwtype,
            core::mem::transmute(ftexpiretime),
            core::mem::transmute(ftmodifiedtime),
            core::mem::transmute(
                pbblob
                    .as_deref()
                    .map_or(core::ptr::null(), |slice| slice.as_ptr()),
...
#[inline]
pub unsafe fn CommitUrlCacheEntryW<P0, P1, P7, P8>(
    lpszurlname: P0,
    lpszlocalfilename: P1,
    expiretime: super::super::Foundation::FILETIME,
    lastmodifiedtime: super::super::Foundation::FILETIME,
    cacheentrytype: u32,
    lpszheaderinfo: Option<&[u16]>,
    lpszfileextension: P7,
    lpszoriginalurl: P8,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn CreateMD5SSOHash<P0, P1, P2>(
    pszchallengeinfo: P0,
    pwszrealm: P1,
    pwsztarget: P2,
    pbhexhash: *mut u8,
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        CreateMD5SSOHash(
            pszchallengeinfo.param().abi(),
            pwszrealm.param().abi(),
            pwsztarget.param().abi(),
            pbhexhash as _,
        )
    }
}
...
pub unsafe fn CreateUrlCacheContainerA<P0, P1, P2>(
    ...
    dwcontainertype: u32,
    dwoptions: u32,
    pvbuffer: Option<*const core::ffi::c_void>,
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CreateUrlCacheContainerA(
            name.param().abi(),
            lpcacheprefix.param().abi(),
            lpszcachepath.param().abi(),
            kbcachelimit,
            dwcontainertype,
            dwoptions,
            pvbuffer.unwrap_or(core::mem::zeroed()) as _,
            cbbuffer.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn CreateUrlCacheContainerW<P0, P1, P2>(
    name: P0,
    lpcacheprefix: P1,
    lpszcachepath: P2,
    kbcachelimit: u32,
...
#[inline]
pub unsafe fn CreateUrlCacheEntryA<P0, P2>(
    lpszurlname: P0,
    dwexpectedfilesize: u32,
    lpszfileextension: P2,
    lpszfilename: &mut [u8; 260],
    dwreserved: u32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CreateUrlCacheEntryA(
            ...
            dwexpectedfilesize,
            lpszfileextension.param().abi(),
            core::mem::transmute(lpszfilename.as_ptr()),
            dwreserved,
        )
        .ok()
    }
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        CreateUrlCacheEntryExW(
            ...
            core::mem::transmute(lpszfilename.as_ptr()),
            dwreserved,
            fpreserveincomingfilename.into(),
        )
    }
}
#[inline]
pub unsafe fn CreateUrlCacheEntryW<P0, P2>(
    lpszurlname: P0,
    dwexpectedfilesize: u32,
    lpszfileextension: P2,
    lpszfilename: &mut [u16; 260],
...
#[inline]
pub unsafe fn CreateUrlCacheGroup(
    dwflags: u32,
...
#[inline]
pub unsafe fn DeleteIE3Cache<P2>(
...
pub unsafe fn DetectAutoProxyUrl(
    ...
    unsafe {
        DetectAutoProxyUrl(
            core::mem::transmute(pszautoproxyurl.as_ptr()),
            pszautoproxyurl.len().try_into().unwrap(),
            dwdetectflags,
        )
        .ok()
    }
...
pub unsafe fn FindFirstUrlCacheContainerA(
    ...
    unsafe {
        FindFirstUrlCacheContainerA(
            pdwmodified as _,
            lpcontainerinfo as _,
            lpcbcontainerinfo as _,
            dwoptions,
        )
    }
}
...
#[inline]
pub unsafe fn FindFirstUrlCacheEntryA<P0>(
    lpszurlsearchpattern: P0,
    lpfirstcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOA>,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    let result__ = unsafe {
        FindFirstUrlCacheEntryA(
            lpszurlsearchpattern.param().abi(),
            lpfirstcacheentryinfo.unwrap_or(core::mem::zeroed()) as _,
            lpcbcacheentryinfo as _,
        )
    };
    (!result__.is_invalid())
        .then_some(result__)
...
#[inline]
pub unsafe fn FindFirstUrlCacheEntryExA<P0>(
    lpszurlsearchpattern: P0,
    dwflags: u32,
    dwfilter: u32,
    groupid: i64,
    lpfirstcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOA>,
    lpcbcacheentryinfo: *mut u32,
    lpgroupattributes: Option<*const core::ffi::c_void>,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    let result__ = unsafe {
        FindFirstUrlCacheEntryExA(
            ...
            lpfirstcacheentryinfo.unwrap_or(core::mem::zeroed()) as _,
            lpcbcacheentryinfo as _,
            lpgroupattributes.unwrap_or(core::mem::zeroed()) as _,
            lpcbgroupattributes.unwrap_or(core::mem::zeroed()) as _,
            lpreserved.unwrap_or(core::mem::zeroed()) as _,
        )
    };
    (!result__.is_invalid())
...
#[inline]
pub unsafe fn FindFirstUrlCacheEntryExW<P0>(
    lpszurlsearchpattern: P0,
    dwflags: u32,
    dwfilter: u32,
    groupid: i64,
    lpfirstcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOW>,
    lpcbcacheentryinfo: *mut u32,
    lpgroupattributes: Option<*const core::ffi::c_void>,
    lpcbgroupattributes: Option<*const u32>,
    lpreserved: Option<*const core::ffi::c_void>,
...
#[inline]
pub unsafe fn FindFirstUrlCacheEntryW<P0>(
    lpszurlsearchpattern: P0,
    lpfirstcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOW>,
    lpcbcacheentryinfo: *mut u32,
) -> windows_core::Result<super::super::Foundation::HANDLE>
...
pub unsafe fn FindFirstUrlCacheGroup(
    dwflags: u32,
    dwfilter: u32,
    lpsearchcondition: Option<*const core::ffi::c_void>,
    dwsearchcondition: Option<u32>,
    lpgroupid: *mut i64,
    lpreserved: Option<*const core::ffi::c_void>,
) -> windows_core::Result<super::super::Foundation::HANDLE> {
    ...
    let result__ = unsafe {
        FindFirstUrlCacheGroup(
            dwflags,
            dwfilter,
            lpsearchcondition.unwrap_or(core::mem::zeroed()) as _,
            dwsearchcondition.unwrap_or(core::mem::zeroed()) as _,
            lpgroupid as _,
            lpreserved.unwrap_or(core::mem::zeroed()) as _,
        )
    };
...
pub unsafe fn FindNextUrlCacheEntryA(
    ...
    unsafe {
        FindNextUrlCacheEntryA(
            henumhandle,
            lpnextcacheentryinfo.unwrap_or(core::mem::zeroed()) as _,
            lpcbcacheentryinfo as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn FreeUrlCacheSpaceA<P0>(
    lpszcachepath: P0,
    dwsize: u32,
    dwfilter: u32,
) -> windows_core::Result<()>
...
pub unsafe fn FtpCommandA<P3>(
    ...
    phftpcommand: Option<*mut *mut core::ffi::c_void>,
) -> windows_core::Result<()>
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        FtpCommandA(
            hconnect,
            fexpectresponse.into(),
            dwflags,
            lpszcommand.param().abi(),
            dwcontext.unwrap_or(core::mem::zeroed()) as _,
            phftpcommand.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn FtpCreateDirectoryA<P1>(
    hconnect: *const core::ffi::c_void,
    lpszdirectory: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn FtpCreateDirectoryW<P1>(
    hconnect: *const core::ffi::c_void,
    lpszdirectory: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn FtpDeleteFileA<P1>(
    hconnect: *const core::ffi::c_void,
    lpszfilename: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn FtpFindFirstFileA<P1>(
    hconnect: *const core::ffi::c_void,
    lpszsearchfile: P1,
    lpfindfiledata: Option<*mut super::super::Storage::FileSystem::WIN32_FIND_DATAA>,
    dwflags: u32,
    dwcontext: Option<usize>,
) -> *mut core::ffi::c_void
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        FtpFindFirstFileA(
            hconnect,
            lpszsearchfile.param().abi(),
            lpfindfiledata.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
            dwcontext.unwrap_or(core::mem::zeroed()) as _,
        )
    }
...
#[cfg(feature = "Win32_Storage_FileSystem")]
#[inline]
pub unsafe fn FtpFindFirstFileW<P1>(
    hconnect: *const core::ffi::c_void,
    lpszsearchfile: P1,
    lpfindfiledata: Option<*mut super::super::Storage::FileSystem::WIN32_FIND_DATAW>,
    dwflags: u32,
    dwcontext: Option<usize>,
) -> *mut core::ffi::c_void
where
...
pub unsafe fn FtpGetCurrentDirectoryA(
    hconnect: *const core::ffi::c_void,
    lpszcurrentdirectory: windows_core::PSTR,
    ...
    unsafe {
        FtpGetCurrentDirectoryA(
            hconnect,
            core::mem::transmute(lpszcurrentdirectory),
            lpdwcurrentdirectory as _,
        )
        .ok()
    }
}
...
pub unsafe fn FtpGetCurrentDirectoryW(
    hconnect: *const core::ffi::c_void,
    lpszcurrentdirectory: windows_core::PWSTR,
    lpdwcurrentdirectory: *mut u32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn FtpGetFileA<P1, P2>(
    hconnect: *const core::ffi::c_void,
    lpszremotefile: P1,
    lpsznewfile: P2,
    ffailifexists: bool,
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        FtpGetFileA(
            hconnect,
            lpszremotefile.param().abi(),
            lpsznewfile.param().abi(),
            ffailifexists.into(),
...
pub unsafe fn FtpGetFileEx<P1, P2>(
    hftpsession: *const core::ffi::c_void,
    lpszremotefile: P1,
    lpsznewfile: P2,
    ffailifexists: bool,
    dwflagsandattributes: u32,
...
#[inline]
pub unsafe fn FtpGetFileSize(
    hfile: *const core::ffi::c_void,
    lpdwfilesizehigh: Option<*mut u32>,
) -> u32 {
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        FtpPutFileA(
            hconnect,
            lpszlocalfile.param().abi(),
            lpsznewremotefile.param().abi(),
            dwflags,
            dwcontext.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
...
#[inline]
pub unsafe fn FtpRemoveDirectoryA<P1>(
    hconnect: *const core::ffi::c_void,
    lpszdirectory: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn FtpRemoveDirectoryW<P1>(
    hconnect: *const core::ffi::c_void,
    lpszdirectory: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn FtpSetCurrentDirectoryA<P1>(
    hconnect: *const core::ffi::c_void,
    lpszdirectory: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn FtpSetCurrentDirectoryW<P1>(
    hconnect: *const core::ffi::c_void,
    lpszdirectory: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn GetDiskInfoA<P0>(
    pszpath: P0,
    pdwclustersize: Option<*mut u32>,
    pdlavail: Option<*mut u64>,
    pdltotal: Option<*mut u64>,
) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        GetDiskInfoA(
            pszpath.param().abi(),
            pdwclustersize.unwrap_or(core::mem::zeroed()) as _,
            pdlavail.unwrap_or(core::mem::zeroed()) as _,
            pdltotal.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn GetUrlCacheConfigInfoA(
    ...
    unsafe {
        GetUrlCacheConfigInfoA(
            lpcacheconfiginfo as _,
            lpcbcacheconfiginfo.unwrap_or(core::mem::zeroed()) as _,
            dwfieldcontrol,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn GetUrlCacheEntryInfoA<P0>(
    lpszurlname: P0,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        GetUrlCacheEntryInfoA(
            lpszurlname.param().abi(),
            lpcacheentryinfo.unwrap_or(core::mem::zeroed()) as _,
            lpcbcacheentryinfo.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn GetUrlCacheEntryInfoExA<P0, P3>(
    lpszurl: P0,
    lpcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOA>,
    lpcbcacheentryinfo: Option<*mut u32>,
    lpszredirecturl: P3,
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        GetUrlCacheEntryInfoExA(
            ...
            lpcacheentryinfo.unwrap_or(core::mem::zeroed()) as _,
            lpcbcacheentryinfo.unwrap_or(core::mem::zeroed()) as _,
            lpszredirecturl.param().abi(),
            lpcbredirecturl.unwrap_or(core::mem::zeroed()) as _,
            lpreserved.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
        )
        .ok()
...
#[inline]
pub unsafe fn GetUrlCacheEntryInfoExW<P0, P3>(
    lpszurl: P0,
...
#[inline]
pub unsafe fn GetUrlCacheEntryInfoW<P0>(
    lpszurlname: P0,
    lpcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOW>,
    lpcbcacheentryinfo: Option<*mut u32>,
) -> windows_core::Result<()>
...
pub unsafe fn GopherCreateLocatorA<P0, P2, P3>(
    ...
    dwgophertype: u32,
    lpszlocator: Option<windows_core::PSTR>,
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        GopherCreateLocatorA(
            lpszhost.param().abi(),
            nserverport,
            lpszdisplaystring.param().abi(),
            lpszselectorstring.param().abi(),
            dwgophertype,
            lpszlocator.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn GopherCreateLocatorW<P0, P2, P3>(
    lpszhost: P0,
    nserverport: u16,
    lpszdisplaystring: P2,
    lpszselectorstring: P3,
    dwgophertype: u32,
    lpszlocator: Option<windows_core::PWSTR>,
    lpdwbufferlength: *mut u32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        GopherFindFirstFileA(
            hconnect,
            lpszlocator.param().abi(),
            lpszsearchstring.param().abi(),
            lpfinddata.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
            dwcontext.unwrap_or(core::mem::zeroed()) as _,
        )
    }
...
#[inline]
pub unsafe fn GopherGetAttributeW<P1, P2>(
    hconnect: *const core::ffi::c_void,
    lpszlocator: P1,
    lpszattributename: P2,
    lpbuffer: &mut [u8],
...
#[inline]
pub unsafe fn GopherOpenFileA<P1, P2>(
    hconnect: *const core::ffi::c_void,
    lpszlocator: P1,
    lpszview: P2,
    dwflags: u32,
...
pub unsafe fn HttpCheckDavComplianceA<P0, P1>(
    ...
    lpffound: *mut windows_core::BOOL,
    hwnd: super::super::Foundation::HWND,
...
#[inline]
pub unsafe fn HttpCheckDavComplianceW<P0, P1>(
    lpszurl: P0,
    lpszcompliancetoken: P1,
    lpffound: *mut windows_core::BOOL,
    hwnd: super::super::Foundation::HWND,
...
pub unsafe fn HttpDuplicateDependencyHandle(
    hdependencyhandle: *const core::ffi::c_void,
    phduplicateddependencyhandle: *mut *mut core::ffi::c_void,
) -> u32 {
...
pub unsafe fn HttpEndRequestA(
    hrequest: *const core::ffi::c_void,
    lpbuffersout: Option<*mut INTERNET_BUFFERSA>,
    dwflags: u32,
    dwcontext: Option<usize>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        HttpEndRequestA(
            hrequest,
            lpbuffersout.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
            dwcontext.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
...
pub unsafe fn HttpEndRequestW(
    hrequest: *const core::ffi::c_void,
    lpbuffersout: Option<*mut INTERNET_BUFFERSW>,
    dwflags: u32,
    dwcontext: Option<usize>,
) -> windows_core::Result<()> {
...
pub unsafe fn HttpGetServerCredentials<P0>(
    pwszurl: P0,
    ppwszusername: *mut windows_core::PWSTR,
    ppwszpassword: *mut windows_core::PWSTR,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
pub unsafe fn HttpOpenDependencyHandle(
    hrequesthandle: *const core::ffi::c_void,
    fbackground: bool,
    phdependencyhandle: *mut *mut core::ffi::c_void,
) -> u32 {
...
#[inline]
pub unsafe fn HttpOpenRequestA<P1, P2, P3, P4>(
    hconnect: *const core::ffi::c_void,
    lpszverb: P1,
    lpszobjectname: P2,
    lpszversion: P3,
    lpszreferrer: P4,
    lplpszaccepttypes: Option<*const windows_core::PCSTR>,
    dwflags: u32,
    dwcontext: Option<usize>,
) -> *mut core::ffi::c_void
where
    ...
    P4: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        HttpOpenRequestA(
            hconnect,
            lpszverb.param().abi(),
            lpszobjectname.param().abi(),
            lpszversion.param().abi(),
            lpszreferrer.param().abi(),
            lplpszaccepttypes.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
            dwcontext.unwrap_or(core::mem::zeroed()) as _,
        )
    }
...
pub unsafe fn HttpOpenRequestW<P1, P2, P3, P4>(
    ...
    lpszversion: P3,
    lpszreferrer: P4,
    lplpszaccepttypes: Option<*const windows_core::PCWSTR>,
    dwflags: u32,
    dwcontext: Option<usize>,
) -> *mut core::ffi::c_void
where
...
#[inline]
pub unsafe fn HttpPushWait(
    hwait: HTTP_PUSH_WAIT_HANDLE,
    etype: HTTP_PUSH_WAIT_TYPE,
    pnotificationstatus: Option<*mut HTTP_PUSH_NOTIFICATION_STATUS>,
) -> u32 {
    ...
    unsafe {
        HttpPushWait(
            hwait,
            etype,
            pnotificationstatus.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn HttpQueryInfoA(
    ...
    unsafe {
        HttpQueryInfoA(
            ...
            lpdwbufferlength as _,
            lpdwindex.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn HttpSendRequestExA(
    hrequest: *const core::ffi::c_void,
    lpbuffersin: Option<*const INTERNET_BUFFERSA>,
    lpbuffersout: Option<*mut INTERNET_BUFFERSA>,
    dwflags: u32,
    dwcontext: Option<usize>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        HttpSendRequestExA(
            hrequest,
            lpbuffersin.unwrap_or(core::mem::zeroed()) as _,
            lpbuffersout.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
            dwcontext.unwrap_or(core::mem::zeroed()) as _,
        )
...
pub unsafe fn HttpSendRequestExW(
    hrequest: *const core::ffi::c_void,
    lpbuffersin: Option<*const INTERNET_BUFFERSW>,
    lpbuffersout: Option<*mut INTERNET_BUFFERSW>,
    dwflags: u32,
    dwcontext: Option<usize>,
) -> windows_core::Result<()> {
...
pub unsafe fn InternalInternetGetCookie<P0>(
    lpszurl: P0,
    lpszcookiedata: windows_core::PSTR,
...
pub unsafe fn InternetAlgIdToStringA(
    ai: super::super::Security::Cryptography::ALG_ID,
    lpstr: windows_core::PSTR,
...
#[inline]
pub unsafe fn InternetCanonicalizeUrlA<P0>(
    lpszurl: P0,
    lpszbuffer: windows_core::PSTR,
    lpdwbufferlength: *mut u32,
    dwflags: u32,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn InternetCanonicalizeUrlW<P0>(
    lpszurl: P0,
    lpszbuffer: windows_core::PWSTR,
    lpdwbufferlength: *mut u32,
    dwflags: u32,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn InternetCheckConnectionA<P0>(
    lpszurl: P0,
    dwflags: u32,
    dwreserved: u32,
) -> windows_core::Result<()>
...
#[inline]
pub unsafe fn InternetCombineUrlA<P0, P1>(
    lpszbaseurl: P0,
    lpszrelativeurl: P1,
    lpszbuffer: windows_core::PSTR,
    lpdwbufferlength: *mut u32,
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        InternetCombineUrlA(
            lpszbaseurl.param().abi(),
            lpszrelativeurl.param().abi(),
            core::mem::transmute(lpszbuffer),
            lpdwbufferlength as _,
            dwflags,
        )
...
#[inline]
pub unsafe fn InternetConfirmZoneCrossingA<P1, P2>(
    hwnd: super::super::Foundation::HWND,
    szurlprev: P1,
    szurlnew: P2,
    bpost: bool,
...
#[inline]
pub unsafe fn InternetConnectA<P1, P3, P4>(
...
#[inline]
pub unsafe fn InternetConnectW<P1, P3, P4>(
    hinternet: *const core::ffi::c_void,
    lpszservername: P1,
    nserverport: u16,
    lpszusername: P3,
...
pub unsafe fn InternetConvertUrlFromWireToWideChar<P2>(
    ...
    dwcodepageextra: u32,
    ppwszconvertedurl: *mut windows_core::PWSTR,
) -> u32
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        InternetConvertUrlFromWireToWideChar(
            core::mem::transmute(pcszurl.as_ptr()),
            pcszurl.len().try_into().unwrap(),
            pcwszbaseurl.param().abi(),
            dwcodepagehost,
            dwcodepagepath,
            fencodepathextra.into(),
            dwcodepageextra,
            ppwszconvertedurl as _,
        )
    }
}
...
pub unsafe fn InternetCrackUrlA(
    ...
    unsafe {
        InternetCrackUrlA(
            core::mem::transmute(lpszurl.as_ptr()),
            lpszurl.len().try_into().unwrap(),
            dwflags,
...
pub unsafe fn InternetCreateUrlA(
    ...
    dwflags: u32,
    lpszurl: Option<windows_core::PSTR>,
    ...
    unsafe {
        InternetCreateUrlA(
            lpurlcomponents,
            dwflags,
            lpszurl.unwrap_or(core::mem::zeroed()) as _,
            lpdwurllength as _,
        )
        .ok()
    }
...
pub unsafe fn InternetCreateUrlW(
    ...
    dwflags: u32,
    lpszurl: Option<windows_core::PWSTR>,
    lpdwurllength: *mut u32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn InternetDialA<P1>(
    hwndparent: super::super::Foundation::HWND,
    lpszconnectoid: P1,
    dwflags: u32,
...
#[inline]
pub unsafe fn InternetDialW<P1>(
    hwndparent: super::super::Foundation::HWND,
    lpszconnectoid: P1,
    dwflags: u32,
    lpdwconnection: *mut usize,
...
pub unsafe fn InternetEnumPerSiteCookieDecisionW(
    pszsitename: windows_core::PWSTR,
    pcsitenamesize: *mut u32,
    pdwdecision: *mut u32,
    dwindex: u32,
) -> windows_core::BOOL {
...
pub unsafe fn InternetErrorDlg(
    hwnd: super::super::Foundation::HWND,
    hrequest: Option<*mut core::ffi::c_void>,
    dwerror: u32,
    dwflags: u32,
    lppvdata: Option<*mut *mut core::ffi::c_void>,
) -> u32 {
    ...
    unsafe {
        InternetErrorDlg(
            hwnd,
            hrequest.unwrap_or(core::mem::zeroed()) as _,
            dwerror,
            dwflags,
            lppvdata.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn InternetFindNextFileA(
    hfind: *const core::ffi::c_void,
    lpvfinddata: *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn InternetGetCookieA<P0, P1>(
    lpszurl: P0,
    lpszcookiename: P1,
    lpszcookiedata: Option<windows_core::PSTR>,
    lpdwsize: *mut u32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        InternetGetCookieA(
            ...
            lpszcookiedata.unwrap_or(core::mem::zeroed()) as _,
            lpdwsize as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn InternetGetCookieEx2<P0, P1>(
    pcwszurl: P0,
    pcwszcookiename: P1,
    dwflags: u32,
...
#[inline]
pub unsafe fn InternetGetCookieExW<P0, P1, P2>(
    lpszurl: P0,
    lpszcookiename: P1,
    lpszcookiedata: P2,
    lpdwsize: *mut u32,
...
pub unsafe fn InternetGetCookieW<P0, P1>(
    lpszurl: P0,
    lpszcookiename: P1,
    lpszcookiedata: Option<windows_core::PWSTR>,
    lpdwsize: *mut u32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn InternetGetLastResponseInfoA(
    lpdwerror: *mut u32,
    lpszbuffer: Option<windows_core::PSTR>,
    lpdwbufferlength: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        InternetGetLastResponseInfoA(
            lpdwerror as _,
            lpszbuffer.unwrap_or(core::mem::zeroed()) as _,
            lpdwbufferlength as _,
        )
        .ok()
    }
...
pub unsafe fn InternetGetLastResponseInfoW(
    lpdwerror: *mut u32,
    lpszbuffer: Option<windows_core::PWSTR>,
    lpdwbufferlength: *mut u32,
) -> windows_core::Result<()> {
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        InternetGetSecurityInfoByURL(lpszurl.param().abi(), ppcertchain as _, pdwsecureflags as _)
    }
}
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn InternetGetSecurityInfoByURLA<P0>(
    lpszurl: P0,
    ppcertchain: *mut *mut super::super::Security::Cryptography::CERT_CHAIN_CONTEXT,
    pdwsecureflags: *mut u32,
) -> windows_core::BOOL
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        InternetGetSecurityInfoByURLA(lpszurl.param().abi(), ppcertchain as _, pdwsecureflags as _)
    }
}
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        InternetGetSecurityInfoByURLW(lpszurl.param().abi(), ppcertchain as _, pdwsecureflags as _)
    }
}
#[inline]
pub unsafe fn InternetGoOnline<P0>(
    lpszurl: P0,
    hwndparent: super::super::Foundation::HWND,
    dwflags: u32,
) -> windows_core::Result<()>
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        InternetOpenA(
            ...
            dwaccesstype,
            lpszproxy.param().abi(),
            lpszproxybypass.param().abi(),
            dwflags,
        )
    }
}
#[inline]
pub unsafe fn InternetOpenUrlA<P1>(
    hinternet: *const core::ffi::c_void,
    lpszurl: P1,
    lpszheaders: Option<&[u8]>,
    dwflags: u32,
...
#[inline]
pub unsafe fn InternetOpenUrlW<P1>(
    hinternet: *const core::ffi::c_void,
    lpszurl: P1,
    lpszheaders: Option<&[u16]>,
    dwflags: u32,
...
pub unsafe fn InternetQueryDataAvailable(
    ...
    unsafe {
        InternetQueryDataAvailable(
            hfile,
            lpdwnumberofbytesavailable.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
            dwcontext.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
...
pub unsafe fn InternetSecurityProtocolToStringA(
    dwprotocol: u32,
    lpstr: Option<windows_core::PSTR>,
    lpdwstrlength: *mut u32,
    dwreserved: Option<u32>,
) -> windows_core::BOOL {
    ...
    unsafe {
        InternetSecurityProtocolToStringA(
            dwprotocol,
            lpstr.unwrap_or(core::mem::zeroed()) as _,
            lpdwstrlength as _,
            dwreserved.unwrap_or(core::mem::zeroed()) as _,
        )
    }
...
pub unsafe fn InternetSecurityProtocolToStringW(
    dwprotocol: u32,
    lpstr: Option<windows_core::PWSTR>,
    lpdwstrlength: *mut u32,
    dwreserved: Option<u32>,
) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn InternetSetCookieA<P0, P1, P2>(
    lpszurl: P0,
    lpszcookiename: P1,
    lpszcookiedata: P2,
) -> windows_core::Result<()>
...
#[inline]
pub unsafe fn InternetSetCookieEx2<P0, P2>(
    pcwszurl: P0,
...
#[inline]
pub unsafe fn InternetSetCookieExW<P0, P1, P2>(
    lpszurl: P0,
    lpszcookiename: P1,
    lpszcookiedata: P2,
    dwflags: u32,
...
#[inline]
pub unsafe fn InternetSetCookieW<P0, P1, P2>(
    lpszurl: P0,
    lpszcookiename: P1,
    lpszcookiedata: P2,
) -> windows_core::Result<()>
...
#[inline]
pub unsafe fn InternetSetDialState<P0>(
    lpszconnectoid: P0,
    dwstate: u32,
    dwreserved: u32,
) -> windows_core::BOOL
...
#[inline]
pub unsafe fn InternetSetDialStateA<P0>(
    lpszconnectoid: P0,
    dwstate: u32,
    dwreserved: Option<u32>,
) -> windows_core::BOOL
...
#[inline]
pub unsafe fn InternetSetDialStateW<P0>(
    lpszconnectoid: P0,
    dwstate: u32,
    dwreserved: Option<u32>,
) -> windows_core::BOOL
...
#[inline]
pub unsafe fn InternetSetPerSiteCookieDecisionW<P0>(
    pchhostname: P0,
    dwdecision: u32,
) -> windows_core::BOOL
where
...
#[inline]
pub unsafe fn InternetShowSecurityInfoByURLW<P0>(
    lpszurl: P0,
    hwndparent: super::super::Foundation::HWND,
) -> windows_core::BOOL
where
...
pub unsafe fn InternetTimeFromSystemTime(
    ...
    unsafe {
        InternetTimeFromSystemTime(
            pst,
            dwrfc,
            core::mem::transmute(lpsztime.as_ptr()),
            lpsztime.len().try_into().unwrap(),
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn InternetTimeToSystemTimeW<P0>(
    lpsztime: P0,
    pst: *mut super::super::Foundation::SYSTEMTIME,
    dwreserved: Option<u32>,
) -> windows_core::Result<()>
...
#[inline]
pub unsafe fn IsDomainLegalCookieDomainW<P0, P1>(
    pchdomain: P0,
    pchfulldomain: P1,
) -> windows_core::BOOL
where
...
pub unsafe fn IsHostInProxyBypassList(
    ...
    unsafe {
        IsHostInProxyBypassList(
            tscheme,
            core::mem::transmute(lpszhost.as_ptr()),
            lpszhost.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn IsUrlCacheEntryExpiredA<P0>(
    lpszurlname: P0,
    dwflags: u32,
...
pub unsafe fn ParseX509EncodedCertificateForListBoxEntry(
    lpcert: &[u8],
    lpszlistboxentry: Option<windows_core::PSTR>,
    ...
    unsafe {
        ParseX509EncodedCertificateForListBoxEntry(
            core::mem::transmute(lpcert.as_ptr()),
            lpcert.len().try_into().unwrap(),
            lpszlistboxentry.unwrap_or(core::mem::zeroed()) as _,
            lpdwlistboxentry as _,
        )
    }
}
#[inline]
pub unsafe fn PerformOperationOverUrlCacheA<P0>(
    ...
    op: CACHE_OPERATOR,
    poperatordata: *mut core::ffi::c_void,
) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        PerformOperationOverUrlCacheA(
            pszurlsearchpattern.param().abi(),
            dwflags,
            dwfilter,
            groupid,
            preserved1.unwrap_or(core::mem::zeroed()) as _,
            pdwreserved2.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn PrivacyGetZonePreferenceW(
    dwzone: u32,
    dwtype: u32,
    pdwtemplate: Option<*mut u32>,
    pszbuffer: Option<windows_core::PWSTR>,
    pdwbufferlength: Option<*mut u32>,
) -> u32 {
    ...
    unsafe {
        PrivacyGetZonePreferenceW(
            dwzone,
            dwtype,
            pdwtemplate.unwrap_or(core::mem::zeroed()) as _,
            pszbuffer.unwrap_or(core::mem::zeroed()) as _,
            pdwbufferlength.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn ReadGuidsForConnectedNetworks(
    pcnetworks: Option<*mut u32>,
    pppwsznetworkguids: Option<*mut *mut windows_core::PWSTR>,
    pppbstrnetworknames: Option<*mut *mut windows_core::BSTR>,
    pppwszgwmacs: Option<*mut *mut windows_core::PWSTR>,
    pcgatewaymacs: Option<*mut u32>,
    ...
    unsafe {
        ReadGuidsForConnectedNetworks(
            pcnetworks.unwrap_or(core::mem::zeroed()) as _,
            pppwsznetworkguids.unwrap_or(core::mem::zeroed()) as _,
            pppbstrnetworknames.unwrap_or(core::mem::zeroed()) as _,
            pppwszgwmacs.unwrap_or(core::mem::zeroed()) as _,
            pcgatewaymacs.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn RunOnceUrlCache<P2>(
    hwnd: super::super::Foundation::HWND,
    hinst: super::super::Foundation::HINSTANCE,
    lpszcmd: P2,
    ncmdshow: i32,
...
#[inline]
pub unsafe fn SetUrlCacheEntryGroup<P0>(
    lpszurlname: P0,
    dwflags: u32,
    groupid: i64,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SetUrlCacheEntryGroup(
            ...
            dwflags,
            groupid,
            pbgroupattributes.unwrap_or(core::mem::zeroed()) as _,
            cbgroupattributes.unwrap_or(core::mem::zeroed()) as _,
            lpreserved.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn SetUrlCacheEntryGroupA<P0>(
    lpszurlname: P0,
    dwflags: u32,
    groupid: i64,
    pbgroupattributes: Option<*const u8>,
...
#[inline]
pub unsafe fn SetUrlCacheEntryInfoA<P0>(
    lpszurlname: P0,
...
#[inline]
pub unsafe fn SetUrlCacheEntryInfoW<P0>(
    lpszurlname: P0,
...
pub unsafe fn UrlCacheCheckEntriesExist(
    rgpwszurls: *const windows_core::PCWSTR,
    centries: u32,
    rgfexist: *mut windows_core::BOOL,
) -> u32 {
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        UrlCacheCreateContainer(
            pwszname.param().abi(),
            pwszprefix.param().abi(),
            pwszdirectory.param().abi(),
            ulllimit,
            dwoptions,
        )
    }
...
#[inline]
pub unsafe fn UrlCacheFindFirstEntry<P0>(
    pwszprefix: P0,
    dwflags: u32,
    dwfilter: u32,
    groupid: i64,
...
pub unsafe fn UrlCacheGetContentPaths(
    pppwszdirectories: *mut *mut windows_core::PWSTR,
...
pub unsafe fn UrlCacheGetEntryInfo<P1>(
    happcache: Option<*const core::ffi::c_void>,
    pcwszurl: P1,
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        UrlCacheGetEntryInfo(
            happcache.unwrap_or(core::mem::zeroed()) as _,
            pcwszurl.param().abi(),
            pcacheentryinfo.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn UrlCacheReadEntryStream(
    hurlcachestream: *const core::ffi::c_void,
    ulllocation: u64,
...
pub unsafe fn UrlCacheRetrieveEntryFile<P1>(
    ...
    pcwszurl: P1,
    pcacheentryinfo: *mut URLCACHE_ENTRY_INFO,
    phentryfile: *mut *mut core::ffi::c_void,
) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
pub unsafe fn UrlCacheRetrieveEntryStream<P1>(
    ...
    frandomread: bool,
    pcacheentryinfo: *mut URLCACHE_ENTRY_INFO,
    phentrystream: *mut *mut core::ffi::c_void,
) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn UrlCacheUpdateEntryExtraData<P1>(
    happcache: Option<*const core::ffi::c_void>,
    pcwszurl: P1,
    pbextradata: &[u8],
) -> u32
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        UrlCacheUpdateEntryExtraData(
            happcache.unwrap_or(core::mem::zeroed()) as _,
            pcwszurl.param().abi(),
            core::mem::transmute(pbextradata.as_ptr()),
            pbextradata.len().try_into().unwrap(),
        )
    }
}
...
windows_core::imp::define_interface!(
    IDialBranding,
    IDialBranding_Vtbl,
    0x8aecafa9_4306_43cc_8c5a_765f2979cc16
);
...
impl IDialBranding {
    ...
    pub unsafe fn GetBitmap(
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(self).GetBitmap)(
                windows_core::Interface::as_raw(self),
                dwindex,
                &mut result__,
            )
...
pub struct IDialBranding_Vtbl {
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub GetBitmap: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
...
pub trait IDialBranding_Impl: windows_core::IUnknownImpl {
    ...
    fn GetBitmap(&self, dwindex: u32)
        -> windows_core::Result<super::super::Graphics::Gdi::HBITMAP>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
impl IDialBranding_Vtbl {
    pub const fn new<Identity: IDialBranding_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Initialize<Identity: IDialBranding_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwzconnectoid: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetBitmap<Identity: IDialBranding_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwindex: u32,
...
windows_core::imp::define_interface!(
    IDialEngine,
    IDialEngine_Vtbl,
    0x39fd782b_7905_40d5_9148_3c9b190423d5
);
...
impl IDialEngine {
    ...
    pub unsafe fn GetProperty<P0, P1>(
        &self,
        pwzproperty: P0,
        pwzvalue: P1,
        dwbufsize: u32,
    ...
    pub unsafe fn SetProperty<P0, P1>(
        &self,
        pwzproperty: P0,
        pwzvalue: P1,
    ) -> windows_core::Result<()>
    ...
    pub unsafe fn HangUp(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).HangUp)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn GetConnectedState(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetConnectedState)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetConnectHandle(&self) -> windows_core::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetConnectHandle)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IDialEngine_Vtbl {
    ...
    pub GetConnectedState:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetConnectHandle:
...
pub trait IDialEngine_Impl: windows_core::IUnknownImpl {
    fn Initialize(
        &self,
        pwzconnectoid: &windows_core::PCWSTR,
        pides: windows_core::Ref<'_, IDialEventSink>,
    ) -> windows_core::Result<()>;
    fn GetProperty(
        &self,
        pwzproperty: &windows_core::PCWSTR,
        pwzvalue: &windows_core::PCWSTR,
        dwbufsize: u32,
    ) -> windows_core::Result<()>;
    fn SetProperty(
        &self,
...
impl IDialEngine_Vtbl {
    pub const fn new<Identity: IDialEngine_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Initialize<Identity: IDialEngine_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwzconnectoid: windows_core::PCWSTR,
            pides: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDialEngine_Impl::Initialize(
                    this,
                    core::mem::transmute(&pwzconnectoid),
                    core::mem::transmute_copy(&pides),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetProperty<Identity: IDialEngine_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwzproperty: windows_core::PCWSTR,
            pwzvalue: windows_core::PCWSTR,
            dwbufsize: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDialEngine_Impl::GetProperty(
                    this,
                    core::mem::transmute(&pwzproperty),
                    core::mem::transmute(&pwzvalue),
                    core::mem::transmute_copy(&dwbufsize),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetProperty<Identity: IDialEngine_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwzproperty: windows_core::PCWSTR,
            pwzvalue: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Dial<Identity: IDialEngine_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn HangUp<Identity: IDialEngine_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetConnectedState<
        ...
        unsafe extern "system" fn GetConnectHandle<
            Identity: IDialEngine_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IDialEventSink,
    IDialEventSink_Vtbl,
    0x2d86f4ff_6e2d_4488_b2e9_6934afd41bea
);
...
impl IDialEventSink_Vtbl {
    pub const fn new<Identity: IDialEventSink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnEvent<Identity: IDialEventSink_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwevent: u32,
            dwstatus: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDialEventSink_Impl::OnEvent(
                    this,
                    core::mem::transmute_copy(&dwevent),
...
windows_core::imp::define_interface!(
    ...
    0xcdaece56_4edf_43df_b113_88e4556fa1bb
);
...
impl IProofOfPossessionCookieInfoManager {
    pub unsafe fn GetCookieInfoForUri<P0>(
        &self,
        uri: P0,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetCookieInfoForUri)(
                windows_core::Interface::as_raw(self),
                uri.param().abi(),
                cookieinfocount as _,
                cookieinfo as _,
            )
            .ok()
        }
...
pub struct IProofOfPossessionCookieInfoManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetCookieInfoForUri: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut u32,
        *mut *mut ProofOfPossessionCookieInfo,
    ) -> windows_core::HRESULT,
}
...
impl IProofOfPossessionCookieInfoManager_Vtbl {
    pub const fn new<Identity: IProofOfPossessionCookieInfoManager_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn GetCookieInfoForUri<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IProofOfPossessionCookieInfoManager_Impl::GetCookieInfoForUri(
                    this,
                    core::mem::transmute(&uri),
                    core::mem::transmute_copy(&cookieinfocount),
                    core::mem::transmute_copy(&cookieinfo),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetCookieInfoForUri: GetCookieInfoForUri::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x15e41407_b42f_4ae7_9966_34a087b2d713
);
windows_core::imp::interface_hierarchy!(
    IProofOfPossessionCookieInfoManager2,
    windows_core::IUnknown
...
impl IProofOfPossessionCookieInfoManager2 {
    pub unsafe fn GetCookieInfoWithUriForAccount<P0, P1>(
        &self,
        webaccount: P0,
        uri: P1,
        cookieinfocount: *mut u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetCookieInfoWithUriForAccount)(
                windows_core::Interface::as_raw(self),
...
pub struct IProofOfPossessionCookieInfoManager2_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetCookieInfoWithUriForAccount: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut u32,
...
impl IProofOfPossessionCookieInfoManager2_Vtbl {
    pub const fn new<Identity: IProofOfPossessionCookieInfoManager2_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn GetCookieInfoWithUriForAccount<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IProofOfPossessionCookieInfoManager2_Impl::GetCookieInfoWithUriForAccount(
                    this,
...
pub const ProofOfPossessionCookieInfoManager: windows_core::GUID =
    windows_core::GUID::from_u128(0xa9927f85_a304_4390_8b23_a75f1c668600);
...
pub type pfnInternetDeInitializeAutoProxyDll = Option<
    unsafe extern "system" fn(lpszmime: windows_core::PCSTR, dwreserved: u32) -> windows_core::BOOL,
>;
pub type pfnInternetGetProxyInfo = Option<
    unsafe extern "system" fn(
        lpszurl: windows_core::PCSTR,
        dwurllength: u32,
        lpszurlhostname: windows_core::PCSTR,
        dwurlhostnamelength: u32,
        lplpszproxyhostname: *mut windows_core::PSTR,
...
pub type pfnInternetInitializeAutoProxyDll = Option<
    unsafe extern "system" fn(
        dwversion: u32,
        lpszdownloadedtempfile: windows_core::PCSTR,
        lpszmime: windows_core::PCSTR,

...
pub unsafe fn ApplyGuestMemoryFix(
    vmsavedstatedumphandle: *mut core::ffi::c_void,
    vpid: u32,
    virtualaddress: u64,
    fixbuffer: *const core::ffi::c_void,
    fixbuffersize: u32,
) -> windows_core::Result<()> {
...
pub unsafe fn CallStackUnwind(
    ...
    imageinfocount: u32,
    framecount: u32,
    callstack: *mut windows_core::PWSTR,
) -> windows_core::Result<()> {
...
pub unsafe fn ForceActiveVirtualTrustLevel(
    ...
    unsafe {
        ForceActiveVirtualTrustLevel(vmsavedstatedumphandle as _, vpid, virtualtrustlevel).ok()
    }
}
#[inline]
...
pub unsafe fn ForceNestedHostMode(
    ...
    vpid: u32,
    hostmode: bool,
    oldmode: Option<*mut windows_core::BOOL>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        ForceNestedHostMode(
            ...
            vpid,
            hostmode.into(),
            oldmode.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn GetActiveVirtualTrustLevel(
    ...
    unsafe {
        GetActiveVirtualTrustLevel(vmsavedstatedumphandle as _, vpid, virtualtrustlevel as _).ok()
    }
}
#[inline]
...
pub unsafe fn GetEnabledVirtualTrustLevels(
    ...
    unsafe {
        GetEnabledVirtualTrustLevels(vmsavedstatedumphandle as _, vpid, virtualtrustlevels as _)
            .ok()
    }
}
#[inline]
pub unsafe fn GetGuestEnabledVirtualTrustLevels(
    ...
    unsafe {
        GetGuestEnabledVirtualTrustLevels(vmsavedstatedumphandle as _, virtualtrustlevels as _).ok()
    }
}
#[inline]
...
pub unsafe fn GetGuestPhysicalMemoryChunks(
    ...
    unsafe {
        GetGuestPhysicalMemoryChunks(
            vmsavedstatedumphandle as _,
            memorychunkpagesize as _,
            memorychunks as _,
            memorychunkcount as _,
        )
        .ok()
    }
}
...
pub unsafe fn GetGuestRawSavedMemorySize(
    ...
    unsafe {
        GetGuestRawSavedMemorySize(vmsavedstatedumphandle as _, guestrawsavedmemorysize as _).ok()
    }
}
#[inline]
pub unsafe fn GetMemoryBlockCacheLimit(
    ...
    unsafe {
        GetMemoryBlockCacheLimit(vmsavedstatedumphandle as _, memoryblockcachelimit as _).ok()
    }
}
#[inline]
...
#[inline]
pub unsafe fn GetSavedStateSymbolFieldInfo<P2>(
    vmsavedstatedumphandle: *mut core::ffi::c_void,
    vpid: u32,
    typename: P2,
    typefieldinfomap: *mut windows_core::PWSTR,
) -> windows_core::Result<()>
where
    P2: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn GetSavedStateSymbolTypeSize<P2>(
    vmsavedstatedumphandle: *mut core::ffi::c_void,
    vpid: u32,
    typename: P2,
    size: *mut u32,
...
pub unsafe fn GuestVirtualAddressToPhysicalAddress(
    ...
    unmappedregionsize: Option<*mut u64>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        GuestVirtualAddressToPhysicalAddress(
            ...
            unmappedregionsize.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn HdvCreateDeviceInstance(
    devicehosthandle: *const core::ffi::c_void,
    devicetype: HDV_DEVICE_TYPE,
    deviceclassid: *const windows_core::GUID,
    deviceinstanceid: *const windows_core::GUID,
    deviceinterface: *const core::ffi::c_void,
    devicecontext: Option<*const core::ffi::c_void>,
    devicehandle: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn HdvCreateGuestMemoryAperture(
    ...
    bytecount: u32,
    writeprotected: bool,
    mappedaddress: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn HdvDestroyGuestMemoryAperture(
    requestor: *const core::ffi::c_void,
    mappedaddress: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn HdvInitializeDeviceHost(
    ...
    devicehosthandle: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn InKernelSpace(
    vmsavedstatedumphandle: *mut core::ffi::c_void,
    vpid: u32,
    inkernelspace: *mut windows_core::BOOL,
) -> windows_core::Result<()> {
...
pub unsafe fn IsActiveVirtualTrustLevelEnabled(
    vmsavedstatedumphandle: *mut core::ffi::c_void,
    vpid: u32,
    activevirtualtrustlevelenabled: *mut windows_core::BOOL,
) -> windows_core::Result<()> {
    ...
    unsafe {
        IsActiveVirtualTrustLevelEnabled(
            vmsavedstatedumphandle as _,
            vpid,
            activevirtualtrustlevelenabled as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn LoadSavedStateFile<P0>(
    vmrsfile: P0,
    vmsavedstatedumphandle: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn LoadSavedStateModuleSymbols<P1, P2>(
    vmsavedstatedumphandle: *mut core::ffi::c_void,
    imagename: P1,
    modulename: P2,
    baseaddress: u64,
...
#[inline]
pub unsafe fn LoadSavedStateModuleSymbolsEx<P1, P3>(
    vmsavedstatedumphandle: *mut core::ffi::c_void,
    imagename: P1,
    imagetimestamp: u32,
    modulename: P3,
...
#[inline]
pub unsafe fn LoadSavedStateSymbolProvider<P1>(
    vmsavedstatedumphandle: *mut core::ffi::c_void,
    usersymbols: P1,
    force: bool,
) -> windows_core::Result<()>
...
pub unsafe fn LocateSavedStateFiles<P0, P1>(
    vmname: P0,
    snapshotname: P1,
    binpath: *mut windows_core::PWSTR,
    vsvpath: *mut windows_core::PWSTR,
    vmrspath: *mut windows_core::PWSTR,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn ReadSavedStateGlobalVariable<P2>(
    vmsavedstatedumphandle: *mut core::ffi::c_void,
    vpid: u32,
    globalname: P2,
    buffer: *mut core::ffi::c_void,
...
#[inline]
pub unsafe fn ResolveSavedStateGlobalVariableAddress<P2>(
    vmsavedstatedumphandle: *mut core::ffi::c_void,
    vpid: u32,
    globalname: P2,
...
pub unsafe fn SetSavedStateSymbolProviderDebugInfoCallback(
    ...
    unsafe {
        SetSavedStateSymbolProviderDebugInfoCallback(vmsavedstatedumphandle as _, callback).ok()
    }
}
#[inline]
pub unsafe fn WHvAcceptPartitionMigration(
    migrationhandle: super::super::Foundation::HANDLE,
) -> windows_core::Result<WHV_PARTITION_HANDLE> {
...
pub unsafe fn WHvAdviseGpaRange(
    ...
    advicebuffer: *const core::ffi::c_void,
    ...
    unsafe {
        WHvAdviseGpaRange(
            partition,
            core::mem::transmute(gparanges.as_ptr()),
            gparanges.len().try_into().unwrap(),
            advice,
            advicebuffer,
...
pub unsafe fn WHvAllocateVpciResource(
    providerid: Option<*const windows_core::GUID>,
    flags: WHV_ALLOCATE_VPCI_RESOURCE_FLAGS,
    resourcedescriptor: Option<&[u8]>,
    ...
    unsafe {
        ...
        WHvAllocateVpciResource(
            providerid.unwrap_or(core::mem::zeroed()) as _,
            flags,
            core::mem::transmute(
                resourcedescriptor
                    .as_deref()
...
pub unsafe fn WHvCreateNotificationPort(
    ...
    porthandle: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn WHvCreateTrigger(
    ...
    triggerhandle: *mut *mut core::ffi::c_void,
...
pub unsafe fn WHvCreateVirtualProcessor2(
    ...
    unsafe {
        WHvCreateVirtualProcessor2(
            partition,
            vpindex,
            core::mem::transmute(properties.as_ptr()),
...
pub unsafe fn WHvCreateVpciDevice(
    ...
    notificationeventhandle: Option<super::super::Foundation::HANDLE>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WHvCreateVpciDevice(
            ...
            vpciresource,
            flags,
            notificationeventhandle.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WHvDeleteNotificationPort(
    partition: WHV_PARTITION_HANDLE,
    porthandle: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn WHvDeleteTrigger(
    partition: WHV_PARTITION_HANDLE,
    triggerhandle: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn WHvEmulatorCreateEmulator(
    ...
    emulator: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn WHvEmulatorDestroyEmulator(
    emulator: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
) -> windows_core::Result<WHV_EMULATOR_STATUS> {
...
pub unsafe fn WHvGetCapability(
    ...
    capabilitybuffer: *mut core::ffi::c_void,
    ...
    unsafe {
        WHvGetCapability(
            capabilitycode,
            capabilitybuffer as _,
            capabilitybuffersizeinbytes,
            writtensizeinbytes.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WHvGetInterruptTargetVpSet(
    ...
    unsafe {
        WHvGetInterruptTargetVpSet(
            ...
            destination,
            destinationmode,
            core::mem::transmute(targetvps.as_ptr()),
            targetvps.len().try_into().unwrap(),
            targetvpcount as _,
        )
        .ok()
    }
...
pub unsafe fn WHvGetPartitionProperty(
    ...
    propertybuffer: *mut core::ffi::c_void,
...
pub unsafe fn WHvGetVirtualProcessorCpuidOutput(
    ...
    eax: u32,
    ecx: u32,
) -> windows_core::Result<WHV_CPUID_OUTPUT> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        WHvGetVirtualProcessorCpuidOutput(partition, vpindex, eax, ecx, &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn WHvGetVirtualProcessorInterruptControllerState(
    ...
    unsafe {
        WHvGetVirtualProcessorInterruptControllerState(
            ...
            state as _,
            statesize,
            writtensize.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WHvMapGpaRange(
    partition: WHV_PARTITION_HANDLE,
    sourceaddress: *const core::ffi::c_void,
    guestaddress: u64,
    sizeinbytes: u64,
...
pub unsafe fn WHvMapVpciDeviceMmioRanges(
    ...
    unsafe {
        WHvMapVpciDeviceMmioRanges(partition, logicaldeviceid, mappingcount as _, mappings as _)
            .ok()
    }
}
#[inline]
...
pub unsafe fn WHvQueryGpaRangeDirtyBitmap(
    ...
    unsafe {
        WHvQueryGpaRangeDirtyBitmap(
            ...
            guestaddress,
            rangesizeinbytes,
            bitmap.unwrap_or(core::mem::zeroed()) as _,
            bitmapsizeinbytes,
        )
        .ok()
    }
...
pub unsafe fn WHvRetargetVpciDeviceInterrupt(
    ...
    unsafe {
        WHvRetargetVpciDeviceInterrupt(partition, logicaldeviceid, msiaddress, msidata, target).ok()
    }
}
#[inline]
pub unsafe fn WHvRunVirtualProcessor(
    partition: WHV_PARTITION_HANDLE,
    vpindex: u32,
    exitcontext: *mut core::ffi::c_void,
    ...
    unsafe {
        WHvRunVirtualProcessor(partition, vpindex, exitcontext as _, exitcontextsizeinbytes).ok()
    }
}
#[inline]
pub unsafe fn WHvSetNotificationPortProperty(
    ...
    unsafe {
        WHvSetNotificationPortProperty(partition, porthandle, propertycode, propertyvalue).ok()
    }
}
#[inline]
...
pub unsafe fn WHvSetVirtualProcessorInterruptControllerState(
    ...
    unsafe {
        WHvSetVirtualProcessorInterruptControllerState(partition, vpindex, state, statesize).ok()
    }
}
#[inline]
pub unsafe fn WHvSetVirtualProcessorInterruptControllerState2(
    ...
    unsafe {
        WHvSetVirtualProcessorInterruptControllerState2(partition, vpindex, state, statesize).ok()
    }
}
#[inline]
...
pub unsafe fn WHvSetVirtualProcessorState(
    ...
    unsafe {
        WHvSetVirtualProcessorState(partition, vpindex, statetype, buffer, buffersizeinbytes).ok()
    }
}
#[inline]
...
pub unsafe fn WHvSetVpciDevicePowerState(
    partition: WHV_PARTITION_HANDLE,
    logicaldeviceid: u64,
    powerstate: super::Power::DEVICE_POWER_STATE,
) -> windows_core::Result<()> {
...
pub unsafe fn WHvSignalVirtualProcessorSynicEvent(
    ...
    newlysignaled: Option<*mut windows_core::BOOL>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WHvSignalVirtualProcessorSynicEvent(
            partition,
            core::mem::transmute(synicevent),
            newlysignaled.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub type FOUND_IMAGE_CALLBACK = Option<
...
pub type GUEST_SYMBOLS_PROVIDER_DEBUG_INFO_CALLBACK =
    Option<unsafe extern "system" fn(infomessage: windows_core::PCSTR)>;
pub const GUID_DEVINTERFACE_VM_GENCOUNTER: windows_core::GUID =
    windows_core::GUID::from_u128(0x3ff2c92b_6598_4e60_8e1c_0ccf4927e319);
...
pub type HDV_PCI_DEVICE_INITIALIZE = Option<
    unsafe extern "system" fn(devicecontext: *const core::ffi::c_void) -> windows_core::HRESULT,
>;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub type HDV_PCI_DEVICE_SET_CONFIGURATION = Option<
    unsafe extern "system" fn(
        devicecontext: *const core::ffi::c_void,
        configurationvaluecount: u32,
        configurationvalues: *const windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
>;
pub type HDV_PCI_DEVICE_START = Option<
    unsafe extern "system" fn(devicecontext: *const core::ffi::c_void) -> windows_core::HRESULT,
>;
pub type HDV_PCI_DEVICE_STOP =
    Option<unsafe extern "system" fn(devicecontext: *const core::ffi::c_void)>;
...
pub const HV_GUID_BROADCAST: windows_core::GUID =
    windows_core::GUID::from_u128(0xffffffff_ffff_ffff_ffff_ffffffffffff);
pub const HV_GUID_CHILDREN: windows_core::GUID =
    windows_core::GUID::from_u128(0x90db8b89_0d35_4f79_8ce9_49ea0ac8b7cd);
pub const HV_GUID_LOOPBACK: windows_core::GUID =
    windows_core::GUID::from_u128(0xe0e16197_dd56_4a10_9195_5ee7a155a838);
pub const HV_GUID_PARENT: windows_core::GUID =
    windows_core::GUID::from_u128(0xa42e7cda_d03f_480c_9cc2_a4de20abb878);
pub const HV_GUID_SILOHOST: windows_core::GUID =
    windows_core::GUID::from_u128(0x36bd0c5c_7276_4223_88ba_7d03b654c568);
pub const HV_GUID_VSOCK_TEMPLATE: windows_core::GUID =
    windows_core::GUID::from_u128(0x00000000_facb_11e6_bd58_64006a7986d3);
pub const HV_GUID_ZERO: windows_core::GUID =
    windows_core::GUID::from_u128(0x00000000_0000_0000_0000_000000000000);
pub const HV_PROTOCOL_RAW: u32 = 1u32;
pub const HdvDeviceHostFlagInitializeComSecurity: HDV_DEVICE_HOST_FLAGS =
    HDV_DEVICE_HOST_FLAGS(1i32);
...
pub const VM_GENCOUNTER_SYMBOLIC_LINK_NAME: windows_core::PCWSTR =
    windows_core::w!("\\VmGenerationCounter");
#[repr(C)]
#[derive(Clone, Copy)]
...
pub type WHV_EMULATOR_GET_VIRTUAL_PROCESSOR_REGISTERS_CALLBACK = Option<
    unsafe extern "system" fn(
        context: *const core::ffi::c_void,
        registernames: *const WHV_REGISTER_NAME,
        registercount: u32,
...
pub type WHV_EMULATOR_IO_PORT_CALLBACK = Option<
    unsafe extern "system" fn(
        context: *const core::ffi::c_void,
...
pub type WHV_EMULATOR_MEMORY_CALLBACK = Option<
    unsafe extern "system" fn(
        context: *const core::ffi::c_void,
        memoryaccess: *mut WHV_EMULATOR_MEMORY_ACCESS_INFO,
    ) -> windows_core::HRESULT,
>;
pub type WHV_EMULATOR_SET_VIRTUAL_PROCESSOR_REGISTERS_CALLBACK = Option<
    unsafe extern "system" fn(
        context: *const core::ffi::c_void,
        registernames: *const WHV_REGISTER_NAME,
        registercount: u32,
...
pub type WHV_EMULATOR_TRANSLATE_GVA_PAGE_CALLBACK = Option<
    unsafe extern "system" fn(
        context: *const core::ffi::c_void,
        gva: u64,
        translateflags: WHV_TRANSLATE_GVA_FLAGS,
...
pub const WHvAllocateVpciResourceFlagAllowDirectP2P: WHV_ALLOCATE_VPCI_RESOURCE_FLAGS =
    WHV_ALLOCATE_VPCI_RESOURCE_FLAGS(1i32);
pub const WHvAllocateVpciResourceFlagNone: WHV_ALLOCATE_VPCI_RESOURCE_FLAGS =
    WHV_ALLOCATE_VPCI_RESOURCE_FLAGS(0i32);

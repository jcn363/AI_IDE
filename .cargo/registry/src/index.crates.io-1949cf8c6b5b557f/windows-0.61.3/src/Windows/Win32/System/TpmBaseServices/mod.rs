...
pub unsafe fn GetDeviceID(
    pbwindowsaik: Option<&mut [u8]>,
    pcbresult: *mut u32,
    pfprotectedbytpm: Option<*mut windows_core::BOOL>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        GetDeviceID(
            ...
            pcbresult as _,
            pfprotectedbytpm.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn Tbsi_Context_Create(
    ...
    windows_link::link!("tbs.dll" "system" fn Tbsi_Context_Create(pcontextparams : *const TBS_CONTEXT_PARAMS, phcontext : *mut *mut core::ffi::c_void) -> u32);
    unsafe { Tbsi_Context_Create(pcontextparams, phcontext as _) }
}
#[inline]
pub unsafe fn Tbsi_Create_Windows_Key(keyhandle: u32) -> u32 {
    windows_link::link!("tbs.dll" "system" fn Tbsi_Create_Windows_Key(keyhandle : u32) -> u32);
    unsafe { Tbsi_Create_Windows_Key(keyhandle) }
}
#[inline]
pub unsafe fn Tbsi_GetDeviceInfo(size: u32, info: *mut core::ffi::c_void) -> u32 {
    windows_link::link!("tbs.dll" "system" fn Tbsi_GetDeviceInfo(size : u32, info : *mut core::ffi::c_void) -> u32);
...
pub unsafe fn Tbsi_Get_OwnerAuth(
    ...
    ownerauthtype: u32,
    poutputbuf: Option<*mut u8>,
    poutputbuflen: *mut u32,
) -> u32 {
    windows_link::link!("tbs.dll" "system" fn Tbsi_Get_OwnerAuth(hcontext : *const core::ffi::c_void, ownerauthtype : u32, poutputbuf : *mut u8, poutputbuflen : *mut u32) -> u32);
    unsafe {
        Tbsi_Get_OwnerAuth(
            hcontext,
            ownerauthtype,
            poutputbuf.unwrap_or(core::mem::zeroed()) as _,
            poutputbuflen as _,
        )
    }
}
...
pub unsafe fn Tbsi_Get_TCG_Log(
    ...
    windows_link::link!("tbs.dll" "system" fn Tbsi_Get_TCG_Log(hcontext : *const core::ffi::c_void, poutputbuf : *mut u8, poutputbuflen : *mut u32) -> u32);
    unsafe {
        Tbsi_Get_TCG_Log(
            hcontext,
            poutputbuf.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn Tbsi_Get_TCG_Log_Ex(
    logtype: u32,
    pboutput: Option<*mut u8>,
    pcboutput: *mut u32,
) -> u32 {
    windows_link::link!("tbs.dll" "system" fn Tbsi_Get_TCG_Log_Ex(logtype : u32, pboutput : *mut u8, pcboutput : *mut u32) -> u32);
    unsafe {
        Tbsi_Get_TCG_Log_Ex(
            logtype,
            pboutput.unwrap_or(core::mem::zeroed()) as _,
            pcboutput as _,
        )
    }
}
...
pub unsafe fn Tbsi_Is_Tpm_Present() -> windows_core::BOOL {
    windows_link::link!("tbs.dll" "system" fn Tbsi_Is_Tpm_Present() -> windows_core::BOOL);
...
pub unsafe fn Tbsi_Physical_Presence_Command(
    ...
    unsafe {
        Tbsi_Physical_Presence_Command(
            hcontext,
            core::mem::transmute(pabinput.as_ptr()),
            pabinput.len().try_into().unwrap(),
            paboutput as _,
            pcboutput as _,
        )
    }
...
pub unsafe fn Tbsip_Submit_Command(
    ...
    unsafe {
        Tbsip_Submit_Command(
            ...
            locality,
            priority,
            core::mem::transmute(pabcommand.as_ptr()),
            pabcommand.len().try_into().unwrap(),
            pabresult as _,
            pcbresult as _,
        )
    }

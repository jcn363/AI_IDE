#[inline]
pub unsafe fn CreateDeviceAccessInstance<P0>(
    deviceinterfacepath: P0,
    desiredaccess: u32,
) -> windows_core::Result<ICreateDeviceAccessAsync>
where
...
pub const CLSID_DeviceIoControl: windows_core::GUID =
    windows_core::GUID::from_u128(0x12d3e372_874b_457d_9fdf_73977778686c);
...
windows_core::imp::define_interface!(
    ...
    0x3474628f_683d_42d2_abcb_db018c6503bc
);
...
pub trait ICreateDeviceAccessAsync_Impl: windows_core::IUnknownImpl {
    ...
    fn GetResult(
        ...
        deviceaccess: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
}
    ...
    pub const fn new<Identity: ICreateDeviceAccessAsync_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICreateDeviceAccessAsync_Impl::Wait(this, core::mem::transmute_copy(&timeout))
                    .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICreateDeviceAccessAsync_Impl::GetResult(
                    this,
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&deviceaccess),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x9eefe161_23ab_4f18_9b49_991b586ae970
);
...
impl IDeviceIoControl {
    pub unsafe fn DeviceIoControlSync(
        &self,
        iocontrolcode: u32,
        inputbuffer: Option<&[u8]>,
        outputbuffer: Option<&mut [u8]>,
        bytesreturned: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeviceIoControlSync)(
                windows_core::Interface::as_raw(self),
                iocontrolcode,
                core::mem::transmute(
                    inputbuffer
    ...
    pub unsafe fn DeviceIoControlAsync<P5>(
        &self,
        iocontrolcode: u32,
        inputbuffer: Option<&[u8]>,
        outputbuffer: Option<&mut [u8]>,
        requestcompletioncallback: P5,
        cancelcontext: Option<*mut usize>,
    ) -> windows_core::Result<()>
    where
    ...
    pub unsafe fn CancelOperation(&self, cancelcontext: usize) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CancelOperation)(
                windows_core::Interface::as_raw(self),
                cancelcontext,
            )
            .ok()
...
pub struct IDeviceIoControl_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub DeviceIoControlSync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        u32,
    ...
    pub DeviceIoControlAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        u32,
...
pub trait IDeviceIoControl_Impl: windows_core::IUnknownImpl {
    ...
    fn DeviceIoControlAsync(
        ...
        outputbuffer: *mut u8,
        outputbuffersize: u32,
        requestcompletioncallback: windows_core::Ref<'_, IDeviceRequestCompletionCallback>,
...
impl IDeviceIoControl_Vtbl {
    pub const fn new<Identity: IDeviceIoControl_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DeviceIoControlSync<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDeviceIoControl_Impl::DeviceIoControlSync(
                    this,
                    core::mem::transmute_copy(&iocontrolcode),
                    core::mem::transmute_copy(&inputbuffer),
                    core::mem::transmute_copy(&inputbuffersize),
        ...
        unsafe extern "system" fn DeviceIoControlAsync<
            Identity: IDeviceIoControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            outputbuffer: *mut u8,
            outputbuffersize: u32,
            requestcompletioncallback: *mut core::ffi::c_void,
            cancelcontext: *mut usize,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDeviceIoControl_Impl::DeviceIoControlAsync(
                    this,
                    core::mem::transmute_copy(&iocontrolcode),
                    core::mem::transmute_copy(&inputbuffer),
                    core::mem::transmute_copy(&inputbuffersize),
                    core::mem::transmute_copy(&outputbuffer),
                    core::mem::transmute_copy(&outputbuffersize),
                    core::mem::transmute_copy(&requestcompletioncallback),
                    core::mem::transmute_copy(&cancelcontext),
                )
                .into()
            }
        }
        unsafe extern "system" fn CancelOperation<
            Identity: IDeviceIoControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDeviceIoControl_Impl::CancelOperation(
                    this,
                    core::mem::transmute_copy(&cancelcontext),
                )
                .into()
...
impl IDeviceRequestCompletionCallback {
    pub unsafe fn Invoke(
        &self,
        requestresult: windows_core::HRESULT,
        bytesreturned: u32,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub const fn new<Identity: IDeviceRequestCompletionCallback_Impl, const OFFSET: isize>() -> Self
    {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDeviceRequestCompletionCallback_Impl::Invoke(
                    this,
                    core::mem::transmute_copy(&requestresult),
                    core::mem::transmute_copy(&bytesreturned),
                )
                .into()
            }

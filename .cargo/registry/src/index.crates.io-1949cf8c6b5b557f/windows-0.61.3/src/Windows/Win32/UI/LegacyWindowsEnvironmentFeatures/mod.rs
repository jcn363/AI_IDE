...
windows_core::imp::define_interface!(
    IADesktopP2,
    IADesktopP2_Vtbl,
    0xb22754e2_4574_11d1_9888_006097deacf9
);
...
impl IADesktopP2 {
    pub unsafe fn ReReadWallpaper(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ReReadWallpaper)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    }
    pub unsafe fn GetADObjectFlags(
        &self,
        pdwflags: *mut u32,
        dwmask: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetADObjectFlags)(
                windows_core::Interface::as_raw(self),
                pdwflags as _,
                dwmask,
            )
    ...
    pub unsafe fn UpdateAllDesktopSubscriptions(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).UpdateAllDesktopSubscriptions)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).MakeDynamicChanges)(
                windows_core::Interface::as_raw(self),
                poleobj.param().abi(),
            )
            .ok()
...
pub struct IADesktopP2_Vtbl {
    ...
    pub GetADObjectFlags:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32, u32) -> windows_core::HRESULT,
    pub UpdateAllDesktopSubscriptions:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Ole")]
    pub MakeDynamicChanges: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
pub trait IADesktopP2_Impl: windows_core::IUnknownImpl {
    ...
    fn MakeDynamicChanges(
        &self,
        poleobj: windows_core::Ref<'_, super::super::System::Ole::IOleObject>,
    ) -> windows_core::Result<()>;
}
#[cfg(feature = "Win32_System_Ole")]
impl IADesktopP2_Vtbl {
    pub const fn new<Identity: IADesktopP2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ReReadWallpaper<
        ...
        unsafe extern "system" fn GetADObjectFlags<
            Identity: IADesktopP2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IADesktopP2_Impl::GetADObjectFlags(
                    this,
        ...
        unsafe extern "system" fn UpdateAllDesktopSubscriptions<
            Identity: IADesktopP2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn MakeDynamicChanges<
            Identity: IADesktopP2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            poleobj: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IADesktopP2_Impl::MakeDynamicChanges(this, core::mem::transmute_copy(&poleobj))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0x52502ee0_ec80_11d0_89ab_00c04fc2972d
);
...
impl IActiveDesktopP {
    pub unsafe fn SetSafeMode(&self, dwflags: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSafeMode)(
                windows_core::Interface::as_raw(self),
                dwflags,
            )
            .ok()
    ...
    pub unsafe fn EnsureUpdateHTML(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EnsureUpdateHTML)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetScheme)(
                windows_core::Interface::as_raw(self),
                pwszschemename.param().abi(),
                dwflags,
            )
            .ok()
        }
    }
    pub unsafe fn GetScheme(
        &self,
        pwszschemename: windows_core::PWSTR,
        pdwcchbuffer: *mut u32,
        dwflags: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetScheme)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pwszschemename),
                pdwcchbuffer as _,
                dwflags,
            )
            .ok()
...
pub struct IActiveDesktopP_Vtbl {
    ...
    pub GetScheme: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PWSTR,
        *mut u32,
        u32,
...
pub trait IActiveDesktopP_Impl: windows_core::IUnknownImpl {
    ...
    fn SetScheme(
        &self,
        pwszschemename: &windows_core::PCWSTR,
        dwflags: u32,
    ) -> windows_core::Result<()>;
    fn GetScheme(
        &self,
...
impl IActiveDesktopP_Vtbl {
    pub const fn new<Identity: IActiveDesktopP_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetSafeMode<
        ...
        unsafe extern "system" fn EnsureUpdateHTML<
            Identity: IActiveDesktopP_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetScheme<Identity: IActiveDesktopP_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwszschemename: windows_core::PCWSTR,
            dwflags: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IActiveDesktopP_Impl::SetScheme(
                    this,
                    core::mem::transmute(&pwszschemename),
        ...
        unsafe extern "system" fn GetScheme<Identity: IActiveDesktopP_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwszschemename: windows_core::PWSTR,
            pdwcchbuffer: *mut u32,
            dwflags: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IActiveDesktopP_Impl::GetScheme(
                    this,
                    core::mem::transmute_copy(&pwszschemename),
                    core::mem::transmute_copy(&pdwcchbuffer),
                    core::mem::transmute_copy(&dwflags),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0x99180164_da16_101a_935c_444553540000
);
...
impl IBriefcaseInitiator {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).IsMonikerInBriefcase)(
                windows_core::Interface::as_raw(self),
                pmk.param().abi(),
            )
            .ok()
...
pub struct IBriefcaseInitiator_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_System_Com")]
    pub IsMonikerInBriefcase: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl IBriefcaseInitiator_Vtbl {
    pub const fn new<Identity: IBriefcaseInitiator_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsMonikerInBriefcase<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IBriefcaseInitiator_Impl::IsMonikerInBriefcase(
                    this,
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            IsMonikerInBriefcase: IsMonikerInBriefcase::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x8fce5227_04da_11d1_a004_00805f8abe06
);
...
impl IEmptyVolumeCache {
    ...
    pub unsafe fn Initialize<P1>(
        &self,
        hkregkey: super::super::System::Registry::HKEY,
        pcwszvolume: P1,
        ppwszdisplayname: *mut windows_core::PWSTR,
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Initialize)(
                windows_core::Interface::as_raw(self),
                hkregkey,
                pcwszvolume.param().abi(),
                ppwszdisplayname as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetSpaceUsed)(
                windows_core::Interface::as_raw(self),
                pdwlspaceused as _,
                picb.param().abi(),
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Purge)(
                windows_core::Interface::as_raw(self),
                dwlspacetofree,
                picb.param().abi(),
            )
    ...
    pub unsafe fn ShowProperties(
        &self,
        hwnd: super::super::Foundation::HWND,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ShowProperties)(
                windows_core::Interface::as_raw(self),
                hwnd,
            )
            .ok()
...
pub struct IEmptyVolumeCache_Vtbl {
    ...
    pub Initialize: unsafe extern "system" fn(
        ...
        *mut windows_core::PWSTR,
        *mut EMPTY_VOLUME_CACHE_FLAGS,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Registry"))]
    Initialize: usize,
    pub GetSpaceUsed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u64,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Purge: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ShowProperties: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait IEmptyVolumeCache_Impl: windows_core::IUnknownImpl {
    fn Initialize(
        &self,
        hkregkey: super::super::System::Registry::HKEY,
        pcwszvolume: &windows_core::PCWSTR,
        ppwszdisplayname: *mut windows_core::PWSTR,
        ppwszdescription: *mut windows_core::PWSTR,
        pdwflags: *mut EMPTY_VOLUME_CACHE_FLAGS,
    ) -> windows_core::Result<()>;
    fn GetSpaceUsed(
        &self,
        pdwlspaceused: *mut u64,
        picb: windows_core::Ref<'_, IEmptyVolumeCacheCallBack>,
    ) -> windows_core::Result<()>;
    fn Purge(
        &self,
        dwlspacetofree: u64,
    ...
    pub const fn new<Identity: IEmptyVolumeCache_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEmptyVolumeCache_Impl::Initialize(
                    this,
                    core::mem::transmute_copy(&hkregkey),
                    core::mem::transmute(&pcwszvolume),
        ...
        unsafe extern "system" fn GetSpaceUsed<
            Identity: IEmptyVolumeCache_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pdwlspaceused: *mut u64,
            picb: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEmptyVolumeCache_Impl::GetSpaceUsed(
                    this,
                    core::mem::transmute_copy(&pdwlspaceused),
                    core::mem::transmute_copy(&picb),
                )
                .into()
            }
        }
        unsafe extern "system" fn Purge<Identity: IEmptyVolumeCache_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwlspacetofree: u64,
            picb: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEmptyVolumeCache_Impl::Purge(
                    this,
                    core::mem::transmute_copy(&dwlspacetofree),
                    core::mem::transmute_copy(&picb),
                )
                .into()
            }
        }
        unsafe extern "system" fn ShowProperties<
            Identity: IEmptyVolumeCache_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEmptyVolumeCache_Impl::ShowProperties(this, core::mem::transmute_copy(&hwnd))
                    .into()
            }
        }
...
windows_core::imp::define_interface!(
    IEmptyVolumeCache2,
    IEmptyVolumeCache2_Vtbl,
    0x02b7e3ba_4db3_11d2_b2d9_00c04f8eec8c
);
...
impl IEmptyVolumeCache2 {
    #[cfg(feature = "Win32_System_Registry")]
    pub unsafe fn InitializeEx<P1, P2>(
        &self,
        hkregkey: super::super::System::Registry::HKEY,
        pcwszvolume: P1,
        pcwszkeyname: P2,
        ppwszdisplayname: *mut windows_core::PWSTR,
        ppwszdescription: *mut windows_core::PWSTR,
        ppwszbtntext: *mut windows_core::PWSTR,
        pdwflags: *mut EMPTY_VOLUME_CACHE_FLAGS,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
...
pub struct IEmptyVolumeCache2_Vtbl {
    ...
    #[cfg(feature = "Win32_System_Registry")]
    pub InitializeEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::System::Registry::HKEY,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
pub trait IEmptyVolumeCache2_Impl: IEmptyVolumeCache_Impl {
    fn InitializeEx(
        ...
        hkregkey: super::super::System::Registry::HKEY,
        pcwszvolume: &windows_core::PCWSTR,
        pcwszkeyname: &windows_core::PCWSTR,
        ppwszdisplayname: *mut windows_core::PWSTR,
        ppwszdescription: *mut windows_core::PWSTR,
        ppwszbtntext: *mut windows_core::PWSTR,
        pdwflags: *mut EMPTY_VOLUME_CACHE_FLAGS,
...
impl IEmptyVolumeCache2_Vtbl {
    pub const fn new<Identity: IEmptyVolumeCache2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn InitializeEx<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEmptyVolumeCache2_Impl::InitializeEx(
                    this,
                    core::mem::transmute_copy(&hkregkey),
                    core::mem::transmute(&pcwszvolume),
                    core::mem::transmute(&pcwszkeyname),
                    core::mem::transmute_copy(&ppwszdisplayname),
                    core::mem::transmute_copy(&ppwszdescription),
        ...
        Self {
            base__: IEmptyVolumeCache_Vtbl::new::<Identity, OFFSET>(),
...
impl IEmptyVolumeCacheCallBack {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ScanProgress)(
                windows_core::Interface::as_raw(self),
                dwlspaceused,
                dwflags,
                pcwszstatus.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn PurgeProgress<P3>(
        &self,
        dwlspacefreed: u64,
        dwlspacetofree: u64,
        dwflags: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PurgeProgress)(
                windows_core::Interface::as_raw(self),
                dwlspacefreed,
                dwlspacetofree,
                dwflags,
...
pub struct IEmptyVolumeCacheCallBack_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ScanProgress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        u32,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub PurgeProgress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        u64,
        u32,
...
pub trait IEmptyVolumeCacheCallBack_Impl: windows_core::IUnknownImpl {
    fn ScanProgress(
        ...
        dwlspaceused: u64,
        dwflags: u32,
        pcwszstatus: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    fn PurgeProgress(
        &self,
        dwlspacefreed: u64,
...
impl IEmptyVolumeCacheCallBack_Vtbl {
    pub const fn new<Identity: IEmptyVolumeCacheCallBack_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ScanProgress<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEmptyVolumeCacheCallBack_Impl::ScanProgress(
                    this,
                    core::mem::transmute_copy(&dwlspaceused),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute(&pcwszstatus),
                )
                .into()
            }
        }
        unsafe extern "system" fn PurgeProgress<
            Identity: IEmptyVolumeCacheCallBack_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEmptyVolumeCacheCallBack_Impl::PurgeProgress(
                    this,
                    core::mem::transmute_copy(&dwlspacefreed),
                    core::mem::transmute_copy(&dwlspacetofree),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute(&pcwszstatus),
                )
...
windows_core::imp::define_interface!(
    ...
    0x99180162_da16_101a_935c_444553540000
);
windows_core::imp::interface_hierarchy!(IReconcilableObject, windows_core::IUnknown);
impl IReconcilableObject {
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn Reconcile<P0, P7>(
        &self,
        pinitiator: P0,
        dwflags: u32,
        hwndowner: super::super::Foundation::HWND,
        hwndprogressfeedback: super::super::Foundation::HWND,
        rgpmkotherinput: &mut [Option<super::super::System::Com::IMoniker>],
        ploutindex: *mut i32,
        pstgnewresidues: P7,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Reconcile)(
                windows_core::Interface::as_raw(self),
                pinitiator.param().abi(),
                dwflags,
                hwndowner,
                hwndprogressfeedback,
                rgpmkotherinput.len().try_into().unwrap(),
                core::mem::transmute(rgpmkotherinput.as_ptr()),
                ploutindex as _,
                pstgnewresidues.param().abi(),
    ...
    pub unsafe fn GetProgressFeedbackMaxEstimate(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetProgressFeedbackMaxEstimate)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IReconcilableObject_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub Reconcile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        super::super::Foundation::HWND,
    ...
    Reconcile: usize,
    pub GetProgressFeedbackMaxEstimate:
...
pub trait IReconcilableObject_Impl: windows_core::IUnknownImpl {
    fn Reconcile(
        &self,
        pinitiator: windows_core::Ref<'_, IReconcileInitiator>,
        dwflags: u32,
        hwndowner: super::super::Foundation::HWND,
        hwndprogressfeedback: super::super::Foundation::HWND,
        ulcinput: u32,
        rgpmkotherinput: *mut Option<super::super::System::Com::IMoniker>,
        ploutindex: *mut i32,
        pstgnewresidues: windows_core::Ref<
            '_,
            super::super::System::Com::StructuredStorage::IStorage,
        >,
...
impl IReconcilableObject_Vtbl {
    pub const fn new<Identity: IReconcilableObject_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Reconcile<
            Identity: IReconcilableObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pinitiator: *mut core::ffi::c_void,
            dwflags: u32,
            hwndowner: super::super::Foundation::HWND,
            hwndprogressfeedback: super::super::Foundation::HWND,
            ulcinput: u32,
            rgpmkotherinput: *mut *mut core::ffi::c_void,
            ploutindex: *mut i32,
            pstgnewresidues: *mut core::ffi::c_void,
            pvreserved: *const core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IReconcilableObject_Impl::Reconcile(
                    this,
                    core::mem::transmute_copy(&pinitiator),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&hwndowner),
                    core::mem::transmute_copy(&hwndprogressfeedback),
                    core::mem::transmute_copy(&ulcinput),
                    core::mem::transmute_copy(&rgpmkotherinput),
                    core::mem::transmute_copy(&ploutindex),
                    core::mem::transmute_copy(&pstgnewresidues),
...
windows_core::imp::define_interface!(
    ...
    0x99180161_da16_101a_935c_444553540000
);
...
impl IReconcileInitiator {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetAbortCallback)(
                windows_core::Interface::as_raw(self),
                punkforabort.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn SetProgressFeedback(
        &self,
        ulprogress: u32,
        ulprogressmax: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetProgressFeedback)(
                windows_core::Interface::as_raw(self),
                ulprogress,
                ulprogressmax,
            )
...
pub struct IReconcileInitiator_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetAbortCallback: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetProgressFeedback:
...
pub trait IReconcileInitiator_Impl: windows_core::IUnknownImpl {
    fn SetAbortCallback(
        &self,
        punkforabort: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
...
impl IReconcileInitiator_Vtbl {
    pub const fn new<Identity: IReconcileInitiator_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetAbortCallback<
            Identity: IReconcileInitiator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            punkforabort: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IReconcileInitiator_Impl::SetAbortCallback(
                    this,
                    core::mem::transmute_copy(&punkforabort),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetProgressFeedback<
            Identity: IReconcileInitiator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IReconcileInitiator_Impl::SetProgressFeedback(
                    this,
...
pub const REC_E_INEEDTODOTHEUPDATES: windows_core::HRESULT =
    windows_core::HRESULT(0x80041004_u32 as _);
...
pub const REC_S_NOTCOMPLETEBUTPROPAGATE: windows_core::HRESULT =
    windows_core::HRESULT(0x41002_u32 as _);

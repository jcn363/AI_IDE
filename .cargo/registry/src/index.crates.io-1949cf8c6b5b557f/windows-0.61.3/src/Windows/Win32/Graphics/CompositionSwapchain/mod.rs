    ...
    T: windows_core::Interface,
{
    ...
    unsafe {
        CreatePresentationFactory(d3ddevice.param().abi(), &T::IID, &mut result__)
...
pub const CompositionFrameInstanceKind_ComposedOnScreen: CompositionFrameInstanceKind =
    CompositionFrameInstanceKind(0i32);
pub const CompositionFrameInstanceKind_ComposedToIntermediate: CompositionFrameInstanceKind =
    CompositionFrameInstanceKind(2i32);
pub const CompositionFrameInstanceKind_ScanoutOnScreen: CompositionFrameInstanceKind =
    CompositionFrameInstanceKind(1i32);
...
windows_core::imp::define_interface!(
    ...
    0x8c93be27_ad94_4da0_8fd4_2413132d124e
);
...
impl IIndependentFlipFramePresentStatistics {
    pub unsafe fn GetOutputAdapterLUID(&self) -> super::super::Foundation::LUID {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).GetOutputAdapterLUID)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            );
            result__
    ...
    pub unsafe fn GetOutputVidPnSourceId(&self) -> u32 {
        unsafe {
            (windows_core::Interface::vtable(self).GetOutputVidPnSourceId)(
                windows_core::Interface::as_raw(self),
            )
        }
    }
    ...
    pub unsafe fn GetDisplayedTime(&self) -> SystemInterruptTime {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDisplayedTime)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            );
            result__
    ...
    pub unsafe fn GetPresentDuration(&self) -> SystemInterruptTime {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPresentDuration)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            );
            result__
...
pub struct IIndependentFlipFramePresentStatistics_Vtbl {
    pub base__: IPresentStatistics_Vtbl,
    pub GetOutputAdapterLUID:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::super::Foundation::LUID),
    pub GetOutputVidPnSourceId: unsafe extern "system" fn(*mut core::ffi::c_void) -> u32,
    pub GetContentTag: unsafe extern "system" fn(*mut core::ffi::c_void) -> usize,
    pub GetDisplayedTime:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut SystemInterruptTime),
    pub GetPresentDuration:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut SystemInterruptTime),
}
...
impl IIndependentFlipFramePresentStatistics_Vtbl {
    pub const fn new<Identity: IIndependentFlipFramePresentStatistics_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn GetOutputAdapterLUID<
        ...
        unsafe extern "system" fn GetOutputVidPnSourceId<
            Identity: IIndependentFlipFramePresentStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetDisplayedTime<
            Identity: IIndependentFlipFramePresentStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            result__: *mut SystemInterruptTime,
        ) {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetPresentDuration<
            Identity: IIndependentFlipFramePresentStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl IPresentationBuffer {
    pub unsafe fn GetAvailableEvent(
        &self,
...
pub struct IPresentationBuffer_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetAvailableEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IPresentationBuffer_Vtbl {
    pub const fn new<Identity: IPresentationBuffer_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            availableeventhandle: *mut super::super::Foundation::HANDLE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IPresentationManager {
    ...
    pub unsafe fn CreatePresentationSurface(
        &self,
        compositionsurfacehandle: super::super::Foundation::HANDLE,
    ...
    pub unsafe fn CancelPresentsFrom(
        &self,
    ...
    pub unsafe fn GetPresentStatisticsAvailableEvent(
        &self,
    ) -> windows_core::Result<super::super::Foundation::HANDLE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct IPresentationManager_Vtbl {
    ...
    pub GetLostEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::HANDLE,
    ) -> windows_core::HRESULT,
    pub GetPresentStatisticsAvailableEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::HANDLE,
    ) -> windows_core::HRESULT,
...
pub trait IPresentationManager_Impl: windows_core::IUnknownImpl {
    fn AddBufferFromResource(
        &self,
        resource: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<IPresentationBuffer>;
...
impl IPresentationManager_Vtbl {
    pub const fn new<Identity: IPresentationManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            losteventhandle: *mut super::super::Foundation::HANDLE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            presentstatisticsavailableeventhandle: *mut super::super::Foundation::HANDLE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IPresentationSurface {
    ...
    pub unsafe fn SetSourceRect(
        &self,
        sourcerect: *const super::super::Foundation::RECT,
    ) -> windows_core::Result<()> {
        unsafe {
...
pub trait IPresentationSurface_Impl: IPresentationContent_Impl {
    fn SetBuffer(
        &self,
        presentationbuffer: windows_core::Ref<'_, IPresentationBuffer>,
    ) -> windows_core::Result<()>;
    fn SetColorSpace(
        &self,
        colorspace: super::Dxgi::Common::DXGI_COLOR_SPACE_TYPE,
    ...
    fn RestrictToOutput(
        &self,
        output: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
...
pub const PresentStatisticsKind_CompositionFrame: PresentStatisticsKind =
    PresentStatisticsKind(2i32);
pub const PresentStatisticsKind_IndependentFlipFrame: PresentStatisticsKind =
    PresentStatisticsKind(3i32);

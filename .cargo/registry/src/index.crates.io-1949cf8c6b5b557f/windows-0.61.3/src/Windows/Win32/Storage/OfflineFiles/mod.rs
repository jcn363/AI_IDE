...
pub unsafe fn OfflineFilesQueryStatus(
    pbactive: Option<*mut windows_core::BOOL>,
    pbenabled: Option<*mut windows_core::BOOL>,
) -> u32 {
    ...
    unsafe {
        OfflineFilesQueryStatus(
            pbactive.unwrap_or(core::mem::zeroed()) as _,
            pbenabled.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn OfflineFilesQueryStatusEx(
    pbactive: Option<*mut windows_core::BOOL>,
    pbenabled: Option<*mut windows_core::BOOL>,
    pbavailable: Option<*mut windows_core::BOOL>,
) -> u32 {
    ...
    unsafe {
        OfflineFilesQueryStatusEx(
            pbactive.unwrap_or(core::mem::zeroed()) as _,
            pbenabled.unwrap_or(core::mem::zeroed()) as _,
            pbavailable.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
    ...
    pub const fn new<Identity: IEnumOfflineFilesItems_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                IEnumOfflineFilesItems_Impl::Next(
                    this,
    ...
    pub const fn new<Identity: IEnumOfflineFilesSettings_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumOfflineFilesSettings_Impl::Next(
                    this,
                    core::mem::transmute_copy(&celt),
                    core::mem::transmute_copy(&rgelt),
                    core::mem::transmute_copy(&pceltfetched),
...
windows_core::imp::define_interface!(
    ...
    0x855d6203_7914_48b9_8d40_4c56f5acffc5
);
windows_core::imp::interface_hierarchy!(IOfflineFilesCache, windows_core::IUnknown);
impl IOfflineFilesCache {
    pub unsafe fn Synchronize<P5, P6>(
        &self,
        hwndparent: Option<super::super::Foundation::HWND>,
        rgpszpaths: &[windows_core::PCWSTR],
        basync: bool,
        dwsynccontrol: u32,
        pisyncconflicthandler: P5,
        piprogress: P6,
        psyncid: Option<*const windows_core::GUID>,
    ) -> windows_core::Result<()>
    where
        ...
        P6: windows_core::Param<IOfflineFilesSyncProgress>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Synchronize)(
                ...
                core::mem::transmute(rgpszpaths.as_ptr()),
                rgpszpaths.len().try_into().unwrap(),
                basync.into(),
                dwsynccontrol,
                pisyncconflicthandler.param().abi(),
                piprogress.param().abi(),
                psyncid.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn DeleteItems<P4>(
        &self,
        rgpszpaths: &[windows_core::PCWSTR],
        dwflags: u32,
        basync: bool,
    ...
    pub unsafe fn DeleteItemsForUser<P0, P5>(
        &self,
        pszuser: P0,
        rgpszpaths: &[windows_core::PCWSTR],
        dwflags: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteItemsForUser)(
                windows_core::Interface::as_raw(self),
                pszuser.param().abi(),
                core::mem::transmute(rgpszpaths.as_ptr()),
                rgpszpaths.len().try_into().unwrap(),
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Pin)(
                windows_core::Interface::as_raw(self),
                hwndparent.unwrap_or(core::mem::zeroed()) as _,
                core::mem::transmute(rgpszpaths.as_ptr()),
                rgpszpaths.len().try_into().unwrap(),
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Unpin)(
                windows_core::Interface::as_raw(self),
                hwndparent.unwrap_or(core::mem::zeroed()) as _,
                core::mem::transmute(rgpszpaths.as_ptr()),
                rgpszpaths.len().try_into().unwrap(),
    ...
    pub unsafe fn GetEncryptionStatus(
        &self,
        pbencrypted: *mut windows_core::BOOL,
        pbpartial: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetEncryptionStatus)(
                windows_core::Interface::as_raw(self),
                pbencrypted as _,
                pbpartial as _,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Encrypt)(
                windows_core::Interface::as_raw(self),
                hwndparent.unwrap_or(core::mem::zeroed()) as _,
                bencrypt.into(),
    ...
    pub unsafe fn FindItem<P0>(
        &self,
        pszpath: P0,
        dwqueryflags: u32,
    ) -> windows_core::Result<IOfflineFilesItem>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn FindItemEx<P0, P1, P2, P3, P4>(
        &self,
        pszpath: P0,
        pincludefilefilter: P1,
        pincludedirfilter: P2,
        pexcludefilefilter: P3,
        pexcludedirfilter: P4,
        dwqueryflags: u32,
    ) -> windows_core::Result<IOfflineFilesItem>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        ...
        P4: windows_core::Param<IOfflineFilesItemFilter>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindItemEx)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                pincludefilefilter.param().abi(),
                pincludedirfilter.param().abi(),
                pexcludefilefilter.param().abi(),
                pexcludedirfilter.param().abi(),
                dwqueryflags,
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn RenameItem<P0, P1>(
        &self,
        pszpathoriginal: P0,
        pszpathnew: P1,
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).RenameItem)(
                windows_core::Interface::as_raw(self),
                pszpathoriginal.param().abi(),
                pszpathnew.param().abi(),
                breplaceifexists.into(),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn GetDiskSpaceInformation(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetDiskSpaceInformation)(
                windows_core::Interface::as_raw(self),
                pcbvolumetotal as _,
                pcblimit as _,
                pcbused as _,
                pcbunpinnedlimit as _,
                pcbunpinnedused as _,
            )
            .ok()
        }
    }
    pub unsafe fn SetDiskSpaceLimits(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetDiskSpaceLimits)(
                windows_core::Interface::as_raw(self),
                cblimit,
                cbunpinnedlimit,
            )
    ...
    pub unsafe fn ProcessAdminPinPolicy<P0, P1>(
        &self,
        ppinprogress: P0,
        punpinprogress: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ProcessAdminPinPolicy)(
                windows_core::Interface::as_raw(self),
                ppinprogress.param().abi(),
                punpinprogress.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn GetSettingObject<P0>(
        &self,
        pszsettingname: P0,
    ) -> windows_core::Result<IOfflineFilesSetting>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSettingObject)(
                windows_core::Interface::as_raw(self),
                pszsettingname.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn EnumSettingObjects(&self) -> windows_core::Result<IEnumOfflineFilesSettings> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumSettingObjects)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn IsPathCacheable<P0>(
        &self,
        pszpath: P0,
        pbcacheable: *mut windows_core::BOOL,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).IsPathCacheable)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                pbcacheable as _,
                psharecachingmode as _,
            )
            .ok()
        }
    }
...
pub struct IOfflineFilesCache_Vtbl {
    ...
    pub DeleteItemsForUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const windows_core::PCWSTR,
        u32,
    ...
    pub Pin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HWND,
        *const windows_core::PCWSTR,
        u32,
    ...
    pub Unpin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HWND,
        *const windows_core::PCWSTR,
        u32,
    ...
    pub GetEncryptionStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub Encrypt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HWND,
        windows_core::BOOL,
        u32,
    ...
    pub FindItemEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub GetDiskSpaceInformation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u64,
        *mut u64,
        *mut u64,
    ...
    pub SetDiskSpaceLimits:
        unsafe extern "system" fn(*mut core::ffi::c_void, u64, u64) -> windows_core::HRESULT,
    pub ProcessAdminPinPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetSettingObject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub EnumSettingObjects: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsPathCacheable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut windows_core::BOOL,
...
pub trait IOfflineFilesCache_Impl: windows_core::IUnknownImpl {
    fn Synchronize(
        ...
        rgpszpaths: *const windows_core::PCWSTR,
        cpaths: u32,
        basync: windows_core::BOOL,
        dwsynccontrol: u32,
        pisyncconflicthandler: windows_core::Ref<'_, IOfflineFilesSyncConflictHandler>,
        piprogress: windows_core::Ref<'_, IOfflineFilesSyncProgress>,
        psyncid: *const windows_core::GUID,
    ) -> windows_core::Result<()>;
    fn DeleteItems(
        &self,
        rgpszpaths: *const windows_core::PCWSTR,
    ...
    fn FindItemEx(
        &self,
        pszpath: &windows_core::PCWSTR,
        pincludefilefilter: windows_core::Ref<'_, IOfflineFilesItemFilter>,
        pincludedirfilter: windows_core::Ref<'_, IOfflineFilesItemFilter>,
        pexcludefilefilter: windows_core::Ref<'_, IOfflineFilesItemFilter>,
        pexcludedirfilter: windows_core::Ref<'_, IOfflineFilesItemFilter>,
        dwqueryflags: u32,
    ) -> windows_core::Result<IOfflineFilesItem>;
    fn RenameItem(
        &self,
        pszpathoriginal: &windows_core::PCWSTR,
        pszpathnew: &windows_core::PCWSTR,
        breplaceifexists: windows_core::BOOL,
    ) -> windows_core::Result<()>;
    ...
    fn ProcessAdminPinPolicy(
        &self,
        ppinprogress: windows_core::Ref<'_, IOfflineFilesSyncProgress>,
        punpinprogress: windows_core::Ref<'_, IOfflineFilesSyncProgress>,
    ) -> windows_core::Result<()>;
    fn GetSettingObject(
        &self,
        pszsettingname: &windows_core::PCWSTR,
    ) -> windows_core::Result<IOfflineFilesSetting>;
...
impl IOfflineFilesCache_Vtbl {
    pub const fn new<Identity: IOfflineFilesCache_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            basync: windows_core::BOOL,
            dwsynccontrol: u32,
            pisyncconflicthandler: *mut core::ffi::c_void,
            piprogress: *mut core::ffi::c_void,
            psyncid: *const windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                ...
                IOfflineFilesCache_Impl::Synchronize(
                    ...
                    core::mem::transmute_copy(&rgpszpaths),
                    core::mem::transmute_copy(&cpaths),
                    core::mem::transmute_copy(&basync),
                    core::mem::transmute_copy(&dwsynccontrol),
                    core::mem::transmute_copy(&pisyncconflicthandler),
                    core::mem::transmute_copy(&piprogress),
                    core::mem::transmute_copy(&psyncid),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesCache_Impl::DeleteItems(
                    this,
                    core::mem::transmute_copy(&rgpszpaths),
                    core::mem::transmute_copy(&cpaths),
        ...
        unsafe extern "system" fn DeleteItemsForUser<
            Identity: IOfflineFilesCache_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesCache_Impl::DeleteItemsForUser(
                    this,
                    core::mem::transmute(&pszuser),
                    core::mem::transmute_copy(&rgpszpaths),
                    core::mem::transmute_copy(&cpaths),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&basync),
        ...
        unsafe extern "system" fn Pin<Identity: IOfflineFilesCache_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hwndparent: super::super::Foundation::HWND,
            rgpszpaths: *const windows_core::PCWSTR,
            cpaths: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesCache_Impl::Pin(
                    this,
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute_copy(&rgpszpaths),
                    core::mem::transmute_copy(&cpaths),
                    core::mem::transmute_copy(&bdeep),
                    core::mem::transmute_copy(&basync),
                    core::mem::transmute_copy(&dwpincontrolflags),
                    core::mem::transmute_copy(&piprogress),
                )
                .into()
            }
        }
        unsafe extern "system" fn Unpin<Identity: IOfflineFilesCache_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hwndparent: super::super::Foundation::HWND,
            rgpszpaths: *const windows_core::PCWSTR,
            cpaths: u32,
        ...
        unsafe extern "system" fn GetEncryptionStatus<
            Identity: IOfflineFilesCache_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesCache_Impl::GetEncryptionStatus(
                    this,
                    core::mem::transmute_copy(&pbencrypted),
                    core::mem::transmute_copy(&pbpartial),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesCache_Impl::Encrypt(
                    this,
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute_copy(&bencrypt),
                    core::mem::transmute_copy(&dwencryptioncontrolflags),
                    core::mem::transmute_copy(&basync),
                    core::mem::transmute_copy(&piprogress),
                )
                .into()
        ...
        unsafe extern "system" fn FindItem<
            Identity: IOfflineFilesCache_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IOfflineFilesCache_Impl::FindItem(
                    this,
        ...
        unsafe extern "system" fn FindItemEx<
            Identity: IOfflineFilesCache_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pszpath: windows_core::PCWSTR,
            pincludefilefilter: *mut core::ffi::c_void,
            pincludedirfilter: *mut core::ffi::c_void,
            pexcludefilefilter: *mut core::ffi::c_void,
            pexcludedirfilter: *mut core::ffi::c_void,
            dwqueryflags: u32,
            ppitem: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IOfflineFilesCache_Impl::FindItemEx(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&pincludefilefilter),
                    core::mem::transmute_copy(&pincludedirfilter),
                    core::mem::transmute_copy(&pexcludefilefilter),
                    core::mem::transmute_copy(&pexcludedirfilter),
                    core::mem::transmute_copy(&dwqueryflags),
                ) {
                    Ok(ok__) => {
                        ppitem.write(core::mem::transmute(ok__));
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesCache_Impl::RenameItem(
                    this,
                    core::mem::transmute(&pszpathoriginal),
                    core::mem::transmute(&pszpathnew),
                    core::mem::transmute_copy(&breplaceifexists),
                )
                .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            ppszpath: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetDiskSpaceInformation<
            Identity: IOfflineFilesCache_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesCache_Impl::GetDiskSpaceInformation(
                    this,
                    core::mem::transmute_copy(&pcbvolumetotal),
                    core::mem::transmute_copy(&pcblimit),
                    core::mem::transmute_copy(&pcbused),
                    core::mem::transmute_copy(&pcbunpinnedlimit),
                    core::mem::transmute_copy(&pcbunpinnedused),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetDiskSpaceLimits<
            Identity: IOfflineFilesCache_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesCache_Impl::SetDiskSpaceLimits(
                    this,
                    core::mem::transmute_copy(&cblimit),
                    core::mem::transmute_copy(&cbunpinnedlimit),
                )
                .into()
            }
        }
        unsafe extern "system" fn ProcessAdminPinPolicy<
            Identity: IOfflineFilesCache_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppinprogress: *mut core::ffi::c_void,
            punpinprogress: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesCache_Impl::ProcessAdminPinPolicy(
                    this,
                    core::mem::transmute_copy(&ppinprogress),
                    core::mem::transmute_copy(&punpinprogress),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetSettingObject<
            Identity: IOfflineFilesCache_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pszsettingname: windows_core::PCWSTR,
            ppsetting: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IOfflineFilesCache_Impl::GetSettingObject(
                    this,
                    core::mem::transmute(&pszsettingname),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn EnumSettingObjects<
            Identity: IOfflineFilesCache_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn IsPathCacheable<
            Identity: IOfflineFilesCache_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesCache_Impl::IsPathCacheable(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&pbcacheable),
                    core::mem::transmute_copy(&psharecachingmode),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x8c075039_1551_4ed9_8781_56705c04d3c0
);
...
impl IOfflineFilesCache2 {
    pub unsafe fn RenameItemEx<P0, P1>(
        &self,
        pszpathoriginal: P0,
        pszpathnew: P1,
        breplaceifexists: bool,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RenameItemEx)(
                windows_core::Interface::as_raw(self),
                pszpathoriginal.param().abi(),
                pszpathnew.param().abi(),
                breplaceifexists.into(),
...
pub struct IOfflineFilesCache2_Vtbl {
    ...
    pub RenameItemEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::BOOL,
...
impl IOfflineFilesCache2_Vtbl {
    pub const fn new<Identity: IOfflineFilesCache2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RenameItemEx<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesCache2_Impl::RenameItemEx(
                    this,
                    core::mem::transmute(&pszpathoriginal),
                    core::mem::transmute(&pszpathnew),
                    core::mem::transmute_copy(&breplaceifexists),
        ...
        Self {
            base__: IOfflineFilesCache_Vtbl::new::<Identity, OFFSET>(),
            RenameItemEx: RenameItemEx::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xa96e6fa4_e0d1_4c29_960b_ee508fe68c72
);
...
impl IOfflineFilesChangeInfo {
    ...
    pub unsafe fn IsDeletedOffline(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsDeletedOffline)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn IsCreatedOffline(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsCreatedOffline)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn IsLocallyModifiedData(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsLocallyModifiedData)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn IsLocallyModifiedAttributes(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsLocallyModifiedAttributes)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn IsLocallyModifiedTime(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsLocallyModifiedTime)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IOfflineFilesChangeInfo_Vtbl {
    ...
    pub IsDeletedOffline: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub IsCreatedOffline: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub IsLocallyModifiedData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub IsLocallyModifiedAttributes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub IsLocallyModifiedTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
}
...
impl IOfflineFilesChangeInfo_Vtbl {
    pub const fn new<Identity: IOfflineFilesChangeInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn IsDeletedOffline<
            Identity: IOfflineFilesChangeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbdeletedoffline: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsCreatedOffline<
            Identity: IOfflineFilesChangeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbcreatedoffline: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsLocallyModifiedData<
            Identity: IOfflineFilesChangeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pblocallymodifieddata: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsLocallyModifiedAttributes<
            Identity: IOfflineFilesChangeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pblocallymodifiedattributes: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsLocallyModifiedTime<
            Identity: IOfflineFilesChangeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pblocallymodifiedtime: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0xefb23a09_a867_4be8_83a6_86969a7d0856
);
...
impl IOfflineFilesConnectionInfo {
    pub unsafe fn GetConnectState(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetConnectState)(
                windows_core::Interface::as_raw(self),
                pconnectstate as _,
                pofflinereason as _,
            )
    ...
    pub unsafe fn SetConnectState(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetConnectState)(
                windows_core::Interface::as_raw(self),
                hwndparent.unwrap_or(core::mem::zeroed()) as _,
                dwflags,
                connectstate,
    ...
    pub unsafe fn TransitionOnline(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).TransitionOnline)(
                windows_core::Interface::as_raw(self),
                hwndparent.unwrap_or(core::mem::zeroed()) as _,
                dwflags,
            )
    ...
    pub unsafe fn TransitionOffline(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TransitionOffline)(
                windows_core::Interface::as_raw(self),
                hwndparent.unwrap_or(core::mem::zeroed()) as _,
                dwflags,
                bforceopenfilesclosed.into(),
                &mut result__,
            )
            .map(|| result__)
        }
...
pub struct IOfflineFilesConnectionInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetConnectState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut OFFLINEFILES_CONNECT_STATE,
        *mut OFFLINEFILES_OFFLINE_REASON,
    ) -> windows_core::HRESULT,
    pub SetConnectState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HWND,
        u32,
        OFFLINEFILES_CONNECT_STATE,
    ) -> windows_core::HRESULT,
    pub TransitionOnline: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HWND,
        u32,
    ) -> windows_core::HRESULT,
    pub TransitionOffline: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HWND,
        u32,
        windows_core::BOOL,
    ...
    pub const fn new<Identity: IOfflineFilesConnectionInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesConnectionInfo_Impl::GetConnectState(
                    this,
                    core::mem::transmute_copy(&pconnectstate),
                    core::mem::transmute_copy(&pofflinereason),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetConnectState<
            Identity: IOfflineFilesConnectionInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesConnectionInfo_Impl::SetConnectState(
                    this,
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&connectstate),
                )
                .into()
            }
        }
        unsafe extern "system" fn TransitionOnline<
            Identity: IOfflineFilesConnectionInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesConnectionInfo_Impl::TransitionOnline(
                    this,
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute_copy(&dwflags),
                )
        ...
        unsafe extern "system" fn TransitionOffline<
            Identity: IOfflineFilesConnectionInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            dwflags: u32,
            bforceopenfilesclosed: windows_core::BOOL,
            pbopenfilespreventedtransition: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IOfflineFilesConnectionInfo_Impl::TransitionOffline(
                    this,
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&bforceopenfilesclosed),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    IOfflineFilesDirectoryItem_Vtbl,
    0x2273597a_a08c_4a00_a37a_c1ae4e9a1cfd
);
...
impl IOfflineFilesDirectoryItem_Vtbl {
    pub const fn new<Identity: IOfflineFilesDirectoryItem_Impl, const OFFSET: isize>() -> Self {
        Self {
            base__: IOfflineFilesItem_Vtbl::new::<Identity, OFFSET>(),
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x0f50ce33_bac9_4eaa_a11d_da0e527d047d
);
...
impl IOfflineFilesDirtyInfo {
    pub unsafe fn LocalDirtyByteCount(&self) -> windows_core::Result<i64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LocalDirtyByteCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn RemoteDirtyByteCount(&self) -> windows_core::Result<i64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RemoteDirtyByteCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
impl IOfflineFilesDirtyInfo_Vtbl {
    pub const fn new<Identity: IOfflineFilesDirtyInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn LocalDirtyByteCount<
        ...
        unsafe extern "system" fn RemoteDirtyByteCount<
            Identity: IOfflineFilesDirtyInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x7112fa5f_7571_435a_8eb7_195c7c1429bc
);
...
impl IOfflineFilesErrorInfo {
    ...
    pub unsafe fn GetRawData(
        &self,
    ) -> windows_core::Result<*mut super::super::System::Com::BYTE_BLOB> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRawData)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IOfflineFilesErrorInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_System_Com")]
    pub GetRawData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::super::System::Com::BYTE_BLOB,
    ) -> windows_core::HRESULT,
...
impl IOfflineFilesErrorInfo_Vtbl {
    pub const fn new<Identity: IOfflineFilesErrorInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetRawData<
...
impl IOfflineFilesEvents {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CacheMoved)(
                windows_core::Interface::as_raw(self),
                pszoldpath.param().abi(),
                psznewpath.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn CacheIsFull(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CacheIsFull)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn CacheIsCorrupted(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CacheIsCorrupted)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn EncryptionChanged(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EncryptionChanged)(
                windows_core::Interface::as_raw(self),
                bwasencrypted.into(),
                bwaspartial.into(),
                bisencrypted.into(),
    ...
    pub unsafe fn SyncBegin(&self, rsyncid: *const windows_core::GUID) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SyncBegin)(
                windows_core::Interface::as_raw(self),
                rsyncid,
            )
            .ok()
    ...
    pub unsafe fn SyncFileResult<P1>(
        &self,
        rsyncid: *const windows_core::GUID,
        pszfile: P1,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SyncFileResult)(
                windows_core::Interface::as_raw(self),
                rsyncid,
                pszfile.param().abi(),
                hrresult,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SyncConflictRecAdded)(
                windows_core::Interface::as_raw(self),
                pszconflictpath.param().abi(),
                pftconflictdatetime,
                conflictsyncstate,
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SyncConflictRecUpdated)(
                windows_core::Interface::as_raw(self),
                pszconflictpath.param().abi(),
                pftconflictdatetime,
                conflictsyncstate,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SyncConflictRecRemoved)(
                windows_core::Interface::as_raw(self),
                pszconflictpath.param().abi(),
                pftconflictdatetime,
                conflictsyncstate,
    ...
    pub unsafe fn SyncEnd(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SyncEnd)(
                windows_core::Interface::as_raw(self),
                rsyncid,
                hrresult,
            )
    ...
    pub unsafe fn NetTransportArrived(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).NetTransportArrived)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn NoNetTransports(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).NoNetTransports)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ItemDisconnected)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                itemtype,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ItemReconnected)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                itemtype,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ItemAvailableOffline)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                itemtype,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ItemNotAvailableOffline)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                itemtype,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ItemPinned)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                itemtype,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ItemNotPinned)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                itemtype,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ItemModified)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                itemtype,
                bmodifieddata.into(),
                bmodifiedattributes.into(),
            )
            .ok()
        }
    }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ItemAddedToCache)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                itemtype,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ItemDeletedFromCache)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                itemtype,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ItemRenamed)(
                windows_core::Interface::as_raw(self),
                pszoldpath.param().abi(),
                psznewpath.param().abi(),
                itemtype,
    ...
    pub unsafe fn DataLost(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DataLost)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
...
pub struct IOfflineFilesEvents_Vtbl {
    ...
    pub SyncBegin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub SyncFileResult: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        windows_core::PCWSTR,
        windows_core::HRESULT,
    ) -> windows_core::HRESULT,
    pub SyncConflictRecAdded: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const super::super::Foundation::FILETIME,
        OFFLINEFILES_SYNC_STATE,
    ) -> windows_core::HRESULT,
    pub SyncConflictRecUpdated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const super::super::Foundation::FILETIME,
        OFFLINEFILES_SYNC_STATE,
    ) -> windows_core::HRESULT,
    pub SyncConflictRecRemoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const super::super::Foundation::FILETIME,
        OFFLINEFILES_SYNC_STATE,
    ) -> windows_core::HRESULT,
    pub SyncEnd: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        windows_core::HRESULT,
    ) -> windows_core::HRESULT,
    pub NetTransportArrived:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub NoNetTransports: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ItemDisconnected: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        OFFLINEFILES_ITEM_TYPE,
    ) -> windows_core::HRESULT,
    pub ItemReconnected: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        OFFLINEFILES_ITEM_TYPE,
    ) -> windows_core::HRESULT,
    pub ItemAvailableOffline: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        OFFLINEFILES_ITEM_TYPE,
    ) -> windows_core::HRESULT,
    pub ItemNotAvailableOffline: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        OFFLINEFILES_ITEM_TYPE,
    ) -> windows_core::HRESULT,
    pub ItemPinned: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        OFFLINEFILES_ITEM_TYPE,
    ) -> windows_core::HRESULT,
    pub ItemNotPinned: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        OFFLINEFILES_ITEM_TYPE,
    ) -> windows_core::HRESULT,
    pub ItemModified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        OFFLINEFILES_ITEM_TYPE,
        windows_core::BOOL,
    ...
    pub ItemAddedToCache: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        OFFLINEFILES_ITEM_TYPE,
    ) -> windows_core::HRESULT,
    pub ItemDeletedFromCache: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        OFFLINEFILES_ITEM_TYPE,
    ) -> windows_core::HRESULT,
    pub ItemRenamed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        OFFLINEFILES_ITEM_TYPE,
...
pub trait IOfflineFilesEvents_Impl: windows_core::IUnknownImpl {
    fn CacheMoved(
        &self,
        pszoldpath: &windows_core::PCWSTR,
        psznewpath: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    ...
    fn EncryptionChanged(
        &self,
        bwasencrypted: windows_core::BOOL,
        bwaspartial: windows_core::BOOL,
        bisencrypted: windows_core::BOOL,
        bispartial: windows_core::BOOL,
    ) -> windows_core::Result<()>;
    ...
    fn SyncConflictRecAdded(
        &self,
        pszconflictpath: &windows_core::PCWSTR,
        pftconflictdatetime: *const super::super::Foundation::FILETIME,
        conflictsyncstate: OFFLINEFILES_SYNC_STATE,
    ) -> windows_core::Result<()>;
    ...
    fn ItemModified(
        ...
        pszpath: &windows_core::PCWSTR,
        itemtype: OFFLINEFILES_ITEM_TYPE,
        bmodifieddata: windows_core::BOOL,
        bmodifiedattributes: windows_core::BOOL,
    ) -> windows_core::Result<()>;
    fn ItemAddedToCache(
        &self,
        pszpath: &windows_core::PCWSTR,
...
impl IOfflineFilesEvents_Vtbl {
    pub const fn new<Identity: IOfflineFilesEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CacheMoved<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::CacheMoved(
                    this,
                    core::mem::transmute(&pszoldpath),
                    core::mem::transmute(&psznewpath),
                )
                .into()
            }
        }
        unsafe extern "system" fn CacheIsFull<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CacheIsCorrupted<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EncryptionChanged<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::EncryptionChanged(
                    this,
                    core::mem::transmute_copy(&bwasencrypted),
                    core::mem::transmute_copy(&bwaspartial),
                    core::mem::transmute_copy(&bisencrypted),
                    core::mem::transmute_copy(&bispartial),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::SyncBegin(this, core::mem::transmute_copy(&rsyncid))
                    .into()
            }
        }
        unsafe extern "system" fn SyncFileResult<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::SyncFileResult(
                    this,
                    core::mem::transmute_copy(&rsyncid),
                    core::mem::transmute(&pszfile),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::SyncConflictRecAdded(
                    this,
                    core::mem::transmute(&pszconflictpath),
                    core::mem::transmute_copy(&pftconflictdatetime),
                    core::mem::transmute_copy(&conflictsyncstate),
                )
                .into()
            }
        }
        unsafe extern "system" fn SyncConflictRecUpdated<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::SyncConflictRecUpdated(
                    this,
                    core::mem::transmute(&pszconflictpath),
                    core::mem::transmute_copy(&pftconflictdatetime),
                    core::mem::transmute_copy(&conflictsyncstate),
        ...
        unsafe extern "system" fn SyncConflictRecRemoved<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::SyncConflictRecRemoved(
                    this,
                    core::mem::transmute(&pszconflictpath),
                    core::mem::transmute_copy(&pftconflictdatetime),
                    core::mem::transmute_copy(&conflictsyncstate),
        ...
        unsafe extern "system" fn SyncEnd<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::SyncEnd(
                    this,
                    core::mem::transmute_copy(&rsyncid),
                    core::mem::transmute_copy(&hrresult),
                )
        ...
        unsafe extern "system" fn NetTransportArrived<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ItemDisconnected<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::ItemDisconnected(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&itemtype),
                )
                .into()
            }
        }
        unsafe extern "system" fn ItemReconnected<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::ItemReconnected(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&itemtype),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::ItemAvailableOffline(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&itemtype),
                )
        ...
        unsafe extern "system" fn ItemNotAvailableOffline<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::ItemNotAvailableOffline(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&itemtype),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::ItemPinned(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&itemtype),
                )
        ...
        unsafe extern "system" fn ItemNotPinned<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::ItemNotPinned(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&itemtype),
                )
        ...
        unsafe extern "system" fn ItemModified<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::ItemModified(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&itemtype),
                    core::mem::transmute_copy(&bmodifieddata),
                    core::mem::transmute_copy(&bmodifiedattributes),
                )
                .into()
            }
        }
        unsafe extern "system" fn ItemAddedToCache<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::ItemAddedToCache(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&itemtype),
                )
        ...
        unsafe extern "system" fn ItemDeletedFromCache<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::ItemDeletedFromCache(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&itemtype),
                )
        ...
        unsafe extern "system" fn ItemRenamed<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents_Impl::ItemRenamed(
                    this,
                    core::mem::transmute(&pszoldpath),
                    core::mem::transmute(&psznewpath),
                    core::mem::transmute_copy(&itemtype),
        ...
        unsafe extern "system" fn DataLost<
            Identity: IOfflineFilesEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Ping<Identity: IOfflineFilesEvents_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    ...
    0x1ead8f56_ff76_4faa_a795_6f6ef792498b
);
...
impl IOfflineFilesEvents2 {
    pub unsafe fn ItemReconnectBegin(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ItemReconnectBegin)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn ItemReconnectEnd(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ItemReconnectEnd)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn CacheEvictBegin(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CacheEvictBegin)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn CacheEvictEnd(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CacheEvictEnd)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn BackgroundSyncBegin(&self, dwsynccontrolflags: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BackgroundSyncBegin)(
                windows_core::Interface::as_raw(self),
                dwsynccontrolflags,
            )
            .ok()
    ...
    pub unsafe fn BackgroundSyncEnd(&self, dwsynccontrolflags: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BackgroundSyncEnd)(
                windows_core::Interface::as_raw(self),
                dwsynccontrolflags,
            )
            .ok()
    ...
    pub unsafe fn PolicyChangeDetected(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).PolicyChangeDetected)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn PreferenceChangeDetected(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).PreferenceChangeDetected)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn SettingsChangesApplied(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SettingsChangesApplied)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct IOfflineFilesEvents2_Vtbl {
    ...
    pub ItemReconnectBegin:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ItemReconnectEnd:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    ...
    pub BackgroundSyncBegin:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub BackgroundSyncEnd:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub PolicyChangeDetected:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub PreferenceChangeDetected:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub SettingsChangesApplied:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
}
...
impl IOfflineFilesEvents2_Vtbl {
    pub const fn new<Identity: IOfflineFilesEvents2_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn ItemReconnectEnd<
            Identity: IOfflineFilesEvents2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CacheEvictBegin<
            Identity: IOfflineFilesEvents2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn BackgroundSyncBegin<
            Identity: IOfflineFilesEvents2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents2_Impl::BackgroundSyncBegin(
                    this,
                    core::mem::transmute_copy(&dwsynccontrolflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn BackgroundSyncEnd<
            Identity: IOfflineFilesEvents2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents2_Impl::BackgroundSyncEnd(
                    this,
                    core::mem::transmute_copy(&dwsynccontrolflags),
                )
                .into()
        ...
        unsafe extern "system" fn PreferenceChangeDetected<
            Identity: IOfflineFilesEvents2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x9ba04a45_ee69_42f0_9ab1_7db5c8805808
);
...
impl IOfflineFilesEvents3 {
    pub unsafe fn TransparentCacheItemNotify<P0, P5>(
        &self,
        pszpath: P0,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).TransparentCacheItemNotify)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                eventtype,
                itemtype,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PrefetchFileBegin)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PrefetchFileEnd)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                hrresult,
            )
...
pub struct IOfflineFilesEvents3_Vtbl {
    ...
    pub TransparentCacheItemNotify: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        OFFLINEFILES_EVENTS,
        OFFLINEFILES_ITEM_TYPE,
    ...
    pub PrefetchFileBegin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub PrefetchFileEnd: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::HRESULT,
    ) -> windows_core::HRESULT,
...
pub trait IOfflineFilesEvents3_Impl: IOfflineFilesEvents2_Impl {
    fn TransparentCacheItemNotify(
        ...
        bmodifieddata: windows_core::BOOL,
        bmodifiedattributes: windows_core::BOOL,
        pzsoldpath: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: IOfflineFilesEvents3_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents3_Impl::TransparentCacheItemNotify(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&eventtype),
                    core::mem::transmute_copy(&itemtype),
                    core::mem::transmute_copy(&bmodifieddata),
                    core::mem::transmute_copy(&bmodifiedattributes),
                    core::mem::transmute(&pzsoldpath),
                )
                .into()
            }
        }
        unsafe extern "system" fn PrefetchFileBegin<
            Identity: IOfflineFilesEvents3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents3_Impl::PrefetchFileBegin(this, core::mem::transmute(&pszpath))
                    .into()
            }
        }
        unsafe extern "system" fn PrefetchFileEnd<
            Identity: IOfflineFilesEvents3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents3_Impl::PrefetchFileEnd(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&hrresult),
                )
...
windows_core::imp::define_interface!(
    ...
    0xdbd69b1e_c7d2_473e_b35f_9d8c24c0c484
);
...
impl IOfflineFilesEvents4 {
    pub unsafe fn PrefetchCloseHandleBegin(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).PrefetchCloseHandleBegin)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn PrefetchCloseHandleEnd(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).PrefetchCloseHandleEnd)(
                windows_core::Interface::as_raw(self),
                dwclosedhandlecount,
                dwopenhandlecount,
                hrresult,
...
pub struct IOfflineFilesEvents4_Vtbl {
    ...
    pub PrefetchCloseHandleBegin:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub PrefetchCloseHandleEnd: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        windows_core::HRESULT,
...
impl IOfflineFilesEvents4_Vtbl {
    pub const fn new<Identity: IOfflineFilesEvents4_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn PrefetchCloseHandleBegin<
        ...
        unsafe extern "system" fn PrefetchCloseHandleEnd<
            Identity: IOfflineFilesEvents4_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEvents4_Impl::PrefetchCloseHandleEnd(
                    this,
                    core::mem::transmute_copy(&dwclosedhandlecount),
...
windows_core::imp::define_interface!(
    ...
    0x33fc4e1b_0716_40fa_ba65_6e62a84a846f
);
...
impl IOfflineFilesEventsFilter {
    pub unsafe fn GetPathFilter(
        &self,
        ppszfilter: *mut windows_core::PWSTR,
        pmatch: *mut OFFLINEFILES_PATHFILTER_MATCH,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPathFilter)(
                windows_core::Interface::as_raw(self),
                ppszfilter as _,
                pmatch as _,
            )
    ...
    pub unsafe fn GetIncludedEvents(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetIncludedEvents)(
                windows_core::Interface::as_raw(self),
                prgevents.len().try_into().unwrap(),
                core::mem::transmute(prgevents.as_ptr()),
                pcevents as _,
            )
            .ok()
        }
    ...
    pub unsafe fn GetExcludedEvents(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetExcludedEvents)(
                windows_core::Interface::as_raw(self),
                prgevents.len().try_into().unwrap(),
                core::mem::transmute(prgevents.as_ptr()),
                pcevents as _,
...
pub struct IOfflineFilesEventsFilter_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetPathFilter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
        *mut OFFLINEFILES_PATHFILTER_MATCH,
    ) -> windows_core::HRESULT,
    pub GetIncludedEvents: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut OFFLINEFILES_EVENTS,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetExcludedEvents: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut OFFLINEFILES_EVENTS,
        *mut u32,
...
impl IOfflineFilesEventsFilter_Vtbl {
    pub const fn new<Identity: IOfflineFilesEventsFilter_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetPathFilter<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEventsFilter_Impl::GetPathFilter(
                    this,
                    core::mem::transmute_copy(&ppszfilter),
                    core::mem::transmute_copy(&pmatch),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetIncludedEvents<
            Identity: IOfflineFilesEventsFilter_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEventsFilter_Impl::GetIncludedEvents(
                    this,
                    core::mem::transmute_copy(&celements),
                    core::mem::transmute_copy(&prgevents),
                    core::mem::transmute_copy(&pcevents),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetExcludedEvents<
            Identity: IOfflineFilesEventsFilter_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesEventsFilter_Impl::GetExcludedEvents(
                    this,
                    core::mem::transmute_copy(&celements),
                    core::mem::transmute_copy(&prgevents),
                    core::mem::transmute_copy(&pcevents),
...
windows_core::imp::define_interface!(
    ...
    0x8dfadead_26c2_4eff_8a72_6b50723d9a00
);
...
impl IOfflineFilesFileItem {
    pub unsafe fn IsSparse(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsSparse)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn IsEncrypted(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsEncrypted)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IOfflineFilesFileItem_Vtbl {
    pub base__: IOfflineFilesItem_Vtbl,
    pub IsSparse: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub IsEncrypted: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
}
...
impl IOfflineFilesFileItem_Vtbl {
    pub const fn new<Identity: IOfflineFilesFileItem_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsSparse<
            Identity: IOfflineFilesFileItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbissparse: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsEncrypted<
            Identity: IOfflineFilesFileItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbisencrypted: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: IOfflineFilesItem_Vtbl::new::<Identity, OFFSET>(),
            IsSparse: IsSparse::<Identity, OFFSET>,
...
windows_core::imp::define_interface!(
    ...
    0xbc1a163f_7bfd_4d88_9c66_96ea9a6a3d6b
);
    ...
    pub unsafe fn GetTimes(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetTimes)(
                windows_core::Interface::as_raw(self),
                copy,
                pftcreationtime as _,
                pftlastwritetime as _,
                pftchangetime as _,
                pftlastaccesstime as _,
            )
            .ok()
        }
    }
...
pub struct IOfflineFilesFileSysInfo_Vtbl {
    ...
    pub GetFileSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        OFFLINEFILES_ITEM_COPY,
        *mut i64,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IOfflineFilesFileSysInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IOfflineFilesFileSysInfo_Impl::GetAttributes(
                    this,
                    core::mem::transmute_copy(&copy),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesFileSysInfo_Impl::GetTimes(
                    this,
                    core::mem::transmute_copy(&copy),
                    core::mem::transmute_copy(&pftcreationtime),
                    core::mem::transmute_copy(&pftlastwritetime),
                    core::mem::transmute_copy(&pftchangetime),
                    core::mem::transmute_copy(&pftlastaccesstime),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IOfflineFilesFileSysInfo_Impl::GetFileSize(
                    this,
                    core::mem::transmute_copy(&copy),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    IOfflineFilesGhostInfo_Vtbl,
    0x2b09d48c_8ab5_464f_a755_a59d92f99429
);
...
impl IOfflineFilesGhostInfo {
    pub unsafe fn IsGhosted(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsGhosted)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IOfflineFilesGhostInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub IsGhosted: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
}
...
impl IOfflineFilesGhostInfo_Vtbl {
    pub const fn new<Identity: IOfflineFilesGhostInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsGhosted<
            Identity: IOfflineFilesGhostInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbghosted: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            IsGhosted: IsGhosted::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x4a753da6_e044_4f12_a718_5d14d079a906
);
...
impl IOfflineFilesItem {
    ...
    pub unsafe fn IsMarkedForDeletion(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsMarkedForDeletion)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IOfflineFilesItem_Vtbl {
    ...
    pub IsMarkedForDeletion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
}
...
impl IOfflineFilesItem_Vtbl {
    pub const fn new<Identity: IOfflineFilesItem_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetPath<Identity: IOfflineFilesItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppszpath: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Refresh<Identity: IOfflineFilesItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwqueryflags: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesItem_Impl::Refresh(this, core::mem::transmute_copy(&dwqueryflags))
                    .into()
            }
        }
        unsafe extern "system" fn IsMarkedForDeletion<
            Identity: IOfflineFilesItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbmarkedfordeletion: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x3836f049_9413_45dd_bf46_b5aaa82dc310
);
...
impl IOfflineFilesItemContainer {
    pub unsafe fn EnumItems(
        &self,
        dwqueryflags: u32,
    ) -> windows_core::Result<IEnumOfflineFilesItems> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumItemsEx<P0, P1, P2, P3>(
        &self,
        pincludefilefilter: P0,
        pincludedirfilter: P1,
        pexcludefilefilter: P2,
        pexcludedirfilter: P3,
        dwenumflags: u32,
        dwqueryflags: u32,
    ) -> windows_core::Result<IEnumOfflineFilesItems>
    where
        ...
        P3: windows_core::Param<IOfflineFilesItemFilter>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumItemsEx)(
                windows_core::Interface::as_raw(self),
                pincludefilefilter.param().abi(),
                pincludedirfilter.param().abi(),
                pexcludefilefilter.param().abi(),
...
pub struct IOfflineFilesItemContainer_Vtbl {
    ...
    pub EnumItemsEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
impl IOfflineFilesItemContainer_Vtbl {
    pub const fn new<Identity: IOfflineFilesItemContainer_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn EnumItems<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IOfflineFilesItemContainer_Impl::EnumItems(
                    this,
                    core::mem::transmute_copy(&dwqueryflags),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn EnumItemsEx<
            Identity: IOfflineFilesItemContainer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IOfflineFilesItemContainer_Impl::EnumItemsEx(
                    this,
                    core::mem::transmute_copy(&pincludefilefilter),
                    core::mem::transmute_copy(&pincludedirfilter),
                    core::mem::transmute_copy(&pexcludefilefilter),
                    core::mem::transmute_copy(&pexcludedirfilter),
                    core::mem::transmute_copy(&dwenumflags),
                    core::mem::transmute_copy(&dwqueryflags),
                ) {
                    Ok(ok__) => {
                        ppenum.write(core::mem::transmute(ok__));
...
windows_core::imp::define_interface!(
    ...
    0xf4b5a26c_dc05_4f20_ada4_551f1077be5c
);
...
impl IOfflineFilesItemFilter {
    pub unsafe fn GetFilterFlags(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetFilterFlags)(
                windows_core::Interface::as_raw(self),
                pullflags as _,
                pullmask as _,
            )
    ...
    pub unsafe fn GetTimeFilter(
        ...
        pbevaltimeofday: *mut windows_core::BOOL,
        ptimetype: *mut OFFLINEFILES_ITEM_TIME,
        pcompare: *mut OFFLINEFILES_COMPARE,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetTimeFilter)(
                windows_core::Interface::as_raw(self),
                pfttime as _,
                pbevaltimeofday as _,
                ptimetype as _,
                pcompare as _,
            )
            .ok()
    ...
    pub unsafe fn GetPatternFilter(&self, pszpattern: &mut [u16]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPatternFilter)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pszpattern.as_ptr()),
                pszpattern.len().try_into().unwrap(),
            )
            .ok()
        }
    }
...
pub struct IOfflineFilesItemFilter_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetFilterFlags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u64,
        *mut u64,
    ) -> windows_core::HRESULT,
    pub GetTimeFilter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::FILETIME,
        *mut windows_core::BOOL,
        *mut OFFLINEFILES_ITEM_TIME,
        *mut OFFLINEFILES_COMPARE,
    ) -> windows_core::HRESULT,
    pub GetPatternFilter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PWSTR,
        u32,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IOfflineFilesItemFilter_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesItemFilter_Impl::GetFilterFlags(
                    this,
                    core::mem::transmute_copy(&pullflags),
                    core::mem::transmute_copy(&pullmask),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetTimeFilter<
            Identity: IOfflineFilesItemFilter_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesItemFilter_Impl::GetTimeFilter(
                    this,
                    core::mem::transmute_copy(&pfttime),
                    core::mem::transmute_copy(&pbevaltimeofday),
                    core::mem::transmute_copy(&ptimetype),
                    core::mem::transmute_copy(&pcompare),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetPatternFilter<
            Identity: IOfflineFilesItemFilter_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesItemFilter_Impl::GetPatternFilter(
                    this,
                    core::mem::transmute_copy(&pszpattern),
                    core::mem::transmute_copy(&cchpattern),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x5b2b0655_b3fd_497d_adeb_bd156bc8355b
);
...
impl IOfflineFilesPinInfo {
    pub unsafe fn IsPinned(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsPinned)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn IsPinnedForUser(
        &self,
        pbpinnedforuser: *mut windows_core::BOOL,
        pbinherit: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).IsPinnedForUser)(
                windows_core::Interface::as_raw(self),
                pbpinnedforuser as _,
                pbinherit as _,
            )
            .ok()
        }
    ...
    pub unsafe fn IsPinnedForUserByPolicy(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).IsPinnedForUserByPolicy)(
                windows_core::Interface::as_raw(self),
                pbpinnedforuser as _,
                pbinherit as _,
            )
    ...
    pub unsafe fn IsPinnedForComputer(
        &self,
        pbpinnedforcomputer: *mut windows_core::BOOL,
        pbinherit: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).IsPinnedForComputer)(
                windows_core::Interface::as_raw(self),
                pbpinnedforcomputer as _,
                pbinherit as _,
            )
            .ok()
        }
    ...
    pub unsafe fn IsPinnedForFolderRedirection(
        &self,
        pbpinnedforfolderredirection: *mut windows_core::BOOL,
        pbinherit: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).IsPinnedForFolderRedirection)(
                windows_core::Interface::as_raw(self),
                pbpinnedforfolderredirection as _,
                pbinherit as _,
            )
            .ok()
        }
...
pub struct IOfflineFilesPinInfo_Vtbl {
    ...
    pub IsPinnedForUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub IsPinnedForUserByPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub IsPinnedForComputer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub IsPinnedForFolderRedirection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
...
impl IOfflineFilesPinInfo_Vtbl {
    pub const fn new<Identity: IOfflineFilesPinInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsPinned<
            Identity: IOfflineFilesPinInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbpinned: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesPinInfo_Impl::IsPinnedForUser(
                    this,
                    core::mem::transmute_copy(&pbpinnedforuser),
                    core::mem::transmute_copy(&pbinherit),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesPinInfo_Impl::IsPinnedForUserByPolicy(
                    this,
                    core::mem::transmute_copy(&pbpinnedforuser),
                    core::mem::transmute_copy(&pbinherit),
                )
        ...
        unsafe extern "system" fn IsPinnedForComputer<
            Identity: IOfflineFilesPinInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesPinInfo_Impl::IsPinnedForComputer(
                    this,
                    core::mem::transmute_copy(&pbpinnedforcomputer),
                    core::mem::transmute_copy(&pbinherit),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsPinnedForFolderRedirection<
            Identity: IOfflineFilesPinInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesPinInfo_Impl::IsPinnedForFolderRedirection(
                    this,
                    core::mem::transmute_copy(&pbpinnedforfolderredirection),
                    core::mem::transmute_copy(&pbinherit),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0x623c58a2_42ed_4ad7_b69a_0f1b30a72d0d
);
...
impl IOfflineFilesPinInfo2 {
    pub unsafe fn IsPartlyPinned(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsPartlyPinned)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IOfflineFilesPinInfo2_Vtbl {
    ...
    pub IsPartlyPinned: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
}
...
impl IOfflineFilesPinInfo2_Vtbl {
    pub const fn new<Identity: IOfflineFilesPinInfo2_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            pbpartlypinned: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: IOfflineFilesPinInfo_Vtbl::new::<Identity, OFFSET>(),
            IsPartlyPinned: IsPartlyPinned::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xfad63237_c55b_4911_9850_bcf96d4c979e
);
...
impl IOfflineFilesProgress {
    ...
    pub unsafe fn QueryAbort(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).QueryAbort)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IOfflineFilesProgress_Vtbl {
    ...
    pub QueryAbort: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
...
impl IOfflineFilesProgress_Vtbl {
    pub const fn new<Identity: IOfflineFilesProgress_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn QueryAbort<
            Identity: IOfflineFilesProgress_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn End<Identity: IOfflineFilesProgress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hrresult: windows_core::HRESULT,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    ...
    IOfflineFilesServerItem_Vtbl,
    0x9b1c9576_a92b_4151_8e9e_7c7b3ec2e016
);
...
windows_core::imp::define_interface!(
    ...
    0xd871d3f7_f613_48a1_827e_7a34e560fff6
);
...
impl IOfflineFilesSetting {
    ...
    pub unsafe fn GetValueType(&self) -> windows_core::Result<OFFLINEFILES_SETTING_VALUE_TYPE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetValueType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetPreference(
        &self,
        pvarvalue: *mut super::super::System::Variant::VARIANT,
        dwscope: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPreference)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn GetPreferenceScope(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPreferenceScope)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetPreference(
        &self,
        pvarvalue: *const super::super::System::Variant::VARIANT,
        dwscope: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPreference)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pvarvalue),
                dwscope,
            )
    ...
    pub unsafe fn DeletePreference(&self, dwscope: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeletePreference)(
                windows_core::Interface::as_raw(self),
                dwscope,
            )
            .ok()
    ...
    pub unsafe fn GetPolicyScope(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPolicyScope)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetValue(
        &self,
        pvarvalue: *mut super::super::System::Variant::VARIANT,
        pbsetbypolicy: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
...
pub struct IOfflineFilesSetting_Vtbl {
    ...
    pub GetValueType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut OFFLINEFILES_SETTING_VALUE_TYPE,
    ) -> windows_core::HRESULT,
    #[cfg(all(
        feature = "Win32_System_Com",
        feature = "Win32_System_Ole",
    ...
    pub GetPreference: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub SetPreference: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IOfflineFilesSetting_Vtbl {
    pub const fn new<Identity: IOfflineFilesSetting_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetValueType<
            Identity: IOfflineFilesSetting_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetPreference<
            Identity: IOfflineFilesSetting_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesSetting_Impl::GetPreference(
                    this,
        ...
        unsafe extern "system" fn GetPreferenceScope<
            Identity: IOfflineFilesSetting_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetPreference<
            Identity: IOfflineFilesSetting_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesSetting_Impl::SetPreference(
                    this,
                    core::mem::transmute_copy(&pvarvalue),
                    core::mem::transmute_copy(&dwscope),
                )
        ...
        unsafe extern "system" fn DeletePreference<
            Identity: IOfflineFilesSetting_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesSetting_Impl::DeletePreference(
                    this,
                    core::mem::transmute_copy(&dwscope),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesSetting_Impl::GetPolicy(
                    this,
                    core::mem::transmute_copy(&pvarvalue),
                    core::mem::transmute_copy(&dwscope),
                )
        ...
        unsafe extern "system" fn GetPolicyScope<
            Identity: IOfflineFilesSetting_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesSetting_Impl::GetValue(
                    this,
                    core::mem::transmute_copy(&pvarvalue),
                    core::mem::transmute_copy(&pbsetbypolicy),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x7bcc43e7_31ce_4ca4_8ccd_1cff2dc494da
);
...
impl IOfflineFilesShareInfo {
    pub unsafe fn GetShareItem(&self) -> windows_core::Result<IOfflineFilesShareItem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetShareItem)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetShareCachingMode(&self) -> windows_core::Result<OFFLINEFILES_CACHING_MODE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetShareCachingMode)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn IsShareDfsJunction(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsShareDfsJunction)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IOfflineFilesShareInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetShareItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetShareCachingMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut OFFLINEFILES_CACHING_MODE,
    ) -> windows_core::HRESULT,
    pub IsShareDfsJunction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
}
...
impl IOfflineFilesShareInfo_Vtbl {
    pub const fn new<Identity: IOfflineFilesShareInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetShareItem<
            Identity: IOfflineFilesShareInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppshareitem: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetShareCachingMode<
            Identity: IOfflineFilesShareInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn IsShareDfsJunction<
            Identity: IOfflineFilesShareInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbisdfsjunction: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    IOfflineFilesShareItem_Vtbl,
    0xbab7e48d_4804_41b5_a44d_0f199b06b145
);
...
windows_core::imp::define_interface!(
    ...
    0xc34f7f9b_c43d_4f9d_a776_c0eb6de5d401
);
...
impl IOfflineFilesSimpleProgress {
    pub unsafe fn ItemBegin<P0>(
        &self,
        pszfile: P0,
    ) -> windows_core::Result<OFFLINEFILES_OP_RESPONSE>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ItemBegin)(
                windows_core::Interface::as_raw(self),
                pszfile.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ItemResult)(
                windows_core::Interface::as_raw(self),
                pszfile.param().abi(),
                hrresult,
                &mut result__,
...
pub struct IOfflineFilesSimpleProgress_Vtbl {
    ...
    pub ItemBegin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut OFFLINEFILES_OP_RESPONSE,
    ) -> windows_core::HRESULT,
    pub ItemResult: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::HRESULT,
        *mut OFFLINEFILES_OP_RESPONSE,
...
impl IOfflineFilesSimpleProgress_Vtbl {
    pub const fn new<Identity: IOfflineFilesSimpleProgress_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ItemBegin<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IOfflineFilesSimpleProgress_Impl::ItemBegin(
                    this,
                    core::mem::transmute(&pszfile),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn ItemResult<
            Identity: IOfflineFilesSimpleProgress_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IOfflineFilesSimpleProgress_Impl::ItemResult(
                    this,
                    core::mem::transmute(&pszfile),
                    core::mem::transmute_copy(&hrresult),
                ) {
...
windows_core::imp::define_interface!(
    ...
    IOfflineFilesSuspend_Vtbl,
    0x62c4560f_bc0b_48ca_ad9d_34cb528d99a9
);
...
impl IOfflineFilesSuspend {
    pub unsafe fn SuspendRoot(&self, bsuspend: bool) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SuspendRoot)(
                windows_core::Interface::as_raw(self),
                bsuspend.into(),
            )
            .ok()
...
pub struct IOfflineFilesSuspend_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SuspendRoot: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
}
...
impl IOfflineFilesSuspend_Vtbl {
    pub const fn new<Identity: IOfflineFilesSuspend_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SuspendRoot<
            Identity: IOfflineFilesSuspend_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bsuspend: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesSuspend_Impl::SuspendRoot(this, core::mem::transmute_copy(&bsuspend))
                    .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            SuspendRoot: SuspendRoot::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    IOfflineFilesSuspendInfo_Vtbl,
    0xa457c25b_4e9c_4b04_85af_8932ccd97889
);
...
impl IOfflineFilesSuspendInfo {
    pub unsafe fn IsSuspended(
        &self,
        pbsuspended: *mut windows_core::BOOL,
        pbsuspendedroot: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).IsSuspended)(
                windows_core::Interface::as_raw(self),
                pbsuspended as _,
                pbsuspendedroot as _,
            )
            .ok()
        }
    }
    ...
    pub const fn new<Identity: IOfflineFilesSuspendInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesSuspendInfo_Impl::IsSuspended(
                    this,
                    core::mem::transmute_copy(&pbsuspended),
                    core::mem::transmute_copy(&pbsuspendedroot),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xb6dd5092_c65c_46b6_97b8_fadd08e7e1be
);
...
impl IOfflineFilesSyncConflictHandler {
    pub unsafe fn ResolveConflict<P0>(
        &self,
        pszpath: P0,
        fstateknown: u32,
        ...
        ppsznewname: *mut windows_core::PWSTR,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).ResolveConflict)(
                windows_core::Interface::as_raw(self),
                pszpath.param().abi(),
                fstateknown,
                state,
                fchangedetails,
                pconflictresolution as _,
                ppsznewname as _,
            )
            .ok()
        }
...
pub struct IOfflineFilesSyncConflictHandler_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ResolveConflict: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        OFFLINEFILES_SYNC_STATE,
        u32,
        *mut OFFLINEFILES_SYNC_CONFLICT_RESOLVE,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
}
...
impl IOfflineFilesSyncConflictHandler_Vtbl {
    ...
    {
        unsafe extern "system" fn ResolveConflict<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesSyncConflictHandler_Impl::ResolveConflict(
                    this,
                    core::mem::transmute(&pszpath),
                    core::mem::transmute_copy(&fstateknown),
                    core::mem::transmute_copy(&state),
                    core::mem::transmute_copy(&fchangedetails),
                    core::mem::transmute_copy(&pconflictresolution),
                    core::mem::transmute_copy(&ppsznewname),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            ResolveConflict: ResolveConflict::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IOfflineFilesSyncErrorInfo {
    pub unsafe fn GetSyncOperation(&self) -> windows_core::Result<OFFLINEFILES_SYNC_OPERATION> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSyncOperation)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetItemChangeFlags(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetItemChangeFlags)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn InfoEnumerated(
        &self,
        pblocalenumerated: *mut windows_core::BOOL,
        pbremoteenumerated: *mut windows_core::BOOL,
        pboriginalenumerated: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).InfoEnumerated)(
                windows_core::Interface::as_raw(self),
                pblocalenumerated as _,
                pbremoteenumerated as _,
                pboriginalenumerated as _,
            )
            .ok()
        }
    }
    pub unsafe fn InfoAvailable(
        &self,
        pblocalinfo: *mut windows_core::BOOL,
        pbremoteinfo: *mut windows_core::BOOL,
        pboriginalinfo: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).InfoAvailable)(
                windows_core::Interface::as_raw(self),
                pblocalinfo as _,
                pbremoteinfo as _,
                pboriginalinfo as _,
    ...
    pub unsafe fn GetLocalInfo(&self) -> windows_core::Result<IOfflineFilesSyncErrorItemInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLocalInfo)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetRemoteInfo(&self) -> windows_core::Result<IOfflineFilesSyncErrorItemInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRemoteInfo)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetOriginalInfo(&self) -> windows_core::Result<IOfflineFilesSyncErrorItemInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOriginalInfo)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IOfflineFilesSyncErrorInfo_Vtbl {
    ...
    pub GetSyncOperation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut OFFLINEFILES_SYNC_OPERATION,
    ) -> windows_core::HRESULT,
    pub GetItemChangeFlags:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub InfoEnumerated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
        *mut windows_core::BOOL,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub InfoAvailable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
        *mut windows_core::BOOL,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub GetLocalInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetRemoteInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetOriginalInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IOfflineFilesSyncErrorInfo_Vtbl {
    pub const fn new<Identity: IOfflineFilesSyncErrorInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetSyncOperation<
        ...
        unsafe extern "system" fn GetItemChangeFlags<
            Identity: IOfflineFilesSyncErrorInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesSyncErrorInfo_Impl::InfoEnumerated(
                    this,
                    core::mem::transmute_copy(&pblocalenumerated),
                    core::mem::transmute_copy(&pbremoteenumerated),
                    core::mem::transmute_copy(&pboriginalenumerated),
                )
                .into()
            }
        }
        unsafe extern "system" fn InfoAvailable<
            Identity: IOfflineFilesSyncErrorInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesSyncErrorInfo_Impl::InfoAvailable(
                    this,
                    core::mem::transmute_copy(&pblocalinfo),
                    core::mem::transmute_copy(&pbremoteinfo),
                    core::mem::transmute_copy(&pboriginalinfo),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetLocalInfo<
            Identity: IOfflineFilesSyncErrorInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppinfo: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetRemoteInfo<
            Identity: IOfflineFilesSyncErrorInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetOriginalInfo<
            Identity: IOfflineFilesSyncErrorInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xecdbaf0d_6a18_4d55_8017_108f7660ba44
);
...
impl IOfflineFilesSyncErrorItemInfo {
    pub unsafe fn GetFileAttributes(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFileAttributes)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetFileTimes(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetFileTimes)(
                windows_core::Interface::as_raw(self),
                pftlastwrite as _,
                pftchange as _,
            )
...
pub struct IOfflineFilesSyncErrorItemInfo_Vtbl {
    ...
    pub GetFileAttributes:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetFileTimes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::FILETIME,
        *mut super::super::Foundation::FILETIME,
    ) -> windows_core::HRESULT,
...
impl IOfflineFilesSyncErrorItemInfo_Vtbl {
    pub const fn new<Identity: IOfflineFilesSyncErrorItemInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetFileTimes<
            Identity: IOfflineFilesSyncErrorItemInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOfflineFilesSyncErrorItemInfo_Impl::GetFileTimes(
                    this,
                    core::mem::transmute_copy(&pftlastwrite),
                    core::mem::transmute_copy(&pftchange),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x6931f49a_6fc7_4c1b_b265_56793fc451b7
);
...
impl IOfflineFilesSyncProgress {
    pub unsafe fn SyncItemBegin<P0>(
        &self,
        pszfile: P0,
    ) -> windows_core::Result<OFFLINEFILES_OP_RESPONSE>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SyncItemBegin)(
                windows_core::Interface::as_raw(self),
                pszfile.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn SyncItemResult<P0, P2>(
        &self,
        pszfile: P0,
        hrresult: windows_core::HRESULT,
        perrorinfo: P2,
        ...
        P2: windows_core::Param<IOfflineFilesSyncErrorInfo>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SyncItemResult)(
                windows_core::Interface::as_raw(self),
                pszfile.param().abi(),
                hrresult,
                perrorinfo.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
...
pub struct IOfflineFilesSyncProgress_Vtbl {
    pub base__: IOfflineFilesProgress_Vtbl,
    pub SyncItemBegin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut OFFLINEFILES_OP_RESPONSE,
    ) -> windows_core::HRESULT,
    pub SyncItemResult: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::HRESULT,
        *mut core::ffi::c_void,
    ...
    pub const fn new<Identity: IOfflineFilesSyncProgress_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IOfflineFilesSyncProgress_Impl::SyncItemBegin(
                    this,
                    core::mem::transmute(&pszfile),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SyncItemResult<
            Identity: IOfflineFilesSyncProgress_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pszfile: windows_core::PCWSTR,
            hrresult: windows_core::HRESULT,
            perrorinfo: *mut core::ffi::c_void,
            presponse: *mut OFFLINEFILES_OP_RESPONSE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IOfflineFilesSyncProgress_Impl::SyncItemResult(
                    this,
                    core::mem::transmute(&pszfile),
                    core::mem::transmute_copy(&hrresult),
...
windows_core::imp::define_interface!(
    ...
    0xbcaf4a01_5b68_4b56_a6a1_8d2786ede8e3
);
...
impl IOfflineFilesTransparentCacheInfo {
    pub unsafe fn IsTransparentlyCached(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsTransparentlyCached)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IOfflineFilesTransparentCacheInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub IsTransparentlyCached: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
}
...
impl IOfflineFilesTransparentCacheInfo_Vtbl {
    ...
    {
        unsafe extern "system" fn IsTransparentlyCached<
            Identity: IOfflineFilesTransparentCacheInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbtransparentlycached: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            IsTransparentlyCached: IsTransparentlyCached::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub const OFFLINEFILES_SETTING_PinLinkTargets: windows_core::PCWSTR =
    windows_core::w!("LinkTargetCaching");
...
pub const OfflineFilesCache: windows_core::GUID =
    windows_core::GUID::from_u128(0x48c6be7c_3871_43cc_b46f_1449a1bb2ff3);
pub const OfflineFilesSetting: windows_core::GUID =
    windows_core::GUID::from_u128(0xfd3659e9_a920_4123_ad64_7fc76c7aacdf);

...
#[inline]
pub unsafe fn CallFunctionShim<P0, P1, P4>(
    szdllname: P0,
    szfunctionname: P1,
    lpvargument1: *mut core::ffi::c_void,
    lpvargument2: *mut core::ffi::c_void,
    szversion: P4,
...
#[inline]
pub unsafe fn CorBindToRuntime<P0, P1>(
    pwszversion: P0,
    pwszbuildflavor: P1,
    rclsid: *const windows_core::GUID,
    riid: *const windows_core::GUID,
...
#[inline]
pub unsafe fn CorLaunchApplication<P1>(
    dwclickoncehost: HOST_TYPE,
    pwzappfullname: P1,
    dwmanifestpaths: u32,
    ppwzmanifestpaths: *const windows_core::PCWSTR,
    dwactivationdata: u32,
    ppwzactivationdata: *const windows_core::PCWSTR,
    lpprocessinformation: *mut super::Threading::PROCESS_INFORMATION,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn CreateDebuggingInterfaceFromVersion<P1>(
    idebuggerversion: i32,
    szdebuggeeversion: P1,
...
#[inline]
pub unsafe fn GetCLRIdentityManager(
    riid: *const windows_core::GUID,
) -> windows_core::Result<windows_core::IUnknown> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        GetCLRIdentityManager(riid, &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
pub unsafe fn GetCORRequiredVersion(
    pbuffer: &mut [u16],
    dwlength: *mut u32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn GetFileVersion<P0>(
    szfilename: P0,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        GetRequestedRuntimeVersion(
            pexe.param().abi(),
            core::mem::transmute(pversion.as_ptr()),
            pversion.len().try_into().unwrap(),
            dwlength as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn GetRequestedRuntimeVersionForCLSID(
    rclsid: *const windows_core::GUID,
    pversion: Option<&mut [u16]>,
    dwlength: Option<*mut u32>,
...
#[inline]
pub unsafe fn GetVersionFromProcess(
...
pub unsafe fn LoadLibraryShim<P0, P1>(
    ...
    szversion: P1,
    pvreserved: *mut core::ffi::c_void,
    phmoddll: *mut super::super::Foundation::HMODULE,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn LoadStringRC(
    ...
    unsafe {
        LoadStringRC(
            iresouceid,
            core::mem::transmute(szbuffer.as_ptr()),
            szbuffer.len().try_into().unwrap(),
            bquiet,
        )
        .ok()
    }
...
pub const APPDOMAIN_FORCE_TRIVIAL_WAIT_OPERATIONS: APPDOMAIN_SECURITY_FLAGS =
    APPDOMAIN_SECURITY_FLAGS(8i32);
...
pub const APPDOMAIN_SECURITY_FORBID_CROSSAD_REVERSE_PINVOKE: APPDOMAIN_SECURITY_FLAGS =
    APPDOMAIN_SECURITY_FLAGS(2i32);
...
pub type CLRCreateInstanceFnPtr = Option<
...
>;
pub const CLRRuntimeHost: windows_core::GUID =
    windows_core::GUID::from_u128(0x90f1a06e_7712_4762_86b5_7a5eba6bdb02);
pub const CLR_ASSEMBLY_BUILD_VERSION: u32 = 0u32;
pub const CLR_ASSEMBLY_IDENTITY_FLAGS_DEFAULT: ECLRAssemblyIdentityFlags =
    ECLRAssemblyIdentityFlags(0i32);
...
pub const CLR_DEBUGGING_MANAGED_EVENT_DEBUGGER_LAUNCH: CLR_DEBUGGING_PROCESS_FLAGS =
    CLR_DEBUGGING_PROCESS_FLAGS(2i32);
pub const CLR_DEBUGGING_MANAGED_EVENT_PENDING: CLR_DEBUGGING_PROCESS_FLAGS =
    CLR_DEBUGGING_PROCESS_FLAGS(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CLSID_CLRDebugging: windows_core::GUID =
    windows_core::GUID::from_u128(0xbacc578d_fbdd_48a4_969f_02d932b74634);
pub const CLSID_CLRDebuggingLegacy: windows_core::GUID =
    windows_core::GUID::from_u128(0xdf8395b5_a4ba_450b_a77c_a9a47762c520);
pub const CLSID_CLRMetaHost: windows_core::GUID =
    windows_core::GUID::from_u128(0x9280188d_0e8e_4867_b30c_7fa83884e8de);
pub const CLSID_CLRMetaHostPolicy: windows_core::GUID =
    windows_core::GUID::from_u128(0x2ebcd49a_1b47_4a61_b13a_4a03701e594b);
pub const CLSID_CLRProfiling: windows_core::GUID =
    windows_core::GUID::from_u128(0xbd097ed8_733e_43fe_8ed7_a95ff9a8448c);
pub const CLSID_CLRStrongName: windows_core::GUID =
    windows_core::GUID::from_u128(0xb79b0acd_f5cd_409b_b5a5_a16244610b92);
...
pub const COR_GC_THREAD_HAS_PROMOTED_BYTES: COR_GC_THREAD_STATS_TYPES =
    COR_GC_THREAD_STATS_TYPES(1i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const ComCallUnmarshal: windows_core::GUID =
    windows_core::GUID::from_u128(0x3f281000_e95a_11d2_886b_00c04f869f04);
pub const ComCallUnmarshalV4: windows_core::GUID =
    windows_core::GUID::from_u128(0x45fb4600_e6e8_4928_b25e_50476ff79425);
pub const CorRuntimeHost: windows_core::GUID =
    windows_core::GUID::from_u128(0xcb2f6723_ab3a_11d2_9c40_00c04fa30a3e);
pub type CreateInterfaceFnPtr = Option<
    unsafe extern "system" fn(
        clsid: *const windows_core::GUID,
        riid: *const windows_core::GUID,
        ppinterface: *mut *mut core::ffi::c_void,
...
pub type FExecuteInAppDomainCallback =
    Option<unsafe extern "system" fn(cookie: *mut core::ffi::c_void) -> windows_core::HRESULT>;
...
pub const HOST_BINDING_POLICY_MODIFY_CHAIN: EHostBindingPolicyModifyFlags =
    EHostBindingPolicyModifyFlags(1i32);
pub const HOST_BINDING_POLICY_MODIFY_DEFAULT: EHostBindingPolicyModifyFlags =
    EHostBindingPolicyModifyFlags(0i32);
pub const HOST_BINDING_POLICY_MODIFY_MAX: EHostBindingPolicyModifyFlags =
    EHostBindingPolicyModifyFlags(3i32);
pub const HOST_BINDING_POLICY_MODIFY_REMOVE: EHostBindingPolicyModifyFlags =
    EHostBindingPolicyModifyFlags(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
windows_core::imp::define_interface!(
    IActionOnCLREvent,
    IActionOnCLREvent_Vtbl,
    0x607be24b_d91b_4e28_a242_61871ce56e35
);
...
pub trait IActionOnCLREvent_Impl: windows_core::IUnknownImpl {
    fn OnEvent(&self, event: EClrEvent, data: *const core::ffi::c_void)
        -> windows_core::Result<()>;
}
impl IActionOnCLREvent_Vtbl {
    pub const fn new<Identity: IActionOnCLREvent_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnEvent<Identity: IActionOnCLREvent_Impl, const OFFSET: isize>(
            ...
            unsafe {
                ...
                IActionOnCLREvent_Impl::OnEvent(
                    this,
...
windows_core::imp::define_interface!(
    IApartmentCallback,
    IApartmentCallback_Vtbl,
    0x178e5337_1528_4591_b1c9_1c6e484686d8
);
    ...
    pub const fn new<Identity: IApartmentCallback_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IApartmentCallback_Impl::DoCallback(
                    this,
                    core::mem::transmute_copy(&pfunc),
...
windows_core::imp::define_interface!(
    ...
    0x5c2b07a7_1e98_11d3_872f_00c04f79ed0d
);
...
impl IAppDomainBinding {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnAppDomain)(
                windows_core::Interface::as_raw(self),
                pappdomain.param().abi(),
            )
            .ok()
        }
    }
...
pub struct IAppDomainBinding_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OnAppDomain: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IAppDomainBinding_Impl: windows_core::IUnknownImpl {
    fn OnAppDomain(
        &self,
        pappdomain: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
}
impl IAppDomainBinding_Vtbl {
    pub const fn new<Identity: IAppDomainBinding_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnAppDomain<
            Identity: IAppDomainBinding_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pappdomain: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAppDomainBinding_Impl::OnAppDomain(this, core::mem::transmute_copy(&pappdomain))
                    .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            OnAppDomain: OnAppDomain::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xc62de18c_2e23_4aea_8423_b40c1fc59eae
);
windows_core::imp::interface_hierarchy!(ICLRAppDomainResourceMonitor, windows_core::IUnknown);
impl ICLRAppDomainResourceMonitor {
    pub unsafe fn GetCurrentAllocated(
        &self,
        dwappdomainid: u32,
        pbytesallocated: *mut u64,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetCurrentAllocated)(
                windows_core::Interface::as_raw(self),
                dwappdomainid,
                pbytesallocated as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetCurrentSurvived(
        &self,
        dwappdomainid: u32,
        pappdomainbytessurvived: *mut u64,
        ptotalbytessurvived: *mut u64,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetCurrentSurvived)(
                windows_core::Interface::as_raw(self),
                dwappdomainid,
                pappdomainbytessurvived as _,
                ptotalbytessurvived as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetCurrentCpuTime(
        &self,
        dwappdomainid: u32,
        pmilliseconds: *mut u64,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetCurrentCpuTime)(
                windows_core::Interface::as_raw(self),
                dwappdomainid,
                pmilliseconds as _,
            )
...
pub struct ICLRAppDomainResourceMonitor_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetCurrentAllocated:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut u64) -> windows_core::HRESULT,
    pub GetCurrentSurvived: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u64,
        *mut u64,
    ) -> windows_core::HRESULT,
    pub GetCurrentCpuTime:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut u64) -> windows_core::HRESULT,
}
...
impl ICLRAppDomainResourceMonitor_Vtbl {
    pub const fn new<Identity: ICLRAppDomainResourceMonitor_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCurrentAllocated<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRAppDomainResourceMonitor_Impl::GetCurrentAllocated(
                    this,
                    core::mem::transmute_copy(&dwappdomainid),
                    core::mem::transmute_copy(&pbytesallocated),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetCurrentSurvived<
            Identity: ICLRAppDomainResourceMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRAppDomainResourceMonitor_Impl::GetCurrentSurvived(
                    this,
                    core::mem::transmute_copy(&dwappdomainid),
                    core::mem::transmute_copy(&pappdomainbytessurvived),
                    core::mem::transmute_copy(&ptotalbytessurvived),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetCurrentCpuTime<
            Identity: ICLRAppDomainResourceMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRAppDomainResourceMonitor_Impl::GetCurrentCpuTime(
                    this,
                    core::mem::transmute_copy(&dwappdomainid),
                    core::mem::transmute_copy(&pmilliseconds),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x15f0a9da_3ff6_4393_9da9_fdfd284e6972
);
windows_core::imp::interface_hierarchy!(ICLRAssemblyIdentityManager, windows_core::IUnknown);
impl ICLRAssemblyIdentityManager {
    pub unsafe fn GetCLRAssemblyReferenceList(
        &self,
        ppwzassemblyreferences: *const windows_core::PCWSTR,
        dwnumofreferences: u32,
    ) -> windows_core::Result<ICLRAssemblyReferenceList> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCLRAssemblyReferenceList)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn GetBindingIdentityFromFile<P0>(
        &self,
        pwzfilepath: P0,
        dwflags: u32,
        pwzbuffer: windows_core::PWSTR,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetBindingIdentityFromFile)(
                windows_core::Interface::as_raw(self),
                pwzfilepath.param().abi(),
                dwflags,
                core::mem::transmute(pwzbuffer),
                pcchbuffersize as _,
            )
            .ok()
        }
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetBindingIdentityFromStream<P0>(
        &self,
        pstream: P0,
        dwflags: u32,
        pwzbuffer: windows_core::PWSTR,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetBindingIdentityFromStream)(
                windows_core::Interface::as_raw(self),
                pstream.param().abi(),
                dwflags,
                core::mem::transmute(pwzbuffer),
    ...
    pub unsafe fn GetReferencedAssembliesFromFile<P0, P2>(
        &self,
        pwzfilepath: P0,
        dwflags: u32,
        pexcludeassemblieslist: P2,
    ) -> windows_core::Result<ICLRReferenceAssemblyEnum>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<ICLRAssemblyReferenceList>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetReferencedAssembliesFromFile)(
                windows_core::Interface::as_raw(self),
                pwzfilepath.param().abi(),
                dwflags,
                pexcludeassemblieslist.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetReferencedAssembliesFromStream<P0, P2>(
        &self,
        pstream: P0,
        dwflags: u32,
        pexcludeassemblieslist: P2,
        ...
        P2: windows_core::Param<ICLRAssemblyReferenceList>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetReferencedAssembliesFromStream)(
                windows_core::Interface::as_raw(self),
                pstream.param().abi(),
                dwflags,
                pexcludeassemblieslist.param().abi(),
    ...
    pub unsafe fn GetProbingAssembliesFromReference<P2>(
        &self,
        dwmachinetype: u32,
        dwflags: u32,
        pwzreferenceidentity: P2,
    ) -> windows_core::Result<ICLRProbingAssemblyEnum>
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetProbingAssembliesFromReference)(
                windows_core::Interface::as_raw(self),
                dwmachinetype,
                dwflags,
                pwzreferenceidentity.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn IsStronglyNamed<P0>(
        &self,
        pwzassemblyidentity: P0,
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsStronglyNamed)(
                windows_core::Interface::as_raw(self),
                pwzassemblyidentity.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
...
pub struct ICLRAssemblyIdentityManager_Vtbl {
    ...
    pub GetProbingAssembliesFromReference: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        windows_core::PCWSTR,
...
pub trait ICLRAssemblyIdentityManager_Impl: windows_core::IUnknownImpl {
    ...
    fn GetBindingIdentityFromFile(
        &self,
        pwzfilepath: &windows_core::PCWSTR,
        dwflags: u32,
        pwzbuffer: windows_core::PWSTR,
        pcchbuffersize: *mut u32,
    ) -> windows_core::Result<()>;
    fn GetBindingIdentityFromStream(
        &self,
        pstream: windows_core::Ref<'_, super::Com::IStream>,
        dwflags: u32,
        pwzbuffer: windows_core::PWSTR,
        pcchbuffersize: *mut u32,
    ) -> windows_core::Result<()>;
    fn GetReferencedAssembliesFromFile(
        ...
        pwzfilepath: &windows_core::PCWSTR,
        dwflags: u32,
        pexcludeassemblieslist: windows_core::Ref<'_, ICLRAssemblyReferenceList>,
    ) -> windows_core::Result<ICLRReferenceAssemblyEnum>;
    ...
    fn GetProbingAssembliesFromReference(
        ...
        dwmachinetype: u32,
        dwflags: u32,
        pwzreferenceidentity: &windows_core::PCWSTR,
    ) -> windows_core::Result<ICLRProbingAssemblyEnum>;
    fn IsStronglyNamed(
        &self,
        pwzassemblyidentity: &windows_core::PCWSTR,
    ) -> windows_core::Result<windows_core::BOOL>;
}
#[cfg(feature = "Win32_System_Com")]
impl ICLRAssemblyIdentityManager_Vtbl {
    pub const fn new<Identity: ICLRAssemblyIdentityManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCLRAssemblyReferenceList<
        ...
        >(
            ...
            ppwzassemblyreferences: *const windows_core::PCWSTR,
            dwnumofreferences: u32,
            ppreferencelist: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRAssemblyIdentityManager_Impl::GetCLRAssemblyReferenceList(
                    this,
                    core::mem::transmute_copy(&ppwzassemblyreferences),
                    core::mem::transmute_copy(&dwnumofreferences),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetBindingIdentityFromFile<
            Identity: ICLRAssemblyIdentityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRAssemblyIdentityManager_Impl::GetBindingIdentityFromFile(
                    this,
                    core::mem::transmute(&pwzfilepath),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&pwzbuffer),
                    core::mem::transmute_copy(&pcchbuffersize),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetBindingIdentityFromStream<
            Identity: ICLRAssemblyIdentityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRAssemblyIdentityManager_Impl::GetBindingIdentityFromStream(
                    this,
        ...
        >(
            ...
            pwzfilepath: windows_core::PCWSTR,
            dwflags: u32,
            pexcludeassemblieslist: *mut core::ffi::c_void,
            ppreferenceenum: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRAssemblyIdentityManager_Impl::GetReferencedAssembliesFromFile(
                    this,
                    core::mem::transmute(&pwzfilepath),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&pexcludeassemblieslist),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetReferencedAssembliesFromStream<
            Identity: ICLRAssemblyIdentityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRAssemblyIdentityManager_Impl::GetReferencedAssembliesFromStream(
                    this,
                    core::mem::transmute_copy(&pstream),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&pexcludeassemblieslist),
        ...
        unsafe extern "system" fn GetProbingAssembliesFromReference<
            Identity: ICLRAssemblyIdentityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            dwflags: u32,
            pwzreferenceidentity: windows_core::PCWSTR,
            ppprobingassemblyenum: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRAssemblyIdentityManager_Impl::GetProbingAssembliesFromReference(
                    this,
                    core::mem::transmute_copy(&dwmachinetype),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute(&pwzreferenceidentity),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn IsStronglyNamed<
            Identity: ICLRAssemblyIdentityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pwzassemblyidentity: windows_core::PCWSTR,
            pbisstronglynamed: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRAssemblyIdentityManager_Impl::IsStronglyNamed(
                    this,
                    core::mem::transmute(&pwzassemblyidentity),
                ) {
                    Ok(ok__) => {
...
impl ICLRAssemblyReferenceList {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).IsStringAssemblyReferenceInList)(
                windows_core::Interface::as_raw(self),
                pwzassemblyname.param().abi(),
            )
            .ok()
        }
    }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).IsAssemblyReferenceInList)(
                windows_core::Interface::as_raw(self),
                pname.param().abi(),
            )
            .ok()
...
pub struct ICLRAssemblyReferenceList_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub IsStringAssemblyReferenceInList: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub IsAssemblyReferenceInList: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
    ...
    pub const fn new<Identity: ICLRAssemblyReferenceList_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRAssemblyReferenceList_Impl::IsStringAssemblyReferenceInList(
                    this,
                    core::mem::transmute(&pwzassemblyname),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsAssemblyReferenceInList<
            Identity: ICLRAssemblyReferenceList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRAssemblyReferenceList_Impl::IsAssemblyReferenceInList(
                    this,
...
windows_core::imp::define_interface!(
    ICLRControl,
    ICLRControl_Vtbl,
    0x9065597e_d1a1_4fb2_b6ba_7e1fce230f61
);
...
impl ICLRControl {
    pub unsafe fn GetCLRManager(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetCLRManager)(
                windows_core::Interface::as_raw(self),
                riid,
                ppobject as _,
            )
    ...
    pub unsafe fn SetAppDomainManagerType<P0, P1>(
        &self,
        pwzappdomainmanagerassembly: P0,
        pwzappdomainmanagertype: P1,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetAppDomainManagerType)(
                windows_core::Interface::as_raw(self),
                pwzappdomainmanagerassembly.param().abi(),
                pwzappdomainmanagertype.param().abi(),
            )
            .ok()
        }
    }
...
pub struct ICLRControl_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetCLRManager: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetAppDomainManagerType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
...
pub trait ICLRControl_Impl: windows_core::IUnknownImpl {
    ...
    fn SetAppDomainManagerType(
        &self,
        pwzappdomainmanagerassembly: &windows_core::PCWSTR,
        pwzappdomainmanagertype: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
}
impl ICLRControl_Vtbl {
    pub const fn new<Identity: ICLRControl_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCLRManager<Identity: ICLRControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            riid: *const windows_core::GUID,
            ppobject: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRControl_Impl::GetCLRManager(
                    this,
        ...
        unsafe extern "system" fn SetAppDomainManagerType<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRControl_Impl::SetAppDomainManagerType(
                    this,
                    core::mem::transmute(&pwzappdomainmanagerassembly),
                    core::mem::transmute(&pwzappdomainmanagertype),
                )
                .into()
            }
        }
...
impl ICLRDebugManager {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).BeginConnection)(
                windows_core::Interface::as_raw(self),
                dwconnectionid,
                szconnectionname.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn SetConnectionTasks(
        &self,
        id: u32,
        ppclrtask: &[Option<ICLRTask>],
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetConnectionTasks)(
                windows_core::Interface::as_raw(self),
                id,
                ppclrtask.len().try_into().unwrap(),
                core::mem::transmute(ppclrtask.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn EndConnection(&self, dwconnectionid: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndConnection)(
                windows_core::Interface::as_raw(self),
                dwconnectionid,
            )
            .ok()
    ...
    pub unsafe fn SetDacl(
        &self,
        pacl: *const super::super::Security::ACL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDacl)(
                windows_core::Interface::as_raw(self),
                pacl,
            )
            .ok()
    ...
    pub unsafe fn GetDacl(&self) -> windows_core::Result<*mut super::super::Security::ACL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDacl)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn IsDebuggerAttached(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsDebuggerAttached)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSymbolReadingPolicy(
        &self,
        policy: ESymbolReadingPolicy,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSymbolReadingPolicy)(
                windows_core::Interface::as_raw(self),
                policy,
            )
            .ok()
...
pub struct ICLRDebugManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub BeginConnection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub SetConnectionTasks: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
    ...
    #[cfg(feature = "Win32_Security")]
    pub SetDacl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::super::Security::ACL,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Security"))]
    SetDacl: usize,
    #[cfg(feature = "Win32_Security")]
    pub GetDacl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::super::Security::ACL,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Security"))]
    GetDacl: usize,
    pub IsDebuggerAttached: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub SetSymbolReadingPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait ICLRDebugManager_Impl: windows_core::IUnknownImpl {
    fn BeginConnection(
        &self,
        dwconnectionid: u32,
        szconnectionname: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
...
impl ICLRDebugManager_Vtbl {
    pub const fn new<Identity: ICLRDebugManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BeginConnection<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRDebugManager_Impl::BeginConnection(
                    this,
                    core::mem::transmute_copy(&dwconnectionid),
                    core::mem::transmute(&szconnectionname),
                )
                .into()
            }
        }
        ...
        >(
            ...
            id: u32,
            dwcount: u32,
            ppclrtask: *const *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRDebugManager_Impl::SetConnectionTasks(
                    this,
                    core::mem::transmute_copy(&id),
                    core::mem::transmute_copy(&dwcount),
                    core::mem::transmute_copy(&ppclrtask),
                )
                .into()
            }
        }
        unsafe extern "system" fn EndConnection<
            Identity: ICLRDebugManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRDebugManager_Impl::EndConnection(
                    this,
                    core::mem::transmute_copy(&dwconnectionid),
                )
                .into()
        ...
        unsafe extern "system" fn SetDacl<Identity: ICLRDebugManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pacl: *const super::super::Security::ACL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetDacl<Identity: ICLRDebugManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pacl: *mut *mut super::super::Security::ACL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsDebuggerAttached<
            Identity: ICLRDebugManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbattached: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetSymbolReadingPolicy<
            Identity: ICLRDebugManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRDebugManager_Impl::SetSymbolReadingPolicy(
                    this,
...
windows_core::imp::define_interface!(
    ICLRDebugging,
    ICLRDebugging_Vtbl,
    0xd28f3c5a_9634_4206_a509_477552eefb10
);
windows_core::imp::interface_hierarchy!(ICLRDebugging, windows_core::IUnknown);
impl ICLRDebugging {
    pub unsafe fn OpenVirtualProcess<P1, P2>(
        &self,
        modulebaseaddress: u64,
        pdatatarget: P1,
        plibraryprovider: P2,
        pmaxdebuggersupportedversion: *const CLR_DEBUGGING_VERSION,
        riidprocess: *const windows_core::GUID,
        ppprocess: *mut Option<windows_core::IUnknown>,
        ...
        P2: windows_core::Param<ICLRDebuggingLibraryProvider>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).OpenVirtualProcess)(
                ...
                plibraryprovider.param().abi(),
                pmaxdebuggersupportedversion,
                riidprocess,
                core::mem::transmute(ppprocess),
                pversion as _,
                pdwflags as _,
            )
            .ok()
    ...
    pub unsafe fn CanUnloadNow(
        &self,
        hmodule: super::super::Foundation::HMODULE,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CanUnloadNow)(
                windows_core::Interface::as_raw(self),
                hmodule,
            )
            .ok()
...
pub struct ICLRDebugging_Vtbl {
    ...
    pub OpenVirtualProcess: unsafe extern "system" fn(
        ...
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const CLR_DEBUGGING_VERSION,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
        *mut CLR_DEBUGGING_VERSION,
        *mut CLR_DEBUGGING_PROCESS_FLAGS,
    ) -> windows_core::HRESULT,
    pub CanUnloadNow: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait ICLRDebugging_Impl: windows_core::IUnknownImpl {
    fn OpenVirtualProcess(
        &self,
        modulebaseaddress: u64,
        pdatatarget: windows_core::Ref<'_, windows_core::IUnknown>,
        plibraryprovider: windows_core::Ref<'_, ICLRDebuggingLibraryProvider>,
        pmaxdebuggersupportedversion: *const CLR_DEBUGGING_VERSION,
        riidprocess: *const windows_core::GUID,
        ppprocess: windows_core::OutRef<'_, windows_core::IUnknown>,
        pversion: *mut CLR_DEBUGGING_VERSION,
        pdwflags: *mut CLR_DEBUGGING_PROCESS_FLAGS,
    ) -> windows_core::Result<()>;
...
impl ICLRDebugging_Vtbl {
    pub const fn new<Identity: ICLRDebugging_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            plibraryprovider: *mut core::ffi::c_void,
            pmaxdebuggersupportedversion: *const CLR_DEBUGGING_VERSION,
            riidprocess: *const windows_core::GUID,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRDebugging_Impl::OpenVirtualProcess(
                    this,
                    core::mem::transmute_copy(&modulebaseaddress),
                    core::mem::transmute_copy(&pdatatarget),
                    core::mem::transmute_copy(&plibraryprovider),
                    core::mem::transmute_copy(&pmaxdebuggersupportedversion),
                    core::mem::transmute_copy(&riidprocess),
                    core::mem::transmute_copy(&ppprocess),
        ...
        unsafe extern "system" fn CanUnloadNow<
            Identity: ICLRDebugging_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl ICLRDebuggingLibraryProvider {
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProvideLibrary)(
                windows_core::Interface::as_raw(self),
...
pub struct ICLRDebuggingLibraryProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ProvideLibrary: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        u32,
        *mut super::super::Foundation::HMODULE,
    ) -> windows_core::HRESULT,
}
...
impl ICLRDebuggingLibraryProvider_Vtbl {
    pub const fn new<Identity: ICLRDebuggingLibraryProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ProvideLibrary<
        ...
        >(
            ...
            dwtimestamp: u32,
            dwsizeofimage: u32,
            phmodule: *mut super::super::Foundation::HMODULE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRDebuggingLibraryProvider_Impl::ProvideLibrary(
                    this,
                    core::mem::transmute(&pwszfilename),
                    core::mem::transmute_copy(&dwtimestamp),
                    core::mem::transmute_copy(&dwsizeofimage),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            ProvideLibrary: ProvideLibrary::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl ICLRDomainManager {
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetAppDomainManagerType)(
                windows_core::Interface::as_raw(self),
                wszappdomainmanagerassembly.param().abi(),
                wszappdomainmanagertype.param().abi(),
                dwinitializedomainflags,
            )
            .ok()
        }
    }
    pub unsafe fn SetPropertiesForDefaultAppDomain(
        &self,
        nproperties: u32,
        pwszpropertynames: *const windows_core::PCWSTR,
        pwszpropertyvalues: *const windows_core::PCWSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPropertiesForDefaultAppDomain)(
                windows_core::Interface::as_raw(self),
                nproperties,
                pwszpropertynames,
                pwszpropertyvalues,
...
pub struct ICLRDomainManager_Vtbl {
    ...
    pub SetPropertiesForDefaultAppDomain: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const windows_core::PCWSTR,
        *const windows_core::PCWSTR,
...
pub trait ICLRDomainManager_Impl: windows_core::IUnknownImpl {
    fn SetAppDomainManagerType(
        &self,
        wszappdomainmanagerassembly: &windows_core::PCWSTR,
        wszappdomainmanagertype: &windows_core::PCWSTR,
        dwinitializedomainflags: EInitializeNewDomainFlags,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: ICLRDomainManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRDomainManager_Impl::SetAppDomainManagerType(
                    this,
                    core::mem::transmute(&wszappdomainmanagerassembly),
                    core::mem::transmute(&wszappdomainmanagertype),
                    core::mem::transmute_copy(&dwinitializedomainflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetPropertiesForDefaultAppDomain<
            Identity: ICLRDomainManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRDomainManager_Impl::SetPropertiesForDefaultAppDomain(
                    this,
                    core::mem::transmute_copy(&nproperties),
                    core::mem::transmute_copy(&pwszpropertynames),
                    core::mem::transmute_copy(&pwszpropertyvalues),
                )
                .into()
            }
        }
...
impl ICLRErrorReportingManager {
    pub unsafe fn GetBucketParametersForCurrentException(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetBucketParametersForCurrentException)(
                windows_core::Interface::as_raw(self),
                pparams as _,
            )
            .ok()
    ...
    pub unsafe fn BeginCustomDump(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).BeginCustomDump)(
                windows_core::Interface::as_raw(self),
                dwflavor,
    ...
    pub unsafe fn EndCustomDump(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndCustomDump)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub struct ICLRErrorReportingManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetBucketParametersForCurrentException: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut BucketParameters,
    )
        -> windows_core::HRESULT,
    pub BeginCustomDump: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        ECustomDumpFlavor,
        u32,
        *const CustomDumpItem,
        u32,
    ) -> windows_core::HRESULT,
...
impl ICLRErrorReportingManager_Vtbl {
    pub const fn new<Identity: ICLRErrorReportingManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetBucketParametersForCurrentException<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRErrorReportingManager_Impl::GetBucketParametersForCurrentException(
                    this,
        ...
        unsafe extern "system" fn BeginCustomDump<
            Identity: ICLRErrorReportingManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRErrorReportingManager_Impl::BeginCustomDump(
                    this,
                    core::mem::transmute_copy(&dwflavor),
        ...
        unsafe extern "system" fn EndCustomDump<
            Identity: ICLRErrorReportingManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetBucketParametersForCurrentException: GetBucketParametersForCurrentException::<
                Identity,
                OFFSET,
            >,
...
windows_core::imp::define_interface!(
    ICLRGCManager,
    ICLRGCManager_Vtbl,
    0x54d9007e_a8e2_4885_b7bf_f998deee4f2a
);
...
impl ICLRGCManager {
    pub unsafe fn Collect(&self, generation: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Collect)(
                windows_core::Interface::as_raw(self),
                generation,
            )
            .ok()
    ...
    pub unsafe fn SetGCStartupLimits(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetGCStartupLimits)(
                windows_core::Interface::as_raw(self),
                segmentsize,
                maxgen0size,
            )
...
impl ICLRGCManager_Vtbl {
    pub const fn new<Identity: ICLRGCManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Collect<Identity: ICLRGCManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            generation: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetStats<Identity: ICLRGCManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetGCStartupLimits<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRGCManager_Impl::SetGCStartupLimits(
                    this,
                    core::mem::transmute_copy(&segmentsize),
                    core::mem::transmute_copy(&maxgen0size),
                )
                .into()
            }
        }
...
impl ICLRGCManager2 {
    pub unsafe fn SetGCStartupLimitsEx(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetGCStartupLimitsEx)(
                windows_core::Interface::as_raw(self),
                segmentsize,
                maxgen0size,
            )
...
impl ICLRGCManager2_Vtbl {
    pub const fn new<Identity: ICLRGCManager2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetGCStartupLimitsEx<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRGCManager2_Impl::SetGCStartupLimitsEx(
                    this,
                    core::mem::transmute_copy(&segmentsize),
                    core::mem::transmute_copy(&maxgen0size),
                )
        ...
        Self {
            base__: ICLRGCManager_Vtbl::new::<Identity, OFFSET>(),
            SetGCStartupLimitsEx: SetGCStartupLimitsEx::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x4b3545e7_1856_48c9_a8ba_24b21a753c09
);
windows_core::imp::interface_hierarchy!(ICLRHostBindingPolicyManager, windows_core::IUnknown);
impl ICLRHostBindingPolicyManager {
    pub unsafe fn ModifyApplicationPolicy<P0, P1>(
        &self,
        pwzsourceassemblyidentity: P0,
        pwztargetassemblyidentity: P1,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ModifyApplicationPolicy)(
                windows_core::Interface::as_raw(self),
                pwzsourceassemblyidentity.param().abi(),
                pwztargetassemblyidentity.param().abi(),
                pbapplicationpolicy,
                cbapppolicysize,
                dwpolicymodifyflags,
                pbnewapplicationpolicy as _,
                pcbnewapppolicysize as _,
            )
            .ok()
        }
    }
    pub unsafe fn EvaluatePolicy<P0>(
        &self,
        pwzreferenceidentity: P0,
        pbapplicationpolicy: *const u8,
        cbapppolicysize: u32,
        pwzpostpolicyreferenceidentity: windows_core::PWSTR,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EvaluatePolicy)(
                windows_core::Interface::as_raw(self),
                pwzreferenceidentity.param().abi(),
                pbapplicationpolicy,
                cbapppolicysize,
                core::mem::transmute(pwzpostpolicyreferenceidentity),
                pcchpostpolicyreferenceidentity as _,
                pdwpoliciesapplied as _,
            )
            .ok()
        }
    }
...
pub struct ICLRHostBindingPolicyManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ModifyApplicationPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *const u8,
    ...
    pub EvaluatePolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const u8,
        u32,
...
pub trait ICLRHostBindingPolicyManager_Impl: windows_core::IUnknownImpl {
    fn ModifyApplicationPolicy(
        &self,
        pwzsourceassemblyidentity: &windows_core::PCWSTR,
        pwztargetassemblyidentity: &windows_core::PCWSTR,
        pbapplicationpolicy: *const u8,
        cbapppolicysize: u32,
        dwpolicymodifyflags: u32,
        pbnewapplicationpolicy: *mut u8,
...
impl ICLRHostBindingPolicyManager_Vtbl {
    pub const fn new<Identity: ICLRHostBindingPolicyManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ModifyApplicationPolicy<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRHostBindingPolicyManager_Impl::ModifyApplicationPolicy(
                    this,
                    core::mem::transmute(&pwzsourceassemblyidentity),
                    core::mem::transmute(&pwztargetassemblyidentity),
                    core::mem::transmute_copy(&pbapplicationpolicy),
                    core::mem::transmute_copy(&cbapppolicysize),
                    core::mem::transmute_copy(&dwpolicymodifyflags),
                    core::mem::transmute_copy(&pbnewapplicationpolicy),
                    core::mem::transmute_copy(&pcbnewapppolicysize),
                )
                .into()
            }
        }
        unsafe extern "system" fn EvaluatePolicy<
            Identity: ICLRHostBindingPolicyManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRHostBindingPolicyManager_Impl::EvaluatePolicy(
                    this,
                    core::mem::transmute(&pwzreferenceidentity),
                    core::mem::transmute_copy(&pbapplicationpolicy),
                    core::mem::transmute_copy(&cbapppolicysize),
                    core::mem::transmute_copy(&pwzpostpolicyreferenceidentity),
                    core::mem::transmute_copy(&pcchpostpolicyreferenceidentity),
                    core::mem::transmute_copy(&pdwpoliciesapplied),
                )
                .into()
            }
        }
...
impl ICLRHostProtectionManager {
    pub unsafe fn SetProtectedCategories(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetProtectedCategories)(
                windows_core::Interface::as_raw(self),
                categories,
            )
            .ok()
    ...
    pub unsafe fn SetEagerSerializeGrantSets(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetEagerSerializeGrantSets)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct ICLRHostProtectionManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetProtectedCategories:
        unsafe extern "system" fn(*mut core::ffi::c_void, EApiCategories) -> windows_core::HRESULT,
    pub SetEagerSerializeGrantSets:
...
impl ICLRHostProtectionManager_Vtbl {
    pub const fn new<Identity: ICLRHostProtectionManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetProtectedCategories<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRHostProtectionManager_Impl::SetProtectedCategories(
                    this,
                    core::mem::transmute_copy(&categories),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetEagerSerializeGrantSets<
            Identity: ICLRHostProtectionManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    ICLRIoCompletionManager_Vtbl,
    0x2d74ce86_b8d6_4c84_b3a7_9768933b3c12
);
...
impl ICLRIoCompletionManager {
    pub unsafe fn OnComplete(
        ...
        pvoverlapped: *const core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub const fn new<Identity: ICLRIoCompletionManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRIoCompletionManager_Impl::OnComplete(
                    this,
                    core::mem::transmute_copy(&dwerrorcode),
                    core::mem::transmute_copy(&numberofbytestransferred),
                    core::mem::transmute_copy(&pvoverlapped),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x47eb8e57_0846_4546_af76_6f42fcfc2649
);
...
impl ICLRMemoryNotificationCallback {
    pub unsafe fn OnMemoryNotification(
        &self,
        ememoryavailable: EMemoryAvailable,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnMemoryNotification)(
                windows_core::Interface::as_raw(self),
                ememoryavailable,
            )
            .ok()
...
pub struct ICLRMemoryNotificationCallback_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OnMemoryNotification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EMemoryAvailable,
    ) -> windows_core::HRESULT,
}
    ...
    pub const fn new<Identity: ICLRMemoryNotificationCallback_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRMemoryNotificationCallback_Impl::OnMemoryNotification(
                    this,
                    core::mem::transmute_copy(&ememoryavailable),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            OnMemoryNotification: OnMemoryNotification::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ICLRMetaHost,
    ICLRMetaHost_Vtbl,
    0xd332db9e_b9b3_4125_8207_a14884f53216
);
...
impl ICLRMetaHost {
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).GetRuntime)(
                windows_core::Interface::as_raw(self),
                pwzversion.param().abi(),
                &T::IID,
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetVersionFromFile<P0>(
        &self,
        pwzfilepath: P0,
        pwzbuffer: windows_core::PWSTR,
        pcchbuffer: *mut u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetVersionFromFile)(
                windows_core::Interface::as_raw(self),
                pwzfilepath.param().abi(),
                core::mem::transmute(pwzbuffer),
                pcchbuffer as _,
    ...
    pub unsafe fn EnumerateInstalledRuntimes(
        &self,
    ) -> windows_core::Result<super::Com::IEnumUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerateInstalledRuntimes)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn EnumerateLoadedRuntimes(
        &self,
        hndprocess: super::super::Foundation::HANDLE,
    ) -> windows_core::Result<super::Com::IEnumUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerateLoadedRuntimes)(
                windows_core::Interface::as_raw(self),
                hndprocess,
                &mut result__,
            )
    ...
    pub unsafe fn RequestRuntimeLoadedNotification(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).RequestRuntimeLoadedNotification)(
                windows_core::Interface::as_raw(self),
                pcallbackfunction,
            )
            .ok()
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).QueryLegacyV2RuntimeBinding)(
                windows_core::Interface::as_raw(self),
                &T::IID,
                &mut result__,
            )
    ...
    pub unsafe fn ExitProcess(&self, iexitcode: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ExitProcess)(
                windows_core::Interface::as_raw(self),
                iexitcode,
            )
            .ok()
...
pub trait ICLRMetaHost_Impl: windows_core::IUnknownImpl {
    fn GetRuntime(
        &self,
        pwzversion: &windows_core::PCWSTR,
        riid: *const windows_core::GUID,
...
impl ICLRMetaHost_Vtbl {
    pub const fn new<Identity: ICLRMetaHost_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetRuntime<Identity: ICLRMetaHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwzversion: windows_core::PCWSTR,
            riid: *const windows_core::GUID,
            ppruntime: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRMetaHost_Impl::GetRuntime(
                    this,
                    core::mem::transmute(&pwzversion),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppruntime),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetVersionFromFile<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRMetaHost_Impl::GetVersionFromFile(
                    this,
                    core::mem::transmute(&pwzfilepath),
                    core::mem::transmute_copy(&pwzbuffer),
                    core::mem::transmute_copy(&pcchbuffer),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumerateInstalledRuntimes<
            Identity: ICLRMetaHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnumerateLoadedRuntimes<
            Identity: ICLRMetaHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRMetaHost_Impl::EnumerateLoadedRuntimes(
                    this,
                    core::mem::transmute_copy(&hndprocess),
                ) {
                    Ok(ok__) => {
                        ppenumerator.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn RequestRuntimeLoadedNotification<
            Identity: ICLRMetaHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRMetaHost_Impl::RequestRuntimeLoadedNotification(
                    this,
                    core::mem::transmute_copy(&pcallbackfunction),
                )
                .into()
            }
        }
        unsafe extern "system" fn QueryLegacyV2RuntimeBinding<
            Identity: ICLRMetaHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRMetaHost_Impl::QueryLegacyV2RuntimeBinding(
                    this,
                    core::mem::transmute_copy(&riid),
        ...
        unsafe extern "system" fn ExitProcess<Identity: ICLRMetaHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iexitcode: i32,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    ...
    0xe2190695_77b2_492e_8e14_c4b3a7fdd593
);
windows_core::imp::interface_hierarchy!(ICLRMetaHostPolicy, windows_core::IUnknown);
impl ICLRMetaHostPolicy {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetRequestedRuntime<P1, P2, T>(
        &self,
        dwpolicyflags: METAHOST_POLICY_FLAGS,
        pwzbinary: P1,
        pcfgstream: P2,
        pwzversion: Option<windows_core::PWSTR>,
        pcchversion: *mut u32,
        pwzimageversion: Option<windows_core::PWSTR>,
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).GetRequestedRuntime)(
                windows_core::Interface::as_raw(self),
                dwpolicyflags,
                pwzbinary.param().abi(),
                pcfgstream.param().abi(),
                pwzversion.unwrap_or(core::mem::zeroed()) as _,
                pcchversion as _,
                pwzimageversion.unwrap_or(core::mem::zeroed()) as _,
                pcchimageversion as _,
                pdwconfigflags as _,
                &T::IID,
                &mut result__,
            )
...
pub struct ICLRMetaHostPolicy_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_System_Com")]
    pub GetRequestedRuntime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait ICLRMetaHostPolicy_Impl: windows_core::IUnknownImpl {
    fn GetRequestedRuntime(
        &self,
        dwpolicyflags: METAHOST_POLICY_FLAGS,
        pwzbinary: &windows_core::PCWSTR,
        pcfgstream: windows_core::Ref<'_, super::Com::IStream>,
        pwzversion: windows_core::PWSTR,
        pcchversion: *mut u32,
        pwzimageversion: windows_core::PWSTR,
        pcchimageversion: *mut u32,
        pdwconfigflags: *mut u32,
        riid: *const windows_core::GUID,
        ppruntime: *mut *mut core::ffi::c_void,
...
impl ICLRMetaHostPolicy_Vtbl {
    pub const fn new<Identity: ICLRMetaHostPolicy_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetRequestedRuntime<
        ...
        >(
            ...
            dwpolicyflags: METAHOST_POLICY_FLAGS,
            pwzbinary: windows_core::PCWSTR,
            pcfgstream: *mut core::ffi::c_void,
            pwzversion: windows_core::PWSTR,
            pcchversion: *mut u32,
            pwzimageversion: windows_core::PWSTR,
            pcchimageversion: *mut u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRMetaHostPolicy_Impl::GetRequestedRuntime(
                    this,
                    core::mem::transmute_copy(&dwpolicyflags),
                    core::mem::transmute(&pwzbinary),
                    core::mem::transmute_copy(&pcfgstream),
                    core::mem::transmute_copy(&pwzversion),
                    core::mem::transmute_copy(&pcchversion),
                    core::mem::transmute_copy(&pwzimageversion),
                    core::mem::transmute_copy(&pcchimageversion),
                    core::mem::transmute_copy(&pdwconfigflags),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppruntime),
                )
                .into()
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetRequestedRuntime: GetRequestedRuntime::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl ICLROnEventManager {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterActionOnEvent)(
                windows_core::Interface::as_raw(self),
                event,
                paction.param().abi(),
            )
    ...
    pub unsafe fn UnregisterActionOnEvent<P1>(
        &self,
        event: EClrEvent,
        paction: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).UnregisterActionOnEvent)(
                windows_core::Interface::as_raw(self),
                event,
                paction.param().abi(),
            )
...
pub struct ICLROnEventManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub RegisterActionOnEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EClrEvent,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UnregisterActionOnEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EClrEvent,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait ICLROnEventManager_Impl: windows_core::IUnknownImpl {
    fn RegisterActionOnEvent(
        &self,
        event: EClrEvent,
        paction: windows_core::Ref<'_, IActionOnCLREvent>,
    ) -> windows_core::Result<()>;
...
impl ICLROnEventManager_Vtbl {
    pub const fn new<Identity: ICLROnEventManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RegisterActionOnEvent<
            Identity: ICLROnEventManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            event: EClrEvent,
            paction: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLROnEventManager_Impl::RegisterActionOnEvent(
                    this,
                    core::mem::transmute_copy(&event),
                    core::mem::transmute_copy(&paction),
                )
                .into()
            }
        }
        unsafe extern "system" fn UnregisterActionOnEvent<
            Identity: ICLROnEventManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLROnEventManager_Impl::UnregisterActionOnEvent(
                    this,
                    core::mem::transmute_copy(&event),
                    core::mem::transmute_copy(&paction),
                )
...
windows_core::imp::define_interface!(
    ...
    0x7d290010_d781_45da_a6f8_aa5d711a730e
);
...
impl ICLRPolicyManager {
    pub unsafe fn SetDefaultAction(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetDefaultAction)(
                windows_core::Interface::as_raw(self),
                operation,
                action,
            )
    ...
    pub unsafe fn SetTimeout(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetTimeout)(
                windows_core::Interface::as_raw(self),
                operation,
                dwmilliseconds,
            )
    ...
    pub unsafe fn SetActionOnTimeout(
        &self,
        operation: EClrOperation,
        action: EPolicyAction,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetActionOnTimeout)(
                windows_core::Interface::as_raw(self),
                operation,
                action,
            )
    ...
    pub unsafe fn SetTimeoutAndAction(
        &self,
        operation: EClrOperation,
        dwmilliseconds: u32,
        action: EPolicyAction,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetTimeoutAndAction)(
                windows_core::Interface::as_raw(self),
                operation,
                dwmilliseconds,
                action,
    ...
    pub unsafe fn SetActionOnFailure(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetActionOnFailure)(
                windows_core::Interface::as_raw(self),
                failure,
                action,
            )
    ...
    pub unsafe fn SetUnhandledExceptionPolicy(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetUnhandledExceptionPolicy)(
                windows_core::Interface::as_raw(self),
                policy,
            )
            .ok()
...
pub struct ICLRPolicyManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetDefaultAction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EClrOperation,
        EPolicyAction,
    ) -> windows_core::HRESULT,
    pub SetTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EClrOperation,
        u32,
    ) -> windows_core::HRESULT,
    pub SetActionOnTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EClrOperation,
        EPolicyAction,
    ) -> windows_core::HRESULT,
    pub SetTimeoutAndAction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EClrOperation,
        u32,
        EPolicyAction,
    ) -> windows_core::HRESULT,
    pub SetActionOnFailure: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EClrFailure,
        EPolicyAction,
    ) -> windows_core::HRESULT,
    pub SetUnhandledExceptionPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait ICLRPolicyManager_Impl: windows_core::IUnknownImpl {
    ...
    fn SetTimeout(&self, operation: EClrOperation, dwmilliseconds: u32)
        -> windows_core::Result<()>;
...
impl ICLRPolicyManager_Vtbl {
    pub const fn new<Identity: ICLRPolicyManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetDefaultAction<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRPolicyManager_Impl::SetDefaultAction(
                    this,
                    core::mem::transmute_copy(&operation),
                    core::mem::transmute_copy(&action),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetTimeout<
            Identity: ICLRPolicyManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRPolicyManager_Impl::SetTimeout(
                    this,
                    core::mem::transmute_copy(&operation),
        ...
        unsafe extern "system" fn SetActionOnTimeout<
            Identity: ICLRPolicyManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRPolicyManager_Impl::SetActionOnTimeout(
                    this,
                    core::mem::transmute_copy(&operation),
                    core::mem::transmute_copy(&action),
                )
        ...
        unsafe extern "system" fn SetTimeoutAndAction<
            Identity: ICLRPolicyManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRPolicyManager_Impl::SetTimeoutAndAction(
                    this,
                    core::mem::transmute_copy(&operation),
                    core::mem::transmute_copy(&dwmilliseconds),
                    core::mem::transmute_copy(&action),
        ...
        unsafe extern "system" fn SetActionOnFailure<
            Identity: ICLRPolicyManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRPolicyManager_Impl::SetActionOnFailure(
                    this,
                    core::mem::transmute_copy(&failure),
                    core::mem::transmute_copy(&action),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetUnhandledExceptionPolicy<
            Identity: ICLRPolicyManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRPolicyManager_Impl::SetUnhandledExceptionPolicy(
                    this,
                    core::mem::transmute_copy(&policy),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    ICLRProbingAssemblyEnum_Vtbl,
    0xd0c5fb1f_416b_4f97_81f4_7ac7dc24dd5d
);
    ...
    pub const fn new<Identity: ICLRProbingAssemblyEnum_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRProbingAssemblyEnum_Impl::Get(
                    this,
...
impl ICLRProfiling {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AttachProfiler)(
                windows_core::Interface::as_raw(self),
                dwprofileeprocessid,
                dwmillisecondsmax,
                pclsidprofiler,
                wszprofilerpath.param().abi(),
                core::mem::transmute(pvclientdata.as_ptr()),
                pvclientdata.len().try_into().unwrap(),
            )
            .ok()
        }
    }
...
pub struct ICLRProfiling_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub AttachProfiler: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const windows_core::GUID,
...
pub trait ICLRProfiling_Impl: windows_core::IUnknownImpl {
    fn AttachProfiler(
        ...
        dwmillisecondsmax: u32,
        pclsidprofiler: *const windows_core::GUID,
        wszprofilerpath: &windows_core::PCWSTR,
        pvclientdata: *const core::ffi::c_void,
        cbclientdata: u32,
    ) -> windows_core::Result<()>;
}
impl ICLRProfiling_Vtbl {
    pub const fn new<Identity: ICLRProfiling_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AttachProfiler<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRProfiling_Impl::AttachProfiler(
                    this,
                    core::mem::transmute_copy(&dwprofileeprocessid),
                    core::mem::transmute_copy(&dwmillisecondsmax),
                    core::mem::transmute_copy(&pclsidprofiler),
                    core::mem::transmute(&wszprofilerpath),
                    core::mem::transmute_copy(&pvclientdata),
                    core::mem::transmute_copy(&cbclientdata),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            AttachProfiler: AttachProfiler::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xd509cb5d_cf32_4876_ae61_67770cf91973
);
    ...
    pub const fn new<Identity: ICLRReferenceAssemblyEnum_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRReferenceAssemblyEnum_Impl::Get(
                    this,
                    core::mem::transmute_copy(&dwindex),
                    core::mem::transmute_copy(&pwzbuffer),
                    core::mem::transmute_copy(&pcchbuffersize),
...
windows_core::imp::define_interface!(
    ...
    0x90f1a06c_7712_4762_86b5_7a5eba6bdb02
);
...
impl ICLRRuntimeHost {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetHostControl)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn GetCLRControl(&self) -> windows_core::Result<ICLRControl> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCLRControl)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn UnloadAppDomain(
        &self,
        dwappdomainid: u32,
        fwaituntildone: bool,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).UnloadAppDomain)(
                windows_core::Interface::as_raw(self),
                dwappdomainid,
                fwaituntildone.into(),
            )
    ...
    pub unsafe fn ExecuteInAppDomain(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ExecuteInAppDomain)(
                windows_core::Interface::as_raw(self),
                dwappdomainid,
                pcallback,
                cookie,
    ...
    pub unsafe fn GetCurrentAppDomainId(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCurrentAppDomainId)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ExecuteApplication<P0>(
        &self,
        pwzappfullname: P0,
        dwmanifestpaths: u32,
        ppwzmanifestpaths: *const windows_core::PCWSTR,
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExecuteApplication)(
                windows_core::Interface::as_raw(self),
                pwzappfullname.param().abi(),
                dwmanifestpaths,
                ppwzmanifestpaths,
    ...
    pub unsafe fn ExecuteInDefaultAppDomain<P0, P1, P2, P3>(
        &self,
        pwzassemblypath: P0,
        pwztypename: P1,
        pwzmethodname: P2,
        ...
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExecuteInDefaultAppDomain)(
                windows_core::Interface::as_raw(self),
                pwzassemblypath.param().abi(),
                pwztypename.param().abi(),
                pwzmethodname.param().abi(),
                pwzargument.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
...
pub trait ICLRRuntimeHost_Impl: windows_core::IUnknownImpl {
    ...
    fn SetHostControl(
        &self,
        phostcontrol: windows_core::Ref<'_, IHostControl>,
    ) -> windows_core::Result<()>;
    fn GetCLRControl(&self) -> windows_core::Result<ICLRControl>;
    fn UnloadAppDomain(
        &self,
        dwappdomainid: u32,
        fwaituntildone: windows_core::BOOL,
    ) -> windows_core::Result<()>;
    ...
    fn ExecuteApplication(
        &self,
        pwzappfullname: &windows_core::PCWSTR,
        dwmanifestpaths: u32,
        ppwzmanifestpaths: *const windows_core::PCWSTR,
        dwactivationdata: u32,
        ppwzactivationdata: *const windows_core::PCWSTR,
    ...
    fn ExecuteInDefaultAppDomain(
        &self,
        pwzassemblypath: &windows_core::PCWSTR,
        pwztypename: &windows_core::PCWSTR,
        pwzmethodname: &windows_core::PCWSTR,
        pwzargument: &windows_core::PCWSTR,
    ) -> windows_core::Result<u32>;
}
impl ICLRRuntimeHost_Vtbl {
    pub const fn new<Identity: ICLRRuntimeHost_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Start<Identity: ICLRRuntimeHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Stop<Identity: ICLRRuntimeHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn SetHostControl<
            Identity: ICLRRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            phostcontrol: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRRuntimeHost_Impl::SetHostControl(this, core::mem::transmute_copy(&phostcontrol))
                    .into()
            }
        }
        unsafe extern "system" fn GetCLRControl<
            Identity: ICLRRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pclrcontrol: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn UnloadAppDomain<
            Identity: ICLRRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRRuntimeHost_Impl::UnloadAppDomain(
                    this,
                    core::mem::transmute_copy(&dwappdomainid),
                    core::mem::transmute_copy(&fwaituntildone),
                )
                .into()
            }
        }
        unsafe extern "system" fn ExecuteInAppDomain<
            Identity: ICLRRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRRuntimeHost_Impl::ExecuteInAppDomain(
                    this,
                    core::mem::transmute_copy(&dwappdomainid),
        ...
        unsafe extern "system" fn GetCurrentAppDomainId<
            Identity: ICLRRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ExecuteApplication<
            Identity: ICLRRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRRuntimeHost_Impl::ExecuteApplication(
                    this,
                    core::mem::transmute(&pwzappfullname),
                    core::mem::transmute_copy(&dwmanifestpaths),
                    core::mem::transmute_copy(&ppwzmanifestpaths),
                    core::mem::transmute_copy(&dwactivationdata),
                    core::mem::transmute_copy(&ppwzactivationdata),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn ExecuteInDefaultAppDomain<
            Identity: ICLRRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRRuntimeHost_Impl::ExecuteInDefaultAppDomain(
                    this,
                    core::mem::transmute(&pwzassemblypath),
                    core::mem::transmute(&pwztypename),
                    core::mem::transmute(&pwzmethodname),
                    core::mem::transmute(&pwzargument),
                ) {
                    Ok(ok__) => {
                        preturnvalue.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
...
windows_core::imp::define_interface!(
    ...
    0xbd39d1d2_ba2f_486a_89b0_b4b0cb466891
);
...
impl ICLRRuntimeInfo {
    pub unsafe fn GetVersionString(
        &self,
        pwzbuffer: Option<windows_core::PWSTR>,
        pcchbuffer: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetVersionString)(
                windows_core::Interface::as_raw(self),
                pwzbuffer.unwrap_or(core::mem::zeroed()) as _,
                pcchbuffer as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetRuntimeDirectory(
        &self,
        pwzbuffer: windows_core::PWSTR,
        pcchbuffer: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetRuntimeDirectory)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pwzbuffer),
                pcchbuffer as _,
            )
    ...
    pub unsafe fn LoadErrorString(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).LoadErrorString)(
                windows_core::Interface::as_raw(self),
                iresourceid,
                core::mem::transmute(pwzbuffer),
                pcchbuffer as _,
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LoadLibraryA)(
                windows_core::Interface::as_raw(self),
                pwzdllname.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    }
    pub unsafe fn GetProcAddress<P0>(
        &self,
        pszprocname: P0,
        ...
        P0: windows_core::Param<windows_core::PCSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetProcAddress)(
                windows_core::Interface::as_raw(self),
                pszprocname.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    }
    pub unsafe fn GetInterface<T>(
        &self,
        rclsid: *const windows_core::GUID,
    ) -> windows_core::Result<T>
    where
    ...
    pub unsafe fn IsLoadable(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsLoadable)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetDefaultStartupFlags<P1>(
        &self,
        dwstartupflags: u32,
        pwzhostconfigfile: P1,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetDefaultStartupFlags)(
                windows_core::Interface::as_raw(self),
                dwstartupflags,
                pwzhostconfigfile.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn GetDefaultStartupFlags(
        ...
        pwzhostconfigfile: Option<windows_core::PWSTR>,
        pcchhostconfigfile: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetDefaultStartupFlags)(
                windows_core::Interface::as_raw(self),
                pdwstartupflags as _,
                pwzhostconfigfile.unwrap_or(core::mem::zeroed()) as _,
                pcchhostconfigfile as _,
            )
            .ok()
        }
    }
    pub unsafe fn BindAsLegacyV2Runtime(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BindAsLegacyV2Runtime)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    }
    pub unsafe fn IsStarted(
        &self,
        pbstarted: *mut windows_core::BOOL,
        pdwstartupflags: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).IsStarted)(
                windows_core::Interface::as_raw(self),
                pbstarted as _,
                pdwstartupflags as _,
            )
...
pub trait ICLRRuntimeInfo_Impl: windows_core::IUnknownImpl {
    ...
    fn LoadLibraryA(
        &self,
        pwzdllname: &windows_core::PCWSTR,
    ) -> windows_core::Result<super::super::Foundation::HMODULE>;
    fn GetProcAddress(
        &self,
        pszprocname: &windows_core::PCSTR,
    ) -> windows_core::Result<*mut core::ffi::c_void>;
    fn GetInterface(
        &self,
        rclsid: *const windows_core::GUID,
    ...
    fn GetDefaultStartupFlags(
        &self,
        pdwstartupflags: *mut u32,
        pwzhostconfigfile: windows_core::PWSTR,
        pcchhostconfigfile: *mut u32,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: ICLRRuntimeInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRRuntimeInfo_Impl::GetVersionString(
                    this,
                    core::mem::transmute_copy(&pwzbuffer),
                    core::mem::transmute_copy(&pcchbuffer),
                )
        ...
        unsafe extern "system" fn GetRuntimeDirectory<
            Identity: ICLRRuntimeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRRuntimeInfo_Impl::GetRuntimeDirectory(
                    this,
                    core::mem::transmute_copy(&pwzbuffer),
                    core::mem::transmute_copy(&pcchbuffer),
                )
        ...
        unsafe extern "system" fn IsLoaded<Identity: ICLRRuntimeInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hndprocess: super::super::Foundation::HANDLE,
            pbloaded: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn LoadErrorString<
            Identity: ICLRRuntimeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRRuntimeInfo_Impl::LoadErrorString(
                    this,
                    core::mem::transmute_copy(&iresourceid),
                    core::mem::transmute_copy(&pwzbuffer),
                    core::mem::transmute_copy(&pcchbuffer),
                    core::mem::transmute_copy(&ilocaleid),
                )
                .into()
            }
        }
        unsafe extern "system" fn LoadLibraryA<
            Identity: ICLRRuntimeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pwzdllname: windows_core::PCWSTR,
            phndmodule: *mut super::super::Foundation::HMODULE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetProcAddress<
            Identity: ICLRRuntimeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRRuntimeInfo_Impl::GetInterface(
                    this,
        ...
        unsafe extern "system" fn IsLoadable<
            Identity: ICLRRuntimeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbloadable: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetDefaultStartupFlags<
            Identity: ICLRRuntimeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRRuntimeInfo_Impl::SetDefaultStartupFlags(
                    this,
                    core::mem::transmute_copy(&dwstartupflags),
                    core::mem::transmute(&pwzhostconfigfile),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetDefaultStartupFlags<
            Identity: ICLRRuntimeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRRuntimeInfo_Impl::GetDefaultStartupFlags(
                    this,
                    core::mem::transmute_copy(&pdwstartupflags),
                    core::mem::transmute_copy(&pwzhostconfigfile),
                    core::mem::transmute_copy(&pcchhostconfigfile),
                )
                .into()
            }
        }
        unsafe extern "system" fn BindAsLegacyV2Runtime<
            Identity: ICLRRuntimeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn IsStarted<Identity: ICLRRuntimeInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstarted: *mut windows_core::BOOL,
            pdwstartupflags: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRRuntimeInfo_Impl::IsStarted(
                    this,
                    core::mem::transmute_copy(&pbstarted),
                    core::mem::transmute_copy(&pdwstartupflags),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ICLRStrongName,
    ICLRStrongName_Vtbl,
    0x9fd93ccf_3280_4391_b3a9_96e1cde77c8d
);
windows_core::imp::interface_hierarchy!(ICLRStrongName, windows_core::IUnknown);
impl ICLRStrongName {
    pub unsafe fn GetHashFromAssemblyFile<P0>(
        &self,
        pszfilepath: P0,
        pihashalg: *mut u32,
        pbhash: &mut [u8],
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetHashFromAssemblyFile)(
                windows_core::Interface::as_raw(self),
                pszfilepath.param().abi(),
                pihashalg as _,
                core::mem::transmute(pbhash.as_ptr()),
    ...
    pub unsafe fn GetHashFromAssemblyFileW<P0>(
        &self,
        pwzfilepath: P0,
        pihashalg: *mut u32,
        pbhash: &mut [u8],
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetHashFromAssemblyFileW)(
                windows_core::Interface::as_raw(self),
                pwzfilepath.param().abi(),
                pihashalg as _,
                core::mem::transmute(pbhash.as_ptr()),
    ...
    pub unsafe fn GetHashFromBlob(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetHashFromBlob)(
                windows_core::Interface::as_raw(self),
                pbblob,
                cchblob,
                pihashalg as _,
    ...
    pub unsafe fn GetHashFromFile<P0>(
        &self,
        pszfilepath: P0,
        pihashalg: *mut u32,
        pbhash: &mut [u8],
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetHashFromFile)(
                windows_core::Interface::as_raw(self),
                pszfilepath.param().abi(),
                pihashalg as _,
                core::mem::transmute(pbhash.as_ptr()),
    ...
    pub unsafe fn GetHashFromFileW<P0>(
        &self,
        pwzfilepath: P0,
        pihashalg: *mut u32,
        pbhash: &mut [u8],
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetHashFromFileW)(
                windows_core::Interface::as_raw(self),
                pwzfilepath.param().abi(),
                pihashalg as _,
                core::mem::transmute(pbhash.as_ptr()),
    ...
    pub unsafe fn GetHashFromHandle(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetHashFromHandle)(
                windows_core::Interface::as_raw(self),
                hfile,
                pihashalg as _,
                core::mem::transmute(pbhash.as_ptr()),
    ...
    pub unsafe fn StrongNameCompareAssemblies<P0, P1>(
        &self,
        pwzassembly1: P0,
        pwzassembly2: P1,
    ) -> windows_core::Result<u32>
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StrongNameCompareAssemblies)(
                windows_core::Interface::as_raw(self),
                pwzassembly1.param().abi(),
                pwzassembly2.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub unsafe fn StrongNameFreeBuffer(&self, pbmemory: *const u8) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameFreeBuffer)(
                windows_core::Interface::as_raw(self),
                pbmemory,
            )
            .ok()
    ...
    pub unsafe fn StrongNameGetBlob<P0>(
        &self,
        pwzfilepath: P0,
        pbblob: *mut u8,
        pcbblob: *mut u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameGetBlob)(
                windows_core::Interface::as_raw(self),
                pwzfilepath.param().abi(),
                pbblob as _,
                pcbblob as _,
    ...
    pub unsafe fn StrongNameGetBlobFromImage(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameGetBlobFromImage)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pbbase.as_ptr()),
                pbbase.len().try_into().unwrap(),
                pbblob as _,
                pcbblob as _,
            )
            .ok()
    ...
    pub unsafe fn StrongNameGetPublicKey<P0>(
        &self,
        pwzkeycontainer: P0,
        pbkeyblob: *const u8,
        cbkeyblob: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameGetPublicKey)(
                windows_core::Interface::as_raw(self),
                pwzkeycontainer.param().abi(),
                pbkeyblob,
                cbkeyblob,
                ppbpublickeyblob as _,
                pcbpublickeyblob as _,
            )
            .ok()
        }
    }
    pub unsafe fn StrongNameHashSize(&self, ulhashalg: u32) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StrongNameHashSize)(
                windows_core::Interface::as_raw(self),
                ulhashalg,
                &mut result__,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameKeyDelete)(
                windows_core::Interface::as_raw(self),
                pwzkeycontainer.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn StrongNameKeyGen<P0>(
        &self,
        pwzkeycontainer: P0,
        dwflags: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameKeyGen)(
                windows_core::Interface::as_raw(self),
                pwzkeycontainer.param().abi(),
                dwflags,
                ppbkeyblob as _,
    ...
    pub unsafe fn StrongNameKeyGenEx<P0>(
        &self,
        pwzkeycontainer: P0,
        dwflags: u32,
        dwkeysize: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameKeyGenEx)(
                windows_core::Interface::as_raw(self),
                pwzkeycontainer.param().abi(),
                dwflags,
                dwkeysize,
    ...
    pub unsafe fn StrongNameKeyInstall<P0>(
        &self,
        pwzkeycontainer: P0,
        pbkeyblob: *const u8,
        cbkeyblob: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameKeyInstall)(
                windows_core::Interface::as_raw(self),
                pwzkeycontainer.param().abi(),
                pbkeyblob,
                cbkeyblob,
    ...
    pub unsafe fn StrongNameSignatureGeneration<P0, P1>(
        &self,
        pwzfilepath: P0,
        pwzkeycontainer: P1,
        pbkeyblob: *const u8,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameSignatureGeneration)(
                windows_core::Interface::as_raw(self),
                pwzfilepath.param().abi(),
                pwzkeycontainer.param().abi(),
                pbkeyblob,
                cbkeyblob,
                ppbsignatureblob as _,
                pcbsignatureblob as _,
            )
            .ok()
        }
    }
    pub unsafe fn StrongNameSignatureGenerationEx<P0, P1>(
        &self,
        wszfilepath: P0,
        wszkeycontainer: P1,
        pbkeyblob: *const u8,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameSignatureGenerationEx)(
                windows_core::Interface::as_raw(self),
                wszfilepath.param().abi(),
                wszkeycontainer.param().abi(),
                pbkeyblob,
                cbkeyblob,
                ppbsignatureblob as _,
                pcbsignatureblob as _,
    ...
    pub unsafe fn StrongNameSignatureSize(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameSignatureSize)(
                windows_core::Interface::as_raw(self),
                pbpublickeyblob,
                cbpublickeyblob,
                pcbsize,
    ...
    pub unsafe fn StrongNameSignatureVerification<P0>(
        &self,
        pwzfilepath: P0,
        dwinflags: u32,
    ) -> windows_core::Result<u32>
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StrongNameSignatureVerification)(
                windows_core::Interface::as_raw(self),
                pwzfilepath.param().abi(),
                dwinflags,
                &mut result__,
    ...
    pub unsafe fn StrongNameSignatureVerificationEx<P0>(
        &self,
        pwzfilepath: P0,
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StrongNameSignatureVerificationEx)(
                windows_core::Interface::as_raw(self),
                pwzfilepath.param().abi(),
                fforceverification,
                &mut result__,
    ...
    pub unsafe fn StrongNameSignatureVerificationFromImage(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StrongNameSignatureVerificationFromImage)(
                windows_core::Interface::as_raw(self),
                pbbase,
                dwlength,
                dwinflags,
    ...
    pub unsafe fn StrongNameTokenFromAssembly<P0>(
        &self,
        pwzfilepath: P0,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameTokenFromAssembly)(
                windows_core::Interface::as_raw(self),
                pwzfilepath.param().abi(),
                ppbstrongnametoken as _,
                pcbstrongnametoken as _,
            )
            .ok()
        }
    }
    pub unsafe fn StrongNameTokenFromAssemblyEx<P0>(
        &self,
        pwzfilepath: P0,
        ppbstrongnametoken: *mut *mut u8,
        pcbstrongnametoken: *mut u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameTokenFromAssemblyEx)(
                windows_core::Interface::as_raw(self),
                pwzfilepath.param().abi(),
                ppbstrongnametoken as _,
                pcbstrongnametoken as _,
    ...
    pub unsafe fn StrongNameTokenFromPublicKey(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameTokenFromPublicKey)(
                windows_core::Interface::as_raw(self),
                pbpublickeyblob,
                cbpublickeyblob,
                ppbstrongnametoken as _,
...
pub struct ICLRStrongName_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetHashFromAssemblyFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCSTR,
        *mut u32,
        *mut u8,
    ...
    pub GetHashFromAssemblyFileW: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut u32,
        *mut u8,
    ...
    pub GetHashFromBlob: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const u8,
        u32,
        *mut u32,
    ...
    pub GetHashFromFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCSTR,
        *mut u32,
        *mut u8,
    ...
    pub GetHashFromFileW: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut u32,
        *mut u8,
    ...
    pub GetHashFromHandle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HANDLE,
        *mut u32,
        *mut u8,
    ...
    pub StrongNameCompareAssemblies: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub StrongNameFreeBuffer:
        unsafe extern "system" fn(*mut core::ffi::c_void, *const u8) -> windows_core::HRESULT,
    pub StrongNameGetBlob: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub StrongNameGetBlobFromImage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const u8,
        u32,
        *mut u8,
    ...
    pub StrongNameGetPublicKey: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const u8,
        u32,
    ...
    pub StrongNameHashSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut u32) -> windows_core::HRESULT,
    pub StrongNameKeyDelete: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub StrongNameKeyGen: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        *mut *mut u8,
    ...
    pub StrongNameKeyGenEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        u32,
    ...
    pub StrongNameKeyInstall: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const u8,
        u32,
    ) -> windows_core::HRESULT,
    pub StrongNameSignatureGeneration: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *const u8,
    ...
    pub StrongNameSignatureGenerationEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *const u8,
    ...
    pub StrongNameSignatureSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const u8,
        u32,
        *const u32,
    ) -> windows_core::HRESULT,
    pub StrongNameSignatureVerification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        *mut u32,
    ...
    pub StrongNameSignatureVerificationFromImage:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *const u8,
            u32,
    ...
    pub StrongNameTokenFromAssembly: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub StrongNameTokenFromAssemblyEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut u8,
        *mut u32,
    ...
    pub StrongNameTokenFromPublicKey: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const u8,
        u32,
        *mut *mut u8,
...
pub trait ICLRStrongName_Impl: windows_core::IUnknownImpl {
    ...
    fn StrongNameCompareAssemblies(
        &self,
        pwzassembly1: &windows_core::PCWSTR,
        pwzassembly2: &windows_core::PCWSTR,
    ) -> windows_core::Result<u32>;
    ...
    fn StrongNameGetPublicKey(
        &self,
        pwzkeycontainer: &windows_core::PCWSTR,
        pbkeyblob: *const u8,
        cbkeyblob: u32,
        ppbpublickeyblob: *mut *mut u8,
        pcbpublickeyblob: *mut u32,
    ...
    fn StrongNameSignatureGenerationEx(
        &self,
        wszfilepath: &windows_core::PCWSTR,
        wszkeycontainer: &windows_core::PCWSTR,
        pbkeyblob: *const u8,
        cbkeyblob: u32,
        ppbsignatureblob: *mut *mut u8,
        pcbsignatureblob: *mut u32,
...
impl ICLRStrongName_Vtbl {
    pub const fn new<Identity: ICLRStrongName_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetHashFromAssemblyFile<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::GetHashFromAssemblyFile(
                    this,
                    core::mem::transmute(&pszfilepath),
                    core::mem::transmute_copy(&pihashalg),
                    core::mem::transmute_copy(&pbhash),
                    core::mem::transmute_copy(&cchhash),
                    core::mem::transmute_copy(&pchhash),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetHashFromAssemblyFileW<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::GetHashFromAssemblyFileW(
                    this,
                    core::mem::transmute(&pwzfilepath),
                    core::mem::transmute_copy(&pihashalg),
                    core::mem::transmute_copy(&pbhash),
        ...
        unsafe extern "system" fn GetHashFromBlob<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::GetHashFromBlob(
                    this,
                    core::mem::transmute_copy(&pbblob),
                    core::mem::transmute_copy(&cchblob),
                    core::mem::transmute_copy(&pihashalg),
                    core::mem::transmute_copy(&pbhash),
                    core::mem::transmute_copy(&cchhash),
                    core::mem::transmute_copy(&pchhash),
        ...
        unsafe extern "system" fn GetHashFromFile<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::GetHashFromFile(
                    this,
                    core::mem::transmute(&pszfilepath),
                    core::mem::transmute_copy(&pihashalg),
                    core::mem::transmute_copy(&pbhash),
        ...
        unsafe extern "system" fn GetHashFromFileW<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::GetHashFromFileW(
                    this,
                    core::mem::transmute(&pwzfilepath),
                    core::mem::transmute_copy(&pihashalg),
                    core::mem::transmute_copy(&pbhash),
        ...
        unsafe extern "system" fn GetHashFromHandle<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::GetHashFromHandle(
                    this,
        ...
        unsafe extern "system" fn StrongNameCompareAssemblies<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRStrongName_Impl::StrongNameCompareAssemblies(
                    this,
                    core::mem::transmute(&pwzassembly1),
                    core::mem::transmute(&pwzassembly2),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn StrongNameFreeBuffer<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameFreeBuffer(
                    this,
                    core::mem::transmute_copy(&pbmemory),
                )
                .into()
            }
        }
        unsafe extern "system" fn StrongNameGetBlob<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameGetBlob(
                    this,
                    core::mem::transmute(&pwzfilepath),
                    core::mem::transmute_copy(&pbblob),
                    core::mem::transmute_copy(&pcbblob),
                )
                .into()
            }
        }
        unsafe extern "system" fn StrongNameGetBlobFromImage<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameGetBlobFromImage(
                    this,
                    core::mem::transmute_copy(&pbbase),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameGetPublicKey(
                    this,
                    core::mem::transmute(&pwzkeycontainer),
                    core::mem::transmute_copy(&pbkeyblob),
                    core::mem::transmute_copy(&cbkeyblob),
                    core::mem::transmute_copy(&ppbpublickeyblob),
                    core::mem::transmute_copy(&pcbpublickeyblob),
                )
                .into()
            }
        }
        unsafe extern "system" fn StrongNameHashSize<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRStrongName_Impl::StrongNameHashSize(
                    this,
                    core::mem::transmute_copy(&ulhashalg),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn StrongNameKeyDelete<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameKeyDelete(
                    this,
                    core::mem::transmute(&pwzkeycontainer),
                )
                .into()
        ...
        unsafe extern "system" fn StrongNameKeyGen<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameKeyGen(
                    this,
                    core::mem::transmute(&pwzkeycontainer),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&ppbkeyblob),
                    core::mem::transmute_copy(&pcbkeyblob),
                )
                .into()
            }
        }
        unsafe extern "system" fn StrongNameKeyGenEx<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameKeyGenEx(
                    this,
                    core::mem::transmute(&pwzkeycontainer),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&dwkeysize),
                    core::mem::transmute_copy(&ppbkeyblob),
                    core::mem::transmute_copy(&pcbkeyblob),
                )
                .into()
        ...
        unsafe extern "system" fn StrongNameKeyInstall<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameKeyInstall(
                    this,
                    core::mem::transmute(&pwzkeycontainer),
                    core::mem::transmute_copy(&pbkeyblob),
                    core::mem::transmute_copy(&cbkeyblob),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameSignatureGeneration(
                    this,
                    core::mem::transmute(&pwzfilepath),
                    core::mem::transmute(&pwzkeycontainer),
                    core::mem::transmute_copy(&pbkeyblob),
                    core::mem::transmute_copy(&cbkeyblob),
                    core::mem::transmute_copy(&ppbsignatureblob),
                    core::mem::transmute_copy(&pcbsignatureblob),
                )
                .into()
            }
        }
        unsafe extern "system" fn StrongNameSignatureGenerationEx<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameSignatureGenerationEx(
                    this,
                    core::mem::transmute(&wszfilepath),
                    core::mem::transmute(&wszkeycontainer),
                    core::mem::transmute_copy(&pbkeyblob),
                    core::mem::transmute_copy(&cbkeyblob),
                    core::mem::transmute_copy(&ppbsignatureblob),
                    core::mem::transmute_copy(&pcbsignatureblob),
        ...
        unsafe extern "system" fn StrongNameSignatureSize<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameSignatureSize(
                    this,
                    core::mem::transmute_copy(&pbpublickeyblob),
                    core::mem::transmute_copy(&cbpublickeyblob),
                    core::mem::transmute_copy(&pcbsize),
                )
                .into()
            }
        }
        unsafe extern "system" fn StrongNameSignatureVerification<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRStrongName_Impl::StrongNameSignatureVerification(
                    this,
                    core::mem::transmute(&pwzfilepath),
                    core::mem::transmute_copy(&dwinflags),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn StrongNameSignatureVerificationEx<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRStrongName_Impl::StrongNameSignatureVerificationEx(
                    this,
                    core::mem::transmute(&pwzfilepath),
                    core::mem::transmute_copy(&fforceverification),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn StrongNameSignatureVerificationFromImage<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRStrongName_Impl::StrongNameSignatureVerificationFromImage(
                    this,
                    core::mem::transmute_copy(&pbbase),
                    core::mem::transmute_copy(&dwlength),
                    core::mem::transmute_copy(&dwinflags),
        ...
        unsafe extern "system" fn StrongNameTokenFromAssembly<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameTokenFromAssembly(
                    this,
                    core::mem::transmute(&pwzfilepath),
                    core::mem::transmute_copy(&ppbstrongnametoken),
                    core::mem::transmute_copy(&pcbstrongnametoken),
                )
                .into()
            }
        }
        unsafe extern "system" fn StrongNameTokenFromAssemblyEx<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameTokenFromAssemblyEx(
                    this,
                    core::mem::transmute(&pwzfilepath),
                    core::mem::transmute_copy(&ppbstrongnametoken),
                    core::mem::transmute_copy(&pcbstrongnametoken),
        ...
        unsafe extern "system" fn StrongNameTokenFromPublicKey<
            Identity: ICLRStrongName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName_Impl::StrongNameTokenFromPublicKey(
                    this,
                    core::mem::transmute_copy(&pbpublickeyblob),
                    core::mem::transmute_copy(&cbpublickeyblob),
                    core::mem::transmute_copy(&ppbstrongnametoken),
        ...
        Self {
            ...
            StrongNameSignatureVerificationFromImage: StrongNameSignatureVerificationFromImage::<
                Identity,
                OFFSET,
            >,
...
impl ICLRStrongName2 {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameGetPublicKeyEx)(
                windows_core::Interface::as_raw(self),
                pwzkeycontainer.param().abi(),
                pbkeyblob,
                cbkeyblob,
    ...
    pub unsafe fn StrongNameSignatureVerificationEx2<P0>(
        &self,
        wszfilepath: P0,
        fforceverification: bool,
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StrongNameSignatureVerificationEx2)(
                windows_core::Interface::as_raw(self),
                wszfilepath.param().abi(),
                fforceverification,
                pbecmapublickey,
...
pub struct ICLRStrongName2_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub StrongNameGetPublicKeyEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const u8,
        u32,
    ...
    pub StrongNameSignatureVerificationEx2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        bool,
        *const u8,
...
impl ICLRStrongName2_Vtbl {
    pub const fn new<Identity: ICLRStrongName2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn StrongNameGetPublicKeyEx<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName2_Impl::StrongNameGetPublicKeyEx(
                    this,
                    core::mem::transmute(&pwzkeycontainer),
                    core::mem::transmute_copy(&pbkeyblob),
                    core::mem::transmute_copy(&cbkeyblob),
                    core::mem::transmute_copy(&ppbpublickeyblob),
                    core::mem::transmute_copy(&pcbpublickeyblob),
                    core::mem::transmute_copy(&uhashalgid),
                    core::mem::transmute_copy(&ureserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn StrongNameSignatureVerificationEx2<
            Identity: ICLRStrongName2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRStrongName2_Impl::StrongNameSignatureVerificationEx2(
                    this,
                    core::mem::transmute(&wszfilepath),
                    core::mem::transmute_copy(&fforceverification),
                    core::mem::transmute_copy(&pbecmapublickey),
                    core::mem::transmute_copy(&cbecmapublickey),
                ) {
                    Ok(ok__) => {
                        pfwasverified.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        Self {
            ...
            StrongNameSignatureVerificationEx2: StrongNameSignatureVerificationEx2::<
                Identity,
                OFFSET,
            >,
        }
...
impl ICLRStrongName3 {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameDigestGenerate)(
                windows_core::Interface::as_raw(self),
                wszfilepath.param().abi(),
                ppbdigestblob as _,
                pcbdigestblob as _,
    ...
    pub unsafe fn StrongNameDigestSign<P0>(
        &self,
        wszkeycontainer: P0,
        pbkeyblob: &[u8],
        pbdigestblob: &[u8],
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameDigestSign)(
                windows_core::Interface::as_raw(self),
                wszkeycontainer.param().abi(),
                core::mem::transmute(pbkeyblob.as_ptr()),
                pbkeyblob.len().try_into().unwrap(),
                core::mem::transmute(pbdigestblob.as_ptr()),
                pbdigestblob.len().try_into().unwrap(),
                hashalgid,
                ppbsignatureblob as _,
                pcbsignatureblob as _,
                dwflags,
    ...
    pub unsafe fn StrongNameDigestEmbed<P0>(
        &self,
        wszfilepath: P0,
        pbsignatureblob: &[u8],
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StrongNameDigestEmbed)(
                windows_core::Interface::as_raw(self),
                wszfilepath.param().abi(),
                core::mem::transmute(pbsignatureblob.as_ptr()),
                pbsignatureblob.len().try_into().unwrap(),
            )
            .ok()
        }
    }
...
pub struct ICLRStrongName3_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub StrongNameDigestGenerate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut u8,
        *mut u32,
    ...
    pub StrongNameDigestSign: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const u8,
        u32,
    ...
    pub StrongNameDigestEmbed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const u8,
        u32,
...
impl ICLRStrongName3_Vtbl {
    pub const fn new<Identity: ICLRStrongName3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn StrongNameDigestGenerate<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName3_Impl::StrongNameDigestGenerate(
                    this,
                    core::mem::transmute(&wszfilepath),
                    core::mem::transmute_copy(&ppbdigestblob),
                    core::mem::transmute_copy(&pcbdigestblob),
                    core::mem::transmute_copy(&dwflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn StrongNameDigestSign<
            Identity: ICLRStrongName3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName3_Impl::StrongNameDigestSign(
                    this,
                    core::mem::transmute(&wszkeycontainer),
                    core::mem::transmute_copy(&pbkeyblob),
                    core::mem::transmute_copy(&cbkeyblob),
                    core::mem::transmute_copy(&pbdigestblob),
                    core::mem::transmute_copy(&cbdigestblob),
                    core::mem::transmute_copy(&hashalgid),
                    core::mem::transmute_copy(&ppbsignatureblob),
                    core::mem::transmute_copy(&pcbsignatureblob),
                    core::mem::transmute_copy(&dwflags),
                )
        ...
        unsafe extern "system" fn StrongNameDigestEmbed<
            Identity: ICLRStrongName3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRStrongName3_Impl::StrongNameDigestEmbed(
                    this,
                    core::mem::transmute(&wszfilepath),
                    core::mem::transmute_copy(&pbsignatureblob),
                    core::mem::transmute_copy(&cbsignatureblob),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x55ff199d_ad21_48f9_a16c_f24ebbb8727d
);
...
impl ICLRSyncManager {
    pub unsafe fn GetMonitorOwner(&self, cookie: usize) -> windows_core::Result<IHostTask> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMonitorOwner)(
                windows_core::Interface::as_raw(self),
                cookie,
                &mut result__,
            )
    ...
    pub unsafe fn CreateRWLockOwnerIterator(&self, cookie: usize) -> windows_core::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateRWLockOwnerIterator)(
                windows_core::Interface::as_raw(self),
                cookie,
                &mut result__,
            )
    ...
    pub unsafe fn GetRWLockOwnerNext(&self, iterator: usize) -> windows_core::Result<IHostTask> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRWLockOwnerNext)(
                windows_core::Interface::as_raw(self),
                iterator,
                &mut result__,
            )
    ...
    pub unsafe fn DeleteRWLockOwnerIterator(&self, iterator: usize) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteRWLockOwnerIterator)(
                windows_core::Interface::as_raw(self),
                iterator,
            )
            .ok()
...
pub struct ICLRSyncManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetMonitorOwner: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        usize,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateRWLockOwnerIterator: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        usize,
        *mut usize,
    ) -> windows_core::HRESULT,
    pub GetRWLockOwnerNext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        usize,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeleteRWLockOwnerIterator:
...
impl ICLRSyncManager_Vtbl {
    pub const fn new<Identity: ICLRSyncManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetMonitorOwner<
            Identity: ICLRSyncManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            cookie: usize,
            ppownerhosttask: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRSyncManager_Impl::GetMonitorOwner(
                    this,
                    core::mem::transmute_copy(&cookie),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateRWLockOwnerIterator<
            Identity: ICLRSyncManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRSyncManager_Impl::CreateRWLockOwnerIterator(
                    this,
                    core::mem::transmute_copy(&cookie),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetRWLockOwnerNext<
            Identity: ICLRSyncManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICLRSyncManager_Impl::GetRWLockOwnerNext(
                    this,
                    core::mem::transmute_copy(&iterator),
                ) {
                    Ok(ok__) => {
                        ppownerhosttask.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn DeleteRWLockOwnerIterator<
            Identity: ICLRSyncManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICLRSyncManager_Impl::DeleteRWLockOwnerIterator(
                    this,
                    core::mem::transmute_copy(&iterator),
                )
                .into()
...
impl ICLRTask {
    ...
    pub unsafe fn SwitchOut(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SwitchOut)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn GetMemStats(&self) -> windows_core::Result<COR_GC_THREAD_STATS> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMemStats)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ExitTask(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ExitTask)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    ...
    pub unsafe fn RudeAbort(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RudeAbort)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn NeedsPriorityScheduling(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).NeedsPriorityScheduling)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn YieldTask(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).YieldTask)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn LocksHeld(&self) -> windows_core::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LocksHeld)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetTaskIdentifier(&self, asked: u64) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTaskIdentifier)(
                windows_core::Interface::as_raw(self),
                asked,
            )
            .ok()
...
pub struct ICLRTask_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SwitchIn: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HANDLE,
    ) -> windows_core::HRESULT,
    pub SwitchOut: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub GetMemStats: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut COR_GC_THREAD_STATS,
    ) -> windows_core::HRESULT,
    ...
    pub NeedsPriorityScheduling: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
...
impl ICLRTask_Vtbl {
    pub const fn new<Identity: ICLRTask_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SwitchIn<Identity: ICLRTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            threadhandle: super::super::Foundation::HANDLE,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SwitchOut<Identity: ICLRTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetMemStats<Identity: ICLRTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            memusage: *mut COR_GC_THREAD_STATS,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Reset<Identity: ICLRTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ffull: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ExitTask<Identity: ICLRTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Abort<Identity: ICLRTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn RudeAbort<Identity: ICLRTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn NeedsPriorityScheduling<
            Identity: ICLRTask_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbneedspriorityscheduling: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn YieldTask<Identity: ICLRTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn LocksHeld<Identity: ICLRTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetTaskIdentifier<
            Identity: ICLRTask_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ICLRTask2,
    ICLRTask2_Vtbl,
    0x28e66a4a_9906_4225_b231_9187c3eb8612
);
...
impl ICLRTask2 {
    pub unsafe fn BeginPreventAsyncAbort(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BeginPreventAsyncAbort)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn EndPreventAsyncAbort(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndPreventAsyncAbort)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct ICLRTask2_Vtbl {
    ...
    pub BeginPreventAsyncAbort:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub EndPreventAsyncAbort:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
}
...
impl ICLRTask2_Vtbl {
    pub const fn new<Identity: ICLRTask2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BeginPreventAsyncAbort<
        ...
        unsafe extern "system" fn EndPreventAsyncAbort<
            Identity: ICLRTask2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl ICLRTaskManager {
    ...
    pub unsafe fn GetCurrentTask(&self) -> windows_core::Result<ICLRTask> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCurrentTask)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn SetUILocale(&self, lcid: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetUILocale)(
                windows_core::Interface::as_raw(self),
                lcid,
            )
            .ok()
    ...
    pub unsafe fn GetCurrentTaskType(&self) -> windows_core::Result<ETaskType> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCurrentTaskType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct ICLRTaskManager_Vtbl {
    ...
    pub GetCurrentTask: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetUILocale:
    ...
    pub GetCurrentTaskType:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut ETaskType) -> windows_core::HRESULT,
}
...
impl ICLRTaskManager_Vtbl {
    pub const fn new<Identity: ICLRTaskManager_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetCurrentTask<
            Identity: ICLRTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetUILocale<
            Identity: ICLRTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetLocale<Identity: ICLRTaskManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lcid: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetCurrentTaskType<
            Identity: ICLRTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl ICatalogServices {
    pub unsafe fn Autodone(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Autodone)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn NotAutodone(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).NotAutodone)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
impl ICatalogServices_Vtbl {
    pub const fn new<Identity: ICatalogServices_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Autodone<Identity: ICatalogServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn NotAutodone<
...
windows_core::imp::define_interface!(
    ...
    0x5c2b07a5_1e98_11d3_872f_00c04f79ed0d
);
...
impl ICorConfiguration {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetGCThreadControl)(
                windows_core::Interface::as_raw(self),
                pgcthreadcontrol.param().abi(),
            )
            .ok()
        }
    }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetGCHostControl)(
                windows_core::Interface::as_raw(self),
                pgchostcontrol.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn SetDebuggerThreadControl<P0>(
        &self,
        pdebuggerthreadcontrol: P0,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<IDebuggerThreadControl>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetDebuggerThreadControl)(
                windows_core::Interface::as_raw(self),
                pdebuggerthreadcontrol.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn AddDebuggerSpecialThread(
        &self,
        dwspecialthreadid: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddDebuggerSpecialThread)(
                windows_core::Interface::as_raw(self),
                dwspecialthreadid,
            )
            .ok()
...
pub struct ICorConfiguration_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetGCThreadControl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetGCHostControl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetDebuggerThreadControl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AddDebuggerSpecialThread:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
}
pub trait ICorConfiguration_Impl: windows_core::IUnknownImpl {
    fn SetGCThreadControl(
        &self,
        pgcthreadcontrol: windows_core::Ref<'_, IGCThreadControl>,
    ) -> windows_core::Result<()>;
    fn SetGCHostControl(
        &self,
        pgchostcontrol: windows_core::Ref<'_, IGCHostControl>,
    ) -> windows_core::Result<()>;
    fn SetDebuggerThreadControl(
        &self,
        pdebuggerthreadcontrol: windows_core::Ref<'_, IDebuggerThreadControl>,
    ) -> windows_core::Result<()>;
...
impl ICorConfiguration_Vtbl {
    pub const fn new<Identity: ICorConfiguration_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetGCThreadControl<
            Identity: ICorConfiguration_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pgcthreadcontrol: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICorConfiguration_Impl::SetGCThreadControl(
                    this,
                    core::mem::transmute_copy(&pgcthreadcontrol),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetGCHostControl<
            Identity: ICorConfiguration_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pgchostcontrol: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICorConfiguration_Impl::SetGCHostControl(
                    this,
                    core::mem::transmute_copy(&pgchostcontrol),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetDebuggerThreadControl<
            Identity: ICorConfiguration_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pdebuggerthreadcontrol: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICorConfiguration_Impl::SetDebuggerThreadControl(
                    this,
                    core::mem::transmute_copy(&pdebuggerthreadcontrol),
                )
                .into()
            }
        }
        unsafe extern "system" fn AddDebuggerSpecialThread<
            Identity: ICorConfiguration_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICorConfiguration_Impl::AddDebuggerSpecialThread(
                    this,
                    core::mem::transmute_copy(&dwspecialthreadid),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xcb2f6722_ab3a_11d2_9c40_00c04fa30a3e
);
...
impl ICorRuntimeHost {
    pub unsafe fn CreateLogicalThreadState(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CreateLogicalThreadState)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn DeleteLogicalThreadState(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteLogicalThreadState)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn SwitchInLogicalThreadState(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SwitchInLogicalThreadState)(
                windows_core::Interface::as_raw(self),
                pfibercookie,
            )
            .ok()
    ...
    pub unsafe fn SwitchOutLogicalThreadState(&self) -> windows_core::Result<*mut u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SwitchOutLogicalThreadState)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn LocksHeldByLogicalThread(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LocksHeldByLogicalThread)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn MapFile(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MapFile)(
                windows_core::Interface::as_raw(self),
                hfile,
                &mut result__,
            )
        ...
        P1: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateDomain)(
                windows_core::Interface::as_raw(self),
                pwzfriendlyname.param().abi(),
                pidentityarray.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn GetDefaultDomain(&self) -> windows_core::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDefaultDomain)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn EnumDomains(
        &self,
        henum: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EnumDomains)(
                windows_core::Interface::as_raw(self),
                henum as _,
            )
            .ok()
    ...
    pub unsafe fn NextDomain(
        &self,
        henum: *const core::ffi::c_void,
    ) -> windows_core::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).NextDomain)(
                windows_core::Interface::as_raw(self),
                henum,
                &mut result__,
            )
        ...
        P2: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateDomainEx)(
                windows_core::Interface::as_raw(self),
                pwzfriendlyname.param().abi(),
                psetup.param().abi(),
                pevidence.param().abi(),
    ...
    pub unsafe fn CreateDomainSetup(&self) -> windows_core::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateDomainSetup)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn CreateEvidence(&self) -> windows_core::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateEvidence)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).UnloadDomain)(
                windows_core::Interface::as_raw(self),
                pappdomain.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn CurrentDomain(&self) -> windows_core::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CurrentDomain)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ICorRuntimeHost_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateLogicalThreadState:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub DeleteLogicalThreadState:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    ...
    pub SwitchOutLogicalThreadState:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut u32) -> windows_core::HRESULT,
...
pub trait ICorRuntimeHost_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateDomain(
        &self,
        pwzfriendlyname: &windows_core::PCWSTR,
        pidentityarray: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<windows_core::IUnknown>;
    ...
    fn CreateDomainEx(
        &self,
        pwzfriendlyname: &windows_core::PCWSTR,
        psetup: windows_core::Ref<'_, windows_core::IUnknown>,
        pevidence: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<windows_core::IUnknown>;
...
impl ICorRuntimeHost_Vtbl {
    pub const fn new<Identity: ICorRuntimeHost_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateLogicalThreadState<
        ...
        unsafe extern "system" fn DeleteLogicalThreadState<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SwitchInLogicalThreadState<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICorRuntimeHost_Impl::SwitchInLogicalThreadState(
                    this,
                    core::mem::transmute_copy(&pfibercookie),
                )
                .into()
            }
        }
        unsafe extern "system" fn SwitchOutLogicalThreadState<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn LocksHeldByLogicalThread<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn MapFile<Identity: ICorRuntimeHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hfile: super::super::Foundation::HANDLE,
            hmapaddress: *mut super::super::Foundation::HMODULE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            pconfiguration: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Start<Identity: ICorRuntimeHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Stop<Identity: ICorRuntimeHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn CreateDomain<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICorRuntimeHost_Impl::CreateDomain(
                    this,
                    core::mem::transmute(&pwzfriendlyname),
                    core::mem::transmute_copy(&pidentityarray),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetDefaultDomain<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnumDomains<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn NextDomain<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CloseEnum<Identity: ICorRuntimeHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            henum: *const core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn CreateDomainEx<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICorRuntimeHost_Impl::CreateDomainEx(
                    this,
                    core::mem::transmute(&pwzfriendlyname),
                    core::mem::transmute_copy(&psetup),
                    core::mem::transmute_copy(&pevidence),
                ) {
                    Ok(ok__) => {
                        pappdomain.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn CreateDomainSetup<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pappdomainsetup: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateEvidence<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pevidence: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn UnloadDomain<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICorRuntimeHost_Impl::UnloadDomain(this, core::mem::transmute_copy(&pappdomain))
                    .into()
            }
        }
        unsafe extern "system" fn CurrentDomain<
            Identity: ICorRuntimeHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ICorThreadpool,
    ICorThreadpool_Vtbl,
    0x84680d3a_b2c1_46e8_acc2_dbc0a359159a
);
windows_core::imp::interface_hierarchy!(ICorThreadpool, windows_core::IUnknown);
impl ICorThreadpool {
    #[cfg(feature = "Win32_System_Threading")]
    pub unsafe fn CorRegisterWaitForSingleObject(
        &self,
        phnewwaitobject: *const super::super::Foundation::HANDLE,
        hwaitobject: super::super::Foundation::HANDLE,
        callback: super::Threading::WAITORTIMERCALLBACK,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CorRegisterWaitForSingleObject)(
                windows_core::Interface::as_raw(self),
                phnewwaitobject,
                hwaitobject,
                callback,
                context,
                timeout,
                executeonlyonce.into(),
                &mut result__,
            )
            .map(|| result__)
        }
    }
    pub unsafe fn CorUnregisterWait(
        &self,
        hwaitobject: super::super::Foundation::HANDLE,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CorUnregisterWait)(
                windows_core::Interface::as_raw(self),
                hwaitobject,
                completionevent,
                &mut result__,
    ...
    #[cfg(feature = "Win32_System_Threading")]
    pub unsafe fn CorQueueUserWorkItem(
        &self,
        function: super::Threading::LPTHREAD_START_ROUTINE,
        context: *const core::ffi::c_void,
        executeonlyonce: bool,
    ) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CorQueueUserWorkItem)(
                windows_core::Interface::as_raw(self),
                function,
                context,
                executeonlyonce.into(),
    ...
    #[cfg(feature = "Win32_System_Threading")]
    pub unsafe fn CorCreateTimer(
        &self,
        phnewtimer: *const super::super::Foundation::HANDLE,
        callback: super::Threading::WAITORTIMERCALLBACK,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CorCreateTimer)(
                windows_core::Interface::as_raw(self),
                phnewtimer,
                callback,
                parameter,
    ...
    pub unsafe fn CorChangeTimer(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CorChangeTimer)(
                windows_core::Interface::as_raw(self),
                timer,
                duetime,
                period,
    ...
    pub unsafe fn CorDeleteTimer(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CorDeleteTimer)(
                windows_core::Interface::as_raw(self),
                timer,
                completionevent,
                &mut result__,
    ...
    pub unsafe fn CorBindIoCompletionCallback(
        ...
        callback: super::IO::LPOVERLAPPED_COMPLETION_ROUTINE,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CorBindIoCompletionCallback)(
                windows_core::Interface::as_raw(self),
                filehandle,
                callback,
            )
    ...
    #[cfg(feature = "Win32_System_Threading")]
    pub unsafe fn CorCallOrQueueUserWorkItem(
        &self,
        function: super::Threading::LPTHREAD_START_ROUTINE,
        context: *const core::ffi::c_void,
    ) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CorCallOrQueueUserWorkItem)(
                windows_core::Interface::as_raw(self),
                function,
                context,
                &mut result__,
    ...
    pub unsafe fn CorSetMaxThreads(
        &self,
        maxworkerthreads: u32,
        maxiocompletionthreads: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CorSetMaxThreads)(
                windows_core::Interface::as_raw(self),
                maxworkerthreads,
    ...
    pub unsafe fn CorGetMaxThreads(
        &self,
        maxworkerthreads: *mut u32,
        maxiocompletionthreads: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CorGetMaxThreads)(
                windows_core::Interface::as_raw(self),
                maxworkerthreads as _,
                maxiocompletionthreads as _,
            )
            .ok()
        }
    }
    pub unsafe fn CorGetAvailableThreads(
        &self,
        availableworkerthreads: *mut u32,
        availableiocompletionthreads: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CorGetAvailableThreads)(
                windows_core::Interface::as_raw(self),
                availableworkerthreads as _,
                availableiocompletionthreads as _,
            )
            .ok()
        }
    }
...
pub struct ICorThreadpool_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_System_Threading")]
    pub CorRegisterWaitForSingleObject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::super::Foundation::HANDLE,
        super::super::Foundation::HANDLE,
        super::Threading::WAITORTIMERCALLBACK,
        *const core::ffi::c_void,
        u32,
        windows_core::BOOL,
        *mut windows_core::BOOL,
    ...
    pub CorUnregisterWait: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HANDLE,
        super::super::Foundation::HANDLE,
        *mut windows_core::BOOL,
    ...
    #[cfg(feature = "Win32_System_Threading")]
    pub CorQueueUserWorkItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::Threading::LPTHREAD_START_ROUTINE,
        *const core::ffi::c_void,
        windows_core::BOOL,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Win32_System_Threading")]
    pub CorCreateTimer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::super::Foundation::HANDLE,
        super::Threading::WAITORTIMERCALLBACK,
        *const core::ffi::c_void,
    ...
    pub CorChangeTimer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HANDLE,
        u32,
        u32,
    ...
    pub CorDeleteTimer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HANDLE,
        super::super::Foundation::HANDLE,
        *mut windows_core::BOOL,
    ...
    #[cfg(feature = "Win32_System_IO")]
    pub CorBindIoCompletionCallback: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HANDLE,
        super::IO::LPOVERLAPPED_COMPLETION_ROUTINE,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_IO"))]
    CorBindIoCompletionCallback: usize,
    #[cfg(feature = "Win32_System_Threading")]
    pub CorCallOrQueueUserWorkItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::Threading::LPTHREAD_START_ROUTINE,
        *const core::ffi::c_void,
        *mut windows_core::BOOL,
    ...
    pub CorSetMaxThreads:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, u32) -> windows_core::HRESULT,
    pub CorGetMaxThreads: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub CorGetAvailableThreads: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
...
pub trait ICorThreadpool_Impl: windows_core::IUnknownImpl {
    fn CorRegisterWaitForSingleObject(
        ...
        context: *const core::ffi::c_void,
        timeout: u32,
        executeonlyonce: windows_core::BOOL,
    ) -> windows_core::Result<windows_core::BOOL>;
...
impl ICorThreadpool_Vtbl {
    pub const fn new<Identity: ICorThreadpool_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CorRegisterWaitForSingleObject<
        ...
        >(
            ...
            timeout: u32,
            executeonlyonce: windows_core::BOOL,
            result: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICorThreadpool_Impl::CorRegisterWaitForSingleObject(
                    this,
                    core::mem::transmute_copy(&phnewwaitobject),
                    core::mem::transmute_copy(&hwaitobject),
                    core::mem::transmute_copy(&callback),
                    core::mem::transmute_copy(&context),
                    core::mem::transmute_copy(&timeout),
                    core::mem::transmute_copy(&executeonlyonce),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CorUnregisterWait<
            Identity: ICorThreadpool_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICorThreadpool_Impl::CorUnregisterWait(
                    this,
                    core::mem::transmute_copy(&hwaitobject),
                    core::mem::transmute_copy(&completionevent),
                ) {
                    Ok(ok__) => {
                        result.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn CorQueueUserWorkItem<
            Identity: ICorThreadpool_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICorThreadpool_Impl::CorQueueUserWorkItem(
                    this,
                    core::mem::transmute_copy(&function),
                    core::mem::transmute_copy(&context),
                    core::mem::transmute_copy(&executeonlyonce),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CorCreateTimer<
            Identity: ICorThreadpool_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICorThreadpool_Impl::CorCreateTimer(
                    this,
                    core::mem::transmute_copy(&phnewtimer),
                    core::mem::transmute_copy(&callback),
                    core::mem::transmute_copy(&parameter),
                    core::mem::transmute_copy(&duetime),
                    core::mem::transmute_copy(&period),
                ) {
                    Ok(ok__) => {
                        result.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn CorChangeTimer<
            Identity: ICorThreadpool_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICorThreadpool_Impl::CorChangeTimer(
                    this,
                    core::mem::transmute_copy(&timer),
                    core::mem::transmute_copy(&duetime),
                    core::mem::transmute_copy(&period),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CorDeleteTimer<
            Identity: ICorThreadpool_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICorThreadpool_Impl::CorDeleteTimer(
                    this,
                    core::mem::transmute_copy(&timer),
                    core::mem::transmute_copy(&completionevent),
                ) {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICorThreadpool_Impl::CorBindIoCompletionCallback(
                    this,
                    core::mem::transmute_copy(&filehandle),
                    core::mem::transmute_copy(&callback),
                )
                .into()
            }
        }
        unsafe extern "system" fn CorCallOrQueueUserWorkItem<
            Identity: ICorThreadpool_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICorThreadpool_Impl::CorCallOrQueueUserWorkItem(
                    this,
                    core::mem::transmute_copy(&function),
                    core::mem::transmute_copy(&context),
                ) {
        ...
        unsafe extern "system" fn CorSetMaxThreads<
            Identity: ICorThreadpool_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICorThreadpool_Impl::CorSetMaxThreads(
                    this,
                    core::mem::transmute_copy(&maxworkerthreads),
                    core::mem::transmute_copy(&maxiocompletionthreads),
                )
                .into()
            }
        }
        unsafe extern "system" fn CorGetMaxThreads<
            Identity: ICorThreadpool_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICorThreadpool_Impl::CorGetMaxThreads(
                    this,
                    core::mem::transmute_copy(&maxworkerthreads),
                    core::mem::transmute_copy(&maxiocompletionthreads),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICorThreadpool_Impl::CorGetAvailableThreads(
                    this,
                    core::mem::transmute_copy(&availableworkerthreads),
                    core::mem::transmute_copy(&availableiocompletionthreads),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IDebuggerInfo,
    IDebuggerInfo_Vtbl,
    0xbf24142d_a47d_4d24_a66d_8c2141944e44
);
...
windows_core::imp::define_interface!(
    ...
    0x23d86786_0bb5_4774_8fb5_e3522add6246
);
...
impl IDebuggerThreadControl {
    pub unsafe fn ThreadIsBlockingForDebugger(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ThreadIsBlockingForDebugger)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn ReleaseAllRuntimeThreads(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ReleaseAllRuntimeThreads)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn StartBlockingForDebugger(&self, dwunused: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).StartBlockingForDebugger)(
                windows_core::Interface::as_raw(self),
                dwunused,
            )
            .ok()
...
pub struct IDebuggerThreadControl_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ThreadIsBlockingForDebugger:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ReleaseAllRuntimeThreads:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub StartBlockingForDebugger:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
}
...
impl IDebuggerThreadControl_Vtbl {
    pub const fn new<Identity: IDebuggerThreadControl_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ThreadIsBlockingForDebugger<
        ...
        unsafe extern "system" fn ReleaseAllRuntimeThreads<
            Identity: IDebuggerThreadControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn StartBlockingForDebugger<
            Identity: IDebuggerThreadControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDebuggerThreadControl_Impl::StartBlockingForDebugger(
                    this,
                    core::mem::transmute_copy(&dwunused),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IGCHost,
    IGCHost_Vtbl,
    0xfac34f6e_0dcd_47b5_8021_531bc5ecca63
);
...
impl IGCHost {
    ...
    pub unsafe fn GetThreadStats(
        &self,
        pfibercookie: *const u32,
        pstats: *mut COR_GC_THREAD_STATS,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetThreadStats)(
                windows_core::Interface::as_raw(self),
                pfibercookie,
                pstats as _,
            )
    ...
    pub unsafe fn SetVirtualMemLimit(&self, sztmaxvirtualmemmb: usize) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetVirtualMemLimit)(
                windows_core::Interface::as_raw(self),
                sztmaxvirtualmemmb,
            )
            .ok()
...
pub struct IGCHost_Vtbl {
    ...
    pub GetThreadStats: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const u32,
        *mut COR_GC_THREAD_STATS,
    ) -> windows_core::HRESULT,
    pub SetVirtualMemLimit:
        unsafe extern "system" fn(*mut core::ffi::c_void, usize) -> windows_core::HRESULT,
}
    ...
    pub const fn new<Identity: IGCHost_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGCHost_Impl::SetGCStartupLimits(
                    this,
                    core::mem::transmute_copy(&segmentsize),
                    core::mem::transmute_copy(&maxgen0size),
                )
        ...
        unsafe extern "system" fn Collect<Identity: IGCHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            generation: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetStats<Identity: IGCHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pstats: *mut COR_GC_STATS,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetThreadStats<Identity: IGCHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pfibercookie: *const u32,
            pstats: *mut COR_GC_THREAD_STATS,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn SetVirtualMemLimit<
            Identity: IGCHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGCHost_Impl::SetVirtualMemLimit(
                    this,
                    core::mem::transmute_copy(&sztmaxvirtualmemmb),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IGCHost2,
    IGCHost2_Vtbl,
    0xa1d70cec_2dbe_4e2f_9291_fdf81438a1df
);
    ...
    pub const fn new<Identity: IGCHost2_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGCHost2_Impl::SetGCStartupLimitsEx(
                    this,
                    core::mem::transmute_copy(&segmentsize),
                    core::mem::transmute_copy(&maxgen0size),
                )
        ...
        Self {
            base__: IGCHost_Vtbl::new::<Identity, OFFSET>(),
            SetGCStartupLimitsEx: SetGCStartupLimitsEx::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IGCHostControl,
    IGCHostControl_Vtbl,
    0x5513d564_8374_4cb9_aed9_0083f4160a1d
);
windows_core::imp::interface_hierarchy!(IGCHostControl, windows_core::IUnknown);
impl IGCHostControl {
    pub unsafe fn RequestVirtualMemLimit(
        &self,
        sztmaxvirtualmemmb: usize,
        psztnewmaxvirtualmemmb: *mut usize,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RequestVirtualMemLimit)(
                windows_core::Interface::as_raw(self),
                sztmaxvirtualmemmb,
                psztnewmaxvirtualmemmb as _,
            )
            .ok()
        }
    }
...
pub struct IGCHostControl_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub RequestVirtualMemLimit: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        usize,
        *mut usize,
    ) -> windows_core::HRESULT,
...
impl IGCHostControl_Vtbl {
    pub const fn new<Identity: IGCHostControl_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RequestVirtualMemLimit<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGCHostControl_Impl::RequestVirtualMemLimit(
                    this,
                    core::mem::transmute_copy(&sztmaxvirtualmemmb),
                    core::mem::transmute_copy(&psztnewmaxvirtualmemmb),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            RequestVirtualMemLimit: RequestVirtualMemLimit::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xf31d1788_c397_4725_87a5_6af3472c2791
);
...
impl IGCThreadControl {
    pub unsafe fn ThreadIsBlockingForSuspension(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ThreadIsBlockingForSuspension)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn SuspensionStarting(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SuspensionStarting)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn SuspensionEnding(&self, generation: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SuspensionEnding)(
                windows_core::Interface::as_raw(self),
                generation,
            )
            .ok()
...
pub struct IGCThreadControl_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ThreadIsBlockingForSuspension:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub SuspensionStarting:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub SuspensionEnding:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
}
    ...
    pub const fn new<Identity: IGCThreadControl_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGCThreadControl_Impl::SuspensionEnding(
                    this,
                    core::mem::transmute_copy(&generation),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x613dabd7_62b2_493e_9e65_c1e32a1e0c5e
);
windows_core::imp::interface_hierarchy!(IHostAssemblyManager, windows_core::IUnknown);
impl IHostAssemblyManager {
    pub unsafe fn GetNonHostStoreAssemblies(
        &self,
    ) -> windows_core::Result<ICLRAssemblyReferenceList> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNonHostStoreAssemblies)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetAssemblyStore(&self) -> windows_core::Result<IHostAssemblyStore> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAssemblyStore)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl IHostAssemblyManager_Vtbl {
    pub const fn new<Identity: IHostAssemblyManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            ppassemblystore: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x7b102a88_3f7f_496d_8fa2_c35374e01af3
);
windows_core::imp::interface_hierarchy!(IHostAssemblyStore, windows_core::IUnknown);
impl IHostAssemblyStore {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn ProvideAssembly(
        &self,
        pbindinfo: *const AssemblyBindInfo,
        passemblyid: *mut u64,
        pcontext: *mut u64,
        ppstmassemblyimage: *mut Option<super::Com::IStream>,
        ppstmpdb: *mut Option<super::Com::IStream>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ProvideAssembly)(
                windows_core::Interface::as_raw(self),
                pbindinfo,
                passemblyid as _,
                pcontext as _,
                core::mem::transmute(ppstmassemblyimage),
                core::mem::transmute(ppstmpdb),
            )
            .ok()
        }
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn ProvideModule(
        &self,
        pbindinfo: *const ModuleBindInfo,
        pdwmoduleid: *mut u32,
        ppstmmoduleimage: *mut Option<super::Com::IStream>,
        ppstmpdb: *mut Option<super::Com::IStream>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ProvideModule)(
                windows_core::Interface::as_raw(self),
                pbindinfo,
                pdwmoduleid as _,
                core::mem::transmute(ppstmmoduleimage),
                core::mem::transmute(ppstmpdb),
            )
            .ok()
        }
...
pub trait IHostAssemblyStore_Impl: windows_core::IUnknownImpl {
    fn ProvideAssembly(
        ...
        passemblyid: *mut u64,
        pcontext: *mut u64,
        ppstmassemblyimage: windows_core::OutRef<'_, super::Com::IStream>,
        ppstmpdb: windows_core::OutRef<'_, super::Com::IStream>,
    ) -> windows_core::Result<()>;
    fn ProvideModule(
        &self,
        pbindinfo: *const ModuleBindInfo,
        pdwmoduleid: *mut u32,
        ppstmmoduleimage: windows_core::OutRef<'_, super::Com::IStream>,
        ppstmpdb: windows_core::OutRef<'_, super::Com::IStream>,
    ) -> windows_core::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
impl IHostAssemblyStore_Vtbl {
    pub const fn new<Identity: IHostAssemblyStore_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            passemblyid: *mut u64,
            pcontext: *mut u64,
            ppstmassemblyimage: *mut *mut core::ffi::c_void,
            ppstmpdb: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostAssemblyStore_Impl::ProvideAssembly(
                    ...
                    core::mem::transmute_copy(&passemblyid),
                    core::mem::transmute_copy(&pcontext),
                    core::mem::transmute_copy(&ppstmassemblyimage),
                    core::mem::transmute_copy(&ppstmpdb),
                )
                .into()
            }
        }
        ...
        >(
            ...
            pbindinfo: *const ModuleBindInfo,
            pdwmoduleid: *mut u32,
            ppstmmoduleimage: *mut *mut core::ffi::c_void,
            ppstmpdb: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                ...
                IHostAssemblyStore_Impl::ProvideModule(
                    this,
                    core::mem::transmute_copy(&pbindinfo),
                    core::mem::transmute_copy(&pdwmoduleid),
                    core::mem::transmute_copy(&ppstmmoduleimage),
                    core::mem::transmute_copy(&ppstmpdb),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    IHostAutoEvent,
    IHostAutoEvent_Vtbl,
    0x50b0cfce_4063_4278_9673_e5cb4ed0bdb8
);
...
impl IHostAutoEvent_Vtbl {
    pub const fn new<Identity: IHostAutoEvent_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Wait<Identity: IHostAutoEvent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwmilliseconds: u32,
            option: u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Set<Identity: IHostAutoEvent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    IHostControl,
    IHostControl_Vtbl,
    0x02ca073c_7079_4860_880a_c2f7a449c991
);
...
impl IHostControl {
    pub unsafe fn GetHostManager(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetHostManager)(
                windows_core::Interface::as_raw(self),
                riid,
                ppobject as _,
            )
    ...
    pub unsafe fn SetAppDomainManager<P1>(
        &self,
        dwappdomainid: u32,
        punkappdomainmanager: P1,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetAppDomainManager)(
                windows_core::Interface::as_raw(self),
                dwappdomainid,
                punkappdomainmanager.param().abi(),
            )
            .ok()
        }
    }
...
impl IHostControl_Vtbl {
    pub const fn new<Identity: IHostControl_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            dwappdomainid: u32,
            punkappdomainmanager: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    IHostCrst,
    IHostCrst_Vtbl,
    0x6df710a6_26a4_4a65_8cd5_7237b8bda8dc
);
...
impl IHostCrst {
    pub unsafe fn Enter(&self, option: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Enter)(
                windows_core::Interface::as_raw(self),
                option,
            )
            .ok()
    ...
    pub unsafe fn TryEnter(&self, option: u32) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TryEnter)(
                windows_core::Interface::as_raw(self),
                option,
                &mut result__,
            )
    ...
    pub unsafe fn SetSpinCount(&self, dwspincount: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSpinCount)(
                windows_core::Interface::as_raw(self),
                dwspincount,
            )
            .ok()
...
pub struct IHostCrst_Vtbl {
    ...
    pub TryEnter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
...
impl IHostCrst_Vtbl {
    pub const fn new<Identity: IHostCrst_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Enter<Identity: IHostCrst_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            option: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Leave<Identity: IHostCrst_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn TryEnter<Identity: IHostCrst_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            option: u32,
            pbsucceeded: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetSpinCount<Identity: IHostCrst_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwspincount: u32,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    IHostGCManager,
    IHostGCManager_Vtbl,
    0x5d4ec34e_f248_457b_b603_255faaba0d21
);
    ...
    pub const fn new<Identity: IHostGCManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostGCManager_Impl::SuspensionEnding(this, core::mem::transmute_copy(&generation))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0x8bde9d80_ec06_41d6_83e6_22580effcc20
);
...
impl IHostIoCompletionManager {
    pub unsafe fn CreateIoCompletionPort(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateIoCompletionPort)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn CloseIoCompletionPort(
        &self,
        hport: super::super::Foundation::HANDLE,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CloseIoCompletionPort)(
                windows_core::Interface::as_raw(self),
                hport,
            )
            .ok()
    ...
    pub unsafe fn GetAvailableThreads(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAvailableThreads)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetHostOverlappedSize(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetHostOverlappedSize)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetCLRIoCompletionManager)(
                windows_core::Interface::as_raw(self),
                pmanager.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn InitializeHostOverlapped(
        &self,
        pvoverlapped: *const core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).InitializeHostOverlapped)(
                windows_core::Interface::as_raw(self),
                pvoverlapped,
            )
            .ok()
    ...
    pub unsafe fn GetMinThreads(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMinThreads)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IHostIoCompletionManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateIoCompletionPort: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::HANDLE,
    ) -> windows_core::HRESULT,
    pub CloseIoCompletionPort: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HANDLE,
    ) -> windows_core::HRESULT,
    pub SetMaxThreads:
    ...
    pub GetMaxThreads:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetAvailableThreads:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetHostOverlappedSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetCLRIoCompletionManager: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub InitializeHostOverlapped: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IHostIoCompletionManager_Impl: windows_core::IUnknownImpl {
    ...
    fn SetCLRIoCompletionManager(
        &self,
        pmanager: windows_core::Ref<'_, ICLRIoCompletionManager>,
    ) -> windows_core::Result<()>;
...
impl IHostIoCompletionManager_Vtbl {
    pub const fn new<Identity: IHostIoCompletionManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateIoCompletionPort<
            Identity: IHostIoCompletionManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            phport: *mut super::super::Foundation::HANDLE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CloseIoCompletionPort<
            Identity: IHostIoCompletionManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostIoCompletionManager_Impl::CloseIoCompletionPort(
                    this,
                    core::mem::transmute_copy(&hport),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostIoCompletionManager_Impl::SetMaxThreads(
                    this,
                    core::mem::transmute_copy(&dwmaxiocompletionthreads),
                )
                .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            pdwmaxiocompletionthreads: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetAvailableThreads<
            Identity: IHostIoCompletionManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pdwavailableiocompletionthreads: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetHostOverlappedSize<
            Identity: IHostIoCompletionManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetCLRIoCompletionManager<
            Identity: IHostIoCompletionManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pmanager: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostIoCompletionManager_Impl::SetCLRIoCompletionManager(
                    this,
                    core::mem::transmute_copy(&pmanager),
                )
                .into()
            }
        }
        unsafe extern "system" fn InitializeHostOverlapped<
            Identity: IHostIoCompletionManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostIoCompletionManager_Impl::InitializeHostOverlapped(
                    this,
                    core::mem::transmute_copy(&pvoverlapped),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostIoCompletionManager_Impl::Bind(
                    this,
                    core::mem::transmute_copy(&hport),
                    core::mem::transmute_copy(&hhandle),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostIoCompletionManager_Impl::SetMinThreads(
                    this,
                    core::mem::transmute_copy(&dwminiocompletionthreads),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetMinThreads<
            Identity: IHostIoCompletionManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pdwminiocompletionthreads: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    IHostMalloc,
    IHostMalloc_Vtbl,
    0x1831991c_cc53_4a31_b218_04e910446479
);
...
impl IHostMalloc {
    pub unsafe fn Alloc(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Alloc)(
                windows_core::Interface::as_raw(self),
                cbsize,
                ecriticallevel,
                ppmem as _,
    ...
    pub unsafe fn DebugAlloc(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DebugAlloc)(
                windows_core::Interface::as_raw(self),
                cbsize,
                ecriticallevel,
                pszfilename,
...
pub struct IHostMalloc_Vtbl {
    ...
    pub DebugAlloc: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        usize,
        EMemoryCriticalLevel,
        *const u8,
...
impl IHostMalloc_Vtbl {
    pub const fn new<Identity: IHostMalloc_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Alloc<Identity: IHostMalloc_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            cbsize: usize,
            ecriticallevel: EMemoryCriticalLevel,
            ppmem: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostMalloc_Impl::Alloc(
                    this,
                    core::mem::transmute_copy(&cbsize),
                    core::mem::transmute_copy(&ecriticallevel),
                    core::mem::transmute_copy(&ppmem),
                )
                .into()
            }
        }
        unsafe extern "system" fn DebugAlloc<Identity: IHostMalloc_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            cbsize: usize,
            ecriticallevel: EMemoryCriticalLevel,
            pszfilename: *const u8,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostMalloc_Impl::DebugAlloc(
                    this,
                    core::mem::transmute_copy(&cbsize),
                    core::mem::transmute_copy(&ecriticallevel),
                    core::mem::transmute_copy(&pszfilename),
                    core::mem::transmute_copy(&ilineno),
                    core::mem::transmute_copy(&ppmem),
                )
                .into()
            }
        }
        unsafe extern "system" fn Free<Identity: IHostMalloc_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x1bf4ec38_affe_4fb9_85a6_525268f15b54
);
...
impl IHostManualEvent_Vtbl {
    pub const fn new<Identity: IHostManualEvent_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Wait<Identity: IHostManualEvent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwmilliseconds: u32,
            option: u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Reset<Identity: IHostManualEvent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Set<Identity: IHostManualEvent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    ...
    0x7bc698d1_f9e3_4460_9cde_d04248e9fa25
);
...
impl IHostMemoryManager {
    pub unsafe fn CreateMalloc(&self, dwmalloctype: u32) -> windows_core::Result<IHostMalloc> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateMalloc)(
                windows_core::Interface::as_raw(self),
                dwmalloctype,
                &mut result__,
            )
    ...
    pub unsafe fn VirtualAlloc(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).VirtualAlloc)(
                windows_core::Interface::as_raw(self),
                paddress,
                dwsize,
                flallocationtype,
    ...
    pub unsafe fn VirtualFree(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).VirtualFree)(
                windows_core::Interface::as_raw(self),
                lpaddress,
                dwsize,
                dwfreetype,
    ...
    pub unsafe fn VirtualQuery(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).VirtualQuery)(
                windows_core::Interface::as_raw(self),
                lpaddress,
                lpbuffer as _,
                dwlength,
    ...
    pub unsafe fn VirtualProtect(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).VirtualProtect)(
                windows_core::Interface::as_raw(self),
                lpaddress,
                dwsize,
                flnewprotect,
    ...
    pub unsafe fn GetMemoryLoad(
        &self,
        pmemoryload: *mut u32,
        pavailablebytes: *mut usize,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetMemoryLoad)(
                windows_core::Interface::as_raw(self),
                pmemoryload as _,
                pavailablebytes as _,
            )
            .ok()
        }
    }
    pub unsafe fn RegisterMemoryNotificationCallback<P0>(
        &self,
        pcallback: P0,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterMemoryNotificationCallback)(
                windows_core::Interface::as_raw(self),
                pcallback.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn NeedsVirtualAddressSpace(
        &self,
        startaddress: *const core::ffi::c_void,
        size: usize,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).NeedsVirtualAddressSpace)(
                windows_core::Interface::as_raw(self),
                startaddress,
                size,
            )
    ...
    pub unsafe fn AcquiredVirtualAddressSpace(
        &self,
        startaddress: *const core::ffi::c_void,
        size: usize,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AcquiredVirtualAddressSpace)(
                windows_core::Interface::as_raw(self),
                startaddress,
                size,
            )
    ...
    pub unsafe fn ReleasedVirtualAddressSpace(
        &self,
        startaddress: *const core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ReleasedVirtualAddressSpace)(
                windows_core::Interface::as_raw(self),
                startaddress,
            )
            .ok()
...
pub struct IHostMemoryManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateMalloc: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub VirtualAlloc: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        usize,
        u32,
    ...
    pub VirtualFree: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        usize,
        u32,
    ) -> windows_core::HRESULT,
    pub VirtualQuery: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        *mut core::ffi::c_void,
        usize,
    ...
    pub VirtualProtect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        usize,
        u32,
    ...
    pub GetMemoryLoad: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut usize,
    ) -> windows_core::HRESULT,
    pub RegisterMemoryNotificationCallback: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub NeedsVirtualAddressSpace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        usize,
    ) -> windows_core::HRESULT,
    pub AcquiredVirtualAddressSpace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        usize,
    ) -> windows_core::HRESULT,
    pub ReleasedVirtualAddressSpace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IHostMemoryManager_Impl: windows_core::IUnknownImpl {
    ...
    fn RegisterMemoryNotificationCallback(
        &self,
        pcallback: windows_core::Ref<'_, ICLRMemoryNotificationCallback>,
    ) -> windows_core::Result<()>;
...
impl IHostMemoryManager_Vtbl {
    pub const fn new<Identity: IHostMemoryManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateMalloc<
            Identity: IHostMemoryManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dwmalloctype: u32,
            ppmalloc: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostMemoryManager_Impl::CreateMalloc(
                    this,
                    core::mem::transmute_copy(&dwmalloctype),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn VirtualAlloc<
            Identity: IHostMemoryManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostMemoryManager_Impl::VirtualAlloc(
                    this,
                    core::mem::transmute_copy(&paddress),
                    core::mem::transmute_copy(&dwsize),
                    core::mem::transmute_copy(&flallocationtype),
                    core::mem::transmute_copy(&flprotect),
                    core::mem::transmute_copy(&ecriticallevel),
                    core::mem::transmute_copy(&ppmem),
                )
                .into()
        ...
        unsafe extern "system" fn VirtualFree<
            Identity: IHostMemoryManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostMemoryManager_Impl::VirtualFree(
                    this,
                    core::mem::transmute_copy(&lpaddress),
                    core::mem::transmute_copy(&dwsize),
                    core::mem::transmute_copy(&dwfreetype),
                )
                .into()
            }
        }
        unsafe extern "system" fn VirtualQuery<
            Identity: IHostMemoryManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostMemoryManager_Impl::VirtualQuery(
                    this,
                    core::mem::transmute_copy(&lpaddress),
        ...
        unsafe extern "system" fn VirtualProtect<
            Identity: IHostMemoryManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            dwsize: usize,
            flnewprotect: u32,
            pfloldprotect: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostMemoryManager_Impl::VirtualProtect(
                    this,
                    core::mem::transmute_copy(&lpaddress),
                    core::mem::transmute_copy(&dwsize),
                    core::mem::transmute_copy(&flnewprotect),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetMemoryLoad<
            Identity: IHostMemoryManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostMemoryManager_Impl::GetMemoryLoad(
                    this,
                    core::mem::transmute_copy(&pmemoryload),
                    core::mem::transmute_copy(&pavailablebytes),
                )
                .into()
            }
        }
        unsafe extern "system" fn RegisterMemoryNotificationCallback<
            Identity: IHostMemoryManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostMemoryManager_Impl::RegisterMemoryNotificationCallback(
                    this,
                    core::mem::transmute_copy(&pcallback),
                )
                .into()
        ...
        unsafe extern "system" fn NeedsVirtualAddressSpace<
            Identity: IHostMemoryManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostMemoryManager_Impl::NeedsVirtualAddressSpace(
                    this,
        ...
        unsafe extern "system" fn AcquiredVirtualAddressSpace<
            Identity: IHostMemoryManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostMemoryManager_Impl::AcquiredVirtualAddressSpace(
                    this,
                    core::mem::transmute_copy(&startaddress),
                    core::mem::transmute_copy(&size),
                )
        ...
        unsafe extern "system" fn ReleasedVirtualAddressSpace<
            Identity: IHostMemoryManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostMemoryManager_Impl::ReleasedVirtualAddressSpace(
                    this,
                    core::mem::transmute_copy(&startaddress),
                )
                .into()
        ...
        Self {
            ...
            RegisterMemoryNotificationCallback: RegisterMemoryNotificationCallback::<
                Identity,
                OFFSET,
            >,
...
impl IHostPolicyManager {
    pub unsafe fn OnDefaultAction(
        &self,
        operation: EClrOperation,
        action: EPolicyAction,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnDefaultAction)(
                windows_core::Interface::as_raw(self),
                operation,
                action,
            )
    ...
    pub unsafe fn OnTimeout(
        &self,
        operation: EClrOperation,
        action: EPolicyAction,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnTimeout)(
                windows_core::Interface::as_raw(self),
                operation,
                action,
            )
    ...
    pub unsafe fn OnFailure(
        &self,
        failure: EClrFailure,
        action: EPolicyAction,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnFailure)(
                windows_core::Interface::as_raw(self),
                failure,
                action,
            )
...
pub struct IHostPolicyManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OnDefaultAction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EClrOperation,
        EPolicyAction,
    ) -> windows_core::HRESULT,
    pub OnTimeout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EClrOperation,
        EPolicyAction,
    ) -> windows_core::HRESULT,
    pub OnFailure: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EClrFailure,
        EPolicyAction,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IHostPolicyManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostPolicyManager_Impl::OnDefaultAction(
                    this,
                    core::mem::transmute_copy(&operation),
                    core::mem::transmute_copy(&action),
                )
        ...
        unsafe extern "system" fn OnTimeout<
            Identity: IHostPolicyManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostPolicyManager_Impl::OnTimeout(
                    this,
                    core::mem::transmute_copy(&operation),
                    core::mem::transmute_copy(&action),
                )
        ...
        unsafe extern "system" fn OnFailure<
            Identity: IHostPolicyManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostPolicyManager_Impl::OnFailure(
                    this,
                    core::mem::transmute_copy(&failure),
                    core::mem::transmute_copy(&action),
                )
...
windows_core::imp::define_interface!(
    ...
    0x7e573ce4_0343_4423_98d7_6318348a1d3c
);
...
impl IHostSecurityContext {
    pub unsafe fn Capture(&self) -> windows_core::Result<IHostSecurityContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Capture)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl IHostSecurityContext_Vtbl {
    pub const fn new<Identity: IHostSecurityContext_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Capture<
            Identity: IHostSecurityContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppclonedcontext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x75ad2468_a349_4d02_a764_76a68aee0c4f
);
...
impl IHostSecurityManager {
    pub unsafe fn ImpersonateLoggedOnUser(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ImpersonateLoggedOnUser)(
                windows_core::Interface::as_raw(self),
                htoken,
            )
            .ok()
    ...
    pub unsafe fn OpenThreadToken(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenThreadToken)(
                windows_core::Interface::as_raw(self),
                dwdesiredaccess,
                bopenasself.into(),
                &mut result__,
    ...
    pub unsafe fn SetThreadToken(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetThreadToken)(
                windows_core::Interface::as_raw(self),
                htoken,
            )
            .ok()
    ...
    pub unsafe fn GetSecurityContext(
        &self,
        econtexttype: EContextType,
    ) -> windows_core::Result<IHostSecurityContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSecurityContext)(
                windows_core::Interface::as_raw(self),
                econtexttype,
                &mut result__,
            )
    ...
    pub unsafe fn SetSecurityContext<P1>(
        &self,
        econtexttype: EContextType,
        psecuritycontext: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetSecurityContext)(
                windows_core::Interface::as_raw(self),
                econtexttype,
                psecuritycontext.param().abi(),
            )
            .ok()
        }
    }
...
pub struct IHostSecurityManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ImpersonateLoggedOnUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HANDLE,
    ) -> windows_core::HRESULT,
    pub RevertToSelf: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub OpenThreadToken: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::BOOL,
        *mut super::super::Foundation::HANDLE,
    ) -> windows_core::HRESULT,
    pub SetThreadToken: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HANDLE,
    ) -> windows_core::HRESULT,
    pub GetSecurityContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EContextType,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetSecurityContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        EContextType,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IHostSecurityManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostSecurityManager_Impl::ImpersonateLoggedOnUser(
                    this,
                    core::mem::transmute_copy(&htoken),
                )
                .into()
            }
        }
        ...
        unsafe extern "system" fn OpenThreadToken<
            Identity: IHostSecurityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dwdesiredaccess: u32,
            bopenasself: windows_core::BOOL,
            phthreadtoken: *mut super::super::Foundation::HANDLE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostSecurityManager_Impl::OpenThreadToken(
                    this,
                    core::mem::transmute_copy(&dwdesiredaccess),
                    core::mem::transmute_copy(&bopenasself),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SetThreadToken<
            Identity: IHostSecurityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostSecurityManager_Impl::SetThreadToken(this, core::mem::transmute_copy(&htoken))
                    .into()
            }
        }
        unsafe extern "system" fn GetSecurityContext<
            Identity: IHostSecurityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            econtexttype: EContextType,
            ppsecuritycontext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostSecurityManager_Impl::GetSecurityContext(
                    this,
                    core::mem::transmute_copy(&econtexttype),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SetSecurityContext<
            Identity: IHostSecurityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            econtexttype: EContextType,
            psecuritycontext: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostSecurityManager_Impl::SetSecurityContext(
                    this,
                    core::mem::transmute_copy(&econtexttype),
                    core::mem::transmute_copy(&psecuritycontext),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IHostSemaphore,
    IHostSemaphore_Vtbl,
    0x855efd47_cc09_463a_a97d_16acab882661
);
...
impl IHostSemaphore {
    ...
    pub unsafe fn ReleaseSemaphore(&self, lreleasecount: i32) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReleaseSemaphore)(
                windows_core::Interface::as_raw(self),
                lreleasecount,
                &mut result__,
            )
...
impl IHostSemaphore_Vtbl {
    pub const fn new<Identity: IHostSemaphore_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Wait<Identity: IHostSemaphore_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwmilliseconds: u32,
            option: u32,
        ) -> windows_core::HRESULT {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostSemaphore_Impl::ReleaseSemaphore(
                    this,
                    core::mem::transmute_copy(&lreleasecount),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0x234330c7_5f10_4f20_9615_5122dab7a0ac
);
...
impl IHostSyncManager {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetCLRSyncManager)(
                windows_core::Interface::as_raw(self),
                pmanager.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn CreateCrst(&self) -> windows_core::Result<IHostCrst> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateCrst)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn CreateCrstWithSpinCount(
        &self,
        dwspincount: u32,
    ) -> windows_core::Result<IHostCrst> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateCrstWithSpinCount)(
                windows_core::Interface::as_raw(self),
                dwspincount,
                &mut result__,
            )
    ...
    pub unsafe fn CreateAutoEvent(&self) -> windows_core::Result<IHostAutoEvent> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateAutoEvent)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn CreateManualEvent(
        &self,
        binitialstate: bool,
    ) -> windows_core::Result<IHostManualEvent> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateManualEvent)(
                windows_core::Interface::as_raw(self),
                binitialstate.into(),
                &mut result__,
            )
    ...
    pub unsafe fn CreateMonitorEvent(&self, cookie: usize) -> windows_core::Result<IHostAutoEvent> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateMonitorEvent)(
                windows_core::Interface::as_raw(self),
                cookie,
                &mut result__,
            )
    ...
    pub unsafe fn CreateRWLockWriterEvent(
        &self,
        cookie: usize,
    ) -> windows_core::Result<IHostAutoEvent> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateRWLockWriterEvent)(
                windows_core::Interface::as_raw(self),
                cookie,
                &mut result__,
            )
    ...
    pub unsafe fn CreateRWLockReaderEvent(
        &self,
        binitialstate: bool,
        cookie: usize,
    ) -> windows_core::Result<IHostManualEvent> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateRWLockReaderEvent)(
                windows_core::Interface::as_raw(self),
                binitialstate.into(),
                cookie,
                &mut result__,
    ...
    pub unsafe fn CreateSemaphoreA(
        ...
        dwinitial: u32,
        dwmax: u32,
    ) -> windows_core::Result<IHostSemaphore> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSemaphoreA)(
                windows_core::Interface::as_raw(self),
                dwinitial,
                dwmax,
                &mut result__,
...
pub struct IHostSyncManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetCLRSyncManager: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateCrst: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateCrstWithSpinCount: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateAutoEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateManualEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateMonitorEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        usize,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateRWLockWriterEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        usize,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateRWLockReaderEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
        usize,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateSemaphoreA: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut *mut core::ffi::c_void,
...
pub trait IHostSyncManager_Impl: windows_core::IUnknownImpl {
    fn SetCLRSyncManager(
        &self,
        pmanager: windows_core::Ref<'_, ICLRSyncManager>,
    ) -> windows_core::Result<()>;
    ...
    fn CreateManualEvent(
        &self,
        binitialstate: windows_core::BOOL,
    ) -> windows_core::Result<IHostManualEvent>;
...
impl IHostSyncManager_Vtbl {
    pub const fn new<Identity: IHostSyncManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetCLRSyncManager<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostSyncManager_Impl::SetCLRSyncManager(this, core::mem::transmute_copy(&pmanager))
                    .into()
            }
        }
        unsafe extern "system" fn CreateCrst<
            Identity: IHostSyncManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppcrst: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateCrstWithSpinCount<
            Identity: IHostSyncManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostSyncManager_Impl::CreateCrstWithSpinCount(
                    this,
                    core::mem::transmute_copy(&dwspincount),
                ) {
                    Ok(ok__) => {
                        ppcrst.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn CreateAutoEvent<
            Identity: IHostSyncManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppevent: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateManualEvent<
            Identity: IHostSyncManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostSyncManager_Impl::CreateManualEvent(
                    this,
                    core::mem::transmute_copy(&binitialstate),
                ) {
                    Ok(ok__) => {
                        ppevent.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn CreateMonitorEvent<
            Identity: IHostSyncManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostSyncManager_Impl::CreateMonitorEvent(
                    this,
                    core::mem::transmute_copy(&cookie),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateRWLockWriterEvent<
            Identity: IHostSyncManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostSyncManager_Impl::CreateRWLockWriterEvent(
                    this,
                    core::mem::transmute_copy(&cookie),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateRWLockReaderEvent<
            Identity: IHostSyncManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostSyncManager_Impl::CreateRWLockReaderEvent(
                    this,
                    core::mem::transmute_copy(&binitialstate),
                    core::mem::transmute_copy(&cookie),
                ) {
        ...
        unsafe extern "system" fn CreateSemaphoreA<
            Identity: IHostSyncManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dwinitial: u32,
            dwmax: u32,
            ppsemaphore: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostSyncManager_Impl::CreateSemaphoreA(
                    this,
                    core::mem::transmute_copy(&dwinitial),
...
windows_core::imp::define_interface!(
    IHostTask,
    IHostTask_Vtbl,
    0xc2275828_c4b1_4b55_82c9_92135f74df1a
);
...
impl IHostTask {
    ...
    pub unsafe fn Alert(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Alert)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn Join(&self, dwmilliseconds: u32, option: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Join)(
                windows_core::Interface::as_raw(self),
                dwmilliseconds,
                option,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetCLRTask)(
                windows_core::Interface::as_raw(self),
                pclrtask.param().abi(),
            )
            .ok()
...
pub struct IHostTask_Vtbl {
    ...
    pub SetCLRTask: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IHostTask_Vtbl {
    pub const fn new<Identity: IHostTask_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Start<Identity: IHostTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Alert<Identity: IHostTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Join<Identity: IHostTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwmilliseconds: u32,
            option: u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn SetPriority<Identity: IHostTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            newpriority: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetPriority<Identity: IHostTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppriority: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetCLRTask<Identity: IHostTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pclrtask: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x997ff24c_43b7_4352_8667_0dc04fafd354
);
...
impl IHostTaskManager {
    ...
    pub unsafe fn CreateTask(
        &self,
        dwstacksize: u32,
        pstartaddress: super::Threading::LPTHREAD_START_ROUTINE,
        pparameter: *const core::ffi::c_void,
    ) -> windows_core::Result<IHostTask> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTask)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn Sleep(&self, dwmilliseconds: u32, option: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Sleep)(
                windows_core::Interface::as_raw(self),
                dwmilliseconds,
                option,
            )
    ...
    pub unsafe fn SwitchToTask(&self, option: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SwitchToTask)(
                windows_core::Interface::as_raw(self),
                option,
            )
            .ok()
    ...
    pub unsafe fn CallNeedsHostHook(
        &self,
        target: usize,
    ) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CallNeedsHostHook)(
                windows_core::Interface::as_raw(self),
                target,
                &mut result__,
            )
    ...
    pub unsafe fn LeaveRuntime(&self, target: usize) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).LeaveRuntime)(
                windows_core::Interface::as_raw(self),
                target,
            )
            .ok()
    ...
    pub unsafe fn EnterRuntime(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EnterRuntime)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn ReverseLeaveRuntime(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ReverseLeaveRuntime)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn ReverseEnterRuntime(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ReverseEnterRuntime)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn BeginDelayAbort(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BeginDelayAbort)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn EndDelayAbort(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndDelayAbort)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn BeginThreadAffinity(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BeginThreadAffinity)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn EndThreadAffinity(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndThreadAffinity)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn SetStackGuarantee(&self, guarantee: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetStackGuarantee)(
                windows_core::Interface::as_raw(self),
                guarantee,
            )
            .ok()
    ...
    pub unsafe fn GetStackGuarantee(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStackGuarantee)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetCLRTaskManager)(
                windows_core::Interface::as_raw(self),
                ppmanager.param().abi(),
            )
            .ok()
...
pub struct IHostTaskManager_Vtbl {
    ...
    pub SetUILocale:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub SetLocale: unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub CallNeedsHostHook: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        usize,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    ...
    pub ReverseLeaveRuntime:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ReverseEnterRuntime:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    ...
    pub BeginThreadAffinity:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub EndThreadAffinity:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub SetStackGuarantee:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub GetStackGuarantee:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetCLRTaskManager: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub trait IHostTaskManager_Impl: windows_core::IUnknownImpl {
    ...
    fn SetCLRTaskManager(
        &self,
        ppmanager: windows_core::Ref<'_, ICLRTaskManager>,
    ) -> windows_core::Result<()>;
}
#[cfg(feature = "Win32_System_Threading")]
    ...
    pub const fn new<Identity: IHostTaskManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostTaskManager_Impl::CreateTask(
                    this,
                    core::mem::transmute_copy(&dwstacksize),
                    core::mem::transmute_copy(&pstartaddress),
                    core::mem::transmute_copy(&pparameter),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Sleep<Identity: IHostTaskManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwmilliseconds: u32,
            option: u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn SwitchToTask<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CallNeedsHostHook<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            target: usize,
            pbcallneedshosthook: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHostTaskManager_Impl::CallNeedsHostHook(
                    this,
        ...
        unsafe extern "system" fn LeaveRuntime<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnterRuntime<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ReverseLeaveRuntime<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ReverseEnterRuntime<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn BeginDelayAbort<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EndDelayAbort<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn BeginThreadAffinity<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EndThreadAffinity<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetStackGuarantee<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostTaskManager_Impl::SetStackGuarantee(
                    this,
                    core::mem::transmute_copy(&guarantee),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetStackGuarantee<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetCLRTaskManager<
            Identity: IHostTaskManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppmanager: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostTaskManager_Impl::SetCLRTaskManager(
                    this,
                    core::mem::transmute_copy(&ppmanager),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x983d50e2_cb15_466b_80fc_845dc6e8c5fd
);
...
impl IHostThreadpoolManager {
    ...
    pub unsafe fn QueueUserWorkItem(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).QueueUserWorkItem)(
                windows_core::Interface::as_raw(self),
                function,
                context,
                flags,
...
pub struct IHostThreadpoolManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_System_Threading")]
    pub QueueUserWorkItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::Threading::LPTHREAD_START_ROUTINE,
        *const core::ffi::c_void,
        u32,
...
impl IHostThreadpoolManager_Vtbl {
    pub const fn new<Identity: IHostThreadpoolManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn QueueUserWorkItem<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostThreadpoolManager_Impl::QueueUserWorkItem(
                    this,
                    core::mem::transmute_copy(&function),
                    core::mem::transmute_copy(&context),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostThreadpoolManager_Impl::SetMaxThreads(
                    this,
                    core::mem::transmute_copy(&dwmaxworkerthreads),
                )
                .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            pdwavailableworkerthreads: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHostThreadpoolManager_Impl::SetMinThreads(
                    this,
                    core::mem::transmute_copy(&dwminiocompletionthreads),
                )
                .into()
...
windows_core::imp::define_interface!(
    IManagedObject,
    IManagedObject_Vtbl,
    0xc3fcc19e_a970_11d2_8b5a_00a0c9b7c9c4
);
...
impl IManagedObject {
    pub unsafe fn GetSerializedBuffer(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSerializedBuffer)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
    ...
    pub unsafe fn GetObjectIdentity(
        &self,
        pbstrguid: *mut windows_core::BSTR,
        appdomainid: *mut i32,
        pccw: *mut i32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetObjectIdentity)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pbstrguid),
                appdomainid as _,
                pccw as _,
            )
            .ok()
...
pub struct IManagedObject_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetSerializedBuffer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetObjectIdentity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
        *mut i32,
        *mut i32,
...
impl IManagedObject_Vtbl {
    pub const fn new<Identity: IManagedObject_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetSerializedBuffer<
        ...
        unsafe extern "system" fn GetObjectIdentity<
            Identity: IManagedObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrguid: *mut *mut core::ffi::c_void,
            appdomainid: *mut i32,
            pccw: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IManagedObject_Impl::GetObjectIdentity(
                    this,
                    core::mem::transmute_copy(&pbstrguid),
                    core::mem::transmute_copy(&appdomainid),
                    core::mem::transmute_copy(&pccw),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IObjectHandle,
    IObjectHandle_Vtbl,
    0xc460e2b4_e199_412a_8456_84dc3e4838c3
);
...
impl IObjectHandle {
    ...
    pub unsafe fn Unwrap(&self) -> windows_core::Result<super::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Unwrap)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct IObjectHandle_Vtbl {
    ...
    pub Unwrap: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IObjectHandle_Vtbl {
    pub const fn new<Identity: IObjectHandle_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Unwrap<Identity: IObjectHandle_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppv: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ITypeName,
    ITypeName_Vtbl,
    0xb81ff171_20f3_11d2_8dcc_00a0c9b00522
);
...
impl ITypeName {
    pub unsafe fn GetNameCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNameCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetNames(
        &self,
        count: u32,
        rgbsznames: *mut windows_core::BSTR,
    ) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetTypeArgumentCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTypeArgumentCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetTypeArguments(
        &self,
        count: u32,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTypeArguments)(
                windows_core::Interface::as_raw(self),
                count,
                core::mem::transmute(rgparguments),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub unsafe fn GetModifierLength(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetModifierLength)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetModifiers(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetModifiers)(
                windows_core::Interface::as_raw(self),
                count,
                rgmodifiers as _,
                &mut result__,
    ...
    pub unsafe fn GetAssemblyName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAssemblyName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct ITypeName_Vtbl {
    ...
    pub GetTypeArgumentCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetTypeArguments: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetModifierLength:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetModifiers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetAssemblyName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait ITypeName_Impl: windows_core::IUnknownImpl {
    ...
    fn GetTypeArguments(
        &self,
        count: u32,
        rgparguments: windows_core::OutRef<'_, ITypeName>,
    ) -> windows_core::Result<u32>;
...
impl ITypeName_Vtbl {
    pub const fn new<Identity: ITypeName_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetNameCount<Identity: ITypeName_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pcount: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetNames<Identity: ITypeName_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            count: u32,
            rgbsznames: *mut *mut core::ffi::c_void,
            pcount: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITypeName_Impl::GetNames(
                    this,
                    core::mem::transmute_copy(&count),
                    core::mem::transmute_copy(&rgbsznames),
                ) {
                    Ok(ok__) => {
                        pcount.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn GetTypeArgumentCount<
        ...
        unsafe extern "system" fn GetTypeArguments<
            Identity: ITypeName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            count: u32,
            rgparguments: *mut *mut core::ffi::c_void,
            pcount: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITypeName_Impl::GetTypeArguments(
                    this,
                    core::mem::transmute_copy(&count),
                    core::mem::transmute_copy(&rgparguments),
                ) {
                    Ok(ok__) => {
                        pcount.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn GetModifierLength<
            Identity: ITypeName_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetModifiers<Identity: ITypeName_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            count: u32,
            rgmodifiers: *mut u32,
            pcount: *mut u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITypeName_Impl::GetModifiers(
                    this,
                    core::mem::transmute_copy(&count),
                    core::mem::transmute_copy(&rgmodifiers),
                ) {
                    Ok(ok__) => {
                        pcount.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn GetAssemblyName<Identity: ITypeName_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            rgbszassemblynames: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0xb81ff171_20f3_11d2_8dcc_00a0c9b00523
);
...
impl ITypeNameBuilder {
    pub unsafe fn OpenGenericArguments(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OpenGenericArguments)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn CloseGenericArguments(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CloseGenericArguments)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn OpenGenericArgument(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OpenGenericArgument)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn CloseGenericArgument(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CloseGenericArgument)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddName)(
                windows_core::Interface::as_raw(self),
                szname.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn AddPointer(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddPointer)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn AddByRef(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddByRef)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn AddSzArray(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddSzArray)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn AddArray(&self, rank: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddArray)(
                windows_core::Interface::as_raw(self),
                rank,
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddAssemblySpec)(
                windows_core::Interface::as_raw(self),
                szassemblyspec.param().abi(),
            )
            .ok()
        }
    }
...
pub struct ITypeNameBuilder_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OpenGenericArguments:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub CloseGenericArguments:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub OpenGenericArgument:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub CloseGenericArgument:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub AddName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    ...
    pub AddAssemblySpec: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
...
impl ITypeNameBuilder_Vtbl {
    pub const fn new<Identity: ITypeNameBuilder_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OpenGenericArguments<
        ...
        unsafe extern "system" fn CloseGenericArguments<
            Identity: ITypeNameBuilder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn OpenGenericArgument<
            Identity: ITypeNameBuilder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CloseGenericArgument<
            Identity: ITypeNameBuilder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AddName<Identity: ITypeNameBuilder_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AddPointer<
            Identity: ITypeNameBuilder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AddByRef<Identity: ITypeNameBuilder_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn AddSzArray<
            Identity: ITypeNameBuilder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AddArray<Identity: ITypeNameBuilder_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            rank: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn AddAssemblySpec<
            Identity: ITypeNameBuilder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            szassemblyspec: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITypeNameBuilder_Impl::AddAssemblySpec(this, core::mem::transmute(&szassemblyspec))
                    .into()
            }
        }
        unsafe extern "system" fn ToString<Identity: ITypeNameBuilder_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszstringrepresentation: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Clear<Identity: ITypeNameBuilder_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    ...
    0xb81ff171_20f3_11d2_8dcc_00a0c9b00521
);
windows_core::imp::interface_hierarchy!(ITypeNameFactory, windows_core::IUnknown);
impl ITypeNameFactory {
    pub unsafe fn ParseTypeName<P0>(
        &self,
        szname: P0,
        perror: *mut u32,
    ) -> windows_core::Result<ITypeName>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ParseTypeName)(
                windows_core::Interface::as_raw(self),
                szname.param().abi(),
                perror as _,
                &mut result__,
    ...
    pub unsafe fn GetTypeNameBuilder(&self) -> windows_core::Result<ITypeNameBuilder> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTypeNameBuilder)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ITypeNameFactory_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ParseTypeName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetTypeNameBuilder: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ITypeNameFactory_Vtbl {
    pub const fn new<Identity: ITypeNameFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ParseTypeName<
        ...
        >(
            ...
            szname: windows_core::PCWSTR,
            perror: *mut u32,
            pptypename: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITypeNameFactory_Impl::ParseTypeName(
                    this,
        ...
        unsafe extern "system" fn GetTypeNameBuilder<
            Identity: ITypeNameFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pptypebuilder: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub const LIBID_mscoree: windows_core::GUID =
    windows_core::GUID::from_u128(0x5477469e_83b1_11d2_8b49_00a0c9b7c9c4);
...
pub const METAHOST_CONFIG_FLAGS_LEGACY_V2_ACTIVATION_POLICY_FALSE: METAHOST_CONFIG_FLAGS =
    METAHOST_CONFIG_FLAGS(2i32);
pub const METAHOST_CONFIG_FLAGS_LEGACY_V2_ACTIVATION_POLICY_MASK: METAHOST_CONFIG_FLAGS =
    METAHOST_CONFIG_FLAGS(3i32);
pub const METAHOST_CONFIG_FLAGS_LEGACY_V2_ACTIVATION_POLICY_TRUE: METAHOST_CONFIG_FLAGS =
    METAHOST_CONFIG_FLAGS(1i32);
pub const METAHOST_CONFIG_FLAGS_LEGACY_V2_ACTIVATION_POLICY_UNSET: METAHOST_CONFIG_FLAGS =
    METAHOST_CONFIG_FLAGS(0i32);
...
pub const METAHOST_POLICY_ENSURE_SKU_SUPPORTED: METAHOST_POLICY_FLAGS =
    METAHOST_POLICY_FLAGS(128i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const METAHOST_POLICY_USE_PROCESS_IMAGE_PATH: METAHOST_POLICY_FLAGS =
    METAHOST_POLICY_FLAGS(64i32);
...
pub type PTLS_CALLBACK_FUNCTION = Option<
    unsafe extern "system" fn(__midl____midl_itf_mscoree_0000_00040005: *mut core::ffi::c_void),
>;
...
pub type RuntimeLoadedCallbackFnPtr = Option<
    unsafe extern "system" fn(
        pruntimeinfo: windows_core::Ref<'_, ICLRRuntimeInfo>,
...
pub const TypeNameFactory: windows_core::GUID =
    windows_core::GUID::from_u128(0xb81ff171_20f3_11d2_8dcc_00a0c9b00525);
...
pub const eInitializeNewDomainFlags_NoSecurityChanges: EInitializeNewDomainFlags =
    EInitializeNewDomainFlags(2i32);
pub const eInitializeNewDomainFlags_None: EInitializeNewDomainFlags =
    EInitializeNewDomainFlags(0i32);

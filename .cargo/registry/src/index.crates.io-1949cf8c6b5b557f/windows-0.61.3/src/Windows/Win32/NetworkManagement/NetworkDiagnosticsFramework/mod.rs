...
pub unsafe fn NdfCancelIncident(handle: *const core::ffi::c_void) -> windows_core::Result<()> {
    windows_link::link!("ndfapi.dll" "system" fn NdfCancelIncident(handle : *const core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { NdfCancelIncident(handle).ok() }
}
#[inline]
pub unsafe fn NdfCloseIncident(handle: *mut core::ffi::c_void) -> windows_core::Result<()> {
    windows_link::link!("ndfapi.dll" "system" fn NdfCloseIncident(handle : *mut core::ffi::c_void) -> windows_core::HRESULT);
...
pub unsafe fn NdfCreateConnectivityIncident(
    ...
    windows_link::link!("ndfapi.dll" "system" fn NdfCreateConnectivityIncident(handle : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
...
{
    windows_link::link!("ndfapi.dll" "system" fn NdfCreateDNSIncident(hostname : windows_core::PCWSTR, querytype : u16, handle : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
...
pub unsafe fn NdfCreateGroupingIncident<P0, P1, P2, P3, P5>(
    ...
    identity: P2,
    invitation: P3,
    addresses: Option<*const super::super::Networking::WinSock::SOCKET_ADDRESS_LIST>,
    appid: P5,
    handle: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
where
...
{
    windows_link::link!("ndfapi.dll" "system" fn NdfCreateGroupingIncident(cloudname : windows_core::PCWSTR, groupname : windows_core::PCWSTR, identity : windows_core::PCWSTR, invitation : windows_core::PCWSTR, addresses : *const super::super::Networking::WinSock:: SOCKET_ADDRESS_LIST, appid : windows_core::PCWSTR, handle : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        NdfCreateGroupingIncident(
            cloudname.param().abi(),
            groupname.param().abi(),
            identity.param().abi(),
            invitation.param().abi(),
            addresses.unwrap_or(core::mem::zeroed()) as _,
            appid.param().abi(),
            handle as _,
        )
        .ok()
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("ndfapi.dll" "system" fn NdfCreateIncident(helperclassname : windows_core::PCWSTR, celt : u32, attributes : *const HELPER_ATTRIBUTE, handle : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        NdfCreateIncident(
            helperclassname.param().abi(),
            attributes.len().try_into().unwrap(),
            core::mem::transmute(attributes.as_ptr()),
            handle as _,
        )
        .ok()
    }
...
pub unsafe fn NdfCreateNetConnectionIncident(
    ...
    windows_link::link!("ndfapi.dll" "system" fn NdfCreateNetConnectionIncident(handle : *mut *mut core::ffi::c_void, id : windows_core::GUID) -> windows_core::HRESULT);
...
where
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("ndfapi.dll" "system" fn NdfCreatePnrpIncident(cloudname : windows_core::PCWSTR, peername : windows_core::PCWSTR, diagnosepublish : windows_core::BOOL, appid : windows_core::PCWSTR, handle : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        NdfCreatePnrpIncident(
            cloudname.param().abi(),
            peername.param().abi(),
            diagnosepublish.into(),
            appid.param().abi(),
            handle as _,
        )
        .ok()
...
#[inline]
pub unsafe fn NdfCreateSharingIncident<P0>(
    uncpath: P0,
    handle: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("ndfapi.dll" "system" fn NdfCreateSharingIncident(uncpath : windows_core::PCWSTR, handle : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("ndfapi.dll" "system" fn NdfCreateWebIncident(url : windows_core::PCWSTR, handle : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { NdfCreateWebIncident(url.param().abi(), handle as _).ok() }
}
#[inline]
pub unsafe fn NdfCreateWebIncidentEx<P0, P2>(
    url: P0,
    usewinhttp: bool,
    modulename: P2,
    handle: *mut *mut core::ffi::c_void,
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("ndfapi.dll" "system" fn NdfCreateWebIncidentEx(url : windows_core::PCWSTR, usewinhttp : windows_core::BOOL, modulename : windows_core::PCWSTR, handle : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
...
pub unsafe fn NdfCreateWinSockIncident<P1, P3>(
    ...
    port: u16,
    appid: P3,
    userid: Option<*const super::super::Security::SID>,
    handle: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("ndfapi.dll" "system" fn NdfCreateWinSockIncident(sock : super::super::Networking::WinSock:: SOCKET, host : windows_core::PCWSTR, port : u16, appid : windows_core::PCWSTR, userid : *const super::super::Security:: SID, handle : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        NdfCreateWinSockIncident(
            ...
            port,
            appid.param().abi(),
            userid.unwrap_or(core::mem::zeroed()) as _,
            handle as _,
        )
        .ok()
    }
...
pub unsafe fn NdfDiagnoseIncident(
    ...
    windows_link::link!("ndfapi.dll" "system" fn NdfDiagnoseIncident(handle : *const core::ffi::c_void, rootcausecount : *mut u32, rootcauses : *mut *mut RootCauseInfo, dwwait : u32, dwflags : u32) -> windows_core::HRESULT);
    unsafe {
        NdfDiagnoseIncident(
            handle,
            rootcausecount as _,
...
pub unsafe fn NdfExecuteDiagnosis(
    ...
    windows_link::link!("ndfapi.dll" "system" fn NdfExecuteDiagnosis(handle : *const core::ffi::c_void, hwnd : super::super::Foundation:: HWND) -> windows_core::HRESULT);
...
pub unsafe fn NdfRepairIncident(
    ...
    windows_link::link!("ndfapi.dll" "system" fn NdfRepairIncident(handle : *const core::ffi::c_void, repairex : *const RepairInfoEx, dwwait : u32) -> windows_core::HRESULT);
...
impl INetDiagExtensibleHelper {
    pub unsafe fn ResolveAttributes(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ResolveAttributes)(
                windows_core::Interface::as_raw(self),
                rgkeyattributes.len().try_into().unwrap(),
                core::mem::transmute(rgkeyattributes.as_ptr()),
                pcelt as _,
                prgmatchvalues as _,
            )
            .ok()
...
pub struct INetDiagExtensibleHelper_Vtbl {
    ...
    pub ResolveAttributes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const HELPER_ATTRIBUTE,
        *mut u32,
        *mut *mut HELPER_ATTRIBUTE,
...
impl INetDiagExtensibleHelper_Vtbl {
    pub const fn new<Identity: INetDiagExtensibleHelper_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ResolveAttributes<
        ...
        >(
            ...
            unsafe {
                ...
                INetDiagExtensibleHelper_Impl::ResolveAttributes(
                    this,
                    core::mem::transmute_copy(&celt),
                    core::mem::transmute_copy(&rgkeyattributes),
                    core::mem::transmute_copy(&pcelt),
                    core::mem::transmute_copy(&prgmatchvalues),
                )
                .into()
            }
        }
        Self {
            ...
            ResolveAttributes: ResolveAttributes::<Identity, OFFSET>,
        }
    }
...
impl INetDiagHelper {
    pub unsafe fn Initialize(&self, rgattributes: &[HELPER_ATTRIBUTE]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Initialize)(
                windows_core::Interface::as_raw(self),
                rgattributes.len().try_into().unwrap(),
                core::mem::transmute(rgattributes.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn GetDiagnosticsInfo(&self) -> windows_core::Result<*mut DiagnosticsInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDiagnosticsInfo)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetKeyAttributes(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetKeyAttributes)(
                windows_core::Interface::as_raw(self),
                pcelt as _,
                pprgattributes as _,
            )
    ...
    pub unsafe fn LowHealth<P0>(
        &self,
        pwszinstancedescription: P0,
        ppwszdescription: *mut windows_core::PWSTR,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).LowHealth)(
                windows_core::Interface::as_raw(self),
                pwszinstancedescription.param().abi(),
                ppwszdescription as _,
                pdeferredtime as _,
                pstatus as _,
            )
            .ok()
    ...
    pub unsafe fn HighUtilization<P0>(
        &self,
        pwszinstancedescription: P0,
        ppwszdescription: *mut windows_core::PWSTR,
        pdeferredtime: *mut i32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).HighUtilization)(
                windows_core::Interface::as_raw(self),
                pwszinstancedescription.param().abi(),
                ppwszdescription as _,
                pdeferredtime as _,
    ...
    pub unsafe fn GetLowerHypotheses(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetLowerHypotheses)(
                windows_core::Interface::as_raw(self),
                pcelt as _,
                pprghypotheses as _,
            )
    ...
    pub unsafe fn GetDownStreamHypotheses(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetDownStreamHypotheses)(
                windows_core::Interface::as_raw(self),
                pcelt as _,
                pprghypotheses as _,
            )
    ...
    pub unsafe fn GetHigherHypotheses(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetHigherHypotheses)(
                windows_core::Interface::as_raw(self),
                pcelt as _,
                pprghypotheses as _,
            )
    ...
    pub unsafe fn GetUpStreamHypotheses(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetUpStreamHypotheses)(
                windows_core::Interface::as_raw(self),
                pcelt as _,
                pprghypotheses as _,
            )
    ...
    pub unsafe fn GetRepairInfo(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetRepairInfo)(
                windows_core::Interface::as_raw(self),
                problem,
                pcelt as _,
                ppinfo as _,
    ...
    pub unsafe fn GetLifeTime(&self) -> windows_core::Result<LIFE_TIME> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLifeTime)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetLifeTime(&self, lifetime: LIFE_TIME) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLifeTime)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(lifetime),
            )
            .ok()
        }
    }
    pub unsafe fn GetCacheTime(&self) -> windows_core::Result<super::super::Foundation::FILETIME> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCacheTime)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct INetDiagHelper_Vtbl {
    ...
    pub GetDiagnosticsInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut DiagnosticsInfo,
    ) -> windows_core::HRESULT,
    pub GetKeyAttributes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut *mut HELPER_ATTRIBUTE,
    ) -> windows_core::HRESULT,
    pub LowHealth: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ...
    pub HighUtilization: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut windows_core::PWSTR,
        *mut i32,
    ...
    pub GetLowerHypotheses: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut *mut HYPOTHESIS,
    ) -> windows_core::HRESULT,
    pub GetDownStreamHypotheses: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut *mut HYPOTHESIS,
    ) -> windows_core::HRESULT,
    pub GetHigherHypotheses: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut *mut HYPOTHESIS,
    ) -> windows_core::HRESULT,
    pub GetUpStreamHypotheses: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut *mut HYPOTHESIS,
    ) -> windows_core::HRESULT,
    ...
    pub GetRepairInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        PROBLEM_TYPE,
        *mut u32,
        *mut *mut RepairInfo,
    ...
    pub GetLifeTime:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut LIFE_TIME) -> windows_core::HRESULT,
    pub SetLifeTime:
        unsafe extern "system" fn(*mut core::ffi::c_void, LIFE_TIME) -> windows_core::HRESULT,
    pub GetCacheTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait INetDiagHelper_Impl: windows_core::IUnknownImpl {
    ...
    fn LowHealth(
        &self,
        pwszinstancedescription: &windows_core::PCWSTR,
        ppwszdescription: *mut windows_core::PWSTR,
        pdeferredtime: *mut i32,
        pstatus: *mut DIAGNOSIS_STATUS,
    ) -> windows_core::Result<()>;
...
impl INetDiagHelper_Vtbl {
    pub const fn new<Identity: INetDiagHelper_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Initialize<Identity: INetDiagHelper_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            rgattributes: *const HELPER_ATTRIBUTE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelper_Impl::Initialize(
                    this,
                    core::mem::transmute_copy(&celt),
                    core::mem::transmute_copy(&rgattributes),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetDiagnosticsInfo<
        ...
        unsafe extern "system" fn GetKeyAttributes<
            Identity: INetDiagHelper_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelper_Impl::GetKeyAttributes(
                    this,
                    core::mem::transmute_copy(&pcelt),
                    core::mem::transmute_copy(&pprgattributes),
                )
                .into()
            }
        }
        unsafe extern "system" fn LowHealth<Identity: INetDiagHelper_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwszinstancedescription: windows_core::PCWSTR,
            ppwszdescription: *mut windows_core::PWSTR,
            pdeferredtime: *mut i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelper_Impl::LowHealth(
                    this,
                    core::mem::transmute(&pwszinstancedescription),
                    core::mem::transmute_copy(&ppwszdescription),
                    core::mem::transmute_copy(&pdeferredtime),
                    core::mem::transmute_copy(&pstatus),
                )
                .into()
            }
        }
        unsafe extern "system" fn HighUtilization<
            Identity: INetDiagHelper_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelper_Impl::HighUtilization(
                    this,
                    core::mem::transmute(&pwszinstancedescription),
                    core::mem::transmute_copy(&ppwszdescription),
                    core::mem::transmute_copy(&pdeferredtime),
        ...
        unsafe extern "system" fn GetLowerHypotheses<
            Identity: INetDiagHelper_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelper_Impl::GetLowerHypotheses(
                    this,
                    core::mem::transmute_copy(&pcelt),
                    core::mem::transmute_copy(&pprghypotheses),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelper_Impl::GetDownStreamHypotheses(
                    this,
                    core::mem::transmute_copy(&pcelt),
                    core::mem::transmute_copy(&pprghypotheses),
                )
        ...
        unsafe extern "system" fn GetHigherHypotheses<
            Identity: INetDiagHelper_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelper_Impl::GetHigherHypotheses(
                    this,
                    core::mem::transmute_copy(&pcelt),
                    core::mem::transmute_copy(&pprghypotheses),
                )
        ...
        unsafe extern "system" fn GetUpStreamHypotheses<
            Identity: INetDiagHelper_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelper_Impl::GetUpStreamHypotheses(
                    this,
                    core::mem::transmute_copy(&pcelt),
                    core::mem::transmute_copy(&pprghypotheses),
                )
        ...
        unsafe extern "system" fn Repair<Identity: INetDiagHelper_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pinfo: *const RepairInfo,
            pdeferredtime: *mut i32,
            pstatus: *mut REPAIR_STATUS,
        ...
        unsafe extern "system" fn Validate<Identity: INetDiagHelper_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            problem: PROBLEM_TYPE,
            pdeferredtime: *mut i32,
            pstatus: *mut REPAIR_STATUS,
        ...
        unsafe extern "system" fn GetRepairInfo<
            Identity: INetDiagHelper_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelper_Impl::GetRepairInfo(
                    this,
                    core::mem::transmute_copy(&problem),
                    core::mem::transmute_copy(&pcelt),
                    core::mem::transmute_copy(&ppinfo),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetLifeTime<
            Identity: INetDiagHelper_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetLifeTime<
            Identity: INetDiagHelper_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetCacheTime<
            Identity: INetDiagHelper_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelper_Impl::GetAttributes(
                    this,
                    core::mem::transmute_copy(&pcelt),
                    core::mem::transmute_copy(&pprgattributes),
                )
        ...
        unsafe extern "system" fn Cancel<Identity: INetDiagHelper_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Cleanup<Identity: INetDiagHelper_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    ...
    0x972dab4d_e4e3_4fc6_ae54_5f65ccde4a15
);
...
impl INetDiagHelperEx {
    pub unsafe fn ReconfirmLowHealth(
        ...
        ppwszupdateddescription: *mut windows_core::PWSTR,
        pupdatedstatus: *mut DIAGNOSIS_STATUS,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ReconfirmLowHealth)(
                windows_core::Interface::as_raw(self),
                presults.len().try_into().unwrap(),
                core::mem::transmute(presults.as_ptr()),
                ppwszupdateddescription as _,
                pupdatedstatus as _,
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetUtilities)(
                windows_core::Interface::as_raw(self),
                putilities.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn ReproduceFailure(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ReproduceFailure)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct INetDiagHelperEx_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ReconfirmLowHealth: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
    ...
    pub SetUtilities: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ReproduceFailure:
...
pub trait INetDiagHelperEx_Impl: windows_core::IUnknownImpl {
    ...
    fn SetUtilities(
        &self,
        putilities: windows_core::Ref<'_, INetDiagHelperUtilFactory>,
    ) -> windows_core::Result<()>;
...
impl INetDiagHelperEx_Vtbl {
    pub const fn new<Identity: INetDiagHelperEx_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ReconfirmLowHealth<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelperEx_Impl::ReconfirmLowHealth(
                    this,
                    core::mem::transmute_copy(&celt),
                    core::mem::transmute_copy(&presults),
                    core::mem::transmute_copy(&ppwszupdateddescription),
                    core::mem::transmute_copy(&pupdatedstatus),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetUtilities<
            Identity: INetDiagHelperEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            putilities: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelperEx_Impl::SetUtilities(this, core::mem::transmute_copy(&putilities))
                    .into()
            }
        }
        unsafe extern "system" fn ReproduceFailure<
            Identity: INetDiagHelperEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xc0b35747_ebf5_11d8_bbe9_505054503030
);
    ...
    pub const fn new<Identity: INetDiagHelperInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelperInfo_Impl::GetAttributeInfo(
                    this,
                    core::mem::transmute_copy(&pcelt),
                    core::mem::transmute_copy(&pprgattributeinfos),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x104613fb_bc57_4178_95ba_88809698354a
);
...
impl INetDiagHelperUtilFactory {
        ...
        T: windows_core::Interface,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(self).CreateUtilityInstance)(
                windows_core::Interface::as_raw(self),
                &T::IID,
                &mut result__,
            )
...
pub struct INetDiagHelperUtilFactory_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateUtilityInstance: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl INetDiagHelperUtilFactory_Vtbl {
    pub const fn new<Identity: INetDiagHelperUtilFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateUtilityInstance<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetDiagHelperUtilFactory_Impl::CreateUtilityInstance(
                    this,
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            CreateUtilityInstance: CreateUtilityInstance::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {

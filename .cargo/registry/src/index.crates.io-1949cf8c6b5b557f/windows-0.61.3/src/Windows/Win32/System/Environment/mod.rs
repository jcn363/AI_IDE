...
pub unsafe fn CreateEnclave(
    ...
    flenclavetype: u32,
    lpenclaveinformation: *const core::ffi::c_void,
    dwinfolength: u32,
    ...
    unsafe {
        CreateEnclave(
            ...
            dwinfolength,
            lpenclaveerror.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn CreateEnvironmentBlock(
    lpenvironment: *mut *mut core::ffi::c_void,
...
pub unsafe fn EnclaveGetAttestationReport(
    enclavedata: Option<&[u8; 64]>,
    report: Option<*mut core::ffi::c_void>,
    buffersize: u32,
    outputsize: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        EnclaveGetAttestationReport(
            ...
            report.unwrap_or(core::mem::zeroed()) as _,
            buffersize,
            outputsize as _,
        )
        .ok()
...
pub unsafe fn EnclaveSealData(
    datatoencrypt: *const core::ffi::c_void,
    datatoencryptsize: u32,
    identitypolicy: ENCLAVE_SEALING_IDENTITY_POLICY,
    runtimepolicy: u32,
    protectedblob: Option<*mut core::ffi::c_void>,
    buffersize: u32,
    ...
    unsafe {
        EnclaveSealData(
            ...
            identitypolicy,
            runtimepolicy,
            protectedblob.unwrap_or(core::mem::zeroed()) as _,
            buffersize,
            protectedblobsize as _,
        )
        .ok()
    }
}
...
pub unsafe fn EnclaveUnsealData(
    protectedblob: *const core::ffi::c_void,
    protectedblobsize: u32,
    decrypteddata: Option<*mut core::ffi::c_void>,
    buffersize: u32,
    decrypteddatasize: *mut u32,
    sealingidentity: Option<*mut ENCLAVE_IDENTITY>,
    unsealingflags: Option<*mut u32>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        EnclaveUnsealData(
            protectedblob,
            protectedblobsize,
            decrypteddata.unwrap_or(core::mem::zeroed()) as _,
            buffersize,
            decrypteddatasize as _,
            sealingidentity.unwrap_or(core::mem::zeroed()) as _,
            unsealingflags.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn ExpandEnvironmentStringsForUserA<P1>(
    htoken: Option<super::super::Foundation::HANDLE>,
    lpsrc: P1,
    lpdest: &mut [u8],
) -> windows_core::Result<()>
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        ExpandEnvironmentStringsForUserA(
            htoken.unwrap_or(core::mem::zeroed()) as _,
            lpsrc.param().abi(),
            core::mem::transmute(lpdest.as_ptr()),
            lpdest.len().try_into().unwrap(),
        )
        .ok()
    }
}
#[inline]
pub unsafe fn ExpandEnvironmentStringsForUserW<P1>(
    htoken: Option<super::super::Foundation::HANDLE>,
    lpsrc: P1,
    lpdest: &mut [u16],
) -> windows_core::Result<()>
...
pub unsafe fn LoadEnclaveData(
    ...
    nsize: usize,
    flprotect: u32,
    lppageinformation: *const core::ffi::c_void,
    dwinfolength: u32,
...
#[inline]
pub unsafe fn LoadEnclaveImageA<P1>(
    lpenclaveaddress: *const core::ffi::c_void,
    lpimagename: P1,
) -> windows_core::BOOL
where
    P1: windows_core::Param<windows_core::PCSTR>,
...
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_COMMIT_PAGES = Option<
...
>;
#[cfg(target_arch = "x86")]
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_CREATE_THREAD = Option<
    unsafe extern "system" fn(
        threaddescriptor: *const VBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR32,
    ) -> i32,
>;
#[cfg(any(
    target_arch = "aarch64",
...
>;
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_DECOMMIT_PAGES = Option<
    unsafe extern "system" fn(
        enclaveaddress: *const core::ffi::c_void,
        numberofbytes: usize,
    ) -> i32,
>;
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_GENERATE_KEY = Option<
    unsafe extern "system" fn(
...
>;
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_GENERATE_RANDOM_DATA = Option<
    unsafe extern "system" fn(buffer: *mut u8, numberofbytes: u32, generation: *mut u64) -> i32,
>;
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_GENERATE_REPORT = Option<
    unsafe extern "system" fn(
...
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_GET_ENCLAVE_INFORMATION =
    Option<unsafe extern "system" fn(enclaveinfo: *mut ENCLAVE_INFORMATION) -> i32>;
#[cfg(target_arch = "x86")]
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_INTERRUPT_THREAD = Option<
    unsafe extern "system" fn(
        threaddescriptor: *const VBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR32,
    ) -> i32,
>;
...
>;
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_PROTECT_PAGES = Option<
    unsafe extern "system" fn(
        enclaveaddress: *const core::ffi::c_void,
        numberofytes: usize,
        pageprotection: u32,
...
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_RETURN_FROM_ENCLAVE =
    Option<unsafe extern "system" fn(returnvalue: usize)>;
#[cfg(any(target_arch = "arm64ec", target_arch = "x86_64"))]
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_RETURN_FROM_EXCEPTION = Option<
...
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_RETURN_FROM_EXCEPTION =
    Option<unsafe extern "system" fn(exceptionrecord: *const core::ffi::c_void) -> i32>;
#[cfg(target_arch = "x86")]
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_TERMINATE_THREAD = Option<
    unsafe extern "system" fn(
        threaddescriptor: *const VBS_BASIC_ENCLAVE_THREAD_DESCRIPTOR32,
    ) -> i32,
>;
...
pub type VBS_BASIC_ENCLAVE_BASIC_CALL_VERIFY_REPORT =
    Option<unsafe extern "system" fn(report: *const core::ffi::c_void, reportsize: u32) -> i32>;
#[repr(C)]

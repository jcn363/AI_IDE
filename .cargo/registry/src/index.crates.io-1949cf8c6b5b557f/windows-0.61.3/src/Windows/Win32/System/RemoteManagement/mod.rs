...
pub unsafe fn WSManCloseCommand(
    commandhandle: Option<WSMAN_COMMAND_HANDLE>,
    flags: u32,
    ...
    unsafe {
        WSManCloseCommand(
            commandhandle.unwrap_or(core::mem::zeroed()) as _,
            flags,
            r#async,
        )
    }
...
#[inline]
pub unsafe fn WSManCloseOperation(
    operationhandle: Option<WSMAN_OPERATION_HANDLE>,
    flags: u32,
) -> u32 {
...
pub unsafe fn WSManCloseShell(
    shellhandle: Option<WSMAN_SHELL_HANDLE>,
    flags: u32,
    r#async: *const WSMAN_SHELL_ASYNC,
) {
    ...
    unsafe {
        WSManCloseShell(
            shellhandle.unwrap_or(core::mem::zeroed()) as _,
            flags,
            r#async,
        )
    }
...
#[inline]
pub unsafe fn WSManConnectShell<P2, P3>(
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ...
        WSManConnectShell(
            ...
            connectxml.unwrap_or(core::mem::zeroed()) as _,
            r#async,
            &mut result__,
        );
        result__
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WSManCreateSession(
            ...
            flags,
            serverauthenticationcredentials.unwrap_or(core::mem::zeroed()) as _,
            proxyinfo.unwrap_or(core::mem::zeroed()) as _,
            session as _,
        )
    }
}
#[inline]
pub unsafe fn WSManCreateShell<P2>(
    session: WSMAN_SESSION_HANDLE,
    flags: u32,
    resourceuri: P2,
    startupinfo: Option<*const WSMAN_SHELL_STARTUP_INFO_V11>,
    options: Option<*const WSMAN_OPTION_SET>,
    createxml: Option<*const WSMAN_DATA>,
    r#async: *const WSMAN_SHELL_ASYNC,
) -> WSMAN_SHELL_HANDLE
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ...
        WSManCreateShell(
            ...
            flags,
            resourceuri.param().abi(),
            startupinfo.unwrap_or(core::mem::zeroed()) as _,
            options.unwrap_or(core::mem::zeroed()) as _,
            createxml.unwrap_or(core::mem::zeroed()) as _,
            r#async,
            &mut result__,
        );
        result__
...
#[inline]
pub unsafe fn WSManCreateShellEx<P2, P3>(
    session: WSMAN_SESSION_HANDLE,
    flags: u32,
    resourceuri: P2,
    shellid: P3,
...
#[inline]
pub unsafe fn WSManGetErrorMessage<P2>(
    apihandle: WSMAN_API_HANDLE,
    flags: Option<u32>,
    languagecode: P2,
    errorcode: u32,
    message: Option<&mut [u16]>,
...
pub unsafe fn WSManPluginAuthzOperationComplete<P4>(
    ...
    flags: u32,
    userauthorizationcontext: Option<*const core::ffi::c_void>,
    errorcode: u32,
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WSManPluginAuthzOperationComplete(
            senderdetails,
            flags,
            userauthorizationcontext.unwrap_or(core::mem::zeroed()) as _,
            errorcode,
            extendederrorinformation.param().abi(),
        )
    }
}
#[inline]
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WSManPluginAuthzQueryQuotaComplete(
            senderdetails,
            flags,
            quota.unwrap_or(core::mem::zeroed()) as _,
            errorcode,
            extendederrorinformation.param().abi(),
        )
    }
...
pub unsafe fn WSManPluginAuthzUserComplete<P6>(
    ...
    flags: u32,
    userauthorizationcontext: Option<*const core::ffi::c_void>,
    impersonationtoken: Option<super::super::Foundation::HANDLE>,
    ...
    P6: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WSManPluginAuthzUserComplete(
            ...
            flags,
            userauthorizationcontext.unwrap_or(core::mem::zeroed()) as _,
            impersonationtoken.unwrap_or(core::mem::zeroed()) as _,
            userisadministrator.into(),
            errorcode,
            extendederrorinformation.param().abi(),
        )
    }
...
pub unsafe fn WSManPluginGetConfiguration(
    plugincontext: *const core::ffi::c_void,
    flags: u32,
    data: *mut WSMAN_DATA,
) -> u32 {
...
#[inline]
pub unsafe fn WSManPluginOperationComplete<P3>(
    requestdetails: *const WSMAN_PLUGIN_REQUEST,
    flags: u32,
    errorcode: u32,
    extendedinformation: P3,
) -> u32
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WSManPluginOperationComplete(
            ...
            flags,
            errorcode,
            extendedinformation.param().abi(),
        )
    }
}
#[inline]
pub unsafe fn WSManPluginReceiveResult<P2, P4>(
    requestdetails: *const WSMAN_PLUGIN_REQUEST,
    flags: u32,
    stream: P2,
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WSManPluginReceiveResult(
            ...
            flags,
            stream.param().abi(),
            streamresult.unwrap_or(core::mem::zeroed()) as _,
            commandstate.param().abi(),
            exitcode,
        )
    }
}
...
pub unsafe fn WSManReceiveShellOutput(
    ...
    unsafe {
        ...
        WSManReceiveShellOutput(
            shell,
            command.unwrap_or(core::mem::zeroed()) as _,
            flags,
            desiredstreamset.unwrap_or(core::mem::zeroed()) as _,
            r#async,
            &mut result__,
        );
        result__
...
#[inline]
pub unsafe fn WSManSendShellInput<P3>(
    shell: WSMAN_SHELL_HANDLE,
    command: Option<WSMAN_COMMAND_HANDLE>,
    flags: u32,
    streamid: P3,
...
#[inline]
pub unsafe fn WSManSignalShell<P3>(
    shell: WSMAN_SHELL_HANDLE,
    command: Option<WSMAN_COMMAND_HANDLE>,
    flags: u32,
    code: P3,
...
impl IWSMan {
    pub unsafe fn CreateSession<P2>(
        &self,
        connection: &windows_core::BSTR,
        flags: i32,
        connectionoptions: P2,
        ...
        P2: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).CreateSession)(
                ...
                core::mem::transmute_copy(connection),
                flags,
                connectionoptions.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn CreateConnectionOptions(&self) -> windows_core::Result<super::Com::IDispatch> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateConnectionOptions)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn CommandLine(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CommandLine)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
    ...
    pub unsafe fn Error(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Error)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct IWSMan_Vtbl {
    ...
    pub CreateConnectionOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CommandLine: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IWSMan_Impl: super::Com::IDispatch_Impl {
    fn CreateSession(
        ...
        connection: &windows_core::BSTR,
        flags: i32,
        connectionoptions: windows_core::Ref<'_, super::Com::IDispatch>,
    ) -> windows_core::Result<super::Com::IDispatch>;
...
impl IWSMan_Vtbl {
    pub const fn new<Identity: IWSMan_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateSession<Identity: IWSMan_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            connection: *mut core::ffi::c_void,
            flags: i32,
            connectionoptions: *mut core::ffi::c_void,
            session: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSMan_Impl::CreateSession(
                    this,
                    core::mem::transmute(&connection),
                    core::mem::transmute_copy(&flags),
                    core::mem::transmute_copy(&connectionoptions),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateConnectionOptions<
            Identity: IWSMan_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            connectionoptions: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CommandLine<Identity: IWSMan_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Error<Identity: IWSMan_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
    ...
    pub const fn new<Identity: IWSManConnectionOptions_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSManConnectionOptions_Impl::SetPassword(this, core::mem::transmute(&password))
                    .into()
            }
        }
        Self {
...
impl IWSManConnectionOptionsEx {
    pub unsafe fn CertificateThumbprint(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CertificateThumbprint)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetCertificateThumbprint(
        &self,
        thumbprint: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetCertificateThumbprint)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(thumbprint),
            )
            .ok()
        }
    }
...
pub struct IWSManConnectionOptionsEx_Vtbl {
    ...
    pub CertificateThumbprint: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetCertificateThumbprint: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub trait IWSManConnectionOptionsEx_Impl: IWSManConnectionOptions_Impl {
    ...
    fn SetCertificateThumbprint(&self, thumbprint: &windows_core::BSTR)
        -> windows_core::Result<()>;
}
#[cfg(all(
    feature = "Win32_System_Com",
...
impl IWSManConnectionOptionsEx_Vtbl {
    pub const fn new<Identity: IWSManConnectionOptionsEx_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CertificateThumbprint<
            Identity: IWSManConnectionOptionsEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            thumbprint: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetCertificateThumbprint<
            Identity: IWSManConnectionOptionsEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            thumbprint: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSManConnectionOptionsEx_Impl::SetCertificateThumbprint(
                    this,
                    core::mem::transmute(&thumbprint),
                )
                .into()
            }
        }
...
impl IWSManConnectionOptionsEx2 {
    ...
    pub unsafe fn ProxyIEConfig(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProxyIEConfig)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ProxyWinHttpConfig(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProxyWinHttpConfig)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ProxyAutoDetect(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProxyAutoDetect)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ProxyNoProxyServer(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProxyNoProxyServer)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ProxyAuthenticationUseNegotiate(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProxyAuthenticationUseNegotiate)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ProxyAuthenticationUseBasic(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProxyAuthenticationUseBasic)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ProxyAuthenticationUseDigest(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProxyAuthenticationUseDigest)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWSManConnectionOptionsEx2_Vtbl {
    ...
    pub ProxyWinHttpConfig:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub ProxyAutoDetect:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub ProxyNoProxyServer:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub ProxyAuthenticationUseNegotiate:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub ProxyAuthenticationUseBasic:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub ProxyAuthenticationUseDigest:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
}
#[cfg(all(
    feature = "Win32_System_Com",
...
impl IWSManConnectionOptionsEx2_Vtbl {
    pub const fn new<Identity: IWSManConnectionOptionsEx2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetProxy<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSManConnectionOptionsEx2_Impl::SetProxy(
                    this,
                    core::mem::transmute_copy(&accesstype),
                    core::mem::transmute_copy(&authenticationmechanism),
        ...
        unsafe extern "system" fn ProxyIEConfig<
            Identity: IWSManConnectionOptionsEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ProxyWinHttpConfig<
            Identity: IWSManConnectionOptionsEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ProxyAutoDetect<
            Identity: IWSManConnectionOptionsEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ProxyNoProxyServer<
            Identity: IWSManConnectionOptionsEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ProxyAuthenticationUseNegotiate<
            Identity: IWSManConnectionOptionsEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ProxyAuthenticationUseBasic<
            Identity: IWSManConnectionOptionsEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ProxyAuthenticationUseDigest<
            Identity: IWSManConnectionOptionsEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl IWSManEnumerator {
    pub unsafe fn ReadItem(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReadItem)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn AtEndOfStream(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AtEndOfStream)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWSManEnumerator_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub ReadItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AtEndOfStream: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IWSManEnumerator_Vtbl {
    pub const fn new<Identity: IWSManEnumerator_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ReadItem<Identity: IWSManEnumerator_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AtEndOfStream<
            Identity: IWSManEnumerator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            eos: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Error<Identity: IWSManEnumerator_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl IWSManEx {
    pub unsafe fn CreateResourceLocator(
        &self,
        strresourcelocator: &windows_core::BSTR,
    ) -> windows_core::Result<super::Com::IDispatch> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateResourceLocator)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strresourcelocator),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn SessionFlagUTF8(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagUTF8)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagCredUsernamePassword(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagCredUsernamePassword)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagSkipCACheck(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagSkipCACheck)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagSkipCNCheck(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagSkipCNCheck)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagUseDigest(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagUseDigest)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagUseNegotiate(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagUseNegotiate)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagUseBasic(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagUseBasic)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagUseKerberos(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagUseKerberos)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagNoEncryption(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagNoEncryption)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagEnableSPNServerPort(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagEnableSPNServerPort)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagUseNoAuthentication(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagUseNoAuthentication)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn EnumerationFlagNonXmlText(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerationFlagNonXmlText)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn EnumerationFlagReturnEPR(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerationFlagReturnEPR)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn EnumerationFlagReturnObjectAndEPR(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerationFlagReturnObjectAndEPR)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetErrorMessage(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetErrorMessage)(
                windows_core::Interface::as_raw(self),
                errornumber,
                &mut result__,
            )
    ...
    pub unsafe fn EnumerationFlagHierarchyDeep(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerationFlagHierarchyDeep)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn EnumerationFlagHierarchyShallow(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerationFlagHierarchyShallow)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn EnumerationFlagHierarchyDeepBasePropsOnly(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerationFlagHierarchyDeepBasePropsOnly)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn EnumerationFlagReturnObject(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerationFlagReturnObject)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWSManEx_Vtbl {
    ...
    pub CreateResourceLocator: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SessionFlagUTF8:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagCredUsernamePassword:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagSkipCACheck:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagSkipCNCheck:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagUseDigest:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagUseNegotiate:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagUseBasic:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagUseKerberos:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagNoEncryption:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagEnableSPNServerPort:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagUseNoAuthentication:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub EnumerationFlagNonXmlText:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub EnumerationFlagReturnEPR:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub EnumerationFlagReturnObjectAndEPR:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    ...
    pub EnumerationFlagHierarchyDeep:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub EnumerationFlagHierarchyShallow:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub EnumerationFlagHierarchyDeepBasePropsOnly:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub EnumerationFlagReturnObject:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
}
#[cfg(all(
    feature = "Win32_System_Com",
...
impl IWSManEx_Vtbl {
    pub const fn new<Identity: IWSManEx_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateResourceLocator<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strresourcelocator: *mut core::ffi::c_void,
            newresourcelocator: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSManEx_Impl::CreateResourceLocator(
                    this,
                    core::mem::transmute(&strresourcelocator),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SessionFlagUTF8<Identity: IWSManEx_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            flags: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SessionFlagCredUsernamePassword<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionFlagSkipCACheck<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionFlagSkipCNCheck<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionFlagUseDigest<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionFlagUseNegotiate<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionFlagUseBasic<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionFlagUseKerberos<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionFlagNoEncryption<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionFlagEnableSPNServerPort<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionFlagUseNoAuthentication<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnumerationFlagNonXmlText<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnumerationFlagReturnEPR<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnumerationFlagReturnObjectAndEPR<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetErrorMessage<Identity: IWSManEx_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            errornumber: u32,
            errormessage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn EnumerationFlagHierarchyDeep<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnumerationFlagHierarchyShallow<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnumerationFlagHierarchyDeepBasePropsOnly<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnumerationFlagReturnObject<
            Identity: IWSManEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        Self {
            ...
            EnumerationFlagHierarchyDeepBasePropsOnly: EnumerationFlagHierarchyDeepBasePropsOnly::<
                Identity,
                OFFSET,
            >,
...
impl IWSManEx2 {
    pub unsafe fn SessionFlagUseClientCertificate(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagUseClientCertificate)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWSManEx2_Vtbl {
    ...
    pub SessionFlagUseClientCertificate:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
}
#[cfg(all(
    feature = "Win32_System_Com",
...
impl IWSManEx2_Vtbl {
    pub const fn new<Identity: IWSManEx2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SessionFlagUseClientCertificate<
        ...
        Self {
            base__: IWSManEx_Vtbl::new::<Identity, OFFSET>(),
            SessionFlagUseClientCertificate: SessionFlagUseClientCertificate::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IWSManEx3 {
    pub unsafe fn SessionFlagUTF16(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagUTF16)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagUseCredSsp(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagUseCredSsp)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn EnumerationFlagAssociationInstance(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerationFlagAssociationInstance)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn EnumerationFlagAssociatedInstance(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerationFlagAssociatedInstance)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagSkipRevocationCheck(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagSkipRevocationCheck)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagAllowNegotiateImplicitCredentials(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagAllowNegotiateImplicitCredentials)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SessionFlagUseSsl(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionFlagUseSsl)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWSManEx3_Vtbl {
    ...
    pub SessionFlagUTF16:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagUseCredSsp:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub EnumerationFlagAssociationInstance:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub EnumerationFlagAssociatedInstance:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagSkipRevocationCheck:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagAllowNegotiateImplicitCredentials:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SessionFlagUseSsl:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
}
#[cfg(all(
    feature = "Win32_System_Com",
...
impl IWSManEx3_Vtbl {
    pub const fn new<Identity: IWSManEx3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SessionFlagUTF16<
        ...
        unsafe extern "system" fn SessionFlagUseCredSsp<
            Identity: IWSManEx3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnumerationFlagAssociationInstance<
            Identity: IWSManEx3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnumerationFlagAssociatedInstance<
            Identity: IWSManEx3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionFlagSkipRevocationCheck<
            Identity: IWSManEx3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionFlagAllowNegotiateImplicitCredentials<
            Identity: IWSManEx3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionFlagUseSsl<
            Identity: IWSManEx3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        Self {
            ...
            EnumerationFlagAssociationInstance: EnumerationFlagAssociationInstance::<
                Identity,
                OFFSET,
            >,
            ...
            SessionFlagAllowNegotiateImplicitCredentials:
                SessionFlagAllowNegotiateImplicitCredentials::<Identity, OFFSET>,
...
impl IWSManInternal {
    ...
    pub unsafe fn ConfigSDDL<P0>(
        &self,
        session: P0,
        resourceuri: &super::Variant::VARIANT,
        flags: i32,
    ) -> windows_core::Result<windows_core::BSTR>
    where
        P0: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ConfigSDDL)(
                windows_core::Interface::as_raw(self),
                session.param().abi(),
...
pub struct IWSManInternal_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub ConfigSDDL: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
pub trait IWSManInternal_Impl: super::Com::IDispatch_Impl {
    fn ConfigSDDL(
        &self,
        session: windows_core::Ref<'_, super::Com::IDispatch>,
        resourceuri: &super::Variant::VARIANT,
        flags: i32,
    ) -> windows_core::Result<windows_core::BSTR>;
}
...
impl IWSManInternal_Vtbl {
    pub const fn new<Identity: IWSManInternal_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ConfigSDDL<Identity: IWSManInternal_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSManInternal_Impl::ConfigSDDL(
                    this,
                    core::mem::transmute_copy(&session),
                    core::mem::transmute(&resourceuri),
                    core::mem::transmute_copy(&flags),
                ) {
                    Ok(ok__) => {
                        resource.write(core::mem::transmute(ok__));
        ...
        Self {
            base__: super::Com::IDispatch_Vtbl::new::<Identity, OFFSET>(),
            ConfigSDDL: ConfigSDDL::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IWSManResourceLocator {
    pub unsafe fn SetResourceURI(&self, uri: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetResourceURI)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn ResourceURI(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ResourceURI)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn AddSelector(
        &self,
        resourceselname: &windows_core::BSTR,
        selvalue: &super::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddSelector)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(resourceselname),
                core::mem::transmute_copy(selvalue),
            )
            .ok()
        }
    }
    pub unsafe fn ClearSelectors(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ClearSelectors)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn FragmentPath(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FragmentPath)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetFragmentPath(&self, text: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFragmentPath)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn FragmentDialect(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FragmentDialect)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetFragmentDialect(&self, text: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFragmentDialect)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(text),
            )
            .ok()
    ...
    pub unsafe fn AddOption(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AddOption)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn SetMustUnderstandOptions(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetMustUnderstandOptions)(
                windows_core::Interface::as_raw(self),
                mustunderstand.into(),
            )
            .ok()
    ...
    pub unsafe fn MustUnderstandOptions(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MustUnderstandOptions)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ClearOptions(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ClearOptions)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub struct IWSManResourceLocator_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub SetResourceURI: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddSelector: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    pub FragmentPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetFragmentPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FragmentDialect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetFragmentDialect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddOption: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::Variant::VARIANT,
        windows_core::BOOL,
    ...
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    AddOption: usize,
    pub SetMustUnderstandOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub MustUnderstandOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait IWSManResourceLocator_Impl: super::Com::IDispatch_Impl {
    ...
    fn AddOption(
        ...
        optionname: &windows_core::BSTR,
        optionvalue: &super::Variant::VARIANT,
        mustcomply: windows_core::BOOL,
    ) -> windows_core::Result<()>;
    fn SetMustUnderstandOptions(
        &self,
        mustunderstand: windows_core::BOOL,
    ) -> windows_core::Result<()>;
...
impl IWSManResourceLocator_Vtbl {
    pub const fn new<Identity: IWSManResourceLocator_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetResourceURI<
        ...
        unsafe extern "system" fn ResourceURI<
            Identity: IWSManResourceLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AddSelector<
            Identity: IWSManResourceLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            resourceselname: *mut core::ffi::c_void,
            selvalue: super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSManResourceLocator_Impl::AddSelector(
                    this,
                    core::mem::transmute(&resourceselname),
                    core::mem::transmute(&selvalue),
                )
                .into()
            }
        }
        unsafe extern "system" fn ClearSelectors<
            Identity: IWSManResourceLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn FragmentPath<
            Identity: IWSManResourceLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            text: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetFragmentPath<
            Identity: IWSManResourceLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSManResourceLocator_Impl::SetFragmentPath(this, core::mem::transmute(&text))
                    .into()
            }
        }
        unsafe extern "system" fn FragmentDialect<
            Identity: IWSManResourceLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetFragmentDialect<
            Identity: IWSManResourceLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSManResourceLocator_Impl::SetFragmentDialect(this, core::mem::transmute(&text))
                    .into()
            }
        }
        unsafe extern "system" fn AddOption<
            Identity: IWSManResourceLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSManResourceLocator_Impl::AddOption(
                    this,
                    core::mem::transmute(&optionname),
                    core::mem::transmute(&optionvalue),
                    core::mem::transmute_copy(&mustcomply),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetMustUnderstandOptions<
            Identity: IWSManResourceLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSManResourceLocator_Impl::SetMustUnderstandOptions(
                    this,
                    core::mem::transmute_copy(&mustunderstand),
                )
                .into()
            }
        }
        unsafe extern "system" fn MustUnderstandOptions<
            Identity: IWSManResourceLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            mustunderstand: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ClearOptions<
            Identity: IWSManResourceLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IWSManResourceLocatorInternal_Vtbl,
    0xeffaead7_7ec8_4716_b9be_f2e7e9fb4adb
);
...
impl IWSManSession {
    ...
    pub unsafe fn Invoke(
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(self).Invoke)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(actionuri),
                core::mem::transmute_copy(resourceuri),
    ...
    pub unsafe fn Enumerate(
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(self).Enumerate)(
                ...
                core::mem::transmute_copy(dialect),
                flags,
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn Identify(&self, flags: i32) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Identify)(
                windows_core::Interface::as_raw(self),
                flags,
                &mut result__,
            )
    ...
    pub unsafe fn BatchItems(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BatchItems)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetBatchItems(&self, value: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBatchItems)(
                windows_core::Interface::as_raw(self),
                value,
            )
            .ok()
...
pub trait IWSManSession_Impl: super::Com::IDispatch_Impl {
    ...
    fn Delete(&self, resourceuri: &super::Variant::VARIANT, flags: i32)
        -> windows_core::Result<()>;
    fn Invoke(
        &self,
        actionuri: &windows_core::BSTR,
...
impl IWSManSession_Vtbl {
    pub const fn new<Identity: IWSManSession_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Get<Identity: IWSManSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            resourceuri: super::Variant::VARIANT,
            flags: i32,
            resource: *mut *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Put<Identity: IWSManSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            resourceuri: super::Variant::VARIANT,
            resource: *mut core::ffi::c_void,
            flags: i32,
            resultresource: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSManSession_Impl::Put(
                    this,
                    core::mem::transmute(&resourceuri),
        ...
        unsafe extern "system" fn Create<Identity: IWSManSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            resourceuri: super::Variant::VARIANT,
            resource: *mut core::ffi::c_void,
            flags: i32,
            newuri: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSManSession_Impl::Create(
                    this,
                    core::mem::transmute(&resourceuri),
                    core::mem::transmute(&resource),
                    core::mem::transmute_copy(&flags),
        ...
        unsafe extern "system" fn Delete<Identity: IWSManSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            resourceuri: super::Variant::VARIANT,
            flags: i32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Invoke<Identity: IWSManSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            actionuri: *mut core::ffi::c_void,
            resourceuri: super::Variant::VARIANT,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSManSession_Impl::Invoke(
                    this,
                    core::mem::transmute(&actionuri),
                    core::mem::transmute(&resourceuri),
        ...
        unsafe extern "system" fn Enumerate<Identity: IWSManSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            resourceuri: super::Variant::VARIANT,
            filter: *mut core::ffi::c_void,
            dialect: *mut core::ffi::c_void,
            flags: i32,
            resultset: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSManSession_Impl::Enumerate(
                    this,
                    core::mem::transmute(&resourceuri),
                    core::mem::transmute(&filter),
                    core::mem::transmute(&dialect),
                    core::mem::transmute_copy(&flags),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Identify<Identity: IWSManSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            flags: i32,
            result: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Error<Identity: IWSManSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn BatchItems<Identity: IWSManSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetBatchItems<
        ...
        unsafe extern "system" fn Timeout<Identity: IWSManSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetTimeout<Identity: IWSManSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: i32,
        ) -> windows_core::HRESULT {
            unsafe {
...
pub const WSMAN_CMDSHELL_OPTION_CONSOLEMODE_STDIN: windows_core::PCWSTR =
    windows_core::w!("WINRS_CONSOLEMODE_STDIN");
pub const WSMAN_CMDSHELL_OPTION_SKIP_CMD_SHELL: windows_core::PCWSTR =
    windows_core::w!("WINRS_SKIP_CMD_SHELL");
#[repr(C)]
...
pub type WSMAN_PLUGIN_AUTHORIZE_OPERATION = Option<
    unsafe extern "system" fn(
        plugincontext: *const core::ffi::c_void,
        senderdetails: *const WSMAN_SENDER_DETAILS,
        flags: u32,
        operation: u32,
        action: windows_core::PCWSTR,
        resourceuri: windows_core::PCWSTR,
    ),
>;
pub type WSMAN_PLUGIN_AUTHORIZE_QUERY_QUOTA = Option<
    unsafe extern "system" fn(
        plugincontext: *const core::ffi::c_void,
        senderdetails: *const WSMAN_SENDER_DETAILS,
        flags: u32,
...
pub type WSMAN_PLUGIN_AUTHORIZE_RELEASE_CONTEXT =
    Option<unsafe extern "system" fn(userauthorizationcontext: *const core::ffi::c_void)>;
pub type WSMAN_PLUGIN_AUTHORIZE_USER = Option<
    unsafe extern "system" fn(
        plugincontext: *const core::ffi::c_void,
        senderdetails: *const WSMAN_SENDER_DETAILS,
        flags: u32,
...
>;
pub type WSMAN_PLUGIN_COMMAND = Option<
    unsafe extern "system" fn(
        requestdetails: *const WSMAN_PLUGIN_REQUEST,
        flags: u32,
        shellcontext: *const core::ffi::c_void,
        commandline: windows_core::PCWSTR,
        arguments: *const WSMAN_COMMAND_ARG_SET,
    ),
>;
pub type WSMAN_PLUGIN_CONNECT = Option<
    unsafe extern "system" fn(
        requestdetails: *const WSMAN_PLUGIN_REQUEST,
        flags: u32,
        shellcontext: *const core::ffi::c_void,
        commandcontext: *const core::ffi::c_void,
...
pub type WSMAN_PLUGIN_RECEIVE = Option<
    unsafe extern "system" fn(
        requestdetails: *const WSMAN_PLUGIN_REQUEST,
        flags: u32,
        shellcontext: *const core::ffi::c_void,
...
>;
pub type WSMAN_PLUGIN_RELEASE_COMMAND_CONTEXT = Option<
    unsafe extern "system" fn(
        shellcontext: *const core::ffi::c_void,
        commandcontext: *const core::ffi::c_void,
    ),
...
pub type WSMAN_PLUGIN_RELEASE_SHELL_CONTEXT =
    Option<unsafe extern "system" fn(shellcontext: *const core::ffi::c_void)>;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub type WSMAN_PLUGIN_SEND = Option<
    unsafe extern "system" fn(
        requestdetails: *const WSMAN_PLUGIN_REQUEST,
        flags: u32,
        shellcontext: *const core::ffi::c_void,
...
>;
pub type WSMAN_PLUGIN_SHELL = Option<
    unsafe extern "system" fn(
        plugincontext: *const core::ffi::c_void,
        requestdetails: *const WSMAN_PLUGIN_REQUEST,
        flags: u32,
...
>;
pub type WSMAN_PLUGIN_SHUTDOWN = Option<
    unsafe extern "system" fn(
        plugincontext: *const core::ffi::c_void,
        flags: u32,
        reason: u32,
...
pub type WSMAN_PLUGIN_SIGNAL = Option<
    unsafe extern "system" fn(
        requestdetails: *const WSMAN_PLUGIN_REQUEST,
        flags: u32,
        shellcontext: *const core::ffi::c_void,
        commandcontext: *const core::ffi::c_void,
        code: windows_core::PCWSTR,
    ),
>;
pub type WSMAN_PLUGIN_STARTUP = Option<
    unsafe extern "system" fn(
        flags: u32,
        applicationidentification: windows_core::PCWSTR,
        extrainfo: windows_core::PCWSTR,
        plugincontext: *mut *mut core::ffi::c_void,
    ) -> u32,
>;
...
pub type WSMAN_SHELL_COMPLETION_FUNCTION = Option<
    unsafe extern "system" fn(
        operationcontext: *const core::ffi::c_void,
        flags: u32,
...
pub const WSMAN_SHELL_NS: windows_core::PCWSTR =
    windows_core::w!("http://schemas.microsoft.com/wbem/wsman/1/windows/shell");
...
pub const WSMan: windows_core::GUID =
    windows_core::GUID::from_u128(0xbced617b_ec03_420b_8508_977dc7a686bd);
#[repr(transparent)]
...
pub const WSManInternal: windows_core::GUID =
    windows_core::GUID::from_u128(0x7de087a5_5dcb_4df7_bb12_0924ad8fbd9a);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]

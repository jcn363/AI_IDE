...
pub unsafe fn EapHostPeerBeginSession(
    ...
    pconnectionid: *const windows_core::GUID,
...
pub unsafe fn EapHostPeerClearConnection(
    pconnectionid: *mut windows_core::GUID,
    ppeaperror: *mut *mut EAP_ERROR,
) -> u32 {
...
pub unsafe fn EapHostPeerConfigBlob2Xml(
    ...
    pconfigin: &[u8],
    ppconfigdoc: *mut Option<super::super::Data::Xml::MsXml::IXMLDOMDocument2>,
    ppeaperror: *mut *mut EAP_ERROR,
) -> u32 {
    ...
    unsafe {
        EapHostPeerConfigBlob2Xml(
            ...
            pconfigin.len().try_into().unwrap(),
            core::mem::transmute(pconfigin.as_ptr()),
            core::mem::transmute(ppconfigdoc),
            ppeaperror as _,
        )
    }
}
#[cfg(all(feature = "Win32_Data_Xml_MsXml", feature = "Win32_System_Com"))]
#[inline]
pub unsafe fn EapHostPeerConfigXml2Blob<P1>(
    dwflags: u32,
    pconfigdoc: P1,
    ...
    P1: windows_core::Param<super::super::Data::Xml::MsXml::IXMLDOMNode>,
{
    ...
    unsafe {
        EapHostPeerConfigXml2Blob(
            dwflags,
            pconfigdoc.param().abi(),
            pdwsizeofconfigout as _,
            ppconfigout as _,
            peapmethodtype as _,
            ppeaperror as _,
        )
...
#[cfg(all(feature = "Win32_Data_Xml_MsXml", feature = "Win32_System_Com"))]
#[inline]
pub unsafe fn EapHostPeerCredentialsXml2Blob<P1>(
    dwflags: u32,
    pcredentialsdoc: P1,
    pconfigin: &[u8],
    ...
    P1: windows_core::Param<super::super::Data::Xml::MsXml::IXMLDOMNode>,
{
    ...
    unsafe {
        EapHostPeerCredentialsXml2Blob(
            dwflags,
            pcredentialsdoc.param().abi(),
            pconfigin.len().try_into().unwrap(),
            core::mem::transmute(pconfigin.as_ptr()),
            pdwsizeofcredentialsout as _,
            ppcredentialsout as _,
            peapmethodtype as _,
            ppeaperror as _,
        )
    }
...
pub unsafe fn EapHostPeerGetDataToUnplumbCredentials(
    pconnectionidthatlastsavedcreds: *mut windows_core::GUID,
    phcredentialimpersonationtoken: *mut isize,
    sessionhandle: u32,
    ppeaperror: *mut *mut EAP_ERROR,
    fsavetocredman: *mut windows_core::BOOL,
) -> u32 {
    ...
    unsafe {
        EapHostPeerGetDataToUnplumbCredentials(
            pconnectionidthatlastsavedcreds as _,
            phcredentialimpersonationtoken as _,
            sessionhandle,
            ppeaperror as _,
            fsavetocredman as _,
        )
...
pub unsafe fn EapHostPeerGetEncryptedPassword<P1>(
    ...
    szpassword: P1,
    ppszencpassword: *mut windows_core::PWSTR,
) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        EapHostPeerGetEncryptedPassword(
            dwsizeofpassword,
            szpassword.param().abi(),
            ppszencpassword as _,
        )
    }
}
#[inline]
pub unsafe fn EapHostPeerGetIdentity(
    ...
    puserdata: Option<&[u8]>,
    htokenimpersonateuser: super::super::Foundation::HANDLE,
    pfinvokeui: *mut windows_core::BOOL,
...
pub unsafe fn EapHostPeerGetMethodProperties(
    ...
    unsafe {
        EapHostPeerGetMethodProperties(
            ...
            pbeapconndata.len().try_into().unwrap(),
            core::mem::transmute(pbeapconndata.as_ptr()),
            pbuserdata.len().try_into().unwrap(),
            core::mem::transmute(pbuserdata.as_ptr()),
            pmethodpropertyarray as _,
            ppeaperror as _,
        )
    }
}
...
pub unsafe fn EapHostPeerGetUIContext(
    ...
    unsafe {
        EapHostPeerGetUIContext(
            sessionhandle,
            pdwsizeofuicontextdata as _,
            ppuicontextdata as _,
            ppeaperror as _,
        )
    }
}
...
pub unsafe fn EapHostPeerInvokeInteractiveUI(
    ...
    unsafe {
        EapHostPeerInvokeInteractiveUI(
            ...
            pdwsizeofdatafrominteractiveui as _,
            ppdatafrominteractiveui as _,
            ppeaperror as _,
        )
    }
}
...
pub unsafe fn EapHostPeerQueryCredentialInputFields(
    ...
    unsafe {
        EapHostPeerQueryCredentialInputFields(
            ...
            pbeapconndata.len().try_into().unwrap(),
            core::mem::transmute(pbeapconndata.as_ptr()),
            peapconfiginputfieldarray as _,
            ppeaperror as _,
        )
    }
}
...
pub unsafe fn EapHostPeerQueryInteractiveUIInputFields(
    ...
    unsafe {
        EapHostPeerQueryInteractiveUIInputFields(
            dwversion,
            dwflags,
            puicontextdata.len().try_into().unwrap(),
            core::mem::transmute(puicontextdata.as_ptr()),
            peapinteractiveuidata as _,
            ppeaperror as _,
            ppvreserved as _,
        )
    }
...
pub unsafe fn EapHostPeerSetResponseAttributes(
    ...
    unsafe {
        EapHostPeerSetResponseAttributes(sessionhandle, pattribs, peapoutput as _, ppeaperror as _)
    }
}
#[inline]
...
pub const EAP_AUTHENTICATOR_VALUENAME_CONFIGUI: windows_core::PCWSTR =
    windows_core::w!("AuthenticatorConfigUIPath");
pub const EAP_AUTHENTICATOR_VALUENAME_DLL_PATH: windows_core::PCWSTR =
    windows_core::w!("AuthenticatorDllPath");
pub const EAP_AUTHENTICATOR_VALUENAME_FRIENDLY_NAME: windows_core::PCWSTR =
    windows_core::w!("AuthenticatorFriendlyName");
pub const EAP_AUTHENTICATOR_VALUENAME_PROPERTIES: windows_core::PCWSTR =
...
pub const EAP_PEER_VALUENAME_FRIENDLY_NAME: windows_core::PCWSTR =
    windows_core::w!("PeerFriendlyName");
pub const EAP_PEER_VALUENAME_IDENTITY: windows_core::PCWSTR = windows_core::w!("PeerIdentityPath");
pub const EAP_PEER_VALUENAME_INTERACTIVEUI: windows_core::PCWSTR =
    windows_core::w!("PeerInteractiveUIPath");
pub const EAP_PEER_VALUENAME_INVOKE_NAMEDLG: windows_core::PCWSTR =
    windows_core::w!("PeerInvokeUsernameDialog");
pub const EAP_PEER_VALUENAME_INVOKE_PWDDLG: windows_core::PCWSTR =
    windows_core::w!("PeerInvokePasswordDialog");
pub const EAP_PEER_VALUENAME_PROPERTIES: windows_core::PCWSTR = windows_core::w!("Properties");
pub const EAP_PEER_VALUENAME_REQUIRE_CONFIGUI: windows_core::PCWSTR =
    windows_core::w!("PeerRequireConfigUI");
pub const EAP_REGISTRY_LOCATION: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\EapHost\\Methods");
...
pub const GUID_EapHost_Cause_CertStoreInaccessible: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000004);
pub const GUID_EapHost_Cause_EapNegotiationFailed: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000001c);
pub const GUID_EapHost_Cause_EapQecInaccessible: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000312);
pub const GUID_EapHost_Cause_Generic_AuthFailure: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000104);
pub const GUID_EapHost_Cause_IdentityUnknown: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000204);
pub const GUID_EapHost_Cause_MethodDLLNotFound: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000001);
pub const GUID_EapHost_Cause_MethodDoesNotSupportOperation: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000001e);
pub const GUID_EapHost_Cause_Method_Config_Does_Not_Support_Sso: windows_core::GUID =
    windows_core::GUID::from_u128(0xda18bd32_004f_41fa_ae08_0bc85e5845ac);
pub const GUID_EapHost_Cause_No_SmartCardReader_Found: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000002b);
pub const GUID_EapHost_Cause_Server_CertExpired: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000005);
pub const GUID_EapHost_Cause_Server_CertInvalid: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000006);
pub const GUID_EapHost_Cause_Server_CertNotFound: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000007);
pub const GUID_EapHost_Cause_Server_CertOtherError: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000108);
pub const GUID_EapHost_Cause_Server_CertRevoked: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000008);
pub const GUID_EapHost_Cause_Server_Root_CertNameRequired: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000012);
pub const GUID_EapHost_Cause_Server_Root_CertNotFound: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000112);
pub const GUID_EapHost_Cause_SimNotValid: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000304);
pub const GUID_EapHost_Cause_ThirdPartyMethod_Host_Reset: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000212);
pub const GUID_EapHost_Cause_User_Account_OtherProblem: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000010e);
pub const GUID_EapHost_Cause_User_CertExpired: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000009);
pub const GUID_EapHost_Cause_User_CertInvalid: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000000a);
pub const GUID_EapHost_Cause_User_CertNotFound: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000000b);
pub const GUID_EapHost_Cause_User_CertOtherError: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000000c);
pub const GUID_EapHost_Cause_User_CertRejected: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000000d);
pub const GUID_EapHost_Cause_User_CertRevoked: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000000e);
pub const GUID_EapHost_Cause_User_CredsRejected: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000020e);
pub const GUID_EapHost_Cause_User_Root_CertExpired: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000000f);
pub const GUID_EapHost_Cause_User_Root_CertInvalid: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000010);
pub const GUID_EapHost_Cause_User_Root_CertNotFound: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000011);
pub const GUID_EapHost_Cause_XmlMalformed: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000001d);
pub const GUID_EapHost_Default: windows_core::GUID =
    windows_core::GUID::from_u128(0x00000000_0000_0000_0000_000000000000);
pub const GUID_EapHost_Help_ObtainingCerts: windows_core::GUID =
    windows_core::GUID::from_u128(0xf535eea3_1bdd_46ca_a2fc_a6655939b7e8);
pub const GUID_EapHost_Help_Troubleshooting: windows_core::GUID =
    windows_core::GUID::from_u128(0x33307acf_0698_41ba_b014_ea0a2eb8d0a8);
pub const GUID_EapHost_Repair_ContactAdmin_AuthFailure: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000001f);
pub const GUID_EapHost_Repair_ContactAdmin_CertNameAbsent: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000029);
pub const GUID_EapHost_Repair_ContactAdmin_CertStoreInaccessible: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000024);
pub const GUID_EapHost_Repair_ContactAdmin_IdentityUnknown: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000020);
pub const GUID_EapHost_Repair_ContactAdmin_InvalidUserAccount: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000025);
pub const GUID_EapHost_Repair_ContactAdmin_InvalidUserCert: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000002c);
pub const GUID_EapHost_Repair_ContactAdmin_MethodNotFound: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000022);
pub const GUID_EapHost_Repair_ContactAdmin_NegotiationFailed: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000021);
pub const GUID_EapHost_Repair_ContactAdmin_NoSmartCardReader: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000002a);
pub const GUID_EapHost_Repair_ContactAdmin_RootCertInvalid: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000026);
pub const GUID_EapHost_Repair_ContactAdmin_RootCertNotFound: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000027);
pub const GUID_EapHost_Repair_ContactAdmin_RootExpired: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000028);
pub const GUID_EapHost_Repair_ContactSysadmin: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000002);
pub const GUID_EapHost_Repair_Method_Not_Support_Sso: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000002d);
pub const GUID_EapHost_Repair_No_ValidSim_Found: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000002e);
pub const GUID_EapHost_Repair_RestartNap: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000023);
pub const GUID_EapHost_Repair_Retry_Authentication: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000011b);
pub const GUID_EapHost_Repair_Server_ClientSelectServerCert: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000018);
pub const GUID_EapHost_Repair_User_AuthFailure: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d800000019);
pub const GUID_EapHost_Repair_User_GetNewCert: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000001a);
pub const GUID_EapHost_Repair_User_SelectValidCert: windows_core::GUID =
    windows_core::GUID::from_u128(0x9612fc67_6150_4209_a85e_a8d80000001b);
windows_core::imp::define_interface!(
    IAccountingProviderConfig,
    IAccountingProviderConfig_Vtbl,
    0x66a2db18_d706_11d0_a37b_00c04fc9da04
);
...
impl IAccountingProviderConfig {
    ...
    pub unsafe fn Uninitialize(&self, uconnectionparam: usize) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Uninitialize)(
                windows_core::Interface::as_raw(self),
                uconnectionparam,
            )
            .ok()
...
impl IAccountingProviderConfig_Vtbl {
    pub const fn new<Identity: IAccountingProviderConfig_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            pszmachinename: windows_core::PCWSTR,
            puconnectionparam: *mut usize,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAccountingProviderConfig_Impl::Initialize(
                    this,
                    core::mem::transmute(&pszmachinename),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAccountingProviderConfig_Impl::Uninitialize(
                    this,
                    core::mem::transmute_copy(&uconnectionparam),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAccountingProviderConfig_Impl::Configure(
                    this,
                    core::mem::transmute_copy(&uconnectionparam),
                    core::mem::transmute_copy(&hwnd),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&ureserved1),
                    core::mem::transmute_copy(&ureserved2),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAccountingProviderConfig_Impl::Activate(
                    this,
                    core::mem::transmute_copy(&uconnectionparam),
                    core::mem::transmute_copy(&ureserved1),
                    core::mem::transmute_copy(&ureserved2),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAccountingProviderConfig_Impl::Deactivate(
                    this,
                    core::mem::transmute_copy(&uconnectionparam),
                    core::mem::transmute_copy(&ureserved1),
                    core::mem::transmute_copy(&ureserved2),
...
windows_core::imp::define_interface!(
    ...
    0x66a2db17_d706_11d0_a37b_00c04fc9da04
);
    ...
    pub const fn new<Identity: IAuthenticationProviderConfig_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAuthenticationProviderConfig_Impl::Initialize(
                    this,
                    core::mem::transmute(&pszmachinename),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAuthenticationProviderConfig_Impl::Uninitialize(
                    this,
                    core::mem::transmute_copy(&uconnectionparam),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAuthenticationProviderConfig_Impl::Configure(
                    this,
                    core::mem::transmute_copy(&uconnectionparam),
                    core::mem::transmute_copy(&hwnd),
                    core::mem::transmute_copy(&dwflags),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAuthenticationProviderConfig_Impl::Activate(
                    this,
                    core::mem::transmute_copy(&uconnectionparam),
                    core::mem::transmute_copy(&ureserved1),
                    core::mem::transmute_copy(&ureserved2),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAuthenticationProviderConfig_Impl::Deactivate(
                    this,
                    core::mem::transmute_copy(&uconnectionparam),
                    core::mem::transmute_copy(&ureserved1),
                    core::mem::transmute_copy(&ureserved2),
...
windows_core::imp::define_interface!(
    ...
    0x66a2db19_d706_11d0_a37b_00c04fc9da04
);
...
impl IEAPProviderConfig {
    ...
    pub unsafe fn ServerInvokeConfigUI(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ServerInvokeConfigUI)(
                windows_core::Interface::as_raw(self),
                dweaptypeid,
                uconnectionparam,
                hwnd,
    ...
    pub unsafe fn RouterInvokeConfigUI(
        ...
        hwndparent: super::super::Foundation::HWND,
        dwflags: u32,
        pconnectiondatain: &[u8],
        ppconnectiondataout: *mut *mut u8,
        pdwsizeofconnectiondataout: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RouterInvokeConfigUI)(
                windows_core::Interface::as_raw(self),
                dweaptypeid,
                uconnectionparam,
                hwndparent,
                dwflags,
                core::mem::transmute(pconnectiondatain.as_ptr()),
                pconnectiondatain.len().try_into().unwrap(),
                ppconnectiondataout as _,
                pdwsizeofconnectiondataout as _,
            )
            .ok()
        }
    }
    pub unsafe fn RouterInvokeCredentialsUI(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).RouterInvokeCredentialsUI)(
                windows_core::Interface::as_raw(self),
                dweaptypeid,
                uconnectionparam,
                hwndparent,
                ...
                core::mem::transmute(pconnectiondatain.as_ptr()),
                pconnectiondatain.len().try_into().unwrap(),
                core::mem::transmute(puserdatain.as_ptr()),
                puserdatain.len().try_into().unwrap(),
                ppuserdataout as _,
                pdwsizeofuserdataout as _,
            )
            .ok()
...
pub struct IEAPProviderConfig_Vtbl {
    ...
    pub ServerInvokeConfigUI: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        usize,
        super::super::Foundation::HWND,
    ...
    pub RouterInvokeConfigUI: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        usize,
        super::super::Foundation::HWND,
    ...
    pub RouterInvokeCredentialsUI: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        usize,
        super::super::Foundation::HWND,
    ...
    pub const fn new<Identity: IEAPProviderConfig_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IEAPProviderConfig_Impl::Initialize(
                    this,
                    core::mem::transmute(&pszmachinename),
                    core::mem::transmute_copy(&dweaptypeid),
                ) {
                    Ok(ok__) => {
                        puconnectionparam.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEAPProviderConfig_Impl::Uninitialize(
                    this,
                    core::mem::transmute_copy(&dweaptypeid),
                    core::mem::transmute_copy(&uconnectionparam),
                )
        ...
        unsafe extern "system" fn ServerInvokeConfigUI<
            Identity: IEAPProviderConfig_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEAPProviderConfig_Impl::ServerInvokeConfigUI(
                    this,
                    core::mem::transmute_copy(&dweaptypeid),
                    core::mem::transmute_copy(&uconnectionparam),
                    core::mem::transmute_copy(&hwnd),
        ...
        unsafe extern "system" fn RouterInvokeConfigUI<
            Identity: IEAPProviderConfig_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEAPProviderConfig_Impl::RouterInvokeConfigUI(
                    this,
                    core::mem::transmute_copy(&dweaptypeid),
                    core::mem::transmute_copy(&uconnectionparam),
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&pconnectiondatain),
                    core::mem::transmute_copy(&dwsizeofconnectiondatain),
                    core::mem::transmute_copy(&ppconnectiondataout),
                    core::mem::transmute_copy(&pdwsizeofconnectiondataout),
                )
                .into()
            }
        }
        unsafe extern "system" fn RouterInvokeCredentialsUI<
            Identity: IEAPProviderConfig_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEAPProviderConfig_Impl::RouterInvokeCredentialsUI(
                    this,
                    core::mem::transmute_copy(&dweaptypeid),
                    core::mem::transmute_copy(&uconnectionparam),
                    core::mem::transmute_copy(&hwndparent),
                    ...
                    core::mem::transmute_copy(&pconnectiondatain),
                    core::mem::transmute_copy(&dwsizeofconnectiondatain),
                    core::mem::transmute_copy(&puserdatain),
                    core::mem::transmute_copy(&dwsizeofuserdatain),
                    core::mem::transmute_copy(&ppuserdataout),
                    core::mem::transmute_copy(&pdwsizeofuserdataout),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xd565917a_85c4_4466_856e_671c3742ea9a
);
...
impl IEAPProviderConfig2 {
    pub unsafe fn ServerInvokeConfigUI2(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ServerInvokeConfigUI2)(
                windows_core::Interface::as_raw(self),
                dweaptypeid,
                uconnectionparam,
                hwnd,
                ...
                ppconfigdataout as _,
                pdwsizeofconfigdataout as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetGlobalConfig(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetGlobalConfig)(
                windows_core::Interface::as_raw(self),
                dweaptypeid,
                ppconfigdataout as _,
                pdwsizeofconfigdataout as _,
...
pub struct IEAPProviderConfig2_Vtbl {
    ...
    pub ServerInvokeConfigUI2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        usize,
        super::super::Foundation::HWND,
    ...
    pub GetGlobalConfig: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut u8,
        *mut u32,
...
impl IEAPProviderConfig2_Vtbl {
    pub const fn new<Identity: IEAPProviderConfig2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ServerInvokeConfigUI2<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEAPProviderConfig2_Impl::ServerInvokeConfigUI2(
                    this,
                    core::mem::transmute_copy(&dweaptypeid),
                    core::mem::transmute_copy(&uconnectionparam),
                    core::mem::transmute_copy(&hwnd),
                    core::mem::transmute_copy(&pconfigdatain),
                    core::mem::transmute_copy(&dwsizeofconfigdatain),
                    core::mem::transmute_copy(&ppconfigdataout),
                    core::mem::transmute_copy(&pdwsizeofconfigdataout),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetGlobalConfig<
            Identity: IEAPProviderConfig2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEAPProviderConfig2_Impl::GetGlobalConfig(
                    this,
                    core::mem::transmute_copy(&dweaptypeid),
                    core::mem::transmute_copy(&ppconfigdataout),
                    core::mem::transmute_copy(&pdwsizeofconfigdataout),
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IEAPProviderConfig2 as windows_core::Interface>::IID
            || iid == &<IEAPProviderConfig as windows_core::Interface>::IID
    }
}
...
windows_core::imp::define_interface!(
    ...
    0xb78ecd12_68bb_4f86_9bf0_8438dd3be982
);
...
impl IEAPProviderConfig3 {
    pub unsafe fn ServerInvokeCertificateConfigUI(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ServerInvokeCertificateConfigUI)(
                windows_core::Interface::as_raw(self),
                dweaptypeid,
                uconnectionparam,
                hwnd,
...
pub struct IEAPProviderConfig3_Vtbl {
    ...
    pub ServerInvokeCertificateConfigUI: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        usize,
        super::super::Foundation::HWND,
...
impl IEAPProviderConfig3_Vtbl {
    pub const fn new<Identity: IEAPProviderConfig3_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEAPProviderConfig3_Impl::ServerInvokeCertificateConfigUI(
                    this,
                    core::mem::transmute_copy(&dweaptypeid),
                    core::mem::transmute_copy(&uconnectionparam),
                    core::mem::transmute_copy(&hwnd),
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IEAPProviderConfig3 as windows_core::Interface>::IID
            || iid == &<IEAPProviderConfig as windows_core::Interface>::IID
            || iid == &<IEAPProviderConfig2 as windows_core::Interface>::IID
    }
}
...
impl IRouterProtocolConfig {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddProtocol)(
                windows_core::Interface::as_raw(self),
                pszmachinename.param().abi(),
                dwtransportid,
                dwprotocolid,
    ...
    pub unsafe fn RemoveProtocol<P0, P5>(
        &self,
        pszmachinename: P0,
        dwtransportid: u32,
        dwprotocolid: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveProtocol)(
                windows_core::Interface::as_raw(self),
                pszmachinename.param().abi(),
                dwtransportid,
                dwprotocolid,
...
pub struct IRouterProtocolConfig_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub AddProtocol: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        u32,
    ...
    pub RemoveProtocol: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        u32,
...
pub trait IRouterProtocolConfig_Impl: windows_core::IUnknownImpl {
    fn AddProtocol(
        ...
        hwnd: super::super::Foundation::HWND,
        dwflags: u32,
        prouter: windows_core::Ref<'_, windows_core::IUnknown>,
        ureserved1: usize,
    ) -> windows_core::Result<()>;
    fn RemoveProtocol(
        &self,
...
impl IRouterProtocolConfig_Vtbl {
    pub const fn new<Identity: IRouterProtocolConfig_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddProtocol<
        ...
        >(
            ...
            hwnd: super::super::Foundation::HWND,
            dwflags: u32,
            prouter: *mut core::ffi::c_void,
            ureserved1: usize,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRouterProtocolConfig_Impl::AddProtocol(
                    this,
                    core::mem::transmute(&pszmachinename),
                    core::mem::transmute_copy(&dwtransportid),
                    core::mem::transmute_copy(&dwprotocolid),
                    core::mem::transmute_copy(&hwnd),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&prouter),
                    core::mem::transmute_copy(&ureserved1),
                )
                .into()
            }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRouterProtocolConfig_Impl::RemoveProtocol(
                    this,
                    core::mem::transmute(&pszmachinename),
                    core::mem::transmute_copy(&dwtransportid),
                    core::mem::transmute_copy(&dwprotocolid),
...
pub type NotificationHandler = Option<
    unsafe extern "system" fn(
        connectionid: windows_core::GUID,
        pcontextdata: *mut core::ffi::c_void,
    ),
>;
#[repr(transparent)]
...
pub const RAS_EAP_REGISTRY_LOCATION: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\Rasman\\PPP\\EAP");
...
pub const RAS_EAP_VALUENAME_ENCRYPTION: windows_core::PCWSTR =
    windows_core::w!("MPPEEncryptionSupported");
pub const RAS_EAP_VALUENAME_FILTER_INNERMETHODS: windows_core::PCWSTR =
    windows_core::w!("FilterInnerMethods");
...
pub const RAS_EAP_VALUENAME_INTERACTIVEUI: windows_core::PCWSTR =
    windows_core::w!("InteractiveUIPath");
pub const RAS_EAP_VALUENAME_INVOKE_NAMEDLG: windows_core::PCWSTR =
    windows_core::w!("InvokeUsernameDialog");
pub const RAS_EAP_VALUENAME_INVOKE_PWDDLG: windows_core::PCWSTR =
    windows_core::w!("InvokePasswordDialog");
pub const RAS_EAP_VALUENAME_ISTUNNEL_METHOD: windows_core::PCWSTR =
    windows_core::w!("IsTunnelMethod");
pub const RAS_EAP_VALUENAME_PATH: windows_core::PCWSTR = windows_core::w!("Path");
pub const RAS_EAP_VALUENAME_PER_POLICY_CONFIG: windows_core::PCWSTR =
    windows_core::w!("PerPolicyConfig");
pub const RAS_EAP_VALUENAME_REQUIRE_CONFIGUI: windows_core::PCWSTR =
    windows_core::w!("RequireConfigUI");
pub const RAS_EAP_VALUENAME_ROLES_SUPPORTED: windows_core::PCWSTR =
    windows_core::w!("RolesSupported");
pub const RAS_EAP_VALUENAME_STANDALONE_SUPPORTED: windows_core::PCWSTR =
    windows_core::w!("StandaloneSupported");

...
impl ISensLogon {
    ...
    pub unsafe fn StartShell(&self, bstrusername: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).StartShell)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrusername),
            )
            .ok()
    ...
    pub unsafe fn DisplayLock(
        &self,
        bstrusername: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DisplayLock)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrusername),
            )
            .ok()
    ...
    pub unsafe fn DisplayUnlock(
        &self,
        bstrusername: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DisplayUnlock)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrusername),
            )
            .ok()
    ...
    pub unsafe fn StartScreenSaver(
        &self,
        bstrusername: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).StartScreenSaver)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrusername),
            )
            .ok()
    ...
    pub unsafe fn StopScreenSaver(
        &self,
        bstrusername: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).StopScreenSaver)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrusername),
            )
            .ok()
...
pub struct ISensLogon_Vtbl {
    ...
    pub StartShell: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DisplayLock: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DisplayUnlock: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub StartScreenSaver: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub StopScreenSaver: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ISensLogon_Vtbl {
    pub const fn new<Identity: ISensLogon_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Logon<Identity: ISensLogon_Impl, const OFFSET: isize>(
        ...
        unsafe extern "system" fn Logoff<Identity: ISensLogon_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrusername: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn StartShell<Identity: ISensLogon_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrusername: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn DisplayLock<Identity: ISensLogon_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrusername: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn DisplayUnlock<Identity: ISensLogon_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrusername: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn StartScreenSaver<
        ...
        unsafe extern "system" fn StopScreenSaver<
            Identity: ISensLogon_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl ISensLogon2 {
    ...
    pub unsafe fn SessionDisconnect(
        &self,
        bstrusername: &windows_core::BSTR,
        dwsessionid: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SessionDisconnect)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrusername),
                dwsessionid,
            )
    ...
    pub unsafe fn SessionReconnect(
        &self,
        bstrusername: &windows_core::BSTR,
        dwsessionid: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SessionReconnect)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrusername),
                dwsessionid,
            )
    ...
    pub unsafe fn PostShell(
        &self,
        bstrusername: &windows_core::BSTR,
        dwsessionid: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).PostShell)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrusername),
                dwsessionid,
            )
...
pub struct ISensLogon2_Vtbl {
    ...
    pub SessionDisconnect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ) -> windows_core::HRESULT,
    pub SessionReconnect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ) -> windows_core::HRESULT,
    pub PostShell: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ) -> windows_core::HRESULT,
...
impl ISensLogon2_Vtbl {
    pub const fn new<Identity: ISensLogon2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Logon<Identity: ISensLogon2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrusername: *mut core::ffi::c_void,
            dwsessionid: u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Logoff<Identity: ISensLogon2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrusername: *mut core::ffi::c_void,
            dwsessionid: u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn SessionDisconnect<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISensLogon2_Impl::SessionDisconnect(
                    this,
                    core::mem::transmute(&bstrusername),
                    core::mem::transmute_copy(&dwsessionid),
                )
        ...
        unsafe extern "system" fn SessionReconnect<
            Identity: ISensLogon2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISensLogon2_Impl::SessionReconnect(
                    this,
                    core::mem::transmute(&bstrusername),
                    core::mem::transmute_copy(&dwsessionid),
                )
        ...
        unsafe extern "system" fn PostShell<Identity: ISensLogon2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrusername: *mut core::ffi::c_void,
            dwsessionid: u32,
        ) -> windows_core::HRESULT {
...
#[cfg(feature = "Win32_System_Com")]
impl ISensNetwork {
    pub unsafe fn ConnectionMade(
        &self,
        bstrconnection: &windows_core::BSTR,
        ultype: u32,
        lpqocinfo: *const SENS_QOCINFO,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ConnectionMade)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrconnection),
                ultype,
                lpqocinfo,
            )
            .ok()
    ...
    pub unsafe fn ConnectionMadeNoQOCInfo(
        &self,
        bstrconnection: &windows_core::BSTR,
        ultype: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ConnectionMadeNoQOCInfo)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrconnection),
                ultype,
            )
    ...
    pub unsafe fn ConnectionLost(
        &self,
        bstrconnection: &windows_core::BSTR,
        ultype: SENS_CONNECTION_TYPE,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ConnectionLost)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrconnection),
                ultype,
            )
    ...
    pub unsafe fn DestinationReachable(
        &self,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DestinationReachable)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn DestinationReachableNoQOCInfo(
        &self,
        bstrdestination: &windows_core::BSTR,
        bstrconnection: &windows_core::BSTR,
        ultype: u32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DestinationReachableNoQOCInfo)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrdestination),
                core::mem::transmute_copy(bstrconnection),
                ultype,
...
pub struct ISensNetwork_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub ConnectionMade: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const SENS_QOCINFO,
    ) -> windows_core::HRESULT,
    pub ConnectionMadeNoQOCInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ) -> windows_core::HRESULT,
    pub ConnectionLost: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        SENS_CONNECTION_TYPE,
    ) -> windows_core::HRESULT,
    pub DestinationReachable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ...
    pub DestinationReachableNoQOCInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
...
impl ISensNetwork_Vtbl {
    pub const fn new<Identity: ISensNetwork_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ConnectionMade<
            Identity: ISensNetwork_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrconnection: *mut core::ffi::c_void,
            ultype: u32,
            lpqocinfo: *const SENS_QOCINFO,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISensNetwork_Impl::ConnectionMade(
                    this,
                    core::mem::transmute(&bstrconnection),
                    core::mem::transmute_copy(&ultype),
                    core::mem::transmute_copy(&lpqocinfo),
                )
                .into()
            }
        }
        unsafe extern "system" fn ConnectionMadeNoQOCInfo<
            Identity: ISensNetwork_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISensNetwork_Impl::ConnectionMadeNoQOCInfo(
                    this,
                    core::mem::transmute(&bstrconnection),
                    core::mem::transmute_copy(&ultype),
                )
        ...
        unsafe extern "system" fn ConnectionLost<
            Identity: ISensNetwork_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISensNetwork_Impl::ConnectionLost(
                    this,
                    core::mem::transmute(&bstrconnection),
                    core::mem::transmute_copy(&ultype),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISensNetwork_Impl::DestinationReachable(
                    this,
                    core::mem::transmute(&bstrdestination),
                    core::mem::transmute(&bstrconnection),
                    core::mem::transmute_copy(&ultype),
                    core::mem::transmute_copy(&lpqocinfo),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISensNetwork_Impl::DestinationReachableNoQOCInfo(
                    this,
                    core::mem::transmute(&bstrdestination),
                    core::mem::transmute(&bstrconnection),
                    core::mem::transmute_copy(&ultype),
...
impl ISensOnNow {
    pub unsafe fn OnACPower(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnACPower)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn OnBatteryPower(&self, dwbatterylifepercent: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnBatteryPower)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn BatteryLow(&self, dwbatterylifepercent: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BatteryLow)(
                windows_core::Interface::as_raw(self),
                dwbatterylifepercent,
            )
            .ok()
...
impl ISensOnNow_Vtbl {
    pub const fn new<Identity: ISensOnNow_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnACPower<Identity: ISensOnNow_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn OnBatteryPower<Identity: ISensOnNow_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISensOnNow_Impl::OnBatteryPower(
                    this,
                    core::mem::transmute_copy(&dwbatterylifepercent),
                )
                .into()
            }
        }
        unsafe extern "system" fn BatteryLow<Identity: ISensOnNow_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwbatterylifepercent: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISensOnNow_Impl::BatteryLow(this, core::mem::transmute_copy(&dwbatterylifepercent))
                    .into()
            }
        }
        Self {
...
pub const SENS: windows_core::GUID =
    windows_core::GUID::from_u128(0xd597cafe_5b9f_11d1_8dd2_00aa004abd5e);
pub const SENSGUID_EVENTCLASS_LOGON: windows_core::GUID =
    windows_core::GUID::from_u128(0xd5978630_5b9f_11d1_8dd2_00aa004abd5e);
pub const SENSGUID_EVENTCLASS_LOGON2: windows_core::GUID =
    windows_core::GUID::from_u128(0xd5978650_5b9f_11d1_8dd2_00aa004abd5e);
pub const SENSGUID_EVENTCLASS_NETWORK: windows_core::GUID =
    windows_core::GUID::from_u128(0xd5978620_5b9f_11d1_8dd2_00aa004abd5e);
pub const SENSGUID_EVENTCLASS_ONNOW: windows_core::GUID =
    windows_core::GUID::from_u128(0xd5978640_5b9f_11d1_8dd2_00aa004abd5e);
pub const SENSGUID_PUBLISHER: windows_core::GUID =
    windows_core::GUID::from_u128(0x5fee1bd6_5b9b_11d1_8dd2_00aa004abd5e);
pub const SENSGUID_SUBSCRIBER_LCE: windows_core::GUID =
    windows_core::GUID::from_u128(0xd3938ab0_5b9d_11d1_8dd2_00aa004abd5e);
pub const SENSGUID_SUBSCRIBER_WININET: windows_core::GUID =
    windows_core::GUID::from_u128(0xd3938ab5_5b9d_11d1_8dd2_00aa004abd5e);
#[repr(transparent)]

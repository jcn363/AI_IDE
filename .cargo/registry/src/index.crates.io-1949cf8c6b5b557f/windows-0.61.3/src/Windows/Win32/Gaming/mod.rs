...
pub unsafe fn CheckGamingPrivilegeSilently(
    privilegeid: u32,
    scope: &windows_core::HSTRING,
    policy: &windows_core::HSTRING,
...
pub unsafe fn CheckGamingPrivilegeWithUI(
    ...
    scope: &windows_core::HSTRING,
    policy: &windows_core::HSTRING,
    friendlymessage: &windows_core::HSTRING,
    ...
    unsafe {
        CheckGamingPrivilegeWithUI(
            ...
            core::mem::transmute_copy(scope),
            core::mem::transmute_copy(policy),
            core::mem::transmute_copy(friendlymessage),
            completionroutine,
...
) -> windows_core::Result<GAMING_DEVICE_MODEL_INFORMATION> {
...
pub unsafe fn ShowChangeFriendRelationshipUI(
    targetuserxuid: &windows_core::HSTRING,
    completionroutine: GameUICompletionRoutine,
    context: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        ShowChangeFriendRelationshipUI(
            core::mem::transmute_copy(targetuserxuid),
            completionroutine,
            context.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
...
#[inline]
pub unsafe fn ShowChangeFriendRelationshipUIForUser<P0>(
    user: P0,
    targetuserxuid: &windows_core::HSTRING,
    completionroutine: GameUICompletionRoutine,
    context: Option<*const core::ffi::c_void>,
...
#[inline]
pub unsafe fn ShowCustomizeUserProfileUIForUser<P0>(
    user: P0,
    completionroutine: GameUICompletionRoutine,
    context: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()>
...
#[inline]
pub unsafe fn ShowGameInfoUIForUser<P0>(
    user: P0,
    titleid: u32,
    completionroutine: GameUICompletionRoutine,
    context: Option<*const core::ffi::c_void>,
...
pub unsafe fn ShowGameInviteUI(
    serviceconfigurationid: &windows_core::HSTRING,
    sessiontemplatename: &windows_core::HSTRING,
    sessionid: &windows_core::HSTRING,
    invitationdisplaytext: &windows_core::HSTRING,
    completionroutine: GameUICompletionRoutine,
    context: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        ShowGameInviteUI(
            ...
            core::mem::transmute_copy(sessiontemplatename),
            core::mem::transmute_copy(sessionid),
            core::mem::transmute_copy(invitationdisplaytext),
            completionroutine,
            context.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
...
#[inline]
pub unsafe fn ShowGameInviteUIForUser<P0>(
    user: P0,
    serviceconfigurationid: &windows_core::HSTRING,
    sessiontemplatename: &windows_core::HSTRING,
    sessionid: &windows_core::HSTRING,
...
pub unsafe fn ShowGameInviteUIWithContext(
    ...
    sessionid: &windows_core::HSTRING,
    invitationdisplaytext: &windows_core::HSTRING,
    customactivationcontext: &windows_core::HSTRING,
    completionroutine: GameUICompletionRoutine,
    context: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        ShowGameInviteUIWithContext(
            ...
            core::mem::transmute_copy(sessionid),
            core::mem::transmute_copy(invitationdisplaytext),
            core::mem::transmute_copy(customactivationcontext),
            completionroutine,
            context.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
...
pub unsafe fn ShowPlayerPickerUI(
    promptdisplaytext: &windows_core::HSTRING,
    xuids: &[windows_core::HSTRING],
    preselectedxuids: Option<&[windows_core::HSTRING]>,
...
#[inline]
pub unsafe fn ShowUserSettingsUIForUser<P0>(
    user: P0,
    completionroutine: GameUICompletionRoutine,
    context: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()>
...
pub const GAMING_DEVICE_DEVICE_ID_XBOX_SERIES_S: GAMING_DEVICE_DEVICE_ID =
    GAMING_DEVICE_DEVICE_ID(489159355i32);
pub const GAMING_DEVICE_DEVICE_ID_XBOX_SERIES_X: GAMING_DEVICE_DEVICE_ID =
    GAMING_DEVICE_DEVICE_ID(796540415i32);
pub const GAMING_DEVICE_DEVICE_ID_XBOX_SERIES_X_DEVKIT: GAMING_DEVICE_DEVICE_ID =
    GAMING_DEVICE_DEVICE_ID(-561359263i32);
#[repr(C)]
...
pub const GameExplorer: windows_core::GUID =
    windows_core::GUID::from_u128(0x9a5ea990_3034_4d6f_9128_01f3c61022bc);
pub const GameStatistics: windows_core::GUID =
    windows_core::GUID::from_u128(0xdbc85a2c_c0dc_4961_b6e2_d28b62c11ad4);
pub type GameUICompletionRoutine = Option<
    unsafe extern "system" fn(returncode: windows_core::HRESULT, context: *const core::ffi::c_void),
>;
...
windows_core::imp::define_interface!(
    IGameExplorer,
    IGameExplorer_Vtbl,
    0xe7b2fb72_d728_49b3_a5f2_18ebf5f1349e
);
windows_core::imp::interface_hierarchy!(IGameExplorer, windows_core::IUnknown);
impl IGameExplorer {
    pub unsafe fn AddGame(
        &self,
        bstrgdfbinarypath: &windows_core::BSTR,
        bstrgameinstalldirectory: &windows_core::BSTR,
        installscope: GAME_INSTALL_SCOPE,
        pguidinstanceid: *mut windows_core::GUID,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddGame)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrgdfbinarypath),
                core::mem::transmute_copy(bstrgameinstalldirectory),
                installscope,
                pguidinstanceid as _,
            )
            .ok()
        }
    }
    pub unsafe fn RemoveGame(
        &self,
        guidinstanceid: windows_core::GUID,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveGame)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(guidinstanceid),
            )
            .ok()
        }
    }
    pub unsafe fn UpdateGame(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).UpdateGame)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(guidinstanceid),
            )
            .ok()
    ...
    pub unsafe fn VerifyAccess(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).VerifyAccess)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrgdfbinarypath),
                &mut result__,
            )
...
pub struct IGameExplorer_Vtbl {
    ...
    pub AddGame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        GAME_INSTALL_SCOPE,
    ...
    pub RemoveGame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub UpdateGame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub VerifyAccess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
impl IGameExplorer_Vtbl {
    pub const fn new<Identity: IGameExplorer_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddGame<Identity: IGameExplorer_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrgdfbinarypath: *mut core::ffi::c_void,
            bstrgameinstalldirectory: *mut core::ffi::c_void,
            installscope: GAME_INSTALL_SCOPE,
            pguidinstanceid: *mut windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
                ...
                IGameExplorer_Impl::AddGame(
                    this,
                    core::mem::transmute(&bstrgdfbinarypath),
                    core::mem::transmute(&bstrgameinstalldirectory),
                    core::mem::transmute_copy(&installscope),
                    core::mem::transmute_copy(&pguidinstanceid),
                )
                .into()
            }
        }
        unsafe extern "system" fn RemoveGame<Identity: IGameExplorer_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            guidinstanceid: windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn UpdateGame<Identity: IGameExplorer_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            guidinstanceid: windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn VerifyAccess<
            Identity: IGameExplorer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrgdfbinarypath: *mut core::ffi::c_void,
            pfhasaccess: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IGameExplorer_Impl::VerifyAccess(
                    this,
                    core::mem::transmute(&bstrgdfbinarypath),
                ) {
                    Ok(ok__) => {
...
impl IGameExplorer2 {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).InstallGame)(
                windows_core::Interface::as_raw(self),
                binarygdfpath.param().abi(),
                installdirectory.param().abi(),
                installscope,
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).UninstallGame)(
                windows_core::Interface::as_raw(self),
                binarygdfpath.param().abi(),
            )
            .ok()
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CheckAccess)(
                windows_core::Interface::as_raw(self),
                binarygdfpath.param().abi(),
                &mut result__,
            )
...
pub struct IGameExplorer2_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub InstallGame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        GAME_INSTALL_SCOPE,
    ) -> windows_core::HRESULT,
    pub UninstallGame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
...
pub trait IGameExplorer2_Impl: windows_core::IUnknownImpl {
    fn InstallGame(
        &self,
        binarygdfpath: &windows_core::PCWSTR,
        installdirectory: &windows_core::PCWSTR,
        installscope: GAME_INSTALL_SCOPE,
    ) -> windows_core::Result<()>;
...
impl IGameExplorer2_Vtbl {
    pub const fn new<Identity: IGameExplorer2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn InstallGame<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGameExplorer2_Impl::InstallGame(
                    this,
                    core::mem::transmute(&binarygdfpath),
                    core::mem::transmute(&installdirectory),
                    core::mem::transmute_copy(&installscope),
                )
                .into()
            }
        }
        unsafe extern "system" fn UninstallGame<
            Identity: IGameExplorer2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGameExplorer2_Impl::UninstallGame(this, core::mem::transmute(&binarygdfpath))
                    .into()
            }
        }
        unsafe extern "system" fn CheckAccess<
            Identity: IGameExplorer2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            binarygdfpath: windows_core::PCWSTR,
            phasaccess: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x3887c9ca_04a0_42ae_bc4c_5fa6c7721145
);
...
impl IGameStatistics {
    pub unsafe fn GetMaxCategoryLength(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMaxCategoryLength)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetMaxNameLength(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMaxNameLength)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetMaxValueLength(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMaxValueLength)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetMaxCategories(&self) -> windows_core::Result<u16> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMaxCategories)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetMaxStatsPerCategory(&self) -> windows_core::Result<u16> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMaxStatsPerCategory)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetCategoryTitle<P1>(
        &self,
        categoryindex: u16,
        title: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetCategoryTitle)(
                windows_core::Interface::as_raw(self),
                categoryindex,
                title.param().abi(),
            )
    ...
    pub unsafe fn GetCategoryTitle(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCategoryTitle)(
                windows_core::Interface::as_raw(self),
                categoryindex,
                &mut result__,
            )
    ...
    pub unsafe fn GetStatistic(
        ...
        categoryindex: u16,
        statindex: u16,
        pname: Option<*mut windows_core::PWSTR>,
        pvalue: Option<*mut windows_core::PWSTR>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetStatistic)(
                windows_core::Interface::as_raw(self),
                categoryindex,
                statindex,
                pname.unwrap_or(core::mem::zeroed()) as _,
                pvalue.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn SetStatistic<P2, P3>(
        &self,
        categoryindex: u16,
        statindex: u16,
        name: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetStatistic)(
                windows_core::Interface::as_raw(self),
                categoryindex,
                statindex,
                name.param().abi(),
    ...
    pub unsafe fn SetLastPlayedCategory(&self, categoryindex: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLastPlayedCategory)(
                windows_core::Interface::as_raw(self),
                categoryindex,
            )
            .ok()
    ...
    pub unsafe fn GetLastPlayedCategory(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLastPlayedCategory)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IGameStatistics_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetMaxCategoryLength:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetMaxNameLength:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetMaxValueLength:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetMaxCategories:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u16) -> windows_core::HRESULT,
    pub GetMaxStatsPerCategory:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u16) -> windows_core::HRESULT,
    pub SetCategoryTitle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u16,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetCategoryTitle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u16,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetStatistic: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u16,
        u16,
        *mut windows_core::PWSTR,
    ...
    pub SetStatistic: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u16,
        u16,
        windows_core::PCWSTR,
...
impl IGameStatistics_Vtbl {
    pub const fn new<Identity: IGameStatistics_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetMaxCategoryLength<
        ...
        unsafe extern "system" fn GetMaxNameLength<
            Identity: IGameStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetMaxValueLength<
            Identity: IGameStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetMaxCategories<
            Identity: IGameStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetMaxStatsPerCategory<
            Identity: IGameStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetCategoryTitle<
            Identity: IGameStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGameStatistics_Impl::SetCategoryTitle(
                    this,
                    core::mem::transmute_copy(&categoryindex),
                    core::mem::transmute(&title),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetCategoryTitle<
            Identity: IGameStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            categoryindex: u16,
            ptitle: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IGameStatistics_Impl::GetCategoryTitle(
                    this,
                    core::mem::transmute_copy(&categoryindex),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetStatistic<
            Identity: IGameStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGameStatistics_Impl::GetStatistic(
                    this,
                    core::mem::transmute_copy(&categoryindex),
                    core::mem::transmute_copy(&statindex),
        ...
        unsafe extern "system" fn SetStatistic<
            Identity: IGameStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGameStatistics_Impl::SetStatistic(
                    this,
                    core::mem::transmute_copy(&categoryindex),
                    core::mem::transmute_copy(&statindex),
        ...
        unsafe extern "system" fn Save<Identity: IGameStatistics_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            trackchanges: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetLastPlayedCategory<
            Identity: IGameStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGameStatistics_Impl::SetLastPlayedCategory(
                    this,
                    core::mem::transmute_copy(&categoryindex),
                )
                .into()
        ...
        unsafe extern "system" fn GetLastPlayedCategory<
            Identity: IGameStatistics_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl IGameStatisticsMgr {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetGameStatistics)(
                windows_core::Interface::as_raw(self),
                gdfbinarypath.param().abi(),
                opentype,
                popenresult as _,
                core::mem::transmute(ppistats),
            )
            .ok()
        }
    }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveGameStatistics)(
                windows_core::Interface::as_raw(self),
                gdfbinarypath.param().abi(),
            )
            .ok()
...
pub struct IGameStatisticsMgr_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetGameStatistics: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        GAMESTATS_OPEN_TYPE,
    ...
    pub RemoveGameStatistics: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
}
pub trait IGameStatisticsMgr_Impl: windows_core::IUnknownImpl {
    fn GetGameStatistics(
        &self,
        gdfbinarypath: &windows_core::PCWSTR,
        opentype: GAMESTATS_OPEN_TYPE,
        popenresult: *mut GAMESTATS_OPEN_RESULT,
        ppistats: windows_core::OutRef<'_, IGameStatistics>,
    ) -> windows_core::Result<()>;
...
impl IGameStatisticsMgr_Vtbl {
    pub const fn new<Identity: IGameStatisticsMgr_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetGameStatistics<
        ...
        >(
            ...
            opentype: GAMESTATS_OPEN_TYPE,
            popenresult: *mut GAMESTATS_OPEN_RESULT,
            ppistats: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGameStatisticsMgr_Impl::GetGameStatistics(
                    this,
                    core::mem::transmute(&gdfbinarypath),
                    core::mem::transmute_copy(&opentype),
                    core::mem::transmute_copy(&popenresult),
                    core::mem::transmute_copy(&ppistats),
                )
                .into()
            }
        }
        unsafe extern "system" fn RemoveGameStatistics<
            Identity: IGameStatisticsMgr_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGameStatisticsMgr_Impl::RemoveGameStatistics(
                    this,
                    core::mem::transmute(&gdfbinarypath),
                )
                .into()
...
impl IXblIdpAuthManager {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetGamerAccount)(
                windows_core::Interface::as_raw(self),
                msaaccountid.param().abi(),
                xuid.param().abi(),
            )
            .ok()
        }
    ...
    pub unsafe fn GetGamerAccount(
        &self,
        msaaccountid: *mut windows_core::PWSTR,
        xuid: *mut windows_core::PWSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetGamerAccount)(
                windows_core::Interface::as_raw(self),
                msaaccountid as _,
                xuid as _,
            )
    ...
    pub unsafe fn SetAppViewInitialized<P0, P1>(
        &self,
        appsid: P0,
        msaaccountid: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetAppViewInitialized)(
                windows_core::Interface::as_raw(self),
                appsid.param().abi(),
                msaaccountid.param().abi(),
            )
    ...
    pub unsafe fn GetEnvironment(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEnvironment)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetSandbox(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSandbox)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetTokenAndSignatureWithTokenResult<P0, P1, P2, P3, P4, P5, P6>(
        &self,
        msaaccountid: P0,
        appsid: P1,
        msatarget: P2,
...
pub struct IXblIdpAuthManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetGamerAccount: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetGamerAccount: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub SetAppViewInitialized: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetEnvironment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetSandbox: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetTokenAndSignatureWithTokenResult: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
pub trait IXblIdpAuthManager_Impl: windows_core::IUnknownImpl {
    fn SetGamerAccount(
        &self,
        msaaccountid: &windows_core::PCWSTR,
        xuid: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    fn GetGamerAccount(
        &self,
        msaaccountid: *mut windows_core::PWSTR,
    ...
    fn GetTokenAndSignatureWithTokenResult(
        ...
        msaaccountid: &windows_core::PCWSTR,
        appsid: &windows_core::PCWSTR,
        msatarget: &windows_core::PCWSTR,
        msapolicy: &windows_core::PCWSTR,
        httpmethod: &windows_core::PCWSTR,
        uri: &windows_core::PCWSTR,
        headers: &windows_core::PCWSTR,
        body: *const u8,
        bodysize: u32,
        forcerefresh: windows_core::BOOL,
    ) -> windows_core::Result<IXblIdpAuthTokenResult>;
}
impl IXblIdpAuthManager_Vtbl {
    pub const fn new<Identity: IXblIdpAuthManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetGamerAccount<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IXblIdpAuthManager_Impl::SetGamerAccount(
                    this,
                    core::mem::transmute(&msaaccountid),
                    core::mem::transmute(&xuid),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetGamerAccount<
            Identity: IXblIdpAuthManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IXblIdpAuthManager_Impl::GetGamerAccount(
                    this,
                    core::mem::transmute_copy(&msaaccountid),
                    core::mem::transmute_copy(&xuid),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetAppViewInitialized<
            Identity: IXblIdpAuthManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IXblIdpAuthManager_Impl::SetAppViewInitialized(
                    this,
                    core::mem::transmute(&appsid),
                    core::mem::transmute(&msaaccountid),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetEnvironment<
            Identity: IXblIdpAuthManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            environment: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetSandbox<
            Identity: IXblIdpAuthManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            sandbox: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetTokenAndSignatureWithTokenResult<
            Identity: IXblIdpAuthManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IXblIdpAuthManager_Impl::GetTokenAndSignatureWithTokenResult(
                    this,
                    core::mem::transmute(&msaaccountid),
                    core::mem::transmute(&appsid),
                    core::mem::transmute(&msatarget),
                    core::mem::transmute(&msapolicy),
                    core::mem::transmute(&httpmethod),
                    core::mem::transmute(&uri),
                    core::mem::transmute(&headers),
                    core::mem::transmute_copy(&body),
                    core::mem::transmute_copy(&bodysize),
                    core::mem::transmute_copy(&forcerefresh),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            ...
            GetTokenAndSignatureWithTokenResult: GetTokenAndSignatureWithTokenResult::<
                Identity,
                OFFSET,
            >,
        }
...
windows_core::imp::define_interface!(
    ...
    0xbf8c0950_8389_43dd_9a76_a19728ec5dc5
);
windows_core::imp::interface_hierarchy!(IXblIdpAuthManager2, windows_core::IUnknown);
impl IXblIdpAuthManager2 {
    pub unsafe fn GetUserlessTokenAndSignatureWithTokenResult<P0, P1, P2, P3, P4, P5>(
        &self,
        appsid: P0,
        msatarget: P1,
        msapolicy: P2,
        ...
        P5: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetUserlessTokenAndSignatureWithTokenResult)(
                windows_core::Interface::as_raw(self),
                appsid.param().abi(),
                msatarget.param().abi(),
                msapolicy.param().abi(),
...
pub struct IXblIdpAuthManager2_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetUserlessTokenAndSignatureWithTokenResult:
...
impl IXblIdpAuthManager2_Vtbl {
    pub const fn new<Identity: IXblIdpAuthManager2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetUserlessTokenAndSignatureWithTokenResult<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IXblIdpAuthManager2_Impl::GetUserlessTokenAndSignatureWithTokenResult(
                    this,
                    core::mem::transmute(&appsid),
                    core::mem::transmute(&msatarget),
                    core::mem::transmute(&msapolicy),
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetUserlessTokenAndSignatureWithTokenResult:
                GetUserlessTokenAndSignatureWithTokenResult::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x46ce0225_f267_4d68_b299_b2762552dec1
);
...
impl IXblIdpAuthTokenResult {
    ...
    pub unsafe fn GetToken(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetToken)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetMsaAccountId(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMsaAccountId)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetXuid(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetXuid)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetGamertag(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetGamertag)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetAgeGroup(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAgeGroup)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetPrivileges(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPrivileges)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetMsaTarget(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMsaTarget)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetMsaPolicy(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMsaPolicy)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetMsaAppId(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMsaAppId)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetRedirect(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRedirect)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetHelpId(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetHelpId)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetEnforcementBans(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEnforcementBans)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetRestrictions(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRestrictions)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetTitleRestrictions(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTitleRestrictions)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IXblIdpAuthTokenResult_Vtbl {
    ...
    pub GetStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut XBL_IDP_AUTH_TOKEN_STATUS,
    ) -> windows_core::HRESULT,
    pub GetErrorCode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::HRESULT,
    ) -> windows_core::HRESULT,
    pub GetToken: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    ...
    pub GetMsaAccountId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetXuid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetGamertag: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetAgeGroup: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetPrivileges: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetMsaTarget: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetMsaPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetMsaAppId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetRedirect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    ...
    pub GetHelpId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetEnforcementBans: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetRestrictions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetTitleRestrictions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
}
...
impl IXblIdpAuthTokenResult_Vtbl {
    pub const fn new<Identity: IXblIdpAuthTokenResult_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            errorcode: *mut windows_core::HRESULT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetToken<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            token: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            signature: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetMsaAccountId<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetXuid<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetGamertag<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            gamertag: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetAgeGroup<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            agegroup: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetPrivileges<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            privileges: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetMsaTarget<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            msatarget: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetMsaPolicy<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            msapolicy: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetMsaAppId<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            msaappid: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetRedirect<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            redirect: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetHelpId<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            helpid: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetEnforcementBans<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            enforcementbans: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetRestrictions<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            restrictions: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetTitleRestrictions<
            Identity: IXblIdpAuthTokenResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            titlerestrictions: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x75d760b0_60b9_412d_994f_26b2cd5f7812
);
...
impl IXblIdpAuthTokenResult2 {
    pub unsafe fn GetModernGamertag(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetModernGamertag)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetModernGamertagSuffix(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetModernGamertagSuffix)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetUniqueModernGamertag(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetUniqueModernGamertag)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IXblIdpAuthTokenResult2_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetModernGamertag: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetModernGamertagSuffix: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetUniqueModernGamertag: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
}
...
impl IXblIdpAuthTokenResult2_Vtbl {
    pub const fn new<Identity: IXblIdpAuthTokenResult2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetModernGamertag<
        ...
        unsafe extern "system" fn GetModernGamertagSuffix<
            Identity: IXblIdpAuthTokenResult2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetUniqueModernGamertag<
            Identity: IXblIdpAuthTokenResult2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub type PlayerPickerUICompletionRoutine = Option<
    unsafe extern "system" fn(
        returncode: windows_core::HRESULT,
        context: *const core::ffi::c_void,
        selectedxuids: *const windows_core::HSTRING,
...
pub const XblIdpAuthManager: windows_core::GUID =
    windows_core::GUID::from_u128(0xce23534b_56d8_4978_86a2_7ee570640468);
pub const XblIdpAuthTokenResult: windows_core::GUID =
    windows_core::GUID::from_u128(0x9f493441_744a_410c_ae2b_9a22f7c7731f);

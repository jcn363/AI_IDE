...
pub unsafe fn CaptureInterfaceHardwareCrossTimestamp(
    interfaceluid: *const super::Ndis::NET_LUID_LH,
...
pub unsafe fn ConvertCompartmentGuidToId(
    compartmentguid: *const windows_core::GUID,
...
pub unsafe fn ConvertCompartmentIdToGuid(
    compartmentid: super::Ndis::NET_IF_COMPARTMENT_ID,
    compartmentguid: *mut windows_core::GUID,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn ConvertInterfaceAliasToLuid<P0>(
    interfacealias: P0,
    interfaceluid: *mut super::Ndis::NET_LUID_LH,
) -> super::super::Foundation::WIN32_ERROR
where
...
pub unsafe fn ConvertInterfaceGuidToLuid(
    interfaceguid: *const windows_core::GUID,
    interfaceluid: *mut super::Ndis::NET_LUID_LH,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn ConvertInterfaceLuidToAlias(
    ...
    unsafe {
        ConvertInterfaceLuidToAlias(
            interfaceluid,
            core::mem::transmute(interfacealias.as_ptr()),
            interfacealias.len().try_into().unwrap(),
        )
    }
}
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
...
pub unsafe fn ConvertInterfaceLuidToGuid(
    interfaceluid: *const super::Ndis::NET_LUID_LH,
    interfaceguid: *mut windows_core::GUID,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn ConvertInterfaceLuidToNameA(
    ...
    unsafe {
        ConvertInterfaceLuidToNameA(
            interfaceluid,
            core::mem::transmute(interfacename.as_ptr()),
            interfacename.len().try_into().unwrap(),
        )
    }
}
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
...
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
#[inline]
pub unsafe fn ConvertInterfaceNameToLuidW<P0>(
    interfacename: P0,
    interfaceluid: *mut super::Ndis::NET_LUID_LH,
) -> super::super::Foundation::WIN32_ERROR
where
...
#[inline]
pub unsafe fn CreateIpNetEntry2(
...
pub unsafe fn CreateSortedAddressPairs(
    sourceaddresslist: Option<*const super::super::Networking::WinSock::SOCKADDR_IN6>,
    ...
    unsafe {
        CreateSortedAddressPairs(
            sourceaddresslist.unwrap_or(core::mem::zeroed()) as _,
            sourceaddresscount,
            destinationaddresslist,
            destinationaddresscount,
            addresssortoptions,
            sortedaddresspairlist as _,
            sortedaddresspaircount as _,
        )
    }
}
#[cfg(all(
...
#[inline]
pub unsafe fn DeleteIpNetEntry2(
    row: *const MIB_IPNET_ROW2,
) -> super::super::Foundation::WIN32_ERROR {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn FlushIpNetTable2(
    family: super::super::Networking::WinSock::ADDRESS_FAMILY,
    interfaceindex: u32,
) -> super::super::Foundation::WIN32_ERROR {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn FlushIpPathTable(
    family: super::super::Networking::WinSock::ADDRESS_FAMILY,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn GetAdaptersAddresses(
    ...
    unsafe {
        GetAdaptersAddresses(
            ...
            adapteraddresses.unwrap_or(core::mem::zeroed()) as _,
            sizepointer as _,
        )
    }
}
#[inline]
pub unsafe fn GetAdaptersInfo(
    adapterinfo: Option<*mut IP_ADAPTER_INFO>,
    sizepointer: *mut u32,
) -> u32 {
    windows_link::link!("iphlpapi.dll" "system" fn GetAdaptersInfo(adapterinfo : *mut IP_ADAPTER_INFO, sizepointer : *mut u32) -> u32);
    unsafe {
        GetAdaptersInfo(
            adapterinfo.unwrap_or(core::mem::zeroed()) as _,
            sizepointer as _,
        )
    }
}
...
pub unsafe fn GetBestRoute(
    ...
    unsafe {
        GetBestRoute(
            dwdestaddr,
            dwsourceaddr.unwrap_or(core::mem::zeroed()) as _,
            pbestroute as _,
        )
    }
}
...
pub unsafe fn GetBestRoute2(
    interfaceluid: Option<*const super::Ndis::NET_LUID_LH>,
    interfaceindex: u32,
    sourceaddress: Option<*const super::super::Networking::WinSock::SOCKADDR_INET>,
    ...
    unsafe {
        GetBestRoute2(
            interfaceluid.unwrap_or(core::mem::zeroed()) as _,
            interfaceindex,
            sourceaddress.unwrap_or(core::mem::zeroed()) as _,
            destinationaddress,
            addresssortoptions,
            bestroute as _,
            bestsourceaddress as _,
        )
    }
}
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
...
pub unsafe fn GetExtendedTcpTable(
    ptcptable: Option<*mut core::ffi::c_void>,
    pdwsize: *mut u32,
    border: bool,
    ulaf: u32,
    ...
    unsafe {
        GetExtendedTcpTable(
            ptcptable.unwrap_or(core::mem::zeroed()) as _,
            pdwsize as _,
            border.into(),
            ulaf,
            tableclass,
...
pub unsafe fn GetExtendedUdpTable(
    pudptable: Option<*mut core::ffi::c_void>,
    pdwsize: *mut u32,
    border: bool,
    ulaf: u32,
    ...
    unsafe {
        GetExtendedUdpTable(
            pudptable.unwrap_or(core::mem::zeroed()) as _,
            pdwsize as _,
            border.into(),
            ulaf,
            tableclass,
...
pub unsafe fn GetIfTable(
    ...
    unsafe {
        GetIfTable(
            piftable.unwrap_or(core::mem::zeroed()) as _,
            pdwsize as _,
            border.into(),
        )
    }
...
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
#[inline]
pub unsafe fn GetInterfaceCurrentTimestampCapabilities(
    interfaceluid: *const super::Ndis::NET_LUID_LH,
    timestampcapabilites: *mut INTERFACE_TIMESTAMP_CAPABILITIES,
) -> u32 {
...
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
#[inline]
pub unsafe fn GetInterfaceHardwareTimestampCapabilities(
    interfaceluid: *const super::Ndis::NET_LUID_LH,
    timestampcapabilites: *mut INTERFACE_TIMESTAMP_CAPABILITIES,
) -> u32 {
...
#[inline]
pub unsafe fn GetInterfaceInfo(
    piftable: Option<*mut IP_INTERFACE_INFO>,
    dwoutbuflen: *mut u32,
) -> u32 {
...
pub unsafe fn GetIpAddrTable(
    ...
    unsafe {
        GetIpAddrTable(
            pipaddrtable.unwrap_or(core::mem::zeroed()) as _,
            pdwsize as _,
            border.into(),
        )
    }
...
#[inline]
pub unsafe fn GetIpForwardEntry2(
...
pub unsafe fn GetIpForwardTable(
    ...
    unsafe {
        GetIpForwardTable(
            pipforwardtable.unwrap_or(core::mem::zeroed()) as _,
            pdwsize as _,
            border.into(),
        )
    }
...
#[inline]
pub unsafe fn GetIpInterfaceEntry(
...
pub unsafe fn GetIpNetTable(
    ...
    unsafe {
        GetIpNetTable(
            ipnettable.unwrap_or(core::mem::zeroed()) as _,
            sizepointer as _,
            order.into(),
        )
    }
...
pub unsafe fn GetIpNetworkConnectionBandwidthEstimates(
    interfaceindex: u32,
    addressfamily: super::super::Networking::WinSock::ADDRESS_FAMILY,
...
) -> super::Ndis::NET_IF_COMPARTMENT_ID {
...
pub unsafe fn GetNetworkInformation(
    networkguid: *const windows_core::GUID,
    compartmentid: *mut u32,
    siteid: *mut u32,
    networkname: &mut [u16],
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        GetNetworkInformation(
            ...
            compartmentid as _,
            siteid as _,
            core::mem::transmute(networkname.as_ptr()),
            networkname.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn GetNetworkParams(
    pfixedinfo: Option<*mut FIXED_INFO_W2KSP1>,
    poutbuflen: *mut u32,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        GetNetworkParams(
            pfixedinfo.unwrap_or(core::mem::zeroed()) as _,
            poutbuflen as _,
        )
    }
}
...
pub unsafe fn GetPerAdapterInfo(
    ifindex: u32,
    pperadapterinfo: Option<*mut IP_PER_ADAPTER_INFO_W2KSP1>,
    poutbuflen: *mut u32,
) -> u32 {
    ...
    unsafe {
        GetPerAdapterInfo(
            ifindex,
            pperadapterinfo.unwrap_or(core::mem::zeroed()) as _,
            poutbuflen as _,
        )
    }
}
...
pub unsafe fn GetTcpTable(
    tcptable: Option<*mut MIB_TCPTABLE>,
    sizepointer: *mut u32,
    order: bool,
) -> u32 {
    ...
    unsafe {
        GetTcpTable(
            tcptable.unwrap_or(core::mem::zeroed()) as _,
            sizepointer as _,
            order.into(),
        )
    }
...
pub unsafe fn GetTcpTable2(
    tcptable: Option<*mut MIB_TCPTABLE2>,
    sizepointer: *mut u32,
    order: bool,
) -> u32 {
...
pub unsafe fn GetUdp6Table(
    ...
    unsafe {
        GetUdp6Table(
            udp6table.unwrap_or(core::mem::zeroed()) as _,
            sizepointer as _,
            order.into(),
        )
    }
...
pub unsafe fn GetUdpTable(
    ...
    unsafe {
        GetUdpTable(
            udptable.unwrap_or(core::mem::zeroed()) as _,
            sizepointer as _,
            order.into(),
        )
    }
...
pub unsafe fn GetUniDirectionalAdapterInfo(
    pipifinfo: Option<*mut IP_UNIDIRECTIONAL_ADAPTER_ADDRESS>,
    dwoutbuflen: *mut u32,
) -> u32 {
    ...
    unsafe {
        GetUniDirectionalAdapterInfo(
            pipifinfo.unwrap_or(core::mem::zeroed()) as _,
            dwoutbuflen as _,
        )
    }
}
...
pub unsafe fn Icmp6SendEcho2(
    icmphandle: super::super::Foundation::HANDLE,
    event: Option<super::super::Foundation::HANDLE>,
    apcroutine: super::super::System::IO::PIO_APC_ROUTINE,
    ...
    requestsize: u16,
    requestoptions: Option<*const IP_OPTION_INFORMATION>,
    ...
    unsafe {
        Icmp6SendEcho2(
            ...
            requestdata,
            requestsize,
            requestoptions.unwrap_or(core::mem::zeroed()) as _,
            replybuffer as _,
            replysize,
            timeout,
        )
...
#[inline]
pub unsafe fn NotifyIfTimestampConfigChange(
    callercontext: Option<*const core::ffi::c_void>,
    ...
    unsafe {
        NotifyIfTimestampConfigChange(
            callercontext.unwrap_or(core::mem::zeroed()) as _,
            callback,
            notificationhandle as _,
        )
    }
}
#[cfg(all(
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn ParseNetworkString<P0>(
    networkstring: P0,
    types: u32,
    addressinfo: Option<*mut NET_ADDRESS_INFO>,
    portnumber: Option<*mut u16>,
    prefixlength: Option<*mut u8>,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ParseNetworkString(
            networkstring.param().abi(),
            types,
            addressinfo.unwrap_or(core::mem::zeroed()) as _,
            portnumber.unwrap_or(core::mem::zeroed()) as _,
            prefixlength.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn PfAddFiltersToInterface(
    ...
    pfhandle: *mut *mut core::ffi::c_void,
) -> u32 {
...
pub unsafe fn PfRemoveFilterHandles(
    pinterface: *mut core::ffi::c_void,
    cfilters: u32,
    pvhandles: *mut *mut core::ffi::c_void,
) -> u32 {
...
pub unsafe fn PfTestPacket(
    pininterface: *mut core::ffi::c_void,
    poutinterface: *mut core::ffi::c_void,
    cbytes: u32,
    pbpacket: *mut u8,
...
pub unsafe fn ResolveNeighbor(
    ...
    physicaladdress: *mut core::ffi::c_void,
...
pub unsafe fn RestoreMediaSense(
    poverlapped: *const super::super::System::IO::OVERLAPPED,
    lpdwenablecount: Option<*mut u32>,
) -> u32 {
    ...
    unsafe {
        RestoreMediaSense(
            poverlapped,
            lpdwenablecount.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
#[inline]
pub unsafe fn SetCurrentThreadCompartmentId(
    compartmentid: super::Ndis::NET_IF_COMPARTMENT_ID,
) -> super::super::Foundation::WIN32_ERROR {
...
#[inline]
pub unsafe fn SetIpInterfaceEntry(
    row: *mut MIB_IPINTERFACE_ROW,
) -> super::super::Foundation::WIN32_ERROR {
...
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
#[inline]
pub unsafe fn SetNetworkInformation<P2>(
    networkguid: *const windows_core::GUID,
    compartmentid: super::Ndis::NET_IF_COMPARTMENT_ID,
    networkname: P2,
) -> super::super::Foundation::WIN32_ERROR
...
pub unsafe fn SetPerTcp6ConnectionEStats(
    ...
    unsafe {
        SetPerTcp6ConnectionEStats(
            row,
            estatstype,
            core::mem::transmute(rw.as_ptr()),
            rwversion,
            rw.len().try_into().unwrap(),
            offset,
        )
    }
}
...
pub type PINTERFACE_TIMESTAMP_CONFIG_CHANGE_CALLBACK =
    Option<unsafe extern "system" fn(callercontext: *const core::ffi::c_void)>;
#[cfg(all(
    feature = "Win32_NetworkManagement_Ndis",
    feature = "Win32_Networking_WinSock"
))]
pub type PIPFORWARD_CHANGE_CALLBACK = Option<
...
>;
#[cfg(feature = "Win32_Networking_WinSock")]
pub type PNETWORK_CONNECTIVITY_HINT_CHANGE_CALLBACK = Option<
    unsafe extern "system" fn(
        callercontext: *const core::ffi::c_void,
...
pub type PSTABLE_UNICAST_IPADDRESS_TABLE_CALLBACK = Option<
    unsafe extern "system" fn(
        callercontext: *const core::ffi::c_void,
        addresstable: *const MIB_UNICASTIPADDRESS_TABLE,
    ),
>;
pub type PTEREDO_PORT_CHANGE_CALLBACK = Option<
    unsafe extern "system" fn(
        callercontext: *const core::ffi::c_void,
        port: u16,
        notificationtype: MIB_NOTIFICATION_TYPE,
...
pub type PUNICAST_IPADDRESS_CHANGE_CALLBACK = Option<
    unsafe extern "system" fn(
        callercontext: *const core::ffi::c_void,
        row: *const MIB_UNICASTIPADDRESS_ROW,
        notificationtype: MIB_NOTIFICATION_TYPE,

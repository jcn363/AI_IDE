...
impl DRendezvousSessionEvents_Vtbl {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<DRendezvousSessionEvents as windows_core::Interface>::IID
...
windows_core::imp::define_interface!(
    ...
    0x4f4d070b_a275_49fb_b10d_8ec26387b50d
);
windows_core::imp::interface_hierarchy!(IRendezvousApplication, windows_core::IUnknown);
impl IRendezvousApplication {
    pub unsafe fn SetRendezvousSession<P0>(
        &self,
        prendezvoussession: P0,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetRendezvousSession)(
                windows_core::Interface::as_raw(self),
                prendezvoussession.param().abi(),
            )
            .ok()
        }
    }
...
pub struct IRendezvousApplication_Vtbl {
    ...
    pub SetRendezvousSession: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
pub trait IRendezvousApplication_Impl: windows_core::IUnknownImpl {
    fn SetRendezvousSession(
        &self,
        prendezvoussession: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
}
impl IRendezvousApplication_Vtbl {
    pub const fn new<Identity: IRendezvousApplication_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetRendezvousSession<
            Identity: IRendezvousApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            prendezvoussession: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRendezvousApplication_Impl::SetRendezvousSession(
                    this,
                    core::mem::transmute_copy(&prendezvoussession),
                )
                .into()
            }
        }
        Self {
            ...
            SetRendezvousSession: SetRendezvousSession::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x9ba4b1dd_8b0c_48b7_9e7c_2f25857c8df5
);
...
impl IRendezvousSession {
    ...
    pub unsafe fn RemoteUser(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RemoteUser)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
    ...
    pub unsafe fn SendContextData(
        &self,
        bstrdata: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SendContextData)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn Terminate(
        ...
        bstrappdata: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Terminate)(
                windows_core::Interface::as_raw(self),
                hr,
                core::mem::transmute_copy(bstrappdata),
            )
            .ok()
        }
    }
...
pub struct IRendezvousSession_Vtbl {
    ...
    pub State: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RENDEZVOUS_SESSION_STATE,
    ) -> windows_core::HRESULT,
    pub RemoteUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Flags: unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SendContextData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl IRendezvousSession_Vtbl {
    pub const fn new<Identity: IRendezvousSession_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn State<Identity: IRendezvousSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            psessionstate: *mut RENDEZVOUS_SESSION_STATE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn RemoteUser<
        ...
        unsafe extern "system" fn Flags<Identity: IRendezvousSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pflags: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SendContextData<
            Identity: IRendezvousSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRendezvousSession_Impl::SendContextData(this, core::mem::transmute(&bstrdata))
                    .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            hr: windows_core::HRESULT,
            bstrappdata: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRendezvousSession_Impl::Terminate(
                    this,
                    core::mem::transmute_copy(&hr),
                    core::mem::transmute(&bstrappdata),
                )
                .into()
            }
        }
...
pub const RendezvousApplication: windows_core::GUID =
    windows_core::GUID::from_u128(0x0b7e019a_b5de_47fa_8966_9082f82fb192);

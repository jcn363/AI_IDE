...
pub unsafe fn CryptSIPCreateIndirectData(
    ...
    unsafe {
        CryptSIPCreateIndirectData(psubjectinfo as _, pcbindirectdata as _, pindirectdata as _).ok()
    }
}
#[cfg(feature = "Win32_Security_Cryptography_Catalog")]
#[inline]
...
pub unsafe fn CryptSIPGetSealedDigest(
    ...
    unsafe {
        CryptSIPGetSealedDigest(
            ...
            pbdigest.unwrap_or(core::mem::zeroed()) as _,
            pcbdigest as _,
        )
    }
}
...
pub unsafe fn CryptSIPGetSignedDataMsg(
    ...
    unsafe {
        CryptSIPGetSignedDataMsg(
            psubjectinfo as _,
            pdwencodingtype as _,
            dwindex,
            pcbsigneddatamsg as _,
            pbsigneddatamsg as _,
        )
        .ok()
    }
}
...
pub unsafe fn CryptSIPLoad(
    pgsubject: *const windows_core::GUID,
    dwflags: u32,
...
#[inline]
pub unsafe fn CryptSIPRetrieveSubjectGuid<P0>(
    filename: P0,
    hfilein: super::super::super::Foundation::HANDLE,
    pgsubject: *mut windows_core::GUID,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn CryptSIPRetrieveSubjectGuidForCatalogFile<P0>(
    filename: P0,
    hfilein: super::super::super::Foundation::HANDLE,
    pgsubject: *mut windows_core::GUID,
) -> windows_core::Result<()>
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        CryptSIPRetrieveSubjectGuidForCatalogFile(filename.param().abi(), hfilein, pgsubject as _)
            .ok()
    }
}
#[cfg(feature = "Win32_Security_Cryptography_Catalog")]
...
>;
#[cfg(feature = "Win32_Security_Cryptography_Catalog")]
pub type pCryptSIPGetCaps = Option<
    unsafe extern "system" fn(
        psubjinfo: *const SIP_SUBJECTINFO,
        pcaps: *mut SIP_CAP_SET_V3,
    ) -> windows_core::BOOL,
>;
#[cfg(feature = "Win32_Security_Cryptography_Catalog")]
pub type pCryptSIPGetSealedDigest = Option<
    unsafe extern "system" fn(
        psubjectinfo: *const SIP_SUBJECTINFO,
        psig: *const u8,
        dwsig: u32,
...
>;
pub type pfnIsFileSupported = Option<
    unsafe extern "system" fn(
        hfile: super::super::super::Foundation::HANDLE,
        pgsubject: *mut windows_core::GUID,
    ) -> windows_core::BOOL,
>;
pub type pfnIsFileSupportedName = Option<
    unsafe extern "system" fn(

...
#[inline]
pub unsafe fn LdapMapErrorToWin32(
...
pub unsafe fn LdapUTF8ToUnicode(lpsrcstr: &[u8], lpdeststr: &mut [u16]) -> i32 {
    ...
    unsafe {
        LdapUTF8ToUnicode(
            core::mem::transmute(lpsrcstr.as_ptr()),
            lpsrcstr.len().try_into().unwrap(),
            core::mem::transmute(lpdeststr.as_ptr()),
            lpdeststr.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn ldap_add_extA<P1>(
    ld: *mut LDAP,
    dn: P1,
    attrs: *mut *mut LDAPModA,
    servercontrols: *mut *mut LDAPControlA,
...
#[inline]
pub unsafe fn ldap_add_extW<P1>(
    ld: *mut LDAP,
    dn: P1,
...
#[inline]
pub unsafe fn ldap_add_ext_s<P1>(
    ld: *mut LDAP,
    dn: P1,
    attrs: *mut *mut LDAPModA,
    servercontrols: *mut *mut LDAPControlA,
...
#[inline]
pub unsafe fn ldap_add_ext_sA<P1>(
    ld: *mut LDAP,
    dn: P1,
    attrs: *mut *mut LDAPModA,
    servercontrols: *mut *mut LDAPControlA,
...
#[inline]
pub unsafe fn ldap_add_ext_sW<P1>(
    ld: *mut LDAP,
    dn: P1,
    attrs: *mut *mut LDAPModW,
    servercontrols: *mut *mut LDAPControlW,
...
#[inline]
pub unsafe fn ldap_compare_ext<P1, P2, P3>(
    ld: *mut LDAP,
    dn: P1,
    attr: P2,
    value: P3,
...
#[inline]
pub unsafe fn ldap_compare_extA<P1, P2, P3>(
    ld: *mut LDAP,
    dn: P1,
    attr: P2,
    value: P3,
    data: Option<*const LDAP_BERVAL>,
    servercontrols: *mut *mut LDAPControlA,
    clientcontrols: *mut *mut LDAPControlA,
    messagenumber: *mut u32,
) -> u32
...
#[inline]
pub unsafe fn ldap_compare_extW<P1, P2, P3>(
    ld: *mut LDAP,
    dn: P1,
    attr: P2,
    value: P3,
...
#[inline]
pub unsafe fn ldap_compare_ext_s<P1, P2, P3>(
    ld: *mut LDAP,
    dn: P1,
    attr: P2,
    value: P3,
...
#[inline]
pub unsafe fn ldap_compare_ext_sA<P1, P2, P3>(
    ld: *mut LDAP,
    dn: P1,
    attr: P2,
    value: P3,
...
#[inline]
pub unsafe fn ldap_compare_ext_sW<P1, P2, P3>(
    ld: *mut LDAP,
    dn: P1,
    attr: P2,
    value: P3,
...
pub unsafe fn ldap_create_sort_control(
    ...
    unsafe {
        ldap_create_sort_control(externalhandle as _, sortkeys as _, iscritical, control as _)
    }
}
#[inline]
pub unsafe fn ldap_create_sort_controlA(
    ...
    unsafe {
        ldap_create_sort_controlA(externalhandle as _, sortkeys as _, iscritical, control as _)
    }
}
#[inline]
pub unsafe fn ldap_create_sort_controlW(
    ...
    unsafe {
        ldap_create_sort_controlW(externalhandle as _, sortkeys as _, iscritical, control as _)
    }
}
#[inline]
...
#[inline]
pub unsafe fn ldap_delete_ext<P1>(
    ld: *mut LDAP,
    dn: P1,
    servercontrols: *mut *mut LDAPControlA,
    clientcontrols: *mut *mut LDAPControlA,
...
#[inline]
pub unsafe fn ldap_delete_extA<P1>(
    ld: *mut LDAP,
    dn: P1,
    servercontrols: *mut *mut LDAPControlA,
    clientcontrols: *mut *mut LDAPControlA,
...
#[inline]
pub unsafe fn ldap_delete_extW<P1>(
    ld: *mut LDAP,
    dn: P1,
    servercontrols: *mut *mut LDAPControlW,
    clientcontrols: *mut *mut LDAPControlW,
...
#[inline]
pub unsafe fn ldap_delete_ext_s<P1>(
    ld: *mut LDAP,
    dn: P1,
    servercontrols: *mut *mut LDAPControlA,
    clientcontrols: *mut *mut LDAPControlA,
...
#[inline]
pub unsafe fn ldap_delete_ext_sA<P1>(
    ld: *mut LDAP,
    dn: P1,
    servercontrols: *mut *mut LDAPControlA,
    clientcontrols: *mut *mut LDAPControlA,
...
#[inline]
pub unsafe fn ldap_delete_ext_sW<P1>(
    ld: *mut LDAP,
    dn: P1,
    servercontrols: *mut *mut LDAPControlW,
    clientcontrols: *mut *mut LDAPControlW,
...
pub unsafe fn ldap_escape_filter_element(
    ...
    destfilterelement: Option<&mut [u8]>,
) -> u32 {
    ...
    unsafe {
        ldap_escape_filter_element(
            core::mem::transmute(sourcefilterelement.as_ptr()),
            sourcefilterelement.len().try_into().unwrap(),
            core::mem::transmute(
                destfilterelement
                    .as_deref()
...
pub unsafe fn ldap_escape_filter_elementW(
    sourcefilterelement: &[u8],
    destfilterelement: Option<windows_core::PWSTR>,
    destlength: u32,
) -> u32 {
    ...
    unsafe {
        ldap_escape_filter_elementW(
            core::mem::transmute(sourcefilterelement.as_ptr()),
            sourcefilterelement.len().try_into().unwrap(),
            destfilterelement.unwrap_or(core::mem::zeroed()) as _,
            destlength,
        )
    }
}
...
#[inline]
pub unsafe fn ldap_extended_operation<P1>(
    ld: *mut LDAP,
    oid: P1,
    data: *mut LDAP_BERVAL,
    servercontrols: *mut *mut LDAPControlA,
...
#[inline]
pub unsafe fn ldap_extended_operationA<P1>(
    ld: *mut LDAP,
    oid: P1,
    data: *mut LDAP_BERVAL,
    servercontrols: *mut *mut LDAPControlA,
...
#[inline]
pub unsafe fn ldap_extended_operationW<P1>(
    ld: *mut LDAP,
    oid: P1,
    data: *mut LDAP_BERVAL,
    servercontrols: *mut *mut LDAPControlW,
...
#[inline]
pub unsafe fn ldap_extended_operation_sA<P1>(
    externalhandle: *mut LDAP,
    oid: P1,
    data: *mut LDAP_BERVAL,
    servercontrols: *mut *mut LDAPControlA,
    clientcontrols: *mut *mut LDAPControlA,
    returnedoid: *mut windows_core::PSTR,
...
#[inline]
pub unsafe fn ldap_extended_operation_sW<P1>(
    externalhandle: *mut LDAP,
    oid: P1,
    data: *mut LDAP_BERVAL,
    servercontrols: *mut *mut LDAPControlW,
    clientcontrols: *mut *mut LDAPControlW,
    returnedoid: *mut windows_core::PWSTR,
    returneddata: *mut *mut LDAP_BERVAL,
) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn ldap_get_values<P2>(
    ld: *mut LDAP,
    entry: *mut LDAPMessage,
    attr: P2,
...
#[inline]
pub unsafe fn ldap_get_valuesA<P2>(
    ld: *mut LDAP,
    entry: *mut LDAPMessage,
    attr: P2,
) -> *mut windows_core::PSTR
...
#[inline]
pub unsafe fn ldap_get_valuesW<P2>(
    ld: *mut LDAP,
    entry: *mut LDAPMessage,
    attr: P2,
...
#[inline]
pub unsafe fn ldap_get_values_len<P2>(
    externalhandle: *mut LDAP,
...
#[inline]
pub unsafe fn ldap_get_values_lenA<P2>(
    externalhandle: *mut LDAP,
    message: *mut LDAPMessage,
    attr: P2,
) -> *mut *mut LDAP_BERVAL
...
#[inline]
pub unsafe fn ldap_get_values_lenW<P2>(
    externalhandle: *mut LDAP,
    message: *mut LDAPMessage,
    attr: P2,
) -> *mut *mut LDAP_BERVAL
...
#[inline]
pub unsafe fn ldap_modify_ext<P1>(
    ld: *mut LDAP,
    dn: P1,
...
#[inline]
pub unsafe fn ldap_modify_extA<P1>(
    ld: *mut LDAP,
    dn: P1,
    mods: *mut *mut LDAPModA,
    servercontrols: *mut *mut LDAPControlA,
...
#[inline]
pub unsafe fn ldap_modify_extW<P1>(
    ld: *mut LDAP,
    dn: P1,
...
#[inline]
pub unsafe fn ldap_modify_ext_s<P1>(
    ld: *mut LDAP,
    dn: P1,
    mods: *mut *mut LDAPModA,
    servercontrols: *mut *mut LDAPControlA,
...
#[inline]
pub unsafe fn ldap_modify_ext_sA<P1>(
    ld: *mut LDAP,
    dn: P1,
    mods: *mut *mut LDAPModA,
    servercontrols: *mut *mut LDAPControlA,
...
#[inline]
pub unsafe fn ldap_modify_ext_sW<P1>(
    ld: *mut LDAP,
    dn: P1,
    mods: *mut *mut LDAPModW,
    servercontrols: *mut *mut LDAPControlW,
...
#[inline]
pub unsafe fn ldap_modrdn<P1, P2>(
    externalhandle: *mut LDAP,
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        ldap_modrdn(
            externalhandle as _,
            distinguishedname.param().abi(),
            newdistinguishedname.param().abi(),
        )
    }
}
#[inline]
pub unsafe fn ldap_modrdn2<P1, P2>(
    externalhandle: *mut LDAP,
    distinguishedname: P1,
    newdistinguishedname: P2,
    deleteoldrdn: i32,
...
#[inline]
pub unsafe fn ldap_modrdn2A<P1, P2>(
    externalhandle: *mut LDAP,
    distinguishedname: P1,
    newdistinguishedname: P2,
    deleteoldrdn: i32,
...
#[inline]
pub unsafe fn ldap_modrdn2W<P1, P2>(
    externalhandle: *mut LDAP,
    distinguishedname: P1,
    newdistinguishedname: P2,
    deleteoldrdn: i32,
...
#[inline]
pub unsafe fn ldap_modrdn2_s<P1, P2>(
    externalhandle: *mut LDAP,
    distinguishedname: P1,
    newdistinguishedname: P2,
    deleteoldrdn: i32,
...
#[inline]
pub unsafe fn ldap_modrdn2_sW<P1, P2>(
    externalhandle: *mut LDAP,
    distinguishedname: P1,
    newdistinguishedname: P2,
    deleteoldrdn: i32,
...
#[inline]
pub unsafe fn ldap_modrdnA<P1, P2>(
    externalhandle: *mut LDAP,
    distinguishedname: P1,
    newdistinguishedname: P2,
) -> u32
...
#[inline]
pub unsafe fn ldap_modrdnW<P1, P2>(
    externalhandle: *mut LDAP,
    distinguishedname: P1,
    newdistinguishedname: P2,
) -> u32
...
#[inline]
pub unsafe fn ldap_modrdn_s<P1, P2>(
    externalhandle: *mut LDAP,
    distinguishedname: P1,
    newdistinguishedname: P2,
) -> u32
...
#[inline]
pub unsafe fn ldap_modrdn_sA<P1, P2>(
    externalhandle: *mut LDAP,
    distinguishedname: P1,
    newdistinguishedname: P2,
) -> u32
...
pub unsafe fn ldap_parse_extended_resultA(
    ...
    resultoid: Option<*mut windows_core::PSTR>,
    ...
    unsafe {
        ldap_parse_extended_resultA(
            connection as _,
            resultmessage as _,
            resultoid.unwrap_or(core::mem::zeroed()) as _,
            resultdata as _,
            freeit,
        )
    }
...
pub unsafe fn ldap_parse_extended_resultW(
    connection: *mut LDAP,
    resultmessage: *mut LDAPMessage,
    resultoid: Option<*mut windows_core::PWSTR>,
    resultdata: *mut *mut LDAP_BERVAL,
    freeit: bool,
) -> u32 {
...
pub unsafe fn ldap_parse_reference(
    connection: *mut LDAP,
    resultmessage: *mut LDAPMessage,
    referrals: *mut *mut windows_core::PSTR,
) -> u32 {
...
pub unsafe fn ldap_parse_referenceW(
    connection: *mut LDAP,
    resultmessage: *mut LDAPMessage,
    referrals: *mut *mut windows_core::PWSTR,
) -> u32 {
...
pub unsafe fn ldap_parse_result(
    ...
    resultmessage: *mut LDAPMessage,
    returncode: *mut u32,
    matcheddns: Option<*mut windows_core::PSTR>,
    errormessage: Option<*mut windows_core::PSTR>,
    referrals: Option<*mut *mut windows_core::PSTR>,
    ...
    unsafe {
        ldap_parse_result(
            ...
            resultmessage as _,
            returncode as _,
            matcheddns.unwrap_or(core::mem::zeroed()) as _,
            errormessage.unwrap_or(core::mem::zeroed()) as _,
            referrals.unwrap_or(core::mem::zeroed()) as _,
            servercontrols as _,
            freeit,
        )
    }
...
pub unsafe fn ldap_parse_resultA(
    ...
    matcheddns: Option<*mut windows_core::PSTR>,
    errormessage: Option<*mut windows_core::PSTR>,
    referrals: Option<*mut *mut *mut i8>,
    servercontrols: *mut *mut *mut LDAPControlA,
    freeit: bool,
) -> u32 {
...
pub unsafe fn ldap_parse_resultW(
    ...
    resultmessage: *mut LDAPMessage,
    returncode: *mut u32,
    matcheddns: Option<*mut windows_core::PWSTR>,
    errormessage: Option<*mut windows_core::PWSTR>,
    referrals: Option<*mut *mut *mut u16>,
...
pub unsafe fn ldap_parse_sort_control(
    ...
    control: *mut *mut LDAPControlA,
    result: *mut u32,
    attribute: *mut windows_core::PSTR,
) -> u32 {
...
pub unsafe fn ldap_parse_sort_controlA(
    ...
    control: *mut *mut LDAPControlA,
    result: *mut u32,
    attribute: Option<*mut windows_core::PSTR>,
) -> u32 {
    ...
    unsafe {
        ldap_parse_sort_controlA(
            ...
            control as _,
            result as _,
            attribute.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn ldap_parse_sort_controlW(
    ...
    control: *mut *mut LDAPControlW,
    result: *mut u32,
    attribute: Option<*mut windows_core::PWSTR>,
) -> u32 {
...
#[inline]
pub unsafe fn ldap_rename_ext<P1, P2, P3>(
    ld: *mut LDAP,
    dn: P1,
    newrdn: P2,
    newparent: P3,
...
#[inline]
pub unsafe fn ldap_rename_extA<P1, P2, P3>(
    ld: *mut LDAP,
    dn: P1,
    newrdn: P2,
    newparent: P3,
...
#[inline]
pub unsafe fn ldap_rename_extW<P1, P2, P3>(
    ld: *mut LDAP,
    dn: P1,
    newrdn: P2,
    newparent: P3,
...
#[inline]
pub unsafe fn ldap_rename_ext_s<P1, P2, P3>(
    ld: *mut LDAP,
    dn: P1,
    newrdn: P2,
    newparent: P3,
...
#[inline]
pub unsafe fn ldap_rename_ext_sA<P1, P2, P3>(
    ld: *mut LDAP,
    dn: P1,
    newrdn: P2,
    newparent: P3,
...
#[inline]
pub unsafe fn ldap_rename_ext_sW<P1, P2, P3>(
    ld: *mut LDAP,
    dn: P1,
    newrdn: P2,
    newparent: P3,
...
pub unsafe fn ldap_result(
    ...
    msgid: u32,
    all: u32,
    timeout: Option<*const LDAP_TIMEVAL>,
...
#[inline]
pub unsafe fn ldap_sasl_bind_sA<P1, P2>(
    externalhandle: *mut LDAP,
    distname: P1,
    authmechanism: P2,
    cred: *const LDAP_BERVAL,
...
#[inline]
pub unsafe fn ldap_sasl_bind_sW<P1, P2>(
    externalhandle: *mut LDAP,
    distname: P1,
    authmechanism: P2,
    cred: *const LDAP_BERVAL,
...
#[inline]
pub unsafe fn ldap_search<P1, P3>(
    ld: *mut LDAP,
    base: P1,
    scope: u32,
    filter: P3,
...
#[inline]
pub unsafe fn ldap_searchA<P1, P3>(
    ld: *mut LDAP,
    base: P1,
    scope: u32,
    filter: P3,
...
#[inline]
pub unsafe fn ldap_search_ext<P1, P3>(
    ld: *mut LDAP,
    base: P1,
    scope: u32,
    filter: P3,
    attrs: *const *const i8,
    attrsonly: u32,
    servercontrols: Option<*const *const LDAPControlA>,
    clientcontrols: Option<*const *const LDAPControlA>,
    timelimit: u32,
    sizelimit: u32,
    messagenumber: *mut u32,
) -> u32
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        ldap_search_ext(
            ...
            attrs,
            attrsonly,
            servercontrols.unwrap_or(core::mem::zeroed()) as _,
            clientcontrols.unwrap_or(core::mem::zeroed()) as _,
            timelimit,
            sizelimit,
            messagenumber as _,
        )
...
#[inline]
pub unsafe fn ldap_search_extA<P1, P3>(
    ld: *mut LDAP,
    base: P1,
    scope: u32,
    filter: P3,
...
#[inline]
pub unsafe fn ldap_search_ext_s<P1, P3>(
    ld: *mut LDAP,
    base: P1,
    scope: u32,
    filter: P3,
...
#[inline]
pub unsafe fn ldap_search_ext_sA<P1, P3>(
    ld: *mut LDAP,
    base: P1,
    scope: u32,
    filter: P3,
...
#[inline]
pub unsafe fn ldap_search_ext_sW<P1, P3>(
    ld: *mut LDAP,
    base: P1,
    scope: u32,
    filter: P3,
...
#[inline]
pub unsafe fn ldap_search_init_page<P1, P3>(
    externalhandle: *mut LDAP,
    distinguishedname: P1,
    scopeofsearch: u32,
    searchfilter: P3,
...
#[inline]
pub unsafe fn ldap_search_init_pageA<P1, P3>(
    externalhandle: *mut LDAP,
    distinguishedname: P1,
    scopeofsearch: u32,
    searchfilter: P3,
...
#[inline]
pub unsafe fn ldap_search_init_pageW<P1, P3>(
    externalhandle: *mut LDAP,
    distinguishedname: P1,
    scopeofsearch: u32,
    searchfilter: P3,
...
#[inline]
pub unsafe fn ldap_search_s<P1, P3>(
    ld: *mut LDAP,
    base: P1,
    scope: u32,
    filter: P3,
...
#[inline]
pub unsafe fn ldap_search_sA<P1, P3>(
    ld: *mut LDAP,
    base: P1,
    scope: u32,
    filter: P3,
...
#[inline]
pub unsafe fn ldap_search_st<P1, P3>(
    ld: *mut LDAP,
    base: P1,
    scope: u32,
    filter: P3,
...
#[inline]
pub unsafe fn ldap_search_stA<P1, P3>(
    ld: *mut LDAP,
    base: P1,
    scope: u32,
    filter: P3,
...
#[inline]
pub unsafe fn ldap_search_stW<P1, P3>(
    ld: *mut LDAP,
    base: P1,
    scope: u32,
    filter: P3,
...
pub type DEREFERENCECONNECTION = Option<
...
pub const LDAP_CAP_ACTIVE_DIRECTORY_ADAM_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1851");
pub const LDAP_CAP_ACTIVE_DIRECTORY_ADAM_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1851");
pub const LDAP_CAP_ACTIVE_DIRECTORY_LDAP_INTEG_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1791");
pub const LDAP_CAP_ACTIVE_DIRECTORY_LDAP_INTEG_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1791");
pub const LDAP_CAP_ACTIVE_DIRECTORY_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.800");
pub const LDAP_CAP_ACTIVE_DIRECTORY_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.800");
pub const LDAP_CAP_ACTIVE_DIRECTORY_PARTIAL_SECRETS_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1920");
pub const LDAP_CAP_ACTIVE_DIRECTORY_PARTIAL_SECRETS_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1920");
pub const LDAP_CAP_ACTIVE_DIRECTORY_V51_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1670");
pub const LDAP_CAP_ACTIVE_DIRECTORY_V51_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1670");
pub const LDAP_CAP_ACTIVE_DIRECTORY_V60_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1935");
pub const LDAP_CAP_ACTIVE_DIRECTORY_V60_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1935");
pub const LDAP_CAP_ACTIVE_DIRECTORY_V61_OID: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1935");
pub const LDAP_CAP_ACTIVE_DIRECTORY_V61_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1935");
pub const LDAP_CAP_ACTIVE_DIRECTORY_V61_R2_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2080");
pub const LDAP_CAP_ACTIVE_DIRECTORY_V61_R2_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2080");
pub const LDAP_CAP_ACTIVE_DIRECTORY_W8_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2237");
pub const LDAP_CAP_ACTIVE_DIRECTORY_W8_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2237");
...
pub const LDAP_CONTROL_REFERRALS_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.616");
pub const LDAP_CONTROL_VLVREQUEST: windows_core::PCSTR =
    windows_core::s!("2.16.840.1.113730.3.4.9");
pub const LDAP_CONTROL_VLVREQUEST_W: windows_core::PCWSTR =
    windows_core::w!("2.16.840.1.113730.3.4.9");
pub const LDAP_CONTROL_VLVRESPONSE: windows_core::PCSTR =
    windows_core::s!("2.16.840.1.113730.3.4.10");
pub const LDAP_CONTROL_VLVRESPONSE_W: windows_core::PCWSTR =
    windows_core::w!("2.16.840.1.113730.3.4.10");
...
pub const LDAP_MATCHING_RULE_BIT_AND: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.803");
pub const LDAP_MATCHING_RULE_BIT_AND_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.803");
pub const LDAP_MATCHING_RULE_BIT_OR: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.804");
pub const LDAP_MATCHING_RULE_BIT_OR_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.804");
pub const LDAP_MATCHING_RULE_DN_BINARY_COMPLEX: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2253");
pub const LDAP_MATCHING_RULE_DN_BINARY_COMPLEX_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2253");
pub const LDAP_MATCHING_RULE_TRANSITIVE_EVALUATION: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1941");
pub const LDAP_MATCHING_RULE_TRANSITIVE_EVALUATION_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1941");
...
pub const LDAP_OPATT_BECOME_DOM_MASTER: windows_core::PCSTR =
    windows_core::s!("becomeDomainMaster");
pub const LDAP_OPATT_BECOME_DOM_MASTER_W: windows_core::PCWSTR =
    windows_core::w!("becomeDomainMaster");
...
pub const LDAP_OPATT_BECOME_RID_MASTER_W: windows_core::PCWSTR =
    windows_core::w!("becomeRidMaster");
pub const LDAP_OPATT_BECOME_SCHEMA_MASTER: windows_core::PCSTR =
    windows_core::s!("becomeSchemaMaster");
pub const LDAP_OPATT_BECOME_SCHEMA_MASTER_W: windows_core::PCWSTR =
    windows_core::w!("becomeSchemaMaster");
pub const LDAP_OPATT_CONFIG_NAMING_CONTEXT: windows_core::PCSTR =
    windows_core::s!("configurationNamingContext");
pub const LDAP_OPATT_CONFIG_NAMING_CONTEXT_W: windows_core::PCWSTR =
    windows_core::w!("configurationNamingContext");
...
pub const LDAP_OPATT_DEFAULT_NAMING_CONTEXT: windows_core::PCSTR =
    windows_core::s!("defaultNamingContext");
pub const LDAP_OPATT_DEFAULT_NAMING_CONTEXT_W: windows_core::PCWSTR =
    windows_core::w!("defaultNamingContext");
...
pub const LDAP_OPATT_DO_GARBAGE_COLLECTION: windows_core::PCSTR =
    windows_core::s!("doGarbageCollection");
pub const LDAP_OPATT_DO_GARBAGE_COLLECTION_W: windows_core::PCWSTR =
    windows_core::w!("doGarbageCollection");
...
pub const LDAP_OPATT_FIXUP_INHERITANCE_W: windows_core::PCWSTR =
    windows_core::w!("fixupInheritance");
pub const LDAP_OPATT_HIGHEST_COMMITTED_USN: windows_core::PCSTR =
    windows_core::s!("highestCommitedUSN");
pub const LDAP_OPATT_HIGHEST_COMMITTED_USN_W: windows_core::PCWSTR =
    windows_core::w!("highestCommitedUSN");
pub const LDAP_OPATT_INVALIDATE_RID_POOL: windows_core::PCSTR =
    windows_core::s!("invalidateRidPool");
pub const LDAP_OPATT_INVALIDATE_RID_POOL_W: windows_core::PCWSTR =
    windows_core::w!("invalidateRidPool");
pub const LDAP_OPATT_LDAP_SERVICE_NAME: windows_core::PCSTR = windows_core::s!("ldapServiceName");
pub const LDAP_OPATT_LDAP_SERVICE_NAME_W: windows_core::PCWSTR =
    windows_core::w!("ldapServiceName");
...
pub const LDAP_OPATT_ROOT_DOMAIN_NAMING_CONTEXT: windows_core::PCSTR =
    windows_core::s!("rootDomainNamingContext");
pub const LDAP_OPATT_ROOT_DOMAIN_NAMING_CONTEXT_W: windows_core::PCWSTR =
    windows_core::w!("rootDomainNamingContext");
pub const LDAP_OPATT_SCHEMA_NAMING_CONTEXT: windows_core::PCSTR =
    windows_core::s!("schemaNamingContext");
pub const LDAP_OPATT_SCHEMA_NAMING_CONTEXT_W: windows_core::PCWSTR =
    windows_core::w!("schemaNamingContext");
pub const LDAP_OPATT_SCHEMA_UPDATE_NOW: windows_core::PCSTR = windows_core::s!("schemaUpdateNow");
pub const LDAP_OPATT_SCHEMA_UPDATE_NOW_W: windows_core::PCWSTR =
    windows_core::w!("schemaUpdateNow");
...
pub const LDAP_OPATT_SUBSCHEMA_SUBENTRY: windows_core::PCSTR =
    windows_core::s!("subschemaSubentry");
pub const LDAP_OPATT_SUBSCHEMA_SUBENTRY_W: windows_core::PCWSTR =
    windows_core::w!("subschemaSubentry");
pub const LDAP_OPATT_SUPPORTED_CAPABILITIES: windows_core::PCSTR =
    windows_core::s!("supportedCapabilities");
pub const LDAP_OPATT_SUPPORTED_CAPABILITIES_W: windows_core::PCWSTR =
    windows_core::w!("supportedCapabilities");
pub const LDAP_OPATT_SUPPORTED_CONTROL: windows_core::PCSTR = windows_core::s!("supportedControl");
pub const LDAP_OPATT_SUPPORTED_CONTROL_W: windows_core::PCWSTR =
    windows_core::w!("supportedControl");
pub const LDAP_OPATT_SUPPORTED_LDAP_POLICIES: windows_core::PCSTR =
    windows_core::s!("supportedLDAPPolicies");
pub const LDAP_OPATT_SUPPORTED_LDAP_POLICIES_W: windows_core::PCWSTR =
    windows_core::w!("supportedLDAPPolicies");
pub const LDAP_OPATT_SUPPORTED_LDAP_VERSION: windows_core::PCSTR =
    windows_core::s!("supportedLDAPVersion");
pub const LDAP_OPATT_SUPPORTED_LDAP_VERSION_W: windows_core::PCWSTR =
    windows_core::w!("supportedLDAPVersion");
pub const LDAP_OPATT_SUPPORTED_SASL_MECHANISM: windows_core::PCSTR =
    windows_core::s!("supportedSASLMechanisms");
pub const LDAP_OPATT_SUPPORTED_SASL_MECHANISM_W: windows_core::PCWSTR =
    windows_core::w!("supportedSASLMechanisms");
...
pub const LDAP_PAGED_RESULT_OID_STRING: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.319");
pub const LDAP_PAGED_RESULT_OID_STRING_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.319");
...
pub const LDAP_SEARCH_HINT_INDEX_ONLY_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2207");
pub const LDAP_SEARCH_HINT_INDEX_ONLY_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2207");
pub const LDAP_SEARCH_HINT_REQUIRED_INDEX_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2306");
pub const LDAP_SEARCH_HINT_REQUIRED_INDEX_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2306");
pub const LDAP_SEARCH_HINT_SOFT_SIZE_LIMIT_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2210");
pub const LDAP_SEARCH_HINT_SOFT_SIZE_LIMIT_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2210");
...
pub const LDAP_SERVER_BATCH_REQUEST_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2212");
pub const LDAP_SERVER_BATCH_REQUEST_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2212");
pub const LDAP_SERVER_BYPASS_QUOTA_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2256");
pub const LDAP_SERVER_BYPASS_QUOTA_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2256");
pub const LDAP_SERVER_CROSSDOM_MOVE_TARGET_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.521");
pub const LDAP_SERVER_CROSSDOM_MOVE_TARGET_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.521");
pub const LDAP_SERVER_DIRSYNC_EX_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2090");
pub const LDAP_SERVER_DIRSYNC_EX_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2090");
pub const LDAP_SERVER_DIRSYNC_OID: windows_core::PCSTR = windows_core::s!("1.2.840.113556.1.4.841");
pub const LDAP_SERVER_DIRSYNC_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.841");
pub const LDAP_SERVER_DN_INPUT_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2026");
pub const LDAP_SERVER_DN_INPUT_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2026");
pub const LDAP_SERVER_DOMAIN_SCOPE_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1339");
pub const LDAP_SERVER_DOMAIN_SCOPE_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1339");
pub const LDAP_SERVER_DOWN: LDAP_RETCODE = LDAP_RETCODE(81i32);
pub const LDAP_SERVER_EXPECTED_ENTRY_COUNT_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2211");
pub const LDAP_SERVER_EXPECTED_ENTRY_COUNT_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2211");
pub const LDAP_SERVER_EXTENDED_DN_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.529");
pub const LDAP_SERVER_EXTENDED_DN_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.529");
pub const LDAP_SERVER_FAST_BIND_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1781");
pub const LDAP_SERVER_FAST_BIND_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1781");
pub const LDAP_SERVER_FORCE_UPDATE_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1974");
pub const LDAP_SERVER_FORCE_UPDATE_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1974");
pub const LDAP_SERVER_GET_STATS_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.970");
pub const LDAP_SERVER_GET_STATS_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.970");
pub const LDAP_SERVER_LAZY_COMMIT_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.619");
pub const LDAP_SERVER_LAZY_COMMIT_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.619");
pub const LDAP_SERVER_LINK_TTL_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2309");
pub const LDAP_SERVER_LINK_TTL_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2309");
pub const LDAP_SERVER_NOTIFICATION_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.528");
pub const LDAP_SERVER_NOTIFICATION_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.528");
pub const LDAP_SERVER_PERMISSIVE_MODIFY_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1413");
pub const LDAP_SERVER_PERMISSIVE_MODIFY_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1413");
pub const LDAP_SERVER_POLICY_HINTS_DEPRECATED_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2066");
pub const LDAP_SERVER_POLICY_HINTS_DEPRECATED_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2066");
pub const LDAP_SERVER_POLICY_HINTS_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2239");
pub const LDAP_SERVER_POLICY_HINTS_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2239");
pub const LDAP_SERVER_QUOTA_CONTROL_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1852");
pub const LDAP_SERVER_QUOTA_CONTROL_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1852");
pub const LDAP_SERVER_RANGE_OPTION_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.802");
pub const LDAP_SERVER_RANGE_OPTION_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.802");
pub const LDAP_SERVER_RANGE_RETRIEVAL_NOERR_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1948");
pub const LDAP_SERVER_RANGE_RETRIEVAL_NOERR_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1948");
pub const LDAP_SERVER_RESP_SORT_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.474");
pub const LDAP_SERVER_RESP_SORT_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.474");
pub const LDAP_SERVER_SD_FLAGS_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.801");
pub const LDAP_SERVER_SD_FLAGS_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.801");
pub const LDAP_SERVER_SEARCH_HINTS_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2206");
pub const LDAP_SERVER_SEARCH_HINTS_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2206");
pub const LDAP_SERVER_SEARCH_OPTIONS_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1340");
pub const LDAP_SERVER_SEARCH_OPTIONS_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1340");
pub const LDAP_SERVER_SET_OWNER_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2255");
pub const LDAP_SERVER_SET_OWNER_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2255");
pub const LDAP_SERVER_SHOW_DEACTIVATED_LINK_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2065");
pub const LDAP_SERVER_SHOW_DEACTIVATED_LINK_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2065");
pub const LDAP_SERVER_SHOW_DELETED_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.417");
pub const LDAP_SERVER_SHOW_DELETED_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.417");
pub const LDAP_SERVER_SHOW_RECYCLED_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2064");
pub const LDAP_SERVER_SHOW_RECYCLED_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2064");
pub const LDAP_SERVER_SHUTDOWN_NOTIFY_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1907");
pub const LDAP_SERVER_SHUTDOWN_NOTIFY_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1907");
...
pub const LDAP_SERVER_TREE_DELETE_EX_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2204");
pub const LDAP_SERVER_TREE_DELETE_EX_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2204");
pub const LDAP_SERVER_TREE_DELETE_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.805");
pub const LDAP_SERVER_TREE_DELETE_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.805");
pub const LDAP_SERVER_UPDATE_STATS_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2205");
pub const LDAP_SERVER_UPDATE_STATS_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2205");
pub const LDAP_SERVER_VERIFY_NAME_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.1338");
pub const LDAP_SERVER_VERIFY_NAME_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.1338");
pub const LDAP_SERVER_WHO_AM_I_OID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.4203.1.11.3");
pub const LDAP_SERVER_WHO_AM_I_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.3.6.1.4.1.4203.1.11.3");
...
pub const LDAP_TTL_EXTENDED_OP_OID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.1466.101.119.1");
pub const LDAP_TTL_EXTENDED_OP_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.3.6.1.4.1.1466.101.119.1");
...
pub const LDAP_UPDATE_STATS_INVOCATIONID_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2209");
pub const LDAP_UPDATE_STATS_INVOCATIONID_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2209");
pub const LDAP_UPDATE_STATS_USN_OID: windows_core::PCSTR =
    windows_core::s!("1.2.840.113556.1.4.2208");
pub const LDAP_UPDATE_STATS_USN_OID_W: windows_core::PCWSTR =
    windows_core::w!("1.2.840.113556.1.4.2208");
...
pub type NOTIFYOFNEWCONNECTION = Option<
    unsafe extern "system" fn(
        primaryconnection: *mut LDAP,
        referralfromconnection: *mut LDAP,
        newdn: windows_core::PCWSTR,
        hostname: windows_core::PCSTR,
        newconnection: *mut LDAP,
        portnumber: u32,
        secauthidentity: *mut core::ffi::c_void,
        currentuser: *mut core::ffi::c_void,
...
pub type QUERYFORCONNECTION = Option<
    unsafe extern "system" fn(
        primaryconnection: *mut LDAP,
        referralfromconnection: *mut LDAP,
        newdn: windows_core::PCWSTR,
        ...
        portnumber: u32,
        secauthidentity: *mut core::ffi::c_void,
        currentusertoken: *mut core::ffi::c_void,
...
pub type VERIFYSERVERCERT = Option<
    unsafe extern "system" fn(
        connection: *mut LDAP,

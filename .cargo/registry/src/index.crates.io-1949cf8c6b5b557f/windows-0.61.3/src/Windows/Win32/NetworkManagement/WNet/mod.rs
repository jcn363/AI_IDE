...
pub unsafe fn NPAddConnection4(
    hwndowner: Option<super::super::Foundation::HWND>,
    lpnetresource: *const NETRESOURCEW,
    lpauthbuffer: Option<*const core::ffi::c_void>,
    cbauthbuffer: u32,
    dwflags: u32,
    lpuseoptions: Option<&[u8]>,
) -> u32 {
    ...
    unsafe {
        NPAddConnection4(
            hwndowner.unwrap_or(core::mem::zeroed()) as _,
            lpnetresource,
            lpauthbuffer.unwrap_or(core::mem::zeroed()) as _,
            cbauthbuffer,
            dwflags,
            core::mem::transmute(
                lpuseoptions
...
pub unsafe fn NPFormatNetworkName<P0>(
    lpremotename: P0,
    lpformattedname: windows_core::PWSTR,
    lpnlength: *mut u32,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NPFormatNetworkName(
            lpremotename.param().abi(),
            core::mem::transmute(lpformattedname),
            lpnlength as _,
            dwflags,
            dwavecharperline,
        )
...
#[inline]
pub unsafe fn NPGetConnection<P0>(
    lplocalname: P0,
    lpremotename: Option<windows_core::PWSTR>,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NPGetConnection(
            lplocalname.param().abi(),
            lpremotename.unwrap_or(core::mem::zeroed()) as _,
            lpnbufferlen as _,
        )
    }
}
...
#[inline]
pub unsafe fn NPGetPersistentUseOptionsForConnection<P0>(
    lpremotepath: P0,
    lpreaduseoptions: Option<&[u8]>,
    ...
    unsafe {
        NPGetPersistentUseOptionsForConnection(
            ...
            lpreaduseoptions
                .as_deref()
                .map_or(0, |slice| slice.len().try_into().unwrap()),
            lpwriteuseoptions as _,
            lpsizewriteuseoptions as _,
        )
    }
}
#[inline]
pub unsafe fn NPGetResourceInformation(
    ...
    lpbuffer: *mut core::ffi::c_void,
    lpbuffersize: *mut u32,
    lplpsystem: *mut windows_core::PWSTR,
) -> u32 {
...
#[inline]
pub unsafe fn NPGetUser<P0>(
    lpname: P0,
    lpusername: windows_core::PWSTR,
    lpnbufferlen: *mut u32,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn NPOpenEnum(
    ...
    dwtype: u32,
    dwusage: u32,
    lpnetresource: Option<*const NETRESOURCEW>,
    ...
    unsafe {
        NPOpenEnum(
            ...
            dwtype,
            dwusage,
            lpnetresource.unwrap_or(core::mem::zeroed()) as _,
            lphenum as _,
        )
    }
}
...
#[inline]
pub unsafe fn WNetAddConnection3A<P2, P3>(
    hwndowner: Option<super::super::Foundation::HWND>,
    lpnetresource: *const NETRESOURCEA,
    lppassword: P2,
    lpusername: P3,
...
pub unsafe fn WNetAddConnection4A(
    ...
    unsafe {
        WNetAddConnection4A(
            ...
            cbauthbuffer,
            dwflags,
            core::mem::transmute(lpuseoptions.as_ptr()),
            lpuseoptions.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn WNetAddConnectionA<P0, P1, P2>(
    lpremotename: P0,
    lppassword: P1,
    lplocalname: P2,
) -> super::super::Foundation::WIN32_ERROR
...
#[inline]
pub unsafe fn WNetCancelConnection2A<P0>(
    lpname: P0,
    dwflags: NET_CONNECT_FLAGS,
    fforce: bool,
) -> super::super::Foundation::WIN32_ERROR
...
#[inline]
pub unsafe fn WNetCancelConnectionA<P0>(
    lpname: P0,
    fforce: bool,
) -> super::super::Foundation::WIN32_ERROR
where
...
#[inline]
pub unsafe fn WNetCancelConnectionW<P0>(
    lpname: P0,
    fforce: bool,
) -> super::super::Foundation::WIN32_ERROR
where
...
#[inline]
pub unsafe fn WNetConnectionDialog1A(
    lpconndlgstruct: *mut CONNECTDLGSTRUCTA,
) -> super::super::Foundation::WIN32_ERROR {
...
#[inline]
pub unsafe fn WNetConnectionDialog1W(
    lpconndlgstruct: *mut CONNECTDLGSTRUCTW,
) -> super::super::Foundation::WIN32_ERROR {
...
#[inline]
pub unsafe fn WNetDisconnectDialog1A(
    lpconndlgstruct: *const DISCDLGSTRUCTA,
) -> super::super::Foundation::WIN32_ERROR {
...
#[inline]
pub unsafe fn WNetDisconnectDialog1W(
    lpconndlgstruct: *const DISCDLGSTRUCTW,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn WNetGetConnectionA<P0>(
    lplocalname: P0,
    lpremotename: Option<windows_core::PSTR>,
    lpnlength: *mut u32,
) -> super::super::Foundation::WIN32_ERROR
where
    P0: windows_core::Param<windows_core::PCSTR>,
...
pub unsafe fn WNetGetLastErrorA(
    ...
    unsafe {
        WNetGetLastErrorA(
            lperror as _,
            core::mem::transmute(lperrorbuf.as_ptr()),
            lperrorbuf.len().try_into().unwrap(),
            core::mem::transmute(lpnamebuf.as_ptr()),
            lpnamebuf.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
pub unsafe fn WNetGetProviderNameA(
    dwnettype: u32,
    lpprovidername: windows_core::PSTR,
    lpbuffersize: *mut u32,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        WNetGetProviderNameA(
            dwnettype,
            core::mem::transmute(lpprovidername),
            lpbuffersize as _,
        )
    }
}
...
pub unsafe fn WNetGetProviderNameW(
    dwnettype: u32,
    lpprovidername: windows_core::PWSTR,
    lpbuffersize: *mut u32,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn WNetGetResourceInformationA(
    ...
    lpbuffer: *mut core::ffi::c_void,
    lpcbbuffer: *mut u32,
    lplpsystem: *mut windows_core::PSTR,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn WNetOpenEnumA(
    ...
    lpnetresource: Option<*const NETRESOURCEA>,
    lphenum: *mut super::super::Foundation::HANDLE,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn WNetUseConnection4A(
    hwndowner: Option<super::super::Foundation::HWND>,
    lpnetresource: *const NETRESOURCEA,
    pauthbuffer: Option<*const core::ffi::c_void>,
    cbauthbuffer: u32,
    dwflags: u32,
    lpuseoptions: Option<&[u8]>,
    lpaccessname: Option<windows_core::PSTR>,
    lpbuffersize: Option<*mut u32>,
    lpresult: Option<*mut u32>,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        WNetUseConnection4A(
            hwndowner.unwrap_or(core::mem::zeroed()) as _,
            lpnetresource,
            pauthbuffer.unwrap_or(core::mem::zeroed()) as _,
            cbauthbuffer,
            dwflags,
            core::mem::transmute(
                lpuseoptions
            ...
            lpuseoptions
                .as_deref()
                .map_or(0, |slice| slice.len().try_into().unwrap()),
            lpaccessname.unwrap_or(core::mem::zeroed()) as _,
            lpbuffersize.unwrap_or(core::mem::zeroed()) as _,
            lpresult.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn WNetUseConnection4W(
    ...
    dwflags: u32,
    lpuseoptions: Option<&[u8]>,
    lpaccessname: Option<windows_core::PWSTR>,
    lpbuffersize: Option<*mut u32>,
    lpresult: Option<*mut u32>,
) -> super::super::Foundation::WIN32_ERROR {
...
#[inline]
pub unsafe fn WNetUseConnectionA<P2, P3>(
    hwndowner: Option<super::super::Foundation::HWND>,
    lpnetresource: *const NETRESOURCEA,
    lppassword: P2,
    lpuserid: P3,
...
#[inline]
pub unsafe fn WNetUseConnectionW<P2, P3>(
    hwndowner: Option<super::super::Foundation::HWND>,
    lpnetresource: *const NETRESOURCEW,
    lppassword: P2,
    lpuserid: P3,
...
pub type PF_NPAddConnection = Option<
    unsafe extern "system" fn(
        lpnetresource: *const NETRESOURCEW,
        lppassword: windows_core::PCWSTR,
        lpusername: windows_core::PCWSTR,
    ) -> u32,
>;
...
pub type PF_NPCancelConnection = Option<
    unsafe extern "system" fn(lpname: windows_core::PCWSTR, fforce: windows_core::BOOL) -> u32,
>;
pub type PF_NPCancelConnection2 = Option<
    unsafe extern "system" fn(
        lpname: windows_core::PCWSTR,
        fforce: windows_core::BOOL,
        dwflags: u32,
    ) -> u32,
>;
...
pub type PF_NPFMXEditPerm = Option<
    unsafe extern "system" fn(
        lpdrivename: windows_core::PCWSTR,
        hwndfmx: super::super::Foundation::HWND,
        ndialogtype: u32,
    ) -> u32,
>;
pub type PF_NPFMXGetPermCaps =
    Option<unsafe extern "system" fn(lpdrivename: windows_core::PCWSTR) -> u32>;
pub type PF_NPFMXGetPermHelp = Option<
    unsafe extern "system" fn(
        lpdrivename: windows_core::PCWSTR,
        ndialogtype: u32,
        fdirectory: windows_core::BOOL,
...
pub type PF_NPFormatNetworkName = Option<
    unsafe extern "system" fn(
        lpremotename: windows_core::PCWSTR,
        lpformattedname: windows_core::PWSTR,
        lpnlength: *mut u32,
        dwflags: u32,
        dwavecharperline: u32,
...
pub type PF_NPGetConnection = Option<
    unsafe extern "system" fn(
        lplocalname: windows_core::PCWSTR,
        lpremotename: windows_core::PWSTR,
        lpnbufferlen: *mut u32,
    ) -> u32,
>;
...
pub type PF_NPGetDirectoryType = Option<
    unsafe extern "system" fn(
        lpname: windows_core::PCWSTR,
        lptype: *const i32,
        bflushcache: windows_core::BOOL,
    ) -> u32,
>;
pub type PF_NPGetPersistentUseOptionsForConnection = Option<
    unsafe extern "system" fn(
        lpremotepath: windows_core::PCWSTR,
...
pub type PF_NPGetPropertyText = Option<
    unsafe extern "system" fn(
        ...
        npropsel: u32,
        lpname: windows_core::PCWSTR,
        lpbuttonname: windows_core::PWSTR,
        nbuttonnamelen: u32,
        ntype: u32,
    ) -> u32,
>;
...
pub type PF_NPGetUniversalName = Option<
    unsafe extern "system" fn(
        lplocalpath: windows_core::PCWSTR,
        dwinfolevel: u32,
        lpbuffer: *mut core::ffi::c_void,
...
pub type PF_NPLogonNotify = Option<
    unsafe extern "system" fn(
        ...
        lpauthentinfotype: windows_core::PCWSTR,
        lpauthentinfo: *const core::ffi::c_void,
        lppreviousauthentinfotype: windows_core::PCWSTR,
        lppreviousauthentinfo: *const core::ffi::c_void,
        lpstationname: windows_core::PCWSTR,
        stationhandle: *const core::ffi::c_void,
        lplogonscript: *mut windows_core::PWSTR,
    ) -> u32,
>;

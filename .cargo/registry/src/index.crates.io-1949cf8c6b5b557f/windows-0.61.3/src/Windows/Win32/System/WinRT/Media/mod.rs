pub const CLSID_AudioFrameNativeFactory: windows_core::GUID =
    windows_core::GUID::from_u128(0x16a0a3b9_9f65_4102_9367_2cda3a4f372a);
pub const CLSID_VideoFrameNativeFactory: windows_core::GUID =
    windows_core::GUID::from_u128(0xd194386a_04e3_4814_8100_b2b0ae6d78c7);
windows_core::imp::define_interface!(
    IAudioFrameNative,
    IAudioFrameNative_Vtbl,
    0x20be1e2e_930f_4746_9335_3c332f255093
);
...
impl IAudioFrameNative_Vtbl {
    pub const fn new<Identity: IAudioFrameNative_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetData<Identity: IAudioFrameNative_Impl, const OFFSET: isize>(
            ...
            unsafe {
                ...
                IAudioFrameNative_Impl::GetData(
                    this,
        ...
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IAudioFrameNative, OFFSET>(),
...
windows_core::imp::define_interface!(
    ...
    0x7bd67cf8_bf7d_43e6_af8d_b170ee0c0110
);
windows_core::imp::interface_hierarchy!(
    IAudioFrameNativeFactory,
    windows_core::IUnknown,
...
impl IAudioFrameNativeFactory {
    ...
    pub unsafe fn CreateFromMFSample<P0, T>(
        &self,
        data: P0,
        forcereadonly: bool,
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).CreateFromMFSample)(
                windows_core::Interface::as_raw(self),
                data.param().abi(),
                forcereadonly.into(),
                &T::IID,
...
pub struct IAudioFrameNativeFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Win32_Media_MediaFoundation")]
    pub CreateFromMFSample: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::BOOL,
        *const windows_core::GUID,
...
pub trait IAudioFrameNativeFactory_Impl: windows_core::IUnknownImpl {
    fn CreateFromMFSample(
        &self,
        data: windows_core::Ref<'_, super::super::super::Media::MediaFoundation::IMFSample>,
        forcereadonly: windows_core::BOOL,
        riid: *const windows_core::GUID,
        ppv: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
}
...
impl IAudioFrameNativeFactory_Vtbl {
    pub const fn new<Identity: IAudioFrameNativeFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateFromMFSample<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioFrameNativeFactory_Impl::CreateFromMFSample(
                    this,
                    core::mem::transmute_copy(&data),
                    core::mem::transmute_copy(&forcereadonly),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppv),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    0x26ba702b_314a_4620_aaf6_7a51aa58fa18
);
windows_core::imp::interface_hierarchy!(
    IVideoFrameNative,
    windows_core::IUnknown,
...
impl IVideoFrameNative_Vtbl {
    pub const fn new<Identity: IVideoFrameNative_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetData<Identity: IVideoFrameNative_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            riid: *const windows_core::GUID,
            ppv: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVideoFrameNative_Impl::GetData(
                    this,
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppv),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVideoFrameNative_Impl::GetDevice(
                    this,
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppv),
                )
...
windows_core::imp::define_interface!(
    ...
    0x69e3693e_8e1e_4e63_ac4c_7fdc21d9731d
);
windows_core::imp::interface_hierarchy!(
    IVideoFrameNativeFactory,
    windows_core::IUnknown,
...
impl IVideoFrameNativeFactory {
    #[cfg(feature = "Win32_Media_MediaFoundation")]
    pub unsafe fn CreateFromMFSample<P0, P6, T>(
        &self,
        data: P0,
        subtype: *const windows_core::GUID,
        width: u32,
        height: u32,
        forcereadonly: bool,
        mindisplayaperture: Option<*const super::super::super::Media::MediaFoundation::MFVideoArea>,
        device: P6,
    ) -> windows_core::Result<T>
    where
        P0: windows_core::Param<super::super::super::Media::MediaFoundation::IMFSample>,
        ...
        T: windows_core::Interface,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(self).CreateFromMFSample)(
                ...
                height,
                forcereadonly.into(),
                mindisplayaperture.unwrap_or(core::mem::zeroed()) as _,
                device.param().abi(),
                &T::IID,
                &mut result__,
            )
...
pub struct IVideoFrameNativeFactory_Vtbl {
    ...
    pub CreateFromMFSample: unsafe extern "system" fn(
        ...
        *const windows_core::GUID,
        ...
        u32,
        windows_core::BOOL,
        *const super::super::super::Media::MediaFoundation::MFVideoArea,
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IVideoFrameNativeFactory_Impl: windows_core::IUnknownImpl {
    fn CreateFromMFSample(
        ...
        device: windows_core::Ref<
            '_,
            super::super::super::Media::MediaFoundation::IMFDXGIDeviceManager,
        >,
        riid: *const windows_core::GUID,
        ppv: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: IVideoFrameNativeFactory_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVideoFrameNativeFactory_Impl::CreateFromMFSample(
                    this,
                    core::mem::transmute_copy(&data),
                    ...
                    core::mem::transmute_copy(&forcereadonly),
                    core::mem::transmute_copy(&mindisplayaperture),

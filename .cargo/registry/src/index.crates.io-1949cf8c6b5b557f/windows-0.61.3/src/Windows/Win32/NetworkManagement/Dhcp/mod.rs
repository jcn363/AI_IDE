#[inline]
pub unsafe fn DhcpAddFilterV4<P0>(
    serveripaddress: P0,
...
pub unsafe fn DhcpAddServer(
    flags: u32,
    idinfo: *mut core::ffi::c_void,
    newserver: *mut DHCPDS_SERVER,
    callbackfn: *mut core::ffi::c_void,
...
#[inline]
pub unsafe fn DhcpAuditLogGetParams<P0>(
    serveripaddress: P0,
    flags: u32,
    auditlogdir: *mut windows_core::PWSTR,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DhcpAuditLogGetParams(
            ...
            flags,
            auditlogdir as _,
            diskcheckinterval as _,
            maxlogfilessize as _,
            minspaceondisk as _,
        )
    }
}
...
#[inline]
pub unsafe fn DhcpCreateOptionV5<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
...
#[inline]
pub unsafe fn DhcpCreateSubnet<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
...
#[inline]
pub unsafe fn DhcpCreateSubnetV6<P0>(
    serveripaddress: P0,
    subnetaddress: DHCP_IPV6_ADDRESS,
...
#[inline]
pub unsafe fn DhcpCreateSubnetVQ<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
...
#[inline]
pub unsafe fn DhcpDeleteSubnetV6<P0>(
    serveripaddress: P0,
    subnetaddress: DHCP_IPV6_ADDRESS,
    forceflag: DHCP_FORCE_FLAG,
) -> u32
...
#[inline]
pub unsafe fn DhcpEnumClasses<P0>(
    serveripaddress: P0,
    reservedmustbezero: u32,
...
#[inline]
pub unsafe fn DhcpEnumClassesV6<P0>(
    serveripaddress: P0,
    reservedmustbezero: u32,
    resumehandle: *mut u32,
    preferredmaximum: u32,
...
#[inline]
pub unsafe fn DhcpEnumFilterV4<P0>(
    serveripaddress: P0,
...
#[inline]
pub unsafe fn DhcpEnumOptionValues<P0>(
    serveripaddress: P0,
...
#[inline]
pub unsafe fn DhcpEnumOptionValuesV5<P0, P2, P3>(
    serveripaddress: P0,
    flags: u32,
    classname: P2,
    vendorname: P3,
...
#[inline]
pub unsafe fn DhcpEnumOptionValuesV6<P0, P2, P3>(
    serveripaddress: P0,
    flags: u32,
    classname: P2,
    vendorname: P3,
...
#[inline]
pub unsafe fn DhcpEnumOptionsV5<P0, P2, P3>(
    serveripaddress: P0,
    flags: u32,
    classname: P2,
    vendorname: P3,
...
#[inline]
pub unsafe fn DhcpEnumSubnetClients<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
    resumehandle: *mut u32,
    preferredmaximum: u32,
...
#[inline]
pub unsafe fn DhcpEnumSubnetClientsFilterStatusInfo<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
    resumehandle: *mut u32,
    preferredmaximum: u32,
...
#[inline]
pub unsafe fn DhcpEnumSubnetClientsV4<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
    resumehandle: *mut u32,
    preferredmaximum: u32,
...
#[inline]
pub unsafe fn DhcpEnumSubnetClientsV5<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
    resumehandle: *mut u32,
    preferredmaximum: u32,
...
#[inline]
pub unsafe fn DhcpEnumSubnetClientsV6<P0>(
    serveripaddress: P0,
    subnetaddress: DHCP_IPV6_ADDRESS,
...
#[inline]
pub unsafe fn DhcpEnumSubnetClientsVQ<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
    resumehandle: *mut u32,
    preferredmaximum: u32,
...
#[inline]
pub unsafe fn DhcpEnumSubnetElements<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
...
#[inline]
pub unsafe fn DhcpEnumSubnetElementsV4<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
    enumelementtype: DHCP_SUBNET_ELEMENT_TYPE,
    resumehandle: *mut u32,
...
#[inline]
pub unsafe fn DhcpEnumSubnetElementsV5<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
    enumelementtype: DHCP_SUBNET_ELEMENT_TYPE,
    resumehandle: *mut u32,
...
#[inline]
pub unsafe fn DhcpEnumSubnetElementsV6<P0>(
    serveripaddress: P0,
    subnetaddress: DHCP_IPV6_ADDRESS,
...
#[inline]
pub unsafe fn DhcpEnumSubnets<P0>(
    serveripaddress: P0,
    resumehandle: *mut u32,
    preferredmaximum: u32,
...
#[inline]
pub unsafe fn DhcpEnumSubnetsV6<P0>(
    serveripaddress: P0,
    resumehandle: *mut u32,
    preferredmaximum: u32,
...
#[inline]
pub unsafe fn DhcpGetClassInfo<P0>(
    serveripaddress: P0,
    reservedmustbezero: u32,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DhcpGetClassInfo(
            serveripaddress.param().abi(),
            reservedmustbezero,
            partialclassinfo as _,
            filledclassinfo as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn DhcpGetClientInfoVQ<P0>(
    serveripaddress: P0,
    searchinfo: *const DHCP_SEARCH_INFO,
...
#[inline]
pub unsafe fn DhcpGetFilterV4<P0>(
    serveripaddress: P0,
...
#[inline]
pub unsafe fn DhcpGetOptionInfoV5<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
...
#[inline]
pub unsafe fn DhcpGetOptionInfoV6<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
...
#[inline]
pub unsafe fn DhcpGetOptionValueV5<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
...
#[inline]
pub unsafe fn DhcpGetOptionValueV6<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DhcpGetServerBindingInfoV6(serveripaddress.param().abi(), flags, bindelementsinfo as _)
    }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DhcpGetServerSpecificStrings(serveripaddress.param().abi(), serverspecificstrings as _)
    }
}
#[inline]
...
#[inline]
pub unsafe fn DhcpHlprAddV4PolicyCondition<P5>(
...
#[inline]
pub unsafe fn DhcpHlprCreateV4Policy<P0, P5>(
    policyname: P0,
    fglobalpolicy: bool,
    subnet: u32,
    processingorder: u32,
...
#[inline]
pub unsafe fn DhcpHlprCreateV4PolicyEx<P0, P5>(
    policyname: P0,
    fglobalpolicy: bool,
    subnet: u32,
    processingorder: u32,
...
#[inline]
pub unsafe fn DhcpModifyClass<P0>(
    serveripaddress: P0,
    reservedmustbezero: u32,
    classinfo: *mut DHCP_CLASS_INFO,
) -> u32
...
#[inline]
pub unsafe fn DhcpModifyClassV6<P0>(
    serveripaddress: P0,
    reservedmustbezero: u32,
    classinfo: *mut DHCP_CLASS_INFO_V6,
) -> u32
...
#[inline]
pub unsafe fn DhcpRemoveOptionV5<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
...
#[inline]
pub unsafe fn DhcpRemoveOptionV6<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
...
#[inline]
pub unsafe fn DhcpRemoveOptionValueV5<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
...
#[inline]
pub unsafe fn DhcpRemoveOptionValueV6<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
...
#[inline]
pub unsafe fn DhcpRemoveSubnetElementV4<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
...
#[inline]
pub unsafe fn DhcpRemoveSubnetElementV6<P0>(
    serveripaddress: P0,
    subnetaddress: DHCP_IPV6_ADDRESS,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DhcpRemoveSubnetElementV6(
            serveripaddress.param().abi(),
            core::mem::transmute(subnetaddress),
            removeelementinfo as _,
            forceflag,
        )
    }
}
#[inline]
pub unsafe fn DhcpRequestParams<P2, P8>(
    flags: u32,
    reserved: *mut core::ffi::c_void,
    adaptername: P2,
    classid: *mut DHCPCAPI_CLASSID,
    ...
    P8: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DhcpRequestParams(
            ...
            adaptername.param().abi(),
            classid as _,
            core::mem::transmute(sendparams),
            core::mem::transmute(recdparams),
            buffer as _,
            psize as _,
            requestidstr.param().abi(),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn DhcpScanDatabase<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
    fixflag: u32,
...
#[inline]
pub unsafe fn DhcpServerQueryDnsRegCredentials<P0>(
    serveripaddress: P0,
    uname: &mut [u16],
    domain: &mut [u16],
) -> u32
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DhcpServerQueryDnsRegCredentials(
            serveripaddress.param().abi(),
            uname.len().try_into().unwrap(),
            core::mem::transmute(uname.as_ptr()),
...
#[inline]
pub unsafe fn DhcpSetOptionInfo<P0>(
    serveripaddress: P0,
    optionid: u32,
    optioninfo: *const DHCP_OPTION,
) -> u32
...
#[inline]
pub unsafe fn DhcpSetOptionInfoV5<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
...
#[inline]
pub unsafe fn DhcpSetOptionInfoV6<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
...
#[inline]
pub unsafe fn DhcpSetOptionValueV5<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
...
#[inline]
pub unsafe fn DhcpSetOptionValueV6<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    classname: P3,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DhcpSetServerBindingInfoV6(serveripaddress.param().abi(), flags, bindelementinfo as _)
    }
}
#[inline]
...
#[inline]
pub unsafe fn DhcpV4AddPolicyRange<P0, P2>(
    serveripaddress: P0,
    subnetaddress: u32,
    policyname: P2,
    range: *const DHCP_IP_RANGE,
...
#[inline]
pub unsafe fn DhcpV4EnumPolicies<P0>(
    serveripaddress: P0,
    resumehandle: *mut u32,
    preferredmaximum: u32,
    fglobalpolicy: bool,
...
#[inline]
pub unsafe fn DhcpV4EnumPoliciesEx<P0>(
    serveripaddress: P0,
    resumehandle: *mut u32,
    preferredmaximum: u32,
    globalpolicy: bool,
...
#[inline]
pub unsafe fn DhcpV4EnumSubnetClients<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
    resumehandle: *mut u32,
    preferredmaximum: u32,
...
#[inline]
pub unsafe fn DhcpV4EnumSubnetClientsEx<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
    resumehandle: *mut u32,
    preferredmaximum: u32,
...
#[inline]
pub unsafe fn DhcpV4EnumSubnetReservations<P0>(
    serveripaddress: P0,
    subnetaddress: u32,
    resumehandle: *mut u32,
    preferredmaximum: u32,
...
#[inline]
pub unsafe fn DhcpV4FailoverAddScopeToRelationship<P0>(
    serveripaddress: P0,
...
#[inline]
pub unsafe fn DhcpV4FailoverEnumRelationship<P0>(
    serveripaddress: P0,
    resumehandle: *mut u32,
    preferredmaximum: u32,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DhcpV4FailoverEnumRelationship(
            ...
            preferredmaximum,
            prelationship as _,
            relationshipread as _,
            relationshiptotal as _,
        )
    }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DhcpV4FailoverGetAddressStatus(serveripaddress.param().abi(), subnetaddress, pstatus as _)
    }
}
#[inline]
pub unsafe fn DhcpV4FailoverGetClientInfo<P0>(
    serveripaddress: P0,
    searchinfo: *const DHCP_SEARCH_INFO,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DhcpV4FailoverGetClientInfo(serveripaddress.param().abi(), searchinfo, clientinfo as _)
    }
}
#[inline]
...
#[inline]
pub unsafe fn DhcpV4GetClientInfo<P0>(
    serveripaddress: P0,
    searchinfo: *const DHCP_SEARCH_INFO,
...
#[inline]
pub unsafe fn DhcpV4GetClientInfoEx<P0>(
    serveripaddress: P0,
    searchinfo: *const DHCP_SEARCH_INFO,
...
#[inline]
pub unsafe fn DhcpV4RemoveOptionValue<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    policyname: P3,
...
#[inline]
pub unsafe fn DhcpV4SetOptionValue<P0, P3, P4>(
    serveripaddress: P0,
    flags: u32,
    optionid: u32,
    policyname: P3,
...
#[inline]
pub unsafe fn DhcpV4SetPolicy<P0, P4>(
    serveripaddress: P0,
    fieldsmodified: u32,
    fglobalpolicy: bool,
    subnetaddress: u32,
...
#[inline]
pub unsafe fn DhcpV6GetFreeIPAddress<P0>(
    serveripaddress: P0,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DhcpV6GetFreeIPAddress(
            serveripaddress.param().abi(),
            core::mem::transmute(scopeid),
            core::mem::transmute(startip),
            core::mem::transmute(endip),
            numfreeaddrreq,
            ipaddrlist as _,
        )
    }
...
#[inline]
pub unsafe fn DhcpV6GetStatelessStatistics<P0>(
    serveripaddress: P0,
...
#[inline]
pub unsafe fn DhcpV6GetStatelessStoreParams<P0>(
    serveripaddress: P0,
    fserverlevel: bool,
    subnetaddress: DHCP_IPV6_ADDRESS,
...
#[inline]
pub unsafe fn DhcpV6SetStatelessStoreParams<P0>(
    serveripaddress: P0,
    fserverlevel: bool,
    subnetaddress: DHCP_IPV6_ADDRESS,
    fieldmodified: u32,
...
#[inline]
pub unsafe fn Dhcpv6RequestParams<P2>(
    forcenewinform: bool,
    reserved: *mut core::ffi::c_void,
    adaptername: P2,
    classid: *mut DHCPV6CAPI_CLASSID,
...
#[inline]
pub unsafe fn Dhcpv6RequestPrefix<P0>(
    adaptername: P0,
    pclassid: *mut DHCPV6CAPI_CLASSID,
    prefixleaseinfo: *mut DHCPV6PrefixLeaseInformation,
    pdwtimetowait: *mut u32,
...
pub const DHCP_CALLOUT_ENTRY_POINT: windows_core::PCSTR =
    windows_core::s!("DhcpServerCalloutEntry");
pub const DHCP_CALLOUT_LIST_KEY: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\DHCPServer\\Parameters");
...
pub type LPDHCP_CONTROL = Option<
    unsafe extern "system" fn(dwcontrolcode: u32, lpreserved: *mut core::ffi::c_void) -> u32,
>;
pub type LPDHCP_DELETE_CLIENT = Option<
...
>;
pub type LPDHCP_DROP_SEND = Option<
    unsafe extern "system" fn(
        packet: *mut *mut u8,
        packetsize: *mut u32,
        controlcode: u32,
        ipaddress: u32,
        reserved: *mut core::ffi::c_void,
        pktcontext: *mut core::ffi::c_void,
    ) -> u32,
>;
pub type LPDHCP_ENTRY_POINT_FUNC = Option<
    unsafe extern "system" fn(
        chaindlls: windows_core::PCWSTR,
        calloutversion: u32,
        callouttbl: *mut DHCP_CALLOUT_TABLE,
    ) -> u32,
>;
pub type LPDHCP_GIVE_ADDRESS = Option<
    unsafe extern "system" fn(
        packet: *mut u8,
        packetsize: u32,
        controlcode: u32,
...
>;
pub type LPDHCP_HANDLE_OPTIONS = Option<
    unsafe extern "system" fn(
        packet: *mut u8,
        packetsize: u32,
        reserved: *mut core::ffi::c_void,
...
>;
pub type LPDHCP_NEWPKT = Option<
    unsafe extern "system" fn(
        packet: *mut *mut u8,
        packetsize: *mut u32,
        ipaddress: u32,
        reserved: *mut core::ffi::c_void,
        pktcontext: *mut *mut core::ffi::c_void,
        processit: *mut windows_core::BOOL,
    ) -> u32,
>;
pub type LPDHCP_PROB = Option<
    unsafe extern "system" fn(
        packet: *mut u8,
        packetsize: u32,
        controlcode: u32,

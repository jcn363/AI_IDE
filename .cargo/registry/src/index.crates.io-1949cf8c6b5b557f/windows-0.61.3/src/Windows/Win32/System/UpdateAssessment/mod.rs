windows_core::imp::define_interface!(
    IWaaSAssessor,
    IWaaSAssessor_Vtbl,
    0x2347bbef_1a3b_45a4_902d_3e09c269b45e
);
...
impl IWaaSAssessor {
    pub unsafe fn GetOSUpdateAssessment(&self) -> windows_core::Result<OSUpdateAssessment> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).GetOSUpdateAssessment)(
...
pub struct IWaaSAssessor_Vtbl {
    ...
    pub GetOSUpdateAssessment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut OSUpdateAssessment,
...
impl IWaaSAssessor_Vtbl {
    pub const fn new<Identity: IWaaSAssessor_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetOSUpdateAssessment<
            Identity: IWaaSAssessor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            result: *mut OSUpdateAssessment,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        Self {
            ...
            GetOSUpdateAssessment: GetOSUpdateAssessment::<Identity, OFFSET>,
        }
    }
...
pub const UpdateAssessmentStatus_NotLatestDeferredFeature: UpdateAssessmentStatus =
    UpdateAssessmentStatus(5i32);
pub const UpdateAssessmentStatus_NotLatestDeferredQuality: UpdateAssessmentStatus =
    UpdateAssessmentStatus(6i32);
pub const UpdateAssessmentStatus_NotLatestEndOfSupport: UpdateAssessmentStatus =
    UpdateAssessmentStatus(3i32);
pub const UpdateAssessmentStatus_NotLatestHardRestriction: UpdateAssessmentStatus =
    UpdateAssessmentStatus(2i32);
pub const UpdateAssessmentStatus_NotLatestManaged: UpdateAssessmentStatus =
    UpdateAssessmentStatus(9i32);
pub const UpdateAssessmentStatus_NotLatestPausedFeature: UpdateAssessmentStatus =
    UpdateAssessmentStatus(7i32);
pub const UpdateAssessmentStatus_NotLatestPausedQuality: UpdateAssessmentStatus =
    UpdateAssessmentStatus(8i32);
pub const UpdateAssessmentStatus_NotLatestServicingTrain: UpdateAssessmentStatus =
    UpdateAssessmentStatus(4i32);
pub const UpdateAssessmentStatus_NotLatestSoftRestriction: UpdateAssessmentStatus =
    UpdateAssessmentStatus(1i32);
pub const UpdateAssessmentStatus_NotLatestTargetedVersion: UpdateAssessmentStatus =
    UpdateAssessmentStatus(11i32);
pub const UpdateAssessmentStatus_NotLatestUnknown: UpdateAssessmentStatus =
    UpdateAssessmentStatus(10i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const WaaSAssessor: windows_core::GUID =
    windows_core::GUID::from_u128(0x098ef871_fa9f_46af_8958_c083515d7c9c);

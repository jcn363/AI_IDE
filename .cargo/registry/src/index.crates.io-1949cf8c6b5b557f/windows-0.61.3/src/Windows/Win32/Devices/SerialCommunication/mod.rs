...
pub unsafe fn ComDBClaimPort(
    ...
    comnumber: u32,
    forceclaim: bool,
    forced: Option<*mut windows_core::BOOL>,
) -> i32 {
    windows_link::link!("msports.dll" "system" fn ComDBClaimPort(hcomdb : HCOMDB, comnumber : u32, forceclaim : windows_core::BOOL, forced : *mut windows_core::BOOL) -> i32);
    unsafe {
        ComDBClaimPort(
            hcomdb,
            comnumber,
            forceclaim.into(),
            forced.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn ComDBGetCurrentPortUsage(
    hcomdb: HCOMDB,
    ...
    unsafe {
        ComDBGetCurrentPortUsage(
            ...
            reporttype,
            maxportsreported.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub const DEVPKEY_DeviceInterface_Serial_PortName: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x4c6bf15c_4c03_4aac_91f5_64c0f852bcf4),
        pid: 4,
    };
pub const DEVPKEY_DeviceInterface_Serial_UsbProductId: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x4c6bf15c_4c03_4aac_91f5_64c0f852bcf4),
        pid: 3,
    };
pub const DEVPKEY_DeviceInterface_Serial_UsbVendorId: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x4c6bf15c_4c03_4aac_91f5_64c0f852bcf4),
        pid: 2,
    };
...
impl windows_core::Free for HCOMDB {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("msports.dll" "system" fn ComDBClose(hcomdb : *mut core::ffi::c_void) -> i32);
            unsafe {
                ComDBClose(self.0);
            }
        }
...
pub type PSERENUM_READPORT =
    Option<unsafe extern "system" fn(serportaddress: *const core::ffi::c_void) -> u8>;
pub type PSERENUM_WRITEPORT =
    Option<unsafe extern "system" fn(serportaddress: *const core::ffi::c_void, value: u8)>;
#[repr(transparent)]

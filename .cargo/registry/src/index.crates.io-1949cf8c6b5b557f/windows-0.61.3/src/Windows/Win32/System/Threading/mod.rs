...
pub unsafe fn AddIntegrityLabelToBoundaryDescriptor(
    ...
    integritylabel: super::super::Security::PSID,
) -> windows_core::Result<()> {
...
pub unsafe fn AddSIDToBoundaryDescriptor(
    boundarydescriptor: *mut super::super::Foundation::HANDLE,
    requiredsid: super::super::Security::PSID,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn AvQuerySystemResponsiveness(
    avrthandle: super::super::Foundation::HANDLE,
...
#[inline]
pub unsafe fn AvRevertMmThreadCharacteristics(
    avrthandle: super::super::Foundation::HANDLE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn AvRtCreateThreadOrderingGroup(
    context: *mut super::super::Foundation::HANDLE,
    period: *const i64,
    threadorderingguid: *mut windows_core::GUID,
...
#[inline]
pub unsafe fn AvRtCreateThreadOrderingGroupExW<P4>(
    context: *mut super::super::Foundation::HANDLE,
    period: *const i64,
    threadorderingguid: *mut windows_core::GUID,
    timeout: Option<*const i64>,
...
#[inline]
pub unsafe fn AvRtDeleteThreadOrderingGroup(
...
#[inline]
pub unsafe fn AvRtJoinThreadOrderingGroup(
    context: *mut super::super::Foundation::HANDLE,
    threadorderingguid: *const windows_core::GUID,
    before: bool,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn AvRtLeaveThreadOrderingGroup(
    context: super::super::Foundation::HANDLE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn AvRtWaitOnThreadOrderingGroup(
    context: super::super::Foundation::HANDLE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn AvSetMmMaxThreadCharacteristicsA<P0, P1>(
    firsttask: P0,
    secondtask: P1,
    taskindex: *mut u32,
...
#[inline]
pub unsafe fn AvSetMmThreadPriority(
    avrthandle: super::super::Foundation::HANDLE,
...
#[inline]
pub unsafe fn CancelTimerQueueTimer(
    timerqueue: Option<super::super::Foundation::HANDLE>,
...
pub unsafe fn ChangeTimerQueueTimer(
    ...
    unsafe {
        ChangeTimerQueueTimer(
            timerqueue.unwrap_or(core::mem::zeroed()) as _,
            timer as _,
            duetime,
            period,
        )
...
pub unsafe fn CloseThreadpoolCleanupGroupMembers(
    ...
    pvcleanupcontext: Option<*mut core::ffi::c_void>,
) {
    ...
    unsafe {
        CloseThreadpoolCleanupGroupMembers(
            ptpcg,
            fcancelpendingcallbacks.into(),
            pvcleanupcontext.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn ConvertThreadToFiber(
    lpparameter: Option<*const core::ffi::c_void>,
) -> *mut core::ffi::c_void {
...
#[inline]
pub unsafe fn CreateBoundaryDescriptorW<P0>(
    name: P0,
    flags: u32,
...
pub unsafe fn CreateEventA<P3>(
    lpeventattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
    bmanualreset: bool,
    binitialstate: bool,
    lpname: P3,
) -> windows_core::Result<super::super::Foundation::HANDLE>
...
pub unsafe fn CreateFiber(
    ...
    unsafe {
        CreateFiber(
            dwstacksize,
            lpstartaddress,
            lpparameter.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn CreateMutexA<P2>(
    lpmutexattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
    binitialowner: bool,
    lpname: P2,
) -> windows_core::Result<super::super::Foundation::HANDLE>
where
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn CreateMutexExA<P1>(
    lpmutexattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
    lpname: P1,
    dwflags: u32,
    dwdesiredaccess: u32,
...
pub unsafe fn CreatePrivateNamespaceA<P2>(
    lpprivatenamespaceattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
    lpboundarydescriptor: *const core::ffi::c_void,
    lpaliasprefix: P2,
) -> windows_core::Result<super::super::Foundation::HANDLE>
where
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    let result__ = unsafe {
        CreatePrivateNamespaceA(
            lpprivatenamespaceattributes.unwrap_or(core::mem::zeroed()) as _,
            lpboundarydescriptor,
            lpaliasprefix.param().abi(),
        )
    };
    (!result__.is_invalid())
        .then_some(result__)
...
pub unsafe fn CreateProcessA<P0, P7>(
    ...
    lpcommandline: Option<windows_core::PSTR>,
    lpprocessattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
...
pub unsafe fn CreateRemoteThread(
    ...
    let result__ = unsafe {
        CreateRemoteThread(
            ...
            lpparameter.unwrap_or(core::mem::zeroed()) as _,
            dwcreationflags,
            lpthreadid.unwrap_or(core::mem::zeroed()) as _,
        )
    };
    (!result__.is_invalid())
        .then_some(result__)
...
pub unsafe fn CreateRemoteThreadEx(
    ...
    let result__ = unsafe {
        CreateRemoteThreadEx(
            ...
            lpparameter.unwrap_or(core::mem::zeroed()) as _,
            dwcreationflags,
            lpattributelist.unwrap_or(core::mem::zeroed()) as _,
            lpthreadid.unwrap_or(core::mem::zeroed()) as _,
        )
    };
    (!result__.is_invalid())
...
pub unsafe fn CreateSemaphoreA<P3>(
    lpsemaphoreattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
    linitialcount: i32,
    lmaximumcount: i32,
    lpname: P3,
) -> windows_core::Result<super::super::Foundation::HANDLE>
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    let result__ = unsafe {
        CreateSemaphoreA(
            lpsemaphoreattributes.unwrap_or(core::mem::zeroed()) as _,
            linitialcount,
            lmaximumcount,
            lpname.param().abi(),
        )
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn CreateSemaphoreExA<P3>(
    lpsemaphoreattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
    linitialcount: i32,
    lmaximumcount: i32,
    lpname: P3,
...
pub unsafe fn CreateTimerQueueTimer(
    ...
    parameter: Option<*const core::ffi::c_void>,
    duetime: u32,
    period: u32,
    ...
    unsafe {
        CreateTimerQueueTimer(
            ...
            timerqueue.unwrap_or(core::mem::zeroed()) as _,
            callback,
            parameter.unwrap_or(core::mem::zeroed()) as _,
            duetime,
            period,
            flags,
        )
...
pub unsafe fn CreateUmsCompletionList(
    umscompletionlist: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn CreateUmsThreadContext(
    lpumsthread: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn CreateWaitableTimerA<P2>(
    lptimerattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
    bmanualreset: bool,
    lptimername: P2,
) -> super::super::Foundation::HANDLE
where
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CreateWaitableTimerA(
            lptimerattributes.unwrap_or(core::mem::zeroed()) as _,
            bmanualreset.into(),
            lptimername.param().abi(),
        )
    }
}
#[cfg(feature = "Win32_Security")]
...
pub unsafe fn DeleteSynchronizationBarrier(
    lpbarrier: *mut SYNCHRONIZATION_BARRIER,
) -> windows_core::BOOL {
...
pub unsafe fn DeleteTimerQueueEx(
    timerqueue: super::super::Foundation::HANDLE,
    completionevent: Option<super::super::Foundation::HANDLE>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        DeleteTimerQueueEx(
            timerqueue,
            completionevent.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn DeleteUmsCompletionList(
    umscompletionlist: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn DeleteUmsThreadContext(
    umsthread: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn DequeueUmsCompletionListItems(
    umscompletionlist: *const core::ffi::c_void,
    waittimeout: u32,
    umsthreadlist: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
    ...
    unsafe {
        DequeueUmsCompletionListItems(umscompletionlist, waittimeout, umsthreadlist as _).ok()
    }
}
#[inline]
...
pub unsafe fn FlsSetValue(
    dwflsindex: u32,
    lpflsdata: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
...
pub unsafe fn FreeLibraryWhenCallbackReturns(
    ...
    r#mod: super::super::Foundation::HMODULE,
) {
...
pub unsafe fn GetNumaNodeProcessorMask2(
    nodenumber: u16,
    processormasks: Option<&mut [super::SystemInformation::GROUP_AFFINITY]>,
...
pub unsafe fn GetProcessAffinityMask(
    ...
    unsafe {
        GetProcessAffinityMask(
            hprocess,
            lpprocessaffinitymask as _,
            lpsystemaffinitymask as _,
        )
        .ok()
    }
}
...
pub unsafe fn GetProcessDEPPolicy(
    hprocess: super::super::Foundation::HANDLE,
    lpflags: *mut u32,
    lppermanent: *mut windows_core::BOOL,
) -> windows_core::Result<()> {
...
pub unsafe fn GetProcessDefaultCpuSetMasks(
    ...
    cpusetmasks: Option<&mut [super::SystemInformation::GROUP_AFFINITY]>,
    requiredmaskcount: *mut u16,
) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn GetProcessHandleFromHwnd(
...
pub unsafe fn GetProcessPriorityBoost(
    hprocess: super::super::Foundation::HANDLE,
    pdisablepriorityboost: *mut windows_core::BOOL,
) -> windows_core::Result<()> {
...
pub unsafe fn GetSystemTimes(
    lpidletime: Option<*mut super::super::Foundation::FILETIME>,
    lpkerneltime: Option<*mut super::super::Foundation::FILETIME>,
    lpusertime: Option<*mut super::super::Foundation::FILETIME>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        GetSystemTimes(
            lpidletime.unwrap_or(core::mem::zeroed()) as _,
            lpkerneltime.unwrap_or(core::mem::zeroed()) as _,
            lpusertime.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn GetThreadIOPendingFlag(
    hthread: super::super::Foundation::HANDLE,
    lpioispending: *mut windows_core::BOOL,
) -> windows_core::Result<()> {
...
pub unsafe fn InitOnceBeginInitialize(
    ...
    dwflags: u32,
    fpending: *mut windows_core::BOOL,
    lpcontext: Option<*mut *mut core::ffi::c_void>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        InitOnceBeginInitialize(
            ...
            dwflags,
            fpending as _,
            lpcontext.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn InitOnceComplete(
    lpinitonce: *mut INIT_ONCE,
    dwflags: u32,
    lpcontext: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
...
pub unsafe fn InitOnceExecuteOnce(
    ...
    parameter: Option<*mut core::ffi::c_void>,
    context: Option<*mut *mut core::ffi::c_void>,
) -> windows_core::Result<()> {
...
pub unsafe fn IsProcessCritical(
    hprocess: super::super::Foundation::HANDLE,
    critical: *mut windows_core::BOOL,
) -> windows_core::Result<()> {
...
pub unsafe fn IsWow64Process(
    hprocess: super::super::Foundation::HANDLE,
    wow64process: *mut windows_core::BOOL,
) -> windows_core::Result<()> {
...
pub unsafe fn IsWow64Process2(
    hprocess: super::super::Foundation::HANDLE,
    pprocessmachine: *mut super::SystemInformation::IMAGE_FILE_MACHINE,
...
#[inline]
pub unsafe fn OpenPrivateNamespaceA<P1>(
    lpboundarydescriptor: *const core::ffi::c_void,
    lpaliasprefix: P1,
) -> super::super::Foundation::HANDLE
where
...
#[inline]
pub unsafe fn OpenPrivateNamespaceW<P1>(
    lpboundarydescriptor: *const core::ffi::c_void,
    lpaliasprefix: P1,
) -> super::super::Foundation::HANDLE
where
...
#[inline]
pub unsafe fn OpenSemaphoreW<P2>(
    dwdesiredaccess: SYNCHRONIZATION_ACCESS_RIGHTS,
    binherithandle: bool,
    lpname: P2,
) -> windows_core::Result<super::super::Foundation::HANDLE>
...
#[inline]
pub unsafe fn OpenWaitableTimerW<P2>(
    dwdesiredaccess: SYNCHRONIZATION_ACCESS_RIGHTS,
    binherithandle: bool,
    lptimername: P2,
) -> windows_core::Result<super::super::Foundation::HANDLE>
...
pub unsafe fn QueryProcessAffinityUpdateMode(
    hprocess: super::super::Foundation::HANDLE,
    lpdwflags: Option<*mut PROCESS_AFFINITY_AUTO_UPDATE_FLAGS>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        QueryProcessAffinityUpdateMode(hprocess, lpdwflags.unwrap_or(core::mem::zeroed()) as _).ok()
    }
}
#[inline]
pub unsafe fn QueryProtectedPolicy(
    policyguid: *const windows_core::GUID,
...
pub unsafe fn QueryUmsThreadInformation(
    ...
    umsthreadinformation: *mut core::ffi::c_void,
...
pub unsafe fn QueueUserAPC(
    pfnapc: super::super::Foundation::PAPCFUNC,
    hthread: super::super::Foundation::HANDLE,
    dwdata: usize,
) -> u32 {
...
pub unsafe fn QueueUserAPC2(
    apcroutine: super::super::Foundation::PAPCFUNC,
    thread: super::super::Foundation::HANDLE,
    data: usize,
...
pub unsafe fn ReleaseSemaphore(
    ...
    unsafe {
        ReleaseSemaphore(
            hsemaphore,
            lreleasecount,
            lppreviouscount.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn RtwqAllocateWorkQueue(
    ...
    P5: windows_core::Param<windows_core::IUnknown>,
{
    ...
    unsafe {
        RtwqBeginRegisterWorkQueueWithMMCSS(
            workqueueid,
            usageclass.param().abi(),
            dwtaskid,
            lpriority,
            donecallback.param().abi(),
            donestate.param().abi(),
        )
        .ok()
    }
...
#[inline]
pub unsafe fn RtwqCancelDeadline(
    prequest: super::super::Foundation::HANDLE,
) -> windows_core::Result<()> {
...
pub unsafe fn RtwqCreateAsyncResult<P0, P1, P2>(
    ...
    callback: P1,
    appstate: P2,
) -> windows_core::Result<IRtwqAsyncResult>
where
...
#[inline]
pub unsafe fn RtwqGetWorkQueueMMCSSClass(
    workqueueid: u32,
    usageclass: Option<windows_core::PWSTR>,
    usageclasslength: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        RtwqGetWorkQueueMMCSSClass(
            workqueueid,
            usageclass.unwrap_or(core::mem::zeroed()) as _,
            usageclasslength as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn RtwqJoinWorkQueue(
    workqueueid: u32,
    hfile: super::super::Foundation::HANDLE,
) -> windows_core::Result<super::super::Foundation::HANDLE> {
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        RtwqLockSharedWorkQueue(usageclass.param().abi(), basepriority, taskid as _, id as _).ok()
    }
}
#[inline]
...
#[inline]
pub unsafe fn RtwqPutWaitingWorkItem<P2>(
...
#[inline]
pub unsafe fn RtwqSetDeadline2(
    workqueueid: u32,
    deadlineinhns: i64,
    predeadlineinhns: i64,
) -> windows_core::Result<super::super::Foundation::HANDLE> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        RtwqSetDeadline2(workqueueid, deadlineinhns, predeadlineinhns, &mut result__)
            .map(|| result__)
    }
}
#[inline]
...
#[inline]
pub unsafe fn RtwqUnjoinWorkQueue(
    workqueueid: u32,
    hfile: super::super::Foundation::HANDLE,
) -> windows_core::Result<()> {
...
pub unsafe fn SetProcessDefaultCpuSetMasks(
    process: super::super::Foundation::HANDLE,
    cpusetmasks: Option<&[super::SystemInformation::GROUP_AFFINITY]>,
) -> windows_core::BOOL {
...
pub unsafe fn SetProcessDynamicEHContinuationTargets(
    process: super::super::Foundation::HANDLE,
    targets: &mut [PROCESS_DYNAMIC_EH_CONTINUATION_TARGET],
) -> windows_core::Result<()> {
    ...
    unsafe {
        SetProcessDynamicEHContinuationTargets(
            ...
            core::mem::transmute(targets.as_ptr()),
        )
        .ok()
    }
}
...
pub unsafe fn SetProcessWorkingSetSize(
    ...
    unsafe {
        SetProcessWorkingSetSize(hprocess, dwminimumworkingsetsize, dwmaximumworkingsetsize).ok()
    }
}
#[inline]
pub unsafe fn SetProtectedPolicy(
    policyguid: *const windows_core::GUID,
    policyvalue: usize,
    oldpolicyvalue: Option<*mut usize>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        SetProtectedPolicy(
            policyguid,
            policyvalue,
            oldpolicyvalue.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn SetThreadGroupAffinity(
    ...
    previousgroupaffinity: Option<*mut super::SystemInformation::GROUP_AFFINITY>,
) -> windows_core::BOOL {
    ...
    unsafe {
        SetThreadGroupAffinity(
            hthread,
            groupaffinity,
            previousgroupaffinity.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn SetThreadIdealProcessorEx(
    ...
    lppreviousidealprocessor: Option<*mut super::Kernel::PROCESSOR_NUMBER>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        SetThreadIdealProcessorEx(
            hthread,
            lpidealprocessor,
            lppreviousidealprocessor.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn SetThreadInformation(
    hthread: super::super::Foundation::HANDLE,
    threadinformationclass: THREAD_INFORMATION_CLASS,
    threadinformation: *const core::ffi::c_void,
    threadinformationsize: u32,
) -> windows_core::Result<()> {
...
pub unsafe fn SetThreadSelectedCpuSets(
    ...
    unsafe {
        SetThreadSelectedCpuSets(
            thread,
            core::mem::transmute(cpusetids.as_ptr()),
            cpusetids.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
pub unsafe fn SetThreadToken(
    thread: Option<*const super::super::Foundation::HANDLE>,
    token: Option<super::super::Foundation::HANDLE>,
) -> windows_core::Result<()> {
...
pub unsafe fn SetThreadpoolTimer(
    pti: PTP_TIMER,
    pftduetime: Option<*const super::super::Foundation::FILETIME>,
    msperiod: u32,
...
pub unsafe fn SetThreadpoolWait(
    pwa: PTP_WAIT,
    h: Option<super::super::Foundation::HANDLE>,
    pfttimeout: Option<*const super::super::Foundation::FILETIME>,
) {
    ...
    unsafe {
        SetThreadpoolWait(
            pwa,
            h.unwrap_or(core::mem::zeroed()) as _,
            pfttimeout.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn SetTimerQueueTimer(
    timerqueue: Option<super::super::Foundation::HANDLE>,
    callback: WAITORTIMERCALLBACK,
    parameter: Option<*const core::ffi::c_void>,
    duetime: u32,
...
pub unsafe fn SetUmsThreadInformation(
    umsthread: *const core::ffi::c_void,
    umsthreadinfoclass: UMS_THREAD_INFO_CLASS,
    umsthreadinformation: *const core::ffi::c_void,
    umsthreadinformationlength: u32,
) -> windows_core::Result<()> {
...
pub unsafe fn SetWaitableTimer(
    ...
    lpargtocompletionroutine: Option<*const core::ffi::c_void>,
    fresume: bool,
) -> windows_core::Result<()> {
    ...
    unsafe {
        SetWaitableTimer(
            ...
            lpargtocompletionroutine.unwrap_or(core::mem::zeroed()) as _,
            fresume.into(),
        )
        .ok()
    }
...
pub unsafe fn SetWaitableTimerEx(
    ...
    unsafe {
        SetWaitableTimerEx(
            ...
            pfncompletionroutine,
            lpargtocompletionroutine.unwrap_or(core::mem::zeroed()) as _,
            wakecontext.unwrap_or(core::mem::zeroed()) as _,
            tolerabledelay,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn SignalObjectAndWait(
    hobjecttosignal: super::super::Foundation::HANDLE,
    hobjecttowaiton: super::super::Foundation::HANDLE,
    dwmilliseconds: u32,
    balertable: bool,
...
pub unsafe fn SleepConditionVariableCS(
    ...
    unsafe {
        SleepConditionVariableCS(conditionvariable as _, criticalsection as _, dwmilliseconds).ok()
    }
}
#[inline]
pub unsafe fn SleepConditionVariableSRW(
    ...
    unsafe {
        SleepConditionVariableSRW(conditionvariable as _, srwlock as _, dwmilliseconds, flags).ok()
    }
}
#[inline]
...
pub unsafe fn TlsSetValue(
    dwtlsindex: u32,
    lptlsvalue: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
...
pub unsafe fn UpdateProcThreadAttribute(
    ...
    dwflags: u32,
    attribute: usize,
    lpvalue: Option<*const core::ffi::c_void>,
    cbsize: usize,
    lppreviousvalue: Option<*mut core::ffi::c_void>,
    ...
    unsafe {
        UpdateProcThreadAttribute(
            lpattributelist as _,
            dwflags,
            attribute,
            lpvalue.unwrap_or(core::mem::zeroed()) as _,
            cbsize,
            lppreviousvalue.unwrap_or(core::mem::zeroed()) as _,
            lpreturnsize.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WaitForMultipleObjects(
    lphandles: &[super::super::Foundation::HANDLE],
    bwaitall: bool,
    dwmilliseconds: u32,
) -> super::super::Foundation::WAIT_EVENT {
    ...
    unsafe {
        WaitForMultipleObjects(
            ...
            core::mem::transmute(lphandles.as_ptr()),
            bwaitall.into(),
            dwmilliseconds,
        )
    }
...
pub type APC_CALLBACK_FUNCTION = Option<
...
pub const EVENT_ALL_ACCESS: SYNCHRONIZATION_ACCESS_RIGHTS =
    SYNCHRONIZATION_ACCESS_RIGHTS(2031619u32);
...
windows_core::imp::define_interface!(
    ...
    0xa27003cf_2354_4f2a_8d6a_ab7cff15437e
);
...
pub trait IRtwqAsyncCallback_Impl: windows_core::IUnknownImpl {
    ...
    fn Invoke(
        &self,
        pasyncresult: windows_core::Ref<'_, IRtwqAsyncResult>,
    ) -> windows_core::Result<()>;
}
    ...
    pub const fn new<Identity: IRtwqAsyncCallback_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                IRtwqAsyncCallback_Impl::GetParameters(
                    this,
                    core::mem::transmute_copy(&pdwflags),
                    core::mem::transmute_copy(&pdwqueue),
                )
                .into()
            }
        }
        unsafe extern "system" fn Invoke<Identity: IRtwqAsyncCallback_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRtwqAsyncCallback_Impl::Invoke(this, core::mem::transmute_copy(&pasyncresult))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0xac6b7889_0740_4d51_8619_905994a55cc6
);
...
impl IRtwqAsyncResult {
    ...
    pub unsafe fn GetStateNoAddRef(&self) -> Option<windows_core::IUnknown> {
        unsafe {
            (windows_core::Interface::vtable(self).GetStateNoAddRef)(
                windows_core::Interface::as_raw(self),
            )
        }
    }
...
pub struct IRtwqAsyncResult_Vtbl {
    ...
    pub GetStateNoAddRef:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> Option<windows_core::IUnknown>,
}
...
impl IRtwqAsyncResult_Vtbl {
    pub const fn new<Identity: IRtwqAsyncResult_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetState<Identity: IRtwqAsyncResult_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppunkstate: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x63d9255a_7ff1_4b61_8faf_ed6460dacf2b
);
...
impl IRtwqPlatformEvents {
    pub unsafe fn InitializationComplete(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).InitializationComplete)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn ShutdownStart(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ShutdownStart)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn ShutdownComplete(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ShutdownComplete)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
impl IRtwqPlatformEvents_Vtbl {
    pub const fn new<Identity: IRtwqPlatformEvents_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn ShutdownStart<
            Identity: IRtwqPlatformEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ShutdownComplete<
            Identity: IRtwqPlatformEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub type LPFIBER_START_ROUTINE =
    Option<unsafe extern "system" fn(lpfiberparameter: *mut core::ffi::c_void)>;
#[repr(transparent)]
...
pub const MUTEX_ALL_ACCESS: SYNCHRONIZATION_ACCESS_RIGHTS =
    SYNCHRONIZATION_ACCESS_RIGHTS(2031617u32);
...
pub const PF_ARM_V83_JSCVT_INSTRUCTIONS_AVAILABLE: PROCESSOR_FEATURE_ID =
    PROCESSOR_FEATURE_ID(44u32);
pub const PF_ARM_V83_LRCPC_INSTRUCTIONS_AVAILABLE: PROCESSOR_FEATURE_ID =
    PROCESSOR_FEATURE_ID(45u32);
...
#[cfg(feature = "Win32_System_SystemServices")]
pub type PRTL_UMS_SCHEDULER_ENTRY_POINT = Option<
    unsafe extern "system" fn(
...
>;
pub type PTP_WIN32_IO_CALLBACK = Option<
    unsafe extern "system" fn(
        instance: PTP_CALLBACK_INSTANCE,
        context: *mut core::ffi::c_void,
...
pub type PTP_WORK_CALLBACK = Option<
    unsafe extern "system" fn(
        instance: PTP_CALLBACK_INSTANCE,
        context: *mut core::ffi::c_void,
        work: PTP_WORK,
...
pub const ProcThreadAttributeTrustedApp: PROC_THREAD_ATTRIBUTE_NUM =
    PROC_THREAD_ATTRIBUTE_NUM(29u32);
...
pub const ProcessActivationContextTrustPolicy: PROCESS_MITIGATION_POLICY =
    PROCESS_MITIGATION_POLICY(19i32);
...
pub const ProcessMaxOverridePrefetchParameter: PROCESS_INFORMATION_CLASS =
    PROCESS_INFORMATION_CLASS(11i32);
...
pub const ProcessOverrideSubsequentPrefetchParameter: PROCESS_INFORMATION_CLASS =
    PROCESS_INFORMATION_CLASS(10i32);
...
pub const ProcessUserPointerAuthPolicy: PROCESS_MITIGATION_POLICY =
    PROCESS_MITIGATION_POLICY(17i32);
pub const ProcessUserShadowStackPolicy: PROCESS_MITIGATION_POLICY =
    PROCESS_MITIGATION_POLICY(15i32);
pub const QUEUE_USER_APC_CALLBACK_DATA_CONTEXT: QUEUE_USER_APC_FLAGS =
    QUEUE_USER_APC_FLAGS(65536i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl RTWQASYNCRESULT_Vtbl {
    pub const fn new<Identity: RTWQASYNCRESULT_Impl, const OFFSET: isize>() -> Self {
        Self {
            base__: IRtwqAsyncResult_Vtbl::new::<Identity, OFFSET>(),
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub type RTWQPERIODICCALLBACK =
    Option<unsafe extern "system" fn(context: windows_core::Ref<'_, windows_core::IUnknown>)>;
...
pub const SYNCHRONIZATION_DELETE: SYNCHRONIZATION_ACCESS_RIGHTS =
    SYNCHRONIZATION_ACCESS_RIGHTS(65536u32);
pub const SYNCHRONIZATION_READ_CONTROL: SYNCHRONIZATION_ACCESS_RIGHTS =
    SYNCHRONIZATION_ACCESS_RIGHTS(131072u32);
pub const SYNCHRONIZATION_SYNCHRONIZE: SYNCHRONIZATION_ACCESS_RIGHTS =
    SYNCHRONIZATION_ACCESS_RIGHTS(1048576u32);
pub const SYNCHRONIZATION_WRITE_DAC: SYNCHRONIZATION_ACCESS_RIGHTS =
    SYNCHRONIZATION_ACCESS_RIGHTS(262144u32);
pub const SYNCHRONIZATION_WRITE_OWNER: SYNCHRONIZATION_ACCESS_RIGHTS =
    SYNCHRONIZATION_ACCESS_RIGHTS(524288u32);
#[repr(C)]
#[cfg(feature = "Win32_System_Kernel")]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct TEB {
...
pub type WAITORTIMERCALLBACK =
    Option<unsafe extern "system" fn(param0: *mut core::ffi::c_void, param1: bool)>;

windows_core::imp::define_interface!(
    ...
    0xc100be9f_d33a_4a4b_bf23_bbef4663d017
);
...
impl IWCNConnectNotify {
    pub unsafe fn ConnectSucceeded(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ConnectSucceeded)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    }
    pub unsafe fn ConnectFailed(
        &self,
        hrfailure: windows_core::HRESULT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ConnectFailed)(
                windows_core::Interface::as_raw(self),
                hrfailure,
            )
            .ok()
...
pub struct IWCNConnectNotify_Vtbl {
    ...
    pub ConnectSucceeded:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ConnectFailed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IWCNConnectNotify_Vtbl {
    pub const fn new<Identity: IWCNConnectNotify_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ConnectSucceeded<
        ...
        unsafe extern "system" fn ConnectFailed<
            Identity: IWCNConnectNotify_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWCNConnectNotify_Impl::ConnectFailed(this, core::mem::transmute_copy(&hrfailure))
                    .into()
            }
        }
        Self {
...
impl IWCNDevice {
    pub unsafe fn SetPassword(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetPassword)(
                windows_core::Interface::as_raw(self),
                r#type,
                pbpassword.len().try_into().unwrap(),
                core::mem::transmute(pbpassword.as_ptr()),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn GetIntegerAttribute(
        &self,
        attributetype: WCN_ATTRIBUTE_TYPE,
    ) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetIntegerAttribute)(
                windows_core::Interface::as_raw(self),
                attributetype,
                &mut result__,
            )
    ...
    pub unsafe fn GetStringAttribute(
        &self,
        attributetype: WCN_ATTRIBUTE_TYPE,
        wszstring: &mut [u16],
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetStringAttribute)(
                windows_core::Interface::as_raw(self),
                attributetype,
                wszstring.len().try_into().unwrap(),
                core::mem::transmute(wszstring.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn GetNetworkProfile(&self, wszprofile: &mut [u16]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetNetworkProfile)(
                windows_core::Interface::as_raw(self),
                wszprofile.len().try_into().unwrap(),
                core::mem::transmute(wszprofile.as_ptr()),
            )
            .ok()
        }
    }
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetNetworkProfile)(
                windows_core::Interface::as_raw(self),
                pszprofilexml.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn GetVendorExtension(
        &self,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetVendorExtension)(
                windows_core::Interface::as_raw(self),
                pvendorextspec,
                pbbuffer.len().try_into().unwrap(),
                core::mem::transmute(pbbuffer.as_ptr()),
    ...
    pub unsafe fn SetVendorExtension(
        &self,
        pvendorextspec: *const WCN_VENDOR_EXTENSION_SPEC,
        pbbuffer: &[u8],
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetVendorExtension)(
                windows_core::Interface::as_raw(self),
                pvendorextspec,
                pbbuffer.len().try_into().unwrap(),
                core::mem::transmute(pbbuffer.as_ptr()),
    ...
    pub unsafe fn Unadvise(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Unadvise)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn SetNFCPasswordParams(
        &self,
        r#type: WCN_PASSWORD_TYPE,
        dwoobpasswordid: u32,
        pbpassword: Option<&[u8]>,
        pbremotepublickeyhash: Option<&[u8]>,
        pbdhkeyblob: Option<&[u8]>,
    ) -> windows_core::Result<()> {
        unsafe {
...
pub struct IWCNDevice_Vtbl {
    ...
    pub GetIntegerAttribute: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WCN_ATTRIBUTE_TYPE,
        *mut u32,
    ) -> windows_core::HRESULT,
    ...
    pub GetNetworkProfile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    ...
    pub GetVendorExtension: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WCN_VENDOR_EXTENSION_SPEC,
        u32,
        *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub SetVendorExtension: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WCN_VENDOR_EXTENSION_SPEC,
        u32,
        *const u8,
    ...
    pub SetNFCPasswordParams: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WCN_PASSWORD_TYPE,
        u32,
        u32,
...
pub trait IWCNDevice_Impl: windows_core::IUnknownImpl {
    ...
    fn Connect(
        &self,
        pnotify: windows_core::Ref<'_, IWCNConnectNotify>,
    ) -> windows_core::Result<()>;
    fn GetAttribute(
        &self,
        attributetype: WCN_ATTRIBUTE_TYPE,
    ...
    fn GetStringAttribute(
        ...
        attributetype: WCN_ATTRIBUTE_TYPE,
        cchmaxstring: u32,
        wszstring: windows_core::PWSTR,
    ) -> windows_core::Result<()>;
    fn GetNetworkProfile(
        &self,
        cchmaxstringlength: u32,
        wszprofile: windows_core::PWSTR,
    ) -> windows_core::Result<()>;
...
impl IWCNDevice_Vtbl {
    pub const fn new<Identity: IWCNDevice_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetPassword<Identity: IWCNDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            r#type: WCN_PASSWORD_TYPE,
            dwpasswordlength: u32,
            pbpassword: *const u8,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWCNDevice_Impl::SetPassword(
                    this,
                    core::mem::transmute_copy(&r#type),
                    core::mem::transmute_copy(&dwpasswordlength),
                    core::mem::transmute_copy(&pbpassword),
                )
                .into()
            }
        }
        unsafe extern "system" fn Connect<Identity: IWCNDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetAttribute<Identity: IWCNDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            attributetype: WCN_ATTRIBUTE_TYPE,
            dwmaxbuffersize: u32,
            pbbuffer: *mut u8,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWCNDevice_Impl::GetAttribute(
                    this,
                    core::mem::transmute_copy(&attributetype),
                    core::mem::transmute_copy(&dwmaxbuffersize),
                    core::mem::transmute_copy(&pbbuffer),
                    core::mem::transmute_copy(&pdwbufferused),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetIntegerAttribute<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWCNDevice_Impl::GetIntegerAttribute(
                    this,
                    core::mem::transmute_copy(&attributetype),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetStringAttribute<
            Identity: IWCNDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWCNDevice_Impl::GetStringAttribute(
                    this,
                    core::mem::transmute_copy(&attributetype),
                    core::mem::transmute_copy(&cchmaxstring),
                    core::mem::transmute_copy(&wszstring),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetNetworkProfile<
            Identity: IWCNDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWCNDevice_Impl::GetNetworkProfile(
                    this,
                    core::mem::transmute_copy(&cchmaxstringlength),
                    core::mem::transmute_copy(&wszprofile),
                )
                .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            pszprofilexml: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWCNDevice_Impl::SetNetworkProfile(this, core::mem::transmute(&pszprofilexml))
                    .into()
            }
        }
        unsafe extern "system" fn GetVendorExtension<
            Identity: IWCNDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWCNDevice_Impl::GetVendorExtension(
                    this,
                    core::mem::transmute_copy(&pvendorextspec),
                    core::mem::transmute_copy(&dwmaxbuffersize),
                    core::mem::transmute_copy(&pbbuffer),
                    core::mem::transmute_copy(&pdwbufferused),
                )
        ...
        unsafe extern "system" fn SetVendorExtension<
            Identity: IWCNDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWCNDevice_Impl::SetVendorExtension(
                    this,
                    core::mem::transmute_copy(&pvendorextspec),
        ...
        unsafe extern "system" fn Unadvise<Identity: IWCNDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn SetNFCPasswordParams<
            Identity: IWCNDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                ...
                IWCNDevice_Impl::SetNFCPasswordParams(
                    this,
                    core::mem::transmute_copy(&r#type),
                    core::mem::transmute_copy(&dwoobpasswordid),
                    core::mem::transmute_copy(&dwpasswordlength),
                    core::mem::transmute_copy(&pbpassword),
                    core::mem::transmute_copy(&dwremotepublickeyhashlength),
                    core::mem::transmute_copy(&pbremotepublickeyhash),
                    core::mem::transmute_copy(&dwdhkeybloblength),
                    core::mem::transmute_copy(&pbdhkeyblob),
                )
                .into()
            }
        }
...
pub const PKEY_WCN_DeviceType_Category: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x88190b8b_4684_11da_a26a_0002b3988e81),
        pid: 16,
    };
pub const PKEY_WCN_DeviceType_SubCategory: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x88190b8b_4684_11da_a26a_0002b3988e81),
        pid: 18,
    };
pub const PKEY_WCN_DeviceType_SubCategoryOUI: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x88190b8b_4684_11da_a26a_0002b3988e81),
        pid: 17,
    };
pub const PKEY_WCN_SSID: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x88190b8b_4684_11da_a26a_0002b3988e81),
        pid: 32,
    };
pub const SID_WcnProvider: windows_core::GUID =
    windows_core::GUID::from_u128(0xc100beca_d33a_4a4b_bf23_bbef4663d017);
pub const WCNDeviceObject: windows_core::GUID =
    windows_core::GUID::from_u128(0xc100bea7_d33a_4a4b_bf23_bbef4663d017);
pub const WCN_API_MAX_BUFFER_SIZE: u32 = 2096u32;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WCN_ATTRIBUTE_TYPE(pub i32);
pub const WCN_E_AUTHENTICATION_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0x80043C02_u32 as _);
pub const WCN_E_CONNECTION_REJECTED: windows_core::HRESULT =
    windows_core::HRESULT(0x80043C03_u32 as _);
...
pub const WCN_E_SESSION_TIMEDOUT: windows_core::HRESULT =
    windows_core::HRESULT(0x80043C04_u32 as _);
...
pub const WCN_QUERY_CONSTRAINT_USE_SOFTAP: windows_core::PCWSTR =
    windows_core::w!("WCN.Discovery.SoftAP");
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const WCN_TYPE_PRIMARY_DEVICE_TYPE_SUBCATEGORY_OUI: WCN_ATTRIBUTE_TYPE =
    WCN_ATTRIBUTE_TYPE(88i32);
...
pub const WCN_TYPE_SELECTED_REGISTRAR_CONFIG_METHODS: WCN_ATTRIBUTE_TYPE =
    WCN_ATTRIBUTE_TYPE(74i32);
...
pub const WCN_VALUE_AS_ASSOCIATION_FAILURE: WCN_VALUE_TYPE_ASSOCIATION_STATE =
    WCN_VALUE_TYPE_ASSOCIATION_STATE(3i32);
pub const WCN_VALUE_AS_CONFIGURATION_FAILURE: WCN_VALUE_TYPE_ASSOCIATION_STATE =
    WCN_VALUE_TYPE_ASSOCIATION_STATE(2i32);
pub const WCN_VALUE_AS_CONNECTION_SUCCESS: WCN_VALUE_TYPE_ASSOCIATION_STATE =
    WCN_VALUE_TYPE_ASSOCIATION_STATE(1i32);
pub const WCN_VALUE_AS_IP_FAILURE: WCN_VALUE_TYPE_ASSOCIATION_STATE =
    WCN_VALUE_TYPE_ASSOCIATION_STATE(4i32);
pub const WCN_VALUE_AS_NOT_ASSOCIATED: WCN_VALUE_TYPE_ASSOCIATION_STATE =
    WCN_VALUE_TYPE_ASSOCIATION_STATE(0i32);
pub const WCN_VALUE_AT_OPEN: WCN_VALUE_TYPE_AUTHENTICATION_TYPE =
    WCN_VALUE_TYPE_AUTHENTICATION_TYPE(1i32);
pub const WCN_VALUE_AT_SHARED: WCN_VALUE_TYPE_AUTHENTICATION_TYPE =
    WCN_VALUE_TYPE_AUTHENTICATION_TYPE(4i32);
pub const WCN_VALUE_AT_WPA: WCN_VALUE_TYPE_AUTHENTICATION_TYPE =
    WCN_VALUE_TYPE_AUTHENTICATION_TYPE(8i32);
pub const WCN_VALUE_AT_WPA2: WCN_VALUE_TYPE_AUTHENTICATION_TYPE =
    WCN_VALUE_TYPE_AUTHENTICATION_TYPE(16i32);
pub const WCN_VALUE_AT_WPA2PSK: WCN_VALUE_TYPE_AUTHENTICATION_TYPE =
    WCN_VALUE_TYPE_AUTHENTICATION_TYPE(32i32);
pub const WCN_VALUE_AT_WPAPSK: WCN_VALUE_TYPE_AUTHENTICATION_TYPE =
    WCN_VALUE_TYPE_AUTHENTICATION_TYPE(2i32);
pub const WCN_VALUE_AT_WPAWPA2PSK_MIXED: WCN_VALUE_TYPE_AUTHENTICATION_TYPE =
    WCN_VALUE_TYPE_AUTHENTICATION_TYPE(34i32);
pub const WCN_VALUE_CE_2_4_CHANNEL_NOT_SUPPORTED: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(3i32);
pub const WCN_VALUE_CE_5_0_CHANNEL_NOT_SUPPORTED: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(4i32);
pub const WCN_VALUE_CE_COULD_NOT_CONNECT_TO_REGISTRAR: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(11i32);
pub const WCN_VALUE_CE_DECRYPTION_CRC_FAILURE: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(2i32);
pub const WCN_VALUE_CE_DEVICE_BUSY: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(14i32);
pub const WCN_VALUE_CE_DEVICE_PASSWORD_AUTH_FAILURE: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(18i32);
pub const WCN_VALUE_CE_FAILED_DHCP_CONFIG: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(9i32);
pub const WCN_VALUE_CE_IP_ADDRESS_CONFLICT: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(10i32);
pub const WCN_VALUE_CE_MESSAGE_TIMEOUT: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(16i32);
pub const WCN_VALUE_CE_MULTIPLE_PBC_SESSIONS_DETECTED: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(12i32);
pub const WCN_VALUE_CE_NETWORK_ASSOCIATION_FAILURE: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(7i32);
pub const WCN_VALUE_CE_NETWORK_AUTHENTICATION_FAILURE: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(6i32);
pub const WCN_VALUE_CE_NO_DHCP_RESPONSE: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(8i32);
pub const WCN_VALUE_CE_NO_ERROR: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(0i32);
pub const WCN_VALUE_CE_OOB_INTERFACE_READ_ERROR: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(1i32);
pub const WCN_VALUE_CE_REGISTRATION_SESSION_TIMEOUT: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(17i32);
pub const WCN_VALUE_CE_ROGUE_ACTIVITY_SUSPECTED: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(13i32);
pub const WCN_VALUE_CE_SETUP_LOCKED: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(15i32);
pub const WCN_VALUE_CE_SIGNAL_TOO_WEAK: WCN_VALUE_TYPE_CONFIGURATION_ERROR =
    WCN_VALUE_TYPE_CONFIGURATION_ERROR(5i32);
pub const WCN_VALUE_CM_DISPLAY: WCN_VALUE_TYPE_CONFIG_METHODS = WCN_VALUE_TYPE_CONFIG_METHODS(8i32);
pub const WCN_VALUE_CM_ETHERNET: WCN_VALUE_TYPE_CONFIG_METHODS =
    WCN_VALUE_TYPE_CONFIG_METHODS(2i32);
pub const WCN_VALUE_CM_EXTERNAL_NFC: WCN_VALUE_TYPE_CONFIG_METHODS =
    WCN_VALUE_TYPE_CONFIG_METHODS(16i32);
pub const WCN_VALUE_CM_INTEGRATED_NFC: WCN_VALUE_TYPE_CONFIG_METHODS =
    WCN_VALUE_TYPE_CONFIG_METHODS(32i32);
pub const WCN_VALUE_CM_KEYPAD: WCN_VALUE_TYPE_CONFIG_METHODS =
    WCN_VALUE_TYPE_CONFIG_METHODS(256i32);
pub const WCN_VALUE_CM_LABEL: WCN_VALUE_TYPE_CONFIG_METHODS = WCN_VALUE_TYPE_CONFIG_METHODS(4i32);
pub const WCN_VALUE_CM_NFC_INTERFACE: WCN_VALUE_TYPE_CONFIG_METHODS =
    WCN_VALUE_TYPE_CONFIG_METHODS(64i32);
pub const WCN_VALUE_CM_PHYS_DISPLAY: WCN_VALUE_TYPE_CONFIG_METHODS =
    WCN_VALUE_TYPE_CONFIG_METHODS(16392i32);
pub const WCN_VALUE_CM_PHYS_PUSHBUTTON: WCN_VALUE_TYPE_CONFIG_METHODS =
    WCN_VALUE_TYPE_CONFIG_METHODS(1152i32);
pub const WCN_VALUE_CM_PUSHBUTTON: WCN_VALUE_TYPE_CONFIG_METHODS =
    WCN_VALUE_TYPE_CONFIG_METHODS(128i32);
pub const WCN_VALUE_CM_USBA: WCN_VALUE_TYPE_CONFIG_METHODS = WCN_VALUE_TYPE_CONFIG_METHODS(1i32);
pub const WCN_VALUE_CM_VIRT_DISPLAY: WCN_VALUE_TYPE_CONFIG_METHODS =
    WCN_VALUE_TYPE_CONFIG_METHODS(8200i32);
pub const WCN_VALUE_CM_VIRT_PUSHBUTTON: WCN_VALUE_TYPE_CONFIG_METHODS =
    WCN_VALUE_TYPE_CONFIG_METHODS(640i32);
...
pub const WCN_VALUE_DP_DEFAULT: WCN_VALUE_TYPE_DEVICE_PASSWORD_ID =
    WCN_VALUE_TYPE_DEVICE_PASSWORD_ID(0i32);
pub const WCN_VALUE_DP_MACHINE_SPECIFIED: WCN_VALUE_TYPE_DEVICE_PASSWORD_ID =
    WCN_VALUE_TYPE_DEVICE_PASSWORD_ID(2i32);
pub const WCN_VALUE_DP_NFC_CONNECTION_HANDOVER: WCN_VALUE_TYPE_DEVICE_PASSWORD_ID =
    WCN_VALUE_TYPE_DEVICE_PASSWORD_ID(7i32);
pub const WCN_VALUE_DP_OUTOFBAND_MAX: WCN_VALUE_TYPE_DEVICE_PASSWORD_ID =
    WCN_VALUE_TYPE_DEVICE_PASSWORD_ID(65535i32);
pub const WCN_VALUE_DP_OUTOFBAND_MIN: WCN_VALUE_TYPE_DEVICE_PASSWORD_ID =
    WCN_VALUE_TYPE_DEVICE_PASSWORD_ID(16i32);
pub const WCN_VALUE_DP_PUSHBUTTON: WCN_VALUE_TYPE_DEVICE_PASSWORD_ID =
    WCN_VALUE_TYPE_DEVICE_PASSWORD_ID(4i32);
pub const WCN_VALUE_DP_REGISTRAR_SPECIFIED: WCN_VALUE_TYPE_DEVICE_PASSWORD_ID =
    WCN_VALUE_TYPE_DEVICE_PASSWORD_ID(5i32);
pub const WCN_VALUE_DP_REKEY: WCN_VALUE_TYPE_DEVICE_PASSWORD_ID =
    WCN_VALUE_TYPE_DEVICE_PASSWORD_ID(3i32);
pub const WCN_VALUE_DP_USER_SPECIFIED: WCN_VALUE_TYPE_DEVICE_PASSWORD_ID =
    WCN_VALUE_TYPE_DEVICE_PASSWORD_ID(1i32);
pub const WCN_VALUE_DP_WFD_SERVICES: WCN_VALUE_TYPE_DEVICE_PASSWORD_ID =
    WCN_VALUE_TYPE_DEVICE_PASSWORD_ID(8i32);
...
pub const WCN_VALUE_ET_TKIP_AES_MIXED: WCN_VALUE_TYPE_ENCRYPTION_TYPE =
    WCN_VALUE_TYPE_ENCRYPTION_TYPE(12i32);
...
pub const WCN_VALUE_MT_PROBE_REQUEST: WCN_VALUE_TYPE_MESSAGE_TYPE =
    WCN_VALUE_TYPE_MESSAGE_TYPE(2i32);
pub const WCN_VALUE_MT_PROBE_RESPONSE: WCN_VALUE_TYPE_MESSAGE_TYPE =
    WCN_VALUE_TYPE_MESSAGE_TYPE(3i32);
...
pub const WCN_VALUE_ReqT_ENROLLEE_INFO: WCN_VALUE_TYPE_REQUEST_TYPE =
    WCN_VALUE_TYPE_REQUEST_TYPE(0i32);
pub const WCN_VALUE_ReqT_ENROLLEE_OPEN_1X: WCN_VALUE_TYPE_REQUEST_TYPE =
    WCN_VALUE_TYPE_REQUEST_TYPE(1i32);
pub const WCN_VALUE_ReqT_MANAGER_REGISTRAR: WCN_VALUE_TYPE_REQUEST_TYPE =
    WCN_VALUE_TYPE_REQUEST_TYPE(3i32);
...
pub const WCN_VALUE_RspT_ENROLLEE_INFO: WCN_VALUE_TYPE_RESPONSE_TYPE =
    WCN_VALUE_TYPE_RESPONSE_TYPE(0i32);
pub const WCN_VALUE_RspT_ENROLLEE_OPEN_1X: WCN_VALUE_TYPE_RESPONSE_TYPE =
    WCN_VALUE_TYPE_RESPONSE_TYPE(1i32);
pub const WCN_VALUE_RspT_REGISTRAR: WCN_VALUE_TYPE_RESPONSE_TYPE =
    WCN_VALUE_TYPE_RESPONSE_TYPE(2i32);
pub const WCN_VALUE_SS_CONFIGURED: WCN_VALUE_TYPE_WI_FI_PROTECTED_SETUP_STATE =
    WCN_VALUE_TYPE_WI_FI_PROTECTED_SETUP_STATE(2i32);
pub const WCN_VALUE_SS_NOT_CONFIGURED: WCN_VALUE_TYPE_WI_FI_PROTECTED_SETUP_STATE =
    WCN_VALUE_TYPE_WI_FI_PROTECTED_SETUP_STATE(1i32);
pub const WCN_VALUE_SS_RESERVED00: WCN_VALUE_TYPE_WI_FI_PROTECTED_SETUP_STATE =
    WCN_VALUE_TYPE_WI_FI_PROTECTED_SETUP_STATE(0i32);

...
#[inline]
pub unsafe fn DSCreateISecurityInfoObject<P0, P1>(
    pwszobjectpath: P0,
    pwszobjectclass: P1,
    dwflags: u32,
    ppsi: *mut Option<super::Authorization::UI::ISecurityInformation>,
...
#[cfg(feature = "Win32_Security_Authorization_UI")]
pub type PFNDSCREATEISECINFO = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCWSTR,
        param1: windows_core::PCWSTR,
        param2: u32,
        param3: windows_core::OutRef<'_, super::Authorization::UI::ISecurityInformation>,
...
>;
#[cfg(feature = "Win32_Security_Authorization_UI")]
pub type PFNDSCREATEISECINFOEX = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCWSTR,
        param1: windows_core::PCWSTR,
        ...
        param5: u32,
        param6: windows_core::OutRef<'_, super::Authorization::UI::ISecurityInformation>,
...
>;
#[cfg(feature = "Win32_UI_Controls")]
pub type PFNDSCREATESECPAGE = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCWSTR,
        param1: windows_core::PCWSTR,
        param2: u32,
...
>;
pub type PFNDSEDITSECURITY = Option<
    unsafe extern "system" fn(
...
>;
pub type PFNREADOBJECTSECURITY = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCWSTR,
        param1: u32,
        param2: *mut super::PSECURITY_DESCRIPTOR,
        param3: super::super::Foundation::LPARAM,
    ) -> windows_core::HRESULT,
>;
pub type PFNWRITEOBJECTSECURITY = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCWSTR,
        param1: u32,
        param2: super::PSECURITY_DESCRIPTOR,
        param3: super::super::Foundation::LPARAM,
    ) -> windows_core::HRESULT,
>;

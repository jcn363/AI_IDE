...
windows_core::imp::define_interface!(
    ...
    0x2834d6ed_297e_4e72_8a51_961e86f05152
);
...
impl AsyncIAssociatedIdentityProvider {
    pub unsafe fn Begin_AssociateIdentity(
        &self,
        hwndparent: super::super::super::super::Foundation::HWND,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_AssociateIdentity)(
    ...
    pub unsafe fn Finish_AssociateIdentity(
        &self,
    ) -> windows_core::Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_AssociateIdentity)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
    ...
    pub unsafe fn Begin_DisassociateIdentity<P1>(
        &self,
        hwndparent: super::super::super::super::Foundation::HWND,
        lpszuniqueid: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_DisassociateIdentity)(
                windows_core::Interface::as_raw(self),
                hwndparent,
                lpszuniqueid.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn Finish_DisassociateIdentity(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_DisassociateIdentity)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    }
    pub unsafe fn Begin_ChangeCredential<P1>(
        &self,
        hwndparent: super::super::super::super::Foundation::HWND,
        lpszuniqueid: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_ChangeCredential)(
                windows_core::Interface::as_raw(self),
                hwndparent,
                lpszuniqueid.param().abi(),
            )
    ...
    pub unsafe fn Finish_ChangeCredential(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_ChangeCredential)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct AsyncIAssociatedIdentityProvider_Vtbl {
    ...
    pub Begin_AssociateIdentity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::super::Foundation::HWND,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub Finish_AssociateIdentity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_UI_Shell_PropertiesSystem"))]
    Finish_AssociateIdentity: usize,
    pub Begin_DisassociateIdentity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::super::Foundation::HWND,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub Finish_DisassociateIdentity:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Begin_ChangeCredential: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::super::Foundation::HWND,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub Finish_ChangeCredential:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
}
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
pub trait AsyncIAssociatedIdentityProvider_Impl: windows_core::IUnknownImpl {
    ...
    fn Begin_DisassociateIdentity(
        &self,
        hwndparent: super::super::super::super::Foundation::HWND,
        lpszuniqueid: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
...
impl AsyncIAssociatedIdentityProvider_Vtbl {
    ...
    {
        unsafe extern "system" fn Begin_AssociateIdentity<
        ...
        >(
            ...
            unsafe {
                ...
                AsyncIAssociatedIdentityProvider_Impl::Begin_AssociateIdentity(
                    this,
        ...
        unsafe extern "system" fn Finish_AssociateIdentity<
            Identity: AsyncIAssociatedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pppropertystore: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Begin_DisassociateIdentity<
            Identity: AsyncIAssociatedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIAssociatedIdentityProvider_Impl::Begin_DisassociateIdentity(
                    this,
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute(&lpszuniqueid),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_DisassociateIdentity<
            Identity: AsyncIAssociatedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_ChangeCredential<
            Identity: AsyncIAssociatedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIAssociatedIdentityProvider_Impl::Begin_ChangeCredential(
                    this,
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute(&lpszuniqueid),
                )
        ...
        unsafe extern "system" fn Finish_ChangeCredential<
            Identity: AsyncIAssociatedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x9ce55141_bce9_4e15_824d_43d79f512f93
);
...
impl AsyncIConnectedIdentityProvider {
    pub unsafe fn Begin_ConnectIdentity(&self, authbuffer: &[u8]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_ConnectIdentity)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(authbuffer.as_ptr()),
                authbuffer.len().try_into().unwrap(),
            )
            .ok()
        }
    }
    pub unsafe fn Finish_ConnectIdentity(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_ConnectIdentity)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn Begin_DisconnectIdentity(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_DisconnectIdentity)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn Finish_DisconnectIdentity(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_DisconnectIdentity)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn Begin_IsConnected(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_IsConnected)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn Finish_IsConnected(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_IsConnected)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_GetUrl)(
                windows_core::Interface::as_raw(self),
                identifier,
                context.param().abi(),
            )
    ...
    pub unsafe fn Finish_GetUrl(
        &self,
        postdata: *mut super::super::super::super::System::Variant::VARIANT,
        url: *mut windows_core::PWSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_GetUrl)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn Begin_GetAccountState(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_GetAccountState)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn Finish_GetAccountState(&self) -> windows_core::Result<ACCOUNT_STATE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_GetAccountState)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct AsyncIConnectedIdentityProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Begin_ConnectIdentity:
        unsafe extern "system" fn(*mut core::ffi::c_void, *const u8, u32) -> windows_core::HRESULT,
    pub Finish_ConnectIdentity:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Begin_DisconnectIdentity:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Finish_DisconnectIdentity:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Begin_IsConnected:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Finish_IsConnected: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub Begin_GetUrl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        IDENTITY_URL,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub Finish_GetUrl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::super::System::Variant::VARIANT,
    ...
    Finish_GetUrl: usize,
    pub Begin_GetAccountState:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Finish_GetAccountState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ACCOUNT_STATE,
    ) -> windows_core::HRESULT,
}
...
pub trait AsyncIConnectedIdentityProvider_Impl: windows_core::IUnknownImpl {
    ...
    fn Begin_GetUrl(
        &self,
        identifier: IDENTITY_URL,
        context: windows_core::Ref<'_, super::super::super::super::System::Com::IBindCtx>,
    ) -> windows_core::Result<()>;
    fn Finish_GetUrl(
        &self,
        postdata: *mut super::super::super::super::System::Variant::VARIANT,
...
impl AsyncIConnectedIdentityProvider_Vtbl {
    ...
    {
        unsafe extern "system" fn Begin_ConnectIdentity<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIConnectedIdentityProvider_Impl::Begin_ConnectIdentity(
                    this,
                    core::mem::transmute_copy(&authbuffer),
                    core::mem::transmute_copy(&authbuffersize),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_ConnectIdentity<
            Identity: AsyncIConnectedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_DisconnectIdentity<
            Identity: AsyncIConnectedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Finish_DisconnectIdentity<
            Identity: AsyncIConnectedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_IsConnected<
            Identity: AsyncIConnectedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Finish_IsConnected<
            Identity: AsyncIConnectedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            connected: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Begin_GetUrl<
            Identity: AsyncIConnectedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIConnectedIdentityProvider_Impl::Begin_GetUrl(
                    this,
                    core::mem::transmute_copy(&identifier),
                    core::mem::transmute_copy(&context),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_GetUrl<
            Identity: AsyncIConnectedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIConnectedIdentityProvider_Impl::Finish_GetUrl(
                    this,
        ...
        unsafe extern "system" fn Begin_GetAccountState<
            Identity: AsyncIConnectedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Finish_GetAccountState<
            Identity: AsyncIConnectedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pstate: *mut ACCOUNT_STATE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl AsyncIIdentityAdvise {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_IdentityUpdated)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn Finish_IdentityUpdated(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_IdentityUpdated)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct AsyncIIdentityAdvise_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Begin_IdentityUpdated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub Finish_IdentityUpdated:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
}
...
impl AsyncIIdentityAdvise_Vtbl {
    pub const fn new<Identity: AsyncIIdentityAdvise_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin_IdentityUpdated<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityAdvise_Impl::Begin_IdentityUpdated(
                    this,
                    core::mem::transmute_copy(&dwidentityupdateevents),
                    core::mem::transmute(&lpszuniqueid),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_IdentityUpdated<
            Identity: AsyncIIdentityAdvise_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xf9a2f918_feca_4e9c_9633_61cbf13ed34d
);
windows_core::imp::interface_hierarchy!(AsyncIIdentityAuthentication, windows_core::IUnknown);
impl AsyncIIdentityAuthentication {
    pub unsafe fn Begin_SetIdentityCredential(
        &self,
        credbuffer: Option<&[u8]>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_SetIdentityCredential)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(
                    credbuffer
                        .as_deref()
    ...
    pub unsafe fn Finish_SetIdentityCredential(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_SetIdentityCredential)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Begin_ValidateIdentityCredential(
        &self,
        credbuffer: &[u8],
        ppidentityproperties: Option<
            *mut Option<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>,
        >,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_ValidateIdentityCredential)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(credbuffer.as_ptr()),
                credbuffer.len().try_into().unwrap(),
                ppidentityproperties.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Finish_ValidateIdentityCredential(
        &self,
        ppidentityproperties: Option<
            *mut Option<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>,
        >,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Finish_ValidateIdentityCredential)(
                windows_core::Interface::as_raw(self),
                ppidentityproperties.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
...
pub struct AsyncIIdentityAuthentication_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Begin_SetIdentityCredential:
        unsafe extern "system" fn(*mut core::ffi::c_void, *const u8, u32) -> windows_core::HRESULT,
    pub Finish_SetIdentityCredential:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub Begin_ValidateIdentityCredential: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const u8,
        u32,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub Finish_ValidateIdentityCredential: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_UI_Shell_PropertiesSystem"))]
...
pub trait AsyncIIdentityAuthentication_Impl: windows_core::IUnknownImpl {
    ...
    fn Begin_ValidateIdentityCredential(
        ...
        credbuffer: *const u8,
        credbufferlength: u32,
        ppidentityproperties: windows_core::OutRef<
            '_,
            super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore,
        >,
    ) -> windows_core::Result<()>;
...
impl AsyncIIdentityAuthentication_Vtbl {
    pub const fn new<Identity: AsyncIIdentityAuthentication_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin_SetIdentityCredential<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityAuthentication_Impl::Begin_SetIdentityCredential(
                    this,
                    core::mem::transmute_copy(&credbuffer),
                    core::mem::transmute_copy(&credbufferlength),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_SetIdentityCredential<
            Identity: AsyncIIdentityAuthentication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_ValidateIdentityCredential<
            Identity: AsyncIIdentityAuthentication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            credbuffer: *const u8,
            credbufferlength: u32,
            ppidentityproperties: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityAuthentication_Impl::Begin_ValidateIdentityCredential(
                    this,
                    core::mem::transmute_copy(&credbuffer),
                    core::mem::transmute_copy(&credbufferlength),
                    core::mem::transmute_copy(&ppidentityproperties),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_ValidateIdentityCredential<
            Identity: AsyncIIdentityAuthentication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityAuthentication_Impl::Finish_ValidateIdentityCredential(
                    this,
                    core::mem::transmute_copy(&ppidentityproperties),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    0xc6fc9901_c433_4646_8f48_4e4687aae2a0
);
...
impl AsyncIIdentityProvider {
    ...
    pub unsafe fn Begin_GetIdentityEnum(
        ...
        pfilterkey: Option<*const super::super::super::super::Foundation::PROPERTYKEY>,
        pfilterpropvarvalue: Option<
            *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT,
        >,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_GetIdentityEnum)(
                windows_core::Interface::as_raw(self),
                eidentitytype,
                pfilterkey.unwrap_or(core::mem::zeroed()) as _,
                pfilterpropvarvalue.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Finish_GetIdentityEnum(
        &self,
    ) -> windows_core::Result<super::super::super::super::System::Com::IEnumUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_GetIdentityEnum)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_Create)(
                windows_core::Interface::as_raw(self),
                lpszusername.param().abi(),
                core::mem::transmute(pkeywordstoadd),
            )
            .ok()
        }
    }
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Finish_Create(
        &self,
    ) -> windows_core::Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_Create)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_Import)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn Finish_Import(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_Import)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_Delete)(
                windows_core::Interface::as_raw(self),
                lpszuniqueid.param().abi(),
                core::mem::transmute(pkeywordstodelete),
            )
            .ok()
        }
    }
    pub unsafe fn Finish_Delete(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_Delete)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_FindByUniqueID)(
                windows_core::Interface::as_raw(self),
                lpszuniqueid.param().abi(),
            )
            .ok()
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Finish_FindByUniqueID(
        &self,
    ) -> windows_core::Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_FindByUniqueID)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn Begin_GetProviderPropertyStore(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_GetProviderPropertyStore)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Finish_GetProviderPropertyStore(
        &self,
    ) -> windows_core::Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_GetProviderPropertyStore)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_Advise)(
                windows_core::Interface::as_raw(self),
                pidentityadvise.param().abi(),
                dwidentityupdateevents,
            )
            .ok()
        }
    ...
    pub unsafe fn Finish_Advise(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_Advise)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn Begin_UnAdvise(&self, dwcookie: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_UnAdvise)(
                windows_core::Interface::as_raw(self),
                dwcookie,
            )
            .ok()
    ...
    pub unsafe fn Finish_UnAdvise(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_UnAdvise)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct AsyncIIdentityProvider_Vtbl {
    ...
    pub Begin_GetIdentityEnum: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        IDENTITY_TYPE,
        *const super::super::super::super::Foundation::PROPERTYKEY,
        *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(
        feature = "Win32_System_Com_StructuredStorage",
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub Finish_GetIdentityEnum: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    ...
    pub Begin_Create: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT,
    ) -> windows_core::HRESULT,
    ...
    Begin_Create: usize,
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub Finish_Create: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_UI_Shell_PropertiesSystem"))]
    Finish_Create: usize,
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub Begin_Import: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_UI_Shell_PropertiesSystem"))]
    ...
    pub Begin_Delete: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT,
    ) -> windows_core::HRESULT,
    ...
    pub Begin_FindByUniqueID: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub Finish_FindByUniqueID: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_UI_Shell_PropertiesSystem"))]
    Finish_FindByUniqueID: usize,
    pub Begin_GetProviderPropertyStore:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub Finish_GetProviderPropertyStore: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_UI_Shell_PropertiesSystem"))]
    Finish_GetProviderPropertyStore: usize,
    pub Begin_Advise: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ) -> windows_core::HRESULT,
...
pub trait AsyncIIdentityProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_GetIdentityEnum(
        &self,
        eidentitytype: IDENTITY_TYPE,
        pfilterkey: *const super::super::super::super::Foundation::PROPERTYKEY,
    ...
    fn Begin_Create(
        &self,
        lpszusername: &windows_core::PCWSTR,
        pkeywordstoadd: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT,
    ) -> windows_core::Result<()>;
    fn Finish_Create(
        &self,
    ...
    fn Begin_FindByUniqueID(&self, lpszuniqueid: &windows_core::PCWSTR)
        -> windows_core::Result<()>;
    ...
    fn Begin_Advise(
        &self,
        pidentityadvise: windows_core::Ref<'_, IIdentityAdvise>,
        dwidentityupdateevents: u32,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: AsyncIIdentityProvider_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityProvider_Impl::Begin_GetIdentityEnum(
                    this,
                    core::mem::transmute_copy(&eidentitytype),
                    core::mem::transmute_copy(&pfilterkey),
                    core::mem::transmute_copy(&pfilterpropvarvalue),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_GetIdentityEnum<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppidentityenum: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Begin_Create<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityProvider_Impl::Begin_Create(
                    this,
                    core::mem::transmute(&lpszusername),
                    core::mem::transmute_copy(&pkeywordstoadd),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_Create<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_Import<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityProvider_Impl::Begin_Import(
                    this,
        ...
        unsafe extern "system" fn Finish_Import<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_Delete<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityProvider_Impl::Begin_Delete(
                    this,
                    core::mem::transmute(&lpszuniqueid),
                    core::mem::transmute_copy(&pkeywordstodelete),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_Delete<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_FindByUniqueID<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityProvider_Impl::Begin_FindByUniqueID(
                    this,
                    core::mem::transmute(&lpszuniqueid),
                )
                .into()
        ...
        unsafe extern "system" fn Finish_FindByUniqueID<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_GetProviderPropertyStore<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Finish_GetProviderPropertyStore<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_Advise<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pidentityadvise: *mut core::ffi::c_void,
            dwidentityupdateevents: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityProvider_Impl::Begin_Advise(
                    this,
                    core::mem::transmute_copy(&pidentityadvise),
                    core::mem::transmute_copy(&dwidentityupdateevents),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_Advise<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_UnAdvise<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityProvider_Impl::Begin_UnAdvise(
                    this,
        ...
        unsafe extern "system" fn Finish_UnAdvise<
            Identity: AsyncIIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xeefa1616_48de_4872_aa64_6e6206535a51
);
...
impl AsyncIIdentityStore {
    pub unsafe fn Begin_GetCount(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_GetCount)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn Finish_GetCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_GetCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn Begin_GetAt(
        &self,
        dwprovider: u32,
        pprovguid: Option<*mut windows_core::GUID>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_GetAt)(
                windows_core::Interface::as_raw(self),
                dwprovider,
                pprovguid.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn Finish_GetAt(
        &self,
        pprovguid: Option<*mut windows_core::GUID>,
        ppidentityprovider: *mut Option<windows_core::IUnknown>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_GetAt)(
                windows_core::Interface::as_raw(self),
                pprovguid.unwrap_or(core::mem::zeroed()) as _,
                core::mem::transmute(ppidentityprovider),
            )
            .ok()
        }
    }
    pub unsafe fn Begin_AddToCache<P0>(
        &self,
        lpszuniqueid: P0,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_AddToCache)(
                windows_core::Interface::as_raw(self),
                lpszuniqueid.param().abi(),
                providerguid,
            )
    ...
    pub unsafe fn Finish_AddToCache(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_AddToCache)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    }
    pub unsafe fn Begin_ConvertToSid<P0>(
        &self,
        lpszuniqueid: P0,
        providerguid: *const windows_core::GUID,
        cbsid: u16,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_ConvertToSid)(
                windows_core::Interface::as_raw(self),
                lpszuniqueid.param().abi(),
                providerguid,
                cbsid,
    ...
    pub unsafe fn Finish_ConvertToSid(
        &self,
        psid: Option<*mut u8>,
        pcbrequiredsid: *mut u16,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_ConvertToSid)(
                windows_core::Interface::as_raw(self),
                psid.unwrap_or(core::mem::zeroed()) as _,
                pcbrequiredsid as _,
            )
    ...
    pub unsafe fn Begin_EnumerateIdentities(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Begin_EnumerateIdentities)(
                windows_core::Interface::as_raw(self),
                eidentitytype,
                pfilterkey.unwrap_or(core::mem::zeroed()) as _,
                pfilterpropvarvalue.unwrap_or(core::mem::zeroed()) as _,
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Finish_EnumerateIdentities(
        &self,
    ) -> windows_core::Result<super::super::super::super::System::Com::IEnumUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_EnumerateIdentities)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn Begin_Reset(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_Reset)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn Finish_Reset(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_Reset)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub struct AsyncIIdentityStore_Vtbl {
    ...
    pub Finish_GetCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub Begin_GetAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub Finish_GetAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Begin_AddToCache: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub Finish_AddToCache:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Begin_ConvertToSid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const windows_core::GUID,
        u16,
    ...
    pub Finish_ConvertToSid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u8,
        *mut u16,
    ) -> windows_core::HRESULT,
    ...
    pub Begin_EnumerateIdentities: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        IDENTITY_TYPE,
        *const super::super::super::super::Foundation::PROPERTYKEY,
        *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT,
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub Finish_EnumerateIdentities: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
...
pub trait AsyncIIdentityStore_Impl: windows_core::IUnknownImpl {
    ...
    fn Begin_GetAt(
        &self,
        dwprovider: u32,
        pprovguid: *mut windows_core::GUID,
    ) -> windows_core::Result<()>;
    fn Finish_GetAt(
        &self,
        pprovguid: *mut windows_core::GUID,
        ppidentityprovider: windows_core::OutRef<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
    fn Begin_AddToCache(
        &self,
        lpszuniqueid: &windows_core::PCWSTR,
...
impl AsyncIIdentityStore_Vtbl {
    pub const fn new<Identity: AsyncIIdentityStore_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin_GetCount<
        ...
        unsafe extern "system" fn Finish_GetCount<
            Identity: AsyncIIdentityStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pdwproviders: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Begin_GetAt<
            Identity: AsyncIIdentityStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityStore_Impl::Begin_GetAt(
                    this,
                    core::mem::transmute_copy(&dwprovider),
                    core::mem::transmute_copy(&pprovguid),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_GetAt<
            Identity: AsyncIIdentityStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pprovguid: *mut windows_core::GUID,
            ppidentityprovider: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityStore_Impl::Finish_GetAt(
                    this,
                    core::mem::transmute_copy(&pprovguid),
                    core::mem::transmute_copy(&ppidentityprovider),
                )
                .into()
            }
        }
        unsafe extern "system" fn Begin_AddToCache<
            Identity: AsyncIIdentityStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityStore_Impl::Begin_AddToCache(
                    this,
                    core::mem::transmute(&lpszuniqueid),
                    core::mem::transmute_copy(&providerguid),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_AddToCache<
            Identity: AsyncIIdentityStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_ConvertToSid<
            Identity: AsyncIIdentityStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityStore_Impl::Begin_ConvertToSid(
                    this,
                    core::mem::transmute(&lpszuniqueid),
                    core::mem::transmute_copy(&providerguid),
                    core::mem::transmute_copy(&cbsid),
                    core::mem::transmute_copy(&psid),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_ConvertToSid<
            Identity: AsyncIIdentityStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityStore_Impl::Finish_ConvertToSid(
                    this,
                    core::mem::transmute_copy(&psid),
                    core::mem::transmute_copy(&pcbrequiredsid),
                )
                .into()
            }
        }
        unsafe extern "system" fn Begin_EnumerateIdentities<
            Identity: AsyncIIdentityStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityStore_Impl::Begin_EnumerateIdentities(
                    this,
                    core::mem::transmute_copy(&eidentitytype),
                    core::mem::transmute_copy(&pfilterkey),
                    core::mem::transmute_copy(&pfilterpropvarvalue),
        ...
        unsafe extern "system" fn Finish_EnumerateIdentities<
            Identity: AsyncIIdentityStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_Reset<
            Identity: AsyncIIdentityStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Finish_Reset<
            Identity: AsyncIIdentityStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl AsyncIIdentityStoreEx {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_CreateConnectedIdentity)(
                windows_core::Interface::as_raw(self),
                localname.param().abi(),
                connectedname.param().abi(),
                providerguid,
            )
            .ok()
        }
    ...
    pub unsafe fn Finish_CreateConnectedIdentity(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_CreateConnectedIdentity)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    }
    pub unsafe fn Begin_DeleteConnectedIdentity<P0>(
        &self,
        connectedname: P0,
        providerguid: *const windows_core::GUID,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_DeleteConnectedIdentity)(
                windows_core::Interface::as_raw(self),
                connectedname.param().abi(),
                providerguid,
            )
    ...
    pub unsafe fn Finish_DeleteConnectedIdentity(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_DeleteConnectedIdentity)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct AsyncIIdentityStoreEx_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Begin_CreateConnectedIdentity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub Finish_CreateConnectedIdentity:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Begin_DeleteConnectedIdentity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub Finish_DeleteConnectedIdentity:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
}
pub trait AsyncIIdentityStoreEx_Impl: windows_core::IUnknownImpl {
    fn Begin_CreateConnectedIdentity(
        ...
        connectedname: &windows_core::PCWSTR,
        providerguid: *const windows_core::GUID,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: AsyncIIdentityStoreEx_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityStoreEx_Impl::Begin_CreateConnectedIdentity(
                    this,
                    core::mem::transmute(&localname),
                    core::mem::transmute(&connectedname),
                    core::mem::transmute_copy(&providerguid),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_CreateConnectedIdentity<
            Identity: AsyncIIdentityStoreEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_DeleteConnectedIdentity<
            Identity: AsyncIIdentityStoreEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIIdentityStoreEx_Impl::Begin_DeleteConnectedIdentity(
                    this,
                    core::mem::transmute(&connectedname),
                    core::mem::transmute_copy(&providerguid),
                )
        ...
        unsafe extern "system" fn Finish_DeleteConnectedIdentity<
            Identity: AsyncIIdentityStoreEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub const CIdentityProfileHandler: windows_core::GUID =
    windows_core::GUID::from_u128(0xecf5bf46_e3b6_449a_b56b_43f58f867814);
pub const CONNECTING: ACCOUNT_STATE = ACCOUNT_STATE(1i32);
pub const CONNECT_COMPLETED: ACCOUNT_STATE = ACCOUNT_STATE(2i32);
pub const CoClassIdentityStore: windows_core::GUID =
    windows_core::GUID::from_u128(0x30d49246_d217_465f_b00b_ac9ddd652eb7);
windows_core::imp::define_interface!(
    IAssociatedIdentityProvider,
    IAssociatedIdentityProvider_Vtbl,
    0x2af066b3_4cbb_4cba_a798_204b6af68cc0
);
windows_core::imp::interface_hierarchy!(IAssociatedIdentityProvider, windows_core::IUnknown);
impl IAssociatedIdentityProvider {
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn AssociateIdentity(
        &self,
        hwndparent: super::super::super::super::Foundation::HWND,
    ) -> windows_core::Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AssociateIdentity)(
                windows_core::Interface::as_raw(self),
                hwndparent,
                &mut result__,
            )
    ...
    pub unsafe fn DisassociateIdentity<P1>(
        &self,
        hwndparent: super::super::super::super::Foundation::HWND,
        lpszuniqueid: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DisassociateIdentity)(
                windows_core::Interface::as_raw(self),
                hwndparent,
                lpszuniqueid.param().abi(),
            )
    ...
    pub unsafe fn ChangeCredential<P1>(
        &self,
        hwndparent: super::super::super::super::Foundation::HWND,
        lpszuniqueid: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ChangeCredential)(
                windows_core::Interface::as_raw(self),
                hwndparent,
                lpszuniqueid.param().abi(),
            )
...
pub struct IAssociatedIdentityProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub AssociateIdentity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::super::Foundation::HWND,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub DisassociateIdentity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::super::Foundation::HWND,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub ChangeCredential: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::super::Foundation::HWND,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
...
impl IAssociatedIdentityProvider_Vtbl {
    pub const fn new<Identity: IAssociatedIdentityProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AssociateIdentity<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAssociatedIdentityProvider_Impl::AssociateIdentity(
                    this,
                    core::mem::transmute_copy(&hwndparent),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn DisassociateIdentity<
            Identity: IAssociatedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAssociatedIdentityProvider_Impl::DisassociateIdentity(
                    this,
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute(&lpszuniqueid),
                )
        ...
        unsafe extern "system" fn ChangeCredential<
            Identity: IAssociatedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAssociatedIdentityProvider_Impl::ChangeCredential(
                    this,
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute(&lpszuniqueid),
                )
...
impl IConnectedIdentityProvider {
    pub unsafe fn ConnectIdentity(&self, authbuffer: &[u8]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ConnectIdentity)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(authbuffer.as_ptr()),
                authbuffer.len().try_into().unwrap(),
            )
    ...
    pub unsafe fn DisconnectIdentity(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DisconnectIdentity)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn GetAccountState(&self) -> windows_core::Result<ACCOUNT_STATE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAccountState)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IConnectedIdentityProvider_Vtbl {
    ...
    GetUrl: usize,
    pub GetAccountState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ACCOUNT_STATE,
    ) -> windows_core::HRESULT,
}
...
impl IConnectedIdentityProvider_Vtbl {
    pub const fn new<Identity: IConnectedIdentityProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ConnectIdentity<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IConnectedIdentityProvider_Impl::ConnectIdentity(
                    this,
                    core::mem::transmute_copy(&authbuffer),
                    core::mem::transmute_copy(&authbuffersize),
                )
        ...
        unsafe extern "system" fn DisconnectIdentity<
            Identity: IConnectedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IConnectedIdentityProvider_Impl::GetUrl(
                    this,
                    core::mem::transmute_copy(&identifier),
                    core::mem::transmute_copy(&context),
                    core::mem::transmute_copy(&postdata),
        ...
        unsafe extern "system" fn GetAccountState<
            Identity: IConnectedIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl IIdentityAdvise {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).IdentityUpdated)(
                windows_core::Interface::as_raw(self),
                dwidentityupdateevents.0 as _,
                lpszuniqueid.param().abi(),
            )
            .ok()
        }
...
pub struct IIdentityAdvise_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub IdentityUpdated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
...
impl IIdentityAdvise_Vtbl {
    pub const fn new<Identity: IIdentityAdvise_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IdentityUpdated<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IIdentityAdvise_Impl::IdentityUpdated(
                    this,
                    core::mem::transmute(&dwidentityupdateevents),
                    core::mem::transmute(&lpszuniqueid),
                )
                .into()
            }
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            IdentityUpdated: IdentityUpdated::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x5e7ef254_979f_43b5_b74e_06e4eb7df0f9
);
windows_core::imp::interface_hierarchy!(IIdentityAuthentication, windows_core::IUnknown);
impl IIdentityAuthentication {
    pub unsafe fn SetIdentityCredential(
        &self,
        credbuffer: Option<&[u8]>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetIdentityCredential)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(
                    credbuffer
                        .as_deref()
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn ValidateIdentityCredential(
        &self,
        credbuffer: &[u8],
        ppidentityproperties: Option<
            *mut Option<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ValidateIdentityCredential)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(credbuffer.as_ptr()),
                credbuffer.len().try_into().unwrap(),
                ppidentityproperties.unwrap_or(core::mem::zeroed()) as _,
...
pub struct IIdentityAuthentication_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetIdentityCredential:
        unsafe extern "system" fn(*mut core::ffi::c_void, *const u8, u32) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub ValidateIdentityCredential: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const u8,
        u32,
        *mut *mut core::ffi::c_void,
...
impl IIdentityAuthentication_Vtbl {
    pub const fn new<Identity: IIdentityAuthentication_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetIdentityCredential<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IIdentityAuthentication_Impl::SetIdentityCredential(
                    this,
                    core::mem::transmute_copy(&credbuffer),
                    core::mem::transmute_copy(&credbufferlength),
                )
        ...
        unsafe extern "system" fn ValidateIdentityCredential<
            Identity: IIdentityAuthentication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IIdentityAuthentication_Impl::ValidateIdentityCredential(
                    this,
                    core::mem::transmute_copy(&credbuffer),
                    core::mem::transmute_copy(&credbufferlength),
                    core::mem::transmute_copy(&ppidentityproperties),
...
windows_core::imp::define_interface!(
    ...
    0x0d1b9e0c_e8ba_4f55_a81b_bce934b948f5
);
...
impl IIdentityProvider {
    ...
    pub unsafe fn GetIdentityEnum(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetIdentityEnum)(
                windows_core::Interface::as_raw(self),
                eidentitytype,
                pfilterkey.unwrap_or(core::mem::zeroed()) as _,
                pfilterpropvarvalue.unwrap_or(core::mem::zeroed()) as _,
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Create)(
                windows_core::Interface::as_raw(self),
                lpszusername.param().abi(),
                core::mem::transmute(pppropertystore),
                core::mem::transmute(pkeywordstoadd),
            )
            .ok()
        }
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn FindByUniqueID<P0>(
        &self,
        lpszuniqueid: P0,
    ) -> windows_core::Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindByUniqueID)(
                windows_core::Interface::as_raw(self),
                lpszuniqueid.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn GetProviderPropertyStore(
        &self,
    ) -> windows_core::Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetProviderPropertyStore)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IIdentityProvider_Vtbl {
    ...
    pub GetIdentityEnum: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        IDENTITY_TYPE,
        *const super::super::super::super::Foundation::PROPERTYKEY,
        *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT,
    ...
    Delete: usize,
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub FindByUniqueID: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub GetProviderPropertyStore: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_UI_Shell_PropertiesSystem"))]
...
pub trait IIdentityProvider_Impl: windows_core::IUnknownImpl {
    ...
    fn Create(
        &self,
        lpszusername: &windows_core::PCWSTR,
        pppropertystore: windows_core::OutRef<
            '_,
            super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore,
        >,
        pkeywordstoadd: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT,
...
impl IIdentityProvider_Vtbl {
    pub const fn new<Identity: IIdentityProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetIdentityEnum<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IIdentityProvider_Impl::GetIdentityEnum(
                    this,
                    core::mem::transmute_copy(&eidentitytype),
                    core::mem::transmute_copy(&pfilterkey),
                    core::mem::transmute_copy(&pfilterpropvarvalue),
        ...
        unsafe extern "system" fn Create<Identity: IIdentityProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpszusername: windows_core::PCWSTR,
            pppropertystore: *mut *mut core::ffi::c_void,
            pkeywordstoadd: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT,
        ...
        unsafe extern "system" fn Import<Identity: IIdentityProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppropertystore: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IIdentityProvider_Impl::Import(this, core::mem::transmute_copy(&ppropertystore))
                    .into()
            }
        }
        unsafe extern "system" fn Delete<Identity: IIdentityProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpszuniqueid: windows_core::PCWSTR,
            pkeywordstodelete: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn FindByUniqueID<
            Identity: IIdentityProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IIdentityProvider_Impl::FindByUniqueID(
                    this,
                    core::mem::transmute(&lpszuniqueid),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Advise<Identity: IIdentityProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pidentityadvise: *mut core::ffi::c_void,
            dwidentityupdateevents: u32,
            pdwcookie: *mut u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IIdentityProvider_Impl::Advise(
                    this,
                    core::mem::transmute_copy(&pidentityadvise),
                    core::mem::transmute(&dwidentityupdateevents),
                ) {
...
windows_core::imp::define_interface!(
    IIdentityStore,
    IIdentityStore_Vtbl,
    0xdf586fa5_6f35_44f1_b209_b38e169772eb
);
...
impl IIdentityStore {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddToCache)(
                windows_core::Interface::as_raw(self),
                lpszuniqueid.param().abi(),
                providerguid,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ConvertToSid)(
                windows_core::Interface::as_raw(self),
                lpszuniqueid.param().abi(),
                providerguid,
                psid.as_deref()
    ...
    pub unsafe fn EnumerateIdentities(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerateIdentities)(
                windows_core::Interface::as_raw(self),
                eidentitytype,
                pfilterkey.unwrap_or(core::mem::zeroed()) as _,
                pfilterpropvarvalue.unwrap_or(core::mem::zeroed()) as _,
...
pub struct IIdentityStore_Vtbl {
    ...
    pub AddToCache: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub ConvertToSid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const windows_core::GUID,
        u16,
    ...
    pub EnumerateIdentities: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        IDENTITY_TYPE,
        *const super::super::super::super::Foundation::PROPERTYKEY,
        *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT,
...
impl IIdentityStore_Vtbl {
    pub const fn new<Identity: IIdentityStore_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCount<Identity: IIdentityStore_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwproviders: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetAt<Identity: IIdentityStore_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwprovider: u32,
            pprovguid: *mut windows_core::GUID,
            ppidentityprovider: *mut *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AddToCache<Identity: IIdentityStore_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpszuniqueid: windows_core::PCWSTR,
            providerguid: *const windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IIdentityStore_Impl::AddToCache(
                    this,
                    core::mem::transmute(&lpszuniqueid),
                    core::mem::transmute_copy(&providerguid),
                )
        ...
        unsafe extern "system" fn ConvertToSid<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IIdentityStore_Impl::ConvertToSid(
                    this,
                    core::mem::transmute(&lpszuniqueid),
                    core::mem::transmute_copy(&providerguid),
                    core::mem::transmute_copy(&cbsid),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IIdentityStore_Impl::EnumerateIdentities(
                    this,
                    core::mem::transmute_copy(&eidentitytype),
                    core::mem::transmute_copy(&pfilterkey),
                    core::mem::transmute_copy(&pfilterpropvarvalue),
        ...
        unsafe extern "system" fn Reset<Identity: IIdentityStore_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
impl IIdentityStoreEx {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CreateConnectedIdentity)(
                windows_core::Interface::as_raw(self),
                localname.param().abi(),
                connectedname.param().abi(),
                providerguid,
    ...
    pub unsafe fn DeleteConnectedIdentity<P0>(
        &self,
        connectedname: P0,
        providerguid: *const windows_core::GUID,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteConnectedIdentity)(
                windows_core::Interface::as_raw(self),
                connectedname.param().abi(),
                providerguid,
            )
...
pub struct IIdentityStoreEx_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateConnectedIdentity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub DeleteConnectedIdentity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IIdentityStoreEx_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IIdentityStoreEx_Impl::CreateConnectedIdentity(
                    this,
                    core::mem::transmute(&localname),
                    core::mem::transmute(&connectedname),
                    core::mem::transmute_copy(&providerguid),
        ...
        unsafe extern "system" fn DeleteConnectedIdentity<
            Identity: IIdentityStoreEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IIdentityStoreEx_Impl::DeleteConnectedIdentity(
                    this,
                    core::mem::transmute(&connectedname),
                    core::mem::transmute_copy(&providerguid),
                )
...
pub const OID_OAssociatedIdentityProviderObject: windows_core::GUID =
    windows_core::GUID::from_u128(0x98c5a3dd_db68_4f1a_8d2b_9079cdfeaf61);
pub const STR_COMPLETE_ACCOUNT: windows_core::PCWSTR = windows_core::w!("CompleteAccount");
pub const STR_MODERN_SETTINGS_ADD_USER: windows_core::PCWSTR =
    windows_core::w!("ModernSettingsAddUser");
...
pub const STR_OUT_OF_BOX_UPGRADE_EXPERIENCE: windows_core::PCWSTR =
    windows_core::w!("OutOfBoxUpgradeExperience");

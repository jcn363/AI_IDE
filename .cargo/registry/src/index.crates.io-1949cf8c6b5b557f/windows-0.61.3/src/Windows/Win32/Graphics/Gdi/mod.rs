...
pub unsafe fn AddFontMemResourceEx(
    ...
    cjsize: u32,
    pvresrved: Option<*const core::ffi::c_void>,
    pnumfonts: *const u32,
    ...
    unsafe {
        AddFontMemResourceEx(
            pfileview,
            cjsize,
            pvresrved.unwrap_or(core::mem::zeroed()) as _,
            pnumfonts,
        )
    }
}
...
pub unsafe fn AddFontResourceExA<P0>(
    ...
    res: Option<*const core::ffi::c_void>,
) -> i32
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        AddFontResourceExA(
            name.param().abi(),
            fl,
            res.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn AlphaBlend(
    ...
    unsafe {
        AlphaBlend(
            ...
            wsrc,
            hsrc,
            core::mem::transmute(ftn),
        )
    }
}
#[inline]
pub unsafe fn AngleArc(
    hdc: HDC,
    x: i32,
    y: i32,
    r: u32,
...
pub unsafe fn AnimatePalette(
    ...
    unsafe {
        AnimatePalette(
            hpal,
            istartindex,
            ppe.len().try_into().unwrap(),
            core::mem::transmute(ppe.as_ptr()),
        )
    }
}
#[inline]
...
pub unsafe fn ChangeDisplaySettingsA(
    lpdevmode: Option<*const DEVMODEA>,
    dwflags: CDS_TYPE,
) -> DISP_CHANGE {
...
#[inline]
pub unsafe fn ChangeDisplaySettingsExA<P0>(
    lpszdevicename: P0,
    lpdevmode: Option<*const DEVMODEA>,
    hwnd: Option<super::super::Foundation::HWND>,
    dwflags: CDS_TYPE,
    lparam: Option<*const core::ffi::c_void>,
) -> DISP_CHANGE
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        ChangeDisplaySettingsExA(
            lpszdevicename.param().abi(),
            lpdevmode.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn ChangeDisplaySettingsExW<P0>(
    lpszdevicename: P0,
...
pub unsafe fn CombineRgn(
    hrgndst: Option<HRGN>,
    hrgnsrc1: Option<HRGN>,
    hrgnsrc2: Option<HRGN>,
    ...
    unsafe {
        CombineRgn(
            hrgndst.unwrap_or(core::mem::zeroed()) as _,
            hrgnsrc1.unwrap_or(core::mem::zeroed()) as _,
            hrgnsrc2.unwrap_or(core::mem::zeroed()) as _,
            imode,
        )
    }
}
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CreateDCA(
            pwszdriver.param().abi(),
            pwszdevice.param().abi(),
            pszport.param().abi(),
            pdm.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn CreateDIBPatternBrush(
    h: super::super::Foundation::HGLOBAL,
    iusage: DIB_USAGE,
) -> HBRUSH {
...
pub unsafe fn CreateDIBSection(
    ...
    hsection: Option<super::super::Foundation::HANDLE>,
    offset: u32,
...
#[inline]
pub unsafe fn CreateDIBitmap(
    hdc: HDC,
    pbmih: Option<*const BITMAPINFOHEADER>,
    flinit: u32,
    pjbits: Option<*const core::ffi::c_void>,
    pbmi: Option<*const BITMAPINFO>,
    iusage: DIB_USAGE,
) -> HBITMAP {
    ...
    unsafe {
        CreateDIBitmap(
            hdc,
            pbmih.unwrap_or(core::mem::zeroed()) as _,
            flinit,
            pjbits.unwrap_or(core::mem::zeroed()) as _,
            pbmi.unwrap_or(core::mem::zeroed()) as _,
            iusage,
        )
    }
}
...
#[inline]
pub unsafe fn CreateEnhMetaFileA<P1, P3>(
    hdc: Option<HDC>,
    lpfilename: P1,
    lprc: Option<*const super::super::Foundation::RECT>,
    lpdesc: P3,
) -> HDC
where
    P1: windows_core::Param<windows_core::PCSTR>,
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CreateEnhMetaFileA(
            ...
            lprc.unwrap_or(core::mem::zeroed()) as _,
            lpdesc.param().abi(),
        )
    }
}
    ...
    P13: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CreateFontA(
            ...
            bstrikeout,
            icharset.0 as _,
            ioutprecision.0 as _,
            iclipprecision.0 as _,
            iquality.0 as _,
            ipitchandfamily,
...
pub unsafe fn CreateFontPackage(
    ...
    unsafe {
        CreateFontPackage(
            puchsrcbuffer,
            ulsrcbuffersize,
            ppuchfontpackagebuffer as _,
            pulfontpackagebuffersize as _,
            pulbyteswritten as _,
            usflag,
            usttcindex,
            ussubsetformat,
            ussubsetlanguage,
...
#[inline]
pub unsafe fn CreateHatchBrush(
...
pub unsafe fn CreatePolyPolygonRgn(
    ...
    unsafe {
        CreatePolyPolygonRgn(
            pptl,
            core::mem::transmute(pc.as_ptr()),
            pc.len().try_into().unwrap(),
            imode,
        )
    }
}
...
pub unsafe fn CreatePolygonRgn(
    pptl: &[super::super::Foundation::POINT],
    imode: CREATE_POLYGON_RGN_MODE,
) -> HRGN {
    ...
    unsafe {
        CreatePolygonRgn(
            core::mem::transmute(pptl.as_ptr()),
            pptl.len().try_into().unwrap(),
            imode,
        )
    }
}
...
#[inline]
pub unsafe fn CreateScalableFontResourceA<P1, P2, P3>(
    fdwhidden: u32,
    lpszfont: P1,
    lpszfile: P2,
    lpszpath: P3,
...
#[inline]
pub unsafe fn CreateScalableFontResourceW<P1, P2, P3>(
    fdwhidden: u32,
    lpszfont: P1,
    lpszfile: P2,
    lpszpath: P3,
...
pub unsafe fn DPtoLP(hdc: HDC, lppt: &mut [super::super::Foundation::POINT]) -> windows_core::BOOL {
    ...
    unsafe {
        DPtoLP(
            hdc,
            core::mem::transmute(lppt.as_ptr()),
            lppt.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn DrawFrameControl(
    param0: HDC,
...
pub unsafe fn DrawStateA(
    ...
    unsafe {
        DrawStateA(
            hdc,
            hbrfore.unwrap_or(core::mem::zeroed()) as _,
            qfncallback,
            ldata,
            wdata,
            x,
...
pub unsafe fn DrawTextA(
    ...
    unsafe {
        DrawTextA(
            hdc,
            core::mem::transmute(lpchtext.as_ptr()),
            lpchtext.len().try_into().unwrap(),
            lprc as _,
            format,
        )
    }
...
pub unsafe fn DrawTextExA(
    ...
    unsafe {
        DrawTextExA(
            ...
            lprc as _,
            format,
            lpdtp.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn EnumDisplayDevicesA<P0>(
    lpdevice: P0,
    idevnum: u32,
...
#[inline]
pub unsafe fn EnumDisplaySettingsA<P0>(
    lpszdevicename: P0,
...
#[inline]
pub unsafe fn EnumDisplaySettingsExA<P0>(
    lpszdevicename: P0,
    imodenum: ENUM_DISPLAY_SETTINGS_MODE,
    lpdevmode: *mut DEVMODEA,
...
#[inline]
pub unsafe fn EnumDisplaySettingsExW<P0>(
    lpszdevicename: P0,
    imodenum: ENUM_DISPLAY_SETTINGS_MODE,
...
pub unsafe fn EnumEnhMetaFile(
    ...
    hmf: HENHMETAFILE,
    proc: ENHMFENUMPROC,
    param3: Option<*const core::ffi::c_void>,
...
#[inline]
pub unsafe fn EnumFontFamiliesW<P1>(
    hdc: HDC,
    lplogfont: P1,
    lpproc: FONTENUMPROCW,
    lparam: super::super::Foundation::LPARAM,
...
pub unsafe fn EnumMetaFile(
    ...
    hmf: HMETAFILE,
    proc: MFENUMPROC,
    param3: Option<super::super::Foundation::LPARAM>,
) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn ExtCreateRegion(
    lpx: Option<*const XFORM>,
    ncount: u32,
    ...
    P5: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        ExtTextOutA(
            ...
            lpstring.param().abi(),
            c,
            lpdx.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn FixBrushOrgEx(
    ...
    x: i32,
    y: i32,
    ptl: Option<*const super::super::Foundation::POINT>,
) -> windows_core::BOOL {
...
pub unsafe fn GdiGradientFill(
    ...
    unsafe {
        GdiGradientFill(
            hdc,
            core::mem::transmute(pvertex.as_ptr()),
            pvertex.len().try_into().unwrap(),
            pmesh,
            ncount,
            ulmode,
        )
...
#[inline]
pub unsafe fn GetAspectRatioFilterEx(
    hdc: HDC,
...
#[inline]
pub unsafe fn GetCharABCWidthsA(
    hdc: HDC,
    wfirst: u32,
    wlast: u32,
    lpabc: *mut ABC,
...
#[inline]
pub unsafe fn GetCharABCWidthsFloatA(
    hdc: HDC,
    ifirst: u32,
    ilast: u32,
    lpabc: *mut ABCFLOAT,
...
#[inline]
pub unsafe fn GetCharABCWidthsFloatW(
    hdc: HDC,
    ifirst: u32,
    ilast: u32,
    lpabc: *mut ABCFLOAT,
...
#[inline]
pub unsafe fn GetCharABCWidthsI(
    hdc: HDC,
    gifirst: u32,
    cgi: u32,
    ...
    unsafe {
        GetCharABCWidthsI(
            ...
            gifirst,
            cgi,
            pgi.unwrap_or(core::mem::zeroed()) as _,
            pabc as _,
        )
    }
}
#[inline]
pub unsafe fn GetCharABCWidthsW(
    hdc: HDC,
    wfirst: u32,
    wlast: u32,
    lpabc: *mut ABC,
...
#[inline]
pub unsafe fn GetCharWidthFloatA(
    hdc: HDC,
    ifirst: u32,
    ilast: u32,
    lpbuffer: *mut f32,
...
#[inline]
pub unsafe fn GetCharWidthFloatW(
    hdc: HDC,
    ifirst: u32,
    ilast: u32,
    lpbuffer: *mut f32,
...
pub unsafe fn GetDCEx(
    ...
    unsafe {
        GetDCEx(
            hwnd.unwrap_or(core::mem::zeroed()) as _,
            hrgnclip.unwrap_or(core::mem::zeroed()) as _,
            flags,
        )
    }
}
#[inline]
pub unsafe fn GetDCOrgEx(
    hdc: HDC,
    lppt: *mut super::super::Foundation::POINT,
) -> windows_core::BOOL {
...
pub unsafe fn GetDIBColorTable(hdc: HDC, istart: u32, prgbq: &mut [RGBQUAD]) -> u32 {
    ...
    unsafe {
        GetDIBColorTable(
            hdc,
            istart,
            prgbq.len().try_into().unwrap(),
            core::mem::transmute(prgbq.as_ptr()),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn GetEnhMetaFileHeader(
    hemf: HENHMETAFILE,
    nsize: u32,
    lpenhmetaheader: Option<*mut ENHMETAHEADER>,
) -> u32 {
    ...
    unsafe {
        GetEnhMetaFileHeader(
            hemf,
            nsize,
            lpenhmetaheader.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn GetEnhMetaFilePaletteEntries(
    hemf: HENHMETAFILE,
    lppaletteentries: Option<&mut [PALETTEENTRY]>,
) -> u32 {
...
#[inline]
pub unsafe fn GetGlyphOutlineA(
    hdc: HDC,
    uchar: u32,
...
#[inline]
pub unsafe fn GetMetaFileBitsEx(
    hmf: HMETAFILE,
    cbbuffer: u32,
    lpdata: Option<*mut core::ffi::c_void>,
) -> u32 {
...
#[inline]
pub unsafe fn GetNearestPaletteIndex(
    h: HPALETTE,
    color: super::super::Foundation::COLORREF,
) -> u32 {
...
#[inline]
pub unsafe fn GetOutlineTextMetricsA(
    hdc: HDC,
    cjcopy: u32,
...
#[inline]
pub unsafe fn GetOutlineTextMetricsW(
    hdc: HDC,
    cjcopy: u32,
...
pub unsafe fn GetPath(
    hdc: HDC,
    apt: Option<*mut super::super::Foundation::POINT>,
    aj: Option<*mut u8>,
    cpt: i32,
) -> i32 {
    ...
    unsafe {
        GetPath(
            hdc,
            apt.unwrap_or(core::mem::zeroed()) as _,
            aj.unwrap_or(core::mem::zeroed()) as _,
            cpt,
        )
    }
}
...
#[inline]
pub unsafe fn GetSystemPaletteEntries(
    hdc: HDC,
    istart: u32,
    ppalentries: Option<&mut [PALETTEENTRY]>,
) -> u32 {
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        GetTextExtentExPointA(
            hdc,
            lpszstring.param().abi(),
            cchstring,
            nmaxextent,
            lpnfit.unwrap_or(core::mem::zeroed()) as _,
            lpndx.unwrap_or(core::mem::zeroed()) as _,
            lpsize as _,
        )
    }
}
#[inline]
pub unsafe fn GetTextExtentExPointI(
    hdc: HDC,
...
#[inline]
pub unsafe fn GetTextExtentExPointW<P1>(
    hdc: HDC,
    lpszstring: P1,
    cchstring: i32,
    nmaxextent: i32,
...
#[inline]
pub unsafe fn GetTextExtentPointI(
    hdc: HDC,
    pgiin: &[u16],
    ...
    unsafe {
        GetTextExtentPointI(
            hdc,
            core::mem::transmute(pgiin.as_ptr()),
            pgiin.len().try_into().unwrap(),
            psize as _,
        )
    }
}
...
pub unsafe fn GetUpdateRect(
    hwnd: super::super::Foundation::HWND,
    lprect: Option<*mut super::super::Foundation::RECT>,
    berase: bool,
) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn GetViewportExtEx(
    hdc: HDC,
    lpsize: *mut super::super::Foundation::SIZE,
) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn GetViewportOrgEx(
    hdc: HDC,
    lppoint: *mut super::super::Foundation::POINT,
) -> windows_core::BOOL {
...
pub unsafe fn GrayStringA(
    ...
    unsafe {
        GrayStringA(
            hdc,
            hbrush.unwrap_or(core::mem::zeroed()) as _,
            lpoutputfunc,
            lpdata,
            ncount,
            x,
...
pub unsafe fn LineDDA(
    ...
    yend: i32,
    lpproc: LINEDDAPROC,
    data: Option<super::super::Foundation::LPARAM>,
) -> windows_core::BOOL {
...
pub unsafe fn MapWindowPoints(
    hwndfrom: Option<super::super::Foundation::HWND>,
    hwndto: Option<super::super::Foundation::HWND>,
    ...
    unsafe {
        MapWindowPoints(
            hwndfrom.unwrap_or(core::mem::zeroed()) as _,
            hwndto.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(lppoints.as_ptr()),
            lppoints.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
pub unsafe fn MergeFontPackage(
    ...
    unsafe {
        MergeFontPackage(
            ...
            ppuchdestbuffer as _,
            puldestbuffersize as _,
            pulbyteswritten as _,
            usmode,
            lpfnallocate,
            lpfnreallocate,
...
#[inline]
pub unsafe fn ModifyWorldTransform(
    hdc: HDC,
    lpxf: Option<*const XFORM>,
...
pub unsafe fn MoveToEx(
    ...
    x: i32,
    y: i32,
    lppt: Option<*mut super::super::Foundation::POINT>,
) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn OffsetViewportOrgEx(
    hdc: HDC,
    x: i32,
    y: i32,
    lppt: Option<*mut super::super::Foundation::POINT>,
...
#[inline]
pub unsafe fn PlayEnhMetaFileRecord(
    hdc: HDC,
    pht: &[HANDLETABLE],
    ...
    unsafe {
        PlayEnhMetaFileRecord(
            hdc,
            core::mem::transmute(pht.as_ptr()),
            pmr,
            pht.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn PlayMetaFileRecord(
    hdc: HDC,
    ...
    unsafe {
        PlayMetaFileRecord(
            hdc,
            core::mem::transmute(lphandletable.as_ptr()),
            lpmr,
            lphandletable.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn PlgBlt(
    hdcdest: HDC,
    lppoint: &[super::super::Foundation::POINT; 3],
    hdcsrc: HDC,
    xsrc: i32,
    ysrc: i32,
    width: i32,
    height: i32,
    hbmmask: Option<HBITMAP>,
    xmask: i32,
    ymask: i32,
) -> windows_core::BOOL {
    ...
    unsafe {
        PlgBlt(
            hdcdest,
            core::mem::transmute(lppoint.as_ptr()),
            hdcsrc,
            xsrc,
            ysrc,
            width,
...
pub unsafe fn PolyBezier(hdc: HDC, apt: &[super::super::Foundation::POINT]) -> windows_core::BOOL {
    ...
    unsafe {
        PolyBezier(
            hdc,
            core::mem::transmute(apt.as_ptr()),
            apt.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn PolyBezierTo(
    hdc: HDC,
    apt: &[super::super::Foundation::POINT],
) -> windows_core::BOOL {
...
pub unsafe fn PolyPolygon(
    ...
    unsafe {
        PolyPolygon(
            hdc,
            apt,
            core::mem::transmute(asz.as_ptr()),
            asz.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
pub unsafe fn PolyTextOutA(hdc: HDC, ppt: &[POLYTEXTA]) -> windows_core::BOOL {
    ...
    unsafe {
        PolyTextOutA(
            hdc,
            core::mem::transmute(ppt.as_ptr()),
            ppt.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
pub unsafe fn RedrawWindow(
    hwnd: Option<super::super::Foundation::HWND>,
    lprcupdate: Option<*const super::super::Foundation::RECT>,
...
pub unsafe fn RemoveFontResourceExA<P0>(
    name: P0,
    fl: u32,
    pdv: Option<*const core::ffi::c_void>,
) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        RemoveFontResourceExA(
            name.param().abi(),
            fl,
            pdv.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn ScaleViewportExtEx(
    hdc: HDC,
    xn: i32,
    dx: i32,
    yn: i32,
    yd: i32,
    lpsz: Option<*mut super::super::Foundation::SIZE>,
) -> windows_core::BOOL {
    ...
    unsafe {
        ScaleViewportExtEx(
            ...
            yn,
            yd,
            lpsz.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn ScaleWindowExtEx(
    hdc: HDC,
    xn: i32,
    xd: i32,
    yn: i32,
...
#[inline]
pub unsafe fn SetDIBitsToDevice(
    hdc: HDC,
    xdest: i32,
    ydest: i32,
    w: u32,
...
pub unsafe fn SetPaletteEntries(hpal: HPALETTE, istart: u32, ppalentries: &[PALETTEENTRY]) -> u32 {
    ...
    unsafe {
        SetPaletteEntries(
            hpal,
            istart,
            ppalentries.len().try_into().unwrap(),
            core::mem::transmute(ppalentries.as_ptr()),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn SetViewportExtEx(
    hdc: HDC,
    x: i32,
    y: i32,
    lpsz: Option<*mut super::super::Foundation::SIZE>,
...
#[inline]
pub unsafe fn SetViewportOrgEx(
    hdc: HDC,
    x: i32,
    y: i32,
    lppt: Option<*mut super::super::Foundation::POINT>,
...
pub unsafe fn TTCharToUnicode(
    ...
    unsafe {
        TTCharToUnicode(
            hdc,
            core::mem::transmute(puccharcodes.as_ptr()),
            puccharcodes.len().try_into().unwrap(),
            core::mem::transmute(pusshortcodes.as_ptr()),
            pusshortcodes.len().try_into().unwrap(),
            ulflags,
        )
    }
}
...
pub unsafe fn TTEmbedFont(
    ...
    unsafe {
        TTEmbedFont(
            ...
            lpfnwritetostream,
            lpvwritestream,
            core::mem::transmute(puscharcodeset.as_ptr()),
            puscharcodeset.len().try_into().unwrap(),
            uslanguage,
            pttembedinfo.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn TTEmbedFontEx(
    hdc: HDC,
    ulflags: TTEMBED_FLAGS,
    ulcharset: EMBED_FONT_CHARSET,
    pulprivstatus: *mut EMBEDDED_FONT_PRIV_STATUS,
    ...
    unsafe {
        TTEmbedFontEx(
            ...
            lpfnwritetostream,
            lpvwritestream,
            core::mem::transmute(pulcharcodeset.as_ptr()),
            pulcharcodeset.len().try_into().unwrap(),
            uslanguage,
            pttembedinfo.unwrap_or(core::mem::zeroed()) as _,
        )
    }
...
#[inline]
pub unsafe fn TTEmbedFontFromFileA<P1>(
    hdc: HDC,
    szfontfilename: P1,
    usttcindex: u16,
    ulflags: TTEMBED_FLAGS,
...
pub unsafe fn TTGetEmbeddedFontInfo(
    ...
    pttloadinfo: Option<*const TTLOADINFO>,
) -> i32 {
    ...
    unsafe {
        TTGetEmbeddedFontInfo(
            ...
            lpfnreadfromstream,
            lpvreadstream,
            pttloadinfo.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn TTGetNewFontName(
    ...
    wzwinfamilyname: &mut [u16],
    szmacfamilyname: &mut [u8],
) -> i32 {
    ...
    unsafe {
        TTGetNewFontName(
            phfontreference,
            core::mem::transmute(wzwinfamilyname.as_ptr()),
            wzwinfamilyname.len().try_into().unwrap(),
            core::mem::transmute(szmacfamilyname.as_ptr()),
            szmacfamilyname.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn TTLoadEmbeddedFont<P7, P8>(
    ...
    P8: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        TTLoadEmbeddedFont(
            ...
            lpfnreadfromstream,
            lpvreadstream,
            szwinfamilyname.param().abi(),
            szmacfamilyname.param().abi(),
            pttloadinfo.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
#[inline]
pub unsafe fn TTRunValidationTestsEx(
    hdc: HDC,
...
pub const DISPLAY_DEVICE_ATTACHED_TO_DESKTOP: DISPLAY_DEVICE_STATE_FLAGS =
    DISPLAY_DEVICE_STATE_FLAGS(1u32);
pub const DISPLAY_DEVICE_DISCONNECT: DISPLAY_DEVICE_STATE_FLAGS =
    DISPLAY_DEVICE_STATE_FLAGS(33554432u32);
pub const DISPLAY_DEVICE_MIRRORING_DRIVER: DISPLAY_DEVICE_STATE_FLAGS =
    DISPLAY_DEVICE_STATE_FLAGS(8u32);
pub const DISPLAY_DEVICE_MODESPRUNED: DISPLAY_DEVICE_STATE_FLAGS =
    DISPLAY_DEVICE_STATE_FLAGS(134217728u32);
pub const DISPLAY_DEVICE_MULTI_DRIVER: DISPLAY_DEVICE_STATE_FLAGS =
    DISPLAY_DEVICE_STATE_FLAGS(2u32);
pub const DISPLAY_DEVICE_PRIMARY_DEVICE: DISPLAY_DEVICE_STATE_FLAGS =
    DISPLAY_DEVICE_STATE_FLAGS(4u32);
pub const DISPLAY_DEVICE_RDPUDD: DISPLAY_DEVICE_STATE_FLAGS =
    DISPLAY_DEVICE_STATE_FLAGS(16777216u32);
pub const DISPLAY_DEVICE_REMOTE: DISPLAY_DEVICE_STATE_FLAGS =
    DISPLAY_DEVICE_STATE_FLAGS(67108864u32);
...
pub const DISPLAY_DEVICE_TS_COMPATIBLE: DISPLAY_DEVICE_STATE_FLAGS =
    DISPLAY_DEVICE_STATE_FLAGS(2097152u32);
pub const DISPLAY_DEVICE_UNSAFE_MODES_ON: DISPLAY_DEVICE_STATE_FLAGS =
    DISPLAY_DEVICE_STATE_FLAGS(524288u32);
pub const DISPLAY_DEVICE_VGA_COMPATIBLE: DISPLAY_DEVICE_STATE_FLAGS =
    DISPLAY_DEVICE_STATE_FLAGS(16u32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const EMR_COLORCORRECTPALETTE: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(111u32);
pub const EMR_COLORMATCHTOTARGETW: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(121u32);
pub const EMR_CREATEBRUSHINDIRECT: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(39u32);
pub const EMR_CREATECOLORSPACE: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(99u32);
pub const EMR_CREATECOLORSPACEW: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(122u32);
pub const EMR_CREATEDIBPATTERNBRUSHPT: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(94u32);
...
pub const EMR_DELETECOLORSPACE: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(101u32);
...
pub const EMR_EXTCREATEFONTINDIRECTW: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(82u32);
...
pub const EMR_EXTSELECTCLIPRGN: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(75u32);
...
pub const EMR_GLSBOUNDEDRECORD: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(103u32);
...
pub const EMR_INTERSECTCLIPRECT: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(30u32);
...
pub const EMR_MODIFYWORLDTRANSFORM: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(36u32);
...
pub const EMR_SCALEVIEWPORTEXTEX: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(31u32);
pub const EMR_SCALEWINDOWEXTEX: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(32u32);
...
pub const EMR_SETCOLORADJUSTMENT: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(23u32);
pub const EMR_SETCOLORSPACE: ENHANCED_METAFILE_RECORD_TYPE = ENHANCED_METAFILE_RECORD_TYPE(100u32);
pub const EMR_SETDIBITSTODEVICE: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(80u32);
...
pub const EMR_SETPALETTEENTRIES: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(50u32);
...
pub const EMR_SETSTRETCHBLTMODE: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(21u32);
...
pub const EMR_SETVIEWPORTEXTEX: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(11u32);
pub const EMR_SETVIEWPORTORGEX: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(12u32);
...
pub const EMR_SETWORLDTRANSFORM: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(35u32);
...
pub const EMR_STROKEANDFILLPATH: ENHANCED_METAFILE_RECORD_TYPE =
    ENHANCED_METAFILE_RECORD_TYPE(63u32);
...
pub const TTFCFP_ISO_PLATFORMID: CREATE_FONT_PACKAGE_SUBSET_PLATFORM =
    CREATE_FONT_PACKAGE_SUBSET_PLATFORM(2i16);
...
pub const TTFCFP_STD_MAC_CHAR_SET: CREATE_FONT_PACKAGE_SUBSET_ENCODING =
    CREATE_FONT_PACKAGE_SUBSET_ENCODING(0i16);
...
pub const TTFCFP_UNICODE_CHAR_SET: CREATE_FONT_PACKAGE_SUBSET_ENCODING =
    CREATE_FONT_PACKAGE_SUBSET_ENCODING(1i16);
pub const TTFCFP_UNICODE_PLATFORMID: CREATE_FONT_PACKAGE_SUBSET_PLATFORM =
    CREATE_FONT_PACKAGE_SUBSET_PLATFORM(0i16);

...
windows_core::imp::define_interface!(
    ...
    0x29c687dc_de74_4e3b_ab00_1168f2fc3cfc
);
...
impl IDMLBindingTable {
    pub unsafe fn BindInputs(&self, bindings: Option<&[DML_BINDING_DESC]>) {
        unsafe {
            (windows_core::Interface::vtable(self).BindInputs)(
    ...
    pub unsafe fn BindOutputs(&self, bindings: Option<&[DML_BINDING_DESC]>) {
        unsafe {
            (windows_core::Interface::vtable(self).BindOutputs)(
                windows_core::Interface::as_raw(self),
                bindings
                    .as_deref()
                    .map_or(0, |slice| slice.len().try_into().unwrap()),
    ...
    pub unsafe fn BindTemporaryResource(&self, binding: Option<*const DML_BINDING_DESC>) {
        unsafe {
            (windows_core::Interface::vtable(self).BindTemporaryResource)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn BindPersistentResource(&self, binding: Option<*const DML_BINDING_DESC>) {
        unsafe {
            (windows_core::Interface::vtable(self).BindPersistentResource)(
                windows_core::Interface::as_raw(self),
                binding.unwrap_or(core::mem::zeroed()) as _,
            )
        }
    ...
    pub unsafe fn Reset(
        &self,
        desc: Option<*const DML_BINDING_TABLE_DESC>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Reset)(
                windows_core::Interface::as_raw(self),
                desc.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
...
pub struct IDMLBindingTable_Vtbl {
    ...
    pub BindOutputs:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *const DML_BINDING_DESC),
    pub BindTemporaryResource:
        unsafe extern "system" fn(*mut core::ffi::c_void, *const DML_BINDING_DESC),
    pub BindPersistentResource:
        unsafe extern "system" fn(*mut core::ffi::c_void, *const DML_BINDING_DESC),
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub Reset: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const DML_BINDING_TABLE_DESC,
...
impl IDMLBindingTable_Vtbl {
    pub const fn new<Identity: IDMLBindingTable_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BindInputs<
        ...
        >(
            ...
            unsafe {
                ...
                IDMLBindingTable_Impl::BindInputs(
                    this,
                    core::mem::transmute_copy(&bindingcount),
                    core::mem::transmute_copy(&bindings),
                )
            }
        }
        unsafe extern "system" fn BindOutputs<
            Identity: IDMLBindingTable_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLBindingTable_Impl::BindOutputs(
                    this,
                    core::mem::transmute_copy(&bindingcount),
                    core::mem::transmute_copy(&bindings),
                )
        ...
        unsafe extern "system" fn BindTemporaryResource<
            Identity: IDMLBindingTable_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLBindingTable_Impl::BindTemporaryResource(
                    this,
                    core::mem::transmute_copy(&binding),
                )
            }
        }
        unsafe extern "system" fn BindPersistentResource<
            Identity: IDMLBindingTable_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLBindingTable_Impl::BindPersistentResource(
                    this,
                    core::mem::transmute_copy(&binding),
                )
            }
        }
        unsafe extern "system" fn Reset<Identity: IDMLBindingTable_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IDMLBindingTable as windows_core::Interface>::IID
            || iid == &<IDMLObject as windows_core::Interface>::IID
            || iid == &<IDMLDeviceChild as windows_core::Interface>::IID
    }
}
#[cfg(feature = "Win32_Graphics_Direct3D12")]
...
windows_core::imp::define_interface!(
    IDMLCommandRecorder,
    IDMLCommandRecorder_Vtbl,
    0xe6857a76_2e3e_4fdd_bff4_5d2ba10fb453
);
...
impl IDMLCommandRecorder {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RecordDispatch)(
                windows_core::Interface::as_raw(self),
                commandlist.param().abi(),
                dispatchable.param().abi(),
                bindings.param().abi(),
            )
        }
    }
...
pub struct IDMLCommandRecorder_Vtbl {
    pub base__: IDMLDeviceChild_Vtbl,
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub RecordDispatch: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
pub trait IDMLCommandRecorder_Impl: IDMLDeviceChild_Impl {
    fn RecordDispatch(
        &self,
        commandlist: windows_core::Ref<
            '_,
            super::super::super::Graphics::Direct3D12::ID3D12CommandList,
        >,
        dispatchable: windows_core::Ref<'_, IDMLDispatchable>,
        bindings: windows_core::Ref<'_, IDMLBindingTable>,
    );
}
#[cfg(feature = "Win32_Graphics_Direct3D12")]
impl IDMLCommandRecorder_Vtbl {
    pub const fn new<Identity: IDMLCommandRecorder_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RecordDispatch<
            Identity: IDMLCommandRecorder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            commandlist: *mut core::ffi::c_void,
            dispatchable: *mut core::ffi::c_void,
            bindings: *mut core::ffi::c_void,
        ) {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLCommandRecorder_Impl::RecordDispatch(
                    this,
                    core::mem::transmute_copy(&commandlist),
                    core::mem::transmute_copy(&dispatchable),
                    core::mem::transmute_copy(&bindings),
                )
            }
        }
        Self {
            base__: IDMLDeviceChild_Vtbl::new::<Identity, OFFSET>(),
            RecordDispatch: RecordDispatch::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IDMLCommandRecorder as windows_core::Interface>::IID
            || iid == &<IDMLObject as windows_core::Interface>::IID
            || iid == &<IDMLDeviceChild as windows_core::Interface>::IID
    }
}
...
windows_core::imp::define_interface!(
    ...
    IDMLCompiledOperator_Vtbl,
    0x6b15e56a_bf5c_4902_92d8_da3a650afea4
);
...
impl IDMLCompiledOperator_Vtbl {
    pub const fn new<Identity: IDMLCompiledOperator_Impl, const OFFSET: isize>() -> Self {
        Self {
            base__: IDMLDispatchable_Vtbl::new::<Identity, OFFSET>(),
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IDMLCompiledOperator as windows_core::Interface>::IID
            || iid == &<IDMLObject as windows_core::Interface>::IID
            || iid == &<IDMLDeviceChild as windows_core::Interface>::IID
            || iid == &<IDMLPageable as windows_core::Interface>::IID
            || iid == &<IDMLDispatchable as windows_core::Interface>::IID
    }
}
...
windows_core::imp::define_interface!(
    ...
    0x7d6f3ac9_394a_4ac3_92a7_390cc57a8217
);
...
windows_core::imp::define_interface!(
    IDMLDevice,
    IDMLDevice_Vtbl,
    0x6dbd6437_96fd_423f_a98c_ae5e7c2a573f
);
...
impl IDMLDevice {
    pub unsafe fn CheckFeatureSupport(
        ...
        featurequerydata: Option<*const core::ffi::c_void>,
        featuresupportdatasize: u32,
        featuresupportdata: *mut core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CheckFeatureSupport)(
                ...
                featurequerydata.unwrap_or(core::mem::zeroed()) as _,
                featuresupportdatasize,
                featuresupportdata as _,
            )
            .ok()
        }
    }
    pub unsafe fn CreateOperator<T>(
        &self,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CreateOperator)(
                windows_core::Interface::as_raw(self),
                desc,
                &T::IID,
                result__ as *mut _ as *mut _,
    ...
    pub unsafe fn CompileOperator<P0, T>(
        &self,
        op: P0,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CompileOperator)(
                windows_core::Interface::as_raw(self),
                op.param().abi(),
                flags,
                &T::IID,
    ...
    pub unsafe fn CreateOperatorInitializer<T>(
        &self,
        operators: Option<&[Option<IDMLCompiledOperator>]>,
        ...
        T: windows_core::Interface,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(self).CreateOperatorInitializer)(
                windows_core::Interface::as_raw(self),
                operators
                    .as_deref()
                    .map_or(0, |slice| slice.len().try_into().unwrap()),
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).CreateCommandRecorder)(
                windows_core::Interface::as_raw(self),
                &T::IID,
                &mut result__,
            )
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub unsafe fn CreateBindingTable<T>(
        &self,
        desc: Option<*const DML_BINDING_TABLE_DESC>,
    ) -> windows_core::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).CreateBindingTable)(
                windows_core::Interface::as_raw(self),
                desc.unwrap_or(core::mem::zeroed()) as _,
                &T::IID,
                &mut result__,
    ...
    pub unsafe fn Evict(&self, ppobjects: &[Option<IDMLPageable>]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Evict)(
                windows_core::Interface::as_raw(self),
                ppobjects.len().try_into().unwrap(),
    ...
    pub unsafe fn MakeResident(
        &self,
        ppobjects: &[Option<IDMLPageable>],
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).MakeResident)(
                windows_core::Interface::as_raw(self),
                ppobjects.len().try_into().unwrap(),
                core::mem::transmute(ppobjects.as_ptr()),
            )
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).GetParentDevice)(
                windows_core::Interface::as_raw(self),
                &T::IID,
                &mut result__,
            )
...
pub struct IDMLDevice_Vtbl {
    ...
    pub CreateOperator: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const DML_OPERATOR_DESC,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CompileOperator: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        DML_EXECUTION_FLAGS,
        *const windows_core::GUID,
    ...
    pub CreateOperatorInitializer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
    ...
    pub CreateCommandRecorder: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub CreateBindingTable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const DML_BINDING_TABLE_DESC,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ...
    pub GetParentDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IDMLDevice_Impl: IDMLObject_Impl {
    fn CheckFeatureSupport(
        ...
        feature: DML_FEATURE,
        featurequerydatasize: u32,
        featurequerydata: *const core::ffi::c_void,
        featuresupportdatasize: u32,
        featuresupportdata: *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
    fn CreateOperator(
    ...
    fn CompileOperator(
        &self,
        op: windows_core::Ref<'_, IDMLOperator>,
        flags: DML_EXECUTION_FLAGS,
        riid: *const windows_core::GUID,
        ppv: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
    ...
    fn Evict(&self, count: u32, ppobjects: *const Option<IDMLPageable>)
        -> windows_core::Result<()>;
    fn MakeResident(
        &self,
        count: u32,
...
impl IDMLDevice_Vtbl {
    pub const fn new<Identity: IDMLDevice_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLDevice_Impl::CheckFeatureSupport(
                    this,
                    core::mem::transmute_copy(&feature),
                    core::mem::transmute_copy(&featurequerydatasize),
                    core::mem::transmute_copy(&featurequerydata),
                    core::mem::transmute_copy(&featuresupportdatasize),
                    core::mem::transmute_copy(&featuresupportdata),
                )
                .into()
            }
        }
        unsafe extern "system" fn CreateOperator<Identity: IDMLDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            desc: *const DML_OPERATOR_DESC,
            riid: *const windows_core::GUID,
            ppv: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLDevice_Impl::CreateOperator(
                    this,
        ...
        unsafe extern "system" fn CompileOperator<
            Identity: IDMLDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLDevice_Impl::CompileOperator(
                    this,
                    core::mem::transmute_copy(&op),
        ...
        unsafe extern "system" fn CreateOperatorInitializer<
            Identity: IDMLDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            operatorcount: u32,
            operators: *const *mut core::ffi::c_void,
            riid: *const windows_core::GUID,
            ppv: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLDevice_Impl::CreateOperatorInitializer(
                    this,
                    core::mem::transmute_copy(&operatorcount),
                    core::mem::transmute_copy(&operators),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppv),
                )
                .into()
        ...
        unsafe extern "system" fn CreateCommandRecorder<
            Identity: IDMLDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLDevice_Impl::CreateCommandRecorder(
                    this,
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppv),
                )
        ...
        unsafe extern "system" fn CreateBindingTable<
            Identity: IDMLDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLDevice_Impl::CreateBindingTable(
                    this,
                    core::mem::transmute_copy(&desc),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppv),
        ...
        unsafe extern "system" fn Evict<Identity: IDMLDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            count: u32,
        ...
        unsafe extern "system" fn MakeResident<Identity: IDMLDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            count: u32,
            ppobjects: *const *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetParentDevice<
            Identity: IDMLDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLDevice_Impl::GetParentDevice(
                    this,
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppv),
                )
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IDMLDevice as windows_core::Interface>::IID
            || iid == &<IDMLObject as windows_core::Interface>::IID
    }
}
#[cfg(feature = "Win32_Graphics_Direct3D12")]
...
windows_core::imp::define_interface!(
    IDMLDevice1,
    IDMLDevice1_Vtbl,
    0xa0884f9a_d2be_4355_aa5d_5901281ad1d2
);
...
impl IDMLDevice1 {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CompileGraph)(
                windows_core::Interface::as_raw(self),
                desc,
                flags,
                &T::IID,
...
pub struct IDMLDevice1_Vtbl {
    ...
    pub CompileGraph: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const DML_GRAPH_DESC,
        DML_EXECUTION_FLAGS,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl IDMLDevice1_Vtbl {
    pub const fn new<Identity: IDMLDevice1_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CompileGraph<Identity: IDMLDevice1_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            desc: *const DML_GRAPH_DESC,
            flags: DML_EXECUTION_FLAGS,
            riid: *const windows_core::GUID,
        ...
        Self {
            base__: IDMLDevice_Vtbl::new::<Identity, OFFSET>(),
            CompileGraph: CompileGraph::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IDMLDevice1 as windows_core::Interface>::IID
            || iid == &<IDMLObject as windows_core::Interface>::IID
            || iid == &<IDMLDevice as windows_core::Interface>::IID
    }
}
...
windows_core::imp::define_interface!(
    IDMLDeviceChild,
    IDMLDeviceChild_Vtbl,
    0x27e83142_8165_49e3_974e_2fd66e4cb69d
);
...
impl IDMLDeviceChild_Vtbl {
    pub const fn new<Identity: IDMLDeviceChild_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDevice<Identity: IDMLDeviceChild_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            riid: *const windows_core::GUID,
            ppv: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLDeviceChild_Impl::GetDevice(
                    this,
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppv),
                )
...
windows_core::imp::define_interface!(
    IDMLDispatchable,
    IDMLDispatchable_Vtbl,
    0xdcb821a8_1039_441e_9f1c_b1759c2f3cec
);
...
impl IDMLDispatchable {
    pub unsafe fn GetBindingProperties(&self) -> DML_BINDING_PROPERTIES {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).GetBindingProperties)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            );
            result__
...
pub struct IDMLDispatchable_Vtbl {
    ...
    pub GetBindingProperties:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut DML_BINDING_PROPERTIES),
}
...
impl IDMLDispatchable_Vtbl {
    pub const fn new<Identity: IDMLDispatchable_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetBindingProperties<
        ...
        Self {
            base__: IDMLPageable_Vtbl::new::<Identity, OFFSET>(),
            GetBindingProperties: GetBindingProperties::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IDMLDispatchable as windows_core::Interface>::IID
...
windows_core::imp::define_interface!(
    IDMLObject,
    IDMLObject_Vtbl,
    0xc8263aac_9e0c_4a2d_9b8e_007521a3317c
);
...
pub trait IDMLObject_Impl: windows_core::IUnknownImpl {
    ...
    fn SetPrivateDataInterface(
        &self,
        guid: *const windows_core::GUID,
        data: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
...
impl IDMLObject_Vtbl {
    pub const fn new<Identity: IDMLObject_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetPrivateData<Identity: IDMLObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            guid: *const windows_core::GUID,
            datasize: *mut u32,
            data: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLObject_Impl::GetPrivateData(
                    this,
        ...
        unsafe extern "system" fn SetPrivateData<Identity: IDMLObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            guid: *const windows_core::GUID,
            datasize: u32,
            data: *const core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLObject_Impl::SetPrivateData(
                    this,
                    core::mem::transmute_copy(&guid),
                    core::mem::transmute_copy(&datasize),
                    core::mem::transmute_copy(&data),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLObject_Impl::SetPrivateDataInterface(
                    this,
                    core::mem::transmute_copy(&guid),
                    core::mem::transmute_copy(&data),
                )
        ...
        unsafe extern "system" fn SetName<Identity: IDMLObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IDMLOperator,
    IDMLOperator_Vtbl,
    0x26caae7a_3081_4633_9581_226fbe57695d
);
...
impl IDMLOperator_Vtbl {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IDMLOperator as windows_core::Interface>::IID
            || iid == &<IDMLObject as windows_core::Interface>::IID
            || iid == &<IDMLDeviceChild as windows_core::Interface>::IID
    }
}
...
windows_core::imp::define_interface!(
    ...
    IDMLOperatorInitializer_Vtbl,
    0x427c1113_435c_469c_8676_4d5dd072f813
);
...
impl IDMLOperatorInitializer_Vtbl {
    pub const fn new<Identity: IDMLOperatorInitializer_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDMLOperatorInitializer_Impl::Reset(
                    this,
                    core::mem::transmute_copy(&operatorcount),
                    core::mem::transmute_copy(&operators),
                )
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IDMLOperatorInitializer as windows_core::Interface>::IID
            || iid == &<IDMLObject as windows_core::Interface>::IID
            || iid == &<IDMLDeviceChild as windows_core::Interface>::IID
            || iid == &<IDMLPageable as windows_core::Interface>::IID
            || iid == &<IDMLDispatchable as windows_core::Interface>::IID
...
windows_core::imp::define_interface!(
    IDMLPageable,
    IDMLPageable_Vtbl,
    0xb1ab0825_4542_4a4b_8617_6dde6e8f6201
);

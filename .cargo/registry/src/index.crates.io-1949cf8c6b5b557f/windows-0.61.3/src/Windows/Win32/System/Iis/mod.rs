...
pub unsafe fn HttpFilterProc(
    ...
    pvnotification: *mut core::ffi::c_void,
) -> u32 {
...
windows_core::imp::define_interface!(
    ...
    0xc24efb65_9f3e_4996_8fb1_ce166916bab5
);
...
impl AsyncIFtpAuthenticationProvider {
    pub unsafe fn Begin_AuthenticateUser<P0, P1, P2, P3>(
        &self,
        pszsessionid: P0,
        pszsitename: P1,
        pszusername: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_AuthenticateUser)(
                windows_core::Interface::as_raw(self),
                pszsessionid.param().abi(),
                pszsitename.param().abi(),
                pszusername.param().abi(),
                pszpassword.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn Finish_AuthenticateUser(
        &self,
        ppszcanonicalusername: *mut windows_core::PWSTR,
        pfauthenticated: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_AuthenticateUser)(
                windows_core::Interface::as_raw(self),
                ppszcanonicalusername as _,
                pfauthenticated as _,
            )
            .ok()
        }
    }
...
pub struct AsyncIFtpAuthenticationProvider_Vtbl {
    ...
    pub Begin_AuthenticateUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ...
    pub Finish_AuthenticateUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait AsyncIFtpAuthenticationProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_AuthenticateUser(
        ...
        pszsitename: &windows_core::PCWSTR,
        pszusername: &windows_core::PCWSTR,
        pszpassword: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
...
impl AsyncIFtpAuthenticationProvider_Vtbl {
    ...
    {
        unsafe extern "system" fn Begin_AuthenticateUser<
        ...
        >(
            ...
            unsafe {
                ...
                AsyncIFtpAuthenticationProvider_Impl::Begin_AuthenticateUser(
                    this,
                    core::mem::transmute(&pszsessionid),
                    core::mem::transmute(&pszsitename),
        ...
        unsafe extern "system" fn Finish_AuthenticateUser<
            Identity: AsyncIFtpAuthenticationProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIFtpAuthenticationProvider_Impl::Finish_AuthenticateUser(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0x860dc339_07e5_4a5c_9c61_8820cea012bc
);
...
impl AsyncIFtpAuthorizationProvider {
    pub unsafe fn Begin_GetUserAccessPermission<P0, P1, P2, P3>(
        &self,
        pszsessionid: P0,
        pszsitename: P1,
        pszvirtualpath: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_GetUserAccessPermission)(
                windows_core::Interface::as_raw(self),
                pszsessionid.param().abi(),
                pszsitename.param().abi(),
                pszvirtualpath.param().abi(),
                pszusername.param().abi(),
            )
            .ok()
        }
    ...
    pub unsafe fn Finish_GetUserAccessPermission(&self) -> windows_core::Result<FTP_ACCESS> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).Finish_GetUserAccessPermission)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct AsyncIFtpAuthorizationProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Begin_GetUserAccessPermission: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ...
    pub Finish_GetUserAccessPermission:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut FTP_ACCESS) -> windows_core::HRESULT,
}
pub trait AsyncIFtpAuthorizationProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_GetUserAccessPermission(
        ...
        pszsessionid: &windows_core::PCWSTR,
        pszsitename: &windows_core::PCWSTR,
        pszvirtualpath: &windows_core::PCWSTR,
        pszusername: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
...
impl AsyncIFtpAuthorizationProvider_Vtbl {
    pub const fn new<Identity: AsyncIFtpAuthorizationProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin_GetUserAccessPermission<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIFtpAuthorizationProvider_Impl::Begin_GetUserAccessPermission(
                    this,
                    core::mem::transmute(&pszsessionid),
                    core::mem::transmute(&pszsitename),
                    core::mem::transmute(&pszvirtualpath),
                    core::mem::transmute(&pszusername),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_GetUserAccessPermission<
            Identity: AsyncIFtpAuthorizationProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl AsyncIFtpHomeDirectoryProvider {
    pub unsafe fn Begin_GetUserHomeDirectoryData<P0, P1, P2>(
        &self,
        pszsessionid: P0,
        pszsitename: P1,
        pszusername: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_GetUserHomeDirectoryData)(
                windows_core::Interface::as_raw(self),
                pszsessionid.param().abi(),
                pszsitename.param().abi(),
                pszusername.param().abi(),
    ...
    pub unsafe fn Finish_GetUserHomeDirectoryData(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_GetUserHomeDirectoryData)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct AsyncIFtpHomeDirectoryProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Begin_GetUserHomeDirectoryData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub Finish_GetUserHomeDirectoryData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
}
...
impl AsyncIFtpHomeDirectoryProvider_Vtbl {
    pub const fn new<Identity: AsyncIFtpHomeDirectoryProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin_GetUserHomeDirectoryData<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIFtpHomeDirectoryProvider_Impl::Begin_GetUserHomeDirectoryData(
                    this,
                    core::mem::transmute(&pszsessionid),
                    core::mem::transmute(&pszsitename),
                    core::mem::transmute(&pszusername),
        ...
        unsafe extern "system" fn Finish_GetUserHomeDirectoryData<
            Identity: AsyncIFtpHomeDirectoryProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppszhomedirectorydata: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl AsyncIFtpLogProvider {
    pub unsafe fn Begin_Log(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Begin_Log)(
                windows_core::Interface::as_raw(self),
                ploggingparameters,
            )
            .ok()
    ...
    pub unsafe fn Finish_Log(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_Log)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub struct AsyncIFtpLogProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Begin_Log: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl AsyncIFtpLogProvider_Vtbl {
    pub const fn new<Identity: AsyncIFtpLogProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin_Log<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIFtpLogProvider_Impl::Begin_Log(
                    this,
                    core::mem::transmute_copy(&ploggingparameters),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_Log<
            Identity: AsyncIFtpLogProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl AsyncIFtpPostprocessProvider {
    pub unsafe fn Begin_HandlePostprocess(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Begin_HandlePostprocess)(
                windows_core::Interface::as_raw(self),
                ppostprocessparameters,
            )
            .ok()
        }
    }
    pub unsafe fn Finish_HandlePostprocess(&self) -> windows_core::Result<FTP_PROCESS_STATUS> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_HandlePostprocess)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct AsyncIFtpPostprocessProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Begin_HandlePostprocess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const POST_PROCESS_PARAMETERS,
    ) -> windows_core::HRESULT,
    pub Finish_HandlePostprocess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut FTP_PROCESS_STATUS,
    ) -> windows_core::HRESULT,
}
...
impl AsyncIFtpPostprocessProvider_Vtbl {
    pub const fn new<Identity: AsyncIFtpPostprocessProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin_HandlePostprocess<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIFtpPostprocessProvider_Impl::Begin_HandlePostprocess(
                    this,
                    core::mem::transmute_copy(&ppostprocessparameters),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_HandlePostprocess<
            Identity: AsyncIFtpPostprocessProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x6ff5fd8f_fd8e_48b1_a3e0_bf7073db4db5
);
...
impl AsyncIFtpPreprocessProvider {
    pub unsafe fn Begin_HandlePreprocess(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Begin_HandlePreprocess)(
                windows_core::Interface::as_raw(self),
                ppreprocessparameters,
            )
            .ok()
        }
    }
    pub unsafe fn Finish_HandlePreprocess(&self) -> windows_core::Result<FTP_PROCESS_STATUS> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_HandlePreprocess)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct AsyncIFtpPreprocessProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Begin_HandlePreprocess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const PRE_PROCESS_PARAMETERS,
    ) -> windows_core::HRESULT,
    pub Finish_HandlePreprocess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut FTP_PROCESS_STATUS,
    ) -> windows_core::HRESULT,
}
...
impl AsyncIFtpPreprocessProvider_Vtbl {
    pub const fn new<Identity: AsyncIFtpPreprocessProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin_HandlePreprocess<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIFtpPreprocessProvider_Impl::Begin_HandlePreprocess(
                    this,
                    core::mem::transmute_copy(&ppreprocessparameters),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_HandlePreprocess<
            Identity: AsyncIFtpPreprocessProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl AsyncIFtpRoleProvider {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_IsUserInRole)(
                windows_core::Interface::as_raw(self),
                pszsessionid.param().abi(),
                pszsitename.param().abi(),
                pszusername.param().abi(),
    ...
    pub unsafe fn Finish_IsUserInRole(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_IsUserInRole)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct AsyncIFtpRoleProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Begin_IsUserInRole: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ...
    pub Finish_IsUserInRole: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
}
...
impl AsyncIFtpRoleProvider_Vtbl {
    pub const fn new<Identity: AsyncIFtpRoleProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin_IsUserInRole<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIFtpRoleProvider_Impl::Begin_IsUserInRole(
                    this,
                    core::mem::transmute(&pszsessionid),
                    core::mem::transmute(&pszsitename),
                    core::mem::transmute(&pszusername),
                    core::mem::transmute(&pszrole),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_IsUserInRole<
            Identity: AsyncIFtpRoleProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xa9e69613_b80d_11d0_b9b9_00a0c922e750
);
...
impl AsyncIMSAdminBaseSinkW {
    pub unsafe fn Begin_SinkNotify(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Begin_SinkNotify)(
                windows_core::Interface::as_raw(self),
                pcochangelist.len().try_into().unwrap(),
                core::mem::transmute(pcochangelist.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn Finish_SinkNotify(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_SinkNotify)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn Begin_ShutdownNotify(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin_ShutdownNotify)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn Finish_ShutdownNotify(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Finish_ShutdownNotify)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct AsyncIMSAdminBaseSinkW_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Begin_SinkNotify: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const MD_CHANGE_OBJECT_W,
    ) -> windows_core::HRESULT,
    pub Finish_SinkNotify:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Begin_ShutdownNotify:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
...
impl AsyncIMSAdminBaseSinkW_Vtbl {
    pub const fn new<Identity: AsyncIMSAdminBaseSinkW_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin_SinkNotify<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                AsyncIMSAdminBaseSinkW_Impl::Begin_SinkNotify(
                    this,
                    core::mem::transmute_copy(&dwmdnumelements),
                    core::mem::transmute_copy(&pcochangelist),
                )
                .into()
            }
        }
        unsafe extern "system" fn Finish_SinkNotify<
            Identity: AsyncIMSAdminBaseSinkW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Begin_ShutdownNotify<
            Identity: AsyncIMSAdminBaseSinkW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Finish_ShutdownNotify<
            Identity: AsyncIMSAdminBaseSinkW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub const CLSID_IImgCtx: windows_core::GUID =
    windows_core::GUID::from_u128(0x3050f3d6_98b5_11cf_bb82_00aa00bdce0b);
pub const CLSID_IisServiceControl: windows_core::GUID =
    windows_core::GUID::from_u128(0xe8fb8621_588f_11d2_9d61_00c04f79c5fe);
pub const CLSID_MSAdminBase_W: windows_core::GUID =
    windows_core::GUID::from_u128(0xa9e69610_b80d_11d0_b9b9_00a0c922e750);
pub const CLSID_Request: windows_core::GUID =
    windows_core::GUID::from_u128(0x920c25d0_25d9_11d0_a55f_00a0c90c2091);
pub const CLSID_Response: windows_core::GUID =
    windows_core::GUID::from_u128(0x46e19ba0_25dd_11d0_a55f_00a0c90c2091);
pub const CLSID_ScriptingContext: windows_core::GUID =
    windows_core::GUID::from_u128(0xd97a6da0_a868_11cf_83ae_11b0c90c2bd8);
pub const CLSID_Server: windows_core::GUID =
    windows_core::GUID::from_u128(0xa506d160_25e0_11d0_a55f_00a0c90c2091);
pub const CLSID_Session: windows_core::GUID =
    windows_core::GUID::from_u128(0x509f8f20_25de_11d0_a55f_00a0c90c2091);
pub const CLSID_WamAdmin: windows_core::GUID =
    windows_core::GUID::from_u128(0x61738644_f196_11d0_9953_00c04fd919c1);
#[repr(C)]
...
pub const FtpProvider: windows_core::GUID =
    windows_core::GUID::from_u128(0x70bdc667_33b2_45f0_ac52_c3ca46f7a656);
pub const GUID_IIS_ALL_TRACE_PROVIDERS: windows_core::GUID =
    windows_core::GUID::from_u128(0x00000000_0000_0000_0000_000000000000);
pub const GUID_IIS_ASPNET_TRACE_PROVIDER: windows_core::GUID =
    windows_core::GUID::from_u128(0xaff081fe_0247_4275_9c4e_021f3dc1da35);
pub const GUID_IIS_ASP_TRACE_TRACE_PROVIDER: windows_core::GUID =
    windows_core::GUID::from_u128(0x06b94d9a_b15e_456e_a4ef_37c984a2cb4b);
pub const GUID_IIS_ISAPI_TRACE_PROVIDER: windows_core::GUID =
    windows_core::GUID::from_u128(0xa1c2040e_8840_4c31_ba11_9871031a19ea);
pub const GUID_IIS_WWW_GLOBAL_TRACE_PROVIDER: windows_core::GUID =
    windows_core::GUID::from_u128(0xd55d3bc9_cba9_44df_827e_132d3a4596c2);
pub const GUID_IIS_WWW_SERVER_TRACE_PROVIDER: windows_core::GUID =
    windows_core::GUID::from_u128(0x3a2a4e84_4c21_4981_ae10_3fda0d9b0f83);
pub const GUID_IIS_WWW_SERVER_V2_TRACE_PROVIDER: windows_core::GUID =
    windows_core::GUID::from_u128(0xde4649c9_15e8_4fea_9d85_1cdda520c334);
#[repr(transparent)]
...
impl IADMEXT {
    ...
    pub unsafe fn EnumDcomCLSIDs(
        &self,
        pclsiddcom: *mut windows_core::GUID,
        dwenumindex: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EnumDcomCLSIDs)(
                windows_core::Interface::as_raw(self),
                pclsiddcom as _,
                dwenumindex,
            )
...
pub struct IADMEXT_Vtbl {
    ...
    pub EnumDcomCLSIDs: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IADMEXT_Vtbl {
    pub const fn new<Identity: IADMEXT_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Initialize<Identity: IADMEXT_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn EnumDcomCLSIDs<Identity: IADMEXT_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pclsiddcom: *mut windows_core::GUID,
            dwenumindex: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IADMEXT_Impl::EnumDcomCLSIDs(
                    this,
                    core::mem::transmute_copy(&pclsiddcom),
                    core::mem::transmute_copy(&dwenumindex),
                )
                .into()
            }
        }
        unsafe extern "system" fn Terminate<Identity: IADMEXT_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
    ...
    pub const fn new<Identity: IFtpAuthenticationProvider_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IFtpAuthenticationProvider_Impl::AuthenticateUser(
                    this,
                    core::mem::transmute(&pszsessionid),
                    core::mem::transmute(&pszsitename),
                    core::mem::transmute(&pszusername),
...
windows_core::imp::define_interface!(
    ...
    0xa50ae7a1_a35a_42b4_a4f3_f4f7057a05d1
);
windows_core::imp::interface_hierarchy!(IFtpAuthorizationProvider, windows_core::IUnknown);
impl IFtpAuthorizationProvider {
    pub unsafe fn GetUserAccessPermission<P0, P1, P2, P3>(
        &self,
        pszsessionid: P0,
        pszsitename: P1,
        pszvirtualpath: P2,
        pszusername: P3,
    ) -> windows_core::Result<FTP_ACCESS>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetUserAccessPermission)(
                windows_core::Interface::as_raw(self),
                pszsessionid.param().abi(),
                pszsitename.param().abi(),
                pszvirtualpath.param().abi(),
...
pub struct IFtpAuthorizationProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetUserAccessPermission: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
impl IFtpAuthorizationProvider_Vtbl {
    pub const fn new<Identity: IFtpAuthorizationProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetUserAccessPermission<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IFtpAuthorizationProvider_Impl::GetUserAccessPermission(
                    this,
                    core::mem::transmute(&pszsessionid),
                    core::mem::transmute(&pszsitename),
                    core::mem::transmute(&pszvirtualpath),
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetUserAccessPermission: GetUserAccessPermission::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IFtpHomeDirectoryProvider {
        ...
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetUserHomeDirectoryData)(
                windows_core::Interface::as_raw(self),
                pszsessionid.param().abi(),
                pszsitename.param().abi(),
                pszusername.param().abi(),
...
pub struct IFtpHomeDirectoryProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetUserHomeDirectoryData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
impl IFtpHomeDirectoryProvider_Vtbl {
    pub const fn new<Identity: IFtpHomeDirectoryProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetUserHomeDirectoryData<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IFtpHomeDirectoryProvider_Impl::GetUserHomeDirectoryData(
                    this,
                    core::mem::transmute(&pszsessionid),
                    core::mem::transmute(&pszsitename),
                    core::mem::transmute(&pszusername),
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetUserHomeDirectoryData: GetUserHomeDirectoryData::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xa18a94cc_8299_4408_816c_7c3baca1a40e
);
...
impl IFtpLogProvider_Vtbl {
    pub const fn new<Identity: IFtpLogProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Log<Identity: IFtpLogProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ploggingparameters: *const LOGGING_PARAMETERS,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IFtpLogProvider_Impl::Log(this, core::mem::transmute_copy(&ploggingparameters))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0x4522cbc6_16cd_49ad_8653_9a2c579e4280
);
...
impl IFtpPostprocessProvider {
    pub unsafe fn HandlePostprocess(
        &self,
        ppostprocessparameters: *const POST_PROCESS_PARAMETERS,
    ) -> windows_core::Result<FTP_PROCESS_STATUS> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).HandlePostprocess)(
                windows_core::Interface::as_raw(self),
                ppostprocessparameters,
                &mut result__,
            )
...
pub struct IFtpPostprocessProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub HandlePostprocess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const POST_PROCESS_PARAMETERS,
        *mut FTP_PROCESS_STATUS,
    ) -> windows_core::HRESULT,
...
impl IFtpPostprocessProvider_Vtbl {
    pub const fn new<Identity: IFtpPostprocessProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn HandlePostprocess<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IFtpPostprocessProvider_Impl::HandlePostprocess(
                    this,
                    core::mem::transmute_copy(&ppostprocessparameters),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            HandlePostprocess: HandlePostprocess::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xa3c19b60_5a28_471a_8f93_ab30411cee82
);
...
impl IFtpPreprocessProvider {
    pub unsafe fn HandlePreprocess(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).HandlePreprocess)(
                windows_core::Interface::as_raw(self),
                ppreprocessparameters,
                &mut result__,
            )
...
pub struct IFtpPreprocessProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub HandlePreprocess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const PRE_PROCESS_PARAMETERS,
        *mut FTP_PROCESS_STATUS,
    ) -> windows_core::HRESULT,
...
impl IFtpPreprocessProvider_Vtbl {
    pub const fn new<Identity: IFtpPreprocessProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn HandlePreprocess<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IFtpPreprocessProvider_Impl::HandlePreprocess(
                    this,
                    core::mem::transmute_copy(&ppreprocessparameters),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            HandlePreprocess: HandlePreprocess::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    IFtpProviderConstruct_Vtbl,
    0x4d1a3f7b_412d_447c_b199_64f967e9a2da
);
    ...
    pub const fn new<Identity: IFtpProviderConstruct_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IFtpProviderConstruct_Impl::Construct(
                    this,
                    core::mem::transmute_copy(&configurationentries),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IFtpRoleProvider,
    IFtpRoleProvider_Vtbl,
    0x909c850d_8ca0_4674_96b8_cc2941535725
);
windows_core::imp::interface_hierarchy!(IFtpRoleProvider, windows_core::IUnknown);
impl IFtpRoleProvider {
    pub unsafe fn IsUserInRole<P0, P1, P2, P3>(
        &self,
        pszsessionid: P0,
        pszsitename: P1,
        pszusername: P2,
    ...
    pub const fn new<Identity: IFtpRoleProvider_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IFtpRoleProvider_Impl::IsUserInRole(
                    this,
                    core::mem::transmute(&pszsessionid),
                    core::mem::transmute(&pszsitename),
                    core::mem::transmute(&pszusername),
...
pub const IISADMIN_EXTENSIONS_CLSID_MD_KEY: windows_core::PCWSTR =
    windows_core::w!("LM/IISADMIN/EXTENSIONS/DCOMCLSIDS");
pub const IISADMIN_EXTENSIONS_CLSID_MD_KEYA: windows_core::PCSTR =
    windows_core::s!("LM/IISADMIN/EXTENSIONS/DCOMCLSIDS");
pub const IISADMIN_EXTENSIONS_CLSID_MD_KEYW: windows_core::PCWSTR =
    windows_core::w!("LM/IISADMIN/EXTENSIONS/DCOMCLSIDS");
pub const IISADMIN_EXTENSIONS_REG_KEY: windows_core::PCWSTR =
    windows_core::w!("SOFTWARE\\Microsoft\\InetStp\\Extensions");
pub const IISADMIN_EXTENSIONS_REG_KEYA: windows_core::PCSTR =
    windows_core::s!("SOFTWARE\\Microsoft\\InetStp\\Extensions");
pub const IISADMIN_EXTENSIONS_REG_KEYW: windows_core::PCWSTR =
    windows_core::w!("SOFTWARE\\Microsoft\\InetStp\\Extensions");
...
pub const IIS_CLASS_COMPRESS_SCHEMES: windows_core::PCSTR =
    windows_core::s!("IIsCompressionSchemes");
pub const IIS_CLASS_COMPRESS_SCHEMES_W: windows_core::PCWSTR =
    windows_core::w!("IIsCompressionSchemes");
pub const IIS_CLASS_COMPRESS_SCHEME_W: windows_core::PCWSTR =
    windows_core::w!("IIsCompressionScheme");
...
windows_core::imp::define_interface!(
    IMSAdminBase2W,
    IMSAdminBase2W_Vtbl,
    0x8298d101_f992_43b7_8eca_5052d885b995
);
...
impl IMSAdminBase2W {
    pub unsafe fn BackupWithPasswd<P0, P3>(
        &self,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).BackupWithPasswd)(
                windows_core::Interface::as_raw(self),
                pszmdbackuplocation.param().abi(),
                dwmdversion,
                dwmdflags,
                pszpasswd.param().abi(),
            )
    ...
    pub unsafe fn RestoreWithPasswd<P0, P3>(
        &self,
        pszmdbackuplocation: P0,
        dwmdversion: u32,
        dwmdflags: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RestoreWithPasswd)(
                windows_core::Interface::as_raw(self),
                pszmdbackuplocation.param().abi(),
                dwmdversion,
                dwmdflags,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RestoreHistory)(
                windows_core::Interface::as_raw(self),
                pszmdhistorylocation.param().abi(),
                dwmdmajorversion,
                dwmdminorversion,
                dwmdflags,
            )
    ...
    pub unsafe fn EnumHistory(
        &self,
        pszmdhistorylocation: &mut [u16; 256],
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumHistory)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pszmdhistorylocation.as_ptr()),
                pdwmdmajorversion as _,
                pdwmdminorversion as _,
                pftmdhistorytime as _,
                dwmdenumindex,
            )
            .ok()
        }
...
pub struct IMSAdminBase2W_Vtbl {
    ...
    pub BackupWithPasswd: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        u32,
    ...
    pub RestoreWithPasswd: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        u32,
    ...
    pub RestoreHistory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        u32,
    ...
    pub EnumHistory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PWSTR,
        *mut u32,
        *mut u32,
...
pub trait IMSAdminBase2W_Impl: IMSAdminBaseW_Impl {
    fn BackupWithPasswd(
        &self,
        pszmdbackuplocation: &windows_core::PCWSTR,
        dwmdversion: u32,
        dwmdflags: u32,
        pszpasswd: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    ...
    fn Export(
        ...
        pszsourcepath: &windows_core::PCWSTR,
        dwmdflags: u32,
    ) -> windows_core::Result<()>;
    fn Import(
        &self,
        ...
        pszfilename: &windows_core::PCWSTR,
        pszsourcepath: &windows_core::PCWSTR,
        pszdestpath: &windows_core::PCWSTR,
        dwmdflags: u32,
    ) -> windows_core::Result<()>;
    fn RestoreHistory(
        &self,
        pszmdhistorylocation: &windows_core::PCWSTR,
        dwmdmajorversion: u32,
        dwmdminorversion: u32,
        dwmdflags: u32,
    ) -> windows_core::Result<()>;
    fn EnumHistory(
        &self,
        pszmdhistorylocation: windows_core::PWSTR,
        pdwmdmajorversion: *mut u32,
        pdwmdminorversion: *mut u32,
        pftmdhistorytime: *mut super::super::Foundation::FILETIME,
        dwmdenumindex: u32,
...
impl IMSAdminBase2W_Vtbl {
    pub const fn new<Identity: IMSAdminBase2W_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BackupWithPasswd<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBase2W_Impl::BackupWithPasswd(
                    this,
                    core::mem::transmute(&pszmdbackuplocation),
                    core::mem::transmute_copy(&dwmdversion),
                    core::mem::transmute_copy(&dwmdflags),
                    core::mem::transmute(&pszpasswd),
                )
                .into()
            }
        }
        unsafe extern "system" fn RestoreWithPasswd<
            Identity: IMSAdminBase2W_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBase2W_Impl::RestoreWithPasswd(
                    this,
                    core::mem::transmute(&pszmdbackuplocation),
                    core::mem::transmute_copy(&dwmdversion),
                    core::mem::transmute_copy(&dwmdflags),
        ...
        unsafe extern "system" fn Export<Identity: IMSAdminBase2W_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszpasswd: windows_core::PCWSTR,
            pszfilename: windows_core::PCWSTR,
            pszsourcepath: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBase2W_Impl::Export(
                    this,
                    core::mem::transmute(&pszpasswd),
                    core::mem::transmute(&pszfilename),
                    core::mem::transmute(&pszsourcepath),
                    core::mem::transmute_copy(&dwmdflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn Import<Identity: IMSAdminBase2W_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszpasswd: windows_core::PCWSTR,
            pszfilename: windows_core::PCWSTR,
            pszsourcepath: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBase2W_Impl::Import(
                    this,
                    core::mem::transmute(&pszpasswd),
                    core::mem::transmute(&pszfilename),
                    core::mem::transmute(&pszsourcepath),
                    core::mem::transmute(&pszdestpath),
                    core::mem::transmute_copy(&dwmdflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn RestoreHistory<
            Identity: IMSAdminBase2W_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBase2W_Impl::RestoreHistory(
                    this,
                    core::mem::transmute(&pszmdhistorylocation),
                    core::mem::transmute_copy(&dwmdmajorversion),
                    core::mem::transmute_copy(&dwmdminorversion),
                    core::mem::transmute_copy(&dwmdflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumHistory<
            Identity: IMSAdminBase2W_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBase2W_Impl::EnumHistory(
                    this,
                    core::mem::transmute_copy(&pszmdhistorylocation),
                    core::mem::transmute_copy(&pdwmdmajorversion),
                    core::mem::transmute_copy(&pdwmdminorversion),
                    core::mem::transmute_copy(&pftmdhistorytime),
                    core::mem::transmute_copy(&dwmdenumindex),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IMSAdminBase3W,
    IMSAdminBase3W_Vtbl,
    0xf612954d_3b0b_4c56_9563_227b7be624b4
);
...
impl IMSAdminBase3W {
    pub unsafe fn GetChildPaths<P1>(
        &self,
        hmdhandle: u32,
        pszmdpath: P1,
        pszbuffer: Option<&mut [u16]>,
        pcchmdrequiredbuffersize: Option<*mut u32>,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetChildPaths)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
                pszbuffer
                ...
                pcchmdrequiredbuffersize.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
...
pub struct IMSAdminBase3W_Vtbl {
    ...
    pub GetChildPaths: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        u32,
...
impl IMSAdminBase3W_Vtbl {
    pub const fn new<Identity: IMSAdminBase3W_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetChildPaths<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBase3W_Impl::GetChildPaths(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute_copy(&cchmdbuffersize),
                    core::mem::transmute_copy(&pszbuffer),
                    core::mem::transmute_copy(&pcchmdrequiredbuffersize),
                )
                .into()
            }
        }
        Self {
            base__: IMSAdminBase2W_Vtbl::new::<Identity, OFFSET>(),
            GetChildPaths: GetChildPaths::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xa9e69612_b80d_11d0_b9b9_00a0c922e750
);
...
impl IMSAdminBaseSinkW {
    pub unsafe fn SinkNotify(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SinkNotify)(
                windows_core::Interface::as_raw(self),
                pcochangelist.len().try_into().unwrap(),
                core::mem::transmute(pcochangelist.as_ptr()),
            )
    ...
    pub unsafe fn ShutdownNotify(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ShutdownNotify)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub struct IMSAdminBaseSinkW_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SinkNotify: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const MD_CHANGE_OBJECT_W,
    ) -> windows_core::HRESULT,
...
impl IMSAdminBaseSinkW_Vtbl {
    pub const fn new<Identity: IMSAdminBaseSinkW_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SinkNotify<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseSinkW_Impl::SinkNotify(
                    this,
                    core::mem::transmute_copy(&dwmdnumelements),
                    core::mem::transmute_copy(&pcochangelist),
                )
        ...
        unsafe extern "system" fn ShutdownNotify<
            Identity: IMSAdminBaseSinkW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IMSAdminBaseW,
    IMSAdminBaseW_Vtbl,
    0x70b51430_b6ca_11d0_b9b9_00a0c922e750
);
...
impl IMSAdminBaseW {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddKey)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteKey)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
            )
    ...
    pub unsafe fn DeleteChildKeys<P1>(
        &self,
        hmdhandle: u32,
        pszmdpath: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteChildKeys)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EnumKeys)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
                core::mem::transmute(pszmdname.as_ptr()),
                dwmdenumobjectindex,
            )
            .ok()
        }
    }
    pub unsafe fn CopyKey<P1, P3>(
        &self,
        hmdsourcehandle: u32,
        pszmdsourcepath: P1,
        hmddesthandle: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CopyKey)(
                windows_core::Interface::as_raw(self),
                hmdsourcehandle,
                pszmdsourcepath.param().abi(),
                hmddesthandle,
                pszmddestpath.param().abi(),
                bmdoverwriteflag.into(),
                bmdcopyflag.into(),
            )
            .ok()
        }
    }
    pub unsafe fn RenameKey<P1, P2>(
        &self,
        hmdhandle: u32,
        pszmdpath: P1,
        pszmdnewname: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RenameKey)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
                pszmdnewname.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn SetData<P1>(
        &self,
        hmdhandle: u32,
        pszmdpath: P1,
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetData)(
                ...
                pszmdpath.param().abi(),
                pmdrmddata as _,
                pdwmdrequireddatalen as _,
            )
            .ok()
        }
    }
    pub unsafe fn DeleteData<P1>(
        &self,
        hmdhandle: u32,
        pszmdpath: P1,
        dwmdidentifier: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteData)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
                dwmdidentifier,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EnumData)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
                pmdrmddata as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetAllData)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
                dwmdattributes,
                dwmdusertype,
                dwmddatatype,
                pdwmdnumdataentries as _,
                pdwmddatasetnumber as _,
                dwmdbuffersize,
                pbmdbuffer as _,
                pdwmdrequiredbuffersize as _,
            )
            .ok()
        }
    }
    pub unsafe fn DeleteAllData<P1>(
        &self,
        hmdhandle: u32,
        pszmdpath: P1,
        dwmdusertype: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteAllData)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
                dwmdusertype,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CopyData)(
                windows_core::Interface::as_raw(self),
                hmdsourcehandle,
                pszmdsourcepath.param().abi(),
                hmddesthandle,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetDataPaths)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
                dwmdidentifier,
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenKey)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
                dwmdaccessrequested,
    ...
    pub unsafe fn CloseKey(&self, hmdhandle: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CloseKey)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
            )
            .ok()
    ...
    pub unsafe fn ChangePermissions(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ChangePermissions)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                dwmdtimeout,
                dwmdaccessrequested,
    ...
    pub unsafe fn SaveData(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SaveData)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn GetHandleInfo(
        &self,
        hmdhandle: u32,
    ) -> windows_core::Result<METADATA_HANDLE_INFO> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetHandleInfo)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                &mut result__,
            )
    ...
    pub unsafe fn GetSystemChangeNumber(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSystemChangeNumber)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetDataSetNumber<P1>(
        &self,
        hmdhandle: u32,
        pszmdpath: P1,
    ) -> windows_core::Result<u32>
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDataSetNumber)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
                &mut result__,
    ...
    pub unsafe fn SetLastChangeTime<P1>(
        &self,
        hmdhandle: u32,
        pszmdpath: P1,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetLastChangeTime)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
                pftmdlastchangetime,
    ...
    pub unsafe fn GetLastChangeTime<P1>(
        &self,
        hmdhandle: u32,
        pszmdpath: P1,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetLastChangeTime)(
                windows_core::Interface::as_raw(self),
                hmdhandle,
                pszmdpath.param().abi(),
                pftmdlastchangetime as _,
                blocaltime.into(),
            )
            .ok()
        }
    ...
    pub unsafe fn KeyExchangePhase1(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).KeyExchangePhase1)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn KeyExchangePhase2(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).KeyExchangePhase2)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn EnumBackups(
        &self,
        pszmdbackuplocation: &mut [u16; 256],
        pdwmdversion: *mut u32,
        pftmdbackuptime: *mut super::super::Foundation::FILETIME,
        dwmdenumindex: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EnumBackups)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pszmdbackuplocation.as_ptr()),
                pdwmdversion as _,
                pftmdbackuptime as _,
                dwmdenumindex,
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteBackup)(
                windows_core::Interface::as_raw(self),
                pszmdbackuplocation.param().abi(),
                dwmdversion,
            )
    ...
    pub unsafe fn UnmarshalInterface(&self) -> windows_core::Result<IMSAdminBaseW> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UnmarshalInterface)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
    ...
    pub unsafe fn GetServerGuid(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetServerGuid)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub struct IMSAdminBaseW_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub AddKey: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub DeleteKey: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub DeleteChildKeys: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub EnumKeys: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        windows_core::PWSTR,
    ...
    pub CopyKey: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        u32,
    ...
    pub RenameKey: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ...
    pub DeleteData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        u32,
    ...
    pub EnumData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        *mut METADATA_RECORD,
    ...
    pub GetAllData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        u32,
    ...
    pub DeleteAllData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        u32,
    ...
    pub CopyData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        u32,
    ...
    pub GetDataPaths: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        u32,
    ...
    pub OpenKey: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        u32,
    ...
    pub GetHandleInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut METADATA_HANDLE_INFO,
    ) -> windows_core::HRESULT,
    pub GetSystemChangeNumber:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetDataSetNumber: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub SetLastChangeTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
    ...
    pub GetLastChangeTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        *mut super::super::Foundation::FILETIME,
    ...
    pub KeyExchangePhase1:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub KeyExchangePhase2:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    ...
    pub EnumBackups: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PWSTR,
        *mut u32,
        *mut super::super::Foundation::FILETIME,
    ...
    pub DeleteBackup: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
    ) -> windows_core::HRESULT,
...
pub trait IMSAdminBaseW_Impl: windows_core::IUnknownImpl {
    ...
    fn EnumKeys(
        ...
        hmdhandle: u32,
        pszmdpath: &windows_core::PCWSTR,
        pszmdname: windows_core::PWSTR,
        dwmdenumobjectindex: u32,
    ) -> windows_core::Result<()>;
    fn CopyKey(
        &self,
        hmdsourcehandle: u32,
        pszmdsourcepath: &windows_core::PCWSTR,
        hmddesthandle: u32,
        pszmddestpath: &windows_core::PCWSTR,
        bmdoverwriteflag: windows_core::BOOL,
        bmdcopyflag: windows_core::BOOL,
    ) -> windows_core::Result<()>;
    fn RenameKey(
        &self,
        hmdhandle: u32,
        pszmdpath: &windows_core::PCWSTR,
        pszmdnewname: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    fn SetData(
        &self,
        hmdhandle: u32,
    ...
    fn EnumBackups(
        &self,
        pszmdbackuplocation: windows_core::PWSTR,
        pdwmdversion: *mut u32,
        pftmdbackuptime: *mut super::super::Foundation::FILETIME,
        dwmdenumindex: u32,
    ) -> windows_core::Result<()>;
...
impl IMSAdminBaseW_Vtbl {
    pub const fn new<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddKey<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdhandle: u32,
            pszmdpath: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn DeleteKey<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdhandle: u32,
            pszmdpath: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn DeleteChildKeys<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::DeleteChildKeys(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                )
        ...
        unsafe extern "system" fn EnumKeys<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdhandle: u32,
            pszmdpath: windows_core::PCWSTR,
            pszmdname: windows_core::PWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::EnumKeys(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute_copy(&pszmdname),
                    core::mem::transmute_copy(&dwmdenumobjectindex),
                )
                .into()
            }
        }
        unsafe extern "system" fn CopyKey<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdsourcehandle: u32,
            pszmdsourcepath: windows_core::PCWSTR,
            hmddesthandle: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::CopyKey(
                    this,
                    core::mem::transmute_copy(&hmdsourcehandle),
                    core::mem::transmute(&pszmdsourcepath),
                    core::mem::transmute_copy(&hmddesthandle),
                    core::mem::transmute(&pszmddestpath),
                    core::mem::transmute_copy(&bmdoverwriteflag),
                    core::mem::transmute_copy(&bmdcopyflag),
                )
                .into()
            }
        }
        unsafe extern "system" fn RenameKey<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdhandle: u32,
            pszmdpath: windows_core::PCWSTR,
            pszmdnewname: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::RenameKey(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute(&pszmdnewname),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetData<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdhandle: u32,
            pszmdpath: windows_core::PCWSTR,
            pmdrmddata: *mut METADATA_RECORD,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::SetData(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute_copy(&pmdrmddata),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetData<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdhandle: u32,
            pszmdpath: windows_core::PCWSTR,
            pmdrmddata: *mut METADATA_RECORD,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::GetData(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute_copy(&pmdrmddata),
                    core::mem::transmute_copy(&pdwmdrequireddatalen),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeleteData<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdhandle: u32,
            pszmdpath: windows_core::PCWSTR,
            dwmdidentifier: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::DeleteData(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute_copy(&dwmdidentifier),
                    core::mem::transmute_copy(&dwmddatatype),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumData<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdhandle: u32,
            pszmdpath: windows_core::PCWSTR,
            pmdrmddata: *mut METADATA_RECORD,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::EnumData(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute_copy(&pmdrmddata),
                    core::mem::transmute_copy(&dwmdenumdataindex),
                    core::mem::transmute_copy(&pdwmdrequireddatalen),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetAllData<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdhandle: u32,
            pszmdpath: windows_core::PCWSTR,
            dwmdattributes: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::GetAllData(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute_copy(&dwmdattributes),
                    core::mem::transmute_copy(&dwmdusertype),
                    core::mem::transmute_copy(&dwmddatatype),
                    core::mem::transmute_copy(&pdwmdnumdataentries),
                    core::mem::transmute_copy(&pdwmddatasetnumber),
                    core::mem::transmute_copy(&dwmdbuffersize),
                    core::mem::transmute_copy(&pbmdbuffer),
                    core::mem::transmute_copy(&pdwmdrequiredbuffersize),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeleteAllData<
            Identity: IMSAdminBaseW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::DeleteAllData(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute_copy(&dwmdusertype),
        ...
        unsafe extern "system" fn CopyData<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdsourcehandle: u32,
            pszmdsourcepath: windows_core::PCWSTR,
            hmddesthandle: u32,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::GetDataPaths(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute_copy(&dwmdidentifier),
        ...
        unsafe extern "system" fn OpenKey<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdhandle: u32,
            pszmdpath: windows_core::PCWSTR,
            dwmdaccessrequested: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMSAdminBaseW_Impl::OpenKey(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute_copy(&dwmdaccessrequested),
                    core::mem::transmute_copy(&dwmdtimeout),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CloseKey<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hmdhandle: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ChangePermissions<
            Identity: IMSAdminBaseW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::ChangePermissions(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute_copy(&dwmdtimeout),
                    core::mem::transmute_copy(&dwmdaccessrequested),
        ...
        unsafe extern "system" fn SaveData<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetHandleInfo<
            Identity: IMSAdminBaseW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetSystemChangeNumber<
            Identity: IMSAdminBaseW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetDataSetNumber<
            Identity: IMSAdminBaseW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMSAdminBaseW_Impl::GetDataSetNumber(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                ) {
        ...
        unsafe extern "system" fn SetLastChangeTime<
            Identity: IMSAdminBaseW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::SetLastChangeTime(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute_copy(&pftmdlastchangetime),
                    core::mem::transmute_copy(&blocaltime),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetLastChangeTime<
            Identity: IMSAdminBaseW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::GetLastChangeTime(
                    this,
                    core::mem::transmute_copy(&hmdhandle),
                    core::mem::transmute(&pszmdpath),
                    core::mem::transmute_copy(&pftmdlastchangetime),
        ...
        unsafe extern "system" fn KeyExchangePhase1<
            Identity: IMSAdminBaseW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn KeyExchangePhase2<
            Identity: IMSAdminBaseW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Backup<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszmdbackuplocation: windows_core::PCWSTR,
            dwmdversion: u32,
            dwmdflags: u32,
        ...
        unsafe extern "system" fn Restore<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszmdbackuplocation: windows_core::PCWSTR,
            dwmdversion: u32,
            dwmdflags: u32,
        ...
        unsafe extern "system" fn EnumBackups<Identity: IMSAdminBaseW_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszmdbackuplocation: windows_core::PWSTR,
            pdwmdversion: *mut u32,
            pftmdbackuptime: *mut super::super::Foundation::FILETIME,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::EnumBackups(
                    this,
                    core::mem::transmute_copy(&pszmdbackuplocation),
                    core::mem::transmute_copy(&pdwmdversion),
                    core::mem::transmute_copy(&pftmdbackuptime),
                    core::mem::transmute_copy(&dwmdenumindex),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeleteBackup<
            Identity: IMSAdminBaseW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSAdminBaseW_Impl::DeleteBackup(
                    this,
                    core::mem::transmute(&pszmdbackuplocation),
                    core::mem::transmute_copy(&dwmdversion),
                )
        ...
        >(
            this: *mut core::ffi::c_void,
            piadmbwinterface: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetServerGuid<
            Identity: IMSAdminBaseW_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IMSImpExpHelpW,
    IMSImpExpHelpW_Vtbl,
    0x29ff67ff_8050_480f_9f30_cc41635f2f9d
);
windows_core::imp::interface_hierarchy!(IMSImpExpHelpW, windows_core::IUnknown);
impl IMSImpExpHelpW {
    pub unsafe fn EnumeratePathsInFile<P0, P1>(
        &self,
        pszfilename: P0,
        pszkeytype: P1,
        pszbuffer: Option<&mut [u16]>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EnumeratePathsInFile)(
                windows_core::Interface::as_raw(self),
                pszfilename.param().abi(),
                pszkeytype.param().abi(),
                pszbuffer
                    .as_deref()
                    .map_or(0, |slice| slice.len().try_into().unwrap()),
                core::mem::transmute(
...
pub struct IMSImpExpHelpW_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub EnumeratePathsInFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        u32,
...
pub trait IMSImpExpHelpW_Impl: windows_core::IUnknownImpl {
    fn EnumeratePathsInFile(
        &self,
        pszfilename: &windows_core::PCWSTR,
        pszkeytype: &windows_core::PCWSTR,
        dwmdbuffersize: u32,
        pszbuffer: windows_core::PWSTR,
        pdwmdrequiredbuffersize: *mut u32,
    ) -> windows_core::Result<()>;
...
impl IMSImpExpHelpW_Vtbl {
    pub const fn new<Identity: IMSImpExpHelpW_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn EnumeratePathsInFile<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMSImpExpHelpW_Impl::EnumeratePathsInFile(
                    this,
                    core::mem::transmute(&pszfilename),
                    core::mem::transmute(&pszkeytype),
                    core::mem::transmute_copy(&dwmdbuffersize),
                    core::mem::transmute_copy(&pszbuffer),
                    core::mem::transmute_copy(&pdwmdrequiredbuffersize),
                )
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            EnumeratePathsInFile: EnumeratePathsInFile::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub const LIBID_ASPTypeLibrary: windows_core::GUID =
    windows_core::GUID::from_u128(0xd97a6da0_a85c_11cf_83ae_00a0c90c2bd8);
pub const LIBID_IISRSTALib: windows_core::GUID =
    windows_core::GUID::from_u128(0xe8fb8614_588f_11d2_9d61_00c04f79c5fe);
pub const LIBID_WAMREGLib: windows_core::GUID =
    windows_core::GUID::from_u128(0x29822aa8_f302_11d0_9953_00c04fd919c1);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub type PFN_GETEXTENSIONVERSION =
    Option<unsafe extern "system" fn(pver: *mut HSE_VERSION_INFO) -> windows_core::BOOL>;
pub type PFN_HSE_CACHE_INVALIDATION_CALLBACK =
    Option<unsafe extern "system" fn(pszurl: windows_core::PCWSTR) -> windows_core::HRESULT>;
pub type PFN_HSE_GET_PROTOCOL_MANAGER_CUSTOM_INTERFACE_CALLBACK = Option<
    unsafe extern "system" fn(
        pszprotocolmanagerdll: windows_core::PCWSTR,
        pszprotocolmanagerdllinitfunction: windows_core::PCWSTR,
        dwcustominterfaceid: u32,
        ppcustominterface: *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
>;
pub type PFN_HSE_IO_COMPLETION = Option<
    unsafe extern "system" fn(
...
pub type PFN_HTTPEXTENSIONPROC =
    Option<unsafe extern "system" fn(pecb: *mut EXTENSION_CONTROL_BLOCK) -> u32>;
pub type PFN_IIS_GETSERVERVARIABLE = Option<
    unsafe extern "system" fn(
        param0: HCONN,
...
>;
pub type PFN_IIS_READCLIENT = Option<
    unsafe extern "system" fn(
        param0: HCONN,
...
>;
pub type PFN_IIS_SERVERSUPPORTFUNCTION = Option<
    unsafe extern "system" fn(
        param0: HCONN,
        param1: u32,
        param2: *mut core::ffi::c_void,
...
>;
pub type PFN_IIS_WRITECLIENT = Option<
    unsafe extern "system" fn(
        param0: HCONN,
        param1: *mut core::ffi::c_void,
        param2: *mut u32,
...
pub type PFN_TERMINATEEXTENSION =
    Option<unsafe extern "system" fn(dwflags: u32) -> windows_core::BOOL>;
pub type PFN_WEB_CORE_ACTIVATE = Option<
    unsafe extern "system" fn(
        pszapphostconfigfile: windows_core::PCWSTR,
        pszrootwebconfigfile: windows_core::PCWSTR,
        pszinstancename: windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
>;
pub type PFN_WEB_CORE_SET_METADATA_DLL_ENTRY = Option<
    unsafe extern "system" fn(
        pszmetadatatype: windows_core::PCWSTR,
        pszvalue: windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
>;
pub type PFN_WEB_CORE_SHUTDOWN =
    Option<unsafe extern "system" fn(fimmediate: u32) -> windows_core::HRESULT>;
...
pub const WEB_CORE_SET_METADATA_DLL_ENTRY: windows_core::PCSTR =
    windows_core::s!("WebCoreSetMetadata");

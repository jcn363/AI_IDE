...
#[inline]
pub unsafe fn CreateSecurityPage<P0>(
    psi: P0,
) -> windows_core::Result<super::super::super::UI::Controls::HPROPSHEETPAGE>
where
...
#[inline]
pub unsafe fn EditSecurity<P1>(
    hwndowner: super::super::super::Foundation::HWND,
    psi: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn EditSecurityAdvanced<P1>(
    hwndowner: super::super::super::Foundation::HWND,
    psi: P1,
...
pub const CFSTR_ACLUI_SID_INFO_LIST: windows_core::PCWSTR =
    windows_core::w!("CFSTR_ACLUI_SID_INFO_LIST");
...
windows_core::imp::define_interface!(
    ...
    0x3853dc76_9f35_407c_88a1_d19344365fbc
);
windows_core::imp::interface_hierarchy!(IEffectivePermission, windows_core::IUnknown);
impl IEffectivePermission {
    pub unsafe fn GetEffectivePermission<P2>(
        &self,
        pguidobjecttype: *const windows_core::GUID,
        pusersid: super::super::PSID,
        pszservername: P2,
        psd: super::super::PSECURITY_DESCRIPTOR,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetEffectivePermission)(
                windows_core::Interface::as_raw(self),
                pguidobjecttype,
                pusersid,
                pszservername.param().abi(),
                psd,
                ppobjecttypelist as _,
                pcobjecttypelistlength as _,
                ppgrantedaccesslist as _,
                pcgrantedaccesslistlength as _,
            )
            .ok()
        }
    }
...
pub struct IEffectivePermission_Vtbl {
    ...
    pub GetEffectivePermission: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        super::super::PSID,
        windows_core::PCWSTR,
        super::super::PSECURITY_DESCRIPTOR,
        *mut *mut super::super::OBJECT_TYPE_LIST,
        *mut u32,
        *mut *mut u32,
        *mut u32,
...
impl IEffectivePermission_Vtbl {
    pub const fn new<Identity: IEffectivePermission_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetEffectivePermission<
            Identity: IEffectivePermission_Impl,
            const OFFSET: isize,
        >(
            ...
            unsafe {
                ...
                IEffectivePermission_Impl::GetEffectivePermission(
                    this,
                    core::mem::transmute_copy(&pguidobjecttype),
                    core::mem::transmute_copy(&pusersid),
                    core::mem::transmute(&pszservername),
                    core::mem::transmute_copy(&psd),
                    core::mem::transmute_copy(&ppobjecttypelist),
                    core::mem::transmute_copy(&pcobjecttypelistlength),
                    core::mem::transmute_copy(&ppgrantedaccesslist),
                    core::mem::transmute_copy(&pcgrantedaccesslistlength),
                )
                .into()
            }
        }
        Self {
            ...
            GetEffectivePermission: GetEffectivePermission::<Identity, OFFSET>,
        }
    }
...
windows_core::imp::define_interface!(
    ...
    0x941fabca_dd47_4fca_90bb_b0e10255f20d
);
...
pub struct IEffectivePermission2_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ComputeEffectivePermissionWithSecondarySecurity:
        unsafe extern "system" fn(
            ...
            *const super::AUTHZ_SID_OPERATION,
            *const super::super::TOKEN_GROUPS,
            *const super::AUTHZ_SID_OPERATION,
            *const super::AUTHZ_SECURITY_ATTRIBUTES_INFORMATION,
            *const super::AUTHZ_SECURITY_ATTRIBUTE_OPERATION,
            *const super::AUTHZ_SECURITY_ATTRIBUTES_INFORMATION,
            *const super::AUTHZ_SECURITY_ATTRIBUTE_OPERATION,
            *mut EFFPERM_RESULT_LIST,
        ) -> windows_core::HRESULT,
}
...
impl IEffectivePermission2_Vtbl {
    pub const fn new<Identity: IEffectivePermission2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ComputeEffectivePermissionWithSecondarySecurity<
            Identity: IEffectivePermission2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            psid: super::super::PSID,
        ...
        Self {
            ...
            ComputeEffectivePermissionWithSecondarySecurity:
                ComputeEffectivePermissionWithSecondarySecurity::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl ISecurityInformation {
    ...
    pub unsafe fn GetSecurity(
        &self,
        requestedinformation: super::super::OBJECT_SECURITY_INFORMATION,
    ...
    pub unsafe fn GetAccessRights(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetAccessRights)(
                windows_core::Interface::as_raw(self),
                pguidobjecttype,
                dwflags,
                ppaccess as _,
                pcaccesses as _,
                pidefaultaccess as _,
            )
            .ok()
        }
    }
    pub unsafe fn MapGeneric(
        &self,
        pguidobjecttype: *const windows_core::GUID,
        paceflags: *mut u8,
        pmask: *mut u32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).MapGeneric)(
                windows_core::Interface::as_raw(self),
                pguidobjecttype,
                paceflags as _,
                pmask as _,
    ...
    pub unsafe fn GetInheritTypes(
        &self,
        ppinherittypes: *mut *mut SI_INHERIT_TYPE,
        pcinherittypes: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetInheritTypes)(
                windows_core::Interface::as_raw(self),
                ppinherittypes as _,
                pcinherittypes as _,
            )
    ...
    #[cfg(feature = "Win32_UI_Controls")]
    pub unsafe fn PropertySheetPageCallback(
        &self,
        hwnd: super::super::super::Foundation::HWND,
        umsg: super::super::super::UI::Controls::PSPCB_MESSAGE,
        upage: SI_PAGE_TYPE,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).PropertySheetPageCallback)(
                windows_core::Interface::as_raw(self),
                hwnd,
                umsg,
                upage,
...
pub struct ISecurityInformation_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetObjectInformation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SI_OBJECT_INFO,
    ) -> windows_core::HRESULT,
    pub GetSecurity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::OBJECT_SECURITY_INFORMATION,
    ...
    pub GetAccessRights: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
    ...
    pub MapGeneric: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetInheritTypes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut SI_INHERIT_TYPE,
        *mut u32,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_UI_Controls")]
    pub PropertySheetPageCallback: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::Foundation::HWND,
        super::super::super::UI::Controls::PSPCB_MESSAGE,
        SI_PAGE_TYPE,
    ) -> windows_core::HRESULT,
...
impl ISecurityInformation_Vtbl {
    pub const fn new<Identity: ISecurityInformation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetObjectInformation<
            Identity: ISecurityInformation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pobjectinfo: *mut SI_OBJECT_INFO,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISecurityInformation_Impl::GetObjectInformation(
                    this,
                    core::mem::transmute_copy(&pobjectinfo),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISecurityInformation_Impl::GetSecurity(
                    this,
                    core::mem::transmute_copy(&requestedinformation),
                    core::mem::transmute_copy(&ppsecuritydescriptor),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISecurityInformation_Impl::SetSecurity(
                    this,
                    core::mem::transmute_copy(&securityinformation),
                    core::mem::transmute_copy(&psecuritydescriptor),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetAccessRights<
            Identity: ISecurityInformation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISecurityInformation_Impl::GetAccessRights(
                    this,
                    core::mem::transmute_copy(&pguidobjecttype),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&ppaccess),
                    core::mem::transmute_copy(&pcaccesses),
                    core::mem::transmute_copy(&pidefaultaccess),
                )
                .into()
            }
        }
        unsafe extern "system" fn MapGeneric<
            Identity: ISecurityInformation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISecurityInformation_Impl::MapGeneric(
                    this,
                    core::mem::transmute_copy(&pguidobjecttype),
                    core::mem::transmute_copy(&paceflags),
                    core::mem::transmute_copy(&pmask),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetInheritTypes<
            Identity: ISecurityInformation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISecurityInformation_Impl::GetInheritTypes(
                    this,
                    core::mem::transmute_copy(&ppinherittypes),
                    core::mem::transmute_copy(&pcinherittypes),
                )
                .into()
            }
        }
        unsafe extern "system" fn PropertySheetPageCallback<
            Identity: ISecurityInformation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISecurityInformation_Impl::PropertySheetPageCallback(
                    this,
                    core::mem::transmute_copy(&hwnd),
                    core::mem::transmute_copy(&umsg),
                    core::mem::transmute_copy(&upage),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xc3ccfdb4_6f88_11d2_a3ce_00c04fb1782a
);
...
impl ISecurityInformation2 {
    pub unsafe fn IsDaclCanonical(&self, pdacl: *const super::super::ACL) -> windows_core::BOOL {
        unsafe {
            (windows_core::Interface::vtable(self).IsDaclCanonical)(
                windows_core::Interface::as_raw(self),
                pdacl,
            )
        }
    ...
    pub unsafe fn LookupSids(
        &self,
        csids: u32,
        rgpsids: *const super::super::PSID,
    ) -> windows_core::Result<super::super::super::System::Com::IDataObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LookupSids)(
                windows_core::Interface::as_raw(self),
                csids,
                rgpsids,
                &mut result__,
...
pub struct ISecurityInformation2_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub IsDaclCanonical: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::super::ACL,
    ) -> windows_core::BOOL,
    #[cfg(feature = "Win32_System_Com")]
    pub LookupSids: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const super::super::PSID,
...
impl ISecurityInformation2_Vtbl {
    pub const fn new<Identity: ISecurityInformation2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsDaclCanonical<
            Identity: ISecurityInformation2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pdacl: *const super::super::ACL,
        ) -> windows_core::BOOL {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn LookupSids<
            Identity: ISecurityInformation2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            csids: u32,
            rgpsids: *const super::super::PSID,
            ppdo: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISecurityInformation2_Impl::LookupSids(
                    this,
                    core::mem::transmute_copy(&csids),
                    core::mem::transmute_copy(&rgpsids),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0xe2cdc9cc_31bd_4f8f_8c8b_b641af516a1a
);
...
impl ISecurityInformation3 {
    pub unsafe fn GetFullResourceName(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFullResourceName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn OpenElevatedEditor(
        &self,
        hwnd: super::super::super::Foundation::HWND,
        upage: SI_PAGE_TYPE,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OpenElevatedEditor)(
                windows_core::Interface::as_raw(self),
                hwnd,
                upage,
            )
...
pub struct ISecurityInformation3_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetFullResourceName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub OpenElevatedEditor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::Foundation::HWND,
        SI_PAGE_TYPE,
    ) -> windows_core::HRESULT,
...
impl ISecurityInformation3_Vtbl {
    pub const fn new<Identity: ISecurityInformation3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetFullResourceName<
            Identity: ISecurityInformation3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppszresourcename: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OpenElevatedEditor<
            Identity: ISecurityInformation3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISecurityInformation3_Impl::OpenElevatedEditor(
                    this,
                    core::mem::transmute_copy(&hwnd),
                    core::mem::transmute_copy(&upage),
                )
...
windows_core::imp::define_interface!(
    ...
    0xea961070_cd14_4621_ace4_f63c03e583e4
);
windows_core::imp::interface_hierarchy!(ISecurityInformation4, windows_core::IUnknown);
impl ISecurityInformation4 {
    pub unsafe fn GetSecondarySecurity(
        &self,
        psecurityobjects: *mut *mut SECURITY_OBJECT,
        psecurityobjectcount: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetSecondarySecurity)(
                windows_core::Interface::as_raw(self),
                psecurityobjects as _,
                psecurityobjectcount as _,
            )
            .ok()
        }
    }
...
pub struct ISecurityInformation4_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetSecondarySecurity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut SECURITY_OBJECT,
        *mut u32,
    ) -> windows_core::HRESULT,
}
...
impl ISecurityInformation4_Vtbl {
    pub const fn new<Identity: ISecurityInformation4_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetSecondarySecurity<
            Identity: ISecurityInformation4_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            psecurityobjects: *mut *mut SECURITY_OBJECT,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISecurityInformation4_Impl::GetSecondarySecurity(
                    this,
                    core::mem::transmute_copy(&psecurityobjects),
                    core::mem::transmute_copy(&psecurityobjectcount),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetSecondarySecurity: GetSecondarySecurity::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xfc3066eb_79ef_444b_9111_d18a75ebf2fa
);
windows_core::imp::interface_hierarchy!(ISecurityObjectTypeInfo, windows_core::IUnknown);
impl ISecurityObjectTypeInfo {
    pub unsafe fn GetInheritSource(
        &self,
        si: u32,
        pacl: *mut super::super::ACL,
        ppinheritarray: *mut *mut super::INHERITED_FROMA,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetInheritSource)(
                windows_core::Interface::as_raw(self),
                si,
                pacl as _,
                ppinheritarray as _,
...
pub struct ISecurityObjectTypeInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetInheritSource: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut super::super::ACL,
        *mut *mut super::INHERITED_FROMA,
    ) -> windows_core::HRESULT,
}
...
impl ISecurityObjectTypeInfo_Vtbl {
    pub const fn new<Identity: ISecurityObjectTypeInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetInheritSource<
            Identity: ISecurityObjectTypeInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            si: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISecurityObjectTypeInfo_Impl::GetInheritSource(
                    this,
                    core::mem::transmute_copy(&si),
                    core::mem::transmute_copy(&pacl),
                    core::mem::transmute_copy(&ppinheritarray),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetInheritSource: GetInheritSource::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub const SI_ENABLE_EDIT_ATTRIBUTE_CONDITION: SI_OBJECT_INFO_FLAGS =
    SI_OBJECT_INFO_FLAGS(536870912u32);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]

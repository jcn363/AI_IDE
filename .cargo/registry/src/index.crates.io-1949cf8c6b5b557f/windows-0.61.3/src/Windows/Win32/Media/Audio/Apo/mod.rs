pub const APOERR_ALREADY_INITIALIZED: windows_core::HRESULT =
    windows_core::HRESULT(0x887D0001_u32 as _);
pub const APOERR_ALREADY_UNLOCKED: windows_core::HRESULT =
    windows_core::HRESULT(0x887D0006_u32 as _);
pub const APOERR_APO_LOCKED: windows_core::HRESULT = windows_core::HRESULT(0x887D000A_u32 as _);
pub const APOERR_BUFFERS_OVERLAP: windows_core::HRESULT =
    windows_core::HRESULT(0x887D0005_u32 as _);
pub const APOERR_FORMAT_NOT_SUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0x887D0003_u32 as _);
pub const APOERR_INVALID_APO_CLSID: windows_core::HRESULT =
    windows_core::HRESULT(0x887D0004_u32 as _);
pub const APOERR_INVALID_COEFFCOUNT: windows_core::HRESULT =
    windows_core::HRESULT(0x887D000B_u32 as _);
pub const APOERR_INVALID_COEFFICIENT: windows_core::HRESULT =
    windows_core::HRESULT(0x887D000C_u32 as _);
pub const APOERR_INVALID_CONNECTION_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0x887D0009_u32 as _);
pub const APOERR_INVALID_CURVE_PARAM: windows_core::HRESULT =
    windows_core::HRESULT(0x887D000D_u32 as _);
pub const APOERR_INVALID_INPUTID: windows_core::HRESULT =
    windows_core::HRESULT(0x887D000E_u32 as _);
pub const APOERR_INVALID_OUTPUT_MAXFRAMECOUNT: windows_core::HRESULT =
    windows_core::HRESULT(0x887D0008_u32 as _);
pub const APOERR_NOT_INITIALIZED: windows_core::HRESULT =
    windows_core::HRESULT(0x887D0002_u32 as _);
pub const APOERR_NUM_CONNECTIONS_INVALID: windows_core::HRESULT =
    windows_core::HRESULT(0x887D0007_u32 as _);
#[repr(C)]
...
pub struct APOInitSystemEffects {
    ...
    pub pAPOEndpointProperties: core::mem::ManuallyDrop<
        Option<super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>,
    >,
    pub pAPOSystemEffectsProperties: core::mem::ManuallyDrop<
        Option<super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>,
    >,
...
pub struct APOInitSystemEffects3 {
    ...
    pub pServiceProvider:
        core::mem::ManuallyDrop<Option<super::super::super::System::Com::IServiceProvider>>,
    pub pDeviceCollection: core::mem::ManuallyDrop<Option<super::IMMDeviceCollection>>,
    pub nSoftwareIoDeviceInCollection: u32,
    pub nSoftwareIoConnectorIndex: u32,
    pub AudioProcessingMode: windows_core::GUID,
...
pub union APO_NOTIFICATION_0 {
    pub audioEndpointVolumeChange:
        core::mem::ManuallyDrop<AUDIO_ENDPOINT_VOLUME_CHANGE_NOTIFICATION>,
    pub audioEndpointPropertyChange:
        core::mem::ManuallyDrop<AUDIO_ENDPOINT_PROPERTY_CHANGE_NOTIFICATION>,
    pub audioSystemEffectsPropertyChange:
        core::mem::ManuallyDrop<AUDIO_SYSTEMEFFECTS_PROPERTY_CHANGE_NOTIFICATION>,
    pub audioEndpointVolumeChange2:
        core::mem::ManuallyDrop<AUDIO_ENDPOINT_VOLUME_CHANGE_NOTIFICATION2>,
...
pub union APO_NOTIFICATION_DESCRIPTOR_0 {
    pub audioEndpointVolume:
        core::mem::ManuallyDrop<AUDIO_ENDPOINT_VOLUME_APO_NOTIFICATION_DESCRIPTOR>,
    pub audioEndpointPropertyChange:
        core::mem::ManuallyDrop<AUDIO_ENDPOINT_PROPERTY_CHANGE_APO_NOTIFICATION_DESCRIPTOR>,
    pub audioSystemEffectsPropertyChange:
        core::mem::ManuallyDrop<AUDIO_SYSTEMEFFECTS_PROPERTY_CHANGE_APO_NOTIFICATION_DESCRIPTOR>,
    pub audioMicrophoneBoost:
        core::mem::ManuallyDrop<AUDIO_MICROPHONE_BOOST_APO_NOTIFICATION_DESCRIPTOR>,
}
...
pub const APO_NOTIFICATION_TYPE_DEVICE_ORIENTATION: APO_NOTIFICATION_TYPE =
    APO_NOTIFICATION_TYPE(5i32);
pub const APO_NOTIFICATION_TYPE_ENDPOINT_PROPERTY_CHANGE: APO_NOTIFICATION_TYPE =
    APO_NOTIFICATION_TYPE(2i32);
pub const APO_NOTIFICATION_TYPE_ENDPOINT_VOLUME: APO_NOTIFICATION_TYPE =
    APO_NOTIFICATION_TYPE(1i32);
pub const APO_NOTIFICATION_TYPE_ENDPOINT_VOLUME2: APO_NOTIFICATION_TYPE =
    APO_NOTIFICATION_TYPE(4i32);
pub const APO_NOTIFICATION_TYPE_MICROPHONE_BOOST: APO_NOTIFICATION_TYPE =
    APO_NOTIFICATION_TYPE(6i32);
pub const APO_NOTIFICATION_TYPE_NONE: APO_NOTIFICATION_TYPE = APO_NOTIFICATION_TYPE(0i32);
pub const APO_NOTIFICATION_TYPE_SYSTEM_EFFECTS_PROPERTY_CHANGE: APO_NOTIFICATION_TYPE =
    APO_NOTIFICATION_TYPE(3i32);
#[repr(C)]
...
pub struct AUDIO_ENDPOINT_PROPERTY_CHANGE_NOTIFICATION {
    ...
    pub propertyStore: core::mem::ManuallyDrop<
        Option<super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>,
    >,
...
pub struct AudioFXExtensionParams {
    ...
    pub pFxProperties: core::mem::ManuallyDrop<
        Option<super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>,
    >,
}
...
pub const DEVICE_ROTATED_180_DEGREES_CLOCKWISE: DEVICE_ORIENTATION_TYPE =
    DEVICE_ORIENTATION_TYPE(2i32);
pub const DEVICE_ROTATED_270_DEGREES_CLOCKWISE: DEVICE_ORIENTATION_TYPE =
    DEVICE_ORIENTATION_TYPE(3i32);
pub const DEVICE_ROTATED_90_DEGREES_CLOCKWISE: DEVICE_ORIENTATION_TYPE =
    DEVICE_ORIENTATION_TYPE(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct EAudioConstriction(pub i32);
pub type FNAPONOTIFICATIONCALLBACK = Option<
    unsafe extern "system" fn(
        pproperties: *mut APO_REG_PROPERTIES,
        pvrefdata: *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
>;
windows_core::imp::define_interface!(
    IApoAcousticEchoCancellation,
    IApoAcousticEchoCancellation_Vtbl,
    0x25385759_3236_4101_a943_25693dfb5d2d
);
...
windows_core::imp::define_interface!(
    ...
    0x4ceb0aab_fa19_48ed_a857_87771ae1b768
);
...
impl IApoAuxiliaryInputConfiguration {
    pub unsafe fn AddAuxiliaryInput(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AddAuxiliaryInput)(
                windows_core::Interface::as_raw(self),
                dwinputid,
                pbydata.len().try_into().unwrap(),
                core::mem::transmute(pbydata.as_ptr()),
                core::mem::transmute(pinputconnection),
            )
            .ok()
        }
    }
    pub unsafe fn RemoveAuxiliaryInput(&self, dwinputid: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveAuxiliaryInput)(
                windows_core::Interface::as_raw(self),
                dwinputid,
            )
            .ok()
    ...
    pub unsafe fn IsInputFormatSupported<P0>(
        &self,
        prequestedinputformat: P0,
        ...
        P0: windows_core::Param<IAudioMediaType>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).IsInputFormatSupported)(
                windows_core::Interface::as_raw(self),
                prequestedinputformat.param().abi(),
                &mut result__,
            )
...
pub struct IApoAuxiliaryInputConfiguration_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub AddAuxiliaryInput: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const u8,
        *const APO_CONNECTION_DESCRIPTOR,
    ) -> windows_core::HRESULT,
    pub RemoveAuxiliaryInput:
...
pub trait IApoAuxiliaryInputConfiguration_Impl: windows_core::IUnknownImpl {
    ...
    fn IsInputFormatSupported(
        &self,
        prequestedinputformat: windows_core::Ref<'_, IAudioMediaType>,
    ) -> windows_core::Result<IAudioMediaType>;
}
    ...
    pub const fn new<Identity: IApoAuxiliaryInputConfiguration_Impl, const OFFSET: isize>() -> Self
    {
        ...
        >(
            ...
            unsafe {
                ...
                IApoAuxiliaryInputConfiguration_Impl::AddAuxiliaryInput(
                    this,
                    core::mem::transmute_copy(&dwinputid),
                    core::mem::transmute_copy(&cbdatasize),
                    core::mem::transmute_copy(&pbydata),
                    core::mem::transmute_copy(&pinputconnection),
                )
                .into()
            }
        }
        unsafe extern "system" fn RemoveAuxiliaryInput<
            Identity: IApoAuxiliaryInputConfiguration_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IApoAuxiliaryInputConfiguration_Impl::RemoveAuxiliaryInput(
                    this,
                    core::mem::transmute_copy(&dwinputid),
                )
                .into()
        ...
        >(
            this: *mut core::ffi::c_void,
            prequestedinputformat: *mut core::ffi::c_void,
            ppsupportedinputformat: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IApoAuxiliaryInputConfiguration_Impl::IsInputFormatSupported(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0xf851809c_c177_49a0_b1b2_b66f017943ab
);
...
impl IApoAuxiliaryInputRT {
    pub unsafe fn AcceptInput(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AcceptInput)(
                windows_core::Interface::as_raw(self),
                dwinputid,
                pinputconnection,
            )
...
pub struct IApoAuxiliaryInputRT_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub AcceptInput:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *const APO_CONNECTION_PROPERTY),
}
...
impl IApoAuxiliaryInputRT_Vtbl {
    pub const fn new<Identity: IApoAuxiliaryInputRT_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AcceptInput<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IApoAuxiliaryInputRT_Impl::AcceptInput(
                    this,
                    core::mem::transmute_copy(&dwinputid),
                    core::mem::transmute_copy(&pinputconnection),
                )
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            AcceptInput: AcceptInput::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x98f37dac_d0b6_49f5_896a_aa4d169a4c48
);
windows_core::imp::interface_hierarchy!(IAudioDeviceModulesClient, windows_core::IUnknown);
impl IAudioDeviceModulesClient {
    pub unsafe fn SetAudioDeviceModulesManager<P0>(
        &self,
        paudiodevicemodulesmanager: P0,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetAudioDeviceModulesManager)(
                windows_core::Interface::as_raw(self),
                paudiodevicemodulesmanager.param().abi(),
            )
            .ok()
        }
    }
...
pub struct IAudioDeviceModulesClient_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetAudioDeviceModulesManager: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IAudioDeviceModulesClient_Impl: windows_core::IUnknownImpl {
    fn SetAudioDeviceModulesManager(
        &self,
        paudiodevicemodulesmanager: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
}
impl IAudioDeviceModulesClient_Vtbl {
    pub const fn new<Identity: IAudioDeviceModulesClient_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetAudioDeviceModulesManager<
            Identity: IAudioDeviceModulesClient_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            paudiodevicemodulesmanager: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioDeviceModulesClient_Impl::SetAudioDeviceModulesManager(
                    this,
                    core::mem::transmute_copy(&paudiodevicemodulesmanager),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            SetAudioDeviceModulesManager: SetAudioDeviceModulesManager::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x4e997f73_b71f_4798_873b_ed7dfcf15b4d
);
...
impl IAudioMediaType {
    pub unsafe fn IsCompressedFormat(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsCompressedFormat)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetAudioFormat(&self) -> *mut super::WAVEFORMATEX {
        unsafe {
            (windows_core::Interface::vtable(self).GetAudioFormat)(windows_core::Interface::as_raw(
                self,
            ))
        }
    }
    pub unsafe fn GetUncompressedAudioFormat(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetUncompressedAudioFormat)(
                windows_core::Interface::as_raw(self),
                puncompressedaudioformat as _,
            )
            .ok()
        }
    }
...
pub struct IAudioMediaType_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub IsCompressedFormat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub GetUncompressedAudioFormat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait IAudioMediaType_Impl: windows_core::IUnknownImpl {
    ...
    fn IsEqual(
        &self,
        piaudiotype: windows_core::Ref<'_, IAudioMediaType>,
...
impl IAudioMediaType_Vtbl {
    pub const fn new<Identity: IAudioMediaType_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsCompressedFormat<
        ...
        unsafe extern "system" fn IsEqual<Identity: IAudioMediaType_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            piaudiotype: *mut core::ffi::c_void,
            pdwflags: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetAudioFormat<
            Identity: IAudioMediaType_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetUncompressedAudioFormat<
            Identity: IAudioMediaType_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioMediaType_Impl::GetUncompressedAudioFormat(
                    this,
                    core::mem::transmute_copy(&puncompressedaudioformat),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xfd7f2b29_24d0_4b5c_b177_592c39f9ca10
);
...
impl IAudioProcessingObject {
    ...
    pub unsafe fn IsInputFormatSupported<P0, P1>(
        &self,
        poppositeformat: P0,
        prequestedinputformat: P1,
    ) -> windows_core::Result<IAudioMediaType>
    where
        P0: windows_core::Param<IAudioMediaType>,
    ...
    pub unsafe fn IsOutputFormatSupported<P0, P1>(
        &self,
        poppositeformat: P0,
        prequestedoutputformat: P1,
    ) -> windows_core::Result<IAudioMediaType>
    where
        P0: windows_core::Param<IAudioMediaType>,
        P1: windows_core::Param<IAudioMediaType>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).IsOutputFormatSupported)(
                windows_core::Interface::as_raw(self),
                poppositeformat.param().abi(),
                prequestedoutputformat.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn GetInputChannelCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetInputChannelCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub trait IAudioProcessingObject_Impl: windows_core::IUnknownImpl {
    ...
    fn IsInputFormatSupported(
        &self,
        poppositeformat: windows_core::Ref<'_, IAudioMediaType>,
        prequestedinputformat: windows_core::Ref<'_, IAudioMediaType>,
    ) -> windows_core::Result<IAudioMediaType>;
    fn IsOutputFormatSupported(
        &self,
        poppositeformat: windows_core::Ref<'_, IAudioMediaType>,
        prequestedoutputformat: windows_core::Ref<'_, IAudioMediaType>,
    ) -> windows_core::Result<IAudioMediaType>;
...
impl IAudioProcessingObject_Vtbl {
    pub const fn new<Identity: IAudioProcessingObject_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetLatency<
            Identity: IAudioProcessingObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioProcessingObject_Impl::Initialize(
                    this,
                    core::mem::transmute_copy(&cbdatasize),
                    core::mem::transmute_copy(&pbydata),
                )
        ...
        >(
            this: *mut core::ffi::c_void,
            poppositeformat: *mut core::ffi::c_void,
            prequestedinputformat: *mut core::ffi::c_void,
            ppsupportedinputformat: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAudioProcessingObject_Impl::IsInputFormatSupported(
                    this,
                    core::mem::transmute_copy(&poppositeformat),
                    core::mem::transmute_copy(&prequestedinputformat),
                ) {
                    Ok(ok__) => {
                        ppsupportedinputformat.write(core::mem::transmute(ok__));
        ...
        >(
            this: *mut core::ffi::c_void,
            poppositeformat: *mut core::ffi::c_void,
            prequestedoutputformat: *mut core::ffi::c_void,
            ppsupportedoutputformat: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAudioProcessingObject_Impl::IsOutputFormatSupported(
                    this,
                    core::mem::transmute_copy(&poppositeformat),
        ...
        unsafe extern "system" fn GetInputChannelCount<
            Identity: IAudioProcessingObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x0e5ed805_aba6_49c3_8f9a_2b8c889c4fa8
);
...
impl IAudioProcessingObjectConfiguration {
    pub unsafe fn LockForProcess(
        &self,
        ppinputconnections: &[*const APO_CONNECTION_DESCRIPTOR],
        ppoutputconnections: &[*const APO_CONNECTION_DESCRIPTOR],
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).LockForProcess)(
                windows_core::Interface::as_raw(self),
                ppinputconnections.len().try_into().unwrap(),
                core::mem::transmute(ppinputconnections.as_ptr()),
                ppoutputconnections.len().try_into().unwrap(),
                core::mem::transmute(ppoutputconnections.as_ptr()),
            )
            .ok()
        }
    }
...
pub struct IAudioProcessingObjectConfiguration_Vtbl {
    ...
    pub LockForProcess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const *const APO_CONNECTION_DESCRIPTOR,
        u32,
        *const *const APO_CONNECTION_DESCRIPTOR,
    ) -> windows_core::HRESULT,
    pub UnlockForProcess:
...
impl IAudioProcessingObjectConfiguration_Vtbl {
    pub const fn new<Identity: IAudioProcessingObjectConfiguration_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn LockForProcess<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioProcessingObjectConfiguration_Impl::LockForProcess(
                    this,
                    core::mem::transmute_copy(&u32numinputconnections),
                    core::mem::transmute_copy(&ppinputconnections),
                    core::mem::transmute_copy(&u32numoutputconnections),
                    core::mem::transmute_copy(&ppoutputconnections),
                )
                .into()
            }
        }
        unsafe extern "system" fn UnlockForProcess<
            Identity: IAudioProcessingObjectConfiguration_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IAudioProcessingObjectLoggingService_Vtbl,
    0x698f0107_1745_4708_95a5_d84478a62a65
);
windows_core::imp::interface_hierarchy!(
    IAudioProcessingObjectLoggingService,
    windows_core::IUnknown
...
impl IAudioProcessingObjectLoggingService {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ApoLog)(
                windows_core::Interface::as_raw(self),
                level,
                format.param().abi(),
            )
...
pub struct IAudioProcessingObjectLoggingService_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ApoLog:
        unsafe extern "system" fn(*mut core::ffi::c_void, APO_LOG_LEVEL, windows_core::PCWSTR),
}
...
impl IAudioProcessingObjectLoggingService_Vtbl {
    pub const fn new<Identity: IAudioProcessingObjectLoggingService_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn ApoLog<
            Identity: IAudioProcessingObjectLoggingService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            level: APO_LOG_LEVEL,
            format: windows_core::PCWSTR,
        ) {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioProcessingObjectLoggingService_Impl::ApoLog(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0x56b0c76f_02fd_4b21_a52e_9f8219fc86e4
);
windows_core::imp::interface_hierarchy!(
    IAudioProcessingObjectNotifications,
    windows_core::IUnknown
...
impl IAudioProcessingObjectNotifications {
    pub unsafe fn GetApoNotificationRegistrationInfo(
        &self,
        aponotifications: *mut *mut APO_NOTIFICATION_DESCRIPTOR,
        count: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetApoNotificationRegistrationInfo)(
                windows_core::Interface::as_raw(self),
                aponotifications as _,
                count as _,
            )
            .ok()
        }
    ...
    pub unsafe fn HandleNotification(&self, aponotification: *const APO_NOTIFICATION) {
        unsafe {
            (windows_core::Interface::vtable(self).HandleNotification)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(aponotification),
            )
        }
    }
}
...
pub struct IAudioProcessingObjectNotifications_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetApoNotificationRegistrationInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut APO_NOTIFICATION_DESCRIPTOR,
        *mut u32,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub HandleNotification:
        unsafe extern "system" fn(*mut core::ffi::c_void, *const APO_NOTIFICATION),
...
impl IAudioProcessingObjectNotifications_Vtbl {
    pub const fn new<Identity: IAudioProcessingObjectNotifications_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn GetApoNotificationRegistrationInfo<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioProcessingObjectNotifications_Impl::GetApoNotificationRegistrationInfo(
                    this,
                    core::mem::transmute_copy(&aponotifications),
                    core::mem::transmute_copy(&count),
                )
                .into()
            }
        }
        unsafe extern "system" fn HandleNotification<
            Identity: IAudioProcessingObjectNotifications_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            aponotification: *const APO_NOTIFICATION,
        ) {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioProcessingObjectNotifications_Impl::HandleNotification(
                    this,
                    core::mem::transmute_copy(&aponotification),
                )
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetApoNotificationRegistrationInfo: GetApoNotificationRegistrationInfo::<
                Identity,
                OFFSET,
            >,
...
windows_core::imp::define_interface!(
    ...
    0xca2cfbde_a9d6_4eb0_bc95_c4d026b380f0
);
...
impl IAudioProcessingObjectNotifications2 {
    pub unsafe fn GetApoNotificationRegistrationInfo2(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetApoNotificationRegistrationInfo2)(
                windows_core::Interface::as_raw(self),
...
pub struct IAudioProcessingObjectNotifications2_Vtbl {
    ...
    pub GetApoNotificationRegistrationInfo2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
pub trait IAudioProcessingObjectNotifications2_Impl:
    IAudioProcessingObjectNotifications_Impl
{
...
impl IAudioProcessingObjectNotifications2_Vtbl {
    pub const fn new<Identity: IAudioProcessingObjectNotifications2_Impl, const OFFSET: isize>(
    ) -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioProcessingObjectNotifications2_Impl::GetApoNotificationRegistrationInfo2(
                    this,
                    core::mem::transmute_copy(&maxaponotificationtypesupported),
                    core::mem::transmute_copy(&aponotifications),
                    core::mem::transmute_copy(&count),
                )
                .into()
        ...
        Self {
            ...
            GetApoNotificationRegistrationInfo2: GetApoNotificationRegistrationInfo2::<
                Identity,
                OFFSET,
            >,
        }
...
windows_core::imp::define_interface!(
    ...
    0x9e1d6a6d_ddbc_4e95_a4c7_ad64ba37846c
);
...
impl IAudioProcessingObjectRT {
    pub unsafe fn APOProcess(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).APOProcess)(
                windows_core::Interface::as_raw(self),
                u32numinputconnections,
                ppinputconnections,
                u32numoutputconnections,
                ppoutputconnections as _,
            )
        }
    }
...
pub struct IAudioProcessingObjectRT_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub APOProcess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const *const APO_CONNECTION_PROPERTY,
        u32,
...
impl IAudioProcessingObjectRT_Vtbl {
    pub const fn new<Identity: IAudioProcessingObjectRT_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn APOProcess<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioProcessingObjectRT_Impl::APOProcess(
                    this,
                    core::mem::transmute_copy(&u32numinputconnections),
                    core::mem::transmute_copy(&ppinputconnections),
                    core::mem::transmute_copy(&u32numoutputconnections),
        ...
        unsafe extern "system" fn CalcInputFrames<
            Identity: IAudioProcessingObjectRT_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioProcessingObjectRT_Impl::CalcInputFrames(
                    this,
                    core::mem::transmute_copy(&u32outputframecount),
                )
            }
        }
        unsafe extern "system" fn CalcOutputFrames<
            Identity: IAudioProcessingObjectRT_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioProcessingObjectRT_Impl::CalcOutputFrames(
                    this,
                    core::mem::transmute_copy(&u32inputframecount),
                )
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0xacd65e2f_955b_4b57_b9bf_ac297bb752c9
);
windows_core::imp::interface_hierarchy!(
    IAudioProcessingObjectRTQueueService,
    windows_core::IUnknown
...
impl IAudioProcessingObjectRTQueueService {
    pub unsafe fn GetRealTimeWorkQueue(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRealTimeWorkQueue)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
impl IAudioProcessingObjectRTQueueService_Vtbl {
    pub const fn new<Identity: IAudioProcessingObjectRTQueueService_Impl, const OFFSET: isize>(
    ) -> Self {
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetRealTimeWorkQueue: GetRealTimeWorkQueue::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x7ba1db8f_78ad_49cd_9591_f79d80a17c81
);
...
impl IAudioProcessingObjectVBR {
    pub unsafe fn CalcMaxInputFrames(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CalcMaxInputFrames)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn CalcMaxOutputFrames(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CalcMaxOutputFrames)(
                windows_core::Interface::as_raw(self),
...
impl IAudioProcessingObjectVBR_Vtbl {
    pub const fn new<Identity: IAudioProcessingObjectVBR_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CalcMaxInputFrames<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAudioProcessingObjectVBR_Impl::CalcMaxInputFrames(
                    this,
                    core::mem::transmute_copy(&u32maxoutputframecount),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CalcMaxOutputFrames<
            Identity: IAudioProcessingObjectVBR_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAudioProcessingObjectVBR_Impl::CalcMaxOutputFrames(
                    this,
                    core::mem::transmute_copy(&u32maxinputframecount),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0x5fa00f27_add6_499a_8a9d_6b98521fa75b
);
...
windows_core::imp::define_interface!(
    ...
    IAudioSystemEffects2_Vtbl,
    0xbafe99d2_7436_44ce_9e0e_4d89afbfff56
);
...
impl IAudioSystemEffects2 {
    pub unsafe fn GetEffectsList(
        &self,
        ppeffectsids: *mut *mut windows_core::GUID,
        pceffects: *mut u32,
        event: super::super::super::Foundation::HANDLE,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetEffectsList)(
                windows_core::Interface::as_raw(self),
                ppeffectsids as _,
                pceffects as _,
                event,
...
pub struct IAudioSystemEffects2_Vtbl {
    ...
    pub GetEffectsList: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IAudioSystemEffects2_Vtbl {
    pub const fn new<Identity: IAudioSystemEffects2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetEffectsList<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioSystemEffects2_Impl::GetEffectsList(
                    this,
                    core::mem::transmute_copy(&ppeffectsids),
                    core::mem::transmute_copy(&pceffects),
        ...
        Self {
            base__: IAudioSystemEffects_Vtbl::new::<Identity, OFFSET>(),
            GetEffectsList: GetEffectsList::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xc58b31cd_fc6a_4255_bc1f_ad29bb0a4a17
);
...
impl IAudioSystemEffects3 {
    pub unsafe fn GetControllableSystemEffectsList(
        &self,
        effects: *mut *mut AUDIO_SYSTEMEFFECT,
        numeffects: *mut u32,
        event: Option<super::super::super::Foundation::HANDLE>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetControllableSystemEffectsList)(
                windows_core::Interface::as_raw(self),
                effects as _,
                numeffects as _,
    ...
    pub unsafe fn SetAudioSystemEffectState(
        &self,
        effectid: windows_core::GUID,
        state: AUDIO_SYSTEMEFFECT_STATE,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAudioSystemEffectState)(
                windows_core::Interface::as_raw(self),
...
pub struct IAudioSystemEffects3_Vtbl {
    ...
    pub GetControllableSystemEffectsList: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut AUDIO_SYSTEMEFFECT,
        *mut u32,
        super::super::super::Foundation::HANDLE,
    ) -> windows_core::HRESULT,
    pub SetAudioSystemEffectState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
...
impl IAudioSystemEffects3_Vtbl {
    pub const fn new<Identity: IAudioSystemEffects3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetControllableSystemEffectsList<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioSystemEffects3_Impl::GetControllableSystemEffectsList(
                    this,
        ...
        unsafe extern "system" fn SetAudioSystemEffectState<
            Identity: IAudioSystemEffects3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioSystemEffects3_Impl::SetAudioSystemEffectState(
                    this,
                    core::mem::transmute(&effectid),
...
windows_core::imp::define_interface!(
    ...
    0xb1176e34_bb7f_4f05_bebd_1b18a534e097
);
...
impl IAudioSystemEffectsCustomFormats {
    pub unsafe fn GetFormatCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFormatCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetFormatRepresentation(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFormatRepresentation)(
                windows_core::Interface::as_raw(self),
                nformat,
                &mut result__,
            )
...
pub struct IAudioSystemEffectsCustomFormats_Vtbl {
    ...
    pub GetFormatRepresentation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
...
impl IAudioSystemEffectsCustomFormats_Vtbl {
    ...
    {
        unsafe extern "system" fn GetFormatCount<
        ...
        >(
            this: *mut core::ffi::c_void,
            nformat: u32,
            ppformat: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAudioSystemEffectsCustomFormats_Impl::GetFormat(
                    this,
        ...
        unsafe extern "system" fn GetFormatRepresentation<
            Identity: IAudioSystemEffectsCustomFormats_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            nformat: u32,
            ppwstrformatrep: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAudioSystemEffectsCustomFormats_Impl::GetFormatRepresentation(
                    this,
                    core::mem::transmute_copy(&nformat),
                ) {
                    Ok(ok__) => {
...
pub const PKEY_APO_SWFallback_ProcessingModes: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd3993a3f_99c2_4402_b5ec_a92a0367664b),
        pid: 13,
    };
pub const PKEY_CompositeFX_EndpointEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 15,
    };
pub const PKEY_CompositeFX_KeywordDetector_EndpointEffectClsid:
    super::super::super::Foundation::PROPERTYKEY = super::super::super::Foundation::PROPERTYKEY {
    fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
    pid: 18,
};
pub const PKEY_CompositeFX_KeywordDetector_ModeEffectClsid:
    super::super::super::Foundation::PROPERTYKEY = super::super::super::Foundation::PROPERTYKEY {
    fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
    pid: 17,
};
pub const PKEY_CompositeFX_KeywordDetector_StreamEffectClsid:
    super::super::super::Foundation::PROPERTYKEY = super::super::super::Foundation::PROPERTYKEY {
    fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
    pid: 16,
};
pub const PKEY_CompositeFX_ModeEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 14,
    };
pub const PKEY_CompositeFX_Offload_ModeEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 20,
    };
pub const PKEY_CompositeFX_Offload_StreamEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 19,
    };
pub const PKEY_CompositeFX_StreamEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 13,
    };
pub const PKEY_EFX_KeywordDetector_ProcessingModes_Supported_For_Streaming:
    super::super::super::Foundation::PROPERTYKEY = super::super::super::Foundation::PROPERTYKEY {
    fmtid: windows_core::GUID::from_u128(0xd3993a3f_99c2_4402_b5ec_a92a0367664b),
    pid: 10,
};
pub const PKEY_EFX_ProcessingModes_Supported_For_Streaming:
    super::super::super::Foundation::PROPERTYKEY = super::super::super::Foundation::PROPERTYKEY {
    fmtid: windows_core::GUID::from_u128(0xd3993a3f_99c2_4402_b5ec_a92a0367664b),
    pid: 7,
};
pub const PKEY_FX_ApplyToBluetooth: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 30,
    };
pub const PKEY_FX_ApplyToCapture: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 33,
    };
pub const PKEY_FX_ApplyToRender: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 32,
    };
pub const PKEY_FX_ApplyToUsb: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 31,
    };
pub const PKEY_FX_Association: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 0,
    };
pub const PKEY_FX_Author: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 26,
    };
pub const PKEY_FX_EffectPackSchema_Version: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 29,
    };
pub const PKEY_FX_EffectPack_Schema_V1: windows_core::GUID =
    windows_core::GUID::from_u128(0x7abf23d9_727e_4d0b_86a3_dd501d260001);
pub const PKEY_FX_EndpointEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 7,
    };
pub const PKEY_FX_Enumerator: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 23,
    };
pub const PKEY_FX_FriendlyName: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 4,
    };
pub const PKEY_FX_KeywordDetector_EndpointEffectClsid:
    super::super::super::Foundation::PROPERTYKEY = super::super::super::Foundation::PROPERTYKEY {
    fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
    pid: 10,
};
pub const PKEY_FX_KeywordDetector_ModeEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 9,
    };
pub const PKEY_FX_KeywordDetector_StreamEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 8,
    };
pub const PKEY_FX_ModeEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 6,
    };
pub const PKEY_FX_ObjectId: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 27,
    };
pub const PKEY_FX_Offload_ModeEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 12,
    };
pub const PKEY_FX_Offload_StreamEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 11,
    };
pub const PKEY_FX_PostMixEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 2,
    };
pub const PKEY_FX_PreMixEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 1,
    };
pub const PKEY_FX_State: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 28,
    };
pub const PKEY_FX_StreamEffectClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 5,
    };
pub const PKEY_FX_SupportAppLauncher: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 21,
    };
pub const PKEY_FX_SupportedFormats: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 22,
    };
pub const PKEY_FX_UserInterfaceClsid: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 3,
    };
pub const PKEY_FX_VersionMajor: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 24,
    };
pub const PKEY_FX_VersionMinor: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0xd04e05a6_594b_4fb6_a80d_01af5eed7d1d),
        pid: 25,
    };
pub const PKEY_MFX_KeywordDetector_ProcessingModes_Supported_For_Streaming:
    super::super::super::Foundation::PROPERTYKEY = super::super::super::Foundation::PROPERTYKEY {
    fmtid: windows_core::GUID::from_u128(0xd3993a3f_99c2_4402_b5ec_a92a0367664b),
    pid: 9,
};
pub const PKEY_MFX_Offload_ProcessingModes_Supported_For_Streaming:
    super::super::super::Foundation::PROPERTYKEY = super::super::super::Foundation::PROPERTYKEY {
    fmtid: windows_core::GUID::from_u128(0xd3993a3f_99c2_4402_b5ec_a92a0367664b),
    pid: 12,
};
pub const PKEY_MFX_ProcessingModes_Supported_For_Streaming:
    super::super::super::Foundation::PROPERTYKEY = super::super::super::Foundation::PROPERTYKEY {
    fmtid: windows_core::GUID::from_u128(0xd3993a3f_99c2_4402_b5ec_a92a0367664b),
    pid: 6,
};
pub const PKEY_SFX_KeywordDetector_ProcessingModes_Supported_For_Streaming:
    super::super::super::Foundation::PROPERTYKEY = super::super::super::Foundation::PROPERTYKEY {
    fmtid: windows_core::GUID::from_u128(0xd3993a3f_99c2_4402_b5ec_a92a0367664b),
    pid: 8,
};
pub const PKEY_SFX_Offload_ProcessingModes_Supported_For_Streaming:
    super::super::super::Foundation::PROPERTYKEY = super::super::super::Foundation::PROPERTYKEY {
    fmtid: windows_core::GUID::from_u128(0xd3993a3f_99c2_4402_b5ec_a92a0367664b),
    pid: 11,
};
pub const PKEY_SFX_ProcessingModes_Supported_For_Streaming:
    super::super::super::Foundation::PROPERTYKEY = super::super::super::Foundation::PROPERTYKEY {
    fmtid: windows_core::GUID::from_u128(0xd3993a3f_99c2_4402_b5ec_a92a0367664b),
    pid: 5,
};
pub const SID_AudioProcessingObjectLoggingService: windows_core::GUID =
    windows_core::GUID::from_u128(0x8b8008af_09f9_456e_a173_bdb58499bce7);
pub const SID_AudioProcessingObjectRTQueue: windows_core::GUID =
    windows_core::GUID::from_u128(0x458c1a1f_6899_4c12_99ac_e2e6ac253104);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]

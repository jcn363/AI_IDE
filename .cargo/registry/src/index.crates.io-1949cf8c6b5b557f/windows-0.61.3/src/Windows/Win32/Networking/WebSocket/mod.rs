...
pub unsafe fn WebSocketBeginClientHandshake(
    ...
    pszsubprotocols: Option<&[windows_core::PCSTR]>,
    pszextensions: Option<&[windows_core::PCSTR]>,
...
#[inline]
pub unsafe fn WebSocketBeginServerHandshake<P1>(
    hwebsocket: WEB_SOCKET_HANDLE,
    pszsubprotocolselected: P1,
    pszextensionselected: Option<&[windows_core::PCSTR]>,
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        WebSocketBeginServerHandshake(
            hwebsocket,
            pszsubprotocolselected.param().abi(),
            core::mem::transmute(
            ...
            pszextensionselected
                .as_deref()
                .map_or(0, |slice| slice.len().try_into().unwrap()),
            core::mem::transmute(prequestheaders.as_ptr()),
            prequestheaders.len().try_into().unwrap(),
            presponseheaders as _,
            pulresponseheadercount as _,
        )
        .ok()
    }
}
...
pub unsafe fn WebSocketCompleteAction(
    hwebsocket: WEB_SOCKET_HANDLE,
    pvactioncontext: *const core::ffi::c_void,
...
) -> windows_core::Result<WEB_SOCKET_HANDLE> {
...
pub unsafe fn WebSocketEndClientHandshake(
    ...
    unsafe {
        WebSocketEndClientHandshake(
            hwebsocket,
            core::mem::transmute(presponseheaders.as_ptr()),
            presponseheaders.len().try_into().unwrap(),
            pulselectedextensions.unwrap_or(core::mem::zeroed()) as _,
            pulselectedextensioncount.unwrap_or(core::mem::zeroed()) as _,
            pulselectedsubprotocol.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WebSocketGetAction(
    ...
    pvapplicationcontext: Option<*mut *mut core::ffi::c_void>,
    pvactioncontext: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WebSocketGetAction(
            ...
            eactionqueue,
            pdatabuffers as _,
            puldatabuffercount as _,
            paction as _,
            pbuffertype as _,
            pvapplicationcontext.unwrap_or(core::mem::zeroed()) as _,
            pvactioncontext as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn WebSocketReceive(
    hwebsocket: WEB_SOCKET_HANDLE,
    pbuffer: Option<*const WEB_SOCKET_BUFFER>,

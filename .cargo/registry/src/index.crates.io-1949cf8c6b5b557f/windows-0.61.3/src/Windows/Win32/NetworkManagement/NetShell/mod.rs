...
pub unsafe fn PreprocessCommand(
    hmodule: Option<super::super::Foundation::HANDLE>,
    ppwcarguments: &mut [windows_core::PWSTR],
    dwcurrentindex: u32,
    ...
    unsafe {
        PreprocessCommand(
            ...
            core::mem::transmute(ppwcarguments.as_ptr()),
            dwcurrentindex,
            ppwcarguments.len().try_into().unwrap(),
            core::mem::transmute(
                ptttags
                    .as_deref()
            ...
            dwminargs,
            dwmaxargs,
            pdwtagtype.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn RegisterHelper(
    pguidparentcontext: *const windows_core::GUID,
...
pub type PFN_CUSTOM_HELP = Option<
    unsafe extern "system" fn(
        hmodule: super::super::Foundation::HANDLE,
        pwszcmdtoken: windows_core::PCWSTR,
    ),
>;
pub type PFN_HANDLE_CMD = Option<
    unsafe extern "system" fn(
        pwszmachine: windows_core::PCWSTR,
        ppwcarguments: *mut windows_core::PWSTR,
        dwcurrentindex: u32,
        dwargcount: u32,
        dwflags: u32,
        pvdata: *const core::ffi::c_void,
        pbdone: *mut windows_core::BOOL,
    ) -> u32,
>;
pub type PGET_RESOURCE_STRING_FN = Option<
    unsafe extern "system" fn(dwmsgid: u32, lpbuffer: windows_core::PCWSTR, nbuffermax: u32) -> u32,
>;
pub type PNS_CONTEXT_COMMIT_FN = Option<unsafe extern "system" fn(dwaction: u32) -> u32>;
pub type PNS_CONTEXT_CONNECT_FN =
    Option<unsafe extern "system" fn(pwszmachine: windows_core::PCWSTR) -> u32>;
pub type PNS_CONTEXT_DUMP_FN = Option<
    unsafe extern "system" fn(
        pwszrouter: windows_core::PCWSTR,
        ppwcarguments: *const windows_core::PCWSTR,
        dwargcount: u32,
        pvdata: *const core::ffi::c_void,
    ) -> u32,
>;
pub type PNS_DLL_INIT_FN = Option<
...
pub type PNS_HELPER_START_FN = Option<
    unsafe extern "system" fn(pguidparent: *const windows_core::GUID, dwversion: u32) -> u32,
>;
pub type PNS_HELPER_STOP_FN = Option<unsafe extern "system" fn(dwreserved: u32) -> u32>;
pub type PNS_OSVERSIONCHECK = Option<
    unsafe extern "system" fn(
        cimostype: u32,
        cimosproductsuite: u32,
        cimosversion: windows_core::PCWSTR,
        cimosbuildnumber: windows_core::PCWSTR,
        cimservicepackmajorversion: windows_core::PCWSTR,
        cimservicepackminorversion: windows_core::PCWSTR,
        uireserved: u32,
        dwreserved: u32,
    ) -> windows_core::BOOL,
>;

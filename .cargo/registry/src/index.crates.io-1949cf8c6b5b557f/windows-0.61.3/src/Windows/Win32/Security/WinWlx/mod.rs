...
>;
pub type PWLX_CHANGE_PASSWORD_NOTIFY = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
...
>;
pub type PWLX_CHANGE_PASSWORD_NOTIFY_EX = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        pmprinfo: *mut WLX_MPR_NOTIFY_INFO,
        dwchangeinfo: u32,
...
>;
#[cfg(feature = "Win32_System_StationsAndDesktops")]
pub type PWLX_CREATE_USER_DESKTOP = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        htoken: super::super::Foundation::HANDLE,
        flags: u32,
        pszdesktopname: windows_core::PCWSTR,
        ppdesktop: *mut *mut WLX_DESKTOP,
    ) -> windows_core::BOOL,
>;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type PWLX_DIALOG_BOX = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        hinst: super::super::Foundation::HANDLE,
        lpsztemplate: windows_core::PCWSTR,
        hwndowner: super::super::Foundation::HWND,
        dlgprc: super::super::UI::WindowsAndMessaging::DLGPROC,
    ) -> i32,
>;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type PWLX_DIALOG_BOX_INDIRECT = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        hinst: super::super::Foundation::HANDLE,
...
>;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type PWLX_DIALOG_BOX_INDIRECT_PARAM = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        hinst: super::super::Foundation::HANDLE,
        hdialogtemplate: *mut super::super::UI::WindowsAndMessaging::DLGTEMPLATE,
...
>;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type PWLX_DIALOG_BOX_PARAM = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        hinst: super::super::Foundation::HANDLE,
        lpsztemplate: windows_core::PCWSTR,
...
pub type PWLX_GET_OPTION = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        option: u32,
        value: *mut usize,
...
>;
#[cfg(feature = "Win32_System_StationsAndDesktops")]
pub type PWLX_GET_SOURCE_DESKTOP = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        ppdesktop: *mut *mut WLX_DESKTOP,
    ) -> windows_core::BOOL,
>;
pub type PWLX_MESSAGE_BOX = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        hwndowner: super::super::Foundation::HWND,
...
>;
pub type PWLX_QUERY_CLIENT_CREDENTIALS = Option<
    unsafe extern "system" fn(pcred: *mut WLX_CLIENT_CREDENTIALS_INFO_V1_0) -> windows_core::BOOL,
>;
pub type PWLX_QUERY_CONSOLESWITCH_CREDENTIALS =
    Option<unsafe extern "system" fn(pcred: *mut WLX_CONSOLESWITCH_CREDENTIALS_INFO_V1_0) -> u32>;
pub type PWLX_QUERY_IC_CREDENTIALS = Option<
    unsafe extern "system" fn(pcred: *mut WLX_CLIENT_CREDENTIALS_INFO_V1_0) -> windows_core::BOOL,
>;
pub type PWLX_QUERY_TERMINAL_SERVICES_DATA = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
...
>;
pub type PWLX_QUERY_TS_LOGON_CREDENTIALS = Option<
    unsafe extern "system" fn(pcred: *mut WLX_CLIENT_CREDENTIALS_INFO_V2_0) -> windows_core::BOOL,
>;
pub type PWLX_SAS_NOTIFY =
    Option<unsafe extern "system" fn(hwlx: super::super::Foundation::HANDLE, dwsastype: u32)>;
pub type PWLX_SET_CONTEXT_POINTER = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        pwlxcontext: *mut core::ffi::c_void,
    ),
>;
pub type PWLX_SET_OPTION = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        option: u32,
        value: usize,
...
>;
#[cfg(feature = "Win32_System_StationsAndDesktops")]
pub type PWLX_SET_RETURN_DESKTOP = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        pdesktop: *mut WLX_DESKTOP,
    ) -> windows_core::BOOL,
>;
pub type PWLX_SET_TIMEOUT = Option<
    unsafe extern "system" fn(
        hwlx: super::super::Foundation::HANDLE,
        timeout: u32,
    ) -> windows_core::BOOL,
...
pub type PWLX_SWITCH_DESKTOP_TO_USER =
    Option<unsafe extern "system" fn(hwlx: super::super::Foundation::HANDLE) -> i32>;
pub type PWLX_SWITCH_DESKTOP_TO_WINLOGON =
    Option<unsafe extern "system" fn(hwlx: super::super::Foundation::HANDLE) -> i32>;
pub type PWLX_USE_CTRL_ALT_DEL =
    Option<unsafe extern "system" fn(hwlx: super::super::Foundation::HANDLE)>;

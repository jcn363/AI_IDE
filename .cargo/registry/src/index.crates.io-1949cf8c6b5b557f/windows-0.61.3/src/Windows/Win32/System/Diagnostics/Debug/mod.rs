...
#[inline]
pub unsafe fn AddVectoredContinueHandler(
    first: u32,
...
#[inline]
pub unsafe fn CheckRemoteDebuggerPresent(
    hprocess: super::super::super::Foundation::HANDLE,
    pbdebuggerpresent: *mut windows_core::BOOL,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn CheckSumMappedFile(
    baseaddress: *const core::ffi::c_void,
    filelength: u32,
    headersum: *mut u32,
    checksum: *mut u32,
) -> *mut IMAGE_NT_HEADERS32 {
...
pub unsafe fn ContinueDebugEvent(
    dwprocessid: u32,
    dwthreadid: u32,
    dwcontinuestatus: super::super::super::Foundation::NTSTATUS,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn DebugBreakProcess(
    process: super::super::super::Foundation::HANDLE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn DecodeRemotePointer(
    processhandle: super::super::super::Foundation::HANDLE,
    ptr: Option<*const core::ffi::c_void>,
    decodedptr: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
    ...
    unsafe {
        DecodeRemotePointer(
            processhandle,
            ptr.unwrap_or(core::mem::zeroed()) as _,
            decodedptr as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn EncodeRemotePointer(
    processhandle: super::super::super::Foundation::HANDLE,
    ptr: Option<*const core::ffi::c_void>,
    encodedptr: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn EnumDirTree<P1, P2>(
    hprocess: Option<super::super::super::Foundation::HANDLE>,
    rootpath: P1,
    inputpathname: P2,
    outputpathbuffer: Option<windows_core::PSTR>,
    cb: PENUMDIRTREE_CALLBACK,
    data: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<windows_core::PCSTR>,
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        EnumDirTree(
            hprocess.unwrap_or(core::mem::zeroed()) as _,
            rootpath.param().abi(),
            inputpathname.param().abi(),
            outputpathbuffer.unwrap_or(core::mem::zeroed()) as _,
            cb,
...
pub unsafe fn EnumDirTreeW<P1, P2>(
    ...
    rootpath: P1,
    inputpathname: P2,
    outputpathbuffer: Option<windows_core::PWSTR>,
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn EnumerateLoadedModules(
    hprocess: super::super::super::Foundation::HANDLE,
    enumloadedmodulescallback: PENUMLOADED_MODULES_CALLBACK,
    usercontext: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        EnumerateLoadedModules(
            ...
            usercontext.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn EnumerateLoadedModules64(
    hprocess: super::super::super::Foundation::HANDLE,
...
#[inline]
pub unsafe fn EnumerateLoadedModulesExW(
    hprocess: super::super::super::Foundation::HANDLE,
...
#[inline]
pub unsafe fn EnumerateLoadedModulesW64(
    hprocess: super::super::super::Foundation::HANDLE,
    enumloadedmodulescallback: PENUMLOADED_MODULES_CALLBACKW64,
    usercontext: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
...
pub unsafe fn FindDebugInfoFile<P0, P1>(
    filename: P0,
    symbolpath: P1,
    debugfilepath: windows_core::PSTR,
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    let result__ = unsafe {
        FindDebugInfoFile(
            filename.param().abi(),
            symbolpath.param().abi(),
            core::mem::transmute(debugfilepath),
        )
    };
    (!result__.is_invalid())
        .then_some(result__)
...
pub unsafe fn FindDebugInfoFileEx<P0, P1>(
    ...
    callerdata: Option<*const core::ffi::c_void>,
) -> windows_core::Result<super::super::super::Foundation::HANDLE>
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    let result__ = unsafe {
        FindDebugInfoFileEx(
            ...
            core::mem::transmute(debugfilepath),
            callback,
            callerdata.unwrap_or(core::mem::zeroed()) as _,
        )
    };
    (!result__.is_invalid())
        .then_some(result__)
...
pub unsafe fn FindDebugInfoFileExW<P0, P1>(
    filename: P0,
    symbolpath: P1,
    debugfilepath: windows_core::PWSTR,
...
pub unsafe fn FindExecutableImage<P0, P1>(
    filename: P0,
    symbolpath: P1,
    imagefilepath: windows_core::PSTR,
) -> windows_core::Result<super::super::super::Foundation::HANDLE>
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    let result__ = unsafe {
        FindExecutableImage(
            filename.param().abi(),
            symbolpath.param().abi(),
            core::mem::transmute(imagefilepath),
        )
    };
    (!result__.is_invalid())
        .then_some(result__)
...
#[inline]
pub unsafe fn FindExecutableImageEx<P0, P1>(
    filename: P0,
    symbolpath: P1,
    imagefilepath: windows_core::PSTR,
...
pub unsafe fn FindExecutableImageExW<P0, P1>(
    filename: P0,
    symbolpath: P1,
    imagefilepath: windows_core::PWSTR,
...
#[inline]
pub unsafe fn FindFileInPath<P1, P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    searchpatha: P1,
    filename: P2,
...
pub unsafe fn FlushInstructionCache(
    hprocess: super::super::super::Foundation::HANDLE,
    lpbaseaddress: Option<*const core::ffi::c_void>,
    dwsize: usize,
) -> windows_core::Result<()> {
    ...
    unsafe {
        FlushInstructionCache(
            hprocess,
            lpbaseaddress.unwrap_or(core::mem::zeroed()) as _,
            dwsize,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn FormatMessageA(
    dwflags: FORMAT_MESSAGE_OPTIONS,
    lpsource: Option<*const core::ffi::c_void>,
    dwmessageid: u32,
    dwlanguageid: u32,
    lpbuffer: windows_core::PSTR,
    nsize: u32,
    ...
    unsafe {
        FormatMessageA(
            dwflags,
            lpsource.unwrap_or(core::mem::zeroed()) as _,
            dwmessageid,
            dwlanguageid,
            core::mem::transmute(lpbuffer),
            nsize,
            arguments.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn GetImageConfigInformation(
    ...
    imageconfiginformation: *mut IMAGE_LOAD_CONFIG_DIRECTORY32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn GetImageUnusedHeaderBytes(
    loadedimage: *const LOADED_IMAGE,
    sizeunusedheaderbytes: *mut u32,
) -> u32 {
...
#[inline]
pub unsafe fn GetThreadWaitChain(
    wcthandle: *const core::ffi::c_void,
    context: Option<usize>,
    flags: WAIT_CHAIN_THREAD_OPTIONS,
    threadid: u32,
    nodecount: *mut u32,
    nodeinfoarray: *mut WAITCHAIN_NODE_INFO,
    iscycle: *mut windows_core::BOOL,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn GetTimestampForLoadedLibrary(
    module: super::super::super::Foundation::HMODULE,
) -> u32 {
...
#[cfg(feature = "Win32_System_Kernel")]
#[inline]
pub unsafe fn GetXStateFeaturesMask(
...
#[inline]
pub unsafe fn ImageAddCertificate(
    filehandle: super::super::super::Foundation::HANDLE,
    certificate: *const super::super::super::Security::WinTrust::WIN_CERTIFICATE,
    index: *mut u32,
) -> windows_core::Result<()> {
...
pub unsafe fn ImageDirectoryEntryToDataEx(
    ...
    directoryentry: IMAGE_DIRECTORY_ENTRY,
    size: *mut u32,
    foundheader: Option<*mut *mut IMAGE_SECTION_HEADER>,
) -> *mut core::ffi::c_void {
    ...
    unsafe {
        ImageDirectoryEntryToDataEx(
            ...
            directoryentry,
            size as _,
            foundheader.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn ImageEnumerateCertificates(
    filehandle: super::super::super::Foundation::HANDLE,
    typefilter: u16,
    certificatecount: *mut u32,
    indices: Option<&mut [u32]>,
) -> windows_core::Result<()> {
...
#[cfg(feature = "Win32_Security_WinTrust")]
#[inline]
pub unsafe fn ImageGetCertificateData(
    filehandle: super::super::super::Foundation::HANDLE,
    certificateindex: u32,
    certificate: *mut super::super::super::Security::WinTrust::WIN_CERTIFICATE,
...
#[cfg(feature = "Win32_Security_WinTrust")]
#[inline]
pub unsafe fn ImageGetCertificateHeader(
    filehandle: super::super::super::Foundation::HANDLE,
    certificateindex: u32,
    certificateheader: *mut super::super::super::Security::WinTrust::WIN_CERTIFICATE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn ImageGetDigestStream(
    filehandle: super::super::super::Foundation::HANDLE,
    digestlevel: u32,
    digestfunction: DIGEST_FUNCTION,
    digesthandle: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn ImageRemoveCertificate(
    filehandle: super::super::super::Foundation::HANDLE,
    index: u32,
) -> windows_core::Result<()> {
...
#[cfg(feature = "Win32_System_SystemInformation")]
#[inline]
pub unsafe fn ImageRvaToSection(
...
#[cfg(feature = "Win32_System_SystemInformation")]
#[inline]
pub unsafe fn ImageRvaToVa(
    ntheaders: *const IMAGE_NT_HEADERS32,
    base: *const core::ffi::c_void,
    rva: u32,
    lastrvasection: Option<*const *const IMAGE_SECTION_HEADER>,
) -> *mut core::ffi::c_void {
    ...
    unsafe {
        ImageRvaToVa(
            ...
            base,
            rva,
            lastrvasection.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(any(
...
#[cfg(feature = "Win32_System_Kernel")]
#[inline]
pub unsafe fn InitializeContext(
...
#[cfg(feature = "Win32_System_Kernel")]
#[inline]
pub unsafe fn InitializeContext2(
    buffer: Option<*mut core::ffi::c_void>,
    contextflags: CONTEXT_FLAGS,
    context: *mut *mut CONTEXT,
    contextlength: *mut u32,
...
#[cfg(feature = "Win32_System_Kernel")]
#[inline]
pub unsafe fn LocateXStateFeature(
    context: *const CONTEXT,
    featureid: u32,
...
#[inline]
pub unsafe fn MapAndLoad<P0, P1>(
    imagename: P0,
    dllpath: P1,
...
#[inline]
pub unsafe fn MessageBeep(
    utype: super::super::super::UI::WindowsAndMessaging::MESSAGEBOX_STYLE,
) -> windows_core::Result<()> {
...
pub unsafe fn MiniDumpReadDumpStream(
    baseofdump: *const core::ffi::c_void,
    streamnumber: u32,
    dir: *mut *mut MINIDUMP_DIRECTORY,
    streampointer: *mut *mut core::ffi::c_void,
    ...
    unsafe {
        MiniDumpReadDumpStream(
            ...
            dir as _,
            streampointer as _,
            streamsize.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(all(
...
#[inline]
pub unsafe fn OpenThreadWaitChainSession(
...
pub unsafe fn RaiseFailFastException(
    pexceptionrecord: Option<*const EXCEPTION_RECORD>,
    pcontextrecord: Option<*const CONTEXT>,
    dwflags: u32,
) {
    ...
    unsafe {
        RaiseFailFastException(
            pexceptionrecord.unwrap_or(core::mem::zeroed()) as _,
            pcontextrecord.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
        )
    }
}
...
pub unsafe fn RangeMapAddPeImageSections<P1>(
    rmaphandle: *const core::ffi::c_void,
    imagename: P1,
    mappedimage: *const core::ffi::c_void,
    mappingbytes: u32,
    imagebase: u64,
    usertag: u64,
    mappingflags: u32,
...
pub unsafe fn RangeMapRead(
    ...
    unsafe {
        RangeMapRead(
            ...
            requestbytes,
            flags,
            donebytes.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn RangeMapRemove(
    rmaphandle: *const core::ffi::c_void,
    usertag: u64,
) -> windows_core::BOOL {
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        ReBaseImage(
            currentimagename.param().abi(),
            symbolpath.param().abi(),
            frebase.into(),
            frebasesysfileok.into(),
            fgoingdown.into(),
            checkimagesize,
            oldimagesize as _,
            oldimagebase as _,
...
#[inline]
pub unsafe fn RegisterWaitChainCOMCallback(
...
#[inline]
pub unsafe fn ReportSymbolLoadSummary<P1>(
    hprocess: super::super::super::Foundation::HANDLE,
    ploadmodule: P1,
...
#[inline]
pub unsafe fn RtlAddFunctionTable(
    ...
    unsafe {
        RtlAddFunctionTable(
            core::mem::transmute(functiontable.as_ptr()),
            functiontable.len().try_into().unwrap(),
            baseaddress,
        )
    }
}
...
#[cfg(any(target_arch = "arm64ec", target_arch = "x86_64"))]
#[inline]
pub unsafe fn RtlAddGrowableFunctionTable(
    dynamictable: *mut *mut core::ffi::c_void,
    functiontable: &[IMAGE_RUNTIME_FUNCTION_ENTRY],
    entrycount: u32,
    rangebase: usize,
    rangeend: usize,
...
pub unsafe fn RtlCaptureStackBackTrace(
    ...
    unsafe {
        RtlCaptureStackBackTrace(
            framestoskip,
            backtrace.len().try_into().unwrap(),
            core::mem::transmute(backtrace.as_ptr()),
    ...
    P5: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        RtlInstallFunctionTableCallback(
            ...
            callback,
            context.unwrap_or(core::mem::zeroed()) as _,
            outofprocesscallbackdll.param().abi(),
        )
    }
}
#[cfg(target_arch = "aarch64")]
...
#[cfg(any(target_arch = "arm64ec", target_arch = "x86_64"))]
#[inline]
pub unsafe fn RtlLookupFunctionEntry(
    controlpc: u64,
    imagebase: *mut u64,
    historytable: Option<*mut UNWIND_HISTORY_TABLE>,
    ...
    unsafe {
        RtlLookupFunctionEntry(
            controlpc,
            imagebase as _,
            historytable.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(target_arch = "aarch64")]
...
#[inline]
pub unsafe fn RtlPcToFileHeader(
    pcvalue: *const core::ffi::c_void,
    baseofimage: *mut *mut core::ffi::c_void,
) -> *mut core::ffi::c_void {
...
pub unsafe fn RtlRestoreContext(
    ...
    unsafe {
        RtlRestoreContext(
            contextrecord,
            exceptionrecord.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn RtlUnwind(
    targetframe: Option<*const core::ffi::c_void>,
    targetip: Option<*const core::ffi::c_void>,
    exceptionrecord: Option<*const EXCEPTION_RECORD>,
    returnvalue: *const core::ffi::c_void,
) {
    ...
    unsafe {
        RtlUnwind(
            targetframe.unwrap_or(core::mem::zeroed()) as _,
            targetip.unwrap_or(core::mem::zeroed()) as _,
            exceptionrecord.unwrap_or(core::mem::zeroed()) as _,
            returnvalue,
        )
    }
...
#[cfg(feature = "Win32_System_Kernel")]
#[inline]
pub unsafe fn RtlVirtualUnwind(
    ...
    contextpointers: Option<*mut KNONVOLATILE_CONTEXT_POINTERS>,
) -> super::super::Kernel::EXCEPTION_ROUTINE {
    ...
    unsafe {
        RtlVirtualUnwind(
            ...
            contextrecord as _,
            handlerdata as _,
            establisherframe as _,
            contextpointers.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(target_arch = "aarch64")]
...
pub unsafe fn SearchTreeForFile<P0, P1>(
    rootpath: P0,
    inputpathname: P1,
    outputpathbuffer: windows_core::PSTR,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SearchTreeForFile(
            rootpath.param().abi(),
            inputpathname.param().abi(),
            core::mem::transmute(outputpathbuffer),
        )
        .ok()
    }
}
...
pub unsafe fn SearchTreeForFileW<P0, P1>(
    rootpath: P0,
    inputpathname: P1,
    outputpathbuffer: windows_core::PWSTR,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn SetImageConfigInformation(
    loadedimage: *mut LOADED_IMAGE,
    imageconfiginformation: *const IMAGE_LOAD_CONFIG_DIRECTORY32,
) -> windows_core::Result<()> {
...
pub unsafe fn SetThreadErrorMode(
    ...
    lpoldmode: Option<*mut THREAD_ERROR_MODE>,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SymAddSourceStream<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    base: u64,
    streamfile: P2,
    buffer: Option<&[u8]>,
...
#[inline]
pub unsafe fn SymAddrIncludeInlineTrace(
    hprocess: super::super::super::Foundation::HANDLE,
    address: u64,
) -> u32 {
...
#[inline]
pub unsafe fn SymCompareInlineTrace(
    hprocess: super::super::super::Foundation::HANDLE,
    address1: u64,
    inlinecontext1: u32,
    retaddress1: u64,
...
#[inline]
pub unsafe fn SymDeleteSymbol<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
    name: P2,
    address: u64,
...
#[inline]
pub unsafe fn SymDeleteSymbolW<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
    name: P2,
    address: u64,
...
#[inline]
pub unsafe fn SymEnumLines<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    base: u64,
    obj: P2,
    file: P3,
...
#[inline]
pub unsafe fn SymEnumSourceFiles<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    modbase: u64,
    mask: P2,
...
#[inline]
pub unsafe fn SymEnumSourceFilesW<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    modbase: u64,
    mask: P2,
...
#[inline]
pub unsafe fn SymEnumSourceLines<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    base: u64,
    obj: P2,
    file: P3,
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SymEnumSourceLines(
            ...
            obj.param().abi(),
            file.param().abi(),
            line.unwrap_or(core::mem::zeroed()) as _,
            flags,
            enumlinescallback,
            usercontext.unwrap_or(core::mem::zeroed()) as _,
        )
...
#[inline]
pub unsafe fn SymEnumSourceLinesW<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    base: u64,
    obj: P2,
    file: P3,
...
#[inline]
pub unsafe fn SymEnumSymbols<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
    mask: P2,
    enumsymbolscallback: PSYM_ENUMERATESYMBOLS_CALLBACK,
...
#[inline]
pub unsafe fn SymEnumSymbolsEx<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
    mask: P2,
    enumsymbolscallback: PSYM_ENUMERATESYMBOLS_CALLBACK,
...
#[inline]
pub unsafe fn SymEnumSymbolsExW<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
    mask: P2,
...
#[inline]
pub unsafe fn SymEnumSymbolsForAddr(
    hprocess: super::super::super::Foundation::HANDLE,
    address: u64,
    enumsymbolscallback: PSYM_ENUMERATESYMBOLS_CALLBACK,
    usercontext: Option<*const core::ffi::c_void>,
...
#[inline]
pub unsafe fn SymEnumSymbolsForAddrW(
    hprocess: super::super::super::Foundation::HANDLE,
    address: u64,
    enumsymbolscallback: PSYM_ENUMERATESYMBOLS_CALLBACKW,
    usercontext: Option<*const core::ffi::c_void>,
...
#[inline]
pub unsafe fn SymEnumSymbolsW<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
    mask: P2,
    enumsymbolscallback: PSYM_ENUMERATESYMBOLS_CALLBACKW,
...
#[inline]
pub unsafe fn SymEnumTypesByName<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
    mask: P2,
    enumsymbolscallback: PSYM_ENUMERATESYMBOLS_CALLBACK,
...
#[inline]
pub unsafe fn SymEnumTypesByNameW<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
    mask: P2,
    enumsymbolscallback: PSYM_ENUMERATESYMBOLS_CALLBACKW,
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymEnumerateModules(
    hprocess: super::super::super::Foundation::HANDLE,
...
#[inline]
pub unsafe fn SymEnumerateModules64(
    hprocess: super::super::super::Foundation::HANDLE,
...
#[inline]
pub unsafe fn SymEnumerateModulesW64(
    hprocess: super::super::super::Foundation::HANDLE,
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymEnumerateSymbols(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u32,
...
#[inline]
pub unsafe fn SymEnumerateSymbols64(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymEnumerateSymbolsW(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u32,
...
#[inline]
pub unsafe fn SymEnumerateSymbolsW64(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
...
pub unsafe fn SymFindFileInPath<P1, P2>(
    ...
    searchpatha: P1,
    filename: P2,
    id: Option<*const core::ffi::c_void>,
    two: u32,
    three: u32,
    flags: SYM_FIND_ID_OPTION,
    foundfile: windows_core::PSTR,
...
#[inline]
pub unsafe fn SymFindFileInPathW<P1, P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    searchpatha: P1,
    filename: P2,
    id: Option<*const core::ffi::c_void>,
...
#[inline]
pub unsafe fn SymFromAddr(
    hprocess: super::super::super::Foundation::HANDLE,
    address: u64,
    displacement: Option<*mut u64>,
    ...
    unsafe {
        SymFromAddr(
            hprocess,
            address,
            displacement.unwrap_or(core::mem::zeroed()) as _,
            symbol as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn SymFromInlineContext(
    hprocess: super::super::super::Foundation::HANDLE,
    address: u64,
    inlinecontext: u32,
    displacement: Option<*mut u64>,
...
#[inline]
pub unsafe fn SymFromInlineContextW(
    hprocess: super::super::super::Foundation::HANDLE,
    address: u64,
    inlinecontext: u32,
    displacement: Option<*mut u64>,
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymFunctionTableAccess(
    hprocess: super::super::super::Foundation::HANDLE,
    addrbase: u32,
) -> *mut core::ffi::c_void {
...
#[inline]
pub unsafe fn SymFunctionTableAccess64(
    hprocess: super::super::super::Foundation::HANDLE,
    addrbase: u64,
) -> *mut core::ffi::c_void {
...
#[inline]
pub unsafe fn SymFunctionTableAccess64AccessRoutines(
    hprocess: super::super::super::Foundation::HANDLE,
    addrbase: u64,
    readmemoryroutine: PREAD_PROCESS_MEMORY_ROUTINE64,
    getmodulebaseroutine: PGET_MODULE_BASE_ROUTINE64,
...
#[inline]
pub unsafe fn SymGetFileLineOffsets64<P1, P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    modulename: P1,
    filename: P2,
    buffer: &mut [u64],
...
pub unsafe fn SymGetHomeDirectory(r#type: IMAGEHLP_HD_TYPE, dir: &mut [u8]) -> windows_core::PSTR {
    ...
    unsafe {
        SymGetHomeDirectory(
            r#type.0 as _,
            core::mem::transmute(dir.as_ptr()),
            dir.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn SymGetHomeDirectoryW(
    r#type: IMAGEHLP_HD_TYPE,
    dir: &mut [u16],
) -> windows_core::PWSTR {
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymGetLineFromAddr(
    hprocess: super::super::super::Foundation::HANDLE,
    dwaddr: u32,
    pdwdisplacement: *mut u32,
    line: *mut IMAGEHLP_LINE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SymGetLineFromAddr64(
    hprocess: super::super::super::Foundation::HANDLE,
    qwaddr: u64,
    pdwdisplacement: *mut u32,
...
#[inline]
pub unsafe fn SymGetLineFromAddrW64(
    hprocess: super::super::super::Foundation::HANDLE,
    dwaddr: u64,
    pdwdisplacement: *mut u32,
...
#[inline]
pub unsafe fn SymGetLineFromInlineContext(
    hprocess: super::super::super::Foundation::HANDLE,
    qwaddr: u64,
    inlinecontext: u32,
    qwmodulebaseaddress: Option<u64>,
    pdwdisplacement: *mut u32,
    line64: *mut IMAGEHLP_LINE64,
) -> windows_core::Result<()> {
    ...
    unsafe {
        SymGetLineFromInlineContext(
            ...
            qwaddr,
            inlinecontext,
            qwmodulebaseaddress.unwrap_or(core::mem::zeroed()) as _,
            pdwdisplacement as _,
            line64 as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn SymGetLineFromInlineContextW(
    hprocess: super::super::super::Foundation::HANDLE,
    dwaddr: u64,
    inlinecontext: u32,
    qwmodulebaseaddress: Option<u64>,
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymGetLineFromName<P1, P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    modulename: P1,
    filename: P2,
    dwlinenumber: u32,
...
#[inline]
pub unsafe fn SymGetLineFromName64<P1, P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    modulename: P1,
    filename: P2,
    dwlinenumber: u32,
...
#[inline]
pub unsafe fn SymGetLineFromNameW64<P1, P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    modulename: P1,
    filename: P2,
    dwlinenumber: u32,
...
#[inline]
pub unsafe fn SymGetLineNext64(
    hprocess: super::super::super::Foundation::HANDLE,
    line: *mut IMAGEHLP_LINE64,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SymGetLinePrevW64(
    hprocess: super::super::super::Foundation::HANDLE,
    line: *mut IMAGEHLP_LINEW64,
) -> windows_core::Result<()> {
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymGetModuleBase(
    hprocess: super::super::super::Foundation::HANDLE,
    dwaddr: u32,
) -> u32 {
...
#[inline]
pub unsafe fn SymGetModuleBase64(
    hprocess: super::super::super::Foundation::HANDLE,
    qwaddr: u64,
) -> u64 {
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymGetModuleInfo(
    hprocess: super::super::super::Foundation::HANDLE,
    dwaddr: u32,
    moduleinfo: *mut IMAGEHLP_MODULE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SymGetModuleInfo64(
    hprocess: super::super::super::Foundation::HANDLE,
    qwaddr: u64,
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymGetModuleInfoW(
    hprocess: super::super::super::Foundation::HANDLE,
    dwaddr: u32,
    moduleinfo: *mut IMAGEHLP_MODULEW,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SymGetModuleInfoW64(
    hprocess: super::super::super::Foundation::HANDLE,
    qwaddr: u64,
    moduleinfo: *mut IMAGEHLP_MODULEW64,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SymGetSearchPath(
    hprocess: super::super::super::Foundation::HANDLE,
    searchpatha: &mut [u8],
) -> windows_core::Result<()> {
    ...
    unsafe {
        SymGetSearchPath(
            hprocess,
            core::mem::transmute(searchpatha.as_ptr()),
            searchpatha.len().try_into().unwrap(),
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn SymGetSourceFile<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    base: u64,
    params: P2,
    filespec: P3,
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SymGetSourceFile(
            ...
            params.param().abi(),
            filespec.param().abi(),
            core::mem::transmute(filepath.as_ptr()),
            filepath.len().try_into().unwrap(),
        )
        .ok()
    }
}
#[inline]
pub unsafe fn SymGetSourceFileChecksum<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    base: u64,
    filespec: P2,
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SymGetSourceFileChecksum(
            ...
            filespec.param().abi(),
            pchecksumtype as _,
            core::mem::transmute(pchecksum.as_ptr()),
            pchecksum.len().try_into().unwrap(),
            pactualbyteswritten as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn SymGetSourceFileChecksumW<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    base: u64,
    filespec: P2,
    pchecksumtype: *mut u32,
...
#[inline]
pub unsafe fn SymGetSourceFileFromToken<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
...
#[inline]
pub unsafe fn SymGetSourceFileFromTokenByTokenName<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    token: *const core::ffi::c_void,
    tokenname: P2,
    params: P3,
...
#[inline]
pub unsafe fn SymGetSourceFileFromTokenByTokenNameW<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    token: *const core::ffi::c_void,
    tokenname: P2,
    params: P3,
...
#[inline]
pub unsafe fn SymGetSourceFileFromTokenW<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    token: *const core::ffi::c_void,
    params: P2,
    filepath: &mut [u16],
...
#[inline]
pub unsafe fn SymGetSourceFileToken<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    base: u64,
    filespec: P2,
...
#[inline]
pub unsafe fn SymGetSourceFileTokenByTokenName<P2, P3, P4>(
    hprocess: super::super::super::Foundation::HANDLE,
    base: u64,
    filespec: P2,
    tokenname: P3,
...
#[inline]
pub unsafe fn SymGetSourceFileTokenByTokenNameW<P2, P3, P4>(
    hprocess: super::super::super::Foundation::HANDLE,
    base: u64,
    filespec: P2,
    tokenname: P3,
...
#[inline]
pub unsafe fn SymGetSourceFileTokenW<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    base: u64,
    filespec: P2,
    token: *mut *mut core::ffi::c_void,
...
#[inline]
pub unsafe fn SymGetSourceFileW<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    base: u64,
    params: P2,
    filespec: P3,
...
#[inline]
pub unsafe fn SymGetSourceVarFromToken<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    token: *const core::ffi::c_void,
    params: P2,
    varname: P3,
...
#[inline]
pub unsafe fn SymGetSourceVarFromTokenW<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    token: *const core::ffi::c_void,
    params: P2,
    varname: P3,
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymGetSymFromAddr(
    hprocess: super::super::super::Foundation::HANDLE,
    dwaddr: u32,
    pdwdisplacement: Option<*mut u32>,
    symbol: *mut IMAGEHLP_SYMBOL,
) -> windows_core::Result<()> {
    ...
    unsafe {
        SymGetSymFromAddr(
            hprocess,
            dwaddr,
            pdwdisplacement.unwrap_or(core::mem::zeroed()) as _,
            symbol as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn SymGetSymFromAddr64(
    hprocess: super::super::super::Foundation::HANDLE,
    qwaddr: u64,
    pdwdisplacement: Option<*mut u64>,
    symbol: *mut IMAGEHLP_SYMBOL64,
) -> windows_core::Result<()> {
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymGetSymFromName<P1>(
    hprocess: super::super::super::Foundation::HANDLE,
    name: P1,
    symbol: *mut IMAGEHLP_SYMBOL,
) -> windows_core::Result<()>
...
#[inline]
pub unsafe fn SymGetSymFromName64<P1>(
    hprocess: super::super::super::Foundation::HANDLE,
    name: P1,
    symbol: *mut IMAGEHLP_SYMBOL64,
) -> windows_core::Result<()>
...
#[inline]
pub unsafe fn SymGetSymbolFile<P1, P2>(
    hprocess: Option<super::super::super::Foundation::HANDLE>,
    sympath: P1,
    imagefile: P2,
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SymGetSymbolFile(
            ...
            imagefile.param().abi(),
            r#type.0 as _,
            core::mem::transmute(symbolfile.as_ptr()),
            symbolfile.len().try_into().unwrap(),
            core::mem::transmute(dbgfile.as_ptr()),
            dbgfile.len().try_into().unwrap(),
        )
        .ok()
    }
}
#[inline]
pub unsafe fn SymGetSymbolFileW<P1, P2>(
    hprocess: Option<super::super::super::Foundation::HANDLE>,
    sympath: P1,
    imagefile: P2,
    r#type: IMAGEHLP_SF_TYPE,
...
#[inline]
pub unsafe fn SymGetTypeFromName<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
    name: P2,
    symbol: *mut SYMBOL_INFO,
...
#[inline]
pub unsafe fn SymGetTypeFromNameW<P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
    name: P2,
    symbol: *mut SYMBOL_INFOW,
...
#[inline]
pub unsafe fn SymGetTypeInfoEx(
    hprocess: super::super::super::Foundation::HANDLE,
    modbase: u64,
...
#[inline]
pub unsafe fn SymInitialize<P1>(
    hprocess: super::super::super::Foundation::HANDLE,
    usersearchpath: P1,
    finvadeprocess: bool,
) -> windows_core::Result<()>
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymLoadModule<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    hfile: Option<super::super::super::Foundation::HANDLE>,
    imagename: P2,
    modulename: P3,
    baseofdll: u32,
    sizeofdll: u32,
...
#[inline]
pub unsafe fn SymLoadModule64<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    hfile: Option<super::super::super::Foundation::HANDLE>,
    imagename: P2,
    modulename: P3,
...
#[inline]
pub unsafe fn SymLoadModuleEx<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    hfile: Option<super::super::super::Foundation::HANDLE>,
    imagename: P2,
    modulename: P3,
    baseofdll: u64,
    dllsize: u32,
    data: Option<*const MODLOAD_DATA>,
    flags: Option<SYM_LOAD_FLAGS>,
) -> u64
where
    P2: windows_core::Param<windows_core::PCSTR>,
    P3: windows_core::Param<windows_core::PCSTR>,
...
#[inline]
pub unsafe fn SymLoadModuleExW<P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    hfile: Option<super::super::super::Foundation::HANDLE>,
    imagename: P2,
    modulename: P3,
...
pub unsafe fn SymMatchFileName<P0, P1>(
    filename: P0,
    r#match: P1,
    filenamestop: Option<*mut windows_core::PSTR>,
    matchstop: Option<*mut windows_core::PSTR>,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SymMatchFileName(
            filename.param().abi(),
            r#match.param().abi(),
            filenamestop.unwrap_or(core::mem::zeroed()) as _,
            matchstop.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn SymMatchFileNameW<P0, P1>(
    filename: P0,
    r#match: P1,
    filenamestop: Option<*mut windows_core::PWSTR>,
    matchstop: Option<*mut windows_core::PWSTR>,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn SymMatchString<P0, P1>(
    string: P0,
    expression: P1,
    fcase: bool,
) -> windows_core::Result<()>
...
#[inline]
pub unsafe fn SymNextW(
    hprocess: super::super::super::Foundation::HANDLE,
    siw: *mut SYMBOL_INFOW,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SymQueryInlineTrace(
    hprocess: super::super::super::Foundation::HANDLE,
    startaddress: u64,
    startcontext: u32,
    startretaddress: u64,
...
#[inline]
pub unsafe fn SymRefreshModuleList(
    hprocess: super::super::super::Foundation::HANDLE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SymRegisterCallback64(
    hprocess: super::super::super::Foundation::HANDLE,
...
#[inline]
pub unsafe fn SymRegisterCallbackW64(
    hprocess: super::super::super::Foundation::HANDLE,
    callbackfunction: PSYMBOL_REGISTERED_CALLBACK64,
    usercontext: u64,
) -> windows_core::Result<()> {
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymRegisterFunctionEntryCallback(
    hprocess: super::super::super::Foundation::HANDLE,
    ...
    P4: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SymSearch(
            ...
            symtag.unwrap_or(core::mem::zeroed()) as _,
            mask.param().abi(),
            address.unwrap_or(core::mem::zeroed()) as _,
            enumsymbolscallback,
            usercontext.unwrap_or(core::mem::zeroed()) as _,
            options,
        )
...
#[inline]
pub unsafe fn SymSetExtendedOption(
...
#[inline]
pub unsafe fn SymSetHomeDirectory<P1>(
    hprocess: Option<super::super::super::Foundation::HANDLE>,
    dir: P1,
) -> windows_core::PSTR
where
...
#[inline]
pub unsafe fn SymSetHomeDirectoryW<P1>(
    hprocess: Option<super::super::super::Foundation::HANDLE>,
    dir: P1,
) -> windows_core::PWSTR
where
...
#[inline]
pub unsafe fn SymSetParentWindow(
...
#[inline]
pub unsafe fn SymSetScopeFromAddr(
    hprocess: super::super::super::Foundation::HANDLE,
    address: u64,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SymSetScopeFromIndex(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
    index: u32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SymSetSearchPath<P1>(
    hprocess: super::super::super::Foundation::HANDLE,
    searchpatha: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn SymSetSearchPathW<P1>(
    hprocess: super::super::super::Foundation::HANDLE,
    searchpatha: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn SymSrvDeltaName<P1, P2, P3, P4>(
    hprocess: super::super::super::Foundation::HANDLE,
    sympath: P1,
    r#type: P2,
    file1: P3,
...
#[inline]
pub unsafe fn SymSrvDeltaNameW<P1, P2, P3, P4>(
    hprocess: super::super::super::Foundation::HANDLE,
    sympath: P1,
    r#type: P2,
    file1: P3,
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SymSrvGetFileIndexString(
            ...
            srvpath.param().abi(),
            file.param().abi(),
            core::mem::transmute(index.as_ptr()),
            index.len().try_into().unwrap(),
            flags,
        )
        .ok()
    }
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SymSrvGetFileIndexes(
            ...
            id as _,
            val1 as _,
            val2.unwrap_or(core::mem::zeroed()) as _,
            flags,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn SymSrvGetFileIndexesW<P0>(
    file: P0,
    id: *mut windows_core::GUID,
    val1: *mut u32,
    val2: Option<*mut u32>,
...
#[inline]
pub unsafe fn SymSrvGetSupplement<P1, P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    sympath: P1,
    node: P2,
    file: P3,
...
#[inline]
pub unsafe fn SymSrvGetSupplementW<P1, P2, P3>(
    hprocess: super::super::super::Foundation::HANDLE,
    sympath: P1,
    node: P2,
    file: P3,
...
#[inline]
pub unsafe fn SymSrvIsStoreW<P1>(
    hprocess: Option<super::super::super::Foundation::HANDLE>,
    path: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn SymSrvStoreFile<P1, P2>(
    hprocess: super::super::super::Foundation::HANDLE,
    srvpath: P1,
    file: P2,
...
#[cfg(target_arch = "x86")]
#[inline]
pub unsafe fn SymUnDName(
    sym: *const IMAGEHLP_SYMBOL,
    undecname: &mut [u8],
) -> windows_core::Result<()> {
    ...
    unsafe {
        SymUnDName(
            sym,
            core::mem::transmute(undecname.as_ptr()),
            undecname.len().try_into().unwrap(),
        )
        .ok()
    }
}
#[inline]
pub unsafe fn SymUnDName64(
    sym: *const IMAGEHLP_SYMBOL64,
    undecname: &mut [u8],
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SymUnloadModule64(
    hprocess: super::super::super::Foundation::HANDLE,
    baseofdll: u64,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn TouchFileTimes(
    filehandle: super::super::super::Foundation::HANDLE,
    psystemtime: Option<*const super::super::super::Foundation::SYSTEMTIME>,
) -> windows_core::Result<()> {
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        UnDecorateSymbolName(
            name.param().abi(),
            core::mem::transmute(outputstring.as_ptr()),
            outputstring.len().try_into().unwrap(),
            flags,
        )
    }
}
...
#[cfg(feature = "Win32_System_SystemInformation")]
#[inline]
pub unsafe fn UpdateDebugInfoFileEx<P0, P1>(
    imagefilename: P0,
    symbolpath: P1,
    debugfilepath: windows_core::PSTR,
    ntheaders: *const IMAGE_NT_HEADERS32,
...
#[inline]
pub unsafe fn Wow64GetThreadContext(
    hthread: super::super::super::Foundation::HANDLE,
...
#[inline]
pub unsafe fn Wow64GetThreadSelectorEntry(
    hthread: super::super::super::Foundation::HANDLE,
    dwselector: u32,
...
#[inline]
pub unsafe fn Wow64SetThreadContext(
    hthread: super::super::super::Foundation::HANDLE,
...
pub const DBGPROP_ATTRIB_FRAME_INFINALLYBLOCK: DBGPROP_ATTRIB_FLAGS =
    DBGPROP_ATTRIB_FLAGS(67108864i32);
...
pub const DBGPROP_ATTRIB_HAS_EXTENDED_ATTRIBS: DBGPROP_ATTRIB_FLAGS =
    DBGPROP_ATTRIB_FLAGS(8388608i32);
...
pub const DBGPROP_ATTRIB_TYPE_IS_SYNCHRONIZED: DBGPROP_ATTRIB_FLAGS =
    DBGPROP_ATTRIB_FLAGS(2097152i32);
...
pub type DIGEST_FUNCTION = Option<
...
windows_core::imp::define_interface!(
    ...
    0x51973c52_cb0c_11d0_b5c9_00a0244a0e7a
);
...
impl IDebugExtendedProperty {
    ...
    pub unsafe fn GetExtendedPropertyInfo(
        &self,
        dwfieldspec: u32,
        nradix: u32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetExtendedPropertyInfo)(
                windows_core::Interface::as_raw(self),
                dwfieldspec,
                nradix,
                core::mem::transmute(pextendedpropertyinfo),
            )
            .ok()
        }
    }
    pub unsafe fn EnumExtendedMembers(
        &self,
        dwfieldspec: u32,
        nradix: u32,
    ) -> windows_core::Result<IEnumDebugExtendedPropertyInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumExtendedMembers)(
                windows_core::Interface::as_raw(self),
                dwfieldspec,
                nradix,
                &mut result__,
...
pub struct IDebugExtendedProperty_Vtbl {
    ...
    pub GetExtendedPropertyInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut ExtendedDebugPropertyInfo,
    ...
    pub EnumExtendedMembers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
...
impl IDebugExtendedProperty_Vtbl {
    pub const fn new<Identity: IDebugExtendedProperty_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetExtendedPropertyInfo<
        ...
        >(
            ...
            unsafe {
                ...
                IDebugExtendedProperty_Impl::GetExtendedPropertyInfo(
                    this,
                    core::mem::transmute_copy(&dwfieldspec),
                    core::mem::transmute_copy(&nradix),
                    core::mem::transmute_copy(&pextendedpropertyinfo),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumExtendedMembers<
            Identity: IDebugExtendedProperty_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dwfieldspec: u32,
            nradix: u32,
            ppeepi: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDebugExtendedProperty_Impl::EnumExtendedMembers(
                    this,
                    core::mem::transmute_copy(&dwfieldspec),
                    core::mem::transmute_copy(&nradix),
                ) {
...
windows_core::imp::define_interface!(
    IDebugProperty,
    IDebugProperty_Vtbl,
    0x51973c50_cb0c_11d0_b5c9_00a0244a0e7a
);
...
impl IDebugProperty {
    ...
    pub unsafe fn GetExtendedInfo(
        &self,
        cinfos: u32,
        rgguidextendedinfo: *const windows_core::GUID,
        rgvar: *mut super::super::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetExtendedInfo)(
                windows_core::Interface::as_raw(self),
                cinfos,
                rgguidextendedinfo,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetValueAsString)(
                windows_core::Interface::as_raw(self),
                pszvalue.param().abi(),
                nradix,
            )
    ...
    ) -> windows_core::Result<IEnumDebugPropertyInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct IDebugProperty_Vtbl {
    ...
    pub GetExtendedInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
    ...
    pub SetValueAsString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IDebugProperty_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDebugProperty_Impl::GetPropertyInfo(
                    this,
                    core::mem::transmute_copy(&dwfieldspec),
                    core::mem::transmute_copy(&nradix),
        ...
        unsafe extern "system" fn GetExtendedInfo<
            Identity: IDebugProperty_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDebugProperty_Impl::GetExtendedInfo(
                    this,
                    core::mem::transmute_copy(&cinfos),
                    core::mem::transmute_copy(&rgguidextendedinfo),
                    core::mem::transmute_copy(&rgvar),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetValueAsString<
            Identity: IDebugProperty_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDebugProperty_Impl::SetValueAsString(
                    this,
        ...
        >(
            ...
            nradix: u32,
            refiid: *const windows_core::GUID,
            ppepi: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDebugProperty_Impl::EnumMembers(
                    this,
                    core::mem::transmute_copy(&dwfieldspec),
                    core::mem::transmute_copy(&nradix),
        ...
        unsafe extern "system" fn GetParent<Identity: IDebugProperty_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IDebugPropertyEnumType_All_Vtbl,
    0x51973c55_cb0c_11d0_b5c9_00a0244a0e7a
);
...
impl IDebugPropertyEnumType_All_Vtbl {
    pub const fn new<Identity: IDebugPropertyEnumType_All_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            __midl__idebugpropertyenumtype_all0000: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x51973c57_cb0c_11d0_b5c9_00a0244a0e7a
);
...
impl IDebugPropertyEnumType_Arguments_Vtbl {
    ...
    {
        Self {
            base__: IDebugPropertyEnumType_All_Vtbl::new::<Identity, OFFSET>(),
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    IDebugPropertyEnumType_Locals_Vtbl,
    0x51973c56_cb0c_11d0_b5c9_00a0244a0e7a
);
...
impl IDebugPropertyEnumType_LocalsPlusArgs_Vtbl {
    pub const fn new<Identity: IDebugPropertyEnumType_LocalsPlusArgs_Impl, const OFFSET: isize>(
    ) -> Self {
        Self {
            base__: IDebugPropertyEnumType_All_Vtbl::new::<Identity, OFFSET>(),
        }
...
windows_core::imp::define_interface!(
    ...
    IDebugPropertyEnumType_Registers_Vtbl,
    0x51973c59_cb0c_11d0_b5c9_00a0244a0e7a
);
...
windows_core::imp::define_interface!(
    ...
    0x51973c53_cb0c_11d0_b5c9_00a0244a0e7a
);
    ...
    pub unsafe fn Next(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Next)(
                windows_core::Interface::as_raw(self),
                rgextendedpropertyinfo.len().try_into().unwrap(),
                core::mem::transmute(rgextendedpropertyinfo.as_ptr()),
                pceltfetched as _,
            )
            .ok()
        }
    ...
    pub const fn new<Identity: IEnumDebugExtendedPropertyInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumDebugExtendedPropertyInfo_Impl::Next(
                    this,
                    core::mem::transmute_copy(&celt),
                    core::mem::transmute_copy(&rgextendedpropertyinfo),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumDebugExtendedPropertyInfo_Impl::Skip(this, core::mem::transmute_copy(&celt))
                    .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x51973c51_cb0c_11d0_b5c9_00a0244a0e7a
);
windows_core::imp::interface_hierarchy!(IEnumDebugPropertyInfo, windows_core::IUnknown);
impl IEnumDebugPropertyInfo {
    pub unsafe fn Next(
        &self,
        pi: &mut [DebugPropertyInfo],
        pceltsfetched: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Next)(
                windows_core::Interface::as_raw(self),
                pi.len().try_into().unwrap(),
                core::mem::transmute(pi.as_ptr()),
                pceltsfetched as _,
            )
            .ok()
        }
    ...
    pub const fn new<Identity: IEnumDebugPropertyInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumDebugPropertyInfo_Impl::Next(
                    this,
                    core::mem::transmute_copy(&celt),
                    core::mem::transmute_copy(&pi),
                    core::mem::transmute_copy(&pceltsfetched),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IObjectSafety,
    IObjectSafety_Vtbl,
    0xcb5bdc81_93c1_11cf_8f20_00805f2cd064
);
windows_core::imp::interface_hierarchy!(IObjectSafety, windows_core::IUnknown);
impl IObjectSafety {
    pub unsafe fn GetInterfaceSafetyOptions(
        &self,
        riid: *const windows_core::GUID,
        pdwsupportedoptions: *mut u32,
        pdwenabledoptions: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetInterfaceSafetyOptions)(
                windows_core::Interface::as_raw(self),
                riid,
                pdwsupportedoptions as _,
                pdwenabledoptions as _,
            )
            .ok()
        }
    }
    pub unsafe fn SetInterfaceSafetyOptions(
        &self,
        riid: *const windows_core::GUID,
        dwoptionsetmask: u32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetInterfaceSafetyOptions)(
                windows_core::Interface::as_raw(self),
                riid,
                dwoptionsetmask,
                dwenabledoptions,
...
pub struct IObjectSafety_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetInterfaceSafetyOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub SetInterfaceSafetyOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        u32,
        u32,
...
impl IObjectSafety_Vtbl {
    pub const fn new<Identity: IObjectSafety_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetInterfaceSafetyOptions<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IObjectSafety_Impl::GetInterfaceSafetyOptions(
                    this,
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&pdwsupportedoptions),
                    core::mem::transmute_copy(&pdwenabledoptions),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetInterfaceSafetyOptions<
            Identity: IObjectSafety_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IObjectSafety_Impl::SetInterfaceSafetyOptions(
                    this,
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&dwoptionsetmask),
                    core::mem::transmute_copy(&dwenabledoptions),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x51973c54_cb0c_11d0_b5c9_00a0244a0e7a
);
...
impl IPerPropertyBrowsing2 {
    pub unsafe fn GetDisplayString(&self, dispid: i32) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDisplayString)(
                windows_core::Interface::as_raw(self),
                dispid,
                &mut result__,
            )
    ...
    pub unsafe fn MapPropertyToPage(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MapPropertyToPage)(
                windows_core::Interface::as_raw(self),
                dispid,
                &mut result__,
            )
    ...
    pub unsafe fn GetPredefinedStrings(
        &self,
        dispid: i32,
        pcastrings: *mut super::super::Ole::CALPOLESTR,
        pcacookies: *mut super::super::Ole::CADWORD,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPredefinedStrings)(
                windows_core::Interface::as_raw(self),
                dispid,
                pcastrings as _,
                pcacookies as _,
    ...
    pub unsafe fn SetPredefinedValue(
        &self,
        dispid: i32,
        dwcookie: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPredefinedValue)(
                windows_core::Interface::as_raw(self),
                dispid,
                dwcookie,
            )
...
pub struct IPerPropertyBrowsing2_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetDisplayString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub MapPropertyToPage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Ole")]
    pub GetPredefinedStrings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut super::super::Ole::CALPOLESTR,
        *mut super::super::Ole::CADWORD,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Ole"))]
    GetPredefinedStrings: usize,
    pub SetPredefinedValue:
...
impl IPerPropertyBrowsing2_Vtbl {
    pub const fn new<Identity: IPerPropertyBrowsing2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDisplayString<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IPerPropertyBrowsing2_Impl::GetDisplayString(
                    this,
                    core::mem::transmute_copy(&dispid),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn MapPropertyToPage<
            Identity: IPerPropertyBrowsing2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dispid: i32,
            pclsidproppage: *mut windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IPerPropertyBrowsing2_Impl::MapPropertyToPage(
                    this,
                    core::mem::transmute_copy(&dispid),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetPredefinedStrings<
            Identity: IPerPropertyBrowsing2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPerPropertyBrowsing2_Impl::GetPredefinedStrings(
                    this,
                    core::mem::transmute_copy(&dispid),
                    core::mem::transmute_copy(&pcastrings),
                    core::mem::transmute_copy(&pcacookies),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetPredefinedValue<
            Identity: IPerPropertyBrowsing2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPerPropertyBrowsing2_Impl::SetPredefinedValue(
                    this,
                    core::mem::transmute_copy(&dispid),
...
pub type PCOGETACTIVATIONSTATE = Option<
    unsafe extern "system" fn(
        param0: windows_core::GUID,
        param1: u32,
        param2: *mut u32,
    ) -> windows_core::HRESULT,
>;
pub type PCOGETCALLSTATE =
    Option<unsafe extern "system" fn(param0: i32, param1: *mut u32) -> windows_core::HRESULT>;
pub type PDBGHELP_CREATE_USER_DUMP_CALLBACK = Option<
    unsafe extern "system" fn(
        datatype: u32,
...
pub type PENUMDIRTREE_CALLBACK = Option<
    unsafe extern "system" fn(
        filepath: windows_core::PCSTR,
        callerdata: *const core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
pub type PENUMDIRTREE_CALLBACKW = Option<
    unsafe extern "system" fn(
...
>;
#[cfg(target_arch = "x86")]
pub type PENUMLOADED_MODULES_CALLBACK = Option<
    unsafe extern "system" fn(
        modulename: windows_core::PCSTR,
        modulebase: u32,
        modulesize: u32,
        usercontext: *const core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
pub type PENUMLOADED_MODULES_CALLBACK64 = Option<
    unsafe extern "system" fn(
        modulename: windows_core::PCSTR,
        modulebase: u64,
        modulesize: u32,
...
pub type PENUMLOADED_MODULES_CALLBACKW64 = Option<
    unsafe extern "system" fn(
        modulename: windows_core::PCWSTR,
        modulebase: u64,
        modulesize: u32,
        usercontext: *const core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
pub type PENUMSOURCEFILETOKENSCALLBACK = Option<
    unsafe extern "system" fn(token: *const core::ffi::c_void, size: usize) -> windows_core::BOOL,
>;
pub type PFINDFILEINPATHCALLBACK = Option<
    unsafe extern "system" fn(
        filename: windows_core::PCSTR,
        context: *const core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
pub type PFINDFILEINPATHCALLBACKW = Option<
    unsafe extern "system" fn(
        filename: windows_core::PCWSTR,
        context: *const core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
pub type PFIND_DEBUG_FILE_CALLBACK = Option<
    unsafe extern "system" fn(
        filehandle: super::super::super::Foundation::HANDLE,
        filename: windows_core::PCSTR,
        callerdata: *const core::ffi::c_void,
...
>;
pub type PFIND_DEBUG_FILE_CALLBACKW = Option<
    unsafe extern "system" fn(
        filehandle: super::super::super::Foundation::HANDLE,
        filename: windows_core::PCWSTR,
        callerdata: *const core::ffi::c_void,
...
>;
pub type PFIND_EXE_FILE_CALLBACK = Option<
    unsafe extern "system" fn(
        filehandle: super::super::super::Foundation::HANDLE,
        filename: windows_core::PCSTR,
        callerdata: *const core::ffi::c_void,
...
>;
pub type PFIND_EXE_FILE_CALLBACKW = Option<
    unsafe extern "system" fn(
        filehandle: super::super::super::Foundation::HANDLE,
        filename: windows_core::PCWSTR,
        callerdata: *const core::ffi::c_void,
...
#[cfg(target_arch = "x86")]
pub type PFUNCTION_TABLE_ACCESS_ROUTINE = Option<
    unsafe extern "system" fn(
        hprocess: super::super::super::Foundation::HANDLE,
        addrbase: u32,
    ) -> *mut core::ffi::c_void,
>;
pub type PFUNCTION_TABLE_ACCESS_ROUTINE64 = Option<
    unsafe extern "system" fn(
...
#[cfg(target_arch = "x86")]
pub type PGET_MODULE_BASE_ROUTINE = Option<
    unsafe extern "system" fn(
        hprocess: super::super::super::Foundation::HANDLE,
        address: u32,
    ) -> u32,
>;
pub type PGET_MODULE_BASE_ROUTINE64 = Option<
    unsafe extern "system" fn(
        hprocess: super::super::super::Foundation::HANDLE,
        address: u64,
    ) -> u64,
>;
#[cfg(any(target_arch = "arm64ec", target_arch = "x86_64"))]
pub type PGET_RUNTIME_FUNCTION_CALLBACK = Option<
    unsafe extern "system" fn(
        controlpc: u64,
        context: *const core::ffi::c_void,
    ) -> *mut IMAGE_RUNTIME_FUNCTION_ENTRY,
...
>;
pub type PGET_TARGET_ATTRIBUTE_VALUE64 = Option<
    unsafe extern "system" fn(
        hprocess: super::super::super::Foundation::HANDLE,
        attribute: u32,
        attributedata: u64,
        attributevalue: *mut u64,
    ) -> windows_core::BOOL,
>;
...
pub type PIMAGEHLP_STATUS_ROUTINE = Option<
    unsafe extern "system" fn(
        reason: IMAGEHLP_STATUS_REASON,
        imagename: windows_core::PCSTR,
        dllname: windows_core::PCSTR,
        va: usize,
        parameter: usize,
    ) -> windows_core::BOOL,
>;
pub type PIMAGEHLP_STATUS_ROUTINE32 = Option<
    unsafe extern "system" fn(
        reason: IMAGEHLP_STATUS_REASON,
        imagename: windows_core::PCSTR,
        dllname: windows_core::PCSTR,
...
>;
pub type PIMAGEHLP_STATUS_ROUTINE64 = Option<
    unsafe extern "system" fn(
        reason: IMAGEHLP_STATUS_REASON,
        imagename: windows_core::PCSTR,
        dllname: windows_core::PCSTR,
...
#[cfg(target_arch = "x86")]
pub type PREAD_PROCESS_MEMORY_ROUTINE = Option<
    unsafe extern "system" fn(
        hprocess: super::super::super::Foundation::HANDLE,
        lpbaseaddress: u32,
        lpbuffer: *mut core::ffi::c_void,
...
pub type PSYMBOLSERVERBYINDEXPROC = Option<
    unsafe extern "system" fn(
...
>;
pub type PSYMBOLSERVERBYINDEXPROCA = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCSTR,
        param1: windows_core::PCSTR,
        param2: windows_core::PCSTR,
...
>;
pub type PSYMBOLSERVERBYINDEXPROCW = Option<
    unsafe extern "system" fn(
...
pub type PSYMBOLSERVERCALLBACKPROC =
    Option<unsafe extern "system" fn(action: usize, data: u64, context: u64) -> windows_core::BOOL>;
pub type PSYMBOLSERVERCLOSEPROC = Option<unsafe extern "system" fn() -> windows_core::BOOL>;
pub type PSYMBOLSERVERDELTANAME = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCSTR,
        ...
        param5: u32,
        param6: u32,
        param7: windows_core::PCSTR,
        param8: usize,
    ) -> windows_core::BOOL,
>;
pub type PSYMBOLSERVERDELTANAMEW = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCWSTR,
        param1: *mut core::ffi::c_void,
        param2: u32,
        ...
        param5: u32,
        param6: u32,
        param7: windows_core::PCWSTR,
        param8: usize,
    ) -> windows_core::BOOL,
>;
pub type PSYMBOLSERVERGETINDEXSTRING = Option<
    unsafe extern "system" fn(
...
>;
pub type PSYMBOLSERVERGETINDEXSTRINGW = Option<
    unsafe extern "system" fn(
        param0: *mut core::ffi::c_void,
        param1: u32,
        param2: u32,
...
pub type PSYMBOLSERVERGETOPTIONDATAPROC =
    Option<unsafe extern "system" fn(param0: usize, param1: *mut u64) -> windows_core::BOOL>;
pub type PSYMBOLSERVERGETOPTIONSPROC = Option<unsafe extern "system" fn() -> usize>;
pub type PSYMBOLSERVERGETSUPPLEMENT = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCSTR,
        param1: windows_core::PCSTR,
        param2: windows_core::PCSTR,
...
>;
pub type PSYMBOLSERVERGETSUPPLEMENTW = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCWSTR,
        param1: windows_core::PCWSTR,
        param2: windows_core::PCWSTR,
...
pub type PSYMBOLSERVERGETVERSION =
    Option<unsafe extern "system" fn(param0: *mut API_VERSION) -> windows_core::BOOL>;
pub type PSYMBOLSERVERISSTORE =
    Option<unsafe extern "system" fn(param0: windows_core::PCSTR) -> windows_core::BOOL>;
pub type PSYMBOLSERVERISSTOREW =
    Option<unsafe extern "system" fn(param0: windows_core::PCWSTR) -> windows_core::BOOL>;
pub type PSYMBOLSERVERMESSAGEPROC =
    Option<unsafe extern "system" fn(action: usize, data: u64, context: u64) -> windows_core::BOOL>;
pub type PSYMBOLSERVEROPENPROC = Option<unsafe extern "system" fn() -> windows_core::BOOL>;
pub type PSYMBOLSERVERPINGPROC =
    Option<unsafe extern "system" fn(param0: windows_core::PCSTR) -> windows_core::BOOL>;
pub type PSYMBOLSERVERPINGPROCA =
    Option<unsafe extern "system" fn(param0: windows_core::PCSTR) -> windows_core::BOOL>;
pub type PSYMBOLSERVERPINGPROCW =
    Option<unsafe extern "system" fn(param0: windows_core::PCWSTR) -> windows_core::BOOL>;
pub type PSYMBOLSERVERPINGPROCWEX =
    Option<unsafe extern "system" fn(param0: windows_core::PCWSTR) -> windows_core::BOOL>;
pub type PSYMBOLSERVERPROC = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCSTR,
        param1: windows_core::PCSTR,
...
>;
pub type PSYMBOLSERVERPROCA = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCSTR,
        param1: windows_core::PCSTR,
        param2: *mut core::ffi::c_void,
...
>;
pub type PSYMBOLSERVERPROCW = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCWSTR,
        param1: windows_core::PCWSTR,
        param2: *mut core::ffi::c_void,
...
pub type PSYMBOLSERVERSETHTTPAUTHHEADER =
    Option<unsafe extern "system" fn(pszauthheader: windows_core::PCWSTR) -> windows_core::BOOL>;
pub type PSYMBOLSERVERSETOPTIONSPROC =
    Option<unsafe extern "system" fn(param0: usize, param1: u64) -> windows_core::BOOL>;
pub type PSYMBOLSERVERSETOPTIONSWPROC =
    Option<unsafe extern "system" fn(param0: usize, param1: u64) -> windows_core::BOOL>;
pub type PSYMBOLSERVERSTOREFILE = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCSTR,
        param1: windows_core::PCSTR,
        param2: *mut core::ffi::c_void,
...
>;
pub type PSYMBOLSERVERSTOREFILEW = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCWSTR,
        param1: windows_core::PCWSTR,
        param2: *mut core::ffi::c_void,
...
>;
pub type PSYMBOLSERVERSTORESUPPLEMENT = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCSTR,
        param1: windows_core::PCSTR,
        param2: windows_core::PCSTR,
...
>;
pub type PSYMBOLSERVERSTORESUPPLEMENTW = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCWSTR,
        param1: windows_core::PCWSTR,
        param2: windows_core::PCWSTR,
...
pub type PSYMBOLSERVERWEXPROC = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCWSTR,
        param1: windows_core::PCWSTR,
        param2: *mut core::ffi::c_void,
...
>;
pub type PSYMBOL_FUNCENTRY_CALLBACK = Option<
    unsafe extern "system" fn(
        hprocess: super::super::super::Foundation::HANDLE,
        addrbase: u32,
        usercontext: *const core::ffi::c_void,
...
>;
pub type PSYMBOL_FUNCENTRY_CALLBACK64 = Option<
    unsafe extern "system" fn(
        hprocess: super::super::super::Foundation::HANDLE,
        addrbase: u64,
        usercontext: u64,
...
>;
#[cfg(target_arch = "x86")]
pub type PSYMBOL_REGISTERED_CALLBACK = Option<
    unsafe extern "system" fn(
        hprocess: super::super::super::Foundation::HANDLE,
        actioncode: u32,
...
>;
pub type PSYMBOL_REGISTERED_CALLBACK64 = Option<
    unsafe extern "system" fn(
        hprocess: super::super::super::Foundation::HANDLE,
        actioncode: u32,
        callbackdata: u64,
...
>;
pub type PSYM_ENUMERATESYMBOLS_CALLBACK = Option<
    unsafe extern "system" fn(
...
>;
pub type PSYM_ENUMERATESYMBOLS_CALLBACKW = Option<
    unsafe extern "system" fn(
...
>;
pub type PSYM_ENUMLINES_CALLBACK = Option<
    unsafe extern "system" fn(
        lineinfo: *const SRCCODEINFO,
        usercontext: *const core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
pub type PSYM_ENUMLINES_CALLBACKW = Option<
    unsafe extern "system" fn(
...
>;
#[cfg(target_arch = "x86")]
pub type PSYM_ENUMMODULES_CALLBACK = Option<
    unsafe extern "system" fn(
        modulename: windows_core::PCSTR,
        baseofdll: u32,
        usercontext: *const core::ffi::c_void,
...
>;
pub type PSYM_ENUMMODULES_CALLBACK64 = Option<
    unsafe extern "system" fn(
        modulename: windows_core::PCSTR,
        baseofdll: u64,
        usercontext: *const core::ffi::c_void,
...
>;
pub type PSYM_ENUMMODULES_CALLBACKW64 = Option<
    unsafe extern "system" fn(
        modulename: windows_core::PCWSTR,
        baseofdll: u64,
        usercontext: *const core::ffi::c_void,
...
>;
pub type PSYM_ENUMPROCESSES_CALLBACK = Option<
    unsafe extern "system" fn(
        hprocess: super::super::super::Foundation::HANDLE,
        usercontext: *const core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
pub type PSYM_ENUMSOURCEFILES_CALLBACK = Option<
    unsafe extern "system" fn(
        psourcefile: *const SOURCEFILE,
        usercontext: *const core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
pub type PSYM_ENUMSOURCEFILES_CALLBACKW = Option<
    unsafe extern "system" fn(
...
>;
#[cfg(target_arch = "x86")]
pub type PSYM_ENUMSYMBOLS_CALLBACK = Option<
    unsafe extern "system" fn(
        symbolname: windows_core::PCSTR,
        symboladdress: u32,
        symbolsize: u32,
        usercontext: *const core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
pub type PSYM_ENUMSYMBOLS_CALLBACK64 = Option<
    unsafe extern "system" fn(
        symbolname: windows_core::PCSTR,
        symboladdress: u64,
        symbolsize: u32,
...
>;
pub type PSYM_ENUMSYMBOLS_CALLBACK64W = Option<
    unsafe extern "system" fn(
        symbolname: windows_core::PCWSTR,
        symboladdress: u64,
        symbolsize: u32,
        usercontext: *const core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
#[cfg(target_arch = "x86")]
pub type PSYM_ENUMSYMBOLS_CALLBACKW = Option<
    unsafe extern "system" fn(
        symbolname: windows_core::PCWSTR,
        symboladdress: u32,
        symbolsize: u32,
...
>;
#[cfg(target_arch = "x86")]
pub type PTRANSLATE_ADDRESS_ROUTINE = Option<
    unsafe extern "system" fn(
        hprocess: super::super::super::Foundation::HANDLE,
        hthread: super::super::super::Foundation::HANDLE,
        lpaddr: *mut ADDRESS,
...
pub type SYMADDSOURCESTREAM = Option<
    unsafe extern "system" fn(
...
>;
pub type SYMADDSOURCESTREAMA = Option<
    unsafe extern "system" fn(
        param0: super::super::super::Foundation::HANDLE,
        param1: u64,
        param2: windows_core::PCSTR,
...
pub type WHEA_ERROR_SOURCE_CORRECT_DEVICE_DRIVER = Option<
    unsafe extern "system" fn(
...
pub type WHEA_ERROR_SOURCE_INITIALIZE_DEVICE_DRIVER = Option<
    unsafe extern "system" fn(
...
pub const WOW64_CONTEXT_EXCEPTION_REPORTING: WOW64_CONTEXT_FLAGS =
    WOW64_CONTEXT_FLAGS(2147483648u32);

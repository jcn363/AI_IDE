...
pub unsafe fn PssCaptureSnapshot(
    ...
    unsafe {
        PssCaptureSnapshot(
            processhandle,
            captureflags,
            threadcontextflags.unwrap_or(core::mem::zeroed()) as _,
            snapshothandle as _,
        )
    }
}
...
pub unsafe fn PssDuplicateSnapshot(
    ...
    flags: Option<PSS_DUPLICATE_FLAGS>,
) -> u32 {
...
#[inline]
pub unsafe fn PssQuerySnapshot(
    snapshothandle: HPSS,
...
pub unsafe fn PssWalkMarkerCreate(
    allocator: Option<*const PSS_ALLOCATOR>,
    ...
    unsafe {
        PssWalkMarkerCreate(
            allocator.unwrap_or(core::mem::zeroed()) as _,
            walkmarkerhandle as _,
        )
    }
}
#[inline]

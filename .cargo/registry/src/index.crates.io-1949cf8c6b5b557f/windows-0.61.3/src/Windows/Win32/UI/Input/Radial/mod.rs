...
impl IRadialControllerConfigurationInterop_Vtbl {
    pub const fn new<Identity: IRadialControllerConfigurationInterop_Impl, const OFFSET: isize>(
    ) -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                IRadialControllerConfigurationInterop_Impl::GetForWindow(
                    this,
    ...
    >() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRadialControllerIndependentInputSourceInterop_Impl::CreateForWindow(
                    this,
                    core::mem::transmute_copy(&hwnd),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppv),
    ...
    pub const fn new<Identity: IRadialControllerInterop_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRadialControllerInterop_Impl::CreateForWindow(
                    this,
                    core::mem::transmute_copy(&hwnd),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppv),

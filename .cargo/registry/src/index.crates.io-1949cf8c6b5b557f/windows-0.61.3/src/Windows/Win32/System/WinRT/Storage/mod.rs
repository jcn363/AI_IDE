...
windows_core::imp::define_interface!(
    ...
    IOplockBreakingHandler_Vtbl,
    0x826abe3d_3acd_47d3_84f2_88aaedcf6304
);
...
impl IOplockBreakingHandler {
    pub unsafe fn OplockBreaking(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OplockBreaking)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
impl IOplockBreakingHandler_Vtbl {
    pub const fn new<Identity: IOplockBreakingHandler_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OplockBreaking<
        ...
        Self {
            ...
            OplockBreaking: OplockBreaking::<Identity, OFFSET>,
        }
    }
...
windows_core::imp::define_interface!(
    ...
    IRandomAccessStreamFileAccessMode_Vtbl,
    0x332e5848_2e15_458e_85c4_c911c0c3d6f4
);
        ...
        P5: windows_core::Param<IOplockBreakingHandler>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).Create)(
                ...
                sharingoptions,
                options,
                oplockbreakinghandler.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
...
pub trait IStorageFolderHandleAccess_Impl: windows_core::IUnknownImpl {
    fn Create(
        ...
        sharingoptions: HANDLE_SHARING_OPTIONS,
        options: HANDLE_OPTIONS,
        oplockbreakinghandler: windows_core::Ref<'_, IOplockBreakingHandler>,
    ) -> windows_core::Result<super::super::super::Foundation::HANDLE>;
}
impl IStorageFolderHandleAccess_Vtbl {
    pub const fn new<Identity: IStorageFolderHandleAccess_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            sharingoptions: HANDLE_SHARING_OPTIONS,
            options: HANDLE_OPTIONS,
            oplockbreakinghandler: *mut core::ffi::c_void,
            interophandle: *mut super::super::super::Foundation::HANDLE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IStorageFolderHandleAccess_Impl::Create(
                    this,
                    core::mem::transmute(&filename),
                    core::mem::transmute_copy(&creationoptions),
                    core::mem::transmute_copy(&accessoptions),
                    core::mem::transmute_copy(&sharingoptions),
                    core::mem::transmute_copy(&options),
                    core::mem::transmute_copy(&oplockbreakinghandler),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    IStorageItemHandleAccess_Vtbl,
    0x5ca296b2_2c25_4d22_b785_b885c8201e6a
);
    ...
    pub const fn new<Identity: IStorageItemHandleAccess_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IStorageItemHandleAccess_Impl::Create(
                    this,
                    core::mem::transmute_copy(&accessoptions),
                    core::mem::transmute_copy(&sharingoptions),
                    core::mem::transmute_copy(&options),
...
windows_core::imp::define_interface!(
    ...
    0xd1019a0e_6243_4329_8497_2e75894d7710
);
...
impl IUnbufferedFileHandleOplockCallback {
    pub unsafe fn OnBrokenCallback(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnBrokenCallback)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
impl IUnbufferedFileHandleOplockCallback_Vtbl {
    pub const fn new<Identity: IUnbufferedFileHandleOplockCallback_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn OnBrokenCallback<
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            OnBrokenCallback: OnBrokenCallback::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xa65c9109_42ab_4b94_a7b1_dd2e4e68515e
);
...
impl IUnbufferedFileHandleProvider {
    pub unsafe fn OpenUnbufferedFileHandle<P0>(
        &self,
        oplockbreakcallback: P0,
        ...
        P0: windows_core::Param<IUnbufferedFileHandleOplockCallback>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenUnbufferedFileHandle)(
                windows_core::Interface::as_raw(self),
                oplockbreakcallback.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub unsafe fn CloseUnbufferedFileHandle(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CloseUnbufferedFileHandle)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct IUnbufferedFileHandleProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OpenUnbufferedFileHandle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut usize,
    ) -> windows_core::HRESULT,
    pub CloseUnbufferedFileHandle:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
}
pub trait IUnbufferedFileHandleProvider_Impl: windows_core::IUnknownImpl {
    fn OpenUnbufferedFileHandle(
        &self,
        oplockbreakcallback: windows_core::Ref<'_, IUnbufferedFileHandleOplockCallback>,
    ) -> windows_core::Result<usize>;
...
impl IUnbufferedFileHandleProvider_Vtbl {
    pub const fn new<Identity: IUnbufferedFileHandleProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OpenUnbufferedFileHandle<
            Identity: IUnbufferedFileHandleProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            oplockbreakcallback: *mut core::ffi::c_void,
            filehandle: *mut usize,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUnbufferedFileHandleProvider_Impl::OpenUnbufferedFileHandle(
                    this,
                    core::mem::transmute_copy(&oplockbreakcallback),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CloseUnbufferedFileHandle<
            Identity: IUnbufferedFileHandleProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,

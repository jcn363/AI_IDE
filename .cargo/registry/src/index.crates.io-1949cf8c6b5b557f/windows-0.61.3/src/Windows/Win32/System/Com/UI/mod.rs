windows_core::imp::define_interface!(
    ...
    0x947990de_cc28_11d2_a0f7_00805f858fb1
);
...
impl IDummyHICONIncluder {
    ...
    pub unsafe fn Dummy(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Dummy)(
...
pub struct IDummyHICONIncluder_Vtbl {
    ...
    pub Dummy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::UI::WindowsAndMessaging::HICON,
...
impl IDummyHICONIncluder_Vtbl {
    pub const fn new<Identity: IDummyHICONIncluder_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Dummy<Identity: IDummyHICONIncluder_Impl, const OFFSET: isize>(
            ...
            unsafe {
                ...
                IDummyHICONIncluder_Impl::Dummy(
                    this,
                    core::mem::transmute_copy(&h1),
                    core::mem::transmute_copy(&h2),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x969dc708_5c76_11d1_8d86_0000f804b057
);
...
impl IThumbnailExtractor {
    ...
    pub unsafe fn ExtractThumbnail<P0>(
        &self,
        pstg: P0,
        ullength: u32,
        ulheight: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ExtractThumbnail)(
                windows_core::Interface::as_raw(self),
                pstg.param().abi(),
                ullength,
                ulheight,
                puloutputlength as _,
                puloutputheight as _,
                phoutputbitmap as _,
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnFileUpdated)(
                windows_core::Interface::as_raw(self),
                pstg.param().abi(),
            )
            .ok()
...
pub struct IThumbnailExtractor_Vtbl {
    ...
    pub ExtractThumbnail: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut u32,
        *mut u32,
        *mut super::super::super::Graphics::Gdi::HBITMAP,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(
        feature = "Win32_Graphics_Gdi",
        feature = "Win32_System_Com_StructuredStorage"
    ...
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub OnFileUpdated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IThumbnailExtractor_Impl: windows_core::IUnknownImpl {
    fn ExtractThumbnail(
        &self,
        pstg: windows_core::Ref<'_, super::StructuredStorage::IStorage>,
        ullength: u32,
        ulheight: u32,
        puloutputlength: *mut u32,
        puloutputheight: *mut u32,
...
impl IThumbnailExtractor_Vtbl {
    pub const fn new<Identity: IThumbnailExtractor_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ExtractThumbnail<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IThumbnailExtractor_Impl::ExtractThumbnail(
                    this,
                    core::mem::transmute_copy(&pstg),
                    core::mem::transmute_copy(&ullength),
                    core::mem::transmute_copy(&ulheight),
                    core::mem::transmute_copy(&puloutputlength),
                    core::mem::transmute_copy(&puloutputheight),
                    core::mem::transmute_copy(&phoutputbitmap),
                )
                .into()
            }
        }
        unsafe extern "system" fn OnFileUpdated<
            Identity: IThumbnailExtractor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IThumbnailExtractor_Impl::OnFileUpdated(this, core::mem::transmute_copy(&pstg))
                    .into()
            }
        }
        Self {

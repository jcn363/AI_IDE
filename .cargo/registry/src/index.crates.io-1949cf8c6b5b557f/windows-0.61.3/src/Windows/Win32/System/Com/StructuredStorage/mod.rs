...
pub unsafe fn ClearPropVariantArray(rgpropvar: &mut [PROPVARIANT]) {
    ...
    unsafe {
        ClearPropVariantArray(
            core::mem::transmute(rgpropvar.as_ptr()),
            rgpropvar.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn CoGetInstanceFromFile<P2, P5>(
    pserverinfo: Option<*const super::COSERVERINFO>,
...
#[inline]
pub unsafe fn CoGetInstanceFromIStorage<P2, P4>(
    pserverinfo: Option<*const super::COSERVERINFO>,
    pclsid: Option<*const windows_core::GUID>,
    punkouter: P2,
    dwclsctx: super::CLSCTX,
    ...
    T: windows_core::Interface,
{
    ...
    unsafe {
        CoGetInterfaceAndReleaseStream(pstm.param().abi(), &T::IID, &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
pub unsafe fn CreateILockBytesOnHGlobal(
    hglobal: Option<super::super::super::Foundation::HGLOBAL>,
    fdeleteonrelease: bool,
) -> windows_core::Result<ILockBytes> {
    ...
    unsafe {
        ...
        CreateILockBytesOnHGlobal(
            hglobal.unwrap_or(core::mem::zeroed()) as _,
            fdeleteonrelease.into(),
            &mut result__,
        )
        .and_then(|| windows_core::Type::from_abi(result__))
    }
...
pub unsafe fn CreateStreamOnHGlobal(
    hglobal: super::super::super::Foundation::HGLOBAL,
    fdeleteonrelease: bool,
) -> windows_core::Result<super::IStream> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        CreateStreamOnHGlobal(hglobal, fdeleteonrelease.into(), &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
pub unsafe fn FmtIdToPropStgName(
    pfmtid: *const windows_core::GUID,
    oszname: windows_core::PWSTR,
) -> windows_core::Result<()> {
...
pub unsafe fn FreePropVariantArray(rgvars: &mut [PROPVARIANT]) -> windows_core::Result<()> {
    ...
    unsafe {
        FreePropVariantArray(
            rgvars.len().try_into().unwrap(),
            core::mem::transmute(rgvars.as_ptr()),
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn GetHGlobalFromILockBytes<P0>(
    plkbyt: P0,
) -> windows_core::Result<super::super::super::Foundation::HGLOBAL>
where
...
#[inline]
pub unsafe fn GetHGlobalFromStream<P0>(
    pstm: P0,
) -> windows_core::Result<super::super::super::Foundation::HGLOBAL>
where
    P0: windows_core::Param<super::IStream>,
...
pub unsafe fn InitPropVariantFromFileTime(
    pftin: *const super::super::super::Foundation::FILETIME,
) -> windows_core::Result<PROPVARIANT> {
...
pub unsafe fn InitPropVariantFromFileTimeVector(
    prgft: Option<&[super::super::super::Foundation::FILETIME]>,
) -> windows_core::Result<PROPVARIANT> {
...
pub unsafe fn InitPropVariantFromResource(
    hinst: super::super::super::Foundation::HINSTANCE,
    id: u32,
) -> windows_core::Result<PROPVARIANT> {
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        InitPropVariantFromStringAsVector(psz.param().abi(), &mut result__)
            .map(|| core::mem::transmute(result__))
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn InitPropVariantFromStringVector(
    prgsz: Option<&[windows_core::PCWSTR]>,
) -> windows_core::Result<PROPVARIANT> {
...
pub unsafe fn InitPropVariantVectorFromPropVariant(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        InitPropVariantVectorFromPropVariant(core::mem::transmute(propvarsingle), &mut result__)
            .map(|| core::mem::transmute(result__))
    }
}
#[inline]
...
#[inline]
pub unsafe fn OleConvertIStorageToOLESTREAMEx<P0>(
    pstg: P0,
    cfformat: u16,
    lwidth: i32,
    lheight: i32,
    dwsize: u32,
    pmedium: *const super::STGMEDIUM,
) -> windows_core::Result<OLESTREAM>
where
    P0: windows_core::Param<IStorage>,
{
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn OleConvertOLESTREAMToIStorageEx<P1>(
    polestm: *const OLESTREAM,
    pstg: P1,
    pcfformat: *mut u16,
    plwwidth: *mut i32,
    plheight: *mut i32,
...
pub unsafe fn PropVariantChangeType(
    ppropvardest: *mut PROPVARIANT,
    propvarsrc: *const PROPVARIANT,
    flags: PROPVAR_CHANGE_FLAGS,
    vt: super::super::Variant::VARENUM,
) -> windows_core::Result<()> {
    ...
    unsafe {
        PropVariantChangeType(
            core::mem::transmute(ppropvardest),
            core::mem::transmute(propvarsrc),
            flags,
            vt,
        )
        .ok()
...
pub unsafe fn PropVariantCopy(
    ...
    unsafe {
        PropVariantCopy(
            core::mem::transmute(pvardest),
            core::mem::transmute(pvarsrc),
        )
        .ok()
    }
}
...
pub unsafe fn PropVariantGetBooleanElem(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantGetBooleanElem(core::mem::transmute(propvar), ielem, &mut result__)
            .map(|| result__)
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantGetDoubleElem(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantGetDoubleElem(core::mem::transmute(propvar), ielem, &mut result__)
            .map(|| result__)
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantGetFileTimeElem(
    propvar: *const PROPVARIANT,
    ielem: u32,
) -> windows_core::Result<super::super::super::Foundation::FILETIME> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantGetFileTimeElem(core::mem::transmute(propvar), ielem, &mut result__)
            .map(|| result__)
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantGetInt16Elem(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantGetInt16Elem(core::mem::transmute(propvar), ielem, &mut result__)
            .map(|| result__)
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantGetInt32Elem(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantGetInt32Elem(core::mem::transmute(propvar), ielem, &mut result__)
            .map(|| result__)
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantGetInt64Elem(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantGetInt64Elem(core::mem::transmute(propvar), ielem, &mut result__)
            .map(|| result__)
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantGetStringElem(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantGetStringElem(core::mem::transmute(propvar), ielem, &mut result__)
            .map(|| result__)
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantGetUInt16Elem(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantGetUInt16Elem(core::mem::transmute(propvar), ielem, &mut result__)
            .map(|| result__)
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantGetUInt32Elem(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantGetUInt32Elem(core::mem::transmute(propvar), ielem, &mut result__)
            .map(|| result__)
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantGetUInt64Elem(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantGetUInt64Elem(core::mem::transmute(propvar), ielem, &mut result__)
            .map(|| result__)
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantToBSTR(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantToBSTR(core::mem::transmute(propvar), &mut result__)
            .map(|| core::mem::transmute(result__))
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantToBooleanVector(
    ...
    unsafe {
        PropVariantToBooleanVector(
            ...
            core::mem::transmute(prgf.as_ptr()),
            prgf.len().try_into().unwrap(),
            pcelem as _,
        )
        .ok()
    }
...
pub unsafe fn PropVariantToBooleanVectorAlloc(
    propvar: *const PROPVARIANT,
    pprgf: *mut *mut windows_core::BOOL,
    pcelem: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        PropVariantToBooleanVectorAlloc(core::mem::transmute(propvar), pprgf as _, pcelem as _).ok()
    }
}
#[cfg(feature = "Win32_System_Variant")]
#[inline]
...
pub unsafe fn PropVariantToDoubleVector(
    ...
    unsafe {
        PropVariantToDoubleVector(
            core::mem::transmute(propvar),
            core::mem::transmute(prgn.as_ptr()),
            prgn.len().try_into().unwrap(),
            pcelem as _,
        )
        .ok()
    }
...
pub unsafe fn PropVariantToDoubleVectorAlloc(
    ...
    unsafe {
        PropVariantToDoubleVectorAlloc(core::mem::transmute(propvar), pprgn as _, pcelem as _).ok()
    }
}
#[cfg(feature = "Win32_System_Variant")]
#[inline]
...
pub unsafe fn PropVariantToFileTime(
    propvar: *const PROPVARIANT,
    pstfout: super::super::Variant::PSTIME_FLAGS,
) -> windows_core::Result<super::super::super::Foundation::FILETIME> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantToFileTime(core::mem::transmute(propvar), pstfout, &mut result__)
            .map(|| result__)
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantToFileTimeVector(
    propvar: *const PROPVARIANT,
    prgft: &mut [super::super::super::Foundation::FILETIME],
    pcelem: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        PropVariantToFileTimeVector(
            core::mem::transmute(propvar),
            core::mem::transmute(prgft.as_ptr()),
            prgft.len().try_into().unwrap(),
            pcelem as _,
        )
        .ok()
    }
...
pub unsafe fn PropVariantToFileTimeVectorAlloc(
    propvar: *const PROPVARIANT,
    pprgft: *mut *mut super::super::super::Foundation::FILETIME,
    pcelem: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        PropVariantToFileTimeVectorAlloc(core::mem::transmute(propvar), pprgft as _, pcelem as _)
            .ok()
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn PropVariantToInt16VectorAlloc(
    ...
    unsafe {
        PropVariantToInt16VectorAlloc(core::mem::transmute(propvar), pprgn as _, pcelem as _).ok()
    }
}
#[cfg(feature = "Win32_System_Variant")]
#[inline]
...
pub unsafe fn PropVariantToInt32VectorAlloc(
    ...
    unsafe {
        PropVariantToInt32VectorAlloc(core::mem::transmute(propvar), pprgn as _, pcelem as _).ok()
    }
}
#[cfg(feature = "Win32_System_Variant")]
#[inline]
...
pub unsafe fn PropVariantToInt64VectorAlloc(
    ...
    unsafe {
        PropVariantToInt64VectorAlloc(core::mem::transmute(propvar), pprgn as _, pcelem as _).ok()
    }
}
#[cfg(feature = "Win32_System_Variant")]
#[inline]
...
pub unsafe fn PropVariantToStringVector(
    ...
    unsafe {
        PropVariantToStringVector(
            core::mem::transmute(propvar),
            core::mem::transmute(prgsz.as_ptr()),
            prgsz.len().try_into().unwrap(),
            pcelem as _,
        )
        .ok()
    }
...
pub unsafe fn PropVariantToStringVectorAlloc(
    propvar: *const PROPVARIANT,
    pprgsz: *mut *mut windows_core::PWSTR,
    pcelem: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        PropVariantToStringVectorAlloc(core::mem::transmute(propvar), pprgsz as _, pcelem as _).ok()
    }
}
#[cfg(feature = "Win32_System_Variant")]
#[inline]
...
pub unsafe fn PropVariantToUInt16VectorAlloc(
    ...
    unsafe {
        PropVariantToUInt16VectorAlloc(core::mem::transmute(propvar), pprgn as _, pcelem as _).ok()
    }
}
#[cfg(feature = "Win32_System_Variant")]
#[inline]
...
pub unsafe fn PropVariantToUInt32VectorAlloc(
    ...
    unsafe {
        PropVariantToUInt32VectorAlloc(core::mem::transmute(propvar), pprgn as _, pcelem as _).ok()
    }
}
#[cfg(feature = "Win32_System_Variant")]
#[inline]
...
pub unsafe fn PropVariantToUInt64VectorAlloc(
    ...
    unsafe {
        PropVariantToUInt64VectorAlloc(core::mem::transmute(propvar), pprgn as _, pcelem as _).ok()
    }
}
#[cfg(feature = "Win32_System_Variant")]
#[inline]
...
pub unsafe fn PropVariantToVariant(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PropVariantToVariant(core::mem::transmute(ppropvar), &mut result__)
            .map(|| core::mem::transmute(result__))
    }
}
#[cfg(feature = "Win32_System_Variant")]
    ...
    T: windows_core::Interface,
{
    ...
    let mut result__ = core::ptr::null_mut();
    unsafe {
        PropVariantToWinRTPropertyValue(core::mem::transmute(propvar), &T::IID, &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
...
pub unsafe fn ReadFmtUserTypeStg<P0>(
    pstg: P0,
    pcf: *mut u16,
    lplpszusertype: Option<*mut windows_core::PWSTR>,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<IStorage>,
{
    ...
    unsafe {
        ReadFmtUserTypeStg(
            pstg.param().abi(),
            pcf as _,
            lplpszusertype.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[cfg(feature = "Win32_System_Variant")]
#[inline]
pub unsafe fn StgConvertPropertyToVariant<P3>(
...
pub unsafe fn StgConvertVariantToProperty(
    ...
    codepage: u16,
    pprop: Option<*mut SERIALIZEDPROPERTYVALUE>,
    pcb: *mut u32,
    pid: u32,
    freserved: Option<bool>,
    pcindirect: Option<*mut u32>,
    ...
    unsafe {
        StgConvertVariantToProperty(
            core::mem::transmute(pvar),
            codepage,
            pprop.unwrap_or(core::mem::zeroed()) as _,
            pcb as _,
            pid,
            freserved.unwrap_or(core::mem::zeroed()) as _,
            pcindirect.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
    ...
    P0: windows_core::Param<ILockBytes>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        StgCreateDocfileOnILockBytes(plkbyt.param().abi(), grfmode, reserved, &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
...
) -> windows_core::Result<IPropertySetStorage>
where
    P0: windows_core::Param<IStorage>,
{
...
pub unsafe fn StgCreatePropStg<P0>(
    ...
    grfflags: u32,
    dwreserved: Option<u32>,
) -> windows_core::Result<IPropertyStorage>
where
...
#[inline]
pub unsafe fn StgCreateStorageEx<P0>(
    pwcsname: P0,
    grfmode: super::STGM,
    stgfmt: STGFMT,
    grfattrs: u32,
    pstgoptions: Option<*mut STGOPTIONS>,
    psecuritydescriptor: Option<super::super::super::Security::PSECURITY_DESCRIPTOR>,
    riid: *const windows_core::GUID,
    ppobjectopen: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        StgCreateStorageEx(
            ...
            stgfmt,
            grfattrs,
            pstgoptions.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn StgDeserializePropVariant(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        StgDeserializePropVariant(pprop, cbmax, &mut result__)
            .map(|| core::mem::transmute(result__))
    }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        StgGetIFillLockBytesOnFile(pwcsname.param().abi(), &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
    ...
    P0: windows_core::Param<ILockBytes>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        StgGetIFillLockBytesOnILockBytes(pilb.param().abi(), &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
...
#[inline]
pub unsafe fn StgOpenAsyncDocfileOnIFillLockBytes<P0>(
    pflb: P0,
    grfmode: u32,
    asyncflags: u32,
) -> windows_core::Result<IStorage>
    ...
    P0: windows_core::Param<IFillLockBytes>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        StgOpenAsyncDocfileOnIFillLockBytes(pflb.param().abi(), grfmode, asyncflags, &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        StgOpenLayoutDocfile(pwcsdfname.param().abi(), grfmode, reserved, &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
...
pub unsafe fn StgPropertyLengthAsVariant(
    ...
    unsafe {
        StgPropertyLengthAsVariant(
            ...
            cbprop,
            codepage,
            breserved.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_System_Variant")]
...
pub unsafe fn StgSetTimes<P0>(
    lpszname: P0,
    pctime: Option<*const super::super::super::Foundation::FILETIME>,
    patime: Option<*const super::super::super::Foundation::FILETIME>,
    pmtime: Option<*const super::super::super::Foundation::FILETIME>,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        StgSetTimes(
            lpszname.param().abi(),
            pctime.unwrap_or(core::mem::zeroed()) as _,
            patime.unwrap_or(core::mem::zeroed()) as _,
            pmtime.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn VariantToPropVariant(
    pvar: *const super::super::Variant::VARIANT,
) -> windows_core::Result<PROPVARIANT> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        VariantToPropVariant(core::mem::transmute(pvar), &mut result__)
            .map(|| core::mem::transmute(result__))
    }
}
#[cfg(feature = "Win32_System_Variant")]
    ...
    P0: windows_core::Param<windows_core::IUnknown>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        WinRTPropertyValueToPropVariant(punkpropertyvalue.param().abi(), &mut result__)
            .map(|| core::mem::transmute(result__))
    }
}
#[inline]
pub unsafe fn WriteClassStg<P0>(
    pstg: P0,
...
#[inline]
pub unsafe fn WriteClassStm<P0>(
    pstm: P0,
    rclsid: *const windows_core::GUID,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn WriteFmtUserTypeStg<P0, P2>(
    pstg: P0,
    cf: u16,
    lpszusertype: P2,
) -> windows_core::Result<()>
...
windows_core::imp::define_interface!(
    ...
    0x0e6d4d92_6738_11cf_9608_00aa00680db4
);
...
impl IDirectWriterLock {
    pub unsafe fn WaitForWriteAccess(&self, dwtimeout: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).WaitForWriteAccess)(
    ...
    pub unsafe fn ReleaseWriteAccess(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ReleaseWriteAccess)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn HaveWriteAccess(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).HaveWriteAccess)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
impl IDirectWriterLock_Vtbl {
    pub const fn new<Identity: IDirectWriterLock_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn WaitForWriteAccess<
        ...
        >(
            ...
            unsafe {
                ...
                IDirectWriterLock_Impl::WaitForWriteAccess(
                    this,
        ...
        unsafe extern "system" fn ReleaseWriteAccess<
            Identity: IDirectWriterLock_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn HaveWriteAccess<
            Identity: IDirectWriterLock_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x0000013b_0000_0000_c000_000000000046
);
...
impl IEnumSTATPROPSETSTG_Vtbl {
    pub const fn new<Identity: IEnumSTATPROPSETSTG_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Next<Identity: IEnumSTATPROPSETSTG_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            rgelt: *mut STATPROPSETSTG,
            pceltfetched: *mut u32,
        ...
        unsafe extern "system" fn Skip<Identity: IEnumSTATPROPSETSTG_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Reset<Identity: IEnumSTATPROPSETSTG_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Clone<Identity: IEnumSTATPROPSETSTG_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x00000139_0000_0000_c000_000000000046
);
...
impl IEnumSTATPROPSTG_Vtbl {
    pub const fn new<Identity: IEnumSTATPROPSTG_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Next<Identity: IEnumSTATPROPSTG_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            rgelt: *mut STATPROPSTG,
            pceltfetched: *mut u32,
        ...
        unsafe extern "system" fn Skip<Identity: IEnumSTATPROPSTG_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Reset<Identity: IEnumSTATPROPSTG_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Clone<Identity: IEnumSTATPROPSTG_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenum: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    IEnumSTATSTG,
    IEnumSTATSTG_Vtbl,
    0x0000000d_0000_0000_c000_000000000046
);
...
impl IEnumSTATSTG_Vtbl {
    pub const fn new<Identity: IEnumSTATSTG_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Next<Identity: IEnumSTATSTG_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            rgelt: *mut super::STATSTG,
            pceltfetched: *mut u32,
        ...
        unsafe extern "system" fn Skip<Identity: IEnumSTATSTG_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Reset<Identity: IEnumSTATSTG_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Clone<Identity: IEnumSTATSTG_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenum: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    IFillLockBytes,
    IFillLockBytes_Vtbl,
    0x99caf010_415e_11cf_8814_00aa00b569f5
);
...
impl IFillLockBytes {
    pub unsafe fn FillAppend(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FillAppend)(
                windows_core::Interface::as_raw(self),
                pv,
                cb,
                &mut result__,
    ...
    pub unsafe fn FillAt(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FillAt)(
                windows_core::Interface::as_raw(self),
                uloffset,
                pv,
                cb,
    ...
    pub unsafe fn SetFillSize(&self, ulsize: u64) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFillSize)(
                windows_core::Interface::as_raw(self),
                ulsize,
            )
            .ok()
...
pub struct IFillLockBytes_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub FillAppend: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub FillAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        *const core::ffi::c_void,
        u32,
...
impl IFillLockBytes_Vtbl {
    pub const fn new<Identity: IFillLockBytes_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn FillAppend<Identity: IFillLockBytes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pv: *const core::ffi::c_void,
            cb: u32,
            pcbwritten: *mut u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IFillLockBytes_Impl::FillAppend(
                    this,
        ...
        unsafe extern "system" fn FillAt<Identity: IFillLockBytes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uloffset: u64,
            pv: *const core::ffi::c_void,
            cb: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IFillLockBytes_Impl::FillAt(
                    this,
        ...
        unsafe extern "system" fn SetFillSize<
        ...
        unsafe extern "system" fn Terminate<Identity: IFillLockBytes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bcanceled: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ILayoutStorage,
    ILayoutStorage_Vtbl,
    0x0e6d4d90_6738_11cf_9608_00aa00680db4
);
windows_core::imp::interface_hierarchy!(ILayoutStorage, windows_core::IUnknown);
impl ILayoutStorage {
    pub unsafe fn LayoutScript(
        &self,
        pstoragelayout: &[super::StorageLayout],
        glfinterleavedflag: Option<u32>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).LayoutScript)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pstoragelayout.as_ptr()),
                pstoragelayout.len().try_into().unwrap(),
                glfinterleavedflag.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn BeginMonitor(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BeginMonitor)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn EndMonitor(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndMonitor)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ReLayoutDocfile)(
                windows_core::Interface::as_raw(self),
                pwcsnewdfname.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn ReLayoutDocfileOnILockBytes<P0>(
        &self,
        pilockbytes: P0,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ReLayoutDocfileOnILockBytes)(
                windows_core::Interface::as_raw(self),
                pilockbytes.param().abi(),
            )
            .ok()
        }
    }
...
pub struct ILayoutStorage_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub LayoutScript: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::StorageLayout,
        u32,
        u32,
    ) -> windows_core::HRESULT,
    ...
    pub ReLayoutDocfile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub ReLayoutDocfileOnILockBytes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
    ...
    pub const fn new<Identity: ILayoutStorage_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILayoutStorage_Impl::LayoutScript(
                    this,
                    core::mem::transmute_copy(&pstoragelayout),
                    core::mem::transmute_copy(&nentries),
                    core::mem::transmute_copy(&glfinterleavedflag),
                )
                .into()
            }
        }
        unsafe extern "system" fn BeginMonitor<
            Identity: ILayoutStorage_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EndMonitor<Identity: ILayoutStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn ReLayoutDocfile<
            Identity: ILayoutStorage_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pwcsnewdfname: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILayoutStorage_Impl::ReLayoutDocfile(this, core::mem::transmute(&pwcsnewdfname))
                    .into()
            }
        }
        unsafe extern "system" fn ReLayoutDocfileOnILockBytes<
            Identity: ILayoutStorage_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pilockbytes: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILayoutStorage_Impl::ReLayoutDocfileOnILockBytes(
                    this,
                    core::mem::transmute_copy(&pilockbytes),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ILockBytes,
    ILockBytes_Vtbl,
    0x0000000a_0000_0000_c000_000000000046
);
...
impl ILockBytes {
    pub unsafe fn ReadAt(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ReadAt)(
                windows_core::Interface::as_raw(self),
                uloffset,
                pv as _,
                cb,
    ...
    pub unsafe fn WriteAt(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).WriteAt)(
                windows_core::Interface::as_raw(self),
                uloffset,
                pv,
                cb,
...
pub struct ILockBytes_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ReadAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        *mut core::ffi::c_void,
        u32,
    ...
    pub WriteAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        *const core::ffi::c_void,
        u32,
...
impl ILockBytes_Vtbl {
    pub const fn new<Identity: ILockBytes_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ReadAt<Identity: ILockBytes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uloffset: u64,
            pv: *mut core::ffi::c_void,
            cb: u32,
        ...
        unsafe extern "system" fn WriteAt<Identity: ILockBytes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uloffset: u64,
            pv: *const core::ffi::c_void,
            cb: u32,
        ...
        unsafe extern "system" fn Flush<Identity: ILockBytes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn SetSize<Identity: ILockBytes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            cb: u64,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn LockRegion<Identity: ILockBytes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            liboffset: u64,
            cb: u64,
            dwlocktype: u32,
        ...
        unsafe extern "system" fn UnlockRegion<Identity: ILockBytes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            liboffset: u64,
            cb: u64,
            dwlocktype: u32,
        ...
        unsafe extern "system" fn Stat<Identity: ILockBytes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pstatstg: *mut super::STATSTG,
            grfstatflag: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILockBytes_Impl::Stat(
                    this,
                    core::mem::transmute_copy(&pstatstg),
                    core::mem::transmute_copy(&grfstatflag),
                )
                .into()
            }
        }
...
impl IMemoryAllocator {
    pub unsafe fn Allocate(&self, cbsize: u32) -> *mut core::ffi::c_void {
        unsafe {
            (windows_core::Interface::vtable(self).Allocate)(
                windows_core::Interface::as_raw(self),
                cbsize,
            )
        }
...
impl IMemoryAllocator_Vtbl {
    pub const fn new<Identity: IMemoryAllocator_Impl>() -> Self {
        unsafe extern "system" fn Allocate<Identity: IMemoryAllocator_Impl>(
            this: *mut core::ffi::c_void,
            cbsize: u32,
        ) -> *mut core::ffi::c_void {
            unsafe {
        ...
        unsafe extern "system" fn Free<Identity: IMemoryAllocator_Impl>(
            this: *mut core::ffi::c_void,
            pv: *mut core::ffi::c_void,
        ) {
            unsafe {
...
impl IMemoryAllocator {
    pub fn new<'a, T: IMemoryAllocator_Impl>(
        this: &'a T,
    ) -> windows_core::ScopedInterface<'a, Self> {
        let this = windows_core::ScopedHeap {
            vtable: &IMemoryAllocator_ImplVtbl::<T>::VTABLE as *const _ as *const _,
...
windows_core::imp::define_interface!(
    ...
    0x0000010a_0000_0000_c000_000000000046
);
...
pub trait IPersistStorage_Impl: super::IPersist_Impl {
    ...
    fn Save(
        &self,
        pstgsave: windows_core::Ref<'_, IStorage>,
        fsameasload: windows_core::BOOL,
    ) -> windows_core::Result<()>;
...
impl IPersistStorage_Vtbl {
    pub const fn new<Identity: IPersistStorage_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsDirty<Identity: IPersistStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn InitNew<Identity: IPersistStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pstg: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Load<Identity: IPersistStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pstg: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Save<Identity: IPersistStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pstgsave: *mut core::ffi::c_void,
            fsameasload: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPersistStorage_Impl::Save(
                    this,
                    core::mem::transmute_copy(&pstgsave),
        ...
        >(
            this: *mut core::ffi::c_void,
            pstgnew: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPersistStorage_Impl::SaveCompleted(this, core::mem::transmute_copy(&pstgnew))
                    .into()
            }
        }
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IPersistStorage as windows_core::Interface>::IID
            || iid == &<super::IPersist as windows_core::Interface>::IID
    }
}
...
impl IPropertyBag {
    ...
    pub unsafe fn Read<P0, P2>(
        &self,
        pszpropname: P0,
        pvar: *mut super::super::Variant::VARIANT,
        perrorlog: P2,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IPropertyBag_Impl: windows_core::IUnknownImpl {
    fn Read(
        ...
        pvar: *mut super::super::Variant::VARIANT,
        perrorlog: windows_core::Ref<'_, super::IErrorLog>,
    ) -> windows_core::Result<()>;
    fn Write(
        &self,
        pszpropname: &windows_core::PCWSTR,
...
impl IPropertyBag_Vtbl {
    pub const fn new<Identity: IPropertyBag_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Read<Identity: IPropertyBag_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszpropname: windows_core::PCWSTR,
            pvar: *mut super::super::Variant::VARIANT,
            perrorlog: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPropertyBag_Impl::Read(
                    this,
                    core::mem::transmute(&pszpropname),
                    core::mem::transmute_copy(&pvar),
                    core::mem::transmute_copy(&perrorlog),
                )
                .into()
            }
        }
        unsafe extern "system" fn Write<Identity: IPropertyBag_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszpropname: windows_core::PCWSTR,
            pvar: *const super::super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
...
windows_core::imp::define_interface!(
    IPropertyBag2,
    IPropertyBag2_Vtbl,
    0x22f55882_280b_11d0_a8a9_00a0c90c2004
);
windows_core::imp::interface_hierarchy!(IPropertyBag2, windows_core::IUnknown);
impl IPropertyBag2 {
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn Read<P2>(
        &self,
        cproperties: u32,
        ppropbag: *const PROPBAG2,
        perrlog: P2,
        pvarvalue: *mut super::super::Variant::VARIANT,
    ...
    pub unsafe fn Write(
        ...
        cproperties: u32,
        ppropbag: *const PROPBAG2,
        pvarvalue: *const super::super::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Write)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn CountProperties(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CountProperties)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetPropertyInfo(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetPropertyInfo)(
                windows_core::Interface::as_raw(self),
                iproperty,
                ppropbag.len().try_into().unwrap(),
                core::mem::transmute(ppropbag.as_ptr()),
                pcproperties as _,
            )
            .ok()
        }
    }
    pub unsafe fn LoadObject<P0, P2, P3>(
        &self,
        pstrname: P0,
        dwhint: u32,
        punkobject: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).LoadObject)(
                windows_core::Interface::as_raw(self),
                pstrname.param().abi(),
                dwhint,
...
pub struct IPropertyBag2_Vtbl {
    ...
    pub LoadObject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        *mut core::ffi::c_void,
...
pub trait IPropertyBag2_Impl: windows_core::IUnknownImpl {
    fn Read(
        ...
        cproperties: u32,
        ppropbag: *const PROPBAG2,
        perrlog: windows_core::Ref<'_, super::IErrorLog>,
        pvarvalue: *mut super::super::Variant::VARIANT,
        phrerror: *mut windows_core::HRESULT,
    ) -> windows_core::Result<()>;
    fn Write(
...
impl IPropertyBag2_Vtbl {
    pub const fn new<Identity: IPropertyBag2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Read<Identity: IPropertyBag2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            cproperties: u32,
            ppropbag: *const PROPBAG2,
            perrlog: *mut core::ffi::c_void,
            pvarvalue: *mut super::super::Variant::VARIANT,
            phrerror: *mut windows_core::HRESULT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPropertyBag2_Impl::Read(
                    this,
                    core::mem::transmute_copy(&cproperties),
                    core::mem::transmute_copy(&ppropbag),
                    core::mem::transmute_copy(&perrlog),
        ...
        unsafe extern "system" fn Write<Identity: IPropertyBag2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            cproperties: u32,
            ppropbag: *const PROPBAG2,
            pvarvalue: *const super::super::Variant::VARIANT,
        ...
        unsafe extern "system" fn CountProperties<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPropertyBag2_Impl::GetPropertyInfo(
                    this,
                    core::mem::transmute_copy(&iproperty),
                    core::mem::transmute_copy(&cproperties),
                    core::mem::transmute_copy(&ppropbag),
        ...
        unsafe extern "system" fn LoadObject<Identity: IPropertyBag2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pstrname: windows_core::PCWSTR,
            dwhint: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPropertyBag2_Impl::LoadObject(
                    this,
                    core::mem::transmute(&pstrname),
                    core::mem::transmute_copy(&dwhint),
...
impl IPropertySetStorage_Vtbl {
    pub const fn new<Identity: IPropertySetStorage_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            grfflags: u32,
            grfmode: u32,
            ppprstg: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IPropertySetStorage_Impl::Create(
                    this,
                    core::mem::transmute_copy(&rfmtid),
        ...
        unsafe extern "system" fn Open<Identity: IPropertySetStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            rfmtid: *const windows_core::GUID,
            grfmode: u32,
            ppprstg: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IPropertySetStorage_Impl::Open(
                    this,
                    core::mem::transmute_copy(&rfmtid),
                    core::mem::transmute_copy(&grfmode),
                ) {
        ...
        unsafe extern "system" fn Enum<Identity: IPropertySetStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenum: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    ...
    0x00000138_0000_0000_c000_000000000046
);
...
pub struct IPropertyStorage_Vtbl {
    ...
    pub SetTimes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::super::super::Foundation::FILETIME,
        *const super::super::super::Foundation::FILETIME,
        *const super::super::super::Foundation::FILETIME,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IPropertyStorage_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPropertyStorage_Impl::ReadMultiple(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPropertyStorage_Impl::WriteMultiple(
                    this,
                    core::mem::transmute_copy(&cpspec),
                    core::mem::transmute_copy(&rgpspec),
                    core::mem::transmute_copy(&rgpropvar),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPropertyStorage_Impl::DeleteMultiple(
                    this,
                    core::mem::transmute_copy(&cpspec),
                    core::mem::transmute_copy(&rgpspec),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPropertyStorage_Impl::ReadPropertyNames(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPropertyStorage_Impl::WritePropertyNames(
                    this,
                    core::mem::transmute_copy(&cpropid),
                    core::mem::transmute_copy(&rgpropid),
                    core::mem::transmute_copy(&rglpwstrname),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPropertyStorage_Impl::DeletePropertyNames(
                    this,
                    core::mem::transmute_copy(&cpropid),
                    core::mem::transmute_copy(&rgpropid),
                )
        ...
        unsafe extern "system" fn Commit<Identity: IPropertyStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            grfcommitflags: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPropertyStorage_Impl::Commit(this, core::mem::transmute_copy(&grfcommitflags))
                    .into()
            }
        }
        unsafe extern "system" fn Revert<Identity: IPropertyStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Enum<Identity: IPropertyStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenum: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetTimes<Identity: IPropertyStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pctime: *const super::super::super::Foundation::FILETIME,
            patime: *const super::super::super::Foundation::FILETIME,
            pmtime: *const super::super::super::Foundation::FILETIME,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPropertyStorage_Impl::SetTimes(
                    this,
        ...
        unsafe extern "system" fn SetClass<Identity: IPropertyStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            clsid: *const windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Stat<Identity: IPropertyStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IRootStorage,
    IRootStorage_Vtbl,
    0x00000012_0000_0000_c000_000000000046
);
...
impl IRootStorage {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SwitchToFile)(
                windows_core::Interface::as_raw(self),
                pszfile.param().abi(),
            )
            .ok()
...
pub struct IRootStorage_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SwitchToFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
}
...
impl IRootStorage_Vtbl {
    pub const fn new<Identity: IRootStorage_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SwitchToFile<Identity: IRootStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            SwitchToFile: SwitchToFile::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IStorage {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).MoveElementTo)(
                windows_core::Interface::as_raw(self),
                pwcsname.param().abi(),
                pstgdest.param().abi(),
    ...
    ) -> windows_core::Result<IEnumSTATSTG> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumElements)(
                windows_core::Interface::as_raw(self),
                reserved1.unwrap_or(core::mem::zeroed()) as _,
                reserved2.unwrap_or(core::mem::zeroed()) as _,
                reserved3.unwrap_or(core::mem::zeroed()) as _,
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IStorage_Impl: windows_core::IUnknownImpl {
    ...
    fn EnumElements(
        &self,
        reserved1: u32,
        reserved2: *const core::ffi::c_void,
        reserved3: u32,
    ) -> windows_core::Result<IEnumSTATSTG>;
...
impl IStorage_Vtbl {
    pub const fn new<Identity: IStorage_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn MoveElementTo<Identity: IStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwcsname: windows_core::PCWSTR,
            pstgdest: *mut core::ffi::c_void,
            pwcsnewname: windows_core::PCWSTR,
        ...
        unsafe extern "system" fn EnumElements<Identity: IStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            reserved1: u32,
            reserved2: *const core::ffi::c_void,
            reserved3: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IStorage_Impl::EnumElements(
                    this,
                    core::mem::transmute_copy(&reserved1),
                    core::mem::transmute_copy(&reserved2),
                    core::mem::transmute_copy(&reserved3),
                ) {
                    Ok(ok__) => {
                        ppenum.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn Stat<Identity: IStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pstatstg: *mut super::STATSTG,
            grfstatflag: u32,
        ) -> windows_core::HRESULT {

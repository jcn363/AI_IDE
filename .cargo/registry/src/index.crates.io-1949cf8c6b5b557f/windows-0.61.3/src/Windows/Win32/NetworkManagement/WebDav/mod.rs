#[inline]
pub unsafe fn DavAddConnection<P1, P2, P3>(
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DavAddConnection(
            connectionhandle as _,
            remotename.param().abi(),
            username.param().abi(),
            password.param().abi(),
            core::mem::transmute(clientcert.as_ptr()),
            clientcert.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
pub unsafe fn DavGetExtendedError(
    ...
    exterror: *mut u32,
    exterrorstring: windows_core::PWSTR,
    cchsize: *mut u32,
) -> u32 {
    ...
    unsafe {
        DavGetExtendedError(
            hfile,
            exterror as _,
            core::mem::transmute(exterrorstring),
            cchsize as _,
        )
    }
}
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DavGetHTTPFromUNCPath(
            uncpath.param().abi(),
            url.unwrap_or(core::mem::zeroed()) as _,
            lpsize as _,
        )
    }
}
...
pub unsafe fn DavGetTheLockOwnerOfTheFile<P0>(
    filename: P0,
    lockownername: Option<windows_core::PWSTR>,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DavGetTheLockOwnerOfTheFile(
            filename.param().abi(),
            lockownername.unwrap_or(core::mem::zeroed()) as _,
            lockownernamelengthinbytes as _,
        )
    }
}
#[inline]
pub unsafe fn DavGetUNCFromHTTPPath<P0>(
    url: P0,
    uncpath: Option<windows_core::PWSTR>,
    lpsize: *mut u32,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DavGetUNCFromHTTPPath(
            url.param().abi(),
            uncpath.unwrap_or(core::mem::zeroed()) as _,
            lpsize as _,
        )
    }
}
...
pub type PFNDAVAUTHCALLBACK = Option<
    unsafe extern "system" fn(
        lpwzservername: windows_core::PCWSTR,
        lpwzremotename: windows_core::PCWSTR,
        dwauthscheme: u32,
        dwflags: u32,
...
pub type PFNDAVAUTHCALLBACK_FREECRED =
    Option<unsafe extern "system" fn(pbuffer: *const core::ffi::c_void) -> u32>;

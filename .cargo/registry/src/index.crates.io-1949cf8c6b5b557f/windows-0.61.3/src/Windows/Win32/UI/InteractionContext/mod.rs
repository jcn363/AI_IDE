...
pub unsafe fn AddPointerInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn AddPointerInteractionContext(interactioncontext : HINTERACTIONCONTEXT, pointerid : u32) -> windows_core::HRESULT);
...
pub unsafe fn BufferPointerPacketsInteractionContext(
    interactioncontext: HINTERACTIONCONTEXT,
    pointerinfo: &[super::Input::Pointer::POINTER_INFO],
) -> windows_core::Result<()> {
    windows_link::link!("ninput.dll" "system" fn BufferPointerPacketsInteractionContext(interactioncontext : HINTERACTIONCONTEXT, entriescount : u32, pointerinfo : *const super::Input::Pointer:: POINTER_INFO) -> windows_core::HRESULT);
    unsafe {
        BufferPointerPacketsInteractionContext(
            interactioncontext,
            pointerinfo.len().try_into().unwrap(),
            core::mem::transmute(pointerinfo.as_ptr()),
        )
        .ok()
    }
}
...
pub unsafe fn DestroyInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn DestroyInteractionContext(interactioncontext : HINTERACTIONCONTEXT) -> windows_core::HRESULT);
...
pub unsafe fn GetCrossSlideParameterInteractionContext(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        GetCrossSlideParameterInteractionContext(interactioncontext, threshold, &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn GetHoldParameterInteractionContext(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        GetHoldParameterInteractionContext(interactioncontext, parameter, &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn GetInertiaParameterInteractionContext(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        GetInertiaParameterInteractionContext(interactioncontext, inertiaparameter, &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn GetInteractionConfigurationInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn GetInteractionConfigurationInteractionContext(interactioncontext : HINTERACTIONCONTEXT, configurationcount : u32, configuration : *mut INTERACTION_CONTEXT_CONFIGURATION) -> windows_core::HRESULT);
    unsafe {
        GetInteractionConfigurationInteractionContext(
            interactioncontext,
            configuration.len().try_into().unwrap(),
            core::mem::transmute(configuration.as_ptr()),
        )
        .ok()
    }
}
...
pub unsafe fn GetMouseWheelParameterInteractionContext(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        GetMouseWheelParameterInteractionContext(interactioncontext, parameter, &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn GetPropertyInteractionContext(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        GetPropertyInteractionContext(interactioncontext, contextproperty, &mut result__)
            .map(|| result__)
    }
}
#[cfg(all(
...
pub unsafe fn GetStateInteractionContext(
    interactioncontext: HINTERACTIONCONTEXT,
    pointerinfo: Option<*const super::Input::Pointer::POINTER_INFO>,
) -> windows_core::Result<INTERACTION_STATE> {
    ...
    unsafe {
        ...
        GetStateInteractionContext(
            interactioncontext,
            pointerinfo.unwrap_or(core::mem::zeroed()) as _,
            &mut result__,
        )
        .map(|| result__)
    }
...
pub unsafe fn GetTapParameterInteractionContext(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        GetTapParameterInteractionContext(interactioncontext, parameter, &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn GetTranslationParameterInteractionContext(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        GetTranslationParameterInteractionContext(interactioncontext, parameter, &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn ProcessBufferedPacketsInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn ProcessBufferedPacketsInteractionContext(interactioncontext : HINTERACTIONCONTEXT) -> windows_core::HRESULT);
...
pub unsafe fn ProcessInertiaInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn ProcessInertiaInteractionContext(interactioncontext : HINTERACTIONCONTEXT) -> windows_core::HRESULT);
...
pub unsafe fn ProcessPointerFramesInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn ProcessPointerFramesInteractionContext(interactioncontext : HINTERACTIONCONTEXT, entriescount : u32, pointercount : u32, pointerinfo : *const super::Input::Pointer:: POINTER_INFO) -> windows_core::HRESULT);
    unsafe {
...
pub unsafe fn RegisterOutputCallbackInteractionContext(
    ...
    clientdata: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    windows_link::link!("ninput.dll" "system" fn RegisterOutputCallbackInteractionContext(interactioncontext : HINTERACTIONCONTEXT, outputcallback : INTERACTION_CONTEXT_OUTPUT_CALLBACK, clientdata : *const core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        RegisterOutputCallbackInteractionContext(
            interactioncontext,
            outputcallback,
            clientdata.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn RegisterOutputCallbackInteractionContext2(
    ...
    windows_link::link!("ninput.dll" "system" fn RegisterOutputCallbackInteractionContext2(interactioncontext : HINTERACTIONCONTEXT, outputcallback : INTERACTION_CONTEXT_OUTPUT_CALLBACK2, clientdata : *const core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
...
pub unsafe fn RemovePointerInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn RemovePointerInteractionContext(interactioncontext : HINTERACTIONCONTEXT, pointerid : u32) -> windows_core::HRESULT);
...
pub unsafe fn ResetInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn ResetInteractionContext(interactioncontext : HINTERACTIONCONTEXT) -> windows_core::HRESULT);
...
pub unsafe fn SetCrossSlideParametersInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn SetCrossSlideParametersInteractionContext(interactioncontext : HINTERACTIONCONTEXT, parametercount : u32, crossslideparameters : *const CROSS_SLIDE_PARAMETER) -> windows_core::HRESULT);
    unsafe {
        SetCrossSlideParametersInteractionContext(
            interactioncontext,
            crossslideparameters.len().try_into().unwrap(),
            core::mem::transmute(crossslideparameters.as_ptr()),
        )
        .ok()
    }
}
...
pub unsafe fn SetHoldParameterInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn SetHoldParameterInteractionContext(interactioncontext : HINTERACTIONCONTEXT, parameter : HOLD_PARAMETER, value : f32) -> windows_core::HRESULT);
...
pub unsafe fn SetInertiaParameterInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn SetInertiaParameterInteractionContext(interactioncontext : HINTERACTIONCONTEXT, inertiaparameter : INERTIA_PARAMETER, value : f32) -> windows_core::HRESULT);
    unsafe {
        SetInertiaParameterInteractionContext(interactioncontext, inertiaparameter, value).ok()
    }
}
#[inline]
pub unsafe fn SetInteractionConfigurationInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn SetInteractionConfigurationInteractionContext(interactioncontext : HINTERACTIONCONTEXT, configurationcount : u32, configuration : *const INTERACTION_CONTEXT_CONFIGURATION) -> windows_core::HRESULT);
    unsafe {
...
pub unsafe fn SetMouseWheelParameterInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn SetMouseWheelParameterInteractionContext(interactioncontext : HINTERACTIONCONTEXT, parameter : MOUSE_WHEEL_PARAMETER, value : f32) -> windows_core::HRESULT);
...
pub unsafe fn SetPivotInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn SetPivotInteractionContext(interactioncontext : HINTERACTIONCONTEXT, x : f32, y : f32, radius : f32) -> windows_core::HRESULT);
...
pub unsafe fn SetPropertyInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn SetPropertyInteractionContext(interactioncontext : HINTERACTIONCONTEXT, contextproperty : INTERACTION_CONTEXT_PROPERTY, value : u32) -> windows_core::HRESULT);
...
pub unsafe fn SetTapParameterInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn SetTapParameterInteractionContext(interactioncontext : HINTERACTIONCONTEXT, parameter : TAP_PARAMETER, value : f32) -> windows_core::HRESULT);
...
pub unsafe fn SetTranslationParameterInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn SetTranslationParameterInteractionContext(interactioncontext : HINTERACTIONCONTEXT, parameter : TRANSLATION_PARAMETER, value : f32) -> windows_core::HRESULT);
...
pub unsafe fn StopInteractionContext(
    ...
    windows_link::link!("ninput.dll" "system" fn StopInteractionContext(interactioncontext : HINTERACTIONCONTEXT) -> windows_core::HRESULT);
...
pub const CROSS_SLIDE_THRESHOLD_REARRANGE_START: CROSS_SLIDE_THRESHOLD =
    CROSS_SLIDE_THRESHOLD(3i32);
...
pub const CROSS_SLIDE_THRESHOLD_SPEED_BUMP_START: CROSS_SLIDE_THRESHOLD =
    CROSS_SLIDE_THRESHOLD(1i32);
#[repr(transparent)]
...
impl windows_core::Free for HINTERACTIONCONTEXT {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("ninput.dll" "system" fn DestroyInteractionContext(interactioncontext : *mut core::ffi::c_void) -> i32);
            unsafe {
...
pub const INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(1u32);
pub const INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_EXACT: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(32u32);
pub const INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_HORIZONTAL: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(2u32);
pub const INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_REARRANGE: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(16u32);
pub const INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_SELECT: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(4u32);
pub const INTERACTION_CONFIGURATION_FLAG_CROSS_SLIDE_SPEED_BUMP: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(8u32);
pub const INTERACTION_CONFIGURATION_FLAG_DRAG: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(1u32);
pub const INTERACTION_CONFIGURATION_FLAG_HOLD: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(1u32);
pub const INTERACTION_CONFIGURATION_FLAG_HOLD_MOUSE: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(2u32);
pub const INTERACTION_CONFIGURATION_FLAG_HOLD_MULTIPLE_FINGER: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(4u32);
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(1u32);
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_EXACT: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(1024u32);
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_MULTIPLE_FINGER_PANNING:
    INTERACTION_CONFIGURATION_FLAGS = INTERACTION_CONFIGURATION_FLAGS(2048u32);
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_RAILS_X: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(256u32);
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_RAILS_Y: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(512u32);
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_ROTATION: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(8u32);
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_ROTATION_INERTIA:
    INTERACTION_CONFIGURATION_FLAGS = INTERACTION_CONFIGURATION_FLAGS(64u32);
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_SCALING: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(16u32);
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_SCALING_INERTIA:
    INTERACTION_CONFIGURATION_FLAGS = INTERACTION_CONFIGURATION_FLAGS(128u32);
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_TRANSLATION_INERTIA:
    INTERACTION_CONFIGURATION_FLAGS = INTERACTION_CONFIGURATION_FLAGS(32u32);
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_TRANSLATION_X:
    INTERACTION_CONFIGURATION_FLAGS = INTERACTION_CONFIGURATION_FLAGS(2u32);
pub const INTERACTION_CONFIGURATION_FLAG_MANIPULATION_TRANSLATION_Y:
    INTERACTION_CONFIGURATION_FLAGS = INTERACTION_CONFIGURATION_FLAGS(4u32);
pub const INTERACTION_CONFIGURATION_FLAG_MAX: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(4294967295u32);
pub const INTERACTION_CONFIGURATION_FLAG_NONE: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(0u32);
pub const INTERACTION_CONFIGURATION_FLAG_SECONDARY_TAP: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(1u32);
pub const INTERACTION_CONFIGURATION_FLAG_TAP: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(1u32);
pub const INTERACTION_CONFIGURATION_FLAG_TAP_DOUBLE: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(2u32);
pub const INTERACTION_CONFIGURATION_FLAG_TAP_MULTIPLE_FINGER: INTERACTION_CONFIGURATION_FLAGS =
    INTERACTION_CONFIGURATION_FLAGS(4u32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type INTERACTION_CONTEXT_OUTPUT_CALLBACK = Option<
...
>;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type INTERACTION_CONTEXT_OUTPUT_CALLBACK2 = Option<
    unsafe extern "system" fn(
        clientdata: *const core::ffi::c_void,
...
pub const INTERACTION_CONTEXT_PROPERTY_FILTER_POINTERS: INTERACTION_CONTEXT_PROPERTY =
    INTERACTION_CONTEXT_PROPERTY(3i32);
pub const INTERACTION_CONTEXT_PROPERTY_INTERACTION_UI_FEEDBACK: INTERACTION_CONTEXT_PROPERTY =
    INTERACTION_CONTEXT_PROPERTY(2i32);
pub const INTERACTION_CONTEXT_PROPERTY_MAX: INTERACTION_CONTEXT_PROPERTY =
    INTERACTION_CONTEXT_PROPERTY(-1i32);
pub const INTERACTION_CONTEXT_PROPERTY_MEASUREMENT_UNITS: INTERACTION_CONTEXT_PROPERTY =
    INTERACTION_CONTEXT_PROPERTY(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const MANIPULATION_RAILS_STATE_RAILED: MANIPULATION_RAILS_STATE =
    MANIPULATION_RAILS_STATE(2i32);
pub const MANIPULATION_RAILS_STATE_UNDECIDED: MANIPULATION_RAILS_STATE =
    MANIPULATION_RAILS_STATE(0i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const MOUSE_WHEEL_PARAMETER_CHAR_TRANSLATION_X: MOUSE_WHEEL_PARAMETER =
    MOUSE_WHEEL_PARAMETER(1i32);
pub const MOUSE_WHEEL_PARAMETER_CHAR_TRANSLATION_Y: MOUSE_WHEEL_PARAMETER =
    MOUSE_WHEEL_PARAMETER(2i32);
...
pub const MOUSE_WHEEL_PARAMETER_PAGE_TRANSLATION_X: MOUSE_WHEEL_PARAMETER =
    MOUSE_WHEEL_PARAMETER(5i32);
pub const MOUSE_WHEEL_PARAMETER_PAGE_TRANSLATION_Y: MOUSE_WHEEL_PARAMETER =
    MOUSE_WHEEL_PARAMETER(6i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const TRANSLATION_PARAMETER_MAX_CONTACT_COUNT: TRANSLATION_PARAMETER =
    TRANSLATION_PARAMETER(1i32);
pub const TRANSLATION_PARAMETER_MIN_CONTACT_COUNT: TRANSLATION_PARAMETER =
    TRANSLATION_PARAMETER(0i32);

...
impl IUIApplication {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnViewChanged)(
    ...
    ) -> windows_core::Result<IUICommandHandler> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OnCreateUICommand)(
                windows_core::Interface::as_raw(self),
                commandid,
                typeid,
                &mut result__,
    ...
    pub unsafe fn OnDestroyUICommand<P2>(
        &self,
        commandid: u32,
        typeid: UI_COMMANDTYPE,
        commandhandler: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnDestroyUICommand)(
                windows_core::Interface::as_raw(self),
                commandid,
                typeid,
                commandhandler.param().abi(),
            )
            .ok()
        }
    }
...
pub struct IUIApplication_Vtbl {
    ...
    pub OnViewChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        UI_VIEWTYPE,
        *mut core::ffi::c_void,
    ...
    pub OnCreateUICommand: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        UI_COMMANDTYPE,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OnDestroyUICommand: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        UI_COMMANDTYPE,
        *mut core::ffi::c_void,
...
pub trait IUIApplication_Impl: windows_core::IUnknownImpl {
    fn OnViewChanged(
        ...
        viewid: u32,
        typeid: UI_VIEWTYPE,
        view: windows_core::Ref<'_, windows_core::IUnknown>,
        verb: UI_VIEWVERB,
        ureasoncode: i32,
    ) -> windows_core::Result<()>;
    ...
    fn OnDestroyUICommand(
        ...
        commandid: u32,
        typeid: UI_COMMANDTYPE,
        commandhandler: windows_core::Ref<'_, IUICommandHandler>,
    ) -> windows_core::Result<()>;
}
impl IUIApplication_Vtbl {
    pub const fn new<Identity: IUIApplication_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnViewChanged<
            Identity: IUIApplication_Impl,
            const OFFSET: isize,
        >(
            ...
            unsafe {
                ...
                IUIApplication_Impl::OnViewChanged(
                    this,
                    core::mem::transmute_copy(&viewid),
                    core::mem::transmute_copy(&typeid),
                    core::mem::transmute_copy(&view),
                    core::mem::transmute_copy(&verb),
                    core::mem::transmute_copy(&ureasoncode),
                )
                .into()
            }
        }
        unsafe extern "system" fn OnCreateUICommand<
            Identity: IUIApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            commandid: u32,
            typeid: UI_COMMANDTYPE,
            commandhandler: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUIApplication_Impl::OnCreateUICommand(
                    this,
        ...
        unsafe extern "system" fn OnDestroyUICommand<
            Identity: IUIApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            commandid: u32,
            typeid: UI_COMMANDTYPE,
            commandhandler: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUIApplication_Impl::OnDestroyUICommand(
                    this,
                    core::mem::transmute_copy(&commandid),
                    core::mem::transmute_copy(&typeid),
                    core::mem::transmute_copy(&commandhandler),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IUICollection,
    IUICollection_Vtbl,
    0xdf4f45bf_6f9d_4dd7_9d68_d8f9cd18c4db
);
...
pub trait IUICollection_Impl: windows_core::IUnknownImpl {
    ...
    fn Insert(
        &self,
        index: u32,
        item: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
    fn RemoveAt(&self, index: u32) -> windows_core::Result<()>;
    fn Replace(
        &self,
        indexreplaced: u32,
        itemreplacewith: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
    fn Clear(&self) -> windows_core::Result<()>;
}
impl IUICollection_Vtbl {
    pub const fn new<Identity: IUICollection_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCount<Identity: IUICollection_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            count: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetItem<Identity: IUICollection_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: u32,
        ...
        unsafe extern "system" fn Add<Identity: IUICollection_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Insert<Identity: IUICollection_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: u32,
            item: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn RemoveAt<Identity: IUICollection_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Replace<Identity: IUICollection_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            indexreplaced: u32,
            itemreplacewith: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUICollection_Impl::Replace(
                    this,
                    core::mem::transmute_copy(&indexreplaced),
                    core::mem::transmute_copy(&itemreplacewith),
                )
                .into()
            }
        }
        unsafe extern "system" fn Clear<Identity: IUICollection_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
pub trait IUICollectionChangedEvent_Impl: windows_core::IUnknownImpl {
    fn OnChanged(
        ...
        action: UI_COLLECTIONCHANGE,
        oldindex: u32,
        olditem: windows_core::Ref<'_, windows_core::IUnknown>,
        newindex: u32,
        newitem: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
}
impl IUICollectionChangedEvent_Vtbl {
    pub const fn new<Identity: IUICollectionChangedEvent_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnChanged<
            Identity: IUICollectionChangedEvent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            action: UI_COLLECTIONCHANGE,
            oldindex: u32,
            olditem: *mut core::ffi::c_void,
            newindex: u32,
            newitem: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUICollectionChangedEvent_Impl::OnChanged(
                    this,
                    core::mem::transmute_copy(&action),
                    core::mem::transmute_copy(&oldindex),
                    core::mem::transmute_copy(&olditem),
                    core::mem::transmute_copy(&newindex),
                    core::mem::transmute_copy(&newitem),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x75ae0a2d_dc03_4c9f_8883_069660d0beb6
);
...
impl IUICommandHandler {
    ...
    pub unsafe fn Execute<P4>(
        &self,
        commandid: u32,
        verb: UI_EXECUTIONVERB,
        key: Option<*const super::super::Foundation::PROPERTYKEY>,
        currentvalue: Option<*const super::super::System::Com::StructuredStorage::PROPVARIANT>,
        commandexecutionproperties: P4,
    ) -> windows_core::Result<()>
    where
        P4: windows_core::Param<IUISimplePropertySet>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Execute)(
                ...
                currentvalue.unwrap_or(core::mem::zeroed()) as _,
                commandexecutionproperties.param().abi(),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn UpdateProperty(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UpdateProperty)(
                windows_core::Interface::as_raw(self),
                commandid,
                key,
                currentvalue.unwrap_or(core::mem::zeroed()) as _,
...
pub struct IUICommandHandler_Vtbl {
    ...
    pub UpdateProperty: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const super::super::Foundation::PROPERTYKEY,
        *const super::super::System::Com::StructuredStorage::PROPVARIANT,
...
pub trait IUICommandHandler_Impl: windows_core::IUnknownImpl {
    fn Execute(
        ...
        commandexecutionproperties: windows_core::Ref<'_, IUISimplePropertySet>,
    ) -> windows_core::Result<()>;
    fn UpdateProperty(
        &self,
        commandid: u32,
...
impl IUICommandHandler_Vtbl {
    pub const fn new<Identity: IUICommandHandler_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Execute<Identity: IUICommandHandler_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            commandid: u32,
            verb: UI_EXECUTIONVERB,
            key: *const super::super::Foundation::PROPERTYKEY,
            currentvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT,
            commandexecutionproperties: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUICommandHandler_Impl::Execute(
                    this,
                    core::mem::transmute_copy(&commandid),
                    core::mem::transmute_copy(&verb),
                    core::mem::transmute_copy(&key),
                    core::mem::transmute_copy(&currentvalue),
                    core::mem::transmute_copy(&commandexecutionproperties),
                )
                .into()
            }
        }
        unsafe extern "system" fn UpdateProperty<
            Identity: IUICommandHandler_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            commandid: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUICommandHandler_Impl::UpdateProperty(
                    this,
                    core::mem::transmute_copy(&commandid),
                    core::mem::transmute_copy(&key),
                    core::mem::transmute_copy(&currentvalue),
...
windows_core::imp::define_interface!(
    IUIContextualUI,
    IUIContextualUI_Vtbl,
    0xeea11f37_7c46_437c_8e55_b52122b29293
);
...
impl IUIContextualUI {
    pub unsafe fn ShowAtLocation(&self, x: i32, y: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ShowAtLocation)(
                windows_core::Interface::as_raw(self),
                x,
                y,
            )
...
impl IUIContextualUI_Vtbl {
    pub const fn new<Identity: IUIContextualUI_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ShowAtLocation<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUIContextualUI_Impl::ShowAtLocation(
                    this,
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            ShowAtLocation: ShowAtLocation::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IUIEventLogger,
    IUIEventLogger_Vtbl,
    0xec3e1034_dbf4_41a1_95d5_03e0f1026e05
);
...
impl IUIEventLogger {
    pub unsafe fn OnUIEvent(&self, peventparams: *const UI_EVENTPARAMS) {
        unsafe {
            (windows_core::Interface::vtable(self).OnUIEvent)(
                windows_core::Interface::as_raw(self),
                peventparams,
            )
        }
...
impl IUIEventLogger_Vtbl {
    pub const fn new<Identity: IUIEventLogger_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnUIEvent<Identity: IUIEventLogger_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            OnUIEvent: OnUIEvent::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IUIEventingManager,
    IUIEventingManager_Vtbl,
    0x3be6ea7f_9a9b_4198_9368_9b0f923bd534
);
...
impl IUIEventingManager {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetEventLogger)(
                windows_core::Interface::as_raw(self),
                eventlogger.param().abi(),
            )
            .ok()
        }
    }
...
pub struct IUIEventingManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetEventLogger: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IUIEventingManager_Impl: windows_core::IUnknownImpl {
    fn SetEventLogger(
        &self,
        eventlogger: windows_core::Ref<'_, IUIEventLogger>,
    ) -> windows_core::Result<()>;
}
impl IUIEventingManager_Vtbl {
    pub const fn new<Identity: IUIEventingManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetEventLogger<
            Identity: IUIEventingManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            eventlogger: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUIEventingManager_Impl::SetEventLogger(
                    this,
                    core::mem::transmute_copy(&eventlogger),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            SetEventLogger: SetEventLogger::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IUIFramework,
    IUIFramework_Vtbl,
    0xf4f0385d_6872_43a8_ad09_4c339cb3f5c5
);
...
impl IUIFramework {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).LoadUI)(
                windows_core::Interface::as_raw(self),
                instance,
                resourcename.param().abi(),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn GetUICommandProperty(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetUICommandProperty)(
                windows_core::Interface::as_raw(self),
                commandid,
                key,
                &mut result__,
    ...
    pub unsafe fn SetUICommandProperty(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetUICommandProperty)(
                windows_core::Interface::as_raw(self),
                commandid,
                key,
    ...
    pub unsafe fn InvalidateUICommand(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).InvalidateUICommand)(
                windows_core::Interface::as_raw(self),
                commandid,
                flags,
                key.unwrap_or(core::mem::zeroed()) as _,
    ...
    pub unsafe fn FlushPendingInvalidations(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).FlushPendingInvalidations)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn SetModes(&self, imodes: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetModes)(
                windows_core::Interface::as_raw(self),
                imodes,
            )
            .ok()
...
pub struct IUIFramework_Vtbl {
    ...
    pub LoadUI: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub GetUICommandProperty: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const super::super::Foundation::PROPERTYKEY,
        *mut super::super::System::Com::StructuredStorage::PROPVARIANT,
    ...
    pub SetUICommandProperty: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const super::super::Foundation::PROPERTYKEY,
        *const super::super::System::Com::StructuredStorage::PROPVARIANT,
    ...
    pub InvalidateUICommand: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        UI_INVALIDATIONS,
        *const super::super::Foundation::PROPERTYKEY,
    ) -> windows_core::HRESULT,
    pub FlushPendingInvalidations:
...
pub trait IUIFramework_Impl: windows_core::IUnknownImpl {
    fn Initialize(
        &self,
        framewnd: super::super::Foundation::HWND,
        application: windows_core::Ref<'_, IUIApplication>,
    ) -> windows_core::Result<()>;
    fn Destroy(&self) -> windows_core::Result<()>;
    fn LoadUI(
        &self,
        instance: super::super::Foundation::HINSTANCE,
        resourcename: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    fn GetView(
        &self,
        viewid: u32,
...
impl IUIFramework_Vtbl {
    pub const fn new<Identity: IUIFramework_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Initialize<Identity: IUIFramework_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            framewnd: super::super::Foundation::HWND,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUIFramework_Impl::Initialize(
                    this,
                    core::mem::transmute_copy(&framewnd),
                    core::mem::transmute_copy(&application),
                )
                .into()
            }
        }
        unsafe extern "system" fn Destroy<Identity: IUIFramework_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn LoadUI<Identity: IUIFramework_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            instance: super::super::Foundation::HINSTANCE,
            resourcename: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetView<Identity: IUIFramework_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            viewid: u32,
            riid: *const windows_core::GUID,
            ppv: *mut *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetUICommandProperty<
            Identity: IUIFramework_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            commandid: u32,
            key: *const super::super::Foundation::PROPERTYKEY,
            value: *mut super::super::System::Com::StructuredStorage::PROPVARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUIFramework_Impl::GetUICommandProperty(
                    this,
                    core::mem::transmute_copy(&commandid),
                    core::mem::transmute_copy(&key),
                ) {
        ...
        unsafe extern "system" fn SetUICommandProperty<
            Identity: IUIFramework_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUIFramework_Impl::SetUICommandProperty(
                    this,
                    core::mem::transmute_copy(&commandid),
                    core::mem::transmute_copy(&key),
        ...
        unsafe extern "system" fn InvalidateUICommand<
            Identity: IUIFramework_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUIFramework_Impl::InvalidateUICommand(
                    this,
                    core::mem::transmute_copy(&commandid),
        ...
        unsafe extern "system" fn FlushPendingInvalidations<
            Identity: IUIFramework_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetModes<Identity: IUIFramework_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            imodes: i32,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    IUIImage,
    IUIImage_Vtbl,
    0x23c8c838_4de6_436b_ab01_5554bb7c30dd
);
...
impl IUIImage_Vtbl {
    pub const fn new<Identity: IUIImage_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetBitmap<Identity: IUIImage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IUIImageFromBitmap,
    IUIImageFromBitmap_Vtbl,
    0x18aba7f3_4c1c_4ba2_bf6c_f5c3326fa816
);
...
impl IUIImageFromBitmap {
    ...
    ) -> windows_core::Result<IUIImage> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateImage)(
                windows_core::Interface::as_raw(self),
                bitmap,
                options,
                &mut result__,
...
pub struct IUIImageFromBitmap_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub CreateImage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IUIImageFromBitmap_Vtbl {
    pub const fn new<Identity: IUIImageFromBitmap_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateImage<
            Identity: IUIImageFromBitmap_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bitmap: super::super::Graphics::Gdi::HBITMAP,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUIImageFromBitmap_Impl::CreateImage(
                    this,
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            CreateImage: CreateImage::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IUIRibbon,
    IUIRibbon_Vtbl,
    0x803982ab_370a_4f7e_a9e7_8784036a6e26
);
...
impl IUIRibbon {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).LoadSettingsFromStream)(
                windows_core::Interface::as_raw(self),
                pstream.param().abi(),
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SaveSettingsToStream)(
                windows_core::Interface::as_raw(self),
                pstream.param().abi(),
            )
            .ok()
...
pub struct IUIRibbon_Vtbl {
    ...
    pub GetHeight:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub LoadSettingsFromStream: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub SaveSettingsToStream: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
...
impl IUIRibbon_Vtbl {
    pub const fn new<Identity: IUIRibbon_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetHeight<Identity: IUIRibbon_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            cy: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUIRibbon_Impl::LoadSettingsFromStream(this, core::mem::transmute_copy(&pstream))
                    .into()
            }
        }
        unsafe extern "system" fn SaveSettingsToStream<
            Identity: IUIRibbon_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IUIRibbon_Impl::SaveSettingsToStream(this, core::mem::transmute_copy(&pstream))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    IUISimplePropertySet_Vtbl,
    0xc205bb48_5b1c_4219_a106_15bd0a5f24e2
);
...
impl IUISimplePropertySet_Vtbl {
    pub const fn new<Identity: IUISimplePropertySet_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetValue<
            Identity: IUISimplePropertySet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            key: *const super::super::Foundation::PROPERTYKEY,
...
pub const LIBID_UIRibbon: windows_core::GUID =
    windows_core::GUID::from_u128(0x942f35c2_e83b_45ef_b085_ac295dd63d5b);
pub const UIRibbonFramework: windows_core::GUID =
    windows_core::GUID::from_u128(0x926749fa_2615_4987_8845_c33e65f2b957);
pub const UIRibbonImageFromBitmapFactory: windows_core::GUID =
    windows_core::GUID::from_u128(0x0f7434b6_59b6_4250_999e_d168d6ae4293);

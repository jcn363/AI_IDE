#[inline]
pub unsafe fn CoGetInterceptor<P1>(
    iidintercepted: *const windows_core::GUID,
    punkouter: P1,
...
#[inline]
pub unsafe fn CoGetInterceptorFromTypeInfo<P1, P2>(
    iidintercepted: *const windows_core::GUID,
    punkouter: P1,
    typeinfo: P2,
    iid: *const windows_core::GUID,
...
windows_core::imp::define_interface!(
    ICallFrame,
    ICallFrame_Vtbl,
    0xd573b4b0_894e_11d2_b8b6_00c04fb9618a
);
...
impl ICallFrame {
    ...
    pub unsafe fn GetIIDAndMethod(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetIIDAndMethod)(
                windows_core::Interface::as_raw(self),
                piid as _,
                pimethod as _,
            )
    ...
    pub unsafe fn GetNames(
        &self,
        pwszinterface: *mut windows_core::PWSTR,
        pwszmethod: *mut windows_core::PWSTR,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub unsafe fn GetStackLocation(&self) -> *mut core::ffi::c_void {
        unsafe {
            (windows_core::Interface::vtable(self).GetStackLocation)(
                windows_core::Interface::as_raw(self),
            )
        }
    }
    pub unsafe fn SetStackLocation(&self, pvstack: *const core::ffi::c_void) {
        unsafe {
            (windows_core::Interface::vtable(self).SetStackLocation)(
                windows_core::Interface::as_raw(self),
                pvstack,
            )
        }
    ...
    pub unsafe fn SetReturnValue(&self, hr: windows_core::HRESULT) {
        unsafe {
            (windows_core::Interface::vtable(self).SetReturnValue)(
                windows_core::Interface::as_raw(self),
                hr,
            )
        }
    ...
    pub unsafe fn GetReturnValue(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetReturnValue)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn GetParamInfo(&self, iparam: u32) -> windows_core::Result<CALLFRAMEPARAMINFO> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).GetParamInfo)(
                windows_core::Interface::as_raw(self),
                iparam,
                &mut result__,
            )
    ...
    pub unsafe fn SetParam(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetParam)(
                windows_core::Interface::as_raw(self),
                iparam,
    ...
    pub unsafe fn GetParam(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetParam)(
                windows_core::Interface::as_raw(self),
                iparam,
                &mut result__,
            )
    ...
    pub unsafe fn Copy<P1>(
        ...
        pwalker: P1,
    ) -> windows_core::Result<ICallFrame>
    where
    ...
    pub unsafe fn Free<P0, P1, P2, P4>(
        &self,
        pframeargsdest: P0,
        pwalkerdestfree: P1,
        pwalkercopy: P2,
        ...
        P4: windows_core::Param<ICallFrameWalker>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Free)(
                windows_core::Interface::as_raw(self),
                pframeargsdest.param().abi(),
                pwalkerdestfree.param().abi(),
                pwalkercopy.param().abi(),
                freeflags,
                pwalkerfree.param().abi(),
                nullflags,
            )
            .ok()
        }
    }
    pub unsafe fn FreeParam<P2>(
        &self,
        iparam: u32,
        freeflags: u32,
        pwalkerfree: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).FreeParam)(
                windows_core::Interface::as_raw(self),
                iparam,
                freeflags,
                pwalkerfree.param().abi(),
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).WalkFrame)(
                windows_core::Interface::as_raw(self),
                walkwhat,
                pwalker.param().abi(),
            )
    ...
    pub unsafe fn GetMarshalSizeMax(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMarshalSizeMax)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pmshlcontext),
                mshlflags,
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn Marshal(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Marshal)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pmshlcontext),
                mshlflags,
    ...
    pub unsafe fn Unmarshal(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Unmarshal)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pbuffer.as_ptr()),
                pbuffer.len().try_into().unwrap(),
                datarep,
    ...
    pub unsafe fn ReleaseMarshalData(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ReleaseMarshalData)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pbuffer.as_ptr()),
                pbuffer.len().try_into().unwrap(),
                ibfirstrelease,
...
pub struct ICallFrame_Vtbl {
    ...
    pub GetIIDAndMethod: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub GetParamInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut CALLFRAMEPARAMINFO,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub SetParam: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
    ...
    SetParam: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub GetParam: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
    ...
    pub FreeParam: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut core::ffi::c_void,
    ...
    pub WalkFrame: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetMarshalSizeMax: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const CALLFRAME_MARSHALCONTEXT,
        super::MSHLFLAGS,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub Marshal: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const CALLFRAME_MARSHALCONTEXT,
        super::MSHLFLAGS,
    ...
    pub Unmarshal: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        u32,
        u32,
    ...
    pub ReleaseMarshalData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        u32,
        u32,
...
pub trait ICallFrame_Impl: windows_core::IUnknownImpl {
    ...
    fn Copy(
        &self,
        copycontrol: CALLFRAME_COPY,
        pwalker: windows_core::Ref<'_, ICallFrameWalker>,
    ) -> windows_core::Result<ICallFrame>;
    fn Free(
        &self,
        pframeargsdest: windows_core::Ref<'_, ICallFrame>,
        pwalkerdestfree: windows_core::Ref<'_, ICallFrameWalker>,
        pwalkercopy: windows_core::Ref<'_, ICallFrameWalker>,
        freeflags: u32,
        pwalkerfree: windows_core::Ref<'_, ICallFrameWalker>,
        nullflags: u32,
    ) -> windows_core::Result<()>;
    fn FreeParam(
        &self,
...
impl ICallFrame_Vtbl {
    pub const fn new<Identity: ICallFrame_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetInfo<Identity: ICallFrame_Impl, const OFFSET: isize>(
        ...
        unsafe extern "system" fn GetIIDAndMethod<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallFrame_Impl::GetIIDAndMethod(
                    this,
        ...
        unsafe extern "system" fn GetNames<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwszinterface: *mut windows_core::PWSTR,
            pwszmethod: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallFrame_Impl::GetNames(
                    this,
                    core::mem::transmute_copy(&pwszinterface),
                    core::mem::transmute_copy(&pwszmethod),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetStackLocation<
            Identity: ICallFrame_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetStackLocation<
            Identity: ICallFrame_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pvstack: *const core::ffi::c_void,
        ) {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetReturnValue<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetReturnValue<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetParamInfo<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iparam: u32,
        ...
        unsafe extern "system" fn SetParam<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iparam: u32,
            pvar: *const super::super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallFrame_Impl::SetParam(
                    this,
                    core::mem::transmute_copy(&iparam),
                    core::mem::transmute_copy(&pvar),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetParam<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iparam: u32,
        ...
        unsafe extern "system" fn Copy<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            copycontrol: CALLFRAME_COPY,
            pwalker: *mut core::ffi::c_void,
            ppframe: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICallFrame_Impl::Copy(
                    this,
                    core::mem::transmute_copy(&copycontrol),
                    core::mem::transmute_copy(&pwalker),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Free<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pframeargsdest: *mut core::ffi::c_void,
            pwalkerdestfree: *mut core::ffi::c_void,
            pwalkercopy: *mut core::ffi::c_void,
            freeflags: u32,
            pwalkerfree: *mut core::ffi::c_void,
            nullflags: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallFrame_Impl::Free(
                    this,
                    core::mem::transmute_copy(&pframeargsdest),
                    core::mem::transmute_copy(&pwalkerdestfree),
                    core::mem::transmute_copy(&pwalkercopy),
                    core::mem::transmute_copy(&freeflags),
                    core::mem::transmute_copy(&pwalkerfree),
                    core::mem::transmute_copy(&nullflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn FreeParam<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iparam: u32,
            freeflags: u32,
            pwalkerfree: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn WalkFrame<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            walkwhat: u32,
            pwalker: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallFrame_Impl::WalkFrame(
                    this,
                    core::mem::transmute_copy(&walkwhat),
                    core::mem::transmute_copy(&pwalker),
                )
                .into()
            }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICallFrame_Impl::GetMarshalSizeMax(
                    this,
                    core::mem::transmute_copy(&pmshlcontext),
                    core::mem::transmute_copy(&mshlflags),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Marshal<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pmshlcontext: *const CALLFRAME_MARSHALCONTEXT,
            mshlflags: super::MSHLFLAGS,
            pbuffer: *const core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallFrame_Impl::Marshal(
                    this,
                    core::mem::transmute_copy(&pmshlcontext),
                    core::mem::transmute_copy(&mshlflags),
                    core::mem::transmute_copy(&pbuffer),
                    core::mem::transmute_copy(&cbbuffer),
                    core::mem::transmute_copy(&pcbbufferused),
                    core::mem::transmute_copy(&pdatarep),
                    core::mem::transmute_copy(&prpcflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn Unmarshal<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbuffer: *const core::ffi::c_void,
            cbbuffer: u32,
            datarep: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICallFrame_Impl::Unmarshal(
                    this,
                    core::mem::transmute_copy(&pbuffer),
                    core::mem::transmute_copy(&cbbuffer),
                    core::mem::transmute_copy(&datarep),
        ...
        unsafe extern "system" fn ReleaseMarshalData<
            Identity: ICallFrame_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallFrame_Impl::ReleaseMarshalData(
                    this,
                    core::mem::transmute_copy(&pbuffer),
                    core::mem::transmute_copy(&cbbuffer),
                    core::mem::transmute_copy(&ibfirstrelease),
                    core::mem::transmute_copy(&datarep),
                    core::mem::transmute_copy(&pcontext),
                )
                .into()
        ...
        unsafe extern "system" fn Invoke<Identity: ICallFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pvreceiver: *const core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ICallFrameEvents,
    ICallFrameEvents_Vtbl,
    0xfd5e0843_fc91_11d0_97d7_00c04fb9618a
);
...
impl ICallFrameEvents {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnCall)(
                windows_core::Interface::as_raw(self),
                pframe.param().abi(),
            )
            .ok()
...
pub struct ICallFrameEvents_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OnCall: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ICallFrameEvents_Vtbl {
    pub const fn new<Identity: ICallFrameEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnCall<Identity: ICallFrameEvents_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pframe: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x08b23919_392d_11d2_b8a4_00c04fb9618a
);
...
impl ICallFrameWalker {
    pub unsafe fn OnWalkInterface(
        &self,
        iid: *const windows_core::GUID,
        ppvinterface: *const *const core::ffi::c_void,
        fin: bool,
        fout: bool,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnWalkInterface)(
                windows_core::Interface::as_raw(self),
                iid,
                ppvinterface,
                fin.into(),
...
pub struct ICallFrameWalker_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OnWalkInterface: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub const fn new<Identity: ICallFrameWalker_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallFrameWalker_Impl::OnWalkInterface(
                    this,
                    core::mem::transmute_copy(&iid),
                    core::mem::transmute_copy(&ppvinterface),
                    core::mem::transmute_copy(&fin),
                    core::mem::transmute_copy(&fout),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            OnWalkInterface: OnWalkInterface::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ICallIndirect,
    ICallIndirect_Vtbl,
    0xd573b4b1_894e_11d2_b8b6_00c04fb9618a
);
windows_core::imp::interface_hierarchy!(ICallIndirect, windows_core::IUnknown);
impl ICallIndirect {
    pub unsafe fn CallIndirect(
        &self,
        phrreturn: *mut windows_core::HRESULT,
        imethod: u32,
        pvargs: *const core::ffi::c_void,
        cbargs: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CallIndirect)(
                windows_core::Interface::as_raw(self),
                phrreturn as _,
                imethod,
                pvargs,
    ...
    pub unsafe fn GetMethodInfo(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetMethodInfo)(
                windows_core::Interface::as_raw(self),
                imethod,
                pinfo as _,
                pwszmethod as _,
    ...
    pub unsafe fn GetStackSize(&self, imethod: u32) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStackSize)(
                windows_core::Interface::as_raw(self),
                imethod,
                &mut result__,
            )
    ...
    pub unsafe fn GetIID(
        &self,
        piid: Option<*mut windows_core::GUID>,
        pfderivesfromidispatch: Option<*mut windows_core::BOOL>,
        pcmethod: Option<*mut u32>,
        pwszinterface: *mut windows_core::PWSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetIID)(
                windows_core::Interface::as_raw(self),
                piid.unwrap_or(core::mem::zeroed()) as _,
                pfderivesfromidispatch.unwrap_or(core::mem::zeroed()) as _,
                pcmethod.unwrap_or(core::mem::zeroed()) as _,
                pwszinterface as _,
            )
            .ok()
        }
...
pub struct ICallIndirect_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CallIndirect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub GetMethodInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut CALLFRAMEINFO,
        *mut windows_core::PWSTR,
...
pub trait ICallIndirect_Impl: windows_core::IUnknownImpl {
    ...
    fn GetIID(
        &self,
        piid: *mut windows_core::GUID,
        pfderivesfromidispatch: *mut windows_core::BOOL,
        pcmethod: *mut u32,
        pwszinterface: *mut windows_core::PWSTR,
    ) -> windows_core::Result<()>;
}
impl ICallIndirect_Vtbl {
    pub const fn new<Identity: ICallIndirect_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CallIndirect<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallIndirect_Impl::CallIndirect(
                    this,
                    core::mem::transmute_copy(&phrreturn),
                    core::mem::transmute_copy(&imethod),
                    core::mem::transmute_copy(&pvargs),
                    core::mem::transmute_copy(&cbargs),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetMethodInfo<
            Identity: ICallIndirect_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallIndirect_Impl::GetMethodInfo(
                    this,
                    core::mem::transmute_copy(&imethod),
        ...
        unsafe extern "system" fn GetStackSize<
            Identity: ICallIndirect_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetIID<Identity: ICallIndirect_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            piid: *mut windows_core::GUID,
            pfderivesfromidispatch: *mut windows_core::BOOL,
            pcmethod: *mut u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallIndirect_Impl::GetIID(
                    this,
                    core::mem::transmute_copy(&piid),
                    core::mem::transmute_copy(&pfderivesfromidispatch),
                    core::mem::transmute_copy(&pcmethod),
                    core::mem::transmute_copy(&pwszinterface),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0x60c7ca75_896d_11d2_b8b6_00c04fb9618a
);
...
impl ICallInterceptor {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterSink)(
                windows_core::Interface::as_raw(self),
                psink.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn GetRegisteredSink(&self) -> windows_core::Result<ICallFrameEvents> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRegisteredSink)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ICallInterceptor_Vtbl {
    ...
    pub RegisterSink: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetRegisteredSink: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait ICallInterceptor_Impl: ICallIndirect_Impl {
    fn RegisterSink(
        &self,
        psink: windows_core::Ref<'_, ICallFrameEvents>,
    ) -> windows_core::Result<()>;
...
impl ICallInterceptor_Vtbl {
    pub const fn new<Identity: ICallInterceptor_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RegisterSink<
        ...
        unsafe extern "system" fn GetRegisteredSink<
            Identity: ICallInterceptor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ICallUnmarshal,
    ICallUnmarshal_Vtbl,
    0x5333b003_2e42_11d2_b89d_00c04fb9618a
);
    ...
    pub unsafe fn Unmarshal(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Unmarshal)(
                ...
                core::mem::transmute(pbuffer.as_ptr()),
                pbuffer.len().try_into().unwrap(),
                fforcebuffercopy.into(),
                datarep,
                core::mem::transmute(pcontext),
                pcbunmarshalled as _,
...
pub trait ICallUnmarshal_Impl: windows_core::IUnknownImpl {
    fn Unmarshal(
        ...
        pbuffer: *const core::ffi::c_void,
        cbbuffer: u32,
        fforcebuffercopy: windows_core::BOOL,
        datarep: u32,
        pcontext: *const CALLFRAME_MARSHALCONTEXT,
        pcbunmarshalled: *mut u32,
        ppframe: windows_core::OutRef<'_, ICallFrame>,
    ) -> windows_core::Result<()>;
    fn ReleaseMarshalData(
        &self,
        imethod: u32,
...
impl ICallUnmarshal_Vtbl {
    pub const fn new<Identity: ICallUnmarshal_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Unmarshal<Identity: ICallUnmarshal_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            imethod: u32,
            pbuffer: *const core::ffi::c_void,
            cbbuffer: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallUnmarshal_Impl::Unmarshal(
                    this,
                    core::mem::transmute_copy(&imethod),
                    core::mem::transmute_copy(&pbuffer),
                    core::mem::transmute_copy(&cbbuffer),
                    core::mem::transmute_copy(&fforcebuffercopy),
                    core::mem::transmute_copy(&datarep),
                    core::mem::transmute_copy(&pcontext),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICallUnmarshal_Impl::ReleaseMarshalData(
                    this,
                    core::mem::transmute_copy(&imethod),
                    core::mem::transmute_copy(&pbuffer),
                    core::mem::transmute_copy(&cbbuffer),
...
windows_core::imp::define_interface!(
    ...
    0xd1fb5a79_7706_11d1_adba_00c04fc2adc0
);
...
impl IInterfaceRelated {
    pub unsafe fn SetIID(&self, iid: *const windows_core::GUID) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetIID)(
                windows_core::Interface::as_raw(self),
                iid,
            )
            .ok()
...
pub struct IInterfaceRelated_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetIID: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub GetIID: unsafe extern "system" fn(
...
impl IInterfaceRelated_Vtbl {
    pub const fn new<Identity: IInterfaceRelated_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetIID<Identity: IInterfaceRelated_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iid: *const windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetIID<Identity: IInterfaceRelated_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            piid: *mut windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {

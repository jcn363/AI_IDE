...
pub unsafe fn WinUsb_ControlTransfer(
    ...
    unsafe {
        WinUsb_ControlTransfer(
            interfacehandle,
            core::mem::transmute(setuppacket),
            core::mem::transmute(
                buffer
                    .as_deref()
            ...
            lengthtransferred.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn WinUsb_GetAssociatedInterface(
    ...
    unsafe {
        WinUsb_GetAssociatedInterface(
            ...
            associatedinterfacehandle as _,
        )
        .ok()
    }
}
...
pub unsafe fn WinUsb_GetCurrentFrameNumber(
    ...
    unsafe {
        WinUsb_GetCurrentFrameNumber(interfacehandle, currentframenumber as _, timestamp as _).ok()
    }
}
#[inline]
...
pub unsafe fn WinUsb_Initialize(
    ...
    interfacehandle: *mut WINUSB_INTERFACE_HANDLE,
) -> windows_core::Result<()> {
...
pub unsafe fn WinUsb_ParseConfigurationDescriptor(
    ...
    startposition: *const core::ffi::c_void,
    interfacenumber: i32,
...
pub unsafe fn WinUsb_ParseDescriptors(
    descriptorbuffer: *const core::ffi::c_void,
    totallength: u32,
    startposition: *const core::ffi::c_void,
    descriptortype: i32,
...
pub unsafe fn WinUsb_QueryInterfaceSettings(
    ...
    unsafe {
        WinUsb_QueryInterfaceSettings(
            ...
            usbaltinterfacedescriptor as _,
        )
        .ok()
    }
}
...
pub unsafe fn WinUsb_ReadIsochPipe(
    bufferhandle: *const core::ffi::c_void,
    offset: u32,
    length: u32,
    framenumber: *mut u32,
    ...
    unsafe {
        WinUsb_ReadIsochPipe(
            ...
            length,
            framenumber as _,
            isopacketdescriptors.len().try_into().unwrap(),
            core::mem::transmute(isopacketdescriptors.as_ptr()),
            overlapped.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub unsafe fn WinUsb_RegisterIsochBuffer(
    ...
    pipeid: u8,
    buffer: &mut [u8],
    isochbufferhandle: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn WinUsb_UnregisterIsochBuffer(
    isochbufferhandle: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub const GUID_DEVINTERFACE_USB_BILLBOARD: windows_core::GUID =
    windows_core::GUID::from_u128(0x5e9adaef_f879_473f_b807_4e5ea77d1b1c);
pub const GUID_DEVINTERFACE_USB_DEVICE: windows_core::GUID =
    windows_core::GUID::from_u128(0xa5dcbf10_6530_11d2_901f_00c04fb951ed);
pub const GUID_DEVINTERFACE_USB_HOST_CONTROLLER: windows_core::GUID =
    windows_core::GUID::from_u128(0x3abf6f2d_71c4_462a_8a92_1e6861e6af27);
pub const GUID_DEVINTERFACE_USB_HUB: windows_core::GUID =
    windows_core::GUID::from_u128(0xf18a0e88_c30c_11d0_8815_00a0c906bed8);
pub const GUID_USB_MSOS20_PLATFORM_CAPABILITY_ID: windows_core::GUID =
    windows_core::GUID::from_u128(0xd8dd60df_4589_4cc7_9cd2_659d9e648a9f);
pub const GUID_USB_PERFORMANCE_TRACING: windows_core::GUID =
    windows_core::GUID::from_u128(0xd5de77a6_6ae9_425c_b1e2_f5615fd348a9);
pub const GUID_USB_TRANSFER_TRACING: windows_core::GUID =
    windows_core::GUID::from_u128(0x681eb8aa_403d_452c_9f8a_f0616fac9540);
pub const GUID_USB_WMI_DEVICE_PERF_INFO: windows_core::GUID =
    windows_core::GUID::from_u128(0x66c1aa3c_499f_49a0_a9a5_61e2359f6407);
pub const GUID_USB_WMI_NODE_INFO: windows_core::GUID =
    windows_core::GUID::from_u128(0x9c179357_dc7a_4f41_b66b_323b9ddcb5b1);
pub const GUID_USB_WMI_STD_DATA: windows_core::GUID =
    windows_core::GUID::from_u128(0x4e623b20_cb14_11d1_b331_00a0c959bbd2);
pub const GUID_USB_WMI_STD_NOTIFICATION: windows_core::GUID =
    windows_core::GUID::from_u128(0x4e623b20_cb14_11d1_b331_00a0c959bbd2);
pub const GUID_USB_WMI_SURPRISE_REMOVAL_NOTIFICATION: windows_core::GUID =
    windows_core::GUID::from_u128(0x9bbbf831_a2f2_43b4_96d1_86944b5914b3);
pub const GUID_USB_WMI_TRACING: windows_core::GUID =
    windows_core::GUID::from_u128(0x3a61881b_b4e6_4bf9_ae0f_3cd8f394e52f);
...
pub const KREGMANUSBFNENUMPATH: windows_core::PCWSTR = windows_core::w!(
    "\\Registry\\Machine\\SYSTEM\\CurrentControlSet\\Control\\ManufacturingMode\\Current\\USBFN\\"
);
pub const KREGUSBFNENUMPATH: windows_core::PCWSTR =
    windows_core::w!("\\Registry\\Machine\\SYSTEM\\CurrentControlSet\\Control\\USBFN\\");
...
pub const UREGMANUSBFNENUMPATH: windows_core::PCWSTR = windows_core::w!(
    "HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\ManufacturingMode\\Current\\USBFN\\"
);
pub const UREGUSBFNENUMPATH: windows_core::PCWSTR =
    windows_core::w!("HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\USBFN\\");
...
pub const WinUSB_TestGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xda812bff_12c3_46a2_8e2b_dbd3b7834c43);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]

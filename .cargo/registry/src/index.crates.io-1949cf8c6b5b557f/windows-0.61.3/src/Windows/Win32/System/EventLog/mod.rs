#[inline]
pub unsafe fn BackupEventLogA<P1>(
...
#[inline]
pub unsafe fn BackupEventLogW<P1>(
    heventlog: super::super::Foundation::HANDLE,
    lpbackupfilename: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn EvtArchiveExportedLog<P1>(
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        EvtClearLog(
            session.unwrap_or(core::mem::zeroed()) as _,
            channelpath.param().abi(),
            targetfilepath.param().abi(),
            flags,
        )
        .ok()
    }
...
pub unsafe fn EvtCreateRenderContext(
    valuepaths: Option<&[windows_core::PCWSTR]>,
    flags: u32,
) -> windows_core::Result<EVT_HANDLE> {
...
pub unsafe fn EvtFormatMessage(
    publishermetadata: Option<EVT_HANDLE>,
    event: Option<EVT_HANDLE>,
    messageid: u32,
    values: Option<&[EVT_VARIANT]>,
    flags: u32,
    ...
    unsafe {
        EvtFormatMessage(
            publishermetadata.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn EvtGetChannelConfigProperty(
    ...
    propertyvaluebuffer: Option<*mut EVT_VARIANT>,
    ...
    unsafe {
        EvtGetChannelConfigProperty(
            ...
            propertyvaluebuffer.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn EvtGetEventMetadataProperty(
    ...
    eventmetadatapropertybuffer: Option<*mut EVT_VARIANT>,
    ...
    unsafe {
        EvtGetEventMetadataProperty(
            ...
            eventmetadatapropertybuffer.unwrap_or(core::mem::zeroed()) as _,
            eventmetadatapropertybufferused as _,
        )
        .ok()
    }
}
...
pub unsafe fn EvtGetPublisherMetadataProperty(
    ...
    publishermetadatapropertybuffer: Option<*mut EVT_VARIANT>,
    ...
    unsafe {
        EvtGetPublisherMetadataProperty(
            ...
            publishermetadatapropertybuffer.unwrap_or(core::mem::zeroed()) as _,
            publishermetadatapropertybufferused as _,
        )
        .ok()
    }
}
...
pub unsafe fn EvtNext(
    ...
    unsafe {
        EvtNext(
            ...
            core::mem::transmute(events.as_ptr()),
            timeout,
            flags,
            returned as _,
        )
...
pub unsafe fn EvtNextChannelPath(
    ...
    unsafe {
        EvtNextChannelPath(
            ...
            channelpathbufferused as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn EvtNextEventMetadata(
...
pub unsafe fn EvtNextPublisherId(
    ...
    publisheridbuffer: Option<&mut [u16]>,
...
#[inline]
pub unsafe fn EvtOpenChannelEnum(
    session: Option<EVT_HANDLE>,
    flags: u32,
) -> windows_core::Result<EVT_HANDLE> {
...
#[inline]
pub unsafe fn EvtOpenEventMetadataEnum(
    publishermetadata: EVT_HANDLE,
    flags: u32,
) -> windows_core::Result<EVT_HANDLE> {
...
#[inline]
pub unsafe fn EvtOpenPublisherEnum(
    session: Option<EVT_HANDLE>,
    flags: u32,
) -> windows_core::Result<EVT_HANDLE> {
...
#[inline]
pub unsafe fn EvtOpenPublisherMetadata<P1, P2>(
    session: Option<EVT_HANDLE>,
    publisherid: P1,
    logfilepath: P2,
    locale: u32,
...
pub unsafe fn EvtSeek(
    ...
    unsafe {
        EvtSeek(
            resultset,
            position,
            bookmark.unwrap_or(core::mem::zeroed()) as _,
            timeout.unwrap_or(core::mem::zeroed()) as _,
            flags,
        )
        .ok()
...
#[inline]
pub unsafe fn EvtSubscribe<P2, P3>(
    session: Option<EVT_HANDLE>,
    signalevent: Option<super::super::Foundation::HANDLE>,
    channelpath: P2,
    query: P3,
    bookmark: Option<EVT_HANDLE>,
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    let result__ = unsafe {
        EvtSubscribe(
            session.unwrap_or(core::mem::zeroed()) as _,
            signalevent.unwrap_or(core::mem::zeroed()) as _,
            channelpath.param().abi(),
            query.param().abi(),
            bookmark.unwrap_or(core::mem::zeroed()) as _,
            context.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn EvtUpdateBookmark(
    bookmark: EVT_HANDLE,
    event: EVT_HANDLE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn OpenEventLogA<P0, P1>(
    lpuncservername: P0,
    lpsourcename: P1,
) -> windows_core::Result<super::super::Foundation::HANDLE>
where
...
#[inline]
pub unsafe fn RegisterEventSourceA<P0, P1>(
    lpuncservername: P0,
    lpsourcename: P1,
) -> windows_core::Result<super::super::Foundation::HANDLE>
where
...
pub unsafe fn ReportEventA(
    ...
    wcategory: u16,
    dweventid: u32,
    lpusersid: Option<super::super::Security::PSID>,
    dwdatasize: u32,
    lpstrings: Option<&[windows_core::PCSTR]>,
    lprawdata: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        ReportEventA(
            ...
            wcategory,
            dweventid,
            lpusersid.unwrap_or(core::mem::zeroed()) as _,
            lpstrings
                .as_deref()
                .map_or(0, |slice| slice.len().try_into().unwrap()),
            dwdatasize,
            ...
            lprawdata.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn ReportEventW(
    ...
    lpusersid: Option<super::super::Security::PSID>,
    dwdatasize: u32,
    lpstrings: Option<&[windows_core::PCWSTR]>,
    lprawdata: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
...
pub type EVT_SUBSCRIBE_CALLBACK = Option<
...
pub const EvtChannelReferenceImported: EVT_CHANNEL_REFERENCE_FLAGS =
    EVT_CHANNEL_REFERENCE_FLAGS(1u32);

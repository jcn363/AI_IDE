...
pub unsafe fn PrjClearNegativePathCache(
    namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,
    totalentrynumber: Option<*mut u32>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        PrjClearNegativePathCache(
            ...
            totalentrynumber.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn PrjCompleteCommand(
    namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,
    commandid: i32,
    completionresult: windows_core::HRESULT,
    ...
    unsafe {
        PrjCompleteCommand(
            ...
            commandid,
            completionresult,
            extendedparameters.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn PrjDeleteFile<P1>(
    namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,
    destinationfilename: P1,
    updateflags: Option<PRJ_UPDATE_TYPES>,
    failurereason: Option<*mut PRJ_UPDATE_FAILURE_CAUSES>,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PrjDeleteFile(
            ...
            updateflags.unwrap_or(core::mem::zeroed()) as _,
            failurereason.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn PrjFillDirEntryBuffer<P0>(
    filename: P0,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PrjFillDirEntryBuffer(
            filename.param().abi(),
            filebasicinfo.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn PrjFillDirEntryBuffer2<P1>(
    direntrybufferhandle: PRJ_DIR_ENTRY_BUFFER_HANDLE,
    filename: P1,
    filebasicinfo: Option<*const PRJ_FILE_BASIC_INFO>,
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PrjFillDirEntryBuffer2(
            ...
            filename.param().abi(),
            filebasicinfo.unwrap_or(core::mem::zeroed()) as _,
            extendedinfo.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
) -> windows_core::Result<PRJ_FILE_STATE>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
pub unsafe fn PrjGetVirtualizationInstanceInfo(
    ...
    unsafe {
        PrjGetVirtualizationInstanceInfo(
            namespacevirtualizationcontext,
            virtualizationinstanceinfo as _,
        )
        .ok()
    }
}
...
pub unsafe fn PrjMarkDirectoryAsPlaceholder<P0, P1>(
    ...
    virtualizationinstanceid: *const windows_core::GUID,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PrjMarkDirectoryAsPlaceholder(
            ...
            versioninfo.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn PrjStartVirtualizing<P0>(
...
) -> windows_core::Result<PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ...
        PrjStartVirtualizing(
            ...
            callbacks,
            instancecontext.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn PrjUpdateFileIfNeeded<P1>(
    namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,
    destinationfilename: P1,
...
pub unsafe fn PrjWriteFileData(
    namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,
    datastreamid: *const windows_core::GUID,
...
pub type PRJ_CANCEL_COMMAND_CB =
    Option<unsafe extern "system" fn(callbackdata: *const PRJ_CALLBACK_DATA)>;
...
pub type PRJ_END_DIRECTORY_ENUMERATION_CB = Option<
    unsafe extern "system" fn(
        callbackdata: *const PRJ_CALLBACK_DATA,
        enumerationid: *const windows_core::GUID,
    ) -> windows_core::HRESULT,
>;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const PRJ_FLAG_USE_NEGATIVE_PATH_CACHE: PRJ_STARTVIRTUALIZING_FLAGS =
    PRJ_STARTVIRTUALIZING_FLAGS(1i32);
pub type PRJ_GET_DIRECTORY_ENUMERATION_CB = Option<
    unsafe extern "system" fn(
        callbackdata: *const PRJ_CALLBACK_DATA,
        enumerationid: *const windows_core::GUID,
        searchexpression: windows_core::PCWSTR,
        direntrybufferhandle: PRJ_DIR_ENTRY_BUFFER_HANDLE,
    ) -> windows_core::HRESULT,
>;
pub type PRJ_GET_FILE_DATA_CB = Option<
    unsafe extern "system" fn(
        callbackdata: *const PRJ_CALLBACK_DATA,
        byteoffset: u64,
        length: u32,
...
>;
pub type PRJ_GET_PLACEHOLDER_INFO_CB = Option<
    unsafe extern "system" fn(callbackdata: *const PRJ_CALLBACK_DATA) -> windows_core::HRESULT,
>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub type PRJ_NOTIFICATION_CB = Option<
    unsafe extern "system" fn(
        callbackdata: *const PRJ_CALLBACK_DATA,
        isdirectory: bool,
        notification: PRJ_NOTIFICATION,
        destinationfilename: windows_core::PCWSTR,
...
pub type PRJ_QUERY_FILE_NAME_CB = Option<
    unsafe extern "system" fn(callbackdata: *const PRJ_CALLBACK_DATA) -> windows_core::HRESULT,
>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub type PRJ_START_DIRECTORY_ENUMERATION_CB = Option<
    unsafe extern "system" fn(
        callbackdata: *const PRJ_CALLBACK_DATA,
        enumerationid: *const windows_core::GUID,
    ) -> windows_core::HRESULT,

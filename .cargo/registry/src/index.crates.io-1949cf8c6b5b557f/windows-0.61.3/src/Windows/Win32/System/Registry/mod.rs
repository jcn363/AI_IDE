...
{
    windows_link::link!("api-ms-win-core-state-helpers-l1-1-0.dll" "system" fn GetRegistryValueWithFallbackW(hkeyprimary : HKEY, pwszprimarysubkey : windows_core::PCWSTR, hkeyfallback : HKEY, pwszfallbacksubkey : windows_core::PCWSTR, pwszvalue : windows_core::PCWSTR, dwflags : u32, pdwtype : *mut u32, pvdata : *mut core::ffi::c_void, cbdatain : u32, pcbdataout : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        GetRegistryValueWithFallbackW(
            hkeyprimary.unwrap_or(core::mem::zeroed()) as _,
            pwszprimarysubkey.param().abi(),
            hkeyfallback.unwrap_or(core::mem::zeroed()) as _,
            pwszfallbacksubkey.param().abi(),
            pwszvalue.param().abi(),
            dwflags,
            pdwtype.unwrap_or(core::mem::zeroed()) as _,
            pvdata.unwrap_or(core::mem::zeroed()) as _,
            cbdatain,
            pcbdataout.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
{
    windows_link::link!("advapi32.dll" "system" fn RegConnectRegistryA(lpmachinename : windows_core::PCSTR, hkey : HKEY, phkresult : *mut HKEY) -> super::super::Foundation:: WIN32_ERROR);
    unsafe { RegConnectRegistryA(lpmachinename.param().abi(), hkey, phkresult as _) }
}
#[inline]
pub unsafe fn RegConnectRegistryExA<P0>(
    lpmachinename: P0,
    hkey: HKEY,
    flags: u32,
    phkresult: *mut HKEY,
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegConnectRegistryExA(lpmachinename : windows_core::PCSTR, hkey : HKEY, flags : u32, phkresult : *mut HKEY) -> i32);
...
{
    windows_link::link!("advapi32.dll" "system" fn RegConnectRegistryExW(lpmachinename : windows_core::PCWSTR, hkey : HKEY, flags : u32, phkresult : *mut HKEY) -> i32);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegConnectRegistryW(lpmachinename : windows_core::PCWSTR, hkey : HKEY, phkresult : *mut HKEY) -> super::super::Foundation:: WIN32_ERROR);
...
{
    windows_link::link!("advapi32.dll" "system" fn RegCopyTreeA(hkeysrc : HKEY, lpsubkey : windows_core::PCSTR, hkeydest : HKEY) -> super::super::Foundation:: WIN32_ERROR);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegCopyTreeW(hkeysrc : HKEY, lpsubkey : windows_core::PCWSTR, hkeydest : HKEY) -> super::super::Foundation:: WIN32_ERROR);
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegCreateKeyA(hkey : HKEY, lpsubkey : windows_core::PCSTR, phkresult : *mut HKEY) -> super::super::Foundation:: WIN32_ERROR);
    unsafe { RegCreateKeyA(hkey, lpsubkey.param().abi(), phkresult as _) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn RegCreateKeyExA<P1, P3>(
    hkey: HKEY,
    lpsubkey: P1,
    reserved: Option<u32>,
    lpclass: P3,
...
where
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegCreateKeyExW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, reserved : u32, lpclass : windows_core::PCWSTR, dwoptions : REG_OPEN_CREATE_OPTIONS, samdesired : REG_SAM_FLAGS, lpsecurityattributes : *const super::super::Security:: SECURITY_ATTRIBUTES, phkresult : *mut HKEY, lpdwdisposition : *mut REG_CREATE_KEY_DISPOSITION) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegCreateKeyExW(
            hkey,
            lpsubkey.param().abi(),
...
where
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegCreateKeyTransactedW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, reserved : u32, lpclass : windows_core::PCWSTR, dwoptions : REG_OPEN_CREATE_OPTIONS, samdesired : REG_SAM_FLAGS, lpsecurityattributes : *const super::super::Security:: SECURITY_ATTRIBUTES, phkresult : *mut HKEY, lpdwdisposition : *mut REG_CREATE_KEY_DISPOSITION, htransaction : super::super::Foundation:: HANDLE, pextendedparemeter : *const core::ffi::c_void) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegCreateKeyW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, phkresult : *mut HKEY) -> super::super::Foundation:: WIN32_ERROR);
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegDeleteKeyA(hkey : HKEY, lpsubkey : windows_core::PCSTR) -> super::super::Foundation:: WIN32_ERROR);
    unsafe { RegDeleteKeyA(hkey, lpsubkey.param().abi()) }
}
#[inline]
pub unsafe fn RegDeleteKeyExA<P1>(
    hkey: HKEY,
    lpsubkey: P1,
    samdesired: u32,
    reserved: Option<u32>,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegDeleteKeyExA(hkey : HKEY, lpsubkey : windows_core::PCSTR, samdesired : u32, reserved : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegDeleteKeyExA(
            hkey,
            lpsubkey.param().abi(),
...
#[inline]
pub unsafe fn RegDeleteKeyExW<P1>(
    hkey: HKEY,
    lpsubkey: P1,
    samdesired: u32,
    reserved: Option<u32>,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegDeleteKeyExW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, samdesired : u32, reserved : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegDeleteKeyExW(
            hkey,
            lpsubkey.param().abi(),
...
#[inline]
pub unsafe fn RegDeleteKeyTransactedA<P1>(
    hkey: HKEY,
    lpsubkey: P1,
    samdesired: u32,
    reserved: Option<u32>,
    htransaction: super::super::Foundation::HANDLE,
    pextendedparameter: Option<*const core::ffi::c_void>,
) -> super::super::Foundation::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegDeleteKeyTransactedA(hkey : HKEY, lpsubkey : windows_core::PCSTR, samdesired : u32, reserved : u32, htransaction : super::super::Foundation:: HANDLE, pextendedparameter : *const core::ffi::c_void) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegDeleteKeyTransactedA(
            ...
            reserved.unwrap_or(core::mem::zeroed()) as _,
            htransaction,
            pextendedparameter.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegDeleteKeyTransactedW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, samdesired : u32, reserved : u32, htransaction : super::super::Foundation:: HANDLE, pextendedparameter : *const core::ffi::c_void) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
...
#[inline]
pub unsafe fn RegDeleteKeyValueA<P1, P2>(
    hkey: HKEY,
    lpsubkey: P1,
    lpvaluename: P2,
) -> super::super::Foundation::WIN32_ERROR
...
{
    windows_link::link!("advapi32.dll" "system" fn RegDeleteKeyValueA(hkey : HKEY, lpsubkey : windows_core::PCSTR, lpvaluename : windows_core::PCSTR) -> super::super::Foundation:: WIN32_ERROR);
...
{
    windows_link::link!("advapi32.dll" "system" fn RegDeleteKeyValueW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, lpvaluename : windows_core::PCWSTR) -> super::super::Foundation:: WIN32_ERROR);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegDeleteKeyW(hkey : HKEY, lpsubkey : windows_core::PCWSTR) -> super::super::Foundation:: WIN32_ERROR);
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegDeleteTreeA(hkey : HKEY, lpsubkey : windows_core::PCSTR) -> super::super::Foundation:: WIN32_ERROR);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegDeleteTreeW(hkey : HKEY, lpsubkey : windows_core::PCWSTR) -> super::super::Foundation:: WIN32_ERROR);
    unsafe { RegDeleteTreeW(hkey, lpsubkey.param().abi()) }
}
#[inline]
pub unsafe fn RegDeleteValueA<P1>(
    hkey: HKEY,
    lpvaluename: P1,
) -> super::super::Foundation::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegDeleteValueA(hkey : HKEY, lpvaluename : windows_core::PCSTR) -> super::super::Foundation:: WIN32_ERROR);
    unsafe { RegDeleteValueA(hkey, lpvaluename.param().abi()) }
}
#[inline]
pub unsafe fn RegDeleteValueW<P1>(
    hkey: HKEY,
    lpvaluename: P1,
) -> super::super::Foundation::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegDeleteValueW(hkey : HKEY, lpvaluename : windows_core::PCWSTR) -> super::super::Foundation:: WIN32_ERROR);
...
#[inline]
pub unsafe fn RegEnumKeyA(
    hkey: HKEY,
    dwindex: u32,
    lpname: Option<&mut [u8]>,
) -> super::super::Foundation::WIN32_ERROR {
    windows_link::link!("advapi32.dll" "system" fn RegEnumKeyA(hkey : HKEY, dwindex : u32, lpname : windows_core::PSTR, cchname : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegEnumKeyA(
            hkey,
            dwindex,
...
#[inline]
pub unsafe fn RegEnumKeyExA(
    hkey: HKEY,
    dwindex: u32,
    lpname: Option<windows_core::PSTR>,
    lpcchname: *mut u32,
    lpreserved: Option<*const u32>,
    lpclass: Option<windows_core::PSTR>,
    lpcchclass: Option<*mut u32>,
    lpftlastwritetime: Option<*mut super::super::Foundation::FILETIME>,
) -> super::super::Foundation::WIN32_ERROR {
    windows_link::link!("advapi32.dll" "system" fn RegEnumKeyExA(hkey : HKEY, dwindex : u32, lpname : windows_core::PSTR, lpcchname : *mut u32, lpreserved : *const u32, lpclass : windows_core::PSTR, lpcchclass : *mut u32, lpftlastwritetime : *mut super::super::Foundation:: FILETIME) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegEnumKeyExA(
            hkey,
            dwindex,
...
pub unsafe fn RegEnumKeyExW(
    hkey: HKEY,
    dwindex: u32,
    lpname: Option<windows_core::PWSTR>,
    lpcchname: *mut u32,
    lpreserved: Option<*const u32>,
    lpclass: Option<windows_core::PWSTR>,
    lpcchclass: Option<*mut u32>,
    lpftlastwritetime: Option<*mut super::super::Foundation::FILETIME>,
) -> super::super::Foundation::WIN32_ERROR {
    windows_link::link!("advapi32.dll" "system" fn RegEnumKeyExW(hkey : HKEY, dwindex : u32, lpname : windows_core::PWSTR, lpcchname : *mut u32, lpreserved : *const u32, lpclass : windows_core::PWSTR, lpcchclass : *mut u32, lpftlastwritetime : *mut super::super::Foundation:: FILETIME) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegEnumKeyExW(
            hkey,
            dwindex,
...
#[inline]
pub unsafe fn RegEnumKeyW(
    hkey: HKEY,
    dwindex: u32,
    lpname: Option<&mut [u16]>,
) -> super::super::Foundation::WIN32_ERROR {
    windows_link::link!("advapi32.dll" "system" fn RegEnumKeyW(hkey : HKEY, dwindex : u32, lpname : windows_core::PWSTR, cchname : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegEnumKeyW(
            hkey,
            dwindex,
...
#[inline]
pub unsafe fn RegEnumValueA(
    hkey: HKEY,
    dwindex: u32,
    lpvaluename: Option<windows_core::PSTR>,
    ...
    windows_link::link!("advapi32.dll" "system" fn RegEnumValueA(hkey : HKEY, dwindex : u32, lpvaluename : windows_core::PSTR, lpcchvaluename : *mut u32, lpreserved : *const u32, lptype : *mut u32, lpdata : *mut u8, lpcbdata : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegEnumValueA(
            hkey,
            dwindex,
            lpvaluename.unwrap_or(core::mem::zeroed()) as _,
            lpcchvaluename as _,
            lpreserved.unwrap_or(core::mem::zeroed()) as _,
            lptype.unwrap_or(core::mem::zeroed()) as _,
            lpdata.unwrap_or(core::mem::zeroed()) as _,
            lpcbdata.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn RegEnumValueW(
    hkey: HKEY,
    dwindex: u32,
    lpvaluename: Option<windows_core::PWSTR>,
    lpcchvaluename: *mut u32,
    lpreserved: Option<*const u32>,
    lptype: Option<*mut u32>,
    lpdata: Option<*mut u8>,
    ...
    windows_link::link!("advapi32.dll" "system" fn RegEnumValueW(hkey : HKEY, dwindex : u32, lpvaluename : windows_core::PWSTR, lpcchvaluename : *mut u32, lpreserved : *const u32, lptype : *mut u32, lpdata : *mut u8, lpcbdata : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegEnumValueW(
            hkey,
            dwindex,
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn RegGetKeySecurity(
    hkey: HKEY,
    ...
    unsafe {
        RegGetKeySecurity(
            ...
            lpcbsecuritydescriptor as _,
        )
    }
}
#[inline]
pub unsafe fn RegGetValueA<P1, P2>(
    hkey: HKEY,
    lpsubkey: P1,
    lpvalue: P2,
...
where
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegGetValueA(hkey : HKEY, lpsubkey : windows_core::PCSTR, lpvalue : windows_core::PCSTR, dwflags : REG_ROUTINE_FLAGS, pdwtype : *mut REG_VALUE_TYPE, pvdata : *mut core::ffi::c_void, pcbdata : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegGetValueA(
            hkey,
            lpsubkey.param().abi(),
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegGetValueW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, lpvalue : windows_core::PCWSTR, dwflags : REG_ROUTINE_FLAGS, pdwtype : *mut REG_VALUE_TYPE, pvdata : *mut core::ffi::c_void, pcbdata : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegGetValueW(
            hkey,
            lpsubkey.param().abi(),
...
#[inline]
pub unsafe fn RegLoadAppKeyA<P0>(
    lpfile: P0,
    phkresult: *mut HKEY,
    samdesired: u32,
    dwoptions: u32,
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegLoadAppKeyA(lpfile : windows_core::PCSTR, phkresult : *mut HKEY, samdesired : u32, dwoptions : u32, reserved : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegLoadAppKeyA(
            lpfile.param().abi(),
            phkresult as _,
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegLoadAppKeyW(lpfile : windows_core::PCWSTR, phkresult : *mut HKEY, samdesired : u32, dwoptions : u32, reserved : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegLoadAppKeyW(
            lpfile.param().abi(),
            phkresult as _,
...
where
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegLoadKeyA(hkey : HKEY, lpsubkey : windows_core::PCSTR, lpfile : windows_core::PCSTR) -> super::super::Foundation:: WIN32_ERROR);
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegLoadKeyW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, lpfile : windows_core::PCWSTR) -> super::super::Foundation:: WIN32_ERROR);
...
{
    windows_link::link!("advapi32.dll" "system" fn RegLoadMUIStringA(hkey : HKEY, pszvalue : windows_core::PCSTR, pszoutbuf : windows_core::PSTR, cboutbuf : u32, pcbdata : *mut u32, flags : u32, pszdirectory : windows_core::PCSTR) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegLoadMUIStringA(
            hkey,
            pszvalue.param().abi(),
...
pub unsafe fn RegLoadMUIStringW<P1, P6>(
    hkey: HKEY,
    pszvalue: P1,
    pszoutbuf: Option<windows_core::PWSTR>,
    cboutbuf: u32,
    pcbdata: Option<*mut u32>,
    flags: u32,
    pszdirectory: P6,
...
{
    windows_link::link!("advapi32.dll" "system" fn RegLoadMUIStringW(hkey : HKEY, pszvalue : windows_core::PCWSTR, pszoutbuf : windows_core::PWSTR, cboutbuf : u32, pcbdata : *mut u32, flags : u32, pszdirectory : windows_core::PCWSTR) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegLoadMUIStringW(
            hkey,
            pszvalue.param().abi(),
            pszoutbuf.unwrap_or(core::mem::zeroed()) as _,
            cboutbuf,
            pcbdata.unwrap_or(core::mem::zeroed()) as _,
            flags,
            pszdirectory.param().abi(),
...
pub unsafe fn RegNotifyChangeKeyValue(
    ...
    hevent: Option<super::super::Foundation::HANDLE>,
    fasynchronous: bool,
) -> super::super::Foundation::WIN32_ERROR {
    windows_link::link!("advapi32.dll" "system" fn RegNotifyChangeKeyValue(hkey : HKEY, bwatchsubtree : windows_core::BOOL, dwnotifyfilter : REG_NOTIFY_FILTER, hevent : super::super::Foundation:: HANDLE, fasynchronous : windows_core::BOOL) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegOpenKeyA(hkey : HKEY, lpsubkey : windows_core::PCSTR, phkresult : *mut HKEY) -> super::super::Foundation:: WIN32_ERROR);
    unsafe { RegOpenKeyA(hkey, lpsubkey.param().abi(), phkresult as _) }
}
#[inline]
pub unsafe fn RegOpenKeyExA<P1>(
    hkey: HKEY,
    lpsubkey: P1,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegOpenKeyExA(hkey : HKEY, lpsubkey : windows_core::PCSTR, uloptions : u32, samdesired : REG_SAM_FLAGS, phkresult : *mut HKEY) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegOpenKeyExA(
            hkey,
            lpsubkey.param().abi(),
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegOpenKeyExW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, uloptions : u32, samdesired : REG_SAM_FLAGS, phkresult : *mut HKEY) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegOpenKeyExW(
            hkey,
            lpsubkey.param().abi(),
...
#[inline]
pub unsafe fn RegOpenKeyTransactedA<P1>(
    hkey: HKEY,
    lpsubkey: P1,
    uloptions: Option<u32>,
    samdesired: REG_SAM_FLAGS,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegOpenKeyTransactedA(hkey : HKEY, lpsubkey : windows_core::PCSTR, uloptions : u32, samdesired : REG_SAM_FLAGS, phkresult : *mut HKEY, htransaction : super::super::Foundation:: HANDLE, pextendedparemeter : *const core::ffi::c_void) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegOpenKeyTransactedW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, uloptions : u32, samdesired : REG_SAM_FLAGS, phkresult : *mut HKEY, htransaction : super::super::Foundation:: HANDLE, pextendedparemeter : *const core::ffi::c_void) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegOpenKeyW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, phkresult : *mut HKEY) -> super::super::Foundation:: WIN32_ERROR);
...
pub unsafe fn RegOpenUserClassesRoot(
    ...
    unsafe {
        RegOpenUserClassesRoot(
            htoken,
            dwoptions.unwrap_or(core::mem::zeroed()) as _,
            samdesired,
            phkresult as _,
        )
    }
...
#[inline]
pub unsafe fn RegQueryInfoKeyA(
    hkey: HKEY,
    lpclass: Option<windows_core::PSTR>,
    lpcchclass: Option<*mut u32>,
    lpreserved: Option<*const u32>,
...
#[inline]
pub unsafe fn RegQueryInfoKeyW(
    hkey: HKEY,
    lpclass: Option<windows_core::PWSTR>,
    lpcchclass: Option<*mut u32>,
    lpreserved: Option<*const u32>,
    ...
    windows_link::link!("advapi32.dll" "system" fn RegQueryInfoKeyW(hkey : HKEY, lpclass : windows_core::PWSTR, lpcchclass : *mut u32, lpreserved : *const u32, lpcsubkeys : *mut u32, lpcbmaxsubkeylen : *mut u32, lpcbmaxclasslen : *mut u32, lpcvalues : *mut u32, lpcbmaxvaluenamelen : *mut u32, lpcbmaxvaluelen : *mut u32, lpcbsecuritydescriptor : *mut u32, lpftlastwritetime : *mut super::super::Foundation:: FILETIME) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegQueryInfoKeyW(
            hkey,
            lpclass.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn RegQueryMultipleValuesA(
    hkey: HKEY,
    val_list: &mut [VALENTA],
    lpvaluebuf: Option<windows_core::PSTR>,
    ldwtotsize: Option<*mut u32>,
) -> super::super::Foundation::WIN32_ERROR {
    windows_link::link!("advapi32.dll" "system" fn RegQueryMultipleValuesA(hkey : HKEY, val_list : *mut VALENTA, num_vals : u32, lpvaluebuf : windows_core::PSTR, ldwtotsize : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegQueryMultipleValuesA(
            hkey,
            core::mem::transmute(val_list.as_ptr()),
            val_list.len().try_into().unwrap(),
            lpvaluebuf.unwrap_or(core::mem::zeroed()) as _,
            ldwtotsize.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn RegQueryMultipleValuesW(
    ...
    windows_link::link!("advapi32.dll" "system" fn RegQueryMultipleValuesW(hkey : HKEY, val_list : *mut VALENTW, num_vals : u32, lpvaluebuf : windows_core::PWSTR, ldwtotsize : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
...
#[inline]
pub unsafe fn RegQueryReflectionKey(
    hbase: HKEY,
    bisreflectiondisabled: *mut windows_core::BOOL,
) -> super::super::Foundation::WIN32_ERROR {
    windows_link::link!("advapi32.dll" "system" fn RegQueryReflectionKey(hbase : HKEY, bisreflectiondisabled : *mut windows_core::BOOL) -> super::super::Foundation:: WIN32_ERROR);
...
pub unsafe fn RegQueryValueA<P1>(
    hkey: HKEY,
    lpsubkey: P1,
    lpdata: Option<windows_core::PSTR>,
    lpcbdata: Option<*mut i32>,
) -> super::super::Foundation::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegQueryValueA(hkey : HKEY, lpsubkey : windows_core::PCSTR, lpdata : windows_core::PSTR, lpcbdata : *mut i32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegQueryValueA(
            hkey,
            lpsubkey.param().abi(),
...
#[inline]
pub unsafe fn RegQueryValueExA<P1>(
    hkey: HKEY,
    lpvaluename: P1,
    lpreserved: Option<*const u32>,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegQueryValueExA(hkey : HKEY, lpvaluename : windows_core::PCSTR, lpreserved : *const u32, lptype : *mut REG_VALUE_TYPE, lpdata : *mut u8, lpcbdata : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegQueryValueExA(
            hkey,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegQueryValueExW(hkey : HKEY, lpvaluename : windows_core::PCWSTR, lpreserved : *const u32, lptype : *mut REG_VALUE_TYPE, lpdata : *mut u8, lpcbdata : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegQueryValueExW(
            hkey,
            lpvaluename.param().abi(),
...
pub unsafe fn RegQueryValueW<P1>(
    hkey: HKEY,
    lpsubkey: P1,
    lpdata: Option<windows_core::PWSTR>,
    lpcbdata: Option<*mut i32>,
) -> super::super::Foundation::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegQueryValueW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, lpdata : windows_core::PWSTR, lpcbdata : *mut i32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegQueryValueW(
            hkey,
            lpsubkey.param().abi(),
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegRenameKey(hkey : HKEY, lpsubkeyname : windows_core::PCWSTR, lpnewkeyname : windows_core::PCWSTR) -> super::super::Foundation:: WIN32_ERROR);
...
where
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegReplaceKeyA(hkey : HKEY, lpsubkey : windows_core::PCSTR, lpnewfile : windows_core::PCSTR, lpoldfile : windows_core::PCSTR) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegReplaceKeyA(
            hkey,
            lpsubkey.param().abi(),
...
where
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegReplaceKeyW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, lpnewfile : windows_core::PCWSTR, lpoldfile : windows_core::PCWSTR) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegReplaceKeyW(
            hkey,
            lpsubkey.param().abi(),
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegRestoreKeyA(hkey : HKEY, lpfile : windows_core::PCSTR, dwflags : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe { RegRestoreKeyA(hkey, lpfile.param().abi(), dwflags.0 as _) }
}
#[inline]
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegRestoreKeyW(hkey : HKEY, lpfile : windows_core::PCWSTR, dwflags : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe { RegRestoreKeyW(hkey, lpfile.param().abi(), dwflags.0 as _) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegSaveKeyA(hkey : HKEY, lpfile : windows_core::PCSTR, lpsecurityattributes : *const super::super::Security:: SECURITY_ATTRIBUTES) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegSaveKeyA(
            hkey,
            lpfile.param().abi(),
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegSaveKeyExA(hkey : HKEY, lpfile : windows_core::PCSTR, lpsecurityattributes : *const super::super::Security:: SECURITY_ATTRIBUTES, flags : REG_SAVE_FORMAT) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegSaveKeyExA(
            hkey,
            lpfile.param().abi(),
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn RegSaveKeyExW<P1>(
    hkey: HKEY,
    lpfile: P1,
    lpsecurityattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
    flags: REG_SAVE_FORMAT,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegSaveKeyExW(hkey : HKEY, lpfile : windows_core::PCWSTR, lpsecurityattributes : *const super::super::Security:: SECURITY_ATTRIBUTES, flags : REG_SAVE_FORMAT) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegSaveKeyExW(
            hkey,
            lpfile.param().abi(),
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegSaveKeyW(hkey : HKEY, lpfile : windows_core::PCWSTR, lpsecurityattributes : *const super::super::Security:: SECURITY_ATTRIBUTES) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegSaveKeyW(
            hkey,
            lpfile.param().abi(),
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn RegSetKeySecurity(
    hkey: HKEY,
    securityinformation: super::super::Security::OBJECT_SECURITY_INFORMATION,
...
#[inline]
pub unsafe fn RegSetKeyValueA<P1, P2>(
    hkey: HKEY,
    lpsubkey: P1,
    lpvaluename: P2,
    dwtype: u32,
...
where
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegSetKeyValueA(hkey : HKEY, lpsubkey : windows_core::PCSTR, lpvaluename : windows_core::PCSTR, dwtype : u32, lpdata : *const core::ffi::c_void, cbdata : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegSetKeyValueA(
            hkey,
            lpsubkey.param().abi(),
...
#[inline]
pub unsafe fn RegSetKeyValueW<P1, P2>(
    hkey: HKEY,
    lpsubkey: P1,
    lpvaluename: P2,
    dwtype: u32,
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegSetKeyValueW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, lpvaluename : windows_core::PCWSTR, dwtype : u32, lpdata : *const core::ffi::c_void, cbdata : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegSetKeyValueW(
            hkey,
            lpsubkey.param().abi(),
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegSetValueA(hkey : HKEY, lpsubkey : windows_core::PCSTR, dwtype : REG_VALUE_TYPE, lpdata : windows_core::PCSTR, cbdata : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegSetValueA(
            hkey,
            lpsubkey.param().abi(),
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegSetValueExA(hkey : HKEY, lpvaluename : windows_core::PCSTR, reserved : u32, dwtype : REG_VALUE_TYPE, lpdata : *const u8, cbdata : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegSetValueExA(
            hkey,
            lpvaluename.param().abi(),
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegSetValueExW(hkey : HKEY, lpvaluename : windows_core::PCWSTR, reserved : u32, dwtype : REG_VALUE_TYPE, lpdata : *const u8, cbdata : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegSetValueExW(
            hkey,
            lpvaluename.param().abi(),
...
where
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegSetValueW(hkey : HKEY, lpsubkey : windows_core::PCWSTR, dwtype : REG_VALUE_TYPE, lpdata : windows_core::PCWSTR, cbdata : u32) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
        RegSetValueW(
            hkey,
            lpsubkey.param().abi(),
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegUnLoadKeyA(hkey : HKEY, lpsubkey : windows_core::PCSTR) -> super::super::Foundation:: WIN32_ERROR);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn RegUnLoadKeyW(hkey : HKEY, lpsubkey : windows_core::PCWSTR) -> super::super::Foundation:: WIN32_ERROR);
...
impl windows_core::Free for HKEY {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("advapi32.dll" "system" fn RegCloseKey(hkey : *mut core::ffi::c_void) -> u32);
            unsafe {
                RegCloseKey(self.0);
            }
        }
...
pub const REGSTR_KEY_EBDAUTOEXECBATKEYBOARD: windows_core::PCWSTR =
    windows_core::w!("EBDAutoexecBatKeyboard");
pub const REGSTR_KEY_EBDAUTOEXECBATLOCAL: windows_core::PCWSTR =
    windows_core::w!("EBDAutoexecBatLocale");
pub const REGSTR_KEY_EBDCONFIGSYSKEYBOARD: windows_core::PCWSTR =
    windows_core::w!("EBDConfigSysKeyboard");
pub const REGSTR_KEY_EBDCONFIGSYSLOCAL: windows_core::PCWSTR =
    windows_core::w!("EBDConfigSysLocale");
...
pub const REGSTR_KEY_KNOWNDOCKINGSTATES: windows_core::PCWSTR =
    windows_core::w!("Hardware Profiles");
...
pub const REGSTR_KEY_POL_USERGROUPDATA: windows_core::PCWSTR =
    windows_core::w!("GroupData\\UserGroups\\Priority");
...
pub const REGSTR_KEY_SHARES: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Network\\LanMan");
...
pub const REGSTR_MACHTYPE_PHOENIX_PCAT: windows_core::PCWSTR =
    windows_core::w!("Phoenix PC/AT Compatible");
...
pub const REGSTR_PATH_ADDRARB: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\Arbitrators\\AddrArb");
pub const REGSTR_PATH_AEDEBUG: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows NT\\CurrentVersion\\AeDebug");
pub const REGSTR_PATH_APPEARANCE: windows_core::PCWSTR =
    windows_core::w!("Control Panel\\Appearance");
pub const REGSTR_PATH_APPPATCH: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\SessionManager\\AppPatches");
pub const REGSTR_PATH_APPPATHS: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\App Paths");
pub const REGSTR_PATH_BIOSINFO: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\BiosInfo");
pub const REGSTR_PATH_BUSINFORMATION: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\PnP\\BusInformation");
pub const REGSTR_PATH_CDFS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\FileSystem\\CDFS");
pub const REGSTR_PATH_CHECKBADAPPS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\SessionManager\\CheckBadApps");
pub const REGSTR_PATH_CHECKBADAPPS400: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\SessionManager\\CheckBadApps400");
pub const REGSTR_PATH_CHECKDISK: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Applets\\Check Drive");
...
pub const REGSTR_PATH_CHECKVERDLLS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\SessionManager\\CheckVerDLLs");
pub const REGSTR_PATH_CHILD_PREFIX: windows_core::PCWSTR = windows_core::w!("Child");
pub const REGSTR_PATH_CHKLASTCHECK: windows_core::PCWSTR = windows_core::w!(
    "Software\\Microsoft\\Windows\\CurrentVersion\\Applets\\Check Drive\\LastCheck"
);
pub const REGSTR_PATH_CHKLASTSURFAN: windows_core::PCWSTR = windows_core::w!(
    "Software\\Microsoft\\Windows\\CurrentVersion\\Applets\\Check Drive\\LastSurfaceAnalysis"
);
pub const REGSTR_PATH_CLASS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\Class");
pub const REGSTR_PATH_CLASS_NT: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\Class");
pub const REGSTR_PATH_CODEPAGE: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\Nls\\Codepage");
pub const REGSTR_PATH_CODEVICEINSTALLERS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\CoDeviceInstallers");
pub const REGSTR_PATH_COLORS: windows_core::PCWSTR = windows_core::w!("Control Panel\\Colors");
pub const REGSTR_PATH_COMPUTRNAME: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\ComputerName\\ComputerName");
pub const REGSTR_PATH_CONTROLPANEL: windows_core::PCWSTR = windows_core::w!("Control Panel");
pub const REGSTR_PATH_CONTROLSFOLDER: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Controls Folder");
pub const REGSTR_PATH_CRITICALDEVICEDATABASE: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\CriticalDeviceDatabase");
pub const REGSTR_PATH_CURRENTCONTROLSET: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet");
pub const REGSTR_PATH_CURRENT_CONTROL_SET: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control");
pub const REGSTR_PATH_CURSORS: windows_core::PCWSTR = windows_core::w!("Control Panel\\Cursors");
pub const REGSTR_PATH_CVNETWORK: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Network");
pub const REGSTR_PATH_DESKTOP: windows_core::PCWSTR = windows_core::w!("Control Panel\\Desktop");
pub const REGSTR_PATH_DETECT: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Detect");
pub const REGSTR_PATH_DEVICEINSTALLER: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Device Installer");
pub const REGSTR_PATH_DEVICE_CLASSES: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\DeviceClasses");
pub const REGSTR_PATH_DIFX: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\DIFX");
pub const REGSTR_PATH_DISPLAYSETTINGS: windows_core::PCWSTR = windows_core::w!("Display\\Settings");
pub const REGSTR_PATH_DMAARB: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\Arbitrators\\DMAArb");
pub const REGSTR_PATH_DRIVERSIGN: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Driver Signing");
pub const REGSTR_PATH_DRIVERSIGN_POLICY: windows_core::PCWSTR =
    windows_core::w!("Software\\Policies\\Microsoft\\Windows NT\\Driver Signing");
pub const REGSTR_PATH_ENUM: windows_core::PCWSTR = windows_core::w!("Enum");
pub const REGSTR_PATH_ENVIRONMENTS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\Print\\Environments");
pub const REGSTR_PATH_EVENTLABELS: windows_core::PCWSTR =
    windows_core::w!("AppEvents\\EventLabels");
pub const REGSTR_PATH_EXPLORER: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Explorer");
pub const REGSTR_PATH_FAULT: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Fault");
pub const REGSTR_PATH_FILESYSTEM: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\FileSystem");
pub const REGSTR_PATH_FILESYSTEM_NOVOLTRACK: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\FileSystem\\NoVolTrack");
pub const REGSTR_PATH_FLOATINGPOINTPROCESSOR: windows_core::PCWSTR =
    windows_core::w!("HARDWARE\\DESCRIPTION\\System\\FloatingPointProcessor");
pub const REGSTR_PATH_FLOATINGPOINTPROCESSOR0: windows_core::PCWSTR =
    windows_core::w!("HARDWARE\\DESCRIPTION\\System\\FloatingPointProcessor\\0");
pub const REGSTR_PATH_FONTS: windows_core::PCWSTR = windows_core::w!("Display\\Fonts");
pub const REGSTR_PATH_GRPCONV: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\GrpConv");
pub const REGSTR_PATH_HACKINIFILE: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\SessionManager\\HackIniFiles");
pub const REGSTR_PATH_HWPROFILES: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Hardware Profiles");
pub const REGSTR_PATH_HWPROFILESCURRENT: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Hardware Profiles\\Current");
pub const REGSTR_PATH_ICONS: windows_core::PCWSTR = windows_core::w!("Control Panel\\Icons");
pub const REGSTR_PATH_IDCONFIGDB: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\IDConfigDB");
pub const REGSTR_PATH_INSTALLEDFILES: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\InstalledFiles");
pub const REGSTR_PATH_IOARB: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\Arbitrators\\IOArb");
pub const REGSTR_PATH_IOS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\VxD\\IOS");
pub const REGSTR_PATH_IRQARB: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\Arbitrators\\IRQArb");
pub const REGSTR_PATH_KEYBOARD: windows_core::PCWSTR = windows_core::w!("Control Panel\\Keyboard");
pub const REGSTR_PATH_KNOWN16DLLS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\SessionManager\\Known16DLLs");
pub const REGSTR_PATH_KNOWNDLLS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\SessionManager\\KnownDLLs");
pub const REGSTR_PATH_KNOWNVXDS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\SessionManager\\KnownVxDs");
pub const REGSTR_PATH_LASTBACKUP: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\LastBackup");
pub const REGSTR_PATH_LASTCHECK: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\LastCheck");
pub const REGSTR_PATH_LASTGOOD: windows_core::PCWSTR =
    windows_core::w!("System\\LastKnownGoodRecovery\\LastGood");
pub const REGSTR_PATH_LASTGOODTMP: windows_core::PCWSTR =
    windows_core::w!("System\\LastKnownGoodRecovery\\LastGood.Tmp");
pub const REGSTR_PATH_LASTOPTIMIZE: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\LastOptimize");
pub const REGSTR_PATH_LOOKSCHEMES: windows_core::PCWSTR =
    windows_core::w!("Control Panel\\Appearance\\Schemes");
pub const REGSTR_PATH_METRICS: windows_core::PCWSTR =
    windows_core::w!("Control Panel\\Desktop\\WindowMetrics");
pub const REGSTR_PATH_MONITORS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\Print\\Monitors");
pub const REGSTR_PATH_MOUSE: windows_core::PCWSTR = windows_core::w!("Control Panel\\Mouse");
pub const REGSTR_PATH_MSDOSOPTS: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\MS-DOSOptions");
pub const REGSTR_PATH_MULTIMEDIA_AUDIO: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Multimedia\\Audio");
pub const REGSTR_PATH_MULTI_FUNCTION: windows_core::PCWSTR = windows_core::w!("MF");
pub const REGSTR_PATH_NCPSERVER: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\NcpServer\\Parameters");
pub const REGSTR_PATH_NETEQUIV: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Network\\Equivalent");
pub const REGSTR_PATH_NETWORK_USERSETTINGS: windows_core::PCWSTR = windows_core::w!("Network");
pub const REGSTR_PATH_NEWDOSBOX: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\MS-DOSSpecialConfig");
pub const REGSTR_PATH_NONDRIVERSIGN: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Non-Driver Signing");
pub const REGSTR_PATH_NONDRIVERSIGN_POLICY: windows_core::PCWSTR =
    windows_core::w!("Software\\Policies\\Microsoft\\Windows NT\\Non-Driver Signing");
pub const REGSTR_PATH_NOSUGGMSDOS: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\NoMSDOSWarn");
pub const REGSTR_PATH_NT_CURRENTVERSION: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows NT\\CurrentVersion");
pub const REGSTR_PATH_NWREDIR: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\VxD\\NWREDIR");
pub const REGSTR_PATH_PCIIR: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\Pnp\\PciIrqRouting");
pub const REGSTR_PATH_PER_HW_ID_STORAGE: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows NT\\CurrentVersion\\PerHwIdStorage");
pub const REGSTR_PATH_PIFCONVERT: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\PIFConvert");
pub const REGSTR_PATH_POLICIES: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Policies");
pub const REGSTR_PATH_PRINT: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\Print");
pub const REGSTR_PATH_PRINTERS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\Print\\Printers");
pub const REGSTR_PATH_PROPERTYSYSTEM: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\PropertySystem");
pub const REGSTR_PATH_PROVIDERS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\Print\\Providers");
pub const REGSTR_PATH_PWDPROVIDER: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\PwdProvider");
pub const REGSTR_PATH_REALMODENET: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Network\\Real Mode Net");
pub const REGSTR_PATH_REINSTALL: windows_core::PCWSTR =
    windows_core::w!("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Reinstall");
pub const REGSTR_PATH_RELIABILITY: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Reliability");
pub const REGSTR_PATH_RELIABILITY_POLICY: windows_core::PCWSTR =
    windows_core::w!("Software\\Policies\\Microsoft\\Windows NT\\Reliability");
pub const REGSTR_PATH_RELIABILITY_POLICY_REPORTSNAPSHOT: windows_core::PCWSTR =
    windows_core::w!("ReportSnapshot");
pub const REGSTR_PATH_RELIABILITY_POLICY_SHUTDOWNREASONUI: windows_core::PCWSTR =
    windows_core::w!("ShutdownReasonUI");
pub const REGSTR_PATH_RELIABILITY_POLICY_SNAPSHOT: windows_core::PCWSTR =
    windows_core::w!("Snapshot");
pub const REGSTR_PATH_ROOT: windows_core::PCWSTR = windows_core::w!("Enum\\Root");
pub const REGSTR_PATH_RUN: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Run");
pub const REGSTR_PATH_RUNONCE: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\RunOnce");
pub const REGSTR_PATH_RUNONCEEX: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\RunOnceEx");
pub const REGSTR_PATH_RUNSERVICES: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\RunServices");
pub const REGSTR_PATH_RUNSERVICESONCE: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\RunServicesOnce");
...
pub const REGSTR_PATH_SERVICES: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services");
pub const REGSTR_PATH_SETUP: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion");
pub const REGSTR_PATH_SHUTDOWN: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\Shutdown");
pub const REGSTR_PATH_SOUND: windows_core::PCWSTR = windows_core::w!("Control Panel\\Sound");
pub const REGSTR_PATH_SYSTEMENUM: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Enum");
pub const REGSTR_PATH_SYSTRAY: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Applets\\SysTray");
pub const REGSTR_PATH_TIMEZONE: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\TimeZoneInformation");
pub const REGSTR_PATH_UNINSTALL: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall");
pub const REGSTR_PATH_UPDATE: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\Update");
pub const REGSTR_PATH_VCOMM: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\VxD\\VCOMM");
pub const REGSTR_PATH_VMM: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\VxD\\VMM");
pub const REGSTR_PATH_VMM32FILES: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\VMM32Files");
pub const REGSTR_PATH_VNETSUP: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\VxD\\VNETSUP");
pub const REGSTR_PATH_VOLUMECACHE: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\VolumeCaches");
pub const REGSTR_PATH_VPOWERD: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\VxD\\VPOWERD");
pub const REGSTR_PATH_VXD: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Services\\VxD");
pub const REGSTR_PATH_WARNVERDLLS: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\SessionManager\\WarnVerDLLs");
pub const REGSTR_PATH_WINBOOT: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\WinBoot");
pub const REGSTR_PATH_WINDOWSAPPLETS: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Applets");
pub const REGSTR_PATH_WINLOGON: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\Winlogon");
pub const REGSTR_PATH_WMI_SECURITY: windows_core::PCWSTR =
    windows_core::w!("System\\CurrentControlSet\\Control\\Wmi\\Security");
...
pub const REGSTR_VALUE_LOWPOWERACTIVE: windows_core::PCWSTR =
    windows_core::w!("ScreenSaveLowPowerActive");
pub const REGSTR_VALUE_LOWPOWERTIMEOUT: windows_core::PCWSTR =
    windows_core::w!("ScreenSaveLowPowerTimeout");
pub const REGSTR_VALUE_NETPATH: windows_core::PCWSTR = windows_core::w!("NetworkPath");
pub const REGSTR_VALUE_POWEROFFACTIVE: windows_core::PCWSTR =
    windows_core::w!("ScreenSavePowerOffActive");
pub const REGSTR_VALUE_POWEROFFTIMEOUT: windows_core::PCWSTR =
    windows_core::w!("ScreenSavePowerOffTimeout");
pub const REGSTR_VALUE_SCRPASSWORD: windows_core::PCWSTR = windows_core::w!("ScreenSave_Data");
pub const REGSTR_VALUE_USESCRPASSWORD: windows_core::PCWSTR =
    windows_core::w!("ScreenSaveUsePassword");
...
pub const REGSTR_VAL_ACSPINDOWNPREVIOUS: windows_core::PCWSTR =
    windows_core::w!("ACSpinDownPrevious");
...
pub const REGSTR_VAL_BASICPROPERTIES_32: windows_core::PCWSTR =
    windows_core::w!("BasicProperties32");
pub const REGSTR_VAL_BATDRIVESPINDOWN: windows_core::PCWSTR = windows_core::w!("BatDriveSpinDown");
pub const REGSTR_VAL_BATSPINDOWNPREVIOUS: windows_core::PCWSTR =
    windows_core::w!("BatSpinDownPrevious");
pub const REGSTR_VAL_BEHAVIOR_ON_FAILED_VERIFY: windows_core::PCWSTR =
    windows_core::w!("BehaviorOnFailedVerify");
...
pub const REGSTR_VAL_COMPRESSIONMETHOD: windows_core::PCWSTR =
    windows_core::w!("CompressionAlgorithm");
pub const REGSTR_VAL_COMPRESSIONTHRESHOLD: windows_core::PCWSTR =
    windows_core::w!("CompressionThreshold");
...
pub const REGSTR_VAL_CONTIGFILEALLOC: windows_core::PCWSTR =
    windows_core::w!("ContigFileAllocSize");
...
pub const REGSTR_VAL_CURDRVLET: windows_core::PCWSTR =
    windows_core::w!("CurrentDriveLetterAssignment");
...
pub const REGSTR_VAL_CUSTOM_PROPERTY_CACHE_DATE: windows_core::PCWSTR =
    windows_core::w!("CustomPropertyCacheDate");
pub const REGSTR_VAL_CUSTOM_PROPERTY_HW_ID_KEY: windows_core::PCWSTR =
    windows_core::w!("CustomPropertyHwIdKey");
...
pub const REGSTR_VAL_DEVICE_CHARACTERISTICS: windows_core::PCWSTR =
    windows_core::w!("DeviceCharacteristics");
...
pub const REGSTR_VAL_DEVICE_SECURITY_DESCRIPTOR: windows_core::PCWSTR =
    windows_core::w!("Security");
...
pub const REGSTR_VAL_DIRTYSHUTDOWNTIME: windows_core::PCWSTR =
    windows_core::w!("DirtyShutdownTime");
pub const REGSTR_VAL_DISABLECOUNT: windows_core::PCWSTR = windows_core::w!("DisableCount");
pub const REGSTR_VAL_DISABLEPWDCACHING: windows_core::PCWSTR =
    windows_core::w!("DisablePwdCaching");
pub const REGSTR_VAL_DISABLEREGTOOLS: windows_core::PCWSTR =
    windows_core::w!("DisableRegistryTools");
...
pub const REGSTR_VAL_DISPCPL_NOAPPEARANCEPAGE: windows_core::PCWSTR =
    windows_core::w!("NoDispAppearancePage");
pub const REGSTR_VAL_DISPCPL_NOBACKGROUNDPAGE: windows_core::PCWSTR =
    windows_core::w!("NoDispBackgroundPage");
pub const REGSTR_VAL_DISPCPL_NODISPCPL: windows_core::PCWSTR = windows_core::w!("NoDispCPL");
pub const REGSTR_VAL_DISPCPL_NOSCRSAVPAGE: windows_core::PCWSTR =
    windows_core::w!("NoDispScrSavPage");
pub const REGSTR_VAL_DISPCPL_NOSETTINGSPAGE: windows_core::PCWSTR =
    windows_core::w!("NoDispSettingsPage");
...
pub const REGSTR_VAL_DONTLOADIFCONFLICT: windows_core::PCWSTR =
    windows_core::w!("DontLoadIfConflict");
...
pub const REGSTR_VAL_EISA_FUNCTIONS_MASK: windows_core::PCWSTR =
    windows_core::w!("EISAFunctionsMask");
pub const REGSTR_VAL_EISA_RANGES: windows_core::PCWSTR = windows_core::w!("EISARanges");
pub const REGSTR_VAL_EISA_SIMULATE_INT15: windows_core::PCWSTR =
    windows_core::w!("EISASimulateInt15");
...
pub const REGSTR_VAL_FIRSTINSTALLDATETIME: windows_core::PCWSTR =
    windows_core::w!("FirstInstallDateTime");
...
pub const REGSTR_VAL_IDE_FORCE_SERIALIZE: windows_core::PCWSTR =
    windows_core::w!("ForceSerialization");
...
pub const REGSTR_VAL_JOYNOEMCALLOUT: windows_core::PCWSTR =
    windows_core::w!("Joystick%dOEMCallout");
...
pub const REGSTR_VAL_JOYOEMTESTBUTTONCAP: windows_core::PCWSTR =
    windows_core::w!("OEMTestButtonCap");
pub const REGSTR_VAL_JOYOEMTESTBUTTONDESC: windows_core::PCWSTR =
    windows_core::w!("OEMTestButtonDesc");
...
pub const REGSTR_VAL_LASTALIVEINTERVAL: windows_core::PCWSTR =
    windows_core::w!("TimeStampInterval");
pub const REGSTR_VAL_LASTALIVEPMPOLICY: windows_core::PCWSTR =
    windows_core::w!("LastAlivePMPolicy");
pub const REGSTR_VAL_LASTALIVESTAMP: windows_core::PCWSTR = windows_core::w!("LastAliveStamp");
pub const REGSTR_VAL_LASTALIVESTAMPFORCED: windows_core::PCWSTR =
    windows_core::w!("LastAliveStampForced");
pub const REGSTR_VAL_LASTALIVESTAMPINTERVAL: windows_core::PCWSTR =
    windows_core::w!("LastAliveStampInterval");
pub const REGSTR_VAL_LASTALIVESTAMPPOLICYINTERVAL: windows_core::PCWSTR =
    windows_core::w!("LastAliveStampPolicyInterval");
...
pub const REGSTR_VAL_LEGALNOTICECAPTION: windows_core::PCWSTR =
    windows_core::w!("LegalNoticeCaption");
...
pub const REGSTR_VAL_LOCATION_INFORMATION: windows_core::PCWSTR =
    windows_core::w!("LocationInformation");
pub const REGSTR_VAL_LOCATION_INFORMATION_OVERRIDE: windows_core::PCWSTR =
    windows_core::w!("LocationInformationOverride");
pub const REGSTR_VAL_LOWERFILTERS: windows_core::PCWSTR = windows_core::w!("LowerFilters");
pub const REGSTR_VAL_LOWER_FILTER_DEFAULT_LEVEL: windows_core::PCWSTR =
    windows_core::w!("LowerFilterDefaultLevel");
pub const REGSTR_VAL_LOWER_FILTER_LEVELS: windows_core::PCWSTR =
    windows_core::w!("LowerFilterLevels");
...
pub const REGSTR_VAL_NCP_USEPEERBROWSING: windows_core::PCWSTR =
    windows_core::w!("Use_PeerBrowsing");
...
pub const REGSTR_VAL_NETSETUP_NOCONFIGPAGE: windows_core::PCWSTR =
    windows_core::w!("NoNetSetupConfigPage");
pub const REGSTR_VAL_NETSETUP_NOIDPAGE: windows_core::PCWSTR = windows_core::w!("NoNetSetupIDPage");
pub const REGSTR_VAL_NETSETUP_NOSECURITYPAGE: windows_core::PCWSTR =
    windows_core::w!("NoNetSetupSecurityPage");
...
pub const REGSTR_VAL_NOFILESHARINGCTRL: windows_core::PCWSTR =
    windows_core::w!("NoFileSharingControl");
...
pub const REGSTR_VAL_NOPRINTSHARINGCTRL: windows_core::PCWSTR =
    windows_core::w!("NoPrintSharingControl");
pub const REGSTR_VAL_NOUSECLASS: windows_core::PCWSTR = windows_core::w!("NoUseClass");
pub const REGSTR_VAL_NOWORKGROUPCONTENTS: windows_core::PCWSTR =
    windows_core::w!("NoWorkgroupContents");
...
pub const REGSTR_VAL_PHYSICALDEVICEOBJECT: windows_core::PCWSTR =
    windows_core::w!("PhysicalDeviceObject");
...
pub const REGSTR_VAL_PRESERVELONGNAMES: windows_core::PCWSTR =
    windows_core::w!("PreserveLongNames");
...
pub const REGSTR_VAL_PWDPROVIDER_CHANGEORDER: windows_core::PCWSTR =
    windows_core::w!("ChangeOrder");
pub const REGSTR_VAL_PWDPROVIDER_CHANGEPWD: windows_core::PCWSTR =
    windows_core::w!("ChangePassword");
pub const REGSTR_VAL_PWDPROVIDER_CHANGEPWDHWND: windows_core::PCWSTR =
    windows_core::w!("ChangePasswordHwnd");
pub const REGSTR_VAL_PWDPROVIDER_DESC: windows_core::PCWSTR = windows_core::w!("Description");
pub const REGSTR_VAL_PWDPROVIDER_GETPWDSTATUS: windows_core::PCWSTR =
    windows_core::w!("GetPasswordStatus");
...
pub const REGSTR_VAL_READAHEADTHRESHOLD: windows_core::PCWSTR =
    windows_core::w!("ReadAheadThreshold");
...
pub const REGSTR_VAL_REGITEMDELETEMESSAGE: windows_core::PCWSTR =
    windows_core::w!("Removal Message");
pub const REGSTR_VAL_REGORGANIZATION: windows_core::PCWSTR =
    windows_core::w!("RegisteredOrganization");
pub const REGSTR_VAL_REGOWNER: windows_core::PCWSTR = windows_core::w!("RegisteredOwner");
pub const REGSTR_VAL_REINSTALL_DEVICEINSTANCEIDS: windows_core::PCWSTR =
    windows_core::w!("DeviceInstanceIds");
...
pub const REGSTR_VAL_REMOVEROMOKAYFUNC: windows_core::PCWSTR =
    windows_core::w!("RemoveRomOkayFunc");
pub const REGSTR_VAL_RESERVED_DEVNODE: windows_core::PCWSTR =
    windows_core::w!("HTREE\\RESERVED\\0");
...
pub const REGSTR_VAL_RESOURCE_PICKER_EXCEPTIONS: windows_core::PCWSTR =
    windows_core::w!("ResourcePickerExceptions");
pub const REGSTR_VAL_RESOURCE_PICKER_TAGS: windows_core::PCWSTR =
    windows_core::w!("ResourcePickerTags");
...
pub const REGSTR_VAL_SHUTDOWNREASON_CODE: windows_core::PCWSTR =
    windows_core::w!("ShutdownReasonCode");
pub const REGSTR_VAL_SHUTDOWNREASON_COMMENT: windows_core::PCWSTR =
    windows_core::w!("ShutdownReasonComment");
pub const REGSTR_VAL_SHUTDOWNREASON_PROCESS: windows_core::PCWSTR =
    windows_core::w!("ShutdownReasonProcess");
pub const REGSTR_VAL_SHUTDOWNREASON_USERNAME: windows_core::PCWSTR =
    windows_core::w!("ShutdownReasonUserName");
pub const REGSTR_VAL_SHUTDOWN_FLAGS: windows_core::PCWSTR = windows_core::w!("ShutdownFlags");
pub const REGSTR_VAL_SHUTDOWN_IGNORE_PREDEFINED: windows_core::PCWSTR =
    windows_core::w!("ShutdownIgnorePredefinedReasons");
pub const REGSTR_VAL_SHUTDOWN_STATE_SNAPSHOT: windows_core::PCWSTR =
    windows_core::w!("ShutdownStateSnapshot");
...
pub const REGSTR_VAL_SRVNAMECACHECOUNT: windows_core::PCWSTR =
    windows_core::w!("ServerNameCacheMax");
pub const REGSTR_VAL_SRVNAMECACHENETPROV: windows_core::PCWSTR =
    windows_core::w!("ServerNameCacheNumNets");
...
pub const REGSTR_VAL_SUPPORTTUNNELLING: windows_core::PCWSTR =
    windows_core::w!("SupportTunnelling");
...
pub const REGSTR_VAL_SYSTEMCPL_NOCONFIGPAGE: windows_core::PCWSTR =
    windows_core::w!("NoConfigPage");
pub const REGSTR_VAL_SYSTEMCPL_NODEVMGRPAGE: windows_core::PCWSTR =
    windows_core::w!("NoDevMgrPage");
pub const REGSTR_VAL_SYSTEMCPL_NOFILESYSPAGE: windows_core::PCWSTR =
    windows_core::w!("NoFileSysPage");
pub const REGSTR_VAL_SYSTEMCPL_NOVIRTMEMPAGE: windows_core::PCWSTR =
    windows_core::w!("NoVirtMemPage");
...
pub const REGSTR_VAL_TZNOAUTOTIME: windows_core::PCWSTR =
    windows_core::w!("DisableAutoDaylightTimeSet");
...
pub const REGSTR_VAL_UI_NUMBER_DESC_FORMAT: windows_core::PCWSTR =
    windows_core::w!("UINumberDescFormat");
pub const REGSTR_VAL_UNDOCK_WITHOUT_LOGON: windows_core::PCWSTR =
    windows_core::w!("UndockWithoutLogon");
pub const REGSTR_VAL_UNINSTALLER_COMMANDLINE: windows_core::PCWSTR =
    windows_core::w!("UninstallString");
pub const REGSTR_VAL_UNINSTALLER_DISPLAYNAME: windows_core::PCWSTR =
    windows_core::w!("DisplayName");
...
pub const REGSTR_VAL_UPPER_FILTER_DEFAULT_LEVEL: windows_core::PCWSTR =
    windows_core::w!("UpperFilterDefaultLevel");
pub const REGSTR_VAL_UPPER_FILTER_LEVELS: windows_core::PCWSTR =
    windows_core::w!("UpperFilterLevels");
...
pub const REGSTR_VAL_USRDRVLET: windows_core::PCWSTR =
    windows_core::w!("UserDriveLetterAssignment");
...
pub const REGSTR_VAL_WAITFORUNDOCKFUNC: windows_core::PCWSTR =
    windows_core::w!("WaitForUndockFunc");
...
pub const REGSTR_VAL_WRKGRP_FORCEMAPPING: windows_core::PCWSTR =
    windows_core::w!("WrkgrpForceMapping");

    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        GetNetScheduleAccountInformation(
            pwszservername.param().abi(),
            wszaccount.len().try_into().unwrap(),
            core::mem::transmute(wszaccount.as_ptr()),
        )
        .ok()
    }
}
...
pub unsafe fn LogErrorA(
    dwmessageid: u32,
    plpwssubstrings: &[windows_core::PCSTR],
    dwerrorcode: u32,
) {
    ...
    unsafe {
        LogErrorA(
            dwmessageid,
            plpwssubstrings.len().try_into().unwrap(),
            core::mem::transmute(plpwssubstrings.as_ptr()),
            dwerrorcode,
        )
    }
}
...
pub unsafe fn LogErrorW(
    dwmessageid: u32,
    plpwssubstrings: &[windows_core::PCWSTR],
    dwerrorcode: u32,
) {
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NetAccessAdd(
            ...
            level,
            buf,
            parm_err.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn NetAccessEnum<P0, P1>(
    servername: P0,
    basepath: P1,
    recursive: u32,
    level: u32,
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NetAccessEnum(
            ...
            entriesread as _,
            totalentries as _,
            resume_handle.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn NetAccessGetInfo<P0, P1>(
    servername: P0,
    resource: P1,
    level: u32,
    bufptr: *mut *mut u8,
...
#[inline]
pub unsafe fn NetAccessSetInfo<P0, P1>(
    servername: P0,
    resource: P1,
    level: u32,
    buf: *const u8,
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NetAddAlternateComputerName(
            server.param().abi(),
            alternatename.param().abi(),
            domainaccount.param().abi(),
            domainaccountpassword.param().abi(),
            reserved,
        )
    }
}
...
#[inline]
pub unsafe fn NetAlertRaiseEx<P0, P3>(
    alerttype: P0,
    variableinfo: *const core::ffi::c_void,
...
pub unsafe fn NetApiBufferReallocate(
    oldbuffer: Option<*const core::ffi::c_void>,
    newbytecount: u32,
    newbuffer: *mut *mut core::ffi::c_void,
) -> u32 {
    ...
    unsafe {
        NetApiBufferReallocate(
            oldbuffer.unwrap_or(core::mem::zeroed()) as _,
            newbytecount,
            newbuffer as _,
        )
    }
...
#[inline]
pub unsafe fn NetAuditWrite<P3>(
    r#type: u32,
    buf: *mut u8,
    numbytes: u32,
    service: P3,
...
pub unsafe fn NetCreateProvisioningPackage(
    ...
    pppackagebindata: Option<*mut *mut u8>,
    pdwpackagebindatasize: Option<*mut u32>,
    pppackagetextdata: Option<*mut windows_core::PWSTR>,
) -> u32 {
    ...
    unsafe {
        NetCreateProvisioningPackage(
            pprovisioningparams,
            pppackagebindata.unwrap_or(core::mem::zeroed()) as _,
            pdwpackagebindatasize.unwrap_or(core::mem::zeroed()) as _,
            pppackagetextdata.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn NetEnumerateComputerNames<P0>(
    server: P0,
    nametype: NET_COMPUTER_NAME_TYPE,
    reserved: u32,
    entrycount: *mut u32,
    computernames: *mut *mut windows_core::PWSTR,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn NetEnumerateServiceAccounts<P0>(
    servername: P0,
    flags: u32,
...
pub unsafe fn NetGetAadJoinInformation<P0>(
    pcsztenantid: P0,
) -> windows_core::Result<*mut DSREG_JOIN_INFO>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
pub unsafe fn NetGetJoinInformation<P0>(
    lpserver: P0,
    lpnamebuffer: *mut windows_core::PWSTR,
...
pub unsafe fn NetGetJoinableOUs<P0, P1, P2, P3>(
    ...
    lppassword: P3,
    oucount: *mut u32,
    ous: *mut *mut windows_core::PWSTR,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn NetGroupGetInfo<P0, P1>(
    servername: P0,
    groupname: P1,
    level: u32,
    bufptr: *mut *mut u8,
...
#[inline]
pub unsafe fn NetGroupGetUsers<P0, P1>(
    servername: P0,
    groupname: P1,
    level: u32,
    bufptr: *mut *mut u8,
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NetGroupGetUsers(
            ...
            entriesread as _,
            totalentries as _,
            resumehandle.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn NetGroupSetInfo<P0, P1>(
    servername: P0,
    groupname: P1,
    level: u32,
    buf: *const u8,
...
#[inline]
pub unsafe fn NetGroupSetUsers<P0, P1>(
    servername: P0,
    groupname: P1,
    level: u32,
    buf: *const u8,
...
pub unsafe fn NetIsServiceAccount<P0, P1>(
    servername: P0,
    accountname: P1,
    isservice: *mut windows_core::BOOL,
) -> super::super::Foundation::NTSTATUS
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn NetLocalGroupAdd<P0>(
    servername: P0,
    level: u32,
    buf: *const u8,
    parm_err: Option<*mut u32>,
...
#[inline]
pub unsafe fn NetLocalGroupAddMember<P0, P1>(
    servername: P0,
    groupname: P1,
    membersid: super::super::Security::PSID,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn NetLocalGroupAddMembers<P0, P1>(
    servername: P0,
    groupname: P1,
    level: u32,
    buf: *const u8,
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn NetLocalGroupDelMember<P0, P1>(
    servername: P0,
    groupname: P1,
    membersid: super::super::Security::PSID,
) -> u32
...
#[inline]
pub unsafe fn NetLocalGroupDelMembers<P0, P1>(
    servername: P0,
    groupname: P1,
    level: u32,
    buf: *const u8,
...
#[inline]
pub unsafe fn NetLocalGroupEnum<P0>(
    servername: P0,
    level: u32,
    bufptr: *mut *mut u8,
    prefmaxlen: u32,
...
#[inline]
pub unsafe fn NetLocalGroupGetInfo<P0, P1>(
    servername: P0,
    groupname: P1,
    level: u32,
    bufptr: *mut *mut u8,
...
#[inline]
pub unsafe fn NetLocalGroupGetMembers<P0, P1>(
    servername: P0,
    localgroupname: P1,
    level: u32,
    bufptr: *mut *mut u8,
...
#[inline]
pub unsafe fn NetLocalGroupSetInfo<P0, P1>(
    servername: P0,
    groupname: P1,
    level: u32,
    buf: *const u8,
...
#[inline]
pub unsafe fn NetLocalGroupSetMembers<P0, P1>(
    servername: P0,
    groupname: P1,
    level: u32,
    buf: *const u8,
...
#[inline]
pub unsafe fn NetMessageNameEnum<P0>(
    servername: P0,
    level: u32,
...
#[inline]
pub unsafe fn NetMessageNameGetInfo<P0, P1>(
    servername: P0,
    msgname: P1,
    level: u32,
    bufptr: *const *const u8,
...
#[inline]
pub unsafe fn NetProvisionComputerAccount<P0, P1, P2, P3>(
    lpdomain: P0,
    lpmachinename: P1,
    lpmachineaccountou: P2,
    lpdcname: P3,
    dwoptions: NETSETUP_PROVISION,
    pprovisionbindata: Option<*mut *mut u8>,
    pdwprovisionbindatasize: Option<*mut u32>,
    pprovisiontextdata: Option<*mut windows_core::PWSTR>,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NetProvisionComputerAccount(
            ...
            lpdcname.param().abi(),
            dwoptions,
            pprovisionbindata.unwrap_or(core::mem::zeroed()) as _,
            pdwprovisionbindatasize.unwrap_or(core::mem::zeroed()) as _,
            pprovisiontextdata.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn NetQueryDisplayInformation<P0>(
    ...
    sortedbuffer: *mut *mut core::ffi::c_void,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn NetRemoveAlternateComputerName<P0, P1, P2, P3>(
    server: P0,
    alternatename: P1,
    domainaccount: P2,
    domainaccountpassword: P3,
...
#[inline]
pub unsafe fn NetRemoveServiceAccount<P0, P1>(
    servername: P0,
    accountname: P1,
    flags: u32,
) -> super::super::Foundation::NTSTATUS
...
#[inline]
pub unsafe fn NetRenameMachineInDomain<P0, P1, P2, P3>(
    lpserver: P0,
    lpnewmachinename: P1,
    lpaccount: P2,
    lppassword: P3,
...
#[inline]
pub unsafe fn NetReplExportDirAdd<P0>(
    servername: P0,
    level: u32,
    buf: *const u8,
    parm_err: *mut u32,
...
#[inline]
pub unsafe fn NetReplExportDirEnum<P0>(
    servername: P0,
    level: u32,
    bufptr: *mut *mut u8,
    prefmaxlen: u32,
...
#[inline]
pub unsafe fn NetReplExportDirGetInfo<P0, P1>(
    servername: P0,
    dirname: P1,
    level: u32,
    bufptr: *mut *mut u8,
...
#[inline]
pub unsafe fn NetReplExportDirSetInfo<P0, P1>(
    servername: P0,
    dirname: P1,
    level: u32,
    buf: *const u8,
...
#[inline]
pub unsafe fn NetReplImportDirAdd<P0>(
    servername: P0,
    level: u32,
    buf: *const u8,
    parm_err: *mut u32,
...
#[inline]
pub unsafe fn NetReplImportDirEnum<P0>(
    servername: P0,
    level: u32,
    bufptr: *mut *mut u8,
    prefmaxlen: u32,
...
#[inline]
pub unsafe fn NetReplImportDirGetInfo<P0, P1>(
    servername: P0,
    dirname: P1,
    level: u32,
    bufptr: *mut *mut u8,
...
#[inline]
pub unsafe fn NetReplSetInfo<P0>(
    servername: P0,
    level: u32,
    buf: *const u8,
    parm_err: *mut u32,
...
#[inline]
pub unsafe fn NetRequestOfflineDomainJoin<P3>(
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NetRequestOfflineDomainJoin(
            core::mem::transmute(pprovisionbindata.as_ptr()),
            pprovisionbindata.len().try_into().unwrap(),
            dwoptions,
            lpwindowspath.param().abi(),
        )
    }
}
#[inline]
pub unsafe fn NetRequestProvisioningPackageInstall<P3>(
    ppackagebindata: &[u8],
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NetRequestProvisioningPackageInstall(
            core::mem::transmute(ppackagebindata.as_ptr()),
            ppackagebindata.len().try_into().unwrap(),
            dwprovisionoptions,
            lpwindowspath.param().abi(),
...
#[inline]
pub unsafe fn NetScheduleJobEnum<P0>(
    servername: P0,
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NetServerComputerNameAdd(
            servername.param().abi(),
            emulateddomainname.param().abi(),
            emulatedservername.param().abi(),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn NetServerDiskEnum<P0>(
    servername: P0,
    level: u32,
    bufptr: *mut *mut u8,
    prefmaxlen: u32,
...
#[inline]
pub unsafe fn NetServerEnum<P0, P7>(
    servername: P0,
    level: u32,
    bufptr: *mut *mut u8,
    prefmaxlen: u32,
...
#[inline]
pub unsafe fn NetServerSetInfo<P0>(
    servername: P0,
    level: u32,
    buf: *const u8,
    parmerror: Option<*mut u32>,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NetServerSetInfo(
            ...
            level,
            buf,
            parmerror.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn NetServerTransportEnum<P0>(
    servername: P0,
    level: u32,
    bufptr: *mut *mut u8,
    prefmaxlen: u32,
...
#[inline]
pub unsafe fn NetServiceEnum<P0>(
    servername: P0,
    level: u32,
    bufptr: *mut *mut u8,
    prefmaxlen: u32,
...
#[inline]
pub unsafe fn NetServiceGetInfo<P0, P1>(
    servername: P0,
    service: P1,
    level: u32,
    bufptr: *mut *mut u8,
...
#[inline]
pub unsafe fn NetServiceInstall<P0, P1>(
    servername: P0,
    service: P1,
    argv: &[windows_core::PCWSTR],
    bufptr: *mut *mut u8,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NetServiceInstall(
            ...
            core::mem::transmute(argv.as_ptr()),
            bufptr as _,
        )
    }
}
#[inline]
pub unsafe fn NetSetPrimaryComputerName<P0, P1, P2, P3>(
    server: P0,
    primaryname: P1,
    domainaccount: P2,
    domainaccountpassword: P3,
...
pub unsafe fn NetUseAdd(
    ...
    unsafe {
        NetUseAdd(
            servername.unwrap_or(core::mem::zeroed()) as _,
            levelflags,
            buf,
            parm_err.unwrap_or(core::mem::zeroed()) as _,
        )
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NetUseEnum(
            uncservername.param().abi(),
            levelflags,
            bufptr.unwrap_or(core::mem::zeroed()) as _,
            preferedmaximumsize,
            entriesread.unwrap_or(core::mem::zeroed()) as _,
            totalentries as _,
            resumehandle.unwrap_or(core::mem::zeroed()) as _,
        )
    }
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        NetUserChangePassword(
            domainname.param().abi(),
            username.param().abi(),
            oldpassword.param().abi(),
            newpassword.param().abi(),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn NetUserGetGroups<P0, P1>(
    servername: P0,
    username: P1,
    level: u32,
    bufptr: *mut *mut u8,
...
#[inline]
pub unsafe fn NetUserGetInfo<P0, P1>(
    servername: P0,
    username: P1,
    level: u32,
    bufptr: *mut *mut u8,
...
#[inline]
pub unsafe fn NetUserModalsSet<P0>(
    servername: P0,
    level: u32,
    buf: *const u8,
    parm_err: Option<*mut u32>,
...
#[inline]
pub unsafe fn NetUserSetGroups<P0, P1>(
    servername: P0,
    username: P1,
    level: u32,
    buf: *const u8,
...
#[inline]
pub unsafe fn NetUserSetInfo<P0, P1>(
    servername: P0,
    username: P1,
    level: u32,
    buf: *const u8,
...
#[inline]
pub unsafe fn NetValidatePasswordPolicy<P0>(
    servername: P0,
    qualifier: *mut core::ffi::c_void,
    validationtype: NET_VALIDATE_PASSWORD_TYPE,
    inputarg: *mut core::ffi::c_void,
    outputarg: *mut *mut core::ffi::c_void,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn NetWkstaSetInfo<P0>(
    servername: P0,
    level: u32,
    buffer: *const u8,
    parm_err: Option<*mut u32>,
...
#[inline]
pub unsafe fn NetWkstaUserSetInfo<P0>(
    reserved: P0,
    level: u32,
    buf: *const u8,
    parm_err: Option<*mut u32>,
...
#[inline]
pub unsafe fn RouterAssert<P0, P1, P3>(
    pszfailedassertion: P0,
    pszfilename: P1,
    dwlinenumber: u32,
    pszmessage: P3,
) where
...
pub unsafe fn RouterGetErrorStringA(
    dwerrorcode: u32,
    lplpszerrorstring: *mut windows_core::PSTR,
) -> u32 {
...
pub unsafe fn RouterGetErrorStringW(
    dwerrorcode: u32,
    lplpwszerrorstring: *mut windows_core::PWSTR,
) -> u32 {
...
pub unsafe fn RouterLogEventA(
    ...
    dweventtype: u32,
    dwmessageid: u32,
    plpszsubstringarray: Option<&[windows_core::PCSTR]>,
    dwerrorcode: u32,
) {
...
pub unsafe fn RouterLogEventDataW(
    ...
    dweventtype: u32,
    dwmessageid: u32,
    plpszsubstringarray: Option<&[windows_core::PCWSTR]>,
    dwdatabytes: u32,
    lpdatabytes: *mut u8,
) {
...
#[inline]
pub unsafe fn RouterLogEventExA<P4>(
    hloghandle: super::super::Foundation::HANDLE,
    dweventtype: u32,
    dwerrorcode: u32,
    dwmessageid: u32,
    ...
    P4: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        RouterLogEventExA(
            ...
            dwerrorcode,
            dwmessageid,
            ptszformat.param().abi(),
        )
    }
}
#[inline]
pub unsafe fn RouterLogEventExW<P4>(
    hloghandle: super::super::Foundation::HANDLE,
    dweventtype: u32,
    dwerrorcode: u32,
    dwmessageid: u32,
...
pub unsafe fn RouterLogEventStringA(
    ...
    dweventtype: u32,
    dwmessageid: u32,
    plpszsubstringarray: &[windows_core::PCSTR],
    dwerrorcode: u32,
    dwerrorindex: u32,
) {
    ...
    unsafe {
        RouterLogEventStringA(
            ...
            dweventtype,
            dwmessageid,
            plpszsubstringarray.len().try_into().unwrap(),
            core::mem::transmute(plpszsubstringarray.as_ptr()),
            dwerrorcode,
            dwerrorindex,
        )
    }
...
pub unsafe fn RouterLogEventStringW(
    ...
    dweventtype: u32,
    dwmessageid: u32,
    plpszsubstringarray: &[windows_core::PCWSTR],
    dwerrorcode: u32,
    dwerrorindex: u32,
) {
...
#[inline]
pub unsafe fn RouterLogEventValistExA<P4>(
    hloghandle: super::super::Foundation::HANDLE,
    dweventtype: u32,
    dwerrorcode: u32,
    dwmessageid: u32,
...
#[inline]
pub unsafe fn RouterLogEventValistExW<P4>(
    hloghandle: super::super::Foundation::HANDLE,
    dweventtype: u32,
    dwerrorcode: u32,
    dwmessageid: u32,
    ...
    P6: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        TraceDumpExA(
            ...
            dwgroupsize,
            baddressprefix.into(),
            lpszprefix.param().abi(),
        )
    }
}
#[inline]
pub unsafe fn TraceDumpExW<P6>(
    dwtraceid: u32,
    dwflags: u32,
    lpbbytes: *mut u8,
    dwbytecount: u32,
...
#[inline]
pub unsafe fn TraceVprintfExA<P2>(
    dwtraceid: u32,
    dwflags: u32,
    lpszformat: P2,
    arglist: *mut i8,
...
#[inline]
pub unsafe fn TraceVprintfExW<P2>(
    dwtraceid: u32,
    dwflags: u32,
    lpszformat: P2,
    arglist: *mut i8,
...
impl IEnumNetCfgBindingInterface {
    ...
    pub unsafe fn Clone(
        &self,
        ppenum: Option<*const Option<IEnumNetCfgBindingInterface>>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Clone)(
                windows_core::Interface::as_raw(self),
                ppenum.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
...
pub trait IEnumNetCfgBindingInterface_Impl: windows_core::IUnknownImpl {
    ...
    fn Clone(&self, ppenum: *const Option<IEnumNetCfgBindingInterface>)
        -> windows_core::Result<()>;
}
    ...
    pub const fn new<Identity: IEnumNetCfgBindingInterface_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                IEnumNetCfgBindingInterface_Impl::Next(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumNetCfgBindingInterface_Impl::Skip(this, core::mem::transmute_copy(&celt))
                    .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            ppenum: *const *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumNetCfgBindingInterface_Impl::Clone(this, core::mem::transmute_copy(&ppenum))
                    .into()
            }
        }
        Self {
...
impl IEnumNetCfgBindingPath {
    ...
    pub unsafe fn Clone(
        &self,
        ppenum: Option<*const Option<IEnumNetCfgBindingPath>>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Clone)(
                windows_core::Interface::as_raw(self),
    ...
    pub const fn new<Identity: IEnumNetCfgBindingPath_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumNetCfgBindingPath_Impl::Next(
                    this,
                    core::mem::transmute_copy(&celt),
                    core::mem::transmute_copy(&rgelt),
                    core::mem::transmute_copy(&pceltfetched),
...
impl IEnumNetCfgComponent {
    ...
    pub unsafe fn Clone(
        &self,
        ppenum: Option<*const Option<IEnumNetCfgComponent>>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Clone)(
                windows_core::Interface::as_raw(self),
...
impl IEnumNetCfgComponent_Vtbl {
    pub const fn new<Identity: IEnumNetCfgComponent_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Next<Identity: IEnumNetCfgComponent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            rgelt: *mut *mut core::ffi::c_void,
            pceltfetched: *mut u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumNetCfgComponent_Impl::Next(
                    this,
                    core::mem::transmute_copy(&celt),
                    core::mem::transmute_copy(&rgelt),
                    core::mem::transmute_copy(&pceltfetched),
        ...
        unsafe extern "system" fn Skip<Identity: IEnumNetCfgComponent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    INetCfg,
    INetCfg_Vtbl,
    0xc0e8ae93_306e_11d1_aacf_00805fc1270e
);
...
impl INetCfg {
    ...
    pub unsafe fn EnumComponents(
        &self,
        pguidclass: *const windows_core::GUID,
        ppenumcomponent: Option<*mut Option<IEnumNetCfgComponent>>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EnumComponents)(
                windows_core::Interface::as_raw(self),
                pguidclass,
                ppenumcomponent.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn FindComponent<P0>(
        &self,
        pszwinfid: P0,
        pcomponent: Option<*mut Option<INetCfgComponent>>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).FindComponent)(
                windows_core::Interface::as_raw(self),
                pszwinfid.param().abi(),
                pcomponent.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn QueryNetCfgClass(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).QueryNetCfgClass)(
                windows_core::Interface::as_raw(self),
                pguidclass,
                riid,
...
pub struct INetCfg_Vtbl {
    ...
    pub EnumComponents: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FindComponent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub QueryNetCfgClass: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
...
pub trait INetCfg_Impl: windows_core::IUnknownImpl {
    ...
    fn EnumComponents(
        &self,
        pguidclass: *const windows_core::GUID,
        ppenumcomponent: windows_core::OutRef<'_, IEnumNetCfgComponent>,
    ) -> windows_core::Result<()>;
    fn FindComponent(
        &self,
        pszwinfid: &windows_core::PCWSTR,
        pcomponent: windows_core::OutRef<'_, INetCfgComponent>,
    ) -> windows_core::Result<()>;
    fn QueryNetCfgClass(
        &self,
        pguidclass: *const windows_core::GUID,
...
impl INetCfg_Vtbl {
    pub const fn new<Identity: INetCfg_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Initialize<Identity: INetCfg_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Uninitialize<Identity: INetCfg_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Apply<Identity: INetCfg_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Cancel<Identity: INetCfg_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn EnumComponents<Identity: INetCfg_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pguidclass: *const windows_core::GUID,
            ppenumcomponent: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfg_Impl::EnumComponents(
                    this,
                    core::mem::transmute_copy(&pguidclass),
                    core::mem::transmute_copy(&ppenumcomponent),
                )
                .into()
            }
        }
        unsafe extern "system" fn FindComponent<Identity: INetCfg_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszwinfid: windows_core::PCWSTR,
            pcomponent: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfg_Impl::FindComponent(
                    this,
                    core::mem::transmute(&pszwinfid),
                    core::mem::transmute_copy(&pcomponent),
                )
                .into()
            }
        }
        unsafe extern "system" fn QueryNetCfgClass<Identity: INetCfg_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pguidclass: *const windows_core::GUID,
            riid: *const windows_core::GUID,
            ppvobject: *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xc0e8ae94_306e_11d1_aacf_00805fc1270e
);
...
impl INetCfgBindingInterface {
    pub unsafe fn GetName(
        &self,
        ppszwinterfacename: Option<*mut windows_core::PWSTR>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetName)(
                windows_core::Interface::as_raw(self),
                ppszwinterfacename.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetUpperComponent(
        &self,
        ppnccitem: Option<*mut Option<INetCfgComponent>>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetUpperComponent)(
                windows_core::Interface::as_raw(self),
                ppnccitem.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetLowerComponent(
        &self,
        ppnccitem: Option<*mut Option<INetCfgComponent>>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetLowerComponent)(
                windows_core::Interface::as_raw(self),
                ppnccitem.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
...
pub struct INetCfgBindingInterface_Vtbl {
    ...
    pub GetUpperComponent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetLowerComponent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait INetCfgBindingInterface_Impl: windows_core::IUnknownImpl {
    ...
    fn GetUpperComponent(
        &self,
        ppnccitem: windows_core::OutRef<'_, INetCfgComponent>,
    ) -> windows_core::Result<()>;
...
impl INetCfgBindingInterface_Vtbl {
    pub const fn new<Identity: INetCfgBindingInterface_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            ppszwinterfacename: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgBindingInterface_Impl::GetName(
                    this,
                    core::mem::transmute_copy(&ppszwinterfacename),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetUpperComponent<
            Identity: INetCfgBindingInterface_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppnccitem: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgBindingInterface_Impl::GetUpperComponent(
                    this,
        ...
        unsafe extern "system" fn GetLowerComponent<
            Identity: INetCfgBindingInterface_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgBindingInterface_Impl::GetLowerComponent(
                    this,
                    core::mem::transmute_copy(&ppnccitem),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    0xc0e8ae96_306e_11d1_aacf_00805fc1270e
);
...
impl INetCfgBindingPath {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).IsSamePathAs)(
                windows_core::Interface::as_raw(self),
                ppath.param().abi(),
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).IsSubPathOf)(
                windows_core::Interface::as_raw(self),
                ppath.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn GetPathToken(
        &self,
        ppszwpathtoken: Option<*mut windows_core::PWSTR>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPathToken)(
                windows_core::Interface::as_raw(self),
                ppszwpathtoken.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetOwner(
        &self,
        ppcomponent: Option<*mut Option<INetCfgComponent>>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetOwner)(
                windows_core::Interface::as_raw(self),
                ppcomponent.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetDepth(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDepth)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn EnumBindingInterfaces(
        &self,
        ppenuminterface: Option<*mut Option<IEnumNetCfgBindingInterface>>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EnumBindingInterfaces)(
                windows_core::Interface::as_raw(self),
                ppenuminterface.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
...
pub struct INetCfgBindingPath_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub IsSamePathAs: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsSubPathOf: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GetPathToken: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    ...
    pub EnumBindingInterfaces: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait INetCfgBindingPath_Impl: windows_core::IUnknownImpl {
    fn IsSamePathAs(
        &self,
        ppath: windows_core::Ref<'_, INetCfgBindingPath>,
    ) -> windows_core::Result<()>;
    fn IsSubPathOf(
        &self,
        ppath: windows_core::Ref<'_, INetCfgBindingPath>,
    ...
    fn GetOwner(
        &self,
        ppcomponent: windows_core::OutRef<'_, INetCfgComponent>,
    ) -> windows_core::Result<()>;
    fn GetDepth(&self) -> windows_core::Result<u32>;
    fn EnumBindingInterfaces(
        &self,
        ppenuminterface: windows_core::OutRef<'_, IEnumNetCfgBindingInterface>,
    ) -> windows_core::Result<()>;
}
impl INetCfgBindingPath_Vtbl {
    pub const fn new<Identity: INetCfgBindingPath_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsSamePathAs<
            Identity: INetCfgBindingPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppath: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgBindingPath_Impl::IsSamePathAs(this, core::mem::transmute_copy(&ppath))
                    .into()
            }
        }
        unsafe extern "system" fn IsSubPathOf<
            Identity: INetCfgBindingPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Enable<Identity: INetCfgBindingPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetPathToken<
            Identity: INetCfgBindingPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppszwpathtoken: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgBindingPath_Impl::GetPathToken(
                    this,
                    core::mem::transmute_copy(&ppszwpathtoken),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgBindingPath_Impl::GetOwner(this, core::mem::transmute_copy(&ppcomponent))
                    .into()
            }
        }
        unsafe extern "system" fn GetDepth<
            Identity: INetCfgBindingPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn EnumBindingInterfaces<
            Identity: INetCfgBindingPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppenuminterface: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgBindingPath_Impl::EnumBindingInterfaces(
                    this,
                    core::mem::transmute_copy(&ppenuminterface),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    INetCfgClass,
    INetCfgClass_Vtbl,
    0xc0e8ae97_306e_11d1_aacf_00805fc1270e
);
...
impl INetCfgClass_Vtbl {
    pub const fn new<Identity: INetCfgClass_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn FindComponent<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgClass_Impl::FindComponent(
                    this,
                    core::mem::transmute(&pszwinfid),
                    core::mem::transmute_copy(&ppnccitem),
                )
        ...
        unsafe extern "system" fn EnumComponents<
            Identity: INetCfgClass_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgClass_Impl::EnumComponents(this, core::mem::transmute_copy(&ppenumcomponent))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0xc0e8ae9d_306e_11d1_aacf_00805fc1270e
);
...
impl INetCfgClassSetup {
    pub unsafe fn SelectAndInstall(
        ...
        pobotoken: Option<*const OBO_TOKEN>,
        ppnccitem: Option<*mut Option<INetCfgComponent>>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SelectAndInstall)(
                windows_core::Interface::as_raw(self),
                hwndparent,
                pobotoken.unwrap_or(core::mem::zeroed()) as _,
                ppnccitem.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn Install<P0, P4, P5>(
        &self,
        pszwinfid: P0,
        pobotoken: Option<*const OBO_TOKEN>,
        dwsetupflags: Option<u32>,
        dwupgradefrombuildno: Option<u32>,
        pszwanswerfile: P4,
        pszwanswersections: P5,
        ppnccitem: Option<*mut Option<INetCfgComponent>>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        ...
        P5: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Install)(
                ...
                pszwinfid.param().abi(),
                pobotoken.unwrap_or(core::mem::zeroed()) as _,
                dwsetupflags.unwrap_or(core::mem::zeroed()) as _,
                dwupgradefrombuildno.unwrap_or(core::mem::zeroed()) as _,
                pszwanswerfile.param().abi(),
                pszwanswersections.param().abi(),
                ppnccitem.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn DeInstall<P0>(
        &self,
        pcomponent: P0,
        pobotoken: Option<*const OBO_TOKEN>,
        pmszwrefs: Option<*mut windows_core::PWSTR>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<INetCfgComponent>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeInstall)(
                windows_core::Interface::as_raw(self),
                pcomponent.param().abi(),
                pobotoken.unwrap_or(core::mem::zeroed()) as _,
                pmszwrefs.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
...
pub struct INetCfgClassSetup_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SelectAndInstall: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub DeInstall: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const OBO_TOKEN,
        *mut windows_core::PWSTR,
...
pub trait INetCfgClassSetup_Impl: windows_core::IUnknownImpl {
    ...
    fn Install(
        ...
        pszwanswerfile: &windows_core::PCWSTR,
        pszwanswersections: &windows_core::PCWSTR,
        ppnccitem: windows_core::OutRef<'_, INetCfgComponent>,
    ) -> windows_core::Result<()>;
    fn DeInstall(
        &self,
        pcomponent: windows_core::Ref<'_, INetCfgComponent>,
        pobotoken: *const OBO_TOKEN,
        pmszwrefs: *mut windows_core::PWSTR,
    ) -> windows_core::Result<()>;
}
impl INetCfgClassSetup_Vtbl {
    pub const fn new<Identity: INetCfgClassSetup_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SelectAndInstall<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgClassSetup_Impl::SelectAndInstall(
                    this,
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute_copy(&pobotoken),
                    core::mem::transmute_copy(&ppnccitem),
                )
                .into()
            }
        }
        unsafe extern "system" fn Install<Identity: INetCfgClassSetup_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszwinfid: windows_core::PCWSTR,
            pobotoken: *const OBO_TOKEN,
            dwsetupflags: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgClassSetup_Impl::Install(
                    this,
                    core::mem::transmute(&pszwinfid),
                    core::mem::transmute_copy(&pobotoken),
                    core::mem::transmute_copy(&dwsetupflags),
                    core::mem::transmute_copy(&dwupgradefrombuildno),
                    core::mem::transmute(&pszwanswerfile),
                    core::mem::transmute(&pszwanswersections),
                    core::mem::transmute_copy(&ppnccitem),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeInstall<
            Identity: INetCfgClassSetup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pcomponent: *mut core::ffi::c_void,
            pobotoken: *const OBO_TOKEN,
            pmszwrefs: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgClassSetup_Impl::DeInstall(
                    this,
                    core::mem::transmute_copy(&pcomponent),
                    core::mem::transmute_copy(&pobotoken),
                    core::mem::transmute_copy(&pmszwrefs),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xc0e8aea0_306e_11d1_aacf_00805fc1270e
);
...
impl INetCfgClassSetup2 {
    pub unsafe fn UpdateNonEnumeratedComponent<P0>(
        &self,
        picomp: P0,
        dwsetupflags: Option<u32>,
        dwupgradefrombuildno: Option<u32>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).UpdateNonEnumeratedComponent)(
                windows_core::Interface::as_raw(self),
                picomp.param().abi(),
                dwsetupflags.unwrap_or(core::mem::zeroed()) as _,
                dwupgradefrombuildno.unwrap_or(core::mem::zeroed()) as _,
...
pub struct INetCfgClassSetup2_Vtbl {
    ...
    pub UpdateNonEnumeratedComponent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        u32,
...
pub trait INetCfgClassSetup2_Impl: INetCfgClassSetup_Impl {
    fn UpdateNonEnumeratedComponent(
        &self,
        picomp: windows_core::Ref<'_, INetCfgComponent>,
        dwsetupflags: u32,
        dwupgradefrombuildno: u32,
    ) -> windows_core::Result<()>;
}
impl INetCfgClassSetup2_Vtbl {
    pub const fn new<Identity: INetCfgClassSetup2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn UpdateNonEnumeratedComponent<
            Identity: INetCfgClassSetup2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            picomp: *mut core::ffi::c_void,
            dwsetupflags: u32,
            dwupgradefrombuildno: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgClassSetup2_Impl::UpdateNonEnumeratedComponent(
                    this,
                    core::mem::transmute_copy(&picomp),
                    core::mem::transmute_copy(&dwsetupflags),
                    core::mem::transmute_copy(&dwupgradefrombuildno),
                )
                .into()
        ...
        Self {
            base__: INetCfgClassSetup_Vtbl::new::<Identity, OFFSET>(),
            UpdateNonEnumeratedComponent: UpdateNonEnumeratedComponent::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xc0e8ae99_306e_11d1_aacf_00805fc1270e
);
...
impl INetCfgComponent {
    pub unsafe fn GetDisplayName(
        &self,
        ppszwdisplayname: Option<*mut windows_core::PWSTR>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetDisplayName)(
                windows_core::Interface::as_raw(self),
                ppszwdisplayname.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    ...
    pub unsafe fn GetHelpText(
        &self,
        pszwhelptext: Option<*mut windows_core::PWSTR>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetHelpText)(
                windows_core::Interface::as_raw(self),
                pszwhelptext.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetId(
        &self,
        ppszwid: Option<*mut windows_core::PWSTR>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetId)(
                windows_core::Interface::as_raw(self),
                ppszwid.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    ...
    pub unsafe fn GetInstanceGuid(
        &self,
        pguid: Option<*mut windows_core::GUID>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetInstanceGuid)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn GetPnpDevNodeId(
        &self,
        ppszwdevnodeid: Option<*mut windows_core::PWSTR>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPnpDevNodeId)(
                windows_core::Interface::as_raw(self),
                ppszwdevnodeid.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetClassGuid(
        &self,
        pguid: Option<*mut windows_core::GUID>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetClassGuid)(
                windows_core::Interface::as_raw(self),
                pguid.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
    ...
    pub unsafe fn GetBindName(
        &self,
        ppszwbindname: Option<*mut windows_core::PWSTR>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetBindName)(
                windows_core::Interface::as_raw(self),
                ppszwbindname.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetDeviceStatus(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDeviceStatus)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn OpenParamKey(
        &self,
        phkey: Option<*mut super::super::System::Registry::HKEY>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OpenParamKey)(
                windows_core::Interface::as_raw(self),
                phkey.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn RaisePropertyUi<P2>(
        &self,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RaisePropertyUi)(
                windows_core::Interface::as_raw(self),
...
pub struct INetCfgComponent_Vtbl {
    ...
    pub GetCharacteristics:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetInstanceGuid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub GetPnpDevNodeId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetClassGuid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub GetBindName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetDeviceStatus:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Registry")]
    pub OpenParamKey: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Registry::HKEY,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Registry"))]
    OpenParamKey: usize,
    pub RaisePropertyUi: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HWND,
        u32,
        *mut core::ffi::c_void,
...
pub trait INetCfgComponent_Impl: windows_core::IUnknownImpl {
    fn GetDisplayName(
        &self,
        ppszwdisplayname: *mut windows_core::PWSTR,
    ) -> windows_core::Result<()>;
    ...
    fn GetPnpDevNodeId(&self, ppszwdevnodeid: *mut windows_core::PWSTR)
        -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: INetCfgComponent_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponent_Impl::GetDisplayName(
                    this,
                    core::mem::transmute_copy(&ppszwdisplayname),
                )
                .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            pszwdisplayname: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponent_Impl::SetDisplayName(this, core::mem::transmute(&pszwdisplayname))
                    .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            pszwhelptext: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponent_Impl::GetHelpText(this, core::mem::transmute_copy(&pszwhelptext))
                    .into()
            }
        }
        unsafe extern "system" fn GetId<Identity: INetCfgComponent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppszwid: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetInstanceGuid<
            Identity: INetCfgComponent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponent_Impl::GetInstanceGuid(this, core::mem::transmute_copy(&pguid))
                    .into()
            }
        }
        unsafe extern "system" fn GetPnpDevNodeId<
            Identity: INetCfgComponent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppszwdevnodeid: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponent_Impl::GetPnpDevNodeId(
                    this,
                    core::mem::transmute_copy(&ppszwdevnodeid),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetClassGuid<
            Identity: INetCfgComponent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetBindName<
            Identity: INetCfgComponent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppszwbindname: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponent_Impl::GetBindName(this, core::mem::transmute_copy(&ppszwbindname))
                    .into()
            }
        }
        unsafe extern "system" fn GetDeviceStatus<
            Identity: INetCfgComponent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn OpenParamKey<
            Identity: INetCfgComponent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn RaisePropertyUi<
            Identity: INetCfgComponent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponent_Impl::RaisePropertyUi(
                    this,
                    core::mem::transmute_copy(&hwndparent),
...
windows_core::imp::define_interface!(
    ...
    0xc0e8ae9e_306e_11d1_aacf_00805fc1270e
);
...
impl INetCfgComponentBindings {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).BindTo)(
                windows_core::Interface::as_raw(self),
                pnccitem.param().abi(),
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).UnbindFrom)(
                windows_core::Interface::as_raw(self),
                pnccitem.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn SupportsBindingInterface<P1>(
        &self,
        dwflags: u32,
        pszwinterfacename: P1,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SupportsBindingInterface)(
                windows_core::Interface::as_raw(self),
                dwflags,
                pszwinterfacename.param().abi(),
            )
            .ok()
        }
    }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).IsBoundTo)(
                windows_core::Interface::as_raw(self),
                pnccitem.param().abi(),
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).IsBindableTo)(
                windows_core::Interface::as_raw(self),
                pnccitem.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn EnumBindingPaths(
        &self,
        dwflags: u32,
        ppienum: Option<*mut Option<IEnumNetCfgBindingPath>>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EnumBindingPaths)(
                windows_core::Interface::as_raw(self),
                dwflags,
                ppienum.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn MoveBefore<P0, P1>(
        &self,
        pncbitemsrc: P0,
        pncbitemdest: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).MoveBefore)(
                windows_core::Interface::as_raw(self),
                pncbitemsrc.param().abi(),
                pncbitemdest.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn MoveAfter<P0, P1>(
        &self,
        pncbitemsrc: P0,
        pncbitemdest: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).MoveAfter)(
                windows_core::Interface::as_raw(self),
                pncbitemsrc.param().abi(),
                pncbitemdest.param().abi(),
            )
...
pub struct INetCfgComponentBindings_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub BindTo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UnbindFrom: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SupportsBindingInterface: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub IsBoundTo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsBindableTo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub EnumBindingPaths: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub MoveBefore: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub MoveAfter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait INetCfgComponentBindings_Impl: windows_core::IUnknownImpl {
    fn BindTo(&self, pnccitem: windows_core::Ref<'_, INetCfgComponent>)
        -> windows_core::Result<()>;
    fn UnbindFrom(
        &self,
        pnccitem: windows_core::Ref<'_, INetCfgComponent>,
    ) -> windows_core::Result<()>;
    fn SupportsBindingInterface(
        &self,
        dwflags: u32,
        pszwinterfacename: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    fn IsBoundTo(
        &self,
        pnccitem: windows_core::Ref<'_, INetCfgComponent>,
    ...
    fn EnumBindingPaths(
        &self,
        dwflags: u32,
        ppienum: windows_core::OutRef<'_, IEnumNetCfgBindingPath>,
    ) -> windows_core::Result<()>;
    fn MoveBefore(
        &self,
        pncbitemsrc: windows_core::Ref<'_, INetCfgBindingPath>,
        pncbitemdest: windows_core::Ref<'_, INetCfgBindingPath>,
    ) -> windows_core::Result<()>;
    fn MoveAfter(
        &self,
        pncbitemsrc: windows_core::Ref<'_, INetCfgBindingPath>,
...
impl INetCfgComponentBindings_Vtbl {
    pub const fn new<Identity: INetCfgComponentBindings_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BindTo<
            Identity: INetCfgComponentBindings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pnccitem: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentBindings_Impl::BindTo(this, core::mem::transmute_copy(&pnccitem))
                    .into()
            }
        }
        unsafe extern "system" fn UnbindFrom<
            Identity: INetCfgComponentBindings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentBindings_Impl::UnbindFrom(
                    this,
                    core::mem::transmute_copy(&pnccitem),
                )
                .into()
            }
        }
        unsafe extern "system" fn SupportsBindingInterface<
            Identity: INetCfgComponentBindings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentBindings_Impl::SupportsBindingInterface(
                    this,
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute(&pszwinterfacename),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsBoundTo<
            Identity: INetCfgComponentBindings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentBindings_Impl::IsBoundTo(this, core::mem::transmute_copy(&pnccitem))
                    .into()
            }
        }
        unsafe extern "system" fn IsBindableTo<
            Identity: INetCfgComponentBindings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentBindings_Impl::IsBindableTo(
                    this,
                    core::mem::transmute_copy(&pnccitem),
                )
                .into()
        ...
        unsafe extern "system" fn EnumBindingPaths<
            Identity: INetCfgComponentBindings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentBindings_Impl::EnumBindingPaths(
                    this,
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&ppienum),
                )
                .into()
            }
        }
        unsafe extern "system" fn MoveBefore<
            Identity: INetCfgComponentBindings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pncbitemsrc: *mut core::ffi::c_void,
            pncbitemdest: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentBindings_Impl::MoveBefore(
                    this,
                    core::mem::transmute_copy(&pncbitemsrc),
                    core::mem::transmute_copy(&pncbitemdest),
                )
                .into()
            }
        }
        unsafe extern "system" fn MoveAfter<
            Identity: INetCfgComponentBindings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentBindings_Impl::MoveAfter(
                    this,
                    core::mem::transmute_copy(&pncbitemsrc),
                    core::mem::transmute_copy(&pncbitemdest),
                )
...
windows_core::imp::define_interface!(
    ...
    0x932238df_bea1_11d0_9298_00c04fc99dcf
);
...
impl INetCfgComponentControl {
    ...
    pub unsafe fn ApplyRegistryChanges(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ApplyRegistryChanges)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ApplyPnpChanges)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn CancelChanges(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CancelChanges)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub struct INetCfgComponentControl_Vtbl {
    ...
    pub ApplyRegistryChanges:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub ApplyPnpChanges: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait INetCfgComponentControl_Impl: windows_core::IUnknownImpl {
    fn Initialize(
        &self,
        picomp: windows_core::Ref<'_, INetCfgComponent>,
        pinetcfg: windows_core::Ref<'_, INetCfg>,
        finstalling: windows_core::BOOL,
    ) -> windows_core::Result<()>;
    fn ApplyRegistryChanges(&self) -> windows_core::Result<()>;
    fn ApplyPnpChanges(
        &self,
        picallback: windows_core::Ref<'_, INetCfgPnpReconfigCallback>,
    ) -> windows_core::Result<()>;
...
impl INetCfgComponentControl_Vtbl {
    pub const fn new<Identity: INetCfgComponentControl_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            picomp: *mut core::ffi::c_void,
            pinetcfg: *mut core::ffi::c_void,
            finstalling: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentControl_Impl::Initialize(
                    this,
                    core::mem::transmute_copy(&picomp),
                    core::mem::transmute_copy(&pinetcfg),
                    core::mem::transmute_copy(&finstalling),
                )
                .into()
            }
        }
        unsafe extern "system" fn ApplyRegistryChanges<
            Identity: INetCfgComponentControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ApplyPnpChanges<
            Identity: INetCfgComponentControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentControl_Impl::ApplyPnpChanges(
                    this,
        ...
        unsafe extern "system" fn CancelChanges<
            Identity: INetCfgComponentControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x932238e1_bea1_11d0_9298_00c04fc99dcf
);
...
impl INetCfgComponentNotifyBinding {
    pub unsafe fn QueryBindingPath<P1>(
        &self,
        dwchangeflag: u32,
        pipath: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).QueryBindingPath)(
                windows_core::Interface::as_raw(self),
                dwchangeflag,
                pipath.param().abi(),
            )
    ...
    pub unsafe fn NotifyBindingPath<P1>(
        &self,
        dwchangeflag: u32,
        pipath: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).NotifyBindingPath)(
                windows_core::Interface::as_raw(self),
                dwchangeflag,
                pipath.param().abi(),
            )
...
pub struct INetCfgComponentNotifyBinding_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub QueryBindingPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub NotifyBindingPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait INetCfgComponentNotifyBinding_Impl: windows_core::IUnknownImpl {
    fn QueryBindingPath(
        &self,
        dwchangeflag: u32,
        pipath: windows_core::Ref<'_, INetCfgBindingPath>,
    ) -> windows_core::Result<()>;
...
impl INetCfgComponentNotifyBinding_Vtbl {
    pub const fn new<Identity: INetCfgComponentNotifyBinding_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn QueryBindingPath<
            Identity: INetCfgComponentNotifyBinding_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dwchangeflag: u32,
            pipath: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentNotifyBinding_Impl::QueryBindingPath(
                    this,
                    core::mem::transmute_copy(&dwchangeflag),
                    core::mem::transmute_copy(&pipath),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentNotifyBinding_Impl::NotifyBindingPath(
                    this,
                    core::mem::transmute_copy(&dwchangeflag),
                    core::mem::transmute_copy(&pipath),
                )
...
windows_core::imp::define_interface!(
    ...
    0x932238e2_bea1_11d0_9298_00c04fc99dcf
);
...
impl INetCfgComponentNotifyGlobal {
    pub unsafe fn GetSupportedNotifications(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSupportedNotifications)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SysQueryBindingPath<P1>(
        &self,
        dwchangeflag: u32,
        pipath: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SysQueryBindingPath)(
                windows_core::Interface::as_raw(self),
                dwchangeflag,
                pipath.param().abi(),
            )
    ...
    pub unsafe fn SysNotifyBindingPath<P1>(
        &self,
        dwchangeflag: u32,
        pipath: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SysNotifyBindingPath)(
                windows_core::Interface::as_raw(self),
                dwchangeflag,
                pipath.param().abi(),
            )
    ...
    pub unsafe fn SysNotifyComponent<P1>(
        &self,
        dwchangeflag: u32,
        picomp: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SysNotifyComponent)(
                windows_core::Interface::as_raw(self),
                dwchangeflag,
                picomp.param().abi(),
            )
...
pub struct INetCfgComponentNotifyGlobal_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetSupportedNotifications:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SysQueryBindingPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SysNotifyBindingPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SysNotifyComponent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl INetCfgComponentNotifyGlobal_Vtbl {
    pub const fn new<Identity: INetCfgComponentNotifyGlobal_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetSupportedNotifications<
        ...
        unsafe extern "system" fn SysQueryBindingPath<
            Identity: INetCfgComponentNotifyGlobal_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentNotifyGlobal_Impl::SysQueryBindingPath(
                    this,
                    core::mem::transmute_copy(&dwchangeflag),
                    core::mem::transmute_copy(&pipath),
                )
        ...
        unsafe extern "system" fn SysNotifyBindingPath<
            Identity: INetCfgComponentNotifyGlobal_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentNotifyGlobal_Impl::SysNotifyBindingPath(
                    this,
                    core::mem::transmute_copy(&dwchangeflag),
                    core::mem::transmute_copy(&pipath),
                )
        ...
        unsafe extern "system" fn SysNotifyComponent<
            Identity: INetCfgComponentNotifyGlobal_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentNotifyGlobal_Impl::SysNotifyComponent(
                    this,
                    core::mem::transmute_copy(&dwchangeflag),
                    core::mem::transmute_copy(&picomp),
                )
...
windows_core::imp::define_interface!(
    ...
    0x932238e0_bea1_11d0_9298_00c04fc99dcf
);
...
impl INetCfgComponentPropertyUi {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).QueryPropertyUi)(
                windows_core::Interface::as_raw(self),
                punkreserved.param().abi(),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn MergePropPages(
        ...
        pcpages: *mut u32,
        hwndparent: super::super::Foundation::HWND,
        pszstartpage: Option<*const windows_core::PCWSTR>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).MergePropPages)(
                windows_core::Interface::as_raw(self),
                pdwdefpages as _,
                pahpspprivate as _,
                pcpages as _,
                hwndparent,
                pszstartpage.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn ValidateProperties(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ValidateProperties)(
                windows_core::Interface::as_raw(self),
                hwndsheet,
            )
            .ok()
    ...
    pub unsafe fn CancelProperties(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CancelProperties)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct INetCfgComponentPropertyUi_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub QueryPropertyUi: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub MergePropPages: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut *mut u8,
        *mut u32,
...
pub trait INetCfgComponentPropertyUi_Impl: windows_core::IUnknownImpl {
    ...
    fn MergePropPages(
        ...
        pcpages: *mut u32,
        hwndparent: super::super::Foundation::HWND,
        pszstartpage: *const windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
...
impl INetCfgComponentPropertyUi_Vtbl {
    pub const fn new<Identity: INetCfgComponentPropertyUi_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn QueryPropertyUi<
            Identity: INetCfgComponentPropertyUi_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            punkreserved: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentPropertyUi_Impl::QueryPropertyUi(
                    this,
                    core::mem::transmute_copy(&punkreserved),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentPropertyUi_Impl::SetContext(
                    this,
                    core::mem::transmute_copy(&punkreserved),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentPropertyUi_Impl::MergePropPages(
                    this,
                    core::mem::transmute_copy(&pdwdefpages),
                    core::mem::transmute_copy(&pahpspprivate),
                    core::mem::transmute_copy(&pcpages),
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute_copy(&pszstartpage),
                )
                .into()
            }
        }
        unsafe extern "system" fn ValidateProperties<
            Identity: INetCfgComponentPropertyUi_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentPropertyUi_Impl::ValidateProperties(
                    this,
                    core::mem::transmute_copy(&hwndsheet),
                )
                .into()
            }
        }
        ...
        unsafe extern "system" fn CancelProperties<
            Identity: INetCfgComponentPropertyUi_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x932238e3_bea1_11d0_9298_00c04fc99dcf
);
...
impl INetCfgComponentSetup {
    ...
    pub unsafe fn Upgrade(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Upgrade)(
                windows_core::Interface::as_raw(self),
                dwsetupflags,
                dwupgradefombuildno,
            )
    ...
    pub unsafe fn ReadAnswerFile<P0, P1>(
        &self,
        pszwanswerfile: P0,
        pszwanswersections: P1,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).ReadAnswerFile)(
                windows_core::Interface::as_raw(self),
                pszwanswerfile.param().abi(),
                pszwanswersections.param().abi(),
            )
    ...
    pub unsafe fn Removing(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Removing)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
}
...
pub struct INetCfgComponentSetup_Vtbl {
    ...
    pub ReadAnswerFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
...
impl INetCfgComponentSetup_Vtbl {
    pub const fn new<Identity: INetCfgComponentSetup_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Install<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentSetup_Impl::Install(this, core::mem::transmute_copy(&dwsetupflags))
                    .into()
            }
        }
        unsafe extern "system" fn Upgrade<
            Identity: INetCfgComponentSetup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentSetup_Impl::Upgrade(
                    this,
                    core::mem::transmute_copy(&dwsetupflags),
                    core::mem::transmute_copy(&dwupgradefombuildno),
                )
                .into()
            }
        }
        unsafe extern "system" fn ReadAnswerFile<
            Identity: INetCfgComponentSetup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentSetup_Impl::ReadAnswerFile(
                    this,
                    core::mem::transmute(&pszwanswerfile),
                    core::mem::transmute(&pszwanswersections),
                )
        ...
        unsafe extern "system" fn Removing<
            Identity: INetCfgComponentSetup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xc0e8ae9a_306e_11d1_aacf_00805fc1270e
);
windows_core::imp::interface_hierarchy!(INetCfgComponentSysPrep, windows_core::IUnknown);
impl INetCfgComponentSysPrep {
    pub unsafe fn SaveAdapterParameters<P0, P1>(
        &self,
        pncsp: P0,
        pszwanswersections: P1,
        padapterinstanceguid: *const windows_core::GUID,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SaveAdapterParameters)(
                windows_core::Interface::as_raw(self),
                pncsp.param().abi(),
                pszwanswersections.param().abi(),
    ...
    pub unsafe fn RestoreAdapterParameters<P0, P1>(
        &self,
        pszwanswerfile: P0,
        pszwanswersection: P1,
        padapterinstanceguid: *const windows_core::GUID,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RestoreAdapterParameters)(
                windows_core::Interface::as_raw(self),
                pszwanswerfile.param().abi(),
                pszwanswersection.param().abi(),
                padapterinstanceguid,
            )
            .ok()
        }
...
pub struct INetCfgComponentSysPrep_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SaveAdapterParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub RestoreAdapterParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *const windows_core::GUID,
...
pub trait INetCfgComponentSysPrep_Impl: windows_core::IUnknownImpl {
    fn SaveAdapterParameters(
        &self,
        pncsp: windows_core::Ref<'_, INetCfgSysPrep>,
        pszwanswersections: &windows_core::PCWSTR,
        padapterinstanceguid: *const windows_core::GUID,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: INetCfgComponentSysPrep_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentSysPrep_Impl::SaveAdapterParameters(
                    this,
                    core::mem::transmute_copy(&pncsp),
                    core::mem::transmute(&pszwanswersections),
                    core::mem::transmute_copy(&padapterinstanceguid),
                )
                .into()
            }
        }
        unsafe extern "system" fn RestoreAdapterParameters<
            Identity: INetCfgComponentSysPrep_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentSysPrep_Impl::RestoreAdapterParameters(
                    this,
                    core::mem::transmute(&pszwanswerfile),
                    core::mem::transmute(&pszwanswersection),
                    core::mem::transmute_copy(&padapterinstanceguid),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0x932238e4_bea1_11d0_9298_00c04fc99dcf
);
windows_core::imp::interface_hierarchy!(INetCfgComponentUpperEdge, windows_core::IUnknown);
impl INetCfgComponentUpperEdge {
    pub unsafe fn GetInterfaceIdsForAdapter<P0>(
        &self,
        padapter: P0,
        pdwnuminterfaces: *mut u32,
        ppguidinterfaceids: Option<*mut *mut windows_core::GUID>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<INetCfgComponent>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetInterfaceIdsForAdapter)(
                windows_core::Interface::as_raw(self),
                padapter.param().abi(),
                pdwnuminterfaces as _,
                ppguidinterfaceids.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn AddInterfacesToAdapter<P0>(
        &self,
        padapter: P0,
        dwnuminterfaces: u32,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddInterfacesToAdapter)(
                windows_core::Interface::as_raw(self),
                padapter.param().abi(),
                dwnuminterfaces,
            )
    ...
    pub unsafe fn RemoveInterfacesFromAdapter<P0>(
        &self,
        padapter: P0,
        pguidinterfaceids: &[windows_core::GUID],
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<INetCfgComponent>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveInterfacesFromAdapter)(
                windows_core::Interface::as_raw(self),
                padapter.param().abi(),
                pguidinterfaceids.len().try_into().unwrap(),
                core::mem::transmute(pguidinterfaceids.as_ptr()),
            )
            .ok()
        }
    }
...
pub struct INetCfgComponentUpperEdge_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetInterfaceIdsForAdapter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut u32,
        *mut *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub AddInterfacesToAdapter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ) -> windows_core::HRESULT,
    pub RemoveInterfacesFromAdapter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const windows_core::GUID,
...
pub trait INetCfgComponentUpperEdge_Impl: windows_core::IUnknownImpl {
    fn GetInterfaceIdsForAdapter(
        &self,
        padapter: windows_core::Ref<'_, INetCfgComponent>,
        pdwnuminterfaces: *mut u32,
        ppguidinterfaceids: *mut *mut windows_core::GUID,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: INetCfgComponentUpperEdge_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentUpperEdge_Impl::GetInterfaceIdsForAdapter(
                    this,
                    core::mem::transmute_copy(&padapter),
                    core::mem::transmute_copy(&pdwnuminterfaces),
                    core::mem::transmute_copy(&ppguidinterfaceids),
                )
                .into()
            }
        }
        unsafe extern "system" fn AddInterfacesToAdapter<
            Identity: INetCfgComponentUpperEdge_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentUpperEdge_Impl::AddInterfacesToAdapter(
                    this,
                    core::mem::transmute_copy(&padapter),
                    core::mem::transmute_copy(&dwnuminterfaces),
                )
                .into()
            }
        }
        unsafe extern "system" fn RemoveInterfacesFromAdapter<
            Identity: INetCfgComponentUpperEdge_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgComponentUpperEdge_Impl::RemoveInterfacesFromAdapter(
                    this,
                    core::mem::transmute_copy(&padapter),
                    core::mem::transmute_copy(&dwnuminterfaces),
                    core::mem::transmute_copy(&pguidinterfaceids),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    INetCfgLock,
    INetCfgLock_Vtbl,
    0xc0e8ae9f_306e_11d1_aacf_00805fc1270e
);
windows_core::imp::interface_hierarchy!(INetCfgLock, windows_core::IUnknown);
impl INetCfgLock {
    pub unsafe fn AcquireWriteLock<P1>(
        &self,
        cmstimeout: u32,
        pszwclientdescription: P1,
        ppszwclientdescription: Option<*mut windows_core::PWSTR>,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).AcquireWriteLock)(
                windows_core::Interface::as_raw(self),
                cmstimeout,
                pszwclientdescription.param().abi(),
                ppszwclientdescription.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn ReleaseWriteLock(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ReleaseWriteLock)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn IsWriteLocked(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).IsWriteLocked)(
                windows_core::Interface::as_raw(self),
                ppszwclientdescription.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
...
pub struct INetCfgLock_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub AcquireWriteLock: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub ReleaseWriteLock:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub IsWriteLocked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
}
pub trait INetCfgLock_Impl: windows_core::IUnknownImpl {
    fn AcquireWriteLock(
        &self,
        cmstimeout: u32,
        pszwclientdescription: &windows_core::PCWSTR,
        ppszwclientdescription: *mut windows_core::PWSTR,
    ) -> windows_core::Result<()>;
...
impl INetCfgLock_Vtbl {
    pub const fn new<Identity: INetCfgLock_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AcquireWriteLock<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgLock_Impl::AcquireWriteLock(
                    this,
                    core::mem::transmute_copy(&cmstimeout),
                    core::mem::transmute(&pszwclientdescription),
                    core::mem::transmute_copy(&ppszwclientdescription),
                )
                .into()
            }
        }
        unsafe extern "system" fn ReleaseWriteLock<
            Identity: INetCfgLock_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn IsWriteLocked<Identity: INetCfgLock_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppszwclientdescription: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgLock_Impl::IsWriteLocked(
                    this,
                    core::mem::transmute_copy(&ppszwclientdescription),
                )
                .into()
...
impl INetCfgPnpReconfigCallback {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SendPnpReconfig)(
                windows_core::Interface::as_raw(self),
                layer,
                pszwupper.param().abi(),
                pszwlower.param().abi(),
...
pub struct INetCfgPnpReconfigCallback_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SendPnpReconfig: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait INetCfgPnpReconfigCallback_Impl: windows_core::IUnknownImpl {
    fn SendPnpReconfig(
        &self,
        layer: NCPNP_RECONFIG_LAYER,
        pszwupper: &windows_core::PCWSTR,
        pszwlower: &windows_core::PCWSTR,
        pvdata: *const core::ffi::c_void,
        dwsizeofdata: u32,
    ) -> windows_core::Result<()>;
}
impl INetCfgPnpReconfigCallback_Vtbl {
    pub const fn new<Identity: INetCfgPnpReconfigCallback_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SendPnpReconfig<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgPnpReconfigCallback_Impl::SendPnpReconfig(
                    this,
                    core::mem::transmute_copy(&layer),
                    core::mem::transmute(&pszwupper),
                    core::mem::transmute(&pszwlower),
                    core::mem::transmute_copy(&pvdata),
                    core::mem::transmute_copy(&dwsizeofdata),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            SendPnpReconfig: SendPnpReconfig::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    INetCfgSysPrep,
    INetCfgSysPrep_Vtbl,
    0xc0e8ae98_306e_11d1_aacf_00805fc1270e
);
windows_core::imp::interface_hierarchy!(INetCfgSysPrep, windows_core::IUnknown);
impl INetCfgSysPrep {
    pub unsafe fn HrSetupSetFirstDword<P0, P1>(
        &self,
        pwszsection: P0,
        pwszkey: P1,
        dwvalue: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).HrSetupSetFirstDword)(
                windows_core::Interface::as_raw(self),
                pwszsection.param().abi(),
                pwszkey.param().abi(),
                dwvalue,
            )
            .ok()
    ...
    pub unsafe fn HrSetupSetFirstString<P0, P1, P2>(
        &self,
        pwszsection: P0,
        pwszkey: P1,
        pwszvalue: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).HrSetupSetFirstString)(
                windows_core::Interface::as_raw(self),
                pwszsection.param().abi(),
                pwszkey.param().abi(),
                pwszvalue.param().abi(),
    ...
    pub unsafe fn HrSetupSetFirstStringAsBool<P0, P1>(
        &self,
        pwszsection: P0,
        pwszkey: P1,
        fvalue: bool,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).HrSetupSetFirstStringAsBool)(
                windows_core::Interface::as_raw(self),
                pwszsection.param().abi(),
                pwszkey.param().abi(),
                fvalue.into(),
    ...
    pub unsafe fn HrSetupSetFirstMultiSzField<P0, P1, P2>(
        &self,
        pwszsection: P0,
        pwszkey: P1,
        pmszvalue: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).HrSetupSetFirstMultiSzField)(
                windows_core::Interface::as_raw(self),
                pwszsection.param().abi(),
                pwszkey.param().abi(),
                pmszvalue.param().abi(),
...
pub struct INetCfgSysPrep_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub HrSetupSetFirstDword: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        u32,
    ) -> windows_core::HRESULT,
    pub HrSetupSetFirstString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub HrSetupSetFirstStringAsBool: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub HrSetupSetFirstMultiSzField: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
pub trait INetCfgSysPrep_Impl: windows_core::IUnknownImpl {
    fn HrSetupSetFirstDword(
        &self,
        pwszsection: &windows_core::PCWSTR,
        pwszkey: &windows_core::PCWSTR,
        dwvalue: u32,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: INetCfgSysPrep_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgSysPrep_Impl::HrSetupSetFirstDword(
                    this,
                    core::mem::transmute(&pwszsection),
                    core::mem::transmute(&pwszkey),
                    core::mem::transmute_copy(&dwvalue),
                )
                .into()
            }
        }
        unsafe extern "system" fn HrSetupSetFirstString<
            Identity: INetCfgSysPrep_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgSysPrep_Impl::HrSetupSetFirstString(
                    this,
                    core::mem::transmute(&pwszsection),
                    core::mem::transmute(&pwszkey),
                    core::mem::transmute(&pwszvalue),
                )
                .into()
            }
        }
        unsafe extern "system" fn HrSetupSetFirstStringAsBool<
            Identity: INetCfgSysPrep_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgSysPrep_Impl::HrSetupSetFirstStringAsBool(
                    this,
                    core::mem::transmute(&pwszsection),
                    core::mem::transmute(&pwszkey),
        ...
        unsafe extern "system" fn HrSetupSetFirstMultiSzField<
            Identity: INetCfgSysPrep_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetCfgSysPrep_Impl::HrSetupSetFirstMultiSzField(
                    this,
                    core::mem::transmute(&pwszsection),
                    core::mem::transmute(&pwszkey),
                    core::mem::transmute(&pmszvalue),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xc08956a6_1cd3_11d1_b1c5_00805fc1270e
);
...
impl INetLanConnectionUiInfo {
    pub unsafe fn GetDeviceGuid(&self) -> windows_core::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDeviceGuid)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct INetLanConnectionUiInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetDeviceGuid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
}
...
impl INetLanConnectionUiInfo_Vtbl {
    pub const fn new<Identity: INetLanConnectionUiInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDeviceGuid<
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetDeviceGuid: GetDeviceGuid::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    INetRasConnectionIpUiInfo_Vtbl,
    0xfaedcf58_31fe_11d1_aad2_00805fc1270e
);
...
impl INetRasConnectionIpUiInfo {
    pub unsafe fn GetUiInfo(&self, pinfo: *mut RASCON_IPUI) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetUiInfo)(
                windows_core::Interface::as_raw(self),
                pinfo as _,
            )
            .ok()
...
pub struct INetRasConnectionIpUiInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetUiInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RASCON_IPUI,
    ) -> windows_core::HRESULT,
}
...
impl INetRasConnectionIpUiInfo_Vtbl {
    pub const fn new<Identity: INetRasConnectionIpUiInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetUiInfo<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetRasConnectionIpUiInfo_Impl::GetUiInfo(this, core::mem::transmute_copy(&pinfo))
                    .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetUiInfo: GetUiInfo::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xc96fbd50_24dd_11d8_89fb_00904b2ea9c6
);
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Add)(
                windows_core::Interface::as_raw(self),
                pszwpathtofolder.param().abi(),
            )
            .ok()
        }
    }
    #[cfg(all(feature = "Win32_Data_Xml_MsXml", feature = "Win32_System_Com"))]
    pub unsafe fn Query<P0, P1, P2>(
        &self,
        pszwdomain: P0,
        pszwlanguage: P1,
        pszwxpathquery: P2,
    ) -> windows_core::Result<super::super::Data::Xml::MsXml::IXMLDOMNodeList>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).Query)(
                windows_core::Interface::as_raw(self),
                pszwdomain.param().abi(),
                pszwlanguage.param().abi(),
                pszwxpathquery.param().abi(),
                &mut result__,
            )
...
pub trait IProvisioningDomain_Impl: windows_core::IUnknownImpl {
    ...
    fn Query(
        &self,
        pszwdomain: &windows_core::PCWSTR,
        pszwlanguage: &windows_core::PCWSTR,
        pszwxpathquery: &windows_core::PCWSTR,
    ) -> windows_core::Result<super::super::Data::Xml::MsXml::IXMLDOMNodeList>;
}
#[cfg(all(feature = "Win32_Data_Xml_MsXml", feature = "Win32_System_Com"))]
impl IProvisioningDomain_Vtbl {
    pub const fn new<Identity: IProvisioningDomain_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Add<Identity: IProvisioningDomain_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszwpathtofolder: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Query<Identity: IProvisioningDomain_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszwdomain: windows_core::PCWSTR,
            pszwlanguage: windows_core::PCWSTR,
            pszwxpathquery: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IProvisioningDomain_Impl::Query(
                    this,
                    core::mem::transmute(&pszwdomain),
                    core::mem::transmute(&pszwlanguage),
                    core::mem::transmute(&pszwxpathquery),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0xc96fbd51_24dd_11d8_89fb_00904b2ea9c6
);
...
impl IProvisioningProfileWireless {
    pub unsafe fn CreateProfile(
        &self,
        bstrxmlwirelessconfigprofile: &windows_core::BSTR,
        bstrxmlconnectionconfigprofile: &windows_core::BSTR,
        padapterinstanceguid: *const windows_core::GUID,
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(self).CreateProfile)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrxmlwirelessconfigprofile),
                core::mem::transmute_copy(bstrxmlconnectionconfigprofile),
                padapterinstanceguid,
                &mut result__,
            )
            .map(|| result__)
...
impl IProvisioningProfileWireless_Vtbl {
    pub const fn new<Identity: IProvisioningProfileWireless_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            bstrxmlwirelessconfigprofile: *mut core::ffi::c_void,
            bstrxmlconnectionconfigprofile: *mut core::ffi::c_void,
            padapterinstanceguid: *const windows_core::GUID,
            pulstatus: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IProvisioningProfileWireless_Impl::CreateProfile(
                    this,
                    core::mem::transmute(&bstrxmlwirelessconfigprofile),
                    core::mem::transmute(&bstrxmlconnectionconfigprofile),
                    core::mem::transmute_copy(&padapterinstanceguid),
                ) {
                    Ok(ok__) => {
                        pulstatus.write(core::mem::transmute(ok__));
...
pub const NETCFG_E_ACTIVE_RAS_CONNECTIONS: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A026_u32 as _);
pub const NETCFG_E_ADAPTER_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A027_u32 as _);
pub const NETCFG_E_ALREADY_INITIALIZED: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A020_u32 as _);
pub const NETCFG_E_COMPONENT_REMOVED_PENDING_REBOOT: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A028_u32 as _);
pub const NETCFG_E_DUPLICATE_INSTANCEID: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A02B_u32 as _);
pub const NETCFG_E_IN_USE: windows_core::HRESULT = windows_core::HRESULT(0x8004A022_u32 as _);
pub const NETCFG_E_MAX_FILTER_LIMIT: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A029_u32 as _);
pub const NETCFG_E_NEED_REBOOT: windows_core::HRESULT = windows_core::HRESULT(0x8004A025_u32 as _);
pub const NETCFG_E_NOT_INITIALIZED: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A021_u32 as _);
pub const NETCFG_E_NO_WRITE_LOCK: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A024_u32 as _);
pub const NETCFG_E_VMSWITCH_ACTIVE_OVER_ADAPTER: windows_core::HRESULT =
    windows_core::HRESULT(0x8004A02A_u32 as _);
...
pub const NETCFG_S_CAUSED_SETUP_CHANGE: windows_core::HRESULT =
    windows_core::HRESULT(0x4A024_u32 as _);
...
pub const NETCFG_S_STILL_REFERENCED: windows_core::HRESULT =
    windows_core::HRESULT(0x4A023_u32 as _);
...
pub const NetProvisioning: windows_core::GUID =
    windows_core::GUID::from_u128(0x2aa2b5fe_b846_4d07_810c_b21ee45320e3);
...
pub const REGISTER_PROTOCOL_ENTRY_POINT_STRING: windows_core::PCSTR =
    windows_core::s!("RegisterProtocol");
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const SERVICE_ACCOUNT_PASSWORD: windows_core::PCWSTR =
    windows_core::w!("_SA_{262E99C9-6160-4871-ACEC-4E61736B6F21}");
pub const SERVICE_ACCOUNT_SECRET_PREFIX: windows_core::PCWSTR =
    windows_core::w!("_SC_{262E99C9-6160-4871-ACEC-4E61736B6F21}_");
...
pub const ServiceAccountPasswordGUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x262e99c9_6160_4871_acec_4e61736b6f21);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]

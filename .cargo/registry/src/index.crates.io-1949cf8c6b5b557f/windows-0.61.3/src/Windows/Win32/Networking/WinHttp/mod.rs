#[inline]
pub unsafe fn WinHttpAddRequestHeaders(
    hrequest: *mut core::ffi::c_void,
    lpszheaders: &[u16],
    dwmodifiers: u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinHttpAddRequestHeaders(
            hrequest as _,
            core::mem::transmute(lpszheaders.as_ptr()),
            lpszheaders.len().try_into().unwrap(),
            dwmodifiers,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn WinHttpAddRequestHeadersEx(
    hrequest: *mut core::ffi::c_void,
    dwmodifiers: u32,
    ullflags: u64,
    ullextra: u64,
    ...
    unsafe {
        WinHttpAddRequestHeadersEx(
            ...
            ullflags,
            ullextra,
            pheaders.len().try_into().unwrap(),
            core::mem::transmute(pheaders.as_ptr()),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn WinHttpConnect<P1>(
    hsession: *mut core::ffi::c_void,
    pswzservername: P1,
    nserverport: u16,
    dwreserved: u32,
) -> *mut core::ffi::c_void
...
pub unsafe fn WinHttpCrackUrl(
    ...
    unsafe {
        WinHttpCrackUrl(
            core::mem::transmute(pwszurl.as_ptr()),
            pwszurl.len().try_into().unwrap(),
            dwflags,
            lpurlcomponents as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn WinHttpCreateProxyResolver(
    hsession: *const core::ffi::c_void,
    phresolver: *mut *mut core::ffi::c_void,
) -> u32 {
...
pub unsafe fn WinHttpCreateUrl(
    ...
    pwszurl: Option<windows_core::PWSTR>,
    ...
    unsafe {
        WinHttpCreateUrl(
            lpurlcomponents,
            dwflags,
            pwszurl.unwrap_or(core::mem::zeroed()) as _,
            pdwurllength as _,
        )
        .ok()
    }
...
pub unsafe fn WinHttpDetectAutoProxyConfigUrl(
    ...
    ppwstrautoconfigurl: *mut windows_core::PWSTR,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn WinHttpFreeProxySettingsEx(
    proxysettingstype: WINHTTP_PROXY_SETTINGS_TYPE,
    pproxysettingsex: *const core::ffi::c_void,
) -> u32 {
...
#[inline]
pub unsafe fn WinHttpFreeQueryConnectionGroupResult(
...
#[inline]
pub unsafe fn WinHttpGetDefaultProxyConfiguration(
...
#[inline]
pub unsafe fn WinHttpGetIEProxyConfigForCurrentUser(
...
#[inline]
pub unsafe fn WinHttpGetProxyForUrl<P1>(
    hsession: *mut core::ffi::c_void,
    lpcwszurl: P1,
...
pub unsafe fn WinHttpGetProxyForUrlEx<P1>(
    hresolver: *const core::ffi::c_void,
    pcwszurl: P1,
...
#[inline]
pub unsafe fn WinHttpGetProxyForUrlEx2<P1>(
    hresolver: *const core::ffi::c_void,
    pcwszurl: P1,
    pautoproxyoptions: *const WINHTTP_AUTOPROXY_OPTIONS,
...
#[inline]
pub unsafe fn WinHttpGetProxyResult(
    hresolver: *const core::ffi::c_void,
...
#[inline]
pub unsafe fn WinHttpGetProxyResultEx(
    hresolver: *const core::ffi::c_void,
    pproxyresultex: *mut WINHTTP_PROXY_RESULT_EX,
) -> u32 {
...
#[inline]
pub unsafe fn WinHttpGetProxySettingsEx(
    hresolver: *const core::ffi::c_void,
    proxysettingstype: WINHTTP_PROXY_SETTINGS_TYPE,
    pproxysettingsparam: Option<*const WINHTTP_PROXY_SETTINGS_PARAM>,
    pcontext: Option<usize>,
) -> u32 {
    ...
    unsafe {
        WinHttpGetProxySettingsEx(
            hresolver,
            proxysettingstype,
            pproxysettingsparam.unwrap_or(core::mem::zeroed()) as _,
            pcontext.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn WinHttpGetProxySettingsResultEx(
    hresolver: *const core::ffi::c_void,
    pproxysettingsex: *mut core::ffi::c_void,
) -> u32 {
...
#[inline]
pub unsafe fn WinHttpGetProxySettingsVersion(
    hsession: *const core::ffi::c_void,
    pdwproxysettingsversion: *mut u32,
) -> u32 {
...
#[inline]
pub unsafe fn WinHttpOpen<P0, P2, P3>(
    pszagentw: P0,
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WinHttpOpen(
            ...
            dwaccesstype,
            pszproxyw.param().abi(),
            pszproxybypassw.param().abi(),
            dwflags,
        )
    }
}
#[inline]
pub unsafe fn WinHttpOpenRequest<P1, P2, P3, P4>(
    hconnect: *mut core::ffi::c_void,
    pwszverb: P1,
    pwszobjectname: P2,
    pwszversion: P3,
    pwszreferrer: P4,
    ppwszaccepttypes: *const windows_core::PCWSTR,
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WinHttpOpenRequest(
            hconnect as _,
            pwszverb.param().abi(),
            pwszobjectname.param().abi(),
            pwszversion.param().abi(),
            pwszreferrer.param().abi(),
            ppwszaccepttypes,
            dwflags,
        )
    }
...
#[inline]
pub unsafe fn WinHttpQueryAuthSchemes(
    hrequest: *mut core::ffi::c_void,
    ...
    unsafe {
        WinHttpQueryAuthSchemes(
            hrequest as _,
            lpdwsupportedschemes as _,
            lpdwfirstscheme as _,
            pdwauthtarget as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn WinHttpQueryConnectionGroup(
    hinternet: *const core::ffi::c_void,
    pguidconnection: Option<*const windows_core::GUID>,
    ullflags: u64,
    ppresult: *mut *mut WINHTTP_QUERY_CONNECTION_GROUP_RESULT,
) -> u32 {
    ...
    unsafe {
        WinHttpQueryConnectionGroup(
            hinternet,
            pguidconnection.unwrap_or(core::mem::zeroed()) as _,
            ullflags,
            ppresult as _,
        )
    }
...
#[inline]
pub unsafe fn WinHttpQueryDataAvailable(
    hrequest: *mut core::ffi::c_void,
...
#[inline]
pub unsafe fn WinHttpQueryHeaders<P2>(
    hrequest: *mut core::ffi::c_void,
    dwinfolevel: u32,
    pwszname: P2,
...
#[inline]
pub unsafe fn WinHttpQueryHeadersEx(
    hrequest: *const core::ffi::c_void,
    dwinfolevel: u32,
    ullflags: u64,
    uicodepage: u32,
    pdwindex: Option<*mut u32>,
    pheadername: Option<*const WINHTTP_HEADER_NAME>,
    pbuffer: Option<*mut core::ffi::c_void>,
    pdwbufferlength: *mut u32,
    ppheaders: Option<*mut *mut WINHTTP_EXTENDED_HEADER>,
    pdwheaderscount: *mut u32,
) -> u32 {
    ...
    unsafe {
        WinHttpQueryHeadersEx(
            ...
            ullflags,
            uicodepage,
            pdwindex.unwrap_or(core::mem::zeroed()) as _,
            pheadername.unwrap_or(core::mem::zeroed()) as _,
            pbuffer.unwrap_or(core::mem::zeroed()) as _,
            pdwbufferlength as _,
            ppheaders.unwrap_or(core::mem::zeroed()) as _,
            pdwheaderscount as _,
        )
    }
}
#[inline]
pub unsafe fn WinHttpQueryOption(
...
pub unsafe fn WinHttpReadData(
    ...
    unsafe {
        WinHttpReadData(
            ...
            lpdwnumberofbytesread as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn WinHttpReadDataEx(
    hrequest: *mut core::ffi::c_void,
    lpbuffer: *mut core::ffi::c_void,
    dwnumberofbytestoread: u32,
    lpdwnumberofbytesread: *mut u32,
    ullflags: u64,
    cbproperty: u32,
    pvproperty: Option<*const core::ffi::c_void>,
) -> u32 {
    ...
    unsafe {
        WinHttpReadDataEx(
            ...
            ullflags,
            cbproperty,
            pvproperty.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn WinHttpReadProxySettings<P1>(
    hsession: *const core::ffi::c_void,
    pcwszconnectionname: P1,
    ffallbacktodefaultsettings: bool,
    fsetautodiscoverfordefaultsettings: bool,
    pdwsettingsversion: *mut u32,
    pfdefaultsettingsarereturned: *mut windows_core::BOOL,
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WinHttpReadProxySettings(
            hsession,
            pcwszconnectionname.param().abi(),
            ffallbacktodefaultsettings.into(),
            fsetautodiscoverfordefaultsettings.into(),
            pdwsettingsversion as _,
            pfdefaultsettingsarereturned as _,
            pwinhttpproxysettings as _,
        )
    }
}
#[inline]
pub unsafe fn WinHttpReceiveResponse(
    hrequest: *mut core::ffi::c_void,
...
pub unsafe fn WinHttpRegisterProxyChangeNotification(
    ...
    hregistration: *mut *mut core::ffi::c_void,
) -> u32 {
    ...
    unsafe {
        WinHttpRegisterProxyChangeNotification(ullflags, pfncallback, pvcontext, hregistration as _)
    }
}
#[inline]
...
#[inline]
pub unsafe fn WinHttpSendRequest(
    hrequest: *mut core::ffi::c_void,
    lpszheaders: Option<&[u16]>,
    lpoptional: Option<*const core::ffi::c_void>,
    ...
    unsafe {
        WinHttpSendRequest(
            ...
            lpszheaders
                .as_deref()
                .map_or(0, |slice| slice.len().try_into().unwrap()),
            lpoptional.unwrap_or(core::mem::zeroed()) as _,
            dwoptionallength,
            dwtotallength,
            dwcontext,
        )
...
pub unsafe fn WinHttpSetCredentials<P3, P4>(
    ...
    pwszusername: P3,
    pwszpassword: P4,
    pauthparams: *mut core::ffi::c_void,
) -> windows_core::Result<()>
where
    P3: windows_core::Param<windows_core::PCWSTR>,
    P4: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn WinHttpSetOption(
    hinternet: Option<*const core::ffi::c_void>,
    dwoption: u32,
    lpbuffer: Option<&[u8]>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinHttpSetOption(
            hinternet.unwrap_or(core::mem::zeroed()) as _,
            dwoption,
            core::mem::transmute(
                lpbuffer
                    .as_deref()
...
#[inline]
pub unsafe fn WinHttpSetStatusCallback(
    hinternet: *mut core::ffi::c_void,
...
#[inline]
pub unsafe fn WinHttpSetTimeouts(
    hinternet: *mut core::ffi::c_void,
    nresolvetimeout: i32,
    nconnecttimeout: i32,
    nsendtimeout: i32,
...
#[inline]
pub unsafe fn WinHttpUnregisterProxyChangeNotification(
    hregistration: *const core::ffi::c_void,
) -> u32 {
...
#[inline]
pub unsafe fn WinHttpWebSocketClose(
    hwebsocket: *const core::ffi::c_void,
    usstatus: u16,
    pvreason: Option<*const core::ffi::c_void>,
    dwreasonlength: u32,
) -> u32 {
    ...
    unsafe {
        WinHttpWebSocketClose(
            hwebsocket,
            usstatus,
            pvreason.unwrap_or(core::mem::zeroed()) as _,
            dwreasonlength,
        )
    }
}
#[inline]
pub unsafe fn WinHttpWebSocketCompleteUpgrade(
    hrequest: *const core::ffi::c_void,
    pcontext: Option<usize>,
) -> *mut core::ffi::c_void {
    ...
    unsafe {
        WinHttpWebSocketCompleteUpgrade(hrequest, pcontext.unwrap_or(core::mem::zeroed()) as _)
    }
}
#[inline]
pub unsafe fn WinHttpWebSocketQueryCloseStatus(
    hwebsocket: *const core::ffi::c_void,
    pusstatus: *mut u16,
    pvreason: Option<*mut core::ffi::c_void>,
    dwreasonlength: u32,
    ...
    unsafe {
        WinHttpWebSocketQueryCloseStatus(
            ...
            pvreason.unwrap_or(core::mem::zeroed()) as _,
            dwreasonlength,
            pdwreasonlengthconsumed as _,
        )
    }
}
#[inline]
pub unsafe fn WinHttpWebSocketReceive(
    hwebsocket: *const core::ffi::c_void,
...
#[inline]
pub unsafe fn WinHttpWebSocketSend(
    hwebsocket: *const core::ffi::c_void,
...
#[inline]
pub unsafe fn WinHttpWebSocketShutdown(
    hwebsocket: *const core::ffi::c_void,
    usstatus: u16,
    pvreason: Option<*const core::ffi::c_void>,
    dwreasonlength: u32,
...
#[inline]
pub unsafe fn WinHttpWriteData(
    hrequest: *mut core::ffi::c_void,
    ...
    unsafe {
        WinHttpWriteData(
            ...
            lpdwnumberofbyteswritten as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn WinHttpWriteProxySettings(
    hsession: *const core::ffi::c_void,
    fforceupdate: bool,
    pwinhttpproxysettings: *const WINHTTP_PROXY_SETTINGS,
) -> u32 {
...
pub const AutoLogonPolicy_Always: WinHttpRequestAutoLogonPolicy =
    WinHttpRequestAutoLogonPolicy(0i32);
pub const AutoLogonPolicy_Never: WinHttpRequestAutoLogonPolicy =
    WinHttpRequestAutoLogonPolicy(2i32);
pub const AutoLogonPolicy_OnlyIfBypassProxy: WinHttpRequestAutoLogonPolicy =
    WinHttpRequestAutoLogonPolicy(1i32);
...
impl IWinHttpRequest {
    ...
    pub unsafe fn SetProxy(
        &self,
        proxysetting: i32,
        proxyserver: &super::super::System::Variant::VARIANT,
        bypasslist: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetProxy)(
                windows_core::Interface::as_raw(self),
                proxysetting,
                core::mem::transmute_copy(proxyserver),
                core::mem::transmute_copy(bypasslist),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn Open(
        &self,
        method: &windows_core::BSTR,
        url: &windows_core::BSTR,
        r#async: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Open)(
                ...
                core::mem::transmute_copy(r#async),
            )
            .ok()
        }
    }
    pub unsafe fn SetRequestHeader(
        &self,
        header: &windows_core::BSTR,
        value: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetRequestHeader)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(header),
                core::mem::transmute_copy(value),
            )
            .ok()
        }
    }
    pub unsafe fn GetResponseHeader(
        &self,
        header: &windows_core::BSTR,
    ) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetResponseHeader)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(header),
                &mut result__,
            )
    ...
    pub unsafe fn GetAllResponseHeaders(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAllResponseHeaders)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn Send(
        &self,
        body: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub unsafe fn ResponseText(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ResponseText)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn ResponseBody(
        &self,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ResponseBody)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn ResponseStream(
        &self,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ResponseStream)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn get_Option(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Option)(
                windows_core::Interface::as_raw(self),
                option,
                &mut result__,
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn put_Option(
        &self,
        option: WinHttpRequestOption,
        value: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).put_Option)(
                windows_core::Interface::as_raw(self),
                option,
                core::mem::transmute_copy(value),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn WaitForResponse(
        &self,
        timeout: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).WaitForResponse)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn SetTimeouts(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetTimeouts)(
                windows_core::Interface::as_raw(self),
                resolvetimeout,
                connecttimeout,
                sendtimeout,
    ...
    pub unsafe fn SetClientCertificate(
        &self,
        clientcertificate: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetClientCertificate)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(clientcertificate),
            )
            .ok()
        }
    }
    pub unsafe fn SetAutoLogonPolicy(
        &self,
        autologonpolicy: WinHttpRequestAutoLogonPolicy,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAutoLogonPolicy)(
                windows_core::Interface::as_raw(self),
                autologonpolicy,
            )
            .ok()
...
pub struct IWinHttpRequest_Vtbl {
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub SetProxy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
    ...
    pub GetResponseHeader: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetAllResponseHeaders: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    ...
    pub ResponseText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub ResponseBody: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    ResponseBody: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub ResponseStream: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub get_Option: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    get_Option: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub put_Option: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WinHttpRequestOption,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    put_Option: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub WaitForResponse: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ...
    pub SetTimeouts: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        i32,
        i32,
    ...
    pub SetAutoLogonPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IWinHttpRequest_Vtbl {
    pub const fn new<Identity: IWinHttpRequest_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetProxy<Identity: IWinHttpRequest_Impl, const OFFSET: isize>(
            ...
            unsafe {
                ...
                IWinHttpRequest_Impl::SetProxy(
                    this,
                    core::mem::transmute_copy(&proxysetting),
                    core::mem::transmute(&proxyserver),
                    core::mem::transmute(&bypasslist),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinHttpRequest_Impl::SetCredentials(
                    this,
        ...
        unsafe extern "system" fn Open<Identity: IWinHttpRequest_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinHttpRequest_Impl::Open(
                    this,
                    core::mem::transmute(&method),
                    core::mem::transmute(&url),
                    core::mem::transmute(&r#async),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinHttpRequest_Impl::SetRequestHeader(
                    this,
        ...
        unsafe extern "system" fn GetResponseHeader<
            Identity: IWinHttpRequest_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetAllResponseHeaders<
            Identity: IWinHttpRequest_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Send<Identity: IWinHttpRequest_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            body: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Status<Identity: IWinHttpRequest_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            status: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            this: *mut core::ffi::c_void,
            status: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ResponseText<
            Identity: IWinHttpRequest_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            body: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ResponseBody<
            Identity: IWinHttpRequest_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            body: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ResponseStream<
            Identity: IWinHttpRequest_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn get_Option<
            Identity: IWinHttpRequest_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn put_Option<
            Identity: IWinHttpRequest_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinHttpRequest_Impl::put_Option(
                    this,
        ...
        unsafe extern "system" fn WaitForResponse<
            Identity: IWinHttpRequest_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            timeout: super::super::System::Variant::VARIANT,
            succeeded: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Abort<Identity: IWinHttpRequest_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn SetTimeouts<
            Identity: IWinHttpRequest_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinHttpRequest_Impl::SetTimeouts(
                    this,
                    core::mem::transmute_copy(&resolvetimeout),
                    core::mem::transmute_copy(&connecttimeout),
                    core::mem::transmute_copy(&sendtimeout),
                    core::mem::transmute_copy(&receivetimeout),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetClientCertificate<
            Identity: IWinHttpRequest_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            clientcertificate: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinHttpRequest_Impl::SetClientCertificate(
                    this,
                    core::mem::transmute(&clientcertificate),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetAutoLogonPolicy<
            Identity: IWinHttpRequest_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinHttpRequest_Impl::SetAutoLogonPolicy(
                    this,
                    core::mem::transmute_copy(&autologonpolicy),
                )
                .into()
            }
        }
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IWinHttpRequest as windows_core::Interface>::IID
...
windows_core::imp::define_interface!(
    ...
    0xf97f4e15_b787_4212_80d1_d380cbbf982e
);
...
impl IWinHttpRequestEvents {
    pub unsafe fn OnResponseStart(&self, status: i32, contenttype: &windows_core::BSTR) {
        unsafe {
            (windows_core::Interface::vtable(self).OnResponseStart)(
                windows_core::Interface::as_raw(self),
                status,
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn OnResponseDataAvailable(
        &self,
        data: *const *const super::super::System::Com::SAFEARRAY,
    ) {
        unsafe {
            (windows_core::Interface::vtable(self).OnResponseDataAvailable)(
                windows_core::Interface::as_raw(self),
                data,
            )
        }
    ...
    pub unsafe fn OnResponseFinished(&self) {
        unsafe {
            (windows_core::Interface::vtable(self).OnResponseFinished)(
                windows_core::Interface::as_raw(self),
            )
        }
    }
    pub unsafe fn OnError(&self, errornumber: i32, errordescription: &windows_core::BSTR) {
        unsafe {
            (windows_core::Interface::vtable(self).OnError)(
                windows_core::Interface::as_raw(self),
                errornumber,
                core::mem::transmute_copy(errordescription),
            )
        }
    }
}
...
pub struct IWinHttpRequestEvents_Vtbl {
    ...
    pub OnResponseStart:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, *mut core::ffi::c_void),
    #[cfg(feature = "Win32_System_Com")]
    pub OnResponseDataAvailable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const *const super::super::System::Com::SAFEARRAY,
    ),
...
impl IWinHttpRequestEvents_Vtbl {
    pub const fn new<Identity: IWinHttpRequestEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnResponseStart<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinHttpRequestEvents_Impl::OnResponseStart(
                    this,
        ...
        unsafe extern "system" fn OnResponseDataAvailable<
            Identity: IWinHttpRequestEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinHttpRequestEvents_Impl::OnResponseDataAvailable(
                    this,
                    core::mem::transmute_copy(&data),
                )
            }
        }
        unsafe extern "system" fn OnResponseFinished<
            Identity: IWinHttpRequestEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            this: *mut core::ffi::c_void,
            errornumber: i32,
            errordescription: *mut core::ffi::c_void,
        ) {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinHttpRequestEvents_Impl::OnError(
                    this,
                    core::mem::transmute_copy(&errornumber),
                    core::mem::transmute(&errordescription),
                )
            }
        }
        Self {
...
pub const SecureProtocol_TLS1: WinHttpRequestSecureProtocols =
    WinHttpRequestSecureProtocols(128i32);
pub const SecureProtocol_TLS1_1: WinHttpRequestSecureProtocols =
    WinHttpRequestSecureProtocols(512i32);
pub const SecureProtocol_TLS1_2: WinHttpRequestSecureProtocols =
    WinHttpRequestSecureProtocols(2048i32);
pub const SslErrorFlag_CertCNInvalid: WinHttpRequestSslErrorFlags =
    WinHttpRequestSslErrorFlags(4096i32);
pub const SslErrorFlag_CertDateInvalid: WinHttpRequestSslErrorFlags =
    WinHttpRequestSslErrorFlags(8192i32);
pub const SslErrorFlag_CertWrongUsage: WinHttpRequestSslErrorFlags =
    WinHttpRequestSslErrorFlags(512i32);
pub const SslErrorFlag_Ignore_All: WinHttpRequestSslErrorFlags =
    WinHttpRequestSslErrorFlags(13056i32);
...
pub const WINHTTP_FLAG_BYPASS_PROXY_CACHE: WINHTTP_OPEN_REQUEST_FLAGS =
    WINHTTP_OPEN_REQUEST_FLAGS(256u32);
pub const WINHTTP_FLAG_ESCAPE_DISABLE: WINHTTP_OPEN_REQUEST_FLAGS =
    WINHTTP_OPEN_REQUEST_FLAGS(64u32);
pub const WINHTTP_FLAG_ESCAPE_DISABLE_QUERY: WINHTTP_OPEN_REQUEST_FLAGS =
    WINHTTP_OPEN_REQUEST_FLAGS(128u32);
pub const WINHTTP_FLAG_ESCAPE_PERCENT: WINHTTP_OPEN_REQUEST_FLAGS =
    WINHTTP_OPEN_REQUEST_FLAGS(4u32);
...
pub type WINHTTP_PROXY_CHANGE_CALLBACK =
    Option<unsafe extern "system" fn(ullflags: u64, pvcontext: *const core::ffi::c_void)>;
...
pub const WINHTTP_WEB_SOCKET_ABORTED_CLOSE_STATUS: WINHTTP_WEB_SOCKET_CLOSE_STATUS =
    WINHTTP_WEB_SOCKET_CLOSE_STATUS(1006i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const WINHTTP_WEB_SOCKET_BINARY_FRAGMENT_BUFFER_TYPE: WINHTTP_WEB_SOCKET_BUFFER_TYPE =
    WINHTTP_WEB_SOCKET_BUFFER_TYPE(1i32);
pub const WINHTTP_WEB_SOCKET_BINARY_MESSAGE_BUFFER_TYPE: WINHTTP_WEB_SOCKET_BUFFER_TYPE =
    WINHTTP_WEB_SOCKET_BUFFER_TYPE(0i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WINHTTP_WEB_SOCKET_BUFFER_TYPE(pub i32);
pub const WINHTTP_WEB_SOCKET_CLOSE_BUFFER_TYPE: WINHTTP_WEB_SOCKET_BUFFER_TYPE =
    WINHTTP_WEB_SOCKET_BUFFER_TYPE(4i32);
pub const WINHTTP_WEB_SOCKET_CLOSE_OPERATION: WINHTTP_WEB_SOCKET_OPERATION =
    WINHTTP_WEB_SOCKET_OPERATION(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WINHTTP_WEB_SOCKET_CLOSE_STATUS(pub i32);
pub const WINHTTP_WEB_SOCKET_EMPTY_CLOSE_STATUS: WINHTTP_WEB_SOCKET_CLOSE_STATUS =
    WINHTTP_WEB_SOCKET_CLOSE_STATUS(1005i32);
pub const WINHTTP_WEB_SOCKET_ENDPOINT_TERMINATED_CLOSE_STATUS: WINHTTP_WEB_SOCKET_CLOSE_STATUS =
    WINHTTP_WEB_SOCKET_CLOSE_STATUS(1001i32);
pub const WINHTTP_WEB_SOCKET_INVALID_DATA_TYPE_CLOSE_STATUS: WINHTTP_WEB_SOCKET_CLOSE_STATUS =
    WINHTTP_WEB_SOCKET_CLOSE_STATUS(1003i32);
pub const WINHTTP_WEB_SOCKET_INVALID_PAYLOAD_CLOSE_STATUS: WINHTTP_WEB_SOCKET_CLOSE_STATUS =
    WINHTTP_WEB_SOCKET_CLOSE_STATUS(1007i32);
pub const WINHTTP_WEB_SOCKET_MAX_CLOSE_REASON_LENGTH: u32 = 123u32;
pub const WINHTTP_WEB_SOCKET_MESSAGE_TOO_BIG_CLOSE_STATUS: WINHTTP_WEB_SOCKET_CLOSE_STATUS =
    WINHTTP_WEB_SOCKET_CLOSE_STATUS(1009i32);
pub const WINHTTP_WEB_SOCKET_MIN_KEEPALIVE_VALUE: u32 = 15000u32;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WINHTTP_WEB_SOCKET_OPERATION(pub i32);
pub const WINHTTP_WEB_SOCKET_POLICY_VIOLATION_CLOSE_STATUS: WINHTTP_WEB_SOCKET_CLOSE_STATUS =
    WINHTTP_WEB_SOCKET_CLOSE_STATUS(1008i32);
pub const WINHTTP_WEB_SOCKET_PROTOCOL_ERROR_CLOSE_STATUS: WINHTTP_WEB_SOCKET_CLOSE_STATUS =
    WINHTTP_WEB_SOCKET_CLOSE_STATUS(1002i32);
pub const WINHTTP_WEB_SOCKET_RECEIVE_OPERATION: WINHTTP_WEB_SOCKET_OPERATION =
    WINHTTP_WEB_SOCKET_OPERATION(1i32);
pub const WINHTTP_WEB_SOCKET_SECURE_HANDSHAKE_ERROR_CLOSE_STATUS: WINHTTP_WEB_SOCKET_CLOSE_STATUS =
    WINHTTP_WEB_SOCKET_CLOSE_STATUS(1015i32);
pub const WINHTTP_WEB_SOCKET_SEND_OPERATION: WINHTTP_WEB_SOCKET_OPERATION =
    WINHTTP_WEB_SOCKET_OPERATION(0i32);
pub const WINHTTP_WEB_SOCKET_SERVER_ERROR_CLOSE_STATUS: WINHTTP_WEB_SOCKET_CLOSE_STATUS =
    WINHTTP_WEB_SOCKET_CLOSE_STATUS(1011i32);
pub const WINHTTP_WEB_SOCKET_SHUTDOWN_OPERATION: WINHTTP_WEB_SOCKET_OPERATION =
    WINHTTP_WEB_SOCKET_OPERATION(3i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const WINHTTP_WEB_SOCKET_SUCCESS_CLOSE_STATUS: WINHTTP_WEB_SOCKET_CLOSE_STATUS =
    WINHTTP_WEB_SOCKET_CLOSE_STATUS(1000i32);
pub const WINHTTP_WEB_SOCKET_UNSUPPORTED_EXTENSIONS_CLOSE_STATUS: WINHTTP_WEB_SOCKET_CLOSE_STATUS =
    WINHTTP_WEB_SOCKET_CLOSE_STATUS(1010i32);
pub const WINHTTP_WEB_SOCKET_UTF8_FRAGMENT_BUFFER_TYPE: WINHTTP_WEB_SOCKET_BUFFER_TYPE =
    WINHTTP_WEB_SOCKET_BUFFER_TYPE(3i32);
pub const WINHTTP_WEB_SOCKET_UTF8_MESSAGE_BUFFER_TYPE: WINHTTP_WEB_SOCKET_BUFFER_TYPE =
    WINHTTP_WEB_SOCKET_BUFFER_TYPE(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const WinHttpConnectionAcquireEnd: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(4i32);
pub const WinHttpConnectionAcquireStart: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(2i32);
pub const WinHttpConnectionAcquireWaitEnd: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(3i32);
pub const WinHttpConnectionEstablishmentEnd: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(8i32);
pub const WinHttpConnectionEstablishmentStart: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(7i32);
...
pub const WinHttpProxySettingsTypeUnknown: WINHTTP_PROXY_SETTINGS_TYPE =
    WINHTTP_PROXY_SETTINGS_TYPE(0i32);
pub const WinHttpProxySettingsTypeWsa: WINHTTP_PROXY_SETTINGS_TYPE =
    WINHTTP_PROXY_SETTINGS_TYPE(2i32);
pub const WinHttpProxySettingsTypeWsl: WINHTTP_PROXY_SETTINGS_TYPE =
    WINHTTP_PROXY_SETTINGS_TYPE(1i32);
pub const WinHttpProxyTlsHandshakeClientLeg1End: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(31i32);
pub const WinHttpProxyTlsHandshakeClientLeg1Size: WINHTTP_REQUEST_STAT_ENTRY =
    WINHTTP_REQUEST_STAT_ENTRY(12i32);
pub const WinHttpProxyTlsHandshakeClientLeg1Start: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(30i32);
pub const WinHttpProxyTlsHandshakeClientLeg2End: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(33i32);
pub const WinHttpProxyTlsHandshakeClientLeg2Size: WINHTTP_REQUEST_STAT_ENTRY =
    WINHTTP_REQUEST_STAT_ENTRY(14i32);
pub const WinHttpProxyTlsHandshakeClientLeg2Start: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(32i32);
pub const WinHttpProxyTlsHandshakeClientLeg3End: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(35i32);
pub const WinHttpProxyTlsHandshakeClientLeg3Start: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(34i32);
pub const WinHttpProxyTlsHandshakeServerLeg1Size: WINHTTP_REQUEST_STAT_ENTRY =
    WINHTTP_REQUEST_STAT_ENTRY(13i32);
pub const WinHttpProxyTlsHandshakeServerLeg2Size: WINHTTP_REQUEST_STAT_ENTRY =
    WINHTTP_REQUEST_STAT_ENTRY(15i32);
...
pub const WinHttpReceiveResponseBodyDecompressionDelta: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(26i32);
pub const WinHttpReceiveResponseEnd: WINHTTP_REQUEST_TIME_ENTRY = WINHTTP_REQUEST_TIME_ENTRY(27i32);
pub const WinHttpReceiveResponseHeadersDecompressionEnd: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(24i32);
pub const WinHttpReceiveResponseHeadersDecompressionStart: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(23i32);
pub const WinHttpReceiveResponseHeadersEnd: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(25i32);
pub const WinHttpReceiveResponseStart: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(22i32);
pub const WinHttpRequest: windows_core::GUID =
    windows_core::GUID::from_u128(0x2087c2f4_2cef_4953_a8ab_66779b670495);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WinHttpRequestAutoLogonPolicy(pub i32);
pub const WinHttpRequestHeadersCompressedSize: WINHTTP_REQUEST_STAT_ENTRY =
    WINHTTP_REQUEST_STAT_ENTRY(7i32);
...
pub const WinHttpRequestOption_EnableCertificateRevocationCheck: WinHttpRequestOption =
    WinHttpRequestOption(18i32);
pub const WinHttpRequestOption_EnableHttp1_1: WinHttpRequestOption = WinHttpRequestOption(17i32);
pub const WinHttpRequestOption_EnableHttpsToHttpRedirects: WinHttpRequestOption =
    WinHttpRequestOption(12i32);
pub const WinHttpRequestOption_EnablePassportAuthentication: WinHttpRequestOption =
    WinHttpRequestOption(13i32);
...
pub const WinHttpRequestOption_EscapePercentInURL: WinHttpRequestOption =
    WinHttpRequestOption(3i32);
pub const WinHttpRequestOption_MaxAutomaticRedirects: WinHttpRequestOption =
    WinHttpRequestOption(14i32);
pub const WinHttpRequestOption_MaxResponseDrainSize: WinHttpRequestOption =
    WinHttpRequestOption(16i32);
pub const WinHttpRequestOption_MaxResponseHeaderSize: WinHttpRequestOption =
    WinHttpRequestOption(15i32);
pub const WinHttpRequestOption_RejectUserpwd: WinHttpRequestOption = WinHttpRequestOption(19i32);
pub const WinHttpRequestOption_RevertImpersonationOverSsl: WinHttpRequestOption =
    WinHttpRequestOption(11i32);
...
pub const WinHttpRequestOption_SslErrorIgnoreFlags: WinHttpRequestOption =
    WinHttpRequestOption(4i32);
...
pub const WinHttpRequestOption_UrlEscapeDisableQuery: WinHttpRequestOption =
    WinHttpRequestOption(8i32);
...
pub const WinHttpResponseBodyCompressedSize: WINHTTP_REQUEST_STAT_ENTRY =
    WINHTTP_REQUEST_STAT_ENTRY(11i32);
pub const WinHttpResponseBodySize: WINHTTP_REQUEST_STAT_ENTRY = WINHTTP_REQUEST_STAT_ENTRY(10i32);
pub const WinHttpResponseHeadersCompressedSize: WINHTTP_REQUEST_STAT_ENTRY =
    WINHTTP_REQUEST_STAT_ENTRY(9i32);
pub const WinHttpResponseHeadersSize: WINHTTP_REQUEST_STAT_ENTRY = WINHTTP_REQUEST_STAT_ENTRY(8i32);
pub const WinHttpSecureDnsSettingDefault: WINHTTP_SECURE_DNS_SETTING =
    WINHTTP_SECURE_DNS_SETTING(0i32);
pub const WinHttpSecureDnsSettingForcePlaintext: WINHTTP_SECURE_DNS_SETTING =
    WINHTTP_SECURE_DNS_SETTING(1i32);
pub const WinHttpSecureDnsSettingMax: WINHTTP_SECURE_DNS_SETTING = WINHTTP_SECURE_DNS_SETTING(4i32);
pub const WinHttpSecureDnsSettingRequireEncryption: WINHTTP_SECURE_DNS_SETTING =
    WINHTTP_SECURE_DNS_SETTING(2i32);
pub const WinHttpSecureDnsSettingTryEncryptionWithFallback: WINHTTP_SECURE_DNS_SETTING =
    WINHTTP_SECURE_DNS_SETTING(3i32);
pub const WinHttpSendRequestEnd: WINHTTP_REQUEST_TIME_ENTRY = WINHTTP_REQUEST_TIME_ENTRY(21i32);
pub const WinHttpSendRequestHeadersCompressionEnd: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(19i32);
pub const WinHttpSendRequestHeadersCompressionStart: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(18i32);
pub const WinHttpSendRequestHeadersEnd: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(20i32);
...
pub const WinHttpTlsHandshakeClientLeg1End: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(10i32);
pub const WinHttpTlsHandshakeClientLeg1Size: WINHTTP_REQUEST_STAT_ENTRY =
    WINHTTP_REQUEST_STAT_ENTRY(2i32);
pub const WinHttpTlsHandshakeClientLeg1Start: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(9i32);
pub const WinHttpTlsHandshakeClientLeg2End: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(12i32);
pub const WinHttpTlsHandshakeClientLeg2Size: WINHTTP_REQUEST_STAT_ENTRY =
    WINHTTP_REQUEST_STAT_ENTRY(4i32);
pub const WinHttpTlsHandshakeClientLeg2Start: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(11i32);
pub const WinHttpTlsHandshakeClientLeg3End: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(14i32);
pub const WinHttpTlsHandshakeClientLeg3Start: WINHTTP_REQUEST_TIME_ENTRY =
    WINHTTP_REQUEST_TIME_ENTRY(13i32);
pub const WinHttpTlsHandshakeServerLeg1Size: WINHTTP_REQUEST_STAT_ENTRY =
    WINHTTP_REQUEST_STAT_ENTRY(3i32);
pub const WinHttpTlsHandshakeServerLeg2Size: WINHTTP_REQUEST_STAT_ENTRY =
    WINHTTP_REQUEST_STAT_ENTRY(5i32);

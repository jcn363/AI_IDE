windows_core::imp::define_interface!(
    ...
    0x64338358_366a_471b_bd56_dd8ef48e439b
);
windows_core::imp::interface_hierarchy!(IDisplayDeviceInterop, windows_core::IUnknown);
impl IDisplayDeviceInterop {
    #[cfg(feature = "Win32_Security")]
    pub unsafe fn CreateSharedHandle<P0>(
        &self,
        pobject: P0,
        psecurityattributes: *const super::super::super::Security::SECURITY_ATTRIBUTES,
        access: u32,
    ...
    pub unsafe fn OpenSharedHandle(
        &self,
        nthandle: super::super::super::Foundation::HANDLE,
...
pub trait IDisplayDeviceInterop_Impl: windows_core::IUnknownImpl {
    fn CreateSharedHandle(
        &self,
        pobject: windows_core::Ref<'_, windows_core::IInspectable>,
        psecurityattributes: *const super::super::super::Security::SECURITY_ATTRIBUTES,
        access: u32,
        name: &windows_core::HSTRING,
    ) -> windows_core::Result<super::super::super::Foundation::HANDLE>;
...
impl IDisplayDeviceInterop_Vtbl {
    pub const fn new<Identity: IDisplayDeviceInterop_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            phandle: *mut super::super::super::Foundation::HANDLE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDisplayDeviceInterop_Impl::CreateSharedHandle(
                    this,
                    core::mem::transmute_copy(&pobject),
                    core::mem::transmute_copy(&psecurityattributes),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDisplayDeviceInterop_Impl::OpenSharedHandle(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0xa6ba4205_e59e_4e71_b25b_4e436d21ee3d
);
windows_core::imp::interface_hierarchy!(IDisplayPathInterop, windows_core::IUnknown);
impl IDisplayPathInterop {
    pub unsafe fn CreateSourcePresentationHandle(
        &self,
    ) -> windows_core::Result<super::super::super::Foundation::HANDLE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSourcePresentationHandle)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetSourceId(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSourceId)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IDisplayPathInterop_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateSourcePresentationHandle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Foundation::HANDLE,
    ) -> windows_core::HRESULT,
    pub GetSourceId:
...
impl IDisplayPathInterop_Vtbl {
    pub const fn new<Identity: IDisplayPathInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateSourcePresentationHandle<
            Identity: IDisplayPathInterop_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pvalue: *mut super::super::super::Foundation::HANDLE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetSourceId<
            Identity: IDisplayPathInterop_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,

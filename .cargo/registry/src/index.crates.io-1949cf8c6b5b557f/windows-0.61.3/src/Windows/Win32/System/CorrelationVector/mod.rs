...
pub unsafe fn RtlInitializeCorrelationVector(
    ...
    windows_link::link!("ntdll.dll" "system" fn RtlInitializeCorrelationVector(correlationvector : *mut CORRELATION_VECTOR, version : i32, guid : *const windows_core::GUID) -> u32);
    unsafe {
        RtlInitializeCorrelationVector(
            correlationvector as _,
            version,

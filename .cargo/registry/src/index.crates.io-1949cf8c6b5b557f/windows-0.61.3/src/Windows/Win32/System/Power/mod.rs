...
pub unsafe fn DevicePowerEnumDevices(
    ...
    unsafe {
        DevicePowerEnumDevices(
            ...
            queryflags,
            preturnbuffer.unwrap_or(core::mem::zeroed()) as _,
            pbuffersize as _,
        )
    }
}
...
pub unsafe fn DevicePowerSetDeviceState<P0>(
    ...
    setflags: u32,
    setdata: Option<*const core::ffi::c_void>,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DevicePowerSetDeviceState(
            ...
            setflags,
            setdata.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn PowerCanRestoreIndividualDefaultPowerScheme(
    schemeguid: *const windows_core::GUID,
...
pub unsafe fn PowerCreatePossibleSetting(
    rootsystempowerkey: Option<super::Registry::HKEY>,
    subgroupofpowersettingsguid: *const windows_core::GUID,
    powersettingguid: *const windows_core::GUID,
    ...
    unsafe {
        PowerCreatePossibleSetting(
            rootsystempowerkey.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn PowerCreateRequest(
    context: *const super::Threading::REASON_CONTEXT,
...
pub unsafe fn PowerDeleteScheme(
    rootpowerkey: Option<super::Registry::HKEY>,
    schemeguid: *const windows_core::GUID,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn PowerDuplicateScheme(
    rootpowerkey: Option<super::Registry::HKEY>,
    sourceschemeguid: *const windows_core::GUID,
    destinationschemeguid: *mut *mut windows_core::GUID,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        PowerDuplicateScheme(
            rootpowerkey.unwrap_or(core::mem::zeroed()) as _,
            sourceschemeguid,
            destinationschemeguid as _,
        )
    }
}
#[cfg(feature = "Win32_System_Registry")]
...
pub unsafe fn PowerEnumerate(
    rootpowerkey: Option<super::Registry::HKEY>,
    schemeguid: Option<*const windows_core::GUID>,
    subgroupofpowersettingsguid: Option<*const windows_core::GUID>,
    ...
    unsafe {
        PowerEnumerate(
            rootpowerkey.unwrap_or(core::mem::zeroed()) as _,
            schemeguid.unwrap_or(core::mem::zeroed()) as _,
            subgroupofpowersettingsguid.unwrap_or(core::mem::zeroed()) as _,
            accessflags,
            index,
...
pub unsafe fn PowerGetActiveScheme(
    userrootpowerkey: Option<super::Registry::HKEY>,
    activepolicyguid: *mut *mut windows_core::GUID,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        PowerGetActiveScheme(
            userrootpowerkey.unwrap_or(core::mem::zeroed()) as _,
            activepolicyguid as _,
        )
    }
}
#[cfg(feature = "Win32_System_Registry")]
...
pub unsafe fn PowerIsSettingRangeDefined(
    subkeyguid: Option<*const windows_core::GUID>,
    settingguid: Option<*const windows_core::GUID>,
) -> bool {
    ...
    unsafe {
        PowerIsSettingRangeDefined(
            subkeyguid.unwrap_or(core::mem::zeroed()) as _,
            settingguid.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_System_Registry")]
...
pub unsafe fn PowerReadACDefaultIndex(
    rootpowerkey: Option<super::Registry::HKEY>,
    schemepersonalityguid: *const windows_core::GUID,
    subgroupofpowersettingsguid: Option<*const windows_core::GUID>,
    powersettingguid: *const windows_core::GUID,
...
pub unsafe fn PowerReadACValue(
    ...
    schemeguid: Option<*const windows_core::GUID>,
    subgroupofpowersettingsguid: Option<*const windows_core::GUID>,
    powersettingguid: Option<*const windows_core::GUID>,
    r#type: Option<*mut u32>,
    buffer: Option<*mut u8>,
    ...
    unsafe {
        PowerReadACValue(
            ...
            schemeguid.unwrap_or(core::mem::zeroed()) as _,
            subgroupofpowersettingsguid.unwrap_or(core::mem::zeroed()) as _,
            powersettingguid.unwrap_or(core::mem::zeroed()) as _,
            r#type.unwrap_or(core::mem::zeroed()) as _,
            buffer.unwrap_or(core::mem::zeroed()) as _,
            buffersize.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_System_Registry")]
...
pub unsafe fn PowerReadSettingAttributes(
    subgroupguid: Option<*const windows_core::GUID>,
    powersettingguid: Option<*const windows_core::GUID>,
) -> u32 {
    ...
    unsafe {
        PowerReadSettingAttributes(
            subgroupguid.unwrap_or(core::mem::zeroed()) as _,
            powersettingguid.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
pub unsafe fn PowerRemovePowerSetting(
    powersettingsubkeyguid: *const windows_core::GUID,
    powersettingguid: *const windows_core::GUID,
) -> super::super::Foundation::WIN32_ERROR {
...
#[inline]
pub unsafe fn PowerReportThermalEvent(
    event: *const THERMAL_EVENT,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn PowerSettingAccessCheck(
    accessflags: POWER_DATA_ACCESSOR,
    powerguid: Option<*const windows_core::GUID>,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn PowerSettingAccessCheckEx(
    ...
    unsafe {
        PowerSettingAccessCheckEx(
            accessflags,
            powerguid.unwrap_or(core::mem::zeroed()) as _,
            accesstype,
        )
    }
}
...
pub unsafe fn PowerSettingRegisterNotification(
    settingguid: *const windows_core::GUID,
    flags: super::super::UI::WindowsAndMessaging::REGISTER_NOTIFICATION_FLAGS,
    recipient: super::super::Foundation::HANDLE,
    registrationhandle: *mut *mut core::ffi::c_void,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        PowerSettingRegisterNotification(settingguid, flags, recipient, registrationhandle as _)
    }
}
#[inline]
...
pub unsafe fn PowerUnregisterFromEffectivePowerModeNotifications(
    registrationhandle: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn RegisterPowerSettingNotification(
    ...
    powersettingguid: *const windows_core::GUID,
    flags: super::super::UI::WindowsAndMessaging::REGISTER_NOTIFICATION_FLAGS,
) -> windows_core::Result<HPOWERNOTIFY> {
...
pub unsafe fn SetActivePwrScheme(
    uiid: u32,
    pglobalpowerpolicy: Option<*const GLOBAL_POWER_POLICY>,
    ppowerpolicy: Option<*const POWER_POLICY>,
) -> bool {
    ...
    unsafe {
        SetActivePwrScheme(
            uiid,
            pglobalpowerpolicy.unwrap_or(core::mem::zeroed()) as _,
            ppowerpolicy.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn ValidatePowerPolicies(
    pglobalpowerpolicy: Option<*mut GLOBAL_POWER_POLICY>,
    ppowerpolicy: Option<*mut POWER_POLICY>,
) -> bool {
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WritePwrScheme(
            puiid,
            lpszschemename.param().abi(),
            lpszdescription.param().abi(),
            lpscheme,
        )
    }
}
...
pub const BATTERY_CYCLE_COUNT_WMI_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xef98db24_0014_4c25_a50b_c724ae5cd371);
pub const BATTERY_DISCHARGING: u32 = 2u32;
pub const BATTERY_FULL_CHARGED_CAPACITY_WMI_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x40b40565_96f7_4435_8694_97e0e4395905);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const BATTERY_RUNTIME_WMI_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x535a3767_1ac2_49bc_a077_3f7a02e40aec);
...
pub const BATTERY_STATIC_DATA_WMI_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x05e1e463_e4e2_4ea9_80cb_9bd4b3ca0655);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const BATTERY_STATUS_CHANGE_WMI_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xcddfa0c3_7c5b_4e43_a034_059fa5b84364);
pub const BATTERY_STATUS_WMI_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xfc4670d1_ebbf_416e_87ce_374a4ebc111a);
pub const BATTERY_SYSTEM_BATTERY: u32 = 2147483648u32;
pub const BATTERY_TAG_CHANGE_WMI_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x5e1f6e19_8786_4d23_94fc_9e746bd5d888);
pub const BATTERY_TAG_INVALID: u32 = 0u32;
pub const BATTERY_TEMPERATURE_WMI_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x1a52a14d_adce_4a44_9a3e_c8d8f15ff2c2);
...
pub const BlackBoxRecorderDirectAccessBuffer: POWER_INFORMATION_LEVEL =
    POWER_INFORMATION_LEVEL(97i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub type EFFECTIVE_POWER_MODE_CALLBACK = Option<
    unsafe extern "system" fn(mode: EFFECTIVE_POWER_MODE, context: *const core::ffi::c_void),
>;
...
pub const GUID_CLASS_INPUT: windows_core::GUID =
    windows_core::GUID::from_u128(0x4d1e55b2_f16f_11cf_88cb_001111000030);
pub const GUID_DEVICE_ACPI_TIME: windows_core::GUID =
    windows_core::GUID::from_u128(0x97f99bf6_4497_4f18_bb22_4b9fb2fbef9c);
pub const GUID_DEVICE_APPLICATIONLAUNCH_BUTTON: windows_core::GUID =
    windows_core::GUID::from_u128(0x629758ee_986e_4d9e_8e47_de27f8ab054d);
pub const GUID_DEVICE_BATTERY: windows_core::GUID =
    windows_core::GUID::from_u128(0x72631e54_78a4_11d0_bcf7_00aa00b7b32a);
pub const GUID_DEVICE_ENERGY_METER: windows_core::GUID =
    windows_core::GUID::from_u128(0x45bd8344_7ed6_49cf_a440_c276c933b053);
pub const GUID_DEVICE_FAN: windows_core::GUID =
    windows_core::GUID::from_u128(0x05ecd13d_81da_4a2a_8a4c_524f23dd4dc9);
pub const GUID_DEVICE_LID: windows_core::GUID =
    windows_core::GUID::from_u128(0x4afa3d52_74a7_11d0_be5e_00a0c9062857);
pub const GUID_DEVICE_MEMORY: windows_core::GUID =
    windows_core::GUID::from_u128(0x3fd0f03d_92e0_45fb_b75c_5ed8ffb01021);
pub const GUID_DEVICE_MESSAGE_INDICATOR: windows_core::GUID =
    windows_core::GUID::from_u128(0xcd48a365_fa94_4ce2_a232_a1b764e5d8b4);
pub const GUID_DEVICE_PROCESSOR: windows_core::GUID =
    windows_core::GUID::from_u128(0x97fadb10_4e33_40ae_359c_8bef029dbdd0);
pub const GUID_DEVICE_SYS_BUTTON: windows_core::GUID =
    windows_core::GUID::from_u128(0x4afa3d53_74a7_11d0_be5e_00a0c9062857);
pub const GUID_DEVICE_THERMAL_ZONE: windows_core::GUID =
    windows_core::GUID::from_u128(0x4afa3d51_74a7_11d0_be5e_00a0c9062857);
pub const GUID_DEVINTERFACE_THERMAL_COOLING: windows_core::GUID =
    windows_core::GUID::from_u128(0xdbe4373d_3c81_40cb_ace4_e0e5d05f0c9f);
pub const GUID_DEVINTERFACE_THERMAL_MANAGER: windows_core::GUID =
    windows_core::GUID::from_u128(0x927ec093_69a4_4bc0_bd02_711664714463);
...
pub const PDCAP_WAKE_FROM_D0_SUPPORTED: DEVICE_POWER_CAPABILITIES =
    DEVICE_POWER_CAPABILITIES(16u32);
pub const PDCAP_WAKE_FROM_D1_SUPPORTED: DEVICE_POWER_CAPABILITIES =
    DEVICE_POWER_CAPABILITIES(32u32);
pub const PDCAP_WAKE_FROM_D2_SUPPORTED: DEVICE_POWER_CAPABILITIES =
    DEVICE_POWER_CAPABILITIES(64u32);
pub const PDCAP_WAKE_FROM_D3_SUPPORTED: DEVICE_POWER_CAPABILITIES =
    DEVICE_POWER_CAPABILITIES(128u32);
pub const PDCAP_WAKE_FROM_S0_SUPPORTED: DEVICE_POWER_CAPABILITIES =
    DEVICE_POWER_CAPABILITIES(1048576u32);
pub const PDCAP_WAKE_FROM_S1_SUPPORTED: DEVICE_POWER_CAPABILITIES =
    DEVICE_POWER_CAPABILITIES(2097152u32);
pub const PDCAP_WAKE_FROM_S2_SUPPORTED: DEVICE_POWER_CAPABILITIES =
    DEVICE_POWER_CAPABILITIES(4194304u32);
pub const PDCAP_WAKE_FROM_S3_SUPPORTED: DEVICE_POWER_CAPABILITIES =
    DEVICE_POWER_CAPABILITIES(8388608u32);
...
pub const PPM_IDLESTATES_DATA_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xba138e10_e250_4ad7_8616_cf1a7ad410e7);
pub const PPM_IDLESTATE_CHANGE_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x4838fe4f_f71c_4e51_9ecc_8430a7ac4c6c);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PPM_IDLE_ACCOUNTING_EX_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xd67abd39_81f8_4a5e_8152_72e31ec912ee);
pub const PPM_IDLE_ACCOUNTING_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xe2a26f78_ae07_4ee0_a30f_ce54f55a94cd);
...
pub const PPM_PERFMON_PERFSTATE_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x7fd18652_0cfe_40d2_b0a1_0b066a87759e);
...
pub const PPM_PERFSTATES_DATA_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x5708cc20_7d40_4bf4_b4aa_2b01338d0126);
pub const PPM_PERFSTATE_CHANGE_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xa5b32ddd_7f39_4abc_b892_900e43b59ebb);
pub const PPM_PERFSTATE_DOMAIN_CHANGE_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x995e6b7f_d653_497a_b978_36a30c29bf01);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PPM_THERMALCONSTRAINT_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0xa852c2c8_1a4c_423b_8c2c_f30d82931a88);
pub const PPM_THERMAL_POLICY_CHANGE_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x48f377b8_6880_4c7b_8bdc_380176c6654d);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub type PWRSCHEMESENUMPROC = Option<
    unsafe extern "system" fn(
        index: u32,
        namesize: u32,
...
>;
pub type PWRSCHEMESENUMPROC_V1 = Option<
    unsafe extern "system" fn(
        index: u32,
        namesize: u32,
        name: *const i8,

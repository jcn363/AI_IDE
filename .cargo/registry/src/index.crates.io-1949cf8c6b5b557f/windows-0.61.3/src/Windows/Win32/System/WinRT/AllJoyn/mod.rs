windows_core::imp::define_interface!(
    ...
    0x4b8f7505_b239_4e7b_88af_f6682575d861
);
...
impl IWindowsDevicesAllJoynBusAttachmentFactoryInterop {
    pub unsafe fn CreateFromWin32Handle<T>(
        &self,
        win32handle: u64,
        enableaboutdata: u8,
        ...
        T: windows_core::Interface,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(self).CreateFromWin32Handle)(
...
pub struct IWindowsDevicesAllJoynBusAttachmentFactoryInterop_Vtbl {
    ...
    pub CreateFromWin32Handle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        u8,
...
impl IWindowsDevicesAllJoynBusAttachmentFactoryInterop_Vtbl {
    pub const fn new<
        ...
        const OFFSET: isize,
    >() -> Self {
        unsafe extern "system" fn CreateFromWin32Handle<
            Identity: IWindowsDevicesAllJoynBusAttachmentFactoryInterop_Impl,
            const OFFSET: isize,
        >(
            ...
            unsafe {
                ...
                IWindowsDevicesAllJoynBusAttachmentFactoryInterop_Impl::CreateFromWin32Handle(
                    this,
                    core::mem::transmute_copy(&win32handle),
                    core::mem::transmute_copy(&enableaboutdata),
...
windows_core::imp::define_interface!(
    ...
    0xfd89c65b_b50e_4a19_9d0c_b42b783281cd
);
windows_core::imp::interface_hierarchy!(
    IWindowsDevicesAllJoynBusAttachmentInterop,
    windows_core::IUnknown,
...
impl IWindowsDevicesAllJoynBusAttachmentInterop {
    pub unsafe fn Win32Handle(&self) -> windows_core::Result<u64> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).Win32Handle)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
windows_core::imp::define_interface!(
    ...
    0x6174e506_8b95_4e36_95c0_b88fed34938c
);
windows_core::imp::interface_hierarchy!(
    IWindowsDevicesAllJoynBusObjectFactoryInterop,
    windows_core::IUnknown,
    ...
    >() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWindowsDevicesAllJoynBusObjectFactoryInterop_Impl::CreateFromWin32Handle(
                    this,
                    core::mem::transmute_copy(&win32handle),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppv),
...
windows_core::imp::define_interface!(
    ...
    0xd78aa3d5_5054_428f_99f2_ec3a5de3c3bc
);
windows_core::imp::interface_hierarchy!(
    IWindowsDevicesAllJoynBusObjectInterop,
    windows_core::IUnknown,
...
impl IWindowsDevicesAllJoynBusObjectInterop {
    pub unsafe fn AddPropertyGetHandler(
        &self,
        context: *const core::ffi::c_void,
        interfacename: &windows_core::HSTRING,
        callback: isize,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddPropertyGetHandler)(
                windows_core::Interface::as_raw(self),
                context,
    ...
    pub unsafe fn AddPropertySetHandler(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AddPropertySetHandler)(
                windows_core::Interface::as_raw(self),
                context,
                core::mem::transmute_copy(interfacename),
                callback,
...
pub struct IWindowsDevicesAllJoynBusObjectInterop_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AddPropertyGetHandler: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        *mut core::ffi::c_void,
        isize,
    ) -> windows_core::HRESULT,
    pub AddPropertySetHandler: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        *mut core::ffi::c_void,
        isize,
...
impl IWindowsDevicesAllJoynBusObjectInterop_Vtbl {
    pub const fn new<Identity: IWindowsDevicesAllJoynBusObjectInterop_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn AddPropertyGetHandler<
            Identity: IWindowsDevicesAllJoynBusObjectInterop_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            context: *const core::ffi::c_void,
            interfacename: *mut core::ffi::c_void,
            callback: isize,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWindowsDevicesAllJoynBusObjectInterop_Impl::AddPropertyGetHandler(
                    this,
                    core::mem::transmute_copy(&context),
                    core::mem::transmute(&interfacename),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWindowsDevicesAllJoynBusObjectInterop_Impl::AddPropertySetHandler(
                    this,
                    core::mem::transmute_copy(&context),
                    core::mem::transmute(&interfacename),
                    core::mem::transmute_copy(&callback),

...
#[inline]
pub unsafe fn StartXpsPrintJob<P0, P1, P2>(
    printername: P0,
    jobname: P1,
    outputfilename: P2,
    ...
    documentstream: *mut Option<IXpsPrintJobStream>,
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        StartXpsPrintJob(
            printername.param().abi(),
            jobname.param().abi(),
            outputfilename.param().abi(),
            progressevent,
            completionevent,
            core::mem::transmute(printablepageson.as_ptr()),
            printablepageson.len().try_into().unwrap(),
...
pub unsafe fn StartXpsPrintJob1<P0, P1, P2>(
    ...
    completionevent: super::super::super::Foundation::HANDLE,
    xpsprintjob: *mut Option<IXpsPrintJob>,
    printcontentreceiver: *mut Option<super::IXpsOMPackageTarget>,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        StartXpsPrintJob1(
            ...
            completionevent,
            core::mem::transmute(xpsprintjob),
            core::mem::transmute(printcontentreceiver),
        )
        .ok()
    }
}
pub const ID_DOCUMENTPACKAGETARGET_MSXPS: windows_core::GUID =
    windows_core::GUID::from_u128(0x9cae40a8_ded1_41c9_a9fd_d735ef33aeda);
pub const ID_DOCUMENTPACKAGETARGET_OPENXPS: windows_core::GUID =
    windows_core::GUID::from_u128(0x0056bb72_8c9c_4612_bd0f_93012a87099d);
pub const ID_DOCUMENTPACKAGETARGET_OPENXPS_WITH_3D: windows_core::GUID =
    windows_core::GUID::from_u128(0x63dbd720_8b14_4577_b074_7bb11b596d28);
#[cfg(feature = "Win32_System_Com")]
...
impl IPrintDocumentPackageStatusEvent {
    pub unsafe fn PackageStatusUpdated(
        &self,
        packagestatus: *const PrintDocumentPackageStatus,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).PackageStatusUpdated)(
...
pub struct IPrintDocumentPackageStatusEvent_Vtbl {
    ...
    pub PackageStatusUpdated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const PrintDocumentPackageStatus,
...
pub trait IPrintDocumentPackageStatusEvent_Impl:
    super::super::super::System::Com::IDispatch_Impl
{
...
impl IPrintDocumentPackageStatusEvent_Vtbl {
    ...
    {
        unsafe extern "system" fn PackageStatusUpdated<
        ...
        >(
            ...
            unsafe {
                ...
                IPrintDocumentPackageStatusEvent_Impl::PackageStatusUpdated(
                    this,
                    core::mem::transmute_copy(&packagestatus),
                )
                .into()
            }
        }
...
impl IPrintDocumentPackageTarget {
    pub unsafe fn GetPackageTargetTypes(
        &self,
        targetcount: *mut u32,
        targettypes: *mut *mut windows_core::GUID,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPackageTargetTypes)(
                windows_core::Interface::as_raw(self),
                targetcount as _,
                targettypes as _,
            )
    ...
    pub unsafe fn GetPackageTarget<T>(
        &self,
        guidtargettype: *const windows_core::GUID,
        ...
        T: windows_core::Interface,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetPackageTarget)(
                windows_core::Interface::as_raw(self),
                guidtargettype,
                &T::IID,
                &mut result__,
...
pub struct IPrintDocumentPackageTarget_Vtbl {
    ...
    pub GetPackageTargetTypes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub GetPackageTarget: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait IPrintDocumentPackageTarget_Impl: windows_core::IUnknownImpl {
    ...
    fn GetPackageTarget(
        ...
        ppvtarget: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
...
impl IPrintDocumentPackageTarget_Vtbl {
    pub const fn new<Identity: IPrintDocumentPackageTarget_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetPackageTargetTypes<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintDocumentPackageTarget_Impl::GetPackageTargetTypes(
                    this,
                    core::mem::transmute_copy(&targetcount),
                    core::mem::transmute_copy(&targettypes),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetPackageTarget<
            Identity: IPrintDocumentPackageTarget_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintDocumentPackageTarget_Impl::GetPackageTarget(
                    this,
                    core::mem::transmute_copy(&guidtargettype),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppvtarget),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xc560298a_535c_48f9_866a_632540660cb4
);
...
impl IPrintDocumentPackageTarget2 {
    pub unsafe fn GetIsTargetIppPrinter(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).GetIsTargetIppPrinter)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).GetTargetIppPrintDevice)(
                windows_core::Interface::as_raw(self),
                &T::IID,
                &mut result__,
            )
...
pub struct IPrintDocumentPackageTarget2_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetIsTargetIppPrinter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub GetTargetIppPrintDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl IPrintDocumentPackageTarget2_Vtbl {
    pub const fn new<Identity: IPrintDocumentPackageTarget2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetIsTargetIppPrinter<
            Identity: IPrintDocumentPackageTarget2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            isippprinter: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetTargetIppPrintDevice<
            Identity: IPrintDocumentPackageTarget2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintDocumentPackageTarget2_Impl::GetTargetIppPrintDevice(
                    this,
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppvtarget),
                )
...
windows_core::imp::define_interface!(
    ...
    0xd2959bf7_b31b_4a3d_9600_712eb1335ba4
);
...
impl IPrintDocumentPackageTargetFactory {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateDocumentPackageTargetForPrintJob<P0, P1, P2, P3>(
        &self,
        printername: P0,
        jobname: P1,
        joboutputstream: P2,
        jobprintticketstream: P3,
    ) -> windows_core::Result<IPrintDocumentPackageTarget>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        ...
        P3: windows_core::Param<super::super::super::System::Com::IStream>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateDocumentPackageTargetForPrintJob)(
                windows_core::Interface::as_raw(self),
                printername.param().abi(),
                jobname.param().abi(),
                joboutputstream.param().abi(),
                jobprintticketstream.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub struct IPrintDocumentPackageTargetFactory_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_System_Com")]
    pub CreateDocumentPackageTargetForPrintJob: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *mut core::ffi::c_void,
...
pub trait IPrintDocumentPackageTargetFactory_Impl: windows_core::IUnknownImpl {
    fn CreateDocumentPackageTargetForPrintJob(
        &self,
        printername: &windows_core::PCWSTR,
        jobname: &windows_core::PCWSTR,
        joboutputstream: windows_core::Ref<'_, super::super::super::System::Com::IStream>,
        jobprintticketstream: windows_core::Ref<'_, super::super::super::System::Com::IStream>,
    ) -> windows_core::Result<IPrintDocumentPackageTarget>;
}
#[cfg(feature = "Win32_System_Com")]
impl IPrintDocumentPackageTargetFactory_Vtbl {
    pub const fn new<Identity: IPrintDocumentPackageTargetFactory_Impl, const OFFSET: isize>(
    ) -> Self {
        ...
        >(
            ...
            printername: windows_core::PCWSTR,
            jobname: windows_core::PCWSTR,
            joboutputstream: *mut core::ffi::c_void,
            jobprintticketstream: *mut core::ffi::c_void,
            docpackagetarget: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            CreateDocumentPackageTargetForPrintJob: CreateDocumentPackageTargetForPrintJob::<
                Identity,
                OFFSET,
            >,
        }
...
windows_core::imp::define_interface!(
    IXpsPrintJob,
    IXpsPrintJob_Vtbl,
    0x5ab89b06_8194_425f_ab3b_d7a96e350161
);
...
impl IXpsPrintJob {
    ...
    pub unsafe fn GetJobStatus(&self, jobstatus: *mut XPS_JOB_STATUS) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetJobStatus)(
                windows_core::Interface::as_raw(self),
                jobstatus as _,
            )
            .ok()
...
impl IXpsPrintJob_Vtbl {
    pub const fn new<Identity: IXpsPrintJob_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Cancel<Identity: IXpsPrintJob_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetJobStatus<Identity: IXpsPrintJob_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            jobstatus: *mut XPS_JOB_STATUS,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
#[cfg(feature = "Win32_System_Com")]
pub trait IXpsPrintJobStream_Impl:
    super::super::super::System::Com::ISequentialStream_Impl
{
...
impl IXpsPrintJobStream_Vtbl {
    pub const fn new<Identity: IXpsPrintJobStream_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Close<Identity: IXpsPrintJobStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        Self {
            base__: super::super::super::System::Com::ISequentialStream_Vtbl::new::<Identity, OFFSET>(
            ),
...
pub const PrintDocumentPackageCompletion_Canceled: PrintDocumentPackageCompletion =
    PrintDocumentPackageCompletion(2i32);
pub const PrintDocumentPackageCompletion_Completed: PrintDocumentPackageCompletion =
    PrintDocumentPackageCompletion(1i32);
pub const PrintDocumentPackageCompletion_Failed: PrintDocumentPackageCompletion =
    PrintDocumentPackageCompletion(3i32);
pub const PrintDocumentPackageCompletion_InProgress: PrintDocumentPackageCompletion =
    PrintDocumentPackageCompletion(0i32);
#[repr(C)]
...
pub const PrintDocumentPackageTarget: windows_core::GUID =
    windows_core::GUID::from_u128(0x4842669e_9947_46ea_8ba2_d8cce432c2ca);
pub const PrintDocumentPackageTargetFactory: windows_core::GUID =
    windows_core::GUID::from_u128(0x348ef17d_6c81_4982_92b4_ee188a43867a);

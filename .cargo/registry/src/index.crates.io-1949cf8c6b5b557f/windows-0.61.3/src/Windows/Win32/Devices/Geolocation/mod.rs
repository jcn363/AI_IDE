...
pub const CivicAddressReport: windows_core::GUID =
    windows_core::GUID::from_u128(0xd39e7bdd_7d05_46b8_8721_80cf035f57d7);
pub const CivicAddressReportFactory: windows_core::GUID =
    windows_core::GUID::from_u128(0x2a11f42c_3e81_4ad4_9cbe_45579d89671a);
pub const DefaultLocation: windows_core::GUID =
    windows_core::GUID::from_u128(0x8b7fbfe0_5cd7_494a_af8c_283a65707506);
pub const DispCivicAddressReport: windows_core::GUID =
    windows_core::GUID::from_u128(0x4c596aec_8544_4082_ba9f_eb0a7d8e65c6);
pub const DispLatLongReport: windows_core::GUID =
    windows_core::GUID::from_u128(0x7a7c3277_8f84_4636_95b2_ebb5507ff77e);
...
pub const GUID_DEVINTERFACE_GNSS: windows_core::GUID =
    windows_core::GUID::from_u128(0x3336e5e4_018a_4669_84c5_bd05f3bd368b);
windows_core::imp::define_interface!(
    ICivicAddressReport,
    ICivicAddressReport_Vtbl,
    0xc0b19f70_4adf_445d_87f2_cad8fd711792
);
...
impl ICivicAddressReport {
    pub unsafe fn GetAddressLine1(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).GetAddressLine1)(
    ...
    pub unsafe fn GetAddressLine2(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAddressLine2)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn GetCity(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCity)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn GetStateProvince(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStateProvince)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn GetPostalCode(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPostalCode)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn GetCountryRegion(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCountryRegion)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn GetDetailLevel(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDetailLevel)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct ICivicAddressReport_Vtbl {
    ...
    pub GetAddressLine1: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetAddressLine2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetCity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetStateProvince: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetPostalCode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetCountryRegion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetDetailLevel:
...
impl ICivicAddressReport_Vtbl {
    pub const fn new<Identity: ICivicAddressReport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetAddressLine1<
            Identity: ICivicAddressReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstraddress1: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetAddressLine2<
            Identity: ICivicAddressReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstraddress2: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetCity<
            Identity: ICivicAddressReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrcity: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetStateProvince<
            Identity: ICivicAddressReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrstateprovince: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetPostalCode<
            Identity: ICivicAddressReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrpostalcode: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetCountryRegion<
            Identity: ICivicAddressReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrcountryregion: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetDetailLevel<
            Identity: ICivicAddressReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<ICivicAddressReport as windows_core::Interface>::IID
...
windows_core::imp::define_interface!(
    ...
    0xbf773b93_c64f_4bee_beb2_67c0b8df66e0
);
#[cfg(feature = "Win32_System_Com")]
...
impl ICivicAddressReportFactory {
    pub unsafe fn CivicAddressReport(&self) -> windows_core::Result<IDispCivicAddressReport> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CivicAddressReport)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
...
pub struct ICivicAddressReportFactory_Vtbl {
    ...
    pub CivicAddressReport: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ICivicAddressReportFactory_Vtbl {
    pub const fn new<Identity: ICivicAddressReportFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CivicAddressReport<
        ...
        Self {
            base__: ILocationReportFactory_Vtbl::new::<Identity, OFFSET>(),
            CivicAddressReport: CivicAddressReport::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<ICivicAddressReportFactory as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<ILocationReportFactory as windows_core::Interface>::IID
    }
}
#[cfg(all(
    feature = "Win32_System_Com",
...
windows_core::imp::define_interface!(
    ...
    0xa65af77e_969a_4a2e_8aca_33bb7cbb1235
);
windows_core::imp::interface_hierarchy!(IDefaultLocation, windows_core::IUnknown);
impl IDefaultLocation {
    pub unsafe fn SetReport<P1>(
        &self,
        reporttype: *const windows_core::GUID,
        plocationreport: P1,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetReport)(
                windows_core::Interface::as_raw(self),
                reporttype,
                plocationreport.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn GetReport(
        &self,
        reporttype: *const windows_core::GUID,
    ) -> windows_core::Result<ILocationReport> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetReport)(
                windows_core::Interface::as_raw(self),
                reporttype,
                &mut result__,
            )
...
pub struct IDefaultLocation_Vtbl {
    ...
    pub SetReport: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetReport: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IDefaultLocation_Impl: windows_core::IUnknownImpl {
    fn SetReport(
        &self,
        reporttype: *const windows_core::GUID,
        plocationreport: windows_core::Ref<'_, ILocationReport>,
    ) -> windows_core::Result<()>;
    fn GetReport(
        &self,
        reporttype: *const windows_core::GUID,
...
impl IDefaultLocation_Vtbl {
    pub const fn new<Identity: IDefaultLocation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetReport<
            Identity: IDefaultLocation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            reporttype: *const windows_core::GUID,
            plocationreport: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDefaultLocation_Impl::SetReport(
                    this,
                    core::mem::transmute_copy(&reporttype),
                    core::mem::transmute_copy(&plocationreport),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetReport<
            Identity: IDefaultLocation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            reporttype: *const windows_core::GUID,
            pplocationreport: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x16ff1a34_9e30_42c3_b44d_e22513b5767a
);
#[cfg(feature = "Win32_System_Com")]
...
impl IDispCivicAddressReport {
    pub unsafe fn AddressLine1(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AddressLine1)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn AddressLine2(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AddressLine2)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn City(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).City)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn StateProvince(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StateProvince)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn PostalCode(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PostalCode)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn CountryRegion(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CountryRegion)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct IDispCivicAddressReport_Vtbl {
    ...
    pub AddressLine1: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AddressLine2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub StateProvince: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub CountryRegion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DetailLevel:
...
impl IDispCivicAddressReport_Vtbl {
    pub const fn new<Identity: IDispCivicAddressReport_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            paddress1: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn AddressLine2<
            Identity: IDispCivicAddressReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            paddress2: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn City<
            Identity: IDispCivicAddressReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pcity: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn StateProvince<
            Identity: IDispCivicAddressReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pstateprovince: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn PostalCode<
            Identity: IDispCivicAddressReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppostalcode: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CountryRegion<
            Identity: IDispCivicAddressReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pcountryregion: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IDispCivicAddressReport as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
windows_core::imp::define_interface!(
    ...
    0x8ae32723_389b_4a11_9957_5bdd48fc9617
);
#[cfg(feature = "Win32_System_Com")]
...
impl IDispLatLongReport {
    pub unsafe fn Latitude(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Latitude)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn Longitude(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Longitude)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ErrorRadius(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ErrorRadius)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn Altitude(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Altitude)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn AltitudeError(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AltitudeError)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
impl IDispLatLongReport_Vtbl {
    pub const fn new<Identity: IDispLatLongReport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Latitude<
        ...
        unsafe extern "system" fn Longitude<
            Identity: IDispLatLongReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ErrorRadius<
            Identity: IDispLatLongReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Altitude<
            Identity: IDispLatLongReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AltitudeError<
            Identity: IDispLatLongReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IDispLatLongReport as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
windows_core::imp::define_interface!(
    ILatLongReport,
    ILatLongReport_Vtbl,
    0x7fed806d_0ef8_4f07_80ac_36a0beae3134
);
...
impl ILatLongReport {
    pub unsafe fn GetLatitude(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLatitude)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetLongitude(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLongitude)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetErrorRadius(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetErrorRadius)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetAltitude(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAltitude)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetAltitudeError(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAltitudeError)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
impl ILatLongReport_Vtbl {
    pub const fn new<Identity: ILatLongReport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetLatitude<
        ...
        unsafe extern "system" fn GetLongitude<
            Identity: ILatLongReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetErrorRadius<
            Identity: ILatLongReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetAltitude<
            Identity: ILatLongReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetAltitudeError<
            Identity: ILatLongReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<ILatLongReport as windows_core::Interface>::IID
            || iid == &<ILocationReport as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
windows_core::imp::define_interface!(
    ...
    ILatLongReportFactory_Vtbl,
    0x3f0804cb_b114_447d_83dd_390174ebb082
);
#[cfg(feature = "Win32_System_Com")]
...
impl ILatLongReportFactory {
    pub unsafe fn LatLongReport(&self) -> windows_core::Result<IDispLatLongReport> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LatLongReport)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ILatLongReportFactory_Vtbl {
    pub base__: ILocationReportFactory_Vtbl,
    pub LatLongReport: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ILatLongReportFactory_Vtbl {
    pub const fn new<Identity: ILatLongReportFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn LatLongReport<
        ...
        Self {
            base__: ILocationReportFactory_Vtbl::new::<Identity, OFFSET>(),
            LatLongReport: LatLongReport::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<ILatLongReportFactory as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<ILocationReportFactory as windows_core::Interface>::IID
    }
}
...
windows_core::imp::define_interface!(
    ILocation,
    ILocation_Vtbl,
    0xab2ece69_56d9_4f28_b525_de1b0ee44237
);
windows_core::imp::interface_hierarchy!(ILocation, windows_core::IUnknown);
impl ILocation {
    pub unsafe fn RegisterForReport<P0>(
        &self,
        pevents: P0,
        reporttype: *const windows_core::GUID,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterForReport)(
                windows_core::Interface::as_raw(self),
                pevents.param().abi(),
                reporttype,
    ...
    pub unsafe fn UnregisterForReport(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).UnregisterForReport)(
                windows_core::Interface::as_raw(self),
                reporttype,
            )
            .ok()
    ...
    pub unsafe fn GetReportStatus(
        &self,
        reporttype: *const windows_core::GUID,
    ) -> windows_core::Result<LOCATION_REPORT_STATUS> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetReportStatus)(
                windows_core::Interface::as_raw(self),
                reporttype,
                &mut result__,
            )
    ...
    pub unsafe fn GetReportInterval(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetReportInterval)(
                windows_core::Interface::as_raw(self),
                reporttype,
                &mut result__,
            )
    ...
    pub unsafe fn SetReportInterval(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetReportInterval)(
                windows_core::Interface::as_raw(self),
                reporttype,
    ...
    pub unsafe fn GetDesiredAccuracy(
        &self,
        reporttype: *const windows_core::GUID,
    ) -> windows_core::Result<super::Sensors::LOCATION_DESIRED_ACCURACY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDesiredAccuracy)(
                windows_core::Interface::as_raw(self),
                reporttype,
                &mut result__,
            )
    ...
    pub unsafe fn SetDesiredAccuracy(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetDesiredAccuracy)(
                windows_core::Interface::as_raw(self),
                reporttype,
                desiredaccuracy,
            )
    ...
    pub unsafe fn RequestPermissions(
        &self,
        hparent: Option<super::super::Foundation::HWND>,
        preporttypes: &[windows_core::GUID],
        fmodal: bool,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RequestPermissions)(
                windows_core::Interface::as_raw(self),
                hparent.unwrap_or(core::mem::zeroed()) as _,
                core::mem::transmute(preporttypes.as_ptr()),
                preporttypes.len().try_into().unwrap(),
                fmodal.into(),
            )
            .ok()
        }
...
pub struct ILocation_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub RegisterForReport: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        u32,
    ) -> windows_core::HRESULT,
    pub UnregisterForReport: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub GetReport: unsafe extern "system" fn(
    ...
    pub GetReportStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut LOCATION_REPORT_STATUS,
    ) -> windows_core::HRESULT,
    pub GetReportInterval: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub SetReportInterval: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        u32,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_Devices_Sensors")]
    pub GetDesiredAccuracy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut super::Sensors::LOCATION_DESIRED_ACCURACY,
    ) -> windows_core::HRESULT,
    ...
    pub SetDesiredAccuracy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        super::Sensors::LOCATION_DESIRED_ACCURACY,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Devices_Sensors"))]
...
pub trait ILocation_Impl: windows_core::IUnknownImpl {
    fn RegisterForReport(
        &self,
        pevents: windows_core::Ref<'_, ILocationEvents>,
        reporttype: *const windows_core::GUID,
        dwrequestedreportinterval: u32,
    ) -> windows_core::Result<()>;
    ...
    fn GetReportInterval(&self, reporttype: *const windows_core::GUID)
        -> windows_core::Result<u32>;
    ...
    fn RequestPermissions(
        ...
        preporttypes: *const windows_core::GUID,
        count: u32,
...
impl ILocation_Vtbl {
    pub const fn new<Identity: ILocation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RegisterForReport<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILocation_Impl::RegisterForReport(
                    this,
                    core::mem::transmute_copy(&pevents),
                    core::mem::transmute_copy(&reporttype),
                    core::mem::transmute_copy(&dwrequestedreportinterval),
                )
                .into()
            }
        }
        unsafe extern "system" fn UnregisterForReport<
            Identity: ILocation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILocation_Impl::UnregisterForReport(this, core::mem::transmute_copy(&reporttype))
                    .into()
            }
        }
        unsafe extern "system" fn GetReport<Identity: ILocation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            reporttype: *const windows_core::GUID,
            pplocationreport: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetReportStatus<Identity: ILocation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            reporttype: *const windows_core::GUID,
        ...
        unsafe extern "system" fn GetReportInterval<
            Identity: ILocation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ILocation_Impl::GetReportInterval(
                    this,
                    core::mem::transmute_copy(&reporttype),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SetReportInterval<
            Identity: ILocation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILocation_Impl::SetReportInterval(
                    this,
                    core::mem::transmute_copy(&reporttype),
                    core::mem::transmute_copy(&millisecondsrequested),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ILocation_Impl::GetDesiredAccuracy(
                    this,
                    core::mem::transmute_copy(&reporttype),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SetDesiredAccuracy<
            Identity: ILocation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILocation_Impl::SetDesiredAccuracy(
                    this,
                    core::mem::transmute_copy(&reporttype),
                    core::mem::transmute_copy(&desiredaccuracy),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILocation_Impl::RequestPermissions(
                    this,
                    core::mem::transmute_copy(&hparent),
                    core::mem::transmute_copy(&preporttypes),
...
impl ILocationEvents {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnLocationChanged)(
                windows_core::Interface::as_raw(self),
                reporttype,
                plocationreport.param().abi(),
            )
    ...
    pub unsafe fn OnStatusChanged(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).OnStatusChanged)(
                windows_core::Interface::as_raw(self),
                reporttype,
                newstatus,
            )
...
pub struct ILocationEvents_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OnLocationChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OnStatusChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
...
impl ILocationEvents_Vtbl {
    pub const fn new<Identity: ILocationEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnLocationChanged<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILocationEvents_Impl::OnLocationChanged(
                    this,
                    core::mem::transmute_copy(&reporttype),
                    core::mem::transmute_copy(&plocationreport),
                )
        ...
        unsafe extern "system" fn OnStatusChanged<
            Identity: ILocationEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILocationEvents_Impl::OnStatusChanged(
                    this,
                    core::mem::transmute_copy(&reporttype),
...
windows_core::imp::define_interface!(
    ILocationPower,
    ILocationPower_Vtbl,
    0x193e7729_ab6b_4b12_8617_7596e1bb191c
);
...
impl ILocationPower_Vtbl {
    pub const fn new<Identity: ILocationPower_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Connect<Identity: ILocationPower_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Disconnect<Identity: ILocationPower_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    ...
    0xc8b7f7ee_75d0_4db9_b62d_7a0f369ca456
);
...
impl ILocationReport {
    pub unsafe fn GetSensorID(&self) -> windows_core::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSensorID)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct ILocationReport_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetSensorID: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl ILocationReport_Vtbl {
    pub const fn new<Identity: ILocationReport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetSensorID<
            Identity: ILocationReport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            psensorid: *mut windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetValue<Identity: ILocationReport_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pkey: *const super::super::Foundation::PROPERTYKEY,
...
windows_core::imp::define_interface!(
    ...
    0x2daec322_90b2_47e4_bb08_0da841935a6b
);
#[cfg(feature = "Win32_System_Com")]
...
impl ILocationReportFactory {
    pub unsafe fn ListenForReports(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ListenForReports)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn StopListeningForReports(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).StopListeningForReports)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn ReportInterval(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReportInterval)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn DesiredAccuracy(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DesiredAccuracy)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct ILocationReportFactory_Vtbl {
    ...
    pub DesiredAccuracy:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetDesiredAccuracy:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub RequestPermissions:
...
impl ILocationReportFactory_Vtbl {
    pub const fn new<Identity: ILocationReportFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ListenForReports<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILocationReportFactory_Impl::ListenForReports(
                    this,
                    core::mem::transmute_copy(&requestedreportinterval),
                )
                .into()
            }
        }
        unsafe extern "system" fn StopListeningForReports<
            Identity: ILocationReportFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ReportInterval<
            Identity: ILocationReportFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILocationReportFactory_Impl::SetReportInterval(
                    this,
                    core::mem::transmute_copy(&millisecondsrequested),
                )
                .into()
        ...
        unsafe extern "system" fn DesiredAccuracy<
            Identity: ILocationReportFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILocationReportFactory_Impl::SetDesiredAccuracy(
                    this,
                    core::mem::transmute_copy(&desiredaccuracy),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILocationReportFactory_Impl::RequestPermissions(
                    this,
...
pub const LatLongReport: windows_core::GUID =
    windows_core::GUID::from_u128(0xed81c073_1f84_4ca8_a161_183c776bc651);
pub const LatLongReportFactory: windows_core::GUID =
    windows_core::GUID::from_u128(0x9dcc3cc8_8609_4863_bad4_03601f4c65e8);
pub const Location: windows_core::GUID =
    windows_core::GUID::from_u128(0xe5b8e079_ee6d_4e33_a438_c87f2e959254);
...
windows_core::imp::define_interface!(
    ...
    _ICivicAddressReportFactoryEvents_Vtbl,
    0xc96039ff_72ec_4617_89bd_84d88bedc722
);
#[cfg(feature = "Win32_System_Com")]
...
pub trait _ICivicAddressReportFactoryEvents_Impl:
...
impl _ICivicAddressReportFactoryEvents_Vtbl {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<_ICivicAddressReportFactoryEvents as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
windows_core::imp::define_interface!(
    ...
    0x16ee6cb7_ab3c_424b_849f_269be551fcbc
);
#[cfg(feature = "Win32_System_Com")]
...
impl _ILatLongReportFactoryEvents_Vtbl {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<_ILatLongReportFactoryEvents as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(

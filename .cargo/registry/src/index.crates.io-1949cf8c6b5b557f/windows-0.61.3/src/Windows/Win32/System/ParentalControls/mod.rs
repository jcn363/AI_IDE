...
windows_core::imp::define_interface!(
    IWPCGamesSettings,
    IWPCGamesSettings_Vtbl,
    0x95e87780_e158_489e_b452_bbb850790715
);
...
impl IWPCGamesSettings {
    pub unsafe fn IsBlocked(&self, guidappid: windows_core::GUID) -> windows_core::Result<u32> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).IsBlocked)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(guidappid),
                &mut result__,
            )
            .map(|| result__)
        }
...
pub struct IWPCGamesSettings_Vtbl {
    ...
    pub IsBlocked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut u32,
...
impl IWPCGamesSettings_Vtbl {
    pub const fn new<Identity: IWPCGamesSettings_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsBlocked<
            Identity: IWPCGamesSettings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            guidappid: windows_core::GUID,
            pdwreasons: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        Self {
            ...
            IsBlocked: IsBlocked::<Identity, OFFSET>,
        }
    }
...
windows_core::imp::define_interface!(
    ...
    0xbef54196_2d02_4a26_b6e5_d65af295d0f1
);
...
impl IWPCProviderConfig {
    pub unsafe fn GetUserSummary(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetUserSummary)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn RequestOverride(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).RequestOverride)(
                windows_core::Interface::as_raw(self),
                hwnd.unwrap_or(core::mem::zeroed()) as _,
...
pub struct IWPCProviderConfig_Vtbl {
    ...
    pub GetUserSummary: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub RequestOverride: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HWND,
        *mut core::ffi::c_void,
        u32,
...
impl IWPCProviderConfig_Vtbl {
    pub const fn new<Identity: IWPCProviderConfig_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            pbstrusersummary: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWPCProviderConfig_Impl::Configure(
                    this,
        ...
        unsafe extern "system" fn RequestOverride<
            Identity: IWPCProviderConfig_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWPCProviderConfig_Impl::RequestOverride(
                    this,
                    core::mem::transmute_copy(&hwnd),
                    core::mem::transmute(&bstrpath),
...
windows_core::imp::define_interface!(
    ...
    0x50b6a267_c4bd_450b_adb5_759073837c9e
);
...
impl IWPCProviderState_Vtbl {
    pub const fn new<Identity: IWPCProviderState_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Enable<Identity: IWPCProviderState_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Disable<Identity: IWPCProviderState_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    IWPCProviderSupport,
    IWPCProviderSupport_Vtbl,
    0x41eba572_23ed_4779_bec1_8df96206c44c
);
...
impl IWPCProviderSupport_Vtbl {
    pub const fn new<Identity: IWPCProviderSupport_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            pguidprovider: *mut windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    IWPCSettings,
    IWPCSettings_Vtbl,
    0x8fdf6ca1_0189_47e4_b670_1a8a4636e340
);
...
impl IWPCSettings {
    pub unsafe fn IsLoggingRequired(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsLoggingRequired)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetLastSettingsChangeTime(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLastSettingsChangeTime)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWPCSettings_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub IsLoggingRequired: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub GetLastSettingsChangeTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::SYSTEMTIME,
    ) -> windows_core::HRESULT,
    pub GetRestrictions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WPCFLAG_RESTRICTION,
    ) -> windows_core::HRESULT,
}
...
impl IWPCSettings_Vtbl {
    pub const fn new<Identity: IWPCSettings_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsLoggingRequired<
            Identity: IWPCSettings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pfrequired: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetLastSettingsChangeTime<
            Identity: IWPCSettings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xffccbdb8_0992_4c30_b0f1_1cbb09c240aa
);
...
impl IWPCWebSettings {
    ...
    pub unsafe fn RequestURLOverride<P1>(
        &self,
        hwnd: Option<super::super::Foundation::HWND>,
        pcszurl: P1,
        ppcszsuburls: Option<&[windows_core::PCWSTR]>,
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RequestURLOverride)(
                windows_core::Interface::as_raw(self),
                hwnd.unwrap_or(core::mem::zeroed()) as _,
                pcszurl.param().abi(),
                ppcszsuburls
...
pub struct IWPCWebSettings_Vtbl {
    ...
    pub GetSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WPCFLAG_WEB_SETTING,
    ) -> windows_core::HRESULT,
    pub RequestURLOverride: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HWND,
        windows_core::PCWSTR,
        u32,
...
pub trait IWPCWebSettings_Impl: IWPCSettings_Impl {
    ...
    fn RequestURLOverride(
        &self,
        hwnd: super::super::Foundation::HWND,
        pcszurl: &windows_core::PCWSTR,
        curls: u32,
        ppcszsuburls: *const windows_core::PCWSTR,
    ) -> windows_core::Result<windows_core::BOOL>;
}
impl IWPCWebSettings_Vtbl {
    pub const fn new<Identity: IWPCWebSettings_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn RequestURLOverride<
            Identity: IWPCWebSettings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            curls: u32,
            ppcszsuburls: *const windows_core::PCWSTR,
            pfchanged: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWPCWebSettings_Impl::RequestURLOverride(
                    this,
                    core::mem::transmute_copy(&hwnd),
                    core::mem::transmute(&pcszurl),
                    core::mem::transmute_copy(&curls),
                    core::mem::transmute_copy(&ppcszsuburls),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0x28b4d88b_e072_49e6_804d_26edbe21a7b9
);
...
impl IWindowsParentalControls {
    pub unsafe fn GetGamesSettings<P0>(
        &self,
        pcszsid: P0,
    ) -> windows_core::Result<IWPCGamesSettings>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetGamesSettings)(
                windows_core::Interface::as_raw(self),
                pcszsid.param().abi(),
                &mut result__,
            )
...
pub struct IWindowsParentalControls_Vtbl {
    ...
    pub GetGamesSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IWindowsParentalControls_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWindowsParentalControls_Impl::GetGamesSettings(
                    this,
                    core::mem::transmute(&pcszsid),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            base__: IWindowsParentalControlsCore_Vtbl::new::<Identity, OFFSET>(),
            GetGamesSettings: GetGamesSettings::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x4ff40a0f_3f3b_4d7c_a41b_4f39d7b44d05
);
...
impl IWindowsParentalControlsCore {
    pub unsafe fn GetVisibility(&self) -> windows_core::Result<WPCFLAG_VISIBILITY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetVisibility)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetUserSettings)(
                windows_core::Interface::as_raw(self),
                pcszsid.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetWebSettings)(
                windows_core::Interface::as_raw(self),
                pcszsid.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn GetWebFilterInfo(
        ...
        ppszname: Option<*mut windows_core::PWSTR>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetWebFilterInfo)(
                windows_core::Interface::as_raw(self),
                pguidid as _,
                ppszname.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
...
pub struct IWindowsParentalControlsCore_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetVisibility: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WPCFLAG_VISIBILITY,
    ) -> windows_core::HRESULT,
    pub GetUserSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetWebSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetWebFilterInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::GUID,
...
pub trait IWindowsParentalControlsCore_Impl: windows_core::IUnknownImpl {
    ...
    fn GetUserSettings(&self, pcszsid: &windows_core::PCWSTR)
        -> windows_core::Result<IWPCSettings>;
    fn GetWebSettings(
        &self,
        pcszsid: &windows_core::PCWSTR,
    ) -> windows_core::Result<IWPCWebSettings>;
    fn GetWebFilterInfo(
        &self,
        pguidid: *mut windows_core::GUID,
...
impl IWindowsParentalControlsCore_Vtbl {
    pub const fn new<Identity: IWindowsParentalControlsCore_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetVisibility<
        ...
        unsafe extern "system" fn GetUserSettings<
            Identity: IWindowsParentalControlsCore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWindowsParentalControlsCore_Impl::GetUserSettings(
                    this,
                    core::mem::transmute(&pcszsid),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetWebSettings<
            Identity: IWindowsParentalControlsCore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWindowsParentalControlsCore_Impl::GetWebSettings(
                    this,
                    core::mem::transmute(&pcszsid),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetWebFilterInfo<
            Identity: IWindowsParentalControlsCore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWindowsParentalControlsCore_Impl::GetWebFilterInfo(
                    this,
                    core::mem::transmute_copy(&pguidid),
...
pub const WPCPROV: windows_core::GUID =
    windows_core::GUID::from_u128(0x01090065_b467_4503_9b28_533766761087);
...
pub const WindowsParentalControls: windows_core::GUID =
    windows_core::GUID::from_u128(0xe77cc89b_7401_4c04_8ced_149db35add04);
pub const WpcProviderSupport: windows_core::GUID =
    windows_core::GUID::from_u128(0xbb18c7a0_2186_4be0_97d8_04847b628e02);
pub const WpcSettingsProvider: windows_core::GUID =
    windows_core::GUID::from_u128(0x355dffaa_3b9f_435c_b428_5d44290bc5f2);

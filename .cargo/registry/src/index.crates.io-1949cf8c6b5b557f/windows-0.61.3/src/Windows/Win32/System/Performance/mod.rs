...
#[inline]
pub unsafe fn PdhAddCounterA<P1>(
    hquery: PDH_HQUERY,
...
#[inline]
pub unsafe fn PdhAddCounterW<P1>(
    hquery: PDH_HQUERY,
    szfullcounterpath: P1,
    dwuserdata: usize,
    phcounter: *mut PDH_HCOUNTER,
...
#[inline]
pub unsafe fn PdhAddEnglishCounterA<P1>(
    hquery: PDH_HQUERY,
    szfullcounterpath: P1,
    dwuserdata: usize,
    phcounter: *mut PDH_HCOUNTER,
...
pub unsafe fn PdhCalculateCounterFromRawValue(
    ...
    unsafe {
        PdhCalculateCounterFromRawValue(hcounter, dwformat, rawvalue1, rawvalue2, fmtvalue as _)
    }
}
#[inline]
...
pub unsafe fn PdhCollectQueryDataEx(
    hquery: PDH_HQUERY,
    dwintervaltime: u32,
    hnewdataevent: super::super::Foundation::HANDLE,
) -> u32 {
...
pub unsafe fn PdhEnumLogSetNamesA<P0>(
    szdatasource: P0,
    mszdatasetnamelist: Option<windows_core::PSTR>,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        PdhEnumLogSetNamesA(
            szdatasource.param().abi(),
            mszdatasetnamelist.unwrap_or(core::mem::zeroed()) as _,
            pcchbufferlength as _,
        )
    }
}
#[inline]
pub unsafe fn PdhEnumLogSetNamesW<P0>(
    szdatasource: P0,
    mszdatasetnamelist: Option<windows_core::PWSTR>,
    pcchbufferlength: *mut u32,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn PdhEnumMachinesA<P0>(
    szdatasource: P0,
    mszmachinelist: Option<windows_core::PSTR>,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        PdhEnumMachinesA(
            szdatasource.param().abi(),
            mszmachinelist.unwrap_or(core::mem::zeroed()) as _,
            pcchbuffersize as _,
        )
    }
}
...
pub unsafe fn PdhEnumMachinesHA(
    ...
    unsafe {
        PdhEnumMachinesHA(
            hdatasource.unwrap_or(core::mem::zeroed()) as _,
            mszmachinelist.unwrap_or(core::mem::zeroed()) as _,
            pcchbuffersize as _,
        )
    }
...
pub unsafe fn PdhEnumMachinesHW(
    hdatasource: Option<PDH_HLOG>,
    mszmachinelist: Option<windows_core::PWSTR>,
    pcchbuffersize: *mut u32,
) -> u32 {
...
#[inline]
pub unsafe fn PdhEnumMachinesW<P0>(
    szdatasource: P0,
    mszmachinelist: Option<windows_core::PWSTR>,
    pcchbuffersize: *mut u32,
) -> u32
...
#[inline]
pub unsafe fn PdhEnumObjectItemsA<P0, P1, P2>(
    szdatasource: P0,
    szmachinename: P1,
    szobjectname: P2,
    mszcounterlist: Option<windows_core::PSTR>,
    pcchcounterlistlength: *mut u32,
    mszinstancelist: Option<windows_core::PSTR>,
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        PdhEnumObjectItemsA(
            szdatasource.param().abi(),
            szmachinename.param().abi(),
            szobjectname.param().abi(),
            mszcounterlist.unwrap_or(core::mem::zeroed()) as _,
            pcchcounterlistlength as _,
            mszinstancelist.unwrap_or(core::mem::zeroed()) as _,
            pcchinstancelistlength as _,
            dwdetaillevel,
            dwflags,
        )
    }
...
#[inline]
pub unsafe fn PdhEnumObjectItemsHA<P1, P2>(
    hdatasource: Option<PDH_HLOG>,
    szmachinename: P1,
    szobjectname: P2,
    mszcounterlist: Option<windows_core::PSTR>,
...
pub unsafe fn PdhEnumObjectItemsHW<P1, P2>(
    ...
    szmachinename: P1,
    szobjectname: P2,
    mszcounterlist: Option<windows_core::PWSTR>,
    pcchcounterlistlength: *mut u32,
    mszinstancelist: Option<windows_core::PWSTR>,
    pcchinstancelistlength: *mut u32,
    dwdetaillevel: PERF_DETAIL,
    dwflags: u32,
) -> u32
...
#[inline]
pub unsafe fn PdhEnumObjectItemsW<P0, P1, P2>(
    szdatasource: P0,
    szmachinename: P1,
    szobjectname: P2,
    mszcounterlist: Option<windows_core::PWSTR>,
...
#[inline]
pub unsafe fn PdhEnumObjectsA<P0, P1>(
    szdatasource: P0,
    szmachinename: P1,
    mszobjectlist: Option<windows_core::PSTR>,
    pcchbuffersize: *mut u32,
    dwdetaillevel: PERF_DETAIL,
    brefresh: bool,
) -> u32
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        PdhEnumObjectsA(
            szdatasource.param().abi(),
            szmachinename.param().abi(),
            mszobjectlist.unwrap_or(core::mem::zeroed()) as _,
            pcchbuffersize as _,
            dwdetaillevel,
            brefresh.into(),
        )
...
pub unsafe fn PdhEnumObjectsHW<P1>(
    hdatasource: Option<PDH_HLOG>,
    szmachinename: P1,
    mszobjectlist: Option<windows_core::PWSTR>,
    pcchbuffersize: *mut u32,
    dwdetaillevel: PERF_DETAIL,
    brefresh: bool,
) -> u32
...
#[inline]
pub unsafe fn PdhExpandCounterPathA<P0>(
    szwildcardpath: P0,
    mszexpandedpathlist: Option<windows_core::PSTR>,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        PdhExpandCounterPathA(
            szwildcardpath.param().abi(),
            mszexpandedpathlist.unwrap_or(core::mem::zeroed()) as _,
            pcchpathlistlength as _,
        )
    }
}
#[inline]
pub unsafe fn PdhExpandCounterPathW<P0>(
    szwildcardpath: P0,
    mszexpandedpathlist: Option<windows_core::PWSTR>,
    pcchpathlistlength: *mut u32,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn PdhExpandWildCardPathA<P0, P1>(
    szdatasource: P0,
    szwildcardpath: P1,
    mszexpandedpathlist: Option<windows_core::PSTR>,
    pcchpathlistlength: *mut u32,
...
#[inline]
pub unsafe fn PdhExpandWildCardPathHA<P1>(
    hdatasource: Option<PDH_HLOG>,
    szwildcardpath: P1,
    mszexpandedpathlist: Option<windows_core::PSTR>,
    pcchpathlistlength: *mut u32,
...
#[inline]
pub unsafe fn PdhExpandWildCardPathHW<P1>(
    hdatasource: Option<PDH_HLOG>,
    szwildcardpath: P1,
    mszexpandedpathlist: Option<windows_core::PWSTR>,
    pcchpathlistlength: *mut u32,
...
#[inline]
pub unsafe fn PdhExpandWildCardPathW<P0, P1>(
    szdatasource: P0,
    szwildcardpath: P1,
    mszexpandedpathlist: Option<windows_core::PWSTR>,
    pcchpathlistlength: *mut u32,
...
pub unsafe fn PdhFormatFromRawValue(
    ...
    unsafe {
        PdhFormatFromRawValue(
            dwcountertype,
            dwformat,
            ptimebase.unwrap_or(core::mem::zeroed()) as _,
            prawvalue1,
            prawvalue2,
            pfmtvalue as _,
        )
...
pub unsafe fn PdhGetCounterInfoA(
    ...
    lpbuffer: Option<*mut PDH_COUNTER_INFO_A>,
) -> u32 {
...
#[inline]
pub unsafe fn PdhGetDataSourceTimeRangeA<P0>(
    szdatasource: P0,
    pdwnumentries: *mut u32,
    pinfo: *mut PDH_TIME_INFO,
    pdwbuffersize: *mut u32,
) -> u32
where
    P0: windows_core::Param<windows_core::PCSTR>,
...
#[inline]
pub unsafe fn PdhGetDataSourceTimeRangeW<P0>(
    szdatasource: P0,
    pdwnumentries: *mut u32,
    pinfo: *mut PDH_TIME_INFO,
    pdwbuffersize: *mut u32,
...
#[inline]
pub unsafe fn PdhGetDefaultPerfCounterA<P0, P1, P2>(
    szdatasource: P0,
    szmachinename: P1,
    szobjectname: P2,
    szdefaultcountername: Option<windows_core::PSTR>,
    pcchbuffersize: *mut u32,
) -> u32
where
    P0: windows_core::Param<windows_core::PCSTR>,
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        PdhGetDefaultPerfCounterA(
            ...
            szmachinename.param().abi(),
            szobjectname.param().abi(),
            szdefaultcountername.unwrap_or(core::mem::zeroed()) as _,
            pcchbuffersize as _,
        )
    }
}
#[inline]
pub unsafe fn PdhGetDefaultPerfCounterHA<P1, P2>(
    hdatasource: Option<PDH_HLOG>,
    szmachinename: P1,
    szobjectname: P2,
    szdefaultcountername: Option<windows_core::PSTR>,
...
pub unsafe fn PdhGetDefaultPerfCounterHW<P1, P2>(
    ...
    szmachinename: P1,
    szobjectname: P2,
    szdefaultcountername: Option<windows_core::PWSTR>,
    pcchbuffersize: *mut u32,
) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn PdhGetDefaultPerfCounterW<P0, P1, P2>(
    szdatasource: P0,
    szmachinename: P1,
    szobjectname: P2,
    szdefaultcountername: Option<windows_core::PWSTR>,
...
#[inline]
pub unsafe fn PdhGetDefaultPerfObjectA<P0, P1>(
    szdatasource: P0,
    szmachinename: P1,
    szdefaultobjectname: Option<windows_core::PSTR>,
    pcchbuffersize: *mut u32,
) -> u32
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        PdhGetDefaultPerfObjectA(
            szdatasource.param().abi(),
            szmachinename.param().abi(),
            szdefaultobjectname.unwrap_or(core::mem::zeroed()) as _,
            pcchbuffersize as _,
        )
    }
}
#[inline]
pub unsafe fn PdhGetDefaultPerfObjectHA<P1>(
    hdatasource: Option<PDH_HLOG>,
    szmachinename: P1,
    szdefaultobjectname: Option<windows_core::PSTR>,
    pcchbuffersize: *mut u32,
...
pub unsafe fn PdhGetDefaultPerfObjectHW<P1>(
    hdatasource: Option<PDH_HLOG>,
    szmachinename: P1,
    szdefaultobjectname: Option<windows_core::PWSTR>,
    pcchbuffersize: *mut u32,
) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn PdhGetFormattedCounterArrayA(
    ...
    itembuffer: Option<*mut PDH_FMT_COUNTERVALUE_ITEM_A>,
) -> u32 {
    ...
    unsafe {
        PdhGetFormattedCounterArrayA(
            ...
            lpdwbuffersize as _,
            lpdwitemcount as _,
            itembuffer.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn PdhGetFormattedCounterArrayW(
    ...
    lpdwbuffersize: *mut u32,
    lpdwitemcount: *mut u32,
    itembuffer: Option<*mut PDH_FMT_COUNTERVALUE_ITEM_W>,
) -> u32 {
...
pub unsafe fn PdhGetLogSetGUID(
    hlog: PDH_HLOG,
    pguid: Option<*mut windows_core::GUID>,
    prunid: Option<*mut i32>,
) -> u32 {
    windows_link::link!("pdh.dll" "system" fn PdhGetLogSetGUID(hlog : PDH_HLOG, pguid : *mut windows_core::GUID, prunid : *mut i32) -> u32);
    unsafe {
        PdhGetLogSetGUID(
            hlog,
            pguid.unwrap_or(core::mem::zeroed()) as _,
            prunid.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn PdhGetRawCounterArrayA(
    ...
    lpdwbuffersize: *mut u32,
    lpdwitemcount: *mut u32,
    itembuffer: Option<*mut PDH_RAW_COUNTER_ITEM_A>,
) -> u32 {
...
pub unsafe fn PdhGetRawCounterArrayW(
    ...
    lpdwbuffersize: *mut u32,
    lpdwitemcount: *mut u32,
    itembuffer: Option<*mut PDH_RAW_COUNTER_ITEM_W>,
) -> u32 {
...
#[inline]
pub unsafe fn PdhLookupPerfNameByIndexA<P0>(
    szmachinename: P0,
    dwnameindex: u32,
    sznamebuffer: Option<windows_core::PSTR>,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        PdhLookupPerfNameByIndexA(
            szmachinename.param().abi(),
            dwnameindex,
            sznamebuffer.unwrap_or(core::mem::zeroed()) as _,
            pcchnamebuffersize as _,
        )
    }
}
#[inline]
pub unsafe fn PdhLookupPerfNameByIndexW<P0>(
    szmachinename: P0,
    dwnameindex: u32,
    sznamebuffer: Option<windows_core::PWSTR>,
    pcchnamebuffersize: *mut u32,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn PdhMakeCounterPathA(
    ...
    szfullpathbuffer: Option<windows_core::PSTR>,
    pcchbuffersize: *mut u32,
    ...
    unsafe {
        PdhMakeCounterPathA(
            ...
            szfullpathbuffer.unwrap_or(core::mem::zeroed()) as _,
            pcchbuffersize as _,
            dwflags,
        )
    }
...
pub unsafe fn PdhMakeCounterPathW(
    ...
    szfullpathbuffer: Option<windows_core::PWSTR>,
    pcchbuffersize: *mut u32,
    dwflags: PDH_PATH_FLAGS,
) -> u32 {
...
#[inline]
pub unsafe fn PdhOpenLogA<P0, P5>(
    szlogfilename: P0,
    ...
    P5: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        PdhOpenLogA(
            szlogfilename.param().abi(),
            dwaccessflags,
            lpdwlogtype as _,
            hquery.unwrap_or(core::mem::zeroed()) as _,
            dwmaxsize,
            szusercaption.param().abi(),
            phlog as _,
        )
    }
}
...
#[inline]
pub unsafe fn PdhOpenQueryA<P0>(
    szdatasource: P0,
    dwuserdata: usize,
...
#[inline]
pub unsafe fn PdhParseCounterPathA<P0>(
    szfullpathbuffer: P0,
    pcounterpathelements: Option<*mut PDH_COUNTER_PATH_ELEMENTS_A>,
    pdwbuffersize: *mut u32,
    dwflags: u32,
) -> u32
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        PdhParseCounterPathA(
            szfullpathbuffer.param().abi(),
            pcounterpathelements.unwrap_or(core::mem::zeroed()) as _,
            pdwbuffersize as _,
            dwflags,
        )
    }
...
#[inline]
pub unsafe fn PdhParseCounterPathW<P0>(
    szfullpathbuffer: P0,
    pcounterpathelements: Option<*mut PDH_COUNTER_PATH_ELEMENTS_W>,
    pdwbuffersize: *mut u32,
    dwflags: u32,
) -> u32
where
...
#[inline]
pub unsafe fn PdhParseInstanceNameA<P0>(
    szinstancestring: P0,
    szinstancename: Option<windows_core::PSTR>,
    pcchinstancenamelength: *mut u32,
    szparentname: Option<windows_core::PSTR>,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        PdhParseInstanceNameA(
            szinstancestring.param().abi(),
            szinstancename.unwrap_or(core::mem::zeroed()) as _,
            pcchinstancenamelength as _,
            szparentname.unwrap_or(core::mem::zeroed()) as _,
            pcchparentnamelength as _,
            lpindex as _,
        )
    }
}
...
pub unsafe fn PdhParseInstanceNameW<P0>(
    szinstancestring: P0,
    szinstancename: Option<windows_core::PWSTR>,
    pcchinstancenamelength: *mut u32,
    szparentname: Option<windows_core::PWSTR>,
    pcchparentnamelength: *mut u32,
    lpindex: *mut u32,
) -> u32
where
...
pub unsafe fn PdhReadRawLogRecord(
    hlog: PDH_HLOG,
    ftrecord: super::super::Foundation::FILETIME,
    prawlogrecord: Option<*mut PDH_RAW_LOG_RECORD>,
    ...
    unsafe {
        PdhReadRawLogRecord(
            hlog,
            core::mem::transmute(ftrecord),
            prawlogrecord.unwrap_or(core::mem::zeroed()) as _,
            pdwbufferlength as _,
        )
    }
}
#[inline]
...
pub unsafe fn PdhSelectDataSourceA(
    ...
    szdatasource: windows_core::PSTR,
    pcchbufferlength: *mut u32,
) -> u32 {
    ...
    unsafe {
        PdhSelectDataSourceA(
            hwndowner,
            dwflags,
            core::mem::transmute(szdatasource),
            pcchbufferlength as _,
        )
    }
}
...
pub unsafe fn PdhSelectDataSourceW(
    hwndowner: super::super::Foundation::HWND,
    dwflags: PDH_SELECT_DATA_SOURCE_FLAGS,
    szdatasource: windows_core::PWSTR,
    pcchbufferlength: *mut u32,
) -> u32 {
...
#[inline]
pub unsafe fn PerfAddCounters(
    hquery: super::super::Foundation::HANDLE,
    pcounters: *mut PERF_COUNTER_IDENTIFIER,
    cbcounters: u32,
) -> u32 {
...
pub unsafe fn PerfCreateInstance<P2>(
    ...
    countersetguid: *const windows_core::GUID,
    name: P2,
    id: u32,
...
#[inline]
pub unsafe fn PerfEnumerateCounterSet<P0>(
    szmachine: P0,
    pcountersetids: Option<&mut [windows_core::GUID]>,
    pccountersetidsactual: *mut u32,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PerfEnumerateCounterSet(
            ...
            pccountersetidsactual as _,
        )
    }
}
#[inline]
pub unsafe fn PerfEnumerateCounterSetInstances<P0>(
    szmachine: P0,
    pcountersetid: *const windows_core::GUID,
    pinstances: Option<*mut PERF_INSTANCE_HEADER>,
    cbinstances: u32,
    pcbinstancesactual: *mut u32,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PerfEnumerateCounterSetInstances(
            szmachine.param().abi(),
            pcountersetid,
            pinstances.unwrap_or(core::mem::zeroed()) as _,
            cbinstances,
            pcbinstancesactual as _,
        )
    }
}
#[inline]
...
pub unsafe fn PerfOpenQueryHandle<P0>(
    szmachine: P0,
    phquery: *mut super::super::Foundation::HANDLE,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
pub unsafe fn PerfQueryCounterData(
    hquery: super::super::Foundation::HANDLE,
    pcounterblock: Option<*mut PERF_DATA_HEADER>,
    cbcounterblock: u32,
    pcbcounterblockactual: *mut u32,
) -> u32 {
    ...
    unsafe {
        PerfQueryCounterData(
            hquery,
            pcounterblock.unwrap_or(core::mem::zeroed()) as _,
            cbcounterblock,
            pcbcounterblockactual as _,
        )
    }
}
#[inline]
pub unsafe fn PerfQueryCounterInfo(
    hquery: super::super::Foundation::HANDLE,
    pcounters: Option<*mut PERF_COUNTER_IDENTIFIER>,
    cbcounters: u32,
    pcbcountersactual: *mut u32,
) -> u32 {
    ...
    unsafe {
        PerfQueryCounterInfo(
            hquery,
            pcounters.unwrap_or(core::mem::zeroed()) as _,
            cbcounters,
            pcbcountersactual as _,
        )
    }
}
#[inline]
...
pub unsafe fn PerfSetCounterSetInfo(
    providerhandle: super::super::Foundation::HANDLE,
    template: *mut PERF_COUNTERSET_INFO,
    templatesize: u32,
) -> u32 {
...
pub unsafe fn PerfStartProvider(
    providerguid: *const windows_core::GUID,
    controlcallback: PERFLIBREQUEST,
    phprovider: *mut super::super::Foundation::HANDLE,
) -> u32 {
...
pub unsafe fn PerfStartProviderEx(
    providerguid: *const windows_core::GUID,
    providercontext: Option<*const PERF_PROVIDER_CONTEXT>,
    provider: *mut super::super::Foundation::HANDLE,
) -> u32 {
    ...
    unsafe {
        PerfStartProviderEx(
            providerguid,
            providercontext.unwrap_or(core::mem::zeroed()) as _,
            provider as _,
        )
    }
}
...
#[inline]
pub unsafe fn UpdatePerfNameFilesA<P0, P1, P2>(
    sznewctrfilepath: P0,
    sznewhlpfilepath: P1,
    szlanguageid: P2,
    dwflags: usize,
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        UpdatePerfNameFilesA(
            sznewctrfilepath.param().abi(),
            sznewhlpfilepath.param().abi(),
            szlanguageid.param().abi(),
            dwflags,
        )
    }
}
...
pub const AppearPropPage: windows_core::GUID =
    windows_core::GUID::from_u128(0xe49741e9_93a8_4ab1_8e96_bf4482282e9c);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct AutoPathFormat(pub i32);
pub const BootTraceSession: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837538_098b_11d8_9414_505054503030);
pub const BootTraceSessionCollection: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837539_098b_11d8_9414_505054503030);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CounterItem: windows_core::GUID =
    windows_core::GUID::from_u128(0xc4d2d8e0_d1dd_11ce_940f_008029004348);
pub const CounterItem2: windows_core::GUID =
    windows_core::GUID::from_u128(0x43196c62_c31f_4ce3_a02e_79efe0f6a525);
pub type CounterPathCallBack = Option<unsafe extern "system" fn(param0: usize) -> i32>;
pub const CounterPropPage: windows_core::GUID =
    windows_core::GUID::from_u128(0xcf948561_ede8_11ce_941e_008029004347);
pub const Counters: windows_core::GUID =
    windows_core::GUID::from_u128(0xb2b066d2_2aac_11cf_942f_008029004347);
...
pub const DIID_DICounterItem: windows_core::GUID =
    windows_core::GUID::from_u128(0xc08c4ff2_0e2e_11cf_942c_008029004347);
pub const DIID_DILogFileItem: windows_core::GUID =
    windows_core::GUID::from_u128(0x8d093ffc_f777_4917_82d1_833fbc54c58f);
pub const DIID_DISystemMonitor: windows_core::GUID =
    windows_core::GUID::from_u128(0x13d73d81_c32e_11cf_9398_00aa00a3ddea);
pub const DIID_DISystemMonitorEvents: windows_core::GUID =
    windows_core::GUID::from_u128(0x84979930_4ab3_11cf_943a_008029004347);
pub const DIID_DISystemMonitorInternal: windows_core::GUID =
    windows_core::GUID::from_u128(0x194eb242_c32c_11cf_9398_00aa00a3ddea);
#[cfg(feature = "Win32_System_Com")]
windows_core::imp::define_interface!(
    DILogFileItem,
    DILogFileItem_Vtbl,
...
pub const DataCollectorSet: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837521_098b_11d8_9414_505054503030);
pub const DataCollectorSetCollection: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837525_098b_11d8_9414_505054503030);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const GeneralPropPage: windows_core::GUID =
    windows_core::GUID::from_u128(0xc3e5d3d2_1a03_11cf_942d_008029004347);
pub const GraphPropPage: windows_core::GUID =
    windows_core::GUID::from_u128(0xc3e5d3d3_1a03_11cf_942d_008029004347);
...
impl IAlertDataCollector {
    pub unsafe fn AlertThresholds(&self) -> windows_core::Result<*mut super::Com::SAFEARRAY> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).AlertThresholds)(
    ...
    pub unsafe fn SetAlertThresholds(
        &self,
        alerts: *const super::Com::SAFEARRAY,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAlertThresholds)(
                windows_core::Interface::as_raw(self),
                alerts,
            )
            .ok()
    ...
    pub unsafe fn EventLog(&self) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EventLog)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetEventLog(
        &self,
        log: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetEventLog)(
                windows_core::Interface::as_raw(self),
                log,
            )
            .ok()
    ...
    pub unsafe fn SampleInterval(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SampleInterval)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSampleInterval(&self, interval: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSampleInterval)(
                windows_core::Interface::as_raw(self),
                interval,
            )
            .ok()
    ...
    pub unsafe fn SetTask(&self, task: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTask)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(task),
            )
            .ok()
        }
    }
    pub unsafe fn TaskRunAsSelf(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TaskRunAsSelf)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetTaskRunAsSelf(
        &self,
        runasself: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTaskRunAsSelf)(
                windows_core::Interface::as_raw(self),
                runasself,
            )
            .ok()
    ...
    pub unsafe fn TaskArguments(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TaskArguments)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetTaskArguments(&self, task: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTaskArguments)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(task),
            )
            .ok()
    ...
    pub unsafe fn TaskUserTextArguments(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TaskUserTextArguments)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetTaskUserTextArguments(
        &self,
        task: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTaskUserTextArguments)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(task),
            )
            .ok()
    ...
    pub unsafe fn TriggerDataCollectorSet(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TriggerDataCollectorSet)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetTriggerDataCollectorSet(
        &self,
        name: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTriggerDataCollectorSet)(
                windows_core::Interface::as_raw(self),
...
pub struct IAlertDataCollector_Vtbl {
    ...
    pub AlertThresholds: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub SetAlertThresholds: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub EventLog: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetEventLog: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SampleInterval:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetSampleInterval:
    ...
    pub TaskRunAsSelf: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetTaskRunAsSelf: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub TaskArguments: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetTaskArguments: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TaskUserTextArguments: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetTaskUserTextArguments: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TriggerDataCollectorSet: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetTriggerDataCollectorSet: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IAlertDataCollector_Vtbl {
    pub const fn new<Identity: IAlertDataCollector_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AlertThresholds<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            alerts: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn SetAlertThresholds<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAlertDataCollector_Impl::SetAlertThresholds(
                    this,
                    core::mem::transmute_copy(&alerts),
                )
                .into()
            }
        }
        unsafe extern "system" fn EventLog<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            log: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetEventLog<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SampleInterval<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetSampleInterval<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAlertDataCollector_Impl::SetSampleInterval(
                    this,
        ...
        unsafe extern "system" fn Task<Identity: IAlertDataCollector_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            task: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TaskRunAsSelf<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            runasself: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetTaskRunAsSelf<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAlertDataCollector_Impl::SetTaskRunAsSelf(
                    this,
                    core::mem::transmute_copy(&runasself),
                )
                .into()
            }
        }
        unsafe extern "system" fn TaskArguments<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetTaskArguments<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn TaskUserTextArguments<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetTaskUserTextArguments<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAlertDataCollector_Impl::SetTaskUserTextArguments(
                    this,
                    core::mem::transmute(&task),
                )
                .into()
            }
        }
        unsafe extern "system" fn TriggerDataCollectorSet<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetTriggerDataCollectorSet<
            Identity: IAlertDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAlertDataCollector_Impl::SetTriggerDataCollectorSet(
                    this,
...
impl IApiTracingDataCollector {
    pub unsafe fn LogApiNamesOnly(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogApiNamesOnly)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetLogApiNamesOnly(
        &self,
        logapinames: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLogApiNamesOnly)(
                windows_core::Interface::as_raw(self),
                logapinames,
            )
            .ok()
    ...
    pub unsafe fn LogApisRecursively(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogApisRecursively)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetLogApisRecursively(
        &self,
        logrecursively: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLogApisRecursively)(
                windows_core::Interface::as_raw(self),
                logrecursively,
            )
            .ok()
    ...
    pub unsafe fn ExePath(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExePath)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetExePath(&self, exepath: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetExePath)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn LogFilePath(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogFilePath)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetLogFilePath(
        &self,
        logfilepath: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLogFilePath)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(logfilepath),
            )
            .ok()
        }
    }
    pub unsafe fn IncludeModules(&self) -> windows_core::Result<*mut super::Com::SAFEARRAY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IncludeModules)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetIncludeModules(
        &self,
        includemodules: *const super::Com::SAFEARRAY,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetIncludeModules)(
                windows_core::Interface::as_raw(self),
                includemodules,
            )
            .ok()
    ...
    pub unsafe fn IncludeApis(&self) -> windows_core::Result<*mut super::Com::SAFEARRAY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IncludeApis)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetIncludeApis(
        &self,
        includeapis: *const super::Com::SAFEARRAY,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetIncludeApis)(
                windows_core::Interface::as_raw(self),
                includeapis,
            )
            .ok()
    ...
    pub unsafe fn ExcludeApis(&self) -> windows_core::Result<*mut super::Com::SAFEARRAY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExcludeApis)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetExcludeApis(
        &self,
        excludeapis: *const super::Com::SAFEARRAY,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetExcludeApis)(
                windows_core::Interface::as_raw(self),
                excludeapis,
            )
            .ok()
...
pub struct IApiTracingDataCollector_Vtbl {
    pub base__: IDataCollector_Vtbl,
    pub LogApiNamesOnly: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetLogApiNamesOnly: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub LogApisRecursively: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetLogApisRecursively: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub ExePath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetExePath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub LogFilePath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetLogFilePath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IncludeModules: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub SetIncludeModules: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub IncludeApis: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub SetIncludeApis: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub ExcludeApis: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub SetExcludeApis: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
}
...
pub trait IApiTracingDataCollector_Impl: IDataCollector_Impl {
    ...
    fn SetIncludeApis(&self, includeapis: *const super::Com::SAFEARRAY)
        -> windows_core::Result<()>;
    fn ExcludeApis(&self) -> windows_core::Result<*mut super::Com::SAFEARRAY>;
    fn SetExcludeApis(&self, excludeapis: *const super::Com::SAFEARRAY)
        -> windows_core::Result<()>;
}
#[cfg(all(
    feature = "Win32_System_Com",
...
impl IApiTracingDataCollector_Vtbl {
    pub const fn new<Identity: IApiTracingDataCollector_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn LogApiNamesOnly<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            logapinames: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetLogApiNamesOnly<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IApiTracingDataCollector_Impl::SetLogApiNamesOnly(
                    this,
                    core::mem::transmute_copy(&logapinames),
                )
                .into()
            }
        }
        unsafe extern "system" fn LogApisRecursively<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            logrecursively: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetLogApisRecursively<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IApiTracingDataCollector_Impl::SetLogApisRecursively(
                    this,
                    core::mem::transmute_copy(&logrecursively),
                )
                .into()
            }
        }
        unsafe extern "system" fn ExePath<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            exepath: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetExePath<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            exepath: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IApiTracingDataCollector_Impl::SetExePath(this, core::mem::transmute(&exepath))
                    .into()
            }
        }
        unsafe extern "system" fn LogFilePath<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            logfilepath: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetLogFilePath<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            logfilepath: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IApiTracingDataCollector_Impl::SetLogFilePath(
                    this,
                    core::mem::transmute(&logfilepath),
                )
                .into()
            }
        }
        unsafe extern "system" fn IncludeModules<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            includemodules: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetIncludeModules<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IApiTracingDataCollector_Impl::SetIncludeModules(
                    this,
                    core::mem::transmute_copy(&includemodules),
                )
                .into()
            }
        }
        unsafe extern "system" fn IncludeApis<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            includeapis: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetIncludeApis<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IApiTracingDataCollector_Impl::SetIncludeApis(
                    this,
                    core::mem::transmute_copy(&includeapis),
                )
                .into()
            }
        }
        unsafe extern "system" fn ExcludeApis<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            excludeapis: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetExcludeApis<
            Identity: IApiTracingDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IApiTracingDataCollector_Impl::SetExcludeApis(
                    this,
                    core::mem::transmute_copy(&excludeapis),
                )
                .into()
            }
        }
...
impl IConfigurationDataCollector {
    pub unsafe fn FileMaxCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FileMaxCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetFileMaxCount(&self, count: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFileMaxCount)(
                windows_core::Interface::as_raw(self),
                count,
            )
            .ok()
    ...
    pub unsafe fn FileMaxRecursiveDepth(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FileMaxRecursiveDepth)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetFileMaxRecursiveDepth(&self, depth: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFileMaxRecursiveDepth)(
                windows_core::Interface::as_raw(self),
                depth,
            )
            .ok()
    ...
    pub unsafe fn FileMaxTotalSize(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FileMaxTotalSize)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetFileMaxTotalSize(&self, size: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFileMaxTotalSize)(
                windows_core::Interface::as_raw(self),
                size,
            )
            .ok()
    ...
    pub unsafe fn Files(&self) -> windows_core::Result<*mut super::Com::SAFEARRAY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Files)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetFiles(&self, files: *const super::Com::SAFEARRAY) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFiles)(
                windows_core::Interface::as_raw(self),
                files,
            )
            .ok()
    ...
    pub unsafe fn ManagementQueries(&self) -> windows_core::Result<*mut super::Com::SAFEARRAY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ManagementQueries)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetManagementQueries(
        &self,
        queries: *const super::Com::SAFEARRAY,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetManagementQueries)(
                windows_core::Interface::as_raw(self),
                queries,
            )
            .ok()
    ...
    pub unsafe fn QueryNetworkAdapters(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).QueryNetworkAdapters)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetQueryNetworkAdapters(
        &self,
        network: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetQueryNetworkAdapters)(
                windows_core::Interface::as_raw(self),
                network,
            )
            .ok()
    ...
    pub unsafe fn RegistryKeys(&self) -> windows_core::Result<*mut super::Com::SAFEARRAY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RegistryKeys)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetRegistryKeys(
        &self,
        query: *const super::Com::SAFEARRAY,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetRegistryKeys)(
                windows_core::Interface::as_raw(self),
                query,
            )
            .ok()
    ...
    pub unsafe fn RegistryMaxRecursiveDepth(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RegistryMaxRecursiveDepth)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetRegistryMaxRecursiveDepth(&self, depth: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetRegistryMaxRecursiveDepth)(
                windows_core::Interface::as_raw(self),
                depth,
            )
            .ok()
    ...
    pub unsafe fn SystemStateFile(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SystemStateFile)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetSystemStateFile(
        &self,
        filename: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSystemStateFile)(
                windows_core::Interface::as_raw(self),
...
pub struct IConfigurationDataCollector_Vtbl {
    ...
    pub SetFileMaxCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub FileMaxRecursiveDepth:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetFileMaxRecursiveDepth:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub FileMaxTotalSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetFileMaxTotalSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub Files: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub SetFiles: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub ManagementQueries: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub SetManagementQueries: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub QueryNetworkAdapters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetQueryNetworkAdapters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub RegistryKeys: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub SetRegistryKeys: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub RegistryMaxRecursiveDepth:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetRegistryMaxRecursiveDepth:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub SystemStateFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetSystemStateFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IConfigurationDataCollector_Vtbl {
    pub const fn new<Identity: IConfigurationDataCollector_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn FileMaxCount<
        ...
        unsafe extern "system" fn SetFileMaxCount<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IConfigurationDataCollector_Impl::SetFileMaxCount(
                    this,
        ...
        unsafe extern "system" fn FileMaxRecursiveDepth<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetFileMaxRecursiveDepth<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IConfigurationDataCollector_Impl::SetFileMaxRecursiveDepth(
                    this,
        ...
        unsafe extern "system" fn FileMaxTotalSize<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetFileMaxTotalSize<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IConfigurationDataCollector_Impl::SetFileMaxTotalSize(
                    this,
        ...
        unsafe extern "system" fn Files<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            files: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetFiles<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            files: *const super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IConfigurationDataCollector_Impl::SetFiles(this, core::mem::transmute_copy(&files))
                    .into()
            }
        }
        unsafe extern "system" fn ManagementQueries<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            queries: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetManagementQueries<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IConfigurationDataCollector_Impl::SetManagementQueries(
                    this,
                    core::mem::transmute_copy(&queries),
                )
                .into()
            }
        }
        unsafe extern "system" fn QueryNetworkAdapters<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            network: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetQueryNetworkAdapters<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IConfigurationDataCollector_Impl::SetQueryNetworkAdapters(
                    this,
                    core::mem::transmute_copy(&network),
                )
                .into()
            }
        }
        unsafe extern "system" fn RegistryKeys<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            query: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetRegistryKeys<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IConfigurationDataCollector_Impl::SetRegistryKeys(
                    this,
        ...
        unsafe extern "system" fn RegistryMaxRecursiveDepth<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetRegistryMaxRecursiveDepth<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IConfigurationDataCollector_Impl::SetRegistryMaxRecursiveDepth(
                    this,
                    core::mem::transmute_copy(&depth),
                )
                .into()
        ...
        unsafe extern "system" fn SystemStateFile<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            filename: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetSystemStateFile<
            Identity: IConfigurationDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IConfigurationDataCollector_Impl::SetSystemStateFile(
                    this,
...
windows_core::imp::define_interface!(
    ICounterItem,
    ICounterItem_Vtbl,
    0x771a9520_ee28_11ce_941e_008029004347
);
...
impl ICounterItem {
    ...
    pub unsafe fn SetLineStyle(&self, ilinestyle: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLineStyle)(
                windows_core::Interface::as_raw(self),
                ilinestyle,
            )
            .ok()
    ...
    pub unsafe fn LineStyle(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LineStyle)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
impl ICounterItem_Vtbl {
    pub const fn new<Identity: ICounterItem_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Value<Identity: ICounterItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdblvalue: *mut f64,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetColor<Identity: ICounterItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            color: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Color<Identity: ICounterItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pcolor: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetWidth<Identity: ICounterItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iwidth: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Width<Identity: ICounterItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pivalue: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetLineStyle<Identity: ICounterItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ilinestyle: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn LineStyle<Identity: ICounterItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pivalue: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ScaleFactor<Identity: ICounterItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pivalue: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Path<Identity: ICounterItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pstrvalue: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetValue<Identity: ICounterItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut f64,
            status: *mut i32,
        ) -> windows_core::HRESULT {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICounterItem_Impl::GetStatistics(
                    this,
                    core::mem::transmute_copy(&max),
                    core::mem::transmute_copy(&min),
                    core::mem::transmute_copy(&avg),
                    core::mem::transmute_copy(&status),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ICounterItem2,
    ICounterItem2_Vtbl,
    0xeefcd4e1_ea1c_4435_b7f4_e341ba03b4f9
);
...
impl ICounterItem2 {
    pub unsafe fn SetSelected(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSelected)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn SetVisible(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetVisible)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn GetDataAt(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDataAt)(
                windows_core::Interface::as_raw(self),
                iindex,
                iwhich,
                &mut result__,
...
pub struct ICounterItem2_Vtbl {
    ...
    pub SetSelected: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    ...
    pub SetVisible: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    ...
    pub GetDataAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        SysmonDataType,
...
impl ICounterItem2_Vtbl {
    pub const fn new<Identity: ICounterItem2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetSelected<Identity: ICounterItem2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstate: super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Selected<Identity: ICounterItem2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstate: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetVisible<Identity: ICounterItem2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstate: super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Visible<Identity: ICounterItem2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstate: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetDataAt<Identity: ICounterItem2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iindex: i32,
            iwhich: SysmonDataType,
            pvariant: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICounterItem2_Impl::GetDataAt(
                    this,
                    core::mem::transmute_copy(&iindex),
                    core::mem::transmute_copy(&iwhich),
                ) {
                    Ok(ok__) => {
...
impl ICounters {
    ...
    ) -> windows_core::Result<DICounterItem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Add(&self, pathname: &windows_core::BSTR) -> windows_core::Result<DICounterItem> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).Add)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(pathname),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
impl ICounters_Vtbl {
    pub const fn new<Identity: ICounters_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Count<Identity: ICounters_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plong: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn _NewEnum<Identity: ICounters_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppiunk: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn get_Item<Identity: ICounters_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: super::Variant::VARIANT,
            ppi: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Add<Identity: ICounters_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Remove<Identity: ICounters_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl IDataCollector {
    pub unsafe fn DataCollectorSet(&self) -> windows_core::Result<IDataCollectorSet> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DataCollectorSet)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetDataCollectorSet)(
                windows_core::Interface::as_raw(self),
                group.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn DataCollectorType(&self) -> windows_core::Result<DataCollectorType> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DataCollectorType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn FileNameFormat(&self) -> windows_core::Result<AutoPathFormat> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FileNameFormat)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetFileNameFormat(&self, format: AutoPathFormat) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFileNameFormat)(
                windows_core::Interface::as_raw(self),
                format,
            )
            .ok()
    ...
    pub unsafe fn FileNameFormatPattern(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FileNameFormatPattern)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetFileNameFormatPattern(
        &self,
        pattern: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFileNameFormatPattern)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn LatestOutputLocation(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LatestOutputLocation)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetLatestOutputLocation(
        &self,
        path: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLatestOutputLocation)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn LogAppend(&self) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogAppend)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetLogAppend(
        &self,
        append: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLogAppend)(
                windows_core::Interface::as_raw(self),
                append,
            )
            .ok()
    ...
    pub unsafe fn LogCircular(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogCircular)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetLogCircular(
        &self,
        circular: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLogCircular)(
                windows_core::Interface::as_raw(self),
                circular,
            )
            .ok()
    ...
    pub unsafe fn LogOverwrite(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogOverwrite)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetLogOverwrite(
        &self,
        overwrite: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLogOverwrite)(
                windows_core::Interface::as_raw(self),
                overwrite,
            )
            .ok()
    ...
    pub unsafe fn OutputLocation(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OutputLocation)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetIndex(&self, index: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetIndex)(
                windows_core::Interface::as_raw(self),
                index,
            )
            .ok()
    ...
    pub unsafe fn Xml(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Xml)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetXml(&self, xml: &windows_core::BSTR) -> windows_core::Result<IValueMap> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SetXml)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn CreateOutputLocation(
        &self,
        latest: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateOutputLocation)(
                windows_core::Interface::as_raw(self),
                latest,
                &mut result__,
            )
...
pub struct IDataCollector_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub DataCollectorSet: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetDataCollectorSet: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DataCollectorType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub FileNameFormat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut AutoPathFormat,
    ) -> windows_core::HRESULT,
    pub SetFileNameFormat:
        unsafe extern "system" fn(*mut core::ffi::c_void, AutoPathFormat) -> windows_core::HRESULT,
    pub FileNameFormatPattern: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetFileNameFormatPattern: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub LatestOutputLocation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetLatestOutputLocation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub LogAppend: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetLogAppend: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub LogCircular: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetLogCircular: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub LogOverwrite: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetLogOverwrite: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    ...
    pub OutputLocation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub Xml: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetXml: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateOutputLocation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IDataCollector_Impl: super::Com::IDispatch_Impl {
    ...
    fn SetDataCollectorSet(
        &self,
        group: windows_core::Ref<'_, IDataCollectorSet>,
    ) -> windows_core::Result<()>;
...
impl IDataCollector_Vtbl {
    pub const fn new<Identity: IDataCollector_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DataCollectorSet<
        ...
        unsafe extern "system" fn SetDataCollectorSet<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollector_Impl::SetDataCollectorSet(this, core::mem::transmute_copy(&group))
                    .into()
            }
        }
        unsafe extern "system" fn DataCollectorType<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            r#type: *mut DataCollectorType,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn FileName<Identity: IDataCollector_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            name: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn FileNameFormat<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            format: *mut AutoPathFormat,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetFileNameFormat<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollector_Impl::SetFileNameFormat(this, core::mem::transmute_copy(&format))
                    .into()
            }
        }
        unsafe extern "system" fn FileNameFormatPattern<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pattern: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetFileNameFormatPattern<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pattern: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollector_Impl::SetFileNameFormatPattern(this, core::mem::transmute(&pattern))
                    .into()
            }
        }
        unsafe extern "system" fn LatestOutputLocation<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetLatestOutputLocation<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollector_Impl::SetLatestOutputLocation(this, core::mem::transmute(&path))
                    .into()
            }
        }
        unsafe extern "system" fn LogAppend<Identity: IDataCollector_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            append: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetLogAppend<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn LogCircular<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            circular: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetLogCircular<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollector_Impl::SetLogCircular(this, core::mem::transmute_copy(&circular))
                    .into()
            }
        }
        unsafe extern "system" fn LogOverwrite<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetLogOverwrite<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollector_Impl::SetLogOverwrite(this, core::mem::transmute_copy(&overwrite))
                    .into()
            }
        }
        unsafe extern "system" fn Name<Identity: IDataCollector_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            name: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetName<Identity: IDataCollector_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            name: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn OutputLocation<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Index<Identity: IDataCollector_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetIndex<Identity: IDataCollector_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Xml<Identity: IDataCollector_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            xml: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetXml<Identity: IDataCollector_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            xml: *mut core::ffi::c_void,
            validation: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateOutputLocation<
            Identity: IDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            latest: super::super::Foundation::VARIANT_BOOL,
            location: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDataCollector_Impl::CreateOutputLocation(
                    this,
                    core::mem::transmute_copy(&latest),
                ) {
                    Ok(ok__) => {
...
impl IDataCollectorCollection {
    ...
    pub unsafe fn get_Item(
        &self,
        index: &super::Variant::VARIANT,
    ) -> windows_core::Result<IDataCollector> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Item)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn Remove(&self, collector: &super::Variant::VARIANT) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Remove)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(collector),
            )
            .ok()
        }
    }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddRange)(
                windows_core::Interface::as_raw(self),
                collectors.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn CreateDataCollectorFromXml(
        &self,
        bstrxml: &windows_core::BSTR,
        pvalidation: *mut Option<IValueMap>,
        pcollector: *mut Option<IDataCollector>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CreateDataCollectorFromXml)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrxml),
                core::mem::transmute(pvalidation),
                core::mem::transmute(pcollector),
            )
            .ok()
        }
    }
    pub unsafe fn CreateDataCollector(
        &self,
        r#type: DataCollectorType,
    ) -> windows_core::Result<IDataCollector> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateDataCollector)(
                windows_core::Interface::as_raw(self),
                r#type,
                &mut result__,
            )
...
pub struct IDataCollectorCollection_Vtbl {
    ...
    pub AddRange: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateDataCollectorFromXml: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateDataCollector: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        DataCollectorType,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IDataCollectorCollection_Impl: super::Com::IDispatch_Impl {
    ...
    fn AddRange(
        &self,
        collectors: windows_core::Ref<'_, IDataCollectorCollection>,
    ) -> windows_core::Result<()>;
    fn CreateDataCollectorFromXml(
        &self,
        bstrxml: &windows_core::BSTR,
        pvalidation: windows_core::OutRef<'_, IValueMap>,
        pcollector: windows_core::OutRef<'_, IDataCollector>,
    ) -> windows_core::Result<()>;
...
impl IDataCollectorCollection_Vtbl {
    pub const fn new<Identity: IDataCollectorCollection_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            index: super::Variant::VARIANT,
            collector: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorCollection_Impl::Add(this, core::mem::transmute_copy(&collector))
                    .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            collector: super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn AddRange<
            Identity: IDataCollectorCollection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            collectors: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorCollection_Impl::AddRange(
                    this,
                    core::mem::transmute_copy(&collectors),
                )
                .into()
            }
        }
        unsafe extern "system" fn CreateDataCollectorFromXml<
            Identity: IDataCollectorCollection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrxml: *mut core::ffi::c_void,
            pvalidation: *mut *mut core::ffi::c_void,
            pcollector: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorCollection_Impl::CreateDataCollectorFromXml(
                    this,
                    core::mem::transmute(&bstrxml),
                    core::mem::transmute_copy(&pvalidation),
                    core::mem::transmute_copy(&pcollector),
                )
                .into()
            }
        }
        unsafe extern "system" fn CreateDataCollector<
            Identity: IDataCollectorCollection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDataCollectorCollection_Impl::CreateDataCollector(
                    this,
...
impl IDataCollectorSet {
    pub unsafe fn DataCollectors(&self) -> windows_core::Result<IDataCollectorCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DataCollectors)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn DescriptionUnresolved(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DescriptionUnresolved)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn DisplayNameUnresolved(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DisplayNameUnresolved)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn Keywords(&self) -> windows_core::Result<*mut super::Com::SAFEARRAY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Keywords)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetKeywords(
        &self,
        keywords: *const super::Com::SAFEARRAY,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub unsafe fn RootPath(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RootPath)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetRootPath(&self, folder: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetRootPath)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(folder),
            )
            .ok()
        }
    }
    pub unsafe fn Segment(&self) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Segment)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSegment(
        &self,
        segment: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSegment)(
                windows_core::Interface::as_raw(self),
                segment,
            )
            .ok()
    ...
    pub unsafe fn SegmentMaxDuration(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SegmentMaxDuration)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSegmentMaxDuration(&self, seconds: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSegmentMaxDuration)(
                windows_core::Interface::as_raw(self),
                seconds,
            )
            .ok()
    ...
    pub unsafe fn SegmentMaxSize(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SegmentMaxSize)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSegmentMaxSize(&self, size: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSegmentMaxSize)(
                windows_core::Interface::as_raw(self),
                size,
            )
            .ok()
    ...
    pub unsafe fn SerialNumber(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SerialNumber)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSerialNumber(&self, index: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSerialNumber)(
                windows_core::Interface::as_raw(self),
                index,
            )
            .ok()
    ...
    pub unsafe fn Subdirectory(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Subdirectory)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetSubdirectory(&self, folder: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSubdirectory)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(folder),
            )
            .ok()
    ...
    pub unsafe fn SubdirectoryFormat(&self) -> windows_core::Result<AutoPathFormat> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SubdirectoryFormat)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSubdirectoryFormat(&self, format: AutoPathFormat) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSubdirectoryFormat)(
                windows_core::Interface::as_raw(self),
                format,
            )
            .ok()
    ...
    pub unsafe fn SubdirectoryFormatPattern(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SubdirectoryFormatPattern)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetSubdirectoryFormatPattern(
        &self,
        pattern: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSubdirectoryFormatPattern)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(pattern),
            )
            .ok()
    ...
    pub unsafe fn SetTaskUserTextArguments(
        &self,
        usertext: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTaskUserTextArguments)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(usertext),
            )
            .ok()
        }
    }
    pub unsafe fn Schedules(&self) -> windows_core::Result<IScheduleCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Schedules)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn SchedulesEnabled(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SchedulesEnabled)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSchedulesEnabled(
        &self,
        enabled: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSchedulesEnabled)(
                windows_core::Interface::as_raw(self),
                enabled,
            )
            .ok()
    ...
    pub unsafe fn SetSecurity(
        &self,
        bstrsecurity: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSecurity)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrsecurity),
            )
            .ok()
        }
    }
    pub unsafe fn StopOnCompletion(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StopOnCompletion)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetStopOnCompletion(
        &self,
        stop: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetStopOnCompletion)(
                windows_core::Interface::as_raw(self),
                stop,
            )
            .ok()
    ...
    pub unsafe fn DataManager(&self) -> windows_core::Result<IDataManager> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DataManager)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn SetCredentials(
        &self,
        user: &windows_core::BSTR,
        password: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetCredentials)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(user),
    ...
    pub unsafe fn Query(
        &self,
        name: &windows_core::BSTR,
        server: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Query)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(name),
                core::mem::transmute_copy(server),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn Start(
        &self,
        synchronous: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
...
pub struct IDataCollectorSet_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub DataCollectors: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Duration:
    ...
    pub DescriptionUnresolved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub DisplayNameUnresolved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub RootPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetRootPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Segment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetSegment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SegmentMaxDuration:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetSegmentMaxDuration:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub SegmentMaxSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetSegmentMaxSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub SerialNumber:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetSerialNumber:
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut DataCollectorSetStatus,
    ) -> windows_core::HRESULT,
    pub Subdirectory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetSubdirectory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SubdirectoryFormat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut AutoPathFormat,
    ) -> windows_core::HRESULT,
    pub SetSubdirectoryFormat:
        unsafe extern "system" fn(*mut core::ffi::c_void, AutoPathFormat) -> windows_core::HRESULT,
    pub SubdirectoryFormatPattern: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetSubdirectoryFormatPattern: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Task: unsafe extern "system" fn(
    ...
    pub Schedules: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SchedulesEnabled: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetSchedulesEnabled: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    ...
    pub SetSecurity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub StopOnCompletion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetStopOnCompletion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub DataManager: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IDataCollectorSet_Impl: super::Com::IDispatch_Impl {
    ...
    fn Stop(&self, synchronous: super::super::Foundation::VARIANT_BOOL)
        -> windows_core::Result<()>;
    fn SetXml(&self, xml: &windows_core::BSTR) -> windows_core::Result<IValueMap>;
    fn SetValue(
        &self,
...
impl IDataCollectorSet_Vtbl {
    pub const fn new<Identity: IDataCollectorSet_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DataCollectors<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            collectors: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetDuration(this, core::mem::transmute_copy(&seconds))
                    .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetDescription(this, core::mem::transmute(&description))
                    .into()
            }
        }
        unsafe extern "system" fn DescriptionUnresolved<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            descr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            displayname: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetDisplayName(this, core::mem::transmute(&displayname))
                    .into()
            }
        }
        unsafe extern "system" fn DisplayNameUnresolved<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Keywords<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            keywords: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetKeywords(this, core::mem::transmute_copy(&keywords))
                    .into()
            }
        }
        unsafe extern "system" fn LatestOutputLocation<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetLatestOutputLocation(this, core::mem::transmute(&path))
                    .into()
            }
        }
        unsafe extern "system" fn Name<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            name: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn RootPath<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            folder: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetRootPath<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            folder: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Segment<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            segment: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetSegment<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SegmentMaxDuration<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetSegmentMaxDuration<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetSegmentMaxDuration(
                    this,
                    core::mem::transmute_copy(&seconds),
                )
                .into()
            }
        }
        unsafe extern "system" fn SegmentMaxSize<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetSegmentMaxSize<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetSegmentMaxSize(this, core::mem::transmute_copy(&size))
                    .into()
            }
        }
        unsafe extern "system" fn SerialNumber<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetSerialNumber<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetSerialNumber(this, core::mem::transmute_copy(&index))
                    .into()
            }
        }
        unsafe extern "system" fn Server<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            server: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Status<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            status: *mut DataCollectorSetStatus,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Subdirectory<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetSubdirectory<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SubdirectoryFormat<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetSubdirectoryFormat<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetSubdirectoryFormat(
                    this,
        ...
        unsafe extern "system" fn SubdirectoryFormatPattern<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetSubdirectoryFormatPattern<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetSubdirectoryFormatPattern(
                    this,
        ...
        unsafe extern "system" fn Task<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            task: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetTask<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            task: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetTaskRunAsSelf(
                    this,
                    core::mem::transmute_copy(&runasself),
                )
                .into()
        ...
        >(
            this: *mut core::ffi::c_void,
            usertext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            usertext: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetTaskUserTextArguments(
                    this,
                    core::mem::transmute(&usertext),
                )
                .into()
            }
        }
        unsafe extern "system" fn Schedules<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppschedules: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SchedulesEnabled<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetSchedulesEnabled<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetSchedulesEnabled(
                    this,
        ...
        unsafe extern "system" fn Xml<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            xml: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            this: *mut core::ffi::c_void,
            pbstrsecurity: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetSecurity<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrsecurity: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetSecurity(this, core::mem::transmute(&bstrsecurity))
                    .into()
            }
        }
        unsafe extern "system" fn StopOnCompletion<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            stop: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetStopOnCompletion<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetStopOnCompletion(this, core::mem::transmute_copy(&stop))
                    .into()
            }
        }
        unsafe extern "system" fn DataManager<
            Identity: IDataCollectorSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            datamanager: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            password: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetCredentials(
                    this,
        ...
        unsafe extern "system" fn Query<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            name: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Commit<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            name: *mut core::ffi::c_void,
            server: *mut core::ffi::c_void,
            mode: CommitMode,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDataCollectorSet_Impl::Commit(
                    this,
                    core::mem::transmute(&name),
                    core::mem::transmute(&server),
        ...
        unsafe extern "system" fn Delete<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Start<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            synchronous: super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Stop<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            synchronous: super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetXml<Identity: IDataCollectorSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            xml: *mut core::ffi::c_void,
            validation: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSet_Impl::SetValue(
                    this,
...
impl IDataCollectorSetCollection {
    ...
    pub unsafe fn get_Item(
        &self,
        index: &super::Variant::VARIANT,
    ) -> windows_core::Result<IDataCollectorSet> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Item)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn GetDataCollectorSets(
        &self,
        server: &windows_core::BSTR,
        filter: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetDataCollectorSets)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(server),
...
pub struct IDataCollectorSetCollection_Vtbl {
    ...
    pub GetDataCollectorSets: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IDataCollectorSetCollection_Impl: super::Com::IDispatch_Impl {
    ...
    fn AddRange(
        &self,
        sets: windows_core::Ref<'_, IDataCollectorSetCollection>,
    ) -> windows_core::Result<()>;
...
impl IDataCollectorSetCollection_Vtbl {
    pub const fn new<Identity: IDataCollectorSetCollection_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            sets: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSetCollection_Impl::AddRange(this, core::mem::transmute_copy(&sets))
                    .into()
            }
        }
        unsafe extern "system" fn GetDataCollectorSets<
            Identity: IDataCollectorSetCollection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            server: *mut core::ffi::c_void,
            filter: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataCollectorSetCollection_Impl::GetDataCollectorSets(
                    this,
                    core::mem::transmute(&server),
...
impl IDataManager {
    ...
    pub unsafe fn SetEnabled(
        &self,
        fenabled: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub unsafe fn CheckBeforeRunning(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CheckBeforeRunning)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetCheckBeforeRunning(
        &self,
        fcheck: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetCheckBeforeRunning)(
                windows_core::Interface::as_raw(self),
                fcheck,
            )
            .ok()
    ...
    pub unsafe fn MinFreeDisk(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MinFreeDisk)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMinFreeDisk(&self, minfreedisk: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMinFreeDisk)(
                windows_core::Interface::as_raw(self),
                minfreedisk,
            )
            .ok()
    ...
    pub unsafe fn MaxSize(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MaxSize)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMaxSize(&self, ulmaxsize: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMaxSize)(
                windows_core::Interface::as_raw(self),
                ulmaxsize,
            )
            .ok()
    ...
    pub unsafe fn MaxFolderCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MaxFolderCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMaxFolderCount(&self, ulmaxfoldercount: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMaxFolderCount)(
                windows_core::Interface::as_raw(self),
                ulmaxfoldercount,
            )
            .ok()
    ...
    pub unsafe fn ResourcePolicy(&self) -> windows_core::Result<ResourcePolicy> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ResourcePolicy)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetResourcePolicy(&self, policy: ResourcePolicy) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetResourcePolicy)(
                windows_core::Interface::as_raw(self),
                policy,
            )
            .ok()
    ...
    pub unsafe fn FolderActions(&self) -> windows_core::Result<IFolderActionCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FolderActions)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn ReportSchema(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReportSchema)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetReportSchema(
        &self,
        reportschema: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetReportSchema)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(reportschema),
            )
            .ok()
        }
    }
    pub unsafe fn ReportFileName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReportFileName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetReportFileName(
        &self,
        pbstrfilename: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetReportFileName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(pbstrfilename),
            )
            .ok()
        }
    }
    pub unsafe fn RuleTargetFileName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RuleTargetFileName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetRuleTargetFileName(
        &self,
        filename: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetRuleTargetFileName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(filename),
            )
            .ok()
    ...
    pub unsafe fn EventsFileName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EventsFileName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetEventsFileName(
        &self,
        pbstrfilename: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetEventsFileName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(pbstrfilename),
            )
            .ok()
    ...
    pub unsafe fn Rules(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Rules)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetRules(&self, bstrxml: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetRules)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrxml),
            )
            .ok()
    ...
    pub unsafe fn Run(
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(self).Run)(
                windows_core::Interface::as_raw(self),
                steps,
                core::mem::transmute_copy(bstrfolder),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn Extract(
        &self,
        cabfilename: &windows_core::BSTR,
        destinationpath: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Extract)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(cabfilename),
                core::mem::transmute_copy(destinationpath),
            )
            .ok()
        }
    }
...
pub struct IDataManager_Vtbl {
    ...
    pub CheckBeforeRunning: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetCheckBeforeRunning: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub MinFreeDisk:
    ...
    pub MaxFolderCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetMaxFolderCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub ResourcePolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ResourcePolicy,
    ) -> windows_core::HRESULT,
    pub SetResourcePolicy:
        unsafe extern "system" fn(*mut core::ffi::c_void, ResourcePolicy) -> windows_core::HRESULT,
    pub FolderActions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ReportSchema: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetReportSchema: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ReportFileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetReportFileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RuleTargetFileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetRuleTargetFileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub EventsFileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetEventsFileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Rules: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetRules: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl IDataManager_Vtbl {
    pub const fn new<Identity: IDataManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Enabled<Identity: IDataManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pfenabled: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetEnabled<Identity: IDataManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fenabled: super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn CheckBeforeRunning<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pfcheck: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetCheckBeforeRunning<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataManager_Impl::SetCheckBeforeRunning(this, core::mem::transmute_copy(&fcheck))
                    .into()
            }
        }
        unsafe extern "system" fn MinFreeDisk<Identity: IDataManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            minfreedisk: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetMinFreeDisk<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataManager_Impl::SetMinFreeDisk(this, core::mem::transmute_copy(&minfreedisk))
                    .into()
            }
        }
        unsafe extern "system" fn MaxSize<Identity: IDataManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pulmaxsize: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetMaxSize<Identity: IDataManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ulmaxsize: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn MaxFolderCount<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pulmaxfoldercount: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetMaxFolderCount<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataManager_Impl::SetMaxFolderCount(
                    this,
                    core::mem::transmute_copy(&ulmaxfoldercount),
                )
                .into()
            }
        }
        unsafe extern "system" fn ResourcePolicy<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppolicy: *mut ResourcePolicy,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetResourcePolicy<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataManager_Impl::SetResourcePolicy(this, core::mem::transmute_copy(&policy))
                    .into()
            }
        }
        unsafe extern "system" fn FolderActions<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ReportSchema<Identity: IDataManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            reportschema: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetReportSchema<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            reportschema: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ReportFileName<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetReportFileName<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrfilename: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataManager_Impl::SetReportFileName(this, core::mem::transmute(&pbstrfilename))
                    .into()
            }
        }
        unsafe extern "system" fn RuleTargetFileName<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetRuleTargetFileName<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataManager_Impl::SetRuleTargetFileName(this, core::mem::transmute(&filename))
                    .into()
            }
        }
        unsafe extern "system" fn EventsFileName<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetEventsFileName<
            Identity: IDataManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataManager_Impl::SetEventsFileName(this, core::mem::transmute(&pbstrfilename))
                    .into()
            }
        }
        unsafe extern "system" fn Rules<Identity: IDataManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetRules<Identity: IDataManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrxml: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Run<Identity: IDataManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            steps: DataManagerSteps,
            bstrfolder: *mut core::ffi::c_void,
            errors: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDataManager_Impl::Run(
                    this,
                    core::mem::transmute_copy(&steps),
                    core::mem::transmute(&bstrfolder),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Extract<Identity: IDataManager_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            cabfilename: *mut core::ffi::c_void,
            destinationpath: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataManager_Impl::Extract(
                    this,
                    core::mem::transmute(&cabfilename),
                    core::mem::transmute(&destinationpath),
                )
                .into()
            }
        }
...
impl IFolderAction {
    ...
    pub unsafe fn SetAge(&self, ulage: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAge)(
                windows_core::Interface::as_raw(self),
                ulage,
            )
            .ok()
    ...
    pub unsafe fn SetActions(&self, steps: FolderActionSteps) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetActions)(
                windows_core::Interface::as_raw(self),
                steps,
            )
            .ok()
    ...
    pub unsafe fn SendCabTo(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SendCabTo)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetSendCabTo(
        &self,
        bstrdestination: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSendCabTo)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrdestination),
            )
            .ok()
        }
    }
...
pub struct IFolderAction_Vtbl {
    ...
    pub Actions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut FolderActionSteps,
    ) -> windows_core::HRESULT,
    pub SetActions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        FolderActionSteps,
    ) -> windows_core::HRESULT,
    pub SendCabTo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetSendCabTo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IFolderAction_Vtbl {
    pub const fn new<Identity: IFolderAction_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Age<Identity: IFolderAction_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pulage: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetAge<Identity: IFolderAction_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ulage: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Size<Identity: IFolderAction_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pulage: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetSize<Identity: IFolderAction_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ulage: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Actions<Identity: IFolderAction_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            steps: *mut FolderActionSteps,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetActions<Identity: IFolderAction_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SendCabTo<Identity: IFolderAction_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrdestination: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetSendCabTo<
            Identity: IFolderAction_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrdestination: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IFolderAction_Impl::SetSendCabTo(this, core::mem::transmute(&bstrdestination))
                    .into()
            }
        }
        Self {
...
impl IFolderActionCollection {
    ...
    pub unsafe fn get_Item(
        &self,
        index: &super::Variant::VARIANT,
    ) -> windows_core::Result<IFolderAction> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Item)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn CreateFolderAction(&self) -> windows_core::Result<IFolderAction> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateFolderAction)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IFolderActionCollection_Vtbl {
    ...
    pub CreateFolderAction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub trait IFolderActionCollection_Impl: super::Com::IDispatch_Impl {
    ...
    fn AddRange(
        &self,
        actions: windows_core::Ref<'_, IFolderActionCollection>,
    ) -> windows_core::Result<()>;
...
impl IFolderActionCollection_Vtbl {
    pub const fn new<Identity: IFolderActionCollection_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            r#enum: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            actions: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IFolderActionCollection_Impl::AddRange(this, core::mem::transmute_copy(&actions))
                    .into()
            }
        }
        unsafe extern "system" fn CreateFolderAction<
            Identity: IFolderActionCollection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            folderaction: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ILogFileItem,
    ILogFileItem_Vtbl,
    0xd6b518dd_05c7_418a_89e6_4f9ce8c6841e
);
...
impl ILogFileItem_Vtbl {
    pub const fn new<Identity: ILogFileItem_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Path<Identity: ILogFileItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pstrvalue: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl ILogFiles {
    ...
    pub unsafe fn get_Item(
        &self,
        index: &super::Variant::VARIANT,
    ) -> windows_core::Result<DILogFileItem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Item)(
                windows_core::Interface::as_raw(self),
...
impl ILogFiles_Vtbl {
    pub const fn new<Identity: ILogFiles_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Count<Identity: ILogFiles_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plong: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn _NewEnum<Identity: ILogFiles_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppiunk: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn get_Item<Identity: ILogFiles_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: super::Variant::VARIANT,
            ppi: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Add<Identity: ILogFiles_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pathname: *mut core::ffi::c_void,
            ppi: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Remove<Identity: ILogFiles_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl IPerformanceCounterDataCollector {
    pub unsafe fn DataSourceName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DataSourceName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetDataSourceName(&self, dsn: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDataSourceName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(dsn),
            )
            .ok()
        }
    }
    pub unsafe fn PerformanceCounters(&self) -> windows_core::Result<*mut super::Com::SAFEARRAY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PerformanceCounters)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetPerformanceCounters(
        &self,
        counters: *const super::Com::SAFEARRAY,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPerformanceCounters)(
                windows_core::Interface::as_raw(self),
                counters,
            )
            .ok()
    ...
    pub unsafe fn LogFileFormat(&self) -> windows_core::Result<FileFormat> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogFileFormat)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetLogFileFormat(&self, format: FileFormat) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLogFileFormat)(
                windows_core::Interface::as_raw(self),
                format,
            )
            .ok()
    ...
    pub unsafe fn SegmentMaxRecords(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SegmentMaxRecords)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSegmentMaxRecords(&self, records: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSegmentMaxRecords)(
                windows_core::Interface::as_raw(self),
                records,
            )
            .ok()
...
pub struct IPerformanceCounterDataCollector_Vtbl {
    pub base__: IDataCollector_Vtbl,
    pub DataSourceName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetDataSourceName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PerformanceCounters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub SetPerformanceCounters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub LogFileFormat:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut FileFormat) -> windows_core::HRESULT,
    pub SetLogFileFormat:
        unsafe extern "system" fn(*mut core::ffi::c_void, FileFormat) -> windows_core::HRESULT,
    pub SampleInterval:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetSampleInterval:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub SegmentMaxRecords:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetSegmentMaxRecords:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
}
#[cfg(all(
    feature = "Win32_System_Com",
...
impl IPerformanceCounterDataCollector_Vtbl {
    ...
    {
        unsafe extern "system" fn DataSourceName<
            Identity: IPerformanceCounterDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dsn: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetDataSourceName<
            Identity: IPerformanceCounterDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dsn: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPerformanceCounterDataCollector_Impl::SetDataSourceName(
                    this,
                    core::mem::transmute(&dsn),
                )
                .into()
            }
        }
        unsafe extern "system" fn PerformanceCounters<
            Identity: IPerformanceCounterDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            counters: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetPerformanceCounters<
            Identity: IPerformanceCounterDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPerformanceCounterDataCollector_Impl::SetPerformanceCounters(
                    this,
                    core::mem::transmute_copy(&counters),
                )
                .into()
            }
        }
        unsafe extern "system" fn LogFileFormat<
            Identity: IPerformanceCounterDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            format: *mut FileFormat,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetLogFileFormat<
            Identity: IPerformanceCounterDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPerformanceCounterDataCollector_Impl::SetLogFileFormat(
                    this,
                    core::mem::transmute_copy(&format),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPerformanceCounterDataCollector_Impl::SetSampleInterval(
                    this,
                    core::mem::transmute_copy(&interval),
                )
                .into()
        ...
        unsafe extern "system" fn SegmentMaxRecords<
            Identity: IPerformanceCounterDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetSegmentMaxRecords<
            Identity: IPerformanceCounterDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPerformanceCounterDataCollector_Impl::SetSegmentMaxRecords(
                    this,
                    core::mem::transmute_copy(&records),
                )
                .into()
            }
        }
...
impl ISchedule {
    ...
    pub unsafe fn StartDate(&self) -> windows_core::Result<super::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StartDate)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetStartDate(&self, start: &super::Variant::VARIANT) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetStartDate)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(start),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn EndDate(&self) -> windows_core::Result<super::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EndDate)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetEndDate(&self, end: &super::Variant::VARIANT) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetEndDate)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(end),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn Days(&self) -> windows_core::Result<WeekDays> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Days)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetDays(&self, days: WeekDays) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDays)(
                windows_core::Interface::as_raw(self),
                days,
            )
            .ok()
...
pub struct ISchedule_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub StartDate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    StartDate: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub SetStartDate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    SetStartDate: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub EndDate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    EndDate: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub SetEndDate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    ...
    SetStartTime: usize,
    pub Days:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut WeekDays) -> windows_core::HRESULT,
    pub SetDays:
        unsafe extern "system" fn(*mut core::ffi::c_void, WeekDays) -> windows_core::HRESULT,
}
#[cfg(all(
    feature = "Win32_System_Com",
    feature = "Win32_System_Ole",
...
impl ISchedule_Vtbl {
    pub const fn new<Identity: ISchedule_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn StartDate<Identity: ISchedule_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            start: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetStartDate<Identity: ISchedule_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            start: super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn EndDate<Identity: ISchedule_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            end: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetEndDate<Identity: ISchedule_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            end: super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn StartTime<Identity: ISchedule_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            start: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetStartTime<Identity: ISchedule_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            start: super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Days<Identity: ISchedule_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            days: *mut WeekDays,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetDays<Identity: ISchedule_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            days: WeekDays,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl IScheduleCollection {
    ...
    pub unsafe fn Remove(&self, vschedule: &super::Variant::VARIANT) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Remove)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(vschedule),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn CreateSchedule(&self) -> windows_core::Result<ISchedule> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSchedule)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IScheduleCollection_Vtbl {
    ...
    pub CreateSchedule: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub trait IScheduleCollection_Impl: super::Com::IDispatch_Impl {
    ...
    fn AddRange(
        &self,
        pschedules: windows_core::Ref<'_, IScheduleCollection>,
    ) -> windows_core::Result<()>;
...
impl IScheduleCollection_Vtbl {
    pub const fn new<Identity: IScheduleCollection_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Count<Identity: IScheduleCollection_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            retval: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            this: *mut core::ffi::c_void,
            index: super::Variant::VARIANT,
            ppschedule: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Add<Identity: IScheduleCollection_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pschedule: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            vschedule: super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Clear<Identity: IScheduleCollection_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        >(
            this: *mut core::ffi::c_void,
            pschedules: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IScheduleCollection_Impl::AddRange(this, core::mem::transmute_copy(&pschedules))
                    .into()
            }
        }
        unsafe extern "system" fn CreateSchedule<
            Identity: IScheduleCollection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            schedule: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ISystemMonitor,
    ISystemMonitor_Vtbl,
    0x194eb241_c32c_11cf_9398_00aa00a3ddea
);
...
impl ISystemMonitor {
    pub unsafe fn Appearance(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Appearance)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetAppearance(&self, iappearance: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAppearance)(
                windows_core::Interface::as_raw(self),
                iappearance,
            )
            .ok()
    ...
    pub unsafe fn BackColor(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BackColor)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetBackColor(&self, color: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBackColor)(
                windows_core::Interface::as_raw(self),
                color,
            )
            .ok()
    ...
    pub unsafe fn BorderStyle(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BorderStyle)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetBorderStyle(&self, iborderstyle: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBorderStyle)(
                windows_core::Interface::as_raw(self),
                iborderstyle,
            )
            .ok()
    ...
    pub unsafe fn ForeColor(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ForeColor)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetForeColor(&self, color: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetForeColor)(
                windows_core::Interface::as_raw(self),
                color,
            )
            .ok()
    ...
    pub unsafe fn Font(&self) -> windows_core::Result<super::Ole::IFontDisp> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Font)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).putref_Font)(
                windows_core::Interface::as_raw(self),
                pfont.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn Counters(&self) -> windows_core::Result<ICounters> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Counters)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn SetShowVerticalGrid(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetShowVerticalGrid)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn ShowVerticalGrid(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ShowVerticalGrid)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetShowHorizontalGrid(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetShowHorizontalGrid)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn ShowHorizontalGrid(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ShowHorizontalGrid)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetShowLegend(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetShowLegend)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn ShowLegend(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ShowLegend)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetShowScaleLabels(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetShowScaleLabels)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn ShowScaleLabels(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ShowScaleLabels)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetShowValueBar(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetShowValueBar)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn ShowValueBar(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ShowValueBar)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMaximumScale(&self, ivalue: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMaximumScale)(
                windows_core::Interface::as_raw(self),
                ivalue,
            )
            .ok()
    ...
    pub unsafe fn MaximumScale(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MaximumScale)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMinimumScale(&self, ivalue: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMinimumScale)(
                windows_core::Interface::as_raw(self),
                ivalue,
            )
            .ok()
    ...
    pub unsafe fn MinimumScale(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MinimumScale)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetUpdateInterval(&self, fvalue: f32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetUpdateInterval)(
                windows_core::Interface::as_raw(self),
                fvalue,
            )
            .ok()
    ...
    pub unsafe fn UpdateInterval(&self) -> windows_core::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UpdateInterval)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetDisplayType(
        &self,
        edisplaytype: DisplayTypeConstants,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDisplayType)(
                windows_core::Interface::as_raw(self),
                edisplaytype,
            )
            .ok()
    ...
    pub unsafe fn DisplayType(&self) -> windows_core::Result<DisplayTypeConstants> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DisplayType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetManualUpdate(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetManualUpdate)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn ManualUpdate(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ManualUpdate)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetGraphTitle(&self, bstitle: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetGraphTitle)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstitle),
            )
            .ok()
        }
    }
    pub unsafe fn GraphTitle(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GraphTitle)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetYAxisLabel(&self, bstitle: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetYAxisLabel)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstitle),
            )
            .ok()
    ...
    pub unsafe fn YAxisLabel(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).YAxisLabel)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn CollectSample(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CollectSample)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn UpdateGraph(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).UpdateGraph)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn BrowseCounters(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BrowseCounters)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn DisplayProperties(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DisplayProperties)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn Counter(&self, iindex: i32) -> windows_core::Result<ICounterItem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Counter)(
                windows_core::Interface::as_raw(self),
                iindex,
                &mut result__,
            )
    ...
    pub unsafe fn AddCounter(
        &self,
        bspath: &windows_core::BSTR,
    ) -> windows_core::Result<ICounterItem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AddCounter)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bspath),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteCounter)(
                windows_core::Interface::as_raw(self),
                pctr.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn BackColorCtl(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BackColorCtl)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetBackColorCtl(&self, color: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBackColorCtl)(
                windows_core::Interface::as_raw(self),
                color,
            )
            .ok()
    ...
    pub unsafe fn SetLogFileName(
        &self,
        bsfilename: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLogFileName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bsfilename),
            )
            .ok()
        }
    }
    pub unsafe fn LogFileName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogFileName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetLogViewStart(&self, starttime: f64) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLogViewStart)(
                windows_core::Interface::as_raw(self),
                starttime,
            )
            .ok()
    ...
    pub unsafe fn LogViewStart(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogViewStart)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetLogViewStop(&self, stoptime: f64) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLogViewStop)(
                windows_core::Interface::as_raw(self),
                stoptime,
            )
            .ok()
    ...
    pub unsafe fn LogViewStop(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogViewStop)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GridColor(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GridColor)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetGridColor(&self, color: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetGridColor)(
                windows_core::Interface::as_raw(self),
                color,
            )
            .ok()
    ...
    pub unsafe fn TimeBarColor(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TimeBarColor)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetTimeBarColor(&self, color: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTimeBarColor)(
                windows_core::Interface::as_raw(self),
                color,
            )
            .ok()
    ...
    pub unsafe fn Highlight(&self) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Highlight)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetHighlight(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetHighlight)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn ShowToolbar(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ShowToolbar)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetShowToolbar(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetShowToolbar)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn Paste(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Paste)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    ...
    pub unsafe fn SetReadOnly(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetReadOnly)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn SetReportValueType(
        &self,
        ereportvaluetype: ReportValueTypeConstants,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetReportValueType)(
                windows_core::Interface::as_raw(self),
                ereportvaluetype,
            )
            .ok()
    ...
    pub unsafe fn ReportValueType(&self) -> windows_core::Result<ReportValueTypeConstants> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReportValueType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMonitorDuplicateInstances(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMonitorDuplicateInstances)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn MonitorDuplicateInstances(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MonitorDuplicateInstances)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetDisplayFilter(&self, ivalue: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDisplayFilter)(
                windows_core::Interface::as_raw(self),
                ivalue,
            )
            .ok()
    ...
    pub unsafe fn DisplayFilter(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DisplayFilter)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn LogFiles(&self) -> windows_core::Result<ILogFiles> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogFiles)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn SetDataSourceType(
        &self,
        edatasourcetype: DataSourceTypeConstants,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDataSourceType)(
                windows_core::Interface::as_raw(self),
                edatasourcetype,
            )
            .ok()
    ...
    pub unsafe fn DataSourceType(&self) -> windows_core::Result<DataSourceTypeConstants> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DataSourceType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSqlDsnName(
        &self,
        bssqldsnname: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSqlDsnName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bssqldsnname),
            )
            .ok()
        }
    }
    pub unsafe fn SqlDsnName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SqlDsnName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetSqlLogSetName(
        &self,
        bssqllogsetname: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSqlLogSetName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bssqllogsetname),
            )
            .ok()
        }
    }
    pub unsafe fn SqlLogSetName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SqlLogSetName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct ISystemMonitor_Vtbl {
    ...
    pub SetForeColor:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
    pub Font: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    Font: usize,
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
    pub putref_Font: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Com", feature = "Win32_System_Ole")))]
    putref_Font: usize,
    #[cfg(feature = "Win32_System_Com")]
    pub Counters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    Counters: usize,
    pub SetShowVerticalGrid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub ShowVerticalGrid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetShowHorizontalGrid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub ShowHorizontalGrid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetShowLegend: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub ShowLegend: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetShowScaleLabels: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub ShowScaleLabels: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetShowValueBar: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub ShowValueBar: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetMaximumScale:
    ...
    pub SetDisplayType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        DisplayTypeConstants,
    ) -> windows_core::HRESULT,
    pub DisplayType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut DisplayTypeConstants,
    ) -> windows_core::HRESULT,
    pub SetManualUpdate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub ManualUpdate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetGraphTitle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GraphTitle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetYAxisLabel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub YAxisLabel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub DisplayProperties:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Counter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AddCounter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeleteCounter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BackColorCtl:
    ...
    pub SetBackColorCtl:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub SetLogFileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub LogFileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetLogViewStart:
    ...
    pub SetTimeBarColor:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub Highlight: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetHighlight: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub ShowToolbar: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetShowToolbar: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    ...
    pub SetReadOnly: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    ...
    pub SetReportValueType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        ReportValueTypeConstants,
    ) -> windows_core::HRESULT,
    pub ReportValueType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ReportValueTypeConstants,
    ) -> windows_core::HRESULT,
    pub SetMonitorDuplicateInstances: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub MonitorDuplicateInstances: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetDisplayFilter:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub DisplayFilter:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub LogFiles: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    LogFiles: usize,
    pub SetDataSourceType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        DataSourceTypeConstants,
    ) -> windows_core::HRESULT,
    pub DataSourceType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut DataSourceTypeConstants,
    ) -> windows_core::HRESULT,
    pub SetSqlDsnName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SqlDsnName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetSqlLogSetName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SqlLogSetName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub trait ISystemMonitor_Impl: windows_core::IUnknownImpl {
    ...
    fn putref_Font(
        &self,
        pfont: windows_core::Ref<'_, super::Ole::IFontDisp>,
    ) -> windows_core::Result<()>;
...
impl ISystemMonitor_Vtbl {
    pub const fn new<Identity: ISystemMonitor_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Appearance<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iappearance: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetAppearance<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetAppearance(this, core::mem::transmute_copy(&iappearance))
                    .into()
            }
        }
        unsafe extern "system" fn BackColor<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pcolor: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetBackColor<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn BorderStyle<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            iborderstyle: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetBorderStyle<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetBorderStyle(this, core::mem::transmute_copy(&iborderstyle))
                    .into()
            }
        }
        unsafe extern "system" fn ForeColor<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pcolor: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetForeColor<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Font<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppfont: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn putref_Font<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pfont: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Counters<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppicounters: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetShowVerticalGrid<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetShowVerticalGrid(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        unsafe extern "system" fn ShowVerticalGrid<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetShowHorizontalGrid<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetShowHorizontalGrid(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        unsafe extern "system" fn ShowHorizontalGrid<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetShowLegend<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ShowLegend<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstate: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetShowScaleLabels<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetShowScaleLabels(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        unsafe extern "system" fn ShowScaleLabels<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetShowValueBar<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetShowValueBar(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        unsafe extern "system" fn ShowValueBar<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetMaximumScale<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetMaximumScale(this, core::mem::transmute_copy(&ivalue))
                    .into()
            }
        }
        unsafe extern "system" fn MaximumScale<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetMinimumScale<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetMinimumScale(this, core::mem::transmute_copy(&ivalue))
                    .into()
            }
        }
        unsafe extern "system" fn MinimumScale<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetUpdateInterval<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetUpdateInterval(this, core::mem::transmute_copy(&fvalue))
                    .into()
            }
        }
        unsafe extern "system" fn UpdateInterval<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetDisplayType<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetDisplayType(this, core::mem::transmute_copy(&edisplaytype))
                    .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            pedisplaytype: *mut DisplayTypeConstants,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetManualUpdate<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetManualUpdate(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        unsafe extern "system" fn ManualUpdate<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetGraphTitle<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstitle: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GraphTitle<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstitle: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetYAxisLabel<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn YAxisLabel<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstitle: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn CollectSample<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn UpdateGraph<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn BrowseCounters<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn DisplayProperties<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Counter<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iindex: i32,
            ppicounter: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn AddCounter<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bspath: *mut core::ffi::c_void,
            ppicounter: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn DeleteCounter<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pctr: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn BackColorCtl<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetBackColorCtl<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetLogFileName<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bsfilename: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn LogFileName<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bsfilename: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetLogViewStart<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetLogViewStart(this, core::mem::transmute_copy(&starttime))
                    .into()
            }
        }
        unsafe extern "system" fn LogViewStart<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetLogViewStop<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetLogViewStop(this, core::mem::transmute_copy(&stoptime))
                    .into()
            }
        }
        unsafe extern "system" fn LogViewStop<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GridColor<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pcolor: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetGridColor<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn TimeBarColor<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetTimeBarColor<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Highlight<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstate: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetHighlight<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ShowToolbar<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetShowToolbar<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Paste<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Copy<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Reset<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn SetReadOnly<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ReadOnly<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstate: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetReportValueType<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetReportValueType(
                    this,
                    core::mem::transmute_copy(&ereportvaluetype),
                )
                .into()
            }
        }
        unsafe extern "system" fn ReportValueType<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pereportvaluetype: *mut ReportValueTypeConstants,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetMonitorDuplicateInstances<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetMonitorDuplicateInstances(
                    this,
                    core::mem::transmute_copy(&bstate),
                )
                .into()
            }
        }
        unsafe extern "system" fn MonitorDuplicateInstances<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetDisplayFilter<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetDisplayFilter(this, core::mem::transmute_copy(&ivalue))
                    .into()
            }
        }
        unsafe extern "system" fn DisplayFilter<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn LogFiles<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppilogfiles: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetDataSourceType<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetDataSourceType(
                    this,
                    core::mem::transmute_copy(&edatasourcetype),
                )
                .into()
            }
        }
        unsafe extern "system" fn DataSourceType<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pedatasourcetype: *mut DataSourceTypeConstants,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetSqlDsnName<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bssqldsnname: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SqlDsnName<Identity: ISystemMonitor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bssqldsnname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetSqlLogSetName<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bssqllogsetname: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor_Impl::SetSqlLogSetName(this, core::mem::transmute(&bssqllogsetname))
                    .into()
            }
        }
        unsafe extern "system" fn SqlLogSetName<
            Identity: ISystemMonitor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bssqllogsetname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ISystemMonitor2,
    ISystemMonitor2_Vtbl,
    0x08e3206a_5fd2_4fde_a8a5_8cb3b63d2677
);
...
impl ISystemMonitor2 {
    pub unsafe fn SetEnableDigitGrouping(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetEnableDigitGrouping)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn EnableDigitGrouping(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnableDigitGrouping)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetEnableToolTips(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetEnableToolTips)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn EnableToolTips(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnableToolTips)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetShowTimeAxisLabels(
        &self,
        bstate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetShowTimeAxisLabels)(
                windows_core::Interface::as_raw(self),
                bstate,
            )
            .ok()
    ...
    pub unsafe fn ShowTimeAxisLabels(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ShowTimeAxisLabels)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetChartScroll(
        &self,
        bscroll: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetChartScroll)(
                windows_core::Interface::as_raw(self),
                bscroll,
            )
            .ok()
    ...
    pub unsafe fn ChartScroll(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ChartScroll)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetDataPointCount(&self, inewcount: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDataPointCount)(
                windows_core::Interface::as_raw(self),
                inewcount,
            )
            .ok()
    ...
    pub unsafe fn DataPointCount(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DataPointCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ScaleToFit(
        &self,
        bselectedcountersonly: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ScaleToFit)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn SaveAs(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SaveAs)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn Relog(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Relog)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrfilename),
                esysmonfiletype,
                ifilter,
    ...
    pub unsafe fn ClearData(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ClearData)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn LogSourceStartTime(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogSourceStartTime)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn LogSourceStopTime(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LogSourceStopTime)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetLogViewRange(
        &self,
        starttime: f64,
        stoptime: f64,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLogViewRange)(
                windows_core::Interface::as_raw(self),
                starttime,
                stoptime,
            )
    ...
    pub unsafe fn GetLogViewRange(
        &self,
        starttime: *mut f64,
        stoptime: *mut f64,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetLogViewRange)(
                windows_core::Interface::as_raw(self),
                starttime as _,
                stoptime as _,
            )
    ...
    pub unsafe fn BatchingLock(
        &self,
        flock: super::super::Foundation::VARIANT_BOOL,
        ebatchreason: SysmonBatchReason,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BatchingLock)(
                windows_core::Interface::as_raw(self),
                flock,
                ebatchreason,
            )
    ...
    pub unsafe fn LoadSettings(
        &self,
        bstrsettingfilename: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).LoadSettings)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrsettingfilename),
            )
            .ok()
        }
    }
...
pub struct ISystemMonitor2_Vtbl {
    ...
    pub SetEnableDigitGrouping: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub EnableDigitGrouping: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetEnableToolTips: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub EnableToolTips: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetShowTimeAxisLabels: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub ShowTimeAxisLabels: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetChartScroll: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub ChartScroll: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetDataPointCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub DataPointCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub ScaleToFit: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SaveAs: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        SysmonFileType,
    ) -> windows_core::HRESULT,
    pub Relog: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        SysmonFileType,
        i32,
    ...
    pub LogSourceStartTime:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub LogSourceStopTime:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub SetLogViewRange:
        unsafe extern "system" fn(*mut core::ffi::c_void, f64, f64) -> windows_core::HRESULT,
    pub GetLogViewRange: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut f64,
        *mut f64,
    ) -> windows_core::HRESULT,
    pub BatchingLock: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
        SysmonBatchReason,
    ) -> windows_core::HRESULT,
    pub LoadSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ISystemMonitor2_Vtbl {
    pub const fn new<Identity: ISystemMonitor2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetEnableDigitGrouping<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor2_Impl::SetEnableDigitGrouping(
                    this,
                    core::mem::transmute_copy(&bstate),
                )
                .into()
        ...
        unsafe extern "system" fn EnableDigitGrouping<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetEnableToolTips<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor2_Impl::SetEnableToolTips(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        unsafe extern "system" fn EnableToolTips<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetShowTimeAxisLabels<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor2_Impl::SetShowTimeAxisLabels(
                    this,
                    core::mem::transmute_copy(&bstate),
                )
                .into()
        ...
        unsafe extern "system" fn ShowTimeAxisLabels<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetChartScroll<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor2_Impl::SetChartScroll(this, core::mem::transmute_copy(&bscroll))
                    .into()
            }
        }
        unsafe extern "system" fn ChartScroll<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbscroll: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetDataPointCount<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor2_Impl::SetDataPointCount(this, core::mem::transmute_copy(&inewcount))
                    .into()
            }
        }
        unsafe extern "system" fn DataPointCount<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pidatapointcount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ScaleToFit<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor2_Impl::ScaleToFit(
                    this,
                    core::mem::transmute_copy(&bselectedcountersonly),
                )
                .into()
            }
        }
        unsafe extern "system" fn SaveAs<Identity: ISystemMonitor2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor2_Impl::SaveAs(
                    this,
                    core::mem::transmute(&bstrfilename),
                    core::mem::transmute_copy(&esysmonfiletype),
                )
                .into()
            }
        }
        unsafe extern "system" fn Relog<Identity: ISystemMonitor2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrfilename: *mut core::ffi::c_void,
            esysmonfiletype: SysmonFileType,
            ifilter: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor2_Impl::Relog(
                    this,
                    core::mem::transmute(&bstrfilename),
                    core::mem::transmute_copy(&esysmonfiletype),
                    core::mem::transmute_copy(&ifilter),
                )
                .into()
            }
        }
        unsafe extern "system" fn ClearData<Identity: ISystemMonitor2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn LogSourceStartTime<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn LogSourceStopTime<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetLogViewRange<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor2_Impl::SetLogViewRange(
                    this,
                    core::mem::transmute_copy(&starttime),
                    core::mem::transmute_copy(&stoptime),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetLogViewRange<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor2_Impl::GetLogViewRange(
                    this,
                    core::mem::transmute_copy(&starttime),
                    core::mem::transmute_copy(&stoptime),
                )
        ...
        unsafe extern "system" fn BatchingLock<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor2_Impl::BatchingLock(
                    this,
                    core::mem::transmute_copy(&flock),
                    core::mem::transmute_copy(&ebatchreason),
                )
                .into()
            }
        }
        unsafe extern "system" fn LoadSettings<
            Identity: ISystemMonitor2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrsettingfilename: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitor2_Impl::LoadSettings(this, core::mem::transmute(&bstrsettingfilename))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    ISystemMonitorEvents_Vtbl,
    0xee660ea0_4abd_11cf_943a_008029004347
);
...
impl ISystemMonitorEvents {
    pub unsafe fn OnCounterSelected(&self, index: i32) {
        unsafe {
            (windows_core::Interface::vtable(self).OnCounterSelected)(
                windows_core::Interface::as_raw(self),
                index,
            )
        }
    ...
    pub unsafe fn OnCounterAdded(&self, index: i32) {
        unsafe {
            (windows_core::Interface::vtable(self).OnCounterAdded)(
                windows_core::Interface::as_raw(self),
                index,
            )
        }
    ...
    pub unsafe fn OnCounterDeleted(&self, index: i32) {
        unsafe {
            (windows_core::Interface::vtable(self).OnCounterDeleted)(
                windows_core::Interface::as_raw(self),
                index,
            )
        }
    ...
    pub unsafe fn OnSampleCollected(&self) {
        unsafe {
            (windows_core::Interface::vtable(self).OnSampleCollected)(
                windows_core::Interface::as_raw(self),
            )
        }
    }
    pub unsafe fn OnDblClick(&self, index: i32) {
        unsafe {
            (windows_core::Interface::vtable(self).OnDblClick)(
                windows_core::Interface::as_raw(self),
                index,
            )
        }
...
impl ISystemMonitorEvents_Vtbl {
    pub const fn new<Identity: ISystemMonitorEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnCounterSelected<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISystemMonitorEvents_Impl::OnCounterSelected(
                    this,
                    core::mem::transmute_copy(&index),
                )
            }
        }
        unsafe extern "system" fn OnCounterAdded<
            Identity: ISystemMonitorEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn OnCounterDeleted<
            Identity: ISystemMonitorEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn OnSampleCollected<
            Identity: ISystemMonitorEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn OnDblClick<
            Identity: ISystemMonitorEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl ITraceDataCollector {
    pub unsafe fn BufferSize(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BufferSize)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetBufferSize(&self, size: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBufferSize)(
                windows_core::Interface::as_raw(self),
                size,
            )
            .ok()
    ...
    pub unsafe fn BuffersLost(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BuffersLost)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetBuffersLost(&self, buffers: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBuffersLost)(
                windows_core::Interface::as_raw(self),
                buffers,
            )
            .ok()
    ...
    pub unsafe fn BuffersWritten(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BuffersWritten)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetBuffersWritten(&self, buffers: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBuffersWritten)(
                windows_core::Interface::as_raw(self),
                buffers,
            )
            .ok()
    ...
    pub unsafe fn ClockType(&self) -> windows_core::Result<ClockType> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ClockType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetClockType(&self, clock: ClockType) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetClockType)(
                windows_core::Interface::as_raw(self),
                clock,
            )
            .ok()
    ...
    pub unsafe fn EventsLost(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EventsLost)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetEventsLost(&self, events: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetEventsLost)(
                windows_core::Interface::as_raw(self),
                events,
            )
            .ok()
    ...
    pub unsafe fn ExtendedModes(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExtendedModes)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetExtendedModes(&self, mode: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetExtendedModes)(
                windows_core::Interface::as_raw(self),
                mode,
            )
            .ok()
    ...
    pub unsafe fn FlushTimer(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FlushTimer)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetFlushTimer(&self, seconds: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFlushTimer)(
                windows_core::Interface::as_raw(self),
                seconds,
            )
            .ok()
    ...
    pub unsafe fn FreeBuffers(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FreeBuffers)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetFreeBuffers(&self, buffers: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFreeBuffers)(
                windows_core::Interface::as_raw(self),
                buffers,
            )
            .ok()
    ...
    pub unsafe fn IsKernelTrace(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsKernelTrace)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn MaximumBuffers(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MaximumBuffers)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMaximumBuffers(&self, buffers: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMaximumBuffers)(
                windows_core::Interface::as_raw(self),
                buffers,
            )
            .ok()
    ...
    pub unsafe fn MinimumBuffers(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MinimumBuffers)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMinimumBuffers(&self, buffers: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMinimumBuffers)(
                windows_core::Interface::as_raw(self),
                buffers,
            )
            .ok()
    ...
    pub unsafe fn NumberOfBuffers(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).NumberOfBuffers)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetNumberOfBuffers(&self, buffers: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetNumberOfBuffers)(
                windows_core::Interface::as_raw(self),
                buffers,
            )
            .ok()
    ...
    pub unsafe fn PreallocateFile(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PreallocateFile)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetPreallocateFile(
        &self,
        allocate: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPreallocateFile)(
                windows_core::Interface::as_raw(self),
                allocate,
            )
            .ok()
    ...
    pub unsafe fn ProcessMode(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProcessMode)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetProcessMode(
        &self,
        process: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetProcessMode)(
                windows_core::Interface::as_raw(self),
                process,
            )
            .ok()
    ...
    pub unsafe fn RealTimeBuffersLost(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RealTimeBuffersLost)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetRealTimeBuffersLost(&self, buffers: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetRealTimeBuffersLost)(
                windows_core::Interface::as_raw(self),
                buffers,
            )
            .ok()
    ...
    pub unsafe fn SetSessionId(&self, id: u64) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSessionId)(
                windows_core::Interface::as_raw(self),
                id,
            )
            .ok()
    ...
    pub unsafe fn SessionName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetSessionName(&self, name: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSessionName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(name),
            )
            .ok()
    ...
    pub unsafe fn SessionThreadId(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SessionThreadId)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSessionThreadId(&self, tid: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSessionThreadId)(
                windows_core::Interface::as_raw(self),
                tid,
            )
            .ok()
    ...
    pub unsafe fn StreamMode(&self) -> windows_core::Result<StreamMode> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StreamMode)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetStreamMode(&self, mode: StreamMode) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetStreamMode)(
                windows_core::Interface::as_raw(self),
                mode,
            )
            .ok()
    ...
    pub unsafe fn TraceDataProviders(&self) -> windows_core::Result<ITraceDataProviderCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TraceDataProviders)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ITraceDataCollector_Vtbl {
    ...
    pub BuffersWritten:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetBuffersWritten:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub ClockType:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut ClockType) -> windows_core::HRESULT,
    pub SetClockType:
        unsafe extern "system" fn(*mut core::ffi::c_void, ClockType) -> windows_core::HRESULT,
    pub EventsLost:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetEventsLost:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    ...
    pub IsKernelTrace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub MaximumBuffers:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetMaximumBuffers:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub MinimumBuffers:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetMinimumBuffers:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub NumberOfBuffers:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetNumberOfBuffers:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub PreallocateFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetPreallocateFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub ProcessMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetProcessMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub RealTimeBuffersLost:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetRealTimeBuffersLost:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub SessionId:
    ...
    pub SessionName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetSessionName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SessionThreadId:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetSessionThreadId:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub StreamMode:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut StreamMode) -> windows_core::HRESULT,
    pub SetStreamMode:
        unsafe extern "system" fn(*mut core::ffi::c_void, StreamMode) -> windows_core::HRESULT,
    pub TraceDataProviders: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ITraceDataCollector_Vtbl {
    pub const fn new<Identity: ITraceDataCollector_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BufferSize<
        ...
        unsafe extern "system" fn SetBufferSize<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetBufferSize(this, core::mem::transmute_copy(&size))
                    .into()
            }
        }
        unsafe extern "system" fn BuffersLost<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetBuffersLost(this, core::mem::transmute_copy(&buffers))
                    .into()
            }
        }
        unsafe extern "system" fn BuffersWritten<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetBuffersWritten<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetBuffersWritten(
                    this,
        ...
        unsafe extern "system" fn ClockType<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetClockType<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetClockType(this, core::mem::transmute_copy(&clock))
                    .into()
            }
        }
        unsafe extern "system" fn EventsLost<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetEventsLost(this, core::mem::transmute_copy(&events))
                    .into()
            }
        }
        unsafe extern "system" fn ExtendedModes<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetExtendedModes<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetExtendedModes(this, core::mem::transmute_copy(&mode))
                    .into()
            }
        }
        unsafe extern "system" fn FlushTimer<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetFlushTimer<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetFlushTimer(this, core::mem::transmute_copy(&seconds))
                    .into()
            }
        }
        unsafe extern "system" fn FreeBuffers<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetFreeBuffers<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetFreeBuffers(this, core::mem::transmute_copy(&buffers))
                    .into()
            }
        }
        unsafe extern "system" fn Guid<Identity: ITraceDataCollector_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetGuid<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn IsKernelTrace<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            kernel: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn MaximumBuffers<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetMaximumBuffers<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetMaximumBuffers(
                    this,
                    core::mem::transmute_copy(&buffers),
                )
                .into()
        ...
        unsafe extern "system" fn MinimumBuffers<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetMinimumBuffers<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetMinimumBuffers(
                    this,
                    core::mem::transmute_copy(&buffers),
                )
                .into()
        ...
        unsafe extern "system" fn NumberOfBuffers<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetNumberOfBuffers<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetNumberOfBuffers(
                    this,
                    core::mem::transmute_copy(&buffers),
                )
                .into()
        ...
        unsafe extern "system" fn PreallocateFile<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            allocate: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetPreallocateFile<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetPreallocateFile(
                    this,
                    core::mem::transmute_copy(&allocate),
                )
                .into()
            }
        }
        unsafe extern "system" fn ProcessMode<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            process: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetProcessMode(this, core::mem::transmute_copy(&process))
                    .into()
            }
        }
        ...
        unsafe extern "system" fn SetRealTimeBuffersLost<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetRealTimeBuffersLost(
                    this,
                    core::mem::transmute_copy(&buffers),
                )
                .into()
        ...
        unsafe extern "system" fn SetSessionId<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionName<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SessionThreadId<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetSessionThreadId(this, core::mem::transmute_copy(&tid))
                    .into()
            }
        }
        unsafe extern "system" fn StreamMode<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetStreamMode<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataCollector_Impl::SetStreamMode(this, core::mem::transmute_copy(&mode))
                    .into()
            }
        }
        unsafe extern "system" fn TraceDataProviders<
            Identity: ITraceDataCollector_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            providers: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ITraceDataProvider {
    ...
    pub unsafe fn Level(&self) -> windows_core::Result<IValueMap> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Level)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn KeywordsAny(&self) -> windows_core::Result<IValueMap> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).KeywordsAny)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn KeywordsAll(&self) -> windows_core::Result<IValueMap> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).KeywordsAll)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn FilterEnabled(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FilterEnabled)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetFilterEnabled(
        &self,
        filterenabled: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFilterEnabled)(
                windows_core::Interface::as_raw(self),
                filterenabled,
            )
            .ok()
    ...
    pub unsafe fn FilterType(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FilterType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetFilterType(&self, ultype: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFilterType)(
                windows_core::Interface::as_raw(self),
                ultype,
            )
            .ok()
    ...
    pub unsafe fn FilterData(&self) -> windows_core::Result<*mut super::Com::SAFEARRAY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FilterData)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetFilterData(
        &self,
        pdata: *const super::Com::SAFEARRAY,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFilterData)(
                windows_core::Interface::as_raw(self),
                pdata,
            )
            .ok()
    ...
    pub unsafe fn Query(
        ...
        bstrserver: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Query)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrname),
                core::mem::transmute_copy(bstrserver),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn SetSecurity(&self, sddl: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSecurity)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(sddl),
            )
            .ok()
        }
    }
    pub unsafe fn GetSecurity(
        &self,
        securityinfo: u32,
    ) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSecurity)(
                windows_core::Interface::as_raw(self),
                securityinfo,
                &mut result__,
            )
    ...
    pub unsafe fn GetRegisteredProcesses(&self) -> windows_core::Result<IValueMap> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRegisteredProcesses)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ITraceDataProvider_Vtbl {
    ...
    pub KeywordsAny: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub KeywordsAll: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub FilterEnabled: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetFilterEnabled: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub FilterType:
    ...
    pub SetFilterType:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub FilterData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub SetFilterData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::Com::SAFEARRAY,
    ) -> windows_core::HRESULT,
    pub Query: unsafe extern "system" fn(
    ...
    pub GetSecurity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetRegisteredProcesses: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub trait ITraceDataProvider_Impl: super::Com::IDispatch_Impl {
    ...
    fn Resolve(
        &self,
        pfrom: windows_core::Ref<'_, super::Com::IDispatch>,
    ) -> windows_core::Result<()>;
...
impl ITraceDataProvider_Vtbl {
    pub const fn new<Identity: ITraceDataProvider_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Guid<Identity: ITraceDataProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            guid: *mut windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Level<Identity: ITraceDataProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pplevel: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn KeywordsAny<
            Identity: ITraceDataProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppkeywords: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn KeywordsAll<
            Identity: ITraceDataProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn FilterEnabled<
            Identity: ITraceDataProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            filterenabled: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetFilterEnabled<
            Identity: ITraceDataProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataProvider_Impl::SetFilterEnabled(
                    this,
                    core::mem::transmute_copy(&filterenabled),
                )
                .into()
            }
        }
        unsafe extern "system" fn FilterType<
            Identity: ITraceDataProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetFilterType<
            Identity: ITraceDataProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataProvider_Impl::SetFilterType(this, core::mem::transmute_copy(&ultype))
                    .into()
            }
        }
        unsafe extern "system" fn FilterData<
            Identity: ITraceDataProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppdata: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetFilterData<
            Identity: ITraceDataProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataProvider_Impl::SetFilterData(this, core::mem::transmute_copy(&pdata))
                    .into()
            }
        }
        unsafe extern "system" fn Query<Identity: ITraceDataProvider_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrname: *mut core::ffi::c_void,
            bstrserver: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataProvider_Impl::Query(
                    this,
                    core::mem::transmute(&bstrname),
                    core::mem::transmute(&bstrserver),
                )
                .into()
            }
        }
        ...
        unsafe extern "system" fn GetSecurity<
            Identity: ITraceDataProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            securityinfo: u32,
            sddl: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITraceDataProvider_Impl::GetSecurity(
                    this,
                    core::mem::transmute_copy(&securityinfo),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetRegisteredProcesses<
            Identity: ITraceDataProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            processes: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ITraceDataProviderCollection {
    ...
    pub unsafe fn get_Item(
        &self,
        index: &super::Variant::VARIANT,
    ) -> windows_core::Result<ITraceDataProvider> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Item)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn Remove(&self, vprovider: &super::Variant::VARIANT) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Remove)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(vprovider),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn CreateTraceDataProvider(&self) -> windows_core::Result<ITraceDataProvider> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTraceDataProvider)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetTraceDataProviders(
        &self,
        server: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetTraceDataProviders)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(server),
            )
            .ok()
    ...
    pub unsafe fn GetTraceDataProvidersByProcess(
        &self,
        server: &windows_core::BSTR,
        pid: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetTraceDataProvidersByProcess)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(server),
                pid,
            )
...
pub struct ITraceDataProviderCollection_Vtbl {
    ...
    pub CreateTraceDataProvider: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetTraceDataProviders: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetTraceDataProvidersByProcess: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ) -> windows_core::HRESULT,
...
pub trait ITraceDataProviderCollection_Impl: super::Com::IDispatch_Impl {
    fn Count(&self) -> windows_core::Result<i32>;
    fn get_Item(&self, index: &super::Variant::VARIANT)
        -> windows_core::Result<ITraceDataProvider>;
    fn _NewEnum(&self) -> windows_core::Result<windows_core::IUnknown>;
    fn Add(&self, pprovider: windows_core::Ref<'_, ITraceDataProvider>)
        -> windows_core::Result<()>;
    fn Remove(&self, vprovider: &super::Variant::VARIANT) -> windows_core::Result<()>;
    fn Clear(&self) -> windows_core::Result<()>;
    fn AddRange(
        &self,
        providers: windows_core::Ref<'_, ITraceDataProviderCollection>,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: ITraceDataProviderCollection_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITraceDataProviderCollection_Impl::get_Item(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataProviderCollection_Impl::Add(this, core::mem::transmute_copy(&pprovider))
                    .into()
            }
        }
        unsafe extern "system" fn Remove<
        ...
        >(
            this: *mut core::ffi::c_void,
            vprovider: super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataProviderCollection_Impl::Remove(this, core::mem::transmute(&vprovider))
                    .into()
            }
        }
        unsafe extern "system" fn Clear<
        ...
        >(
            this: *mut core::ffi::c_void,
            providers: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataProviderCollection_Impl::AddRange(
                    this,
                    core::mem::transmute_copy(&providers),
                )
                .into()
            }
        }
        unsafe extern "system" fn CreateTraceDataProvider<
            Identity: ITraceDataProviderCollection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataProviderCollection_Impl::GetTraceDataProviders(
                    this,
                    core::mem::transmute(&server),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceDataProviderCollection_Impl::GetTraceDataProvidersByProcess(
                    this,
                    core::mem::transmute(&server),
                    core::mem::transmute_copy(&pid),
                )
                .into()
            }
        }
...
impl IValueMap {
    ...
    pub unsafe fn get_Item(
        &self,
        index: &super::Variant::VARIANT,
    ) -> windows_core::Result<IValueMapItem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Item)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn ValueMapType(&self) -> windows_core::Result<ValueMapType> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ValueMapType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetValueMapType(&self, r#type: ValueMapType) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetValueMapType)(
                windows_core::Interface::as_raw(self),
                r#type,
            )
            .ok()
    ...
    pub unsafe fn CreateValueMapItem(&self) -> windows_core::Result<IValueMapItem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateValueMapItem)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IValueMap_Vtbl {
    ...
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    SetValue: usize,
    pub ValueMapType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ValueMapType,
    ) -> windows_core::HRESULT,
    pub SetValueMapType:
        unsafe extern "system" fn(*mut core::ffi::c_void, ValueMapType) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub Add: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::Variant::VARIANT,
    ...
    pub CreateValueMapItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IValueMap_Vtbl {
    pub const fn new<Identity: IValueMap_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Count<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            retval: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn get_Item<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: super::Variant::VARIANT,
            value: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn _NewEnum<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            retval: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Description<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            description: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetDescription<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            description: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Value<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetValue<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ValueMapType<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            r#type: *mut ValueMapType,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetValueMapType<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            r#type: ValueMapType,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Add<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Remove<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Clear<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn AddRange<Identity: IValueMap_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CreateValueMapItem<
...
impl IValueMapItem_Vtbl {
    pub const fn new<Identity: IValueMapItem_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Description<Identity: IValueMapItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            description: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Enabled<Identity: IValueMapItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            enabled: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetEnabled<Identity: IValueMapItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            enabled: super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Key<Identity: IValueMapItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetKey<Identity: IValueMapItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            key: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Value<Identity: IValueMapItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetValue<Identity: IValueMapItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ValueMapType<
            Identity: IValueMapItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetValueMapType<
            Identity: IValueMapItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub const LIBID_SystemMonitor: windows_core::GUID =
    windows_core::GUID::from_u128(0x1b773e42_2509_11cf_942f_008029004347);
pub const LegacyDataCollectorSet: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837526_098b_11d8_9414_505054503030);
pub const LegacyDataCollectorSetCollection: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837527_098b_11d8_9414_505054503030);
pub const LegacyTraceSession: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837528_098b_11d8_9414_505054503030);
pub const LegacyTraceSessionCollection: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837529_098b_11d8_9414_505054503030);
pub const LogFileItem: windows_core::GUID =
    windows_core::GUID::from_u128(0x16ec5be8_df93_4237_94e4_9ee918111d71);
pub const LogFiles: windows_core::GUID =
    windows_core::GUID::from_u128(0x2735d9fd_f6b9_4f19_a5d9_e2d068584bc5);
...
pub type PLA_CABEXTRACT_CALLBACK = Option<
    unsafe extern "system" fn(filename: windows_core::PCWSTR, context: *mut core::ffi::c_void),
>;
...
pub type PM_COLLECT_PROC = Option<
    unsafe extern "system" fn(
        pvaluename: windows_core::PCWSTR,
        ppdata: *mut *mut core::ffi::c_void,
        pcbtotalbytes: *mut u32,
        pnumobjecttypes: *mut u32,
    ) -> u32,
>;
...
pub const S_PDH: windows_core::GUID =
    windows_core::GUID::from_u128(0x04d66358_c4a1_419b_8023_23b73902de2c);
pub const ServerDataCollectorSet: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837531_098b_11d8_9414_505054503030);
pub const ServerDataCollectorSetCollection: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837532_098b_11d8_9414_505054503030);
pub const SourcePropPage: windows_core::GUID =
    windows_core::GUID::from_u128(0x0cf32aa1_7571_11d0_93c4_00aa00a3ddea);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const SystemDataCollectorSet: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837546_098b_11d8_9414_505054503030);
pub const SystemDataCollectorSetCollection: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837547_098b_11d8_9414_505054503030);
pub const SystemMonitor: windows_core::GUID =
    windows_core::GUID::from_u128(0xc4d2d8e0_d1dd_11ce_940f_008029004347);
pub const SystemMonitor2: windows_core::GUID =
    windows_core::GUID::from_u128(0x7f30578c_5f38_4612_acfe_6ed04c7b7af8);
pub const TraceDataProvider: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837513_098b_11d8_9414_505054503030);
pub const TraceDataProviderCollection: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837511_098b_11d8_9414_505054503030);
pub const TraceSession: windows_core::GUID =
    windows_core::GUID::from_u128(0x0383751c_098b_11d8_9414_505054503030);
pub const TraceSessionCollection: windows_core::GUID =
    windows_core::GUID::from_u128(0x03837530_098b_11d8_9414_505054503030);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
windows_core::imp::define_interface!(
    _ICounterItemUnion,
    _ICounterItemUnion_Vtbl,
    0xde1a6b74_9182_4c41_8e2c_24c2cd30ee83
);
...
impl _ICounterItemUnion_Vtbl {
    pub const fn new<Identity: _ICounterItemUnion_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Value<Identity: _ICounterItemUnion_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdblvalue: *mut f64,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Color<Identity: _ICounterItemUnion_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pcolor: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Width<Identity: _ICounterItemUnion_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pivalue: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetLineStyle<
            Identity: _ICounterItemUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ICounterItemUnion_Impl::SetLineStyle(this, core::mem::transmute_copy(&ilinestyle))
                    .into()
            }
        }
        unsafe extern "system" fn LineStyle<
            Identity: _ICounterItemUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ICounterItemUnion_Impl::SetScaleFactor(this, core::mem::transmute_copy(&iscale))
                    .into()
            }
        }
        ...
        unsafe extern "system" fn Path<Identity: _ICounterItemUnion_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pstrvalue: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ICounterItemUnion_Impl::GetValue(
                    this,
                    core::mem::transmute_copy(&value),
                    core::mem::transmute_copy(&status),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ICounterItemUnion_Impl::GetStatistics(
                    this,
                    core::mem::transmute_copy(&max),
                    core::mem::transmute_copy(&min),
                    core::mem::transmute_copy(&avg),
        ...
        unsafe extern "system" fn SetSelected<
            Identity: _ICounterItemUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ICounterItemUnion_Impl::SetSelected(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        ...
        unsafe extern "system" fn SetVisible<
            Identity: _ICounterItemUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetDataAt<
            Identity: _ICounterItemUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match _ICounterItemUnion_Impl::GetDataAt(
                    this,
                    core::mem::transmute_copy(&iindex),
                    core::mem::transmute_copy(&iwhich),
                ) {
...
windows_core::imp::define_interface!(
    ...
    _ISystemMonitorUnion_Vtbl,
    0xc8a77338_265f_4de5_aa25_c7da1ce5a8f4
);
...
impl _ISystemMonitorUnion_Vtbl {
    pub const fn new<Identity: _ISystemMonitorUnion_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Appearance<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetAppearance(
                    this,
                    core::mem::transmute_copy(&iappearance),
                )
                .into()
            }
        }
        unsafe extern "system" fn BackColor<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetBackColor(this, core::mem::transmute_copy(&color))
                    .into()
            }
        }
        unsafe extern "system" fn BorderStyle<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetBorderStyle(
                    this,
                    core::mem::transmute_copy(&iborderstyle),
                )
                .into()
            }
        }
        unsafe extern "system" fn ForeColor<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetForeColor(this, core::mem::transmute_copy(&color))
                    .into()
            }
        }
        unsafe extern "system" fn Font<Identity: _ISystemMonitorUnion_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppfont: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::putref_Font(this, core::mem::transmute_copy(&pfont))
                    .into()
            }
        }
        unsafe extern "system" fn Counters<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetShowVerticalGrid(
                    this,
                    core::mem::transmute_copy(&bstate),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetShowHorizontalGrid(
                    this,
                    core::mem::transmute_copy(&bstate),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetShowLegend(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        unsafe extern "system" fn ShowLegend<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetShowScaleLabels(
                    this,
                    core::mem::transmute_copy(&bstate),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetShowValueBar(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        unsafe extern "system" fn ShowValueBar<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetMaximumScale(this, core::mem::transmute_copy(&ivalue))
                    .into()
            }
        }
        unsafe extern "system" fn MaximumScale<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetMinimumScale(this, core::mem::transmute_copy(&ivalue))
                    .into()
            }
        }
        unsafe extern "system" fn MinimumScale<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetUpdateInterval(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetDisplayType(
                    this,
                    core::mem::transmute_copy(&edisplaytype),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetManualUpdate(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        unsafe extern "system" fn ManualUpdate<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetGraphTitle(this, core::mem::transmute(&bstitle))
                    .into()
            }
        }
        unsafe extern "system" fn GraphTitle<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetYAxisLabel(this, core::mem::transmute(&bstitle))
                    .into()
            }
        }
        unsafe extern "system" fn YAxisLabel<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AddCounter<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::DeleteCounter(this, core::mem::transmute_copy(&pctr))
                    .into()
            }
        }
        unsafe extern "system" fn BackColorCtl<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetBackColorCtl(this, core::mem::transmute_copy(&color))
                    .into()
            }
        }
        unsafe extern "system" fn SetLogFileName<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetLogFileName(this, core::mem::transmute(&bsfilename))
                    .into()
            }
        }
        unsafe extern "system" fn LogFileName<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetLogViewStart(
                    this,
                    core::mem::transmute_copy(&starttime),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetLogViewStop(
                    this,
                    core::mem::transmute_copy(&stoptime),
                )
                .into()
        ...
        unsafe extern "system" fn GridColor<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetGridColor(this, core::mem::transmute_copy(&color))
                    .into()
            }
        }
        unsafe extern "system" fn TimeBarColor<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetTimeBarColor(this, core::mem::transmute_copy(&color))
                    .into()
            }
        }
        unsafe extern "system" fn Highlight<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetHighlight(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        unsafe extern "system" fn ShowToolbar<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetShowToolbar(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        ...
        unsafe extern "system" fn Copy<Identity: _ISystemMonitorUnion_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetReadOnly(this, core::mem::transmute_copy(&bstate))
                    .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetReportValueType(
                    this,
                    core::mem::transmute_copy(&ereportvaluetype),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetMonitorDuplicateInstances(
                    this,
                    core::mem::transmute_copy(&bstate),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetDisplayFilter(
                    this,
                    core::mem::transmute_copy(&ivalue),
                )
                .into()
            }
        }
        ...
        unsafe extern "system" fn LogFiles<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetDataSourceType(
                    this,
                    core::mem::transmute_copy(&edatasourcetype),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetSqlDsnName(this, core::mem::transmute(&bssqldsnname))
                    .into()
            }
        }
        unsafe extern "system" fn SqlDsnName<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetSqlLogSetName(
                    this,
                    core::mem::transmute(&bssqllogsetname),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetEnableDigitGrouping(
                    this,
                    core::mem::transmute_copy(&bstate),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetEnableToolTips(
                    this,
                    core::mem::transmute_copy(&bstate),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetShowTimeAxisLabels(
                    this,
                    core::mem::transmute_copy(&bstate),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetChartScroll(this, core::mem::transmute_copy(&bscroll))
                    .into()
            }
        }
        unsafe extern "system" fn ChartScroll<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetDataPointCount(
                    this,
                    core::mem::transmute_copy(&inewcount),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::ScaleToFit(
                    this,
                    core::mem::transmute_copy(&bselectedcountersonly),
                )
                .into()
        ...
        unsafe extern "system" fn SaveAs<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SaveAs(
                    this,
                    core::mem::transmute(&bstrfilename),
                    core::mem::transmute_copy(&esysmonfiletype),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::Relog(
                    this,
                    core::mem::transmute(&bstrfilename),
                    core::mem::transmute_copy(&esysmonfiletype),
                    core::mem::transmute_copy(&ifilter),
        ...
        unsafe extern "system" fn ClearData<
            Identity: _ISystemMonitorUnion_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::SetLogViewRange(
                    this,
                    core::mem::transmute_copy(&starttime),
                    core::mem::transmute_copy(&stoptime),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::GetLogViewRange(
                    this,
                    core::mem::transmute_copy(&starttime),
                    core::mem::transmute_copy(&stoptime),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::BatchingLock(
                    this,
                    core::mem::transmute_copy(&flock),
                    core::mem::transmute_copy(&ebatchreason),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                _ISystemMonitorUnion_Impl::LoadSettings(
                    this,
                    core::mem::transmute(&bstrsettingfilename),
                )
                .into()
            }
        }

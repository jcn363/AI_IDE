#[inline]
pub unsafe fn AddVirtualDiskParent<P1>(
...
pub unsafe fn AttachVirtualDisk(
    virtualdiskhandle: super::super::Foundation::HANDLE,
    securitydescriptor: Option<super::super::Security::PSECURITY_DESCRIPTOR>,
...
#[cfg(all(feature = "Win32_Security", feature = "Win32_System_IO"))]
#[inline]
pub unsafe fn CreateVirtualDisk<P1>(
...
pub unsafe fn GetAllAttachedVirtualDiskPhysicalPaths(
    ...
    pathsbuffer: windows_core::PWSTR,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        GetAllAttachedVirtualDiskPhysicalPaths(
            pathsbuffersizeinbytes as _,
            core::mem::transmute(pathsbuffer),
        )
    }
}
#[inline]
pub unsafe fn GetStorageDependencyInformation(
    ...
    unsafe {
        GetStorageDependencyInformation(
            ...
            storagedependencyinfo as _,
            sizeused.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn GetVirtualDiskInformation(
    ...
    unsafe {
        GetVirtualDiskInformation(
            virtualdiskhandle,
            virtualdiskinfosize as _,
            virtualdiskinfo as _,
            sizeused.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
pub unsafe fn GetVirtualDiskPhysicalPath(
    ...
    unsafe {
        GetVirtualDiskPhysicalPath(
            virtualdiskhandle,
            diskpathsizeinbytes as _,
            core::mem::transmute(diskpath),
        )
    }
}
#[cfg(feature = "Win32_System_IO")]
...
#[inline]
pub unsafe fn OpenVirtualDisk<P1>(
    virtualstoragetype: *const VIRTUAL_STORAGE_TYPE,
    path: P1,
    virtualdiskaccessmask: VIRTUAL_DISK_ACCESS_MASK,
    flags: OPEN_VIRTUAL_DISK_FLAG,
    parameters: Option<*const OPEN_VIRTUAL_DISK_PARAMETERS>,
    handle: *mut super::super::Foundation::HANDLE,
) -> super::super::Foundation::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn QueryChangesVirtualDisk<P1>(
    virtualdiskhandle: super::super::Foundation::HANDLE,
    changetrackingid: P1,
    byteoffset: u64,
    bytelength: u64,
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        QueryChangesVirtualDisk(
            virtualdiskhandle,
            changetrackingid.param().abi(),
            byteoffset,
            bytelength,
            flags,
            ranges as _,
            rangecount as _,
            processedlength as _,
        )
    }
}
#[inline]
...
pub const ATTACH_VIRTUAL_DISK_FLAG_AT_BOOT: ATTACH_VIRTUAL_DISK_FLAG =
...
pub const QUERY_CHANGES_VIRTUAL_DISK_FLAG_NONE: QUERY_CHANGES_VIRTUAL_DISK_FLAG =
    QUERY_CHANGES_VIRTUAL_DISK_FLAG(0i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const RAW_SCSI_VIRTUAL_DISK_FLAG_NONE: RAW_SCSI_VIRTUAL_DISK_FLAG =
    RAW_SCSI_VIRTUAL_DISK_FLAG(0i32);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const VIRTUAL_DISK_ACCESS_METAOPS: VIRTUAL_DISK_ACCESS_MASK =
    VIRTUAL_DISK_ACCESS_MASK(2097152i32);
...
pub const VIRTUAL_DISK_ACCESS_WRITABLE: VIRTUAL_DISK_ACCESS_MASK =
    VIRTUAL_DISK_ACCESS_MASK(3276800i32);
...
pub const VIRTUAL_STORAGE_TYPE_VENDOR_MICROSOFT: windows_core::GUID =
    windows_core::GUID::from_u128(0xec984aec_a0f9_47e9_901f_71415a66345b);
pub const VIRTUAL_STORAGE_TYPE_VENDOR_UNKNOWN: windows_core::GUID =

...
pub unsafe fn QOSAddSocketToFlow(
    ...
    socket: super::super::Networking::WinSock::SOCKET,
    destaddr: Option<*const super::super::Networking::WinSock::SOCKADDR>,
    ...
    unsafe {
        QOSAddSocketToFlow(
            qoshandle,
            socket,
            destaddr.unwrap_or(core::mem::zeroed()) as _,
            traffictype,
...
#[inline]
pub unsafe fn QOSCreateHandle(
    version: *const QOS_VERSION,
    qoshandle: *mut super::super::Foundation::HANDLE,
) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn QOSEnumerateFlows(
    qoshandle: super::super::Foundation::HANDLE,
    size: *mut u32,
...
pub unsafe fn QOSNotifyFlow(
    ...
    flags: Option<u32>,
    overlapped: Option<*mut super::super::System::IO::OVERLAPPED>,
) -> windows_core::BOOL {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn QOSRemoveSocketFromFlow(
    qoshandle: super::super::Foundation::HANDLE,
    socket: Option<super::super::Networking::WinSock::SOCKET>,
    flowid: u32,
    flags: Option<u32>,
) -> windows_core::BOOL {
    ...
    unsafe {
        QOSRemoveSocketFromFlow(
            qoshandle,
            socket.unwrap_or(core::mem::zeroed()) as _,
            flowid,
            flags.unwrap_or(core::mem::zeroed()) as _,
        )
    }
...
pub unsafe fn QOSStartTrackingClient(
    qoshandle: super::super::Foundation::HANDLE,
    destaddr: *const super::super::Networking::WinSock::SOCKADDR,
    flags: Option<u32>,
) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn TcAddFilter(
    flowhandle: super::super::Foundation::HANDLE,
    pgenericfilter: *const TC_GEN_FILTER,
    pfilterhandle: *mut super::super::Foundation::HANDLE,
) -> u32 {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn TcAddFlow(
    ifchandle: super::super::Foundation::HANDLE,
    clflowctx: super::super::Foundation::HANDLE,
    flags: u32,
    pgenericflow: *const TC_GEN_FLOW,
    pflowhandle: *mut super::super::Foundation::HANDLE,
) -> u32 {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn TcEnumerateFlows(
    ifchandle: super::super::Foundation::HANDLE,
    penumhandle: *mut super::super::Foundation::HANDLE,
    pflowcount: *mut u32,
    pbufsize: *mut u32,
    buffer: *mut ENUMERATION_BUFFER,
) -> u32 {
...
#[inline]
pub unsafe fn TcEnumerateInterfaces(
    clienthandle: super::super::Foundation::HANDLE,
    pbuffersize: *mut u32,
    interfacebuffer: *mut TC_IFC_DESCRIPTOR,
) -> u32 {
...
pub unsafe fn TcGetFlowNameA(
    ...
    unsafe {
        TcGetFlowNameA(
            flowhandle,
            pflowname.len().try_into().unwrap(),
            core::mem::transmute(pflowname.as_ptr()),
        )
    }
}
#[inline]
pub unsafe fn TcGetFlowNameW(
    flowhandle: super::super::Foundation::HANDLE,
    pflowname: &mut [u16],
) -> u32 {
...
#[inline]
pub unsafe fn TcOpenInterfaceA<P0>(
    pinterfacename: P0,
    clienthandle: super::super::Foundation::HANDLE,
    clifcctx: super::super::Foundation::HANDLE,
    pifchandle: *mut super::super::Foundation::HANDLE,
) -> u32
where
...
#[inline]
pub unsafe fn TcOpenInterfaceW<P0>(
    pinterfacename: P0,
    clienthandle: super::super::Foundation::HANDLE,
    clifcctx: super::super::Foundation::HANDLE,
    pifchandle: *mut super::super::Foundation::HANDLE,
...
#[inline]
pub unsafe fn TcQueryFlowA<P0>(
    pflowname: P0,
    pguidparam: *const windows_core::GUID,
    pbuffersize: *mut u32,
    buffer: *mut core::ffi::c_void,
) -> u32
where
...
#[inline]
pub unsafe fn TcQueryInterface(
    ifchandle: super::super::Foundation::HANDLE,
    pguidparam: *const windows_core::GUID,
    notifychange: bool,
    pbuffersize: *mut u32,
...
#[inline]
pub unsafe fn TcRegisterClient(
    tciversion: u32,
    clregctx: super::super::Foundation::HANDLE,
    clienthandlerlist: *const TCI_CLIENT_FUNC_LIST,
    pclienthandle: *mut super::super::Foundation::HANDLE,
) -> u32 {
...
pub type CBADMITRESULT = Option<
    unsafe extern "system" fn(
        ...
        ppolicydecisions: *mut POLICY_DECISION,
    ) -> *mut u32,
>;
pub type CBGETRSVPOBJECTS = Option<
    unsafe extern "system" fn(
        lpmhandle: LPM_HANDLE,
        requesthandle: RHANDLE,
        lpmerror: i32,
        rsvpobjectscount: i32,
        pprsvpobjects: *mut *mut RsvpObjHdr,
    ) -> *mut u32,
>;
...
pub const GUID_QOS_BESTEFFORT_BANDWIDTH: windows_core::GUID =
    windows_core::GUID::from_u128(0xed885290_40ec_11d1_2c91_00aa00574915);
pub const GUID_QOS_ENABLE_AVG_STATS: windows_core::GUID =
    windows_core::GUID::from_u128(0xbafb6d11_27c4_4801_a46f_ef8080c188c8);
pub const GUID_QOS_ENABLE_WINDOW_ADJUSTMENT: windows_core::GUID =
    windows_core::GUID::from_u128(0xaa966725_d3e9_4c55_b335_2a00279a1e64);
pub const GUID_QOS_FLOW_8021P_CONFORMING: windows_core::GUID =
    windows_core::GUID::from_u128(0x08c1e013_fcd2_11d2_be1e_00a0c99ee63b);
pub const GUID_QOS_FLOW_8021P_NONCONFORMING: windows_core::GUID =
    windows_core::GUID::from_u128(0x09023f91_fcd2_11d2_be1e_00a0c99ee63b);
pub const GUID_QOS_FLOW_COUNT: windows_core::GUID =
    windows_core::GUID::from_u128(0x1147f880_40ed_11d1_2c91_00aa00574915);
pub const GUID_QOS_FLOW_IP_CONFORMING: windows_core::GUID =
    windows_core::GUID::from_u128(0x07f99a8b_fcd2_11d2_be1e_00a0c99ee63b);
pub const GUID_QOS_FLOW_IP_NONCONFORMING: windows_core::GUID =
    windows_core::GUID::from_u128(0x087a5987_fcd2_11d2_be1e_00a0c99ee63b);
pub const GUID_QOS_FLOW_MODE: windows_core::GUID =
    windows_core::GUID::from_u128(0x5c82290a_515a_11d2_8e58_00c04fc9bfcb);
pub const GUID_QOS_ISSLOW_FLOW: windows_core::GUID =
    windows_core::GUID::from_u128(0xabf273a4_ee07_11d2_be1b_00a0c99ee63b);
pub const GUID_QOS_LATENCY: windows_core::GUID =
    windows_core::GUID::from_u128(0xfc408ef0_40ec_11d1_2c91_00aa00574915);
pub const GUID_QOS_MAX_OUTSTANDING_SENDS: windows_core::GUID =
    windows_core::GUID::from_u128(0x161ffa86_6120_11d1_2c91_00aa00574915);
pub const GUID_QOS_NON_BESTEFFORT_LIMIT: windows_core::GUID =
    windows_core::GUID::from_u128(0x185c44e0_40ed_11d1_2c91_00aa00574915);
pub const GUID_QOS_REMAINING_BANDWIDTH: windows_core::GUID =
    windows_core::GUID::from_u128(0xc4c51720_40ec_11d1_2c91_00aa00574915);
pub const GUID_QOS_STATISTICS_BUFFER: windows_core::GUID =
    windows_core::GUID::from_u128(0xbb2c0980_e900_11d1_b07e_0080c71382bf);
pub const GUID_QOS_TIMER_RESOLUTION: windows_core::GUID =
    windows_core::GUID::from_u128(0xba10cc88_f13e_11d2_be1b_00a0c99ee63b);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub type TCI_ADD_FLOW_COMPLETE_HANDLER =
    Option<unsafe extern "system" fn(clflowctx: super::super::Foundation::HANDLE, status: u32)>;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub type TCI_DEL_FLOW_COMPLETE_HANDLER =
    Option<unsafe extern "system" fn(clflowctx: super::super::Foundation::HANDLE, status: u32)>;
pub type TCI_MOD_FLOW_COMPLETE_HANDLER =
    Option<unsafe extern "system" fn(clflowctx: super::super::Foundation::HANDLE, status: u32)>;
pub type TCI_NOTIFY_HANDLER = Option<
    unsafe extern "system" fn(
        clregctx: super::super::Foundation::HANDLE,
        clifcctx: super::super::Foundation::HANDLE,
        event: u32,
        subcode: super::super::Foundation::HANDLE,
        bufsize: u32,
        buffer: *const core::ffi::c_void,
    ),
>;

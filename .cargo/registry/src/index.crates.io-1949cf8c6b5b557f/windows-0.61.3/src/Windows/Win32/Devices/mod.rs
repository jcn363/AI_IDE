...
pub const BUS1394_LOCAL_HOST_INSTANCE_KEY: windows_core::PCWSTR =
    windows_core::w!("LOCAL HOST EUI64");
pub const BUS1394_VIRTUAL_DEVICE_LIST_KEY: windows_core::PCWSTR =
    windows_core::w!("Virtual Device List");

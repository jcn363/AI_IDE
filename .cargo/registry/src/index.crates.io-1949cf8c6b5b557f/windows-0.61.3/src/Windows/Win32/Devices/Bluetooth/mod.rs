...
pub unsafe fn BluetoothAuthenticateDevice(
    ...
    hradio: Option<super::super::Foundation::HANDLE>,
    pbtbi: *mut BLUETOOTH_DEVICE_INFO,
    pszpasskey: Option<&[u16]>,
) -> u32 {
    ...
    unsafe {
        BluetoothAuthenticateDevice(
            ...
            hradio.unwrap_or(core::mem::zeroed()) as _,
            pbtbi as _,
            core::mem::transmute(
                pszpasskey
                    .as_deref()
...
pub unsafe fn BluetoothAuthenticateDeviceEx(
    hwndparentin: Option<super::super::Foundation::HWND>,
    hradioin: Option<super::super::Foundation::HANDLE>,
    ...
    unsafe {
        BluetoothAuthenticateDeviceEx(
            hwndparentin.unwrap_or(core::mem::zeroed()) as _,
            hradioin.unwrap_or(core::mem::zeroed()) as _,
            pbtdiinout as _,
            pbtoobdata.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn BluetoothAuthenticateMultipleDevices(
    ...
    unsafe {
        BluetoothAuthenticateMultipleDevices(
            hwndparent.unwrap_or(core::mem::zeroed()) as _,
            hradio.unwrap_or(core::mem::zeroed()) as _,
            rgbtdi.len().try_into().unwrap(),
            core::mem::transmute(rgbtdi.as_ptr()),
        )
    }
}
#[inline]
pub unsafe fn BluetoothDisplayDeviceProperties(
    ...
    unsafe {
        BluetoothDisplayDeviceProperties(hwndparent.unwrap_or(core::mem::zeroed()) as _, pbtdi as _)
            .ok()
    }
}
#[inline]
...
pub unsafe fn BluetoothEnumerateInstalledServices(
    ...
    pcserviceinout: *mut u32,
    pguidservices: Option<*mut windows_core::GUID>,
) -> u32 {
    ...
    unsafe {
        BluetoothEnumerateInstalledServices(
            ...
            pbtdi,
            pcserviceinout as _,
            pguidservices.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn BluetoothFindFirstDevice(
    ...
    pbtdi: *mut BLUETOOTH_DEVICE_INFO,
) -> windows_core::Result<HBLUETOOTH_DEVICE_FIND> {
...
) -> windows_core::Result<HBLUETOOTH_RADIO_FIND> {
...
#[inline]
pub unsafe fn BluetoothGATTAbortReliableWrite(
...
#[inline]
pub unsafe fn BluetoothGATTBeginReliableWrite(
    hdevice: super::super::Foundation::HANDLE,
    reliablewritecontext: *mut u64,
    flags: u32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn BluetoothGATTEndReliableWrite(
    hdevice: super::super::Foundation::HANDLE,
    reliablewritecontext: u64,
    flags: u32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn BluetoothGATTGetCharacteristicValue(
    hdevice: super::super::Foundation::HANDLE,
    characteristic: *const BTH_LE_GATT_CHARACTERISTIC,
    characteristicvaluedatasize: u32,
    characteristicvalue: Option<*mut BTH_LE_GATT_CHARACTERISTIC_VALUE>,
    characteristicvaluesizerequired: Option<*mut u16>,
    flags: u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        BluetoothGATTGetCharacteristicValue(
            ...
            characteristic,
            characteristicvaluedatasize,
            characteristicvalue.unwrap_or(core::mem::zeroed()) as _,
            characteristicvaluesizerequired.unwrap_or(core::mem::zeroed()) as _,
            flags,
        )
        .ok()
    }
...
pub unsafe fn BluetoothGATTGetCharacteristics(
    ...
    unsafe {
        BluetoothGATTGetCharacteristics(
            hdevice,
            service.unwrap_or(core::mem::zeroed()) as _,
            ...
            characteristicsbufferactual as _,
            flags,
        )
        .ok()
    }
...
pub unsafe fn BluetoothGATTGetDescriptorValue(
    ...
    unsafe {
        BluetoothGATTGetDescriptorValue(
            ...
            descriptorvalue.unwrap_or(core::mem::zeroed()) as _,
            descriptorvaluesizerequired.unwrap_or(core::mem::zeroed()) as _,
            flags,
        )
        .ok()
    }
...
pub unsafe fn BluetoothGATTGetIncludedServices(
    ...
    unsafe {
        BluetoothGATTGetIncludedServices(
            hdevice,
            parentservice.unwrap_or(core::mem::zeroed()) as _,
            ...
            includedservicesbufferactual as _,
            flags,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn BluetoothGATTGetServices(
    hdevice: super::super::Foundation::HANDLE,
...
pub unsafe fn BluetoothGATTRegisterEvent(
    hservice: super::super::Foundation::HANDLE,
    eventtype: BTH_LE_GATT_EVENT_TYPE,
    eventparameterin: *const core::ffi::c_void,
...
pub unsafe fn BluetoothGATTSetCharacteristicValue(
    ...
    unsafe {
        BluetoothGATTSetCharacteristicValue(
            ...
            characteristic,
            characteristicvalue,
            reliablewritecontext.unwrap_or(core::mem::zeroed()) as _,
            flags,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn BluetoothGATTUnregisterEvent(
    eventhandle: isize,
    flags: u32,
) -> windows_core::Result<()> {
...
pub unsafe fn BluetoothGetRadioInfo(
    hradio: super::super::Foundation::HANDLE,
...
pub unsafe fn BluetoothRegisterForAuthentication(
    ...
    unsafe {
        BluetoothRegisterForAuthentication(
            pbtdi.unwrap_or(core::mem::zeroed()) as _,
            phreghandle as _,
            pfncallback,
...
pub unsafe fn BluetoothRegisterForAuthenticationEx(
    ...
    unsafe {
        BluetoothRegisterForAuthenticationEx(
            pbtdiin.unwrap_or(core::mem::zeroed()) as _,
            phreghandleout as _,
            pfncallbackin,
            pvparam.unwrap_or(core::mem::zeroed()) as _,
        )
...
pub unsafe fn BluetoothSdpEnumAttributes(
    ...
    unsafe {
        BluetoothSdpEnumAttributes(
            core::mem::transmute(psdpstream.as_ptr()),
            psdpstream.len().try_into().unwrap(),
            pfncallback,
            pvparam,
        )
        .ok()
...
pub unsafe fn BluetoothSdpGetAttributeValue(
    precordstream: &[u8],
    usattributeid: u16,
    pattributedata: *mut SDP_ELEMENT_DATA,
) -> u32 {
    ...
    unsafe {
        BluetoothSdpGetAttributeValue(
            core::mem::transmute(precordstream.as_ptr()),
            precordstream.len().try_into().unwrap(),
            usattributeid,
            pattributedata as _,
        )
    }
...
pub unsafe fn BluetoothSdpGetContainerElementData(
    ...
    unsafe {
        BluetoothSdpGetContainerElementData(
            core::mem::transmute(pcontainerstream.as_ptr()),
            pcontainerstream.len().try_into().unwrap(),
            pelement as _,
            pdata as _,
        )
    }
...
pub unsafe fn BluetoothSdpGetString(
    precordstream: &[u8],
    pstringdata: Option<*const SDP_STRING_TYPE_DATA>,
    usstringoffset: u16,
    pszstring: windows_core::PWSTR,
    pcchstringlength: *mut u32,
) -> u32 {
    ...
    unsafe {
        BluetoothSdpGetString(
            core::mem::transmute(precordstream.as_ptr()),
            precordstream.len().try_into().unwrap(),
            pstringdata.unwrap_or(core::mem::zeroed()) as _,
            usstringoffset,
            core::mem::transmute(pszstring),
            pcchstringlength as _,
        )
    }
}
#[inline]
...
pub unsafe fn BluetoothSetLocalServiceInfo(
    hradioin: Option<super::super::Foundation::HANDLE>,
    pclassguid: *const windows_core::GUID,
    ulinstance: u32,
...
pub const BLUETOOTH_AUTHENTICATION_METHOD_LEGACY: BLUETOOTH_AUTHENTICATION_METHOD =
    BLUETOOTH_AUTHENTICATION_METHOD(1i32);
pub const BLUETOOTH_AUTHENTICATION_METHOD_NUMERIC_COMPARISON: BLUETOOTH_AUTHENTICATION_METHOD =
    BLUETOOTH_AUTHENTICATION_METHOD(3i32);
pub const BLUETOOTH_AUTHENTICATION_METHOD_OOB: BLUETOOTH_AUTHENTICATION_METHOD =
    BLUETOOTH_AUTHENTICATION_METHOD(2i32);
pub const BLUETOOTH_AUTHENTICATION_METHOD_PASSKEY: BLUETOOTH_AUTHENTICATION_METHOD =
    BLUETOOTH_AUTHENTICATION_METHOD(5i32);
pub const BLUETOOTH_AUTHENTICATION_METHOD_PASSKEY_NOTIFICATION: BLUETOOTH_AUTHENTICATION_METHOD =
    BLUETOOTH_AUTHENTICATION_METHOD(4i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const BLUETOOTH_IO_CAPABILITY_DISPLAYONLY: BLUETOOTH_IO_CAPABILITY =
    BLUETOOTH_IO_CAPABILITY(0i32);
pub const BLUETOOTH_IO_CAPABILITY_DISPLAYYESNO: BLUETOOTH_IO_CAPABILITY =
    BLUETOOTH_IO_CAPABILITY(1i32);
pub const BLUETOOTH_IO_CAPABILITY_KEYBOARDONLY: BLUETOOTH_IO_CAPABILITY =
    BLUETOOTH_IO_CAPABILITY(2i32);
pub const BLUETOOTH_IO_CAPABILITY_NOINPUTNOOUTPUT: BLUETOOTH_IO_CAPABILITY =
    BLUETOOTH_IO_CAPABILITY(3i32);
pub const BLUETOOTH_IO_CAPABILITY_UNDEFINED: BLUETOOTH_IO_CAPABILITY =
    BLUETOOTH_IO_CAPABILITY(255i32);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const BLUETOOTH_MITM_ProtectionNotDefined: BLUETOOTH_AUTHENTICATION_REQUIREMENTS =
    BLUETOOTH_AUTHENTICATION_REQUIREMENTS(255i32);
pub const BLUETOOTH_MITM_ProtectionNotRequired: BLUETOOTH_AUTHENTICATION_REQUIREMENTS =
    BLUETOOTH_AUTHENTICATION_REQUIREMENTS(0i32);
pub const BLUETOOTH_MITM_ProtectionNotRequiredBonding: BLUETOOTH_AUTHENTICATION_REQUIREMENTS =
    BLUETOOTH_AUTHENTICATION_REQUIREMENTS(2i32);
pub const BLUETOOTH_MITM_ProtectionNotRequiredGeneralBonding:
    BLUETOOTH_AUTHENTICATION_REQUIREMENTS = BLUETOOTH_AUTHENTICATION_REQUIREMENTS(4i32);
pub const BLUETOOTH_MITM_ProtectionRequired: BLUETOOTH_AUTHENTICATION_REQUIREMENTS =
    BLUETOOTH_AUTHENTICATION_REQUIREMENTS(1i32);
pub const BLUETOOTH_MITM_ProtectionRequiredBonding: BLUETOOTH_AUTHENTICATION_REQUIREMENTS =
    BLUETOOTH_AUTHENTICATION_REQUIREMENTS(3i32);
pub const BLUETOOTH_MITM_ProtectionRequiredGeneralBonding: BLUETOOTH_AUTHENTICATION_REQUIREMENTS =
    BLUETOOTH_AUTHENTICATION_REQUIREMENTS(5i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const BTH_LE_ATT_BLUETOOTH_BASE_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x00000000_0000_1000_8000_00805f9b34fb);
...
pub const BTH_LE_GAP_APPEARANCE_OUTDOOR_SPORTS_ACTIVITY_SUBCATEGORY_LOCATION_DISPLAY_DEVICE: u32 =
    1u32;
pub const BTH_LE_GAP_APPEARANCE_OUTDOOR_SPORTS_ACTIVITY_SUBCATEGORY_LOCATION_NAVIGATION_DISPLAY_DEVICE: u32 = 2u32;
pub const BTH_LE_GAP_APPEARANCE_OUTDOOR_SPORTS_ACTIVITY_SUBCATEGORY_LOCATION_NAVIGATION_POD: u32 =
    4u32;
...
pub const Bluetooth_Base_UUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x00000000_0000_1000_8000_00805f9b34fb);
...
pub const CharacteristicAggregateFormat: BTH_LE_GATT_DESCRIPTOR_TYPE =
    BTH_LE_GATT_DESCRIPTOR_TYPE(5i32);
pub const CharacteristicExtendedProperties: BTH_LE_GATT_DESCRIPTOR_TYPE =
    BTH_LE_GATT_DESCRIPTOR_TYPE(0i32);
pub const CharacteristicFormat: BTH_LE_GATT_DESCRIPTOR_TYPE = BTH_LE_GATT_DESCRIPTOR_TYPE(4i32);
pub const CharacteristicUserDescription: BTH_LE_GATT_DESCRIPTOR_TYPE =
    BTH_LE_GATT_DESCRIPTOR_TYPE(1i32);
pub const CharacteristicValueChangedEvent: BTH_LE_GATT_EVENT_TYPE = BTH_LE_GATT_EVENT_TYPE(0i32);
pub const ClientCharacteristicConfiguration: BTH_LE_GATT_DESCRIPTOR_TYPE =
    BTH_LE_GATT_DESCRIPTOR_TYPE(2i32);
...
pub const GUID_BLUETOOTHLE_DEVICE_INTERFACE: windows_core::GUID =
    windows_core::GUID::from_u128(0x781aee18_7733_4ce4_add0_91f41c67b592);
pub const GUID_BLUETOOTH_AUTHENTICATION_REQUEST: windows_core::GUID =
    windows_core::GUID::from_u128(0x5dc9136d_996c_46db_84f5_32c0a3f47352);
pub const GUID_BLUETOOTH_GATT_SERVICE_DEVICE_INTERFACE: windows_core::GUID =
    windows_core::GUID::from_u128(0x6e3bb679_4372_40c8_9eaa_4509df260cd8);
pub const GUID_BLUETOOTH_HCI_EVENT: windows_core::GUID =
    windows_core::GUID::from_u128(0xfc240062_1541_49be_b463_84c4dcd7bf7f);
pub const GUID_BLUETOOTH_HCI_VENDOR_EVENT: windows_core::GUID =
    windows_core::GUID::from_u128(0x547247e6_45bb_4c33_af8c_c00efe15a71d);
pub const GUID_BLUETOOTH_KEYPRESS_EVENT: windows_core::GUID =
    windows_core::GUID::from_u128(0xd668dfcd_0f4e_4efc_bfe0_392eeec5109c);
pub const GUID_BLUETOOTH_L2CAP_EVENT: windows_core::GUID =
    windows_core::GUID::from_u128(0x7eae4030_b709_4aa8_ac55_e953829c9daa);
pub const GUID_BLUETOOTH_RADIO_IN_RANGE: windows_core::GUID =
    windows_core::GUID::from_u128(0xea3b5b82_26ee_450e_b0d8_d26fe30a3869);
pub const GUID_BLUETOOTH_RADIO_OUT_OF_RANGE: windows_core::GUID =
    windows_core::GUID::from_u128(0xe28867c9_c2aa_4ced_b969_4570866037c4);
pub const GUID_BTHPORT_DEVICE_INTERFACE: windows_core::GUID =
    windows_core::GUID::from_u128(0x0850302a_b344_4fda_9be9_90576b8d46f0);
pub const GUID_BTH_RFCOMM_SERVICE_DEVICE_INTERFACE: windows_core::GUID =
    windows_core::GUID::from_u128(0xb142fc3e_fa4e_460b_8abc_072b628b3c70);
...
pub const MITMProtectionNotDefined: AUTHENTICATION_REQUIREMENTS =
    AUTHENTICATION_REQUIREMENTS(255i32);
pub const MITMProtectionNotRequired: AUTHENTICATION_REQUIREMENTS =
    AUTHENTICATION_REQUIREMENTS(0i32);
pub const MITMProtectionNotRequiredBonding: AUTHENTICATION_REQUIREMENTS =
    AUTHENTICATION_REQUIREMENTS(2i32);
pub const MITMProtectionNotRequiredGeneralBonding: AUTHENTICATION_REQUIREMENTS =
    AUTHENTICATION_REQUIREMENTS(4i32);
pub const MITMProtectionRequired: AUTHENTICATION_REQUIREMENTS = AUTHENTICATION_REQUIREMENTS(1i32);
pub const MITMProtectionRequiredBonding: AUTHENTICATION_REQUIREMENTS =
    AUTHENTICATION_REQUIREMENTS(3i32);
pub const MITMProtectionRequiredGeneralBonding: AUTHENTICATION_REQUIREMENTS =
    AUTHENTICATION_REQUIREMENTS(5i32);
...
pub type PFNBLUETOOTH_GATT_EVENT_CALLBACK = Option<
    unsafe extern "system" fn(
        eventtype: BTH_LE_GATT_EVENT_TYPE,
        eventoutparameter: *const core::ffi::c_void,
        context: *const core::ffi::c_void,
    ),
>;
pub type PFN_AUTHENTICATION_CALLBACK = Option<
    unsafe extern "system" fn(
        pvparam: *mut core::ffi::c_void,
        pdevice: *mut BLUETOOTH_DEVICE_INFO,
    ) -> windows_core::BOOL,
>;
pub type PFN_AUTHENTICATION_CALLBACK_EX = Option<
    unsafe extern "system" fn(
        pvparam: *const core::ffi::c_void,
        pauthcallbackparams: *const BLUETOOTH_AUTHENTICATION_CALLBACK_PARAMS,
    ) -> windows_core::BOOL,
>;
pub type PFN_BLUETOOTH_ENUM_ATTRIBUTES_CALLBACK = Option<
    unsafe extern "system" fn(
        uattribid: u32,
        pvaluestream: *const u8,
        cbstreamsize: u32,
        pvparam: *const core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
pub type PFN_DEVICE_CALLBACK = Option<
    unsafe extern "system" fn(
        pvparam: *mut core::ffi::c_void,
...
pub const STR_USBHCI_CLASS_HARDWAREID: windows_core::PCWSTR =
    windows_core::w!("USB\\Class_E0&SubClass_01&Prot_01");
pub const STR_USBHCI_CLASS_HARDWAREIDA: windows_core::PCSTR =
    windows_core::s!("USB\\Class_E0&SubClass_01&Prot_01");
pub const STR_USBHCI_CLASS_HARDWAREIDW: windows_core::PCWSTR =
    windows_core::w!("USB\\Class_E0&SubClass_01&Prot_01");
pub const SVCID_BTH_PROVIDER: windows_core::GUID =
    windows_core::GUID::from_u128(0x06aa63e0_7d60_41ff_afb2_3ee6d2d9392d);
...
pub const ServerCharacteristicConfiguration: BTH_LE_GATT_DESCRIPTOR_TYPE =
    BTH_LE_GATT_DESCRIPTOR_TYPE(3i32);

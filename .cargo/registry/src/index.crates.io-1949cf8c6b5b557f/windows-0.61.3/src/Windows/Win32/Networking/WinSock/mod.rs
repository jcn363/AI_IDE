...
pub unsafe fn AcceptEx(
    ...
    unsafe {
        AcceptEx(
            ...
            lpdwbytesreceived as _,
            lpoverlapped as _,
        )
    }
}
#[inline]
pub unsafe fn EnumProtocolsA(
    ...
    unsafe {
        EnumProtocolsA(
            lpiprotocols.unwrap_or(core::mem::zeroed()) as _,
            lpprotocolbuffer as _,
...
pub unsafe fn GetAcceptExSockaddrs(
    lpoutputbuffer: *const core::ffi::c_void,
    dwreceivedatalength: u32,
    dwlocaladdresslength: u32,
    dwremoteaddresslength: u32,
    ...
    unsafe {
        GetAcceptExSockaddrs(
            ...
            dwremoteaddresslength,
            localsockaddr as _,
            localsockaddrlength as _,
            remotesockaddr as _,
            remotesockaddrlength as _,
        )
    }
}
#[cfg(feature = "Win32_System_IO")]
...
pub unsafe fn GetAddrInfoExA<P0, P1>(
    ...
    pservicename: P1,
    dwnamespace: u32,
    lpnspid: Option<*const windows_core::GUID>,
    hints: Option<*const ADDRINFOEXA>,
    ppresult: *mut *mut ADDRINFOEXA,
    timeout: Option<*const TIMEVAL>,
    lpoverlapped: Option<*const super::super::System::IO::OVERLAPPED>,
    lpcompletionroutine: LPLOOKUPSERVICE_COMPLETION_ROUTINE,
    lpnamehandle: Option<*mut super::super::Foundation::HANDLE>,
) -> i32
where
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        GetAddrInfoExA(
            pname.param().abi(),
            pservicename.param().abi(),
            dwnamespace,
            lpnspid.unwrap_or(core::mem::zeroed()) as _,
            hints.unwrap_or(core::mem::zeroed()) as _,
            ppresult as _,
            timeout.unwrap_or(core::mem::zeroed()) as _,
            lpoverlapped.unwrap_or(core::mem::zeroed()) as _,
            lpcompletionroutine,
            lpnamehandle.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn GetAddrInfoExW<P0, P1>(
    pname: P0,
    pservicename: P1,
    dwnamespace: u32,
    lpnspid: Option<*const windows_core::GUID>,
    hints: Option<*const ADDRINFOEXW>,
    ppresult: *mut *mut ADDRINFOEXW,
    timeout: Option<*const TIMEVAL>,
    lpoverlapped: Option<*const super::super::System::IO::OVERLAPPED>,
    lpcompletionroutine: LPLOOKUPSERVICE_COMPLETION_ROUTINE,
    lphandle: Option<*mut super::super::Foundation::HANDLE>,
) -> i32
where
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        GetAddrInfoExW(
            ...
            lpoverlapped.unwrap_or(core::mem::zeroed()) as _,
            lpcompletionroutine,
            lphandle.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        GetAddrInfoW(
            pnodename.param().abi(),
            pservicename.param().abi(),
            phints.unwrap_or(core::mem::zeroed()) as _,
            ppresult as _,
        )
    }
}
#[inline]
pub unsafe fn GetAddressByNameA<P2>(
    dwnamespace: u32,
    lpservicetype: *const windows_core::GUID,
    lpservicename: P2,
    lpiprotocols: Option<*const i32>,
    dwresolution: u32,
    lpserviceasyncinfo: Option<*const SERVICE_ASYNC_INFO>,
    lpcsaddrbuffer: *mut core::ffi::c_void,
    lpdwbufferlength: *mut u32,
    lpaliasbuffer: Option<windows_core::PSTR>,
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        GetAddressByNameA(
            dwnamespace,
            lpservicetype,
            lpservicename.param().abi(),
            lpiprotocols.unwrap_or(core::mem::zeroed()) as _,
            dwresolution,
            lpserviceasyncinfo.unwrap_or(core::mem::zeroed()) as _,
            lpcsaddrbuffer as _,
            lpdwbufferlength as _,
            lpaliasbuffer.unwrap_or(core::mem::zeroed()) as _,
            lpdwaliasbufferlength as _,
        )
    }
}
#[inline]
pub unsafe fn GetAddressByNameW<P2>(
    dwnamespace: u32,
    lpservicetype: *const windows_core::GUID,
    lpservicename: P2,
    lpiprotocols: Option<*const i32>,
    ...
    lpcsaddrbuffer: *mut core::ffi::c_void,
    lpdwbufferlength: *mut u32,
    lpaliasbuffer: Option<windows_core::PWSTR>,
    lpdwaliasbufferlength: *mut u32,
) -> i32
where
...
#[inline]
pub unsafe fn GetNameByTypeA(
    lpservicetype: *const windows_core::GUID,
    lpservicename: &mut [u8],
) -> i32 {
    ...
    unsafe {
        GetNameByTypeA(
            lpservicetype,
            core::mem::transmute(lpservicename.as_ptr()),
            lpservicename.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn GetNameByTypeW(
    lpservicetype: *const windows_core::GUID,
    lpservicename: windows_core::PWSTR,
    dwnamelength: u32,
) -> i32 {
    ...
    unsafe {
        GetNameByTypeW(
            lpservicetype,
            core::mem::transmute(lpservicename),
            dwnamelength,
        )
    }
}
...
pub unsafe fn GetNameInfoW(
    ...
    pnodebuffer: Option<&mut [u16]>,
    pservicebuffer: Option<&mut [u16]>,
    flags: i32,
) -> i32 {
...
#[inline]
pub unsafe fn GetServiceA<P2>(
    dwnamespace: u32,
    lpguid: *const windows_core::GUID,
    lpservicename: P2,
    dwproperties: u32,
...
#[inline]
pub unsafe fn InetNtopW(
    family: i32,
    paddr: *const core::ffi::c_void,
    pstringbuf: &mut [u16],
) -> windows_core::PCWSTR {
    ...
    unsafe {
        InetNtopW(
            family,
            paddr,
            core::mem::transmute(pstringbuf.as_ptr()),
            pstringbuf.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
pub unsafe fn ProcessSocketNotifications(
    ...
    timeoutms: u32,
    completionportentries: Option<&mut [super::super::System::IO::OVERLAPPED_ENTRY]>,
...
pub unsafe fn RtlEthernetStringToAddressA<P0>(
    s: P0,
    terminator: *mut windows_core::PCSTR,
    addr: *mut DL_EUI48,
) -> i32
where
    P0: windows_core::Param<windows_core::PCSTR>,
...
pub unsafe fn RtlEthernetStringToAddressW<P0>(
    s: P0,
    terminator: *mut windows_core::PCWSTR,
    addr: *mut DL_EUI48,
) -> i32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn RtlIpv4AddressToStringExA(
    ...
    port: u16,
    addressstring: windows_core::PSTR,
    ...
    unsafe {
        RtlIpv4AddressToStringExA(
            address,
            port,
            core::mem::transmute(addressstring),
            addressstringlength as _,
        )
    }
}
#[inline]
pub unsafe fn RtlIpv4AddressToStringExW(
    address: *const IN_ADDR,
    port: u16,
    addressstring: windows_core::PWSTR,
    addressstringlength: *mut u32,
) -> i32 {
...
#[inline]
pub unsafe fn RtlIpv4StringToAddressExA<P0>(
    addressstring: P0,
    strict: bool,
    address: *mut IN_ADDR,
    port: *mut u16,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        RtlIpv4StringToAddressExA(addressstring.param().abi(), strict, address as _, port as _)
    }
}
#[inline]
pub unsafe fn RtlIpv4StringToAddressExW<P0>(
    addressstring: P0,
    strict: bool,
    address: *mut IN_ADDR,
    port: *mut u16,
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        RtlIpv4StringToAddressExW(addressstring.param().abi(), strict, address as _, port as _)
    }
}
#[inline]
pub unsafe fn RtlIpv4StringToAddressW<P0>(
    s: P0,
    strict: bool,
    terminator: *mut windows_core::PCWSTR,
    addr: *mut IN_ADDR,
...
#[inline]
pub unsafe fn RtlIpv6AddressToStringA(
    addr: *const IN6_ADDR,
    s: &mut [u8; 46],
) -> windows_core::PSTR {
...
#[inline]
pub unsafe fn RtlIpv6AddressToStringExW(
    address: *const IN6_ADDR,
    scopeid: u32,
    port: u16,
    addressstring: windows_core::PWSTR,
...
#[inline]
pub unsafe fn RtlIpv6StringToAddressExA<P0>(
    addressstring: P0,
...
#[inline]
pub unsafe fn RtlIpv6StringToAddressExW<P0>(
    addressstring: P0,
    address: *mut IN6_ADDR,
    scopeid: *mut u32,
    port: *mut u16,
...
#[inline]
pub unsafe fn RtlIpv6StringToAddressW<P0>(
    s: P0,
    terminator: *mut windows_core::PCWSTR,
    addr: *mut IN6_ADDR,
) -> i32
...
#[inline]
pub unsafe fn SetAddrInfoExA<P0, P1>(
    pname: P0,
    pservicename: P1,
    paddresses: Option<*const SOCKET_ADDRESS>,
    dwaddresscount: u32,
    lpblob: Option<*const super::super::System::Com::BLOB>,
    dwflags: u32,
    dwnamespace: u32,
    lpnspid: Option<*const windows_core::GUID>,
    timeout: Option<*const TIMEVAL>,
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SetAddrInfoExA(
            pname.param().abi(),
            pservicename.param().abi(),
            paddresses.unwrap_or(core::mem::zeroed()) as _,
            dwaddresscount,
            lpblob.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
            dwnamespace,
            lpnspid.unwrap_or(core::mem::zeroed()) as _,
            timeout.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn SetServiceA(
    dwnamespace: u32,
    dwoperation: SET_SERVICE_OPERATION,
    dwflags: u32,
    lpserviceinfo: *const SERVICE_INFOA,
    lpserviceasyncinfo: Option<*const SERVICE_ASYNC_INFO>,
    lpdwstatusflags: *mut u32,
) -> i32 {
    ...
    unsafe {
        SetServiceA(
            ...
            lpserviceinfo,
            lpserviceasyncinfo.unwrap_or(core::mem::zeroed()) as _,
            lpdwstatusflags as _,
        )
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn SetServiceW(
    dwnamespace: u32,
    dwoperation: SET_SERVICE_OPERATION,
    dwflags: u32,
    lpserviceinfo: *const SERVICE_INFOW,
    lpserviceasyncinfo: Option<*const SERVICE_ASYNC_INFO>,
    lpdwstatusflags: *mut u32,
) -> i32 {
...
pub unsafe fn TransmitFile(
    ...
    unsafe {
        TransmitFile(
            ...
            lpoverlapped.unwrap_or(core::mem::zeroed()) as _,
            lptransmitbuffers.unwrap_or(core::mem::zeroed()) as _,
            dwreserved,
        )
    }
}
...
pub unsafe fn WPUCompleteOverlappedRequest(
    ...
    unsafe {
        WPUCompleteOverlappedRequest(s, lpoverlapped as _, dwerror, cbtransferred, lperrno as _)
    }
}
#[inline]
pub unsafe fn WSAAccept(
    ...
    dwcallbackdata: Option<usize>,
) -> windows_core::Result<SOCKET> {
    ...
    let result__ = unsafe {
        WSAAccept(
            s,
            addr.unwrap_or(core::mem::zeroed()) as _,
            addrlen.unwrap_or(core::mem::zeroed()) as _,
            lpfncondition,
            dwcallbackdata.unwrap_or(core::mem::zeroed()) as _,
        )
    };
    (!result__.is_invalid())
        .then_some(result__)
...
pub unsafe fn WSAAddressToStringA(
    ...
    dwaddresslength: u32,
    lpprotocolinfo: Option<*const WSAPROTOCOL_INFOA>,
    lpszaddressstring: windows_core::PSTR,
    ...
    unsafe {
        WSAAddressToStringA(
            lpsaaddress,
            dwaddresslength,
            lpprotocolinfo.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(lpszaddressstring),
            lpdwaddressstringlength as _,
        )
    }
}
#[inline]
pub unsafe fn WSAAddressToStringW(
    lpsaaddress: *const SOCKADDR,
    dwaddresslength: u32,
    lpprotocolinfo: Option<*const WSAPROTOCOL_INFOW>,
    lpszaddressstring: windows_core::PWSTR,
    lpdwaddressstringlength: *mut u32,
) -> i32 {
...
pub unsafe fn WSAAdvertiseProvider(
    puuidproviderid: *const windows_core::GUID,
...
#[inline]
pub unsafe fn WSAAsyncGetHostByAddr(
    ...
    let result__ = unsafe {
        WSAAsyncGetHostByAddr(
            hwnd,
            wmsg,
            core::mem::transmute(addr.as_ptr()),
            addr.len().try_into().unwrap(),
            r#type,
...
#[inline]
pub unsafe fn WSAAsyncGetHostByName<P2>(
    hwnd: super::super::Foundation::HWND,
    wmsg: u32,
    name: P2,
    buf: &mut [u8],
...
#[inline]
pub unsafe fn WSAAsyncGetProtoByName<P2>(
    hwnd: super::super::Foundation::HWND,
    wmsg: u32,
    name: P2,
    buf: &mut [u8],
...
#[inline]
pub unsafe fn WSAAsyncGetProtoByNumber(
    hwnd: super::super::Foundation::HWND,
    wmsg: u32,
    number: i32,
    buf: &mut [u8],
...
#[inline]
pub unsafe fn WSAAsyncGetServByName<P2, P3>(
    hwnd: super::super::Foundation::HWND,
    wmsg: u32,
    name: P2,
    proto: P3,
...
#[inline]
pub unsafe fn WSAAsyncGetServByPort<P3>(
    hwnd: super::super::Foundation::HWND,
    wmsg: u32,
    port: i32,
    proto: P3,
...
pub unsafe fn WSAConnect(
    ...
    name: *const SOCKADDR,
    namelen: i32,
    lpcallerdata: Option<*const WSABUF>,
    lpcalleedata: Option<*mut WSABUF>,
    lpsqos: Option<*const QOS>,
    lpgqos: Option<*const QOS>,
) -> i32 {
    ...
    unsafe {
        WSAConnect(
            ...
            name,
            namelen,
            lpcallerdata.unwrap_or(core::mem::zeroed()) as _,
            lpcalleedata.unwrap_or(core::mem::zeroed()) as _,
            lpsqos.unwrap_or(core::mem::zeroed()) as _,
            lpgqos.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn WSAConnectByList(
    s: SOCKET,
    ...
    timeout: Option<*const TIMEVAL>,
    reserved: Option<*const super::super::System::IO::OVERLAPPED>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WSAConnectByList(
            s,
            socketaddress,
            localaddresslength.unwrap_or(core::mem::zeroed()) as _,
            localaddress.unwrap_or(core::mem::zeroed()) as _,
            remoteaddresslength.unwrap_or(core::mem::zeroed()) as _,
            remoteaddress.unwrap_or(core::mem::zeroed()) as _,
            timeout.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn WSADeleteSocketPeerTargetName(
    ...
    peeraddrlen: u32,
    overlapped: Option<*const super::super::System::IO::OVERLAPPED>,
    ...
    unsafe {
        WSADeleteSocketPeerTargetName(
            ...
            peeraddr,
            peeraddrlen,
            overlapped.unwrap_or(core::mem::zeroed()) as _,
            completionroutine,
        )
    }
}
#[inline]
pub unsafe fn WSADuplicateSocketA(
    s: SOCKET,
    dwprocessid: u32,
...
#[inline]
pub unsafe fn WSADuplicateSocketW(
    s: SOCKET,
    dwprocessid: u32,
...
#[inline]
pub unsafe fn WSAEnumNameSpaceProvidersA(
    lpdwbufferlength: *mut u32,
    lpnspbuffer: *mut WSANAMESPACE_INFOA,
) -> i32 {
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn WSAEnumNameSpaceProvidersExA(
    lpdwbufferlength: *mut u32,
    lpnspbuffer: *mut WSANAMESPACE_INFOEXA,
) -> i32 {
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn WSAEnumNameSpaceProvidersExW(
    lpdwbufferlength: *mut u32,
    lpnspbuffer: *mut WSANAMESPACE_INFOEXW,
) -> i32 {
...
#[inline]
pub unsafe fn WSAEnumNameSpaceProvidersW(
    lpdwbufferlength: *mut u32,
    lpnspbuffer: *mut WSANAMESPACE_INFOW,
) -> i32 {
...
pub unsafe fn WSAEnumProtocolsA(
    lpiprotocols: Option<*const i32>,
    lpprotocolbuffer: Option<*mut WSAPROTOCOL_INFOA>,
    lpdwbufferlength: *mut u32,
) -> i32 {
    ...
    unsafe {
        WSAEnumProtocolsA(
            lpiprotocols.unwrap_or(core::mem::zeroed()) as _,
            lpprotocolbuffer.unwrap_or(core::mem::zeroed()) as _,
            lpdwbufferlength as _,
        )
    }
}
#[inline]
pub unsafe fn WSAEnumProtocolsW(
    lpiprotocols: Option<*const i32>,
    lpprotocolbuffer: Option<*mut WSAPROTOCOL_INFOW>,
    lpdwbufferlength: *mut u32,
) -> i32 {
...
#[inline]
pub unsafe fn WSAEventSelect(
    s: SOCKET,
    heventobject: Option<WSAEVENT>,
    lnetworkevents: i32,
) -> i32 {
    ...
    unsafe {
        WSAEventSelect(
            s,
            heventobject.unwrap_or(core::mem::zeroed()) as _,
            lnetworkevents,
        )
    }
}
...
#[inline]
pub unsafe fn WSAGetServiceClassInfoA(
    lpproviderid: *const windows_core::GUID,
    lpserviceclassid: *const windows_core::GUID,
    lpdwbufsize: *mut u32,
    lpserviceclassinfo: *mut WSASERVICECLASSINFOA,
) -> i32 {
    ...
    unsafe {
        WSAGetServiceClassInfoA(
            ...
            lpserviceclassid,
            lpdwbufsize as _,
            lpserviceclassinfo as _,
        )
    }
}
#[inline]
pub unsafe fn WSAGetServiceClassInfoW(
    lpproviderid: *const windows_core::GUID,
    lpserviceclassid: *const windows_core::GUID,
    lpdwbufsize: *mut u32,
    lpserviceclassinfo: *mut WSASERVICECLASSINFOW,
) -> i32 {
...
#[inline]
pub unsafe fn WSAGetServiceClassNameByClassIdA(
    lpserviceclassid: *const windows_core::GUID,
    lpszserviceclassname: windows_core::PSTR,
    lpdwbufferlength: *mut u32,
) -> i32 {
    ...
    unsafe {
        WSAGetServiceClassNameByClassIdA(
            lpserviceclassid,
            core::mem::transmute(lpszserviceclassname),
            lpdwbufferlength as _,
        )
    }
}
#[inline]
pub unsafe fn WSAGetServiceClassNameByClassIdW(
    lpserviceclassid: *const windows_core::GUID,
    lpszserviceclassname: windows_core::PWSTR,
    lpdwbufferlength: *mut u32,
) -> i32 {
...
#[inline]
pub unsafe fn WSAImpersonateSocketPeer(
    socket: SOCKET,
    peeraddr: Option<*const SOCKADDR>,
    peeraddrlen: u32,
) -> i32 {
    ...
    unsafe {
        WSAImpersonateSocketPeer(
            socket,
            peeraddr.unwrap_or(core::mem::zeroed()) as _,
            peeraddrlen,
        )
    }
}
...
pub unsafe fn WSAIoctl(
    s: SOCKET,
    dwiocontrolcode: u32,
    lpvinbuffer: Option<*const core::ffi::c_void>,
    cbinbuffer: u32,
    lpvoutbuffer: Option<*mut core::ffi::c_void>,
    cboutbuffer: u32,
    ...
    unsafe {
        WSAIoctl(
            s,
            dwiocontrolcode,
            lpvinbuffer.unwrap_or(core::mem::zeroed()) as _,
            cbinbuffer,
            lpvoutbuffer.unwrap_or(core::mem::zeroed()) as _,
            cboutbuffer,
            lpcbbytesreturned as _,
            lpoverlapped.unwrap_or(core::mem::zeroed()) as _,
            lpcompletionroutine,
        )
    }
...
pub unsafe fn WSALookupServiceBeginA(
    ...
    dwcontrolflags: u32,
    lphlookup: *mut super::super::Foundation::HANDLE,
) -> i32 {
...
pub unsafe fn WSALookupServiceNextW(
    ...
    dwcontrolflags: u32,
    lpdwbufferlength: *mut u32,
    lpqsresults: Option<*mut WSAQUERYSETW>,
) -> i32 {
    ...
    unsafe {
        WSALookupServiceNextW(
            ...
            dwcontrolflags,
            lpdwbufferlength as _,
            lpqsresults.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_System_IO")]
...
pub unsafe fn WSANSPIoctl(
    ...
    unsafe {
        WSANSPIoctl(
            ...
            cboutbuffer,
            lpcbbytesreturned as _,
            lpcompletion.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn WSAProviderCompleteAsyncCall(
...
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn WSAQuerySocketSecurity(
    socket: SOCKET,
    ...
    unsafe {
        WSAQuerySocketSecurity(
            socket,
            securityquerytemplate.unwrap_or(core::mem::zeroed()) as _,
            securityquerytemplatelen,
            securityqueryinfo.unwrap_or(core::mem::zeroed()) as _,
            securityqueryinfolen as _,
            overlapped.unwrap_or(core::mem::zeroed()) as _,
            completionroutine,
        )
    }
...
pub unsafe fn WSARecv(
    ...
    unsafe {
        WSARecv(
            s,
            core::mem::transmute(lpbuffers.as_ptr()),
            lpbuffers.len().try_into().unwrap(),
            lpnumberofbytesrecvd.unwrap_or(core::mem::zeroed()) as _,
            lpflags as _,
            lpoverlapped.unwrap_or(core::mem::zeroed()) as _,
            lpcompletionroutine,
        )
...
pub unsafe fn WSARecvDisconnect(s: SOCKET, lpinbounddisconnectdata: Option<*const WSABUF>) -> i32 {
    ...
    unsafe {
        WSARecvDisconnect(
            s,
            lpinbounddisconnectdata.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn WSARecvFrom(
    s: SOCKET,
    lpbuffers: &[WSABUF],
    lpnumberofbytesrecvd: Option<*mut u32>,
    lpflags: *mut u32,
    lpfrom: Option<*mut SOCKADDR>,
    lpfromlen: Option<*mut i32>,
    lpoverlapped: Option<*mut super::super::System::IO::OVERLAPPED>,
    lpcompletionroutine: LPWSAOVERLAPPED_COMPLETION_ROUTINE,
) -> i32 {
    ...
    unsafe {
        WSARecvFrom(
            ...
            lpnumberofbytesrecvd.unwrap_or(core::mem::zeroed()) as _,
            lpflags as _,
            lpfrom.unwrap_or(core::mem::zeroed()) as _,
            lpfromlen.unwrap_or(core::mem::zeroed()) as _,
            lpoverlapped.unwrap_or(core::mem::zeroed()) as _,
            lpcompletionroutine,
        )
    }
...
pub unsafe fn WSASend(
    ...
    unsafe {
        WSASend(
            ...
            core::mem::transmute(lpbuffers.as_ptr()),
            lpbuffers.len().try_into().unwrap(),
            lpnumberofbytessent.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
            lpoverlapped.unwrap_or(core::mem::zeroed()) as _,
            lpcompletionroutine,
        )
...
pub unsafe fn WSASendDisconnect(s: SOCKET, lpoutbounddisconnectdata: Option<*const WSABUF>) -> i32 {
    ...
    unsafe {
        WSASendDisconnect(
            s,
            lpoutbounddisconnectdata.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn WSASendMsg(
    handle: SOCKET,
    lpmsg: *const WSAMSG,
    dwflags: u32,
    lpnumberofbytessent: Option<*mut u32>,
...
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn WSASendTo(
    s: SOCKET,
    lpbuffers: &[WSABUF],
    lpnumberofbytessent: Option<*mut u32>,
    dwflags: u32,
    lpto: Option<*const SOCKADDR>,
    itolen: i32,
    lpoverlapped: Option<*mut super::super::System::IO::OVERLAPPED>,
    lpcompletionroutine: LPWSAOVERLAPPED_COMPLETION_ROUTINE,
) -> i32 {
    ...
    unsafe {
        WSASendTo(
            ...
            lpnumberofbytessent.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
            lpto.unwrap_or(core::mem::zeroed()) as _,
            itolen,
            lpoverlapped.unwrap_or(core::mem::zeroed()) as _,
            lpcompletionroutine,
        )
...
#[inline]
pub unsafe fn WSASetBlockingHook(
    lpblockfunc: super::super::Foundation::FARPROC,
...
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn WSASetSocketPeerTargetName(
    socket: SOCKET,
...
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn WSASetSocketSecurity(
    socket: SOCKET,
    securitysettings: Option<*const SOCKET_SECURITY_SETTINGS>,
    ...
    unsafe {
        WSASetSocketSecurity(
            socket,
            securitysettings.unwrap_or(core::mem::zeroed()) as _,
            securitysettingslen,
            overlapped.unwrap_or(core::mem::zeroed()) as _,
            completionroutine,
        )
...
#[inline]
pub unsafe fn WSAStringToAddressA<P0>(
    addressstring: P0,
    addressfamily: i32,
    lpprotocolinfo: Option<*const WSAPROTOCOL_INFOA>,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        WSAStringToAddressA(
            ...
            lpprotocolinfo.unwrap_or(core::mem::zeroed()) as _,
            lpaddress as _,
            lpaddresslength as _,
        )
    }
}
#[inline]
pub unsafe fn WSAStringToAddressW<P0>(
    addressstring: P0,
    addressfamily: i32,
    lpprotocolinfo: Option<*const WSAPROTOCOL_INFOW>,
    lpaddress: *mut SOCKADDR,
...
#[inline]
pub unsafe fn WSAWaitForMultipleEvents(
    lphevents: &[super::super::Foundation::HANDLE],
    fwaitall: bool,
    dwtimeout: u32,
    falertable: bool,
) -> super::super::Foundation::WAIT_EVENT {
    ...
    unsafe {
        WSAWaitForMultipleEvents(
            lphevents.len().try_into().unwrap(),
            core::mem::transmute(lphevents.as_ptr()),
            fwaitall.into(),
            dwtimeout,
            falertable.into(),
        )
...
#[inline]
pub unsafe fn WSCDeinstallProvider(
    lpproviderid: *const windows_core::GUID,
    lperrno: *mut i32,
) -> i32 {
...
#[inline]
pub unsafe fn WSCDeinstallProvider32(
    lpproviderid: *const windows_core::GUID,
    lperrno: *mut i32,
) -> i32 {
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn WSCEnumNameSpaceProvidersEx32(
    lpdwbufferlength: *mut u32,
    lpnspbuffer: *mut WSANAMESPACE_INFOEXW,
) -> i32 {
...
#[inline]
pub unsafe fn WSCEnumProtocols(
    lpiprotocols: Option<*const i32>,
    lpprotocolbuffer: Option<*mut WSAPROTOCOL_INFOW>,
    lpdwbufferlength: *mut u32,
    lperrno: *mut i32,
...
#[inline]
pub unsafe fn WSCEnumProtocols32(
    lpiprotocols: Option<*const i32>,
...
#[inline]
pub unsafe fn WSCGetApplicationCategory(
    path: &[u16],
    extra: Option<&[u16]>,
    ppermittedlspcategories: *mut u32,
    lperrno: *mut i32,
) -> i32 {
    ...
    unsafe {
        WSCGetApplicationCategory(
            core::mem::transmute(path.as_ptr()),
            ...
            extra
                .as_deref()
                .map_or(0, |slice| slice.len().try_into().unwrap()),
            ppermittedlspcategories as _,
            lperrno as _,
        )
    }
}
#[inline]
pub unsafe fn WSCGetProviderInfo(
    lpproviderid: *const windows_core::GUID,
...
#[inline]
pub unsafe fn WSCGetProviderInfo32(
    lpproviderid: *const windows_core::GUID,
    infotype: WSC_PROVIDER_INFO_TYPE,
    info: *mut u8,
    infosize: *mut usize,
...
#[inline]
pub unsafe fn WSCGetProviderPath(
    lpproviderid: *const windows_core::GUID,
    lpszproviderdllpath: windows_core::PWSTR,
    lpproviderdllpathlen: *mut i32,
    lperrno: *mut i32,
) -> i32 {
    ...
    unsafe {
        WSCGetProviderPath(
            lpproviderid,
            core::mem::transmute(lpszproviderdllpath),
            lpproviderdllpathlen as _,
            lperrno as _,
        )
    }
}
...
#[inline]
pub unsafe fn WSCGetProviderPath32(
    lpproviderid: *const windows_core::GUID,
    lpszproviderdllpath: windows_core::PWSTR,
    lpproviderdllpathlen: *mut i32,
    lperrno: *mut i32,
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WSCInstallNameSpace(
            lpszidentifier.param().abi(),
            lpszpathname.param().abi(),
            dwnamespace,
            dwversion,
            lpproviderid,
        )
...
#[inline]
pub unsafe fn WSCInstallNameSpace32<P0, P1>(
    lpszidentifier: P0,
    lpszpathname: P1,
    dwnamespace: u32,
    dwversion: u32,
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn WSCInstallNameSpaceEx<P0, P1>(
    lpszidentifier: P0,
    lpszpathname: P1,
    dwnamespace: u32,
    dwversion: u32,
    lpproviderid: *const windows_core::GUID,
    lpproviderspecific: *const super::super::System::Com::BLOB,
) -> i32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn WSCInstallProvider<P1>(
    lpproviderid: *const windows_core::GUID,
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WSCInstallProvider(
            lpproviderid,
            lpszproviderdllpath.param().abi(),
            core::mem::transmute(lpprotocolinfolist.as_ptr()),
            lpprotocolinfolist.len().try_into().unwrap(),
            lperrno as _,
        )
    }
}
...
#[inline]
pub unsafe fn WSCInstallProvider64_32<P1>(
    lpproviderid: *const windows_core::GUID,
    lpszproviderdllpath: P1,
    lpprotocolinfolist: &[WSAPROTOCOL_INFOW],
    lperrno: *mut i32,
...
#[inline]
pub unsafe fn WSCInstallProviderAndChains64_32<P1, P2, P3>(
    lpproviderid: *const windows_core::GUID,
    lpszproviderdllpath: P1,
    lpszproviderdllpath32: P2,
    lpszlspname: P3,
    dwserviceflags: u32,
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WSCInstallProviderAndChains64_32(
            lpproviderid,
            lpszproviderdllpath.param().abi(),
            lpszproviderdllpath32.param().abi(),
            lpszlspname.param().abi(),
            dwserviceflags,
            core::mem::transmute(lpprotocolinfolist.as_ptr()),
            lpprotocolinfolist.len().try_into().unwrap(),
            lpdwcatalogentryid.unwrap_or(core::mem::zeroed()) as _,
            lperrno as _,
        )
    }
}
#[inline]
pub unsafe fn WSCSetApplicationCategory(
    path: &[u16],
    extra: Option<&[u16]>,
    permittedlspcategories: u32,
    pprevpermlspcat: Option<*mut u32>,
    lperrno: *mut i32,
) -> i32 {
    ...
    unsafe {
        WSCSetApplicationCategory(
            ...
            pprevpermlspcat.unwrap_or(core::mem::zeroed()) as _,
            lperrno as _,
        )
    }
}
#[inline]
pub unsafe fn WSCSetProviderInfo(
    lpproviderid: *const windows_core::GUID,
    infotype: WSC_PROVIDER_INFO_TYPE,
    info: &[u8],
    flags: u32,
    ...
    unsafe {
        WSCSetProviderInfo(
            lpproviderid,
            infotype,
            core::mem::transmute(info.as_ptr()),
...
#[inline]
pub unsafe fn WSCSetProviderInfo32(
    lpproviderid: *const windows_core::GUID,
    infotype: WSC_PROVIDER_INFO_TYPE,
    info: &[u8],
    flags: u32,
...
#[inline]
pub unsafe fn WSCWriteNameSpaceOrder(
    lpproviderid: *mut windows_core::GUID,
    dwnumberofentries: u32,
) -> i32 {
...
#[inline]
pub unsafe fn WSCWriteNameSpaceOrder32(
    lpproviderid: *mut windows_core::GUID,
    dwnumberofentries: u32,
) -> i32 {
...
#[inline]
pub unsafe fn getaddrinfo<P0, P1>(
    pnodename: P0,
    pservicename: P1,
    phints: Option<*const ADDRINFOA>,
...
pub unsafe fn getnameinfo(
    psockaddr: *const SOCKADDR,
    sockaddrlength: socklen_t,
    pnodebuffer: Option<&mut [u8]>,
    pservicebuffer: Option<&mut [u8]>,
    flags: i32,
) -> i32 {
...
pub unsafe fn recvfrom(
    ...
    unsafe {
        recvfrom(
            ...
            buf.len().try_into().unwrap(),
            flags,
            from.unwrap_or(core::mem::zeroed()) as _,
            fromlen.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn select(
    ...
    unsafe {
        select(
            nfds,
            readfds.unwrap_or(core::mem::zeroed()) as _,
            writefds.unwrap_or(core::mem::zeroed()) as _,
            exceptfds.unwrap_or(core::mem::zeroed()) as _,
            timeout.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
pub const ASSOCIATE_NAMERES_CONTEXT: windows_core::GUID =
    windows_core::GUID::from_u128(0x59a38b67_d4fe_46e1_ba3c_87ea74ca3049);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub type LPBLOCKINGCALLBACK =
    Option<unsafe extern "system" fn(dwcontext: usize) -> windows_core::BOOL>;
pub type LPCONDITIONPROC = Option<
    unsafe extern "system" fn(
        lpcallerid: *mut WSABUF,
        lpcallerdata: *mut WSABUF,
        lpsqos: *mut QOS,
        lpgqos: *mut QOS,
        lpcalleeid: *mut WSABUF,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type LPFN_CONNECTEX = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        name: *const SOCKADDR,
        namelen: i32,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type LPFN_DISCONNECTEX = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        lpoverlapped: *mut super::super::System::IO::OVERLAPPED,
        dwflags: u32,
...
>;
pub type LPFN_GETACCEPTEXSOCKADDRS = Option<
    unsafe extern "system" fn(
        lpoutputbuffer: *const core::ffi::c_void,
        dwreceivedatalength: u32,
        dwlocaladdresslength: u32,
...
pub type LPFN_RIOCREATECOMPLETIONQUEUE = Option<
    unsafe extern "system" fn(
        queuesize: u32,
        notificationcompletion: *const RIO_NOTIFICATION_COMPLETION,
    ) -> RIO_CQ,
>;
pub type LPFN_RIOCREATEREQUESTQUEUE = Option<
    unsafe extern "system" fn(
        socket: SOCKET,
        ...
        receivecq: RIO_CQ,
        sendcq: RIO_CQ,
        socketcontext: *const core::ffi::c_void,
    ) -> RIO_RQ,
>;
pub type LPFN_RIODEQUEUECOMPLETION =
    Option<unsafe extern "system" fn(cq: RIO_CQ, array: *mut RIORESULT, arraysize: u32) -> u32>;
...
pub type LPFN_RIORECEIVE = Option<
    unsafe extern "system" fn(
        socketqueue: RIO_RQ,
        pdata: *const RIO_BUF,
        databuffercount: u32,
...
>;
pub type LPFN_RIORECEIVEEX = Option<
    unsafe extern "system" fn(
        socketqueue: RIO_RQ,
        pdata: *const RIO_BUF,
        databuffercount: u32,
        plocaladdress: *const RIO_BUF,
        premoteaddress: *const RIO_BUF,
        pcontrolcontext: *const RIO_BUF,
        pflags: *const RIO_BUF,
        flags: u32,
        requestcontext: *const core::ffi::c_void,
    ) -> i32,
>;
pub type LPFN_RIOREGISTERBUFFER = Option<
    unsafe extern "system" fn(databuffer: windows_core::PCSTR, datalength: u32) -> RIO_BUFFERID,
>;
pub type LPFN_RIORESIZECOMPLETIONQUEUE =
    Option<unsafe extern "system" fn(cq: RIO_CQ, queuesize: u32) -> windows_core::BOOL>;
pub type LPFN_RIORESIZEREQUESTQUEUE = Option<
    unsafe extern "system" fn(
        rq: RIO_RQ,
        maxoutstandingreceive: u32,
        maxoutstandingsend: u32,
...
>;
pub type LPFN_RIOSENDEX = Option<
    unsafe extern "system" fn(
        socketqueue: RIO_RQ,
        pdata: *const RIO_BUF,
        databuffercount: u32,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type LPFN_TRANSMITFILE = Option<
    unsafe extern "system" fn(
        hsocket: SOCKET,
        hfile: super::super::Foundation::HANDLE,
        nnumberofbytestowrite: u32,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type LPFN_TRANSMITPACKETS = Option<
    unsafe extern "system" fn(
        hsocket: SOCKET,
...
pub type LPFN_WSAPOLL =
    Option<unsafe extern "system" fn(fdarray: *mut WSAPOLLFD, nfds: u32, timeout: i32) -> i32>;
#[cfg(feature = "Win32_System_IO")]
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type LPFN_WSASENDMSG = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        lpmsg: *const WSAMSG,
        dwflags: u32,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type LPLOOKUPSERVICE_COMPLETION_ROUTINE = Option<
    unsafe extern "system" fn(
        dwerror: u32,
        dwbytes: u32,
        lpoverlapped: *const super::super::System::IO::OVERLAPPED,
...
pub type LPNSPCLEANUP =
    Option<unsafe extern "system" fn(lpproviderid: *const windows_core::GUID) -> i32>;
pub type LPNSPGETSERVICECLASSINFO = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        lpdwbufsize: *const u32,
        lpserviceclassinfo: *const WSASERVICECLASSINFOW,
    ) -> i32,
>;
pub type LPNSPINSTALLSERVICECLASS = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        lpserviceclassinfo: *const WSASERVICECLASSINFOW,
    ) -> i32,
...
pub type LPNSPIOCTL = Option<
    unsafe extern "system" fn(
        ...
        cboutbuffer: u32,
        lpcbbytesreturned: *mut u32,
        lpcompletion: *const WSACOMPLETION,
        lpthreadid: *const WSATHREADID,
    ) -> i32,
>;
#[cfg(feature = "Win32_System_Com")]
pub type LPNSPLOOKUPSERVICEBEGIN = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        lpqsrestrictions: *const WSAQUERYSETW,
        lpserviceclassinfo: *const WSASERVICECLASSINFOW,
...
pub type LPNSPLOOKUPSERVICEEND =
    Option<unsafe extern "system" fn(hlookup: super::super::Foundation::HANDLE) -> i32>;
#[cfg(feature = "Win32_System_Com")]
pub type LPNSPLOOKUPSERVICENEXT = Option<
    unsafe extern "system" fn(
        hlookup: super::super::Foundation::HANDLE,
        dwcontrolflags: u32,
        lpdwbufferlength: *mut u32,
...
>;
pub type LPNSPREMOVESERVICECLASS = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        lpserviceclassid: *const windows_core::GUID,
    ) -> i32,
>;
#[cfg(feature = "Win32_System_Com")]
pub type LPNSPSETSERVICE = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        lpserviceclassinfo: *const WSASERVICECLASSINFOW,
        lpqsreginfo: *const WSAQUERYSETW,
...
>;
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_IO"))]
pub type LPNSPSTARTUP = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        lpnsproutines: *mut NSP_ROUTINE,
    ) -> i32,
>;
pub type LPNSPV2CLEANUP = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        pvclientsessionarg: *const core::ffi::c_void,
    ) -> i32,
>;
pub type LPNSPV2CLIENTSESSIONRUNDOWN = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        pvclientsessionarg: *const core::ffi::c_void,
    ),
>;
#[cfg(feature = "Win32_System_Com")]
pub type LPNSPV2LOOKUPSERVICEBEGIN = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        lpqsrestrictions: *const WSAQUERYSET2W,
        dwcontrolflags: u32,
        lpvclientsessionarg: *const core::ffi::c_void,
        lphlookup: *mut super::super::Foundation::HANDLE,
    ) -> i32,
>;
pub type LPNSPV2LOOKUPSERVICEEND =
    Option<unsafe extern "system" fn(hlookup: super::super::Foundation::HANDLE) -> i32>;
#[cfg(feature = "Win32_System_Com")]
pub type LPNSPV2LOOKUPSERVICENEXTEX = Option<
    unsafe extern "system" fn(
        hasynccall: super::super::Foundation::HANDLE,
        hlookup: super::super::Foundation::HANDLE,
        dwcontrolflags: u32,
...
>;
#[cfg(feature = "Win32_System_Com")]
pub type LPNSPV2SETSERVICEEX = Option<
    unsafe extern "system" fn(
        hasynccall: super::super::Foundation::HANDLE,
        lpproviderid: *const windows_core::GUID,
        lpqsreginfo: *const WSAQUERYSET2W,
        essoperation: WSAESETSERVICEOP,
        dwcontrolflags: u32,
        lpvclientsessionarg: *const core::ffi::c_void,
    ),
>;
pub type LPNSPV2STARTUP = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        ppvclientsessionarg: *mut *mut core::ffi::c_void,
    ) -> i32,
>;
pub type LPSERVICE_CALLBACK_PROC = Option<
    unsafe extern "system" fn(
        lparam: super::super::Foundation::LPARAM,
        hasynctaskhandle: super::super::Foundation::HANDLE,
    ),
>;
pub type LPWPUCLOSEEVENT =
    Option<unsafe extern "system" fn(hevent: WSAEVENT, lperrno: *mut i32) -> windows_core::BOOL>;
pub type LPWPUCLOSESOCKETHANDLE =
    Option<unsafe extern "system" fn(s: SOCKET, lperrno: *mut i32) -> i32>;
pub type LPWPUCLOSETHREAD =
    Option<unsafe extern "system" fn(lpthreadid: *const WSATHREADID, lperrno: *mut i32) -> i32>;
#[cfg(feature = "Win32_System_IO")]
pub type LPWPUCOMPLETEOVERLAPPEDREQUEST = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        lpoverlapped: *mut super::super::System::IO::OVERLAPPED,
        dwerror: u32,
...
pub type LPWPUCREATESOCKETHANDLE = Option<
...
pub type LPWPUGETPROVIDERPATH = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        lpszproviderdllpath: windows_core::PWSTR,
        lpproviderdllpathlen: *mut i32,
...
>;
pub type LPWPUMODIFYIFSHANDLE = Option<
    unsafe extern "system" fn(
...
>;
pub type LPWPUOPENCURRENTTHREAD =
    Option<unsafe extern "system" fn(lpthreadid: *mut WSATHREADID, lperrno: *mut i32) -> i32>;
pub type LPWPUPOSTMESSAGE = Option<
    unsafe extern "system" fn(
        hwnd: super::super::Foundation::HWND,
        msg: u32,
...
>;
pub type LPWPUQUERYBLOCKINGCALLBACK = Option<
    unsafe extern "system" fn(
        dwcatalogentryid: u32,
        lplpfncallback: *mut LPBLOCKINGCALLBACK,
        lpdwcontext: *mut usize,
        lperrno: *mut i32,
    ) -> i32,
>;
pub type LPWPUQUERYSOCKETHANDLECONTEXT =
    Option<unsafe extern "system" fn(s: SOCKET, lpcontext: *mut usize, lperrno: *mut i32) -> i32>;
pub type LPWPUQUEUEAPC = Option<
    unsafe extern "system" fn(
        lpthreadid: *const WSATHREADID,
...
pub type LPWSCDEINSTALLPROVIDER = Option<
    unsafe extern "system" fn(lpproviderid: *const windows_core::GUID, lperrno: *mut i32) -> i32,
>;
pub type LPWSCENABLENSPROVIDER = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        fenable: windows_core::BOOL,
    ) -> i32,
>;
pub type LPWSCENUMPROTOCOLS = Option<
    unsafe extern "system" fn(
...
>;
pub type LPWSCGETPROVIDERPATH = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        lpszproviderdllpath: windows_core::PWSTR,
        lpproviderdllpathlen: *mut i32,
...
>;
pub type LPWSCINSTALLNAMESPACE = Option<
    unsafe extern "system" fn(
        lpszidentifier: windows_core::PCWSTR,
        lpszpathname: windows_core::PCWSTR,
        dwnamespace: u32,
        dwversion: u32,
        lpproviderid: *const windows_core::GUID,
    ) -> i32,
>;
pub type LPWSCINSTALLPROVIDER = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        lpszproviderdllpath: windows_core::PCWSTR,
        lpprotocolinfolist: *const WSAPROTOCOL_INFOW,
        dwnumberofentries: u32,
        lperrno: *mut i32,
    ) -> i32,
>;
pub type LPWSCUNINSTALLNAMESPACE =
    Option<unsafe extern "system" fn(lpproviderid: *const windows_core::GUID) -> i32>;
pub type LPWSCUPDATEPROVIDER = Option<
    unsafe extern "system" fn(
        lpproviderid: *const windows_core::GUID,
        lpszproviderdllpath: windows_core::PCWSTR,
        lpprotocolinfolist: *const WSAPROTOCOL_INFOW,
...
>;
pub type LPWSCWRITENAMESPACEORDER = Option<
    unsafe extern "system" fn(lpproviderid: *mut windows_core::GUID, dwnumberofentries: u32) -> i32,
>;
pub type LPWSCWRITEPROVIDERORDER =
    Option<unsafe extern "system" fn(lpwdcatalogentryid: *mut u32, dwnumberofentries: u32) -> i32>;
pub type LPWSPACCEPT = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        addr: *mut SOCKADDR,
        addrlen: *mut i32,
...
>;
pub type LPWSPADDRESSTOSTRING = Option<
    unsafe extern "system" fn(
        lpsaaddress: *const SOCKADDR,
        dwaddresslength: u32,
...
>;
pub type LPWSPASYNCSELECT = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        hwnd: super::super::Foundation::HWND,
        wmsg: u32,
...
>;
pub type LPWSPDUPLICATESOCKET = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        dwprocessid: u32,
        lpprotocolinfo: *mut WSAPROTOCOL_INFOW,
...
>;
pub type LPWSPENUMNETWORKEVENTS = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        heventobject: super::super::Foundation::HANDLE,
        lpnetworkevents: *mut WSANETWORKEVENTS,
        lperrno: *mut i32,
    ) -> i32,
>;
pub type LPWSPEVENTSELECT = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        heventobject: WSAEVENT,
        lnetworkevents: i32,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type LPWSPGETOVERLAPPEDRESULT = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        lpoverlapped: *const super::super::System::IO::OVERLAPPED,
        lpcbtransfer: *mut u32,
        fwait: windows_core::BOOL,
        lpdwflags: *mut u32,
        lperrno: *mut i32,
    ) -> windows_core::BOOL,
>;
pub type LPWSPGETPEERNAME = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        name: *mut SOCKADDR,
        namelen: *mut i32,
...
>;
pub type LPWSPGETQOSBYNAME = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        lpqosname: *const WSABUF,
        lpqos: *mut QOS,
...
>;
pub type LPWSPGETSOCKNAME = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        name: *mut SOCKADDR,
        namelen: *mut i32,
...
>;
pub type LPWSPGETSOCKOPT = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        level: i32,
        optname: i32,
...
>;
pub type LPWSPLISTEN =
    Option<unsafe extern "system" fn(s: SOCKET, backlog: i32, lperrno: *mut i32) -> i32>;
#[cfg(feature = "Win32_System_IO")]
pub type LPWSPRECV = Option<
    unsafe extern "system" fn(
        s: SOCKET,
...
>;
pub type LPWSPRECVDISCONNECT = Option<
    unsafe extern "system" fn(
        s: SOCKET,
...
>;
pub type LPWSPSENDDISCONNECT = Option<
    unsafe extern "system" fn(
        s: SOCKET,
...
>;
pub type LPWSPSETSOCKOPT = Option<
    unsafe extern "system" fn(
        s: SOCKET,
        level: i32,
        optname: i32,
        optval: windows_core::PCSTR,
        optlen: i32,
        lperrno: *mut i32,
    ) -> i32,
>;
pub type LPWSPSHUTDOWN =
    Option<unsafe extern "system" fn(s: SOCKET, how: i32, lperrno: *mut i32) -> i32>;
pub type LPWSPSOCKET = Option<
    unsafe extern "system" fn(
        af: i32,
        r#type: i32,
        protocol: i32,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type LPWSPSTARTUP = Option<
    unsafe extern "system" fn(
        wversionrequested: u16,
        lpwspdata: *const WSPDATA,
        lpprotocolinfo: *const WSAPROTOCOL_INFOW,
        upcalltable: WSPUPCALLTABLE,
        lpproctable: *mut WSPPROC_TABLE,
    ) -> i32,
>;
pub type LPWSPSTRINGTOADDRESS = Option<
    unsafe extern "system" fn(
        addressstring: windows_core::PCWSTR,
        addressfamily: i32,
        lpprotocolinfo: *const WSAPROTOCOL_INFOW,
        lpaddress: *mut SOCKADDR,
        lpaddresslength: *mut i32,
...
pub const NLA_NAMESPACE_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x6642243a_3ba8_4aa6_baa5_2e0bd71fdd83);
...
pub const NLA_SERVICE_CLASS_GUID: windows_core::GUID =
    windows_core::GUID::from_u128(0x0037e515_b5c9_4a43_bada_8b48a87ad239);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const REAL_TIME_NOTIFICATION_CAPABILITY: windows_core::GUID =
    windows_core::GUID::from_u128(0x6b59819a_5cae_492d_a901_2a3c2c50164f);
pub const REAL_TIME_NOTIFICATION_CAPABILITY_EX: windows_core::GUID =
    windows_core::GUID::from_u128(0x6843da03_154a_4616_a508_44371295f96b);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const SOCKET_DEFAULT2_QM_POLICY: windows_core::GUID =
    windows_core::GUID::from_u128(0xaec2ef9c_3a4d_4d3e_8842_239942e39a47);
...
pub const WSAID_ACCEPTEX: windows_core::GUID =
    windows_core::GUID::from_u128(0xb5367df1_cbac_11cf_95ca_00805f48a192);
pub const WSAID_CONNECTEX: windows_core::GUID =
    windows_core::GUID::from_u128(0x25a207b9_ddf3_4660_8ee9_76e58c74063e);
pub const WSAID_DISCONNECTEX: windows_core::GUID =
    windows_core::GUID::from_u128(0x7fda2e11_8630_436f_a031_f536a6eec157);
pub const WSAID_GETACCEPTEXSOCKADDRS: windows_core::GUID =
    windows_core::GUID::from_u128(0xb5367df2_cbac_11cf_95ca_00805f48a192);
pub const WSAID_MULTIPLE_RIO: windows_core::GUID =
    windows_core::GUID::from_u128(0x8509e081_96dd_4005_b165_9e2ee8c79e3f);
pub const WSAID_TRANSMITFILE: windows_core::GUID =
    windows_core::GUID::from_u128(0xb5367df0_cbac_11cf_95ca_00805f48a192);
pub const WSAID_TRANSMITPACKETS: windows_core::GUID =
    windows_core::GUID::from_u128(0xd9689da0_1f90_11d3_9971_00c04f68c876);
pub const WSAID_WSAPOLL: windows_core::GUID =
    windows_core::GUID::from_u128(0x18c76f85_dc66_4964_972e_23c27238312b);
pub const WSAID_WSARECVMSG: windows_core::GUID =
    windows_core::GUID::from_u128(0xf689d7c8_6f1f_436b_8a53_e54fe351c322);
pub const WSAID_WSASENDMSG: windows_core::GUID =
    windows_core::GUID::from_u128(0xa441e712_754f_43ca_84a7_0dee44cf606d);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct WSAMSG {

...
pub unsafe fn EnableTrace(
    ...
    enableflag: u32,
    enablelevel: u32,
    controlguid: *const windows_core::GUID,
    tracehandle: CONTROLTRACE_HANDLE,
) -> super::super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn EnableTraceEx(
    ...
    sourceid: Option<*const windows_core::GUID>,
    tracehandle: CONTROLTRACE_HANDLE,
    isenabled: u32,
    level: u8,
    matchanykeyword: u64,
    ...
    unsafe {
        EnableTraceEx(
            providerid,
            sourceid.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(tracehandle),
            isenabled,
            level,
            matchanykeyword,
            matchallkeyword,
            enableproperty,
            enablefilterdesc.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn EnumerateTraceGuids(
    ...
    unsafe {
        EnumerateTraceGuids(
            core::mem::transmute(guidpropertiesarray.as_ptr()),
            guidpropertiesarray.len().try_into().unwrap(),
            guidcount as _,
        )
    }
}
...
pub unsafe fn EventAccessControl(
    ...
    operation: u32,
    sid: super::super::super::Security::PSID,
    rights: u32,
    allowordeny: bool,
) -> u32 {
...
pub unsafe fn EventAccessQuery(
    guid: *const windows_core::GUID,
    buffer: Option<super::super::super::Security::PSECURITY_DESCRIPTOR>,
    buffersize: *mut u32,
) -> u32 {
...
pub unsafe fn EventWriteEx(
    ...
    filter: u64,
    flags: u32,
    activityid: Option<*const windows_core::GUID>,
    relatedactivityid: Option<*const windows_core::GUID>,
    userdata: Option<&[EVENT_DATA_DESCRIPTOR]>,
) -> u32 {
    ...
    unsafe {
        EventWriteEx(
            ...
            filter,
            flags,
            activityid.unwrap_or(core::mem::zeroed()) as _,
            relatedactivityid.unwrap_or(core::mem::zeroed()) as _,
            userdata
                .as_deref()
                .map_or(0, |slice| slice.len().try_into().unwrap()),
            core::mem::transmute(
...
pub unsafe fn OpenTraceFromBufferStream(
    ...
    unsafe {
        OpenTraceFromBufferStream(
            ...
            buffercompletioncontext.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_System_Time")]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        OpenTraceFromFile(
            ...
            options,
            logfileheader.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_System_Time")]
...
pub unsafe fn OpenTraceFromRealTimeLoggerWithAllocationOptions<P0>(
    ...
    memorypartitionhandle: Option<super::super::super::Foundation::HANDLE>,
    logfileheader: Option<*mut TRACE_LOGFILE_HEADER>,
) -> u64
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        OpenTraceFromRealTimeLoggerWithAllocationOptions(
            ...
            options,
            allocationsize,
            memorypartitionhandle.unwrap_or(core::mem::zeroed()) as _,
            logfileheader.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
pub unsafe fn ProcessTrace(
    ...
    starttime: Option<*const super::super::super::Foundation::FILETIME>,
    endtime: Option<*const super::super::super::Foundation::FILETIME>,
) -> super::super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        ProcessTrace(
            core::mem::transmute(handlearray.as_ptr()),
...
#[inline]
pub unsafe fn ProcessTraceAddBufferToBufferStream(
    tracehandle: u64,
    buffer: *const ETW_BUFFER_HEADER,
    buffersize: u32,
) -> u32 {
...
#[inline]
pub unsafe fn ProcessTraceBufferIncrementReference(
    tracehandle: u64,
    buffer: *const ETW_BUFFER_HEADER,
) -> u32 {
...
pub unsafe fn QueryAllTracesA(
    ...
    unsafe {
        QueryAllTracesA(
            core::mem::transmute(propertyarray.as_ptr()),
            propertyarray.len().try_into().unwrap(),
            loggercount as _,
        )
    }
}
...
pub unsafe fn QueryTraceProcessingHandle(
    ...
    unsafe {
        QueryTraceProcessingHandle(
            core::mem::transmute(processinghandle),
            informationclass,
            inbuffer.unwrap_or(core::mem::zeroed()) as _,
            inbuffersize,
            outbuffer.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn RegisterTraceGuidsA<P5, P6>(
    ...
    requestcontext: Option<*const core::ffi::c_void>,
    controlguid: *const windows_core::GUID,
    ...
    P6: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        RegisterTraceGuidsA(
            requestaddress,
            requestcontext.unwrap_or(core::mem::zeroed()) as _,
            controlguid,
            traceguidreg
                .as_deref()
                .map_or(0, |slice| slice.len().try_into().unwrap()),
            ...
            mofimagepath.param().abi(),
            mofresourcename.param().abi(),
...
#[inline]
pub unsafe fn RemoveTraceCallback(
    pguid: *const windows_core::GUID,
) -> super::super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn TdhAggregatePayloadFilters(
    ...
    payloadfilterptrs: *const *const core::ffi::c_void,
    eventmatchallflags: Option<*const bool>,
    ...
    unsafe {
        TdhAggregatePayloadFilters(
            payloadfiltercount,
            payloadfilterptrs,
            eventmatchallflags.unwrap_or(core::mem::zeroed()) as _,
            eventfilterdescriptor as _,
        )
    }
}
#[inline]
...
pub unsafe fn TdhCreatePayloadFilter(
    ...
    payloadfilter: *mut *mut core::ffi::c_void,
) -> u32 {
    ...
    unsafe {
        TdhCreatePayloadFilter(
            ...
            eventdescriptor,
            eventmatchany,
            payloadpredicates.len().try_into().unwrap(),
            core::mem::transmute(payloadpredicates.as_ptr()),
            payloadfilter as _,
        )
    }
}
...
pub unsafe fn TdhEnumerateManifestProviderEvents(
    providerguid: *const windows_core::GUID,
    buffer: Option<*mut PROVIDER_EVENT_INFO>,
    buffersize: *mut u32,
) -> u32 {
...
pub unsafe fn TdhEnumerateProviderFieldInformation(
    ...
    pbuffer: Option<*mut PROVIDER_FIELD_INFOARRAY>,
    pbuffersize: *mut u32,
) -> u32 {
...
pub unsafe fn TdhEnumerateProviderFilters(
    ...
    filtercount: *mut u32,
    buffer: Option<*mut *mut PROVIDER_FILTER_INFO>,
    buffersize: *mut u32,
) -> u32 {
...
pub unsafe fn TdhEnumerateProviders(
    pbuffer: Option<*mut PROVIDER_ENUMERATION_INFO>,
    pbuffersize: *mut u32,
) -> u32 {
...
pub unsafe fn TdhEnumerateProvidersForDecodingSource(
    ...
    buffer: Option<*mut PROVIDER_ENUMERATION_INFO>,
    buffersize: u32,
...
pub unsafe fn TdhFormatProperty(
    ...
    mapinfo: Option<*const EVENT_MAP_INFO>,
    pointersize: u32,
    propertyintype: u16,
    propertyouttype: u16,
    propertylength: u16,
    ...
    unsafe {
        TdhFormatProperty(
            eventinfo,
            mapinfo.unwrap_or(core::mem::zeroed()) as _,
            pointersize,
            propertyintype,
            propertyouttype,
            propertylength,
            userdata.len().try_into().unwrap(),
            core::mem::transmute(userdata.as_ptr()),
            buffersize as _,
            buffer.unwrap_or(core::mem::zeroed()) as _,
            userdataconsumed as _,
        )
    }
}
#[inline]
...
pub unsafe fn TdhGetProperty(
    ...
    unsafe {
        TdhGetProperty(
            ...
            core::mem::transmute(ppropertydata.as_ptr()),
...
#[inline]
pub unsafe fn TdhGetWppMessage(
    handle: TDH_HANDLE,
...
#[inline]
pub unsafe fn TraceEvent(
    tracehandle: u64,
    eventtrace: *const EVENT_TRACE_HEADER,
) -> super::super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn TraceEventInstance(
    ...
    parentinstinfo: Option<*const EVENT_INSTANCE_INFO>,
) -> u32 {
    ...
    unsafe {
        TraceEventInstance(
            ...
            eventtrace,
            instinfo,
            parentinstinfo.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn TraceMessage(
    ...
    messageguid: *const windows_core::GUID,
    messagenumber: u16,
) -> super::super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn TraceQueryInformation(
    ...
    traceinformation: *mut core::ffi::c_void,
    informationlength: u32,
...
pub unsafe fn TraceSetInformation(
    sessionhandle: CONTROLTRACE_HANDLE,
    informationclass: TRACE_QUERY_INFO_CLASS,
    traceinformation: *const core::ffi::c_void,
    informationlength: u32,
) -> super::super::super::Foundation::WIN32_ERROR {
...
pub const ALPCGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x45d8cccd_539f_4b72_a8b7_5c683142609a);
#[repr(C)]
...
pub const CLSID_TraceRelogger: windows_core::GUID =
    windows_core::GUID::from_u128(0x7b40792d_05ff_44c4_9058_f440c71f17d4);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct CONTROLTRACE_HANDLE {
    pub Value: u64,
}
pub const CTraceRelogger: windows_core::GUID =
    windows_core::GUID::from_u128(0x7b40792d_05ff_44c4_9058_f440c71f17d4);
#[repr(transparent)]
...
pub const DefaultTraceSecurityGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x0811c1af_7a07_4a06_82ed_869455cdf713);
pub const DiskIoGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x3d6fa8d4_fe05_11d0_9dda_00c04fd7ba7c);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const ETW_PROCESS_TRACE_MODE_RAW_TIMESTAMP: ETW_PROCESS_TRACE_MODES =
    ETW_PROCESS_TRACE_MODES(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const EtwQueryProcessHandleInfoMax: ETW_PROCESS_HANDLE_INFO_TYPE =
    ETW_PROCESS_HANDLE_INFO_TYPE(5i32);
...
pub const EventTraceConfigGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x01853a65_418f_4f36_aefc_dc0f1d2fd235);
pub const EventTraceGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x68fdd900_4a3e_11d1_84f4_0000f80464e3);
pub const FileIoGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x90cbdc39_4a3e_11d1_84f4_0000f80464e3);
...
windows_core::imp::define_interface!(
    ITraceEvent,
    ITraceEvent_Vtbl,
    0x8cc97f40_9028_4ff3_9b62_7d1f79ca7bcb
);
...
impl ITraceEvent {
    ...
    pub unsafe fn GetUserContext(&self) -> windows_core::Result<*mut core::ffi::c_void> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetUserContext)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetEventRecord(&self) -> windows_core::Result<*mut EVENT_RECORD> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEventRecord)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetPayload(&self, payload: &[u8]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPayload)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn SetEventDescriptor(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetEventDescriptor)(
                windows_core::Interface::as_raw(self),
                eventdescriptor,
            )
            .ok()
    ...
    pub unsafe fn SetProcessId(&self, processid: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetProcessId)(
                windows_core::Interface::as_raw(self),
                processid,
            )
            .ok()
    ...
    pub unsafe fn SetProcessorIndex(&self, processorindex: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetProcessorIndex)(
                windows_core::Interface::as_raw(self),
                processorindex,
            )
            .ok()
    ...
    pub unsafe fn SetThreadId(&self, threadid: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetThreadId)(
                windows_core::Interface::as_raw(self),
                threadid,
            )
            .ok()
    ...
    pub unsafe fn SetThreadTimes(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetThreadTimes)(
                windows_core::Interface::as_raw(self),
                kerneltime,
                usertime,
            )
    ...
    pub unsafe fn SetActivityId(
        &self,
        activityid: *const windows_core::GUID,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetActivityId)(
                windows_core::Interface::as_raw(self),
                activityid,
            )
            .ok()
    ...
    pub unsafe fn SetTimeStamp(&self, timestamp: *const i64) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTimeStamp)(
                windows_core::Interface::as_raw(self),
                timestamp,
            )
            .ok()
    ...
    pub unsafe fn SetProviderId(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetProviderId)(
                windows_core::Interface::as_raw(self),
                providerid,
            )
            .ok()
...
pub struct ITraceEvent_Vtbl {
    ...
    pub GetUserContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetEventRecord: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut EVENT_RECORD,
    ) -> windows_core::HRESULT,
    pub SetPayload:
        unsafe extern "system" fn(*mut core::ffi::c_void, *const u8, u32) -> windows_core::HRESULT,
    pub SetEventDescriptor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const EVENT_DESCRIPTOR,
    ) -> windows_core::HRESULT,
    pub SetProcessId:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub SetProcessorIndex:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub SetThreadId:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub SetThreadTimes:
    ...
    pub SetTimeStamp:
        unsafe extern "system" fn(*mut core::ffi::c_void, *const i64) -> windows_core::HRESULT,
...
impl ITraceEvent_Vtbl {
    pub const fn new<Identity: ITraceEvent_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Clone<Identity: ITraceEvent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            newevent: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetUserContext<
            Identity: ITraceEvent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            usercontext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetEventRecord<
            Identity: ITraceEvent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetPayload<Identity: ITraceEvent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            payload: *const u8,
            payloadsize: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceEvent_Impl::SetPayload(
                    this,
                    core::mem::transmute_copy(&payload),
                    core::mem::transmute_copy(&payloadsize),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetEventDescriptor<
            Identity: ITraceEvent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceEvent_Impl::SetEventDescriptor(
                    this,
                    core::mem::transmute_copy(&eventdescriptor),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetProcessId<Identity: ITraceEvent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            processid: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetProcessorIndex<
            Identity: ITraceEvent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceEvent_Impl::SetProcessorIndex(
                    this,
                    core::mem::transmute_copy(&processorindex),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetThreadId<Identity: ITraceEvent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            threadid: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetThreadTimes<
            Identity: ITraceEvent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceEvent_Impl::SetThreadTimes(
                    this,
                    core::mem::transmute_copy(&kerneltime),
                    core::mem::transmute_copy(&usertime),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetActivityId<Identity: ITraceEvent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            activityid: *const windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetTimeStamp<Identity: ITraceEvent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            timestamp: *const i64,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetProviderId<Identity: ITraceEvent_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            providerid: *const windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl ITraceEventCallback {
    pub unsafe fn OnBeginProcessTrace<P0, P1>(
        &self,
        headerevent: P0,
        relogger: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnBeginProcessTrace)(
                windows_core::Interface::as_raw(self),
                headerevent.param().abi(),
                relogger.param().abi(),
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnFinalizeProcessTrace)(
                windows_core::Interface::as_raw(self),
                relogger.param().abi(),
            )
            .ok()
...
pub struct ITraceEventCallback_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OnBeginProcessTrace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OnFinalizeProcessTrace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait ITraceEventCallback_Impl: windows_core::IUnknownImpl {
    fn OnBeginProcessTrace(
        &self,
        headerevent: windows_core::Ref<'_, ITraceEvent>,
        relogger: windows_core::Ref<'_, ITraceRelogger>,
    ) -> windows_core::Result<()>;
    ...
    fn OnEvent(
        &self,
        event: windows_core::Ref<'_, ITraceEvent>,
        relogger: windows_core::Ref<'_, ITraceRelogger>,
    ) -> windows_core::Result<()>;
}
impl ITraceEventCallback_Vtbl {
    pub const fn new<Identity: ITraceEventCallback_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnBeginProcessTrace<
            Identity: ITraceEventCallback_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            headerevent: *mut core::ffi::c_void,
            relogger: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceEventCallback_Impl::OnBeginProcessTrace(
                    this,
                    core::mem::transmute_copy(&headerevent),
                    core::mem::transmute_copy(&relogger),
                )
                .into()
            }
        }
        unsafe extern "system" fn OnFinalizeProcessTrace<
            Identity: ITraceEventCallback_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceEventCallback_Impl::OnFinalizeProcessTrace(
                    this,
                    core::mem::transmute_copy(&relogger),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceEventCallback_Impl::OnEvent(
                    this,
...
windows_core::imp::define_interface!(
    ITraceRelogger,
    ITraceRelogger_Vtbl,
    0xf754ad43_3bcc_4286_8009_9c5da214e84e
);
windows_core::imp::interface_hierarchy!(ITraceRelogger, windows_core::IUnknown);
impl ITraceRelogger {
    pub unsafe fn AddLogfileTraceStream(
        &self,
        logfilename: &windows_core::BSTR,
        usercontext: *const core::ffi::c_void,
    ) -> windows_core::Result<RELOGSTREAM_HANDLE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AddLogfileTraceStream)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(logfilename),
                usercontext,
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn AddRealtimeTraceStream(
        &self,
        loggername: &windows_core::BSTR,
        usercontext: *const core::ffi::c_void,
    ) -> windows_core::Result<RELOGSTREAM_HANDLE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AddRealtimeTraceStream)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(loggername),
                usercontext,
                &mut result__,
            )
            .map(|| result__)
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Inject)(
                windows_core::Interface::as_raw(self),
                event.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn CreateEventInstance(
        ...
        flags: u32,
    ) -> windows_core::Result<ITraceEvent> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateEventInstance)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(tracehandle),
                flags,
                &mut result__,
    ...
    pub unsafe fn ProcessTrace(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ProcessTrace)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub struct ITraceRelogger_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub AddLogfileTraceStream: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        *mut RELOGSTREAM_HANDLE,
    ) -> windows_core::HRESULT,
    pub AddRealtimeTraceStream: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        *mut RELOGSTREAM_HANDLE,
    ...
    pub Inject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateEventInstance: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        RELOGSTREAM_HANDLE,
        u32,
        *mut *mut core::ffi::c_void,
...
pub trait ITraceRelogger_Impl: windows_core::IUnknownImpl {
    ...
    fn RegisterCallback(
        &self,
        callback: windows_core::Ref<'_, ITraceEventCallback>,
    ) -> windows_core::Result<()>;
...
impl ITraceRelogger_Vtbl {
    pub const fn new<Identity: ITraceRelogger_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddLogfileTraceStream<
            Identity: ITraceRelogger_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            logfilename: *mut core::ffi::c_void,
            usercontext: *const core::ffi::c_void,
            tracehandle: *mut RELOGSTREAM_HANDLE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITraceRelogger_Impl::AddLogfileTraceStream(
                    this,
                    core::mem::transmute(&logfilename),
                    core::mem::transmute_copy(&usercontext),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn AddRealtimeTraceStream<
            Identity: ITraceRelogger_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            loggername: *mut core::ffi::c_void,
            usercontext: *const core::ffi::c_void,
            tracehandle: *mut RELOGSTREAM_HANDLE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITraceRelogger_Impl::AddRealtimeTraceStream(
                    this,
                    core::mem::transmute(&loggername),
                    core::mem::transmute_copy(&usercontext),
                ) {
                    Ok(ok__) => {
                        tracehandle.write(core::mem::transmute(ok__));
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceRelogger_Impl::RegisterCallback(this, core::mem::transmute_copy(&callback))
                    .into()
            }
        }
        unsafe extern "system" fn Inject<Identity: ITraceRelogger_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            event: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn CreateEventInstance<
            Identity: ITraceRelogger_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            tracehandle: RELOGSTREAM_HANDLE,
            flags: u32,
            event: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITraceRelogger_Impl::CreateEventInstance(
                    this,
                    core::mem::transmute(&tracehandle),
        ...
        unsafe extern "system" fn ProcessTrace<
            Identity: ITraceRelogger_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceRelogger_Impl::SetOutputFilename(this, core::mem::transmute(&logfilename))
                    .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITraceRelogger_Impl::SetCompressionMode(
                    this,
                    core::mem::transmute_copy(&compressionmode),
                )
                .into()
            }
        }
        unsafe extern "system" fn Cancel<Identity: ITraceRelogger_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
pub const ImageLoadGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x2cb15d1d_5fc1_11d2_abe1_00a0c911f518);
...
pub type PENABLECALLBACK = Option<
    unsafe extern "system" fn(
        sourceid: *const windows_core::GUID,
...
>;
#[cfg(feature = "Win32_System_Time")]
pub type PETW_BUFFER_CALLBACK = Option<
    unsafe extern "system" fn(
        buffer: *const ETW_BUFFER_HEADER,
        buffersize: u32,
        consumerinfo: *const ETW_BUFFER_CALLBACK_INFORMATION,
        callbackcontext: *const core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
pub type PETW_BUFFER_COMPLETION_CALLBACK = Option<
    unsafe extern "system" fn(
        buffer: *const ETW_BUFFER_HEADER,
        callbackcontext: *const core::ffi::c_void,
    ),
...
pub type PEVENT_TRACE_BUFFER_CALLBACKA =
    Option<unsafe extern "system" fn(logfile: *mut EVENT_TRACE_LOGFILEA) -> u32>;
#[cfg(feature = "Win32_System_Time")]
...
pub const PageFaultGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x3d6fa8d3_fe05_11d0_9dda_00c04fd7ba7c);
pub const PerfInfoGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xce1dbfb4_137e_4da6_87b0_3f59aa102cbc);
pub const PrivateLoggerNotificationGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x3595ab5c_042a_4c8e_b942_2d059bfeb1b1);
pub const ProcessGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x3d6fa8d0_fe05_11d0_9dda_00c04fd7ba7c);
...
pub const RegistryGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xae53722e_c863_11d2_8659_00c04fa321a1);
...
pub const SplitIoGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xd837ca92_12b9_44a5_ad6a_3a65b3578aa8);
pub const SystemAlpcProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xfcb9baaf_e529_4980_92e9_ced1a6aadfdf);
pub const SystemConfigProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xfef3a8b6_318d_4b67_a96a_3b0f6b8f18fe);
pub const SystemCpuProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xc6c5265f_eae8_4650_aae4_9d48603d8510);
pub const SystemHypervisorProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xbafa072a_918a_4bed_b622_bc152097098f);
pub const SystemInterruptProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xd4bbee17_b545_4888_858b_744169015b25);
pub const SystemIoFilterProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xfbd09363_9e22_4661_b8bf_e7a34b535b8c);
pub const SystemIoProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x3d5c43e3_0f1c_4202_b817_174c0070dc79);
pub const SystemLockProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x721ddfd3_dacc_4e1e_b26a_a2cb31d4705a);
pub const SystemMemoryProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x82958ca9_b6cd_47f8_a3a8_03ae85a4bc24);
pub const SystemObjectProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xfebd7460_3d1d_47eb_af49_c9eeb1e146f2);
pub const SystemPowerProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xc134884a_32d5_4488_80e5_14ed7abb8269);
pub const SystemProcessProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x151f55dc_467d_471f_83b5_5f889d46ff66);
pub const SystemProfileProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xbfeb0324_1cee_496f_a409_2ac2b48a6322);
pub const SystemRegistryProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x16156bd9_fab4_4cfa_a232_89d1099058e3);
pub const SystemSchedulerProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x599a2a76_4d91_4910_9ac7_7d33f2e97a6c);
pub const SystemSyscallProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x434286f7_6f1b_45bb_b37e_95f623046c7c);
pub const SystemTimerProviderGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x4f061568_e215_499f_ab2e_eda0ae890a5b);
pub const SystemTraceControlGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x9e814aad_3204_11d2_9a82_006008a86939);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const TcpIpGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x9a280ac0_c8e0_11d1_84e2_00c04fb998a2);
pub const ThreadGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x3d6fa8d1_fe05_11d0_9dda_00c04fd7ba7c);
...
pub const UdpIpGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xbf3a50c5_a9c9_4988_a005_2df0b7c80f80);
pub type WMIDPREQUEST = Option<
    unsafe extern "system" fn(

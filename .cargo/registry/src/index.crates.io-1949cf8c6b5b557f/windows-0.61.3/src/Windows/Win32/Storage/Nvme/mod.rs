...
pub const GUID_MFND_CHILD_CONTROLLER_EVENT_LOG_PAGE: windows_core::GUID =
    windows_core::GUID::from_u128(0x98bcce18_a5f0_bf35_a544_d97f259d669c);
pub const GUID_MFND_CHILD_CONTROLLER_EVENT_LOG_PAGEGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x98bcce18_a5f0_bf35_a544_d97f259d669c);
pub const GUID_OCP_DEVICE_DEVICE_CAPABILITIES: windows_core::GUID =
    windows_core::GUID::from_u128(0x0d054297_e1d1_98c9_5d49_584b913c05b7);
pub const GUID_OCP_DEVICE_DEVICE_CAPABILITIESGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x0d054297_e1d1_98c9_5d49_584b913c05b7);
pub const GUID_OCP_DEVICE_ERROR_RECOVERY: windows_core::GUID =
    windows_core::GUID::from_u128(0x2131d944_30fe_ae34_ab4d_fd3dba83195a);
pub const GUID_OCP_DEVICE_ERROR_RECOVERYGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x2131d944_30fe_ae34_ab4d_fd3dba83195a);
pub const GUID_OCP_DEVICE_FIRMWARE_ACTIVATION_HISTORY: windows_core::GUID =
    windows_core::GUID::from_u128(0x769a796d_dab4_a3f6_e24d_b28aacf31cd1);
pub const GUID_OCP_DEVICE_FIRMWARE_ACTIVATION_HISTORYGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x769a796d_dab4_a3f6_e24d_b28aacf31cd1);
pub const GUID_OCP_DEVICE_LATENCY_MONITOR: windows_core::GUID =
    windows_core::GUID::from_u128(0x8cc07a92_84d0_9c6c_7043_e6d4585ed485);
pub const GUID_OCP_DEVICE_LATENCY_MONITORGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x8cc07a92_84d0_9c6c_7043_e6d4585ed485);
pub const GUID_OCP_DEVICE_SMART_INFORMATION: windows_core::GUID =
    windows_core::GUID::from_u128(0x2810afc5_bfea_a4f2_9c4f_6f7cc914d5af);
pub const GUID_OCP_DEVICE_SMART_INFORMATIONGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x2810afc5_bfea_a4f2_9c4f_6f7cc914d5af);
pub const GUID_OCP_DEVICE_TCG_CONFIGURATION: windows_core::GUID =
    windows_core::GUID::from_u128(0xbd244006_e07e_83e6_c047_54fa9d2ae054);
pub const GUID_OCP_DEVICE_TCG_CONFIGURATIONGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0xbd244006_e07e_83e6_c047_54fa9d2ae054);
pub const GUID_OCP_DEVICE_TCG_HISTORY: windows_core::GUID =
    windows_core::GUID::from_u128(0x704b513e_09c6_9490_274e_d0969690d788);
pub const GUID_OCP_DEVICE_TCG_HISTORYGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x704b513e_09c6_9490_274e_d0969690d788);
pub const GUID_OCP_DEVICE_UNSUPPORTED_REQUIREMENTS: windows_core::GUID =
    windows_core::GUID::from_u128(0x0e9c722f_2399_bb2c_6348_32d0b798bbc7);
pub const GUID_OCP_DEVICE_UNSUPPORTED_REQUIREMENTSGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x0e9c722f_2399_bb2c_6348_32d0b798bbc7);
pub const GUID_WCS_DEVICE_ERROR_RECOVERY: windows_core::GUID =
    windows_core::GUID::from_u128(0x2131d944_30fe_ae34_ab4d_fd3dba83195a);
pub const GUID_WCS_DEVICE_ERROR_RECOVERYGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x2131d944_30fe_ae34_ab4d_fd3dba83195a);
pub const GUID_WCS_DEVICE_SMART_ATTRIBUTES: windows_core::GUID =
    windows_core::GUID::from_u128(0x2810afc5_bfea_a4f2_9c4f_6f7cc914d5af);
pub const GUID_WCS_DEVICE_SMART_ATTRIBUTESGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x2810afc5_bfea_a4f2_9c4f_6f7cc914d5af);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const NVME_ACCESS_FREQUENCY_FR_WRITE_FR_READ: NVME_ACCESS_FREQUENCIES =
    NVME_ACCESS_FREQUENCIES(5i32);
pub const NVME_ACCESS_FREQUENCY_FR_WRITE_INFR_READ: NVME_ACCESS_FREQUENCIES =
    NVME_ACCESS_FREQUENCIES(4i32);
pub const NVME_ACCESS_FREQUENCY_INFR_WRITE_FR_READ: NVME_ACCESS_FREQUENCIES =
    NVME_ACCESS_FREQUENCIES(3i32);
pub const NVME_ACCESS_FREQUENCY_INFR_WRITE_INFR_READ: NVME_ACCESS_FREQUENCIES =
    NVME_ACCESS_FREQUENCIES(2i32);
pub const NVME_ACCESS_FREQUENCY_NONE: NVME_ACCESS_FREQUENCIES = NVME_ACCESS_FREQUENCIES(0i32);
pub const NVME_ACCESS_FREQUENCY_ONE_TIME_READ: NVME_ACCESS_FREQUENCIES =
    NVME_ACCESS_FREQUENCIES(6i32);
pub const NVME_ACCESS_FREQUENCY_SPECULATIVE_READ: NVME_ACCESS_FREQUENCIES =
    NVME_ACCESS_FREQUENCIES(7i32);
pub const NVME_ACCESS_FREQUENCY_TYPICAL: NVME_ACCESS_FREQUENCIES = NVME_ACCESS_FREQUENCIES(1i32);
pub const NVME_ACCESS_FREQUENCY_WILL_BE_OVERWRITTEN: NVME_ACCESS_FREQUENCIES =
    NVME_ACCESS_FREQUENCIES(8i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NVME_ADMIN_COMMAND_DOORBELL_BUFFER_CONFIG: NVME_ADMIN_COMMANDS =
    NVME_ADMIN_COMMANDS(124i32);
...
pub const NVME_ADMIN_COMMAND_FIRMWARE_IMAGE_DOWNLOAD: NVME_ADMIN_COMMANDS =
    NVME_ADMIN_COMMANDS(17i32);
...
pub const NVME_ADMIN_COMMAND_VIRTUALIZATION_MANAGEMENT: NVME_ADMIN_COMMANDS =
    NVME_ADMIN_COMMANDS(28i32);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const NVME_ASYNC_ERROR_DIAG_FAILURE: NVME_ASYNC_EVENT_ERROR_STATUS_CODES =
    NVME_ASYNC_EVENT_ERROR_STATUS_CODES(2i32);
pub const NVME_ASYNC_ERROR_FIRMWARE_IMAGE_LOAD_ERROR: NVME_ASYNC_EVENT_ERROR_STATUS_CODES =
    NVME_ASYNC_EVENT_ERROR_STATUS_CODES(5i32);
pub const NVME_ASYNC_ERROR_INVALID_DOORBELL_WRITE_VALUE: NVME_ASYNC_EVENT_ERROR_STATUS_CODES =
    NVME_ASYNC_EVENT_ERROR_STATUS_CODES(1i32);
pub const NVME_ASYNC_ERROR_INVALID_SUBMISSION_QUEUE: NVME_ASYNC_EVENT_ERROR_STATUS_CODES =
    NVME_ASYNC_EVENT_ERROR_STATUS_CODES(0i32);
pub const NVME_ASYNC_ERROR_PERSISTENT_INTERNAL_DEVICE_ERROR: NVME_ASYNC_EVENT_ERROR_STATUS_CODES =
    NVME_ASYNC_EVENT_ERROR_STATUS_CODES(3i32);
pub const NVME_ASYNC_ERROR_TRANSIENT_INTERNAL_DEVICE_ERROR: NVME_ASYNC_EVENT_ERROR_STATUS_CODES =
    NVME_ASYNC_EVENT_ERROR_STATUS_CODES(4i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NVME_ASYNC_EVENT_TYPE_HEALTH_STATUS: NVME_ASYNC_EVENT_TYPES =
    NVME_ASYNC_EVENT_TYPES(1i32);
pub const NVME_ASYNC_EVENT_TYPE_IO_COMMAND_SET_STATUS: NVME_ASYNC_EVENT_TYPES =
    NVME_ASYNC_EVENT_TYPES(6i32);
pub const NVME_ASYNC_EVENT_TYPE_NOTICE: NVME_ASYNC_EVENT_TYPES = NVME_ASYNC_EVENT_TYPES(2i32);
pub const NVME_ASYNC_EVENT_TYPE_VENDOR_SPECIFIC: NVME_ASYNC_EVENT_TYPES =
    NVME_ASYNC_EVENT_TYPES(7i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_ASYNC_EVENT_TYPE_VENDOR_SPECIFIC_CODES(pub i32);
pub const NVME_ASYNC_EVENT_TYPE_VENDOR_SPECIFIC_DEVICE_PANIC:
    NVME_ASYNC_EVENT_TYPE_VENDOR_SPECIFIC_CODES = NVME_ASYNC_EVENT_TYPE_VENDOR_SPECIFIC_CODES(1i32);
pub const NVME_ASYNC_EVENT_TYPE_VENDOR_SPECIFIC_RESERVED:
    NVME_ASYNC_EVENT_TYPE_VENDOR_SPECIFIC_CODES = NVME_ASYNC_EVENT_TYPE_VENDOR_SPECIFIC_CODES(0i32);
pub const NVME_ASYNC_HEALTH_NVM_SUBSYSTEM_RELIABILITY: NVME_ASYNC_EVENT_HEALTH_STATUS_CODES =
    NVME_ASYNC_EVENT_HEALTH_STATUS_CODES(0i32);
pub const NVME_ASYNC_HEALTH_SPARE_BELOW_THRESHOLD: NVME_ASYNC_EVENT_HEALTH_STATUS_CODES =
    NVME_ASYNC_EVENT_HEALTH_STATUS_CODES(2i32);
pub const NVME_ASYNC_HEALTH_TEMPERATURE_THRESHOLD: NVME_ASYNC_EVENT_HEALTH_STATUS_CODES =
    NVME_ASYNC_EVENT_HEALTH_STATUS_CODES(1i32);
pub const NVME_ASYNC_IO_CMD_SANITIZE_OPERATION_COMPLETED:
    NVME_ASYNC_EVENT_IO_COMMAND_SET_STATUS_CODES =
    NVME_ASYNC_EVENT_IO_COMMAND_SET_STATUS_CODES(1i32);
pub const NVME_ASYNC_IO_CMD_SANITIZE_OPERATION_COMPLETED_WITH_UNEXPECTED_DEALLOCATION:
    NVME_ASYNC_EVENT_IO_COMMAND_SET_STATUS_CODES =
    NVME_ASYNC_EVENT_IO_COMMAND_SET_STATUS_CODES(2i32);
pub const NVME_ASYNC_IO_CMD_SET_RESERVATION_LOG_PAGE_AVAILABLE:
    NVME_ASYNC_EVENT_IO_COMMAND_SET_STATUS_CODES =
    NVME_ASYNC_EVENT_IO_COMMAND_SET_STATUS_CODES(0i32);
pub const NVME_ASYNC_NOTICE_ASYMMETRIC_ACCESS_CHANGE: NVME_ASYNC_EVENT_NOTICE_CODES =
    NVME_ASYNC_EVENT_NOTICE_CODES(3i32);
pub const NVME_ASYNC_NOTICE_ENDURANCE_GROUP_EVENT_AGGREGATE_LOG_CHANGE:
    NVME_ASYNC_EVENT_NOTICE_CODES = NVME_ASYNC_EVENT_NOTICE_CODES(6i32);
pub const NVME_ASYNC_NOTICE_FIRMWARE_ACTIVATION_STARTING: NVME_ASYNC_EVENT_NOTICE_CODES =
    NVME_ASYNC_EVENT_NOTICE_CODES(1i32);
pub const NVME_ASYNC_NOTICE_LBA_STATUS_INFORMATION_ALERT: NVME_ASYNC_EVENT_NOTICE_CODES =
    NVME_ASYNC_EVENT_NOTICE_CODES(5i32);
pub const NVME_ASYNC_NOTICE_NAMESPACE_ATTRIBUTE_CHANGED: NVME_ASYNC_EVENT_NOTICE_CODES =
    NVME_ASYNC_EVENT_NOTICE_CODES(0i32);
pub const NVME_ASYNC_NOTICE_PREDICTABLE_LATENCY_EVENT_AGGREGATE_LOG_CHANGE:
    NVME_ASYNC_EVENT_NOTICE_CODES = NVME_ASYNC_EVENT_NOTICE_CODES(4i32);
pub const NVME_ASYNC_NOTICE_TELEMETRY_LOG_CHANGED: NVME_ASYNC_EVENT_NOTICE_CODES =
    NVME_ASYNC_EVENT_NOTICE_CODES(2i32);
pub const NVME_ASYNC_NOTICE_ZONE_DESCRIPTOR_CHANGED: NVME_ASYNC_EVENT_NOTICE_CODES =
    NVME_ASYNC_EVENT_NOTICE_CODES(239i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const NVME_CC_SHN_ABRUPT_SHUTDOWN: NVME_CC_SHN_SHUTDOWN_NOTIFICATIONS =
    NVME_CC_SHN_SHUTDOWN_NOTIFICATIONS(2i32);
pub const NVME_CC_SHN_NORMAL_SHUTDOWN: NVME_CC_SHN_SHUTDOWN_NOTIFICATIONS =
    NVME_CC_SHN_SHUTDOWN_NOTIFICATIONS(1i32);
pub const NVME_CC_SHN_NO_NOTIFICATION: NVME_CC_SHN_SHUTDOWN_NOTIFICATIONS =
    NVME_CC_SHN_SHUTDOWN_NOTIFICATIONS(0i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NVME_COMMAND_EFFECT_SBUMISSION_EXECUTION_LIMIT_NONE:
    NVME_COMMAND_EFFECT_SBUMISSION_EXECUTION_LIMITS =
    NVME_COMMAND_EFFECT_SBUMISSION_EXECUTION_LIMITS(0i32);
pub const NVME_COMMAND_EFFECT_SBUMISSION_EXECUTION_LIMIT_SINGLE_PER_CONTROLLER:
    NVME_COMMAND_EFFECT_SBUMISSION_EXECUTION_LIMITS =
    NVME_COMMAND_EFFECT_SBUMISSION_EXECUTION_LIMITS(2i32);
pub const NVME_COMMAND_EFFECT_SBUMISSION_EXECUTION_LIMIT_SINGLE_PER_NAMESPACE:
    NVME_COMMAND_EFFECT_SBUMISSION_EXECUTION_LIMITS =
    NVME_COMMAND_EFFECT_SBUMISSION_EXECUTION_LIMITS(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_COMMAND_SET_IDENTIFIERS(pub i32);
pub const NVME_COMMAND_SET_KEY_VALUE: NVME_COMMAND_SET_IDENTIFIERS =
    NVME_COMMAND_SET_IDENTIFIERS(1i32);
pub const NVME_COMMAND_SET_NVM: NVME_COMMAND_SET_IDENTIFIERS = NVME_COMMAND_SET_IDENTIFIERS(0i32);
pub const NVME_COMMAND_SET_ZONED_NAMESPACE: NVME_COMMAND_SET_IDENTIFIERS =
    NVME_COMMAND_SET_IDENTIFIERS(2i32);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const NVME_CONTROLLER_METADATA_CHIPSET_DRIVER_NAME: NVME_CONTROLLER_METADATA_ELEMENT_TYPES =
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES(8i32);
pub const NVME_CONTROLLER_METADATA_CHIPSET_DRIVER_VERSION: NVME_CONTROLLER_METADATA_ELEMENT_TYPES =
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES(9i32);
pub const NVME_CONTROLLER_METADATA_DISPLAY_DRIVER_NAME: NVME_CONTROLLER_METADATA_ELEMENT_TYPES =
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES(14i32);
pub const NVME_CONTROLLER_METADATA_DISPLAY_DRIVER_VERSION: NVME_CONTROLLER_METADATA_ELEMENT_TYPES =
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES(15i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_CONTROLLER_METADATA_ELEMENT_TYPES(pub i32);
pub const NVME_CONTROLLER_METADATA_FIRMWARE_VERSION: NVME_CONTROLLER_METADATA_ELEMENT_TYPES =
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES(12i32);
pub const NVME_CONTROLLER_METADATA_HOST_DETERMINED_FAILURE_RECORD:
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES = NVME_CONTROLLER_METADATA_ELEMENT_TYPES(16i32);
pub const NVME_CONTROLLER_METADATA_OPERATING_SYSTEM_CONTROLLER_NAME:
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES = NVME_CONTROLLER_METADATA_ELEMENT_TYPES(1i32);
pub const NVME_CONTROLLER_METADATA_OPERATING_SYSTEM_DRIVER_FILENAME:
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES = NVME_CONTROLLER_METADATA_ELEMENT_TYPES(13i32);
pub const NVME_CONTROLLER_METADATA_OPERATING_SYSTEM_DRIVER_NAME:
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES = NVME_CONTROLLER_METADATA_ELEMENT_TYPES(2i32);
pub const NVME_CONTROLLER_METADATA_OPERATING_SYSTEM_DRIVER_VERSION:
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES = NVME_CONTROLLER_METADATA_ELEMENT_TYPES(3i32);
pub const NVME_CONTROLLER_METADATA_OPERATING_SYSTEM_NAME_AND_BUILD:
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES = NVME_CONTROLLER_METADATA_ELEMENT_TYPES(10i32);
pub const NVME_CONTROLLER_METADATA_PREBOOT_CONTROLLER_NAME: NVME_CONTROLLER_METADATA_ELEMENT_TYPES =
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES(4i32);
pub const NVME_CONTROLLER_METADATA_PREBOOT_DRIVER_NAME: NVME_CONTROLLER_METADATA_ELEMENT_TYPES =
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES(5i32);
pub const NVME_CONTROLLER_METADATA_PREBOOT_DRIVER_VERSION: NVME_CONTROLLER_METADATA_ELEMENT_TYPES =
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES(6i32);
pub const NVME_CONTROLLER_METADATA_SYSTEM_PROCESSOR_MODEL: NVME_CONTROLLER_METADATA_ELEMENT_TYPES =
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES(7i32);
pub const NVME_CONTROLLER_METADATA_SYSTEM_PRODUCT_NAME: NVME_CONTROLLER_METADATA_ELEMENT_TYPES =
    NVME_CONTROLLER_METADATA_ELEMENT_TYPES(11i32);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const NVME_CSS_ALL_SUPPORTED_IO_COMMAND_SET: NVME_CSS_COMMAND_SETS =
    NVME_CSS_COMMAND_SETS(6i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NVME_CSTS_SHST_NO_SHUTDOWN: NVME_CSTS_SHST_SHUTDOWN_STATUS =
    NVME_CSTS_SHST_SHUTDOWN_STATUS(0i32);
pub const NVME_CSTS_SHST_SHUTDOWN_COMPLETED: NVME_CSTS_SHST_SHUTDOWN_STATUS =
    NVME_CSTS_SHST_SHUTDOWN_STATUS(2i32);
pub const NVME_CSTS_SHST_SHUTDOWN_IN_PROCESS: NVME_CSTS_SHST_SHUTDOWN_STATUS =
    NVME_CSTS_SHST_SHUTDOWN_STATUS(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NVME_DIRECTIVE_RECEIVE_IDENTIFY_OPERATION_RETURN_PARAMETERS:
    NVME_DIRECTIVE_RECEIVE_IDENTIFY_OPERATIONS = NVME_DIRECTIVE_RECEIVE_IDENTIFY_OPERATIONS(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_DIRECTIVE_RECEIVE_STREAMS_OPERATIONS(pub i32);
pub const NVME_DIRECTIVE_RECEIVE_STREAMS_OPERATION_ALLOCATE_RESOURCES:
    NVME_DIRECTIVE_RECEIVE_STREAMS_OPERATIONS = NVME_DIRECTIVE_RECEIVE_STREAMS_OPERATIONS(3i32);
pub const NVME_DIRECTIVE_RECEIVE_STREAMS_OPERATION_GET_STATUS:
    NVME_DIRECTIVE_RECEIVE_STREAMS_OPERATIONS = NVME_DIRECTIVE_RECEIVE_STREAMS_OPERATIONS(2i32);
pub const NVME_DIRECTIVE_RECEIVE_STREAMS_OPERATION_RETURN_PARAMETERS:
    NVME_DIRECTIVE_RECEIVE_STREAMS_OPERATIONS = NVME_DIRECTIVE_RECEIVE_STREAMS_OPERATIONS(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_DIRECTIVE_SEND_IDENTIFY_OPERATIONS(pub i32);
pub const NVME_DIRECTIVE_SEND_IDENTIFY_OPERATION_ENABLE_DIRECTIVE:
    NVME_DIRECTIVE_SEND_IDENTIFY_OPERATIONS = NVME_DIRECTIVE_SEND_IDENTIFY_OPERATIONS(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_DIRECTIVE_SEND_STREAMS_OPERATIONS(pub i32);
pub const NVME_DIRECTIVE_SEND_STREAMS_OPERATION_RELEASE_IDENTIFIER:
    NVME_DIRECTIVE_SEND_STREAMS_OPERATIONS = NVME_DIRECTIVE_SEND_STREAMS_OPERATIONS(1i32);
pub const NVME_DIRECTIVE_SEND_STREAMS_OPERATION_RELEASE_RESOURCES:
    NVME_DIRECTIVE_SEND_STREAMS_OPERATIONS = NVME_DIRECTIVE_SEND_STREAMS_OPERATIONS(2i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const NVME_ERROR_INJECTION_TYPE_DEVICE_PANIC_CPU_CONTROLLER_HANG: NVME_ERROR_INJECTION_TYPES =
    NVME_ERROR_INJECTION_TYPES(1i32);
pub const NVME_ERROR_INJECTION_TYPE_DEVICE_PANIC_DRAM_CORRUPTION_CRITICAL:
    NVME_ERROR_INJECTION_TYPES = NVME_ERROR_INJECTION_TYPES(5i32);
pub const NVME_ERROR_INJECTION_TYPE_DEVICE_PANIC_DRAM_CORRUPTION_NONCRITICAL:
    NVME_ERROR_INJECTION_TYPES = NVME_ERROR_INJECTION_TYPES(6i32);
pub const NVME_ERROR_INJECTION_TYPE_DEVICE_PANIC_HW_MALFUNCTION: NVME_ERROR_INJECTION_TYPES =
    NVME_ERROR_INJECTION_TYPES(9i32);
pub const NVME_ERROR_INJECTION_TYPE_DEVICE_PANIC_LOGICAL_FW_ERROR: NVME_ERROR_INJECTION_TYPES =
    NVME_ERROR_INJECTION_TYPES(4i32);
pub const NVME_ERROR_INJECTION_TYPE_DEVICE_PANIC_NAND_CORRUPTION: NVME_ERROR_INJECTION_TYPES =
    NVME_ERROR_INJECTION_TYPES(7i32);
pub const NVME_ERROR_INJECTION_TYPE_DEVICE_PANIC_NAND_HANG: NVME_ERROR_INJECTION_TYPES =
    NVME_ERROR_INJECTION_TYPES(2i32);
pub const NVME_ERROR_INJECTION_TYPE_DEVICE_PANIC_PLP_DEFECT: NVME_ERROR_INJECTION_TYPES =
    NVME_ERROR_INJECTION_TYPES(3i32);
pub const NVME_ERROR_INJECTION_TYPE_DEVICE_PANIC_SRAM_CORRUPTION: NVME_ERROR_INJECTION_TYPES =
    NVME_ERROR_INJECTION_TYPES(8i32);
pub const NVME_ERROR_INJECTION_TYPE_MAX: NVME_ERROR_INJECTION_TYPES =
    NVME_ERROR_INJECTION_TYPES(65535i32);
pub const NVME_ERROR_INJECTION_TYPE_RESERVED0: NVME_ERROR_INJECTION_TYPES =
    NVME_ERROR_INJECTION_TYPES(0i32);
pub const NVME_ERROR_INJECTION_TYPE_RESERVED1: NVME_ERROR_INJECTION_TYPES =
    NVME_ERROR_INJECTION_TYPES(10i32);
...
pub const NVME_FEATURE_VALUE_SUPPORTED_CAPABILITIES: NVME_FEATURE_VALUE_CODES =
    NVME_FEATURE_VALUE_CODES(3i32);
...
pub const NVME_FIRMWARE_ACTIVATE_ACTION_ACTIVATE: NVME_FIRMWARE_ACTIVATE_ACTIONS =
    NVME_FIRMWARE_ACTIVATE_ACTIONS(2i32);
pub const NVME_FIRMWARE_ACTIVATE_ACTION_DOWNLOAD_TO_SLOT: NVME_FIRMWARE_ACTIVATE_ACTIONS =
    NVME_FIRMWARE_ACTIVATE_ACTIONS(0i32);
pub const NVME_FIRMWARE_ACTIVATE_ACTION_DOWNLOAD_TO_SLOT_AND_ACTIVATE:
    NVME_FIRMWARE_ACTIVATE_ACTIONS = NVME_FIRMWARE_ACTIVATE_ACTIONS(1i32);
pub const NVME_FIRMWARE_ACTIVATE_ACTION_DOWNLOAD_TO_SLOT_AND_ACTIVATE_IMMEDIATE:
    NVME_FIRMWARE_ACTIVATE_ACTIONS = NVME_FIRMWARE_ACTIVATE_ACTIONS(3i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const NVME_FUSED_OPERATION_FIRST_CMD: NVME_FUSED_OPERATION_CODES =
    NVME_FUSED_OPERATION_CODES(1i32);
pub const NVME_FUSED_OPERATION_NORMAL: NVME_FUSED_OPERATION_CODES =
    NVME_FUSED_OPERATION_CODES(0i32);
pub const NVME_FUSED_OPERATION_SECOND_CMD: NVME_FUSED_OPERATION_CODES =
    NVME_FUSED_OPERATION_CODES(2i32);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const NVME_HOST_METADATA_ADD_ENTRY_MULTIPLE: NVME_HOST_METADATA_ELEMENT_ACTIONS =
    NVME_HOST_METADATA_ELEMENT_ACTIONS(2i32);
pub const NVME_HOST_METADATA_ADD_REPLACE_ENTRY: NVME_HOST_METADATA_ELEMENT_ACTIONS =
    NVME_HOST_METADATA_ELEMENT_ACTIONS(0i32);
pub const NVME_HOST_METADATA_DELETE_ENTRY_MULTIPLE: NVME_HOST_METADATA_ELEMENT_ACTIONS =
    NVME_HOST_METADATA_ELEMENT_ACTIONS(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NVME_IDENTIFIER_TYPE_CSI_LENGTH: NVME_IDENTIFIER_TYPE_LENGTH =
    NVME_IDENTIFIER_TYPE_LENGTH(1i32);
pub const NVME_IDENTIFIER_TYPE_EUI64: NVME_IDENTIFIER_TYPE = NVME_IDENTIFIER_TYPE(1i32);
pub const NVME_IDENTIFIER_TYPE_EUI64_LENGTH: NVME_IDENTIFIER_TYPE_LENGTH =
    NVME_IDENTIFIER_TYPE_LENGTH(8i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NVME_IDENTIFIER_TYPE_NGUID_LENGTH: NVME_IDENTIFIER_TYPE_LENGTH =
    NVME_IDENTIFIER_TYPE_LENGTH(16i32);
pub const NVME_IDENTIFIER_TYPE_UUID: NVME_IDENTIFIER_TYPE = NVME_IDENTIFIER_TYPE(3i32);
pub const NVME_IDENTIFIER_TYPE_UUID_LENGTH: NVME_IDENTIFIER_TYPE_LENGTH =
    NVME_IDENTIFIER_TYPE_LENGTH(16i32);
pub const NVME_IDENTIFY_CNS_ACTIVE_NAMESPACES: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(2i32);
pub const NVME_IDENTIFY_CNS_ACTIVE_NAMESPACE_LIST_IO_COMMAND_SET: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(7i32);
pub const NVME_IDENTIFY_CNS_ALLOCATED_NAMESPACE: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(17i32);
pub const NVME_IDENTIFY_CNS_ALLOCATED_NAMESPACE_IO_COMMAND_SET: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(27i32);
pub const NVME_IDENTIFY_CNS_ALLOCATED_NAMESPACE_LIST: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(16i32);
pub const NVME_IDENTIFY_CNS_ALLOCATED_NAMSPACE_LIST_IO_COMMAND_SET: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(26i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NVME_IDENTIFY_CNS_CONTROLLER_LIST_OF_NSID: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(18i32);
pub const NVME_IDENTIFY_CNS_CONTROLLER_LIST_OF_NVM_SUBSYSTEM: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(19i32);
pub const NVME_IDENTIFY_CNS_DESCRIPTOR_NAMESPACE: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(3i32);
...
pub const NVME_IDENTIFY_CNS_ENDURANCE_GROUP_LIST: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(25i32);
pub const NVME_IDENTIFY_CNS_IO_COMMAND_SET: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(28i32);
pub const NVME_IDENTIFY_CNS_NAMESPACE_GRANULARITY_LIST: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(22i32);
pub const NVME_IDENTIFY_CNS_NVM_SET: NVME_IDENTIFY_CNS_CODES = NVME_IDENTIFY_CNS_CODES(4i32);
pub const NVME_IDENTIFY_CNS_PRIMARY_CONTROLLER_CAPABILITIES: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(20i32);
pub const NVME_IDENTIFY_CNS_SECONDARY_CONTROLLER_LIST: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(21i32);
pub const NVME_IDENTIFY_CNS_SPECIFIC_CONTROLLER_IO_COMMAND_SET: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(6i32);
pub const NVME_IDENTIFY_CNS_SPECIFIC_NAMESPACE: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(0i32);
pub const NVME_IDENTIFY_CNS_SPECIFIC_NAMESPACE_IO_COMMAND_SET: NVME_IDENTIFY_CNS_CODES =
    NVME_IDENTIFY_CNS_CODES(5i32);
...
pub const NVME_IO_COMMAND_SET_COMBINATION_REJECTED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(43i32);
pub const NVME_IO_COMMAND_SET_INVALID: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(44i32);
pub const NVME_IO_COMMAND_SET_NOT_ENABLED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(42i32);
pub const NVME_IO_COMMAND_SET_NOT_SUPPORTED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(41i32);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const NVME_LOG_PAGE_OCP_DEVICE_CAPABILITIES: NVME_VENDOR_LOG_PAGES =
    NVME_VENDOR_LOG_PAGES(196i32);
pub const NVME_LOG_PAGE_OCP_DEVICE_ERROR_RECOVERY: NVME_VENDOR_LOG_PAGES =
    NVME_VENDOR_LOG_PAGES(193i32);
pub const NVME_LOG_PAGE_OCP_DEVICE_SMART_INFORMATION: NVME_VENDOR_LOG_PAGES =
    NVME_VENDOR_LOG_PAGES(192i32);
pub const NVME_LOG_PAGE_OCP_FIRMWARE_ACTIVATION_HISTORY: NVME_VENDOR_LOG_PAGES =
    NVME_VENDOR_LOG_PAGES(194i32);
pub const NVME_LOG_PAGE_OCP_LATENCY_MONITOR: NVME_VENDOR_LOG_PAGES = NVME_VENDOR_LOG_PAGES(195i32);
pub const NVME_LOG_PAGE_OCP_TCG_CONFIGURATION: NVME_VENDOR_LOG_PAGES =
    NVME_VENDOR_LOG_PAGES(200i32);
pub const NVME_LOG_PAGE_OCP_TCG_HISTORY: NVME_VENDOR_LOG_PAGES = NVME_VENDOR_LOG_PAGES(201i32);
pub const NVME_LOG_PAGE_OCP_UNSUPPORTED_REQUIREMENTS: NVME_VENDOR_LOG_PAGES =
    NVME_VENDOR_LOG_PAGES(197i32);
...
pub const NVME_MEDIA_ADDITIONALLY_MODIFIED_AFTER_SANITIZE_NOT_DEFINED:
    NVME_NO_DEALLOCATE_MODIFIES_MEDIA_AFTER_SANITIZE =
    NVME_NO_DEALLOCATE_MODIFIES_MEDIA_AFTER_SANITIZE(0i32);
pub const NVME_MEDIA_ADDITIONALLY_MOFIDIED_AFTER_SANITIZE:
    NVME_NO_DEALLOCATE_MODIFIES_MEDIA_AFTER_SANITIZE =
    NVME_NO_DEALLOCATE_MODIFIES_MEDIA_AFTER_SANITIZE(2i32);
pub const NVME_MEDIA_NOT_ADDITIONALLY_MODIFIED_AFTER_SANITIZE:
    NVME_NO_DEALLOCATE_MODIFIES_MEDIA_AFTER_SANITIZE =
    NVME_NO_DEALLOCATE_MODIFIES_MEDIA_AFTER_SANITIZE(1i32);
pub const NVME_NAMESPACE_ALL: u32 = 4294967295u32;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_NAMESPACE_METADATA_ELEMENT_TYPES(pub i32);
pub const NVME_NAMESPACE_METADATA_OPERATING_SYSTEM_NAMESPACE_NAME:
    NVME_NAMESPACE_METADATA_ELEMENT_TYPES = NVME_NAMESPACE_METADATA_ELEMENT_TYPES(1i32);
pub const NVME_NAMESPACE_METADATA_OPERATING_SYSTEM_NAMESPACE_NAME_QUALIFIER_1:
    NVME_NAMESPACE_METADATA_ELEMENT_TYPES = NVME_NAMESPACE_METADATA_ELEMENT_TYPES(3i32);
pub const NVME_NAMESPACE_METADATA_OPERATING_SYSTEM_NAMESPACE_NAME_QUALIFIER_2:
    NVME_NAMESPACE_METADATA_ELEMENT_TYPES = NVME_NAMESPACE_METADATA_ELEMENT_TYPES(4i32);
pub const NVME_NAMESPACE_METADATA_PREBOOT_NAMESPACE_NAME: NVME_NAMESPACE_METADATA_ELEMENT_TYPES =
    NVME_NAMESPACE_METADATA_ELEMENT_TYPES(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NVME_NVM_QUEUE_PRIORITY_MEDIUM: NVME_NVM_QUEUE_PRIORITIES =
    NVME_NVM_QUEUE_PRIORITIES(2i32);
pub const NVME_NVM_QUEUE_PRIORITY_URGENT: NVME_NVM_QUEUE_PRIORITIES =
    NVME_NVM_QUEUE_PRIORITIES(0i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const NVME_PERSISTENT_EVENT_TYPE_CHANGE_NAMESPACE: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(6i32);
pub const NVME_PERSISTENT_EVENT_TYPE_FIRMWARE_COMMIT: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(2i32);
pub const NVME_PERSISTENT_EVENT_TYPE_FORMAT_NVM_COMPLETION: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(8i32);
pub const NVME_PERSISTENT_EVENT_TYPE_FORMAT_NVM_START: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(7i32);
pub const NVME_PERSISTENT_EVENT_TYPE_MAX: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(255i32);
pub const NVME_PERSISTENT_EVENT_TYPE_NVM_SUBSYSTEM_HARDWARE_ERROR:
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES = NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(5i32);
pub const NVME_PERSISTENT_EVENT_TYPE_POWER_ON_OR_RESET: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(4i32);
pub const NVME_PERSISTENT_EVENT_TYPE_RESERVED0: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(0i32);
pub const NVME_PERSISTENT_EVENT_TYPE_RESERVED1_BEGIN: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(14i32);
pub const NVME_PERSISTENT_EVENT_TYPE_RESERVED1_END: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(221i32);
pub const NVME_PERSISTENT_EVENT_TYPE_RESERVED2_BEGIN: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(224i32);
pub const NVME_PERSISTENT_EVENT_TYPE_RESERVED2_END: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(255i32);
pub const NVME_PERSISTENT_EVENT_TYPE_SANITIZE_COMPLETION: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(10i32);
pub const NVME_PERSISTENT_EVENT_TYPE_SANITIZE_START: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(9i32);
pub const NVME_PERSISTENT_EVENT_TYPE_SET_FEATURE: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(11i32);
pub const NVME_PERSISTENT_EVENT_TYPE_SMART_HEALTH_LOG_SNAPSHOT:
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES = NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(1i32);
pub const NVME_PERSISTENT_EVENT_TYPE_TCG_DEFINED: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(223i32);
pub const NVME_PERSISTENT_EVENT_TYPE_TELEMETRY_LOG_CREATED: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(12i32);
pub const NVME_PERSISTENT_EVENT_TYPE_THERMAL_EXCURSION: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(13i32);
pub const NVME_PERSISTENT_EVENT_TYPE_TIMESTAMP_CHANGE: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(3i32);
pub const NVME_PERSISTENT_EVENT_TYPE_VENDOR_SPECIFIC_EVENT: NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES =
    NVME_PERSISTENT_EVENT_LOG_EVENT_TYPES(222i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const NVME_PROTECTION_INFORMATION_NOT_ENABLED: NVME_PROTECTION_INFORMATION_TYPES =
    NVME_PROTECTION_INFORMATION_TYPES(0i32);
pub const NVME_PROTECTION_INFORMATION_TYPE1: NVME_PROTECTION_INFORMATION_TYPES =
    NVME_PROTECTION_INFORMATION_TYPES(1i32);
pub const NVME_PROTECTION_INFORMATION_TYPE2: NVME_PROTECTION_INFORMATION_TYPES =
    NVME_PROTECTION_INFORMATION_TYPES(2i32);
pub const NVME_PROTECTION_INFORMATION_TYPE3: NVME_PROTECTION_INFORMATION_TYPES =
    NVME_PROTECTION_INFORMATION_TYPES(3i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NVME_RESERVATION_ACQUIRE_ACTION_ACQUIRE: NVME_RESERVATION_ACQUIRE_ACTIONS =
    NVME_RESERVATION_ACQUIRE_ACTIONS(0i32);
pub const NVME_RESERVATION_ACQUIRE_ACTION_PREEMPT: NVME_RESERVATION_ACQUIRE_ACTIONS =
    NVME_RESERVATION_ACQUIRE_ACTIONS(1i32);
pub const NVME_RESERVATION_ACQUIRE_ACTION_PREEMPT_AND_ABORT: NVME_RESERVATION_ACQUIRE_ACTIONS =
    NVME_RESERVATION_ACQUIRE_ACTIONS(2i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const NVME_RESERVATION_NOTIFICATION_TYPE_EMPTY_LOG_PAGE: NVME_RESERVATION_NOTIFICATION_TYPES =
    NVME_RESERVATION_NOTIFICATION_TYPES(0i32);
pub const NVME_RESERVATION_NOTIFICATION_TYPE_REGISTRATION_PREEMPTED:
    NVME_RESERVATION_NOTIFICATION_TYPES = NVME_RESERVATION_NOTIFICATION_TYPES(1i32);
pub const NVME_RESERVATION_NOTIFICATION_TYPE_REGISTRATION_RELEASED:
    NVME_RESERVATION_NOTIFICATION_TYPES = NVME_RESERVATION_NOTIFICATION_TYPES(2i32);
pub const NVME_RESERVATION_NOTIFICATION_TYPE_RESERVATION_PREEPMPTED:
    NVME_RESERVATION_NOTIFICATION_TYPES = NVME_RESERVATION_NOTIFICATION_TYPES(3i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_RESERVATION_REGISTER_ACTIONS(pub i32);
pub const NVME_RESERVATION_REGISTER_ACTION_REGISTER: NVME_RESERVATION_REGISTER_ACTIONS =
    NVME_RESERVATION_REGISTER_ACTIONS(0i32);
pub const NVME_RESERVATION_REGISTER_ACTION_REPLACE: NVME_RESERVATION_REGISTER_ACTIONS =
    NVME_RESERVATION_REGISTER_ACTIONS(2i32);
pub const NVME_RESERVATION_REGISTER_ACTION_UNREGISTER: NVME_RESERVATION_REGISTER_ACTIONS =
    NVME_RESERVATION_REGISTER_ACTIONS(1i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const NVME_RESERVATION_REGISTER_PTPL_STATE_NO_CHANGE:
    NVME_RESERVATION_REGISTER_PTPL_STATE_CHANGES =
    NVME_RESERVATION_REGISTER_PTPL_STATE_CHANGES(0i32);
pub const NVME_RESERVATION_REGISTER_PTPL_STATE_RESERVED:
    NVME_RESERVATION_REGISTER_PTPL_STATE_CHANGES =
    NVME_RESERVATION_REGISTER_PTPL_STATE_CHANGES(1i32);
pub const NVME_RESERVATION_REGISTER_PTPL_STATE_SET_TO_0:
    NVME_RESERVATION_REGISTER_PTPL_STATE_CHANGES =
    NVME_RESERVATION_REGISTER_PTPL_STATE_CHANGES(2i32);
pub const NVME_RESERVATION_REGISTER_PTPL_STATE_SET_TO_1:
    NVME_RESERVATION_REGISTER_PTPL_STATE_CHANGES =
    NVME_RESERVATION_REGISTER_PTPL_STATE_CHANGES(3i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_RESERVATION_RELEASE_ACTIONS(pub i32);
pub const NVME_RESERVATION_RELEASE_ACTION_CLEAR: NVME_RESERVATION_RELEASE_ACTIONS =
    NVME_RESERVATION_RELEASE_ACTIONS(1i32);
pub const NVME_RESERVATION_RELEASE_ACTION_RELEASE: NVME_RESERVATION_RELEASE_ACTIONS =
    NVME_RESERVATION_RELEASE_ACTIONS(0i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const NVME_RESERVATION_TYPE_EXCLUSIVE_ACCESS: NVME_RESERVATION_TYPES =
    NVME_RESERVATION_TYPES(2i32);
pub const NVME_RESERVATION_TYPE_EXCLUSIVE_ACCESS_ALL_REGISTRANTS: NVME_RESERVATION_TYPES =
    NVME_RESERVATION_TYPES(6i32);
pub const NVME_RESERVATION_TYPE_EXCLUSIVE_ACCESS_REGISTRANTS_ONLY: NVME_RESERVATION_TYPES =
    NVME_RESERVATION_TYPES(4i32);
pub const NVME_RESERVATION_TYPE_RESERVED: NVME_RESERVATION_TYPES = NVME_RESERVATION_TYPES(0i32);
pub const NVME_RESERVATION_TYPE_WRITE_EXCLUSIVE: NVME_RESERVATION_TYPES =
    NVME_RESERVATION_TYPES(1i32);
pub const NVME_RESERVATION_TYPE_WRITE_EXCLUSIVE_ALL_REGISTRANTS: NVME_RESERVATION_TYPES =
    NVME_RESERVATION_TYPES(5i32);
pub const NVME_RESERVATION_TYPE_WRITE_EXCLUSIVE_REGISTRANTS_ONLY: NVME_RESERVATION_TYPES =
...
pub const NVME_SANITIZE_ACTION_START_BLOCK_ERASE_SANITIZE: NVME_SANITIZE_ACTION =
    NVME_SANITIZE_ACTION(2i32);
pub const NVME_SANITIZE_ACTION_START_CRYPTO_ERASE_SANITIZE: NVME_SANITIZE_ACTION =
    NVME_SANITIZE_ACTION(4i32);
pub const NVME_SANITIZE_ACTION_START_OVERWRITE_SANITIZE: NVME_SANITIZE_ACTION =
    NVME_SANITIZE_ACTION(3i32);
pub const NVME_SANITIZE_OPERATION_FAILED: NVME_SANITIZE_OPERATION_STATUS =
    NVME_SANITIZE_OPERATION_STATUS(3i32);
pub const NVME_SANITIZE_OPERATION_IN_PROGRESS: NVME_SANITIZE_OPERATION_STATUS =
    NVME_SANITIZE_OPERATION_STATUS(2i32);
pub const NVME_SANITIZE_OPERATION_NONE: NVME_SANITIZE_OPERATION_STATUS =
    NVME_SANITIZE_OPERATION_STATUS(0i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_SANITIZE_OPERATION_STATUS(pub i32);
pub const NVME_SANITIZE_OPERATION_SUCCEEDED: NVME_SANITIZE_OPERATION_STATUS =
    NVME_SANITIZE_OPERATION_STATUS(1i32);
pub const NVME_SANITIZE_OPERATION_SUCCEEDED_WITH_FORCED_DEALLOCATION:
    NVME_SANITIZE_OPERATION_STATUS = NVME_SANITIZE_OPERATION_STATUS(4i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const NVME_SECURE_ERASE_CRYPTOGRAPHIC: NVME_SECURE_ERASE_SETTINGS =
    NVME_SECURE_ERASE_SETTINGS(2i32);
...
pub const NVME_SECURE_ERASE_USER_DATA: NVME_SECURE_ERASE_SETTINGS =
    NVME_SECURE_ERASE_SETTINGS(1i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const NVME_STATUS_ABORT_COMMAND_LIMIT_EXCEEDED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(3i32);
pub const NVME_STATUS_ANA_ATTACH_FAILED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(37i32);
pub const NVME_STATUS_ASYNC_EVENT_REQUEST_LIMIT_EXCEEDED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(5i32);
pub const NVME_STATUS_ATOMIC_WRITE_UNIT_EXCEEDED: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(20i32);
pub const NVME_STATUS_BOOT_PARTITION_WRITE_PROHIBITED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(30i32);
pub const NVME_STATUS_COMMAND_ABORTED_DUE_TO_FAILED_FUSED_COMMAND:
    NVME_STATUS_GENERIC_COMMAND_CODES = NVME_STATUS_GENERIC_COMMAND_CODES(9i32);
pub const NVME_STATUS_COMMAND_ABORTED_DUE_TO_FAILED_MISSING_COMMAND:
    NVME_STATUS_GENERIC_COMMAND_CODES = NVME_STATUS_GENERIC_COMMAND_CODES(10i32);
pub const NVME_STATUS_COMMAND_ABORTED_DUE_TO_POWER_LOSS_NOTIFICATION:
    NVME_STATUS_GENERIC_COMMAND_CODES = NVME_STATUS_GENERIC_COMMAND_CODES(5i32);
pub const NVME_STATUS_COMMAND_ABORTED_DUE_TO_PREEMPT_ABORT: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(27i32);
pub const NVME_STATUS_COMMAND_ABORTED_DUE_TO_SQ_DELETION: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(8i32);
pub const NVME_STATUS_COMMAND_ABORT_REQUESTED: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(7i32);
pub const NVME_STATUS_COMMAND_ID_CONFLICT: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(3i32);
pub const NVME_STATUS_COMMAND_SEQUENCE_ERROR: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(12i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_STATUS_COMMAND_SPECIFIC_CODES(pub i32);
pub const NVME_STATUS_COMPLETION_QUEUE_INVALID: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(0i32);
pub const NVME_STATUS_CONTROLLER_LIST_INVALID: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(28i32);
pub const NVME_STATUS_DATA_SGL_LENGTH_INVALID: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(15i32);
pub const NVME_STATUS_DATA_TRANSFER_ERROR: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(4i32);
pub const NVME_STATUS_DEVICE_SELF_TEST_IN_PROGRESS: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(29i32);
pub const NVME_STATUS_DIRECTIVE_ID_INVALID: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(113i32);
pub const NVME_STATUS_DIRECTIVE_TYPE_INVALID: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(112i32);
pub const NVME_STATUS_FEATURE_ID_NOT_SAVEABLE: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(13i32);
pub const NVME_STATUS_FEATURE_NOT_CHANGEABLE: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(14i32);
pub const NVME_STATUS_FEATURE_NOT_NAMESPACE_SPECIFIC: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(15i32);
pub const NVME_STATUS_FIRMWARE_ACTIVATION_PROHIBITED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(19i32);
pub const NVME_STATUS_FIRMWARE_ACTIVATION_REQUIRES_CONVENTIONAL_RESET:
    NVME_STATUS_COMMAND_SPECIFIC_CODES = NVME_STATUS_COMMAND_SPECIFIC_CODES(11i32);
pub const NVME_STATUS_FIRMWARE_ACTIVATION_REQUIRES_MAX_TIME_VIOLATION:
    NVME_STATUS_COMMAND_SPECIFIC_CODES = NVME_STATUS_COMMAND_SPECIFIC_CODES(18i32);
pub const NVME_STATUS_FIRMWARE_ACTIVATION_REQUIRES_NVM_SUBSYSTEM_RESET:
    NVME_STATUS_COMMAND_SPECIFIC_CODES = NVME_STATUS_COMMAND_SPECIFIC_CODES(16i32);
pub const NVME_STATUS_FIRMWARE_ACTIVATION_REQUIRES_RESET: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(17i32);
pub const NVME_STATUS_FORMAT_IN_PROGRESS: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(132i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_STATUS_GENERIC_COMMAND_CODES(pub i32);
pub const NVME_STATUS_HOST_IDENTIFIER_INCONSISTENT_FORMAT: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(24i32);
pub const NVME_STATUS_INTERNAL_DEVICE_ERROR: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(6i32);
pub const NVME_STATUS_INVALID_ANA_GROUP_IDENTIFIER: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(36i32);
pub const NVME_STATUS_INVALID_COMMAND_OPCODE: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(1i32);
pub const NVME_STATUS_INVALID_CONTROLLER_IDENTIFIER: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(31i32);
pub const NVME_STATUS_INVALID_FIELD_IN_COMMAND: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(2i32);
pub const NVME_STATUS_INVALID_FIRMWARE_IMAGE: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(7i32);
pub const NVME_STATUS_INVALID_FIRMWARE_SLOT: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(6i32);
pub const NVME_STATUS_INVALID_FORMAT: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(10i32);
pub const NVME_STATUS_INVALID_INTERRUPT_VECTOR: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(8i32);
pub const NVME_STATUS_INVALID_LOG_PAGE: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(9i32);
pub const NVME_STATUS_INVALID_NAMESPACE_OR_FORMAT: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(11i32);
pub const NVME_STATUS_INVALID_NUMBER_OF_CONTROLLER_RESOURCES: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(33i32);
pub const NVME_STATUS_INVALID_NUMBER_OF_SGL_DESCR: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(14i32);
pub const NVME_STATUS_INVALID_QUEUE_DELETION: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(12i32);
pub const NVME_STATUS_INVALID_QUEUE_IDENTIFIER: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(1i32);
pub const NVME_STATUS_INVALID_RESOURCE_IDENTIFIER: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(34i32);
pub const NVME_STATUS_INVALID_SECONDARY_CONTROLLER_STATE: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(32i32);
pub const NVME_STATUS_INVALID_SGL_LAST_SEGMENT_DESCR: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(13i32);
pub const NVME_STATUS_INVALID_USE_OF_CONTROLLER_MEMORY_BUFFER: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(18i32);
pub const NVME_STATUS_KEEP_ALIVE_TIMEOUT_EXPIRED: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(25i32);
pub const NVME_STATUS_KEEP_ALIVE_TIMEOUT_INVALID: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(26i32);
pub const NVME_STATUS_MAX_QUEUE_SIZE_EXCEEDED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_STATUS_MEDIA_ERROR_CODES(pub i32);
pub const NVME_STATUS_METADATA_SGL_LENGTH_INVALID: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(16i32);
pub const NVME_STATUS_NAMESPACE_ALREADY_ATTACHED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(24i32);
pub const NVME_STATUS_NAMESPACE_IDENTIFIER_UNAVAILABLE: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(22i32);
pub const NVME_STATUS_NAMESPACE_INSUFFICIENT_CAPACITY: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(21i32);
pub const NVME_STATUS_NAMESPACE_IS_PRIVATE: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(25i32);
pub const NVME_STATUS_NAMESPACE_NOT_ATTACHED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(26i32);
pub const NVME_STATUS_NAMESPACE_THIN_PROVISIONING_NOT_SUPPORTED:
    NVME_STATUS_COMMAND_SPECIFIC_CODES = NVME_STATUS_COMMAND_SPECIFIC_CODES(27i32);
pub const NVME_STATUS_NVM_ACCESS_DENIED: NVME_STATUS_MEDIA_ERROR_CODES =
    NVME_STATUS_MEDIA_ERROR_CODES(134i32);
pub const NVME_STATUS_NVM_ATTEMPTED_WRITE_TO_READ_ONLY_RANGE: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(130i32);
pub const NVME_STATUS_NVM_CAPACITY_EXCEEDED: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(129i32);
pub const NVME_STATUS_NVM_COMMAND_SIZE_LIMIT_EXCEEDED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(131i32);
pub const NVME_STATUS_NVM_COMPARE_FAILURE: NVME_STATUS_MEDIA_ERROR_CODES =
    NVME_STATUS_MEDIA_ERROR_CODES(133i32);
pub const NVME_STATUS_NVM_CONFLICTING_ATTRIBUTES: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(128i32);
pub const NVME_STATUS_NVM_DEALLOCATED_OR_UNWRITTEN_LOGICAL_BLOCK: NVME_STATUS_MEDIA_ERROR_CODES =
    NVME_STATUS_MEDIA_ERROR_CODES(135i32);
pub const NVME_STATUS_NVM_END_TO_END_APPLICATION_TAG_CHECK_ERROR: NVME_STATUS_MEDIA_ERROR_CODES =
    NVME_STATUS_MEDIA_ERROR_CODES(131i32);
pub const NVME_STATUS_NVM_END_TO_END_GUARD_CHECK_ERROR: NVME_STATUS_MEDIA_ERROR_CODES =
    NVME_STATUS_MEDIA_ERROR_CODES(130i32);
pub const NVME_STATUS_NVM_END_TO_END_REFERENCE_TAG_CHECK_ERROR: NVME_STATUS_MEDIA_ERROR_CODES =
    NVME_STATUS_MEDIA_ERROR_CODES(132i32);
pub const NVME_STATUS_NVM_INVALID_PROTECTION_INFORMATION: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(129i32);
pub const NVME_STATUS_NVM_LBA_OUT_OF_RANGE: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(128i32);
pub const NVME_STATUS_NVM_NAMESPACE_NOT_READY: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(130i32);
pub const NVME_STATUS_NVM_RESERVATION_CONFLICT: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(131i32);
pub const NVME_STATUS_NVM_UNRECOVERED_READ_ERROR: NVME_STATUS_MEDIA_ERROR_CODES =
    NVME_STATUS_MEDIA_ERROR_CODES(129i32);
pub const NVME_STATUS_NVM_WRITE_FAULT: NVME_STATUS_MEDIA_ERROR_CODES =
    NVME_STATUS_MEDIA_ERROR_CODES(128i32);
pub const NVME_STATUS_OPERATION_DENIED: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(21i32);
pub const NVME_STATUS_OVERLAPPING_RANGE: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(20i32);
pub const NVME_STATUS_PRP_OFFSET_INVALID: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(19i32);
pub const NVME_STATUS_RESERVED: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(23i32);
pub const NVME_STATUS_SANITIZE_FAILED: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(28i32);
pub const NVME_STATUS_SANITIZE_IN_PROGRESS: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(29i32);
pub const NVME_STATUS_SANITIZE_PROHIBITED_ON_PERSISTENT_MEMORY: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(35i32);
pub const NVME_STATUS_SGL_DATA_BLOCK_GRANULARITY_INVALID: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(30i32);
pub const NVME_STATUS_SGL_DESCR_TYPE_INVALID: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(17i32);
pub const NVME_STATUS_SGL_OFFSET_INVALID: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(22i32);
pub const NVME_STATUS_STREAM_RESOURCE_ALLOCATION_FAILED: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(127i32);
pub const NVME_STATUS_SUCCESS_COMPLETION: NVME_STATUS_GENERIC_COMMAND_CODES =
    NVME_STATUS_GENERIC_COMMAND_CODES(0i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NVME_STATUS_ZONE_BOUNDARY_ERROR: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(184i32);
pub const NVME_STATUS_ZONE_FULL: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(185i32);
pub const NVME_STATUS_ZONE_INVALID_FORMAT: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(127i32);
pub const NVME_STATUS_ZONE_INVALID_STATE_TRANSITION: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(191i32);
pub const NVME_STATUS_ZONE_INVALID_WRITE: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(188i32);
pub const NVME_STATUS_ZONE_OFFLINE: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(187i32);
pub const NVME_STATUS_ZONE_READ_ONLY: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(186i32);
pub const NVME_STATUS_ZONE_TOO_MANY_ACTIVE: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(189i32);
pub const NVME_STATUS_ZONE_TOO_MANY_OPEN: NVME_STATUS_COMMAND_SPECIFIC_CODES =
    NVME_STATUS_COMMAND_SPECIFIC_CODES(190i32);
...
pub const NVME_TEMPERATURE_OVER_THRESHOLD: NVME_TEMPERATURE_THRESHOLD_TYPES =
    NVME_TEMPERATURE_THRESHOLD_TYPES(0i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NVME_TEMPERATURE_THRESHOLD_TYPES(pub i32);
pub const NVME_TEMPERATURE_UNDER_THRESHOLD: NVME_TEMPERATURE_THRESHOLD_TYPES =
    NVME_TEMPERATURE_THRESHOLD_TYPES(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NVME_ZONE_RECEIVE_EXTENDED_REPORT_ZONES: NVME_ZONE_RECEIVE_ACTION =
    NVME_ZONE_RECEIVE_ACTION(1i32);
...
pub const NVME_ZRA_ALL_ZONES: NVME_ZONE_RECEIVE_ACTION_SPECIFIC =
    NVME_ZONE_RECEIVE_ACTION_SPECIFIC(0i32);
pub const NVME_ZRA_CLOSED_STATE_ZONES: NVME_ZONE_RECEIVE_ACTION_SPECIFIC =
    NVME_ZONE_RECEIVE_ACTION_SPECIFIC(4i32);
pub const NVME_ZRA_EMPTY_STATE_ZONES: NVME_ZONE_RECEIVE_ACTION_SPECIFIC =
    NVME_ZONE_RECEIVE_ACTION_SPECIFIC(1i32);
pub const NVME_ZRA_EO_STATE_ZONES: NVME_ZONE_RECEIVE_ACTION_SPECIFIC =
    NVME_ZONE_RECEIVE_ACTION_SPECIFIC(3i32);
pub const NVME_ZRA_FULL_STATE_ZONES: NVME_ZONE_RECEIVE_ACTION_SPECIFIC =
    NVME_ZONE_RECEIVE_ACTION_SPECIFIC(5i32);
pub const NVME_ZRA_IO_STATE_ZONES: NVME_ZONE_RECEIVE_ACTION_SPECIFIC =
    NVME_ZONE_RECEIVE_ACTION_SPECIFIC(2i32);
pub const NVME_ZRA_OFFLINE_STATE_ZONES: NVME_ZONE_RECEIVE_ACTION_SPECIFIC =
    NVME_ZONE_RECEIVE_ACTION_SPECIFIC(7i32);
pub const NVME_ZRA_RO_STATE_ZONES: NVME_ZONE_RECEIVE_ACTION_SPECIFIC =
    NVME_ZONE_RECEIVE_ACTION_SPECIFIC(6i32);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const NVMeDeviceRecovery1Max: NVME_WCS_DEVICE_RECOVERY_ACTION1 =
    NVME_WCS_DEVICE_RECOVERY_ACTION1(15i32);
pub const NVMeDeviceRecovery2Max: NVME_WCS_DEVICE_RECOVERY_ACTION2 =
    NVME_WCS_DEVICE_RECOVERY_ACTION2(15i32);
pub const NVMeDeviceRecoveryControllerReset: NVME_WCS_DEVICE_RECOVERY_ACTION2 =
    NVME_WCS_DEVICE_RECOVERY_ACTION2(0i32);
pub const NVMeDeviceRecoveryDeviceReplacement: NVME_WCS_DEVICE_RECOVERY_ACTION1 =
    NVME_WCS_DEVICE_RECOVERY_ACTION1(4i32);
pub const NVMeDeviceRecoveryFormatNVM: NVME_WCS_DEVICE_RECOVERY_ACTION1 =
    NVME_WCS_DEVICE_RECOVERY_ACTION1(1i32);
pub const NVMeDeviceRecoveryNoAction: NVME_WCS_DEVICE_RECOVERY_ACTION1 =
    NVME_WCS_DEVICE_RECOVERY_ACTION1(0i32);
pub const NVMeDeviceRecoveryPERST: NVME_WCS_DEVICE_RECOVERY_ACTION2 =
    NVME_WCS_DEVICE_RECOVERY_ACTION2(3i32);
pub const NVMeDeviceRecoveryPcieFunctionReset: NVME_WCS_DEVICE_RECOVERY_ACTION2 =
    NVME_WCS_DEVICE_RECOVERY_ACTION2(2i32);
pub const NVMeDeviceRecoveryPcieHotReset: NVME_WCS_DEVICE_RECOVERY_ACTION2 =
    NVME_WCS_DEVICE_RECOVERY_ACTION2(5i32);
pub const NVMeDeviceRecoveryPowerCycle: NVME_WCS_DEVICE_RECOVERY_ACTION2 =
    NVME_WCS_DEVICE_RECOVERY_ACTION2(4i32);
pub const NVMeDeviceRecoverySanitize: NVME_WCS_DEVICE_RECOVERY_ACTION1 =
    NVME_WCS_DEVICE_RECOVERY_ACTION1(5i32);
pub const NVMeDeviceRecoverySubsystemReset: NVME_WCS_DEVICE_RECOVERY_ACTION2 =
    NVME_WCS_DEVICE_RECOVERY_ACTION2(1i32);
pub const NVMeDeviceRecoveryVendorAnalysis: NVME_WCS_DEVICE_RECOVERY_ACTION1 =
    NVME_WCS_DEVICE_RECOVERY_ACTION1(3i32);
pub const NVMeDeviceRecoveryVendorSpecificCommand: NVME_WCS_DEVICE_RECOVERY_ACTION1 =
    NVME_WCS_DEVICE_RECOVERY_ACTION1(2i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]

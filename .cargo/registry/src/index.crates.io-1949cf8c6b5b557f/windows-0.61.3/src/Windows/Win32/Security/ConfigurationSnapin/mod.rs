...
pub const CCF_SCESVC_ATTACHMENT_DATA: windows_core::PCWSTR =
    windows_core::w!("CCF_SCESVC_ATTACHMENT_DATA");
windows_core::imp::define_interface!(
    ISceSvcAttachmentData,
    ISceSvcAttachmentData_Vtbl,
    0x17c35fde_200d_11d1_affb_00c04fb984f9
);
...
impl ISceSvcAttachmentData {
    pub unsafe fn GetData(
        &self,
        scesvchandle: *mut core::ffi::c_void,
    ...
    pub unsafe fn Initialize<P2>(
        &self,
        lpservicename: *mut i8,
        lptemplatename: *mut i8,
        lpscesvcpersistinfo: P2,
        pscesvchandle: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()>
    where
    ...
    pub unsafe fn CloseHandle(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).CloseHandle)(
                windows_core::Interface::as_raw(self),
                scesvchandle as _,
            )
            .ok()
...
pub struct ISceSvcAttachmentData_Vtbl {
    ...
    pub CloseHandle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait ISceSvcAttachmentData_Impl: windows_core::IUnknownImpl {
    ...
    fn Initialize(
        ...
        lpservicename: *mut i8,
        lptemplatename: *mut i8,
        lpscesvcpersistinfo: windows_core::Ref<'_, ISceSvcAttachmentPersistInfo>,
        pscesvchandle: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: ISceSvcAttachmentData_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                ISceSvcAttachmentData_Impl::GetData(
                    this,
                    core::mem::transmute_copy(&scesvchandle),
                    core::mem::transmute_copy(&scetype),
                    core::mem::transmute_copy(&ppvdata),
                    core::mem::transmute_copy(&psceenumhandle),
                )
                .into()
            }
        }
        ...
        >(
            ...
            lpservicename: *mut i8,
            lptemplatename: *mut i8,
            lpscesvcpersistinfo: *mut core::ffi::c_void,
            pscesvchandle: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISceSvcAttachmentData_Impl::Initialize(
                    this,
                    core::mem::transmute_copy(&lpservicename),
                    core::mem::transmute_copy(&lptemplatename),
                    core::mem::transmute_copy(&lpscesvcpersistinfo),
                    core::mem::transmute_copy(&pscesvchandle),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISceSvcAttachmentData_Impl::FreeBuffer(this, core::mem::transmute_copy(&pvdata))
                    .into()
            }
        }
        unsafe extern "system" fn CloseHandle<
            Identity: ISceSvcAttachmentData_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISceSvcAttachmentData_Impl::CloseHandle(
                    this,
                    core::mem::transmute_copy(&scesvchandle),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    0x6d90e0d0_200d_11d1_affb_00c04fb984f9
);
...
impl ISceSvcAttachmentPersistInfo {
    pub unsafe fn Save(
        &self,
        lptemplatename: *mut i8,
        scesvchandle: *mut *mut core::ffi::c_void,
        ppvdata: *mut *mut core::ffi::c_void,
        pboverwriteall: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub const fn new<Identity: ISceSvcAttachmentPersistInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISceSvcAttachmentPersistInfo_Impl::Save(
                    this,
                    core::mem::transmute_copy(&lptemplatename),
                    core::mem::transmute_copy(&scesvchandle),
                    core::mem::transmute_copy(&ppvdata),
                    core::mem::transmute_copy(&pboverwriteall),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISceSvcAttachmentPersistInfo_Impl::IsDirty(
                    this,
                    core::mem::transmute_copy(&lptemplatename),
                )
            }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISceSvcAttachmentPersistInfo_Impl::FreeBuffer(
                    this,
...
pub type PFSCE_FREE_INFO =
    Option<unsafe extern "system" fn(pvserviceinfo: *mut core::ffi::c_void) -> u32>;
pub type PFSCE_LOG_INFO = Option<
    unsafe extern "system" fn(errlevel: SCE_LOG_ERR_LEVEL, win32rc: u32, perrfmt: *mut i8) -> u32,
>;
pub type PFSCE_QUERY_INFO = Option<
    unsafe extern "system" fn(
        scehandle: *mut core::ffi::c_void,
        scetype: SCESVC_INFO_TYPE,
        lpprefix: *mut i8,
        bexact: windows_core::BOOL,
        ppvinfo: *mut *mut core::ffi::c_void,
        psceenumhandle: *mut u32,
    ) -> u32,
>;
pub type PFSCE_SET_INFO = Option<
    unsafe extern "system" fn(
        scehandle: *mut core::ffi::c_void,
        scetype: SCESVC_INFO_TYPE,
        lpprefix: *mut i8,
...
>;
pub type PF_ConfigAnalyzeService =
    Option<unsafe extern "system" fn(pscecbinfo: *mut SCESVC_CALLBACK_INFO) -> u32>;
pub type PF_UpdateService = Option<
    unsafe extern "system" fn(
        pscecbinfo: *mut SCESVC_CALLBACK_INFO,
...
pub const SCE_ROOT_PATH: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Windows NT\\CurrentVersion\\SeCEdit");
...
pub const cNodetypeSceAnalysisServices: windows_core::GUID =
    windows_core::GUID::from_u128(0x678050c7_1ff8_11d1_affb_00c04fb984f9);
pub const cNodetypeSceEventLog: windows_core::GUID =
    windows_core::GUID::from_u128(0x2ce06698_4bf3_11d1_8c30_00c04fb984f9);
pub const cNodetypeSceTemplateServices: windows_core::GUID =
    windows_core::GUID::from_u128(0x24a7f717_1f0c_11d1_affb_00c04fb984f9);
pub const lstruuidNodetypeSceAnalysisServices: windows_core::PCWSTR =
    windows_core::w!("{678050c7-1ff8-11d1-affb-00c04fb984f9}");
pub const lstruuidNodetypeSceEventLog: windows_core::PCWSTR =
    windows_core::w!("{2ce06698-4bf3-11d1-8c30-00c04fb984f9}");
pub const lstruuidNodetypeSceTemplateServices: windows_core::PCWSTR =
    windows_core::w!("{24a7f717-1f0c-11d1-affb-00c04fb984f9}");
pub const struuidNodetypeSceAnalysisServices: windows_core::PCSTR =
    windows_core::s!("{678050c7-1ff8-11d1-affb-00c04fb984f9}");
pub const struuidNodetypeSceEventLog: windows_core::PCSTR =
    windows_core::s!("{2ce06698-4bf3-11d1-8c30-00c04fb984f9}");
pub const struuidNodetypeSceTemplateServices: windows_core::PCSTR =
    windows_core::s!("{24a7f717-1f0c-11d1-affb-00c04fb984f9}");

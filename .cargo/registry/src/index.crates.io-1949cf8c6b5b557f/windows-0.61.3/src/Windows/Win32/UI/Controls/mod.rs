...
pub unsafe fn BeginBufferedAnimation(
    ...
    unsafe {
        BeginBufferedAnimation(
            ...
            prctarget,
            dwformat,
            ppaintparams.unwrap_or(core::mem::zeroed()) as _,
            panimationparams,
            phdcfrom as _,
            phdcto as _,
        )
...
pub unsafe fn BufferedPaintClear(
    ...
    prc: Option<*const super::super::Foundation::RECT>,
) -> windows_core::Result<()> {
...
pub unsafe fn BufferedPaintSetAlpha(
    ...
    unsafe {
        BufferedPaintSetAlpha(
            hbufferedpaint,
            prc.unwrap_or(core::mem::zeroed()) as _,
            alpha,
        )
        .ok()
    }
...
pub unsafe fn CreateMappedBitmap(
    ...
    let result__ = unsafe {
        CreateMappedBitmap(
            ...
            idbitmap,
            wflags,
            lpcolormap.unwrap_or(core::mem::zeroed()) as _,
            inummaps,
        )
    };
    (!result__.is_invalid())
...
#[inline]
pub unsafe fn CreateStatusWindowA<P1>(
    style: i32,
    lpsztext: P1,
...
) -> windows_core::Result<HSYNTHETICPOINTERDEVICE> {
...
pub unsafe fn DPA_DestroyCallback(
    ...
    unsafe {
        DPA_DestroyCallback(
            hdpa.unwrap_or(core::mem::zeroed()) as _,
            pfncb,
...
#[inline]
pub unsafe fn DPA_LoadStream<P2>(
    phdpa: *mut HDPA,
    pfn: PFNDPASTREAM,
    pstream: P2,
    pvinstdata: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()>
where
    P2: windows_core::Param<super::super::System::Com::IStream>,
{
    ...
    unsafe {
        DPA_LoadStream(
            ...
            pfn,
            pstream.param().abi(),
            pvinstdata.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn DPA_SaveStream<P2>(
    hdpa: HDPA,
    pfn: PFNDPASTREAM,
    pstream: P2,
    pvinstdata: Option<*const core::ffi::c_void>,
...
pub unsafe fn DPA_Search(
    hdpa: HDPA,
    pfind: Option<*const core::ffi::c_void>,
    istart: i32,
    pfncompare: PFNDACOMPARE,
    lparam: super::super::Foundation::LPARAM,
    options: u32,
    ...
    unsafe {
        DPA_Search(
            hdpa,
            pfind.unwrap_or(core::mem::zeroed()) as _,
            istart,
            pfncompare,
            lparam,
            options,
...
pub unsafe fn DPA_SetPtr(
    hdpa: HDPA,
    i: i32,
    p: Option<*const core::ffi::c_void>,
) -> windows_core::BOOL {
...
pub unsafe fn DSA_DestroyCallback(
    ...
    unsafe {
        DSA_DestroyCallback(
            hdsa.unwrap_or(core::mem::zeroed()) as _,
            pfncb,
            pdata.unwrap_or(core::mem::zeroed()) as _,
        )
    }
...
pub unsafe fn DlgDirSelectComboBoxExA(
    ...
    unsafe {
        DlgDirSelectComboBoxExA(
            hwnddlg,
            core::mem::transmute(lpstring.as_ptr()),
            lpstring.len().try_into().unwrap(),
            idcombobox,
        )
        .ok()
    }
...
pub unsafe fn DrawShadowText(
    ...
    dwflags: u32,
    crtext: super::super::Foundation::COLORREF,
    crshadow: super::super::Foundation::COLORREF,
    ixoffset: i32,
    iyoffset: i32,
) -> i32 {
...
pub unsafe fn DrawThemeBackground(
    ...
    pcliprect: Option<*const super::super::Foundation::RECT>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        DrawThemeBackground(
            ...
            istateid,
            prect,
            pcliprect.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn DrawThemeEdge(
    ...
    uedge: super::super::Graphics::Gdi::DRAWEDGE_FLAGS,
    uflags: super::super::Graphics::Gdi::DRAW_EDGE_FLAGS,
    pcontentrect: Option<*mut super::super::Foundation::RECT>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        DrawThemeEdge(
            ...
            uedge,
            uflags,
            pcontentrect.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn DrawThemeParentBackgroundEx(
    ...
    unsafe {
        DrawThemeParentBackgroundEx(hwnd, hdc, dwflags, prc.unwrap_or(core::mem::zeroed()) as _)
            .ok()
    }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub unsafe fn DrawThemeText(
    ...
    istateid: i32,
    psztext: &[u16],
    dwtextflags: super::super::Graphics::Gdi::DRAW_TEXT_FORMAT,
    dwtextflags2: u32,
    prect: *const super::super::Foundation::RECT,
) -> windows_core::Result<()> {
...
pub unsafe fn EvaluateProximityToPolygon(
    controlpolygon: &[super::super::Foundation::POINT],
    ...
    unsafe {
        EvaluateProximityToPolygon(
            controlpolygon.len().try_into().unwrap(),
            core::mem::transmute(controlpolygon.as_ptr()),
            phittestinginput,
            pproximityeval as _,
        )
        .ok()
...
pub unsafe fn EvaluateProximityToRect(
    ...
    unsafe {
        EvaluateProximityToRect(controlboundingbox, phittestinginput, pproximityeval as _).ok()
    }
}
#[inline]
...
pub unsafe fn GetCurrentThemeName(
    ...
    pszcolorbuff: Option<&mut [u16]>,
    pszsizebuff: Option<&mut [u16]>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        GetCurrentThemeName(
            core::mem::transmute(pszthemefilename.as_ptr()),
            pszthemefilename.len().try_into().unwrap(),
            core::mem::transmute(
                pszcolorbuff
                    .as_deref()
...
pub unsafe fn GetThemeAnimationProperty(
    ...
    pvproperty: Option<*mut core::ffi::c_void>,
    cbsize: u32,
    pcbsizeout: *mut u32,
) -> windows_core::Result<()> {
...
pub unsafe fn GetThemeAnimationTransform(
    ...
    ptransform: Option<*mut TA_TRANSFORM>,
    cbsize: u32,
    pcbsizeout: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        GetThemeAnimationTransform(
            ...
            itargetid,
            dwtransformindex,
            ptransform.unwrap_or(core::mem::zeroed()) as _,
            cbsize,
            pcbsizeout as _,
        )
        .ok()
...
pub unsafe fn GetThemeBackgroundRegion(
    ...
    istateid: i32,
    prect: *const super::super::Foundation::RECT,
) -> windows_core::Result<super::super::Graphics::Gdi::HRGN> {
...
pub unsafe fn GetThemeColor(
    ...
    istateid: i32,
    ipropid: THEME_PROPERTY_SYMBOL_ID,
) -> windows_core::Result<super::super::Foundation::COLORREF> {
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        GetThemeDocumentationProperty(
            pszthemename.param().abi(),
            pszpropertyname.param().abi(),
            core::mem::transmute(pszvaluebuff.as_ptr()),
            pszvaluebuff.len().try_into().unwrap(),
        )
        .ok()
    }
}
...
pub unsafe fn GetThemePosition(
    ...
    istateid: i32,
    ipropid: THEME_PROPERTY_SYMBOL_ID,
) -> windows_core::Result<super::super::Foundation::POINT> {
...
pub unsafe fn GetThemePropertyOrigin(
    ...
    istateid: i32,
    ipropid: i32,
) -> windows_core::Result<PROPERTYORIGIN> {
...
pub unsafe fn GetThemeStream(
    ...
    istateid: i32,
    ipropid: i32,
    ppvstream: *mut *mut core::ffi::c_void,
    pcbstream: Option<*mut u32>,
    hinst: Option<super::super::Foundation::HINSTANCE>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        GetThemeStream(
            ...
            ipropid,
            ppvstream as _,
            pcbstream.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn GetThemeString(
    ...
    unsafe {
        GetThemeString(
            ...
            istateid,
            ipropid,
            core::mem::transmute(pszbuff.as_ptr()),
            pszbuff.len().try_into().unwrap(),
        )
        .ok()
    }
}
#[inline]
pub unsafe fn GetThemeSysBool(
...
#[inline]
pub unsafe fn GetThemeSysColor(
    htheme: Option<HTHEME>,
    icolorid: i32,
...
pub unsafe fn GetThemeSysFont(
    ...
    unsafe {
        GetThemeSysFont(
            htheme.unwrap_or(core::mem::zeroed()) as _,
            ifontid.0 as _,
            plf as _,
        )
        .ok()
...
pub unsafe fn GetThemeSysString(
    ...
    unsafe {
        GetThemeSysString(
            htheme,
            istringid.0 as _,
            core::mem::transmute(pszstringbuff.as_ptr()),
            pszstringbuff.len().try_into().unwrap(),
        )
        .ok()
    }
}
...
pub unsafe fn GetThemeTextExtent(
    ...
    psztext: &[u16],
    dwtextflags: super::super::Graphics::Gdi::DRAW_TEXT_FORMAT,
    pboundingrect: Option<*const super::super::Foundation::RECT>,
) -> windows_core::Result<super::super::Foundation::RECT> {
    ...
    unsafe {
        ...
        GetThemeTextExtent(
            ...
            psztext.len().try_into().unwrap(),
            dwtextflags,
            pboundingrect.unwrap_or(core::mem::zeroed()) as _,
            &mut result__,
        )
        .map(|| result__)
    }
...
pub unsafe fn GetThemeTimingFunction(
    ...
    ptimingfunction: Option<*mut TA_TIMINGFUNCTION>,
    cbsize: u32,
    pcbsizeout: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        GetThemeTimingFunction(
            htheme,
            itimingfunctionid,
            ptimingfunction.unwrap_or(core::mem::zeroed()) as _,
            cbsize,
            pcbsizeout as _,
        )
        .ok()
...
pub unsafe fn GetWindowFeedbackSetting(
    ...
    dwflags: u32,
    psize: *mut u32,
    config: Option<*mut core::ffi::c_void>,
) -> windows_core::BOOL {
    ...
    unsafe {
        GetWindowFeedbackSetting(
            ...
            dwflags,
            psize as _,
            config.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn HitTestThemeBackground(
    ...
    prect: *const super::super::Foundation::RECT,
    hrgn: Option<super::super::Graphics::Gdi::HRGN>,
    ...
    unsafe {
        ...
        HitTestThemeBackground(
            ...
            dwoptions,
            prect,
            hrgn.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(pttest),
            &mut result__,
        )
        .map(|| result__)
    }
...
pub unsafe fn ImageList_Add(
    ...
    hbmmask: Option<super::super::Graphics::Gdi::HBITMAP>,
) -> i32 {
...
#[inline]
pub unsafe fn ImageList_BeginDrag(
...
#[inline]
pub unsafe fn ImageList_CoCreateInstance<P1, T>(
...
pub unsafe fn ImageList_DrawEx(
    ...
    dx: i32,
    dy: i32,
    rgbbk: super::super::Foundation::COLORREF,
    rgbfg: super::super::Foundation::COLORREF,
    fstyle: IMAGE_LIST_DRAW_STYLE,
) -> windows_core::BOOL {
...
pub unsafe fn ImageList_GetDragImage(
    ppt: Option<*mut super::super::Foundation::POINT>,
    ppthotspot: Option<*mut super::super::Foundation::POINT>,
) -> HIMAGELIST {
    ...
    unsafe {
        ImageList_GetDragImage(
            ppt.unwrap_or(core::mem::zeroed()) as _,
            ppthotspot.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn ImageList_GetIcon(
    himl: HIMAGELIST,
    i: i32,
...
#[inline]
pub unsafe fn ImageList_GetIconSize(
    himl: HIMAGELIST,
    cx: Option<*mut i32>,
    cy: Option<*mut i32>,
) -> windows_core::BOOL {
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ImageList_GetImageInfo(
    himl: HIMAGELIST,
    i: i32,
...
pub unsafe fn ImageList_Replace(
    ...
    unsafe {
        ImageList_Replace(
            ...
            i,
            hbmimage,
            hbmmask.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[inline]
pub unsafe fn ImageList_SetBkColor(
    himl: HIMAGELIST,
    clrbk: super::super::Foundation::COLORREF,
) -> super::super::Foundation::COLORREF {
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn ImageList_WriteEx<P2>(
    himl: HIMAGELIST,
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn LoadIconMetric<P1>(
    hinst: Option<super::super::Foundation::HINSTANCE>,
    pszname: P1,
    lims: _LI_METRIC,
) -> windows_core::Result<super::WindowsAndMessaging::HICON>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn LoadIconWithScaleDown<P1>(
    hinst: Option<super::super::Foundation::HINSTANCE>,
    pszname: P1,
    cx: i32,
    cy: i32,
...
#[inline]
pub unsafe fn OpenThemeData<P1>(
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        OpenThemeData(
            ...
            pszclasslist.param().abi(),
        )
    }
}
#[inline]
pub unsafe fn OpenThemeDataEx<P1>(
    hwnd: Option<super::super::Foundation::HWND>,
    pszclasslist: P1,
...
pub unsafe fn SetWindowFeedbackSetting(
    ...
    dwflags: u32,
    size: u32,
    configuration: Option<*const core::ffi::c_void>,
) -> windows_core::BOOL {
    ...
    unsafe {
        SetWindowFeedbackSetting(
            ...
            dwflags,
            size,
            configuration.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn TaskDialog<P2, P3, P4, P6>(
    ...
    P6: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        TaskDialog(
            ...
            pszwindowtitle.param().abi(),
            pszmaininstruction.param().abi(),
            pszcontent.param().abi(),
            dwcommonbuttons,
            pszicon.param().abi(),
...
pub const CDIS_SHOWKEYBOARDCUES: NMCUSTOMDRAW_DRAW_STATE_FLAGS =
    NMCUSTOMDRAW_DRAW_STATE_FLAGS(512u32);
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type DTT_CALLBACK_PROC = Option<
...
pub type EDITWORDBREAKPROCA = Option<
    unsafe extern "system" fn(
        lpch: windows_core::PCSTR,
        ichcurrent: i32,
        cch: i32,
        code: WORD_BREAK_ACTION,
    ) -> i32,
>;
pub type EDITWORDBREAKPROCW = Option<
    unsafe extern "system" fn(
        lpch: windows_core::PCWSTR,
        ichcurrent: i32,
        cch: i32,
        code: WORD_BREAK_ACTION,
    ) -> i32,
...
pub const HTTB_RESIZINGBORDER_BOTTOM: HIT_TEST_BACKGROUND_OPTIONS =
    HIT_TEST_BACKGROUND_OPTIONS(128u32);
pub const HTTB_RESIZINGBORDER_LEFT: HIT_TEST_BACKGROUND_OPTIONS =
    HIT_TEST_BACKGROUND_OPTIONS(16u32);
pub const HTTB_RESIZINGBORDER_RIGHT: HIT_TEST_BACKGROUND_OPTIONS =
    HIT_TEST_BACKGROUND_OPTIONS(64u32);
...
pub const HTTB_SYSTEMSIZINGMARGINS: HIT_TEST_BACKGROUND_OPTIONS =
    HIT_TEST_BACKGROUND_OPTIONS(512u32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl IImageList {
    ...
    pub unsafe fn ReplaceIcon(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReplaceIcon)(
                windows_core::Interface::as_raw(self),
                i,
                hicon,
                &mut result__,
    ...
    pub unsafe fn SetOverlayImage(&self, iimage: i32, ioverlay: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetOverlayImage)(
                windows_core::Interface::as_raw(self),
                iimage,
                ioverlay,
            )
    ...
    pub unsafe fn AddMasked(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AddMasked)(
                windows_core::Interface::as_raw(self),
                hbmimage,
                crmask,
                &mut result__,
    ...
    pub unsafe fn Remove(&self, i: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Remove)(windows_core::Interface::as_raw(self), i)
                .ok()
        }
    }
    #[cfg(feature = "Win32_UI_WindowsAndMessaging")]
    ...
    pub unsafe fn GetImageRect(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetImageRect)(
                windows_core::Interface::as_raw(self),
                i,
                &mut result__,
            )
    ...
    pub unsafe fn GetIconSize(&self, cx: *mut i32, cy: *mut i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetIconSize)(
                windows_core::Interface::as_raw(self),
                cx as _,
                cy as _,
            )
    ...
    pub unsafe fn SetIconSize(&self, cx: i32, cy: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetIconSize)(
                windows_core::Interface::as_raw(self),
                cx,
                cy,
            )
    ...
    pub unsafe fn SetImageCount(&self, unewcount: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetImageCount)(
                windows_core::Interface::as_raw(self),
                unewcount,
            )
            .ok()
    ...
    pub unsafe fn SetBkColor(
        &self,
        clrbk: super::super::Foundation::COLORREF,
    ) -> windows_core::Result<super::super::Foundation::COLORREF> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SetBkColor)(
                windows_core::Interface::as_raw(self),
                clrbk,
                &mut result__,
            )
    ...
    pub unsafe fn GetBkColor(&self) -> windows_core::Result<super::super::Foundation::COLORREF> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetBkColor)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn BeginDrag(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).BeginDrag)(
                windows_core::Interface::as_raw(self),
                itrack,
                dxhotspot,
                dyhotspot,
    ...
    pub unsafe fn EndDrag(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndDrag)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn DragEnter(
        &self,
        hwndlock: Option<super::super::Foundation::HWND>,
        x: i32,
        y: i32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DragEnter)(
                windows_core::Interface::as_raw(self),
                hwndlock.unwrap_or(core::mem::zeroed()) as _,
                x,
                y,
            )
            .ok()
    ...
    pub unsafe fn DragMove(&self, x: i32, y: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DragMove)(
                windows_core::Interface::as_raw(self),
                x,
                y,
            )
    ...
    pub unsafe fn SetDragCursorImage<P0>(
        &self,
        punk: P0,
        idrag: i32,
        dxhotspot: i32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetDragCursorImage)(
                windows_core::Interface::as_raw(self),
                punk.param().abi(),
                idrag,
                dxhotspot,
    ...
    pub unsafe fn DragShowNolock(&self, fshow: bool) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DragShowNolock)(
                windows_core::Interface::as_raw(self),
                fshow.into(),
            )
            .ok()
    ...
    pub unsafe fn GetDragImage(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetDragImage)(
                windows_core::Interface::as_raw(self),
                ppt.unwrap_or(core::mem::zeroed()) as _,
                ppthotspot.unwrap_or(core::mem::zeroed()) as _,
                riid,
    ...
    pub unsafe fn GetOverlayImage(&self, ioverlay: i32) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOverlayImage)(
                windows_core::Interface::as_raw(self),
                ioverlay,
                &mut result__,
            )
...
pub struct IImageList_Vtbl {
    ...
    Add: usize,
    #[cfg(feature = "Win32_UI_WindowsAndMessaging")]
    pub ReplaceIcon: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        super::WindowsAndMessaging::HICON,
        *mut i32,
    ...
    Replace: usize,
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub AddMasked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Graphics::Gdi::HBITMAP,
        super::super::Foundation::COLORREF,
        *mut i32,
    ...
    pub GetIcon: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        u32,
        *mut super::WindowsAndMessaging::HICON,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_UI_WindowsAndMessaging"))]
    GetIcon: usize,
    #[cfg(feature = "Win32_Graphics_Gdi")]
    ...
    pub GetImageRect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut super::super::Foundation::RECT,
    ) -> windows_core::HRESULT,
    pub GetIconSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut i32,
        *mut i32,
    ) -> windows_core::HRESULT,
    ...
    pub SetBkColor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::COLORREF,
        *mut super::super::Foundation::COLORREF,
    ) -> windows_core::HRESULT,
    pub GetBkColor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::COLORREF,
    ) -> windows_core::HRESULT,
    pub BeginDrag:
    ...
    pub DragMove:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, i32) -> windows_core::HRESULT,
    pub SetDragCursorImage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        i32,
    ...
    pub DragShowNolock: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub GetDragImage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub GetItemFlags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut IMAGE_LIST_ITEM_FLAGS,
    ) -> windows_core::HRESULT,
    pub GetOverlayImage:
...
pub trait IImageList_Impl: windows_core::IUnknownImpl {
    ...
    fn Copy(
        &self,
        idst: i32,
        punksrc: windows_core::Ref<'_, windows_core::IUnknown>,
        isrc: i32,
        uflags: u32,
    ) -> windows_core::Result<()>;
    fn Merge(
        &self,
        i1: i32,
        punk2: windows_core::Ref<'_, windows_core::IUnknown>,
        i2: i32,
        dx: i32,
        dy: i32,
        riid: *const windows_core::GUID,
...
impl IImageList_Vtbl {
    pub const fn new<Identity: IImageList_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Add<Identity: IImageList_Impl, const OFFSET: isize>(
            ...
            unsafe {
                ...
                match IImageList_Impl::Add(
                    this,
                    core::mem::transmute_copy(&hbmimage),
                    core::mem::transmute_copy(&hbmmask),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn ReplaceIcon<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            i: i32,
            hicon: super::WindowsAndMessaging::HICON,
            pi: *mut i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IImageList_Impl::ReplaceIcon(
                    this,
        ...
        unsafe extern "system" fn SetOverlayImage<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList_Impl::SetOverlayImage(
                    this,
                    core::mem::transmute_copy(&iimage),
                    core::mem::transmute_copy(&ioverlay),
                )
                .into()
            }
        }
        unsafe extern "system" fn Replace<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            i: i32,
            hbmimage: super::super::Graphics::Gdi::HBITMAP,
            hbmmask: super::super::Graphics::Gdi::HBITMAP,
        ...
        unsafe extern "system" fn AddMasked<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hbmimage: super::super::Graphics::Gdi::HBITMAP,
            crmask: super::super::Foundation::COLORREF,
            pi: *mut i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IImageList_Impl::AddMasked(
                    this,
                    core::mem::transmute_copy(&hbmimage),
        ...
        unsafe extern "system" fn Draw<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Remove<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            i: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetIcon<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            i: i32,
            flags: u32,
        ...
        unsafe extern "system" fn GetImageInfo<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            i: i32,
            pimageinfo: *mut IMAGEINFO,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList_Impl::GetImageInfo(
                    this,
                    core::mem::transmute_copy(&i),
                    core::mem::transmute_copy(&pimageinfo),
                )
                .into()
            }
        }
        unsafe extern "system" fn Copy<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            idst: i32,
            punksrc: *mut core::ffi::c_void,
            isrc: i32,
            uflags: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList_Impl::Copy(
                    this,
                    core::mem::transmute_copy(&idst),
                    core::mem::transmute_copy(&punksrc),
                    core::mem::transmute_copy(&isrc),
                    core::mem::transmute_copy(&uflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn Merge<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            i1: i32,
            punk2: *mut core::ffi::c_void,
            i2: i32,
            dx: i32,
            dy: i32,
            riid: *const windows_core::GUID,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList_Impl::Merge(
                    this,
                    core::mem::transmute_copy(&i1),
                    core::mem::transmute_copy(&punk2),
                    core::mem::transmute_copy(&i2),
        ...
        unsafe extern "system" fn Clone<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            riid: *const windows_core::GUID,
            ppv: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetImageRect<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            i: i32,
            prc: *mut super::super::Foundation::RECT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetIconSize<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            cx: *mut i32,
            cy: *mut i32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn SetIconSize<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            cx: i32,
            cy: i32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetImageCount<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pi: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetImageCount<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            unewcount: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetBkColor<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            clrbk: super::super::Foundation::COLORREF,
            pclr: *mut super::super::Foundation::COLORREF,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetBkColor<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pclr: *mut super::super::Foundation::COLORREF,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn BeginDrag<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            itrack: i32,
            dxhotspot: i32,
            dyhotspot: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList_Impl::BeginDrag(
                    this,
                    core::mem::transmute_copy(&itrack),
                    core::mem::transmute_copy(&dxhotspot),
                    core::mem::transmute_copy(&dyhotspot),
                )
                .into()
            }
        }
        unsafe extern "system" fn EndDrag<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn DragEnter<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hwndlock: super::super::Foundation::HWND,
            x: i32,
            y: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList_Impl::DragEnter(
                    this,
                    core::mem::transmute_copy(&hwndlock),
        ...
        unsafe extern "system" fn DragLeave<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hwndlock: super::super::Foundation::HWND,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn DragMove<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            x: i32,
            y: i32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn SetDragCursorImage<
            Identity: IImageList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList_Impl::SetDragCursorImage(
                    this,
                    core::mem::transmute_copy(&punk),
                    core::mem::transmute_copy(&idrag),
                    core::mem::transmute_copy(&dxhotspot),
                    core::mem::transmute_copy(&dyhotspot),
                )
                .into()
        ...
        unsafe extern "system" fn DragShowNolock<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetDragImage<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppt: *mut super::super::Foundation::POINT,
            ppthotspot: *mut super::super::Foundation::POINT,
            riid: *const windows_core::GUID,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList_Impl::GetDragImage(
                    this,
                    core::mem::transmute_copy(&ppt),
                    core::mem::transmute_copy(&ppthotspot),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppv),
                )
                .into()
        ...
        unsafe extern "system" fn GetItemFlags<Identity: IImageList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            i: i32,
        ...
        unsafe extern "system" fn GetOverlayImage<
            Identity: IImageList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IImageList2,
    IImageList2_Vtbl,
    0x192b9d83_50fc_457b_90a0_2b82a8b5dae1
);
...
impl IImageList2 {
    ...
    pub unsafe fn GetOriginalSize(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetOriginalSize)(
                windows_core::Interface::as_raw(self),
                iimage,
                dwflags,
                pcx as _,
    ...
    pub unsafe fn SetOriginalSize(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetOriginalSize)(
                windows_core::Interface::as_raw(self),
                iimage,
                cx,
                cy,
    ...
    pub unsafe fn GetCallback(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetCallback)(
                windows_core::Interface::as_raw(self),
                riid,
                ppv as _,
            )
    ...
    pub unsafe fn ForceImagePresent(&self, iimage: i32, dwflags: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ForceImagePresent)(
                windows_core::Interface::as_raw(self),
                iimage,
                dwflags,
            )
    ...
    pub unsafe fn DiscardImages(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DiscardImages)(
                windows_core::Interface::as_raw(self),
                ifirstimage,
                ilastimage,
                dwflags,
    ...
    pub unsafe fn PreloadImages(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).PreloadImages)(
                windows_core::Interface::as_raw(self),
                pimldp,
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Replace2)(
                windows_core::Interface::as_raw(self),
                i,
                hbmimage,
                hbmmask.unwrap_or(core::mem::zeroed()) as _,
    ...
    pub unsafe fn ReplaceFromImageList<P1, P3>(
        &self,
        i: i32,
        pil: P1,
        isrc: i32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ReplaceFromImageList)(
                windows_core::Interface::as_raw(self),
                i,
                pil.param().abi(),
                isrc,
...
pub struct IImageList2_Vtbl {
    ...
    pub Resize:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, i32) -> windows_core::HRESULT,
    pub GetOriginalSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        u32,
        *mut i32,
    ...
    pub GetCallback: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ForceImagePresent:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, u32) -> windows_core::HRESULT,
    pub DiscardImages:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, i32, u32) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub PreloadImages: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const IMAGELISTDRAWPARAMS,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Graphics_Gdi"))]
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub Replace2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        super::super::Graphics::Gdi::HBITMAP,
        super::super::Graphics::Gdi::HBITMAP,
    ...
    #[cfg(not(feature = "Win32_Graphics_Gdi"))]
    Replace2: usize,
    pub ReplaceFromImageList: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
        i32,
...
pub trait IImageList2_Impl: IImageList_Impl {
    ...
    fn ReplaceFromImageList(
        &self,
        i: i32,
        pil: windows_core::Ref<'_, IImageList>,
        isrc: i32,
        punk: windows_core::Ref<'_, windows_core::IUnknown>,
        dwflags: u32,
    ) -> windows_core::Result<()>;
...
impl IImageList2_Vtbl {
    pub const fn new<Identity: IImageList2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Resize<Identity: IImageList2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            cxnewiconsize: i32,
            cynewiconsize: i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList2_Impl::Resize(
                    this,
                    core::mem::transmute_copy(&cxnewiconsize),
                    core::mem::transmute_copy(&cynewiconsize),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetOriginalSize<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList2_Impl::GetOriginalSize(
                    this,
                    core::mem::transmute_copy(&iimage),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&pcx),
                    core::mem::transmute_copy(&pcy),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetOriginalSize<
            Identity: IImageList2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList2_Impl::SetOriginalSize(
                    this,
                    core::mem::transmute_copy(&iimage),
                    core::mem::transmute_copy(&cx),
                    core::mem::transmute_copy(&cy),
        ...
        unsafe extern "system" fn SetCallback<Identity: IImageList2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            punk: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetCallback<Identity: IImageList2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            riid: *const windows_core::GUID,
            ppv: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn ForceImagePresent<
            Identity: IImageList2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList2_Impl::ForceImagePresent(
                    this,
                    core::mem::transmute_copy(&iimage),
                    core::mem::transmute_copy(&dwflags),
                )
        ...
        unsafe extern "system" fn DiscardImages<Identity: IImageList2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ifirstimage: i32,
            ilastimage: i32,
            dwflags: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList2_Impl::DiscardImages(
                    this,
                    core::mem::transmute_copy(&ifirstimage),
                    core::mem::transmute_copy(&ilastimage),
                    core::mem::transmute_copy(&dwflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn PreloadImages<Identity: IImageList2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pimldp: *const IMAGELISTDRAWPARAMS,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetStatistics<Identity: IImageList2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Initialize<Identity: IImageList2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            cx: i32,
            cy: i32,
            flags: IMAGELIST_CREATION_FLAGS,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList2_Impl::Initialize(
                    this,
                    core::mem::transmute_copy(&cx),
                    core::mem::transmute_copy(&cy),
                    core::mem::transmute_copy(&flags),
                    core::mem::transmute_copy(&cinitial),
                    core::mem::transmute_copy(&cgrow),
                )
                .into()
            }
        }
        unsafe extern "system" fn Replace2<Identity: IImageList2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            i: i32,
            hbmimage: super::super::Graphics::Gdi::HBITMAP,
            hbmmask: super::super::Graphics::Gdi::HBITMAP,
        ...
        unsafe extern "system" fn ReplaceFromImageList<
            Identity: IImageList2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            i: i32,
            pil: *mut core::ffi::c_void,
            isrc: i32,
            punk: *mut core::ffi::c_void,
            dwflags: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IImageList2_Impl::ReplaceFromImageList(
                    this,
                    core::mem::transmute_copy(&i),
                    core::mem::transmute_copy(&pil),
                    core::mem::transmute_copy(&isrc),
                    core::mem::transmute_copy(&punk),
                    core::mem::transmute_copy(&dwflags),
                )
...
pub const ImageList: windows_core::GUID =
    windows_core::GUID::from_u128(0x7c476ba2_02b1_48f4_8048_b24619ddc058);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub type LPFNADDPROPSHEETPAGES = Option<
    unsafe extern "system" fn(
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type LPFNCCSIZETOTEXTA = Option<
    unsafe extern "system" fn(
        flstyle: u32,
        flextstyle: u32,
...
>;
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type LPFNCCSIZETOTEXTW = Option<
    unsafe extern "system" fn(
        flstyle: u32,
        flextstyle: u32,
        hfont: super::super::Graphics::Gdi::HFONT,
...
>;
pub type LPFNCCSTYLEA = Option<
    unsafe extern "system" fn(
        hwndparent: super::super::Foundation::HWND,
        pccs: *mut CCSTYLEA,
    ) -> windows_core::BOOL,
>;
pub type LPFNCCSTYLEW = Option<
    unsafe extern "system" fn(
        hwndparent: super::super::Foundation::HWND,
        pccs: *mut CCSTYLEW,
    ) -> windows_core::BOOL,
...
pub type LPFNPSPCALLBACKA = Option<
    unsafe extern "system" fn(
        hwnd: super::super::Foundation::HWND,
        umsg: PSPCB_MESSAGE,
...
pub type LPFNPSPCALLBACKW = Option<
    unsafe extern "system" fn(
        hwnd: super::super::Foundation::HWND,
        umsg: PSPCB_MESSAGE,
...
>;
pub type LPFNSVADDPROPSHEETPAGE = Option<
    unsafe extern "system" fn(
...
pub const LVBKIF_FLAG_ALPHABLEND: LIST_VIEW_BACKGROUND_IMAGE_FLAGS =
    LIST_VIEW_BACKGROUND_IMAGE_FLAGS(536870912u32);
pub const LVBKIF_FLAG_TILEOFFSET: LIST_VIEW_BACKGROUND_IMAGE_FLAGS =
    LIST_VIEW_BACKGROUND_IMAGE_FLAGS(256u32);
pub const LVBKIF_SOURCE_HBITMAP: LIST_VIEW_BACKGROUND_IMAGE_FLAGS =
    LIST_VIEW_BACKGROUND_IMAGE_FLAGS(1u32);
pub const LVBKIF_SOURCE_MASK: LIST_VIEW_BACKGROUND_IMAGE_FLAGS =
    LIST_VIEW_BACKGROUND_IMAGE_FLAGS(3u32);
pub const LVBKIF_SOURCE_NONE: LIST_VIEW_BACKGROUND_IMAGE_FLAGS =
    LIST_VIEW_BACKGROUND_IMAGE_FLAGS(0u32);
pub const LVBKIF_SOURCE_URL: LIST_VIEW_BACKGROUND_IMAGE_FLAGS =
    LIST_VIEW_BACKGROUND_IMAGE_FLAGS(2u32);
pub const LVBKIF_STYLE_MASK: LIST_VIEW_BACKGROUND_IMAGE_FLAGS =
    LIST_VIEW_BACKGROUND_IMAGE_FLAGS(16u32);
pub const LVBKIF_STYLE_NORMAL: LIST_VIEW_BACKGROUND_IMAGE_FLAGS =
    LIST_VIEW_BACKGROUND_IMAGE_FLAGS(0u32);
pub const LVBKIF_STYLE_TILE: LIST_VIEW_BACKGROUND_IMAGE_FLAGS =
    LIST_VIEW_BACKGROUND_IMAGE_FLAGS(16u32);
pub const LVBKIF_TYPE_WATERMARK: LIST_VIEW_BACKGROUND_IMAGE_FLAGS =
    LIST_VIEW_BACKGROUND_IMAGE_FLAGS(268435456u32);
#[repr(C)]
#[cfg(feature = "Win32_Graphics_Gdi")]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const LVCFMT_FILL: LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS =
    LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS(2097152i32);
...
pub const LVCFMT_LINE_BREAK: LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS =
    LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS(1048576i32);
pub const LVCFMT_NO_DPI_SCALE: LVCOLUMNW_FORMAT = LVCOLUMNW_FORMAT(262144i32);
pub const LVCFMT_NO_TITLE: LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS =
    LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS(8388608i32);
...
pub const LVCFMT_TILE_PLACEMENTMASK: LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS =
    LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS(3145728i32);
pub const LVCFMT_WRAP: LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS =
    LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS(4194304i32);
...
>;
pub type PFNDACOMPARECONST = Option<
    unsafe extern "system" fn(
        p1: *const core::ffi::c_void,
        p2: *const core::ffi::c_void,
        lparam: super::super::Foundation::LPARAM,
...
>;
pub type PFNDAENUMCALLBACK = Option<
    unsafe extern "system" fn(p: *const core::ffi::c_void, pdata: *const core::ffi::c_void) -> i32,
>;
pub type PFNDAENUMCALLBACKCONST = Option<
    unsafe extern "system" fn(p: *const core::ffi::c_void, pdata: *const core::ffi::c_void) -> i32,
>;
pub type PFNDPAMERGE = Option<
    unsafe extern "system" fn(
        umsg: DPAMM_MESSAGE,
        pvdest: *const core::ffi::c_void,
        pvsrc: *const core::ffi::c_void,
        lparam: super::super::Foundation::LPARAM,
    ) -> *mut core::ffi::c_void,
>;
pub type PFNDPAMERGECONST = Option<
    unsafe extern "system" fn(
        umsg: DPAMM_MESSAGE,
        pvdest: *const core::ffi::c_void,
        pvsrc: *const core::ffi::c_void,
...
>;
#[cfg(feature = "Win32_System_Com")]
pub type PFNDPASTREAM = Option<
    unsafe extern "system" fn(
        pinfo: *const DPASTREAMINFO,
        pstream: windows_core::Ref<'_, super::super::System::Com::IStream>,
        pvinstdata: *const core::ffi::c_void,
    ) -> windows_core::HRESULT,
>;
pub type PFNLVCOMPARE = Option<
    unsafe extern "system" fn(
...
>;
pub type PFNLVGROUPCOMPARE = Option<
    unsafe extern "system" fn(param0: i32, param1: i32, param2: *mut core::ffi::c_void) -> i32,
>;
pub type PFNPROPSHEETCALLBACK = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HWND,
        param1: u32,
        param2: super::super::Foundation::LPARAM,
...
pub const TDCBF_ABORT_BUTTON: TASKDIALOG_COMMON_BUTTON_FLAGS =
    TASKDIALOG_COMMON_BUTTON_FLAGS(65536i32);
...
pub const TDCBF_CONTINUE_BUTTON: TASKDIALOG_COMMON_BUTTON_FLAGS =
    TASKDIALOG_COMMON_BUTTON_FLAGS(524288i32);
pub const TDCBF_HELP_BUTTON: TASKDIALOG_COMMON_BUTTON_FLAGS =
    TASKDIALOG_COMMON_BUTTON_FLAGS(1048576i32);
pub const TDCBF_IGNORE_BUTTON: TASKDIALOG_COMMON_BUTTON_FLAGS =
    TASKDIALOG_COMMON_BUTTON_FLAGS(131072i32);
...
pub const TDCBF_TRYAGAIN_BUTTON: TASKDIALOG_COMMON_BUTTON_FLAGS =
    TASKDIALOG_COMMON_BUTTON_FLAGS(262144i32);
...
pub const VSCLASS_COMMUNICATIONSSTYLE: windows_core::PCWSTR =
    windows_core::w!("COMMUNICATIONSSTYLE");
...
pub const VSCLASS_TEXTSELECTIONGRIPPER: windows_core::PCWSTR =
    windows_core::w!("TEXTSELECTIONGRIPPER");

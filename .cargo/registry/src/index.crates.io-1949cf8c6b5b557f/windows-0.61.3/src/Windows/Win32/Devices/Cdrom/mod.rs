...
pub const CDDA: TRACK_MODE_TYPE = TRACK_MODE_TYPE(2i32);
...
pub const Cdrom10Nominal20Exceptions: CDROM_PERFORMANCE_TOLERANCE_TYPE =
    CDROM_PERFORMANCE_TOLERANCE_TYPE(1i32);
pub const CdromCAVRotation: WRITE_ROTATION = WRITE_ROTATION(1i32);
pub const CdromDefaultRotation: WRITE_ROTATION = WRITE_ROTATION(0i32);
pub const CdromEntirePerformanceList: CDROM_PERFORMANCE_EXCEPTION_TYPE =
    CDROM_PERFORMANCE_EXCEPTION_TYPE(2i32);
pub const CdromNominalPerformance: CDROM_PERFORMANCE_EXCEPTION_TYPE =
    CDROM_PERFORMANCE_EXCEPTION_TYPE(1i32);
pub const CdromPerformanceExceptionsOnly: CDROM_PERFORMANCE_EXCEPTION_TYPE =
    CDROM_PERFORMANCE_EXCEPTION_TYPE(3i32);
pub const CdromPerformanceRequest: CDROM_PERFORMANCE_REQUEST_TYPE =
    CDROM_PERFORMANCE_REQUEST_TYPE(1i32);
pub const CdromReadPerformance: CDROM_PERFORMANCE_TYPE = CDROM_PERFORMANCE_TYPE(1i32);
pub const CdromSetSpeed: CDROM_SPEED_REQUEST = CDROM_SPEED_REQUEST(0i32);
pub const CdromSetStreaming: CDROM_SPEED_REQUEST = CDROM_SPEED_REQUEST(1i32);
pub const CdromStreamingDisable: STREAMING_CONTROL_REQUEST_TYPE =
    STREAMING_CONTROL_REQUEST_TYPE(1i32);
pub const CdromStreamingEnableForReadOnly: STREAMING_CONTROL_REQUEST_TYPE =
    STREAMING_CONTROL_REQUEST_TYPE(2i32);
pub const CdromStreamingEnableForReadWrite: STREAMING_CONTROL_REQUEST_TYPE =
    STREAMING_CONTROL_REQUEST_TYPE(4i32);
pub const CdromStreamingEnableForWriteOnly: STREAMING_CONTROL_REQUEST_TYPE =
    STREAMING_CONTROL_REQUEST_TYPE(3i32);
pub const CdromWritePerformance: CDROM_PERFORMANCE_TYPE = CDROM_PERFORMANCE_TYPE(2i32);
pub const CdromWriteSpeedRequest: CDROM_PERFORMANCE_REQUEST_TYPE =
    CDROM_PERFORMANCE_REQUEST_TYPE(2i32);
pub const DIGITAL_COPY_PERMITTED: u32 = 2u32;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct EXCLUSIVE_ACCESS_REQUEST_TYPE(pub i32);
pub const ExclusiveAccessLockDevice: EXCLUSIVE_ACCESS_REQUEST_TYPE =
    EXCLUSIVE_ACCESS_REQUEST_TYPE(1i32);
pub const ExclusiveAccessQueryState: EXCLUSIVE_ACCESS_REQUEST_TYPE =
    EXCLUSIVE_ACCESS_REQUEST_TYPE(0i32);
pub const ExclusiveAccessUnlockDevice: EXCLUSIVE_ACCESS_REQUEST_TYPE =
    EXCLUSIVE_ACCESS_REQUEST_TYPE(2i32);
...
pub const MediaBlankTypeEraseLastSession: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(6i32);
pub const MediaBlankTypeFull: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(0i32);
pub const MediaBlankTypeIncompleteTrack: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(2i32);
pub const MediaBlankTypeMinimal: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(1i32);
pub const MediaBlankTypeTrackTail: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(4i32);
pub const MediaBlankTypeUncloseLastSession: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(5i32);
...
pub const XAForm2: TRACK_MODE_TYPE = TRACK_MODE_TYPE(1i32);
pub const YellowMode2: TRACK_MODE_TYPE = TRACK_MODE_TYPE(0i32);

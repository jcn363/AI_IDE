windows_core::imp::define_interface!(
    ...
    ICompositionCapabilitiesInteropFactory_Vtbl,
    0x2c9db356_e70d_4642_8298_bc4aa5b4865c
);
...
impl ICompositionCapabilitiesInteropFactory {
    ...
    ) -> windows_core::Result<super::super::super::super::UI::Composition::CompositionCapabilities>
    {
        unsafe {
...
impl ICompositionCapabilitiesInteropFactory_Vtbl {
    pub const fn new<Identity: ICompositionCapabilitiesInteropFactory_Impl, const OFFSET: isize>(
    ) -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                match ICompositionCapabilitiesInteropFactory_Impl::GetForWindow(
                    this,
...
impl ICompositionDrawingSurfaceInterop {
    pub unsafe fn BeginDraw<T>(
        &self,
        updaterect: Option<*const super::super::super::Foundation::RECT>,
        updateoffset: *mut super::super::super::Foundation::POINT,
    ...
    pub unsafe fn Resize(
        &self,
        sizepixels: super::super::super::Foundation::SIZE,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub unsafe fn Scroll(
        &self,
        scrollrect: Option<*const super::super::super::Foundation::RECT>,
        cliprect: Option<*const super::super::super::Foundation::RECT>,
        offsetx: i32,
        offsety: i32,
    ) -> windows_core::Result<()> {
        unsafe {
...
pub struct ICompositionDrawingSurfaceInterop_Vtbl {
    ...
    pub BeginDraw: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::super::super::Foundation::RECT,
...
pub trait ICompositionDrawingSurfaceInterop_Impl: windows_core::IUnknownImpl {
    ...
    fn Scroll(
        &self,
        scrollrect: *const super::super::super::Foundation::RECT,
        cliprect: *const super::super::super::Foundation::RECT,
        offsetx: i32,
        offsety: i32,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: ICompositionDrawingSurfaceInterop_Impl, const OFFSET: isize>() -> Self
    {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICompositionDrawingSurfaceInterop_Impl::BeginDraw(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICompositionDrawingSurfaceInterop_Impl::Resize(
                    this,
                    core::mem::transmute(&sizepixels),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICompositionDrawingSurfaceInterop_Impl::Scroll(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0x41e64aae_98c0_4239_8e95_a330dd6aa18b
);
...
impl ICompositionDrawingSurfaceInterop2 {
    pub unsafe fn CopySurface<P0>(
        &self,
        destinationresource: P0,
        destinationoffsetx: i32,
        destinationoffsety: i32,
        sourcerectangle: Option<*const super::super::super::Foundation::RECT>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).CopySurface)(
                windows_core::Interface::as_raw(self),
                destinationresource.param().abi(),
                destinationoffsetx,
                destinationoffsety,
...
pub struct ICompositionDrawingSurfaceInterop2_Vtbl {
    ...
    pub CopySurface: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        i32,
...
pub trait ICompositionDrawingSurfaceInterop2_Impl: ICompositionDrawingSurfaceInterop_Impl {
    fn CopySurface(
        &self,
        destinationresource: windows_core::Ref<'_, windows_core::IUnknown>,
        destinationoffsetx: i32,
        destinationoffsety: i32,
        sourcerectangle: *const super::super::super::Foundation::RECT,
    ) -> windows_core::Result<()>;
}
impl ICompositionDrawingSurfaceInterop2_Vtbl {
    pub const fn new<Identity: ICompositionDrawingSurfaceInterop2_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn CopySurface<
            Identity: ICompositionDrawingSurfaceInterop2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            destinationresource: *mut core::ffi::c_void,
            destinationoffsetx: i32,
            destinationoffsety: i32,
            sourcerectangle: *const super::super::super::Foundation::RECT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICompositionDrawingSurfaceInterop2_Impl::CopySurface(
                    this,
                    core::mem::transmute_copy(&destinationresource),
                    core::mem::transmute_copy(&destinationoffsetx),
                    core::mem::transmute_copy(&destinationoffsety),
                    core::mem::transmute_copy(&sourcerectangle),
                )
                .into()
            }
        }
        Self {
            base__: ICompositionDrawingSurfaceInterop_Vtbl::new::<Identity, OFFSET>(),
            CopySurface: CopySurface::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl ICompositionGraphicsDeviceInterop_Vtbl {
    ...
    {
        unsafe extern "system" fn GetRenderingDevice<
        ...
        unsafe extern "system" fn SetRenderingDevice<
            Identity: ICompositionGraphicsDeviceInterop_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICompositionGraphicsDeviceInterop_Impl::SetRenderingDevice(
                    this,
    ...
    pub const fn new<Identity: ICompositionTextureInterop_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICompositionTextureInterop_Impl::GetAvailableFence(
                    this,
...
impl ICompositorDesktopInterop {
    ...
    pub unsafe fn CreateDesktopWindowTarget(
        &self,
        hwndtarget: super::super::super::Foundation::HWND,
        istopmost: bool,
    ) -> windows_core::Result<
        super::super::super::super::UI::Composition::Desktop::DesktopWindowTarget,
    > {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnsureOnThread(&self, threadid: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EnsureOnThread)(
                windows_core::Interface::as_raw(self),
                threadid,
            )
            .ok()
...
impl ICompositorDesktopInterop_Vtbl {
    pub const fn new<Identity: ICompositorDesktopInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateDesktopWindowTarget<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICompositorDesktopInterop_Impl::CreateDesktopWindowTarget(
                    this,
                    core::mem::transmute_copy(&hwndtarget),
                    core::mem::transmute_copy(&istopmost),
                ) {
                    Ok(ok__) => {
                        result.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn EnsureOnThread<
            Identity: ICompositorDesktopInterop_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICompositorDesktopInterop_Impl::EnsureOnThread(
                    this,
...
impl ICompositorInterop {
    #[cfg(feature = "UI_Composition")]
    pub unsafe fn CreateCompositionSurfaceForHandle(
        &self,
        swapchain: super::super::super::Foundation::HANDLE,
    ) -> windows_core::Result<super::super::super::super::UI::Composition::ICompositionSurface>
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Composition")]
    pub unsafe fn CreateCompositionSurfaceForSwapChain<P0>(
        &self,
        swapchain: P0,
    ) -> windows_core::Result<super::super::super::super::UI::Composition::ICompositionSurface>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateCompositionSurfaceForSwapChain)(
                windows_core::Interface::as_raw(self),
                swapchain.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(feature = "UI_Composition")]
    pub unsafe fn CreateGraphicsDevice<P0>(
        &self,
        renderingdevice: P0,
    ) -> windows_core::Result<super::super::super::super::UI::Composition::CompositionGraphicsDevice>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
...
impl ICompositorInterop_Vtbl {
    pub const fn new<Identity: ICompositorInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateCompositionSurfaceForHandle<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICompositorInterop_Impl::CreateCompositionSurfaceForHandle(
                    this,
        ...
        unsafe extern "system" fn CreateCompositionSurfaceForSwapChain<
            Identity: ICompositorInterop_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICompositorInterop_Impl::CreateCompositionSurfaceForSwapChain(
                    this,
                    core::mem::transmute_copy(&swapchain),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICompositorInterop_Impl::CreateGraphicsDevice(
                    this,
        ...
        Self {
            ...
            CreateCompositionSurfaceForSwapChain: CreateCompositionSurfaceForSwapChain::<
                Identity,
                OFFSET,
            >,
...
windows_core::imp::define_interface!(
    ...
    0xd3eef34c_0667_4afc_8d13_867607b0fe91
);
...
impl ICompositorInterop2 {
    ...
    pub unsafe fn CreateCompositionTexture<P0>(
        &self,
        d3dtexture: P0,
    ) -> windows_core::Result<super::super::super::super::UI::Composition::CompositionTexture>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
    ...
    pub const fn new<Identity: ICompositorInterop2_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICompositorInterop2_Impl::CheckCompositionTextureSupport(
                    this,
                    core::mem::transmute_copy(&renderingdevice),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICompositorInterop2_Impl::CreateCompositionTexture(
                    this,
...
windows_core::imp::define_interface!(
    ...
    IDesktopWindowTargetInterop_Vtbl,
    0x35dbf59e_e3f9_45b0_81e7_fe75f4145dc9
);
...
impl IDesktopWindowTargetInterop {
    pub unsafe fn Hwnd(&self) -> windows_core::Result<super::super::super::Foundation::HWND> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Hwnd)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IDesktopWindowTargetInterop_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Hwnd: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IDesktopWindowTargetInterop_Vtbl {
    pub const fn new<Identity: IDesktopWindowTargetInterop_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            value: *mut super::super::super::Foundation::HWND,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVisualInteractionSourceInterop {
    ...
    pub unsafe fn TryRedirectForManipulation(
        &self,
        pointerinfo: *const super::super::super::UI::Input::Pointer::POINTER_INFO,
    ) -> windows_core::Result<()> {
        unsafe {
...
pub struct IVisualInteractionSourceInterop_Vtbl {
    ...
    pub TryRedirectForManipulation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::super::super::UI::Input::Pointer::POINTER_INFO,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(
        feature = "Win32_UI_Input_Pointer",
        feature = "Win32_UI_WindowsAndMessaging"
    ...
    pub const fn new<Identity: IVisualInteractionSourceInterop_Impl, const OFFSET: isize>() -> Self
    {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVisualInteractionSourceInterop_Impl::TryRedirectForManipulation(
                    this,

...
windows_core::imp::define_interface!(
    ...
    0x9f7d7bb7_20b3_11da_81a5_0030f1642e3c
);
...
impl IItemEnumerator_Vtbl {
    pub const fn new<Identity: IItemEnumerator_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Current<Identity: IItemEnumerator_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            item: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn MoveNext<Identity: IItemEnumerator_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            itemvalid: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Reset<Identity: IItemEnumerator_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    ...
    0x9f7d7bbd_20b3_11da_81a5_0030f1642e3c
);
...
impl ISettingsContext {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Deserialize<P0, P1>(
        &self,
        pstream: P0,
        ptarget: P1,
    ...
    pub unsafe fn SetUserData(
        &self,
        puserdata: *const core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetUserData)(
                windows_core::Interface::as_raw(self),
                puserdata,
            )
            .ok()
    ...
    pub unsafe fn GetStoredSettings<P0>(
        &self,
        pidentity: P0,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetStoredSettings)(
                windows_core::Interface::as_raw(self),
                pidentity.param().abi(),
                core::mem::transmute(ppaddedsettings),
                core::mem::transmute(ppmodifiedsettings),
                core::mem::transmute(ppdeletedsettings),
            )
            .ok()
        }
    }
    pub unsafe fn RevertSetting<P0, P1>(
        &self,
        pidentity: P0,
        pwzsetting: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RevertSetting)(
                windows_core::Interface::as_raw(self),
                pidentity.param().abi(),
                pwzsetting.param().abi(),
            )
            .ok()
        }
    }
...
pub struct ISettingsContext_Vtbl {
    ...
    #[cfg(not(feature = "Win32_System_Com"))]
    Deserialize: usize,
    pub SetUserData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub GetStoredSettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    pub RevertSetting: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
...
pub trait ISettingsContext_Impl: windows_core::IUnknownImpl {
    fn Serialize(
        ...
        ptarget: windows_core::Ref<'_, ITargetInfo>,
    ) -> windows_core::Result<()>;
    fn Deserialize(
        &self,
        pstream: windows_core::Ref<'_, super::Com::IStream>,
    ...
    fn GetStoredSettings(
        &self,
        pidentity: windows_core::Ref<'_, ISettingsIdentity>,
        ppaddedsettings: windows_core::OutRef<'_, IItemEnumerator>,
        ppmodifiedsettings: windows_core::OutRef<'_, IItemEnumerator>,
        ppdeletedsettings: windows_core::OutRef<'_, IItemEnumerator>,
    ) -> windows_core::Result<()>;
    fn RevertSetting(
        &self,
        pidentity: windows_core::Ref<'_, ISettingsIdentity>,
        pwzsetting: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
    ...
    pub const fn new<Identity: ISettingsContext_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISettingsContext_Impl::Serialize(
                    this,
        ...
        >(
            ...
            pstream: *mut core::ffi::c_void,
            ptarget: *mut core::ffi::c_void,
            pppresults: *mut *mut *mut core::ffi::c_void,
            pcresultcount: *mut usize,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsContext_Impl::Deserialize(
                    this,
                    core::mem::transmute_copy(&pstream),
                    core::mem::transmute_copy(&ptarget),
                    core::mem::transmute_copy(&pppresults),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SetUserData<
            Identity: ISettingsContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISettingsContext_Impl::SetUserData(this, core::mem::transmute_copy(&puserdata))
                    .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            ppnamespaceids: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            pidentity: *mut core::ffi::c_void,
            ppaddedsettings: *mut *mut core::ffi::c_void,
            ppmodifiedsettings: *mut *mut core::ffi::c_void,
            ppdeletedsettings: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISettingsContext_Impl::GetStoredSettings(
                    this,
                    core::mem::transmute_copy(&pidentity),
                    core::mem::transmute_copy(&ppaddedsettings),
                    core::mem::transmute_copy(&ppmodifiedsettings),
                    core::mem::transmute_copy(&ppdeletedsettings),
                )
                .into()
            }
        }
        unsafe extern "system" fn RevertSetting<
            Identity: ISettingsContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISettingsContext_Impl::RevertSetting(
                    this,
                    core::mem::transmute_copy(&pidentity),
                    core::mem::transmute(&pwzsetting),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x9f7d7bb9_20b3_11da_81a5_0030f1642e3c
);
...
impl ISettingsEngine {
    ...
    ) -> windows_core::Result<IItemEnumerator> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNamespaces)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn GetNamespace<P0>(
        &self,
        settingsid: P0,
        access: WcmNamespaceAccess,
        reserved: *const core::ffi::c_void,
    ) -> windows_core::Result<ISettingsNamespace>
    where
        P0: windows_core::Param<ISettingsIdentity>,
    {
        unsafe {
    ...
    pub unsafe fn CreateSettingsIdentity(&self) -> windows_core::Result<ISettingsIdentity> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSettingsIdentity)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetStoreStatus(
        &self,
        reserved: *const core::ffi::c_void,
    ) -> windows_core::Result<WcmUserStatus> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStoreStatus)(
                windows_core::Interface::as_raw(self),
                reserved,
                &mut result__,
            )
    ...
    pub unsafe fn LoadStore(&self, flags: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).LoadStore)(
                windows_core::Interface::as_raw(self),
                flags,
            )
            .ok()
    ...
    pub unsafe fn UnloadStore(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).UnloadStore)(
                windows_core::Interface::as_raw(self),
                reserved,
            )
            .ok()
    ...
    pub unsafe fn RegisterNamespace<P0, P1>(
        &self,
        settingsid: P0,
        stream: P1,
        pushsettings: bool,
    ...
    pub unsafe fn UnregisterNamespace<P0>(
        &self,
        settingsid: P0,
        removesettings: bool,
    ) -> windows_core::Result<()>
    ...
    pub unsafe fn CreateTargetInfo(&self) -> windows_core::Result<ITargetInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTargetInfo)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetTargetInfo(&self) -> windows_core::Result<ITargetInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTargetInfo)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetTargetInfo)(
                windows_core::Interface::as_raw(self),
                target.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn CreateSettingsContext(
        ...
        flags: u32,
        reserved: *const core::ffi::c_void,
    ) -> windows_core::Result<ISettingsContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSettingsContext)(
                windows_core::Interface::as_raw(self),
                flags,
                reserved,
                &mut result__,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetSettingsContext)(
                windows_core::Interface::as_raw(self),
                settingscontext.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn ApplySettingsContext<P0>(
        &self,
        settingscontext: P0,
        pppwzidentities: *mut *mut windows_core::PWSTR,
    ) -> windows_core::Result<usize>
    where
        P0: windows_core::Param<ISettingsContext>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ApplySettingsContext)(
                windows_core::Interface::as_raw(self),
                settingscontext.param().abi(),
                pppwzidentities as _,
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub unsafe fn GetSettingsContext(&self) -> windows_core::Result<ISettingsContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSettingsContext)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ISettingsEngine_Vtbl {
    ...
    pub CreateSettingsIdentity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetStoreStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        *mut WcmUserStatus,
    ) -> windows_core::HRESULT,
    pub LoadStore: unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub UnloadStore: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(
    ...
    pub CreateTargetInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetTargetInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetTargetInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateSettingsContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetSettingsContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ApplySettingsContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut windows_core::PWSTR,
        *mut usize,
    ) -> windows_core::HRESULT,
    pub GetSettingsContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub trait ISettingsEngine_Impl: windows_core::IUnknownImpl {
    ...
    fn GetNamespace(
        &self,
        settingsid: windows_core::Ref<'_, ISettingsIdentity>,
        access: WcmNamespaceAccess,
        reserved: *const core::ffi::c_void,
    ) -> windows_core::Result<ISettingsNamespace>;
    ...
    fn RegisterNamespace(
        &self,
        settingsid: windows_core::Ref<'_, ISettingsIdentity>,
        stream: windows_core::Ref<'_, super::Com::IStream>,
        pushsettings: windows_core::BOOL,
    ) -> windows_core::Result<super::Variant::VARIANT>;
    fn UnregisterNamespace(
        &self,
        settingsid: windows_core::Ref<'_, ISettingsIdentity>,
        removesettings: windows_core::BOOL,
    ) -> windows_core::Result<()>;
    fn CreateTargetInfo(&self) -> windows_core::Result<ITargetInfo>;
    fn GetTargetInfo(&self) -> windows_core::Result<ITargetInfo>;
    fn SetTargetInfo(&self, target: windows_core::Ref<'_, ITargetInfo>)
        -> windows_core::Result<()>;
    ...
    fn SetSettingsContext(
        &self,
        settingscontext: windows_core::Ref<'_, ISettingsContext>,
    ) -> windows_core::Result<()>;
...
impl ISettingsEngine_Vtbl {
    pub const fn new<Identity: ISettingsEngine_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            flags: WcmNamespaceEnumerationFlags,
            reserved: *const core::ffi::c_void,
            namespaces: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsEngine_Impl::GetNamespaces(
                    this,
        ...
        >(
            this: *mut core::ffi::c_void,
            settingsid: *mut core::ffi::c_void,
            access: WcmNamespaceAccess,
            reserved: *const core::ffi::c_void,
            namespaceitem: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsEngine_Impl::GetNamespace(
                    this,
                    core::mem::transmute_copy(&settingsid),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsEngine_Impl::GetErrorDescription(
                    this,
        ...
        unsafe extern "system" fn CreateSettingsIdentity<
            Identity: ISettingsEngine_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            settingsid: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetStoreStatus<
            Identity: ISettingsEngine_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsEngine_Impl::GetStoreStatus(
                    this,
                    core::mem::transmute_copy(&reserved),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn LoadStore<Identity: ISettingsEngine_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            flags: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn UnloadStore<
            Identity: ISettingsEngine_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            pushsettings: windows_core::BOOL,
            results: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsEngine_Impl::RegisterNamespace(
                    this,
                    core::mem::transmute_copy(&settingsid),
                    core::mem::transmute_copy(&stream),
                    core::mem::transmute_copy(&pushsettings),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISettingsEngine_Impl::UnregisterNamespace(
                    this,
                    core::mem::transmute_copy(&settingsid),
                    core::mem::transmute_copy(&removesettings),
                )
                .into()
            }
        }
        unsafe extern "system" fn CreateTargetInfo<
            Identity: ISettingsEngine_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetTargetInfo<
            Identity: ISettingsEngine_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetTargetInfo<
            Identity: ISettingsEngine_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CreateSettingsContext<
            Identity: ISettingsEngine_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            flags: u32,
            reserved: *const core::ffi::c_void,
            settingscontext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsEngine_Impl::CreateSettingsContext(
                    this,
                    core::mem::transmute_copy(&flags),
                    core::mem::transmute_copy(&reserved),
                ) {
        ...
        unsafe extern "system" fn SetSettingsContext<
            Identity: ISettingsEngine_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            settingscontext: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISettingsEngine_Impl::SetSettingsContext(
                    this,
                    core::mem::transmute_copy(&settingscontext),
                )
                .into()
            }
        }
        unsafe extern "system" fn ApplySettingsContext<
            Identity: ISettingsEngine_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsEngine_Impl::ApplySettingsContext(
                    this,
                    core::mem::transmute_copy(&settingscontext),
                    core::mem::transmute_copy(&pppwzidentities),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetSettingsContext<
            Identity: ISettingsEngine_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl ISettingsIdentity {
    ...
    pub unsafe fn SetAttribute<P1, P2>(
        &self,
        reserved: *const core::ffi::c_void,
        name: P1,
        value: P2,
    ...
    pub const fn new<Identity: ISettingsIdentity_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsIdentity_Impl::GetAttribute(
                    this,
                    core::mem::transmute_copy(&reserved),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISettingsIdentity_Impl::SetAttribute(
                    this,
                    core::mem::transmute_copy(&reserved),
                    core::mem::transmute(&name),
...
windows_core::imp::define_interface!(
    ISettingsItem,
    ISettingsItem_Vtbl,
    0x9f7d7bbb_20b3_11da_81a5_0030f1642e3c
);
...
impl ISettingsItem {
    ...
    pub unsafe fn SetValue(
        &self,
        value: *const super::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub unsafe fn GetSettingType(&self) -> windows_core::Result<WcmSettingType> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSettingType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetDataType(&self) -> windows_core::Result<WcmDataType> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDataType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetValueRaw(&self, data: *mut *mut u8) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetValueRaw)(
                windows_core::Interface::as_raw(self),
                data as _,
                &mut result__,
            )
    ...
    pub unsafe fn SetValueRaw(&self, datatype: i32, data: &[u8]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetValueRaw)(
                windows_core::Interface::as_raw(self),
                datatype,
    ...
    pub unsafe fn HasChild(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).HasChild)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSettingByPath)(
                windows_core::Interface::as_raw(self),
                path.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSettingByPath)(
                windows_core::Interface::as_raw(self),
                path.param().abi(),
                &mut result__,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveSettingByPath)(
                windows_core::Interface::as_raw(self),
                path.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn GetListKeyInformation(
        &self,
        keyname: *mut windows_core::BSTR,
    ) -> windows_core::Result<WcmDataType> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetListKeyInformation)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(keyname),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub unsafe fn CreateListElement(
        &self,
        keydata: *const super::Variant::VARIANT,
    ) -> windows_core::Result<ISettingsItem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateListElement)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(keydata),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveListElement)(
                windows_core::Interface::as_raw(self),
                elementname.param().abi(),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn GetRestrictionFacets(&self) -> windows_core::Result<WcmRestrictionFacets> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRestrictionFacets)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetRestriction(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRestriction)(
                windows_core::Interface::as_raw(self),
                restrictionfacet,
                &mut result__,
            )
...
pub struct ISettingsItem_Vtbl {
    ...
    SetValue: usize,
    pub GetSettingType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WcmSettingType,
    ) -> windows_core::HRESULT,
    pub GetDataType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WcmDataType,
    ) -> windows_core::HRESULT,
    pub GetValueRaw: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub SetValueRaw: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *const u8,
        u32,
    ) -> windows_core::HRESULT,
    pub HasChild: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    ...
    pub GetSettingByPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateSettingByPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RemoveSettingByPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetListKeyInformation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
        *mut WcmDataType,
    ) -> windows_core::HRESULT,
    ...
    pub CreateListElement: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub RemoveListElement: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    ...
    pub GetRestrictionFacets: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WcmRestrictionFacets,
    ) -> windows_core::HRESULT,
    #[cfg(all(
        feature = "Win32_System_Com",
        feature = "Win32_System_Ole",
    ...
    pub GetRestriction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl ISettingsItem_Vtbl {
    pub const fn new<Identity: ISettingsItem_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetName<Identity: ISettingsItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetValue<Identity: ISettingsItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetValue<Identity: ISettingsItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *const super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetSettingType<
        ...
        unsafe extern "system" fn GetDataType<Identity: ISettingsItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetValueRaw<Identity: ISettingsItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            data: *mut *mut u8,
            datasize: *mut u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn SetValueRaw<Identity: ISettingsItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            datatype: i32,
            data: *const u8,
            datasize: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISettingsItem_Impl::SetValueRaw(
                    this,
        ...
        unsafe extern "system" fn HasChild<Identity: ISettingsItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            itemhaschild: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Children<Identity: ISettingsItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetChild<Identity: ISettingsItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            name: windows_core::PCWSTR,
        ...
        unsafe extern "system" fn GetSettingByPath<
            Identity: ISettingsItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            path: windows_core::PCWSTR,
            setting: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateSettingByPath<
            Identity: ISettingsItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn RemoveSettingByPath<
            Identity: ISettingsItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetListKeyInformation<
            Identity: ISettingsItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            keyname: *mut *mut core::ffi::c_void,
            datatype: *mut WcmDataType,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsItem_Impl::GetListKeyInformation(
                    this,
        ...
        unsafe extern "system" fn CreateListElement<
            Identity: ISettingsItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsItem_Impl::CreateListElement(
                    this,
                    core::mem::transmute_copy(&keydata),
                ) {
                    Ok(ok__) => {
                        child.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn RemoveListElement<
            Identity: ISettingsItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            elementname: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISettingsItem_Impl::RemoveListElement(this, core::mem::transmute(&elementname))
                    .into()
            }
        }
        unsafe extern "system" fn Attributes<Identity: ISettingsItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            attributes: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetPath<Identity: ISettingsItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetRestrictionFacets<
            Identity: ISettingsItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetRestriction<
            Identity: ISettingsItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            restrictionfacet: WcmRestrictionFacets,
            facetdata: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsItem_Impl::GetRestriction(
                    this,
                    core::mem::transmute_copy(&restrictionfacet),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetKeyValue<Identity: ISettingsItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    ...
    0x9f7d7bba_20b3_11da_81a5_0030f1642e3c
);
...
impl ISettingsNamespace_Vtbl {
    pub const fn new<Identity: ISettingsNamespace_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Save<Identity: ISettingsNamespace_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pushsettings: windows_core::BOOL,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISettingsNamespace_Impl::CreateSettingByPath(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISettingsNamespace_Impl::RemoveSettingByPath(this, core::mem::transmute(&path))
                    .into()
            }
        }
        unsafe extern "system" fn GetAttribute<
...
windows_core::imp::define_interface!(
    ...
    0x9f7d7bbc_20b3_11da_81a5_0030f1642e3c
);
...
impl ISettingsResult {
    ...
    pub unsafe fn GetErrorCode(&self) -> windows_core::Result<windows_core::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetErrorCode)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetLine(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLine)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct ISettingsResult_Vtbl {
    ...
    pub GetErrorCode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl ISettingsResult_Vtbl {
    pub const fn new<Identity: ISettingsResult_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetErrorCode<
            Identity: ISettingsResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            hrout: *mut windows_core::HRESULT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetLine<Identity: ISettingsResult_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwline: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetColumn<Identity: ISettingsResult_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwcolumn: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetSource<Identity: ISettingsResult_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ITargetInfo,
    ITargetInfo_Vtbl,
    0x9f7d7bb8_20b3_11da_81a5_0030f1642e3c
);
...
impl ITargetInfo {
    ...
    pub unsafe fn SetTargetMode(&self, targetmode: WcmTargetMode) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTargetMode)(
                windows_core::Interface::as_raw(self),
                targetmode,
            )
            .ok()
    ...
    pub unsafe fn GetTemporaryStoreLocation(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTemporaryStoreLocation)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetTemporaryStoreLocation<P0>(
        &self,
        temporarystorelocation: P0,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetTemporaryStoreLocation)(
                windows_core::Interface::as_raw(self),
                temporarystorelocation.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn GetTargetID(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTargetID)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetTargetID(&self, targetid: windows_core::GUID) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTargetID)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn GetTargetProcessorArchitecture(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTargetProcessorArchitecture)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetTargetProcessorArchitecture<P0>(
        &self,
        processorarchitecture: P0,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetTargetProcessorArchitecture)(
                windows_core::Interface::as_raw(self),
                processorarchitecture.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn GetProperty<P1>(
        &self,
        offline: bool,
        property: P1,
    ) -> windows_core::Result<windows_core::BSTR>
    ...
    pub unsafe fn SetProperty<P1, P2>(
        &self,
        offline: bool,
        property: P1,
        value: P2,
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExpandTarget)(
                windows_core::Interface::as_raw(self),
                offline.into(),
                location.param().abi(),
                &mut result__,
    ...
    pub unsafe fn ExpandTargetPath<P1>(
        &self,
        offline: bool,
        location: P1,
    ) -> windows_core::Result<windows_core::BSTR>
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExpandTargetPath)(
                windows_core::Interface::as_raw(self),
                offline.into(),
                location.param().abi(),
                &mut result__,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetModulePath)(
                windows_core::Interface::as_raw(self),
                module.param().abi(),
                path.param().abi(),
            )
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LoadModule)(
                windows_core::Interface::as_raw(self),
                module.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn SetWow64Context<P0>(
        &self,
        installermodule: P0,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetWow64Context)(
                windows_core::Interface::as_raw(self),
                installermodule.param().abi(),
                wow64context,
            )
            .ok()
        }
    }
    pub unsafe fn TranslateWow64<P0, P1>(
        &self,
        clientarchitecture: P0,
        value: P1,
    ) -> windows_core::Result<windows_core::BSTR>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TranslateWow64)(
                windows_core::Interface::as_raw(self),
                clientarchitecture.param().abi(),
                value.param().abi(),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetSchemaHiveLocation)(
                windows_core::Interface::as_raw(self),
                pwzhivedir.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn GetSchemaHiveLocation(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSchemaHiveLocation)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetSchemaHiveMountName)(
                windows_core::Interface::as_raw(self),
                pwzmountname.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn GetSchemaHiveMountName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSchemaHiveMountName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct ITargetInfo_Vtbl {
    ...
    pub SetTargetMode:
        unsafe extern "system" fn(*mut core::ffi::c_void, WcmTargetMode) -> windows_core::HRESULT,
    pub GetTemporaryStoreLocation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetTemporaryStoreLocation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetTargetID: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetTargetID: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub GetTargetProcessorArchitecture: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetTargetProcessorArchitecture: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    ...
    pub ExpandTarget: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ExpandTargetPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetModulePath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub LoadModule: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut super::super::Foundation::HMODULE,
    ) -> windows_core::HRESULT,
    pub SetWow64Context: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const u8,
    ) -> windows_core::HRESULT,
    pub TranslateWow64: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetSchemaHiveLocation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetSchemaHiveLocation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetSchemaHiveMountName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetSchemaHiveMountName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait ITargetInfo_Impl: windows_core::IUnknownImpl {
    ...
    fn SetTemporaryStoreLocation(
        &self,
        temporarystorelocation: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    ...
    fn SetTargetProcessorArchitecture(
        &self,
        processorarchitecture: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    fn GetProperty(
        &self,
        offline: windows_core::BOOL,
    ...
    fn SetWow64Context(
        &self,
        installermodule: &windows_core::PCWSTR,
        wow64context: *const u8,
    ) -> windows_core::Result<()>;
    fn TranslateWow64(
        &self,
        clientarchitecture: &windows_core::PCWSTR,
        value: &windows_core::PCWSTR,
    ) -> windows_core::Result<windows_core::BSTR>;
    ...
    fn SetSchemaHiveMountName(
        &self,
        pwzmountname: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
...
impl ITargetInfo_Vtbl {
    pub const fn new<Identity: ITargetInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetTargetMode<Identity: ITargetInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetTargetMode<Identity: ITargetInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetTemporaryStoreLocation<
            Identity: ITargetInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            temporarystorelocation: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetTemporaryStoreLocation<
            Identity: ITargetInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITargetInfo_Impl::SetTemporaryStoreLocation(
                    this,
                    core::mem::transmute(&temporarystorelocation),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetTargetID<Identity: ITargetInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            targetid: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetTargetID<Identity: ITargetInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetTargetProcessorArchitecture<
            Identity: ITargetInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            processorarchitecture: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetTargetProcessorArchitecture<
            Identity: ITargetInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                ...
                ITargetInfo_Impl::SetTargetProcessorArchitecture(
                    this,
                    core::mem::transmute(&processorarchitecture),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetProperty<Identity: ITargetInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            offline: windows_core::BOOL,
            property: windows_core::PCWSTR,
            value: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITargetInfo_Impl::GetProperty(
                    this,
                    core::mem::transmute_copy(&offline),
        ...
        unsafe extern "system" fn SetProperty<Identity: ITargetInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            offline: windows_core::BOOL,
            property: windows_core::PCWSTR,
            value: windows_core::PCWSTR,
        ...
        unsafe extern "system" fn GetEnumerator<Identity: ITargetInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ExpandTarget<Identity: ITargetInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            offline: windows_core::BOOL,
            location: windows_core::PCWSTR,
            expandedlocation: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITargetInfo_Impl::ExpandTarget(
                    this,
                    core::mem::transmute_copy(&offline),
        ...
        unsafe extern "system" fn ExpandTargetPath<
            Identity: ITargetInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITargetInfo_Impl::ExpandTargetPath(
                    this,
                    core::mem::transmute_copy(&offline),
                    core::mem::transmute(&location),
                ) {
        ...
        unsafe extern "system" fn SetModulePath<Identity: ITargetInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            module: windows_core::PCWSTR,
            path: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITargetInfo_Impl::SetModulePath(
                    this,
        ...
        unsafe extern "system" fn LoadModule<Identity: ITargetInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            module: windows_core::PCWSTR,
            modulehandle: *mut super::super::Foundation::HMODULE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetWow64Context<
            Identity: ITargetInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITargetInfo_Impl::SetWow64Context(
                    this,
                    core::mem::transmute(&installermodule),
                    core::mem::transmute_copy(&wow64context),
                )
                .into()
            }
        }
        unsafe extern "system" fn TranslateWow64<
            Identity: ITargetInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            clientarchitecture: windows_core::PCWSTR,
            value: windows_core::PCWSTR,
            translatedvalue: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITargetInfo_Impl::TranslateWow64(
                    this,
                    core::mem::transmute(&clientarchitecture),
                    core::mem::transmute(&value),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SetSchemaHiveLocation<
            Identity: ITargetInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pwzhivedir: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITargetInfo_Impl::SetSchemaHiveLocation(this, core::mem::transmute(&pwzhivedir))
                    .into()
            }
        }
        unsafe extern "system" fn GetSchemaHiveLocation<
            Identity: ITargetInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            phivelocation: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetSchemaHiveMountName<
            Identity: ITargetInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITargetInfo_Impl::SetSchemaHiveMountName(this, core::mem::transmute(&pwzmountname))
                    .into()
            }
        }
        unsafe extern "system" fn GetSchemaHiveMountName<
            Identity: ITargetInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pmountname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub const SettingsEngine: windows_core::GUID =
    windows_core::GUID::from_u128(0x9f7d7bb5_20b3_11da_81a5_0030f1642e3c);
...
pub const WCM_E_ATTRIBUTENOTALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0x80220004_u32 as _);
pub const WCM_E_ATTRIBUTENOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x80220003_u32 as _);
pub const WCM_E_CONFLICTINGASSERTION: windows_core::HRESULT =
    windows_core::HRESULT(0x80220019_u32 as _);
...
pub const WCM_E_EXPRESSIONNOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x80220010_u32 as _);
...
pub const WCM_E_INVALIDATTRIBUTECOMBINATION: windows_core::HRESULT =
    windows_core::HRESULT(0x80220027_u32 as _);
pub const WCM_E_INVALIDDATATYPE: windows_core::HRESULT = windows_core::HRESULT(0x80220008_u32 as _);
pub const WCM_E_INVALIDEXPRESSIONSYNTAX: windows_core::HRESULT =
    windows_core::HRESULT(0x80220017_u32 as _);
pub const WCM_E_INVALIDHANDLERSYNTAX: windows_core::HRESULT =
    windows_core::HRESULT(0x8022001F_u32 as _);
pub const WCM_E_INVALIDKEY: windows_core::HRESULT = windows_core::HRESULT(0x8022001C_u32 as _);
pub const WCM_E_INVALIDLANGUAGEFORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0x8022000E_u32 as _);
pub const WCM_E_INVALIDPATH: windows_core::HRESULT = windows_core::HRESULT(0x8022000B_u32 as _);
pub const WCM_E_INVALIDPROCESSORFORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0x8022002A_u32 as _);
...
pub const WCM_E_INVALIDVALUEFORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0x80220006_u32 as _);
pub const WCM_E_INVALIDVERSIONFORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0x8022000D_u32 as _);
pub const WCM_E_KEYNOTCHANGEABLE: windows_core::HRESULT =
    windows_core::HRESULT(0x8022000F_u32 as _);
pub const WCM_E_MANIFESTCOMPILATIONFAILED: windows_core::HRESULT =
    windows_core::HRESULT(0x80220022_u32 as _);
pub const WCM_E_MISSINGCONFIGURATION: windows_core::HRESULT =
    windows_core::HRESULT(0x80220029_u32 as _);
pub const WCM_E_MIXTYPEASSERTION: windows_core::HRESULT =
    windows_core::HRESULT(0x80220024_u32 as _);
pub const WCM_E_NAMESPACEALREADYREGISTERED: windows_core::HRESULT =
    windows_core::HRESULT(0x80220015_u32 as _);
pub const WCM_E_NAMESPACENOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x80220014_u32 as _);
pub const WCM_E_NOTIFICATIONNOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x80220018_u32 as _);
pub const WCM_E_NOTPOSITIONED: windows_core::HRESULT = windows_core::HRESULT(0x80220009_u32 as _);
pub const WCM_E_NOTSUPPORTEDFUNCTION: windows_core::HRESULT =
    windows_core::HRESULT(0x80220025_u32 as _);
pub const WCM_E_READONLYITEM: windows_core::HRESULT = windows_core::HRESULT(0x8022000A_u32 as _);
pub const WCM_E_RESTRICTIONFAILED: windows_core::HRESULT =
    windows_core::HRESULT(0x80220021_u32 as _);
pub const WCM_E_SOURCEMANEMPTYVALUE: windows_core::HRESULT =
    windows_core::HRESULT(0x8022002B_u32 as _);
pub const WCM_E_STATENODENOTALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0x80220002_u32 as _);
pub const WCM_E_STATENODENOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x80220001_u32 as _);
pub const WCM_E_STORECORRUPTED: windows_core::HRESULT = windows_core::HRESULT(0x80220016_u32 as _);
pub const WCM_E_SUBSTITUTIONNOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x80220011_u32 as _);
pub const WCM_E_TYPENOTSPECIFIED: windows_core::HRESULT =
    windows_core::HRESULT(0x80220007_u32 as _);
pub const WCM_E_UNKNOWNRESULT: windows_core::HRESULT = windows_core::HRESULT(0x80221003_u32 as _);
pub const WCM_E_USERALREADYREGISTERED: windows_core::HRESULT =
    windows_core::HRESULT(0x80220012_u32 as _);
pub const WCM_E_USERNOTFOUND: windows_core::HRESULT = windows_core::HRESULT(0x80220013_u32 as _);
pub const WCM_E_VALIDATIONFAILED: windows_core::HRESULT =
    windows_core::HRESULT(0x80220020_u32 as _);
pub const WCM_E_VALUETOOBIG: windows_core::HRESULT = windows_core::HRESULT(0x80220026_u32 as _);
pub const WCM_E_WRONGESCAPESTRING: windows_core::HRESULT =
    windows_core::HRESULT(0x8022000C_u32 as _);
...
pub const WCM_S_ATTRIBUTENOTALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0x221005_u32 as _);
...
pub const WCM_S_INVALIDATTRIBUTECOMBINATION: windows_core::HRESULT =
    windows_core::HRESULT(0x221004_u32 as _);
pub const WCM_S_LEGACYSETTINGWARNING: windows_core::HRESULT =
    windows_core::HRESULT(0x221002_u32 as _);

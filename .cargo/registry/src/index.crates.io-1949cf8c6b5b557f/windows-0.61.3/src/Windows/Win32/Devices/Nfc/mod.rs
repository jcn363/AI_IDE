...
pub const EmulationOff: SECURE_ELEMENT_CARD_EMULATION_MODE =
    SECURE_ELEMENT_CARD_EMULATION_MODE(0i32);
pub const EmulationOnPowerDependent: SECURE_ELEMENT_CARD_EMULATION_MODE =
    SECURE_ELEMENT_CARD_EMULATION_MODE(2i32);
pub const EmulationOnPowerIndependent: SECURE_ELEMENT_CARD_EMULATION_MODE =
    SECURE_ELEMENT_CARD_EMULATION_MODE(1i32);
pub const EmulationStealthListen: SECURE_ELEMENT_CARD_EMULATION_MODE =
    SECURE_ELEMENT_CARD_EMULATION_MODE(3i32);
...
pub const GUID_DEVINTERFACE_NFCDTA: windows_core::GUID =
    windows_core::GUID::from_u128(0x7fd3f30b_5e49_4be1_b3aa_af06260d236a);
pub const GUID_DEVINTERFACE_NFCSE: windows_core::GUID =
    windows_core::GUID::from_u128(0x8dc7c854_f5e5_4bed_815d_0c85ad047725);
pub const GUID_NFCSE_RADIO_MEDIA_DEVICE_INTERFACE: windows_core::GUID =
    windows_core::GUID::from_u128(0xef8ba08f_148d_4116_83ef_a2679dfc3fa5);
pub const GUID_NFC_RADIO_MEDIA_DEVICE_INTERFACE: windows_core::GUID =
    windows_core::GUID::from_u128(0x4d51e930_750d_4a36_a9f7_91dc540fcd30);

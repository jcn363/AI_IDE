windows_core::imp::define_interface!(
    ...
    0x1e9b31a1_662e_4ae0_af67_f63bb337e634
);
...
impl ILearningModelDeviceFactoryNative {
    ...
    pub unsafe fn CreateFromD3D12CommandQueue<P0>(
        &self,
        value: P0,
        ...
        P0: windows_core::Param<super::super::super::Graphics::Direct3D12::ID3D12CommandQueue>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).CreateFromD3D12CommandQueue)(
...
pub struct ILearningModelDeviceFactoryNative_Vtbl {
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub CreateFromD3D12CommandQueue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
pub trait ILearningModelDeviceFactoryNative_Impl: windows_core::IUnknownImpl {
    fn CreateFromD3D12CommandQueue(
        &self,
        value: windows_core::Ref<'_, super::super::super::Graphics::Direct3D12::ID3D12CommandQueue>,
    ) -> windows_core::Result<windows_core::IUnknown>;
}
#[cfg(feature = "Win32_Graphics_Direct3D12")]
impl ILearningModelDeviceFactoryNative_Vtbl {
    ...
    {
        unsafe extern "system" fn CreateFromD3D12CommandQueue<
        ...
        >(
            ...
            unsafe {
                ...
                match ILearningModelDeviceFactoryNative_Impl::CreateFromD3D12CommandQueue(
                    this,
        ...
        Self {
            ...
            CreateFromD3D12CommandQueue: CreateFromD3D12CommandQueue::<Identity, OFFSET>,
        }
    }
...
windows_core::imp::define_interface!(
    ...
    0x1adaa23a_eb67_41f3_aad8_5d984e9bacd4
);
...
impl ILearningModelOperatorProviderNative {
    ...
    pub unsafe fn GetRegistry(
        &self,
    ) -> windows_core::Result<super::super::super::AI::MachineLearning::WinML::IMLOperatorRegistry>
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRegistry)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ILearningModelOperatorProviderNative_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_AI_MachineLearning_WinML")]
    pub GetRegistry: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl ILearningModelOperatorProviderNative_Vtbl {
    pub const fn new<Identity: ILearningModelOperatorProviderNative_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn GetRegistry<
            Identity: ILearningModelOperatorProviderNative_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppoperatorregistry: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetRegistry: GetRegistry::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xc71e953f_37b4_4564_8658_d8396866db0d
);
...
impl ILearningModelSessionOptionsNative {
    pub unsafe fn SetIntraOpNumThreadsOverride(
        &self,
        intraopnumthreads: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetIntraOpNumThreadsOverride)(
                windows_core::Interface::as_raw(self),
                intraopnumthreads,
            )
            .ok()
...
pub struct ILearningModelSessionOptionsNative_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetIntraOpNumThreadsOverride:
...
impl ILearningModelSessionOptionsNative_Vtbl {
    pub const fn new<Identity: ILearningModelSessionOptionsNative_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn SetIntraOpNumThreadsOverride<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILearningModelSessionOptionsNative_Impl::SetIntraOpNumThreadsOverride(
                    this,
                    core::mem::transmute_copy(&intraopnumthreads),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            SetIntraOpNumThreadsOverride: SetIntraOpNumThreadsOverride::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x5da37a26_0526_414b_91e4_2a0fa3ddba40
);
windows_core::imp::interface_hierarchy!(
    ILearningModelSessionOptionsNative1,
    windows_core::IUnknown
...
impl ILearningModelSessionOptionsNative1 {
    pub unsafe fn SetIntraOpThreadSpinning(&self, allowspinning: u8) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetIntraOpThreadSpinning)(
                windows_core::Interface::as_raw(self),
                allowspinning,
            )
            .ok()
...
impl ILearningModelSessionOptionsNative1_Vtbl {
    pub const fn new<Identity: ILearningModelSessionOptionsNative1_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn SetIntraOpThreadSpinning<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILearningModelSessionOptionsNative1_Impl::SetIntraOpThreadSpinning(
                    this,
                    core::mem::transmute_copy(&allowspinning),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            SetIntraOpThreadSpinning: SetIntraOpThreadSpinning::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl ITensorNative {
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub unsafe fn GetD3D12Resource(
        &self,
    ) -> windows_core::Result<super::super::super::Graphics::Direct3D12::ID3D12Resource> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetD3D12Resource)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ITensorNative_Vtbl {
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub GetD3D12Resource: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Graphics_Direct3D12"))]
...
impl ITensorNative_Vtbl {
    pub const fn new<Identity: ITensorNative_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetBuffer<Identity: ITensorNative_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut *mut u8,
            capacity: *mut u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetD3D12Resource<
...
pub struct ITensorStaticsNative_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub CreateFromD3D12Resource: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
        i32,
...
pub trait ITensorStaticsNative_Impl: windows_core::IUnknownImpl {
    fn CreateFromD3D12Resource(
        &self,
        value: windows_core::Ref<'_, super::super::super::Graphics::Direct3D12::ID3D12Resource>,
        shape: *mut i64,
        shapecount: i32,
        result: windows_core::OutRef<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Direct3D12")]
impl ITensorStaticsNative_Vtbl {
    pub const fn new<Identity: ITensorStaticsNative_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateFromD3D12Resource<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITensorStaticsNative_Impl::CreateFromD3D12Resource(
                    this,
                    core::mem::transmute_copy(&value),
                    core::mem::transmute_copy(&shape),
                    core::mem::transmute_copy(&shapecount),
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            CreateFromD3D12Resource: CreateFromD3D12Resource::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {

...
pub const FindSimilarResults: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a93_9dbc_11da_9e3f_0011114ae311);
#[repr(transparent)]
...
windows_core::imp::define_interface!(
    ...
    0x96236a81_9dbc_11da_9e3f_0011114ae311
);
...
impl IFindSimilarResults {
    ...
    pub unsafe fn GetNextFileId(
        &self,
        numtraitsmatched: *mut u32,
        similarityfileid: *mut SimilarityFileId,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetNextFileId)(
                windows_core::Interface::as_raw(self),
                numtraitsmatched as _,
                similarityfileid as _,
            )
            .ok()
        }
    }
...
pub struct IFindSimilarResults_Vtbl {
    ...
    pub GetNextFileId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut SimilarityFileId,
...
impl IFindSimilarResults_Vtbl {
    pub const fn new<Identity: IFindSimilarResults_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetNextFileId<
            Identity: IFindSimilarResults_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IFindSimilarResults_Impl::GetNextFileId(
                    this,
                    core::mem::transmute_copy(&numtraitsmatched),
                    core::mem::transmute_copy(&similarityfileid),
                )
                .into()
            }
        }
...
impl IRdcComparator {
    pub unsafe fn Process(
        &self,
        endofinput: bool,
        endofoutput: *mut windows_core::BOOL,
...
impl IRdcComparator_Vtbl {
    pub const fn new<Identity: IRdcComparator_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Process<Identity: IRdcComparator_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            endofinput: windows_core::BOOL,
            endofoutput: *mut windows_core::BOOL,
            inputbuffer: *mut RdcBufferPointer,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRdcComparator_Impl::Process(
                    this,
                    core::mem::transmute_copy(&endofinput),
                    core::mem::transmute_copy(&endofoutput),
                    core::mem::transmute_copy(&inputbuffer),
                    core::mem::transmute_copy(&outputbuffer),
...
windows_core::imp::define_interface!(
    IRdcFileReader,
    IRdcFileReader_Vtbl,
    0x96236a74_9dbc_11da_9e3f_0011114ae311
);
...
impl IRdcFileReader {
    ...
    pub unsafe fn GetFilePosition(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFilePosition)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
impl IRdcFileReader_Vtbl {
    pub const fn new<Identity: IRdcFileReader_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Read<Identity: IRdcFileReader_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            offsetfilestart: u64,
            bytestoread: u32,
            bytesactuallyread: *mut u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRdcFileReader_Impl::Read(
                    this,
                    core::mem::transmute_copy(&offsetfilestart),
                    core::mem::transmute_copy(&bytestoread),
                    core::mem::transmute_copy(&bytesactuallyread),
                    core::mem::transmute_copy(&buffer),
                    core::mem::transmute_copy(&eof),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetFilePosition<
            Identity: IRdcFileReader_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            offsetfromstart: *mut u64,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    IRdcFileWriter,
    IRdcFileWriter_Vtbl,
    0x96236a75_9dbc_11da_9e3f_0011114ae311
);
...
impl IRdcFileWriter {
    ...
    pub unsafe fn Truncate(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Truncate)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn DeleteOnClose(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteOnClose)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
impl IRdcFileWriter_Vtbl {
    pub const fn new<Identity: IRdcFileWriter_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Write<Identity: IRdcFileWriter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            offsetfilestart: u64,
            bytestowrite: u32,
            buffer: *mut u8,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRdcFileWriter_Impl::Write(
                    this,
                    core::mem::transmute_copy(&offsetfilestart),
                    core::mem::transmute_copy(&bytestowrite),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Truncate<Identity: IRdcFileWriter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn DeleteOnClose<
...
windows_core::imp::define_interface!(
    IRdcGenerator,
    IRdcGenerator_Vtbl,
    0x96236a73_9dbc_11da_9e3f_0011114ae311
);
windows_core::imp::interface_hierarchy!(IRdcGenerator, windows_core::IUnknown);
impl IRdcGenerator {
    pub unsafe fn GetGeneratorParameters(
        &self,
        level: u32,
    ) -> windows_core::Result<IRdcGeneratorParameters> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetGeneratorParameters)(
                windows_core::Interface::as_raw(self),
                level,
                &mut result__,
            )
    ...
    pub unsafe fn Process(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Process)(
                ...
                endofoutput as _,
                inputbuffer as _,
                outputbuffers.len().try_into().unwrap(),
                core::mem::transmute(outputbuffers.as_ptr()),
                rdc_errorcode as _,
            )
            .ok()
        }
...
pub struct IRdcGenerator_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetGeneratorParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
...
impl IRdcGenerator_Vtbl {
    pub const fn new<Identity: IRdcGenerator_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetGeneratorParameters<
            Identity: IRdcGenerator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            level: u32,
            igeneratorparameters: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRdcGenerator_Impl::GetGeneratorParameters(
                    this,
        ...
        unsafe extern "system" fn Process<Identity: IRdcGenerator_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            endofinput: windows_core::BOOL,
            endofoutput: *mut windows_core::BOOL,
            inputbuffer: *mut RdcBufferPointer,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRdcGenerator_Impl::Process(
                    this,
                    core::mem::transmute_copy(&endofinput),
                    core::mem::transmute_copy(&endofoutput),
                    core::mem::transmute_copy(&inputbuffer),
                    core::mem::transmute_copy(&depth),
                    core::mem::transmute_copy(&outputbuffers),
                    core::mem::transmute_copy(&rdc_errorcode),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0x96236a72_9dbc_11da_9e3f_0011114ae311
);
...
impl IRdcGeneratorFilterMaxParameters {
    pub unsafe fn GetHorizonSize(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetHorizonSize)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetHorizonSize(&self, horizonsize: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetHorizonSize)(
                windows_core::Interface::as_raw(self),
                horizonsize,
            )
            .ok()
    ...
    pub unsafe fn GetHashWindowSize(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetHashWindowSize)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetHashWindowSize(&self, hashwindowsize: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetHashWindowSize)(
                windows_core::Interface::as_raw(self),
                hashwindowsize,
            )
            .ok()
...
pub struct IRdcGeneratorFilterMaxParameters_Vtbl {
    ...
    pub GetHashWindowSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetHashWindowSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
}
...
impl IRdcGeneratorFilterMaxParameters_Vtbl {
    ...
    {
        unsafe extern "system" fn GetHorizonSize<
        ...
        unsafe extern "system" fn SetHorizonSize<
            Identity: IRdcGeneratorFilterMaxParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRdcGeneratorFilterMaxParameters_Impl::SetHorizonSize(
                    this,
                    core::mem::transmute_copy(&horizonsize),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetHashWindowSize<
            Identity: IRdcGeneratorFilterMaxParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            hashwindowsize: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetHashWindowSize<
            Identity: IRdcGeneratorFilterMaxParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRdcGeneratorFilterMaxParameters_Impl::SetHashWindowSize(
                    this,
                    core::mem::transmute_copy(&hashwindowsize),
                )
                .into()
            }
        }
...
impl IRdcGeneratorParameters {
    pub unsafe fn GetGeneratorParametersType(
        &self,
    ) -> windows_core::Result<GeneratorParametersType> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetGeneratorParametersType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetParametersVersion(
        &self,
        currentversion: *mut u32,
        minimumcompatibleappversion: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetParametersVersion)(
                windows_core::Interface::as_raw(self),
                currentversion as _,
                minimumcompatibleappversion as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetSerializeSize(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSerializeSize)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IRdcGeneratorParameters_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetGeneratorParametersType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut GeneratorParametersType,
    ) -> windows_core::HRESULT,
    pub GetParametersVersion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetSerializeSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
...
impl IRdcGeneratorParameters_Vtbl {
    pub const fn new<Identity: IRdcGeneratorParameters_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetGeneratorParametersType<
            Identity: IRdcGeneratorParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            parameterstype: *mut GeneratorParametersType,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetParametersVersion<
            Identity: IRdcGeneratorParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRdcGeneratorParameters_Impl::GetParametersVersion(
                    this,
                    core::mem::transmute_copy(&currentversion),
                    core::mem::transmute_copy(&minimumcompatibleappversion),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetSerializeSize<
            Identity: IRdcGeneratorParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRdcGeneratorParameters_Impl::Serialize(
                    this,
                    core::mem::transmute_copy(&size),
                    core::mem::transmute_copy(&parametersblob),
...
windows_core::imp::define_interface!(
    IRdcLibrary,
    IRdcLibrary_Vtbl,
    0x96236a78_9dbc_11da_9e3f_0011114ae311
);
...
impl IRdcLibrary {
    pub unsafe fn ComputeDefaultRecursionDepth(&self, filesize: u64) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ComputeDefaultRecursionDepth)(
                windows_core::Interface::as_raw(self),
                filesize,
                &mut result__,
            )
    ...
    pub unsafe fn CreateGeneratorParameters(
        &self,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateGeneratorParameters)(
                windows_core::Interface::as_raw(self),
                parameterstype,
                level,
                &mut result__,
    ...
    pub unsafe fn OpenGeneratorParameters(
        &self,
        size: u32,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenGeneratorParameters)(
                windows_core::Interface::as_raw(self),
                size,
                parametersblob,
                &mut result__,
    ...
    pub unsafe fn CreateGenerator(
        &self,
        igeneratorparametersarray: &[Option<IRdcGeneratorParameters>],
    ) -> windows_core::Result<IRdcGenerator> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateGenerator)(
                windows_core::Interface::as_raw(self),
                igeneratorparametersarray.len().try_into().unwrap(),
                core::mem::transmute(igeneratorparametersarray.as_ptr()),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateComparator<P0>(
        &self,
        iseedsignaturesfile: P0,
        comparatorbuffersize: u32,
    ) -> windows_core::Result<IRdcComparator>
    where
        P0: windows_core::Param<IRdcFileReader>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateComparator)(
                windows_core::Interface::as_raw(self),
                iseedsignaturesfile.param().abi(),
    ...
    pub unsafe fn CreateSignatureReader<P0>(
        &self,
        ifilereader: P0,
    ) -> windows_core::Result<IRdcSignatureReader>
    where
        P0: windows_core::Param<IRdcFileReader>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSignatureReader)(
                windows_core::Interface::as_raw(self),
                ifilereader.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn GetRDCVersion(
        &self,
        currentversion: *mut u32,
        minimumcompatibleappversion: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetRDCVersion)(
                windows_core::Interface::as_raw(self),
                currentversion as _,
                minimumcompatibleappversion as _,
            )
...
pub struct IRdcLibrary_Vtbl {
    ...
    pub ComputeDefaultRecursionDepth:
        unsafe extern "system" fn(*mut core::ffi::c_void, u64, *mut u32) -> windows_core::HRESULT,
    pub CreateGeneratorParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        GeneratorParametersType,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OpenGeneratorParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateGenerator: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateComparator: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateSignatureReader: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetRDCVersion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
...
pub trait IRdcLibrary_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateComparator(
        &self,
        iseedsignaturesfile: windows_core::Ref<'_, IRdcFileReader>,
        comparatorbuffersize: u32,
    ) -> windows_core::Result<IRdcComparator>;
    fn CreateSignatureReader(
        &self,
        ifilereader: windows_core::Ref<'_, IRdcFileReader>,
    ) -> windows_core::Result<IRdcSignatureReader>;
    fn GetRDCVersion(
        &self,
        currentversion: *mut u32,
...
impl IRdcLibrary_Vtbl {
    pub const fn new<Identity: IRdcLibrary_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ComputeDefaultRecursionDepth<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRdcLibrary_Impl::ComputeDefaultRecursionDepth(
                    this,
                    core::mem::transmute_copy(&filesize),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateGeneratorParameters<
            Identity: IRdcLibrary_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRdcLibrary_Impl::CreateGeneratorParameters(
                    this,
                    core::mem::transmute_copy(&parameterstype),
                    core::mem::transmute_copy(&level),
                ) {
                    Ok(ok__) => {
                        igeneratorparameters.write(core::mem::transmute(ok__));
        ...
        unsafe extern "system" fn OpenGeneratorParameters<
            Identity: IRdcLibrary_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRdcLibrary_Impl::OpenGeneratorParameters(
                    this,
                    core::mem::transmute_copy(&size),
                    core::mem::transmute_copy(&parametersblob),
                ) {
        ...
        unsafe extern "system" fn CreateGenerator<
            Identity: IRdcLibrary_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            depth: u32,
            igeneratorparametersarray: *const *mut core::ffi::c_void,
            igenerator: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRdcLibrary_Impl::CreateGenerator(
                    this,
                    core::mem::transmute_copy(&depth),
                    core::mem::transmute_copy(&igeneratorparametersarray),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateComparator<
            Identity: IRdcLibrary_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            iseedsignaturesfile: *mut core::ffi::c_void,
            comparatorbuffersize: u32,
            icomparator: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRdcLibrary_Impl::CreateComparator(
                    this,
                    core::mem::transmute_copy(&iseedsignaturesfile),
                    core::mem::transmute_copy(&comparatorbuffersize),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateSignatureReader<
            Identity: IRdcLibrary_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ifilereader: *mut core::ffi::c_void,
            isignaturereader: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IRdcLibrary_Impl::CreateSignatureReader(
                    this,
                    core::mem::transmute_copy(&ifilereader),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetRDCVersion<Identity: IRdcLibrary_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            currentversion: *mut u32,
            minimumcompatibleappversion: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRdcLibrary_Impl::GetRDCVersion(
                    this,
                    core::mem::transmute_copy(&currentversion),
                    core::mem::transmute_copy(&minimumcompatibleappversion),
                )
...
windows_core::imp::define_interface!(
    ...
    0x96236a76_9dbc_11da_9e3f_0011114ae311
);
...
impl IRdcSignatureReader {
    pub unsafe fn ReadHeader(&self) -> windows_core::Result<RDC_ErrorCode> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReadHeader)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn ReadSignatures(
        &self,
        rdcsignaturepointer: *mut RdcSignaturePointer,
        endofoutput: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ReadSignatures)(
                windows_core::Interface::as_raw(self),
                rdcsignaturepointer as _,
                endofoutput as _,
            )
            .ok()
        }
...
pub struct IRdcSignatureReader_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ReadHeader: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RDC_ErrorCode,
    ) -> windows_core::HRESULT,
    pub ReadSignatures: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut RdcSignaturePointer,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
}
...
impl IRdcSignatureReader_Vtbl {
    pub const fn new<Identity: IRdcSignatureReader_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ReadHeader<
        ...
        unsafe extern "system" fn ReadSignatures<
            Identity: IRdcSignatureReader_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IRdcSignatureReader_Impl::ReadSignatures(
                    this,
                    core::mem::transmute_copy(&rdcsignaturepointer),
                    core::mem::transmute_copy(&endofoutput),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0x96236a80_9dbc_11da_9e3f_0011114ae311
);
...
impl IRdcSimilarityGenerator {
    pub unsafe fn EnableSimilarity(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EnableSimilarity)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
impl IRdcSimilarityGenerator_Vtbl {
    pub const fn new<Identity: IRdcSimilarityGenerator_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn EnableSimilarity<
        ...
        >(
            this: *mut core::ffi::c_void,
            similaritydata: *mut SimilarityData,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ISimilarity,
    ISimilarity_Vtbl,
    0x96236a83_9dbc_11da_9e3f_0011114ae311
);
windows_core::imp::interface_hierarchy!(ISimilarity, windows_core::IUnknown);
impl ISimilarity {
    pub unsafe fn CreateTable<P0>(
        &self,
        path: P0,
        truncate: bool,
        securitydescriptor: *const u8,
        recordsize: u32,
    ) -> windows_core::Result<RdcCreatedTables>
    where
    ...
    pub unsafe fn CreateTableIndirect<P0, P1>(
        &self,
        mapping: P0,
        fileidfile: P1,
        truncate: bool,
        ...
        P1: windows_core::Param<IRdcFileWriter>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTableIndirect)(
                windows_core::Interface::as_raw(self),
                mapping.param().abi(),
                fileidfile.param().abi(),
                truncate.into(),
                recordsize,
                &mut result__,
            )
    ...
    pub unsafe fn CloseTable(&self, isvalid: bool) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CloseTable)(
                windows_core::Interface::as_raw(self),
                isvalid.into(),
            )
            .ok()
    ...
    pub unsafe fn FindSimilarFileId(
        &self,
        similaritydata: *const SimilarityData,
        numberofmatchesrequired: u16,
        resultssize: u32,
    ) -> windows_core::Result<IFindSimilarResults> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindSimilarFileId)(
                windows_core::Interface::as_raw(self),
                similaritydata,
    ...
    pub unsafe fn CopyAndSwap<P0, P1>(
        &self,
        newsimilaritytables: P0,
        reportprogress: P1,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CopyAndSwap)(
                windows_core::Interface::as_raw(self),
                newsimilaritytables.param().abi(),
                reportprogress.param().abi(),
            )
            .ok()
        }
    }
...
pub struct ISimilarity_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateTable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::BOOL,
        *const u8,
        u32,
        *mut RdcCreatedTables,
    ) -> windows_core::HRESULT,
    pub CreateTableIndirect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::BOOL,
    ...
    pub CloseTable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub Append: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const SimilarityFileId,
        *const SimilarityData,
    ) -> windows_core::HRESULT,
    pub FindSimilarFileId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const SimilarityData,
        u16,
        u32,
    ...
    pub CopyAndSwap: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait ISimilarity_Impl: windows_core::IUnknownImpl {
    fn CreateTable(
        ...
        truncate: windows_core::BOOL,
        securitydescriptor: *const u8,
        recordsize: u32,
    ) -> windows_core::Result<RdcCreatedTables>;
    fn CreateTableIndirect(
        &self,
        mapping: windows_core::Ref<'_, ISimilarityTraitsMapping>,
        fileidfile: windows_core::Ref<'_, IRdcFileWriter>,
        truncate: windows_core::BOOL,
        recordsize: u32,
    ) -> windows_core::Result<RdcCreatedTables>;
    ...
    fn CopyAndSwap(
        &self,
        newsimilaritytables: windows_core::Ref<'_, ISimilarity>,
        reportprogress: windows_core::Ref<'_, ISimilarityReportProgress>,
    ) -> windows_core::Result<()>;
...
impl ISimilarity_Vtbl {
    pub const fn new<Identity: ISimilarity_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateTable<Identity: ISimilarity_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            path: windows_core::PCWSTR,
            truncate: windows_core::BOOL,
            securitydescriptor: *const u8,
            recordsize: u32,
            isnew: *mut RdcCreatedTables,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISimilarity_Impl::CreateTable(
                    this,
                    core::mem::transmute(&path),
                    core::mem::transmute_copy(&truncate),
                    core::mem::transmute_copy(&securitydescriptor),
                    core::mem::transmute_copy(&recordsize),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            fileidfile: *mut core::ffi::c_void,
            truncate: windows_core::BOOL,
            recordsize: u32,
            isnew: *mut RdcCreatedTables,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISimilarity_Impl::CreateTableIndirect(
                    this,
                    core::mem::transmute_copy(&mapping),
                    core::mem::transmute_copy(&fileidfile),
                    core::mem::transmute_copy(&truncate),
                    core::mem::transmute_copy(&recordsize),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CloseTable<Identity: ISimilarity_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            isvalid: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Append<Identity: ISimilarity_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            similarityfileid: *const SimilarityFileId,
            similaritydata: *const SimilarityData,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarity_Impl::Append(
                    this,
                    core::mem::transmute_copy(&similarityfileid),
                    core::mem::transmute_copy(&similaritydata),
                )
                .into()
            }
        }
        unsafe extern "system" fn FindSimilarFileId<
            Identity: ISimilarity_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            numberofmatchesrequired: u16,
            resultssize: u32,
            findsimilarresults: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISimilarity_Impl::FindSimilarFileId(
                    this,
                    core::mem::transmute_copy(&similaritydata),
                    core::mem::transmute_copy(&numberofmatchesrequired),
        ...
        unsafe extern "system" fn CopyAndSwap<Identity: ISimilarity_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            newsimilaritytables: *mut core::ffi::c_void,
            reportprogress: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarity_Impl::CopyAndSwap(
                    this,
                    core::mem::transmute_copy(&newsimilaritytables),
                    core::mem::transmute_copy(&reportprogress),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x96236a7f_9dbc_11da_9e3f_0011114ae311
);
...
impl ISimilarityFileIdTable {
    ...
    pub unsafe fn CreateTableIndirect<P0>(
        &self,
        fileidfile: P0,
        truncate: bool,
        recordsize: u32,
    ...
    pub const fn new<Identity: ISimilarityFileIdTable_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISimilarityFileIdTable_Impl::CreateTable(
                    this,
                    core::mem::transmute(&path),
                    core::mem::transmute_copy(&truncate),
                    core::mem::transmute_copy(&securitydescriptor),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISimilarityFileIdTable_Impl::CreateTableIndirect(
                    this,
                    core::mem::transmute_copy(&fileidfile),
                    core::mem::transmute_copy(&truncate),
                    core::mem::transmute_copy(&recordsize),
        ...
        unsafe extern "system" fn CloseTable<
            Identity: ISimilarityFileIdTable_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarityFileIdTable_Impl::CloseTable(this, core::mem::transmute_copy(&isvalid))
                    .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            similarityfileid: *const SimilarityFileId,
            similarityfileindex: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISimilarityFileIdTable_Impl::Append(
                    this,
                    core::mem::transmute_copy(&similarityfileid),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarityFileIdTable_Impl::Lookup(
                    this,
                    core::mem::transmute_copy(&similarityfileindex),
                    core::mem::transmute_copy(&similarityfileid),
                )
                .into()
            }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarityFileIdTable_Impl::Invalidate(
                    this,
                    core::mem::transmute_copy(&similarityfileindex),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    ISimilarityReportProgress_Vtbl,
    0x96236a7a_9dbc_11da_9e3f_0011114ae311
);
    ...
    pub const fn new<Identity: ISimilarityReportProgress_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarityReportProgress_Impl::ReportProgress(
                    this,
                    core::mem::transmute_copy(&percentcompleted),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x96236a7b_9dbc_11da_9e3f_0011114ae311
);
windows_core::imp::interface_hierarchy!(ISimilarityTableDumpState, windows_core::IUnknown);
impl ISimilarityTableDumpState {
    pub unsafe fn GetNextData(
        &self,
        resultssize: u32,
        resultsused: *mut u32,
        eof: *mut windows_core::BOOL,
        results: *mut SimilarityDumpData,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetNextData)(
                windows_core::Interface::as_raw(self),
                resultssize,
                resultsused as _,
                eof as _,
...
pub struct ISimilarityTableDumpState_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetNextData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u32,
        *mut windows_core::BOOL,
        *mut SimilarityDumpData,
    ) -> windows_core::HRESULT,
}
...
impl ISimilarityTableDumpState_Vtbl {
    pub const fn new<Identity: ISimilarityTableDumpState_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetNextData<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarityTableDumpState_Impl::GetNextData(
                    this,
                    core::mem::transmute_copy(&resultssize),
                    core::mem::transmute_copy(&resultsused),
                    core::mem::transmute_copy(&eof),
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetNextData: GetNextData::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x96236a7c_9dbc_11da_9e3f_0011114ae311
);
...
impl ISimilarityTraitsMappedView {
    ...
    pub unsafe fn Get(
        ...
        dirty: bool,
        numelements: u32,
    ) -> windows_core::Result<SimilarityMappedViewInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ISimilarityTraitsMappedView_Vtbl {
    pub const fn new<Identity: ISimilarityTraitsMappedView_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            dirty: windows_core::BOOL,
            numelements: u32,
            viewinfo: *mut SimilarityMappedViewInfo,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISimilarityTraitsMappedView_Impl::Get(
                    this,
                    core::mem::transmute_copy(&index),
                    core::mem::transmute_copy(&dirty),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarityTraitsMappedView_Impl::GetView(
                    this,
                    core::mem::transmute_copy(&mappedpagebegin),
                    core::mem::transmute_copy(&mappedpageend),
                )
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0x96236a7d_9dbc_11da_9e3f_0011114ae311
);
...
impl ISimilarityTraitsMapping {
    pub unsafe fn CloseMapping(&self) {
        unsafe {
            (windows_core::Interface::vtable(self).CloseMapping)(windows_core::Interface::as_raw(
                self,
            ))
        }
    }
    pub unsafe fn SetFileSize(&self, filesize: u64) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFileSize)(
                windows_core::Interface::as_raw(self),
                filesize,
            )
            .ok()
    ...
    pub unsafe fn OpenMapping(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenMapping)(
                windows_core::Interface::as_raw(self),
                accessmode,
                begin,
                end,
    ...
    pub unsafe fn ResizeMapping(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ResizeMapping)(
                windows_core::Interface::as_raw(self),
                accessmode,
                begin,
                end,
    ...
    pub unsafe fn GetPageSize(&self) -> u32 {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPageSize)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            );
            result__
    ...
    pub unsafe fn CreateView(
        ...
        accessmode: RdcMappingAccessMode,
    ) -> windows_core::Result<ISimilarityTraitsMappedView> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateView)(
                windows_core::Interface::as_raw(self),
                minimummappedpages,
                accessmode,
                &mut result__,
...
pub struct ISimilarityTraitsMapping_Vtbl {
    ...
    pub GetFileSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub OpenMapping: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub ResizeMapping: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        RdcMappingAccessMode,
        u64,
        u64,
...
impl ISimilarityTraitsMapping_Vtbl {
    pub const fn new<Identity: ISimilarityTraitsMapping_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CloseMapping<
        ...
        unsafe extern "system" fn SetFileSize<
            Identity: ISimilarityTraitsMapping_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarityTraitsMapping_Impl::SetFileSize(
                    this,
                    core::mem::transmute_copy(&filesize),
                )
                .into()
        ...
        unsafe extern "system" fn OpenMapping<
            Identity: ISimilarityTraitsMapping_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISimilarityTraitsMapping_Impl::OpenMapping(
                    this,
                    core::mem::transmute_copy(&accessmode),
                    core::mem::transmute_copy(&begin),
        ...
        unsafe extern "system" fn ResizeMapping<
            Identity: ISimilarityTraitsMapping_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISimilarityTraitsMapping_Impl::ResizeMapping(
                    this,
                    core::mem::transmute_copy(&accessmode),
                    core::mem::transmute_copy(&begin),
                    core::mem::transmute_copy(&end),
        ...
        unsafe extern "system" fn GetPageSize<
            Identity: ISimilarityTraitsMapping_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarityTraitsMapping_Impl::GetPageSize(
                    this,
        ...
        >(
            ...
            minimummappedpages: u32,
            accessmode: RdcMappingAccessMode,
            mappedview: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISimilarityTraitsMapping_Impl::CreateView(
                    this,
                    core::mem::transmute_copy(&minimummappedpages),
                    core::mem::transmute_copy(&accessmode),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0x96236a7e_9dbc_11da_9e3f_0011114ae311
);
...
impl ISimilarityTraitsTable {
    ...
    pub unsafe fn FindSimilarFileIndex(
        &self,
        similaritydata: *const SimilarityData,
        numberofmatchesrequired: u16,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).FindSimilarFileIndex)(
                windows_core::Interface::as_raw(self),
                similaritydata,
                numberofmatchesrequired,
                findsimilarfileindexresults as _,
                resultssize,
                resultsused as _,
            )
            .ok()
    ...
    pub unsafe fn BeginDump(&self) -> windows_core::Result<ISimilarityTableDumpState> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BeginDump)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetLastIndex(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLastIndex)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct ISimilarityTraitsTable_Vtbl {
    ...
    pub FindSimilarFileIndex: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const SimilarityData,
        u16,
        *mut FindSimilarFileIndexResults,
        u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub BeginDump: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetLastIndex:
    ...
    pub const fn new<Identity: ISimilarityTraitsTable_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISimilarityTraitsTable_Impl::CreateTable(
                    this,
                    core::mem::transmute(&path),
                    core::mem::transmute_copy(&truncate),
                    core::mem::transmute_copy(&securitydescriptor),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISimilarityTraitsTable_Impl::CreateTableIndirect(
                    this,
                    core::mem::transmute_copy(&mapping),
                    core::mem::transmute_copy(&truncate),
                ) {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarityTraitsTable_Impl::CloseTable(this, core::mem::transmute_copy(&isvalid))
                    .into()
            }
        }
        unsafe extern "system" fn Append<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarityTraitsTable_Impl::Append(
                    this,
                    core::mem::transmute_copy(&data),
                    core::mem::transmute_copy(&fileindex),
                )
                .into()
            }
        }
        unsafe extern "system" fn FindSimilarFileIndex<
            Identity: ISimilarityTraitsTable_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISimilarityTraitsTable_Impl::FindSimilarFileIndex(
                    this,
                    core::mem::transmute_copy(&similaritydata),
                    core::mem::transmute_copy(&numberofmatchesrequired),
                    core::mem::transmute_copy(&findsimilarfileindexresults),
                    core::mem::transmute_copy(&resultssize),
                    core::mem::transmute_copy(&resultsused),
                )
                .into()
        ...
        unsafe extern "system" fn BeginDump<
            Identity: ISimilarityTraitsTable_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            similaritytabledumpstate: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetLastIndex<
            Identity: ISimilarityTraitsTable_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub const RdcComparator: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a8b_9dbc_11da_9e3f_0011114ae311);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct RdcCreatedTables(pub i32);
pub const RdcFileReader: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a89_9dbc_11da_9e3f_0011114ae311);
pub const RdcGenerator: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a88_9dbc_11da_9e3f_0011114ae311);
pub const RdcGeneratorFilterMaxParameters: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a87_9dbc_11da_9e3f_0011114ae311);
pub const RdcGeneratorParameters: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a86_9dbc_11da_9e3f_0011114ae311);
pub const RdcLibrary: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a85_9dbc_11da_9e3f_0011114ae311);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const RdcSignatureReader: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a8a_9dbc_11da_9e3f_0011114ae311);
pub const RdcSimilarityGenerator: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a92_9dbc_11da_9e3f_0011114ae311);
pub const Similarity: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a91_9dbc_11da_9e3f_0011114ae311);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const SimilarityFileIdTable: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a90_9dbc_11da_9e3f_0011114ae311);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const SimilarityReportProgress: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a8d_9dbc_11da_9e3f_0011114ae311);
pub const SimilarityTableDumpState: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a8e_9dbc_11da_9e3f_0011114ae311);
pub const SimilarityTraitsMappedView: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a95_9dbc_11da_9e3f_0011114ae311);
pub const SimilarityTraitsMapping: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a94_9dbc_11da_9e3f_0011114ae311);
pub const SimilarityTraitsTable: windows_core::GUID =
    windows_core::GUID::from_u128(0x96236a8f_9dbc_11da_9e3f_0011114ae311);

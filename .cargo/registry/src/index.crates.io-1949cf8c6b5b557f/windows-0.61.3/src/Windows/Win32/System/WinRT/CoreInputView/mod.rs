windows_core::imp::define_interface!(
    ...
    0x0e3da342_b11c_484b_9c1c_be0d61c2f6c5
);
...
pub trait ICoreFrameworkInputViewInterop_Impl: windows_core::IUnknownImpl {
    fn GetForWindow(
        ...
        coreframeworkinputview: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
}
    ...
    pub const fn new<Identity: ICoreFrameworkInputViewInterop_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                ICoreFrameworkInputViewInterop_Impl::GetForWindow(
                    this,
                    core::mem::transmute_copy(&appwindow),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&coreframeworkinputview),
                )
                .into()
            }
        }

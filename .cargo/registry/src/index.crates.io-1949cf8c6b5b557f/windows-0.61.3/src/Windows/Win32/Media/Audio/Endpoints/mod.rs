...
pub const DEVINTERFACE_AUDIOENDPOINTPLUGIN: windows_core::GUID =
    windows_core::GUID::from_u128(0x9f2f7b66_65ac_4fa6_8ae4_123c78b89313);
pub const DEVPKEY_AudioEndpointPlugin2_FactoryCLSID: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x12d83bd7_cf12_46be_8540_812710d3021c),
        pid: 4,
    };
pub const DEVPKEY_AudioEndpointPlugin_DataFlow: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x12d83bd7_cf12_46be_8540_812710d3021c),
        pid: 2,
    };
pub const DEVPKEY_AudioEndpointPlugin_FactoryCLSID: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x12d83bd7_cf12_46be_8540_812710d3021c),
        pid: 1,
    };
pub const DEVPKEY_AudioEndpointPlugin_PnPInterface: super::super::super::Foundation::PROPERTYKEY =
    super::super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x12d83bd7_cf12_46be_8540_812710d3021c),
        pid: 3,
    };
...
windows_core::imp::define_interface!(
    ...
    0x784cfd40_9f89_456e_a1a6_873b006a664e
);
...
impl IAudioEndpointFormatControl {
    pub unsafe fn ResetToDefault(&self, resetflags: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ResetToDefault)(
    ...
    pub const fn new<Identity: IAudioEndpointFormatControl_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                IAudioEndpointFormatControl_Impl::ResetToDefault(
                    this,
                    core::mem::transmute_copy(&resetflags),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xf8520dd3_8f9d_4437_9861_62f584c33dd6
);
...
impl IAudioEndpointLastBufferControl {
    pub unsafe fn IsLastBufferControlSupported(&self) -> windows_core::BOOL {
        unsafe {
            (windows_core::Interface::vtable(self).IsLastBufferControlSupported)(
                windows_core::Interface::as_raw(self),
            )
        }
    }
    ...
    pub unsafe fn ReleaseOutputDataPointerForLastBuffer(
        &self,
        pconnectionproperty: *const super::Apo::APO_CONNECTION_PROPERTY,
    ) {
        unsafe {
            (windows_core::Interface::vtable(self).ReleaseOutputDataPointerForLastBuffer)(
                windows_core::Interface::as_raw(self),
                pconnectionproperty,
            )
        }
...
pub struct IAudioEndpointLastBufferControl_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub IsLastBufferControlSupported:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::BOOL,
    #[cfg(feature = "Win32_Media_Audio_Apo")]
    pub ReleaseOutputDataPointerForLastBuffer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::Apo::APO_CONNECTION_PROPERTY,
    ),
...
impl IAudioEndpointLastBufferControl_Vtbl {
    ...
    {
        unsafe extern "system" fn IsLastBufferControlSupported<
        ...
        unsafe extern "system" fn ReleaseOutputDataPointerForLastBuffer<
            Identity: IAudioEndpointLastBufferControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointLastBufferControl_Impl::ReleaseOutputDataPointerForLastBuffer(
                    this,
        ...
        Self {
            ...
            ReleaseOutputDataPointerForLastBuffer: ReleaseOutputDataPointerForLastBuffer::<
                Identity,
                OFFSET,
            >,
        }
...
windows_core::imp::define_interface!(
    ...
    0xe1546dce_9dd1_418b_9ab2_348ced161c86
);
...
impl IAudioEndpointOffloadStreamMeter {
    pub unsafe fn GetMeterChannelCount(&self) -> windows_core::Result<u32> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).GetMeterChannelCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetMeteringData(&self, u32channelcount: u32) -> windows_core::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMeteringData)(
                windows_core::Interface::as_raw(self),
                u32channelcount,
                &mut result__,
            )
...
impl IAudioEndpointOffloadStreamMeter_Vtbl {
    pub const fn new<Identity: IAudioEndpointOffloadStreamMeter_Impl, const OFFSET: isize>() -> Self
    {
        ...
        unsafe extern "system" fn GetMeteringData<
            Identity: IAudioEndpointOffloadStreamMeter_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAudioEndpointOffloadStreamMeter_Impl::GetMeteringData(
                    this,
                    core::mem::transmute_copy(&u32channelcount),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0xdfe21355_5ec2_40e0_8d6b_710ac3c00249
);
    ...
    pub const fn new<Identity: IAudioEndpointOffloadStreamMute_Impl, const OFFSET: isize>() -> Self
    {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointOffloadStreamMute_Impl::SetMute(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0x64f1dd49_71ca_4281_8672_3a9eddd1d0b6
);
...
impl IAudioEndpointOffloadStreamVolume {
    pub unsafe fn GetVolumeChannelCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetVolumeChannelCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetChannelVolumes(
        ...
        u32curvetype: super::super::KernelStreaming::AUDIO_CURVE_TYPE,
...
impl IAudioEndpointOffloadStreamVolume_Vtbl {
    ...
    {
        unsafe extern "system" fn GetVolumeChannelCount<
        ...
        unsafe extern "system" fn SetChannelVolumes<
            Identity: IAudioEndpointOffloadStreamVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointOffloadStreamVolume_Impl::SetChannelVolumes(
                    this,
                    core::mem::transmute_copy(&u32channelcount),
                    core::mem::transmute_copy(&pf32volumes),
                    core::mem::transmute_copy(&u32curvetype),
                    core::mem::transmute_copy(&pcurveduration),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetChannelVolumes<
            Identity: IAudioEndpointOffloadStreamVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAudioEndpointOffloadStreamVolume_Impl::GetChannelVolumes(
                    this,
                    core::mem::transmute_copy(&u32channelcount),
                ) {
                    Ok(ok__) => {
...
pub trait IAudioEndpointVolume_Impl: windows_core::IUnknownImpl {
    fn RegisterControlChangeNotify(
        &self,
        pnotify: windows_core::Ref<'_, IAudioEndpointVolumeCallback>,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: IAudioEndpointVolume_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointVolume_Impl::RegisterControlChangeNotify(
                    this,
        ...
        unsafe extern "system" fn UnregisterControlChangeNotify<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointVolume_Impl::UnregisterControlChangeNotify(
                    this,
                    core::mem::transmute_copy(&pnotify),
                )
                .into()
        ...
        unsafe extern "system" fn SetMasterVolumeLevel<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointVolume_Impl::SetMasterVolumeLevel(
                    this,
        ...
        unsafe extern "system" fn SetMasterVolumeLevelScalar<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointVolume_Impl::SetMasterVolumeLevelScalar(
                    this,
        ...
        unsafe extern "system" fn GetMasterVolumeLevel<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetMasterVolumeLevelScalar<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetChannelVolumeLevel<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointVolume_Impl::SetChannelVolumeLevel(
                    this,
        ...
        unsafe extern "system" fn SetChannelVolumeLevelScalar<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointVolume_Impl::SetChannelVolumeLevelScalar(
                    this,
                    core::mem::transmute_copy(&nchannel),
                    core::mem::transmute_copy(&flevel),
                    core::mem::transmute_copy(&pguideventcontext),
        ...
        unsafe extern "system" fn GetChannelVolumeLevel<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAudioEndpointVolume_Impl::GetChannelVolumeLevel(
                    this,
                    core::mem::transmute_copy(&nchannel),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetChannelVolumeLevelScalar<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAudioEndpointVolume_Impl::GetChannelVolumeLevelScalar(
                    this,
                    core::mem::transmute_copy(&nchannel),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointVolume_Impl::SetMute(
                    this,
        ...
        unsafe extern "system" fn GetVolumeStepInfo<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointVolume_Impl::GetVolumeStepInfo(
                    this,
                    core::mem::transmute_copy(&pnstep),
                    core::mem::transmute_copy(&pnstepcount),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointVolume_Impl::VolumeStepUp(
                    this,
                    core::mem::transmute_copy(&pguideventcontext),
                )
                .into()
        ...
        unsafe extern "system" fn VolumeStepDown<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointVolume_Impl::VolumeStepDown(
                    this,
                    core::mem::transmute_copy(&pguideventcontext),
                )
                .into()
        ...
        unsafe extern "system" fn QueryHardwareSupport<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetVolumeRange<
            Identity: IAudioEndpointVolume_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointVolume_Impl::GetVolumeRange(
                    this,
                    core::mem::transmute_copy(&pflvolumemindb),
                    core::mem::transmute_copy(&pflvolumemaxdb),
...
impl IAudioEndpointVolumeCallback {
    pub unsafe fn OnNotify(
        &self,
        pnotify: *mut super::AUDIO_VOLUME_NOTIFICATION_DATA,
    ) -> windows_core::Result<()> {
        unsafe {
...
pub struct IAudioEndpointVolumeCallback_Vtbl {
    ...
    pub OnNotify: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::AUDIO_VOLUME_NOTIFICATION_DATA,
    ) -> windows_core::HRESULT,
}
...
windows_core::imp::define_interface!(
    ...
    0x66e11784_f695_4f28_a505_a7080081a78f
);
...
impl IAudioEndpointVolumeEx {
    pub unsafe fn GetVolumeRangeChannel(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetVolumeRangeChannel)(
                windows_core::Interface::as_raw(self),
                ichannel,
                pflvolumemindb as _,
                pflvolumemaxdb as _,
...
pub struct IAudioEndpointVolumeEx_Vtbl {
    ...
    pub GetVolumeRangeChannel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut f32,
        *mut f32,
...
impl IAudioEndpointVolumeEx_Vtbl {
    pub const fn new<Identity: IAudioEndpointVolumeEx_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetVolumeRangeChannel<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioEndpointVolumeEx_Impl::GetVolumeRangeChannel(
                    this,
                    core::mem::transmute_copy(&ichannel),
                    core::mem::transmute_copy(&pflvolumemindb),
                    core::mem::transmute_copy(&pflvolumemaxdb),
                    core::mem::transmute_copy(&pflvolumeincrementdb),
                )
        ...
        Self {
            base__: IAudioEndpointVolume_Vtbl::new::<Identity, OFFSET>(),
            GetVolumeRangeChannel: GetVolumeRangeChannel::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x076a6922_d802_4f83_baf6_409d9ca11bfe
);
...
impl IAudioLfxControl {
    pub unsafe fn SetLocalEffectsState(&self, benabled: bool) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLocalEffectsState)(
                windows_core::Interface::as_raw(self),
                benabled.into(),
            )
            .ok()
    ...
    pub unsafe fn GetLocalEffectsState(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLocalEffectsState)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IAudioLfxControl_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetLocalEffectsState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub GetLocalEffectsState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
}
...
impl IAudioLfxControl_Vtbl {
    pub const fn new<Identity: IAudioLfxControl_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetLocalEffectsState<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioLfxControl_Impl::SetLocalEffectsState(
                    this,
        ...
        unsafe extern "system" fn GetLocalEffectsState<
            Identity: IAudioLfxControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xc02216f6_8c67_4b5b_9d00_d008e73e0064
);
...
impl IAudioMeterInformation {
    pub unsafe fn GetPeakValue(&self) -> windows_core::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPeakValue)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetMeteringChannelCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMeteringChannelCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetChannelsPeakValues(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetChannelsPeakValues)(
                windows_core::Interface::as_raw(self),
                afpeakvalues.len().try_into().unwrap(),
                core::mem::transmute(afpeakvalues.as_ptr()),
            )
            .ok()
        }
    }
...
pub struct IAudioMeterInformation_Vtbl {
    ...
    pub GetPeakValue:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f32) -> windows_core::HRESULT,
    pub GetMeteringChannelCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetChannelsPeakValues:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut f32) -> windows_core::HRESULT,
    pub QueryHardwareSupport:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
}
...
impl IAudioMeterInformation_Vtbl {
    pub const fn new<Identity: IAudioMeterInformation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetPeakValue<
        ...
        unsafe extern "system" fn GetMeteringChannelCount<
            Identity: IAudioMeterInformation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetChannelsPeakValues<
            Identity: IAudioMeterInformation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAudioMeterInformation_Impl::GetChannelsPeakValues(
                    this,
                    core::mem::transmute_copy(&u32channelcount),
                    core::mem::transmute_copy(&afpeakvalues),
                )
                .into()
            }
        }
...
impl IHardwareAudioEngineBase {
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAvailableOffloadConnectorCount)(
                windows_core::Interface::as_raw(self),
                _pwstrdeviceid.param().abi(),
                _uconnectorid,
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetEngineFormat<P0>(
        &self,
        pdevice: P0,
        _brequestdeviceformat: bool,
        _ppwfxformat: *mut *mut super::WAVEFORMATEX,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::IMMDevice>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetEngineFormat)(
                windows_core::Interface::as_raw(self),
                pdevice.param().abi(),
                _brequestdeviceformat.into(),
                _ppwfxformat as _,
            )
            .ok()
        }
    }
    pub unsafe fn SetEngineDeviceFormat<P0>(
        &self,
        pdevice: P0,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetEngineDeviceFormat)(
                windows_core::Interface::as_raw(self),
                pdevice.param().abi(),
                _pwfxformat as _,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetGfxState)(
                windows_core::Interface::as_raw(self),
                pdevice.param().abi(),
                _benable.into(),
            )
        ...
        P0: windows_core::Param<super::IMMDevice>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetGfxState)(
                windows_core::Interface::as_raw(self),
                pdevice.param().abi(),
                &mut result__,
            )
...
pub struct IHardwareAudioEngineBase_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetAvailableOffloadConnectorCount: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetEngineFormat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::BOOL,
        *mut *mut super::WAVEFORMATEX,
    ) -> windows_core::HRESULT,
    pub SetEngineDeviceFormat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut super::WAVEFORMATEX,
    ) -> windows_core::HRESULT,
    pub SetGfxState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub GetGfxState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
...
pub trait IHardwareAudioEngineBase_Impl: windows_core::IUnknownImpl {
    ...
    fn GetEngineFormat(
        &self,
        pdevice: windows_core::Ref<'_, super::IMMDevice>,
        _brequestdeviceformat: windows_core::BOOL,
        _ppwfxformat: *mut *mut super::WAVEFORMATEX,
    ) -> windows_core::Result<()>;
...
impl IHardwareAudioEngineBase_Vtbl {
    pub const fn new<Identity: IHardwareAudioEngineBase_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetAvailableOffloadConnectorCount<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHardwareAudioEngineBase_Impl::GetAvailableOffloadConnectorCount(
                    this,
                    core::mem::transmute(&_pwstrdeviceid),
                    core::mem::transmute_copy(&_uconnectorid),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHardwareAudioEngineBase_Impl::GetEngineFormat(
                    this,
                    core::mem::transmute_copy(&pdevice),
                    core::mem::transmute_copy(&_brequestdeviceformat),
                    core::mem::transmute_copy(&_ppwfxformat),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetEngineDeviceFormat<
            Identity: IHardwareAudioEngineBase_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHardwareAudioEngineBase_Impl::SetEngineDeviceFormat(
                    this,
                    core::mem::transmute_copy(&pdevice),
                    core::mem::transmute_copy(&_pwfxformat),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetGfxState<
            Identity: IHardwareAudioEngineBase_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHardwareAudioEngineBase_Impl::SetGfxState(
                    this,
                    core::mem::transmute_copy(&pdevice),
                    core::mem::transmute_copy(&_benable),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetGfxState<
            Identity: IHardwareAudioEngineBase_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pdevice: *mut core::ffi::c_void,
            _pbenable: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHardwareAudioEngineBase_Impl::GetGfxState(
                    this,
                    core::mem::transmute_copy(&pdevice),
                ) {
                    Ok(ok__) => {

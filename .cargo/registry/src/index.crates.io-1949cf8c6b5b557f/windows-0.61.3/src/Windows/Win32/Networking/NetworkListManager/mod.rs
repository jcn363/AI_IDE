...
impl IEnumNetworkConnections {
    ...
    pub unsafe fn Next(
        &self,
        rgelt: &mut [Option<INetworkConnection>],
...
impl IEnumNetworkConnections_Vtbl {
    pub const fn new<Identity: IEnumNetworkConnections_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            ppenumvar: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumNetworkConnections_Impl::Next(
                    this,
        ...
        >(
            this: *mut core::ffi::c_void,
            ppenumnetwork: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IEnumNetworks_Vtbl {
    pub const fn new<Identity: IEnumNetworks_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn _NewEnum<Identity: IEnumNetworks_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumvar: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Next<Identity: IEnumNetworks_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            rgelt: *mut *mut core::ffi::c_void,
            pceltfetched: *mut u32,
        ...
        unsafe extern "system" fn Skip<Identity: IEnumNetworks_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Reset<Identity: IEnumNetworks_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Clone<Identity: IEnumNetworks_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumnetwork: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl INetwork {
    ...
    pub unsafe fn SetName(
        &self,
        sznetworknewname: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(sznetworknewname),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn SetDescription(
        &self,
        szdescription: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub unsafe fn GetNetworkId(&self) -> windows_core::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNetworkId)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetNetworkConnections(&self) -> windows_core::Result<IEnumNetworkConnections> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNetworkConnections)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetTimeCreatedAndConnected(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetTimeCreatedAndConnected)(
                windows_core::Interface::as_raw(self),
                pdwlowdatetimecreated as _,
                pdwhighdatetimecreated as _,
                pdwlowdatetimeconnected as _,
                pdwhighdatetimeconnected as _,
            )
            .ok()
        }
    }
    pub unsafe fn IsConnectedToInternet(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsConnectedToInternet)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetConnectivity(&self) -> windows_core::Result<NLM_CONNECTIVITY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetConnectivity)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct INetwork_Vtbl {
    ...
    pub GetNetworkId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub GetNetworkConnections: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetTimeCreatedAndConnected: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
        *mut u32,
    ...
    pub IsConnectedToInternet: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub GetConnectivity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut NLM_CONNECTIVITY,
    ) -> windows_core::HRESULT,
    pub GetCategory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut NLM_NETWORK_CATEGORY,
    ) -> windows_core::HRESULT,
...
impl INetwork_Vtbl {
    pub const fn new<Identity: INetwork_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetName<Identity: INetwork_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            psznetworkname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetName<Identity: INetwork_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            sznetworknewname: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetDescription<Identity: INetwork_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszdescription: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetDescription<Identity: INetwork_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            szdescription: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetNetworkId<Identity: INetwork_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pgdguidnetworkid: *mut windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetDomainType<Identity: INetwork_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetNetworkConnections<
            Identity: INetwork_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppenumnetworkconnection: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetTimeCreatedAndConnected<
            Identity: INetwork_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetwork_Impl::GetTimeCreatedAndConnected(
                    this,
                    core::mem::transmute_copy(&pdwlowdatetimecreated),
                    core::mem::transmute_copy(&pdwhighdatetimecreated),
                    core::mem::transmute_copy(&pdwlowdatetimeconnected),
                    core::mem::transmute_copy(&pdwhighdatetimeconnected),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsConnectedToInternet<
            Identity: INetwork_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbisconnected: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsConnected<Identity: INetwork_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbisconnected: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetConnectivity<Identity: INetwork_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetCategory<Identity: INetwork_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetCategory<Identity: INetwork_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            newcategory: NLM_NETWORK_CATEGORY,
        ) -> windows_core::HRESULT {
            unsafe {
...
#[cfg(feature = "Win32_System_Com")]
impl INetwork2 {
    pub unsafe fn IsDomainAuthenticatedBy(
        &self,
        domainauthenticationkind: NLM_DOMAIN_AUTHENTICATION_KIND,
    ) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsDomainAuthenticatedBy)(
                windows_core::Interface::as_raw(self),
...
impl INetwork2_Vtbl {
    pub const fn new<Identity: INetwork2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsDomainAuthenticatedBy<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match INetwork2_Impl::IsDomainAuthenticatedBy(
                    this,
                    core::mem::transmute_copy(&domainauthenticationkind),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            base__: INetwork_Vtbl::new::<Identity, OFFSET>(),
            IsDomainAuthenticatedBy: IsDomainAuthenticatedBy::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl INetworkConnection {
    ...
    pub unsafe fn GetAdapterId(&self) -> windows_core::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAdapterId)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct INetworkConnection_Vtbl {
    ...
    pub GetConnectionId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub GetAdapterId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub GetDomainType: unsafe extern "system" fn(
...
impl INetworkConnection_Vtbl {
    pub const fn new<Identity: INetworkConnection_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetConnectivity<
            Identity: INetworkConnection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            this: *mut core::ffi::c_void,
            pgdconnectionid: *mut windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetAdapterId<
            Identity: INetworkConnection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pgdadapterid: *mut windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetDomainType<
            Identity: INetworkConnection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
    ...
    pub const fn new<Identity: INetworkConnection2_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match INetworkConnection2_Impl::IsDomainAuthenticatedBy(
                    this,
                    core::mem::transmute_copy(&domainauthenticationkind),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            base__: INetworkConnection_Vtbl::new::<Identity, OFFSET>(),
            IsDomainAuthenticatedBy: IsDomainAuthenticatedBy::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl INetworkConnectionCost {
    pub unsafe fn GetCost(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCost)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetDataPlanStatus(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetDataPlanStatus)(
                windows_core::Interface::as_raw(self),
                pdataplanstatus as _,
            )
            .ok()
        }
    }
...
impl INetworkConnectionCost_Vtbl {
    pub const fn new<Identity: INetworkConnectionCost_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCost<
        ...
        unsafe extern "system" fn GetDataPlanStatus<
            Identity: INetworkConnectionCost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkConnectionCost_Impl::GetDataPlanStatus(
                    this,
                    core::mem::transmute_copy(&pdataplanstatus),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xdcb0000b_570f_4a9b_8d69_199fdba5723b
);
...
impl INetworkConnectionCostEvents {
    pub unsafe fn ConnectionCostChanged(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ConnectionCostChanged)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn ConnectionDataPlanStatusChanged(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ConnectionDataPlanStatusChanged)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(connectionid),
            )
            .ok()
...
pub struct INetworkConnectionCostEvents_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ConnectionCostChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        u32,
    ) -> windows_core::HRESULT,
    pub ConnectionDataPlanStatusChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
    ) -> windows_core::HRESULT,
}
...
impl INetworkConnectionCostEvents_Vtbl {
    pub const fn new<Identity: INetworkConnectionCostEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ConnectionCostChanged<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkConnectionCostEvents_Impl::ConnectionCostChanged(
                    this,
                    core::mem::transmute(&connectionid),
                    core::mem::transmute_copy(&newcost),
                )
                .into()
            }
        }
        unsafe extern "system" fn ConnectionDataPlanStatusChanged<
            Identity: INetworkConnectionCostEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkConnectionCostEvents_Impl::ConnectionDataPlanStatusChanged(
                    this,
                    core::mem::transmute(&connectionid),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    0xdcb00007_570f_4a9b_8d69_199fdba5723b
);
...
impl INetworkConnectionEvents {
    pub unsafe fn NetworkConnectionConnectivityChanged(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).NetworkConnectionConnectivityChanged)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(connectionid),
                newconnectivity,
            )
    ...
    pub unsafe fn NetworkConnectionPropertyChanged(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).NetworkConnectionPropertyChanged)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(connectionid),
                flags,
            )
...
pub struct INetworkConnectionEvents_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub NetworkConnectionConnectivityChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        NLM_CONNECTIVITY,
    )
        -> windows_core::HRESULT,
    pub NetworkConnectionPropertyChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
...
impl INetworkConnectionEvents_Vtbl {
    pub const fn new<Identity: INetworkConnectionEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn NetworkConnectionConnectivityChanged<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkConnectionEvents_Impl::NetworkConnectionConnectivityChanged(
                    this,
                    core::mem::transmute(&connectionid),
                    core::mem::transmute_copy(&newconnectivity),
                )
                .into()
            }
        }
        unsafe extern "system" fn NetworkConnectionPropertyChanged<
            Identity: INetworkConnectionEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkConnectionEvents_Impl::NetworkConnectionPropertyChanged(
                    this,
                    core::mem::transmute(&connectionid),
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            NetworkConnectionConnectivityChanged: NetworkConnectionConnectivityChanged::<
                Identity,
                OFFSET,
            >,
...
windows_core::imp::define_interface!(
    ...
    0xdcb00008_570f_4a9b_8d69_199fdba5723b
);
...
impl INetworkCostManager {
    ...
    pub unsafe fn SetDestinationAddresses(
        ...
        bappend: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDestinationAddresses)(
                windows_core::Interface::as_raw(self),
                pdestipaddrlist.len().try_into().unwrap(),
                core::mem::transmute(pdestipaddrlist.as_ptr()),
                bappend,
            )
            .ok()
        }
...
pub struct INetworkCostManager_Vtbl {
    ...
    pub SetDestinationAddresses: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const NLM_SOCKADDR,
    ...
    pub const fn new<Identity: INetworkCostManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkCostManager_Impl::GetCost(
                    this,
                    core::mem::transmute_copy(&pcost),
                    core::mem::transmute_copy(&pdestipaddr),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkCostManager_Impl::GetDataPlanStatus(
                    this,
                    core::mem::transmute_copy(&pdataplanstatus),
                    core::mem::transmute_copy(&pdestipaddr),
                )
        ...
        unsafe extern "system" fn SetDestinationAddresses<
            Identity: INetworkCostManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkCostManager_Impl::SetDestinationAddresses(
                    this,
                    core::mem::transmute_copy(&length),
                    core::mem::transmute_copy(&pdestipaddrlist),
                    core::mem::transmute_copy(&bappend),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xdcb00009_570f_4a9b_8d69_199fdba5723b
);
...
impl INetworkCostManagerEvents {
    pub unsafe fn CostChanged(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).CostChanged)(
                windows_core::Interface::as_raw(self),
                newcost,
                pdestaddr,
            )
    ...
    pub unsafe fn DataPlanStatusChanged(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DataPlanStatusChanged)(
                windows_core::Interface::as_raw(self),
                pdestaddr,
            )
            .ok()
...
pub struct INetworkCostManagerEvents_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CostChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const NLM_SOCKADDR,
    ) -> windows_core::HRESULT,
    pub DataPlanStatusChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const NLM_SOCKADDR,
    ) -> windows_core::HRESULT,
}
pub trait INetworkCostManagerEvents_Impl: windows_core::IUnknownImpl {
    fn CostChanged(&self, newcost: u32, pdestaddr: *const NLM_SOCKADDR)
        -> windows_core::Result<()>;
...
impl INetworkCostManagerEvents_Vtbl {
    pub const fn new<Identity: INetworkCostManagerEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CostChanged<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkCostManagerEvents_Impl::CostChanged(
                    this,
                    core::mem::transmute_copy(&newcost),
                    core::mem::transmute_copy(&pdestaddr),
                )
                .into()
            }
        }
        unsafe extern "system" fn DataPlanStatusChanged<
            Identity: INetworkCostManagerEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkCostManagerEvents_Impl::DataPlanStatusChanged(
                    this,
                    core::mem::transmute_copy(&pdestaddr),
                )
                .into()
...
windows_core::imp::define_interface!(
    INetworkEvents,
    INetworkEvents_Vtbl,
    0xdcb00004_570f_4a9b_8d69_199fdba5723b
);
...
impl INetworkEvents {
    pub unsafe fn NetworkAdded(&self, networkid: windows_core::GUID) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).NetworkAdded)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(networkid),
            )
            .ok()
        }
    }
    pub unsafe fn NetworkDeleted(&self, networkid: windows_core::GUID) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).NetworkDeleted)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(networkid),
            )
            .ok()
    ...
    pub unsafe fn NetworkConnectivityChanged(
        &self,
        networkid: windows_core::GUID,
        newconnectivity: NLM_CONNECTIVITY,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).NetworkConnectivityChanged)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(networkid),
                newconnectivity,
            )
    ...
    pub unsafe fn NetworkPropertyChanged(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).NetworkPropertyChanged)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(networkid),
                flags,
            )
...
pub struct INetworkEvents_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub NetworkAdded: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub NetworkDeleted: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub NetworkConnectivityChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        NLM_CONNECTIVITY,
    ) -> windows_core::HRESULT,
    pub NetworkPropertyChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
...
impl INetworkEvents_Vtbl {
    pub const fn new<Identity: INetworkEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn NetworkAdded<
        ...
        unsafe extern "system" fn NetworkConnectivityChanged<
            Identity: INetworkEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkEvents_Impl::NetworkConnectivityChanged(
                    this,
                    core::mem::transmute(&networkid),
                    core::mem::transmute_copy(&newconnectivity),
                )
        ...
        unsafe extern "system" fn NetworkPropertyChanged<
            Identity: INetworkEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkEvents_Impl::NetworkPropertyChanged(
                    this,
                    core::mem::transmute(&networkid),
                    core::mem::transmute_copy(&flags),
                )
...
impl INetworkListManager {
    ...
    ) -> windows_core::Result<IEnumNetworks> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNetworks)(
                windows_core::Interface::as_raw(self),
                flags,
                &mut result__,
            )
    ...
    pub unsafe fn GetNetwork(
        &self,
        gdnetworkid: windows_core::GUID,
    ) -> windows_core::Result<INetwork> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNetwork)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(gdnetworkid),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn GetNetworkConnection(
        &self,
        gdnetworkconnectionid: windows_core::GUID,
    ) -> windows_core::Result<INetworkConnection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNetworkConnection)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(gdnetworkconnectionid),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn SetSimulatedProfileInfo(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetSimulatedProfileInfo)(
                windows_core::Interface::as_raw(self),
                psimulatedinfo,
            )
            .ok()
    ...
    pub unsafe fn ClearSimulatedProfileInfo(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ClearSimulatedProfileInfo)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct INetworkListManager_Vtbl {
    pub base__: super::super::System::Com::IDispatch_Vtbl,
    pub GetNetworks: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        NLM_ENUM_NETWORK,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GetNetworkConnection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetSimulatedProfileInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const NLM_SIMULATED_PROFILE_INFO,
    ) -> windows_core::HRESULT,
    pub ClearSimulatedProfileInfo:
...
impl INetworkListManager_Vtbl {
    pub const fn new<Identity: INetworkListManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetNetworks<
        ...
        unsafe extern "system" fn GetNetworkConnection<
            Identity: INetworkListManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            gdnetworkconnectionid: windows_core::GUID,
            ppnetworkconnection: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match INetworkListManager_Impl::GetNetworkConnection(
                    this,
                    core::mem::transmute(&gdnetworkconnectionid),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SetSimulatedProfileInfo<
            Identity: INetworkListManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkListManager_Impl::SetSimulatedProfileInfo(
                    this,
                    core::mem::transmute_copy(&psimulatedinfo),
                )
                .into()
            }
        }
        unsafe extern "system" fn ClearSimulatedProfileInfo<
            Identity: INetworkListManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xdcb00001_570f_4a9b_8d69_199fdba5723b
);
...
impl INetworkListManagerEvents {
    pub unsafe fn ConnectivityChanged(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ConnectivityChanged)(
                windows_core::Interface::as_raw(self),
                newconnectivity,
            )
            .ok()
...
pub struct INetworkListManagerEvents_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ConnectivityChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        NLM_CONNECTIVITY,
    ) -> windows_core::HRESULT,
}
    ...
    pub const fn new<Identity: INetworkListManagerEvents_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                INetworkListManagerEvents_Impl::ConnectivityChanged(
                    this,
                    core::mem::transmute_copy(&newconnectivity),
                )
                .into()
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            ConnectivityChanged: ConnectivityChanged::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub const NA_DescriptionSetByPolicy: windows_core::PCWSTR =
    windows_core::w!("NA_DescriptionSetByPolicy");
pub const NA_DomainAuthenticationFailed: windows_core::PCWSTR =
    windows_core::w!("NA_DomainAuthenticationFailed");
...
pub const NA_InternetConnectivityV4: windows_core::PCWSTR =
    windows_core::w!("NA_InternetConnectivityV4");
pub const NA_InternetConnectivityV6: windows_core::PCWSTR =
    windows_core::w!("NA_InternetConnectivityV6");
...
pub const NLM_DOMAIN_AUTHENTICATION_KIND_LDAP: NLM_DOMAIN_AUTHENTICATION_KIND =
    NLM_DOMAIN_AUTHENTICATION_KIND(1i32);
pub const NLM_DOMAIN_AUTHENTICATION_KIND_NONE: NLM_DOMAIN_AUTHENTICATION_KIND =
    NLM_DOMAIN_AUTHENTICATION_KIND(0i32);
pub const NLM_DOMAIN_AUTHENTICATION_KIND_TLS: NLM_DOMAIN_AUTHENTICATION_KIND =
    NLM_DOMAIN_AUTHENTICATION_KIND(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NetworkListManager: windows_core::GUID =
    windows_core::GUID::from_u128(0xdcb00c01_570f_4a9b_8d69_199fdba5723b);

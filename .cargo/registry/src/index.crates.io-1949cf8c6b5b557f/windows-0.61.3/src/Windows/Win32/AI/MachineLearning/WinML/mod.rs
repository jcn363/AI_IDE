...
impl IMLOperatorAttributes {
        ...
        P0: windows_core::Param<windows_core::PCSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAttributeElementCount)(
    ...
    pub unsafe fn GetStringAttributeElementLength<P0>(
        &self,
        name: P0,
        elementindex: u32,
    ) -> windows_core::Result<u32>
        ...
        P0: windows_core::Param<windows_core::PCSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStringAttributeElementLength)(
                windows_core::Interface::as_raw(self),
                name.param().abi(),
                elementindex,
                &mut result__,
    ...
    pub unsafe fn GetStringAttributeElement<P0>(
        &self,
        name: P0,
        elementindex: u32,
        attributeelement: &mut [u8],
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetStringAttributeElement)(
                windows_core::Interface::as_raw(self),
                name.param().abi(),
                elementindex,
                attributeelement.len().try_into().unwrap(),
                core::mem::transmute(attributeelement.as_ptr()),
            )
            .ok()
        }
    }
...
pub struct IMLOperatorAttributes_Vtbl {
    ...
    pub GetAttributeElementCount: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCSTR,
    ...
    pub GetStringAttributeElementLength: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCSTR,
        u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetStringAttributeElement: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCSTR,
        u32,
        u32,
...
pub trait IMLOperatorAttributes_Impl: windows_core::IUnknownImpl {
    ...
    fn GetStringAttributeElement(
        ...
        attributeelement: windows_core::PSTR,
    ) -> windows_core::Result<()>;
}
    ...
    pub const fn new<Identity: IMLOperatorAttributes_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                match IMLOperatorAttributes_Impl::GetAttributeElementCount(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorAttributes_Impl::GetAttribute(
                    this,
                    core::mem::transmute(&name),
                    core::mem::transmute_copy(&r#type),
                    core::mem::transmute_copy(&elementcount),
                    core::mem::transmute_copy(&elementbytesize),
                    core::mem::transmute_copy(&value),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetStringAttributeElementLength<
            Identity: IMLOperatorAttributes_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorAttributes_Impl::GetStringAttributeElementLength(
                    this,
                    core::mem::transmute(&name),
                    core::mem::transmute_copy(&elementindex),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetStringAttributeElement<
            Identity: IMLOperatorAttributes_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorAttributes_Impl::GetStringAttributeElement(
                    this,
                    core::mem::transmute(&name),
                    core::mem::transmute_copy(&elementindex),
                    core::mem::transmute_copy(&attributeelementbytesize),
                    core::mem::transmute_copy(&attributeelement),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x11c4b4a0_b467_4eaa_a1a6_b961d8d0ed79
);
...
impl IMLOperatorKernel {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Compute)(
                windows_core::Interface::as_raw(self),
                context.param().abi(),
            )
            .ok()
...
pub struct IMLOperatorKernel_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Compute: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IMLOperatorKernel_Impl: windows_core::IUnknownImpl {
    fn Compute(
        &self,
        context: windows_core::Ref<'_, IMLOperatorKernelContext>,
    ) -> windows_core::Result<()>;
}
impl IMLOperatorKernel_Vtbl {
    pub const fn new<Identity: IMLOperatorKernel_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Compute<Identity: IMLOperatorKernel_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            Compute: Compute::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x82536a28_f022_4769_9d3f_8b278f84c0c3
);
...
impl IMLOperatorKernelContext {
    pub unsafe fn GetInputTensor(
        &self,
        inputindex: u32,
    ) -> windows_core::Result<IMLOperatorTensor> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetInputTensor)(
                windows_core::Interface::as_raw(self),
                inputindex,
                &mut result__,
            )
    ...
    pub unsafe fn GetOutputTensor(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOutputTensor)(
                windows_core::Interface::as_raw(self),
                outputindex,
                dimensionsizes.len().try_into().unwrap(),
                core::mem::transmute(dimensionsizes.as_ptr()),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn GetOutputTensor2(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOutputTensor2)(
                windows_core::Interface::as_raw(self),
                outputindex,
                &mut result__,
            )
    ...
    pub unsafe fn AllocateTemporaryData(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AllocateTemporaryData)(
                windows_core::Interface::as_raw(self),
                size,
                &mut result__,
            )
    ...
    pub unsafe fn GetExecutionInterface(&self) -> windows_core::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetExecutionInterface)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            );
...
pub struct IMLOperatorKernelContext_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetInputTensor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetOutputTensor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const u32,
    ...
    pub GetOutputTensor2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AllocateTemporaryData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        usize,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetExecutionInterface:
...
pub trait IMLOperatorKernelContext_Impl: windows_core::IUnknownImpl {
    ...
    fn GetExecutionInterface(
        &self,
        executionobject: windows_core::OutRef<'_, windows_core::IUnknown>,
    );
}
impl IMLOperatorKernelContext_Vtbl {
    pub const fn new<Identity: IMLOperatorKernelContext_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetInputTensor<
            Identity: IMLOperatorKernelContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            inputindex: u32,
            tensor: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorKernelContext_Impl::GetInputTensor(
                    this,
                    core::mem::transmute_copy(&inputindex),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetOutputTensor<
            Identity: IMLOperatorKernelContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorKernelContext_Impl::GetOutputTensor(
                    this,
                    core::mem::transmute_copy(&outputindex),
                    core::mem::transmute_copy(&dimensioncount),
                    core::mem::transmute_copy(&dimensionsizes),
                ) {
                    Ok(ok__) => {
                        tensor.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn GetOutputTensor2<
            Identity: IMLOperatorKernelContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorKernelContext_Impl::GetOutputTensor2(
                    this,
                    core::mem::transmute_copy(&outputindex),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn AllocateTemporaryData<
            Identity: IMLOperatorKernelContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorKernelContext_Impl::AllocateTemporaryData(
                    this,
        ...
        unsafe extern "system" fn GetExecutionInterface<
            Identity: IMLOperatorKernelContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            executionobject: *mut *mut core::ffi::c_void,
        ) {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorKernelContext_Impl::GetExecutionInterface(
                    this,
                    core::mem::transmute_copy(&executionobject),
                )
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0x5459b53d_a0fc_4665_addd_70171ef7e631
);
...
impl IMLOperatorKernelCreationContext {
    ...
    pub unsafe fn IsInputValid(&self, inputindex: u32) -> bool {
        unsafe {
            (windows_core::Interface::vtable(self).IsInputValid)(
                windows_core::Interface::as_raw(self),
                inputindex,
            )
        }
    ...
    pub unsafe fn IsOutputValid(&self, outputindex: u32) -> bool {
        unsafe {
            (windows_core::Interface::vtable(self).IsOutputValid)(
                windows_core::Interface::as_raw(self),
                outputindex,
            )
        }
    ...
    pub unsafe fn GetInputEdgeDescription(
        &self,
        inputindex: u32,
    ) -> windows_core::Result<MLOperatorEdgeDescription> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetInputEdgeDescription)(
                windows_core::Interface::as_raw(self),
                inputindex,
                &mut result__,
            )
    ...
    pub unsafe fn GetOutputEdgeDescription(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOutputEdgeDescription)(
                windows_core::Interface::as_raw(self),
                outputindex,
                &mut result__,
            )
    ...
    pub unsafe fn HasTensorShapeDescription(&self) -> bool {
        unsafe {
            (windows_core::Interface::vtable(self).HasTensorShapeDescription)(
                windows_core::Interface::as_raw(self),
            )
        }
    }
    pub unsafe fn GetTensorShapeDescription(
        &self,
    ) -> windows_core::Result<IMLOperatorTensorShapeDescription> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTensorShapeDescription)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IMLOperatorKernelCreationContext_Vtbl {
    ...
    pub GetInputEdgeDescription: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut MLOperatorEdgeDescription,
    ) -> windows_core::HRESULT,
    pub GetOutputEdgeDescription: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut MLOperatorEdgeDescription,
    ) -> windows_core::HRESULT,
    pub HasTensorShapeDescription: unsafe extern "system" fn(*mut core::ffi::c_void) -> bool,
    pub GetTensorShapeDescription: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetExecutionInterface:
...
impl IMLOperatorKernelCreationContext_Vtbl {
    ...
    {
        unsafe extern "system" fn GetInputCount<
        ...
        unsafe extern "system" fn IsInputValid<
            Identity: IMLOperatorKernelCreationContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorKernelCreationContext_Impl::IsInputValid(
                    this,
                    core::mem::transmute_copy(&inputindex),
                )
            }
        }
        unsafe extern "system" fn IsOutputValid<
            Identity: IMLOperatorKernelCreationContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorKernelCreationContext_Impl::IsOutputValid(
                    this,
                    core::mem::transmute_copy(&outputindex),
                )
            }
        }
        unsafe extern "system" fn GetInputEdgeDescription<
            Identity: IMLOperatorKernelCreationContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorKernelCreationContext_Impl::GetInputEdgeDescription(
                    this,
                    core::mem::transmute_copy(&inputindex),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetOutputEdgeDescription<
            Identity: IMLOperatorKernelCreationContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorKernelCreationContext_Impl::GetOutputEdgeDescription(
                    this,
                    core::mem::transmute_copy(&outputindex),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn HasTensorShapeDescription<
            Identity: IMLOperatorKernelCreationContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetTensorShapeDescription<
            Identity: IMLOperatorKernelCreationContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            shapedescription: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorKernelCreationContext_Impl::GetExecutionInterface(
                    this,
                    core::mem::transmute_copy(&executionobject),
                )
            }
...
windows_core::imp::define_interface!(
    ...
    IMLOperatorKernelFactory_Vtbl,
    0xef15ad6f_0dc9_4908_ab35_a575a30dfbf8
);
...
impl IMLOperatorKernelFactory {
        ...
        P0: windows_core::Param<IMLOperatorKernelCreationContext>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateKernel)(
                windows_core::Interface::as_raw(self),
                context.param().abi(),
                &mut result__,
            )
...
pub struct IMLOperatorKernelFactory_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateKernel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IMLOperatorKernelFactory_Impl: windows_core::IUnknownImpl {
    fn CreateKernel(
        &self,
        context: windows_core::Ref<'_, IMLOperatorKernelCreationContext>,
    ) -> windows_core::Result<IMLOperatorKernel>;
}
    ...
    pub const fn new<Identity: IMLOperatorKernelFactory_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorKernelFactory_Impl::CreateKernel(
                    this,
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            CreateKernel: CreateKernel::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IMLOperatorRegistry {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterOperatorSetSchema)(
                windows_core::Interface::as_raw(self),
                operatorsetid,
                baselineversion,
                core::mem::transmute(
                ...
                typeinferrer.param().abi(),
                shapeinferrer.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn RegisterOperatorKernel<P1, P2>(
        &self,
        operatorkernel: *const MLOperatorKernelDescription,
        operatorkernelfactory: P1,
        shapeinferrer: P2,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterOperatorKernel)(
                windows_core::Interface::as_raw(self),
                operatorkernel,
                operatorkernelfactory.param().abi(),
                shapeinferrer.param().abi(),
            )
            .ok()
        }
...
pub struct IMLOperatorRegistry_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub RegisterOperatorSetSchema: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const MLOperatorSetId,
        i32,
        *const *const MLOperatorSchemaDescription,
        u32,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RegisterOperatorKernel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const MLOperatorKernelDescription,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IMLOperatorRegistry_Impl: windows_core::IUnknownImpl {
    fn RegisterOperatorSetSchema(
        ...
        schemacount: u32,
        typeinferrer: windows_core::Ref<'_, IMLOperatorTypeInferrer>,
        shapeinferrer: windows_core::Ref<'_, IMLOperatorShapeInferrer>,
    ) -> windows_core::Result<()>;
    fn RegisterOperatorKernel(
        &self,
        operatorkernel: *const MLOperatorKernelDescription,
        operatorkernelfactory: windows_core::Ref<'_, IMLOperatorKernelFactory>,
        shapeinferrer: windows_core::Ref<'_, IMLOperatorShapeInferrer>,
    ) -> windows_core::Result<()>;
}
impl IMLOperatorRegistry_Vtbl {
    pub const fn new<Identity: IMLOperatorRegistry_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RegisterOperatorSetSchema<
        ...
        >(
            ...
            schema: *const *const MLOperatorSchemaDescription,
            schemacount: u32,
            typeinferrer: *mut core::ffi::c_void,
            shapeinferrer: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorRegistry_Impl::RegisterOperatorSetSchema(
                    this,
                    core::mem::transmute_copy(&operatorsetid),
                    core::mem::transmute_copy(&baselineversion),
                    core::mem::transmute_copy(&schema),
                    core::mem::transmute_copy(&schemacount),
                    core::mem::transmute_copy(&typeinferrer),
                    core::mem::transmute_copy(&shapeinferrer),
                )
                .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            operatorkernel: *const MLOperatorKernelDescription,
            operatorkernelfactory: *mut core::ffi::c_void,
            shapeinferrer: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorRegistry_Impl::RegisterOperatorKernel(
                    this,
                    core::mem::transmute_copy(&operatorkernel),
                    core::mem::transmute_copy(&operatorkernelfactory),
                    core::mem::transmute_copy(&shapeinferrer),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0x105b6b29_5408_4a68_9959_09b5955a3492
);
...
impl IMLOperatorShapeInferenceContext {
    ...
    pub unsafe fn GetInputTensorDimensionCount(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetInputTensorDimensionCount)(
                windows_core::Interface::as_raw(self),
                inputindex,
                &mut result__,
            )
    ...
    pub unsafe fn GetInputTensorShape(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetInputTensorShape)(
                windows_core::Interface::as_raw(self),
                inputindex,
                dimensions.len().try_into().unwrap(),
                core::mem::transmute(dimensions.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn SetOutputTensorShape(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetOutputTensorShape)(
                windows_core::Interface::as_raw(self),
                outputindex,
                dimensioncount,
                dimensions,
...
pub struct IMLOperatorShapeInferenceContext_Vtbl {
    ...
    pub GetInputTensorDimensionCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut u32) -> windows_core::HRESULT,
    pub GetInputTensorShape: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub SetOutputTensorShape: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const u32,
    ...
    pub const fn new<Identity: IMLOperatorShapeInferenceContext_Impl, const OFFSET: isize>() -> Self
    {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorShapeInferenceContext_Impl::IsInputValid(
                    this,
                    core::mem::transmute_copy(&inputindex),
                )
            }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorShapeInferenceContext_Impl::IsOutputValid(
                    this,
                    core::mem::transmute_copy(&outputindex),
                )
            }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorShapeInferenceContext_Impl::GetInputEdgeDescription(
                    this,
                    core::mem::transmute_copy(&inputindex),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetInputTensorDimensionCount<
            Identity: IMLOperatorShapeInferenceContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorShapeInferenceContext_Impl::GetInputTensorDimensionCount(
                    this,
                    core::mem::transmute_copy(&inputindex),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetInputTensorShape<
            Identity: IMLOperatorShapeInferenceContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorShapeInferenceContext_Impl::GetInputTensorShape(
                    this,
                    core::mem::transmute_copy(&inputindex),
                    core::mem::transmute_copy(&dimensioncount),
                    core::mem::transmute_copy(&dimensions),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetOutputTensorShape<
            Identity: IMLOperatorShapeInferenceContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorShapeInferenceContext_Impl::SetOutputTensorShape(
                    this,
                    core::mem::transmute_copy(&outputindex),
                    core::mem::transmute_copy(&dimensioncount),
                    core::mem::transmute_copy(&dimensions),
...
windows_core::imp::define_interface!(
    ...
    0x540be5be_a6c9_40ee_83f6_d2b8b40a7798
);
...
impl IMLOperatorShapeInferrer {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).InferOutputShapes)(
                windows_core::Interface::as_raw(self),
                context.param().abi(),
            )
            .ok()
...
pub struct IMLOperatorShapeInferrer_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub InferOutputShapes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
    ...
    pub const fn new<Identity: IMLOperatorShapeInferrer_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorShapeInferrer_Impl::InferOutputShapes(
                    this,
                    core::mem::transmute_copy(&context),
                )
                .into()
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            InferOutputShapes: InferOutputShapes::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x7fe41f41_f430_440e_aece_54416dc8b9db
);
...
impl IMLOperatorTensor {
    pub unsafe fn GetDimensionCount(&self) -> u32 {
        unsafe {
            (windows_core::Interface::vtable(self).GetDimensionCount)(
                windows_core::Interface::as_raw(self),
            )
        }
    }
    pub unsafe fn GetShape(&self, dimensions: &mut [u32]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetShape)(
                windows_core::Interface::as_raw(self),
                dimensions.len().try_into().unwrap(),
                core::mem::transmute(dimensions.as_ptr()),
            )
    ...
    pub unsafe fn GetTensorDataType(&self) -> MLOperatorTensorDataType {
        unsafe {
            (windows_core::Interface::vtable(self).GetTensorDataType)(
                windows_core::Interface::as_raw(self),
            )
        }
    }
    ...
    pub unsafe fn IsDataInterface(&self) -> bool {
        unsafe {
            (windows_core::Interface::vtable(self).IsDataInterface)(
                windows_core::Interface::as_raw(self),
            )
        }
    }
    ...
    pub unsafe fn GetDataInterface(&self) -> windows_core::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDataInterface)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            );
            windows_core::Type::from_abi(result__)
...
pub struct IMLOperatorTensor_Vtbl {
    ...
    pub GetShape:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut u32) -> windows_core::HRESULT,
    pub GetTensorDataType:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> MLOperatorTensorDataType,
...
impl IMLOperatorTensor_Vtbl {
    pub const fn new<Identity: IMLOperatorTensor_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDimensionCount<
        ...
        unsafe extern "system" fn GetShape<
            Identity: IMLOperatorTensor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorTensor_Impl::GetShape(
                    this,
                    core::mem::transmute_copy(&dimensioncount),
                    core::mem::transmute_copy(&dimensions),
                )
        ...
        unsafe extern "system" fn GetTensorDataType<
            Identity: IMLOperatorTensor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn IsCpuData<
            Identity: IMLOperatorTensor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn IsDataInterface<
            Identity: IMLOperatorTensor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetData<Identity: IMLOperatorTensor_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> *mut core::ffi::c_void {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetDataInterface<
            Identity: IMLOperatorTensor_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            datainterface: *mut *mut core::ffi::c_void,
        ) {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorTensor_Impl::GetDataInterface(
                    this,
                    core::mem::transmute_copy(&datainterface),
                )
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0xf20e8cbe_3b28_4248_be95_f96fbc6e4643
);
...
impl IMLOperatorTensorShapeDescription {
    ...
    pub unsafe fn HasOutputShapeDescription(&self) -> bool {
        unsafe {
            (windows_core::Interface::vtable(self).HasOutputShapeDescription)(
                windows_core::Interface::as_raw(self),
            )
        }
    }
    pub unsafe fn GetOutputTensorDimensionCount(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOutputTensorDimensionCount)(
                windows_core::Interface::as_raw(self),
                outputindex,
                &mut result__,
            )
    ...
    pub unsafe fn GetOutputTensorShape(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetOutputTensorShape)(
                windows_core::Interface::as_raw(self),
                outputindex,
                dimensions.len().try_into().unwrap(),
                core::mem::transmute(dimensions.as_ptr()),
...
pub struct IMLOperatorTensorShapeDescription_Vtbl {
    ...
    pub GetOutputTensorDimensionCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut u32) -> windows_core::HRESULT,
    pub GetOutputTensorShape: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut u32,
    ...
    pub const fn new<Identity: IMLOperatorTensorShapeDescription_Impl, const OFFSET: isize>() -> Self
    {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorTensorShapeDescription_Impl::GetInputTensorDimensionCount(
                    this,
                    core::mem::transmute_copy(&inputindex),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorTensorShapeDescription_Impl::GetInputTensorShape(
                    this,
                    core::mem::transmute_copy(&inputindex),
                    core::mem::transmute_copy(&dimensioncount),
                    core::mem::transmute_copy(&dimensions),
        ...
        unsafe extern "system" fn HasOutputShapeDescription<
            Identity: IMLOperatorTensorShapeDescription_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetOutputTensorDimensionCount<
            Identity: IMLOperatorTensorShapeDescription_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorTensorShapeDescription_Impl::GetOutputTensorDimensionCount(
                    this,
                    core::mem::transmute_copy(&outputindex),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetOutputTensorShape<
            Identity: IMLOperatorTensorShapeDescription_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorTensorShapeDescription_Impl::GetOutputTensorShape(
                    this,
                    core::mem::transmute_copy(&outputindex),
                    core::mem::transmute_copy(&dimensioncount),
                    core::mem::transmute_copy(&dimensions),
...
windows_core::imp::define_interface!(
    ...
    0xec893bb1_f938_427b_8488_c8dcf775f138
);
...
impl IMLOperatorTypeInferenceContext {
    ...
    pub unsafe fn SetOutputEdgeDescription(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetOutputEdgeDescription)(
                windows_core::Interface::as_raw(self),
                outputindex,
                edgedescription,
            )
...
pub struct IMLOperatorTypeInferenceContext_Vtbl {
    ...
    pub SetOutputEdgeDescription: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
    ...
    pub const fn new<Identity: IMLOperatorTypeInferenceContext_Impl, const OFFSET: isize>() -> Self
    {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorTypeInferenceContext_Impl::IsInputValid(
                    this,
                    core::mem::transmute_copy(&inputindex),
                )
            }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorTypeInferenceContext_Impl::IsOutputValid(
                    this,
                    core::mem::transmute_copy(&outputindex),
                )
            }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMLOperatorTypeInferenceContext_Impl::GetInputEdgeDescription(
                    this,
                    core::mem::transmute_copy(&inputindex),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SetOutputEdgeDescription<
            Identity: IMLOperatorTypeInferenceContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorTypeInferenceContext_Impl::SetOutputEdgeDescription(
                    this,
                    core::mem::transmute_copy(&outputindex),
                    core::mem::transmute_copy(&edgedescription),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x781aeb48_9bcb_4797_bf77_8bf455217beb
);
...
impl IMLOperatorTypeInferrer {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).InferOutputTypes)(
                windows_core::Interface::as_raw(self),
                context.param().abi(),
            )
            .ok()
...
pub struct IMLOperatorTypeInferrer_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub InferOutputTypes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
    ...
    pub const fn new<Identity: IMLOperatorTypeInferrer_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMLOperatorTypeInferrer_Impl::InferOutputTypes(
                    this,
                    core::mem::transmute_copy(&context),
                )
                .into()
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            InferOutputTypes: InferOutputTypes::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x95848f9e_583d_4054_af12_916387cd8426
);
...
impl IWinMLEvaluationContext {
    ...
    pub unsafe fn BindValue(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).BindValue)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pdescriptor),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn GetValueByName<P0>(
        &self,
        name: P0,
    ) -> windows_core::Result<*mut WINML_BINDING_DESC>
    where
...
impl IWinMLEvaluationContext_Vtbl {
    pub const fn new<Identity: IWinMLEvaluationContext_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BindValue<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinMLEvaluationContext_Impl::BindValue(
                    this,
                    core::mem::transmute_copy(&pdescriptor),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWinMLEvaluationContext_Impl::GetValueByName(
                    this,
                    core::mem::transmute(&name),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    IWinMLModel,
    IWinMLModel_Vtbl,
    0xe2eeb6a9_f31f_4055_a521_e30b5b33664a
);
...
impl IWinMLModel {
    ...
    pub unsafe fn EnumerateMetadata(
        &self,
        index: u32,
        pkey: *mut windows_core::PCWSTR,
        pvalue: *mut windows_core::PCWSTR,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub unsafe fn EnumerateModelInputs(
        &self,
        index: u32,
    ) -> windows_core::Result<*mut WINML_VARIABLE_DESC> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerateModelInputs)(
                windows_core::Interface::as_raw(self),
                index,
                &mut result__,
            )
    ...
    pub unsafe fn EnumerateModelOutputs(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumerateModelOutputs)(
                windows_core::Interface::as_raw(self),
                index,
                &mut result__,
            )
...
pub struct IWinMLModel_Vtbl {
    ...
    pub EnumerateModelInputs: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut WINML_VARIABLE_DESC,
    ) -> windows_core::HRESULT,
    pub EnumerateModelOutputs: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut WINML_VARIABLE_DESC,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IWinMLModel_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinMLModel_Impl::EnumerateMetadata(
                    this,
        ...
        unsafe extern "system" fn EnumerateModelInputs<
            Identity: IWinMLModel_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWinMLModel_Impl::EnumerateModelInputs(
                    this,
                    core::mem::transmute_copy(&index),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn EnumerateModelOutputs<
            Identity: IWinMLModel_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWinMLModel_Impl::EnumerateModelOutputs(
                    this,
                    core::mem::transmute_copy(&index),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    IWinMLRuntime,
    IWinMLRuntime_Vtbl,
    0xa0425329_40ae_48d9_bce3_829ef7b8a41a
);
...
impl IWinMLRuntime {
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LoadModel)(
                windows_core::Interface::as_raw(self),
                path.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub unsafe fn CreateEvaluationContext<P0>(
        &self,
        device: P0,
    ) -> windows_core::Result<IWinMLEvaluationContext>
    where
        P0: windows_core::Param<super::super::super::Graphics::Direct3D12::ID3D12Device>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateEvaluationContext)(
                windows_core::Interface::as_raw(self),
                device.param().abi(),
                &mut result__,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EvaluateModel)(
                windows_core::Interface::as_raw(self),
                pcontext.param().abi(),
            )
            .ok()
...
pub struct IWinMLRuntime_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub LoadModel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub CreateEvaluationContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub EvaluateModel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub trait IWinMLRuntime_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateEvaluationContext(
        &self,
        device: windows_core::Ref<'_, super::super::super::Graphics::Direct3D12::ID3D12Device>,
    ) -> windows_core::Result<IWinMLEvaluationContext>;
    fn EvaluateModel(
        &self,
...
impl IWinMLRuntime_Vtbl {
    pub const fn new<Identity: IWinMLRuntime_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn LoadModel<Identity: IWinMLRuntime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            path: windows_core::PCWSTR,
            ppmodel: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateEvaluationContext<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWinMLRuntime_Impl::CreateEvaluationContext(
                    this,
        ...
        unsafe extern "system" fn EvaluateModel<
            Identity: IWinMLRuntime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IWinMLRuntimeFactory_Vtbl,
    0xa807b84d_4ae5_4bc0_a76a_941aa246bd41
);
...
impl IWinMLRuntimeFactory {
    ...
    ) -> windows_core::Result<IWinMLRuntime> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateRuntime)(
                windows_core::Interface::as_raw(self),
                runtimetype,
                &mut result__,
            )
...
pub struct IWinMLRuntimeFactory_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateRuntime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WINML_RUNTIME_TYPE,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IWinMLRuntimeFactory_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWinMLRuntimeFactory_Impl::CreateRuntime(
                    this,
                    core::mem::transmute_copy(&runtimetype),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            CreateRuntime: CreateRuntime::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub struct WINML_RESOURCE_BINDING_DESC {
    ...
    pub pShape: *mut i64,
    pub pResource:
        core::mem::ManuallyDrop<Option<super::super::super::Graphics::Direct3D12::ID3D12Resource>>,
}
#[cfg(feature = "Win32_Graphics_Direct3D12")]

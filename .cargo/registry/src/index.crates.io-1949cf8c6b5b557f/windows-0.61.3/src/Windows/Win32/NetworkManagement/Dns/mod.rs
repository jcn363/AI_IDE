...
pub unsafe fn DnsAcquireContextHandle_A(
    credentialflags: u32,
    credentials: Option<*const core::ffi::c_void>,
    pcontext: *mut super::super::Foundation::HANDLE,
) -> i32 {
    ...
    unsafe {
        DnsAcquireContextHandle_A(
            credentialflags,
            credentials.unwrap_or(core::mem::zeroed()) as _,
            pcontext as _,
        )
    }
}
...
#[inline]
pub unsafe fn DnsConnectionGetProxyInfo<P0>(
    pwszconnectionname: P0,
    r#type: DNS_CONNECTION_PROXY_TYPE,
...
#[inline]
pub unsafe fn DnsConnectionGetProxyInfoForHostUrl<P0>(
    pwszhosturl: P0,
    pselectioncontext: Option<&[u8]>,
...
#[inline]
pub unsafe fn DnsConnectionGetProxyInfoForHostUrlEx<P0, P4>(
    pwszhosturl: P0,
    pselectioncontext: Option<&[u8]>,
    dwexplicitinterfaceindex: u32,
    pwszconnectionname: P4,
    pproxyinfoex: *mut DNS_CONNECTION_PROXY_INFO_EX,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    unsafe {
        DnsConnectionGetProxyInfoForHostUrlEx(
            ...
            pselectioncontext
                ...
                .map_or(0, |slice| slice.len().try_into().unwrap()),
            dwexplicitinterfaceindex,
            pwszconnectionname.param().abi(),
            pproxyinfoex as _,
        )
    }
}
#[inline]
pub unsafe fn DnsConnectionGetProxyList<P0>(
    pwszconnectionname: P0,
...
#[inline]
pub unsafe fn DnsConnectionSetProxyInfo<P0>(
    pwszconnectionname: P0,
    r#type: DNS_CONNECTION_PROXY_TYPE,
...
pub unsafe fn DnsGetApplicationSettings(
    ...
    psettings: Option<*mut DNS_APPLICATION_SETTINGS>,
) -> u32 {
    ...
    unsafe {
        DnsGetApplicationSettings(
            pcservers as _,
            ppdefaultservers as _,
            psettings.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DnsGetProxyInformation(
            hostname.param().abi(),
            proxyinformation as _,
            defaultproxyinformation.unwrap_or(core::mem::zeroed()) as _,
            completionroutine,
...
pub unsafe fn DnsModifyRecordsInSet_A(
    paddrecords: Option<*const DNS_RECORDA>,
    pdeleterecords: Option<*const DNS_RECORDA>,
    options: u32,
    hcredentials: Option<super::super::Foundation::HANDLE>,
    pextralist: Option<*mut core::ffi::c_void>,
    ...
    unsafe {
        DnsModifyRecordsInSet_A(
            paddrecords.unwrap_or(core::mem::zeroed()) as _,
            pdeleterecords.unwrap_or(core::mem::zeroed()) as _,
            options,
            hcredentials.unwrap_or(core::mem::zeroed()) as _,
            pextralist.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn DnsQueryEx(
    ...
    pcancelhandle: Option<*mut DNS_QUERY_CANCEL>,
) -> i32 {
    ...
    unsafe {
        DnsQueryEx(
            pqueryrequest,
            pqueryresults as _,
            pcancelhandle.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn DnsQueryRaw(
    queryrequest: *const DNS_QUERY_RAW_REQUEST,
    cancelhandle: *mut DNS_QUERY_RAW_CANCEL,
) -> i32 {
...
pub unsafe fn DnsQuery_A<P0>(
    ...
    pextra: Option<*mut core::ffi::c_void>,
    ppqueryresults: *mut *mut DNS_RECORDA,
    preserved: Option<*mut *mut core::ffi::c_void>,
...
pub unsafe fn DnsRecordSetCompare(
    ...
    ppdiff1: Option<*mut *mut DNS_RECORDA>,
    ppdiff2: Option<*mut *mut DNS_RECORDA>,
) -> windows_core::BOOL {
    ...
    unsafe {
        DnsRecordSetCompare(
            prr1 as _,
            prr2 as _,
            ppdiff1.unwrap_or(core::mem::zeroed()) as _,
            ppdiff2.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn DnsReplaceRecordSetA(
    ...
    options: u32,
    hcontext: Option<super::super::Foundation::HANDLE>,
    pextrainfo: Option<*mut core::ffi::c_void>,
    preserved: Option<*mut core::ffi::c_void>,
) -> i32 {
    ...
    unsafe {
        DnsReplaceRecordSetA(
            preplaceset,
            options,
            hcontext.unwrap_or(core::mem::zeroed()) as _,
            pextrainfo.unwrap_or(core::mem::zeroed()) as _,
            preserved.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
pub unsafe fn DnsServiceConstructInstance<P0, P1>(
    ...
    keys: *const windows_core::PCWSTR,
    values: *const windows_core::PCWSTR,
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DnsServiceConstructInstance(
            ...
            phostname.param().abi(),
            pip4.unwrap_or(core::mem::zeroed()) as _,
            pip6.unwrap_or(core::mem::zeroed()) as _,
            wport,
            wpriority,
            wweight,
            dwpropertiescount,
...
pub unsafe fn DnsServiceDeRegister(
    ...
    pcancel: Option<*mut DNS_SERVICE_CANCEL>,
) -> u32 {
...
pub unsafe fn DnsSetApplicationSettings(
    pservers: &[DNS_CUSTOM_SERVER],
    psettings: Option<*const DNS_APPLICATION_SETTINGS>,
) -> u32 {
    ...
    unsafe {
        DnsSetApplicationSettings(
            pservers.len().try_into().unwrap(),
            core::mem::transmute(pservers.as_ptr()),
            psettings.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
pub const DNS_CONNECTION_PROXY_INFO_SWITCH_CONFIG: DNS_CONNECTION_PROXY_INFO_SWITCH =
    DNS_CONNECTION_PROXY_INFO_SWITCH(0i32);
pub const DNS_CONNECTION_PROXY_INFO_SWITCH_SCRIPT: DNS_CONNECTION_PROXY_INFO_SWITCH =
    DNS_CONNECTION_PROXY_INFO_SWITCH(1i32);
pub const DNS_CONNECTION_PROXY_INFO_SWITCH_WPAD: DNS_CONNECTION_PROXY_INFO_SWITCH =
...
pub const DNS_CONNECTION_PROXY_TYPE_HTTP: DNS_CONNECTION_PROXY_TYPE =
    DNS_CONNECTION_PROXY_TYPE(1i32);
pub const DNS_CONNECTION_PROXY_TYPE_NULL: DNS_CONNECTION_PROXY_TYPE =
    DNS_CONNECTION_PROXY_TYPE(0i32);
pub const DNS_CONNECTION_PROXY_TYPE_SOCKS4: DNS_CONNECTION_PROXY_TYPE =
    DNS_CONNECTION_PROXY_TYPE(4i32);
pub const DNS_CONNECTION_PROXY_TYPE_SOCKS5: DNS_CONNECTION_PROXY_TYPE =
    DNS_CONNECTION_PROXY_TYPE(5i32);
pub const DNS_CONNECTION_PROXY_TYPE_WAP: DNS_CONNECTION_PROXY_TYPE =
...
pub type DNS_PROXY_COMPLETION_ROUTINE =
    Option<unsafe extern "system" fn(completioncontext: *const core::ffi::c_void, status: i32)>;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const DNS_PROXY_INFORMATION_DEFAULT_SETTINGS: DNS_PROXY_INFORMATION_TYPE =
    DNS_PROXY_INFORMATION_TYPE(1i32);
pub const DNS_PROXY_INFORMATION_DIRECT: DNS_PROXY_INFORMATION_TYPE =
    DNS_PROXY_INFORMATION_TYPE(0i32);
pub const DNS_PROXY_INFORMATION_DOES_NOT_EXIST: DNS_PROXY_INFORMATION_TYPE =
    DNS_PROXY_INFORMATION_TYPE(3i32);
pub const DNS_PROXY_INFORMATION_PROXY_NAME: DNS_PROXY_INFORMATION_TYPE =
...
pub type DNS_QUERY_RAW_COMPLETION_ROUTINE = Option<
    unsafe extern "system" fn(
        querycontext: *const core::ffi::c_void,
        queryresults: *const DNS_QUERY_RAW_RESULT,
    ),
>;
...
pub type PDNS_QUERY_COMPLETION_ROUTINE = Option<
    unsafe extern "system" fn(
        pquerycontext: *const core::ffi::c_void,
        pqueryresults: *mut DNS_QUERY_RESULT,
    ),
>;
pub type PDNS_SERVICE_BROWSE_CALLBACK = Option<
    unsafe extern "system" fn(
        status: u32,
        pquerycontext: *const core::ffi::c_void,
...
>;
pub type PDNS_SERVICE_REGISTER_COMPLETE = Option<
    unsafe extern "system" fn(
        status: u32,
        pquerycontext: *const core::ffi::c_void,
...
>;
pub type PDNS_SERVICE_RESOLVE_COMPLETE = Option<
    unsafe extern "system" fn(
        status: u32,
        pquerycontext: *const core::ffi::c_void,
        pinstance: *const DNS_SERVICE_INSTANCE,
...
>;
pub type PMDNS_QUERY_CALLBACK = Option<
    unsafe extern "system" fn(
        pquerycontext: *const core::ffi::c_void,
...
pub const TAG_DNS_CONNECTION_POLICY_TAG_CONNECTION_MANAGER: DNS_CONNECTION_POLICY_TAG =
    DNS_CONNECTION_POLICY_TAG(1i32);
pub const TAG_DNS_CONNECTION_POLICY_TAG_DEFAULT: DNS_CONNECTION_POLICY_TAG =
    DNS_CONNECTION_POLICY_TAG(0i32);
pub const TAG_DNS_CONNECTION_POLICY_TAG_WWWPT: DNS_CONNECTION_POLICY_TAG =

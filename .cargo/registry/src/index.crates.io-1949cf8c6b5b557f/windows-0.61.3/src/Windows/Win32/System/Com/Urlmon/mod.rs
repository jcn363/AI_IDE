#[inline]
pub unsafe fn CoGetClassObjectFromURL<P1, P4, P5>(
    rclassid: *const windows_core::GUID,
    szcode: P1,
    dwfileversionms: u32,
    dwfileversionls: u32,
    sztype: P4,
...
#[inline]
pub unsafe fn CoInternetCombineIUri<P0, P1>(
    pbaseuri: P0,
    prelativeuri: P1,
    dwcombineflags: u32,
    ppcombineduri: *mut Option<super::IUri>,
    ...
    P1: windows_core::Param<super::IUri>,
{
    ...
    unsafe {
        CoInternetCombineIUri(
            pbaseuri.param().abi(),
            prelativeuri.param().abi(),
            dwcombineflags,
            core::mem::transmute(ppcombineduri),
...
#[inline]
pub unsafe fn CoInternetCombineUrl<P0, P1>(
    pwzbaseurl: P0,
    pwzrelativeurl: P1,
    dwcombineflags: u32,
    pszresult: &mut [u16],
    pcchresult: Option<*mut u32>,
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        CoInternetCombineUrl(
            pwzbaseurl.param().abi(),
            pwzrelativeurl.param().abi(),
            dwcombineflags,
            core::mem::transmute(pszresult.as_ptr()),
            pszresult.len().try_into().unwrap(),
            pcchresult.unwrap_or(core::mem::zeroed()) as _,
            dwreserved.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn CoInternetCompareUrl<P0, P1>(
    pwzurl1: P0,
    pwzurl2: P1,
    dwflags: u32,
) -> windows_core::Result<()>
...
#[inline]
pub unsafe fn CoInternetCreateSecurityManager<P0>(
    psp: P0,
    ppsm: *mut Option<IInternetSecurityManager>,
    dwreserved: u32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<super::IServiceProvider>,
{
    ...
    unsafe {
        CoInternetCreateSecurityManager(psp.param().abi(), core::mem::transmute(ppsm), dwreserved)
            .ok()
    }
}
#[inline]
...
pub unsafe fn CoInternetGetSecurityUrl<P0>(
    pwszurl: P0,
    ppwszsecurl: *mut windows_core::PWSTR,
    psuaction: PSUACTION,
    dwreserved: Option<u32>,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn CoInternetGetSecurityUrlEx<P0>(
    puri: P0,
    ppsecuri: *mut Option<super::IUri>,
    psuaction: PSUACTION,
    dwreserved: Option<usize>,
) -> windows_core::Result<()>
where
...
pub unsafe fn CoInternetGetSession(
    ...
    unsafe {
        CoInternetGetSession(
            dwsessionmode,
            core::mem::transmute(ppiinternetsession),
            dwreserved,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn CoInternetIsFeatureEnabledForIUri<P2, P3>(
    featureentry: INTERNETFEATURELIST,
    dwflags: u32,
    piuri: P2,
    psecmgr: P3,
...
#[inline]
pub unsafe fn CoInternetIsFeatureZoneElevationEnabled<P0, P1, P2>(
    szfromurl: P0,
    sztourl: P1,
    psecmgr: P2,
    dwflags: u32,
...
#[inline]
pub unsafe fn CoInternetParseIUri<P0>(
    piuri: P0,
    ...
    P0: windows_core::Param<super::IUri>,
{
    ...
    unsafe {
        CoInternetParseIUri(
            ...
            parseaction,
            dwflags,
            core::mem::transmute(pwzresult.as_ptr()),
            pwzresult.len().try_into().unwrap(),
            pcchresult as _,
            dwreserved.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
...
#[inline]
pub unsafe fn CoInternetParseUrl<P0>(
    pwzurl: P0,
    parseaction: PARSEACTION,
    dwflags: u32,
    pszresult: &mut [u16],
...
#[inline]
pub unsafe fn CoInternetQueryInfo<P0>(
    pwzurl: P0,
    queryoptions: QUERYOPTION,
    dwqueryflags: u32,
    pvbuffer: *mut core::ffi::c_void,
    cbbuffer: u32,
    pcbbuffer: Option<*mut u32>,
    dwreserved: u32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        CoInternetQueryInfo(
            ...
            pvbuffer as _,
            cbbuffer,
            pcbbuffer.unwrap_or(core::mem::zeroed()) as _,
            dwreserved,
        )
        .ok()
    }
...
pub unsafe fn CompareSecurityIds(
    ...
    unsafe {
        CompareSecurityIds(
            core::mem::transmute(pbsecurityid1.as_ptr()),
            pbsecurityid1.len().try_into().unwrap(),
            core::mem::transmute(pbsecurityid2.as_ptr()),
            pbsecurityid2.len().try_into().unwrap(),
            dwreserved,
        )
        .ok()
    }
...
pub unsafe fn CopyStgMedium(
...
) -> windows_core::Result<super::STGMEDIUM> {
    ...
    unsafe {
        ...
        CopyStgMedium(core::mem::transmute(pcstgmedsrc), &mut result__)
            .map(|| core::mem::transmute(result__))
    }
}
#[inline]
pub unsafe fn CreateAsyncBindCtx<P1, P2>(
    reserved: u32,
    pbscb: P1,
    pefetc: P2,
) -> windows_core::Result<super::IBindCtx>
where
...
#[inline]
pub unsafe fn CreateAsyncBindCtxEx<P0, P2, P3>(
    pbc: P0,
    dwoptions: u32,
    pbscb: P2,
    penum: P3,
    ppbc: *mut Option<super::IBindCtx>,
    reserved: u32,
) -> windows_core::Result<()>
where
...
pub unsafe fn CreateFormatEnumerator(
    rgfmtetc: &[super::FORMATETC],
) -> windows_core::Result<super::IEnumFORMATETC> {
    ...
    unsafe {
        ...
        CreateFormatEnumerator(
            rgfmtetc.len().try_into().unwrap(),
            core::mem::transmute(rgfmtetc.as_ptr()),
            &mut result__,
        )
        .and_then(|| windows_core::Type::from_abi(result__))
    }
...
#[inline]
pub unsafe fn CreateURLMoniker<P0, P1>(
    pmkctx: P0,
    szurl: P1,
) -> windows_core::Result<super::IMoniker>
where
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        CreateURLMoniker(pmkctx.param().abi(), szurl.param().abi(), &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
pub unsafe fn CreateURLMonikerEx<P0, P1>(
    pmkctx: P0,
    szurl: P1,
    ppmk: *mut Option<super::IMoniker>,
    dwflags: u32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<super::IMoniker>,
...
#[inline]
pub unsafe fn CreateURLMonikerEx2<P0, P1>(
    pmkctx: P0,
    puri: P1,
    ppmk: *mut Option<super::IMoniker>,
    dwflags: u32,
...
pub unsafe fn FaultInIEFeature(
    ...
    pquery: Option<*mut super::QUERYCONTEXT>,
    dwflags: u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        FaultInIEFeature(
            hwnd,
            pclassspec,
            pquery.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn FindMediaTypeClass<P0, P1>(
    pbc: P0,
    sztype: P1,
...
#[inline]
pub unsafe fn FindMimeFromData<P0, P1, P4>(
    pbc: P0,
    pwzurl: P1,
    pbuffer: Option<*const core::ffi::c_void>,
    cbsize: u32,
    pwzmimeproposed: P4,
    dwmimeflags: u32,
    ppwzmimeout: *mut windows_core::PWSTR,
    dwreserved: Option<u32>,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<super::IBindCtx>,
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        FindMimeFromData(
            pbc.param().abi(),
            pwzurl.param().abi(),
            pbuffer.unwrap_or(core::mem::zeroed()) as _,
            cbsize,
            pwzmimeproposed.param().abi(),
            dwmimeflags,
            ppwzmimeout as _,
            dwreserved.unwrap_or(core::mem::zeroed()) as _,
        )
...
#[inline]
pub unsafe fn GetSoftwareUpdateInfo<P0>(
    szdistunit: P0,
...
#[inline]
pub unsafe fn HlinkSimpleNavigateToMoniker<P0, P1, P2, P3, P4, P5>(
    pmktarget: P0,
    szlocation: P1,
    sztargetframename: P2,
    punk: P3,
    pbc: P4,
    param5: P5,
    grfhlnf: u32,
    ...
    P5: windows_core::Param<super::IBindStatusCallback>,
{
    ...
    unsafe {
        HlinkSimpleNavigateToMoniker(
            pmktarget.param().abi(),
            szlocation.param().abi(),
            sztargetframename.param().abi(),
            punk.param().abi(),
            pbc.param().abi(),
            param5.param().abi(),
            grfhlnf,
...
#[inline]
pub unsafe fn HlinkSimpleNavigateToString<P0, P1, P2, P3, P4, P5>(
    sztarget: P0,
    szlocation: P1,
    sztargetframename: P2,
    punk: P3,
...
pub unsafe fn RegisterBindStatusCallback<P0, P1>(
    pbc: P0,
    pbscb: P1,
    ppbscbprev: *mut Option<super::IBindStatusCallback>,
    dwreserved: u32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<super::IBindCtx>,
...
pub unsafe fn RegisterMediaTypeClass<P0>(
    pbc: P0,
    ctypes: u32,
    rgsztypes: *const windows_core::PCSTR,
    rgclsid: *const windows_core::GUID,
    reserved: u32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<super::IBindCtx>,
...
#[inline]
pub unsafe fn SetSoftwareUpdateAdvertisementState<P0>(
    szdistunit: P0,
    dwadstate: u32,
...
#[inline]
pub unsafe fn URLDownloadToCacheFileA<P0, P1, P5>(
    param0: P0,
    param1: P1,
    param2: &mut [u8],
    param4: u32,
    ...
    P5: windows_core::Param<super::IBindStatusCallback>,
{
    ...
    unsafe {
        URLDownloadToCacheFileA(
            param0.param().abi(),
            param1.param().abi(),
            core::mem::transmute(param2.as_ptr()),
            param2.len().try_into().unwrap(),
            param4,
            param5.param().abi(),
        )
        .ok()
...
#[inline]
pub unsafe fn URLDownloadToCacheFileW<P0, P1, P5>(
    param0: P0,
    param1: P1,
    param2: &mut [u16],
    param4: u32,
...
#[inline]
pub unsafe fn URLDownloadToFileA<P0, P1, P2, P4>(
    param0: P0,
    param1: P1,
    param2: P2,
    param3: u32,
...
#[inline]
pub unsafe fn URLDownloadToFileW<P0, P1, P2, P4>(
    param0: P0,
    param1: P1,
    param2: P2,
    param3: u32,
...
#[inline]
pub unsafe fn URLOpenBlockingStreamA<P0, P1, P4>(
    param0: P0,
    param1: P1,
    param2: *mut Option<super::IStream>,
    param3: u32,
    param4: P4,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn URLOpenBlockingStreamW<P0, P1, P4>(
    param0: P0,
    param1: P1,
    param2: *mut Option<super::IStream>,
    param3: u32,
...
#[inline]
pub unsafe fn URLOpenPullStreamA<P0, P1, P3>(
    param0: P0,
    param1: P1,
    param2: u32,
    param3: P3,
...
#[inline]
pub unsafe fn URLOpenPullStreamW<P0, P1, P3>(
    param0: P0,
    param1: P1,
    param2: u32,
    param3: P3,
...
#[inline]
pub unsafe fn URLOpenStreamA<P0, P1, P3>(
    param0: P0,
    param1: P1,
    param2: u32,
    param3: P3,
...
#[inline]
pub unsafe fn URLOpenStreamW<P0, P1, P3>(
    param0: P0,
    param1: P1,
    param2: u32,
    param3: P3,
...
pub unsafe fn UrlMkGetSessionOption(
    dwoption: u32,
    pbuffer: Option<*mut core::ffi::c_void>,
    dwbufferlength: u32,
...
windows_core::imp::define_interface!(
    ...
    0x11c81bc2_121e_4ed5_b9c4_b430bd54f2c0
);
windows_core::imp::interface_hierarchy!(IBindCallbackRedirect, windows_core::IUnknown);
impl IBindCallbackRedirect {
    pub unsafe fn Redirect<P0>(
        &self,
        lpcurl: P0,
    ) -> windows_core::Result<super::super::super::Foundation::VARIANT_BOOL>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
windows_core::imp::define_interface!(
    ...
    0xa9eda967_f50e_4a33_b358_206f6ef3086d
);
...
impl IBindHttpSecurity {
    pub unsafe fn GetIgnoreCertMask(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetIgnoreCertMask)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
impl IBindHttpSecurity_Vtbl {
    pub const fn new<Identity: IBindHttpSecurity_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetIgnoreCertMask<
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetIgnoreCertMask: GetIgnoreCertMask::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IBindProtocol,
    IBindProtocol_Vtbl,
    0x79eac9cd_baf9_11ce_8c82_00aa004ba90b
);
...
impl IBindProtocol {
    pub unsafe fn CreateBinding<P0, P1>(
        ...
        szurl: P0,
        pbc: P1,
    ) -> windows_core::Result<super::IBinding>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<super::IBindCtx>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateBinding)(
                windows_core::Interface::as_raw(self),
                szurl.param().abi(),
                pbc.param().abi(),
                &mut result__,
...
pub struct IBindProtocol_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateBinding: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut core::ffi::c_void,
...
pub trait IBindProtocol_Impl: windows_core::IUnknownImpl {
    fn CreateBinding(
        &self,
        szurl: &windows_core::PCWSTR,
        pbc: windows_core::Ref<'_, super::IBindCtx>,
    ) -> windows_core::Result<super::IBinding>;
}
impl IBindProtocol_Vtbl {
    pub const fn new<Identity: IBindProtocol_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateBinding<
        ...
        >(
            ...
            ppb: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IBindProtocol_Impl::CreateBinding(
                    this,
                    core::mem::transmute(&szurl),
...
windows_core::imp::define_interface!(
    ...
    0x711c7600_6b48_11d1_b403_00aa00b92af1
);
...
impl ICatalogFileInfo {
    pub unsafe fn GetCatalogFile(&self) -> windows_core::Result<windows_core::PSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCatalogFile)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetJavaTrust(
        &self,
        ppjavatrust: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetJavaTrust)(
                windows_core::Interface::as_raw(self),
                ppjavatrust as _,
            )
            .ok()
...
pub struct ICatalogFileInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetCatalogFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PSTR,
    ) -> windows_core::HRESULT,
    pub GetJavaTrust: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ICatalogFileInfo_Vtbl {
    pub const fn new<Identity: ICatalogFileInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCatalogFile<
            Identity: ICatalogFileInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppszcatalogfile: *mut windows_core::PSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetJavaTrust<
            Identity: ICatalogFileInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICatalogFileInfo_Impl::GetJavaTrust(this, core::mem::transmute_copy(&ppjavatrust))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ICodeInstall,
    ICodeInstall_Vtbl,
    0x79eac9d1_baf9_11ce_8c82_00aa004ba90b
);
...
impl ICodeInstall {
    pub unsafe fn OnCodeInstallProblem<P1, P2>(
        &self,
        ulstatuscode: u32,
        szdestination: P1,
        szsource: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnCodeInstallProblem)(
                windows_core::Interface::as_raw(self),
                ulstatuscode,
                szdestination.param().abi(),
                szsource.param().abi(),
                dwreserved,
            )
            .ok()
...
pub struct ICodeInstall_Vtbl {
    ...
    pub OnCodeInstallProblem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
pub trait ICodeInstall_Impl: IWindowForBindingUI_Impl {
    fn OnCodeInstallProblem(
        &self,
        ulstatuscode: u32,
        szdestination: &windows_core::PCWSTR,
...
impl ICodeInstall_Vtbl {
    pub const fn new<Identity: ICodeInstall_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnCodeInstallProblem<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICodeInstall_Impl::OnCodeInstallProblem(
                    this,
                    core::mem::transmute_copy(&ulstatuscode),
                    core::mem::transmute(&szdestination),
        ...
        Self {
            base__: IWindowForBindingUI_Vtbl::new::<Identity, OFFSET>(),
            OnCodeInstallProblem: OnCodeInstallProblem::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IDataFilter,
    IDataFilter_Vtbl,
    0x69d14c80_c18e_11d0_a9ce_006097942311
);
...
impl IDataFilter {
    pub unsafe fn DoEncode(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DoEncode)(
                windows_core::Interface::as_raw(self),
                dwflags,
                pbinbuffer.len().try_into().unwrap(),
                core::mem::transmute(pbinbuffer.as_ptr()),
                pboutbuffer.len().try_into().unwrap(),
                core::mem::transmute(pboutbuffer.as_ptr()),
                linbytesavailable,
                plinbytesread as _,
                ploutbyteswritten as _,
                dwreserved,
            )
            .ok()
        }
    ...
    pub unsafe fn DoDecode(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DoDecode)(
                windows_core::Interface::as_raw(self),
                dwflags,
                pbinbuffer.len().try_into().unwrap(),
                core::mem::transmute(pbinbuffer.as_ptr()),
    ...
    pub unsafe fn SetEncodingLevel(&self, dwenclevel: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetEncodingLevel)(
                windows_core::Interface::as_raw(self),
                dwenclevel,
            )
            .ok()
...
pub struct IDataFilter_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub DoEncode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        i32,
        *const u8,
    ...
    pub DoDecode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        i32,
        *const u8,
...
impl IDataFilter_Vtbl {
    pub const fn new<Identity: IDataFilter_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DoEncode<Identity: IDataFilter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwflags: u32,
            linbuffersize: i32,
            pbinbuffer: *const u8,
            ...
            unsafe {
                ...
                IDataFilter_Impl::DoEncode(
                    ...
                    core::mem::transmute_copy(&linbuffersize),
                    core::mem::transmute_copy(&pbinbuffer),
                    core::mem::transmute_copy(&loutbuffersize),
                    core::mem::transmute_copy(&pboutbuffer),
                    core::mem::transmute_copy(&linbytesavailable),
                    core::mem::transmute_copy(&plinbytesread),
                    core::mem::transmute_copy(&ploutbyteswritten),
                    core::mem::transmute_copy(&dwreserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn DoDecode<Identity: IDataFilter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwflags: u32,
            linbuffersize: i32,
            pbinbuffer: *const u8,
        ...
        unsafe extern "system" fn SetEncodingLevel<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDataFilter_Impl::SetEncodingLevel(this, core::mem::transmute_copy(&dwenclevel))
                    .into()
            }
        }
        Self {
...
impl IEncodingFilterFactory {
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindBestFilter)(
                windows_core::Interface::as_raw(self),
                pwzcodein.param().abi(),
                pwzcodeout.param().abi(),
    ...
    pub unsafe fn GetDefaultFilter<P0, P1>(
        &self,
        pwzcodein: P0,
        pwzcodeout: P1,
    ) -> windows_core::Result<IDataFilter>
...
pub struct IEncodingFilterFactory_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub FindBestFilter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        DATAINFO,
...
pub trait IEncodingFilterFactory_Impl: windows_core::IUnknownImpl {
    fn FindBestFilter(
        &self,
        pwzcodein: &windows_core::PCWSTR,
        pwzcodeout: &windows_core::PCWSTR,
        info: &DATAINFO,
    ) -> windows_core::Result<IDataFilter>;
    fn GetDefaultFilter(
        &self,
...
impl IEncodingFilterFactory_Vtbl {
    pub const fn new<Identity: IEncodingFilterFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn FindBestFilter<
        ...
        >(
            ...
            pwzcodeout: windows_core::PCWSTR,
            info: DATAINFO,
            ppdf: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IEncodingFilterFactory_Impl::FindBestFilter(
                    this,
                    core::mem::transmute(&pwzcodein),
                    core::mem::transmute(&pwzcodeout),
                    core::mem::transmute(&info),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IEncodingFilterFactory_Impl::GetDefaultFilter(
                    this,
                    core::mem::transmute(&pwzcodein),
                    core::mem::transmute(&pwzcodeout),
                ) {
...
windows_core::imp::define_interface!(
    IGetBindHandle,
    IGetBindHandle_Vtbl,
    0xaf0ff408_129d_4b20_91f0_02bd23d88352
);
...
impl IGetBindHandle {
    pub unsafe fn GetBindHandle(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetBindHandle)(
                windows_core::Interface::as_raw(self),
                enumrequestedhandle,
                &mut result__,
            )
...
pub struct IGetBindHandle_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetBindHandle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        BINDHANDLETYPES,
...
impl IGetBindHandle_Vtbl {
    pub const fn new<Identity: IGetBindHandle_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetBindHandle<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IGetBindHandle_Impl::GetBindHandle(
                    this,
                    core::mem::transmute_copy(&enumrequestedhandle),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetBindHandle: GetBindHandle::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IHttpNegotiate,
    IHttpNegotiate_Vtbl,
    0x79eac9d2_baf9_11ce_8c82_00aa004ba90b
);
windows_core::imp::interface_hierarchy!(IHttpNegotiate, windows_core::IUnknown);
impl IHttpNegotiate {
    pub unsafe fn BeginningTransaction<P0, P1>(
        &self,
        szurl: P0,
        szheaders: P1,
        dwreserved: u32,
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BeginningTransaction)(
                windows_core::Interface::as_raw(self),
                szurl.param().abi(),
                szheaders.param().abi(),
                dwreserved,
    ...
    pub unsafe fn OnResponse<P1, P2>(
        &self,
        dwresponsecode: u32,
        szresponseheaders: P1,
        szrequestheaders: P2,
    ) -> windows_core::Result<windows_core::PWSTR>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OnResponse)(
                windows_core::Interface::as_raw(self),
                dwresponsecode,
                szresponseheaders.param().abi(),
                szrequestheaders.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
...
pub struct IHttpNegotiate_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub BeginningTransaction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        u32,
    ...
    pub OnResponse: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
pub trait IHttpNegotiate_Impl: windows_core::IUnknownImpl {
    fn BeginningTransaction(
        &self,
        szurl: &windows_core::PCWSTR,
        szheaders: &windows_core::PCWSTR,
        dwreserved: u32,
    ) -> windows_core::Result<windows_core::PWSTR>;
    fn OnResponse(
        &self,
        dwresponsecode: u32,
        szresponseheaders: &windows_core::PCWSTR,
        szrequestheaders: &windows_core::PCWSTR,
    ) -> windows_core::Result<windows_core::PWSTR>;
}
impl IHttpNegotiate_Vtbl {
    pub const fn new<Identity: IHttpNegotiate_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BeginningTransaction<
        ...
        >(
            ...
            szheaders: windows_core::PCWSTR,
            dwreserved: u32,
            pszadditionalheaders: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHttpNegotiate_Impl::BeginningTransaction(
                    this,
                    core::mem::transmute(&szurl),
                    core::mem::transmute(&szheaders),
                    core::mem::transmute_copy(&dwreserved),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn OnResponse<Identity: IHttpNegotiate_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwresponsecode: u32,
            szresponseheaders: windows_core::PCWSTR,
            szrequestheaders: windows_core::PCWSTR,
            pszadditionalrequestheaders: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IHttpNegotiate_Impl::OnResponse(
                    this,
                    core::mem::transmute_copy(&dwresponsecode),
                    core::mem::transmute(&szresponseheaders),
                    core::mem::transmute(&szrequestheaders),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0x4f9f9fcb_e0f4_48eb_b7ab_fa2ea9365cb4
);
...
impl IHttpNegotiate2 {
    pub unsafe fn GetRootSecurityId(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetRootSecurityId)(
                windows_core::Interface::as_raw(self),
                pbsecurityid as _,
                pcbsecurityid as _,
                dwreserved,
...
pub struct IHttpNegotiate2_Vtbl {
    ...
    pub GetRootSecurityId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u8,
        *mut u32,
        usize,
...
impl IHttpNegotiate2_Vtbl {
    pub const fn new<Identity: IHttpNegotiate2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetRootSecurityId<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHttpNegotiate2_Impl::GetRootSecurityId(
                    this,
                    core::mem::transmute_copy(&pbsecurityid),
                    core::mem::transmute_copy(&pcbsecurityid),
                    core::mem::transmute_copy(&dwreserved),
                )
                .into()
            }
        ...
        Self {
            base__: IHttpNegotiate_Vtbl::new::<Identity, OFFSET>(),
            GetRootSecurityId: GetRootSecurityId::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x57b6c80a_34c2_4602_bc26_66a02fc57153
);
...
impl IHttpNegotiate3 {
    pub unsafe fn GetSerializedClientCertContext(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetSerializedClientCertContext)(
                windows_core::Interface::as_raw(self),
                ppbcert as _,
                pcbcert as _,
            )
...
pub struct IHttpNegotiate3_Vtbl {
    ...
    pub GetSerializedClientCertContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
...
impl IHttpNegotiate3_Vtbl {
    pub const fn new<Identity: IHttpNegotiate3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetSerializedClientCertContext<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHttpNegotiate3_Impl::GetSerializedClientCertContext(
                    this,
                    core::mem::transmute_copy(&ppbcert),
                    core::mem::transmute_copy(&pcbcert),
                )
                .into()
            }
        }
        Self {
            base__: IHttpNegotiate2_Vtbl::new::<Identity, OFFSET>(),
            GetSerializedClientCertContext: GetSerializedClientCertContext::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IHttpSecurity,
    IHttpSecurity_Vtbl,
    0x79eac9d7_bafa_11ce_8c82_00aa004ba90b
);
...
impl IHttpSecurity {
    pub unsafe fn OnSecurityProblem(&self, dwproblem: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnSecurityProblem)(
                windows_core::Interface::as_raw(self),
                dwproblem,
            )
            .ok()
...
impl IHttpSecurity_Vtbl {
    pub const fn new<Identity: IHttpSecurity_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnSecurityProblem<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IHttpSecurity_Impl::OnSecurityProblem(this, core::mem::transmute_copy(&dwproblem))
                    .into()
            }
        }
        Self {
            base__: IWindowForBindingUI_Vtbl::new::<Identity, OFFSET>(),
            OnSecurityProblem: OnSecurityProblem::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IInternet,
    IInternet_Vtbl,
    0x79eac9e0_baf9_11ce_8c82_00aa004ba90b
);
...
windows_core::imp::define_interface!(
    ...
    0x79eac9e1_baf9_11ce_8c82_00aa004ba90b
);
...
impl IInternetBindInfo {
    ...
    pub unsafe fn GetBindString(
        &self,
        ulstringtype: u32,
        ppwzstr: *mut windows_core::PWSTR,
        cel: u32,
        pcelfetched: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetBindString)(
                windows_core::Interface::as_raw(self),
                ulstringtype,
                ppwzstr as _,
                cel,
...
pub struct IInternetBindInfo_Vtbl {
    ...
    GetBindInfo: usize,
    pub GetBindString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut windows_core::PWSTR,
        u32,
    ...
    pub const fn new<Identity: IInternetBindInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetBindInfo_Impl::GetBindInfo(
                    this,
        ...
        unsafe extern "system" fn GetBindString<
            Identity: IInternetBindInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetBindInfo_Impl::GetBindString(
                    this,
                    core::mem::transmute_copy(&ulstringtype),
                    core::mem::transmute_copy(&ppwzstr),
                    core::mem::transmute_copy(&cel),
                    core::mem::transmute_copy(&pcelfetched),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xa3e015b7_a82c_4dcd_a150_569aeeed36ab
);
    ...
    pub const fn new<Identity: IInternetBindInfoEx_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetBindInfoEx_Impl::GetBindInfoEx(
                    this,
                    core::mem::transmute_copy(&grfbindf),
                    core::mem::transmute_copy(&pbindinfo),
        ...
        Self {
            base__: IInternetBindInfo_Vtbl::new::<Identity, OFFSET>(),
...
windows_core::imp::define_interface!(
    ...
    0x3af280b6_cb3f_11d0_891e_00c04fb6bfc4
);
...
impl IInternetHostSecurityManager {
    pub unsafe fn GetSecurityId(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetSecurityId)(
                windows_core::Interface::as_raw(self),
                pbsecurityid as _,
                pcbsecurityid as _,
                dwreserved,
    ...
    pub unsafe fn ProcessUrlAction(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ProcessUrlAction)(
                windows_core::Interface::as_raw(self),
                dwaction,
                core::mem::transmute(ppolicy.as_ptr()),
                ppolicy.len().try_into().unwrap(),
                core::mem::transmute(
                    pcontext
                        .as_deref()
    ...
    pub unsafe fn QueryCustomPolicy(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).QueryCustomPolicy)(
                windows_core::Interface::as_raw(self),
                guidkey,
                pppolicy as _,
                pcbpolicy as _,
...
pub struct IInternetHostSecurityManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetSecurityId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u8,
        *mut u32,
        usize,
    ) -> windows_core::HRESULT,
    pub ProcessUrlAction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u8,
        u32,
    ...
    pub QueryCustomPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IInternetHostSecurityManager_Vtbl {
    pub const fn new<Identity: IInternetHostSecurityManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetSecurityId<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetHostSecurityManager_Impl::GetSecurityId(
                    this,
                    core::mem::transmute_copy(&pbsecurityid),
                    core::mem::transmute_copy(&pcbsecurityid),
                    core::mem::transmute_copy(&dwreserved),
        ...
        unsafe extern "system" fn ProcessUrlAction<
            Identity: IInternetHostSecurityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetHostSecurityManager_Impl::ProcessUrlAction(
                    this,
                    core::mem::transmute_copy(&dwaction),
                    core::mem::transmute_copy(&ppolicy),
                    core::mem::transmute_copy(&cbpolicy),
                    core::mem::transmute_copy(&pcontext),
                    core::mem::transmute_copy(&cbcontext),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&dwreserved),
                )
                .into()
        ...
        unsafe extern "system" fn QueryCustomPolicy<
            Identity: IInternetHostSecurityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetHostSecurityManager_Impl::QueryCustomPolicy(
                    this,
                    core::mem::transmute_copy(&guidkey),
                    core::mem::transmute_copy(&pppolicy),
                    core::mem::transmute_copy(&pcbpolicy),
                    core::mem::transmute_copy(&pcontext),
                    core::mem::transmute_copy(&cbcontext),
                    core::mem::transmute_copy(&dwreserved),
                )
...
windows_core::imp::define_interface!(
    ...
    0x79eac9eb_baf9_11ce_8c82_00aa004ba90b
);
    ...
    pub const fn new<Identity: IInternetPriority_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetPriority_Impl::SetPriority(this, core::mem::transmute_copy(&npriority))
                    .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x79eac9e4_baf9_11ce_8c82_00aa004ba90b
);
...
impl IInternetProtocol {
    pub unsafe fn Read(&self, pv: &mut [u8], pcbread: *mut u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Read)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pv.as_ptr()),
                pv.len().try_into().unwrap(),
                pcbread as _,
            )
            .ok()
        }
    ...
    pub unsafe fn LockRequest(&self, dwoptions: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).LockRequest)(
                windows_core::Interface::as_raw(self),
                dwoptions,
            )
            .ok()
    ...
    pub unsafe fn UnlockRequest(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).UnlockRequest)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
impl IInternetProtocol_Vtbl {
    pub const fn new<Identity: IInternetProtocol_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Read<Identity: IInternetProtocol_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pv: *mut core::ffi::c_void,
            cb: u32,
            pcbread: *mut u32,
        ...
        unsafe extern "system" fn Seek<Identity: IInternetProtocol_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dlibmove: i64,
            dworigin: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IInternetProtocol_Impl::Seek(
                    this,
        ...
        unsafe extern "system" fn LockRequest<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocol_Impl::LockRequest(this, core::mem::transmute_copy(&dwoptions))
                    .into()
            }
        }
        unsafe extern "system" fn UnlockRequest<
            Identity: IInternetProtocol_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xc7a98e66_1010_492c_a1c8_c809e1f75905
);
...
impl IInternetProtocolEx {
    pub unsafe fn StartEx<P0, P1, P2>(
        &self,
        puri: P0,
        poiprotsink: P1,
        poibindinfo: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StartEx)(
                windows_core::Interface::as_raw(self),
                puri.param().abi(),
                poiprotsink.param().abi(),
                poibindinfo.param().abi(),
                grfpi,
                dwreserved,
            )
            .ok()
...
pub struct IInternetProtocolEx_Vtbl {
    ...
    pub StartEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        super::super::super::Foundation::HANDLE_PTR,
    ) -> windows_core::HRESULT,
}
pub trait IInternetProtocolEx_Impl: IInternetProtocol_Impl {
    fn StartEx(
        &self,
        puri: windows_core::Ref<'_, super::IUri>,
        poiprotsink: windows_core::Ref<'_, IInternetProtocolSink>,
        poibindinfo: windows_core::Ref<'_, IInternetBindInfo>,
        grfpi: u32,
        dwreserved: super::super::super::Foundation::HANDLE_PTR,
    ) -> windows_core::Result<()>;
}
impl IInternetProtocolEx_Vtbl {
    pub const fn new<Identity: IInternetProtocolEx_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn StartEx<
            Identity: IInternetProtocolEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            puri: *mut core::ffi::c_void,
            poiprotsink: *mut core::ffi::c_void,
            poibindinfo: *mut core::ffi::c_void,
            grfpi: u32,
            dwreserved: super::super::super::Foundation::HANDLE_PTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolEx_Impl::StartEx(
                    this,
                    core::mem::transmute_copy(&puri),
                    core::mem::transmute_copy(&poiprotsink),
                    core::mem::transmute_copy(&poibindinfo),
                    core::mem::transmute_copy(&grfpi),
                    core::mem::transmute_copy(&dwreserved),
                )
                .into()
            }
        ...
        Self {
            base__: IInternetProtocol_Vtbl::new::<Identity, OFFSET>(),
            StartEx: StartEx::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IInternetProtocolInfo {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ParseUrl)(
                windows_core::Interface::as_raw(self),
                pwzurl.param().abi(),
                parseaction,
                dwparseflags,
                core::mem::transmute(pwzresult),
                cchresult,
                pcchresult as _,
                dwreserved,
            )
    ...
    pub unsafe fn CombineUrl<P0, P1, P3>(
        &self,
        pwzbaseurl: P0,
        pwzrelativeurl: P1,
        dwcombineflags: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CombineUrl)(
                windows_core::Interface::as_raw(self),
                pwzbaseurl.param().abi(),
                pwzrelativeurl.param().abi(),
                dwcombineflags,
    ...
    pub unsafe fn CompareUrl<P0, P1>(
        &self,
        pwzurl1: P0,
        pwzurl2: P1,
        dwcompareflags: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CompareUrl)(
                windows_core::Interface::as_raw(self),
                pwzurl1.param().abi(),
                pwzurl2.param().abi(),
                dwcompareflags,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).QueryInfo)(
                windows_core::Interface::as_raw(self),
                pwzurl.param().abi(),
                oueryoption,
                dwqueryflags,
...
pub struct IInternetProtocolInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ParseUrl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        PARSEACTION,
        u32,
    ...
    pub CombineUrl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        u32,
    ...
    pub CompareUrl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        u32,
    ) -> windows_core::HRESULT,
    pub QueryInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        QUERYOPTION,
        u32,
...
pub trait IInternetProtocolInfo_Impl: windows_core::IUnknownImpl {
    ...
    fn CombineUrl(
        &self,
        pwzbaseurl: &windows_core::PCWSTR,
        pwzrelativeurl: &windows_core::PCWSTR,
        dwcombineflags: u32,
        pwzresult: &windows_core::PCWSTR,
        cchresult: u32,
        pcchresult: *mut u32,
        dwreserved: u32,
    ) -> windows_core::Result<()>;
    fn CompareUrl(
        &self,
        pwzurl1: &windows_core::PCWSTR,
        pwzurl2: &windows_core::PCWSTR,
        dwcompareflags: u32,
    ) -> windows_core::Result<()>;
    fn QueryInfo(
        &self,
...
impl IInternetProtocolInfo_Vtbl {
    pub const fn new<Identity: IInternetProtocolInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ParseUrl<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolInfo_Impl::ParseUrl(
                    this,
                    core::mem::transmute(&pwzurl),
                    core::mem::transmute_copy(&parseaction),
                    core::mem::transmute_copy(&dwparseflags),
                    core::mem::transmute_copy(&pwzresult),
                    core::mem::transmute_copy(&cchresult),
        ...
        unsafe extern "system" fn CombineUrl<
            Identity: IInternetProtocolInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolInfo_Impl::CombineUrl(
                    this,
                    core::mem::transmute(&pwzbaseurl),
                    core::mem::transmute(&pwzrelativeurl),
                    core::mem::transmute_copy(&dwcombineflags),
                    core::mem::transmute(&pwzresult),
                    core::mem::transmute_copy(&cchresult),
                    core::mem::transmute_copy(&pcchresult),
                    core::mem::transmute_copy(&dwreserved),
        ...
        unsafe extern "system" fn CompareUrl<
            Identity: IInternetProtocolInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolInfo_Impl::CompareUrl(
                    this,
                    core::mem::transmute(&pwzurl1),
                    core::mem::transmute(&pwzurl2),
                    core::mem::transmute_copy(&dwcompareflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn QueryInfo<
            Identity: IInternetProtocolInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolInfo_Impl::QueryInfo(
                    this,
                    core::mem::transmute(&pwzurl),
                    core::mem::transmute_copy(&oueryoption),
                    core::mem::transmute_copy(&dwqueryflags),
                    core::mem::transmute_copy(&pbuffer),
                    core::mem::transmute_copy(&cbbuffer),
                    core::mem::transmute_copy(&pcbbuf),
                    core::mem::transmute_copy(&dwreserved),
                )
                .into()
            }
...
impl IInternetProtocolRoot {
    ...
    pub unsafe fn Continue(&self, pprotocoldata: *const PROTOCOLDATA) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Continue)(
                windows_core::Interface::as_raw(self),
                pprotocoldata,
            )
            .ok()
...
pub struct IInternetProtocolRoot_Vtbl {
    ...
    pub Continue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const PROTOCOLDATA,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IInternetProtocolRoot_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolRoot_Impl::Start(
                    this,
                    core::mem::transmute(&szurl),
                    core::mem::transmute_copy(&poiprotsink),
                    core::mem::transmute_copy(&poibindinfo),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolRoot_Impl::Continue(
                    this,
                    core::mem::transmute_copy(&pprotocoldata),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolRoot_Impl::Abort(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolRoot_Impl::Terminate(this, core::mem::transmute_copy(&dwoptions))
                    .into()
            }
        }
...
impl IInternetProtocolSink {
    pub unsafe fn Switch(&self, pprotocoldata: *const PROTOCOLDATA) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Switch)(
                windows_core::Interface::as_raw(self),
                pprotocoldata,
            )
            .ok()
    ...
    pub unsafe fn ReportProgress<P1>(
        &self,
        ulstatuscode: u32,
        szstatustext: P1,
    ) -> windows_core::Result<()>
    ...
    pub unsafe fn ReportData(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ReportData)(
                windows_core::Interface::as_raw(self),
                grfbscf,
                ulprogress,
                ulprogressmax,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ReportResult)(
                windows_core::Interface::as_raw(self),
                hrresult,
                dwerror,
                szresult.param().abi(),
...
pub struct IInternetProtocolSink_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Switch: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const PROTOCOLDATA,
    ) -> windows_core::HRESULT,
    ...
    pub ReportResult: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::HRESULT,
        u32,
        windows_core::PCWSTR,
    ...
    pub const fn new<Identity: IInternetProtocolSink_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolSink_Impl::Switch(this, core::mem::transmute_copy(&pprotocoldata))
                    .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolSink_Impl::ReportProgress(
                    this,
                    core::mem::transmute_copy(&ulstatuscode),
        ...
        unsafe extern "system" fn ReportData<
            Identity: IInternetProtocolSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolSink_Impl::ReportData(
                    this,
        ...
        unsafe extern "system" fn ReportResult<
            Identity: IInternetProtocolSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolSink_Impl::ReportResult(
                    this,
                    core::mem::transmute_copy(&hrresult),
                    core::mem::transmute_copy(&dwerror),
                    core::mem::transmute(&szresult),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x79eac9f0_baf9_11ce_8c82_00aa004ba90b
);
...
impl IInternetProtocolSinkStackable {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SwitchSink)(
                windows_core::Interface::as_raw(self),
                poiprotsink.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn CommitSwitch(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CommitSwitch)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn RollbackSwitch(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RollbackSwitch)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub struct IInternetProtocolSinkStackable_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SwitchSink: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl IInternetProtocolSinkStackable_Vtbl {
    pub const fn new<Identity: IInternetProtocolSinkStackable_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SwitchSink<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetProtocolSinkStackable_Impl::SwitchSink(
                    this,
                    core::mem::transmute_copy(&poiprotsink),
                )
                .into()
        ...
        unsafe extern "system" fn CommitSwitch<
            Identity: IInternetProtocolSinkStackable_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn RollbackSwitch<
            Identity: IInternetProtocolSinkStackable_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x79eac9ee_baf9_11ce_8c82_00aa004ba90b
);
...
impl IInternetSecurityManager {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetSecuritySite)(
                windows_core::Interface::as_raw(self),
                psite.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn GetSecuritySite(&self) -> windows_core::Result<IInternetSecurityMgrSite> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSecuritySite)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).MapUrlToZone)(
                windows_core::Interface::as_raw(self),
                pwszurl.param().abi(),
                pdwzone as _,
                dwflags,
    ...
    pub unsafe fn GetSecurityId<P0>(
        &self,
        pwszurl: P0,
        pbsecurityid: &mut [u8; 512],
        pcbsecurityid: *mut u32,
        dwreserved: usize,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetSecurityId)(
                windows_core::Interface::as_raw(self),
                pwszurl.param().abi(),
                core::mem::transmute(pbsecurityid.as_ptr()),
                pcbsecurityid as _,
                dwreserved,
            )
            .ok()
    ...
    pub unsafe fn ProcessUrlAction<P0>(
        &self,
        pwszurl: P0,
        dwaction: u32,
        ppolicy: &mut [u8],
    ...
    pub unsafe fn QueryCustomPolicy<P0>(
        &self,
        pwszurl: P0,
        guidkey: *const windows_core::GUID,
        pppolicy: *mut *mut u8,
    ...
    pub unsafe fn SetZoneMapping<P1>(
        &self,
        dwzone: u32,
        lpszpattern: P1,
        dwflags: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetZoneMapping)(
                windows_core::Interface::as_raw(self),
                dwzone,
                lpszpattern.param().abi(),
                dwflags,
            )
            .ok()
        }
    ...
    pub unsafe fn GetZoneMappings(
        &self,
        dwzone: u32,
        ppenumstring: *mut Option<super::IEnumString>,
        dwflags: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetZoneMappings)(
                windows_core::Interface::as_raw(self),
                dwzone,
                core::mem::transmute(ppenumstring),
                dwflags,
            )
            .ok()
        }
...
pub struct IInternetSecurityManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetSecuritySite: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetSecuritySite: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub MapUrlToZone: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut u32,
        u32,
    ...
    pub SetZoneMapping: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        u32,
    ) -> windows_core::HRESULT,
    pub GetZoneMappings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
        u32,
...
pub trait IInternetSecurityManager_Impl: windows_core::IUnknownImpl {
    fn SetSecuritySite(
        &self,
        psite: windows_core::Ref<'_, IInternetSecurityMgrSite>,
    ) -> windows_core::Result<()>;
    ...
    fn SetZoneMapping(
        &self,
        dwzone: u32,
        lpszpattern: &windows_core::PCWSTR,
        dwflags: u32,
    ) -> windows_core::Result<()>;
    fn GetZoneMappings(
        &self,
        dwzone: u32,
        ppenumstring: windows_core::OutRef<'_, super::IEnumString>,
        dwflags: u32,
    ) -> windows_core::Result<()>;
}
impl IInternetSecurityManager_Vtbl {
    pub const fn new<Identity: IInternetSecurityManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetSecuritySite<
            Identity: IInternetSecurityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            psite: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityManager_Impl::SetSecuritySite(
                    this,
                    core::mem::transmute_copy(&psite),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetSecuritySite<
            Identity: IInternetSecurityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppsite: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn MapUrlToZone<
            Identity: IInternetSecurityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityManager_Impl::MapUrlToZone(
                    this,
                    core::mem::transmute(&pwszurl),
                    core::mem::transmute_copy(&pdwzone),
                    core::mem::transmute_copy(&dwflags),
                )
                .into()
            }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityManager_Impl::GetSecurityId(
                    this,
                    core::mem::transmute(&pwszurl),
                    core::mem::transmute_copy(&pbsecurityid),
                    core::mem::transmute_copy(&pcbsecurityid),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityManager_Impl::ProcessUrlAction(
                    this,
                    core::mem::transmute(&pwszurl),
                    core::mem::transmute_copy(&dwaction),
                    core::mem::transmute_copy(&ppolicy),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityManager_Impl::QueryCustomPolicy(
                    this,
                    core::mem::transmute(&pwszurl),
                    core::mem::transmute_copy(&guidkey),
                    core::mem::transmute_copy(&pppolicy),
        ...
        unsafe extern "system" fn SetZoneMapping<
            Identity: IInternetSecurityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityManager_Impl::SetZoneMapping(
                    this,
                    core::mem::transmute_copy(&dwzone),
                    core::mem::transmute(&lpszpattern),
                    core::mem::transmute_copy(&dwflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetZoneMappings<
            Identity: IInternetSecurityManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dwzone: u32,
            ppenumstring: *mut *mut core::ffi::c_void,
            dwflags: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityManager_Impl::GetZoneMappings(
                    this,
                    core::mem::transmute_copy(&dwzone),
                    core::mem::transmute_copy(&ppenumstring),
                    core::mem::transmute_copy(&dwflags),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0xf164edf1_cc7c_4f0d_9a94_34222625c393
);
...
impl IInternetSecurityManagerEx {
    pub unsafe fn ProcessUrlActionEx<P0>(
        &self,
        pwszurl: P0,
        dwaction: u32,
        ppolicy: &mut [u8],
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ProcessUrlActionEx)(
                windows_core::Interface::as_raw(self),
                pwszurl.param().abi(),
                dwaction,
                core::mem::transmute(ppolicy.as_ptr()),
...
pub struct IInternetSecurityManagerEx_Vtbl {
    ...
    pub ProcessUrlActionEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        *mut u8,
...
impl IInternetSecurityManagerEx_Vtbl {
    pub const fn new<Identity: IInternetSecurityManagerEx_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ProcessUrlActionEx<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityManagerEx_Impl::ProcessUrlActionEx(
                    this,
                    core::mem::transmute(&pwszurl),
                    core::mem::transmute_copy(&dwaction),
                    core::mem::transmute_copy(&ppolicy),
                    ...
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&dwreserved),
                    core::mem::transmute_copy(&pdwoutflags),
                )
                .into()
            }
        }
        Self {
            base__: IInternetSecurityManager_Vtbl::new::<Identity, OFFSET>(),
            ProcessUrlActionEx: ProcessUrlActionEx::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xf1e50292_a795_4117_8e09_2b560a72ac60
);
...
impl IInternetSecurityManagerEx2 {
    pub unsafe fn MapUrlToZoneEx2<P0>(
        &self,
        puri: P0,
        pdwzone: *mut u32,
        dwflags: u32,
        ppwszmappedurl: Option<*mut windows_core::PWSTR>,
        pdwoutflags: Option<*mut u32>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::IUri>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).MapUrlToZoneEx2)(
                windows_core::Interface::as_raw(self),
                puri.param().abi(),
                pdwzone as _,
                dwflags,
                ppwszmappedurl.unwrap_or(core::mem::zeroed()) as _,
                pdwoutflags.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn ProcessUrlActionEx2<P0>(
        &self,
        puri: P0,
        dwaction: u32,
        ppolicy: &mut [u8],
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ProcessUrlActionEx2)(
                windows_core::Interface::as_raw(self),
                puri.param().abi(),
                dwaction,
                core::mem::transmute(ppolicy.as_ptr()),
    ...
    pub unsafe fn GetSecurityIdEx2<P0>(
        &self,
        puri: P0,
        pbsecurityid: &mut [u8; 512],
        pcbsecurityid: *mut u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetSecurityIdEx2)(
                windows_core::Interface::as_raw(self),
                puri.param().abi(),
                core::mem::transmute(pbsecurityid.as_ptr()),
                pcbsecurityid as _,
    ...
    pub unsafe fn QueryCustomPolicyEx2<P0>(
        &self,
        puri: P0,
        guidkey: *const windows_core::GUID,
        pppolicy: *mut *mut u8,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).QueryCustomPolicyEx2)(
                windows_core::Interface::as_raw(self),
                puri.param().abi(),
                guidkey,
                pppolicy as _,
...
pub struct IInternetSecurityManagerEx2_Vtbl {
    ...
    pub MapUrlToZoneEx2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut u32,
        u32,
    ...
    pub ProcessUrlActionEx2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *mut u8,
    ...
    pub GetSecurityIdEx2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut u8,
        *mut u32,
    ...
    pub QueryCustomPolicyEx2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut u8,
...
pub trait IInternetSecurityManagerEx2_Impl: IInternetSecurityManagerEx_Impl {
    fn MapUrlToZoneEx2(
        ...
        pdwzone: *mut u32,
        dwflags: u32,
        ppwszmappedurl: *mut windows_core::PWSTR,
        pdwoutflags: *mut u32,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: IInternetSecurityManagerEx2_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityManagerEx2_Impl::MapUrlToZoneEx2(
                    this,
                    core::mem::transmute_copy(&puri),
                    core::mem::transmute_copy(&pdwzone),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&ppwszmappedurl),
                    core::mem::transmute_copy(&pdwoutflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn ProcessUrlActionEx2<
            Identity: IInternetSecurityManagerEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityManagerEx2_Impl::ProcessUrlActionEx2(
                    this,
                    core::mem::transmute_copy(&puri),
                    core::mem::transmute_copy(&dwaction),
                    core::mem::transmute_copy(&ppolicy),
        ...
        unsafe extern "system" fn GetSecurityIdEx2<
            Identity: IInternetSecurityManagerEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityManagerEx2_Impl::GetSecurityIdEx2(
                    this,
                    core::mem::transmute_copy(&puri),
                    core::mem::transmute_copy(&pbsecurityid),
                    core::mem::transmute_copy(&pcbsecurityid),
        ...
        unsafe extern "system" fn QueryCustomPolicyEx2<
            Identity: IInternetSecurityManagerEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityManagerEx2_Impl::QueryCustomPolicyEx2(
                    this,
                    core::mem::transmute_copy(&puri),
                    core::mem::transmute_copy(&guidkey),
                    core::mem::transmute_copy(&pppolicy),
...
windows_core::imp::define_interface!(
    ...
    0x79eac9ed_baf9_11ce_8c82_00aa004ba90b
);
    ...
    pub const fn new<Identity: IInternetSecurityMgrSite_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSecurityMgrSite_Impl::EnableModeless(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0x79eac9e7_baf9_11ce_8c82_00aa004ba90b
);
windows_core::imp::interface_hierarchy!(IInternetSession, windows_core::IUnknown);
impl IInternetSession {
    pub unsafe fn RegisterNameSpace<P0, P2>(
        &self,
        pcf: P0,
        rclsid: *const windows_core::GUID,
        pwzprotocol: P2,
        cpatterns: u32,
        ppwzpatterns: *const windows_core::PCWSTR,
        dwreserved: u32,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterNameSpace)(
                windows_core::Interface::as_raw(self),
                pcf.param().abi(),
                rclsid,
                pwzprotocol.param().abi(),
                cpatterns,
                ppwzpatterns,
                dwreserved,
            )
    ...
    pub unsafe fn UnregisterNameSpace<P0, P1>(
        &self,
        pcf: P0,
        pszprotocol: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).UnregisterNameSpace)(
                windows_core::Interface::as_raw(self),
                pcf.param().abi(),
                pszprotocol.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn RegisterMimeFilter<P0, P2>(
        &self,
        pcf: P0,
        rclsid: *const windows_core::GUID,
        pwztype: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterMimeFilter)(
                windows_core::Interface::as_raw(self),
                pcf.param().abi(),
                rclsid,
                pwztype.param().abi(),
    ...
    pub unsafe fn UnregisterMimeFilter<P0, P1>(
        &self,
        pcf: P0,
        pwztype: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).UnregisterMimeFilter)(
                windows_core::Interface::as_raw(self),
                pcf.param().abi(),
                pwztype.param().abi(),
            )
    ...
    pub unsafe fn CreateBinding<P0, P1, P2>(
        &self,
        pbc: P0,
        szurl: P1,
        punkouter: P2,
        ppunk: *mut Option<windows_core::IUnknown>,
        ppoinetprot: *mut Option<IInternetProtocol>,
        dwoption: u32,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::IBindCtx>,
        ...
        P2: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).CreateBinding)(
                ...
                core::mem::transmute(ppoinetprot),
                dwoption,
            )
            .ok()
        }
    ...
    pub unsafe fn SetSessionOption(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetSessionOption)(
                windows_core::Interface::as_raw(self),
                dwoption,
                pbuffer,
                dwbufferlength,
    ...
    pub unsafe fn GetSessionOption(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetSessionOption)(
                windows_core::Interface::as_raw(self),
                dwoption,
                pbuffer as _,
...
pub struct IInternetSession_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub RegisterNameSpace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        windows_core::PCWSTR,
    ...
    pub UnregisterNameSpace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub RegisterMimeFilter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub UnregisterMimeFilter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    ...
    pub SetSessionOption: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
    ...
    pub GetSessionOption: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
        *mut u32,
...
pub trait IInternetSession_Impl: windows_core::IUnknownImpl {
    fn RegisterNameSpace(
        &self,
        pcf: windows_core::Ref<'_, super::IClassFactory>,
        rclsid: *const windows_core::GUID,
        pwzprotocol: &windows_core::PCWSTR,
        cpatterns: u32,
        ppwzpatterns: *const windows_core::PCWSTR,
        dwreserved: u32,
    ) -> windows_core::Result<()>;
    fn UnregisterNameSpace(
        &self,
        pcf: windows_core::Ref<'_, super::IClassFactory>,
        pszprotocol: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    fn RegisterMimeFilter(
        &self,
        pcf: windows_core::Ref<'_, super::IClassFactory>,
        rclsid: *const windows_core::GUID,
        pwztype: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    ...
    fn CreateBinding(
        ...
        ppoinetprot: windows_core::OutRef<'_, IInternetProtocol>,
        dwoption: u32,
    ) -> windows_core::Result<()>;
    fn SetSessionOption(
        &self,
...
impl IInternetSession_Vtbl {
    pub const fn new<Identity: IInternetSession_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RegisterNameSpace<
            Identity: IInternetSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pcf: *mut core::ffi::c_void,
            rclsid: *const windows_core::GUID,
            pwzprotocol: windows_core::PCWSTR,
            cpatterns: u32,
            ppwzpatterns: *const windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSession_Impl::RegisterNameSpace(
                    this,
                    core::mem::transmute_copy(&pcf),
                    core::mem::transmute_copy(&rclsid),
                    core::mem::transmute(&pwzprotocol),
                    core::mem::transmute_copy(&cpatterns),
                    core::mem::transmute_copy(&ppwzpatterns),
                    core::mem::transmute_copy(&dwreserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn UnregisterNameSpace<
            Identity: IInternetSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSession_Impl::UnregisterNameSpace(
                    this,
                    core::mem::transmute_copy(&pcf),
                    core::mem::transmute(&pszprotocol),
                )
                .into()
            }
        }
        unsafe extern "system" fn RegisterMimeFilter<
            Identity: IInternetSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSession_Impl::RegisterMimeFilter(
                    this,
                    core::mem::transmute_copy(&pcf),
                    core::mem::transmute_copy(&rclsid),
                    core::mem::transmute(&pwztype),
                )
                .into()
            }
        }
        unsafe extern "system" fn UnregisterMimeFilter<
            Identity: IInternetSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSession_Impl::UnregisterMimeFilter(
                    this,
                    core::mem::transmute_copy(&pcf),
                    core::mem::transmute(&pwztype),
                )
        ...
        >(
            ...
            ppoinetprot: *mut *mut core::ffi::c_void,
            dwoption: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSession_Impl::CreateBinding(
                    this,
                    core::mem::transmute_copy(&pbc),
                    core::mem::transmute(&szurl),
                    ...
                    core::mem::transmute_copy(&dwoption),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetSessionOption<
            Identity: IInternetSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSession_Impl::SetSessionOption(
                    this,
                    core::mem::transmute_copy(&dwoption),
                    core::mem::transmute_copy(&pbuffer),
                    core::mem::transmute_copy(&dwbufferlength),
                    core::mem::transmute_copy(&dwreserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetSessionOption<
            Identity: IInternetSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetSession_Impl::GetSessionOption(
                    this,
                    core::mem::transmute_copy(&dwoption),
                    core::mem::transmute_copy(&pbuffer),
                    core::mem::transmute_copy(&pdwbufferlength),
                    core::mem::transmute_copy(&dwreserved),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0x79eac9e8_baf9_11ce_8c82_00aa004ba90b
);
...
windows_core::imp::define_interface!(
    ...
    0x79eac9ef_baf9_11ce_8c82_00aa004ba90b
);
...
impl IInternetZoneManager {
    pub unsafe fn GetZoneAttributes(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetZoneAttributes)(
                windows_core::Interface::as_raw(self),
                dwzone,
                pzoneattributes as _,
            )
            .ok()
        }
    }
    pub unsafe fn SetZoneAttributes(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetZoneAttributes)(
                windows_core::Interface::as_raw(self),
                dwzone,
                pzoneattributes,
            )
    ...
    pub unsafe fn GetZoneCustomPolicy(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetZoneCustomPolicy)(
                windows_core::Interface::as_raw(self),
                dwzone,
                guidkey,
                pppolicy as _,
    ...
    pub unsafe fn SetZoneCustomPolicy(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetZoneCustomPolicy)(
                windows_core::Interface::as_raw(self),
                dwzone,
                guidkey,
                core::mem::transmute(ppolicy.as_ptr()),
    ...
    pub unsafe fn GetZoneActionPolicy(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetZoneActionPolicy)(
                windows_core::Interface::as_raw(self),
                dwzone,
                dwaction,
                core::mem::transmute(ppolicy.as_ptr()),
    ...
    pub unsafe fn SetZoneActionPolicy(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetZoneActionPolicy)(
                windows_core::Interface::as_raw(self),
                dwzone,
                dwaction,
                core::mem::transmute(ppolicy.as_ptr()),
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PromptAction)(
                windows_core::Interface::as_raw(self),
                dwaction,
                hwndparent,
                pwszurl.param().abi(),
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).LogAction)(
                windows_core::Interface::as_raw(self),
                dwaction,
                pwszurl.param().abi(),
                pwsztext.param().abi(),
    ...
    pub unsafe fn CreateZoneEnumerator(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).CreateZoneEnumerator)(
                windows_core::Interface::as_raw(self),
                pdwenum as _,
                pdwcount as _,
                dwflags,
    ...
    pub unsafe fn GetZoneAt(&self, dwenum: u32, dwindex: u32) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetZoneAt)(
                windows_core::Interface::as_raw(self),
                dwenum,
                dwindex,
                &mut result__,
    ...
    pub unsafe fn DestroyZoneEnumerator(&self, dwenum: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DestroyZoneEnumerator)(
                windows_core::Interface::as_raw(self),
                dwenum,
            )
            .ok()
    ...
    pub unsafe fn CopyTemplatePoliciesToZone(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).CopyTemplatePoliciesToZone)(
                windows_core::Interface::as_raw(self),
                dwtemplate,
                dwzone,
                dwreserved,
...
pub struct IInternetZoneManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetZoneAttributes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut ZONEATTRIBUTES,
    ) -> windows_core::HRESULT,
    pub SetZoneAttributes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const ZONEATTRIBUTES,
    ) -> windows_core::HRESULT,
    pub GetZoneCustomPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const windows_core::GUID,
        *mut *mut u8,
    ...
    pub SetZoneCustomPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const windows_core::GUID,
        *const u8,
    ...
    pub GetZoneActionPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut u8,
    ...
    pub SetZoneActionPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const u8,
    ...
    pub PromptAction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
    ...
    pub LogAction: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ...
    pub CreateZoneEnumerator: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
        u32,
    ) -> windows_core::HRESULT,
    pub GetZoneAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub DestroyZoneEnumerator:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub CopyTemplatePoliciesToZone:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, u32, u32) -> windows_core::HRESULT,
}
...
impl IInternetZoneManager_Vtbl {
    pub const fn new<Identity: IInternetZoneManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetZoneAttributes<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManager_Impl::GetZoneAttributes(
                    this,
                    core::mem::transmute_copy(&dwzone),
                    core::mem::transmute_copy(&pzoneattributes),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetZoneAttributes<
            Identity: IInternetZoneManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManager_Impl::SetZoneAttributes(
                    this,
                    core::mem::transmute_copy(&dwzone),
                    core::mem::transmute_copy(&pzoneattributes),
                )
        ...
        unsafe extern "system" fn GetZoneCustomPolicy<
            Identity: IInternetZoneManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManager_Impl::GetZoneCustomPolicy(
                    this,
                    core::mem::transmute_copy(&dwzone),
                    core::mem::transmute_copy(&guidkey),
                    core::mem::transmute_copy(&pppolicy),
                    core::mem::transmute_copy(&pcbpolicy),
                    core::mem::transmute_copy(&urlzonereg),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetZoneCustomPolicy<
            Identity: IInternetZoneManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManager_Impl::SetZoneCustomPolicy(
                    this,
                    core::mem::transmute_copy(&dwzone),
                    core::mem::transmute_copy(&guidkey),
                    core::mem::transmute_copy(&ppolicy),
        ...
        unsafe extern "system" fn GetZoneActionPolicy<
            Identity: IInternetZoneManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManager_Impl::GetZoneActionPolicy(
                    this,
                    core::mem::transmute_copy(&dwzone),
                    core::mem::transmute_copy(&dwaction),
                    core::mem::transmute_copy(&ppolicy),
        ...
        unsafe extern "system" fn SetZoneActionPolicy<
            Identity: IInternetZoneManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManager_Impl::SetZoneActionPolicy(
                    this,
                    core::mem::transmute_copy(&dwzone),
                    core::mem::transmute_copy(&dwaction),
                    core::mem::transmute_copy(&ppolicy),
        ...
        unsafe extern "system" fn PromptAction<
            Identity: IInternetZoneManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManager_Impl::PromptAction(
                    this,
                    core::mem::transmute_copy(&dwaction),
                    core::mem::transmute_copy(&hwndparent),
                    core::mem::transmute(&pwszurl),
                    core::mem::transmute(&pwsztext),
                    core::mem::transmute_copy(&dwpromptflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn LogAction<
            Identity: IInternetZoneManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManager_Impl::LogAction(
                    this,
                    core::mem::transmute_copy(&dwaction),
                    core::mem::transmute(&pwszurl),
                    core::mem::transmute(&pwsztext),
                    core::mem::transmute_copy(&dwlogflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn CreateZoneEnumerator<
            Identity: IInternetZoneManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManager_Impl::CreateZoneEnumerator(
                    this,
                    core::mem::transmute_copy(&pdwenum),
        ...
        unsafe extern "system" fn GetZoneAt<
            Identity: IInternetZoneManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IInternetZoneManager_Impl::GetZoneAt(
                    this,
                    core::mem::transmute_copy(&dwenum),
        ...
        unsafe extern "system" fn DestroyZoneEnumerator<
            Identity: IInternetZoneManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManager_Impl::DestroyZoneEnumerator(
                    this,
                    core::mem::transmute_copy(&dwenum),
                )
                .into()
        ...
        unsafe extern "system" fn CopyTemplatePoliciesToZone<
            Identity: IInternetZoneManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManager_Impl::CopyTemplatePoliciesToZone(
                    this,
                    core::mem::transmute_copy(&dwtemplate),
                    core::mem::transmute_copy(&dwzone),
                    core::mem::transmute_copy(&dwreserved),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    0xa4c23339_8e06_431e_9bf4_7e711c085648
);
...
impl IInternetZoneManagerEx {
    pub unsafe fn GetZoneActionPolicyEx(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetZoneActionPolicyEx)(
                windows_core::Interface::as_raw(self),
                dwzone,
                dwaction,
                core::mem::transmute(ppolicy.as_ptr()),
    ...
    pub unsafe fn SetZoneActionPolicyEx(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetZoneActionPolicyEx)(
                windows_core::Interface::as_raw(self),
                dwzone,
                dwaction,
                core::mem::transmute(ppolicy.as_ptr()),
...
pub struct IInternetZoneManagerEx_Vtbl {
    ...
    pub GetZoneActionPolicyEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut u8,
    ...
    pub SetZoneActionPolicyEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const u8,
    ...
    pub const fn new<Identity: IInternetZoneManagerEx_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManagerEx_Impl::GetZoneActionPolicyEx(
                    this,
                    core::mem::transmute_copy(&dwzone),
                    core::mem::transmute_copy(&dwaction),
                    core::mem::transmute_copy(&ppolicy),
        ...
        unsafe extern "system" fn SetZoneActionPolicyEx<
            Identity: IInternetZoneManagerEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManagerEx_Impl::SetZoneActionPolicyEx(
                    this,
                    core::mem::transmute_copy(&dwzone),
                    core::mem::transmute_copy(&dwaction),
                    core::mem::transmute_copy(&ppolicy),
...
windows_core::imp::define_interface!(
    ...
    0xedc17559_dd5d_4846_8eef_8becba5a4abf
);
...
impl IInternetZoneManagerEx2 {
    pub unsafe fn GetZoneAttributesEx(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetZoneAttributesEx)(
                windows_core::Interface::as_raw(self),
                dwzone,
                pzoneattributes as _,
                dwflags,
    ...
    pub unsafe fn GetZoneSecurityState(
        ...
        frespectpolicy: bool,
        pdwstate: *mut u32,
        pfpolicyencountered: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetZoneSecurityState)(
                windows_core::Interface::as_raw(self),
                dwzoneindex,
                frespectpolicy.into(),
                pdwstate as _,
                pfpolicyencountered as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetIESecurityState(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetIESecurityState)(
                windows_core::Interface::as_raw(self),
                frespectpolicy.into(),
                pdwstate as _,
                pfpolicyencountered as _,
    ...
    pub unsafe fn FixUnsecureSettings(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).FixUnsecureSettings)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct IInternetZoneManagerEx2_Vtbl {
    ...
    pub GetZoneAttributesEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut ZONEATTRIBUTES,
        u32,
    ) -> windows_core::HRESULT,
    pub GetZoneSecurityState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::BOOL,
        *mut u32,
    ...
    pub GetIESecurityState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
        *mut u32,
        *mut windows_core::BOOL,
...
pub trait IInternetZoneManagerEx2_Impl: IInternetZoneManagerEx_Impl {
    ...
    fn GetZoneSecurityState(
        &self,
        dwzoneindex: u32,
        frespectpolicy: windows_core::BOOL,
        pdwstate: *mut u32,
        pfpolicyencountered: *mut windows_core::BOOL,
    ) -> windows_core::Result<()>;
...
impl IInternetZoneManagerEx2_Vtbl {
    pub const fn new<Identity: IInternetZoneManagerEx2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetZoneAttributesEx<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManagerEx2_Impl::GetZoneAttributesEx(
                    this,
                    core::mem::transmute_copy(&dwzone),
                    core::mem::transmute_copy(&pzoneattributes),
                    core::mem::transmute_copy(&dwflags),
        ...
        unsafe extern "system" fn GetZoneSecurityState<
            Identity: IInternetZoneManagerEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManagerEx2_Impl::GetZoneSecurityState(
                    this,
                    core::mem::transmute_copy(&dwzoneindex),
                    core::mem::transmute_copy(&frespectpolicy),
                    core::mem::transmute_copy(&pdwstate),
                    core::mem::transmute_copy(&pfpolicyencountered),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetIESecurityState<
            Identity: IInternetZoneManagerEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInternetZoneManagerEx2_Impl::GetIESecurityState(
                    this,
                    core::mem::transmute_copy(&frespectpolicy),
                    core::mem::transmute_copy(&pdwstate),
                    core::mem::transmute_copy(&pfpolicyencountered),
                    core::mem::transmute_copy(&fnocache),
                )
                .into()
            }
        }
        unsafe extern "system" fn FixUnsecureSettings<
            Identity: IInternetZoneManagerEx2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IMonikerProp,
    IMonikerProp_Vtbl,
    0xa5ca5f7f_1847_4d87_9c5b_918509f7511d
);
...
impl IMonikerProp_Vtbl {
    pub const fn new<Identity: IMonikerProp_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn PutProperty<Identity: IMonikerProp_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            mkp: MONIKERPROPERTY,
            val: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMonikerProp_Impl::PutProperty(
                    this,
                    core::mem::transmute_copy(&mkp),
...
pub const INET_E_AUTHENTICATION_REQUIRED: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0009_u32 as _);
pub const INET_E_BLOCKED_ENHANCEDPROTECTEDMODE: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0506_u32 as _);
pub const INET_E_BLOCKED_PLUGGABLE_PROTOCOL: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0505_u32 as _);
pub const INET_E_BLOCKED_REDIRECT_XSECURITYID: windows_core::HRESULT =
    windows_core::HRESULT(0x800C001B_u32 as _);
pub const INET_E_CANNOT_CONNECT: windows_core::HRESULT = windows_core::HRESULT(0x800C0004_u32 as _);
pub const INET_E_CANNOT_INSTANTIATE_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0010_u32 as _);
pub const INET_E_CANNOT_LOAD_DATA: windows_core::HRESULT =
    windows_core::HRESULT(0x800C000F_u32 as _);
pub const INET_E_CANNOT_LOCK_REQUEST: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0016_u32 as _);
pub const INET_E_CANNOT_REPLACE_SFP_FILE: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0300_u32 as _);
pub const INET_E_CODE_DOWNLOAD_DECLINED: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0100_u32 as _);
pub const INET_E_CODE_INSTALL_BLOCKED_ARM: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0504_u32 as _);
pub const INET_E_CODE_INSTALL_BLOCKED_BITNESS: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0507_u32 as _);
pub const INET_E_CODE_INSTALL_BLOCKED_BY_HASH_POLICY: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0500_u32 as _);
pub const INET_E_CODE_INSTALL_BLOCKED_IMMERSIVE: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0502_u32 as _);
pub const INET_E_CODE_INSTALL_SUPPRESSED: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0400_u32 as _);
pub const INET_E_CONNECTION_TIMEOUT: windows_core::HRESULT =
    windows_core::HRESULT(0x800C000B_u32 as _);
pub const INET_E_DATA_NOT_AVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0007_u32 as _);
pub const INET_E_DEFAULT_ACTION: i32 = -2146697199i32;
pub const INET_E_DOMINJECTIONVALIDATION: windows_core::HRESULT =
    windows_core::HRESULT(0x800C001C_u32 as _);
pub const INET_E_DOWNLOAD_BLOCKED_BY_CSP: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0508_u32 as _);
pub const INET_E_DOWNLOAD_BLOCKED_BY_INPRIVATE: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0501_u32 as _);
pub const INET_E_DOWNLOAD_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0008_u32 as _);
...
pub const INET_E_HSTS_CERTIFICATE_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0x800C001E_u32 as _);
pub const INET_E_INVALID_CERTIFICATE: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0019_u32 as _);
pub const INET_E_INVALID_REQUEST: windows_core::HRESULT =
    windows_core::HRESULT(0x800C000C_u32 as _);
...
pub const INET_E_OBJECT_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0006_u32 as _);
pub const INET_E_QUERYOPTION_UNKNOWN: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0013_u32 as _);
pub const INET_E_REDIRECTING: windows_core::HRESULT = windows_core::HRESULT(0x800C0014_u32 as _);
pub const INET_E_REDIRECT_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0014_u32 as _);
pub const INET_E_REDIRECT_TO_DIR: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0015_u32 as _);
...
pub const INET_E_RESOURCE_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0005_u32 as _);
pub const INET_E_RESULT_DISPATCHED: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0200_u32 as _);
pub const INET_E_SECURITY_PROBLEM: windows_core::HRESULT =
    windows_core::HRESULT(0x800C000E_u32 as _);
pub const INET_E_TERMINATED_BIND: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0018_u32 as _);
pub const INET_E_UNKNOWN_PROTOCOL: windows_core::HRESULT =
    windows_core::HRESULT(0x800C000D_u32 as _);
pub const INET_E_USE_DEFAULT_PROTOCOLHANDLER: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0011_u32 as _);
pub const INET_E_USE_DEFAULT_SETTING: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0012_u32 as _);
pub const INET_E_USE_EXTEND_BINDING: windows_core::HRESULT =
    windows_core::HRESULT(0x800C0017_u32 as _);
pub const INET_E_VTAB_SWITCH_FORCE_ENGINE: windows_core::HRESULT =
    windows_core::HRESULT(0x800C001D_u32 as _);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
windows_core::imp::define_interface!(
    ...
    0x79eac9c9_baf9_11ce_8c82_00aa004ba90b
);
...
impl IPersistMoniker {
    ...
    pub unsafe fn GetCurMoniker(&self) -> windows_core::Result<super::IMoniker> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCurMoniker)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IPersistMoniker_Vtbl {
    ...
    pub GetCurMoniker: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IPersistMoniker_Impl: windows_core::IUnknownImpl {
    ...
    fn Load(
        &self,
        ffullyavailable: windows_core::BOOL,
        pimkname: windows_core::Ref<'_, super::IMoniker>,
        pibc: windows_core::Ref<'_, super::IBindCtx>,
        grfmode: u32,
    ) -> windows_core::Result<()>;
    fn Save(
        &self,
...
impl IPersistMoniker_Vtbl {
    pub const fn new<Identity: IPersistMoniker_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn IsDirty<Identity: IPersistMoniker_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Load<Identity: IPersistMoniker_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ffullyavailable: windows_core::BOOL,
            pimkname: *mut core::ffi::c_void,
            pibc: *mut core::ffi::c_void,
            grfmode: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPersistMoniker_Impl::Load(
                    this,
                    core::mem::transmute_copy(&ffullyavailable),
                    core::mem::transmute_copy(&pimkname),
                    core::mem::transmute_copy(&pibc),
                    core::mem::transmute_copy(&grfmode),
                )
                .into()
            }
        }
        unsafe extern "system" fn Save<Identity: IPersistMoniker_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pimkname: *mut core::ffi::c_void,
            pbc: *mut core::ffi::c_void,
            fremember: windows_core::BOOL,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPersistMoniker_Impl::SaveCompleted(
                    this,
                    core::mem::transmute_copy(&pimkname),
                    core::mem::transmute_copy(&pibc),
                )
        ...
        unsafe extern "system" fn GetCurMoniker<
            Identity: IPersistMoniker_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppimkname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ISoftDistExt {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ProcessSoftDist)(
                windows_core::Interface::as_raw(self),
                szcdfurl.param().abi(),
                psoftdistelement.param().abi(),
                lpsdi as _,
            )
            .ok()
        }
    ...
    pub unsafe fn GetFirstCodeBase(
        &self,
        szcodebase: *const windows_core::PCWSTR,
        dwmaxsize: *const u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetFirstCodeBase)(
                windows_core::Interface::as_raw(self),
                szcodebase,
                dwmaxsize,
            )
    ...
    pub unsafe fn GetNextCodeBase(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetNextCodeBase)(
                windows_core::Interface::as_raw(self),
                szcodebase,
                dwmaxsize,
            )
    ...
    pub unsafe fn AsyncInstallDistributionUnit<P0>(
        &self,
        pbc: P0,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AsyncInstallDistributionUnit)(
                windows_core::Interface::as_raw(self),
                pbc.param().abi(),
                pvreserved,
                flags,
...
pub struct ISoftDistExt_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_Data_Xml_MsXml")]
    pub ProcessSoftDist: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut core::ffi::c_void,
        *mut SOFTDISTINFO,
    ...
    pub GetFirstCodeBase: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::PCWSTR,
        *const u32,
    ) -> windows_core::HRESULT,
    pub GetNextCodeBase: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::PCWSTR,
        *const u32,
    ) -> windows_core::HRESULT,
    pub AsyncInstallDistributionUnit: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        u32,
...
pub trait ISoftDistExt_Impl: windows_core::IUnknownImpl {
    fn ProcessSoftDist(
        &self,
        szcdfurl: &windows_core::PCWSTR,
        psoftdistelement: windows_core::Ref<'_, super::super::super::Data::Xml::MsXml::IXMLElement>,
        lpsdi: *mut SOFTDISTINFO,
    ) -> windows_core::Result<()>;
    fn GetFirstCodeBase(
        &self,
...
impl ISoftDistExt_Vtbl {
    pub const fn new<Identity: ISoftDistExt_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ProcessSoftDist<
            Identity: ISoftDistExt_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            szcdfurl: windows_core::PCWSTR,
            psoftdistelement: *mut core::ffi::c_void,
            lpsdi: *mut SOFTDISTINFO,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISoftDistExt_Impl::ProcessSoftDist(
                    this,
                    core::mem::transmute(&szcdfurl),
                    core::mem::transmute_copy(&psoftdistelement),
                    core::mem::transmute_copy(&lpsdi),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetFirstCodeBase<
            Identity: ISoftDistExt_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISoftDistExt_Impl::GetFirstCodeBase(
                    this,
                    core::mem::transmute_copy(&szcodebase),
                    core::mem::transmute_copy(&dwmaxsize),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetNextCodeBase<
            Identity: ISoftDistExt_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISoftDistExt_Impl::GetNextCodeBase(
                    this,
                    core::mem::transmute_copy(&szcodebase),
                    core::mem::transmute_copy(&dwmaxsize),
                )
        ...
        unsafe extern "system" fn AsyncInstallDistributionUnit<
            Identity: ISoftDistExt_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISoftDistExt_Impl::AsyncInstallDistributionUnit(
                    this,
                    core::mem::transmute_copy(&pbc),
                    core::mem::transmute_copy(&pvreserved),
                    core::mem::transmute_copy(&flags),
                    core::mem::transmute_copy(&lpcbh),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xe982ce48_0b96_440c_bc37_0c869b27a29e
);
...
impl IUriBuilderFactory {
    pub unsafe fn CreateIUriBuilder(
        ...
        dwflags: u32,
        dwreserved: usize,
    ) -> windows_core::Result<super::IUriBuilder> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateIUriBuilder)(
                windows_core::Interface::as_raw(self),
                dwflags,
                dwreserved,
                &mut result__,
    ...
    pub unsafe fn CreateInitializedIUriBuilder(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateInitializedIUriBuilder)(
                windows_core::Interface::as_raw(self),
                dwflags,
                dwreserved,
                &mut result__,
...
pub struct IUriBuilderFactory_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateIUriBuilder: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        usize,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateInitializedIUriBuilder: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        usize,
        *mut *mut core::ffi::c_void,
...
impl IUriBuilderFactory_Vtbl {
    pub const fn new<Identity: IUriBuilderFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateIUriBuilder<
        ...
        >(
            ...
            dwflags: u32,
            dwreserved: usize,
            ppiuribuilder: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUriBuilderFactory_Impl::CreateIUriBuilder(
                    this,
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&dwreserved),
                ) {
        ...
        unsafe extern "system" fn CreateInitializedIUriBuilder<
            Identity: IUriBuilderFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUriBuilderFactory_Impl::CreateInitializedIUriBuilder(
                    this,
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&dwreserved),
                ) {
...
windows_core::imp::define_interface!(
    IUriContainer,
    IUriContainer_Vtbl,
    0xa158a630_ed6f_45fb_b987_f68676f57752
);
...
impl IUriContainer_Vtbl {
    pub const fn new<Identity: IUriContainer_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetIUri<Identity: IUriContainer_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xdd1ec3b3_8391_4fdb_a9e6_347c3caaa7dd
);
windows_core::imp::interface_hierarchy!(IWinInetCacheHints, windows_core::IUnknown);
impl IWinInetCacheHints {
    pub unsafe fn SetCacheExtension<P0>(
        &self,
        pwzext: P0,
        pszcachefile: *mut core::ffi::c_void,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetCacheExtension)(
                windows_core::Interface::as_raw(self),
                pwzext.param().abi(),
                pszcachefile as _,
                pcbcachefile as _,
                pdwwinineterror as _,
                pdwreserved as _,
            )
            .ok()
        }
...
pub struct IWinInetCacheHints_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetCacheExtension: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut core::ffi::c_void,
        *mut u32,
...
impl IWinInetCacheHints_Vtbl {
    pub const fn new<Identity: IWinInetCacheHints_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetCacheExtension<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinInetCacheHints_Impl::SetCacheExtension(
                    this,
                    core::mem::transmute(&pwzext),
                    core::mem::transmute_copy(&pszcachefile),
                    core::mem::transmute_copy(&pcbcachefile),
                    core::mem::transmute_copy(&pdwwinineterror),
                    core::mem::transmute_copy(&pdwreserved),
                )
                .into()
            }
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            SetCacheExtension: SetCacheExtension::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x7857aeac_d31f_49bf_884e_dd46df36780a
);
...
impl IWinInetCacheHints2 {
    pub unsafe fn SetCacheExtension2<P0>(
        &self,
        pwzext: P0,
        pwzcachefile: windows_core::PWSTR,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetCacheExtension2)(
                windows_core::Interface::as_raw(self),
                pwzext.param().abi(),
                core::mem::transmute(pwzcachefile),
                pcchcachefile as _,
                pdwwinineterror as _,
                pdwreserved as _,
            )
...
pub struct IWinInetCacheHints2_Vtbl {
    ...
    pub SetCacheExtension2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PWSTR,
        *mut u32,
...
impl IWinInetCacheHints2_Vtbl {
    pub const fn new<Identity: IWinInetCacheHints2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetCacheExtension2<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinInetCacheHints2_Impl::SetCacheExtension2(
                    this,
                    core::mem::transmute(&pwzext),
                    core::mem::transmute_copy(&pwzcachefile),
                    core::mem::transmute_copy(&pcchcachefile),
                    core::mem::transmute_copy(&pdwwinineterror),
                    core::mem::transmute_copy(&pdwreserved),
                )
                .into()
        ...
        Self {
            base__: IWinInetCacheHints_Vtbl::new::<Identity, OFFSET>(),
            SetCacheExtension2: SetCacheExtension2::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xf134c4b7_b1f8_4e75_b886_74b90943becb
);
...
impl IWinInetFileStream {
    pub unsafe fn SetHandleForUnlock(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetHandleForUnlock)(
                windows_core::Interface::as_raw(self),
                hwininetlockhandle,
                dwreserved,
            )
    ...
    pub unsafe fn SetDeleteFile(&self, dwreserved: usize) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDeleteFile)(
                windows_core::Interface::as_raw(self),
                dwreserved,
            )
            .ok()
...
impl IWinInetFileStream_Vtbl {
    pub const fn new<Identity: IWinInetFileStream_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetHandleForUnlock<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinInetFileStream_Impl::SetHandleForUnlock(
                    this,
                    core::mem::transmute_copy(&hwininetlockhandle),
                    core::mem::transmute_copy(&dwreserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetDeleteFile<
            Identity: IWinInetFileStream_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinInetFileStream_Impl::SetDeleteFile(this, core::mem::transmute_copy(&dwreserved))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0x79eac9d8_bafa_11ce_8c82_00aa004ba90b
);
    ...
    pub const fn new<Identity: IWinInetHttpInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinInetHttpInfo_Impl::QueryInfo(
                    this,
                    core::mem::transmute_copy(&dwoption),
                    core::mem::transmute_copy(&pbuffer),
                    core::mem::transmute_copy(&pcbbuf),
        ...
        Self {
            base__: IWinInetInfo_Vtbl::new::<Identity, OFFSET>(),
            QueryInfo: QueryInfo::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xf286fa56_c1fd_4270_8e67_b3eb790a81e8
);
...
impl IWinInetHttpTimeouts {
    pub unsafe fn GetRequestTimeouts(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetRequestTimeouts)(
                windows_core::Interface::as_raw(self),
                pdwconnecttimeout as _,
                pdwsendtimeout as _,
                pdwreceivetimeout as _,
            )
            .ok()
        }
    }
...
pub struct IWinInetHttpTimeouts_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetRequestTimeouts: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
        *mut u32,
...
impl IWinInetHttpTimeouts_Vtbl {
    pub const fn new<Identity: IWinInetHttpTimeouts_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetRequestTimeouts<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinInetHttpTimeouts_Impl::GetRequestTimeouts(
                    this,
                    core::mem::transmute_copy(&pdwconnecttimeout),
                    core::mem::transmute_copy(&pdwsendtimeout),
                    core::mem::transmute_copy(&pdwreceivetimeout),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetRequestTimeouts: GetRequestTimeouts::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IWinInetInfo,
    IWinInetInfo_Vtbl,
    0x79eac9d6_bafa_11ce_8c82_00aa004ba90b
);
...
impl IWinInetInfo {
    pub unsafe fn QueryOption(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).QueryOption)(
                windows_core::Interface::as_raw(self),
                dwoption,
                pbuffer as _,
                pcbbuf as _,
...
pub struct IWinInetInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub QueryOption: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
        *mut u32,
...
impl IWinInetInfo_Vtbl {
    pub const fn new<Identity: IWinInetInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn QueryOption<Identity: IWinInetInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwoption: u32,
            pbuffer: *mut core::ffi::c_void,
            pcbbuf: *mut u32,
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            QueryOption: QueryOption::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IWinInetInfo as windows_core::Interface>::IID
...
windows_core::imp::define_interface!(
    ...
    0x79eac9d5_bafa_11ce_8c82_00aa004ba90b
);
...
impl IWindowForBindingUI {
    pub unsafe fn GetWindow(
        &self,
        rguidreason: *const windows_core::GUID,
    ...
    pub const fn new<Identity: IWindowForBindingUI_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWindowForBindingUI_Impl::GetWindow(
                    this,
                    core::mem::transmute_copy(&rguidreason),
                ) {
                    Ok(ok__) => {
                        phwnd.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
...
windows_core::imp::define_interface!(
    ...
    0x53c84785_8425_4dc5_971b_e58d9c19f9b6
);
...
impl IWrappedProtocol {
    pub unsafe fn GetWrapperCode(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetWrapperCode)(
                windows_core::Interface::as_raw(self),
                pncode as _,
                dwreserved,
            )
...
pub struct IWrappedProtocol_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetWrapperCode:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32, usize) -> windows_core::HRESULT,
}
...
impl IWrappedProtocol_Vtbl {
    pub const fn new<Identity: IWrappedProtocol_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetWrapperCode<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWrappedProtocol_Impl::GetWrapperCode(
                    this,
                    core::mem::transmute_copy(&pncode),
                    core::mem::transmute_copy(&dwreserved),
                )
                .into()
            }
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetWrapperCode: GetWrapperCode::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xcd45f185_1b21_48e2_967b_ead743a8914e
);
...
impl IZoneIdentifier_Vtbl {
    pub const fn new<Identity: IZoneIdentifier_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetId<Identity: IZoneIdentifier_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwzone: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetId<Identity: IZoneIdentifier_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwzone: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Remove<Identity: IZoneIdentifier_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    ...
    0xeb5e760c_09ef_45c0_b510_70830ce31e6a
);
...
impl IZoneIdentifier2 {
    pub unsafe fn GetLastWriterPackageFamilyName(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLastWriterPackageFamilyName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetLastWriterPackageFamilyName<P0>(
        &self,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetLastWriterPackageFamilyName)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn RemoveLastWriterPackageFamilyName(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveLastWriterPackageFamilyName)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn GetAppZoneId(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAppZoneId)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetAppZoneId(&self, zone: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAppZoneId)(
                windows_core::Interface::as_raw(self),
                zone,
            )
            .ok()
    ...
    pub unsafe fn RemoveAppZoneId(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveAppZoneId)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct IZoneIdentifier2_Vtbl {
    ...
    pub GetLastWriterPackageFamilyName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub SetLastWriterPackageFamilyName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
...
pub trait IZoneIdentifier2_Impl: IZoneIdentifier_Impl {
    ...
    fn SetLastWriterPackageFamilyName(
        &self,
        packagefamilyname: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
...
impl IZoneIdentifier2_Vtbl {
    pub const fn new<Identity: IZoneIdentifier2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetLastWriterPackageFamilyName<
        ...
        unsafe extern "system" fn SetLastWriterPackageFamilyName<
            Identity: IZoneIdentifier2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IZoneIdentifier2_Impl::SetLastWriterPackageFamilyName(
                    this,
        ...
        unsafe extern "system" fn RemoveLastWriterPackageFamilyName<
            Identity: IZoneIdentifier2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetAppZoneId<
            Identity: IZoneIdentifier2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetAppZoneId<
            Identity: IZoneIdentifier2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn RemoveAppZoneId<
            Identity: IZoneIdentifier2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,

...
#[inline]
pub unsafe fn HttpAddFragmentToCache<P1>(
...
#[inline]
pub unsafe fn HttpCreateRequestQueue<P1>(
    ...
    P4: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        HttpDeclarePush(
            ...
            path.param().abi(),
            query.param().abi(),
            headers.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn HttpDeleteServiceConfiguration(
    servicehandle: Option<super::super::Foundation::HANDLE>,
    configid: HTTP_SERVICE_CONFIG_ID,
    pconfiginformation: *const core::ffi::c_void,
    ...
    unsafe {
        HttpDeleteServiceConfiguration(
            servicehandle.unwrap_or(core::mem::zeroed()) as _,
            configid,
            pconfiginformation,
...
#[inline]
pub unsafe fn HttpGetExtension(
    version: HTTPAPI_VERSION,
    extension: u32,
...
#[inline]
pub unsafe fn HttpPrepareUrl<P2>(
    reserved: Option<*const core::ffi::c_void>,
    flags: Option<u32>,
    url: P2,
    preparedurl: *mut windows_core::PWSTR,
) -> u32
where
...
pub unsafe fn HttpQueryRequestQueueProperty(
    ...
    propertyinformation: Option<*mut core::ffi::c_void>,
    ...
    unsafe {
        HttpQueryRequestQueueProperty(
            requestqueuehandle,
            property,
            propertyinformation.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn HttpQueryServiceConfiguration(
    servicehandle: Option<super::super::Foundation::HANDLE>,
    configid: HTTP_SERVICE_CONFIG_ID,
    pinput: Option<*const core::ffi::c_void>,
    inputlength: u32,
    poutput: Option<*mut core::ffi::c_void>,
    outputlength: u32,
    ...
    unsafe {
        HttpQueryServiceConfiguration(
            ...
            outputlength,
            preturnlength.unwrap_or(core::mem::zeroed()) as _,
            poverlapped.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn HttpReadFragmentFromCache<P1>(
    requestqueuehandle: super::super::Foundation::HANDLE,
    urlprefix: P1,
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        HttpReadFragmentFromCache(
            requestqueuehandle,
            urlprefix.param().abi(),
            byterange.unwrap_or(core::mem::zeroed()) as _,
            buffer as _,
            bufferlength,
...
pub unsafe fn HttpReceiveClientCertificate(
    ...
    unsafe {
        HttpReceiveClientCertificate(
            ...
            connectionid,
            flags,
            sslclientcertinfo as _,
            sslclientcertinfosize,
            bytesreceived.unwrap_or(core::mem::zeroed()) as _,
            overlapped.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
pub unsafe fn HttpReceiveRequestEntityBody(
    ...
    requestid: u64,
    flags: u32,
    entitybuffer: *mut core::ffi::c_void,
...
#[inline]
pub unsafe fn HttpRemoveUrl<P1>(
    requestqueuehandle: super::super::Foundation::HANDLE,
    fullyqualifiedurl: P1,
) -> u32
where
...
#[inline]
pub unsafe fn HttpRemoveUrlFromUrlGroup<P1>(
    urlgroupid: u64,
    pfullyqualifiedurl: P1,
    flags: u32,
) -> u32
...
pub unsafe fn HttpSendHttpResponse(
    ...
    cachepolicy: Option<*const HTTP_CACHE_POLICY>,
    bytessent: Option<*mut u32>,
    reserved1: Option<*const core::ffi::c_void>,
    reserved2: Option<u32>,
    overlapped: Option<*mut super::super::System::IO::OVERLAPPED>,
    logdata: Option<*const HTTP_LOG_DATA>,
) -> u32 {
    ...
    unsafe {
        HttpSendHttpResponse(
            ...
            flags,
            httpresponse,
            cachepolicy.unwrap_or(core::mem::zeroed()) as _,
            bytessent.unwrap_or(core::mem::zeroed()) as _,
            reserved1.unwrap_or(core::mem::zeroed()) as _,
            reserved2.unwrap_or(core::mem::zeroed()) as _,
            overlapped.unwrap_or(core::mem::zeroed()) as _,
            logdata.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_System_IO")]
...
pub unsafe fn HttpSendResponseEntityBody(
    ...
    requestid: u64,
    flags: u32,
    entitychunks: Option<&[HTTP_DATA_CHUNK]>,
    bytessent: Option<*mut u32>,
    reserved1: Option<*const core::ffi::c_void>,
    reserved2: Option<u32>,
    overlapped: Option<*mut super::super::System::IO::OVERLAPPED>,
...
pub unsafe fn HttpSetRequestProperty(
    ...
    input: Option<*const core::ffi::c_void>,
...
pub unsafe fn HttpUpdateServiceConfiguration(
    handle: Option<super::super::Foundation::HANDLE>,
    configid: HTTP_SERVICE_CONFIG_ID,
    configinfo: *const core::ffi::c_void,

...
pub unsafe fn D3D11On12CreateDevice<P0>(
    ...
    ppcommandqueues: Option<&[Option<windows_core::IUnknown>]>,
    nodemask: u32,
    ppdevice: Option<*mut Option<super::Direct3D11::ID3D11Device>>,
    ppimmediatecontext: Option<*mut Option<super::Direct3D11::ID3D11DeviceContext>>,
    pchosenfeaturelevel: Option<*mut super::Direct3D::D3D_FEATURE_LEVEL>,
) -> windows_core::Result<()>
where
...
impl ID3D11On12Device {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CreateWrappedResource)(
                windows_core::Interface::as_raw(self),
                presource12.param().abi(),
                pflags11,
                instate,
                outstate,
                &T::IID,
    ...
    pub unsafe fn ReleaseWrappedResources(
        &self,
        ppresources: &[Option<super::Direct3D11::ID3D11Resource>],
    ) {
        unsafe {
            (windows_core::Interface::vtable(self).ReleaseWrappedResources)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn AcquireWrappedResources(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AcquireWrappedResources)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(ppresources.as_ptr()),
                ppresources.len().try_into().unwrap(),
            )
...
pub struct ID3D11On12Device_Vtbl {
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub CreateWrappedResource: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const D3D11_RESOURCE_FLAGS,
        super::Direct3D12::D3D12_RESOURCE_STATES,
        super::Direct3D12::D3D12_RESOURCE_STATES,
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D11")]
    pub ReleaseWrappedResources:
        unsafe extern "system" fn(*mut core::ffi::c_void, *const *mut core::ffi::c_void, u32),
    #[cfg(not(feature = "Win32_Graphics_Direct3D11"))]
    ReleaseWrappedResources: usize,
    #[cfg(feature = "Win32_Graphics_Direct3D11")]
    pub AcquireWrappedResources:
        unsafe extern "system" fn(*mut core::ffi::c_void, *const *mut core::ffi::c_void, u32),
    #[cfg(not(feature = "Win32_Graphics_Direct3D11"))]
...
pub trait ID3D11On12Device_Impl: windows_core::IUnknownImpl {
    fn CreateWrappedResource(
        &self,
        presource12: windows_core::Ref<'_, windows_core::IUnknown>,
        pflags11: *const D3D11_RESOURCE_FLAGS,
        instate: super::Direct3D12::D3D12_RESOURCE_STATES,
        outstate: super::Direct3D12::D3D12_RESOURCE_STATES,
        riid: *const windows_core::GUID,
        ppresource11: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
    fn ReleaseWrappedResources(
        &self,
        ppresources: *const Option<super::Direct3D11::ID3D11Resource>,
        numresources: u32,
    );
...
impl ID3D11On12Device_Vtbl {
    pub const fn new<Identity: ID3D11On12Device_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateWrappedResource<
            Identity: ID3D11On12Device_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            presource12: *mut core::ffi::c_void,
            pflags11: *const D3D11_RESOURCE_FLAGS,
            instate: super::Direct3D12::D3D12_RESOURCE_STATES,
            outstate: super::Direct3D12::D3D12_RESOURCE_STATES,
            riid: *const windows_core::GUID,
            ...
            unsafe {
                ...
                ID3D11On12Device_Impl::CreateWrappedResource(
                    this,
                    core::mem::transmute_copy(&presource12),
                    core::mem::transmute_copy(&pflags11),
                    core::mem::transmute_copy(&instate),
                    core::mem::transmute_copy(&outstate),
        ...
        unsafe extern "system" fn ReleaseWrappedResources<
            Identity: ID3D11On12Device_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ID3D11On12Device_Impl::ReleaseWrappedResources(
                    this,
        ...
        unsafe extern "system" fn AcquireWrappedResources<
            Identity: ID3D11On12Device_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ID3D11On12Device_Impl::AcquireWrappedResources(
                    this,
                    core::mem::transmute_copy(&ppresources),
                    core::mem::transmute_copy(&numresources),
                )
...
windows_core::imp::define_interface!(
    ID3D11On12Device1,
    ID3D11On12Device1_Vtbl,
    0xbdb64df4_ea2f_4c70_b861_aaab1258bb5d
);
...
impl ID3D11On12Device1 {
        ...
        T: windows_core::Interface,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetD3D12Device)(
                windows_core::Interface::as_raw(self),
                &T::IID,
                &mut result__,
            )
...
pub struct ID3D11On12Device1_Vtbl {
    ...
    pub GetD3D12Device: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl ID3D11On12Device1_Vtbl {
    pub const fn new<Identity: ID3D11On12Device1_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetD3D12Device<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ID3D11On12Device1_Impl::GetD3D12Device(
                    this,
                    core::mem::transmute_copy(&riid),
        ...
        Self {
            base__: ID3D11On12Device_Vtbl::new::<Identity, OFFSET>(),
...
windows_core::imp::define_interface!(
    ...
    0xdc90f331_4740_43fa_866e_67f12cb58223
);
...
impl ID3D11On12Device2 {
    ...
    pub unsafe fn UnwrapUnderlyingResource<P0, P1, T>(
        &self,
        presource11: P0,
        pcommandqueue: P1,
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).UnwrapUnderlyingResource)(
                windows_core::Interface::as_raw(self),
                presource11.param().abi(),
    ...
    pub unsafe fn ReturnUnderlyingResource<P0>(
        &self,
        presource11: P0,
        numsync: u32,
        psignalvalues: *const u64,
        ppfences: *const Option<super::Direct3D12::ID3D12Fence>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::Direct3D11::ID3D11Resource>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).ReturnUnderlyingResource)(
                windows_core::Interface::as_raw(self),
                presource11.param().abi(),
                numsync,
                psignalvalues,
...
pub struct ID3D11On12Device2_Vtbl {
    ...
    pub UnwrapUnderlyingResource: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const windows_core::GUID,
    ...
    pub ReturnUnderlyingResource: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const u64,
...
pub trait ID3D11On12Device2_Impl: ID3D11On12Device1_Impl {
    fn UnwrapUnderlyingResource(
        &self,
        presource11: windows_core::Ref<'_, super::Direct3D11::ID3D11Resource>,
        pcommandqueue: windows_core::Ref<'_, super::Direct3D12::ID3D12CommandQueue>,
        riid: *const windows_core::GUID,
        ppvresource12: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
...
impl ID3D11On12Device2_Vtbl {
    pub const fn new<Identity: ID3D11On12Device2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn UnwrapUnderlyingResource<
            Identity: ID3D11On12Device2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            presource11: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ID3D11On12Device2_Impl::UnwrapUnderlyingResource(
                    this,
                    core::mem::transmute_copy(&presource11),
        ...
        unsafe extern "system" fn ReturnUnderlyingResource<
            Identity: ID3D11On12Device2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ID3D11On12Device2_Impl::ReturnUnderlyingResource(
                    this,
                    core::mem::transmute_copy(&presource11),
                    core::mem::transmute_copy(&numsync),
                    core::mem::transmute_copy(&psignalvalues),
...
pub type PFN_D3D11ON12_CREATE_DEVICE = Option<
    unsafe extern "system" fn(
        param0: windows_core::Ref<'_, windows_core::IUnknown>,
        param1: u32,
        param2: *const super::Direct3D::D3D_FEATURE_LEVEL,
        featurelevels: u32,
        param4: *const Option<windows_core::IUnknown>,
        numqueues: u32,
        param6: u32,
        param7: windows_core::OutRef<'_, super::Direct3D11::ID3D11Device>,
        param8: windows_core::OutRef<'_, super::Direct3D11::ID3D11DeviceContext>,

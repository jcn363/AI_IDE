...
pub unsafe fn RtlFlushNonVolatileMemory(
    nvtoken: *const core::ffi::c_void,
    nvbuffer: *const core::ffi::c_void,
    size: usize,
    flags: u32,
) -> u32 {
...
pub unsafe fn RtlFlushNonVolatileMemoryRanges(
    ...
    unsafe {
        RtlFlushNonVolatileMemoryRanges(
            nvtoken,
            core::mem::transmute(nvranges.as_ptr()),
            nvranges.len().try_into().unwrap(),
            flags,
        )
    }
}
...
pub unsafe fn RtlGetNonVolatileToken(
    nvbuffer: *const core::ffi::c_void,
    size: usize,
    nvtoken: *mut *mut core::ffi::c_void,
) -> u32 {

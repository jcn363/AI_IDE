...
#[inline]
pub unsafe fn AddIScsiSendTargetPortalA<P0>(
...
#[inline]
pub unsafe fn AddIScsiSendTargetPortalW<P0>(
    initiatorinstance: P0,
    initiatorportnumber: u32,
    loginoptions: *mut ISCSI_LOGIN_OPTIONS,
    securityflags: u64,
...
#[inline]
pub unsafe fn AddIScsiStaticTargetA<P0, P1>(
    targetname: P0,
    targetalias: P1,
    targetflags: u32,
    persist: bool,
...
#[inline]
pub unsafe fn AddIScsiStaticTargetW<P0, P1>(
    targetname: P0,
    targetalias: P1,
    targetflags: u32,
    persist: bool,
...
#[inline]
pub unsafe fn GetIScsiIKEInfoA<P0>(
    initiatorname: P0,
    initiatorportnumber: u32,
    reserved: *mut u32,
...
#[inline]
pub unsafe fn GetIScsiIKEInfoW<P0>(
    initiatorname: P0,
    initiatorportnumber: u32,
    reserved: *mut u32,
    authinfo: *mut IKE_AUTHENTICATION_INFORMATION,
...
#[inline]
pub unsafe fn LoginIScsiTargetA<P0, P2>(
    targetname: P0,
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        LoginIScsiTargetA(
            ...
            ispersistent,
            uniquesessionid as _,
            uniqueconnectionid as _,
        )
    }
}
#[inline]
pub unsafe fn LoginIScsiTargetW<P0, P2>(
    targetname: P0,
    isinformationalsession: bool,
    initiatorinstance: P2,
    initiatorportnumber: u32,
...
#[inline]
pub unsafe fn RefreshIScsiSendTargetPortalA<P0>(
    initiatorinstance: P0,
    initiatorportnumber: u32,
    portal: *mut ISCSI_TARGET_PORTALA,
) -> u32
...
#[inline]
pub unsafe fn RemoveIScsiPersistentTargetA<P0, P2>(
    initiatorinstance: P0,
    initiatorportnumber: u32,
    targetname: P2,
    portal: *mut ISCSI_TARGET_PORTALA,
...
#[inline]
pub unsafe fn RemoveIScsiSendTargetPortalA<P0>(
    initiatorinstance: P0,
    initiatorportnumber: u32,
    portal: *mut ISCSI_TARGET_PORTALA,
) -> u32
...
#[inline]
pub unsafe fn RemoveIScsiSendTargetPortalW<P0>(
    initiatorinstance: P0,
    initiatorportnumber: u32,
    portal: *mut ISCSI_TARGET_PORTALW,
) -> u32
...
pub unsafe fn ReportIScsiInitiatorListA(
    ...
    unsafe {
        ReportIScsiInitiatorListA(buffersize as _, buffer.unwrap_or(core::mem::zeroed()) as _)
    }
}
#[inline]
pub unsafe fn ReportIScsiInitiatorListW(
    ...
    unsafe {
        ReportIScsiInitiatorListW(buffersize as _, buffer.unwrap_or(core::mem::zeroed()) as _)
    }
}
#[inline]
pub unsafe fn ReportIScsiPersistentLoginsA(
    ...
    unsafe {
        ReportIScsiPersistentLoginsA(count as _, persistentlogininfo as _, buffersizeinbytes as _)
    }
}
#[inline]
pub unsafe fn ReportIScsiPersistentLoginsW(
    ...
    unsafe {
        ReportIScsiPersistentLoginsW(count as _, persistentlogininfo as _, buffersizeinbytes as _)
    }
}
#[inline]
...
pub unsafe fn ReportIScsiSendTargetPortalsExA(
    ...
    unsafe {
        ReportIScsiSendTargetPortalsExA(portalcount as _, portalinfosize as _, portalinfo as _)
    }
}
#[inline]
pub unsafe fn ReportIScsiSendTargetPortalsExW(
    ...
    unsafe {
        ReportIScsiSendTargetPortalsExW(portalcount as _, portalinfosize as _, portalinfo as _)
    }
}
#[inline]
...
#[inline]
pub unsafe fn SetIScsiIKEInfoA<P0>(
    initiatorname: P0,
    initiatorportnumber: u32,
    authinfo: *mut IKE_AUTHENTICATION_INFORMATION,
    persist: bool,
...
#[inline]
pub unsafe fn SetIScsiIKEInfoW<P0>(
    initiatorname: P0,
    initiatorportnumber: u32,
    authinfo: *mut IKE_AUTHENTICATION_INFORMATION,
    persist: bool,
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SetIScsiTunnelModeOuterAddressA(
            initiatorname.param().abi(),
            initiatorportnumber,
            destinationaddress.param().abi(),
            outermodeaddress.param().abi(),
            persist,
        )
    }
}
...
pub const IOCTL_MINIPORT_SIGNATURE_DSM_NOTIFICATION: windows_core::PCSTR =
    windows_core::s!("MPDSM   ");
pub const IOCTL_MINIPORT_SIGNATURE_ENDURANCE_INFO: windows_core::PCSTR =
    windows_core::s!("ENDURINF");
...
pub const IOCTL_MINIPORT_SIGNATURE_QUERY_PHYSICAL_TOPOLOGY: windows_core::PCSTR =
    windows_core::s!("TOPOLOGY");
pub const IOCTL_MINIPORT_SIGNATURE_QUERY_PROTOCOL: windows_core::PCSTR =
    windows_core::s!("PROTOCOL");
pub const IOCTL_MINIPORT_SIGNATURE_QUERY_TEMPERATURE: windows_core::PCSTR =
    windows_core::s!("TEMPERAT");
...
pub const IOCTL_MINIPORT_SIGNATURE_SET_TEMPERATURE_THRESHOLD: windows_core::PCSTR =
    windows_core::s!("SETTEMPT");
...
pub const ISCSI_LOGIN_OPTIONS_DEFAULT_TIME_2_RETAIN: windows_core::PCSTR =
    windows_core::s!("0x00000010");
pub const ISCSI_LOGIN_OPTIONS_DEFAULT_TIME_2_WAIT: windows_core::PCSTR =
    windows_core::s!("0x00000008");
pub const ISCSI_LOGIN_OPTIONS_HEADER_DIGEST: windows_core::PCSTR = windows_core::s!("0x00000001");
pub const ISCSI_LOGIN_OPTIONS_MAXIMUM_CONNECTIONS: windows_core::PCSTR =
    windows_core::s!("0x00000004");
...
pub const ISCSI_SECURITY_FLAG_AGGRESSIVE_MODE_ENABLED: windows_core::PCSTR =
    windows_core::s!("0x00000008");
pub const ISCSI_SECURITY_FLAG_IKE_IPSEC_ENABLED: windows_core::PCSTR =
    windows_core::s!("0x00000002");
pub const ISCSI_SECURITY_FLAG_MAIN_MODE_ENABLED: windows_core::PCSTR =
    windows_core::s!("0x00000004");
pub const ISCSI_SECURITY_FLAG_PFS_ENABLED: windows_core::PCSTR = windows_core::s!("0x00000010");
pub const ISCSI_SECURITY_FLAG_TRANSPORT_MODE_PREFERRED: windows_core::PCSTR =
    windows_core::s!("0x00000020");
pub const ISCSI_SECURITY_FLAG_TUNNEL_MODE_PREFERRED: windows_core::PCSTR =
    windows_core::s!("0x00000040");
...
pub type PDUMP_DEVICE_POWERON_ROUTINE =
    Option<unsafe extern "system" fn(context: *const core::ffi::c_void) -> i32>;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const ScsiRawInterfaceGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x53f56309_b6bf_11d0_94f2_00a0c91efb8b);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const WmiScsiAddressGuid: windows_core::GUID =
    windows_core::GUID::from_u128(0x53f5630f_b6bf_11d0_94f2_00a0c91efb8b);
#[repr(transparent)]

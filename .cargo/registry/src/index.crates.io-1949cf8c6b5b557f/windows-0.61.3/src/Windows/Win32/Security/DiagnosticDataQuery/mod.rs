...
) -> windows_core::Result<HDIAGNOSTIC_DATA_QUERY_SESSION> {
...
pub unsafe fn DdqGetDiagnosticRecordBinaryDistribution(
    hsession: HDIAGNOSTIC_DATA_QUERY_SESSION,
    producernames: &[windows_core::PCWSTR],
    topnbinaries: u32,
    ...
    unsafe {
        DdqGetDiagnosticRecordBinaryDistribution(
            hsession,
            core::mem::transmute(producernames.as_ptr()),
            producernames.len().try_into().unwrap(),
            topnbinaries,
            binarystats as _,
            statcount as _,
        )
...
pub unsafe fn DdqGetDiagnosticRecordCategoryAtIndex(
    hcategorydescription: HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION,
    index: u32,
) -> windows_core::Result<DIAGNOSTIC_DATA_EVENT_CATEGORY_DESCRIPTION> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        DdqGetDiagnosticRecordCategoryAtIndex(hcategorydescription, index, &mut result__)
            .map(|| result__)
    }
}
#[inline]
...
pub unsafe fn DdqGetDiagnosticRecordLocaleTagAtIndex(
    htagdescription: HDIAGNOSTIC_EVENT_TAG_DESCRIPTION,
    index: u32,
) -> windows_core::Result<DIAGNOSTIC_DATA_EVENT_TAG_DESCRIPTION> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        DdqGetDiagnosticRecordLocaleTagAtIndex(htagdescription, index, &mut result__)
            .map(|| result__)
    }
}
#[inline]
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordLocaleTags<P1>(
    hsession: HDIAGNOSTIC_DATA_QUERY_SESSION,
    locale: P1,
) -> windows_core::Result<HDIAGNOSTIC_EVENT_TAG_DESCRIPTION>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        DdqGetDiagnosticRecordLocaleTags(hsession, locale.param().abi(), &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn DdqGetDiagnosticRecordPage(
    ...
    pagerecordcount: u32,
    baserowid: i64,
) -> windows_core::Result<HDIAGNOSTIC_RECORD> {
...
pub unsafe fn DdqGetDiagnosticRecordProducerAtIndex(
    hproducerdescription: HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION,
    index: u32,
) -> windows_core::Result<DIAGNOSTIC_DATA_EVENT_PRODUCER_DESCRIPTION> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        DdqGetDiagnosticRecordProducerAtIndex(hproducerdescription, index, &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn DdqGetDiagnosticRecordProducerCategories<P1>(
    hsession: HDIAGNOSTIC_DATA_QUERY_SESSION,
    producername: P1,
) -> windows_core::Result<HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
pub unsafe fn DdqGetDiagnosticRecordProducers(
    hsession: HDIAGNOSTIC_DATA_QUERY_SESSION,
) -> windows_core::Result<HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION> {
...
pub unsafe fn DdqGetDiagnosticReport(
    hsession: HDIAGNOSTIC_DATA_QUERY_SESSION,
    reportstoretype: u32,
) -> windows_core::Result<HDIAGNOSTIC_REPORT> {
...
pub unsafe fn DdqGetDiagnosticReportStoreReportCount(
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        DdqGetDiagnosticReportStoreReportCount(hsession, reportstoretype, &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn DdqGetSessionAccessLevel(
    hsession: HDIAGNOSTIC_DATA_QUERY_SESSION,
) -> windows_core::Result<DdqAccessLevel> {
...
pub unsafe fn DdqGetTranscriptConfiguration(
    hsession: HDIAGNOSTIC_DATA_QUERY_SESSION,
) -> windows_core::Result<DIAGNOSTIC_DATA_EVENT_TRANSCRIPT_CONFIGURATION> {
...
pub unsafe fn DdqIsDiagnosticRecordSampledIn<P3, P5>(
    hsession: HDIAGNOSTIC_DATA_QUERY_SESSION,
    providergroup: *const windows_core::GUID,
    ...
    P5: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ...
        DdqIsDiagnosticRecordSampledIn(
            ...
            eventid.unwrap_or(core::mem::zeroed()) as _,
            eventname.param().abi(),
            eventversion.unwrap_or(core::mem::zeroed()) as _,
            eventkeywords.unwrap_or(core::mem::zeroed()) as _,
            &mut result__,
        )
        .map(|| result__)
    }

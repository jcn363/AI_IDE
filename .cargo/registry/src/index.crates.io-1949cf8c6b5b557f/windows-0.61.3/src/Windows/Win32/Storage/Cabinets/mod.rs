...
{
    windows_link::link!("cabinet.dll" "C" fn FCIAddFile(hfci : *const core::ffi::c_void, pszsourcefile : windows_core::PCSTR, pszfilename : windows_core::PCSTR, fexecute : windows_core::BOOL, pfnfcignc : PFNFCIGETNEXTCABINET, pfnfcis : PFNFCISTATUS, pfnfcigoi : PFNFCIGETOPENINFO, typecompress : u16) -> windows_core::BOOL);
    unsafe {
        FCIAddFile(
            hfci,
            pszsourcefile.param().abi(),
...
pub unsafe fn FCIDestroy(hfci: *const core::ffi::c_void) -> windows_core::BOOL {
    windows_link::link!("cabinet.dll" "C" fn FCIDestroy(hfci : *const core::ffi::c_void) -> windows_core::BOOL);
...
pub unsafe fn FCIFlushCabinet(
    ...
    windows_link::link!("cabinet.dll" "C" fn FCIFlushCabinet(hfci : *const core::ffi::c_void, fgetnextcab : windows_core::BOOL, pfnfcignc : PFNFCIGETNEXTCABINET, pfnfcis : PFNFCISTATUS) -> windows_core::BOOL);
...
pub unsafe fn FCIFlushFolder(
    ...
    windows_link::link!("cabinet.dll" "C" fn FCIFlushFolder(hfci : *const core::ffi::c_void, pfnfcignc : PFNFCIGETNEXTCABINET, pfnfcis : PFNFCISTATUS) -> windows_core::BOOL);
    unsafe { FCIFlushFolder(hfci, pfnfcignc, pfnfcis) }
}
#[inline]
pub unsafe fn FDICopy<P1, P2>(
    hfdi: *const core::ffi::c_void,
    pszcabinet: P1,
    pszcabpath: P2,
    flags: i32,
    pfnfdin: PFNFDINOTIFY,
    pfnfdid: PFNFDIDECRYPT,
    pvuser: Option<*const core::ffi::c_void>,
) -> windows_core::BOOL
where
    P1: windows_core::Param<windows_core::PCSTR>,
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("cabinet.dll" "C" fn FDICopy(hfdi : *const core::ffi::c_void, pszcabinet : windows_core::PCSTR, pszcabpath : windows_core::PCSTR, flags : i32, pfnfdin : PFNFDINOTIFY, pfnfdid : PFNFDIDECRYPT, pvuser : *const core::ffi::c_void) -> windows_core::BOOL);
    unsafe {
        FDICopy(
            hfdi,
            pszcabinet.param().abi(),
            pszcabpath.param().abi(),
            flags,
            pfnfdin,
            pfnfdid,
            pvuser.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn FDICreate(
    ...
    unsafe {
        FDICreate(
            pfnalloc, pfnfree, pfnopen, pfnread, pfnwrite, pfnclose, pfnseek, cputype, perf as _,
        )
    }
}
#[inline]
pub unsafe fn FDIDestroy(hfdi: *const core::ffi::c_void) -> windows_core::BOOL {
    windows_link::link!("cabinet.dll" "C" fn FDIDestroy(hfdi : *const core::ffi::c_void) -> windows_core::BOOL);
...
pub unsafe fn FDIIsCabinet(
    hfdi: *const core::ffi::c_void,
    hf: isize,
    pfdici: Option<*mut FDICABINETINFO>,
) -> windows_core::BOOL {
    windows_link::link!("cabinet.dll" "C" fn FDIIsCabinet(hfdi : *const core::ffi::c_void, hf : isize, pfdici : *mut FDICABINETINFO) -> windows_core::BOOL);
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("cabinet.dll" "C" fn FDITruncateCabinet(hfdi : *const core::ffi::c_void, pszcabinetname : windows_core::PCSTR, ifoldertodelete : u16) -> windows_core::BOOL);
...
pub type PFNFCICLOSE =
    Option<unsafe extern "system" fn(hf: isize, err: *mut i32, pv: *mut core::ffi::c_void) -> i32>;
pub type PFNFCIDELETE = Option<
    unsafe extern "system" fn(
        pszfile: windows_core::PCSTR,
        err: *mut i32,
        pv: *mut core::ffi::c_void,
    ) -> i32,
>;
pub type PFNFCIFILEPLACED = Option<
    unsafe extern "system" fn(
        pccab: *mut CCAB,
        pszfile: windows_core::PCSTR,
        cbfile: i32,
        fcontinuation: windows_core::BOOL,
        pv: *mut core::ffi::c_void,
    ) -> i32,
>;
pub type PFNFCIFREE = Option<unsafe extern "system" fn(memory: *mut core::ffi::c_void)>;
pub type PFNFCIGETNEXTCABINET = Option<
    unsafe extern "system" fn(
        pccab: *mut CCAB,
        cbprevcab: u32,
        pv: *mut core::ffi::c_void,
...
>;
pub type PFNFCIGETOPENINFO = Option<
    unsafe extern "system" fn(
...
>;
pub type PFNFCIGETTEMPFILE = Option<
    unsafe extern "system" fn(
        psztempname: windows_core::PSTR,
        cbtempname: i32,
        pv: *mut core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
pub type PFNFCIOPEN = Option<
    unsafe extern "system" fn(
        pszfile: windows_core::PCSTR,
        oflag: i32,
        pmode: i32,
...
pub type PFNOPEN = Option<
    unsafe extern "system" fn(pszfile: windows_core::PCSTR, oflag: i32, pmode: i32) -> isize,
>;
pub type PFNREAD =
    Option<unsafe extern "system" fn(hf: isize, pv: *mut core::ffi::c_void, cb: u32) -> u32>;
pub type PFNSEEK = Option<unsafe extern "system" fn(hf: isize, dist: i32, seektype: i32) -> i32>;
pub type PFNWRITE =
    Option<unsafe extern "system" fn(hf: isize, pv: *const core::ffi::c_void, cb: u32) -> u32>;

...
pub unsafe fn DefRawInputProc(
    ...
    unsafe {
        DefRawInputProc(
            core::mem::transmute(parawinput.as_ptr()),
            parawinput.len().try_into().unwrap(),
            cbsizeheader,
        )
    }
}
...
pub unsafe fn GetRawInputDeviceInfoA(
    hdevice: Option<super::super::Foundation::HANDLE>,
    ...
    unsafe {
        GetRawInputDeviceInfoA(
            hdevice.unwrap_or(core::mem::zeroed()) as _,
            uicommand,
            pdata.unwrap_or(core::mem::zeroed()) as _,
            pcbsize as _,
        )
...
pub unsafe fn GetRawInputDeviceList(
    ...
    unsafe {
        GetRawInputDeviceList(
            prawinputdevicelist.unwrap_or(core::mem::zeroed()) as _,
            puinumdevices as _,
            cbsize,
        )
    }
...
pub unsafe fn GetRegisteredRawInputDevices(
    prawinputdevices: Option<*mut RAWINPUTDEVICE>,
    puinumdevices: *mut u32,
    cbsize: u32,
) -> u32 {
    ...
    unsafe {
        GetRegisteredRawInputDevices(
            prawinputdevices.unwrap_or(core::mem::zeroed()) as _,
            puinumdevices as _,
            cbsize,
        )
    }
...
pub unsafe fn RegisterRawInputDevices(
    ...
    unsafe {
        RegisterRawInputDevices(
            core::mem::transmute(prawinputdevices.as_ptr()),

...
pub unsafe fn WscRegisterForChanges(
    ...
    lpcallbackaddress: super::Threading::LPTHREAD_START_ROUTINE,
...
impl IWSCDefaultProduct {
    pub unsafe fn SetDefaultProduct(
        ...
        pguid: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDefaultProduct)(
...
pub struct IWSCDefaultProduct_Vtbl {
    ...
    pub SetDefaultProduct: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IWSCDefaultProduct_Vtbl {
    pub const fn new<Identity: IWSCDefaultProduct_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetDefaultProduct<
            Identity: IWSCDefaultProduct_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            etype: SECURITY_PRODUCT_TYPE,
            pguid: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSCDefaultProduct_Impl::SetDefaultProduct(
                    this,
                    core::mem::transmute_copy(&etype),
                    core::mem::transmute(&pguid),
                )
                .into()
            }
        }
        Self {
            ...
            SetDefaultProduct: SetDefaultProduct::<Identity, OFFSET>,
        }
    }
...
impl IWSCProductList_Vtbl {
    pub const fn new<Identity: IWSCProductList_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Count<Identity: IWSCProductList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pval: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn get_Item<Identity: IWSCProductList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: u32,
...
impl IWscProduct {
    pub unsafe fn ProductName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProductName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
    ...
    pub unsafe fn ProductState(&self) -> windows_core::Result<WSC_SECURITY_PRODUCT_STATE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProductState)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SignatureStatus(&self) -> windows_core::Result<WSC_SECURITY_SIGNATURE_STATUS> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SignatureStatus)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn RemediationPath(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RemediationPath)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn ProductStateTimestamp(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProductStateTimestamp)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn ProductGuid(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProductGuid)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn ProductIsDefault(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProductIsDefault)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWscProduct_Vtbl {
    ...
    pub ProductState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WSC_SECURITY_PRODUCT_STATE,
    ) -> windows_core::HRESULT,
    pub SignatureStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WSC_SECURITY_SIGNATURE_STATUS,
    ) -> windows_core::HRESULT,
    pub RemediationPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ProductStateTimestamp: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ProductGuid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ProductIsDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IWscProduct_Vtbl {
    pub const fn new<Identity: IWscProduct_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ProductName<Identity: IWscProduct_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pval: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ProductState<Identity: IWscProduct_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SignatureStatus<
        ...
        unsafe extern "system" fn RemediationPath<
            Identity: IWscProduct_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ProductStateTimestamp<
            Identity: IWscProduct_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ProductGuid<Identity: IWscProduct_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pval: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ProductIsDefault<
            Identity: IWscProduct_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl IWscProduct2 {
    pub unsafe fn AntivirusScanSubstatus(
        &self,
    ) -> windows_core::Result<WSC_SECURITY_PRODUCT_SUBSTATUS> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AntivirusScanSubstatus)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn AntivirusSettingsSubstatus(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AntivirusSettingsSubstatus)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn AntivirusProtectionUpdateSubstatus(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AntivirusProtectionUpdateSubstatus)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn FirewallDomainProfileSubstatus(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FirewallDomainProfileSubstatus)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn FirewallPrivateProfileSubstatus(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FirewallPrivateProfileSubstatus)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn FirewallPublicProfileSubstatus(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FirewallPublicProfileSubstatus)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWscProduct2_Vtbl {
    ...
    pub AntivirusScanSubstatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WSC_SECURITY_PRODUCT_SUBSTATUS,
    ) -> windows_core::HRESULT,
    pub AntivirusSettingsSubstatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WSC_SECURITY_PRODUCT_SUBSTATUS,
    ) -> windows_core::HRESULT,
    pub AntivirusProtectionUpdateSubstatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WSC_SECURITY_PRODUCT_SUBSTATUS,
    ) -> windows_core::HRESULT,
    pub FirewallDomainProfileSubstatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WSC_SECURITY_PRODUCT_SUBSTATUS,
    ) -> windows_core::HRESULT,
    pub FirewallPrivateProfileSubstatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WSC_SECURITY_PRODUCT_SUBSTATUS,
    ) -> windows_core::HRESULT,
    pub FirewallPublicProfileSubstatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WSC_SECURITY_PRODUCT_SUBSTATUS,
    ) -> windows_core::HRESULT,
}
...
impl IWscProduct2_Vtbl {
    pub const fn new<Identity: IWscProduct2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AntivirusScanSubstatus<
        ...
        unsafe extern "system" fn AntivirusSettingsSubstatus<
            Identity: IWscProduct2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AntivirusProtectionUpdateSubstatus<
            Identity: IWscProduct2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn FirewallDomainProfileSubstatus<
            Identity: IWscProduct2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn FirewallPrivateProfileSubstatus<
            Identity: IWscProduct2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn FirewallPublicProfileSubstatus<
            Identity: IWscProduct2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        Self {
            ...
            AntivirusProtectionUpdateSubstatus: AntivirusProtectionUpdateSubstatus::<
                Identity,
                OFFSET,
            >,
...
impl IWscProduct3 {
    pub unsafe fn AntivirusDaysUntilExpired(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AntivirusDaysUntilExpired)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
impl IWscProduct3_Vtbl {
    pub const fn new<Identity: IWscProduct3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AntivirusDaysUntilExpired<
        ...
        Self {
            base__: IWscProduct2_Vtbl::new::<Identity, OFFSET>(),
            AntivirusDaysUntilExpired: AntivirusDaysUntilExpired::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub const WSCDefaultProduct: windows_core::GUID =
    windows_core::GUID::from_u128(0x2981a36e_f22d_11e5_9ce9_5e5517507c66);
pub const WSCProductList: windows_core::GUID =
    windows_core::GUID::from_u128(0x17072f7b_9abe_4a74_a261_1eb76b55107a);

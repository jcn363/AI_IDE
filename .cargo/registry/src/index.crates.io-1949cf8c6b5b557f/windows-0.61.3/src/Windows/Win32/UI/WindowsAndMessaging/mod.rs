#[inline]
pub unsafe fn AdjustWindowRect(
...
#[inline]
pub unsafe fn CalculatePopupWindowPosition(
    anchorpoint: *const super::super::Foundation::POINT,
    windowsize: *const super::super::Foundation::SIZE,
    flags: u32,
    excluderect: Option<*const super::super::Foundation::RECT>,
    popupwindowposition: *mut super::super::Foundation::RECT,
) -> windows_core::Result<()> {
    ...
    unsafe {
        CalculatePopupWindowPosition(
            ...
            windowsize,
            flags,
            excluderect.unwrap_or(core::mem::zeroed()) as _,
            popupwindowposition as _,
        )
        .ok()
    }
}
...
pub unsafe fn CallNextHookEx(
    ...
    unsafe {
        CallNextHookEx(
            hhk.unwrap_or(core::mem::zeroed()) as _,
            ncode,
            wparam,
            lparam,
        )
...
#[inline]
pub unsafe fn CascadeWindows(
    hwndparent: Option<super::super::Foundation::HWND>,
    whow: CASCADE_WINDOWS_HOW,
    lprect: Option<*const super::super::Foundation::RECT>,
    lpkids: Option<&[super::super::Foundation::HWND]>,
) -> u16 {
...
#[inline]
pub unsafe fn ChangeWindowMessageFilter(
    message: u32,
...
#[inline]
pub unsafe fn ChangeWindowMessageFilterEx(
    hwnd: super::super::Foundation::HWND,
    message: u32,
    action: WINDOW_MESSAGE_FILTER_ACTION,
    pchangefilterstruct: Option<*mut CHANGEFILTERSTRUCT>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        ChangeWindowMessageFilterEx(
            ...
            message,
            action,
            pchangefilterstruct.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CharToOemBuffA(
            lpszsrc.param().abi(),
            core::mem::transmute(lpszdst.as_ptr()),
            lpszdst.len().try_into().unwrap(),
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn CheckMenuRadioItem(
    hmenu: HMENU,
    first: u32,
    last: u32,
    check: u32,
...
#[inline]
pub unsafe fn ChildWindowFromPoint(
...
#[inline]
pub unsafe fn ChildWindowFromPointEx(
    hwnd: super::super::Foundation::HWND,
...
pub unsafe fn CreateAcceleratorTableA(paccel: &[ACCEL]) -> windows_core::Result<HACCEL> {
    ...
    let result__ = unsafe {
        CreateAcceleratorTableA(
            core::mem::transmute(paccel.as_ptr()),
            paccel.len().try_into().unwrap(),
        )
    };
    (!result__.is_invalid())
        .then_some(result__)
...
pub unsafe fn CreateCursor(
    ...
    nwidth: i32,
    nheight: i32,
    pvandplane: *const core::ffi::c_void,
    pvxorplane: *const core::ffi::c_void,
...
#[inline]
pub unsafe fn CreateDialogIndirectParamW(
    hinstance: Option<super::super::Foundation::HINSTANCE>,
    lptemplate: *const DLGTEMPLATE,
    hwndparent: Option<super::super::Foundation::HWND>,
    lpdialogfunc: DLGPROC,
...
pub unsafe fn CreateIconFromResource(
    ...
    let result__ = unsafe {
        CreateIconFromResource(
            core::mem::transmute(presbits.as_ptr()),
            presbits.len().try_into().unwrap(),
            ficon.into(),
            dwver,
        )
    };
...
#[inline]
pub unsafe fn CreateIconFromResourceEx(
    presbits: &[u8],
    ficon: bool,
    dwver: u32,
    cxdesired: i32,
...
#[inline]
pub unsafe fn CreateMDIWindowW<P0, P1>(
    lpclassname: P0,
    lpwindowname: P1,
    dwstyle: WINDOW_STYLE,
    x: i32,
...
pub unsafe fn CreateResourceIndexer<P0, P1>(
    projectroot: P0,
    extensiondllpath: P1,
    ppresourceindexer: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        CreateResourceIndexer(
            projectroot.param().abi(),
            extensiondllpath.param().abi(),
            ppresourceindexer as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn CreateWindowExA<P1, P2>(
    dwexstyle: WINDOW_EX_STYLE,
    lpclassname: P1,
    lpwindowname: P2,
    dwstyle: WINDOW_STYLE,
...
#[inline]
pub unsafe fn DefFrameProcA(
    hwnd: super::super::Foundation::HWND,
    hwndmdiclient: Option<super::super::Foundation::HWND>,
    umsg: u32,
    wparam: super::super::Foundation::WPARAM,
    lparam: super::super::Foundation::LPARAM,
) -> super::super::Foundation::LRESULT {
    ...
    unsafe {
        DefFrameProcA(
            hwnd,
            hwndmdiclient.unwrap_or(core::mem::zeroed()) as _,
            umsg,
            wparam,
            lparam,
        )
...
#[inline]
pub unsafe fn DefMDIChildProcA(
    hwnd: super::super::Foundation::HWND,
    umsg: u32,
    wparam: super::super::Foundation::WPARAM,
    lparam: super::super::Foundation::LPARAM,
...
#[inline]
pub unsafe fn DefMDIChildProcW(
    hwnd: super::super::Foundation::HWND,
    umsg: u32,
    wparam: super::super::Foundation::WPARAM,
    lparam: super::super::Foundation::LPARAM,
...
#[inline]
pub unsafe fn DialogBoxIndirectParamA(
    hinstance: Option<super::super::Foundation::HINSTANCE>,
...
#[inline]
pub unsafe fn DialogBoxParamA<P1>(
    hinstance: Option<super::super::Foundation::HINSTANCE>,
    lptemplatename: P1,
    hwndparent: Option<super::super::Foundation::HWND>,
    lpdialogfunc: DLGPROC,
...
#[inline]
pub unsafe fn DialogBoxParamW<P1>(
    hinstance: Option<super::super::Foundation::HINSTANCE>,
    lptemplatename: P1,
    hwndparent: Option<super::super::Foundation::HWND>,
    lpdialogfunc: DLGPROC,
...
pub unsafe fn DragObject(
    ...
    unsafe {
        DragObject(
            ...
            fmt,
            data,
            hcur.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn DrawIcon(
...
pub unsafe fn DrawIconEx(
    ...
    cywidth: i32,
    istepifanicur: u32,
    hbrflickerfreedraw: Option<super::super::Graphics::Gdi::HBRUSH>,
    diflags: DI_FLAGS,
) -> windows_core::Result<()> {
    ...
    unsafe {
        DrawIconEx(
            ...
            cywidth,
            istepifanicur,
            hbrflickerfreedraw.unwrap_or(core::mem::zeroed()) as _,
            diflags,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn EnumThreadWindows(
    dwthreadid: u32,
    lpfn: WNDENUMPROC,
    lparam: super::super::Foundation::LPARAM,
) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn FindWindowExA<P2, P3>(
    hwndparent: Option<super::super::Foundation::HWND>,
    hwndchildafter: Option<super::super::Foundation::HWND>,
    lpszclass: P2,
    lpszwindow: P3,
) -> windows_core::Result<super::super::Foundation::HWND>
where
...
#[inline]
pub unsafe fn GetAltTabInfoW(
    hwnd: Option<super::super::Foundation::HWND>,
    iitem: i32,
    pati: *mut ALTTABINFO,
    pszitemtext: Option<&mut [u16]>,
) -> windows_core::Result<()> {
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn GetClassInfoA<P1>(
    hinstance: Option<super::super::Foundation::HINSTANCE>,
    lpclassname: P1,
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn GetClassInfoW<P1>(
    hinstance: Option<super::super::Foundation::HINSTANCE>,
    lpclassname: P1,
...
#[inline]
pub unsafe fn GetClassLongPtrA(
    hwnd: super::super::Foundation::HWND,
    nindex: GET_CLASS_LONG_INDEX,
) -> usize {
...
#[inline]
pub unsafe fn GetClassLongPtrW(
    hwnd: super::super::Foundation::HWND,
    nindex: GET_CLASS_LONG_INDEX,
) -> usize {
...
#[inline]
pub unsafe fn GetDlgItem(
    hdlg: Option<super::super::Foundation::HWND>,
    niddlgitem: i32,
) -> windows_core::Result<super::super::Foundation::HWND> {
...
pub unsafe fn GetDlgItemInt(
    hdlg: super::super::Foundation::HWND,
    niddlgitem: i32,
    lptranslated: Option<*mut windows_core::BOOL>,
    bsigned: bool,
) -> u32 {
    ...
    unsafe {
        GetDlgItemInt(
            hdlg,
            niddlgitem,
            lptranslated.unwrap_or(core::mem::zeroed()) as _,
            bsigned.into(),
        )
    }
}
#[inline]
pub unsafe fn GetDlgItemTextA(
    hdlg: super::super::Foundation::HWND,
    niddlgitem: i32,
    lpstring: &mut [u8],
) -> u32 {
...
#[inline]
pub unsafe fn GetLastActivePopup(
    hwnd: super::super::Foundation::HWND,
) -> super::super::Foundation::HWND {
...
#[inline]
pub unsafe fn GetMenuDefaultItem(
    hmenu: HMENU,
    fbypos: u32,
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn GetMenuItemInfoA(
    hmenu: HMENU,
    item: u32,
    fbyposition: bool,
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn GetMenuItemInfoW(
    hmenu: HMENU,
    item: u32,
    fbyposition: bool,
...
#[inline]
pub unsafe fn GetMenuItemRect(
    hwnd: Option<super::super::Foundation::HWND>,
    hmenu: HMENU,
    uitem: u32,
    lprcitem: *mut super::super::Foundation::RECT,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn GetMenuStringA(
    hmenu: HMENU,
    uiditem: u32,
    lpstring: Option<&mut [u8]>,
...
#[inline]
pub unsafe fn GetMenuStringW(
    hmenu: HMENU,
    uiditem: u32,
    lpstring: Option<&mut [u16]>,
    flags: MENU_ITEM_FLAGS,
) -> i32 {
...
#[inline]
pub unsafe fn GetNextDlgGroupItem(
    hdlg: super::super::Foundation::HWND,
    hctl: Option<super::super::Foundation::HWND>,
    bprevious: bool,
) -> windows_core::Result<super::super::Foundation::HWND> {
    ...
    let result__ = unsafe {
        GetNextDlgGroupItem(
            hdlg,
            hctl.unwrap_or(core::mem::zeroed()) as _,
            bprevious.into(),
        )
    };
    (!result__.is_invalid())
...
#[inline]
pub unsafe fn GetNextDlgTabItem(
    hdlg: super::super::Foundation::HWND,
    hctl: Option<super::super::Foundation::HWND>,
    bprevious: bool,
) -> windows_core::Result<super::super::Foundation::HWND> {
...
#[inline]
pub unsafe fn GetPhysicalCursorPos(
    lppoint: *mut super::super::Foundation::POINT,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn GetWindowDisplayAffinity(
    hwnd: super::super::Foundation::HWND,
    pdwaffinity: *mut u32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn GetWindowLongPtrA(
    hwnd: super::super::Foundation::HWND,
    nindex: WINDOW_LONG_PTR_INDEX,
) -> isize {
...
#[inline]
pub unsafe fn GetWindowModuleFileNameA(
    hwnd: super::super::Foundation::HWND,
    pszfilename: &mut [u8],
) -> u32 {
    ...
    unsafe {
        GetWindowModuleFileNameA(
            hwnd,
            core::mem::transmute(pszfilename.as_ptr()),
            pszfilename.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn GetWindowModuleFileNameW(
    hwnd: super::super::Foundation::HWND,
    pszfilename: &mut [u16],
) -> u32 {
...
pub unsafe fn IndexFilePath<P1>(
    resourceindexer: *const core::ffi::c_void,
    filepath: P1,
    ppresourceuri: *mut windows_core::PWSTR,
...
#[inline]
pub unsafe fn InheritWindowMonitor(
    hwnd: super::super::Foundation::HWND,
    hwndinherit: Option<super::super::Foundation::HWND>,
) -> windows_core::BOOL {
...
pub unsafe fn InternalGetWindowText(
    ...
    unsafe {
        InternalGetWindowText(
            hwnd,
            core::mem::transmute(pstring.as_ptr()),
            pstring.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn IsDialogMessageW(
    hdlg: super::super::Foundation::HWND,
    lpmsg: *const MSG,
) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn LoadAcceleratorsA<P1>(
    hinstance: Option<super::super::Foundation::HINSTANCE>,
    lptablename: P1,
) -> windows_core::Result<HACCEL>
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn LoadAcceleratorsW<P1>(
    hinstance: Option<super::super::Foundation::HINSTANCE>,
    lptablename: P1,
) -> windows_core::Result<HACCEL>
where
...
#[inline]
pub unsafe fn LoadMenuA<P1>(
    hinstance: Option<super::super::Foundation::HINSTANCE>,
    lpmenuname: P1,
) -> windows_core::Result<HMENU>
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn LoadMenuIndirectA(
    lpmenutemplate: *const core::ffi::c_void,
) -> windows_core::Result<HMENU> {
...
#[inline]
pub unsafe fn LoadMenuIndirectW(
    lpmenutemplate: *const core::ffi::c_void,
) -> windows_core::Result<HMENU> {
...
#[inline]
pub unsafe fn LockSetForegroundWindow(
...
#[inline]
pub unsafe fn LogicalToPhysicalPoint(
    hwnd: super::super::Foundation::HWND,
    lppoint: *mut super::super::Foundation::POINT,
) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn LookupIconIdFromDirectoryEx(
    presbits: *const u8,
    ficon: bool,
    cxdesired: i32,
    cydesired: i32,
...
#[inline]
pub unsafe fn MenuItemFromPoint(
    hwnd: Option<super::super::Foundation::HWND>,
    hmenu: HMENU,
    ...
    unsafe {
        MenuItemFromPoint(
            hwnd.unwrap_or(core::mem::zeroed()) as _,
            hmenu,
            core::mem::transmute(ptscreen),
        )
    }
}
#[inline]
pub unsafe fn MessageBoxA<P1, P2>(
    hwnd: Option<super::super::Foundation::HWND>,
    lptext: P1,
    lpcaption: P2,
...
#[inline]
pub unsafe fn MessageBoxExA<P1, P2>(
    hwnd: Option<super::super::Foundation::HWND>,
    lptext: P1,
    lpcaption: P2,
    utype: MESSAGEBOX_STYLE,
...
#[inline]
pub unsafe fn MrmCreateConfig<P1, P2>(
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        MrmCreateConfig(
            platformversion,
            defaultqualifiers.param().abi(),
            outputxmlfile.param().abi(),
        )
        .ok()
    }
}
#[inline]
pub unsafe fn MrmCreateConfigInMemory<P1>(
    platformversion: MrmPlatformVersion,
    defaultqualifiers: P1,
...
#[inline]
pub unsafe fn MrmCreateResourceFile<P3>(
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        MrmCreateResourceFile(
            core::mem::transmute(indexer),
            packagingmode,
            packagingoptions,
            outputdirectory.param().abi(),
        )
        .ok()
    }
}
...
pub unsafe fn MrmCreateResourceFileInMemory(
    ...
    packagingmode: MrmPackagingMode,
    packagingoptions: MrmPackagingOptions,
    outputpridata: *mut *mut u8,
    outputprisize: *mut u32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn MrmCreateResourceFileWithChecksum<P4>(
    indexer: MrmResourceIndexerHandle,
    packagingmode: MrmPackagingMode,
    packagingoptions: MrmPackagingOptions,
    checksum: u32,
...
#[inline]
pub unsafe fn MrmCreateResourceIndexer<P0, P1, P3>(
    packagefamilyname: P0,
    projectroot: P1,
    platformversion: MrmPlatformVersion,
    defaultqualifiers: P3,
...
#[inline]
pub unsafe fn MrmCreateResourceIndexerFromPreviousPriData<P0, P2>(
    projectroot: P0,
    platformversion: MrmPlatformVersion,
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        MrmCreateResourceIndexerFromPreviousPriData(
            ...
            platformversion,
            defaultqualifiers.param().abi(),
            core::mem::transmute(pridata.as_ptr()),
            pridata.len().try_into().unwrap(),
            indexer as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn MrmCreateResourceIndexerFromPreviousPriFile<P0, P2, P3>(
    projectroot: P0,
    platformversion: MrmPlatformVersion,
    defaultqualifiers: P2,
    prifile: P3,
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        MrmCreateResourceIndexerFromPreviousSchemaData(
            ...
            platformversion,
            defaultqualifiers.param().abi(),
            core::mem::transmute(schemaxmldata.as_ptr()),
            schemaxmldata.len().try_into().unwrap(),
            indexer as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn MrmCreateResourceIndexerFromPreviousSchemaFile<P0, P2, P3>(
    projectroot: P0,
    platformversion: MrmPlatformVersion,
    defaultqualifiers: P2,
    schemafile: P3,
...
#[inline]
pub unsafe fn MrmCreateResourceIndexerWithFlags<P0, P1, P3>(
    packagefamilyname: P0,
    projectroot: P1,
    platformversion: MrmPlatformVersion,
    defaultqualifiers: P3,
...
pub unsafe fn MrmDumpPriDataInMemory(
    ...
    unsafe {
        MrmDumpPriDataInMemory(
            core::mem::transmute(inputpridata.as_ptr()),
            inputpridata.len().try_into().unwrap(),
            core::mem::transmute(
                schemapridata
                    .as_deref()
                    .map_or(core::ptr::null(), |slice| slice.as_ptr()),
...
#[inline]
pub unsafe fn MrmDumpPriFile<P0, P1, P3>(
    indexfilename: P0,
    schemaprifile: P1,
    dumptype: MrmDumpType,
    outputxmlfile: P3,
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        MrmDumpPriFile(
            indexfilename.param().abi(),
            schemaprifile.param().abi(),
            dumptype,
            outputxmlfile.param().abi(),
        )
        .ok()
...
#[inline]
pub unsafe fn MrmIndexEmbeddedData<P1, P4>(
    indexer: MrmResourceIndexerHandle,
    resourceuri: P1,
    embeddeddata: &[u8],
    qualifiers: P4,
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        MrmIndexEmbeddedData(
            core::mem::transmute(indexer),
            resourceuri.param().abi(),
            core::mem::transmute(embeddeddata.as_ptr()),
            embeddeddata.len().try_into().unwrap(),
            qualifiers.param().abi(),
        )
        .ok()
    }
}
#[inline]
pub unsafe fn MrmIndexFile<P1, P2, P3>(
    indexer: MrmResourceIndexerHandle,
    resourceuri: P1,
    filepath: P2,
    qualifiers: P3,
...
#[inline]
pub unsafe fn MrmIndexFileAutoQualifiers<P1>(
    indexer: MrmResourceIndexerHandle,
    filepath: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn MrmIndexResourceContainerAutoQualifiers<P1>(
    indexer: MrmResourceIndexerHandle,
    containerpath: P1,
) -> windows_core::Result<()>
where
...
pub unsafe fn MrmPeekResourceIndexerMessages(
    ...
    messages: *mut *mut MrmResourceIndexerMessage,
    nummsgs: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        MrmPeekResourceIndexerMessages(core::mem::transmute(handle), messages as _, nummsgs as _)
            .ok()
    }
}
#[inline]
pub unsafe fn MsgWaitForMultipleObjects(
    phandles: Option<&[super::super::Foundation::HANDLE]>,
    fwaitall: bool,
    dwmilliseconds: u32,
...
#[inline]
pub unsafe fn PhysicalToLogicalPoint(
    hwnd: super::super::Foundation::HWND,
    lppoint: *mut super::super::Foundation::POINT,
) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn PostThreadMessageA(
    idthread: u32,
    msg: u32,
    wparam: super::super::Foundation::WPARAM,
    lparam: super::super::Foundation::LPARAM,
...
#[inline]
pub unsafe fn PrivateExtractIconsA(
    szfilename: &[u8; 260],
    niconindex: i32,
    cxicon: i32,
    cyicon: i32,
    ...
    unsafe {
        PrivateExtractIconsA(
            core::mem::transmute(szfilename.as_ptr()),
            niconindex,
            cxicon,
            cyicon,
            core::mem::transmute(
...
#[inline]
pub unsafe fn PrivateExtractIconsW(
    szfilename: &[u16; 260],
    niconindex: i32,
    cxicon: i32,
    cyicon: i32,
...
#[inline]
pub unsafe fn RealChildWindowFromPoint(
    hwndparent: super::super::Foundation::HWND,
...
#[inline]
pub unsafe fn RealGetWindowClassA(
    hwnd: super::super::Foundation::HWND,
    ptszclassname: &mut [u8],
) -> u32 {
    ...
    unsafe {
        RealGetWindowClassA(
            hwnd,
            core::mem::transmute(ptszclassname.as_ptr()),
            ptszclassname.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn RealGetWindowClassW(
    hwnd: super::super::Foundation::HWND,
...
pub unsafe fn RegisterDeviceNotificationA(
    ...
    notificationfilter: *const core::ffi::c_void,
    flags: REGISTER_NOTIFICATION_FLAGS,
) -> windows_core::Result<HDEVNOTIFY> {
...
pub unsafe fn ScrollDC(
    ...
    dx: i32,
    dy: i32,
    lprcscroll: Option<*const super::super::Foundation::RECT>,
    lprcclip: Option<*const super::super::Foundation::RECT>,
    hrgnupdate: Option<super::super::Graphics::Gdi::HRGN>,
    lprcupdate: Option<*mut super::super::Foundation::RECT>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        ScrollDC(
            ...
            dx,
            dy,
            lprcscroll.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn ScrollWindow(
    ...
    yamount: i32,
    lprect: Option<*const super::super::Foundation::RECT>,
    lpcliprect: Option<*const super::super::Foundation::RECT>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        ScrollWindow(
            ...
            yamount,
            lprect.unwrap_or(core::mem::zeroed()) as _,
            lpcliprect.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn ScrollWindowEx(
    ...
    dx: i32,
    dy: i32,
    prcscroll: Option<*const super::super::Foundation::RECT>,
    prcclip: Option<*const super::super::Foundation::RECT>,
    hrgnupdate: Option<super::super::Graphics::Gdi::HRGN>,
    prcupdate: Option<*mut super::super::Foundation::RECT>,
    ...
    unsafe {
        ScrollWindowEx(
            ...
            dx,
            dy,
            prcscroll.unwrap_or(core::mem::zeroed()) as _,
            prcclip.unwrap_or(core::mem::zeroed()) as _,
            hrgnupdate.unwrap_or(core::mem::zeroed()) as _,
            prcupdate.unwrap_or(core::mem::zeroed()) as _,
            flags,
        )
    }
}
#[inline]
pub unsafe fn SendDlgItemMessageA(
    hdlg: super::super::Foundation::HWND,
    niddlgitem: i32,
    msg: u32,
    wparam: super::super::Foundation::WPARAM,
...
#[inline]
pub unsafe fn SendDlgItemMessageW(
    hdlg: super::super::Foundation::HWND,
    niddlgitem: i32,
    msg: u32,
    wparam: super::super::Foundation::WPARAM,
...
#[inline]
pub unsafe fn SendMessageCallbackA(
    hwnd: super::super::Foundation::HWND,
    msg: u32,
    wparam: super::super::Foundation::WPARAM,
    lparam: super::super::Foundation::LPARAM,
...
#[inline]
pub unsafe fn SendMessageCallbackW(
    hwnd: super::super::Foundation::HWND,
    msg: u32,
    wparam: super::super::Foundation::WPARAM,
    lparam: super::super::Foundation::LPARAM,
...
#[inline]
pub unsafe fn SendMessageTimeoutA(
    hwnd: super::super::Foundation::HWND,
    msg: u32,
    wparam: super::super::Foundation::WPARAM,
    lparam: super::super::Foundation::LPARAM,
...
pub unsafe fn SendMessageW(
    hwnd: super::super::Foundation::HWND,
    msg: u32,
    wparam: Option<super::super::Foundation::WPARAM>,
    lparam: Option<super::super::Foundation::LPARAM>,
) -> super::super::Foundation::LRESULT {
    ...
    unsafe {
        SendMessageW(
            hwnd,
            msg,
            wparam.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn SetAdditionalForegroundBoostProcesses(
    toplevelwindow: super::super::Foundation::HWND,
    processhandlearray: &[super::super::Foundation::HANDLE],
) -> windows_core::BOOL {
    ...
    unsafe {
        SetAdditionalForegroundBoostProcesses(
            toplevelwindow,
            processhandlearray.len().try_into().unwrap(),
            core::mem::transmute(processhandlearray.as_ptr()),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn SetClassLongPtrA(
    hwnd: super::super::Foundation::HWND,
    nindex: GET_CLASS_LONG_INDEX,
    dwnewlong: isize,
) -> usize {
...
#[inline]
pub unsafe fn SetClassLongPtrW(
    hwnd: super::super::Foundation::HWND,
    nindex: GET_CLASS_LONG_INDEX,
    dwnewlong: isize,
) -> usize {
...
#[inline]
pub unsafe fn SetDlgItemTextA<P2>(
    hdlg: super::super::Foundation::HWND,
    niddlgitem: i32,
    lpstring: P2,
) -> windows_core::Result<()>
...
#[inline]
pub unsafe fn SetDlgItemTextW<P2>(
    hdlg: super::super::Foundation::HWND,
    niddlgitem: i32,
    lpstring: P2,
) -> windows_core::Result<()>
...
pub unsafe fn SetLayeredWindowAttributes(
    hwnd: super::super::Foundation::HWND,
    crkey: super::super::Foundation::COLORREF,
    balpha: u8,
...
#[inline]
pub unsafe fn SetMenuDefaultItem(
    hmenu: HMENU,
    uitem: u32,
    fbypos: u32,
) -> windows_core::Result<()> {
...
pub unsafe fn SetMenuItemBitmaps(
    ...
    uposition: u32,
    uflags: MENU_ITEM_FLAGS,
    hbitmapunchecked: Option<super::super::Graphics::Gdi::HBITMAP>,
    hbitmapchecked: Option<super::super::Graphics::Gdi::HBITMAP>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        SetMenuItemBitmaps(
            ...
            uposition,
            uflags,
            hbitmapunchecked.unwrap_or(core::mem::zeroed()) as _,
            hbitmapchecked.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn SetMenuItemInfoA(
    hmenu: HMENU,
    item: u32,
    fbypositon: bool,
...
#[inline]
pub unsafe fn SetMessageExtraInfo(
    lparam: super::super::Foundation::LPARAM,
...
pub unsafe fn SetParent(
    ...
    hwndnewparent: Option<super::super::Foundation::HWND>,
) -> windows_core::Result<super::super::Foundation::HWND> {
...
pub unsafe fn SetPropA<P1>(
    hwnd: super::super::Foundation::HWND,
    lpstring: P1,
    hdata: Option<super::super::Foundation::HANDLE>,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn SetWindowDisplayAffinity(
    hwnd: super::super::Foundation::HWND,
...
#[inline]
pub unsafe fn SetWindowTextA<P1>(
    hwnd: super::super::Foundation::HWND,
    lpstring: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn SetWindowTextW<P1>(
    hwnd: super::super::Foundation::HWND,
    lpstring: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn SetWindowsHookExA(
    idhook: WINDOWS_HOOK_ID,
    lpfn: HOOKPROC,
    hmod: Option<super::super::Foundation::HINSTANCE>,
    dwthreadid: u32,
...
#[inline]
pub unsafe fn SystemParametersInfoA(
...
pub unsafe fn TrackPopupMenu(
    ...
    hwnd: super::super::Foundation::HWND,
    prcrect: Option<*const super::super::Foundation::RECT>,
) -> windows_core::BOOL {
    ...
    unsafe {
        TrackPopupMenu(
            ...
            x,
            y,
            nreserved.unwrap_or(core::mem::zeroed()) as _,
            hwnd,
            prcrect.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn TranslateAcceleratorA(
    hwnd: super::super::Foundation::HWND,
    hacctable: HACCEL,
    lpmsg: *const MSG,
) -> i32 {
...
#[inline]
pub unsafe fn TranslateAcceleratorW(
    hwnd: super::super::Foundation::HWND,
    hacctable: HACCEL,
    lpmsg: *const MSG,
) -> i32 {
...
#[inline]
pub unsafe fn TranslateMDISysAccel(
...
#[inline]
pub unsafe fn UnregisterClassA<P0>(
    lpclassname: P0,
    hinstance: Option<super::super::Foundation::HINSTANCE>,
) -> windows_core::Result<()>
where
...
pub unsafe fn UpdateLayeredWindow(
    hwnd: super::super::Foundation::HWND,
    hdcdst: Option<super::super::Graphics::Gdi::HDC>,
    pptdst: Option<*const super::super::Foundation::POINT>,
    psize: Option<*const super::super::Foundation::SIZE>,
    hdcsrc: Option<super::super::Graphics::Gdi::HDC>,
    pptsrc: Option<*const super::super::Foundation::POINT>,
    crkey: super::super::Foundation::COLORREF,
    pblend: Option<*const super::super::Graphics::Gdi::BLENDFUNCTION>,
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn UpdateLayeredWindowIndirect(
    hwnd: super::super::Foundation::HWND,
...
#[inline]
pub unsafe fn WindowFromPhysicalPoint(
    point: super::super::Foundation::POINT,
) -> super::super::Foundation::HWND {
...
pub const DEVICE_NOTIFY_ALL_INTERFACE_CLASSES: REGISTER_NOTIFICATION_FLAGS =
    REGISTER_NOTIFICATION_FLAGS(4u32);
pub const DEVICE_NOTIFY_CALLBACK: REGISTER_NOTIFICATION_FLAGS = REGISTER_NOTIFICATION_FLAGS(2u32);
pub const DEVICE_NOTIFY_SERVICE_HANDLE: REGISTER_NOTIFICATION_FLAGS =
    REGISTER_NOTIFICATION_FLAGS(1u32);
pub const DEVICE_NOTIFY_WINDOW_HANDLE: REGISTER_NOTIFICATION_FLAGS =
    REGISTER_NOTIFICATION_FLAGS(0u32);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const GUID_DEVICE_EVENT_RBC: windows_core::GUID =
    windows_core::GUID::from_u128(0xd0744792_a98e_11d2_917a_00a0c9068ff3);
pub const GUID_IO_CDROM_EXCLUSIVE_LOCK: windows_core::GUID =
    windows_core::GUID::from_u128(0xbc56c139_7a10_47ee_a294_4c6a38f0149a);
pub const GUID_IO_CDROM_EXCLUSIVE_UNLOCK: windows_core::GUID =
    windows_core::GUID::from_u128(0xa3b6d27d_5e35_4885_81e5_ee18c00ed779);
pub const GUID_IO_DEVICE_BECOMING_READY: windows_core::GUID =
    windows_core::GUID::from_u128(0xd07433f0_a98e_11d2_917a_00a0c9068ff3);
pub const GUID_IO_DEVICE_EXTERNAL_REQUEST: windows_core::GUID =
    windows_core::GUID::from_u128(0xd07433d0_a98e_11d2_917a_00a0c9068ff3);
pub const GUID_IO_DISK_CLONE_ARRIVAL: windows_core::GUID =
    windows_core::GUID::from_u128(0x6a61885b_7c39_43dd_9b56_b8ac22a549aa);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct GUID_IO_DISK_CLONE_ARRIVAL_INFORMATION {
    pub DiskNumber: u32,
}
pub const GUID_IO_DISK_HEALTH_NOTIFICATION: windows_core::GUID =
    windows_core::GUID::from_u128(0x0f1bd644_3916_49c5_b063_991940118fb2);
pub const GUID_IO_DISK_LAYOUT_CHANGE: windows_core::GUID =
    windows_core::GUID::from_u128(0x11dff54c_8469_41f9_b3de_ef836487c54a);
pub const GUID_IO_DRIVE_REQUIRES_CLEANING: windows_core::GUID =
    windows_core::GUID::from_u128(0x7207877c_90ed_44e5_a000_81428d4c79bb);
pub const GUID_IO_MEDIA_ARRIVAL: windows_core::GUID =
    windows_core::GUID::from_u128(0xd07433c0_a98e_11d2_917a_00a0c9068ff3);
pub const GUID_IO_MEDIA_EJECT_REQUEST: windows_core::GUID =
    windows_core::GUID::from_u128(0xd07433d1_a98e_11d2_917a_00a0c9068ff3);
pub const GUID_IO_MEDIA_REMOVAL: windows_core::GUID =
    windows_core::GUID::from_u128(0xd07433c1_a98e_11d2_917a_00a0c9068ff3);
pub const GUID_IO_TAPE_ERASE: windows_core::GUID =
    windows_core::GUID::from_u128(0x852d11eb_4bb8_4507_9d9b_417cc2b1b438);
pub const GUID_IO_VOLUME_BACKGROUND_FORMAT: windows_core::GUID =
    windows_core::GUID::from_u128(0xa2e5fc86_d5cd_4038_b2e3_4445065c2377);
pub const GUID_IO_VOLUME_CHANGE: windows_core::GUID =
    windows_core::GUID::from_u128(0x7373654a_812a_11d0_bec7_08002be2092f);
pub const GUID_IO_VOLUME_CHANGE_SIZE: windows_core::GUID =
    windows_core::GUID::from_u128(0x3a1625be_ad03_49f1_8ef8_6bbac182d1fd);
pub const GUID_IO_VOLUME_DEVICE_INTERFACE: windows_core::GUID =
    windows_core::GUID::from_u128(0x53f5630d_b6bf_11d0_94f2_00a0c91efb8b);
pub const GUID_IO_VOLUME_DISMOUNT: windows_core::GUID =
    windows_core::GUID::from_u128(0xd16a55e8_1059_11d2_8ffd_00a0c9a06d32);
pub const GUID_IO_VOLUME_DISMOUNT_FAILED: windows_core::GUID =
    windows_core::GUID::from_u128(0xe3c5b178_105d_11d2_8ffd_00a0c9a06d32);
pub const GUID_IO_VOLUME_FORCE_CLOSED: windows_core::GUID =
    windows_core::GUID::from_u128(0x411ad84f_433e_4dc2_a5ae_4a2d1a2de654);
pub const GUID_IO_VOLUME_FVE_STATUS_CHANGE: windows_core::GUID =
    windows_core::GUID::from_u128(0x062998b2_ee1f_4b6a_b857_e76cbbe9a6da);
pub const GUID_IO_VOLUME_INFO_MAKE_COMPAT: windows_core::GUID =
    windows_core::GUID::from_u128(0x3ab9a0d2_ef80_45cf_8cdc_cbe02a212906);
pub const GUID_IO_VOLUME_LOCK: windows_core::GUID =
    windows_core::GUID::from_u128(0x50708874_c9af_11d1_8fef_00a0c9a06d32);
pub const GUID_IO_VOLUME_LOCK_FAILED: windows_core::GUID =
    windows_core::GUID::from_u128(0xae2eed10_0ba8_11d2_8ffb_00a0c9a06d32);
pub const GUID_IO_VOLUME_MOUNT: windows_core::GUID =
    windows_core::GUID::from_u128(0xb5804878_1a96_11d2_8ffd_00a0c9a06d32);
pub const GUID_IO_VOLUME_NAME_CHANGE: windows_core::GUID =
    windows_core::GUID::from_u128(0x2de97f83_4c06_11d2_a532_00609713055a);
pub const GUID_IO_VOLUME_NEED_CHKDSK: windows_core::GUID =
    windows_core::GUID::from_u128(0x799a0960_0a0b_4e03_ad88_2fa7c6ce748a);
pub const GUID_IO_VOLUME_PHYSICAL_CONFIGURATION_CHANGE: windows_core::GUID =
    windows_core::GUID::from_u128(0x2de97f84_4c06_11d2_a532_00609713055a);
pub const GUID_IO_VOLUME_PREPARING_EJECT: windows_core::GUID =
    windows_core::GUID::from_u128(0xc79eb16e_0dac_4e7a_a86c_b25ceeaa88f6);
pub const GUID_IO_VOLUME_UNIQUE_ID_CHANGE: windows_core::GUID =
    windows_core::GUID::from_u128(0xaf39da42_6622_41f5_970b_139d092fa3d9);
pub const GUID_IO_VOLUME_UNLOCK: windows_core::GUID =
    windows_core::GUID::from_u128(0x9a8c3d68_d0cb_11d1_8fef_00a0c9a06d32);
pub const GUID_IO_VOLUME_WEARING_OUT: windows_core::GUID =
    windows_core::GUID::from_u128(0x873113ca_1486_4508_82ac_c3b2e5297aaa);
pub const GUID_IO_VOLUME_WORM_NEAR_FULL: windows_core::GUID =
    windows_core::GUID::from_u128(0xf3bfff82_f3de_48d2_af95_457f80b763f2);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const HWND_BROADCAST: super::super::Foundation::HWND =
    super::super::Foundation::HWND(65535i32 as _);
...
pub type MSGBOXCALLBACK =
    Option<unsafe extern "system" fn(lphelpinfo: *mut super::Shell::HELPINFO)>;
#[repr(C)]
#[cfg(feature = "Win32_UI_Shell")]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub type PREGISTERCLASSNAMEW =
    Option<unsafe extern "system" fn(param0: windows_core::PCWSTR) -> bool>;
...
>;
pub type PROPENUMPROCEXA = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HWND,
        param1: windows_core::PCSTR,
        param2: super::super::Foundation::HANDLE,
...
pub const STRSAFE_E_INSUFFICIENT_BUFFER: windows_core::HRESULT =
    windows_core::HRESULT(0x8007007A_u32 as _);
pub const STRSAFE_E_INVALID_PARAMETER: windows_core::HRESULT =

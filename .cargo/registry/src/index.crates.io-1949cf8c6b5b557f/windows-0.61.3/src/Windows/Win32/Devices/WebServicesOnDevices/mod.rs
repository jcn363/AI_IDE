...
pub unsafe fn WSDCreateDeviceHost<P0, P1>(
    pszlocalid: P0,
    pcontext: P1,
) -> windows_core::Result<IWSDDeviceHost>
where
...
#[inline]
pub unsafe fn WSDCreateDeviceHostAdvanced<P0, P1>(
    pszlocalid: P0,
    pcontext: P1,
...
pub unsafe fn WSDCreateDeviceProxy<P0, P1, P2>(
    ...
    pszlocalid: P1,
    pcontext: P2,
) -> windows_core::Result<IWSDDeviceProxy>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn WSDCreateDiscoveryProvider<P0>(
    pcontext: P0,
) -> windows_core::Result<IWSDiscoveryProvider>
where
    P0: windows_core::Param<IWSDXMLContext>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        WSDCreateDiscoveryProvider(pcontext.param().abi(), &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
...
#[inline]
pub unsafe fn WSDCreateDiscoveryPublisher<P0>(
    pcontext: P0,
) -> windows_core::Result<IWSDiscoveryPublisher>
where
    P0: windows_core::Param<IWSDXMLContext>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        WSDCreateDiscoveryPublisher(pcontext.param().abi(), &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
...
pub unsafe fn WSDCreateHttpMessageParameters() -> windows_core::Result<IWSDHttpMessageParameters> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        WSDCreateHttpMessageParameters(&mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
pub unsafe fn WSDCreateOutboundAttachment() -> windows_core::Result<IWSDOutboundAttachment> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        WSDCreateOutboundAttachment(&mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
...
pub unsafe fn WSDCreateUdpMessageParameters() -> windows_core::Result<IWSDUdpMessageParameters> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        WSDCreateUdpMessageParameters(&mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
...
pub unsafe fn WSDGenerateFault<P0, P1, P2, P3, P4>(
    ...
    pszdetail: P3,
    pcontext: P4,
) -> windows_core::Result<*mut WSD_SOAP_FAULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ...
        WSDGenerateFaultEx(
            pcode,
            psubcode.unwrap_or(core::mem::zeroed()) as _,
            preasons,
            pszdetail.param().abi(),
            &mut result__,
        )
...
pub unsafe fn WSDUriDecode(
    source: &[u16],
    destout: *mut windows_core::PWSTR,
    cchdestout: Option<*mut u32>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WSDUriDecode(
            core::mem::transmute(source.as_ptr()),
            source.len().try_into().unwrap(),
            destout as _,
            cchdestout.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WSDXMLBuildAnyForSingleElement(pelementname as _, psztext.param().abi(), ppany as _).ok()
    }
}
#[inline]
...
pub unsafe fn WSDXMLGetNameFromBuiltinNamespace<P0, P1>(
    psznamespace: P0,
    pszname: P1,
) -> windows_core::Result<*mut WSDXML_NAME>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
pub unsafe fn WSDXMLGetValueFromAny<P0, P1>(
    ...
    ppszvalue: *mut windows_core::PCWSTR,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
...
windows_core::imp::define_interface!(
    IWSDAddress,
    IWSDAddress_Vtbl,
    0xb9574c6c_12a6_4f74_93a1_3318ff605759
);
...
impl IWSDAddress {
    pub unsafe fn Serialize(&self, pszbuffer: &mut [u16], fsafe: bool) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Serialize)(
                ...
                core::mem::transmute(pszbuffer.as_ptr()),
                pszbuffer.len().try_into().unwrap(),
                fsafe.into(),
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Deserialize)(
                windows_core::Interface::as_raw(self),
                pszbuffer.param().abi(),
            )
            .ok()
...
pub struct IWSDAddress_Vtbl {
    ...
    pub Deserialize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
}
pub trait IWSDAddress_Impl: windows_core::IUnknownImpl {
    fn Serialize(
        &self,
        pszbuffer: windows_core::PWSTR,
        cchlength: u32,
        fsafe: windows_core::BOOL,
    ) -> windows_core::Result<()>;
...
impl IWSDAddress_Vtbl {
    pub const fn new<Identity: IWSDAddress_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Serialize<Identity: IWSDAddress_Impl, const OFFSET: isize>(
            ...
            unsafe {
                ...
                IWSDAddress_Impl::Serialize(
                    this,
                    core::mem::transmute_copy(&pszbuffer),
                    core::mem::transmute_copy(&cchlength),
                    core::mem::transmute_copy(&fsafe),
                )
                .into()
            }
        }
        unsafe extern "system" fn Deserialize<Identity: IWSDAddress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszbuffer: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IWSDAsyncCallback {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AsyncOperationComplete)(
                windows_core::Interface::as_raw(self),
                pasyncresult.param().abi(),
                pasyncstate.param().abi(),
            )
            .ok()
        }
    }
...
pub struct IWSDAsyncCallback_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub AsyncOperationComplete: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IWSDAsyncCallback_Impl: windows_core::IUnknownImpl {
    fn AsyncOperationComplete(
        &self,
        pasyncresult: windows_core::Ref<'_, IWSDAsyncResult>,
        pasyncstate: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
}
impl IWSDAsyncCallback_Vtbl {
    pub const fn new<Identity: IWSDAsyncCallback_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AsyncOperationComplete<
            Identity: IWSDAsyncCallback_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pasyncresult: *mut core::ffi::c_void,
            pasyncstate: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDAsyncCallback_Impl::AsyncOperationComplete(
                    this,
                    core::mem::transmute_copy(&pasyncresult),
                    core::mem::transmute_copy(&pasyncstate),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            AsyncOperationComplete: AsyncOperationComplete::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IWSDAsyncResult {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetCallback)(
                windows_core::Interface::as_raw(self),
                pcallback.param().abi(),
                pasyncstate.param().abi(),
            )
    ...
    pub unsafe fn SetWaitHandle(
        &self,
        hwaithandle: super::super::Foundation::HANDLE,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetWaitHandle)(
                windows_core::Interface::as_raw(self),
                hwaithandle,
            )
            .ok()
    ...
    pub unsafe fn HasCompleted(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).HasCompleted)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn GetAsyncState(&self) -> windows_core::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAsyncState)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetEndpointProxy(&self) -> windows_core::Result<IWSDEndpointProxy> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEndpointProxy)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IWSDAsyncResult_Vtbl {
    ...
    pub SetWaitHandle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::HANDLE,
    ) -> windows_core::HRESULT,
    pub HasCompleted: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub GetAsyncState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Abort: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub GetEvent:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut WSD_EVENT) -> windows_core::HRESULT,
    pub GetEndpointProxy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IWSDAsyncResult_Impl: windows_core::IUnknownImpl {
    fn SetCallback(
        &self,
        pcallback: windows_core::Ref<'_, IWSDAsyncCallback>,
        pasyncstate: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
    fn SetWaitHandle(
        &self,
...
impl IWSDAsyncResult_Vtbl {
    pub const fn new<Identity: IWSDAsyncResult_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetCallback<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDAsyncResult_Impl::SetCallback(
                    this,
        ...
        unsafe extern "system" fn SetWaitHandle<
            Identity: IWSDAsyncResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDAsyncResult_Impl::SetWaitHandle(this, core::mem::transmute_copy(&hwaithandle))
                    .into()
            }
        }
        unsafe extern "system" fn HasCompleted<
            Identity: IWSDAsyncResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetAsyncState<
            Identity: IWSDAsyncResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppasyncstate: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Abort<Identity: IWSDAsyncResult_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetEvent<Identity: IWSDAsyncResult_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pevent: *mut WSD_EVENT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetEndpointProxy<
            Identity: IWSDAsyncResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IWSDDeviceHost,
    IWSDDeviceHost_Vtbl,
    0x917fe891_3d13_4138_9809_934c8abeb12c
);
...
impl IWSDDeviceHost {
    ...
    pub unsafe fn RegisterPortType(
        &self,
        pporttype: *const WSD_PORT_TYPE,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterPortType)(
                windows_core::Interface::as_raw(self),
                pporttype,
            )
            .ok()
    ...
    pub unsafe fn SetMetadata(
        ...
        phostmetadata: Option<*const WSD_HOST_METADATA>,
        pcustommetadata: Option<*const WSD_METADATA_SECTION_LIST>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMetadata)(
                ...
                pthismodelmetadata,
                pthisdevicemetadata,
                phostmetadata.unwrap_or(core::mem::zeroed()) as _,
                pcustommetadata.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterService)(
                windows_core::Interface::as_raw(self),
                pszserviceid.param().abi(),
                pservice.param().abi(),
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RetireService)(
                windows_core::Interface::as_raw(self),
                pszserviceid.param().abi(),
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddDynamicService)(
                windows_core::Interface::as_raw(self),
                pszserviceid.param().abi(),
                pszendpointaddress.param().abi(),
                pporttype.unwrap_or(core::mem::zeroed()) as _,
                pportname.unwrap_or(core::mem::zeroed()) as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveDynamicService)(
                windows_core::Interface::as_raw(self),
                pszserviceid.param().abi(),
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetServiceDiscoverable)(
                windows_core::Interface::as_raw(self),
                pszserviceid.param().abi(),
                fdiscoverable.into(),
            )
    ...
    pub unsafe fn SignalEvent<P0>(
        &self,
        pszserviceid: P0,
        pbody: Option<*const core::ffi::c_void>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SignalEvent)(
                windows_core::Interface::as_raw(self),
                pszserviceid.param().abi(),
                pbody.unwrap_or(core::mem::zeroed()) as _,
                poperation,
            )
            .ok()
        }
...
pub struct IWSDDeviceHost_Vtbl {
    ...
    pub RegisterPortType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_PORT_TYPE,
    ) -> windows_core::HRESULT,
    pub SetMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_THIS_MODEL_METADATA,
        *const WSD_THIS_DEVICE_METADATA,
        *const WSD_HOST_METADATA,
        *const WSD_METADATA_SECTION_LIST,
    ) -> windows_core::HRESULT,
    ...
    pub RetireService: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub AddDynamicService: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *const WSD_PORT_TYPE,
    ...
    pub RemoveDynamicService: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub SetServiceDiscoverable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub SignalEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
...
pub trait IWSDDeviceHost_Impl: windows_core::IUnknownImpl {
    fn Init(
        &self,
        pszlocalid: &windows_core::PCWSTR,
        pcontext: windows_core::Ref<'_, IWSDXMLContext>,
    ...
    fn Start(
        ...
        ullinstanceid: u64,
        pscopelist: *const WSD_URI_LIST,
        pnotificationsink: windows_core::Ref<'_, IWSDDeviceHostNotify>,
    ) -> windows_core::Result<()>;
    ...
    fn RegisterService(
        &self,
        pszserviceid: &windows_core::PCWSTR,
        pservice: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
    fn RetireService(&self, pszserviceid: &windows_core::PCWSTR) -> windows_core::Result<()>;
    fn AddDynamicService(
        &self,
        pszserviceid: &windows_core::PCWSTR,
        pszendpointaddress: &windows_core::PCWSTR,
        pporttype: *const WSD_PORT_TYPE,
        pportname: *const WSDXML_NAME,
        pany: *const WSDXML_ELEMENT,
        pservice: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
    fn RemoveDynamicService(&self, pszserviceid: &windows_core::PCWSTR)
        -> windows_core::Result<()>;
    fn SetServiceDiscoverable(
        &self,
        pszserviceid: &windows_core::PCWSTR,
        fdiscoverable: windows_core::BOOL,
    ) -> windows_core::Result<()>;
    fn SignalEvent(
        &self,
        pszserviceid: &windows_core::PCWSTR,
        pbody: *const core::ffi::c_void,
        poperation: *const WSD_OPERATION,
    ) -> windows_core::Result<()>;
}
impl IWSDDeviceHost_Vtbl {
    pub const fn new<Identity: IWSDDeviceHost_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Init<Identity: IWSDDeviceHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszlocalid: windows_core::PCWSTR,
            pcontext: *mut core::ffi::c_void,
            pphostaddresses: *const *mut core::ffi::c_void,
            dwhostaddresscount: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDDeviceHost_Impl::Init(
                    this,
                    core::mem::transmute(&pszlocalid),
                    core::mem::transmute_copy(&pcontext),
                    core::mem::transmute_copy(&pphostaddresses),
                    core::mem::transmute_copy(&dwhostaddresscount),
                )
                .into()
            }
        }
        unsafe extern "system" fn Start<Identity: IWSDDeviceHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ullinstanceid: u64,
            pscopelist: *const WSD_URI_LIST,
            pnotificationsink: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDDeviceHost_Impl::Start(
                    this,
                    core::mem::transmute_copy(&ullinstanceid),
                    core::mem::transmute_copy(&pscopelist),
                    core::mem::transmute_copy(&pnotificationsink),
                )
                .into()
            }
        }
        unsafe extern "system" fn Stop<Identity: IWSDDeviceHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Terminate<Identity: IWSDDeviceHost_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn RegisterPortType<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDDeviceHost_Impl::RegisterPortType(this, core::mem::transmute_copy(&pporttype))
                    .into()
            }
        }
        unsafe extern "system" fn SetMetadata<
            Identity: IWSDDeviceHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDDeviceHost_Impl::SetMetadata(
                    this,
                    core::mem::transmute_copy(&pthismodelmetadata),
                    core::mem::transmute_copy(&pthisdevicemetadata),
                    core::mem::transmute_copy(&phostmetadata),
                    core::mem::transmute_copy(&pcustommetadata),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDDeviceHost_Impl::RegisterService(
                    this,
                    core::mem::transmute(&pszserviceid),
                    core::mem::transmute_copy(&pservice),
                )
                .into()
            }
        }
        unsafe extern "system" fn RetireService<
            Identity: IWSDDeviceHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AddDynamicService<
            Identity: IWSDDeviceHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDDeviceHost_Impl::AddDynamicService(
                    this,
                    core::mem::transmute(&pszserviceid),
                    core::mem::transmute(&pszendpointaddress),
                    core::mem::transmute_copy(&pporttype),
                    core::mem::transmute_copy(&pportname),
        ...
        unsafe extern "system" fn RemoveDynamicService<
            Identity: IWSDDeviceHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDDeviceHost_Impl::RemoveDynamicService(this, core::mem::transmute(&pszserviceid))
                    .into()
            }
        }
        unsafe extern "system" fn SetServiceDiscoverable<
            Identity: IWSDDeviceHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDDeviceHost_Impl::SetServiceDiscoverable(
                    this,
                    core::mem::transmute(&pszserviceid),
                    core::mem::transmute_copy(&fdiscoverable),
                )
                .into()
            }
        }
        unsafe extern "system" fn SignalEvent<
            Identity: IWSDDeviceHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDDeviceHost_Impl::SignalEvent(
                    this,
                    core::mem::transmute(&pszserviceid),
    ...
    pub const fn new<Identity: IWSDDeviceHostNotify_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSDDeviceHostNotify_Impl::GetService(
                    this,
                    core::mem::transmute(&pszserviceid),
                ) {
                    Ok(ok__) => {
...
impl IWSDDeviceProxy {
    ...
    pub unsafe fn BeginGetMetadata(&self) -> windows_core::Result<IWSDAsyncResult> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BeginGetMetadata)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EndGetMetadata)(
                windows_core::Interface::as_raw(self),
                presult.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn GetHostMetadata(&self) -> windows_core::Result<*mut WSD_HOST_METADATA> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetHostMetadata)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetThisModelMetadata(
        &self,
    ) -> windows_core::Result<*mut WSD_THIS_MODEL_METADATA> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetThisModelMetadata)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetThisDeviceMetadata(
        &self,
    ) -> windows_core::Result<*mut WSD_THIS_DEVICE_METADATA> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetThisDeviceMetadata)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetAllMetadata(&self) -> windows_core::Result<*mut WSD_METADATA_SECTION_LIST> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAllMetadata)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetServiceProxyById<P0>(
        &self,
        pszserviceid: P0,
    ) -> windows_core::Result<IWSDServiceProxy>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetServiceProxyById)(
                windows_core::Interface::as_raw(self),
                pszserviceid.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn GetServiceProxyByType(
        &self,
        ptype: *const WSDXML_NAME,
    ) -> windows_core::Result<IWSDServiceProxy> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetServiceProxyByType)(
                windows_core::Interface::as_raw(self),
                ptype,
                &mut result__,
            )
...
pub struct IWSDDeviceProxy_Vtbl {
    ...
    pub BeginGetMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub EndGetMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetHostMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut WSD_HOST_METADATA,
    ) -> windows_core::HRESULT,
    pub GetThisModelMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut WSD_THIS_MODEL_METADATA,
    ) -> windows_core::HRESULT,
    pub GetThisDeviceMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut WSD_THIS_DEVICE_METADATA,
    ) -> windows_core::HRESULT,
    pub GetAllMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut WSD_METADATA_SECTION_LIST,
    ) -> windows_core::HRESULT,
    pub GetServiceProxyById: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetServiceProxyByType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSDXML_NAME,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IWSDDeviceProxy_Impl: windows_core::IUnknownImpl {
    fn Init(
        &self,
        pszdeviceid: &windows_core::PCWSTR,
        pdeviceaddress: windows_core::Ref<'_, IWSDAddress>,
        pszlocalid: &windows_core::PCWSTR,
        pcontext: windows_core::Ref<'_, IWSDXMLContext>,
        psponsor: windows_core::Ref<'_, IWSDDeviceProxy>,
    ) -> windows_core::Result<()>;
    fn BeginGetMetadata(&self) -> windows_core::Result<IWSDAsyncResult>;
    fn EndGetMetadata(
        &self,
        presult: windows_core::Ref<'_, IWSDAsyncResult>,
    ) -> windows_core::Result<()>;
...
impl IWSDDeviceProxy_Vtbl {
    pub const fn new<Identity: IWSDDeviceProxy_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Init<Identity: IWSDDeviceProxy_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszdeviceid: windows_core::PCWSTR,
            pdeviceaddress: *mut core::ffi::c_void,
            pszlocalid: windows_core::PCWSTR,
            pcontext: *mut core::ffi::c_void,
            psponsor: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDDeviceProxy_Impl::Init(
                    this,
                    core::mem::transmute(&pszdeviceid),
                    core::mem::transmute_copy(&pdeviceaddress),
                    core::mem::transmute(&pszlocalid),
                    core::mem::transmute_copy(&pcontext),
                    core::mem::transmute_copy(&psponsor),
                )
                .into()
            }
        }
        unsafe extern "system" fn BeginGetMetadata<
        ...
        unsafe extern "system" fn EndGetMetadata<
            Identity: IWSDDeviceProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            presult: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDDeviceProxy_Impl::EndGetMetadata(this, core::mem::transmute_copy(&presult))
                    .into()
            }
        }
        unsafe extern "system" fn GetHostMetadata<
            Identity: IWSDDeviceProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pphostmetadata: *mut *mut WSD_HOST_METADATA,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetThisModelMetadata<
            Identity: IWSDDeviceProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppmanufacturermetadata: *mut *mut WSD_THIS_MODEL_METADATA,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetThisDeviceMetadata<
            Identity: IWSDDeviceProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppthisdevicemetadata: *mut *mut WSD_THIS_DEVICE_METADATA,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetAllMetadata<
            Identity: IWSDDeviceProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppmetadata: *mut *mut WSD_METADATA_SECTION_LIST,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetServiceProxyById<
            Identity: IWSDDeviceProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pszserviceid: windows_core::PCWSTR,
            ppserviceproxy: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSDDeviceProxy_Impl::GetServiceProxyById(
                    this,
                    core::mem::transmute(&pszserviceid),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetServiceProxyByType<
            Identity: IWSDDeviceProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSDDeviceProxy_Impl::GetServiceProxyByType(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0x1860d430_b24c_4975_9f90_dbb39baa24ec
);
windows_core::imp::interface_hierarchy!(IWSDEndpointProxy, windows_core::IUnknown);
impl IWSDEndpointProxy {
    pub unsafe fn SendOneWayRequest(
        &self,
        pbody: *const core::ffi::c_void,
        poperation: *const WSD_OPERATION,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SendOneWayRequest)(
                windows_core::Interface::as_raw(self),
                pbody,
                poperation,
            )
    ...
    pub unsafe fn SendTwoWayRequest(
        &self,
        pbody: *const core::ffi::c_void,
        poperation: *const WSD_OPERATION,
        presponsecontext: Option<*const WSD_SYNCHRONOUS_RESPONSE_CONTEXT>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SendTwoWayRequest)(
                windows_core::Interface::as_raw(self),
                pbody,
                poperation,
                presponsecontext.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn SendTwoWayRequestAsync<P2, P3>(
        &self,
        pbody: *const core::ffi::c_void,
        poperation: *const WSD_OPERATION,
        pasyncstate: P2,
        ...
        P3: windows_core::Param<IWSDAsyncCallback>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SendTwoWayRequestAsync)(
                windows_core::Interface::as_raw(self),
                pbody,
                poperation,
                pasyncstate.param().abi(),
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AbortAsyncOperation)(
                windows_core::Interface::as_raw(self),
                pasyncresult.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn ProcessFault(&self, pfault: *const WSD_SOAP_FAULT) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ProcessFault)(
                windows_core::Interface::as_raw(self),
                pfault,
            )
            .ok()
    ...
    pub unsafe fn GetFaultInfo(&self) -> windows_core::Result<*mut WSD_SOAP_FAULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFaultInfo)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWSDEndpointProxy_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SendOneWayRequest: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        *const WSD_OPERATION,
    ) -> windows_core::HRESULT,
    pub SendTwoWayRequest: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        *const WSD_OPERATION,
        *const WSD_SYNCHRONOUS_RESPONSE_CONTEXT,
    ) -> windows_core::HRESULT,
    pub SendTwoWayRequestAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        *const WSD_OPERATION,
        *mut core::ffi::c_void,
    ...
    pub AbortAsyncOperation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ProcessFault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_SOAP_FAULT,
    ) -> windows_core::HRESULT,
    pub GetErrorInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetFaultInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut WSD_SOAP_FAULT,
    ) -> windows_core::HRESULT,
}
...
impl IWSDEndpointProxy_Vtbl {
    pub const fn new<Identity: IWSDEndpointProxy_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SendOneWayRequest<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDEndpointProxy_Impl::SendOneWayRequest(
                    this,
                    core::mem::transmute_copy(&pbody),
                    core::mem::transmute_copy(&poperation),
                )
        ...
        unsafe extern "system" fn SendTwoWayRequest<
            Identity: IWSDEndpointProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDEndpointProxy_Impl::SendTwoWayRequest(
                    this,
                    core::mem::transmute_copy(&pbody),
                    core::mem::transmute_copy(&poperation),
                    core::mem::transmute_copy(&presponsecontext),
                )
                .into()
            }
        }
        unsafe extern "system" fn SendTwoWayRequestAsync<
            Identity: IWSDEndpointProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            pasyncstate: *mut core::ffi::c_void,
            pcallback: *mut core::ffi::c_void,
            presult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSDEndpointProxy_Impl::SendTwoWayRequestAsync(
                    this,
                    core::mem::transmute_copy(&pbody),
                    core::mem::transmute_copy(&poperation),
                    core::mem::transmute_copy(&pasyncstate),
        ...
        unsafe extern "system" fn AbortAsyncOperation<
            Identity: IWSDEndpointProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDEndpointProxy_Impl::AbortAsyncOperation(
                    this,
                    core::mem::transmute_copy(&pasyncresult),
                )
                .into()
        ...
        unsafe extern "system" fn ProcessFault<
            Identity: IWSDEndpointProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDEndpointProxy_Impl::ProcessFault(this, core::mem::transmute_copy(&pfault))
                    .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            ppszerrorinfo: *mut windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetFaultInfo<
            Identity: IWSDEndpointProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x49b17f52_637a_407a_ae99_fbe82a4d38c0
);
...
impl IWSDEventingStatus {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SubscriptionRenewed)(
                windows_core::Interface::as_raw(self),
                pszsubscriptionaction.param().abi(),
            )
        }
    }
    pub unsafe fn SubscriptionRenewalFailed<P0>(
        &self,
        pszsubscriptionaction: P0,
        hr: windows_core::HRESULT,
    ) where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SubscriptionRenewalFailed)(
                windows_core::Interface::as_raw(self),
                pszsubscriptionaction.param().abi(),
                hr,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SubscriptionEnded)(
                windows_core::Interface::as_raw(self),
                pszsubscriptionaction.param().abi(),
            )
        }
...
pub struct IWSDEventingStatus_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SubscriptionRenewed:
        unsafe extern "system" fn(*mut core::ffi::c_void, windows_core::PCWSTR),
    pub SubscriptionRenewalFailed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::HRESULT,
    ),
...
pub trait IWSDEventingStatus_Impl: windows_core::IUnknownImpl {
    ...
    fn SubscriptionRenewalFailed(
        &self,
        pszsubscriptionaction: &windows_core::PCWSTR,
        hr: windows_core::HRESULT,
    );
...
impl IWSDEventingStatus_Vtbl {
    pub const fn new<Identity: IWSDEventingStatus_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SubscriptionRenewed<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDEventingStatus_Impl::SubscriptionRenewed(
                    this,
                    core::mem::transmute(&pszsubscriptionaction),
                )
            }
        }
        unsafe extern "system" fn SubscriptionRenewalFailed<
            Identity: IWSDEventingStatus_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDEventingStatus_Impl::SubscriptionRenewalFailed(
                    this,
                    core::mem::transmute(&pszsubscriptionaction),
        ...
        unsafe extern "system" fn SubscriptionEnded<
            Identity: IWSDEventingStatus_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDEventingStatus_Impl::SubscriptionEnded(
                    this,
                    core::mem::transmute(&pszsubscriptionaction),
                )
            }
...
impl IWSDHttpAddress {
    pub unsafe fn GetSecure(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetSecure)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn SetSecure(&self, fsecure: bool) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSecure)(
                windows_core::Interface::as_raw(self),
                fsecure.into(),
            )
            .ok()
...
pub struct IWSDHttpAddress_Vtbl {
    ...
    pub SetSecure: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
...
impl IWSDHttpAddress_Vtbl {
    pub const fn new<Identity: IWSDHttpAddress_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetSecure<Identity: IWSDHttpAddress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn SetSecure<Identity: IWSDHttpAddress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fsecure: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetPath<Identity: IWSDHttpAddress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppszpath: *mut windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetPath<Identity: IWSDHttpAddress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
...
impl IWSDHttpAuthParameters {
    ...
    pub unsafe fn GetAuthType(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAuthType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWSDHttpAuthParameters_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetClientAccessToken: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IWSDHttpAuthParameters_Vtbl {
    pub const fn new<Identity: IWSDHttpAuthParameters_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetClientAccessToken<
        ...
        unsafe extern "system" fn GetAuthType<
            Identity: IWSDHttpAuthParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x540bd122_5c83_4dec_b396_ea62a2697fdf
);
...
impl IWSDHttpMessageParameters {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetInboundHttpHeaders)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn GetInboundHttpHeaders(&self) -> windows_core::Result<windows_core::PCWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetInboundHttpHeaders)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetOutboundHttpHeaders)(
                windows_core::Interface::as_raw(self),
                pszheaders.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn GetOutboundHttpHeaders(&self) -> windows_core::Result<windows_core::PCWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOutboundHttpHeaders)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWSDHttpMessageParameters_Vtbl {
    ...
    pub SetInboundHttpHeaders: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetInboundHttpHeaders: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub SetOutboundHttpHeaders: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetOutboundHttpHeaders: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
...
pub trait IWSDHttpMessageParameters_Impl: IWSDMessageParameters_Impl {
    ...
    fn SetOutboundHttpHeaders(&self, pszheaders: &windows_core::PCWSTR)
        -> windows_core::Result<()>;
...
impl IWSDHttpMessageParameters_Vtbl {
    pub const fn new<Identity: IWSDHttpMessageParameters_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetInboundHttpHeaders<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDHttpMessageParameters_Impl::SetInboundHttpHeaders(
                    this,
        ...
        unsafe extern "system" fn GetInboundHttpHeaders<
            Identity: IWSDHttpMessageParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppszheaders: *mut windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetOutboundHttpHeaders<
            Identity: IWSDHttpMessageParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDHttpMessageParameters_Impl::SetOutboundHttpHeaders(
                    this,
                    core::mem::transmute(&pszheaders),
                )
                .into()
        ...
        unsafe extern "system" fn GetOutboundHttpHeaders<
            Identity: IWSDHttpMessageParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            this: *mut core::ffi::c_void,
            ppszid: *mut windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDHttpMessageParameters_Impl::SetContext(
                    this,
                    core::mem::transmute_copy(&pcontext),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    0x5bd6ca65_233c_4fb8_9f7a_2641619655c9
);
    ...
    pub const fn new<Identity: IWSDInboundAttachment_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDInboundAttachment_Impl::Read(
                    this,
                    core::mem::transmute_copy(&pbuffer),
                    core::mem::transmute_copy(&dwbytestoread),
                    core::mem::transmute_copy(&pdwnumberofbytesread),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x1fafe8a2_e6fc_4b80_b6cf_b7d45c416d7c
);
...
impl IWSDMessageParameters {
    pub unsafe fn GetLocalAddress(&self) -> windows_core::Result<IWSDAddress> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLocalAddress)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetLocalAddress)(
                windows_core::Interface::as_raw(self),
                paddress.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn GetRemoteAddress(&self) -> windows_core::Result<IWSDAddress> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRemoteAddress)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetRemoteAddress)(
                windows_core::Interface::as_raw(self),
                paddress.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn GetLowerParameters(&self) -> windows_core::Result<IWSDMessageParameters> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLowerParameters)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IWSDMessageParameters_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetLocalAddress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetLocalAddress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetRemoteAddress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetRemoteAddress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetLowerParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IWSDMessageParameters_Impl: windows_core::IUnknownImpl {
    ...
    fn SetLocalAddress(
        &self,
        paddress: windows_core::Ref<'_, IWSDAddress>,
    ) -> windows_core::Result<()>;
...
impl IWSDMessageParameters_Vtbl {
    pub const fn new<Identity: IWSDMessageParameters_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetLocalAddress<
        ...
        unsafe extern "system" fn SetLocalAddress<
            Identity: IWSDMessageParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDMessageParameters_Impl::SetLocalAddress(
                    this,
        ...
        unsafe extern "system" fn GetRemoteAddress<
            Identity: IWSDMessageParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetRemoteAddress<
            Identity: IWSDMessageParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDMessageParameters_Impl::SetRemoteAddress(
                    this,
                    core::mem::transmute_copy(&paddress),
                )
                .into()
        ...
        unsafe extern "system" fn GetLowerParameters<
            Identity: IWSDMessageParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pptxparams: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    IWSDMetadataExchange_Vtbl,
    0x06996d57_1d67_4928_9307_3d7833fdb846
);
...
impl IWSDMetadataExchange_Vtbl {
    pub const fn new<Identity: IWSDMetadataExchange_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            metadataout: *mut *mut WSD_METADATA_SECTION_LIST,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0xaa302f8d_5a22_4ba5_b392_aa8486f4c15d
);
...
impl IWSDOutboundAttachment_Vtbl {
    pub const fn new<Identity: IWSDOutboundAttachment_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            pbuffer: *const u8,
            dwbytestowrite: u32,
            pdwnumberofbyteswritten: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSDOutboundAttachment_Impl::Write(
                    this,
                    core::mem::transmute_copy(&pbuffer),
                    core::mem::transmute_copy(&dwbytestowrite),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0xde105e87_a0da_418e_98ad_27b9eed87bdc
);
...
impl IWSDSSLClientCertificate {
    ...
    pub unsafe fn GetClientCertificate(
        &self,
    ) -> windows_core::Result<*mut super::super::Security::Cryptography::CERT_CONTEXT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetClientCertificate)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetMappedAccessToken(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMappedAccessToken)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWSDSSLClientCertificate_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_Security_Cryptography")]
    pub GetClientCertificate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::super::Security::Cryptography::CERT_CONTEXT,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Security_Cryptography"))]
    GetClientCertificate: usize,
    pub GetMappedAccessToken: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::HANDLE,
    ) -> windows_core::HRESULT,
}
...
impl IWSDSSLClientCertificate_Vtbl {
    pub const fn new<Identity: IWSDSSLClientCertificate_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetClientCertificate<
        ...
        unsafe extern "system" fn GetMappedAccessToken<
            Identity: IWSDSSLClientCertificate_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xfcafe424_fef5_481a_bd9f_33ce0574256f
);
...
impl IWSDScopeMatchingRule {
    pub unsafe fn GetScopeRule(&self) -> windows_core::Result<windows_core::PCWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetScopeRule)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn MatchScopes<P0, P1>(
        &self,
        pszscope1: P0,
        pszscope2: P1,
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MatchScopes)(
                windows_core::Interface::as_raw(self),
                pszscope1.param().abi(),
                pszscope2.param().abi(),
                &mut result__,
...
pub struct IWSDScopeMatchingRule_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetScopeRule: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub MatchScopes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
impl IWSDScopeMatchingRule_Vtbl {
    pub const fn new<Identity: IWSDScopeMatchingRule_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn MatchScopes<
            Identity: IWSDScopeMatchingRule_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pszscope1: windows_core::PCWSTR,
            pszscope2: windows_core::PCWSTR,
            pfmatch: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSDScopeMatchingRule_Impl::MatchScopes(
                    this,
                    core::mem::transmute(&pszscope1),
                    core::mem::transmute(&pszscope2),
                ) {
                    Ok(ok__) => {
...
impl IWSDServiceMessaging {
    ...
    pub unsafe fn FaultRequest<P1>(
        &self,
        prequestheader: *const WSD_SOAP_HEADER,
        pmessageparameters: P1,
        pfault: Option<*const WSD_SOAP_FAULT>,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<IWSDMessageParameters>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).FaultRequest)(
                windows_core::Interface::as_raw(self),
                prequestheader,
                pmessageparameters.param().abi(),
                pfault.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
...
pub struct IWSDServiceMessaging_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SendResponse: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        *const WSD_OPERATION,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FaultRequest: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_SOAP_HEADER,
        *mut core::ffi::c_void,
        *const WSD_SOAP_FAULT,
    ) -> windows_core::HRESULT,
}
pub trait IWSDServiceMessaging_Impl: windows_core::IUnknownImpl {
    fn SendResponse(
        ...
        pbody: *const core::ffi::c_void,
        poperation: *const WSD_OPERATION,
        pmessageparameters: windows_core::Ref<'_, IWSDMessageParameters>,
    ) -> windows_core::Result<()>;
    fn FaultRequest(
        &self,
        prequestheader: *const WSD_SOAP_HEADER,
...
impl IWSDServiceMessaging_Vtbl {
    pub const fn new<Identity: IWSDServiceMessaging_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SendResponse<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceMessaging_Impl::SendResponse(
                    this,
                    core::mem::transmute_copy(&pbody),
                    core::mem::transmute_copy(&poperation),
        ...
        unsafe extern "system" fn FaultRequest<
            Identity: IWSDServiceMessaging_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceMessaging_Impl::FaultRequest(
                    this,
                    core::mem::transmute_copy(&prequestheader),
                    core::mem::transmute_copy(&pmessageparameters),
...
windows_core::imp::define_interface!(
    ...
    0xd4c7fb9c_03ab_4175_9d67_094fafebf487
);
...
impl IWSDServiceProxy {
    ...
    pub unsafe fn EndGetMetadata<P0>(
        &self,
        presult: P0,
    ) -> windows_core::Result<*mut WSD_METADATA_SECTION_LIST>
    where
        P0: windows_core::Param<IWSDAsyncResult>,
    {
        unsafe {
    ...
    pub unsafe fn GetServiceMetadata(&self) -> windows_core::Result<*mut WSD_SERVICE_METADATA> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetServiceMetadata)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SubscribeToOperation<P1>(
        &self,
        poperation: *const WSD_OPERATION,
        punknown: P1,
        pany: *const WSDXML_ELEMENT,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SubscribeToOperation)(
                windows_core::Interface::as_raw(self),
                poperation,
                punknown.param().abi(),
                pany,
                ppany.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn UnsubscribeToOperation(
        &self,
        poperation: *const WSD_OPERATION,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).UnsubscribeToOperation)(
                windows_core::Interface::as_raw(self),
                poperation,
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetEventingStatusCallback)(
                windows_core::Interface::as_raw(self),
                pstatus.param().abi(),
            )
            .ok()
...
pub struct IWSDServiceProxy_Vtbl {
    ...
    pub GetServiceMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut WSD_SERVICE_METADATA,
    ) -> windows_core::HRESULT,
    pub SubscribeToOperation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        *mut core::ffi::c_void,
        *const WSDXML_ELEMENT,
        *mut *mut WSDXML_ELEMENT,
    ) -> windows_core::HRESULT,
    pub UnsubscribeToOperation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
    ) -> windows_core::HRESULT,
    pub SetEventingStatusCallback: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetEndpointProxy: unsafe extern "system" fn(
...
pub trait IWSDServiceProxy_Impl: IWSDMetadataExchange_Impl {
    ...
    fn SetEventingStatusCallback(
        &self,
        pstatus: windows_core::Ref<'_, IWSDEventingStatus>,
    ) -> windows_core::Result<()>;
    fn GetEndpointProxy(&self) -> windows_core::Result<IWSDEndpointProxy>;
}
    ...
    pub const fn new<Identity: IWSDServiceProxy_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSDServiceProxy_Impl::EndGetMetadata(
                    this,
        ...
        unsafe extern "system" fn GetServiceMetadata<
            Identity: IWSDServiceProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppservicemetadata: *mut *mut WSD_SERVICE_METADATA,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SubscribeToOperation<
            Identity: IWSDServiceProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceProxy_Impl::SubscribeToOperation(
                    this,
                    core::mem::transmute_copy(&poperation),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceProxy_Impl::UnsubscribeToOperation(
                    this,
                    core::mem::transmute_copy(&poperation),
                )
                .into()
        ...
        unsafe extern "system" fn SetEventingStatusCallback<
            Identity: IWSDServiceProxy_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pstatus: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceProxy_Impl::SetEventingStatusCallback(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0xf9279d6d_1012_4a94_b8cc_fd35d2202bfe
);
...
impl IWSDServiceProxyEventing {
    pub unsafe fn SubscribeToMultipleOperations<P2>(
        &self,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SubscribeToMultipleOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(poperations.as_ptr()),
                poperations.len().try_into().unwrap(),
                punknown.param().abi(),
                pexpires.unwrap_or(core::mem::zeroed()) as _,
                pany.unwrap_or(core::mem::zeroed()) as _,
                ppexpires.unwrap_or(core::mem::zeroed()) as _,
                ppany.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn BeginSubscribeToMultipleOperations<P2, P5, P6>(
        &self,
        poperations: &[WSD_OPERATION],
        punknown: P2,
        pexpires: Option<*const WSD_EVENTING_EXPIRES>,
        ...
        P6: windows_core::Param<IWSDAsyncCallback>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BeginSubscribeToMultipleOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(poperations.as_ptr()),
                poperations.len().try_into().unwrap(),
                punknown.param().abi(),
                ...
                pany.unwrap_or(core::mem::zeroed()) as _,
                pasyncstate.param().abi(),
                pasynccallback.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn EndSubscribeToMultipleOperations<P2>(
        &self,
        poperations: &[WSD_OPERATION],
        presult: P2,
        ppexpires: Option<*mut *mut WSD_EVENTING_EXPIRES>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EndSubscribeToMultipleOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(poperations.as_ptr()),
                poperations.len().try_into().unwrap(),
                presult.param().abi(),
    ...
    pub unsafe fn UnsubscribeToMultipleOperations(
        &self,
        poperations: &[WSD_OPERATION],
        pany: *const WSDXML_ELEMENT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).UnsubscribeToMultipleOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(poperations.as_ptr()),
                poperations.len().try_into().unwrap(),
                pany,
    ...
    pub unsafe fn BeginUnsubscribeToMultipleOperations<P3, P4>(
        &self,
        poperations: &[WSD_OPERATION],
        pany: Option<*const WSDXML_ELEMENT>,
        pasyncstate: P3,
        ...
        P4: windows_core::Param<IWSDAsyncCallback>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BeginUnsubscribeToMultipleOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(poperations.as_ptr()),
                poperations.len().try_into().unwrap(),
                pany.unwrap_or(core::mem::zeroed()) as _,
    ...
    pub unsafe fn EndUnsubscribeToMultipleOperations<P2>(
        &self,
        poperations: &[WSD_OPERATION],
        presult: P2,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EndUnsubscribeToMultipleOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(poperations.as_ptr()),
                poperations.len().try_into().unwrap(),
                presult.param().abi(),
    ...
    pub unsafe fn RenewMultipleOperations(
        &self,
        poperations: &[WSD_OPERATION],
        pexpires: Option<*const WSD_EVENTING_EXPIRES>,
        pany: Option<*const WSDXML_ELEMENT>,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).RenewMultipleOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(poperations.as_ptr()),
                poperations.len().try_into().unwrap(),
                pexpires.unwrap_or(core::mem::zeroed()) as _,
    ...
    pub unsafe fn BeginRenewMultipleOperations<P4, P5>(
        &self,
        poperations: &[WSD_OPERATION],
        pexpires: Option<*const WSD_EVENTING_EXPIRES>,
        pany: Option<*const WSDXML_ELEMENT>,
        ...
        P5: windows_core::Param<IWSDAsyncCallback>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BeginRenewMultipleOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(poperations.as_ptr()),
                poperations.len().try_into().unwrap(),
                pexpires.unwrap_or(core::mem::zeroed()) as _,
    ...
    pub unsafe fn EndRenewMultipleOperations<P2>(
        &self,
        poperations: &[WSD_OPERATION],
        presult: P2,
        ppexpires: Option<*mut *mut WSD_EVENTING_EXPIRES>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EndRenewMultipleOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(poperations.as_ptr()),
                poperations.len().try_into().unwrap(),
                presult.param().abi(),
    ...
    pub unsafe fn GetStatusForMultipleOperations(
        &self,
        poperations: &[WSD_OPERATION],
        pany: Option<*const WSDXML_ELEMENT>,
        ppexpires: Option<*mut *mut WSD_EVENTING_EXPIRES>,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetStatusForMultipleOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(poperations.as_ptr()),
                poperations.len().try_into().unwrap(),
                pany.unwrap_or(core::mem::zeroed()) as _,
    ...
    pub unsafe fn BeginGetStatusForMultipleOperations<P3, P4>(
        &self,
        poperations: &[WSD_OPERATION],
        pany: Option<*const WSDXML_ELEMENT>,
        pasyncstate: P3,
        ...
        P4: windows_core::Param<IWSDAsyncCallback>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BeginGetStatusForMultipleOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(poperations.as_ptr()),
                poperations.len().try_into().unwrap(),
                pany.unwrap_or(core::mem::zeroed()) as _,
    ...
    pub unsafe fn EndGetStatusForMultipleOperations<P2>(
        &self,
        poperations: &[WSD_OPERATION],
        presult: P2,
        ppexpires: Option<*mut *mut WSD_EVENTING_EXPIRES>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EndGetStatusForMultipleOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(poperations.as_ptr()),
                poperations.len().try_into().unwrap(),
                presult.param().abi(),
...
pub struct IWSDServiceProxyEventing_Vtbl {
    ...
    pub SubscribeToMultipleOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        u32,
        *mut core::ffi::c_void,
        *const WSD_EVENTING_EXPIRES,
        *const WSDXML_ELEMENT,
        *mut *mut WSD_EVENTING_EXPIRES,
        *mut *mut WSDXML_ELEMENT,
    ) -> windows_core::HRESULT,
    pub BeginSubscribeToMultipleOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        u32,
        *mut core::ffi::c_void,
    ...
    pub EndSubscribeToMultipleOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        u32,
        *mut core::ffi::c_void,
    ...
    pub UnsubscribeToMultipleOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        u32,
        *const WSDXML_ELEMENT,
    ) -> windows_core::HRESULT,
    pub BeginUnsubscribeToMultipleOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        u32,
        *const WSDXML_ELEMENT,
        ...
        *mut *mut core::ffi::c_void,
        ...
        -> windows_core::HRESULT,
    pub EndUnsubscribeToMultipleOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        u32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RenewMultipleOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        u32,
        *const WSD_EVENTING_EXPIRES,
    ...
    pub BeginRenewMultipleOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        u32,
        *const WSD_EVENTING_EXPIRES,
    ...
    pub EndRenewMultipleOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        u32,
        *mut core::ffi::c_void,
    ...
    pub GetStatusForMultipleOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        u32,
        *const WSDXML_ELEMENT,
    ...
    pub BeginGetStatusForMultipleOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        u32,
        *const WSDXML_ELEMENT,
        ...
        *mut *mut core::ffi::c_void,
        ...
        -> windows_core::HRESULT,
    pub EndGetStatusForMultipleOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_OPERATION,
        u32,
        *mut core::ffi::c_void,
...
pub trait IWSDServiceProxyEventing_Impl: IWSDServiceProxy_Impl {
    ...
    fn BeginSubscribeToMultipleOperations(
        ...
        pany: *const WSDXML_ELEMENT,
        pasyncstate: windows_core::Ref<'_, windows_core::IUnknown>,
        pasynccallback: windows_core::Ref<'_, IWSDAsyncCallback>,
    ) -> windows_core::Result<IWSDAsyncResult>;
    ...
    pub const fn new<Identity: IWSDServiceProxyEventing_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceProxyEventing_Impl::SubscribeToMultipleOperations(
                    this,
                    core::mem::transmute_copy(&poperations),
                    core::mem::transmute_copy(&dwoperationcount),
                    core::mem::transmute_copy(&punknown),
                    core::mem::transmute_copy(&pexpires),
                    core::mem::transmute_copy(&pany),
        ...
        unsafe extern "system" fn BeginSubscribeToMultipleOperations<
            Identity: IWSDServiceProxyEventing_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            pany: *const WSDXML_ELEMENT,
            pasyncstate: *mut core::ffi::c_void,
            pasynccallback: *mut core::ffi::c_void,
            ppresult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSDServiceProxyEventing_Impl::BeginSubscribeToMultipleOperations(
                    this,
                    core::mem::transmute_copy(&poperations),
                    core::mem::transmute_copy(&dwoperationcount),
                    core::mem::transmute_copy(&punknown),
                    ...
                    core::mem::transmute_copy(&pany),
                    core::mem::transmute_copy(&pasyncstate),
                    core::mem::transmute_copy(&pasynccallback),
                ) {
                    Ok(ok__) => {
                        ppresult.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceProxyEventing_Impl::EndSubscribeToMultipleOperations(
                    this,
                    core::mem::transmute_copy(&poperations),
                    core::mem::transmute_copy(&dwoperationcount),
                    core::mem::transmute_copy(&presult),
        ...
        unsafe extern "system" fn UnsubscribeToMultipleOperations<
            Identity: IWSDServiceProxyEventing_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceProxyEventing_Impl::UnsubscribeToMultipleOperations(
                    this,
                    core::mem::transmute_copy(&poperations),
                    core::mem::transmute_copy(&dwoperationcount),
                    core::mem::transmute_copy(&pany),
        ...
        unsafe extern "system" fn BeginUnsubscribeToMultipleOperations<
            Identity: IWSDServiceProxyEventing_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSDServiceProxyEventing_Impl::BeginUnsubscribeToMultipleOperations(
                    this,
                    core::mem::transmute_copy(&poperations),
                    core::mem::transmute_copy(&dwoperationcount),
                    core::mem::transmute_copy(&pany),
        ...
        unsafe extern "system" fn EndUnsubscribeToMultipleOperations<
            Identity: IWSDServiceProxyEventing_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceProxyEventing_Impl::EndUnsubscribeToMultipleOperations(
                    this,
                    core::mem::transmute_copy(&poperations),
                    core::mem::transmute_copy(&dwoperationcount),
                    core::mem::transmute_copy(&presult),
        ...
        unsafe extern "system" fn RenewMultipleOperations<
            Identity: IWSDServiceProxyEventing_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceProxyEventing_Impl::RenewMultipleOperations(
                    this,
                    core::mem::transmute_copy(&poperations),
                    core::mem::transmute_copy(&dwoperationcount),
                    core::mem::transmute_copy(&pexpires),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSDServiceProxyEventing_Impl::BeginRenewMultipleOperations(
                    this,
                    core::mem::transmute_copy(&poperations),
                    core::mem::transmute_copy(&dwoperationcount),
                    core::mem::transmute_copy(&pexpires),
        ...
        unsafe extern "system" fn EndRenewMultipleOperations<
            Identity: IWSDServiceProxyEventing_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceProxyEventing_Impl::EndRenewMultipleOperations(
                    this,
                    core::mem::transmute_copy(&poperations),
                    core::mem::transmute_copy(&dwoperationcount),
                    core::mem::transmute_copy(&presult),
        ...
        unsafe extern "system" fn GetStatusForMultipleOperations<
            Identity: IWSDServiceProxyEventing_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceProxyEventing_Impl::GetStatusForMultipleOperations(
                    this,
                    core::mem::transmute_copy(&poperations),
                    core::mem::transmute_copy(&dwoperationcount),
                    core::mem::transmute_copy(&pany),
        ...
        unsafe extern "system" fn BeginGetStatusForMultipleOperations<
            Identity: IWSDServiceProxyEventing_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSDServiceProxyEventing_Impl::BeginGetStatusForMultipleOperations(
                    this,
                    core::mem::transmute_copy(&poperations),
                    core::mem::transmute_copy(&dwoperationcount),
                    core::mem::transmute_copy(&pany),
        ...
        unsafe extern "system" fn EndGetStatusForMultipleOperations<
            Identity: IWSDServiceProxyEventing_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDServiceProxyEventing_Impl::EndGetStatusForMultipleOperations(
                    this,
                    core::mem::transmute_copy(&poperations),
                    core::mem::transmute_copy(&dwoperationcount),
                    core::mem::transmute_copy(&presult),
        ...
        Self {
            ...
            BeginSubscribeToMultipleOperations: BeginSubscribeToMultipleOperations::<
                Identity,
                OFFSET,
            >,
            ...
            BeginUnsubscribeToMultipleOperations: BeginUnsubscribeToMultipleOperations::<
                Identity,
                OFFSET,
            >,
            EndUnsubscribeToMultipleOperations: EndUnsubscribeToMultipleOperations::<
                Identity,
                OFFSET,
            >,
            ...
            BeginGetStatusForMultipleOperations: BeginGetStatusForMultipleOperations::<
                Identity,
                OFFSET,
            >,
...
windows_core::imp::define_interface!(
    ...
    0x03ce20aa_71c4_45e2_b32e_3766c61c790f
);
...
impl IWSDSignatureProperty {
    pub unsafe fn IsMessageSigned(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsMessageSigned)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn IsMessageSignatureTrusted(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsMessageSignatureTrusted)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetKeyInfo(
        &self,
        pbkeyinfo: Option<*mut u8>,
        pdwkeyinfosize: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetKeyInfo)(
                windows_core::Interface::as_raw(self),
                pbkeyinfo.unwrap_or(core::mem::zeroed()) as _,
                pdwkeyinfosize as _,
            )
            .ok()
        }
    ...
    pub unsafe fn GetSignature(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetSignature)(
                windows_core::Interface::as_raw(self),
                pbsignature.unwrap_or(core::mem::zeroed()) as _,
                pdwsignaturesize as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetSignedInfoHash(
        &self,
        pbsignedinfohash: Option<*mut u8>,
        pdwhashsize: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetSignedInfoHash)(
                windows_core::Interface::as_raw(self),
                pbsignedinfohash.unwrap_or(core::mem::zeroed()) as _,
                pdwhashsize as _,
            )
            .ok()
        }
...
pub struct IWSDSignatureProperty_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub IsMessageSigned: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub IsMessageSignatureTrusted: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub GetKeyInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
    ...
    pub GetSignedInfoHash: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
...
impl IWSDSignatureProperty_Vtbl {
    pub const fn new<Identity: IWSDSignatureProperty_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsMessageSigned<
            Identity: IWSDSignatureProperty_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbsigned: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsMessageSignatureTrusted<
            Identity: IWSDSignatureProperty_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbsignaturetrusted: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetKeyInfo<
            Identity: IWSDSignatureProperty_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDSignatureProperty_Impl::GetKeyInfo(
                    this,
                    core::mem::transmute_copy(&pbkeyinfo),
                    core::mem::transmute_copy(&pdwkeyinfosize),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDSignatureProperty_Impl::GetSignature(
                    this,
                    core::mem::transmute_copy(&pbsignature),
                    core::mem::transmute_copy(&pdwsignaturesize),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetSignedInfoHash<
            Identity: IWSDSignatureProperty_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDSignatureProperty_Impl::GetSignedInfoHash(
                    this,
                    core::mem::transmute_copy(&pbsignedinfohash),
                    core::mem::transmute_copy(&pdwhashsize),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x70d23498_4ee6_4340_a3df_d845d2235467
);
...
impl IWSDTransportAddress {
    ...
    pub unsafe fn GetTransportAddress(&self) -> windows_core::Result<windows_core::PCWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTransportAddress)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetTransportAddressEx(
        &self,
        fsafe: bool,
    ) -> windows_core::Result<windows_core::PCWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTransportAddressEx)(
                windows_core::Interface::as_raw(self),
                fsafe.into(),
                &mut result__,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetTransportAddress)(
                windows_core::Interface::as_raw(self),
                pszaddress.param().abi(),
            )
            .ok()
        }
    }
...
pub struct IWSDTransportAddress_Vtbl {
    ...
    pub GetTransportAddress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetTransportAddressEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
        *mut windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub SetTransportAddress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
}
...
impl IWSDTransportAddress_Vtbl {
    pub const fn new<Identity: IWSDTransportAddress_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetPort<
        ...
        unsafe extern "system" fn SetPort<
            Identity: IWSDTransportAddress_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetTransportAddress<
            Identity: IWSDTransportAddress_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppszaddress: *mut windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetTransportAddressEx<
            Identity: IWSDTransportAddress_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWSDTransportAddress_Impl::GetTransportAddressEx(
                    this,
                    core::mem::transmute_copy(&fsafe),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SetTransportAddress<
            Identity: IWSDTransportAddress_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pszaddress: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDTransportAddress_Impl::SetTransportAddress(
                    this,
                    core::mem::transmute(&pszaddress),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IWSDUdpAddress,
    IWSDUdpAddress_Vtbl,
    0x74d6124a_a441_4f78_a1eb_97a8d1996893
);
...
impl IWSDUdpAddress {
    ...
    pub unsafe fn SetSockaddr(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetSockaddr)(
                windows_core::Interface::as_raw(self),
                psockaddr,
            )
            .ok()
    ...
    pub unsafe fn GetSockaddr(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetSockaddr)(
                windows_core::Interface::as_raw(self),
                psockaddr as _,
            )
            .ok()
    ...
    pub unsafe fn GetExclusive(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetExclusive)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    }
    pub unsafe fn SetMessageType(
        &self,
        messagetype: WSDUdpMessageType,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMessageType)(
                windows_core::Interface::as_raw(self),
                messagetype,
            )
            .ok()
    ...
    pub unsafe fn SetTTL(&self, dwttl: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTTL)(
                windows_core::Interface::as_raw(self),
                dwttl,
            )
            .ok()
    ...
    pub unsafe fn GetTTL(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTTL)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetAlias(&self, palias: *const windows_core::GUID) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAlias)(
                windows_core::Interface::as_raw(self),
                palias,
            )
            .ok()
    ...
    pub unsafe fn GetAlias(&self) -> windows_core::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAlias)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWSDUdpAddress_Vtbl {
    pub base__: IWSDTransportAddress_Vtbl,
    #[cfg(feature = "Win32_Networking_WinSock")]
    pub SetSockaddr: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::super::Networking::WinSock::SOCKADDR_STORAGE,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Networking_WinSock"))]
    SetSockaddr: usize,
    #[cfg(feature = "Win32_Networking_WinSock")]
    pub GetSockaddr: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Networking::WinSock::SOCKADDR_STORAGE,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Networking_WinSock"))]
    GetSockaddr: usize,
    ...
    pub GetMessageType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WSDUdpMessageType,
    ) -> windows_core::HRESULT,
    pub SetTTL: unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub GetTTL:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetAlias: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub GetAlias: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IWSDUdpAddress_Vtbl {
    pub const fn new<Identity: IWSDUdpAddress_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetSockaddr<
        ...
        unsafe extern "system" fn GetSockaddr<
            Identity: IWSDUdpAddress_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            this: *mut core::ffi::c_void,
            fexclusive: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDUdpAddress_Impl::SetExclusive(this, core::mem::transmute_copy(&fexclusive))
                    .into()
            }
        }
        unsafe extern "system" fn GetExclusive<
            Identity: IWSDUdpAddress_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDUdpAddress_Impl::SetMessageType(this, core::mem::transmute_copy(&messagetype))
                    .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            pmessagetype: *mut WSDUdpMessageType,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetTTL<Identity: IWSDUdpAddress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwttl: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetTTL<Identity: IWSDUdpAddress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwttl: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetAlias<Identity: IWSDUdpAddress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            palias: *const windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetAlias<Identity: IWSDUdpAddress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            palias: *mut windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x9934149f_8f0c_447b_aa0b_73124b0ca7f0
);
...
impl IWSDUdpMessageParameters {
    pub unsafe fn SetRetransmitParams(
        &self,
        pparams: *const WSDUdpRetransmitParams,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetRetransmitParams)(
                windows_core::Interface::as_raw(self),
                pparams,
            )
            .ok()
    ...
    pub unsafe fn GetRetransmitParams(
        &self,
        pparams: *mut WSDUdpRetransmitParams,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetRetransmitParams)(
                windows_core::Interface::as_raw(self),
                pparams as _,
            )
            .ok()
...
pub struct IWSDUdpMessageParameters_Vtbl {
    pub base__: IWSDMessageParameters_Vtbl,
    pub SetRetransmitParams: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSDUdpRetransmitParams,
    ) -> windows_core::HRESULT,
    pub GetRetransmitParams: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WSDUdpRetransmitParams,
    ) -> windows_core::HRESULT,
}
    ...
    pub const fn new<Identity: IWSDUdpMessageParameters_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDUdpMessageParameters_Impl::SetRetransmitParams(
                    this,
        ...
        unsafe extern "system" fn GetRetransmitParams<
            Identity: IWSDUdpMessageParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDUdpMessageParameters_Impl::GetRetransmitParams(
                    this,
                    core::mem::transmute_copy(&pparams),
                )
                .into()
...
windows_core::imp::define_interface!(
    IWSDXMLContext,
    IWSDXMLContext_Vtbl,
    0x75d8f3ee_3e5a_43b4_a15a_bcf6887460c0
);
windows_core::imp::interface_hierarchy!(IWSDXMLContext, windows_core::IUnknown);
impl IWSDXMLContext {
    pub unsafe fn AddNamespace<P0, P1>(
        &self,
        pszuri: P0,
        pszsuggestedprefix: P1,
        ppnamespace: Option<*mut *mut WSDXML_NAMESPACE>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddNamespace)(
                windows_core::Interface::as_raw(self),
                pszuri.param().abi(),
                pszsuggestedprefix.param().abi(),
                ppnamespace.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn AddNameToNamespace<P0, P1>(
        &self,
        pszuri: P0,
        pszname: P1,
        ppname: Option<*mut *mut WSDXML_NAME>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddNameToNamespace)(
                windows_core::Interface::as_raw(self),
                pszuri.param().abi(),
                pszname.param().abi(),
                ppname.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn SetNamespaces(
        &self,
        pnamespaces: &[*const WSDXML_NAMESPACE],
        blayernumber: u8,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetNamespaces)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pnamespaces.as_ptr()),
                pnamespaces.len().try_into().unwrap(),
                blayernumber,
            )
            .ok()
        }
    }
    pub unsafe fn SetTypes(
        &self,
        ptypes: &[*const WSDXML_TYPE],
        blayernumber: u8,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetTypes)(
                windows_core::Interface::as_raw(self),
...
pub struct IWSDXMLContext_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub AddNamespace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *mut *mut WSDXML_NAMESPACE,
    ) -> windows_core::HRESULT,
    pub AddNameToNamespace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *mut *mut WSDXML_NAME,
    ) -> windows_core::HRESULT,
    pub SetNamespaces: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const *const WSDXML_NAMESPACE,
        u16,
        u8,
    ) -> windows_core::HRESULT,
    pub SetTypes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const *const WSDXML_TYPE,
        u32,
        u8,
    ) -> windows_core::HRESULT,
}
pub trait IWSDXMLContext_Impl: windows_core::IUnknownImpl {
    fn AddNamespace(
        &self,
        pszuri: &windows_core::PCWSTR,
        pszsuggestedprefix: &windows_core::PCWSTR,
...
impl IWSDXMLContext_Vtbl {
    pub const fn new<Identity: IWSDXMLContext_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddNamespace<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDXMLContext_Impl::AddNamespace(
                    this,
                    core::mem::transmute(&pszuri),
                    core::mem::transmute(&pszsuggestedprefix),
                    core::mem::transmute_copy(&ppnamespace),
                )
                .into()
            }
        }
        unsafe extern "system" fn AddNameToNamespace<
            Identity: IWSDXMLContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDXMLContext_Impl::AddNameToNamespace(
                    this,
                    core::mem::transmute(&pszuri),
        ...
        unsafe extern "system" fn SetNamespaces<
            Identity: IWSDXMLContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDXMLContext_Impl::SetNamespaces(
                    this,
                    core::mem::transmute_copy(&pnamespaces),
                    core::mem::transmute_copy(&wnamespacescount),
                    core::mem::transmute_copy(&blayernumber),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetTypes<Identity: IWSDXMLContext_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ptypes: *const *const WSDXML_TYPE,
            dwtypescount: u32,
            blayernumber: u8,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDXMLContext_Impl::SetTypes(
                    this,
                    core::mem::transmute_copy(&ptypes),
                    core::mem::transmute_copy(&dwtypescount),
                    core::mem::transmute_copy(&blayernumber),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0x4bad8a3b_b374_4420_9632_aac945b374aa
);
...
impl IWSDiscoveredService {
    pub unsafe fn GetEndpointReference(&self) -> windows_core::Result<*mut WSD_ENDPOINT_REFERENCE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEndpointReference)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetScopes(&self) -> windows_core::Result<*mut WSD_URI_LIST> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetScopes)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetXAddrs(&self) -> windows_core::Result<*mut WSD_URI_LIST> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetXAddrs)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetMetadataVersion(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMetadataVersion)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetExtendedDiscoXML(
        &self,
        ppheaderany: *mut *mut WSDXML_ELEMENT,
        ppbodyany: *mut *mut WSDXML_ELEMENT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetExtendedDiscoXML)(
                windows_core::Interface::as_raw(self),
                ppheaderany as _,
                ppbodyany as _,
            )
    ...
    pub unsafe fn GetProbeResolveTag(&self) -> windows_core::Result<windows_core::PCWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetProbeResolveTag)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetRemoteTransportAddress(&self) -> windows_core::Result<windows_core::PCWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRemoteTransportAddress)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetLocalTransportAddress(&self) -> windows_core::Result<windows_core::PCWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLocalTransportAddress)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetLocalInterfaceGUID(&self) -> windows_core::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLocalInterfaceGUID)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IWSDiscoveredService_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetEndpointReference: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut WSD_ENDPOINT_REFERENCE,
    ) -> windows_core::HRESULT,
    pub GetTypes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut WSD_NAME_LIST,
    ) -> windows_core::HRESULT,
    pub GetScopes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut WSD_URI_LIST,
    ) -> windows_core::HRESULT,
    pub GetXAddrs: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut WSD_URI_LIST,
    ) -> windows_core::HRESULT,
    pub GetMetadataVersion:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u64) -> windows_core::HRESULT,
    pub GetExtendedDiscoXML: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut WSDXML_ELEMENT,
        *mut *mut WSDXML_ELEMENT,
    ) -> windows_core::HRESULT,
    pub GetProbeResolveTag: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetRemoteTransportAddress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetLocalTransportAddress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetLocalInterfaceGUID: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub GetInstanceId:
...
impl IWSDiscoveredService_Vtbl {
    pub const fn new<Identity: IWSDiscoveredService_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetEndpointReference<
            Identity: IWSDiscoveredService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppendpointreference: *mut *mut WSD_ENDPOINT_REFERENCE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            pptypeslist: *mut *mut WSD_NAME_LIST,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetScopes<
            Identity: IWSDiscoveredService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppscopeslist: *mut *mut WSD_URI_LIST,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetXAddrs<
            Identity: IWSDiscoveredService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppxaddrslist: *mut *mut WSD_URI_LIST,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetMetadataVersion<
            Identity: IWSDiscoveredService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pullmetadataversion: *mut u64,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetExtendedDiscoXML<
            Identity: IWSDiscoveredService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveredService_Impl::GetExtendedDiscoXML(
                    this,
                    core::mem::transmute_copy(&ppheaderany),
                    core::mem::transmute_copy(&ppbodyany),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetProbeResolveTag<
            Identity: IWSDiscoveredService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppsztag: *mut windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetRemoteTransportAddress<
            Identity: IWSDiscoveredService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppszremotetransportaddress: *mut windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetLocalTransportAddress<
            Identity: IWSDiscoveredService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppszlocaltransportaddress: *mut windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetLocalInterfaceGUID<
            Identity: IWSDiscoveredService_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x8ffc8e55_f0eb_480f_88b7_b435dd281d45
);
...
impl IWSDiscoveryProvider {
    pub unsafe fn SetAddressFamily(&self, dwaddressfamily: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAddressFamily)(
                windows_core::Interface::as_raw(self),
                dwaddressfamily,
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SearchById)(
                windows_core::Interface::as_raw(self),
                pszid.param().abi(),
                psztag.param().abi(),
            )
    ...
    pub unsafe fn SearchByAddress<P0, P1>(
        &self,
        pszaddress: P0,
        psztag: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SearchByAddress)(
                windows_core::Interface::as_raw(self),
                pszaddress.param().abi(),
                psztag.param().abi(),
            )
    ...
    pub unsafe fn SearchByType<P2, P3>(
        &self,
        ptypeslist: Option<*const WSD_NAME_LIST>,
        pscopeslist: Option<*const WSD_URI_LIST>,
        pszmatchby: P2,
        psztag: P3,
    ) -> windows_core::Result<()>
    where
    ...
    pub unsafe fn GetXMLContext(&self) -> windows_core::Result<IWSDXMLContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetXMLContext)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IWSDiscoveryProvider_Vtbl {
    ...
    pub SearchById: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub SearchByAddress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub SearchByType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_NAME_LIST,
        *const WSD_URI_LIST,
        windows_core::PCWSTR,
    ...
    pub GetXMLContext: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IWSDiscoveryProvider_Impl: windows_core::IUnknownImpl {
    ...
    fn Attach(
        &self,
        psink: windows_core::Ref<'_, IWSDiscoveryProviderNotify>,
    ) -> windows_core::Result<()>;
    fn Detach(&self) -> windows_core::Result<()>;
    fn SearchById(
        &self,
        pszid: &windows_core::PCWSTR,
        psztag: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    fn SearchByAddress(
        &self,
        pszaddress: &windows_core::PCWSTR,
    ...
    fn SearchByType(
        ...
        pszmatchby: &windows_core::PCWSTR,
        psztag: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
...
impl IWSDiscoveryProvider_Vtbl {
    pub const fn new<Identity: IWSDiscoveryProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetAddressFamily<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryProvider_Impl::SetAddressFamily(
                    this,
                    core::mem::transmute_copy(&dwaddressfamily),
                )
                .into()
            }
        }
        ...
        unsafe extern "system" fn SearchById<
            Identity: IWSDiscoveryProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryProvider_Impl::SearchById(
                    this,
                    core::mem::transmute(&pszid),
                    core::mem::transmute(&psztag),
                )
                .into()
            }
        }
        unsafe extern "system" fn SearchByAddress<
            Identity: IWSDiscoveryProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryProvider_Impl::SearchByAddress(
                    this,
                    core::mem::transmute(&pszaddress),
                    core::mem::transmute(&psztag),
                )
        ...
        unsafe extern "system" fn SearchByType<
            Identity: IWSDiscoveryProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryProvider_Impl::SearchByType(
                    this,
                    core::mem::transmute_copy(&ptypeslist),
                    core::mem::transmute_copy(&pscopeslist),
                    core::mem::transmute(&pszmatchby),
                    core::mem::transmute(&psztag),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetXMLContext<
            Identity: IWSDiscoveryProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x73ee3ced_b6e6_4329_a546_3e8ad46563d2
);
...
impl IWSDiscoveryProviderNotify {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SearchFailed)(
                windows_core::Interface::as_raw(self),
                hr,
                psztag.param().abi(),
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SearchComplete)(
                windows_core::Interface::as_raw(self),
                psztag.param().abi(),
            )
            .ok()
...
pub struct IWSDiscoveryProviderNotify_Vtbl {
    ...
    pub SearchFailed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::HRESULT,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub SearchComplete: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
}
pub trait IWSDiscoveryProviderNotify_Impl: windows_core::IUnknownImpl {
    fn Add(
        &self,
        pservice: windows_core::Ref<'_, IWSDiscoveredService>,
    ) -> windows_core::Result<()>;
    fn Remove(
        &self,
        pservice: windows_core::Ref<'_, IWSDiscoveredService>,
    ...
    pub const fn new<Identity: IWSDiscoveryProviderNotify_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryProviderNotify_Impl::Add(this, core::mem::transmute_copy(&pservice))
                    .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryProviderNotify_Impl::Remove(this, core::mem::transmute_copy(&pservice))
                    .into()
            }
        }
        unsafe extern "system" fn SearchFailed<
            Identity: IWSDiscoveryProviderNotify_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryProviderNotify_Impl::SearchFailed(
                    this,
                    core::mem::transmute_copy(&hr),
                    core::mem::transmute(&psztag),
                )
        ...
        unsafe extern "system" fn SearchComplete<
            Identity: IWSDiscoveryProviderNotify_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryProviderNotify_Impl::SearchComplete(this, core::mem::transmute(&psztag))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0xae01e1a8_3ff9_4148_8116_057cc616fe13
);
...
impl IWSDiscoveryPublisher {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterNotificationSink)(
                windows_core::Interface::as_raw(self),
                psink.param().abi(),
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).UnRegisterNotificationSink)(
                windows_core::Interface::as_raw(self),
                psink.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn Publish<P0, P4>(
        ...
        ptypeslist: Option<*const WSD_NAME_LIST>,
        pscopeslist: Option<*const WSD_URI_LIST>,
        pxaddrslist: Option<*const WSD_URI_LIST>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Publish)(
                windows_core::Interface::as_raw(self),
                pszid.param().abi(),
                ullmetadataversion,
                ullinstanceid,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).UnPublish)(
                windows_core::Interface::as_raw(self),
                pszid.param().abi(),
                ullinstanceid,
                ullmessagenumber,
    ...
    pub unsafe fn MatchProbe<P1, P2, P6>(
        &self,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).MatchProbe)(
                windows_core::Interface::as_raw(self),
                pprobemessage,
                pmessageparameters.param().abi(),
                pszid.param().abi(),
    ...
    pub unsafe fn MatchResolve<P1, P2, P6>(
        &self,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).MatchResolve)(
                windows_core::Interface::as_raw(self),
                presolvemessage,
                pmessageparameters.param().abi(),
                pszid.param().abi(),
    ...
    pub unsafe fn PublishEx<P0, P4>(
        ...
        pscopeslist: Option<*const WSD_URI_LIST>,
        pxaddrslist: Option<*const WSD_URI_LIST>,
        pheaderany: Option<*const WSDXML_ELEMENT>,
        preferenceparameterany: Option<*const WSDXML_ELEMENT>,
        ppolicyany: Option<*const WSDXML_ELEMENT>,
        pendpointreferenceany: Option<*const WSDXML_ELEMENT>,
        pany: Option<*const WSDXML_ELEMENT>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn MatchProbeEx<P1, P2, P6>(
        &self,
        pprobemessage: *const WSD_SOAP_MESSAGE,
        pmessageparameters: P1,
        pszid: P2,
    ...
    pub unsafe fn MatchResolveEx<P1, P2, P6>(
        &self,
        presolvemessage: *const WSD_SOAP_MESSAGE,
        pmessageparameters: P1,
        pszid: P2,
    ...
    pub unsafe fn RegisterScopeMatchingRule<P0>(
        &self,
        pscopematchingrule: P0,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<IWSDScopeMatchingRule>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterScopeMatchingRule)(
                windows_core::Interface::as_raw(self),
                pscopematchingrule.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn UnRegisterScopeMatchingRule<P0>(
        &self,
        pscopematchingrule: P0,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).UnRegisterScopeMatchingRule)(
                windows_core::Interface::as_raw(self),
                pscopematchingrule.param().abi(),
            )
            .ok()
...
pub struct IWSDiscoveryPublisher_Vtbl {
    ...
    pub SetAddressFamily:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub RegisterNotificationSink: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UnRegisterNotificationSink: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Publish: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u64,
        u64,
    ...
    pub UnPublish: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u64,
        u64,
    ...
    pub MatchProbe: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub MatchResolve: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_SOAP_MESSAGE,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ...
    pub PublishEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u64,
        u64,
    ...
    pub MatchProbeEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_SOAP_MESSAGE,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ...
    pub MatchResolveEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_SOAP_MESSAGE,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ...
    pub RegisterScopeMatchingRule: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UnRegisterScopeMatchingRule: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetXMLContext: unsafe extern "system" fn(
...
pub trait IWSDiscoveryPublisher_Impl: windows_core::IUnknownImpl {
    ...
    fn RegisterNotificationSink(
        &self,
        psink: windows_core::Ref<'_, IWSDiscoveryPublisherNotify>,
    ) -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: IWSDiscoveryPublisher_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryPublisher_Impl::SetAddressFamily(
                    this,
                    core::mem::transmute_copy(&dwaddressfamily),
                )
                .into()
        ...
        unsafe extern "system" fn RegisterNotificationSink<
            Identity: IWSDiscoveryPublisher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryPublisher_Impl::RegisterNotificationSink(
                    this,
        ...
        unsafe extern "system" fn UnRegisterNotificationSink<
            Identity: IWSDiscoveryPublisher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryPublisher_Impl::UnRegisterNotificationSink(
                    this,
                    core::mem::transmute_copy(&psink),
                )
                .into()
        ...
        unsafe extern "system" fn Publish<
            Identity: IWSDiscoveryPublisher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryPublisher_Impl::Publish(
                    this,
                    core::mem::transmute(&pszid),
        ...
        unsafe extern "system" fn UnPublish<
            Identity: IWSDiscoveryPublisher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryPublisher_Impl::UnPublish(
                    this,
                    core::mem::transmute(&pszid),
                    core::mem::transmute_copy(&ullinstanceid),
                    core::mem::transmute_copy(&ullmessagenumber),
        ...
        unsafe extern "system" fn MatchProbe<
            Identity: IWSDiscoveryPublisher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryPublisher_Impl::MatchProbe(
                    this,
        ...
        unsafe extern "system" fn MatchResolve<
            Identity: IWSDiscoveryPublisher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryPublisher_Impl::MatchResolve(
                    this,
        ...
        unsafe extern "system" fn PublishEx<
            Identity: IWSDiscoveryPublisher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn MatchProbeEx<
            Identity: IWSDiscoveryPublisher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            this: *mut core::ffi::c_void,
            pscopematchingrule: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryPublisher_Impl::RegisterScopeMatchingRule(
                    this,
        ...
        unsafe extern "system" fn UnRegisterScopeMatchingRule<
            Identity: IWSDiscoveryPublisher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryPublisher_Impl::UnRegisterScopeMatchingRule(
                    this,
                    core::mem::transmute_copy(&pscopematchingrule),
                )
                .into()
...
impl IWSDiscoveryPublisherNotify {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ProbeHandler)(
                windows_core::Interface::as_raw(self),
                psoap,
                pmessageparameters.param().abi(),
            )
    ...
    pub unsafe fn ResolveHandler<P1>(
        &self,
        psoap: *const WSD_SOAP_MESSAGE,
        pmessageparameters: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ResolveHandler)(
                windows_core::Interface::as_raw(self),
                psoap,
                pmessageparameters.param().abi(),
            )
...
pub struct IWSDiscoveryPublisherNotify_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ProbeHandler: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_SOAP_MESSAGE,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ResolveHandler: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const WSD_SOAP_MESSAGE,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl IWSDiscoveryPublisherNotify_Vtbl {
    pub const fn new<Identity: IWSDiscoveryPublisherNotify_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ProbeHandler<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryPublisherNotify_Impl::ProbeHandler(
                    this,
                    core::mem::transmute_copy(&psoap),
                    core::mem::transmute_copy(&pmessageparameters),
                )
                .into()
            }
        }
        unsafe extern "system" fn ResolveHandler<
            Identity: IWSDiscoveryPublisherNotify_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWSDiscoveryPublisherNotify_Impl::ResolveHandler(
                    this,
                    core::mem::transmute_copy(&psoap),
                    core::mem::transmute_copy(&pmessageparameters),
                )
...
pub type PWSD_SOAP_MESSAGE_HANDLER = Option<
    unsafe extern "system" fn(
        thisunknown: windows_core::Ref<'_, windows_core::IUnknown>,
        event: *mut WSD_EVENT,
    ) -> windows_core::HRESULT,
>;
#[repr(C)]
...
pub const WSD_DEFAULT_SECURE_HOSTING_ADDRESS: windows_core::PCWSTR =
    windows_core::w!("https://*:5358/");
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const WSD_SECURITY_REQUIRE_CLIENT_CERT_OR_HTTP_CLIENT_AUTH: WSD_CONFIG_PARAM_TYPE =
    WSD_CONFIG_PARAM_TYPE(12i32);
pub const WSD_SECURITY_REQUIRE_HTTP_CLIENT_AUTH: WSD_CONFIG_PARAM_TYPE =
    WSD_CONFIG_PARAM_TYPE(11i32);
#[repr(C)]
#[cfg(feature = "Win32_Security_Cryptography")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const WSD_SECURITY_SSL_CERT_FOR_CLIENT_AUTH: WSD_CONFIG_PARAM_TYPE =
    WSD_CONFIG_PARAM_TYPE(3i32);
pub const WSD_SECURITY_SSL_CLIENT_CERT_VALIDATION: WSD_CONFIG_PARAM_TYPE =
    WSD_CONFIG_PARAM_TYPE(5i32);
pub const WSD_SECURITY_SSL_NEGOTIATE_CLIENT_CERT: WSD_CONFIG_PARAM_TYPE =
    WSD_CONFIG_PARAM_TYPE(6i32);
pub const WSD_SECURITY_SSL_SERVER_CERT_VALIDATION: WSD_CONFIG_PARAM_TYPE =
    WSD_CONFIG_PARAM_TYPE(4i32);
...
pub type WSD_STUB_FUNCTION = Option<
    unsafe extern "system" fn(
        server: windows_core::Ref<'_, windows_core::IUnknown>,
        session: windows_core::Ref<'_, IWSDServiceMessaging>,
        event: *mut WSD_EVENT,
    ) -> windows_core::HRESULT,
>;
#[repr(C)]

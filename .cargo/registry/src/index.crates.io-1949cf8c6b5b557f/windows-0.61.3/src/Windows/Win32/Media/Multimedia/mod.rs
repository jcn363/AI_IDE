...
pub unsafe fn AVIBuildFilterA(lpszfilter: &mut [u8], fsaving: bool) -> windows_core::Result<()> {
    ...
    unsafe {
        AVIBuildFilterA(
            core::mem::transmute(lpszfilter.as_ptr()),
            lpszfilter.len().try_into().unwrap(),
            fsaving.into(),
        )
        .ok()
    }
...
#[inline]
pub unsafe fn AVIFileGetStream<P0>(
    pfile: P0,
    ppavi: *mut Option<IAVIStream>,
    fcctype: u32,
    lparam: i32,
...
#[inline]
pub unsafe fn AVIFileOpenA<P1>(
    ppfile: *mut Option<IAVIFile>,
    szfile: P1,
    umode: u32,
    lphandler: Option<*const windows_core::GUID>,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        AVIFileOpenA(
            core::mem::transmute(ppfile),
            szfile.param().abi(),
            umode,
            lphandler.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn AVIFileOpenW<P1>(
    ppfile: *mut Option<IAVIFile>,
    szfile: P1,
    umode: u32,
    lphandler: Option<*const windows_core::GUID>,
...
#[inline]
pub unsafe fn AVIFileReadData<P0>(
    pfile: P0,
    ckid: u32,
...
#[inline]
pub unsafe fn AVIMakeCompressedStream<P1>(
    ppscompressed: *mut Option<IAVIStream>,
    ppssource: P1,
    lpoptions: *const AVICOMPRESSOPTIONS,
    pclsidhandler: Option<*const windows_core::GUID>,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<IAVIStream>,
{
    ...
    unsafe {
        AVIMakeCompressedStream(
            core::mem::transmute(ppscompressed),
            ppssource.param().abi(),
            lpoptions,
            pclsidhandler.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn AVIMakeFileFromStreams(
    ...
    unsafe {
        AVIMakeFileFromStreams(
            core::mem::transmute(ppfile),
            papstreams.len().try_into().unwrap(),
            core::mem::transmute(papstreams.as_ptr()),
        )
        .ok()
    }
}
...
pub unsafe fn AVIMakeStreamFromClipboard(
...
) -> windows_core::Result<IAVIStream> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        AVIMakeStreamFromClipboard(cfformat, hglobal, &mut result__)
...
pub unsafe fn AVISaveOptionsFree(
    plpoptions: &[*const AVICOMPRESSOPTIONS],
) -> windows_core::Result<()> {
    ...
    unsafe {
        AVISaveOptionsFree(
            plpoptions.len().try_into().unwrap(),
            core::mem::transmute(plpoptions.as_ptr()),
        )
        .ok()
    }
}
#[inline]
pub unsafe fn AVISaveVA<P0>(
    szfile: P0,
    pclsidhandler: Option<*const windows_core::GUID>,
    lpfncallback: AVISAVECALLBACK,
    nstreams: i32,
...
#[inline]
pub unsafe fn AVIStreamBeginStreaming<P0>(
    pavi: P0,
    lstart: i32,
    lend: i32,
    lrate: i32,
...
pub unsafe fn AVIStreamGetFrameOpen<P0>(
    pavi: P0,
    lpbiwanted: Option<*const super::super::Graphics::Gdi::BITMAPINFOHEADER>,
) -> Option<IGetFrame>
where
    P0: windows_core::Param<IAVIStream>,
{
    ...
    unsafe {
        AVIStreamGetFrameOpen(
            pavi.param().abi(),
            lpbiwanted.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn AVIStreamOpenFromFileA<P1>(
    ppavi: *mut Option<IAVIStream>,
    szfile: P1,
    fcctype: u32,
    lparam: i32,
    ...
    P0: windows_core::Param<IAVIStream>,
{
    ...
    unsafe {
        AVIStreamRead(
            ...
            cbbuffer,
            plbytes.unwrap_or(core::mem::zeroed()) as _,
            plsamples.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn AVIStreamReadData<P0>(
    pavi: P0,
    fcc: u32,
    lp: Option<*mut core::ffi::c_void>,
    lpcb: *mut i32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
    ...
    unsafe {
        AVIStreamReadData(
            pavi.param().abi(),
            fcc,
            lp.unwrap_or(core::mem::zeroed()) as _,
            lpcb as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn AVIStreamReadFormat<P0>(
    pavi: P0,
    lpos: i32,
    lpformat: Option<*mut core::ffi::c_void>,
    lpcbformat: *mut i32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
    ...
    unsafe {
        AVIStreamReadFormat(
            pavi.param().abi(),
            lpos,
            lpformat.unwrap_or(core::mem::zeroed()) as _,
            lpcbformat as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn AVIStreamSetFormat<P0>(
    pavi: P0,
    lpos: i32,
    lpformat: *const core::ffi::c_void,
    cbformat: i32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
    ...
    P0: windows_core::Param<IAVIStream>,
{
    ...
    unsafe {
        AVIStreamWrite(
            ...
            cbbuffer,
            dwflags,
            plsampwritten.unwrap_or(core::mem::zeroed()) as _,
            plbyteswritten.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn CreateEditableStream<P1>(
...
pub unsafe fn DrawDibBegin(
    hdd: isize,
    hdc: Option<super::super::Graphics::Gdi::HDC>,
    dxdst: i32,
    dydst: i32,
...
pub unsafe fn DrawDibChangePalette(
    hdd: isize,
    istart: i32,
    lppe: &[super::super::Graphics::Gdi::PALETTEENTRY],
) -> windows_core::BOOL {
    ...
    unsafe {
        DrawDibChangePalette(
            hdd,
            istart,
            lppe.len().try_into().unwrap(),
            core::mem::transmute(lppe.as_ptr()),
        )
    }
}
#[inline]
...
pub unsafe fn DrawDibDraw(
    ...
    dxdst: i32,
    dydst: i32,
    lpbi: Option<*const super::super::Graphics::Gdi::BITMAPINFOHEADER>,
    ...
    unsafe {
        DrawDibDraw(
            ...
            dxdst,
            dydst,
            lpbi.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn DrawDibSetPalette(
    hdd: isize,
    hpal: Option<super::super::Graphics::Gdi::HPALETTE>,
) -> windows_core::BOOL {
    ...
    P0: windows_core::Param<IAVIStream>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        EditStreamClone(pavi.param().abi(), &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
...
#[inline]
pub unsafe fn EditStreamCut<P0>(
    pavi: P0,
    plstart: *mut i32,
    pllength: *mut i32,
    ppresult: *mut Option<IAVIStream>,
...
#[inline]
pub unsafe fn EditStreamSetInfoA<P0>(
    pavi: P0,
...
#[inline]
pub unsafe fn EditStreamSetInfoW<P0>(
    pavi: P0,
...
pub unsafe fn ICCompress(
    ...
    dwframesize: u32,
    dwquality: u32,
    lpbiprev: Option<*const super::super::Graphics::Gdi::BITMAPINFOHEADER>,
    lpprev: Option<*const core::ffi::c_void>,
) -> u32 {
    ...
    unsafe {
        ICCompress(
            ...
            lpbiinput,
            lpbits,
            lpckid.unwrap_or(core::mem::zeroed()) as _,
            lpdwflags.unwrap_or(core::mem::zeroed()) as _,
            lframenum,
            dwframesize,
            dwquality,
            lpbiprev.unwrap_or(core::mem::zeroed()) as _,
            lpprev.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub unsafe fn ICCompressorChoose<P5>(
    ...
    uiflags: u32,
    pvin: Option<*const core::ffi::c_void>,
    lpdata: Option<*const core::ffi::c_void>,
    pc: *mut COMPVARS,
    lpsztitle: P5,
) -> windows_core::BOOL
where
    P5: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        ICCompressorChoose(
            ...
            uiflags,
            pvin.unwrap_or(core::mem::zeroed()) as _,
            lpdata.unwrap_or(core::mem::zeroed()) as _,
            pc as _,
            lpsztitle.param().abi(),
        )
    }
...
pub unsafe fn ICDrawBegin(
    ...
    unsafe {
        ICDrawBegin(
            hic,
            dwflags,
            hpal.unwrap_or(core::mem::zeroed()) as _,
            hwnd.unwrap_or(core::mem::zeroed()) as _,
            hdc.unwrap_or(core::mem::zeroed()) as _,
            xdst,
            ydst,
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ICGetDisplayFormat(
    hic: Option<HIC>,
    ...
    unsafe {
        ICGetDisplayFormat(
            hic.unwrap_or(core::mem::zeroed()) as _,
            lpbiin,
            lpbiout as _,
            bitdepth,
            dx,
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ICImageCompress(
    hic: HIC,
    uiflags: u32,
    lpbiin: *const super::super::Graphics::Gdi::BITMAPINFO,
    lpbits: *const core::ffi::c_void,
    lpbiout: Option<*const super::super::Graphics::Gdi::BITMAPINFO>,
    lquality: i32,
    plsize: Option<*mut i32>,
    ...
    unsafe {
        ICImageCompress(
            ...
            lpbiin,
            lpbits,
            lpbiout.unwrap_or(core::mem::zeroed()) as _,
            lquality,
            plsize.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ICImageDecompress(
    hic: Option<HIC>,
    uiflags: u32,
    lpbiin: *const super::super::Graphics::Gdi::BITMAPINFO,
    lpbits: *const core::ffi::c_void,
...
pub unsafe fn ICLocate(
    ...
    fcchandler: u32,
    lpbiin: *const super::super::Graphics::Gdi::BITMAPINFOHEADER,
    lpbiout: Option<*const super::super::Graphics::Gdi::BITMAPINFOHEADER>,
    wflags: u16,
) -> HIC {
...
pub unsafe fn ICOpenFunction(
    ...
    fcchandler: u32,
    wmode: u32,
    lpfnhandler: super::super::Foundation::FARPROC,
) -> HIC {
...
pub unsafe fn ICSeqCompressFrame(
    ...
    unsafe {
        ICSeqCompressFrame(
            pc,
            uiflags.unwrap_or(core::mem::zeroed()) as _,
            lpbits,
            pfkey as _,
            plsize.unwrap_or(core::mem::zeroed()) as _,
        )
...
#[inline]
pub unsafe fn MCIWndCreateA<P3>(
    hwndparent: Option<super::super::Foundation::HWND>,
    hinstance: Option<super::super::Foundation::HINSTANCE>,
    dwstyle: u32,
    szfile: P3,
...
#[inline]
pub unsafe fn OpenDriver<P0, P1>(
    szdrivername: P0,
    szsectionname: P1,
    lparam2: super::super::Foundation::LPARAM,
) -> HDRVR
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        OpenDriver(
            szdrivername.param().abi(),
            szsectionname.param().abi(),
            lparam2,
        )
    }
}
...
#[inline]
pub unsafe fn capCreateCaptureWindowA<P0>(
    lpszwindowname: P0,
    dwstyle: u32,
    x: i32,
    y: i32,
...
pub unsafe fn capGetDriverDescriptionA(
    ...
    unsafe {
        capGetDriverDescriptionA(
            wdriverindex,
            core::mem::transmute(lpszname.as_ptr()),
            lpszname.len().try_into().unwrap(),
            core::mem::transmute(lpszver.as_ptr()),
            lpszver.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
pub unsafe fn mciDriverNotify(
    hwndcallback: super::super::Foundation::HANDLE,
    wdeviceid: u32,
    ustatus: u32,
) -> windows_core::BOOL {
...
pub unsafe fn mciGetErrorStringA(mcierr: u32, psztext: &mut [u8]) -> windows_core::BOOL {
    ...
    unsafe {
        mciGetErrorStringA(
            mcierr,
            core::mem::transmute(psztext.as_ptr()),
            psztext.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn mciLoadCommandResource<P1>(
    hinstance: super::super::Foundation::HANDLE,
    lpresname: P1,
    wtype: u32,
) -> u32
where
...
pub unsafe fn mciSendCommandA(
    mciid: u32,
    umsg: u32,
    dwparam1: Option<usize>,
    dwparam2: Option<usize>,
) -> u32 {
    ...
    unsafe {
        mciSendCommandA(
            mciid,
            umsg,
            dwparam1.unwrap_or(core::mem::zeroed()) as _,
            dwparam2.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn mciSendStringA<P0>(
    lpstrcommand: P0,
    lpstrreturnstring: Option<&mut [u8]>,
    hwndcallback: Option<super::super::Foundation::HWND>,
) -> u32
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        mciSendStringA(
            ...
            hwndcallback.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn mciSendStringW<P0>(
    lpstrcommand: P0,
    lpstrreturnstring: Option<&mut [u16]>,
    hwndcallback: Option<super::super::Foundation::HWND>,
) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn mmioAdvance(hmmio: HMMIO, pmmioinfo: Option<*const MMIOINFO>, fuadvance: u32) -> u32 {
    ...
    unsafe {
        mmioAdvance(
            hmmio,
            pmmioinfo.unwrap_or(core::mem::zeroed()) as _,
            fuadvance,
        )
    }
}
...
pub unsafe fn mmioDescend(
    ...
    unsafe {
        mmioDescend(
            hmmio,
            pmmcki as _,
            pmmckiparent.unwrap_or(core::mem::zeroed()) as _,
            fudescend,
        )
    }
}
...
pub unsafe fn mmioOpenA(
    pszfilename: Option<&mut [u8; 128]>,
    pmmioinfo: Option<*mut MMIOINFO>,
    fdwopen: u32,
) -> HMMIO {
...
pub unsafe fn mmioOpenW(
    pszfilename: Option<&mut [u16; 128]>,
    pmmioinfo: Option<*mut MMIOINFO>,
    fdwopen: u32,
) -> HMMIO {
...
pub unsafe fn mmioRead(hmmio: HMMIO, pch: &mut [u8]) -> i32 {
    ...
    unsafe {
        mmioRead(
            hmmio,
            core::mem::transmute(pch.as_ptr()),
            pch.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn mmioRenameA<P0, P1>(
    pszfilename: P0,
    psznewfilename: P1,
...
#[inline]
pub unsafe fn mmioRenameW<P0, P1>(
    pszfilename: P0,
    psznewfilename: P1,
    pmmioinfo: Option<*const MMIOINFO>,
    fdwrename: u32,
...
pub unsafe fn mmioSendMessage(
    hmmio: HMMIO,
    umsg: u32,
    lparam1: Option<super::super::Foundation::LPARAM>,
    lparam2: Option<super::super::Foundation::LPARAM>,
) -> super::super::Foundation::LRESULT {
    ...
    unsafe {
        mmioSendMessage(
            hmmio,
            umsg,
            lparam1.unwrap_or(core::mem::zeroed()) as _,
            lparam2.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub type CAPCONTROLCALLBACK = Option<
...
pub type CAPERRORCALLBACKA = Option<
    unsafe extern "system" fn(
        hwnd: super::super::Foundation::HWND,
        nid: i32,
        lpsz: windows_core::PCSTR,
    ) -> super::super::Foundation::LRESULT,
>;
pub type CAPERRORCALLBACKW = Option<
    unsafe extern "system" fn(
        hwnd: super::super::Foundation::HWND,
        nid: i32,
...
pub type CAPSTATUSCALLBACKA = Option<
    unsafe extern "system" fn(
        hwnd: super::super::Foundation::HWND,
        nid: i32,
        lpsz: windows_core::PCSTR,
...
>;
pub type CAPSTATUSCALLBACKW = Option<
    unsafe extern "system" fn(
        hwnd: super::super::Foundation::HWND,
        nid: i32,
        lpsz: windows_core::PCWSTR,
...
pub type CAPVIDEOCALLBACK = Option<
    unsafe extern "system" fn(
        hwnd: super::super::Foundation::HWND,
...
>;
#[cfg(feature = "Win32_Media_Audio")]
pub type CAPWAVECALLBACK = Option<
    unsafe extern "system" fn(
        hwnd: super::super::Foundation::HWND,
        lpwhdr: *const super::Audio::WAVEHDR,
    ) -> super::super::Foundation::LRESULT,
>;
pub type CAPYIELDCALLBACK = Option<
    unsafe extern "system" fn(
        hwnd: super::super::Foundation::HWND,
    ) -> super::super::Foundation::LRESULT,
>;
...
pub const CLSID_AVIFile: windows_core::GUID =
    windows_core::GUID::from_u128(0x00020000_0000_0000_c000_000000000046);
pub const CLSID_AVISimpleUnMarshal: windows_core::GUID =
    windows_core::GUID::from_u128(0x00020009_0000_0000_c000_000000000046);
#[repr(C)]
#[cfg(feature = "Win32_Graphics_Gdi")]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct COMPVARS {
...
windows_core::imp::define_interface!(
    IAVIEditStream,
    IAVIEditStream_Vtbl,
    0x00020024_0000_0000_c000_000000000046
);
...
impl IAVIEditStream {
    pub unsafe fn Cut(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Cut)(
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Paste)(
                windows_core::Interface::as_raw(self),
                plpos as _,
                pllength as _,
                pstream.param().abi(),
    ...
    pub unsafe fn SetInfo(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetInfo)(
                windows_core::Interface::as_raw(self),
                lpinfo,
                cbinfo,
            )
...
pub struct IAVIEditStream_Vtbl {
    ...
    pub Cut: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut i32,
        *mut i32,
    ...
    pub SetInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait IAVIEditStream_Impl: windows_core::IUnknownImpl {
    fn Cut(
        ...
        plstart: *mut i32,
        pllength: *mut i32,
        ppresult: windows_core::OutRef<'_, IAVIStream>,
    ) -> windows_core::Result<()>;
    fn Copy(
        &self,
        plstart: *mut i32,
    ...
    fn Paste(
        ...
        plpos: *mut i32,
        pllength: *mut i32,
        pstream: windows_core::Ref<'_, IAVIStream>,
        lstart: i32,
        lend: i32,
    ) -> windows_core::Result<()>;
...
impl IAVIEditStream_Vtbl {
    pub const fn new<Identity: IAVIEditStream_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Cut<Identity: IAVIEditStream_Impl, const OFFSET: isize>(
            ...
            unsafe {
                ...
                IAVIEditStream_Impl::Cut(
                    this,
                    core::mem::transmute_copy(&plstart),
                    core::mem::transmute_copy(&pllength),
                    core::mem::transmute_copy(&ppresult),
                )
                .into()
            }
        }
        unsafe extern "system" fn Copy<Identity: IAVIEditStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plstart: *mut i32,
            pllength: *mut i32,
            ppresult: *mut *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Paste<Identity: IAVIEditStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plpos: *mut i32,
            pllength: *mut i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAVIEditStream_Impl::Paste(
                    this,
                    core::mem::transmute_copy(&plpos),
                    core::mem::transmute_copy(&pllength),
                    core::mem::transmute_copy(&pstream),
                    core::mem::transmute_copy(&lstart),
                    core::mem::transmute_copy(&lend),
                )
                .into()
            }
        }
        unsafe extern "system" fn Clone<Identity: IAVIEditStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppresult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetInfo<Identity: IAVIEditStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpinfo: *const AVISTREAMINFOW,
            cbinfo: i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAVIEditStream_Impl::SetInfo(
                    this,
                    core::mem::transmute_copy(&lpinfo),
                    core::mem::transmute_copy(&cbinfo),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IAVIFile,
    IAVIFile_Vtbl,
    0x00020020_0000_0000_c000_000000000046
);
...
impl IAVIFile {
    ...
    pub unsafe fn WriteData(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).WriteData)(
                windows_core::Interface::as_raw(self),
                ckid,
                lpdata,
                cbdata,
    ...
    pub unsafe fn ReadData(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ReadData)(
                windows_core::Interface::as_raw(self),
                ckid,
                lpdata as _,
                lpcbdata as _,
    ...
    pub unsafe fn EndRecord(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndRecord)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn DeleteStream(&self, fcctype: u32, lparam: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteStream)(
                windows_core::Interface::as_raw(self),
                fcctype,
                lparam,
            )
...
pub struct IAVIFile_Vtbl {
    ...
    pub WriteData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const core::ffi::c_void,
        i32,
    ) -> windows_core::HRESULT,
    pub ReadData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
        *mut i32,
    ...
    pub DeleteStream:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, i32) -> windows_core::HRESULT,
}
pub trait IAVIFile_Impl: windows_core::IUnknownImpl {
    fn Info(&self, pfi: *mut AVIFILEINFOW, lsize: i32) -> windows_core::Result<()>;
    fn GetStream(
        &self,
        ppstream: windows_core::OutRef<'_, IAVIStream>,
        fcctype: u32,
        lparam: i32,
    ) -> windows_core::Result<()>;
    fn CreateStream(
...
impl IAVIFile_Vtbl {
    pub const fn new<Identity: IAVIFile_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Info<Identity: IAVIFile_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pfi: *mut AVIFILEINFOW,
            lsize: i32,
        ) -> windows_core::HRESULT {
            unsafe {
                ...
                IAVIFile_Impl::Info(
                    this,
                    core::mem::transmute_copy(&pfi),
                    core::mem::transmute_copy(&lsize),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetStream<Identity: IAVIFile_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAVIFile_Impl::GetStream(
                    this,
                    core::mem::transmute_copy(&ppstream),
                    core::mem::transmute_copy(&fcctype),
                    core::mem::transmute_copy(&lparam),
                )
                .into()
            }
        }
        unsafe extern "system" fn CreateStream<Identity: IAVIFile_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppstream: *mut *mut core::ffi::c_void,
            psi: *const AVISTREAMINFOW,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn WriteData<Identity: IAVIFile_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ckid: u32,
            lpdata: *const core::ffi::c_void,
            cbdata: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAVIFile_Impl::WriteData(
                    this,
                    core::mem::transmute_copy(&ckid),
                    core::mem::transmute_copy(&lpdata),
                    core::mem::transmute_copy(&cbdata),
                )
                .into()
            }
        }
        unsafe extern "system" fn ReadData<Identity: IAVIFile_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ckid: u32,
            lpdata: *mut core::ffi::c_void,
            lpcbdata: *mut i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAVIFile_Impl::ReadData(
                    this,
                    core::mem::transmute_copy(&ckid),
                    core::mem::transmute_copy(&lpdata),
                    core::mem::transmute_copy(&lpcbdata),
                )
                .into()
            }
        }
        unsafe extern "system" fn EndRecord<Identity: IAVIFile_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn DeleteStream<Identity: IAVIFile_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fcctype: u32,
            lparam: i32,
        ) -> windows_core::HRESULT {
...
windows_core::imp::interface_hierarchy!(
    ...
    super::super::System::Com::IPersist,
...
impl IAVIPersistFile_Vtbl {
    pub const fn new<Identity: IAVIPersistFile_Impl, const OFFSET: isize>() -> Self {
        ...
        Self {
            base__: super::super::System::Com::IPersistFile_Vtbl::new::<Identity, OFFSET>(),
            Reserved1: Reserved1::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAVIPersistFile as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IPersist as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IPersistFile as windows_core::Interface>::IID
    }
}
#[cfg(feature = "Win32_System_Com")]
...
windows_core::imp::define_interface!(
    IAVIStream,
    IAVIStream_Vtbl,
    0x00020021_0000_0000_c000_000000000046
);
...
impl IAVIStream {
    ...
    pub unsafe fn FindSample(&self, lpos: i32, lflags: i32) -> i32 {
        unsafe {
            (windows_core::Interface::vtable(self).FindSample)(
                windows_core::Interface::as_raw(self),
                lpos,
                lflags,
            )
    ...
    pub unsafe fn ReadFormat(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ReadFormat)(
                windows_core::Interface::as_raw(self),
                lpos,
                lpformat.unwrap_or(core::mem::zeroed()) as _,
                lpcbformat as _,
    ...
    pub unsafe fn SetFormat(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetFormat)(
                windows_core::Interface::as_raw(self),
                lpos,
                lpformat,
                cbformat,
...
pub struct IAVIStream_Vtbl {
    ...
    pub ReadFormat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
        *mut i32,
...
impl IAVIStream_Vtbl {
    pub const fn new<Identity: IAVIStream_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Create<Identity: IAVIStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lparam1: super::super::Foundation::LPARAM,
            lparam2: super::super::Foundation::LPARAM,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAVIStream_Impl::Create(
                    this,
                    core::mem::transmute_copy(&lparam1),
                    core::mem::transmute_copy(&lparam2),
                )
                .into()
            }
        }
        unsafe extern "system" fn Info<Identity: IAVIStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            psi: *mut AVISTREAMINFOW,
            lsize: i32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn FindSample<Identity: IAVIStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpos: i32,
            lflags: i32,
        ) -> i32 {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAVIStream_Impl::FindSample(
                    this,
                    core::mem::transmute_copy(&lpos),
                    core::mem::transmute_copy(&lflags),
                )
            }
        }
        unsafe extern "system" fn ReadFormat<Identity: IAVIStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpos: i32,
            lpformat: *mut core::ffi::c_void,
            lpcbformat: *mut i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAVIStream_Impl::ReadFormat(
                    this,
                    core::mem::transmute_copy(&lpos),
                    core::mem::transmute_copy(&lpformat),
                    core::mem::transmute_copy(&lpcbformat),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetFormat<Identity: IAVIStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpos: i32,
            lpformat: *const core::ffi::c_void,
            cbformat: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAVIStream_Impl::SetFormat(
                    this,
                    core::mem::transmute_copy(&lpos),
                    core::mem::transmute_copy(&lpformat),
                    core::mem::transmute_copy(&cbformat),
                )
                .into()
            }
        }
        unsafe extern "system" fn Read<Identity: IAVIStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lstart: i32,
            lsamples: i32,
            lpbuffer: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAVIStream_Impl::Read(
                    this,
                    core::mem::transmute_copy(&lstart),
                    core::mem::transmute_copy(&lsamples),
                    core::mem::transmute_copy(&lpbuffer),
                    core::mem::transmute_copy(&cbbuffer),
                    core::mem::transmute_copy(&plbytes),
                    core::mem::transmute_copy(&plsamples),
                )
                .into()
            }
        }
        unsafe extern "system" fn Write<Identity: IAVIStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lstart: i32,
            lsamples: i32,
            lpbuffer: *const core::ffi::c_void,
            ...
            unsafe {
                ...
                IAVIStream_Impl::Write(
                    ...
                    core::mem::transmute_copy(&plsampwritten),
                    core::mem::transmute_copy(&plbyteswritten),
                )
                .into()
            }
        }
        unsafe extern "system" fn Delete<Identity: IAVIStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lstart: i32,
            lsamples: i32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn ReadData<Identity: IAVIStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fcc: u32,
            lp: *mut core::ffi::c_void,
            lpcb: *mut i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAVIStream_Impl::ReadData(
                    this,
                    core::mem::transmute_copy(&fcc),
                    core::mem::transmute_copy(&lp),
                    core::mem::transmute_copy(&lpcb),
                )
                .into()
            }
        }
        unsafe extern "system" fn WriteData<Identity: IAVIStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fcc: u32,
            lp: *const core::ffi::c_void,
            cb: i32,
        ...
        unsafe extern "system" fn SetInfo<Identity: IAVIStream_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpinfo: *const AVISTREAMINFOW,
            cbinfo: i32,
        ) -> windows_core::HRESULT {
...
windows_core::imp::define_interface!(
    IAVIStreaming,
    IAVIStreaming_Vtbl,
    0x00020022_0000_0000_c000_000000000046
);
...
pub struct IAVIStreaming_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Begin:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, i32, i32) -> windows_core::HRESULT,
...
impl IAVIStreaming_Vtbl {
    pub const fn new<Identity: IAVIStreaming_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin<Identity: IAVIStreaming_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lstart: i32,
            lend: i32,
            lrate: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAVIStreaming_Impl::Begin(
                    this,
                    core::mem::transmute_copy(&lstart),
                    core::mem::transmute_copy(&lend),
                    core::mem::transmute_copy(&lrate),
                )
                .into()
            }
        }
        unsafe extern "system" fn End<Identity: IAVIStreaming_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    IGetFrame,
    IGetFrame_Vtbl,
    0x00020023_0000_0000_c000_000000000046
);
...
pub struct IGetFrame_Vtbl {
    ...
    pub SetFormat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::super::Graphics::Gdi::BITMAPINFOHEADER,
        *const core::ffi::c_void,
        i32,
        i32,
        i32,
...
impl IGetFrame_Vtbl {
    pub const fn new<Identity: IGetFrame_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetFrame<Identity: IGetFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpos: i32,
        ) -> *mut core::ffi::c_void {
            unsafe {
        ...
        unsafe extern "system" fn Begin<Identity: IGetFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lstart: i32,
            lend: i32,
            lrate: i32,
        ...
        unsafe extern "system" fn End<Identity: IGetFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn SetFormat<Identity: IGetFrame_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpbi: *const super::super::Graphics::Gdi::BITMAPINFOHEADER,
            lpbits: *const core::ffi::c_void,
            x: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGetFrame_Impl::SetFormat(
                    this,
                    core::mem::transmute_copy(&lpbi),
                    core::mem::transmute_copy(&lpbits),
                    core::mem::transmute_copy(&x),
                    core::mem::transmute_copy(&y),
                    core::mem::transmute_copy(&dx),
                    core::mem::transmute_copy(&dy),
                )
                .into()
            }
        }
...
pub const KSDATAFORMAT_SUBTYPE_IEEE_FLOAT: windows_core::GUID =
...
>;
pub type LPMMIOPROC = Option<
    unsafe extern "system" fn(
        lpmmioinfo: windows_core::PCSTR,
        umsg: u32,
        lparam1: super::super::Foundation::LPARAM,
        lparam2: super::super::Foundation::LPARAM,
    ) -> super::super::Foundation::LRESULT,
...
pub const MCMADM_E_REGKEY_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D006A_u32 as _);
...
pub const NS_DRM_E_MIGRATION_IMAGE_ALREADY_EXISTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D278E_u32 as _);
pub const NS_DRM_E_MIGRATION_SOURCE_MACHINE_IN_USE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D278C_u32 as _);
pub const NS_DRM_E_MIGRATION_TARGET_MACHINE_LESS_THAN_LH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D278D_u32 as _);
pub const NS_DRM_E_MIGRATION_UPGRADE_WITH_DIFF_SID: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D278B_u32 as _);
pub const NS_E_8BIT_WAVE_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BCE_u32 as _);
pub const NS_E_ACTIVE_SG_DEVICE_CONTROL_DISCONNECTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BA6_u32 as _);
pub const NS_E_ACTIVE_SG_DEVICE_DISCONNECTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BA5_u32 as _);
pub const NS_E_ADVANCEDEDIT_TOO_MANY_PICTURES: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D136A_u32 as _);
pub const NS_E_ALLOCATE_FILE_FAIL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0061_u32 as _);
pub const NS_E_ALL_PROTOCOLS_DISABLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EEB_u32 as _);
pub const NS_E_ALREADY_CONNECTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0010_u32 as _);
pub const NS_E_ANALOG_VIDEO_PROTECTION_LEVEL_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2907_u32 as _);
pub const NS_E_ARCHIVE_ABORT_DUE_TO_BCAST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D158E_u32 as _);
pub const NS_E_ARCHIVE_FILENAME_NOTSET: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B79_u32 as _);
pub const NS_E_ARCHIVE_GAP_DETECTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D158F_u32 as _);
pub const NS_E_ARCHIVE_REACH_QUOTA: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D158D_u32 as _);
pub const NS_E_ARCHIVE_SAME_AS_INPUT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B84_u32 as _);
pub const NS_E_ASSERT: windows_core::HRESULT = windows_core::HRESULT(0xC00D00CB_u32 as _);
pub const NS_E_ASX_INVALIDFORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1069_u32 as _);
pub const NS_E_ASX_INVALIDVERSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D106A_u32 as _);
pub const NS_E_ASX_INVALID_REPEAT_BLOCK: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D106B_u32 as _);
pub const NS_E_ASX_NOTHING_TO_WRITE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D106C_u32 as _);
pub const NS_E_ATTRIBUTE_NOT_ALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BD7_u32 as _);
pub const NS_E_ATTRIBUTE_READ_ONLY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BD6_u32 as _);
pub const NS_E_AUDIENCE_CONTENTTYPE_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B99_u32 as _);
pub const NS_E_AUDIENCE__LANGUAGE_CONTENTTYPE_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BE3_u32 as _);
pub const NS_E_AUDIODEVICE_BADFORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B63_u32 as _);
pub const NS_E_AUDIODEVICE_BUSY: windows_core::HRESULT = windows_core::HRESULT(0xC00D1B61_u32 as _);
pub const NS_E_AUDIODEVICE_UNEXPECTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B62_u32 as _);
pub const NS_E_AUDIO_BITRATE_STEPDOWN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BB9_u32 as _);
pub const NS_E_AUDIO_CODEC_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BC3_u32 as _);
pub const NS_E_AUDIO_CODEC_NOT_INSTALLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BC2_u32 as _);
pub const NS_E_AUTHORIZATION_FILE_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1590_u32 as _);
pub const NS_E_BACKUP_RESTORE_BAD_DATA: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2745_u32 as _);
pub const NS_E_BACKUP_RESTORE_BAD_REQUEST_ID: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D272E_u32 as _);
pub const NS_E_BACKUP_RESTORE_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D272D_u32 as _);
pub const NS_E_BACKUP_RESTORE_TOO_MANY_RESETS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2766_u32 as _);
pub const NS_E_BAD_ADAPTER_ADDRESS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0039_u32 as _);
pub const NS_E_BAD_ADAPTER_NAME: windows_core::HRESULT = windows_core::HRESULT(0xC00D00CC_u32 as _);
pub const NS_E_BAD_BLOCK0_VERSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0063_u32 as _);
...
pub const NS_E_BAD_DELIVERY_MODE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D003A_u32 as _);
pub const NS_E_BAD_DISK_UID: windows_core::HRESULT = windows_core::HRESULT(0xC00D0064_u32 as _);
pub const NS_E_BAD_FSMAJOR_VERSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0065_u32 as _);
...
pub const NS_E_BAD_MULTICAST_ADDRESS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0038_u32 as _);
...
pub const NS_E_BAD_SYNTAX_IN_SERVER_RESPONSE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EFE_u32 as _);
pub const NS_E_BKGDOWNLOAD_CALLFUNCENDED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1267_u32 as _);
pub const NS_E_BKGDOWNLOAD_CALLFUNCFAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1265_u32 as _);
pub const NS_E_BKGDOWNLOAD_CALLFUNCTIMEOUT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1266_u32 as _);
pub const NS_E_BKGDOWNLOAD_CANCELCOMPLETEDJOB: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D125F_u32 as _);
pub const NS_E_BKGDOWNLOAD_COMPLETECANCELLEDJOB: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D125E_u32 as _);
pub const NS_E_BKGDOWNLOAD_FAILEDINITIALIZE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1269_u32 as _);
pub const NS_E_BKGDOWNLOAD_FAILED_TO_CREATE_TEMPFILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1262_u32 as _);
pub const NS_E_BKGDOWNLOAD_INVALIDJOBSIGNATURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1261_u32 as _);
pub const NS_E_BKGDOWNLOAD_INVALID_FILE_NAME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D126B_u32 as _);
pub const NS_E_BKGDOWNLOAD_NOJOBPOINTER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1260_u32 as _);
pub const NS_E_BKGDOWNLOAD_PLUGIN_FAILEDINITIALIZE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1263_u32 as _);
pub const NS_E_BKGDOWNLOAD_PLUGIN_FAILEDTOMOVEFILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1264_u32 as _);
pub const NS_E_BKGDOWNLOAD_WMDUNPACKFAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1268_u32 as _);
pub const NS_E_BKGDOWNLOAD_WRONG_NO_FILES: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D125D_u32 as _);
pub const NS_E_BUSY: windows_core::HRESULT = windows_core::HRESULT(0xC00D0025_u32 as _);
pub const NS_E_CACHE_ARCHIVE_CONFLICT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D13EC_u32 as _);
pub const NS_E_CACHE_CANNOT_BE_CACHED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D13F0_u32 as _);
pub const NS_E_CACHE_NOT_BROADCAST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D13EF_u32 as _);
pub const NS_E_CACHE_NOT_MODIFIED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D13F1_u32 as _);
pub const NS_E_CACHE_ORIGIN_SERVER_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D13ED_u32 as _);
pub const NS_E_CACHE_ORIGIN_SERVER_TIMEOUT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D13EE_u32 as _);
pub const NS_E_CANNOTCONNECT: windows_core::HRESULT = windows_core::HRESULT(0xC00D0006_u32 as _);
pub const NS_E_CANNOTCONNECTEVENTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D006F_u32 as _);
pub const NS_E_CANNOTDESTROYTITLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0007_u32 as _);
pub const NS_E_CANNOTOFFLINEDISK: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0009_u32 as _);
pub const NS_E_CANNOTONLINEDISK: windows_core::HRESULT = windows_core::HRESULT(0xC00D000A_u32 as _);
pub const NS_E_CANNOTRENAMETITLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0008_u32 as _);
pub const NS_E_CANNOT_BUY_OR_DOWNLOAD_CONTENT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1358_u32 as _);
pub const NS_E_CANNOT_BUY_OR_DOWNLOAD_FROM_MULTIPLE_SERVICES: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1357_u32 as _);
pub const NS_E_CANNOT_CONNECT_TO_PROXY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EEE_u32 as _);
pub const NS_E_CANNOT_DELETE_ACTIVE_SOURCEGROUP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B60_u32 as _);
pub const NS_E_CANNOT_GENERATE_BROADCAST_INFO_FOR_QUALITYVBR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BDF_u32 as _);
pub const NS_E_CANNOT_PAUSE_LIVEBROADCAST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B8E_u32 as _);
pub const NS_E_CANNOT_READ_PLAYLIST_FROM_MEDIASERVER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EF2_u32 as _);
pub const NS_E_CANNOT_REMOVE_PLUGIN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1451_u32 as _);
pub const NS_E_CANNOT_REMOVE_PUBLISHING_POINT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1450_u32 as _);
pub const NS_E_CANNOT_SYNC_DRM_TO_NON_JANUS_DEVICE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1246_u32 as _);
pub const NS_E_CANNOT_SYNC_PREVIOUS_SYNC_RUNNING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1247_u32 as _);
pub const NS_E_CANT_READ_DIGITAL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FA1_u32 as _);
...
pub const NS_E_CD_DRIVER_PROBLEM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FB2_u32 as _);
pub const NS_E_CD_EMPTY_TRACK_QUEUE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11F9_u32 as _);
pub const NS_E_CD_ISRC_INVALID: windows_core::HRESULT = windows_core::HRESULT(0xC00D11FB_u32 as _);
pub const NS_E_CD_MEDIA_CATALOG_NUMBER_INVALID: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11FC_u32 as _);
pub const NS_E_CD_NO_BUFFERS_READ: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11F8_u32 as _);
pub const NS_E_CD_NO_READER: windows_core::HRESULT = windows_core::HRESULT(0xC00D11FA_u32 as _);
pub const NS_E_CD_QUEUEING_DISABLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11FF_u32 as _);
pub const NS_E_CD_READ_ERROR: windows_core::HRESULT = windows_core::HRESULT(0xC00D0FAC_u32 as _);
pub const NS_E_CD_READ_ERROR_NO_CORRECTION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FAB_u32 as _);
...
pub const NS_E_CD_SPEEDDETECT_NOT_ENOUGH_READS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11FE_u32 as _);
pub const NS_E_CHANGING_PROXYBYPASS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10C3_u32 as _);
pub const NS_E_CHANGING_PROXY_EXCEPTIONLIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10C2_u32 as _);
pub const NS_E_CHANGING_PROXY_NAME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10C0_u32 as _);
pub const NS_E_CHANGING_PROXY_PORT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10C1_u32 as _);
pub const NS_E_CHANGING_PROXY_PROTOCOL_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10C4_u32 as _);
pub const NS_E_CLOSED_ON_SUSPEND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EF1_u32 as _);
pub const NS_E_CODEC_DMO_ERROR: windows_core::HRESULT = windows_core::HRESULT(0xC00D0BDA_u32 as _);
pub const NS_E_CODEC_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B83_u32 as _);
pub const NS_E_COMPRESSED_DIGITAL_AUDIO_PROTECTION_LEVEL_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2908_u32 as _);
pub const NS_E_COMPRESSED_DIGITAL_VIDEO_PROTECTION_LEVEL_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2905_u32 as _);
pub const NS_E_CONNECTION_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0029_u32 as _);
pub const NS_E_CONNECT_TIMEOUT: windows_core::HRESULT = windows_core::HRESULT(0xC00D2F06_u32 as _);
pub const NS_E_CONTENT_PARTNER_STILL_INITIALIZING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1362_u32 as _);
pub const NS_E_CORECD_NOTAMEDIACD: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10C7_u32 as _);
...
pub const NS_E_CURLHELPER_NOTADIRECTORY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D132D_u32 as _);
pub const NS_E_CURLHELPER_NOTAFILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D132E_u32 as _);
pub const NS_E_CURLHELPER_NOTRELATIVE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1330_u32 as _);
...
pub const NS_E_CURL_INVALIDBUFFERSIZE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1331_u32 as _);
pub const NS_E_CURL_INVALIDCHAR: windows_core::HRESULT = windows_core::HRESULT(0xC00D1325_u32 as _);
pub const NS_E_CURL_INVALIDHOSTNAME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1326_u32 as _);
...
pub const NS_E_CURL_INVALIDSCHEME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1328_u32 as _);
...
pub const NS_E_DATA_SOURCE_ENUMERATION_NOT_SUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1580_u32 as _);
pub const NS_E_DATA_UNIT_EXTENSION_TOO_LARGE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BD9_u32 as _);
pub const NS_E_DDRAW_GENERIC: windows_core::HRESULT = windows_core::HRESULT(0xC00D10BD_u32 as _);
pub const NS_E_DEVCONTROL_FAILED_SEEK: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B94_u32 as _);
pub const NS_E_DEVICECONTROL_UNSTABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BE1_u32 as _);
pub const NS_E_DEVICE_DISCONNECTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FA2_u32 as _);
pub const NS_E_DEVICE_IS_NOT_READY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1177_u32 as _);
pub const NS_E_DEVICE_NOT_READY: windows_core::HRESULT = windows_core::HRESULT(0xC00D0FCA_u32 as _);
pub const NS_E_DEVICE_NOT_SUPPORT_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FA3_u32 as _);
pub const NS_E_DEVICE_NOT_WMDRM_DEVICE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D277B_u32 as _);
...
pub const NS_E_DISPLAY_MODE_CHANGE_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10BE_u32 as _);
pub const NS_E_DRMPROFILE_NOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BD5_u32 as _);
pub const NS_E_DRM_ACQUIRING_LICENSE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D272B_u32 as _);
pub const NS_E_DRM_ACTION_NOT_QUERIED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D272A_u32 as _);
pub const NS_E_DRM_ALREADY_INDIVIDUALIZED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2729_u32 as _);
pub const NS_E_DRM_APPCERT_REVOKED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2752_u32 as _);
pub const NS_E_DRM_ATTRIBUTE_TOO_LONG: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28B2_u32 as _);
pub const NS_E_DRM_BACKUPRESTORE_BUSY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2744_u32 as _);
pub const NS_E_DRM_BACKUP_CORRUPT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2743_u32 as _);
pub const NS_E_DRM_BACKUP_EXISTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2742_u32 as _);
pub const NS_E_DRM_BAD_REQUEST: windows_core::HRESULT = windows_core::HRESULT(0xC00D28B0_u32 as _);
pub const NS_E_DRM_BB_UNABLE_TO_INITIALIZE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2780_u32 as _);
pub const NS_E_DRM_BUFFER_TOO_SMALL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D275C_u32 as _);
pub const NS_E_DRM_BUSY: windows_core::HRESULT = windows_core::HRESULT(0xC00D2841_u32 as _);
pub const NS_E_DRM_CACHED_CONTENT_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D274B_u32 as _);
pub const NS_E_DRM_CERTIFICATE_REVOKED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28A1_u32 as _);
pub const NS_E_DRM_CERTIFICATE_SECURITY_LEVEL_INADEQUATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28AE_u32 as _);
pub const NS_E_DRM_CHAIN_TOO_LONG: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D284C_u32 as _);
pub const NS_E_DRM_CHECKPOINT_CORRUPT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2797_u32 as _);
pub const NS_E_DRM_CHECKPOINT_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D277F_u32 as _);
pub const NS_E_DRM_CHECKPOINT_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2796_u32 as _);
pub const NS_E_DRM_CLIENT_CODE_EXPIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2847_u32 as _);
pub const NS_E_DRM_DATASTORE_CORRUPT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2783_u32 as _);
pub const NS_E_DRM_DEBUGGING_NOT_ALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2767_u32 as _);
pub const NS_E_DRM_DECRYPT_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2723_u32 as _);
pub const NS_E_DRM_DEVICE_ACTIVATION_CANCELED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2765_u32 as _);
pub const NS_E_DRM_DEVICE_ALREADY_REGISTERED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28AB_u32 as _);
pub const NS_E_DRM_DEVICE_LIMIT_REACHED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28A3_u32 as _);
pub const NS_E_DRM_DEVICE_NOT_OPEN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28AA_u32 as _);
pub const NS_E_DRM_DEVICE_NOT_REGISTERED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D27E2_u32 as _);
pub const NS_E_DRM_DRIVER_AUTH_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D274D_u32 as _);
pub const NS_E_DRM_DRIVER_DIGIOUT_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2750_u32 as _);
pub const NS_E_DRM_DRMV2CLT_REVOKED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28B6_u32 as _);
pub const NS_E_DRM_ENCRYPT_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2722_u32 as _);
pub const NS_E_DRM_ENUM_LICENSE_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D271B_u32 as _);
pub const NS_E_DRM_ERROR_BAD_NET_RESP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D275E_u32 as _);
pub const NS_E_DRM_EXPIRED_LICENSEBLOB: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28B3_u32 as _);
pub const NS_E_DRM_GET_CONTENTSTRING_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D273D_u32 as _);
pub const NS_E_DRM_GET_LICENSESTRING_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D273C_u32 as _);
pub const NS_E_DRM_GET_LICENSE_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2739_u32 as _);
pub const NS_E_DRM_HARDWAREID_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D278F_u32 as _);
pub const NS_E_DRM_HARDWARE_INCONSISTENT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2754_u32 as _);
pub const NS_E_DRM_INCLUSION_LIST_REQUIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28B5_u32 as _);
pub const NS_E_DRM_INDIVIDUALIZATION_INCOMPLETE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D274C_u32 as _);
pub const NS_E_DRM_INDIVIDUALIZE_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2736_u32 as _);
pub const NS_E_DRM_INDIVIDUALIZING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D272C_u32 as _);
pub const NS_E_DRM_INDIV_FRAUD: windows_core::HRESULT = windows_core::HRESULT(0xC00D2843_u32 as _);
pub const NS_E_DRM_INDIV_NO_CABS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2844_u32 as _);
pub const NS_E_DRM_INDIV_SERVICE_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2845_u32 as _);
pub const NS_E_DRM_INVALID_APPCERT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D277C_u32 as _);
pub const NS_E_DRM_INVALID_APPDATA: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2740_u32 as _);
pub const NS_E_DRM_INVALID_APPDATA_VERSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2741_u32 as _);
pub const NS_E_DRM_INVALID_APPLICATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2711_u32 as _);
pub const NS_E_DRM_INVALID_CERTIFICATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28A0_u32 as _);
pub const NS_E_DRM_INVALID_CONTENT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2716_u32 as _);
...
pub const NS_E_DRM_INVALID_LICENSE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2718_u32 as _);
pub const NS_E_DRM_INVALID_LICENSEBLOB: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28B4_u32 as _);
pub const NS_E_DRM_INVALID_LICENSE_ACQUIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D271F_u32 as _);
pub const NS_E_DRM_INVALID_LICENSE_REQUEST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D271C_u32 as _);
pub const NS_E_DRM_INVALID_MACHINE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2719_u32 as _);
pub const NS_E_DRM_INVALID_MIGRATION_IMAGE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2788_u32 as _);
pub const NS_E_DRM_INVALID_PROPERTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2749_u32 as _);
pub const NS_E_DRM_INVALID_PROXIMITY_RESPONSE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28A8_u32 as _);
pub const NS_E_DRM_INVALID_SECURESTORE_PASSWORD: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2751_u32 as _);
pub const NS_E_DRM_INVALID_SESSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28A9_u32 as _);
pub const NS_E_DRM_KEY_ERROR: windows_core::HRESULT = windows_core::HRESULT(0xC00D2721_u32 as _);
pub const NS_E_DRM_LICENSE_APPSECLOW: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D27DA_u32 as _);
pub const NS_E_DRM_LICENSE_APP_NOTALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D27DD_u32 as _);
pub const NS_E_DRM_LICENSE_CERT_EXPIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D27DF_u32 as _);
pub const NS_E_DRM_LICENSE_CLOSE_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2738_u32 as _);
pub const NS_E_DRM_LICENSE_CONTENT_REVOKED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D27E1_u32 as _);
pub const NS_E_DRM_LICENSE_DELETION_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D284E_u32 as _);
pub const NS_E_DRM_LICENSE_EXPIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D27D8_u32 as _);
pub const NS_E_DRM_LICENSE_INITIALIZATION_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D284A_u32 as _);
pub const NS_E_DRM_LICENSE_INVALID_XML: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2725_u32 as _);
pub const NS_E_DRM_LICENSE_NOSAP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D280A_u32 as _);
pub const NS_E_DRM_LICENSE_NOSVP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D280B_u32 as _);
pub const NS_E_DRM_LICENSE_NOTACQUIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2759_u32 as _);
pub const NS_E_DRM_LICENSE_NOTENABLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D27D9_u32 as _);
pub const NS_E_DRM_LICENSE_NOTRUSTEDCODEC: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D280D_u32 as _);
pub const NS_E_DRM_LICENSE_NOWDM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D280C_u32 as _);
pub const NS_E_DRM_LICENSE_OPEN_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2737_u32 as _);
pub const NS_E_DRM_LICENSE_SECLOW: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D27E0_u32 as _);
pub const NS_E_DRM_LICENSE_SERVER_INFO_MISSING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2840_u32 as _);
pub const NS_E_DRM_LICENSE_STORE_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2712_u32 as _);
pub const NS_E_DRM_LICENSE_STORE_SAVE_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2714_u32 as _);
pub const NS_E_DRM_LICENSE_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28A2_u32 as _);
pub const NS_E_DRM_LICENSE_UNUSABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2748_u32 as _);
pub const NS_E_DRM_LIC_NEEDS_DEVICE_CLOCK_SET: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2779_u32 as _);
pub const NS_E_DRM_MALFORMED_CONTENT_HEADER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D279C_u32 as _);
pub const NS_E_DRM_MIGRATION_IMPORTER_NOT_AVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D278A_u32 as _);
pub const NS_E_DRM_MIGRATION_INVALID_LEGACYV2_DATA: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2791_u32 as _);
pub const NS_E_DRM_MIGRATION_INVALID_LEGACYV2_SST_PASSWORD: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2793_u32 as _);
pub const NS_E_DRM_MIGRATION_LICENSE_ALREADY_EXISTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2792_u32 as _);
pub const NS_E_DRM_MIGRATION_NOT_SUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2794_u32 as _);
pub const NS_E_DRM_MIGRATION_OBJECT_IN_USE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D279B_u32 as _);
pub const NS_E_DRM_MIGRATION_OPERATION_CANCELLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D279A_u32 as _);
pub const NS_E_DRM_MIGRATION_TARGET_NOT_ONLINE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2787_u32 as _);
pub const NS_E_DRM_MIGRATION_TARGET_STATES_CORRUPTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2789_u32 as _);
pub const NS_E_DRM_MONITOR_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D273E_u32 as _);
pub const NS_E_DRM_MUST_APPROVE: windows_core::HRESULT = windows_core::HRESULT(0xC00D28A6_u32 as _);
pub const NS_E_DRM_MUST_REGISTER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28A5_u32 as _);
pub const NS_E_DRM_MUST_REVALIDATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28A7_u32 as _);
pub const NS_E_DRM_NEEDS_INDIVIDUALIZATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2728_u32 as _);
pub const NS_E_DRM_NEEDS_UPGRADE_TEMPFILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D283D_u32 as _);
pub const NS_E_DRM_NEED_UPGRADE_MSSAP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D274E_u32 as _);
pub const NS_E_DRM_NEED_UPGRADE_PD: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D283E_u32 as _);
pub const NS_E_DRM_NOT_CONFIGURED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2764_u32 as _);
pub const NS_E_DRM_NO_RIGHTS: windows_core::HRESULT = windows_core::HRESULT(0xC00D2720_u32 as _);
pub const NS_E_DRM_NO_UPLINK_LICENSE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2848_u32 as _);
pub const NS_E_DRM_OPERATION_CANCELED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2768_u32 as _);
pub const NS_E_DRM_PARAMETERS_MISMATCHED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D272F_u32 as _);
pub const NS_E_DRM_PASSWORD_TOO_LONG: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B93_u32 as _);
pub const NS_E_DRM_PD_TOO_MANY_DEVICES: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2842_u32 as _);
pub const NS_E_DRM_POLICY_DISABLE_ONLINE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2762_u32 as _);
pub const NS_E_DRM_POLICY_METERING_DISABLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2776_u32 as _);
pub const NS_E_DRM_PROFILE_NOT_SET: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B8F_u32 as _);
pub const NS_E_DRM_PROTOCOL_FORCEFUL_TERMINATION_ON_CHALLENGE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D277E_u32 as _);
pub const NS_E_DRM_PROTOCOL_FORCEFUL_TERMINATION_ON_PETITION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D277D_u32 as _);
pub const NS_E_DRM_QUERY_ERROR: windows_core::HRESULT = windows_core::HRESULT(0xC00D273A_u32 as _);
pub const NS_E_DRM_REOPEN_CONTENT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D274F_u32 as _);
pub const NS_E_DRM_REPORT_ERROR: windows_core::HRESULT = windows_core::HRESULT(0xC00D273B_u32 as _);
pub const NS_E_DRM_RESTORE_FRAUD: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2753_u32 as _);
pub const NS_E_DRM_RESTORE_SERVICE_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2846_u32 as _);
pub const NS_E_DRM_RESTRICTIONS_NOT_RETRIEVED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2769_u32 as _);
pub const NS_E_DRM_RIV_TOO_SMALL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28B7_u32 as _);
pub const NS_E_DRM_SDK_VERSIONMISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2778_u32 as _);
pub const NS_E_DRM_SDMI_NOMORECOPIES: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2756_u32 as _);
pub const NS_E_DRM_SDMI_TRIGGER: windows_core::HRESULT = windows_core::HRESULT(0xC00D2755_u32 as _);
pub const NS_E_DRM_SECURE_STORE_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2713_u32 as _);
pub const NS_E_DRM_SECURE_STORE_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D274A_u32 as _);
pub const NS_E_DRM_SECURE_STORE_UNLOCK_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2715_u32 as _);
pub const NS_E_DRM_SECURITY_COMPONENT_SIGNATURE_INVALID: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2760_u32 as _);
pub const NS_E_DRM_SIGNATURE_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D283F_u32 as _);
pub const NS_E_DRM_SOURCEID_NOT_SUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D280E_u32 as _);
pub const NS_E_DRM_STORE_NEEDINDI: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D27DB_u32 as _);
pub const NS_E_DRM_STORE_NOTALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D27DC_u32 as _);
pub const NS_E_DRM_STORE_NOTALLSTORED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D275F_u32 as _);
pub const NS_E_DRM_STUBLIB_REQUIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2785_u32 as _);
pub const NS_E_DRM_TRACK_EXCEEDED_PLAYLIST_RESTICTION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2770_u32 as _);
pub const NS_E_DRM_TRACK_EXCEEDED_TRACKBURN_RESTRICTION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2771_u32 as _);
pub const NS_E_DRM_TRANSFER_CHAINED_LICENSES_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2777_u32 as _);
pub const NS_E_DRM_UNABLE_TO_ACQUIRE_LICENSE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D271E_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_AUTHENTICATION_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2763_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_BACKUP_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2735_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_CERTIFICATE_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2786_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_CODING_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D275A_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_DECRYPT_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2733_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_DEVICE_REGISTRATION_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D276C_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_ENCRYPT_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2732_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_HEADER_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2757_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_INDI_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2731_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_INMEMORYSTORE_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2784_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_KEYS_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2758_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_LICENSE_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2730_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_METERING_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D276D_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_MIGRATION_IMPORTER_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2795_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_PLAYLIST_BURN_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D276B_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_PLAYLIST_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D276A_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_PROPERTIES_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2734_u32 as _);
pub const NS_E_DRM_UNABLE_TO_CREATE_STATE_DATA_OBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D275B_u32 as _);
pub const NS_E_DRM_UNABLE_TO_GET_DEVICE_CERT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2772_u32 as _);
pub const NS_E_DRM_UNABLE_TO_GET_SECURE_CLOCK: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2773_u32 as _);
pub const NS_E_DRM_UNABLE_TO_GET_SECURE_CLOCK_FROM_SERVER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2775_u32 as _);
pub const NS_E_DRM_UNABLE_TO_INITIALIZE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D271D_u32 as _);
pub const NS_E_DRM_UNABLE_TO_LOAD_HARDWARE_ID: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2781_u32 as _);
pub const NS_E_DRM_UNABLE_TO_OPEN_DATA_STORE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2782_u32 as _);
pub const NS_E_DRM_UNABLE_TO_OPEN_LICENSE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2717_u32 as _);
pub const NS_E_DRM_UNABLE_TO_OPEN_PORT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28AF_u32 as _);
pub const NS_E_DRM_UNABLE_TO_SET_PARAMETER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D273F_u32 as _);
pub const NS_E_DRM_UNABLE_TO_SET_SECURE_CLOCK: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2774_u32 as _);
pub const NS_E_DRM_UNABLE_TO_VERIFY_PROXIMITY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28A4_u32 as _);
pub const NS_E_DRM_UNSUPPORTED_ACTION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28AD_u32 as _);
pub const NS_E_DRM_UNSUPPORTED_ALGORITHM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D284D_u32 as _);
pub const NS_E_DRM_UNSUPPORTED_PROPERTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D275D_u32 as _);
pub const NS_E_DRM_UNSUPPORTED_PROTOCOL_VERSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D28AC_u32 as _);
pub const NS_E_DUPLICATE_ADDRESS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0037_u32 as _);
pub const NS_E_DUPLICATE_DRMPROFILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B90_u32 as _);
...
pub const NS_E_DVD_AUTHORING_PROBLEM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1164_u32 as _);
pub const NS_E_DVD_CANNOT_COPY_PROTECTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1172_u32 as _);
pub const NS_E_DVD_CANNOT_JUMP: windows_core::HRESULT = windows_core::HRESULT(0xC00D116F_u32 as _);
pub const NS_E_DVD_COMPATIBLE_VIDEO_CARD: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1166_u32 as _);
pub const NS_E_DVD_COPY_PROTECT: windows_core::HRESULT = windows_core::HRESULT(0xC00D1163_u32 as _);
pub const NS_E_DVD_DEVICE_CONTENTION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1170_u32 as _);
pub const NS_E_DVD_DISC_COPY_PROTECT_OUTPUT_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1161_u32 as _);
pub const NS_E_DVD_DISC_COPY_PROTECT_OUTPUT_NS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1160_u32 as _);
pub const NS_E_DVD_DISC_DECODER_REGION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1169_u32 as _);
pub const NS_E_DVD_GRAPH_BUILDING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D116C_u32 as _);
pub const NS_E_DVD_INVALID_DISC_REGION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1165_u32 as _);
pub const NS_E_DVD_INVALID_TITLE_CHAPTER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1174_u32 as _);
pub const NS_E_DVD_MACROVISION: windows_core::HRESULT = windows_core::HRESULT(0xC00D1167_u32 as _);
pub const NS_E_DVD_NO_AUDIO_STREAM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D116B_u32 as _);
pub const NS_E_DVD_NO_DECODER: windows_core::HRESULT = windows_core::HRESULT(0xC00D116D_u32 as _);
pub const NS_E_DVD_NO_SUBPICTURE_STREAM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1162_u32 as _);
pub const NS_E_DVD_NO_VIDEO_MEMORY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1171_u32 as _);
pub const NS_E_DVD_NO_VIDEO_STREAM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D116A_u32 as _);
pub const NS_E_DVD_PARENTAL: windows_core::HRESULT = windows_core::HRESULT(0xC00D116E_u32 as _);
pub const NS_E_DVD_REQUIRED_PROPERTY_NOT_SET: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1173_u32 as _);
pub const NS_E_DVD_SYSTEM_DECODER_REGION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1168_u32 as _);
pub const NS_E_EDL_REQUIRED_FOR_DEVICE_MULTIPASS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BE7_u32 as _);
pub const NS_E_EMPTY_PLAYLIST: windows_core::HRESULT = windows_core::HRESULT(0xC00D14B5_u32 as _);
pub const NS_E_EMPTY_PROGRAM_NAME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D00D6_u32 as _);
...
pub const NS_E_EXCEED_MAX_DRM_PROFILE_LIMIT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BE0_u32 as _);
pub const NS_E_EXPECT_MONO_WAV_INPUT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BA1_u32 as _);
pub const NS_E_FAILED_DOWNLOAD_ABORT_BURN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10DC_u32 as _);
pub const NS_E_FAIL_LAUNCH_ROXIO_PLUGIN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1180_u32 as _);
pub const NS_E_FEATURE_DISABLED_BY_GROUP_POLICY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BDC_u32 as _);
pub const NS_E_FEATURE_DISABLED_IN_SKU: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BDD_u32 as _);
pub const NS_E_FEATURE_REQUIRES_ENTERPRISE_SERVER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1583_u32 as _);
pub const NS_E_FILE_ALLOCATION_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D001E_u32 as _);
pub const NS_E_FILE_BANDWIDTH_LIMIT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0030_u32 as _);
pub const NS_E_FILE_EXISTS: windows_core::HRESULT = windows_core::HRESULT(0xC00D001B_u32 as _);
pub const NS_E_FILE_FAILED_CHECKS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FCD_u32 as _);
...
pub const NS_E_FLASH_PLAYBACK_NOT_ALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10CF_u32 as _);
pub const NS_E_GLITCH_MODE: windows_core::HRESULT = windows_core::HRESULT(0xC00D0195_u32 as _);
pub const NS_E_GRAPH_NOAUDIOLANGUAGE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10C5_u32 as _);
pub const NS_E_GRAPH_NOAUDIOLANGUAGESELECTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10C6_u32 as _);
...
pub const NS_E_HTTP_TEXT_DATACONTAINER_INVALID_SERVER_RESPONSE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D158C_u32 as _);
pub const NS_E_HTTP_TEXT_DATACONTAINER_SIZE_LIMIT_EXCEEDED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1589_u32 as _);
pub const NS_E_ICMQUERYFORMAT: windows_core::HRESULT = windows_core::HRESULT(0xC00D1B6C_u32 as _);
pub const NS_E_IE_DISALLOWS_ACTIVEX_CONTROLS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10CE_u32 as _);
pub const NS_E_IMAGE_DOWNLOAD_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D128E_u32 as _);
pub const NS_E_IMAPI_LOSSOFSTREAMING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D117E_u32 as _);
pub const NS_E_IMAPI_MEDIUM_INVALIDTYPE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1182_u32 as _);
pub const NS_E_INCOMPATIBLE_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0041_u32 as _);
pub const NS_E_INCOMPATIBLE_PUSH_SERVER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2F0C_u32 as _);
pub const NS_E_INCOMPATIBLE_SERVER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EE8_u32 as _);
pub const NS_E_INCOMPATIBLE_VERSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BC7_u32 as _);
pub const NS_E_INCOMPLETE_PLAYLIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1242_u32 as _);
pub const NS_E_INCORRECTCLIPSETTINGS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B7C_u32 as _);
pub const NS_E_INDUCED: windows_core::HRESULT = windows_core::HRESULT(0xC00D0022_u32 as _);
pub const NS_E_INPUTSOURCE_PROBLEM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B8A_u32 as _);
pub const NS_E_INPUT_DOESNOT_SUPPORT_SMPTE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BA8_u32 as _);
pub const NS_E_INPUT_WAVFORMAT_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BA2_u32 as _);
pub const NS_E_INSUFFICIENT_BANDWIDTH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D002C_u32 as _);
pub const NS_E_INSUFFICIENT_DATA: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D00CA_u32 as _);
pub const NS_E_INTERFACE_NOT_REGISTERED_IN_GIT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D126A_u32 as _);
pub const NS_E_INTERLACEMODE_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BAB_u32 as _);
pub const NS_E_INTERLACE_REQUIRE_SAMESIZE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B95_u32 as _);
pub const NS_E_INTERNAL: windows_core::HRESULT = windows_core::HRESULT(0xC00D0024_u32 as _);
pub const NS_E_INTERNAL_SERVER_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EE2_u32 as _);
pub const NS_E_INVALIDCALL_WHILE_ARCHIVAL_RUNNING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B74_u32 as _);
pub const NS_E_INVALIDCALL_WHILE_ENCODER_RUNNING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B66_u32 as _);
pub const NS_E_INVALIDCALL_WHILE_ENCODER_STOPPED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B7F_u32 as _);
pub const NS_E_INVALIDINPUTFPS: windows_core::HRESULT = windows_core::HRESULT(0xC00D1B81_u32 as _);
pub const NS_E_INVALIDPACKETSIZE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B75_u32 as _);
...
pub const NS_E_INVALID_AUDIO_BUFFERMAX: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BBC_u32 as _);
pub const NS_E_INVALID_AUDIO_PEAKRATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BBA_u32 as _);
pub const NS_E_INVALID_AUDIO_PEAKRATE_2: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BBB_u32 as _);
pub const NS_E_INVALID_BLACKHOLE_ADDRESS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0040_u32 as _);
...
pub const NS_E_INVALID_DRMV2CLT_STUBLIB: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2790_u32 as _);
pub const NS_E_INVALID_EDL: windows_core::HRESULT = windows_core::HRESULT(0xC00D0BD8_u32 as _);
pub const NS_E_INVALID_FILE_BITRATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BD1_u32 as _);
pub const NS_E_INVALID_FOLDDOWN_COEFFICIENTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BD4_u32 as _);
...
pub const NS_E_INVALID_INPUT_AUDIENCE_INDEX: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B9E_u32 as _);
pub const NS_E_INVALID_INPUT_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BB8_u32 as _);
pub const NS_E_INVALID_INPUT_LANGUAGE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B9F_u32 as _);
pub const NS_E_INVALID_INPUT_STREAM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BA0_u32 as _);
pub const NS_E_INVALID_INTERLACEMODE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BDB_u32 as _);
pub const NS_E_INVALID_INTERLACE_COMPAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BDC_u32 as _);
...
pub const NS_E_INVALID_MTU_RANGE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1586_u32 as _);
pub const NS_E_INVALID_NAME: windows_core::HRESULT = windows_core::HRESULT(0xC00D001C_u32 as _);
pub const NS_E_INVALID_NONSQUAREPIXEL_COMPAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BDD_u32 as _);
pub const NS_E_INVALID_NUM_PASSES: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BD5_u32 as _);
pub const NS_E_INVALID_OPERATING_SYSTEM_VERSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1459_u32 as _);
pub const NS_E_INVALID_OUTPUT_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BBB_u32 as _);
pub const NS_E_INVALID_PIXEL_ASPECT_RATIO: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BE2_u32 as _);
pub const NS_E_INVALID_PLAY_STATISTICS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1587_u32 as _);
pub const NS_E_INVALID_PLUGIN_LOAD_TYPE_CONFIGURATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1454_u32 as _);
pub const NS_E_INVALID_PORT: windows_core::HRESULT = windows_core::HRESULT(0xC00D0043_u32 as _);
pub const NS_E_INVALID_PROFILE_CONTENTTYPE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BE4_u32 as _);
pub const NS_E_INVALID_PUBLISHING_POINT_NAME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1455_u32 as _);
pub const NS_E_INVALID_PUSH_PUBLISHING_POINT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D151B_u32 as _);
pub const NS_E_INVALID_PUSH_PUBLISHING_POINT_START_REQUEST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D145B_u32 as _);
pub const NS_E_INVALID_PUSH_TEMPLATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D151A_u32 as _);
pub const NS_E_INVALID_QUERY_OPERATOR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32CF_u32 as _);
pub const NS_E_INVALID_QUERY_PROPERTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32D0_u32 as _);
...
pub const NS_E_INVALID_SAMPLING_RATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BD0_u32 as _);
pub const NS_E_INVALID_SCRIPT_BITRATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BCF_u32 as _);
pub const NS_E_INVALID_SOURCE_WITH_DEVICE_CONTROL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BDE_u32 as _);
...
pub const NS_E_INVALID_VBR_COMPAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BB2_u32 as _);
pub const NS_E_INVALID_VBR_WITH_UNCOMP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BB4_u32 as _);
pub const NS_E_INVALID_VIDEO_BITRATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BBF_u32 as _);
pub const NS_E_INVALID_VIDEO_BUFFER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BC9_u32 as _);
pub const NS_E_INVALID_VIDEO_BUFFERMAX: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BCA_u32 as _);
pub const NS_E_INVALID_VIDEO_BUFFERMAX_2: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BCB_u32 as _);
pub const NS_E_INVALID_VIDEO_CQUALITY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BC8_u32 as _);
pub const NS_E_INVALID_VIDEO_FPS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BC5_u32 as _);
pub const NS_E_INVALID_VIDEO_HEIGHT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BC4_u32 as _);
pub const NS_E_INVALID_VIDEO_HEIGHT_ALIGN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BCD_u32 as _);
pub const NS_E_INVALID_VIDEO_IQUALITY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BC7_u32 as _);
pub const NS_E_INVALID_VIDEO_KEYFRAME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BC6_u32 as _);
pub const NS_E_INVALID_VIDEO_PEAKRATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BC1_u32 as _);
pub const NS_E_INVALID_VIDEO_PEAKRATE_2: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BC2_u32 as _);
pub const NS_E_INVALID_VIDEO_WIDTH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BC3_u32 as _);
pub const NS_E_INVALID_VIDEO_WIDTH_ALIGN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BCC_u32 as _);
pub const NS_E_INVALID_VIDEO_WIDTH_FOR_INTERLACED_ENCODING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BE8_u32 as _);
pub const NS_E_LANGUAGE_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B9C_u32 as _);
...
pub const NS_E_LICENSE_HEADER_MISSING_URL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D277A_u32 as _);
pub const NS_E_LICENSE_INCORRECT_RIGHTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BC1_u32 as _);
pub const NS_E_LICENSE_OUTOFDATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BC0_u32 as _);
...
pub const NS_E_LOG_NEED_TO_BE_SKIPPED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1588_u32 as _);
pub const NS_E_MARKIN_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BE9_u32 as _);
...
pub const NS_E_MAX_FUNNELS_ALERT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0060_u32 as _);
pub const NS_E_MAX_PACKET_SIZE_TOO_SMALL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BD1_u32 as _);
pub const NS_E_MEDIACD_READ_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10CD_u32 as _);
pub const NS_E_MEDIA_LIBRARY_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FCE_u32 as _);
pub const NS_E_MEDIA_PARSER_INVALID_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1581_u32 as _);
pub const NS_E_MEMSTORAGE_BAD_DATA: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D117B_u32 as _);
pub const NS_E_METADATA_CACHE_DATA_NOT_AVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32DB_u32 as _);
pub const NS_E_METADATA_CANNOT_RETRIEVE_FROM_OFFLINE_CACHE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32DE_u32 as _);
pub const NS_E_METADATA_CANNOT_SET_LOCALE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32D7_u32 as _);
pub const NS_E_METADATA_FORMAT_NOT_SUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32D5_u32 as _);
pub const NS_E_METADATA_IDENTIFIER_NOT_AVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32DD_u32 as _);
pub const NS_E_METADATA_INVALID_DOCUMENT_TYPE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32DC_u32 as _);
pub const NS_E_METADATA_LANGUAGE_NOT_SUPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32D8_u32 as _);
pub const NS_E_METADATA_NOT_AVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32DA_u32 as _);
pub const NS_E_METADATA_NO_EDITING_CAPABILITY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32D6_u32 as _);
pub const NS_E_METADATA_NO_RFC1766_NAME_FOR_LOCALE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32D9_u32 as _);
pub const NS_E_MISMATCHED_MEDIACONTENT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B5F_u32 as _);
...
pub const NS_E_MISSING_SOURCE_INDEX: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B9A_u32 as _);
pub const NS_E_MIXER_INVALID_CONTROL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FA6_u32 as _);
pub const NS_E_MIXER_INVALID_LINE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FA5_u32 as _);
pub const NS_E_MIXER_INVALID_VALUE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FA7_u32 as _);
pub const NS_E_MIXER_NODRIVER: windows_core::HRESULT = windows_core::HRESULT(0xC00D0FAF_u32 as _);
pub const NS_E_MIXER_UNKNOWN_MMRESULT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FA8_u32 as _);
pub const NS_E_MLS_SMARTPLAYLIST_FILTER_NOT_REGISTERED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1075_u32 as _);
pub const NS_E_MMSAUTOSERVER_CANTFINDWALKER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0046_u32 as _);
pub const NS_E_MMS_NOT_SUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EFA_u32 as _);
pub const NS_E_MONITOR_GIVEUP: windows_core::HRESULT = windows_core::HRESULT(0xC00D00C8_u32 as _);
pub const NS_E_MP3_FORMAT_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FAA_u32 as _);
pub const NS_E_MPDB_GENERIC: windows_core::HRESULT = windows_core::HRESULT(0xC00D0FCC_u32 as _);
pub const NS_E_MSAUDIO_NOT_INSTALLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BB9_u32 as _);
pub const NS_E_MSBD_NO_LONGER_SUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EEC_u32 as _);
pub const NS_E_MULTICAST_DISABLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EE9_u32 as _);
pub const NS_E_MULTICAST_PLUGIN_NOT_ENABLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1458_u32 as _);
pub const NS_E_MULTIPLE_AUDIO_CODECS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BB7_u32 as _);
pub const NS_E_MULTIPLE_AUDIO_FORMATS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BB8_u32 as _);
pub const NS_E_MULTIPLE_FILE_BITRATES: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BD0_u32 as _);
pub const NS_E_MULTIPLE_SCRIPT_BITRATES: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BCE_u32 as _);
pub const NS_E_MULTIPLE_VBR_AUDIENCES: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BB5_u32 as _);
pub const NS_E_MULTIPLE_VIDEO_CODECS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BBD_u32 as _);
pub const NS_E_MULTIPLE_VIDEO_SIZES: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BBE_u32 as _);
pub const NS_E_NAMESPACE_BAD_NAME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1396_u32 as _);
pub const NS_E_NAMESPACE_BUFFER_TOO_SMALL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D138E_u32 as _);
pub const NS_E_NAMESPACE_CALLBACK_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1391_u32 as _);
pub const NS_E_NAMESPACE_DUPLICATE_CALLBACK: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1390_u32 as _);
pub const NS_E_NAMESPACE_DUPLICATE_NAME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1393_u32 as _);
pub const NS_E_NAMESPACE_EMPTY_NAME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1394_u32 as _);
pub const NS_E_NAMESPACE_INDEX_TOO_LARGE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1395_u32 as _);
pub const NS_E_NAMESPACE_NAME_TOO_LONG: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1392_u32 as _);
pub const NS_E_NAMESPACE_NODE_CONFLICT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D138C_u32 as _);
pub const NS_E_NAMESPACE_NODE_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D138D_u32 as _);
pub const NS_E_NAMESPACE_TOO_MANY_CALLBACKS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D138F_u32 as _);
pub const NS_E_NAMESPACE_WRONG_PERSIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D138A_u32 as _);
pub const NS_E_NAMESPACE_WRONG_SECURITY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1397_u32 as _);
pub const NS_E_NAMESPACE_WRONG_TYPE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D138B_u32 as _);
pub const NS_E_NEED_CORE_REFERENCE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10CC_u32 as _);
...
pub const NS_E_NETWORK_RESOURCE_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0028_u32 as _);
pub const NS_E_NETWORK_SERVICE_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0027_u32 as _);
pub const NS_E_NETWORK_SINK_WRITE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EF8_u32 as _);
...
pub const NS_E_NOMATCHING_ELEMENT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B5E_u32 as _);
pub const NS_E_NOMATCHING_MEDIASOURCE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B5A_u32 as _);
pub const NS_E_NONSQUAREPIXELMODE_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BAC_u32 as _);
pub const NS_E_NOREGISTEREDWALKER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D000B_u32 as _);
...
pub const NS_E_NOT_CONTENT_PARTNER_TRACK: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D135A_u32 as _);
...
pub const NS_E_NO_ACTIVE_SOURCEGROUP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B72_u32 as _);
...
pub const NS_E_NO_AUDIO_TIMECOMPRESSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BD7_u32 as _);
...
pub const NS_E_NO_DATAVIEW_SUPPORT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B82_u32 as _);
pub const NS_E_NO_DEVICE: windows_core::HRESULT = windows_core::HRESULT(0xC00D0071_u32 as _);
pub const NS_E_NO_ERROR_STRING_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FD0_u32 as _);
pub const NS_E_NO_EXISTING_PACKETIZER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EFD_u32 as _);
pub const NS_E_NO_FORMATS: windows_core::HRESULT = windows_core::HRESULT(0xC00D006B_u32 as _);
pub const NS_E_NO_FRAMES_SUBMITTED_TO_ANALYZER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BA7_u32 as _);
pub const NS_E_NO_LOCALPLAY: windows_core::HRESULT = windows_core::HRESULT(0xC00D000D_u32 as _);
pub const NS_E_NO_MBR_WITH_TIMECODE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BDA_u32 as _);
pub const NS_E_NO_MEDIAFORMAT_IN_SOURCE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B6F_u32 as _);
pub const NS_E_NO_MEDIA_IN_AUDIENCE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BAF_u32 as _);
pub const NS_E_NO_MEDIA_PROTOCOL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D019B_u32 as _);
...
pub const NS_E_NO_MULTIPASS_FOR_LIVEDEVICE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B97_u32 as _);
pub const NS_E_NO_NEW_CONNECTIONS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D151D_u32 as _);
pub const NS_E_NO_PAL_INVERSE_TELECINE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BA4_u32 as _);
pub const NS_E_NO_PDA: windows_core::HRESULT = windows_core::HRESULT(0xC00D1179_u32 as _);
pub const NS_E_NO_PROFILE_IN_SOURCEGROUP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B67_u32 as _);
pub const NS_E_NO_PROFILE_NAME: windows_core::HRESULT = windows_core::HRESULT(0xC00D1BB3_u32 as _);
pub const NS_E_NO_REALTIME_PREPROCESS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B8C_u32 as _);
pub const NS_E_NO_REALTIME_TIMECOMPRESSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B86_u32 as _);
pub const NS_E_NO_REFERENCES: windows_core::HRESULT = windows_core::HRESULT(0xC00D006C_u32 as _);
pub const NS_E_NO_REPEAT_PREPROCESS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B8D_u32 as _);
...
pub const NS_E_NO_SERVER_CONTACT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D00CE_u32 as _);
pub const NS_E_NO_SMPTE_WITH_MULTIPLE_SOURCEGROUPS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BA9_u32 as _);
pub const NS_E_NO_SPECIFIED_DEVICE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0072_u32 as _);
pub const NS_E_NO_STREAM: windows_core::HRESULT = windows_core::HRESULT(0xC00D0033_u32 as _);
pub const NS_E_NO_TWOPASS_TIMECOMPRESSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BD8_u32 as _);
pub const NS_E_NO_VALID_OUTPUT_STREAM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B70_u32 as _);
pub const NS_E_NO_VALID_SOURCE_PLUGIN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B71_u32 as _);
pub const NS_E_NUM_LANGUAGE_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B9B_u32 as _);
pub const NS_E_OFFLINE_MODE: windows_core::HRESULT = windows_core::HRESULT(0xC00D0BCA_u32 as _);
pub const NS_E_OPEN_CONTAINING_FOLDER_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1363_u32 as _);
pub const NS_E_OPEN_FILE_LIMIT: windows_core::HRESULT = windows_core::HRESULT(0xC00D0031_u32 as _);
pub const NS_E_OUTPUT_PROTECTION_LEVEL_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2904_u32 as _);
pub const NS_E_OUTPUT_PROTECTION_SCHEME_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D290A_u32 as _);
pub const NS_E_PACKETSINK_UNKNOWN_FEC_STREAM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2F0A_u32 as _);
pub const NS_E_PAGING_ERROR: windows_core::HRESULT = windows_core::HRESULT(0xC00D0062_u32 as _);
pub const NS_E_PARTIALLY_REBUILT_DISK: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0067_u32 as _);
pub const NS_E_PDA_CANNOT_CREATE_ADDITIONAL_SYNC_RELATIONSHIP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1185_u32 as _);
pub const NS_E_PDA_CANNOT_SYNC_FROM_INTERNET: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1234_u32 as _);
pub const NS_E_PDA_CANNOT_SYNC_FROM_LOCATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1193_u32 as _);
pub const NS_E_PDA_CANNOT_SYNC_INVALID_PLAYLIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1235_u32 as _);
pub const NS_E_PDA_CANNOT_TRANSCODE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1189_u32 as _);
pub const NS_E_PDA_CANNOT_TRANSCODE_TO_AUDIO: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D123D_u32 as _);
pub const NS_E_PDA_CANNOT_TRANSCODE_TO_IMAGE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D123F_u32 as _);
pub const NS_E_PDA_CANNOT_TRANSCODE_TO_VIDEO: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D123E_u32 as _);
pub const NS_E_PDA_CEWMDM_DRM_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1241_u32 as _);
pub const NS_E_PDA_DELETE_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1238_u32 as _);
pub const NS_E_PDA_DEVICESUPPORTDISABLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1190_u32 as _);
pub const NS_E_PDA_DEVICE_FULL: windows_core::HRESULT = windows_core::HRESULT(0xC00D117F_u32 as _);
pub const NS_E_PDA_DEVICE_FULL_IN_SESSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1181_u32 as _);
pub const NS_E_PDA_DEVICE_NOT_RESPONDING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D123A_u32 as _);
pub const NS_E_PDA_ENCODER_NOT_RESPONDING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1192_u32 as _);
pub const NS_E_PDA_FAILED_TO_BURN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10DA_u32 as _);
pub const NS_E_PDA_FAILED_TO_ENCRYPT_TRANSCODED_FILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D123C_u32 as _);
pub const NS_E_PDA_FAILED_TO_RETRIEVE_FILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1239_u32 as _);
pub const NS_E_PDA_FAILED_TO_SYNCHRONIZE_FILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1236_u32 as _);
pub const NS_E_PDA_FAILED_TO_TRANSCODE_PHOTO: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D123B_u32 as _);
pub const NS_E_PDA_FAIL_READ_WAVE_FILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D117D_u32 as _);
pub const NS_E_PDA_FAIL_SELECT_DEVICE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D117C_u32 as _);
pub const NS_E_PDA_INITIALIZINGDEVICES: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D118D_u32 as _);
pub const NS_E_PDA_MANUALDEVICE: windows_core::HRESULT = windows_core::HRESULT(0xC00D1183_u32 as _);
pub const NS_E_PDA_NO_LONGER_AVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1191_u32 as _);
pub const NS_E_PDA_NO_TRANSCODE_OF_DRM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1186_u32 as _);
pub const NS_E_PDA_OBSOLETE_SP: windows_core::HRESULT = windows_core::HRESULT(0xC00D118E_u32 as _);
pub const NS_E_PDA_PARTNERSHIPNOTEXIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1184_u32 as _);
pub const NS_E_PDA_RETRIEVED_FILE_FILENAME_TOO_LONG: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1240_u32 as _);
pub const NS_E_PDA_SYNC_FAILED: windows_core::HRESULT = windows_core::HRESULT(0xC00D1237_u32 as _);
pub const NS_E_PDA_SYNC_LOGIN_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1244_u32 as _);
pub const NS_E_PDA_SYNC_RUNNING: windows_core::HRESULT = windows_core::HRESULT(0xC00D1243_u32 as _);
pub const NS_E_PDA_TITLE_COLLISION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D118F_u32 as _);
pub const NS_E_PDA_TOO_MANY_FILES_IN_DIRECTORY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D118A_u32 as _);
pub const NS_E_PDA_TOO_MANY_FILE_COLLISIONS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1188_u32 as _);
pub const NS_E_PDA_TRANSCODECACHEFULL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1187_u32 as _);
pub const NS_E_PDA_TRANSCODE_CODEC_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1245_u32 as _);
pub const NS_E_PDA_TRANSCODE_NOT_PERMITTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D118C_u32 as _);
pub const NS_E_PDA_UNSPECIFIED_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D117A_u32 as _);
pub const NS_E_PDA_UNSUPPORTED_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1178_u32 as _);
pub const NS_E_PLAYLIST_CONTAINS_ERRORS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10BF_u32 as _);
pub const NS_E_PLAYLIST_END_RECEDING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D14BD_u32 as _);
pub const NS_E_PLAYLIST_ENTRY_ALREADY_PLAYING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D14B4_u32 as _);
pub const NS_E_PLAYLIST_ENTRY_HAS_CHANGED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EF5_u32 as _);
pub const NS_E_PLAYLIST_ENTRY_NOT_IN_PLAYLIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D14B8_u32 as _);
pub const NS_E_PLAYLIST_ENTRY_SEEK: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D14B9_u32 as _);
pub const NS_E_PLAYLIST_PARSE_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D14B6_u32 as _);
pub const NS_E_PLAYLIST_PLUGIN_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D157F_u32 as _);
pub const NS_E_PLAYLIST_RECURSIVE_PLAYLISTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D14BA_u32 as _);
pub const NS_E_PLAYLIST_SHUTDOWN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D14BC_u32 as _);
pub const NS_E_PLAYLIST_TOO_MANY_NESTED_PLAYLISTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D14BB_u32 as _);
pub const NS_E_PLAYLIST_UNSUPPORTED_ENTRY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D14B7_u32 as _);
pub const NS_E_PLUGIN_CLSID_INVALID: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B76_u32 as _);
pub const NS_E_PLUGIN_ERROR_REPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D157D_u32 as _);
pub const NS_E_PLUGIN_NOTSHUTDOWN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FD6_u32 as _);
...
pub const NS_E_PROCESSINGSHOWSYNCWIZARD: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D118B_u32 as _);
pub const NS_E_PROFILE_MISMATCH: windows_core::HRESULT = windows_core::HRESULT(0xC00D1B7B_u32 as _);
pub const NS_E_PROPERTY_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32CA_u32 as _);
pub const NS_E_PROPERTY_NOT_SUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32D2_u32 as _);
pub const NS_E_PROPERTY_READ_ONLY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32CC_u32 as _);
pub const NS_E_PROTECTED_CONTENT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BBD_u32 as _);
pub const NS_E_PROTOCOL_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0012_u32 as _);
pub const NS_E_PROXY_ACCESSDENIED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EF6_u32 as _);
pub const NS_E_PROXY_CONNECT_TIMEOUT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2F07_u32 as _);
pub const NS_E_PROXY_DNS_TIMEOUT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EF0_u32 as _);
pub const NS_E_PROXY_NOT_FOUND: windows_core::HRESULT = windows_core::HRESULT(0xC00D2EED_u32 as _);
pub const NS_E_PROXY_SOURCE_ACCESSDENIED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EF7_u32 as _);
pub const NS_E_PROXY_TIMEOUT: windows_core::HRESULT = windows_core::HRESULT(0xC00D2EE5_u32 as _);
pub const NS_E_PUBLISHING_POINT_INVALID_REQUEST_WHILE_STARTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1457_u32 as _);
pub const NS_E_PUBLISHING_POINT_REMOVED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D145A_u32 as _);
pub const NS_E_PUBLISHING_POINT_STOPPED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D145E_u32 as _);
pub const NS_E_PUSH_CANNOTCONNECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2F0B_u32 as _);
pub const NS_E_PUSH_DUPLICATE_PUBLISHING_POINT_NAME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1520_u32 as _);
pub const NS_E_REBOOT_RECOMMENDED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2AFA_u32 as _);
pub const NS_E_REBOOT_REQUIRED: windows_core::HRESULT = windows_core::HRESULT(0xC00D2AFB_u32 as _);
pub const NS_E_RECORDQ_DISK_FULL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BA3_u32 as _);
pub const NS_E_REDBOOK_ENABLED_WHILE_COPYING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FB0_u32 as _);
pub const NS_E_REDIRECT: windows_core::HRESULT = windows_core::HRESULT(0xC00D1388_u32 as _);
pub const NS_E_REDIRECT_TO_PROXY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EE1_u32 as _);
pub const NS_E_REFUSED_BY_SERVER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EE7_u32 as _);
pub const NS_E_REG_FLUSH_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2798_u32 as _);
pub const NS_E_REMIRRORED_DISK: windows_core::HRESULT = windows_core::HRESULT(0xC00D00C9_u32 as _);
pub const NS_E_REQUIRE_STREAMING_CLIENT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EF4_u32 as _);
pub const NS_E_RESET_SOCKET_CONNECTION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2F00_u32 as _);
pub const NS_E_RESOURCE_GONE: windows_core::HRESULT = windows_core::HRESULT(0xC00D2EFC_u32 as _);
pub const NS_E_SAME_AS_INPUT_COMBINATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BD2_u32 as _);
pub const NS_E_SCHEMA_CLASSIFY_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32D4_u32 as _);
pub const NS_E_SCRIPT_DEBUGGER_NOT_INSTALLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1582_u32 as _);
pub const NS_E_SDK_BUFFERTOOSMALL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BD4_u32 as _);
pub const NS_E_SERVER_ACCESSDENIED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EFB_u32 as _);
pub const NS_E_SERVER_DNS_TIMEOUT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EEF_u32 as _);
pub const NS_E_SERVER_NOT_FOUND: windows_core::HRESULT = windows_core::HRESULT(0xC00D0035_u32 as _);
pub const NS_E_SERVER_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EE6_u32 as _);
pub const NS_E_SESSION_INVALID: windows_core::HRESULT = windows_core::HRESULT(0xC00D2F08_u32 as _);
pub const NS_E_SESSION_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2EF3_u32 as _);
pub const NS_E_SETUP_BLOCKED: windows_core::HRESULT = windows_core::HRESULT(0xC00D2B00_u32 as _);
pub const NS_E_SETUP_DRM_MIGRATION_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2AFD_u32 as _);
pub const NS_E_SETUP_DRM_MIGRATION_FAILED_AND_IGNORABLE_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2AFF_u32 as _);
pub const NS_E_SETUP_IGNORABLE_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2AFE_u32 as _);
pub const NS_E_SETUP_INCOMPLETE: windows_core::HRESULT = windows_core::HRESULT(0xC00D2AFC_u32 as _);
pub const NS_E_SET_DISK_UID_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0021_u32 as _);
pub const NS_E_SHARING_STATE_OUT_OF_SYNC: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FF4_u32 as _);
pub const NS_E_SHARING_VIOLATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FCF_u32 as _);
pub const NS_E_SHUTDOWN: windows_core::HRESULT = windows_core::HRESULT(0xC00D002A_u32 as _);
pub const NS_E_SLOW_READ_DIGITAL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FA4_u32 as _);
pub const NS_E_SLOW_READ_DIGITAL_WITH_ERRORCORRECTION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11FD_u32 as _);
pub const NS_E_SMPTEMODE_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BAD_u32 as _);
pub const NS_E_SOURCEGROUP_NOTPREPARED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B7A_u32 as _);
pub const NS_E_SOURCE_CANNOT_LOOP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BD3_u32 as _);
pub const NS_E_SOURCE_NOTSPECIFIED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B85_u32 as _);
pub const NS_E_SOURCE_PLUGIN_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D157E_u32 as _);
pub const NS_E_SPEECHEDL_ON_NON_MIXEDMODE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B92_u32 as _);
pub const NS_E_STALE_PRESENTATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1389_u32 as _);
...
pub const NS_E_SUBSCRIPTIONSERVICE_DOWNLOAD_TIMEOUT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1360_u32 as _);
pub const NS_E_SUBSCRIPTIONSERVICE_LOGIN_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D135F_u32 as _);
pub const NS_E_SUBSCRIPTIONSERVICE_PLAYBACK_DISALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1356_u32 as _);
pub const NS_E_SYNCWIZ_CANNOT_CHANGE_SETTINGS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11EF_u32 as _);
pub const NS_E_SYNCWIZ_DEVICE_FULL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11EE_u32 as _);
pub const NS_E_TABLE_KEY_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D32CD_u32 as _);
...
pub const NS_E_TIMECODE_REQUIRES_VIDEOSTREAM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BD9_u32 as _);
...
pub const NS_E_TITLE_SIZE_EXCEEDED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D00D0_u32 as _);
pub const NS_E_TOO_MANY_AUDIO: windows_core::HRESULT = windows_core::HRESULT(0xC00D1B5C_u32 as _);
pub const NS_E_TOO_MANY_DEVICECONTROL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B96_u32 as _);
pub const NS_E_TOO_MANY_HOPS: windows_core::HRESULT = windows_core::HRESULT(0xC00D2F02_u32 as _);
pub const NS_E_TOO_MANY_MULTICAST_SINKS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1456_u32 as _);
...
pub const NS_E_TOO_MUCH_DATA_FROM_SERVER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2F05_u32 as _);
pub const NS_E_TRACK_DOWNLOAD_REQUIRES_ALBUM_PURCHASE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D135B_u32 as _);
pub const NS_E_TRACK_DOWNLOAD_REQUIRES_PURCHASE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D135C_u32 as _);
pub const NS_E_TRACK_PURCHASE_MAXIMUM_EXCEEDED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D135D_u32 as _);
pub const NS_E_TRANSCODE_DELETECACHEERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11F0_u32 as _);
pub const NS_E_TRANSFORM_PLUGIN_INVALID: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BE6_u32 as _);
pub const NS_E_TRANSFORM_PLUGIN_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BE5_u32 as _);
pub const NS_E_UDP_DISABLED: windows_core::HRESULT = windows_core::HRESULT(0xC00D00D1_u32 as _);
pub const NS_E_UNABLE_TO_CREATE_RIP_LOCATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10D0_u32 as _);
pub const NS_E_UNCOMPRESSED_DIGITAL_AUDIO_PROTECTION_LEVEL_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2909_u32 as _);
pub const NS_E_UNCOMPRESSED_DIGITAL_VIDEO_PROTECTION_LEVEL_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D2906_u32 as _);
pub const NS_E_UNCOMP_COMP_COMBINATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BB6_u32 as _);
pub const NS_E_UNEXPECTED_DISPLAY_SETTINGS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B88_u32 as _);
pub const NS_E_UNEXPECTED_MSAUDIO_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BBA_u32 as _);
pub const NS_E_UNKNOWN_PROTOCOL: windows_core::HRESULT = windows_core::HRESULT(0xC00D2EE0_u32 as _);
pub const NS_E_UNRECOGNIZED_STREAM_TYPE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0026_u32 as _);
pub const NS_E_UNSUPPORTED_ARCHIVEOPERATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B78_u32 as _);
pub const NS_E_UNSUPPORTED_ARCHIVETYPE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B77_u32 as _);
pub const NS_E_UNSUPPORTED_ENCODER_DEVICE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B87_u32 as _);
pub const NS_E_UNSUPPORTED_LANGUAGE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D145C_u32 as _);
pub const NS_E_UNSUPPORTED_LOAD_TYPE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1453_u32 as _);
pub const NS_E_UNSUPPORTED_PROPERTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BCD_u32 as _);
pub const NS_E_UNSUPPORTED_SOURCETYPE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B5B_u32 as _);
pub const NS_E_URLLIST_INVALIDFORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D106D_u32 as _);
...
pub const NS_E_VIDCAPCREATEWINDOW: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B6D_u32 as _);
pub const NS_E_VIDCAPDRVINUSE: windows_core::HRESULT = windows_core::HRESULT(0xC00D1B6E_u32 as _);
pub const NS_E_VIDCAPSTARTFAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B69_u32 as _);
pub const NS_E_VIDEODEVICE_BUSY: windows_core::HRESULT = windows_core::HRESULT(0xC00D1B64_u32 as _);
pub const NS_E_VIDEODEVICE_UNEXPECTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B65_u32 as _);
pub const NS_E_VIDEODRIVER_UNSTABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B68_u32 as _);
pub const NS_E_VIDEO_BITRATE_STEPDOWN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1BC0_u32 as _);
pub const NS_E_VIDEO_CODEC_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BC5_u32 as _);
pub const NS_E_VIDEO_CODEC_NOT_INSTALLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0BC4_u32 as _);
pub const NS_E_VIDSOURCECOMPRESSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B6A_u32 as _);
...
pub const NS_E_WINSOCK_ERROR_STRING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1129_u32 as _);
...
pub const NS_E_WME_VERSION_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1B8B_u32 as _);
pub const NS_E_WMG_CANNOTQUEUE: windows_core::HRESULT = windows_core::HRESULT(0xC00D104C_u32 as _);
pub const NS_E_WMG_COPP_SECURITY_INVALID: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1052_u32 as _);
pub const NS_E_WMG_COPP_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1053_u32 as _);
pub const NS_E_WMG_FILETRANSFERNOTALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1058_u32 as _);
pub const NS_E_WMG_INVALIDSTATE: windows_core::HRESULT = windows_core::HRESULT(0xC00D1054_u32 as _);
pub const NS_E_WMG_INVALID_COPP_CERTIFICATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1051_u32 as _);
pub const NS_E_WMG_LICENSE_TAMPERED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1064_u32 as _);
pub const NS_E_WMG_NOSDKINTERFACE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1056_u32 as _);
pub const NS_E_WMG_NOTALLOUTPUTSRENDERED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1057_u32 as _);
pub const NS_E_WMG_PLUGINUNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D104B_u32 as _);
pub const NS_E_WMG_PREROLLLICENSEACQUISITIONNOTALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D104D_u32 as _);
pub const NS_E_WMG_RATEUNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D104A_u32 as _);
pub const NS_E_WMG_SINKALREADYEXISTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1055_u32 as _);
pub const NS_E_WMG_UNEXPECTEDPREROLLSTATUS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D104E_u32 as _);
pub const NS_E_WMPBR_BACKUPCANCEL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1131_u32 as _);
pub const NS_E_WMPBR_BACKUPRESTOREFAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1138_u32 as _);
pub const NS_E_WMPBR_DRIVE_INVALID: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1137_u32 as _);
pub const NS_E_WMPBR_ERRORWITHURL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1133_u32 as _);
pub const NS_E_WMPBR_NAMECOLLISION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1134_u32 as _);
pub const NS_E_WMPBR_NOLISTENER: windows_core::HRESULT = windows_core::HRESULT(0xC00D1130_u32 as _);
pub const NS_E_WMPBR_RESTORECANCEL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1132_u32 as _);
pub const NS_E_WMPCORE_BUFFERTOOSMALL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D107F_u32 as _);
pub const NS_E_WMPCORE_BUSY: windows_core::HRESULT = windows_core::HRESULT(0xC00D10B7_u32 as _);
pub const NS_E_WMPCORE_COCREATEFAILEDFORGITOBJECT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D107D_u32 as _);
pub const NS_E_WMPCORE_CODEC_DOWNLOAD_NOT_ALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D109C_u32 as _);
pub const NS_E_WMPCORE_CODEC_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D109B_u32 as _);
pub const NS_E_WMPCORE_CODEC_NOT_TRUSTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D109A_u32 as _);
pub const NS_E_WMPCORE_CURRENT_MEDIA_NOT_ACTIVE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10A9_u32 as _);
pub const NS_E_WMPCORE_DEVICE_DRIVERS_MISSING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10DD_u32 as _);
pub const NS_E_WMPCORE_ERRORMANAGERNOTAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D108D_u32 as _);
pub const NS_E_WMPCORE_ERRORSINKNOTREGISTERED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D108C_u32 as _);
pub const NS_E_WMPCORE_ERROR_DOWNLOADING_PLAYLIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D109D_u32 as _);
pub const NS_E_WMPCORE_FAILEDTOGETMARSHALLEDEVENTHANDLERINTERFACE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D107E_u32 as _);
pub const NS_E_WMPCORE_FAILED_TO_BUILD_PLAYLIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D109E_u32 as _);
pub const NS_E_WMPCORE_FILE_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10BA_u32 as _);
pub const NS_E_WMPCORE_GRAPH_NOT_IN_LIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D108A_u32 as _);
pub const NS_E_WMPCORE_INVALIDPLAYLISTMODE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1081_u32 as _);
pub const NS_E_WMPCORE_INVALID_PLAYLIST_URL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10AF_u32 as _);
pub const NS_E_WMPCORE_ITEMNOTINPLAYLIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1086_u32 as _);
pub const NS_E_WMPCORE_LIST_ENTRY_NO_REF: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1098_u32 as _);
pub const NS_E_WMPCORE_MEDIA_ALTERNATE_REF_EMPTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10A4_u32 as _);
pub const NS_E_WMPCORE_MEDIA_CHILD_PLAYLIST_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10B8_u32 as _);
pub const NS_E_WMPCORE_MEDIA_ERROR_RESUME_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D108F_u32 as _);
pub const NS_E_WMPCORE_MEDIA_NO_CHILD_PLAYLIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10B9_u32 as _);
pub const NS_E_WMPCORE_MEDIA_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10B3_u32 as _);
pub const NS_E_WMPCORE_MEDIA_URL_TOO_LONG: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10C8_u32 as _);
pub const NS_E_WMPCORE_MISMATCHED_RUNTIME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10B0_u32 as _);
pub const NS_E_WMPCORE_MISNAMED_FILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1099_u32 as _);
pub const NS_E_WMPCORE_NOBROWSER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1088_u32 as _);
pub const NS_E_WMPCORE_NOSOURCEURLSTRING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D107C_u32 as _);
pub const NS_E_WMPCORE_NO_PLAYABLE_MEDIA_IN_PLAYLIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10B5_u32 as _);
pub const NS_E_WMPCORE_NO_REF_IN_ENTRY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1090_u32 as _);
pub const NS_E_WMPCORE_PLAYLISTEMPTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1087_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_EMPTY_NESTED_PLAYLIST_SKIPPED_ITEMS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10B6_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_EMPTY_OR_SINGLE_MEDIA: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D108B_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_EVENT_ATTRIBUTE_ABSENT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10A6_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_EVENT_EMPTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10A7_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_IMPORT_FAILED_NO_ITEMS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10B1_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_ITEM_ALTERNATE_EXHAUSTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10A0_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_ITEM_ALTERNATE_INIT_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10A3_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_ITEM_ALTERNATE_MORPH_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10A2_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_ITEM_ALTERNATE_NAME_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10A1_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_ITEM_ALTERNATE_NONE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D109F_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_NO_EVENT_NAME: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10A5_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_REPEAT_EMPTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10AC_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_REPEAT_END_MEDIA_NONE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10AE_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_REPEAT_START_MEDIA_NONE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10AD_u32 as _);
pub const NS_E_WMPCORE_PLAYLIST_STACK_EMPTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10A8_u32 as _);
pub const NS_E_WMPCORE_SOME_CODECS_MISSING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10D1_u32 as _);
pub const NS_E_WMPCORE_TEMP_FILE_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10BB_u32 as _);
pub const NS_E_WMPCORE_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1080_u32 as _);
pub const NS_E_WMPCORE_UNRECOGNIZED_MEDIA_URL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1089_u32 as _);
pub const NS_E_WMPCORE_USER_CANCEL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10AB_u32 as _);
pub const NS_E_WMPCORE_VIDEO_TRANSFORM_FILTER_INSERTION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10B2_u32 as _);
pub const NS_E_WMPCORE_WEBHELPFAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D108E_u32 as _);
pub const NS_E_WMPCORE_WMX_ENTRYREF_NO_REF: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10B4_u32 as _);
pub const NS_E_WMPCORE_WMX_LIST_ATTRIBUTE_NAME_EMPTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1091_u32 as _);
pub const NS_E_WMPCORE_WMX_LIST_ATTRIBUTE_NAME_ILLEGAL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1092_u32 as _);
pub const NS_E_WMPCORE_WMX_LIST_ATTRIBUTE_VALUE_EMPTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1093_u32 as _);
pub const NS_E_WMPCORE_WMX_LIST_ATTRIBUTE_VALUE_ILLEGAL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1094_u32 as _);
pub const NS_E_WMPCORE_WMX_LIST_ITEM_ATTRIBUTE_NAME_EMPTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1095_u32 as _);
pub const NS_E_WMPCORE_WMX_LIST_ITEM_ATTRIBUTE_NAME_ILLEGAL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1096_u32 as _);
pub const NS_E_WMPCORE_WMX_LIST_ITEM_ATTRIBUTE_VALUE_EMPTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1097_u32 as _);
pub const NS_E_WMPFLASH_CANT_FIND_COM_SERVER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10C9_u32 as _);
pub const NS_E_WMPFLASH_INCOMPATIBLEVERSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10CA_u32 as _);
pub const NS_E_WMPIM_DIALUPFAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1128_u32 as _);
pub const NS_E_WMPIM_USERCANCELED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1127_u32 as _);
pub const NS_E_WMPIM_USEROFFLINE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1126_u32 as _);
pub const NS_E_WMPOCXGRAPH_IE_DISALLOWS_ACTIVEX_CONTROLS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10CB_u32 as _);
pub const NS_E_WMPOCX_ERRORMANAGERNOTAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FD5_u32 as _);
pub const NS_E_WMPOCX_NOT_RUNNING_REMOTELY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FD3_u32 as _);
pub const NS_E_WMPOCX_NO_ACTIVE_CORE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FD2_u32 as _);
pub const NS_E_WMPOCX_NO_REMOTE_CORE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FD1_u32 as _);
pub const NS_E_WMPOCX_NO_REMOTE_WINDOW: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FD4_u32 as _);
pub const NS_E_WMPOCX_PLAYER_NOT_DOCKED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FDB_u32 as _);
pub const NS_E_WMPOCX_REMOTE_PLAYER_ALREADY_RUNNING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FFA_u32 as _);
pub const NS_E_WMPOCX_UNABLE_TO_LOAD_SKIN: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FEB_u32 as _);
pub const NS_E_WMPXML_ATTRIBUTENOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FB7_u32 as _);
...
pub const NS_E_WMPXML_PARSEERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FB6_u32 as _);
pub const NS_E_WMPXML_PINOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FB8_u32 as _);
pub const NS_E_WMPZIP_CORRUPT: windows_core::HRESULT = windows_core::HRESULT(0xC00D1019_u32 as _);
pub const NS_E_WMPZIP_FILENOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D101A_u32 as _);
pub const NS_E_WMPZIP_NOTAZIPFILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1018_u32 as _);
pub const NS_E_WMP_ACCESS_DENIED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11D2_u32 as _);
pub const NS_E_WMP_ADDTOLIBRARY_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FC7_u32 as _);
pub const NS_E_WMP_ALREADY_IN_USE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D119E_u32 as _);
pub const NS_E_WMP_AUDIO_CODEC_NOT_INSTALLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11C7_u32 as _);
pub const NS_E_WMP_AUDIO_DEVICE_LOST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11E5_u32 as _);
pub const NS_E_WMP_AUDIO_HW_PROBLEM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11BA_u32 as _);
pub const NS_E_WMP_AUTOPLAY_INVALID_STATE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D12FC_u32 as _);
pub const NS_E_WMP_BAD_DRIVER: windows_core::HRESULT = windows_core::HRESULT(0xC00D11D1_u32 as _);
pub const NS_E_WMP_BMP_BITMAP_NOT_CREATED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1030_u32 as _);
pub const NS_E_WMP_BMP_COMPRESSION_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1031_u32 as _);
pub const NS_E_WMP_BMP_INVALID_BITMASK: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D102E_u32 as _);
pub const NS_E_WMP_BMP_INVALID_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1032_u32 as _);
pub const NS_E_WMP_BMP_TOPDOWN_DIB_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D102F_u32 as _);
pub const NS_E_WMP_BSTR_TOO_LONG: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D12F2_u32 as _);
pub const NS_E_WMP_BURN_DISC_OVERFLOW: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11D9_u32 as _);
pub const NS_E_WMP_CANNOT_BURN_NON_LOCAL_FILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10D6_u32 as _);
pub const NS_E_WMP_CANNOT_FIND_FILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1197_u32 as _);
pub const NS_E_WMP_CANNOT_FIND_FOLDER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FD7_u32 as _);
pub const NS_E_WMP_CANT_PLAY_PROTECTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FF3_u32 as _);
pub const NS_E_WMP_CD_ANOTHER_USER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11CF_u32 as _);
pub const NS_E_WMP_CD_STASH_NO_SPACE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11D5_u32 as _);
pub const NS_E_WMP_CODEC_NEEDED_WITH_4CC: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11A1_u32 as _);
pub const NS_E_WMP_CODEC_NEEDED_WITH_FORMATTAG: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11A2_u32 as _);
pub const NS_E_WMP_COMPONENT_REVOKED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1306_u32 as _);
pub const NS_E_WMP_CONNECT_TIMEOUT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11C1_u32 as _);
pub const NS_E_WMP_CONVERT_FILE_CORRUPT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D115B_u32 as _);
pub const NS_E_WMP_CONVERT_FILE_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1158_u32 as _);
pub const NS_E_WMP_CONVERT_NO_RIGHTS_ERRORURL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1159_u32 as _);
pub const NS_E_WMP_CONVERT_NO_RIGHTS_NOERRORURL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D115A_u32 as _);
pub const NS_E_WMP_CONVERT_PLUGIN_UNAVAILABLE_ERRORURL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D115C_u32 as _);
pub const NS_E_WMP_CONVERT_PLUGIN_UNAVAILABLE_NOERRORURL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D115D_u32 as _);
pub const NS_E_WMP_CONVERT_PLUGIN_UNKNOWN_FILE_OWNER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D115E_u32 as _);
pub const NS_E_WMP_CS_JPGPOSITIONIMAGE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D100E_u32 as _);
pub const NS_E_WMP_CS_NOTEVENLYDIVISIBLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D100F_u32 as _);
pub const NS_E_WMP_DAI_SONGTOOSHORT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1049_u32 as _);
pub const NS_E_WMP_DRM_ACQUIRING_LICENSE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1202_u32 as _);
pub const NS_E_WMP_DRM_CANNOT_RESTORE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11D8_u32 as _);
pub const NS_E_WMP_DRM_COMPONENT_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11E2_u32 as _);
pub const NS_E_WMP_DRM_CORRUPT_BACKUP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11B4_u32 as _);
pub const NS_E_WMP_DRM_DRIVER_AUTH_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11CA_u32 as _);
pub const NS_E_WMP_DRM_GENERIC_LICENSE_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11DA_u32 as _);
pub const NS_E_WMP_DRM_INDIV_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11DD_u32 as _);
pub const NS_E_WMP_DRM_INVALID_SIG: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11D7_u32 as _);
pub const NS_E_WMP_DRM_LICENSE_CONTENT_REVOKED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1207_u32 as _);
pub const NS_E_WMP_DRM_LICENSE_EXPIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1203_u32 as _);
pub const NS_E_WMP_DRM_LICENSE_NOSAP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1208_u32 as _);
pub const NS_E_WMP_DRM_LICENSE_NOTACQUIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1204_u32 as _);
pub const NS_E_WMP_DRM_LICENSE_NOTENABLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1205_u32 as _);
pub const NS_E_WMP_DRM_LICENSE_SERVER_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11B5_u32 as _);
pub const NS_E_WMP_DRM_LICENSE_UNUSABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1206_u32 as _);
pub const NS_E_WMP_DRM_NEEDS_AUTHORIZATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11D0_u32 as _);
pub const NS_E_WMP_DRM_NEW_HARDWARE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11D6_u32 as _);
pub const NS_E_WMP_DRM_NOT_ACQUIRING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D12C1_u32 as _);
pub const NS_E_WMP_DRM_NO_DEVICE_CERT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11E3_u32 as _);
pub const NS_E_WMP_DRM_NO_RIGHTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11DC_u32 as _);
pub const NS_E_WMP_DRM_NO_SECURE_CLOCK: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11DB_u32 as _);
pub const NS_E_WMP_DRM_UNABLE_TO_ACQUIRE_LICENSE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1209_u32 as _);
pub const NS_E_WMP_DSHOW_UNSUPPORTED_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D119A_u32 as _);
pub const NS_E_WMP_ERASE_FAILED: windows_core::HRESULT = windows_core::HRESULT(0xC00D10D4_u32 as _);
pub const NS_E_WMP_EXTERNAL_NOTREADY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FDC_u32 as _);
pub const NS_E_WMP_FAILED_TO_OPEN_IMAGE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1044_u32 as _);
pub const NS_E_WMP_FAILED_TO_OPEN_WMD: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FF2_u32 as _);
pub const NS_E_WMP_FAILED_TO_RIP_TRACK: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10D3_u32 as _);
pub const NS_E_WMP_FAILED_TO_SAVE_FILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FEF_u32 as _);
pub const NS_E_WMP_FAILED_TO_SAVE_PLAYLIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FF1_u32 as _);
pub const NS_E_WMP_FILESCANALREADYSTARTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FBE_u32 as _);
pub const NS_E_WMP_FILE_DOES_NOT_FIT_ON_CD: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10D8_u32 as _);
pub const NS_E_WMP_FILE_NO_DURATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10D9_u32 as _);
pub const NS_E_WMP_FILE_OPEN_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11B1_u32 as _);
pub const NS_E_WMP_FILE_TYPE_CANNOT_BURN_TO_AUDIO_CD: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10D7_u32 as _);
pub const NS_E_WMP_FORMAT_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D10D5_u32 as _);
pub const NS_E_WMP_GIF_BAD_VERSION_NUMBER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1026_u32 as _);
pub const NS_E_WMP_GIF_INVALID_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1025_u32 as _);
pub const NS_E_WMP_GIF_NO_IMAGE_IN_FILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1027_u32 as _);
pub const NS_E_WMP_GIF_UNEXPECTED_ENDOFFILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1024_u32 as _);
pub const NS_E_WMP_GOFULLSCREEN_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11BF_u32 as _);
pub const NS_E_WMP_HME_INVALIDOBJECTID: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FBF_u32 as _);
pub const NS_E_WMP_HME_NOTSEARCHABLEFORITEMS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FC1_u32 as _);
pub const NS_E_WMP_HME_STALEREQUEST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FC2_u32 as _);
pub const NS_E_WMP_HWND_NOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D125C_u32 as _);
pub const NS_E_WMP_IMAGE_FILETYPE_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1022_u32 as _);
pub const NS_E_WMP_IMAGE_INVALID_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1023_u32 as _);
pub const NS_E_WMP_IMAPI2_ERASE_DEVICE_BUSY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11E1_u32 as _);
pub const NS_E_WMP_IMAPI2_ERASE_FAIL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11E0_u32 as _);
pub const NS_E_WMP_IMAPI_DEVICE_BUSY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11AE_u32 as _);
pub const NS_E_WMP_IMAPI_DEVICE_INVALIDTYPE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11C9_u32 as _);
pub const NS_E_WMP_IMAPI_DEVICE_NOTPRESENT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11AD_u32 as _);
pub const NS_E_WMP_IMAPI_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D119F_u32 as _);
pub const NS_E_WMP_IMAPI_GENERIC: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11AB_u32 as _);
pub const NS_E_WMP_IMAPI_LOSS_OF_STREAMING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11AF_u32 as _);
pub const NS_E_WMP_IMAPI_MEDIA_INCOMPATIBLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11E6_u32 as _);
...
pub const NS_E_WMP_INVALID_LIBRARY_ADD: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11BC_u32 as _);
pub const NS_E_WMP_INVALID_MAX_VAL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1009_u32 as _);
pub const NS_E_WMP_INVALID_MIN_VAL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D100A_u32 as _);
pub const NS_E_WMP_INVALID_PROTOCOL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11BB_u32 as _);
pub const NS_E_WMP_INVALID_REQUEST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11D4_u32 as _);
pub const NS_E_WMP_INVALID_SKIN: windows_core::HRESULT = windows_core::HRESULT(0xC00D0FEC_u32 as _);
pub const NS_E_WMP_JPGTRANSPARENCY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1005_u32 as _);
pub const NS_E_WMP_JPG_BAD_DCTSIZE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1035_u32 as _);
pub const NS_E_WMP_JPG_BAD_PRECISION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1037_u32 as _);
pub const NS_E_WMP_JPG_BAD_VERSION_NUMBER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1036_u32 as _);
pub const NS_E_WMP_JPG_CCIR601_NOTIMPL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1038_u32 as _);
pub const NS_E_WMP_JPG_FRACT_SAMPLE_NOTIMPL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D103B_u32 as _);
pub const NS_E_WMP_JPG_IMAGE_TOO_BIG: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D103C_u32 as _);
pub const NS_E_WMP_JPG_INVALID_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1034_u32 as _);
pub const NS_E_WMP_JPG_JERR_ARITHCODING_NOTIMPL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1033_u32 as _);
pub const NS_E_WMP_JPG_NO_IMAGE_IN_FILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1039_u32 as _);
pub const NS_E_WMP_JPG_READ_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D103A_u32 as _);
pub const NS_E_WMP_JPG_SOF_UNSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D103E_u32 as _);
pub const NS_E_WMP_JPG_UNEXPECTED_ENDOFFILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D103D_u32 as _);
pub const NS_E_WMP_JPG_UNKNOWN_MARKER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D103F_u32 as _);
pub const NS_E_WMP_LICENSE_REQUIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D120A_u32 as _);
pub const NS_E_WMP_LICENSE_RESTRICTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11D3_u32 as _);
pub const NS_E_WMP_LOCKEDINSKINMODE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FEE_u32 as _);
pub const NS_E_WMP_LOGON_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1196_u32 as _);
pub const NS_E_WMP_MF_CODE_EXPIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FC0_u32 as _);
pub const NS_E_WMP_MLS_STALE_DATA: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FDD_u32 as _);
pub const NS_E_WMP_MMS_NOT_SUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11BD_u32 as _);
pub const NS_E_WMP_MSSAP_NOT_AVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11A3_u32 as _);
pub const NS_E_WMP_MULTICAST_DISABLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11C2_u32 as _);
pub const NS_E_WMP_MULTIPLE_ERROR_IN_PLAYLIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11DF_u32 as _);
pub const NS_E_WMP_NEED_UPGRADE: windows_core::HRESULT = windows_core::HRESULT(0xC00D11B9_u32 as _);
pub const NS_E_WMP_NETWORK_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11C0_u32 as _);
pub const NS_E_WMP_NETWORK_FIREWALL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11B6_u32 as _);
pub const NS_E_WMP_NETWORK_RESOURCE_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11CB_u32 as _);
pub const NS_E_WMP_NONMEDIA_FILES: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D119C_u32 as _);
pub const NS_E_WMP_NO_DISK_SPACE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1195_u32 as _);
pub const NS_E_WMP_NO_PROTOCOLS_SELECTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11BE_u32 as _);
pub const NS_E_WMP_NO_REMOVABLE_MEDIA: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11B7_u32 as _);
pub const NS_E_WMP_OUTOFMEMORY: windows_core::HRESULT = windows_core::HRESULT(0xC00D11C6_u32 as _);
pub const NS_E_WMP_PATH_ALREADY_IN_LIBRARY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FBA_u32 as _);
pub const NS_E_WMP_PLAYLIST_EXISTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D119B_u32 as _);
pub const NS_E_WMP_PLUGINDLL_NOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FD9_u32 as _);
pub const NS_E_WMP_PNG_INVALIDFORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1028_u32 as _);
pub const NS_E_WMP_PNG_UNSUPPORTED_BAD_CRC: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D102D_u32 as _);
pub const NS_E_WMP_PNG_UNSUPPORTED_BITDEPTH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1029_u32 as _);
pub const NS_E_WMP_PNG_UNSUPPORTED_COMPRESSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D102A_u32 as _);
pub const NS_E_WMP_PNG_UNSUPPORTED_FILTER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D102B_u32 as _);
pub const NS_E_WMP_PNG_UNSUPPORTED_INTERLACE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D102C_u32 as _);
pub const NS_E_WMP_POLICY_VALUE_NOT_CONFIGURED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D122A_u32 as _);
pub const NS_E_WMP_PROTECTED_CONTENT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D120B_u32 as _);
pub const NS_E_WMP_PROTOCOL_PROBLEM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1194_u32 as _);
pub const NS_E_WMP_PROXY_CONNECT_TIMEOUT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11B8_u32 as _);
pub const NS_E_WMP_PROXY_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11C4_u32 as _);
pub const NS_E_WMP_RBC_JPGMAPPINGIMAGE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1004_u32 as _);
pub const NS_E_WMP_RECORDING_NOT_ALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FC9_u32 as _);
pub const NS_E_WMP_RIP_FAILED: windows_core::HRESULT = windows_core::HRESULT(0xC00D10D2_u32 as _);
pub const NS_E_WMP_SAVEAS_READONLY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FF0_u32 as _);
pub const NS_E_WMP_SENDMAILFAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FED_u32 as _);
pub const NS_E_WMP_SERVER_DNS_TIMEOUT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11C3_u32 as _);
pub const NS_E_WMP_SERVER_INACCESSIBLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1198_u32 as _);
pub const NS_E_WMP_SERVER_NONEWCONNECTIONS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11DE_u32 as _);
pub const NS_E_WMP_SERVER_NOT_RESPONDING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11B3_u32 as _);
pub const NS_E_WMP_SERVER_SECURITY_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11E4_u32 as _);
pub const NS_E_WMP_SERVER_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11B0_u32 as _);
pub const NS_E_WMP_STREAMING_RECORDING_NOT_ALLOWED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FD8_u32 as _);
pub const NS_E_WMP_TAMPERED_CONTENT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11C5_u32 as _);
pub const NS_E_WMP_UDRM_NOUSERLIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D12C0_u32 as _);
pub const NS_E_WMP_UI_NOSKININZIP: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FE7_u32 as _);
pub const NS_E_WMP_UI_NOTATHEMEFILE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FE0_u32 as _);
pub const NS_E_WMP_UI_OBJECTNOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FE5_u32 as _);
pub const NS_E_WMP_UI_PASSTHROUGH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FE4_u32 as _);
pub const NS_E_WMP_UI_SECONDHANDLER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FE6_u32 as _);
pub const NS_E_WMP_UI_SUBCONTROLSNOTSUPPORTED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FDE_u32 as _);
pub const NS_E_WMP_UI_SUBELEMENTNOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FE1_u32 as _);
pub const NS_E_WMP_UI_VERSIONMISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FDF_u32 as _);
pub const NS_E_WMP_UI_VERSIONPARSE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FE2_u32 as _);
pub const NS_E_WMP_UI_VIEWIDNOTFOUND: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FE3_u32 as _);
pub const NS_E_WMP_UNKNOWN_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11CD_u32 as _);
pub const NS_E_WMP_UNSUPPORTED_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1199_u32 as _);
pub const NS_E_WMP_UPGRADE_APPLICATION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11CC_u32 as _);
pub const NS_E_WMP_URLDOWNLOADFAILED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FEA_u32 as _);
pub const NS_E_WMP_VERIFY_ONLINE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11B2_u32 as _);
pub const NS_E_WMP_VIDEO_CODEC_NOT_INSTALLED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11C8_u32 as _);
pub const NS_E_WMP_WINDOWSAPIFAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D0FC8_u32 as _);
...
pub const NS_E_WMP_WMDM_INCORRECT_RIGHTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11AA_u32 as _);
pub const NS_E_WMP_WMDM_INTERFACEDEAD: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11A4_u32 as _);
pub const NS_E_WMP_WMDM_LICENSE_EXPIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11A7_u32 as _);
pub const NS_E_WMP_WMDM_LICENSE_NOTEXIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11A6_u32 as _);
pub const NS_E_WMP_WMDM_NORIGHTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11A9_u32 as _);
pub const NS_E_WMP_WMDM_NOTCERTIFIED: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D11A5_u32 as _);
pub const NS_E_WMR_CANNOT_RENDER_BINARY_STREAM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1063_u32 as _);
pub const NS_E_WMR_NOCALLBACKAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D105E_u32 as _);
pub const NS_E_WMR_NOSOURCEFILTER: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D105C_u32 as _);
pub const NS_E_WMR_PINNOTFOUND: windows_core::HRESULT = windows_core::HRESULT(0xC00D105A_u32 as _);
pub const NS_E_WMR_PINTYPENOMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D105D_u32 as _);
pub const NS_E_WMR_SAMPLEPROPERTYNOTSET: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1062_u32 as _);
pub const NS_E_WMR_UNSUPPORTEDSTREAM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1059_u32 as _);
pub const NS_E_WMR_WAITINGONFORMATSWITCH: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D105B_u32 as _);
pub const NS_E_WMR_WILLNOT_RENDER_BINARY_STREAM: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1065_u32 as _);
pub const NS_E_WMX_ATTRIBUTE_ALREADY_EXISTS: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D106F_u32 as _);
pub const NS_E_WMX_ATTRIBUTE_DOES_NOT_EXIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D106E_u32 as _);
pub const NS_E_WMX_ATTRIBUTE_UNRETRIEVABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1070_u32 as _);
pub const NS_E_WMX_INVALID_FORMAT_OVER_NESTING: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1076_u32 as _);
pub const NS_E_WMX_ITEM_DOES_NOT_EXIST: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1071_u32 as _);
pub const NS_E_WMX_ITEM_TYPE_ILLEGAL: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1072_u32 as _);
pub const NS_E_WMX_ITEM_UNSETTABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1073_u32 as _);
pub const NS_E_WMX_PLAYLIST_EMPTY: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1074_u32 as _);
pub const NS_E_WMX_UNRECOGNIZED_PLAYLIST_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1068_u32 as _);
...
pub const NS_E_WRONG_PUBLISHING_POINT_TYPE: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D1452_u32 as _);
pub const NS_E_WSX_INVALID_VERSION: windows_core::HRESULT =
    windows_core::HRESULT(0xC00D151E_u32 as _);
pub const NS_I_CATATONIC_AUTO_UNFAIL: windows_core::HRESULT =
    windows_core::HRESULT(0x800D019A_u32 as _);
pub const NS_I_CATATONIC_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0x800D0199_u32 as _);
...
pub const NS_I_DISK_REBUILD_ABORTED: windows_core::HRESULT =
    windows_core::HRESULT(0x400D0058_u32 as _);
pub const NS_I_DISK_REBUILD_FINISHED: windows_core::HRESULT =
    windows_core::HRESULT(0x400D0057_u32 as _);
pub const NS_I_DISK_REBUILD_STARTED: windows_core::HRESULT =
    windows_core::HRESULT(0x400D0056_u32 as _);
...
pub const NS_I_EXISTING_PACKETIZER: windows_core::HRESULT =
    windows_core::HRESULT(0x400D2F03_u32 as _);
...
pub const NS_I_PLAYLIST_CHANGE_RECEDING: windows_core::HRESULT =
    windows_core::HRESULT(0x400D14BE_u32 as _);
...
pub const NS_I_RESTRIPE_DISK_OUT: windows_core::HRESULT =
    windows_core::HRESULT(0x400D0196_u32 as _);
...
pub const NS_S_DRM_ACQUIRE_CANCELLED: windows_core::HRESULT =
    windows_core::HRESULT(0xD2747_u32 as _);
pub const NS_S_DRM_BURNABLE_TRACK: windows_core::HRESULT = windows_core::HRESULT(0xD276E_u32 as _);
pub const NS_S_DRM_BURNABLE_TRACK_WITH_PLAYLIST_RESTRICTION: windows_core::HRESULT =
    windows_core::HRESULT(0xD276F_u32 as _);
pub const NS_S_DRM_INDIVIDUALIZED: windows_core::HRESULT = windows_core::HRESULT(0xD2727_u32 as _);
pub const NS_S_DRM_LICENSE_ACQUIRED: windows_core::HRESULT =
    windows_core::HRESULT(0xD2726_u32 as _);
pub const NS_S_DRM_MONITOR_CANCELLED: windows_core::HRESULT =
    windows_core::HRESULT(0xD2746_u32 as _);
pub const NS_S_DRM_NEEDS_INDIVIDUALIZATION: windows_core::HRESULT =
    windows_core::HRESULT(0xD27DE_u32 as _);
pub const NS_S_EOSRECEDING: windows_core::HRESULT = windows_core::HRESULT(0xD2F09_u32 as _);
pub const NS_S_NAVIGATION_COMPLETE_WITH_ERRORS: windows_core::HRESULT =
    windows_core::HRESULT(0xD135E_u32 as _);
pub const NS_S_NEED_TO_BUY_BURN_RIGHTS: windows_core::HRESULT =
    windows_core::HRESULT(0xD10DB_u32 as _);
pub const NS_S_OPERATION_PENDING: windows_core::HRESULT = windows_core::HRESULT(0xD114E_u32 as _);
pub const NS_S_PUBLISHING_POINT_STARTED_WITH_FAILED_SINKS: windows_core::HRESULT =
    windows_core::HRESULT(0xD1519_u32 as _);
...
pub const NS_S_TRACK_ALREADY_DOWNLOADED: windows_core::HRESULT =
    windows_core::HRESULT(0xD1361_u32 as _);
pub const NS_S_TRACK_BUY_REQUIRES_ALBUM_PURCHASE: windows_core::HRESULT =
    windows_core::HRESULT(0xD1359_u32 as _);
pub const NS_S_TRANSCRYPTOR_EOF: windows_core::HRESULT = windows_core::HRESULT(0xD0BDB_u32 as _);
pub const NS_S_WMG_ADVISE_DROP_FRAME: windows_core::HRESULT =
    windows_core::HRESULT(0xD1066_u32 as _);
pub const NS_S_WMG_ADVISE_DROP_TO_KEYFRAME: windows_core::HRESULT =
    windows_core::HRESULT(0xD1067_u32 as _);
pub const NS_S_WMG_FORCE_DROP_FRAME: windows_core::HRESULT =
    windows_core::HRESULT(0xD104F_u32 as _);
pub const NS_S_WMPBR_PARTIALSUCCESS: windows_core::HRESULT =
    windows_core::HRESULT(0xD1136_u32 as _);
pub const NS_S_WMPBR_SUCCESS: windows_core::HRESULT = windows_core::HRESULT(0xD1135_u32 as _);
pub const NS_S_WMPCORE_COMMAND_NOT_AVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xD1105_u32 as _);
pub const NS_S_WMPCORE_MEDIA_CHILD_PLAYLIST_OPEN_PENDING: windows_core::HRESULT =
    windows_core::HRESULT(0xD1109_u32 as _);
pub const NS_S_WMPCORE_MEDIA_VALIDATION_PENDING: windows_core::HRESULT =
    windows_core::HRESULT(0xD1103_u32 as _);
pub const NS_S_WMPCORE_MORE_NODES_AVAIABLE: windows_core::HRESULT =
    windows_core::HRESULT(0xD110A_u32 as _);
pub const NS_S_WMPCORE_PLAYLISTCLEARABORT: windows_core::HRESULT =
    windows_core::HRESULT(0xD10FE_u32 as _);
pub const NS_S_WMPCORE_PLAYLISTREMOVEITEMABORT: windows_core::HRESULT =
    windows_core::HRESULT(0xD10FF_u32 as _);
pub const NS_S_WMPCORE_PLAYLIST_COLLAPSED_TO_SINGLE_MEDIA: windows_core::HRESULT =
    windows_core::HRESULT(0xD1108_u32 as _);
pub const NS_S_WMPCORE_PLAYLIST_CREATION_PENDING: windows_core::HRESULT =
    windows_core::HRESULT(0xD1102_u32 as _);
pub const NS_S_WMPCORE_PLAYLIST_IMPORT_MISSING_ITEMS: windows_core::HRESULT =
    windows_core::HRESULT(0xD1107_u32 as _);
pub const NS_S_WMPCORE_PLAYLIST_NAME_AUTO_GENERATED: windows_core::HRESULT =
    windows_core::HRESULT(0xD1106_u32 as _);
pub const NS_S_WMPCORE_PLAYLIST_REPEAT_SECONDARY_SEGMENTS_IGNORED: windows_core::HRESULT =
    windows_core::HRESULT(0xD1104_u32 as _);
pub const NS_S_WMPEFFECT_OPAQUE: windows_core::HRESULT = windows_core::HRESULT(0xD1145_u32 as _);
pub const NS_S_WMPEFFECT_TRANSPARENT: windows_core::HRESULT =
    windows_core::HRESULT(0xD1144_u32 as _);
pub const NS_S_WMP_EXCEPTION: windows_core::HRESULT = windows_core::HRESULT(0xD0FE9_u32 as _);
pub const NS_S_WMP_LOADED_BMP_IMAGE: windows_core::HRESULT =
    windows_core::HRESULT(0xD1042_u32 as _);
pub const NS_S_WMP_LOADED_GIF_IMAGE: windows_core::HRESULT =
    windows_core::HRESULT(0xD1040_u32 as _);
pub const NS_S_WMP_LOADED_JPG_IMAGE: windows_core::HRESULT =
    windows_core::HRESULT(0xD1043_u32 as _);
pub const NS_S_WMP_LOADED_PNG_IMAGE: windows_core::HRESULT =
    windows_core::HRESULT(0xD1041_u32 as _);
pub const NS_S_WMP_UI_VERSIONMISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xD0FE8_u32 as _);
pub const NS_S_WMR_ALREADYRENDERED: windows_core::HRESULT = windows_core::HRESULT(0xD105F_u32 as _);
pub const NS_S_WMR_PINTYPEFULLMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xD1061_u32 as _);
pub const NS_S_WMR_PINTYPEPARTIALMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0xD1060_u32 as _);
pub const NS_W_FILE_BANDWIDTH_LIMIT: windows_core::HRESULT =
    windows_core::HRESULT(0x800D0004_u32 as _);
pub const NS_W_SERVER_BANDWIDTH_LIMIT: windows_core::HRESULT =
    windows_core::HRESULT(0x800D0003_u32 as _);
...
pub const TARGET_DEVICE_FRIENDLY_NAME: windows_core::PCSTR =
    windows_core::s!("TargetDeviceFriendlyName");
pub const TARGET_DEVICE_OPEN_EXCLUSIVELY: windows_core::PCSTR =
    windows_core::s!("TargetDeviceOpenExclusively");
...
pub type VFWWDMExtensionProc = Option<
    unsafe extern "system" fn(
        pfndeviceiocontrol: *mut core::ffi::c_void,
        pfnaddpropertypage: super::super::UI::Controls::LPFNSVADDPROPSHEETPAGE,
        lparam: super::super::Foundation::LPARAM,
    ) -> u32,
>;

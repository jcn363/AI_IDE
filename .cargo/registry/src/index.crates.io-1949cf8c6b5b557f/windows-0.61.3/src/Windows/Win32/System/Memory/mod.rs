...
pub unsafe fn AllocateUserPhysicalPagesNuma(
    ...
    unsafe {
        AllocateUserPhysicalPagesNuma(hprocess, numberofpages as _, pagearray as _, nndpreferred)
            .ok()
    }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn CreateFileMapping2<P6>(
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn CreateFileMappingA<P5>(
    hfile: super::super::Foundation::HANDLE,
    lpfilemappingattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn CreateFileMappingFromApp<P4>(
    hfile: super::super::Foundation::HANDLE,
    securityattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
    pageprotection: PAGE_PROTECTION_FLAGS,
    maximumsize: u64,
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn CreateFileMappingNumaA<P5>(
    hfile: super::super::Foundation::HANDLE,
    lpfilemappingattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
    flprotect: PAGE_PROTECTION_FLAGS,
    dwmaximumsizehigh: u32,
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn CreateFileMappingNumaW<P5>(
    hfile: super::super::Foundation::HANDLE,
    lpfilemappingattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
    flprotect: PAGE_PROTECTION_FLAGS,
    dwmaximumsizehigh: u32,
...
pub unsafe fn DiscardVirtualMemory(virtualaddress: &mut [u8]) -> u32 {
    ...
    unsafe {
        DiscardVirtualMemory(
            core::mem::transmute(virtualaddress.as_ptr()),
            virtualaddress.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
pub unsafe fn GetProcessHeaps(processheaps: &mut [super::super::Foundation::HANDLE]) -> u32 {
    ...
    unsafe {
        GetProcessHeaps(
            processheaps.len().try_into().unwrap(),
            core::mem::transmute(processheaps.as_ptr()),
        )
    }
}
#[inline]
...
pub unsafe fn GetSystemFileCacheSize(
    ...
    unsafe {
        GetSystemFileCacheSize(
            lpminimumfilecachesize as _,
            lpmaximumfilecachesize as _,
            lpflags as _,
        )
        .ok()
    }
...
pub unsafe fn GetWriteWatch(
    ...
    lpbaseaddress: *const core::ffi::c_void,
    dwregionsize: usize,
    lpaddresses: Option<*mut *mut core::ffi::c_void>,
    lpdwcount: Option<*mut usize>,
    lpdwgranularity: Option<*mut u32>,
) -> u32 {
    ...
    unsafe {
        GetWriteWatch(
            ...
            lpbaseaddress,
            dwregionsize,
            lpaddresses.unwrap_or(core::mem::zeroed()) as _,
            lpdwcount.unwrap_or(core::mem::zeroed()) as _,
            lpdwgranularity.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn HeapQueryInformation(
    heaphandle: Option<super::super::Foundation::HANDLE>,
    heapinformationclass: HEAP_INFORMATION_CLASS,
    heapinformation: Option<*mut core::ffi::c_void>,
    ...
    unsafe {
        HeapQueryInformation(
            heaphandle.unwrap_or(core::mem::zeroed()) as _,
            heapinformationclass,
            heapinformation.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn HeapSetInformation(
    heaphandle: Option<super::super::Foundation::HANDLE>,
    heapinformationclass: HEAP_INFORMATION_CLASS,
    heapinformation: Option<*const core::ffi::c_void>,
    heapinformationlength: usize,
) -> windows_core::Result<()> {
...
pub unsafe fn LocalAlloc(
    ...
    ubytes: usize,
) -> windows_core::Result<super::super::Foundation::HLOCAL> {
...
#[inline]
pub unsafe fn LocalReAlloc(
    hmem: Option<super::super::Foundation::HLOCAL>,
    ubytes: usize,
    uflags: u32,
) -> windows_core::Result<super::super::Foundation::HLOCAL> {
    ...
    let result__ =
        unsafe { LocalReAlloc(hmem.unwrap_or(core::mem::zeroed()) as _, ubytes, uflags) };
    (!result__.is_invalid())
        .then_some(result__)
        .ok_or_else(windows_core::Error::from_win32)
}
...
pub unsafe fn MapUserPhysicalPagesScatter(
    virtualaddresses: *const *const core::ffi::c_void,
    numberofpages: usize,
    pagearray: Option<*const usize>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        MapUserPhysicalPagesScatter(
            virtualaddresses,
            numberofpages,
            pagearray.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn OpenFileMappingFromApp<P2>(
    desiredaccess: u32,
    inherithandle: bool,
    name: P2,
) -> windows_core::Result<super::super::Foundation::HANDLE>
...
pub unsafe fn QueryMemoryResourceNotification(
    ...
    resourcestate: *mut windows_core::BOOL,
) -> windows_core::Result<()> {
...
pub unsafe fn QueryPartitionInformation(
    ...
    partitioninformation: *mut core::ffi::c_void,
...
pub unsafe fn QueryVirtualMemoryInformation(
    ...
    unsafe {
        QueryVirtualMemoryInformation(
            ...
            returnsize.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn SetProcessValidCallTargets(
    ...
    unsafe {
        SetProcessValidCallTargets(
            ...
            virtualaddress,
            regionsize,
            offsetinformation.len().try_into().unwrap(),
            core::mem::transmute(offsetinformation.as_ptr()),
        )
        .ok()
    }
}
...
pub const QUOTA_LIMITS_HARDWS_MAX_DISABLE: SETPROCESSWORKINGSETSIZEEX_FLAGS =
    SETPROCESSWORKINGSETSIZEEX_FLAGS(8u32);
pub const QUOTA_LIMITS_HARDWS_MAX_ENABLE: SETPROCESSWORKINGSETSIZEEX_FLAGS =
    SETPROCESSWORKINGSETSIZEEX_FLAGS(4u32);
pub const QUOTA_LIMITS_HARDWS_MIN_DISABLE: SETPROCESSWORKINGSETSIZEEX_FLAGS =
    SETPROCESSWORKINGSETSIZEEX_FLAGS(2u32);
pub const QUOTA_LIMITS_HARDWS_MIN_ENABLE: SETPROCESSWORKINGSETSIZEEX_FLAGS =
    SETPROCESSWORKINGSETSIZEEX_FLAGS(1u32);

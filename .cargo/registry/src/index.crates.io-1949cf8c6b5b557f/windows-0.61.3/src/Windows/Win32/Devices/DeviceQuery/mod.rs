...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn DevCreateObjectQueryFromId<P1>(
    objecttype: DEV_OBJECT_TYPE,
    pszobjectid: P1,
    queryflags: u32,
    prequestedproperties: Option<&[super::Properties::DEVPROPCOMPKEY]>,
...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn DevCreateObjectQueryFromIdEx<P1>(
    objecttype: DEV_OBJECT_TYPE,
    pszobjectid: P1,
    queryflags: u32,
    prequestedproperties: Option<&[super::Properties::DEVPROPCOMPKEY]>,
...
pub unsafe fn DevFindProperty<P2>(
    ...
    store: super::Properties::DEVPROPSTORE,
    pszlocalename: P2,
    pproperties: Option<&[super::Properties::DEVPROPERTY]>,
) -> *mut super::Properties::DEVPROPERTY
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("api-ms-win-devices-query-l1-1-0.dll" "system" fn DevFindProperty(pkey : *const super::super::Foundation:: DEVPROPKEY, store : super::Properties:: DEVPROPSTORE, pszlocalename : windows_core::PCWSTR, cproperties : u32, pproperties : *const super::Properties:: DEVPROPERTY) -> *mut super::Properties:: DEVPROPERTY);
    unsafe {
        DevFindProperty(
            pkey,
            store,
...
pub unsafe fn DevFreeObjects(pobjects: &[DEV_OBJECT]) {
    ...
    unsafe {
        DevFreeObjects(
            pobjects.len().try_into().unwrap(),
            core::mem::transmute(pobjects.as_ptr()),
        )
    }
}
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn DevGetObjectProperties<P1>(
    objecttype: DEV_OBJECT_TYPE,
    pszobjectid: P1,
    queryflags: u32,
    prequestedproperties: &[super::Properties::DEVPROPCOMPKEY],
    pcpropertycount: *mut u32,
    ppproperties: *mut *mut super::Properties::DEVPROPERTY,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        DevGetObjectProperties(
            ...
            pszobjectid.param().abi(),
            queryflags,
            prequestedproperties.len().try_into().unwrap(),
            core::mem::transmute(prequestedproperties.as_ptr()),
            pcpropertycount as _,
            ppproperties as _,
        )
        .ok()
    }
...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn DevGetObjectPropertiesEx<P1>(
    objecttype: DEV_OBJECT_TYPE,
    pszobjectid: P1,
    queryflags: u32,
    prequestedproperties: &[super::Properties::DEVPROPCOMPKEY],
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type PDEV_QUERY_RESULT_CALLBACK = Option<

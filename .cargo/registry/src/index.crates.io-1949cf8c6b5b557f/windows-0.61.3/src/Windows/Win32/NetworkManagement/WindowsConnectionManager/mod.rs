...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("ondemandconnroutehelper.dll" "system" fn OnDemandGetRoutingHint(destinationhostname : windows_core::PCWSTR, interfaceindex : *mut u32) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WcmQueryProperty<P1>(
    pinterface: Option<*const windows_core::GUID>,
    strprofilename: P1,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wcmapi.dll" "system" fn WcmQueryProperty(pinterface : *const windows_core::GUID, strprofilename : windows_core::PCWSTR, property : WCM_PROPERTY, preserved : *const core::ffi::c_void, pdwdatasize : *mut u32, ppdata : *mut *mut u8) -> u32);
    unsafe {
        WcmQueryProperty(
            pinterface.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn WcmSetProfileList(
    ...
    windows_link::link!("wcmapi.dll" "system" fn WcmSetProfileList(pprofilelist : *const WCM_PROFILE_INFO_LIST, dwposition : u32, fignoreunknownprofiles : windows_core::BOOL, preserved : *const core::ffi::c_void) -> u32);
    unsafe {
        WcmSetProfileList(
            pprofilelist,
            dwposition,
            fignoreunknownprofiles.into(),
            preserved.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wcmapi.dll" "system" fn WcmSetProperty(pinterface : *const windows_core::GUID, strprofilename : windows_core::PCWSTR, property : WCM_PROPERTY, preserved : *const core::ffi::c_void, dwdatasize : u32, pbdata : *const u8) -> u32);
    unsafe {
        WcmSetProperty(
            pinterface.unwrap_or(core::mem::zeroed()) as _,
            strprofilename.param().abi(),
...
pub const WCM_CONNECTION_COST_APPROACHINGDATALIMIT: WCM_CONNECTION_COST =
    WCM_CONNECTION_COST(524288i32);
...
pub const WCM_CONNECTION_COST_SOURCE_DEFAULT: WCM_CONNECTION_COST_SOURCE =
    WCM_CONNECTION_COST_SOURCE(0i32);
pub const WCM_CONNECTION_COST_SOURCE_GP: WCM_CONNECTION_COST_SOURCE =
    WCM_CONNECTION_COST_SOURCE(1i32);
pub const WCM_CONNECTION_COST_SOURCE_OPERATOR: WCM_CONNECTION_COST_SOURCE =
    WCM_CONNECTION_COST_SOURCE(3i32);
pub const WCM_CONNECTION_COST_SOURCE_USER: WCM_CONNECTION_COST_SOURCE =
    WCM_CONNECTION_COST_SOURCE(2i32);

...
#[inline]
pub unsafe fn CreateJobObjectA<P1>(
    lpjobattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>,
    lpname: P1,
...
pub unsafe fn CreateJobSet(userjobset: &[JOB_SET_ARRAY], flags: u32) -> windows_core::BOOL {
    ...
    unsafe {
        CreateJobSet(
            userjobset.len().try_into().unwrap(),
            core::mem::transmute(userjobset.as_ptr()),
            flags,
        )
    }
}
...
pub unsafe fn IsProcessInJob(
    ...
    jobhandle: Option<super::super::Foundation::HANDLE>,
    ...
    unsafe {
        IsProcessInJob(
            processhandle,
            jobhandle.unwrap_or(core::mem::zeroed()) as _,
            result as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn OpenJobObjectA<P2>(
    dwdesiredaccess: u32,
    binherithandle: bool,
    lpname: P2,
) -> windows_core::Result<super::super::Foundation::HANDLE>
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    let result__ =
        unsafe { OpenJobObjectA(dwdesiredaccess, binherithandle.into(), lpname.param().abi()) };
    (!result__.is_invalid())
        .then_some(result__)
        .ok_or_else(windows_core::Error::from_win32)
}
...
pub unsafe fn QueryInformationJobObject(
    hjob: Option<super::super::Foundation::HANDLE>,
    jobobjectinformationclass: JOBOBJECTINFOCLASS,
    lpjobobjectinformation: *mut core::ffi::c_void,
    cbjobobjectinformationlength: u32,
    lpreturnlength: Option<*mut u32>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        QueryInformationJobObject(
            hjob.unwrap_or(core::mem::zeroed()) as _,
            jobobjectinformationclass,
            lpjobobjectinformation as _,
            cbjobobjectinformationlength,
            lpreturnlength.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub const JOB_OBJECT_CPU_RATE_CONTROL_MIN_MAX_RATE: JOB_OBJECT_CPU_RATE_CONTROL =
...
pub const JOB_OBJECT_CPU_RATE_CONTROL_VALID_FLAGS: JOB_OBJECT_CPU_RATE_CONTROL =
    JOB_OBJECT_CPU_RATE_CONTROL(31u32);

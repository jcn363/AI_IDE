...
impl IObjectArray_Vtbl {
    pub const fn new<Identity: IObjectArray_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCount<Identity: IObjectArray_Impl, const OFFSET: isize>(
        ...
        unsafe extern "system" fn GetAt<Identity: IObjectArray_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uiindex: u32,
            riid: *const windows_core::GUID,
            ppv: *mut *mut core::ffi::c_void,
...
impl IObjectCollection {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddFromArray)(
                windows_core::Interface::as_raw(self),
                poasource.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn RemoveObjectAt(&self, uiindex: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveObjectAt)(
                windows_core::Interface::as_raw(self),
                uiindex,
            )
            .ok()
...
pub struct IObjectCollection_Vtbl {
    ...
    pub AddFromArray: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RemoveObjectAt:
...
pub trait IObjectCollection_Impl: IObjectArray_Impl {
    ...
    fn AddFromArray(
        &self,
        poasource: windows_core::Ref<'_, IObjectArray>,
    ) -> windows_core::Result<()>;
...
impl IObjectCollection_Vtbl {
    pub const fn new<Identity: IObjectCollection_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddObject<
        ...
        unsafe extern "system" fn AddFromArray<
            Identity: IObjectCollection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            poasource: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IObjectCollection_Impl::AddFromArray(this, core::mem::transmute_copy(&poasource))
                    .into()
            }
        }
        unsafe extern "system" fn RemoveObjectAt<
            Identity: IObjectCollection_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IObjectCollection_Impl::RemoveObjectAt(this, core::mem::transmute_copy(&uiindex))
                    .into()
            }
        }
        unsafe extern "system" fn Clear<Identity: IObjectCollection_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =

...
pub unsafe fn PTCloseProvider(hprovider: HPTPROVIDER) -> windows_core::Result<()> {
    windows_link::link!("prntvpt.dll" "system" fn PTCloseProvider(hprovider : HPTPROVIDER) -> windows_core::HRESULT);
    unsafe { PTCloseProvider(hprovider).ok() }
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com"))]
#[inline]
pub unsafe fn PTConvertDevModeToPrintTicket<P4>(
...
{
    windows_link::link!("prntvpt.dll" "system" fn PTConvertDevModeToPrintTicket(hprovider : HPTPROVIDER, cbdevmode : u32, pdevmode : *const super::super::Gdi:: DEVMODEA, scope : EPrintTicketScope, pprintticket : * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
...
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com"))]
#[inline]
pub unsafe fn PTConvertPrintTicketToDevMode<P1>(
    hprovider: HPTPROVIDER,
    pprintticket: P1,
    ...
    pbstrerrormessage: Option<*mut windows_core::BSTR>,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<super::super::super::System::Com::IStream>,
{
    ...
    unsafe {
        PTConvertPrintTicketToDevMode(
            ...
            pcbdevmode as _,
            ppdevmode as _,
            pbstrerrormessage.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn PTGetPrintCapabilities<P1, P2>(
    hprovider: HPTPROVIDER,
    pprintticket: P1,
    pcapabilities: P2,
    pbstrerrormessage: Option<*mut windows_core::BSTR>,
...
{
    windows_link::link!("prntvpt.dll" "system" fn PTGetPrintCapabilities(hprovider : HPTPROVIDER, pprintticket : * mut core::ffi::c_void, pcapabilities : * mut core::ffi::c_void, pbstrerrormessage : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        PTGetPrintCapabilities(
            hprovider,
            pprintticket.param().abi(),
            pcapabilities.param().abi(),
            pbstrerrormessage.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn PTGetPrintDeviceCapabilities<P1, P2>(
    hprovider: HPTPROVIDER,
    pprintticket: P1,
...
where
    ...
    P2: windows_core::Param<super::super::super::System::Com::IStream>,
{
    windows_link::link!("prntvpt.dll" "system" fn PTGetPrintDeviceCapabilities(hprovider : HPTPROVIDER, pprintticket : * mut core::ffi::c_void, pdevicecapabilities : * mut core::ffi::c_void, pbstrerrormessage : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        PTGetPrintDeviceCapabilities(
            hprovider,
            pprintticket.param().abi(),
            pdevicecapabilities.param().abi(),
            pbstrerrormessage.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn PTGetPrintDeviceResources<P1, P2, P3>(
    hprovider: HPTPROVIDER,
    pszlocalename: P1,
    pprintticket: P2,
    pdeviceresources: P3,
...
{
    windows_link::link!("prntvpt.dll" "system" fn PTGetPrintDeviceResources(hprovider : HPTPROVIDER, pszlocalename : windows_core::PCWSTR, pprintticket : * mut core::ffi::c_void, pdeviceresources : * mut core::ffi::c_void, pbstrerrormessage : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        PTGetPrintDeviceResources(
            hprovider,
            pszlocalename.param().abi(),
            pprintticket.param().abi(),
            pdeviceresources.param().abi(),
            pbstrerrormessage.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn PTMergeAndValidatePrintTicket<P1, P2, P4>(
    hprovider: HPTPROVIDER,
    pbaseticket: P1,
    pdeltaticket: P2,
    scope: EPrintTicketScope,
...
where
    ...
    P4: windows_core::Param<super::super::super::System::Com::IStream>,
{
    windows_link::link!("prntvpt.dll" "system" fn PTMergeAndValidatePrintTicket(hprovider : HPTPROVIDER, pbaseticket : * mut core::ffi::c_void, pdeltaticket : * mut core::ffi::c_void, scope : EPrintTicketScope, presultticket : * mut core::ffi::c_void, pbstrerrormessage : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        PTMergeAndValidatePrintTicket(
            hprovider,
            pbaseticket.param().abi(),
            pdeltaticket.param().abi(),
            scope,
            presultticket.param().abi(),
            pbstrerrormessage.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn PTOpenProvider<P0>(
    pszprintername: P0,
    dwversion: u32,
) -> windows_core::Result<HPTPROVIDER>
where
...
#[inline]
pub unsafe fn PTOpenProviderEx<P0>(
    pszprintername: P0,
    dwmaxversion: u32,
    dwprefversion: u32,
    phprovider: *mut HPTPROVIDER,
    pusedversion: *mut u32,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("prntvpt.dll" "system" fn PTOpenProviderEx(pszprintername : windows_core::PCWSTR, dwmaxversion : u32, dwprefversion : u32, phprovider : *mut HPTPROVIDER, pusedversion : *mut u32) -> windows_core::HRESULT);
    unsafe {
        PTOpenProviderEx(
...
pub unsafe fn PTReleaseMemory(pbuffer: *const core::ffi::c_void) -> windows_core::Result<()> {
    windows_link::link!("prntvpt.dll" "system" fn PTReleaseMemory(pbuffer : *const core::ffi::c_void) -> windows_core::HRESULT);
...
impl windows_core::Free for HPTPROVIDER {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("prntvpt.dll" "system" fn PTCloseProvider(hprovider : *mut core::ffi::c_void) -> i32);
            unsafe {

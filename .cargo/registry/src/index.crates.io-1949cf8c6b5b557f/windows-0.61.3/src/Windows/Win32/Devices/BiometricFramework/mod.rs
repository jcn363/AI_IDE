...
pub unsafe fn WinBioAsyncOpenFramework(
    ...
    targetwindow: Option<super::super::Foundation::HWND>,
    ...
    unsafe {
        WinBioAsyncOpenFramework(
            ...
            frameworkhandle.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WinBioAsyncOpenSession(
    ...
    databaseid: Option<*const windows_core::GUID>,
    notificationmethod: WINBIO_ASYNC_NOTIFICATION_METHOD,
    targetwindow: Option<super::super::Foundation::HWND>,
    messagecode: Option<u32>,
    callbackroutine: PWINBIO_ASYNC_COMPLETION_CALLBACK,
...
pub unsafe fn WinBioCaptureSample(
    ...
    purpose: u8,
    flags: u8,
    unitid: Option<*mut u32>,
    sample: *mut *mut WINBIO_BIR,
    samplesize: Option<*mut usize>,
    rejectdetail: Option<*mut u32>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinBioCaptureSample(
            ...
            purpose,
            flags,
            unitid.unwrap_or(core::mem::zeroed()) as _,
            sample as _,
            samplesize.unwrap_or(core::mem::zeroed()) as _,
            rejectdetail.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WinBioCaptureSampleWithCallback(
    ...
    capturecallbackcontext: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinBioCaptureSampleWithCallback(
            ...
            flags,
            capturecallback,
            capturecallbackcontext.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WinBioControlUnit(
    ...
    operationstatus: Option<*mut u32>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinBioControlUnit(
            ...
            component,
            controlcode,
            core::mem::transmute(sendbuffer.as_ptr()),
            sendbuffer.len().try_into().unwrap(),
            core::mem::transmute(receivebuffer.as_ptr()),
            receivebuffer.len().try_into().unwrap(),
            receivedatasize as _,
            operationstatus.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn WinBioEnrollCapture(
    sessionhandle: u32,
    rejectdetail: Option<*mut u32>,
) -> windows_core::Result<()> {
...
pub unsafe fn WinBioEnrollCaptureWithCallback(
    ...
    enrollcallbackcontext: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinBioEnrollCaptureWithCallback(
            sessionhandle,
            enrollcallback,
            enrollcallbackcontext.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WinBioEnrollCommit(
    sessionhandle: u32,
    identity: Option<*mut WINBIO_IDENTITY>,
    isnewtemplate: Option<*mut u8>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinBioEnrollCommit(
            sessionhandle,
            identity.unwrap_or(core::mem::zeroed()) as _,
            isnewtemplate.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WinBioEnumEnrollments(
    ...
    unitid: u32,
    identity: *const WINBIO_IDENTITY,
    subfactorarray: *mut *mut u8,
    subfactorcount: Option<*mut usize>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinBioEnumEnrollments(
            ...
            identity,
            subfactorarray as _,
            subfactorcount.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WinBioGetCredentialState(
...
) -> windows_core::Result<WINBIO_CREDENTIAL_STATE> {
    ...
    unsafe {
        ...
        WinBioGetCredentialState(core::mem::transmute(identity), r#type, &mut result__)
            .map(|| result__)
    }
}
#[inline]
...
pub unsafe fn WinBioGetProperty(
    ...
    propertyid: u32,
    unitid: Option<u32>,
    identity: Option<*const WINBIO_IDENTITY>,
    subfactor: Option<u8>,
    propertybuffer: *mut *mut core::ffi::c_void,
    propertybuffersize: Option<*mut usize>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinBioGetProperty(
            ...
            unitid.unwrap_or(core::mem::zeroed()) as _,
            identity.unwrap_or(core::mem::zeroed()) as _,
            subfactor.unwrap_or(core::mem::zeroed()) as _,
            propertybuffer as _,
            propertybuffersize.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WinBioIdentifyWithCallback(
    ...
    identifycallbackcontext: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinBioIdentifyWithCallback(
            sessionhandle,
            identifycallback,
            identifycallbackcontext.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn WinBioLocateSensor(
    sessionhandle: u32,
    unitid: Option<*mut u32>,
) -> windows_core::Result<()> {
...
pub unsafe fn WinBioLocateSensorWithCallback(
    ...
    locatecallbackcontext: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinBioLocateSensorWithCallback(
            sessionhandle,
            locatecallback,
            locatecallbackcontext.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WinBioRegisterEventMonitor(
    ...
    eventcallbackcontext: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinBioRegisterEventMonitor(
            ...
            eventmask,
            eventcallback,
            eventcallbackcontext.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn WinBioSetCredential(
    ...
    unsafe {
        WinBioSetCredential(
            r#type,
            core::mem::transmute(credential.as_ptr()),
            credential.len().try_into().unwrap(),
            format,
        )
        .ok()
    }
...
pub unsafe fn WinBioSetProperty(
    ...
    identity: Option<*const WINBIO_IDENTITY>,
    subfactor: Option<u8>,
    propertybuffer: *const core::ffi::c_void,
...
pub unsafe fn WinBioVerify(
    ...
    unsafe {
        WinBioVerify(
            ...
            subfactor,
            unitid.unwrap_or(core::mem::zeroed()) as _,
            r#match.unwrap_or(core::mem::zeroed()) as _,
            rejectdetail.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub unsafe fn WinBioVerifyWithCallback(
    ...
    verifycallbackcontext: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WinBioVerifyWithCallback(
            ...
            subfactor,
            verifycallback,
            verifycallbackcontext.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub const GUID_DEVINTERFACE_BIOMETRIC_READER: windows_core::GUID =
    windows_core::GUID::from_u128(0xe2b5183a_99ea_4cc3_ad6b_80ca8d715b80);
pub const IOCTL_BIOMETRIC_VENDOR: u32 = 4464640u32;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_ACCEPT_PRIVATE_SENSOR_TYPE_INFO_FN = Option<
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_ACCEPT_SAMPLE_DATA_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        samplebuffer: *const WINBIO_BIR,
        samplesize: usize,
        purpose: u8,
...
pub type PIBIO_ENGINE_ACTIVATE_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_ATTACH_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_CHECK_FOR_DUPLICATE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
pub type PIBIO_ENGINE_CLEAR_CONTEXT_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_COMMIT_ENROLLMENT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        identity: *const WINBIO_IDENTITY,
        subfactor: u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_CONTROL_UNIT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        controlcode: u32,
        sendbuffer: *const u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_CONTROL_UNIT_PRIVILEGED_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        controlcode: u32,
        sendbuffer: *const u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_CREATE_ENROLLMENT_AUTHENTICATED_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        nonce: *mut *mut u8,
        noncesize: *mut usize,
...
pub type PIBIO_ENGINE_CREATE_ENROLLMENT_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_CREATE_KEY_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        key: *const u8,
        keysize: usize,
        keyidentifier: *mut u8,
...
pub type PIBIO_ENGINE_DISCARD_ENROLLMENT_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_EXPORT_ENGINE_DATA_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        flags: u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_GET_ENROLLMENT_HASH_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_GET_ENROLLMENT_STATUS_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        rejectdetail: *mut u32,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_IDENTIFY_ALL_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_IDENTIFY_FEATURE_SET_AUTHENTICATED_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        nonce: *const u8,
        noncesize: usize,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_IDENTIFY_FEATURE_SET_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        identity: *mut WINBIO_IDENTITY,
        subfactor: *mut u8,
        payloadblob: *mut *mut u8,
        payloadblobsize: *mut usize,
        hashvalue: *mut *mut u8,
        hashsize: *mut usize,
        rejectdetail: *mut u32,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_IDENTIFY_FEATURE_SET_SECURE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        nonce: *const u8,
        noncesize: usize,
        keyidentifier: *const u8,
        keyidentifiersize: usize,
        identity: *mut WINBIO_IDENTITY,
        subfactor: *mut u8,
        rejectdetail: *mut u32,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_NOTIFY_POWER_CHANGE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        powereventtype: u32,
    ) -> windows_core::HRESULT,
...
pub type PIBIO_ENGINE_PIPELINE_INIT_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_QUERY_CALIBRATION_DATA_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        discardandrepeatcapture: *mut bool,
        calibrationbuffer: *mut u8,
        calibrationbuffersize: *mut usize,
        maxbuffersize: usize,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_QUERY_EXTENDED_ENROLLMENT_STATUS_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_QUERY_EXTENDED_INFO_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_QUERY_HASH_ALGORITHMS_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        algorithmcount: *mut usize,
        algorithmbuffersize: *mut usize,
        algorithmbuffer: *mut *mut u8,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_QUERY_INDEX_VECTOR_SIZE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_QUERY_PREFERRED_FORMAT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        standardformat: *mut WINBIO_REGISTERED_FORMAT,
        vendorformat: *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_QUERY_SAMPLE_HINT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
pub type PIBIO_ENGINE_REFRESH_CACHE_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_RESERVED_1_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        identity: *mut WINBIO_IDENTITY,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_SELECT_CALIBRATION_FORMAT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        formatarray: *const windows_core::GUID,
        formatcount: usize,
        selectedformat: *mut windows_core::GUID,
        maxbuffersize: *mut usize,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_SET_ACCOUNT_POLICY_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_SET_ENROLLMENT_PARAMETERS_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_SET_ENROLLMENT_SELECTOR_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        selectorvalue: u64,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_SET_HASH_ALGORITHM_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_UPDATE_ENROLLMENT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        rejectdetail: *mut u32,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_ENGINE_VERIFY_FEATURE_SET_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        identity: *const WINBIO_IDENTITY,
        subfactor: u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_ALLOCATE_MEMORY_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_FREE_MEMORY_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_GET_PROPERTY_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        propertytype: u32,
        propertyid: u32,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_LOCK_AND_VALIDATE_SECURE_BUFFER_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        securebufferidentifier: windows_core::GUID,
        securebufferaddress: *mut *mut core::ffi::c_void,
        securebuffersize: *mut usize,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_RELEASE_SECURE_BUFFER_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        securebufferidentifier: windows_core::GUID,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_SET_UNIT_STATUS_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
pub type PIBIO_FRAMEWORK_VSM_CACHE_CLEAR_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_VSM_CACHE_EXPORT_BEGIN_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
pub type PIBIO_FRAMEWORK_VSM_CACHE_EXPORT_END_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_VSM_CACHE_EXPORT_NEXT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        bufferaddress: *mut u8,
        buffersize: usize,
        returneddatasize: *mut usize,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_VSM_CACHE_IMPORT_BEGIN_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
pub type PIBIO_FRAMEWORK_VSM_CACHE_IMPORT_END_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_VSM_CACHE_IMPORT_NEXT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_VSM_DECRYPT_SAMPLE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_VSM_QUERY_AUTHORIZED_ENROLLMENTS_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        identity: *const WINBIO_IDENTITY,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_VSM_STORAGE_RESERVED_1_FN = Option<
    unsafe extern "system" fn(
        pipeline: *const WINBIO_PIPELINE,
        reserved1: usize,
        reserved2: *const usize,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_FRAMEWORK_VSM_STORAGE_RESERVED_2_FN = Option<
    unsafe extern "system" fn(
        pipeline: *const WINBIO_PIPELINE,
        reserved1: *const u8,
        reserved2: usize,
...
pub type PIBIO_FRAMEWORK_VSM_STORAGE_RESERVED_3_FN =
    Option<unsafe extern "system" fn(pipeline: *const WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_ACCEPT_CALIBRATION_DATA_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
pub type PIBIO_SENSOR_ACTIVATE_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_ASYNC_IMPORT_RAW_BUFFER_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        rawbufferaddress: *const u8,
        rawbuffersize: usize,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_ASYNC_IMPORT_SECURE_BUFFER_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        securebufferidentifier: windows_core::GUID,
        metadatabufferaddress: *const u8,
...
pub type PIBIO_SENSOR_CLEAR_CONTEXT_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_CONNECT_SECURE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_CONTROL_UNIT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        controlcode: u32,
        sendbuffer: *const u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_CONTROL_UNIT_PRIVILEGED_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        controlcode: u32,
        sendbuffer: *const u8,
...
pub type PIBIO_SENSOR_DETACH_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_EXPORT_SENSOR_DATA_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        samplebuffer: *mut *mut WINBIO_BIR,
        samplesize: *mut usize,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_FINISH_CAPTURE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        rejectdetail: *mut u32,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_FINISH_NOTIFY_WAKE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        reason: *mut u32,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_GET_INDICATOR_STATUS_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_NOTIFY_POWER_CHANGE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        powereventtype: u32,
    ) -> windows_core::HRESULT,
...
pub type PIBIO_SENSOR_PIPELINE_INIT_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_PUSH_DATA_TO_ENGINE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        purpose: u8,
        flags: u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_QUERY_CALIBRATION_FORMATS_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        formatarray: *mut windows_core::GUID,
        formatarraysize: usize,
        formatcount: *mut usize,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_QUERY_EXTENDED_INFO_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_QUERY_PRIVATE_SENSOR_TYPE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        typeinfobufferaddress: *mut u8,
        typeinfobuffersize: usize,
        typeinfodatasize: *mut usize,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_QUERY_STATUS_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        status: *mut u32,
    ) -> windows_core::HRESULT,
...
pub type PIBIO_SENSOR_RESET_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_SET_CALIBRATION_FORMAT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_SET_INDICATOR_STATUS_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        indicatorstatus: u32,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_SET_MODE_FN = Option<
    unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE, mode: u32) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_START_CAPTURE_EX_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        purpose: u8,
        nonce: *const u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_START_CAPTURE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        purpose: u8,
        overlapped: *mut *mut super::super::System::IO::OVERLAPPED,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_SENSOR_START_NOTIFY_WAKE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        overlapped: *mut *mut super::super::System::IO::OVERLAPPED,
    ) -> windows_core::HRESULT,
...
pub type PIBIO_STORAGE_ACTIVATE_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_ADD_RECORD_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
pub type PIBIO_STORAGE_CLOSE_DATABASE_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_CONTROL_UNIT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        controlcode: u32,
        sendbuffer: *const u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_CONTROL_UNIT_PRIVILEGED_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        controlcode: u32,
        sendbuffer: *const u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_CREATE_DATABASE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        databaseid: *const windows_core::GUID,
        factor: u32,
        format: *const windows_core::GUID,
        filepath: windows_core::PCWSTR,
        connectstring: windows_core::PCWSTR,
...
pub type PIBIO_STORAGE_DEACTIVATE_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_DELETE_RECORD_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        identity: *const WINBIO_IDENTITY,
        subfactor: u8,
...
pub type PIBIO_STORAGE_DETACH_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_ERASE_DATABASE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        databaseid: *const windows_core::GUID,
        filepath: windows_core::PCWSTR,
...
pub type PIBIO_STORAGE_FIRST_RECORD_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_GET_CURRENT_RECORD_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_GET_DATABASE_SIZE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_GET_DATA_FORMAT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_GET_RECORD_COUNT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
pub type PIBIO_STORAGE_NEXT_RECORD_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_NOTIFY_DATABASE_CHANGE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        recordsadded: bool,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_NOTIFY_POWER_CHANGE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        powereventtype: u32,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_OPEN_DATABASE_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        databaseid: *const windows_core::GUID,
        filepath: windows_core::PCWSTR,
...
pub type PIBIO_STORAGE_PIPELINE_INIT_FN =
    Option<unsafe extern "system" fn(pipeline: *mut WINBIO_PIPELINE) -> windows_core::HRESULT>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_QUERY_BY_CONTENT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        subfactor: u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_QUERY_BY_SUBJECT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        identity: *const WINBIO_IDENTITY,
        subfactor: u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_QUERY_EXTENDED_INFO_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_RESERVED_1_FN = Option<
    unsafe extern "system" fn(
        pipeline: *const WINBIO_PIPELINE,
        identity: *const WINBIO_IDENTITY,
        reserved1: *const u64,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_RESERVED_2_FN = Option<
    unsafe extern "system" fn(
        pipeline: *const WINBIO_PIPELINE,
        identity: *const WINBIO_IDENTITY,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_UPDATE_RECORD_BEGIN_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        identity: *const WINBIO_IDENTITY,
        subfactor: u8,
...
>;
#[cfg(feature = "Win32_System_IO")]
pub type PIBIO_STORAGE_UPDATE_RECORD_COMMIT_FN = Option<
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        recordcontents: *const WINBIO_STORAGE_RECORD,
    ) -> windows_core::HRESULT,
>;
pub type PWINBIO_ASYNC_COMPLETION_CALLBACK =
    Option<unsafe extern "system" fn(asyncresult: *const WINBIO_ASYNC_RESULT)>;
pub type PWINBIO_CAPTURE_CALLBACK = Option<
    unsafe extern "system" fn(
        capturecallbackcontext: *const core::ffi::c_void,
        operationstatus: windows_core::HRESULT,
        unitid: u32,
        sample: *const WINBIO_BIR,
        samplesize: usize,
        rejectdetail: u32,
    ),
>;
pub type PWINBIO_ENROLL_CAPTURE_CALLBACK = Option<
    unsafe extern "system" fn(
        enrollcallbackcontext: *const core::ffi::c_void,
        operationstatus: windows_core::HRESULT,
        rejectdetail: u32,
    ),
>;
pub type PWINBIO_EVENT_CALLBACK = Option<
    unsafe extern "system" fn(
        eventcallbackcontext: *const core::ffi::c_void,
        operationstatus: windows_core::HRESULT,
        event: *const WINBIO_EVENT,
    ),
>;
pub type PWINBIO_IDENTIFY_CALLBACK = Option<
    unsafe extern "system" fn(
        identifycallbackcontext: *const core::ffi::c_void,
        operationstatus: windows_core::HRESULT,
        unitid: u32,
        identity: *const WINBIO_IDENTITY,
        subfactor: u8,
...
>;
pub type PWINBIO_LOCATE_SENSOR_CALLBACK = Option<
    unsafe extern "system" fn(
        locatecallbackcontext: *const core::ffi::c_void,
        operationstatus: windows_core::HRESULT,
        unitid: u32,
    ),
>;
#[cfg(feature = "Win32_System_IO")]
pub type PWINBIO_QUERY_ENGINE_INTERFACE_FN = Option<
    unsafe extern "system" fn(
        engineinterface: *mut *mut WINBIO_ENGINE_INTERFACE,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PWINBIO_QUERY_SENSOR_INTERFACE_FN = Option<
    unsafe extern "system" fn(
        sensorinterface: *mut *mut WINBIO_SENSOR_INTERFACE,
    ) -> windows_core::HRESULT,
>;
#[cfg(feature = "Win32_System_IO")]
pub type PWINBIO_QUERY_STORAGE_INTERFACE_FN = Option<
    unsafe extern "system" fn(
        storageinterface: *mut *mut WINBIO_STORAGE_INTERFACE,
    ) -> windows_core::HRESULT,
>;
pub type PWINBIO_VERIFY_CALLBACK = Option<
    unsafe extern "system" fn(
        verifycallbackcontext: *const core::ffi::c_void,
        operationstatus: windows_core::HRESULT,
        unitid: u32,
        r#match: bool,
        rejectdetail: u32,
...
pub const WINBIO_ANTI_SPOOF_DISABLE: WINBIO_ANTI_SPOOF_POLICY_ACTION =
    WINBIO_ANTI_SPOOF_POLICY_ACTION(0i32);
pub const WINBIO_ANTI_SPOOF_ENABLE: WINBIO_ANTI_SPOOF_POLICY_ACTION =
    WINBIO_ANTI_SPOOF_POLICY_ACTION(1i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const WINBIO_ANTI_SPOOF_REMOVE: WINBIO_ANTI_SPOOF_POLICY_ACTION =
    WINBIO_ANTI_SPOOF_POLICY_ACTION(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WINBIO_ASYNC_NOTIFICATION_METHOD(pub i32);
pub const WINBIO_ASYNC_NOTIFY_CALLBACK: WINBIO_ASYNC_NOTIFICATION_METHOD =
    WINBIO_ASYNC_NOTIFICATION_METHOD(1i32);
pub const WINBIO_ASYNC_NOTIFY_MAXIMUM_VALUE: WINBIO_ASYNC_NOTIFICATION_METHOD =
    WINBIO_ASYNC_NOTIFICATION_METHOD(3i32);
pub const WINBIO_ASYNC_NOTIFY_MESSAGE: WINBIO_ASYNC_NOTIFICATION_METHOD =
    WINBIO_ASYNC_NOTIFICATION_METHOD(2i32);
pub const WINBIO_ASYNC_NOTIFY_NONE: WINBIO_ASYNC_NOTIFICATION_METHOD =
    WINBIO_ASYNC_NOTIFICATION_METHOD(0i32);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const WINBIO_E_ADAPTER_INTEGRITY_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0x8009803D_u32 as _);
pub const WINBIO_E_AUTO_LOGON_DISABLED: windows_core::HRESULT =
    windows_core::HRESULT(0x80098043_u32 as _);
pub const WINBIO_E_BAD_CAPTURE: windows_core::HRESULT = windows_core::HRESULT(0x80098008_u32 as _);
pub const WINBIO_E_CALIBRATION_BUFFER_INVALID: windows_core::HRESULT =
    windows_core::HRESULT(0x80098051_u32 as _);
pub const WINBIO_E_CALIBRATION_BUFFER_TOO_LARGE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098050_u32 as _);
pub const WINBIO_E_CALIBRATION_BUFFER_TOO_SMALL: windows_core::HRESULT =
    windows_core::HRESULT(0x8009804F_u32 as _);
pub const WINBIO_E_CANCELED: windows_core::HRESULT = windows_core::HRESULT(0x80098004_u32 as _);
pub const WINBIO_E_CAPTURE_ABORTED: windows_core::HRESULT =
    windows_core::HRESULT(0x80098006_u32 as _);
pub const WINBIO_E_CONFIGURATION_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098033_u32 as _);
pub const WINBIO_E_CRED_PROV_DISABLED: windows_core::HRESULT =
    windows_core::HRESULT(0x80098030_u32 as _);
pub const WINBIO_E_CRED_PROV_NO_CREDENTIAL: windows_core::HRESULT =
    windows_core::HRESULT(0x80098031_u32 as _);
pub const WINBIO_E_CRED_PROV_SECURITY_LOCKOUT: windows_core::HRESULT =
    windows_core::HRESULT(0x80098047_u32 as _);
pub const WINBIO_E_DATABASE_ALREADY_EXISTS: windows_core::HRESULT =
    windows_core::HRESULT(0x80098016_u32 as _);
pub const WINBIO_E_DATABASE_BAD_INDEX_VECTOR: windows_core::HRESULT =
    windows_core::HRESULT(0x80098022_u32 as _);
pub const WINBIO_E_DATABASE_CANT_CLOSE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098013_u32 as _);
pub const WINBIO_E_DATABASE_CANT_CREATE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098011_u32 as _);
pub const WINBIO_E_DATABASE_CANT_ERASE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098014_u32 as _);
pub const WINBIO_E_DATABASE_CANT_FIND: windows_core::HRESULT =
    windows_core::HRESULT(0x80098015_u32 as _);
pub const WINBIO_E_DATABASE_CANT_OPEN: windows_core::HRESULT =
    windows_core::HRESULT(0x80098012_u32 as _);
pub const WINBIO_E_DATABASE_CORRUPTED: windows_core::HRESULT =
    windows_core::HRESULT(0x8009801A_u32 as _);
pub const WINBIO_E_DATABASE_EOF: windows_core::HRESULT = windows_core::HRESULT(0x80098021_u32 as _);
pub const WINBIO_E_DATABASE_FULL: windows_core::HRESULT =
    windows_core::HRESULT(0x80098018_u32 as _);
pub const WINBIO_E_DATABASE_LOCKED: windows_core::HRESULT =
    windows_core::HRESULT(0x80098019_u32 as _);
pub const WINBIO_E_DATABASE_NO_MORE_RECORDS: windows_core::HRESULT =
    windows_core::HRESULT(0x80098020_u32 as _);
pub const WINBIO_E_DATABASE_NO_RESULTS: windows_core::HRESULT =
    windows_core::HRESULT(0x8009801F_u32 as _);
pub const WINBIO_E_DATABASE_NO_SUCH_RECORD: windows_core::HRESULT =
    windows_core::HRESULT(0x8009801B_u32 as _);
pub const WINBIO_E_DATABASE_READ_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0x8009801D_u32 as _);
pub const WINBIO_E_DATABASE_WRITE_ERROR: windows_core::HRESULT =
    windows_core::HRESULT(0x8009801E_u32 as _);
pub const WINBIO_E_DATA_COLLECTION_IN_PROGRESS: windows_core::HRESULT =
    windows_core::HRESULT(0x8009800B_u32 as _);
pub const WINBIO_E_DATA_PROTECTION_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098046_u32 as _);
pub const WINBIO_E_DEADLOCK_DETECTED: windows_core::HRESULT =
    windows_core::HRESULT(0x80098040_u32 as _);
pub const WINBIO_E_DEVICE_BUSY: windows_core::HRESULT = windows_core::HRESULT(0x80098010_u32 as _);
pub const WINBIO_E_DEVICE_FAILURE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098036_u32 as _);
pub const WINBIO_E_DISABLED: windows_core::HRESULT = windows_core::HRESULT(0x80098032_u32 as _);
pub const WINBIO_E_DUPLICATE_ENROLLMENT: windows_core::HRESULT =
    windows_core::HRESULT(0x8009801C_u32 as _);
pub const WINBIO_E_DUPLICATE_TEMPLATE: windows_core::HRESULT =
    windows_core::HRESULT(0x8009802B_u32 as _);
pub const WINBIO_E_ENROLLMENT_CANCELED_BY_SUSPEND: windows_core::HRESULT =
    windows_core::HRESULT(0x8009805B_u32 as _);
pub const WINBIO_E_ENROLLMENT_IN_PROGRESS: windows_core::HRESULT =
    windows_core::HRESULT(0x80098007_u32 as _);
pub const WINBIO_E_EVENT_MONITOR_ACTIVE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098039_u32 as _);
pub const WINBIO_E_FAST_USER_SWITCH_DISABLED: windows_core::HRESULT =
    windows_core::HRESULT(0x80098037_u32 as _);
pub const WINBIO_E_INCORRECT_BSP: windows_core::HRESULT =
    windows_core::HRESULT(0x80098024_u32 as _);
pub const WINBIO_E_INCORRECT_SENSOR_POOL: windows_core::HRESULT =
    windows_core::HRESULT(0x80098025_u32 as _);
pub const WINBIO_E_INCORRECT_SESSION_TYPE: windows_core::HRESULT =
    windows_core::HRESULT(0x8009803E_u32 as _);
pub const WINBIO_E_INSECURE_SENSOR: windows_core::HRESULT =
    windows_core::HRESULT(0x80098057_u32 as _);
pub const WINBIO_E_INVALID_BUFFER: windows_core::HRESULT =
    windows_core::HRESULT(0x80098059_u32 as _);
pub const WINBIO_E_INVALID_BUFFER_ID: windows_core::HRESULT =
    windows_core::HRESULT(0x80098058_u32 as _);
pub const WINBIO_E_INVALID_CALIBRATION_FORMAT_ARRAY: windows_core::HRESULT =
    windows_core::HRESULT(0x8009804C_u32 as _);
pub const WINBIO_E_INVALID_CONTROL_CODE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098009_u32 as _);
pub const WINBIO_E_INVALID_DEVICE_STATE: windows_core::HRESULT =
    windows_core::HRESULT(0x8009800F_u32 as _);
pub const WINBIO_E_INVALID_KEY_IDENTIFIER: windows_core::HRESULT =
    windows_core::HRESULT(0x80098052_u32 as _);
pub const WINBIO_E_INVALID_OPERATION: windows_core::HRESULT =
    windows_core::HRESULT(0x8009802C_u32 as _);
pub const WINBIO_E_INVALID_PROPERTY_ID: windows_core::HRESULT =
    windows_core::HRESULT(0x8009803B_u32 as _);
pub const WINBIO_E_INVALID_PROPERTY_TYPE: windows_core::HRESULT =
    windows_core::HRESULT(0x8009803A_u32 as _);
pub const WINBIO_E_INVALID_SENSOR_MODE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098027_u32 as _);
pub const WINBIO_E_INVALID_SUBFACTOR: windows_core::HRESULT =
    windows_core::HRESULT(0x8009804B_u32 as _);
pub const WINBIO_E_INVALID_TICKET: windows_core::HRESULT =
    windows_core::HRESULT(0x80098044_u32 as _);
pub const WINBIO_E_INVALID_UNIT: windows_core::HRESULT = windows_core::HRESULT(0x80098002_u32 as _);
pub const WINBIO_E_KEY_CREATION_FAILED: windows_core::HRESULT =
    windows_core::HRESULT(0x80098053_u32 as _);
pub const WINBIO_E_KEY_IDENTIFIER_BUFFER_TOO_SMALL: windows_core::HRESULT =
    windows_core::HRESULT(0x80098054_u32 as _);
pub const WINBIO_E_LOCK_VIOLATION: windows_core::HRESULT =
    windows_core::HRESULT(0x8009802A_u32 as _);
pub const WINBIO_E_MAX_ERROR_COUNT_EXCEEDED: windows_core::HRESULT =
    windows_core::HRESULT(0x80098042_u32 as _);
pub const WINBIO_E_NOT_ACTIVE_CONSOLE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098038_u32 as _);
pub const WINBIO_E_NO_CAPTURE_DATA: windows_core::HRESULT =
    windows_core::HRESULT(0x80098026_u32 as _);
pub const WINBIO_E_NO_MATCH: windows_core::HRESULT = windows_core::HRESULT(0x80098005_u32 as _);
pub const WINBIO_E_NO_PREBOOT_IDENTITY: windows_core::HRESULT =
    windows_core::HRESULT(0x80098041_u32 as _);
pub const WINBIO_E_NO_SUPPORTED_CALIBRATION_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0x8009804D_u32 as _);
pub const WINBIO_E_POLICY_PROTECTION_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098056_u32 as _);
pub const WINBIO_E_PRESENCE_MONITOR_ACTIVE: windows_core::HRESULT =
    windows_core::HRESULT(0x8009804A_u32 as _);
pub const WINBIO_E_PROPERTY_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098055_u32 as _);
pub const WINBIO_E_SAS_ENABLED: windows_core::HRESULT = windows_core::HRESULT(0x80098035_u32 as _);
pub const WINBIO_E_SELECTION_REQUIRED: windows_core::HRESULT =
    windows_core::HRESULT(0x80098049_u32 as _);
pub const WINBIO_E_SENSOR_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098034_u32 as _);
pub const WINBIO_E_SESSION_BUSY: windows_core::HRESULT = windows_core::HRESULT(0x8009802D_u32 as _);
pub const WINBIO_E_SESSION_HANDLE_CLOSED: windows_core::HRESULT =
    windows_core::HRESULT(0x8009803F_u32 as _);
pub const WINBIO_E_TICKET_QUOTA_EXCEEDED: windows_core::HRESULT =
    windows_core::HRESULT(0x80098045_u32 as _);
pub const WINBIO_E_TRUSTLET_INTEGRITY_FAIL: windows_core::HRESULT =
    windows_core::HRESULT(0x8009805A_u32 as _);
pub const WINBIO_E_UNKNOWN_ID: windows_core::HRESULT = windows_core::HRESULT(0x80098003_u32 as _);
pub const WINBIO_E_UNSUPPORTED_DATA_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0x8009800C_u32 as _);
pub const WINBIO_E_UNSUPPORTED_DATA_TYPE: windows_core::HRESULT =
    windows_core::HRESULT(0x8009800D_u32 as _);
pub const WINBIO_E_UNSUPPORTED_FACTOR: windows_core::HRESULT =
    windows_core::HRESULT(0x80098001_u32 as _);
pub const WINBIO_E_UNSUPPORTED_POOL_TYPE: windows_core::HRESULT =
    windows_core::HRESULT(0x80098048_u32 as _);
pub const WINBIO_E_UNSUPPORTED_PROPERTY: windows_core::HRESULT =
    windows_core::HRESULT(0x8009803C_u32 as _);
pub const WINBIO_E_UNSUPPORTED_PURPOSE: windows_core::HRESULT =
    windows_core::HRESULT(0x8009800E_u32 as _);
pub const WINBIO_E_UNSUPPORTED_SENSOR_CALIBRATION_FORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0x8009804E_u32 as _);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const WINBIO_I_EXTENDED_STATUS_INFORMATION: windows_core::HRESULT =
    windows_core::HRESULT(0x90002_u32 as _);

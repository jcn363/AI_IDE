...
windows_core::imp::define_interface!(
    IDDEInitializer,
    IDDEInitializer_Vtbl,
    0x30dc931f_33fc_4ffd_a168_942258cf3ca4
);
windows_core::imp::interface_hierarchy!(IDDEInitializer, windows_core::IUnknown);
impl IDDEInitializer {
    #[cfg(feature = "Win32_UI_Shell")]
    pub unsafe fn Initialize<P0, P2, P3, P4, P5, P6, P7, P8>(
        &self,
        fileextensionorprotocol: P0,
        ...
        P8: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Initialize)(
                ...
                fileextensionorprotocol.param().abi(),
                method,
                currentdirectory.param().abi(),
                exectarget.param().abi(),
                site.param().abi(),
...
pub trait IDDEInitializer_Impl: windows_core::IUnknownImpl {
    fn Initialize(
        &self,
        fileextensionorprotocol: &windows_core::PCWSTR,
        method: CreateProcessMethod,
        currentdirectory: &windows_core::PCWSTR,
        exectarget: windows_core::Ref<'_, super::super::super::UI::Shell::IShellItem>,
        site: windows_core::Ref<'_, windows_core::IUnknown>,
        application: &windows_core::PCWSTR,
        targetfile: &windows_core::PCWSTR,
        arguments: &windows_core::PCWSTR,
        verb: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
}
#[cfg(feature = "Win32_UI_Shell")]
impl IDDEInitializer_Vtbl {
    pub const fn new<Identity: IDDEInitializer_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            method: CreateProcessMethod,
            currentdirectory: windows_core::PCWSTR,
            exectarget: *mut core::ffi::c_void,
            ...
            unsafe {
                ...
                IDDEInitializer_Impl::Initialize(
                    this,
                    core::mem::transmute(&fileextensionorprotocol),
                    core::mem::transmute_copy(&method),
                    core::mem::transmute(&currentdirectory),
                    core::mem::transmute_copy(&exectarget),
                    core::mem::transmute_copy(&site),
                    core::mem::transmute(&application),
                    core::mem::transmute(&targetfile),
                    core::mem::transmute(&arguments),
                    core::mem::transmute(&verb),
                )
                .into()
            }
        }

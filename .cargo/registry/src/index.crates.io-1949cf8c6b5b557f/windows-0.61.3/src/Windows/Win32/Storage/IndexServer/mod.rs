...
#[inline]
pub unsafe fn BindIFilterFromStorage<P0, P1>(
    pstg: P0,
    punkouter: P1,
...
#[inline]
pub unsafe fn BindIFilterFromStream<P0, P1>(
    pstm: P0,
    punkouter: P1,
    ppiunk: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
...
pub const CLSID_INDEX_SERVER_DSO: windows_core::GUID =
    windows_core::GUID::from_u128(0xf9ae8980_7e52_11d0_8964_00c04fd611d7);
#[repr(C, packed(2))]
#[cfg(target_arch = "x86")]
#[derive(Clone, Copy)]
pub struct DBID {
...
pub const DBPROPSET_CIFRMWRKCORE_EXT: windows_core::GUID =
    windows_core::GUID::from_u128(0xafafaca5_b5d1_11d0_8c62_00c04fc2db8d);
pub const DBPROPSET_FSCIFRMWRK_EXT: windows_core::GUID =
    windows_core::GUID::from_u128(0xa9bd1526_6a80_11d0_8c9d_0020af1d740e);
pub const DBPROPSET_MSIDXS_ROWSETEXT: windows_core::GUID =
    windows_core::GUID::from_u128(0xaa6ee6b0_e828_11d0_b23e_00aa0047fc01);
pub const DBPROPSET_QUERYEXT: windows_core::GUID =
    windows_core::GUID::from_u128(0xa7ac77ed_f8d7_11ce_a798_0020f8008025);
pub const DBPROPSET_SESS_QUERYEXT: windows_core::GUID =
    windows_core::GUID::from_u128(0x63623309_2d8b_4d17_b152_6e2956c26a70);
...
pub const FILTER_E_EMBEDDING_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0x80041707_u32 as _);
pub const FILTER_E_END_OF_CHUNKS: windows_core::HRESULT =
    windows_core::HRESULT(0x80041700_u32 as _);
pub const FILTER_E_LINK_UNAVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0x80041708_u32 as _);
pub const FILTER_E_NO_MORE_TEXT: windows_core::HRESULT = windows_core::HRESULT(0x80041701_u32 as _);
pub const FILTER_E_NO_MORE_VALUES: windows_core::HRESULT =
    windows_core::HRESULT(0x80041702_u32 as _);
...
pub const FILTER_E_UNKNOWNFORMAT: windows_core::HRESULT =
    windows_core::HRESULT(0x8004170C_u32 as _);
...
windows_core::imp::define_interface!(
    IFilter,
    IFilter_Vtbl,
    0x89bcb740_6119_101a_bcb7_00dd010655af
);
...
impl IFilter {
    ...
    pub unsafe fn Init(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Init)(
                ...
                grfflags,
                aattributes.len().try_into().unwrap(),
                core::mem::transmute(aattributes.as_ptr()),
                pflags as _,
            )
        }
    }
    ...
    pub unsafe fn GetChunk(&self, pstat: *mut STAT_CHUNK) -> i32 {
        unsafe {
            (windows_core::Interface::vtable(self).GetChunk)(
                windows_core::Interface::as_raw(self),
                pstat as _,
            )
        }
    ...
    pub unsafe fn BindRegion(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).BindRegion)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(origpos),
                riid,
                ppunk as _,
            )
        }
...
pub struct IFilter_Vtbl {
    ...
    GetChunk: usize,
    pub GetText:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32, windows_core::PWSTR) -> i32,
    #[cfg(all(
        feature = "Win32_System_Com_StructuredStorage",
        feature = "Win32_System_Variant"
    ))]
    pub GetValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::super::System::Com::StructuredStorage::PROPVARIANT,
    ) -> i32,
    #[cfg(not(all(
        feature = "Win32_System_Com_StructuredStorage",
        feature = "Win32_System_Variant"
    ...
    GetValue: usize,
    pub BindRegion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        FILTERREGION,
...
impl IFilter_Vtbl {
    pub const fn new<Identity: IFilter_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Init<Identity: IFilter_Impl, const OFFSET: isize>(
            ...
            unsafe {
                ...
                IFilter_Impl::Init(
                    ...
                    core::mem::transmute_copy(&cattributes),
                    core::mem::transmute_copy(&aattributes),
                    core::mem::transmute_copy(&pflags),
                )
            }
        }
        unsafe extern "system" fn GetChunk<Identity: IFilter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pstat: *mut STAT_CHUNK,
        ) -> i32 {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetText<Identity: IFilter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pcwcbuffer: *mut u32,
            awcbuffer: windows_core::PWSTR,
        ) -> i32 {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IFilter_Impl::GetText(
                    this,
                    core::mem::transmute_copy(&pcwcbuffer),
                    core::mem::transmute_copy(&awcbuffer),
                )
            }
        }
        unsafe extern "system" fn GetValue<Identity: IFilter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pppropvalue: *mut *mut super::super::System::Com::StructuredStorage::PROPVARIANT,
        ) -> i32 {
            unsafe {
        ...
        unsafe extern "system" fn BindRegion<Identity: IFilter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            origpos: FILTERREGION,
            riid: *const windows_core::GUID,
            ppunk: *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IPhraseSink,
    IPhraseSink_Vtbl,
    0xcc906ff0_c058_101a_b554_08002b33b0e6
);
windows_core::imp::interface_hierarchy!(IPhraseSink, windows_core::IUnknown);
impl IPhraseSink {
    pub unsafe fn PutSmallPhrase<P0, P2>(
        &self,
        pwcnoun: P0,
        cwcnoun: u32,
        pwcmodifier: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PutSmallPhrase)(
                windows_core::Interface::as_raw(self),
                pwcnoun.param().abi(),
                cwcnoun,
                pwcmodifier.param().abi(),
                cwcmodifier,
                ulattachmenttype,
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PutPhrase)(
                windows_core::Interface::as_raw(self),
                pwcphrase.param().abi(),
                cwcphrase,
            )
...
pub struct IPhraseSink_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub PutSmallPhrase: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        windows_core::PCWSTR,
    ...
    pub PutPhrase: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
    ) -> windows_core::HRESULT,
...
pub trait IPhraseSink_Impl: windows_core::IUnknownImpl {
    fn PutSmallPhrase(
        &self,
        pwcnoun: &windows_core::PCWSTR,
        cwcnoun: u32,
        pwcmodifier: &windows_core::PCWSTR,
        cwcmodifier: u32,
        ulattachmenttype: u32,
    ) -> windows_core::Result<()>;
    fn PutPhrase(
        &self,
        pwcphrase: &windows_core::PCWSTR,
        cwcphrase: u32,
    ) -> windows_core::Result<()>;
}
impl IPhraseSink_Vtbl {
    pub const fn new<Identity: IPhraseSink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn PutSmallPhrase<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPhraseSink_Impl::PutSmallPhrase(
                    this,
                    core::mem::transmute(&pwcnoun),
                    core::mem::transmute_copy(&cwcnoun),
                    core::mem::transmute(&pwcmodifier),
                    core::mem::transmute_copy(&cwcmodifier),
                    core::mem::transmute_copy(&ulattachmenttype),
                )
                .into()
            }
        }
        unsafe extern "system" fn PutPhrase<Identity: IPhraseSink_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwcphrase: windows_core::PCWSTR,
            cwcphrase: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPhraseSink_Impl::PutPhrase(
                    this,
                    core::mem::transmute(&pwcphrase),
                    core::mem::transmute_copy(&cwcphrase),
                )
                .into()
            }
        }
...
pub const PSGUID_FILENAME: windows_core::GUID =
    windows_core::GUID::from_u128(0x41cf5ae0_f75a_4806_bd87_59c7d9248eb9);

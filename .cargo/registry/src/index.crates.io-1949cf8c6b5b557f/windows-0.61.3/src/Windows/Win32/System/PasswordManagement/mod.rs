#[inline]
pub unsafe fn MSChapSrvChangePassword<P0, P1>(
    servername: P0,
    username: P1,
    lmoldpresent: bool,
...
{
    windows_link::link!("advapi32.dll" "system" fn MSChapSrvChangePassword(servername : windows_core::PCWSTR, username : windows_core::PCWSTR, lmoldpresent : bool, lmoldowfpassword : *const LM_OWF_PASSWORD, lmnewowfpassword : *const LM_OWF_PASSWORD, ntoldowfpassword : *const LM_OWF_PASSWORD, ntnewowfpassword : *const LM_OWF_PASSWORD) -> u32);
    unsafe {

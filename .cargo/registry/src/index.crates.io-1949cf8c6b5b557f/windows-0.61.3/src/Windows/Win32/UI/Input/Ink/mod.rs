windows_core::imp::define_interface!(
    ...
    0xfabea3fc_b108_45b6_a9fc_8d08fa9f85cf
);
...
impl IInkCommitRequestHandler {
    pub unsafe fn OnCommitRequested(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnCommitRequested)(
...
impl IInkCommitRequestHandler_Vtbl {
    pub const fn new<Identity: IInkCommitRequestHandler_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnCommitRequested<
        ...
        Self {
            ...
            OnCommitRequested: OnCommitRequested::<Identity, OFFSET>,
        }
    }
...
windows_core::imp::define_interface!(
    ...
    0x407fb1de_f85a_4150_97cf_b7fb274fb4f8
);
windows_core::imp::interface_hierarchy!(IInkD2DRenderer, windows_core::IUnknown);
impl IInkD2DRenderer {
    pub unsafe fn Draw<P0, P1>(
        &self,
        pd2d1devicecontext: P0,
        pinkstrokeiterable: P1,
        fhighcontrast: bool,
    ) -> windows_core::Result<()>
    where
        ...
        P1: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Draw)(
                windows_core::Interface::as_raw(self),
                pd2d1devicecontext.param().abi(),
                pinkstrokeiterable.param().abi(),
                fhighcontrast.into(),
            )
            .ok()
        }
...
pub trait IInkD2DRenderer_Impl: windows_core::IUnknownImpl {
    fn Draw(
        &self,
        pd2d1devicecontext: windows_core::Ref<'_, windows_core::IUnknown>,
        pinkstrokeiterable: windows_core::Ref<'_, windows_core::IUnknown>,
        fhighcontrast: windows_core::BOOL,
    ) -> windows_core::Result<()>;
}
impl IInkD2DRenderer_Vtbl {
    pub const fn new<Identity: IInkD2DRenderer_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Draw<Identity: IInkD2DRenderer_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pd2d1devicecontext: *mut core::ffi::c_void,
            pinkstrokeiterable: *mut core::ffi::c_void,
            fhighcontrast: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInkD2DRenderer_Impl::Draw(
                    this,
                    core::mem::transmute_copy(&pd2d1devicecontext),
                    core::mem::transmute_copy(&pinkstrokeiterable),
                    core::mem::transmute_copy(&fhighcontrast),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IInkD2DRenderer2,
    IInkD2DRenderer2_Vtbl,
    0x0a95dcd9_4578_4b71_b20b_bf664d4bfeee
);
...
impl IInkD2DRenderer2_Vtbl {
    pub const fn new<Identity: IInkD2DRenderer2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Draw<Identity: IInkD2DRenderer2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pd2d1devicecontext: *mut core::ffi::c_void,
            pinkstrokeiterable: *mut core::ffi::c_void,
            highcontrastadjustment: INK_HIGH_CONTRAST_ADJUSTMENT,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInkD2DRenderer2_Impl::Draw(
                    this,
                    core::mem::transmute_copy(&pd2d1devicecontext),
                    core::mem::transmute_copy(&pinkstrokeiterable),
                    core::mem::transmute_copy(&highcontrastadjustment),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x4ce7d875_a981_4140_a1ff_ad93258e8d59
);
...
impl IInkDesktopHost {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).QueueWorkItem)(
                windows_core::Interface::as_raw(self),
                workitem.param().abi(),
            )
            .ok()
        ...
        T: windows_core::Interface,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(self).CreateInkPresenter)(
                windows_core::Interface::as_raw(self),
                &T::IID,
                &mut result__,
            )
    ...
    pub unsafe fn CreateAndInitializeInkPresenter<P0, T>(
        &self,
        rootvisual: P0,
        width: f32,
        height: f32,
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).CreateAndInitializeInkPresenter)(
                windows_core::Interface::as_raw(self),
                rootvisual.param().abi(),
                width,
                height,
                &T::IID,
                &mut result__,
...
pub struct IInkDesktopHost_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub QueueWorkItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateInkPresenter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateAndInitializeInkPresenter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        f32,
        f32,
...
pub trait IInkDesktopHost_Impl: windows_core::IUnknownImpl {
    fn QueueWorkItem(
        &self,
        workitem: windows_core::Ref<'_, IInkHostWorkItem>,
    ) -> windows_core::Result<()>;
    ...
    fn CreateAndInitializeInkPresenter(
        &self,
        rootvisual: windows_core::Ref<'_, windows_core::IUnknown>,
        width: f32,
        height: f32,
        riid: *const windows_core::GUID,
        ppv: *mut *mut core::ffi::c_void,
...
impl IInkDesktopHost_Vtbl {
    pub const fn new<Identity: IInkDesktopHost_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn QueueWorkItem<
            Identity: IInkDesktopHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            workitem: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInkDesktopHost_Impl::QueueWorkItem(this, core::mem::transmute_copy(&workitem))
                    .into()
            }
        }
        unsafe extern "system" fn CreateInkPresenter<
            Identity: IInkDesktopHost_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInkDesktopHost_Impl::CreateInkPresenter(
                    this,
        ...
        >(
            this: *mut core::ffi::c_void,
            rootvisual: *mut core::ffi::c_void,
            width: f32,
            height: f32,
            riid: *const windows_core::GUID,
            ppv: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInkDesktopHost_Impl::CreateAndInitializeInkPresenter(
                    this,
                    core::mem::transmute_copy(&rootvisual),
...
windows_core::imp::define_interface!(
    IInkHostWorkItem,
    IInkHostWorkItem_Vtbl,
    0xccda0a9a_1b78_4632_bb96_97800662e26c
);
...
impl IInkHostWorkItem_Vtbl {
    pub const fn new<Identity: IInkHostWorkItem_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Invoke<Identity: IInkHostWorkItem_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
impl IInkPresenterDesktop {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetRootVisual)(
                windows_core::Interface::as_raw(self),
                rootvisual.param().abi(),
                device.param().abi(),
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetCommitRequestHandler)(
                windows_core::Interface::as_raw(self),
                handler.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn OnHighContrastChanged(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnHighContrastChanged)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct IInkPresenterDesktop_Vtbl {
    ...
    pub SetCommitRequestHandler: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IInkPresenterDesktop_Impl: windows_core::IUnknownImpl {
    ...
    fn SetCommitRequestHandler(
        &self,
        handler: windows_core::Ref<'_, IInkCommitRequestHandler>,
    ) -> windows_core::Result<()>;
...
impl IInkPresenterDesktop_Vtbl {
    pub const fn new<Identity: IInkPresenterDesktop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetRootVisual<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInkPresenterDesktop_Impl::SetRootVisual(
                    this,
                    core::mem::transmute_copy(&rootvisual),
        ...
        unsafe extern "system" fn SetCommitRequestHandler<
            Identity: IInkPresenterDesktop_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInkPresenterDesktop_Impl::SetCommitRequestHandler(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInkPresenterDesktop_Impl::GetSize(
                    this,
                    core::mem::transmute_copy(&width),
                    core::mem::transmute_copy(&height),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInkPresenterDesktop_Impl::SetSize(
                    this,
                    core::mem::transmute_copy(&width),
                    core::mem::transmute_copy(&height),
                )
        ...
        unsafe extern "system" fn OnHighContrastChanged<
            Identity: IInkPresenterDesktop_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub const InkD2DRenderer: windows_core::GUID =
    windows_core::GUID::from_u128(0x4044e60c_7b01_4671_a97c_04e0210a07a5);
pub const InkDesktopHost: windows_core::GUID =
    windows_core::GUID::from_u128(0x062584a6_f830_4bdc_a4d2_0a10ab062b1d);

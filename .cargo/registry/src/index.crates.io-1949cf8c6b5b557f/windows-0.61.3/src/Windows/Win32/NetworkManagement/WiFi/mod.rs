...
pub unsafe fn WFDOpenLegacySession(
    ...
    pguidsessioninterface: *mut windows_core::GUID,
) -> u32 {
    ...
    unsafe {
        WFDOpenLegacySession(
            hclienthandle,
            plegacymacaddress,
            phsessionhandle as _,
            pguidsessioninterface as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn WlanDeleteProfile<P2>(
    hclienthandle: super::super::Foundation::HANDLE,
    pinterfaceguid: *const windows_core::GUID,
    strprofilename: P2,
    preserved: Option<*const core::ffi::c_void>,
...
pub unsafe fn WlanDeviceServiceCommand(
    hclienthandle: super::super::Foundation::HANDLE,
    pinterfaceguid: *const windows_core::GUID,
    pdeviceserviceguid: *const windows_core::GUID,
    dwopcode: u32,
    dwinbuffersize: u32,
    pinbuffer: Option<*const core::ffi::c_void>,
    dwoutbuffersize: u32,
    poutbuffer: Option<*mut core::ffi::c_void>,
    ...
    unsafe {
        WlanDeviceServiceCommand(
            ...
            dwopcode,
            dwinbuffersize,
            pinbuffer.unwrap_or(core::mem::zeroed()) as _,
            dwoutbuffersize,
            poutbuffer.unwrap_or(core::mem::zeroed()) as _,
            pdwbytesreturned as _,
        )
    }
}
#[inline]
...
pub unsafe fn WlanEnumInterfaces(
    ...
    unsafe {
        WlanEnumInterfaces(
            hclienthandle,
            preserved.unwrap_or(core::mem::zeroed()) as _,
            ppinterfacelist as _,
        )
    }
}
#[inline]
pub unsafe fn WlanExtractPsdIEDataList<P3>(
    hclienthandle: super::super::Foundation::HANDLE,
    prawiedata: &[u8],
    strformat: P3,
    preserved: Option<*const core::ffi::c_void>,
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WlanExtractPsdIEDataList(
            hclienthandle,
            prawiedata.len().try_into().unwrap(),
            core::mem::transmute(prawiedata.as_ptr()),
            strformat.param().abi(),
            preserved.unwrap_or(core::mem::zeroed()) as _,
            pppsdiedatalist as _,
        )
    }
}
#[inline]
...
pub unsafe fn WlanGetNetworkBssList(
    hclienthandle: super::super::Foundation::HANDLE,
    pinterfaceguid: *const windows_core::GUID,
    pdot11ssid: Option<*const DOT11_SSID>,
    ...
    unsafe {
        WlanGetNetworkBssList(
            hclienthandle,
            pinterfaceguid,
            pdot11ssid.unwrap_or(core::mem::zeroed()) as _,
            dot11bsstype,
            bsecurityenabled.into(),
            preserved.unwrap_or(core::mem::zeroed()) as _,
            ppwlanbsslist as _,
        )
    }
...
pub unsafe fn WlanGetProfile<P2>(
    ...
    strprofilename: P2,
    preserved: Option<*const core::ffi::c_void>,
    pstrprofilexml: *mut windows_core::PWSTR,
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WlanGetProfile(
            ...
            pdwgrantedaccess.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn WlanGetSecuritySettings(
    ...
    pstrcurrentsddl: *mut windows_core::PWSTR,
    ...
    unsafe {
        WlanGetSecuritySettings(
            hclienthandle,
            securableobject,
            pvaluetype.unwrap_or(core::mem::zeroed()) as _,
            pstrcurrentsddl as _,
            pdwgrantedaccess as _,
        )
    }
}
#[inline]
...
pub unsafe fn WlanHostedNetworkForceStart(
    ...
    unsafe {
        WlanHostedNetworkForceStart(
            hclienthandle,
            pfailreason.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn WlanHostedNetworkQuerySecondaryKey(
    ...
    pbispassphrase: *mut windows_core::BOOL,
    pbpersistent: *mut windows_core::BOOL,
    pfailreason: Option<*mut WLAN_HOSTED_NETWORK_REASON>,
    pvreserved: Option<*const core::ffi::c_void>,
) -> u32 {
...
pub unsafe fn WlanHostedNetworkQueryStatus(
    ...
    unsafe {
        WlanHostedNetworkQueryStatus(
            hclienthandle,
            ppwlanhostednetworkstatus as _,
            pvreserved.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
pub unsafe fn WlanHostedNetworkSetSecondaryKey(
    ...
    unsafe {
        WlanHostedNetworkSetSecondaryKey(
            hclienthandle,
            puckeydata.len().try_into().unwrap(),
            core::mem::transmute(puckeydata.as_ptr()),
            bispassphrase.into(),
            bpersistent.into(),
            pfailreason.unwrap_or(core::mem::zeroed()) as _,
            pvreserved.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn WlanIhvControl(
    ...
    dwinbuffersize: u32,
    pinbuffer: *const core::ffi::c_void,
    dwoutbuffersize: u32,
    poutbuffer: Option<*mut core::ffi::c_void>,
    pdwbytesreturned: *mut u32,
) -> u32 {
...
pub unsafe fn WlanQueryAutoConfigParameter(
    ...
    unsafe {
        WlanQueryAutoConfigParameter(
            ...
            pdwdatasize as _,
            ppdata as _,
            pwlanopcodevaluetype.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn WlanReasonCodeToString(
    ...
    unsafe {
        WlanReasonCodeToString(
            dwreasoncode,
            pstringbuffer.len().try_into().unwrap(),
            core::mem::transmute(pstringbuffer.as_ptr()),
            preserved.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
pub unsafe fn WlanRegisterDeviceServiceNotification(
    ...
    unsafe {
        WlanRegisterDeviceServiceNotification(
            hclienthandle,
            pdevsvcguidlist.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn WlanRegisterNotification(
    ...
    unsafe {
        WlanRegisterNotification(
            hclienthandle,
            dwnotifsource,
            bignoreduplicate.into(),
            funccallback,
            pcallbackcontext.unwrap_or(core::mem::zeroed()) as _,
            preserved.unwrap_or(core::mem::zeroed()) as _,
            pdwprevnotifsource.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WlanRenameProfile(
            hclienthandle,
            pinterfaceguid,
            stroldprofilename.param().abi(),
            strnewprofilename.param().abi(),
            preserved.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WlanSaveTemporaryProfile(
            ...
            pinterfaceguid,
            strprofilename.param().abi(),
            stralluserprofilesecurity.param().abi(),
            dwflags,
            boverwrite.into(),
            preserved.unwrap_or(core::mem::zeroed()) as _,
        )
...
pub unsafe fn WlanScan(
    ...
    pinterfaceguid: *const windows_core::GUID,
    pdot11ssid: Option<*const DOT11_SSID>,
    piedata: Option<*const WLAN_RAW_DATA>,
    preserved: Option<*const core::ffi::c_void>,
) -> u32 {
    ...
    unsafe {
        WlanScan(
            ...
            pinterfaceguid,
            pdot11ssid.unwrap_or(core::mem::zeroed()) as _,
            piedata.unwrap_or(core::mem::zeroed()) as _,
            preserved.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
pub unsafe fn WlanSetFilterList(
    hclienthandle: super::super::Foundation::HANDLE,
    wlanfilterlisttype: WLAN_FILTER_LIST_TYPE,
    pnetworklist: Option<*const DOT11_NETWORK_LIST>,
    preserved: Option<*const core::ffi::c_void>,
) -> u32 {
    ...
    unsafe {
        WlanSetFilterList(
            hclienthandle,
            wlanfilterlisttype,
            pnetworklist.unwrap_or(core::mem::zeroed()) as _,
            preserved.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
pub unsafe fn WlanSetProfileList(
    hclienthandle: super::super::Foundation::HANDLE,
    pinterfaceguid: *const windows_core::GUID,
    strprofilenames: &[windows_core::PCWSTR],
    preserved: Option<*const core::ffi::c_void>,
) -> u32 {
    ...
    unsafe {
        WlanSetProfileList(
            hclienthandle,
            pinterfaceguid,
            strprofilenames.len().try_into().unwrap(),
            core::mem::transmute(strprofilenames.as_ptr()),
            preserved.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
...
#[inline]
pub unsafe fn WlanSetPsdIEDataList<P1>(
    hclienthandle: super::super::Foundation::HANDLE,
    strformat: P1,
    ppsdiedatalist: Option<*const WLAN_RAW_DATA_LIST>,
    preserved: Option<*const core::ffi::c_void>,
) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WlanSetPsdIEDataList(
            hclienthandle,
            strformat.param().abi(),
            ppsdiedatalist.unwrap_or(core::mem::zeroed()) as _,
            preserved.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn WlanSetSecuritySettings<P2>(
    hclienthandle: super::super::Foundation::HANDLE,
    securableobject: WLAN_SECURABLE_OBJECT,
    strmodifiedsddl: P2,
) -> u32
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WlanUIEditProfile(
            dwclientversion,
            wstrprofilename.param().abi(),
            pinterfaceguid,
            hwnd,
            wlstartpage,
            preserved.unwrap_or(core::mem::zeroed()) as _,
            pwlanreasoncode.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[repr(transparent)]
...
pub const DEVPKEY_InfraCast_AccessPointBssid: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 19,
    };
pub const DEVPKEY_InfraCast_ChallengeAep: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 21,
    };
pub const DEVPKEY_InfraCast_DevnodeAep: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 23,
    };
pub const DEVPKEY_InfraCast_HostName_ResolutionMode: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 25,
    };
pub const DEVPKEY_InfraCast_PinSupported: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 29,
    };
pub const DEVPKEY_InfraCast_RtspTcpConnectionParametersSupported:
    super::super::Foundation::DEVPROPKEY = super::super::Foundation::DEVPROPKEY {
    fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
    pid: 30,
};
pub const DEVPKEY_InfraCast_SinkHostName: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 20,
    };
pub const DEVPKEY_InfraCast_SinkIpAddress: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 26,
    };
pub const DEVPKEY_InfraCast_StreamSecuritySupported: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 18,
    };
pub const DEVPKEY_InfraCast_Supported: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 17,
    };
pub const DEVPKEY_PciDevice_AERCapabilityPresent: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 17,
    };
pub const DEVPKEY_PciDevice_AcsCapabilityRegister: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 32,
    };
pub const DEVPKEY_PciDevice_AcsCompatibleUpHierarchy: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 31,
    };
pub const DEVPKEY_PciDevice_AcsSupport: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 29,
    };
pub const DEVPKEY_PciDevice_AriSupport: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 30,
    };
pub const DEVPKEY_PciDevice_AtomicsSupported: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 35,
    };
pub const DEVPKEY_PciDevice_AtsSupport: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 33,
    };
pub const DEVPKEY_PciDevice_BarTypes: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 16,
    };
pub const DEVPKEY_PciDevice_BaseClass: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 3,
    };
pub const DEVPKEY_PciDevice_Correctable_Error_Mask: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 21,
    };
pub const DEVPKEY_PciDevice_CurrentLinkSpeed: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 9,
    };
pub const DEVPKEY_PciDevice_CurrentLinkWidth: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 10,
    };
pub const DEVPKEY_PciDevice_CurrentPayloadSize: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 6,
    };
pub const DEVPKEY_PciDevice_CurrentSpeedAndMode: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 2,
    };
pub const DEVPKEY_PciDevice_D3ColdSupport: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 38,
    };
pub const DEVPKEY_PciDevice_DeviceType: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 1,
    };
pub const DEVPKEY_PciDevice_ECRC_Errors: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 22,
    };
pub const DEVPKEY_PciDevice_Error_Reporting: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 23,
    };
pub const DEVPKEY_PciDevice_ExpressSpecVersion: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 13,
    };
pub const DEVPKEY_PciDevice_FirmwareErrorHandling: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 18,
    };
pub const DEVPKEY_PciDevice_InterruptMessageMaximum: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 15,
    };
pub const DEVPKEY_PciDevice_InterruptSupport: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 14,
    };
pub const DEVPKEY_PciDevice_Label_Id: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 27,
    };
pub const DEVPKEY_PciDevice_Label_String: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 28,
    };
pub const DEVPKEY_PciDevice_MaxLinkSpeed: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 11,
    };
pub const DEVPKEY_PciDevice_MaxLinkWidth: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 12,
    };
pub const DEVPKEY_PciDevice_MaxPayloadSize: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 7,
    };
pub const DEVPKEY_PciDevice_MaxReadRequestSize: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 8,
    };
pub const DEVPKEY_PciDevice_OnPostPath: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 37,
    };
pub const DEVPKEY_PciDevice_ParentSerialNumber: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 45,
    };
pub const DEVPKEY_PciDevice_ProgIf: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 5,
    };
pub const DEVPKEY_PciDevice_RequiresReservedMemoryRegion: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 34,
    };
pub const DEVPKEY_PciDevice_RootError_Reporting: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 24,
    };
pub const DEVPKEY_PciDevice_S0WakeupSupported: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 25,
    };
pub const DEVPKEY_PciDevice_SerialNumber: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 40,
    };
pub const DEVPKEY_PciDevice_SriovSupport: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 26,
    };
pub const DEVPKEY_PciDevice_SubClass: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 4,
    };
pub const DEVPKEY_PciDevice_SupportedLinkSubState: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 36,
    };
pub const DEVPKEY_PciDevice_Uncorrectable_Error_Mask: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 19,
    };
pub const DEVPKEY_PciDevice_Uncorrectable_Error_Severity: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 20,
    };
pub const DEVPKEY_PciDevice_UsbComponentRelation: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 43,
    };
pub const DEVPKEY_PciDevice_UsbDvsecPortSpecificAttributes: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 42,
    };
pub const DEVPKEY_PciDevice_UsbDvsecPortType: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 41,
    };
pub const DEVPKEY_PciDevice_UsbHostRouterName: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x3ab22e31_8264_4b4e_9af5_a8d2d8e33e62),
        pid: 44,
    };
pub const DEVPKEY_PciRootBus_ASPMSupport: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 8,
    };
pub const DEVPKEY_PciRootBus_ClockPowerManagementSupport: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 9,
    };
pub const DEVPKEY_PciRootBus_CurrentSpeedAndMode: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 2,
    };
pub const DEVPKEY_PciRootBus_DeviceIDMessagingCapable: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 4,
    };
pub const DEVPKEY_PciRootBus_ExtendedConfigAvailable: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 6,
    };
pub const DEVPKEY_PciRootBus_ExtendedPCIConfigOpRegionSupport:
    super::super::Foundation::DEVPROPKEY = super::super::Foundation::DEVPROPKEY {
    fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
    pid: 7,
};
pub const DEVPKEY_PciRootBus_MSISupport: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 11,
    };
pub const DEVPKEY_PciRootBus_NativePciExpressControl: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 17,
    };
pub const DEVPKEY_PciRootBus_PCIExpressAERControl: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 15,
    };
pub const DEVPKEY_PciRootBus_PCIExpressCapabilityControl: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 16,
    };
pub const DEVPKEY_PciRootBus_PCIExpressNativeHotPlugControl: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 12,
    };
pub const DEVPKEY_PciRootBus_PCIExpressNativePMEControl: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 14,
    };
pub const DEVPKEY_PciRootBus_PCISegmentGroupsSupport: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 10,
    };
pub const DEVPKEY_PciRootBus_SHPCNativeHotPlugControl: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 13,
    };
pub const DEVPKEY_PciRootBus_SecondaryBusWidth: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 5,
    };
pub const DEVPKEY_PciRootBus_SecondaryInterface: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 1,
    };
pub const DEVPKEY_PciRootBus_SupportedSpeedsAndModes: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 3,
    };
pub const DEVPKEY_PciRootBus_SystemMsiSupport: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0xd817fc28_793e_4b9e_9970_469d8be63073),
        pid: 18,
    };
pub const DEVPKEY_WiFiDirectServices_AdvertisementId: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
...
pub const DEVPKEY_WiFiDirectServices_ServiceAddress: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x31b37743_7c5e_4005_93e6_e953f92b82e9),
        pid: 2,
    };
pub const DEVPKEY_WiFiDirectServices_ServiceConfigMethods: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x31b37743_7c5e_4005_93e6_e953f92b82e9),
        pid: 6,
    };
pub const DEVPKEY_WiFiDirectServices_ServiceInformation: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x31b37743_7c5e_4005_93e6_e953f92b82e9),
        pid: 4,
    };
pub const DEVPKEY_WiFiDirectServices_ServiceName: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x31b37743_7c5e_4005_93e6_e953f92b82e9),
        pid: 3,
    };
pub const DEVPKEY_WiFiDirect_DeviceAddress: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 1,
    };
pub const DEVPKEY_WiFiDirect_DeviceAddressCopy: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 13,
    };
pub const DEVPKEY_WiFiDirect_FoundWsbService: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 24,
    };
pub const DEVPKEY_WiFiDirect_GroupId: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 4,
    };
pub const DEVPKEY_WiFiDirect_InformationElements: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 12,
    };
pub const DEVPKEY_WiFiDirect_InterfaceAddress: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 2,
    };
pub const DEVPKEY_WiFiDirect_InterfaceGuid: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 3,
    };
pub const DEVPKEY_WiFiDirect_IsConnected: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 5,
    };
pub const DEVPKEY_WiFiDirect_IsDMGCapable: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 22,
    };
pub const DEVPKEY_WiFiDirect_IsLegacyDevice: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 7,
    };
pub const DEVPKEY_WiFiDirect_IsMiracastLCPSupported: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 9,
    };
pub const DEVPKEY_WiFiDirect_IsRecentlyAssociated: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 14,
    };
pub const DEVPKEY_WiFiDirect_IsVisible: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 6,
    };
pub const DEVPKEY_WiFiDirect_LinkQuality: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 28,
    };
pub const DEVPKEY_WiFiDirect_MiracastVersion: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 8,
    };
pub const DEVPKEY_WiFiDirect_Miracast_SessionMgmtControlPort: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 31,
    };
pub const DEVPKEY_WiFiDirect_NoMiracastAutoProject: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 16,
    };
...
pub const DEVPKEY_WiFiDirect_Service_Aeps: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 15,
    };
pub const DEVPKEY_WiFiDirect_Services: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 10,
    };
pub const DEVPKEY_WiFiDirect_SupportedChannelList: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 11,
    };
pub const DEVPKEY_WiFiDirect_TransientAssociation: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_core::GUID::from_u128(0x1506935d_e3e7_450f_8637_82233ebe5f6e),
        pid: 27,
    };
pub const DEVPKEY_WiFi_InterfaceGuid: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
...
pub type DOT11EXTIHV_ADAPTER_RESET =
    Option<unsafe extern "system" fn(hihvextadapter: super::super::Foundation::HANDLE) -> u32>;
pub type DOT11EXTIHV_CONTROL = Option<
    unsafe extern "system" fn(
        hihvextadapter: super::super::Foundation::HANDLE,
        dwinbuffersize: u32,
        pinbuffer: *const u8,
        dwoutbuffersize: u32,
        poutbuffer: *mut u8,
...
>;
#[cfg(feature = "Win32_Security_ExtensibleAuthenticationProtocol")]
pub type DOT11EXTIHV_CREATE_DISCOVERY_PROFILES = Option<
    unsafe extern "system" fn(
        hihvextadapter: super::super::Foundation::HANDLE,
        binsecure: windows_core::BOOL,
        pihvprofileparams: *const DOT11EXT_IHV_PROFILE_PARAMS,
        pconnectablebssid: *const DOT11_BSS_LIST,
        pihvdiscoveryprofilelist: *mut DOT11EXT_IHV_DISCOVERY_PROFILE_LIST,
        pdwreasoncode: *mut u32,
    ) -> u32,
>;
pub type DOT11EXTIHV_DEINIT_ADAPTER =
    Option<unsafe extern "system" fn(hihvextadapter: super::super::Foundation::HANDLE)>;
pub type DOT11EXTIHV_DEINIT_SERVICE = Option<unsafe extern "system" fn()>;
pub type DOT11EXTIHV_GET_VERSION_INFO =
    Option<unsafe extern "system" fn(pdot11ihvversioninfo: *mut DOT11_IHV_VERSION_INFO) -> u32>;
pub type DOT11EXTIHV_INIT_ADAPTER = Option<
    unsafe extern "system" fn(
        pdot11adapter: *const DOT11_ADAPTER,
        hdot11svchandle: super::super::Foundation::HANDLE,
        phihvextadapter: *mut super::super::Foundation::HANDLE,
    ) -> u32,
>;
#[cfg(all(
    feature = "Win32_NetworkManagement_Ndis",
    feature = "Win32_Security_ExtensibleAuthenticationProtocol",
    feature = "Win32_System_RemoteDesktop"
))]
pub type DOT11EXTIHV_INIT_SERVICE = Option<
    unsafe extern "system" fn(
        dwvernumused: u32,
        pdot11extapi: *const DOT11EXT_APIS,
        pvreserved: *const core::ffi::c_void,
        pdot11ihvhandlers: *mut DOT11EXT_IHV_HANDLERS,
    ) -> u32,
>;
pub type DOT11EXTIHV_INIT_VIRTUAL_STATION = Option<
    unsafe extern "system" fn(
        pdot11extvsapi: *const DOT11EXT_VIRTUAL_STATION_APIS,
        pvreserved: *const core::ffi::c_void,
    ) -> u32,
>;
pub type DOT11EXTIHV_IS_UI_REQUEST_PENDING = Option<
    unsafe extern "system" fn(
        guiduirequest: windows_core::GUID,
        pbisrequestpending: *mut windows_core::BOOL,
    ) -> u32,
>;
#[cfg(feature = "Win32_Security_ExtensibleAuthenticationProtocol")]
pub type DOT11EXTIHV_ONEX_INDICATE_RESULT = Option<
    unsafe extern "system" fn(
        hihvextadapter: super::super::Foundation::HANDLE,
        msonexresult: DOT11_MSONEX_RESULT,
        pdot11msonexresultparams: *const DOT11_MSONEX_RESULT_PARAMS,
    ) -> u32,
>;
#[cfg(feature = "Win32_Security_ExtensibleAuthenticationProtocol")]
pub type DOT11EXTIHV_PERFORM_CAPABILITY_MATCH = Option<
    unsafe extern "system" fn(
        hihvextadapter: super::super::Foundation::HANDLE,
        pihvprofileparams: *const DOT11EXT_IHV_PROFILE_PARAMS,
        pihvconnprofile: *const DOT11EXT_IHV_CONNECTIVITY_PROFILE,
        pihvsecprofile: *const DOT11EXT_IHV_SECURITY_PROFILE,
        pconnectablebssid: *const DOT11_BSS_LIST,
        pdwreasoncode: *mut u32,
    ) -> u32,
>;
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
pub type DOT11EXTIHV_PERFORM_POST_ASSOCIATE = Option<
    unsafe extern "system" fn(
        hihvextadapter: super::super::Foundation::HANDLE,
        hsecuritysessionid: super::super::Foundation::HANDLE,
        pportstate: *const DOT11_PORT_STATE,
        udot11assocparamsbytes: u32,
        pdot11assocparams: *const DOT11_ASSOCIATION_COMPLETION_PARAMETERS,
    ) -> u32,
>;
#[cfg(feature = "Win32_Security_ExtensibleAuthenticationProtocol")]
pub type DOT11EXTIHV_PERFORM_PRE_ASSOCIATE = Option<
    unsafe extern "system" fn(
        hihvextadapter: super::super::Foundation::HANDLE,
        hconnectsession: super::super::Foundation::HANDLE,
        pihvprofileparams: *const DOT11EXT_IHV_PROFILE_PARAMS,
        pihvconnprofile: *const DOT11EXT_IHV_CONNECTIVITY_PROFILE,
        pihvsecprofile: *const DOT11EXT_IHV_SECURITY_PROFILE,
        pconnectablebssid: *const DOT11_BSS_LIST,
...
pub type DOT11EXTIHV_PROCESS_SESSION_CHANGE = Option<
    unsafe extern "system" fn(
        ueventtype: u32,
        psessionnotification: *const super::super::System::RemoteDesktop::WTSSESSION_NOTIFICATION,
    ) -> u32,
>;
pub type DOT11EXTIHV_PROCESS_UI_RESPONSE = Option<
    unsafe extern "system" fn(
        guiduirequest: windows_core::GUID,
        dwbytecount: u32,
        pvresponsebuffer: *const core::ffi::c_void,
    ) -> u32,
>;
pub type DOT11EXTIHV_QUERY_UI_REQUEST = Option<
    unsafe extern "system" fn(
        hihvextadapter: super::super::Foundation::HANDLE,
        connectionphase: DOT11EXT_IHV_CONNECTION_PHASE,
        ppihvuirequest: *mut *mut DOT11EXT_IHV_UI_REQUEST,
    ) -> u32,
>;
pub type DOT11EXTIHV_RECEIVE_INDICATION = Option<
    unsafe extern "system" fn(
        hihvextadapter: super::super::Foundation::HANDLE,
...
>;
pub type DOT11EXTIHV_RECEIVE_PACKET = Option<
    unsafe extern "system" fn(
        hihvextadapter: super::super::Foundation::HANDLE,
        dwinbuffersize: u32,
        pvinbuffer: *const core::ffi::c_void,
    ) -> u32,
>;
pub type DOT11EXTIHV_SEND_PACKET_COMPLETION =
    Option<unsafe extern "system" fn(hsendcompletion: super::super::Foundation::HANDLE) -> u32>;
pub type DOT11EXTIHV_STOP_POST_ASSOCIATE = Option<
    unsafe extern "system" fn(
        hihvextadapter: super::super::Foundation::HANDLE,
        ppeer: *const *const u8,
        dot11assocstatus: u32,
    ) -> u32,
>;
#[cfg(feature = "Win32_Security_ExtensibleAuthenticationProtocol")]
pub type DOT11EXTIHV_VALIDATE_PROFILE = Option<
    unsafe extern "system" fn(
        hihvextadapter: super::super::Foundation::HANDLE,
        pihvprofileparams: *const DOT11EXT_IHV_PROFILE_PARAMS,
        pihvconnprofile: *const DOT11EXT_IHV_CONNECTIVITY_PROFILE,
...
>;
pub type DOT11EXT_ALLOCATE_BUFFER = Option<
    unsafe extern "system" fn(dwbytecount: u32, ppvbuffer: *mut *mut core::ffi::c_void) -> u32,
>;
#[repr(C)]
#[cfg(all(
    feature = "Win32_NetworkManagement_Ndis",
...
pub type DOT11EXT_FREE_BUFFER =
    Option<unsafe extern "system" fn(pvmemory: *const core::ffi::c_void)>;
pub type DOT11EXT_GET_PROFILE_CUSTOM_USER_DATA = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        hconnectsession: super::super::Foundation::HANDLE,
        dwsessionid: u32,
...
pub type DOT11EXT_NIC_SPECIFIC_EXTENSION = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        dwinbuffersize: u32,
        pvinbuffer: *const core::ffi::c_void,
        pdwoutbuffersize: *mut u32,
        pvoutbuffer: *mut core::ffi::c_void,
    ) -> u32,
>;
#[cfg(feature = "Win32_Security_ExtensibleAuthenticationProtocol")]
...
pub type DOT11EXT_ONEX_STOP =
    Option<unsafe extern "system" fn(hdot11svchandle: super::super::Foundation::HANDLE) -> u32>;
pub type DOT11EXT_POST_ASSOCIATE_COMPLETION = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        hsecuritysessionid: super::super::Foundation::HANDLE,
        ppeer: *const *const u8,
...
>;
pub type DOT11EXT_PRE_ASSOCIATE_COMPLETION = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        hconnectsession: super::super::Foundation::HANDLE,
        dwreasoncode: u32,
...
>;
pub type DOT11EXT_PROCESS_ONEX_PACKET = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        dwinpacketsize: u32,
        pvinpacket: *const core::ffi::c_void,
    ) -> u32,
>;
pub const DOT11EXT_PSK_MAX_LENGTH: u32 = 64u32;
pub type DOT11EXT_QUERY_VIRTUAL_STATION_PROPERTIES = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        pbisvirtualstation: *mut windows_core::BOOL,
        pgprimary: *mut windows_core::GUID,
        pvreserved: *const core::ffi::c_void,
    ) -> u32,
>;
pub type DOT11EXT_RELEASE_VIRTUAL_STATION = Option<
    unsafe extern "system" fn(
        hdot11primaryhandle: super::super::Foundation::HANDLE,
        pvreserved: *const core::ffi::c_void,
    ) -> u32,
>;
pub type DOT11EXT_REQUEST_VIRTUAL_STATION = Option<
    unsafe extern "system" fn(
        hdot11primaryhandle: super::super::Foundation::HANDLE,
        pvreserved: *const core::ffi::c_void,
    ) -> u32,
>;
pub type DOT11EXT_SEND_NOTIFICATION = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        pnotificationdata: *const L2_NOTIFICATION_DATA,
    ) -> u32,
>;
pub type DOT11EXT_SEND_PACKET = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        upacketlen: u32,
        pvpacket: *const core::ffi::c_void,
        hsendcompletion: super::super::Foundation::HANDLE,
    ) -> u32,
>;
pub type DOT11EXT_SEND_UI_REQUEST = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        pihvuirequest: *const DOT11EXT_IHV_UI_REQUEST,
    ) -> u32,
>;
pub type DOT11EXT_SET_AUTH_ALGORITHM = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        dwauthalgo: u32,
    ) -> u32,
>;
pub type DOT11EXT_SET_CURRENT_PROFILE = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        hconnectsession: super::super::Foundation::HANDLE,
        pihvconnprofile: *const DOT11EXT_IHV_CONNECTIVITY_PROFILE,
...
>;
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
pub type DOT11EXT_SET_DEFAULT_KEY = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        pkey: *const DOT11_CIPHER_DEFAULT_KEY_VALUE,
        dot11direction: DOT11_DIRECTION,
    ) -> u32,
>;
pub type DOT11EXT_SET_DEFAULT_KEY_ID = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        udefaultkeyid: u32,
    ) -> u32,
>;
pub type DOT11EXT_SET_ETHERTYPE_HANDLING = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        umaxbacklog: u32,
        unumofexemption: u32,
        pexemption: *const DOT11_PRIVACY_EXEMPTION,
        unumofregistration: u32,
        pusregistration: *const u16,
    ) -> u32,
>;
pub type DOT11EXT_SET_EXCLUDE_UNENCRYPTED = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        bexcludeunencrypted: windows_core::BOOL,
    ) -> u32,
>;
pub type DOT11EXT_SET_KEY_MAPPING_KEY = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        pkey: *const DOT11_CIPHER_KEY_MAPPING_KEY_VALUE,
    ) -> u32,
>;
pub type DOT11EXT_SET_MULTICAST_CIPHER_ALGORITHM = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        dwmulticastcipheralgo: u32,
    ) -> u32,
>;
pub type DOT11EXT_SET_PROFILE_CUSTOM_USER_DATA = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        hconnectsession: super::super::Foundation::HANDLE,
        dwsessionid: u32,
...
>;
pub type DOT11EXT_SET_UNICAST_CIPHER_ALGORITHM = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        dwunicastcipheralgo: u32,
    ) -> u32,
>;
pub type DOT11EXT_SET_VIRTUAL_STATION_AP_PROPERTIES = Option<
    unsafe extern "system" fn(
        hdot11svchandle: super::super::Foundation::HANDLE,
        hconnectsession: super::super::Foundation::HANDLE,
        dwnumproperties: u32,
        pproperties: *const DOT11EXT_VIRTUAL_STATION_AP_PROPERTY,
        pvreserved: *const core::ffi::c_void,
    ) -> u32,
>;
#[repr(C)]
...
pub const DevProp_PciDevice_AcsCompatibleUpHierarchy_Enhanced:
    DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY = DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY(4u32);
pub const DevProp_PciDevice_AcsCompatibleUpHierarchy_NoP2PSupported:
    DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY = DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY(2u32);
pub const DevProp_PciDevice_AcsCompatibleUpHierarchy_NotSupported:
    DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY = DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY(0u32);
pub const DevProp_PciDevice_AcsCompatibleUpHierarchy_SingleFunctionSupported:
    DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY = DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY(1u32);
pub const DevProp_PciDevice_AcsCompatibleUpHierarchy_Supported:
    DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY = DEVPROP_PCIDEVICE_ACSCOMPATIBLEUPHIERARCHY(3u32);
pub const DevProp_PciDevice_AcsSupport_Missing: DEVPROP_PCIDEVICE_ACSSUPPORT =
    DEVPROP_PCIDEVICE_ACSSUPPORT(2u32);
pub const DevProp_PciDevice_AcsSupport_NotNeeded: DEVPROP_PCIDEVICE_ACSSUPPORT =
    DEVPROP_PCIDEVICE_ACSSUPPORT(1u32);
pub const DevProp_PciDevice_AcsSupport_Present: DEVPROP_PCIDEVICE_ACSSUPPORT =
    DEVPROP_PCIDEVICE_ACSSUPPORT(0u32);
pub const DevProp_PciDevice_BridgeType_PciConventional: DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE =
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(6u32);
pub const DevProp_PciDevice_BridgeType_PciExpressDownstreamSwitchPort:
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(10u32);
pub const DevProp_PciDevice_BridgeType_PciExpressEventCollector:
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(14u32);
pub const DevProp_PciDevice_BridgeType_PciExpressRootPort: DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE =
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(8u32);
pub const DevProp_PciDevice_BridgeType_PciExpressToPciXBridge: DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE =
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(11u32);
pub const DevProp_PciDevice_BridgeType_PciExpressTreatedAsPci: DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE =
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(13u32);
pub const DevProp_PciDevice_BridgeType_PciExpressUpstreamSwitchPort:
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(9u32);
pub const DevProp_PciDevice_BridgeType_PciX: DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE =
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(7u32);
pub const DevProp_PciDevice_BridgeType_PciXToExpressBridge: DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE =
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(12u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode1_100Mhz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(2u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode1_133MHZ:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(3u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode1_66Mhz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(1u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode1_ECC_100Mhz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(6u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode1_ECC_133Mhz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(7u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode1_ECC_66Mhz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(5u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode2_266_100MHz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(10u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode2_266_133MHz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(11u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode2_266_66MHz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(9u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode2_533_100MHz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(14u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode2_533_133MHz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(15u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode2_533_66MHz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(13u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_PciX_Mode_Conventional_Pci:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(0u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_Pci_Conventional_33MHz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(0u32);
pub const DevProp_PciDevice_CurrentSpeedAndMode_Pci_Conventional_66MHz:
    DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE = DEVPROP_PCIDEVICE_CURRENTSPEEDANDMODE(1u32);
pub const DevProp_PciDevice_DeviceType_PciConventional: DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE =
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(0u32);
pub const DevProp_PciDevice_DeviceType_PciExpressEndpoint: DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE =
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(2u32);
pub const DevProp_PciDevice_DeviceType_PciExpressLegacyEndpoint:
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(3u32);
pub const DevProp_PciDevice_DeviceType_PciExpressRootComplexIntegratedEndpoint:
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE = DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(4u32);
pub const DevProp_PciDevice_DeviceType_PciExpressTreatedAsPci: DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE =
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(5u32);
pub const DevProp_PciDevice_DeviceType_PciX: DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE =
    DEVPROP_PCIDEVICE_DEVICEBRIDGETYPE(1u32);
pub const DevProp_PciDevice_InterruptType_LineBased: DEVPROP_PCIDEVICE_INTERRUPTTYPE =
    DEVPROP_PCIDEVICE_INTERRUPTTYPE(1u32);
pub const DevProp_PciDevice_InterruptType_Msi: DEVPROP_PCIDEVICE_INTERRUPTTYPE =
    DEVPROP_PCIDEVICE_INTERRUPTTYPE(2u32);
pub const DevProp_PciDevice_InterruptType_MsiX: DEVPROP_PCIDEVICE_INTERRUPTTYPE =
    DEVPROP_PCIDEVICE_INTERRUPTTYPE(4u32);
pub const DevProp_PciDevice_SriovSupport_DidntGetVfBarSpace: DEVPROP_PCIDEVICE_SRIOVSUPPORT =
    DEVPROP_PCIDEVICE_SRIOVSUPPORT(4u32);
pub const DevProp_PciDevice_SriovSupport_MissingAcs: DEVPROP_PCIDEVICE_SRIOVSUPPORT =
    DEVPROP_PCIDEVICE_SRIOVSUPPORT(1u32);
pub const DevProp_PciDevice_SriovSupport_MissingPfDriver: DEVPROP_PCIDEVICE_SRIOVSUPPORT =
    DEVPROP_PCIDEVICE_SRIOVSUPPORT(2u32);
pub const DevProp_PciDevice_SriovSupport_NoBusResource: DEVPROP_PCIDEVICE_SRIOVSUPPORT =
    DEVPROP_PCIDEVICE_SRIOVSUPPORT(3u32);
pub const DevProp_PciDevice_SriovSupport_Ok: DEVPROP_PCIDEVICE_SRIOVSUPPORT =
    DEVPROP_PCIDEVICE_SRIOVSUPPORT(0u32);
pub const DevProp_PciExpressDevice_LinkSpeed_Five_Gbps: DEVPROP_PCIEXPRESSDEVICE_LINKSPEED =
    DEVPROP_PCIEXPRESSDEVICE_LINKSPEED(2u32);
pub const DevProp_PciExpressDevice_LinkSpeed_TwoAndHalf_Gbps: DEVPROP_PCIEXPRESSDEVICE_LINKSPEED =
    DEVPROP_PCIEXPRESSDEVICE_LINKSPEED(1u32);
pub const DevProp_PciExpressDevice_LinkWidth_By_1: DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH =
    DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH(1u32);
pub const DevProp_PciExpressDevice_LinkWidth_By_12: DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH =
    DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH(12u32);
pub const DevProp_PciExpressDevice_LinkWidth_By_16: DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH =
    DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH(16u32);
pub const DevProp_PciExpressDevice_LinkWidth_By_2: DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH =
    DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH(2u32);
pub const DevProp_PciExpressDevice_LinkWidth_By_32: DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH =
    DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH(32u32);
pub const DevProp_PciExpressDevice_LinkWidth_By_4: DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH =
    DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH(4u32);
pub const DevProp_PciExpressDevice_LinkWidth_By_8: DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH =
    DEVPROP_PCIEXPRESSDEVICE_LINKWIDTH(8u32);
pub const DevProp_PciExpressDevice_PayloadOrRequestSize_1024Bytes:
    DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE =
    DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE(3u32);
pub const DevProp_PciExpressDevice_PayloadOrRequestSize_128Bytes:
    DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE =
    DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE(0u32);
pub const DevProp_PciExpressDevice_PayloadOrRequestSize_2048Bytes:
    DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE =
    DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE(4u32);
pub const DevProp_PciExpressDevice_PayloadOrRequestSize_256Bytes:
    DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE =
    DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE(1u32);
pub const DevProp_PciExpressDevice_PayloadOrRequestSize_4096Bytes:
    DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE =
    DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE(5u32);
pub const DevProp_PciExpressDevice_PayloadOrRequestSize_512Bytes:
    DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE =
    DEVPROP_PCIEXPRESSDEVICE_PAYLOADORREQUESTSIZE(2u32);
pub const DevProp_PciExpressDevice_Spec_Version_10: DEVPROP_PCIEXPRESSDEVICE_SPEC_VERSION =
    DEVPROP_PCIEXPRESSDEVICE_SPEC_VERSION(1u32);
pub const DevProp_PciExpressDevice_Spec_Version_11: DEVPROP_PCIEXPRESSDEVICE_SPEC_VERSION =
    DEVPROP_PCIEXPRESSDEVICE_SPEC_VERSION(2u32);
pub const DevProp_PciRootBus_BusWidth_32Bits: DEVPROP_PCIROOTBUS_BUSWIDTH =
    DEVPROP_PCIROOTBUS_BUSWIDTH(0u32);
pub const DevProp_PciRootBus_BusWidth_64Bits: DEVPROP_PCIROOTBUS_BUSWIDTH =
    DEVPROP_PCIROOTBUS_BUSWIDTH(1u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_Conventional_33Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(0u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_Conventional_66Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(1u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_266_Mode2_100Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(9u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_266_Mode2_133Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(10u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_266_Mode2_66Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(8u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_533_Mode2_100Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(12u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_533_Mode2_133Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(13u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_533_Mode2_66Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(11u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_Mode1_100Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(3u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_Mode1_133Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(4u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_Mode1_66Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(2u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_Mode1_ECC_100Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(6u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_Mode1_ECC_133Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(7u32);
pub const DevProp_PciRootBus_CurrentSpeedAndMode_Pci_X_Mode1_ECC_66Mhz:
    DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE = DEVPROP_PCIROOTBUS_CURRENTSPEEDANDMODE(5u32);
pub const DevProp_PciRootBus_SecondaryInterface_PciConventional:
    DEVPROP_PCIROOTBUS_SECONDARYINTERFACE = DEVPROP_PCIROOTBUS_SECONDARYINTERFACE(0u32);
pub const DevProp_PciRootBus_SecondaryInterface_PciExpress: DEVPROP_PCIROOTBUS_SECONDARYINTERFACE =
    DEVPROP_PCIROOTBUS_SECONDARYINTERFACE(3u32);
pub const DevProp_PciRootBus_SecondaryInterface_PciXMode1: DEVPROP_PCIROOTBUS_SECONDARYINTERFACE =
    DEVPROP_PCIROOTBUS_SECONDARYINTERFACE(1u32);
pub const DevProp_PciRootBus_SecondaryInterface_PciXMode2: DEVPROP_PCIROOTBUS_SECONDARYINTERFACE =
    DEVPROP_PCIROOTBUS_SECONDARYINTERFACE(2u32);
pub const DevProp_PciRootBus_SupportedSpeedsAndModes_Pci_Conventional_33Mhz:
    DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES = DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES(1u32);
pub const DevProp_PciRootBus_SupportedSpeedsAndModes_Pci_Conventional_66Mhz:
    DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES = DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES(2u32);
pub const DevProp_PciRootBus_SupportedSpeedsAndModes_Pci_X_133Mhz:
    DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES = DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES(8u32);
pub const DevProp_PciRootBus_SupportedSpeedsAndModes_Pci_X_266Mhz:
    DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES = DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES(16u32);
pub const DevProp_PciRootBus_SupportedSpeedsAndModes_Pci_X_533Mhz:
    DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES = DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES(32u32);
pub const DevProp_PciRootBus_SupportedSpeedsAndModes_Pci_X_66Mhz:
    DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES = DEVPROP_PCIROOTBUS_SUPPORTEDSPEEDSANDMODES(4u32);
pub const Dot11AdHocManager: windows_core::GUID =
    windows_core::GUID::from_u128(0xdd06a84f_83bd_4d01_8ab9_2389fea0869e);
pub const GUID_AEPSERVICE_WIFIDIRECT_DEVICE: windows_core::GUID =
    windows_core::GUID::from_u128(0xcc29827c_9caf_4928_99a9_18f7c2381389);
pub const GUID_DEVINTERFACE_ASP_INFRA_DEVICE: windows_core::GUID =
    windows_core::GUID::from_u128(0xff823995_7a72_4c80_8757_c67ee13d1a49);
pub const GUID_DEVINTERFACE_WIFIDIRECT_DEVICE: windows_core::GUID =
    windows_core::GUID::from_u128(0x439b20af_8955_405b_99f0_a62af0c68d43);
windows_core::imp::define_interface!(
    IDot11AdHocInterface,
    IDot11AdHocInterface_Vtbl,
    0x8f10cc2b_cf0d_42a0_acbe_e2de7007384d
);
...
impl IDot11AdHocInterface {
    pub unsafe fn GetDeviceSignature(
        &self,
        psignature: *mut windows_core::GUID,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetDeviceSignature)(
    ...
    pub unsafe fn IsDot11d(&self, pf11d: *mut u8) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).IsDot11d)(
                windows_core::Interface::as_raw(self),
                pf11d as _,
            )
            .ok()
    ...
    pub unsafe fn IsAdHocCapable(&self, pfadhoccapable: *mut u8) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).IsAdHocCapable)(
                windows_core::Interface::as_raw(self),
                pfadhoccapable as _,
            )
            .ok()
    ...
    pub unsafe fn IsRadioOn(&self, pfisradioon: *mut u8) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).IsRadioOn)(
                windows_core::Interface::as_raw(self),
                pfisradioon as _,
            )
            .ok()
    ...
    pub unsafe fn GetActiveNetwork(&self) -> windows_core::Result<IDot11AdHocNetwork> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetActiveNetwork)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
    ...
    pub unsafe fn GetIEnumSecuritySettings(
        &self,
    ) -> windows_core::Result<IEnumDot11AdHocSecuritySettings> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetIEnumSecuritySettings)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetIEnumDot11AdHocNetworks(
        &self,
        pfilterguid: *const windows_core::GUID,
    ) -> windows_core::Result<IEnumDot11AdHocNetworks> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetIEnumDot11AdHocNetworks)(
                windows_core::Interface::as_raw(self),
                pfilterguid,
                &mut result__,
            )
...
pub struct IDot11AdHocInterface_Vtbl {
    ...
    pub GetDeviceSignature: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub IsRadioOn:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub GetActiveNetwork: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetIEnumSecuritySettings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetIEnumDot11AdHocNetworks: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub GetStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut DOT11_ADHOC_NETWORK_CONNECTION_STATUS,
    ) -> windows_core::HRESULT,
}
...
impl IDot11AdHocInterface_Vtbl {
    pub const fn new<Identity: IDot11AdHocInterface_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDeviceSignature<
        ...
        >(
            ...
            unsafe {
                ...
                IDot11AdHocInterface_Impl::GetDeviceSignature(
                    this,
                    core::mem::transmute_copy(&psignature),
                )
                .into()
            }
        }
        ...
        unsafe extern "system" fn IsDot11d<
            Identity: IDot11AdHocInterface_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn IsAdHocCapable<
            Identity: IDot11AdHocInterface_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocInterface_Impl::IsAdHocCapable(
                    this,
                    core::mem::transmute_copy(&pfadhoccapable),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsRadioOn<
            Identity: IDot11AdHocInterface_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocInterface_Impl::IsRadioOn(this, core::mem::transmute_copy(&pfisradioon))
                    .into()
            }
        }
        unsafe extern "system" fn GetActiveNetwork<
            Identity: IDot11AdHocInterface_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppnetwork: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetIEnumSecuritySettings<
            Identity: IDot11AdHocInterface_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetIEnumDot11AdHocNetworks<
            Identity: IDot11AdHocInterface_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDot11AdHocInterface_Impl::GetIEnumDot11AdHocNetworks(
                    this,
                    core::mem::transmute_copy(&pfilterguid),
                ) {
                    Ok(ok__) => {
                        ppenum.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocInterface_Impl::GetStatus(this, core::mem::transmute_copy(&pstate))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    IDot11AdHocInterfaceNotificationSink_Vtbl,
    0x8f10cc2f_cf0d_42a0_acbe_e2de7007384d
);
...
impl IDot11AdHocInterfaceNotificationSink {
    pub unsafe fn OnConnectionStatusChange(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).OnConnectionStatusChange)(
                windows_core::Interface::as_raw(self),
                estatus,
            )
            .ok()
...
pub struct IDot11AdHocInterfaceNotificationSink_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OnConnectionStatusChange: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IDot11AdHocInterfaceNotificationSink_Vtbl {
    pub const fn new<Identity: IDot11AdHocInterfaceNotificationSink_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn OnConnectionStatusChange<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocInterfaceNotificationSink_Impl::OnConnectionStatusChange(
                    this,
                    core::mem::transmute_copy(&estatus),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            OnConnectionStatusChange: OnConnectionStatusChange::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IDot11AdHocManager {
    pub unsafe fn CreateNetwork<P0, P1, P3, P4>(
        ...
        pinterface: P3,
        psecurity: P4,
        pcontextguid: *const windows_core::GUID,
    ) -> windows_core::Result<IDot11AdHocNetwork>
    where
        ...
        P4: windows_core::Param<IDot11AdHocSecuritySettings>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateNetwork)(
                windows_core::Interface::as_raw(self),
                name.param().abi(),
                password.param().abi(),
                geographicalid,
                pinterface.param().abi(),
                psecurity.param().abi(),
                pcontextguid,
                &mut result__,
            )
    ...
    pub unsafe fn CommitCreatedNetwork<P0>(
        &self,
        piadhoc: P0,
        fsaveprofile: bool,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CommitCreatedNetwork)(
                windows_core::Interface::as_raw(self),
                piadhoc.param().abi(),
                fsaveprofile,
    ...
    pub unsafe fn GetIEnumDot11AdHocInterfaces(
        &self,
    ) -> windows_core::Result<IEnumDot11AdHocInterfaces> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetIEnumDot11AdHocInterfaces)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetNetwork(
        &self,
        networksignature: *const windows_core::GUID,
    ) -> windows_core::Result<IDot11AdHocNetwork> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNetwork)(
                windows_core::Interface::as_raw(self),
                networksignature,
                &mut result__,
            )
...
pub struct IDot11AdHocManager_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateNetwork: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        i32,
    ...
    pub CommitCreatedNetwork: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        bool,
        bool,
    ...
    pub GetIEnumDot11AdHocInterfaces: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetNetwork: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IDot11AdHocManager_Impl: windows_core::IUnknownImpl {
    fn CreateNetwork(
        ...
        geographicalid: i32,
        pinterface: windows_core::Ref<'_, IDot11AdHocInterface>,
        psecurity: windows_core::Ref<'_, IDot11AdHocSecuritySettings>,
        pcontextguid: *const windows_core::GUID,
    ) -> windows_core::Result<IDot11AdHocNetwork>;
    fn CommitCreatedNetwork(
        &self,
        piadhoc: windows_core::Ref<'_, IDot11AdHocNetwork>,
        fsaveprofile: bool,
        fmakesavedprofileuserspecific: bool,
    ) -> windows_core::Result<()>;
    fn GetIEnumDot11AdHocNetworks(
...
impl IDot11AdHocManager_Vtbl {
    pub const fn new<Identity: IDot11AdHocManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            password: windows_core::PCWSTR,
            geographicalid: i32,
            pinterface: *mut core::ffi::c_void,
            psecurity: *mut core::ffi::c_void,
            pcontextguid: *const windows_core::GUID,
            piadhoc: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDot11AdHocManager_Impl::CreateNetwork(
                    this,
                    core::mem::transmute(&name),
                    core::mem::transmute(&password),
                    core::mem::transmute_copy(&geographicalid),
                    core::mem::transmute_copy(&pinterface),
                    core::mem::transmute_copy(&psecurity),
                    core::mem::transmute_copy(&pcontextguid),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocManager_Impl::CommitCreatedNetwork(
                    this,
                    core::mem::transmute_copy(&piadhoc),
                    core::mem::transmute_copy(&fsaveprofile),
                    core::mem::transmute_copy(&fmakesavedprofileuserspecific),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDot11AdHocManager_Impl::GetIEnumDot11AdHocNetworks(
                    this,
                    core::mem::transmute_copy(&pcontextguid),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetIEnumDot11AdHocInterfaces<
            Identity: IDot11AdHocManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetNetwork<
            Identity: IDot11AdHocManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            networksignature: *const windows_core::GUID,
            pnetwork: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDot11AdHocManager_Impl::GetNetwork(
                    this,
                    core::mem::transmute_copy(&networksignature),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    IDot11AdHocManagerNotificationSink_Vtbl,
    0x8f10cc27_cf0d_42a0_acbe_e2de7007384d
);
...
impl IDot11AdHocManagerNotificationSink {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnNetworkAdd)(
                windows_core::Interface::as_raw(self),
                piadhocnetwork.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn OnNetworkRemove(
        &self,
        signature: *const windows_core::GUID,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OnNetworkRemove)(
                windows_core::Interface::as_raw(self),
                signature,
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OnInterfaceAdd)(
                windows_core::Interface::as_raw(self),
                piadhocinterface.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn OnInterfaceRemove(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).OnInterfaceRemove)(
                windows_core::Interface::as_raw(self),
                signature,
            )
            .ok()
...
pub struct IDot11AdHocManagerNotificationSink_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OnNetworkAdd: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OnNetworkRemove: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub OnInterfaceAdd: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OnInterfaceRemove: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
}
pub trait IDot11AdHocManagerNotificationSink_Impl: windows_core::IUnknownImpl {
    fn OnNetworkAdd(
        &self,
        piadhocnetwork: windows_core::Ref<'_, IDot11AdHocNetwork>,
    ) -> windows_core::Result<()>;
    fn OnNetworkRemove(&self, signature: *const windows_core::GUID) -> windows_core::Result<()>;
    fn OnInterfaceAdd(
        &self,
        piadhocinterface: windows_core::Ref<'_, IDot11AdHocInterface>,
    ) -> windows_core::Result<()>;
...
impl IDot11AdHocManagerNotificationSink_Vtbl {
    pub const fn new<Identity: IDot11AdHocManagerNotificationSink_Impl, const OFFSET: isize>(
    ) -> Self {
        unsafe extern "system" fn OnNetworkAdd<
            Identity: IDot11AdHocManagerNotificationSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            piadhocnetwork: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocManagerNotificationSink_Impl::OnNetworkAdd(
                    this,
                    core::mem::transmute_copy(&piadhocnetwork),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocManagerNotificationSink_Impl::OnNetworkRemove(
                    this,
        ...
        unsafe extern "system" fn OnInterfaceAdd<
            Identity: IDot11AdHocManagerNotificationSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            piadhocinterface: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocManagerNotificationSink_Impl::OnInterfaceAdd(
                    this,
                    core::mem::transmute_copy(&piadhocinterface),
                )
                .into()
            }
        }
        unsafe extern "system" fn OnInterfaceRemove<
            Identity: IDot11AdHocManagerNotificationSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocManagerNotificationSink_Impl::OnInterfaceRemove(
                    this,
                    core::mem::transmute_copy(&signature),
                )
                .into()
...
windows_core::imp::define_interface!(
    IDot11AdHocNetwork,
    IDot11AdHocNetwork_Vtbl,
    0x8f10cc29_cf0d_42a0_acbe_e2de7007384d
);
...
impl IDot11AdHocNetwork {
    ...
    pub unsafe fn GetSSID(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSSID)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn HasProfile(&self, pf11d: *mut u8) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).HasProfile)(
                windows_core::Interface::as_raw(self),
                pf11d as _,
            )
            .ok()
    ...
    pub unsafe fn GetProfileName(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetProfileName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn DeleteProfile(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteProfile)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn GetSignalQuality(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetSignalQuality)(
                windows_core::Interface::as_raw(self),
                pustrengthvalue as _,
                pustrengthmax as _,
            )
            .ok()
        }
    ...
    pub unsafe fn GetSecuritySetting(&self) -> windows_core::Result<IDot11AdHocSecuritySettings> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSecuritySetting)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetContextGuid(
        &self,
        pcontextguid: *mut windows_core::GUID,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetContextGuid)(
                windows_core::Interface::as_raw(self),
                pcontextguid as _,
            )
            .ok()
...
pub struct IDot11AdHocNetwork_Vtbl {
    ...
    pub GetSSID: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub HasProfile:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8) -> windows_core::HRESULT,
    pub GetProfileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub DeleteProfile: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub GetSignalQuality: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetSecuritySetting: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetContextGuid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::GUID,
    ) -> windows_core::HRESULT,
...
pub trait IDot11AdHocNetwork_Impl: windows_core::IUnknownImpl {
    ...
    fn Connect(
        &self,
        passphrase: &windows_core::PCWSTR,
        geographicalid: i32,
        fsaveprofile: bool,
        fmakesavedprofileuserspecific: bool,
    ) -> windows_core::Result<()>;
...
impl IDot11AdHocNetwork_Vtbl {
    pub const fn new<Identity: IDot11AdHocNetwork_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetSSID<
            Identity: IDot11AdHocNetwork_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppszwssid: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn HasProfile<
            Identity: IDot11AdHocNetwork_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetProfileName<
            Identity: IDot11AdHocNetwork_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppszwprofilename: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetSignalQuality<
            Identity: IDot11AdHocNetwork_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocNetwork_Impl::GetSignalQuality(
                    this,
                    core::mem::transmute_copy(&pustrengthvalue),
                    core::mem::transmute_copy(&pustrengthmax),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetSecuritySetting<
            Identity: IDot11AdHocNetwork_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            padhocsecuritysetting: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocNetwork_Impl::GetContextGuid(
                    this,
                    core::mem::transmute_copy(&pcontextguid),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocNetwork_Impl::GetSignature(this, core::mem::transmute_copy(&psignature))
                    .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            padhocinterface: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocNetwork_Impl::Connect(
                    this,
                    core::mem::transmute(&passphrase),
                    core::mem::transmute_copy(&geographicalid),
                    core::mem::transmute_copy(&fsaveprofile),
                    core::mem::transmute_copy(&fmakesavedprofileuserspecific),
                )
...
windows_core::imp::define_interface!(
    ...
    IDot11AdHocNetworkNotificationSink_Vtbl,
    0x8f10cc2a_cf0d_42a0_acbe_e2de7007384d
);
...
impl IDot11AdHocNetworkNotificationSink {
    ...
    pub unsafe fn OnConnectFail(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).OnConnectFail)(
                windows_core::Interface::as_raw(self),
                efailreason,
            )
            .ok()
...
pub struct IDot11AdHocNetworkNotificationSink_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OnStatusChange: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        DOT11_ADHOC_NETWORK_CONNECTION_STATUS,
    ) -> windows_core::HRESULT,
    pub OnConnectFail: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IDot11AdHocNetworkNotificationSink_Vtbl {
    pub const fn new<Identity: IDot11AdHocNetworkNotificationSink_Impl, const OFFSET: isize>(
    ) -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocNetworkNotificationSink_Impl::OnStatusChange(
                    this,
                    core::mem::transmute_copy(&estatus),
                )
                .into()
        ...
        unsafe extern "system" fn OnConnectFail<
            Identity: IDot11AdHocNetworkNotificationSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocNetworkNotificationSink_Impl::OnConnectFail(
                    this,
                    core::mem::transmute_copy(&efailreason),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    IDot11AdHocSecuritySettings_Vtbl,
    0x8f10cc2e_cf0d_42a0_acbe_e2de7007384d
);
...
impl IDot11AdHocSecuritySettings {
    pub unsafe fn GetDot11AuthAlgorithm(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetDot11AuthAlgorithm)(
                windows_core::Interface::as_raw(self),
                pauth as _,
            )
            .ok()
    ...
    pub unsafe fn GetDot11CipherAlgorithm(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetDot11CipherAlgorithm)(
                windows_core::Interface::as_raw(self),
                pcipher as _,
            )
            .ok()
...
pub struct IDot11AdHocSecuritySettings_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetDot11AuthAlgorithm: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut DOT11_ADHOC_AUTH_ALGORITHM,
    ) -> windows_core::HRESULT,
    pub GetDot11CipherAlgorithm: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut DOT11_ADHOC_CIPHER_ALGORITHM,
    ) -> windows_core::HRESULT,
}
...
impl IDot11AdHocSecuritySettings_Vtbl {
    pub const fn new<Identity: IDot11AdHocSecuritySettings_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDot11AuthAlgorithm<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocSecuritySettings_Impl::GetDot11AuthAlgorithm(
                    this,
                    core::mem::transmute_copy(&pauth),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetDot11CipherAlgorithm<
            Identity: IDot11AdHocSecuritySettings_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDot11AdHocSecuritySettings_Impl::GetDot11CipherAlgorithm(
                    this,
                    core::mem::transmute_copy(&pcipher),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    IEnumDot11AdHocInterfaces_Vtbl,
...
impl IEnumDot11AdHocInterfaces {
    pub unsafe fn Next(
        &self,
        rgelt: &mut [Option<IDot11AdHocInterface>],
    ...
    pub const fn new<Identity: IEnumDot11AdHocInterfaces_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumDot11AdHocInterfaces_Impl::Next(
                    this,
    ...
    pub const fn new<Identity: IEnumDot11AdHocNetworks_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumDot11AdHocNetworks_Impl::Next(
                    this,
                    core::mem::transmute_copy(&celt),
                    core::mem::transmute_copy(&rgelt),
                    core::mem::transmute_copy(&pceltfetched),
...
windows_core::imp::define_interface!(
    ...
    IEnumDot11AdHocSecuritySettings_Vtbl,
    0x8f10cc2d_cf0d_42a0_acbe_e2de7007384d
);
...
impl IEnumDot11AdHocSecuritySettings {
    pub unsafe fn Next(
        &self,
        rgelt: &mut [Option<IDot11AdHocSecuritySettings>],
        pceltfetched: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Next)(
    ...
    pub const fn new<Identity: IEnumDot11AdHocSecuritySettings_Impl, const OFFSET: isize>() -> Self
    {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumDot11AdHocSecuritySettings_Impl::Next(
                    this,
                    core::mem::transmute_copy(&celt),
                    core::mem::transmute_copy(&rgelt),
                    core::mem::transmute_copy(&pceltfetched),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumDot11AdHocSecuritySettings_Impl::Skip(this, core::mem::transmute_copy(&celt))
                    .into()
            }
        }
        unsafe extern "system" fn Reset<
...
pub const IHV_INIT_VS_FUNCTION_NAME: windows_core::PCSTR =
    windows_core::s!("Dot11ExtIhvInitVirtualStation");
pub const IHV_VERSION_FUNCTION_NAME: windows_core::PCSTR =
    windows_core::s!("Dot11ExtIhvGetVersionInfo");
pub const IndicationTypeLinkQuality: DOT11EXT_IHV_INDICATION_TYPE =
    DOT11EXT_IHV_INDICATION_TYPE(4i32);
pub const IndicationTypeNicSpecificNotification: DOT11EXT_IHV_INDICATION_TYPE =
    DOT11EXT_IHV_INDICATION_TYPE(0i32);
pub const IndicationTypePhyStateChange: DOT11EXT_IHV_INDICATION_TYPE =
    DOT11EXT_IHV_INDICATION_TYPE(3i32);
pub const IndicationTypePmkidCandidateList: DOT11EXT_IHV_INDICATION_TYPE =
    DOT11EXT_IHV_INDICATION_TYPE(1i32);
pub const IndicationTypeTkipMicFailure: DOT11EXT_IHV_INDICATION_TYPE =
    DOT11EXT_IHV_INDICATION_TYPE(2i32);
...
pub type WFD_OPEN_SESSION_COMPLETE_CALLBACK = Option<
    unsafe extern "system" fn(
        hsessionhandle: super::super::Foundation::HANDLE,
        pvcontext: *const core::ffi::c_void,
        guidsessioninterface: windows_core::GUID,
        dwerror: u32,
        dwreasoncode: u32,
    ),
>;
...
pub type WLAN_NOTIFICATION_CALLBACK = Option<
    unsafe extern "system" fn(param0: *mut L2_NOTIFICATION_DATA, param1: *mut core::ffi::c_void),
>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const WLAN_NOTIFICATION_SOURCE_ALL: WLAN_NOTIFICATION_SOURCES =
    WLAN_NOTIFICATION_SOURCES(65535u32);
pub const WLAN_NOTIFICATION_SOURCE_DEVICE_SERVICE: WLAN_NOTIFICATION_SOURCES =
    WLAN_NOTIFICATION_SOURCES(2048u32);
pub const WLAN_NOTIFICATION_SOURCE_HNWK: WLAN_NOTIFICATION_SOURCES =
    WLAN_NOTIFICATION_SOURCES(128u32);
pub const WLAN_NOTIFICATION_SOURCE_IHV: WLAN_NOTIFICATION_SOURCES =
    WLAN_NOTIFICATION_SOURCES(64u32);
pub const WLAN_NOTIFICATION_SOURCE_MSM: WLAN_NOTIFICATION_SOURCES =
    WLAN_NOTIFICATION_SOURCES(16u32);
pub const WLAN_NOTIFICATION_SOURCE_NONE: WLAN_NOTIFICATION_SOURCES =
    WLAN_NOTIFICATION_SOURCES(0u32);
pub const WLAN_NOTIFICATION_SOURCE_ONEX: WLAN_NOTIFICATION_SOURCES =
    WLAN_NOTIFICATION_SOURCES(4u32);
pub const WLAN_NOTIFICATION_SOURCE_SECURITY: WLAN_NOTIFICATION_SOURCES =
    WLAN_NOTIFICATION_SOURCES(32u32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const connection_phase_initial_connection: DOT11EXT_IHV_CONNECTION_PHASE =
    DOT11EXT_IHV_CONNECTION_PHASE(1i32);
pub const connection_phase_post_l3_connection: DOT11EXT_IHV_CONNECTION_PHASE =
    DOT11EXT_IHV_CONNECTION_PHASE(2i32);

...
impl ITpmVirtualSmartCardManager {
    pub unsafe fn CreateVirtualSmartCard<P0, P11>(
        ...
        fgenerate: bool,
        pstatuscallback: P11,
        ppszinstanceid: *mut windows_core::PWSTR,
        pfneedreboot: *mut windows_core::BOOL,
    ) -> windows_core::Result<()>
    where
    ...
    pub unsafe fn DestroyVirtualSmartCard<P0, P1>(
        &self,
        pszinstanceid: P0,
        pstatuscallback: P1,
        ...
        P1: windows_core::Param<ITpmVirtualSmartCardManagerStatusCallback>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).DestroyVirtualSmartCard)(
                windows_core::Interface::as_raw(self),
                pszinstanceid.param().abi(),
                pstatuscallback.param().abi(),
                &mut result__,
            )
            .map(|| result__)
...
pub struct ITpmVirtualSmartCardManager_Vtbl {
    ...
    pub CreateVirtualSmartCard: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u8,
        *const u8,
    ...
    pub DestroyVirtualSmartCard: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
...
pub trait ITpmVirtualSmartCardManager_Impl: windows_core::IUnknownImpl {
    fn CreateVirtualSmartCard(
        &self,
        pszfriendlyname: &windows_core::PCWSTR,
        badminalgid: u8,
        pbadminkey: *const u8,
        cbadminkey: u32,
        pbadminkcv: *const u8,
        ...
        pbpin: *const u8,
        cbpin: u32,
        fgenerate: windows_core::BOOL,
        pstatuscallback: windows_core::Ref<'_, ITpmVirtualSmartCardManagerStatusCallback>,
        ppszinstanceid: *mut windows_core::PWSTR,
        pfneedreboot: *mut windows_core::BOOL,
    ) -> windows_core::Result<()>;
    fn DestroyVirtualSmartCard(
        &self,
        pszinstanceid: &windows_core::PCWSTR,
        pstatuscallback: windows_core::Ref<'_, ITpmVirtualSmartCardManagerStatusCallback>,
    ) -> windows_core::Result<windows_core::BOOL>;
}
impl ITpmVirtualSmartCardManager_Vtbl {
    pub const fn new<Identity: ITpmVirtualSmartCardManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            cbpin: u32,
            fgenerate: windows_core::BOOL,
            pstatuscallback: *mut core::ffi::c_void,
            ppszinstanceid: *mut windows_core::PWSTR,
            pfneedreboot: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn DestroyVirtualSmartCard<
            Identity: ITpmVirtualSmartCardManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ITpmVirtualSmartCardManager_Impl::DestroyVirtualSmartCard(
                    this,
                    core::mem::transmute(&pszinstanceid),
                    core::mem::transmute_copy(&pstatuscallback),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0xfdf8a2b9_02de_47f4_bc26_aa85ab5e5267
);
...
impl ITpmVirtualSmartCardManager2 {
    pub unsafe fn CreateVirtualSmartCardWithPinPolicy<P0, P13>(
        &self,
        pszfriendlyname: P0,
        badminalgid: u8,
        pbadminkey: &[u8],
...
pub struct ITpmVirtualSmartCardManager2_Vtbl {
    ...
    pub CreateVirtualSmartCardWithPinPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u8,
        *const u8,
...
impl ITpmVirtualSmartCardManager2_Vtbl {
    pub const fn new<Identity: ITpmVirtualSmartCardManager2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateVirtualSmartCardWithPinPolicy<
        ...
        Self {
            ...
            CreateVirtualSmartCardWithPinPolicy: CreateVirtualSmartCardWithPinPolicy::<
                Identity,
                OFFSET,
            >,
        }
...
windows_core::imp::define_interface!(
    ...
    0x3c745a97_f375_4150_be17_5950f694c699
);
...
impl ITpmVirtualSmartCardManager3 {
    pub unsafe fn CreateVirtualSmartCardWithAttestation<P0, P14>(
        &self,
        pszfriendlyname: P0,
        badminalgid: u8,
        pbadminkey: &[u8],
...
pub struct ITpmVirtualSmartCardManager3_Vtbl {
    ...
    pub CreateVirtualSmartCardWithAttestation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u8,
        *const u8,
...
impl ITpmVirtualSmartCardManager3_Vtbl {
    pub const fn new<Identity: ITpmVirtualSmartCardManager3_Impl, const OFFSET: isize>() -> Self {
        ...
        Self {
            ...
            CreateVirtualSmartCardWithAttestation: CreateVirtualSmartCardWithAttestation::<
                Identity,
                OFFSET,
            >,
        }
...
windows_core::imp::define_interface!(
    ...
    0x1a1bb35f_abb8_451c_a1ae_33d98f1bef4a
);
windows_core::imp::interface_hierarchy!(
    ITpmVirtualSmartCardManagerStatusCallback,
    windows_core::IUnknown
...
pub struct ITpmVirtualSmartCardManagerStatusCallback_Vtbl {
    ...
    pub ReportError:
        unsafe extern "system" fn(*mut core::ffi::c_void, TPMVSCMGR_ERROR) -> windows_core::HRESULT,
}
    ...
    >() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITpmVirtualSmartCardManagerStatusCallback_Impl::ReportProgress(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITpmVirtualSmartCardManagerStatusCallback_Impl::ReportError(
                    this,
...
pub const RemoteTpmVirtualSmartCardManager: windows_core::GUID =
    windows_core::GUID::from_u128(0x152ea2a8_70dc_4c59_8b2a_32aa3ca0dcac);
#[repr(transparent)]
...
pub const TpmVirtualSmartCardManager: windows_core::GUID =
    windows_core::GUID::from_u128(0x16a18e86_7f6e_4c20_ad89_4ffc0db7a96a);

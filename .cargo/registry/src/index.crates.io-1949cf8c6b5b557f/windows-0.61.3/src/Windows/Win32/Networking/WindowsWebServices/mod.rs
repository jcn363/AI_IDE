...
) -> windows_core::Result<*mut WEBAUTHN_ASSERTION>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ...
        WebAuthNAuthenticatorGetAssertion(
            ...
            pwszrpid.param().abi(),
            pwebauthnclientdata,
            pwebauthngetassertionoptions.unwrap_or(core::mem::zeroed()) as _,
            &mut result__,
        )
        .map(|| result__)
    }
...
pub unsafe fn WebAuthNAuthenticatorMakeCredential(
...
) -> windows_core::Result<*mut WEBAUTHN_CREDENTIAL_ATTESTATION> {
    ...
    unsafe {
        ...
        WebAuthNAuthenticatorMakeCredential(
            ...
            ppubkeycredparams,
            pwebauthnclientdata,
            pwebauthnmakecredentialoptions.unwrap_or(core::mem::zeroed()) as _,
            &mut result__,
        )
        .map(|| result__)
    }
...
pub unsafe fn WebAuthNCancelCurrentOperation(
    pcancellationid: *const windows_core::GUID,
) -> windows_core::Result<()> {
...
pub unsafe fn WebAuthNDeletePlatformCredential(pbcredentialid: &[u8]) -> windows_core::Result<()> {
    ...
    unsafe {
        WebAuthNDeletePlatformCredential(
            pbcredentialid.len().try_into().unwrap(),
            core::mem::transmute(pbcredentialid.as_ptr()),
        )
        .ok()
    }
}
...
pub unsafe fn WebAuthNFreeCredentialAttestation(
    pwebauthncredentialattestation: Option<*const WEBAUTHN_CREDENTIAL_ATTESTATION>,
) {
    ...
    unsafe {
        WebAuthNFreeCredentialAttestation(
            pwebauthncredentialattestation.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn WebAuthNFreePlatformCredentialList(
...
#[inline]
pub unsafe fn WebAuthNGetPlatformCredentialList(
    pgetcredentialsoptions: *const WEBAUTHN_GET_CREDENTIALS_OPTIONS,
) -> windows_core::Result<*mut WEBAUTHN_CREDENTIAL_DETAILS_LIST> {
...
pub unsafe fn WsAcceptChannel(
    ...
    unsafe {
        WsAcceptChannel(
            listener,
            channel,
            asynccontext.unwrap_or(core::mem::zeroed()) as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub unsafe fn WsAsyncExecute(
    ...
    callbackstate: Option<*const core::ffi::c_void>,
    asynccontext: Option<*const WS_ASYNC_CONTEXT>,
    error: Option<*const WS_ERROR>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WsAsyncExecute(
            ...
            operation,
            callbackmodel,
            callbackstate.unwrap_or(core::mem::zeroed()) as _,
            asynccontext.unwrap_or(core::mem::zeroed()) as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
...
pub unsafe fn WsCall(
    ...
    arguments: Option<*const *const core::ffi::c_void>,
    heap: *const WS_HEAP,
...
pub unsafe fn WsCreateChannel(
    ...
    properties: Option<&[WS_CHANNEL_PROPERTY]>,
...
pub unsafe fn WsCreateError(
    properties: Option<&[WS_ERROR_PROPERTY]>,
) -> windows_core::Result<*mut WS_ERROR> {
...
pub unsafe fn WsCreateFaultFromError(
    error: *const WS_ERROR,
    faulterrorcode: windows_core::HRESULT,
...
pub unsafe fn WsCreateHeap(
    maxsize: usize,
    trimsize: usize,
    properties: Option<*const WS_HEAP_PROPERTY>,
    propertycount: u32,
    ...
    unsafe {
        WsCreateHeap(
            maxsize,
            trimsize,
            properties.unwrap_or(core::mem::zeroed()) as _,
            propertycount,
            heap as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
...
pub unsafe fn WsCreateMetadata(
    properties: Option<&[WS_METADATA_PROPERTY]>,
...
pub unsafe fn WsCreateReader(
    properties: Option<&[WS_XML_READER_PROPERTY]>,
...
pub unsafe fn WsCreateServiceEndpointFromTemplate(
    ...
    templatevalue: Option<*const core::ffi::c_void>,
    templatesize: u32,
...
pub unsafe fn WsCreateServiceHost(
    endpoints: Option<&[*const WS_SERVICE_ENDPOINT]>,
    serviceproperties: Option<&[WS_SERVICE_PROPERTY]>,
...
pub unsafe fn WsCreateWriter(
    properties: Option<&[WS_XML_WRITER_PROPERTY]>,
...
pub unsafe fn WsCreateXmlBuffer(
    heap: *const WS_HEAP,
    properties: Option<&[WS_XML_BUFFER_PROPERTY]>,
...
pub unsafe fn WsCreateXmlSecurityToken(
    ...
    unsafe {
        WsCreateXmlSecurityToken(
            tokenxml.unwrap_or(core::mem::zeroed()) as _,
            tokenkey.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(
                properties
                    .as_deref()
                    .map_or(core::ptr::null(), |slice| slice.as_ptr()),
...
pub unsafe fn WsGetCustomHeader(
    ...
    unsafe {
        WsGetCustomHeader(
            ...
            headerindex,
            readoption,
            heap.unwrap_or(core::mem::zeroed()) as _,
            value as _,
            valuesize,
            headerattributes.unwrap_or(core::mem::zeroed()) as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub unsafe fn WsGetXmlAttribute(
    ...
    unsafe {
        WsGetXmlAttribute(
            ...
            localname,
            heap,
            valuechars.unwrap_or(core::mem::zeroed()) as _,
            valuecharcount as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
...
pub unsafe fn WsInitializeMessage(
    ...
    sourcemessage: Option<*const WS_MESSAGE>,
    error: Option<*const WS_ERROR>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WsInitializeMessage(
            message,
            initialization,
            sourcemessage.unwrap_or(core::mem::zeroed()) as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub unsafe fn WsMoveReader(
    reader: *const WS_XML_READER,
    moveto: WS_MOVE_TO,
    found: Option<*mut windows_core::BOOL>,
    error: Option<*const WS_ERROR>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WsMoveReader(
            reader,
            moveto,
            found.unwrap_or(core::mem::zeroed()) as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub unsafe fn WsReadArray(
    ...
    array: Option<*mut core::ffi::c_void>,
    arraysize: u32,
    itemoffset: u32,
    itemcount: u32,
    ...
    unsafe {
        WsReadArray(
            ...
            ns,
            valuetype,
            array.unwrap_or(core::mem::zeroed()) as _,
            arraysize,
            itemoffset,
            itemcount,
            actualitemcount as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub unsafe fn WsReadChars(
    ...
    unsafe {
        WsReadChars(
            reader,
            core::mem::transmute(chars.as_ptr()),
            chars.len().try_into().unwrap(),
            actualcharcount as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub unsafe fn WsReadEnvelopeStart(
    ...
    donecallbackstate: Option<*const core::ffi::c_void>,
    error: Option<*const WS_ERROR>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WsReadEnvelopeStart(
            ...
            reader,
            donecallback,
            donecallbackstate.unwrap_or(core::mem::zeroed()) as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub unsafe fn WsReadQualifiedName(
    ...
    unsafe {
        WsReadQualifiedName(
            reader,
            heap,
            prefix.unwrap_or(core::mem::zeroed()) as _,
            localname as _,
            ns.unwrap_or(core::mem::zeroed()) as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub unsafe fn WsReadToStartElement(
    ...
    unsafe {
        WsReadToStartElement(
            reader,
            localname.unwrap_or(core::mem::zeroed()) as _,
            ns.unwrap_or(core::mem::zeroed()) as _,
            found.unwrap_or(core::mem::zeroed()) as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
...
pub unsafe fn WsReadType(
    ...
    r#type: WS_TYPE,
    typedescription: Option<*const core::ffi::c_void>,
    readoption: WS_READ_OPTION,
    heap: Option<*const WS_HEAP>,
    value: *mut core::ffi::c_void,
    valuesize: u32,
    ...
    unsafe {
        WsReadType(
            ...
            typemapping,
            r#type,
            typedescription.unwrap_or(core::mem::zeroed()) as _,
            readoption,
            heap.unwrap_or(core::mem::zeroed()) as _,
            value as _,
            valuesize,
...
pub unsafe fn WsReadXmlBufferFromBytes(
    reader: *const WS_XML_READER,
    encoding: Option<*const WS_XML_READER_ENCODING>,
    properties: Option<&[WS_XML_READER_PROPERTY]>,
    ...
    unsafe {
        WsReadXmlBufferFromBytes(
            reader,
            encoding.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(
                properties
                    .as_deref()
                    .map_or(core::ptr::null(), |slice| slice.as_ptr()),
...
pub unsafe fn WsRegisterOperationForCancel(
    ...
    userstate: Option<*const core::ffi::c_void>,
    error: Option<*const WS_ERROR>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WsRegisterOperationForCancel(
            ...
            cancelcallback,
            freestatecallback,
            userstate.unwrap_or(core::mem::zeroed()) as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub unsafe fn WsRequestReply(
    ...
    unsafe {
        WsRequestReply(
            ...
            writeoption,
            requestbodyvalue.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn WsRevokeSecurityContext(
    ...
    unsafe {
        WsRevokeSecurityContext(securitycontext, error.unwrap_or(core::mem::zeroed()) as _).ok()
    }
}
#[inline]
...
pub unsafe fn WsSendMessage(
    ...
    writeoption: WS_WRITE_OPTION,
    bodyvalue: Option<*const core::ffi::c_void>,
    bodyvaluesize: u32,
    asynccontext: Option<*const WS_ASYNC_CONTEXT>,
    error: Option<*const WS_ERROR>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WsSendMessage(
            ...
            messagedescription,
            writeoption,
            bodyvalue.unwrap_or(core::mem::zeroed()) as _,
            bodyvaluesize,
            asynccontext.unwrap_or(core::mem::zeroed()) as _,
            error.unwrap_or(core::mem::zeroed()) as _,
        )
...
pub unsafe fn WsSendReplyMessage(
    ...
    replymessagedescription: *const WS_MESSAGE_DESCRIPTION,
    writeoption: WS_WRITE_OPTION,
    replybodyvalue: Option<*const core::ffi::c_void>,
    ...
    unsafe {
        WsSendReplyMessage(
            ...
            replymessagedescription,
            writeoption,
            replybodyvalue.unwrap_or(core::mem::zeroed()) as _,
            replybodyvaluesize,
            requestmessage,
            asynccontext.unwrap_or(core::mem::zeroed()) as _,
            error.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn WsSetFaultErrorDetail(
    ...
    faultdetaildescription: *const WS_FAULT_DETAIL_DESCRIPTION,
    writeoption: WS_WRITE_OPTION,
    value: Option<*const core::ffi::c_void>,
    valuesize: u32,
) -> windows_core::Result<()> {
...
pub unsafe fn WsSetInput(
    reader: *const WS_XML_READER,
    encoding: Option<*const WS_XML_READER_ENCODING>,
    input: Option<*const WS_XML_READER_INPUT>,
    properties: Option<&[WS_XML_READER_PROPERTY]>,
    error: Option<*const WS_ERROR>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WsSetInput(
            reader,
            encoding.unwrap_or(core::mem::zeroed()) as _,
            input.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(
                properties
                    .as_deref()
                    .map_or(core::ptr::null(), |slice| slice.as_ptr()),
...
pub unsafe fn WsSetOutput(
    writer: *const WS_XML_WRITER,
    encoding: Option<*const WS_XML_WRITER_ENCODING>,
    output: Option<*const WS_XML_WRITER_OUTPUT>,
    properties: Option<&[WS_XML_WRITER_PROPERTY]>,
    error: Option<*const WS_ERROR>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WsSetOutput(
            writer,
            encoding.unwrap_or(core::mem::zeroed()) as _,
            output.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(
                properties
                    .as_deref()
                    .map_or(core::ptr::null(), |slice| slice.as_ptr()),
...
pub unsafe fn WsStartReaderCanonicalization(
    ...
    writecallbackstate: Option<*const core::ffi::c_void>,
    properties: Option<&[WS_XML_CANONICALIZATION_PROPERTY]>,
    error: Option<*const WS_ERROR>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        WsStartReaderCanonicalization(
            reader,
            writecallback,
            writecallbackstate.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(
                properties
                    .as_deref()
                    .map_or(core::ptr::null(), |slice| slice.as_ptr()),
...
pub unsafe fn WsVerifyXmlNCName(
    ...
    unsafe {
        WsVerifyXmlNCName(
            core::mem::transmute(ncnamechars.as_ptr()),
            ncnamechars.len().try_into().unwrap(),
            error.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
...
pub unsafe fn WsWriteArray(
    ...
    ns: *const WS_XML_STRING,
    valuetype: WS_VALUE_TYPE,
    array: Option<*const core::ffi::c_void>,
    arraysize: u32,
    itemoffset: u32,
    itemcount: u32,
    error: Option<*const WS_ERROR>,
...
windows_core::imp::define_interface!(
    ...
    0x1b35a14a_6094_4799_a60e_e474e15d4dc9
);
...
impl IContentPrefetcherTaskTrigger {
    pub unsafe fn TriggerContentPrefetcherTask<P0>(
        &self,
        packagefullname: P0,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).TriggerContentPrefetcherTask)(
    ...
    pub unsafe fn IsRegisteredForContentPrefetch<P0>(
        &self,
        packagefullname: P0,
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsRegisteredForContentPrefetch)(
                windows_core::Interface::as_raw(self),
                packagefullname.param().abi(),
                &mut result__,
            )
...
pub struct IContentPrefetcherTaskTrigger_Vtbl {
    ...
    pub TriggerContentPrefetcherTask: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub IsRegisteredForContentPrefetch: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut u8,
    ) -> windows_core::HRESULT,
...
pub trait IContentPrefetcherTaskTrigger_Impl: windows_core::IUnknownImpl {
    fn TriggerContentPrefetcherTask(
        &self,
        packagefullname: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
...
impl IContentPrefetcherTaskTrigger_Vtbl {
    pub const fn new<Identity: IContentPrefetcherTaskTrigger_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn TriggerContentPrefetcherTask<
        ...
        >(
            ...
            unsafe {
                ...
                IContentPrefetcherTaskTrigger_Impl::TriggerContentPrefetcherTask(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IContentPrefetcherTaskTrigger_Impl::IsRegisteredForContentPrefetch(
                    this,
                    core::mem::transmute(&packagefullname),
                ) {
                    Ok(ok__) => {
...
pub type WS_ABANDON_MESSAGE_CALLBACK = Option<
    unsafe extern "system" fn(
        channelinstance: *const core::ffi::c_void,
        message: *const WS_MESSAGE,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
>;
pub type WS_ABORT_CHANNEL_CALLBACK = Option<
    unsafe extern "system" fn(
        channelinstance: *const core::ffi::c_void,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
>;
pub type WS_ABORT_LISTENER_CALLBACK = Option<
    unsafe extern "system" fn(
        listenerinstance: *const core::ffi::c_void,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
>;
pub type WS_ACCEPT_CHANNEL_CALLBACK = Option<
    unsafe extern "system" fn(
        listenerinstance: *const core::ffi::c_void,
        channelinstance: *const core::ffi::c_void,
...
pub type WS_ASYNC_CALLBACK = Option<
    unsafe extern "system" fn(
        errorcode: windows_core::HRESULT,
        callbackmodel: WS_CALLBACK_MODEL,
        callbackstate: *const core::ffi::c_void,
    ),
>;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub type WS_ASYNC_FUNCTION = Option<
    unsafe extern "system" fn(
        hr: windows_core::HRESULT,
        callbackmodel: WS_CALLBACK_MODEL,
        callbackstate: *const core::ffi::c_void,
        next: *mut WS_ASYNC_OPERATION,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
>;
...
pub type WS_CERTIFICATE_VALIDATION_CALLBACK = Option<
    unsafe extern "system" fn(
...
pub type WS_CLOSE_CHANNEL_CALLBACK = Option<
    unsafe extern "system" fn(
        channelinstance: *const core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
>;
pub type WS_CLOSE_LISTENER_CALLBACK = Option<
    unsafe extern "system" fn(
        listenerinstance: *const core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
pub type WS_CREATE_CHANNEL_CALLBACK = Option<
    unsafe extern "system" fn(
        channeltype: WS_CHANNEL_TYPE,
        channelparameters: *const core::ffi::c_void,
        channelparameterssize: u32,
        channelinstance: *mut *mut core::ffi::c_void,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
>;
pub type WS_CREATE_CHANNEL_FOR_LISTENER_CALLBACK = Option<
    unsafe extern "system" fn(
        listenerinstance: *const core::ffi::c_void,
        channelparameters: *const core::ffi::c_void,
        channelparameterssize: u32,
...
>;
pub type WS_CREATE_DECODER_CALLBACK = Option<
    unsafe extern "system" fn(
        createcontext: *const core::ffi::c_void,
        readcallback: WS_READ_CALLBACK,
        readcontext: *const core::ffi::c_void,
        decodercontext: *mut *mut core::ffi::c_void,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
>;
pub type WS_CREATE_ENCODER_CALLBACK = Option<
    unsafe extern "system" fn(
        createcontext: *const core::ffi::c_void,
        writecallback: WS_WRITE_CALLBACK,
        writecontext: *const core::ffi::c_void,
        encodercontext: *mut *mut core::ffi::c_void,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
>;
pub type WS_CREATE_LISTENER_CALLBACK = Option<
    unsafe extern "system" fn(
        channeltype: WS_CHANNEL_TYPE,
        listenerparameters: *const core::ffi::c_void,
        listenerparameterssize: u32,
        listenerinstance: *mut *mut core::ffi::c_void,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
>;
#[repr(C)]
...
pub type WS_DECODER_DECODE_CALLBACK = Option<
    unsafe extern "system" fn(
        encodercontext: *const core::ffi::c_void,
        buffer: *mut core::ffi::c_void,
        maxlength: u32,
        length: *mut u32,
        asynccontext: *const WS_ASYNC_CONTEXT,
...
>;
pub type WS_DECODER_END_CALLBACK = Option<
    unsafe extern "system" fn(
        encodercontext: *const core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
>;
pub type WS_DECODER_GET_CONTENT_TYPE_CALLBACK = Option<
    unsafe extern "system" fn(
        decodercontext: *const core::ffi::c_void,
...
>;
pub type WS_DECODER_START_CALLBACK = Option<
    unsafe extern "system" fn(
        encodercontext: *const core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
pub type WS_DURATION_COMPARISON_CALLBACK = Option<
    unsafe extern "system" fn(
...
pub type WS_DYNAMIC_STRING_CALLBACK = Option<
    unsafe extern "system" fn(
        callbackstate: *const core::ffi::c_void,
...
pub type WS_ENCODER_ENCODE_CALLBACK = Option<
    unsafe extern "system" fn(
        encodercontext: *const core::ffi::c_void,
...
>;
pub type WS_ENCODER_END_CALLBACK = Option<
    unsafe extern "system" fn(
        encodercontext: *const core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
>;
pub type WS_ENCODER_GET_CONTENT_TYPE_CALLBACK = Option<
    unsafe extern "system" fn(
        encodercontext: *const core::ffi::c_void,
        contenttype: *const WS_STRING,
        newcontenttype: *mut WS_STRING,
...
>;
pub type WS_ENCODER_START_CALLBACK = Option<
    unsafe extern "system" fn(
        encodercontext: *const core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
pub type WS_FREE_CHANNEL_CALLBACK =
    Option<unsafe extern "system" fn(channelinstance: *const core::ffi::c_void)>;
pub type WS_FREE_DECODER_CALLBACK =
    Option<unsafe extern "system" fn(decodercontext: *const core::ffi::c_void)>;
pub type WS_FREE_ENCODER_CALLBACK =
    Option<unsafe extern "system" fn(encodercontext: *const core::ffi::c_void)>;
pub type WS_FREE_LISTENER_CALLBACK =
    Option<unsafe extern "system" fn(listenerinstance: *const core::ffi::c_void)>;
...
#[cfg(feature = "Win32_Security_Cryptography")]
pub type WS_GET_CERT_CALLBACK = Option<
    unsafe extern "system" fn(
        getcertcallbackstate: *const core::ffi::c_void,
...
>;
pub type WS_GET_CHANNEL_PROPERTY_CALLBACK = Option<
    unsafe extern "system" fn(
        channelinstance: *const core::ffi::c_void,
        id: WS_CHANNEL_PROPERTY_ID,
        value: *mut core::ffi::c_void,
...
>;
pub type WS_GET_LISTENER_PROPERTY_CALLBACK = Option<
    unsafe extern "system" fn(
        listenerinstance: *const core::ffi::c_void,
        id: WS_LISTENER_PROPERTY_ID,
        value: *mut core::ffi::c_void,
...
pub type WS_HTTP_REDIRECT_CALLBACK = Option<
    unsafe extern "system" fn(
        state: *const core::ffi::c_void,
...
pub type WS_IS_DEFAULT_VALUE_CALLBACK = Option<
    unsafe extern "system" fn(
        descriptiondata: *const core::ffi::c_void,
        value: *const core::ffi::c_void,
...
pub type WS_MESSAGE_DONE_CALLBACK =
    Option<unsafe extern "system" fn(donecallbackstate: *const core::ffi::c_void)>;
...
pub type WS_OPEN_CHANNEL_CALLBACK = Option<
    unsafe extern "system" fn(
        channelinstance: *const core::ffi::c_void,
        endpointaddress: *const WS_ENDPOINT_ADDRESS,
        asynccontext: *const WS_ASYNC_CONTEXT,
...
>;
pub type WS_OPEN_LISTENER_CALLBACK = Option<
    unsafe extern "system" fn(
        listenerinstance: *const core::ffi::c_void,
        url: *const WS_STRING,
        asynccontext: *const WS_ASYNC_CONTEXT,
...
>;
pub type WS_OPERATION_CANCEL_CALLBACK = Option<
    unsafe extern "system" fn(reason: WS_SERVICE_CANCEL_REASON, state: *const core::ffi::c_void),
>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
...
pub type WS_OPERATION_FREE_STATE_CALLBACK =
    Option<unsafe extern "system" fn(state: *const core::ffi::c_void)>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub type WS_PROXY_MESSAGE_CALLBACK = Option<
    unsafe extern "system" fn(
        message: *const WS_MESSAGE,
        heap: *const WS_HEAP,
        state: *const core::ffi::c_void,
...
pub type WS_PULL_BYTES_CALLBACK = Option<
    unsafe extern "system" fn(
        callbackstate: *const core::ffi::c_void,
        bytes: *mut core::ffi::c_void,
        maxsize: u32,
...
>;
pub type WS_PUSH_BYTES_CALLBACK = Option<
    unsafe extern "system" fn(
        callbackstate: *const core::ffi::c_void,
        writecallback: WS_WRITE_CALLBACK,
        writecallbackstate: *const core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
>;
...
pub type WS_READ_CALLBACK = Option<
    unsafe extern "system" fn(
        callbackstate: *const core::ffi::c_void,
        bytes: *mut core::ffi::c_void,
        maxsize: u32,
...
>;
pub type WS_READ_MESSAGE_END_CALLBACK = Option<
    unsafe extern "system" fn(
        channelinstance: *const core::ffi::c_void,
        message: *const WS_MESSAGE,
        asynccontext: *const WS_ASYNC_CONTEXT,
...
>;
pub type WS_READ_MESSAGE_START_CALLBACK = Option<
    unsafe extern "system" fn(
        channelinstance: *const core::ffi::c_void,
        message: *const WS_MESSAGE,
        asynccontext: *const WS_ASYNC_CONTEXT,
...
pub type WS_READ_TYPE_CALLBACK = Option<
    unsafe extern "system" fn(
        reader: *const WS_XML_READER,
        typemapping: WS_TYPE_MAPPING,
        descriptiondata: *const core::ffi::c_void,
...
pub type WS_RESET_CHANNEL_CALLBACK = Option<
    unsafe extern "system" fn(
        channelinstance: *const core::ffi::c_void,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
>;
pub type WS_RESET_LISTENER_CALLBACK = Option<
    unsafe extern "system" fn(
        listenerinstance: *const core::ffi::c_void,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
...
pub type WS_SERVICE_ACCEPT_CHANNEL_CALLBACK = Option<
    unsafe extern "system" fn(
        context: *const WS_OPERATION_CONTEXT,
        channelstate: *mut *mut core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
>;
...
pub type WS_SERVICE_CLOSE_CHANNEL_CALLBACK = Option<
    unsafe extern "system" fn(
        context: *const WS_OPERATION_CONTEXT,
        asynccontext: *const WS_ASYNC_CONTEXT,
    ) -> windows_core::HRESULT,
...
pub type WS_SERVICE_MESSAGE_RECEIVE_CALLBACK = Option<
    unsafe extern "system" fn(
        context: *const WS_OPERATION_CONTEXT,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
pub type WS_SERVICE_SECURITY_CALLBACK = Option<
    unsafe extern "system" fn(
        context: *const WS_OPERATION_CONTEXT,
        authorized: *mut windows_core::BOOL,
        error: *const WS_ERROR,
    ) -> windows_core::HRESULT,
>;
#[repr(C)]
...
pub type WS_SERVICE_STUB_CALLBACK = Option<
    unsafe extern "system" fn(
        context: *const WS_OPERATION_CONTEXT,
...
>;
pub type WS_SET_CHANNEL_PROPERTY_CALLBACK = Option<
    unsafe extern "system" fn(
        channelinstance: *const core::ffi::c_void,
        id: WS_CHANNEL_PROPERTY_ID,
        value: *const core::ffi::c_void,
...
>;
pub type WS_SET_LISTENER_PROPERTY_CALLBACK = Option<
    unsafe extern "system" fn(
        listenerinstance: *const core::ffi::c_void,
        id: WS_LISTENER_PROPERTY_ID,
        value: *const core::ffi::c_void,
...
pub type WS_SHUTDOWN_SESSION_CHANNEL_CALLBACK = Option<
    unsafe extern "system" fn(
        channelinstance: *const core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
pub type WS_VALIDATE_PASSWORD_CALLBACK = Option<
    unsafe extern "system" fn(
        passwordvalidatorcallbackstate: *const core::ffi::c_void,
...
>;
pub type WS_VALIDATE_SAML_CALLBACK = Option<
    unsafe extern "system" fn(
        samlvalidatorcallbackstate: *const core::ffi::c_void,
...
pub type WS_WRITE_CALLBACK = Option<
    unsafe extern "system" fn(
        callbackstate: *const core::ffi::c_void,
        buffers: *const WS_BYTES,
        count: u32,
...
>;
pub type WS_WRITE_MESSAGE_END_CALLBACK = Option<
    unsafe extern "system" fn(
        channelinstance: *const core::ffi::c_void,
        message: *const WS_MESSAGE,
        asynccontext: *const WS_ASYNC_CONTEXT,
...
>;
pub type WS_WRITE_MESSAGE_START_CALLBACK = Option<
    unsafe extern "system" fn(
        channelinstance: *const core::ffi::c_void,
        message: *const WS_MESSAGE,
        asynccontext: *const WS_ASYNC_CONTEXT,
...
pub type WS_WRITE_TYPE_CALLBACK = Option<
    unsafe extern "system" fn(
        writer: *const WS_XML_WRITER,
        typemapping: WS_TYPE_MAPPING,
        descriptiondata: *const core::ffi::c_void,

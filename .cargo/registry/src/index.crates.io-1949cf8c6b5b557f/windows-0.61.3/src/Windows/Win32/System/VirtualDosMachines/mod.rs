...
pub type DEBUGEVENTPROC = Option<
...
pub struct GLOBALENTRY {
    ...
    pub wcPageLock: u16,
    pub wFlags: u16,
    pub wHeapPresent: windows_core::BOOL,
...
pub type PROCESSENUMPROC = Option<
    unsafe extern "system" fn(
        dwprocessid: u32,
        dwattributes: u32,
...
>;
pub type TASKENUMPROCEX = Option<
    unsafe extern "system" fn(
        dwthreadid: u32,
        hmod16: u16,
        htask16: u16,
...
pub type VDMBREAKTHREADPROC = Option<
...
pub type VDMDETECTWOWPROC = Option<unsafe extern "system" fn() -> windows_core::BOOL>;
pub type VDMENUMPROCESSWOWPROC = Option<
    unsafe extern "system" fn(
        param0: PROCESSENUMPROC,
        param1: super::super::Foundation::LPARAM,
    ) -> i32,
>;
pub type VDMENUMTASKWOWEXPROC = Option<
    unsafe extern "system" fn(
        param0: u32,
...
>;
pub type VDMENUMTASKWOWPROC = Option<
    unsafe extern "system" fn(
        param0: u32,
        param1: TASKENUMPROC,
        param2: super::super::Foundation::LPARAM,
...
pub type VDMGETADDREXPRESSIONPROC = Option<
    unsafe extern "system" fn(
...
pub type VDMGETCONTEXTPROC = Option<
    unsafe extern "system" fn(
...
pub type VDMGETMODULESELECTORPROC = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HANDLE,
        param1: super::super::Foundation::HANDLE,
        param2: u32,
...
>;
pub type VDMGETPOINTERPROC = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HANDLE,
        param1: super::super::Foundation::HANDLE,
        param2: u16,
        param3: u32,
        param4: windows_core::BOOL,
    ) -> u32,
>;
pub type VDMGETSEGMENTINFOPROC = Option<
    unsafe extern "system" fn(
        param0: u16,
        param1: u32,
        param2: windows_core::BOOL,
        param3: VDM_SEGINFO,
    ) -> windows_core::BOOL,
>;
pub type VDMGETSELECTORMODULEPROC = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HANDLE,
        param1: super::super::Foundation::HANDLE,
        param2: u16,
...
>;
pub type VDMGETSYMBOLPROC = Option<
    unsafe extern "system" fn(
        param0: windows_core::PCSTR,
        param1: u16,
        param2: u32,
        ...
        param4: windows_core::BOOL,
        param5: windows_core::PSTR,
        param6: *mut u32,
    ) -> windows_core::BOOL,
>;
#[cfg(target_arch = "x86")]
#[cfg(feature = "Win32_System_Diagnostics_Debug")]
pub type VDMGETTHREADSELECTORENTRYPROC = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HANDLE,
        param1: super::super::Foundation::HANDLE,
        param2: u32,
...
pub type VDMGLOBALFIRSTPROC = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HANDLE,
        param1: super::super::Foundation::HANDLE,
...
pub type VDMGLOBALNEXTPROC = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HANDLE,
        param1: super::super::Foundation::HANDLE,
        param2: *mut GLOBALENTRY,
...
>;
pub type VDMISMODULELOADEDPROC =
    Option<unsafe extern "system" fn(param0: windows_core::PCSTR) -> windows_core::BOOL>;
pub type VDMKILLWOWPROC = Option<unsafe extern "system" fn() -> windows_core::BOOL>;
#[repr(C)]
#[cfg(any(
    target_arch = "aarch64",
    target_arch = "arm64ec",
...
pub type VDMMODULEFIRSTPROC = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HANDLE,
        param1: super::super::Foundation::HANDLE,
...
pub type VDMMODULENEXTPROC = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HANDLE,
        param1: super::super::Foundation::HANDLE,
        param2: *mut MODULEENTRY,
...
pub type VDMPROCESSEXCEPTIONPROC = Option<
    unsafe extern "system" fn(
        param0: *mut super::Diagnostics::Debug::DEBUG_EVENT,
    ) -> windows_core::BOOL,
>;
...
pub type VDMSETCONTEXTPROC = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HANDLE,
        param1: super::super::Foundation::HANDLE,
        param2: *mut super::Diagnostics::Debug::CONTEXT,
...
>;
pub type VDMSETDBGFLAGSPROC = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HANDLE,
        param1: u32,
    ) -> windows_core::BOOL,
>;
pub type VDMSTARTTASKINWOWPROC = Option<
    unsafe extern "system" fn(
        param0: u32,
        param1: windows_core::PCSTR,
        param2: u16,
...
pub type VDMTERMINATETASKINWOWPROC =
    Option<unsafe extern "system" fn(param0: u32, param1: u16) -> windows_core::BOOL>;

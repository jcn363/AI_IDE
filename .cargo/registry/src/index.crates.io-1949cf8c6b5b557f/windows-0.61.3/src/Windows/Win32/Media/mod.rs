...
windows_core::imp::define_interface!(
    ...
    0x56a86897_0ad4_11ce_b03a_0020af0ba770
);
...
impl IReferenceClock {
    ...
    pub unsafe fn AdviseTime(
        &self,
        basetime: i64,
        streamtime: i64,
        hevent: super::Foundation::HANDLE,
    ) -> windows_core::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AdviseTime)(
                windows_core::Interface::as_raw(self),
                basetime,
                streamtime,
                hevent,
    ...
    pub unsafe fn AdvisePeriodic(
        &self,
        starttime: i64,
        periodtime: i64,
        hsemaphore: super::Foundation::HANDLE,
    ) -> windows_core::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AdvisePeriodic)(
                windows_core::Interface::as_raw(self),
                starttime,
                periodtime,
                hsemaphore,
...
pub struct IReferenceClock_Vtbl {
    ...
    pub AdviseTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i64,
        i64,
    ...
    pub AdvisePeriodic: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i64,
        i64,
        super::Foundation::HANDLE,
...
impl IReferenceClock_Vtbl {
    pub const fn new<Identity: IReferenceClock_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetTime<Identity: IReferenceClock_Impl, const OFFSET: isize>(
        ...
        unsafe extern "system" fn AdviseTime<
        ...
        >(
            ...
            streamtime: i64,
            hevent: super::Foundation::HANDLE,
            pdwadvisecookie: *mut usize,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IReferenceClock_Impl::AdviseTime(
                    this,
                    core::mem::transmute_copy(&basetime),
                    core::mem::transmute_copy(&streamtime),
        ...
        unsafe extern "system" fn AdvisePeriodic<
            Identity: IReferenceClock_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IReferenceClock_Impl::AdvisePeriodic(
                    this,
                    core::mem::transmute_copy(&starttime),
                    core::mem::transmute_copy(&periodtime),
                    core::mem::transmute_copy(&hsemaphore),
                ) {
                    Ok(ok__) => {
                        pdwadvisecookie.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn Unadvise<Identity: IReferenceClock_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IReferenceClock_Impl::Unadvise(this, core::mem::transmute_copy(&dwadvisecookie))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    IReferenceClock2,
    IReferenceClock2_Vtbl,
    0x36b73885_c2c8_11cf_8b46_00805f6cef60
);
...
impl IReferenceClock2_Vtbl {
    pub const fn new<Identity: IReferenceClock2_Impl, const OFFSET: isize>() -> Self {
        Self {
            base__: IReferenceClock_Vtbl::new::<Identity, OFFSET>(),
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xebec459c_2eca_4d42_a8af_30df557614b8
);
windows_core::imp::interface_hierarchy!(IReferenceClockTimerControl, windows_core::IUnknown);
impl IReferenceClockTimerControl {
    pub unsafe fn SetDefaultTimerResolution(
        &self,
        timerresolution: i64,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDefaultTimerResolution)(
                windows_core::Interface::as_raw(self),
                timerresolution,
            )
            .ok()
    ...
    pub unsafe fn GetDefaultTimerResolution(&self) -> windows_core::Result<i64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDefaultTimerResolution)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IReferenceClockTimerControl_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetDefaultTimerResolution:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub GetDefaultTimerResolution:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
}
...
impl IReferenceClockTimerControl_Vtbl {
    pub const fn new<Identity: IReferenceClockTimerControl_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetDefaultTimerResolution<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IReferenceClockTimerControl_Impl::SetDefaultTimerResolution(
                    this,
                    core::mem::transmute_copy(&timerresolution),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetDefaultTimerResolution<
            Identity: IReferenceClockTimerControl_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ptimerresolution: *mut i64,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
#[cfg(feature = "Win32_Media_Multimedia")]
pub type LPDRVCALLBACK = Option<
    unsafe extern "system" fn(
        hdrvr: Multimedia::HDRVR,
        umsg: u32,
        dwuser: usize,
        dw1: usize,
        dw2: usize,
...
>;
pub type LPTIMECALLBACK = Option<

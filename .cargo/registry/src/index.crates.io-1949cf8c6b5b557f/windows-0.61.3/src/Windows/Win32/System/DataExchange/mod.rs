...
{
    windows_link::link!("kernel32.dll" "system" fn AddAtomA(lpstring : windows_core::PCSTR) -> u16);
...
{
    windows_link::link!("kernel32.dll" "system" fn AddAtomW(lpstring : windows_core::PCWSTR) -> u16);
...
pub unsafe fn AddClipboardFormatListener(
    ...
    windows_link::link!("user32.dll" "system" fn AddClipboardFormatListener(hwnd : super::super::Foundation:: HWND) -> windows_core::BOOL);
...
pub unsafe fn ChangeClipboardChain(
    ...
    windows_link::link!("user32.dll" "system" fn ChangeClipboardChain(hwndremove : super::super::Foundation:: HWND, hwndnewnext : super::super::Foundation:: HWND) -> windows_core::BOOL);
...
pub unsafe fn DdeAbandonTransaction(
    ...
    windows_link::link!("user32.dll" "system" fn DdeAbandonTransaction(idinst : u32, hconv : HCONV, idtransaction : u32) -> windows_core::BOOL);
...
pub unsafe fn DdeAddData(hdata: HDDEDATA, psrc: &[u8], cboff: u32) -> HDDEDATA {
    ...
    unsafe {
        DdeAddData(
            hdata,
            core::mem::transmute(psrc.as_ptr()),
            psrc.len().try_into().unwrap(),
            cboff,
        )
    }
}
...
pub unsafe fn DdeClientTransaction(
    ...
    unsafe {
        DdeClientTransaction(
            ...
            cbdata,
            hconv,
            hszitem.unwrap_or(core::mem::zeroed()) as _,
            wfmt,
            wtype,
            dwtimeout,
...
pub unsafe fn DdeConnect(
    ...
    unsafe {
        DdeConnect(
            ...
            hszservice,
            hsztopic,
            pcc.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_Security")]
...
#[inline]
pub unsafe fn DdeCreateDataHandle(
    idinst: u32,
    psrc: Option<&[u8]>,
    cboff: u32,
    hszitem: Option<HSZ>,
...
{
    windows_link::link!("user32.dll" "system" fn DdeCreateStringHandleA(idinst : u32, psz : windows_core::PCSTR, icodepage : i32) -> HSZ);
...
{
    windows_link::link!("user32.dll" "system" fn DdeCreateStringHandleW(idinst : u32, psz : windows_core::PCWSTR, icodepage : i32) -> HSZ);
    unsafe { DdeCreateStringHandleW(idinst, psz.param().abi(), icodepage) }
}
#[inline]
pub unsafe fn DdeDisconnect(hconv: HCONV) -> windows_core::BOOL {
    windows_link::link!("user32.dll" "system" fn DdeDisconnect(hconv : HCONV) -> windows_core::BOOL);
    unsafe { DdeDisconnect(hconv) }
}
#[inline]
pub unsafe fn DdeDisconnectList(hconvlist: HCONVLIST) -> windows_core::BOOL {
    windows_link::link!("user32.dll" "system" fn DdeDisconnectList(hconvlist : HCONVLIST) -> windows_core::BOOL);
...
pub unsafe fn DdeEnableCallback(
    ...
    windows_link::link!("user32.dll" "system" fn DdeEnableCallback(idinst : u32, hconv : HCONV, wcmd : DDE_ENABLE_CALLBACK_CMD) -> windows_core::BOOL);
    unsafe { DdeEnableCallback(idinst, hconv, wcmd) }
}
#[inline]
pub unsafe fn DdeFreeDataHandle(hdata: HDDEDATA) -> windows_core::BOOL {
    windows_link::link!("user32.dll" "system" fn DdeFreeDataHandle(hdata : HDDEDATA) -> windows_core::BOOL);
    unsafe { DdeFreeDataHandle(hdata) }
}
#[inline]
pub unsafe fn DdeFreeStringHandle(idinst: u32, hsz: HSZ) -> windows_core::BOOL {
    windows_link::link!("user32.dll" "system" fn DdeFreeStringHandle(idinst : u32, hsz : HSZ) -> windows_core::BOOL);
...
pub unsafe fn DdeImpersonateClient(hconv: HCONV) -> windows_core::Result<()> {
    windows_link::link!("user32.dll" "system" fn DdeImpersonateClient(hconv : HCONV) -> windows_core::BOOL);
...
pub unsafe fn DdeInitializeA(
    ...
    unsafe {
        DdeInitializeA(
            ...
            pfncallback,
            afcmd,
            ulres.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn DdeKeepStringHandle(idinst: u32, hsz: HSZ) -> windows_core::BOOL {
    windows_link::link!("user32.dll" "system" fn DdeKeepStringHandle(idinst : u32, hsz : HSZ) -> windows_core::BOOL);
...
pub unsafe fn DdeNameService(
    ...
    unsafe {
        DdeNameService(
            idinst,
            hsz1.unwrap_or(core::mem::zeroed()) as _,
            hsz2.unwrap_or(core::mem::zeroed()) as _,
            afcmd,
        )
    }
}
...
pub unsafe fn DdePostAdvise(idinst: u32, hsztopic: HSZ, hszitem: HSZ) -> windows_core::BOOL {
    windows_link::link!("user32.dll" "system" fn DdePostAdvise(idinst : u32, hsztopic : HSZ, hszitem : HSZ) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn DdeQueryStringA(
    idinst: u32,
    hsz: HSZ,
    psz: Option<&mut [u8]>,
    icodepage: i32,
) -> u32 {
    windows_link::link!("user32.dll" "system" fn DdeQueryStringA(idinst : u32, hsz : HSZ, psz : windows_core::PSTR, cchmax : u32, icodepage : i32) -> u32);
    unsafe {
        DdeQueryStringA(
            idinst,
            hsz,
...
#[inline]
pub unsafe fn DdeQueryStringW(
    idinst: u32,
    hsz: HSZ,
    psz: Option<&mut [u16]>,
    icodepage: i32,
) -> u32 {
    windows_link::link!("user32.dll" "system" fn DdeQueryStringW(idinst : u32, hsz : HSZ, psz : windows_core::PWSTR, cchmax : u32, icodepage : i32) -> u32);
    unsafe {
        DdeQueryStringW(
            idinst,
            hsz,
...
pub unsafe fn DdeSetQualityOfService(
    ...
    windows_link::link!("user32.dll" "system" fn DdeSetQualityOfService(hwndclient : super::super::Foundation:: HWND, pqosnew : *const super::super::Security:: SECURITY_QUALITY_OF_SERVICE, pqosprev : *mut super::super::Security:: SECURITY_QUALITY_OF_SERVICE) -> windows_core::BOOL);
...
pub unsafe fn DdeSetUserHandle(hconv: HCONV, id: u32, huser: usize) -> windows_core::BOOL {
    windows_link::link!("user32.dll" "system" fn DdeSetUserHandle(hconv : HCONV, id : u32, huser : usize) -> windows_core::BOOL);
    unsafe { DdeSetUserHandle(hconv, id, huser) }
}
#[inline]
pub unsafe fn DdeUnaccessData(hdata: HDDEDATA) -> windows_core::BOOL {
    windows_link::link!("user32.dll" "system" fn DdeUnaccessData(hdata : HDDEDATA) -> windows_core::BOOL);
    unsafe { DdeUnaccessData(hdata) }
}
#[inline]
pub unsafe fn DdeUninitialize(idinst: u32) -> windows_core::BOOL {
    windows_link::link!("user32.dll" "system" fn DdeUninitialize(idinst : u32) -> windows_core::BOOL);
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn FindAtomA(lpstring : windows_core::PCSTR) -> u16);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn FindAtomW(lpstring : windows_core::PCWSTR) -> u16);
...
pub unsafe fn FreeDDElParam(
    ...
    windows_link::link!("user32.dll" "system" fn FreeDDElParam(msg : u32, lparam : super::super::Foundation:: LPARAM) -> windows_core::BOOL);
    unsafe { FreeDDElParam(msg, lparam) }
}
#[inline]
pub unsafe fn GetAtomNameA(natom: u16, lpbuffer: &mut [u8]) -> u32 {
    windows_link::link!("kernel32.dll" "system" fn GetAtomNameA(natom : u16, lpbuffer : windows_core::PSTR, nsize : i32) -> u32);
    unsafe {
        GetAtomNameA(
            natom,
...
pub unsafe fn GetAtomNameW(natom: u16, lpbuffer: &mut [u16]) -> u32 {
    windows_link::link!("kernel32.dll" "system" fn GetAtomNameW(natom : u16, lpbuffer : windows_core::PWSTR, nsize : i32) -> u32);
    unsafe {
        GetAtomNameW(
            natom,
            core::mem::transmute(lpbuffer.as_ptr()),
...
pub unsafe fn GetClipboardFormatNameA(format: u32, lpszformatname: &mut [u8]) -> i32 {
    windows_link::link!("user32.dll" "system" fn GetClipboardFormatNameA(format : u32, lpszformatname : windows_core::PSTR, cchmaxcount : i32) -> i32);
    unsafe {
        GetClipboardFormatNameA(
            format,
            core::mem::transmute(lpszformatname.as_ptr()),
            lpszformatname.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn GetClipboardFormatNameW(format: u32, lpszformatname: &mut [u16]) -> i32 {
    windows_link::link!("user32.dll" "system" fn GetClipboardFormatNameW(format : u32, lpszformatname : windows_core::PWSTR, cchmaxcount : i32) -> i32);
    unsafe {
...
pub unsafe fn GetPriorityClipboardFormat(paformatprioritylist: &[u32]) -> i32 {
    ...
    unsafe {
        GetPriorityClipboardFormat(
            core::mem::transmute(paformatprioritylist.as_ptr()),
            paformatprioritylist.len().try_into().unwrap(),
        )
    }
}
#[inline]
pub unsafe fn GetUpdatedClipboardFormats(
    ...
    windows_link::link!("user32.dll" "system" fn GetUpdatedClipboardFormats(lpuiformats : *mut u32, cformats : u32, pcformatsout : *mut u32) -> windows_core::BOOL);
    unsafe {
        GetUpdatedClipboardFormats(
            core::mem::transmute(lpuiformats.as_ptr()),
            lpuiformats.len().try_into().unwrap(),
            pcformatsout as _,
        )
        .ok()
    }
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn GlobalAddAtomA(lpstring : windows_core::PCSTR) -> u16);
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn GlobalAddAtomExA(lpstring : windows_core::PCSTR, flags : u32) -> u16);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn GlobalAddAtomExW(lpstring : windows_core::PCWSTR, flags : u32) -> u16);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn GlobalAddAtomW(lpstring : windows_core::PCWSTR) -> u16);
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn GlobalFindAtomA(lpstring : windows_core::PCSTR) -> u16);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn GlobalFindAtomW(lpstring : windows_core::PCWSTR) -> u16);
    unsafe { GlobalFindAtomW(lpstring.param().abi()) }
}
#[inline]
pub unsafe fn GlobalGetAtomNameA(natom: u16, lpbuffer: &mut [u8]) -> u32 {
    windows_link::link!("kernel32.dll" "system" fn GlobalGetAtomNameA(natom : u16, lpbuffer : windows_core::PSTR, nsize : i32) -> u32);
    unsafe {
        GlobalGetAtomNameA(
            natom,
            core::mem::transmute(lpbuffer.as_ptr()),
...
pub unsafe fn GlobalGetAtomNameW(natom: u16, lpbuffer: &mut [u16]) -> u32 {
    windows_link::link!("kernel32.dll" "system" fn GlobalGetAtomNameW(natom : u16, lpbuffer : windows_core::PWSTR, nsize : i32) -> u32);
    unsafe {
        GlobalGetAtomNameW(
            natom,
            core::mem::transmute(lpbuffer.as_ptr()),
...
pub unsafe fn ImpersonateDdeClientWindow(
    ...
    windows_link::link!("user32.dll" "system" fn ImpersonateDdeClientWindow(hwndclient : super::super::Foundation:: HWND, hwndserver : super::super::Foundation:: HWND) -> windows_core::BOOL);
    unsafe { ImpersonateDdeClientWindow(hwndclient, hwndserver).ok() }
}
#[inline]
pub unsafe fn InitAtomTable(nsize: u32) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn InitAtomTable(nsize : u32) -> windows_core::BOOL);
    unsafe { InitAtomTable(nsize) }
}
#[inline]
pub unsafe fn IsClipboardFormatAvailable(format: u32) -> windows_core::Result<()> {
    windows_link::link!("user32.dll" "system" fn IsClipboardFormatAvailable(format : u32) -> windows_core::BOOL);
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("user32.dll" "system" fn RegisterClipboardFormatA(lpszformat : windows_core::PCSTR) -> u32);
...
pub unsafe fn RemoveClipboardFormatListener(
    ...
    windows_link::link!("user32.dll" "system" fn RemoveClipboardFormatListener(hwnd : super::super::Foundation:: HWND) -> windows_core::BOOL);
...
pub unsafe fn SetWinMetaFileBits(
    lpmeta16data: &[u8],
    hdcref: Option<super::super::Graphics::Gdi::HDC>,
    lpmfp: Option<*const METAFILEPICT>,
    ...
    unsafe {
        SetWinMetaFileBits(
            lpmeta16data.len().try_into().unwrap(),
            core::mem::transmute(lpmeta16data.as_ptr()),
            hdcref.unwrap_or(core::mem::zeroed()) as _,
            lpmfp.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn UnpackDDElParam(
    ...
    windows_link::link!("user32.dll" "system" fn UnpackDDElParam(msg : u32, lparam : super::super::Foundation:: LPARAM, puilo : *mut usize, puihi : *mut usize) -> windows_core::BOOL);
...
impl windows_core::Free for HCONV {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("user32.dll" "system" fn DdeDisconnect(hconv : *mut core::ffi::c_void) -> i32);
            unsafe {
...
impl windows_core::Free for HCONVLIST {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("user32.dll" "system" fn DdeDisconnectList(hconvlist : *mut core::ffi::c_void) -> i32);
            unsafe {
...
impl windows_core::Free for HDDEDATA {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("user32.dll" "system" fn DdeFreeDataHandle(hdata : *mut core::ffi::c_void) -> i32);
            unsafe {

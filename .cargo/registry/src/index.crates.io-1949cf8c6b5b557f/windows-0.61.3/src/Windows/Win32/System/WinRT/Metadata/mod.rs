...
pub unsafe fn MetaDataGetDispenser(
    ...
    windows_link::link!("rometadata.dll" "system" fn MetaDataGetDispenser(rclsid : *const windows_core::GUID, riid : *const windows_core::GUID, ppv : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { MetaDataGetDispenser(rclsid, riid, ppv as _).ok() }
}
#[cfg(feature = "Foundation_Collections")]
#[inline]
pub unsafe fn RoCreateNonAgilePropertySet(
) -> windows_core::Result<super::super::super::super::Foundation::Collections::IPropertySet> {
    windows_link::link!("api-ms-win-ro-typeresolution-l1-1-1.dll" "system" fn RoCreateNonAgilePropertySet(pppropertyset : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        RoCreateNonAgilePropertySet(&mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[cfg(feature = "Storage_Streams")]
#[inline]
pub unsafe fn RoCreatePropertySetSerializer(
) -> windows_core::Result<super::super::super::super::Storage::Streams::IPropertySetSerializer> {
    windows_link::link!("api-ms-win-ro-typeresolution-l1-1-1.dll" "system" fn RoCreatePropertySetSerializer(pppropertysetserializer : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        RoCreatePropertySetSerializer(&mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
...
#[inline]
pub unsafe fn RoGetMetaDataFile<P1>(
    name: &windows_core::HSTRING,
    metadatadispenser: P1,
    metadatafilepath: Option<*mut windows_core::HSTRING>,
    metadataimport: Option<*mut Option<IMetaDataImport2>>,
    typedeftoken: Option<*mut u32>,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<IMetaDataDispenserEx>,
{
    windows_link::link!("api-ms-win-ro-typeresolution-l1-1-0.dll" "system" fn RoGetMetaDataFile(name : * mut core::ffi::c_void, metadatadispenser : * mut core::ffi::c_void, metadatafilepath : *mut * mut core::ffi::c_void, metadataimport : *mut * mut core::ffi::c_void, typedeftoken : *mut u32) -> windows_core::HRESULT);
    unsafe {
        RoGetMetaDataFile(
            core::mem::transmute_copy(name),
            metadatadispenser.param().abi(),
            metadatafilepath.unwrap_or(core::mem::zeroed()) as _,
            metadataimport.unwrap_or(core::mem::zeroed()) as _,
            typedeftoken.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn RoGetParameterizedTypeInstanceIID<P2>(
    nameelements: &[windows_core::PCWSTR],
    metadatalocator: P2,
    iid: *mut windows_core::GUID,
    pextra: Option<*mut ROPARAMIIDHANDLE>,
) -> windows_core::Result<()>
where
    P2: windows_core::Param<IRoMetaDataLocator>,
{
    windows_link::link!("api-ms-win-core-winrt-roparameterizediid-l1-1-0.dll" "system" fn RoGetParameterizedTypeInstanceIID(nameelementcount : u32, nameelements : *const windows_core::PCWSTR, metadatalocator : * mut core::ffi::c_void, iid : *mut windows_core::GUID, pextra : *mut ROPARAMIIDHANDLE) -> windows_core::HRESULT);
    unsafe {
        RoGetParameterizedTypeInstanceIID(
            nameelements.len().try_into().unwrap(),
            core::mem::transmute(nameelements.as_ptr()),
            metadatalocator.param().abi(),
            iid as _,
            pextra.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        RoIsApiContractMajorVersionPresent(name.param().abi(), majorversion, &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn RoIsApiContractPresent<P0>(
    name: P0,
    majorversion: u16,
    minorversion: u16,
) -> windows_core::Result<windows_core::BOOL>
...
pub unsafe fn RoParameterizedTypeExtraGetTypeSignature(
    ...
    windows_link::link!("api-ms-win-core-winrt-roparameterizediid-l1-1-0.dll" "system" fn RoParameterizedTypeExtraGetTypeSignature(extra : ROPARAMIIDHANDLE) -> windows_core::PCSTR);
    unsafe { RoParameterizedTypeExtraGetTypeSignature(extra) }
}
#[inline]
pub unsafe fn RoParseTypeName(
    typename: &windows_core::HSTRING,
    partscount: *mut u32,
    typenameparts: *mut *mut windows_core::HSTRING,
) -> windows_core::Result<()> {
    windows_link::link!("api-ms-win-ro-typeresolution-l1-1-0.dll" "system" fn RoParseTypeName(typename : * mut core::ffi::c_void, partscount : *mut u32, typenameparts : *mut *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        RoParseTypeName(
...
#[inline]
pub unsafe fn RoResolveNamespace(
    name: &windows_core::HSTRING,
    windowsmetadatadir: &windows_core::HSTRING,
    packagegraphdirs: Option<&[windows_core::HSTRING]>,
    metadatafilepathscount: Option<*mut u32>,
    metadatafilepaths: Option<*mut *mut windows_core::HSTRING>,
    subnamespacescount: Option<*mut u32>,
    subnamespaces: Option<*mut *mut windows_core::HSTRING>,
) -> windows_core::Result<()> {
    windows_link::link!("api-ms-win-ro-typeresolution-l1-1-0.dll" "system" fn RoResolveNamespace(name : * mut core::ffi::c_void, windowsmetadatadir : * mut core::ffi::c_void, packagegraphdirscount : u32, packagegraphdirs : *const * mut core::ffi::c_void, metadatafilepathscount : *mut u32, metadatafilepaths : *mut *mut * mut core::ffi::c_void, subnamespacescount : *mut u32, subnamespaces : *mut *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        RoResolveNamespace(
            core::mem::transmute_copy(name),
...
pub const ASSEMBLY_METADATA_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Reflection.AssemblyMetadataAttribute");
pub const ASSEMBLY_METADATA_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Reflection.AssemblyMetadataAttribute");
pub const CLSID_CLR_v1_MetaData: windows_core::GUID =
    windows_core::GUID::from_u128(0x005023ca_72b1_11d3_9fc4_00c04f79a0a3);
pub const CLSID_CLR_v2_MetaData: windows_core::GUID =
    windows_core::GUID::from_u128(0xefea471a_44fd_4862_9292_0c58d46e1f3a);
pub const CLSID_Cor: windows_core::GUID =
    windows_core::GUID::from_u128(0xbee00010_ee77_11d0_a015_00c04fbbb884);
pub const CLSID_CorMetaDataDispenser: windows_core::GUID =
    windows_core::GUID::from_u128(0xe5cb7a31_7512_11d2_89ce_0080c792e5d8);
pub const CLSID_CorMetaDataDispenserReg: windows_core::GUID =
    windows_core::GUID::from_u128(0x435755ff_7397_11d2_9771_00a0c9b4d50c);
pub const CLSID_CorMetaDataDispenserRuntime: windows_core::GUID =
    windows_core::GUID::from_u128(0x1ec2de53_75cc_11d2_9775_00a0c9b4d50c);
pub const CLSID_CorMetaDataReg: windows_core::GUID =
    windows_core::GUID::from_u128(0x87f3a1f5_7397_11d2_9771_00a0c9b4d50c);
pub const CMOD_CALLCONV_NAMESPACE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices");
pub const CMOD_CALLCONV_NAMESPACE_OLD: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices");
...
pub const COMPILATIONRELAXATIONS_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.CompilationRelaxationsAttribute");
pub const COMPILATIONRELAXATIONS_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.CompilationRelaxationsAttribute");
pub const COR_BASE_SECURITY_ATTRIBUTE_CLASS: windows_core::PCWSTR =
    windows_core::w!("System.Security.Permissions.SecurityAttribute");
pub const COR_BASE_SECURITY_ATTRIBUTE_CLASS_ANSI: windows_core::PCSTR =
    windows_core::s!("System.Security.Permissions.SecurityAttribute");
...
pub const COR_COMPILERSERVICE_DISCARDABLEATTRIBUTE: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.DiscardableAttribute");
pub const COR_COMPILERSERVICE_DISCARDABLEATTRIBUTE_ASNI: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.DiscardableAttribute");
...
pub const COR_E_TARGETPARAMCOUNT: windows_core::HRESULT =
    windows_core::HRESULT(0x8002000E_u32 as _);
...
pub const COR_NATIVE_LINK_CUSTOM_VALUE: windows_core::PCWSTR =
    windows_core::w!("COMPLUS_NativeLink");
pub const COR_NATIVE_LINK_CUSTOM_VALUE_ANSI: windows_core::PCSTR =
    windows_core::s!("COMPLUS_NativeLink");
pub const COR_NATIVE_LINK_CUSTOM_VALUE_CC: u32 = 18u32;
pub const COR_REQUIRES_SECOBJ_ATTRIBUTE: windows_core::PCWSTR =
    windows_core::w!("System.Security.DynamicSecurityMethodAttribute");
pub const COR_REQUIRES_SECOBJ_ATTRIBUTE_ANSI: windows_core::PCSTR =
    windows_core::s!("System.Security.DynamicSecurityMethodAttribute");
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const COR_SUPPRESS_UNMANAGED_CODE_CHECK_ATTRIBUTE: windows_core::PCWSTR =
    windows_core::w!("System.Security.SuppressUnmanagedCodeSecurityAttribute");
pub const COR_SUPPRESS_UNMANAGED_CODE_CHECK_ATTRIBUTE_ANSI: windows_core::PCSTR =
    windows_core::s!("System.Security.SuppressUnmanagedCodeSecurityAttribute");
pub const COR_UNVER_CODE_ATTRIBUTE: windows_core::PCWSTR =
    windows_core::w!("System.Security.UnverifiableCodeAttribute");
pub const COR_UNVER_CODE_ATTRIBUTE_ANSI: windows_core::PCSTR =
    windows_core::s!("System.Security.UnverifiableCodeAttribute");
...
pub const CompilationRelaxations_NoStringInterning: CompilationRelaxationsEnum =
    CompilationRelaxationsEnum(8i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const DEFAULTDEPENDENCY_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.DefaultDependencyAttribute");
pub const DEFAULTDEPENDENCY_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.DefaultDependencyAttribute");
pub const DEFAULTDOMAIN_LOADEROPTIMIZATION_TYPE: windows_core::PCSTR =
    windows_core::s!("System.LoaderOptimizationAttribute");
pub const DEFAULTDOMAIN_LOADEROPTIMIZATION_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.LoaderOptimizationAttribute");
pub const DEFAULTDOMAIN_MTA_TYPE: windows_core::PCSTR =
    windows_core::s!("System.MTAThreadAttribute");
pub const DEFAULTDOMAIN_MTA_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.MTAThreadAttribute");
pub const DEFAULTDOMAIN_STA_TYPE: windows_core::PCSTR =
    windows_core::s!("System.STAThreadAttribute");
pub const DEFAULTDOMAIN_STA_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.STAThreadAttribute");
pub const DEPENDENCY_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.DependencyAttribute");
pub const DEPENDENCY_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.DependencyAttribute");
pub const DESCR_GROUP_METHODDEF: i32 = 0i32;
pub const DESCR_GROUP_METHODIMPL: i32 = 1i32;
pub const DISABLED_PRIVATE_REFLECTION_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.DisablePrivateReflectionAttribute");
pub const DISABLED_PRIVATE_REFLECTION_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.DisablePrivateReflectionAttribute");
...
pub const FORWARD_INTEROP_STUB_METHOD_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ManagedToNativeComInteropStubAttribute");
pub const FORWARD_INTEROP_STUB_METHOD_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ManagedToNativeComInteropStubAttribute");
pub const FRAMEWORK_REGISTRY_KEY: windows_core::PCSTR =
    windows_core::s!("Software\\Microsoft\\.NETFramework");
pub const FRAMEWORK_REGISTRY_KEY_W: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\.NETFramework");
pub const FRIEND_ACCESS_ALLOWED_ATTRIBUTE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.FriendAccessAllowedAttribute");
pub const FRIEND_ACCESS_ALLOWED_ATTRIBUTE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.FriendAccessAllowedAttribute");
pub const FRIEND_ASSEMBLY_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.InternalsVisibleToAttribute");
pub const FRIEND_ASSEMBLY_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.InternalsVisibleToAttribute");
pub const GUID_DispIdOverride: windows_core::GUID =
    windows_core::GUID::from_u128(0xcd2bc5c9_f452_4326_b714_f9c539d4da58);
pub const GUID_ExportedFromComPlus: windows_core::GUID =
    windows_core::GUID::from_u128(0x90883f05_3d28_11d2_8f17_00a0c9a6186d);
pub const GUID_ForceIEnumerable: windows_core::GUID =
    windows_core::GUID::from_u128(0xb64784eb_d8d4_4d9b_9acd_0e30806426f7);
pub const GUID_Function2Getter: windows_core::GUID =
    windows_core::GUID::from_u128(0x54fc8f55_38de_4703_9c4e_250351302b1c);
pub const GUID_ManagedName: windows_core::GUID =
    windows_core::GUID::from_u128(0x0f21f359_ab84_41e8_9a78_36d110e6d2f9);
pub const GUID_PropGetCA: windows_core::GUID =
    windows_core::GUID::from_u128(0x2941ff83_88d8_4f73_b6a9_bdf8712d000d);
pub const GUID_PropPutCA: windows_core::GUID =
    windows_core::GUID::from_u128(0x29533527_3683_4364_abc0_db1add822fa2);
windows_core::imp::define_interface!(
    ICeeGen,
    ICeeGen_Vtbl,
    0x7ed1bdff_8e36_11d2_9c56_00a0c9b7cc45
);
...
impl ICeeGen {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EmitString)(
    ...
    pub unsafe fn GetString(
        &self,
        rva: u32,
        lpstring: Option<*mut windows_core::PWSTR>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetString)(
                windows_core::Interface::as_raw(self),
                rva,
                lpstring.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn AllocateMethodBuffer(
        &self,
        cchbuffer: u32,
        lpbuffer: *mut *mut u8,
        rva: *mut u32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AllocateMethodBuffer)(
                windows_core::Interface::as_raw(self),
                cchbuffer,
                lpbuffer as _,
                rva as _,
    ...
    pub unsafe fn GetMethodBuffer(
        &self,
        rva: u32,
        lpbuffer: *mut *mut u8,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetMethodBuffer)(
                windows_core::Interface::as_raw(self),
                rva,
                lpbuffer as _,
            )
    ...
    pub unsafe fn GetIMapTokenIface(&self) -> windows_core::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetIMapTokenIface)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GenerateCeeFile(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GenerateCeeFile)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    }
    pub unsafe fn GetIlSection(
        &self,
        section: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetIlSection)(
                windows_core::Interface::as_raw(self),
                section as _,
            )
            .ok()
    ...
    pub unsafe fn GetStringSection(
        &self,
        section: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetStringSection)(
                windows_core::Interface::as_raw(self),
                section as _,
            )
            .ok()
    ...
    pub unsafe fn AddSectionReloc(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AddSectionReloc)(
                windows_core::Interface::as_raw(self),
                section as _,
                offset,
                relativeto as _,
    ...
    pub unsafe fn GetSectionCreate<P0>(
        &self,
        name: P0,
        flags: u32,
        section: *mut *mut core::ffi::c_void,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetSectionCreate)(
                windows_core::Interface::as_raw(self),
                name.param().abi(),
                flags,
                section as _,
    ...
    pub unsafe fn GetSectionDataLen(
        &self,
        section: *mut core::ffi::c_void,
        datalen: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetSectionDataLen)(
                windows_core::Interface::as_raw(self),
                section as _,
                datalen as _,
            )
    ...
    pub unsafe fn GetSectionBlock(
        &self,
        section: *mut core::ffi::c_void,
        len: u32,
        align: u32,
        ppbytes: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetSectionBlock)(
                windows_core::Interface::as_raw(self),
                section as _,
                len,
                align,
    ...
    pub unsafe fn TruncateSection(
        &self,
        section: *mut core::ffi::c_void,
        len: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).TruncateSection)(
                windows_core::Interface::as_raw(self),
                section as _,
                len,
            )
    ...
    pub unsafe fn GenerateCeeMemoryImage(
        &self,
        ppimage: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GenerateCeeMemoryImage)(
                windows_core::Interface::as_raw(self),
                ppimage as _,
            )
            .ok()
    ...
    pub unsafe fn ComputePointer(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ComputePointer)(
                windows_core::Interface::as_raw(self),
                section as _,
                rva,
                lpbuffer as _,
...
pub struct ICeeGen_Vtbl {
    ...
    pub EmitString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut u32,
    ...
    pub AllocateMethodBuffer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetMethodBuffer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut u8,
    ) -> windows_core::HRESULT,
    pub GetIMapTokenIface: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GenerateCeeFile: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub GetIlSection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetStringSection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AddSectionReloc: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
    ...
    pub GetSectionCreate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCSTR,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetSectionDataLen: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetSectionBlock: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        u32,
    ...
    pub TruncateSection: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ) -> windows_core::HRESULT,
    pub GenerateCeeMemoryImage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ComputePointer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *mut *mut u8,
...
impl ICeeGen_Vtbl {
    pub const fn new<Identity: ICeeGen_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn EmitString<Identity: ICeeGen_Impl, const OFFSET: isize>(
            ...
            unsafe {
                ...
                ICeeGen_Impl::EmitString(
                    this,
                    core::mem::transmute(&lpstring),
                    core::mem::transmute_copy(&rva),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetString<Identity: ICeeGen_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            rva: u32,
            lpstring: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICeeGen_Impl::GetString(
                    this,
                    core::mem::transmute_copy(&rva),
                    core::mem::transmute_copy(&lpstring),
                )
                .into()
            }
        }
        unsafe extern "system" fn AllocateMethodBuffer<
            Identity: ICeeGen_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            cchbuffer: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICeeGen_Impl::AllocateMethodBuffer(
                    this,
                    core::mem::transmute_copy(&cchbuffer),
        ...
        unsafe extern "system" fn GetMethodBuffer<Identity: ICeeGen_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            rva: u32,
            lpbuffer: *mut *mut u8,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetIMapTokenIface<Identity: ICeeGen_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pimaptoken: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GenerateCeeFile<Identity: ICeeGen_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetIlSection<Identity: ICeeGen_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            section: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetStringSection<Identity: ICeeGen_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            section: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn AddSectionReloc<Identity: ICeeGen_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            section: *mut core::ffi::c_void,
            offset: u32,
            relativeto: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICeeGen_Impl::AddSectionReloc(
                    this,
                    core::mem::transmute_copy(&section),
                    core::mem::transmute_copy(&offset),
                    core::mem::transmute_copy(&relativeto),
                    core::mem::transmute_copy(&reloctype),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetSectionCreate<Identity: ICeeGen_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            name: windows_core::PCSTR,
            flags: u32,
            section: *mut *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetSectionDataLen<Identity: ICeeGen_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            section: *mut core::ffi::c_void,
            datalen: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICeeGen_Impl::GetSectionDataLen(
                    this,
                    core::mem::transmute_copy(&section),
                    core::mem::transmute_copy(&datalen),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetSectionBlock<Identity: ICeeGen_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            section: *mut core::ffi::c_void,
            len: u32,
            align: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICeeGen_Impl::GetSectionBlock(
                    this,
                    core::mem::transmute_copy(&section),
                    core::mem::transmute_copy(&len),
                    core::mem::transmute_copy(&align),
                    core::mem::transmute_copy(&ppbytes),
                )
                .into()
            }
        }
        unsafe extern "system" fn TruncateSection<Identity: ICeeGen_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            section: *mut core::ffi::c_void,
            len: u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GenerateCeeMemoryImage<
            Identity: ICeeGen_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICeeGen_Impl::GenerateCeeMemoryImage(this, core::mem::transmute_copy(&ppimage))
                    .into()
            }
        }
        unsafe extern "system" fn ComputePointer<Identity: ICeeGen_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            section: *mut core::ffi::c_void,
            rva: u32,
            lpbuffer: *mut *mut u8,
...
windows_core::imp::define_interface!(
    IHostFilter,
    IHostFilter_Vtbl,
    0xd0e80dd3_12d4_11d3_b39d_00c04ff81795
);
...
impl IHostFilter {
    pub unsafe fn MarkToken(&self, tk: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).MarkToken)(
                windows_core::Interface::as_raw(self),
                tk,
            )
            .ok()
...
impl IHostFilter_Vtbl {
    pub const fn new<Identity: IHostFilter_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn MarkToken<Identity: IHostFilter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            tk: u32,
        ) -> windows_core::HRESULT {
            unsafe {
...
pub const IMAGE_CEE_CS_CALLCONV_C: CorUnmanagedCallingConvention =
    CorUnmanagedCallingConvention(1i32);
...
pub const IMAGE_CEE_CS_CALLCONV_FASTCALL: CorUnmanagedCallingConvention =
    CorUnmanagedCallingConvention(4i32);
...
pub const IMAGE_CEE_CS_CALLCONV_STDCALL: CorUnmanagedCallingConvention =
    CorUnmanagedCallingConvention(2i32);
pub const IMAGE_CEE_CS_CALLCONV_THISCALL: CorUnmanagedCallingConvention =
    CorUnmanagedCallingConvention(3i32);
...
pub const IMAGE_CEE_UNMANAGED_CALLCONV_C: CorUnmanagedCallingConvention =
    CorUnmanagedCallingConvention(1i32);
pub const IMAGE_CEE_UNMANAGED_CALLCONV_FASTCALL: CorUnmanagedCallingConvention =
    CorUnmanagedCallingConvention(4i32);
pub const IMAGE_CEE_UNMANAGED_CALLCONV_STDCALL: CorUnmanagedCallingConvention =
    CorUnmanagedCallingConvention(2i32);
pub const IMAGE_CEE_UNMANAGED_CALLCONV_THISCALL: CorUnmanagedCallingConvention =
    CorUnmanagedCallingConvention(3i32);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const IMAGE_DIRECTORY_ENTRY_COMHEADER: ReplacesGeneralNumericDefines =
    ReplacesGeneralNumericDefines(14i32);
windows_core::imp::define_interface!(
    IMapToken,
    IMapToken_Vtbl,
    0x06a3ea8b_0225_11d1_bf72_00c04fc31e12
);
...
impl IMapToken_Vtbl {
    pub const fn new<Identity: IMapToken_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Map<Identity: IMapToken_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            tkimp: u32,
            tkemit: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                ...
                IMapToken_Impl::Map(
                    this,
                    core::mem::transmute_copy(&tkimp),
                    core::mem::transmute_copy(&tkemit),
                )
                .into()
            }
        }
...
impl IMetaDataAssemblyEmit {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineAssembly)(
                windows_core::Interface::as_raw(self),
                pbpublickey,
                cbpublickey,
                ulhashalgid,
    ...
    pub unsafe fn DefineAssemblyRef<P2>(
        &self,
        pbpublickeyortoken: *const core::ffi::c_void,
        cbpublickeyortoken: u32,
        szname: P2,
        pmetadata: *const ASSEMBLYMETADATA,
        pbhashvalue: *const core::ffi::c_void,
        cbhashvalue: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineAssemblyRef)(
                windows_core::Interface::as_raw(self),
                pbpublickeyortoken,
                cbpublickeyortoken,
                szname.param().abi(),
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineFile)(
                windows_core::Interface::as_raw(self),
                szname.param().abi(),
                pbhashvalue,
                cbhashvalue,
    ...
    pub unsafe fn DefineExportedType<P0>(
        &self,
        szname: P0,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineExportedType)(
                windows_core::Interface::as_raw(self),
                szname.param().abi(),
                tkimplementation,
                tktypedef,
    ...
    pub unsafe fn DefineManifestResource<P0>(
        &self,
        szname: P0,
        tkimplementation: u32,
        dwoffset: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineManifestResource)(
                windows_core::Interface::as_raw(self),
                szname.param().abi(),
                tkimplementation,
                dwoffset,
    ...
    pub unsafe fn SetAssemblyProps<P4>(
        &self,
        pma: u32,
        pbpublickey: *const core::ffi::c_void,
        cbpublickey: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetAssemblyProps)(
                windows_core::Interface::as_raw(self),
                pma,
                pbpublickey,
                cbpublickey,
    ...
    pub unsafe fn SetAssemblyRefProps<P3>(
        &self,
        ar: u32,
        pbpublickeyortoken: *const core::ffi::c_void,
        cbpublickeyortoken: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetAssemblyRefProps)(
                windows_core::Interface::as_raw(self),
                ar,
                pbpublickeyortoken,
                cbpublickeyortoken,
    ...
    pub unsafe fn SetFileProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetFileProps)(
                windows_core::Interface::as_raw(self),
                file,
                pbhashvalue,
                cbhashvalue,
    ...
    pub unsafe fn SetExportedTypeProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetExportedTypeProps)(
                windows_core::Interface::as_raw(self),
                ct,
                tkimplementation,
                tktypedef,
    ...
    pub unsafe fn SetManifestResourceProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetManifestResourceProps)(
                windows_core::Interface::as_raw(self),
                mr,
                tkimplementation,
                dwoffset,
...
pub struct IMetaDataAssemblyEmit_Vtbl {
    ...
    pub DefineFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const core::ffi::c_void,
        u32,
...
impl IMetaDataAssemblyEmit_Vtbl {
    pub const fn new<Identity: IMetaDataAssemblyEmit_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DefineAssembly<
            Identity: IMetaDataAssemblyEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbpublickey: *const core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyEmit_Impl::DefineAssembly(
                    this,
                    core::mem::transmute_copy(&pbpublickey),
                    core::mem::transmute_copy(&cbpublickey),
                    core::mem::transmute_copy(&ulhashalgid),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&pmetadata),
                    core::mem::transmute_copy(&dwassemblyflags),
                    core::mem::transmute_copy(&pma),
                )
                .into()
            }
        }
        unsafe extern "system" fn DefineAssemblyRef<
            Identity: IMetaDataAssemblyEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyEmit_Impl::DefineAssemblyRef(
                    this,
                    core::mem::transmute_copy(&pbpublickeyortoken),
                    core::mem::transmute_copy(&cbpublickeyortoken),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&pmetadata),
                    core::mem::transmute_copy(&pbhashvalue),
                    core::mem::transmute_copy(&cbhashvalue),
                    core::mem::transmute_copy(&dwassemblyrefflags),
                    core::mem::transmute_copy(&pmdar),
                )
                .into()
            }
        }
        unsafe extern "system" fn DefineFile<
            Identity: IMetaDataAssemblyEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyEmit_Impl::DefineFile(
                    this,
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&pbhashvalue),
                    core::mem::transmute_copy(&cbhashvalue),
                    core::mem::transmute_copy(&dwfileflags),
                    core::mem::transmute_copy(&pmdf),
                )
                .into()
            }
        }
        unsafe extern "system" fn DefineExportedType<
            Identity: IMetaDataAssemblyEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyEmit_Impl::DefineExportedType(
                    this,
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&tkimplementation),
                    core::mem::transmute_copy(&tktypedef),
                    core::mem::transmute_copy(&dwexportedtypeflags),
                    core::mem::transmute_copy(&pmdct),
                )
                .into()
            }
        }
        unsafe extern "system" fn DefineManifestResource<
            Identity: IMetaDataAssemblyEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyEmit_Impl::DefineManifestResource(
                    this,
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&tkimplementation),
                    core::mem::transmute_copy(&dwoffset),
                    core::mem::transmute_copy(&dwresourceflags),
                    core::mem::transmute_copy(&pmdmr),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetAssemblyProps<
            Identity: IMetaDataAssemblyEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyEmit_Impl::SetAssemblyProps(
                    this,
                    core::mem::transmute_copy(&pma),
                    core::mem::transmute_copy(&pbpublickey),
                    core::mem::transmute_copy(&cbpublickey),
        ...
        unsafe extern "system" fn SetAssemblyRefProps<
            Identity: IMetaDataAssemblyEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyEmit_Impl::SetAssemblyRefProps(
                    this,
                    core::mem::transmute_copy(&ar),
                    core::mem::transmute_copy(&pbpublickeyortoken),
                    core::mem::transmute_copy(&cbpublickeyortoken),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&pmetadata),
        ...
        unsafe extern "system" fn SetFileProps<
            Identity: IMetaDataAssemblyEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyEmit_Impl::SetFileProps(
                    this,
        ...
        unsafe extern "system" fn SetExportedTypeProps<
            Identity: IMetaDataAssemblyEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyEmit_Impl::SetExportedTypeProps(
                    this,
        ...
        unsafe extern "system" fn SetManifestResourceProps<
            Identity: IMetaDataAssemblyEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyEmit_Impl::SetManifestResourceProps(
                    this,
                    core::mem::transmute_copy(&mr),
                    core::mem::transmute_copy(&tkimplementation),
                    core::mem::transmute_copy(&dwoffset),
                    core::mem::transmute_copy(&dwresourceflags),
                )
...
windows_core::imp::define_interface!(
    ...
    0xee62470b_e94b_424e_9b7c_2f00c9249f93
);
...
impl IMetaDataAssemblyImport {
    pub unsafe fn GetAssemblyProps(
        &self,
        mda: u32,
        ppbpublickey: *const *const core::ffi::c_void,
        pcbpublickey: *mut u32,
        pulhashalgid: *mut u32,
        szname: Option<&mut [u16]>,
        pchname: *mut u32,
        pmetadata: *mut ASSEMBLYMETADATA,
        pdwassemblyflags: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetAssemblyProps)(
                windows_core::Interface::as_raw(self),
                mda,
                ppbpublickey,
                pcbpublickey as _,
    ...
    pub unsafe fn GetAssemblyRefProps(
        &self,
        mdar: u32,
        ppbpublickeyortoken: *const *const core::ffi::c_void,
        pcbpublickeyortoken: *mut u32,
        szname: Option<&mut [u16]>,
        pchname: *mut u32,
        pmetadata: *mut ASSEMBLYMETADATA,
        ppbhashvalue: *const *const core::ffi::c_void,
        pcbhashvalue: *mut u32,
        pdwassemblyrefflags: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetAssemblyRefProps)(
                windows_core::Interface::as_raw(self),
                mdar,
                ppbpublickeyortoken,
                pcbpublickeyortoken as _,
                core::mem::transmute(
                    szname
                        .as_deref()
                        .map_or(core::ptr::null(), |slice| slice.as_ptr()),
    ...
    pub unsafe fn GetFileProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetFileProps)(
                windows_core::Interface::as_raw(self),
                mdf,
                core::mem::transmute(
                    szname
    ...
    pub unsafe fn GetExportedTypeProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetExportedTypeProps)(
                windows_core::Interface::as_raw(self),
                mdct,
                core::mem::transmute(
                    szname
                ...
                szname
                    ...
                    .map_or(0, |slice| slice.len().try_into().unwrap()),
                pchname as _,
                ptkimplementation as _,
                ptktypedef as _,
                pdwexportedtypeflags as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetManifestResourceProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetManifestResourceProps)(
                windows_core::Interface::as_raw(self),
                mdmr,
                core::mem::transmute(
                    szname
    ...
    pub unsafe fn EnumAssemblyRefs(
        &self,
        phenum: *mut *mut core::ffi::c_void,
        rassemblyrefs: *mut u32,
        cmax: u32,
        pctokens: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EnumAssemblyRefs)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                rassemblyrefs as _,
                cmax,
    ...
    pub unsafe fn EnumFiles(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumFiles)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                rfiles as _,
                cmax,
    ...
    pub unsafe fn EnumExportedTypes(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumExportedTypes)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                rexportedtypes as _,
                cmax,
    ...
    pub unsafe fn EnumManifestResources(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumManifestResources)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                rmanifestresources as _,
                cmax,
                pctokens as _,
            )
            .ok()
    ...
    pub unsafe fn GetAssemblyFromScope(&self, ptkassembly: *mut u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetAssemblyFromScope)(
                windows_core::Interface::as_raw(self),
                ptkassembly as _,
            )
            .ok()
    ...
    pub unsafe fn FindExportedTypeByName<P0>(
        &self,
        szname: P0,
        mdtexportedtype: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).FindExportedTypeByName)(
                windows_core::Interface::as_raw(self),
                szname.param().abi(),
                mdtexportedtype,
                ptkexportedtype as _,
            )
            .ok()
        }
    }
    pub unsafe fn FindManifestResourceByName<P0>(
        &self,
        szname: P0,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).FindManifestResourceByName)(
                windows_core::Interface::as_raw(self),
                szname.param().abi(),
                ptkmanifestresource as _,
            )
            .ok()
        }
    }
    pub unsafe fn CloseEnum(&self, henum: *mut core::ffi::c_void) {
        unsafe {
            (windows_core::Interface::vtable(self).CloseEnum)(
                windows_core::Interface::as_raw(self),
                henum as _,
            )
        }
    }
    pub unsafe fn FindAssembliesByName<P0, P1, P2>(
        &self,
        szappbase: P0,
        szprivatebin: P1,
        szassemblyname: P2,
        ppiunk: *mut Option<windows_core::IUnknown>,
        cmax: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).FindAssembliesByName)(
                windows_core::Interface::as_raw(self),
                szappbase.param().abi(),
                szprivatebin.param().abi(),
                szassemblyname.param().abi(),
                core::mem::transmute(ppiunk),
                cmax,
                pcassemblies as _,
            )
            .ok()
...
pub trait IMetaDataAssemblyImport_Impl: windows_core::IUnknownImpl {
    ...
    fn FindAssembliesByName(
        &self,
        szappbase: &windows_core::PCWSTR,
        szprivatebin: &windows_core::PCWSTR,
        szassemblyname: &windows_core::PCWSTR,
        ppiunk: windows_core::OutRef<'_, windows_core::IUnknown>,
        cmax: u32,
        pcassemblies: *mut u32,
    ) -> windows_core::Result<()>;
}
impl IMetaDataAssemblyImport_Vtbl {
    pub const fn new<Identity: IMetaDataAssemblyImport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetAssemblyProps<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            mda: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyImport_Impl::GetAssemblyProps(
                    this,
                    core::mem::transmute_copy(&mda),
                    core::mem::transmute_copy(&ppbpublickey),
                    core::mem::transmute_copy(&pcbpublickey),
                    core::mem::transmute_copy(&pulhashalgid),
                    core::mem::transmute_copy(&szname),
                    core::mem::transmute_copy(&cchname),
                    core::mem::transmute_copy(&pchname),
                    core::mem::transmute_copy(&pmetadata),
                    core::mem::transmute_copy(&pdwassemblyflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetAssemblyRefProps<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                ...
                IMetaDataAssemblyImport_Impl::GetAssemblyRefProps(
                    this,
                    core::mem::transmute_copy(&mdar),
                    core::mem::transmute_copy(&ppbpublickeyortoken),
                    core::mem::transmute_copy(&pcbpublickeyortoken),
                    core::mem::transmute_copy(&szname),
                    core::mem::transmute_copy(&cchname),
                    core::mem::transmute_copy(&pchname),
                    core::mem::transmute_copy(&pmetadata),
                    core::mem::transmute_copy(&ppbhashvalue),
                    core::mem::transmute_copy(&pcbhashvalue),
                    core::mem::transmute_copy(&pdwassemblyrefflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetFileProps<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyImport_Impl::GetFileProps(
                    this,
                    core::mem::transmute_copy(&mdf),
                    core::mem::transmute_copy(&szname),
                    core::mem::transmute_copy(&cchname),
                    core::mem::transmute_copy(&pchname),
                    core::mem::transmute_copy(&ppbhashvalue),
                    core::mem::transmute_copy(&pcbhashvalue),
                    core::mem::transmute_copy(&pdwfileflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetExportedTypeProps<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyImport_Impl::GetExportedTypeProps(
                    this,
                    core::mem::transmute_copy(&mdct),
                    core::mem::transmute_copy(&szname),
                    core::mem::transmute_copy(&cchname),
                    core::mem::transmute_copy(&pchname),
                    core::mem::transmute_copy(&ptkimplementation),
                    core::mem::transmute_copy(&ptktypedef),
                    core::mem::transmute_copy(&pdwexportedtypeflags),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyImport_Impl::GetManifestResourceProps(
                    this,
                    core::mem::transmute_copy(&mdmr),
                    core::mem::transmute_copy(&szname),
                    core::mem::transmute_copy(&cchname),
                    core::mem::transmute_copy(&pchname),
                    core::mem::transmute_copy(&ptkimplementation),
                    core::mem::transmute_copy(&pdwoffset),
                    core::mem::transmute_copy(&pdwresourceflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumAssemblyRefs<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyImport_Impl::EnumAssemblyRefs(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&rassemblyrefs),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctokens),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumFiles<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyImport_Impl::EnumFiles(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&rfiles),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctokens),
                )
                .into()
        ...
        unsafe extern "system" fn EnumExportedTypes<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyImport_Impl::EnumExportedTypes(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&rexportedtypes),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctokens),
                )
                .into()
        ...
        unsafe extern "system" fn EnumManifestResources<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyImport_Impl::EnumManifestResources(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&rmanifestresources),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctokens),
                )
                .into()
        ...
        unsafe extern "system" fn GetAssemblyFromScope<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyImport_Impl::GetAssemblyFromScope(
                    this,
                    core::mem::transmute_copy(&ptkassembly),
                )
                .into()
            }
        }
        unsafe extern "system" fn FindExportedTypeByName<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyImport_Impl::FindExportedTypeByName(
                    this,
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&mdtexportedtype),
                    core::mem::transmute_copy(&ptkexportedtype),
                )
                .into()
            }
        }
        unsafe extern "system" fn FindManifestResourceByName<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyImport_Impl::FindManifestResourceByName(
                    this,
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&ptkmanifestresource),
                )
                .into()
            }
        }
        unsafe extern "system" fn CloseEnum<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn FindAssembliesByName<
            Identity: IMetaDataAssemblyImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataAssemblyImport_Impl::FindAssembliesByName(
                    this,
                    core::mem::transmute(&szappbase),
                    core::mem::transmute(&szprivatebin),
                    core::mem::transmute(&szassemblyname),
                    core::mem::transmute_copy(&ppiunk),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pcassemblies),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x809c652e_7396_11d2_9771_00a0c9b4d50c
);
...
impl IMetaDataDispenser {
    pub unsafe fn DefineScope(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DefineScope)(
                windows_core::Interface::as_raw(self),
                rclsid,
                dwcreateflags,
                riid,
    ...
    pub unsafe fn OpenScopeOnMemory(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenScopeOnMemory)(
                windows_core::Interface::as_raw(self),
                pdata,
                cbdata,
                dwopenflags,
...
pub struct IMetaDataDispenser_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub DefineScope: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub OpenScopeOnMemory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        u32,
        u32,
...
impl IMetaDataDispenser_Vtbl {
    pub const fn new<Identity: IMetaDataDispenser_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DefineScope<
            Identity: IMetaDataDispenser_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            rclsid: *const windows_core::GUID,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMetaDataDispenser_Impl::DefineScope(
                    this,
        ...
        unsafe extern "system" fn OpenScope<
            Identity: IMetaDataDispenser_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMetaDataDispenser_Impl::OpenScope(
                    this,
                    core::mem::transmute(&szscope),
                    core::mem::transmute_copy(&dwopenflags),
                    core::mem::transmute_copy(&riid),
                ) {
                    Ok(ok__) => {
                        ppiunk.write(core::mem::transmute(ok__));
        ...
        unsafe extern "system" fn OpenScopeOnMemory<
            Identity: IMetaDataDispenser_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMetaDataDispenser_Impl::OpenScopeOnMemory(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0x31bcfce2_dafb_11d2_9f81_00c04f79a0a3
);
...
impl IMetaDataDispenserEx {
    ...
    pub unsafe fn SetOption(
        &self,
        optionid: *const windows_core::GUID,
        value: *const super::super::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub unsafe fn GetOption(
        &self,
        optionid: *const windows_core::GUID,
        pvalue: *mut super::super::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub unsafe fn OpenScopeOnITypeInfo<P0>(
        &self,
        piti: P0,
        dwopenflags: u32,
        riid: *const windows_core::GUID,
        ...
        P0: windows_core::Param<super::super::Com::ITypeInfo>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenScopeOnITypeInfo)(
                windows_core::Interface::as_raw(self),
                piti.param().abi(),
                dwopenflags,
                riid,
    ...
    pub unsafe fn GetCORSystemDirectory(
        &self,
        szbuffer: Option<&mut [u16]>,
        pchbuffer: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetCORSystemDirectory)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(
                    szbuffer
                        .as_deref()
    ...
    pub unsafe fn FindAssembly<P0, P1, P2, P3, P4>(
        &self,
        szappbase: P0,
        szprivatebin: P1,
        szglobalbin: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).FindAssembly)(
                windows_core::Interface::as_raw(self),
                szappbase.param().abi(),
                szprivatebin.param().abi(),
                szglobalbin.param().abi(),
                szassemblyname.param().abi(),
                szname.param().abi(),
                cchname,
                pcname as _,
    ...
    pub unsafe fn FindAssemblyModule<P0, P1, P2, P3, P4>(
        &self,
        szappbase: P0,
        szprivatebin: P1,
        szglobalbin: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).FindAssemblyModule)(
                windows_core::Interface::as_raw(self),
                szappbase.param().abi(),
                szprivatebin.param().abi(),
                szglobalbin.param().abi(),
                szassemblyname.param().abi(),
                szmodulename.param().abi(),
                core::mem::transmute(
                    szname
                        .as_deref()
                        .map_or(core::ptr::null(), |slice| slice.as_ptr()),
...
pub struct IMetaDataDispenserEx_Vtbl {
    ...
    pub SetOption: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *const super::super::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(
        feature = "Win32_System_Com",
        feature = "Win32_System_Ole",
    ...
    pub GetOption: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut super::super::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(
        feature = "Win32_System_Com",
        feature = "Win32_System_Ole",
    ...
    GetOption: usize,
    #[cfg(feature = "Win32_System_Com")]
    pub OpenScopeOnITypeInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const windows_core::GUID,
    ...
    pub GetCORSystemDirectory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PWSTR,
        u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub FindAssembly: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ...
    pub FindAssemblyModule: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
pub trait IMetaDataDispenserEx_Impl: IMetaDataDispenser_Impl {
    ...
    fn OpenScopeOnITypeInfo(
        &self,
        piti: windows_core::Ref<'_, super::super::Com::ITypeInfo>,
        dwopenflags: u32,
        riid: *const windows_core::GUID,
    ) -> windows_core::Result<windows_core::IUnknown>;
    fn GetCORSystemDirectory(
        &self,
        szbuffer: windows_core::PWSTR,
        cchbuffer: u32,
        pchbuffer: *mut u32,
    ) -> windows_core::Result<()>;
    fn FindAssembly(
        ...
        szappbase: &windows_core::PCWSTR,
        szprivatebin: &windows_core::PCWSTR,
        szglobalbin: &windows_core::PCWSTR,
        szassemblyname: &windows_core::PCWSTR,
        szname: &windows_core::PCWSTR,
        cchname: u32,
        pcname: *mut u32,
    ...
    fn FindAssemblyModule(
        ...
        szglobalbin: &windows_core::PCWSTR,
        szassemblyname: &windows_core::PCWSTR,
        szmodulename: &windows_core::PCWSTR,
        szname: windows_core::PWSTR,
        cchname: u32,
        pcname: *mut u32,
    ) -> windows_core::Result<()>;
...
impl IMetaDataDispenserEx_Vtbl {
    pub const fn new<Identity: IMetaDataDispenserEx_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetOption<
            Identity: IMetaDataDispenserEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            optionid: *const windows_core::GUID,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataDispenserEx_Impl::SetOption(
                    this,
                    core::mem::transmute_copy(&optionid),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataDispenserEx_Impl::GetOption(
                    this,
                    core::mem::transmute_copy(&optionid),
        ...
        unsafe extern "system" fn OpenScopeOnITypeInfo<
            Identity: IMetaDataDispenserEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            piti: *mut core::ffi::c_void,
            dwopenflags: u32,
            riid: *const windows_core::GUID,
            ppiunk: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMetaDataDispenserEx_Impl::OpenScopeOnITypeInfo(
                    this,
                    core::mem::transmute_copy(&piti),
                    core::mem::transmute_copy(&dwopenflags),
                    core::mem::transmute_copy(&riid),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetCORSystemDirectory<
            Identity: IMetaDataDispenserEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataDispenserEx_Impl::GetCORSystemDirectory(
                    this,
                    core::mem::transmute_copy(&szbuffer),
                    core::mem::transmute_copy(&cchbuffer),
                    core::mem::transmute_copy(&pchbuffer),
                )
                .into()
            }
        }
        unsafe extern "system" fn FindAssembly<
            Identity: IMetaDataDispenserEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataDispenserEx_Impl::FindAssembly(
                    this,
                    core::mem::transmute(&szappbase),
                    core::mem::transmute(&szprivatebin),
                    core::mem::transmute(&szglobalbin),
                    core::mem::transmute(&szassemblyname),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&cchname),
                    core::mem::transmute_copy(&pcname),
                )
                .into()
            }
        }
        unsafe extern "system" fn FindAssemblyModule<
            Identity: IMetaDataDispenserEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataDispenserEx_Impl::FindAssemblyModule(
                    this,
                    core::mem::transmute(&szappbase),
                    core::mem::transmute(&szprivatebin),
                    core::mem::transmute(&szglobalbin),
                    core::mem::transmute(&szassemblyname),
                    core::mem::transmute(&szmodulename),
                    core::mem::transmute_copy(&szname),
                    core::mem::transmute_copy(&cchname),
                    core::mem::transmute_copy(&pcname),
                )
...
windows_core::imp::define_interface!(
    IMetaDataEmit,
    IMetaDataEmit_Vtbl,
    0xba3fee4c_ecb9_4e41_83b7_183fa41cd859
);
...
impl IMetaDataEmit {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetModuleProps)(
                windows_core::Interface::as_raw(self),
                szname.param().abi(),
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SaveToStream)(
                windows_core::Interface::as_raw(self),
                pistream.param().abi(),
                dwsaveflags,
            )
    ...
    pub unsafe fn GetSaveSize(
        &self,
        fsave: CorSaveSize,
        pdwsavesize: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetSaveSize)(
                windows_core::Interface::as_raw(self),
                fsave,
                pdwsavesize as _,
            )
    ...
    pub unsafe fn DefineTypeDef<P0>(
        &self,
        sztypedef: P0,
        dwtypedefflags: u32,
        tkextends: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineTypeDef)(
                windows_core::Interface::as_raw(self),
                sztypedef.param().abi(),
                dwtypedefflags,
                tkextends,
    ...
    pub unsafe fn DefineNestedType<P0>(
        &self,
        sztypedef: P0,
        dwtypedefflags: u32,
        tkextends: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineNestedType)(
                windows_core::Interface::as_raw(self),
                sztypedef.param().abi(),
                dwtypedefflags,
                tkextends,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetHandler)(
                windows_core::Interface::as_raw(self),
                punk.param().abi(),
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineMethod)(
                windows_core::Interface::as_raw(self),
                td,
                szname.param().abi(),
                dwmethodflags,
    ...
    pub unsafe fn DefineMethodImpl(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DefineMethodImpl)(
                windows_core::Interface::as_raw(self),
                td,
                tkbody,
                tkdecl,
    ...
    pub unsafe fn DefineTypeRefByName<P1>(
        &self,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineTypeRefByName)(
                windows_core::Interface::as_raw(self),
                tkresolutionscope,
                szname.param().abi(),
                ptr as _,
    ...
    pub unsafe fn DefineImportType<P0, P3, P5>(
        &self,
        passemimport: P0,
        pbhashvalue: *const core::ffi::c_void,
        cbhashvalue: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineImportType)(
                windows_core::Interface::as_raw(self),
                passemimport.param().abi(),
                pbhashvalue,
                cbhashvalue,
                pimport.param().abi(),
                tdimport,
                passememit.param().abi(),
                ptr as _,
            )
            .ok()
        }
    }
    pub unsafe fn DefineMemberRef<P1>(
        &self,
        tkimport: u32,
        szname: P1,
        pvsigblob: *mut u8,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineMemberRef)(
                windows_core::Interface::as_raw(self),
                tkimport,
                szname.param().abi(),
                pvsigblob as _,
    ...
    pub unsafe fn DefineImportMember<P0, P3, P5>(
        &self,
        passemimport: P0,
        pbhashvalue: *const core::ffi::c_void,
        cbhashvalue: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineImportMember)(
                windows_core::Interface::as_raw(self),
                passemimport.param().abi(),
                pbhashvalue,
                cbhashvalue,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineEvent)(
                windows_core::Interface::as_raw(self),
                td,
                szevent.param().abi(),
                dweventflags,
    ...
    pub unsafe fn SetClassLayout(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetClassLayout)(
                windows_core::Interface::as_raw(self),
                td,
                dwpacksize,
                rfieldoffsets as _,
    ...
    pub unsafe fn DeleteClassLayout(&self, td: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteClassLayout)(
                windows_core::Interface::as_raw(self),
                td,
            )
            .ok()
    ...
    pub unsafe fn SetFieldMarshal(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetFieldMarshal)(
                windows_core::Interface::as_raw(self),
                tk,
                pvnativetype as _,
                cbnativetype,
    ...
    pub unsafe fn DeleteFieldMarshal(&self, tk: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteFieldMarshal)(
                windows_core::Interface::as_raw(self),
                tk,
            )
            .ok()
    ...
    pub unsafe fn DefinePermissionSet(
        ...
        tk: u32,
        dwaction: u32,
        pvpermission: *const core::ffi::c_void,
        cbpermission: u32,
        ppm: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DefinePermissionSet)(
                windows_core::Interface::as_raw(self),
                tk,
                dwaction,
                pvpermission,
    ...
    pub unsafe fn SetRVA(&self, md: u32, ulrva: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetRVA)(
                windows_core::Interface::as_raw(self),
                md,
                ulrva,
            )
    ...
    pub unsafe fn GetTokenFromSig(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetTokenFromSig)(
                windows_core::Interface::as_raw(self),
                pvsig as _,
                cbsig,
                pmsig as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineModuleRef)(
                windows_core::Interface::as_raw(self),
                szname.param().abi(),
                pmur as _,
            )
    ...
    pub unsafe fn SetParent(&self, mr: u32, tk: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetParent)(
                windows_core::Interface::as_raw(self),
                mr,
                tk,
            )
    ...
    pub unsafe fn GetTokenFromTypeSpec(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetTokenFromTypeSpec)(
                windows_core::Interface::as_raw(self),
                pvsig as _,
                cbsig,
                ptypespec as _,
    ...
    pub unsafe fn SaveToMemory(
        &self,
        pbdata: *mut core::ffi::c_void,
        cbdata: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SaveToMemory)(
                windows_core::Interface::as_raw(self),
                pbdata as _,
                cbdata,
            )
    ...
    pub unsafe fn DefineUserString<P0>(
        &self,
        szstring: P0,
        cchstring: u32,
        pstk: *mut u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineUserString)(
                windows_core::Interface::as_raw(self),
                szstring.param().abi(),
                cchstring,
                pstk as _,
    ...
    pub unsafe fn DeleteToken(&self, tkobj: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteToken)(
                windows_core::Interface::as_raw(self),
                tkobj,
            )
            .ok()
    ...
    pub unsafe fn SetMethodProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetMethodProps)(
                windows_core::Interface::as_raw(self),
                md,
                dwmethodflags,
                ulcoderva,
    ...
    pub unsafe fn SetTypeDefProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetTypeDefProps)(
                windows_core::Interface::as_raw(self),
                td,
                dwtypedefflags,
                tkextends,
    ...
    pub unsafe fn SetEventProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetEventProps)(
                windows_core::Interface::as_raw(self),
                ev,
                dweventflags,
                tkeventtype,
    ...
    pub unsafe fn SetPermissionSetProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetPermissionSetProps)(
                windows_core::Interface::as_raw(self),
                tk,
                dwaction,
                pvpermission,
    ...
    pub unsafe fn DefinePinvokeMap<P2>(
        &self,
        tk: u32,
        dwmappingflags: u32,
        szimportname: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefinePinvokeMap)(
                windows_core::Interface::as_raw(self),
                tk,
                dwmappingflags,
                szimportname.param().abi(),
                mrimportdll,
            )
            .ok()
        }
    }
    pub unsafe fn SetPinvokeMap<P2>(
        &self,
        tk: u32,
        dwmappingflags: u32,
        szimportname: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetPinvokeMap)(
                windows_core::Interface::as_raw(self),
                tk,
                dwmappingflags,
                szimportname.param().abi(),
    ...
    pub unsafe fn DeletePinvokeMap(&self, tk: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeletePinvokeMap)(
                windows_core::Interface::as_raw(self),
                tk,
            )
            .ok()
    ...
    pub unsafe fn DefineCustomAttribute(
        ...
        tkowner: u32,
        tkctor: u32,
        pcustomattribute: *const core::ffi::c_void,
        cbcustomattribute: u32,
        pcv: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DefineCustomAttribute)(
                windows_core::Interface::as_raw(self),
                tkowner,
                tkctor,
                pcustomattribute,
    ...
    pub unsafe fn SetCustomAttributeValue(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetCustomAttributeValue)(
                windows_core::Interface::as_raw(self),
                pcv,
                pcustomattribute,
                cbcustomattribute,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineField)(
                windows_core::Interface::as_raw(self),
                td,
                szname.param().abi(),
                dwfieldflags,
    ...
    pub unsafe fn DefineProperty<P1>(
        &self,
        td: u32,
        szproperty: P1,
        dwpropflags: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineProperty)(
                windows_core::Interface::as_raw(self),
                td,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineParam)(
                windows_core::Interface::as_raw(self),
                md,
                ulparamseq,
                szname.param().abi(),
    ...
    pub unsafe fn SetFieldProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetFieldProps)(
                windows_core::Interface::as_raw(self),
                fd,
                dwfieldflags,
                dwcplustypeflag,
    ...
    pub unsafe fn SetPropertyProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetPropertyProps)(
                windows_core::Interface::as_raw(self),
                pr,
                dwpropflags,
                dwcplustypeflag,
    ...
    pub unsafe fn SetParamProps<P1>(
        &self,
        pd: u32,
        szname: P1,
        dwparamflags: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetParamProps)(
                windows_core::Interface::as_raw(self),
                pd,
                szname.param().abi(),
                dwparamflags,
    ...
    pub unsafe fn DefineSecurityAttributeSet(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DefineSecurityAttributeSet)(
                windows_core::Interface::as_raw(self),
                tkobj,
                rsecattrs as _,
                csecattrs,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ApplyEditAndContinue)(
                windows_core::Interface::as_raw(self),
                pimport.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn TranslateSigWithScope<P0, P3, P6, P7>(
        &self,
        passemimport: P0,
        pbhashvalue: *const core::ffi::c_void,
        cbhashvalue: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).TranslateSigWithScope)(
                windows_core::Interface::as_raw(self),
                passemimport.param().abi(),
                pbhashvalue,
                cbhashvalue,
                ...
                passememit.param().abi(),
                emit.param().abi(),
                pvtranslatedsig as _,
                cbtranslatedsigmax,
                pcbtranslatedsig as _,
            )
            .ok()
        }
    }
    pub unsafe fn SetMethodImplFlags(&self, md: u32, dwimplflags: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMethodImplFlags)(
                windows_core::Interface::as_raw(self),
                md,
                dwimplflags,
            )
    ...
    pub unsafe fn SetFieldRVA(&self, fd: u32, ulrva: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFieldRVA)(
                windows_core::Interface::as_raw(self),
                fd,
                ulrva,
            )
    ...
    pub unsafe fn MergeEnd(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).MergeEnd)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
}
...
pub struct IMetaDataEmit_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetModuleProps: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(not(feature = "Win32_System_Com"))]
    SaveToStream: usize,
    pub GetSaveSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        CorSaveSize,
        *mut u32,
    ) -> windows_core::HRESULT,
    ...
    pub SetHandler: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetClassLayout: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut COR_FIELD_OFFSET,
        u32,
    ) -> windows_core::HRESULT,
    pub DeleteClassLayout:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub SetFieldMarshal: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u8,
        u32,
    ) -> windows_core::HRESULT,
    pub DeleteFieldMarshal:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    ...
    pub DefineModuleRef: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut u32,
    ) -> windows_core::HRESULT,
    ...
    pub SaveToMemory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ) -> windows_core::HRESULT,
    ...
    pub DeleteToken:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub SetMethodProps: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        u32,
...
pub trait IMetaDataEmit_Impl: windows_core::IUnknownImpl {
    ...
    fn SaveToStream(
        &self,
        pistream: windows_core::Ref<'_, super::super::Com::IStream>,
        dwsaveflags: u32,
    ) -> windows_core::Result<()>;
    fn GetSaveSize(&self, fsave: CorSaveSize, pdwsavesize: *mut u32) -> windows_core::Result<()>;
    fn DefineTypeDef(
        &self,
        sztypedef: &windows_core::PCWSTR,
        dwtypedefflags: u32,
        tkextends: u32,
        rtkimplements: *mut u32,
        ptd: *mut u32,
    ...
    fn DefineImportType(
        &self,
        passemimport: windows_core::Ref<'_, IMetaDataAssemblyImport>,
        pbhashvalue: *const core::ffi::c_void,
        cbhashvalue: u32,
        pimport: windows_core::Ref<'_, IMetaDataImport>,
        tdimport: u32,
        passememit: windows_core::Ref<'_, IMetaDataAssemblyEmit>,
        ptr: *mut u32,
    ) -> windows_core::Result<()>;
    fn DefineMemberRef(
        &self,
    ...
    fn SaveToMemory(&self, pbdata: *mut core::ffi::c_void, cbdata: u32)
        -> windows_core::Result<()>;
    fn DefineUserString(
        &self,
    ...
    fn DefinePinvokeMap(
        ...
        tk: u32,
        dwmappingflags: u32,
        szimportname: &windows_core::PCWSTR,
        mrimportdll: u32,
    ) -> windows_core::Result<()>;
    fn SetPinvokeMap(
        &self,
    ...
    fn DefineProperty(
        &self,
        td: u32,
        szproperty: &windows_core::PCWSTR,
        dwpropflags: u32,
        pvsig: *mut u8,
        cbsig: u32,
        dwcplustypeflag: u32,
    ...
    fn ApplyEditAndContinue(
        &self,
        pimport: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
    fn TranslateSigWithScope(
        ...
        pbhashvalue: *const core::ffi::c_void,
        cbhashvalue: u32,
        import: windows_core::Ref<'_, IMetaDataImport>,
        pbsigblob: *mut u8,
        cbsigblob: u32,
        passememit: windows_core::Ref<'_, IMetaDataAssemblyEmit>,
        emit: windows_core::Ref<'_, IMetaDataEmit>,
        pvtranslatedsig: *mut u8,
        cbtranslatedsigmax: u32,
        pcbtranslatedsig: *mut u32,
    ) -> windows_core::Result<()>;
    ...
    fn Merge(
        &self,
        pimport: windows_core::Ref<'_, IMetaDataImport>,
        phostmaptoken: windows_core::Ref<'_, IMapToken>,
        phandler: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
...
impl IMetaDataEmit_Vtbl {
    pub const fn new<Identity: IMetaDataEmit_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetModuleProps<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            szname: windows_core::PCWSTR,
        ...
        unsafe extern "system" fn Save<Identity: IMetaDataEmit_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            szfile: windows_core::PCWSTR,
            dwsaveflags: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::Save(
                    this,
                    core::mem::transmute(&szfile),
                    core::mem::transmute_copy(&dwsaveflags),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SaveToStream(
                    this,
        ...
        unsafe extern "system" fn GetSaveSize<Identity: IMetaDataEmit_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fsave: CorSaveSize,
            pdwsavesize: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::GetSaveSize(
                    this,
                    core::mem::transmute_copy(&fsave),
                    core::mem::transmute_copy(&pdwsavesize),
                )
                .into()
            }
        }
        unsafe extern "system" fn DefineTypeDef<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineTypeDef(
                    this,
                    core::mem::transmute(&sztypedef),
                    core::mem::transmute_copy(&dwtypedefflags),
                    core::mem::transmute_copy(&tkextends),
                    core::mem::transmute_copy(&rtkimplements),
                    core::mem::transmute_copy(&ptd),
                )
                .into()
            }
        }
        unsafe extern "system" fn DefineNestedType<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineNestedType(
                    this,
                    core::mem::transmute(&sztypedef),
                    core::mem::transmute_copy(&dwtypedefflags),
                    core::mem::transmute_copy(&tkextends),
                    core::mem::transmute_copy(&rtkimplements),
                    core::mem::transmute_copy(&tdencloser),
                    core::mem::transmute_copy(&ptd),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetHandler<Identity: IMetaDataEmit_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn DefineMethod<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineMethod(
                    this,
                    core::mem::transmute_copy(&td),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&dwmethodflags),
                    core::mem::transmute_copy(&pvsigblob),
                    core::mem::transmute_copy(&cbsigblob),
                    core::mem::transmute_copy(&ulcoderva),
                    core::mem::transmute_copy(&dwimplflags),
                    core::mem::transmute_copy(&pmd),
                )
                .into()
            }
        }
        unsafe extern "system" fn DefineMethodImpl<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineMethodImpl(
                    this,
                    core::mem::transmute_copy(&td),
                    core::mem::transmute_copy(&tkbody),
                    core::mem::transmute_copy(&tkdecl),
                )
                .into()
            }
        }
        unsafe extern "system" fn DefineTypeRefByName<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineTypeRefByName(
                    this,
                    core::mem::transmute_copy(&tkresolutionscope),
                    core::mem::transmute(&szname),
        ...
        unsafe extern "system" fn DefineImportType<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            passemimport: *mut core::ffi::c_void,
            pbhashvalue: *const core::ffi::c_void,
            cbhashvalue: u32,
            pimport: *mut core::ffi::c_void,
            tdimport: u32,
            passememit: *mut core::ffi::c_void,
            ptr: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineImportType(
                    this,
                    core::mem::transmute_copy(&passemimport),
                    core::mem::transmute_copy(&pbhashvalue),
                    core::mem::transmute_copy(&cbhashvalue),
                    core::mem::transmute_copy(&pimport),
                    core::mem::transmute_copy(&tdimport),
                    core::mem::transmute_copy(&passememit),
                    core::mem::transmute_copy(&ptr),
                )
                .into()
            }
        }
        unsafe extern "system" fn DefineMemberRef<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineMemberRef(
                    this,
                    core::mem::transmute_copy(&tkimport),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&pvsigblob),
                    core::mem::transmute_copy(&cbsigblob),
                    core::mem::transmute_copy(&pmr),
                )
                .into()
            }
        }
        unsafe extern "system" fn DefineImportMember<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineImportMember(
                    this,
                    core::mem::transmute_copy(&passemimport),
                    core::mem::transmute_copy(&pbhashvalue),
                    core::mem::transmute_copy(&cbhashvalue),
                    core::mem::transmute_copy(&pimport),
                    core::mem::transmute_copy(&mbmember),
                    core::mem::transmute_copy(&passememit),
        ...
        unsafe extern "system" fn DefineEvent<Identity: IMetaDataEmit_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            td: u32,
            szevent: windows_core::PCWSTR,
            dweventflags: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineEvent(
                    this,
                    core::mem::transmute_copy(&td),
                    core::mem::transmute(&szevent),
                    core::mem::transmute_copy(&dweventflags),
                    core::mem::transmute_copy(&tkeventtype),
                    core::mem::transmute_copy(&mdaddon),
                    core::mem::transmute_copy(&mdremoveon),
                    core::mem::transmute_copy(&mdfire),
                    core::mem::transmute_copy(&rmdothermethods),
                    core::mem::transmute_copy(&pmdevent),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetClassLayout<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetClassLayout(
                    this,
                    core::mem::transmute_copy(&td),
                    core::mem::transmute_copy(&dwpacksize),
                    core::mem::transmute_copy(&rfieldoffsets),
                    core::mem::transmute_copy(&ulclasssize),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeleteClassLayout<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetFieldMarshal<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetFieldMarshal(
                    this,
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&pvnativetype),
                    core::mem::transmute_copy(&cbnativetype),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeleteFieldMarshal<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn DefinePermissionSet<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefinePermissionSet(
                    this,
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&dwaction),
                    core::mem::transmute_copy(&pvpermission),
                    core::mem::transmute_copy(&cbpermission),
                    core::mem::transmute_copy(&ppm),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetRVA<Identity: IMetaDataEmit_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            md: u32,
            ulrva: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetRVA(
                    this,
                    core::mem::transmute_copy(&md),
                    core::mem::transmute_copy(&ulrva),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetTokenFromSig<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::GetTokenFromSig(
                    this,
                    core::mem::transmute_copy(&pvsig),
                    core::mem::transmute_copy(&cbsig),
                    core::mem::transmute_copy(&pmsig),
                )
                .into()
            }
        }
        unsafe extern "system" fn DefineModuleRef<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineModuleRef(
                    this,
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&pmur),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetParent<Identity: IMetaDataEmit_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            mr: u32,
            tk: u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetTokenFromTypeSpec<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::GetTokenFromTypeSpec(
                    this,
                    core::mem::transmute_copy(&pvsig),
                    core::mem::transmute_copy(&cbsig),
                    core::mem::transmute_copy(&ptypespec),
                )
                .into()
            }
        }
        unsafe extern "system" fn SaveToMemory<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SaveToMemory(
                    this,
        ...
        unsafe extern "system" fn DefineUserString<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineUserString(
                    this,
                    core::mem::transmute(&szstring),
                    core::mem::transmute_copy(&cchstring),
                    core::mem::transmute_copy(&pstk),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeleteToken<Identity: IMetaDataEmit_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            tkobj: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetMethodProps<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetMethodProps(
                    this,
                    core::mem::transmute_copy(&md),
                    core::mem::transmute_copy(&dwmethodflags),
                    core::mem::transmute_copy(&ulcoderva),
        ...
        unsafe extern "system" fn SetTypeDefProps<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetTypeDefProps(
                    this,
                    core::mem::transmute_copy(&td),
                    core::mem::transmute_copy(&dwtypedefflags),
                    core::mem::transmute_copy(&tkextends),
        ...
        unsafe extern "system" fn SetEventProps<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetEventProps(
                    this,
        ...
        unsafe extern "system" fn SetPermissionSetProps<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetPermissionSetProps(
                    this,
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&dwaction),
                    core::mem::transmute_copy(&pvpermission),
        ...
        unsafe extern "system" fn DefinePinvokeMap<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefinePinvokeMap(
                    this,
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&dwmappingflags),
                    core::mem::transmute(&szimportname),
                    core::mem::transmute_copy(&mrimportdll),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetPinvokeMap<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetPinvokeMap(
                    this,
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&dwmappingflags),
                    core::mem::transmute(&szimportname),
        ...
        unsafe extern "system" fn DeletePinvokeMap<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn DefineCustomAttribute<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineCustomAttribute(
                    this,
                    core::mem::transmute_copy(&tkowner),
                    core::mem::transmute_copy(&tkctor),
                    core::mem::transmute_copy(&pcustomattribute),
                    core::mem::transmute_copy(&cbcustomattribute),
                    core::mem::transmute_copy(&pcv),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetCustomAttributeValue<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetCustomAttributeValue(
                    this,
                    core::mem::transmute_copy(&pcv),
                    core::mem::transmute_copy(&pcustomattribute),
                    core::mem::transmute_copy(&cbcustomattribute),
        ...
        unsafe extern "system" fn DefineField<Identity: IMetaDataEmit_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            td: u32,
            szname: windows_core::PCWSTR,
            dwfieldflags: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineField(
                    this,
                    core::mem::transmute_copy(&td),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&dwfieldflags),
                    core::mem::transmute_copy(&pvsigblob),
                    core::mem::transmute_copy(&cbsigblob),
        ...
        unsafe extern "system" fn DefineProperty<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineProperty(
                    this,
                    core::mem::transmute_copy(&td),
        ...
        unsafe extern "system" fn DefineParam<Identity: IMetaDataEmit_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            md: u32,
            ulparamseq: u32,
            szname: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineParam(
                    this,
                    core::mem::transmute_copy(&md),
                    core::mem::transmute_copy(&ulparamseq),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&dwparamflags),
                    core::mem::transmute_copy(&dwcplustypeflag),
                    core::mem::transmute_copy(&pvalue),
                    core::mem::transmute_copy(&cchvalue),
                    core::mem::transmute_copy(&ppd),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetFieldProps<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetFieldProps(
                    this,
                    core::mem::transmute_copy(&fd),
                    core::mem::transmute_copy(&dwfieldflags),
                    core::mem::transmute_copy(&dwcplustypeflag),
                    core::mem::transmute_copy(&pvalue),
                    core::mem::transmute_copy(&cchvalue),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetPropertyProps(
                    this,
                    core::mem::transmute_copy(&pr),
                    core::mem::transmute_copy(&dwpropflags),
                    core::mem::transmute_copy(&dwcplustypeflag),
                    core::mem::transmute_copy(&pvalue),
                    core::mem::transmute_copy(&cchvalue),
        ...
        unsafe extern "system" fn SetParamProps<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetParamProps(
                    this,
                    core::mem::transmute_copy(&pd),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&dwparamflags),
                    core::mem::transmute_copy(&dwcplustypeflag),
                    core::mem::transmute_copy(&pvalue),
        ...
        unsafe extern "system" fn DefineSecurityAttributeSet<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::DefineSecurityAttributeSet(
                    this,
                    core::mem::transmute_copy(&tkobj),
                    core::mem::transmute_copy(&rsecattrs),
                    core::mem::transmute_copy(&csecattrs),
                    core::mem::transmute_copy(&pulerrorattr),
                )
                .into()
            }
        }
        unsafe extern "system" fn ApplyEditAndContinue<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::ApplyEditAndContinue(this, core::mem::transmute_copy(&pimport))
                    .into()
            }
        }
        unsafe extern "system" fn TranslateSigWithScope<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            pbhashvalue: *const core::ffi::c_void,
            cbhashvalue: u32,
            import: *mut core::ffi::c_void,
            pbsigblob: *mut u8,
            cbsigblob: u32,
            passememit: *mut core::ffi::c_void,
            emit: *mut core::ffi::c_void,
            pvtranslatedsig: *mut u8,
            cbtranslatedsigmax: u32,
            pcbtranslatedsig: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::TranslateSigWithScope(
                    this,
                    core::mem::transmute_copy(&passemimport),
                    core::mem::transmute_copy(&pbhashvalue),
                    core::mem::transmute_copy(&cbhashvalue),
                    core::mem::transmute_copy(&import),
                    core::mem::transmute_copy(&pbsigblob),
                    core::mem::transmute_copy(&cbsigblob),
                    core::mem::transmute_copy(&passememit),
                    core::mem::transmute_copy(&emit),
        ...
        unsafe extern "system" fn SetMethodImplFlags<
            Identity: IMetaDataEmit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetMethodImplFlags(
                    this,
                    core::mem::transmute_copy(&md),
                    core::mem::transmute_copy(&dwimplflags),
                )
        ...
        unsafe extern "system" fn SetFieldRVA<Identity: IMetaDataEmit_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fd: u32,
            ulrva: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::SetFieldRVA(
                    this,
                    core::mem::transmute_copy(&fd),
                    core::mem::transmute_copy(&ulrva),
                )
        ...
        unsafe extern "system" fn Merge<Identity: IMetaDataEmit_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pimport: *mut core::ffi::c_void,
            phostmaptoken: *mut core::ffi::c_void,
            phandler: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit_Impl::Merge(
                    this,
                    core::mem::transmute_copy(&pimport),
                    core::mem::transmute_copy(&phostmaptoken),
                    core::mem::transmute_copy(&phandler),
                )
                .into()
            }
        }
        unsafe extern "system" fn MergeEnd<Identity: IMetaDataEmit_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    IMetaDataEmit2,
    IMetaDataEmit2_Vtbl,
    0xf5dd9950_f693_42e6_830e_7b833e8146a9
);
...
impl IMetaDataEmit2 {
    pub unsafe fn DefineMethodSpec(
        &self,
        tkparent: u32,
        pvsigblob: *mut u8,
        cbsigblob: u32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DefineMethodSpec)(
                windows_core::Interface::as_raw(self),
                tkparent,
                pvsigblob as _,
                cbsigblob,
    ...
    pub unsafe fn GetDeltaSaveSize(
        &self,
        fsave: CorSaveSize,
        pdwsavesize: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetDeltaSaveSize)(
                windows_core::Interface::as_raw(self),
                fsave,
                pdwsavesize as _,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SaveDelta)(
                windows_core::Interface::as_raw(self),
                szfile.param().abi(),
                dwsaveflags,
            )
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SaveDeltaToStream<P0>(
        &self,
        pistream: P0,
        dwsaveflags: u32,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SaveDeltaToStream)(
                windows_core::Interface::as_raw(self),
                pistream.param().abi(),
                dwsaveflags,
            )
    ...
    pub unsafe fn SaveDeltaToMemory(
        &self,
        pbdata: *mut core::ffi::c_void,
        cbdata: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SaveDeltaToMemory)(
                windows_core::Interface::as_raw(self),
                pbdata as _,
                cbdata,
            )
    ...
    pub unsafe fn DefineGenericParam<P3>(
        &self,
        tk: u32,
        ulparamseq: u32,
        dwparamflags: u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DefineGenericParam)(
                windows_core::Interface::as_raw(self),
                tk,
                ulparamseq,
                dwparamflags,
    ...
    pub unsafe fn SetGenericParamProps<P2>(
        &self,
        gp: u32,
        dwparamflags: u32,
        szname: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetGenericParamProps)(
                windows_core::Interface::as_raw(self),
                gp,
                dwparamflags,
                szname.param().abi(),
    ...
    pub unsafe fn ResetENCLog(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ResetENCLog)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub struct IMetaDataEmit2_Vtbl {
    ...
    pub GetDeltaSaveSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        CorSaveSize,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub SaveDelta: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
    ) -> windows_core::HRESULT,
    ...
    pub SaveDeltaToMemory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ) -> windows_core::HRESULT,
...
impl IMetaDataEmit2_Vtbl {
    pub const fn new<Identity: IMetaDataEmit2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DefineMethodSpec<
            Identity: IMetaDataEmit2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            tkparent: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit2_Impl::DefineMethodSpec(
                    this,
                    core::mem::transmute_copy(&tkparent),
                    core::mem::transmute_copy(&pvsigblob),
                    core::mem::transmute_copy(&cbsigblob),
                    core::mem::transmute_copy(&pmi),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetDeltaSaveSize<
            Identity: IMetaDataEmit2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit2_Impl::GetDeltaSaveSize(
                    this,
                    core::mem::transmute_copy(&fsave),
                    core::mem::transmute_copy(&pdwsavesize),
                )
        ...
        unsafe extern "system" fn SaveDelta<Identity: IMetaDataEmit2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            szfile: windows_core::PCWSTR,
            dwsaveflags: u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn SaveDeltaToStream<
            Identity: IMetaDataEmit2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit2_Impl::SaveDeltaToStream(
                    this,
                    core::mem::transmute_copy(&pistream),
                    core::mem::transmute_copy(&dwsaveflags),
                )
        ...
        unsafe extern "system" fn SaveDeltaToMemory<
            Identity: IMetaDataEmit2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit2_Impl::SaveDeltaToMemory(
                    this,
                    core::mem::transmute_copy(&pbdata),
                    core::mem::transmute_copy(&cbdata),
                )
        ...
        unsafe extern "system" fn DefineGenericParam<
            Identity: IMetaDataEmit2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit2_Impl::DefineGenericParam(
                    this,
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&ulparamseq),
                    core::mem::transmute_copy(&dwparamflags),
                    ...
                    core::mem::transmute_copy(&rtkconstraints),
                    core::mem::transmute_copy(&pgp),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetGenericParamProps<
            Identity: IMetaDataEmit2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataEmit2_Impl::SetGenericParamProps(
                    this,
                    core::mem::transmute_copy(&gp),
                    core::mem::transmute_copy(&dwparamflags),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&reserved),
                    core::mem::transmute_copy(&rtkconstraints),
        ...
        unsafe extern "system" fn ResetENCLog<
            Identity: IMetaDataEmit2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IMetaDataError,
    IMetaDataError_Vtbl,
    0xb81ff171_20f3_11d2_8dcc_00a0c9b09c19
);
...
impl IMetaDataError_Vtbl {
    pub const fn new<Identity: IMetaDataError_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OnError<Identity: IMetaDataError_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hrerror: windows_core::HRESULT,
            token: u32,
        ) -> windows_core::HRESULT {
...
windows_core::imp::define_interface!(
    ...
    0xd0e80dd1_12d4_11d3_b39d_00c04ff81795
);
...
impl IMetaDataFilter {
    pub unsafe fn UnmarkAll(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).UnmarkAll)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn MarkToken(&self, tk: u32) -> windows_core::Result<()> {
    ...
    pub unsafe fn IsTokenMarked(
        &self,
        tk: u32,
        pismarked: *mut windows_core::BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).IsTokenMarked)(
                windows_core::Interface::as_raw(self),
                tk,
                pismarked as _,
            )
...
pub struct IMetaDataFilter_Vtbl {
    ...
    pub MarkToken: unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub IsTokenMarked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
...
impl IMetaDataFilter_Vtbl {
    pub const fn new<Identity: IMetaDataFilter_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn UnmarkAll<Identity: IMetaDataFilter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn MarkToken<Identity: IMetaDataFilter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            tk: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn IsTokenMarked<
            Identity: IMetaDataFilter_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            tk: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataFilter_Impl::IsTokenMarked(
                    this,
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&pismarked),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x7dac8207_d3ae_4c75_9b67_92801a497d44
);
...
impl IMetaDataImport {
    ...
    pub unsafe fn CountEnum(
        &self,
        henum: *mut core::ffi::c_void,
        pulcount: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CountEnum)(
                windows_core::Interface::as_raw(self),
                henum as _,
                pulcount as _,
            )
    ...
    pub unsafe fn ResetEnum(
        &self,
        henum: *mut core::ffi::c_void,
        ulpos: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ResetEnum)(
                windows_core::Interface::as_raw(self),
                henum as _,
                ulpos,
            )
    ...
    pub unsafe fn EnumTypeDefs(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumTypeDefs)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                rtypedefs as _,
                cmax,
    ...
    pub unsafe fn EnumInterfaceImpls(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumInterfaceImpls)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                td,
                rimpls as _,
    ...
    pub unsafe fn EnumTypeRefs(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumTypeRefs)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                rtyperefs as _,
                cmax,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).FindTypeDefByName)(
                windows_core::Interface::as_raw(self),
                sztypedef.param().abi(),
                tkenclosingclass,
                ptd as _,
    ...
    pub unsafe fn GetScopeProps(
        ...
        szname: Option<&mut [u16]>,
        pchname: *mut u32,
        pmvid: *mut windows_core::GUID,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetScopeProps)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(
                    szname
                        .as_deref()
    ...
    pub unsafe fn GetModuleFromScope(&self, pmd: *mut u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetModuleFromScope)(
                windows_core::Interface::as_raw(self),
                pmd as _,
            )
            .ok()
    ...
    pub unsafe fn GetTypeDefProps(
        &self,
        td: u32,
        sztypedef: Option<&mut [u16]>,
        pchtypedef: *mut u32,
        pdwtypedefflags: *mut u32,
        ptkextends: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetTypeDefProps)(
                windows_core::Interface::as_raw(self),
                td,
                core::mem::transmute(
                    sztypedef
    ...
    pub unsafe fn GetInterfaceImplProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetInterfaceImplProps)(
                windows_core::Interface::as_raw(self),
                iiimpl,
                pclass as _,
                ptkiface as _,
    ...
    pub unsafe fn GetTypeRefProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetTypeRefProps)(
                windows_core::Interface::as_raw(self),
                tr,
                ptkresolutionscope as _,
                core::mem::transmute(
                    szname
                        .as_deref()
                        .map_or(core::ptr::null(), |slice| slice.as_ptr()),
    ...
    pub unsafe fn ResolveTypeRef(
        ...
        tr: u32,
        riid: *const windows_core::GUID,
        ppiscope: *mut Option<windows_core::IUnknown>,
        ptd: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ResolveTypeRef)(
                windows_core::Interface::as_raw(self),
                tr,
                riid,
                core::mem::transmute(ppiscope),
                ptd as _,
            )
            .ok()
        }
    ...
    pub unsafe fn EnumMembers(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumMembers)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                cl,
                rmembers as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EnumMembersWithName)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                cl,
                szname.param().abi(),
    ...
    pub unsafe fn EnumMethods(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumMethods)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                cl,
                rmethods as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EnumMethodsWithName)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                cl,
                szname.param().abi(),
    ...
    pub unsafe fn EnumFields(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumFields)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                cl,
                rfields as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).EnumFieldsWithName)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                cl,
                szname.param().abi(),
    ...
    pub unsafe fn EnumParams(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumParams)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                mb,
                rparams as _,
    ...
    pub unsafe fn EnumMemberRefs(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumMemberRefs)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                tkparent,
                rmemberrefs as _,
    ...
    pub unsafe fn EnumMethodImpls(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumMethodImpls)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                td,
                rmethodbody as _,
    ...
    pub unsafe fn EnumPermissionSets(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumPermissionSets)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                tk,
                dwactions,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).FindMember)(
                windows_core::Interface::as_raw(self),
                td,
                szname.param().abi(),
                pvsigblob as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).FindMethod)(
                windows_core::Interface::as_raw(self),
                td,
                szname.param().abi(),
                pvsigblob as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).FindField)(
                windows_core::Interface::as_raw(self),
                td,
                szname.param().abi(),
                pvsigblob as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).FindMemberRef)(
                windows_core::Interface::as_raw(self),
                td,
                szname.param().abi(),
                pvsigblob as _,
    ...
    pub unsafe fn GetMethodProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetMethodProps)(
                windows_core::Interface::as_raw(self),
                mb,
                pclass as _,
                core::mem::transmute(
    ...
    pub unsafe fn GetMemberRefProps(
        ...
        mr: u32,
        ptk: *mut u32,
        szmember: Option<&mut [u16]>,
        pchmember: *mut u32,
        ppvsigblob: *mut *mut u8,
        pbsig: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetMemberRefProps)(
                windows_core::Interface::as_raw(self),
                mr,
                ptk as _,
                core::mem::transmute(
    ...
    pub unsafe fn EnumEvents(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumEvents)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                td,
                revents as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetEventProps)(
                windows_core::Interface::as_raw(self),
                ev,
                pclass as _,
                szevent.param().abi(),
    ...
    pub unsafe fn EnumMethodSemantics(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumMethodSemantics)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                mb,
                reventprop as _,
    ...
    pub unsafe fn GetMethodSemantics(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetMethodSemantics)(
                windows_core::Interface::as_raw(self),
                mb,
                tkeventprop,
                pdwsemanticsflags as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetClassLayout(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetClassLayout)(
                windows_core::Interface::as_raw(self),
                td,
                pdwpacksize as _,
                rfieldoffset as _,
    ...
    pub unsafe fn GetFieldMarshal(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetFieldMarshal)(
                windows_core::Interface::as_raw(self),
                tk,
                ppvnativetype as _,
                pcbnativetype as _,
    ...
    pub unsafe fn GetRVA(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetRVA)(
                windows_core::Interface::as_raw(self),
                tk,
                pulcoderva as _,
                pdwimplflags as _,
    ...
    pub unsafe fn GetPermissionSetProps(
        ...
        pm: u32,
        pdwaction: *mut u32,
        ppvpermission: *const *const core::ffi::c_void,
        pcbpermission: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPermissionSetProps)(
                windows_core::Interface::as_raw(self),
                pm,
                pdwaction as _,
                ppvpermission,
    ...
    pub unsafe fn GetSigFromToken(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetSigFromToken)(
                windows_core::Interface::as_raw(self),
                mdsig,
                ppvsig as _,
                pcbsig as _,
    ...
    pub unsafe fn GetModuleRefProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetModuleRefProps)(
                windows_core::Interface::as_raw(self),
                mur,
                core::mem::transmute(
                    szname
    ...
    pub unsafe fn EnumModuleRefs(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumModuleRefs)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                rmodulerefs as _,
                cmax,
    ...
    pub unsafe fn GetTypeSpecFromToken(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetTypeSpecFromToken)(
                windows_core::Interface::as_raw(self),
                typespec,
                ppvsig as _,
                pcbsig as _,
    ...
    pub unsafe fn GetNameFromToken(
        &self,
        tk: u32,
        pszutf8nameptr: *mut *mut i8,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetNameFromToken)(
                windows_core::Interface::as_raw(self),
                tk,
                pszutf8nameptr as _,
            )
    ...
    pub unsafe fn EnumUnresolvedMethods(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumUnresolvedMethods)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                rmethods as _,
                cmax,
    ...
    pub unsafe fn GetUserString(
        &self,
        stk: u32,
        szstring: Option<&mut [u16]>,
        pchstring: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetUserString)(
                windows_core::Interface::as_raw(self),
                stk,
                core::mem::transmute(
                    szstring
    ...
    pub unsafe fn GetPinvokeMap(
        ...
        szimportname: Option<&mut [u16]>,
        pchimportname: *mut u32,
        pmrimportdll: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPinvokeMap)(
                windows_core::Interface::as_raw(self),
                tk,
                pdwmappingflags as _,
                core::mem::transmute(
                    szimportname
                        .as_deref()
                        .map_or(core::ptr::null(), |slice| slice.as_ptr()),
    ...
    pub unsafe fn EnumSignatures(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumSignatures)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                rsignatures as _,
                cmax,
    ...
    pub unsafe fn EnumTypeSpecs(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumTypeSpecs)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                rtypespecs as _,
                cmax,
    ...
    pub unsafe fn EnumUserStrings(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumUserStrings)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                rstrings as _,
                cmax,
    ...
    pub unsafe fn GetParamForMethodIndex(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetParamForMethodIndex)(
                windows_core::Interface::as_raw(self),
                md,
                ulparamseq,
                ppd as _,
    ...
    pub unsafe fn EnumCustomAttributes(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumCustomAttributes)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                tk,
                tktype,
                rcustomattributes as _,
                cmax,
                pccustomattributes as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetCustomAttributeProps(
        ...
        ptkobj: *mut u32,
        ptktype: *mut u32,
        ppblob: *const *const core::ffi::c_void,
        pcbsize: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetCustomAttributeProps)(
                windows_core::Interface::as_raw(self),
                cv,
                ptkobj as _,
                ptktype as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).FindTypeRef)(
                windows_core::Interface::as_raw(self),
                tkresolutionscope,
                szname.param().abi(),
                ptr as _,
    ...
    pub unsafe fn GetFieldProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetFieldProps)(
                windows_core::Interface::as_raw(self),
                mb,
                pclass as _,
                core::mem::transmute(
    ...
    pub unsafe fn GetPropertyProps<P2>(
        ...
        pbsig: *mut u32,
        pdwcplustypeflag: *mut u32,
        ppdefaultvalue: *mut *mut core::ffi::c_void,
    ...
    pub unsafe fn GetParamProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetParamProps)(
                windows_core::Interface::as_raw(self),
                tk,
                pmd as _,
                pulsequence as _,
    ...
    pub unsafe fn GetCustomAttributeByName<P1>(
        ...
        tkobj: u32,
        szname: P1,
        ppdata: *const *const core::ffi::c_void,
        pcbdata: *mut u32,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetCustomAttributeByName)(
                windows_core::Interface::as_raw(self),
                tkobj,
                szname.param().abi(),
                ppdata,
    ...
    pub unsafe fn IsValidToken(&self, tk: u32) -> windows_core::BOOL {
        unsafe {
            (windows_core::Interface::vtable(self).IsValidToken)(
                windows_core::Interface::as_raw(self),
                tk,
            )
        }
    ...
    pub unsafe fn GetNestedClassProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetNestedClassProps)(
                windows_core::Interface::as_raw(self),
                tdnestedclass,
                ptdenclosingclass as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetNativeCallConvFromSig(
        &self,
        pvsig: *const core::ffi::c_void,
        cbsig: u32,
        pcallconv: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetNativeCallConvFromSig)(
                windows_core::Interface::as_raw(self),
                pvsig,
                cbsig,
                pcallconv as _,
    ...
    pub unsafe fn IsGlobal(&self, pd: u32, pbglobal: *mut i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).IsGlobal)(
                windows_core::Interface::as_raw(self),
                pd,
                pbglobal as _,
            )
...
pub struct IMetaDataImport_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CloseEnum: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void),
    pub CountEnum: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub ResetEnum: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ) -> windows_core::HRESULT,
...
pub trait IMetaDataImport_Impl: windows_core::IUnknownImpl {
    ...
    fn ResolveTypeRef(
        ...
        tr: u32,
        riid: *const windows_core::GUID,
        ppiscope: windows_core::OutRef<'_, windows_core::IUnknown>,
        ptd: *mut u32,
    ) -> windows_core::Result<()>;
    fn EnumMembers(
        &self,
    ...
    fn GetPinvokeMap(
        ...
        tk: u32,
        pdwmappingflags: *mut u32,
        szimportname: windows_core::PWSTR,
        cchimportname: u32,
        pchimportname: *mut u32,
        pmrimportdll: *mut u32,
    ) -> windows_core::Result<()>;
...
impl IMetaDataImport_Vtbl {
    pub const fn new<Identity: IMetaDataImport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CloseEnum<Identity: IMetaDataImport_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            henum: *mut core::ffi::c_void,
        ) {
            unsafe {
        ...
        unsafe extern "system" fn CountEnum<Identity: IMetaDataImport_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            henum: *mut core::ffi::c_void,
            pulcount: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::CountEnum(
                    this,
                    core::mem::transmute_copy(&henum),
                    core::mem::transmute_copy(&pulcount),
                )
                .into()
            }
        }
        unsafe extern "system" fn ResetEnum<Identity: IMetaDataImport_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            henum: *mut core::ffi::c_void,
            ulpos: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::ResetEnum(
                    this,
                    core::mem::transmute_copy(&henum),
                    core::mem::transmute_copy(&ulpos),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumTypeDefs<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumTypeDefs(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&rtypedefs),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctypedefs),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumInterfaceImpls<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumInterfaceImpls(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&td),
                    core::mem::transmute_copy(&rimpls),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pcimpls),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumTypeRefs<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumTypeRefs(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&rtyperefs),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctyperefs),
                )
                .into()
            }
        }
        unsafe extern "system" fn FindTypeDefByName<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::FindTypeDefByName(
                    this,
                    core::mem::transmute(&sztypedef),
                    core::mem::transmute_copy(&tkenclosingclass),
                    core::mem::transmute_copy(&ptd),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetScopeProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetScopeProps(
                    this,
                    core::mem::transmute_copy(&szname),
                    core::mem::transmute_copy(&cchname),
                    core::mem::transmute_copy(&pchname),
                    core::mem::transmute_copy(&pmvid),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetModuleFromScope<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetModuleFromScope(this, core::mem::transmute_copy(&pmd))
                    .into()
            }
        }
        unsafe extern "system" fn GetTypeDefProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetTypeDefProps(
                    this,
                    core::mem::transmute_copy(&td),
                    core::mem::transmute_copy(&sztypedef),
                    core::mem::transmute_copy(&cchtypedef),
                    core::mem::transmute_copy(&pchtypedef),
                    core::mem::transmute_copy(&pdwtypedefflags),
                    core::mem::transmute_copy(&ptkextends),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetInterfaceImplProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetInterfaceImplProps(
                    this,
                    core::mem::transmute_copy(&iiimpl),
                    core::mem::transmute_copy(&pclass),
                    core::mem::transmute_copy(&ptkiface),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetTypeRefProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetTypeRefProps(
                    this,
                    core::mem::transmute_copy(&tr),
                    core::mem::transmute_copy(&ptkresolutionscope),
                    core::mem::transmute_copy(&szname),
                    core::mem::transmute_copy(&cchname),
                    core::mem::transmute_copy(&pchname),
                )
        ...
        unsafe extern "system" fn ResolveTypeRef<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            tr: u32,
            riid: *const windows_core::GUID,
            ppiscope: *mut *mut core::ffi::c_void,
            ptd: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::ResolveTypeRef(
                    this,
                    core::mem::transmute_copy(&tr),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppiscope),
                    core::mem::transmute_copy(&ptd),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumMembers<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumMembers(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&cl),
                    core::mem::transmute_copy(&rmembers),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctokens),
                )
                .into()
        ...
        unsafe extern "system" fn EnumMembersWithName<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumMembersWithName(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&cl),
                    core::mem::transmute(&szname),
        ...
        unsafe extern "system" fn EnumMethods<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumMethods(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&cl),
                    core::mem::transmute_copy(&rmethods),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctokens),
                )
                .into()
        ...
        unsafe extern "system" fn EnumMethodsWithName<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumMethodsWithName(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&cl),
                    core::mem::transmute(&szname),
        ...
        unsafe extern "system" fn EnumFields<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumFields(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&cl),
                    core::mem::transmute_copy(&rfields),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctokens),
                )
                .into()
        ...
        unsafe extern "system" fn EnumFieldsWithName<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumFieldsWithName(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&cl),
                    core::mem::transmute(&szname),
        ...
        unsafe extern "system" fn EnumParams<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumParams(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&mb),
                    core::mem::transmute_copy(&rparams),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctokens),
                )
                .into()
        ...
        unsafe extern "system" fn EnumMemberRefs<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumMemberRefs(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&tkparent),
                    core::mem::transmute_copy(&rmemberrefs),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctokens),
                )
                .into()
        ...
        unsafe extern "system" fn EnumMethodImpls<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumMethodImpls(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&td),
                    core::mem::transmute_copy(&rmethodbody),
                    core::mem::transmute_copy(&rmethoddecl),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctokens),
                )
                .into()
        ...
        unsafe extern "system" fn EnumPermissionSets<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumPermissionSets(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&dwactions),
                    core::mem::transmute_copy(&rpermission),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctokens),
                )
                .into()
        ...
        unsafe extern "system" fn FindMember<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::FindMember(
                    this,
                    core::mem::transmute_copy(&td),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&pvsigblob),
                    core::mem::transmute_copy(&cbsigblob),
                    core::mem::transmute_copy(&pmb),
                )
                .into()
            }
        }
        unsafe extern "system" fn FindMethod<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::FindMethod(
                    this,
                    core::mem::transmute_copy(&td),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&pvsigblob),
        ...
        unsafe extern "system" fn FindField<Identity: IMetaDataImport_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            td: u32,
            szname: windows_core::PCWSTR,
            pvsigblob: *mut u8,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::FindField(
                    this,
                    core::mem::transmute_copy(&td),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&pvsigblob),
        ...
        unsafe extern "system" fn FindMemberRef<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::FindMemberRef(
                    this,
                    core::mem::transmute_copy(&td),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&pvsigblob),
        ...
        unsafe extern "system" fn GetMethodProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetMethodProps(
                    this,
                    core::mem::transmute_copy(&mb),
                    core::mem::transmute_copy(&pclass),
                    core::mem::transmute_copy(&szmethod),
                    core::mem::transmute_copy(&cchmethod),
                    core::mem::transmute_copy(&pchmethod),
        ...
        unsafe extern "system" fn GetMemberRefProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetMemberRefProps(
                    this,
                    core::mem::transmute_copy(&mr),
                    core::mem::transmute_copy(&ptk),
        ...
        unsafe extern "system" fn EnumProperties<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumProperties(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&td),
                    core::mem::transmute_copy(&rproperties),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pcproperties),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumEvents<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumEvents(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&td),
                    core::mem::transmute_copy(&revents),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pcevents),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetEventProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumMethodSemantics(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&mb),
                    core::mem::transmute_copy(&reventprop),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pceventprop),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetMethodSemantics(
                    this,
                    core::mem::transmute_copy(&mb),
                    core::mem::transmute_copy(&tkeventprop),
                    core::mem::transmute_copy(&pdwsemanticsflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetClassLayout<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetClassLayout(
                    this,
                    core::mem::transmute_copy(&td),
                    core::mem::transmute_copy(&pdwpacksize),
                    core::mem::transmute_copy(&rfieldoffset),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pcfieldoffset),
                    core::mem::transmute_copy(&pulclasssize),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetFieldMarshal<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetFieldMarshal(
                    this,
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&ppvnativetype),
                    core::mem::transmute_copy(&pcbnativetype),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetRVA<Identity: IMetaDataImport_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            tk: u32,
            pulcoderva: *mut u32,
            pdwimplflags: *mut u32,
        ...
        unsafe extern "system" fn GetPermissionSetProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetPermissionSetProps(
                    this,
                    core::mem::transmute_copy(&pm),
                    core::mem::transmute_copy(&pdwaction),
                    core::mem::transmute_copy(&ppvpermission),
                    core::mem::transmute_copy(&pcbpermission),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetSigFromToken<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetSigFromToken(
                    this,
                    core::mem::transmute_copy(&mdsig),
                    core::mem::transmute_copy(&ppvsig),
                    core::mem::transmute_copy(&pcbsig),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetModuleRefProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetModuleRefProps(
                    this,
                    core::mem::transmute_copy(&mur),
                    core::mem::transmute_copy(&szname),
                    core::mem::transmute_copy(&cchname),
                    core::mem::transmute_copy(&pchname),
                )
        ...
        unsafe extern "system" fn EnumModuleRefs<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumModuleRefs(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&rmodulerefs),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pcmodulerefs),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetTypeSpecFromToken<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetTypeSpecFromToken(
                    this,
                    core::mem::transmute_copy(&typespec),
                    core::mem::transmute_copy(&ppvsig),
                    core::mem::transmute_copy(&pcbsig),
                )
                .into()
        ...
        unsafe extern "system" fn GetNameFromToken<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetNameFromToken(
                    this,
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&pszutf8nameptr),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumUnresolvedMethods<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumUnresolvedMethods(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&rmethods),
                    core::mem::transmute_copy(&cmax),
        ...
        unsafe extern "system" fn GetUserString<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetUserString(
                    this,
                    core::mem::transmute_copy(&stk),
                    core::mem::transmute_copy(&szstring),
                    core::mem::transmute_copy(&cchstring),
                    core::mem::transmute_copy(&pchstring),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetPinvokeMap<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetPinvokeMap(
                    this,
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&pdwmappingflags),
                    core::mem::transmute_copy(&szimportname),
                    core::mem::transmute_copy(&cchimportname),
                    core::mem::transmute_copy(&pchimportname),
                    core::mem::transmute_copy(&pmrimportdll),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumSignatures<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumSignatures(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&rsignatures),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pcsignatures),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumTypeSpecs<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumTypeSpecs(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&rtypespecs),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pctypespecs),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumUserStrings<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumUserStrings(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&rstrings),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pcstrings),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetParamForMethodIndex<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetParamForMethodIndex(
                    this,
                    core::mem::transmute_copy(&md),
                    core::mem::transmute_copy(&ulparamseq),
                    core::mem::transmute_copy(&ppd),
        ...
        unsafe extern "system" fn EnumCustomAttributes<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::EnumCustomAttributes(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&tktype),
                    core::mem::transmute_copy(&rcustomattributes),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pccustomattributes),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetCustomAttributeProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetCustomAttributeProps(
                    this,
                    core::mem::transmute_copy(&cv),
                    core::mem::transmute_copy(&ptkobj),
                    core::mem::transmute_copy(&ptktype),
                    core::mem::transmute_copy(&ppblob),
                    core::mem::transmute_copy(&pcbsize),
                )
                .into()
            }
        }
        unsafe extern "system" fn FindTypeRef<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::FindTypeRef(
                    this,
                    core::mem::transmute_copy(&tkresolutionscope),
                    core::mem::transmute(&szname),
                    core::mem::transmute_copy(&ptr),
        ...
        unsafe extern "system" fn GetFieldProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetFieldProps(
                    this,
                    core::mem::transmute_copy(&mb),
                    core::mem::transmute_copy(&pclass),
                    core::mem::transmute_copy(&szfield),
                    core::mem::transmute_copy(&cchfield),
                    core::mem::transmute_copy(&pchfield),
                    core::mem::transmute_copy(&pdwattr),
                    core::mem::transmute_copy(&ppvsigblob),
                    core::mem::transmute_copy(&pcbsigblob),
                    core::mem::transmute_copy(&pdwcplustypeflag),
        ...
        unsafe extern "system" fn GetPropertyProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetParamProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetParamProps(
                    this,
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&pmd),
                    core::mem::transmute_copy(&pulsequence),
                    core::mem::transmute_copy(&szname),
                    core::mem::transmute_copy(&cchname),
                    core::mem::transmute_copy(&pchname),
                    core::mem::transmute_copy(&pdwattr),
        ...
        unsafe extern "system" fn GetCustomAttributeByName<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn IsValidToken<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetNestedClassProps<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetNestedClassProps(
                    this,
                    core::mem::transmute_copy(&tdnestedclass),
                    core::mem::transmute_copy(&ptdenclosingclass),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetNativeCallConvFromSig<
            Identity: IMetaDataImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::GetNativeCallConvFromSig(
                    this,
                    core::mem::transmute_copy(&pvsig),
                    core::mem::transmute_copy(&cbsig),
                    core::mem::transmute_copy(&pcallconv),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsGlobal<Identity: IMetaDataImport_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pd: u32,
            pbglobal: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport_Impl::IsGlobal(
                    this,
                    core::mem::transmute_copy(&pd),
                    core::mem::transmute_copy(&pbglobal),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xfce5efa0_8bba_4f8e_a036_8f2022b08466
);
...
impl IMetaDataImport2 {
    pub unsafe fn EnumGenericParams(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumGenericParams)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                tk,
                rgenericparams as _,
                cmax,
                pcgenericparams as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetGenericParamProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetGenericParamProps)(
                windows_core::Interface::as_raw(self),
                gp,
                pulparamseq as _,
                pdwparamflags as _,
    ...
    pub unsafe fn GetMethodSpecProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetMethodSpecProps)(
                windows_core::Interface::as_raw(self),
                mi,
                tkparent as _,
                ppvsigblob as _,
    ...
    pub unsafe fn EnumGenericParamConstraints(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumGenericParamConstraints)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                tk,
                rgenericparamconstraints as _,
                cmax,
                pcgenericparamconstraints as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetGenericParamConstraintProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetGenericParamConstraintProps)(
                windows_core::Interface::as_raw(self),
                gpc,
                ptgenericparam as _,
                ptkconstrainttype as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetPEKind(
        &self,
        pdwpekind: *mut u32,
        pdwmachine: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPEKind)(
                windows_core::Interface::as_raw(self),
                pdwpekind as _,
                pdwmachine as _,
            )
    ...
    pub unsafe fn GetVersionString(
        &self,
        pwzbuf: Option<&mut [u16]>,
        pccbufsize: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetVersionString)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(
                    pwzbuf
                        .as_deref()
    ...
    pub unsafe fn EnumMethodSpecs(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).EnumMethodSpecs)(
                windows_core::Interface::as_raw(self),
                phenum as _,
                tk,
                rmethodspecs as _,
...
impl IMetaDataImport2_Vtbl {
    pub const fn new<Identity: IMetaDataImport2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn EnumGenericParams<
            Identity: IMetaDataImport2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            phenum: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport2_Impl::EnumGenericParams(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&rgenericparams),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pcgenericparams),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetGenericParamProps<
            Identity: IMetaDataImport2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                ...
                IMetaDataImport2_Impl::GetGenericParamProps(
                    this,
                    core::mem::transmute_copy(&gp),
                    core::mem::transmute_copy(&pulparamseq),
                    core::mem::transmute_copy(&pdwparamflags),
                    core::mem::transmute_copy(&ptowner),
                    core::mem::transmute_copy(&reserved),
                    core::mem::transmute_copy(&wzname),
                    core::mem::transmute_copy(&cchname),
                    core::mem::transmute_copy(&pchname),
                )
                .into()
        ...
        unsafe extern "system" fn GetMethodSpecProps<
            Identity: IMetaDataImport2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport2_Impl::GetMethodSpecProps(
                    this,
                    core::mem::transmute_copy(&mi),
                    core::mem::transmute_copy(&tkparent),
                    core::mem::transmute_copy(&ppvsigblob),
                    core::mem::transmute_copy(&pcbsigblob),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport2_Impl::EnumGenericParamConstraints(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&rgenericparamconstraints),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pcgenericparamconstraints),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetGenericParamConstraintProps<
            Identity: IMetaDataImport2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport2_Impl::GetGenericParamConstraintProps(
                    this,
                    core::mem::transmute_copy(&gpc),
                    core::mem::transmute_copy(&ptgenericparam),
                    core::mem::transmute_copy(&ptkconstrainttype),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetPEKind<
            Identity: IMetaDataImport2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport2_Impl::GetPEKind(
                    this,
                    core::mem::transmute_copy(&pdwpekind),
                    core::mem::transmute_copy(&pdwmachine),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetVersionString<
            Identity: IMetaDataImport2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport2_Impl::GetVersionString(
                    this,
                    core::mem::transmute_copy(&pwzbuf),
                    core::mem::transmute_copy(&ccbufsize),
                    core::mem::transmute_copy(&pccbufsize),
                )
                .into()
            }
        }
        unsafe extern "system" fn EnumMethodSpecs<
            Identity: IMetaDataImport2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataImport2_Impl::EnumMethodSpecs(
                    this,
                    core::mem::transmute_copy(&phenum),
                    core::mem::transmute_copy(&tk),
                    core::mem::transmute_copy(&rmethodspecs),
                    core::mem::transmute_copy(&cmax),
                    core::mem::transmute_copy(&pcmethodspecs),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IMetaDataInfo,
    IMetaDataInfo_Vtbl,
    0x7998ea64_7f95_48b8_86fc_17caf48bf5cb
);
windows_core::imp::interface_hierarchy!(IMetaDataInfo, windows_core::IUnknown);
impl IMetaDataInfo {
    pub unsafe fn GetFileMapping(
        &self,
        ppvdata: *const *const core::ffi::c_void,
        pcbdata: *mut u64,
        pdwmappingtype: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetFileMapping)(
                windows_core::Interface::as_raw(self),
                ppvdata,
                pcbdata as _,
                pdwmappingtype as _,
...
pub struct IMetaDataInfo_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetFileMapping: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const *const core::ffi::c_void,
        *mut u64,
        *mut u32,
...
impl IMetaDataInfo_Vtbl {
    pub const fn new<Identity: IMetaDataInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetFileMapping<
            Identity: IMetaDataInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppvdata: *const *const core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataInfo_Impl::GetFileMapping(
                    this,
                    core::mem::transmute_copy(&ppvdata),
                    core::mem::transmute_copy(&pcbdata),
                    core::mem::transmute_copy(&pdwmappingtype),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetFileMapping: GetFileMapping::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xd8f579ab_402d_4b8e_82d9_5d63b1065c68
);
...
impl IMetaDataTables {
    pub unsafe fn GetStringHeapSize(&self, pcbstrings: *mut u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetStringHeapSize)(
                windows_core::Interface::as_raw(self),
                pcbstrings as _,
            )
            .ok()
    ...
    pub unsafe fn GetBlobHeapSize(&self, pcbblobs: *mut u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetBlobHeapSize)(
                windows_core::Interface::as_raw(self),
                pcbblobs as _,
            )
            .ok()
    ...
    pub unsafe fn GetGuidHeapSize(&self, pcbguids: *mut u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetGuidHeapSize)(
                windows_core::Interface::as_raw(self),
                pcbguids as _,
            )
            .ok()
    ...
    pub unsafe fn GetUserStringHeapSize(&self, pcbblobs: *mut u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetUserStringHeapSize)(
                windows_core::Interface::as_raw(self),
                pcbblobs as _,
            )
            .ok()
    ...
    pub unsafe fn GetNumTables(&self, pctables: *mut u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetNumTables)(
                windows_core::Interface::as_raw(self),
                pctables as _,
            )
            .ok()
    ...
    pub unsafe fn GetTableIndex(&self, token: u32, pixtbl: *mut u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetTableIndex)(
                windows_core::Interface::as_raw(self),
                token,
                pixtbl as _,
            )
    ...
    pub unsafe fn GetTableInfo(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetTableInfo)(
                windows_core::Interface::as_raw(self),
                ixtbl,
                pcbrow as _,
                pcrows as _,
    ...
    pub unsafe fn GetColumnInfo(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetColumnInfo)(
                windows_core::Interface::as_raw(self),
                ixtbl,
                ixcol,
                pocol as _,
    ...
    pub unsafe fn GetCodedTokenInfo(
        &self,
        ixcdtkn: u32,
        pctokens: *mut u32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetCodedTokenInfo)(
                windows_core::Interface::as_raw(self),
                ixcdtkn,
                pctokens as _,
                pptokens as _,
    ...
    pub unsafe fn GetGuid(
        &self,
        ixguid: u32,
        ppguid: *const *const windows_core::GUID,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub unsafe fn GetNextString(&self, ixstring: u32, pnext: *mut u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetNextString)(
                windows_core::Interface::as_raw(self),
                ixstring,
                pnext as _,
            )
    ...
    pub unsafe fn GetNextBlob(&self, ixblob: u32, pnext: *mut u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetNextBlob)(
                windows_core::Interface::as_raw(self),
                ixblob,
                pnext as _,
            )
    ...
    pub unsafe fn GetNextGuid(&self, ixguid: u32, pnext: *mut u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetNextGuid)(
                windows_core::Interface::as_raw(self),
                ixguid,
                pnext as _,
            )
    ...
    pub unsafe fn GetNextUserString(
        &self,
        ixuserstring: u32,
        pnext: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetNextUserString)(
                windows_core::Interface::as_raw(self),
                ixuserstring,
                pnext as _,
            )
...
pub struct IMetaDataTables_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetStringHeapSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetBlobHeapSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetGuidHeapSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetUserStringHeapSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetNumTables:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetTableIndex:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut u32) -> windows_core::HRESULT,
    pub GetTableInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u32,
        *mut u32,
    ...
    pub GetColumnInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut u32,
    ...
    pub GetCodedTokenInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u32,
        *mut *mut u32,
...
impl IMetaDataTables_Vtbl {
    pub const fn new<Identity: IMetaDataTables_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetStringHeapSize<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pcbstrings: *mut u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetStringHeapSize(
                    this,
                    core::mem::transmute_copy(&pcbstrings),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetBlobHeapSize<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetBlobHeapSize(this, core::mem::transmute_copy(&pcbblobs))
                    .into()
            }
        }
        unsafe extern "system" fn GetGuidHeapSize<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetGuidHeapSize(this, core::mem::transmute_copy(&pcbguids))
                    .into()
            }
        }
        unsafe extern "system" fn GetUserStringHeapSize<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetUserStringHeapSize(
                    this,
                    core::mem::transmute_copy(&pcbblobs),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetNumTables<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetNumTables(this, core::mem::transmute_copy(&pctables))
                    .into()
            }
        }
        unsafe extern "system" fn GetTableIndex<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetTableIndex(
                    this,
                    core::mem::transmute_copy(&token),
                    core::mem::transmute_copy(&pixtbl),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetTableInfo<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetTableInfo(
                    this,
                    core::mem::transmute_copy(&ixtbl),
                    core::mem::transmute_copy(&pcbrow),
                    core::mem::transmute_copy(&pcrows),
                    core::mem::transmute_copy(&pccols),
                    core::mem::transmute_copy(&pikey),
                    core::mem::transmute_copy(&ppname),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetColumnInfo<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetColumnInfo(
                    this,
                    core::mem::transmute_copy(&ixtbl),
                    core::mem::transmute_copy(&ixcol),
                    core::mem::transmute_copy(&pocol),
                    core::mem::transmute_copy(&pcbcol),
        ...
        unsafe extern "system" fn GetCodedTokenInfo<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetCodedTokenInfo(
                    this,
                    core::mem::transmute_copy(&ixcdtkn),
                    core::mem::transmute_copy(&pctokens),
                    core::mem::transmute_copy(&pptokens),
                    core::mem::transmute_copy(&ppname),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetRow<Identity: IMetaDataTables_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ixtbl: u32,
            rid: u32,
            pprow: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetRow(
                    this,
                    core::mem::transmute_copy(&ixtbl),
                    core::mem::transmute_copy(&rid),
                    core::mem::transmute_copy(&pprow),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetColumn<Identity: IMetaDataTables_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ixtbl: u32,
            ixcol: u32,
            rid: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetColumn(
                    this,
                    core::mem::transmute_copy(&ixtbl),
                    core::mem::transmute_copy(&ixcol),
                    core::mem::transmute_copy(&rid),
        ...
        unsafe extern "system" fn GetString<Identity: IMetaDataTables_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ixstring: u32,
            ppstring: *const *const i8,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetString(
                    this,
                    core::mem::transmute_copy(&ixstring),
                    core::mem::transmute_copy(&ppstring),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetBlob<Identity: IMetaDataTables_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ixblob: u32,
            pcbdata: *mut u32,
            ppdata: *const *const core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetBlob(
                    this,
                    core::mem::transmute_copy(&ixblob),
                    core::mem::transmute_copy(&pcbdata),
                    core::mem::transmute_copy(&ppdata),
                )
                .into()
        ...
        unsafe extern "system" fn GetGuid<Identity: IMetaDataTables_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ixguid: u32,
            ppguid: *const *const windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetGuid(
                    this,
                    core::mem::transmute_copy(&ixguid),
                    core::mem::transmute_copy(&ppguid),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetUserString(
                    this,
                    core::mem::transmute_copy(&ixuserstring),
                    core::mem::transmute_copy(&pcbdata),
                    core::mem::transmute_copy(&ppdata),
                )
                .into()
        ...
        unsafe extern "system" fn GetNextString<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetNextString(
                    this,
                    core::mem::transmute_copy(&ixstring),
                    core::mem::transmute_copy(&pnext),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetNextBlob<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetNextBlob(
                    this,
                    core::mem::transmute_copy(&ixblob),
                    core::mem::transmute_copy(&pnext),
                )
        ...
        unsafe extern "system" fn GetNextGuid<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetNextGuid(
                    this,
                    core::mem::transmute_copy(&ixguid),
                    core::mem::transmute_copy(&pnext),
                )
        ...
        unsafe extern "system" fn GetNextUserString<
            Identity: IMetaDataTables_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables_Impl::GetNextUserString(
                    this,
                    core::mem::transmute_copy(&ixuserstring),
                    core::mem::transmute_copy(&pnext),
                )
...
windows_core::imp::define_interface!(
    ...
    0xbadb5f70_58da_43a9_a1c6_d74819f19b15
);
...
impl IMetaDataTables2 {
    pub unsafe fn GetMetaDataStorage(
        &self,
        ppvmd: *const *const core::ffi::c_void,
        pcbmd: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetMetaDataStorage)(
                windows_core::Interface::as_raw(self),
                ppvmd,
                pcbmd as _,
            )
    ...
    pub unsafe fn GetMetaDataStreamInfo(
        &self,
        ix: u32,
        ppchname: *const *const i8,
        ppv: *const *const core::ffi::c_void,
        pcb: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetMetaDataStreamInfo)(
                windows_core::Interface::as_raw(self),
                ix,
                ppchname,
                ppv,
...
pub struct IMetaDataTables2_Vtbl {
    ...
    pub GetMetaDataStorage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const *const core::ffi::c_void,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetMetaDataStreamInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const *const i8,
        *const *const core::ffi::c_void,
...
pub trait IMetaDataTables2_Impl: IMetaDataTables_Impl {
    fn GetMetaDataStorage(
        &self,
        ppvmd: *const *const core::ffi::c_void,
        pcbmd: *mut u32,
    ) -> windows_core::Result<()>;
    fn GetMetaDataStreamInfo(
        &self,
        ix: u32,
        ppchname: *const *const i8,
        ppv: *const *const core::ffi::c_void,
...
impl IMetaDataTables2_Vtbl {
    pub const fn new<Identity: IMetaDataTables2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetMetaDataStorage<
            Identity: IMetaDataTables2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppvmd: *const *const core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables2_Impl::GetMetaDataStorage(
                    this,
                    core::mem::transmute_copy(&ppvmd),
                    core::mem::transmute_copy(&pcbmd),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetMetaDataStreamInfo<
            Identity: IMetaDataTables2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataTables2_Impl::GetMetaDataStreamInfo(
                    this,
                    core::mem::transmute_copy(&ix),
                    core::mem::transmute_copy(&ppchname),
...
windows_core::imp::define_interface!(
    ...
    0x4709c9c6_81ff_11d3_9fc7_00c04f79a0a3
);
...
impl IMetaDataValidate {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ValidatorInit)(
                windows_core::Interface::as_raw(self),
                dwmoduletype,
                punk.param().abi(),
            )
    ...
    pub unsafe fn ValidateMetaData(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ValidateMetaData)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct IMetaDataValidate_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ValidatorInit: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ValidateMetaData:
...
impl IMetaDataValidate_Vtbl {
    pub const fn new<Identity: IMetaDataValidate_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ValidatorInit<
            Identity: IMetaDataValidate_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dwmoduletype: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataValidate_Impl::ValidatorInit(
                    this,
                    core::mem::transmute_copy(&dwmoduletype),
                    core::mem::transmute_copy(&punk),
                )
                .into()
            }
        }
        unsafe extern "system" fn ValidateMetaData<
            Identity: IMetaDataValidate_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl IMetaDataWinMDImport {
    pub unsafe fn GetUntransformedTypeRefProps(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetUntransformedTypeRefProps)(
                windows_core::Interface::as_raw(self),
                tr,
                ptkresolutionscope as _,
                core::mem::transmute(
...
pub struct IMetaDataWinMDImport_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetUntransformedTypeRefProps: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u32,
        windows_core::PWSTR,
...
pub trait IMetaDataWinMDImport_Impl: windows_core::IUnknownImpl {
    fn GetUntransformedTypeRefProps(
        &self,
        tr: u32,
        ptkresolutionscope: *mut u32,
        szname: windows_core::PWSTR,
...
impl IMetaDataWinMDImport_Vtbl {
    pub const fn new<Identity: IMetaDataWinMDImport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetUntransformedTypeRefProps<
            Identity: IMetaDataWinMDImport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            tr: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMetaDataWinMDImport_Impl::GetUntransformedTypeRefProps(
                    this,
                    core::mem::transmute_copy(&tr),
                    core::mem::transmute_copy(&ptkresolutionscope),
                    core::mem::transmute_copy(&szname),
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetUntransformedTypeRefProps: GetUntransformedTypeRefProps::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub const INTEROP_AUTOPROXY_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.AutomationProxyAttribute");
pub const INTEROP_AUTOPROXY_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.AutomationProxyAttribute");
pub const INTEROP_BESTFITMAPPING_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.BestFitMappingAttribute");
pub const INTEROP_BESTFITMAPPING_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.BestFitMappingAttribute");
pub const INTEROP_CLASSINTERFACE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ClassInterfaceAttribute");
pub const INTEROP_CLASSINTERFACE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ClassInterfaceAttribute");
pub const INTEROP_COCLASS_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.CoClassAttribute");
pub const INTEROP_COCLASS_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.CoClassAttribute");
pub const INTEROP_COMALIASNAME_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ComAliasNameAttribute");
pub const INTEROP_COMALIASNAME_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ComAliasNameAttribute");
pub const INTEROP_COMCOMPATIBLEVERSION_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ComCompatibleVersionAttribute");
pub const INTEROP_COMCOMPATIBLEVERSION_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ComCompatibleVersionAttribute");
pub const INTEROP_COMCONVERSIONLOSS_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ComConversionLossAttribute");
pub const INTEROP_COMCONVERSIONLOSS_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ComConversionLossAttribute");
pub const INTEROP_COMDEFAULTINTERFACE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ComDefaultInterfaceAttribute");
pub const INTEROP_COMDEFAULTINTERFACE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ComDefaultInterfaceAttribute");
pub const INTEROP_COMEMULATE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ComEmulateAttribute");
pub const INTEROP_COMEMULATE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ComEmulateAttribute");
pub const INTEROP_COMEVENTINTERFACE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ComEventInterfaceAttribute");
pub const INTEROP_COMEVENTINTERFACE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ComEventInterfaceAttribute");
pub const INTEROP_COMIMPORT_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ComImportAttribute");
pub const INTEROP_COMIMPORT_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ComImportAttribute");
pub const INTEROP_COMREGISTERFUNCTION_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ComRegisterFunctionAttribute");
pub const INTEROP_COMREGISTERFUNCTION_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ComRegisterFunctionAttribute");
pub const INTEROP_COMSOURCEINTERFACES_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ComSourceInterfacesAttribute");
pub const INTEROP_COMSOURCEINTERFACES_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ComSourceInterfacesAttribute");
pub const INTEROP_COMSUBSTITUTABLEINTERFACE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ComSubstitutableInterfaceAttribute");
pub const INTEROP_COMSUBSTITUTABLEINTERFACE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ComSubstitutableInterfaceAttribute");
pub const INTEROP_COMUNREGISTERFUNCTION_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ComUnregisterFunctionAttribute");
pub const INTEROP_COMUNREGISTERFUNCTION_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ComUnregisterFunctionAttribute");
pub const INTEROP_COMVISIBLE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ComVisibleAttribute");
pub const INTEROP_COMVISIBLE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ComVisibleAttribute");
pub const INTEROP_DATETIMEVALUE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.DateTimeConstantAttribute");
pub const INTEROP_DATETIMEVALUE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.DateTimeConstantAttribute");
pub const INTEROP_DECIMALVALUE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.DecimalConstantAttribute");
pub const INTEROP_DECIMALVALUE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.DecimalConstantAttribute");
pub const INTEROP_DEFAULTMEMBER_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Reflection.DefaultMemberAttribute");
pub const INTEROP_DEFAULTMEMBER_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Reflection.DefaultMemberAttribute");
pub const INTEROP_DISPID_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.DispIdAttribute");
pub const INTEROP_DISPID_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.DispIdAttribute");
pub const INTEROP_GUID_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.GuidAttribute");
pub const INTEROP_GUID_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.GuidAttribute");
pub const INTEROP_IDISPATCHIMPL_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.IDispatchImplAttribute");
pub const INTEROP_IDISPATCHIMPL_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.IDispatchImplAttribute");
pub const INTEROP_IDISPATCHVALUE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.IDispatchConstantAttribute");
pub const INTEROP_IDISPATCHVALUE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.IDispatchConstantAttribute");
pub const INTEROP_IMPORTEDFROMTYPELIB_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.ImportedFromTypeLibAttribute");
pub const INTEROP_IMPORTEDFROMTYPELIB_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.ImportedFromTypeLibAttribute");
pub const INTEROP_INTERFACETYPE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.InterfaceTypeAttribute");
pub const INTEROP_INTERFACETYPE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.InterfaceTypeAttribute");
pub const INTEROP_IN_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.InAttribute");
pub const INTEROP_IN_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.InAttribute");
pub const INTEROP_IUNKNOWNVALUE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.IUnknownConstantAttribute");
pub const INTEROP_IUNKNOWNVALUE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.IUnknownConstantAttribute");
pub const INTEROP_LCIDCONVERSION_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.LCIDConversionAttribute");
pub const INTEROP_LCIDCONVERSION_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.LCIDConversionAttribute");
pub const INTEROP_MARSHALAS_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.MarshalAsAttribute");
pub const INTEROP_MARSHALAS_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.MarshalAsAttribute");
pub const INTEROP_OUT_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.OutAttribute");
pub const INTEROP_OUT_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.OutAttribute");
pub const INTEROP_PARAMARRAY_TYPE: windows_core::PCSTR =
    windows_core::s!("System.ParamArrayAttribute");
pub const INTEROP_PARAMARRAY_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.ParamArrayAttribute");
pub const INTEROP_PRESERVESIG_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.PreserveSigAttribure");
pub const INTEROP_PRESERVESIG_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.PreserveSigAttribure");
pub const INTEROP_PRIMARYINTEROPASSEMBLY_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.PrimaryInteropAssemblyAttribute");
pub const INTEROP_PRIMARYINTEROPASSEMBLY_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.PrimaryInteropAssemblyAttribute");
pub const INTEROP_SERIALIZABLE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.SerializableAttribute");
pub const INTEROP_SERIALIZABLE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.SerializableAttribute");
pub const INTEROP_SETWIN32CONTEXTINIDISPATCHATTRIBUTE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.SetWin32ContextInIDispatchAttribute");
pub const INTEROP_SETWIN32CONTEXTINIDISPATCHATTRIBUTE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.SetWin32ContextInIDispatchAttribute");
pub const INTEROP_TYPELIBFUNC_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.TypeLibFuncAttribute");
pub const INTEROP_TYPELIBFUNC_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.TypeLibFuncAttribute");
pub const INTEROP_TYPELIBIMPORTCLASS_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.TypeLibImportClassAttribute");
pub const INTEROP_TYPELIBIMPORTCLASS_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.TypeLibImportClassAttribute");
pub const INTEROP_TYPELIBTYPE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.TypeLibTypeAttribute");
pub const INTEROP_TYPELIBTYPE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.TypeLibTypeAttribute");
pub const INTEROP_TYPELIBVAR_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.TypeLibVarAttribute");
pub const INTEROP_TYPELIBVAR_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.TypeLibVarAttribute");
pub const INTEROP_TYPELIBVERSION_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.InteropServices.TypeLibVersionAttribute");
pub const INTEROP_TYPELIBVERSION_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.InteropServices.TypeLibVersionAttribute");
...
impl IRoMetaDataLocator {
    pub unsafe fn Locate<P0, P1>(
        &self,
        nameelement: P0,
        metadatadestination: P1,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Locate)(
                windows_core::Interface::as_raw(self),
                nameelement.param().abi(),
                metadatadestination.param().abi(),
            )
            .ok()
        }
    }
...
pub struct IRoMetaDataLocator_Vtbl {
    pub Locate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IRoMetaDataLocator_Impl {
    fn Locate(
        &self,
        nameelement: &windows_core::PCWSTR,
        metadatadestination: windows_core::Ref<'_, IRoSimpleMetaDataBuilder>,
    ) -> windows_core::Result<()>;
}
impl IRoMetaDataLocator_Vtbl {
    pub const fn new<Identity: IRoMetaDataLocator_Impl>() -> Self {
        unsafe extern "system" fn Locate<Identity: IRoMetaDataLocator_Impl>(
            this: *mut core::ffi::c_void,
            nameelement: windows_core::PCWSTR,
            metadatadestination: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this = (this as *mut *mut core::ffi::c_void) as *const windows_core::ScopedHeap;
                let this = &*((*this).this as *const Identity);
                IRoMetaDataLocator_Impl::Locate(
                    this,
                    core::mem::transmute(&nameelement),
                    core::mem::transmute_copy(&metadatadestination),
                )
                .into()
            }
        }
        Self {
            Locate: Locate::<Identity>,
        }
    }
}
...
impl IRoMetaDataLocator {
    pub fn new<'a, T: IRoMetaDataLocator_Impl>(
        this: &'a T,
    ) -> windows_core::ScopedInterface<'a, Self> {
        let this = windows_core::ScopedHeap {
            vtable: &IRoMetaDataLocator_ImplVtbl::<T>::VTABLE as *const _ as *const _,
...
impl IRoSimpleMetaDataBuilder {
    pub unsafe fn SetWinRtInterface(&self, iid: windows_core::GUID) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetWinRtInterface)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn SetDelegate(&self, iid: windows_core::GUID) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDelegate)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(iid),
            )
            .ok()
    ...
    pub unsafe fn SetInterfaceGroupSimpleDefault<P0, P1>(
        &self,
        name: P0,
        defaultinterfacename: P1,
        defaultinterfaceiid: Option<*const windows_core::GUID>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetInterfaceGroupSimpleDefault)(
                windows_core::Interface::as_raw(self),
                name.param().abi(),
                defaultinterfacename.param().abi(),
                defaultinterfaceiid.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn SetInterfaceGroupParameterizedDefault<P0>(
        &self,
        name: P0,
        defaultinterfacenameelements: &[windows_core::PCWSTR],
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetInterfaceGroupParameterizedDefault)(
                windows_core::Interface::as_raw(self),
                name.param().abi(),
                defaultinterfacenameelements.len().try_into().unwrap(),
                core::mem::transmute(defaultinterfacenameelements.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn SetRuntimeClassSimpleDefault<P0, P1>(
        &self,
        name: P0,
        defaultinterfacename: P1,
        defaultinterfaceiid: Option<*const windows_core::GUID>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetRuntimeClassSimpleDefault)(
                windows_core::Interface::as_raw(self),
                name.param().abi(),
                defaultinterfacename.param().abi(),
                defaultinterfaceiid.unwrap_or(core::mem::zeroed()) as _,
    ...
    pub unsafe fn SetRuntimeClassParameterizedDefault<P0>(
        &self,
        name: P0,
        defaultinterfacenameelements: &[windows_core::PCWSTR],
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetRuntimeClassParameterizedDefault)(
                windows_core::Interface::as_raw(self),
                name.param().abi(),
                defaultinterfacenameelements.len().try_into().unwrap(),
                core::mem::transmute(defaultinterfacenameelements.as_ptr()),
    ...
    pub unsafe fn SetStruct<P0>(
        &self,
        name: P0,
        fieldtypenames: &[windows_core::PCWSTR],
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetStruct)(
                windows_core::Interface::as_raw(self),
                name.param().abi(),
                fieldtypenames.len().try_into().unwrap(),
                core::mem::transmute(fieldtypenames.as_ptr()),
            )
            .ok()
        }
    }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetEnum)(
                windows_core::Interface::as_raw(self),
                name.param().abi(),
                basetype.param().abi(),
            )
    ...
    pub unsafe fn SetParameterizedInterface(
        &self,
        piid: windows_core::GUID,
        numargs: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetParameterizedInterface)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn SetParameterizedDelegate(
        &self,
        piid: windows_core::GUID,
        numargs: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetParameterizedDelegate)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(piid),
                numargs,
            )
...
pub struct IRoSimpleMetaDataBuilder_Vtbl {
    pub SetWinRtInterface: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub SetDelegate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub SetInterfaceGroupSimpleDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub SetInterfaceGroupParameterizedDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        *const windows_core::PCWSTR,
        ...
        -> windows_core::HRESULT,
    pub SetRuntimeClassSimpleDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *const windows_core::GUID,
    ) -> windows_core::HRESULT,
    pub SetRuntimeClassParameterizedDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        *const windows_core::PCWSTR,
        ...
        -> windows_core::HRESULT,
    pub SetStruct: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        *const windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub SetEnum: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub SetParameterizedInterface: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        u32,
    ) -> windows_core::HRESULT,
    pub SetParameterizedDelegate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        u32,
    ) -> windows_core::HRESULT,
...
pub trait IRoSimpleMetaDataBuilder_Impl {
    ...
    fn SetInterfaceGroupSimpleDefault(
        ...
        defaultinterfacename: &windows_core::PCWSTR,
        defaultinterfaceiid: *const windows_core::GUID,
    ) -> windows_core::Result<()>;
    fn SetInterfaceGroupParameterizedDefault(
        &self,
        name: &windows_core::PCWSTR,
        elementcount: u32,
        defaultinterfacenameelements: *const windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    ...
    fn SetStruct(
        ...
        name: &windows_core::PCWSTR,
        numfields: u32,
        fieldtypenames: *const windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    fn SetEnum(
        &self,
        name: &windows_core::PCWSTR,
        basetype: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
...
impl IRoSimpleMetaDataBuilder_Vtbl {
    pub const fn new<Identity: IRoSimpleMetaDataBuilder_Impl>() -> Self {
        unsafe extern "system" fn SetWinRtInterface<Identity: IRoSimpleMetaDataBuilder_Impl>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this = (this as *mut *mut core::ffi::c_void) as *const windows_core::ScopedHeap;
                let this = &*((*this).this as *const Identity);
                IRoSimpleMetaDataBuilder_Impl::SetWinRtInterface(this, core::mem::transmute(&iid))
                    .into()
            }
        }
        unsafe extern "system" fn SetDelegate<Identity: IRoSimpleMetaDataBuilder_Impl>(
            this: *mut core::ffi::c_void,
            iid: windows_core::GUID,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetInterfaceGroupSimpleDefault<
            Identity: IRoSimpleMetaDataBuilder_Impl,
        >(
            this: *mut core::ffi::c_void,
            name: windows_core::PCWSTR,
            defaultinterfacename: windows_core::PCWSTR,
            ...
            unsafe {
                let this = (this as *mut *mut core::ffi::c_void) as *const windows_core::ScopedHeap;
                let this = &*((*this).this as *const Identity);
                IRoSimpleMetaDataBuilder_Impl::SetInterfaceGroupSimpleDefault(
                    this,
                    core::mem::transmute(&name),
                    core::mem::transmute(&defaultinterfacename),
                    core::mem::transmute_copy(&defaultinterfaceiid),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetInterfaceGroupParameterizedDefault<
            Identity: IRoSimpleMetaDataBuilder_Impl,
        >(
            this: *mut core::ffi::c_void,
            name: windows_core::PCWSTR,
            ...
            unsafe {
                let this = (this as *mut *mut core::ffi::c_void) as *const windows_core::ScopedHeap;
                let this = &*((*this).this as *const Identity);
                IRoSimpleMetaDataBuilder_Impl::SetInterfaceGroupParameterizedDefault(
                    this,
                    core::mem::transmute(&name),
                    core::mem::transmute_copy(&elementcount),
                    core::mem::transmute_copy(&defaultinterfacenameelements),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetRuntimeClassSimpleDefault<
            Identity: IRoSimpleMetaDataBuilder_Impl,
        >(
            this: *mut core::ffi::c_void,
            name: windows_core::PCWSTR,
            ...
            unsafe {
                let this = (this as *mut *mut core::ffi::c_void) as *const windows_core::ScopedHeap;
                let this = &*((*this).this as *const Identity);
                IRoSimpleMetaDataBuilder_Impl::SetRuntimeClassSimpleDefault(
                    this,
                    core::mem::transmute(&name),
                    core::mem::transmute(&defaultinterfacename),
                    core::mem::transmute_copy(&defaultinterfaceiid),
        ...
        unsafe extern "system" fn SetRuntimeClassParameterizedDefault<
            Identity: IRoSimpleMetaDataBuilder_Impl,
        >(
            this: *mut core::ffi::c_void,
            name: windows_core::PCWSTR,
            ...
            unsafe {
                let this = (this as *mut *mut core::ffi::c_void) as *const windows_core::ScopedHeap;
                let this = &*((*this).this as *const Identity);
                IRoSimpleMetaDataBuilder_Impl::SetRuntimeClassParameterizedDefault(
                    this,
                    core::mem::transmute(&name),
                    core::mem::transmute_copy(&elementcount),
                    core::mem::transmute_copy(&defaultinterfacenameelements),
        ...
        unsafe extern "system" fn SetStruct<Identity: IRoSimpleMetaDataBuilder_Impl>(
            this: *mut core::ffi::c_void,
            name: windows_core::PCWSTR,
            numfields: u32,
            fieldtypenames: *const windows_core::PCWSTR,
            ...
            unsafe {
                let this = (this as *mut *mut core::ffi::c_void) as *const windows_core::ScopedHeap;
                let this = &*((*this).this as *const Identity);
                IRoSimpleMetaDataBuilder_Impl::SetStruct(
                    this,
                    core::mem::transmute(&name),
                    core::mem::transmute_copy(&numfields),
                    core::mem::transmute_copy(&fieldtypenames),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetEnum<Identity: IRoSimpleMetaDataBuilder_Impl>(
            this: *mut core::ffi::c_void,
            name: windows_core::PCWSTR,
            basetype: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this = (this as *mut *mut core::ffi::c_void) as *const windows_core::ScopedHeap;
                let this = &*((*this).this as *const Identity);
                IRoSimpleMetaDataBuilder_Impl::SetEnum(
                    this,
                    core::mem::transmute(&name),
                    core::mem::transmute(&basetype),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetParameterizedInterface<
            Identity: IRoSimpleMetaDataBuilder_Impl,
        >(
            this: *mut core::ffi::c_void,
            piid: windows_core::GUID,
            ...
            unsafe {
                let this = (this as *mut *mut core::ffi::c_void) as *const windows_core::ScopedHeap;
                let this = &*((*this).this as *const Identity);
                IRoSimpleMetaDataBuilder_Impl::SetParameterizedInterface(
                    this,
                    core::mem::transmute(&piid),
                    core::mem::transmute_copy(&numargs),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetParameterizedDelegate<
            Identity: IRoSimpleMetaDataBuilder_Impl,
        >(
            this: *mut core::ffi::c_void,
            piid: windows_core::GUID,
            ...
            unsafe {
                let this = (this as *mut *mut core::ffi::c_void) as *const windows_core::ScopedHeap;
                let this = &*((*this).this as *const Identity);
                IRoSimpleMetaDataBuilder_Impl::SetParameterizedDelegate(
                    this,
                    core::mem::transmute(&piid),
                    core::mem::transmute_copy(&numargs),
                )
...
struct IRoSimpleMetaDataBuilder_ImplVtbl<T: IRoSimpleMetaDataBuilder_Impl>(
...
impl IRoSimpleMetaDataBuilder {
    pub fn new<'a, T: IRoSimpleMetaDataBuilder_Impl>(
        this: &'a T,
    ) -> windows_core::ScopedInterface<'a, Self> {
        let this = windows_core::ScopedHeap {
            vtable: &IRoSimpleMetaDataBuilder_ImplVtbl::<T>::VTABLE as *const _ as *const _,
            this: this as *const _ as *const _,
        };
        let this = core::mem::ManuallyDrop::new(windows_core::imp::Box::new(this));
        unsafe { windows_core::ScopedInterface::new(core::mem::transmute(&this.vtable)) }
...
pub const LIBID_ComPlusRuntime: windows_core::GUID =
    windows_core::GUID::from_u128(0xbed7f4ea_1a96_11d2_8f08_00a0c9a6186d);
...
pub const MDNotifyAssemblyRef: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(16777216i32);
pub const MDNotifyCustomAttribute: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(2048i32);
...
pub const MDNotifyExportedType: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(67108864i32);
pub const MDNotifyFieldDef: CorNotificationForTokenMovement = CorNotificationForTokenMovement(4i32);
pub const MDNotifyFile: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(33554432i32);
pub const MDNotifyInterfaceImpl: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(64i32);
pub const MDNotifyMemberRef: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(2i32);
pub const MDNotifyMethodDef: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(1i32);
pub const MDNotifyModuleRef: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(16384i32);
pub const MDNotifyNameSpace: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(32768i32);
pub const MDNotifyNone: CorNotificationForTokenMovement = CorNotificationForTokenMovement(0i32);
pub const MDNotifyParamDef: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(32i32);
pub const MDNotifyPermission: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(8192i32);
pub const MDNotifyProperty: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(128i32);
pub const MDNotifyResource: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(134217728i32);
pub const MDNotifySecurityValue: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(4096i32);
pub const MDNotifySignature: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(512i32);
...
pub const MDNotifyTypeSpec: CorNotificationForTokenMovement =
    CorNotificationForTokenMovement(1024i32);
...
pub const MetaDataCheckDuplicatesFor: windows_core::GUID =
    windows_core::GUID::from_u128(0x30fe7be8_d7d9_11d2_9f80_00c04f79a0a3);
pub const MetaDataErrorIfEmitOutOfOrder: windows_core::GUID =
    windows_core::GUID::from_u128(0x1547872d_dc03_11d2_9420_0000f8083460);
pub const MetaDataGenerateTCEAdapters: windows_core::GUID =
    windows_core::GUID::from_u128(0xdcc9de90_4151_11d3_88d6_00902754c43a);
pub const MetaDataImportOption: windows_core::GUID =
    windows_core::GUID::from_u128(0x79700f36_4aac_11d3_84c3_009027868cb1);
pub const MetaDataLinkerOptions: windows_core::GUID =
    windows_core::GUID::from_u128(0x47e099b6_ae7c_4797_8317_b48aa645b8f9);
pub const MetaDataMergerOptions: windows_core::GUID =
    windows_core::GUID::from_u128(0x132d3a6e_b35d_464e_951a_42efb9fb6601);
pub const MetaDataNotificationForTokenMovement: windows_core::GUID =
    windows_core::GUID::from_u128(0xe5d71a4c_d7da_11d2_9f80_00c04f79a0a3);
pub const MetaDataPreserveLocalRefs: windows_core::GUID =
    windows_core::GUID::from_u128(0xa55c0354_e91b_468b_8648_7cc31035d533);
pub const MetaDataRefToDefCheck: windows_core::GUID =
    windows_core::GUID::from_u128(0xde3856f8_d7d9_11d2_9f80_00c04f79a0a3);
pub const MetaDataRuntimeVersion: windows_core::GUID =
    windows_core::GUID::from_u128(0x47e099b7_ae7c_4797_8317_b48aa645b8f9);
pub const MetaDataSetUpdate: windows_core::GUID =
    windows_core::GUID::from_u128(0x2eee315c_d7db_11d2_9f80_00c04f79a0a3);
pub const MetaDataThreadSafetyOptions: windows_core::GUID =
    windows_core::GUID::from_u128(0xf7559806_f266_42ea_8c63_0adb45e8b234);
pub const MetaDataTypeLibImportNamespace: windows_core::GUID =
    windows_core::GUID::from_u128(0xf17ff889_5a63_11d3_9ff2_00c04ff7431a);
...
pub const NONVERSIONABLE_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.Versioning.NonVersionableAttribute");
pub const NONVERSIONABLE_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.Versioning.NonVersionableAttribute");
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::Free for ROPARAMIIDHANDLE {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("api-ms-win-core-winrt-roparameterizediid-l1-1-0.dll" "system" fn RoFreeParameterizedTypeExtra(extra : *mut core::ffi::c_void));
            unsafe {
...
pub const RUNTIMECOMPATIBILITY_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.RuntimeCompatibilityAttribute");
pub const RUNTIMECOMPATIBILITY_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.RuntimeCompatibilityAttribute");
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const SUBJECT_ASSEMBLY_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.CompilerServices.IgnoresAccessChecksToAttribute");
pub const SUBJECT_ASSEMBLY_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.CompilerServices.IgnoresAccessChecksToAttribute");
pub const TARGET_FRAMEWORK_TYPE: windows_core::PCSTR =
    windows_core::s!("System.Runtime.Versioning.TargetFrameworkAttribute");
pub const TARGET_FRAMEWORK_TYPE_W: windows_core::PCWSTR =
    windows_core::w!("System.Runtime.Versioning.TargetFrameworkAttribute");
pub const USER_FRAMEWORK_REGISTRY_KEY: windows_core::PCSTR =
    windows_core::s!("Software\\Microsoft\\.NETFramework64");
pub const USER_FRAMEWORK_REGISTRY_KEY_W: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\.NETFramework64");

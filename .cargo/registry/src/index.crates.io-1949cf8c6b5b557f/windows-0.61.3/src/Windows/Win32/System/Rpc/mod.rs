...
pub unsafe fn DceErrorInqTextA(rpcstatus: RPC_STATUS, errortext: &mut [u8; 256]) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn DceErrorInqTextA(rpcstatus : RPC_STATUS, errortext : windows_core::PSTR) -> RPC_STATUS);
...
pub unsafe fn DceErrorInqTextW(rpcstatus: RPC_STATUS, errortext: &mut [u16; 256]) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn DceErrorInqTextW(rpcstatus : RPC_STATUS, errortext : windows_core::PWSTR) -> RPC_STATUS);
...
where
    P0: windows_core::Param<windows_core::IUnknown>,
{
    windows_link::link!("rpcrt4.dll" "system" fn IUnknown_QueryInterface_Proxy(this : * mut core::ffi::c_void, riid : *const windows_core::GUID, ppvobject : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
...
pub unsafe fn I_RpcBindingCopy(
    sourcebinding: *mut core::ffi::c_void,
    destinationbinding: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcBindingCopy(sourcebinding : *mut core::ffi::c_void, destinationbinding : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe { I_RpcBindingCopy(sourcebinding as _, destinationbinding as _) }
}
#[inline]
pub unsafe fn I_RpcBindingCreateNP<P0, P1, P2>(
    servername: P0,
    servicename: P1,
    networkoptions: P2,
    binding: *mut *mut core::ffi::c_void,
) -> RPC_STATUS
where
...
{
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcBindingCreateNP(servername : windows_core::PCWSTR, servicename : windows_core::PCWSTR, networkoptions : windows_core::PCWSTR, binding : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
        I_RpcBindingCreateNP(
            servername.param().abi(),
            servicename.param().abi(),
            networkoptions.param().abi(),
            binding as _,
        )
    }
}
...
pub unsafe fn I_RpcBindingHandleToAsyncHandle(
    ...
    asynchandle: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
...
pub unsafe fn I_RpcBindingInqClientTokenAttributes(
    binding: *const core::ffi::c_void,
    tokenid: Option<*mut super::super::Foundation::LUID>,
    authenticationid: Option<*mut super::super::Foundation::LUID>,
    modifiedid: Option<*mut super::super::Foundation::LUID>,
) -> RPC_STATUS {
    ...
    unsafe {
        I_RpcBindingInqClientTokenAttributes(
            binding,
            tokenid.unwrap_or(core::mem::zeroed()) as _,
            authenticationid.unwrap_or(core::mem::zeroed()) as _,
            modifiedid.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn I_RpcBindingInqDynamicEndpointA(
    binding: *const core::ffi::c_void,
    dynamicendpoint: *mut windows_core::PSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcBindingInqDynamicEndpointA(binding : *const core::ffi::c_void, dynamicendpoint : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe { I_RpcBindingInqDynamicEndpointA(binding, dynamicendpoint as _) }
}
#[inline]
pub unsafe fn I_RpcBindingInqDynamicEndpointW(
    binding: *const core::ffi::c_void,
    dynamicendpoint: *mut windows_core::PWSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcBindingInqDynamicEndpointW(binding : *const core::ffi::c_void, dynamicendpoint : *mut windows_core::PWSTR) -> RPC_STATUS);
...
pub unsafe fn I_RpcBindingInqMarshalledTargetInfo(
    ...
    marshalledtargetinfo: *mut windows_core::PSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcBindingInqMarshalledTargetInfo(binding : *const core::ffi::c_void, marshalledtargetinfosize : *mut u32, marshalledtargetinfo : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe {
        I_RpcBindingInqMarshalledTargetInfo(
            binding,
            marshalledtargetinfosize as _,
            marshalledtargetinfo as _,
        )
    }
}
#[inline]
pub unsafe fn I_RpcBindingInqSecurityContext(
    binding: *mut core::ffi::c_void,
    securitycontexthandle: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
...
pub unsafe fn I_RpcBindingInqSecurityContextKeyInfo(
    binding: Option<*const core::ffi::c_void>,
    keyinfo: *mut core::ffi::c_void,
) -> RPC_STATUS {
    ...
    unsafe {
        I_RpcBindingInqSecurityContextKeyInfo(
            binding.unwrap_or(core::mem::zeroed()) as _,
            keyinfo as _,
        )
    }
}
...
pub unsafe fn I_RpcBindingIsClientLocal(
    bindinghandle: *mut core::ffi::c_void,
...
pub unsafe fn I_RpcBindingSetPrivateOption(
    hbinding: *const core::ffi::c_void,
    option: u32,
    optionvalue: usize,
) -> RPC_STATUS {
...
pub unsafe fn I_RpcGetBufferWithObject(
    ...
    objectuuid: *mut windows_core::GUID,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcGetBufferWithObject(message : *mut RPC_MESSAGE, objectuuid : *mut windows_core::GUID) -> RPC_STATUS);
    unsafe { I_RpcGetBufferWithObject(message as _, objectuuid as _) }
}
#[inline]
pub unsafe fn I_RpcGetCurrentCallHandle() -> *mut core::ffi::c_void {
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcGetCurrentCallHandle() -> *mut core::ffi::c_void);
...
pub unsafe fn I_RpcIfInqTransferSyntaxes(
    rpcifhandle: *mut core::ffi::c_void,
    transfersyntaxes: *mut RPC_TRANSFER_SYNTAX,
    transfersyntaxsize: u32,
    transfersyntaxcount: *mut u32,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcIfInqTransferSyntaxes(rpcifhandle : *mut core::ffi::c_void, transfersyntaxes : *mut RPC_TRANSFER_SYNTAX, transfersyntaxsize : u32, transfersyntaxcount : *mut u32) -> RPC_STATUS);
    unsafe {
        I_RpcIfInqTransferSyntaxes(
            rpcifhandle as _,
            transfersyntaxes as _,
            transfersyntaxsize,
            transfersyntaxcount as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn I_RpcNsBindingSetEntryNameA<P2>(
    binding: *const core::ffi::c_void,
    entrynamesyntax: u32,
    entryname: P2,
) -> RPC_STATUS
...
{
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcNsBindingSetEntryNameA(binding : *const core::ffi::c_void, entrynamesyntax : u32, entryname : windows_core::PCSTR) -> RPC_STATUS);
    unsafe { I_RpcNsBindingSetEntryNameA(binding, entrynamesyntax, entryname.param().abi()) }
}
#[inline]
pub unsafe fn I_RpcNsBindingSetEntryNameW<P2>(
    binding: *const core::ffi::c_void,
    entrynamesyntax: u32,
    entryname: P2,
) -> RPC_STATUS
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcNsBindingSetEntryNameW(binding : *const core::ffi::c_void, entrynamesyntax : u32, entryname : windows_core::PCWSTR) -> RPC_STATUS);
...
pub unsafe fn I_RpcNsInterfaceExported(
    entrynamesyntax: u32,
    entryname: *const u16,
    rpcinterfaceinformation: *const RPC_SERVER_INTERFACE,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcNsInterfaceExported(entrynamesyntax : u32, entryname : *const u16, rpcinterfaceinformation : *const RPC_SERVER_INTERFACE) -> RPC_STATUS);
...
pub unsafe fn I_RpcOpenClientProcess(
    binding: Option<*const core::ffi::c_void>,
    desiredaccess: u32,
    clientprocess: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
...
pub unsafe fn I_RpcServerSetAddressChangeFn(
    paddresschangefn: *mut RPC_ADDRESS_CHANGE_FN,
) -> RPC_STATUS {
...
pub unsafe fn I_RpcServerStartService<P0, P1>(
    protseq: P0,
    endpoint: P1,
    ifspec: *const core::ffi::c_void,
) -> RPC_STATUS
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcServerStartService(protseq : windows_core::PCWSTR, endpoint : windows_core::PCWSTR, ifspec : *const core::ffi::c_void) -> RPC_STATUS);
...
pub unsafe fn I_RpcServerSubscribeForDisconnectNotification(
    binding: Option<*const core::ffi::c_void>,
    hevent: Option<*const core::ffi::c_void>,
) -> RPC_STATUS {
...
pub unsafe fn I_RpcServerSubscribeForDisconnectNotification2(
    binding: Option<*const core::ffi::c_void>,
    hevent: *const core::ffi::c_void,
    subscriptionid: *mut windows_core::GUID,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcServerSubscribeForDisconnectNotification2(binding : *const core::ffi::c_void, hevent : *const core::ffi::c_void, subscriptionid : *mut windows_core::GUID) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn I_RpcServerUnsubscribeForDisconnectNotification(
    binding: Option<*const core::ffi::c_void>,
    subscriptionid: windows_core::GUID,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcServerUnsubscribeForDisconnectNotification(binding : *const core::ffi::c_void, subscriptionid : windows_core::GUID) -> RPC_STATUS);
    unsafe {
        I_RpcServerUnsubscribeForDisconnectNotification(
            binding.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(subscriptionid),
        )
    }
}
#[inline]
pub unsafe fn I_RpcServerUseProtseq2A<P0, P1>(
    networkaddress: P0,
    protseq: P1,
    maxcalls: u32,
    securitydescriptor: Option<*const core::ffi::c_void>,
    policy: *const core::ffi::c_void,
) -> RPC_STATUS
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcServerUseProtseq2A(networkaddress : windows_core::PCSTR, protseq : windows_core::PCSTR, maxcalls : u32, securitydescriptor : *const core::ffi::c_void, policy : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
        I_RpcServerUseProtseq2A(
            networkaddress.param().abi(),
            protseq.param().abi(),
            maxcalls,
...
where
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcServerUseProtseq2W(networkaddress : windows_core::PCWSTR, protseq : windows_core::PCWSTR, maxcalls : u32, securitydescriptor : *const core::ffi::c_void, policy : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn I_RpcServerUseProtseqEp2A<P0, P1, P3>(
    networkaddress: P0,
    protseq: P1,
    maxcalls: u32,
    endpoint: P3,
...
{
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcServerUseProtseqEp2A(networkaddress : windows_core::PCSTR, protseq : windows_core::PCSTR, maxcalls : u32, endpoint : windows_core::PCSTR, securitydescriptor : *const core::ffi::c_void, policy : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
{
    windows_link::link!("rpcrt4.dll" "system" fn I_RpcServerUseProtseqEp2W(networkaddress : windows_core::PCWSTR, protseq : windows_core::PCWSTR, maxcalls : u32, endpoint : windows_core::PCWSTR, securitydescriptor : *const core::ffi::c_void, policy : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn I_UuidCreate(uuid: *mut windows_core::GUID) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn I_UuidCreate(uuid : *mut windows_core::GUID) -> RPC_STATUS);
...
pub unsafe fn MesBufferHandleReset(
    ...
    unsafe {
        MesBufferHandleReset(
            ...
            pencodedsize.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn MesDecodeBufferHandleCreate(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn MesDecodeBufferHandleCreate(buffer : windows_core::PCSTR, buffersize : u32, phandle : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn MesEncodeFixedBufferHandleCreate(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn MesEncodeFixedBufferHandleCreate(pbuffer : windows_core::PSTR, buffersize : u32, pencodedsize : *mut u32, phandle : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn MesEncodeIncrementalHandleCreate(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn MesEncodeIncrementalHandleCreate(userstate : *mut core::ffi::c_void, allocfn : MIDL_ES_ALLOC, writefn : MIDL_ES_WRITE, phandle : *mut *mut core::ffi::c_void) -> RPC_STATUS);
...
pub unsafe fn MesHandleFree(handle: *mut core::ffi::c_void) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn MesHandleFree(handle : *mut core::ffi::c_void) -> RPC_STATUS);
...
pub unsafe fn MesIncrementalHandleReset(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn MesIncrementalHandleReset(handle : *mut core::ffi::c_void, userstate : *mut core::ffi::c_void, allocfn : MIDL_ES_ALLOC, writefn : MIDL_ES_WRITE, readfn : MIDL_ES_READ, operation : MIDL_ES_CODE) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn MesInqProcEncodingId(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn MesInqProcEncodingId(handle : *mut core::ffi::c_void, pinterfaceid : *mut RPC_SYNTAX_IDENTIFIER, pprocnum : *mut u32) -> RPC_STATUS);
...
pub unsafe fn NDRCContextBinding(ccontext: isize) -> *mut core::ffi::c_void {
    windows_link::link!("rpcrt4.dll" "system" fn NDRCContextBinding(ccontext : isize) -> *mut core::ffi::c_void);
...
pub unsafe fn NDRCContextUnmarshall(
    pccontext: Option<*mut isize>,
    hbinding: *const core::ffi::c_void,
    pbuff: *const core::ffi::c_void,
    ...
    unsafe {
        NDRCContextUnmarshall(
            pccontext.unwrap_or(core::mem::zeroed()) as _,
            hbinding,
            pbuff,
            datarepresentation,
        )
...
pub unsafe fn NDRSContextMarshall(
    ccontext: *const NDR_SCONTEXT,
    pbuff: *mut core::ffi::c_void,
...
pub unsafe fn NDRSContextMarshall2(
    bindinghandle: *const core::ffi::c_void,
    ccontext: *const NDR_SCONTEXT,
    pbuff: *mut core::ffi::c_void,
    userrundownin: NDR_RUNDOWN,
    ctxguard: Option<*const core::ffi::c_void>,
    flags: u32,
) {
    ...
    unsafe {
        NDRSContextMarshall2(
            ...
            pbuff as _,
            userrundownin,
            ctxguard.unwrap_or(core::mem::zeroed()) as _,
            flags,
        )
    }
}
...
pub unsafe fn NDRSContextUnmarshall2(
    bindinghandle: *const core::ffi::c_void,
    pbuff: Option<*const core::ffi::c_void>,
    datarepresentation: u32,
    ctxguard: Option<*const core::ffi::c_void>,
    flags: u32,
) -> *mut NDR_SCONTEXT {
    ...
    unsafe {
        NDRSContextUnmarshall2(
            bindinghandle,
            pbuff.unwrap_or(core::mem::zeroed()) as _,
            datarepresentation,
            ctxguard.unwrap_or(core::mem::zeroed()) as _,
            flags,
        )
...
pub unsafe fn Ndr64AsyncClientCall(
    ...
    nprocnum: u32,
    preturnvalue: *mut core::ffi::c_void,
) -> CLIENT_CALL_RETURN {
...
pub unsafe fn NdrByteCountPointerBufferSize(
    ...
    unsafe {
        NdrByteCountPointerBufferSize(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrByteCountPointerFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrByteCountPointerFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrByteCountPointerMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrByteCountPointerMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
    unsafe {
        NdrByteCountPointerMarshall(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrByteCountPointerUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrByteCountPointerUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
        NdrByteCountPointerUnmarshall(
            core::mem::transmute(pstubmsg),
            ppmemory as _,
            pformat as _,
            fmustalloc,
        )
...
pub unsafe fn NdrClientContextUnmarshall(
    ...
    bindhandle: *mut core::ffi::c_void,
) {
    windows_link::link!("rpcrt4.dll" "system" fn NdrClientContextUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pcontexthandle : *mut isize, bindhandle : *mut core::ffi::c_void));
    unsafe {
...
pub unsafe fn NdrClientInitialize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrClientInitialize(prpcmsg : *mut RPC_MESSAGE, pstubmsg : *mut MIDL_STUB_MESSAGE, pstubdescriptor : *mut MIDL_STUB_DESC, procnum : u32));
    unsafe {
        NdrClientInitialize(
            prpcmsg as _,
            core::mem::transmute(pstubmsg),
            pstubdescriptor as _,
            procnum,
        )
    }
}
...
pub unsafe fn NdrClientInitializeNew(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrClientInitializeNew(prpcmsg : *mut RPC_MESSAGE, pstubmsg : *mut MIDL_STUB_MESSAGE, pstubdescriptor : *mut MIDL_STUB_DESC, procnum : u32));
    unsafe {
...
pub unsafe fn NdrComplexArrayBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrComplexArrayBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrComplexArrayFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrComplexArrayFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrComplexArrayMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrComplexArrayMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
...
pub unsafe fn NdrComplexArrayMemorySize(pstubmsg: *mut MIDL_STUB_MESSAGE, pformat: *mut u8) -> u32 {
    windows_link::link!("rpcrt4.dll" "system" fn NdrComplexArrayMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrComplexArrayUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrComplexArrayUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrComplexStructBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrComplexStructBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
        NdrComplexStructBufferSize(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrComplexStructFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrComplexStructFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrComplexStructMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrComplexStructMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
...
pub unsafe fn NdrComplexStructMemorySize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrComplexStructMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrComplexStructUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrComplexStructUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrConformantArrayBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantArrayBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
        NdrConformantArrayBufferSize(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrConformantArrayFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantArrayFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrConformantArrayMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantArrayMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
    unsafe {
        NdrConformantArrayMarshall(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrConformantArrayMemorySize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantArrayMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrConformantArrayUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantArrayUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrConformantStringBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantStringBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
        NdrConformantStringBufferSize(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrConformantStringMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantStringMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
    unsafe {
        NdrConformantStringMarshall(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrConformantStringMemorySize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantStringMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrConformantStringUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantStringUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrConformantStructBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantStructBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
        NdrConformantStructBufferSize(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrConformantStructFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantStructFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrConformantStructMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantStructMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
    unsafe {
        NdrConformantStructMarshall(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrConformantStructMemorySize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantStructMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrConformantStructUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantStructUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrConformantVaryingArrayBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantVaryingArrayBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
...
pub unsafe fn NdrConformantVaryingArrayFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantVaryingArrayFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
        NdrConformantVaryingArrayFree(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrConformantVaryingArrayMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantVaryingArrayMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrConformantVaryingArrayMemorySize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantVaryingArrayMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrConformantVaryingArrayUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantVaryingArrayUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrConformantVaryingStructBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantVaryingStructBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
...
pub unsafe fn NdrConformantVaryingStructFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantVaryingStructFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
        NdrConformantVaryingStructFree(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrConformantVaryingStructMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantVaryingStructMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrConformantVaryingStructMemorySize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrConformantVaryingStructMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrConvert(pstubmsg: *mut MIDL_STUB_MESSAGE, pformat: *mut u8) {
    windows_link::link!("rpcrt4.dll" "system" fn NdrConvert(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8));
...
pub unsafe fn NdrConvert2(pstubmsg: *mut MIDL_STUB_MESSAGE, pformat: *mut u8, numberparams: i32) {
    windows_link::link!("rpcrt4.dll" "system" fn NdrConvert2(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8, numberparams : i32));
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrCreateServerInterfaceFromStub<P0>(
    pstub: P0,
...
pub unsafe fn NdrEncapsulatedUnionBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrEncapsulatedUnionBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
        NdrEncapsulatedUnionBufferSize(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrEncapsulatedUnionFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrEncapsulatedUnionFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrEncapsulatedUnionMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrEncapsulatedUnionMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
    unsafe {
        NdrEncapsulatedUnionMarshall(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrEncapsulatedUnionMemorySize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrEncapsulatedUnionMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrEncapsulatedUnionUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrEncapsulatedUnionUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrFixedArrayBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrFixedArrayBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrFixedArrayFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrFixedArrayFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrFixedArrayMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrFixedArrayMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
...
pub unsafe fn NdrFixedArrayMemorySize(pstubmsg: *mut MIDL_STUB_MESSAGE, pformat: *mut u8) -> u32 {
    windows_link::link!("rpcrt4.dll" "system" fn NdrFixedArrayMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrFixedArrayUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrFixedArrayUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrFullPointerXlatInit(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrFullPointerXlatInit(numberofpointers : u32, xlatside : XLAT_SIDE) -> *mut FULL_PTR_XLAT_TABLES);
...
pub unsafe fn NdrGetBuffer(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrGetBuffer(pstubmsg : *mut MIDL_STUB_MESSAGE, bufferlength : u32, handle : *mut core::ffi::c_void) -> *mut u8);
...
pub unsafe fn NdrInterfacePointerBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrInterfacePointerBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
        NdrInterfacePointerBufferSize(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrInterfacePointerFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrInterfacePointerFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrInterfacePointerMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrInterfacePointerMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
    unsafe {
        NdrInterfacePointerMarshall(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrInterfacePointerMemorySize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrInterfacePointerMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrInterfacePointerUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrInterfacePointerUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrNonConformantStringBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrNonConformantStringBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
        NdrNonConformantStringBufferSize(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrNonConformantStringMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrNonConformantStringMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
    unsafe {
        NdrNonConformantStringMarshall(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrNonConformantStringMemorySize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrNonConformantStringMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrNonConformantStringUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrNonConformantStringUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrNonEncapsulatedUnionBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrNonEncapsulatedUnionBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
...
pub unsafe fn NdrNonEncapsulatedUnionFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrNonEncapsulatedUnionFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
    unsafe {
        NdrNonEncapsulatedUnionFree(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrNonEncapsulatedUnionMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrNonEncapsulatedUnionMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
    unsafe {
        NdrNonEncapsulatedUnionMarshall(core::mem::transmute(pstubmsg), pmemory as _, pformat as _)
    }
}
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn NdrNonEncapsulatedUnionMemorySize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrNonEncapsulatedUnionMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrNonEncapsulatedUnionUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrNonEncapsulatedUnionUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrNsGetBuffer(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrNsGetBuffer(pstubmsg : *mut MIDL_STUB_MESSAGE, bufferlength : u32, handle : *mut core::ffi::c_void) -> *mut u8);
...
pub unsafe fn NdrNsSendReceive(
    pstubmsg: *mut MIDL_STUB_MESSAGE,
    pbufferend: *mut u8,
    pautohandle: *mut *mut core::ffi::c_void,
) -> *mut u8 {
    windows_link::link!("rpcrt4.dll" "system" fn NdrNsSendReceive(pstubmsg : *mut MIDL_STUB_MESSAGE, pbufferend : *mut u8, pautohandle : *mut *mut core::ffi::c_void) -> *mut u8);
    unsafe {
        NdrNsSendReceive(
            core::mem::transmute(pstubmsg),
            pbufferend as _,
...
pub unsafe fn NdrPartialIgnoreServerInitialize(
    pstubmsg: *mut MIDL_STUB_MESSAGE,
    ppmemory: *mut *mut core::ffi::c_void,
    pformat: *mut u8,
) {
    windows_link::link!("rpcrt4.dll" "system" fn NdrPartialIgnoreServerInitialize(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut core::ffi::c_void, pformat : *mut u8));
    unsafe {
...
pub unsafe fn NdrPointerBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrPointerBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrPointerFree(pstubmsg: *mut MIDL_STUB_MESSAGE, pmemory: *mut u8, pformat: *mut u8) {
    windows_link::link!("rpcrt4.dll" "system" fn NdrPointerFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrPointerMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrPointerMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
...
pub unsafe fn NdrPointerMemorySize(pstubmsg: *mut MIDL_STUB_MESSAGE, pformat: *mut u8) -> u32 {
    windows_link::link!("rpcrt4.dll" "system" fn NdrPointerMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrPointerUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrPointerUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrRangeUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrRangeUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
        NdrRangeUnmarshall(
            core::mem::transmute(pstubmsg),
            ppmemory as _,
...
pub unsafe fn NdrServerContextMarshall(
    pstubmsg: *mut MIDL_STUB_MESSAGE,
    contexthandle: *mut NDR_SCONTEXT,
    rundownroutine: NDR_RUNDOWN,
) {
    windows_link::link!("rpcrt4.dll" "system" fn NdrServerContextMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, contexthandle : *mut NDR_SCONTEXT, rundownroutine : NDR_RUNDOWN));
    unsafe {
...
pub unsafe fn NdrServerContextNewMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrServerContextNewMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, contexthandle : *mut NDR_SCONTEXT, rundownroutine : NDR_RUNDOWN, pformat : *mut u8));
    unsafe {
...
pub unsafe fn NdrServerContextNewUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrServerContextNewUnmarshall(pstubmsg : *const MIDL_STUB_MESSAGE, pformat : *const u8) -> *mut NDR_SCONTEXT);
...
pub unsafe fn NdrServerContextUnmarshall(pstubmsg: *mut MIDL_STUB_MESSAGE) -> *mut NDR_SCONTEXT {
    windows_link::link!("rpcrt4.dll" "system" fn NdrServerContextUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE) -> *mut NDR_SCONTEXT);
...
pub unsafe fn NdrServerInitialize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrServerInitialize(prpcmsg : *mut RPC_MESSAGE, pstubmsg : *mut MIDL_STUB_MESSAGE, pstubdescriptor : *mut MIDL_STUB_DESC) -> *mut u8);
    unsafe {
        NdrServerInitialize(
            prpcmsg as _,
            core::mem::transmute(pstubmsg),
...
pub unsafe fn NdrServerInitializeNew(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrServerInitializeNew(prpcmsg : *mut RPC_MESSAGE, pstubmsg : *mut MIDL_STUB_MESSAGE, pstubdescriptor : *mut MIDL_STUB_DESC) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrServerInitializePartial(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrServerInitializePartial(prpcmsg : *mut RPC_MESSAGE, pstubmsg : *mut MIDL_STUB_MESSAGE, pstubdescriptor : *mut MIDL_STUB_DESC, requestedbuffersize : u32));
    unsafe {
...
pub unsafe fn NdrServerInitializeUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrServerInitializeUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pstubdescriptor : *mut MIDL_STUB_DESC, prpcmsg : *mut RPC_MESSAGE) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrSimpleStructBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrSimpleStructBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrSimpleStructFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrSimpleStructFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrSimpleStructMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrSimpleStructMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
...
pub unsafe fn NdrSimpleStructMemorySize(pstubmsg: *mut MIDL_STUB_MESSAGE, pformat: *mut u8) -> u32 {
    windows_link::link!("rpcrt4.dll" "system" fn NdrSimpleStructMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrSimpleStructUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrSimpleStructUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrUserMarshalBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrUserMarshalBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrUserMarshalFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrUserMarshalFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrUserMarshalMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrUserMarshalMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
...
pub unsafe fn NdrUserMarshalMemorySize(pstubmsg: *mut MIDL_STUB_MESSAGE, pformat: *mut u8) -> u32 {
    windows_link::link!("rpcrt4.dll" "system" fn NdrUserMarshalMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrUserMarshalUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrUserMarshalUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrVaryingArrayBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrVaryingArrayBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrVaryingArrayFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrVaryingArrayFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrVaryingArrayMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrVaryingArrayMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
...
pub unsafe fn NdrVaryingArrayMemorySize(pstubmsg: *mut MIDL_STUB_MESSAGE, pformat: *mut u8) -> u32 {
    windows_link::link!("rpcrt4.dll" "system" fn NdrVaryingArrayMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrVaryingArrayUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrVaryingArrayUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn NdrXmitOrRepAsBufferSize(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrXmitOrRepAsBufferSize(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrXmitOrRepAsFree(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrXmitOrRepAsFree(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8));
...
pub unsafe fn NdrXmitOrRepAsMarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrXmitOrRepAsMarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, pmemory : *mut u8, pformat : *mut u8) -> *mut u8);
...
pub unsafe fn NdrXmitOrRepAsMemorySize(pstubmsg: *mut MIDL_STUB_MESSAGE, pformat: *mut u8) -> u32 {
    windows_link::link!("rpcrt4.dll" "system" fn NdrXmitOrRepAsMemorySize(pstubmsg : *mut MIDL_STUB_MESSAGE, pformat : *mut u8) -> u32);
...
pub unsafe fn NdrXmitOrRepAsUnmarshall(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn NdrXmitOrRepAsUnmarshall(pstubmsg : *mut MIDL_STUB_MESSAGE, ppmemory : *mut *mut u8, pformat : *mut u8, fmustalloc : u8) -> *mut u8);
    unsafe {
...
pub unsafe fn RpcAsyncCancelCall(pasync: *mut RPC_ASYNC_STATE, fabort: bool) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcAsyncCancelCall(pasync : *mut RPC_ASYNC_STATE, fabort : windows_core::BOOL) -> RPC_STATUS);
...
pub unsafe fn RpcAsyncCompleteCall(
    ...
    reply: Option<*mut core::ffi::c_void>,
) -> RPC_STATUS {
...
pub unsafe fn RpcBindingBind(
    pasync: Option<*const RPC_ASYNC_STATE>,
    binding: *const core::ffi::c_void,
    ifspec: *const core::ffi::c_void,
) -> RPC_STATUS {
...
pub unsafe fn RpcBindingCopy(
    sourcebinding: *const core::ffi::c_void,
    destinationbinding: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
...
pub unsafe fn RpcBindingCreateA(
    ...
    security: Option<*const RPC_BINDING_HANDLE_SECURITY_V1_A>,
    options: Option<*const RPC_BINDING_HANDLE_OPTIONS_V1>,
    binding: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
    ...
    unsafe {
        RpcBindingCreateA(
            template,
            security.unwrap_or(core::mem::zeroed()) as _,
            options.unwrap_or(core::mem::zeroed()) as _,
            binding as _,
        )
    }
}
...
pub unsafe fn RpcBindingCreateW(
    ...
    security: Option<*const RPC_BINDING_HANDLE_SECURITY_V1_W>,
    options: Option<*const RPC_BINDING_HANDLE_OPTIONS_V1>,
    binding: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
...
#[inline]
pub unsafe fn RpcBindingFromStringBindingA<P0>(
    stringbinding: P0,
    binding: *mut *mut core::ffi::c_void,
) -> RPC_STATUS
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingFromStringBindingA(stringbinding : windows_core::PCSTR, binding : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe { RpcBindingFromStringBindingA(stringbinding.param().abi(), binding as _) }
}
#[inline]
pub unsafe fn RpcBindingFromStringBindingW<P0>(
    stringbinding: P0,
    binding: *mut *mut core::ffi::c_void,
) -> RPC_STATUS
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingFromStringBindingW(stringbinding : windows_core::PCWSTR, binding : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe { RpcBindingFromStringBindingW(stringbinding.param().abi(), binding as _) }
}
#[inline]
pub unsafe fn RpcBindingInqAuthClientA(
    clientbinding: Option<*const core::ffi::c_void>,
    privs: *mut *mut core::ffi::c_void,
    serverprincname: Option<*mut windows_core::PSTR>,
    authnlevel: Option<*mut u32>,
    authnsvc: Option<*mut u32>,
    authzsvc: Option<*mut u32>,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingInqAuthClientA(clientbinding : *const core::ffi::c_void, privs : *mut *mut core::ffi::c_void, serverprincname : *mut windows_core::PSTR, authnlevel : *mut u32, authnsvc : *mut u32, authzsvc : *mut u32) -> RPC_STATUS);
    unsafe {
        RpcBindingInqAuthClientA(
            clientbinding.unwrap_or(core::mem::zeroed()) as _,
            privs as _,
            serverprincname.unwrap_or(core::mem::zeroed()) as _,
            authnlevel.unwrap_or(core::mem::zeroed()) as _,
            authnsvc.unwrap_or(core::mem::zeroed()) as _,
            authzsvc.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn RpcBindingInqAuthClientExA(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingInqAuthClientExA(clientbinding : *const core::ffi::c_void, privs : *mut *mut core::ffi::c_void, serverprincname : *mut windows_core::PSTR, authnlevel : *mut u32, authnsvc : *mut u32, authzsvc : *mut u32, flags : u32) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcBindingInqAuthClientExW(
    clientbinding: Option<*const core::ffi::c_void>,
    privs: *mut *mut core::ffi::c_void,
    serverprincname: Option<*mut windows_core::PWSTR>,
    authnlevel: Option<*mut u32>,
    authnsvc: Option<*mut u32>,
    authzsvc: Option<*mut u32>,
    flags: u32,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingInqAuthClientExW(clientbinding : *const core::ffi::c_void, privs : *mut *mut core::ffi::c_void, serverprincname : *mut windows_core::PWSTR, authnlevel : *mut u32, authnsvc : *mut u32, authzsvc : *mut u32, flags : u32) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcBindingInqAuthClientW(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingInqAuthClientW(clientbinding : *const core::ffi::c_void, privs : *mut *mut core::ffi::c_void, serverprincname : *mut windows_core::PWSTR, authnlevel : *mut u32, authnsvc : *mut u32, authzsvc : *mut u32) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcBindingInqAuthInfoA(
    ...
    authnlevel: Option<*mut u32>,
    authnsvc: Option<*mut u32>,
    authidentity: Option<*mut *mut core::ffi::c_void>,
    authzsvc: Option<*mut u32>,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingInqAuthInfoA(binding : *const core::ffi::c_void, serverprincname : *mut windows_core::PSTR, authnlevel : *mut u32, authnsvc : *mut u32, authidentity : *mut *mut core::ffi::c_void, authzsvc : *mut u32) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcBindingInqAuthInfoExA(
    ...
    authzsvc: Option<*mut u32>,
    rpcqosversion: u32,
    securityqos: Option<*mut RPC_SECURITY_QOS>,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingInqAuthInfoExA(binding : *const core::ffi::c_void, serverprincname : *mut windows_core::PSTR, authnlevel : *mut u32, authnsvc : *mut u32, authidentity : *mut *mut core::ffi::c_void, authzsvc : *mut u32, rpcqosversion : u32, securityqos : *mut RPC_SECURITY_QOS) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcBindingInqAuthInfoExW(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingInqAuthInfoExW(binding : *const core::ffi::c_void, serverprincname : *mut windows_core::PWSTR, authnlevel : *mut u32, authnsvc : *mut u32, authidentity : *mut *mut core::ffi::c_void, authzsvc : *mut u32, rpcqosversion : u32, securityqos : *mut RPC_SECURITY_QOS) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcBindingInqAuthInfoW(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingInqAuthInfoW(binding : *const core::ffi::c_void, serverprincname : *mut windows_core::PWSTR, authnlevel : *mut u32, authnsvc : *mut u32, authidentity : *mut *mut core::ffi::c_void, authzsvc : *mut u32) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcBindingInqObject(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingInqObject(binding : *const core::ffi::c_void, objectuuid : *mut windows_core::GUID) -> RPC_STATUS);
...
pub unsafe fn RpcBindingServerFromClient(
    clientbinding: Option<*const core::ffi::c_void>,
    serverbinding: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
...
#[inline]
pub unsafe fn RpcBindingSetAuthInfoA<P1>(
    binding: *const core::ffi::c_void,
    serverprincname: P1,
    authnlevel: u32,
    authnsvc: u32,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingSetAuthInfoA(binding : *const core::ffi::c_void, serverprincname : windows_core::PCSTR, authnlevel : u32, authnsvc : u32, authidentity : *const core::ffi::c_void, authzsvc : u32) -> RPC_STATUS);
    unsafe {
        RpcBindingSetAuthInfoA(
            binding,
            serverprincname.param().abi(),
            authnlevel,
            authnsvc,
            authidentity.unwrap_or(core::mem::zeroed()) as _,
            authzsvc,
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn RpcBindingSetAuthInfoExA<P1>(
    binding: *const core::ffi::c_void,
    serverprincname: P1,
    authnlevel: u32,
    authnsvc: u32,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingSetAuthInfoExA(binding : *const core::ffi::c_void, serverprincname : windows_core::PCSTR, authnlevel : u32, authnsvc : u32, authidentity : *const core::ffi::c_void, authzsvc : u32, securityqos : *const RPC_SECURITY_QOS) -> RPC_STATUS);
    unsafe {
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn RpcBindingSetAuthInfoExW<P1>(
    binding: *const core::ffi::c_void,
    serverprincname: P1,
    authnlevel: u32,
    authnsvc: u32,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingSetAuthInfoExW(binding : *const core::ffi::c_void, serverprincname : windows_core::PCWSTR, authnlevel : u32, authnsvc : u32, authidentity : *const core::ffi::c_void, authzsvc : u32, securityqos : *const RPC_SECURITY_QOS) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcBindingSetAuthInfoW<P1>(
    binding: *const core::ffi::c_void,
    serverprincname: P1,
    authnlevel: u32,
    authnsvc: u32,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingSetAuthInfoW(binding : *const core::ffi::c_void, serverprincname : windows_core::PCWSTR, authnlevel : u32, authnsvc : u32, authidentity : *const core::ffi::c_void, authzsvc : u32) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcBindingSetObject(
    binding: *const core::ffi::c_void,
    objectuuid: *const windows_core::GUID,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingSetObject(binding : *const core::ffi::c_void, objectuuid : *const windows_core::GUID) -> RPC_STATUS);
...
pub unsafe fn RpcBindingToStringBindingA(
    binding: *const core::ffi::c_void,
    stringbinding: *mut windows_core::PSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingToStringBindingA(binding : *const core::ffi::c_void, stringbinding : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe { RpcBindingToStringBindingA(binding, stringbinding as _) }
}
#[inline]
pub unsafe fn RpcBindingToStringBindingW(
    binding: *const core::ffi::c_void,
    stringbinding: *mut windows_core::PWSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcBindingToStringBindingW(binding : *const core::ffi::c_void, stringbinding : *mut windows_core::PWSTR) -> RPC_STATUS);
...
pub unsafe fn RpcCertGeneratePrincipalNameA(
    ...
    flags: u32,
    pbuffer: *mut windows_core::PSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcCertGeneratePrincipalNameA(context : *const super::super::Security::Cryptography:: CERT_CONTEXT, flags : u32, pbuffer : *mut windows_core::PSTR) -> RPC_STATUS);
...
pub unsafe fn RpcCertGeneratePrincipalNameW(
    context: *const super::super::Security::Cryptography::CERT_CONTEXT,
    flags: u32,
    pbuffer: *mut windows_core::PWSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcCertGeneratePrincipalNameW(context : *const super::super::Security::Cryptography:: CERT_CONTEXT, flags : u32, pbuffer : *mut windows_core::PWSTR) -> RPC_STATUS);
    unsafe { RpcCertGeneratePrincipalNameW(context, flags, pbuffer as _) }
}
#[inline]
pub unsafe fn RpcEpRegisterA<P3>(
    ifspec: *const core::ffi::c_void,
...
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcEpRegisterA(ifspec : *const core::ffi::c_void, bindingvector : *const RPC_BINDING_VECTOR, uuidvector : *const UUID_VECTOR, annotation : windows_core::PCSTR) -> RPC_STATUS);
    unsafe {
        RpcEpRegisterA(
            ifspec,
            bindingvector,
            uuidvector.unwrap_or(core::mem::zeroed()) as _,
            annotation.param().abi(),
        )
    }
}
#[inline]
...
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcEpRegisterNoReplaceA(ifspec : *const core::ffi::c_void, bindingvector : *const RPC_BINDING_VECTOR, uuidvector : *const UUID_VECTOR, annotation : windows_core::PCSTR) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcEpRegisterNoReplaceW<P3>(
    ifspec: *const core::ffi::c_void,
    bindingvector: *const RPC_BINDING_VECTOR,
    uuidvector: Option<*const UUID_VECTOR>,
    annotation: P3,
...
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcEpRegisterNoReplaceW(ifspec : *const core::ffi::c_void, bindingvector : *const RPC_BINDING_VECTOR, uuidvector : *const UUID_VECTOR, annotation : windows_core::PCWSTR) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcEpRegisterW<P3>(
    ifspec: *const core::ffi::c_void,
    bindingvector: *const RPC_BINDING_VECTOR,
    uuidvector: Option<*const UUID_VECTOR>,
    annotation: P3,
...
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcEpRegisterW(ifspec : *const core::ffi::c_void, bindingvector : *const RPC_BINDING_VECTOR, uuidvector : *const UUID_VECTOR, annotation : windows_core::PCWSTR) -> RPC_STATUS);
    unsafe {
        RpcEpRegisterW(
            ifspec,
            bindingvector,
...
pub unsafe fn RpcErrorGetNextRecord(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn RpcErrorGetNextRecord(enumhandle : *const RPC_ERROR_ENUM_HANDLE, copystrings : windows_core::BOOL, errorinfo : *mut RPC_EXTENDED_ERROR_INFO) -> RPC_STATUS);
...
pub unsafe fn RpcErrorLoadErrorInfo(
    errorblob: *const core::ffi::c_void,
    blobsize: usize,
...
pub unsafe fn RpcErrorSaveErrorInfo(
    enumhandle: *const RPC_ERROR_ENUM_HANDLE,
    errorblob: *mut *mut core::ffi::c_void,
    blobsize: *mut usize,
) -> RPC_STATUS {
...
pub unsafe fn RpcFreeAuthorizationContext(
    pauthzclientcontext: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
...
pub unsafe fn RpcGetAuthorizationContextForClient(
    ...
    reserved3: u32,
    reserved4: Option<*const core::ffi::c_void>,
    pauthzclientcontext: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
...
pub unsafe fn RpcIfInqId(
    rpcifhandle: *const core::ffi::c_void,
...
pub unsafe fn RpcImpersonateClientContainer(
    bindinghandle: Option<*const core::ffi::c_void>,
) -> RPC_STATUS {
...
pub unsafe fn RpcMgmtEpEltInqBegin(
    epbinding: Option<*const core::ffi::c_void>,
    inquirytype: u32,
    ifid: Option<*const RPC_IF_ID>,
    versoption: Option<u32>,
    objectuuid: Option<*const windows_core::GUID>,
    inquirycontext: *mut *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcMgmtEpEltInqBegin(epbinding : *const core::ffi::c_void, inquirytype : u32, ifid : *const RPC_IF_ID, versoption : u32, objectuuid : *const windows_core::GUID, inquirycontext : *mut *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
        RpcMgmtEpEltInqBegin(
            epbinding.unwrap_or(core::mem::zeroed()) as _,
            inquirytype,
            ifid.unwrap_or(core::mem::zeroed()) as _,
            versoption.unwrap_or(core::mem::zeroed()) as _,
            objectuuid.unwrap_or(core::mem::zeroed()) as _,
            inquirycontext as _,
        )
    }
}
...
pub unsafe fn RpcMgmtEpEltInqNextA(
    inquirycontext: *const *const core::ffi::c_void,
    ifid: *mut RPC_IF_ID,
    binding: Option<*mut *mut core::ffi::c_void>,
    objectuuid: Option<*mut windows_core::GUID>,
    annotation: Option<*mut windows_core::PSTR>,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcMgmtEpEltInqNextA(inquirycontext : *const *const core::ffi::c_void, ifid : *mut RPC_IF_ID, binding : *mut *mut core::ffi::c_void, objectuuid : *mut windows_core::GUID, annotation : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe {
        RpcMgmtEpEltInqNextA(
            ...
            binding.unwrap_or(core::mem::zeroed()) as _,
            objectuuid.unwrap_or(core::mem::zeroed()) as _,
            annotation.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn RpcMgmtEpEltInqNextW(
    ...
    binding: Option<*mut *mut core::ffi::c_void>,
    objectuuid: Option<*mut windows_core::GUID>,
    annotation: Option<*mut windows_core::PWSTR>,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcMgmtEpEltInqNextW(inquirycontext : *const *const core::ffi::c_void, ifid : *mut RPC_IF_ID, binding : *mut *mut core::ffi::c_void, objectuuid : *mut windows_core::GUID, annotation : *mut windows_core::PWSTR) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcMgmtEpUnregister(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn RpcMgmtEpUnregister(epbinding : *const core::ffi::c_void, ifid : *const RPC_IF_ID, binding : *const core::ffi::c_void, objectuuid : *const windows_core::GUID) -> RPC_STATUS);
    unsafe {
        RpcMgmtEpUnregister(
            epbinding.unwrap_or(core::mem::zeroed()) as _,
            ifid,
...
pub unsafe fn RpcMgmtInqServerPrincNameA(
    binding: Option<*const core::ffi::c_void>,
    authnsvc: u32,
    serverprincname: *mut windows_core::PSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcMgmtInqServerPrincNameA(binding : *const core::ffi::c_void, authnsvc : u32, serverprincname : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe {
        RpcMgmtInqServerPrincNameA(
            binding.unwrap_or(core::mem::zeroed()) as _,
            authnsvc,
            serverprincname as _,
        )
    }
}
#[inline]
pub unsafe fn RpcMgmtInqServerPrincNameW(
    binding: Option<*const core::ffi::c_void>,
    authnsvc: u32,
    serverprincname: *mut windows_core::PWSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcMgmtInqServerPrincNameW(binding : *const core::ffi::c_void, authnsvc : u32, serverprincname : *mut windows_core::PWSTR) -> RPC_STATUS);
    unsafe {
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcNetworkIsProtseqValidA(protseq : windows_core::PCSTR) -> RPC_STATUS);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcNetworkIsProtseqValidW(protseq : windows_core::PCWSTR) -> RPC_STATUS);
    unsafe { RpcNetworkIsProtseqValidW(protseq.param().abi()) }
}
#[inline]
pub unsafe fn RpcNsBindingExportA<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifspec: Option<*const core::ffi::c_void>,
    bindingvec: Option<*const RPC_BINDING_VECTOR>,
    objectuuidvec: Option<*const UUID_VECTOR>,
) -> RPC_STATUS
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsBindingExportA(entrynamesyntax : u32, entryname : windows_core::PCSTR, ifspec : *const core::ffi::c_void, bindingvec : *const RPC_BINDING_VECTOR, objectuuidvec : *const UUID_VECTOR) -> RPC_STATUS);
    unsafe {
        RpcNsBindingExportA(
            entrynamesyntax,
            entryname.param().abi(),
            ifspec.unwrap_or(core::mem::zeroed()) as _,
            bindingvec.unwrap_or(core::mem::zeroed()) as _,
            objectuuidvec.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn RpcNsBindingExportPnPA<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifspec: Option<*const core::ffi::c_void>,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsBindingExportPnPA(entrynamesyntax : u32, entryname : windows_core::PCSTR, ifspec : *const core::ffi::c_void, objectvector : *const UUID_VECTOR) -> RPC_STATUS);
    unsafe {
        RpcNsBindingExportPnPA(
            entrynamesyntax,
            entryname.param().abi(),
            ifspec.unwrap_or(core::mem::zeroed()) as _,
            objectvector.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn RpcNsBindingExportPnPW<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifspec: Option<*const core::ffi::c_void>,
    objectvector: Option<*const UUID_VECTOR>,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsBindingExportPnPW(entrynamesyntax : u32, entryname : windows_core::PCWSTR, ifspec : *const core::ffi::c_void, objectvector : *const UUID_VECTOR) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcNsBindingExportW<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifspec: Option<*const core::ffi::c_void>,
    bindingvec: Option<*const RPC_BINDING_VECTOR>,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsBindingExportW(entrynamesyntax : u32, entryname : windows_core::PCWSTR, ifspec : *const core::ffi::c_void, bindingvec : *const RPC_BINDING_VECTOR, objectuuidvec : *const UUID_VECTOR) -> RPC_STATUS);
    unsafe {
        RpcNsBindingExportW(
            entrynamesyntax,
            entryname.param().abi(),
...
#[inline]
pub unsafe fn RpcNsBindingImportBeginA<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifspec: Option<*const core::ffi::c_void>,
    objuuid: Option<*const windows_core::GUID>,
    importcontext: *mut *mut core::ffi::c_void,
) -> RPC_STATUS
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsBindingImportBeginA(entrynamesyntax : u32, entryname : windows_core::PCSTR, ifspec : *const core::ffi::c_void, objuuid : *const windows_core::GUID, importcontext : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
        RpcNsBindingImportBeginA(
            entrynamesyntax,
            entryname.param().abi(),
            ifspec.unwrap_or(core::mem::zeroed()) as _,
            objuuid.unwrap_or(core::mem::zeroed()) as _,
            importcontext as _,
        )
    }
}
#[inline]
pub unsafe fn RpcNsBindingImportBeginW<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifspec: Option<*const core::ffi::c_void>,
    objuuid: Option<*const windows_core::GUID>,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsBindingImportBeginW(entrynamesyntax : u32, entryname : windows_core::PCWSTR, ifspec : *const core::ffi::c_void, objuuid : *const windows_core::GUID, importcontext : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcNsBindingImportNext(
    importcontext: *mut core::ffi::c_void,
    binding: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
...
pub unsafe fn RpcNsBindingInqEntryNameA(
    binding: *const core::ffi::c_void,
    entrynamesyntax: u32,
    entryname: *mut windows_core::PSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcNsBindingInqEntryNameA(binding : *const core::ffi::c_void, entrynamesyntax : u32, entryname : *mut windows_core::PSTR) -> RPC_STATUS);
...
pub unsafe fn RpcNsBindingInqEntryNameW(
    binding: *const core::ffi::c_void,
    entrynamesyntax: u32,
    entryname: *mut windows_core::PWSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcNsBindingInqEntryNameW(binding : *const core::ffi::c_void, entrynamesyntax : u32, entryname : *mut windows_core::PWSTR) -> RPC_STATUS);
...
pub unsafe fn RpcNsBindingLookupBeginA<P1>(
    ...
    objuuid: Option<*const windows_core::GUID>,
    bindingmaxcount: u32,
    lookupcontext: *mut *mut core::ffi::c_void,
) -> RPC_STATUS
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsBindingLookupBeginA(entrynamesyntax : u32, entryname : windows_core::PCSTR, ifspec : *const core::ffi::c_void, objuuid : *const windows_core::GUID, bindingmaxcount : u32, lookupcontext : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcNsBindingLookupBeginW<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifspec: Option<*const core::ffi::c_void>,
    objuuid: Option<*const windows_core::GUID>,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsBindingLookupBeginW(entrynamesyntax : u32, entryname : windows_core::PCWSTR, ifspec : *const core::ffi::c_void, objuuid : *const windows_core::GUID, bindingmaxcount : u32, lookupcontext : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcNsBindingLookupNext(
    lookupcontext: *mut core::ffi::c_void,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsBindingUnexportA(entrynamesyntax : u32, entryname : windows_core::PCSTR, ifspec : *const core::ffi::c_void, objectuuidvec : *const UUID_VECTOR) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcNsBindingUnexportPnPA<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifspec: Option<*const core::ffi::c_void>,
    objectvector: Option<*const UUID_VECTOR>,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsBindingUnexportPnPA(entrynamesyntax : u32, entryname : windows_core::PCSTR, ifspec : *const core::ffi::c_void, objectvector : *const UUID_VECTOR) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcNsBindingUnexportPnPW<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifspec: Option<*const core::ffi::c_void>,
    objectvector: Option<*const UUID_VECTOR>,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsBindingUnexportPnPW(entrynamesyntax : u32, entryname : windows_core::PCWSTR, ifspec : *const core::ffi::c_void, objectvector : *const UUID_VECTOR) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcNsBindingUnexportW<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifspec: Option<*const core::ffi::c_void>,
    objectuuidvec: Option<*const UUID_VECTOR>,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsBindingUnexportW(entrynamesyntax : u32, entryname : windows_core::PCWSTR, ifspec : *const core::ffi::c_void, objectuuidvec : *const UUID_VECTOR) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcNsEntryExpandNameA<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    expandedname: *mut windows_core::PSTR,
) -> RPC_STATUS
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsEntryExpandNameA(entrynamesyntax : u32, entryname : windows_core::PCSTR, expandedname : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe { RpcNsEntryExpandNameA(entrynamesyntax, entryname.param().abi(), expandedname as _) }
}
#[inline]
pub unsafe fn RpcNsEntryExpandNameW<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    expandedname: *mut windows_core::PWSTR,
) -> RPC_STATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsEntryExpandNameW(entrynamesyntax : u32, entryname : windows_core::PCWSTR, expandedname : *mut windows_core::PWSTR) -> RPC_STATUS);
    unsafe { RpcNsEntryExpandNameW(entrynamesyntax, entryname.param().abi(), expandedname as _) }
}
#[inline]
pub unsafe fn RpcNsEntryObjectInqBeginA<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    inquirycontext: *mut *mut core::ffi::c_void,
) -> RPC_STATUS
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsEntryObjectInqBeginA(entrynamesyntax : u32, entryname : windows_core::PCSTR, inquirycontext : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcNsEntryObjectInqBeginW<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    inquirycontext: *mut *mut core::ffi::c_void,
) -> RPC_STATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsEntryObjectInqBeginW(entrynamesyntax : u32, entryname : windows_core::PCWSTR, inquirycontext : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcNsEntryObjectInqDone(inquirycontext: *mut *mut core::ffi::c_void) -> RPC_STATUS {
    windows_link::link!("rpcns4.dll" "system" fn RpcNsEntryObjectInqDone(inquirycontext : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe { RpcNsEntryObjectInqDone(inquirycontext as _) }
}
#[inline]
pub unsafe fn RpcNsEntryObjectInqNext(
    inquirycontext: *mut core::ffi::c_void,
    objuuid: *mut windows_core::GUID,
) -> RPC_STATUS {
    windows_link::link!("rpcns4.dll" "system" fn RpcNsEntryObjectInqNext(inquirycontext : *mut core::ffi::c_void, objuuid : *mut windows_core::GUID) -> RPC_STATUS);
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsGroupDeleteA(groupnamesyntax : GROUP_NAME_SYNTAX, groupname : windows_core::PCSTR) -> RPC_STATUS);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsGroupDeleteW(groupnamesyntax : GROUP_NAME_SYNTAX, groupname : windows_core::PCWSTR) -> RPC_STATUS);
    unsafe { RpcNsGroupDeleteW(groupnamesyntax, groupname.param().abi()) }
}
#[inline]
pub unsafe fn RpcNsGroupMbrAddA<P1, P3>(
    groupnamesyntax: u32,
    groupname: P1,
...
where
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsGroupMbrAddA(groupnamesyntax : u32, groupname : windows_core::PCSTR, membernamesyntax : u32, membername : windows_core::PCSTR) -> RPC_STATUS);
    unsafe {
        RpcNsGroupMbrAddA(
            groupnamesyntax,
            groupname.param().abi(),
            membernamesyntax,
            membername.param().abi(),
        )
    }
}
#[inline]
...
where
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsGroupMbrAddW(groupnamesyntax : u32, groupname : windows_core::PCWSTR, membernamesyntax : u32, membername : windows_core::PCWSTR) -> RPC_STATUS);
    unsafe {
        RpcNsGroupMbrAddW(
            groupnamesyntax,
            groupname.param().abi(),
...
#[inline]
pub unsafe fn RpcNsGroupMbrInqBeginA<P1>(
    groupnamesyntax: u32,
    groupname: P1,
    membernamesyntax: u32,
    inquirycontext: *mut *mut core::ffi::c_void,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsGroupMbrInqBeginA(groupnamesyntax : u32, groupname : windows_core::PCSTR, membernamesyntax : u32, inquirycontext : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcNsGroupMbrInqBeginW<P1>(
    groupnamesyntax: u32,
    groupname: P1,
    membernamesyntax: u32,
    inquirycontext: *mut *mut core::ffi::c_void,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsGroupMbrInqBeginW(groupnamesyntax : u32, groupname : windows_core::PCWSTR, membernamesyntax : u32, inquirycontext : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcNsGroupMbrInqDone(inquirycontext: *mut *mut core::ffi::c_void) -> RPC_STATUS {
    windows_link::link!("rpcns4.dll" "system" fn RpcNsGroupMbrInqDone(inquirycontext : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe { RpcNsGroupMbrInqDone(inquirycontext as _) }
}
#[inline]
pub unsafe fn RpcNsGroupMbrInqNextA(
    inquirycontext: *mut core::ffi::c_void,
    membername: *mut windows_core::PSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcns4.dll" "system" fn RpcNsGroupMbrInqNextA(inquirycontext : *mut core::ffi::c_void, membername : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe { RpcNsGroupMbrInqNextA(inquirycontext as _, membername as _) }
}
#[inline]
pub unsafe fn RpcNsGroupMbrInqNextW(
    inquirycontext: *mut core::ffi::c_void,
    membername: *mut windows_core::PWSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcns4.dll" "system" fn RpcNsGroupMbrInqNextW(inquirycontext : *mut core::ffi::c_void, membername : *mut windows_core::PWSTR) -> RPC_STATUS);
    unsafe { RpcNsGroupMbrInqNextW(inquirycontext as _, membername as _) }
}
#[inline]
pub unsafe fn RpcNsGroupMbrRemoveA<P1, P3>(
    groupnamesyntax: u32,
    groupname: P1,
    membernamesyntax: u32,
    membername: P3,
...
where
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsGroupMbrRemoveA(groupnamesyntax : u32, groupname : windows_core::PCSTR, membernamesyntax : u32, membername : windows_core::PCSTR) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcNsGroupMbrRemoveW<P1, P3>(
    groupnamesyntax: u32,
    groupname: P1,
    membernamesyntax: u32,
    membername: P3,
...
where
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsGroupMbrRemoveW(groupnamesyntax : u32, groupname : windows_core::PCWSTR, membernamesyntax : u32, membername : windows_core::PCWSTR) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcNsMgmtBindingUnexportA<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifid: Option<*const RPC_IF_ID>,
    versoption: u32,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsMgmtBindingUnexportA(entrynamesyntax : u32, entryname : windows_core::PCSTR, ifid : *const RPC_IF_ID, versoption : u32, objectuuidvec : *const UUID_VECTOR) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcNsMgmtBindingUnexportW<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifid: Option<*const RPC_IF_ID>,
    versoption: u32,
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsMgmtBindingUnexportW(entrynamesyntax : u32, entryname : windows_core::PCWSTR, ifid : *const RPC_IF_ID, versoption : u32, objectuuidvec : *const UUID_VECTOR) -> RPC_STATUS);
    unsafe {
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsMgmtEntryCreateA(entrynamesyntax : u32, entryname : windows_core::PCSTR) -> RPC_STATUS);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsMgmtEntryCreateW(entrynamesyntax : u32, entryname : windows_core::PCWSTR) -> RPC_STATUS);
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsMgmtEntryDeleteA(entrynamesyntax : u32, entryname : windows_core::PCSTR) -> RPC_STATUS);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsMgmtEntryDeleteW(entrynamesyntax : u32, entryname : windows_core::PCWSTR) -> RPC_STATUS);
    unsafe { RpcNsMgmtEntryDeleteW(entrynamesyntax, entryname.param().abi()) }
}
#[inline]
pub unsafe fn RpcNsMgmtEntryInqIfIdsA<P1>(
    entrynamesyntax: u32,
    entryname: P1,
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsMgmtEntryInqIfIdsA(entrynamesyntax : u32, entryname : windows_core::PCSTR, ifidvec : *mut *mut RPC_IF_ID_VECTOR) -> RPC_STATUS);
    unsafe { RpcNsMgmtEntryInqIfIdsA(entrynamesyntax, entryname.param().abi(), ifidvec as _) }
}
#[inline]
pub unsafe fn RpcNsMgmtEntryInqIfIdsW<P1>(
    entrynamesyntax: u32,
    entryname: P1,
    ifidvec: *mut *mut RPC_IF_ID_VECTOR,
) -> RPC_STATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsMgmtEntryInqIfIdsW(entrynamesyntax : u32, entryname : windows_core::PCWSTR, ifidvec : *mut *mut RPC_IF_ID_VECTOR) -> RPC_STATUS);
    unsafe { RpcNsMgmtEntryInqIfIdsW(entrynamesyntax, entryname.param().abi(), ifidvec as _) }
}
#[inline]
pub unsafe fn RpcNsMgmtHandleSetExpAge(
    nshandle: *mut core::ffi::c_void,
    expirationage: u32,
) -> RPC_STATUS {
    windows_link::link!("rpcns4.dll" "system" fn RpcNsMgmtHandleSetExpAge(nshandle : *mut core::ffi::c_void, expirationage : u32) -> RPC_STATUS);
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsProfileDeleteA(profilenamesyntax : u32, profilename : windows_core::PCSTR) -> RPC_STATUS);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsProfileDeleteW(profilenamesyntax : u32, profilename : windows_core::PCWSTR) -> RPC_STATUS);
...
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsProfileEltAddA(profilenamesyntax : u32, profilename : windows_core::PCSTR, ifid : *const RPC_IF_ID, membernamesyntax : u32, membername : windows_core::PCSTR, priority : u32, annotation : windows_core::PCSTR) -> RPC_STATUS);
    unsafe {
        RpcNsProfileEltAddA(
            profilenamesyntax,
            profilename.param().abi(),
            ifid.unwrap_or(core::mem::zeroed()) as _,
            membernamesyntax,
            membername.param().abi(),
            priority,
...
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsProfileEltAddW(profilenamesyntax : u32, profilename : windows_core::PCWSTR, ifid : *const RPC_IF_ID, membernamesyntax : u32, membername : windows_core::PCWSTR, priority : u32, annotation : windows_core::PCWSTR) -> RPC_STATUS);
    unsafe {
        RpcNsProfileEltAddW(
            profilenamesyntax,
            profilename.param().abi(),
...
where
    ...
    P6: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsProfileEltInqBeginA(profilenamesyntax : u32, profilename : windows_core::PCSTR, inquirytype : u32, ifid : *const RPC_IF_ID, versoption : u32, membernamesyntax : u32, membername : windows_core::PCSTR, inquirycontext : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcNsProfileEltInqBeginW<P1, P6>(
    profilenamesyntax: u32,
    profilename: P1,
    inquirytype: u32,
    ifid: Option<*const RPC_IF_ID>,
...
where
    ...
    P6: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsProfileEltInqBeginW(profilenamesyntax : u32, profilename : windows_core::PCWSTR, inquirytype : u32, ifid : *const RPC_IF_ID, versoption : u32, membernamesyntax : u32, membername : windows_core::PCWSTR, inquirycontext : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcNsProfileEltInqNextA(
    inquirycontext: *const core::ffi::c_void,
    ifid: Option<*mut RPC_IF_ID>,
    membername: *mut windows_core::PSTR,
    priority: *mut u32,
    annotation: *mut windows_core::PSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcns4.dll" "system" fn RpcNsProfileEltInqNextA(inquirycontext : *const core::ffi::c_void, ifid : *mut RPC_IF_ID, membername : *mut windows_core::PSTR, priority : *mut u32, annotation : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcNsProfileEltInqNextW(
    ...
    membername: *mut windows_core::PWSTR,
    priority: *mut u32,
    annotation: *mut windows_core::PWSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcns4.dll" "system" fn RpcNsProfileEltInqNextW(inquirycontext : *const core::ffi::c_void, ifid : *mut RPC_IF_ID, membername : *mut windows_core::PWSTR, priority : *mut u32, annotation : *mut windows_core::PWSTR) -> RPC_STATUS);
    unsafe {
...
where
    ...
    P4: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsProfileEltRemoveA(profilenamesyntax : u32, profilename : windows_core::PCSTR, ifid : *const RPC_IF_ID, membernamesyntax : u32, membername : windows_core::PCSTR) -> RPC_STATUS);
    unsafe {
...
where
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcns4.dll" "system" fn RpcNsProfileEltRemoveW(profilenamesyntax : u32, profilename : windows_core::PCWSTR, ifid : *const RPC_IF_ID, membernamesyntax : u32, membername : windows_core::PCWSTR) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcObjectInqType(
    objuuid: *const windows_core::GUID,
    typeuuid: Option<*mut windows_core::GUID>,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcObjectInqType(objuuid : *const windows_core::GUID, typeuuid : *mut windows_core::GUID) -> RPC_STATUS);
...
pub unsafe fn RpcObjectSetType(
    objuuid: *const windows_core::GUID,
    typeuuid: Option<*const windows_core::GUID>,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcObjectSetType(objuuid : *const windows_core::GUID, typeuuid : *const windows_core::GUID) -> RPC_STATUS);
...
pub unsafe fn RpcServerInqCallAttributesA(
    clientbinding: Option<*const core::ffi::c_void>,
    rpccallattributes: *mut core::ffi::c_void,
) -> RPC_STATUS {
...
#[inline]
pub unsafe fn RpcServerInqDefaultPrincNameA(
    authnsvc: u32,
    princname: *mut windows_core::PSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerInqDefaultPrincNameA(authnsvc : u32, princname : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe { RpcServerInqDefaultPrincNameA(authnsvc, princname as _) }
}
#[inline]
pub unsafe fn RpcServerInqDefaultPrincNameW(
    authnsvc: u32,
    princname: *mut windows_core::PWSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerInqDefaultPrincNameW(authnsvc : u32, princname : *mut windows_core::PWSTR) -> RPC_STATUS);
    unsafe { RpcServerInqDefaultPrincNameW(authnsvc, princname as _) }
}
#[inline]
pub unsafe fn RpcServerInqIf(
    ifspec: *const core::ffi::c_void,
    mgrtypeuuid: Option<*const windows_core::GUID>,
    mgrepv: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerInqIf(ifspec : *const core::ffi::c_void, mgrtypeuuid : *const windows_core::GUID, mgrepv : *mut *mut core::ffi::c_void) -> RPC_STATUS);
    unsafe {
        RpcServerInqIf(
            ifspec,
            mgrtypeuuid.unwrap_or(core::mem::zeroed()) as _,
            mgrepv as _,
        )
    }
}
...
pub unsafe fn RpcServerInterfaceGroupCreateA(
    ...
    idlecallbackcontext: *const core::ffi::c_void,
    ifgroup: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
    ...
    unsafe {
        RpcServerInterfaceGroupCreateA(
            core::mem::transmute(interfaces.as_ptr()),
            interfaces.len().try_into().unwrap(),
            core::mem::transmute(endpoints.as_ptr()),
            endpoints.len().try_into().unwrap(),
            idleperiod,
            idlecallbackfn,
            idlecallbackcontext,
            ifgroup as _,
...
pub unsafe fn RpcServerRegisterAuthInfoA<P0>(
    ...
    arg: Option<*const core::ffi::c_void>,
) -> RPC_STATUS
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerRegisterAuthInfoA(serverprincname : windows_core::PCSTR, authnsvc : u32, getkeyfn : RPC_AUTH_KEY_RETRIEVAL_FN, arg : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
        RpcServerRegisterAuthInfoA(
            serverprincname.param().abi(),
            authnsvc,
            getkeyfn,
            arg.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerRegisterAuthInfoW(serverprincname : windows_core::PCWSTR, authnsvc : u32, getkeyfn : RPC_AUTH_KEY_RETRIEVAL_FN, arg : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcServerRegisterIf(
    ifspec: *const core::ffi::c_void,
    mgrtypeuuid: Option<*const windows_core::GUID>,
    mgrepv: Option<*const core::ffi::c_void>,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerRegisterIf(ifspec : *const core::ffi::c_void, mgrtypeuuid : *const windows_core::GUID, mgrepv : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
        RpcServerRegisterIf(
            ifspec,
            mgrtypeuuid.unwrap_or(core::mem::zeroed()) as _,
            mgrepv.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn RpcServerRegisterIf2(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerRegisterIf2(ifspec : *const core::ffi::c_void, mgrtypeuuid : *const windows_core::GUID, mgrepv : *const core::ffi::c_void, flags : u32, maxcalls : u32, maxrpcsize : u32, ifcallbackfn : RPC_IF_CALLBACK_FN) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcServerRegisterIf3(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerRegisterIf3(ifspec : *const core::ffi::c_void, mgrtypeuuid : *const windows_core::GUID, mgrepv : *const core::ffi::c_void, flags : u32, maxcalls : u32, maxrpcsize : u32, ifcallback : RPC_IF_CALLBACK_FN, securitydescriptor : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcServerRegisterIfEx(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerRegisterIfEx(ifspec : *const core::ffi::c_void, mgrtypeuuid : *const windows_core::GUID, mgrepv : *const core::ffi::c_void, flags : u32, maxcalls : u32, ifcallback : RPC_IF_CALLBACK_FN) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcServerUnregisterIf(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUnregisterIf(ifspec : *const core::ffi::c_void, mgrtypeuuid : *const windows_core::GUID, waitforcallstocomplete : u32) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcServerUnregisterIfEx(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUnregisterIfEx(ifspec : *const core::ffi::c_void, mgrtypeuuid : *const windows_core::GUID, rundowncontexthandles : i32) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcServerUseProtseqA<P0>(
    protseq: P0,
    maxcalls: u32,
    securitydescriptor: Option<*const core::ffi::c_void>,
) -> RPC_STATUS
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUseProtseqA(protseq : windows_core::PCSTR, maxcalls : u32, securitydescriptor : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcServerUseProtseqEpA<P0, P2>(
    protseq: P0,
    maxcalls: u32,
    endpoint: P2,
    securitydescriptor: Option<*const core::ffi::c_void>,
...
where
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUseProtseqEpA(protseq : windows_core::PCSTR, maxcalls : u32, endpoint : windows_core::PCSTR, securitydescriptor : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
where
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUseProtseqEpExA(protseq : windows_core::PCSTR, maxcalls : u32, endpoint : windows_core::PCSTR, securitydescriptor : *const core::ffi::c_void, policy : *const RPC_POLICY) -> RPC_STATUS);
    unsafe {
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUseProtseqEpExW(protseq : windows_core::PCWSTR, maxcalls : u32, endpoint : windows_core::PCWSTR, securitydescriptor : *const core::ffi::c_void, policy : *const RPC_POLICY) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcServerUseProtseqEpW<P0, P2>(
    protseq: P0,
    maxcalls: u32,
    endpoint: P2,
    securitydescriptor: Option<*const core::ffi::c_void>,
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUseProtseqEpW(protseq : windows_core::PCWSTR, maxcalls : u32, endpoint : windows_core::PCWSTR, securitydescriptor : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUseProtseqExA(protseq : windows_core::PCSTR, maxcalls : u32, securitydescriptor : *const core::ffi::c_void, policy : *const RPC_POLICY) -> RPC_STATUS);
    unsafe {
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUseProtseqExW(protseq : windows_core::PCWSTR, maxcalls : u32, securitydescriptor : *const core::ffi::c_void, policy : *const RPC_POLICY) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcServerUseProtseqIfA<P0>(
    protseq: P0,
    maxcalls: u32,
    ifspec: *const core::ffi::c_void,
    securitydescriptor: Option<*const core::ffi::c_void>,
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUseProtseqIfA(protseq : windows_core::PCSTR, maxcalls : u32, ifspec : *const core::ffi::c_void, securitydescriptor : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcServerUseProtseqIfExA<P0>(
    protseq: P0,
    maxcalls: u32,
    ifspec: *const core::ffi::c_void,
    securitydescriptor: Option<*const core::ffi::c_void>,
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUseProtseqIfExA(protseq : windows_core::PCSTR, maxcalls : u32, ifspec : *const core::ffi::c_void, securitydescriptor : *const core::ffi::c_void, policy : *const RPC_POLICY) -> RPC_STATUS);
    unsafe {
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUseProtseqIfExW(protseq : windows_core::PCWSTR, maxcalls : u32, ifspec : *const core::ffi::c_void, securitydescriptor : *const core::ffi::c_void, policy : *const RPC_POLICY) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcServerUseProtseqIfW<P0>(
    protseq: P0,
    maxcalls: u32,
    ifspec: *const core::ffi::c_void,
    securitydescriptor: Option<*const core::ffi::c_void>,
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUseProtseqIfW(protseq : windows_core::PCWSTR, maxcalls : u32, ifspec : *const core::ffi::c_void, securitydescriptor : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcServerUseProtseqW(protseq : windows_core::PCWSTR, maxcalls : u32, securitydescriptor : *const core::ffi::c_void) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcSmDestroyClientContext(
    contexthandle: *const *const core::ffi::c_void,
) -> RPC_STATUS {
...
pub unsafe fn RpcSsContextLockExclusive(
    serverbindinghandle: Option<*const core::ffi::c_void>,
    ...
    unsafe {
        RpcSsContextLockExclusive(
            serverbindinghandle.unwrap_or(core::mem::zeroed()) as _,
            usercontext,
        )
    }
}
...
pub unsafe fn RpcSsContextLockShared(
    serverbindinghandle: *const core::ffi::c_void,
    usercontext: *const core::ffi::c_void,
) -> RPC_STATUS {
...
pub unsafe fn RpcSsGetContextBinding(
    contexthandle: *const core::ffi::c_void,
    binding: *mut *mut core::ffi::c_void,
) -> RPC_STATUS {
...
#[inline]
pub unsafe fn RpcStringBindingComposeA<P0, P1, P2, P3, P4>(
    objuuid: P0,
    protseq: P1,
    networkaddr: P2,
    endpoint: P3,
    options: P4,
    stringbinding: Option<*mut windows_core::PSTR>,
) -> RPC_STATUS
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
    ...
    P4: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcStringBindingComposeA(objuuid : windows_core::PCSTR, protseq : windows_core::PCSTR, networkaddr : windows_core::PCSTR, endpoint : windows_core::PCSTR, options : windows_core::PCSTR, stringbinding : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe {
        RpcStringBindingComposeA(
            objuuid.param().abi(),
            protseq.param().abi(),
            networkaddr.param().abi(),
            endpoint.param().abi(),
            options.param().abi(),
            stringbinding.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn RpcStringBindingComposeW<P0, P1, P2, P3, P4>(
    ...
    endpoint: P3,
    options: P4,
    stringbinding: Option<*mut windows_core::PWSTR>,
) -> RPC_STATUS
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcStringBindingComposeW(objuuid : windows_core::PCWSTR, protseq : windows_core::PCWSTR, networkaddr : windows_core::PCWSTR, endpoint : windows_core::PCWSTR, options : windows_core::PCWSTR, stringbinding : *mut windows_core::PWSTR) -> RPC_STATUS);
    unsafe {
...
#[inline]
pub unsafe fn RpcStringBindingParseA<P0>(
    stringbinding: P0,
    objuuid: Option<*mut windows_core::PSTR>,
    protseq: Option<*mut windows_core::PSTR>,
    networkaddr: Option<*mut windows_core::PSTR>,
    endpoint: Option<*mut windows_core::PSTR>,
    networkoptions: Option<*mut windows_core::PSTR>,
) -> RPC_STATUS
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcStringBindingParseA(stringbinding : windows_core::PCSTR, objuuid : *mut windows_core::PSTR, protseq : *mut windows_core::PSTR, networkaddr : *mut windows_core::PSTR, endpoint : *mut windows_core::PSTR, networkoptions : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe {
        RpcStringBindingParseA(
            stringbinding.param().abi(),
            objuuid.unwrap_or(core::mem::zeroed()) as _,
            protseq.unwrap_or(core::mem::zeroed()) as _,
            networkaddr.unwrap_or(core::mem::zeroed()) as _,
            endpoint.unwrap_or(core::mem::zeroed()) as _,
            networkoptions.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn RpcStringBindingParseW<P0>(
    stringbinding: P0,
    objuuid: Option<*mut windows_core::PWSTR>,
    protseq: Option<*mut windows_core::PWSTR>,
    networkaddr: Option<*mut windows_core::PWSTR>,
    endpoint: Option<*mut windows_core::PWSTR>,
    networkoptions: Option<*mut windows_core::PWSTR>,
) -> RPC_STATUS
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn RpcStringBindingParseW(stringbinding : windows_core::PCWSTR, objuuid : *mut windows_core::PWSTR, protseq : *mut windows_core::PWSTR, networkaddr : *mut windows_core::PWSTR, endpoint : *mut windows_core::PWSTR, networkoptions : *mut windows_core::PWSTR) -> RPC_STATUS);
    unsafe {
...
pub unsafe fn RpcStringFreeA(string: *mut windows_core::PSTR) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcStringFreeA(string : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe { RpcStringFreeA(string as _) }
}
#[inline]
pub unsafe fn RpcStringFreeW(string: *mut windows_core::PWSTR) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn RpcStringFreeW(string : *mut windows_core::PWSTR) -> RPC_STATUS);
...
pub unsafe fn UuidCompare(
    uuid1: *const windows_core::GUID,
    uuid2: *const windows_core::GUID,
    status: *mut RPC_STATUS,
) -> i32 {
    windows_link::link!("rpcrt4.dll" "system" fn UuidCompare(uuid1 : *const windows_core::GUID, uuid2 : *const windows_core::GUID, status : *mut RPC_STATUS) -> i32);
    unsafe { UuidCompare(uuid1, uuid2, status as _) }
}
#[inline]
pub unsafe fn UuidCreate(uuid: *mut windows_core::GUID) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn UuidCreate(uuid : *mut windows_core::GUID) -> RPC_STATUS);
    unsafe { UuidCreate(uuid as _) }
}
#[inline]
pub unsafe fn UuidCreateNil(niluuid: *mut windows_core::GUID) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn UuidCreateNil(niluuid : *mut windows_core::GUID) -> RPC_STATUS);
    unsafe { UuidCreateNil(niluuid as _) }
}
#[inline]
pub unsafe fn UuidCreateSequential(uuid: *mut windows_core::GUID) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn UuidCreateSequential(uuid : *mut windows_core::GUID) -> RPC_STATUS);
...
pub unsafe fn UuidEqual(
    ...
    windows_link::link!("rpcrt4.dll" "system" fn UuidEqual(uuid1 : *const windows_core::GUID, uuid2 : *const windows_core::GUID, status : *mut RPC_STATUS) -> i32);
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn UuidFromStringA(stringuuid : windows_core::PCSTR, uuid : *mut windows_core::GUID) -> RPC_STATUS);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("rpcrt4.dll" "system" fn UuidFromStringW(stringuuid : windows_core::PCWSTR, uuid : *mut windows_core::GUID) -> RPC_STATUS);
...
pub unsafe fn UuidHash(uuid: *const windows_core::GUID, status: *mut RPC_STATUS) -> u16 {
    windows_link::link!("rpcrt4.dll" "system" fn UuidHash(uuid : *const windows_core::GUID, status : *mut RPC_STATUS) -> u16);
    unsafe { UuidHash(uuid, status as _) }
}
#[inline]
pub unsafe fn UuidIsNil(uuid: *const windows_core::GUID, status: *mut RPC_STATUS) -> i32 {
    windows_link::link!("rpcrt4.dll" "system" fn UuidIsNil(uuid : *const windows_core::GUID, status : *mut RPC_STATUS) -> i32);
    unsafe { UuidIsNil(uuid, status as _) }
}
#[inline]
pub unsafe fn UuidToStringA(
    uuid: *const windows_core::GUID,
    stringuuid: *mut windows_core::PSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn UuidToStringA(uuid : *const windows_core::GUID, stringuuid : *mut windows_core::PSTR) -> RPC_STATUS);
    unsafe { UuidToStringA(uuid, stringuuid as _) }
}
#[inline]
pub unsafe fn UuidToStringW(
    uuid: *const windows_core::GUID,
    stringuuid: *mut windows_core::PWSTR,
) -> RPC_STATUS {
    windows_link::link!("rpcrt4.dll" "system" fn UuidToStringW(uuid : *const windows_core::GUID, stringuuid : *mut windows_core::PWSTR) -> RPC_STATUS);
...
pub type CS_TAG_GETTING_ROUTINE = Option<
    unsafe extern "system" fn(
        hbinding: *mut core::ffi::c_void,
        fserverside: i32,
...
>;
pub type CS_TYPE_FROM_NETCS_ROUTINE = Option<
    unsafe extern "system" fn(
        hbinding: *mut core::ffi::c_void,
        ...
        plocaldata: *mut core::ffi::c_void,
        pullocaldatalength: *mut u32,
        pstatus: *mut u32,
    ),
>;
pub type CS_TYPE_LOCAL_SIZE_ROUTINE = Option<
    unsafe extern "system" fn(
        hbinding: *mut core::ffi::c_void,
        ulnetworkcodeset: u32,
...
>;
pub type CS_TYPE_NET_SIZE_ROUTINE = Option<
    unsafe extern "system" fn(
        hbinding: *mut core::ffi::c_void,
        ulnetworkcodeset: u32,
        ullocalbuffersize: u32,
...
>;
pub type CS_TYPE_TO_NETCS_ROUTINE = Option<
    unsafe extern "system" fn(
        hbinding: *mut core::ffi::c_void,
        ulnetworkcodeset: u32,
        plocaldata: *mut core::ffi::c_void,
...
pub type GENERIC_BINDING_ROUTINE =
    Option<unsafe extern "system" fn(param0: *mut core::ffi::c_void) -> *mut core::ffi::c_void>;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub type GENERIC_UNBIND_ROUTINE =
    Option<unsafe extern "system" fn(param0: *mut core::ffi::c_void, param1: *mut u8)>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub type I_RpcFreeCalloutStateFn =
    Option<unsafe extern "system" fn(calloutstate: *mut RDR_CALLOUT_STATE)>;
pub type I_RpcPerformCalloutFn = Option<
    unsafe extern "system" fn(
...
pub type I_RpcProxyFilterIfFn = Option<
    unsafe extern "system" fn(
        context: *const core::ffi::c_void,
        ifuuid: *const windows_core::GUID,
        ifmajorversion: u16,
        fallow: *mut i32,
    ) -> RPC_STATUS,
>;
pub type I_RpcProxyGetClientAddressFn = Option<
    unsafe extern "system" fn(
        context: *mut core::ffi::c_void,
        buffer: windows_core::PCSTR,
        bufferlength: *mut u32,
    ) -> RPC_STATUS,
>;
pub type I_RpcProxyGetClientSessionAndResourceUUID = Option<
    unsafe extern "system" fn(
        context: *const core::ffi::c_void,
        sessionidpresent: *mut i32,
        sessionid: *mut windows_core::GUID,
        resourceidpresent: *mut i32,
        resourceid: *mut windows_core::GUID,
    ) -> RPC_STATUS,
>;
pub type I_RpcProxyGetConnectionTimeoutFn =
    Option<unsafe extern "system" fn(connectiontimeout: *mut u32) -> RPC_STATUS>;
pub type I_RpcProxyIsValidMachineFn = Option<
    unsafe extern "system" fn(
        machine: windows_core::PCWSTR,
        dotmachine: windows_core::PCWSTR,
        portnumber: u32,
    ) -> RPC_STATUS,
>;
pub type I_RpcProxyUpdatePerfCounterBackendServerFn =
    Option<unsafe extern "system" fn(machinename: *const u16, isconnectevent: i32)>;
pub type I_RpcProxyUpdatePerfCounterFn =
    Option<unsafe extern "system" fn(counter: RpcPerfCounters, modifytrend: i32, size: u32)>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
#[cfg(feature = "Win32_System_IO")]
pub type PFN_RPCNOTIFICATION_ROUTINE = Option<
    unsafe extern "system" fn(
        pasync: *mut RPC_ASYNC_STATE,
        context: *mut core::ffi::c_void,
...
>;
pub type PFN_RPC_ALLOCATE =
    Option<unsafe extern "system" fn(param0: usize) -> *mut core::ffi::c_void>;
...
pub type PRPC_RUNDOWN =
    Option<unsafe extern "system" fn(associationcontext: *mut core::ffi::c_void)>;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub type RPCLT_PDU_FILTER_FUNC = Option<
    unsafe extern "system" fn(buffer: *mut core::ffi::c_void, bufferlength: u32, fdatagram: i32),
>;
...
pub type RPC_AUTH_KEY_RETRIEVAL_FN = Option<
    unsafe extern "system" fn(
        arg: *const core::ffi::c_void,
        serverprincname: windows_core::PCWSTR,
        keyver: u32,
...
pub type RPC_BLOCKING_FN = Option<
    unsafe extern "system" fn(
        hwnd: *mut core::ffi::c_void,
        context: *mut core::ffi::c_void,
        hsyncevent: *mut core::ffi::c_void,
    ) -> RPC_STATUS,
>;
...
pub type RPC_CLIENT_ALLOC =
    Option<unsafe extern "system" fn(size: usize) -> *mut core::ffi::c_void>;
...
pub type RPC_FORWARD_FUNCTION = Option<
    unsafe extern "system" fn(
        interfaceid: *mut windows_core::GUID,
        interfaceversion: *mut RPC_VERSION,
        objectid: *mut windows_core::GUID,
        rpcpro: *mut u8,
        ppdestendpoint: *mut *mut core::ffi::c_void,
    ) -> RPC_STATUS,
>;
pub const RPC_FW_IF_FLAG_DCOM: u32 = 1u32;
pub type RPC_HTTP_PROXY_FREE_STRING =
    Option<unsafe extern "system" fn(string: windows_core::PCWSTR)>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub type RPC_IF_CALLBACK_FN = Option<
    unsafe extern "system" fn(
        interfaceuuid: *const core::ffi::c_void,
        context: *const core::ffi::c_void,
    ) -> RPC_STATUS,
>;
#[repr(C)]
...
pub type RPC_INTERFACE_GROUP_IDLE_CALLBACK_FN = Option<
    unsafe extern "system" fn(
        ifgroup: *const core::ffi::c_void,
        idlecallbackcontext: *const core::ffi::c_void,
        isgroupidle: u32,
...
pub type RPC_MGMT_AUTHORIZATION_FN = Option<
    unsafe extern "system" fn(
        clientbinding: *const core::ffi::c_void,
...
pub type RPC_NEW_HTTP_PROXY_CHANNEL = Option<
    unsafe extern "system" fn(
        redirectorstage: RPC_HTTP_REDIRECTOR_STAGE,
        servername: windows_core::PCWSTR,
        serverport: windows_core::PCWSTR,
        remoteuser: windows_core::PCWSTR,
        authtype: windows_core::PCWSTR,
        resourceuuid: *mut core::ffi::c_void,
        sessionid: *mut core::ffi::c_void,
        interface: *const core::ffi::c_void,
        reserved: *const core::ffi::c_void,
        flags: u32,
        newservername: *mut windows_core::PWSTR,
        newserverport: *mut windows_core::PWSTR,
    ) -> RPC_STATUS,
>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub type RPC_OBJECT_INQ_FN = Option<
    unsafe extern "system" fn(
        objectuuid: *const windows_core::GUID,
        typeuuid: *mut windows_core::GUID,
        status: *mut RPC_STATUS,
    ),
>;
#[repr(C)]
...
pub type USER_MARSHAL_FREEING_ROUTINE =
    Option<unsafe extern "system" fn(param0: *mut u32, param1: *mut core::ffi::c_void)>;
pub type USER_MARSHAL_MARSHALLING_ROUTINE = Option<
    unsafe extern "system" fn(
        param0: *mut u32,
        param1: *mut u8,
...
pub type USER_MARSHAL_SIZING_ROUTINE = Option<
    unsafe extern "system" fn(param0: *mut u32, param1: u32, param2: *mut core::ffi::c_void) -> u32,
>;
pub type USER_MARSHAL_UNMARSHALLING_ROUTINE = Option<
    unsafe extern "system" fn(
        param0: *mut u32,
        param1: *mut u8,
        param2: *mut core::ffi::c_void,

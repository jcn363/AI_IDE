...
{
    windows_link::link!("dxcompiler.dll" "system" fn DxcCreateInstance(rclsid : *const windows_core::GUID, riid : *const windows_core::GUID, ppv : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
...
where
    ...
    T: windows_core::Interface,
{
    windows_link::link!("dxcompiler.dll" "system" fn DxcCreateInstance2(pmalloc : * mut core::ffi::c_void, rclsid : *const windows_core::GUID, riid : *const windows_core::GUID, ppv : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    let mut result__ = core::ptr::null_mut();
    unsafe {
        DxcCreateInstance2(pmalloc.param().abi(), rclsid, &T::IID, &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
pub const CLSID_DxcAssembler: windows_core::GUID =
    windows_core::GUID::from_u128(0xd728db68_f903_4f80_94cd_dccf76ec7151);
pub const CLSID_DxcCompiler: windows_core::GUID =
    windows_core::GUID::from_u128(0x73e22d93_e6ce_47f3_b5bf_f0664f39c1b0);
pub const CLSID_DxcCompilerArgs: windows_core::GUID =
    windows_core::GUID::from_u128(0x3e56ae82_224d_470f_a1a1_fe3016ee9f9d);
pub const CLSID_DxcContainerBuilder: windows_core::GUID =
    windows_core::GUID::from_u128(0x94134294_411f_4574_b4d0_8741e25240d2);
...
pub const CLSID_DxcDiaDataSource: windows_core::GUID =
    windows_core::GUID::from_u128(0xcd1f6b73_2ab0_484d_8edc_ebe7a43ca09f);
pub const CLSID_DxcLibrary: windows_core::GUID =
    windows_core::GUID::from_u128(0x6245d6af_66e0_48fd_80b4_4d271796748c);
pub const CLSID_DxcLinker: windows_core::GUID =
    windows_core::GUID::from_u128(0xef6a8087_b0ea_4d56_9e45_d07e1a8b7806);
pub const CLSID_DxcOptimizer: windows_core::GUID =
    windows_core::GUID::from_u128(0xae2cd79f_cc22_453f_9b6b_b124e7a5204c);
pub const CLSID_DxcPdbUtils: windows_core::GUID =
    windows_core::GUID::from_u128(0x54621dfb_f2ce_457e_ae8c_ec355faeec7c);
pub const CLSID_DxcUtils: windows_core::GUID =
    windows_core::GUID::from_u128(0x6245d6af_66e0_48fd_80b4_4d271796748c);
pub const CLSID_DxcValidator: windows_core::GUID =
    windows_core::GUID::from_u128(0x8ca3e215_f728_4cf3_8cdd_88af917587a1);
pub const DXC_ARG_ALL_RESOURCES_BOUND: windows_core::PCWSTR =
    windows_core::w!("-all_resources_bound");
...
#[cfg(feature = "Win32_System_Com")]
pub type DxcCreateInstance2Proc = Option<
    unsafe extern "system" fn(
        pmalloc: windows_core::Ref<'_, super::super::super::System::Com::IMalloc>,
        rclsid: *const windows_core::GUID,
...
windows_core::imp::define_interface!(
    IDxcAssembler,
    IDxcAssembler_Vtbl,
    0x091f7a26_1c1f_4948_904b_e6e3a8a771d5
);
windows_core::imp::interface_hierarchy!(IDxcAssembler, windows_core::IUnknown);
impl IDxcAssembler {
    pub unsafe fn AssembleToContainer<P0>(
        &self,
        pshader: P0,
    ) -> windows_core::Result<IDxcOperationResult>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AssembleToContainer)(
...
pub struct IDxcAssembler_Vtbl {
    ...
    pub AssembleToContainer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub const fn new<Identity: IDxcAssembler_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                match IDxcAssembler_Impl::AssembleToContainer(
                    this,
        ...
        Self {
            ...
            AssembleToContainer: AssembleToContainer::<Identity, OFFSET>,
        }
    }
...
windows_core::imp::define_interface!(
    IDxcBlobUtf8,
    IDxcBlobUtf8_Vtbl,
    0x3da636c9_ba71_4024_a301_30cbf125305b
);
...
windows_core::imp::define_interface!(
    IDxcCompiler,
    IDxcCompiler_Vtbl,
    0x8c210bf3_011f_4422_8d70_6f9acb8db617
);
windows_core::imp::interface_hierarchy!(IDxcCompiler, windows_core::IUnknown);
impl IDxcCompiler {
    pub unsafe fn Compile<P0, P1, P2, P3, P8>(
        &self,
        psource: P0,
        psourcename: P1,
        pentrypoint: P2,
    ...
    pub unsafe fn Preprocess<P0, P1, P6>(
        &self,
        psource: P0,
        psourcename: P1,
        parguments: Option<&[windows_core::PCWSTR]>,
...
pub trait IDxcCompiler_Impl: windows_core::IUnknownImpl {
    fn Compile(
        &self,
        psource: windows_core::Ref<'_, IDxcBlob>,
        psourcename: &windows_core::PCWSTR,
        pentrypoint: &windows_core::PCWSTR,
        ptargetprofile: &windows_core::PCWSTR,
...
impl IDxcCompiler_Vtbl {
    pub const fn new<Identity: IDxcCompiler_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Compile<Identity: IDxcCompiler_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDxcCompiler_Impl::Compile(
                    this,
        ...
        unsafe extern "system" fn Preprocess<Identity: IDxcCompiler_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            psource: *mut core::ffi::c_void,
            psourcename: windows_core::PCWSTR,
            parguments: *const windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDxcCompiler_Impl::Preprocess(
                    this,
                    core::mem::transmute_copy(&psource),
                    core::mem::transmute(&psourcename),
                    core::mem::transmute_copy(&parguments),
        ...
        unsafe extern "system" fn Disassemble<Identity: IDxcCompiler_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            psource: *mut core::ffi::c_void,
            ppdisassembly: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    IDxcCompiler2,
    IDxcCompiler2_Vtbl,
    0xa005a9d9_b8bb_4594_b5c9_0e633bec4d37
);
...
impl IDxcCompiler2 {
    pub unsafe fn CompileWithDebug<P0, P1, P2, P3, P8>(
        &self,
        psource: P0,
        psourcename: P1,
        pentrypoint: P2,
        ...
        pdefines: &[DxcDefine],
        pincludehandler: P8,
        ppresult: *mut Option<IDxcOperationResult>,
        ppdebugblobname: Option<*mut windows_core::PWSTR>,
        ppdebugblob: Option<*mut Option<IDxcBlob>>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<IDxcBlob>,
        P1: windows_core::Param<windows_core::PCWSTR>,
...
pub struct IDxcCompiler2_Vtbl {
    ...
    pub CompileWithDebug: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
pub trait IDxcCompiler2_Impl: IDxcCompiler_Impl {
    fn CompileWithDebug(
        ...
        definecount: u32,
        pincludehandler: windows_core::Ref<'_, IDxcIncludeHandler>,
        ppresult: windows_core::OutRef<'_, IDxcOperationResult>,
        ppdebugblobname: *mut windows_core::PWSTR,
        ppdebugblob: windows_core::OutRef<'_, IDxcBlob>,
    ) -> windows_core::Result<()>;
}
impl IDxcCompiler2_Vtbl {
    pub const fn new<Identity: IDxcCompiler2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CompileWithDebug<
        ...
        >(
            ...
            ppresult: *mut *mut core::ffi::c_void,
            ppdebugblobname: *mut windows_core::PWSTR,
            ppdebugblob: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: IDxcCompiler_Vtbl::new::<Identity, OFFSET>(),
            CompileWithDebug: CompileWithDebug::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x73effe2a_70dc_45f8_9690_eff64c02429d
);
...
impl IDxcCompilerArgs {
    pub unsafe fn GetArguments(&self) -> *mut windows_core::PCWSTR {
        unsafe {
            (windows_core::Interface::vtable(self).GetArguments)(windows_core::Interface::as_raw(
                self,
            ))
        }
    }
    ...
    pub unsafe fn AddArguments(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AddArguments)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(
                    parguments
                        .as_deref()
    ...
    pub unsafe fn AddArgumentsUTF8(
        &self,
        parguments: Option<&[windows_core::PCSTR]>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddArgumentsUTF8)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(
                    parguments
                        .as_deref()
    ...
    pub unsafe fn AddDefines(&self, pdefines: &[DxcDefine]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddDefines)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pdefines.as_ptr()),
                pdefines.len().try_into().unwrap(),
            )
...
pub struct IDxcCompilerArgs_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetArguments:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> *mut windows_core::PCWSTR,
    pub GetCount: unsafe extern "system" fn(*mut core::ffi::c_void) -> u32,
    pub AddArguments: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::PCWSTR,
        u32,
    ) -> windows_core::HRESULT,
    pub AddArgumentsUTF8: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::PCSTR,
        u32,
    ) -> windows_core::HRESULT,
    pub AddDefines: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const DxcDefine,
        u32,
    ) -> windows_core::HRESULT,
...
pub trait IDxcCompilerArgs_Impl: windows_core::IUnknownImpl {
    ...
    fn AddArgumentsUTF8(
        &self,
        parguments: *const windows_core::PCSTR,
        argcount: u32,
    ) -> windows_core::Result<()>;
...
impl IDxcCompilerArgs_Vtbl {
    pub const fn new<Identity: IDxcCompilerArgs_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetArguments<
        ...
        unsafe extern "system" fn GetCount<Identity: IDxcCompilerArgs_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> u32 {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn AddArguments<
            Identity: IDxcCompilerArgs_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcCompilerArgs_Impl::AddArguments(
                    this,
                    core::mem::transmute_copy(&parguments),
                    core::mem::transmute_copy(&argcount),
                )
        ...
        unsafe extern "system" fn AddArgumentsUTF8<
            Identity: IDxcCompilerArgs_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcCompilerArgs_Impl::AddArgumentsUTF8(
                    this,
                    core::mem::transmute_copy(&parguments),
                    core::mem::transmute_copy(&argcount),
                )
        ...
        unsafe extern "system" fn AddDefines<
            Identity: IDxcCompilerArgs_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcCompilerArgs_Impl::AddDefines(
                    this,
                    core::mem::transmute_copy(&pdefines),
                    core::mem::transmute_copy(&definecount),
                )
...
windows_core::imp::define_interface!(
    ...
    0x334b1f50_2292_4b35_99a1_25588d8c17fe
);
...
impl IDxcContainerBuilder {
        ...
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Load)(
                windows_core::Interface::as_raw(self),
                pdxilcontainerheader.param().abi(),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn RemovePart(&self, fourcc: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemovePart)(
                windows_core::Interface::as_raw(self),
                fourcc,
            )
            .ok()
    ...
    pub unsafe fn SerializeContainer(&self) -> windows_core::Result<IDxcOperationResult> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SerializeContainer)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IDxcContainerBuilder_Vtbl {
    ...
    pub SerializeContainer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IDxcContainerBuilder_Impl: windows_core::IUnknownImpl {
    fn Load(
        &self,
        pdxilcontainerheader: windows_core::Ref<'_, IDxcBlob>,
    ) -> windows_core::Result<()>;
    fn AddPart(
        &self,
        fourcc: u32,
...
impl IDxcContainerBuilder_Vtbl {
    pub const fn new<Identity: IDxcContainerBuilder_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Load<Identity: IDxcContainerBuilder_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdxilcontainerheader: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcContainerBuilder_Impl::Load(
                    this,
                    core::mem::transmute_copy(&pdxilcontainerheader),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcContainerBuilder_Impl::AddPart(
                    this,
                    core::mem::transmute_copy(&fourcc),
                    core::mem::transmute_copy(&psource),
                )
                .into()
            }
        }
        unsafe extern "system" fn RemovePart<
            Identity: IDxcContainerBuilder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcContainerBuilder_Impl::RemovePart(this, core::mem::transmute_copy(&fourcc))
                    .into()
            }
        }
        unsafe extern "system" fn SerializeContainer<
            Identity: IDxcContainerBuilder_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x319b37a2_a5c2_494a_a5de_4801b2faf989
);
...
impl IDxcExtraOutputs {
    pub unsafe fn GetOutputCount(&self) -> u32 {
        unsafe {
            (windows_core::Interface::vtable(self).GetOutputCount)(windows_core::Interface::as_raw(
                self,
            ))
        }
    }
    pub unsafe fn GetOutput<T>(
        &self,
        uindex: u32,
        ppoutputtype: Option<*mut Option<IDxcBlobUtf16>>,
        ppoutputname: Option<*mut Option<IDxcBlobUtf16>>,
        ...
        T: windows_core::Interface,
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetOutput)(
                ...
                ppoutputtype.unwrap_or(core::mem::zeroed()) as _,
                ppoutputname.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
...
pub trait IDxcExtraOutputs_Impl: windows_core::IUnknownImpl {
    ...
    fn GetOutput(
        ...
        iid: *const windows_core::GUID,
        ppvobject: *mut *mut core::ffi::c_void,
        ppoutputtype: windows_core::OutRef<'_, IDxcBlobUtf16>,
...
impl IDxcExtraOutputs_Vtbl {
    pub const fn new<Identity: IDxcExtraOutputs_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            iid: *const windows_core::GUID,
            ppvobject: *mut *mut core::ffi::c_void,
            ppoutputtype: *mut *mut core::ffi::c_void,
            ppoutputname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcExtraOutputs_Impl::GetOutput(
                    this,
                    core::mem::transmute_copy(&uindex),
                    core::mem::transmute_copy(&iid),
                    core::mem::transmute_copy(&ppvobject),
                    core::mem::transmute_copy(&ppoutputtype),
...
impl IDxcLibrary {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateBlobWithEncodingOnMalloc<P1>(
        &self,
        ptext: *const core::ffi::c_void,
        pimalloc: P1,
        size: u32,
...
pub trait IDxcLibrary_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateBlobWithEncodingOnMalloc(
        &self,
        ptext: *const core::ffi::c_void,
        pimalloc: windows_core::Ref<'_, super::super::super::System::Com::IMalloc>,
        size: u32,
        codepage: DXC_CP,
    ) -> windows_core::Result<IDxcBlobEncoding>;
...
impl IDxcLibrary_Vtbl {
    pub const fn new<Identity: IDxcLibrary_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetMalloc<Identity: IDxcLibrary_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDxcLibrary_Impl::CreateBlobWithEncodingOnMalloc(
                    this,
                    core::mem::transmute_copy(&ptext),
                    core::mem::transmute_copy(&pimalloc),
                    core::mem::transmute_copy(&size),
                    core::mem::transmute_copy(&codepage),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateStreamFromBlobReadOnly<
            Identity: IDxcLibrary_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDxcLibrary_Impl::CreateStreamFromBlobReadOnly(
                    this,
                    core::mem::transmute_copy(&pblob),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetBlobAsUtf16<
            Identity: IDxcLibrary_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IDxcLinker,
    IDxcLinker_Vtbl,
    0xf1b5be2a_62dd_4327_a1c2_42ac1e1e78e6
);
...
impl IDxcLinker {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RegisterLibrary)(
                windows_core::Interface::as_raw(self),
                plibname.param().abi(),
                plib.param().abi(),
            )
    ...
    pub unsafe fn Link<P0, P1>(
        &self,
        pentryname: P0,
        ptargetprofile: P1,
        plibnames: &[windows_core::PCWSTR],
        parguments: Option<&[windows_core::PCWSTR]>,
    ) -> windows_core::Result<IDxcOperationResult>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).Link)(
                windows_core::Interface::as_raw(self),
                pentryname.param().abi(),
                ptargetprofile.param().abi(),
                core::mem::transmute(plibnames.as_ptr()),
                plibnames.len().try_into().unwrap(),
                core::mem::transmute(
                    parguments
                        .as_deref()
                        .map_or(core::ptr::null(), |slice| slice.as_ptr()),
...
pub struct IDxcLinker_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub RegisterLibrary: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IDxcLinker_Impl: windows_core::IUnknownImpl {
    fn RegisterLibrary(
        &self,
        plibname: &windows_core::PCWSTR,
        plib: windows_core::Ref<'_, IDxcBlob>,
    ) -> windows_core::Result<()>;
    fn Link(
        &self,
        pentryname: &windows_core::PCWSTR,
        ptargetprofile: &windows_core::PCWSTR,
        plibnames: *const windows_core::PCWSTR,
        libcount: u32,
        parguments: *const windows_core::PCWSTR,
        argcount: u32,
    ) -> windows_core::Result<IDxcOperationResult>;
...
impl IDxcLinker_Vtbl {
    pub const fn new<Identity: IDxcLinker_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RegisterLibrary<
            Identity: IDxcLinker_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            plibname: windows_core::PCWSTR,
            plib: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcLinker_Impl::RegisterLibrary(
                    this,
                    core::mem::transmute(&plibname),
                    core::mem::transmute_copy(&plib),
                )
                .into()
            }
        }
        unsafe extern "system" fn Link<Identity: IDxcLinker_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pentryname: windows_core::PCWSTR,
            ptargetprofile: windows_core::PCWSTR,
            plibnames: *const windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDxcLinker_Impl::Link(
                    this,
                    core::mem::transmute(&pentryname),
                    core::mem::transmute(&ptargetprofile),
                    core::mem::transmute_copy(&plibnames),
                    core::mem::transmute_copy(&libcount),
                    core::mem::transmute_copy(&parguments),
                    core::mem::transmute_copy(&argcount),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    IDxcOptimizer,
    IDxcOptimizer_Vtbl,
    0x25740e2e_9cba_401b_9119_4fb42f39f270
);
...
impl IDxcOptimizer {
    pub unsafe fn GetAvailablePassCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAvailablePassCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetAvailablePass(&self, index: u32) -> windows_core::Result<IDxcOptimizerPass> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAvailablePass)(
                windows_core::Interface::as_raw(self),
                index,
                &mut result__,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RunOptimizer)(
                windows_core::Interface::as_raw(self),
                pblob.param().abi(),
                core::mem::transmute(ppoptions.as_ptr()),
                ppoptions.len().try_into().unwrap(),
                core::mem::transmute(poutputmodule),
                ppoutputtext.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
...
pub struct IDxcOptimizer_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetAvailablePassCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetAvailablePass: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RunOptimizer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const windows_core::PCWSTR,
        u32,
...
pub trait IDxcOptimizer_Impl: windows_core::IUnknownImpl {
    ...
    fn RunOptimizer(
        &self,
        pblob: windows_core::Ref<'_, IDxcBlob>,
        ppoptions: *const windows_core::PCWSTR,
        optioncount: u32,
        poutputmodule: windows_core::OutRef<'_, IDxcBlob>,
        ppoutputtext: windows_core::OutRef<'_, IDxcBlobEncoding>,
    ) -> windows_core::Result<()>;
}
impl IDxcOptimizer_Vtbl {
    pub const fn new<Identity: IDxcOptimizer_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetAvailablePassCount<
        ...
        unsafe extern "system" fn GetAvailablePass<
            Identity: IDxcOptimizer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn RunOptimizer<
            Identity: IDxcOptimizer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            ppoptions: *const windows_core::PCWSTR,
            optioncount: u32,
            poutputmodule: *mut *mut core::ffi::c_void,
            ppoutputtext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcOptimizer_Impl::RunOptimizer(
                    this,
                    core::mem::transmute_copy(&pblob),
                    core::mem::transmute_copy(&ppoptions),
                    core::mem::transmute_copy(&optioncount),
                    core::mem::transmute_copy(&poutputmodule),
                    core::mem::transmute_copy(&ppoutputtext),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xae2cd79f_cc22_453f_9b6b_b124e7a5204c
);
...
impl IDxcOptimizerPass {
    pub unsafe fn GetOptionName(&self) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOptionName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetOptionArgCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOptionArgCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetOptionArgName(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOptionArgName)(
                windows_core::Interface::as_raw(self),
                argindex,
                &mut result__,
            )
    ...
    pub unsafe fn GetOptionArgDescription(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOptionArgDescription)(
                windows_core::Interface::as_raw(self),
                argindex,
                &mut result__,
            )
...
pub struct IDxcOptimizerPass_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetOptionName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    ...
    pub GetOptionArgCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetOptionArgName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetOptionArgDescription: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut windows_core::PWSTR,
    ) -> windows_core::HRESULT,
...
impl IDxcOptimizerPass_Vtbl {
    pub const fn new<Identity: IDxcOptimizerPass_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetOptionName<
            Identity: IDxcOptimizerPass_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppresult: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetOptionArgCount<
            Identity: IDxcOptimizerPass_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetOptionArgName<
            Identity: IDxcOptimizerPass_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDxcOptimizerPass_Impl::GetOptionArgName(
                    this,
                    core::mem::transmute_copy(&argindex),
                ) {
                    Ok(ok__) => {
                        ppresult.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn GetOptionArgDescription<
            Identity: IDxcOptimizerPass_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDxcOptimizerPass_Impl::GetOptionArgDescription(
                    this,
                    core::mem::transmute_copy(&argindex),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    IDxcPdbUtils,
    IDxcPdbUtils_Vtbl,
    0xe6c9647e_9d6a_4c3b_b94c_524b5a6c343d
);
...
impl IDxcPdbUtils {
    ...
    pub unsafe fn GetSourceCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSourceCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetSourceName(&self, uindex: u32) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSourceName)(
                windows_core::Interface::as_raw(self),
                uindex,
                &mut result__,
            )
    ...
    pub unsafe fn GetFlagCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFlagCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetFlag(&self, uindex: u32) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFlag)(
                windows_core::Interface::as_raw(self),
                uindex,
                &mut result__,
            )
    ...
    pub unsafe fn GetArgCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetArgCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetArg(&self, uindex: u32) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetArg)(
                windows_core::Interface::as_raw(self),
                uindex,
                &mut result__,
            )
    ...
    pub unsafe fn GetArgPairCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetArgPairCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetArgPair(
        &self,
        uindex: u32,
        pname: *mut windows_core::BSTR,
        pvalue: *mut windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetArgPair)(
                windows_core::Interface::as_raw(self),
                uindex,
    ...
    pub unsafe fn GetDefineCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDefineCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetDefine(&self, uindex: u32) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDefine)(
                windows_core::Interface::as_raw(self),
                uindex,
                &mut result__,
            )
    ...
    pub unsafe fn GetTargetProfile(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTargetProfile)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn GetEntryPoint(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEntryPoint)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn GetMainFileName(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMainFileName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn GetFullPDB(&self) -> windows_core::Result<IDxcBlob> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFullPDB)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetCompiler)(
                windows_core::Interface::as_raw(self),
                pcompiler.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn CompileForFullPDB(&self) -> windows_core::Result<IDxcResult> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CompileForFullPDB)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn OverrideArgs(
        &self,
        pargpairs: *const DxcArgPair,
        unumargpairs: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).OverrideArgs)(
                windows_core::Interface::as_raw(self),
                pargpairs,
                unumargpairs,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OverrideRootSignature)(
                windows_core::Interface::as_raw(self),
                prootsignature.param().abi(),
            )
            .ok()
        }
    }
...
pub struct IDxcPdbUtils_Vtbl {
    ...
    pub GetSourceName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetFlagCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetFlag: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetArgCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetArg: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetArgPairCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetArgPair: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    pub GetDefineCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetDefine: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetTargetProfile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetEntryPoint: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetMainFileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GetFullPDB: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetCompiler: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CompileForFullPDB: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OverrideArgs: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const DxcArgPair,
        u32,
    ) -> windows_core::HRESULT,
    pub OverrideRootSignature: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
}
pub trait IDxcPdbUtils_Impl: windows_core::IUnknownImpl {
    ...
    fn SetCompiler(
        &self,
        pcompiler: windows_core::Ref<'_, IDxcCompiler3>,
    ) -> windows_core::Result<()>;
    ...
    fn OverrideRootSignature(
        &self,
        prootsignature: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
}
impl IDxcPdbUtils_Vtbl {
    pub const fn new<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Load<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppdbordxil: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetSource<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uindex: u32,
            ppresult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetSourceName<
            Identity: IDxcPdbUtils_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetFlagCount<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pcount: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetFlag<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uindex: u32,
            presult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetArgCount<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pcount: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetArg<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uindex: u32,
            presult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetArgPairCount<
            Identity: IDxcPdbUtils_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetArgPair<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uindex: u32,
        ...
        unsafe extern "system" fn GetDefineCount<
            Identity: IDxcPdbUtils_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetDefine<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uindex: u32,
            presult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetTargetProfile<
            Identity: IDxcPdbUtils_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetEntryPoint<
            Identity: IDxcPdbUtils_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetMainFileName<
            Identity: IDxcPdbUtils_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetHash<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppresult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetName<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            presult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn IsFullPDB<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::BOOL {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetFullPDB<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppfullpdb: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            ppversioninfo: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetCompiler<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pcompiler: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CompileForFullPDB<
            Identity: IDxcPdbUtils_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn OverrideArgs<Identity: IDxcPdbUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pargpairs: *const DxcArgPair,
            unumargpairs: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcPdbUtils_Impl::OverrideArgs(
                    this,
                    core::mem::transmute_copy(&pargpairs),
                    core::mem::transmute_copy(&unumargpairs),
                )
                .into()
            }
        }
        unsafe extern "system" fn OverrideRootSignature<
            Identity: IDxcPdbUtils_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcPdbUtils_Impl::OverrideRootSignature(
                    this,
                    core::mem::transmute(&prootsignature),
                )
                .into()
            }
        }
...
impl IDxcUtils {
        ...
        P1: windows_core::Param<super::super::super::System::Com::IMalloc>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MoveToBlob)(
                windows_core::Interface::as_raw(self),
                pdata,
                pimalloc.param().abi(),
                size,
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateReadOnlyStreamFromBlob<P0>(
        &self,
        pblob: P0,
    ) -> windows_core::Result<super::super::super::System::Com::IStream>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateReadOnlyStreamFromBlob)(
                windows_core::Interface::as_raw(self),
                pblob.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn BuildArguments<P0, P1, P2>(
        &self,
        psourcename: P0,
        pentrypoint: P1,
        ptargetprofile: P2,
        parguments: Option<&[windows_core::PCWSTR]>,
        pdefines: &[DxcDefine],
    ) -> windows_core::Result<IDxcCompilerArgs>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BuildArguments)(
                windows_core::Interface::as_raw(self),
                psourcename.param().abi(),
                pentrypoint.param().abi(),
                ptargetprofile.param().abi(),
...
pub struct IDxcUtils_Vtbl {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub MoveToBlob: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub CreateReadOnlyStreamFromBlob: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub BuildArguments: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
pub trait IDxcUtils_Impl: windows_core::IUnknownImpl {
    ...
    fn GetBlobAsUtf8(
        &self,
        pblob: windows_core::Ref<'_, IDxcBlob>,
    ) -> windows_core::Result<IDxcBlobUtf8>;
    fn GetBlobAsUtf16(
        &self,
        pblob: windows_core::Ref<'_, IDxcBlob>,
...
impl IDxcUtils_Vtbl {
    pub const fn new<Identity: IDxcUtils_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn MoveToBlob<Identity: IDxcUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdata: *const core::ffi::c_void,
            pimalloc: *mut core::ffi::c_void,
            size: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDxcUtils_Impl::MoveToBlob(
                    this,
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&pimalloc),
                    core::mem::transmute_copy(&size),
        ...
        unsafe extern "system" fn CreateReadOnlyStreamFromBlob<
            Identity: IDxcUtils_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDxcUtils_Impl::CreateReadOnlyStreamFromBlob(
                    this,
                    core::mem::transmute_copy(&pblob),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetBlobAsUtf8<Identity: IDxcUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pblob: *mut core::ffi::c_void,
            pblobencoding: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetBlobAsUtf16<Identity: IDxcUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pblob: *mut core::ffi::c_void,
            pblobencoding: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn BuildArguments<Identity: IDxcUtils_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            psourcename: windows_core::PCWSTR,
            pentrypoint: windows_core::PCWSTR,
            ptargetprofile: windows_core::PCWSTR,
            ...
            pdefines: *const DxcDefine,
            definecount: u32,
            ppargs: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDxcUtils_Impl::BuildArguments(
                    this,
                    core::mem::transmute(&psourcename),
                    core::mem::transmute(&pentrypoint),
                    core::mem::transmute(&ptargetprofile),
...
windows_core::imp::define_interface!(
    IDxcValidator,
    IDxcValidator_Vtbl,
    0xa6e82bd2_1fd7_4826_9811_2857e797f49a
);
...
impl IDxcValidator_Vtbl {
    pub const fn new<Identity: IDxcValidator_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Validate<Identity: IDxcValidator_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pshader: *mut core::ffi::c_void,
            flags: u32,
            ppresult: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDxcValidator_Impl::Validate(
                    this,
                    core::mem::transmute_copy(&pshader),
...
windows_core::imp::define_interface!(
    IDxcValidator2,
    IDxcValidator2_Vtbl,
    0x458e1fd1_b1b2_4750_a6e1_9c10f03bed92
);
...
impl IDxcValidator2 {
    pub unsafe fn ValidateWithDebug<P0>(
        &self,
        pshader: P0,
        flags: u32,
        poptdebugbitcode: Option<*const DxcBuffer>,
    ) -> windows_core::Result<IDxcOperationResult>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ValidateWithDebug)(
                windows_core::Interface::as_raw(self),
                pshader.param().abi(),
                flags,
                poptdebugbitcode.unwrap_or(core::mem::zeroed()) as _,
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub struct IDxcValidator2_Vtbl {
    ...
    pub ValidateWithDebug: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const DxcBuffer,
    ...
    pub const fn new<Identity: IDxcValidator2_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDxcValidator2_Impl::ValidateWithDebug(
                    this,
                    core::mem::transmute_copy(&pshader),
                    core::mem::transmute_copy(&flags),
                    core::mem::transmute_copy(&poptdebugbitcode),
                ) {
                    Ok(ok__) => {
                        ppresult.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        Self {
            base__: IDxcValidator_Vtbl::new::<Identity, OFFSET>(),
            ValidateWithDebug: ValidateWithDebug::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xb04f5b50_2059_4f12_a8ff_a1e0cde1cc7e
);
    ...
    pub const fn new<Identity: IDxcVersionInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcVersionInfo_Impl::GetVersion(
                    this,
                    core::mem::transmute_copy(&pmajor),
                    core::mem::transmute_copy(&pminor),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetFlags<Identity: IDxcVersionInfo_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pflags: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    IDxcVersionInfo2,
    IDxcVersionInfo2_Vtbl,
    0xfb6904c4_42f0_4b62_9c46_983af7da7c83
);
...
impl IDxcVersionInfo2 {
    pub unsafe fn GetCommitInfo(
        &self,
        pcommitcount: *mut u32,
        pcommithash: *mut *mut i8,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetCommitInfo)(
                windows_core::Interface::as_raw(self),
                pcommitcount as _,
                pcommithash as _,
            )
...
pub struct IDxcVersionInfo2_Vtbl {
    ...
    pub GetCommitInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut *mut i8,
    ) -> windows_core::HRESULT,
...
impl IDxcVersionInfo2_Vtbl {
    pub const fn new<Identity: IDxcVersionInfo2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCommitInfo<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDxcVersionInfo2_Impl::GetCommitInfo(
                    this,
                    core::mem::transmute_copy(&pcommitcount),
                    core::mem::transmute_copy(&pcommithash),
                )
                .into()
            }
        }
        Self {
            base__: IDxcVersionInfo_Vtbl::new::<Identity, OFFSET>(),
            GetCommitInfo: GetCommitInfo::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x5e13e843_9d25_473c_9ad2_03b2d0b44b1e
);
...
impl IDxcVersionInfo3 {
    pub unsafe fn GetCustomVersionString(&self) -> windows_core::Result<*mut i8> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCustomVersionString)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
impl IDxcVersionInfo3_Vtbl {
    pub const fn new<Identity: IDxcVersionInfo3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCustomVersionString<
            Identity: IDxcVersionInfo3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pversionstring: *mut *mut i8,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetCustomVersionString: GetCustomVersionString::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {

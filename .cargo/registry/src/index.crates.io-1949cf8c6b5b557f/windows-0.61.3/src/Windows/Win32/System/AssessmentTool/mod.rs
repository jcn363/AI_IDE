pub const CAccessiblityWinSAT: windows_core::GUID =
    windows_core::GUID::from_u128(0x6e18f9c6_a3eb_495a_89b7_956482e19f7a);
pub const CInitiateWinSAT: windows_core::GUID =
    windows_core::GUID::from_u128(0x489331dc_f5e0_4528_9fda_45331bf4a571);
pub const CProvideWinSATVisuals: windows_core::GUID =
    windows_core::GUID::from_u128(0x9f377d7e_e551_44f8_9f94_9db392b03b7b);
pub const CQueryAllWinSAT: windows_core::GUID =
    windows_core::GUID::from_u128(0x05df8d13_c355_47f4_a11e_851b338cefb8);
pub const CQueryOEMWinSATCustomization: windows_core::GUID =
    windows_core::GUID::from_u128(0xc47a41b7_b729_424f_9af9_5cb3934f2dfa);
pub const CQueryWinSAT: windows_core::GUID =
    windows_core::GUID::from_u128(0xf3bdfad3_f276_49e9_9b17_c474f48f0764);
...
impl IAccessibleWinSAT {
    pub unsafe fn SetAccessiblityData<P0, P1, P2>(
        &self,
        wsname: P0,
        wsvalue: P1,
        wsdesc: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetAccessiblityData)(
...
pub struct IAccessibleWinSAT_Vtbl {
    ...
    pub SetAccessiblityData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
pub trait IAccessibleWinSAT_Impl: super::super::UI::Accessibility::IAccessible_Impl {
    fn SetAccessiblityData(
        &self,
        wsname: &windows_core::PCWSTR,
        wsvalue: &windows_core::PCWSTR,
        wsdesc: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
}
#[cfg(all(
    feature = "Win32_System_Com",
...
impl IAccessibleWinSAT_Vtbl {
    pub const fn new<Identity: IAccessibleWinSAT_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetAccessiblityData<
        ...
        >(
            ...
            unsafe {
                ...
                IAccessibleWinSAT_Impl::SetAccessiblityData(
                    this,
                    core::mem::transmute(&wsname),
                    core::mem::transmute(&wsvalue),
                    core::mem::transmute(&wsdesc),
                )
                .into()
            }
        }
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAccessibleWinSAT as windows_core::Interface>::IID
            ...
            || iid
                == &<super::super::UI::Accessibility::IAccessible as windows_core::Interface>::IID
    }
}
#[cfg(all(
    feature = "Win32_System_Com",
...
windows_core::imp::define_interface!(
    ...
    0xd983fc50_f5bf_49d5_b5ed_cccb18aa7fc1
);
windows_core::imp::interface_hierarchy!(IInitiateWinSATAssessment, windows_core::IUnknown);
impl IInitiateWinSATAssessment {
    pub unsafe fn InitiateAssessment<P0, P1>(
        &self,
        cmdline: P0,
        pcallbacks: P1,
        callerhwnd: Option<super::super::Foundation::HWND>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).InitiateAssessment)(
                windows_core::Interface::as_raw(self),
                cmdline.param().abi(),
                pcallbacks.param().abi(),
                callerhwnd.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn InitiateFormalAssessment<P0>(
        &self,
        pcallbacks: P0,
        callerhwnd: Option<super::super::Foundation::HWND>,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).InitiateFormalAssessment)(
                windows_core::Interface::as_raw(self),
                pcallbacks.param().abi(),
                callerhwnd.unwrap_or(core::mem::zeroed()) as _,
            )
    ...
    pub unsafe fn CancelAssessment(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CancelAssessment)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct IInitiateWinSATAssessment_Vtbl {
    ...
    pub InitiateAssessment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut core::ffi::c_void,
        super::super::Foundation::HWND,
    ) -> windows_core::HRESULT,
    pub InitiateFormalAssessment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::Foundation::HWND,
    ) -> windows_core::HRESULT,
...
pub trait IInitiateWinSATAssessment_Impl: windows_core::IUnknownImpl {
    fn InitiateAssessment(
        &self,
        cmdline: &windows_core::PCWSTR,
        pcallbacks: windows_core::Ref<'_, IWinSATInitiateEvents>,
...
impl IInitiateWinSATAssessment_Vtbl {
    pub const fn new<Identity: IInitiateWinSATAssessment_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn InitiateAssessment<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInitiateWinSATAssessment_Impl::InitiateAssessment(
                    this,
                    core::mem::transmute(&cmdline),
                    core::mem::transmute_copy(&pcallbacks),
                    core::mem::transmute_copy(&callerhwnd),
                )
                .into()
            }
        }
        unsafe extern "system" fn InitiateFormalAssessment<
            Identity: IInitiateWinSATAssessment_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IInitiateWinSATAssessment_Impl::InitiateFormalAssessment(
                    this,
                    core::mem::transmute_copy(&pcallbacks),
                    core::mem::transmute_copy(&callerhwnd),
                )
        ...
        unsafe extern "system" fn CancelAssessment<
            Identity: IInitiateWinSATAssessment_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl IProvideWinSATAssessmentInfo {
    pub unsafe fn Score(&self) -> windows_core::Result<f32> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).Score)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
impl IProvideWinSATResultsInfo {
    ...
    ) -> windows_core::Result<IProvideWinSATAssessmentInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAssessmentInfo)(
                windows_core::Interface::as_raw(self),
                assessment,
                &mut result__,
            )
    ...
    pub unsafe fn AssessmentState(&self) -> windows_core::Result<WINSAT_ASSESSMENT_STATE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AssessmentState)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn AssessmentDateTime(&self) -> windows_core::Result<super::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AssessmentDateTime)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SystemRating(&self) -> windows_core::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SystemRating)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn RatingStateDesc(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RatingStateDesc)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct IProvideWinSATResultsInfo_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub GetAssessmentInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WINSAT_ASSESSMENT_TYPE,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AssessmentState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WINSAT_ASSESSMENT_STATE,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AssessmentDateTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub RatingStateDesc: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IProvideWinSATResultsInfo_Vtbl {
    pub const fn new<Identity: IProvideWinSATResultsInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetAssessmentInfo<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IProvideWinSATResultsInfo_Impl::GetAssessmentInfo(
                    this,
                    core::mem::transmute_copy(&assessment),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn AssessmentState<
            Identity: IProvideWinSATResultsInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AssessmentDateTime<
            Identity: IProvideWinSATResultsInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            filetime: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SystemRating<
            Identity: IProvideWinSATResultsInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn RatingStateDesc<
            Identity: IProvideWinSATResultsInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl IProvideWinSATVisuals {
    ...
    pub unsafe fn get_Bitmap(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Bitmap)(
                windows_core::Interface::as_raw(self),
                bitmapsize,
                state,
                rating,
...
pub struct IProvideWinSATVisuals_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub get_Bitmap: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WINSAT_BITMAP_SIZE,
...
impl IProvideWinSATVisuals_Vtbl {
    pub const fn new<Identity: IProvideWinSATVisuals_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn get_Bitmap<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IProvideWinSATVisuals_Impl::get_Bitmap(
                    this,
                    core::mem::transmute_copy(&bitmapsize),
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            get_Bitmap: get_Bitmap::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IQueryAllWinSATAssessments {
    ...
    pub unsafe fn get_AllXML(
        &self,
        xpath: &windows_core::BSTR,
        namespaces: &windows_core::BSTR,
    ) -> windows_core::Result<super::super::Data::Xml::MsXml::IXMLDOMNodeList> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_AllXML)(
                windows_core::Interface::as_raw(self),
...
pub struct IQueryAllWinSATAssessments_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    #[cfg(feature = "Win32_Data_Xml_MsXml")]
    pub get_AllXML: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
impl IQueryAllWinSATAssessments_Vtbl {
    pub const fn new<Identity: IQueryAllWinSATAssessments_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn get_AllXML<
        ...
        >(
            ...
            ppdomnodelist: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IQueryAllWinSATAssessments_Impl::get_AllXML(
                    this,
                    core::mem::transmute(&xpath),
                    core::mem::transmute(&namespaces),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            base__: super::Com::IDispatch_Vtbl::new::<Identity, OFFSET>(),
            get_AllXML: get_AllXML::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xbc9a6a9f_ad4e_420e_9953_b34671e9df22
);
...
impl IQueryOEMWinSATCustomization {
    pub unsafe fn GetOEMPrePopulationInfo(
        &self,
    ) -> windows_core::Result<WINSAT_OEM_CUSTOMIZATION_STATE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOEMPrePopulationInfo)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IQueryOEMWinSATCustomization_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetOEMPrePopulationInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WINSAT_OEM_CUSTOMIZATION_STATE,
    ) -> windows_core::HRESULT,
}
...
impl IQueryOEMWinSATCustomization_Vtbl {
    pub const fn new<Identity: IQueryOEMWinSATCustomization_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetOEMPrePopulationInfo<
            Identity: IQueryOEMWinSATCustomization_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            state: *mut WINSAT_OEM_CUSTOMIZATION_STATE,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetOEMPrePopulationInfo: GetOEMPrePopulationInfo::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IQueryRecentWinSATAssessment {
    ...
    pub unsafe fn get_XML(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_XML)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(xpath),
                core::mem::transmute_copy(namespaces),
                &mut result__,
...
pub struct IQueryRecentWinSATAssessment_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    #[cfg(feature = "Win32_Data_Xml_MsXml")]
    pub get_XML: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
impl IQueryRecentWinSATAssessment_Vtbl {
    pub const fn new<Identity: IQueryRecentWinSATAssessment_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn get_XML<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IQueryRecentWinSATAssessment_Impl::get_XML(
                    this,
                    core::mem::transmute(&xpath),
                    core::mem::transmute(&namespaces),
                ) {
        ...
        >(
            this: *mut core::ffi::c_void,
            ppwinsatassessmentinfo: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: super::Com::IDispatch_Vtbl::new::<Identity, OFFSET>(),
            get_XML: get_XML::<Identity, OFFSET>,
...
impl IWinSATInitiateEvents {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).WinSATComplete)(
                windows_core::Interface::as_raw(self),
                hresult,
                strdescription.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn WinSATUpdate<P2>(
        &self,
        ucurrenttick: u32,
        uticktotal: u32,
        strcurrentstate: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).WinSATUpdate)(
                windows_core::Interface::as_raw(self),
                ucurrenttick,
                uticktotal,
                strcurrentstate.param().abi(),
            )
            .ok()
        }
    }
...
pub struct IWinSATInitiateEvents_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub WinSATComplete: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::HRESULT,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub WinSATUpdate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        windows_core::PCWSTR,
...
pub trait IWinSATInitiateEvents_Impl: windows_core::IUnknownImpl {
    fn WinSATComplete(
        &self,
        hresult: windows_core::HRESULT,
        strdescription: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
    fn WinSATUpdate(
        &self,
        ucurrenttick: u32,
        uticktotal: u32,
        strcurrentstate: &windows_core::PCWSTR,
    ) -> windows_core::Result<()>;
}
impl IWinSATInitiateEvents_Vtbl {
    pub const fn new<Identity: IWinSATInitiateEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn WinSATComplete<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinSATInitiateEvents_Impl::WinSATComplete(
                    this,
                    core::mem::transmute_copy(&hresult),
                    core::mem::transmute(&strdescription),
                )
                .into()
            }
        }
        unsafe extern "system" fn WinSATUpdate<
            Identity: IWinSATInitiateEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWinSATInitiateEvents_Impl::WinSATUpdate(
                    this,
                    core::mem::transmute_copy(&ucurrenttick),
                    core::mem::transmute_copy(&uticktotal),
                    core::mem::transmute(&strcurrentstate),
                )
                .into()
            }
        }
...
pub const WINSAT_OEM_DATA_INVALID: WINSAT_OEM_CUSTOMIZATION_STATE =
    WINSAT_OEM_CUSTOMIZATION_STATE(2i32);
pub const WINSAT_OEM_DATA_NON_SYS_CONFIG_MATCH: WINSAT_OEM_CUSTOMIZATION_STATE =
    WINSAT_OEM_CUSTOMIZATION_STATE(1i32);
pub const WINSAT_OEM_DATA_VALID: WINSAT_OEM_CUSTOMIZATION_STATE =
    WINSAT_OEM_CUSTOMIZATION_STATE(0i32);
pub const WINSAT_OEM_NO_DATA_SUPPLIED: WINSAT_OEM_CUSTOMIZATION_STATE =
    WINSAT_OEM_CUSTOMIZATION_STATE(3i32);

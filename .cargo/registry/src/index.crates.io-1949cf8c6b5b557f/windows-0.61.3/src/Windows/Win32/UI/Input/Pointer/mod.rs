...
pub unsafe fn GetPointerDeviceCursors(
    device: super::super::super::Foundation::HANDLE,
    cursorcount: *mut u32,
    devicecursors: Option<*mut super::super::Controls::POINTER_DEVICE_CURSOR_INFO>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        GetPointerDeviceCursors(
            device,
            cursorcount as _,
            devicecursors.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn GetPointerDeviceProperties(
    ...
    pointerproperties: Option<*mut super::super::Controls::POINTER_DEVICE_PROPERTY>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        GetPointerDeviceProperties(
            device,
            propertycount as _,
            pointerproperties.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn GetPointerDevices(
    devicecount: *mut u32,
    pointerdevices: Option<*mut super::super::Controls::POINTER_DEVICE_INFO>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        GetPointerDevices(
            devicecount as _,
            pointerdevices.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn GetPointerFrameInfo(
    ...
    pointerinfo: Option<*mut POINTER_INFO>,
) -> windows_core::Result<()> {
...
pub unsafe fn GetPointerFramePenInfo(
    ...
    unsafe {
        GetPointerFramePenInfo(
            pointerid,
            pointercount as _,
            peninfo.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn GetPointerFrameTouchInfo(
    ...
    unsafe {
        GetPointerFrameTouchInfo(
            pointerid,
            pointercount as _,
            touchinfo.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn GetPointerInputTransform(
    ...
    unsafe {
        GetPointerInputTransform(
            pointerid,
            inputtransform.len().try_into().unwrap(),
            core::mem::transmute(inputtransform.as_ptr()),
        )
        .ok()
    }
}
...
pub unsafe fn GetRawPointerDeviceData(
    pointerid: u32,
    historycount: u32,
    pproperties: &[super::super::Controls::POINTER_DEVICE_PROPERTY],
    pvalues: *mut i32,
) -> windows_core::Result<()> {
...
pub unsafe fn InjectSyntheticPointerInput(
    ...
    pointerinfo: &[super::super::Controls::POINTER_TYPE_INFO],
) -> windows_core::Result<()> {
...
pub unsafe fn InjectTouchInput(contacts: &[POINTER_TOUCH_INFO]) -> windows_core::Result<()> {
    ...
    unsafe {
        InjectTouchInput(
            contacts.len().try_into().unwrap(),
            core::mem::transmute(contacts.as_ptr()),
        )
        .ok()
    }
}

pub const CLSID_SoftwareBitmapNativeFactory: windows_core::GUID =
    windows_core::GUID::from_u128(0x84e65691_8602_4a84_be46_708be9cd4b74);
windows_core::imp::define_interface!(
    ISoftwareBitmapNative,
    ISoftwareBitmapNative_Vtbl,
    0x94bc8415_04ea_4b2e_af13_4de95aa898eb
);
    ...
    pub const fn new<Identity: ISoftwareBitmapNative_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                ...
                ISoftwareBitmapNative_Impl::GetData(
                    this,
        ...
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, ISoftwareBitmapNative, OFFSET>(
            ),
...
windows_core::imp::define_interface!(
    ...
    0xc3c181ec_2914_4791_af02_02d224a10b43
);
windows_core::imp::interface_hierarchy!(
    ISoftwareBitmapNativeFactory,
    windows_core::IUnknown,
...
impl ISoftwareBitmapNativeFactory {
    ...
    pub unsafe fn CreateFromWICBitmap<P0, T>(
        &self,
        data: P0,
        forcereadonly: bool,
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).CreateFromWICBitmap)(
                windows_core::Interface::as_raw(self),
                data.param().abi(),
                forcereadonly.into(),
                &T::IID,
    ...
    pub unsafe fn CreateFromMF2DBuffer2<P0, T>(
        &self,
        data: P0,
        ...
        height: u32,
        forcereadonly: bool,
        mindisplayaperture: Option<
            *const super::super::super::super::Media::MediaFoundation::MFVideoArea,
        >,
    ) -> windows_core::Result<T>
    where
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).CreateFromMF2DBuffer2)(
                windows_core::Interface::as_raw(self),
                data.param().abi(),
                subtype,
                width,
...
pub struct ISoftwareBitmapNativeFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Win32_Graphics_Imaging")]
    pub CreateFromWICBitmap: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::BOOL,
        *const windows_core::GUID,
    ...
    #[cfg(feature = "Win32_Media_MediaFoundation")]
    pub CreateFromMF2DBuffer2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        u32,
...
pub trait ISoftwareBitmapNativeFactory_Impl: windows_core::IUnknownImpl {
    fn CreateFromWICBitmap(
        &self,
        data: windows_core::Ref<'_, super::super::super::super::Graphics::Imaging::IWICBitmap>,
    ...
    fn CreateFromMF2DBuffer2(
        &self,
        data: windows_core::Ref<
            '_,
            super::super::super::super::Media::MediaFoundation::IMF2DBuffer2,
        >,
        subtype: *const windows_core::GUID,
        width: u32,
        height: u32,
...
impl ISoftwareBitmapNativeFactory_Vtbl {
    pub const fn new<Identity: ISoftwareBitmapNativeFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateFromWICBitmap<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISoftwareBitmapNativeFactory_Impl::CreateFromWICBitmap(
                    this,
        ...
        unsafe extern "system" fn CreateFromMF2DBuffer2<
            Identity: ISoftwareBitmapNativeFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISoftwareBitmapNativeFactory_Impl::CreateFromMF2DBuffer2(
                    this,
                    core::mem::transmute_copy(&data),

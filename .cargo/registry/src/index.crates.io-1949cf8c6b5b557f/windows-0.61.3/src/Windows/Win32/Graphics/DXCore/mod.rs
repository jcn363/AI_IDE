...
{
    windows_link::link!("dxcore.dll" "system" fn DXCoreCreateAdapterFactory(riid : *const windows_core::GUID, ppvfactory : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
...
pub const AdapterHardwareContentProtectionTeardown: DXCoreNotificationType =
    DXCoreNotificationType(3u32);
...
pub const DXCORE_ADAPTER_ATTRIBUTE_D3D11_GRAPHICS: windows_core::GUID =
    windows_core::GUID::from_u128(0x8c47866b_7583_450d_f0f0_6bada895af4b);
pub const DXCORE_ADAPTER_ATTRIBUTE_D3D12_CORE_COMPUTE: windows_core::GUID =
    windows_core::GUID::from_u128(0x248e2800_a793_4724_abaa_23a6de1be090);
pub const DXCORE_ADAPTER_ATTRIBUTE_D3D12_GRAPHICS: windows_core::GUID =
    windows_core::GUID::from_u128(0x0c9ece4d_2f6e_4f01_8c96_e89e331b47b1);
#[repr(C)]
...
windows_core::imp::define_interface!(
    IDXCoreAdapter,
    IDXCoreAdapter_Vtbl,
    0xf0db4c7f_fe5a_42a2_bd62_f2a6cf6fc83e
);
...
impl IDXCoreAdapter {
    ...
    pub unsafe fn IsAttributeSupported(&self, attributeguid: *const windows_core::GUID) -> bool {
        unsafe {
            (windows_core::Interface::vtable(self).IsAttributeSupported)(
    ...
    pub unsafe fn IsPropertySupported(&self, property: DXCoreAdapterProperty) -> bool {
        unsafe {
            (windows_core::Interface::vtable(self).IsPropertySupported)(
                windows_core::Interface::as_raw(self),
                property,
            )
        }
    ...
    pub unsafe fn GetPropertySize(
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(self).GetPropertySize)(
                windows_core::Interface::as_raw(self),
                property,
                &mut result__,
            )
    ...
    pub unsafe fn IsQueryStateSupported(&self, property: DXCoreAdapterState) -> bool {
        unsafe {
            (windows_core::Interface::vtable(self).IsQueryStateSupported)(
                windows_core::Interface::as_raw(self),
                property,
            )
        }
    }
    pub unsafe fn QueryState(
        &self,
        state: DXCoreAdapterState,
        inputstatedetailssize: usize,
        inputstatedetails: Option<*const core::ffi::c_void>,
        outputbuffersize: usize,
        outputbuffer: *mut core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).QueryState)(
                windows_core::Interface::as_raw(self),
                state,
                inputstatedetailssize,
                inputstatedetails.unwrap_or(core::mem::zeroed()) as _,
                outputbuffersize,
                outputbuffer as _,
            )
            .ok()
    ...
    pub unsafe fn IsSetStateSupported(&self, property: DXCoreAdapterState) -> bool {
        unsafe {
            (windows_core::Interface::vtable(self).IsSetStateSupported)(
                windows_core::Interface::as_raw(self),
                property,
            )
        }
    ...
    pub unsafe fn SetState(
        ...
        inputstatedetails: Option<*const core::ffi::c_void>,
        inputdatasize: usize,
        inputdata: *const core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
...
pub struct IDXCoreAdapter_Vtbl {
    ...
    pub IsAttributeSupported:
        unsafe extern "system" fn(*mut core::ffi::c_void, *const windows_core::GUID) -> bool,
    pub IsPropertySupported:
        unsafe extern "system" fn(*mut core::ffi::c_void, DXCoreAdapterProperty) -> bool,
    ...
    pub GetPropertySize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        DXCoreAdapterProperty,
        *mut usize,
    ) -> windows_core::HRESULT,
    pub IsQueryStateSupported:
        unsafe extern "system" fn(*mut core::ffi::c_void, DXCoreAdapterState) -> bool,
    pub QueryState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        DXCoreAdapterState,
        usize,
    ...
    pub GetFactory: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait IDXCoreAdapter_Impl: windows_core::IUnknownImpl {
    ...
    fn QueryState(
        ...
        state: DXCoreAdapterState,
        inputstatedetailssize: usize,
        inputstatedetails: *const core::ffi::c_void,
        outputbuffersize: usize,
        outputbuffer: *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
...
impl IDXCoreAdapter_Vtbl {
    pub const fn new<Identity: IDXCoreAdapter_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsValid<Identity: IDXCoreAdapter_Impl, const OFFSET: isize>(
        ...
        unsafe extern "system" fn IsAttributeSupported<
            Identity: IDXCoreAdapter_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            attributeguid: *const windows_core::GUID,
        ) -> bool {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapter_Impl::IsAttributeSupported(
                    this,
                    core::mem::transmute_copy(&attributeguid),
                )
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapter_Impl::GetProperty(
                    this,
        ...
        unsafe extern "system" fn GetPropertySize<
            Identity: IDXCoreAdapter_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDXCoreAdapter_Impl::GetPropertySize(
                    this,
                    core::mem::transmute_copy(&property),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn IsQueryStateSupported<
            Identity: IDXCoreAdapter_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapter_Impl::IsQueryStateSupported(
                    this,
                    core::mem::transmute_copy(&property),
                )
            }
        }
        unsafe extern "system" fn QueryState<Identity: IDXCoreAdapter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            state: DXCoreAdapterState,
            inputstatedetailssize: usize,
            inputstatedetails: *const core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapter_Impl::QueryState(
                    this,
                    core::mem::transmute_copy(&state),
                    core::mem::transmute_copy(&inputstatedetailssize),
                    core::mem::transmute_copy(&inputstatedetails),
                    core::mem::transmute_copy(&outputbuffersize),
                    core::mem::transmute_copy(&outputbuffer),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsSetStateSupported<
            Identity: IDXCoreAdapter_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetState<Identity: IDXCoreAdapter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            state: DXCoreAdapterState,
            inputstatedetailssize: usize,
            inputstatedetails: *const core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapter_Impl::SetState(
                    this,
                    core::mem::transmute_copy(&state),
                    core::mem::transmute_copy(&inputstatedetailssize),
                    core::mem::transmute_copy(&inputstatedetails),
                    core::mem::transmute_copy(&inputdatasize),
                    core::mem::transmute_copy(&inputdata),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetFactory<Identity: IDXCoreAdapter_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            riid: *const windows_core::GUID,
            ppvfactory: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapter_Impl::GetFactory(
                    this,
...
impl IDXCoreAdapterFactory {
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).CreateAdapterList)(
                windows_core::Interface::as_raw(self),
                filterattributes.len().try_into().unwrap(),
                core::mem::transmute(filterattributes.as_ptr()),
                &T::IID,
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetAdapterByLuid<T>(
        &self,
        adapterluid: *const super::super::Foundation::LUID,
    ) -> windows_core::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).GetAdapterByLuid)(
                windows_core::Interface::as_raw(self),
                adapterluid,
                &T::IID,
                &mut result__,
    ...
    pub unsafe fn IsNotificationTypeSupported(
        &self,
        notificationtype: DXCoreNotificationType,
    ) -> bool {
        unsafe {
            (windows_core::Interface::vtable(self).IsNotificationTypeSupported)(
                windows_core::Interface::as_raw(self),
                notificationtype,
            )
        }
    }
    pub unsafe fn RegisterEventNotification<P0>(
        &self,
        dxcoreobject: P0,
        notificationtype: DXCoreNotificationType,
        ...
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RegisterEventNotification)(
                windows_core::Interface::as_raw(self),
                dxcoreobject.param().abi(),
                notificationtype,
                callbackfunction,
    ...
    pub unsafe fn UnregisterEventNotification(&self, eventcookie: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).UnregisterEventNotification)(
                windows_core::Interface::as_raw(self),
                eventcookie,
            )
            .ok()
...
pub struct IDXCoreAdapterFactory_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateAdapterList: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const windows_core::GUID,
        *const windows_core::GUID,
    ...
    pub GetAdapterByLuid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::super::Foundation::LUID,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsNotificationTypeSupported:
        unsafe extern "system" fn(*mut core::ffi::c_void, DXCoreNotificationType) -> bool,
    pub RegisterEventNotification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub UnregisterEventNotification:
...
pub trait IDXCoreAdapterFactory_Impl: windows_core::IUnknownImpl {
    fn CreateAdapterList(
        &self,
        numattributes: u32,
        filterattributes: *const windows_core::GUID,
        riid: *const windows_core::GUID,
        ppvadapterlist: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()>;
    fn GetAdapterByLuid(
        &self,
        adapterluid: *const super::super::Foundation::LUID,
    ...
    fn RegisterEventNotification(
        &self,
        dxcoreobject: windows_core::Ref<'_, windows_core::IUnknown>,
        notificationtype: DXCoreNotificationType,
        callbackfunction: PFN_DXCORE_NOTIFICATION_CALLBACK,
    ...
    pub const fn new<Identity: IDXCoreAdapterFactory_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapterFactory_Impl::CreateAdapterList(
                    this,
                    core::mem::transmute_copy(&numattributes),
                    core::mem::transmute_copy(&filterattributes),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppvadapterlist),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetAdapterByLuid<
            Identity: IDXCoreAdapterFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapterFactory_Impl::GetAdapterByLuid(
                    this,
                    core::mem::transmute_copy(&adapterluid),
                    core::mem::transmute_copy(&riid),
        ...
        unsafe extern "system" fn IsNotificationTypeSupported<
            Identity: IDXCoreAdapterFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapterFactory_Impl::IsNotificationTypeSupported(
                    this,
                    core::mem::transmute_copy(&notificationtype),
                )
            }
        }
        unsafe extern "system" fn RegisterEventNotification<
            Identity: IDXCoreAdapterFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dxcoreobject: *mut core::ffi::c_void,
            notificationtype: DXCoreNotificationType,
            callbackfunction: PFN_DXCORE_NOTIFICATION_CALLBACK,
            callbackcontext: *const core::ffi::c_void,
            eventcookie: *mut u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDXCoreAdapterFactory_Impl::RegisterEventNotification(
                    this,
                    core::mem::transmute_copy(&dxcoreobject),
                    core::mem::transmute_copy(&notificationtype),
                    core::mem::transmute_copy(&callbackfunction),
                    core::mem::transmute_copy(&callbackcontext),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn UnregisterEventNotification<
            Identity: IDXCoreAdapterFactory_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapterFactory_Impl::UnregisterEventNotification(
                    this,
...
windows_core::imp::define_interface!(
    ...
    0x526c7776_40e9_459b_b711_f32ad76dfc28
);
...
impl IDXCoreAdapterList {
    ...
    pub unsafe fn Sort(&self, preferences: &[DXCoreAdapterPreference]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Sort)(
                windows_core::Interface::as_raw(self),
                preferences.len().try_into().unwrap(),
                core::mem::transmute(preferences.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn IsAdapterPreferenceSupported(&self, preference: DXCoreAdapterPreference) -> bool {
        unsafe {
            (windows_core::Interface::vtable(self).IsAdapterPreferenceSupported)(
                windows_core::Interface::as_raw(self),
                preference,
            )
        }
...
pub struct IDXCoreAdapterList_Vtbl {
    ...
    pub IsAdapterPreferenceSupported:
        unsafe extern "system" fn(*mut core::ffi::c_void, DXCoreAdapterPreference) -> bool,
}
    ...
    pub const fn new<Identity: IDXCoreAdapterList_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapterList_Impl::GetAdapter(
                    this,
        ...
        unsafe extern "system" fn IsStale<
            Identity: IDXCoreAdapterList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetFactory<
            Identity: IDXCoreAdapterList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapterList_Impl::GetFactory(
                    this,
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&ppvfactory),
                )
        ...
        unsafe extern "system" fn Sort<Identity: IDXCoreAdapterList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            numpreferences: u32,
            preferences: *const DXCoreAdapterPreference,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapterList_Impl::Sort(
                    this,
                    core::mem::transmute_copy(&numpreferences),
                    core::mem::transmute_copy(&preferences),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsAdapterPreferenceSupported<
            Identity: IDXCoreAdapterList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDXCoreAdapterList_Impl::IsAdapterPreferenceSupported(
                    this,
                    core::mem::transmute_copy(&preference),
                )
            }
        }
        Self {
...
pub type PFN_DXCORE_NOTIFICATION_CALLBACK = Option<

#[inline]
pub unsafe fn RmAddFilter<P1, P3>(
    dwsessionhandle: u32,
    strmodulename: P1,
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        RmAddFilter(
            dwsessionhandle,
            strmodulename.param().abi(),
            pprocess.unwrap_or(core::mem::zeroed()) as _,
            strserviceshortname.param().abi(),
            filteraction,
        )
    }
}
...
pub unsafe fn RmGetList(
    ...
    pnprocinfo: *mut u32,
    rgaffectedapps: Option<*mut RM_PROCESS_INFO>,
    ...
    unsafe {
        RmGetList(
            dwsessionhandle,
            pnprocinfoneeded as _,
            pnprocinfo as _,
            rgaffectedapps.unwrap_or(core::mem::zeroed()) as _,
            lpdwrebootreasons as _,
        )
    }
}
#[inline]
...
pub unsafe fn RmRegisterResources(
    dwsessionhandle: u32,
    rgsfilenames: Option<&[windows_core::PCWSTR]>,
    rgapplications: Option<&[RM_UNIQUE_PROCESS]>,
    rgsservicenames: Option<&[windows_core::PCWSTR]>,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn RmRestart(
    ...
    unsafe {
        RmRestart(
            dwsessionhandle,
            dwrestartflags.unwrap_or(core::mem::zeroed()) as _,
            fnstatus,
        )
    }
}
...
pub unsafe fn RmStartSession(
    psessionhandle: *mut u32,
    dwsessionflags: Option<u32>,
    strsessionkey: windows_core::PWSTR,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        RmStartSession(
            psessionhandle as _,
            dwsessionflags.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(strsessionkey),
        )
    }
}

...
pub unsafe fn AdjustWindowRectExForDpi(
    ...
    dwstyle: super::WindowsAndMessaging::WINDOW_STYLE,
    bmenu: bool,
    dwexstyle: super::WindowsAndMessaging::WINDOW_EX_STYLE,
    dpi: u32,
) -> windows_core::Result<()> {
    windows_link::link!("user32.dll" "system" fn AdjustWindowRectExForDpi(lprect : *mut super::super::Foundation:: RECT, dwstyle : super::WindowsAndMessaging:: WINDOW_STYLE, bmenu : windows_core::BOOL, dwexstyle : super::WindowsAndMessaging:: WINDOW_EX_STYLE, dpi : u32) -> windows_core::BOOL);
...
pub unsafe fn AreDpiAwarenessContextsEqual(
    ...
    windows_link::link!("user32.dll" "system" fn AreDpiAwarenessContextsEqual(dpicontexta : DPI_AWARENESS_CONTEXT, dpicontextb : DPI_AWARENESS_CONTEXT) -> windows_core::BOOL);
...
pub unsafe fn EnableNonClientDpiScaling(
    ...
    windows_link::link!("user32.dll" "system" fn EnableNonClientDpiScaling(hwnd : super::super::Foundation:: HWND) -> windows_core::BOOL);
...
pub unsafe fn GetDpiForMonitor(
    ...
    windows_link::link!("api-ms-win-shcore-scaling-l1-1-1.dll" "system" fn GetDpiForMonitor(hmonitor : super::super::Graphics::Gdi:: HMONITOR, dpitype : MONITOR_DPI_TYPE, dpix : *mut u32, dpiy : *mut u32) -> windows_core::HRESULT);
...
) -> windows_core::Result<PROCESS_DPI_AWARENESS> {
    windows_link::link!("api-ms-win-shcore-scaling-l1-1-1.dll" "system" fn GetProcessDpiAwareness(hprocess : super::super::Foundation:: HANDLE, value : *mut PROCESS_DPI_AWARENESS) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        GetProcessDpiAwareness(hprocess.unwrap_or(core::mem::zeroed()) as _, &mut result__)
            .map(|| result__)
    }
}
#[inline]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn GetSystemMetricsForDpi(
    nindex: super::WindowsAndMessaging::SYSTEM_METRICS_INDEX,
    dpi: u32,
) -> i32 {
...
pub unsafe fn IsValidDpiAwarenessContext(value: DPI_AWARENESS_CONTEXT) -> windows_core::BOOL {
    windows_link::link!("user32.dll" "system" fn IsValidDpiAwarenessContext(value : DPI_AWARENESS_CONTEXT) -> windows_core::BOOL);
...
pub unsafe fn LogicalToPhysicalPointForPerMonitorDPI(
    ...
    windows_link::link!("user32.dll" "system" fn LogicalToPhysicalPointForPerMonitorDPI(hwnd : super::super::Foundation:: HWND, lppoint : *mut super::super::Foundation:: POINT) -> windows_core::BOOL);
    unsafe {
...
#[inline]
pub unsafe fn OpenThemeDataForDpi<P1>(
    hwnd: Option<super::super::Foundation::HWND>,
    pszclasslist: P1,
    dpi: u32,
) -> super::Controls::HTHEME
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("uxtheme.dll" "system" fn OpenThemeDataForDpi(hwnd : super::super::Foundation:: HWND, pszclasslist : windows_core::PCWSTR, dpi : u32) -> super::Controls:: HTHEME);
    unsafe {
        OpenThemeDataForDpi(
            hwnd.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn PhysicalToLogicalPointForPerMonitorDPI(
    ...
    windows_link::link!("user32.dll" "system" fn PhysicalToLogicalPointForPerMonitorDPI(hwnd : super::super::Foundation:: HWND, lppoint : *mut super::super::Foundation:: POINT) -> windows_core::BOOL);
    unsafe {
...
pub unsafe fn SetDialogControlDpiChangeBehavior(
    ...
    windows_link::link!("user32.dll" "system" fn SetDialogControlDpiChangeBehavior(hwnd : super::super::Foundation:: HWND, mask : DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS, values : DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS) -> windows_core::BOOL);
...
pub unsafe fn SetDialogDpiChangeBehavior(
    ...
    windows_link::link!("user32.dll" "system" fn SetDialogDpiChangeBehavior(hdlg : super::super::Foundation:: HWND, mask : DIALOG_DPI_CHANGE_BEHAVIORS, values : DIALOG_DPI_CHANGE_BEHAVIORS) -> windows_core::BOOL);
...
pub unsafe fn SetProcessDpiAwareness(value: PROCESS_DPI_AWARENESS) -> windows_core::Result<()> {
    windows_link::link!("api-ms-win-shcore-scaling-l1-1-1.dll" "system" fn SetProcessDpiAwareness(value : PROCESS_DPI_AWARENESS) -> windows_core::HRESULT);
...
pub unsafe fn SetProcessDpiAwarenessContext(
    ...
    windows_link::link!("user32.dll" "system" fn SetProcessDpiAwarenessContext(value : DPI_AWARENESS_CONTEXT) -> windows_core::BOOL);
...
pub unsafe fn SystemParametersInfoForDpi(
    ...
    windows_link::link!("user32.dll" "system" fn SystemParametersInfoForDpi(uiaction : u32, uiparam : u32, pvparam : *mut core::ffi::c_void, fwinini : u32, dpi : u32) -> windows_core::BOOL);
    unsafe {
...
pub const DDC_DISABLE_CONTROL_RELAYOUT: DIALOG_DPI_CHANGE_BEHAVIORS =
    DIALOG_DPI_CHANGE_BEHAVIORS(4i32);

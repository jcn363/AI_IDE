...
pub unsafe fn MI_Application_InitializeV1(
    flags: u32,
    applicationid: Option<*const u16>,
    extendederror: Option<*mut *mut MI_Instance>,
    application: *mut MI_Application,
) -> MI_Result {
    ...
    unsafe {
        MI_Application_InitializeV1(
            flags,
            applicationid.unwrap_or(core::mem::zeroed()) as _,
            extendederror.unwrap_or(core::mem::zeroed()) as _,
            application as _,
        )
    }
}
...
windows_core::imp::define_interface!(
    ...
    0x027947e1_d731_11ce_a357_000000000001
);
...
impl IEnumWbemClassObject {
    ...
    pub unsafe fn Next(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Next)(
                ...
                ltimeout,
                apobjects.len().try_into().unwrap(),
                core::mem::transmute(apobjects.as_ptr()),
                pureturned as _,
            )
        }
    }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).NextAsync)(
                windows_core::Interface::as_raw(self),
                ucount,
                psink.param().abi(),
            )
...
pub struct IEnumWbemClassObject_Vtbl {
    ...
    pub NextAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IEnumWbemClassObject_Impl: windows_core::IUnknownImpl {
    ...
    fn NextAsync(
        &self,
        ucount: u32,
        psink: windows_core::Ref<'_, IWbemObjectSink>,
    ) -> windows_core::HRESULT;
...
impl IEnumWbemClassObject_Vtbl {
    pub const fn new<Identity: IEnumWbemClassObject_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Reset<
            Identity: IEnumWbemClassObject_Impl,
            const OFFSET: isize,
        >(
        ...
        unsafe extern "system" fn Next<Identity: IEnumWbemClassObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ltimeout: i32,
            ucount: u32,
            apobjects: *mut *mut core::ffi::c_void,
            pureturned: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumWbemClassObject_Impl::Next(
                    this,
                    core::mem::transmute_copy(&ltimeout),
                    core::mem::transmute_copy(&ucount),
                    core::mem::transmute_copy(&apobjects),
                    core::mem::transmute_copy(&pureturned),
                )
            }
        }
        unsafe extern "system" fn NextAsync<
            Identity: IEnumWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumWbemClassObject_Impl::NextAsync(
                    this,
                    core::mem::transmute_copy(&ucount),
        ...
        unsafe extern "system" fn Skip<Identity: IEnumWbemClassObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ltimeout: i32,
            ncount: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IEnumWbemClassObject_Impl::Skip(
                    this,
                    core::mem::transmute_copy(&ltimeout),
                    core::mem::transmute_copy(&ncount),
                )
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    IMofCompiler,
    IMofCompiler_Vtbl,
    0x6daf974e_2e37_11d2_aec9_00c04fb68820
);
windows_core::imp::interface_hierarchy!(IMofCompiler, windows_core::IUnknown);
impl IMofCompiler {
    pub unsafe fn CompileFile<P0, P1, P2, P3, P4>(
        &self,
        filename: P0,
        serverandnamespace: P1,
        user: P2,
        authority: P3,
        password: P4,
        loptionflags: i32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CompileFile)(
                windows_core::Interface::as_raw(self),
                filename.param().abi(),
                serverandnamespace.param().abi(),
                user.param().abi(),
                authority.param().abi(),
                password.param().abi(),
                loptionflags,
    ...
    pub unsafe fn CompileBuffer<P2, P3, P4, P5>(
        &self,
        pbuffer: &[u8],
        serverandnamespace: P2,
        user: P3,
        authority: P4,
        password: P5,
        loptionflags: i32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CompileBuffer)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn CreateBMOF<P0, P1, P2>(
        &self,
        textfilename: P0,
        bmoffilename: P1,
        serverandnamespace: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CreateBMOF)(
                windows_core::Interface::as_raw(self),
                textfilename.param().abi(),
                bmoffilename.param().abi(),
                serverandnamespace.param().abi(),
                loptionflags,
                lclassflags,
                linstanceflags,
...
pub struct IMofCompiler_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CompileFile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        ...
        i32,
        i32,
        *mut WBEM_COMPILE_STATUS_INFO,
    ) -> windows_core::HRESULT,
    pub CompileBuffer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *const u8,
        windows_core::PCWSTR,
    ...
    pub CreateBMOF: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
pub trait IMofCompiler_Impl: windows_core::IUnknownImpl {
    fn CompileFile(
        ...
        serverandnamespace: &windows_core::PCWSTR,
        user: &windows_core::PCWSTR,
        authority: &windows_core::PCWSTR,
    ...
    fn CreateBMOF(
        &self,
        textfilename: &windows_core::PCWSTR,
        bmoffilename: &windows_core::PCWSTR,
        serverandnamespace: &windows_core::PCWSTR,
        loptionflags: i32,
        lclassflags: i32,
        linstanceflags: i32,
...
impl IMofCompiler_Vtbl {
    pub const fn new<Identity: IMofCompiler_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CompileFile<Identity: IMofCompiler_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            filename: windows_core::PCWSTR,
            serverandnamespace: windows_core::PCWSTR,
            user: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMofCompiler_Impl::CompileFile(
                    this,
                    core::mem::transmute(&filename),
                    core::mem::transmute(&serverandnamespace),
                    core::mem::transmute(&user),
                    core::mem::transmute(&authority),
                    core::mem::transmute(&password),
                    core::mem::transmute_copy(&loptionflags),
                    core::mem::transmute_copy(&lclassflags),
                    core::mem::transmute_copy(&linstanceflags),
                    core::mem::transmute_copy(&pinfo),
                )
                .into()
            }
        }
        unsafe extern "system" fn CompileBuffer<
            Identity: IMofCompiler_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            buffsize: i32,
            ...
            unsafe {
                ...
                IMofCompiler_Impl::CompileBuffer(
                    this,
                    core::mem::transmute_copy(&buffsize),
        ...
        unsafe extern "system" fn CreateBMOF<Identity: IMofCompiler_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            textfilename: windows_core::PCWSTR,
            bmoffilename: windows_core::PCWSTR,
            serverandnamespace: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMofCompiler_Impl::CreateBMOF(
                    this,
                    core::mem::transmute(&textfilename),
                    core::mem::transmute(&bmoffilename),
                    core::mem::transmute(&serverandnamespace),
                    core::mem::transmute_copy(&loptionflags),
                    core::mem::transmute_copy(&lclassflags),
                    core::mem::transmute_copy(&linstanceflags),
...
impl ISWbemDateTime {
    ...
    pub unsafe fn Year(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Year)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetYear(&self, iyear: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetYear)(
                windows_core::Interface::as_raw(self),
                iyear,
            )
            .ok()
    ...
    pub unsafe fn YearSpecified(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).YearSpecified)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetYearSpecified(
        &self,
        byearspecified: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetYearSpecified)(
                windows_core::Interface::as_raw(self),
                byearspecified,
            )
            .ok()
    ...
    pub unsafe fn Month(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Month)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMonth(&self, imonth: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMonth)(
                windows_core::Interface::as_raw(self),
                imonth,
            )
            .ok()
    ...
    pub unsafe fn MonthSpecified(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MonthSpecified)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMonthSpecified(
        &self,
        bmonthspecified: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMonthSpecified)(
                windows_core::Interface::as_raw(self),
                bmonthspecified,
            )
            .ok()
    ...
    pub unsafe fn Day(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Day)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetDay(&self, iday: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDay)(
                windows_core::Interface::as_raw(self),
                iday,
            )
            .ok()
    ...
    pub unsafe fn DaySpecified(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DaySpecified)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetDaySpecified(
        &self,
        bdayspecified: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDaySpecified)(
                windows_core::Interface::as_raw(self),
                bdayspecified,
            )
            .ok()
    ...
    pub unsafe fn Hours(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Hours)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetHours(&self, ihours: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetHours)(
                windows_core::Interface::as_raw(self),
                ihours,
            )
            .ok()
    ...
    pub unsafe fn HoursSpecified(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).HoursSpecified)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetHoursSpecified(
        &self,
        bhoursspecified: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetHoursSpecified)(
                windows_core::Interface::as_raw(self),
                bhoursspecified,
            )
            .ok()
    ...
    pub unsafe fn Minutes(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Minutes)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMinutes(&self, iminutes: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMinutes)(
                windows_core::Interface::as_raw(self),
                iminutes,
            )
            .ok()
    ...
    pub unsafe fn MinutesSpecified(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MinutesSpecified)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMinutesSpecified(
        &self,
        bminutesspecified: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMinutesSpecified)(
                windows_core::Interface::as_raw(self),
                bminutesspecified,
            )
            .ok()
    ...
    pub unsafe fn Seconds(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Seconds)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSeconds(&self, iseconds: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSeconds)(
                windows_core::Interface::as_raw(self),
                iseconds,
            )
            .ok()
    ...
    pub unsafe fn SecondsSpecified(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SecondsSpecified)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetSecondsSpecified(
        &self,
        bsecondsspecified: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSecondsSpecified)(
                windows_core::Interface::as_raw(self),
                bsecondsspecified,
            )
            .ok()
    ...
    pub unsafe fn Microseconds(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Microseconds)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMicroseconds(&self, imicroseconds: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMicroseconds)(
                windows_core::Interface::as_raw(self),
                imicroseconds,
            )
            .ok()
    ...
    pub unsafe fn MicrosecondsSpecified(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MicrosecondsSpecified)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMicrosecondsSpecified(
        &self,
        bmicrosecondsspecified: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMicrosecondsSpecified)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn UTC(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UTC)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetUTC(&self, iutc: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetUTC)(
                windows_core::Interface::as_raw(self),
                iutc,
            )
            .ok()
    ...
    pub unsafe fn UTCSpecified(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UTCSpecified)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetUTCSpecified(
        &self,
        butcspecified: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetUTCSpecified)(
                windows_core::Interface::as_raw(self),
                butcspecified,
            )
            .ok()
    ...
    pub unsafe fn IsInterval(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsInterval)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetIsInterval(
        &self,
        bisinterval: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetIsInterval)(
                windows_core::Interface::as_raw(self),
                bisinterval,
            )
            .ok()
    ...
    pub unsafe fn GetVarDate(
        &self,
        bislocal: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetVarDate)(
                windows_core::Interface::as_raw(self),
                bislocal,
                &mut result__,
            )
    ...
    pub unsafe fn SetVarDate(
        &self,
        dvardate: f64,
        bislocal: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetVarDate)(
                windows_core::Interface::as_raw(self),
                dvardate,
                bislocal,
            )
    ...
    pub unsafe fn GetFileTime(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFileTime)(
                windows_core::Interface::as_raw(self),
                bislocal,
                &mut result__,
            )
    ...
    pub unsafe fn SetFileTime(
        &self,
        strfiletime: &windows_core::BSTR,
        bislocal: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetFileTime)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strfiletime),
                bislocal,
            )
            .ok()
        }
...
pub struct ISWbemDateTime_Vtbl {
    ...
    pub YearSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetYearSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub MonthSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetMonthSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    ...
    pub DaySpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetDaySpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    ...
    pub HoursSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetHoursSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub Minutes:
    ...
    pub MinutesSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetMinutesSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub Seconds:
    ...
    pub SecondsSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetSecondsSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub Microseconds:
    ...
    pub MicrosecondsSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetMicrosecondsSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    ...
    pub UTCSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetUTCSpecified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub IsInterval: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetIsInterval: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub GetVarDate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
        *mut f64,
    ) -> windows_core::HRESULT,
    pub SetVarDate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        f64,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub GetFileTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetFileTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
...
impl ISWbemDateTime_Vtbl {
    pub const fn new<Identity: ISWbemDateTime_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Value<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strvalue: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetValue<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strvalue: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Year<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iyear: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetYear<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iyear: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn YearSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            byearspecified: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetYearSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemDateTime_Impl::SetYearSpecified(
                    this,
                    core::mem::transmute_copy(&byearspecified),
                )
                .into()
            }
        }
        unsafe extern "system" fn Month<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            imonth: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetMonth<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            imonth: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn MonthSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bmonthspecified: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetMonthSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemDateTime_Impl::SetMonthSpecified(
                    this,
                    core::mem::transmute_copy(&bmonthspecified),
                )
                .into()
            }
        }
        unsafe extern "system" fn Day<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iday: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetDay<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iday: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn DaySpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bdayspecified: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetDaySpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemDateTime_Impl::SetDaySpecified(
                    this,
                    core::mem::transmute_copy(&bdayspecified),
                )
                .into()
            }
        }
        unsafe extern "system" fn Hours<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ihours: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetHours<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ihours: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn HoursSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bhoursspecified: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetHoursSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemDateTime_Impl::SetHoursSpecified(
                    this,
                    core::mem::transmute_copy(&bhoursspecified),
                )
                .into()
            }
        }
        unsafe extern "system" fn Minutes<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iminutes: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetMinutes<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iminutes: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn MinutesSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bminutesspecified: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetMinutesSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemDateTime_Impl::SetMinutesSpecified(
                    this,
                    core::mem::transmute_copy(&bminutesspecified),
                )
                .into()
            }
        }
        unsafe extern "system" fn Seconds<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iseconds: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetSeconds<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iseconds: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SecondsSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bsecondsspecified: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetSecondsSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemDateTime_Impl::SetSecondsSpecified(
                    this,
                    core::mem::transmute_copy(&bsecondsspecified),
                )
                .into()
            }
        }
        unsafe extern "system" fn Microseconds<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            imicroseconds: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetMicroseconds<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemDateTime_Impl::SetMicroseconds(
                    this,
        ...
        unsafe extern "system" fn MicrosecondsSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bmicrosecondsspecified: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetMicrosecondsSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemDateTime_Impl::SetMicrosecondsSpecified(
                    this,
                    core::mem::transmute_copy(&bmicrosecondsspecified),
                )
                .into()
            }
        }
        unsafe extern "system" fn UTC<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iutc: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetUTC<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iutc: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn UTCSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            butcspecified: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetUTCSpecified<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemDateTime_Impl::SetUTCSpecified(
                    this,
                    core::mem::transmute_copy(&butcspecified),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsInterval<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bisinterval: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetIsInterval<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemDateTime_Impl::SetIsInterval(this, core::mem::transmute_copy(&bisinterval))
                    .into()
            }
        }
        unsafe extern "system" fn GetVarDate<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bislocal: super::super::Foundation::VARIANT_BOOL,
            dvardate: *mut f64,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn SetVarDate<Identity: ISWbemDateTime_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dvardate: f64,
            bislocal: super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemDateTime_Impl::SetVarDate(
                    this,
                    core::mem::transmute_copy(&dvardate),
                    core::mem::transmute_copy(&bislocal),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetFileTime<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bislocal: super::super::Foundation::VARIANT_BOOL,
            strfiletime: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetFileTime<
            Identity: ISWbemDateTime_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strfiletime: *mut core::ffi::c_void,
            bislocal: super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemDateTime_Impl::SetFileTime(
                    this,
                    core::mem::transmute(&strfiletime),
                    core::mem::transmute_copy(&bislocal),
                )
                .into()
            }
...
impl ISWbemEventSource {
    pub unsafe fn NextEvent(&self, itimeoutms: i32) -> windows_core::Result<ISWbemObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).NextEvent)(
                windows_core::Interface::as_raw(self),
                itimeoutms,
                &mut result__,
            )
    ...
    pub unsafe fn Security_(&self) -> windows_core::Result<ISWbemSecurity> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Security_)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ISWbemEventSource_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub NextEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Security_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ISWbemEventSource_Vtbl {
    pub const fn new<Identity: ISWbemEventSource_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn NextEvent<
            Identity: ISWbemEventSource_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            itimeoutms: i32,
            objwbemobject: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemEventSource_Impl::NextEvent(
                    this,
                    core::mem::transmute_copy(&itimeoutms),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Security_<
            Identity: ISWbemEventSource_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            objwbemsecurity: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
#[cfg(feature = "Win32_System_Com")]
impl ISWbemLocator {
    pub unsafe fn ConnectServer<P7>(
        &self,
        strserver: &windows_core::BSTR,
        strnamespace: &windows_core::BSTR,
    ...
    ) -> windows_core::Result<ISWbemServices>
    where
        P7: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ConnectServer)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strserver),
                core::mem::transmute_copy(strnamespace),
                core::mem::transmute_copy(struser),
                core::mem::transmute_copy(strpassword),
                core::mem::transmute_copy(strlocale),
                core::mem::transmute_copy(strauthority),
                isecurityflags,
...
pub trait ISWbemLocator_Impl: super::Com::IDispatch_Impl {
    fn ConnectServer(
        ...
        strauthority: &windows_core::BSTR,
        isecurityflags: i32,
        objwbemnamedvalueset: windows_core::Ref<'_, super::Com::IDispatch>,
    ) -> windows_core::Result<ISWbemServices>;
    fn Security_(&self) -> windows_core::Result<ISWbemSecurity>;
}
#[cfg(all(
...
impl ISWbemLocator_Vtbl {
    pub const fn new<Identity: ISWbemLocator_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ConnectServer<
            Identity: ISWbemLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strserver: *mut core::ffi::c_void,
            strnamespace: *mut core::ffi::c_void,
            struser: *mut core::ffi::c_void,
            strpassword: *mut core::ffi::c_void,
            strlocale: *mut core::ffi::c_void,
            strauthority: *mut core::ffi::c_void,
            isecurityflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            objwbemservices: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemLocator_Impl::ConnectServer(
                    this,
                    core::mem::transmute(&strserver),
                    core::mem::transmute(&strnamespace),
                    core::mem::transmute(&struser),
                    core::mem::transmute(&strpassword),
                    core::mem::transmute(&strlocale),
                    core::mem::transmute(&strauthority),
                    core::mem::transmute_copy(&isecurityflags),
        ...
        unsafe extern "system" fn Security_<Identity: ISWbemLocator_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemsecurity: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl ISWbemMethod {
    ...
    pub unsafe fn InParameters(&self) -> windows_core::Result<ISWbemObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).InParameters)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn OutParameters(&self) -> windows_core::Result<ISWbemObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OutParameters)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn Qualifiers_(&self) -> windows_core::Result<ISWbemQualifierSet> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Qualifiers_)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ISWbemMethod_Vtbl {
    ...
    pub InParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OutParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Qualifiers_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ISWbemMethod_Vtbl {
    pub const fn new<Identity: ISWbemMethod_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Name<Identity: ISWbemMethod_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Origin<Identity: ISWbemMethod_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strorigin: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn InParameters<Identity: ISWbemMethod_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbeminparameters: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OutParameters<
            Identity: ISWbemMethod_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            objwbemoutparameters: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Qualifiers_<Identity: ISWbemMethod_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemqualifierset: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ISWbemMethodSet {
    ...
    pub unsafe fn Item(
        &self,
        strname: &windows_core::BSTR,
        iflags: i32,
    ) -> windows_core::Result<ISWbemMethod> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Item)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strname),
                iflags,
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub trait ISWbemMethodSet_Impl: super::Com::IDispatch_Impl {
    ...
    fn Item(&self, strname: &windows_core::BSTR, iflags: i32)
        -> windows_core::Result<ISWbemMethod>;
...
impl ISWbemMethodSet_Vtbl {
    pub const fn new<Identity: ISWbemMethodSet_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn _NewEnum<Identity: ISWbemMethodSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Item<Identity: ISWbemMethodSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strname: *mut core::ffi::c_void,
            iflags: i32,
            objwbemmethod: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemMethodSet_Impl::Item(
                    this,
                    core::mem::transmute(&strname),
        ...
        unsafe extern "system" fn Count<Identity: ISWbemMethodSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            icount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl ISWbemNamedValue {
    ...
    pub unsafe fn SetValue(
        &self,
        varvalue: *const super::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetValue)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(varvalue),
            )
            .ok()
        }
    }
...
impl ISWbemNamedValue_Vtbl {
    pub const fn new<Identity: ISWbemNamedValue_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Value<Identity: ISWbemNamedValue_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            varvalue: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetValue<Identity: ISWbemNamedValue_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            varvalue: *const super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Name<Identity: ISWbemNamedValue_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl ISWbemNamedValueSet {
    ...
    pub unsafe fn Item(
        ...
        strname: &windows_core::BSTR,
        iflags: i32,
    ) -> windows_core::Result<ISWbemNamedValue> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Item)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn DeleteAll(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteAll)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
}
...
impl ISWbemNamedValueSet_Vtbl {
    pub const fn new<Identity: ISWbemNamedValueSet_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn _NewEnum<
            Identity: ISWbemNamedValueSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            punk: *mut *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Item<Identity: ISWbemNamedValueSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strname: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalue: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemNamedValueSet_Impl::Item(
                    this,
                    core::mem::transmute(&strname),
                    core::mem::transmute_copy(&iflags),
                ) {
        ...
        unsafe extern "system" fn Count<Identity: ISWbemNamedValueSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            icount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Add<Identity: ISWbemNamedValueSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strname: *mut core::ffi::c_void,
            varvalue: *const super::Variant::VARIANT,
            iflags: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemNamedValueSet_Impl::Add(
                    this,
                    core::mem::transmute(&strname),
                    core::mem::transmute_copy(&varvalue),
                    core::mem::transmute_copy(&iflags),
                ) {
                    Ok(ok__) => {
                        objwbemnamedvalue.write(core::mem::transmute(ok__));
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemNamedValueSet_Impl::Remove(
                    this,
                    core::mem::transmute(&strname),
                    core::mem::transmute_copy(&iflags),
                )
        ...
        unsafe extern "system" fn Clone<Identity: ISWbemNamedValueSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemnamedvalueset: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn DeleteAll<
            Identity: ISWbemNamedValueSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
#[cfg(feature = "Win32_System_Com")]
impl ISWbemObject {
    pub unsafe fn Put_<P1>(
        &self,
        iflags: i32,
        objwbemnamedvalueset: P1,
    ) -> windows_core::Result<ISWbemObjectPath>
    where
        P1: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Put_)(
                windows_core::Interface::as_raw(self),
                iflags,
                objwbemnamedvalueset.param().abi(),
                &mut result__,
    ...
    pub unsafe fn PutAsync_<P0, P2, P3>(
        &self,
        objwbemsink: P0,
        iflags: i32,
        objwbemnamedvalueset: P2,
        objwbemasynccontext: P3,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PutAsync_)(
                windows_core::Interface::as_raw(self),
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Delete_)(
                windows_core::Interface::as_raw(self),
                iflags,
                objwbemnamedvalueset.param().abi(),
            )
    ...
    pub unsafe fn DeleteAsync_<P0, P2, P3>(
        &self,
        objwbemsink: P0,
        iflags: i32,
        objwbemnamedvalueset: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteAsync_)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                iflags,
                objwbemnamedvalueset.param().abi(),
        ...
        P1: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Instances_)(
                windows_core::Interface::as_raw(self),
                iflags,
                objwbemnamedvalueset.param().abi(),
                &mut result__,
    ...
    pub unsafe fn InstancesAsync_<P0, P2, P3>(
        &self,
        objwbemsink: P0,
        iflags: i32,
        objwbemnamedvalueset: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).InstancesAsync_)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                iflags,
                objwbemnamedvalueset.param().abi(),
        ...
        P1: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Subclasses_)(
                windows_core::Interface::as_raw(self),
                iflags,
                objwbemnamedvalueset.param().abi(),
                &mut result__,
    ...
    pub unsafe fn SubclassesAsync_<P0, P2, P3>(
        &self,
        objwbemsink: P0,
        iflags: i32,
        objwbemnamedvalueset: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SubclassesAsync_)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                iflags,
                objwbemnamedvalueset.param().abi(),
    ...
    pub unsafe fn Associators_<P9>(
        &self,
        strassocclass: &windows_core::BSTR,
        strresultclass: &windows_core::BSTR,
        strresultrole: &windows_core::BSTR,
        strrole: &windows_core::BSTR,
        bclassesonly: super::super::Foundation::VARIANT_BOOL,
        bschemaonly: super::super::Foundation::VARIANT_BOOL,
        strrequiredassocqualifier: &windows_core::BSTR,
        strrequiredqualifier: &windows_core::BSTR,
        iflags: i32,
        ...
        P9: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Associators_)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn AssociatorsAsync_<P0, P10, P11>(
        &self,
        objwbemsink: P0,
        strassocclass: &windows_core::BSTR,
        strresultclass: &windows_core::BSTR,
        ...
        P6: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).References_)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strresultclass),
                core::mem::transmute_copy(strrole),
                bclassesonly,
    ...
    pub unsafe fn ReferencesAsync_<P0, P7, P8>(
        &self,
        objwbemsink: P0,
        strresultclass: &windows_core::BSTR,
        strrole: &windows_core::BSTR,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ReferencesAsync_)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                core::mem::transmute_copy(strresultclass),
                core::mem::transmute_copy(strrole),
    ...
    pub unsafe fn ExecMethod_<P1, P3>(
        &self,
        strmethodname: &windows_core::BSTR,
        objwbeminparameters: P1,
        iflags: i32,
        objwbemnamedvalueset: P3,
    ) -> windows_core::Result<ISWbemObject>
    where
        P1: windows_core::Param<super::Com::IDispatch>,
        P3: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExecMethod_)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strmethodname),
                objwbeminparameters.param().abi(),
                iflags,
                objwbemnamedvalueset.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn ExecMethodAsync_<P0, P2, P4, P5>(
        &self,
        objwbemsink: P0,
        strmethodname: &windows_core::BSTR,
        objwbeminparameters: P2,
        iflags: i32,
        objwbemnamedvalueset: P4,
        objwbemasynccontext: P5,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::Com::IDispatch>,
        P2: windows_core::Param<super::Com::IDispatch>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ExecMethodAsync_)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                core::mem::transmute_copy(strmethodname),
                objwbeminparameters.param().abi(),
    ...
    pub unsafe fn Clone_(&self) -> windows_core::Result<ISWbemObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone_)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetObjectText_(&self, iflags: i32) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetObjectText_)(
                windows_core::Interface::as_raw(self),
                iflags,
                &mut result__,
            )
    ...
    pub unsafe fn SpawnDerivedClass_(&self, iflags: i32) -> windows_core::Result<ISWbemObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SpawnDerivedClass_)(
                windows_core::Interface::as_raw(self),
                iflags,
                &mut result__,
            )
    ...
    pub unsafe fn SpawnInstance_(&self, iflags: i32) -> windows_core::Result<ISWbemObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SpawnInstance_)(
                windows_core::Interface::as_raw(self),
                iflags,
                &mut result__,
            )
        ...
        P0: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CompareTo_)(
                windows_core::Interface::as_raw(self),
                objwbemobject.param().abi(),
                iflags,
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn Properties_(&self) -> windows_core::Result<ISWbemPropertySet> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Properties_)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn Methods_(&self) -> windows_core::Result<ISWbemMethodSet> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Methods_)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn Derivation_(&self) -> windows_core::Result<super::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Derivation_)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn Path_(&self) -> windows_core::Result<ISWbemObjectPath> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Path_)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ISWbemObject_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub Put_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub PutAsync_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
    ...
    pub Delete_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeleteAsync_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
    ...
    pub Instances_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub InstancesAsync_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
    ...
    pub Subclasses_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SubclassesAsync_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
    ...
    pub Associators_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub AssociatorsAsync_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub References_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ...
    pub ReferencesAsync_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub ExecMethod_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
    ...
    pub ExecMethodAsync_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub Clone_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetObjectText_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SpawnDerivedClass_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SpawnInstance_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CompareTo_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        *mut super::super::Foundation::VARIANT_BOOL,
    ...
    pub Properties_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Methods_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub Derivation_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    Derivation_: usize,
    pub Path_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Security_: unsafe extern "system" fn(
...
pub trait ISWbemObject_Impl: super::Com::IDispatch_Impl {
    ...
    fn PutAsync_(
        &self,
        objwbemsink: windows_core::Ref<'_, super::Com::IDispatch>,
        iflags: i32,
        objwbemnamedvalueset: windows_core::Ref<'_, super::Com::IDispatch>,
        objwbemasynccontext: windows_core::Ref<'_, super::Com::IDispatch>,
    ) -> windows_core::Result<()>;
    fn Delete_(
        &self,
        iflags: i32,
    ...
    fn ExecMethod_(
        &self,
        strmethodname: &windows_core::BSTR,
        objwbeminparameters: windows_core::Ref<'_, super::Com::IDispatch>,
        iflags: i32,
        objwbemnamedvalueset: windows_core::Ref<'_, super::Com::IDispatch>,
    ) -> windows_core::Result<ISWbemObject>;
    fn ExecMethodAsync_(
    ...
    fn CompareTo_(
        &self,
        objwbemobject: windows_core::Ref<'_, super::Com::IDispatch>,
        iflags: i32,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL>;
    fn Qualifiers_(&self) -> windows_core::Result<ISWbemQualifierSet>;
...
impl ISWbemObject_Vtbl {
    pub const fn new<Identity: ISWbemObject_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Put_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            objwbemobjectpath: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemObject_Impl::Put_(
                    this,
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
                ) {
        ...
        unsafe extern "system" fn PutAsync_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Delete_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn DeleteAsync_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemsink: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemObject_Impl::DeleteAsync_(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
        ...
        unsafe extern "system" fn Instances_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemObject_Impl::Instances_(
                    this,
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
                ) {
        ...
        unsafe extern "system" fn InstancesAsync_<
            Identity: ISWbemObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            objwbemsink: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemObject_Impl::InstancesAsync_(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
        ...
        unsafe extern "system" fn Subclasses_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            objwbemobjectset: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemObject_Impl::Subclasses_(
                    this,
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
                ) {
        ...
        unsafe extern "system" fn SubclassesAsync_<
            Identity: ISWbemObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemObject_Impl::SubclassesAsync_(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
        ...
        unsafe extern "system" fn Associators_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strassocclass: *mut core::ffi::c_void,
            strresultclass: *mut core::ffi::c_void,
            strresultrole: *mut core::ffi::c_void,
            strrole: *mut core::ffi::c_void,
            bclassesonly: super::super::Foundation::VARIANT_BOOL,
            bschemaonly: super::super::Foundation::VARIANT_BOOL,
            strrequiredassocqualifier: *mut core::ffi::c_void,
            strrequiredqualifier: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            objwbemobjectset: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemObject_Impl::Associators_(
                    this,
        ...
        unsafe extern "system" fn AssociatorsAsync_<
            Identity: ISWbemObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn References_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strresultclass: *mut core::ffi::c_void,
            strrole: *mut core::ffi::c_void,
            bclassesonly: super::super::Foundation::VARIANT_BOOL,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemObject_Impl::References_(
                    this,
                    core::mem::transmute(&strresultclass),
                    core::mem::transmute(&strrole),
                    core::mem::transmute_copy(&bclassesonly),
        ...
        unsafe extern "system" fn ReferencesAsync_<
            Identity: ISWbemObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemObject_Impl::ReferencesAsync_(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute(&strresultclass),
                    core::mem::transmute(&strrole),
        ...
        unsafe extern "system" fn ExecMethod_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strmethodname: *mut core::ffi::c_void,
            objwbeminparameters: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            objwbemoutparameters: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemObject_Impl::ExecMethod_(
                    this,
                    core::mem::transmute(&strmethodname),
                    core::mem::transmute_copy(&objwbeminparameters),
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn ExecMethodAsync_<
            Identity: ISWbemObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemObject_Impl::ExecMethodAsync_(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute(&strmethodname),
                    core::mem::transmute_copy(&objwbeminparameters),
        ...
        unsafe extern "system" fn Clone_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemobject: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetObjectText_<
            Identity: ISWbemObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            iflags: i32,
            strobjecttext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SpawnDerivedClass_<
            Identity: ISWbemObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemObject_Impl::SpawnDerivedClass_(
                    this,
                    core::mem::transmute_copy(&iflags),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SpawnInstance_<
            Identity: ISWbemObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CompareTo_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemobject: *mut core::ffi::c_void,
            iflags: i32,
            bresult: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemObject_Impl::CompareTo_(
                    this,
                    core::mem::transmute_copy(&objwbemobject),
                    core::mem::transmute_copy(&iflags),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Qualifiers_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemqualifierset: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Properties_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbempropertyset: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Methods_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemmethodset: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Derivation_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strclassnamearray: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Path_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemobjectpath: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Security_<Identity: ISWbemObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemsecurity: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl ISWbemObjectEx {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Refresh_)(
                windows_core::Interface::as_raw(self),
                iflags,
                objwbemnamedvalueset.param().abi(),
            )
    ...
    pub unsafe fn SystemProperties_(&self) -> windows_core::Result<ISWbemPropertySet> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SystemProperties_)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P2: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetText_)(
                windows_core::Interface::as_raw(self),
                iobjecttextformat,
                iflags,
                objwbemnamedvalueset.param().abi(),
    ...
    pub unsafe fn SetFromText_<P3>(
        &self,
        bstext: &windows_core::BSTR,
        iobjecttextformat: WbemObjectTextFormatEnum,
        iflags: i32,
        objwbemnamedvalueset: P3,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetFromText_)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstext),
                iobjecttextformat,
                iflags,
                objwbemnamedvalueset.param().abi(),
            )
...
pub struct ISWbemObjectEx_Vtbl {
    pub base__: ISWbemObject_Vtbl,
    pub Refresh_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SystemProperties_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetText_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub SetFromText_: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WbemObjectTextFormatEnum,
        i32,
...
impl ISWbemObjectEx_Vtbl {
    pub const fn new<Identity: ISWbemObjectEx_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Refresh_<Identity: ISWbemObjectEx_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn SystemProperties_<
            Identity: ISWbemObjectEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            objwbempropertyset: *mut *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetText_<Identity: ISWbemObjectEx_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iobjecttextformat: WbemObjectTextFormatEnum,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            bstext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemObjectEx_Impl::GetText_(
                    this,
                    core::mem::transmute_copy(&iobjecttextformat),
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SetFromText_<
            Identity: ISWbemObjectEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstext: *mut core::ffi::c_void,
            iobjecttextformat: WbemObjectTextFormatEnum,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemObjectEx_Impl::SetFromText_(
                    this,
                    core::mem::transmute(&bstext),
                    core::mem::transmute_copy(&iobjecttextformat),
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
                )
...
impl ISWbemObjectPath {
    ...
    pub unsafe fn SetPath(&self, strpath: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPath)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strpath),
            )
            .ok()
        }
    }
    pub unsafe fn RelPath(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RelPath)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetRelPath(&self, strrelpath: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetRelPath)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strrelpath),
            )
            .ok()
        }
    }
    pub unsafe fn Server(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Server)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetServer(&self, strserver: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetServer)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strserver),
            )
            .ok()
    ...
    pub unsafe fn Namespace(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Namespace)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetNamespace(
        &self,
        strnamespace: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetNamespace)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strnamespace),
            )
            .ok()
    ...
    pub unsafe fn ParentNamespace(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ParentNamespace)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetDisplayName(
        &self,
        strdisplayname: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDisplayName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strdisplayname),
            )
            .ok()
        }
    }
    pub unsafe fn Class(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Class)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetClass(&self, strclass: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetClass)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strclass),
            )
            .ok()
        }
    }
    pub unsafe fn IsClass(&self) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsClass)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetAsClass(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAsClass)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    }
    pub unsafe fn IsSingleton(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsSingleton)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetAsSingleton(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAsSingleton)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn Keys(&self) -> windows_core::Result<ISWbemNamedValueSet> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Keys)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn Locale(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Locale)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetLocale(&self, strlocale: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLocale)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strlocale),
            )
            .ok()
    ...
    pub unsafe fn Authority(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Authority)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetAuthority(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetAuthority)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strauthority),
            )
            .ok()
...
pub struct ISWbemObjectPath_Vtbl {
    ...
    pub RelPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetRelPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Server: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetServer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Namespace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetNamespace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ParentNamespace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub Class: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub Authority: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetAuthority: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ISWbemObjectPath_Vtbl {
    pub const fn new<Identity: ISWbemObjectPath_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Path<Identity: ISWbemObjectPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strpath: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetPath<Identity: ISWbemObjectPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strpath: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn RelPath<Identity: ISWbemObjectPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strrelpath: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetRelPath<
            Identity: ISWbemObjectPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strrelpath: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Server<Identity: ISWbemObjectPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strserver: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetServer<
            Identity: ISWbemObjectPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Namespace<
            Identity: ISWbemObjectPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strnamespace: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetNamespace<
            Identity: ISWbemObjectPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemObjectPath_Impl::SetNamespace(this, core::mem::transmute(&strnamespace))
                    .into()
            }
        }
        unsafe extern "system" fn ParentNamespace<
            Identity: ISWbemObjectPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strparentnamespace: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            strdisplayname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            strdisplayname: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemObjectPath_Impl::SetDisplayName(this, core::mem::transmute(&strdisplayname))
                    .into()
            }
        }
        unsafe extern "system" fn Class<Identity: ISWbemObjectPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strclass: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetClass<Identity: ISWbemObjectPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strclass: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsClass<Identity: ISWbemObjectPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bisclass: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetAsClass<
            Identity: ISWbemObjectPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn IsSingleton<
            Identity: ISWbemObjectPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bissingleton: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetAsSingleton<
            Identity: ISWbemObjectPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Keys<Identity: ISWbemObjectPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemnamedvalueset: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Locale<Identity: ISWbemObjectPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strlocale: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetLocale<
            Identity: ISWbemObjectPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Authority<
            Identity: ISWbemObjectPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strauthority: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetAuthority<
            Identity: ISWbemObjectPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemObjectPath_Impl::SetAuthority(this, core::mem::transmute(&strauthority))
                    .into()
            }
        }
        Self {
...
impl ISWbemObjectSet {
    ...
    pub unsafe fn Item(
        &self,
        strobjectpath: &windows_core::BSTR,
        iflags: i32,
    ) -> windows_core::Result<ISWbemObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ISWbemObjectSet_Vtbl {
    pub const fn new<Identity: ISWbemObjectSet_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn _NewEnum<Identity: ISWbemObjectSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            punk: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Item<Identity: ISWbemObjectSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strobjectpath: *mut core::ffi::c_void,
            iflags: i32,
            objwbemobject: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemObjectSet_Impl::Item(
                    this,
        ...
        unsafe extern "system" fn Count<Identity: ISWbemObjectSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            icount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Security_<Identity: ISWbemObjectSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemsecurity: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ItemIndex<Identity: ISWbemObjectSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lindex: i32,
            objwbemobject: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
...
impl ISWbemPrivilege {
    ...
    pub unsafe fn SetIsEnabled(
        &self,
        bisenabled: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
...
impl ISWbemPrivilege_Vtbl {
    pub const fn new<Identity: ISWbemPrivilege_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsEnabled<Identity: ISWbemPrivilege_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bisenabled: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemPrivilege_Impl::SetIsEnabled(this, core::mem::transmute_copy(&bisenabled))
                    .into()
            }
        }
        unsafe extern "system" fn Name<Identity: ISWbemPrivilege_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strdisplayname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl ISWbemPrivilegeSet {
    ...
    ) -> windows_core::Result<ISWbemPrivilege> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Item)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn AddAsString(
        &self,
        strprivilege: &windows_core::BSTR,
        bisenabled: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<ISWbemPrivilege> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AddAsString)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strprivilege),
                bisenabled,
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ISWbemPrivilegeSet_Vtbl {
    ...
    pub DeleteAll: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub AddAsString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
        *mut *mut core::ffi::c_void,
...
impl ISWbemPrivilegeSet_Vtbl {
    pub const fn new<Identity: ISWbemPrivilegeSet_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn _NewEnum<
            Identity: ISWbemPrivilegeSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            punk: *mut *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Item<Identity: ISWbemPrivilegeSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iprivilege: WbemPrivilegeEnum,
            objwbemprivilege: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Count<Identity: ISWbemPrivilegeSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            icount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Add<Identity: ISWbemPrivilegeSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iprivilege: WbemPrivilegeEnum,
            bisenabled: super::super::Foundation::VARIANT_BOOL,
            objwbemprivilege: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemPrivilegeSet_Impl::Add(
                    this,
                    core::mem::transmute_copy(&iprivilege),
                    core::mem::transmute_copy(&bisenabled),
                ) {
                    Ok(ok__) => {
                        objwbemprivilege.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn Remove<Identity: ISWbemPrivilegeSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iprivilege: WbemPrivilegeEnum,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn AddAsString<
            Identity: ISWbemPrivilegeSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strprivilege: *mut core::ffi::c_void,
            bisenabled: super::super::Foundation::VARIANT_BOOL,
            objwbemprivilege: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemPrivilegeSet_Impl::AddAsString(
                    this,
                    core::mem::transmute(&strprivilege),
                    core::mem::transmute_copy(&bisenabled),
                ) {
                    Ok(ok__) => {
                        objwbemprivilege.write(core::mem::transmute(ok__));
...
impl ISWbemProperty {
    ...
    pub unsafe fn IsLocal(&self) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsLocal)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn CIMType(&self) -> windows_core::Result<WbemCimtypeEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CIMType)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn IsArray(&self) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsArray)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct ISWbemProperty_Vtbl {
    ...
    pub IsLocal: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub Origin: unsafe extern "system" fn(
    ...
    pub CIMType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WbemCimtypeEnum,
    ) -> windows_core::HRESULT,
    pub Qualifiers_: unsafe extern "system" fn(
...
impl ISWbemProperty_Vtbl {
    pub const fn new<Identity: ISWbemProperty_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Value<Identity: ISWbemProperty_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            varvalue: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetValue<Identity: ISWbemProperty_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            varvalue: *const super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Name<Identity: ISWbemProperty_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn IsLocal<Identity: ISWbemProperty_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bislocal: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Origin<Identity: ISWbemProperty_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strorigin: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn CIMType<Identity: ISWbemProperty_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Qualifiers_<
            Identity: ISWbemProperty_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            objwbemqualifierset: *mut *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn IsArray<Identity: ISWbemProperty_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bisarray: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ISWbemPropertySet {
    ...
    pub unsafe fn Item(
        ...
        strname: &windows_core::BSTR,
        iflags: i32,
    ) -> windows_core::Result<ISWbemProperty> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Item)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn Add(
        ...
        bisarray: super::super::Foundation::VARIANT_BOOL,
        iflags: i32,
    ) -> windows_core::Result<ISWbemProperty> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ISWbemPropertySet_Vtbl {
    pub const fn new<Identity: ISWbemPropertySet_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn _NewEnum<
            Identity: ISWbemPropertySet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            punk: *mut *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Item<Identity: ISWbemPropertySet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strname: *mut core::ffi::c_void,
            iflags: i32,
            objwbemproperty: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemPropertySet_Impl::Item(
                    this,
                    core::mem::transmute(&strname),
                    core::mem::transmute_copy(&iflags),
                ) {
        ...
        unsafe extern "system" fn Count<Identity: ISWbemPropertySet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            icount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Add<Identity: ISWbemPropertySet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strname: *mut core::ffi::c_void,
            icimtype: WbemCimtypeEnum,
            bisarray: super::super::Foundation::VARIANT_BOOL,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemPropertySet_Impl::Add(
                    this,
                    core::mem::transmute(&strname),
                    core::mem::transmute_copy(&icimtype),
                    core::mem::transmute_copy(&bisarray),
                    core::mem::transmute_copy(&iflags),
                ) {
                    Ok(ok__) => {
                        objwbemproperty.write(core::mem::transmute(ok__));
        ...
        unsafe extern "system" fn Remove<Identity: ISWbemPropertySet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strname: *mut core::ffi::c_void,
            iflags: i32,
        ) -> windows_core::HRESULT {
...
impl ISWbemQualifier {
    ...
    pub unsafe fn PropagatesToSubclass(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PropagatesToSubclass)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetPropagatesToSubclass(
        &self,
        bpropagatestosubclass: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPropagatesToSubclass)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn PropagatesToInstance(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PropagatesToInstance)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetPropagatesToInstance(
        &self,
        bpropagatestoinstance: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPropagatesToInstance)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn IsOverridable(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsOverridable)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetIsOverridable(
        &self,
        bisoverridable: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetIsOverridable)(
                windows_core::Interface::as_raw(self),
                bisoverridable,
            )
            .ok()
    ...
    pub unsafe fn IsAmended(&self) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsAmended)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct ISWbemQualifier_Vtbl {
    ...
    pub PropagatesToSubclass: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetPropagatesToSubclass: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub PropagatesToInstance: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetPropagatesToInstance: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub IsOverridable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetIsOverridable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub IsAmended: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
}
...
impl ISWbemQualifier_Vtbl {
    pub const fn new<Identity: ISWbemQualifier_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Value<Identity: ISWbemQualifier_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            varvalue: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetValue<Identity: ISWbemQualifier_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            varvalue: *const super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Name<Identity: ISWbemQualifier_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn IsLocal<Identity: ISWbemQualifier_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bislocal: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn PropagatesToSubclass<
            Identity: ISWbemQualifier_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bpropagatestosubclass: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetPropagatesToSubclass<
            Identity: ISWbemQualifier_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemQualifier_Impl::SetPropagatesToSubclass(
                    this,
                    core::mem::transmute_copy(&bpropagatestosubclass),
                )
                .into()
            }
        }
        unsafe extern "system" fn PropagatesToInstance<
            Identity: ISWbemQualifier_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bpropagatestoinstance: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetPropagatesToInstance<
            Identity: ISWbemQualifier_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemQualifier_Impl::SetPropagatesToInstance(
                    this,
                    core::mem::transmute_copy(&bpropagatestoinstance),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsOverridable<
            Identity: ISWbemQualifier_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bisoverridable: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetIsOverridable<
            Identity: ISWbemQualifier_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemQualifier_Impl::SetIsOverridable(
                    this,
                    core::mem::transmute_copy(&bisoverridable),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsAmended<Identity: ISWbemQualifier_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bisamended: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ISWbemQualifierSet {
    ...
    pub unsafe fn Item(
        ...
        iflags: i32,
    ) -> windows_core::Result<ISWbemQualifier> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Item)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn Add(
        &self,
        strname: &windows_core::BSTR,
        varval: *const super::Variant::VARIANT,
        bpropagatestosubclass: super::super::Foundation::VARIANT_BOOL,
        bpropagatestoinstance: super::super::Foundation::VARIANT_BOOL,
        bisoverridable: super::super::Foundation::VARIANT_BOOL,
        iflags: i32,
...
pub trait ISWbemQualifierSet_Impl: super::Com::IDispatch_Impl {
    fn _NewEnum(&self) -> windows_core::Result<windows_core::IUnknown>;
    fn Item(&self, name: &windows_core::BSTR, iflags: i32)
        -> windows_core::Result<ISWbemQualifier>;
    fn Count(&self) -> windows_core::Result<i32>;
    fn Add(
        &self,
...
impl ISWbemQualifierSet_Vtbl {
    pub const fn new<Identity: ISWbemQualifierSet_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Item<Identity: ISWbemQualifierSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            name: *mut core::ffi::c_void,
            iflags: i32,
            objwbemqualifier: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemQualifierSet_Impl::Item(
                    this,
        ...
        unsafe extern "system" fn Count<Identity: ISWbemQualifierSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            icount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Add<Identity: ISWbemQualifierSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strname: *mut core::ffi::c_void,
            varval: *const super::Variant::VARIANT,
            bpropagatestosubclass: super::super::Foundation::VARIANT_BOOL,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemQualifierSet_Impl::Add(
                    this,
                    core::mem::transmute(&strname),
                    core::mem::transmute_copy(&varval),
                    core::mem::transmute_copy(&bpropagatestosubclass),
                    core::mem::transmute_copy(&bpropagatestoinstance),
                    core::mem::transmute_copy(&bisoverridable),
                    core::mem::transmute_copy(&iflags),
        ...
        unsafe extern "system" fn Remove<Identity: ISWbemQualifierSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strname: *mut core::ffi::c_void,
            iflags: i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemQualifierSet_Impl::Remove(
                    this,
                    core::mem::transmute(&strname),
                    core::mem::transmute_copy(&iflags),
                )
...
impl ISWbemRefreshableItem {
    ...
    pub unsafe fn Refresher(&self) -> windows_core::Result<ISWbemRefresher> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Refresher)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn IsSet(&self) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsSet)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn Object(&self) -> windows_core::Result<ISWbemObjectEx> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Object)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn ObjectSet(&self) -> windows_core::Result<ISWbemObjectSet> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ObjectSet)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ISWbemRefreshableItem_Vtbl {
    ...
    pub Refresher: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsSet: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub Object: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ObjectSet: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl ISWbemRefreshableItem_Vtbl {
    pub const fn new<Identity: ISWbemRefreshableItem_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Index<
            Identity: ISWbemRefreshableItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            iindex: *mut i32,
        ...
        unsafe extern "system" fn Refresher<
            Identity: ISWbemRefreshableItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            objwbemrefresher: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsSet<
            Identity: ISWbemRefreshableItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bisset: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ObjectSet<
            Identity: ISWbemRefreshableItem_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl ISWbemRefresher {
    ...
    pub unsafe fn Add<P0, P3>(
        &self,
        objwbemservices: P0,
        bsinstancepath: &windows_core::BSTR,
        iflags: i32,
        objwbemnamedvalueset: P3,
    ) -> windows_core::Result<ISWbemRefreshableItem>
    where
        ...
        P3: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).Add)(
                windows_core::Interface::as_raw(self),
                objwbemservices.param().abi(),
                core::mem::transmute_copy(bsinstancepath),
                iflags,
                objwbemnamedvalueset.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn AddEnum<P0, P3>(
        &self,
        objwbemservices: P0,
        bsclassname: &windows_core::BSTR,
        iflags: i32,
        objwbemnamedvalueset: P3,
    ) -> windows_core::Result<ISWbemRefreshableItem>
    where
        ...
        P3: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AddEnum)(
                windows_core::Interface::as_raw(self),
                objwbemservices.param().abi(),
                core::mem::transmute_copy(bsclassname),
                iflags,
                objwbemnamedvalueset.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn AutoReconnect(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AutoReconnect)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetAutoReconnect(
        &self,
        bcount: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAutoReconnect)(
                windows_core::Interface::as_raw(self),
                bcount,
            )
            .ok()
...
pub struct ISWbemRefresher_Vtbl {
    ...
    pub AddEnum: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
    ...
    pub SetAutoReconnect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub DeleteAll: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
...
pub trait ISWbemRefresher_Impl: super::Com::IDispatch_Impl {
    ...
    fn Add(
        &self,
        objwbemservices: windows_core::Ref<'_, ISWbemServicesEx>,
        bsinstancepath: &windows_core::BSTR,
        iflags: i32,
        objwbemnamedvalueset: windows_core::Ref<'_, super::Com::IDispatch>,
    ) -> windows_core::Result<ISWbemRefreshableItem>;
...
impl ISWbemRefresher_Vtbl {
    pub const fn new<Identity: ISWbemRefresher_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn _NewEnum<Identity: ISWbemRefresher_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            punk: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Item<Identity: ISWbemRefresher_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iindex: i32,
            objwbemrefreshableitem: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Count<Identity: ISWbemRefresher_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            icount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Add<Identity: ISWbemRefresher_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemservices: *mut core::ffi::c_void,
            bsinstancepath: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            objwbemrefreshableitem: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemRefresher_Impl::Add(
                    this,
                    core::mem::transmute_copy(&objwbemservices),
                    core::mem::transmute(&bsinstancepath),
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn AddEnum<Identity: ISWbemRefresher_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemservices: *mut core::ffi::c_void,
            bsclassname: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            objwbemrefreshableitem: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemRefresher_Impl::AddEnum(
                    this,
                    core::mem::transmute_copy(&objwbemservices),
                    core::mem::transmute(&bsclassname),
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Remove<Identity: ISWbemRefresher_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iindex: i32,
            iflags: i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemRefresher_Impl::Remove(
                    this,
                    core::mem::transmute_copy(&iindex),
                    core::mem::transmute_copy(&iflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn Refresh<Identity: ISWbemRefresher_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            iflags: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn AutoReconnect<
            Identity: ISWbemRefresher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bcount: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetAutoReconnect<
            Identity: ISWbemRefresher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemRefresher_Impl::SetAutoReconnect(this, core::mem::transmute_copy(&bcount))
                    .into()
            }
        }
        unsafe extern "system" fn DeleteAll<Identity: ISWbemRefresher_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
impl ISWbemSecurity {
    pub unsafe fn ImpersonationLevel(&self) -> windows_core::Result<WbemImpersonationLevelEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ImpersonationLevel)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetImpersonationLevel(
        &self,
        iimpersonationlevel: WbemImpersonationLevelEnum,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetImpersonationLevel)(
                windows_core::Interface::as_raw(self),
                iimpersonationlevel,
            )
            .ok()
    ...
    pub unsafe fn AuthenticationLevel(&self) -> windows_core::Result<WbemAuthenticationLevelEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AuthenticationLevel)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetAuthenticationLevel(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetAuthenticationLevel)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn Privileges(&self) -> windows_core::Result<ISWbemPrivilegeSet> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Privileges)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ISWbemSecurity_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub ImpersonationLevel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WbemImpersonationLevelEnum,
    ) -> windows_core::HRESULT,
    pub SetImpersonationLevel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WbemImpersonationLevelEnum,
    ) -> windows_core::HRESULT,
    pub AuthenticationLevel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WbemAuthenticationLevelEnum,
    ) -> windows_core::HRESULT,
    pub SetAuthenticationLevel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WbemAuthenticationLevelEnum,
    ) -> windows_core::HRESULT,
    pub Privileges: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ISWbemSecurity_Vtbl {
    pub const fn new<Identity: ISWbemSecurity_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetImpersonationLevel<
            Identity: ISWbemSecurity_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemSecurity_Impl::SetImpersonationLevel(
                    this,
                    core::mem::transmute_copy(&iimpersonationlevel),
                )
                .into()
            }
        }
        unsafe extern "system" fn AuthenticationLevel<
            Identity: ISWbemSecurity_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetAuthenticationLevel<
            Identity: ISWbemSecurity_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemSecurity_Impl::SetAuthenticationLevel(
                    this,
                    core::mem::transmute_copy(&iauthenticationlevel),
                )
                .into()
            }
        }
        unsafe extern "system" fn Privileges<Identity: ISWbemSecurity_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemprivilegeset: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ISWbemServices {
    ...
    pub unsafe fn GetAsync<P0, P3, P4>(
        &self,
        objwbemsink: P0,
        strobjectpath: &windows_core::BSTR,
        iflags: i32,
        objwbemnamedvalueset: P3,
        objwbemasynccontext: P4,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::Com::IDispatch>,
        P3: windows_core::Param<super::Com::IDispatch>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetAsync)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                core::mem::transmute_copy(strobjectpath),
                iflags,
    ...
    pub unsafe fn DeleteAsync<P0, P3, P4>(
        &self,
        objwbemsink: P0,
        strobjectpath: &windows_core::BSTR,
        iflags: i32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteAsync)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                core::mem::transmute_copy(strobjectpath),
                iflags,
        ...
        P2: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).InstancesOf)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strclass),
                iflags,
                objwbemnamedvalueset.param().abi(),
    ...
    pub unsafe fn InstancesOfAsync<P0, P3, P4>(
        &self,
        objwbemsink: P0,
        strclass: &windows_core::BSTR,
        iflags: i32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).InstancesOfAsync)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                core::mem::transmute_copy(strclass),
                iflags,
    ...
    pub unsafe fn SubclassesOf<P2>(
        &self,
        strsuperclass: &windows_core::BSTR,
        iflags: i32,
        objwbemnamedvalueset: P2,
    ) -> windows_core::Result<ISWbemObjectSet>
    where
        P2: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SubclassesOf)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strsuperclass),
                iflags,
                objwbemnamedvalueset.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn SubclassesOfAsync<P0, P3, P4>(
        &self,
        objwbemsink: P0,
        strsuperclass: &windows_core::BSTR,
        iflags: i32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SubclassesOfAsync)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                core::mem::transmute_copy(strsuperclass),
                iflags,
        ...
        P3: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExecQuery)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strquery),
                core::mem::transmute_copy(strquerylanguage),
                iflags,
                objwbemnamedvalueset.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn ExecQueryAsync<P0, P4, P5>(
        &self,
        objwbemsink: P0,
        strquery: &windows_core::BSTR,
        strquerylanguage: &windows_core::BSTR,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ExecQueryAsync)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                core::mem::transmute_copy(strquery),
                core::mem::transmute_copy(strquerylanguage),
    ...
    pub unsafe fn AssociatorsOfAsync<P0, P11, P12>(
        &self,
        objwbemsink: P0,
        strobjectpath: &windows_core::BSTR,
        strassocclass: &windows_core::BSTR,
        ...
        strrequiredqualifier: &windows_core::BSTR,
        iflags: i32,
        objwbemnamedvalueset: P11,
        objwbemasynccontext: P12,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::Com::IDispatch>,
        P11: windows_core::Param<super::Com::IDispatch>,
        ...
        P7: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReferencesTo)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strobjectpath),
                core::mem::transmute_copy(strresultclass),
                core::mem::transmute_copy(strrole),
    ...
    pub unsafe fn ReferencesToAsync<P0, P8, P9>(
        &self,
        objwbemsink: P0,
        strobjectpath: &windows_core::BSTR,
        strresultclass: &windows_core::BSTR,
        ...
        strrequiredqualifier: &windows_core::BSTR,
        iflags: i32,
        objwbemnamedvalueset: P8,
        objwbemasynccontext: P9,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::Com::IDispatch>,
        P8: windows_core::Param<super::Com::IDispatch>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ReferencesToAsync)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                core::mem::transmute_copy(strobjectpath),
                core::mem::transmute_copy(strresultclass),
    ...
    pub unsafe fn ExecNotificationQuery<P3>(
        ...
        iflags: i32,
        objwbemnamedvalueset: P3,
    ) -> windows_core::Result<ISWbemEventSource>
    where
        P3: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExecNotificationQuery)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strquery),
                core::mem::transmute_copy(strquerylanguage),
                iflags,
    ...
    pub unsafe fn ExecNotificationQueryAsync<P0, P4, P5>(
        &self,
        objwbemsink: P0,
        strquery: &windows_core::BSTR,
        strquerylanguage: &windows_core::BSTR,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ExecNotificationQueryAsync)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                core::mem::transmute_copy(strquery),
                core::mem::transmute_copy(strquerylanguage),
    ...
    pub unsafe fn ExecMethod<P2, P4>(
        &self,
        strobjectpath: &windows_core::BSTR,
        strmethodname: &windows_core::BSTR,
        objwbeminparameters: P2,
        ...
        P4: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExecMethod)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strobjectpath),
                core::mem::transmute_copy(strmethodname),
                objwbeminparameters.param().abi(),
    ...
    pub unsafe fn ExecMethodAsync<P0, P3, P5, P6>(
        &self,
        objwbemsink: P0,
        strobjectpath: &windows_core::BSTR,
        strmethodname: &windows_core::BSTR,
        objwbeminparameters: P3,
        iflags: i32,
        objwbemnamedvalueset: P5,
        objwbemasynccontext: P6,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::Com::IDispatch>,
        P3: windows_core::Param<super::Com::IDispatch>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ExecMethodAsync)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                core::mem::transmute_copy(strobjectpath),
                core::mem::transmute_copy(strmethodname),
...
pub struct ISWbemServices_Vtbl {
    ...
    pub InstancesOf: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
    ...
    pub InstancesOfAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
    ...
    pub SubclassesOf: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
    ...
    pub SubclassesOfAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
    ...
    pub ExecQueryAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub AssociatorsOf: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub ReferencesTo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub ReferencesToAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub ExecNotificationQuery: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
    ...
    pub ExecNotificationQueryAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub ExecMethod: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub ExecMethodAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
impl ISWbemServices_Vtbl {
    pub const fn new<Identity: ISWbemServices_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Get<Identity: ISWbemServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strobjectpath: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetAsync<Identity: ISWbemServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemsink: *mut core::ffi::c_void,
            strobjectpath: *mut core::ffi::c_void,
            iflags: i32,
        ...
        unsafe extern "system" fn Delete<Identity: ISWbemServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strobjectpath: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemServices_Impl::DeleteAsync(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute(&strobjectpath),
                    core::mem::transmute_copy(&iflags),
        ...
        unsafe extern "system" fn InstancesOf<
            Identity: ISWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemServices_Impl::InstancesOf(
                    this,
                    core::mem::transmute(&strclass),
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemServices_Impl::InstancesOfAsync(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute(&strclass),
                    core::mem::transmute_copy(&iflags),
        ...
        unsafe extern "system" fn SubclassesOf<
            Identity: ISWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strsuperclass: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            objwbemobjectset: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemServices_Impl::SubclassesOf(
                    this,
                    core::mem::transmute(&strsuperclass),
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SubclassesOfAsync<
            Identity: ISWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemServices_Impl::SubclassesOfAsync(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute(&strsuperclass),
                    core::mem::transmute_copy(&iflags),
        ...
        unsafe extern "system" fn ExecQuery<Identity: ISWbemServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strquery: *mut core::ffi::c_void,
            strquerylanguage: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            objwbemobjectset: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemServices_Impl::ExecQuery(
                    this,
                    core::mem::transmute(&strquery),
                    core::mem::transmute(&strquerylanguage),
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn ExecQueryAsync<
            Identity: ISWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemServices_Impl::ExecQueryAsync(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute(&strquery),
                    core::mem::transmute(&strquerylanguage),
        ...
        unsafe extern "system" fn AssociatorsOf<
            Identity: ISWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemServices_Impl::AssociatorsOf(
                    this,
                    core::mem::transmute(&strobjectpath),
                    core::mem::transmute(&strassocclass),
                    core::mem::transmute(&strresultclass),
        ...
        unsafe extern "system" fn AssociatorsOfAsync<
            Identity: ISWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn ReferencesTo<
            Identity: ISWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemServices_Impl::ReferencesTo(
                    this,
                    core::mem::transmute(&strobjectpath),
                    core::mem::transmute(&strresultclass),
                    core::mem::transmute(&strrole),
        ...
        unsafe extern "system" fn ReferencesToAsync<
            Identity: ISWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemServices_Impl::ReferencesToAsync(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute(&strobjectpath),
                    core::mem::transmute(&strresultclass),
        ...
        unsafe extern "system" fn ExecNotificationQuery<
            Identity: ISWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            objwbemeventsource: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemServices_Impl::ExecNotificationQuery(
                    this,
                    core::mem::transmute(&strquery),
                    core::mem::transmute(&strquerylanguage),
                    core::mem::transmute_copy(&iflags),
        ...
        unsafe extern "system" fn ExecNotificationQueryAsync<
            Identity: ISWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemServices_Impl::ExecNotificationQueryAsync(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute(&strquery),
                    core::mem::transmute(&strquerylanguage),
        ...
        unsafe extern "system" fn ExecMethod<Identity: ISWbemServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strobjectpath: *mut core::ffi::c_void,
            strmethodname: *mut core::ffi::c_void,
            objwbeminparameters: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemServices_Impl::ExecMethod(
                    this,
                    core::mem::transmute(&strobjectpath),
                    core::mem::transmute(&strmethodname),
                    core::mem::transmute_copy(&objwbeminparameters),
        ...
        unsafe extern "system" fn ExecMethodAsync<
            Identity: ISWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemServices_Impl::ExecMethodAsync(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute(&strobjectpath),
                    core::mem::transmute(&strmethodname),
        ...
        unsafe extern "system" fn Security_<Identity: ISWbemServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemsecurity: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl ISWbemServicesEx {
        ...
        P2: windows_core::Param<super::Com::IDispatch>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Put)(
                windows_core::Interface::as_raw(self),
                objwbemobject.param().abi(),
                iflags,
                objwbemnamedvalueset.param().abi(),
    ...
    pub unsafe fn PutAsync<P0, P1, P3, P4>(
        &self,
        objwbemsink: P0,
        objwbemobject: P1,
        iflags: i32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PutAsync)(
                windows_core::Interface::as_raw(self),
                objwbemsink.param().abi(),
                objwbemobject.param().abi(),
                iflags,
...
pub trait ISWbemServicesEx_Impl: ISWbemServices_Impl {
    fn Put(
        &self,
        objwbemobject: windows_core::Ref<'_, ISWbemObjectEx>,
        iflags: i32,
        objwbemnamedvalueset: windows_core::Ref<'_, super::Com::IDispatch>,
    ) -> windows_core::Result<ISWbemObjectPath>;
    fn PutAsync(
        &self,
        objwbemsink: windows_core::Ref<'_, ISWbemSink>,
        objwbemobject: windows_core::Ref<'_, ISWbemObjectEx>,
        iflags: i32,
        objwbemnamedvalueset: windows_core::Ref<'_, super::Com::IDispatch>,
        objwbemasynccontext: windows_core::Ref<'_, super::Com::IDispatch>,
...
impl ISWbemServicesEx_Vtbl {
    pub const fn new<Identity: ISWbemServicesEx_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Put<Identity: ISWbemServicesEx_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemobject: *mut core::ffi::c_void,
            iflags: i32,
            objwbemnamedvalueset: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISWbemServicesEx_Impl::Put(
                    this,
                    core::mem::transmute_copy(&objwbemobject),
                    core::mem::transmute_copy(&iflags),
                    core::mem::transmute_copy(&objwbemnamedvalueset),
        ...
        unsafe extern "system" fn PutAsync<Identity: ISWbemServicesEx_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            objwbemsink: *mut core::ffi::c_void,
            objwbemobject: *mut core::ffi::c_void,
            iflags: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISWbemServicesEx_Impl::PutAsync(
                    this,
                    core::mem::transmute_copy(&objwbemsink),
                    core::mem::transmute_copy(&objwbemobject),
                    core::mem::transmute_copy(&iflags),
        ...
        Self {
            base__: ISWbemServices_Vtbl::new::<Identity, OFFSET>(),
            Put: Put::<Identity, OFFSET>,
            PutAsync: PutAsync::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl ISWbemSink_Vtbl {
    pub const fn new<Identity: ISWbemSink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Cancel<Identity: ISWbemSink_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
impl IUnsecuredApartment {
        ...
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateObjectStub)(
                windows_core::Interface::as_raw(self),
                pobject.param().abi(),
                &mut result__,
            )
...
pub struct IUnsecuredApartment_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub CreateObjectStub: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IUnsecuredApartment_Impl: windows_core::IUnknownImpl {
    fn CreateObjectStub(
        &self,
        pobject: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<windows_core::IUnknown>;
}
impl IUnsecuredApartment_Vtbl {
    pub const fn new<Identity: IUnsecuredApartment_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateObjectStub<
            Identity: IUnsecuredApartment_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pobject: *mut core::ffi::c_void,
            ppstub: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IUnsecuredApartment_Impl::CreateObjectStub(
                    this,
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            CreateObjectStub: CreateObjectStub::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IWMIExtension {
    pub unsafe fn WMIObjectPath(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).WMIObjectPath)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn GetWMIObject(&self) -> windows_core::Result<ISWbemObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetWMIObject)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetWMIServices(&self) -> windows_core::Result<ISWbemServices> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetWMIServices)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IWMIExtension_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub WMIObjectPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetWMIObject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetWMIServices: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IWMIExtension_Vtbl {
    pub const fn new<Identity: IWMIExtension_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn WMIObjectPath<
            Identity: IWMIExtension_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strwmiobjectpath: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetWMIObject<
            Identity: IWMIExtension_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            objwmiobject: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetWMIServices<
            Identity: IWMIExtension_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            objwmiservices: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    IWbemAddressResolution_Vtbl,
    0xf7ce2e12_8c90_11d1_9e7b_00c04fc324a8
);
...
impl IWbemAddressResolution {
    pub unsafe fn Resolve<P0>(
        &self,
        wsznamespacepath: P0,
        wszaddresstype: windows_core::PWSTR,
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Resolve)(
                windows_core::Interface::as_raw(self),
                wsznamespacepath.param().abi(),
                core::mem::transmute(wszaddresstype),
                pdwaddresslength as _,
                pabbinaryaddress as _,
            )
            .ok()
        }
    }
...
pub trait IWbemAddressResolution_Impl: windows_core::IUnknownImpl {
    fn Resolve(
        &self,
        wsznamespacepath: &windows_core::PCWSTR,
        wszaddresstype: windows_core::PWSTR,
        pdwaddresslength: *mut u32,
        pabbinaryaddress: *mut *mut u8,
    ) -> windows_core::Result<()>;
...
impl IWbemAddressResolution_Vtbl {
    pub const fn new<Identity: IWbemAddressResolution_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Resolve<
            Identity: IWbemAddressResolution_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            wsznamespacepath: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemAddressResolution_Impl::Resolve(
                    this,
                    core::mem::transmute(&wsznamespacepath),
                    core::mem::transmute_copy(&wszaddresstype),
                    core::mem::transmute_copy(&pdwaddresslength),
                    core::mem::transmute_copy(&pabbinaryaddress),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xc49e32c7_bc8b_11d2_85d4_00105a1f8304
);
...
pub trait IWbemBackupRestore_Impl: windows_core::IUnknownImpl {
    fn Backup(
        &self,
        strbackuptofile: &windows_core::PCWSTR,
        lflags: i32,
    ) -> windows_core::Result<()>;
    fn Restore(
        &self,
        strrestorefromfile: &windows_core::PCWSTR,
        lflags: i32,
    ) -> windows_core::Result<()>;
}
impl IWbemBackupRestore_Vtbl {
    pub const fn new<Identity: IWbemBackupRestore_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Backup<Identity: IWbemBackupRestore_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strbackuptofile: windows_core::PCWSTR,
            lflags: i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemBackupRestore_Impl::Backup(
                    this,
                    core::mem::transmute(&strbackuptofile),
                    core::mem::transmute_copy(&lflags),
                )
                .into()
            }
        ...
        unsafe extern "system" fn Restore<
            Identity: IWbemBackupRestore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strrestorefromfile: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemBackupRestore_Impl::Restore(
                    this,
                    core::mem::transmute(&strrestorefromfile),
                    core::mem::transmute_copy(&lflags),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0xa359dec5_e813_4834_8a2a_ba7f1d777d76
);
...
impl IWbemBackupRestoreEx_Vtbl {
    pub const fn new<Identity: IWbemBackupRestoreEx_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Pause<
            Identity: IWbemBackupRestoreEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        Self {
            base__: IWbemBackupRestore_Vtbl::new::<Identity, OFFSET>(),
...
windows_core::imp::define_interface!(
    ...
    0x44aca675_e8fc_11d0_a07c_00c04fb68820
);
...
impl IWbemCallResult {
    pub unsafe fn GetResultObject(&self, ltimeout: i32) -> windows_core::Result<IWbemClassObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetResultObject)(
                windows_core::Interface::as_raw(self),
                ltimeout,
                &mut result__,
            )
    ...
    pub unsafe fn GetResultString(
        &self,
        ltimeout: i32,
    ) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetResultString)(
                windows_core::Interface::as_raw(self),
                ltimeout,
                &mut result__,
            )
    ...
    pub unsafe fn GetResultServices(&self, ltimeout: i32) -> windows_core::Result<IWbemServices> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetResultServices)(
                windows_core::Interface::as_raw(self),
                ltimeout,
                &mut result__,
            )
    ...
    pub unsafe fn GetCallStatus(&self, ltimeout: i32) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCallStatus)(
                windows_core::Interface::as_raw(self),
                ltimeout,
                &mut result__,
            )
...
pub struct IWbemCallResult_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetResultObject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetResultString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetResultServices: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl IWbemCallResult_Vtbl {
    pub const fn new<Identity: IWbemCallResult_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetResultObject<
            Identity: IWbemCallResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ltimeout: i32,
            ppresultobject: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemCallResult_Impl::GetResultObject(
                    this,
                    core::mem::transmute_copy(&ltimeout),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetResultString<
            Identity: IWbemCallResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ltimeout: i32,
            pstrresultstring: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemCallResult_Impl::GetResultString(
                    this,
                    core::mem::transmute_copy(&ltimeout),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetResultServices<
            Identity: IWbemCallResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemCallResult_Impl::GetResultServices(
                    this,
                    core::mem::transmute_copy(&ltimeout),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetCallStatus<
            Identity: IWbemCallResult_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemCallResult_Impl::GetCallStatus(
                    this,
                    core::mem::transmute_copy(&ltimeout),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    ...
    0xdc12a681_737f_11cf_884d_00aa004b2e24
);
...
impl IWbemClassObject {
    pub unsafe fn GetQualifierSet(&self) -> windows_core::Result<IWbemQualifierSet> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetQualifierSet)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Get)(
                ...
                plflavor.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    ...
    pub unsafe fn Put<P0>(
        &self,
        wszname: P0,
        lflags: i32,
        pval: *const super::Variant::VARIANT,
        r#type: i32,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn GetNames<P0>(
        &self,
        wszqualifiername: P0,
        lflags: WBEM_CONDITION_FLAG_TYPE,
        pqualifierval: *const super::Variant::VARIANT,
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).GetNames)(
                windows_core::Interface::as_raw(self),
                wszqualifiername.param().abi(),
                lflags,
                core::mem::transmute(pqualifierval),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub unsafe fn BeginEnumeration(&self, lenumflags: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BeginEnumeration)(
                windows_core::Interface::as_raw(self),
                lenumflags,
            )
            .ok()
    ...
    pub unsafe fn EndEnumeration(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndEnumeration)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    }
    pub unsafe fn GetPropertyQualifierSet<P0>(
        &self,
        wszproperty: P0,
    ) -> windows_core::Result<IWbemQualifierSet>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPropertyQualifierSet)(
                windows_core::Interface::as_raw(self),
                wszproperty.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn GetObjectText(&self, lflags: i32) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetObjectText)(
                windows_core::Interface::as_raw(self),
                lflags,
                &mut result__,
            )
    ...
    pub unsafe fn SpawnDerivedClass(&self, lflags: i32) -> windows_core::Result<IWbemClassObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SpawnDerivedClass)(
                windows_core::Interface::as_raw(self),
                lflags,
                &mut result__,
            )
    ...
    pub unsafe fn SpawnInstance(&self, lflags: i32) -> windows_core::Result<IWbemClassObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SpawnInstance)(
                windows_core::Interface::as_raw(self),
                lflags,
                &mut result__,
            )
    ...
    pub unsafe fn CompareTo<P1>(
        &self,
        lflags: WBEM_COMPARISON_FLAG,
        pcompareto: P1,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CompareTo)(
                windows_core::Interface::as_raw(self),
                lflags,
                pcompareto.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn GetPropertyOrigin<P0>(
        &self,
        wszname: P0,
    ) -> windows_core::Result<windows_core::BSTR>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPropertyOrigin)(
                windows_core::Interface::as_raw(self),
                wszname.param().abi(),
                &mut result__,
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).InheritsFrom)(
                windows_core::Interface::as_raw(self),
                strancestor.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn GetMethod<P0>(
        &self,
        wszname: P0,
        lflags: i32,
        ppinsignature: *mut Option<IWbemClassObject>,
        ppoutsignature: *mut Option<IWbemClassObject>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetMethod)(
                windows_core::Interface::as_raw(self),
                wszname.param().abi(),
                lflags,
                core::mem::transmute(ppinsignature),
                core::mem::transmute(ppoutsignature),
            )
            .ok()
        }
    }
    pub unsafe fn PutMethod<P0, P2, P3>(
        &self,
        wszname: P0,
        lflags: i32,
        pinsignature: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PutMethod)(
                windows_core::Interface::as_raw(self),
                wszname.param().abi(),
                lflags,
                pinsignature.param().abi(),
                poutsignature.param().abi(),
            )
            .ok()
        }
    }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteMethod)(
                windows_core::Interface::as_raw(self),
                wszname.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn BeginMethodEnumeration(&self, lenumflags: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BeginMethodEnumeration)(
                windows_core::Interface::as_raw(self),
                lenumflags,
            )
            .ok()
    ...
    pub unsafe fn NextMethod(
        &self,
        lflags: i32,
        pstrname: *mut windows_core::BSTR,
        ppinsignature: *mut Option<IWbemClassObject>,
        ppoutsignature: *mut Option<IWbemClassObject>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).NextMethod)(
                windows_core::Interface::as_raw(self),
                lflags,
                core::mem::transmute(pstrname),
                core::mem::transmute(ppinsignature),
                core::mem::transmute(ppoutsignature),
            )
            .ok()
    ...
    pub unsafe fn EndMethodEnumeration(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).EndMethodEnumeration)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    }
    pub unsafe fn GetMethodQualifierSet<P0>(
        &self,
        wszmethod: P0,
    ) -> windows_core::Result<IWbemQualifierSet>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMethodQualifierSet)(
                windows_core::Interface::as_raw(self),
                wszmethod.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn GetMethodOrigin<P0>(
        &self,
        wszmethodname: P0,
    ) -> windows_core::Result<windows_core::BSTR>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMethodOrigin)(
                windows_core::Interface::as_raw(self),
                wszmethodname.param().abi(),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
        }
...
pub struct IWbemClassObject_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetQualifierSet: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(
    ...
    pub GetPropertyQualifierSet: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GetObjectText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SpawnDerivedClass: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SpawnInstance: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CompareTo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WBEM_COMPARISON_FLAG,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetPropertyOrigin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub InheritsFrom: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    ...
    pub PutMethod: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        i32,
        *mut core::ffi::c_void,
    ...
    pub DeleteMethod: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub BeginMethodEnumeration:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub NextMethod: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    pub EndMethodEnumeration:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub GetMethodQualifierSet: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetMethodOrigin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IWbemClassObject_Impl: windows_core::IUnknownImpl {
    ...
    fn GetNames(
        &self,
        wszqualifiername: &windows_core::PCWSTR,
        lflags: WBEM_CONDITION_FLAG_TYPE,
        pqualifierval: *const super::Variant::VARIANT,
    ) -> windows_core::Result<*mut super::Com::SAFEARRAY>;
    ...
    fn GetPropertyQualifierSet(
        &self,
        wszproperty: &windows_core::PCWSTR,
    ) -> windows_core::Result<IWbemQualifierSet>;
    ...
    fn CompareTo(
        &self,
        lflags: WBEM_COMPARISON_FLAG,
        pcompareto: windows_core::Ref<'_, IWbemClassObject>,
    ) -> windows_core::Result<()>;
    ...
    fn GetMethod(
        ...
        wszname: &windows_core::PCWSTR,
        lflags: i32,
        ppinsignature: windows_core::OutRef<'_, IWbemClassObject>,
        ppoutsignature: windows_core::OutRef<'_, IWbemClassObject>,
    ) -> windows_core::Result<()>;
    fn PutMethod(
        &self,
        wszname: &windows_core::PCWSTR,
        lflags: i32,
        pinsignature: windows_core::Ref<'_, IWbemClassObject>,
        poutsignature: windows_core::Ref<'_, IWbemClassObject>,
    ) -> windows_core::Result<()>;
    ...
    fn GetMethodQualifierSet(
        &self,
        wszmethod: &windows_core::PCWSTR,
    ) -> windows_core::Result<IWbemQualifierSet>;
    fn GetMethodOrigin(
        &self,
        wszmethodname: &windows_core::PCWSTR,
    ) -> windows_core::Result<windows_core::BSTR>;
}
#[cfg(all(
    feature = "Win32_System_Com",
...
impl IWbemClassObject_Vtbl {
    pub const fn new<Identity: IWbemClassObject_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetQualifierSet<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppqualset: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Get<Identity: IWbemClassObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            lflags: i32,
            pval: *mut super::Variant::VARIANT,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemClassObject_Impl::Get(
                    this,
                    core::mem::transmute(&wszname),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pval),
                    core::mem::transmute_copy(&ptype),
                    core::mem::transmute_copy(&plflavor),
                )
                .into()
            }
        }
        unsafe extern "system" fn Put<Identity: IWbemClassObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            lflags: i32,
            pval: *const super::Variant::VARIANT,
        ...
        unsafe extern "system" fn Delete<Identity: IWbemClassObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetNames<Identity: IWbemClassObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszqualifiername: windows_core::PCWSTR,
            lflags: WBEM_CONDITION_FLAG_TYPE,
            pqualifierval: *const super::Variant::VARIANT,
            pnames: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemClassObject_Impl::GetNames(
                    this,
                    core::mem::transmute(&wszqualifiername),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pqualifierval),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn BeginEnumeration<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemClassObject_Impl::BeginEnumeration(
                    this,
                    core::mem::transmute_copy(&lenumflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn Next<Identity: IWbemClassObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            strname: *mut *mut core::ffi::c_void,
            pval: *mut super::Variant::VARIANT,
        ...
        unsafe extern "system" fn EndEnumeration<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetPropertyQualifierSet<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemClassObject_Impl::GetPropertyQualifierSet(
                    this,
                    core::mem::transmute(&wszproperty),
                ) {
                    Ok(ok__) => {
                        ppqualset.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn Clone<Identity: IWbemClassObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppcopy: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetObjectText<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: i32,
            pstrobjecttext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SpawnDerivedClass<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: i32,
            ppnewclass: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemClassObject_Impl::SpawnDerivedClass(
                    this,
                    core::mem::transmute_copy(&lflags),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SpawnInstance<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: i32,
            ppnewinstance: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CompareTo<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: WBEM_COMPARISON_FLAG,
            pcompareto: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemClassObject_Impl::CompareTo(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pcompareto),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetPropertyOrigin<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            pstrclassname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn InheritsFrom<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strancestor: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetMethod<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            lflags: i32,
            ppinsignature: *mut *mut core::ffi::c_void,
            ppoutsignature: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemClassObject_Impl::GetMethod(
                    this,
                    core::mem::transmute(&wszname),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&ppinsignature),
                    core::mem::transmute_copy(&ppoutsignature),
                )
                .into()
            }
        }
        unsafe extern "system" fn PutMethod<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            lflags: i32,
            pinsignature: *mut core::ffi::c_void,
            poutsignature: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemClassObject_Impl::PutMethod(
                    this,
                    core::mem::transmute(&wszname),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pinsignature),
                    core::mem::transmute_copy(&poutsignature),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeleteMethod<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn BeginMethodEnumeration<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemClassObject_Impl::BeginMethodEnumeration(
                    this,
                    core::mem::transmute_copy(&lenumflags),
                )
                .into()
        ...
        unsafe extern "system" fn NextMethod<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: i32,
            pstrname: *mut *mut core::ffi::c_void,
            ppinsignature: *mut *mut core::ffi::c_void,
            ppoutsignature: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemClassObject_Impl::NextMethod(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pstrname),
                    core::mem::transmute_copy(&ppinsignature),
                    core::mem::transmute_copy(&ppoutsignature),
                )
                .into()
        ...
        unsafe extern "system" fn EndMethodEnumeration<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetMethodQualifierSet<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemClassObject_Impl::GetMethodQualifierSet(
                    this,
                    core::mem::transmute(&wszmethod),
                ) {
                    Ok(ok__) => {
                        ppqualset.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn GetMethodOrigin<
            Identity: IWbemClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemClassObject_Impl::GetMethodOrigin(
                    this,
                    core::mem::transmute(&wszmethodname),
                ) {
                    Ok(ok__) => {
                        pstrclassname.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
...
windows_core::imp::define_interface!(
    ...
    0xa889c72a_fcc1_4a9e_af61_ed071333fb5b
);
...
impl IWbemClientConnectionTransport {
    pub unsafe fn Open<P8, T>(
        &self,
        straddresstype: &windows_core::BSTR,
        abbinaryaddress: &[u8],
        strobject: &windows_core::BSTR,
        struser: &windows_core::BSTR,
        strpassword: &windows_core::BSTR,
        strlocale: &windows_core::BSTR,
        lflags: i32,
        ...
        T: windows_core::Interface,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Open)(
                ...
                abbinaryaddress.len().try_into().unwrap(),
                core::mem::transmute(abbinaryaddress.as_ptr()),
                ...
                &T::IID,
                &mut result__,
                core::mem::transmute(pcallres),
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn OpenAsync<P8, P10>(
        &self,
        straddresstype: &windows_core::BSTR,
        abbinaryaddress: &[u8],
        strobject: &windows_core::BSTR,
...
pub trait IWbemClientConnectionTransport_Impl: windows_core::IUnknownImpl {
    fn Open(
        ...
        strlocale: &windows_core::BSTR,
        lflags: i32,
        pctx: windows_core::Ref<'_, IWbemContext>,
        riid: *const windows_core::GUID,
        pinterface: *mut *mut core::ffi::c_void,
        pcallres: windows_core::OutRef<'_, IWbemCallResult>,
    ) -> windows_core::Result<()>;
    fn OpenAsync(
        &self,
        straddresstype: &windows_core::BSTR,
        ...
        pctx: windows_core::Ref<'_, IWbemContext>,
        riid: *const windows_core::GUID,
        presponsehandler: windows_core::Ref<'_, IWbemObjectSink>,
    ) -> windows_core::Result<()>;
    fn Cancel(
        &self,
        lflags: i32,
        phandler: windows_core::Ref<'_, IWbemObjectSink>,
    ) -> windows_core::Result<()>;
}
impl IWbemClientConnectionTransport_Vtbl {
    pub const fn new<Identity: IWbemClientConnectionTransport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Open<
            Identity: IWbemClientConnectionTransport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            straddresstype: *mut core::ffi::c_void,
            dwbinaryaddresslength: u32,
            abbinaryaddress: *const u8,
            strobject: *mut core::ffi::c_void,
            struser: *mut core::ffi::c_void,
            strpassword: *mut core::ffi::c_void,
            strlocale: *mut core::ffi::c_void,
            lflags: i32,
            ...
            riid: *const windows_core::GUID,
            pinterface: *mut *mut core::ffi::c_void,
            pcallres: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemClientConnectionTransport_Impl::Open(
                    this,
        ...
        >(
            ...
            pctx: *mut core::ffi::c_void,
            riid: *const windows_core::GUID,
            presponsehandler: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemClientConnectionTransport_Impl::OpenAsync(
                    this,
                    core::mem::transmute(&straddresstype),
                    core::mem::transmute_copy(&dwbinaryaddresslength),
                    core::mem::transmute_copy(&abbinaryaddress),
                    ...
                    core::mem::transmute_copy(&pctx),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&presponsehandler),
                )
                .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            lflags: i32,
            phandler: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemClientConnectionTransport_Impl::Cancel(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&phandler),
                )
                .into()
            }
        }
        ...
        P9: windows_core::Param<IWbemContext>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).ConnectServer)(
                ...
                abbinaryaddress.len().try_into().unwrap(),
                core::mem::transmute(abbinaryaddress.as_ptr()),
                core::mem::transmute_copy(strnetworkresource),
                core::mem::transmute_copy(struser),
                core::mem::transmute_copy(strpassword),
                core::mem::transmute_copy(strlocale),
                lsecurityflags,
...
impl IWbemClientTransport_Vtbl {
    pub const fn new<Identity: IWbemClientTransport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ConnectServer<
            Identity: IWbemClientTransport_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            straddresstype: *mut core::ffi::c_void,
            dwbinaryaddresslength: u32,
            abbinaryaddress: *const u8,
            strnetworkresource: *mut core::ffi::c_void,
            struser: *mut core::ffi::c_void,
            strpassword: *mut core::ffi::c_void,
            strlocale: *mut core::ffi::c_void,
            lsecurityflags: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemClientTransport_Impl::ConnectServer(
                    this,
                    core::mem::transmute(&straddresstype),
                    core::mem::transmute_copy(&dwbinaryaddresslength),
                    core::mem::transmute_copy(&abbinaryaddress),
                    core::mem::transmute(&strnetworkresource),
                    core::mem::transmute(&struser),
                    core::mem::transmute(&strpassword),
                    core::mem::transmute(&strlocale),
                    core::mem::transmute_copy(&lsecurityflags),
                    core::mem::transmute(&strauthority),
                    core::mem::transmute_copy(&pctx),
                ) {
                    Ok(ok__) => {
...
impl IWbemConfigureRefresher {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddObjectByPath)(
                windows_core::Interface::as_raw(self),
                pnamespace.param().abi(),
                wszpath.param().abi(),
                lflags,
                pcontext.param().abi(),
                core::mem::transmute(pprefreshable),
                plid as _,
            )
            .ok()
        }
    }
    pub unsafe fn AddObjectByTemplate<P0, P1, P3>(
        &self,
        pnamespace: P0,
        ptemplate: P1,
        lflags: i32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddObjectByTemplate)(
                windows_core::Interface::as_raw(self),
                pnamespace.param().abi(),
                ptemplate.param().abi(),
                lflags,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).AddRefresher)(
                windows_core::Interface::as_raw(self),
                prefresher.param().abi(),
                lflags,
                plid as _,
            )
            .ok()
    ...
    pub unsafe fn AddEnum<P0, P1, P3>(
        &self,
        pnamespace: P0,
        wszclassname: P1,
        lflags: i32,
...
pub struct IWbemConfigureRefresher_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub AddObjectByPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        i32,
    ...
    pub AddObjectByTemplate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
    ...
    pub AddRefresher: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        *mut i32,
...
pub trait IWbemConfigureRefresher_Impl: windows_core::IUnknownImpl {
    fn AddObjectByPath(
        &self,
        pnamespace: windows_core::Ref<'_, IWbemServices>,
        wszpath: &windows_core::PCWSTR,
        lflags: i32,
        pcontext: windows_core::Ref<'_, IWbemContext>,
        pprefreshable: windows_core::OutRef<'_, IWbemClassObject>,
        plid: *mut i32,
    ) -> windows_core::Result<()>;
    fn AddObjectByTemplate(
        &self,
        pnamespace: windows_core::Ref<'_, IWbemServices>,
        ptemplate: windows_core::Ref<'_, IWbemClassObject>,
        lflags: i32,
        pcontext: windows_core::Ref<'_, IWbemContext>,
        pprefreshable: windows_core::OutRef<'_, IWbemClassObject>,
        plid: *mut i32,
    ...
    fn AddRefresher(
        &self,
        prefresher: windows_core::Ref<'_, IWbemRefresher>,
        lflags: i32,
        plid: *mut i32,
    ) -> windows_core::Result<()>;
    ...
    fn AddEnum(
        &self,
        pnamespace: windows_core::Ref<'_, IWbemServices>,
        wszclassname: &windows_core::PCWSTR,
        lflags: i32,
        pcontext: windows_core::Ref<'_, IWbemContext>,
        ppenum: windows_core::OutRef<'_, IWbemHiPerfEnum>,
        plid: *mut i32,
    ) -> windows_core::Result<()>;
}
impl IWbemConfigureRefresher_Vtbl {
    pub const fn new<Identity: IWbemConfigureRefresher_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddObjectByPath<
            Identity: IWbemConfigureRefresher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pnamespace: *mut core::ffi::c_void,
            wszpath: windows_core::PCWSTR,
            lflags: i32,
            pcontext: *mut core::ffi::c_void,
            pprefreshable: *mut *mut core::ffi::c_void,
            plid: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemConfigureRefresher_Impl::AddObjectByPath(
                    this,
                    core::mem::transmute_copy(&pnamespace),
                    core::mem::transmute(&wszpath),
                    core::mem::transmute_copy(&lflags),
        ...
        unsafe extern "system" fn AddObjectByTemplate<
            Identity: IWbemConfigureRefresher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pnamespace: *mut core::ffi::c_void,
            ptemplate: *mut core::ffi::c_void,
            lflags: i32,
            pcontext: *mut core::ffi::c_void,
            pprefreshable: *mut *mut core::ffi::c_void,
            plid: *mut i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemConfigureRefresher_Impl::AddObjectByTemplate(
                    this,
                    core::mem::transmute_copy(&pnamespace),
                    core::mem::transmute_copy(&ptemplate),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pcontext),
                    core::mem::transmute_copy(&pprefreshable),
                    core::mem::transmute_copy(&plid),
        ...
        unsafe extern "system" fn AddRefresher<
            Identity: IWbemConfigureRefresher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            prefresher: *mut core::ffi::c_void,
            lflags: i32,
            plid: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemConfigureRefresher_Impl::AddRefresher(
                    this,
                    core::mem::transmute_copy(&prefresher),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&plid),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemConfigureRefresher_Impl::Remove(
                    this,
                    core::mem::transmute_copy(&lid),
                    core::mem::transmute_copy(&lflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn AddEnum<
            Identity: IWbemConfigureRefresher_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemConfigureRefresher_Impl::AddEnum(
                    this,
                    core::mem::transmute_copy(&pnamespace),
                    core::mem::transmute(&wszclassname),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pcontext),
...
windows_core::imp::define_interface!(
    IWbemConnectorLogin,
    IWbemConnectorLogin_Vtbl,
    0xd8ec9cb1_b135_4f10_8b1b_c7188bb0d186
);
windows_core::imp::interface_hierarchy!(IWbemConnectorLogin, windows_core::IUnknown);
impl IWbemConnectorLogin {
    pub unsafe fn ConnectorLogin<P0, P1, P3, T>(
        &self,
        wsznetworkresource: P0,
        wszpreferredlocale: P1,
        lflags: i32,
        pctx: P3,
    ) -> windows_core::Result<T>
    where
        ...
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
        unsafe {
            (windows_core::Interface::vtable(self).ConnectorLogin)(
                windows_core::Interface::as_raw(self),
                wsznetworkresource.param().abi(),
                wszpreferredlocale.param().abi(),
                lflags,
                pctx.param().abi(),
                &T::IID,
                &mut result__,
...
pub struct IWbemConnectorLogin_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ConnectorLogin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        i32,
...
pub trait IWbemConnectorLogin_Impl: windows_core::IUnknownImpl {
    fn ConnectorLogin(
        &self,
        wsznetworkresource: &windows_core::PCWSTR,
        wszpreferredlocale: &windows_core::PCWSTR,
        lflags: i32,
        pctx: windows_core::Ref<'_, IWbemContext>,
        riid: *const windows_core::GUID,
        pinterface: *mut *mut core::ffi::c_void,
...
impl IWbemConnectorLogin_Vtbl {
    pub const fn new<Identity: IWbemConnectorLogin_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ConnectorLogin<
            Identity: IWbemConnectorLogin_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            wsznetworkresource: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemConnectorLogin_Impl::ConnectorLogin(
                    this,
                    core::mem::transmute(&wsznetworkresource),
                    core::mem::transmute(&wszpreferredlocale),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
                    core::mem::transmute_copy(&riid),
                    core::mem::transmute_copy(&pinterface),
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            ConnectorLogin: ConnectorLogin::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x9ef76194_70d5_11d1_ad90_00c04fd8fdff
);
...
impl IWbemConstructClassObject {
    pub unsafe fn SetInheritanceChain(
        &self,
        lnumantecedents: i32,
        awszantecedents: *const windows_core::PCWSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetInheritanceChain)(
                windows_core::Interface::as_raw(self),
                lnumantecedents,
                awszantecedents,
            )
    ...
    pub unsafe fn SetPropertyOrigin<P0>(
        &self,
        wszpropertyname: P0,
        loriginindex: i32,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetPropertyOrigin)(
                windows_core::Interface::as_raw(self),
                wszpropertyname.param().abi(),
                loriginindex,
            )
            .ok()
        }
    }
    pub unsafe fn SetMethodOrigin<P0>(
        &self,
        wszmethodname: P0,
        loriginindex: i32,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetMethodOrigin)(
                windows_core::Interface::as_raw(self),
                wszmethodname.param().abi(),
                loriginindex,
            )
    ...
    pub unsafe fn SetServerNamespace<P0, P1>(
        &self,
        wszserver: P0,
        wsznamespace: P1,
    ) -> windows_core::Result<()>
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetServerNamespace)(
                windows_core::Interface::as_raw(self),
                wszserver.param().abi(),
...
pub struct IWbemConstructClassObject_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetInheritanceChain: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *const windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub SetPropertyOrigin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        i32,
    ) -> windows_core::HRESULT,
    pub SetMethodOrigin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        i32,
    ) -> windows_core::HRESULT,
    pub SetServerNamespace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
...
pub trait IWbemConstructClassObject_Impl: windows_core::IUnknownImpl {
    ...
    fn SetPropertyOrigin(
        &self,
        wszpropertyname: &windows_core::PCWSTR,
        loriginindex: i32,
    ) -> windows_core::Result<()>;
    fn SetMethodOrigin(
        &self,
...
impl IWbemConstructClassObject_Vtbl {
    pub const fn new<Identity: IWbemConstructClassObject_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetInheritanceChain<
            Identity: IWbemConstructClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lnumantecedents: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemConstructClassObject_Impl::SetInheritanceChain(
                    this,
                    core::mem::transmute_copy(&lnumantecedents),
                    core::mem::transmute_copy(&awszantecedents),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetPropertyOrigin<
            Identity: IWbemConstructClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemConstructClassObject_Impl::SetPropertyOrigin(
                    this,
                    core::mem::transmute(&wszpropertyname),
                    core::mem::transmute_copy(&loriginindex),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetMethodOrigin<
            Identity: IWbemConstructClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemConstructClassObject_Impl::SetMethodOrigin(
                    this,
                    core::mem::transmute(&wszmethodname),
                    core::mem::transmute_copy(&loriginindex),
                )
        ...
        unsafe extern "system" fn SetServerNamespace<
            Identity: IWbemConstructClassObject_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemConstructClassObject_Impl::SetServerNamespace(
                    this,
                    core::mem::transmute(&wszserver),
...
windows_core::imp::define_interface!(
    IWbemContext,
    IWbemContext_Vtbl,
    0x44aca674_e8fc_11d0_a07c_00c04fb68820
);
...
impl IWbemContext {
    ...
    pub unsafe fn Next(
        ...
        lflags: i32,
        pstrname: *mut windows_core::BSTR,
        pvalue: *mut super::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Next)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn SetValue<P0>(
        &self,
        wszname: P0,
        lflags: i32,
        pvalue: *const super::Variant::VARIANT,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteValue)(
                windows_core::Interface::as_raw(self),
                wszname.param().abi(),
                lflags,
            )
...
impl IWbemContext_Vtbl {
    pub const fn new<Identity: IWbemContext_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Clone<Identity: IWbemContext_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppnewcopy: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetNames<Identity: IWbemContext_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            pnames: *mut *mut super::Com::SAFEARRAY,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Next<Identity: IWbemContext_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            pstrname: *mut *mut core::ffi::c_void,
            pvalue: *mut super::Variant::VARIANT,
        ...
        unsafe extern "system" fn SetValue<Identity: IWbemContext_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            lflags: i32,
            pvalue: *const super::Variant::VARIANT,
        ...
        unsafe extern "system" fn GetValue<Identity: IWbemContext_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            lflags: i32,
            pvalue: *mut super::Variant::VARIANT,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemContext_Impl::GetValue(
                    this,
                    core::mem::transmute(&wszname),
                    core::mem::transmute_copy(&lflags),
                ) {
        ...
        unsafe extern "system" fn DeleteValue<Identity: IWbemContext_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            lflags: i32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn DeleteAll<Identity: IWbemContext_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    ...
    0x86336d20_ca11_4786_9ef1_bc8a946b42fc
);
...
impl IWbemDecoupledBasicEventProvider {
    pub unsafe fn GetSink<P1>(
        &self,
        a_flags: i32,
        a_context: P1,
    ) -> windows_core::Result<IWbemObjectSink>
    where
...
pub trait IWbemDecoupledBasicEventProvider_Impl: IWbemDecoupledRegistrar_Impl {
    fn GetSink(
        &self,
        a_flags: i32,
        a_context: windows_core::Ref<'_, IWbemContext>,
    ) -> windows_core::Result<IWbemObjectSink>;
    fn GetService(
        &self,
        a_flags: i32,
...
impl IWbemDecoupledBasicEventProvider_Vtbl {
    ...
    {
        unsafe extern "system" fn GetSink<
            Identity: IWbemDecoupledBasicEventProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            a_flags: i32,
            a_context: *mut core::ffi::c_void,
            a_sink: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemDecoupledBasicEventProvider_Impl::GetSink(
                    this,
                    core::mem::transmute_copy(&a_flags),
                    core::mem::transmute_copy(&a_context),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            a_flags: i32,
            a_context: *mut core::ffi::c_void,
            a_service: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemDecoupledBasicEventProvider_Impl::GetService(
                    this,
                    core::mem::transmute_copy(&a_flags),
                    core::mem::transmute_copy(&a_context),
                ) {
...
impl IWbemDecoupledRegistrar {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Register)(
                windows_core::Interface::as_raw(self),
                a_flags,
                a_context.param().abi(),
                a_user.param().abi(),
    ...
    pub unsafe fn UnRegister(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).UnRegister)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub trait IWbemDecoupledRegistrar_Impl: windows_core::IUnknownImpl {
    fn Register(
        ...
        a_flags: i32,
        a_context: windows_core::Ref<'_, IWbemContext>,
        a_user: &windows_core::PCWSTR,
        a_locale: &windows_core::PCWSTR,
        a_scope: &windows_core::PCWSTR,
        a_registration: &windows_core::PCWSTR,
...
impl IWbemDecoupledRegistrar_Vtbl {
    pub const fn new<Identity: IWbemDecoupledRegistrar_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Register<
            Identity: IWbemDecoupledRegistrar_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            a_flags: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemDecoupledRegistrar_Impl::Register(
                    this,
                    core::mem::transmute_copy(&a_flags),
                    core::mem::transmute_copy(&a_context),
                    core::mem::transmute(&a_user),
                    core::mem::transmute(&a_locale),
                    core::mem::transmute(&a_scope),
                    core::mem::transmute(&a_registration),
...
windows_core::imp::define_interface!(
    ...
    IWbemEventConsumerProvider_Vtbl,
    0xe246107a_b06e_11d0_ad61_00c04fd8fdff
);
windows_core::imp::interface_hierarchy!(IWbemEventConsumerProvider, windows_core::IUnknown);
impl IWbemEventConsumerProvider {
    pub unsafe fn FindConsumer<P0>(
        &self,
        plogicalconsumer: P0,
    ) -> windows_core::Result<IWbemUnboundObjectSink>
    where
        P0: windows_core::Param<IWbemClassObject>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindConsumer)(
                windows_core::Interface::as_raw(self),
                plogicalconsumer.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub struct IWbemEventConsumerProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub FindConsumer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IWbemEventConsumerProvider_Impl: windows_core::IUnknownImpl {
    fn FindConsumer(
        &self,
        plogicalconsumer: windows_core::Ref<'_, IWbemClassObject>,
    ) -> windows_core::Result<IWbemUnboundObjectSink>;
}
impl IWbemEventConsumerProvider_Vtbl {
    pub const fn new<Identity: IWbemEventConsumerProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn FindConsumer<
            Identity: IWbemEventConsumerProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            plogicalconsumer: *mut core::ffi::c_void,
            ppconsumer: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemEventConsumerProvider_Impl::FindConsumer(
                    this,
                    core::mem::transmute_copy(&plogicalconsumer),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            FindConsumer: FindConsumer::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xe245105b_b06e_11d0_ad61_00c04fd8fdff
);
...
impl IWbemEventProvider {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ProvideEvents)(
                windows_core::Interface::as_raw(self),
                psink.param().abi(),
                lflags,
            )
...
pub struct IWbemEventProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ProvideEvents: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
    ) -> windows_core::HRESULT,
...
impl IWbemEventProvider_Vtbl {
    pub const fn new<Identity: IWbemEventProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ProvideEvents<
            Identity: IWbemEventProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            psink: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemEventProvider_Impl::ProvideEvents(
                    this,
                    core::mem::transmute_copy(&psink),
                    core::mem::transmute_copy(&lflags),
                )
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            ProvideEvents: ProvideEvents::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x580acaf8_fa1c_11d0_ad72_00c04fd8fdff
);
windows_core::imp::interface_hierarchy!(IWbemEventProviderQuerySink, windows_core::IUnknown);
impl IWbemEventProviderQuerySink {
    pub unsafe fn NewQuery(
        &self,
        dwid: u32,
        wszquerylanguage: *const u16,
        wszquery: *const u16,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).NewQuery)(
                windows_core::Interface::as_raw(self),
                dwid,
                wszquerylanguage,
                wszquery,
    ...
    pub unsafe fn CancelQuery(&self, dwid: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CancelQuery)(
                windows_core::Interface::as_raw(self),
                dwid,
            )
            .ok()
...
pub struct IWbemEventProviderQuerySink_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub NewQuery: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u16,
        *const u16,
...
impl IWbemEventProviderQuerySink_Vtbl {
    pub const fn new<Identity: IWbemEventProviderQuerySink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn NewQuery<
            Identity: IWbemEventProviderQuerySink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dwid: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemEventProviderQuerySink_Impl::NewQuery(
                    this,
                    core::mem::transmute_copy(&dwid),
                    core::mem::transmute_copy(&wszquerylanguage),
                    core::mem::transmute_copy(&wszquery),
                )
                .into()
            }
        }
        unsafe extern "system" fn CancelQuery<
            Identity: IWbemEventProviderQuerySink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemEventProviderQuerySink_Impl::CancelQuery(
                    this,
                    core::mem::transmute_copy(&dwid),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    IWbemEventProviderSecurity_Vtbl,
    0x631f7d96_d993_11d2_b339_00105a1f4aaf
);
...
impl IWbemEventProviderSecurity {
    pub unsafe fn AccessCheck(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AccessCheck)(
                windows_core::Interface::as_raw(self),
                wszquerylanguage,
                wszquery,
                psid.len().try_into().unwrap(),
                core::mem::transmute(psid.as_ptr()),
            )
            .ok()
        }
    }
...
impl IWbemEventProviderSecurity_Vtbl {
    pub const fn new<Identity: IWbemEventProviderSecurity_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AccessCheck<
            Identity: IWbemEventProviderSecurity_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            wszquerylanguage: *const u16,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemEventProviderSecurity_Impl::AccessCheck(
                    this,
                    core::mem::transmute_copy(&wszquerylanguage),
                    core::mem::transmute_copy(&wszquery),
                    core::mem::transmute_copy(&lsidlength),
...
windows_core::imp::define_interface!(
    IWbemEventSink,
    IWbemEventSink_Vtbl,
    0x3ae0080a_7e3a_4366_bf89_0feedc931659
);
...
impl IWbemEventSink {
    pub unsafe fn SetSinkSecurity(&self, psd: &[u8]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSinkSecurity)(
                windows_core::Interface::as_raw(self),
                psd.len().try_into().unwrap(),
                core::mem::transmute(psd.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn IsActive(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).IsActive)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn GetRestrictedSink<P2>(
        &self,
        awszqueries: &[windows_core::PCWSTR],
        pcallback: P2,
    ) -> windows_core::Result<IWbemEventSink>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRestrictedSink)(
                windows_core::Interface::as_raw(self),
                awszqueries.len().try_into().unwrap(),
                core::mem::transmute(awszqueries.as_ptr()),
                pcallback.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn SetBatchingParameters(
        &self,
        lflags: i32,
        dwmaxbuffersize: u32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetBatchingParameters)(
                windows_core::Interface::as_raw(self),
                lflags,
                dwmaxbuffersize,
                dwmaxsendlatency,
...
pub struct IWbemEventSink_Vtbl {
    ...
    pub SetSinkSecurity:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, *const u8) -> windows_core::HRESULT,
    pub IsActive: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub GetRestrictedSink: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *const windows_core::PCWSTR,
        *mut core::ffi::c_void,
    ...
    pub SetBatchingParameters:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, u32, u32) -> windows_core::HRESULT,
}
pub trait IWbemEventSink_Impl: IWbemObjectSink_Impl {
    ...
    fn GetRestrictedSink(
        &self,
        lnumqueries: i32,
        awszqueries: *const windows_core::PCWSTR,
...
impl IWbemEventSink_Vtbl {
    pub const fn new<Identity: IWbemEventSink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetSinkSecurity<
            Identity: IWbemEventSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lsdlength: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemEventSink_Impl::SetSinkSecurity(
                    this,
                    core::mem::transmute_copy(&lsdlength),
                    core::mem::transmute_copy(&psd),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsActive<Identity: IWbemEventSink_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetRestrictedSink<
            Identity: IWbemEventSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemEventSink_Impl::GetRestrictedSink(
                    this,
                    core::mem::transmute_copy(&lnumqueries),
                    core::mem::transmute_copy(&awszqueries),
        ...
        unsafe extern "system" fn SetBatchingParameters<
            Identity: IWbemEventSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemEventSink_Impl::SetBatchingParameters(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&dwmaxbuffersize),
                    core::mem::transmute_copy(&dwmaxsendlatency),
                )
                .into()
            }
        }
...
impl IWbemHiPerfEnum {
    pub unsafe fn AddObjects(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AddObjects)(
                windows_core::Interface::as_raw(self),
                lflags,
                unumobjects,
                apids,
                core::mem::transmute(apobj),
            )
            .ok()
        }
    }
    pub unsafe fn RemoveObjects(&self, lflags: i32, apids: &[i32]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveObjects)(
                windows_core::Interface::as_raw(self),
                lflags,
                apids.len().try_into().unwrap(),
                core::mem::transmute(apids.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn GetObjects(
        &self,
        lflags: i32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetObjects)(
                windows_core::Interface::as_raw(self),
                lflags,
                apobj.len().try_into().unwrap(),
                core::mem::transmute(apobj.as_ptr()),
                pureturned as _,
            )
            .ok()
        }
    ...
    pub unsafe fn RemoveAll(&self, lflags: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveAll)(
                windows_core::Interface::as_raw(self),
                lflags,
            )
            .ok()
...
pub struct IWbemHiPerfEnum_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub AddObjects: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        u32,
        *const i32,
    ...
    pub RemoveObjects: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        u32,
        *const i32,
    ) -> windows_core::HRESULT,
    pub GetObjects: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        u32,
        *mut *mut core::ffi::c_void,
...
impl IWbemHiPerfEnum_Vtbl {
    pub const fn new<Identity: IWbemHiPerfEnum_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddObjects<
            Identity: IWbemHiPerfEnum_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: i32,
            unumobjects: u32,
            apids: *const i32,
            apobj: *const *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemHiPerfEnum_Impl::AddObjects(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&unumobjects),
                    core::mem::transmute_copy(&apids),
                    core::mem::transmute_copy(&apobj),
                )
                .into()
            }
        }
        unsafe extern "system" fn RemoveObjects<
            Identity: IWbemHiPerfEnum_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemHiPerfEnum_Impl::RemoveObjects(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&unumobjects),
                    core::mem::transmute_copy(&apids),
        ...
        unsafe extern "system" fn GetObjects<
            Identity: IWbemHiPerfEnum_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: i32,
            unumobjects: u32,
            apobj: *mut *mut core::ffi::c_void,
            pureturned: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemHiPerfEnum_Impl::GetObjects(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&unumobjects),
                    core::mem::transmute_copy(&apobj),
        ...
        unsafe extern "system" fn RemoveAll<Identity: IWbemHiPerfEnum_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl IWbemHiPerfProvider {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).QueryInstances)(
                windows_core::Interface::as_raw(self),
                pnamespace.param().abi(),
                wszclass.param().abi(),
                lflags,
    ...
    pub unsafe fn CreateRefresher<P0>(
        &self,
        pnamespace: P0,
        lflags: i32,
    ) -> windows_core::Result<IWbemRefresher>
    where
        P0: windows_core::Param<IWbemServices>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateRefresher)(
                windows_core::Interface::as_raw(self),
                pnamespace.param().abi(),
                lflags,
                &mut result__,
    ...
    pub unsafe fn CreateRefreshableObject<P0, P1, P2, P4>(
        &self,
        pnamespace: P0,
        ptemplate: P1,
        prefresher: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CreateRefreshableObject)(
                windows_core::Interface::as_raw(self),
                pnamespace.param().abi(),
                ptemplate.param().abi(),
                prefresher.param().abi(),
    ...
    pub unsafe fn StopRefreshing<P0>(
        &self,
        prefresher: P0,
        lid: i32,
        lflags: i32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).StopRefreshing)(
                windows_core::Interface::as_raw(self),
                prefresher.param().abi(),
                lid,
                lflags,
    ...
    pub unsafe fn CreateRefreshableEnum<P0, P1, P2, P4, P5>(
        &self,
        pnamespace: P0,
        wszclass: P1,
        prefresher: P2,
        ...
        P5: windows_core::Param<IWbemHiPerfEnum>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateRefreshableEnum)(
                windows_core::Interface::as_raw(self),
                pnamespace.param().abi(),
                wszclass.param().abi(),
                prefresher.param().abi(),
                lflags,
                pcontext.param().abi(),
                phiperfenum.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    }
    pub unsafe fn GetObjects<P0, P4>(
        &self,
        pnamespace: P0,
        apobj: &mut [Option<IWbemObjectAccess>],
        lflags: i32,
...
pub struct IWbemHiPerfProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub QueryInstances: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        i32,
    ...
    pub CreateRefresher: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateRefreshableObject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub StopRefreshing: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        i32,
    ) -> windows_core::HRESULT,
    pub CreateRefreshableEnum: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut core::ffi::c_void,
...
pub trait IWbemHiPerfProvider_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateRefreshableObject(
        &self,
        pnamespace: windows_core::Ref<'_, IWbemServices>,
        ptemplate: windows_core::Ref<'_, IWbemObjectAccess>,
        prefresher: windows_core::Ref<'_, IWbemRefresher>,
        lflags: i32,
        pcontext: windows_core::Ref<'_, IWbemContext>,
        pprefreshable: windows_core::OutRef<'_, IWbemObjectAccess>,
        plid: *mut i32,
    ) -> windows_core::Result<()>;
    fn StopRefreshing(
        &self,
    ...
    fn CreateRefreshableEnum(
        ...
        lflags: i32,
        pcontext: windows_core::Ref<'_, IWbemContext>,
        phiperfenum: windows_core::Ref<'_, IWbemHiPerfEnum>,
    ) -> windows_core::Result<i32>;
    fn GetObjects(
        &self,
        pnamespace: windows_core::Ref<'_, IWbemServices>,
...
impl IWbemHiPerfProvider_Vtbl {
    pub const fn new<Identity: IWbemHiPerfProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn QueryInstances<
            Identity: IWbemHiPerfProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pnamespace: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemHiPerfProvider_Impl::QueryInstances(
                    this,
                    core::mem::transmute_copy(&pnamespace),
                    core::mem::transmute(&wszclass),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
                    core::mem::transmute_copy(&psink),
                )
        ...
        unsafe extern "system" fn CreateRefresher<
            Identity: IWbemHiPerfProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pnamespace: *mut core::ffi::c_void,
            lflags: i32,
            pprefresher: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemHiPerfProvider_Impl::CreateRefresher(
                    this,
                    core::mem::transmute_copy(&pnamespace),
                    core::mem::transmute_copy(&lflags),
                ) {
        ...
        unsafe extern "system" fn CreateRefreshableObject<
            Identity: IWbemHiPerfProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemHiPerfProvider_Impl::CreateRefreshableObject(
                    this,
                    core::mem::transmute_copy(&pnamespace),
                    core::mem::transmute_copy(&ptemplate),
                    core::mem::transmute_copy(&prefresher),
        ...
        unsafe extern "system" fn StopRefreshing<
            Identity: IWbemHiPerfProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemHiPerfProvider_Impl::StopRefreshing(
                    this,
                    core::mem::transmute_copy(&prefresher),
                    core::mem::transmute_copy(&lid),
                    core::mem::transmute_copy(&lflags),
        ...
        unsafe extern "system" fn CreateRefreshableEnum<
            Identity: IWbemHiPerfProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            lflags: i32,
            pcontext: *mut core::ffi::c_void,
            phiperfenum: *mut core::ffi::c_void,
            plid: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemHiPerfProvider_Impl::CreateRefreshableEnum(
                    this,
                    core::mem::transmute_copy(&pnamespace),
                    core::mem::transmute(&wszclass),
                    core::mem::transmute_copy(&prefresher),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pcontext),
                    core::mem::transmute_copy(&phiperfenum),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemHiPerfProvider_Impl::GetObjects(
                    this,
                    core::mem::transmute_copy(&pnamespace),
                    core::mem::transmute_copy(&lnumobjects),
                    core::mem::transmute_copy(&apobj),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pcontext),
                )
...
impl IWbemLevel1Login {
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EstablishPosition)(
                windows_core::Interface::as_raw(self),
                wszlocalelist.param().abi(),
                dwnumlocales,
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn RequestChallenge<P0, P1>(
        &self,
        wsznetworkresource: P0,
        wszuser: P1,
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RequestChallenge)(
                windows_core::Interface::as_raw(self),
                wsznetworkresource.param().abi(),
                wszuser.param().abi(),
                &mut result__,
    ...
    pub unsafe fn WBEMLogin<P0, P3>(
        &self,
        wszpreferredlocale: P0,
        ...
        P3: windows_core::Param<IWbemContext>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).WBEMLogin)(
                windows_core::Interface::as_raw(self),
                wszpreferredlocale.param().abi(),
                accesstoken,
                lflags,
    ...
    pub unsafe fn NTLMLogin<P0, P1, P3>(
        &self,
        wsznetworkresource: P0,
        wszpreferredlocale: P1,
        lflags: i32,
        ...
        P3: windows_core::Param<IWbemContext>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).NTLMLogin)(
                windows_core::Interface::as_raw(self),
                wsznetworkresource.param().abi(),
                wszpreferredlocale.param().abi(),
                lflags,
...
pub struct IWbemLevel1Login_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub EstablishPosition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub RequestChallenge: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        *mut u8,
    ) -> windows_core::HRESULT,
    pub WBEMLogin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *const u8,
        i32,
    ...
    pub NTLMLogin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        i32,
...
pub trait IWbemLevel1Login_Impl: windows_core::IUnknownImpl {
    fn EstablishPosition(
        &self,
        wszlocalelist: &windows_core::PCWSTR,
        dwnumlocales: u32,
    ) -> windows_core::Result<u32>;
    fn RequestChallenge(
        &self,
        wsznetworkresource: &windows_core::PCWSTR,
        wszuser: &windows_core::PCWSTR,
    ) -> windows_core::Result<u8>;
    fn WBEMLogin(
        &self,
        wszpreferredlocale: &windows_core::PCWSTR,
...
impl IWbemLevel1Login_Vtbl {
    pub const fn new<Identity: IWbemLevel1Login_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn EstablishPosition<
            Identity: IWbemLevel1Login_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            wszlocalelist: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemLevel1Login_Impl::EstablishPosition(
                    this,
                    core::mem::transmute(&wszlocalelist),
                    core::mem::transmute_copy(&dwnumlocales),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn RequestChallenge<
            Identity: IWbemLevel1Login_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemLevel1Login_Impl::RequestChallenge(
                    this,
                    core::mem::transmute(&wsznetworkresource),
                    core::mem::transmute(&wszuser),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn WBEMLogin<
            Identity: IWbemLevel1Login_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemLevel1Login_Impl::WBEMLogin(
                    this,
                    core::mem::transmute(&wszpreferredlocale),
                    core::mem::transmute_copy(&accesstoken),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn NTLMLogin<
            Identity: IWbemLevel1Login_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemLevel1Login_Impl::NTLMLogin(
                    this,
                    core::mem::transmute(&wsznetworkresource),
                    core::mem::transmute(&wszpreferredlocale),
                    core::mem::transmute_copy(&lflags),
...
windows_core::imp::define_interface!(
    IWbemLocator,
    IWbemLocator_Vtbl,
    0xdc12a687_737f_11cf_884d_00aa004b2e24
);
    ...
    pub const fn new<Identity: IWbemLocator_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemLocator_Impl::ConnectServer(
                    this,
                    core::mem::transmute(&strnetworkresource),
                    core::mem::transmute(&struser),
                    core::mem::transmute(&strpassword),
...
windows_core::imp::define_interface!(
    ...
    0x49353c9a_516b_11d1_aea6_00c04fb68820
);
...
impl IWbemObjectAccess {
    pub unsafe fn GetPropertyHandle<P0>(
        &self,
        wszpropertyname: P0,
        ptype: *mut i32,
        plhandle: *mut i32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetPropertyHandle)(
                windows_core::Interface::as_raw(self),
                wszpropertyname.param().abi(),
                ptype as _,
                plhandle as _,
    ...
    pub unsafe fn WritePropertyValue(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).WritePropertyValue)(
                windows_core::Interface::as_raw(self),
                lhandle,
                adata.len().try_into().unwrap(),
                core::mem::transmute(adata.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn ReadPropertyValue(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ReadPropertyValue)(
                windows_core::Interface::as_raw(self),
                lhandle,
                adata.len().try_into().unwrap(),
                plnumbytes as _,
    ...
    pub unsafe fn WriteDWORD(&self, lhandle: i32, dw: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).WriteDWORD)(
                windows_core::Interface::as_raw(self),
                lhandle,
                dw,
            )
    ...
    pub unsafe fn ReadQWORD(&self, lhandle: i32) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReadQWORD)(
                windows_core::Interface::as_raw(self),
                lhandle,
                &mut result__,
            )
    ...
    pub unsafe fn WriteQWORD(&self, lhandle: i32, pw: u64) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).WriteQWORD)(
                windows_core::Interface::as_raw(self),
                lhandle,
                pw,
            )
    ...
    pub unsafe fn GetPropertyInfoByHandle(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetPropertyInfoByHandle)(
                windows_core::Interface::as_raw(self),
                lhandle,
                core::mem::transmute(pstrname),
                ptype as _,
...
pub struct IWbemObjectAccess_Vtbl {
    ...
    pub GetPropertyHandle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut i32,
        *mut i32,
    ) -> windows_core::HRESULT,
    pub WritePropertyValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        i32,
        *const u8,
    ) -> windows_core::HRESULT,
    pub ReadPropertyValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        i32,
        *mut i32,
    ...
    pub ReadDWORD:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, *mut u32) -> windows_core::HRESULT,
    pub WriteDWORD:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, u32) -> windows_core::HRESULT,
    pub ReadQWORD:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, *mut u64) -> windows_core::HRESULT,
    pub WriteQWORD:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32, u64) -> windows_core::HRESULT,
    pub GetPropertyInfoByHandle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut *mut core::ffi::c_void,
        *mut i32,
...
impl IWbemObjectAccess_Vtbl {
    pub const fn new<Identity: IWbemObjectAccess_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetPropertyHandle<
            Identity: IWbemObjectAccess_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            wszpropertyname: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemObjectAccess_Impl::GetPropertyHandle(
                    this,
                    core::mem::transmute(&wszpropertyname),
                    core::mem::transmute_copy(&ptype),
                    core::mem::transmute_copy(&plhandle),
                )
                .into()
            }
        }
        unsafe extern "system" fn WritePropertyValue<
            Identity: IWbemObjectAccess_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemObjectAccess_Impl::WritePropertyValue(
                    this,
                    core::mem::transmute_copy(&lhandle),
                    core::mem::transmute_copy(&lnumbytes),
                    core::mem::transmute_copy(&adata),
                )
                .into()
            }
        }
        unsafe extern "system" fn ReadPropertyValue<
            Identity: IWbemObjectAccess_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemObjectAccess_Impl::ReadPropertyValue(
                    this,
                    core::mem::transmute_copy(&lhandle),
                    core::mem::transmute_copy(&lbuffersize),
                    core::mem::transmute_copy(&plnumbytes),
                    core::mem::transmute_copy(&adata),
                )
                .into()
            }
        ...
        unsafe extern "system" fn WriteDWORD<
            Identity: IWbemObjectAccess_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemObjectAccess_Impl::WriteDWORD(
                    this,
                    core::mem::transmute_copy(&lhandle),
                    core::mem::transmute_copy(&dw),
                )
                .into()
            }
        }
        unsafe extern "system" fn ReadQWORD<
            Identity: IWbemObjectAccess_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn WriteQWORD<
            Identity: IWbemObjectAccess_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemObjectAccess_Impl::WriteQWORD(
                    this,
                    core::mem::transmute_copy(&lhandle),
                    core::mem::transmute_copy(&pw),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetPropertyInfoByHandle<
            Identity: IWbemObjectAccess_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemObjectAccess_Impl::GetPropertyInfoByHandle(
                    this,
                    core::mem::transmute_copy(&lhandle),
                    core::mem::transmute_copy(&pstrname),
                    core::mem::transmute_copy(&ptype),
        ...
        unsafe extern "system" fn Lock<Identity: IWbemObjectAccess_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Unlock<Identity: IWbemObjectAccess_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    ...
    0x7c857801_7381_11cf_884d_00aa004b2e24
);
windows_core::imp::interface_hierarchy!(IWbemObjectSink, windows_core::IUnknown);
impl IWbemObjectSink {
    pub unsafe fn Indicate(
        &self,
        apobjarray: &[Option<IWbemClassObject>],
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Indicate)(
                windows_core::Interface::as_raw(self),
                apobjarray.len().try_into().unwrap(),
                core::mem::transmute(apobjarray.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn SetStatus<P3>(
        &self,
        lflags: i32,
        hresult: windows_core::HRESULT,
        strparam: &windows_core::BSTR,
        pobjparam: P3,
    ) -> windows_core::Result<()>
    where
        P3: windows_core::Param<IWbemClassObject>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetStatus)(
                windows_core::Interface::as_raw(self),
                lflags,
                hresult,
                core::mem::transmute_copy(strparam),
                pobjparam.param().abi(),
            )
            .ok()
        }
...
pub struct IWbemObjectSink_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub Indicate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *const *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IWbemObjectSink_Impl: windows_core::IUnknownImpl {
    ...
    fn SetStatus(
        ...
        hresult: windows_core::HRESULT,
        strparam: &windows_core::BSTR,
        pobjparam: windows_core::Ref<'_, IWbemClassObject>,
    ) -> windows_core::Result<()>;
}
impl IWbemObjectSink_Vtbl {
    pub const fn new<Identity: IWbemObjectSink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Indicate<Identity: IWbemObjectSink_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lobjectcount: i32,
            apobjarray: *const *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemObjectSink_Impl::Indicate(
                    this,
                    core::mem::transmute_copy(&lobjectcount),
                    core::mem::transmute_copy(&apobjarray),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetStatus<Identity: IWbemObjectSink_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            hresult: windows_core::HRESULT,
            strparam: *mut core::ffi::c_void,
            pobjparam: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemObjectSink_Impl::SetStatus(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&hresult),
                    core::mem::transmute(&strparam),
                    core::mem::transmute_copy(&pobjparam),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            Indicate: Indicate::<Identity, OFFSET>,
...
windows_core::imp::define_interface!(
    ...
    0xe7d35cfa_348b_485e_b524_252725d697ca
);
...
impl IWbemObjectSinkEx {
    pub unsafe fn WriteMessage(
        &self,
        uchannel: u32,
        strmessage: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).WriteMessage)(
                windows_core::Interface::as_raw(self),
                uchannel,
                core::mem::transmute_copy(strmessage),
            )
            .ok()
        }
    }
        ...
        P0: windows_core::Param<IWbemClassObject>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).WriteError)(
                windows_core::Interface::as_raw(self),
                pobjerror.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn PromptUser(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PromptUser)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strmessage),
                uprompttype,
                &mut result__,
    ...
    pub unsafe fn WriteProgress(
        &self,
        stractivity: &windows_core::BSTR,
        strcurrentoperation: &windows_core::BSTR,
        strstatusdescription: &windows_core::BSTR,
        upercentcomplete: u32,
        usecondsremaining: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).WriteProgress)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(stractivity),
                core::mem::transmute_copy(strcurrentoperation),
                core::mem::transmute_copy(strstatusdescription),
                upercentcomplete,
                usecondsremaining,
            )
            .ok()
    ...
    pub unsafe fn WriteStreamParameter(
        &self,
        strname: &windows_core::BSTR,
        vtvalue: *const super::Variant::VARIANT,
        ultype: u32,
        ulflags: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).WriteStreamParameter)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strname),
                core::mem::transmute(vtvalue),
                ultype,
                ulflags,
            )
            .ok()
...
pub struct IWbemObjectSinkEx_Vtbl {
    pub base__: IWbemObjectSink_Vtbl,
    pub WriteMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub WriteError: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut u8,
    ) -> windows_core::HRESULT,
    pub PromptUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u8,
        *mut u8,
    ) -> windows_core::HRESULT,
    pub WriteProgress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub WriteStreamParameter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const super::Variant::VARIANT,
        u32,
...
pub trait IWbemObjectSinkEx_Impl: IWbemObjectSink_Impl {
    ...
    fn WriteError(
        &self,
        pobjerror: windows_core::Ref<'_, IWbemClassObject>,
    ) -> windows_core::Result<u8>;
    fn PromptUser(
        &self,
        strmessage: &windows_core::BSTR,
...
impl IWbemObjectSinkEx_Vtbl {
    pub const fn new<Identity: IWbemObjectSinkEx_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn WriteMessage<
            Identity: IWbemObjectSinkEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            uchannel: u32,
            strmessage: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemObjectSinkEx_Impl::WriteMessage(
                    this,
                    core::mem::transmute_copy(&uchannel),
                    core::mem::transmute(&strmessage),
                )
                .into()
            }
        }
        unsafe extern "system" fn WriteError<
            Identity: IWbemObjectSinkEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pobjerror: *mut core::ffi::c_void,
            pureturned: *mut u8,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemObjectSinkEx_Impl::WriteError(
                    this,
                    core::mem::transmute_copy(&pobjerror),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn PromptUser<
            Identity: IWbemObjectSinkEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemObjectSinkEx_Impl::PromptUser(
                    this,
                    core::mem::transmute(&strmessage),
                    core::mem::transmute_copy(&uprompttype),
                ) {
                    Ok(ok__) => {
                        pureturned.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn WriteProgress<
            Identity: IWbemObjectSinkEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            stractivity: *mut core::ffi::c_void,
            strcurrentoperation: *mut core::ffi::c_void,
            strstatusdescription: *mut core::ffi::c_void,
            upercentcomplete: u32,
            usecondsremaining: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemObjectSinkEx_Impl::WriteProgress(
                    this,
                    core::mem::transmute(&stractivity),
                    core::mem::transmute(&strcurrentoperation),
                    core::mem::transmute(&strstatusdescription),
                    core::mem::transmute_copy(&upercentcomplete),
                    core::mem::transmute_copy(&usecondsremaining),
                )
                .into()
            }
        }
        unsafe extern "system" fn WriteStreamParameter<
            Identity: IWbemObjectSinkEx_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemObjectSinkEx_Impl::WriteStreamParameter(
                    this,
                    core::mem::transmute(&strname),
                    core::mem::transmute_copy(&vtvalue),
                    core::mem::transmute_copy(&ultype),
...
impl IWbemObjectTextSrc {
    ...
    pub unsafe fn CreateFromText<P3>(
        &self,
        lflags: i32,
        strtext: &windows_core::BSTR,
        uobjtextformat: u32,
        pctx: P3,
    ) -> windows_core::Result<IWbemClassObject>
    where
        P3: windows_core::Param<IWbemContext>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateFromText)(
                windows_core::Interface::as_raw(self),
                lflags,
                core::mem::transmute_copy(strtext),
                uobjtextformat,
                pctx.param().abi(),
                &mut result__,
            )
...
pub struct IWbemObjectTextSrc_Vtbl {
    ...
    pub CreateFromText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
        u32,
...
pub trait IWbemObjectTextSrc_Impl: windows_core::IUnknownImpl {
    fn GetText(
        &self,
        lflags: i32,
        pobj: windows_core::Ref<'_, IWbemClassObject>,
        uobjtextformat: u32,
        pctx: windows_core::Ref<'_, IWbemContext>,
    ) -> windows_core::Result<windows_core::BSTR>;
    fn CreateFromText(
...
impl IWbemObjectTextSrc_Vtbl {
    pub const fn new<Identity: IWbemObjectTextSrc_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetText<
            Identity: IWbemObjectTextSrc_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: i32,
            ...
            uobjtextformat: u32,
            pctx: *mut core::ffi::c_void,
            strtext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemObjectTextSrc_Impl::GetText(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pobj),
                    core::mem::transmute_copy(&uobjtextformat),
                    core::mem::transmute_copy(&pctx),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateFromText<
            Identity: IWbemObjectTextSrc_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: i32,
            strtext: *mut core::ffi::c_void,
            uobjtextformat: u32,
            pctx: *mut core::ffi::c_void,
            pnewobj: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemObjectTextSrc_Impl::CreateFromText(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute(&strtext),
                    core::mem::transmute_copy(&uobjtextformat),
                    core::mem::transmute_copy(&pctx),
                ) {
                    Ok(ok__) => {
...
windows_core::imp::define_interface!(
    IWbemPath,
    IWbemPath_Vtbl,
    0x3bc15af2_736c_477e_9e51_238af8667dcc
);
...
impl IWbemPath {
    ...
    pub unsafe fn GetServer(
        &self,
        punamebuflength: *mut u32,
        pname: windows_core::PWSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetServer)(
                windows_core::Interface::as_raw(self),
                punamebuflength as _,
    ...
    pub unsafe fn GetNamespaceCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNamespaceCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetNamespaceAt)(
                windows_core::Interface::as_raw(self),
                uindex,
                pszname.param().abi(),
            )
    ...
    pub unsafe fn GetNamespaceAt(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetNamespaceAt)(
                windows_core::Interface::as_raw(self),
                uindex,
                punamebuflength as _,
                core::mem::transmute(pname),
    ...
    pub unsafe fn RemoveNamespaceAt(&self, uindex: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveNamespaceAt)(
                windows_core::Interface::as_raw(self),
                uindex,
            )
            .ok()
    ...
    pub unsafe fn RemoveAllNamespaces(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveAllNamespaces)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    pub unsafe fn GetScopeCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetScopeCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetScope)(
                windows_core::Interface::as_raw(self),
                uindex,
                pszclass.param().abi(),
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetScopeFromText)(
                windows_core::Interface::as_raw(self),
                uindex,
                psztext.param().abi(),
            )
    ...
    pub unsafe fn GetScope(
        &self,
        uindex: u32,
        puclassnamebufsize: *mut u32,
        pszclass: windows_core::PWSTR,
        pkeylist: *mut Option<IWbemPathKeyList>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetScope)(
                windows_core::Interface::as_raw(self),
                uindex,
                puclassnamebufsize as _,
                core::mem::transmute(pszclass),
                core::mem::transmute(pkeylist),
            )
            .ok()
        }
    }
    pub unsafe fn GetScopeAsText(
        &self,
        uindex: u32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetScopeAsText)(
                windows_core::Interface::as_raw(self),
                uindex,
                putextbufsize as _,
                core::mem::transmute(psztext),
    ...
    pub unsafe fn RemoveScope(&self, uindex: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveScope)(
                windows_core::Interface::as_raw(self),
                uindex,
            )
            .ok()
    ...
    pub unsafe fn RemoveAllScopes(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveAllScopes)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetClassName)(
                windows_core::Interface::as_raw(self),
                name.param().abi(),
            )
            .ok()
    ...
    pub unsafe fn GetClassName(
        &self,
        pubufflength: *mut u32,
        pszname: Option<windows_core::PWSTR>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetClassName)(
                windows_core::Interface::as_raw(self),
                pubufflength as _,
                pszname.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetKeyList(&self) -> windows_core::Result<IWbemPathKeyList> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetKeyList)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CreateClassPart)(
                windows_core::Interface::as_raw(self),
                lflags,
                name.param().abi(),
            )
    ...
    pub unsafe fn DeleteClassPart(&self, lflags: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteClassPart)(
                windows_core::Interface::as_raw(self),
                lflags,
            )
            .ok()
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).IsRelative)(
                windows_core::Interface::as_raw(self),
                wszmachine.param().abi(),
                wsznamespace.param().abi(),
            )
        }
    }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).IsRelativeOrChild)(
                windows_core::Interface::as_raw(self),
                wszmachine.param().abi(),
                wsznamespace.param().abi(),
                lflags,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).IsSameClassName)(
                windows_core::Interface::as_raw(self),
                wszclass.param().abi(),
            )
        }
...
pub struct IWbemPath_Vtbl {
    ...
    pub GetServer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub GetNamespaceCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub SetNamespaceAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetNamespaceAt: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u32,
        windows_core::PWSTR,
    ) -> windows_core::HRESULT,
    pub RemoveNamespaceAt:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub RemoveAllNamespaces:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub GetScopeCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    ...
    pub SetScopeFromText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub GetScope: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u32,
        windows_core::PWSTR,
    ...
    pub GetScopeAsText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u32,
        windows_core::PWSTR,
    ...
    pub SetClassName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    ...
    pub GetKeyList: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateClassPart: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    pub DeleteClassPart:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub IsRelative: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
    ) -> windows_core::BOOL,
    pub IsRelativeOrChild: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        i32,
    ...
    pub IsSameClassName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
    ) -> windows_core::BOOL,
}
pub trait IWbemPath_Impl: windows_core::IUnknownImpl {
    ...
    fn GetScope(
        ...
        puclassnamebufsize: *mut u32,
        pszclass: windows_core::PWSTR,
        pkeylist: windows_core::OutRef<'_, IWbemPathKeyList>,
    ) -> windows_core::Result<()>;
    fn GetScopeAsText(
        &self,
        uindex: u32,
    ...
    fn CreateClassPart(&self, lflags: i32, name: &windows_core::PCWSTR)
        -> windows_core::Result<()>;
    fn DeleteClassPart(&self, lflags: i32) -> windows_core::Result<()>;
    fn IsRelative(
        &self,
        wszmachine: &windows_core::PCWSTR,
        wsznamespace: &windows_core::PCWSTR,
    ) -> windows_core::BOOL;
...
impl IWbemPath_Vtbl {
    pub const fn new<Identity: IWbemPath_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetText<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            umode: u32,
            pszpath: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPath_Impl::SetText(
                    this,
                    core::mem::transmute_copy(&umode),
                    core::mem::transmute(&pszpath),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetText<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            pubufflength: *mut u32,
            psztext: windows_core::PWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPath_Impl::GetText(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pubufflength),
                    core::mem::transmute_copy(&psztext),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetInfo<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            urequestedinfo: u32,
            puresponse: *mut u64,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn SetServer<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetServer<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            punamebuflength: *mut u32,
            pname: windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPath_Impl::GetServer(
                    this,
                    core::mem::transmute_copy(&punamebuflength),
                    core::mem::transmute_copy(&pname),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetNamespaceCount<
            Identity: IWbemPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pucount: *mut u32,
        ...
        unsafe extern "system" fn SetNamespaceAt<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uindex: u32,
            pszname: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPath_Impl::SetNamespaceAt(
                    this,
                    core::mem::transmute_copy(&uindex),
                    core::mem::transmute(&pszname),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetNamespaceAt<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uindex: u32,
            punamebuflength: *mut u32,
            pname: windows_core::PWSTR,
        ...
        unsafe extern "system" fn RemoveNamespaceAt<
            Identity: IWbemPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn RemoveAllNamespaces<
            Identity: IWbemPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetScopeCount<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pucount: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetScope<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uindex: u32,
            pszclass: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPath_Impl::SetScope(
                    this,
                    core::mem::transmute_copy(&uindex),
                    core::mem::transmute(&pszclass),
                )
        ...
        unsafe extern "system" fn SetScopeFromText<
            Identity: IWbemPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPath_Impl::SetScopeFromText(
                    this,
                    core::mem::transmute_copy(&uindex),
                    core::mem::transmute(&psztext),
                )
        ...
        unsafe extern "system" fn GetScope<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uindex: u32,
            puclassnamebufsize: *mut u32,
            pszclass: windows_core::PWSTR,
            pkeylist: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPath_Impl::GetScope(
                    this,
                    core::mem::transmute_copy(&uindex),
                    core::mem::transmute_copy(&puclassnamebufsize),
                    core::mem::transmute_copy(&pszclass),
                    core::mem::transmute_copy(&pkeylist),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetScopeAsText<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uindex: u32,
            putextbufsize: *mut u32,
            psztext: windows_core::PWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPath_Impl::GetScopeAsText(
                    this,
                    core::mem::transmute_copy(&uindex),
                    core::mem::transmute_copy(&putextbufsize),
                    core::mem::transmute_copy(&psztext),
                )
                .into()
            }
        }
        unsafe extern "system" fn RemoveScope<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uindex: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn RemoveAllScopes<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn SetClassName<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            name: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetClassName<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pubufflength: *mut u32,
            pszname: windows_core::PWSTR,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetKeyList<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CreateClassPart<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            name: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPath_Impl::CreateClassPart(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute(&name),
                )
        ...
        unsafe extern "system" fn DeleteClassPart<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn IsRelative<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszmachine: windows_core::PCWSTR,
            wsznamespace: windows_core::PCWSTR,
        ) -> windows_core::BOOL {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPath_Impl::IsRelative(
                    this,
                    core::mem::transmute(&wszmachine),
                    core::mem::transmute(&wsznamespace),
                )
            }
        }
        unsafe extern "system" fn IsRelativeOrChild<
            Identity: IWbemPath_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPath_Impl::IsRelativeOrChild(
                    this,
                    core::mem::transmute(&wszmachine),
                    core::mem::transmute(&wsznamespace),
                    core::mem::transmute_copy(&lflags),
        ...
        unsafe extern "system" fn IsLocal<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszmachine: windows_core::PCWSTR,
        ) -> windows_core::BOOL {
            unsafe {
        ...
        unsafe extern "system" fn IsSameClassName<Identity: IWbemPath_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszclass: windows_core::PCWSTR,
        ) -> windows_core::BOOL {
            unsafe {
...
windows_core::imp::define_interface!(
    ...
    0x9ae62877_7544_4bb0_aa26_a13824659ed6
);
...
impl IWbemPathKeyList {
    ...
    pub unsafe fn SetKey<P0>(
        &self,
        wszname: P0,
        uflags: u32,
        ucimtype: u32,
        pkeyval: *const core::ffi::c_void,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetKey2<P0>(
        &self,
        wszname: P0,
        uflags: u32,
        ucimtype: u32,
        pkeyval: *const super::Variant::VARIANT,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetKey2)(
                windows_core::Interface::as_raw(self),
                wszname.param().abi(),
                uflags,
                ucimtype,
                core::mem::transmute(pkeyval),
            )
            .ok()
        }
    }
    pub unsafe fn GetKey(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetKey)(
                ...
                pukeyvalbufsize as _,
                pkeyval as _,
                puapparentcimtype as _,
            )
            .ok()
        }
    }
    ...
    pub unsafe fn GetKey2(
        &self,
        ukeyix: u32,
        uflags: u32,
        punamebufsize: *mut u32,
        pszkeyname: Option<windows_core::PWSTR>,
        pkeyvalue: *mut super::Variant::VARIANT,
        puapparentcimtype: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetKey2)(
                windows_core::Interface::as_raw(self),
                ukeyix,
                uflags,
                punamebufsize as _,
                pszkeyname.unwrap_or(core::mem::zeroed()) as _,
                core::mem::transmute(pkeyvalue),
                puapparentcimtype as _,
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveKey)(
                windows_core::Interface::as_raw(self),
                wszname.param().abi(),
                uflags,
            )
    ...
    pub unsafe fn RemoveAllKeys(&self, uflags: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RemoveAllKeys)(
                windows_core::Interface::as_raw(self),
                uflags,
            )
            .ok()
    ...
    pub unsafe fn MakeSingleton(&self, bset: u8) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).MakeSingleton)(
                windows_core::Interface::as_raw(self),
                bset,
            )
            .ok()
...
pub struct IWbemPathKeyList_Vtbl {
    ...
    pub SetKey2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
        u32,
    ...
    pub GetKey2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut u32,
    ...
    GetKey2: usize,
    pub RemoveKey: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
    ) -> windows_core::HRESULT,
...
impl IWbemPathKeyList_Vtbl {
    pub const fn new<Identity: IWbemPathKeyList_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCount<Identity: IWbemPathKeyList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pukeycount: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetKey<Identity: IWbemPathKeyList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            uflags: u32,
            ucimtype: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPathKeyList_Impl::SetKey(
                    this,
                    core::mem::transmute(&wszname),
                    core::mem::transmute_copy(&uflags),
                    core::mem::transmute_copy(&ucimtype),
                    core::mem::transmute_copy(&pkeyval),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetKey2<Identity: IWbemPathKeyList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            uflags: u32,
            ucimtype: u32,
        ...
        unsafe extern "system" fn GetKey<Identity: IWbemPathKeyList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ukeyix: u32,
            uflags: u32,
            punamebufsize: *mut u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPathKeyList_Impl::GetKey(
                    this,
                    core::mem::transmute_copy(&ukeyix),
                    core::mem::transmute_copy(&uflags),
                    core::mem::transmute_copy(&punamebufsize),
                    core::mem::transmute_copy(&pszkeyname),
                    core::mem::transmute_copy(&pukeyvalbufsize),
                    core::mem::transmute_copy(&pkeyval),
                    core::mem::transmute_copy(&puapparentcimtype),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetKey2<Identity: IWbemPathKeyList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ukeyix: u32,
            uflags: u32,
            punamebufsize: *mut u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPathKeyList_Impl::GetKey2(
                    this,
                    core::mem::transmute_copy(&ukeyix),
                    core::mem::transmute_copy(&uflags),
                    core::mem::transmute_copy(&punamebufsize),
                    core::mem::transmute_copy(&pszkeyname),
                    core::mem::transmute_copy(&pkeyvalue),
                    core::mem::transmute_copy(&puapparentcimtype),
                )
                .into()
            }
        }
        unsafe extern "system" fn RemoveKey<
            Identity: IWbemPathKeyList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPathKeyList_Impl::RemoveKey(
                    this,
                    core::mem::transmute(&wszname),
                    core::mem::transmute_copy(&uflags),
                )
        ...
        unsafe extern "system" fn RemoveAllKeys<
            Identity: IWbemPathKeyList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPathKeyList_Impl::RemoveAllKeys(this, core::mem::transmute_copy(&uflags))
                    .into()
            }
        }
        unsafe extern "system" fn MakeSingleton<
            Identity: IWbemPathKeyList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetInfo<Identity: IWbemPathKeyList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            urequestedinfo: u32,
            puresponse: *mut u64,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemPathKeyList_Impl::GetInfo(
                    this,
                    core::mem::transmute_copy(&urequestedinfo),
                ) {
                    Ok(ok__) => {
                        puresponse.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn GetText<Identity: IWbemPathKeyList_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            pubufflength: *mut u32,
            psztext: windows_core::PWSTR,
...
windows_core::imp::define_interface!(
    ...
    0xce61e841_65bc_11d0_b6bd_00aa003240c7
);
...
impl IWbemPropertyProvider {
    ...
    pub unsafe fn GetProperty(
        ...
        lflags: i32,
        strlocale: &windows_core::BSTR,
        strclassmapping: &windows_core::BSTR,
        strinstmapping: &windows_core::BSTR,
        strpropmapping: &windows_core::BSTR,
    ) -> windows_core::Result<super::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetProperty)(
                ...
                lflags,
                core::mem::transmute_copy(strlocale),
                core::mem::transmute_copy(strclassmapping),
                core::mem::transmute_copy(strinstmapping),
                core::mem::transmute_copy(strpropmapping),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
        }
    ...
    pub unsafe fn PutProperty(
        ...
        strinstmapping: &windows_core::BSTR,
        strpropmapping: &windows_core::BSTR,
        pvvalue: *const super::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).PutProperty)(
                windows_core::Interface::as_raw(self),
                lflags,
                core::mem::transmute_copy(strlocale),
                core::mem::transmute_copy(strclassmapping),
...
impl IWbemPropertyProvider_Vtbl {
    pub const fn new<Identity: IWbemPropertyProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetProperty<
            Identity: IWbemPropertyProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: i32,
            strlocale: *mut core::ffi::c_void,
            strclassmapping: *mut core::ffi::c_void,
            strinstmapping: *mut core::ffi::c_void,
            strpropmapping: *mut core::ffi::c_void,
            pvvalue: *mut super::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemPropertyProvider_Impl::GetProperty(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute(&strlocale),
                    core::mem::transmute(&strclassmapping),
                    core::mem::transmute(&strinstmapping),
                    core::mem::transmute(&strpropmapping),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn PutProperty<
            Identity: IWbemPropertyProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemPropertyProvider_Impl::PutProperty(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute(&strlocale),
                    core::mem::transmute(&strclassmapping),
...
impl IWbemProviderIdentity {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetRegistrationObject)(
                windows_core::Interface::as_raw(self),
                lflags,
                pprovreg.param().abi(),
            )
...
pub struct IWbemProviderIdentity_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub SetRegistrationObject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub trait IWbemProviderIdentity_Impl: windows_core::IUnknownImpl {
    fn SetRegistrationObject(
        &self,
        lflags: i32,
        pprovreg: windows_core::Ref<'_, IWbemClassObject>,
    ) -> windows_core::Result<()>;
}
impl IWbemProviderIdentity_Vtbl {
    pub const fn new<Identity: IWbemProviderIdentity_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetRegistrationObject<
            Identity: IWbemProviderIdentity_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: i32,
            pprovreg: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemProviderIdentity_Impl::SetRegistrationObject(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pprovreg),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            SetRegistrationObject: SetRegistrationObject::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub trait IWbemProviderInit_Impl: windows_core::IUnknownImpl {
    fn Initialize(
        ...
        lflags: i32,
        wsznamespace: &windows_core::PCWSTR,
        wszlocale: &windows_core::PCWSTR,
        pnamespace: windows_core::Ref<'_, IWbemServices>,
        pctx: windows_core::Ref<'_, IWbemContext>,
        pinitsink: windows_core::Ref<'_, IWbemProviderInitSink>,
    ) -> windows_core::Result<()>;
}
impl IWbemProviderInit_Vtbl {
    pub const fn new<Identity: IWbemProviderInit_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Initialize<
            Identity: IWbemProviderInit_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            wszuser: windows_core::PCWSTR,
            ...
            pnamespace: *mut core::ffi::c_void,
            pctx: *mut core::ffi::c_void,
            pinitsink: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemProviderInit_Impl::Initialize(
                    this,
                    core::mem::transmute(&wszuser),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute(&wsznamespace),
                    core::mem::transmute(&wszlocale),
                    core::mem::transmute_copy(&pnamespace),
                    core::mem::transmute_copy(&pctx),
                    core::mem::transmute_copy(&pinitsink),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x1be41571_91dd_11d1_aeb2_00c04fb68820
);
...
impl IWbemProviderInitSink_Vtbl {
    pub const fn new<Identity: IWbemProviderInitSink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetStatus<
            Identity: IWbemProviderInitSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lstatus: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemProviderInitSink_Impl::SetStatus(
                    this,
                    core::mem::transmute_copy(&lstatus),
                    core::mem::transmute_copy(&lflags),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0xdc12a680_737f_11cf_884d_00aa004b2e24
);
...
impl IWbemQualifierSet_Vtbl {
    pub const fn new<Identity: IWbemQualifierSet_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Get<Identity: IWbemQualifierSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            lflags: i32,
            pval: *mut super::Variant::VARIANT,
        ...
        unsafe extern "system" fn Put<Identity: IWbemQualifierSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
            pval: *const super::Variant::VARIANT,
            lflavor: i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemQualifierSet_Impl::Put(
                    this,
                    core::mem::transmute(&wszname),
                    core::mem::transmute_copy(&pval),
                    core::mem::transmute_copy(&lflavor),
                )
                .into()
            }
        }
        unsafe extern "system" fn Delete<Identity: IWbemQualifierSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            wszname: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetNames<
            Identity: IWbemQualifierSet_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: i32,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemQualifierSet_Impl::BeginEnumeration(this, core::mem::transmute_copy(&lflags))
                    .into()
            }
        }
        unsafe extern "system" fn Next<Identity: IWbemQualifierSet_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            pstrname: *mut *mut core::ffi::c_void,
            pval: *mut super::Variant::VARIANT,
...
windows_core::imp::define_interface!(
    IWbemQuery,
    IWbemQuery_Vtbl,
    0x81166f58_dd98_11d3_a120_00105a1f515a
);
windows_core::imp::interface_hierarchy!(IWbemQuery, windows_core::IUnknown);
impl IWbemQuery {
    pub unsafe fn Empty(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Empty)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn SetLanguageFeatures(
        &self,
        uflags: u32,
        uarraysize: u32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetLanguageFeatures)(
                windows_core::Interface::as_raw(self),
                uflags,
                uarraysize,
                pufeatures,
    ...
    pub unsafe fn TestLanguageFeatures(
        &self,
        uflags: u32,
        uarraysize: *mut u32,
        pufeatures: *mut u32,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).TestLanguageFeatures)(
                windows_core::Interface::as_raw(self),
                uflags,
                uarraysize as _,
                pufeatures as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Parse)(
                windows_core::Interface::as_raw(self),
                pszlang.param().abi(),
                pszquery.param().abi(),
                uflags,
    ...
    pub unsafe fn GetAnalysis(
        &self,
        uanalysistype: u32,
        uflags: u32,
        panalysis: *mut *mut core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetAnalysis)(
                windows_core::Interface::as_raw(self),
                uanalysistype,
                uflags,
                panalysis as _,
    ...
    pub unsafe fn GetQueryInfo(
        &self,
        uanalysistype: u32,
        uinfoid: u32,
        ubufsize: u32,
        pdestbuf: *mut core::ffi::c_void,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetQueryInfo)(
                windows_core::Interface::as_raw(self),
                uanalysistype,
                uinfoid,
                ubufsize,
...
pub struct IWbemQuery_Vtbl {
    ...
    pub SetLanguageFeatures: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const u32,
    ) -> windows_core::HRESULT,
    pub TestLanguageFeatures: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub Parse: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
        u32,
    ) -> windows_core::HRESULT,
    pub GetAnalysis: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *mut *mut core::ffi::c_void,
    ...
    pub GetQueryInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        u32,
...
pub trait IWbemQuery_Impl: windows_core::IUnknownImpl {
    ...
    fn Parse(
        &self,
        pszlang: &windows_core::PCWSTR,
        pszquery: &windows_core::PCWSTR,
        uflags: u32,
    ) -> windows_core::Result<()>;
    fn GetAnalysis(
        &self,
...
impl IWbemQuery_Vtbl {
    pub const fn new<Identity: IWbemQuery_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Empty<Identity: IWbemQuery_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn SetLanguageFeatures<
            Identity: IWbemQuery_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            uflags: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemQuery_Impl::SetLanguageFeatures(
                    this,
                    core::mem::transmute_copy(&uflags),
                    core::mem::transmute_copy(&uarraysize),
                    core::mem::transmute_copy(&pufeatures),
                )
                .into()
            }
        }
        unsafe extern "system" fn TestLanguageFeatures<
            Identity: IWbemQuery_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemQuery_Impl::TestLanguageFeatures(
                    this,
                    core::mem::transmute_copy(&uflags),
                    core::mem::transmute_copy(&uarraysize),
                    core::mem::transmute_copy(&pufeatures),
        ...
        unsafe extern "system" fn Parse<Identity: IWbemQuery_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszlang: windows_core::PCWSTR,
            pszquery: windows_core::PCWSTR,
            uflags: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemQuery_Impl::Parse(
                    this,
                    core::mem::transmute(&pszlang),
                    core::mem::transmute(&pszquery),
                    core::mem::transmute_copy(&uflags),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetAnalysis<Identity: IWbemQuery_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uanalysistype: u32,
            uflags: u32,
            panalysis: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemQuery_Impl::GetAnalysis(
                    this,
                    core::mem::transmute_copy(&uanalysistype),
                    core::mem::transmute_copy(&uflags),
                    core::mem::transmute_copy(&panalysis),
                )
                .into()
            }
        }
        unsafe extern "system" fn FreeMemory<Identity: IWbemQuery_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetQueryInfo<Identity: IWbemQuery_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            uanalysistype: u32,
            uinfoid: u32,
            ubufsize: u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemQuery_Impl::GetQueryInfo(
                    this,
                    core::mem::transmute_copy(&uanalysistype),
                    core::mem::transmute_copy(&uinfoid),
                    core::mem::transmute_copy(&ubufsize),
                    core::mem::transmute_copy(&pdestbuf),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IWbemRefresher,
    IWbemRefresher_Vtbl,
    0x49353c99_516b_11d1_aea6_00c04fb68820
);
...
impl IWbemRefresher_Vtbl {
    pub const fn new<Identity: IWbemRefresher_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Refresh<Identity: IWbemRefresher_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl IWbemServices {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).OpenNamespace)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strnamespace),
                lflags,
                pctx.param().abi(),
                ppworkingnamespace.unwrap_or(core::mem::zeroed()) as _,
    ...
    pub unsafe fn QueryObjectSink(
        &self,
        lflags: WBEM_GENERIC_FLAG_TYPE,
    ) -> windows_core::Result<IWbemObjectSink> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).QueryObjectSink)(
                windows_core::Interface::as_raw(self),
                lflags,
                &mut result__,
            )
        ...
        P2: windows_core::Param<IWbemContext>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetObject)(
                ...
                lflags,
                pctx.param().abi(),
                ppobject.unwrap_or(core::mem::zeroed()) as _,
                ppcallresult.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetObjectAsync<P2, P3>(
        &self,
        strobjectpath: &windows_core::BSTR,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetObjectAsync)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strobjectpath),
                lflags,
                pctx.param().abi(),
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PutClass)(
                windows_core::Interface::as_raw(self),
                pobject.param().abi(),
                lflags,
                pctx.param().abi(),
    ...
    pub unsafe fn PutClassAsync<P0, P2, P3>(
        &self,
        pobject: P0,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PutClassAsync)(
                windows_core::Interface::as_raw(self),
                pobject.param().abi(),
                lflags,
                pctx.param().abi(),
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteClass)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strclass),
                lflags,
                pctx.param().abi(),
    ...
    pub unsafe fn DeleteClassAsync<P2, P3>(
        &self,
        strclass: &windows_core::BSTR,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteClassAsync)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strclass),
                lflags,
                pctx.param().abi(),
    ...
    pub unsafe fn CreateClassEnum<P2>(
        &self,
        strsuperclass: &windows_core::BSTR,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: P2,
        ...
        P2: windows_core::Param<IWbemContext>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateClassEnum)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strsuperclass),
                lflags,
                pctx.param().abi(),
    ...
    pub unsafe fn CreateClassEnumAsync<P2, P3>(
        &self,
        strsuperclass: &windows_core::BSTR,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CreateClassEnumAsync)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strsuperclass),
                lflags,
                pctx.param().abi(),
    ...
    pub unsafe fn PutInstance<P0, P2>(
        &self,
        pinst: P0,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PutInstance)(
                windows_core::Interface::as_raw(self),
                pinst.param().abi(),
                lflags,
                pctx.param().abi(),
    ...
    pub unsafe fn PutInstanceAsync<P0, P2, P3>(
        &self,
        pinst: P0,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).PutInstanceAsync)(
                windows_core::Interface::as_raw(self),
                pinst.param().abi(),
                lflags,
                pctx.param().abi(),
    ...
    pub unsafe fn DeleteInstance<P2>(
        &self,
        strobjectpath: &windows_core::BSTR,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteInstance)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strobjectpath),
                lflags,
                pctx.param().abi(),
    ...
    pub unsafe fn DeleteInstanceAsync<P2, P3>(
        &self,
        strobjectpath: &windows_core::BSTR,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteInstanceAsync)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strobjectpath),
                lflags,
                pctx.param().abi(),
    ...
    pub unsafe fn CreateInstanceEnum<P2>(
        &self,
        strfilter: &windows_core::BSTR,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: P2,
    ) -> windows_core::Result<IEnumWbemClassObject>
    where
        P2: windows_core::Param<IWbemContext>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateInstanceEnum)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strfilter),
                lflags,
                pctx.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn CreateInstanceEnumAsync<P2, P3>(
        &self,
        strfilter: &windows_core::BSTR,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).CreateInstanceEnumAsync)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(strfilter),
                lflags,
                pctx.param().abi(),
    ...
    pub unsafe fn ExecQueryAsync<P3, P4>(
        &self,
        strquerylanguage: &windows_core::BSTR,
        strquery: &windows_core::BSTR,
        lflags: WBEM_GENERIC_FLAG_TYPE,
    ...
    pub unsafe fn ExecNotificationQueryAsync<P3, P4>(
        &self,
        strquerylanguage: &windows_core::BSTR,
        strquery: &windows_core::BSTR,
        lflags: WBEM_GENERIC_FLAG_TYPE,
    ...
    pub unsafe fn ExecMethod<P3, P4>(
        &self,
        strobjectpath: &windows_core::BSTR,
        strmethodname: &windows_core::BSTR,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        ...
        P4: windows_core::Param<IWbemClassObject>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).ExecMethod)(
                ...
                pctx.param().abi(),
                pinparams.param().abi(),
                ppoutparams.unwrap_or(core::mem::zeroed()) as _,
                ppcallresult.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn ExecMethodAsync<P3, P4, P5>(
        &self,
        strobjectpath: &windows_core::BSTR,
        strmethodname: &windows_core::BSTR,
        lflags: WBEM_GENERIC_FLAG_TYPE,
...
pub struct IWbemServices_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub OpenNamespace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub QueryObjectSink: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GetObjectAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
    ...
    pub PutClass: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
    ...
    pub PutClassAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
    ...
    pub DeleteClass: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
    ...
    pub DeleteClassAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
    ...
    pub CreateClassEnum: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
    ...
    pub CreateClassEnumAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
    ...
    pub PutInstance: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
    ...
    pub PutInstanceAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
    ...
    pub DeleteInstance: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
    ...
    pub DeleteInstanceAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
    ...
    pub CreateInstanceEnum: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
    ...
    pub CreateInstanceEnumAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WBEM_GENERIC_FLAG_TYPE,
        *mut core::ffi::c_void,
...
pub trait IWbemServices_Impl: windows_core::IUnknownImpl {
    fn OpenNamespace(
        ...
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: windows_core::Ref<'_, IWbemContext>,
        ppworkingnamespace: windows_core::OutRef<'_, IWbemServices>,
        ppresult: windows_core::OutRef<'_, IWbemCallResult>,
    ) -> windows_core::Result<()>;
    fn CancelAsyncCall(
        &self,
        psink: windows_core::Ref<'_, IWbemObjectSink>,
    ...
    fn GetObject(
        ...
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: windows_core::Ref<'_, IWbemContext>,
        ppobject: windows_core::OutRef<'_, IWbemClassObject>,
        ppcallresult: windows_core::OutRef<'_, IWbemCallResult>,
    ) -> windows_core::Result<()>;
    fn GetObjectAsync(
        &self,
        strobjectpath: &windows_core::BSTR,
    ...
    fn PutClass(
        &self,
        pobject: windows_core::Ref<'_, IWbemClassObject>,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: windows_core::Ref<'_, IWbemContext>,
        ppcallresult: windows_core::OutRef<'_, IWbemCallResult>,
    ) -> windows_core::Result<()>;
    ...
    fn PutInstance(
        &self,
        pinst: windows_core::Ref<'_, IWbemClassObject>,
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: windows_core::Ref<'_, IWbemContext>,
        ppcallresult: windows_core::OutRef<'_, IWbemCallResult>,
    ) -> windows_core::Result<()>;
    ...
    fn ExecMethod(
        ...
        lflags: WBEM_GENERIC_FLAG_TYPE,
        pctx: windows_core::Ref<'_, IWbemContext>,
        pinparams: windows_core::Ref<'_, IWbemClassObject>,
        ppoutparams: windows_core::OutRef<'_, IWbemClassObject>,
        ppcallresult: windows_core::OutRef<'_, IWbemCallResult>,
    ) -> windows_core::Result<()>;
    fn ExecMethodAsync(
        &self,
...
impl IWbemServices_Vtbl {
    pub const fn new<Identity: IWbemServices_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OpenNamespace<
            Identity: IWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strnamespace: *mut core::ffi::c_void,
            lflags: WBEM_GENERIC_FLAG_TYPE,
            pctx: *mut core::ffi::c_void,
            ppworkingnamespace: *mut *mut core::ffi::c_void,
            ppresult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::OpenNamespace(
                    this,
                    core::mem::transmute(&strnamespace),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
                    core::mem::transmute_copy(&ppworkingnamespace),
        ...
        unsafe extern "system" fn QueryObjectSink<
            Identity: IWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            lflags: WBEM_GENERIC_FLAG_TYPE,
            ppresponsehandler: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetObject<Identity: IWbemServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strobjectpath: *mut core::ffi::c_void,
            lflags: WBEM_GENERIC_FLAG_TYPE,
            pctx: *mut core::ffi::c_void,
            ppobject: *mut *mut core::ffi::c_void,
            ppcallresult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::GetObject(
                    this,
                    core::mem::transmute(&strobjectpath),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
                    core::mem::transmute_copy(&ppobject),
                    core::mem::transmute_copy(&ppcallresult),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetObjectAsync<
            Identity: IWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::GetObjectAsync(
                    this,
                    core::mem::transmute(&strobjectpath),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
        ...
        unsafe extern "system" fn PutClass<Identity: IWbemServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pobject: *mut core::ffi::c_void,
            lflags: WBEM_GENERIC_FLAG_TYPE,
            pctx: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn PutClassAsync<
            Identity: IWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::PutClassAsync(
                    this,
                    core::mem::transmute_copy(&pobject),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
        ...
        unsafe extern "system" fn DeleteClass<Identity: IWbemServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strclass: *mut core::ffi::c_void,
            lflags: WBEM_GENERIC_FLAG_TYPE,
            pctx: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::DeleteClass(
                    this,
                    core::mem::transmute(&strclass),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
        ...
        unsafe extern "system" fn DeleteClassAsync<
            Identity: IWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::DeleteClassAsync(
                    this,
                    core::mem::transmute(&strclass),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
        ...
        unsafe extern "system" fn CreateClassEnum<
            Identity: IWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemServices_Impl::CreateClassEnum(
                    this,
                    core::mem::transmute(&strsuperclass),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
        ...
        unsafe extern "system" fn CreateClassEnumAsync<
            Identity: IWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::CreateClassEnumAsync(
                    this,
                    core::mem::transmute(&strsuperclass),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
        ...
        unsafe extern "system" fn PutInstance<Identity: IWbemServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pinst: *mut core::ffi::c_void,
            lflags: WBEM_GENERIC_FLAG_TYPE,
            pctx: *mut core::ffi::c_void,
            ppcallresult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::PutInstance(
                    this,
                    core::mem::transmute_copy(&pinst),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
                    core::mem::transmute_copy(&ppcallresult),
                )
        ...
        unsafe extern "system" fn PutInstanceAsync<
            Identity: IWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::PutInstanceAsync(
                    this,
                    core::mem::transmute_copy(&pinst),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::DeleteInstance(
                    this,
                    core::mem::transmute(&strobjectpath),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
        ...
        unsafe extern "system" fn DeleteInstanceAsync<
            Identity: IWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::DeleteInstanceAsync(
                    this,
                    core::mem::transmute(&strobjectpath),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
        ...
        unsafe extern "system" fn CreateInstanceEnum<
            Identity: IWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            strfilter: *mut core::ffi::c_void,
            lflags: WBEM_GENERIC_FLAG_TYPE,
            pctx: *mut core::ffi::c_void,
            ppenum: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemServices_Impl::CreateInstanceEnum(
                    this,
                    core::mem::transmute(&strfilter),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateInstanceEnumAsync<
            Identity: IWbemServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::CreateInstanceEnumAsync(
                    this,
                    core::mem::transmute(&strfilter),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
        ...
        unsafe extern "system" fn ExecQuery<Identity: IWbemServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strquerylanguage: *mut core::ffi::c_void,
            strquery: *mut core::ffi::c_void,
            lflags: WBEM_GENERIC_FLAG_TYPE,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemServices_Impl::ExecQuery(
                    this,
                    core::mem::transmute(&strquerylanguage),
                    core::mem::transmute(&strquery),
                    core::mem::transmute_copy(&lflags),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::ExecQueryAsync(
                    this,
                    core::mem::transmute(&strquerylanguage),
                    core::mem::transmute(&strquery),
                    core::mem::transmute_copy(&lflags),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemServices_Impl::ExecNotificationQuery(
                    this,
                    core::mem::transmute(&strquerylanguage),
                    core::mem::transmute(&strquery),
                    core::mem::transmute_copy(&lflags),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::ExecNotificationQueryAsync(
                    this,
                    core::mem::transmute(&strquerylanguage),
                    core::mem::transmute(&strquery),
                    core::mem::transmute_copy(&lflags),
        ...
        unsafe extern "system" fn ExecMethod<Identity: IWbemServices_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            strobjectpath: *mut core::ffi::c_void,
            strmethodname: *mut core::ffi::c_void,
            lflags: WBEM_GENERIC_FLAG_TYPE,
            pctx: *mut core::ffi::c_void,
            pinparams: *mut core::ffi::c_void,
            ppoutparams: *mut *mut core::ffi::c_void,
            ppcallresult: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::ExecMethod(
                    this,
                    core::mem::transmute(&strobjectpath),
                    core::mem::transmute(&strmethodname),
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute_copy(&pctx),
                    core::mem::transmute_copy(&pinparams),
                    core::mem::transmute_copy(&ppoutparams),
                    core::mem::transmute_copy(&ppcallresult),
                )
                .into()
            }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemServices_Impl::ExecMethodAsync(
                    this,
                    core::mem::transmute(&strobjectpath),
                    core::mem::transmute(&strmethodname),
                    core::mem::transmute_copy(&lflags),
...
impl IWbemShutdown_Vtbl {
    pub const fn new<Identity: IWbemShutdown_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Shutdown<Identity: IWbemShutdown_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ureason: i32,
            umaxmilliseconds: u32,
            pctx: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemShutdown_Impl::Shutdown(
                    this,
                    core::mem::transmute_copy(&ureason),
                    core::mem::transmute_copy(&umaxmilliseconds),
                    core::mem::transmute_copy(&pctx),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0xeb87e1bc_3233_11d2_aec9_00c04fb68820
);
windows_core::imp::interface_hierarchy!(IWbemStatusCodeText, windows_core::IUnknown);
impl IWbemStatusCodeText {
    pub unsafe fn GetErrorCodeText(
        &self,
        hres: windows_core::HRESULT,
        localeid: u32,
        lflags: i32,
    ) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetErrorCodeText)(
                windows_core::Interface::as_raw(self),
                hres,
                localeid,
                lflags,
    ...
    pub unsafe fn GetFacilityCodeText(
        &self,
        hres: windows_core::HRESULT,
        localeid: u32,
        lflags: i32,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFacilityCodeText)(
                windows_core::Interface::as_raw(self),
                hres,
                localeid,
                lflags,
...
pub struct IWbemStatusCodeText_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetErrorCodeText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::HRESULT,
        u32,
        i32,
    ...
    pub GetFacilityCodeText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::HRESULT,
        u32,
        i32,
...
impl IWbemStatusCodeText_Vtbl {
    pub const fn new<Identity: IWbemStatusCodeText_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetErrorCodeText<
            Identity: IWbemStatusCodeText_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            hres: windows_core::HRESULT,
            localeid: u32,
            lflags: i32,
            messagetext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemStatusCodeText_Impl::GetErrorCodeText(
                    this,
                    core::mem::transmute_copy(&hres),
                    core::mem::transmute_copy(&localeid),
                    core::mem::transmute_copy(&lflags),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetFacilityCodeText<
            Identity: IWbemStatusCodeText_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemStatusCodeText_Impl::GetFacilityCodeText(
                    this,
                    core::mem::transmute_copy(&hres),
                    core::mem::transmute_copy(&localeid),
                    core::mem::transmute_copy(&lflags),
...
windows_core::imp::define_interface!(
    IWbemTransport,
    IWbemTransport_Vtbl,
    0x553fe584_2156_11d0_b6ae_00aa003240c7
);
...
impl IWbemTransport_Vtbl {
    pub const fn new<Identity: IWbemTransport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Initialize<Identity: IWbemTransport_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    ...
    0xe246107b_b06e_11d0_ad61_00c04fd8fdff
);
windows_core::imp::interface_hierarchy!(IWbemUnboundObjectSink, windows_core::IUnknown);
impl IWbemUnboundObjectSink {
    pub unsafe fn IndicateToConsumer<P0>(
        &self,
        plogicalconsumer: P0,
        apobjects: &[Option<IWbemClassObject>],
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<IWbemClassObject>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).IndicateToConsumer)(
                windows_core::Interface::as_raw(self),
                plogicalconsumer.param().abi(),
                apobjects.len().try_into().unwrap(),
                core::mem::transmute(apobjects.as_ptr()),
...
pub struct IWbemUnboundObjectSink_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub IndicateToConsumer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        *const *mut core::ffi::c_void,
...
pub trait IWbemUnboundObjectSink_Impl: windows_core::IUnknownImpl {
    fn IndicateToConsumer(
        ...
        plogicalconsumer: windows_core::Ref<'_, IWbemClassObject>,
        lnumobjects: i32,
        apobjects: *const Option<IWbemClassObject>,
    ) -> windows_core::Result<()>;
}
impl IWbemUnboundObjectSink_Vtbl {
    pub const fn new<Identity: IWbemUnboundObjectSink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IndicateToConsumer<
            Identity: IWbemUnboundObjectSink_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            plogicalconsumer: *mut core::ffi::c_void,
            lnumobjects: i32,
            apobjects: *const *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWbemUnboundObjectSink_Impl::IndicateToConsumer(
                    this,
                    core::mem::transmute_copy(&plogicalconsumer),
                    core::mem::transmute_copy(&lnumobjects),
                    core::mem::transmute_copy(&apobjects),
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            IndicateToConsumer: IndicateToConsumer::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x31739d04_3471_4cf4_9a7c_57a44ae71956
);
...
impl IWbemUnsecuredApartment {
    pub unsafe fn CreateSinkStub<P0, P2>(
        &self,
        psink: P0,
        dwflags: u32,
        wszreserved: P2,
        ...
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSinkStub)(
                windows_core::Interface::as_raw(self),
                psink.param().abi(),
                dwflags,
                wszreserved.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub struct IWbemUnsecuredApartment_Vtbl {
    ...
    pub CreateSinkStub: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
    ...
    pub const fn new<Identity: IWbemUnsecuredApartment_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWbemUnsecuredApartment_Impl::CreateSinkStub(
                    this,
                    core::mem::transmute_copy(&psink),
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute(&wszreserved),
                ) {
                    Ok(ok__) => {
                        ppstub.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        Self {
            base__: IUnsecuredApartment_Vtbl::new::<Identity, OFFSET>(),
            CreateSinkStub: CreateSinkStub::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub type MI_CancelCallback = Option<
...
pub type MI_Deserializer_ClassObjectNeeded = Option<
    unsafe extern "system" fn(
        context: *const core::ffi::c_void,
        servername: *const u16,
        namespacename: *const u16,
        classname: *const u16,
        requestedclassobject: *mut *mut MI_Class,
    ) -> MI_Result,
>;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const MI_DestinationOptions_ImpersonationType_Default: MI_DestinationOptions_ImpersonationType =
    MI_DestinationOptions_ImpersonationType(0i32);
pub const MI_DestinationOptions_ImpersonationType_Delegate:
    MI_DestinationOptions_ImpersonationType = MI_DestinationOptions_ImpersonationType(4i32);
pub const MI_DestinationOptions_ImpersonationType_Identify:
    MI_DestinationOptions_ImpersonationType = MI_DestinationOptions_ImpersonationType(2i32);
pub const MI_DestinationOptions_ImpersonationType_Impersonate:
    MI_DestinationOptions_ImpersonationType = MI_DestinationOptions_ImpersonationType(3i32);
pub const MI_DestinationOptions_ImpersonationType_None: MI_DestinationOptions_ImpersonationType =
    MI_DestinationOptions_ImpersonationType(1i32);
...
pub type MI_MainFunction =
    Option<unsafe extern "system" fn(server: *mut MI_Server) -> *mut MI_Module>;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub type MI_MethodDecl_Invoke = Option<
    unsafe extern "system" fn(
        self_: *const core::ffi::c_void,
        context: *const MI_Context,
        namespace: *const u16,
        classname: *const u16,
...
pub type MI_Module_Load =
    Option<unsafe extern "system" fn(self_: *mut *mut MI_Module_Self, context: *const MI_Context)>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
pub struct MI_Module_Self(pub isize);
pub type MI_Module_Unload =
    Option<unsafe extern "system" fn(self_: *const MI_Module_Self, context: *const MI_Context)>;
...
pub type MI_OperationCallback_Class = Option<
    unsafe extern "system" fn(
        operation: *const MI_Operation,
...
>;
pub type MI_OperationCallback_Indication = Option<
    unsafe extern "system" fn(
        operation: *const MI_Operation,
        callbackcontext: *const core::ffi::c_void,
...
>;
pub type MI_OperationCallback_Instance = Option<
    unsafe extern "system" fn(
        operation: *const MI_Operation,
        callbackcontext: *const core::ffi::c_void,
        instance: *const MI_Instance,
...
>;
pub type MI_OperationCallback_PromptUser = Option<
    unsafe extern "system" fn(
        operation: *const MI_Operation,
        callbackcontext: *const core::ffi::c_void,
        message: *const u16,
...
pub const MI_OperationCallback_ResponseType_No: MI_OperationCallback_ResponseType =
    MI_OperationCallback_ResponseType(0i32);
pub const MI_OperationCallback_ResponseType_NoToAll: MI_OperationCallback_ResponseType =
    MI_OperationCallback_ResponseType(2i32);
pub const MI_OperationCallback_ResponseType_Yes: MI_OperationCallback_ResponseType =
    MI_OperationCallback_ResponseType(1i32);
pub const MI_OperationCallback_ResponseType_YesToAll: MI_OperationCallback_ResponseType =
    MI_OperationCallback_ResponseType(3i32);
pub type MI_OperationCallback_StreamedParameter = Option<
    unsafe extern "system" fn(
        operation: *const MI_Operation,
        callbackcontext: *const core::ffi::c_void,
...
>;
pub type MI_OperationCallback_WriteError = Option<
    unsafe extern "system" fn(
        operation: *const MI_Operation,
        callbackcontext: *const core::ffi::c_void,
        instance: *const MI_Instance,
...
>;
pub type MI_OperationCallback_WriteMessage = Option<
    unsafe extern "system" fn(
        operation: *const MI_Operation,
        callbackcontext: *const core::ffi::c_void,
        channel: u32,
...
>;
pub type MI_OperationCallback_WriteProgress = Option<
    unsafe extern "system" fn(
        operation: *const MI_Operation,
        callbackcontext: *const core::ffi::c_void,
        activity: *const u16,
...
pub type MI_ProviderFT_AssociatorInstances = Option<
    unsafe extern "system" fn(
        self_: *const core::ffi::c_void,
        context: *const MI_Context,
        namespace: *const u16,
...
>;
pub type MI_ProviderFT_CreateInstance = Option<
    unsafe extern "system" fn(
        self_: *const core::ffi::c_void,
        context: *const MI_Context,
        namespace: *const u16,
...
>;
pub type MI_ProviderFT_DeleteInstance = Option<
    unsafe extern "system" fn(
        self_: *const core::ffi::c_void,
        context: *const MI_Context,
        namespace: *const u16,
...
>;
pub type MI_ProviderFT_DisableIndications = Option<
    unsafe extern "system" fn(
        self_: *const core::ffi::c_void,
        indicationscontext: *const MI_Context,
        namespace: *const u16,
        classname: *const u16,
    ),
>;
pub type MI_ProviderFT_EnableIndications = Option<
    unsafe extern "system" fn(
        self_: *const core::ffi::c_void,
        indicationscontext: *const MI_Context,
        namespace: *const u16,
...
>;
pub type MI_ProviderFT_EnumerateInstances = Option<
    unsafe extern "system" fn(
        self_: *const core::ffi::c_void,
        context: *const MI_Context,
        namespace: *const u16,
...
>;
pub type MI_ProviderFT_GetInstance = Option<
    unsafe extern "system" fn(
        self_: *const core::ffi::c_void,
        context: *const MI_Context,
        namespace: *const u16,
...
>;
pub type MI_ProviderFT_Invoke = Option<
    unsafe extern "system" fn(
        self_: *const core::ffi::c_void,
        context: *const MI_Context,
        namespace: *const u16,
...
>;
pub type MI_ProviderFT_Load = Option<
    unsafe extern "system" fn(
        self_: *mut *mut core::ffi::c_void,
        selfmodule: *const MI_Module_Self,
        context: *const MI_Context,
    ),
>;
pub type MI_ProviderFT_ModifyInstance = Option<
    unsafe extern "system" fn(
        self_: *mut core::ffi::c_void,
        context: *mut MI_Context,
        namespace: *const u16,
        classname: *const u16,
...
>;
pub type MI_ProviderFT_ReferenceInstances = Option<
    unsafe extern "system" fn(
        self_: *const core::ffi::c_void,
        context: *const MI_Context,
        namespace: *const u16,
...
>;
pub type MI_ProviderFT_Subscribe = Option<
    unsafe extern "system" fn(
        self_: *const core::ffi::c_void,
        context: *const MI_Context,
        namespace: *const u16,
        ...
        bookmark: *const u16,
        subscriptionid: u64,
        subscriptionself: *mut *mut core::ffi::c_void,
    ),
>;
pub type MI_ProviderFT_Unload =
    Option<unsafe extern "system" fn(self_: *const core::ffi::c_void, context: *const MI_Context)>;
pub type MI_ProviderFT_Unsubscribe = Option<
    unsafe extern "system" fn(
        self_: *const core::ffi::c_void,
        context: *const MI_Context,
        namespace: *const u16,
        classname: *const u16,
        subscriptionid: u64,
        subscriptionself: *const core::ffi::c_void,
    ),
>;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const MI_SUBSCRIBE_BOOKMARK_NEWEST: windows_core::PCWSTR =
    windows_core::w!("MI_SUBSCRIBE_BOOKMARK_NEWEST");
pub const MI_SUBSCRIBE_BOOKMARK_OLDEST: windows_core::PCWSTR =
    windows_core::w!("MI_SUBSCRIBE_BOOKMARK_OLDEST");
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const MI_SubscriptionDeliveryType_Pull: MI_SubscriptionDeliveryType =
    MI_SubscriptionDeliveryType(1i32);
pub const MI_SubscriptionDeliveryType_Push: MI_SubscriptionDeliveryType =
    MI_SubscriptionDeliveryType(2i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const MofCompiler: windows_core::GUID =
    windows_core::GUID::from_u128(0x6daf9757_2e37_11d2_aec9_00c04fb68820);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const SWbemDateTime: windows_core::GUID =
    windows_core::GUID::from_u128(0x47dfbe54_cf76_11d3_b38f_00105a1f473a);
pub const SWbemEventSource: windows_core::GUID =
    windows_core::GUID::from_u128(0x04b83d58_21ae_11d2_8b33_00600806d9b6);
pub const SWbemLastError: windows_core::GUID =
    windows_core::GUID::from_u128(0xc2feeeac_cfcd_11d1_8b05_00600806d9b6);
pub const SWbemLocator: windows_core::GUID =
    windows_core::GUID::from_u128(0x76a64158_cb41_11d1_8b02_00600806d9b6);
pub const SWbemMethod: windows_core::GUID =
    windows_core::GUID::from_u128(0x04b83d5b_21ae_11d2_8b33_00600806d9b6);
pub const SWbemMethodSet: windows_core::GUID =
    windows_core::GUID::from_u128(0x04b83d5a_21ae_11d2_8b33_00600806d9b6);
pub const SWbemNamedValue: windows_core::GUID =
    windows_core::GUID::from_u128(0x04b83d60_21ae_11d2_8b33_00600806d9b6);
pub const SWbemNamedValueSet: windows_core::GUID =
    windows_core::GUID::from_u128(0x9aed384e_ce8b_11d1_8b05_00600806d9b6);
pub const SWbemObject: windows_core::GUID =
    windows_core::GUID::from_u128(0x04b83d62_21ae_11d2_8b33_00600806d9b6);
pub const SWbemObjectEx: windows_core::GUID =
    windows_core::GUID::from_u128(0xd6bdafb2_9435_491f_bb87_6aa0f0bc31a2);
pub const SWbemObjectPath: windows_core::GUID =
    windows_core::GUID::from_u128(0x5791bc26_ce9c_11d1_97bf_0000f81e849c);
pub const SWbemObjectSet: windows_core::GUID =
    windows_core::GUID::from_u128(0x04b83d61_21ae_11d2_8b33_00600806d9b6);
pub const SWbemPrivilege: windows_core::GUID =
    windows_core::GUID::from_u128(0x26ee67bc_5804_11d2_8b4a_00600806d9b6);
pub const SWbemPrivilegeSet: windows_core::GUID =
    windows_core::GUID::from_u128(0x26ee67be_5804_11d2_8b4a_00600806d9b6);
pub const SWbemProperty: windows_core::GUID =
    windows_core::GUID::from_u128(0x04b83d5d_21ae_11d2_8b33_00600806d9b6);
pub const SWbemPropertySet: windows_core::GUID =
    windows_core::GUID::from_u128(0x04b83d5c_21ae_11d2_8b33_00600806d9b6);
pub const SWbemQualifier: windows_core::GUID =
    windows_core::GUID::from_u128(0x04b83d5f_21ae_11d2_8b33_00600806d9b6);
pub const SWbemQualifierSet: windows_core::GUID =
    windows_core::GUID::from_u128(0x04b83d5e_21ae_11d2_8b33_00600806d9b6);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const SWbemRefreshableItem: windows_core::GUID =
    windows_core::GUID::from_u128(0x8c6854bc_de4b_11d3_b390_00105a1f473a);
pub const SWbemRefresher: windows_core::GUID =
    windows_core::GUID::from_u128(0xd269bf5c_d9c1_11d3_b38f_00105a1f473a);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const SWbemSecurity: windows_core::GUID =
    windows_core::GUID::from_u128(0xb54d66e9_2287_11d2_8b33_00600806d9b6);
pub const SWbemServices: windows_core::GUID =
    windows_core::GUID::from_u128(0x04b83d63_21ae_11d2_8b33_00600806d9b6);
pub const SWbemServicesEx: windows_core::GUID =
    windows_core::GUID::from_u128(0x62e522dc_8cf3_40a8_8b2e_37d595651e40);
pub const SWbemSink: windows_core::GUID =
    windows_core::GUID::from_u128(0x75718c9a_f029_11d1_a1ac_00c04fb6c223);
pub const UnsecuredApartment: windows_core::GUID =
    windows_core::GUID::from_u128(0x49bd2028_1523_11d1_ad79_00c04fd8fdff);
...
pub const WBEMPATH_INFO_SERVER_NAMESPACE_ONLY: WBEM_PATH_STATUS_FLAG =
    WBEM_PATH_STATUS_FLAG(16384i32);
...
pub const WBEM_E_RESOURCE_CONTENTION: WBEM_EXTRA_RETURN_CODES =
    WBEM_EXTRA_RETURN_CODES(-2147209214i32);
...
pub const WBEM_FLAG_BACKUP_RESTORE_DEFAULT: WBEM_BACKUP_RESTORE_FLAGS =
    WBEM_BACKUP_RESTORE_FLAGS(0i32);
pub const WBEM_FLAG_BACKUP_RESTORE_FORCE_SHUTDOWN: WBEM_BACKUP_RESTORE_FLAGS =
    WBEM_BACKUP_RESTORE_FLAGS(1i32);
...
pub const WBEM_FLAG_CLASS_LOCAL_AND_OVERRIDES: WBEM_CONDITION_FLAG_TYPE =
    WBEM_CONDITION_FLAG_TYPE(512i32);
pub const WBEM_FLAG_CLASS_OVERRIDES_ONLY: WBEM_CONDITION_FLAG_TYPE =
    WBEM_CONDITION_FLAG_TYPE(256i32);
...
pub const WBEM_FLAG_EXCLUDE_OBJECT_QUALIFIERS: WBEM_LIMITATION_FLAG_TYPE =
    WBEM_LIMITATION_FLAG_TYPE(16i32);
pub const WBEM_FLAG_EXCLUDE_PROPERTY_QUALIFIERS: WBEM_LIMITATION_FLAG_TYPE =
    WBEM_LIMITATION_FLAG_TYPE(32i32);
...
pub const WBEM_FLAG_UNSECAPP_DEFAULT_CHECK_ACCESS: WBEM_UNSECAPP_FLAG_TYPE =
    WBEM_UNSECAPP_FLAG_TYPE(0i32);
pub const WBEM_FLAG_UNSECAPP_DONT_CHECK_ACCESS: WBEM_UNSECAPP_FLAG_TYPE =
    WBEM_UNSECAPP_FLAG_TYPE(2i32);
...
pub const WBEM_FLAG_USE_AMENDED_QUALIFIERS: WBEM_GENERIC_FLAG_TYPE =
    WBEM_GENERIC_FLAG_TYPE(131072i32);
...
pub const WBEM_REQUIREMENTS_RECHECK_SUBSCRIPTIONS: WBEM_PROVIDER_REQUIREMENTS_TYPE =
    WBEM_PROVIDER_REQUIREMENTS_TYPE(2i32);
pub const WBEM_REQUIREMENTS_START_POSTFILTER: WBEM_PROVIDER_REQUIREMENTS_TYPE =
    WBEM_PROVIDER_REQUIREMENTS_TYPE(0i32);
pub const WBEM_REQUIREMENTS_STOP_POSTFILTER: WBEM_PROVIDER_REQUIREMENTS_TYPE =
    WBEM_PROVIDER_REQUIREMENTS_TYPE(1i32);
...
pub const WMIExtension: windows_core::GUID =
    windows_core::GUID::from_u128(0xf0975afe_5c7f_11d2_8b74_00104b2afb41);
...
pub const WMIQ_LF16_SINGLE_LEVEL_TRANSACTIONS: WMIQ_LANGUAGE_FEATURES =
    WMIQ_LANGUAGE_FEATURES(16i32);
...
pub const WMIQ_LF20_EXTENDED_SYSTEM_PROPERTIES: WMIQ_LANGUAGE_FEATURES =
    WMIQ_LANGUAGE_FEATURES(20i32);
...
pub const WbemAdministrativeLocator: windows_core::GUID =
    windows_core::GUID::from_u128(0xcb8555cc_9128_11d1_ad9b_00c04fd8fdff);
pub const WbemAuthenticatedLocator: windows_core::GUID =
    windows_core::GUID::from_u128(0xcd184336_9128_11d1_ad9b_00c04fd8fdff);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WbemAuthenticationLevelEnum(pub i32);
pub const WbemBackupRestore: windows_core::GUID =
    windows_core::GUID::from_u128(0xc49e32c6_bc8b_11d2_85d4_00105a1f8304);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const WbemClassObject: windows_core::GUID =
    windows_core::GUID::from_u128(0x9a653086_174f_11d2_b5f9_00104b703efd);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const WbemContext: windows_core::GUID =
    windows_core::GUID::from_u128(0x674b6698_ee92_11d0_ad71_00c04fd8fdff);
pub const WbemDCOMTransport: windows_core::GUID =
    windows_core::GUID::from_u128(0xf7ce2e13_8c90_11d1_9e7b_00c04fc324a8);
pub const WbemDecoupledBasicEventProvider: windows_core::GUID =
    windows_core::GUID::from_u128(0xf5f75737_2843_4f22_933d_c76a97cda62f);
pub const WbemDecoupledRegistrar: windows_core::GUID =
    windows_core::GUID::from_u128(0x4cfc7932_0f9d_4bef_9c32_8ea2a6b56fcb);
pub const WbemDefPath: windows_core::GUID =
    windows_core::GUID::from_u128(0xcf4cc405_e2c5_4ddd_b3ce_5e7582d8c9fa);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const WbemLevel1Login: windows_core::GUID =
    windows_core::GUID::from_u128(0x8bc3f05e_d86b_11d0_a075_00c04fb68820);
pub const WbemLocalAddrRes: windows_core::GUID =
    windows_core::GUID::from_u128(0xa1044801_8f7e_11d1_9e7c_00c04fc324a8);
pub const WbemLocator: windows_core::GUID =
    windows_core::GUID::from_u128(0x4590f811_1d3a_11d0_891f_00aa004b2e24);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WbemObjectTextFormatEnum(pub i32);
pub const WbemObjectTextSrc: windows_core::GUID =
    windows_core::GUID::from_u128(0x8d1c559d_84f0_4bb3_a7d5_56a7435a9ba6);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WbemPrivilegeEnum(pub i32);
pub const WbemQuery: windows_core::GUID =
    windows_core::GUID::from_u128(0xeac8a024_21e2_4523_ad73_a71a0aa2f56a);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WbemQueryFlagEnum(pub i32);
pub const WbemRefresher: windows_core::GUID =
    windows_core::GUID::from_u128(0xc71566f2_561e_11d1_ad87_00c04fd8fdff);
pub const WbemStatusCodeText: windows_core::GUID =
    windows_core::GUID::from_u128(0xeb87e1bd_3233_11d2_aec9_00c04fb68820);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const WbemUnauthenticatedLocator: windows_core::GUID =
    windows_core::GUID::from_u128(0x443e7b79_de31_11d2_b340_00104bcc4b4a);
pub const WbemUninitializedClassObject: windows_core::GUID =
    windows_core::GUID::from_u128(0x7a0227f6_7108_11d1_ad90_00c04fd8fdff);
pub const wbemAuthenticationLevelCall: WbemAuthenticationLevelEnum =
    WbemAuthenticationLevelEnum(3i32);
pub const wbemAuthenticationLevelConnect: WbemAuthenticationLevelEnum =
    WbemAuthenticationLevelEnum(2i32);
pub const wbemAuthenticationLevelDefault: WbemAuthenticationLevelEnum =
    WbemAuthenticationLevelEnum(0i32);
pub const wbemAuthenticationLevelNone: WbemAuthenticationLevelEnum =
    WbemAuthenticationLevelEnum(1i32);
pub const wbemAuthenticationLevelPkt: WbemAuthenticationLevelEnum =
    WbemAuthenticationLevelEnum(4i32);
pub const wbemAuthenticationLevelPktIntegrity: WbemAuthenticationLevelEnum =
    WbemAuthenticationLevelEnum(5i32);
pub const wbemAuthenticationLevelPktPrivacy: WbemAuthenticationLevelEnum =
    WbemAuthenticationLevelEnum(6i32);
...
pub const wbemComparisonFlagIgnoreDefaultValues: WbemComparisonFlagEnum =
    WbemComparisonFlagEnum(4i32);
pub const wbemComparisonFlagIgnoreFlavor: WbemComparisonFlagEnum = WbemComparisonFlagEnum(32i32);
pub const wbemComparisonFlagIgnoreObjectSource: WbemComparisonFlagEnum =
    WbemComparisonFlagEnum(2i32);
...
pub const wbemImpersonationLevelAnonymous: WbemImpersonationLevelEnum =
    WbemImpersonationLevelEnum(1i32);
pub const wbemImpersonationLevelDelegate: WbemImpersonationLevelEnum =
    WbemImpersonationLevelEnum(4i32);
pub const wbemImpersonationLevelIdentify: WbemImpersonationLevelEnum =
    WbemImpersonationLevelEnum(2i32);
pub const wbemImpersonationLevelImpersonate: WbemImpersonationLevelEnum =
    WbemImpersonationLevelEnum(3i32);

...
#[inline]
pub unsafe fn DrtContinueSearch(
    hsearchcontext: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn DrtCreateDerivedKeySecurityProvider(
    ...
    plocalcert: Option<*const super::super::Security::Cryptography::CERT_CONTEXT>,
) -> windows_core::Result<*mut DRT_SECURITY_PROVIDER> {
    ...
    unsafe {
        ...
        DrtCreateDerivedKeySecurityProvider(
            prootcert,
            plocalcert.unwrap_or(core::mem::zeroed()) as _,
            &mut result__,
        )
        .map(|| result__)
    }
...
pub unsafe fn DrtCreateDnsBootstrapResolver<P1>(
    port: u16,
    pwszaddress: P1,
) -> windows_core::Result<*mut DRT_BOOTSTRAP_PROVIDER>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        DrtCreateDnsBootstrapResolver(port, pwszaddress.param().abi(), &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn DrtCreateIpv6UdpTransport(
    ...
    pwport: *mut u16,
    phtransport: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ...
        DrtCreatePnrpBootstrapResolver(
            fpublish.into(),
            pwzpeername.param().abi(),
            pwzcloudname.param().abi(),
            pwzpublishingidentity.param().abi(),
            &mut result__,
        )
        .map(|| result__)
    }
...
#[inline]
pub unsafe fn DrtDeleteIpv6UdpTransport(
    htransport: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn DrtGetEventData(
    hdrt: *const core::ffi::c_void,
    uleventdatalen: u32,
    peventdata: *mut DRT_EVENT_DATA,
) -> windows_core::Result<()> {
...
pub unsafe fn DrtGetInstanceName(
    ...
    pwzdrtinstancename: windows_core::PWSTR,
) -> windows_core::Result<()> {
    ...
    unsafe {
        DrtGetInstanceName(
            ...
            core::mem::transmute(pwzdrtinstancename),
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn DrtGetSearchPathSize(
    hsearchcontext: *const core::ffi::c_void,
...
#[inline]
pub unsafe fn DrtGetSearchResult(
    hsearchcontext: *const core::ffi::c_void,
    ulsearchresultsize: u32,
    psearchresult: *mut DRT_SEARCH_RESULT,
) -> windows_core::Result<()> {
...
pub unsafe fn DrtRegisterKey(
    ...
    pvkeycontext: Option<*const core::ffi::c_void>,
    phkeyregistration: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
    ...
    unsafe {
        DrtRegisterKey(
            hdrt,
            pregistration,
            pvkeycontext.unwrap_or(core::mem::zeroed()) as _,
            phkeyregistration as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn DrtStartSearch(
    hdrt: *const core::ffi::c_void,
    pkey: *const DRT_DATA,
    ...
    pvcontext: Option<*const core::ffi::c_void>,
    hsearchcontext: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
    ...
    unsafe {
        DrtStartSearch(
            hdrt,
            pkey,
            pinfo.unwrap_or(core::mem::zeroed()) as _,
            timeout,
            hevent,
            pvcontext.unwrap_or(core::mem::zeroed()) as _,
            hsearchcontext as _,
...
#[inline]
pub unsafe fn DrtUpdateKey(
    hkeyregistration: *const core::ffi::c_void,
    pappdata: *const DRT_DATA,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerCollabAddContact<P0>(
    pwzcontactdata: P0,
    ppcontact: Option<*mut *mut PEER_CONTACT>,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PeerCollabAddContact(
            pwzcontactdata.param().abi(),
            ppcontact.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabAsyncInviteContact(
    pccontact: Option<*const PEER_CONTACT>,
    pcendpoint: *const PEER_ENDPOINT,
    pcinvitation: *const PEER_INVITATION,
    hevent: Option<super::super::Foundation::HANDLE>,
    phinvitation: Option<*mut super::super::Foundation::HANDLE>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        PeerCollabAsyncInviteContact(
            pccontact.unwrap_or(core::mem::zeroed()) as _,
            pcendpoint,
            pcinvitation,
            hevent.unwrap_or(core::mem::zeroed()) as _,
            phinvitation.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabAsyncInviteEndpoint(
    pcendpoint: *const PEER_ENDPOINT,
    pcinvitation: *const PEER_INVITATION,
    hevent: Option<super::super::Foundation::HANDLE>,
    phinvitation: Option<*mut super::super::Foundation::HANDLE>,
...
#[inline]
pub unsafe fn PeerCollabCancelInvitation(
...
#[inline]
pub unsafe fn PeerCollabCloseHandle(
    hinvitation: super::super::Foundation::HANDLE,
) -> windows_core::Result<()> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabDeleteEndpointData(
    pcendpoint: *const PEER_ENDPOINT,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerCollabDeleteObject(
    pobjectid: *const windows_core::GUID,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerCollabEnumApplicationRegistrationInfo(
    registrationtype: PEER_APPLICATION_REGISTRATION_TYPE,
    phpeerenum: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabEnumApplications(
    pcendpoint: Option<*const PEER_ENDPOINT>,
    papplicationid: Option<*const windows_core::GUID>,
    phpeerenum: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
    ...
    unsafe {
        PeerCollabEnumApplications(
            pcendpoint.unwrap_or(core::mem::zeroed()) as _,
            papplicationid.unwrap_or(core::mem::zeroed()) as _,
            phpeerenum as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn PeerCollabEnumContacts(
    phpeerenum: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerCollabEnumEndpoints(
    pccontact: Option<*const PEER_CONTACT>,
    phpeerenum: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn PeerCollabEnumObjects(
    pcendpoint: Option<*const PEER_ENDPOINT>,
    pobjectid: Option<*const windows_core::GUID>,
    phpeerenum: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
    ...
    unsafe {
        PeerCollabEnumObjects(
            pcendpoint.unwrap_or(core::mem::zeroed()) as _,
            pobjectid.unwrap_or(core::mem::zeroed()) as _,
            phpeerenum as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn PeerCollabEnumPeopleNearMe(
    phpeerenum: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerCollabExportContact<P0>(
    pwzpeername: P0,
...
#[inline]
pub unsafe fn PeerCollabGetApplicationRegistrationInfo(
    papplicationid: *const windows_core::GUID,
    registrationtype: PEER_APPLICATION_REGISTRATION_TYPE,
) -> windows_core::Result<*mut PEER_APPLICATION_REGISTRATION_INFO> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerCollabGetApplicationRegistrationInfo(papplicationid, registrationtype, &mut result__)
            .map(|| result__)
    }
}
#[inline]
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabGetEventData(
    hpeerevent: *const core::ffi::c_void,
) -> windows_core::Result<*mut PEER_COLLAB_EVENT_DATA> {
...
#[inline]
pub unsafe fn PeerCollabGetInvitationResponse(
    hinvitation: super::super::Foundation::HANDLE,
) -> windows_core::Result<*mut PEER_INVITATION_RESPONSE> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabGetPresenceInfo(
    pcendpoint: Option<*const PEER_ENDPOINT>,
) -> windows_core::Result<*mut PEER_PRESENCE_INFO> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabInviteContact(
    pccontact: Option<*const PEER_CONTACT>,
    pcendpoint: *const PEER_ENDPOINT,
    pcinvitation: *const PEER_INVITATION,
) -> windows_core::Result<*mut PEER_INVITATION_RESPONSE> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabInviteEndpoint(
    pcendpoint: *const PEER_ENDPOINT,
    pcinvitation: *const PEER_INVITATION,
) -> windows_core::Result<*mut PEER_INVITATION_RESPONSE> {
...
pub unsafe fn PeerCollabParseContact<P0>(
    pwzcontactdata: P0,
) -> windows_core::Result<*mut PEER_CONTACT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabQueryContactData(
    pcendpoint: Option<*const PEER_ENDPOINT>,
) -> windows_core::Result<windows_core::PWSTR> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabRefreshEndpointData(
    pcendpoint: *const PEER_ENDPOINT,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerCollabRegisterEvent(
    hevent: super::super::Foundation::HANDLE,
    peventregistrations: &[PEER_COLLAB_EVENT_REGISTRATION],
    phpeerevent: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
    ...
    unsafe {
        PeerCollabRegisterEvent(
            hevent,
            peventregistrations.len().try_into().unwrap(),
            core::mem::transmute(peventregistrations.as_ptr()),
            phpeerevent as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn PeerCollabSetPresenceInfo(
...
#[inline]
pub unsafe fn PeerCollabSignin(
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabSubscribeEndpointData(
    pcendpoint: *const PEER_ENDPOINT,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerCollabUnregisterApplication(
    papplicationid: *const windows_core::GUID,
    registrationtype: PEER_APPLICATION_REGISTRATION_TYPE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerCollabUnregisterEvent(
    hpeerevent: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabUnsubscribeEndpointData(
    pcendpoint: *const PEER_ENDPOINT,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerCreatePeerName<P0, P1>(
    pwzidentity: P0,
    pwzclassifier: P1,
) -> windows_core::Result<windows_core::PWSTR>
where
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerCreatePeerName(
            pwzidentity.param().abi(),
            pwzclassifier.param().abi(),
            &mut result__,
        )
        .map(|| result__)
    }
...
pub unsafe fn PeerDistClientCancelAsyncOperation(
    hpeerdist: isize,
    hcontenthandle: isize,
    poverlapped: Option<*const super::super::System::IO::OVERLAPPED>,
) -> u32 {
    ...
    unsafe {
        PeerDistClientCancelAsyncOperation(
            hpeerdist,
            hcontenthandle,
            poverlapped.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn PeerDistClientFlushContent(
    ...
    hcompletionport: Option<super::super::Foundation::HANDLE>,
    ...
    unsafe {
        PeerDistClientFlushContent(
            hpeerdist,
            pcontenttag,
            hcompletionport.unwrap_or(core::mem::zeroed()) as _,
            ulcompletionkey.unwrap_or(core::mem::zeroed()) as _,
            lpoverlapped,
        )
    }
}
...
pub unsafe fn PeerDistClientGetInformationByHandle(
    ...
    dwbuffersize: u32,
    lpinformation: *mut core::ffi::c_void,
) -> u32 {
...
pub unsafe fn PeerDistGetOverlappedResult(
    ...
    unsafe {
        PeerDistGetOverlappedResult(lpoverlapped, lpnumberofbytestransferred as _, bwait.into())
    }
}
#[inline]
...
pub unsafe fn PeerDistServerCancelAsyncOperation(
    ...
    unsafe {
        PeerDistServerCancelAsyncOperation(
            hpeerdist,
            pcontentidentifier.len().try_into().unwrap(),
            core::mem::transmute(pcontentidentifier.as_ptr()),
            poverlapped,
        )
    }
}
...
pub unsafe fn PeerDistServerPublishStream(
    ...
    unsafe {
        PeerDistServerPublishStream(
            ...
            core::mem::transmute(pcontentidentifier.as_ptr()),
            cbcontentlength,
            ppublishoptions.unwrap_or(core::mem::zeroed()) as _,
            hcompletionport.unwrap_or(core::mem::zeroed()) as _,
            ulcompletionkey.unwrap_or(core::mem::zeroed()) as _,
            phstream as _,
        )
...
pub unsafe fn PeerDistStartup(
    ...
    pdwsupportedversion: Option<*mut u32>,
) -> u32 {
    ...
    unsafe {
        PeerDistStartup(
            dwversionrequested,
            phpeerdist as _,
            pdwsupportedversion.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn PeerEnumIdentities(
    phpeerenum: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
pub unsafe fn PeerGetNextItem(
    hpeerenum: *const core::ffi::c_void,
    pcount: *mut u32,
    pppvitems: *mut *mut *mut core::ffi::c_void,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerGraphCloseDirectConnection(
    hgraph: *const core::ffi::c_void,
    ullconnectionid: u64,
) -> windows_core::Result<()> {
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PeerGraphCreate(
            pgraphproperties,
            pwzdatabasename.param().abi(),
            psecurityinterface.unwrap_or(core::mem::zeroed()) as _,
            phgraph as _,
        )
        .ok()
    }
...
#[inline]
pub unsafe fn PeerGraphDeleteRecord(
    hgraph: *const core::ffi::c_void,
    precordid: *const windows_core::GUID,
    flocal: bool,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerGraphEndEnumeration(
    hpeerenum: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerGraphEnumNodes<P1>(
    hgraph: *const core::ffi::c_void,
    pwzpeerid: P1,
    phpeerenum: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
...
pub unsafe fn PeerGraphEnumRecords<P2>(
    hgraph: *const core::ffi::c_void,
    precordtype: Option<*const windows_core::GUID>,
    pwzpeerid: P2,
    phpeerenum: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PeerGraphEnumRecords(
            hgraph,
            precordtype.unwrap_or(core::mem::zeroed()) as _,
            pwzpeerid.param().abi(),
            phpeerenum as _,
        )
        .ok()
...
#[inline]
pub unsafe fn PeerGraphExportDatabase<P1>(
    hgraph: *const core::ffi::c_void,
    pwzfilepath: P1,
) -> windows_core::Result<()>
where
...
pub unsafe fn PeerGraphGetEventData(
    hpeerevent: *const core::ffi::c_void,
) -> windows_core::Result<*mut PEER_GRAPH_EVENT_DATA> {
...
#[inline]
pub unsafe fn PeerGraphGetItemCount(
    hpeerenum: *const core::ffi::c_void,
) -> windows_core::Result<u32> {
...
pub unsafe fn PeerGraphGetNodeInfo(
    hgraph: *const core::ffi::c_void,
    ullnodeid: u64,
) -> windows_core::Result<*mut PEER_NODE_INFO> {
...
#[inline]
pub unsafe fn PeerGraphGetProperties(
    hgraph: *const core::ffi::c_void,
) -> windows_core::Result<*mut PEER_GRAPH_PROPERTIES> {
...
#[inline]
pub unsafe fn PeerGraphGetRecord(
    hgraph: *const core::ffi::c_void,
    precordid: *const windows_core::GUID,
) -> windows_core::Result<*mut PEER_RECORD> {
...
#[inline]
pub unsafe fn PeerGraphImportDatabase<P1>(
    hgraph: *const core::ffi::c_void,
    pwzfilepath: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn PeerGraphListen(
    hgraph: *const core::ffi::c_void,
    dwscope: Option<u32>,
    dwscopeid: Option<u32>,
    wport: Option<u16>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        PeerGraphListen(
            hgraph,
            dwscope.unwrap_or(core::mem::zeroed()) as _,
            dwscopeid.unwrap_or(core::mem::zeroed()) as _,
            wport.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn PeerGraphOpen<P0, P1, P2>(
    pwzgraphid: P0,
    pwzpeerid: P1,
    pwzdatabasename: P2,
    psecurityinterface: Option<*const PEER_SECURITY_INTERFACE>,
    precordtypesyncprecedence: Option<&[windows_core::GUID]>,
    phgraph: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerGraphOpenDirectConnection(hgraph, pwzpeerid.param().abi(), paddress, &mut result__)
            .map(|| result__)
    }
}
#[inline]
pub unsafe fn PeerGraphPeerTimeToUniversalTime(
    hgraph: *const core::ffi::c_void,
    pftpeertime: *const super::super::Foundation::FILETIME,
...
#[inline]
pub unsafe fn PeerGraphRegisterEvent(
    hgraph: *const core::ffi::c_void,
    hevent: super::super::Foundation::HANDLE,
...
#[inline]
pub unsafe fn PeerGraphSearchRecords<P1>(
    hgraph: *const core::ffi::c_void,
    pwzcriteria: P1,
    phpeerenum: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
...
#[inline]
pub unsafe fn PeerGraphSendData(
    hgraph: *const core::ffi::c_void,
    ullconnectionid: u64,
    ptype: *const windows_core::GUID,
    cbdata: u32,
...
#[inline]
pub unsafe fn PeerGraphSetPresence(
    hgraph: *const core::ffi::c_void,
    fpresent: bool,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerGraphUniversalTimeToPeerTime(
    hgraph: *const core::ffi::c_void,
    pftuniversaltime: *const super::super::Foundation::FILETIME,
) -> windows_core::Result<super::super::Foundation::FILETIME> {
...
#[inline]
pub unsafe fn PeerGraphUnregisterEvent(
    hpeerevent: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerGraphUpdateRecord(
    hgraph: *const core::ffi::c_void,
    precord: *const PEER_RECORD,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerGraphValidateDeferredRecords(
    hgraph: *const core::ffi::c_void,
    precordids: &[windows_core::GUID],
) -> windows_core::Result<()> {
    ...
    unsafe {
        PeerGraphValidateDeferredRecords(
            hgraph,
            precordids.len().try_into().unwrap(),
            core::mem::transmute(precordids.as_ptr()),
        )
        .ok()
    }
}
#[inline]
pub unsafe fn PeerGroupAddRecord(
    hgroup: *const core::ffi::c_void,
    precord: *const PEER_RECORD,
) -> windows_core::Result<windows_core::GUID> {
...
#[inline]
pub unsafe fn PeerGroupCloseDirectConnection(
    hgroup: *const core::ffi::c_void,
    ullconnectionid: u64,
) -> windows_core::Result<()> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerGroupConnectByAddress(
    hgroup: *const core::ffi::c_void,
    ...
    unsafe {
        PeerGroupConnectByAddress(
            hgroup,
            paddresses.len().try_into().unwrap(),
            core::mem::transmute(paddresses.as_ptr()),
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn PeerGroupCreateInvitation<P1>(
    hgroup: *const core::ffi::c_void,
    pwzidentityinfo: P1,
    pftexpiration: Option<*const super::super::Foundation::FILETIME>,
    proles: Option<&[windows_core::GUID]>,
) -> windows_core::Result<windows_core::PWSTR>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ...
        PeerGroupCreateInvitation(
            hgroup,
            pwzidentityinfo.param().abi(),
            pftexpiration.unwrap_or(core::mem::zeroed()) as _,
            proles
                .as_deref()
                .map_or(0, |slice| slice.len().try_into().unwrap()),
            core::mem::transmute(
...
#[inline]
pub unsafe fn PeerGroupCreatePasswordInvitation(
    hgroup: *const core::ffi::c_void,
) -> windows_core::Result<windows_core::PWSTR> {
...
#[inline]
pub unsafe fn PeerGroupDeleteRecord(
    hgroup: *const core::ffi::c_void,
    precordid: *const windows_core::GUID,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerGroupEnumMembers<P2>(
    hgroup: *const core::ffi::c_void,
    dwflags: u32,
    pwzidentity: P2,
    phpeerenum: *mut *mut core::ffi::c_void,
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PeerGroupEnumMembers(hgroup, dwflags, pwzidentity.param().abi(), phpeerenum as _).ok()
    }
}
#[inline]
...
#[inline]
pub unsafe fn PeerGroupExportConfig<P1>(
    hgroup: *const core::ffi::c_void,
    pwzpassword: P1,
) -> windows_core::Result<windows_core::PWSTR>
where
...
pub unsafe fn PeerGroupGetEventData(
    hpeerevent: *const core::ffi::c_void,
) -> windows_core::Result<*mut PEER_GROUP_EVENT_DATA> {
...
pub unsafe fn PeerGroupGetProperties(
    hgroup: *const core::ffi::c_void,
) -> windows_core::Result<*mut PEER_GROUP_PROPERTIES> {
...
#[inline]
pub unsafe fn PeerGroupGetRecord(
    hgroup: *const core::ffi::c_void,
    precordid: *const windows_core::GUID,
) -> windows_core::Result<*mut PEER_RECORD> {
...
#[inline]
pub unsafe fn PeerGroupImportConfig<P0, P1>(
    pwzxml: P0,
    pwzpassword: P1,
    foverwrite: bool,
    ppwzidentity: *mut windows_core::PWSTR,
    ppwzgroup: *mut windows_core::PWSTR,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn PeerGroupImportDatabase<P1>(
    hgroup: *const core::ffi::c_void,
    pwzfilepath: P1,
) -> windows_core::Result<()>
where
...
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn PeerGroupIssueCredentials<P1>(
    hgroup: *const core::ffi::c_void,
    pwzsubjectidentity: P1,
    pcredentialinfo: Option<*const PEER_CREDENTIAL_INFO>,
    dwflags: u32,
    ppwzinvitation: Option<*mut windows_core::PWSTR>,
) -> windows_core::Result<()>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PeerGroupIssueCredentials(
            hgroup,
            pwzsubjectidentity.param().abi(),
            pcredentialinfo.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
            ppwzinvitation.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn PeerGroupOpen<P0, P1, P2>(
    pwzidentity: P0,
    pwzgrouppeername: P1,
    pwzcloud: P2,
    phgroup: *mut *mut core::ffi::c_void,
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerGroupOpenDirectConnection<P1>(
    hgroup: *const core::ffi::c_void,
    pwzidentity: P1,
    paddress: *const PEER_ADDRESS,
) -> windows_core::Result<u64>
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerGroupOpenDirectConnection(hgroup, pwzidentity.param().abi(), paddress, &mut result__)
            .map(|| result__)
    }
}
#[cfg(feature = "Win32_Security_Cryptography")]
...
pub unsafe fn PeerGroupParseInvitation<P0>(
    pwzinvitation: P0,
) -> windows_core::Result<*mut PEER_INVITATION_INFO>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGroupPasswordJoin<P0, P1, P2, P3>(
    pwzidentity: P0,
    pwzinvitation: P1,
    pwzpassword: P2,
    pwzcloud: P3,
...
#[inline]
pub unsafe fn PeerGroupPeerTimeToUniversalTime(
    hgroup: *const core::ffi::c_void,
    pftpeertime: *const super::super::Foundation::FILETIME,
) -> windows_core::Result<super::super::Foundation::FILETIME> {
...
#[inline]
pub unsafe fn PeerGroupRegisterEvent(
    hgroup: *const core::ffi::c_void,
    hevent: super::super::Foundation::HANDLE,
...
pub unsafe fn PeerGroupResumePasswordAuthentication(
    hgroup: *const core::ffi::c_void,
    hpeereventhandle: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerGroupSearchRecords<P1>(
    hgroup: *const core::ffi::c_void,
    pwzcriteria: P1,
    phpeerenum: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
...
#[inline]
pub unsafe fn PeerGroupUniversalTimeToPeerTime(
    hgroup: *const core::ffi::c_void,
    pftuniversaltime: *const super::super::Foundation::FILETIME,
) -> windows_core::Result<super::super::Foundation::FILETIME> {
...
#[inline]
pub unsafe fn PeerGroupUnregisterEvent(
    hpeerevent: *const core::ffi::c_void,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerHostNameToPeerName<P0>(
    pwzhostname: P0,
) -> windows_core::Result<windows_core::PWSTR>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn PeerIdentityCreate<P0, P1>(
    pwzclassifier: P0,
    pwzfriendlyname: P1,
    hcryptprov: Option<usize>,
) -> windows_core::Result<windows_core::PWSTR>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ...
        PeerIdentityCreate(
            ...
            hcryptprov.unwrap_or(core::mem::zeroed()) as _,
            &mut result__,
        )
        .map(|| result__)
    }
...
#[inline]
pub unsafe fn PeerIdentityGetFriendlyName<P0>(
    pwzidentity: P0,
) -> windows_core::Result<windows_core::PWSTR>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn PeerIdentitySetFriendlyName<P0, P1>(
    pwzidentity: P0,
    pwzfriendlyname: P1,
) -> windows_core::Result<()>
where
...
#[inline]
pub unsafe fn PeerNameToPeerHostName<P0>(
    pwzpeername: P0,
) -> windows_core::Result<windows_core::PWSTR>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn PeerPnrpGetEndpoint(
    hresolve: *const core::ffi::c_void,
) -> windows_core::Result<*mut PEER_PNRP_ENDPOINT_INFO> {
...
pub unsafe fn PeerPnrpRegister<P0>(
    ...
    phregistration: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PeerPnrpRegister(
            pcwzpeername.param().abi(),
            pregistrationinfo.unwrap_or(core::mem::zeroed()) as _,
            phregistration as _,
        )
        .ok()
    }
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerPnrpResolve<P0, P1>(
    pcwzpeername: P0,
    pcwzcloudname: P1,
    pcendpoints: *mut u32,
    ppendpoints: *mut *mut PEER_PNRP_ENDPOINT_INFO,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn PeerPnrpStartResolve<P0, P1>(
    ...
    hevent: super::super::Foundation::HANDLE,
    phresolve: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        PeerPnrpStartResolve(
            pcwzpeername.param().abi(),
            pcwzcloudname.param().abi(),
            cmaxendpoints.unwrap_or(core::mem::zeroed()) as _,
            hevent,
            phresolve as _,
        )
        .ok()
...
#[inline]
pub unsafe fn PeerPnrpUnregister(
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type DRT_BOOTSTRAP_RESOLVE_CALLBACK = Option<
    unsafe extern "system" fn(
        hr: windows_core::HRESULT,
        pvcontext: *mut core::ffi::c_void,
        paddresses: *mut super::super::Networking::WinSock::SOCKET_ADDRESS_LIST,
        ffatalerror: windows_core::BOOL,
    ),
>;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const DRT_E_BOOTSTRAPPROVIDER_IN_USE: windows_core::HRESULT =
    windows_core::HRESULT(0x8062200E_u32 as _);
pub const DRT_E_BOOTSTRAPPROVIDER_NOT_ATTACHED: windows_core::HRESULT =
    windows_core::HRESULT(0x8062200F_u32 as _);
pub const DRT_E_CAPABILITY_MISMATCH: windows_core::HRESULT =
    windows_core::HRESULT(0x8062210F_u32 as _);
...
pub const DRT_E_INSUFFICIENT_BUFFER: windows_core::HRESULT =
    windows_core::HRESULT(0x8062210C_u32 as _);
pub const DRT_E_INVALID_ADDRESS: windows_core::HRESULT = windows_core::HRESULT(0x80622005_u32 as _);
pub const DRT_E_INVALID_BOOTSTRAP_PROVIDER: windows_core::HRESULT =
    windows_core::HRESULT(0x80622004_u32 as _);
pub const DRT_E_INVALID_CERT_CHAIN: windows_core::HRESULT =
    windows_core::HRESULT(0x80621004_u32 as _);
pub const DRT_E_INVALID_INSTANCE_PREFIX: windows_core::HRESULT =
    windows_core::HRESULT(0x8062210D_u32 as _);
pub const DRT_E_INVALID_KEY: windows_core::HRESULT = windows_core::HRESULT(0x80621009_u32 as _);
pub const DRT_E_INVALID_KEY_SIZE: windows_core::HRESULT =
    windows_core::HRESULT(0x80621002_u32 as _);
pub const DRT_E_INVALID_MAX_ADDRESSES: windows_core::HRESULT =
    windows_core::HRESULT(0x80621007_u32 as _);
pub const DRT_E_INVALID_MAX_ENDPOINTS: windows_core::HRESULT =
    windows_core::HRESULT(0x80621011_u32 as _);
...
pub const DRT_E_INVALID_SEARCH_INFO: windows_core::HRESULT =
    windows_core::HRESULT(0x80622109_u32 as _);
pub const DRT_E_INVALID_SEARCH_RANGE: windows_core::HRESULT =
    windows_core::HRESULT(0x80621012_u32 as _);
pub const DRT_E_INVALID_SECURITY_MODE: windows_core::HRESULT =
    windows_core::HRESULT(0x8062210E_u32 as _);
pub const DRT_E_INVALID_SECURITY_PROVIDER: windows_core::HRESULT =
    windows_core::HRESULT(0x80622002_u32 as _);
pub const DRT_E_INVALID_SETTINGS: windows_core::HRESULT =
    windows_core::HRESULT(0x80622108_u32 as _);
pub const DRT_E_INVALID_TRANSPORT_PROVIDER: windows_core::HRESULT =
    windows_core::HRESULT(0x80622001_u32 as _);
pub const DRT_E_NO_ADDRESSES_AVAILABLE: windows_core::HRESULT =
    windows_core::HRESULT(0x80622008_u32 as _);
pub const DRT_E_NO_MORE: windows_core::HRESULT = windows_core::HRESULT(0x80621006_u32 as _);
pub const DRT_E_SEARCH_IN_PROGRESS: windows_core::HRESULT =
    windows_core::HRESULT(0x80621008_u32 as _);
pub const DRT_E_SECURITYPROVIDER_IN_USE: windows_core::HRESULT =
    windows_core::HRESULT(0x8062200C_u32 as _);
pub const DRT_E_SECURITYPROVIDER_NOT_ATTACHED: windows_core::HRESULT =
    windows_core::HRESULT(0x8062200D_u32 as _);
...
pub const DRT_E_TRANSPORTPROVIDER_IN_USE: windows_core::HRESULT =
    windows_core::HRESULT(0x8062200A_u32 as _);
pub const DRT_E_TRANSPORTPROVIDER_NOT_ATTACHED: windows_core::HRESULT =
    windows_core::HRESULT(0x8062200B_u32 as _);
pub const DRT_E_TRANSPORT_ALREADY_BOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x80622101_u32 as _);
pub const DRT_E_TRANSPORT_ALREADY_EXISTS_FOR_SCOPE: windows_core::HRESULT =
    windows_core::HRESULT(0x80622107_u32 as _);
pub const DRT_E_TRANSPORT_EXECUTING_CALLBACK: windows_core::HRESULT =
    windows_core::HRESULT(0x80622106_u32 as _);
pub const DRT_E_TRANSPORT_INVALID_ARGUMENT: windows_core::HRESULT =
    windows_core::HRESULT(0x80622104_u32 as _);
pub const DRT_E_TRANSPORT_NOT_BOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x80622102_u32 as _);
pub const DRT_E_TRANSPORT_NO_DEST_ADDRESSES: windows_core::HRESULT =
    windows_core::HRESULT(0x80622105_u32 as _);
pub const DRT_E_TRANSPORT_SHUTTING_DOWN: windows_core::HRESULT =
    windows_core::HRESULT(0x80622007_u32 as _);
pub const DRT_E_TRANSPORT_STILL_BOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x8062210B_u32 as _);
pub const DRT_E_TRANSPORT_UNEXPECTED: windows_core::HRESULT =
    windows_core::HRESULT(0x80622103_u32 as _);
...
pub const DRT_REGISTRATION_STATE_UNRESOLVEABLE: DRT_REGISTRATION_STATE =
    DRT_REGISTRATION_STATE(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const MaximumPeerDistClientInfoByHandlesClass: PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS =
    PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS(1i32);
pub const NS_PNRPCLOUD: u32 = 39u32;
pub const NS_PNRPNAME: u32 = 38u32;
pub const NS_PROVIDER_PNRPCLOUD: windows_core::GUID =
    windows_core::GUID::from_u128(0x03fe89ce_766d_4976_b9c1_bb9bc42c7b4d);
pub const NS_PROVIDER_PNRPNAME: windows_core::GUID =
    windows_core::GUID::from_u128(0x03fe89cd_766d_4976_b9c1_bb9bc42c7b4d);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION:
    PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_VALUE =
    PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_VALUE(2u32);
pub const PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_1:
    PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_VALUE =
    PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_VALUE(1u32);
pub const PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_2:
    PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_VALUE =
    PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_VALUE(2u32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const PEER_APPLICATION_ALL_USERS: PEER_APPLICATION_REGISTRATION_TYPE =
    PEER_APPLICATION_REGISTRATION_TYPE(1i32);
pub const PEER_APPLICATION_CURRENT_USER: PEER_APPLICATION_REGISTRATION_TYPE =
    PEER_APPLICATION_REGISTRATION_TYPE(0i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PEER_COLLAB_OBJECTID_USER_PICTURE: windows_core::GUID =
    windows_core::GUID::from_u128(0xdd15f41f_fc4e_4922_b035_4c06a754d01d);
...
pub const PEER_EVENT_ENDPOINT_APPLICATION_CHANGED: PEER_COLLAB_EVENT_TYPE =
    PEER_COLLAB_EVENT_TYPE(4i32);
...
pub const PEER_EVENT_ENDPOINT_PRESENCE_CHANGED: PEER_COLLAB_EVENT_TYPE =
    PEER_COLLAB_EVENT_TYPE(3i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PEER_E_CLIENT_INVALID_COMPARTMENT_ID: windows_core::HRESULT =
    windows_core::HRESULT(0x80072CF2_u32 as _);
...
pub const PEER_E_CLOUD_IS_SEARCH_ONLY: windows_core::HRESULT =
    windows_core::HRESULT(0x80072CF1_u32 as _);
pub const PEER_E_CLOUD_NOT_FOUND: windows_core::HRESULT =
    windows_core::HRESULT(0x80072CED_u32 as _);
pub const PEER_E_DISK_FULL: windows_core::HRESULT = windows_core::HRESULT(0x80070070_u32 as _);
pub const PEER_E_DUPLICATE_PEER_NAME: windows_core::HRESULT =
    windows_core::HRESULT(0x80072CF4_u32 as _);
pub const PEER_E_INVALID_IDENTITY: windows_core::HRESULT =
    windows_core::HRESULT(0x80072CEF_u32 as _);
...
pub const PEER_GRAPH_PROPERTY_DEFER_EXPIRATION: PEER_GRAPH_PROPERTY_FLAGS =
    PEER_GRAPH_PROPERTY_FLAGS(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct PEER_GRAPH_PROPERTY_FLAGS(pub i32);
pub const PEER_GRAPH_PROPERTY_HEARTBEATS: PEER_GRAPH_PROPERTY_FLAGS =
    PEER_GRAPH_PROPERTY_FLAGS(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const PEER_GRAPH_STATUS_HAS_CONNECTIONS: PEER_GRAPH_STATUS_FLAGS =
    PEER_GRAPH_STATUS_FLAGS(2i32);
...
pub const PEER_GROUP_EVENT_AUTHENTICATION_FAILED: PEER_GROUP_EVENT_TYPE =
    PEER_GROUP_EVENT_TYPE(11i32);
...
pub const PEER_GROUP_GMC_AUTHENTICATION: PEER_GROUP_AUTHENTICATION_SCHEME =
    PEER_GROUP_AUTHENTICATION_SCHEME(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct PEER_GROUP_ISSUE_CREDENTIAL_FLAGS(pub i32);
pub const PEER_GROUP_PASSWORD_AUTHENTICATION: PEER_GROUP_AUTHENTICATION_SCHEME =
    PEER_GROUP_AUTHENTICATION_SCHEME(2i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PEER_GROUP_ROLE_ADMIN: windows_core::GUID =
    windows_core::GUID::from_u128(0x04387127_aa56_450a_8ce5_4f565c6790f4);
pub const PEER_GROUP_ROLE_INVITING_MEMBER: windows_core::GUID =
    windows_core::GUID::from_u128(0x4370fd89_dc18_4cfb_8dbf_9853a8a9f905);
pub const PEER_GROUP_ROLE_MEMBER: windows_core::GUID =
    windows_core::GUID::from_u128(0xf12dc4c7_0857_4ca0_93fc_b1bb19a3d8c2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const PEER_GROUP_STORE_CREDENTIALS: PEER_GROUP_ISSUE_CREDENTIAL_FLAGS =
    PEER_GROUP_ISSUE_CREDENTIAL_FLAGS(1i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PEER_INVITATION_RESPONSE_ACCEPTED: PEER_INVITATION_RESPONSE_TYPE =
    PEER_INVITATION_RESPONSE_TYPE(1i32);
pub const PEER_INVITATION_RESPONSE_DECLINED: PEER_INVITATION_RESPONSE_TYPE =
    PEER_INVITATION_RESPONSE_TYPE(0i32);
pub const PEER_INVITATION_RESPONSE_ERROR: PEER_INVITATION_RESPONSE_TYPE =
    PEER_INVITATION_RESPONSE_TYPE(3i32);
pub const PEER_INVITATION_RESPONSE_EXPIRED: PEER_INVITATION_RESPONSE_TYPE =
    PEER_INVITATION_RESPONSE_TYPE(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub type PFNPEER_FREE_SECURITY_DATA = Option<
    unsafe extern "system" fn(
        hgraph: *const core::ffi::c_void,
        pvcontext: *const core::ffi::c_void,
        psecuritydata: *const PEER_DATA,
    ) -> windows_core::HRESULT,
>;
pub type PFNPEER_ON_PASSWORD_AUTH_FAILED = Option<
    unsafe extern "system" fn(
        hgraph: *const core::ffi::c_void,
        pvcontext: *const core::ffi::c_void,
    ) -> windows_core::HRESULT,
>;
pub type PFNPEER_SECURE_RECORD = Option<
    unsafe extern "system" fn(
        hgraph: *const core::ffi::c_void,
        pvcontext: *const core::ffi::c_void,
        precord: *const PEER_RECORD,
        changetype: PEER_RECORD_CHANGE_TYPE,
        ppsecuritydata: *mut *mut PEER_DATA,
    ) -> windows_core::HRESULT,
>;
pub type PFNPEER_VALIDATE_RECORD = Option<
    unsafe extern "system" fn(
        hgraph: *const core::ffi::c_void,
        pvcontext: *const core::ffi::c_void,
        precord: *const PEER_RECORD,
...
pub const PNRP_EXTENDED_PAYLOAD_TYPE_BINARY: PNRP_EXTENDED_PAYLOAD_TYPE =
    PNRP_EXTENDED_PAYLOAD_TYPE(1i32);
pub const PNRP_EXTENDED_PAYLOAD_TYPE_NONE: PNRP_EXTENDED_PAYLOAD_TYPE =
    PNRP_EXTENDED_PAYLOAD_TYPE(0i32);
pub const PNRP_EXTENDED_PAYLOAD_TYPE_STRING: PNRP_EXTENDED_PAYLOAD_TYPE =
    PNRP_EXTENDED_PAYLOAD_TYPE(2i32);
...
pub const PNRP_REGISTERED_ID_STATE_PROBLEM: PNRP_REGISTERED_ID_STATE =
    PNRP_REGISTERED_ID_STATE(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const PNRP_RESOLVE_CRITERIA_NEAREST_NON_CURRENT_PROCESS_PEER_NAME: PNRP_RESOLVE_CRITERIA =
    PNRP_RESOLVE_CRITERIA(4i32);
pub const PNRP_RESOLVE_CRITERIA_NEAREST_PEER_NAME: PNRP_RESOLVE_CRITERIA =
    PNRP_RESOLVE_CRITERIA(6i32);
pub const PNRP_RESOLVE_CRITERIA_NEAREST_REMOTE_PEER_NAME: PNRP_RESOLVE_CRITERIA =
    PNRP_RESOLVE_CRITERIA(2i32);
pub const PNRP_RESOLVE_CRITERIA_NON_CURRENT_PROCESS_PEER_NAME: PNRP_RESOLVE_CRITERIA =
    PNRP_RESOLVE_CRITERIA(3i32);
pub const PNRP_RESOLVE_CRITERIA_REMOTE_PEER_NAME: PNRP_RESOLVE_CRITERIA =
    PNRP_RESOLVE_CRITERIA(1i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const PeerDistClientBasicInfo: PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS =
    PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS(0i32);
pub const SVCID_PNRPCLOUD: windows_core::GUID =
    windows_core::GUID::from_u128(0xc2239ce6_00c0_4fbf_bad6_18139385a49a);
pub const SVCID_PNRPNAME_V1: windows_core::GUID =
    windows_core::GUID::from_u128(0xc2239ce5_00c0_4fbf_bad6_18139385a49a);
pub const SVCID_PNRPNAME_V2: windows_core::GUID =
    windows_core::GUID::from_u128(0xc2239ce7_00c0_4fbf_bad6_18139385a49a);

...
pub const GUID_DEVINTERFACE_SIDESHOW: windows_core::GUID =
    windows_core::GUID::from_u128(0x152e5811_feb9_4b00_90f4_d32947ae1681);
windows_core::imp::define_interface!(
    ISideShowBulkCapabilities,
    ISideShowBulkCapabilities_Vtbl,
    0x3a2b7fbc_3ad5_48bd_bbf1_0e6cfbd10807
);
...
impl ISideShowBulkCapabilities {
    pub unsafe fn GetCapabilities<P0>(
        &self,
        in_keycollection: P0,
        inout_pvalues: *mut Option<ISideShowPropVariantCollection>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<ISideShowKeyCollection>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetCapabilities)(
                ...
                in_keycollection.param().abi(),
                core::mem::transmute(inout_pvalues),
            )
            .ok()
        }
    }
...
pub trait ISideShowBulkCapabilities_Impl: ISideShowCapabilities_Impl {
    fn GetCapabilities(
        &self,
        in_keycollection: windows_core::Ref<'_, ISideShowKeyCollection>,
        inout_pvalues: windows_core::OutRef<'_, ISideShowPropVariantCollection>,
    ) -> windows_core::Result<()>;
}
#[cfg(all(
    feature = "Win32_System_Com_StructuredStorage",
...
impl ISideShowBulkCapabilities_Vtbl {
    pub const fn new<Identity: ISideShowBulkCapabilities_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            in_keycollection: *mut core::ffi::c_void,
            inout_pvalues: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowBulkCapabilities_Impl::GetCapabilities(
                    this,
                    core::mem::transmute_copy(&in_keycollection),
                    core::mem::transmute_copy(&inout_pvalues),
                )
                .into()
            }
        }
        Self {
            base__: ISideShowCapabilities_Vtbl::new::<Identity, OFFSET>(),
            GetCapabilities: GetCapabilities::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<ISideShowBulkCapabilities as windows_core::Interface>::IID
...
windows_core::imp::define_interface!(
    ISideShowCapabilities,
    ISideShowCapabilities_Vtbl,
    0x535e1379_c09e_4a54_a511_597bab3a72b8
);
...
impl ISideShowCapabilities {
    ...
    pub unsafe fn GetCapability(
        &self,
        in_keycapability: *const super::super::Foundation::PROPERTYKEY,
        inout_pvalue: *mut super::Com::StructuredStorage::PROPVARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetCapability)(
                windows_core::Interface::as_raw(self),
                in_keycapability,
                core::mem::transmute(inout_pvalue),
            )
            .ok()
        }
    }
...
pub struct ISideShowCapabilities_Vtbl {
    ...
    pub GetCapability: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl ISideShowCapabilities_Vtbl {
    pub const fn new<Identity: ISideShowCapabilities_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCapability<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowCapabilities_Impl::GetCapability(
                    this,
                    core::mem::transmute_copy(&in_keycapability),
                    core::mem::transmute_copy(&inout_pvalue),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x50305597_5e0d_4ff7_b3af_33d0d9bd52dd
);
...
impl ISideShowCapabilitiesCollection_Vtbl {
    pub const fn new<Identity: ISideShowCapabilitiesCollection_Impl, const OFFSET: isize>() -> Self
    {
        ...
        >(
            this: *mut core::ffi::c_void,
            in_dwindex: u32,
            out_ppcapabilities: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISideShowCapabilitiesCollection_Impl::GetAt(
                    this,
                    core::mem::transmute_copy(&in_dwindex),
                ) {
                    Ok(ok__) => {
...
impl ISideShowContent {
    ...
    pub unsafe fn ContentId(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ContentId)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn DifferentiateContent(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DifferentiateContent)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct ISideShowContent_Vtbl {
    ...
    pub ContentId:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub DifferentiateContent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait ISideShowContent_Impl: windows_core::IUnknownImpl {
    fn GetContent(
        &self,
        in_picapabilities: windows_core::Ref<'_, ISideShowCapabilities>,
        out_pdwsize: *mut u32,
        out_ppbdata: *mut *mut u8,
    ) -> windows_core::Result<()>;
...
impl ISideShowContent_Vtbl {
    pub const fn new<Identity: ISideShowContent_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            in_picapabilities: *mut core::ffi::c_void,
            out_pdwsize: *mut u32,
            out_ppbdata: *mut *mut u8,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowContent_Impl::GetContent(
                    this,
                    core::mem::transmute_copy(&in_picapabilities),
                    core::mem::transmute_copy(&out_pdwsize),
                    core::mem::transmute_copy(&out_ppbdata),
                )
                .into()
            }
        }
        ...
        unsafe extern "system" fn DifferentiateContent<
            Identity: ISideShowContent_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            out_pfdifferentiatecontent: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0xa5d5b66b_eef9_41db_8d7e_e17c33ab10b0
);
...
impl ISideShowContentManager {
    ...
    pub unsafe fn GetDeviceCapabilities(
        &self,
    ) -> windows_core::Result<ISideShowCapabilitiesCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISideShowContentManager_Impl: windows_core::IUnknownImpl {
    fn Add(
        &self,
        in_picontent: windows_core::Ref<'_, ISideShowContent>,
    ) -> windows_core::Result<()>;
    fn Remove(&self, in_contentid: u32) -> windows_core::Result<()>;
    fn RemoveAll(&self) -> windows_core::Result<()>;
    fn SetEventSink(
        &self,
        in_pievents: windows_core::Ref<'_, ISideShowEvents>,
    ) -> windows_core::Result<()>;
...
impl ISideShowContentManager_Vtbl {
    pub const fn new<Identity: ISideShowContentManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            in_picontent: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowContentManager_Impl::Add(this, core::mem::transmute_copy(&in_picontent))
                    .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowContentManager_Impl::Remove(this, core::mem::transmute_copy(&in_contentid))
                    .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            in_pievents: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowContentManager_Impl::SetEventSink(
                    this,
                    core::mem::transmute_copy(&in_pievents),
                )
                .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            out_ppcollection: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x61feca4c_deb4_4a7e_8d75_51f1132d615b
);
...
impl ISideShowEvents {
    pub unsafe fn ContentMissing(
        &self,
        in_contentid: u32,
    ) -> windows_core::Result<ISideShowContent> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ContentMissing)(
                windows_core::Interface::as_raw(self),
                in_contentid,
                &mut result__,
            )
    ...
    pub unsafe fn ApplicationEvent<P0>(
        &self,
        in_picapabilities: P0,
        in_dweventid: u32,
        in_pbeventdata: Option<&[u8]>,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<ISideShowCapabilities>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).ApplicationEvent)(
                windows_core::Interface::as_raw(self),
                in_picapabilities.param().abi(),
                in_dweventid,
                in_pbeventdata
...
pub struct ISideShowEvents_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub ContentMissing: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ApplicationEvent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        u32,
...
pub trait ISideShowEvents_Impl: windows_core::IUnknownImpl {
    ...
    fn DeviceAdded(
        &self,
        in_pidevice: windows_core::Ref<'_, ISideShowCapabilities>,
    ) -> windows_core::Result<()>;
    fn DeviceRemoved(
        &self,
        in_pidevice: windows_core::Ref<'_, ISideShowCapabilities>,
...
impl ISideShowEvents_Vtbl {
    pub const fn new<Identity: ISideShowEvents_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ContentMissing<
            Identity: ISideShowEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            in_contentid: u32,
            out_ppicontent: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISideShowEvents_Impl::ContentMissing(
                    this,
                    core::mem::transmute_copy(&in_contentid),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn ApplicationEvent<
            Identity: ISideShowEvents_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowEvents_Impl::ApplicationEvent(
                    this,
                    core::mem::transmute_copy(&in_picapabilities),
                    core::mem::transmute_copy(&in_dweventid),
                    core::mem::transmute_copy(&in_dweventsize),
                    core::mem::transmute_copy(&in_pbeventdata),
                )
                .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            in_pidevice: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowEvents_Impl::DeviceAdded(this, core::mem::transmute_copy(&in_pidevice))
                    .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowEvents_Impl::DeviceRemoved(this, core::mem::transmute_copy(&in_pidevice))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0x045473bc_a37b_4957_b144_68105411ed8e
);
    ...
    pub const fn new<Identity: ISideShowKeyCollection_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowKeyCollection_Impl::GetAt(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowKeyCollection_Impl::GetCount(this, core::mem::transmute_copy(&pcelems))
                    .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowKeyCollection_Impl::RemoveAt(this, core::mem::transmute_copy(&dwindex))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    ...
    0x03c93300_8ab2_41c5_9b79_46127a30e148
);
...
impl ISideShowNotification {
    pub unsafe fn NotificationId(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).NotificationId)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetNotificationId(&self, in_notificationid: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetNotificationId)(
                windows_core::Interface::as_raw(self),
                in_notificationid,
            )
            .ok()
    ...
    pub unsafe fn SetExpirationTime(
        &self,
        in_ptime: Option<*const super::super::Foundation::SYSTEMTIME>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetExpirationTime)(
                windows_core::Interface::as_raw(self),
                in_ptime.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
...
impl ISideShowNotification_Vtbl {
    pub const fn new<Identity: ISideShowNotification_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn NotificationId<
        ...
        unsafe extern "system" fn SetNotificationId<
            Identity: ISideShowNotification_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowNotification_Impl::SetNotificationId(
                    this,
                    core::mem::transmute_copy(&in_notificationid),
                )
                .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            out_ppwsztitle: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            in_pwsztitle: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowNotification_Impl::SetTitle(this, core::mem::transmute(&in_pwsztitle))
                    .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            out_ppwszmessage: *mut windows_core::PWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetMessage<
            Identity: ISideShowNotification_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            in_pwszmessage: windows_core::PCWSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowNotification_Impl::SetMessage(this, core::mem::transmute(&in_pwszmessage))
                    .into()
            }
        }
        unsafe extern "system" fn Image<
            Identity: ISideShowNotification_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowNotification_Impl::SetImage(this, core::mem::transmute_copy(&in_hicon))
                    .into()
            }
        }
        unsafe extern "system" fn ExpirationTime<
            Identity: ISideShowNotification_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetExpirationTime<
            Identity: ISideShowNotification_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowNotification_Impl::SetExpirationTime(
                    this,
                    core::mem::transmute_copy(&in_ptime),
                )
                .into()
            }
        }
...
impl ISideShowNotificationManager {
    ...
    pub unsafe fn RevokeAll(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).RevokeAll)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
}
...
pub trait ISideShowNotificationManager_Impl: windows_core::IUnknownImpl {
    fn Show(
        &self,
        in_pinotification: windows_core::Ref<'_, ISideShowNotification>,
    ) -> windows_core::Result<()>;
...
impl ISideShowNotificationManager_Vtbl {
    pub const fn new<Identity: ISideShowNotificationManager_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            in_pinotification: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowNotificationManager_Impl::Show(
                    this,
                    core::mem::transmute_copy(&in_pinotification),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowNotificationManager_Impl::Revoke(
                    this,
                    core::mem::transmute_copy(&in_notificationid),
                )
                .into()
        ...
        unsafe extern "system" fn RevokeAll<
            Identity: ISideShowNotificationManager_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x2ea7a549_7bff_4aae_bab0_22d43111de49
);
...
impl ISideShowPropVariantCollection {
    ...
    pub unsafe fn Add(
        &self,
        pvalue: *const super::Com::StructuredStorage::PROPVARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Add)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn GetAt(
        &self,
        dwindex: u32,
        pvalue: *mut super::Com::StructuredStorage::PROPVARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetAt)(
                windows_core::Interface::as_raw(self),
    ...
    pub const fn new<Identity: ISideShowPropVariantCollection_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowPropVariantCollection_Impl::Add(this, core::mem::transmute_copy(&pvalue))
                    .into()
            }
        }
        unsafe extern "system" fn Clear<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowPropVariantCollection_Impl::GetAt(
                    this,
                    core::mem::transmute_copy(&dwindex),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowPropVariantCollection_Impl::GetCount(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowPropVariantCollection_Impl::RemoveAt(
                    this,
                    core::mem::transmute_copy(&dwindex),
                )
                .into()
...
windows_core::imp::define_interface!(
    ...
    0xe22331ee_9e7d_4922_9fc2_ab7aa41ce491
);
...
impl ISideShowSession {
    pub unsafe fn RegisterContent(
        &self,
        in_applicationid: *const windows_core::GUID,
        in_endpointid: *const windows_core::GUID,
    ) -> windows_core::Result<ISideShowContentManager> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RegisterContent)(
                windows_core::Interface::as_raw(self),
                in_applicationid,
                in_endpointid,
                &mut result__,
    ...
    pub unsafe fn RegisterNotifications(
        &self,
        in_applicationid: *const windows_core::GUID,
    ) -> windows_core::Result<ISideShowNotificationManager> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RegisterNotifications)(
                windows_core::Interface::as_raw(self),
                in_applicationid,
                &mut result__,
            )
...
pub struct ISideShowSession_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub RegisterContent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RegisterNotifications: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const windows_core::GUID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl ISideShowSession_Vtbl {
    pub const fn new<Identity: ISideShowSession_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RegisterContent<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISideShowSession_Impl::RegisterContent(
                    this,
                    core::mem::transmute_copy(&in_applicationid),
                    core::mem::transmute_copy(&in_endpointid),
                ) {
                    Ok(ok__) => {
                        out_ppicontent.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn RegisterNotifications<
            Identity: ISideShowSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            in_applicationid: *const windows_core::GUID,
            out_ppinotification: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ISideShowSession_Impl::RegisterNotifications(
                    this,
                    core::mem::transmute_copy(&in_applicationid),
                ) {
                    Ok(ok__) => {
...
pub const SIDESHOW_APPLICATION_EVENT: windows_core::GUID =
    windows_core::GUID::from_u128(0x4cb572fa_1d3b_49b3_a17a_2e6bff052854);
pub const SIDESHOW_CAPABILITY_CLIENT_AREA_HEIGHT: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 16,
    };
pub const SIDESHOW_CAPABILITY_CLIENT_AREA_WIDTH: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 15,
    };
pub const SIDESHOW_CAPABILITY_COLOR_DEPTH: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 5,
    };
pub const SIDESHOW_CAPABILITY_COLOR_TYPE: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 6,
    };
pub const SIDESHOW_CAPABILITY_CURRENT_LANGUAGE: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 9,
    };
pub const SIDESHOW_CAPABILITY_DATA_CACHE: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 7,
    };
pub const SIDESHOW_CAPABILITY_DEVICE_ID: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 1,
    };
pub const SIDESHOW_CAPABILITY_DEVICE_PROPERTIES: windows_core::GUID =
    windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99);
pub const SIDESHOW_CAPABILITY_SCREEN_HEIGHT: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 4,
    };
pub const SIDESHOW_CAPABILITY_SCREEN_TYPE: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 2,
    };
pub const SIDESHOW_CAPABILITY_SCREEN_WIDTH: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 3,
    };
pub const SIDESHOW_CAPABILITY_SUPPORTED_IMAGE_FORMATS: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 14,
    };
pub const SIDESHOW_CAPABILITY_SUPPORTED_LANGUAGES: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 8,
    };
pub const SIDESHOW_CAPABILITY_SUPPORTED_THEMES: super::super::Foundation::PROPERTYKEY =
    super::super::Foundation::PROPERTYKEY {
        fmtid: windows_core::GUID::from_u128(0x8abc88a8_857b_4ad7_a35a_b5942f492b99),
        pid: 10,
    };
...
pub const SIDESHOW_CONTENT_MISSING_EVENT: windows_core::GUID =
    windows_core::GUID::from_u128(0x5007fba8_d313_439f_bea2_a50201d3e9a8);
pub const SIDESHOW_ENDPOINT_ICAL: windows_core::GUID =
    windows_core::GUID::from_u128(0x4dff36b5_9dde_4f76_9a2a_96435047063d);
pub const SIDESHOW_ENDPOINT_SIMPLE_CONTENT_FORMAT: windows_core::GUID =
    windows_core::GUID::from_u128(0xa9a5353f_2d4b_47ce_93ee_759f3a7dda4f);
...
pub const SIDESHOW_NEW_EVENT_DATA_AVAILABLE: windows_core::GUID =
    windows_core::GUID::from_u128(0x57813854_2fc1_411c_a59f_f24927608804);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const SIDESHOW_USER_CHANGE_REQUEST_EVENT: windows_core::GUID =
    windows_core::GUID::from_u128(0x5009673c_3f7d_4c7e_9971_eaa2e91f1575);
pub const SideShowKeyCollection: windows_core::GUID =
    windows_core::GUID::from_u128(0xdfbbdbf8_18de_49b8_83dc_ebc727c62d94);
pub const SideShowNotification: windows_core::GUID =
    windows_core::GUID::from_u128(0x0ce3e86f_d5cd_4525_a766_1abab1a752f5);
pub const SideShowPropVariantCollection: windows_core::GUID =
    windows_core::GUID::from_u128(0xe640f415_539e_4923_96cd_5f093bc250cd);
pub const SideShowSession: windows_core::GUID =
    windows_core::GUID::from_u128(0xe20543b9_f785_4ea2_981e_c4ffa76bbc7c);

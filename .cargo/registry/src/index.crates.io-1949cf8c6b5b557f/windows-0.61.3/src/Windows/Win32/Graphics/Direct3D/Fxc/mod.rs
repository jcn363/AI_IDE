    ...
    P6: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        D3DCompile2(
            ...
            flags2,
            secondarydataflags,
            psecondarydata.unwrap_or(core::mem::zeroed()) as _,
            secondarydatasize,
            core::mem::transmute(ppcode),
            pperrormsgs.unwrap_or(core::mem::zeroed()) as _,
        )
...
pub unsafe fn D3DDecompressShaders(
    ...
    unsafe {
        D3DDecompressShaders(
            ...
            unumshaders,
            ustartindex,
            pindices.unwrap_or(core::mem::zeroed()) as _,
            uflags,
            core::mem::transmute(ppshaders),
            ptotalshaders.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn D3DDisassemble10Effect<P0>(
    peffect: P0,
    flags: u32,
) -> windows_core::Result<super::ID3DBlob>
where
    P0: windows_core::Param<super::super::Direct3D10::ID3D10Effect>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        D3DDisassemble10Effect(peffect.param().abi(), flags, &mut result__)
            .and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        D3DDisassembleRegion(
            ...
            startbyteoffset,
            numinsts,
            pfinishbyteoffset.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn D3DGetTraceInstructionOffsets(
    ...
    unsafe {
        D3DGetTraceInstructionOffsets(
            ...
            ptotalinsts.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub type pD3DCompile = Option<
    unsafe extern "system" fn(
        ...
        pinclude: windows_core::Ref<'_, super::ID3DInclude>,
        pentrypoint: windows_core::PCSTR,
        ptarget: windows_core::PCSTR,
        flags1: u32,
        flags2: u32,
        ppcode: windows_core::OutRef<'_, super::ID3DBlob>,
        pperrormsgs: windows_core::OutRef<'_, super::ID3DBlob>,
...
pub type pD3DDisassemble = Option<
    unsafe extern "system" fn(
        ...
        ppdisassembly: windows_core::OutRef<'_, super::ID3DBlob>,
    ) -> windows_core::HRESULT,
>;
pub type pD3DPreprocess = Option<
    unsafe extern "system" fn(
        ...
        pdefines: *const super::D3D_SHADER_MACRO,
        pinclude: windows_core::Ref<'_, super::ID3DInclude>,
        ppcodetext: windows_core::OutRef<'_, super::ID3DBlob>,
        pperrormsgs: windows_core::OutRef<'_, super::ID3DBlob>,
    ) -> windows_core::HRESULT,
>;

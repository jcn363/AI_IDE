...
pub unsafe fn ChooseColorA(param0: *mut CHOOSECOLORA) -> windows_core::BOOL {
    windows_link::link!("comdlg32.dll" "system" fn ChooseColorA(param0 : *mut CHOOSECOLORA) -> windows_core::BOOL);
    unsafe { ChooseColorA(param0 as _) }
}
#[inline]
pub unsafe fn ChooseColorW(param0: *mut CHOOSECOLORW) -> windows_core::BOOL {
    windows_link::link!("comdlg32.dll" "system" fn ChooseColorW(param0 : *mut CHOOSECOLORW) -> windows_core::BOOL);
    unsafe { ChooseColorW(param0 as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ChooseFontA(param0: *mut CHOOSEFONTA) -> windows_core::BOOL {
    windows_link::link!("comdlg32.dll" "system" fn ChooseFontA(param0 : *mut CHOOSEFONTA) -> windows_core::BOOL);
    unsafe { ChooseFontA(param0 as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ChooseFontW(param0: *mut CHOOSEFONTW) -> windows_core::BOOL {
    windows_link::link!("comdlg32.dll" "system" fn ChooseFontW(param0 : *mut CHOOSEFONTW) -> windows_core::BOOL);
...
{
    windows_link::link!("comdlg32.dll" "system" fn GetFileTitleA(param0 : windows_core::PCSTR, buf : windows_core::PSTR, cchsize : u16) -> i16);
    unsafe {
        GetFileTitleA(
            param0.param().abi(),
...
{
    windows_link::link!("comdlg32.dll" "system" fn GetFileTitleW(param0 : windows_core::PCWSTR, buf : windows_core::PWSTR, cchsize : u16) -> i16);
    unsafe {
        GetFileTitleW(
            param0.param().abi(),
            core::mem::transmute(buf.as_ptr()),
...
pub unsafe fn GetOpenFileNameA(param0: *mut OPENFILENAMEA) -> windows_core::BOOL {
    windows_link::link!("comdlg32.dll" "system" fn GetOpenFileNameA(param0 : *mut OPENFILENAMEA) -> windows_core::BOOL);
    unsafe { GetOpenFileNameA(param0 as _) }
}
#[inline]
pub unsafe fn GetOpenFileNameW(param0: *mut OPENFILENAMEW) -> windows_core::BOOL {
    windows_link::link!("comdlg32.dll" "system" fn GetOpenFileNameW(param0 : *mut OPENFILENAMEW) -> windows_core::BOOL);
    unsafe { GetOpenFileNameW(param0 as _) }
}
#[inline]
pub unsafe fn GetSaveFileNameA(param0: *mut OPENFILENAMEA) -> windows_core::BOOL {
    windows_link::link!("comdlg32.dll" "system" fn GetSaveFileNameA(param0 : *mut OPENFILENAMEA) -> windows_core::BOOL);
    unsafe { GetSaveFileNameA(param0 as _) }
}
#[inline]
pub unsafe fn GetSaveFileNameW(param0: *mut OPENFILENAMEW) -> windows_core::BOOL {
    windows_link::link!("comdlg32.dll" "system" fn GetSaveFileNameW(param0 : *mut OPENFILENAMEW) -> windows_core::BOOL);
    unsafe { GetSaveFileNameW(param0 as _) }
}
#[inline]
pub unsafe fn PageSetupDlgA(param0: *mut PAGESETUPDLGA) -> windows_core::BOOL {
    windows_link::link!("comdlg32.dll" "system" fn PageSetupDlgA(param0 : *mut PAGESETUPDLGA) -> windows_core::BOOL);
    unsafe { PageSetupDlgA(param0 as _) }
}
#[inline]
pub unsafe fn PageSetupDlgW(param0: *mut PAGESETUPDLGW) -> windows_core::BOOL {
    windows_link::link!("comdlg32.dll" "system" fn PageSetupDlgW(param0 : *mut PAGESETUPDLGW) -> windows_core::BOOL);
    unsafe { PageSetupDlgW(param0 as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn PrintDlgA(ppd: *mut PRINTDLGA) -> windows_core::BOOL {
    windows_link::link!("comdlg32.dll" "system" fn PrintDlgA(ppd : *mut PRINTDLGA) -> windows_core::BOOL);
...
pub unsafe fn PrintDlgW(ppd: *mut PRINTDLGW) -> windows_core::BOOL {
    windows_link::link!("comdlg32.dll" "system" fn PrintDlgW(ppd : *mut PRINTDLGW) -> windows_core::BOOL);
...
windows_core::imp::define_interface!(
    ...
    0x5852a2c3_6530_11d1_b6a3_0000f8757bf9
);
...
impl IPrintDialogCallback {
    pub unsafe fn InitDone(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).InitDone)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn SelectionChange(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SelectionChange)(
    ...
    pub unsafe fn HandleMessage(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).HandleMessage)(
                windows_core::Interface::as_raw(self),
                hdlg,
                umsg,
                wparam,
...
pub struct IPrintDialogCallback_Vtbl {
    ...
    pub HandleMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IPrintDialogCallback_Vtbl {
    pub const fn new<Identity: IPrintDialogCallback_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn InitDone<
        ...
        unsafe extern "system" fn SelectionChange<
            Identity: IPrintDialogCallback_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn HandleMessage<
            Identity: IPrintDialogCallback_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintDialogCallback_Impl::HandleMessage(
                    this,
                    core::mem::transmute_copy(&hdlg),
...
windows_core::imp::define_interface!(
    ...
    0x509aaeda_5639_11d1_b6a1_0000f8757bf9
);
...
impl IPrintDialogServices {
    ...
    pub unsafe fn GetCurrentDevMode(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetCurrentDevMode)(
                windows_core::Interface::as_raw(self),
                pdevmode as _,
                pcbsize as _,
            )
    ...
    pub unsafe fn GetCurrentPrinterName(
        &self,
        pprintername: Option<windows_core::PWSTR>,
        pcchsize: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetCurrentPrinterName)(
                windows_core::Interface::as_raw(self),
                pprintername.unwrap_or(core::mem::zeroed()) as _,
                pcchsize as _,
            )
            .ok()
        }
    ...
    pub unsafe fn GetCurrentPortName(
        &self,
        pportname: Option<windows_core::PWSTR>,
        pcchsize: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetCurrentPortName)(
                windows_core::Interface::as_raw(self),
...
pub struct IPrintDialogServices_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub GetCurrentDevMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Graphics::Gdi::DEVMODEA,
        *mut u32,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Graphics_Gdi"))]
    GetCurrentDevMode: usize,
    pub GetCurrentPrinterName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PWSTR,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetCurrentPortName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PWSTR,
        *mut u32,
    ) -> windows_core::HRESULT,
...
pub trait IPrintDialogServices_Impl: windows_core::IUnknownImpl {
    ...
    fn GetCurrentPrinterName(
        &self,
        pprintername: windows_core::PWSTR,
        pcchsize: *mut u32,
    ) -> windows_core::Result<()>;
    fn GetCurrentPortName(
        &self,
        pportname: windows_core::PWSTR,
        pcchsize: *mut u32,
    ) -> windows_core::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
impl IPrintDialogServices_Vtbl {
    pub const fn new<Identity: IPrintDialogServices_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCurrentDevMode<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintDialogServices_Impl::GetCurrentDevMode(
                    this,
        ...
        unsafe extern "system" fn GetCurrentPrinterName<
            Identity: IPrintDialogServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintDialogServices_Impl::GetCurrentPrinterName(
                    this,
                    core::mem::transmute_copy(&pprintername),
                    core::mem::transmute_copy(&pcchsize),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetCurrentPortName<
            Identity: IPrintDialogServices_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPrintDialogServices_Impl::GetCurrentPortName(
                    this,
...
>;
pub type LPPAGEPAINTHOOK = Option<
    unsafe extern "system" fn(
        param0: super::super::super::Foundation::HWND,
        param1: u32,
        param2: super::super::super::Foundation::WPARAM,
...
>;
pub type LPPAGESETUPHOOK = Option<
    unsafe extern "system" fn(
        param0: super::super::super::Foundation::HWND,
        param1: u32,
        param2: super::super::super::Foundation::WPARAM,
...
>;
pub type LPPRINTHOOKPROC = Option<
    unsafe extern "system" fn(
        param0: super::super::super::Foundation::HWND,
        param1: u32,
        param2: super::super::super::Foundation::WPARAM,
...
>;
pub type LPSETUPHOOKPROC = Option<
    unsafe extern "system" fn(
        param0: super::super::super::Foundation::HWND,
        param1: u32,
        param2: super::super::super::Foundation::WPARAM,

...
pub unsafe fn CMCheckRGBs(
    hcmtransform: isize,
    lpsrcbits: *const core::ffi::c_void,
    bminput: BMFORMAT,
    dwwidth: u32,
    dwheight: u32,
    dwstride: u32,
...
pub unsafe fn CMCreateDeviceLinkProfile(
    ...
    unsafe {
        CMCreateDeviceLinkProfile(
            core::mem::transmute(pahprofiles.as_ptr()),
            pahprofiles.len().try_into().unwrap(),
            core::mem::transmute(padwintents.as_ptr()),
            padwintents.len().try_into().unwrap(),
            dwflags,
            lpprofiledata as _,
        )
    }
...
pub unsafe fn CMCreateProfile(
    ...
    lpprofiledata: *mut *mut core::ffi::c_void,
) -> windows_core::BOOL {
...
pub unsafe fn CMCreateTransform(
    ...
    lpdevcharacter: *const core::ffi::c_void,
    lptargetdevcharacter: *const core::ffi::c_void,
) -> isize {
...
pub unsafe fn CMIsProfileValid(
    hprofile: isize,
    lpbvalid: *mut windows_core::BOOL,
) -> windows_core::BOOL {
...
pub unsafe fn CMTranslateRGB(
    hcmtransform: isize,
    colorref: super::super::Foundation::COLORREF,
    lpcolorref: *mut u32,
    dwflags: u32,
) -> windows_core::BOOL {
...
pub unsafe fn CMTranslateRGBs(
    ...
    dwheight: u32,
    dwstride: u32,
    lpdestbits: *mut core::ffi::c_void,
    bmoutput: BMFORMAT,
...
pub unsafe fn CheckBitmapBits(
    ...
    psrcbits: *const core::ffi::c_void,
    bminput: BMFORMAT,
    dwwidth: u32,
    dwheight: u32,
    dwstride: u32,
    paresult: *mut u8,
    pfncallback: LPBMCALLBACKFN,
    lpcallbackdata: Option<super::super::Foundation::LPARAM>,
) -> windows_core::BOOL {
    ...
    unsafe {
        CheckBitmapBits(
            ...
            paresult as _,
            pfncallback,
            lpcallbackdata.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ColorProfileAddDisplayAssociation(
            ...
            core::mem::transmute(targetadapterid),
            sourceid,
            setasdefault.into(),
            associateasadvancedcolor.into(),
        )
        .ok()
    }
}
...
pub unsafe fn ColorProfileGetDisplayList(
    ...
    targetadapterid: super::super::Foundation::LUID,
    sourceid: u32,
    profilelist: *mut *mut windows_core::PWSTR,
...
pub unsafe fn ColorProfileGetDisplayUserScope(
    targetadapterid: super::super::Foundation::LUID,
    sourceid: u32,
) -> windows_core::Result<WCS_PROFILE_MANAGEMENT_SCOPE> {
...
pub unsafe fn CreateDeviceLinkProfile(
    ...
    unsafe {
        CreateDeviceLinkProfile(
            core::mem::transmute(hprofile.as_ptr()),
            hprofile.len().try_into().unwrap(),
            core::mem::transmute(padwintent.as_ptr()),
            padwintent.len().try_into().unwrap(),
            dwflags,
            pprofiledata as _,
            indexpreferredcmm,
        )
...
#[inline]
pub unsafe fn DisassociateColorProfileFromDeviceW<P0, P1, P2>(
    pmachinename: P0,
    pprofilename: P1,
    pdevicename: P2,
) -> windows_core::BOOL
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        EnumColorProfilesA(
            pmachinename.param().abi(),
            penumrecord,
            penumerationbuffer.unwrap_or(core::mem::zeroed()) as _,
            pdwsizeofenumerationbuffer as _,
            pnprofiles.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn EnumICMProfilesA(
    hdc: super::super::Graphics::Gdi::HDC,
    proc: ICMENUMPROCA,
    param2: Option<super::super::Foundation::LPARAM>,
) -> i32 {
...
pub unsafe fn GetColorDirectoryA<P0>(
    pmachinename: P0,
    pbuffer: Option<windows_core::PSTR>,
    pdwsize: *mut u32,
) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCSTR>,
...
pub unsafe fn GetColorDirectoryW<P0>(
    pmachinename: P0,
    pbuffer: Option<windows_core::PWSTR>,
    pdwsize: *mut u32,
) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn GetColorProfileElement(
    ...
    dwoffset: u32,
    pcbelement: *mut u32,
    pelement: Option<*mut core::ffi::c_void>,
    pbreference: *mut windows_core::BOOL,
) -> windows_core::BOOL {
    ...
    unsafe {
        GetColorProfileElement(
            ...
            dwoffset,
            pcbelement as _,
            pelement.unwrap_or(core::mem::zeroed()) as _,
            pbreference as _,
        )
    }
}
...
pub unsafe fn GetColorProfileFromHandle(
    ...
    unsafe {
        GetColorProfileFromHandle(
            hprofile,
            pprofile.unwrap_or(core::mem::zeroed()) as _,
            pcbprofile as _,
        )
    }
}
...
pub unsafe fn GetICMProfileA(
    hdc: super::super::Graphics::Gdi::HDC,
    pbufsize: *mut u32,
    pszfilename: Option<windows_core::PSTR>,
) -> windows_core::BOOL {
    ...
    unsafe {
        GetICMProfileA(
            hdc,
            pbufsize as _,
            pszfilename.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub unsafe fn GetICMProfileW(
    hdc: super::super::Graphics::Gdi::HDC,
    pbufsize: *mut u32,
    pszfilename: Option<windows_core::PWSTR>,
) -> windows_core::BOOL {
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn GetLogColorSpaceW(
    hcolorspace: HCOLORSPACE,
...
pub unsafe fn GetPS2ColorRenderingDictionary(
    hprofile: isize,
    dwintent: u32,
    pps2colorrenderingdictionary: Option<*mut u8>,
    pcbps2colorrenderingdictionary: *mut u32,
    pbbinary: *mut windows_core::BOOL,
) -> windows_core::BOOL {
    ...
    unsafe {
        GetPS2ColorRenderingDictionary(
            hprofile,
            dwintent,
            pps2colorrenderingdictionary.unwrap_or(core::mem::zeroed()) as _,
            pcbps2colorrenderingdictionary as _,
            pbbinary as _,
        )
    }
}
...
pub unsafe fn GetPS2ColorRenderingIntent(
    ...
    unsafe {
        GetPS2ColorRenderingIntent(
            ...
            dwintent,
            pbuffer.unwrap_or(core::mem::zeroed()) as _,
            pcbps2colorrenderingintent as _,
        )
    }
}
#[inline]
pub unsafe fn GetPS2ColorSpaceArray(
    ...
    dwintent: u32,
    dwcsatype: u32,
    pps2colorspacearray: Option<*mut u8>,
    ...
    unsafe {
        GetPS2ColorSpaceArray(
            ...
            dwintent,
            dwcsatype,
            pps2colorspacearray.unwrap_or(core::mem::zeroed()) as _,
            pcbps2colorspacearray as _,
            pbbinary as _,
        )
    }
}
#[inline]
pub unsafe fn GetStandardColorSpaceProfileA<P0>(
    pmachinename: P0,
    dwscs: u32,
    pbuffer: Option<windows_core::PSTR>,
    pcbsize: *mut u32,
...
pub unsafe fn SetColorProfileElement(
    ...
    pelement: *const core::ffi::c_void,
) -> windows_core::BOOL {
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn SetICMProfileA<P1>(
    hdc: super::super::Graphics::Gdi::HDC,
    lpfilename: P1,
) -> windows_core::BOOL
where
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn SetICMProfileW<P1>(
    hdc: super::super::Graphics::Gdi::HDC,
    lpfilename: P1,
) -> windows_core::BOOL
where
...
pub unsafe fn TranslateBitmapBits(
    ...
    dwheight: u32,
    dwinputstride: u32,
    pdestbits: *mut core::ffi::c_void,
    bmoutput: BMFORMAT,
    dwoutputstride: u32,
    pfncallback: LPBMCALLBACKFN,
    ulcallbackdata: Option<super::super::Foundation::LPARAM>,
) -> windows_core::BOOL {
    ...
    unsafe {
        TranslateBitmapBits(
            ...
            dwoutputstride,
            pfncallback,
            ulcallbackdata.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn UninstallColorProfileW<P0, P1>(
    pmachinename: P0,
    pprofilename: P1,
    bdelete: bool,
) -> windows_core::BOOL
...
#[inline]
pub unsafe fn WcsAssociateColorProfileWithDevice<P1, P2>(
    scope: WCS_PROFILE_MANAGEMENT_SCOPE,
    pprofilename: P1,
    pdevicename: P2,
) -> windows_core::BOOL
...
pub unsafe fn WcsCheckColors(
    ...
    cbinput: u32,
    pinputdata: *const core::ffi::c_void,
    paresult: &mut [u8],
) -> windows_core::BOOL {
    ...
    unsafe {
        WcsCheckColors(
            hcolortransform,
            paresult.len().try_into().unwrap(),
            ninputchannels,
            cdtinput,
            cbinput,
            pinputdata,
            core::mem::transmute(paresult.as_ptr()),
        )
    }
}
#[inline]
...
pub unsafe fn WcsGetCalibrationManagementState(
    pbisenabled: *mut windows_core::BOOL,
) -> windows_core::BOOL {
...
pub unsafe fn WcsGetDefaultColorProfile<P1>(
    ...
    dwprofileid: u32,
    cbprofilename: u32,
    pprofilename: windows_core::PWSTR,
) -> windows_core::BOOL
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        WcsGetDefaultColorProfile(
            ...
            dwprofileid,
            cbprofilename,
            core::mem::transmute(pprofilename),
        )
    }
}
#[inline]
...
pub unsafe fn WcsGetUsePerUserProfiles<P0>(
    pdevicename: P0,
    dwdeviceclass: u32,
    puseperuserprofiles: *mut windows_core::BOOL,
) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
pub unsafe fn WcsOpenColorProfileA(
    ...
    pcampprofile: Option<*const PROFILE>,
    pgmmpprofile: Option<*const PROFILE>,
    dwdesireaccess: u32,
    dwsharemode: u32,
    dwcreationmode: u32,
    dwflags: u32,
    ...
    unsafe {
        WcsOpenColorProfileA(
            pcdmpprofile,
            pcampprofile.unwrap_or(core::mem::zeroed()) as _,
            pgmmpprofile.unwrap_or(core::mem::zeroed()) as _,
            dwdesireaccess,
            dwsharemode,
            dwcreationmode,
            dwflags,
...
pub const CATID_WcsPlugin: windows_core::GUID =
    windows_core::GUID::from_u128(0xa0b402e0_8240_405f_8a16_8a5b4df2f0dd);
...
windows_core::imp::define_interface!(
    ...
    0x1cd63475_07c4_46fe_a903_d655316d11fd
);
...
impl IDeviceModelPlugIn {
    ...
    pub unsafe fn GetNumChannels(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNumChannels)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn DeviceToColorimetricColors(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DeviceToColorimetricColors)(
                windows_core::Interface::as_raw(self),
                pxyzcolors.len().try_into().unwrap(),
                cchannels,
                pdevicevalues,
                core::mem::transmute(pxyzcolors.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn ColorimetricToDeviceColors(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ColorimetricToDeviceColors)(
                windows_core::Interface::as_raw(self),
                pxyzcolors.len().try_into().unwrap(),
                cchannels,
                core::mem::transmute(pxyzcolors.as_ptr()),
    ...
    pub unsafe fn ColorimetricToDeviceColorsWithBlack(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ColorimetricToDeviceColorsWithBlack)(
                windows_core::Interface::as_raw(self),
                ccolors,
                cchannels,
                pxyzcolors,
    ...
    pub unsafe fn SetTransformDeviceModelInfo<P1>(
        &self,
        imodelposition: u32,
        pidevicemodelother: P1,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<IDeviceModelPlugIn>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetTransformDeviceModelInfo)(
                windows_core::Interface::as_raw(self),
                imodelposition,
                pidevicemodelother.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn GetPrimarySamples(
        &self,
        pprimarycolor: *mut PrimaryXYZColors,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPrimarySamples)(
                windows_core::Interface::as_raw(self),
                pprimarycolor as _,
            )
            .ok()
    ...
    pub unsafe fn GetGamutBoundaryMeshSize(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetGamutBoundaryMeshSize)(
                windows_core::Interface::as_raw(self),
                pnumvertices as _,
                pnumtriangles as _,
            )
    ...
    pub unsafe fn GetGamutBoundaryMesh(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetGamutBoundaryMesh)(
                windows_core::Interface::as_raw(self),
                cchannels,
                cvertices,
                ptriangles.len().try_into().unwrap(),
                pvertices as _,
                core::mem::transmute(ptriangles.as_ptr()),
            )
            .ok()
        }
    }
    pub unsafe fn GetNeutralAxisSize(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNeutralAxisSize)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetNeutralAxis(&self, pxyzcolors: &mut [XYZColorF]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetNeutralAxis)(
                windows_core::Interface::as_raw(self),
                pxyzcolors.len().try_into().unwrap(),
                core::mem::transmute(pxyzcolors.as_ptr()),
            )
...
pub struct IDeviceModelPlugIn_Vtbl {
    ...
    pub DeviceToColorimetricColors: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const f32,
    ...
    pub ColorimetricToDeviceColors: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const XYZColorF,
    ...
    pub ColorimetricToDeviceColorsWithBlack: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const XYZColorF,
        ...
        *mut f32,
        ...
        -> windows_core::HRESULT,
    pub SetTransformDeviceModelInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetPrimarySamples: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PrimaryXYZColors,
    ) -> windows_core::HRESULT,
    pub GetGamutBoundaryMeshSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetGamutBoundaryMesh: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        u32,
        *mut f32,
        *mut GamutShellTriangle,
    ) -> windows_core::HRESULT,
    pub GetNeutralAxisSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetNeutralAxis: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut XYZColorF,
    ) -> windows_core::HRESULT,
...
pub trait IDeviceModelPlugIn_Impl: windows_core::IUnknownImpl {
    ...
    fn SetTransformDeviceModelInfo(
        &self,
        imodelposition: u32,
        pidevicemodelother: windows_core::Ref<'_, IDeviceModelPlugIn>,
    ) -> windows_core::Result<()>;
...
impl IDeviceModelPlugIn_Vtbl {
    pub const fn new<Identity: IDeviceModelPlugIn_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Initialize<
            Identity: IDeviceModelPlugIn_Impl,
            const OFFSET: isize,
        >(
            ...
            unsafe {
                ...
                IDeviceModelPlugIn_Impl::Initialize(
                    this,
                    core::mem::transmute(&bstrxml),
                    core::mem::transmute_copy(&cnummodels),
                    core::mem::transmute_copy(&imodelposition),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetNumChannels<
            Identity: IDeviceModelPlugIn_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn DeviceToColorimetricColors<
            Identity: IDeviceModelPlugIn_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDeviceModelPlugIn_Impl::DeviceToColorimetricColors(
                    this,
                    core::mem::transmute_copy(&ccolors),
                    core::mem::transmute_copy(&cchannels),
                    core::mem::transmute_copy(&pdevicevalues),
                    core::mem::transmute_copy(&pxyzcolors),
                )
                .into()
            }
        }
        unsafe extern "system" fn ColorimetricToDeviceColors<
            Identity: IDeviceModelPlugIn_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDeviceModelPlugIn_Impl::ColorimetricToDeviceColors(
                    this,
                    core::mem::transmute_copy(&ccolors),
                    core::mem::transmute_copy(&cchannels),
                    core::mem::transmute_copy(&pxyzcolors),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDeviceModelPlugIn_Impl::ColorimetricToDeviceColorsWithBlack(
                    this,
                    core::mem::transmute_copy(&ccolors),
                    core::mem::transmute_copy(&cchannels),
                    core::mem::transmute_copy(&pxyzcolors),
                    core::mem::transmute_copy(&pblackinformation),
                ) {
                    Ok(ok__) => {
                        pdevicevalues.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn SetTransformDeviceModelInfo<
            Identity: IDeviceModelPlugIn_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            imodelposition: u32,
            pidevicemodelother: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDeviceModelPlugIn_Impl::SetTransformDeviceModelInfo(
                    this,
                    core::mem::transmute_copy(&imodelposition),
                    core::mem::transmute_copy(&pidevicemodelother),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetPrimarySamples<
            Identity: IDeviceModelPlugIn_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDeviceModelPlugIn_Impl::GetPrimarySamples(
                    this,
                    core::mem::transmute_copy(&pprimarycolor),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetGamutBoundaryMeshSize<
            Identity: IDeviceModelPlugIn_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDeviceModelPlugIn_Impl::GetGamutBoundaryMeshSize(
                    this,
                    core::mem::transmute_copy(&pnumvertices),
                    core::mem::transmute_copy(&pnumtriangles),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetGamutBoundaryMesh<
            Identity: IDeviceModelPlugIn_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDeviceModelPlugIn_Impl::GetGamutBoundaryMesh(
                    this,
                    core::mem::transmute_copy(&cchannels),
                    core::mem::transmute_copy(&cvertices),
                    core::mem::transmute_copy(&ctriangles),
                    core::mem::transmute_copy(&pvertices),
                    core::mem::transmute_copy(&ptriangles),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetNeutralAxisSize<
            Identity: IDeviceModelPlugIn_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetNeutralAxis<
            Identity: IDeviceModelPlugIn_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDeviceModelPlugIn_Impl::GetNeutralAxis(
                    this,
                    core::mem::transmute_copy(&ccolors),
                    core::mem::transmute_copy(&pxyzcolors),
                )
        ...
        Self {
            ...
            ColorimetricToDeviceColorsWithBlack: ColorimetricToDeviceColorsWithBlack::<
                Identity,
                OFFSET,
            >,
...
impl IGamutMapModelPlugIn {
        ...
        P2: windows_core::Param<IDeviceModelPlugIn>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Initialize)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrxml),
                psrcplugin.param().abi(),
                pdestplugin.param().abi(),
                psrcgbd,
                pdestgbd,
            )
            .ok()
    ...
    pub unsafe fn SourceToDestinationAppearanceColors(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SourceToDestinationAppearanceColors)(
                windows_core::Interface::as_raw(self),
                ccolors,
                pinputcolors,
                poutputcolors as _,
...
pub struct IGamutMapModelPlugIn_Vtbl {
    ...
    pub SourceToDestinationAppearanceColors: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const JChColorF,
        *mut JChColorF,
...
pub trait IGamutMapModelPlugIn_Impl: windows_core::IUnknownImpl {
    fn Initialize(
        &self,
        bstrxml: &windows_core::BSTR,
        psrcplugin: windows_core::Ref<'_, IDeviceModelPlugIn>,
        pdestplugin: windows_core::Ref<'_, IDeviceModelPlugIn>,
        psrcgbd: *const GamutBoundaryDescription,
        pdestgbd: *const GamutBoundaryDescription,
    ) -> windows_core::Result<()>;
...
impl IGamutMapModelPlugIn_Vtbl {
    pub const fn new<Identity: IGamutMapModelPlugIn_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Initialize<
            Identity: IGamutMapModelPlugIn_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrxml: *mut core::ffi::c_void,
            psrcplugin: *mut core::ffi::c_void,
            pdestplugin: *mut core::ffi::c_void,
            psrcgbd: *const GamutBoundaryDescription,
            pdestgbd: *const GamutBoundaryDescription,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGamutMapModelPlugIn_Impl::Initialize(
                    this,
                    core::mem::transmute(&bstrxml),
                    core::mem::transmute_copy(&psrcplugin),
                    core::mem::transmute_copy(&pdestplugin),
                    core::mem::transmute_copy(&psrcgbd),
                    core::mem::transmute_copy(&pdestgbd),
                )
                .into()
            }
        }
        unsafe extern "system" fn SourceToDestinationAppearanceColors<
            Identity: IGamutMapModelPlugIn_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGamutMapModelPlugIn_Impl::SourceToDestinationAppearanceColors(
                    this,
                    core::mem::transmute_copy(&ccolors),
                    core::mem::transmute_copy(&pinputcolors),
                    core::mem::transmute_copy(&poutputcolors),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            Initialize: Initialize::<Identity, OFFSET>,
            SourceToDestinationAppearanceColors: SourceToDestinationAppearanceColors::<
                Identity,
                OFFSET,
            >,
        }
...
pub type LPBMCALLBACKFN = Option<
    unsafe extern "system" fn(
        param0: u32,
        param1: u32,
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type PCMSCALLBACKA = Option<
    unsafe extern "system" fn(
        param0: *mut COLORMATCHSETUPA,
        param1: super::super::Foundation::LPARAM,
    ) -> windows_core::BOOL,
>;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type PCMSCALLBACKW = Option<
    unsafe extern "system" fn(
        param0: *mut COLORMATCHSETUPW,
        param1: super::super::Foundation::LPARAM,
    ) -> windows_core::BOOL,
>;

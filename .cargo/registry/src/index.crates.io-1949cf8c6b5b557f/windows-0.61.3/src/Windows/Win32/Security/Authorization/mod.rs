...
pub unsafe fn AuthzAccessCheck(
    ...
    unsafe {
        AuthzAccessCheck(
            ...
            hauthzclientcontext,
            prequest,
            hauditevent.unwrap_or(core::mem::zeroed()) as _,
            psecuritydescriptor,
            core::mem::transmute(
            ...
            preply as _,
            phaccesscheckresults.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn AuthzAddSidsToContext(
    hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE,
    sids: Option<*const super::SID_AND_ATTRIBUTES>,
    sidcount: u32,
    restrictedsids: Option<*const super::SID_AND_ATTRIBUTES>,
    restrictedsidcount: u32,
    phnewauthzclientcontext: *mut AUTHZ_CLIENT_CONTEXT_HANDLE,
) -> windows_core::Result<()> {
    windows_link::link!("authz.dll" "system" fn AuthzAddSidsToContext(hauthzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE, sids : *const super:: SID_AND_ATTRIBUTES, sidcount : u32, restrictedsids : *const super:: SID_AND_ATTRIBUTES, restrictedsidcount : u32, phnewauthzclientcontext : *mut AUTHZ_CLIENT_CONTEXT_HANDLE) -> windows_core::BOOL);
    unsafe {
        AuthzAddSidsToContext(
            hauthzclientcontext,
            sids.unwrap_or(core::mem::zeroed()) as _,
            sidcount,
            restrictedsids.unwrap_or(core::mem::zeroed()) as _,
            restrictedsidcount,
            phnewauthzclientcontext as _,
        )
        .ok()
    }
}
...
pub unsafe fn AuthzCachedAccessCheck(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzCachedAccessCheck(flags : u32, haccesscheckresults : AUTHZ_ACCESS_CHECK_RESULTS_HANDLE, prequest : *const AUTHZ_ACCESS_REQUEST, hauditevent : AUTHZ_AUDIT_EVENT_HANDLE, preply : *mut AUTHZ_ACCESS_REPLY) -> windows_core::BOOL);
    unsafe {
...
pub unsafe fn AuthzEnumerateSecurityEventSources(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzEnumerateSecurityEventSources(dwflags : u32, buffer : *mut AUTHZ_SOURCE_SCHEMA_REGISTRATION, pdwcount : *mut u32, pdwlength : *mut u32) -> windows_core::BOOL);
    unsafe {
        AuthzEnumerateSecurityEventSources(dwflags, buffer as _, pdwcount as _, pdwlength as _).ok()
    }
}
#[inline]
pub unsafe fn AuthzEvaluateSacl(
    ...
    prequest: *const AUTHZ_ACCESS_REQUEST,
    sacl: *const super::ACL,
    grantedaccess: u32,
    accessgranted: bool,
    pbgenerateaudit: *mut windows_core::BOOL,
) -> windows_core::BOOL {
    windows_link::link!("authz.dll" "system" fn AuthzEvaluateSacl(authzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE, prequest : *const AUTHZ_ACCESS_REQUEST, sacl : *const super:: ACL, grantedaccess : u32, accessgranted : windows_core::BOOL, pbgenerateaudit : *mut windows_core::BOOL) -> windows_core::BOOL);
    unsafe {
        AuthzEvaluateSacl(
            authzclientcontext,
            prequest,
...
pub unsafe fn AuthzFreeAuditEvent(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzFreeAuditEvent(hauditevent : AUTHZ_AUDIT_EVENT_HANDLE) -> windows_core::BOOL);
    unsafe { AuthzFreeAuditEvent(hauditevent).ok() }
}
#[inline]
pub unsafe fn AuthzFreeCentralAccessPolicyCache() -> windows_core::Result<()> {
    windows_link::link!("authz.dll" "system" fn AuthzFreeCentralAccessPolicyCache() -> windows_core::BOOL);
...
pub unsafe fn AuthzFreeContext(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzFreeContext(hauthzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE) -> windows_core::BOOL);
...
pub unsafe fn AuthzFreeHandle(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzFreeHandle(haccesscheckresults : AUTHZ_ACCESS_CHECK_RESULTS_HANDLE) -> windows_core::BOOL);
...
pub unsafe fn AuthzFreeResourceManager(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzFreeResourceManager(hauthzresourcemanager : AUTHZ_RESOURCE_MANAGER_HANDLE) -> windows_core::BOOL);
...
pub unsafe fn AuthzGetInformationFromContext(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzGetInformationFromContext(hauthzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE, infoclass : AUTHZ_CONTEXT_INFORMATION_CLASS, buffersize : u32, psizerequired : *mut u32, buffer : *mut core::ffi::c_void) -> windows_core::BOOL);
    unsafe {
...
pub unsafe fn AuthzInitializeCompoundContext(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzInitializeCompoundContext(usercontext : AUTHZ_CLIENT_CONTEXT_HANDLE, devicecontext : AUTHZ_CLIENT_CONTEXT_HANDLE, phcompoundcontext : *mut AUTHZ_CLIENT_CONTEXT_HANDLE) -> windows_core::BOOL);
    unsafe {
        AuthzInitializeCompoundContext(usercontext, devicecontext, phcompoundcontext as _).ok()
    }
}
#[inline]
pub unsafe fn AuthzInitializeContextFromAuthzContext(
    flags: u32,
    hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE,
    pexpirationtime: Option<*const i64>,
    identifier: super::super::Foundation::LUID,
    dynamicgroupargs: *const core::ffi::c_void,
    phnewauthzclientcontext: *mut AUTHZ_CLIENT_CONTEXT_HANDLE,
) -> windows_core::Result<()> {
    ...
    unsafe {
        AuthzInitializeContextFromAuthzContext(
            flags,
            hauthzclientcontext,
            pexpirationtime.unwrap_or(core::mem::zeroed()) as _,
...
pub unsafe fn AuthzInitializeContextFromSid(
    ...
    pexpirationtime: Option<*const i64>,
    identifier: super::super::Foundation::LUID,
    dynamicgroupargs: Option<*const core::ffi::c_void>,
    ...
    unsafe {
        AuthzInitializeContextFromSid(
            ...
            pexpirationtime.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(identifier),
            dynamicgroupargs.unwrap_or(core::mem::zeroed()) as _,
            phauthzclientcontext as _,
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn AuthzInitializeObjectAccessAuditEvent<P2, P3, P4, P5>(
...
{
    windows_link::link!("authz.dll" "C" fn AuthzInitializeObjectAccessAuditEvent(flags : AUTHZ_INITIALIZE_OBJECT_ACCESS_AUDIT_EVENT_FLAGS, hauditeventtype : AUTHZ_AUDIT_EVENT_TYPE_HANDLE, szoperationtype : windows_core::PCWSTR, szobjecttype : windows_core::PCWSTR, szobjectname : windows_core::PCWSTR, szadditionalinfo : windows_core::PCWSTR, phauditevent : *mut AUTHZ_AUDIT_EVENT_HANDLE, dwadditionalparametercount : u32) -> windows_core::BOOL);
    unsafe {
        AuthzInitializeObjectAccessAuditEvent(
            flags,
            hauditeventtype,
            szoperationtype.param().abi(),
            szobjecttype.param().abi(),
            szobjectname.param().abi(),
            szadditionalinfo.param().abi(),
            phauditevent as _,
...
#[inline]
pub unsafe fn AuthzInitializeObjectAccessAuditEvent2<P2, P3, P4, P5, P6>(
    flags: u32,
    hauditeventtype: AUTHZ_AUDIT_EVENT_TYPE_HANDLE,
    szoperationtype: P2,
    szobjecttype: P3,
...
{
    windows_link::link!("authz.dll" "C" fn AuthzInitializeObjectAccessAuditEvent2(flags : u32, hauditeventtype : AUTHZ_AUDIT_EVENT_TYPE_HANDLE, szoperationtype : windows_core::PCWSTR, szobjecttype : windows_core::PCWSTR, szobjectname : windows_core::PCWSTR, szadditionalinfo : windows_core::PCWSTR, szadditionalinfo2 : windows_core::PCWSTR, phauditevent : *mut AUTHZ_AUDIT_EVENT_HANDLE, dwadditionalparametercount : u32) -> windows_core::BOOL);
    unsafe {
...
pub unsafe fn AuthzInitializeRemoteResourceManager(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzInitializeRemoteResourceManager(prpcinitinfo : *const AUTHZ_RPC_INIT_INFO_CLIENT, phauthzresourcemanager : *mut AUTHZ_RESOURCE_MANAGER_HANDLE) -> windows_core::BOOL);
    unsafe { AuthzInitializeRemoteResourceManager(prpcinitinfo, phauthzresourcemanager as _).ok() }
}
#[inline]
pub unsafe fn AuthzInitializeResourceManager<P4>(
    flags: u32,
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        AuthzInitializeResourceManager(
            ...
            szresourcemanagername.param().abi(),
            phauthzresourcemanager as _,
        )
        .ok()
    }
}
...
pub unsafe fn AuthzInitializeResourceManagerEx(
    flags: Option<AUTHZ_RESOURCE_MANAGER_FLAGS>,
    pauthzinitinfo: Option<*const AUTHZ_INIT_INFO>,
    phauthzresourcemanager: *mut AUTHZ_RESOURCE_MANAGER_HANDLE,
) -> windows_core::Result<()> {
    windows_link::link!("authz.dll" "system" fn AuthzInitializeResourceManagerEx(flags : AUTHZ_RESOURCE_MANAGER_FLAGS, pauthzinitinfo : *const AUTHZ_INIT_INFO, phauthzresourcemanager : *mut AUTHZ_RESOURCE_MANAGER_HANDLE) -> windows_core::BOOL);
    unsafe {
        AuthzInitializeResourceManagerEx(
            flags.unwrap_or(core::mem::zeroed()) as _,
            pauthzinitinfo.unwrap_or(core::mem::zeroed()) as _,
            phauthzresourcemanager as _,
        )
        .ok()
    }
...
pub unsafe fn AuthzInstallSecurityEventSource(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzInstallSecurityEventSource(dwflags : u32, pregistration : *const AUTHZ_SOURCE_SCHEMA_REGISTRATION) -> windows_core::BOOL);
...
pub unsafe fn AuthzModifyClaims(
    ...
    pclaimoperations: *const AUTHZ_SECURITY_ATTRIBUTE_OPERATION,
    pclaims: Option<*const AUTHZ_SECURITY_ATTRIBUTES_INFORMATION>,
) -> windows_core::Result<()> {
    windows_link::link!("authz.dll" "system" fn AuthzModifyClaims(hauthzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE, claimclass : AUTHZ_CONTEXT_INFORMATION_CLASS, pclaimoperations : *const AUTHZ_SECURITY_ATTRIBUTE_OPERATION, pclaims : *const AUTHZ_SECURITY_ATTRIBUTES_INFORMATION) -> windows_core::BOOL);
    unsafe {
        AuthzModifyClaims(
            hauthzclientcontext,
            claimclass,
            pclaimoperations,
            pclaims.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn AuthzModifySecurityAttributes(
    hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE,
    poperations: *const AUTHZ_SECURITY_ATTRIBUTE_OPERATION,
    pattributes: Option<*const AUTHZ_SECURITY_ATTRIBUTES_INFORMATION>,
) -> windows_core::Result<()> {
    windows_link::link!("authz.dll" "system" fn AuthzModifySecurityAttributes(hauthzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE, poperations : *const AUTHZ_SECURITY_ATTRIBUTE_OPERATION, pattributes : *const AUTHZ_SECURITY_ATTRIBUTES_INFORMATION) -> windows_core::BOOL);
    unsafe {
...
pub unsafe fn AuthzModifySids(
    ...
    psidoperations: *const AUTHZ_SID_OPERATION,
    psids: Option<*const super::TOKEN_GROUPS>,
) -> windows_core::Result<()> {
    windows_link::link!("authz.dll" "system" fn AuthzModifySids(hauthzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE, sidclass : AUTHZ_CONTEXT_INFORMATION_CLASS, psidoperations : *const AUTHZ_SID_OPERATION, psids : *const super:: TOKEN_GROUPS) -> windows_core::BOOL);
    unsafe {
        AuthzModifySids(
            hauthzclientcontext,
            sidclass,
            psidoperations,
            psids.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn AuthzRegisterCapChangeNotification(
    ...
    pfncapchangecallback: super::super::System::Threading::LPTHREAD_START_ROUTINE,
    pcallbackcontext: Option<*const core::ffi::c_void>,
) -> windows_core::Result<()> {
    windows_link::link!("authz.dll" "system" fn AuthzRegisterCapChangeNotification(phcapchangesubscription : *mut AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE, pfncapchangecallback : super::super::System::Threading:: LPTHREAD_START_ROUTINE, pcallbackcontext : *const core::ffi::c_void) -> windows_core::BOOL);
    unsafe {
        AuthzRegisterCapChangeNotification(
            phcapchangesubscription as _,
            pfncapchangecallback,
            pcallbackcontext.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
{
    windows_link::link!("authz.dll" "system" fn AuthzRegisterSecurityEventSource(dwflags : u32, szeventsourcename : windows_core::PCWSTR, pheventprovider : *mut AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE) -> windows_core::BOOL);
    unsafe {
        AuthzRegisterSecurityEventSource(
            dwflags,
            szeventsourcename.param().abi(),
            pheventprovider as _,
        )
        .ok()
    }
}
...
pub unsafe fn AuthzReportSecurityEvent(
    ...
    dwauditid: u32,
    pusersid: Option<super::PSID>,
    dwcount: u32,
) -> windows_core::Result<()> {
    windows_link::link!("authz.dll" "C" fn AuthzReportSecurityEvent(dwflags : u32, heventprovider : AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE, dwauditid : u32, pusersid : super:: PSID, dwcount : u32) -> windows_core::BOOL);
    unsafe {
        AuthzReportSecurityEvent(
            dwflags,
            heventprovider as _,
            dwauditid,
            pusersid.unwrap_or(core::mem::zeroed()) as _,
            dwcount,
        )
        .ok()
    }
...
pub unsafe fn AuthzReportSecurityEventFromParams(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzReportSecurityEventFromParams(dwflags : u32, heventprovider : AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE, dwauditid : u32, pusersid : super:: PSID, pparams : *const AUDIT_PARAMS) -> windows_core::BOOL);
    unsafe {
...
pub unsafe fn AuthzSetAppContainerInformation(
    hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE,
    pappcontainersid: super::PSID,
    pcapabilitysids: Option<&[super::SID_AND_ATTRIBUTES]>,
) -> windows_core::Result<()> {
    windows_link::link!("authz.dll" "system" fn AuthzSetAppContainerInformation(hauthzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE, pappcontainersid : super:: PSID, capabilitycount : u32, pcapabilitysids : *const super:: SID_AND_ATTRIBUTES) -> windows_core::BOOL);
    unsafe {
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("authz.dll" "system" fn AuthzUninstallSecurityEventSource(dwflags : u32, szeventsourcename : windows_core::PCWSTR) -> windows_core::BOOL);
...
pub unsafe fn AuthzUnregisterCapChangeNotification(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzUnregisterCapChangeNotification(hcapchangesubscription : AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE) -> windows_core::BOOL);
...
pub unsafe fn AuthzUnregisterSecurityEventSource(
    ...
    windows_link::link!("authz.dll" "system" fn AuthzUnregisterSecurityEventSource(dwflags : u32, pheventprovider : *mut AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE) -> windows_core::BOOL);
    unsafe { AuthzUnregisterSecurityEventSource(dwflags, pheventprovider as _).ok() }
}
#[inline]
pub unsafe fn BuildExplicitAccessWithNameA<P1>(
    pexplicitaccess: *mut EXPLICIT_ACCESS_A,
    ptrusteename: P1,
    accesspermissions: u32,
    accessmode: ACCESS_MODE,
    inheritance: super::ACE_FLAGS,
) where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn BuildExplicitAccessWithNameA(pexplicitaccess : *mut EXPLICIT_ACCESS_A, ptrusteename : windows_core::PCSTR, accesspermissions : u32, accessmode : ACCESS_MODE, inheritance : super:: ACE_FLAGS));
    unsafe {
        BuildExplicitAccessWithNameA(
            pexplicitaccess as _,
            ptrusteename.param().abi(),
            accesspermissions,
            accessmode,
            inheritance,
        )
...
#[inline]
pub unsafe fn BuildExplicitAccessWithNameW<P1>(
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn BuildExplicitAccessWithNameW(pexplicitaccess : *mut EXPLICIT_ACCESS_W, ptrusteename : windows_core::PCWSTR, accesspermissions : u32, accessmode : ACCESS_MODE, inheritance : super:: ACE_FLAGS));
    unsafe {
...
#[inline]
pub unsafe fn BuildImpersonateExplicitAccessWithNameA<P1>(
    pexplicitaccess: *mut EXPLICIT_ACCESS_A,
    ptrusteename: P1,
    ptrustee: Option<*const TRUSTEE_A>,
    accesspermissions: u32,
    accessmode: ACCESS_MODE,
    inheritance: u32,
) where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn BuildImpersonateExplicitAccessWithNameA(pexplicitaccess : *mut EXPLICIT_ACCESS_A, ptrusteename : windows_core::PCSTR, ptrustee : *const TRUSTEE_A, accesspermissions : u32, accessmode : ACCESS_MODE, inheritance : u32));
    unsafe {
        BuildImpersonateExplicitAccessWithNameA(
            pexplicitaccess as _,
            ptrusteename.param().abi(),
            ptrustee.unwrap_or(core::mem::zeroed()) as _,
            accesspermissions,
            accessmode,
            inheritance,
        )
...
#[inline]
pub unsafe fn BuildImpersonateExplicitAccessWithNameW<P1>(
    pexplicitaccess: *mut EXPLICIT_ACCESS_W,
    ptrusteename: P1,
    ptrustee: Option<*const TRUSTEE_W>,
    accesspermissions: u32,
    accessmode: ACCESS_MODE,
    inheritance: u32,
) where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn BuildImpersonateExplicitAccessWithNameW(pexplicitaccess : *mut EXPLICIT_ACCESS_W, ptrusteename : windows_core::PCWSTR, ptrustee : *const TRUSTEE_W, accesspermissions : u32, accessmode : ACCESS_MODE, inheritance : u32));
    unsafe {
...
pub unsafe fn BuildImpersonateTrusteeA(
    ...
    pimpersonatetrustee: Option<*const TRUSTEE_A>,
) {
    ...
    unsafe {
        BuildImpersonateTrusteeA(
            ptrustee as _,
            pimpersonatetrustee.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn BuildImpersonateTrusteeW(
    ...
    pimpersonatetrustee: Option<*const TRUSTEE_W>,
) {
...
pub unsafe fn BuildSecurityDescriptorA(
    powner: Option<*const TRUSTEE_A>,
    pgroup: Option<*const TRUSTEE_A>,
    plistofaccessentries: Option<&[EXPLICIT_ACCESS_A]>,
    plistofauditentries: Option<&[EXPLICIT_ACCESS_A]>,
    poldsd: Option<super::PSECURITY_DESCRIPTOR>,
    psizenewsd: *mut u32,
    pnewsd: *mut super::PSECURITY_DESCRIPTOR,
...
pub unsafe fn BuildSecurityDescriptorW(
    powner: Option<*const TRUSTEE_W>,
    pgroup: Option<*const TRUSTEE_W>,
    plistofaccessentries: Option<&[EXPLICIT_ACCESS_W]>,
    plistofauditentries: Option<&[EXPLICIT_ACCESS_W]>,
    poldsd: Option<super::PSECURITY_DESCRIPTOR>,
    psizenewsd: *mut u32,
    pnewsd: *mut super::PSECURITY_DESCRIPTOR,
) -> super::super::Foundation::WIN32_ERROR {
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn BuildTrusteeWithNameA(ptrustee : *mut TRUSTEE_A, pname : windows_core::PCSTR));
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn BuildTrusteeWithNameW(ptrustee : *mut TRUSTEE_W, pname : windows_core::PCWSTR));
...
{
    windows_link::link!("advapi32.dll" "system" fn BuildTrusteeWithObjectsAndNameA(ptrustee : *mut TRUSTEE_A, pobjname : *const OBJECTS_AND_NAME_A, objecttype : SE_OBJECT_TYPE, objecttypename : windows_core::PCSTR, inheritedobjecttypename : windows_core::PCSTR, name : windows_core::PCSTR));
    unsafe {
        BuildTrusteeWithObjectsAndNameA(
            ptrustee as _,
            pobjname.unwrap_or(core::mem::zeroed()) as _,
            objecttype.unwrap_or(core::mem::zeroed()) as _,
            objecttypename.param().abi(),
            inheritedobjecttypename.param().abi(),
            name.param().abi(),
        )
    }
}
...
pub unsafe fn BuildTrusteeWithObjectsAndNameW<P3, P4, P5>(
    ...
    P5: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn BuildTrusteeWithObjectsAndNameW(ptrustee : *mut TRUSTEE_W, pobjname : *const OBJECTS_AND_NAME_W, objecttype : SE_OBJECT_TYPE, objecttypename : windows_core::PCWSTR, inheritedobjecttypename : windows_core::PCWSTR, name : windows_core::PCWSTR));
    unsafe {
...
pub unsafe fn BuildTrusteeWithObjectsAndSidA(
    ptrustee: *mut TRUSTEE_A,
    pobjsid: Option<*const OBJECTS_AND_SID>,
    pobjectguid: Option<*const windows_core::GUID>,
    pinheritedobjectguid: Option<*const windows_core::GUID>,
    psid: Option<super::PSID>,
) {
    windows_link::link!("advapi32.dll" "system" fn BuildTrusteeWithObjectsAndSidA(ptrustee : *mut TRUSTEE_A, pobjsid : *const OBJECTS_AND_SID, pobjectguid : *const windows_core::GUID, pinheritedobjectguid : *const windows_core::GUID, psid : super:: PSID));
    unsafe {
        BuildTrusteeWithObjectsAndSidA(
            ptrustee as _,
            pobjsid.unwrap_or(core::mem::zeroed()) as _,
            pobjectguid.unwrap_or(core::mem::zeroed()) as _,
            pinheritedobjectguid.unwrap_or(core::mem::zeroed()) as _,
            psid.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn BuildTrusteeWithObjectsAndSidW(
    ...
    windows_link::link!("advapi32.dll" "system" fn BuildTrusteeWithObjectsAndSidW(ptrustee : *mut TRUSTEE_W, pobjsid : *const OBJECTS_AND_SID, pobjectguid : *const windows_core::GUID, pinheritedobjectguid : *const windows_core::GUID, psid : super:: PSID));
    unsafe {
...
pub unsafe fn ConvertSecurityDescriptorToStringSecurityDescriptorA(
    ...
    securityinformation: super::OBJECT_SECURITY_INFORMATION,
    stringsecuritydescriptor: *mut windows_core::PSTR,
    stringsecuritydescriptorlen: Option<*mut u32>,
) -> windows_core::Result<()> {
    ...
    unsafe {
        ConvertSecurityDescriptorToStringSecurityDescriptorA(
            ...
            requestedstringsdrevision,
            securityinformation,
            stringsecuritydescriptor as _,
            stringsecuritydescriptorlen.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn ConvertSecurityDescriptorToStringSecurityDescriptorW(
    ...
    requestedstringsdrevision: u32,
    securityinformation: super::OBJECT_SECURITY_INFORMATION,
    stringsecuritydescriptor: *mut windows_core::PWSTR,
    stringsecuritydescriptorlen: Option<*mut u32>,
) -> windows_core::Result<()> {
...
pub unsafe fn ConvertSidToStringSidA(
    sid: super::PSID,
    stringsid: *mut windows_core::PSTR,
) -> windows_core::Result<()> {
    windows_link::link!("advapi32.dll" "system" fn ConvertSidToStringSidA(sid : super:: PSID, stringsid : *mut windows_core::PSTR) -> windows_core::BOOL);
...
pub unsafe fn ConvertSidToStringSidW(
    ...
    windows_link::link!("advapi32.dll" "system" fn ConvertSidToStringSidW(sid : super:: PSID, stringsid : *mut windows_core::PWSTR) -> windows_core::BOOL);
    unsafe { ConvertSidToStringSidW(sid, stringsid as _).ok() }
}
#[inline]
pub unsafe fn ConvertStringSecurityDescriptorToSecurityDescriptorA<P0>(
    stringsecuritydescriptor: P0,
    stringsdrevision: u32,
    securitydescriptor: *mut super::PSECURITY_DESCRIPTOR,
    securitydescriptorsize: Option<*mut u32>,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn ConvertStringSecurityDescriptorToSecurityDescriptorA(stringsecuritydescriptor : windows_core::PCSTR, stringsdrevision : u32, securitydescriptor : *mut super:: PSECURITY_DESCRIPTOR, securitydescriptorsize : *mut u32) -> windows_core::BOOL);
    unsafe {
...
{
    windows_link::link!("advapi32.dll" "system" fn ConvertStringSecurityDescriptorToSecurityDescriptorW(stringsecuritydescriptor : windows_core::PCWSTR, stringsdrevision : u32, securitydescriptor : *mut super:: PSECURITY_DESCRIPTOR, securitydescriptorsize : *mut u32) -> windows_core::BOOL);
    unsafe {
...
#[inline]
pub unsafe fn ConvertStringSidToSidA<P0>(
    stringsid: P0,
    sid: *mut super::PSID,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn ConvertStringSidToSidA(stringsid : windows_core::PCSTR, sid : *mut super:: PSID) -> windows_core::BOOL);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn ConvertStringSidToSidW(stringsid : windows_core::PCWSTR, sid : *mut super:: PSID) -> windows_core::BOOL);
...
pub unsafe fn FreeInheritedFromArray(
    ...
    unsafe {
        FreeInheritedFromArray(
            core::mem::transmute(pinheritarray.as_ptr()),
            pinheritarray.len().try_into().unwrap(),
            pfnarray.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn GetAuditedPermissionsFromAclA(
    ...
    psuccessfulauditedrights: *mut u32,
    pfailedauditrights: *mut u32,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        GetAuditedPermissionsFromAclA(
            pacl,
            ptrustee,
            psuccessfulauditedrights as _,
            pfailedauditrights as _,
        )
    }
}
#[inline]
...
pub unsafe fn GetExplicitEntriesFromAclA(
    ...
    plistofexplicitentries: *mut *mut EXPLICIT_ACCESS_A,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        GetExplicitEntriesFromAclA(
            pacl,
            pccountofexplicitentries as _,
            plistofexplicitentries as _,
        )
    }
}
#[inline]
...
pub unsafe fn GetInheritanceSourceA<P0>(
    ...
    securityinfo: super::OBJECT_SECURITY_INFORMATION,
    container: bool,
    pobjectclassguids: Option<&[*const windows_core::GUID]>,
    pacl: *const super::ACL,
    pfnarray: Option<*const FN_OBJECT_MGR_FUNCTS>,
...
#[inline]
pub unsafe fn GetInheritanceSourceW<P0>(
    pobjectname: P0,
    objecttype: SE_OBJECT_TYPE,
    securityinfo: super::OBJECT_SECURITY_INFORMATION,
    container: bool,
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn GetInheritanceSourceW(pobjectname : windows_core::PCWSTR, objecttype : SE_OBJECT_TYPE, securityinfo : super:: OBJECT_SECURITY_INFORMATION, container : windows_core::BOOL, pobjectclassguids : *const *const windows_core::GUID, guidcount : u32, pacl : *const super:: ACL, pfnarray : *const FN_OBJECT_MGR_FUNCTS, pgenericmapping : *const super:: GENERIC_MAPPING, pinheritarray : *mut INHERITED_FROMW) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
...
#[inline]
pub unsafe fn GetNamedSecurityInfoA<P0>(
    pobjectname: P0,
    objecttype: SE_OBJECT_TYPE,
    securityinfo: super::OBJECT_SECURITY_INFORMATION,
    ppsidowner: Option<*mut super::PSID>,
    ppsidgroup: Option<*mut super::PSID>,
    ppdacl: Option<*mut *mut super::ACL>,
    ppsacl: Option<*mut *mut super::ACL>,
    ppsecuritydescriptor: *mut super::PSECURITY_DESCRIPTOR,
) -> super::super::Foundation::WIN32_ERROR
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn GetNamedSecurityInfoA(pobjectname : windows_core::PCSTR, objecttype : SE_OBJECT_TYPE, securityinfo : super:: OBJECT_SECURITY_INFORMATION, ppsidowner : *mut super:: PSID, ppsidgroup : *mut super:: PSID, ppdacl : *mut *mut super:: ACL, ppsacl : *mut *mut super:: ACL, ppsecuritydescriptor : *mut super:: PSECURITY_DESCRIPTOR) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
...
pub unsafe fn GetSecurityInfo(
    ...
    ppdacl: Option<*mut *mut super::ACL>,
    ppsacl: Option<*mut *mut super::ACL>,
    ppsecuritydescriptor: Option<*mut super::PSECURITY_DESCRIPTOR>,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        GetSecurityInfo(
            ...
            ppdacl.unwrap_or(core::mem::zeroed()) as _,
            ppsacl.unwrap_or(core::mem::zeroed()) as _,
            ppsecuritydescriptor.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
pub unsafe fn GetTrusteeNameA(ptrustee: *const TRUSTEE_A) -> windows_core::PSTR {
    windows_link::link!("advapi32.dll" "system" fn GetTrusteeNameA(ptrustee : *const TRUSTEE_A) -> windows_core::PSTR);
    unsafe { GetTrusteeNameA(ptrustee) }
}
#[inline]
pub unsafe fn GetTrusteeNameW(ptrustee: *const TRUSTEE_W) -> windows_core::PWSTR {
    windows_link::link!("advapi32.dll" "system" fn GetTrusteeNameW(ptrustee : *const TRUSTEE_W) -> windows_core::PWSTR);
...
pub unsafe fn LookupSecurityDescriptorPartsA(
    ppowner: Option<*mut *mut TRUSTEE_A>,
    ppgroup: Option<*mut *mut TRUSTEE_A>,
    pccountofaccessentries: Option<*mut u32>,
    pplistofaccessentries: *mut *mut EXPLICIT_ACCESS_A,
    pccountofauditentries: Option<*mut u32>,
    pplistofauditentries: *mut *mut EXPLICIT_ACCESS_A,
    psd: super::PSECURITY_DESCRIPTOR,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        LookupSecurityDescriptorPartsA(
            ppowner.unwrap_or(core::mem::zeroed()) as _,
            ppgroup.unwrap_or(core::mem::zeroed()) as _,
            pccountofaccessentries.unwrap_or(core::mem::zeroed()) as _,
            pplistofaccessentries as _,
            pccountofauditentries.unwrap_or(core::mem::zeroed()) as _,
            pplistofauditentries as _,
            psd,
        )
    }
}
...
pub unsafe fn LookupSecurityDescriptorPartsW(
    ppowner: Option<*mut *mut TRUSTEE_W>,
    ppgroup: Option<*mut *mut TRUSTEE_W>,
    pccountofaccessentries: Option<*mut u32>,
    pplistofaccessentries: *mut *mut EXPLICIT_ACCESS_W,
    pccountofauditentries: Option<*mut u32>,
    pplistofauditentries: *mut *mut EXPLICIT_ACCESS_W,
    psd: super::PSECURITY_DESCRIPTOR,
) -> super::super::Foundation::WIN32_ERROR {
...
pub unsafe fn SetEntriesInAclA(
    plistofexplicitentries: Option<&[EXPLICIT_ACCESS_A]>,
    oldacl: Option<*const super::ACL>,
    newacl: *mut *mut super::ACL,
) -> super::super::Foundation::WIN32_ERROR {
    ...
    unsafe {
        SetEntriesInAclA(
            ...
            oldacl.unwrap_or(core::mem::zeroed()) as _,
            newacl as _,
        )
    }
}
...
pub unsafe fn SetEntriesInAclW(
    plistofexplicitentries: Option<&[EXPLICIT_ACCESS_W]>,
    oldacl: Option<*const super::ACL>,
    newacl: *mut *mut super::ACL,
) -> super::super::Foundation::WIN32_ERROR {
...
#[inline]
pub unsafe fn SetNamedSecurityInfoA<P0>(
    pobjectname: P0,
    objecttype: SE_OBJECT_TYPE,
    securityinfo: super::OBJECT_SECURITY_INFORMATION,
    psidowner: Option<super::PSID>,
    psidgroup: Option<super::PSID>,
    pdacl: Option<*const super::ACL>,
    psacl: Option<*const super::ACL>,
) -> super::super::Foundation::WIN32_ERROR
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn SetNamedSecurityInfoA(pobjectname : windows_core::PCSTR, objecttype : SE_OBJECT_TYPE, securityinfo : super:: OBJECT_SECURITY_INFORMATION, psidowner : super:: PSID, psidgroup : super:: PSID, pdacl : *const super:: ACL, psacl : *const super:: ACL) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn SetNamedSecurityInfoW(pobjectname : windows_core::PCWSTR, objecttype : SE_OBJECT_TYPE, securityinfo : super:: OBJECT_SECURITY_INFORMATION, psidowner : super:: PSID, psidgroup : super:: PSID, pdacl : *const super:: ACL, psacl : *const super:: ACL) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
...
#[inline]
pub unsafe fn TreeResetNamedSecurityInfoA<P0>(
    pobjectname: P0,
    objecttype: SE_OBJECT_TYPE,
    securityinfo: super::OBJECT_SECURITY_INFORMATION,
    powner: Option<super::PSID>,
    pgroup: Option<super::PSID>,
    pdacl: Option<*const super::ACL>,
    psacl: Option<*const super::ACL>,
    keepexplicit: bool,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        TreeResetNamedSecurityInfoA(
            ...
            args.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("advapi32.dll" "system" fn TreeResetNamedSecurityInfoW(pobjectname : windows_core::PCWSTR, objecttype : SE_OBJECT_TYPE, securityinfo : super:: OBJECT_SECURITY_INFORMATION, powner : super:: PSID, pgroup : super:: PSID, pdacl : *const super:: ACL, psacl : *const super:: ACL, keepexplicit : windows_core::BOOL, fnprogress : FN_PROGRESS, progressinvokesetting : PROG_INVOKE_SETTING, args : *const core::ffi::c_void) -> super::super::Foundation:: WIN32_ERROR);
    unsafe {
...
#[inline]
pub unsafe fn TreeSetNamedSecurityInfoA<P0>(
    pobjectname: P0,
    objecttype: SE_OBJECT_TYPE,
    securityinfo: super::OBJECT_SECURITY_INFORMATION,
    powner: Option<super::PSID>,
...
#[inline]
pub unsafe fn TreeSetNamedSecurityInfoW<P0>(
    pobjectname: P0,
    objecttype: SE_OBJECT_TYPE,
    securityinfo: super::OBJECT_SECURITY_INFORMATION,
    powner: Option<super::PSID>,
...
pub const ACCCTRL_DEFAULT_PROVIDER: windows_core::PCWSTR =
    windows_core::w!("Windows NT Access Provider");
pub const ACCCTRL_DEFAULT_PROVIDERA: windows_core::PCSTR =
    windows_core::s!("Windows NT Access Provider");
pub const ACCCTRL_DEFAULT_PROVIDERW: windows_core::PCWSTR =
    windows_core::w!("Windows NT Access Provider");
#[repr(transparent)]
...
pub const ACTRL_ACCESS_ALLOWED: ACTRL_ACCESS_ENTRY_ACCESS_FLAGS =
    ACTRL_ACCESS_ENTRY_ACCESS_FLAGS(1u32);
pub const ACTRL_ACCESS_DENIED: ACTRL_ACCESS_ENTRY_ACCESS_FLAGS =
    ACTRL_ACCESS_ENTRY_ACCESS_FLAGS(2u32);
#[repr(C)]
...
pub const ACTRL_AUDIT_FAILURE: ACTRL_ACCESS_ENTRY_ACCESS_FLAGS =
    ACTRL_ACCESS_ENTRY_ACCESS_FLAGS(8u32);
pub const ACTRL_AUDIT_SUCCESS: ACTRL_ACCESS_ENTRY_ACCESS_FLAGS =
    ACTRL_ACCESS_ENTRY_ACCESS_FLAGS(4u32);
...
pub const AUTHZ_ACCESS_CHECK_NO_DEEP_COPY_SD: AUTHZ_ACCESS_CHECK_FLAGS =
    AUTHZ_ACCESS_CHECK_FLAGS(1u32);
#[repr(transparent)]
...
impl windows_core::Free for AUTHZ_ACCESS_CHECK_RESULTS_HANDLE {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("authz.dll" "system" fn AuthzFreeHandle(haccesscheckresults : *mut core::ffi::c_void) -> i32);
            unsafe {
...
impl windows_core::Free for AUTHZ_AUDIT_EVENT_HANDLE {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("authz.dll" "system" fn AuthzFreeAuditEvent(hauditevent : *mut core::ffi::c_void) -> i32);
            unsafe {
...
impl windows_core::Free for AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("authz.dll" "system" fn AuthzUnregisterCapChangeNotification(hcapchangesubscription : *mut core::ffi::c_void) -> i32);
            unsafe {
...
impl windows_core::Free for AUTHZ_CLIENT_CONTEXT_HANDLE {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("authz.dll" "system" fn AuthzFreeContext(hauthzclientcontext : *mut core::ffi::c_void) -> i32);
            unsafe {
...
pub const AUTHZ_NO_ALLOC_STRINGS: AUTHZ_INITIALIZE_OBJECT_ACCESS_AUDIT_EVENT_FLAGS =
    AUTHZ_INITIALIZE_OBJECT_ACCESS_AUDIT_EVENT_FLAGS(4u32);
pub const AUTHZ_NO_FAILURE_AUDIT: AUTHZ_INITIALIZE_OBJECT_ACCESS_AUDIT_EVENT_FLAGS =
    AUTHZ_INITIALIZE_OBJECT_ACCESS_AUDIT_EVENT_FLAGS(2u32);
pub const AUTHZ_NO_SUCCESS_AUDIT: AUTHZ_INITIALIZE_OBJECT_ACCESS_AUDIT_EVENT_FLAGS =
    AUTHZ_INITIALIZE_OBJECT_ACCESS_AUDIT_EVENT_FLAGS(1u32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
impl windows_core::Free for AUTHZ_RESOURCE_MANAGER_HANDLE {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("authz.dll" "system" fn AuthzFreeResourceManager(hauthzresourcemanager : *mut core::ffi::c_void) -> i32);
            unsafe {
...
pub const AUTHZ_RM_FLAG_INITIALIZE_UNDER_IMPERSONATION: AUTHZ_RESOURCE_MANAGER_FLAGS =
    AUTHZ_RESOURCE_MANAGER_FLAGS(2u32);
pub const AUTHZ_RM_FLAG_NO_AUDIT: AUTHZ_RESOURCE_MANAGER_FLAGS = AUTHZ_RESOURCE_MANAGER_FLAGS(1u32);
pub const AUTHZ_RM_FLAG_NO_CENTRAL_ACCESS_POLICIES: AUTHZ_RESOURCE_MANAGER_FLAGS =
    AUTHZ_RESOURCE_MANAGER_FLAGS(4u32);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AUTHZ_SECURITY_ATTRIBUTE_NON_INHERITABLE: AUTHZ_SECURITY_ATTRIBUTE_FLAGS =
    AUTHZ_SECURITY_ATTRIBUTE_FLAGS(1u32);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const AUTHZ_SECURITY_ATTRIBUTE_OPERATION_ADD: AUTHZ_SECURITY_ATTRIBUTE_OPERATION =
    AUTHZ_SECURITY_ATTRIBUTE_OPERATION(2i32);
pub const AUTHZ_SECURITY_ATTRIBUTE_OPERATION_DELETE: AUTHZ_SECURITY_ATTRIBUTE_OPERATION =
    AUTHZ_SECURITY_ATTRIBUTE_OPERATION(3i32);
pub const AUTHZ_SECURITY_ATTRIBUTE_OPERATION_NONE: AUTHZ_SECURITY_ATTRIBUTE_OPERATION =
    AUTHZ_SECURITY_ATTRIBUTE_OPERATION(0i32);
pub const AUTHZ_SECURITY_ATTRIBUTE_OPERATION_REPLACE: AUTHZ_SECURITY_ATTRIBUTE_OPERATION =
    AUTHZ_SECURITY_ATTRIBUTE_OPERATION(4i32);
pub const AUTHZ_SECURITY_ATTRIBUTE_OPERATION_REPLACE_ALL: AUTHZ_SECURITY_ATTRIBUTE_OPERATION =
    AUTHZ_SECURITY_ATTRIBUTE_OPERATION(1i32);
...
pub const AUTHZ_SECURITY_ATTRIBUTE_VALUE_CASE_SENSITIVE: AUTHZ_SECURITY_ATTRIBUTE_FLAGS =
    AUTHZ_SECURITY_ATTRIBUTE_FLAGS(2u32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub const AZ_AZSTORE_FLAG_MANAGE_ONLY_PASSIVE_SUBMIT: AZ_PROP_CONSTANTS =
    AZ_PROP_CONSTANTS(32768i32);
...
pub const AZ_CLIENT_CONTEXT_GET_GROUPS_STORE_LEVEL_ONLY: AZ_PROP_CONSTANTS =
...
pub const AZ_PROP_CLIENT_CONTEXT_ROLE_FOR_ACCESS_CHECK: AZ_PROP_CONSTANTS =
    AZ_PROP_CONSTANTS(708i32);
...
pub const AuthzAuditEventInfoAdditionalInfo: AUTHZ_AUDIT_EVENT_INFORMATION_CLASS =
    AUTHZ_AUDIT_EVENT_INFORMATION_CLASS(5i32);
pub const AuthzAuditEventInfoFlags: AUTHZ_AUDIT_EVENT_INFORMATION_CLASS =
    AUTHZ_AUDIT_EVENT_INFORMATION_CLASS(1i32);
pub const AuthzAuditEventInfoObjectName: AUTHZ_AUDIT_EVENT_INFORMATION_CLASS =
    AUTHZ_AUDIT_EVENT_INFORMATION_CLASS(4i32);
pub const AuthzAuditEventInfoObjectType: AUTHZ_AUDIT_EVENT_INFORMATION_CLASS =
    AUTHZ_AUDIT_EVENT_INFORMATION_CLASS(3i32);
pub const AuthzAuditEventInfoOperationType: AUTHZ_AUDIT_EVENT_INFORMATION_CLASS =
    AUTHZ_AUDIT_EVENT_INFORMATION_CLASS(2i32);
pub const AuthzContextInfoAll: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(9i32);
pub const AuthzContextInfoAppContainerSid: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(15i32);
pub const AuthzContextInfoAuthenticationId: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(10i32);
pub const AuthzContextInfoCapabilitySids: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(16i32);
pub const AuthzContextInfoDeviceClaims: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(14i32);
pub const AuthzContextInfoDeviceSids: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(12i32);
pub const AuthzContextInfoExpirationTime: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(5i32);
pub const AuthzContextInfoGroupsSids: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(2i32);
pub const AuthzContextInfoIdentifier: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(7i32);
pub const AuthzContextInfoPrivileges: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(4i32);
pub const AuthzContextInfoRestrictedSids: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(3i32);
pub const AuthzContextInfoSecurityAttributes: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(11i32);
pub const AuthzContextInfoServerContext: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(6i32);
pub const AuthzContextInfoSource: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(8i32);
pub const AuthzContextInfoUserClaims: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(13i32);
pub const AuthzContextInfoUserSid: AUTHZ_CONTEXT_INFORMATION_CLASS =
    AUTHZ_CONTEXT_INFORMATION_CLASS(1i32);
pub const AzAuthorizationStore: windows_core::GUID =
    windows_core::GUID::from_u128(0xb2bcff59_a757_4b0b_a1bc_ea69981da69e);
pub const AzBizRuleContext: windows_core::GUID =
    windows_core::GUID::from_u128(0x5c2dc96f_8d51_434b_b33c_379bccae77c3);
pub const AzPrincipalLocator: windows_core::GUID =
    windows_core::GUID::from_u128(0x483afb5d_70df_4e16_abdc_a1de4d015a3e);
...
pub type FN_PROGRESS = Option<
    unsafe extern "system" fn(
        pobjectname: windows_core::PCWSTR,
        status: u32,
        pinvokesetting: *mut PROG_INVOKE_SETTING,
        args: *const core::ffi::c_void,
        securityset: windows_core::BOOL,
    ),
>;
...
impl IAzApplication {
    ...
    pub unsafe fn SetDescription(
        &self,
        bstrdescription: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDescription)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrdescription),
            )
            .ok()
        }
    }
    pub unsafe fn ApplicationData(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ApplicationData)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetApplicationData(
        &self,
        bstrapplicationdata: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetApplicationData)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrapplicationdata),
            )
            .ok()
        }
    }
    pub unsafe fn AuthzInterfaceClsid(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AuthzInterfaceClsid)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetAuthzInterfaceClsid(
        &self,
        bstrprop: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAuthzInterfaceClsid)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn GenerateAudits(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GenerateAudits)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetGenerateAudits(&self, bprop: bool) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetGenerateAudits)(
                windows_core::Interface::as_raw(self),
                bprop.into(),
            )
            .ok()
    ...
    pub unsafe fn ApplyStoreSacl(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ApplyStoreSacl)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetApplyStoreSacl(&self, bprop: bool) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetApplyStoreSacl)(
                windows_core::Interface::as_raw(self),
                bprop.into(),
            )
            .ok()
    ...
    pub unsafe fn Writable(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Writable)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetProperty(
        &self,
        lpropid: i32,
        varreserved: &super::super::System::Variant::VARIANT,
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(self).GetProperty)(
                windows_core::Interface::as_raw(self),
                lpropid,
                core::mem::transmute_copy(varreserved),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
        }
    ...
    pub unsafe fn SetProperty(
        &self,
        lpropid: i32,
        varprop: &super::super::System::Variant::VARIANT,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetProperty)(
                windows_core::Interface::as_raw(self),
                lpropid,
                core::mem::transmute_copy(varprop),
                core::mem::transmute_copy(varreserved),
            )
            .ok()
        }
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn PolicyAdministrators(
        &self,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PolicyAdministrators)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn PolicyReaders(
        &self,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PolicyReaders)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddPolicyAdministrator(
        &self,
        bstradmin: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddPolicyAdministrator)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstradmin),
                core::mem::transmute_copy(varreserved),
            )
            .ok()
        }
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeletePolicyAdministrator(
        &self,
        bstradmin: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeletePolicyAdministrator)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstradmin),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddPolicyReader(
        &self,
        bstrreader: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddPolicyReader)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrreader),
                core::mem::transmute_copy(varreserved),
            )
            .ok()
        }
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeletePolicyReader(
        &self,
        bstrreader: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeletePolicyReader)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrreader),
                core::mem::transmute_copy(varreserved),
            )
    ...
    pub unsafe fn Scopes(&self) -> windows_core::Result<IAzScopes> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Scopes)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
    ...
    pub unsafe fn OpenScope(
        &self,
        bstrscopename: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzScope> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenScope)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrscopename),
                core::mem::transmute_copy(varreserved),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn CreateScope(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateScope)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrscopename),
                core::mem::transmute_copy(varreserved),
                &mut result__,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeleteScope(
        &self,
        bstrscopename: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteScope)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrscopename),
                core::mem::transmute_copy(varreserved),
            )
    ...
    pub unsafe fn Operations(&self) -> windows_core::Result<IAzOperations> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Operations)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn OpenOperation(
        &self,
        bstroperationname: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzOperation> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenOperation)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstroperationname),
                core::mem::transmute_copy(varreserved),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn CreateOperation(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateOperation)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstroperationname),
                core::mem::transmute_copy(varreserved),
                &mut result__,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeleteOperation(
        &self,
        bstroperationname: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteOperation)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstroperationname),
                core::mem::transmute_copy(varreserved),
            )
    ...
    pub unsafe fn Tasks(&self) -> windows_core::Result<IAzTasks> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Tasks)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn OpenTask(
        &self,
        bstrtaskname: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzTask> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenTask)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrtaskname),
                core::mem::transmute_copy(varreserved),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn CreateTask(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTask)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrtaskname),
                core::mem::transmute_copy(varreserved),
                &mut result__,
    ...
    pub unsafe fn DeleteTask(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DeleteTask)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrtaskname),
                core::mem::transmute_copy(varreserved),
            )
    ...
    pub unsafe fn ApplicationGroups(&self) -> windows_core::Result<IAzApplicationGroups> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ApplicationGroups)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn OpenApplicationGroup(
        &self,
        bstrgroupname: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzApplicationGroup> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenApplicationGroup)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrgroupname),
                core::mem::transmute_copy(varreserved),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn CreateApplicationGroup(
        &self,
        bstrgroupname: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzApplicationGroup> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateApplicationGroup)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrgroupname),
                core::mem::transmute_copy(varreserved),
                &mut result__,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeleteApplicationGroup(
        &self,
        bstrgroupname: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteApplicationGroup)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrgroupname),
                core::mem::transmute_copy(varreserved),
            )
    ...
    pub unsafe fn Roles(&self) -> windows_core::Result<IAzRoles> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Roles)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn OpenRole(
        &self,
        bstrrolename: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzRole> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenRole)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrrolename),
                core::mem::transmute_copy(varreserved),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn CreateRole(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateRole)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrrolename),
                core::mem::transmute_copy(varreserved),
                &mut result__,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeleteRole(
        &self,
        bstrrolename: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteRole)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrrolename),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn InitializeClientContextFromToken(
        &self,
        ulltokenhandle: u64,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzClientContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).InitializeClientContextFromToken)(
                windows_core::Interface::as_raw(self),
                ulltokenhandle,
                core::mem::transmute_copy(varreserved),
                &mut result__,
    ...
    pub unsafe fn AddPropertyItem(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AddPropertyItem)(
                windows_core::Interface::as_raw(self),
                lpropid,
                core::mem::transmute_copy(varprop),
                core::mem::transmute_copy(varreserved),
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeletePropertyItem(
        &self,
        lpropid: i32,
        varprop: &super::super::System::Variant::VARIANT,
        varreserved: &super::super::System::Variant::VARIANT,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DeletePropertyItem)(
                windows_core::Interface::as_raw(self),
                lpropid,
                core::mem::transmute_copy(varprop),
                core::mem::transmute_copy(varreserved),
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn InitializeClientContextFromName(
        &self,
        clientname: &windows_core::BSTR,
        domainname: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzClientContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).InitializeClientContextFromName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(clientname),
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DelegatedPolicyUsers(
        &self,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DelegatedPolicyUsers)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddDelegatedPolicyUser(
        &self,
        bstrdelegatedpolicyuser: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddDelegatedPolicyUser)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrdelegatedpolicyuser),
                core::mem::transmute_copy(varreserved),
            )
            .ok()
        }
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeleteDelegatedPolicyUser(
        &self,
        bstrdelegatedpolicyuser: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteDelegatedPolicyUser)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrdelegatedpolicyuser),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn InitializeClientContextFromStringSid(
        &self,
        sidstring: &windows_core::BSTR,
        loptions: i32,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzClientContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).InitializeClientContextFromStringSid)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(sidstring),
                loptions,
                core::mem::transmute_copy(varreserved),
                &mut result__,
            )
    ...
    pub unsafe fn PolicyAdministratorsName(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PolicyAdministratorsName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn PolicyReadersName(
        &self,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PolicyReadersName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddPolicyAdministratorName(
        &self,
        bstradmin: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddPolicyAdministratorName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstradmin),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeletePolicyAdministratorName(
        &self,
        bstradmin: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeletePolicyAdministratorName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstradmin),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddPolicyReaderName(
        &self,
        bstrreader: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddPolicyReaderName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrreader),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeletePolicyReaderName(
        &self,
        bstrreader: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeletePolicyReaderName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrreader),
                core::mem::transmute_copy(varreserved),
            )
    ...
    pub unsafe fn DelegatedPolicyUsersName(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DelegatedPolicyUsersName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddDelegatedPolicyUserName(
        &self,
        bstrdelegatedpolicyuser: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddDelegatedPolicyUserName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrdelegatedpolicyuser),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeleteDelegatedPolicyUserName(
        &self,
        bstrdelegatedpolicyuser: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteDelegatedPolicyUserName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrdelegatedpolicyuser),
                core::mem::transmute_copy(varreserved),
            )
...
pub struct IAzApplication_Vtbl {
    ...
    pub ApplicationData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetApplicationData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AuthzInterfaceClsid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetAuthzInterfaceClsid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GenerateAudits: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub SetGenerateAudits: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub ApplyStoreSacl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub SetApplyStoreSacl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub Writable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    ...
    SetProperty: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub PolicyAdministrators: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub PolicyReaders: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    PolicyReaders: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddPolicyAdministrator: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeletePolicyAdministrator: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddPolicyReader: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeletePolicyReader: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    pub Scopes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub OpenScope: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ...
    OpenScope: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub CreateScope: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ...
    CreateScope: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteScope: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    DeleteScope: usize,
    pub Operations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub OpenOperation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ...
    OpenOperation: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub CreateOperation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteOperation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    pub Tasks: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub OpenTask: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ...
    CreateTask: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteTask: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    DeleteTask: usize,
    pub ApplicationGroups: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub OpenApplicationGroup: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub CreateApplicationGroup: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteApplicationGroup: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    pub Roles: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub OpenRole: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ...
    OpenRole: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub CreateRole: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ...
    CreateRole: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteRole: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    DeleteRole: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub InitializeClientContextFromToken: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddPropertyItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        super::super::System::Variant::VARIANT,
        super::super::System::Variant::VARIANT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeletePropertyItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        super::super::System::Variant::VARIANT,
        super::super::System::Variant::VARIANT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub Submit: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    Submit: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub InitializeClientContextFromName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DelegatedPolicyUsers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddDelegatedPolicyUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteDelegatedPolicyUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub InitializeClientContextFromStringSid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        super::super::System::Variant::VARIANT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub PolicyAdministratorsName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub PolicyReadersName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddPolicyAdministratorName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeletePolicyAdministratorName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddPolicyReaderName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeletePolicyReaderName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DelegatedPolicyUsersName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddDelegatedPolicyUserName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteDelegatedPolicyUserName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
...
impl IAzApplication_Vtbl {
    pub const fn new<Identity: IAzApplication_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Name<Identity: IAzApplication_Impl, const OFFSET: isize>(
        ...
        unsafe extern "system" fn SetName<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        >(
            this: *mut core::ffi::c_void,
            bstrdescription: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::SetDescription(this, core::mem::transmute(&bstrdescription))
                    .into()
            }
        }
        unsafe extern "system" fn ApplicationData<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrapplicationdata: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetApplicationData<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrapplicationdata: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::SetApplicationData(
                    this,
                    core::mem::transmute(&bstrapplicationdata),
                )
                .into()
            }
        }
        unsafe extern "system" fn AuthzInterfaceClsid<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrprop: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetAuthzInterfaceClsid<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::SetAuthzInterfaceClsid(this, core::mem::transmute(&bstrprop))
                    .into()
            }
        }
        unsafe extern "system" fn Version<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrprop: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetVersion<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GenerateAudits<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbprop: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetGenerateAudits<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bprop: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::SetGenerateAudits(this, core::mem::transmute_copy(&bprop))
                    .into()
            }
        }
        unsafe extern "system" fn ApplyStoreSacl<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::SetApplyStoreSacl(this, core::mem::transmute_copy(&bprop))
                    .into()
            }
        }
        unsafe extern "system" fn Writable<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pfprop: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            lpropid: i32,
            varreserved: super::super::System::Variant::VARIANT,
            pvarprop: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::GetProperty(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varreserved),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::SetProperty(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varprop),
                    core::mem::transmute(&varreserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn PolicyAdministrators<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pvaradmins: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn PolicyReaders<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pvarreaders: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn AddPolicyAdministrator<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstradmin: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::AddPolicyAdministrator(
                    this,
                    core::mem::transmute(&bstradmin),
                    core::mem::transmute(&varreserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeletePolicyAdministrator<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::DeletePolicyAdministrator(
                    this,
                    core::mem::transmute(&bstradmin),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn AddPolicyReader<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrreader: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::AddPolicyReader(
                    this,
                    core::mem::transmute(&bstrreader),
                    core::mem::transmute(&varreserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeletePolicyReader<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::DeletePolicyReader(
                    this,
                    core::mem::transmute(&bstrreader),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn Scopes<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppscopecollection: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OpenScope<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrscopename: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            ppscope: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::OpenScope(
                    this,
                    core::mem::transmute(&bstrscopename),
                    core::mem::transmute(&varreserved),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateScope<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::CreateScope(
                    this,
                    core::mem::transmute(&bstrscopename),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn DeleteScope<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::DeleteScope(
                    this,
                    core::mem::transmute(&bstrscopename),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn Operations<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppoperationcollection: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OpenOperation<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstroperationname: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            ppoperation: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::OpenOperation(
                    this,
                    core::mem::transmute(&bstroperationname),
                    core::mem::transmute(&varreserved),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateOperation<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::CreateOperation(
                    this,
                    core::mem::transmute(&bstroperationname),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn DeleteOperation<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::DeleteOperation(
                    this,
                    core::mem::transmute(&bstroperationname),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn Tasks<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pptaskcollection: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OpenTask<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrtaskname: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            pptask: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::OpenTask(
                    this,
                    core::mem::transmute(&bstrtaskname),
                    core::mem::transmute(&varreserved),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateTask<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrtaskname: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            pptask: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::CreateTask(
                    this,
                    core::mem::transmute(&bstrtaskname),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn DeleteTask<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrtaskname: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::DeleteTask(
                    this,
                    core::mem::transmute(&bstrtaskname),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn ApplicationGroups<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppgroupcollection: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OpenApplicationGroup<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrgroupname: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::OpenApplicationGroup(
                    this,
                    core::mem::transmute(&bstrgroupname),
                    core::mem::transmute(&varreserved),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateApplicationGroup<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::CreateApplicationGroup(
                    this,
                    core::mem::transmute(&bstrgroupname),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn DeleteApplicationGroup<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::DeleteApplicationGroup(
                    this,
                    core::mem::transmute(&bstrgroupname),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn Roles<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pprolecollection: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OpenRole<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrrolename: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            pprole: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::OpenRole(
                    this,
                    core::mem::transmute(&bstrrolename),
                    core::mem::transmute(&varreserved),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn CreateRole<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrrolename: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            pprole: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::CreateRole(
                    this,
                    core::mem::transmute(&bstrrolename),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn DeleteRole<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrrolename: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::DeleteRole(
                    this,
                    core::mem::transmute(&bstrrolename),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            ulltokenhandle: u64,
            varreserved: super::super::System::Variant::VARIANT,
            ppclientcontext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::InitializeClientContextFromToken(
                    this,
                    core::mem::transmute_copy(&ulltokenhandle),
                    core::mem::transmute(&varreserved),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::AddPropertyItem(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varprop),
                    core::mem::transmute(&varreserved),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::DeletePropertyItem(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varprop),
                    core::mem::transmute(&varreserved),
        ...
        unsafe extern "system" fn Submit<Identity: IAzApplication_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn InitializeClientContextFromName<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            clientname: *mut core::ffi::c_void,
            domainname: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            ppclientcontext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::InitializeClientContextFromName(
                    this,
                    core::mem::transmute(&clientname),
        ...
        unsafe extern "system" fn DelegatedPolicyUsers<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pvardelegatedpolicyusers: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn AddDelegatedPolicyUser<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrdelegatedpolicyuser: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::AddDelegatedPolicyUser(
                    this,
                    core::mem::transmute(&bstrdelegatedpolicyuser),
                    core::mem::transmute(&varreserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeleteDelegatedPolicyUser<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::DeleteDelegatedPolicyUser(
                    this,
                    core::mem::transmute(&bstrdelegatedpolicyuser),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn InitializeClientContextFromStringSid<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            sidstring: *mut core::ffi::c_void,
            loptions: i32,
            varreserved: super::super::System::Variant::VARIANT,
            ppclientcontext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication_Impl::InitializeClientContextFromStringSid(
                    this,
                    core::mem::transmute(&sidstring),
        ...
        unsafe extern "system" fn AddPolicyAdministratorName<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::AddPolicyAdministratorName(
                    this,
                    core::mem::transmute(&bstradmin),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn DeletePolicyAdministratorName<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::DeletePolicyAdministratorName(
                    this,
                    core::mem::transmute(&bstradmin),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn AddPolicyReaderName<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::AddPolicyReaderName(
                    this,
                    core::mem::transmute(&bstrreader),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::DeletePolicyReaderName(
                    this,
                    core::mem::transmute(&bstrreader),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn AddDelegatedPolicyUserName<
            Identity: IAzApplication_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::AddDelegatedPolicyUserName(
                    this,
                    core::mem::transmute(&bstrdelegatedpolicyuser),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication_Impl::DeleteDelegatedPolicyUserName(
                    this,
                    core::mem::transmute(&bstrdelegatedpolicyuser),
                    core::mem::transmute(&varreserved),
                )
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzApplication as windows_core::Interface>::IID
...
impl IAzApplication2 {
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn InitializeClientContextFromToken2(
        &self,
        ultokenhandlelowpart: u32,
        ultokenhandlehighpart: u32,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzClientContext2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).InitializeClientContextFromToken2)(
                windows_core::Interface::as_raw(self),
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn InitializeClientContext2(
        &self,
        identifyingstring: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzClientContext2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).InitializeClientContext2)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(identifyingstring),
                core::mem::transmute_copy(varreserved),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IAzApplication2_Vtbl {
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub InitializeClientContextFromToken2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        super::super::System::Variant::VARIANT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub InitializeClientContext2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
...
impl IAzApplication2_Vtbl {
    pub const fn new<Identity: IAzApplication2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn InitializeClientContextFromToken2<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication2_Impl::InitializeClientContextFromToken2(
                    this,
                    core::mem::transmute_copy(&ultokenhandlelowpart),
                    core::mem::transmute_copy(&ultokenhandlehighpart),
                    core::mem::transmute(&varreserved),
                ) {
                    Ok(ok__) => {
                        ppclientcontext.write(core::mem::transmute(ok__));
        ...
        unsafe extern "system" fn InitializeClientContext2<
            Identity: IAzApplication2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            identifyingstring: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            ppclientcontext: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication2_Impl::InitializeClientContext2(
                    this,
                    core::mem::transmute(&identifyingstring),
                    core::mem::transmute(&varreserved),
                ) {
                    Ok(ok__) => {
                        ppclientcontext.write(core::mem::transmute(ok__));
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzApplication2 as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<IAzApplication as windows_core::Interface>::IID
    }
}
...
impl IAzApplication3 {
    pub unsafe fn ScopeExists(
        &self,
        bstrscopename: &windows_core::BSTR,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ScopeExists)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrscopename),
                &mut result__,
            )
    ...
    pub unsafe fn OpenScope2(
        &self,
        bstrscopename: &windows_core::BSTR,
    ) -> windows_core::Result<IAzScope2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenScope2)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrscopename),
                &mut result__,
            )
    ...
    pub unsafe fn CreateScope2(
        &self,
        bstrscopename: &windows_core::BSTR,
    ) -> windows_core::Result<IAzScope2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateScope2)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrscopename),
                &mut result__,
            )
    ...
    pub unsafe fn DeleteScope2(
        &self,
        bstrscopename: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteScope2)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrscopename),
            )
            .ok()
    ...
    pub unsafe fn RoleDefinitions(&self) -> windows_core::Result<IAzRoleDefinitions> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RoleDefinitions)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn CreateRoleDefinition(
        &self,
        bstrroledefinitionname: &windows_core::BSTR,
    ) -> windows_core::Result<IAzRoleDefinition> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateRoleDefinition)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrroledefinitionname),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn OpenRoleDefinition(
        &self,
        bstrroledefinitionname: &windows_core::BSTR,
    ) -> windows_core::Result<IAzRoleDefinition> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenRoleDefinition)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrroledefinitionname),
                &mut result__,
            )
    ...
    pub unsafe fn DeleteRoleDefinition(
        &self,
        bstrroledefinitionname: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteRoleDefinition)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrroledefinitionname),
            )
            .ok()
    ...
    pub unsafe fn RoleAssignments(&self) -> windows_core::Result<IAzRoleAssignments> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RoleAssignments)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn CreateRoleAssignment(
        &self,
        bstrroleassignmentname: &windows_core::BSTR,
    ) -> windows_core::Result<IAzRoleAssignment> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateRoleAssignment)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrroleassignmentname),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn OpenRoleAssignment(
        &self,
        bstrroleassignmentname: &windows_core::BSTR,
    ) -> windows_core::Result<IAzRoleAssignment> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenRoleAssignment)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrroleassignmentname),
                &mut result__,
            )
    ...
    pub unsafe fn DeleteRoleAssignment(
        &self,
        bstrroleassignmentname: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteRoleAssignment)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrroleassignmentname),
            )
            .ok()
    ...
    pub unsafe fn BizRulesEnabled(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BizRulesEnabled)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetBizRulesEnabled(
        &self,
        benabled: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBizRulesEnabled)(
                windows_core::Interface::as_raw(self),
                benabled,
            )
            .ok()
...
pub struct IAzApplication3_Vtbl {
    ...
    pub ScopeExists: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub OpenScope2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateScope2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeleteScope2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RoleDefinitions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateRoleDefinition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OpenRoleDefinition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeleteRoleDefinition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RoleAssignments: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateRoleAssignment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub OpenRoleAssignment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeleteRoleAssignment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BizRulesEnabled: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub SetBizRulesEnabled: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IAzApplication3_Vtbl {
    pub const fn new<Identity: IAzApplication3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ScopeExists<
            Identity: IAzApplication3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrscopename: *mut core::ffi::c_void,
            pbexist: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OpenScope2<
            Identity: IAzApplication3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrscopename: *mut core::ffi::c_void,
            ppscope2: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateScope2<
            Identity: IAzApplication3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn DeleteScope2<
            Identity: IAzApplication3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication3_Impl::DeleteScope2(this, core::mem::transmute(&bstrscopename))
                    .into()
            }
        }
        unsafe extern "system" fn RoleDefinitions<
            Identity: IAzApplication3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pproledefinitions: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            bstrroledefinitionname: *mut core::ffi::c_void,
            pproledefinitions: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication3_Impl::CreateRoleDefinition(
                    this,
                    core::mem::transmute(&bstrroledefinitionname),
                ) {
                    Ok(ok__) => {
                        pproledefinitions.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn OpenRoleDefinition<
            Identity: IAzApplication3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication3_Impl::OpenRoleDefinition(
                    this,
                    core::mem::transmute(&bstrroledefinitionname),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn DeleteRoleDefinition<
            Identity: IAzApplication3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication3_Impl::DeleteRoleDefinition(
                    this,
                    core::mem::transmute(&bstrroledefinitionname),
                )
                .into()
        ...
        unsafe extern "system" fn RoleAssignments<
            Identity: IAzApplication3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pproleassignments: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateRoleAssignment<
            Identity: IAzApplication3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrroleassignmentname: *mut core::ffi::c_void,
            pproleassignment: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication3_Impl::CreateRoleAssignment(
                    this,
                    core::mem::transmute(&bstrroleassignmentname),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn OpenRoleAssignment<
            Identity: IAzApplication3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplication3_Impl::OpenRoleAssignment(
                    this,
                    core::mem::transmute(&bstrroleassignmentname),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn DeleteRoleAssignment<
            Identity: IAzApplication3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication3_Impl::DeleteRoleAssignment(
                    this,
                    core::mem::transmute(&bstrroleassignmentname),
                )
                .into()
        ...
        >(
            this: *mut core::ffi::c_void,
            pbenabled: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetBizRulesEnabled<
            Identity: IAzApplication3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplication3_Impl::SetBizRulesEnabled(this, core::mem::transmute_copy(&benabled))
                    .into()
            }
        }
        Self {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzApplication3 as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<IAzApplication as windows_core::Interface>::IID
            || iid == &<IAzApplication2 as windows_core::Interface>::IID
    }
...
impl IAzApplicationGroup {
    ...
    pub unsafe fn LdapQuery(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LdapQuery)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetLdapQuery(&self, bstrprop: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLdapQuery)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
            )
            .ok()
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AppMembers(
        &self,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AppMembers)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AppNonMembers(
        &self,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AppNonMembers)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddAppMember(
        &self,
        bstrprop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddAppMember)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeleteAppMember(
        &self,
        bstrprop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteAppMember)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddAppNonMember(
        &self,
        bstrprop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddAppNonMember)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeleteAppNonMember(
        &self,
        bstrprop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteAppNonMember)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    pub unsafe fn AddMember(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).AddMember)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    pub unsafe fn DeleteMember(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DeleteMember)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddNonMember(
        &self,
        bstrprop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddNonMember)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeleteNonMember(
        &self,
        bstrprop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteNonMember)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddMemberName(
        &self,
        bstrprop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddMemberName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeleteMemberName(
        &self,
        bstrprop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteMemberName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddNonMemberName(
        &self,
        bstrprop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddNonMemberName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeleteNonMemberName(
        &self,
        bstrprop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteNonMemberName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn MembersName(
        &self,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MembersName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn NonMembersName(
        &self,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).NonMembersName)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct IAzApplicationGroup_Vtbl {
    ...
    pub LdapQuery: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetLdapQuery: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AppMembers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    AppMembers: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AppNonMembers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddAppMember: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    AddAppMember: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteAppMember: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddAppNonMember: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteAppNonMember: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddMember: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    AddMember: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteMember: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    DeleteMember: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddNonMember: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    AddNonMember: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteNonMember: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    Submit: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddMemberName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    AddMemberName: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteMemberName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddNonMemberName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteNonMemberName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub MembersName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    MembersName: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub NonMembersName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
...
impl IAzApplicationGroup_Vtbl {
    pub const fn new<Identity: IAzApplicationGroup_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Name<Identity: IAzApplicationGroup_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Type<Identity: IAzApplicationGroup_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plprop: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn LdapQuery<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetLdapQuery<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AppMembers<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn AppNonMembers<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Members<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn NonMembers<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::SetDescription(
                    this,
                    core::mem::transmute(&bstrdescription),
                )
                .into()
            }
        }
        unsafe extern "system" fn AddAppMember<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::AddAppMember(
                    this,
                    core::mem::transmute(&bstrprop),
                    core::mem::transmute(&varreserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeleteAppMember<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::DeleteAppMember(
                    this,
                    core::mem::transmute(&bstrprop),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn AddAppNonMember<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::AddAppNonMember(
                    this,
                    core::mem::transmute(&bstrprop),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn DeleteAppNonMember<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::DeleteAppNonMember(
                    this,
                    core::mem::transmute(&bstrprop),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn AddMember<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::AddMember(
                    this,
                    core::mem::transmute(&bstrprop),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn DeleteMember<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::DeleteMember(
                    this,
                    core::mem::transmute(&bstrprop),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn AddNonMember<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::AddNonMember(
                    this,
                    core::mem::transmute(&bstrprop),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn DeleteNonMember<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::DeleteNonMember(
                    this,
                    core::mem::transmute(&bstrprop),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn Writable<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplicationGroup_Impl::GetProperty(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::SetProperty(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varprop),
                    core::mem::transmute(&varreserved),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::AddPropertyItem(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varprop),
                    core::mem::transmute(&varreserved),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::DeletePropertyItem(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varprop),
                    core::mem::transmute(&varreserved),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::Submit(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn AddMemberName<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::AddMemberName(
                    this,
                    core::mem::transmute(&bstrprop),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn DeleteMemberName<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::DeleteMemberName(
                    this,
                    core::mem::transmute(&bstrprop),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn AddNonMemberName<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::AddNonMemberName(
                    this,
                    core::mem::transmute(&bstrprop),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn DeleteNonMemberName<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup_Impl::DeleteNonMemberName(
                    this,
                    core::mem::transmute(&bstrprop),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn NonMembersName<
            Identity: IAzApplicationGroup_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzApplicationGroup as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzApplicationGroup2 {
    pub unsafe fn BizRule(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BizRule)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetBizRule(&self, bstrprop: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBizRule)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
            )
            .ok()
    ...
    pub unsafe fn BizRuleLanguage(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BizRuleLanguage)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetBizRuleLanguage(
        &self,
        bstrprop: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBizRuleLanguage)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
            )
            .ok()
    ...
    pub unsafe fn BizRuleImportedPath(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BizRuleImportedPath)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetBizRuleImportedPath(
        &self,
        bstrprop: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBizRuleImportedPath)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
            )
            .ok()
    ...
    pub unsafe fn RoleAssignments(
        &self,
        bstrscopename: &windows_core::BSTR,
        brecursive: super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::Result<IAzRoleAssignments> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RoleAssignments)(
                windows_core::Interface::as_raw(self),
...
pub struct IAzApplicationGroup2_Vtbl {
    ...
    pub BizRule: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetBizRule: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BizRuleLanguage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetBizRuleLanguage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BizRuleImportedPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetBizRuleImportedPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RoleAssignments: unsafe extern "system" fn(
...
impl IAzApplicationGroup2_Vtbl {
    pub const fn new<Identity: IAzApplicationGroup2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BizRule<
        ...
        unsafe extern "system" fn SetBizRule<
            Identity: IAzApplicationGroup2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn BizRuleLanguage<
            Identity: IAzApplicationGroup2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetBizRuleLanguage<
            Identity: IAzApplicationGroup2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup2_Impl::SetBizRuleLanguage(this, core::mem::transmute(&bstrprop))
                    .into()
            }
        }
        unsafe extern "system" fn BizRuleImportedPath<
            Identity: IAzApplicationGroup2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetBizRuleImportedPath<
            Identity: IAzApplicationGroup2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzApplicationGroup2_Impl::SetBizRuleImportedPath(
                    this,
                    core::mem::transmute(&bstrprop),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzApplicationGroup2_Impl::RoleAssignments(
                    this,
                    core::mem::transmute(&bstrscopename),
                    core::mem::transmute_copy(&brecursive),
                ) {
                    Ok(ok__) => {
                        pproleassignments.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzApplicationGroup2 as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<IAzApplicationGroup as windows_core::Interface>::IID
    }
}
...
impl IAzApplicationGroups_Vtbl {
    pub const fn new<Identity: IAzApplicationGroups_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            index: i32,
            pvarobtptr: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            ppenumptr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzApplicationGroups as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzApplications_Vtbl {
    pub const fn new<Identity: IAzApplications_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn get_Item<Identity: IAzApplications_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: i32,
            pvarobtptr: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Count<Identity: IAzApplications_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plcount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn _NewEnum<Identity: IAzApplications_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumptr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzApplications as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzAuthorizationStore {
    ...
    pub unsafe fn DomainTimeout(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DomainTimeout)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetDomainTimeout(&self, lprop: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDomainTimeout)(
                windows_core::Interface::as_raw(self),
                lprop,
            )
            .ok()
    ...
    pub unsafe fn ScriptEngineTimeout(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ScriptEngineTimeout)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetScriptEngineTimeout(&self, lprop: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetScriptEngineTimeout)(
                windows_core::Interface::as_raw(self),
                lprop,
            )
            .ok()
    ...
    pub unsafe fn MaxScriptEngines(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MaxScriptEngines)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetMaxScriptEngines(&self, lprop: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetMaxScriptEngines)(
                windows_core::Interface::as_raw(self),
                lprop,
            )
            .ok()
    ...
    pub unsafe fn Initialize(
        ...
        bstrpolicyurl: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Initialize)(
                windows_core::Interface::as_raw(self),
                lflags,
                core::mem::transmute_copy(bstrpolicyurl),
                core::mem::transmute_copy(varreserved),
            )
            .ok()
        }
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn UpdateCache(
        &self,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).UpdateCache)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(varreserved),
            )
            .ok()
    ...
    pub unsafe fn Applications(&self) -> windows_core::Result<IAzApplications> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Applications)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn OpenApplication(
        &self,
        bstrapplicationname: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzApplication> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenApplication)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrapplicationname),
                core::mem::transmute_copy(varreserved),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn CreateApplication(
        &self,
        bstrapplicationname: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzApplication> {
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn DeleteApplication(
        &self,
        bstrapplicationname: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).DeleteApplication)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrapplicationname),
                core::mem::transmute_copy(varreserved),
            )
    ...
    pub unsafe fn TargetMachine(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TargetMachine)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn CloseApplication(
        &self,
        bstrapplicationname: &windows_core::BSTR,
        lflag: i32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).CloseApplication)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrapplicationname),
                lflag,
            )
...
pub struct IAzAuthorizationStore_Vtbl {
    ...
    pub SetDomainTimeout:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub ScriptEngineTimeout:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SetScriptEngineTimeout:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub MaxScriptEngines:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut i32) -> windows_core::HRESULT,
    pub SetMaxScriptEngines:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub GenerateAudits: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ...
    Initialize: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub UpdateCache: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    ...
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    Delete: usize,
    pub Applications: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub OpenApplication: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub DeleteApplication: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    DeleteDelegatedPolicyUser: usize,
    pub TargetMachine: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ApplyStoreSacl: unsafe extern "system" fn(
    ...
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    DeleteDelegatedPolicyUserName: usize,
    pub CloseApplication: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
    ) -> windows_core::HRESULT,
...
impl IAzAuthorizationStore_Vtbl {
    pub const fn new<Identity: IAzAuthorizationStore_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::SetDescription(
                    this,
                    core::mem::transmute(&bstrdescription),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::SetApplicationData(
                    this,
                    core::mem::transmute(&bstrapplicationdata),
                )
                .into()
        ...
        unsafe extern "system" fn DomainTimeout<
            Identity: IAzAuthorizationStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetDomainTimeout<
            Identity: IAzAuthorizationStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::SetDomainTimeout(
                    this,
                    core::mem::transmute_copy(&lprop),
                )
                .into()
            }
        }
        unsafe extern "system" fn ScriptEngineTimeout<
            Identity: IAzAuthorizationStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetScriptEngineTimeout<
            Identity: IAzAuthorizationStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::SetScriptEngineTimeout(
                    this,
                    core::mem::transmute_copy(&lprop),
                )
                .into()
        ...
        unsafe extern "system" fn MaxScriptEngines<
            Identity: IAzAuthorizationStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetMaxScriptEngines<
            Identity: IAzAuthorizationStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::SetMaxScriptEngines(
                    this,
                    core::mem::transmute_copy(&lprop),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::SetGenerateAudits(
                    this,
                    core::mem::transmute_copy(&bprop),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzAuthorizationStore_Impl::GetProperty(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::SetProperty(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varprop),
                    core::mem::transmute(&varreserved),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::AddPropertyItem(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varprop),
                    core::mem::transmute(&varreserved),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::DeletePropertyItem(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varprop),
                    core::mem::transmute(&varreserved),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::AddPolicyAdministrator(
                    this,
                    core::mem::transmute(&bstradmin),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::DeletePolicyAdministrator(
                    this,
                    core::mem::transmute(&bstradmin),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::AddPolicyReader(
                    this,
                    core::mem::transmute(&bstrreader),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::DeletePolicyReader(
                    this,
                    core::mem::transmute(&bstrreader),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            this: *mut core::ffi::c_void,
            lflags: AZ_PROP_CONSTANTS,
            bstrpolicyurl: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::Initialize(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute(&bstrpolicyurl),
                    core::mem::transmute(&varreserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn UpdateCache<
            Identity: IAzAuthorizationStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::UpdateCache(this, core::mem::transmute(&varreserved))
                    .into()
            }
        }
        ...
        unsafe extern "system" fn Applications<
            Identity: IAzAuthorizationStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppappcollection: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OpenApplication<
            Identity: IAzAuthorizationStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrapplicationname: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzAuthorizationStore_Impl::OpenApplication(
                    this,
                    core::mem::transmute(&bstrapplicationname),
                    core::mem::transmute(&varreserved),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzAuthorizationStore_Impl::CreateApplication(
                    this,
                    core::mem::transmute(&bstrapplicationname),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn DeleteApplication<
            Identity: IAzAuthorizationStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::DeleteApplication(
                    this,
                    core::mem::transmute(&bstrapplicationname),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzAuthorizationStore_Impl::CreateApplicationGroup(
                    this,
                    core::mem::transmute(&bstrgroupname),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzAuthorizationStore_Impl::OpenApplicationGroup(
                    this,
                    core::mem::transmute(&bstrgroupname),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::DeleteApplicationGroup(
                    this,
                    core::mem::transmute(&bstrgroupname),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::Submit(
                    this,
                    core::mem::transmute_copy(&lflags),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::AddDelegatedPolicyUser(
                    this,
                    core::mem::transmute(&bstrdelegatedpolicyuser),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::DeleteDelegatedPolicyUser(
                    this,
                    core::mem::transmute(&bstrdelegatedpolicyuser),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn TargetMachine<
            Identity: IAzAuthorizationStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrtargetmachine: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            pbapplystoresacl: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            bapplystoresacl: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::SetApplyStoreSacl(
                    this,
                    core::mem::transmute_copy(&bapplystoresacl),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::AddPolicyAdministratorName(
                    this,
                    core::mem::transmute(&bstradmin),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::DeletePolicyAdministratorName(
                    this,
                    core::mem::transmute(&bstradmin),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::AddPolicyReaderName(
                    this,
                    core::mem::transmute(&bstrreader),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::DeletePolicyReaderName(
                    this,
                    core::mem::transmute(&bstrreader),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::AddDelegatedPolicyUserName(
                    this,
                    core::mem::transmute(&bstrdelegatedpolicyuser),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::DeleteDelegatedPolicyUserName(
                    this,
                    core::mem::transmute(&bstrdelegatedpolicyuser),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn CloseApplication<
            Identity: IAzAuthorizationStore_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore_Impl::CloseApplication(
                    this,
                    core::mem::transmute(&bstrapplicationname),
                    core::mem::transmute_copy(&lflag),
                )
                .into()
            }
        }
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzAuthorizationStore as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzAuthorizationStore2 {
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn OpenApplication2(
        &self,
        bstrapplicationname: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzApplication2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OpenApplication2)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrapplicationname),
                core::mem::transmute_copy(varreserved),
                &mut result__,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn CreateApplication2(
        &self,
        bstrapplicationname: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<IAzApplication2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateApplication2)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrapplicationname),
                core::mem::transmute_copy(varreserved),
                &mut result__,
...
pub struct IAzAuthorizationStore2_Vtbl {
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub OpenApplication2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub CreateApplication2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut *mut core::ffi::c_void,
...
impl IAzAuthorizationStore2_Vtbl {
    pub const fn new<Identity: IAzAuthorizationStore2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn OpenApplication2<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzAuthorizationStore2_Impl::OpenApplication2(
                    this,
                    core::mem::transmute(&bstrapplicationname),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzAuthorizationStore2_Impl::CreateApplication2(
                    this,
                    core::mem::transmute(&bstrapplicationname),
                    core::mem::transmute(&varreserved),
                ) {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzAuthorizationStore2 as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<IAzAuthorizationStore as windows_core::Interface>::IID
    }
}
...
impl IAzAuthorizationStore3 {
    pub unsafe fn IsUpdateNeeded(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsUpdateNeeded)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn BizruleGroupSupported(
        &self,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BizruleGroupSupported)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn UpgradeStoresFunctionalLevel(
        &self,
        lfunctionallevel: i32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).UpgradeStoresFunctionalLevel)(
                windows_core::Interface::as_raw(self),
                lfunctionallevel,
            )
            .ok()
    ...
    pub unsafe fn IsFunctionalLevelUpgradeSupported(
        &self,
        lfunctionallevel: i32,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsFunctionalLevelUpgradeSupported)(
                windows_core::Interface::as_raw(self),
                lfunctionallevel,
                &mut result__,
            )
    ...
    pub unsafe fn GetSchemaVersion(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetSchemaVersion)(
                windows_core::Interface::as_raw(self),
                plmajorversion as _,
                plminorversion as _,
            )
...
pub struct IAzAuthorizationStore3_Vtbl {
    ...
    pub IsUpdateNeeded: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub BizruleGroupSupported: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub UpgradeStoresFunctionalLevel:
        unsafe extern "system" fn(*mut core::ffi::c_void, i32) -> windows_core::HRESULT,
    pub IsFunctionalLevelUpgradeSupported: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub GetSchemaVersion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut i32,
        *mut i32,
    ) -> windows_core::HRESULT,
...
impl IAzAuthorizationStore3_Vtbl {
    pub const fn new<Identity: IAzAuthorizationStore3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsUpdateNeeded<
            Identity: IAzAuthorizationStore3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbisupdateneeded: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn BizruleGroupSupported<
            Identity: IAzAuthorizationStore3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbsupported: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn UpgradeStoresFunctionalLevel<
            Identity: IAzAuthorizationStore3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore3_Impl::UpgradeStoresFunctionalLevel(
                    this,
                    core::mem::transmute_copy(&lfunctionallevel),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsFunctionalLevelUpgradeSupported<
            Identity: IAzAuthorizationStore3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzAuthorizationStore3_Impl::IsFunctionalLevelUpgradeSupported(
                    this,
                    core::mem::transmute_copy(&lfunctionallevel),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetSchemaVersion<
            Identity: IAzAuthorizationStore3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzAuthorizationStore3_Impl::GetSchemaVersion(
                    this,
                    core::mem::transmute_copy(&plmajorversion),
                    core::mem::transmute_copy(&plminorversion),
                )
                .into()
            }
        }
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzAuthorizationStore3 as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<IAzAuthorizationStore as windows_core::Interface>::IID
            || iid == &<IAzAuthorizationStore2 as windows_core::Interface>::IID
    }
...
impl IAzBizRuleContext {
    pub unsafe fn SetBusinessRuleResult(&self, bresult: bool) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBusinessRuleResult)(
                windows_core::Interface::as_raw(self),
                bresult.into(),
            )
            .ok()
    ...
    pub unsafe fn SetBusinessRuleString(
        &self,
        bstrbusinessrulestring: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetBusinessRuleString)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrbusinessrulestring),
            )
            .ok()
        }
    }
    pub unsafe fn BusinessRuleString(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BusinessRuleString)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn GetParameter(
        &self,
        bstrparametername: &windows_core::BSTR,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetParameter)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrparametername),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
        }
...
pub struct IAzBizRuleContext_Vtbl {
    pub base__: super::super::System::Com::IDispatch_Vtbl,
    pub SetBusinessRuleResult: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub SetBusinessRuleString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BusinessRuleString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IAzBizRuleContext_Vtbl {
    pub const fn new<Identity: IAzBizRuleContext_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetBusinessRuleResult<
            Identity: IAzBizRuleContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bresult: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzBizRuleContext_Impl::SetBusinessRuleResult(
                    this,
                    core::mem::transmute_copy(&bresult),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetBusinessRuleString<
            Identity: IAzBizRuleContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrbusinessrulestring: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzBizRuleContext_Impl::SetBusinessRuleString(
                    this,
                    core::mem::transmute(&bstrbusinessrulestring),
                )
                .into()
            }
        }
        unsafe extern "system" fn BusinessRuleString<
            Identity: IAzBizRuleContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrbusinessrulestring: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetParameter<
            Identity: IAzBizRuleContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrparametername: *mut core::ffi::c_void,
            pvarparametervalue: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzBizRuleContext_Impl::GetParameter(
                    this,
                    core::mem::transmute(&bstrparametername),
                ) {
                    Ok(ok__) => {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzBizRuleContext as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzBizRuleInterfaces {
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddInterface(
        &self,
        bstrinterfacename: &windows_core::BSTR,
        linterfaceflag: i32,
        varinterface: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddInterface)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrinterfacename),
                linterfaceflag,
                core::mem::transmute_copy(varinterface),
            )
            .ok()
        }
    }
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddInterfaces(
        &self,
        varinterfacenames: &super::super::System::Variant::VARIANT,
        varinterfaceflags: &super::super::System::Variant::VARIANT,
        varinterfaces: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddInterfaces)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(varinterfacenames),
                core::mem::transmute_copy(varinterfaceflags),
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetInterfaceValue(
        &self,
        bstrinterfacename: &windows_core::BSTR,
        linterfaceflag: *mut i32,
        varinterface: *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetInterfaceValue)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrinterfacename),
                linterfaceflag as _,
                core::mem::transmute(varinterface),
            )
            .ok()
        }
    }
...
pub struct IAzBizRuleInterfaces_Vtbl {
    pub base__: super::super::System::Com::IDispatch_Vtbl,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddInterface: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
        super::super::System::Variant::VARIANT,
    ...
    AddInterface: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddInterfaces: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        super::super::System::Variant::VARIANT,
        super::super::System::Variant::VARIANT,
    ...
    AddInterfaces: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub GetInterfaceValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i32,
        *mut super::super::System::Variant::VARIANT,
...
impl IAzBizRuleInterfaces_Vtbl {
    pub const fn new<Identity: IAzBizRuleInterfaces_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddInterface<
            Identity: IAzBizRuleInterfaces_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrinterfacename: *mut core::ffi::c_void,
            linterfaceflag: i32,
            varinterface: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzBizRuleInterfaces_Impl::AddInterface(
                    this,
                    core::mem::transmute(&bstrinterfacename),
                    core::mem::transmute_copy(&linterfaceflag),
                    core::mem::transmute(&varinterface),
                )
                .into()
            }
        }
        unsafe extern "system" fn AddInterfaces<
            Identity: IAzBizRuleInterfaces_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzBizRuleInterfaces_Impl::AddInterfaces(
                    this,
                    core::mem::transmute(&varinterfacenames),
                    core::mem::transmute(&varinterfaceflags),
                    core::mem::transmute(&varinterfaces),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzBizRuleInterfaces_Impl::GetInterfaceValue(
                    this,
                    core::mem::transmute(&bstrinterfacename),
                    core::mem::transmute_copy(&linterfaceflag),
                    core::mem::transmute_copy(&varinterface),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzBizRuleInterfaces_Impl::Remove(this, core::mem::transmute(&bstrinterfacename))
                    .into()
            }
        }
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzBizRuleInterfaces as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzBizRuleParameters {
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddParameter(
        &self,
        bstrparametername: &windows_core::BSTR,
        varparametervalue: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddParameter)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrparametername),
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddParameters(
        &self,
        varparameternames: &super::super::System::Variant::VARIANT,
        varparametervalues: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddParameters)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(varparameternames),
                core::mem::transmute_copy(varparametervalues),
            )
            .ok()
        }
    }
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetParameterValue(
        &self,
        bstrparametername: &windows_core::BSTR,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetParameterValue)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrparametername),
                &mut result__,
            )
    ...
    pub unsafe fn Remove(&self, varparametername: &windows_core::BSTR) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Remove)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(varparametername),
            )
            .ok()
        }
    }
...
pub struct IAzBizRuleParameters_Vtbl {
    pub base__: super::super::System::Com::IDispatch_Vtbl,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddParameter: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    AddParameter: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    AddParameters: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub GetParameterValue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
...
impl IAzBizRuleParameters_Vtbl {
    pub const fn new<Identity: IAzBizRuleParameters_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddParameter<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzBizRuleParameters_Impl::AddParameter(
                    this,
                    core::mem::transmute(&bstrparametername),
                    core::mem::transmute(&varparametervalue),
                )
                .into()
            }
        }
        unsafe extern "system" fn AddParameters<
            Identity: IAzBizRuleParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzBizRuleParameters_Impl::AddParameters(
                    this,
                    core::mem::transmute(&varparameternames),
                    core::mem::transmute(&varparametervalues),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetParameterValue<
            Identity: IAzBizRuleParameters_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzBizRuleParameters_Impl::GetParameterValue(
                    this,
                    core::mem::transmute(&bstrparametername),
                ) {
                    Ok(ok__) => {
        ...
        >(
            this: *mut core::ffi::c_void,
            varparametername: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzBizRuleParameters_Impl::Remove(this, core::mem::transmute(&varparametername))
                    .into()
            }
        }
        unsafe extern "system" fn RemoveAll<
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzBizRuleParameters as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzClientContext {
    ...
    pub unsafe fn AccessCheck(
        &self,
        bstrobjectname: &windows_core::BSTR,
        varscopenames: &super::super::System::Variant::VARIANT,
        varoperations: &super::super::System::Variant::VARIANT,
        varparameternames: &super::super::System::Variant::VARIANT,
        varparametervalues: &super::super::System::Variant::VARIANT,
        varinterfacenames: &super::super::System::Variant::VARIANT,
        varinterfaceflags: &super::super::System::Variant::VARIANT,
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(self).AccessCheck)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrobjectname),
                core::mem::transmute_copy(varscopenames),
                core::mem::transmute_copy(varoperations),
                core::mem::transmute_copy(varparameternames),
                core::mem::transmute_copy(varparametervalues),
                core::mem::transmute_copy(varinterfacenames),
                core::mem::transmute_copy(varinterfaceflags),
    ...
    pub unsafe fn GetBusinessRuleString(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetBusinessRuleString)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn UserDn(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UserDn)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn UserSamCompat(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UserSamCompat)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn UserDisplay(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UserDisplay)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn UserGuid(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UserGuid)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn UserCanonical(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UserCanonical)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn UserUpn(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UserUpn)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn UserDnsSamCompat(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UserDnsSamCompat)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetRoles(
        &self,
        bstrscopename: &windows_core::BSTR,
    ) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRoles)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrscopename),
                &mut result__,
            )
    ...
    pub unsafe fn RoleForAccessCheck(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RoleForAccessCheck)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub unsafe fn SetRoleForAccessCheck(
        &self,
        bstrprop: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetRoleForAccessCheck)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
            )
            .ok()
...
pub struct IAzClientContext_Vtbl {
    ...
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    AccessCheck: usize,
    pub GetBusinessRuleString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UserDn: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UserSamCompat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UserDisplay: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UserGuid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UserCanonical: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UserUpn: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UserDnsSamCompat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    ...
    GetProperty: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub GetRoles: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    GetRoles: usize,
    pub RoleForAccessCheck: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetRoleForAccessCheck: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IAzClientContext_Vtbl {
    pub const fn new<Identity: IAzClientContext_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            varinterfaceflags: super::super::System::Variant::VARIANT,
            varinterfaces: super::super::System::Variant::VARIANT,
            pvarresults: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzClientContext_Impl::AccessCheck(
                    this,
                    core::mem::transmute(&bstrobjectname),
                    core::mem::transmute(&varscopenames),
                    core::mem::transmute(&varoperations),
                    core::mem::transmute(&varparameternames),
                    core::mem::transmute(&varparametervalues),
                    core::mem::transmute(&varinterfacenames),
                    core::mem::transmute(&varinterfaceflags),
        ...
        unsafe extern "system" fn GetBusinessRuleString<
            Identity: IAzClientContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn UserDn<Identity: IAzClientContext_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrprop: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn UserSamCompat<
            Identity: IAzClientContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn UserDisplay<
            Identity: IAzClientContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn UserGuid<Identity: IAzClientContext_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrprop: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn UserCanonical<
            Identity: IAzClientContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn UserUpn<Identity: IAzClientContext_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrprop: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn UserDnsSamCompat<
            Identity: IAzClientContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzClientContext_Impl::GetProperty(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn GetRoles<Identity: IAzClientContext_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrscopename: *mut core::ffi::c_void,
            pvarrolenames: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn RoleForAccessCheck<
            Identity: IAzClientContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetRoleForAccessCheck<
            Identity: IAzClientContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzClientContext_Impl::SetRoleForAccessCheck(this, core::mem::transmute(&bstrprop))
                    .into()
            }
        }
        Self {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzClientContext as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzClientContext2 {
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetAssignedScopesPage(
        &self,
        loptions: i32,
        pagesize: i32,
        pvarcursor: *mut super::super::System::Variant::VARIANT,
        pvarscopenames: *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetAssignedScopesPage)(
                windows_core::Interface::as_raw(self),
                loptions,
                pagesize,
                core::mem::transmute(pvarcursor),
                core::mem::transmute(pvarscopenames),
            )
            .ok()
        }
    }
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddRoles(
        &self,
        varroles: &super::super::System::Variant::VARIANT,
        bstrscopename: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddRoles)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(varroles),
                core::mem::transmute_copy(bstrscopename),
            )
            .ok()
        }
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddApplicationGroups(
        &self,
        varapplicationgroups: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddApplicationGroups)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(varapplicationgroups),
            )
            .ok()
        }
    }
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddStringSids(
        &self,
        varstringsids: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddStringSids)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(varstringsids),
            )
            .ok()
        }
    }
    pub unsafe fn SetLDAPQueryDN(
        &self,
        bstrldapquerydn: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetLDAPQueryDN)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrldapquerydn),
            )
            .ok()
        }
    }
    pub unsafe fn LDAPQueryDN(&self) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LDAPQueryDN)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct IAzClientContext2_Vtbl {
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub GetAssignedScopesPage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        i32,
        *mut super::super::System::Variant::VARIANT,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddRoles: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    AddRoles: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddApplicationGroups: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddStringSids: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    AddStringSids: usize,
    pub SetLDAPQueryDN: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub LDAPQueryDN: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IAzClientContext2_Vtbl {
    pub const fn new<Identity: IAzClientContext2_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzClientContext2_Impl::GetAssignedScopesPage(
                    this,
                    core::mem::transmute_copy(&loptions),
                    core::mem::transmute_copy(&pagesize),
                    core::mem::transmute_copy(&pvarcursor),
                    core::mem::transmute_copy(&pvarscopenames),
                )
                .into()
            }
        }
        unsafe extern "system" fn AddRoles<
            Identity: IAzClientContext2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzClientContext2_Impl::AddRoles(
                    this,
                    core::mem::transmute(&varroles),
                    core::mem::transmute(&bstrscopename),
                )
                .into()
            }
        }
        unsafe extern "system" fn AddApplicationGroups<
            Identity: IAzClientContext2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzClientContext2_Impl::AddApplicationGroups(
                    this,
                    core::mem::transmute(&varapplicationgroups),
                )
                .into()
            }
        }
        unsafe extern "system" fn AddStringSids<
            Identity: IAzClientContext2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzClientContext2_Impl::AddStringSids(this, core::mem::transmute(&varstringsids))
                    .into()
            }
        }
        unsafe extern "system" fn SetLDAPQueryDN<
            Identity: IAzClientContext2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrldapquerydn: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzClientContext2_Impl::SetLDAPQueryDN(this, core::mem::transmute(&bstrldapquerydn))
                    .into()
            }
        }
        unsafe extern "system" fn LDAPQueryDN<
            Identity: IAzClientContext2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pbstrldapquerydn: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzClientContext2 as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<IAzClientContext as windows_core::Interface>::IID
    }
}
...
impl IAzClientContext3 {
    pub unsafe fn AccessCheck2(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AccessCheck2)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrobjectname),
                core::mem::transmute_copy(bstrscopename),
                loperation,
    ...
    pub unsafe fn IsInRoleAssignment(
        &self,
        bstrscopename: &windows_core::BSTR,
        bstrrolename: &windows_core::BSTR,
    ) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsInRoleAssignment)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrscopename),
                core::mem::transmute_copy(bstrrolename),
                &mut result__,
    ...
    pub unsafe fn GetOperations(
        &self,
        bstrscopename: &windows_core::BSTR,
    ) -> windows_core::Result<IAzOperations> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOperations)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrscopename),
                &mut result__,
            )
    ...
    pub unsafe fn GetTasks(
        &self,
        bstrscopename: &windows_core::BSTR,
    ) -> windows_core::Result<IAzTasks> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTasks)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrscopename),
                &mut result__,
            )
    ...
    pub unsafe fn BizRuleParameters(&self) -> windows_core::Result<IAzBizRuleParameters> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BizRuleParameters)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn BizRuleInterfaces(&self) -> windows_core::Result<IAzBizRuleInterfaces> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BizRuleInterfaces)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetGroups(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetGroups)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrscopename),
                uloptions.0 as _,
                &mut result__,
    ...
    pub unsafe fn Sids(&self) -> windows_core::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Sids)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
pub struct IAzClientContext3_Vtbl {
    ...
    pub AccessCheck2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        i32,
    ...
    pub IsInRoleAssignment: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut super::super::Foundation::VARIANT_BOOL,
    ) -> windows_core::HRESULT,
    pub GetOperations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetTasks: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BizRuleParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BizRuleInterfaces: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub GetGroups: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *mut super::super::System::Variant::VARIANT,
    ...
    GetGroups: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub Sids: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
...
impl IAzClientContext3_Vtbl {
    pub const fn new<Identity: IAzClientContext3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AccessCheck2<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzClientContext3_Impl::AccessCheck2(
                    this,
                    core::mem::transmute(&bstrobjectname),
                    core::mem::transmute(&bstrscopename),
                    core::mem::transmute_copy(&loperation),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn IsInRoleAssignment<
            Identity: IAzClientContext3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrscopename: *mut core::ffi::c_void,
            bstrrolename: *mut core::ffi::c_void,
            pbisinrole: *mut super::super::Foundation::VARIANT_BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzClientContext3_Impl::IsInRoleAssignment(
                    this,
                    core::mem::transmute(&bstrscopename),
                    core::mem::transmute(&bstrrolename),
                ) {
        ...
        unsafe extern "system" fn GetOperations<
            Identity: IAzClientContext3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzClientContext3_Impl::GetOperations(
                    this,
                    core::mem::transmute(&bstrscopename),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetTasks<
            Identity: IAzClientContext3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn BizRuleParameters<
            Identity: IAzClientContext3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppbizruleparam: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn BizRuleInterfaces<
            Identity: IAzClientContext3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppbizruleinterfaces: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetGroups<
            Identity: IAzClientContext3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrscopename: *mut core::ffi::c_void,
            uloptions: u32,
            pgrouparray: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzClientContext3_Impl::GetGroups(
                    this,
                    core::mem::transmute(&bstrscopename),
                    core::mem::transmute(&uloptions),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Sids<Identity: IAzClientContext3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pstringsidarray: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzClientContext3 as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<IAzClientContext as windows_core::Interface>::IID
            || iid == &<IAzClientContext2 as windows_core::Interface>::IID
    }
...
impl IAzNameResolver {
    pub unsafe fn NameFromSid(
        &self,
        bstrsid: &windows_core::BSTR,
        psidtype: *mut i32,
        pbstrname: *mut windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).NameFromSid)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrsid),
                psidtype as _,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn NamesFromSids(
        &self,
        vsids: &super::super::System::Variant::VARIANT,
        pvsidtypes: *mut super::super::System::Variant::VARIANT,
        pvnames: *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).NamesFromSids)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(vsids),
                core::mem::transmute(pvsidtypes),
                core::mem::transmute(pvnames),
            )
            .ok()
        }
    }
...
pub struct IAzNameResolver_Vtbl {
    pub base__: super::super::System::Com::IDispatch_Vtbl,
    pub NameFromSid: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i32,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub NamesFromSids: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
        *mut super::super::System::Variant::VARIANT,
        *mut super::super::System::Variant::VARIANT,
...
impl IAzNameResolver_Vtbl {
    pub const fn new<Identity: IAzNameResolver_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzNameResolver_Impl::NameFromSid(
                    this,
                    core::mem::transmute(&bstrsid),
                    core::mem::transmute_copy(&psidtype),
                    core::mem::transmute_copy(&pbstrname),
                )
                .into()
            }
        }
        unsafe extern "system" fn NamesFromSids<
            Identity: IAzNameResolver_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzNameResolver_Impl::NamesFromSids(
                    this,
                    core::mem::transmute(&vsids),
                    core::mem::transmute_copy(&pvsidtypes),
                    core::mem::transmute_copy(&pvnames),
                )
                .into()
            }
        }
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzNameResolver as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzObjectPicker {
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetPrincipals(
        &self,
        hparentwnd: super::super::Foundation::HWND,
        bstrtitle: &windows_core::BSTR,
        pvsidtypes: *mut super::super::System::Variant::VARIANT,
        pvnames: *mut super::super::System::Variant::VARIANT,
        pvsids: *mut super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPrincipals)(
                windows_core::Interface::as_raw(self),
                hparentwnd,
                core::mem::transmute_copy(bstrtitle),
                core::mem::transmute(pvsidtypes),
                core::mem::transmute(pvnames),
                core::mem::transmute(pvsids),
            )
            .ok()
        }
    }
...
pub struct IAzObjectPicker_Vtbl {
    pub base__: super::super::System::Com::IDispatch_Vtbl,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub GetPrincipals: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IAzObjectPicker_Vtbl {
    pub const fn new<Identity: IAzObjectPicker_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetPrincipals<
            Identity: IAzObjectPicker_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            hparentwnd: super::super::Foundation::HWND,
            bstrtitle: *mut core::ffi::c_void,
            pvsidtypes: *mut super::super::System::Variant::VARIANT,
            pvnames: *mut super::super::System::Variant::VARIANT,
            pvsids: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzObjectPicker_Impl::GetPrincipals(
                    this,
                    core::mem::transmute_copy(&hparentwnd),
                    core::mem::transmute(&bstrtitle),
                    core::mem::transmute_copy(&pvsidtypes),
                    core::mem::transmute_copy(&pvnames),
                    core::mem::transmute_copy(&pvsids),
                )
                .into()
            }
        }
        unsafe extern "system" fn Name<Identity: IAzObjectPicker_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzObjectPicker as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzOperation {
    ...
    pub unsafe fn OperationID(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OperationID)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetOperationID(&self, lprop: i32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetOperationID)(
                windows_core::Interface::as_raw(self),
                lprop,
            )
            .ok()
...
impl IAzOperation_Vtbl {
    pub const fn new<Identity: IAzOperation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Name<Identity: IAzOperation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetName<Identity: IAzOperation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrname: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Description<Identity: IAzOperation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrdescription: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzOperation_Impl::SetDescription(this, core::mem::transmute(&bstrdescription))
                    .into()
            }
        }
        unsafe extern "system" fn ApplicationData<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzOperation_Impl::SetApplicationData(
                    this,
                    core::mem::transmute(&bstrapplicationdata),
                )
                .into()
        ...
        unsafe extern "system" fn OperationID<Identity: IAzOperation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plprop: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetOperationID<
            Identity: IAzOperation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Writable<Identity: IAzOperation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pfprop: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetProperty<Identity: IAzOperation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpropid: i32,
            varreserved: super::super::System::Variant::VARIANT,
            pvarprop: *mut super::super::System::Variant::VARIANT,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzOperation_Impl::GetProperty(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn SetProperty<Identity: IAzOperation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpropid: i32,
            varprop: super::super::System::Variant::VARIANT,
            varreserved: super::super::System::Variant::VARIANT,
        ...
        unsafe extern "system" fn Submit<Identity: IAzOperation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzOperation as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
    ...
    pub const fn new<Identity: IAzOperation2_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzOperation2_Impl::RoleAssignments(
                    this,
                    core::mem::transmute(&bstrscopename),
                    core::mem::transmute_copy(&brecursive),
                ) {
        ...
        Self {
            base__: IAzOperation_Vtbl::new::<Identity, OFFSET>(),
            RoleAssignments: RoleAssignments::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzOperation2 as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<IAzOperation as windows_core::Interface>::IID
    }
}
...
impl IAzOperations_Vtbl {
    pub const fn new<Identity: IAzOperations_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn get_Item<Identity: IAzOperations_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: i32,
            pvarobtptr: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Count<Identity: IAzOperations_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plcount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn _NewEnum<Identity: IAzOperations_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumptr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzOperations as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzPrincipalLocator {
    pub unsafe fn NameResolver(&self) -> windows_core::Result<IAzNameResolver> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).NameResolver)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn ObjectPicker(&self) -> windows_core::Result<IAzObjectPicker> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ObjectPicker)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IAzPrincipalLocator_Vtbl {
    pub base__: super::super::System::Com::IDispatch_Vtbl,
    pub NameResolver: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ObjectPicker: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl IAzPrincipalLocator_Vtbl {
    pub const fn new<Identity: IAzPrincipalLocator_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn NameResolver<
            Identity: IAzPrincipalLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppnameresolver: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ObjectPicker<
            Identity: IAzPrincipalLocator_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppobjectpicker: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzPrincipalLocator as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzRole {
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddTask(
        &self,
        bstrprop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddTask)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn AddOperation(
        &self,
        bstrprop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddOperation)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrprop),
                core::mem::transmute_copy(varreserved),
            )
...
pub struct IAzRole_Vtbl {
    ...
    DeleteAppMember: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddTask: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
    ...
    DeleteTask: usize,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub AddOperation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::System::Variant::VARIANT,
    ) -> windows_core::HRESULT,
...
impl IAzRole_Vtbl {
    pub const fn new<Identity: IAzRole_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Name<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetName<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrname: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Description<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrdescription: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetDescription<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrdescription: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ApplicationData<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrapplicationdata: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzRole_Impl::SetApplicationData(this, core::mem::transmute(&bstrapplicationdata))
                    .into()
            }
        }
        unsafe extern "system" fn AddAppMember<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn DeleteAppMember<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn AddTask<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn DeleteTask<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn AddOperation<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn DeleteOperation<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn AddMember<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn DeleteMember<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Writable<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pfprop: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetProperty<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpropid: i32,
            varreserved: super::super::System::Variant::VARIANT,
            pvarprop: *mut super::super::System::Variant::VARIANT,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzRole_Impl::GetProperty(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn SetProperty<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpropid: i32,
            varprop: super::super::System::Variant::VARIANT,
            varreserved: super::super::System::Variant::VARIANT,
        ...
        unsafe extern "system" fn AppMembers<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pvarprop: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Members<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pvarprop: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Operations<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pvarprop: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Tasks<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pvarprop: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn AddPropertyItem<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpropid: i32,
            varprop: super::super::System::Variant::VARIANT,
            varreserved: super::super::System::Variant::VARIANT,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzRole_Impl::DeletePropertyItem(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varprop),
                    core::mem::transmute(&varreserved),
        ...
        unsafe extern "system" fn Submit<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn AddMemberName<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn DeleteMemberName<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn MembersName<Identity: IAzRole_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pvarprop: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzRole as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzRoleAssignment {
    pub unsafe fn AddRoleDefinition(
        &self,
        bstrroledefinition: &windows_core::BSTR,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddRoleDefinition)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrroledefinition),
            )
            .ok()
        }
    }
    ...
    pub unsafe fn Scope(&self) -> windows_core::Result<IAzScope> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Scope)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IAzRoleAssignment_Vtbl {
    ...
    pub AddRoleDefinition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeleteRoleDefinition: unsafe extern "system" fn(
...
impl IAzRoleAssignment_Vtbl {
    pub const fn new<Identity: IAzRoleAssignment_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddRoleDefinition<
            Identity: IAzRoleAssignment_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            bstrroledefinition: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzRoleAssignment_Impl::AddRoleDefinition(
                    this,
                    core::mem::transmute(&bstrroledefinition),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzRoleAssignment_Impl::DeleteRoleDefinition(
                    this,
                    core::mem::transmute(&bstrroledefinition),
                )
                .into()
        ...
        unsafe extern "system" fn Scope<Identity: IAzRoleAssignment_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppscope: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzRoleAssignment as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<IAzRole as windows_core::Interface>::IID
    }
}
...
impl IAzRoleAssignments_Vtbl {
    pub const fn new<Identity: IAzRoleAssignments_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Count<Identity: IAzRoleAssignments_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plcount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzRoleAssignments as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzRoleDefinition_Vtbl {
    pub const fn new<Identity: IAzRoleDefinition_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzRoleDefinition_Impl::RoleAssignments(
                    this,
                    core::mem::transmute(&bstrscopename),
                    core::mem::transmute_copy(&brecursive),
                ) {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzRoleDefinition_Impl::AddRoleDefinition(
                    this,
                    core::mem::transmute(&bstrroledefinition),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzRoleDefinition_Impl::DeleteRoleDefinition(
                    this,
                    core::mem::transmute(&bstrroledefinition),
                )
                .into()
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzRoleDefinition as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<IAzTask as windows_core::Interface>::IID
    }
}
#[cfg(all(
    feature = "Win32_System_Com",
...
impl IAzRoleDefinitions_Vtbl {
    pub const fn new<Identity: IAzRoleDefinitions_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Count<Identity: IAzRoleDefinitions_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plcount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzRoleDefinitions as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzRoles_Vtbl {
    pub const fn new<Identity: IAzRoles_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn get_Item<Identity: IAzRoles_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: i32,
            pvarobtptr: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Count<Identity: IAzRoles_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plcount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn _NewEnum<Identity: IAzRoles_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumptr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzRoles as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzScope {
    ...
    pub unsafe fn CanBeDelegated(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CanBeDelegated)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn BizrulesWritable(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BizrulesWritable)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
pub struct IAzScope_Vtbl {
    ...
    #[cfg(not(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    Submit: usize,
    pub CanBeDelegated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub BizrulesWritable: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IAzScope_Vtbl {
    pub const fn new<Identity: IAzScope_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Name<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetName<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrname: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Description<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrdescription: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetDescription<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrdescription: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ApplicationData<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrapplicationdata: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzScope_Impl::SetApplicationData(this, core::mem::transmute(&bstrapplicationdata))
                    .into()
            }
        }
        unsafe extern "system" fn Writable<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pfprop: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetProperty<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpropid: i32,
            varreserved: super::super::System::Variant::VARIANT,
            pvarprop: *mut super::super::System::Variant::VARIANT,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzScope_Impl::GetProperty(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn SetProperty<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpropid: i32,
            varprop: super::super::System::Variant::VARIANT,
            varreserved: super::super::System::Variant::VARIANT,
        ...
        unsafe extern "system" fn AddPropertyItem<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpropid: i32,
            varprop: super::super::System::Variant::VARIANT,
            varreserved: super::super::System::Variant::VARIANT,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzScope_Impl::DeletePropertyItem(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varprop),
                    core::mem::transmute(&varreserved),
        ...
        unsafe extern "system" fn PolicyReaders<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pvarreaders: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzScope_Impl::AddPolicyAdministrator(
                    this,
                    core::mem::transmute(&bstradmin),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzScope_Impl::DeletePolicyAdministrator(
                    this,
                    core::mem::transmute(&bstradmin),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn AddPolicyReader<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrreader: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzScope_Impl::DeletePolicyReader(
                    this,
                    core::mem::transmute(&bstrreader),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzScope_Impl::OpenApplicationGroup(
                    this,
                    core::mem::transmute(&bstrgroupname),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzScope_Impl::CreateApplicationGroup(
                    this,
                    core::mem::transmute(&bstrgroupname),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzScope_Impl::DeleteApplicationGroup(
                    this,
                    core::mem::transmute(&bstrgroupname),
                    core::mem::transmute(&varreserved),
                )
        ...
        unsafe extern "system" fn Roles<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pprolecollection: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn OpenRole<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrrolename: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            pprole: *mut *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CreateRole<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrrolename: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            pprole: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzScope_Impl::CreateRole(
                    this,
                    core::mem::transmute(&bstrrolename),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn DeleteRole<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrrolename: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Tasks<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pptaskcollection: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn OpenTask<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrtaskname: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            pptask: *mut *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn CreateTask<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrtaskname: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
            pptask: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzScope_Impl::CreateTask(
                    this,
                    core::mem::transmute(&bstrtaskname),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn DeleteTask<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrtaskname: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Submit<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn CanBeDelegated<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pfprop: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn BizrulesWritable<Identity: IAzScope_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pfprop: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzScope_Impl::AddPolicyAdministratorName(
                    this,
                    core::mem::transmute(&bstradmin),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzScope_Impl::DeletePolicyAdministratorName(
                    this,
                    core::mem::transmute(&bstradmin),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzScope_Impl::AddPolicyReaderName(
                    this,
                    core::mem::transmute(&bstrreader),
                    core::mem::transmute(&varreserved),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzScope_Impl::DeletePolicyReaderName(
                    this,
                    core::mem::transmute(&bstrreader),
                    core::mem::transmute(&varreserved),
                )
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzScope as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzScope2_Vtbl {
    pub const fn new<Identity: IAzScope2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RoleDefinitions<Identity: IAzScope2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pproledefinitions: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzScope2_Impl::CreateRoleDefinition(
                    this,
                    core::mem::transmute(&bstrroledefinitionname),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzScope2_Impl::OpenRoleDefinition(
                    this,
                    core::mem::transmute(&bstrroledefinitionname),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzScope2_Impl::DeleteRoleDefinition(
                    this,
                    core::mem::transmute(&bstrroledefinitionname),
                )
                .into()
        ...
        unsafe extern "system" fn RoleAssignments<Identity: IAzScope2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pproleassignments: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzScope2_Impl::CreateRoleAssignment(
                    this,
                    core::mem::transmute(&bstrroleassignmentname),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzScope2_Impl::OpenRoleAssignment(
                    this,
                    core::mem::transmute(&bstrroleassignmentname),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzScope2_Impl::DeleteRoleAssignment(
                    this,
                    core::mem::transmute(&bstrroleassignmentname),
                )
                .into()
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzScope2 as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<IAzScope as windows_core::Interface>::IID
    }
}
...
impl IAzScopes_Vtbl {
    pub const fn new<Identity: IAzScopes_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn get_Item<Identity: IAzScopes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: i32,
            pvarobtptr: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Count<Identity: IAzScopes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plcount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn _NewEnum<Identity: IAzScopes_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumptr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzScopes as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
impl IAzTask {
    ...
    pub unsafe fn IsRoleDefinition(&self) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsRoleDefinition)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetIsRoleDefinition(&self, fprop: bool) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetIsRoleDefinition)(
                windows_core::Interface::as_raw(self),
                fprop.into(),
            )
            .ok()
    ...
    pub unsafe fn AddOperation(
        &self,
        bstrop: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddOperation)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrop),
                core::mem::transmute_copy(varreserved),
            )
            .ok()
        }
    ...
    pub unsafe fn AddTask(
        &self,
        bstrtask: &windows_core::BSTR,
        varreserved: &super::super::System::Variant::VARIANT,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).AddTask)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute_copy(bstrtask),
                core::mem::transmute_copy(varreserved),
            )
            .ok()
        }
...
pub struct IAzTask_Vtbl {
    ...
    pub IsRoleDefinition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows_core::BOOL,
    ) -> windows_core::HRESULT,
    pub SetIsRoleDefinition: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::BOOL,
    ) -> windows_core::HRESULT,
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IAzTask_Vtbl {
    pub const fn new<Identity: IAzTask_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Name<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrname: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetName<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrname: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Description<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrdescription: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetDescription<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrdescription: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn ApplicationData<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrapplicationdata: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzTask_Impl::SetApplicationData(this, core::mem::transmute(&bstrapplicationdata))
                    .into()
            }
        }
        unsafe extern "system" fn BizRule<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrprop: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetBizRule<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrprop: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn BizRuleLanguage<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pbstrprop: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn IsRoleDefinition<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pfprop: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetIsRoleDefinition<
            Identity: IAzTask_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            fprop: windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Operations<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pvarprop: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Tasks<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pvarprop: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn AddOperation<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrop: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzTask_Impl::AddOperation(
                    this,
                    core::mem::transmute(&bstrop),
                    core::mem::transmute(&varreserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeleteOperation<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrop: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn AddTask<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrtask: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzTask_Impl::AddTask(
                    this,
                    core::mem::transmute(&bstrtask),
                    core::mem::transmute(&varreserved),
                )
                .into()
            }
        }
        unsafe extern "system" fn DeleteTask<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrtask: *mut core::ffi::c_void,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Writable<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pfprop: *mut windows_core::BOOL,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetProperty<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpropid: i32,
            varreserved: super::super::System::Variant::VARIANT,
            pvarprop: *mut super::super::System::Variant::VARIANT,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzTask_Impl::GetProperty(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varreserved),
                ) {
        ...
        unsafe extern "system" fn SetProperty<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpropid: i32,
            varprop: super::super::System::Variant::VARIANT,
            varreserved: super::super::System::Variant::VARIANT,
        ...
        unsafe extern "system" fn AddPropertyItem<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lpropid: i32,
            varprop: super::super::System::Variant::VARIANT,
            varreserved: super::super::System::Variant::VARIANT,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IAzTask_Impl::DeletePropertyItem(
                    this,
                    core::mem::transmute_copy(&lpropid),
                    core::mem::transmute(&varprop),
                    core::mem::transmute(&varreserved),
        ...
        unsafe extern "system" fn Submit<Identity: IAzTask_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            lflags: i32,
            varreserved: super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
...
impl IAzTask2_Vtbl {
    pub const fn new<Identity: IAzTask2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RoleAssignments<Identity: IAzTask2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            bstrscopename: *mut core::ffi::c_void,
            brecursive: super::super::Foundation::VARIANT_BOOL,
            pproleassignments: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IAzTask2_Impl::RoleAssignments(
                    this,
                    core::mem::transmute(&bstrscopename),
                    core::mem::transmute_copy(&brecursive),
                ) {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzTask2 as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
            || iid == &<IAzTask as windows_core::Interface>::IID
    }
}
...
impl IAzTasks_Vtbl {
    pub const fn new<Identity: IAzTasks_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn get_Item<Identity: IAzTasks_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            index: i32,
            pvarobtptr: *mut super::super::System::Variant::VARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Count<Identity: IAzTasks_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            plcount: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn _NewEnum<Identity: IAzTasks_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumptr: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IAzTasks as windows_core::Interface>::IID
            || iid == &<super::super::System::Com::IDispatch as windows_core::Interface>::IID
    }
}
#[cfg(all(
...
pub type PFN_AUTHZ_COMPUTE_DYNAMIC_GROUPS = Option<
    unsafe extern "system" fn(
        hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE,
        args: *const core::ffi::c_void,
        psidattrarray: *mut *mut super::SID_AND_ATTRIBUTES,
        psidcount: *mut u32,
        prestrictedsidattrarray: *mut *mut super::SID_AND_ATTRIBUTES,
        prestrictedsidcount: *mut u32,
    ) -> windows_core::BOOL,
>;
pub type PFN_AUTHZ_DYNAMIC_ACCESS_CHECK = Option<
    unsafe extern "system" fn(
        hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE,
        pace: *const super::ACE_HEADER,
        pargs: *const core::ffi::c_void,
        pbaceapplicable: *mut windows_core::BOOL,
    ) -> windows_core::BOOL,
>;
pub type PFN_AUTHZ_FREE_CENTRAL_ACCESS_POLICY =
    Option<unsafe extern "system" fn(pcentralaccesspolicy: *const core::ffi::c_void)>;
pub type PFN_AUTHZ_FREE_DYNAMIC_GROUPS =
    Option<unsafe extern "system" fn(psidattrarray: *const super::SID_AND_ATTRIBUTES)>;
pub type PFN_AUTHZ_GET_CENTRAL_ACCESS_POLICY = Option<
    unsafe extern "system" fn(
        hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE,
        capid: super::PSID,
        pargs: *const core::ffi::c_void,
        pcentralaccesspolicyapplicable: *mut windows_core::BOOL,
        ppcentralaccesspolicy: *mut *mut core::ffi::c_void,
    ) -> windows_core::BOOL,
>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const SDDL_ACE_COND_DEVICE_ATTRIBUTE_PREFIX: windows_core::PCWSTR =
    windows_core::w!("@DEVICE.");
pub const SDDL_ACE_COND_END: windows_core::PCWSTR = windows_core::w!(")");
pub const SDDL_ACE_COND_RESOURCE_ATTRIBUTE_PREFIX: windows_core::PCWSTR =
    windows_core::w!("@RESOURCE.");

...
pub unsafe fn OpenPersonalTrustDBDialogEx(
    hwndparent: Option<super::super::Foundation::HWND>,
    dwflags: u32,
    pvreserved: Option<*mut *mut core::ffi::c_void>,
) -> windows_core::BOOL {
...
pub unsafe fn WTHelperCertIsSelfSigned(
    dwencoding: u32,
    pcert: *mut super::Cryptography::CERT_INFO,
) -> windows_core::BOOL {
...
pub unsafe fn WTHelperGetProvPrivateDataFromChain(
    pprovdata: *mut CRYPT_PROVIDER_DATA,
    pgproviderid: *mut windows_core::GUID,
...
pub unsafe fn WTHelperProvDataFromStateData(
    hstatedata: super::super::Foundation::HANDLE,
...
pub unsafe fn WintrustAddActionID(
    pgactionid: *const windows_core::GUID,
    fdwflags: u32,
...
#[inline]
pub unsafe fn WintrustAddDefaultForUsage<P0>(
    pszusageoid: P0,
...
#[inline]
pub unsafe fn WintrustGetDefaultForUsage<P1>(
...
pub const CONFIG_CI_ACTION_VERIFY: windows_core::GUID =
    windows_core::GUID::from_u128(0x6078065b_8f22_4b13_bd9b_5b762776f386);
#[repr(C)]
#[cfg(feature = "Win32_Security_Cryptography")]
...
pub const DRIVER_ACTION_VERIFY: windows_core::GUID =
    windows_core::GUID::from_u128(0xf750e6c3_38ee_11d1_85e5_00c04fc295ee);
pub const DRIVER_CLEANUPPOLICY_FUNCTION: windows_core::PCWSTR =
    windows_core::w!("DriverCleanupPolicy");
pub const DRIVER_FINALPOLPROV_FUNCTION: windows_core::PCWSTR =
    windows_core::w!("DriverFinalPolicy");
pub const DRIVER_INITPROV_FUNCTION: windows_core::PCWSTR =
    windows_core::w!("DriverInitializePolicy");
#[repr(C)]
#[cfg(feature = "Win32_Security_Cryptography")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const GENERIC_CHAIN_CERTTRUST_FUNCTION: windows_core::PCWSTR =
    windows_core::w!("GenericChainCertificateTrust");
pub const GENERIC_CHAIN_FINALPOLICY_FUNCTION: windows_core::PCWSTR =
    windows_core::w!("GenericChainFinalProv");
pub const HTTPSPROV_ACTION: windows_core::GUID =
    windows_core::GUID::from_u128(0x573e31f8_aaba_11d0_8ccb_00c04fc295ee);
pub const HTTPS_CERTTRUST_FUNCTION: windows_core::PCWSTR =
    windows_core::w!("HTTPSCertificateTrust");
...
pub const OFFICESIGN_ACTION_VERIFY: windows_core::GUID =
    windows_core::GUID::from_u128(0x5555c2cd_17fb_11d1_85c4_00c04fc295ee);
pub const OFFICE_CLEANUPPOLICY_FUNCTION: windows_core::PCWSTR =
    windows_core::w!("OfficeCleanupPolicy");
pub const OFFICE_INITPROV_FUNCTION: windows_core::PCWSTR =
    windows_core::w!("OfficeInitializePolicy");
...
pub type PFN_ALLOCANDFILLDEFUSAGE = Option<
    unsafe extern "system" fn(
        pszusageoid: windows_core::PCSTR,
...
pub const SEALING_SIGNATURE_ATTRIBUTE_STRUCT: windows_core::PCSTR =
    windows_core::PCSTR(2011i32 as _);
#[repr(C)]
#[cfg(feature = "Win32_Security_Cryptography")]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const SEALING_TIMESTAMP_ATTRIBUTE_STRUCT: windows_core::PCSTR =
    windows_core::PCSTR(2012i32 as _);
...
pub const SPC_CERT_EXTENSIONS_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.1.14");
pub const SPC_COMMERCIAL_SP_KEY_PURPOSE_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.1.22");
pub const SPC_COMMON_NAME_OBJID: windows_core::PCWSTR = windows_core::w!("2.5.4.3");
pub const SPC_ENCRYPTED_DIGEST_RETRY_COUNT_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.6.2");
...
pub const SPC_FINANCIAL_CRITERIA_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.1.27");
...
pub const SPC_INDIVIDUAL_SP_KEY_PURPOSE_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.1.21");
pub const SPC_JAVA_CLASS_DATA_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.1.20");
...
pub const SPC_MINIMAL_CRITERIA_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.1.26");
...
pub const SPC_NATURAL_AUTH_PLUGIN_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.96.1.1");
#[repr(C)]
#[cfg(feature = "Win32_Security_Cryptography")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const SPC_PE_IMAGE_PAGE_HASHES_V1_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.3.1");
pub const SPC_PE_IMAGE_PAGE_HASHES_V2_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.3.2");
pub const SPC_RAW_FILE_DATA_OBJID: windows_core::PCSTR = windows_core::s!("1.3.6.1.4.1.311.2.1.18");
pub const SPC_RELAXED_PE_MARKER_CHECK_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.6.1");
#[repr(C)]
#[cfg(feature = "Win32_Security_Cryptography")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const SPC_SP_AGENCY_INFO_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.1.10");
...
pub const SPC_STATEMENT_TYPE_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.1.11");
pub const SPC_STATEMENT_TYPE_STRUCT: windows_core::PCSTR = windows_core::PCSTR(2006i32 as _);
pub const SPC_STRUCTURED_STORAGE_DATA_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.1.19");
pub const SPC_TIME_STAMP_REQUEST_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.3.2.1");
pub const SPC_URL_LINK_CHOICE: u32 = 1u32;
pub const SPC_UUID_LENGTH: u32 = 16u32;
pub const SPC_WINDOWS_HELLO_COMPATIBILITY_OBJID: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.10.41.1");
...
pub const SP_GENERIC_CERT_INIT_FUNCTION: windows_core::PCWSTR =
    windows_core::w!("SoftpubDefCertInit");
...
pub const SP_TESTDUMPPOLICY_FUNCTION_TEST: windows_core::PCWSTR =
    windows_core::w!("SoftpubDumpStructure");
...
pub const WINTRUST_ACTION_GENERIC_CERT_VERIFY: windows_core::GUID =
    windows_core::GUID::from_u128(0x189a3842_3041_11d1_85e1_00c04fc295ee);
pub const WINTRUST_ACTION_GENERIC_CHAIN_VERIFY: windows_core::GUID =
    windows_core::GUID::from_u128(0xfc451c16_ac75_11d1_b4b8_00c04fb66ea0);
pub const WINTRUST_ACTION_GENERIC_VERIFY_V2: windows_core::GUID =
    windows_core::GUID::from_u128(0x00aac56b_cd44_11d0_8cc2_00c04fc295ee);
pub const WINTRUST_ACTION_TRUSTPROVIDER_TEST: windows_core::GUID =
    windows_core::GUID::from_u128(0x573e31f8_ddba_11d0_8ccb_00c04fc295ee);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const WINTRUST_CONFIG_REGPATH: windows_core::PCWSTR =
    windows_core::w!("Software\\Microsoft\\Cryptography\\Wintrust\\Config");
#[repr(C)]
#[cfg(feature = "Win32_Security_Cryptography")]
#[derive(Clone, Copy)]
...
pub const WINTRUST_MAX_HASH_BYTES_TO_MAP_VALUE_NAME: windows_core::PCWSTR =
    windows_core::w!("MaxHashBytesToMap");
pub const WINTRUST_MAX_HEADER_BYTES_TO_MAP_DEFAULT: u32 = 10485760u32;
pub const WINTRUST_MAX_HEADER_BYTES_TO_MAP_VALUE_NAME: windows_core::PCWSTR =
    windows_core::w!("MaxHeaderBytesToMap");
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const WIN_SPUB_ACTION_NT_ACTIVATE_IMAGE: windows_core::GUID =
    windows_core::GUID::from_u128(0x8bc96b00_8da1_11cf_8736_00aa00a485eb);
pub const WIN_SPUB_ACTION_PUBLISHED_SOFTWARE: windows_core::GUID =
    windows_core::GUID::from_u128(0x64b9d180_8da2_11cf_8736_00aa00a485eb);
pub const WIN_SPUB_ACTION_TRUSTED_PUBLISHER: windows_core::GUID =
    windows_core::GUID::from_u128(0x66426730_8da1_11cf_8736_00aa00a485eb);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const WIN_TRUST_SUBJTYPE_CABINET: windows_core::GUID =
    windows_core::GUID::from_u128(0xd17c5374_a392_11cf_9df5_00aa00c184e0);
pub const WIN_TRUST_SUBJTYPE_CABINETEX: windows_core::GUID =
    windows_core::GUID::from_u128(0x6f458114_c2f1_11cf_8a69_00aa006c3706);
pub const WIN_TRUST_SUBJTYPE_JAVA_CLASS: windows_core::GUID =
    windows_core::GUID::from_u128(0x08ad3990_8da1_11cf_8736_00aa00a485eb);
pub const WIN_TRUST_SUBJTYPE_JAVA_CLASSEX: windows_core::GUID =
    windows_core::GUID::from_u128(0x6f458113_c2f1_11cf_8a69_00aa006c3706);
pub const WIN_TRUST_SUBJTYPE_OLE_STORAGE: windows_core::GUID =
    windows_core::GUID::from_u128(0xc257e740_8da0_11cf_8736_00aa00a485eb);
pub const WIN_TRUST_SUBJTYPE_PE_IMAGE: windows_core::GUID =
    windows_core::GUID::from_u128(0x43c9a1e0_8da0_11cf_8736_00aa00a485eb);
pub const WIN_TRUST_SUBJTYPE_PE_IMAGEEX: windows_core::GUID =
    windows_core::GUID::from_u128(0x6f458111_c2f1_11cf_8a69_00aa006c3706);
pub const WIN_TRUST_SUBJTYPE_RAW_FILE: windows_core::GUID =
    windows_core::GUID::from_u128(0x959dc450_8d9e_11cf_8736_00aa00a485eb);
pub const WIN_TRUST_SUBJTYPE_RAW_FILEEX: windows_core::GUID =
    windows_core::GUID::from_u128(0x6f458110_c2f1_11cf_8a69_00aa006c3706);
...
pub const WTD_CACHE_ONLY_URL_RETRIEVAL: WINTRUST_DATA_PROVIDER_FLAGS =
    WINTRUST_DATA_PROVIDER_FLAGS(4096u32);
...
pub const WTD_LIFETIME_SIGNING_FLAG: WINTRUST_DATA_PROVIDER_FLAGS =
    WINTRUST_DATA_PROVIDER_FLAGS(2048u32);
...
pub const WTD_NO_POLICY_USAGE_FLAG: WINTRUST_DATA_PROVIDER_FLAGS =
    WINTRUST_DATA_PROVIDER_FLAGS(4u32);
pub const WTD_PROV_FLAGS_MASK: u32 = 65535u32;
pub const WTD_REVOCATION_CHECK_CHAIN: WINTRUST_DATA_PROVIDER_FLAGS =
    WINTRUST_DATA_PROVIDER_FLAGS(64u32);
pub const WTD_REVOCATION_CHECK_CHAIN_EXCLUDE_ROOT: WINTRUST_DATA_PROVIDER_FLAGS =
    WINTRUST_DATA_PROVIDER_FLAGS(128u32);
pub const WTD_REVOCATION_CHECK_END_CERT: WINTRUST_DATA_PROVIDER_FLAGS =
    WINTRUST_DATA_PROVIDER_FLAGS(32u32);
pub const WTD_REVOCATION_CHECK_NONE: WINTRUST_DATA_PROVIDER_FLAGS =
    WINTRUST_DATA_PROVIDER_FLAGS(16u32);
...
pub const WTD_USE_DEFAULT_OSVER_CHECK: WINTRUST_DATA_PROVIDER_FLAGS =
    WINTRUST_DATA_PROVIDER_FLAGS(1024u32);
...
pub const WT_PROVIDER_CERTTRUST_FUNCTION: windows_core::PCWSTR =
    windows_core::w!("WintrustCertificateTrust");
...
pub const szOID_PKCS_9_SEQUENCE_NUMBER: windows_core::PCSTR =
    windows_core::s!("1.2.840.113549.1.9.25.4");
...
pub const szOID_TRUSTED_CLIENT_AUTH_CA_LIST: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.2.2");
pub const szOID_TRUSTED_CODESIGNING_CA_LIST: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.2.1");
pub const szOID_TRUSTED_SERVER_AUTH_CA_LIST: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.2.2.3");

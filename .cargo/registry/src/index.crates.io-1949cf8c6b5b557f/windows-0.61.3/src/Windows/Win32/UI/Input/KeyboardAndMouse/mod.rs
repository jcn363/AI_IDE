...
pub unsafe fn GetMouseMovePointsEx(
    ...
    unsafe {
        GetMouseMovePointsEx(
            cbsize,
            lppt,
            core::mem::transmute(lpptbuf.as_ptr()),
            lpptbuf.len().try_into().unwrap(),
            resolution,
        )
    }
}
...
#[inline]
pub unsafe fn LoadKeyboardLayoutA<P0>(
    pwszklid: P0,
    flags: ACTIVATE_KEYBOARD_LAYOUT_FLAGS,
) -> windows_core::Result<HKL>
where
...
#[inline]
pub unsafe fn LoadKeyboardLayoutW<P0>(
    pwszklid: P0,
    flags: ACTIVATE_KEYBOARD_LAYOUT_FLAGS,
) -> windows_core::Result<HKL>
where
...
pub unsafe fn ToAsciiEx(
    ...
    unsafe {
        ToAsciiEx(
            ...
            lpchar as _,
            uflags,
            dwhkl.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn ToUnicode(
    ...
    unsafe {
        ToUnicode(
            ...
            core::mem::transmute(pwszbuff.as_ptr()),
            pwszbuff.len().try_into().unwrap(),
            wflags,
        )
    }
}
...
pub unsafe fn ToUnicodeEx(
    ...
    unsafe {
        ToUnicodeEx(
            wvirtkey,
            wscancode,
            core::mem::transmute(lpkeystate.as_ptr()),
            core::mem::transmute(pwszbuff.as_ptr()),
            pwszbuff.len().try_into().unwrap(),
            wflags,
            dwhkl.unwrap_or(core::mem::zeroed()) as _,

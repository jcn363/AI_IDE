    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        InitiateSystemShutdownA(
            ...
            lpmessage.param().abi(),
            dwtimeout,
            bforceappsclosed.into(),
            brebootaftershutdown.into(),
        )
        .ok()
    }
}
...
#[inline]
pub unsafe fn ShutdownBlockReasonCreate<P1>(
...
#[inline]
pub unsafe fn ShutdownBlockReasonDestroy(
    hwnd: super::super::Foundation::HWND,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn ShutdownBlockReasonQuery(
    hwnd: super::super::Foundation::HWND,
    pwszbuff: Option<windows_core::PWSTR>,
    pcchbuff: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        ShutdownBlockReasonQuery(
            hwnd,
            pwszbuff.unwrap_or(core::mem::zeroed()) as _,
            pcchbuff as _,
        )
        .ok()
    }
...
pub const SHTDN_REASON_FLAG_DIRTY_PROBLEM_ID_REQUIRED: SHUTDOWN_REASON =
    SHUTDOWN_REASON(33554432u32);

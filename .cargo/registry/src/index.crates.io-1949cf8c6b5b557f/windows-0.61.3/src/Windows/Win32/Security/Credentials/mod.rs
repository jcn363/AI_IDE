...
#[inline]
pub unsafe fn CredEnumerateA<P0>(
    filter: P0,
...
#[inline]
pub unsafe fn CredEnumerateW<P0>(
    filter: P0,
    flags: Option<CRED_ENUMERATE_FLAGS>,
    count: *mut u32,
...
#[inline]
pub unsafe fn CredFindBestCredentialA<P0>(
    targetname: P0,
    r#type: u32,
    flags: u32,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CredFindBestCredentialA(targetname.param().abi(), r#type, flags, credential as _).ok()
    }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        CredFindBestCredentialW(targetname.param().abi(), r#type, flags, credential as _).ok()
    }
}
#[inline]
...
pub unsafe fn CredGetSessionTypes(maximumpersist: &mut [u32]) -> windows_core::Result<()> {
    ...
    unsafe {
        CredGetSessionTypes(
            maximumpersist.len().try_into().unwrap(),
            core::mem::transmute(maximumpersist.as_ptr()),
        )
        .ok()
    }
}
#[inline]
pub unsafe fn CredGetTargetInfoA<P0>(
    targetname: P0,
    flags: u32,
...
pub unsafe fn CredMarshalCredentialA(
    ...
    credential: *const core::ffi::c_void,
    marshaledcredential: *mut windows_core::PSTR,
) -> windows_core::Result<()> {
...
pub unsafe fn CredMarshalCredentialW(
    credtype: CRED_MARSHAL_TYPE,
    credential: *const core::ffi::c_void,
    marshaledcredential: *mut windows_core::PWSTR,
) -> windows_core::Result<()> {
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CredPackAuthenticationBufferA(
            ...
            ppackedcredentials.unwrap_or(core::mem::zeroed()) as _,
            pcbpackedcredentials as _,
        )
        .ok()
    }
}
...
pub unsafe fn CredProtectA(
    fasself: bool,
    pszcredentials: &[u8],
    pszprotectedcredentials: windows_core::PSTR,
    ...
    unsafe {
        CredProtectA(
            fasself.into(),
            core::mem::transmute(pszcredentials.as_ptr()),
            pszcredentials.len().try_into().unwrap(),
            core::mem::transmute(pszprotectedcredentials),
            pcchmaxchars as _,
            protectiontype.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
...
pub unsafe fn CredProtectW(
    fasself: bool,
    pszcredentials: &[u16],
    pszprotectedcredentials: windows_core::PWSTR,
    pcchmaxchars: *mut u32,
    protectiontype: Option<*mut CRED_PROTECTION_TYPE>,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn CredRenameA<P0, P1>(
    oldtargetname: P0,
    newtargetname: P1,
    r#type: CRED_TYPE,
    flags: Option<u32>,
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CredRenameA(
            oldtargetname.param().abi(),
            newtargetname.param().abi(),
            r#type,
            flags.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
...
#[inline]
pub unsafe fn CredRenameW<P0, P1>(
    oldtargetname: P0,
    newtargetname: P1,
    r#type: CRED_TYPE,
    flags: Option<u32>,
...
pub unsafe fn CredUICmdLinePromptForCredentialsA<P0>(
    ...
    username: &mut [u8],
    pszpassword: &mut [u8],
    pfsave: Option<*mut windows_core::BOOL>,
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CredUICmdLinePromptForCredentialsA(
            ...
            dwautherror,
            core::mem::transmute(username.as_ptr()),
            username.len().try_into().unwrap(),
            core::mem::transmute(pszpassword.as_ptr()),
            pszpassword.len().try_into().unwrap(),
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CredUIParseUserNameA(
            username.param().abi(),
            core::mem::transmute(user.as_ptr()),
            user.len().try_into().unwrap(),
            core::mem::transmute(domain.as_ptr()),
...
pub unsafe fn CredUIPromptForCredentialsA<P1>(
    ...
    pszusername: &mut [u8],
    pszpassword: &mut [u8],
    save: Option<*mut windows_core::BOOL>,
    dwflags: CREDUI_FLAGS,
) -> super::super::Foundation::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        CredUIPromptForCredentialsA(
            ...
            pcontext.unwrap_or(core::mem::zeroed()) as _,
            dwautherror,
            core::mem::transmute(pszusername.as_ptr()),
            pszusername.len().try_into().unwrap(),
            core::mem::transmute(pszpassword.as_ptr()),
            pszpassword.len().try_into().unwrap(),
            save.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
        )
    }
}
...
pub unsafe fn CredUIPromptForWindowsCredentialsA(
    ...
    pvinauthbuffer: Option<*const core::ffi::c_void>,
    ulinauthbuffersize: u32,
    ppvoutauthbuffer: *mut *mut core::ffi::c_void,
    ...
    unsafe {
        CredUIPromptForWindowsCredentialsA(
            ...
            dwautherror,
            pulauthpackage as _,
            pvinauthbuffer.unwrap_or(core::mem::zeroed()) as _,
            ulinauthbuffersize,
            ppvoutauthbuffer as _,
            puloutauthbuffersize as _,
            pfsave.unwrap_or(core::mem::zeroed()) as _,
            dwflags,
        )
    }
...
pub unsafe fn CredUnPackAuthenticationBufferA(
    dwflags: CRED_PACK_FLAGS,
    pauthbuffer: *const core::ffi::c_void,
    cbauthbuffer: u32,
    pszusername: Option<windows_core::PSTR>,
    pcchlmaxusername: *mut u32,
    pszdomainname: Option<windows_core::PSTR>,
    pcchmaxdomainname: Option<*mut u32>,
    pszpassword: Option<windows_core::PSTR>,
    ...
    unsafe {
        CredUnPackAuthenticationBufferA(
            ...
            pauthbuffer,
            cbauthbuffer,
            pszusername.unwrap_or(core::mem::zeroed()) as _,
            pcchlmaxusername as _,
            pszdomainname.unwrap_or(core::mem::zeroed()) as _,
            pcchmaxdomainname.unwrap_or(core::mem::zeroed()) as _,
            pszpassword.unwrap_or(core::mem::zeroed()) as _,
            pcchmaxpassword as _,
        )
        .ok()
    }
}
...
pub unsafe fn CredUnPackAuthenticationBufferW(
    ...
    pauthbuffer: *const core::ffi::c_void,
    cbauthbuffer: u32,
    pszusername: Option<windows_core::PWSTR>,
    pcchmaxusername: *mut u32,
    pszdomainname: Option<windows_core::PWSTR>,
    pcchmaxdomainname: Option<*mut u32>,
    pszpassword: Option<windows_core::PWSTR>,
    pcchmaxpassword: *mut u32,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn CredUnmarshalCredentialA<P0>(
    marshaledcredential: P0,
    credtype: *mut CRED_MARSHAL_TYPE,
    credential: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn CredUnmarshalCredentialW<P0>(
    marshaledcredential: P0,
    credtype: *mut CRED_MARSHAL_TYPE,
    credential: *mut *mut core::ffi::c_void,
) -> windows_core::Result<()>
...
pub unsafe fn CredUnprotectA(
    ...
    pszcredentials: Option<windows_core::PSTR>,
    pcchmaxchars: *mut u32,
) -> windows_core::Result<()> {
    ...
    unsafe {
        CredUnprotectA(
            fasself.into(),
            core::mem::transmute(pszprotectedcredentials.as_ptr()),
            pszprotectedcredentials.len().try_into().unwrap(),
            pszcredentials.unwrap_or(core::mem::zeroed()) as _,
            pcchmaxchars as _,
        )
        .ok()
    }
...
pub unsafe fn CredUnprotectW(
    ...
    pszcredentials: Option<windows_core::PWSTR>,
    pcchmaxchars: *mut u32,
) -> windows_core::Result<()> {
...
pub unsafe fn KeyCredentialManagerGetOperationErrorStates(
    ...
    unsafe {
        KeyCredentialManagerGetOperationErrorStates(
            ...
            isready as _,
            keycredentialmanageroperationerrorstates as _,
        )
        .ok()
    }
}
...
pub unsafe fn KeyCredentialManagerShowUIOperation(
    ...
    unsafe {
        KeyCredentialManagerShowUIOperation(hwndowner, keycredentialmanageroperationtype).ok()
    }
}
#[inline]
...
#[inline]
pub unsafe fn SCardAddReaderToGroupA<P1, P2>(
    hcontext: usize,
    szreadername: P1,
    szgroupname: P2,
) -> i32
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SCardAddReaderToGroupA(
            hcontext,
            szreadername.param().abi(),
            szgroupname.param().abi(),
        )
    }
}
#[inline]
pub unsafe fn SCardAddReaderToGroupW<P1, P2>(
    hcontext: usize,
    szreadername: P1,
    szgroupname: P2,
) -> i32
...
#[inline]
pub unsafe fn SCardConnectA<P1>(
    hcontext: usize,
    szreader: P1,
    dwsharemode: u32,
...
pub unsafe fn SCardEstablishContext(
    dwscope: SCARD_SCOPE,
    pvreserved1: Option<*const core::ffi::c_void>,
    pvreserved2: Option<*const core::ffi::c_void>,
    phcontext: *mut usize,
) -> i32 {
    ...
    unsafe {
        SCardEstablishContext(
            ...
            pvreserved2.unwrap_or(core::mem::zeroed()) as _,
            phcontext as _,
        )
    }
}
...
pub unsafe fn SCardGetAttrib(
    ...
    unsafe {
        SCardGetAttrib(
            hcard,
            dwattrid,
            pbattr.unwrap_or(core::mem::zeroed()) as _,
            pcbattrlen as _,
        )
    }
}
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SCardGetCardTypeProviderNameA(
            hcontext,
            szcardname.param().abi(),
            dwproviderid,
            core::mem::transmute(szprovider),
            pcchprovider as _,
        )
    }
}
...
#[inline]
pub unsafe fn SCardGetProviderIdA<P1>(
    hcontext: usize,
    szcard: P1,
    pguidproviderid: *mut windows_core::GUID,
) -> i32
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn SCardGetProviderIdW<P1>(
    hcontext: usize,
    szcard: P1,
    pguidproviderid: *mut windows_core::GUID,
) -> i32
...
#[inline]
pub unsafe fn SCardGetReaderDeviceInstanceIdA<P1>(
    hcontext: usize,
    szreadername: P1,
    szdeviceinstanceid: Option<windows_core::PSTR>,
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SCardGetReaderDeviceInstanceIdA(
            hcontext,
            szreadername.param().abi(),
            szdeviceinstanceid.unwrap_or(core::mem::zeroed()) as _,
            pcchdeviceinstanceid as _,
        )
    }
}
#[inline]
pub unsafe fn SCardGetReaderDeviceInstanceIdW<P1>(
    hcontext: usize,
    szreadername: P1,
    szdeviceinstanceid: Option<windows_core::PWSTR>,
    pcchdeviceinstanceid: *mut u32,
) -> i32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn SCardIntroduceCardTypeA<P1>(
    hcontext: usize,
    szcardname: P1,
    pguidprimaryprovider: Option<*const windows_core::GUID>,
    rgguidinterfaces: Option<*const windows_core::GUID>,
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SCardIntroduceCardTypeA(
            hcontext,
            szcardname.param().abi(),
            pguidprimaryprovider.unwrap_or(core::mem::zeroed()) as _,
            rgguidinterfaces.unwrap_or(core::mem::zeroed()) as _,
            dwinterfacecount,
            pbatr,
            pbatrmask,
            cbatrlen,
...
#[inline]
pub unsafe fn SCardIntroduceReaderA<P1, P2>(
    hcontext: usize,
    szreadername: P1,
    szdevicename: P2,
) -> i32
...
pub unsafe fn SCardListCardsA(
    hcontext: usize,
    pbatr: Option<*const u8>,
    rgquidinterfaces: Option<&[windows_core::GUID]>,
    mszcards: Option<windows_core::PSTR>,
    pcchcards: *mut u32,
) -> i32 {
    ...
    unsafe {
        SCardListCardsA(
            hcontext,
            pbatr.unwrap_or(core::mem::zeroed()) as _,
            core::mem::transmute(
                rgquidinterfaces
                    .as_deref()
            ...
            mszcards.unwrap_or(core::mem::zeroed()) as _,
            pcchcards as _,
        )
    }
}
...
pub unsafe fn SCardListCardsW(
    ...
    pbatr: Option<*const u8>,
    rgquidinterfaces: Option<&[windows_core::GUID]>,
    mszcards: Option<windows_core::PWSTR>,
    pcchcards: *mut u32,
) -> i32 {
...
#[inline]
pub unsafe fn SCardListInterfacesA<P1>(
    hcontext: usize,
    szcard: P1,
    pguidinterfaces: *mut windows_core::GUID,
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SCardListInterfacesA(
            hcontext,
            szcard.param().abi(),
            pguidinterfaces as _,
            pcguidinterfaces as _,
        )
    }
}
#[inline]
...
pub unsafe fn SCardListReaderGroupsA(
    hcontext: usize,
    mszgroups: Option<windows_core::PSTR>,
    pcchgroups: *mut u32,
) -> i32 {
    ...
    unsafe {
        SCardListReaderGroupsA(
            hcontext,
            mszgroups.unwrap_or(core::mem::zeroed()) as _,
            pcchgroups as _,
        )
    }
}
...
pub unsafe fn SCardListReaderGroupsW(
    hcontext: usize,
    mszgroups: Option<windows_core::PWSTR>,
    pcchgroups: *mut u32,
) -> i32 {
...
pub unsafe fn SCardListReadersA<P1>(
    hcontext: usize,
    mszgroups: P1,
    mszreaders: Option<windows_core::PSTR>,
    pcchreaders: *mut u32,
) -> i32
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe {
        SCardListReadersA(
            hcontext,
            mszgroups.param().abi(),
            mszreaders.unwrap_or(core::mem::zeroed()) as _,
            pcchreaders as _,
        )
    }
}
...
pub unsafe fn SCardListReadersW<P1>(
    hcontext: usize,
    mszgroups: P1,
    mszreaders: Option<windows_core::PWSTR>,
    pcchreaders: *mut u32,
) -> i32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn SCardListReadersWithDeviceInstanceIdA<P1>(
    hcontext: usize,
    szdeviceinstanceid: P1,
    mszreaders: Option<windows_core::PSTR>,
    pcchreaders: *mut u32,
) -> i32
where
...
#[inline]
pub unsafe fn SCardListReadersWithDeviceInstanceIdW<P1>(
    hcontext: usize,
    szdeviceinstanceid: P1,
    mszreaders: Option<windows_core::PWSTR>,
    pcchreaders: *mut u32,
...
#[inline]
pub unsafe fn SCardLocateCardsA<P1>(
    hcontext: usize,
    mszcards: P1,
    rgreaderstates: *mut SCARD_READERSTATEA,
    creaders: u32,
...
pub unsafe fn SCardReadCacheA<P3>(
    hcontext: usize,
    cardidentifier: *const windows_core::GUID,
...
pub unsafe fn SCardReconnect(
    ...
    pdwactiveprotocol: Option<*mut u32>,
) -> i32 {
    ...
    unsafe {
        SCardReconnect(
            ...
            dwpreferredprotocols,
            dwinitialization,
            pdwactiveprotocol.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
...
#[inline]
pub unsafe fn SCardRemoveReaderFromGroupW<P1, P2>(
    hcontext: usize,
    szreadername: P1,
    szgroupname: P2,
) -> i32
...
pub unsafe fn SCardSetAttrib(hcard: usize, dwattrid: u32, pbattr: &[u8]) -> i32 {
    ...
    unsafe {
        SCardSetAttrib(
            hcard,
            dwattrid,
            core::mem::transmute(pbattr.as_ptr()),
            pbattr.len().try_into().unwrap(),
        )
    }
}
#[inline]
...
pub unsafe fn SCardStatusA(
    hcard: usize,
    mszreadernames: Option<windows_core::PSTR>,
    pcchreaderlen: Option<*mut u32>,
    pdwstate: Option<*mut u32>,
    pdwprotocol: Option<*mut u32>,
    pbatr: Option<*mut u8>,
    pcbatrlen: Option<*mut u32>,
) -> i32 {
    ...
    unsafe {
        SCardStatusA(
            hcard,
            mszreadernames.unwrap_or(core::mem::zeroed()) as _,
            pcchreaderlen.unwrap_or(core::mem::zeroed()) as _,
            pdwstate.unwrap_or(core::mem::zeroed()) as _,
            pdwprotocol.unwrap_or(core::mem::zeroed()) as _,
            pbatr.unwrap_or(core::mem::zeroed()) as _,
            pcbatrlen.unwrap_or(core::mem::zeroed()) as _,
        )
    }
}
#[inline]
pub unsafe fn SCardStatusW(
    hcard: usize,
    mszreadernames: Option<windows_core::PWSTR>,
    pcchreaderlen: Option<*mut u32>,
    pdwstate: Option<*mut u32>,
    pdwprotocol: Option<*mut u32>,
    pbatr: Option<*mut u8>,
...
pub unsafe fn SCardTransmit(
    ...
    pbsendbuffer: &[u8],
    piorecvpci: Option<*mut SCARD_IO_REQUEST>,
    pbrecvbuffer: *mut u8,
    ...
    unsafe {
        SCardTransmit(
            hcard,
            piosendpci,
            core::mem::transmute(pbsendbuffer.as_ptr()),
            pbsendbuffer.len().try_into().unwrap(),
            piorecvpci.unwrap_or(core::mem::zeroed()) as _,
            pbrecvbuffer as _,
            pcbrecvlength as _,
        )
    }
...
#[inline]
pub unsafe fn SCardWriteCacheA<P3>(
    hcontext: usize,
    cardidentifier: *const windows_core::GUID,
    freshnesscounter: u32,
    lookupname: P3,
...
pub const CRED_TARGETNAME_ATTRIBUTE_CACHEDINTERACTIVE: windows_core::PCWSTR =
    windows_core::w!("cachedinteractive");
pub const CRED_TARGETNAME_ATTRIBUTE_CACHEDINTERACTIVE_A: windows_core::PCSTR =
    windows_core::s!("cachedinteractive");
pub const CRED_TARGETNAME_ATTRIBUTE_CACHEDINTERACTIVE_W: windows_core::PCWSTR =
    windows_core::w!("cachedinteractive");
pub const CRED_TARGETNAME_ATTRIBUTE_INTERACTIVE: windows_core::PCWSTR =
    windows_core::w!("interactive");
pub const CRED_TARGETNAME_ATTRIBUTE_INTERACTIVE_A: windows_core::PCSTR =
    windows_core::s!("interactive");
pub const CRED_TARGETNAME_ATTRIBUTE_INTERACTIVE_W: windows_core::PCWSTR =
    windows_core::w!("interactive");
...
pub const CRED_TARGETNAME_ATTRIBUTE_NETWORKCLEARTEXT: windows_core::PCWSTR =
    windows_core::w!("networkcleartext");
pub const CRED_TARGETNAME_ATTRIBUTE_NETWORKCLEARTEXT_A: windows_core::PCSTR =
    windows_core::s!("networkcleartext");
pub const CRED_TARGETNAME_ATTRIBUTE_NETWORKCLEARTEXT_W: windows_core::PCWSTR =
    windows_core::w!("networkcleartext");
...
pub const CRED_TARGETNAME_ATTRIBUTE_REMOTEINTERACTIVE: windows_core::PCWSTR =
    windows_core::w!("remoteinteractive");
pub const CRED_TARGETNAME_ATTRIBUTE_REMOTEINTERACTIVE_A: windows_core::PCSTR =
    windows_core::s!("remoteinteractive");
pub const CRED_TARGETNAME_ATTRIBUTE_REMOTEINTERACTIVE_W: windows_core::PCWSTR =
    windows_core::w!("remoteinteractive");
...
pub const CRED_TARGETNAME_LEGACYGENERIC_NAMESPACE_A: windows_core::PCSTR =
    windows_core::s!("LegacyGeneric");
pub const CRED_TARGETNAME_LEGACYGENERIC_NAMESPACE_W: windows_core::PCWSTR =
    windows_core::w!("LegacyGeneric");
...
pub const GUID_DEVINTERFACE_SMARTCARD_READER: windows_core::GUID =
...
pub const KeyCredentialManagerOperationErrorStateCertificateFailure:
    KeyCredentialManagerOperationErrorStates = KeyCredentialManagerOperationErrorStates(4i32);
pub const KeyCredentialManagerOperationErrorStateDeviceJoinFailure:
    KeyCredentialManagerOperationErrorStates = KeyCredentialManagerOperationErrorStates(1i32);
pub const KeyCredentialManagerOperationErrorStateHardwareFailure:
    KeyCredentialManagerOperationErrorStates = KeyCredentialManagerOperationErrorStates(32i32);
pub const KeyCredentialManagerOperationErrorStateNone: KeyCredentialManagerOperationErrorStates =
    KeyCredentialManagerOperationErrorStates(0i32);
pub const KeyCredentialManagerOperationErrorStatePinExistsFailure:
    KeyCredentialManagerOperationErrorStates = KeyCredentialManagerOperationErrorStates(64i32);
pub const KeyCredentialManagerOperationErrorStatePolicyFailure:
    KeyCredentialManagerOperationErrorStates = KeyCredentialManagerOperationErrorStates(16i32);
pub const KeyCredentialManagerOperationErrorStateRemoteSessionFailure:
    KeyCredentialManagerOperationErrorStates = KeyCredentialManagerOperationErrorStates(8i32);
pub const KeyCredentialManagerOperationErrorStateTokenFailure:
    KeyCredentialManagerOperationErrorStates = KeyCredentialManagerOperationErrorStates(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
>;
pub type LPOCNCONNPROCW = Option<
    unsafe extern "system" fn(
        param0: usize,
...
>;
pub type LPOCNDSCPROC = Option<
    unsafe extern "system" fn(param0: usize, param1: usize, param2: *const core::ffi::c_void),
>;
...
pub const SCARD_DEFAULT_READERS: windows_core::PCWSTR =
    windows_core::w!("SCard$DefaultReaders\u{0}00");
...
pub const SCARD_SYSTEM_READERS: windows_core::PCWSTR =
    windows_core::w!("SCard$SystemReaders\u{0}00");
...
pub const szOID_TS_KP_TS_SERVER_AUTH: windows_core::PCSTR =
    windows_core::s!("1.3.6.1.4.1.311.54.1.2");

#[inline]
pub unsafe fn FilterAttach<P0, P1, P2>(
    lpfiltername: P0,
    lpvolumename: P1,
    lpinstancename: P2,
    dwcreatedinstancenamelength: Option<u32>,
    lpcreatedinstancename: Option<windows_core::PWSTR>,
) -> windows_core::Result<()>
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        FilterAttach(
            lpfiltername.param().abi(),
            lpvolumename.param().abi(),
            lpinstancename.param().abi(),
            dwcreatedinstancenamelength.unwrap_or(core::mem::zeroed()) as _,
            lpcreatedinstancename.unwrap_or(core::mem::zeroed()) as _,
        )
        .ok()
    }
}
#[inline]
pub unsafe fn FilterAttachAtAltitude<P0, P1, P2, P3>(
    lpfiltername: P0,
    lpvolumename: P1,
    lpaltitude: P2,
    lpinstancename: P3,
...
#[inline]
pub unsafe fn FilterConnectCommunicationPort<P0>(
    lpportname: P0,
    dwoptions: u32,
...
pub unsafe fn FilterFindFirst(
    ...
    lpfilterfind: *mut super::super::Foundation::HANDLE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn FilterGetDosName<P0>(
    lpvolumename: P0,
    lpdosname: &mut [u16],
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        FilterGetDosName(
            lpvolumename.param().abi(),
            core::mem::transmute(lpdosname.as_ptr()),
            lpdosname.len().try_into().unwrap(),
        )
        .ok()
    }
}
#[inline]
pub unsafe fn FilterGetInformation(
    hfilter: HFILTER,
    dwinformationclass: FILTER_INFORMATION_CLASS,
    lpbuffer: *mut core::ffi::c_void,
    dwbuffersize: u32,
...
#[inline]
pub unsafe fn FilterInstanceCreate<P0, P1, P2>(
    lpfiltername: P0,
    lpvolumename: P1,
    lpinstancename: P2,
) -> windows_core::Result<HFILTER_INSTANCE>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
...
pub unsafe fn FilterInstanceFindFirst<P0>(
    ...
    dwbuffersize: u32,
    lpbytesreturned: *mut u32,
    lpfilterinstancefind: *mut super::super::Foundation::HANDLE,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
pub unsafe fn FilterVolumeFindFirst(
    ...
    dwbuffersize: u32,
    lpbytesreturned: *mut u32,
    lpvolumefind: *mut super::super::Foundation::HANDLE,
) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn FilterVolumeInstanceFindFirst<P0>(
    lpvolumename: P0,
    dwinformationclass: INSTANCE_INFORMATION_CLASS,
    lpbuffer: *mut core::ffi::c_void,
    dwbuffersize: u32,
    lpbytesreturned: *mut u32,
    lpvolumeinstancefind: *mut super::super::Foundation::HANDLE,
) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{

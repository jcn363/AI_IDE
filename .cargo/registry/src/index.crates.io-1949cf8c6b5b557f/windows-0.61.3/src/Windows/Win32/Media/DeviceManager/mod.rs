...
pub const EVENT_WMDM_CONTENT_TRANSFER: windows_core::GUID =
    windows_core::GUID::from_u128(0x339c9bf4_bcfe_4ed8_94df_eaf8c26ab61b);
windows_core::imp::define_interface!(
    IComponentAuthenticate,
    IComponentAuthenticate_Vtbl,
    0xa9889c00_6d2b_11d3_8496_00c04f79dbc0
);
windows_core::imp::interface_hierarchy!(IComponentAuthenticate, windows_core::IUnknown);
impl IComponentAuthenticate {
    pub unsafe fn SACAuth(
        &self,
        dwprotocolid: u32,
        dwpass: u32,
        pbdatain: &[u8],
        ppbdataout: *mut *mut u8,
        pdwdataoutlen: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SACAuth)(
                windows_core::Interface::as_raw(self),
                dwprotocolid,
                dwpass,
                core::mem::transmute(pbdatain.as_ptr()),
                pbdatain.len().try_into().unwrap(),
                ppbdataout as _,
                pdwdataoutlen as _,
            )
            .ok()
    ...
    pub unsafe fn SACGetProtocols(
        &self,
        ppdwprotocols: *mut *mut u32,
        pdwprotocolcount: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SACGetProtocols)(
                windows_core::Interface::as_raw(self),
                ppdwprotocols as _,
                pdwprotocolcount as _,
            )
            .ok()
        }
    }
...
pub struct IComponentAuthenticate_Vtbl {
    ...
    pub SACAuth: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const u8,
    ...
    pub SACGetProtocols: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
...
impl IComponentAuthenticate_Vtbl {
    pub const fn new<Identity: IComponentAuthenticate_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SACAuth<
        ...
        >(
            ...
            unsafe {
                ...
                IComponentAuthenticate_Impl::SACAuth(
                    this,
                    core::mem::transmute_copy(&dwprotocolid),
                    core::mem::transmute_copy(&dwpass),
                    core::mem::transmute_copy(&pbdatain),
                    core::mem::transmute_copy(&dwdatainlen),
                    core::mem::transmute_copy(&ppbdataout),
                    core::mem::transmute_copy(&pdwdataoutlen),
                )
                .into()
            }
        }
        unsafe extern "system" fn SACGetProtocols<
            Identity: IComponentAuthenticate_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IComponentAuthenticate_Impl::SACGetProtocols(
                    this,
                    core::mem::transmute_copy(&ppdwprotocols),
                    core::mem::transmute_copy(&pdwprotocolcount),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IMDSPDevice,
    IMDSPDevice_Vtbl,
    0x1dcb3a12_33ed_11d3_8470_00c04f79dbc0
);
...
impl IMDSPDevice {
    pub unsafe fn GetName(&self, pwszname: &mut [u16]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pwszname.as_ptr()),
                pwszname.len().try_into().unwrap(),
            )
            .ok()
        }
    }
    pub unsafe fn GetManufacturer(&self, pwszname: &mut [u16]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetManufacturer)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pwszname.as_ptr()),
                pwszname.len().try_into().unwrap(),
            )
    ...
    pub unsafe fn GetSerialNumber(
        &self,
        pserialnumber: *mut WMDMID,
        abmac: &mut [u8; 8],
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetSerialNumber)(
                windows_core::Interface::as_raw(self),
                pserialnumber as _,
    ...
    pub unsafe fn GetPowerSource(
        &self,
        pdwpowersource: *mut u32,
        pdwpercentremaining: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetPowerSource)(
                windows_core::Interface::as_raw(self),
                pdwpowersource as _,
                pdwpercentremaining as _,
            )
            .ok()
        }
    }
    ...
    pub unsafe fn EnumStorage(&self) -> windows_core::Result<IMDSPEnumStorage> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumStorage)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
    ...
    pub unsafe fn GetFormatSupport(
        &self,
        pformatex: *mut *mut super::Audio::WAVEFORMATEX,
        pnformatcount: *mut u32,
        pppwszmimetype: *mut *mut windows_core::PWSTR,
        pnmimetypecount: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetFormatSupport)(
                windows_core::Interface::as_raw(self),
                pformatex as _,
                pnformatcount as _,
                pppwszmimetype as _,
                pnmimetypecount as _,
            )
            .ok()
        }
    }
    pub unsafe fn SendOpaqueCommand(
        &self,
        pcommand: *mut OPAQUECOMMAND,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SendOpaqueCommand)(
                windows_core::Interface::as_raw(self),
                pcommand as _,
            )
            .ok()
...
pub struct IMDSPDevice_Vtbl {
    ...
    pub GetManufacturer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PWSTR,
        u32,
    ) -> windows_core::HRESULT,
    ...
    pub GetType:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetSerialNumber: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WMDMID,
        *mut u8,
    ) -> windows_core::HRESULT,
    pub GetPowerSource: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    ...
    pub GetDeviceIcon:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub EnumStorage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_Media_Audio")]
    pub GetFormatSupport: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut super::Audio::WAVEFORMATEX,
        *mut u32,
    ...
    pub SendOpaqueCommand: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut OPAQUECOMMAND,
    ) -> windows_core::HRESULT,
}
...
impl IMDSPDevice_Vtbl {
    pub const fn new<Identity: IMDSPDevice_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetName<Identity: IMDSPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwszname: windows_core::PWSTR,
            nmaxchars: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPDevice_Impl::GetName(
                    this,
                    core::mem::transmute_copy(&pwszname),
                    core::mem::transmute_copy(&nmaxchars),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetManufacturer<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPDevice_Impl::GetManufacturer(
                    this,
                    core::mem::transmute_copy(&pwszname),
                    core::mem::transmute_copy(&nmaxchars),
                )
        ...
        unsafe extern "system" fn GetVersion<Identity: IMDSPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwversion: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetType<Identity: IMDSPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwtype: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetSerialNumber<
            Identity: IMDSPDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPDevice_Impl::GetSerialNumber(
                    this,
                    core::mem::transmute_copy(&pserialnumber),
                    core::mem::transmute_copy(&abmac),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetPowerSource<
            Identity: IMDSPDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPDevice_Impl::GetPowerSource(
                    this,
                    core::mem::transmute_copy(&pdwpowersource),
                    core::mem::transmute_copy(&pdwpercentremaining),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetStatus<Identity: IMDSPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwstatus: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetDeviceIcon<Identity: IMDSPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hicon: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn EnumStorage<Identity: IMDSPDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetFormatSupport<
            Identity: IMDSPDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPDevice_Impl::GetFormatSupport(
                    this,
                    core::mem::transmute_copy(&pformatex),
                    core::mem::transmute_copy(&pnformatcount),
                    core::mem::transmute_copy(&pppwszmimetype),
                    core::mem::transmute_copy(&pnmimetypecount),
                )
                .into()
            }
        }
        unsafe extern "system" fn SendOpaqueCommand<
            Identity: IMDSPDevice_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPDevice_Impl::SendOpaqueCommand(this, core::mem::transmute_copy(&pcommand))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    IMDSPDevice2,
    IMDSPDevice2_Vtbl,
    0x420d16ad_c97d_4e00_82aa_00e9f4335ddd
);
...
impl IMDSPDevice2 {
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStorage)(
                windows_core::Interface::as_raw(self),
                pszstoragename.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn GetFormatSupport2(
        &self,
        dwflags: u32,
        ppaudioformatex: *mut *mut super::Audio::WAVEFORMATEX,
        pnaudioformatcount: *mut u32,
        ppvideoformatex: *mut *mut super::MediaFoundation::VIDEOINFOHEADER,
        pnvideoformatcount: *mut u32,
        ppfiletype: *mut *mut WMFILECAPABILITIES,
        pnfiletypecount: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetFormatSupport2)(
                windows_core::Interface::as_raw(self),
                dwflags,
                ppaudioformatex as _,
                pnaudioformatcount as _,
                ppvideoformatex as _,
                pnvideoformatcount as _,
                ppfiletype as _,
                pnfiletypecount as _,
            )
            .ok()
        }
    }
    ...
    pub unsafe fn GetSpecifyPropertyPages(
        &self,
        ppspecifyproppages: *mut Option<super::super::System::Ole::ISpecifyPropertyPages>,
        pppunknowns: *mut *mut Option<windows_core::IUnknown>,
        pcunks: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetSpecifyPropertyPages)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(ppspecifyproppages),
                pppunknowns as _,
                pcunks as _,
            )
            .ok()
    ...
    pub unsafe fn GetCanonicalName(&self, pwszpnpname: &mut [u16]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetCanonicalName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pwszpnpname.as_ptr()),
                pwszpnpname.len().try_into().unwrap(),
            )
            .ok()
        }
    }
...
pub struct IMDSPDevice2_Vtbl {
    ...
    pub GetStorage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub GetFormatSupport2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut super::Audio::WAVEFORMATEX,
        *mut u32,
        *mut *mut super::MediaFoundation::VIDEOINFOHEADER,
        *mut u32,
        *mut *mut WMFILECAPABILITIES,
        *mut u32,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(
        feature = "Win32_Graphics_Gdi",
    ...
    #[cfg(feature = "Win32_System_Ole")]
    pub GetSpecifyPropertyPages: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    pub GetCanonicalName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PWSTR,
        u32,
    ) -> windows_core::HRESULT,
...
pub trait IMDSPDevice2_Impl: IMDSPDevice_Impl {
    fn GetStorage(
        &self,
        pszstoragename: &windows_core::PCWSTR,
    ...
    fn GetSpecifyPropertyPages(
        &self,
        ppspecifyproppages: windows_core::OutRef<
            '_,
    ...
    fn GetCanonicalName(
        &self,
        pwszpnpname: windows_core::PWSTR,
        nmaxchars: u32,
    ) -> windows_core::Result<()>;
}
#[cfg(all(
...
impl IMDSPDevice2_Vtbl {
    pub const fn new<Identity: IMDSPDevice2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetStorage<Identity: IMDSPDevice2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszstoragename: windows_core::PCWSTR,
            ppstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPDevice2_Impl::GetFormatSupport2(
                    this,
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&ppaudioformatex),
                    core::mem::transmute_copy(&pnaudioformatcount),
                    core::mem::transmute_copy(&ppvideoformatex),
                    core::mem::transmute_copy(&pnvideoformatcount),
                    core::mem::transmute_copy(&ppfiletype),
                    core::mem::transmute_copy(&pnfiletypecount),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetSpecifyPropertyPages<
            Identity: IMDSPDevice2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppspecifyproppages: *mut *mut core::ffi::c_void,
            pppunknowns: *mut *mut *mut core::ffi::c_void,
            pcunks: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPDevice2_Impl::GetSpecifyPropertyPages(
                    this,
                    core::mem::transmute_copy(&ppspecifyproppages),
                    core::mem::transmute_copy(&pppunknowns),
                    core::mem::transmute_copy(&pcunks),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetCanonicalName<
            Identity: IMDSPDevice2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPDevice2_Impl::GetCanonicalName(
                    this,
                    core::mem::transmute_copy(&pwszpnpname),
                    core::mem::transmute_copy(&nmaxchars),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    IMDSPDevice3,
    IMDSPDevice3_Vtbl,
    0x1a839845_fc55_487c_976f_ee38ac0e8c4e
);
...
impl IMDSPDevice3 {
    ...
    ) -> windows_core::Result<WMDM_FORMAT_CAPABILITY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFormatCapability)(
                windows_core::Interface::as_raw(self),
                format,
                &mut result__,
            )
    ...
    pub unsafe fn DeviceIoControl(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).DeviceIoControl)(
                windows_core::Interface::as_raw(self),
                dwiocontrolcode,
                core::mem::transmute(lpinbuffer.as_ptr()),
                lpinbuffer.len().try_into().unwrap(),
                lpoutbuffer as _,
                pnoutbuffersize as _,
            )
            .ok()
        }
    }
    pub unsafe fn FindStorage<P1>(
        &self,
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindStorage)(
                windows_core::Interface::as_raw(self),
                findscope,
                pwszuniqueid.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub struct IMDSPDevice3_Vtbl {
    ...
    pub GetFormatCapability: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WMDM_FORMATCODE,
        *mut WMDM_FORMAT_CAPABILITY,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(
        feature = "Win32_System_Com_StructuredStorage",
        feature = "Win32_System_Variant"
    ...
    pub DeviceIoControl: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        u32,
    ...
    pub FindStorage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WMDM_FIND_SCOPE,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
...
pub trait IMDSPDevice3_Impl: IMDSPDevice2_Impl {
    fn GetProperty(
        &self,
        pwszpropname: &windows_core::PCWSTR,
    ) -> windows_core::Result<super::super::System::Com::StructuredStorage::PROPVARIANT>;
    fn SetProperty(
        &self,
        pwszpropname: &windows_core::PCWSTR,
    ...
    fn FindStorage(
        &self,
        findscope: WMDM_FIND_SCOPE,
        pwszuniqueid: &windows_core::PCWSTR,
    ) -> windows_core::Result<IMDSPStorage>;
}
#[cfg(all(
    feature = "Win32_Graphics_Gdi",
...
impl IMDSPDevice3_Vtbl {
    pub const fn new<Identity: IMDSPDevice3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetProperty<Identity: IMDSPDevice3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwszpropname: windows_core::PCWSTR,
        ...
        unsafe extern "system" fn SetProperty<Identity: IMDSPDevice3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwszpropname: windows_core::PCWSTR,
            pvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPDevice3_Impl::SetProperty(
                    this,
                    core::mem::transmute(&pwszpropname),
                    core::mem::transmute_copy(&pvalue),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetFormatCapability<
            Identity: IMDSPDevice3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            format: WMDM_FORMATCODE,
            pformatsupport: *mut WMDM_FORMAT_CAPABILITY,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMDSPDevice3_Impl::GetFormatCapability(
                    this,
        ...
        unsafe extern "system" fn DeviceIoControl<
            Identity: IMDSPDevice3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPDevice3_Impl::DeviceIoControl(
                    this,
                    core::mem::transmute_copy(&dwiocontrolcode),
                    core::mem::transmute_copy(&lpinbuffer),
                    core::mem::transmute_copy(&ninbuffersize),
                    core::mem::transmute_copy(&lpoutbuffer),
                    core::mem::transmute_copy(&pnoutbuffersize),
                )
                .into()
            }
        }
        unsafe extern "system" fn FindStorage<Identity: IMDSPDevice3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            findscope: WMDM_FIND_SCOPE,
            pwszuniqueid: windows_core::PCWSTR,
            ppstorage: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMDSPDevice3_Impl::FindStorage(
                    this,
                    core::mem::transmute_copy(&findscope),
                    core::mem::transmute(&pwszuniqueid),
                ) {
                    Ok(ok__) => {
                        ppstorage.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
...
windows_core::imp::define_interface!(
    ...
    0x1dcb3a14_33ed_11d3_8470_00c04f79dbc0
);
...
impl IMDSPDeviceControl {
    pub unsafe fn GetDCStatus(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDCStatus)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn Record(
        &self,
        pformat: *const super::Audio::WAVEFORMATEX,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Record)(
                windows_core::Interface::as_raw(self),
                pformat,
            )
            .ok()
...
pub struct IMDSPDeviceControl_Vtbl {
    ...
    pub Record: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const super::Audio::WAVEFORMATEX,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Media_Audio"))]
    Record: usize,
...
impl IMDSPDeviceControl_Vtbl {
    pub const fn new<Identity: IMDSPDeviceControl_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDCStatus<
        ...
        unsafe extern "system" fn Play<Identity: IMDSPDeviceControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Record<Identity: IMDSPDeviceControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pformat: *const super::Audio::WAVEFORMATEX,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Pause<Identity: IMDSPDeviceControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Resume<Identity: IMDSPDeviceControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Stop<Identity: IMDSPDeviceControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Seek<Identity: IMDSPDeviceControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fumode: u32,
            noffset: i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPDeviceControl_Impl::Seek(
                    this,
                    core::mem::transmute_copy(&fumode),
                    core::mem::transmute_copy(&noffset),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0xc2fe57a8_9304_478c_9ee4_47e397b912d7
);
windows_core::imp::interface_hierarchy!(IMDSPDirectTransfer, windows_core::IUnknown);
impl IMDSPDirectTransfer {
    pub unsafe fn TransferToDevice<P0, P1, P3, P4, P5>(
        &self,
        pwszsourcefilepath: P0,
        psourceoperation: P1,
        fuflags: u32,
        pwszdestinationname: P3,
        psourcemetadata: P4,
        ptransferprogress: P5,
    ) -> windows_core::Result<IMDSPStorage>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        ...
        P5: windows_core::Param<IWMDMProgress>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TransferToDevice)(
                windows_core::Interface::as_raw(self),
                pwszsourcefilepath.param().abi(),
                psourceoperation.param().abi(),
                fuflags,
                pwszdestinationname.param().abi(),
                psourcemetadata.param().abi(),
                ptransferprogress.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub struct IMDSPDirectTransfer_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub TransferToDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut core::ffi::c_void,
        u32,
...
pub trait IMDSPDirectTransfer_Impl: windows_core::IUnknownImpl {
    fn TransferToDevice(
        &self,
        pwszsourcefilepath: &windows_core::PCWSTR,
        psourceoperation: windows_core::Ref<'_, IWMDMOperation>,
        fuflags: u32,
        pwszdestinationname: &windows_core::PCWSTR,
        psourcemetadata: windows_core::Ref<'_, IWMDMMetaData>,
        ptransferprogress: windows_core::Ref<'_, IWMDMProgress>,
    ) -> windows_core::Result<IMDSPStorage>;
}
impl IMDSPDirectTransfer_Vtbl {
    pub const fn new<Identity: IMDSPDirectTransfer_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn TransferToDevice<
            Identity: IMDSPDirectTransfer_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pwszsourcefilepath: windows_core::PCWSTR,
            psourceoperation: *mut core::ffi::c_void,
            fuflags: u32,
            pwszdestinationname: windows_core::PCWSTR,
            psourcemetadata: *mut core::ffi::c_void,
            ptransferprogress: *mut core::ffi::c_void,
            ppnewobject: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMDSPDirectTransfer_Impl::TransferToDevice(
                    this,
                    core::mem::transmute(&pwszsourcefilepath),
                    core::mem::transmute_copy(&psourceoperation),
                    core::mem::transmute_copy(&fuflags),
                    core::mem::transmute(&pwszdestinationname),
                    core::mem::transmute_copy(&psourcemetadata),
                    core::mem::transmute_copy(&ptransferprogress),
                ) {
                    Ok(ok__) => {
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            TransferToDevice: TransferToDevice::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IMDSPEnumDevice_Vtbl {
    pub const fn new<Identity: IMDSPEnumDevice_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Next<Identity: IMDSPEnumDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
        ...
        unsafe extern "system" fn Skip<Identity: IMDSPEnumDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            pceltfetched: *mut u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Reset<Identity: IMDSPEnumDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Clone<Identity: IMDSPEnumDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumdevice: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x1dcb3a15_33ed_11d3_8470_00c04f79dbc0
);
windows_core::imp::interface_hierarchy!(IMDSPEnumStorage, windows_core::IUnknown);
impl IMDSPEnumStorage {
    pub unsafe fn Next(
        &self,
        ppstorage: &mut [Option<IMDSPStorage>],
        pceltfetched: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Next)(
                windows_core::Interface::as_raw(self),
                ppstorage.len().try_into().unwrap(),
                core::mem::transmute(ppstorage.as_ptr()),
                pceltfetched as _,
            )
            .ok()
        }
...
impl IMDSPEnumStorage_Vtbl {
    pub const fn new<Identity: IMDSPEnumStorage_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Next<Identity: IMDSPEnumStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            ppstorage: *mut *mut core::ffi::c_void,
            pceltfetched: *mut u32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPEnumStorage_Impl::Next(
                    this,
                    core::mem::transmute_copy(&celt),
                    core::mem::transmute_copy(&ppstorage),
                    core::mem::transmute_copy(&pceltfetched),
                )
                .into()
            }
        }
        unsafe extern "system" fn Skip<Identity: IMDSPEnumStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            pceltfetched: *mut u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Reset<Identity: IMDSPEnumStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Clone<Identity: IMDSPEnumStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    IMDSPObject,
    IMDSPObject_Vtbl,
    0x1dcb3a18_33ed_11d3_8470_00c04f79dbc0
);
        ...
        P1: windows_core::Param<IWMDMProgress>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).Rename)(
                windows_core::Interface::as_raw(self),
                pwsznewname.param().abi(),
                pprogress.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn Move<P1, P2>(
        &self,
        fumode: u32,
        pprogress: P1,
        ptarget: P2,
...
pub trait IMDSPObject_Impl: windows_core::IUnknownImpl {
    ...
    fn Delete(
        &self,
        fumode: u32,
        pprogress: windows_core::Ref<'_, IWMDMProgress>,
    ) -> windows_core::Result<()>;
    fn Seek(&self, fuflags: u32, dwoffset: u32) -> windows_core::Result<()>;
    fn Rename(
        &self,
        pwsznewname: &windows_core::PCWSTR,
        pprogress: windows_core::Ref<'_, IWMDMProgress>,
    ) -> windows_core::Result<()>;
    fn Move(
        &self,
        fumode: u32,
        pprogress: windows_core::Ref<'_, IWMDMProgress>,
        ptarget: windows_core::Ref<'_, IMDSPStorage>,
    ) -> windows_core::Result<()>;
    fn Close(&self) -> windows_core::Result<()>;
}
impl IMDSPObject_Vtbl {
    pub const fn new<Identity: IMDSPObject_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Open<Identity: IMDSPObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fumode: u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Read<Identity: IMDSPObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdata: *mut u8,
            pdwsize: *mut u32,
            abmac: *mut u8,
        ...
        unsafe extern "system" fn Write<Identity: IMDSPObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdata: *const u8,
            pdwsize: *mut u32,
            abmac: *mut u8,
        ...
        unsafe extern "system" fn Delete<Identity: IMDSPObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fumode: u32,
            pprogress: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPObject_Impl::Delete(
                    this,
                    core::mem::transmute_copy(&fumode),
                    core::mem::transmute_copy(&pprogress),
                )
                .into()
            }
        }
        unsafe extern "system" fn Seek<Identity: IMDSPObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fuflags: u32,
            dwoffset: u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Rename<Identity: IMDSPObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwsznewname: windows_core::PCWSTR,
            pprogress: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPObject_Impl::Rename(
                    this,
                    core::mem::transmute(&pwsznewname),
                    core::mem::transmute_copy(&pprogress),
                )
                .into()
            }
        }
        unsafe extern "system" fn Move<Identity: IMDSPObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fumode: u32,
            pprogress: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Close<Identity: IMDSPObject_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    IMDSPObject2,
    IMDSPObject2_Vtbl,
    0x3f34cd3e_5907_4341_9af9_97f4187c3aa5
);
...
impl IMDSPObject2 {
    pub unsafe fn ReadOnClearChannel(
        &self,
        pdata: *mut u8,
        pdwsize: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).ReadOnClearChannel)(
                windows_core::Interface::as_raw(self),
                pdata as _,
                pdwsize as _,
            )
    ...
    pub unsafe fn WriteOnClearChannel(
        &self,
        pdata: *const u8,
        pdwsize: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).WriteOnClearChannel)(
                windows_core::Interface::as_raw(self),
                pdata,
                pdwsize as _,
            )
...
pub struct IMDSPObject2_Vtbl {
    ...
    pub ReadOnClearChannel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub WriteOnClearChannel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const u8,
        *mut u32,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IMDSPObject2_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPObject2_Impl::ReadOnClearChannel(
                    this,
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&pdwsize),
                )
        ...
        unsafe extern "system" fn WriteOnClearChannel<
            Identity: IMDSPObject2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPObject2_Impl::WriteOnClearChannel(
                    this,
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&pdwsize),
                )
...
windows_core::imp::define_interface!(
    ...
    0x1dcb3a19_33ed_11d3_8470_00c04f79dbc0
);
...
impl IMDSPObjectInfo {
    pub unsafe fn GetPlayLength(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPlayLength)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetPlayLength(&self, dwlength: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPlayLength)(
                windows_core::Interface::as_raw(self),
                dwlength,
            )
            .ok()
    ...
    pub unsafe fn GetPlayOffset(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPlayOffset)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn SetPlayOffset(&self, dwoffset: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetPlayOffset)(
                windows_core::Interface::as_raw(self),
                dwoffset,
            )
            .ok()
    ...
    pub unsafe fn GetTotalLength(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTotalLength)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetLastPlayPosition(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLastPlayPosition)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetLongestPlayPosition(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLongestPlayPosition)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
impl IMDSPObjectInfo_Vtbl {
    pub const fn new<Identity: IMDSPObjectInfo_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetPlayLength<
        ...
        unsafe extern "system" fn SetPlayLength<
            Identity: IMDSPObjectInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPObjectInfo_Impl::SetPlayLength(this, core::mem::transmute_copy(&dwlength))
                    .into()
            }
        }
        unsafe extern "system" fn GetPlayOffset<
            Identity: IMDSPObjectInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetPlayOffset<
            Identity: IMDSPObjectInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPObjectInfo_Impl::SetPlayOffset(this, core::mem::transmute_copy(&dwoffset))
                    .into()
            }
        }
        unsafe extern "system" fn GetTotalLength<
            Identity: IMDSPObjectInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetLastPlayPosition<
            Identity: IMDSPObjectInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetLongestPlayPosition<
            Identity: IMDSPObjectInfo_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pdwlongestpos: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    IMDSPRevoked,
    IMDSPRevoked_Vtbl,
    0xa4e8f2d4_3f31_464d_b53d_4fc335998184
);
windows_core::imp::interface_hierarchy!(IMDSPRevoked, windows_core::IUnknown);
impl IMDSPRevoked {
    pub unsafe fn GetRevocationURL(
        &self,
        ppwszrevocationurl: *mut windows_core::PWSTR,
        pdwbufferlen: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetRevocationURL)(
                windows_core::Interface::as_raw(self),
                ppwszrevocationurl as _,
                pdwbufferlen as _,
            )
            .ok()
        }
...
pub struct IMDSPRevoked_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetRevocationURL: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl IMDSPRevoked_Vtbl {
    pub const fn new<Identity: IMDSPRevoked_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetRevocationURL<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPRevoked_Impl::GetRevocationURL(
                    this,
                    core::mem::transmute_copy(&ppwszrevocationurl),
                    core::mem::transmute_copy(&pdwbufferlen),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetRevocationURL: GetRevocationURL::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IMDSPStorage,
    IMDSPStorage_Vtbl,
    0x1dcb3a16_33ed_11d3_8470_00c04f79dbc0
);
...
impl IMDSPStorage {
    ...
    pub unsafe fn SetAttributes(
        &self,
        dwattributes: u32,
        pformat: Option<*const super::Audio::WAVEFORMATEX>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetAttributes)(
                windows_core::Interface::as_raw(self),
                dwattributes,
                pformat.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetStorageGlobals(&self) -> windows_core::Result<IMDSPStorageGlobals> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStorageGlobals)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn GetAttributes(
        ...
        pformat: Option<*mut super::Audio::WAVEFORMATEX>,
    ) -> windows_core::Result<()> {
        unsafe {
    ...
    pub unsafe fn GetDate(&self) -> windows_core::Result<WMDMDATETIME> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDate)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    #[cfg(feature = "Win32_Media_Audio")]
    pub unsafe fn CreateStorage<P2>(
        &self,
        dwattributes: u32,
        pformat: Option<*const super::Audio::WAVEFORMATEX>,
        pwszname: P2,
...
pub struct IMDSPStorage_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_Media_Audio")]
    pub SetAttributes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const super::Audio::WAVEFORMATEX,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Media_Audio"))]
    SetAttributes: usize,
    pub GetStorageGlobals: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_Media_Audio")]
    ...
    pub GetDate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WMDMDATETIME,
    ) -> windows_core::HRESULT,
...
pub trait IMDSPStorage_Impl: windows_core::IUnknownImpl {
    ...
    fn GetAttributes(
        &self,
        pdwattributes: *mut u32,
        pformat: *mut super::Audio::WAVEFORMATEX,
    ) -> windows_core::Result<()>;
    fn GetName(&self, pwszname: windows_core::PWSTR, nmaxchars: u32) -> windows_core::Result<()>;
...
impl IMDSPStorage_Vtbl {
    pub const fn new<Identity: IMDSPStorage_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetAttributes<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorage_Impl::SetAttributes(
                    this,
                    core::mem::transmute_copy(&dwattributes),
                    core::mem::transmute_copy(&pformat),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetStorageGlobals<
            Identity: IMDSPStorage_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppstorageglobals: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorage_Impl::GetAttributes(
                    this,
        ...
        unsafe extern "system" fn GetName<Identity: IMDSPStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwszname: windows_core::PWSTR,
            nmaxchars: u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetDate<Identity: IMDSPStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdatetimeutc: *mut WMDMDATETIME,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetSize<Identity: IMDSPStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwsizelow: *mut u32,
            pdwsizehigh: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorage_Impl::GetSize(
                    this,
                    core::mem::transmute_copy(&pdwsizelow),
                    core::mem::transmute_copy(&pdwsizehigh),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetRights<Identity: IMDSPStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pprights: *mut *mut WMDMRIGHTS,
            pnrightscount: *mut u32,
            abmac: *mut u8,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorage_Impl::GetRights(
                    this,
                    core::mem::transmute_copy(&pprights),
                    core::mem::transmute_copy(&pnrightscount),
                    core::mem::transmute_copy(&abmac),
                )
                .into()
            }
        }
        unsafe extern "system" fn CreateStorage<
            Identity: IMDSPStorage_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            pformat: *const super::Audio::WAVEFORMATEX,
            pwszname: windows_core::PCWSTR,
            ppnewstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMDSPStorage_Impl::CreateStorage(
                    this,
                    core::mem::transmute_copy(&dwattributes),
                    core::mem::transmute_copy(&pformat),
        ...
        unsafe extern "system" fn EnumStorage<Identity: IMDSPStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorage_Impl::SendOpaqueCommand(this, core::mem::transmute_copy(&pcommand))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    IMDSPStorage2,
    IMDSPStorage2_Vtbl,
    0x0a5e07a5_6454_4451_9c36_1c6ae7e2b1d6
);
...
impl IMDSPStorage2 {
    ...
    pub unsafe fn CreateStorage2<P4>(
        &self,
        dwattributes: u32,
        dwattributesex: u32,
        paudioformat: Option<*const super::Audio::WAVEFORMATEX>,
        pvideoformat: Option<*const super::MediaFoundation::VIDEOINFOHEADER>,
        pwszname: P4,
        qwfilesize: u64,
    ) -> windows_core::Result<IMDSPStorage>
    where
        P4: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateStorage2)(
                windows_core::Interface::as_raw(self),
                dwattributes,
                dwattributesex,
                paudioformat.unwrap_or(core::mem::zeroed()) as _,
                pvideoformat.unwrap_or(core::mem::zeroed()) as _,
                pwszname.param().abi(),
                qwfilesize,
                &mut result__,
            )
    ...
    pub unsafe fn SetAttributes2(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetAttributes2)(
                windows_core::Interface::as_raw(self),
                dwattributes,
                dwattributesex,
                paudioformat.unwrap_or(core::mem::zeroed()) as _,
    ...
    pub unsafe fn GetAttributes2(
        &self,
        pdwattributes: *mut u32,
        pdwattributesex: *mut u32,
        paudioformat: Option<*mut super::Audio::WAVEFORMATEX>,
        pvideoformat: Option<*mut super::MediaFoundation::VIDEOINFOHEADER>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetAttributes2)(
                windows_core::Interface::as_raw(self),
                pdwattributes as _,
                pdwattributesex as _,
                paudioformat.unwrap_or(core::mem::zeroed()) as _,
                pvideoformat.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
...
pub struct IMDSPStorage2_Vtbl {
    ...
    pub CreateStorage2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const super::Audio::WAVEFORMATEX,
        *const super::MediaFoundation::VIDEOINFOHEADER,
        windows_core::PCWSTR,
        u64,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetAttributes2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const super::Audio::WAVEFORMATEX,
    ...
    pub GetAttributes2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
        *mut super::Audio::WAVEFORMATEX,
        *mut super::MediaFoundation::VIDEOINFOHEADER,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(
        feature = "Win32_Graphics_Gdi",
        feature = "Win32_Media_Audio",
...
pub trait IMDSPStorage2_Impl: IMDSPStorage_Impl {
    ...
    fn CreateStorage2(
        ...
        dwattributes: u32,
        dwattributesex: u32,
        paudioformat: *const super::Audio::WAVEFORMATEX,
        pvideoformat: *const super::MediaFoundation::VIDEOINFOHEADER,
        pwszname: &windows_core::PCWSTR,
        qwfilesize: u64,
    ) -> windows_core::Result<IMDSPStorage>;
    fn SetAttributes2(
    ...
    fn GetAttributes2(
        ...
        pdwattributes: *mut u32,
        pdwattributesex: *mut u32,
        paudioformat: *mut super::Audio::WAVEFORMATEX,
        pvideoformat: *mut super::MediaFoundation::VIDEOINFOHEADER,
    ) -> windows_core::Result<()>;
}
#[cfg(all(
    feature = "Win32_Graphics_Gdi",
...
impl IMDSPStorage2_Vtbl {
    pub const fn new<Identity: IMDSPStorage2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetStorage<Identity: IMDSPStorage2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszstoragename: windows_core::PCWSTR,
            ppstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn CreateStorage2<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMDSPStorage2_Impl::CreateStorage2(
                    this,
                    core::mem::transmute_copy(&dwattributes),
                    core::mem::transmute_copy(&dwattributesex),
                    core::mem::transmute_copy(&paudioformat),
                    core::mem::transmute_copy(&pvideoformat),
                    core::mem::transmute(&pwszname),
                    core::mem::transmute_copy(&qwfilesize),
                ) {
                    Ok(ok__) => {
                        ppnewstorage.write(core::mem::transmute(ok__));
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn SetAttributes2<
            Identity: IMDSPStorage2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorage2_Impl::SetAttributes2(
                    this,
                    core::mem::transmute_copy(&dwattributes),
                    core::mem::transmute_copy(&dwattributesex),
                    core::mem::transmute_copy(&paudioformat),
        ...
        unsafe extern "system" fn GetAttributes2<
            Identity: IMDSPStorage2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorage2_Impl::GetAttributes2(
                    this,
                    core::mem::transmute_copy(&pdwattributes),
                    core::mem::transmute_copy(&pdwattributesex),
                    core::mem::transmute_copy(&paudioformat),
                    core::mem::transmute_copy(&pvideoformat),
                )
                .into()
...
windows_core::imp::define_interface!(
    IMDSPStorage3,
    IMDSPStorage3_Vtbl,
    0x6c669867_97ed_4a67_9706_1c5529d2a414
);
...
impl IMDSPStorage3 {
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).SetMetadata)(
                windows_core::Interface::as_raw(self),
                pmetadata.param().abi(),
            )
            .ok()
...
pub struct IMDSPStorage3_Vtbl {
    ...
    pub SetMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub trait IMDSPStorage3_Impl: IMDSPStorage2_Impl {
    fn GetMetadata(
        &self,
        pmetadata: windows_core::Ref<'_, IWMDMMetaData>,
    ) -> windows_core::Result<()>;
    fn SetMetadata(
        &self,
        pmetadata: windows_core::Ref<'_, IWMDMMetaData>,
...
impl IMDSPStorage3_Vtbl {
    pub const fn new<Identity: IMDSPStorage3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetMetadata<Identity: IMDSPStorage3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pmetadata: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetMetadata<Identity: IMDSPStorage3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pmetadata: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl IMDSPStorage4 {
    pub unsafe fn SetReferences(
        &self,
        ppispstorage: Option<&[Option<IMDSPStorage>]>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetReferences)(
                windows_core::Interface::as_raw(self),
                ppispstorage
                    .as_deref()
    ...
    pub unsafe fn GetReferences(
        &self,
        pdwrefs: *mut u32,
        pppispstorage: *mut *mut Option<IMDSPStorage>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetReferences)(
                windows_core::Interface::as_raw(self),
                pdwrefs as _,
                pppispstorage as _,
            )
    ...
    pub unsafe fn CreateStorageWithMetadata<P1, P2>(
        &self,
        dwattributes: u32,
        pwszname: P1,
        pmetadata: P2,
        ...
        P2: windows_core::Param<IWMDMMetaData>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateStorageWithMetadata)(
                windows_core::Interface::as_raw(self),
                dwattributes,
                pwszname.param().abi(),
                pmetadata.param().abi(),
    ...
    pub unsafe fn GetSpecifiedMetadata<P2>(
        &self,
        ppwszpropnames: &[windows_core::PCWSTR],
        pmetadata: P2,
    ) -> windows_core::Result<()>
    where
        P2: windows_core::Param<IWMDMMetaData>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetSpecifiedMetadata)(
                windows_core::Interface::as_raw(self),
                ppwszpropnames.len().try_into().unwrap(),
                core::mem::transmute(ppwszpropnames.as_ptr()),
                pmetadata.param().abi(),
            )
            .ok()
        }
...
pub struct IMDSPStorage4_Vtbl {
    ...
    pub SetReferences: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetReferences: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateStorageWithMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        *mut core::ffi::c_void,
    ...
    pub GetSpecifiedMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
...
pub trait IMDSPStorage4_Impl: IMDSPStorage3_Impl {
    ...
    fn GetSpecifiedMetadata(
        &self,
        cproperties: u32,
        ppwszpropnames: *const windows_core::PCWSTR,
        pmetadata: windows_core::Ref<'_, IWMDMMetaData>,
    ) -> windows_core::Result<()>;
    fn FindStorage(
        &self,
...
impl IMDSPStorage4_Vtbl {
    pub const fn new<Identity: IMDSPStorage4_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetReferences<
            Identity: IMDSPStorage4_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            dwrefs: u32,
            ppispstorage: *const *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorage4_Impl::SetReferences(
                    this,
                    core::mem::transmute_copy(&dwrefs),
                    core::mem::transmute_copy(&ppispstorage),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetReferences<
            Identity: IMDSPStorage4_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pdwrefs: *mut u32,
            pppispstorage: *mut *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorage4_Impl::GetReferences(
                    this,
                    core::mem::transmute_copy(&pdwrefs),
                    core::mem::transmute_copy(&pppispstorage),
                )
                .into()
            }
        }
        unsafe extern "system" fn CreateStorageWithMetadata<
            Identity: IMDSPStorage4_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMDSPStorage4_Impl::CreateStorageWithMetadata(
                    this,
                    core::mem::transmute_copy(&dwattributes),
                    core::mem::transmute(&pwszname),
        ...
        unsafe extern "system" fn GetSpecifiedMetadata<
            Identity: IMDSPStorage4_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorage4_Impl::GetSpecifiedMetadata(
                    this,
                    core::mem::transmute_copy(&cproperties),
                    core::mem::transmute_copy(&ppwszpropnames),
                    core::mem::transmute_copy(&pmetadata),
                )
                .into()
            }
        }
        unsafe extern "system" fn FindStorage<Identity: IMDSPStorage4_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            findscope: WMDM_FIND_SCOPE,
            pwszuniqueid: windows_core::PCWSTR,
            ppstorage: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IMDSPStorage4_Impl::FindStorage(
                    this,
                    core::mem::transmute_copy(&findscope),
                    core::mem::transmute(&pwszuniqueid),
                ) {
        ...
        unsafe extern "system" fn GetParent<Identity: IMDSPStorage4_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    ...
    0x1dcb3a17_33ed_11d3_8470_00c04f79dbc0
);
...
impl IMDSPStorageGlobals {
    ...
    pub unsafe fn GetTotalSize(
        &self,
        pdwtotalsizelow: *mut u32,
        pdwtotalsizehigh: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetTotalSize)(
                windows_core::Interface::as_raw(self),
                pdwtotalsizelow as _,
                pdwtotalsizehigh as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetTotalFree(
        &self,
        pdwfreelow: *mut u32,
        pdwfreehigh: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetTotalFree)(
                windows_core::Interface::as_raw(self),
                pdwfreelow as _,
                pdwfreehigh as _,
            )
    ...
    pub unsafe fn GetTotalBad(
        &self,
        pdwbadlow: *mut u32,
        pdwbadhigh: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetTotalBad)(
                windows_core::Interface::as_raw(self),
                pdwbadlow as _,
                pdwbadhigh as _,
            )
    ...
    pub unsafe fn GetRootStorage(&self) -> windows_core::Result<IMDSPStorage> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRootStorage)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IMDSPStorageGlobals_Vtbl {
    ...
    pub GetTotalSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetTotalFree: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub GetTotalBad: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    ...
    pub GetRootStorage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait IMDSPStorageGlobals_Impl: windows_core::IUnknownImpl {
    ...
    fn GetTotalFree(&self, pdwfreelow: *mut u32, pdwfreehigh: *mut u32)
        -> windows_core::Result<()>;
    ...
    pub const fn new<Identity: IMDSPStorageGlobals_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorageGlobals_Impl::GetSerialNumber(
                    this,
                    core::mem::transmute_copy(&pserialnum),
                    core::mem::transmute_copy(&abmac),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetTotalSize<
            Identity: IMDSPStorageGlobals_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorageGlobals_Impl::GetTotalSize(
                    this,
                    core::mem::transmute_copy(&pdwtotalsizelow),
                    core::mem::transmute_copy(&pdwtotalsizehigh),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetTotalFree<
            Identity: IMDSPStorageGlobals_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorageGlobals_Impl::GetTotalFree(
                    this,
                    core::mem::transmute_copy(&pdwfreelow),
                    core::mem::transmute_copy(&pdwfreehigh),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetTotalBad<
            Identity: IMDSPStorageGlobals_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorageGlobals_Impl::GetTotalBad(
                    this,
                    core::mem::transmute_copy(&pdwbadlow),
                    core::mem::transmute_copy(&pdwbadhigh),
                )
                .into()
            }
        }
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDSPStorageGlobals_Impl::Initialize(
                    this,
                    core::mem::transmute_copy(&fumode),
                    core::mem::transmute_copy(&pprogress),
                )
        ...
        unsafe extern "system" fn GetRootStorage<
            Identity: IMDSPStorageGlobals_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            pproot: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    0x1dcb3a10_33ed_11d3_8470_00c04f79dbc0
);
...
impl IMDServiceProvider {
    pub unsafe fn GetDeviceCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDeviceCount)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
...
impl IMDServiceProvider_Vtbl {
    pub const fn new<Identity: IMDServiceProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDeviceCount<
...
windows_core::imp::define_interface!(
    IMDServiceProvider2,
    IMDServiceProvider2_Vtbl,
    0xb2fa24b7_cda3_4694_9862_413ae1a34819
);
...
impl IMDServiceProvider2_Vtbl {
    pub const fn new<Identity: IMDServiceProvider2_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            pwszdevicepath: windows_core::PCWSTR,
            pdwcount: *mut u32,
            pppdevicearray: *mut *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDServiceProvider2_Impl::CreateDevice(
                    this,
                    core::mem::transmute(&pwszdevicepath),
                    core::mem::transmute_copy(&pdwcount),
                    core::mem::transmute_copy(&pppdevicearray),
                )
                .into()
            }
        }
        Self {
            base__: IMDServiceProvider_Vtbl::new::<Identity, OFFSET>(),
...
windows_core::imp::define_interface!(
    ...
    0x4ed13ef3_a971_4d19_9f51_0e1826b2da57
);
...
impl IMDServiceProvider3 {
    pub unsafe fn SetDeviceEnumPreference(&self, dwenumpref: u32) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetDeviceEnumPreference)(
                windows_core::Interface::as_raw(self),
                dwenumpref,
            )
            .ok()
...
impl IMDServiceProvider3_Vtbl {
    pub const fn new<Identity: IMDServiceProvider3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetDeviceEnumPreference<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMDServiceProvider3_Impl::SetDeviceEnumPreference(
                    this,
                    core::mem::transmute_copy(&dwenumpref),
                )
                .into()
            }
        }
        Self {
            base__: IMDServiceProvider2_Vtbl::new::<Identity, OFFSET>(),
            SetDeviceEnumPreference: SetDeviceEnumPreference::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    ISCPSecureAuthenticate_Vtbl,
    0x1dcb3a0f_33ed_11d3_8470_00c04f79dbc0
);
...
impl ISCPSecureAuthenticate {
    pub unsafe fn GetSecureQuery(&self) -> windows_core::Result<ISCPSecureQuery> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSecureQuery)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ISCPSecureAuthenticate_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetSecureQuery: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ISCPSecureAuthenticate_Vtbl {
    pub const fn new<Identity: ISCPSecureAuthenticate_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetSecureQuery<
            Identity: ISCPSecureAuthenticate_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppsecurequery: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    ...
    ISCPSecureAuthenticate2_Vtbl,
    0xb580cfae_1672_47e2_acaa_44bbecbcae5b
);
...
impl ISCPSecureAuthenticate2 {
    pub unsafe fn GetSCPSession(&self) -> windows_core::Result<ISCPSession> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSCPSession)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct ISCPSecureAuthenticate2_Vtbl {
    ...
    pub GetSCPSession: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl ISCPSecureAuthenticate2_Vtbl {
    pub const fn new<Identity: ISCPSecureAuthenticate2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetSCPSession<
            Identity: ISCPSecureAuthenticate2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ppscpsession: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: ISCPSecureAuthenticate_Vtbl::new::<Identity, OFFSET>(),
            GetSCPSession: GetSCPSession::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x1dcb3a0e_33ed_11d3_8470_00c04f79dbc0
);
windows_core::imp::interface_hierarchy!(ISCPSecureExchange, windows_core::IUnknown);
impl ISCPSecureExchange {
    pub unsafe fn TransferContainerData(
        &self,
        pdata: &[u8],
        pfureadyflags: *mut u32,
        abmac: &mut [u8; 8],
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).TransferContainerData)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn ObjectData(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).ObjectData)(
                windows_core::Interface::as_raw(self),
                pdata as _,
                pdwsize as _,
                core::mem::transmute(abmac.as_ptr()),
    ...
    pub unsafe fn TransferComplete(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).TransferComplete)(
                windows_core::Interface::as_raw(self),
            )
            .ok()
        }
...
pub struct ISCPSecureExchange_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub TransferContainerData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const u8,
        u32,
        *mut u32,
    ...
    pub ObjectData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u8,
        *mut u32,
        *mut u8,
    ) -> windows_core::HRESULT,
    pub TransferComplete:
...
impl ISCPSecureExchange_Vtbl {
    pub const fn new<Identity: ISCPSecureExchange_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn TransferContainerData<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISCPSecureExchange_Impl::TransferContainerData(
                    this,
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&dwsize),
                    core::mem::transmute_copy(&pfureadyflags),
                    core::mem::transmute_copy(&abmac),
                )
                .into()
            }
        }
        unsafe extern "system" fn ObjectData<
            Identity: ISCPSecureExchange_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISCPSecureExchange_Impl::ObjectData(
                    this,
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&pdwsize),
                    core::mem::transmute_copy(&abmac),
        ...
        unsafe extern "system" fn TransferComplete<
            Identity: ISCPSecureExchange_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
impl ISCPSecureExchange2 {
    pub unsafe fn TransferContainerData2<P2>(
        &self,
        pdata: &[u8],
        pprogresscallback: P2,
        pfureadyflags: *mut u32,
        abmac: &mut [u8; 8],
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).TransferContainerData2)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pdata.as_ptr()),
                pdata.len().try_into().unwrap(),
...
pub struct ISCPSecureExchange2_Vtbl {
    ...
    pub TransferContainerData2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const u8,
        u32,
        *mut core::ffi::c_void,
...
pub trait ISCPSecureExchange2_Impl: ISCPSecureExchange_Impl {
    fn TransferContainerData2(
        ...
        pdata: *const u8,
        dwsize: u32,
        pprogresscallback: windows_core::Ref<'_, IWMDMProgress3>,
        pfureadyflags: *mut u32,
        abmac: *mut u8,
    ) -> windows_core::Result<()>;
}
impl ISCPSecureExchange2_Vtbl {
    pub const fn new<Identity: ISCPSecureExchange2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn TransferContainerData2<
        ...
        >(
            ...
            pdata: *const u8,
            dwsize: u32,
            pprogresscallback: *mut core::ffi::c_void,
            pfureadyflags: *mut u32,
            abmac: *mut u8,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISCPSecureExchange2_Impl::TransferContainerData2(
                    this,
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&dwsize),
        ...
        Self {
            base__: ISCPSecureExchange_Vtbl::new::<Identity, OFFSET>(),
            TransferContainerData2: TransferContainerData2::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xab4e77e4_8908_4b17_bd2a_b1dbe6dd69e1
);
...
impl ISCPSecureExchange3 {
    pub unsafe fn TransferContainerDataOnClearChannel<P0, P3>(
        &self,
        pdevice: P0,
        pdata: &[u8],
        pprogresscallback: P3,
        ...
        P3: windows_core::Param<IWMDMProgress3>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TransferContainerDataOnClearChannel)(
                windows_core::Interface::as_raw(self),
                pdevice.param().abi(),
                core::mem::transmute(pdata.as_ptr()),
                pdata.len().try_into().unwrap(),
    ...
    pub unsafe fn GetObjectDataOnClearChannel<P0>(
        &self,
        pdevice: P0,
        pdata: *mut u8,
        pdwsize: *mut u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetObjectDataOnClearChannel)(
                windows_core::Interface::as_raw(self),
                pdevice.param().abi(),
                pdata as _,
                pdwsize as _,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).TransferCompleteForDevice)(
                windows_core::Interface::as_raw(self),
                pdevice.param().abi(),
            )
            .ok()
...
pub struct ISCPSecureExchange3_Vtbl {
    ...
    pub TransferContainerDataOnClearChannel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *const u8,
        u32,
        ...
        *mut u32,
        ...
        -> windows_core::HRESULT,
    pub GetObjectDataOnClearChannel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub TransferCompleteForDevice: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
pub trait ISCPSecureExchange3_Impl: ISCPSecureExchange2_Impl {
    fn TransferContainerDataOnClearChannel(
        &self,
        pdevice: windows_core::Ref<'_, IMDSPDevice>,
        pdata: *const u8,
        dwsize: u32,
        pprogresscallback: windows_core::Ref<'_, IWMDMProgress3>,
    ) -> windows_core::Result<u32>;
...
impl ISCPSecureExchange3_Vtbl {
    pub const fn new<Identity: ISCPSecureExchange3_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetObjectDataOnClearChannel<
            Identity: ISCPSecureExchange3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISCPSecureExchange3_Impl::GetObjectDataOnClearChannel(
                    this,
                    core::mem::transmute_copy(&pdevice),
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&pdwsize),
        ...
        unsafe extern "system" fn TransferCompleteForDevice<
            Identity: ISCPSecureExchange3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISCPSecureExchange3_Impl::TransferCompleteForDevice(
                    this,
                    core::mem::transmute_copy(&pdevice),
                )
                .into()
        ...
        Self {
            ...
            TransferContainerDataOnClearChannel: TransferContainerDataOnClearChannel::<
                Identity,
                OFFSET,
            >,
...
impl ISCPSecureQuery {
    pub unsafe fn GetDataDemands(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetDataDemands)(
                windows_core::Interface::as_raw(self),
                pfuflags as _,
                pdwminrightsdata as _,
                pdwminexaminedata as _,
                pdwmindecidedata as _,
                core::mem::transmute(abmac.as_ptr()),
            )
            .ok()
        }
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).ExamineData)(
                windows_core::Interface::as_raw(self),
                fuflags,
                pwszextension.param().abi(),
                core::mem::transmute(pdata.as_ptr()),
                pdata.len().try_into().unwrap(),
                core::mem::transmute(abmac.as_ptr()),
            )
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).MakeDecision)(
                windows_core::Interface::as_raw(self),
                fuflags,
                core::mem::transmute(pdata.as_ptr()),
                pdata.len().try_into().unwrap(),
...
pub struct ISCPSecureQuery_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub GetDataDemands: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
        *mut u32,
    ...
    pub ExamineData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        *const u8,
    ...
    pub MakeDecision: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        u32,
...
pub trait ISCPSecureQuery_Impl: windows_core::IUnknownImpl {
    ...
    fn ExamineData(
        &self,
        fuflags: u32,
        pwszextension: &windows_core::PCWSTR,
        pdata: *const u8,
        dwsize: u32,
        abmac: *mut u8,
    ) -> windows_core::Result<()>;
    fn MakeDecision(
        ...
        dwsessionkeylen: u32,
        pstorageglobals: windows_core::Ref<'_, IMDSPStorageGlobals>,
        ppexchange: windows_core::OutRef<'_, ISCPSecureExchange>,
        abmac: *mut u8,
    ) -> windows_core::Result<()>;
    fn GetRights(
        &self,
        ...
        pbspsessionkey: *const u8,
        dwsessionkeylen: u32,
        pstgglobals: windows_core::Ref<'_, IMDSPStorageGlobals>,
        pprights: *mut *mut WMDMRIGHTS,
        pnrightscount: *mut u32,
        abmac: *mut u8,
    ) -> windows_core::Result<()>;
...
impl ISCPSecureQuery_Vtbl {
    pub const fn new<Identity: ISCPSecureQuery_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDataDemands<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISCPSecureQuery_Impl::GetDataDemands(
                    this,
                    core::mem::transmute_copy(&pfuflags),
                    core::mem::transmute_copy(&pdwminrightsdata),
                    core::mem::transmute_copy(&pdwminexaminedata),
                    core::mem::transmute_copy(&pdwmindecidedata),
                    core::mem::transmute_copy(&abmac),
                )
                .into()
            }
        }
        unsafe extern "system" fn ExamineData<
            Identity: ISCPSecureQuery_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISCPSecureQuery_Impl::ExamineData(
                    this,
                    core::mem::transmute_copy(&fuflags),
                    core::mem::transmute(&pwszextension),
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&dwsize),
                    core::mem::transmute_copy(&abmac),
                )
        ...
        unsafe extern "system" fn MakeDecision<
            Identity: ISCPSecureQuery_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            pbspsessionkey: *const u8,
            dwsessionkeylen: u32,
            pstorageglobals: *mut core::ffi::c_void,
            ppexchange: *mut *mut core::ffi::c_void,
            abmac: *mut u8,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISCPSecureQuery_Impl::MakeDecision(
                    this,
                    core::mem::transmute_copy(&fuflags),
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&dwsize),
        ...
        unsafe extern "system" fn GetRights<Identity: ISCPSecureQuery_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdata: *const u8,
            dwsize: u32,
            pbspsessionkey: *const u8,
            dwsessionkeylen: u32,
            pstgglobals: *mut core::ffi::c_void,
            pprights: *mut *mut WMDMRIGHTS,
            pnrightscount: *mut u32,
            abmac: *mut u8,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISCPSecureQuery_Impl::GetRights(
                    this,
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&dwsize),
                    core::mem::transmute_copy(&pbspsessionkey),
                    core::mem::transmute_copy(&dwsessionkeylen),
                    core::mem::transmute_copy(&pstgglobals),
                    core::mem::transmute_copy(&pprights),
                    core::mem::transmute_copy(&pnrightscount),
                    core::mem::transmute_copy(&abmac),
                )
...
windows_core::imp::define_interface!(
    ISCPSecureQuery2,
    ISCPSecureQuery2_Vtbl,
    0xebe17e25_4fd7_4632_af46_6d93d4fcc72e
);
...
impl ISCPSecureQuery2 {
    pub unsafe fn MakeDecision2<P6, P15>(
        ...
        pappcertapp: &[u8],
        pappcertsp: &[u8],
        pszrevocationurl: *mut windows_core::PWSTR,
...
pub struct ISCPSecureQuery2_Vtbl {
    ...
    pub MakeDecision2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        u32,
...
impl ISCPSecureQuery2_Vtbl {
    pub const fn new<Identity: ISCPSecureQuery2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn MakeDecision2<
        ...
        Self {
            base__: ISCPSecureQuery_Vtbl::new::<Identity, OFFSET>(),
            MakeDecision2: MakeDecision2::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xb7edd1a2_4dab_484b_b3c5_ad39b8b4c0b1
);
...
impl ISCPSecureQuery3 {
    pub unsafe fn GetRightsOnClearChannel<P4, P5>(
        &self,
        pdata: &[u8],
        pbspsessionkey: &[u8],
        pstgglobals: P4,
        pprogresscallback: P5,
        pprights: *mut *mut WMDMRIGHTS,
        pnrightscount: *mut u32,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetRightsOnClearChannel)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pdata.as_ptr()),
                pdata.len().try_into().unwrap(),
                core::mem::transmute(pbspsessionkey.as_ptr()),
    ...
    pub unsafe fn MakeDecisionOnClearChannel<P6, P7, P16>(
        &self,
        fuflags: u32,
        pdata: &[u8],
        dwappsec: u32,
...
pub struct ISCPSecureQuery3_Vtbl {
    ...
    pub GetRightsOnClearChannel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *const u8,
        u32,
        *const u8,
    ...
    pub MakeDecisionOnClearChannel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const u8,
        u32,
...
impl ISCPSecureQuery3_Vtbl {
    pub const fn new<Identity: ISCPSecureQuery3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetRightsOnClearChannel<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISCPSecureQuery3_Impl::GetRightsOnClearChannel(
                    this,
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&dwsize),
                    core::mem::transmute_copy(&pbspsessionkey),
        ...
        unsafe extern "system" fn MakeDecisionOnClearChannel<
            Identity: ISCPSecureQuery3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ISCPSession,
    ISCPSession_Vtbl,
    0x88a3e6ed_eee4_4619_bbb3_fd4fb62715d1
);
        ...
        P0: windows_core::Param<IMDSPDevice>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).BeginSession)(
                windows_core::Interface::as_raw(self),
                pidevice.param().abi(),
                core::mem::transmute(pctx.as_ptr()),
                pctx.len().try_into().unwrap(),
            )
            .ok()
        }
    }
...
pub trait ISCPSession_Impl: windows_core::IUnknownImpl {
    fn BeginSession(
        &self,
        pidevice: windows_core::Ref<'_, IMDSPDevice>,
        pctx: *const u8,
        dwsizectx: u32,
    ) -> windows_core::Result<()>;
...
impl ISCPSession_Vtbl {
    pub const fn new<Identity: ISCPSession_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BeginSession<Identity: ISCPSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pidevice: *mut core::ffi::c_void,
            pctx: *const u8,
            dwsizectx: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISCPSession_Impl::BeginSession(
                    this,
                    core::mem::transmute_copy(&pidevice),
                    core::mem::transmute_copy(&pctx),
                    core::mem::transmute_copy(&dwsizectx),
                )
                .into()
            }
        }
        unsafe extern "system" fn EndSession<Identity: ISCPSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pctx: *const u8,
            dwsizectx: u32,
        ) -> windows_core::HRESULT {
...
windows_core::imp::define_interface!(
    IWMDMDevice,
    IWMDMDevice_Vtbl,
    0x1dcb3a02_33ed_11d3_8470_00c04f79dbc0
);
...
impl IWMDMDevice {
    ...
    pub unsafe fn GetFormatSupport(
        &self,
        ppformatex: *mut *mut super::Audio::WAVEFORMATEX,
        pnformatcount: *mut u32,
        pppwszmimetype: *mut *mut windows_core::PWSTR,
        pnmimetypecount: *mut u32,
    ) -> windows_core::Result<()> {
...
impl IWMDMDevice_Vtbl {
    pub const fn new<Identity: IWMDMDevice_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetName<Identity: IWMDMDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwszname: windows_core::PWSTR,
            nmaxchars: u32,
        ) -> windows_core::HRESULT {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMDevice_Impl::GetManufacturer(
                    this,
                    core::mem::transmute_copy(&pwszname),
                    core::mem::transmute_copy(&nmaxchars),
                )
        ...
        unsafe extern "system" fn GetVersion<Identity: IWMDMDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwversion: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetType<Identity: IWMDMDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwtype: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMDevice_Impl::GetSerialNumber(
                    this,
                    core::mem::transmute_copy(&pserialnumber),
                    core::mem::transmute_copy(&abmac),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMDevice_Impl::GetPowerSource(
                    this,
                    core::mem::transmute_copy(&pdwpowersource),
                    core::mem::transmute_copy(&pdwpercentremaining),
                )
        ...
        unsafe extern "system" fn GetStatus<Identity: IWMDMDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwstatus: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetDeviceIcon<Identity: IWMDMDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hicon: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn EnumStorage<Identity: IWMDMDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMDevice_Impl::GetFormatSupport(
                    this,
                    core::mem::transmute_copy(&ppformatex),
                    core::mem::transmute_copy(&pnformatcount),
                    core::mem::transmute_copy(&pppwszmimetype),
                    core::mem::transmute_copy(&pnmimetypecount),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMDevice_Impl::SendOpaqueCommand(this, core::mem::transmute_copy(&pcommand))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    IWMDMDevice2,
    IWMDMDevice2_Vtbl,
    0xe34f3d37_9d67_4fc1_9252_62d28b2f8b55
);
...
pub trait IWMDMDevice2_Impl: IWMDMDevice_Impl {
    fn GetStorage(
        &self,
        pszstoragename: &windows_core::PCWSTR,
    ) -> windows_core::Result<IWMDMStorage>;
    fn GetFormatSupport2(
        &self,
        dwflags: u32,
        ppaudioformatex: *mut *mut super::Audio::WAVEFORMATEX,
...
impl IWMDMDevice2_Vtbl {
    pub const fn new<Identity: IWMDMDevice2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetStorage<Identity: IWMDMDevice2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszstoragename: windows_core::PCWSTR,
            ppstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMDevice2_Impl::GetFormatSupport2(
                    this,
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute_copy(&ppaudioformatex),
                    core::mem::transmute_copy(&pnaudioformatcount),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMDevice2_Impl::GetSpecifyPropertyPages(
                    this,
                    core::mem::transmute_copy(&ppspecifyproppages),
                    core::mem::transmute_copy(&pppunknowns),
                    core::mem::transmute_copy(&pcunks),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMDevice2_Impl::GetCanonicalName(
                    this,
                    core::mem::transmute_copy(&pwszpnpname),
                    core::mem::transmute_copy(&nmaxchars),
                )
...
windows_core::imp::define_interface!(
    IWMDMDevice3,
    IWMDMDevice3_Vtbl,
    0x6c03e4fe_05db_4dda_9e3c_06233a6d5d65
);
...
impl IWMDMDevice3_Vtbl {
    pub const fn new<Identity: IWMDMDevice3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetProperty<Identity: IWMDMDevice3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwszpropname: windows_core::PCWSTR,
            pvalue: *mut super::super::System::Com::StructuredStorage::PROPVARIANT,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn SetProperty<Identity: IWMDMDevice3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwszpropname: windows_core::PCWSTR,
            pvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT,
        ) -> windows_core::HRESULT {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWMDMDevice3_Impl::GetFormatCapability(
                    this,
                    core::mem::transmute_copy(&format),
                ) {
                    Ok(ok__) => {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMDevice3_Impl::DeviceIoControl(
                    this,
                    core::mem::transmute_copy(&dwiocontrolcode),
                    core::mem::transmute_copy(&lpinbuffer),
                    core::mem::transmute_copy(&ninbuffersize),
        ...
        unsafe extern "system" fn FindStorage<Identity: IWMDMDevice3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            findscope: WMDM_FIND_SCOPE,
            pwszuniqueid: windows_core::PCWSTR,
            ppstorage: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWMDMDevice3_Impl::FindStorage(
                    this,
                    core::mem::transmute_copy(&findscope),
                    core::mem::transmute(&pwszuniqueid),
                ) {
...
windows_core::imp::define_interface!(
    ...
    0x1dcb3a04_33ed_11d3_8470_00c04f79dbc0
);
...
impl IWMDMDeviceControl_Vtbl {
    pub const fn new<Identity: IWMDMDeviceControl_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Play<Identity: IWMDMDeviceControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Record<Identity: IWMDMDeviceControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pformat: *const super::Audio::WAVEFORMATEX,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Pause<Identity: IWMDMDeviceControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Resume<Identity: IWMDMDeviceControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Stop<Identity: IWMDMDeviceControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Seek<Identity: IWMDMDeviceControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fumode: u32,
            noffset: i32,
        ) -> windows_core::HRESULT {
    ...
    pub const fn new<Identity: IWMDMDeviceSession_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMDeviceSession_Impl::BeginSession(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMDeviceSession_Impl::EndSession(
                    this,
                    core::mem::transmute_copy(&r#type),
                    core::mem::transmute_copy(&pctx),
                    core::mem::transmute_copy(&dwsizectx),
...
impl IWMDMEnumDevice_Vtbl {
    pub const fn new<Identity: IWMDMEnumDevice_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Next<Identity: IWMDMEnumDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            ppdevice: *mut *mut core::ffi::c_void,
            pceltfetched: *mut u32,
        ...
        unsafe extern "system" fn Skip<Identity: IWMDMEnumDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            pceltfetched: *mut u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Reset<Identity: IWMDMEnumDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Clone<Identity: IWMDMEnumDevice_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumdevice: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
impl IWMDMEnumStorage_Vtbl {
    pub const fn new<Identity: IWMDMEnumStorage_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Next<Identity: IWMDMEnumStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            ppstorage: *mut *mut core::ffi::c_void,
            pceltfetched: *mut u32,
        ...
        unsafe extern "system" fn Skip<Identity: IWMDMEnumStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            celt: u32,
            pceltfetched: *mut u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn Reset<Identity: IWMDMEnumStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn Clone<Identity: IWMDMEnumStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppenumstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(
    IWMDMLogger,
    IWMDMLogger_Vtbl,
    0x110a3200_5a79_11d3_8d78_444553540000
);
...
impl IWMDMLogger {
    ...
    pub unsafe fn GetLogFileName(
        &self,
        pszfilename: windows_core::PSTR,
        nmaxchars: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetLogFileName)(
                windows_core::Interface::as_raw(self),
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).LogString)(
                windows_core::Interface::as_raw(self),
                dwflags,
                pszsrcname.param().abi(),
                pszlog.param().abi(),
            )
            .ok()
        }
    }
    pub unsafe fn LogDword<P1, P2>(
        &self,
        dwflags: u32,
        pszsrcname: P1,
        pszlogformat: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).LogDword)(
                windows_core::Interface::as_raw(self),
                dwflags,
                pszsrcname.param().abi(),
                pszlogformat.param().abi(),
                dwlog,
            )
            .ok()
        }
    ...
    pub unsafe fn GetSizeParams(
        &self,
        pdwmaxsize: *mut u32,
        pdwshrinktosize: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetSizeParams)(
                windows_core::Interface::as_raw(self),
                pdwmaxsize as _,
                pdwshrinktosize as _,
            )
            .ok()
        }
    }
    pub unsafe fn SetSizeParams(
        &self,
        dwmaxsize: u32,
        dwshrinktosize: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetSizeParams)(
                windows_core::Interface::as_raw(self),
                dwmaxsize,
                dwshrinktosize,
            )
...
pub struct IWMDMLogger_Vtbl {
    ...
    pub GetLogFileName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PSTR,
        u32,
    ) -> windows_core::HRESULT,
    ...
    pub LogString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCSTR,
        windows_core::PCSTR,
    ) -> windows_core::HRESULT,
    pub LogDword: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCSTR,
        windows_core::PCSTR,
    ...
    pub Reset: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub GetSizeParams: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
...
pub trait IWMDMLogger_Impl: windows_core::IUnknownImpl {
    ...
    fn LogString(
        &self,
        dwflags: u32,
        pszsrcname: &windows_core::PCSTR,
        pszlog: &windows_core::PCSTR,
    ) -> windows_core::Result<()>;
    fn LogDword(
        &self,
        dwflags: u32,
        pszsrcname: &windows_core::PCSTR,
        pszlogformat: &windows_core::PCSTR,
        dwlog: u32,
    ) -> windows_core::Result<()>;
    fn Reset(&self) -> windows_core::Result<()>;
    fn GetSizeParams(
...
impl IWMDMLogger_Vtbl {
    pub const fn new<Identity: IWMDMLogger_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsEnabled<Identity: IWMDMLogger_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Enable<Identity: IWMDMLogger_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn GetLogFileName<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMLogger_Impl::GetLogFileName(
                    this,
        ...
        >(
            this: *mut core::ffi::c_void,
            pszfilename: windows_core::PCSTR,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn LogString<Identity: IWMDMLogger_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwflags: u32,
            pszsrcname: windows_core::PCSTR,
            pszlog: windows_core::PCSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMLogger_Impl::LogString(
                    this,
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute(&pszsrcname),
                    core::mem::transmute(&pszlog),
                )
                .into()
            }
        }
        unsafe extern "system" fn LogDword<Identity: IWMDMLogger_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwflags: u32,
            pszsrcname: windows_core::PCSTR,
            pszlogformat: windows_core::PCSTR,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMLogger_Impl::LogDword(
                    this,
                    core::mem::transmute_copy(&dwflags),
                    core::mem::transmute(&pszsrcname),
                    core::mem::transmute(&pszlogformat),
                    core::mem::transmute_copy(&dwlog),
                )
                .into()
            }
        }
        unsafe extern "system" fn Reset<Identity: IWMDMLogger_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetSizeParams<Identity: IWMDMLogger_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwmaxsize: *mut u32,
            pdwshrinktosize: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMLogger_Impl::GetSizeParams(
                    this,
                    core::mem::transmute_copy(&pdwmaxsize),
                    core::mem::transmute_copy(&pdwshrinktosize),
                )
                .into()
            }
        }
        unsafe extern "system" fn SetSizeParams<Identity: IWMDMLogger_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            dwmaxsize: u32,
            dwshrinktosize: u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMLogger_Impl::SetSizeParams(
                    this,
                    core::mem::transmute_copy(&dwmaxsize),
                    core::mem::transmute_copy(&dwshrinktosize),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IWMDMMetaData,
    IWMDMMetaData_Vtbl,
    0xec3b0663_0951_460a_9a80_0dceed3c043c
);
windows_core::imp::interface_hierarchy!(IWMDMMetaData, windows_core::IUnknown);
impl IWMDMMetaData {
    pub unsafe fn AddItem<P1>(
        &self,
        r#type: WMDM_TAG_DATATYPE,
        pwsztagname: P1,
        pvalue: Option<&[u8]>,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).QueryByName)(
                windows_core::Interface::as_raw(self),
                pwsztagname.param().abi(),
                ptype as _,
                pvalue as _,
    ...
    pub unsafe fn QueryByIndex(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).QueryByIndex)(
                windows_core::Interface::as_raw(self),
                iindex,
                ppwszname as _,
                ptype as _,
...
pub struct IWMDMMetaData_Vtbl {
    ...
    pub QueryByName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut WMDM_TAG_DATATYPE,
        *mut *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub QueryByIndex: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut *mut u16,
        *mut WMDM_TAG_DATATYPE,
...
pub trait IWMDMMetaData_Impl: windows_core::IUnknownImpl {
    fn AddItem(
        &self,
        r#type: WMDM_TAG_DATATYPE,
        pwsztagname: &windows_core::PCWSTR,
        pvalue: *const u8,
        ilength: u32,
    ) -> windows_core::Result<()>;
    fn QueryByName(
...
impl IWMDMMetaData_Vtbl {
    pub const fn new<Identity: IWMDMMetaData_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddItem<Identity: IWMDMMetaData_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            r#type: WMDM_TAG_DATATYPE,
            pwsztagname: windows_core::PCWSTR,
            pvalue: *const u8,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMMetaData_Impl::AddItem(
                    this,
                    core::mem::transmute_copy(&r#type),
                    core::mem::transmute(&pwsztagname),
                    core::mem::transmute_copy(&pvalue),
                    core::mem::transmute_copy(&ilength),
                )
                .into()
            }
        }
        unsafe extern "system" fn QueryByName<Identity: IWMDMMetaData_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwsztagname: windows_core::PCWSTR,
            ptype: *mut WMDM_TAG_DATATYPE,
            pvalue: *mut *mut u8,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMMetaData_Impl::QueryByName(
                    this,
                    core::mem::transmute(&pwsztagname),
        ...
        unsafe extern "system" fn QueryByIndex<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMMetaData_Impl::QueryByIndex(
                    this,
                    core::mem::transmute_copy(&iindex),
                    core::mem::transmute_copy(&ppwszname),
                    core::mem::transmute_copy(&ptype),
...
windows_core::imp::define_interface!(
    ...
    0x3f5e95c0_0f43_4ed4_93d2_c89a45d59b81
);
windows_core::imp::interface_hierarchy!(IWMDMNotification, windows_core::IUnknown);
impl IWMDMNotification {
    pub unsafe fn WMDMMessage<P1>(
        &self,
        dwmessagetype: u32,
        pwszcanonicalname: P1,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            (windows_core::Interface::vtable(self).WMDMMessage)(
                windows_core::Interface::as_raw(self),
                dwmessagetype,
                pwszcanonicalname.param().abi(),
            )
            .ok()
        }
    }
...
pub struct IWMDMNotification_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub WMDMMessage: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
    ) -> windows_core::HRESULT,
    ...
    pub const fn new<Identity: IWMDMNotification_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMNotification_Impl::WMDMMessage(
                    this,
                    core::mem::transmute_copy(&dwmessagetype),
                    core::mem::transmute(&pwszcanonicalname),
                )
                .into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            WMDMMessage: WMDMMessage::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x1dcb3a09_33ed_11d3_8470_00c04f79dbc0
);
    ...
    pub const fn new<Identity: IWMDMObjectInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMObjectInfo_Impl::SetPlayLength(this, core::mem::transmute_copy(&dwlength))
                    .into()
            }
        }
        unsafe extern "system" fn GetPlayOffset<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMObjectInfo_Impl::SetPlayOffset(this, core::mem::transmute_copy(&dwoffset))
                    .into()
            }
        }
        unsafe extern "system" fn GetTotalLength<
...
windows_core::imp::define_interface!(
    IWMDMOperation,
    IWMDMOperation_Vtbl,
    0x1dcb3a0b_33ed_11d3_8470_00c04f79dbc0
);
...
impl IWMDMOperation {
    pub unsafe fn BeginRead(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BeginRead)(windows_core::Interface::as_raw(self))
                .ok()
        }
    }
    pub unsafe fn BeginWrite(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).BeginWrite)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
    ...
    pub unsafe fn GetObjectName(&self, pwszname: &mut [u16]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetObjectName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pwszname.as_ptr()),
                pwszname.len().try_into().unwrap(),
            )
    ...
    pub unsafe fn SetObjectName(&self, pwszname: &[u16]) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetObjectName)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pwszname.as_ptr()),
                pwszname.len().try_into().unwrap(),
            )
    ...
    #[cfg(feature = "Win32_Media_Audio")]
    pub unsafe fn GetObjectAttributes(
        &self,
        pdwattributes: *mut u32,
        pformat: Option<*mut super::Audio::WAVEFORMATEX>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetObjectAttributes)(
                windows_core::Interface::as_raw(self),
                pdwattributes as _,
                pformat.unwrap_or(core::mem::zeroed()) as _,
            )
    ...
    #[cfg(feature = "Win32_Media_Audio")]
    pub unsafe fn SetObjectAttributes(
        &self,
        dwattributes: u32,
        pformat: Option<*const super::Audio::WAVEFORMATEX>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetObjectAttributes)(
                windows_core::Interface::as_raw(self),
                dwattributes,
                pformat.unwrap_or(core::mem::zeroed()) as _,
            )
    ...
    pub unsafe fn GetObjectTotalSize(
        &self,
        pdwsize: *mut u32,
        pdwsizehigh: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).GetObjectTotalSize)(
                windows_core::Interface::as_raw(self),
                pdwsize as _,
                pdwsizehigh as _,
            )
    ...
    pub unsafe fn SetObjectTotalSize(
        &self,
        dwsize: u32,
        dwsizehigh: u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetObjectTotalSize)(
                windows_core::Interface::as_raw(self),
                dwsize,
                dwsizehigh,
            )
    ...
    pub unsafe fn TransferObjectData(
        &self,
        pdata: *mut u8,
        pdwsize: *mut u32,
        abmac: &mut [u8; 8],
        ...
        unsafe {
            (windows_core::Interface::vtable(self).TransferObjectData)(
                windows_core::Interface::as_raw(self),
                pdata as _,
                pdwsize as _,
                core::mem::transmute(abmac.as_ptr()),
    ...
    pub unsafe fn End<P1>(
        &self,
        phcompletioncode: *const windows_core::HRESULT,
        pnewobject: P1,
    ) -> windows_core::Result<()>
    where
...
pub struct IWMDMOperation_Vtbl {
    ...
    pub GetObjectName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PWSTR,
        u32,
    ) -> windows_core::HRESULT,
    pub SetObjectName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        u32,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_Media_Audio")]
    pub GetObjectAttributes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut super::Audio::WAVEFORMATEX,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Win32_Media_Audio")]
    pub SetObjectAttributes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const super::Audio::WAVEFORMATEX,
    ) -> windows_core::HRESULT,
    ...
    pub GetObjectTotalSize: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
    ) -> windows_core::HRESULT,
    pub SetObjectTotalSize:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, u32) -> windows_core::HRESULT,
    pub TransferObjectData: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u8,
        *mut u32,
        *mut u8,
...
pub trait IWMDMOperation_Impl: windows_core::IUnknownImpl {
    ...
    fn End(
        &self,
        phcompletioncode: *const windows_core::HRESULT,
        pnewobject: windows_core::Ref<'_, windows_core::IUnknown>,
    ) -> windows_core::Result<()>;
}
#[cfg(feature = "Win32_Media_Audio")]
impl IWMDMOperation_Vtbl {
    pub const fn new<Identity: IWMDMOperation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BeginRead<Identity: IWMDMOperation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn BeginWrite<Identity: IWMDMOperation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
        ...
        unsafe extern "system" fn GetObjectName<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMOperation_Impl::GetObjectName(
                    this,
                    core::mem::transmute_copy(&pwszname),
                    core::mem::transmute_copy(&nmaxchars),
                )
        ...
        unsafe extern "system" fn SetObjectName<
            Identity: IWMDMOperation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMOperation_Impl::SetObjectName(
                    this,
                    core::mem::transmute(&pwszname),
                    core::mem::transmute_copy(&nmaxchars),
                )
        ...
        unsafe extern "system" fn GetObjectAttributes<
            Identity: IWMDMOperation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMOperation_Impl::GetObjectAttributes(
                    this,
                    core::mem::transmute_copy(&pdwattributes),
                    core::mem::transmute_copy(&pformat),
                )
        ...
        unsafe extern "system" fn SetObjectAttributes<
            Identity: IWMDMOperation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMOperation_Impl::SetObjectAttributes(
                    this,
                    core::mem::transmute_copy(&dwattributes),
                    core::mem::transmute_copy(&pformat),
                )
        ...
        unsafe extern "system" fn GetObjectTotalSize<
            Identity: IWMDMOperation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMOperation_Impl::GetObjectTotalSize(
                    this,
                    core::mem::transmute_copy(&pdwsize),
                    core::mem::transmute_copy(&pdwsizehigh),
                )
        ...
        unsafe extern "system" fn SetObjectTotalSize<
            Identity: IWMDMOperation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMOperation_Impl::SetObjectTotalSize(
                    this,
                    core::mem::transmute_copy(&dwsize),
                    core::mem::transmute_copy(&dwsizehigh),
                )
                .into()
            }
        }
        unsafe extern "system" fn TransferObjectData<
            Identity: IWMDMOperation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMOperation_Impl::TransferObjectData(
                    this,
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&pdwsize),
                    core::mem::transmute_copy(&abmac),
        ...
        unsafe extern "system" fn End<Identity: IWMDMOperation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            phcompletioncode: *const windows_core::HRESULT,
            pnewobject: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMOperation_Impl::End(
                    this,
                    core::mem::transmute_copy(&phcompletioncode),
                    core::mem::transmute_copy(&pnewobject),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    ...
    0x33445b48_7df7_425c_ad8f_0fc6d82f9f75
);
...
impl IWMDMOperation2 {
    ...
    pub unsafe fn SetObjectAttributes2(
        &self,
        dwattributes: u32,
        dwattributesex: u32,
        pformat: Option<*const super::Audio::WAVEFORMATEX>,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).SetObjectAttributes2)(
                windows_core::Interface::as_raw(self),
                dwattributes,
                dwattributesex,
                pformat.unwrap_or(core::mem::zeroed()) as _,
    ...
    pub unsafe fn GetObjectAttributes2(
        &self,
        pdwattributes: *mut u32,
        pdwattributesex: *mut u32,
        paudioformat: Option<*mut super::Audio::WAVEFORMATEX>,
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetObjectAttributes2)(
                windows_core::Interface::as_raw(self),
                pdwattributes as _,
                pdwattributesex as _,
                paudioformat.unwrap_or(core::mem::zeroed()) as _,
...
pub struct IWMDMOperation2_Vtbl {
    ...
    pub SetObjectAttributes2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        *const super::Audio::WAVEFORMATEX,
    ...
    pub GetObjectAttributes2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u32,
        *mut u32,
        *mut super::Audio::WAVEFORMATEX,
...
impl IWMDMOperation2_Vtbl {
    pub const fn new<Identity: IWMDMOperation2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetObjectAttributes2<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMOperation2_Impl::SetObjectAttributes2(
                    this,
                    core::mem::transmute_copy(&dwattributes),
                    core::mem::transmute_copy(&dwattributesex),
                    core::mem::transmute_copy(&pformat),
        ...
        unsafe extern "system" fn GetObjectAttributes2<
            Identity: IWMDMOperation2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMOperation2_Impl::GetObjectAttributes2(
                    this,
                    core::mem::transmute_copy(&pdwattributes),
                    core::mem::transmute_copy(&pdwattributesex),
                    core::mem::transmute_copy(&paudioformat),
...
windows_core::imp::define_interface!(
    ...
    0xd1f9b46a_9ca8_46d8_9d0f_1ec9bae54919
);
...
impl IWMDMOperation3 {
    pub unsafe fn TransferObjectDataOnClearChannel(
        &self,
        pdata: *mut u8,
        pdwsize: *mut u32,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).TransferObjectDataOnClearChannel)(
                windows_core::Interface::as_raw(self),
                pdata as _,
                pdwsize as _,
            )
...
pub struct IWMDMOperation3_Vtbl {
    pub base__: IWMDMOperation_Vtbl,
    pub TransferObjectDataOnClearChannel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut u8,
        *mut u32,
    ) -> windows_core::HRESULT,
...
impl IWMDMOperation3_Vtbl {
    pub const fn new<Identity: IWMDMOperation3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn TransferObjectDataOnClearChannel<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMOperation3_Impl::TransferObjectDataOnClearChannel(
                    this,
                    core::mem::transmute_copy(&pdata),
                    core::mem::transmute_copy(&pdwsize),
                )
        ...
        Self {
            base__: IWMDMOperation_Vtbl::new::<Identity, OFFSET>(),
            TransferObjectDataOnClearChannel: TransferObjectDataOnClearChannel::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    IWMDMProgress,
    IWMDMProgress_Vtbl,
    0x1dcb3a0c_33ed_11d3_8470_00c04f79dbc0
);
...
impl IWMDMProgress_Vtbl {
    pub const fn new<Identity: IWMDMProgress_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin<Identity: IWMDMProgress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Progress<Identity: IWMDMProgress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMProgress_Impl::Progress(this, core::mem::transmute_copy(&dwtranspiredticks))
                    .into()
            }
        }
        unsafe extern "system" fn End<Identity: IWMDMProgress_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
...
windows_core::imp::define_interface!(
    IWMDMProgress2,
    IWMDMProgress2_Vtbl,
    0x3a43f550_b383_4e92_b04a_e6bbc660fefc
);
...
impl IWMDMProgress2 {
    pub unsafe fn End2(&self, hrcompletioncode: windows_core::HRESULT) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).End2)(
                windows_core::Interface::as_raw(self),
                hrcompletioncode,
            )
            .ok()
...
pub struct IWMDMProgress2_Vtbl {
    ...
    pub End2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::HRESULT,
    ) -> windows_core::HRESULT,
}
...
impl IWMDMProgress2_Vtbl {
    pub const fn new<Identity: IWMDMProgress2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn End2<Identity: IWMDMProgress2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            hrcompletioncode: windows_core::HRESULT,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: IWMDMProgress_Vtbl::new::<Identity, OFFSET>(),
            End2: End2::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IWMDMProgress3 {
    pub unsafe fn Begin3(
        &self,
        eventid: windows_core::GUID,
        dwestimatedticks: u32,
        pcontext: Option<*mut OPAQUECOMMAND>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Begin3)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(eventid),
                dwestimatedticks,
    ...
    pub unsafe fn Progress3(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).Progress3)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(eventid),
                dwtranspiredticks,
                pcontext.unwrap_or(core::mem::zeroed()) as _,
    ...
    pub unsafe fn End3(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).End3)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(eventid),
                hrcompletioncode,
                pcontext.unwrap_or(core::mem::zeroed()) as _,
...
pub struct IWMDMProgress3_Vtbl {
    ...
    pub Begin3: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        u32,
        *mut OPAQUECOMMAND,
    ) -> windows_core::HRESULT,
    pub Progress3: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        u32,
        *mut OPAQUECOMMAND,
    ) -> windows_core::HRESULT,
    pub End3: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        windows_core::HRESULT,
        *mut OPAQUECOMMAND,
...
impl IWMDMProgress3_Vtbl {
    pub const fn new<Identity: IWMDMProgress3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Begin3<Identity: IWMDMProgress3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            eventid: windows_core::GUID,
            dwestimatedticks: u32,
            pcontext: *mut OPAQUECOMMAND,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMProgress3_Impl::Begin3(
                    this,
                    core::mem::transmute(&eventid),
                    core::mem::transmute_copy(&dwestimatedticks),
                    core::mem::transmute_copy(&pcontext),
                )
                .into()
            }
        }
        unsafe extern "system" fn Progress3<Identity: IWMDMProgress3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            eventid: windows_core::GUID,
            dwtranspiredticks: u32,
            pcontext: *mut OPAQUECOMMAND,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMProgress3_Impl::Progress3(
                    this,
                    core::mem::transmute(&eventid),
                    core::mem::transmute_copy(&dwtranspiredticks),
                    core::mem::transmute_copy(&pcontext),
                )
                .into()
            }
        }
        unsafe extern "system" fn End3<Identity: IWMDMProgress3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            eventid: windows_core::GUID,
            hrcompletioncode: windows_core::HRESULT,
            pcontext: *mut OPAQUECOMMAND,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMProgress3_Impl::End3(
                    this,
                    core::mem::transmute(&eventid),
                    core::mem::transmute_copy(&hrcompletioncode),
                    core::mem::transmute_copy(&pcontext),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    IWMDMRevoked,
    IWMDMRevoked_Vtbl,
    0xebeccedb_88ee_4e55_b6a4_8d9f07d696aa
);
    ...
    pub const fn new<Identity: IWMDMRevoked_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMRevoked_Impl::GetRevocationURL(
                    this,
                    core::mem::transmute_copy(&ppwszrevocationurl),
                    core::mem::transmute_copy(&pdwbufferlen),
                    core::mem::transmute_copy(&pdwrevokedbitflag),
                )
                .into()
            }
        }
...
windows_core::imp::define_interface!(
    IWMDMStorage,
    IWMDMStorage_Vtbl,
    0x1dcb3a06_33ed_11d3_8470_00c04f79dbc0
);
    ...
    pub const fn new<Identity: IWMDMStorage_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorage_Impl::SetAttributes(
                    this,
                    core::mem::transmute_copy(&dwattributes),
                    core::mem::transmute_copy(&pformat),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorage_Impl::GetAttributes(
                    this,
                    core::mem::transmute_copy(&pdwattributes),
                    core::mem::transmute_copy(&pformat),
                )
        ...
        unsafe extern "system" fn GetName<Identity: IWMDMStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pwszname: windows_core::PWSTR,
            nmaxchars: u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetDate<Identity: IWMDMStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdatetimeutc: *mut WMDMDATETIME,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetSize<Identity: IWMDMStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pdwsizelow: *mut u32,
            pdwsizehigh: *mut u32,
        ) -> windows_core::HRESULT {
        ...
        unsafe extern "system" fn GetRights<Identity: IWMDMStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pprights: *mut *mut WMDMRIGHTS,
            pnrightscount: *mut u32,
            abmac: *mut u8,
        ...
        unsafe extern "system" fn EnumStorage<Identity: IWMDMStorage_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            penumstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorage_Impl::SendOpaqueCommand(this, core::mem::transmute_copy(&pcommand))
                    .into()
            }
        }
        Self {
...
windows_core::imp::define_interface!(
    IWMDMStorage2,
    IWMDMStorage2_Vtbl,
    0x1ed5a144_5cd5_4683_9eff_72cbdb2d9533
);
...
impl IWMDMStorage2_Vtbl {
    pub const fn new<Identity: IWMDMStorage2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetStorage<Identity: IWMDMStorage2_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszstoragename: windows_core::PCWSTR,
            ppstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorage2_Impl::SetAttributes2(
                    this,
                    core::mem::transmute_copy(&dwattributes),
                    core::mem::transmute_copy(&dwattributesex),
                    core::mem::transmute_copy(&pformat),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorage2_Impl::GetAttributes2(
                    this,
                    core::mem::transmute_copy(&pdwattributes),
                    core::mem::transmute_copy(&pdwattributesex),
                    core::mem::transmute_copy(&paudioformat),
...
windows_core::imp::define_interface!(
    IWMDMStorage3,
    IWMDMStorage3_Vtbl,
    0x97717eea_926a_464e_96a4_247b0216026e
);
...
impl IWMDMStorage3 {
    ...
    pub unsafe fn CreateEmptyMetadataObject(&self) -> windows_core::Result<IWMDMMetaData> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateEmptyMetadataObject)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn SetEnumPreference(
        &self,
        pmode: *mut WMDM_STORAGE_ENUM_MODE,
        pviews: Option<&[WMDMMetadataView]>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetEnumPreference)(
                windows_core::Interface::as_raw(self),
                pmode as _,
                pviews
                    .as_deref()
...
pub struct IWMDMStorage3_Vtbl {
    ...
    pub CreateEmptyMetadataObject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetEnumPreference: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WMDM_STORAGE_ENUM_MODE,
        u32,
        *const WMDMMetadataView,
    ) -> windows_core::HRESULT,
}
#[cfg(all(
    feature = "Win32_Graphics_Gdi",
...
impl IWMDMStorage3_Vtbl {
    pub const fn new<Identity: IWMDMStorage3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetMetadata<Identity: IWMDMStorage3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn SetMetadata<Identity: IWMDMStorage3_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pmetadata: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn CreateEmptyMetadataObject<
        ...
        unsafe extern "system" fn SetEnumPreference<
            Identity: IWMDMStorage3_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorage3_Impl::SetEnumPreference(
                    this,
                    core::mem::transmute_copy(&pmode),
                    core::mem::transmute_copy(&nviews),
...
windows_core::imp::define_interface!(
    IWMDMStorage4,
    IWMDMStorage4_Vtbl,
    0xc225bac5_a03a_40b8_9a23_91cf478c64a6
);
...
impl IWMDMStorage4 {
    pub unsafe fn SetReferences(
        &self,
        ppiwmdmstorage: Option<&[Option<IWMDMStorage>]>,
    ) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).SetReferences)(
                windows_core::Interface::as_raw(self),
    ...
    pub unsafe fn GetReferences(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetReferences)(
                windows_core::Interface::as_raw(self),
                pdwrefs as _,
                pppiwmdmstorage as _,
            )
            .ok()
        }
    }
    pub unsafe fn GetRightsWithProgress<P0>(
        &self,
        piprogresscallback: P0,
        pprights: *mut *mut WMDMRIGHTS,
        pnrightscount: *mut u32,
    ) -> windows_core::Result<()>
    where
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetRightsWithProgress)(
                windows_core::Interface::as_raw(self),
                piprogresscallback.param().abi(),
                pprights as _,
                pnrightscount as _,
            )
            .ok()
    ...
    pub unsafe fn GetSpecifiedMetadata(
        &self,
        ppwszpropnames: &[windows_core::PCWSTR],
    ) -> windows_core::Result<IWMDMMetaData> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSpecifiedMetadata)(
                windows_core::Interface::as_raw(self),
...
pub struct IWMDMStorage4_Vtbl {
    ...
    pub GetRightsWithProgress: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut WMDMRIGHTS,
        *mut u32,
...
pub trait IWMDMStorage4_Impl: IWMDMStorage3_Impl {
    ...
    fn GetRightsWithProgress(
        &self,
        piprogresscallback: windows_core::Ref<'_, IWMDMProgress3>,
        pprights: *mut *mut WMDMRIGHTS,
        pnrightscount: *mut u32,
    ) -> windows_core::Result<()>;
    fn GetSpecifiedMetadata(
...
impl IWMDMStorage4_Vtbl {
    pub const fn new<Identity: IWMDMStorage4_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            dwrefs: u32,
            ppiwmdmstorage: *const *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorage4_Impl::SetReferences(
                    this,
                    core::mem::transmute_copy(&dwrefs),
                    core::mem::transmute_copy(&ppiwmdmstorage),
                )
                .into()
            }
        }
        ...
        >(
            this: *mut core::ffi::c_void,
            pdwrefs: *mut u32,
            pppiwmdmstorage: *mut *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorage4_Impl::GetReferences(
                    this,
                    core::mem::transmute_copy(&pdwrefs),
                    core::mem::transmute_copy(&pppiwmdmstorage),
                )
                .into()
            }
        }
        unsafe extern "system" fn GetRightsWithProgress<
            Identity: IWMDMStorage4_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            piprogresscallback: *mut core::ffi::c_void,
            pprights: *mut *mut WMDMRIGHTS,
            pnrightscount: *mut u32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorage4_Impl::GetRightsWithProgress(
                    this,
                    core::mem::transmute_copy(&piprogresscallback),
                    core::mem::transmute_copy(&pprights),
                    core::mem::transmute_copy(&pnrightscount),
                )
                .into()
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWMDMStorage4_Impl::GetSpecifiedMetadata(
                    this,
                    core::mem::transmute_copy(&cproperties),
                    core::mem::transmute_copy(&ppwszpropnames),
                ) {
        ...
        unsafe extern "system" fn FindStorage<Identity: IWMDMStorage4_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            findscope: WMDM_FIND_SCOPE,
            pwszuniqueid: windows_core::PCWSTR,
            ppstorage: *mut *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWMDMStorage4_Impl::FindStorage(
                    this,
                    core::mem::transmute_copy(&findscope),
                    core::mem::transmute(&pwszuniqueid),
                ) {
        ...
        unsafe extern "system" fn GetParent<Identity: IWMDMStorage4_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ppstorage: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
pub trait IWMDMStorageControl_Impl: windows_core::IUnknownImpl {
    fn Insert(
        &self,
        fumode: u32,
        pwszfile: &windows_core::PCWSTR,
        poperation: windows_core::Ref<'_, IWMDMOperation>,
        pprogress: windows_core::Ref<'_, IWMDMProgress>,
    ) -> windows_core::Result<IWMDMStorage>;
    fn Delete(
        &self,
    ...
    fn Move(
        &self,
        fumode: u32,
        ptargetobject: windows_core::Ref<'_, IWMDMStorage>,
        pprogress: windows_core::Ref<'_, IWMDMProgress>,
    ) -> windows_core::Result<()>;
}
impl IWMDMStorageControl_Vtbl {
    pub const fn new<Identity: IWMDMStorageControl_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            fumode: u32,
            pwszfile: windows_core::PCWSTR,
            poperation: *mut core::ffi::c_void,
            pprogress: *mut core::ffi::c_void,
            ppnewobject: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWMDMStorageControl_Impl::Insert(
                    this,
                    core::mem::transmute_copy(&fumode),
                    core::mem::transmute(&pwszfile),
                    core::mem::transmute_copy(&poperation),
                    core::mem::transmute_copy(&pprogress),
                ) {
                    Ok(ok__) => {
                        ppnewobject.write(core::mem::transmute(ok__));
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorageControl_Impl::Delete(
                    this,
                    core::mem::transmute_copy(&fumode),
                    core::mem::transmute_copy(&pprogress),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorageControl_Impl::Rename(
                    this,
                    core::mem::transmute_copy(&fumode),
                    core::mem::transmute(&pwsznewname),
                    core::mem::transmute_copy(&pprogress),
        ...
        unsafe extern "system" fn Read<Identity: IWMDMStorageControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fumode: u32,
            pwszfile: windows_core::PCWSTR,
            pprogress: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Move<Identity: IWMDMStorageControl_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            fumode: u32,
            ptargetobject: *mut core::ffi::c_void,
            pprogress: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorageControl_Impl::Move(
                    this,
                    core::mem::transmute_copy(&fumode),
                    core::mem::transmute_copy(&ptargetobject),
                    core::mem::transmute_copy(&pprogress),
                )
                .into()
            }
...
windows_core::imp::define_interface!(
    ...
    0x972c2e88_bd6c_4125_8e09_84f837e637b6
);
...
impl IWMDMStorageControl2 {
    pub unsafe fn Insert2<P1, P2, P3, P4, P5>(
        &self,
        fumode: u32,
        pwszfilesource: P1,
        pwszfiledest: P2,
        ...
        pprogress: P4,
        punknown: P5,
        ppnewobject: Option<*mut Option<IWMDMStorage>>,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Insert2)(
                windows_core::Interface::as_raw(self),
                fumode,
                pwszfilesource.param().abi(),
                pwszfiledest.param().abi(),
                poperation.param().abi(),
                pprogress.param().abi(),
                punknown.param().abi(),
                ppnewobject.unwrap_or(core::mem::zeroed()) as _,
            )
            .ok()
        }
    }
...
pub struct IWMDMStorageControl2_Vtbl {
    ...
    pub Insert2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        windows_core::PCWSTR,
        windows_core::PCWSTR,
...
pub trait IWMDMStorageControl2_Impl: IWMDMStorageControl_Impl {
    fn Insert2(
        &self,
        fumode: u32,
        pwszfilesource: &windows_core::PCWSTR,
        pwszfiledest: &windows_core::PCWSTR,
        poperation: windows_core::Ref<'_, IWMDMOperation>,
        pprogress: windows_core::Ref<'_, IWMDMProgress>,
        punknown: windows_core::Ref<'_, windows_core::IUnknown>,
        ppnewobject: windows_core::OutRef<'_, IWMDMStorage>,
    ) -> windows_core::Result<()>;
}
impl IWMDMStorageControl2_Vtbl {
    pub const fn new<Identity: IWMDMStorageControl2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Insert2<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorageControl2_Impl::Insert2(
                    this,
                    core::mem::transmute_copy(&fumode),
                    core::mem::transmute(&pwszfilesource),
                    core::mem::transmute(&pwszfiledest),
                    core::mem::transmute_copy(&poperation),
                    core::mem::transmute_copy(&pprogress),
                    core::mem::transmute_copy(&punknown),
        ...
        Self {
            base__: IWMDMStorageControl_Vtbl::new::<Identity, OFFSET>(),
            Insert2: Insert2::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0xb3266365_d4f3_4696_8d53_bd27ec60993a
);
...
impl IWMDMStorageControl3 {
    pub unsafe fn Insert3<P2, P3, P4, P5, P6, P7>(
        &self,
        fumode: u32,
        futype: u32,
        pwszfilesource: P2,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).Insert3)(
                windows_core::Interface::as_raw(self),
                fumode,
                futype,
                pwszfilesource.param().abi(),
...
pub struct IWMDMStorageControl3_Vtbl {
    ...
    pub Insert3: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        u32,
        windows_core::PCWSTR,
...
impl IWMDMStorageControl3_Vtbl {
    pub const fn new<Identity: IWMDMStorageControl3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Insert3<
        ...
        >(
            ...
            unsafe {
                ...
                IWMDMStorageControl3_Impl::Insert3(
                    this,
                    core::mem::transmute_copy(&fumode),
                    core::mem::transmute_copy(&futype),
                    core::mem::transmute(&pwszfilesource),
                    core::mem::transmute(&pwszfiledest),
                    core::mem::transmute_copy(&poperation),
                    core::mem::transmute_copy(&pprogress),
        ...
        Self {
            base__: IWMDMStorageControl2_Vtbl::new::<Identity, OFFSET>(),
            Insert3: Insert3::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    0x1dcb3a07_33ed_11d3_8470_00c04f79dbc0
);
    ...
    pub const fn new<Identity: IWMDMStorageGlobals_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorageGlobals_Impl::GetSerialNumber(
                    this,
                    core::mem::transmute_copy(&pserialnum),
                    core::mem::transmute_copy(&abmac),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorageGlobals_Impl::GetTotalSize(
                    this,
                    core::mem::transmute_copy(&pdwtotalsizelow),
                    core::mem::transmute_copy(&pdwtotalsizehigh),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorageGlobals_Impl::GetTotalFree(
                    this,
                    core::mem::transmute_copy(&pdwfreelow),
                    core::mem::transmute_copy(&pdwfreehigh),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorageGlobals_Impl::GetTotalBad(
                    this,
                    core::mem::transmute_copy(&pdwbadlow),
                    core::mem::transmute_copy(&pdwbadhigh),
                )
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDMStorageGlobals_Impl::Initialize(
                    this,
                    core::mem::transmute_copy(&fumode),
                    core::mem::transmute_copy(&pprogress),
                )
...
windows_core::imp::define_interface!(
    ...
    0x1dcb3a00_33ed_11d3_8470_00c04f79dbc0
);
...
windows_core::imp::define_interface!(
    ...
    0x923e5249_8731_4c5b_9b1c_b8b60b6e46af
);
...
impl IWMDeviceManager2 {
    pub unsafe fn GetDeviceFromCanonicalName<P0>(
        &self,
        pwszcanonicalname: P0,
    ) -> windows_core::Result<IWMDMDevice>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDeviceFromCanonicalName)(
                windows_core::Interface::as_raw(self),
                pwszcanonicalname.param().abi(),
                &mut result__,
            )
    ...
    pub unsafe fn EnumDevices2(&self) -> windows_core::Result<IWMDMEnumDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumDevices2)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub unsafe fn Reinitialize(&self) -> windows_core::Result<()> {
        unsafe {
            (windows_core::Interface::vtable(self).Reinitialize)(windows_core::Interface::as_raw(
                self,
            ))
            .ok()
        }
...
pub struct IWMDeviceManager2_Vtbl {
    ...
    pub GetDeviceFromCanonicalName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::PCWSTR,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub EnumDevices2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl IWMDeviceManager2_Vtbl {
    pub const fn new<Identity: IWMDeviceManager2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDeviceFromCanonicalName<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWMDeviceManager2_Impl::GetDeviceFromCanonicalName(
                    this,
                    core::mem::transmute(&pwszcanonicalname),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn EnumDevices2<
            Identity: IWMDeviceManager2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Reinitialize<
            Identity: IWMDeviceManager2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0xaf185c41_100d_46ed_be2e_9ce8c44594ef
);
    ...
    pub const fn new<Identity: IWMDeviceManager3_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWMDeviceManager3_Impl::SetDeviceEnumPreference(
                    this,
                    core::mem::transmute_copy(&dwenumpref),
                )
                .into()
        ...
        Self {
            base__: IWMDeviceManager2_Vtbl::new::<Identity, OFFSET>(),
            SetDeviceEnumPreference: SetDeviceEnumPreference::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub const MediaDevMgr: windows_core::GUID =
    windows_core::GUID::from_u128(0x25baad81_3560_11d3_8471_00c04f79dbc0);
pub const MediaDevMgrClassFactory: windows_core::GUID =
    windows_core::GUID::from_u128(0x50040c1d_bdbf_4924_b873_f14d6c5bfd66);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const SCP_EVENTID_ACQSECURECLOCK: windows_core::GUID =
    windows_core::GUID::from_u128(0x86248cc9_4a59_43e2_9146_48a7f3f4140c);
pub const SCP_EVENTID_DRMINFO: windows_core::GUID =
    windows_core::GUID::from_u128(0x213dd287_41d2_432b_9e3f_3b4f7b3581dd);
pub const SCP_EVENTID_NEEDTOINDIV: windows_core::GUID =
    windows_core::GUID::from_u128(0x87a507c7_b469_4386_b976_d5d1ce538a6f);
pub const SCP_PARAMID_DRMVERSION: windows_core::GUID =
    windows_core::GUID::from_u128(0x41d0155d_7cc7_4217_ada9_005074624da4);
#[repr(C)]
...
pub const WMDMDevice: windows_core::GUID =
    windows_core::GUID::from_u128(0x807b3cdf_357a_11d3_8471_00c04f79dbc0);
pub const WMDMDeviceEnum: windows_core::GUID =
    windows_core::GUID::from_u128(0x430e35af_3971_11d3_8474_00c04f79dbc0);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct WMDMID {
    pub cbSize: u32,
...
pub const WMDMLogger: windows_core::GUID =
    windows_core::GUID::from_u128(0x110a3202_5a79_11d3_8d78_444553540000);
#[repr(transparent)]
...
pub const WMDMStorage: windows_core::GUID =
    windows_core::GUID::from_u128(0x807b3ce0_357a_11d3_8471_00c04f79dbc0);
pub const WMDMStorageEnum: windows_core::GUID =
    windows_core::GUID::from_u128(0xeb401a3b_3af7_11d3_8474_00c04f79dbc0);
pub const WMDMStorageGlobal: windows_core::GUID =
    windows_core::GUID::from_u128(0x807b3ce1_357a_11d3_8471_00c04f79dbc0);
...
pub const WMDM_DEVICE_PROTOCOL_MSC: windows_core::GUID =
    windows_core::GUID::from_u128(0xa4d2c26c_a881_44bb_bd5d_1f703c71f7a9);
pub const WMDM_DEVICE_PROTOCOL_MTP: windows_core::GUID =
    windows_core::GUID::from_u128(0x979e54e5_0afc_4604_8d93_dc798a4bcf45);
pub const WMDM_DEVICE_PROTOCOL_RAPI: windows_core::GUID =
    windows_core::GUID::from_u128(0x2a11ed91_8c8f_41e4_82d1_8386e003561c);
...
pub const WMDM_ENUM_PROP_VALID_VALUES_ANY: WMDM_ENUM_PROP_VALID_VALUES_FORM =
    WMDM_ENUM_PROP_VALID_VALUES_FORM(0i32);
pub const WMDM_ENUM_PROP_VALID_VALUES_ENUM: WMDM_ENUM_PROP_VALID_VALUES_FORM =
    WMDM_ENUM_PROP_VALID_VALUES_FORM(2i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WMDM_ENUM_PROP_VALID_VALUES_FORM(pub i32);
pub const WMDM_ENUM_PROP_VALID_VALUES_RANGE: WMDM_ENUM_PROP_VALID_VALUES_FORM =
    WMDM_ENUM_PROP_VALID_VALUES_FORM(1i32);
...
pub const WMDM_SERVICE_PROVIDER_VENDOR_MICROSOFT: windows_core::GUID =
    windows_core::GUID::from_u128(0x7de8686d_78ee_43ea_a496_c625ac91cc5d);
...
pub const g_wszWMDMAlbumCoverDuration: windows_core::PCWSTR =
    windows_core::w!("WMDM/AlbumCoverDuration");
pub const g_wszWMDMAlbumCoverFormat: windows_core::PCWSTR =
    windows_core::w!("WMDM/AlbumCoverFormat");
pub const g_wszWMDMAlbumCoverHeight: windows_core::PCWSTR =
    windows_core::w!("WMDM/AlbumCoverHeight");
...
pub const g_wszWMDMDeviceFirmwareVersion: windows_core::PCWSTR =
    windows_core::w!("WMDM/DeviceFirmwareVersion");
pub const g_wszWMDMDeviceFriendlyName: windows_core::PCWSTR =
    windows_core::w!("WMDM/DeviceFriendlyName");
...
pub const g_wszWMDMDeviceRevocationInfo: windows_core::PCWSTR =
    windows_core::w!("WMDM/DeviceRevocationInfo");
pub const g_wszWMDMDeviceServiceProviderVendor: windows_core::PCWSTR =
    windows_core::w!("WMDM/DeviceServiceProviderVendor");
pub const g_wszWMDMDeviceVendorExtension: windows_core::PCWSTR =
    windows_core::w!("WMDM/DeviceVendorExtension");
...
pub const g_wszWMDMFileCreationDate: windows_core::PCWSTR =
    windows_core::w!("WMDM/FileCreationDate");
...
pub const g_wszWMDMFormatsSupported: windows_core::PCWSTR =
    windows_core::w!("WMDM/FormatsSupported");
pub const g_wszWMDMFormatsSupportedAreOrdered: windows_core::PCWSTR =
    windows_core::w!("WMDM/FormatsSupportedAreOrdered");
...
pub const g_wszWMDMKeyFrameDistance: windows_core::PCWSTR =
    windows_core::w!("WMDM/KeyFrameDistance");
pub const g_wszWMDMLastModifiedDate: windows_core::PCWSTR =
    windows_core::w!("WMDM/LastModifiedDate");
pub const g_wszWMDMMediaClassSecondaryID: windows_core::PCWSTR =
    windows_core::w!("WMDM/MediaClassSecondaryID");
...
pub const g_wszWMDMMediaOriginalBroadcastDateTime: windows_core::PCWSTR =
    windows_core::w!("WMDM/MediaOriginalBroadcastDateTime");
pub const g_wszWMDMMediaOriginalChannel: windows_core::PCWSTR =
    windows_core::w!("WMDM/MediaOriginalChannel");
pub const g_wszWMDMMediaStationName: windows_core::PCWSTR =
    windows_core::w!("WMDM/MediaStationName");
...
pub const g_wszWMDMPersistentUniqueID: windows_core::PCWSTR =
    windows_core::w!("WMDM/PersistentUniqueID");
pub const g_wszWMDMPlayCount: windows_core::PCWSTR = windows_core::w!("WMDM/PlayCount");
pub const g_wszWMDMProviderCopyright: windows_core::PCWSTR =
    windows_core::w!("WMDM/ProviderCopyright");
...
pub const g_wszWMDMSubTitleDescription: windows_core::PCWSTR =
    windows_core::w!("WMDM/SubTitleDescription");
pub const g_wszWMDMSupportedDeviceProperties: windows_core::PCWSTR =
    windows_core::w!("WMDM/SupportedDeviceProperties");
pub const g_wszWMDMSyncID: windows_core::PCWSTR = windows_core::w!("WMDM/SyncID");
pub const g_wszWMDMSyncRelationshipID: windows_core::PCWSTR =
    windows_core::w!("WMDM/SyncRelationshipID");
...
pub const g_wszWMDMUserEffectiveRating: windows_core::PCWSTR =
    windows_core::w!("WMDM/UserEffectiveRating");
pub const g_wszWMDMUserLastPlayTime: windows_core::PCWSTR =
    windows_core::w!("WMDM/UserLastPlayTime");
pub const g_wszWMDMUserRating: windows_core::PCWSTR = windows_core::w!("WMDM/UserRating");
pub const g_wszWMDMUserRatingOnDevice: windows_core::PCWSTR =
    windows_core::w!("WMDM/UserRatingOnDevice");
...
pub const g_wszWMDMediaClassPrimaryID: windows_core::PCWSTR =
    windows_core::w!("WMDM/MediaClassPrimaryID");
pub const g_wszWPDPassthroughPropertyValues: windows_core::PCWSTR =
    windows_core::w!("WPD/PassthroughPropertyValues");

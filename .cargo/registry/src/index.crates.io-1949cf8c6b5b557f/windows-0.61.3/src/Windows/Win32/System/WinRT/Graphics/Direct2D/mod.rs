...
pub const GRAPHICS_EFFECT_PROPERTY_MAPPING_COLORMATRIX_ALPHA_MODE:
    GRAPHICS_EFFECT_PROPERTY_MAPPING = GRAPHICS_EFFECT_PROPERTY_MAPPING(8i32);
pub const GRAPHICS_EFFECT_PROPERTY_MAPPING_COLOR_TO_VECTOR3: GRAPHICS_EFFECT_PROPERTY_MAPPING =
    GRAPHICS_EFFECT_PROPERTY_MAPPING(9i32);
pub const GRAPHICS_EFFECT_PROPERTY_MAPPING_COLOR_TO_VECTOR4: GRAPHICS_EFFECT_PROPERTY_MAPPING =
    GRAPHICS_EFFECT_PROPERTY_MAPPING(10i32);
pub const GRAPHICS_EFFECT_PROPERTY_MAPPING_DIRECT: GRAPHICS_EFFECT_PROPERTY_MAPPING =
    GRAPHICS_EFFECT_PROPERTY_MAPPING(1i32);
pub const GRAPHICS_EFFECT_PROPERTY_MAPPING_RADIANS_TO_DEGREES: GRAPHICS_EFFECT_PROPERTY_MAPPING =
    GRAPHICS_EFFECT_PROPERTY_MAPPING(7i32);
pub const GRAPHICS_EFFECT_PROPERTY_MAPPING_RECT_TO_VECTOR4: GRAPHICS_EFFECT_PROPERTY_MAPPING =
    GRAPHICS_EFFECT_PROPERTY_MAPPING(6i32);
pub const GRAPHICS_EFFECT_PROPERTY_MAPPING_UNKNOWN: GRAPHICS_EFFECT_PROPERTY_MAPPING =
    GRAPHICS_EFFECT_PROPERTY_MAPPING(0i32);
pub const GRAPHICS_EFFECT_PROPERTY_MAPPING_VECTORW: GRAPHICS_EFFECT_PROPERTY_MAPPING =
    GRAPHICS_EFFECT_PROPERTY_MAPPING(5i32);
pub const GRAPHICS_EFFECT_PROPERTY_MAPPING_VECTORX: GRAPHICS_EFFECT_PROPERTY_MAPPING =
    GRAPHICS_EFFECT_PROPERTY_MAPPING(2i32);
pub const GRAPHICS_EFFECT_PROPERTY_MAPPING_VECTORY: GRAPHICS_EFFECT_PROPERTY_MAPPING =
    GRAPHICS_EFFECT_PROPERTY_MAPPING(3i32);
pub const GRAPHICS_EFFECT_PROPERTY_MAPPING_VECTORZ: GRAPHICS_EFFECT_PROPERTY_MAPPING =
    GRAPHICS_EFFECT_PROPERTY_MAPPING(4i32);
...
impl IGeometrySource2DInterop {
    ...
    pub unsafe fn GetGeometry(
        &self,
    ) -> windows_core::Result<super::super::super::super::Graphics::Direct2D::ID2D1Geometry> {
        unsafe {
    ...
    #[cfg(feature = "Win32_Graphics_Direct2D")]
    pub unsafe fn TryGetGeometryUsingFactory<P0>(
        &self,
        factory: P0,
    ) -> windows_core::Result<super::super::super::super::Graphics::Direct2D::ID2D1Geometry>
    where
        P0: windows_core::Param<super::super::super::super::Graphics::Direct2D::ID2D1Factory>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TryGetGeometryUsingFactory)(
                windows_core::Interface::as_raw(self),
                factory.param().abi(),
                &mut result__,
            )
...
pub trait IGeometrySource2DInterop_Impl: windows_core::IUnknownImpl {
    ...
    fn TryGetGeometryUsingFactory(
        &self,
        factory: windows_core::Ref<
            '_,
            super::super::super::super::Graphics::Direct2D::ID2D1Factory,
        >,
    ) -> windows_core::Result<super::super::super::super::Graphics::Direct2D::ID2D1Geometry>;
}
#[cfg(feature = "Win32_Graphics_Direct2D")]
...
impl IGraphicsEffectD2D1Interop {
    pub unsafe fn GetEffectId(&self) -> windows_core::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEffectId)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub unsafe fn GetNamedPropertyMapping<P0>(
        &self,
        name: P0,
        index: *mut u32,
    ...
    {
        unsafe {
            (windows_core::Interface::vtable(self).GetNamedPropertyMapping)(
                windows_core::Interface::as_raw(self),
                name.param().abi(),
                index as _,
                mapping as _,
    ...
    pub unsafe fn GetProperty(
        &self,
        index: u32,
    ) -> windows_core::Result<super::super::super::super::super::Foundation::IPropertyValue> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSource(
        ...
        super::super::super::super::super::Graphics::Effects::IGraphicsEffectSource,
    > {
        unsafe {
            let mut result__ = core::mem::zeroed();

...
impl ClassicAppManager {
    pub fn FindInstalledApp(
        appuninstallkey: &windows_core::HSTRING,
    ) -> windows_core::Result<InstalledClassicAppInfo> {
        Self::IClassicAppManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindInstalledApp)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(appuninstallkey),
                &mut result__,
            )
    ...
    fn IClassicAppManagerStatics<
        R,
        F: FnOnce(&IClassicAppManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
windows_core::imp::define_interface!(
    IClassicAppManagerStatics,
    IClassicAppManagerStatics_Vtbl,
...
pub struct IClassicAppManagerStatics_Vtbl {
    ...
    pub FindInstalledApp: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
impl windows_core::RuntimeType for InstalledClassicAppInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInstalledClassicAppInfo>();
}

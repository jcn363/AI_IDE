windows_core::imp::define_interface!(
    INamedPolicyData,
    INamedPolicyData_Vtbl,
    0x38dcb198_95ac_4077_a643_8078cae26400
);
...
pub struct INamedPolicyData_Vtbl {
    ...
    pub Area: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    INamedPolicyStatics,
    INamedPolicyStatics_Vtbl,
    0x7f793be7_76c4_4058_8cad_67662cd05f0d
);
...
pub struct INamedPolicyStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetPolicyFromPath: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(feature = "System")]
    pub GetPolicyFromPathForUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
impl NamedPolicy {
    pub fn GetPolicyFromPath(
        area: &windows_core::HSTRING,
        name: &windows_core::HSTRING,
    ) -> windows_core::Result<NamedPolicyData> {
        Self::INamedPolicyStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPolicyFromPath)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(area),
    ...
    #[cfg(feature = "System")]
    pub fn GetPolicyFromPathForUser<P0>(
        user: P0,
        area: &windows_core::HSTRING,
        name: &windows_core::HSTRING,
    ) -> windows_core::Result<NamedPolicyData>
        ...
        P0: windows_core::Param<super::super::System::User>,
    {
        Self::INamedPolicyStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPolicyFromPathForUser)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                core::mem::transmute_copy(area),
                core::mem::transmute_copy(name),
    ...
    fn INamedPolicyStatics<R, F: FnOnce(&INamedPolicyStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<NamedPolicy, INamedPolicyStatics> =
...
impl NamedPolicyData {
    pub fn Area(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Area)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn IsManaged(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsManaged)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsUserPolicy(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsUserPolicy)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetBinary(&self) -> windows_core::Result<super::super::Storage::Streams::IBuffer> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetBinary)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for NamedPolicyData {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, INamedPolicyData>();
}

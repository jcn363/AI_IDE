...
impl ApplicationDataManager {
    #[cfg(feature = "Storage")]
    pub fn CreateForPackageFamily(
        packagefamilyname: &windows_core::HSTRING,
    ) -> windows_core::Result<super::super::Storage::ApplicationData> {
        Self::IApplicationDataManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateForPackageFamily)(
    ...
    fn IApplicationDataManagerStatics<
        R,
        F: FnOnce(&IApplicationDataManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for ApplicationDataManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IApplicationDataManager>();
}
...
windows_core::imp::define_interface!(
    IApplicationDataManagerStatics,
    IApplicationDataManagerStatics_Vtbl,
    0x1e1862e3_698e_49a1_9752_dee94925b9b3
);
...
pub struct IApplicationDataManagerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Storage")]
    pub CreateForPackageFamily: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,

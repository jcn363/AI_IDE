...
windows_core::imp::define_interface!(
    IMdmAlert,
    IMdmAlert_Vtbl,
    0xb0fbc327_28c1_4b52_a548_c5807caf70b6
);
...
pub struct IMdmAlert_Vtbl {
    ...
    pub Format: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut MdmAlertDataType,
    ) -> windows_core::HRESULT,
    pub SetFormat: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        MdmAlertDataType,
    ) -> windows_core::HRESULT,
    pub Mark: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut MdmAlertMark,
    ) -> windows_core::HRESULT,
    pub SetMark:
        unsafe extern "system" fn(*mut core::ffi::c_void, MdmAlertMark) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IMdmSession,
    IMdmSession_Vtbl,
    0xfe89314c_8f64_4797_a9d7_9d88f86ae166
);
...
pub struct IMdmSession_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Alerts: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub StartWithAlertsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IMdmSessionManagerStatics_Vtbl,
    0xcf4ad959_f745_4b79_9b5c_de0bf8efe44b
);
...
pub struct IMdmSessionManagerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SessionIds: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TryCreateSession: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub DeleteSessionById: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetSessionById: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl MdmAlert {
    ...
    pub fn Mark(&self) -> windows_core::Result<MdmAlertMark> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Mark)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetMark(&self, value: MdmAlertMark) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetMark)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for MdmAlert {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMdmAlert>();
}
...
impl windows_core::RuntimeType for MdmAlertDataType {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Management.MdmAlertDataType;i4)");
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for MdmAlertMark {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Management.MdmAlertMark;i4)");
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl MdmSession {
    pub fn Alerts(&self) -> windows_core::Result<windows_collections::IVectorView<MdmAlert>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Alerts)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn StartWithAlertsAsync<P0>(
        &self,
        alerts: P0,
        ...
        P0: windows_core::Param<windows_collections::IIterable<MdmAlert>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StartWithAlertsAsync)(
                windows_core::Interface::as_raw(this),
                alerts.param().abi(),
                &mut result__,
            )
...
impl windows_core::RuntimeType for MdmSession {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMdmSession>();
}
...
impl MdmSessionManager {
    pub fn SessionIds(
        ...
        Self::IMdmSessionManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SessionIds)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn TryCreateSession() -> windows_core::Result<MdmSession> {
        Self::IMdmSessionManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryCreateSession)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn DeleteSessionById(sessionid: &windows_core::HSTRING) -> windows_core::Result<()> {
        Self::IMdmSessionManagerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).DeleteSessionById)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn GetSessionById(sessionid: &windows_core::HSTRING) -> windows_core::Result<MdmSession> {
        Self::IMdmSessionManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetSessionById)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(sessionid),
                &mut result__,
            )
    ...
    fn IMdmSessionManagerStatics<
        R,
        F: FnOnce(&IMdmSessionManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for MdmSessionState {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.Management.MdmSessionState;i4)");
}

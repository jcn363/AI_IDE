windows_core::imp::define_interface!(
    ...
    IMdmAllowPolicyStatics_Vtbl,
    0xc39709e7_741c_41f2_a4b6_314c31502586
);
...
pub struct IMdmAllowPolicyStatics_Vtbl {
    ...
    pub IsBrowserAllowed:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsCameraAllowed:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsMicrosoftAccountAllowed:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub IsStoreAllowed:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IMdmPolicyStatics2,
    IMdmPolicyStatics2_Vtbl,
    0xc99c7526_03d4_49f9_a993_43efccd265c4
);
...
pub struct IMdmPolicyStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetMessagingSyncPolicy: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut MessagingSyncPolicy,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWorkplaceSettingsStatics,
    IWorkplaceSettingsStatics_Vtbl,
    0xe4676ffd_2d92_4c08_bad4_f6590b54a6d3
);
...
pub struct IWorkplaceSettingsStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsMicrosoftAccountOptional:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
...
impl MdmPolicy {
    pub fn IsBrowserAllowed() -> windows_core::Result<bool> {
        Self::IMdmAllowPolicyStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).IsBrowserAllowed)(
    ...
    pub fn IsCameraAllowed() -> windows_core::Result<bool> {
        Self::IMdmAllowPolicyStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsCameraAllowed)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsMicrosoftAccountAllowed() -> windows_core::Result<bool> {
        Self::IMdmAllowPolicyStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsMicrosoftAccountAllowed)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsStoreAllowed() -> windows_core::Result<bool> {
        Self::IMdmAllowPolicyStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsStoreAllowed)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetMessagingSyncPolicy() -> windows_core::Result<MessagingSyncPolicy> {
        Self::IMdmPolicyStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetMessagingSyncPolicy)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    fn IMdmAllowPolicyStatics<R, F: FnOnce(&IMdmAllowPolicyStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<MdmPolicy, IMdmAllowPolicyStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IMdmPolicyStatics2<R, F: FnOnce(&IMdmPolicyStatics2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<MdmPolicy, IMdmPolicyStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl WorkplaceSettings {
    pub fn IsMicrosoftAccountOptional() -> windows_core::Result<bool> {
        Self::IWorkplaceSettingsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsMicrosoftAccountOptional)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    fn IWorkplaceSettingsStatics<
        R,
        F: FnOnce(&IWorkplaceSettingsStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {

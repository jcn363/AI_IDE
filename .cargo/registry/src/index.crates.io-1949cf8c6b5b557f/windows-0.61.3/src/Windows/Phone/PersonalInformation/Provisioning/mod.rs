...
impl ContactPartnerProvisioningManager {
    pub fn AssociateNetworkAccountAsync<P0>(
        store: P0,
        networkname: &windows_core::HSTRING,
        ...
        P0: windows_core::Param<super::ContactStore>,
    {
        Self::IContactPartnerProvisioningManagerStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).AssociateNetworkAccountAsync)(
                windows_core::Interface::as_raw(this),
                store.param().abi(),
                core::mem::transmute_copy(networkname),
    ...
    pub fn ImportVcardToSystemAsync<P0>(
        stream: P0,
    ) -> windows_core::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::super::super::Storage::Streams::IInputStream>,
    {
        Self::IContactPartnerProvisioningManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ImportVcardToSystemAsync)(
                windows_core::Interface::as_raw(this),
                stream.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<super::ContactStore>,
    {
        Self::IContactPartnerProvisioningManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AssociateSocialNetworkAccountAsync)(
                windows_core::Interface::as_raw(this),
                store.param().abi(),
                core::mem::transmute_copy(networkname),
                core::mem::transmute_copy(networkaccountid),
    ...
    fn IContactPartnerProvisioningManagerStatics<
        R,
        F: FnOnce(&IContactPartnerProvisioningManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ...
    fn IContactPartnerProvisioningManagerStatics2<
        R,
        F: FnOnce(&IContactPartnerProvisioningManagerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
windows_core::imp::define_interface!(
    IContactPartnerProvisioningManagerStatics,
    IContactPartnerProvisioningManagerStatics_Vtbl,
    0xc0d79a21_01af_4fd3_98cd_b3d656de15f4
);
...
pub struct IContactPartnerProvisioningManagerStatics_Vtbl {
    ...
    pub AssociateNetworkAccountAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub ImportVcardToSystemAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IContactPartnerProvisioningManagerStatics2,
    IContactPartnerProvisioningManagerStatics2_Vtbl,
    0xc26155f7_55ed_475d_9334_c5d484c30f1a
);
...
pub struct IContactPartnerProvisioningManagerStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AssociateSocialNetworkAccountAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IMessagePartnerProvisioningManagerStatics_Vtbl,
    0x8a1b0850_73c5_457c_bc59_ed7d615c05a4
);
...
pub struct IMessagePartnerProvisioningManagerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ImportSmsToSystemAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        bool,
        bool,
        *mut core::ffi::c_void,
    ...
    pub ImportMmsToSystemAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        bool,
        bool,
        *mut core::ffi::c_void,
...
impl MessagePartnerProvisioningManager {
        ...
        P4: windows_core::Param<windows_collections::IVectorView<windows_core::HSTRING>>,
    {
        Self::IMessagePartnerProvisioningManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ImportSmsToSystemAsync)(
                windows_core::Interface::as_raw(this),
                incoming,
                read,
        ...
        >,
    {
        Self::IMessagePartnerProvisioningManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ImportMmsToSystemAsync)(
                windows_core::Interface::as_raw(this),
                incoming,
                read,
    ...
    fn IMessagePartnerProvisioningManagerStatics<
        R,
        F: FnOnce(&IMessagePartnerProvisioningManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<

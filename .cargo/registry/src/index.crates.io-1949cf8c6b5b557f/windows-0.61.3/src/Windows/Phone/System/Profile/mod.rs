...
impl RetailMode {
    pub fn RetailModeEnabled() -> windows_core::Result<bool> {
        Self::IRetailModeStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).RetailModeEnabled)(
    ...
    fn IRetailModeStatics<R, F: FnOnce(&IRetailModeStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<RetailMode, IRetailModeStatics> =

...
impl Enterprise {
    ...
    pub fn WorkplaceId(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WorkplaceId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn EnrollmentValidFrom(
        &self,
    ) -> windows_core::Result<super::super::super::Foundation::DateTime> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EnrollmentValidFrom)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn EnrollmentValidTo(
        &self,
    ) -> windows_core::Result<super::super::super::Foundation::DateTime> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EnrollmentValidTo)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for Enterprise {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IEnterprise>();
}
...
impl EnterpriseEnrollmentManager {
    ...
    ) -> windows_core::Result<windows_collections::IVectorView<Enterprise>> {
        Self::IEnterpriseEnrollmentManager(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EnrolledEnterprises)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn CurrentEnterprise() -> windows_core::Result<Enterprise> {
        Self::IEnterpriseEnrollmentManager(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CurrentEnterprise)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ValidateEnterprisesAsync() -> windows_core::Result<windows_future::IAsyncAction> {
        Self::IEnterpriseEnrollmentManager(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ValidateEnterprisesAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn RequestEnrollmentAsync(
        enrollmenttoken: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<EnterpriseEnrollmentResult>> {
        Self::IEnterpriseEnrollmentManager(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestEnrollmentAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(enrollmenttoken),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
        ...
        P0: windows_core::Param<Enterprise>,
    {
        Self::IEnterpriseEnrollmentManager(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestUnenrollmentAsync)(
                windows_core::Interface::as_raw(this),
                enterprise.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    ...
    fn IEnterpriseEnrollmentManager<
        R,
        F: FnOnce(&IEnterpriseEnrollmentManager) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl EnterpriseEnrollmentResult {
    pub fn EnrolledEnterprise(&self) -> windows_core::Result<Enterprise> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EnrolledEnterprise)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for EnterpriseEnrollmentResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IEnterpriseEnrollmentResult>();
}
...
windows_core::imp::define_interface!(
    IEnterprise,
    IEnterprise_Vtbl,
    0x96592f8d_856c_4426_a947_b06307718078
);
...
pub struct IEnterprise_Vtbl {
    ...
    pub EnrollmentValidFrom: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Foundation::DateTime,
    ) -> windows_core::HRESULT,
    pub EnrollmentValidTo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Foundation::DateTime,
    ) -> windows_core::HRESULT,
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut EnterpriseStatus,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IEnterpriseEnrollmentManager,
    IEnterpriseEnrollmentManager_Vtbl,
    0x20f9f390_2c69_41d8_88e6_e4b3884026cb
);
...
pub struct IEnterpriseEnrollmentManager_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub EnrolledEnterprises: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CurrentEnterprise: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ValidateEnterprisesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RequestEnrollmentAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RequestUnenrollmentAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IEnterpriseEnrollmentResult_Vtbl,
    0x9ff71ce6_90db_4342_b326_1729aa91301c
);
...
pub struct IEnterpriseEnrollmentResult_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub EnrolledEnterprise: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut EnterpriseEnrollmentStatus,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IInstallationManagerStatics,
    IInstallationManagerStatics_Vtbl,
    0x929aa738_8d49_42ac_80c9_b4ad793c43f2
);
...
pub struct IInstallationManagerStatics_Vtbl {
    ...
    pub AddPackagePreloadedAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub GetPendingPackageInstalls: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "ApplicationModel")]
    pub FindPackagesForCurrentPublisher: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IInstallationManagerStatics2_Vtbl,
    0x7c6c2cbd_fa4a_4c8e_ab97_d959452f19e5
);
...
pub struct IInstallationManagerStatics2_Vtbl {
    ...
    pub RemovePackageAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::super::Management::Deployment::RemovalOptions,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub RegisterPackageAsync: unsafe extern "system" fn(
        ...
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::super::Management::Deployment::DeploymentOptions,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Management_Deployment"))]
...
windows_core::imp::define_interface!(
    ...
    IPackageInstallResult_Vtbl,
    0x33e8eed5_0f7e_4473_967c_7d6e1c0e7de1
);
...
pub struct IPackageInstallResult_Vtbl {
    ...
    pub InstallState: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Management::Deployment::PackageInstallState,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Management_Deployment"))]
    InstallState: usize,
}
windows_core::imp::define_interface!(
    ...
    IPackageInstallResult2_Vtbl,
    0x7149d909_3ff9_41ed_a717_2bc65ffc61d2
);
...
impl InstallationManager {
    pub fn AddPackageAsync<P1>(
        ...
        sourcelocation: P1,
    ) -> windows_core::Result<windows_future::IAsyncOperationWithProgress<PackageInstallResult, u32>>
    where
        P1: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IInstallationManagerStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).AddPackageAsync)(
                ...
                sourcelocation.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn AddPackagePreloadedAsync<P1, P4>(
        title: &windows_core::HSTRING,
        sourcelocation: P1,
        instanceid: &windows_core::HSTRING,
        offerid: &windows_core::HSTRING,
        license: P4,
    ) -> windows_core::Result<windows_future::IAsyncOperationWithProgress<PackageInstallResult, u32>>
    where
        P1: windows_core::Param<super::super::super::Foundation::Uri>,
        P4: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IInstallationManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AddPackagePreloadedAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(title),
                sourcelocation.param().abi(),
                core::mem::transmute_copy(instanceid),
                core::mem::transmute_copy(offerid),
                license.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetPendingPackageInstalls() -> windows_core::Result<
        windows_collections::IIterable<
            windows_future::IAsyncOperationWithProgress<PackageInstallResult, u32>,
        >,
    > {
        Self::IInstallationManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPendingPackageInstalls)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "ApplicationModel")]
    pub fn FindPackagesForCurrentPublisher() -> windows_core::Result<
        windows_collections::IIterable<super::super::super::ApplicationModel::Package>,
    > {
        Self::IInstallationManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindPackagesForCurrentPublisher)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "ApplicationModel")]
    pub fn FindPackages() -> windows_core::Result<
        windows_collections::IIterable<super::super::super::ApplicationModel::Package>,
    > {
        Self::IInstallationManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemovePackageAsync(
        ...
        removaloptions: super::super::super::Management::Deployment::RemovalOptions,
    ) -> windows_core::Result<windows_future::IAsyncOperationWithProgress<PackageInstallResult, u32>>
    {
    ...
    where
        ...
        P1: windows_core::Param<
            windows_collections::IIterable<super::super::super::Foundation::Uri>,
        >,
    {
        Self::IInstallationManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IInstallationManagerStatics<
        R,
        F: FnOnce(&IInstallationManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IInstallationManagerStatics2<
        R,
        F: FnOnce(&IInstallationManagerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl PackageInstallResult {
    ...
    pub fn InstallState(
        &self,
    ) -> windows_core::Result<super::super::super::Management::Deployment::PackageInstallState>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for PackageInstallResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPackageInstallResult>();
}

...
impl ApplicationProfile {
    pub fn Modes() -> windows_core::Result<ApplicationProfileModes> {
        Self::IApplicationProfileStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).Modes)(
    ...
    fn IApplicationProfileStatics<
        R,
        F: FnOnce(&IApplicationProfileStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
windows_core::imp::define_interface!(
    IApplicationProfileStatics,
    IApplicationProfileStatics_Vtbl,
    0xd5008ab4_7e7a_11e1_a7f2_b0a14824019b
);
...
pub struct IApplicationProfileStatics_Vtbl {
    ...
    pub Modes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ApplicationProfileModes,

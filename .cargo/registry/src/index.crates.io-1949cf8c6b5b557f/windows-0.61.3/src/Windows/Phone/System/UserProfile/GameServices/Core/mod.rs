...
impl GameService {
    pub fn ServiceUri() -> windows_core::Result<super::super::super::super::super::Foundation::Uri>
    {
        Self::IGameService(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).ServiceUri)(
    ...
    pub fn GetGamerProfileAsync(
    ) -> windows_core::Result<windows_future::IAsyncOperation<GameServicePropertyCollection>> {
        Self::IGameService(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetGamerProfileAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetInstalledGameItemsAsync(
    ) -> windows_core::Result<windows_future::IAsyncOperation<GameServicePropertyCollection>> {
        Self::IGameService(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetInstalledGameItemsAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::super::super::super::Foundation::Uri>,
    {
        Self::IGameService(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPartnerTokenAsync)(
                windows_core::Interface::as_raw(this),
                audienceuri.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    ...
    pub fn GetPrivilegesAsync(
        ...
        Self::IGameService(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetPrivilegesAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GrantAchievement(achievementid: u32) -> windows_core::Result<()> {
        Self::IGameService(|this| unsafe {
            (windows_core::Interface::vtable(this).GrantAchievement)(
                windows_core::Interface::as_raw(this),
                achievementid,
            )
            .ok()
    ...
    pub fn GrantAvatarAward(avatarawardid: u32) -> windows_core::Result<()> {
        Self::IGameService(|this| unsafe {
            (windows_core::Interface::vtable(this).GrantAvatarAward)(
                windows_core::Interface::as_raw(this),
                avatarawardid,
            )
            .ok()
    ...
    {
        Self::IGameService(|this| unsafe {
            (windows_core::Interface::vtable(this).PostResult)(
                windows_core::Interface::as_raw(this),
                gamevariant,
                scorekind,
                scorevalue,
        ...
        P0: windows_core::Param<super::super::super::super::super::Foundation::Uri>,
    {
        Self::IGameService2(|this| unsafe {
            (windows_core::Interface::vtable(this).NotifyPartnerTokenExpired)(
                windows_core::Interface::as_raw(this),
                audienceuri.param().abi(),
            )
            .ok()
    ...
    pub fn GetAuthenticationStatus() -> windows_core::Result<u32> {
        Self::IGameService2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAuthenticationStatus)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    fn IGameService<R, F: FnOnce(&IGameService) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<GameService, IGameService> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IGameService2<R, F: FnOnce(&IGameService2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<GameService, IGameService2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl windows_core::RuntimeType for GameServiceGameOutcome {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Phone.System.UserProfile.GameServices.Core.GameServiceGameOutcome;i4)",
    );
}
#[repr(transparent)]
...
impl windows_core::RuntimeType for GameServicePropertyCollection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IGameServicePropertyCollection>();
}
unsafe impl windows_core::Interface for GameServicePropertyCollection {
    ...
    const IID: windows_core::GUID =
        <IGameServicePropertyCollection as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for GameServiceScoreKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Phone.System.UserProfile.GameServices.Core.GameServiceScoreKind;i4)",
    );
}
windows_core::imp::define_interface!(
    IGameService,
    IGameService_Vtbl,
    0x2e2d5098_48a9_4efc_afd6_8e6da09003fb
);
...
pub struct IGameService_Vtbl {
    ...
    pub ServiceUri: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetGamerProfileAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetInstalledGameItemsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetPartnerTokenAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetPrivilegesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GrantAchievement:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub GrantAvatarAward:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    pub PostResult: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
...
windows_core::imp::define_interface!(
    IGameService2,
    IGameService2_Vtbl,
    0xd2364ef6_ea17_4be5_8d8a_c860885e051f
);
...
pub struct IGameService2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub NotifyPartnerTokenExpired: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IGameServicePropertyCollection_Vtbl,
    0x07e57fc8_debb_4609_9cc8_529d16bc2bd9
);

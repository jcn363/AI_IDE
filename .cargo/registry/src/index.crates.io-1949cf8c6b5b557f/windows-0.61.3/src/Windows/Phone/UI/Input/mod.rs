...
impl windows_core::RuntimeType for BackPressedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBackPressedEventArgs>();
}
...
impl windows_core::RuntimeType for CameraEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICameraEventArgs>();
}
...
impl HardwareButtons {
        ...
        >,
    {
        Self::IHardwareButtonsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BackPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveBackPressed(token: i64) -> windows_core::Result<()> {
        Self::IHardwareButtonsStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveBackPressed)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::super::Foundation::EventHandler<CameraEventArgs>>,
    {
        Self::IHardwareButtonsStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CameraHalfPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveCameraHalfPressed(token: i64) -> windows_core::Result<()> {
        Self::IHardwareButtonsStatics2(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveCameraHalfPressed)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::super::Foundation::EventHandler<CameraEventArgs>>,
    {
        Self::IHardwareButtonsStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CameraPressed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveCameraPressed(token: i64) -> windows_core::Result<()> {
        Self::IHardwareButtonsStatics2(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveCameraPressed)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::super::Foundation::EventHandler<CameraEventArgs>>,
    {
        Self::IHardwareButtonsStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CameraReleased)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveCameraReleased(token: i64) -> windows_core::Result<()> {
        Self::IHardwareButtonsStatics2(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveCameraReleased)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    fn IHardwareButtonsStatics<
        R,
        F: FnOnce(&IHardwareButtonsStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<HardwareButtons, IHardwareButtonsStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IHardwareButtonsStatics2<
        R,
        F: FnOnce(&IHardwareButtonsStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<HardwareButtons, IHardwareButtonsStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
windows_core::imp::define_interface!(
    ...
    IBackPressedEventArgs_Vtbl,
    0xf6f555ff_64ec_42a2_b93b_2fbc0c36a121
);
...
windows_core::imp::define_interface!(
    ICameraEventArgs,
    ICameraEventArgs_Vtbl,
    0xb4063bda_201f_473d_bc69_e9e4ac57c9d0
);
...
windows_core::imp::define_interface!(
    ...
    0x594b8780_da66_4fd8_a776_7506bd0cbfa7
);
...
pub struct IHardwareButtonsStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub BackPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveBackPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IHardwareButtonsStatics2,
    IHardwareButtonsStatics2_Vtbl,
    0x39c6c274_993f_40dd_854c_831a8934b92e
);
...
pub struct IHardwareButtonsStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CameraHalfPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveCameraHalfPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub CameraPressed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveCameraPressed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub CameraReleased: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveCameraReleased:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}

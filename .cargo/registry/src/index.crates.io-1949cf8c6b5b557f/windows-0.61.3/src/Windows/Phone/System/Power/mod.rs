windows_core::imp::define_interface!(
    ...
    0x25de8fd0_1c5b_11e1_bddb_0800200c9a66
);
...
pub struct IPowerManagerStatics_Vtbl {
    ...
    pub PowerSavingMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PowerSavingMode,
    ) -> windows_core::HRESULT,
    pub PowerSavingModeChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemovePowerSavingModeChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPowerManagerStatics2,
    IPowerManagerStatics2_Vtbl,
    0x596236cf_1918_4551_a466_c51aae373bf8
);
...
impl PowerManager {
    pub fn PowerSavingMode() -> windows_core::Result<PowerSavingMode> {
        Self::IPowerManagerStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).PowerSavingMode)(
        ...
        >,
    {
        Self::IPowerManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PowerSavingModeChanged)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn RemovePowerSavingModeChanged(token: i64) -> windows_core::Result<()> {
        Self::IPowerManagerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemovePowerSavingModeChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn PowerSavingModeEnabled() -> windows_core::Result<bool> {
        Self::IPowerManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PowerSavingModeEnabled)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    fn IPowerManagerStatics2<R, F: FnOnce(&IPowerManagerStatics2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {

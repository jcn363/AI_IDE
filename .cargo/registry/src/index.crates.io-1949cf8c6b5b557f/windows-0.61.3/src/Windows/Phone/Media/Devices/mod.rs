...
impl AudioRoutingManager {
    pub fn GetAudioEndpoint(&self) -> windows_core::Result<AudioRoutingEndpoint> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).GetAudioEndpoint)(
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AudioEndpointChanged)(
                windows_core::Interface::as_raw(this),
                endpointchangehandler.param().abi(),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub fn RemoveAudioEndpointChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveAudioEndpointChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn AvailableAudioEndpoints(&self) -> windows_core::Result<AvailableAudioRoutingEndpoints> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AvailableAudioEndpoints)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    fn IAudioRoutingManagerStatics<
        R,
        F: FnOnce(&IAudioRoutingManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for AudioRoutingManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAudioRoutingManager>();
}
...
windows_core::imp::define_interface!(
    ...
    IAudioRoutingManager_Vtbl,
    0x79340d20_71cc_4526_9f29_fc8d2486418b
);
...
pub struct IAudioRoutingManager_Vtbl {
    ...
    pub GetAudioEndpoint: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut AudioRoutingEndpoint,
    ) -> windows_core::HRESULT,
    pub SetAudioEndpoint: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        AudioRoutingEndpoint,
    ) -> windows_core::HRESULT,
    pub AudioEndpointChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveAudioEndpointChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub AvailableAudioEndpoints: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut AvailableAudioRoutingEndpoints,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IAudioRoutingManagerStatics,
    IAudioRoutingManagerStatics_Vtbl,
    0x977fb2a4_5590_4a6f_adde_6a3d0ad58250
);

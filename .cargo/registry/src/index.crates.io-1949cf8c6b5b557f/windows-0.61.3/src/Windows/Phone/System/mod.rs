...
windows_core::imp::define_interface!(
    ...
    ISystemProtectionStatics_Vtbl,
    0x49c36560_97e1_4d99_8bfb_befeaa6ace6d
);
...
windows_core::imp::define_interface!(
    ...
    ISystemProtectionUnlockStatics_Vtbl,
    0x0692fa3f_8f11_4c4b_aa0d_87d7af7b1779
);
...
impl SystemProtection {
    pub fn ScreenLocked() -> windows_core::Result<bool> {
        Self::ISystemProtectionStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).ScreenLocked)(
    ...
    pub fn RequestScreenUnlock() -> windows_core::Result<()> {
        Self::ISystemProtectionUnlockStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RequestScreenUnlock)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        })
    ...
    fn ISystemProtectionStatics<
        R,
        F: FnOnce(&ISystemProtectionStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SystemProtection, ISystemProtectionStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ISystemProtectionUnlockStatics<
        R,
        F: FnOnce(&ISystemProtectionUnlockStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {

...
impl<K: windows_core::RuntimeType + 'static, V: windows_core::RuntimeType + 'static>
    windows_core::imp::CanInto<
        windows_collections::IIterable<windows_collections::IKeyValuePair<K, V>>,
    > for IObservableMap<K, V>
{
    const QUERY: bool = true;
}
impl<K: windows_core::RuntimeType + 'static, V: windows_core::RuntimeType + 'static>
    windows_core::imp::CanInto<windows_collections::IMap<K, V>> for IObservableMap<K, V>
{
    const QUERY: bool = true;
}
impl<K: windows_core::RuntimeType + 'static, V: windows_core::RuntimeType + 'static>
...
pub trait IObservableMap_Impl<K, V>:
    windows_collections::IIterable_Impl<windows_collections::IKeyValuePair<K, V>>
    + windows_collections::IMap_Impl<K, V>
where
    K: windows_core::RuntimeType + 'static,
    V: windows_core::RuntimeType + 'static,
{
    fn MapChanged(
        &self,
        vhnd: windows_core::Ref<'_, MapChangedEventHandler<K, V>>,
...
impl<T: windows_core::RuntimeType + 'static>
    windows_core::imp::CanInto<windows_collections::IIterable<T>> for IObservableVector<T>
{
    const QUERY: bool = true;
}
impl<T: windows_core::RuntimeType + 'static>
    windows_core::imp::CanInto<windows_collections::IVector<T>> for IObservableVector<T>
{
    const QUERY: bool = true;
}
...
pub trait IObservableVector_Impl<T>:
    windows_collections::IIterable_Impl<T> + windows_collections::IVector_Impl<T>
where
    T: windows_core::RuntimeType + 'static,
{
    fn VectorChanged(
        &self,
        vhnd: windows_core::Ref<'_, VectorChangedEventHandler<T>>,
    ) -> windows_core::Result<i64>;
...
pub trait IPropertySet_Impl:
    windows_collections::IIterable_Impl<
        windows_collections::IKeyValuePair<windows_core::HSTRING, windows_core::IInspectable>,
    > + windows_collections::IMap_Impl<windows_core::HSTRING, windows_core::IInspectable>
...
impl IPropertySet_Vtbl {
    pub const fn new<Identity: IPropertySet_Impl, const OFFSET: isize>() -> Self {
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IPropertySet, OFFSET>(),
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
    ...
    MapChangedEventHandler<K, V>
{
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, IObservableMap<K, V>>,
                windows_core::Ref<'_, IMapChangedEventArgs<K>>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
...
impl<T: windows_core::RuntimeType + 'static> VectorChangedEventHandler<T> {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, IObservableVector<T>>,
                windows_core::Ref<'_, IVectorChangedEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(

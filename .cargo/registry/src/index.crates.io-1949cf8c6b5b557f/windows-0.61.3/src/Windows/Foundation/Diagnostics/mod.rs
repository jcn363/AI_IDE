...
impl AsyncCausalityTracer {
    ...
    pub fn TraceOperationCompletion(
        ...
        platformid: windows_core::GUID,
        operationid: u64,
        status: windows_future::AsyncStatus,
    ) -> windows_core::Result<()> {
        Self::IAsyncCausalityTracerStatics(|this| unsafe {
...
impl ErrorDetails {
    ...
    pub fn CreateFromHResultAsync(
        errorcode: i32,
    ) -> windows_core::Result<windows_future::IAsyncOperation<ErrorDetails>> {
    ...
    fn IErrorDetailsStatics<R, F: FnOnce(&IErrorDetailsStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ErrorDetails, IErrorDetailsStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl FileLoggingSession {
    ...
    pub fn CloseAndSaveToFileAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::super::Storage::StorageFile>>
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CloseAndSaveToFileAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IAsyncCausalityTracerStatics_Vtbl {
    ...
    pub TraceSynchronousWorkCompletion: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        CausalityTraceLevel,
        CausalitySource,
        CausalitySynchronousWork,
...
pub struct IErrorReportingSettings_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SetErrorOptions:
        unsafe extern "system" fn(*mut core::ffi::c_void, ErrorOptions) -> windows_core::HRESULT,
...
pub trait IFileLoggingSession_Impl: super::IClosable_Impl {
    ...
    fn AddLoggingChannel(
        &self,
        loggingChannel: windows_core::Ref<'_, ILoggingChannel>,
    ) -> windows_core::Result<()>;
...
impl IFileLoggingSession_Vtbl {
    pub const fn new<Identity: IFileLoggingSession_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Name<Identity: IFileLoggingSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                ...
                IFileLoggingSession_Impl::AddLoggingChannel(
                    this,
                    core::mem::transmute_copy(&loggingchannel),
                )
                .into()
            }
        }
        ...
        unsafe extern "system" fn CloseAndSaveToFileAsync<
            Identity: IFileLoggingSession_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub struct IFileLoggingSession_Vtbl {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub CloseAndSaveToFileAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct ILoggingActivity2_Vtbl {
    ...
    pub StopActivityWithFieldsAndOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
pub struct ILoggingActivityFactory_Vtbl {
    ...
    pub CreateLoggingActivityWithLevel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        LoggingLevel,
...
pub trait ILoggingChannel_Impl: super::IClosable_Impl {
    ...
    fn LogValuePair(&self, value1: &windows_core::HSTRING, value2: i32)
        -> windows_core::Result<()>;
...
impl ILoggingChannel_Vtbl {
    pub const fn new<Identity: ILoggingChannel_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Name<Identity: ILoggingChannel_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Enabled<Identity: ILoggingChannel_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut bool,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Level<Identity: ILoggingChannel_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ILoggingChannel_Impl::LogValuePair(this, core::mem::transmute(&value1), value2)
                    .into()
            }
        }
...
pub struct ILoggingFields_Vtbl {
    ...
    pub AddUInt8ArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const u8,
    ...
    pub AddInt16ArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const i16,
    ...
    pub AddUInt16ArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const u16,
    ...
    pub AddInt32ArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const i32,
    ...
    pub AddUInt32ArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const u32,
    ...
    pub AddInt64ArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const i64,
    ...
    pub AddUInt64ArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const u64,
    ...
    pub AddSingleArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const f32,
    ...
    pub AddDoubleArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const f64,
    ...
    pub AddChar16ArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const u16,
    ...
    pub AddBooleanArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const bool,
    ...
    pub AddStringArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const windows_core::HSTRING,
    ...
    pub AddGuidArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const windows_core::GUID,
    ...
    pub AddDateTimeWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::DateTime,
        LoggingFieldFormat,
    ...
    pub AddDateTimeArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const super::DateTime,
    ...
    pub AddTimeSpanWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::TimeSpan,
        LoggingFieldFormat,
    ...
    pub AddTimeSpanArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const super::TimeSpan,
    ...
    pub AddPointArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const super::Point,
    ...
    pub AddSizeArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const super::Size,
    ...
    pub AddRectArrayWithFormatAndTags: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const super::Rect,
...
pub struct ILoggingOptions_Vtbl {
    ...
    pub SetOpcode:
        unsafe extern "system" fn(*mut core::ffi::c_void, LoggingOpcode) -> windows_core::HRESULT,
...
pub trait ILoggingSession_Impl: super::IClosable_Impl {
    ...
    fn SaveToFileAsync(
        &self,
        folder: windows_core::Ref<'_, super::super::Storage::IStorageFolder>,
        fileName: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::super::Storage::StorageFile>>;
    fn AddLoggingChannel(
        &self,
...
impl ILoggingSession_Vtbl {
    pub const fn new<Identity: ILoggingSession_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Name<Identity: ILoggingSession_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SaveToFileAsync<
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ILoggingSession_Impl::SaveToFileAsync(
                    this,
...
pub trait ILoggingTarget_Impl: windows_core::IUnknownImpl {
    ...
    fn LogEventWithFields(
        &self,
        eventName: &windows_core::HSTRING,
        fields: windows_core::Ref<'_, LoggingFields>,
    ) -> windows_core::Result<()>;
    ...
    fn LogEventWithFieldsAndOptions(
        ...
        fields: windows_core::Ref<'_, LoggingFields>,
        level: LoggingLevel,
        options: windows_core::Ref<'_, LoggingOptions>,
    ) -> windows_core::Result<()>;
    fn StartActivity(
        &self,
        startEventName: &windows_core::HSTRING,
...
impl ILoggingTarget_Vtbl {
    pub const fn new<Identity: ILoggingTarget_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsEnabled<Identity: ILoggingTarget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut bool,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn LogEvent<Identity: ILoggingTarget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                ...
                ILoggingTarget_Impl::LogEventWithFields(
                    ...
                    core::mem::transmute_copy(&fields),
                )
                .into()
            }
        }
...
pub struct ILoggingTarget_Vtbl {
    ...
    pub IsEnabledWithLevelAndKeywords: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        LoggingLevel,
        i64,
        *mut bool,
    ...
    pub LogEventWithFieldsAndOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        LoggingLevel,
    ...
    pub StartActivityWithFieldsAndLevel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        LoggingLevel,
    ...
    pub StartActivityWithFieldsAndOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        LoggingLevel,
...
impl LoggingActivity {
    ...
    >(
        ...
        static SHARED: windows_core::imp::FactoryCache<LoggingActivity, ILoggingActivityFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl LoggingChannel {
    ...
    fn ILoggingChannelFactory<R, F: FnOnce(&ILoggingChannelFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<LoggingChannel, ILoggingChannelFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    ...
    >(
        ...
        static SHARED: windows_core::imp::FactoryCache<LoggingChannel, ILoggingChannelFactory2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl LoggingFields {
    ...
    pub fn EndStruct(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).EndStruct)(windows_core::Interface::as_raw(this))
                .ok()
        }
    }
...
impl LoggingOptions {
    ...
    fn ILoggingOptionsFactory<R, F: FnOnce(&ILoggingOptionsFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<LoggingOptions, ILoggingOptionsFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl LoggingSession {
    ...
    fn ILoggingSessionFactory<R, F: FnOnce(&ILoggingSessionFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<LoggingSession, ILoggingSessionFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}

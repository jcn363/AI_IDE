windows_core::imp::define_interface!(
    ...
    0x0fd340a5_f574_4320_a08e_0a19a82322aa
);
...
pub struct IMicrosoftAccountMultiFactorAuthenticationManager_Vtbl {
    ...
    pub GetOneTimePassCodeAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AddDeviceAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub RemoveDeviceAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UpdateWnsChannelAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetSessionsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetSessionsAndUnregisteredAccountsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
    pub ApproveSessionUsingAuthSessionInfoAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        ...
        *mut *mut core::ffi::c_void,
        ...
        -> windows_core::HRESULT,
    pub ApproveSessionAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        MicrosoftAccountMultiFactorSessionAuthenticationStatus,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub DenySessionUsingAuthSessionInfoAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
    pub DenySessionAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        MicrosoftAccountMultiFactorAuthenticationType,
...
windows_core::imp::define_interface!(
    ...
    0xd964c2e6_f446_4c71_8b79_6ea4024aa9b8
);
...
windows_core::imp::define_interface!(
    ...
    IMicrosoftAccountMultiFactorGetSessionsResult_Vtbl,
    0x4e23a9a0_e9fa_497a_95de_6d5747bf974c
);
...
pub struct IMicrosoftAccountMultiFactorGetSessionsResult_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Sessions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ServiceResponse: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut MicrosoftAccountMultiFactorServiceResponse,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
...
pub struct IMicrosoftAccountMultiFactorOneTimeCodedInfo_Vtbl {
    ...
    pub TimeInterval: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub TimeToLive: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub ServiceResponse: unsafe extern "system" fn(
...
windows_core::imp::define_interface!(
    ...
    0x5f7eabb4_a278_4635_b765_b494eb260af4
);
...
pub struct IMicrosoftAccountMultiFactorSessionInfo_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub UserAccountId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub DisplaySessionId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ApprovalStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut MicrosoftAccountMultiFactorSessionApprovalStatus,
    ) -> windows_core::HRESULT,
    pub AuthenticationType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut MicrosoftAccountMultiFactorAuthenticationType,
    ) -> windows_core::HRESULT,
    pub RequestTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IMicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo_Vtbl,
    0xaa7ec5fb_da3f_4088_a20d_5618afadb2e5
);
...
pub struct IMicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo_Vtbl {
    ...
    pub UnregisteredAccounts: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ServiceResponse: unsafe extern "system" fn(
...
impl MicrosoftAccountMultiFactorAuthenticationManager {
    pub fn GetOneTimePassCodeAsync(
        &self,
        useraccountid: &windows_core::HSTRING,
        codelength: u32,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<MicrosoftAccountMultiFactorOneTimeCodedInfo>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetOneTimePassCodeAsync)(
    ...
    pub fn AddDeviceAsync(
        &self,
        useraccountid: &windows_core::HSTRING,
        authenticationtoken: &windows_core::HSTRING,
        wnschannelid: &windows_core::HSTRING,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<MicrosoftAccountMultiFactorServiceResponse>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AddDeviceAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(useraccountid),
                core::mem::transmute_copy(authenticationtoken),
                core::mem::transmute_copy(wnschannelid),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn RemoveDeviceAsync(
        &self,
        useraccountid: &windows_core::HSTRING,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<MicrosoftAccountMultiFactorServiceResponse>,
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoveDeviceAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(useraccountid),
                &mut result__,
            )
    ...
    pub fn UpdateWnsChannelAsync(
        &self,
        useraccountid: &windows_core::HSTRING,
        channeluri: &windows_core::HSTRING,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<MicrosoftAccountMultiFactorServiceResponse>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UpdateWnsChannelAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(useraccountid),
                core::mem::transmute_copy(channeluri),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn GetSessionsAsync<P0>(
        &self,
        useraccountidlist: P0,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<MicrosoftAccountMultiFactorGetSessionsResult>,
    >
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetSessionsAsync)(
                windows_core::Interface::as_raw(this),
                useraccountidlist.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn GetSessionsAndUnregisteredAccountsAsync<P0>(
        &self,
        useraccountidlist: P0,
    ) -> windows_core::Result<
        ...
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetSessionsAndUnregisteredAccountsAsync)(
                windows_core::Interface::as_raw(this),
                useraccountidlist.param().abi(),
                &mut result__,
            )
        ...
        P1: windows_core::Param<MicrosoftAccountMultiFactorSessionInfo>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ApproveSessionUsingAuthSessionInfoAsync)(
                windows_core::Interface::as_raw(this),
                sessionauthentictionstatus,
                authenticationsessioninfo.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn ApproveSessionAsync(
        &self,
        sessionauthentictionstatus: MicrosoftAccountMultiFactorSessionAuthenticationStatus,
        useraccountid: &windows_core::HSTRING,
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ApproveSessionAsync)(
                windows_core::Interface::as_raw(this),
                sessionauthentictionstatus,
                core::mem::transmute_copy(useraccountid),
    ...
    pub fn DenySessionUsingAuthSessionInfoAsync<P0>(
        &self,
        authenticationsessioninfo: P0,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<MicrosoftAccountMultiFactorServiceResponse>,
    >
    where
        P0: windows_core::Param<MicrosoftAccountMultiFactorSessionInfo>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DenySessionUsingAuthSessionInfoAsync)(
                windows_core::Interface::as_raw(this),
                authenticationsessioninfo.param().abi(),
                &mut result__,
            )
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DenySessionAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(useraccountid),
                core::mem::transmute_copy(sessionid),
                sessionauthenticationtype,
    ...
    fn IMicrosoftAccountMultiFactorAuthenticatorStatics<
        R,
        F: FnOnce(&IMicrosoftAccountMultiFactorAuthenticatorStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
unsafe impl windows_core::Interface for MicrosoftAccountMultiFactorAuthenticationManager {
    type Vtable =
        <IMicrosoftAccountMultiFactorAuthenticationManager as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IMicrosoftAccountMultiFactorAuthenticationManager as windows_core::Interface>::IID;
}
...
impl MicrosoftAccountMultiFactorGetSessionsResult {
    pub fn Sessions(
        ...
        windows_collections::IVectorView<MicrosoftAccountMultiFactorSessionInfo>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Sessions)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ServiceResponse(
        &self,
    ) -> windows_core::Result<MicrosoftAccountMultiFactorServiceResponse> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ServiceResponse)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
unsafe impl windows_core::Interface for MicrosoftAccountMultiFactorGetSessionsResult {
    type Vtable =
        <IMicrosoftAccountMultiFactorGetSessionsResult as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IMicrosoftAccountMultiFactorGetSessionsResult as windows_core::Interface>::IID;
}
...
impl MicrosoftAccountMultiFactorOneTimeCodedInfo {
    ...
    pub fn TimeInterval(
        &self,
    ) -> windows_core::Result<super::super::super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TimeInterval)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn TimeToLive(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TimeToLive)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
unsafe impl windows_core::Interface for MicrosoftAccountMultiFactorOneTimeCodedInfo {
    ...
    const IID: windows_core::GUID =
        <IMicrosoftAccountMultiFactorOneTimeCodedInfo as windows_core::Interface>::IID;
}
...
impl MicrosoftAccountMultiFactorSessionInfo {
    pub fn UserAccountId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UserAccountId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn DisplaySessionId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DisplaySessionId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn ApprovalStatus(
        &self,
    ) -> windows_core::Result<MicrosoftAccountMultiFactorSessionApprovalStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ApprovalStatus)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn AuthenticationType(
        &self,
    ) -> windows_core::Result<MicrosoftAccountMultiFactorAuthenticationType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestTime(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for MicrosoftAccountMultiFactorSessionInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMicrosoftAccountMultiFactorSessionInfo>(
        );
}
unsafe impl windows_core::Interface for MicrosoftAccountMultiFactorSessionInfo {
    ...
    const IID: windows_core::GUID =
        <IMicrosoftAccountMultiFactorSessionInfo as windows_core::Interface>::IID;
}
...
impl MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo {
    ...
    pub fn UnregisteredAccounts(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UnregisteredAccounts)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
unsafe impl windows_core::Interface
    for MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo
{

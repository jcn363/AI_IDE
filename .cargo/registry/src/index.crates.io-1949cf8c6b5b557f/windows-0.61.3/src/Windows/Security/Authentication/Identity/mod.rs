...
impl EnterpriseKeyCredentialRegistrationInfo {
    pub fn TenantId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).TenantId)(
    ...
    pub fn TenantName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TenantName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn KeyName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).KeyName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
unsafe impl windows_core::Interface for EnterpriseKeyCredentialRegistrationInfo {
    ...
    const IID: windows_core::GUID =
        <IEnterpriseKeyCredentialRegistrationInfo as windows_core::Interface>::IID;
}
...
impl EnterpriseKeyCredentialRegistrationManager {
    pub fn GetRegistrationsAsync(
        &self,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<
            windows_collections::IVectorView<EnterpriseKeyCredentialRegistrationInfo>,
        >,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetRegistrationsAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    fn IEnterpriseKeyCredentialRegistrationManagerStatics<
        R,
        F: FnOnce(&IEnterpriseKeyCredentialRegistrationManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
unsafe impl windows_core::Interface for EnterpriseKeyCredentialRegistrationManager {
    ...
    const IID: windows_core::GUID =
        <IEnterpriseKeyCredentialRegistrationManager as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    IEnterpriseKeyCredentialRegistrationInfo,
    IEnterpriseKeyCredentialRegistrationInfo_Vtbl,
    0x38321acc_672b_4823_b603_6b3c753daf97
);
...
pub struct IEnterpriseKeyCredentialRegistrationInfo_Vtbl {
    ...
    pub TenantId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TenantName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub KeyName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IEnterpriseKeyCredentialRegistrationManager,
    IEnterpriseKeyCredentialRegistrationManager_Vtbl,
...
pub struct IEnterpriseKeyCredentialRegistrationManager_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetRegistrationsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IEnterpriseKeyCredentialRegistrationManagerStatics,
    IEnterpriseKeyCredentialRegistrationManagerStatics_Vtbl,
    0x77b85e9e_acf4_4bc0_bac2_40bb46efbb3f
);

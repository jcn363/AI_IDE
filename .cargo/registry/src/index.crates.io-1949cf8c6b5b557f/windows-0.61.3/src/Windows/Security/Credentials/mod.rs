...
windows_core::imp::define_interface!(
    ICredentialFactory,
    ICredentialFactory_Vtbl,
    0x54ef13a1_bf26_47b5_97dd_de779b7cad58
);
...
pub struct ICredentialFactory_Vtbl {
    ...
    pub CreatePasswordCredential: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x6ab18989_c720_41a7_a6c1_feadb36329a0
);
...
windows_core::imp::define_interface!(
    IPasswordVault,
    IPasswordVault_Vtbl,
    0x61fd2c0b_c8d4_48c1_a54f_bc5a64205af2
);
...
pub struct IPasswordVault_Vtbl {
    ...
    pub Retrieve: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FindAllByResource: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FindAllByUserName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RetrieveAll: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWebAccount,
    IWebAccount_Vtbl,
    0x69473eb2_8031_49be_80bb_96cb46d99aba
);
...
impl IWebAccount_Vtbl {
    pub const fn new<Identity: IWebAccount_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn WebAccountProvider<
        ...
        unsafe extern "system" fn UserName<Identity: IWebAccount_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn State<Identity: IWebAccount_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut WebAccountState,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(
    IWebAccount2,
    IWebAccount2_Vtbl,
    0x7b56d6f8_990b_4eb5_94a7_5621f3a8b824
);
...
pub struct IWebAccount2_Vtbl {
    ...
    pub SignOutAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SignOutWithClientIdAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IWebAccountFactory,
    IWebAccountFactory_Vtbl,
    0xac9afb39_1de9_4e92_b78f_0581a87f6e5c
);
...
pub struct IWebAccountFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateWebAccount: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WebAccountState,
...
windows_core::imp::define_interface!(
    IWebAccountProvider,
    IWebAccountProvider_Vtbl,
    0x29dcc8c3_7ab9_4a7c_a336_b942f9dbf7c7
);
...
windows_core::imp::define_interface!(
    ...
    IWebAccountProvider2_Vtbl,
    0x4a01eb05_4e42_41d4_b518_e008a5163614
);
...
pub struct IWebAccountProvider2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub DisplayPurpose: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IWebAccountProvider4_Vtbl,
    0x718fd8db_e796_4210_b74e_84d29894b080
);
...
pub struct IWebAccountProvider4_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsSystemProvider:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWebAccountProviderFactory,
    IWebAccountProviderFactory_Vtbl,
    0x1d767df1_e1e1_4b9a_a774_5c7c7e3bf371
);
...
pub struct IWebAccountProviderFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateWebAccountProvider: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
impl KeyCredential {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn RetrievePublicKeyWithDefaultBlobType(
        &self,
    ...
    pub fn RetrievePublicKeyWithBlobType(
        &self,
        blobtype: super::Cryptography::Core::CryptographicPublicKeyBlobType,
    ) -> windows_core::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PasswordCredential {
    ...
    pub fn CreatePasswordCredential(
        resource: &windows_core::HSTRING,
        username: &windows_core::HSTRING,
        password: &windows_core::HSTRING,
    ) -> windows_core::Result<PasswordCredential> {
        Self::ICredentialFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreatePasswordCredential)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn SetResource(&self, resource: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetResource)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(resource),
            )
            .ok()
    ...
    pub fn RetrievePassword(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RetrievePassword)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    fn ICredentialFactory<R, F: FnOnce(&ICredentialFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PasswordCredential, ICredentialFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for PasswordCredential {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPasswordCredential>();
}
...
impl PasswordCredentialPropertyStore {
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::Collections::MapChangedEventHandler<
                windows_core::HSTRING,
                windows_core::IInspectable,
            >,
        >,
    {
        let this = &windows_core::Interface::cast::<
            super::super::Foundation::Collections::IObservableMap<
                windows_core::HSTRING,
                windows_core::IInspectable,
            >,
        >(self)?;
...
unsafe impl windows_core::Interface for PasswordCredentialPropertyStore {
    type Vtable =
        <super::super::Foundation::Collections::IPropertySet as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <super::super::Foundation::Collections::IPropertySet as windows_core::Interface>::IID;
}
#[cfg(feature = "Foundation_Collections")]
...
impl PasswordVault {
    ...
    pub fn Retrieve(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Retrieve)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(resource),
                core::mem::transmute_copy(username),
                &mut result__,
    ...
    pub fn FindAllByResource(
        &self,
        resource: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_collections::IVectorView<PasswordCredential>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindAllByResource)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(resource),
                &mut result__,
            )
    ...
    pub fn FindAllByUserName(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindAllByUserName)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(username),
                &mut result__,
            )
    ...
    pub fn RetrieveAll(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RetrieveAll)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for PasswordVault {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPasswordVault>();
}
...
impl WebAccount {
    ...
    pub fn GetPictureAsync(
        &self,
        desizedsize: WebAccountPictureSize,
    ) -> windows_core::Result<
    ...
    pub fn SignOutAsync(&self) -> windows_core::Result<windows_future::IAsyncAction> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SignOutAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SignOutWithClientIdAsync(
        &self,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SignOutWithClientIdAsync)(
                windows_core::Interface::as_raw(this),
    ...
    fn IWebAccountFactory<R, F: FnOnce(&IWebAccountFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<WebAccount, IWebAccountFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for WebAccount {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebAccount>();
}
...
impl windows_core::RuntimeType for WebAccountPictureSize {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Security.Credentials.WebAccountPictureSize;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl WebAccountProvider {
    ...
    pub fn DisplayPurpose(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DisplayPurpose)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn Authority(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Authority)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn IsSystemProvider(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsSystemProvider)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    fn IWebAccountProviderFactory<
        R,
        F: FnOnce(&IWebAccountProviderFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for WebAccountProvider {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebAccountProvider>();
}
...
impl windows_core::RuntimeType for WebAccountState {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Security.Credentials.WebAccountState;i4)",
    );
}

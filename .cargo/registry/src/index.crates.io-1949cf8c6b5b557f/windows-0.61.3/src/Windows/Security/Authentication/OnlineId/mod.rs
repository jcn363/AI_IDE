...
impl windows_core::RuntimeType for CredentialPromptType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Security.Authentication.OnlineId.CredentialPromptType;i4)",
    );
}
windows_core::imp::define_interface!(
    IOnlineIdAuthenticator,
    IOnlineIdAuthenticator_Vtbl,
    0xa003f58a_29ab_4817_b884_d7516dad18b9
);
...
pub struct IOnlineIdAuthenticator_Vtbl {
    ...
    pub AuthenticateUserAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AuthenticateUserAsyncAdvanced: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        CredentialPromptType,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SignOutUserAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetApplicationId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
    ) -> windows_core::HRESULT,
    ...
    pub AuthenticatedSafeCustomerId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IOnlineIdServiceTicket_Vtbl,
    0xc95c547f_d781_4a94_acb8_c59874238c26
);
...
windows_core::imp::define_interface!(
    ...
    IOnlineIdServiceTicketRequest_Vtbl,
    0x297445d3_fb63_4135_8909_4e354c061466
);
...
windows_core::imp::define_interface!(
    ...
    IOnlineIdServiceTicketRequestFactory_Vtbl,
    0xbebb0a08_9e73_4077_9614_08614c0bc245
);
...
pub struct IOnlineIdServiceTicketRequestFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateOnlineIdServiceTicketRequest: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateOnlineIdServiceTicketRequestAdvanced:
...
windows_core::imp::define_interface!(
    ...
    IOnlineIdSystemAuthenticatorForUser_Vtbl,
    0x5798befb_1de4_4186_a2e6_b563f86aaf44
);
...
pub struct IOnlineIdSystemAuthenticatorForUser_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetTicketAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IOnlineIdSystemIdentity_Vtbl,
    0x743cd20d_b6ca_434d_8124_53ea12685307
);
...
pub struct IOnlineIdSystemIdentity_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Ticket: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IOnlineIdSystemTicketResult_Vtbl,
    0xdb0a5ff8_b098_4acd_9d13_9e640652b5b6
);
...
pub struct IOnlineIdSystemTicketResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut OnlineIdSystemTicketStatus,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IUserIdentity,
    IUserIdentity_Vtbl,
    0x2146d9cd_0742_4be3_8a1c_7c7ae679aa88
);
...
pub struct IUserIdentity_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub Tickets: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Id: unsafe extern "system" fn(
    ...
    pub SafeCustomerId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SignInName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl OnlineIdAuthenticator {
    ...
    pub fn AuthenticateUserAsync<P0>(
        &self,
        request: P0,
    ) -> windows_core::Result<UserAuthenticationOperation>
    where
        P0: windows_core::Param<OnlineIdServiceTicketRequest>,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).AuthenticateUserAsync)(
    ...
    pub fn AuthenticateUserAsyncAdvanced<P0>(
        &self,
        requests: P0,
        ...
        P0: windows_core::Param<windows_collections::IIterable<OnlineIdServiceTicketRequest>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AuthenticateUserAsyncAdvanced)(
                windows_core::Interface::as_raw(this),
                requests.param().abi(),
                credentialprompttype,
                &mut result__,
    ...
    pub fn SignOutUserAsync(&self) -> windows_core::Result<SignOutUserOperation> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SignOutUserAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SetApplicationId(&self, value: windows_core::GUID) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetApplicationId)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn CanSignOut(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CanSignOut)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn AuthenticatedSafeCustomerId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AuthenticatedSafeCustomerId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
...
impl windows_core::RuntimeType for OnlineIdAuthenticator {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOnlineIdAuthenticator>();
}
...
impl windows_core::RuntimeType for OnlineIdServiceTicket {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOnlineIdServiceTicket>();
}
...
impl OnlineIdServiceTicketRequest {
    ...
    pub fn CreateOnlineIdServiceTicketRequest(
        service: &windows_core::HSTRING,
        policy: &windows_core::HSTRING,
    ) -> windows_core::Result<OnlineIdServiceTicketRequest> {
        Self::IOnlineIdServiceTicketRequestFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateOnlineIdServiceTicketRequest)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn CreateOnlineIdServiceTicketRequestAdvanced(
        service: &windows_core::HSTRING,
    ) -> windows_core::Result<OnlineIdServiceTicketRequest> {
        Self::IOnlineIdServiceTicketRequestFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateOnlineIdServiceTicketRequestAdvanced)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(service),
                &mut result__,
            )
    ...
    fn IOnlineIdServiceTicketRequestFactory<
        R,
        F: FnOnce(&IOnlineIdServiceTicketRequestFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for OnlineIdServiceTicketRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOnlineIdServiceTicketRequest>();
}
...
impl OnlineIdSystemAuthenticator {
    ...
    fn IOnlineIdSystemAuthenticatorStatics<
        R,
        F: FnOnce(&IOnlineIdSystemAuthenticatorStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl OnlineIdSystemAuthenticatorForUser {
    pub fn GetTicketAsync<P0>(
        &self,
        request: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<OnlineIdSystemTicketResult>>
    where
        P0: windows_core::Param<OnlineIdServiceTicketRequest>,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetTicketAsync)(
                windows_core::Interface::as_raw(this),
                request.param().abi(),
                &mut result__,
            )
...
impl windows_core::RuntimeType for OnlineIdSystemAuthenticatorForUser {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOnlineIdSystemAuthenticatorForUser>();
}
unsafe impl windows_core::Interface for OnlineIdSystemAuthenticatorForUser {
    ...
    const IID: windows_core::GUID =
        <IOnlineIdSystemAuthenticatorForUser as windows_core::Interface>::IID;
}
...
impl OnlineIdSystemIdentity {
    pub fn Ticket(&self) -> windows_core::Result<OnlineIdServiceTicket> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Ticket)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for OnlineIdSystemIdentity {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOnlineIdSystemIdentity>();
}
...
impl windows_core::RuntimeType for OnlineIdSystemTicketResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOnlineIdSystemTicketResult>();
}
...
impl windows_core::RuntimeType for OnlineIdSystemTicketStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Security.Authentication.OnlineId.OnlineIdSystemTicketStatus;i4)",
    );
}
...
impl UserIdentity {
    pub fn Tickets(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<OnlineIdServiceTicket>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Tickets)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SafeCustomerId(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SafeCustomerId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SignInName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SignInName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn IsBetaAccount(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsBetaAccount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn IsConfirmedPC(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsConfirmedPC)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for UserIdentity {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserIdentity>();
}

...
impl DataProtectionProvider {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ProtectStreamAsync<P0, P1>(
        &self,
        src: P0,
        dest: P1,
    ...
    pub fn CreateOverloadExplicit(
        protectiondescriptor: &windows_core::HSTRING,
    ) -> windows_core::Result<DataProtectionProvider> {
        Self::IDataProtectionProviderFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateOverloadExplicit)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(protectiondescriptor),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IDataProtectionProviderFactory<
        R,
        F: FnOnce(&IDataProtectionProviderFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for DataProtectionProvider {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDataProtectionProvider>();
}
...
windows_core::imp::define_interface!(
    ...
    IDataProtectionProvider_Vtbl,
    0x09639948_ed22_4270_bd1c_6d72c00f8787
);
...
windows_core::imp::define_interface!(
    IDataProtectionProviderFactory,
    IDataProtectionProviderFactory_Vtbl,
    0xadf33dac_4932_4cdf_ac41_7214333514ca
);
...
pub struct IDataProtectionProviderFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateOverloadExplicit: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,

...
impl CryptographicBuffer {
    ...
    pub fn GenerateRandom(
        ...
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GenerateRandom)(
                windows_core::Interface::as_raw(this),
                length,
                &mut result__,
            )
    ...
    pub fn GenerateRandomNumber() -> windows_core::Result<u32> {
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GenerateRandomNumber)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn DecodeFromHexString(
        ...
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DecodeFromHexString)(
                windows_core::Interface::as_raw(this),
        ...
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EncodeToHexString)(
                windows_core::Interface::as_raw(this),
                buffer.param().abi(),
                &mut result__,
            )
    ...
    pub fn DecodeFromBase64String(
        ...
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DecodeFromBase64String)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
                &mut result__,
            )
        ...
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EncodeToBase64String)(
                windows_core::Interface::as_raw(this),
                buffer.param().abi(),
                &mut result__,
            )
    ...
    pub fn ConvertStringToBinary(
        ...
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConvertStringToBinary)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
                encoding,
                &mut result__,
        ...
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ConvertBinaryToString)(
                windows_core::Interface::as_raw(this),
                encoding,
                buffer.param().abi(),
                &mut result__,
...
pub struct ICryptographicBufferStatics_Vtbl {
    ...
    Compare: usize,
    #[cfg(feature = "Storage_Streams")]
    pub GenerateRandom: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub DecodeFromHexString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub EncodeToHexString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub DecodeFromBase64String: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub EncodeToBase64String: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub ConvertStringToBinary: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub ConvertBinaryToString: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        BinaryStringEncoding,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,

...
windows_core::imp::define_interface!(
    ...
    IWebAuthenticationBrokerStatics_Vtbl,
    0x2f149f1a_e673_40b5_bc22_201a6864a37b
);
...
pub struct IWebAuthenticationBrokerStatics_Vtbl {
    ...
    pub AuthenticateWithCallbackUriAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub AuthenticateWithoutCallbackUriAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        WebAuthenticationOptions,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
        ...
        -> windows_core::HRESULT,
    pub GetCurrentApplicationCallbackUri: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IWebAuthenticationBrokerStatics2_Vtbl,
    0x73cdfb9e_14e7_41da_a971_aaf4410b621e
);
...
pub struct IWebAuthenticationBrokerStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AuthenticateAndContinue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AuthenticateWithCallbackUriAndContinue: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    )
    ...
    pub AuthenticateWithCallbackUriContinuationDataAndOptionsAndContinue:
    ...
    pub AuthenticateSilentlyAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AuthenticateSilentlyWithOptionsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        WebAuthenticationOptions,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IWebAuthenticationResult_Vtbl,
    0x64002b4b_ede9_470a_a5cd_0323faf6e262
);
...
pub struct IWebAuthenticationResult_Vtbl {
    ...
    pub ResponseStatus: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WebAuthenticationStatus,
    ) -> windows_core::HRESULT,
    pub ResponseErrorDetail:
...
impl windows_core::RuntimeType for TokenBindingKeyType {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Security.Authentication.Web.TokenBindingKeyType;i4)",
    );
}
pub struct WebAuthenticationBroker;
impl WebAuthenticationBroker {
    pub fn AuthenticateWithCallbackUriAsync<P1, P2>(
        options: WebAuthenticationOptions,
        requesturi: P1,
        callbackuri: P2,
    ) -> windows_core::Result<windows_future::IAsyncOperation<WebAuthenticationResult>>
    where
        ...
        P2: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IWebAuthenticationBrokerStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).AuthenticateWithCallbackUriAsync)(
                windows_core::Interface::as_raw(this),
                options,
                requesturi.param().abi(),
                callbackuri.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn AuthenticateWithoutCallbackUriAsync<P1>(
        options: WebAuthenticationOptions,
        requesturi: P1,
    ) -> windows_core::Result<windows_future::IAsyncOperation<WebAuthenticationResult>>
    where
        P1: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IWebAuthenticationBrokerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AuthenticateWithoutCallbackUriAsync)(
                windows_core::Interface::as_raw(this),
                options,
                requesturi.param().abi(),
                &mut result__,
    ...
    pub fn GetCurrentApplicationCallbackUri(
    ) -> windows_core::Result<super::super::super::Foundation::Uri> {
        Self::IWebAuthenticationBrokerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCurrentApplicationCallbackUri)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IWebAuthenticationBrokerStatics2(|this| unsafe {
            (windows_core::Interface::vtable(this).AuthenticateAndContinue)(
                windows_core::Interface::as_raw(this),
                requesturi.param().abi(),
            )
            .ok()
    ...
    pub fn AuthenticateWithCallbackUriAndContinue<P0, P1>(
        requesturi: P0,
        callbackuri: P1,
    ) -> windows_core::Result<()>
    where
    ...
    {
        Self::IWebAuthenticationBrokerStatics2(|this| unsafe {
            (windows_core::Interface::vtable(this).AuthenticateWithCallbackUriAndContinue)(
                windows_core::Interface::as_raw(this),
                requesturi.param().abi(),
                callbackuri.param().abi(),
            )
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AuthenticateWithCallbackUriContinuationDataAndOptionsAndContinue<P0, P1, P2>(
        requesturi: P0,
        callbackuri: P1,
        continuationdata: P2,
        options: WebAuthenticationOptions,
        ...
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IWebAuthenticationBrokerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AuthenticateSilentlyAsync)(
                windows_core::Interface::as_raw(this),
                requesturi.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IWebAuthenticationBrokerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AuthenticateSilentlyWithOptionsAsync)(
                windows_core::Interface::as_raw(this),
                requesturi.param().abi(),
                options,
                &mut result__,
    ...
    fn IWebAuthenticationBrokerStatics<
        R,
        F: FnOnce(&IWebAuthenticationBrokerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ...
    fn IWebAuthenticationBrokerStatics2<
        R,
        F: FnOnce(&IWebAuthenticationBrokerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for WebAuthenticationOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Security.Authentication.Web.WebAuthenticationOptions;u4)",
    );
}
impl WebAuthenticationOptions {
...
impl WebAuthenticationResult {
    ...
    pub fn ResponseErrorDetail(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResponseErrorDetail)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for WebAuthenticationResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebAuthenticationResult>();
}
...
impl windows_core::RuntimeType for WebAuthenticationStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Security.Authentication.Web.WebAuthenticationStatus;i4)",
    );
}

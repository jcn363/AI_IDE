windows_core::imp::define_interface!(
    ...
    IUserDataAvailabilityStateChangedEventArgs_Vtbl,
    0xa76582c9_06a2_4273_a803_834c9f87fbeb
);
...
windows_core::imp::define_interface!(
    ...
    IUserDataBufferUnprotectResult_Vtbl,
...
pub struct IUserDataBufferUnprotectResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut UserDataBufferUnprotectStatus,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    pub UnprotectedBuffer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IUserDataProtectionManager_Vtbl,
    0x1f13237d_b42e_4a88_9480_0f240924c876
);
...
pub struct IUserDataProtectionManager_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Storage")]
    pub ProtectStorageItemAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Storage")]
    pub GetStorageItemProtectionInfoAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub ProtectBufferAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        UserDataAvailability,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub UnprotectBufferAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub IsContinuedDataAvailabilityExpected: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        UserDataAvailability,
        *mut bool,
    )
        -> windows_core::HRESULT,
    pub DataAvailabilityStateChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveDataAvailabilityStateChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IUserDataProtectionManagerStatics,
    IUserDataProtectionManagerStatics_Vtbl,
    0x977780e8_6dce_4fae_af85_782ac2cf4572
);
...
pub struct IUserDataProtectionManagerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub TryGetDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "System")]
    pub TryGetForUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IUserDataStorageItemProtectionInfo_Vtbl,
    0x5b6680f6_e87f_40a1_b19d_a6187a0c662f
);
...
unsafe impl windows_core::Interface for UserDataAvailabilityStateChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IUserDataAvailabilityStateChangedEventArgs as windows_core::Interface>::IID;
}
...
impl UserDataBufferUnprotectResult {
    ...
    pub fn UnprotectedBuffer(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UnprotectedBuffer)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for UserDataBufferUnprotectResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataBufferUnprotectResult>();
}
unsafe impl windows_core::Interface for UserDataBufferUnprotectResult {
    ...
    const IID: windows_core::GUID =
        <IUserDataBufferUnprotectResult as windows_core::Interface>::IID;
}
...
impl UserDataProtectionManager {
    #[cfg(feature = "Storage")]
    pub fn ProtectStorageItemAsync<P0>(
        &self,
        storageitem: P0,
        availability: UserDataAvailability,
    ) -> windows_core::Result<windows_future::IAsyncOperation<UserDataStorageItemProtectionStatus>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageItem>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ProtectStorageItemAsync)(
                windows_core::Interface::as_raw(this),
    ...
    #[cfg(feature = "Storage")]
    pub fn GetStorageItemProtectionInfoAsync<P0>(
        &self,
        storageitem: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<UserDataStorageItemProtectionInfo>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageItem>,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetStorageItemProtectionInfoAsync)(
                windows_core::Interface::as_raw(this),
                storageitem.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ProtectBufferAsync<P0>(
        &self,
        unprotectedbuffer: P0,
        availability: UserDataAvailability,
    ) -> windows_core::Result<
        ...
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ProtectBufferAsync)(
                windows_core::Interface::as_raw(this),
                unprotectedbuffer.param().abi(),
                availability,
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn UnprotectBufferAsync<P0>(
        &self,
        protectedbuffer: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<UserDataBufferUnprotectResult>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UnprotectBufferAsync)(
                windows_core::Interface::as_raw(this),
                protectedbuffer.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub fn IsContinuedDataAvailabilityExpected(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsContinuedDataAvailabilityExpected)(
                windows_core::Interface::as_raw(this),
                availability,
                &mut result__,
            )
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DataAvailabilityStateChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveDataAvailabilityStateChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDataAvailabilityStateChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn TryGetDefault() -> windows_core::Result<UserDataProtectionManager> {
        Self::IUserDataProtectionManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetDefault)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::System::User>,
    {
        Self::IUserDataProtectionManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetForUser)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                &mut result__,
            )
    ...
    fn IUserDataProtectionManagerStatics<
        R,
        F: FnOnce(&IUserDataProtectionManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for UserDataProtectionManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataProtectionManager>();
}
...
impl windows_core::RuntimeType for UserDataStorageItemProtectionInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserDataStorageItemProtectionInfo>();
}
unsafe impl windows_core::Interface for UserDataStorageItemProtectionInfo {
    ...
    const IID: windows_core::GUID =
        <IUserDataStorageItemProtectionInfo as windows_core::Interface>::IID;
}

windows_core::imp::define_interface!(
    ...
    IPalmRejectionDelayZonePreview_Vtbl,
    0x62b496cb_539d_5343_a65f_41f5300ec70c
);
...
windows_core::imp::define_interface!(
    ...
    IPalmRejectionDelayZonePreviewStatics_Vtbl,
    0xcdef5ee0_93d0_53a9_8f0e_9a379f8f7530
);
...
pub struct IPalmRejectionDelayZonePreviewStatics_Vtbl {
    ...
    #[cfg(feature = "UI_Composition")]
    pub CreateForVisualWithViewportClip: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::super::super::Foundation::Rect,
        *mut core::ffi::c_void,
...
windows_core::imp::required_hierarchy!(
    PalmRejectionDelayZonePreview,
    super::super::super::super::Foundation::IClosable
);
impl PalmRejectionDelayZonePreview {
    ...
    pub fn CreateForVisual<P0>(
        inputpanelvisual: P0,
        inputpanelrect: super::super::super::super::Foundation::Rect,
    ) -> windows_core::Result<PalmRejectionDelayZonePreview>
    where
    ...
    #[cfg(feature = "UI_Composition")]
    pub fn CreateForVisualWithViewportClip<P0, P2>(
        inputpanelvisual: P0,
        inputpanelrect: super::super::super::super::Foundation::Rect,
        viewportvisual: P2,
        viewportrect: super::super::super::super::Foundation::Rect,
    ) -> windows_core::Result<PalmRejectionDelayZonePreview>
    where
        P0: windows_core::Param<super::super::super::Composition::Visual>,
        P2: windows_core::Param<super::super::super::Composition::Visual>,
    {
        Self::IPalmRejectionDelayZonePreviewStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateForVisualWithViewportClip)(
                windows_core::Interface::as_raw(this),
                inputpanelvisual.param().abi(),
                inputpanelrect,
                viewportvisual.param().abi(),
                viewportrect,
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IPalmRejectionDelayZonePreviewStatics<
        R,
        F: FnOnce(&IPalmRejectionDelayZonePreviewStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for PalmRejectionDelayZonePreview {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPalmRejectionDelayZonePreview>();
}
unsafe impl windows_core::Interface for PalmRejectionDelayZonePreview {
    ...
    const IID: windows_core::GUID =
        <IPalmRejectionDelayZonePreview as windows_core::Interface>::IID;
}

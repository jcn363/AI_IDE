windows_core::imp::define_interface!(
    ...
    IWindowManagementPreview_Vtbl,
    0x4ef55b0d_561d_513c_a67c_2c02b69cef41
);
...
windows_core::imp::define_interface!(
    ...
    IWindowManagementPreviewStatics_Vtbl,
    0x0f9725c6_c004_5a23_8fd2_8d092ce2704a
);
...
impl WindowManagementPreview {
    pub fn SetPreferredMinSize<P0>(
        window: P0,
        preferredframeminsize: super::super::super::Foundation::Size,
    ) -> windows_core::Result<()>
    where
        P0: windows_core::Param<super::AppWindow>,
    {
        Self::IWindowManagementPreviewStatics(|this| unsafe {
    ...
    fn IWindowManagementPreviewStatics<
        R,
        F: FnOnce(&IWindowManagementPreviewStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for WindowManagementPreview {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWindowManagementPreview>();
}

...
windows_core::imp::define_interface!(
    ...
    IInputActivationListenerPreviewStatics_Vtbl,
    0xf0551ce5_0de6_5be0_a589_f737201a4582
);
...
pub struct IInputActivationListenerPreviewStatics_Vtbl {
    ...
    pub CreateForApplicationWindow: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
impl InputActivationListenerPreview {
    ...
    pub fn CreateForApplicationWindow<P0>(
        window: P0,
    ) -> windows_core::Result<super::InputActivationListener>
    where
        P0: windows_core::Param<super::super::WindowManagement::AppWindow>,
    {
        Self::IInputActivationListenerPreviewStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).CreateForApplicationWindow)(
    ...
    fn IInputActivationListenerPreviewStatics<
        R,
        F: FnOnce(&IInputActivationListenerPreviewStatics) -> windows_core::Result<R>,
    >(
        callback: F,

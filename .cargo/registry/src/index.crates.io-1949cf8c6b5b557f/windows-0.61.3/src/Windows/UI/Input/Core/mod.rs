windows_core::imp::define_interface!(
    ...
    0x3d577ef6_4cee_11e6_b535_001bdc06ab3b
);
...
windows_core::imp::define_interface!(
    ...
    IRadialControllerIndependentInputSource2_Vtbl,
    0x7073aad8_35f3_4eeb_8751_be4d0a66faf4
);
...
windows_core::imp::define_interface!(
    ...
    0x3d577ef5_4cee_11e6_b535_001bdc06ab3b
);
...
pub struct IRadialControllerIndependentInputSourceStatics_Vtbl {
    ...
    pub CreateForView: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl RadialControllerIndependentInputSource {
    ...
    pub fn DispatcherQueue(
        ...
        let this =
            &windows_core::Interface::cast::<IRadialControllerIndependentInputSource2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel_Core")]
    pub fn CreateForView<P0>(
        view: P0,
    ) -> windows_core::Result<RadialControllerIndependentInputSource>
    where
        P0: windows_core::Param<super::super::super::ApplicationModel::Core::CoreApplicationView>,
    {
        Self::IRadialControllerIndependentInputSourceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateForView)(
                windows_core::Interface::as_raw(this),
                view.param().abi(),
                &mut result__,
            )
    ...
    fn IRadialControllerIndependentInputSourceStatics<
        R,
        F: FnOnce(&IRadialControllerIndependentInputSourceStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for RadialControllerIndependentInputSource {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRadialControllerIndependentInputSource>(
        );
}
unsafe impl windows_core::Interface for RadialControllerIndependentInputSource {
    ...
    const IID: windows_core::GUID =
        <IRadialControllerIndependentInputSource as windows_core::Interface>::IID;
}

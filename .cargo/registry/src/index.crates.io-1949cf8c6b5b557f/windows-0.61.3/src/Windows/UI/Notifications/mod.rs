...
impl AdaptiveNotificationText {
    ...
    ) -> windows_core::Result<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>>
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Hints)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
...
impl windows_core::RuntimeType for AdaptiveNotificationText {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAdaptiveNotificationText>();
}
...
impl BadgeNotification {
        ...
        P0: windows_core::Param<super::super::Data::Xml::Dom::XmlDocument>,
    {
        Self::IBadgeNotificationFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateBadgeNotification)(
                windows_core::Interface::as_raw(this),
                content.param().abi(),
                &mut result__,
            )
    ...
    fn IBadgeNotificationFactory<
        R,
        F: FnOnce(&IBadgeNotificationFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for BadgeNotification {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBadgeNotification>();
}
...
impl BadgeUpdateManager {
    pub fn CreateBadgeUpdaterForApplication() -> windows_core::Result<BadgeUpdater> {
        Self::IBadgeUpdateManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateBadgeUpdaterForApplication)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    ) -> windows_core::Result<BadgeUpdater> {
        Self::IBadgeUpdateManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateBadgeUpdaterForApplicationWithId)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn CreateBadgeUpdaterForSecondaryTile(
        tileid: &windows_core::HSTRING,
    ) -> windows_core::Result<BadgeUpdater> {
        Self::IBadgeUpdateManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateBadgeUpdaterForSecondaryTile)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn GetTemplateContent(
        ...
        Self::IBadgeUpdateManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetTemplateContent)(
                windows_core::Interface::as_raw(this),
                r#type,
                &mut result__,
            )
    ...
    fn IBadgeUpdateManagerStatics<
        R,
        F: FnOnce(&IBadgeUpdateManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IBadgeUpdateManagerStatics2<
        R,
        F: FnOnce(&IBadgeUpdateManagerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for BadgeUpdateManagerForUser {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBadgeUpdateManagerForUser>();
}
...
impl BadgeUpdater {
        ...
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).StartPeriodicUpdate)(
                windows_core::Interface::as_raw(this),
                badgecontent.param().abi(),
                requestedinterval,
            )
            .ok()
        }
    }
    pub fn StartPeriodicUpdateAtTime<P0>(
        &self,
        badgecontent: P0,
        ...
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).StartPeriodicUpdateAtTime)(
                windows_core::Interface::as_raw(this),
                badgecontent.param().abi(),
                starttime,
                requestedinterval,
    ...
    pub fn StopPeriodicUpdate(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).StopPeriodicUpdate)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
...
impl windows_core::RuntimeType for BadgeUpdater {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBadgeUpdater>();
}
...
windows_core::imp::define_interface!(
    ...
    0xeb0dbe66_7448_448d_9db8_d78acd2abba9
);
...
pub struct IAdaptiveNotificationContent_Vtbl {
    ...
    pub Kind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut AdaptiveNotificationContentKind,
    ) -> windows_core::HRESULT,
    pub Hints: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IAdaptiveNotificationText_Vtbl,
    0x46d4a3be_609a_4326_a40b_bfde872034a3
);
...
windows_core::imp::define_interface!(
    IBadgeNotification,
    IBadgeNotification_Vtbl,
    0x075cb4ca_d08a_4e2f_9233_7e289c1f7722
);
...
windows_core::imp::define_interface!(
    IBadgeNotificationFactory,
    IBadgeNotificationFactory_Vtbl,
    0xedf255ce_0618_4d59_948a_5a61040c52f9
);
...
pub struct IBadgeNotificationFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Data_Xml_Dom")]
    pub CreateBadgeNotification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IBadgeUpdateManagerForUser_Vtbl,
    0x996b21bc_0386_44e5_ba8d_0c1077a62e92
);
...
pub struct IBadgeUpdateManagerForUser_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateBadgeUpdaterForApplication: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateBadgeUpdaterForApplicationWithId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
    pub CreateBadgeUpdaterForSecondaryTile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IBadgeUpdateManagerStatics,
    IBadgeUpdateManagerStatics_Vtbl,
    0x33400faa_6dd5_4105_aebc_9b50fca492da
);
...
pub struct IBadgeUpdateManagerStatics_Vtbl {
    ...
    #[cfg(feature = "Data_Xml_Dom")]
    pub GetTemplateContent: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        BadgeTemplateType,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IBadgeUpdateManagerStatics2,
    IBadgeUpdateManagerStatics2_Vtbl,
    0x979a35ce_f940_48bf_94e8_ca244d400b41
);
...
windows_core::imp::define_interface!(
    IBadgeUpdater,
    IBadgeUpdater_Vtbl,
    0xb5fa1fd4_7562_4f6c_bfa3_1b6ed2e57f2f
);
...
pub struct IBadgeUpdater_Vtbl {
    ...
    pub StartPeriodicUpdate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        PeriodicUpdateRecurrence,
    ) -> windows_core::HRESULT,
    pub StartPeriodicUpdateAtTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::Foundation::DateTime,
        PeriodicUpdateRecurrence,
    ) -> windows_core::HRESULT,
    pub StopPeriodicUpdate:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IKnownAdaptiveNotificationHintsStatics,
    IKnownAdaptiveNotificationHintsStatics_Vtbl,
    0x06206598_d496_497d_8692_4f7d7c2770df
);
...
pub struct IKnownAdaptiveNotificationHintsStatics_Vtbl {
    ...
    pub Wrap: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub MinLines: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TextStacking: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IKnownAdaptiveNotificationTextStylesStatics_Vtbl,
    0x202192d7_8996_45aa_8ba1_d461d72c2a1b
);
...
pub struct IKnownAdaptiveNotificationTextStylesStatics_Vtbl {
    ...
    pub Base: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub Subheader: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub TitleNumeral: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SubheaderNumeral: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub HeaderNumeral: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CaptionSubtle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BodySubtle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub BaseSubtle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SubtitleSubtle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TitleSubtle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SubheaderSubtle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SubheaderNumeralSubtle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub HeaderSubtle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub HeaderNumeralSubtle: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IKnownNotificationBindingsStatics_Vtbl,
    0x79427bae_a8b7_4d58_89ea_76a7b7bccded
);
...
pub struct IKnownNotificationBindingsStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ToastGeneric: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    INotification,
    INotification_Vtbl,
    0x108037fe_eb76_4f82_97bc_da07530a2e20
);
...
pub struct INotification_Vtbl {
    ...
    pub SetVisual: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    INotificationBinding_Vtbl,
    0xf29e4b85_0370_4ad3_b4ea_da9e35e7eabf
);
...
pub struct INotificationBinding_Vtbl {
    ...
    pub GetTextElements: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    INotificationData,
    INotificationData_Vtbl,
    0x9ffd2312_9d6a_4aaf_b6ac_ff17f0c1f280
);
...
pub struct INotificationDataFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateNotificationDataWithValuesAndSequenceNumber:
    ...
    pub CreateNotificationDataWithValues: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    INotificationVisual,
    INotificationVisual_Vtbl,
    0x68835b8e_aa56_4e11_86d3_5f9a6957bc5b
);
...
pub struct INotificationVisual_Vtbl {
    ...
    pub Bindings: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetBinding: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IScheduledTileNotification_Vtbl,
    0x0abca6d5_99dc_4c78_a11c_c9e7f86d7ef7
);
...
windows_core::imp::define_interface!(
    ...
    0x3383138a_98c0_4c3b_bbd6_4a633c7cfc29
);
...
pub struct IScheduledTileNotificationFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Data_Xml_Dom")]
    pub CreateScheduledTileNotification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::Foundation::DateTime,
        *mut *mut core::ffi::c_void,
...
pub struct IScheduledToastNotification3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub NotificationMirroring: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut NotificationMirroring,
    ) -> windows_core::HRESULT,
    pub SetNotificationMirroring: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub struct IScheduledToastNotificationFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Data_Xml_Dom")]
    pub CreateScheduledToastNotification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::Foundation::DateTime,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x6173f6b4_412a_5e2c_a6ed_a0209aef9a09
);
...
pub struct IScheduledToastNotificationShowingEventArgs_Vtbl {
    ...
    pub ScheduledToastNotification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IShownTileNotification_Vtbl,
    0x342d8988_5af2_481a_a6a3_f2fdc78de88e
);
...
windows_core::imp::define_interface!(
    ...
    ITileFlyoutNotification_Vtbl,
    0x9a53b261_c70c_42be_b2f3_f42aa97d34e5
);
...
windows_core::imp::define_interface!(
    ...
    ITileFlyoutNotificationFactory_Vtbl,
    0xef556ff5_5226_4f2b_b278_88a35dfe569f
);
...
pub struct ITileFlyoutNotificationFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Data_Xml_Dom")]
    pub CreateTileFlyoutNotification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ITileFlyoutUpdateManagerStatics_Vtbl,
    0x04363b0b_1ac0_4b99_88e7_ada83e953d48
);
...
pub struct ITileFlyoutUpdateManagerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateTileFlyoutUpdaterForApplication: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
    pub CreateTileFlyoutUpdaterForApplicationWithId:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
            *mut core::ffi::c_void,
            *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT,
    pub CreateTileFlyoutUpdaterForSecondaryTile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
...
windows_core::imp::define_interface!(
    ITileNotification,
    ITileNotification_Vtbl,
    0xebaec8fa_50ec_4c18_b4d0_3af02e5540ab
);
...
windows_core::imp::define_interface!(
    ...
    ITileNotificationFactory_Vtbl,
    0xc6abdd6e_4928_46c8_bdbf_81a047dea0d4
);
...
pub struct ITileNotificationFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Data_Xml_Dom")]
    pub CreateTileNotification: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ITileUpdateManagerForUser_Vtbl,
    0x55141348_2ee2_4e2d_9cc1_216a20decc9f
);
...
pub struct ITileUpdateManagerForUser_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateTileUpdaterForApplication: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateTileUpdaterForApplicationWithId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
    pub CreateTileUpdaterForSecondaryTile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ITileUpdateManagerStatics_Vtbl,
    0xda159e5d_3ea9_4986_8d84_b09d5e12276d
);
...
windows_core::imp::define_interface!(
    ...
    ITileUpdateManagerStatics2_Vtbl,
    0x731c1ddc_8e14_4b7c_a34b_9d22de76c84d
);
...
windows_core::imp::define_interface!(
    ITileUpdater,
    ITileUpdater_Vtbl,
    0x0942a48b_1d91_44ec_9243_c1e821c29a20
);
...
pub struct ITileUpdater_Vtbl {
    ...
    pub GetScheduledTileNotifications: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub StartPeriodicUpdate: unsafe extern "system" fn(
    ...
    pub StopPeriodicUpdate:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub StartPeriodicUpdateBatch: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        PeriodicUpdateRecurrence,
    ) -> windows_core::HRESULT,
    pub StartPeriodicUpdateBatchAtTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        super::super::Foundation::DateTime,
        PeriodicUpdateRecurrence,
...
windows_core::imp::define_interface!(
    ITileUpdater2,
    ITileUpdater2_Vtbl,
    0xa2266e12_15ee_43ed_83f5_65b352bb1a84
);
...
pub struct ITileUpdater2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub EnableNotificationQueueForSquare150x150:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub EnableNotificationQueueForWide310x150:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
    pub EnableNotificationQueueForSquare310x310:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
...
windows_core::imp::define_interface!(
    IToastCollection,
    IToastCollection_Vtbl,
    0x0a8bc3b0_e0be_4858_bc2a_89dfe0b32863
);
...
pub struct IToastCollection_Vtbl {
    ...
    pub LaunchArgs: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetLaunchArgs: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
pub struct IToastCollectionManager_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SaveToastCollectionAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FindAllToastCollectionsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetToastCollectionAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RemoveToastCollectionAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RemoveAllToastCollectionsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "System")]
...
windows_core::imp::define_interface!(
    ...
    IToastDismissedEventArgs_Vtbl,
    0x3f89d935_d9cb_4538_a0f0_ffe7659938f8
);
...
pub struct IToastDismissedEventArgs_Vtbl {
    ...
    pub Reason: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ToastDismissalReason,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IToastFailedEventArgs,
    IToastFailedEventArgs_Vtbl,
    0x35176862_cfd4_44f8_ad64_f500fd896c3b
);
...
pub struct IToastNotification6_Vtbl {
    ...
    pub ExpiresOnReboot:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetExpiresOnReboot:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IToastNotificationActionTriggerDetail,
    IToastNotificationActionTriggerDetail_Vtbl,
    0x9445135a_38f3_42f6_96aa_7955b0f03da2
);
...
pub struct IToastNotificationHistoryChangedTriggerDetail_Vtbl {
    ...
    pub ChangeType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ToastHistoryChangedType,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IToastNotificationHistoryChangedTriggerDetail2,
    IToastNotificationHistoryChangedTriggerDetail2_Vtbl,
    0x0b36e982_c871_49fb_babb_25bdbc4cc45b
);
...
pub struct IToastNotificationHistoryChangedTriggerDetail2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CollectionId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IToastNotificationManagerForUser_Vtbl,
    0x79ab57f6_43fe_487b_8a7f_99567200ae94
);
...
windows_core::imp::define_interface!(
    ...
    IToastNotificationManagerForUser2_Vtbl,
    0x679c64b7_81ab_42c2_8819_c958767753f4
);
...
pub struct IToastNotificationManagerForUser2_Vtbl {
    ...
    pub GetHistoryForToastCollectionIdAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
    pub GetToastCollectionManager: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetToastCollectionManagerWithAppId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x3efcb176_6cc1_56dc_973b_251f7aacb1c5
);
...
pub struct IToastNotificationManagerForUser3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub NotificationMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut ToastNotificationMode,
    ) -> windows_core::HRESULT,
    pub NotificationModeChanged: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveNotificationModeChanged:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
...
pub struct IToastNotificationManagerStatics4_Vtbl {
    ...
    #[cfg(not(feature = "System"))]
    GetForUser: usize,
    pub ConfigureNotificationMirroring: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        NotificationMirroring,
    ) -> windows_core::HRESULT,
}
...
pub struct IToastNotifier_Vtbl {
    ...
    pub GetScheduledToastNotifications: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
pub struct IToastNotifier2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub UpdateWithTagAndGroup: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut NotificationUpdateResult,
    ) -> windows_core::HRESULT,
    pub UpdateWithTag: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut NotificationUpdateResult,
...
pub struct IToastNotifier3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ScheduledToastNotificationShowing: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0xadf7e52f_4e53_42d5_9c33_eb5ea515b23e
);
...
windows_core::imp::define_interface!(
    ...
    IUserNotificationChangedEventArgs_Vtbl,
    0xb6bd6839_79cf_4b25_82c0_0ce1eef81f8c
);
...
pub struct IUserNotificationChangedEventArgs_Vtbl {
    ...
    pub ChangeKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut UserNotificationChangedKind,
    ) -> windows_core::HRESULT,
    pub UserNotificationId:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
}
...
impl KnownAdaptiveNotificationHints {
    ...
    pub fn Wrap() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationHintsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Wrap)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn MinLines() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationHintsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MinLines)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn TextStacking() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationHintsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TextStacking)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    fn IKnownAdaptiveNotificationHintsStatics<
        R,
        F: FnOnce(&IKnownAdaptiveNotificationHintsStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl KnownAdaptiveNotificationTextStyles {
    ...
    pub fn Base() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Base)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn Subheader() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Subheader)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn TitleNumeral() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TitleNumeral)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SubheaderNumeral() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SubheaderNumeral)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn HeaderNumeral() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HeaderNumeral)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn CaptionSubtle() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CaptionSubtle)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn BodySubtle() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BodySubtle)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn BaseSubtle() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BaseSubtle)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SubtitleSubtle() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SubtitleSubtle)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn TitleSubtle() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TitleSubtle)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SubheaderSubtle() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SubheaderSubtle)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SubheaderNumeralSubtle() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SubheaderNumeralSubtle)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn HeaderSubtle() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HeaderSubtle)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn HeaderNumeralSubtle() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownAdaptiveNotificationTextStylesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HeaderNumeralSubtle)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    fn IKnownAdaptiveNotificationTextStylesStatics<
        R,
        F: FnOnce(&IKnownAdaptiveNotificationTextStylesStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl KnownNotificationBindings {
    pub fn ToastGeneric() -> windows_core::Result<windows_core::HSTRING> {
        Self::IKnownNotificationBindingsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ToastGeneric)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    fn IKnownNotificationBindingsStatics<
        R,
        F: FnOnce(&IKnownNotificationBindingsStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl Notification {
    ...
    pub fn Visual(&self) -> windows_core::Result<NotificationVisual> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Visual)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<NotificationVisual>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetVisual)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
...
impl windows_core::RuntimeType for Notification {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, INotification>();
}
...
impl NotificationBinding {
    ...
    pub fn GetTextElements(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<AdaptiveNotificationText>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetTextElements)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for NotificationBinding {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, INotificationBinding>();
}
...
impl NotificationData {
    ...
    pub fn CreateNotificationDataWithValuesAndSequenceNumber<P0>(
        initialvalues: P0,
        sequencenumber: u32,
    ) -> windows_core::Result<NotificationData>
    where
        P0: windows_core::Param<
    ...
    pub fn CreateNotificationDataWithValues<P0>(
        initialvalues: P0,
    ) -> windows_core::Result<NotificationData>
    where
        P0: windows_core::Param<
        ...
        >,
    {
        Self::INotificationDataFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateNotificationDataWithValues)(
                windows_core::Interface::as_raw(this),
                initialvalues.param().abi(),
                &mut result__,
            )
    ...
    fn INotificationDataFactory<
        R,
        F: FnOnce(&INotificationDataFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<NotificationData, INotificationDataFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for NotificationData {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, INotificationData>();
}
...
impl NotificationVisual {
    ...
    pub fn Bindings(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<NotificationBinding>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Bindings)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetBinding(
        &self,
        templatename: &windows_core::HSTRING,
    ) -> windows_core::Result<NotificationBinding> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetBinding)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(templatename),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
impl windows_core::RuntimeType for NotificationVisual {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, INotificationVisual>();
}
...
impl ScheduledTileNotification {
    ...
    #[cfg(feature = "Data_Xml_Dom")]
    pub fn CreateScheduledTileNotification<P0>(
        content: P0,
        deliverytime: super::super::Foundation::DateTime,
    ) -> windows_core::Result<ScheduledTileNotification>
    where
        P0: windows_core::Param<super::super::Data::Xml::Dom::XmlDocument>,
    {
        Self::IScheduledTileNotificationFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateScheduledTileNotification)(
                windows_core::Interface::as_raw(this),
                content.param().abi(),
                deliverytime,
                &mut result__,
    ...
    fn IScheduledTileNotificationFactory<
        R,
        F: FnOnce(&IScheduledTileNotificationFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for ScheduledTileNotification {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IScheduledTileNotification>();
}
...
impl ScheduledToastNotification {
    ...
    pub fn NotificationMirroring(&self) -> windows_core::Result<NotificationMirroring> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NotificationMirroring)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetNotificationMirroring(
        ...
        let this = &windows_core::Interface::cast::<IScheduledToastNotification3>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).SetNotificationMirroring)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
        ...
        P0: windows_core::Param<super::super::Data::Xml::Dom::XmlDocument>,
    {
        Self::IScheduledToastNotificationFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateScheduledToastNotificationRecurring)(
                windows_core::Interface::as_raw(this),
                content.param().abi(),
                deliverytime,
                snoozeinterval,
...
impl ScheduledToastNotificationShowingEventArgs {
    ...
    pub fn ScheduledToastNotification(&self) -> windows_core::Result<ScheduledToastNotification> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ScheduledToastNotification)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
unsafe impl windows_core::Interface for ScheduledToastNotificationShowingEventArgs {
    ...
    const IID: windows_core::GUID =
        <IScheduledToastNotificationShowingEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for ShownTileNotification {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IShownTileNotification>();
}
...
impl TileFlyoutNotification {
    ...
    #[cfg(feature = "Data_Xml_Dom")]
    pub fn CreateTileFlyoutNotification<P0>(
        content: P0,
    ) -> windows_core::Result<TileFlyoutNotification>
    where
        P0: windows_core::Param<super::super::Data::Xml::Dom::XmlDocument>,
    {
        Self::ITileFlyoutNotificationFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateTileFlyoutNotification)(
                windows_core::Interface::as_raw(this),
                content.param().abi(),
                &mut result__,
            )
    ...
    fn ITileFlyoutNotificationFactory<
        R,
        F: FnOnce(&ITileFlyoutNotificationFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for TileFlyoutNotification {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITileFlyoutNotification>();
}
...
impl TileFlyoutUpdateManager {
    pub fn CreateTileFlyoutUpdaterForApplication() -> windows_core::Result<TileFlyoutUpdater> {
        Self::ITileFlyoutUpdateManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateTileFlyoutUpdaterForApplication)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateTileFlyoutUpdaterForApplicationWithId(
        applicationid: &windows_core::HSTRING,
    ) -> windows_core::Result<TileFlyoutUpdater> {
        Self::ITileFlyoutUpdateManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateTileFlyoutUpdaterForApplicationWithId)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(applicationid),
                &mut result__,
            )
    ...
    pub fn CreateTileFlyoutUpdaterForSecondaryTile(
        ...
        Self::ITileFlyoutUpdateManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateTileFlyoutUpdaterForSecondaryTile)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(tileid),
                &mut result__,
            )
    ...
    fn ITileFlyoutUpdateManagerStatics<
        R,
        F: FnOnce(&ITileFlyoutUpdateManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for TileFlyoutUpdater {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITileFlyoutUpdater>();
}
...
impl TileNotification {
        ...
        P0: windows_core::Param<super::super::Data::Xml::Dom::XmlDocument>,
    {
        Self::ITileNotificationFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateTileNotification)(
                windows_core::Interface::as_raw(this),
                content.param().abi(),
                &mut result__,
            )
    ...
    fn ITileNotificationFactory<
        R,
        F: FnOnce(&ITileNotificationFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TileNotification, ITileNotificationFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for TileNotification {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITileNotification>();
}
...
impl TileUpdateManager {
    pub fn CreateTileUpdaterForApplication() -> windows_core::Result<TileUpdater> {
        Self::ITileUpdateManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateTileUpdaterForApplication)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateTileUpdaterForApplicationWithId(
        applicationid: &windows_core::HSTRING,
    ) -> windows_core::Result<TileUpdater> {
        Self::ITileUpdateManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateTileUpdaterForApplicationWithId)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(applicationid),
                &mut result__,
            )
    ...
    pub fn CreateTileUpdaterForSecondaryTile(
        ...
        Self::ITileUpdateManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateTileUpdaterForSecondaryTile)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(tileid),
                &mut result__,
            )
    ...
    fn ITileUpdateManagerStatics<
        R,
        F: FnOnce(&ITileUpdateManagerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn ITileUpdateManagerStatics2<
        R,
        F: FnOnce(&ITileUpdateManagerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for TileUpdateManagerForUser {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITileUpdateManagerForUser>();
}
...
impl TileUpdater {
    ...
    pub fn EnableNotificationQueue(&self, enable: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).EnableNotificationQueue)(
                windows_core::Interface::as_raw(this),
                enable,
            )
            .ok()
    ...
    pub fn GetScheduledTileNotifications(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<ScheduledTileNotification>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetScheduledTileNotifications)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn StartPeriodicUpdateBatch<P0>(
        &self,
        tilecontents: P0,
        requestedinterval: PeriodicUpdateRecurrence,
    ) -> windows_core::Result<()>
        ...
        P0: windows_core::Param<windows_collections::IIterable<super::super::Foundation::Uri>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).StartPeriodicUpdateBatch)(
                windows_core::Interface::as_raw(this),
                tilecontents.param().abi(),
                requestedinterval,
            )
            .ok()
        }
    }
    pub fn StartPeriodicUpdateBatchAtTime<P0>(
        &self,
        tilecontents: P0,
        starttime: super::super::Foundation::DateTime,
        requestedinterval: PeriodicUpdateRecurrence,
        ...
        P0: windows_core::Param<windows_collections::IIterable<super::super::Foundation::Uri>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).StartPeriodicUpdateBatchAtTime)(
                windows_core::Interface::as_raw(this),
                tilecontents.param().abi(),
                starttime,
                requestedinterval,
    ...
    pub fn EnableNotificationQueueForSquare150x150(
        ...
        unsafe {
            (windows_core::Interface::vtable(this).EnableNotificationQueueForSquare150x150)(
                windows_core::Interface::as_raw(this),
                enable,
            )
            .ok()
    ...
    pub fn EnableNotificationQueueForWide310x150(&self, enable: bool) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<ITileUpdater2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).EnableNotificationQueueForWide310x150)(
                windows_core::Interface::as_raw(this),
                enable,
            )
            .ok()
    ...
    pub fn EnableNotificationQueueForSquare310x310(
        ...
        let this = &windows_core::Interface::cast::<ITileUpdater2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).EnableNotificationQueueForSquare310x310)(
                windows_core::Interface::as_raw(this),
                enable,
            )
            .ok()
...
impl windows_core::RuntimeType for TileUpdater {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ITileUpdater>();
}
...
impl ToastCollection {
    ...
    pub fn LaunchArgs(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LaunchArgs)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetLaunchArgs(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetLaunchArgs)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn CreateInstance<P3>(
        collectionid: &windows_core::HSTRING,
        displayname: &windows_core::HSTRING,
        launchargs: &windows_core::HSTRING,
        iconuri: P3,
    ) -> windows_core::Result<ToastCollection>
    where
        P3: windows_core::Param<super::super::Foundation::Uri>,
    {
        Self::IToastCollectionFactory(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).CreateInstance)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(collectionid),
                core::mem::transmute_copy(displayname),
                core::mem::transmute_copy(launchargs),
                iconuri.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IToastCollectionFactory<
        R,
        F: FnOnce(&IToastCollectionFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ToastCollection, IToastCollectionFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for ToastCollection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IToastCollection>();
}
...
impl ToastCollectionManager {
    pub fn SaveToastCollectionAsync<P0>(
        &self,
        collection: P0,
        ...
        P0: windows_core::Param<ToastCollection>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SaveToastCollectionAsync)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn FindAllToastCollectionsAsync(
        ...
        windows_future::IAsyncOperation<windows_collections::IVectorView<ToastCollection>>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindAllToastCollectionsAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetToastCollectionAsync(
        &self,
        collectionid: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<ToastCollection>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetToastCollectionAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(collectionid),
                &mut result__,
            )
    ...
    pub fn RemoveToastCollectionAsync(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoveToastCollectionAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(collectionid),
                &mut result__,
            )
    ...
    pub fn RemoveAllToastCollectionsAsync(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoveAllToastCollectionsAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for ToastCollectionManager {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IToastCollectionManager>();
}
...
impl windows_core::RuntimeType for ToastDismissedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IToastDismissedEventArgs>();
}
...
impl windows_core::RuntimeType for ToastFailedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IToastFailedEventArgs>();
}
...
impl windows_core::RuntimeType for ToastNotificationActionTriggerDetail {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IToastNotificationActionTriggerDetail>();
}
unsafe impl windows_core::Interface for ToastNotificationActionTriggerDetail {
    ...
    const IID: windows_core::GUID =
        <IToastNotificationActionTriggerDetail as windows_core::Interface>::IID;
}
...
impl ToastNotificationHistoryChangedTriggerDetail {
    ...
    pub fn CollectionId(&self) -> windows_core::Result<windows_core::HSTRING> {
        let this =
            &windows_core::Interface::cast::<IToastNotificationHistoryChangedTriggerDetail2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CollectionId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
unsafe impl windows_core::Interface for ToastNotificationHistoryChangedTriggerDetail {
    type Vtable =
        <IToastNotificationHistoryChangedTriggerDetail as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IToastNotificationHistoryChangedTriggerDetail as windows_core::Interface>::IID;
}
...
impl ToastNotificationManager {
    ...
    pub fn ConfigureNotificationMirroring(
        ...
        Self::IToastNotificationManagerStatics4(|this| unsafe {
            (windows_core::Interface::vtable(this).ConfigureNotificationMirroring)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl ToastNotificationManagerForUser {
    ...
    pub fn GetToastNotifierForToastCollectionIdAsync(
        &self,
        collectionid: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<ToastNotifier>> {
        let this = &windows_core::Interface::cast::<IToastNotificationManagerForUser2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetToastNotifierForToastCollectionIdAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(collectionid),
                &mut result__,
            )
    ...
    pub fn GetHistoryForToastCollectionIdAsync(
        &self,
        collectionid: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<ToastNotificationHistory>> {
        let this = &windows_core::Interface::cast::<IToastNotificationManagerForUser2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetHistoryForToastCollectionIdAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(collectionid),
                &mut result__,
            )
    ...
    pub fn GetToastCollectionManager(&self) -> windows_core::Result<ToastCollectionManager> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetToastCollectionManager)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetToastCollectionManagerWithAppId(
        &self,
        appid: &windows_core::HSTRING,
    ) -> windows_core::Result<ToastCollectionManager> {
        let this = &windows_core::Interface::cast::<IToastNotificationManagerForUser2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetToastCollectionManagerWithAppId)(
                windows_core::Interface::as_raw(this),
    ...
    pub fn NotificationMode(&self) -> windows_core::Result<ToastNotificationMode> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NotificationMode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NotificationModeChanged)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveNotificationModeChanged(&self, token: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IToastNotificationManagerForUser3>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveNotificationModeChanged)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for ToastNotificationManagerForUser {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IToastNotificationManagerForUser>();
}
unsafe impl windows_core::Interface for ToastNotificationManagerForUser {
    ...
    const IID: windows_core::GUID =
        <IToastNotificationManagerForUser as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for ToastNotificationMode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.UI.Notifications.ToastNotificationMode;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl ToastNotifier {
    ...
    pub fn GetScheduledToastNotifications(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<ScheduledToastNotification>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UpdateWithTagAndGroup<P0>(
        &self,
        data: P0,
        tag: &windows_core::HSTRING,
        group: &windows_core::HSTRING,
        ...
        P0: windows_core::Param<NotificationData>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UpdateWithTagAndGroup)(
                windows_core::Interface::as_raw(this),
                data.param().abi(),
                core::mem::transmute_copy(tag),
                core::mem::transmute_copy(group),
        ...
        P0: windows_core::Param<NotificationData>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UpdateWithTag)(
                windows_core::Interface::as_raw(this),
                data.param().abi(),
                core::mem::transmute_copy(tag),
                &mut result__,
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ScheduledToastNotificationShowing)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveScheduledToastNotificationShowing(&self, token: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IToastNotifier3>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveScheduledToastNotificationShowing)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl UserNotification {
    pub fn Notification(&self) -> windows_core::Result<Notification> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Notification)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreationTime(&self) -> windows_core::Result<super::super::Foundation::DateTime> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreationTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for UserNotification {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserNotification>();
}
...
impl UserNotificationChangedEventArgs {
    ...
    pub fn UserNotificationId(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UserNotificationId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for UserNotificationChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUserNotificationChangedEventArgs>();
}
unsafe impl windows_core::Interface for UserNotificationChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IUserNotificationChangedEventArgs as windows_core::Interface>::IID;
}

...
impl CoreAppWindowPreview {
        ...
        P0: windows_core::Param<super::super::WindowManagement::AppWindow>,
    {
        Self::ICoreAppWindowPreviewStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).GetIdFromWindow)(
    ...
    fn ICoreAppWindowPreviewStatics<
        R,
        F: FnOnce(&ICoreAppWindowPreviewStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for CoreAppWindowPreview {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICoreAppWindowPreview>();
}
...
windows_core::imp::define_interface!(
    ...
    ICoreAppWindowPreview_Vtbl,
    0xa4f6e665_365e_5fde_87a5_9543c3a15aa8
);
...
windows_core::imp::define_interface!(
    ICoreAppWindowPreviewStatics,
    ICoreAppWindowPreviewStatics_Vtbl,
    0x33ac21be_423b_5db6_8a8e_4dc87353b75b
);
...
pub struct ICoreAppWindowPreviewStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "UI_WindowManagement")]
    pub GetIdFromWindow: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i32,
...
windows_core::imp::define_interface!(
    ...
    ISystemNavigationCloseRequestedPreviewEventArgs_Vtbl,
    0x83d00de1_cbe5_4f31_8414_361da046518f
);
...
windows_core::imp::define_interface!(
    ...
    ISystemNavigationManagerPreview_Vtbl,
    0xec5f0488_6425_4777_a536_cb5634427f0d
);
...
windows_core::imp::define_interface!(
    ...
    ISystemNavigationManagerPreviewStatics_Vtbl,
    0x0e971360_df74_4bce_84cb_bd1181ac0a71
);
...
unsafe impl windows_core::Interface for SystemNavigationCloseRequestedPreviewEventArgs {
    type Vtable =
        <ISystemNavigationCloseRequestedPreviewEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <ISystemNavigationCloseRequestedPreviewEventArgs as windows_core::Interface>::IID;
}
...
impl SystemNavigationManagerPreview {
    ...
    fn ISystemNavigationManagerPreviewStatics<
        R,
        F: FnOnce(&ISystemNavigationManagerPreviewStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for SystemNavigationManagerPreview {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISystemNavigationManagerPreview>();
}
unsafe impl windows_core::Interface for SystemNavigationManagerPreview {
    ...
    const IID: windows_core::GUID =
        <ISystemNavigationManagerPreview as windows_core::Interface>::IID;
}

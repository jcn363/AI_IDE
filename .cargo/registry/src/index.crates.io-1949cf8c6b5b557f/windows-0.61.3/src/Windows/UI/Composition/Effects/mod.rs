windows_core::imp::define_interface!(
    ...
    0x91bb5e52_95d1_4f8b_9a5a_6408b24b8c6a
);
...
windows_core::imp::define_interface!(
    ...
    0x9e270e81_72f0_4c5c_95f8_8a6e0024f409
);
...
windows_core::imp::required_hierarchy!(
    SceneLightingEffect,
    super::super::super::Graphics::Effects::IGraphicsEffect,
    super::super::super::Graphics::Effects::IGraphicsEffectSource
);
#[cfg(feature = "Graphics_Effects")]
impl SceneLightingEffect {
    ...
    pub fn NormalMapSource(
        &self,
    ) -> windows_core::Result<super::super::super::Graphics::Effects::IGraphicsEffectSource> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for SceneLightingEffectReflectanceModel {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.UI.Composition.Effects.SceneLightingEffectReflectanceModel;i4)",
    );
}

windows_core::imp::define_interface!(
    ...
    IInjectedInputGamepadInfo_Vtbl,
    0x20ae9a3f_df11_4572_a9ab_d75b8a5e48ad
);
...
pub struct IInjectedInputGamepadInfo_Vtbl {
    ...
    pub Buttons: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::super::Gaming::Input::GamepadButtons,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Gaming_Input"))]
    Buttons: usize,
    #[cfg(feature = "Gaming_Input")]
    pub SetButtons: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::super::Gaming::Input::GamepadButtons,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Gaming_Input"))]
    SetButtons: usize,
    pub LeftThumbstickX:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub SetLeftThumbstickX:
        unsafe extern "system" fn(*mut core::ffi::c_void, f64) -> windows_core::HRESULT,
    pub LeftThumbstickY:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub SetLeftThumbstickY:
        unsafe extern "system" fn(*mut core::ffi::c_void, f64) -> windows_core::HRESULT,
    pub LeftTrigger:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub SetLeftTrigger:
        unsafe extern "system" fn(*mut core::ffi::c_void, f64) -> windows_core::HRESULT,
    pub RightThumbstickX:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub SetRightThumbstickX:
        unsafe extern "system" fn(*mut core::ffi::c_void, f64) -> windows_core::HRESULT,
    pub RightThumbstickY:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub SetRightThumbstickY:
        unsafe extern "system" fn(*mut core::ffi::c_void, f64) -> windows_core::HRESULT,
    pub RightTrigger:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f64) -> windows_core::HRESULT,
    pub SetRightTrigger:
...
windows_core::imp::define_interface!(
    ...
    IInjectedInputGamepadInfoFactory_Vtbl,
    0x59596876_6c39_4ec4_8b2a_29ef7de18aca
);
...
pub struct IInjectedInputGamepadInfoFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Gaming_Input")]
    pub CreateInstanceFromGamepadReading: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::super::super::Gaming::Input::GamepadReading,
...
pub struct IInjectedInputKeyboardInfo_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub KeyOptions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut InjectedInputKeyOptions,
    ) -> windows_core::HRESULT,
...
pub struct IInjectedInputPenInfo_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub PointerInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut InjectedInputPointerInfo,
    ) -> windows_core::HRESULT,
    pub SetPointerInfo: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        InjectedInputPointerInfo,
    ) -> windows_core::HRESULT,
    pub PenButtons: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut InjectedInputPenButtons,
    ) -> windows_core::HRESULT,
    pub SetPenButtons: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        InjectedInputPenButtons,
    ) -> windows_core::HRESULT,
    pub PenParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut InjectedInputPenParameters,
    ) -> windows_core::HRESULT,
...
pub struct IInjectedInputTouchInfo_Vtbl {
    ...
    pub SetPressure:
        unsafe extern "system" fn(*mut core::ffi::c_void, f64) -> windows_core::HRESULT,
    pub TouchParameters: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut InjectedInputTouchParameters,
    ) -> windows_core::HRESULT,
...
pub struct IInputInjector_Vtbl {
    ...
    pub UninitializePenInjection:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub InjectShortcut: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IInputInjector2,
    IInputInjector2_Vtbl,
    0x8e7a905d_1453_43a7_9bcb_06d6d7b305f7
);
...
pub struct IInputInjector2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub InitializeGamepadInjection:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub InjectGamepadInput: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub UninitializeGamepadInjection:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
...
windows_core::imp::define_interface!(
    ...
    0xa4db38fb_dd8c_414f_95ea_f87ef4c0ae6c
);
...
pub struct IInputInjectorStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub TryCreateForAppBroadcastOnly: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl windows_core::RuntimeType for InjectedInputButtonChangeKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.UI.Input.Preview.Injection.InjectedInputButtonChangeKind;i4)",
    );
}
#[repr(transparent)]
...
impl InjectedInputGamepadInfo {
    ...
    pub fn Buttons(
        &self,
    ) -> windows_core::Result<super::super::super::super::Gaming::Input::GamepadButtons> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Buttons)(
    ...
    pub fn SetButtons(
        &self,
        value: super::super::super::super::Gaming::Input::GamepadButtons,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetButtons)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn LeftThumbstickX(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LeftThumbstickX)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetLeftThumbstickX(&self, value: f64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetLeftThumbstickX)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn LeftThumbstickY(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LeftThumbstickY)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetLeftThumbstickY(&self, value: f64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetLeftThumbstickY)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn LeftTrigger(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LeftTrigger)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetLeftTrigger(&self, value: f64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetLeftTrigger)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn RightThumbstickX(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RightThumbstickX)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetRightThumbstickX(&self, value: f64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetRightThumbstickX)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn RightThumbstickY(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RightThumbstickY)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetRightThumbstickY(&self, value: f64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetRightThumbstickY)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn RightTrigger(&self) -> windows_core::Result<f64> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RightTrigger)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetRightTrigger(&self, value: f64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetRightTrigger)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    #[cfg(feature = "Gaming_Input")]
    pub fn CreateInstanceFromGamepadReading(
        reading: super::super::super::super::Gaming::Input::GamepadReading,
    ) -> windows_core::Result<InjectedInputGamepadInfo> {
        Self::IInjectedInputGamepadInfoFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateInstanceFromGamepadReading)(
                windows_core::Interface::as_raw(this),
                reading,
                &mut result__,
            )
    ...
    fn IInjectedInputGamepadInfoFactory<
        R,
        F: FnOnce(&IInjectedInputGamepadInfoFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for InjectedInputGamepadInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInjectedInputGamepadInfo>();
}
...
impl InjectedInputKeyboardInfo {
    ...
    pub fn KeyOptions(&self) -> windows_core::Result<InjectedInputKeyOptions> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).KeyOptions)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetKeyOptions(&self, value: InjectedInputKeyOptions) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetKeyOptions)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn ScanCode(&self) -> windows_core::Result<u16> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ScanCode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetScanCode(&self, value: u16) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetScanCode)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SetVirtualKey(&self, value: u16) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetVirtualKey)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl InjectedInputMouseInfo {
    ...
    pub fn MouseOptions(&self) -> windows_core::Result<InjectedInputMouseOptions> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MouseOptions)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetMouseOptions(&self, value: InjectedInputMouseOptions) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetMouseOptions)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn MouseData(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MouseData)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetMouseData(&self, value: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetMouseData)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn DeltaY(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeltaY)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetDeltaY(&self, value: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDeltaY)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn DeltaX(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeltaX)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetDeltaX(&self, value: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDeltaX)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn TimeOffsetInMilliseconds(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TimeOffsetInMilliseconds)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetTimeOffsetInMilliseconds(&self, value: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetTimeOffsetInMilliseconds)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl InjectedInputPenInfo {
    ...
    pub fn PointerInfo(&self) -> windows_core::Result<InjectedInputPointerInfo> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PointerInfo)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetPointerInfo(&self, value: InjectedInputPointerInfo) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPointerInfo)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn PenButtons(&self) -> windows_core::Result<InjectedInputPenButtons> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PenButtons)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetPenButtons(&self, value: InjectedInputPenButtons) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPenButtons)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn PenParameters(&self) -> windows_core::Result<InjectedInputPenParameters> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PenParameters)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetPenParameters(&self, value: InjectedInputPenParameters) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPenParameters)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SetPressure(&self, value: f64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPressure)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SetTiltX(&self, value: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetTiltX)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SetTiltY(&self, value: i32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetTiltY)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for InjectedInputShortcut {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.UI.Input.Preview.Injection.InjectedInputShortcut;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl InjectedInputTouchInfo {
    ...
    pub fn TouchParameters(&self) -> windows_core::Result<InjectedInputTouchParameters> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TouchParameters)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetTouchParameters(
        &self,
        value: InjectedInputTouchParameters,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetTouchParameters)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl InputInjector {
        ...
        P0: windows_core::Param<windows_collections::IIterable<InjectedInputKeyboardInfo>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).InjectKeyboardInput)(
                windows_core::Interface::as_raw(this),
                input.param().abi(),
            )
            .ok()
        ...
        P0: windows_core::Param<windows_collections::IIterable<InjectedInputMouseInfo>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).InjectMouseInput)(
                windows_core::Interface::as_raw(this),
                input.param().abi(),
            )
            .ok()
    ...
    pub fn InitializeTouchInjection(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).InitializeTouchInjection)(
                windows_core::Interface::as_raw(this),
                visualmode,
            )
            .ok()
        ...
        P0: windows_core::Param<windows_collections::IIterable<InjectedInputTouchInfo>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).InjectTouchInput)(
                windows_core::Interface::as_raw(this),
                input.param().abi(),
            )
            .ok()
    ...
    pub fn UninitializeTouchInjection(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).UninitializeTouchInjection)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    }
    pub fn InitializePenInjection(
        &self,
        visualmode: InjectedInputVisualizationMode,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).InitializePenInjection)(
                windows_core::Interface::as_raw(this),
                visualmode,
            )
            .ok()
        ...
        P0: windows_core::Param<InjectedInputPenInfo>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).InjectPenInput)(
                windows_core::Interface::as_raw(this),
                input.param().abi(),
            )
            .ok()
    ...
    pub fn UninitializePenInjection(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).UninitializePenInjection)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    pub fn InjectShortcut(&self, shortcut: InjectedInputShortcut) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).InjectShortcut)(
                windows_core::Interface::as_raw(this),
                shortcut,
            )
            .ok()
    ...
    pub fn InitializeGamepadInjection(&self) -> windows_core::Result<()> {
        ...
        unsafe {
            (windows_core::Interface::vtable(this).InitializeGamepadInjection)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
        ...
        P0: windows_core::Param<InjectedInputGamepadInfo>,
    {
        let this = &windows_core::Interface::cast::<IInputInjector2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).InjectGamepadInput)(
                windows_core::Interface::as_raw(this),
                input.param().abi(),
            )
            .ok()
    ...
    pub fn UninitializeGamepadInjection(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IInputInjector2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).UninitializeGamepadInjection)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    fn IInputInjectorStatics2<R, F: FnOnce(&IInputInjectorStatics2) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<InputInjector, IInputInjectorStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}

windows_core::imp::define_interface!(
    ...
    IInkAnalysisInkBullet_Vtbl,
    0xee049368_6110_4136_95f9_ee809fc20030
);
...
pub struct IInkAnalysisInkBullet_Vtbl {
    ...
    pub RecognizedText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    0x6a85ed1f_1fe4_4e15_898c_8e112377e021
);
...
pub struct IInkAnalysisInkDrawing_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub DrawingKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut InkAnalysisDrawingKind,
    ) -> windows_core::HRESULT,
    pub Center: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::super::Foundation::Point,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IInkAnalysisInkWord,
    IInkAnalysisInkWord_Vtbl,
    0x4bd228ad_83af_4034_8f3b_f8687dfff436
);
...
pub struct IInkAnalysisInkWord_Vtbl {
    ...
    pub TextAlternates: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IInkAnalysisLine,
    IInkAnalysisLine_Vtbl,
    0xa06d048d_2b8d_4754_ad5a_d0871193a956
);
...
windows_core::imp::define_interface!(
    ...
    IInkAnalysisListItem_Vtbl,
    0xb4e3c23f_c4c3_4c3a_a1a6_9d85547ee586
);
...
windows_core::imp::define_interface!(
    ...
    0x30831f05_5f64_4a2c_ba37_4f4887879574
);
...
impl IInkAnalysisNode {
    ...
    pub fn RotatedBoundingRect(
        ...
        windows_collections::IVectorView<super::super::super::super::Foundation::Point>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RotatedBoundingRect)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn Children(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<IInkAnalysisNode>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetStrokeIds(&self) -> windows_core::Result<windows_collections::IVectorView<u32>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetStrokeIds)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl IInkAnalysisNode_Vtbl {
    pub const fn new<Identity: IInkAnalysisNode_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Id<Identity: IInkAnalysisNode_Impl, const OFFSET: isize>(
        ...
        unsafe extern "system" fn Kind<Identity: IInkAnalysisNode_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut InkAnalysisNodeKind,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Children<Identity: IInkAnalysisNode_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Parent<Identity: IInkAnalysisNode_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetStrokeIds<
            Identity: IInkAnalysisNode_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub struct IInkAnalysisNode_Vtbl {
    ...
    pub GetStrokeIds: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IInkAnalysisParagraph_Vtbl,
    0xd9ad045c_0cd1_4dd4_a68b_eb1f12b3d727
);
...
windows_core::imp::define_interface!(
    IInkAnalysisResult,
    IInkAnalysisResult_Vtbl,
    0x8948ba79_a243_4aa3_a294_1f98bd0ff580
);
...
pub struct IInkAnalysisResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut InkAnalysisStatus,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IInkAnalysisRoot,
    IInkAnalysisRoot_Vtbl,
    0x3fb6a3c4_2fde_4061_8502_a90f32545b84
);
...
pub struct IInkAnalysisRoot_Vtbl {
    ...
    pub FindNodes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        InkAnalysisNodeKind,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IInkAnalysisWritingRegion_Vtbl,
    0xdd6d6231_bd16_4663_b5ae_941d3043ef5b
);
...
windows_core::imp::define_interface!(
    IInkAnalyzer,
    IInkAnalyzer_Vtbl,
    0xf12b8f95_0866_4dc5_8c77_f88614dfe38c
);
...
pub struct IInkAnalyzer_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AnalysisRoot: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub IsAnalyzing:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub AddDataForStroke: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AddDataForStrokes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ClearDataForAllStrokes:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub RemoveDataForStroke:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32) -> windows_core::HRESULT,
    pub RemoveDataForStrokes: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ReplaceDataForStroke: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetStrokeDataKind: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        InkAnalysisStrokeKind,
    ) -> windows_core::HRESULT,
    pub AnalyzeAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0x29138686_1963_49d8_9589_e14384c769e3
);
...
impl IInkAnalyzerFactory {
    pub fn CreateAnalyzer(&self) -> windows_core::Result<InkAnalyzer> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateAnalyzer)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl IInkAnalyzerFactory_Vtbl {
    pub const fn new<Identity: IInkAnalyzerFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateAnalyzer<
        ...
        Self {
            ...
            CreateAnalyzer: CreateAnalyzer::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
pub struct IInkAnalyzerFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CreateAnalyzer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl windows_core::RuntimeType for InkAnalysisDrawingKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.UI.Input.Inking.Analysis.InkAnalysisDrawingKind;i4)",
    );
}
#[repr(transparent)]
...
impl InkAnalysisInkBullet {
    pub fn RecognizedText(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RecognizedText)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
...
impl windows_core::RuntimeType for InkAnalysisInkBullet {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInkAnalysisInkBullet>();
}
...
impl InkAnalysisInkDrawing {
    pub fn DrawingKind(&self) -> windows_core::Result<InkAnalysisDrawingKind> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DrawingKind)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for InkAnalysisInkDrawing {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInkAnalysisInkDrawing>();
}
...
impl windows_core::RuntimeType for InkAnalysisInkWord {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInkAnalysisInkWord>();
}
...
impl InkAnalysisLine {
    ...
    pub fn IndentLevel(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IndentLevel)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for InkAnalysisLine {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInkAnalysisLine>();
}
...
impl windows_core::RuntimeType for InkAnalysisListItem {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInkAnalysisListItem>();
}
...
impl windows_core::RuntimeType for InkAnalysisNode {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInkAnalysisNode>();
}
...
impl windows_core::RuntimeType for InkAnalysisNodeKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.UI.Input.Inking.Analysis.InkAnalysisNodeKind;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for InkAnalysisParagraph {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInkAnalysisParagraph>();
}
...
impl windows_core::RuntimeType for InkAnalysisResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInkAnalysisResult>();
}
...
impl InkAnalysisRoot {
    ...
    pub fn FindNodes(
        &self,
        nodekind: InkAnalysisNodeKind,
    ) -> windows_core::Result<windows_collections::IVectorView<IInkAnalysisNode>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FindNodes)(
                windows_core::Interface::as_raw(this),
                nodekind,
                &mut result__,
            )
...
impl windows_core::RuntimeType for InkAnalysisRoot {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInkAnalysisRoot>();
}
...
impl windows_core::RuntimeType for InkAnalysisStatus {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.UI.Input.Inking.Analysis.InkAnalysisStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl windows_core::RuntimeType for InkAnalysisStrokeKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.UI.Input.Inking.Analysis.InkAnalysisStrokeKind;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl windows_core::RuntimeType for InkAnalysisWritingRegion {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInkAnalysisWritingRegion>();
}
...
impl InkAnalyzer {
    ...
    pub fn AnalysisRoot(&self) -> windows_core::Result<InkAnalysisRoot> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AnalysisRoot)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn IsAnalyzing(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsAnalyzing)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
        ...
        P0: windows_core::Param<super::InkStroke>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AddDataForStroke)(
                windows_core::Interface::as_raw(this),
                stroke.param().abi(),
            )
            .ok()
        ...
        P0: windows_core::Param<windows_collections::IIterable<super::InkStroke>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AddDataForStrokes)(
                windows_core::Interface::as_raw(this),
                strokes.param().abi(),
            )
            .ok()
    ...
    pub fn ClearDataForAllStrokes(&self) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ClearDataForAllStrokes)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    pub fn RemoveDataForStroke(&self, strokeid: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDataForStroke)(
                windows_core::Interface::as_raw(this),
                strokeid,
            )
            .ok()
        ...
        P0: windows_core::Param<windows_collections::IIterable<u32>>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveDataForStrokes)(
                windows_core::Interface::as_raw(this),
                strokeids.param().abi(),
            )
            .ok()
        ...
        P0: windows_core::Param<super::InkStroke>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ReplaceDataForStroke)(
                windows_core::Interface::as_raw(this),
                stroke.param().abi(),
            )
            .ok()
    ...
    pub fn SetStrokeDataKind(
        &self,
        strokeid: u32,
        strokekind: InkAnalysisStrokeKind,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetStrokeDataKind)(
                windows_core::Interface::as_raw(this),
                strokeid,
                strokekind,
            )
    ...
    pub fn AnalyzeAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<InkAnalysisResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AnalyzeAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for InkAnalyzer {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IInkAnalyzer>();
}

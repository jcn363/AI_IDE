windows_core::imp::define_interface!(
    IMessageDialog,
    IMessageDialog_Vtbl,
    0x33f59b01_5325_43ab_9ab3_bdae440e4121
);
...
windows_core::imp::define_interface!(
    ...
    IMessageDialogFactory_Vtbl,
    0x2d161777_a66f_4ea5_bb87_793ffa4941f2
);
...
windows_core::imp::define_interface!(
    IPopupMenu,
    IPopupMenu_Vtbl,
    0x4e9bc6dc_880d_47fc_a0a1_72b639e62559
);
...
pub struct IPopupMenu_Vtbl {
    ...
    pub ShowAsyncWithRect: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::Rect,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ShowAsyncWithRectAndPlacement: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::super::Foundation::Rect,
        Placement,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IUICommand,
    IUICommand_Vtbl,
    0x4ff93a75_4145_47ff_ac7f_dff1c1fa5b0f
);
...
pub trait IUICommand_Impl: windows_core::IUnknownImpl {
    ...
    fn SetInvoked(
        &self,
        value: windows_core::Ref<'_, UICommandInvokedHandler>,
    ) -> windows_core::Result<()>;
...
impl IUICommand_Vtbl {
    pub const fn new<Identity: IUICommand_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Label<Identity: IUICommand_Impl, const OFFSET: isize>(
        ...
        unsafe extern "system" fn SetLabel<Identity: IUICommand_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Invoked<Identity: IUICommand_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetInvoked<Identity: IUICommand_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Id<Identity: IUICommand_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetId<Identity: IUICommand_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
...
pub struct IUICommand_Vtbl {
    ...
    pub SetInvoked: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IUICommandFactory,
    IUICommandFactory_Vtbl,
    0xa21a8189_26b0_4676_ae94_54041bc125e8
);
...
pub struct IUICommandFactory_Vtbl {
    ...
    pub CreateWithHandler: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CreateWithHandlerAndId: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
impl MessageDialog {
    ...
    ) -> windows_core::Result<MessageDialog> {
        Self::IMessageDialogFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IMessageDialogFactory<R, F: FnOnce(&IMessageDialogFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<MessageDialog, IMessageDialogFactory> =
...
impl windows_core::RuntimeType for MessageDialog {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMessageDialog>();
}
...
impl windows_core::RuntimeType for MessageDialogOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.UI.Popups.MessageDialogOptions;u4)",
    );
}
impl MessageDialogOptions {
...
impl windows_core::RuntimeType for Placement {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.UI.Popups.Placement;i4)");
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl PopupMenu {
    ...
    ) -> windows_core::Result<windows_future::IAsyncOperation<IUICommand>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowAsync)(
    ...
    pub fn ShowAsyncWithRect(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowAsyncWithRect)(
                windows_core::Interface::as_raw(this),
                selection,
                &mut result__,
            )
    ...
    pub fn ShowAsyncWithRectAndPlacement(
        &self,
        selection: super::super::Foundation::Rect,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowAsyncWithRectAndPlacement)(
                windows_core::Interface::as_raw(this),
                selection,
                preferredplacement,
                &mut result__,
...
impl windows_core::RuntimeType for PopupMenu {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPopupMenu>();
}
...
impl UICommand {
    ...
    pub fn CreateWithHandler<P1>(
        label: &windows_core::HSTRING,
        action: P1,
    ) -> windows_core::Result<UICommand>
    where
        P1: windows_core::Param<UICommandInvokedHandler>,
    {
        Self::IUICommandFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithHandler)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(label),
                action.param().abi(),
                &mut result__,
    ...
    pub fn CreateWithHandlerAndId<P1, P2>(
        label: &windows_core::HSTRING,
        action: P1,
        commandid: P2,
    ) -> windows_core::Result<UICommand>
        ...
        P2: windows_core::Param<windows_core::IInspectable>,
    {
        Self::IUICommandFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithHandlerAndId)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(label),
                action.param().abi(),
                commandid.param().abi(),
    ...
    fn IUICommandFactory<R, F: FnOnce(&IUICommandFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<UICommand, IUICommandFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
impl windows_core::RuntimeType for UICommand {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IUICommand>();
}
...
windows_core::imp::define_interface!(
    ...
    UICommandInvokedHandler_Vtbl,
    0xdaf77a4f_c27a_4298_9ac6_2922c45e7da6
);
...
impl UICommandInvokedHandler {
    pub fn new<
        F: FnMut(windows_core::Ref<'_, IUICommand>) -> windows_core::Result<()> + Send + 'static,
    >(
        invoke: F,
    ) -> Self {
        let com = UICommandInvokedHandlerBox {
            vtable: &UICommandInvokedHandlerBox::<F>::VTABLE,
...
#[repr(C)]
struct UICommandInvokedHandlerBox<
    F: FnMut(windows_core::Ref<'_, IUICommand>) -> windows_core::Result<()> + Send + 'static,
> {
...
impl<F: FnMut(windows_core::Ref<'_, IUICommand>) -> windows_core::Result<()> + Send + 'static>
    UICommandInvokedHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <UICommandInvokedHandler as windows_core::Interface>::IID

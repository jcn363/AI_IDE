...
impl AnimationDescription {
    pub fn Animations(
        &self,
    ) -> windows_core::Result<windows_collections::IVectorView<IPropertyAnimation>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Animations)(
    ...
    pub fn StaggerDelay(&self) -> windows_core::Result<super::super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StaggerDelay)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn StaggerDelayFactor(&self) -> windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StaggerDelayFactor)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn DelayLimit(&self) -> windows_core::Result<super::super::super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DelayLimit)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ZOrder(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ZOrder)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    ) -> windows_core::Result<AnimationDescription> {
    ...
    fn IAnimationDescriptionFactory<
        R,
        F: FnOnce(&IAnimationDescriptionFactory) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl windows_core::RuntimeType for AnimationDescription {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAnimationDescription>();
}
...
windows_core::imp::define_interface!(
    ...
    IAnimationDescription_Vtbl,
    0x7d11a549_be3d_41de_b081_05c149962f9b
);
...
pub struct IAnimationDescription_Vtbl {
    ...
    pub Animations: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub StaggerDelay: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub StaggerDelayFactor:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f32) -> windows_core::HRESULT,
    pub DelayLimit: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
    pub ZOrder:
...
windows_core::imp::define_interface!(
    IAnimationDescriptionFactory,
    IAnimationDescriptionFactory_Vtbl,
    0xc6e27abe_c1fb_48b5_9271_ecc70ac86ef0
);
...
windows_core::imp::define_interface!(
    IOpacityAnimation,
    IOpacityAnimation_Vtbl,
    0x803aabe5_ee7e_455f_84e9_2506afb8d2b4
);
...
pub struct IOpacityAnimation_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub InitialOpacity: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FinalOpacity:
...
windows_core::imp::define_interface!(
    ...
    0x3a01b4da_4d8c_411e_b615_1ade683a9903
);
...
impl IPropertyAnimation {
    ...
    pub fn Control1(&self) -> windows_core::Result<super::super::super::Foundation::Point> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Control1)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn Control2(&self) -> windows_core::Result<super::super::super::Foundation::Point> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Control2)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl IPropertyAnimation_Vtbl {
    pub const fn new<Identity: IPropertyAnimation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Type<Identity: IPropertyAnimation_Impl, const OFFSET: isize>(
        ...
        unsafe extern "system" fn Delay<Identity: IPropertyAnimation_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Control1<
            Identity: IPropertyAnimation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Control2<
            Identity: IPropertyAnimation_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
pub struct IPropertyAnimation_Vtbl {
    ...
    pub Control1: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Foundation::Point,
    ) -> windows_core::HRESULT,
    pub Control2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Foundation::Point,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IScaleAnimation,
    IScaleAnimation_Vtbl,
    0x023552c7_71ab_428c_9c9f_d31780964995
);
...
pub struct IScaleAnimation_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub InitialScaleX: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub InitialScaleY: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub FinalScaleX:
    ...
    pub FinalScaleY:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut f32) -> windows_core::HRESULT,
    pub NormalizedOrigin: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::super::Foundation::Point,
    ) -> windows_core::HRESULT,
}
...
impl OpacityAnimation {
    pub fn InitialOpacity(
        &self,
    ) -> windows_core::Result<super::super::super::Foundation::IReference<f32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InitialOpacity)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn FinalOpacity(&self) -> windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FinalOpacity)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for OpacityAnimation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IOpacityAnimation>();
}
...
impl windows_core::RuntimeType for PropertyAnimation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPropertyAnimation>();
}
...
impl ScaleAnimation {
    ...
    pub fn InitialScaleX(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InitialScaleX)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn InitialScaleY(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InitialScaleY)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn FinalScaleX(&self) -> windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FinalScaleX)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn FinalScaleY(&self) -> windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FinalScaleY)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn NormalizedOrigin(&self) -> windows_core::Result<super::super::super::Foundation::Point> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NormalizedOrigin)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for ScaleAnimation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IScaleAnimation>();
}

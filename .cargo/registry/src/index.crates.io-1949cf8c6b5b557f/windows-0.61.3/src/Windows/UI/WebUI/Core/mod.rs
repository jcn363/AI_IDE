windows_core::imp::define_interface!(
    IWebUICommandBar,
    IWebUICommandBar_Vtbl,
    0xa4fc0016_dbe5_41ad_8d7b_14698bd6911d
);
...
pub struct IWebUICommandBar_Vtbl {
    ...
    pub ClosedDisplayMode: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WebUICommandBarClosedDisplayMode,
    ) -> windows_core::HRESULT,
    ...
    pub MenuOpened: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveMenuOpened:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub MenuClosed: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveMenuClosed:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IWebUICommandBarBitmapIcon_Vtbl,
    0x858f4f45_08d8_4a46_81ec_00015b0b1c6c
);
...
windows_core::imp::define_interface!(
    ...
    IWebUICommandBarBitmapIconFactory_Vtbl,
    0xf3f7d78a_7673_444a_be62_ac12d31c2231
);
...
windows_core::imp::define_interface!(
    ...
    IWebUICommandBarConfirmationButton_Vtbl,
    0x86e7824a_e3d5_4eb6_b2ff_8f018a172105
);
...
windows_core::imp::define_interface!(
    ...
    IWebUICommandBarElement_Vtbl,
    0xc9069ec2_284a_4633_8aad_637a27e282c3
);
...
impl IWebUICommandBarElement_Vtbl {
    pub const fn new<Identity: IWebUICommandBarElement_Impl, const OFFSET: isize>() -> Self {
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IWebUICommandBarElement, OFFSET>(
            ),
        }
    }
...
windows_core::imp::define_interface!(
    ...
    IWebUICommandBarIcon_Vtbl,
    0xd587655d_2014_42be_969a_7d14ca6c8a49
);
...
impl IWebUICommandBarIcon_Vtbl {
    pub const fn new<Identity: IWebUICommandBarIcon_Impl, const OFFSET: isize>() -> Self {
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IWebUICommandBarIcon, OFFSET>(
            ),
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
windows_core::imp::define_interface!(
    ...
    IWebUICommandBarIconButton_Vtbl,
    0x8f1bc93a_3a7c_4842_a0cf_aff6ea308586
);
...
windows_core::imp::define_interface!(
    ...
    IWebUICommandBarItemInvokedEventArgs_Vtbl,
    0x304edbdd_e741_41ef_bdc4_a45cea2a4f70
);
...
pub struct IWebUICommandBarItemInvokedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsPrimaryCommand:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWebUICommandBarSizeChangedEventArgs,
    IWebUICommandBarSizeChangedEventArgs_Vtbl,
    0xfbf1e2f6_3029_4719_8378_92f82b87af1e
);
...
windows_core::imp::define_interface!(
    ...
    IWebUICommandBarStatics_Vtbl,
    0x1449cdb9_a506_45be_8f42_b2837e2fe0c9
);
...
windows_core::imp::define_interface!(
    ...
    IWebUICommandBarSymbolIcon_Vtbl,
    0xd4935477_fd26_46ed_8658_1a3f4400e7b3
);
...
windows_core::imp::define_interface!(
    ...
    0x51be1a1f_3730_429e_b622_14e2b7bf6a07
);
...
windows_core::imp::define_interface!(
    ...
    MenuClosedEventHandler_Vtbl,
    0x435387c8_4dd0_4c52_9489_d390ce7721d2
);
...
impl MenuClosedEventHandler {
    pub fn new<F: FnMut() -> windows_core::Result<()> + Send + 'static>(invoke: F) -> Self {
        let com = MenuClosedEventHandlerBox {
            vtable: &MenuClosedEventHandlerBox::<F>::VTABLE,
...
impl<F: FnMut() -> windows_core::Result<()> + Send + 'static> MenuClosedEventHandlerBox<F> {
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <MenuClosedEventHandler as windows_core::Interface>::IID
...
windows_core::imp::define_interface!(
    ...
    MenuOpenedEventHandler_Vtbl,
    0x18dc0ad3_678f_4c19_8963_cc1c49a5ef9e
);
...
impl MenuOpenedEventHandler {
    pub fn new<F: FnMut() -> windows_core::Result<()> + Send + 'static>(invoke: F) -> Self {
        let com = MenuOpenedEventHandlerBox {
            vtable: &MenuOpenedEventHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
impl<F: FnMut() -> windows_core::Result<()> + Send + 'static> MenuOpenedEventHandlerBox<F> {
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <MenuOpenedEventHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _
...
windows_core::imp::define_interface!(
    ...
    0xd49cfe3c_dd2e_4c28_b627_303a7f911af5
);
...
impl SizeChangedEventHandler {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, WebUICommandBarSizeChangedEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
...
impl WebUICommandBar {
    ...
    pub fn ClosedDisplayMode(&self) -> windows_core::Result<WebUICommandBarClosedDisplayMode> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ClosedDisplayMode)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetClosedDisplayMode(
        &self,
        value: WebUICommandBarClosedDisplayMode,
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetClosedDisplayMode)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn PrimaryCommands(
        ...
        super::super::super::Foundation::Collections::IObservableVector<IWebUICommandBarElement>,
    > {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PrimaryCommands)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SecondaryCommands)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<MenuOpenedEventHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MenuOpened)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveMenuOpened(&self, value: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveMenuOpened)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
        ...
        P0: windows_core::Param<MenuClosedEventHandler>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MenuClosed)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveMenuClosed(&self, value: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveMenuClosed)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    fn IWebUICommandBarStatics<
        R,
        F: FnOnce(&IWebUICommandBarStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<WebUICommandBar, IWebUICommandBarStatics> =
...
impl windows_core::RuntimeType for WebUICommandBar {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebUICommandBar>();
}
...
impl WebUICommandBarBitmapIcon {
    ...
    fn IWebUICommandBarBitmapIconFactory<
        R,
        F: FnOnce(&IWebUICommandBarBitmapIconFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for WebUICommandBarBitmapIcon {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebUICommandBarBitmapIcon>();
}
...
impl windows_core::RuntimeType for WebUICommandBarClosedDisplayMode {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.UI.WebUI.Core.WebUICommandBarClosedDisplayMode;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl WebUICommandBarConfirmationButton {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ItemInvoked)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveItemInvoked(&self, token: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveItemInvoked)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
...
impl windows_core::RuntimeType for WebUICommandBarConfirmationButton {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebUICommandBarConfirmationButton>();
}
unsafe impl windows_core::Interface for WebUICommandBarConfirmationButton {
    ...
    const IID: windows_core::GUID =
        <IWebUICommandBarConfirmationButton as windows_core::Interface>::IID;
}
...
impl WebUICommandBarIconButton {
    ...
    pub fn IsToggleButton(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsToggleButton)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetIsToggleButton(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetIsToggleButton)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
...
impl windows_core::RuntimeType for WebUICommandBarIconButton {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebUICommandBarIconButton>();
}
...
impl WebUICommandBarItemInvokedEventArgs {
    pub fn IsPrimaryCommand(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsPrimaryCommand)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for WebUICommandBarItemInvokedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebUICommandBarItemInvokedEventArgs>();
}
unsafe impl windows_core::Interface for WebUICommandBarItemInvokedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IWebUICommandBarItemInvokedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for WebUICommandBarSizeChangedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebUICommandBarSizeChangedEventArgs>();
}
unsafe impl windows_core::Interface for WebUICommandBarSizeChangedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IWebUICommandBarSizeChangedEventArgs as windows_core::Interface>::IID;
}
...
impl WebUICommandBarSymbolIcon {
    ...
    pub fn Symbol(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Symbol)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
    ...
    pub fn SetSymbol(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSymbol)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn Create(
        symbol: &windows_core::HSTRING,
    ) -> windows_core::Result<WebUICommandBarSymbolIcon> {
        Self::IWebUICommandBarSymbolIconFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(symbol),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    ...
    fn IWebUICommandBarSymbolIconFactory<
        R,
        F: FnOnce(&IWebUICommandBarSymbolIconFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for WebUICommandBarSymbolIcon {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebUICommandBarSymbolIcon>();
}

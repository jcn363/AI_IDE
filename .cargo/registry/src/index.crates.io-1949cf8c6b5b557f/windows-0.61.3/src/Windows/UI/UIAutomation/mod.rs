...
impl AutomationConnection {
    pub fn IsRemoteSystem(&self) -> bool {
        ...
        unsafe {
            ...
            let hresult__ = (windows_core::Interface::vtable(this).IsRemoteSystem)(
...
impl windows_core::RuntimeType for AutomationConnection {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAutomationConnection>();
}
...
impl windows_core::RuntimeType for AutomationConnectionBoundObject {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAutomationConnectionBoundObject>();
}
unsafe impl windows_core::Interface for AutomationConnectionBoundObject {
    ...
    const IID: windows_core::GUID =
        <IAutomationConnectionBoundObject as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for AutomationElement {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAutomationElement>();
}
...
impl windows_core::RuntimeType for AutomationTextRange {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAutomationTextRange>();
}
...
windows_core::imp::define_interface!(
    ...
    IAutomationConnection_Vtbl,
    0xaad262ed_0ef4_5d43_97be_a834e27b65b9
);
...
windows_core::imp::define_interface!(
    ...
    IAutomationConnectionBoundObject_Vtbl,
    0x5e8558fb_ca52_5b65_9830_dd2905816093
);
...
windows_core::imp::define_interface!(
    IAutomationElement,
    IAutomationElement_Vtbl,
    0xa1898370_2c07_56fd_993f_61a72a08058c
);
...
windows_core::imp::define_interface!(
    ...
    IAutomationTextRange_Vtbl,
    0x7e101b65_40d3_5994_85a9_0a0cb9a4ec98
);

...
impl windows_core::RuntimeType for ActivatedDeferral {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IActivatedDeferral>();
}
...
impl ActivatedEventHandler {
    ...
    >(
        ...
        let com = ActivatedEventHandlerBox {
            vtable: &ActivatedEventHandlerBox::<F>::VTABLE,
...
pub struct ActivatedEventHandler_Vtbl {
    ...
    Invoke: unsafe extern "system" fn(
        ...
        eventargs: *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
#[cfg(feature = "ApplicationModel_Activation")]
#[repr(C)]
struct ActivatedEventHandlerBox<
    F: FnMut(
            windows_core::Ref<'_, windows_core::IInspectable>,
            windows_core::Ref<'_, super::super::ApplicationModel::Activation::IActivatedEventArgs>,
        ) -> windows_core::Result<()>
        + Send
        + 'static,
> {
    ...
    > ActivatedEventHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <ActivatedEventHandler as windows_core::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        unsafe {
            ...
            (this.invoke)(
                ...
                core::mem::transmute_copy(&eventargs),
            )
            .into()
        }
    }
...
impl windows_core::RuntimeType for ActivatedOperation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IActivatedOperation>();
}
...
impl BackgroundActivatedEventArgs {
    ...
    pub fn TaskInstance(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::Background::IBackgroundTaskInstance>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl BackgroundActivatedEventHandler {
    ...
    >(
        ...
        let com = BackgroundActivatedEventHandlerBox {
            vtable: &BackgroundActivatedEventHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
#[cfg(feature = "ApplicationModel_Activation")]
#[repr(C)]
struct BackgroundActivatedEventHandlerBox<
    F: FnMut(
            windows_core::Ref<'_, windows_core::IInspectable>,
            windows_core::Ref<
                '_,
...
impl<
        F: FnMut(
            ...
            + Send
            + 'static,
    > BackgroundActivatedEventHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid
                == <BackgroundActivatedEventHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _
...
windows_core::imp::required_hierarchy!(
    ...
    super::super::Graphics::Printing::IPrintDocumentSource
);
#[cfg(feature = "Graphics_Printing")]
impl HtmlPrintDocumentSource {
    ...
    pub fn LeftMargin(&self) -> windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LeftMargin)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetLeftMargin(&self, value: f32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetLeftMargin)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn TopMargin(&self) -> windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TopMargin)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetTopMargin(&self, value: f32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetTopMargin)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn RightMargin(&self) -> windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RightMargin)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetRightMargin(&self, value: f32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetRightMargin)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn BottomMargin(&self) -> windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BottomMargin)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetBottomMargin(&self, value: f32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetBottomMargin)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn EnableHeaderFooter(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EnableHeaderFooter)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetEnableHeaderFooter(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetEnableHeaderFooter)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn ShrinkToFit(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShrinkToFit)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetShrinkToFit(&self, value: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetShrinkToFit)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn PercentScale(&self) -> windows_core::Result<f32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PercentScale)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SetPercentScale(&self, scalepercent: f32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPercentScale)(
                windows_core::Interface::as_raw(this),
                scalepercent,
            )
            .ok()
    ...
    pub fn PageRange(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PageRange)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn TrySetPageRange(
        &self,
        strpagerange: &windows_core::HSTRING,
    ) -> windows_core::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TrySetPageRange)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(strpagerange),
                &mut result__,
            )
            .map(|| result__)
        }
...
impl windows_core::RuntimeType for HtmlPrintDocumentSource {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHtmlPrintDocumentSource>();
}
#[cfg(feature = "Graphics_Printing")]
...
windows_core::imp::define_interface!(
    IActivatedDeferral,
    IActivatedDeferral_Vtbl,
    0xc3bd1978_a431_49d8_a76a_395a4e03dcf3
);
...
impl IActivatedEventArgsDeferral {
    pub fn ActivatedOperation(&self) -> windows_core::Result<ActivatedOperation> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ActivatedOperation)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl IActivatedEventArgsDeferral_Vtbl {
    pub const fn new<Identity: IActivatedEventArgsDeferral_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ActivatedOperation<
...
pub struct IActivatedEventArgsDeferral_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ActivatedOperation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IActivatedOperation,
    IActivatedOperation_Vtbl,
    0xb6a0b4bc_c6ca_42fd_9818_71904e45fed7
);
...
windows_core::imp::define_interface!(
    ...
    IHtmlPrintDocumentSource_Vtbl,
    0xcea6469a_0e05_467a_abc9_36ec1d4cdcb6
);
#[cfg(feature = "Graphics_Printing")]
...
pub struct IHtmlPrintDocumentSource_Vtbl {
    ...
    pub SetContent:
        unsafe extern "system" fn(*mut core::ffi::c_void, PrintContent) -> windows_core::HRESULT,
    pub LeftMargin:
    ...
    pub SetBottomMargin:
        unsafe extern "system" fn(*mut core::ffi::c_void, f32) -> windows_core::HRESULT,
    pub EnableHeaderFooter:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetEnableHeaderFooter:
    ...
    pub SetPercentScale:
        unsafe extern "system" fn(*mut core::ffi::c_void, f32) -> windows_core::HRESULT,
    pub PageRange: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub TrySetPageRange: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut bool,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    INewWebUIViewCreatedEventArgs_Vtbl,
    0xe8e1b216_be2b_4c9e_85e7_083143ec4be7
);
...
pub struct INewWebUIViewCreatedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Web_UI")]
    pub WebUIView: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    WebUIView: usize,
    #[cfg(feature = "ApplicationModel_Activation")]
    pub ActivatedEventArgs: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "ApplicationModel_Activation"))]
    ActivatedEventArgs: usize,
    pub HasPendingNavigate:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub GetDeferral: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IWebUIActivationStatics_Vtbl,
    0x351b86bd_43b3_482b_85db_35d87b517ad9
);
...
pub struct IWebUIActivationStatics_Vtbl {
    ...
    #[cfg(feature = "ApplicationModel")]
    pub Suspending: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    ...
    pub RemoveResuming:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub Navigated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IWebUIActivationStatics2_Vtbl,
    0xc8e88696_4d78_4aa4_8f06_2a9eadc6c40a
);
...
pub struct IWebUIActivationStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "ApplicationModel")]
    pub LeavingBackground: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    ...
    pub RemoveLeavingBackground:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    #[cfg(feature = "ApplicationModel")]
    pub EnteredBackground: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IWebUIActivationStatics3_Vtbl,
    0x91abb686_1af5_4445_b49f_9459f40fc8de
);
...
pub struct IWebUIActivationStatics3_Vtbl {
    ...
    pub RequestRestartAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub RequestRestartForUserAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IWebUIActivationStatics4_Vtbl,
    0x5e391429_183f_478d_8a25_67f80d03935b
);
...
pub struct IWebUIActivationStatics4_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub NewWebUIViewCreated: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveNewWebUIViewCreated:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    #[cfg(feature = "ApplicationModel_Activation")]
...
windows_core::imp::define_interface!(
    ...
    0x23f12c25_e2f7_4741_bc9c_394595de24dc
);
...
impl IWebUIBackgroundTaskInstance {
    ...
    pub fn SetSucceeded(&self, succeeded: bool) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSucceeded)(
                windows_core::Interface::as_raw(this),
                succeeded,
            )
            .ok()
...
impl IWebUIBackgroundTaskInstance_Vtbl {
    pub const fn new<Identity: IWebUIBackgroundTaskInstance_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetSucceeded<
            Identity: IWebUIBackgroundTaskInstance_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IWebUINavigatedDeferral_Vtbl,
    0xd804204d_831f_46e2_b432_3afce211f962
);
...
windows_core::imp::define_interface!(
    ...
    0xa75841b8_2499_4030_a69d_15d2d9cfe524
);
...
impl IWebUINavigatedEventArgs {
    pub fn NavigatedOperation(&self) -> windows_core::Result<WebUINavigatedOperation> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NavigatedOperation)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl IWebUINavigatedEventArgs_Vtbl {
    pub const fn new<Identity: IWebUINavigatedEventArgs_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn NavigatedOperation<
...
pub struct IWebUINavigatedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub NavigatedOperation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0x7a965f08_8182_4a89_ab67_8492e8750d4b
);
...
pub struct IWebUIView_Vtbl {
    ...
    pub RemoveActivated:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub IgnoreApplicationContentUriRulesNavigationRestrictions:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    pub SetIgnoreApplicationContentUriRulesNavigationRestrictions:
        unsafe extern "system" fn(*mut core::ffi::c_void, bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWebUIViewStatics,
    IWebUIViewStatics_Vtbl,
    0xb591e668_8e59_44f9_8803_1b24c9149d30
);
...
pub struct IWebUIViewStatics_Vtbl {
    ...
    CreateAsync: usize,
    #[cfg(feature = "Web_UI")]
    pub CreateWithUriAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
impl LeavingBackgroundEventHandler {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, windows_core::IInspectable>,
                windows_core::Ref<'_, super::super::ApplicationModel::ILeavingBackgroundEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
...
windows_core::imp::define_interface!(
    ...
    0x7af46fe6_40ca_4e49_a7d6_dbdb330cd1a3
);
...
impl NavigatedEventHandler {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, windows_core::IInspectable>,
                windows_core::Ref<'_, IWebUINavigatedEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
...
impl NewWebUIViewCreatedEventArgs {
    ...
    pub fn WebUIView(&self) -> windows_core::Result<WebUIView> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WebUIView)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ActivatedEventArgs(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::Activation::IActivatedEventArgs> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ActivatedEventArgs)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn HasPendingNavigate(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HasPendingNavigate)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for NewWebUIViewCreatedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, INewWebUIViewCreatedEventArgs>();
}
...
impl windows_core::RuntimeType for PrintContent {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::from_slice(b"enum(Windows.UI.WebUI.PrintContent;i4)");
}
windows_core::imp::define_interface!(
    ResumingEventHandler,
    ResumingEventHandler_Vtbl,
    0x26599ba9_a22d_4806_a728_acadc1d075fa
);
...
impl ResumingEventHandler {
    ...
    >(
        ...
        let com = ResumingEventHandlerBox {
            vtable: &ResumingEventHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
#[repr(C)]
struct ResumingEventHandlerBox<
    F: FnMut(windows_core::Ref<'_, windows_core::IInspectable>) -> windows_core::Result<()>
        + Send
        + 'static,
> {
    ...
    > ResumingEventHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid == <ResumingEventHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _
...
unsafe impl windows_core::Interface for SuspendingDeferral {
    type Vtable =
        <super::super::ApplicationModel::ISuspendingDeferral as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <super::super::ApplicationModel::ISuspendingDeferral as windows_core::Interface>::IID;
}
#[cfg(feature = "ApplicationModel")]
...
impl SuspendingEventArgs {
    pub fn SuspendingOperation(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::SuspendingOperation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
unsafe impl windows_core::Interface for SuspendingEventArgs {
    type Vtable =
        <super::super::ApplicationModel::ISuspendingEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <super::super::ApplicationModel::ISuspendingEventArgs as windows_core::Interface>::IID;
}
#[cfg(feature = "ApplicationModel")]
...
impl SuspendingOperation {
    pub fn GetDeferral(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::SuspendingDeferral> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDeferral)(
...
unsafe impl windows_core::Interface for SuspendingOperation {
    type Vtable =
        <super::super::ApplicationModel::ISuspendingOperation as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <super::super::ApplicationModel::ISuspendingOperation as windows_core::Interface>::IID;
}
#[cfg(feature = "ApplicationModel")]
...
impl WebUIApplication {
        ...
        P0: windows_core::Param<SuspendingEventHandler>,
    {
        Self::IWebUIActivationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Suspending)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveSuspending(token: i64) -> windows_core::Result<()> {
        Self::IWebUIActivationStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveSuspending)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<ResumingEventHandler>,
    {
        Self::IWebUIActivationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Resuming)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveResuming(token: i64) -> windows_core::Result<()> {
        Self::IWebUIActivationStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveResuming)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<NavigatedEventHandler>,
    {
        Self::IWebUIActivationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Navigated)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveNavigated(token: i64) -> windows_core::Result<()> {
        Self::IWebUIActivationStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveNavigated)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        P0: windows_core::Param<LeavingBackgroundEventHandler>,
    {
        Self::IWebUIActivationStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LeavingBackground)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
        ...
        P0: windows_core::Param<EnteredBackgroundEventHandler>,
    {
        Self::IWebUIActivationStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EnteredBackground)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn EnablePrelaunch(value: bool) -> windows_core::Result<()> {
        Self::IWebUIActivationStatics2(|this| unsafe {
            (windows_core::Interface::vtable(this).EnablePrelaunch)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn RequestRestartAsync(
        launcharguments: &windows_core::HSTRING,
    ) -> windows_core::Result<
    ...
    > {
        Self::IWebUIActivationStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestRestartAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(launcharguments),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
        ...
        P0: windows_core::Param<super::super::System::User>,
    {
        Self::IWebUIActivationStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestRestartForUserAsync)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                core::mem::transmute_copy(launcharguments),
                &mut result__,
        ...
        >,
    {
        Self::IWebUIActivationStatics4(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NewWebUIViewCreated)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveNewWebUIViewCreated(token: i64) -> windows_core::Result<()> {
        Self::IWebUIActivationStatics4(|this| unsafe {
            (windows_core::Interface::vtable(this).RemoveNewWebUIViewCreated)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    fn IWebUIActivationStatics<
        R,
        F: FnOnce(&IWebUIActivationStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<WebUIApplication, IWebUIActivationStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IWebUIActivationStatics2<
        R,
        F: FnOnce(&IWebUIActivationStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<WebUIApplication, IWebUIActivationStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IWebUIActivationStatics3<
        R,
        F: FnOnce(&IWebUIActivationStatics3) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<WebUIApplication, IWebUIActivationStatics3> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IWebUIActivationStatics4<
        R,
        F: FnOnce(&IWebUIActivationStatics4) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<WebUIApplication, IWebUIActivationStatics4> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl WebUIBackgroundTaskInstance {
    ...
    fn IWebUIBackgroundTaskInstanceStatics<
        R,
        F: FnOnce(&IWebUIBackgroundTaskInstanceStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
...
impl WebUIBackgroundTaskInstanceRuntimeClass {
    ...
    pub fn Task(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::Background::BackgroundTaskRegistration>
    {
        let this = &windows_core::Interface::cast::<
            super::super::ApplicationModel::Background::IBackgroundTaskInstance,
        >(self)?;
    ...
    pub fn GetDeferral(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::Background::BackgroundTaskDeferral>
    {
        let this = &windows_core::Interface::cast::<
            super::super::ApplicationModel::Background::IBackgroundTaskInstance,
        >(self)?;
...
impl windows_core::RuntimeType for WebUIBackgroundTaskInstanceRuntimeClass {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebUIBackgroundTaskInstance>();
}
#[cfg(feature = "ApplicationModel_Background")]
...
impl WebUIContactCallActivatedEventArgs {
    ...
    pub fn Contact(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::Contacts::Contact> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebUIContactMapActivatedEventArgs {
    ...
    pub fn Address(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::Contacts::ContactAddress> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebUIContactPanelActivatedEventArgs {
    ...
    pub fn ContactPanel(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::Contacts::ContactPanel> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebUIContactPickerActivatedEventArgs {
    ...
    pub fn ContactPickerUI(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::Contacts::Provider::ContactPickerUI>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebUILaunchActivatedEventArgs {
    ...
    pub fn TileActivatedInfo(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::Activation::TileActivatedInfo> {
        let this = &windows_core::Interface::cast::<
            super::super::ApplicationModel::Activation::ILaunchActivatedEventArgs2,
        >(self)?;
        unsafe {
...
impl WebUILockScreenCallActivatedEventArgs {
    ...
    pub fn CallUI(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::Calls::LockScreenCallUI> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for WebUINavigatedDeferral {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebUINavigatedDeferral>();
}
...
impl windows_core::RuntimeType for WebUINavigatedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebUINavigatedEventArgs>();
}
...
impl windows_core::RuntimeType for WebUINavigatedOperation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebUINavigatedOperation>();
}
...
windows_core::imp::required_hierarchy!(
    ...
    super::super::Web::UI::IWebViewControl2
);
#[cfg(feature = "Web_UI")]
impl WebUIView {
    pub fn ApplicationViewId(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ApplicationViewId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    where
        P0: windows_core::Param<
            super::super::Foundation::TypedEventHandler<WebUIView, windows_core::IInspectable>,
        >,
    {
        let this = self;
        unsafe {
    ...
    pub fn CreateWithUriAsync<P0>(
        uri: P0,
    ) -> windows_core::Result<windows_future::IAsyncOperation<WebUIView>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        Self::IWebUIViewStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithUriAsync)(
                windows_core::Interface::as_raw(this),
                uri.param().abi(),
                &mut result__,
            )
    ...
    > {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DeferredPermissionRequests)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Refresh(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).Refresh)(windows_core::Interface::as_raw(this))
                .ok()
        }
    }
    ...
    #[cfg(feature = "Web")]
    pub fn NavigateToLocalStreamUri<P0, P1>(
        &self,
        source: P0,
        streamresolver: P1,
    ) -> windows_core::Result<()>
        ...
        P1: windows_core::Param<super::super::Web::IUriToStreamResolver>,
    {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).NavigateToLocalStreamUri)(
                windows_core::Interface::as_raw(this),
                source.param().abi(),
                streamresolver.param().abi(),
            )
            .ok()
        }
    }
        ...
        P0: windows_core::Param<super::super::Web::Http::HttpRequestMessage>,
    {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).NavigateWithHttpRequestMessage)(
                windows_core::Interface::as_raw(this),
                requestmessage.param().abi(),
            )
            .ok()
        }
    }
    pub fn InvokeScriptAsync<P1>(
        &self,
        scriptname: &windows_core::HSTRING,
        arguments: P1,
        ...
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InvokeScriptAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(scriptname),
                arguments.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStream>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CapturePreviewToStreamAsync)(
                windows_core::Interface::as_raw(this),
                stream.param().abi(),
                &mut result__,
            )
    ...
    pub fn CaptureSelectedContentToDataPackageAsync(
        ...
        windows_future::IAsyncOperation<super::super::ApplicationModel::DataTransfer::DataPackage>,
    > {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CaptureSelectedContentToDataPackageAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn BuildLocalStreamUri(
        &self,
        contentidentifier: &windows_core::HSTRING,
        relativepath: &windows_core::HSTRING,
    ) -> windows_core::Result<super::super::Foundation::Uri> {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BuildLocalStreamUri)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(contentidentifier),
                core::mem::transmute_copy(relativepath),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub fn GetDeferredPermissionRequestById(
        &self,
        id: u32,
        result: &mut Option<super::super::Web::UI::WebViewControlDeferredPermissionRequest>,
    ) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).GetDeferredPermissionRequestById)(
                windows_core::Interface::as_raw(this),
                id,
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FrameContentLoading)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveFrameContentLoading(&self, token: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveFrameContentLoading)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FrameDOMContentLoaded)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveFrameDOMContentLoaded(&self, token: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveFrameDOMContentLoaded)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ScriptNotify)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveScriptNotify(&self, token: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveScriptNotify)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LongRunningScriptDetected)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveLongRunningScriptDetected(&self, token: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveLongRunningScriptDetected)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UnsafeContentWarningDisplaying)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveUnsafeContentWarningDisplaying(&self, token: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveUnsafeContentWarningDisplaying)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UnviewableContentIdentified)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveUnviewableContentIdentified(&self, token: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveUnviewableContentIdentified)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UnsupportedUriSchemeIdentified)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveUnsupportedUriSchemeIdentified(&self, token: i64) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::super::Web::UI::IWebViewControl>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveUnsupportedUriSchemeIdentified)(
                windows_core::Interface::as_raw(this),
                token,
            )
            .ok()
    ...
    pub fn AddInitializeScript(&self, script: &windows_core::HSTRING) -> windows_core::Result<()> {
        ...
        unsafe {
            (windows_core::Interface::vtable(this).AddInitializeScript)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(script),
            )
            .ok()
        }
    }
    fn IWebUIViewStatics<R, F: FnOnce(&IWebUIViewStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<WebUIView, IWebUIViewStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl windows_core::RuntimeType for WebUIView {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebUIView>();
}
#[cfg(feature = "Web_UI")]
...
impl WebUIWalletActionActivatedEventArgs {
    ...
    pub fn ActionKind(
        &self,
    ) -> windows_core::Result<super::super::ApplicationModel::Wallet::WalletActionKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();

...
impl AccountsSettingsPane {
        ...
        >,
    {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).AccountCommandsRequested)(
    ...
    pub fn RemoveAccountCommandsRequested(&self, cookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveAccountCommandsRequested)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
    ...
    pub fn ShowManageAccountsAsync() -> windows_core::Result<windows_future::IAsyncAction> {
        Self::IAccountsSettingsPaneStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowManageAccountsAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ShowAddAccountAsync() -> windows_core::Result<windows_future::IAsyncAction> {
        Self::IAccountsSettingsPaneStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowAddAccountAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "System")]
    pub fn ShowManageAccountsForUserAsync<P0>(
        user: P0,
        ...
        P0: windows_core::Param<super::super::System::User>,
    {
        Self::IAccountsSettingsPaneStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowManageAccountsForUserAsync)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                &mut result__,
            )
    ...
    #[cfg(feature = "System")]
    pub fn ShowAddAccountForUserAsync<P0>(
        user: P0,
    ) -> windows_core::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::super::System::User>,
    {
        Self::IAccountsSettingsPaneStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowAddAccountForUserAsync)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                &mut result__,
            )
    ...
    fn IAccountsSettingsPaneStatics<
        R,
        F: FnOnce(&IAccountsSettingsPaneStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ...
    fn IAccountsSettingsPaneStatics2<
        R,
        F: FnOnce(&IAccountsSettingsPaneStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
    ...
    fn IAccountsSettingsPaneStatics3<
        R,
        F: FnOnce(&IAccountsSettingsPaneStatics3) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for AccountsSettingsPane {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAccountsSettingsPane>();
}
...
impl AccountsSettingsPaneCommandsRequestedEventArgs {
    pub fn WebAccountProviderCommands(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<WebAccountProviderCommand>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WebAccountProviderCommands)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn WebAccountCommands(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<WebAccountCommand>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WebAccountCommands)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CredentialCommands(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<CredentialCommand>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CredentialCommands)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn HeaderText(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HeaderText)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn SetHeaderText(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetHeaderText)(
                windows_core::Interface::as_raw(this),
...
unsafe impl windows_core::Interface for AccountsSettingsPaneCommandsRequestedEventArgs {
    type Vtable =
        <IAccountsSettingsPaneCommandsRequestedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IAccountsSettingsPaneCommandsRequestedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for AccountsSettingsPaneEventDeferral {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAccountsSettingsPaneEventDeferral>();
}
unsafe impl windows_core::Interface for AccountsSettingsPaneEventDeferral {
    ...
    const IID: windows_core::GUID =
        <IAccountsSettingsPaneEventDeferral as windows_core::Interface>::IID;
}
...
impl CredentialCommand {
    ...
    pub fn PasswordCredential(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PasswordCredential)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CredentialDeleted(
        &self,
    ) -> windows_core::Result<CredentialCommandCredentialDeletedHandler> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CredentialDeleted)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateCredentialCommandWithHandler<P0, P1>(
        passwordcredential: P0,
        deleted: P1,
    ) -> windows_core::Result<CredentialCommand>
    where
        ...
        P1: windows_core::Param<CredentialCommandCredentialDeletedHandler>,
    {
        Self::ICredentialCommandFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateCredentialCommandWithHandler)(
                windows_core::Interface::as_raw(this),
                passwordcredential.param().abi(),
                deleted.param().abi(),
                &mut result__,
    ...
    fn ICredentialCommandFactory<
        R,
        F: FnOnce(&ICredentialCommandFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for CredentialCommand {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICredentialCommand>();
}
...
windows_core::imp::define_interface!(
    ...
    CredentialCommandCredentialDeletedHandler_Vtbl,
    0x61c0e185_0977_4678_b4e2_98727afbeed9
);
...
impl CredentialCommandCredentialDeletedHandler {
    pub fn new<
        F: FnMut(windows_core::Ref<'_, CredentialCommand>) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        invoke: F,
    ) -> Self {
        let com = CredentialCommandCredentialDeletedHandlerBox {
            vtable: &CredentialCommandCredentialDeletedHandlerBox::<F>::VTABLE,
...
#[repr(C)]
struct CredentialCommandCredentialDeletedHandlerBox<
    F: FnMut(windows_core::Ref<'_, CredentialCommand>) -> windows_core::Result<()> + Send + 'static,
> {
...
impl<
        F: FnMut(windows_core::Ref<'_, CredentialCommand>) -> windows_core::Result<()>
            + Send
            + 'static,
    > CredentialCommandCredentialDeletedHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid
                == <CredentialCommandCredentialDeletedHandler as windows_core::Interface>::IID
...
windows_core::imp::define_interface!(
    ...
    IAccountsSettingsPane_Vtbl,
    0x81ea942c_4f09_4406_a538_838d9b14b7e6
);
...
pub struct IAccountsSettingsPane_Vtbl {
    ...
    pub AccountCommandsRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveAccountCommandsRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IAccountsSettingsPaneCommandsRequestedEventArgs,
    IAccountsSettingsPaneCommandsRequestedEventArgs_Vtbl,
    0x3b68c099_db19_45d0_9abf_95d3773c9330
);
...
pub struct IAccountsSettingsPaneCommandsRequestedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub WebAccountProviderCommands: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub WebAccountCommands: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub CredentialCommands: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(feature = "UI_Popups")]
    ...
    pub SetHeaderText: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IAccountsSettingsPaneCommandsRequestedEventArgs2,
    IAccountsSettingsPaneCommandsRequestedEventArgs2_Vtbl,
    0x362f7bad_4e37_4967_8c40_e78ee7a1e5bb
);
...
windows_core::imp::define_interface!(
    ...
    IAccountsSettingsPaneEventDeferral_Vtbl,
    0xcbf25d3f_e5ba_40ef_93da_65e096e5fb04
);
...
windows_core::imp::define_interface!(
    IAccountsSettingsPaneStatics,
    IAccountsSettingsPaneStatics_Vtbl,
    0x561f8b60_b0ec_4150_a8dc_208ee44b068a
);
...
windows_core::imp::define_interface!(
    IAccountsSettingsPaneStatics2,
    IAccountsSettingsPaneStatics2_Vtbl,
    0xd21df7c2_ce0d_484f_b8e8_e823c215765e
);
...
pub struct IAccountsSettingsPaneStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ShowManageAccountsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ShowAddAccountAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0x08410458_a2ba_4c6f_b4ac_48f514331216
);
...
pub struct IAccountsSettingsPaneStatics3_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "System")]
    pub ShowManageAccountsForUserAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "System")]
    pub ShowAddAccountForUserAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ICredentialCommand,
    ICredentialCommand_Vtbl,
    0xa5f665e6_6143_4a7a_a971_b017ba978ce2
);
...
pub struct ICredentialCommand_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Security_Credentials")]
    pub PasswordCredential: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Security_Credentials"))]
    PasswordCredential: usize,
    pub CredentialDeleted: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ICredentialCommandFactory,
    ICredentialCommandFactory_Vtbl,
    0x27e88c17_bc3e_4b80_9495_4ed720e48a91
);
...
pub struct ICredentialCommandFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Security_Credentials")]
    pub CreateCredentialCommand: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Security_Credentials")]
    pub CreateCredentialCommandWithHandler: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    ISettingsCommandFactory_Vtbl,
    0x68e15b33_1c83_433a_aa5a_ceeea5bd4764
);
...
pub struct ISettingsCommandFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "UI_Popups")]
    pub CreateSettingsCommand: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    ISettingsCommandStatics_Vtbl,
    0x749ae954_2f69_4b17_8aba_d05ce5778e46
);
...
pub struct ISettingsCommandStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "UI_Popups")]
    pub AccountsCommand: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "UI_Popups"))]
...
pub struct ISettingsPane_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CommandsRequested: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveCommandsRequested:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
#[cfg(feature = "deprecated")]
windows_core::imp::define_interface!(
...
pub struct ISettingsPaneCommandsRequest_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "UI_Popups")]
    pub ApplicationCommands: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "UI_Popups"))]
...
pub struct ISettingsPaneStatics_Vtbl {
    ...
    pub Edge: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SettingsEdgeLocation,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWebAccountCommand,
    IWebAccountCommand_Vtbl,
    0xcaa39398_9cfa_4246_b0c4_a913a3896541
);
...
pub struct IWebAccountCommand_Vtbl {
    ...
    pub Actions: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut SupportedWebAccountActions,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWebAccountCommandFactory,
    IWebAccountCommandFactory_Vtbl,
    0xbfa6cdff_2f2d_42f5_81de_1d56bafc496d
);
...
pub struct IWebAccountCommandFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Security_Credentials")]
    pub CreateWebAccountCommand: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IWebAccountInvokedArgs_Vtbl,
    0xe7abcc40_a1d8_4c5d_9a7f_1d34b2f90ad2
);
...
pub struct IWebAccountInvokedArgs_Vtbl {
    ...
    pub Action: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut WebAccountAction,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IWebAccountProviderCommand,
    IWebAccountProviderCommand_Vtbl,
    0xd69bdd9a_a0a6_4e9b_88dc_c71e757a3501
);
...
windows_core::imp::define_interface!(
    ...
    IWebAccountProviderCommandFactory_Vtbl,
    0xd5658a1b_b176_4776_8469_a9d3ff0b3f59
);
...
pub struct IWebAccountProviderCommandFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Security_Credentials")]
    pub CreateWebAccountProviderCommand: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::interface_hierarchy!(
    ...
    windows_core::IUnknown,
    windows_core::IInspectable,
    super::Popups::IUICommand
);
#[cfg(feature = "UI_Popups")]
impl SettingsCommand {
    pub fn CreateSettingsCommand<P0, P2>(
        settingscommandid: P0,
        label: &windows_core::HSTRING,
        handler: P2,
    ) -> windows_core::Result<SettingsCommand>
    where
        ...
        P2: windows_core::Param<super::Popups::UICommandInvokedHandler>,
    {
        Self::ISettingsCommandFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateSettingsCommand)(
                windows_core::Interface::as_raw(this),
                settingscommandid.param().abi(),
    ...
    pub fn AccountsCommand() -> windows_core::Result<SettingsCommand> {
        Self::ISettingsCommandStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AccountsCommand)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::Popups::UICommandInvokedHandler>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetInvoked)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    fn ISettingsCommandFactory<
        R,
        F: FnOnce(&ISettingsCommandFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SettingsCommand, ISettingsCommandFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ISettingsCommandStatics<
        R,
        F: FnOnce(&ISettingsCommandStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SettingsCommand, ISettingsCommandStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl windows_core::RuntimeType for SettingsCommand {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, super::Popups::IUICommand>();
}
#[cfg(feature = "UI_Popups")]
...
impl SettingsPane {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CommandsRequested)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveCommandsRequested(&self, cookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveCommandsRequested)(
                windows_core::Interface::as_raw(this),
                cookie,
            )
            .ok()
    ...
    fn ISettingsPaneStatics<R, F: FnOnce(&ISettingsPaneStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SettingsPane, ISettingsPaneStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl windows_core::RuntimeType for SettingsPane {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISettingsPane>();
}
#[cfg(feature = "deprecated")]
...
impl SettingsPaneCommandsRequest {
    ...
    pub fn ApplicationCommands(
        &self,
    ) -> windows_core::Result<windows_collections::IVector<SettingsCommand>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ApplicationCommands)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for SettingsPaneCommandsRequest {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISettingsPaneCommandsRequest>();
}
#[cfg(feature = "deprecated")]
...
impl windows_core::RuntimeType for SettingsPaneCommandsRequestedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ISettingsPaneCommandsRequestedEventArgs>(
        );
}
#[cfg(feature = "deprecated")]
unsafe impl windows_core::Interface for SettingsPaneCommandsRequestedEventArgs {
    ...
    const IID: windows_core::GUID =
        <ISettingsPaneCommandsRequestedEventArgs as windows_core::Interface>::IID;
}
#[cfg(feature = "deprecated")]
...
impl WebAccountCommand {
    ...
    pub fn WebAccount(
        &self,
    ) -> windows_core::Result<super::super::Security::Credentials::WebAccount> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateWebAccountCommand<P0, P1>(
        webaccount: P0,
        invoked: P1,
        actions: SupportedWebAccountActions,
    ) -> windows_core::Result<WebAccountCommand>
    where
        ...
        P1: windows_core::Param<WebAccountCommandInvokedHandler>,
    {
        Self::IWebAccountCommandFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWebAccountCommand)(
                windows_core::Interface::as_raw(this),
    ...
    fn IWebAccountCommandFactory<
        R,
        F: FnOnce(&IWebAccountCommandFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for WebAccountCommand {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebAccountCommand>();
}
...
windows_core::imp::define_interface!(
    ...
    WebAccountCommandInvokedHandler_Vtbl,
    0x1ee6e459_1705_4a9a_b599_a0c3d6921973
);
...
impl WebAccountCommandInvokedHandler {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, WebAccountCommand>,
                windows_core::Ref<'_, WebAccountInvokedArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        ...
        let com = WebAccountCommandInvokedHandlerBox {
            vtable: &WebAccountCommandInvokedHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
#[repr(C)]
struct WebAccountCommandInvokedHandlerBox<
    F: FnMut(
            windows_core::Ref<'_, WebAccountCommand>,
            windows_core::Ref<'_, WebAccountInvokedArgs>,
        ) -> windows_core::Result<()>
...
impl<
        F: FnMut(
            ...
            + Send
            + 'static,
    > WebAccountCommandInvokedHandlerBox<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid
                == <WebAccountCommandInvokedHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _
...
impl windows_core::RuntimeType for WebAccountInvokedArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebAccountInvokedArgs>();
}
...
impl WebAccountProviderCommand {
    ...
    pub fn WebAccountProvider(
        &self,
    ) -> windows_core::Result<super::super::Security::Credentials::WebAccountProvider> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateWebAccountProviderCommand<P0, P1>(
        webaccountprovider: P0,
        invoked: P1,
    ) -> windows_core::Result<WebAccountProviderCommand>
    where
        ...
        P1: windows_core::Param<WebAccountProviderCommandInvokedHandler>,
    {
        Self::IWebAccountProviderCommandFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWebAccountProviderCommand)(
                windows_core::Interface::as_raw(this),
                webaccountprovider.param().abi(),
                invoked.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IWebAccountProviderCommandFactory<
        R,
        F: FnOnce(&IWebAccountProviderCommandFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for WebAccountProviderCommand {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IWebAccountProviderCommand>();
}
...
windows_core::imp::define_interface!(
    ...
    WebAccountProviderCommandInvokedHandler_Vtbl,
    0xb7de5527_4c8f_42dd_84da_5ec493abdb9a
);
...
impl WebAccountProviderCommandInvokedHandler {
    pub fn new<
        F: FnMut(windows_core::Ref<'_, WebAccountProviderCommand>) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
        invoke: F,
    ) -> Self {
        let com = WebAccountProviderCommandInvokedHandlerBox {
            vtable: &WebAccountProviderCommandInvokedHandlerBox::<F>::VTABLE,
            count: windows_core::imp::RefCount::new(1),
            invoke,
        };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
...
#[repr(C)]
struct WebAccountProviderCommandInvokedHandlerBox<
    F: FnMut(windows_core::Ref<'_, WebAccountProviderCommand>) -> windows_core::Result<()>
        + Send
        + 'static,
> {
...
impl<
        F: FnMut(windows_core::Ref<'_, WebAccountProviderCommand>) -> windows_core::Result<()>
            + Send
            + 'static,
    > WebAccountProviderCommandInvokedHandlerBox<F>
{
    const VTABLE: WebAccountProviderCommandInvokedHandler_Vtbl =
        WebAccountProviderCommandInvokedHandler_Vtbl {
            base__: windows_core::IUnknown_Vtbl {
                QueryInterface: Self::QueryInterface,
                AddRef: Self::AddRef,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        unsafe {
            ...
            *interface = if *iid
                == <WebAccountProviderCommandInvokedHandler as windows_core::Interface>::IID
                || *iid == <windows_core::IUnknown as windows_core::Interface>::IID
                || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID
            {
                &mut (*this).vtable as *mut _ as _

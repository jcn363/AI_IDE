...
impl AutomationRemoteOperationResult {
    ...
    pub fn ErrorLocation(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ErrorLocation)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn HasOperand(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HasOperand)(
                windows_core::Interface::as_raw(this),
                operandid,
                &mut result__,
            )
    ...
    pub fn GetOperand(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetOperand)(
                windows_core::Interface::as_raw(this),
                operandid,
                &mut result__,
            )
...
impl windows_core::RuntimeType for AutomationRemoteOperationResult {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IAutomationRemoteOperationResult>();
}
unsafe impl windows_core::Interface for AutomationRemoteOperationResult {
    ...
    const IID: windows_core::GUID =
        <IAutomationRemoteOperationResult as windows_core::Interface>::IID;
}
...
impl CoreAutomationRegistrar {
    ...
    ) -> windows_core::Result<AutomationAnnotationTypeRegistration> {
        Self::ICoreAutomationRegistrarStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RegisterAnnotationType)(
                windows_core::Interface::as_raw(this),
                guid,
                &mut result__,
            )
    ...
    pub fn UnregisterAnnotationType(
        ...
        Self::ICoreAutomationRegistrarStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).UnregisterAnnotationType)(
                windows_core::Interface::as_raw(this),
                registration,
            )
            .ok()
    ...
    fn ICoreAutomationRegistrarStatics<
        R,
        F: FnOnce(&ICoreAutomationRegistrarStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
impl CoreAutomationRemoteOperation {
    ...
    pub fn IsOpcodeSupported(&self, opcode: u32) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsOpcodeSupported)(
                windows_core::Interface::as_raw(this),
                opcode,
                &mut result__,
            )
        ...
        P1: windows_core::Param<super::AutomationElement>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ImportElement)(
                windows_core::Interface::as_raw(this),
                operandid,
                element.param().abi(),
            )
        ...
        P1: windows_core::Param<super::AutomationTextRange>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).ImportTextRange)(
                windows_core::Interface::as_raw(this),
                operandid,
                textrange.param().abi(),
            )
    ...
    pub fn AddToResults(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AddToResults)(
                windows_core::Interface::as_raw(this),
                operandid,
            )
            .ok()
    ...
    pub fn Execute(
        &self,
        bytecodebuffer: &[u8],
    ) -> windows_core::Result<AutomationRemoteOperationResult> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Execute)(
                windows_core::Interface::as_raw(this),
                bytecodebuffer.len().try_into().unwrap(),
                bytecodebuffer.as_ptr(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn ImportConnectionBoundObject<P1>(
        &self,
        operandid: AutomationRemoteOperationOperandId,
        connectionboundobject: P1,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<super::AutomationConnectionBoundObject>,
    {
        ...
        unsafe {
            (windows_core::Interface::vtable(this).ImportConnectionBoundObject)(
                windows_core::Interface::as_raw(this),
                operandid,
                connectionboundobject.param().abi(),
            )
            .ok()
        }
    }
...
impl windows_core::RuntimeType for CoreAutomationRemoteOperation {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICoreAutomationRemoteOperation>();
}
unsafe impl windows_core::Interface for CoreAutomationRemoteOperation {
    ...
    const IID: windows_core::GUID =
        <ICoreAutomationRemoteOperation as windows_core::Interface>::IID;
}
...
impl CoreAutomationRemoteOperationContext {
        ...
        P1: windows_core::Param<windows_core::IInspectable>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetOperand)(
                windows_core::Interface::as_raw(this),
                id,
                operand.param().abi(),
            )
    ...
    pub fn SetOperand2<P1>(
        &self,
        id: AutomationRemoteOperationOperandId,
        operand: P1,
        operandinterfaceid: windows_core::GUID,
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<windows_core::IInspectable>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetOperand2)(
                windows_core::Interface::as_raw(this),
                id,
                operand.param().abi(),
                operandinterfaceid,
...
impl windows_core::RuntimeType for CoreAutomationRemoteOperationContext {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICoreAutomationRemoteOperationContext>();
}
unsafe impl windows_core::Interface for CoreAutomationRemoteOperationContext {
    ...
    const IID: windows_core::GUID =
        <ICoreAutomationRemoteOperationContext as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    ...
    IAutomationRemoteOperationResult_Vtbl,
    0xe0f80c42_4a67_5534_bf5a_09e8a99b36b1
);
...
pub struct IAutomationRemoteOperationResult_Vtbl {
    ...
    pub Status: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut AutomationRemoteOperationStatus,
    ...
    pub HasOperand: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        AutomationRemoteOperationOperandId,
        *mut bool,
    ) -> windows_core::HRESULT,
    pub GetOperand: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        AutomationRemoteOperationOperandId,
...
windows_core::imp::define_interface!(
    ...
    0x0620bb64_9616_5593_be3a_eb8e6daeb3fa
);
...
impl ICoreAutomationConnectionBoundObjectProvider {
    pub fn IsComThreadingRequired(&self) -> bool {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            let hresult__ = (windows_core::Interface::vtable(this).IsComThreadingRequired)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            );
...
impl ICoreAutomationConnectionBoundObjectProvider_Vtbl {
    pub const fn new<
        ...
        const OFFSET: isize,
    >() -> Self {
        unsafe extern "system" fn IsComThreadingRequired<
            Identity: ICoreAutomationConnectionBoundObjectProvider_Impl,
            const OFFSET: isize,
        >(
            ...
            unsafe {
                ...
                let ok__ =
                    ICoreAutomationConnectionBoundObjectProvider_Impl::IsComThreadingRequired(this);
...
pub struct ICoreAutomationConnectionBoundObjectProvider_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsComThreadingRequired:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ICoreAutomationRegistrarStatics,
    ICoreAutomationRegistrarStatics_Vtbl,
    0x3e50129b_d6dc_5680_b580_ffff78300304
);
...
pub struct ICoreAutomationRegistrarStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub RegisterAnnotationType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut AutomationAnnotationTypeRegistration,
    ) -> windows_core::HRESULT,
    pub UnregisterAnnotationType: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    ICoreAutomationRemoteOperation_Vtbl,
    0x3ac656f4_e2bc_5c6e_b8e7_b224fb74b060
);
...
pub struct ICoreAutomationRemoteOperation_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub IsOpcodeSupported:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut bool) -> windows_core::HRESULT,
    pub ImportElement: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        AutomationRemoteOperationOperandId,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub ImportTextRange: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        AutomationRemoteOperationOperandId,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub AddToResults: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        AutomationRemoteOperationOperandId,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ICoreAutomationRemoteOperation2_Vtbl,
    0xeefaf86f_e953_5099_8ce9_dca813482ba0
);
...
pub struct ICoreAutomationRemoteOperation2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ImportConnectionBoundObject: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        AutomationRemoteOperationOperandId,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    ICoreAutomationRemoteOperationContext_Vtbl,
    0xb9af9cbb_3d3e_5918_a16b_7861626a3aeb
);
...
pub struct ICoreAutomationRemoteOperationContext_Vtbl {
    ...
    pub SetOperand: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        AutomationRemoteOperationOperandId,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SetOperand2: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        AutomationRemoteOperationOperandId,
        *mut core::ffi::c_void,
        windows_core::GUID,
...
impl ICoreAutomationRemoteOperationExtensionProvider {
    pub fn CallExtension<P1>(
        &self,
        extensionid: windows_core::GUID,
        context: P1,
        operandids: &[AutomationRemoteOperationOperandId],
    ) -> windows_core::Result<()>
    where
        P1: windows_core::Param<CoreAutomationRemoteOperationContext>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).CallExtension)(
                windows_core::Interface::as_raw(this),
                extensionid,
                context.param().abi(),
                operandids.len().try_into().unwrap(),
                operandids.as_ptr(),
            )
            .ok()
        }
    ...
    pub fn IsExtensionSupported(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsExtensionSupported)(
                windows_core::Interface::as_raw(this),
                extensionid,
                &mut result__,
            )
...
pub trait ICoreAutomationRemoteOperationExtensionProvider_Impl: windows_core::IUnknownImpl {
    fn CallExtension(
        &self,
        extensionId: &windows_core::GUID,
        context: windows_core::Ref<'_, CoreAutomationRemoteOperationContext>,
        operandIds: &[AutomationRemoteOperationOperandId],
    ) -> windows_core::Result<()>;
...
impl ICoreAutomationRemoteOperationExtensionProvider_Vtbl {
    pub const fn new<
        ...
        const OFFSET: isize,
    >() -> Self {
        unsafe extern "system" fn CallExtension<
            Identity: ICoreAutomationRemoteOperationExtensionProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICoreAutomationRemoteOperationExtensionProvider_Impl::CallExtension(
                    this,
                    core::mem::transmute(&extensionid),
                    core::mem::transmute_copy(&context),
                    core::slice::from_raw_parts(
                        core::mem::transmute_copy(&operandids),
                        operandids_array_size as usize,
                    ),
                )
                .into()
            }
        }
        unsafe extern "system" fn IsExtensionSupported<
            Identity: ICoreAutomationRemoteOperationExtensionProvider_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match ICoreAutomationRemoteOperationExtensionProvider_Impl::IsExtensionSupported(
                    this,
                    core::mem::transmute(&extensionid),
                ) {
                    Ok(ok__) => {
...
pub struct ICoreAutomationRemoteOperationExtensionProvider_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub CallExtension: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut core::ffi::c_void,
        u32,
        *const AutomationRemoteOperationOperandId,
    ) -> windows_core::HRESULT,
    pub IsExtensionSupported: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
        *mut bool,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IRemoteAutomationClientSession_Vtbl,
    0x5c8a091d_94cc_5b33_afdb_678cded2bd54
);
...
pub struct IRemoteAutomationClientSession_Vtbl {
    ...
    pub CreateWindowAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u64,
        u32,
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IRemoteAutomationConnectionRequestedEventArgs_Vtbl,
    0xea3319a8_e3a8_5dc6_adf8_044e46b14af5
);
...
pub struct IRemoteAutomationConnectionRequestedEventArgs_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub LocalPipeName: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub RemoteProcessId:
...
windows_core::imp::define_interface!(
    IRemoteAutomationDisconnectedEventArgs,
    IRemoteAutomationDisconnectedEventArgs_Vtbl,
    0xbbb33a3d_5d90_5c38_9eb2_dd9dcc1b2e3f
);
...
windows_core::imp::define_interface!(
    ...
    IRemoteAutomationServerStatics_Vtbl,
    0xe6e8945e_0c11_5028_9ae3_c2771288b6b7
);
...
pub struct IRemoteAutomationServerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ReportSession: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        windows_core::GUID,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IRemoteAutomationWindow_Vtbl,
    0x7c607689_496d_512a_9bd5_c050cfaf1428
);
...
pub struct IRemoteAutomationWindow_Vtbl {
    ...
    pub UnregisterAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
...
impl RemoteAutomationClientSession {
    ...
    pub fn CreateWindowAsync<P2>(
        &self,
        remotewindowid: u64,
        remoteprocessid: u32,
        parentautomationelement: P2,
    ) -> windows_core::Result<windows_future::IAsyncOperation<RemoteAutomationWindow>>
    where
        P2: windows_core::Param<windows_core::IInspectable>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWindowAsync)(
                windows_core::Interface::as_raw(this),
                remotewindowid,
                remoteprocessid,
                parentautomationelement.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    ) -> windows_core::Result<RemoteAutomationClientSession> {
    ...
    fn IRemoteAutomationClientSessionFactory<
        R,
        F: FnOnce(&IRemoteAutomationClientSessionFactory) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for RemoteAutomationClientSession {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteAutomationClientSession>();
}
unsafe impl windows_core::Interface for RemoteAutomationClientSession {
    ...
    const IID: windows_core::GUID =
        <IRemoteAutomationClientSession as windows_core::Interface>::IID;
}
...
impl RemoteAutomationConnectionRequestedEventArgs {
    pub fn LocalPipeName(&self) -> windows_core::Result<windows_core::HSTRING> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LocalPipeName)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn RemoteProcessId(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemoteProcessId)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
unsafe impl windows_core::Interface for RemoteAutomationConnectionRequestedEventArgs {
    type Vtable =
        <IRemoteAutomationConnectionRequestedEventArgs as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <IRemoteAutomationConnectionRequestedEventArgs as windows_core::Interface>::IID;
}
...
impl windows_core::RuntimeType for RemoteAutomationDisconnectedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteAutomationDisconnectedEventArgs>();
}
unsafe impl windows_core::Interface for RemoteAutomationDisconnectedEventArgs {
    ...
    const IID: windows_core::GUID =
        <IRemoteAutomationDisconnectedEventArgs as windows_core::Interface>::IID;
}
...
impl RemoteAutomationServer {
    pub fn ReportSession(sessionid: windows_core::GUID) -> windows_core::Result<()> {
        Self::IRemoteAutomationServerStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).ReportSession)(
                windows_core::Interface::as_raw(this),
                sessionid,
            )
            .ok()
    ...
    fn IRemoteAutomationServerStatics<
        R,
        F: FnOnce(&IRemoteAutomationServerStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl RemoteAutomationWindow {
    ...
    pub fn UnregisterAsync(&self) -> windows_core::Result<windows_future::IAsyncAction> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UnregisterAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for RemoteAutomationWindow {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IRemoteAutomationWindow>();
}

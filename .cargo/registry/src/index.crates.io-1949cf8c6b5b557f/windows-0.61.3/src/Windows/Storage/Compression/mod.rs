...
impl Compressor {
        ...
        P0: windows_core::Param<super::Streams::IOutputStream>,
    {
        Self::ICompressorFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateCompressor)(
                windows_core::Interface::as_raw(this),
                underlyingstream.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateCompressorEx<P0>(
        underlyingstream: P0,
        algorithm: CompressAlgorithm,
        blocksize: u32,
    ) -> windows_core::Result<Compressor>
    where
        P0: windows_core::Param<super::Streams::IOutputStream>,
    {
        Self::ICompressorFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateCompressorEx)(
                windows_core::Interface::as_raw(this),
                underlyingstream.param().abi(),
                algorithm,
                blocksize,
    ...
    fn ICompressorFactory<R, F: FnOnce(&ICompressorFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<Compressor, ICompressorFactory> =
...
impl windows_core::RuntimeType for Compressor {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, ICompressor>();
}
#[cfg(feature = "Storage_Streams")]
...
impl Decompressor {
        ...
        P0: windows_core::Param<super::Streams::IInputStream>,
    {
        Self::IDecompressorFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateDecompressor)(
                windows_core::Interface::as_raw(this),
                underlyingstream.param().abi(),
                &mut result__,
            )
    ...
    fn IDecompressorFactory<R, F: FnOnce(&IDecompressorFactory) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<Decompressor, IDecompressorFactory> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl windows_core::RuntimeType for Decompressor {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDecompressor>();
}
#[cfg(feature = "Storage_Streams")]
...
windows_core::imp::define_interface!(
    ICompressor,
    ICompressor_Vtbl,
    0x0ac3645a_57ac_4ee1_b702_84d39d5424e0
);
#[cfg(feature = "Storage_Streams")]
...
windows_core::imp::define_interface!(
    ICompressorFactory,
    ICompressorFactory_Vtbl,
    0x5f3d96a4_2cfb_442c_a8ba_d7d11b039da0
);
...
pub struct ICompressorFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Storage_Streams")]
    pub CreateCompressor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub CreateCompressorEx: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        CompressAlgorithm,
        u32,
...
windows_core::imp::define_interface!(
    IDecompressor,
    IDecompressor_Vtbl,
    0xb883fe46_d68a_4c8b_ada0_4ee813fc5283
);
#[cfg(feature = "Storage_Streams")]
...
pub struct IDecompressorFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "Storage_Streams")]
    pub CreateDecompressor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,

...
impl BasicProperties {
    ...
    pub fn DateModified(&self) -> windows_core::Result<super::super::Foundation::DateTime> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DateModified)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ItemDate(&self) -> windows_core::Result<super::super::Foundation::DateTime> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ItemDate)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn RetrievePropertiesAsync<P0>(
        &self,
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SavePropertiesAsync)(
                windows_core::Interface::as_raw(this),
                propertiestosave.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn SavePropertiesAsyncOverloadDefault(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncAction> {
        let this = &windows_core::Interface::cast::<IStorageItemExtraProperties>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SavePropertiesAsyncOverloadDefault)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for BasicProperties {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IBasicProperties>();
}
...
impl windows_core::RuntimeType for DocumentProperties {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IDocumentProperties>();
}
...
impl GeotagHelper {
    ...
    pub fn GetGeotagAsync<P0>(
        file: P0,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<super::super::Devices::Geolocation::Geopoint>,
    >
    where
        P0: windows_core::Param<super::IStorageFile>,
    {
        Self::IGeotagHelperStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetGeotagAsync)(
                windows_core::Interface::as_raw(this),
                file.param().abi(),
                &mut result__,
            )
        ...
        P1: windows_core::Param<super::super::Devices::Geolocation::Geolocator>,
    {
        Self::IGeotagHelperStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetGeotagFromGeolocatorAsync)(
                windows_core::Interface::as_raw(this),
                file.param().abi(),
                geolocator.param().abi(),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        })
        ...
        P1: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    {
        Self::IGeotagHelperStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetGeotagAsync)(
                windows_core::Interface::as_raw(this),
                file.param().abi(),
                geopoint.param().abi(),
                &mut result__,
    ...
    fn IGeotagHelperStatics<R, F: FnOnce(&IGeotagHelperStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<GeotagHelper, IGeotagHelperStatics> =
...
windows_core::imp::define_interface!(
    IBasicProperties,
    IBasicProperties_Vtbl,
    0xd05d55db_785e_4a66_be02_9beec58aea81
);
...
pub struct IBasicProperties_Vtbl {
    ...
    pub DateModified: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::DateTime,
    ) -> windows_core::HRESULT,
    pub ItemDate: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::super::Foundation::DateTime,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IDocumentProperties,
    IDocumentProperties_Vtbl,
    0x7eab19bc_1821_4923_b4a9_0aea404d0070
);
...
windows_core::imp::define_interface!(
    ...
    IGeotagHelperStatics_Vtbl,
    0x41493244_2524_4655_86a6_ed16f5fc716b
);
...
pub struct IGeotagHelperStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(all(feature = "Devices_Geolocation", feature = "Storage_Streams"))]
    pub GetGeotagAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Storage_Streams"))]
    pub SetGeotagFromGeolocatorAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Storage_Streams"))]
    pub SetGeotagAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    IImageProperties,
    IImageProperties_Vtbl,
    0x523c9424_fcff_4275_afee_ecdb9ab47973
);
...
pub struct IImageProperties_Vtbl {
    ...
    pub SetDateTaken: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ...
    pub Latitude: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Longitude: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetCameraManufacturer: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetCameraModel: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Orientation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut PhotoOrientation,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IMusicProperties,
    IMusicProperties_Vtbl,
    0xbc8aab62_66ec_419a_bc5d_ca65a4cb46da
);
...
pub struct IMusicProperties_Vtbl {
    ...
    pub SetAlbum: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub Composers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Conductors: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub Producers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub SetPublisher: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Writers: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IStorageItemContentProperties_Vtbl,
    0x05294bad_bc38_48bf_85d7_770e0e2ae0ba
);
...
pub struct IStorageItemContentProperties_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub GetMusicPropertiesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetVideoPropertiesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetImagePropertiesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub GetDocumentPropertiesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    0xc54361b2_54cd_432b_bdbc_4b19c4b470d7
);
...
pub trait IStorageItemExtraProperties_Impl: windows_core::IUnknownImpl {
    ...
    fn SavePropertiesAsync(
        &self,
        propertiesToSave: windows_core::Ref<
            '_,
            windows_collections::IIterable<
                windows_collections::IKeyValuePair<
                    windows_core::HSTRING,
...
impl IStorageItemExtraProperties_Vtbl {
    pub const fn new<Identity: IStorageItemExtraProperties_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RetrievePropertiesAsync<
        ...
        >(
            ...
            unsafe {
                ...
                match IStorageItemExtraProperties_Impl::RetrievePropertiesAsync(
                    this,
        ...
        unsafe extern "system" fn SavePropertiesAsync<
            Identity: IStorageItemExtraProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            propertiestosave: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IStorageItemExtraProperties_Impl::SavePropertiesAsync(
                    this,
                    core::mem::transmute_copy(&propertiestosave),
                ) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
        ...
        unsafe extern "system" fn SavePropertiesAsyncOverloadDefault<
            Identity: IStorageItemExtraProperties_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        Self {
            ...
            SavePropertiesAsyncOverloadDefault: SavePropertiesAsyncOverloadDefault::<
                Identity,
                OFFSET,
            >,
        }
...
pub struct IStorageItemExtraProperties_Vtbl {
    ...
    pub SavePropertiesAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub SavePropertiesAsyncOverloadDefault: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IThumbnailProperties_Vtbl,
    0x693dd42f_dbe7_49b5_b3b3_2893ac5d3423
);
...
windows_core::imp::define_interface!(
    ...
    0x719ae507_68de_4db8_97de_49998c059f2f
);
...
pub struct IVideoProperties_Vtbl {
    ...
    pub Bitrate:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub Directors: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub Orientation: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut VideoOrientation,
    ) -> windows_core::HRESULT,
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl ImageProperties {
    ...
    pub fn SetRating(&self, value: u32) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetRating)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SetDateTaken(
        ...
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetDateTaken)(
                windows_core::Interface::as_raw(this),
                value,
            )
            .ok()
    ...
    pub fn SetCameraManufacturer(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetCameraManufacturer)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn SetCameraModel(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetCameraModel)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
...
impl windows_core::RuntimeType for ImageProperties {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IImageProperties>();
}
...
impl MusicProperties {
    ...
    pub fn SetAlbum(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetAlbum)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn Composers(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Composers)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Conductors(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Conductors)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Producers(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Producers)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SetPublisher(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetPublisher)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(value),
            )
            .ok()
    ...
    pub fn Writers(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Writers)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for MusicProperties {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IMusicProperties>();
}
...
impl StorageItemContentProperties {
    pub fn GetMusicPropertiesAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<MusicProperties>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetMusicPropertiesAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetVideoPropertiesAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<VideoProperties>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetVideoPropertiesAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetImagePropertiesAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<ImageProperties>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetImagePropertiesAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetDocumentPropertiesAsync(
        &self,
    ) -> windows_core::Result<windows_future::IAsyncOperation<DocumentProperties>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDocumentPropertiesAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for StorageItemContentProperties {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IStorageItemContentProperties>();
}
...
windows_core::imp::required_hierarchy!(
    ...
    super::Streams::IInputStream,
    super::Streams::IOutputStream,
...
impl StorageItemThumbnail {
    ...
    pub fn ReadAsync<P0>(
        ...
        windows_future::IAsyncOperationWithProgress<super::Streams::IBuffer, u32>,
    >
    where
    ...
    pub fn GetInputStreamAt(
        &self,
        position: u64,
    ) -> windows_core::Result<super::Streams::IInputStream> {
        let this = &windows_core::Interface::cast::<super::Streams::IRandomAccessStream>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetOutputStreamAt(
        &self,
        position: u64,
    ) -> windows_core::Result<super::Streams::IOutputStream> {
        let this = &windows_core::Interface::cast::<super::Streams::IRandomAccessStream>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OriginalWidth(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).OriginalWidth)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn OriginalHeight(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).OriginalHeight)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn ReturnedSmallerCachedSize(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReturnedSmallerCachedSize)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
unsafe impl windows_core::Interface for StorageItemThumbnail {
    type Vtable =
        <super::Streams::IRandomAccessStreamWithContentType as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <super::Streams::IRandomAccessStreamWithContentType as windows_core::Interface>::IID;
}
#[cfg(feature = "Storage_Streams")]
...
impl VideoProperties {
    ...
    pub fn Directors(
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Directors)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
impl windows_core::RuntimeType for VideoProperties {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IVideoProperties>();
}

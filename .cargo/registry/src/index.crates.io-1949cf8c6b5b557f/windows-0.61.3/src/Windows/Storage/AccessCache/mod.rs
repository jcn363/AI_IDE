...
impl windows_core::RuntimeType for AccessCacheOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Storage.AccessCache.AccessCacheOptions;u4)",
    );
}
impl AccessCacheOptions {
...
impl windows_core::RuntimeType for AccessListEntry {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"struct(Windows.Storage.AccessCache.AccessListEntry;string;string)",
    );
}
#[repr(transparent)]
...
windows_core::imp::interface_hierarchy!(
    ...
    windows_collections::IVectorView<AccessListEntry>
);
windows_core::imp::required_hierarchy!(
    AccessListEntryView,
    windows_collections::IIterable<AccessListEntry>
);
impl AccessListEntryView {
    pub fn First(&self) -> windows_core::Result<windows_collections::IIterator<AccessListEntry>> {
        let this = &windows_core::Interface::cast::<windows_collections::IIterable<AccessListEntry>>(
            self,
        )?;
        unsafe {
...
unsafe impl windows_core::Interface for AccessListEntryView {
    type Vtable =
        <windows_collections::IVectorView<AccessListEntry> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <windows_collections::IVectorView<AccessListEntry> as windows_core::Interface>::IID;
}
...
windows_core::imp::define_interface!(
    ...
    IItemRemovedEventArgs_Vtbl,
    0x59677e5c_55be_4c66_ba66_5eaea79d2631
);
...
pub struct IItemRemovedEventArgs_Vtbl {
    ...
    pub RemovedEntry: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::mem::MaybeUninit<AccessListEntry>,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IStorageApplicationPermissionsStatics,
    IStorageApplicationPermissionsStatics_Vtbl,
    0x4391dfaa_d033_48f9_8060_3ec847d2e3f1
);
...
pub struct IStorageApplicationPermissionsStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub FutureAccessList: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub MostRecentlyUsedList: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IStorageApplicationPermissionsStatics2_Vtbl,
    0x072716ec_aa05_4294_9a11_1a3d04519ad0
);
...
pub struct IStorageApplicationPermissionsStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(feature = "System")]
    pub GetFutureAccessListForUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "System")]
    pub GetMostRecentlyUsedListForUser: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    0x2caff6ad_de90_47f5_b2c3_dd36c9fdd453
);
...
impl IStorageItemAccessList {
    pub fn AddOverloadDefaultMetadata<P0>(
        &self,
        file: P0,
        ...
        P0: windows_core::Param<super::IStorageItem>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AddOverloadDefaultMetadata)(
                windows_core::Interface::as_raw(this),
                file.param().abi(),
                &mut result__,
            )
    ...
    pub fn AddOrReplaceOverloadDefaultMetadata<P1>(
        &self,
        ...
        P1: windows_core::Param<super::IStorageItem>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AddOrReplaceOverloadDefaultMetadata)(
                windows_core::Interface::as_raw(this),
        ...
        P1: windows_core::Param<super::IStorageItem>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).AddOrReplace)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(token),
                file.param().abi(),
                core::mem::transmute_copy(metadata),
    ...
    pub fn GetItemWithOptionsAsync(
        &self,
        token: &windows_core::HSTRING,
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetItemWithOptionsAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(token),
                options,
                &mut result__,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetFileWithOptionsAsync(
        &self,
        token: &windows_core::HSTRING,
        options: AccessCacheOptions,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::StorageFile>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetFileWithOptionsAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(token),
                options,
                &mut result__,
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn GetFolderWithOptionsAsync(
        &self,
        token: &windows_core::HSTRING,
        options: AccessCacheOptions,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::StorageFolder>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetFolderWithOptionsAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(token),
                options,
                &mut result__,
    ...
    pub fn ContainsItem(&self, token: &windows_core::HSTRING) -> windows_core::Result<bool> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ContainsItem)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(token),
                &mut result__,
            )
    ...
    pub fn Entries(&self) -> windows_core::Result<AccessListEntryView> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Entries)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn MaximumItemsAllowed(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MaximumItemsAllowed)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl IStorageItemAccessList_Vtbl {
    pub const fn new<Identity: IStorageItemAccessList_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AddOverloadDefaultMetadata<
        ...
        >(
            ...
            unsafe {
                ...
                match IStorageItemAccessList_Impl::AddOverloadDefaultMetadata(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IStorageItemAccessList_Impl::Add(
                    this,
                    core::mem::transmute_copy(&file),
        ...
        unsafe extern "system" fn AddOrReplaceOverloadDefaultMetadata<
            Identity: IStorageItemAccessList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IStorageItemAccessList_Impl::AddOrReplaceOverloadDefaultMetadata(
                    this,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IStorageItemAccessList_Impl::AddOrReplace(
                    this,
                    core::mem::transmute(&token),
                    core::mem::transmute_copy(&file),
                    core::mem::transmute(&metadata),
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IStorageItemAccessList_Impl::GetFolderAsync(
                    this,
                    core::mem::transmute(&token),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetItemWithOptionsAsync<
            Identity: IStorageItemAccessList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IStorageItemAccessList_Impl::GetItemWithOptionsAsync(
                    this,
                    core::mem::transmute(&token),
                    options,
                ) {
        ...
        unsafe extern "system" fn GetFileWithOptionsAsync<
            Identity: IStorageItemAccessList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IStorageItemAccessList_Impl::GetFileWithOptionsAsync(
                    this,
                    core::mem::transmute(&token),
                    options,
                ) {
        ...
        unsafe extern "system" fn GetFolderWithOptionsAsync<
            Identity: IStorageItemAccessList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IStorageItemAccessList_Impl::GetFolderWithOptionsAsync(
                    this,
                    core::mem::transmute(&token),
                    options,
                ) {
        ...
        unsafe extern "system" fn ContainsItem<
            Identity: IStorageItemAccessList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IStorageItemAccessList_Impl::CheckAccess(
                    this,
                    core::mem::transmute_copy(&file),
                ) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn Entries<
            Identity: IStorageItemAccessList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn MaximumItemsAllowed<
            Identity: IStorageItemAccessList_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
        ...
        Self {
            ...
            AddOrReplaceOverloadDefaultMetadata: AddOrReplaceOverloadDefaultMetadata::<
                Identity,
                OFFSET,
            >,
...
pub struct IStorageItemAccessList_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AddOverloadDefaultMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    ...
    pub AddOrReplaceOverloadDefaultMetadata: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    )
        -> windows_core::HRESULT,
    pub AddOrReplace: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub GetItemWithOptionsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        AccessCacheOptions,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub GetFileWithOptionsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        AccessCacheOptions,
        *mut *mut core::ffi::c_void,
    ...
    #[cfg(feature = "Storage_Search")]
    pub GetFolderWithOptionsAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        AccessCacheOptions,
        *mut *mut core::ffi::c_void,
    ...
    pub ContainsItem: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut bool,
    ) -> windows_core::HRESULT,
    ...
    pub Entries: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub MaximumItemsAllowed:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IStorageItemMostRecentlyUsedList,
    IStorageItemMostRecentlyUsedList_Vtbl,
    0x016239d5_510d_411e_8cf1_c3d1effa4c33
);
...
pub struct IStorageItemMostRecentlyUsedList_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub ItemRemoved: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut i64,
    ) -> windows_core::HRESULT,
    pub RemoveItemRemoved:
        unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IStorageItemMostRecentlyUsedList2,
    IStorageItemMostRecentlyUsedList2_Vtbl,
    0xda481ea0_ed8d_4731_a1db_e44ee2204093
);
...
pub struct IStorageItemMostRecentlyUsedList2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub AddWithMetadataAndVisibility: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
    ...
    pub AddOrReplaceWithMetadataAndVisibility: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
...
impl ItemRemovedEventArgs {
    pub fn RemovedEntry(&self) -> windows_core::Result<AccessListEntry> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemovedEntry)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| core::mem::transmute(result__))
...
impl windows_core::RuntimeType for ItemRemovedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IItemRemovedEventArgs>();
}
...
impl windows_core::RuntimeType for RecentStorageItemVisibility {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Storage.AccessCache.RecentStorageItemVisibility;i4)",
    );
}
...
impl StorageApplicationPermissions {
    pub fn FutureAccessList() -> windows_core::Result<StorageItemAccessList> {
        Self::IStorageApplicationPermissionsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FutureAccessList)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn MostRecentlyUsedList() -> windows_core::Result<StorageItemMostRecentlyUsedList> {
        Self::IStorageApplicationPermissionsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MostRecentlyUsedList)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::super::System::User>,
    {
        Self::IStorageApplicationPermissionsStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetFutureAccessListForUser)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                &mut result__,
            )
    ...
    pub fn GetMostRecentlyUsedListForUser<P0>(
        user: P0,
    ) -> windows_core::Result<StorageItemMostRecentlyUsedList>
    where
        P0: windows_core::Param<super::super::System::User>,
    {
        Self::IStorageApplicationPermissionsStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetMostRecentlyUsedListForUser)(
                windows_core::Interface::as_raw(this),
                user.param().abi(),
                &mut result__,
            )
    ...
    fn IStorageApplicationPermissionsStatics<
        R,
        F: FnOnce(&IStorageApplicationPermissionsStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ...
    fn IStorageApplicationPermissionsStatics2<
        R,
        F: FnOnce(&IStorageApplicationPermissionsStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<
...
impl windows_core::RuntimeType for StorageItemAccessList {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IStorageItemAccessList>();
}
...
impl StorageItemMostRecentlyUsedList {
        ...
        >,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ItemRemoved)(
                windows_core::Interface::as_raw(this),
                handler.param().abi(),
                &mut result__,
            )
    ...
    pub fn RemoveItemRemoved(&self, eventcookie: i64) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).RemoveItemRemoved)(
                windows_core::Interface::as_raw(this),
                eventcookie,
            )
            .ok()
    ...
    pub fn AddWithMetadataAndVisibility<P0>(
        &self,
        file: P0,
        metadata: &windows_core::HSTRING,
        ...
        P0: windows_core::Param<super::IStorageItem>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AddWithMetadataAndVisibility)(
                windows_core::Interface::as_raw(this),
                file.param().abi(),
                core::mem::transmute_copy(metadata),
                visibility,
    ...
    pub fn AddOrReplaceWithMetadataAndVisibility<P1>(
        &self,
        token: &windows_core::HSTRING,
        file: P1,
        metadata: &windows_core::HSTRING,
        ...
        P1: windows_core::Param<super::IStorageItem>,
    {
        let this = &windows_core::Interface::cast::<IStorageItemMostRecentlyUsedList2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).AddOrReplaceWithMetadataAndVisibility)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(token),
                file.param().abi(),
                core::mem::transmute_copy(metadata),
...
impl windows_core::RuntimeType for StorageItemMostRecentlyUsedList {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IStorageItemMostRecentlyUsedList>();
}
unsafe impl windows_core::Interface for StorageItemMostRecentlyUsedList {
    ...
    const IID: windows_core::GUID =
        <IStorageItemMostRecentlyUsedList as windows_core::Interface>::IID;
}

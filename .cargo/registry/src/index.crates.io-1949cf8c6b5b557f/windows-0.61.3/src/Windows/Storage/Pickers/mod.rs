...
unsafe impl windows_core::Interface for FileExtensionVector {
    type Vtable =
        <windows_collections::IVector<windows_core::HSTRING> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <windows_collections::IVector<windows_core::HSTRING> as windows_core::Interface>::IID;
}
...
impl FileOpenPicker {
    ...
    pub fn PickSingleFileAndContinue(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IFileOpenPicker2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).PickSingleFileAndContinue)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    pub fn PickMultipleFilesAndContinue(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IFileOpenPicker2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).PickMultipleFilesAndContinue)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    pub fn ResumePickSingleFileAsync(
        ...
        Self::IFileOpenPickerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResumePickSingleFileAsync)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn PickSingleFileAsync2(
        &self,
        pickeroperationid: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_future::IAsyncOperation<super::StorageFile>> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).PickSingleFileAsync)(
                windows_core::Interface::as_raw(this),
                core::mem::transmute_copy(pickeroperationid),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    fn IFileOpenPickerStatics<R, F: FnOnce(&IFileOpenPickerStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<FileOpenPicker, IFileOpenPickerStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IFileOpenPickerStatics2<
        R,
        F: FnOnce(&IFileOpenPickerStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<FileOpenPicker, IFileOpenPickerStatics2> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
windows_core::imp::interface_hierarchy!(
    ...
    windows_core::IUnknown,
    windows_core::IInspectable,
    windows_collections::IVectorView<super::StorageFile>
);
#[cfg(feature = "Storage_Streams")]
windows_core::imp::required_hierarchy!(
    FilePickerSelectedFilesArray,
    windows_collections::IIterable<super::StorageFile>
);
#[cfg(feature = "Storage_Streams")]
impl FilePickerSelectedFilesArray {
    pub fn First(
        &self,
    ) -> windows_core::Result<windows_collections::IIterator<super::StorageFile>> {
        let this = &windows_core::Interface::cast::<
            windows_collections::IIterable<super::StorageFile>,
        >(self)?;
        unsafe {
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [Option<super::StorageFile>],
    ) -> windows_core::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
unsafe impl windows_core::Interface for FilePickerSelectedFilesArray {
    type Vtable =
        <windows_collections::IVectorView<super::StorageFile> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <windows_collections::IVectorView<super::StorageFile> as windows_core::Interface>::IID;
}
#[cfg(feature = "Storage_Streams")]
...
impl FileSavePicker {
    ...
    pub fn SuggestedSaveFile(&self) -> windows_core::Result<super::StorageFile> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SuggestedSaveFile)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        ...
        P0: windows_core::Param<super::StorageFile>,
    {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).SetSuggestedSaveFile)(
                windows_core::Interface::as_raw(this),
                value.param().abi(),
            )
            .ok()
    ...
    pub fn PickSaveFileAndContinue(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IFileSavePicker2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).PickSaveFileAndContinue)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    fn IFileSavePickerStatics<R, F: FnOnce(&IFileSavePickerStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<FileSavePicker, IFileSavePickerStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
impl FolderPicker {
    ...
    pub fn PickFolderAndContinue(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IFolderPicker2>(self)?;
        unsafe {
            (windows_core::Interface::vtable(this).PickFolderAndContinue)(
                windows_core::Interface::as_raw(this),
            )
            .ok()
        }
    ...
    fn IFolderPickerStatics<R, F: FnOnce(&IFolderPickerStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<FolderPicker, IFolderPickerStatics> =
            windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
}
...
windows_core::imp::define_interface!(
    ...
    0x2ca8278a_12c5_4c5f_8977_94547793c241
);
...
windows_core::imp::define_interface!(
    ...
    0x8ceb6cd2_b446_46f7_b265_90f8e55ad650
);
...
pub struct IFileOpenPicker2_Vtbl {
    ...
    #[cfg(feature = "deprecated")]
    pub PickSingleFileAndContinue:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "deprecated"))]
    PickSingleFileAndContinue: usize,
    #[cfg(feature = "deprecated")]
    pub PickMultipleFilesAndContinue:
        unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "deprecated"))]
...
windows_core::imp::define_interface!(
    IFileOpenPicker3,
    IFileOpenPicker3_Vtbl,
    0xd9a5c5b3_c5dc_5b98_bd80_a8d0ca0584d8
);
...
windows_core::imp::define_interface!(
    ...
    IFileOpenPickerStatics_Vtbl,
    0x6821573b_2f02_4833_96d4_abbfad72b67b
);
...
pub struct IFileOpenPickerStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(all(feature = "Storage_Streams", feature = "deprecated"))]
    pub ResumePickSingleFileAsync: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    ...
    IFileOpenPickerStatics2_Vtbl,
    0xe8917415_eddd_5c98_b6f3_366fdfcad392
);
...
windows_core::imp::define_interface!(
    ...
    0x3f57b569_2522_4ca5_aa73_a15509f1fcbf
);
...
windows_core::imp::define_interface!(
    ...
    0x0ec313a2_d24b_449a_8197_e89104fd42cc
);
...
windows_core::imp::define_interface!(
    IFileSavePicker3,
    IFileSavePicker3_Vtbl,
    0x698aec69_ba3c_4e51_bd90_4abcbbf4cfaf
);
...
windows_core::imp::define_interface!(
    IFileSavePicker4,
    IFileSavePicker4_Vtbl,
    0xe7d83a5a_ddfa_5de0_8b70_c842c21988ec
);
...
windows_core::imp::define_interface!(
    IFolderPicker,
    IFolderPicker_Vtbl,
    0x084f7799_f3fb_400a_99b1_7b4a772fd60d
);
...
windows_core::imp::define_interface!(
    IFolderPicker2,
    IFolderPicker2_Vtbl,
    0x8eb3ba97_dc85_4616_be94_9660881f2f5d
);
...
windows_core::imp::define_interface!(
    IFolderPicker3,
    IFolderPicker3_Vtbl,
    0x673b1e29_d326_53c0_bd24_a25c714cee36
);
...
windows_core::imp::define_interface!(
    ...
    IFolderPickerStatics_Vtbl,
    0x9be34740_7ca1_5942_a3c8_46f2551ecff3
);

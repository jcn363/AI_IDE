...
windows_core::imp::define_interface!(
    ...
    0x87c24804_a22e_4adb_ba26_d78ef639bcf4
);
...
pub struct IPerceptionTimestamp_Vtbl {
    ...
    pub TargetTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::Foundation::DateTime,
    ) -> windows_core::HRESULT,
    pub PredictionAmount: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IPerceptionTimestamp2,
    IPerceptionTimestamp2_Vtbl,
    0xe354b7ed_2bd1_41b7_9ed0_74a15c354537
);
...
pub struct IPerceptionTimestamp2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub SystemRelativeTargetTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::Foundation::TimeSpan,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    ...
    IPerceptionTimestampHelperStatics_Vtbl,
    0x47a611d4_a9df_4edc_855d_f4d339d967ac
);
...
pub struct IPerceptionTimestampHelperStatics_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub FromHistoricalTargetTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
windows_core::imp::define_interface!(
    ...
    IPerceptionTimestampHelperStatics2_Vtbl,
    0x73d1a7fe_3fb9_4571_87d4_3c920a5e86eb
);
...
pub struct IPerceptionTimestampHelperStatics2_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub FromSystemRelativeTargetTime: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
impl PerceptionTimestamp {
    pub fn TargetTime(&self) -> windows_core::Result<super::Foundation::DateTime> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).TargetTime)(
    ...
    pub fn PredictionAmount(&self) -> windows_core::Result<super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PredictionAmount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn SystemRelativeTargetTime(&self) -> windows_core::Result<super::Foundation::TimeSpan> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SystemRelativeTargetTime)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for PerceptionTimestamp {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IPerceptionTimestamp>();
}
...
impl PerceptionTimestampHelper {
    pub fn FromHistoricalTargetTime(
        targettime: super::Foundation::DateTime,
    ) -> windows_core::Result<PerceptionTimestamp> {
        Self::IPerceptionTimestampHelperStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromHistoricalTargetTime)(
                windows_core::Interface::as_raw(this),
                targettime,
                &mut result__,
            )
    ...
    pub fn FromSystemRelativeTargetTime(
        targettime: super::Foundation::TimeSpan,
    ) -> windows_core::Result<PerceptionTimestamp> {
        Self::IPerceptionTimestampHelperStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromSystemRelativeTargetTime)(
                windows_core::Interface::as_raw(this),
                targettime,
                &mut result__,
            )
    ...
    fn IPerceptionTimestampHelperStatics<
        R,
        F: FnOnce(&IPerceptionTimestampHelperStatics) -> windows_core::Result<R>,
    >(
        callback: F,
    ...
    fn IPerceptionTimestampHelperStatics2<
        R,
        F: FnOnce(&IPerceptionTimestampHelperStatics2) -> windows_core::Result<R>,
    >(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<

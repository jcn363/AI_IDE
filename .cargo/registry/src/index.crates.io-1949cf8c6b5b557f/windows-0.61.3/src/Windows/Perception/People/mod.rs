...
impl EyesPose {
    pub fn IsCalibrationValid(&self) -> windows_core::Result<bool> {
        ...
        unsafe {
            ...
            (windows_core::Interface::vtable(this).IsCalibrationValid)(
    ...
    pub fn Gaze(
        &self,
    ) -> windows_core::Result<super::super::Foundation::IReference<super::Spatial::SpatialRay>>
    {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Gaze)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
    ...
    pub fn UpdateTimestamp(&self) -> windows_core::Result<super::PerceptionTimestamp> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UpdateTimestamp)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn RequestAccessAsync() -> windows_core::Result<
        windows_future::IAsyncOperation<super::super::UI::Input::GazeInputAccessStatus>,
    > {
        Self::IEyesPoseStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IEyesPoseStatics<R, F: FnOnce(&IEyesPoseStatics) -> windows_core::Result<R>>(
        callback: F,
    ) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<EyesPose, IEyesPoseStatics> =
...
impl windows_core::RuntimeType for EyesPose {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IEyesPose>();
}
...
impl windows_core::RuntimeType for HandJointKind {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Perception.People.HandJointKind;i4)",
    );
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl HandMeshObserver {
    ...
    pub fn Source(
        &self,
    ) -> windows_core::Result<super::super::UI::Input::Spatial::SpatialInteractionSource> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TriangleIndexCount(&self) -> windows_core::Result<u32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TriangleIndexCount)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
    ...
    pub fn GetVertexStateForPose<P0>(
        &self,
        handpose: P0,
    ) -> windows_core::Result<HandMeshVertexState>
    where
        P0: windows_core::Param<HandPose>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetVertexStateForPose)(
                windows_core::Interface::as_raw(this),
                handpose.param().abi(),
                &mut result__,
            )
    ...
    pub fn NeutralPose(&self) -> windows_core::Result<HandPose> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NeutralPose)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn NeutralPoseVersion(&self) -> windows_core::Result<i32> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NeutralPoseVersion)(
                windows_core::Interface::as_raw(this),
                &mut result__,
            )
            .map(|| result__)
...
impl windows_core::RuntimeType for HandMeshObserver {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHandMeshObserver>();
}
...
impl HandMeshVertexState {
    ...
    pub fn CoordinateSystem(
        &self,
    ) -> windows_core::Result<super::Spatial::SpatialCoordinateSystem> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetVertices(&self, vertices: &mut [HandMeshVertex]) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).GetVertices)(
                windows_core::Interface::as_raw(this),
...
impl windows_core::RuntimeType for HandMeshVertexState {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHandMeshVertexState>();
}
...
impl HandPose {
    ...
    pub fn TryGetJoint<P0>(
        &self,
        coordinatesystem: P0,
        joint: HandJointKind,
        jointpose: &mut JointPose,
        ...
        P0: windows_core::Param<super::Spatial::SpatialCoordinateSystem>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetJoint)(
                windows_core::Interface::as_raw(this),
    ...
    #[cfg(all(feature = "Foundation_Numerics", feature = "Perception_Spatial"))]
    pub fn TryGetJoints<P0>(
        &self,
        coordinatesystem: P0,
        joints: &[HandJointKind],
        jointposes: &mut [JointPose],
    ) -> windows_core::Result<bool>
    where
        P0: windows_core::Param<super::Spatial::SpatialCoordinateSystem>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetJoints)(
                windows_core::Interface::as_raw(this),
                coordinatesystem.param().abi(),
                joints.len().try_into().unwrap(),
                joints.as_ptr(),
                jointposes.len().try_into().unwrap(),
                jointposes.as_mut_ptr(),
                &mut result__,
            )
            .map(|| result__)
        }
    ...
    pub fn GetRelativeJoint(
        &self,
        joint: HandJointKind,
        referencejoint: HandJointKind,
    ) -> windows_core::Result<JointPose> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetRelativeJoint)(
                windows_core::Interface::as_raw(this),
                joint,
                referencejoint,
                &mut result__,
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn GetRelativeJoints(
        &self,
        joints: &[HandJointKind],
        referencejoints: &[HandJointKind],
        jointposes: &mut [JointPose],
    ) -> windows_core::Result<()> {
        let this = self;
        unsafe {
            (windows_core::Interface::vtable(this).GetRelativeJoints)(
                windows_core::Interface::as_raw(this),
                joints.len().try_into().unwrap(),
                joints.as_ptr(),
                referencejoints.len().try_into().unwrap(),
                referencejoints.as_ptr(),
                jointposes.len().try_into().unwrap(),
                jointposes.as_mut_ptr(),
            )
            .ok()
...
impl windows_core::RuntimeType for HandPose {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHandPose>();
}
...
impl windows_core::RuntimeType for HeadPose {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_class::<Self, IHeadPose>();
}
...
windows_core::imp::define_interface!(
    IEyesPose,
    IEyesPose_Vtbl,
    0x682a9b23_8a1e_5b86_a060_906ffacb62a4
);
...
pub struct IEyesPose_Vtbl {
    ...
    pub IsCalibrationValid:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    #[cfg(feature = "Perception_Spatial")]
    pub Gaze: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Perception_Spatial"))]
    Gaze: usize,
    pub UpdateTimestamp: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(
    IEyesPoseStatics,
    IEyesPoseStatics_Vtbl,
    0x1cff7413_b21f_54c0_80c1_e60d994ca58c
);
...
windows_core::imp::define_interface!(
    IHandMeshObserver,
    IHandMeshObserver_Vtbl,
    0x85ae30cb_6fc3_55c4_a7b4_29e33896ca69
);
...
pub struct IHandMeshObserver_Vtbl {
    ...
    Source: usize,
    pub TriangleIndexCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub VertexCount:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    pub GetTriangleIndices:
        unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut u16) -> windows_core::HRESULT,
    pub GetVertexStateForPose: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub NeutralPose: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    pub NeutralPoseVersion:
...
windows_core::imp::define_interface!(
    ...
    IHandMeshVertexState_Vtbl,
    0x046c5fef_1d8b_55de_ab2c_1cd424886d8f
);
...
pub struct IHandMeshVertexState_Vtbl {
    ...
    pub GetVertices: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *mut HandMeshVertex,
    ) -> windows_core::HRESULT,
...
windows_core::imp::define_interface!(
    IHandPose,
    IHandPose_Vtbl,
    0x4d98e79a_bb08_5d09_91de_df0dd3fae46c
);
...
pub struct IHandPose_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    #[cfg(all(feature = "Foundation_Numerics", feature = "Perception_Spatial"))]
    pub TryGetJoint: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        HandJointKind,
        *mut JointPose,
    ...
    TryGetJoint: usize,
    #[cfg(all(feature = "Foundation_Numerics", feature = "Perception_Spatial"))]
    pub TryGetJoints: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        u32,
        *const HandJointKind,
    ...
    TryGetJoints: usize,
    #[cfg(feature = "Foundation_Numerics")]
    pub GetRelativeJoint: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        HandJointKind,
        HandJointKind,
        *mut JointPose,
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub GetRelativeJoints: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        u32,
        *const HandJointKind,
        u32,
...
windows_core::imp::define_interface!(
    IHeadPose,
    IHeadPose_Vtbl,
    0x7f5ac5a5_49db_379f_9429_32a2faf34fa6
);
...
impl windows_core::RuntimeType for JointPoseAccuracy {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(
        b"enum(Windows.Perception.People.JointPoseAccuracy;i4)",
    );
}

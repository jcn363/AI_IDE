...
impl CorePerceptionAutomation {
    ...
    {
        Self::ICorePerceptionAutomationStatics(|this| unsafe {
            (windows_core::Interface::vtable(this).SetActivationFactoryProvider)(
    ...
    fn ICorePerceptionAutomationStatics<
        R,
        F: FnOnce(&ICorePerceptionAutomationStatics) -> windows_core::Result<R>,
    >(
        callback: F,
...
windows_core::imp::define_interface!(
    ICorePerceptionAutomationStatics,
    ICorePerceptionAutomationStatics_Vtbl,
    0x0bb04541_4ce2_4923_9a76_8187ecc59112
);
...
pub struct ICorePerceptionAutomationStatics_Vtbl {
    ...
    pub SetActivationFactoryProvider: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,

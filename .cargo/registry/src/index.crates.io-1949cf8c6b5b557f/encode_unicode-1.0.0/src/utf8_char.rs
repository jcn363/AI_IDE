...
impl From<Utf16Char> for Utf8Char {
    fn from(utf16: Utf16Char) -> Utf8Char {
        match utf16.to_tuple() {
            (ascii @ 0..=0x00_7f, _) => Utf8Char {
                bytes: [ascii as u8, 0, 0, 0],
            },
            (unit @ 0..=0x07_ff, _) => {
            ...
            (first, Some(second)) => {
                ...
                let byte3 = 0x80 | ((second & 0x03_c0) >> 6) as u8 | ((first & 0x00_03) << 4) as u8;
...
impl Utf8Char {
    ...
    pub const fn new(c: char) -> Self {
        if c.is_ascii() {
            ...
            const EXTRA_BYTES: u64 =
                0b11_11_11_11_11__10_10_10_10_10__01_01_01_01__00_00_00_00_00_00_00__00;
    ...
    pub fn from_array(utf8: [u8; 4]) -> Result<Self, Utf8Error> {
        ...
        Ok(Utf8Char {
            bytes: unused_zeroed.to_ne_bytes(),
        })
    }

...
pub(crate) fn parse_constructor_string<R: RegExp>(input: &str) -> Result<UrlPatternInit, Error> {
    let token_list = crate::tokenizer::tokenize(input, crate::tokenizer::TokenizePolicy::Lenient)?;

...
mod bstr {
    ...
    impl fmt::Display for BStr {
        ...
        fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
            ...
            fn write_bstr(f: &mut fmt::Formatter<'_>, bstr: &BStr) -> Result<(), fmt::Error> {
    ...
    impl<'a, 'de: 'a> Deserialize<'de> for &'a BStr {
            ...
            D: Deserializer<'de>,
        {
            ...
            impl<'de> Visitor<'de> for BStrVisitor {
                ...
                #[inline]
                fn visit_borrowed_bytes<E: Error>(self, value: &'de [u8]) -> Result<&'de BStr, E> {
                    Ok(BStr::new(value))
                }

                #[inline]
                fn visit_borrowed_str<E: Error>(self, value: &'de str) -> Result<&'de BStr, E> {
                    Ok(BStr::new(value))
                }
            }
    ...
    impl<'de> Deserialize<'de> for BString {
            ...
            D: Deserializer<'de>,
        {
            ...
            impl<'de> Visitor<'de> for BStringVisitor {
                ...
                #[inline]
                fn visit_seq<V: SeqAccess<'de>>(self, mut visitor: V) -> Result<BString, V::Error> {
    ...
    impl<'de> Deserialize<'de> for Box<BStr> {
            ...
            D: Deserializer<'de>,
        {
            ...
            impl<'de> Visitor<'de> for BoxedBStrVisitor {
                ...
                #[inline]
                fn visit_bytes<E: Error>(self, value: &[u8]) -> Result<Box<BStr>, E> {
                    Ok(BStr::from_boxed_bytes(value.to_vec().into_boxed_slice()))
                }

                #[inline]
                fn visit_byte_buf<E: Error>(self, value: Vec<u8>) -> Result<Box<BStr>, E> {
                    Ok(BStr::from_boxed_bytes(value.into_boxed_slice()))
                }

                #[inline]
                fn visit_str<E: Error>(self, value: &str) -> Result<Box<BStr>, E> {
                ...
                #[inline]
                fn visit_string<E: Error>(self, value: String) -> Result<Box<BStr>, E> {
                    Ok(BStr::from_boxed_bytes(

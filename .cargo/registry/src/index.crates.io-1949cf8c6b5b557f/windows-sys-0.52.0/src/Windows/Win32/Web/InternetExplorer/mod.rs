...
pub const AnchorClick: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x13d5413c_33b9_11d2_95a7_00c04f8ecb02);
pub const CATID_MSOfficeAntiVirus: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x56ffcc30_d398_11d0_b2ae_00a0c908fa49);
pub const CDeviceRect: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x3050f6d4_98b5_11cf_bb82_00aa00bdce0b);
pub const CDownloadBehavior: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x3050f5be_98b5_11cf_bb82_00aa00bdce0b);
pub const CHeaderFooter: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x3050f6cd_98b5_11cf_bb82_00aa00bdce0b);
pub const CLayoutRect: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x3050f664_98b5_11cf_bb82_00aa00bdce0b);
pub const COLOR_NO_TRANSPARENT: u32 = 4294967295u32;
pub const CPersistDataPeer: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x3050f487_98b5_11cf_bb82_00aa00bdce0b);
pub const CPersistHistory: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x3050f4c8_98b5_11cf_bb82_00aa00bdce0b);
pub const CPersistShortcut: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x3050f4c6_98b5_11cf_bb82_00aa00bdce0b);
pub const CPersistSnapshot: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x3050f4c9_98b5_11cf_bb82_00aa00bdce0b);
pub const CPersistUserData: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x3050f48e_98b5_11cf_bb82_00aa00bdce0b);
pub const CoDitherToRGB8: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xa860ce50_3910_11d0_86fc_00a0c913f750);
pub const CoMapMIMEToCLSID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x30c3b080_30fb_11d0_b724_00aa006c1a01);
pub const CoSniffStream: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x6a01fda0_30df_11d0_b724_00aa006c1a01);
...
pub const HomePage: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x766bf2ae_d650_11d1_9811_00c04fc31d2e);
pub const HomePageSetting: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x374cede0_873a_4c4f_bc86_bcc8cf5116a3);
...
pub const IEGetProcessModule_PROC_NAME: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("IEGetProcessModule");
pub const IEGetTabWindowExports_PROC_NAME: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("IEGetTabWindowExports");
...
pub const IEPROCESS_MODULE_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("IERtUtil.dll");
pub const IEWebDriverManager: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x90314af2_5250_47b3_89d8_6295fc23bc22);
pub const IE_USE_OE_MAIL_HKEY: i32 = -2147483647i32;
pub const IE_USE_OE_MAIL_KEY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Software\\Microsoft\\Internet Explorer\\Mail");
pub const IE_USE_OE_MAIL_VALUE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Use Outlook Express");
pub const IE_USE_OE_NEWS_HKEY: i32 = -2147483647i32;
pub const IE_USE_OE_NEWS_KEY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Software\\Microsoft\\Internet Explorer\\News");
pub const IE_USE_OE_NEWS_VALUE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Use Outlook Express");
pub const IE_USE_OE_PRESENT_HKEY: i32 = -2147483646i32;
pub const IE_USE_OE_PRESENT_KEY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Software\\Microsoft\\Windows\\CurrentVersion\\app.paths\\msimn.exe");
...
pub const IntelliForms: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x613ab92e_16bf_11d2_bca5_00c04fd929db);
pub const InternetExplorerManager: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xdf4fcc34_067a_4e0a_8352_4a1a5095346e);
...
pub const OpenServiceActivityManager: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xc5efd803_50f8_43cd_9ab8_aafc1394c9e0);
pub const OpenServiceManager: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x098870b6_39ea_480b_b8b5_dd0167c4db59);
pub const PeerFactory: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x3050f4cf_98b5_11cf_bb82_00aa00bdce0b);
...
pub const REGSTR_PATH_INETCPL_RESTRICTIONS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Software\\Policies\\Microsoft\\Internet Explorer\\Control Panel");
pub const REGSTR_PATH_MIME_DATABASE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MIME\\Database");
pub const REGSTR_PATH_REMOTEACCESS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("RemoteAccess");
pub const REGSTR_PATH_REMOTEACESS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("RemoteAccess");
pub const REGSTR_SHIFTQUICKSUFFIX: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ShiftQuickCompleteSuffix");
pub const REGSTR_VAL_ACCEPT_LANGUAGE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AcceptLanguage");
pub const REGSTR_VAL_ACCESSMEDIUM: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AccessMedium");
pub const REGSTR_VAL_ACCESSTYPE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AccessType");
pub const REGSTR_VAL_ALIASTO: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AliasForCharset");
pub const REGSTR_VAL_ANCHORCOLOR: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Anchor Color");
pub const REGSTR_VAL_ANCHORCOLORHOVER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Anchor Color Hover");
pub const REGSTR_VAL_ANCHORCOLORVISITED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Anchor Color Visited");
pub const REGSTR_VAL_ANCHORUNDERLINE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Anchor Underline");
pub const REGSTR_VAL_AUTODETECT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AutoDetect");
pub const REGSTR_VAL_AUTODIALDLLNAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AutodialDllName");
pub const REGSTR_VAL_AUTODIALFCNNAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AutodialFcnName");
pub const REGSTR_VAL_AUTODIAL_MONITORCLASSNAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MS_AutodialMonitor");
pub const REGSTR_VAL_AUTODIAL_TRYONLYONCE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("TryAutodialOnce");
pub const REGSTR_VAL_AUTONAVIGATE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SearchForExtensions");
pub const REGSTR_VAL_AUTOSEARCH: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Do404Search");
pub const REGSTR_VAL_BACKBITMAP: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("BackBitmap");
pub const REGSTR_VAL_BACKGROUNDCOLOR: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Background Color");
pub const REGSTR_VAL_BODYCHARSET: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("BodyCharset");
pub const REGSTR_VAL_BYPASSAUTOCONFIG: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("BypassAutoconfig");
pub const REGSTR_VAL_CACHEPREFIX: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CachePrefix");
pub const REGSTR_VAL_CHECKASSOC: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Check_Associations");
pub const REGSTR_VAL_CODEDOWNLOAD: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Code Download");
...
pub const REGSTR_VAL_COVEREXCLUDE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CoverExclude");
pub const REGSTR_VAL_DAYSTOKEEP: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DaysToKeep");
pub const REGSTR_VAL_DEFAULT_CODEPAGE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Default_CodePage");
pub const REGSTR_VAL_DEFAULT_SCRIPT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Default_Script");
pub const REGSTR_VAL_DEF_ENCODING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Default_Encoding");
pub const REGSTR_VAL_DEF_INETENCODING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Default_InternetEncoding");
pub const REGSTR_VAL_DESCRIPTION: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Description");
pub const REGSTR_VAL_DIRECTORY: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("Directory");
pub const REGSTR_VAL_DISCONNECTIDLETIME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DisconnectIdleTime");
pub const REGSTR_VAL_ENABLEAUTODIAL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("EnableAutodial");
pub const REGSTR_VAL_ENABLEAUTODIALDISCONNECT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("EnableAutodisconnect");
pub const REGSTR_VAL_ENABLEAUTODISCONNECT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("EnableAutodisconnect");
pub const REGSTR_VAL_ENABLEEXITDISCONNECT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("EnableExitDisconnect");
pub const REGSTR_VAL_ENABLESECURITYCHECK: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("EnableSecurityCheck");
pub const REGSTR_VAL_ENABLEUNATTENDED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("EnableUnattended");
pub const REGSTR_VAL_ENCODENAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("EncodingName");
pub const REGSTR_VAL_FAMILY: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("Family");
pub const REGSTR_VAL_FIXEDWIDTHFONT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("FixedWidthFont");
pub const REGSTR_VAL_FIXED_FONT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("IEFixedFontName");
...
pub const REGSTR_VAL_FONT_SCRIPT_NAME: ::windows_sys::core::PCWSTR =
...
pub const REGSTR_VAL_HEADERCHARSET: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("HeaderCharset");
pub const REGSTR_VAL_HTTP_ERRORS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Friendly http errors");
pub const REGSTR_VAL_IE_CUSTOMCOLORS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Custom Colors");
pub const REGSTR_VAL_INETCPL_ADVANCEDTAB: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AdvancedTab");
pub const REGSTR_VAL_INETCPL_CONNECTIONSTAB: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ConnectionsTab");
pub const REGSTR_VAL_INETCPL_CONTENTTAB: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ContentTab");
pub const REGSTR_VAL_INETCPL_GENERALTAB: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("GeneralTab");
pub const REGSTR_VAL_INETCPL_IEAK: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("IEAKContext");
pub const REGSTR_VAL_INETCPL_PRIVACYTAB: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PrivacyTab");
pub const REGSTR_VAL_INETCPL_PROGRAMSTAB: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProgramsTab");
pub const REGSTR_VAL_INETCPL_SECURITYTAB: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SecurityTab");
pub const REGSTR_VAL_INETENCODING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("InternetEncoding");
pub const REGSTR_VAL_INTERNETENTRY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("InternetProfile");
pub const REGSTR_VAL_INTERNETENTRYBKUP: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("BackupInternetProfile");
pub const REGSTR_VAL_INTERNETPROFILE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("InternetProfile");
...
pub const REGSTR_VAL_JAVALOGGING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("EnableLogging");
pub const REGSTR_VAL_JAVALOGGING_DEF: u32 = 0u32;
pub const REGSTR_VAL_LEVEL: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("Level");
pub const REGSTR_VAL_LOADIMAGES: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Display Inline Images");
pub const REGSTR_VAL_LOCALPAGE: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("Local Page");
pub const REGSTR_VAL_MOSDISCONNECT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DisconnectTimeout");
pub const REGSTR_VAL_NEWDIRECTORY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("NewDirectory");
pub const REGSTR_VAL_NONETAUTODIAL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("NoNetAutodial");
pub const REGSTR_VAL_PLAYSOUNDS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Play_Background_Sounds");
pub const REGSTR_VAL_PLAYVIDEOS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Display Inline Videos");
pub const REGSTR_VAL_PRIVCONVERTER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PrivConverter");
pub const REGSTR_VAL_PROPORTIONALFONT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProportionalFont");
pub const REGSTR_VAL_PROP_FONT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("IEPropFontName");
pub const REGSTR_VAL_PROXYENABLE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProxyEnable");
pub const REGSTR_VAL_PROXYOVERRIDE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProxyOverride");
pub const REGSTR_VAL_PROXYSERVER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProxyServer");
pub const REGSTR_VAL_REDIALATTEMPTS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("RedialAttempts");
pub const REGSTR_VAL_REDIALINTERVAL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("RedialWait");
pub const REGSTR_VAL_RNAINSTALLED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Installed");
pub const REGSTR_VAL_SAFETYWARNINGLEVEL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Safety Warning Level");
pub const REGSTR_VAL_SCHANNELENABLEPROTOCOL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Enabled");
pub const REGSTR_VAL_SCHANNELENABLEPROTOCOL_DEF: u32 = 1u32;
pub const REGSTR_VAL_SCRIPT_FIXED_FONT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("IEFixedFontName");
pub const REGSTR_VAL_SCRIPT_PROP_FONT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("IEPropFontName");
pub const REGSTR_VAL_SEARCHPAGE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Search Page");
pub const REGSTR_VAL_SECURITYACTICEXSCRIPTS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Security_RunScripts");
pub const REGSTR_VAL_SECURITYACTICEXSCRIPTS_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYACTIVEX: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Security_RunActiveXControls");
pub const REGSTR_VAL_SECURITYACTIVEX_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYALLOWCOOKIES: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AllowCookies");
pub const REGSTR_VAL_SECURITYALLOWCOOKIES_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYDISABLECACHINGOFSSLPAGES: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DisableCachingOfSSLPages");
pub const REGSTR_VAL_SECURITYDISABLECACHINGOFSSLPAGES_DEF: u32 = 0u32;
pub const REGSTR_VAL_SECURITYJAVA: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Security_RunJavaApplets");
pub const REGSTR_VAL_SECURITYJAVA_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYWARNONBADCERTSENDING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("WarnOnBadCertSending");
pub const REGSTR_VAL_SECURITYWARNONBADCERTSENDING_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYWARNONBADCERTVIEWING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("WarnOnBadCertRecving");
pub const REGSTR_VAL_SECURITYWARNONBADCERTVIEWING_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYWARNONSEND: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("WarnOnPost");
pub const REGSTR_VAL_SECURITYWARNONSENDALWAYS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("WarnAlwaysOnPost");
pub const REGSTR_VAL_SECURITYWARNONSENDALWAYS_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYWARNONSEND_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYWARNONVIEW: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("WarnOnView");
pub const REGSTR_VAL_SECURITYWARNONVIEW_DEF: u32 = 1u32;
pub const REGSTR_VAL_SECURITYWARNONZONECROSSING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("WarnOnZoneCrossing");
pub const REGSTR_VAL_SECURITYWARNONZONECROSSING_DEF: u32 = 1u32;
pub const REGSTR_VAL_SHOWADDRESSBAR: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Show_URLToolBar");
pub const REGSTR_VAL_SHOWFOCUS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Tabstop - MouseDown");
pub const REGSTR_VAL_SHOWFOCUS_DEF: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("no");
pub const REGSTR_VAL_SHOWFULLURLS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Show_FullURL");
pub const REGSTR_VAL_SHOWTOOLBAR: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Show_ToolBar");
pub const REGSTR_VAL_SMOOTHSCROLL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SmoothScroll");
...
pub const REGSTR_VAL_TRUSTWARNINGLEVEL_HIGH: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("High");
pub const REGSTR_VAL_TRUSTWARNINGLEVEL_LOW: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("No Security");
pub const REGSTR_VAL_TRUSTWARNINGLEVEL_MED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Medium");
pub const REGSTR_VAL_USEAUTOAPPEND: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Append Completion");
pub const REGSTR_VAL_USEAUTOCOMPLETE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Use AutoComplete");
pub const REGSTR_VAL_USEAUTOSUGGEST: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AutoSuggest");
pub const REGSTR_VAL_USEDLGCOLORS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Use_DlgBox_Colors");
pub const REGSTR_VAL_USEHOVERCOLOR: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Use Anchor Hover Color");
...
pub const REGSTR_VAL_USESTYLESHEETS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Use Stylesheets");
pub const REGSTR_VAL_USESTYLESHEETS_DEF: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("yes");
pub const REGSTR_VAL_VISIBLEBANDS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("VisibleBands");
pub const REGSTR_VAL_VISIBLEBANDS_DEF: u32 = 7u32;
pub const REGSTR_VAL_WEBCHARSET: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("WebCharset");
...
pub const SZTRUSTWARNLEVEL: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("Trust Warning Level");
pub const SZVISIBLE: ::windows_sys::core::PCSTR = ::windows_sys::core::s!("VisibleBands");
pub const SZ_IE_DEFAULT_HTML_EDITOR: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("Default HTML Editor");
...
pub const TARGET_NOTIFY_OBJECT_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("863a99a0-21bc-11d0-82b4-00a0c90c29c5");
...
pub const TSZINTERNETCLIENTSPATH: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Software\\Microsoft\\Internet Explorer\\Unix");
...
pub const TSZMICROSOFTPATH: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Software\\Microsoft");
...
pub const TSZSCHANNELPATH: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SYSTEM\\CurrentControlSet\\Control\\SecurityProviders\\SCHANNEL");
...
pub const wfolders: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xbae31f9a_1b81_11d2_a97a_00c04f8ecb02);

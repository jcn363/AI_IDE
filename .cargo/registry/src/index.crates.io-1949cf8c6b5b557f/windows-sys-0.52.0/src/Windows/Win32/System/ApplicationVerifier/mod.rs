...
pub type AVRF_HANDLEOPERATION_ENUMERATE_CALLBACK = ::core::option::Option<
...
>;
pub type AVRF_HEAPALLOCATION_ENUMERATE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type AVRF_RESOURCE_ENUMERATE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(

...
pub const CLRRuntimeHost: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x90f1a06e_7712_4762_86b5_7a5eba6bdb02);
...
pub const CLSID_CLRDebugging: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xbacc578d_fbdd_48a4_969f_02d932b74634);
pub const CLSID_CLRDebuggingLegacy: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xdf8395b5_a4ba_450b_a77c_a9a47762c520);
pub const CLSID_CLRMetaHost: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x9280188d_0e8e_4867_b30c_7fa83884e8de);
pub const CLSID_CLRMetaHostPolicy: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x2ebcd49a_1b47_4a61_b13a_4a03701e594b);
pub const CLSID_CLRProfiling: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xbd097ed8_733e_43fe_8ed7_a95ff9a8448c);
pub const CLSID_CLRStrongName: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xb79b0acd_f5cd_409b_b5a5_a16244610b92);
...
pub const ComCallUnmarshal: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x3f281000_e95a_11d2_886b_00c04f869f04);
pub const ComCallUnmarshalV4: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x45fb4600_e6e8_4928_b25e_50476ff79425);
pub const CorRuntimeHost: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xcb2f6723_ab3a_11d2_9c40_00c04fa30a3e);
...
pub const LIBID_mscoree: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x5477469e_83b1_11d2_8b49_00a0c9b7c9c4);
...
pub const TypeNameFactory: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xb81ff171_20f3_11d2_8dcc_00a0c9b00525);
...
pub type CLRCreateInstanceFnPtr = ::core::option::Option<
...
>;
pub type CallbackThreadSetFnPtr =
    ::core::option::Option<unsafe extern "system" fn() -> ::windows_sys::core::HRESULT>;
pub type CallbackThreadUnsetFnPtr =
    ::core::option::Option<unsafe extern "system" fn() -> ::windows_sys::core::HRESULT>;
pub type CreateInterfaceFnPtr = ::core::option::Option<
    unsafe extern "system" fn(
        clsid: *const ::windows_sys::core::GUID,
        riid: *const ::windows_sys::core::GUID,
        ppinterface: *mut *mut ::core::ffi::c_void,
...
>;
pub type FExecuteInAppDomainCallback = ::core::option::Option<
    unsafe extern "system" fn(cookie: *mut ::core::ffi::c_void) -> ::windows_sys::core::HRESULT,
>;
pub type FLockClrVersionCallback =
    ::core::option::Option<unsafe extern "system" fn() -> ::windows_sys::core::HRESULT>;
pub type PTLS_CALLBACK_FUNCTION = ::core::option::Option<
    unsafe extern "system" fn(
        __midl____midl_itf_mscoree_0000_00040005: *mut ::core::ffi::c_void,
    ) -> (),
>;
pub type RuntimeLoadedCallbackFnPtr = ::core::option::Option<
    unsafe extern "system" fn(

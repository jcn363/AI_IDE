...
pub const SE_ASSIGNPRIMARYTOKEN_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeAssignPrimaryTokenPrivilege");
pub const SE_AUDIT_NAME: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("SeAuditPrivilege");
pub const SE_BACKUP_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeBackupPrivilege");
pub const SE_CHANGE_NOTIFY_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeChangeNotifyPrivilege");
pub const SE_CREATE_GLOBAL_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeCreateGlobalPrivilege");
pub const SE_CREATE_PAGEFILE_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeCreatePagefilePrivilege");
pub const SE_CREATE_PERMANENT_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeCreatePermanentPrivilege");
pub const SE_CREATE_SYMBOLIC_LINK_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeCreateSymbolicLinkPrivilege");
pub const SE_CREATE_TOKEN_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeCreateTokenPrivilege");
...
pub const SE_DELEGATE_SESSION_USER_IMPERSONATE_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeDelegateSessionUserImpersonatePrivilege");
pub const SE_ENABLE_DELEGATION_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeEnableDelegationPrivilege");
pub const SE_GROUP_DEFAULTED: SECURITY_DESCRIPTOR_CONTROL = 2u16;
pub const SE_IMPERSONATE_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeImpersonatePrivilege");
pub const SE_INCREASE_QUOTA_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeIncreaseQuotaPrivilege");
pub const SE_INC_BASE_PRIORITY_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeIncreaseBasePriorityPrivilege");
pub const SE_INC_WORKING_SET_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeIncreaseWorkingSetPrivilege");
pub const SE_LOAD_DRIVER_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeLoadDriverPrivilege");
pub const SE_LOCK_MEMORY_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeLockMemoryPrivilege");
pub const SE_MACHINE_ACCOUNT_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeMachineAccountPrivilege");
pub const SE_MANAGE_VOLUME_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeManageVolumePrivilege");
...
pub const SE_PROF_SINGLE_PROCESS_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeProfileSingleProcessPrivilege");
pub const SE_RELABEL_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeRelabelPrivilege");
pub const SE_REMOTE_SHUTDOWN_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeRemoteShutdownPrivilege");
pub const SE_RESTORE_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeRestorePrivilege");
...
pub const SE_SECURITY_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeSecurityPrivilege");
pub const SE_SELF_RELATIVE: SECURITY_DESCRIPTOR_CONTROL = 32768u16;
pub const SE_SHUTDOWN_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeShutdownPrivilege");
pub const SE_SYNC_AGENT_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeSyncAgentPrivilege");
pub const SE_SYSTEMTIME_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeSystemtimePrivilege");
pub const SE_SYSTEM_ENVIRONMENT_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeSystemEnvironmentPrivilege");
pub const SE_SYSTEM_PROFILE_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeSystemProfilePrivilege");
pub const SE_TAKE_OWNERSHIP_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeTakeOwnershipPrivilege");
pub const SE_TCB_NAME: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("SeTcbPrivilege");
pub const SE_TIME_ZONE_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeTimeZonePrivilege");
pub const SE_TRUSTED_CREDMAN_ACCESS_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeTrustedCredManAccessPrivilege");
pub const SE_UNDOCK_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeUndockPrivilege");
pub const SE_UNSOLICITED_INPUT_NAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SeUnsolicitedInputPrivilege");
...
pub const wszCERTENROLLSHAREPATH: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CertSrv\\CertEnroll");
pub const wszFCSAPARM_CERTFILENAMESUFFIX: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("%4");
pub const wszFCSAPARM_CONFIGDN: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("%6");
pub const wszFCSAPARM_CRLDELTAFILENAMESUFFIX: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("%9");
pub const wszFCSAPARM_CRLFILENAMESUFFIX: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("%8");
pub const wszFCSAPARM_DOMAINDN: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("%5");
pub const wszFCSAPARM_DSCACERTATTRIBUTE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("%11");
pub const wszFCSAPARM_DSCRLATTRIBUTE: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("%10");
pub const wszFCSAPARM_DSCROSSCERTPAIRATTRIBUTE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("%14");
pub const wszFCSAPARM_DSKRACERTATTRIBUTE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("%13");
pub const wszFCSAPARM_DSUSERCERTATTRIBUTE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("%12");
pub const wszFCSAPARM_SANITIZEDCANAME: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("%3");
pub const wszFCSAPARM_SANITIZEDCANAMEHASH: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("%7");
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type PLSA_AP_CALL_PACKAGE_UNTRUSTED = ::core::option::Option<
...
>;
pub type SEC_THREAD_START = ::core::option::Option<

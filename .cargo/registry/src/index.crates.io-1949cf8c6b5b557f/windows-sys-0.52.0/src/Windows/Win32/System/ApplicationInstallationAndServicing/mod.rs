...
pub const CLSID_EvalCom2: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x6e5e1910_8053_4660_b795_6b612e29bc58);
pub const CLSID_MsmMerge2: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xf94985d5_29f9_4743_9805_99bc3f35b678);
...
pub const FUSION_REFCOUNT_FILEPATH_GUID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xb02f9d65_fb77_4f7a_afa5_b391309f11c9);
pub const FUSION_REFCOUNT_OPAQUE_STRING_GUID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x2ec93463_b0c3_45e1_8364_327e96aea856);
pub const FUSION_REFCOUNT_UNINSTALL_SUBKEY_GUID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x8cedc215_ac4b_488b_93c0_a50a49cb2fb8);
...
pub const IACTIONNAME_COLLECTUSERINFO: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CollectUserInfo");
...
pub const IASSEMBLYCACHE_UNINSTALL_DISPOSITION_ALREADY_UNINSTALLED:
    IASSEMBLYCACHE_UNINSTALL_DISPOSITION = 3u32;
pub const IASSEMBLYCACHE_UNINSTALL_DISPOSITION_DELETE_PENDING:
    IASSEMBLYCACHE_UNINSTALL_DISPOSITION = 4u32;
...
pub const INSTALLPROPERTY_ASSIGNMENTTYPE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AssignmentType");
pub const INSTALLPROPERTY_AUTHORIZED_LUA_APP: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AuthorizedLUAApp");
pub const INSTALLPROPERTY_DISKPROMPT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DiskPrompt");
pub const INSTALLPROPERTY_DISPLAYNAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DisplayName");
pub const INSTALLPROPERTY_HELPLINK: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("HelpLink");
pub const INSTALLPROPERTY_HELPTELEPHONE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("HelpTelephone");
pub const INSTALLPROPERTY_INSTALLDATE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("InstallDate");
pub const INSTALLPROPERTY_INSTALLEDLANGUAGE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("InstalledLanguage");
pub const INSTALLPROPERTY_INSTALLEDPRODUCTNAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("InstalledProductName");
pub const INSTALLPROPERTY_INSTALLLOCATION: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("InstallLocation");
pub const INSTALLPROPERTY_INSTALLSOURCE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("InstallSource");
pub const INSTALLPROPERTY_INSTANCETYPE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("InstanceType");
pub const INSTALLPROPERTY_LANGUAGE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Language");
pub const INSTALLPROPERTY_LASTUSEDSOURCE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("LastUsedSource");
pub const INSTALLPROPERTY_LASTUSEDTYPE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("LastUsedType");
pub const INSTALLPROPERTY_LOCALPACKAGE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("LocalPackage");
pub const INSTALLPROPERTY_LUAENABLED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("LUAEnabled");
pub const INSTALLPROPERTY_MEDIAPACKAGEPATH: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MediaPackagePath");
pub const INSTALLPROPERTY_MOREINFOURL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MoreInfoURL");
pub const INSTALLPROPERTY_PACKAGECODE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PackageCode");
pub const INSTALLPROPERTY_PACKAGENAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PackageName");
pub const INSTALLPROPERTY_PATCHSTATE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("State");
pub const INSTALLPROPERTY_PATCHTYPE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PatchType");
pub const INSTALLPROPERTY_PRODUCTICON: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProductIcon");
pub const INSTALLPROPERTY_PRODUCTID: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProductID");
pub const INSTALLPROPERTY_PRODUCTNAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProductName");
pub const INSTALLPROPERTY_PRODUCTSTATE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("State");
pub const INSTALLPROPERTY_PUBLISHER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Publisher");
pub const INSTALLPROPERTY_REGCOMPANY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("RegCompany");
pub const INSTALLPROPERTY_REGOWNER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("RegOwner");
pub const INSTALLPROPERTY_TRANSFORMS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Transforms");
pub const INSTALLPROPERTY_UNINSTALLABLE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Uninstallable");
pub const INSTALLPROPERTY_URLINFOABOUT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("URLInfoAbout");
pub const INSTALLPROPERTY_URLUPDATEINFO: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("URLUpdateInfo");
pub const INSTALLPROPERTY_VERSION: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("Version");
pub const INSTALLPROPERTY_VERSIONMAJOR: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("VersionMajor");
pub const INSTALLPROPERTY_VERSIONMINOR: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("VersionMinor");
pub const INSTALLPROPERTY_VERSIONSTRING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("VersionString");
...
pub const IPROPNAME_ADMINTOOLS_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AdminToolsFolder");
pub const IPROPNAME_ADMINUSER: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("AdminUser");
pub const IPROPNAME_ADMIN_PROPERTIES: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AdminProperties");
pub const IPROPNAME_AFTERREBOOT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AFTERREBOOT");
pub const IPROPNAME_ALLOWEDPROPERTIES: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SecureCustomProperties");
pub const IPROPNAME_ALLUSERS: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("ALLUSERS");
pub const IPROPNAME_APPDATA_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AppDataFolder");
...
pub const IPROPNAME_ARPAUTHORIZEDCDFPREFIX: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ARPAUTHORIZEDCDFPREFIX");
pub const IPROPNAME_ARPCOMMENTS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ARPCOMMENTS");
pub const IPROPNAME_ARPCONTACT: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("ARPCONTACT");
pub const IPROPNAME_ARPHELPLINK: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ARPHELPLINK");
pub const IPROPNAME_ARPHELPTELEPHONE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ARPHELPTELEPHONE");
pub const IPROPNAME_ARPINSTALLLOCATION: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ARPINSTALLLOCATION");
pub const IPROPNAME_ARPNOMODIFY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ARPNOMODIFY");
pub const IPROPNAME_ARPNOREMOVE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ARPNOREMOVE");
pub const IPROPNAME_ARPNOREPAIR: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ARPNOREPAIR");
pub const IPROPNAME_ARPPRODUCTICON: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ARPPRODUCTICON");
pub const IPROPNAME_ARPREADME: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("ARPREADME");
pub const IPROPNAME_ARPSETTINGSIDENTIFIER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIARPSETTINGSIDENTIFIER");
pub const IPROPNAME_ARPSHIMFLAGS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SHIMFLAGS");
pub const IPROPNAME_ARPSHIMSERVICEPACKLEVEL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SHIMSERVICEPACKLEVEL");
pub const IPROPNAME_ARPSHIMVERSIONNT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SHIMVERSIONNT");
pub const IPROPNAME_ARPSIZE: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("ARPSIZE");
pub const IPROPNAME_ARPSYSTEMCOMPONENT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ARPSYSTEMCOMPONENT");
pub const IPROPNAME_ARPURLINFOABOUT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ARPURLINFOABOUT");
pub const IPROPNAME_ARPURLUPDATEINFO: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ARPURLUPDATEINFO");
pub const IPROPNAME_AVAILABLEFREEREG: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("AVAILABLEFREEREG");
...
pub const IPROPNAME_CAPTIONHEIGHT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CaptionHeight");
pub const IPROPNAME_CARRYINGNDP: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CARRYINGNDP");
pub const IPROPNAME_CHECKCRCS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSICHECKCRCS");
pub const IPROPNAME_COLORBITS: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("ColorBits");
pub const IPROPNAME_COMMONAPPDATA_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CommonAppDataFolder");
pub const IPROPNAME_COMMONFILES64_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CommonFiles64Folder");
pub const IPROPNAME_COMMONFILES_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CommonFilesFolder");
pub const IPROPNAME_COMPANYNAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("COMPANYNAME");
pub const IPROPNAME_COMPONENTADDDEFAULT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("COMPADDDEFAULT");
pub const IPROPNAME_COMPONENTADDLOCAL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("COMPADDLOCAL");
pub const IPROPNAME_COMPONENTADDSOURCE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("COMPADDSOURCE");
pub const IPROPNAME_COMPUTERNAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ComputerName");
pub const IPROPNAME_COSTINGCOMPLETE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CostingComplete");
pub const IPROPNAME_CUSTOMACTIONDATA: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CustomActionData");
...
pub const IPROPNAME_DEFAULTUIFONT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DefaultUIFont");
pub const IPROPNAME_DESKTOP_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DesktopFolder");
pub const IPROPNAME_DISABLEADVTSHORTCUTS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DISABLEADVTSHORTCUTS");
pub const IPROPNAME_DISABLEROLLBACK: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DISABLEROLLBACK");
pub const IPROPNAME_DISKPROMPT: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("DiskPrompt");
pub const IPROPNAME_ENABLEUSERCONTROL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("EnableUserControl");
pub const IPROPNAME_ENFORCE_UPGRADE_COMPONENT_RULES: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIENFORCEUPGRADECOMPONENTRULES");
pub const IPROPNAME_EXECUTEACTION: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("EXECUTEACTION");
pub const IPROPNAME_EXECUTEMODE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("EXECUTEMODE");
pub const IPROPNAME_FAVORITES_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("FavoritesFolder");
pub const IPROPNAME_FEATUREADDDEFAULT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ADDDEFAULT");
pub const IPROPNAME_FEATUREADDLOCAL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ADDLOCAL");
pub const IPROPNAME_FEATUREADDSOURCE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ADDSOURCE");
pub const IPROPNAME_FEATUREADVERTISE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ADVERTISE");
pub const IPROPNAME_FEATUREREMOVE: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("REMOVE");
pub const IPROPNAME_FILEADDDEFAULT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("FILEADDDEFAULT");
pub const IPROPNAME_FILEADDLOCAL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("FILEADDLOCAL");
pub const IPROPNAME_FILEADDSOURCE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("FILEADDSOURCE");
pub const IPROPNAME_FONTS_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("FontsFolder");
pub const IPROPNAME_HIDDEN_PROPERTIES: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiHiddenProperties");
pub const IPROPNAME_HIDECANCEL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiUIHideCancel");
...
pub const IPROPNAME_INSTALLLANGUAGE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProductLanguage");
pub const IPROPNAME_INSTALLLEVEL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("INSTALLLEVEL");
pub const IPROPNAME_INSTALLPERUSER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIINSTALLPERUSER");
...
pub const IPROPNAME_INTERNALINSTALLEDPERUSER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIINTERNALINSTALLEDPERUSER");
pub const IPROPNAME_ISADMINPACKAGE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("IsAdminPackage");
...
pub const IPROPNAME_LOCALAPPDATA_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("LocalAppDataFolder");
...
pub const IPROPNAME_MANUFACTURER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Manufacturer");
pub const IPROPNAME_MSIAMD64: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("MsiAMD64");
pub const IPROPNAME_MSIDISABLEEEUI: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIDISABLEEEUI");
pub const IPROPNAME_MSIDISABLELUAPATCHING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIDISABLELUAPATCHING");
pub const IPROPNAME_MSIINSTANCEGUID: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIINSTANCEGUID");
pub const IPROPNAME_MSILOGFILELOCATION: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiLogFileLocation");
pub const IPROPNAME_MSILOGGINGMODE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiLogging");
pub const IPROPNAME_MSINEWINSTANCE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSINEWINSTANCE");
pub const IPROPNAME_MSINODISABLEMEDIA: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSINODISABLEMEDIA");
pub const IPROPNAME_MSIPACKAGEDOWNLOADLOCALCOPY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIPACKAGEDOWNLOADLOCALCOPY");
pub const IPROPNAME_MSIPATCHDOWNLOADLOCALCOPY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIPATCHDOWNLOADLOCALCOPY");
pub const IPROPNAME_MSIPATCHREMOVE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIPATCHREMOVE");
pub const IPROPNAME_MSITABLETPC: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiTabletPC");
pub const IPROPNAME_MSIX64: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("Msix64");
pub const IPROPNAME_MSI_FASTINSTALL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIFASTINSTALL");
pub const IPROPNAME_MSI_REBOOT_PENDING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiSystemRebootPending");
pub const IPROPNAME_MSI_RM_CONTROL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIRESTARTMANAGERCONTROL");
pub const IPROPNAME_MSI_RM_DISABLE_RESTART: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIDISABLERMRESTART");
pub const IPROPNAME_MSI_RM_SESSION_KEY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiRestartManagerSessionKey");
pub const IPROPNAME_MSI_RM_SHUTDOWN: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIRMSHUTDOWN");
pub const IPROPNAME_MSI_UAC_DEPLOYMENT_COMPLIANT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIDEPLOYMENTCOMPLIANT");
pub const IPROPNAME_MSI_UNINSTALL_SUPERSEDED_COMPONENTS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIUNINSTALLSUPERSEDEDCOMPONENTS");
pub const IPROPNAME_MSI_USE_REAL_ADMIN_DETECTION: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MSIUSEREALADMINDETECTION");
pub const IPROPNAME_MYPICTURES_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MyPicturesFolder");
pub const IPROPNAME_NETASSEMBLYSUPPORT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiNetAssemblySupport");
pub const IPROPNAME_NETHOOD_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("NetHoodFolder");
pub const IPROPNAME_NOCOMPANYNAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("NOCOMPANYNAME");
pub const IPROPNAME_NOUSERNAME: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("NOUSERNAME");
pub const IPROPNAME_NTPRODUCTTYPE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiNTProductType");
pub const IPROPNAME_NTSUITEBACKOFFICE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiNTSuiteBackOffice");
pub const IPROPNAME_NTSUITEDATACENTER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiNTSuiteDataCenter");
pub const IPROPNAME_NTSUITEENTERPRISE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiNTSuiteEnterprise");
pub const IPROPNAME_NTSUITEPERSONAL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiNTSuitePersonal");
pub const IPROPNAME_NTSUITESMALLBUSINESS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiNTSuiteSmallBusiness");
pub const IPROPNAME_NTSUITESMALLBUSINESSRESTRICTED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiNTSuiteSmallBusinessRestricted");
pub const IPROPNAME_NTSUITEWEBSERVER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiNTSuiteWebServer");
pub const IPROPNAME_OLEADVTSUPPORT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("OLEAdvtSupport");
pub const IPROPNAME_OUTOFDISKSPACE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("OutOfDiskSpace");
pub const IPROPNAME_OUTOFNORBDISKSPACE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("OutOfNoRbDiskSpace");
pub const IPROPNAME_PATCH: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("PATCH");
pub const IPROPNAME_PATCHNEWPACKAGECODE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PATCHNEWPACKAGECODE");
pub const IPROPNAME_PATCHNEWSUMMARYCOMMENTS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PATCHNEWSUMMARYCOMMENTS");
pub const IPROPNAME_PATCHNEWSUMMARYSUBJECT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PATCHNEWSUMMARYSUBJECT");
pub const IPROPNAME_PERSONAL_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PersonalFolder");
pub const IPROPNAME_PHYSICALMEMORY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PhysicalMemory");
pub const IPROPNAME_PIDKEY: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("PIDKEY");
pub const IPROPNAME_PIDTEMPLATE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PIDTemplate");
pub const IPROPNAME_PRESELECTED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Preselected");
pub const IPROPNAME_PRIMARYFOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PRIMARYFOLDER");
pub const IPROPNAME_PRIMARYFOLDER_PATH: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PrimaryVolumePath");
pub const IPROPNAME_PRIMARYFOLDER_SPACEAVAILABLE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PrimaryVolumeSpaceAvailable");
pub const IPROPNAME_PRIMARYFOLDER_SPACEREMAINING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PrimaryVolumeSpaceRemaining");
pub const IPROPNAME_PRIMARYFOLDER_SPACEREQUIRED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PrimaryVolumeSpaceRequired");
pub const IPROPNAME_PRINTHOOD_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PrintHoodFolder");
pub const IPROPNAME_PRIVILEGED: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("Privileged");
pub const IPROPNAME_PRODUCTCODE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProductCode");
pub const IPROPNAME_PRODUCTID: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("ProductID");
pub const IPROPNAME_PRODUCTLANGUAGE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PRODUCTLANGUAGE");
pub const IPROPNAME_PRODUCTNAME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProductName");
pub const IPROPNAME_PRODUCTSTATE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProductState");
pub const IPROPNAME_PRODUCTVERSION: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProductVersion");
pub const IPROPNAME_PROGRAMFILES64_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProgramFiles64Folder");
pub const IPROPNAME_PROGRAMFILES_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProgramFilesFolder");
pub const IPROPNAME_PROGRAMMENU_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ProgramMenuFolder");
pub const IPROPNAME_PROGRESSONLY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiUIProgressOnly");
pub const IPROPNAME_PROMPTROLLBACKCOST: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("PROMPTROLLBACKCOST");
pub const IPROPNAME_REBOOT: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("REBOOT");
pub const IPROPNAME_REBOOTPROMPT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("REBOOTPROMPT");
pub const IPROPNAME_RECENT_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("RecentFolder");
pub const IPROPNAME_REDIRECTEDDLLSUPPORT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("RedirectedDllSupport");
pub const IPROPNAME_REINSTALL: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("REINSTALL");
pub const IPROPNAME_REINSTALLMODE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("REINSTALLMODE");
pub const IPROPNAME_REMOTEADMINTS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("RemoteAdminTS");
pub const IPROPNAME_REPLACEDINUSEFILES: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ReplacedInUseFiles");
pub const IPROPNAME_RESTRICTEDUSERCONTROL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("RestrictedUserControl");
pub const IPROPNAME_RESUME: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("RESUME");
pub const IPROPNAME_ROLLBACKDISABLED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("RollbackDisabled");
pub const IPROPNAME_ROOTDRIVE: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("ROOTDRIVE");
pub const IPROPNAME_RUNNINGELEVATED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiRunningElevated");
...
pub const IPROPNAME_SENDTO_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SendToFolder");
pub const IPROPNAME_SEQUENCE: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("SEQUENCE");
pub const IPROPNAME_SERVICEPACKLEVEL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ServicePackLevel");
pub const IPROPNAME_SERVICEPACKLEVELMINOR: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ServicePackLevelMinor");
pub const IPROPNAME_SHAREDWINDOWS: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SharedWindows");
pub const IPROPNAME_SHELLADVTSUPPORT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ShellAdvtSupport");
pub const IPROPNAME_SHORTFILENAMES: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SHORTFILENAMES");
...
pub const IPROPNAME_SOURCERESONLY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiUISourceResOnly");
pub const IPROPNAME_STARTMENU_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("StartMenuFolder");
pub const IPROPNAME_STARTUP_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("StartupFolder");
pub const IPROPNAME_SYSTEM16_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("System16Folder");
pub const IPROPNAME_SYSTEM64_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("System64Folder");
pub const IPROPNAME_SYSTEMLANGUAGEID: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SystemLanguageID");
pub const IPROPNAME_SYSTEM_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SystemFolder");
...
pub const IPROPNAME_TEMPLATE_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("TemplateFolder");
pub const IPROPNAME_TEMPLATE_X64: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("x64");
pub const IPROPNAME_TEMP_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("TempFolder");
pub const IPROPNAME_TERMSERVER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("TerminalServer");
pub const IPROPNAME_TEXTHEIGHT: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("TextHeight");
pub const IPROPNAME_TEXTHEIGHT_CORRECTION: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("TextHeightCorrection");
pub const IPROPNAME_TEXTINTERNALLEADING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("TextInternalLeading");
...
pub const IPROPNAME_TRANSFORMSATSOURCE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("TRANSFORMSATSOURCE");
pub const IPROPNAME_TRANSFORMSSECURE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("TRANSFORMSSECURE");
pub const IPROPNAME_TRUEADMINUSER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiTrueAdminUser");
...
pub const IPROPNAME_UPDATESTARTED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("UpdateStarted");
pub const IPROPNAME_UPGRADECODE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("UpgradeCode");
pub const IPROPNAME_USERLANGUAGEID: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("UserLanguageID");
...
pub const IPROPNAME_VERSIONNT64: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("VersionNT64");
pub const IPROPNAME_VIRTUALMEMORY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("VirtualMemory");
pub const IPROPNAME_WIN32ASSEMBLYSUPPORT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MsiWin32AssemblySupport");
pub const IPROPNAME_WINDOWSBUILD: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("WindowsBuild");
pub const IPROPNAME_WINDOWS_FOLDER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("WindowsFolder");
pub const IPROPNAME_WINDOWS_VOLUME: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("WindowsVolume");
pub const IPROPVALUE_EXECUTEMODE_NONE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("NONE");
pub const IPROPVALUE_EXECUTEMODE_SCRIPT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("SCRIPT");
pub const IPROPVALUE_FEATURE_ALL: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("ALL");
pub const IPROPVALUE_MSI_RM_CONTROL_DISABLE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Disable");
pub const IPROPVALUE_MSI_RM_CONTROL_DISABLESHUTDOWN: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DisableShutdown");
...
pub const IPROPVALUE__CARRYINGNDP_URTREINSTALL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("URTREINSTALL");
pub const IPROPVALUE__CARRYINGNDP_URTUPGRADE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("URTUPGRADE");
pub const LIBID_MsmMergeTypeLib: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x0adda82f_2c26_11d2_ad65_00a0c9af11a6);
...
pub const MsmMerge: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x0adda830_2c26_11d2_ad65_00a0c9af11a6);
...
pub const PMSvc: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xb9e511fc_e364_497a_a121_b7b3612cedce);
...
pub const SFC_IDLE_TRIGGER: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("WFP_IDLE_TRIGGER");
...
pub type INSTALLUI_HANDLERA = ::core::option::Option<
    unsafe extern "system" fn(
        pvcontext: *mut ::core::ffi::c_void,
        imessagetype: u32,
        szmessage: ::windows_sys::core::PCSTR,
    ) -> i32,
>;
pub type INSTALLUI_HANDLERW = ::core::option::Option<
    unsafe extern "system" fn(
        pvcontext: *mut ::core::ffi::c_void,
        imessagetype: u32,
        szmessage: ::windows_sys::core::PCWSTR,
    ) -> i32,
>;
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type LPDISPLAYVAL = ::core::option::Option<
    unsafe extern "system" fn(
        pcontext: *mut ::core::ffi::c_void,
        uitype: RESULTTYPES,
        szwval: ::windows_sys::core::PCWSTR,
        szwdescription: ::windows_sys::core::PCWSTR,
        szwlocation: ::windows_sys::core::PCWSTR,
    ) -> super::super::Foundation::BOOL,
>;
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type LPEVALCOMCALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        istatus: STATUSTYPES,
        szdata: ::windows_sys::core::PCWSTR,
        pcontext: *mut ::core::ffi::c_void,
    ) -> super::super::Foundation::BOOL,
>;
pub type PINSTALLUI_HANDLER_RECORD = ::core::option::Option<
    unsafe extern "system" fn(
        pvcontext: *mut ::core::ffi::c_void,
        imessagetype: u32,
        hrecord: MSIHANDLE,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type PPATCH_PROGRESS_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type PPATCH_SYMLOAD_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        whichfile: u32,
        symbolfilename: ::windows_sys::core::PCSTR,
        symtype: u32,

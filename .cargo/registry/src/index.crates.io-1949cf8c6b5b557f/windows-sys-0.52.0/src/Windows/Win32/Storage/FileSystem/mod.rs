...
pub const CLFS_CONTAINER_STREAM_PREFIX: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("%BLF%:");
...
pub type CACHE_ACCESS_CHECK = ::core::option::Option<
    unsafe extern "system" fn(
        ...
        accessstatus: *mut super::super::Foundation::BOOL,
    ) -> super::super::Foundation::BOOL,
>;
pub type CACHE_DESTROY_CALLBACK =
    ::core::option::Option<unsafe extern "system" fn(cb: u32, lpb: *mut u8) -> ()>;
...
pub type CACHE_KEY_HASH =
    ::core::option::Option<unsafe extern "system" fn(lpbkey: *mut u8, cbkey: u32) -> u32>;
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
...
pub type MAXMEDIALABEL =
    ::core::option::Option<unsafe extern "system" fn(pmaxsize: *mut u32) -> u32>;
pub type PCLFS_COMPLETION_ROUTINE = ::core::option::Option<
    unsafe extern "system" fn(pvoverlapped: *mut ::core::ffi::c_void, ulreserved: u32) -> (),
>;
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]

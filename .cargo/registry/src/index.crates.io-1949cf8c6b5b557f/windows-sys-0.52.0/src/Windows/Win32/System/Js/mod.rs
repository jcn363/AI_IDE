...
pub type JsBackgroundWorkItemCallback = ::core::option::Option<
    unsafe extern "system" fn(callbackstate: *const ::core::ffi::c_void) -> (),
>;
pub type JsBeforeCollectCallback = ::core::option::Option<
    unsafe extern "system" fn(callbackstate: *const ::core::ffi::c_void) -> (),
>;
pub type JsFinalizeCallback =
    ::core::option::Option<unsafe extern "system" fn(data: *const ::core::ffi::c_void) -> ()>;
pub type JsMemoryAllocationCallback = ::core::option::Option<
...
>;
pub type JsNativeFunction = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type JsThreadServiceCallback = ::core::option::Option<
    unsafe extern "system" fn(

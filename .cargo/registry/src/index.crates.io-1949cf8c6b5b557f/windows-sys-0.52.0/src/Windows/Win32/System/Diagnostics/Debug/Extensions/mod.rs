...
pub const DEBUG_OUTPUT_NAME_END_T: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("**NAME**");
pub const DEBUG_OUTPUT_NAME_END_WIDE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("**NAME**");
pub const DEBUG_OUTPUT_NORMAL: u32 = 1u32;
pub const DEBUG_OUTPUT_OFFSET_END: ::windows_sys::core::PCSTR = ::windows_sys::core::s!("**OFF**");
pub const DEBUG_OUTPUT_OFFSET_END_T: ::windows_sys::core::PCWSTR =
...
pub const DEBUG_OUTPUT_TYPE_END_T: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("**TYPE**");
pub const DEBUG_OUTPUT_TYPE_END_WIDE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("**TYPE**");
pub const DEBUG_OUTPUT_VALUE_END: ::windows_sys::core::PCSTR = ::windows_sys::core::s!("**VALUE**");
pub const DEBUG_OUTPUT_VALUE_END_T: ::windows_sys::core::PCWSTR =
...
pub type ENTRY_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        entryaddress: u64,
        context: *mut ::core::ffi::c_void,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type EXTDLL_ITERATERTLBALANCEDNODES = ::core::option::Option<
    unsafe extern "system" fn(
        rootnode: u64,
        entryoffset: u32,
...
>;
pub type EXTDLL_QUERYDATABYTAG = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type EXTDLL_QUERYDATABYTAGEX = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient4,
        dwdatatag: u32,
        pqueryinfo: *const ::core::ffi::c_void,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type EXTS_JOB_PROCESS_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        job: u64,
        process: u64,
        context: *mut ::core::ffi::c_void,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type EXTS_TABLE_ENTRY_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        entry: u64,
        context: *mut ::core::ffi::c_void,
    ) -> super::super::super::super::Foundation::BOOLEAN,
>;
pub type EXT_ANALYSIS_PLUGIN = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient4,
...
>;
pub type EXT_ANALYZER = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
...
pub type EXT_DECODE_ERROR =
    ::core::option::Option<unsafe extern "system" fn(pdecodeerror: *mut DEBUG_DECODE_ERROR) -> ()>;
pub type EXT_GET_DEBUG_FAILURE_ANALYSIS = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient4,
        flags: u32,
        classid: ::windows_sys::core::GUID,
        ppanalysis: *mut IDebugFailureAnalysis2,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type EXT_GET_ENVIRONMENT_VARIABLE = ::core::option::Option<
    unsafe extern "system" fn(
        peb: u64,
...
>;
pub type EXT_GET_FAILURE_ANALYSIS = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient4,
        flags: u32,
        ppanalysis: *mut IDebugFailureAnalysis,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type EXT_GET_FA_ENTRIES_DATA = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient4,
        count: *mut u32,
...
>;
pub type EXT_GET_HANDLE_TRACE = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        tracetype: u32,
        startindex: u32,
...
>;
pub type EXT_RELOAD_TRIAGER = ::core::option::Option<
    unsafe extern "system" fn(client: IDebugClient4) -> ::windows_sys::core::HRESULT,
>;
pub type EXT_TARGET_INFO = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient4,
        ptargetinfo: *mut TARGET_DEBUG_INFO,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type EXT_TRIAGE_FOLLOWUP = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient4,
...
>;
pub type EXT_XML_DATA = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient4,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type KDEXTS_LOCK_CALLBACKROUTINE = ::core::option::Option<
    unsafe extern "system" fn(
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type KDEXT_DUMP_HANDLE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type PENUMERATE_HANDLES = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        process: u64,
        handletodump: u64,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type PENUMERATE_HASH_TABLE = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        hashtable: u64,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type PENUMERATE_JOB_PROCESSES = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        job: u64,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type PENUMERATE_SYSTEM_LOCKS = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        flags: u32,
...
>;
pub type PFIND_FILELOCK_OWNERINFO = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        pfilelockowner: *mut KDEXT_FILELOCK_OWNER,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type PFIND_MATCHING_PROCESS = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
...
>;
pub type PFIND_MATCHING_THREAD = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        threadinfo: *mut KDEXT_THREAD_FIND_PARAMS,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type PGET_CPU_MICROCODE_VERSION = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        pcpumicrocodeversion: *mut DEBUG_CPU_MICROCODE_VERSION,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type PGET_CPU_PSPEED_INFO = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type PGET_DEVICE_OBJECT_INFO = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        deviceobject: u64,
...
>;
pub type PGET_DRIVER_OBJECT_INFO = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        driverobject: u64,
...
>;
pub type PGET_FULL_IMAGE_NAME = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        process: u64,
...
>;
pub type PGET_IRP_INFO = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        irp: u64,
...
>;
pub type PGET_PNP_TRIAGE_INFO = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        ppnptriageinfo: *mut DEBUG_PNP_TRIAGE_INFO,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type PGET_POOL_DATA = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        pool: u64,
...
>;
pub type PGET_POOL_REGION = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        pool: u64,
...
>;
pub type PGET_POOL_TAG_DESCRIPTION = ::core::option::Option<
    unsafe extern "system" fn(
        pooltag: u32,
        pdescription: *mut DEBUG_POOLTAG_DESCRIPTION,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type PGET_PROCESS_COMMIT = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
...
>;
pub type PGET_SMBIOS_INFO = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        psmbiosinfo: *mut DEBUG_SMBIOS_INFO,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type PKDEXTS_GET_PTE_INFO = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,
        r#virtual: u64,
...
pub type PWINDBG_GET_EXPRESSION = ::core::option::Option<
    unsafe extern "system" fn(lpexpression: ::windows_sys::core::PCSTR) -> usize,
>;
pub type PWINDBG_GET_EXPRESSION32 = ::core::option::Option<
    unsafe extern "system" fn(lpexpression: ::windows_sys::core::PCSTR) -> u32,
>;
pub type PWINDBG_GET_EXPRESSION64 = ::core::option::Option<
    unsafe extern "system" fn(lpexpression: ::windows_sys::core::PCSTR) -> u64,
>;
...
pub type PWINDBG_OUTPUT_ROUTINE =
    ::core::option::Option<unsafe extern "system" fn(lpformat: ::windows_sys::core::PCSTR) -> ()>;
...
>;
pub type fnDebugFailureAnalysisCreateInstance = ::core::option::Option<
    unsafe extern "system" fn(
        client: IDebugClient,

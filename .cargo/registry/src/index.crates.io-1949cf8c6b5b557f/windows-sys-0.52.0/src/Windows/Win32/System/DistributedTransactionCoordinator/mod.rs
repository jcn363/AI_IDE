...
pub const CLSID_MSDtcTransaction: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x39f8d76b_0928_11d1_97df_00c04fb9618a);
pub const CLSID_MSDtcTransactionManager: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x5b18ab61_091d_11d1_97df_00c04fb9618a);
...
pub type DTC_GET_TRANSACTION_MANAGER = ::core::option::Option<
    unsafe extern "system" fn(
        pszhost: ::windows_sys::core::PCSTR,
        psztmname: ::windows_sys::core::PCSTR,
        rid: *const ::windows_sys::core::GUID,
        dwreserved1: u32,
        wcbreserved2: u16,
...
>;
pub type DTC_GET_TRANSACTION_MANAGER_EX_A = ::core::option::Option<
    unsafe extern "system" fn(
        i_pszhost: ::windows_sys::core::PCSTR,
        i_psztmname: ::windows_sys::core::PCSTR,
        i_riid: *const ::windows_sys::core::GUID,
        i_grfoptions: u32,
        i_pvconfigparams: *mut ::core::ffi::c_void,
        o_ppvobject: *mut *mut ::core::ffi::c_void,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type DTC_GET_TRANSACTION_MANAGER_EX_W = ::core::option::Option<
    unsafe extern "system" fn(
        i_pwszhost: ::windows_sys::core::PCWSTR,
        i_pwsztmname: ::windows_sys::core::PCWSTR,
        i_riid: *const ::windows_sys::core::GUID,
        i_grfoptions: u32,
        i_pvconfigparams: *mut ::core::ffi::c_void,
        o_ppvobject: *mut *mut ::core::ffi::c_void,
...
>;
pub type DTC_INSTALL_CLIENT = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type XA_CLOSE_EPT = ::core::option::Option<
    unsafe extern "system" fn(param0: ::windows_sys::core::PCSTR, param1: i32, param2: i32) -> i32,
>;
pub type XA_COMMIT_EPT = ::core::option::Option<
    unsafe extern "system" fn(param0: *mut XID, param1: i32, param2: i32) -> i32,
>;
pub type XA_COMPLETE_EPT = ::core::option::Option<
    unsafe extern "system" fn(param0: *mut i32, param1: *mut i32, param2: i32, param3: i32) -> i32,
>;
pub type XA_END_EPT = ::core::option::Option<
    unsafe extern "system" fn(param0: *mut XID, param1: i32, param2: i32) -> i32,
>;
pub type XA_FORGET_EPT = ::core::option::Option<
    unsafe extern "system" fn(param0: *mut XID, param1: i32, param2: i32) -> i32,
>;
pub type XA_OPEN_EPT = ::core::option::Option<
    unsafe extern "system" fn(param0: ::windows_sys::core::PCSTR, param1: i32, param2: i32) -> i32,
>;
pub type XA_PREPARE_EPT = ::core::option::Option<
    unsafe extern "system" fn(param0: *mut XID, param1: i32, param2: i32) -> i32,
>;
pub type XA_RECOVER_EPT = ::core::option::Option<
    unsafe extern "system" fn(param0: *mut XID, param1: i32, param2: i32, param3: i32) -> i32,
>;
pub type XA_ROLLBACK_EPT = ::core::option::Option<
    unsafe extern "system" fn(param0: *mut XID, param1: i32, param2: i32) -> i32,
>;
pub type XA_START_EPT = ::core::option::Option<
    unsafe extern "system" fn(param0: *mut XID, param1: i32, param2: i32) -> i32,
>;

...
pub const ALLJOYN_NAMED_PIPE_CONNECT_SPEC: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("npipe:");
...
pub type alljoyn_about_announced_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        busname: ::windows_sys::core::PCSTR,
        version: u16,
        port: u16,
...
>;
pub type alljoyn_aboutdatalistener_getaboutdata_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        msgarg: alljoyn_msgarg,
        language: ::windows_sys::core::PCSTR,
    ) -> QStatus,
>;
pub type alljoyn_aboutdatalistener_getannouncedaboutdata_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        msgarg: alljoyn_msgarg,
    ) -> QStatus,
>;
pub type alljoyn_applicationstatelistener_state_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        busname: *mut i8,
        publickey: *mut i8,
...
>;
pub type alljoyn_authlistener_authenticationcomplete_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        authmechanism: ::windows_sys::core::PCSTR,
        peername: ::windows_sys::core::PCSTR,
        success: i32,
    ) -> (),
>;
pub type alljoyn_authlistener_requestcredentials_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        authmechanism: ::windows_sys::core::PCSTR,
        peername: ::windows_sys::core::PCSTR,
        authcount: u16,
        username: ::windows_sys::core::PCSTR,
        credmask: u16,
        credentials: alljoyn_credentials,
    ) -> i32,
>;
pub type alljoyn_authlistener_requestcredentialsasync_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
...
>;
pub type alljoyn_authlistener_securityviolation_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        status: QStatus,
        msg: alljoyn_message,
...
>;
pub type alljoyn_authlistener_verifycredentials_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        authmechanism: ::windows_sys::core::PCSTR,
        peername: ::windows_sys::core::PCSTR,
...
>;
pub type alljoyn_authlistener_verifycredentialsasync_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        listener: alljoyn_authlistener,
        authmechanism: ::windows_sys::core::PCSTR,
...
>;
pub type alljoyn_autopinger_destination_found_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        group: ::windows_sys::core::PCSTR,
        destination: ::windows_sys::core::PCSTR,
    ) -> (),
>;
pub type alljoyn_autopinger_destination_lost_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        group: ::windows_sys::core::PCSTR,
        destination: ::windows_sys::core::PCSTR,
...
>;
pub type alljoyn_busattachment_joinsessioncb_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        status: QStatus,
        sessionid: u32,
...
>;
pub type alljoyn_busattachment_setlinktimeoutcb_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        status: QStatus,
        timeout: u32,
        context: *mut ::core::ffi::c_void,
...
pub type alljoyn_buslistener_bus_prop_changed_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        prop_name: ::windows_sys::core::PCSTR,
        prop_value: alljoyn_msgarg,
    ) -> (),
>;
pub type alljoyn_buslistener_bus_stopping_ptr =
    ::core::option::Option<unsafe extern "system" fn(context: *const ::core::ffi::c_void) -> ()>;
pub type alljoyn_buslistener_found_advertised_name_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        name: ::windows_sys::core::PCSTR,
        transport: u16,
        nameprefix: ::windows_sys::core::PCSTR,
    ) -> (),
>;
pub type alljoyn_buslistener_listener_registered_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
...
pub type alljoyn_buslistener_listener_unregistered_ptr =
    ::core::option::Option<unsafe extern "system" fn(context: *const ::core::ffi::c_void) -> ()>;
pub type alljoyn_buslistener_lost_advertised_name_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        name: ::windows_sys::core::PCSTR,
        transport: u16,
...
>;
pub type alljoyn_buslistener_name_owner_changed_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        busname: ::windows_sys::core::PCSTR,
        previousowner: ::windows_sys::core::PCSTR,
        newowner: ::windows_sys::core::PCSTR,
    ) -> (),
>;
pub type alljoyn_busobject_object_registration_ptr =
    ::core::option::Option<unsafe extern "system" fn(context: *const ::core::ffi::c_void) -> ()>;
pub type alljoyn_busobject_prop_get_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        ifcname: ::windows_sys::core::PCSTR,
        propname: ::windows_sys::core::PCSTR,
        val: alljoyn_msgarg,
    ) -> QStatus,
>;
pub type alljoyn_busobject_prop_set_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        ifcname: ::windows_sys::core::PCSTR,
        propname: ::windows_sys::core::PCSTR,
...
>;
pub type alljoyn_interfacedescription_translation_callback_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        sourcelanguage: ::windows_sys::core::PCSTR,
        targetlanguage: ::windows_sys::core::PCSTR,
        sourcetext: ::windows_sys::core::PCSTR,
    ) -> ::windows_sys::core::PCSTR,
>;
pub type alljoyn_keystorelistener_acquireexclusivelock_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        listener: alljoyn_keystorelistener,
    ) -> QStatus,
>;
pub type alljoyn_keystorelistener_loadrequest_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        listener: alljoyn_keystorelistener,
...
>;
pub type alljoyn_keystorelistener_releaseexclusivelock_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        listener: alljoyn_keystorelistener,
    ) -> (),
>;
pub type alljoyn_keystorelistener_storerequest_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        listener: alljoyn_keystorelistener,
        keystore: alljoyn_keystore,
...
>;
pub type alljoyn_messagereceiver_methodhandler_ptr = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type alljoyn_messagereceiver_replyhandler_ptr = ::core::option::Option<
    unsafe extern "system" fn(message: alljoyn_message, context: *mut ::core::ffi::c_void) -> (),
>;
pub type alljoyn_messagereceiver_signalhandler_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        member: *const alljoyn_interfacedescription_member,
        srcpath: ::windows_sys::core::PCSTR,
        message: alljoyn_message,
    ) -> (),
>;
pub type alljoyn_observer_object_discovered_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        proxyref: alljoyn_proxybusobject_ref,
    ) -> (),
>;
pub type alljoyn_observer_object_lost_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        proxyref: alljoyn_proxybusobject_ref,
    ) -> (),
...
pub type alljoyn_permissionconfigurationlistener_endmanagement_ptr =
    ::core::option::Option<unsafe extern "system" fn(context: *const ::core::ffi::c_void) -> ()>;
pub type alljoyn_permissionconfigurationlistener_factoryreset_ptr = ::core::option::Option<
    unsafe extern "system" fn(context: *const ::core::ffi::c_void) -> QStatus,
>;
...
pub type alljoyn_permissionconfigurationlistener_startmanagement_ptr =
    ::core::option::Option<unsafe extern "system" fn(context: *const ::core::ffi::c_void) -> ()>;
pub type alljoyn_proxybusobject_listener_getallpropertiescb_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        status: QStatus,
...
>;
pub type alljoyn_proxybusobject_listener_getpropertycb_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        status: QStatus,
        obj: alljoyn_proxybusobject,
...
>;
pub type alljoyn_proxybusobject_listener_introspectcb_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        status: QStatus,
        obj: alljoyn_proxybusobject,
        context: *mut ::core::ffi::c_void,
...
>;
pub type alljoyn_proxybusobject_listener_propertieschanged_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        obj: alljoyn_proxybusobject,
        ifacename: ::windows_sys::core::PCSTR,
        changed: alljoyn_msgarg,
        invalidated: alljoyn_msgarg,
        context: *mut ::core::ffi::c_void,
    ) -> (),
>;
pub type alljoyn_proxybusobject_listener_setpropertycb_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        status: QStatus,
        obj: alljoyn_proxybusobject,
        context: *mut ::core::ffi::c_void,
...
>;
pub type alljoyn_sessionlistener_sessionlost_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        sessionid: u32,
...
>;
pub type alljoyn_sessionlistener_sessionmemberadded_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        sessionid: u32,
        uniquename: ::windows_sys::core::PCSTR,
    ) -> (),
>;
pub type alljoyn_sessionlistener_sessionmemberremoved_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        sessionid: u32,
        uniquename: ::windows_sys::core::PCSTR,
...
>;
pub type alljoyn_sessionportlistener_acceptsessionjoiner_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        sessionport: u16,
        joiner: ::windows_sys::core::PCSTR,
        opts: alljoyn_sessionopts,
    ) -> i32,
>;
pub type alljoyn_sessionportlistener_sessionjoined_ptr = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const ::core::ffi::c_void,
        sessionport: u16,
        id: u32,

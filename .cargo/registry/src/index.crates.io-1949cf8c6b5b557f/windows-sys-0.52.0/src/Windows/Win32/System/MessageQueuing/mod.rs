...
pub const MACHINE_ACTION_DISCONNECT: ::windows_sys::core::PCWSTR =
...
pub const MGMT_QUEUE_NOT_TRANSACTIONAL_TYPE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("NO");
pub const MGMT_QUEUE_REMOTE_LOCATION: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("REMOTE");
pub const MGMT_QUEUE_STATE_CONNECTED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CONNECTED");
pub const MGMT_QUEUE_STATE_DISCONNECTED: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DISCONNECTED");
pub const MGMT_QUEUE_STATE_DISCONNECTING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DISCONNECTING");
pub const MGMT_QUEUE_STATE_LOCAL: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("LOCAL CONNECTION");
pub const MGMT_QUEUE_STATE_LOCKED: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("LOCKED");
pub const MGMT_QUEUE_STATE_NEED_VALIDATE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("NEED VALIDATION");
pub const MGMT_QUEUE_STATE_NONACTIVE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("INACTIVE");
pub const MGMT_QUEUE_STATE_ONHOLD: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("ONHOLD");
pub const MGMT_QUEUE_STATE_WAITING: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("WAITING");
pub const MGMT_QUEUE_TRANSACTIONAL_TYPE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("YES");
pub const MGMT_QUEUE_TYPE_CONNECTOR: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CONNECTOR");
pub const MGMT_QUEUE_TYPE_MACHINE: ::windows_sys::core::PCWSTR = ::windows_sys::core::w!("MACHINE");
pub const MGMT_QUEUE_TYPE_MULTICAST: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MULTICAST");
...
pub const MQ_QTYPE_REPORT: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x55ee8f32_cce9_11cf_b108_0020afd61ce9);
pub const MQ_QTYPE_TEST: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x55ee8f33_cce9_11cf_b108_0020afd61ce9);
...
pub const MSMQApplication: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xd7d6e086_dccd_11d0_aa4b_0060970debae);
pub const MSMQCollection: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xf72b9031_2f0c_43e8_924e_e6052cdc493f);
pub const MSMQCoordinatedTransactionDispenser: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xd7d6e082_dccd_11d0_aa4b_0060970debae);
pub const MSMQDestination: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xeba96b18_2168_11d3_898c_00e02c074f6b);
pub const MSMQEvent: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xd7d6e07a_dccd_11d0_aa4b_0060970debae);
pub const MSMQManagement: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x39ce96fe_f4c5_4484_a143_4c2d5d324229);
pub const MSMQMessage: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xd7d6e075_dccd_11d0_aa4b_0060970debae);
pub const MSMQOutgoingQueueManagement: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x0188401c_247a_4fed_99c6_bf14119d7055);
pub const MSMQQuery: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xd7d6e073_dccd_11d0_aa4b_0060970debae);
pub const MSMQQueue: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xd7d6e079_dccd_11d0_aa4b_0060970debae);
pub const MSMQQueueInfo: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xd7d6e07c_dccd_11d0_aa4b_0060970debae);
pub const MSMQQueueInfos: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xd7d6e07e_dccd_11d0_aa4b_0060970debae);
pub const MSMQQueueManagement: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x33b6d07e_f27d_42fa_b2d7_bf82e11e9374);
pub const MSMQTransaction: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xd7d6e080_dccd_11d0_aa4b_0060970debae);
pub const MSMQTransactionDispenser: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xd7d6e084_dccd_11d0_aa4b_0060970debae);
...
pub const QUEUE_ACTION_EOD_RESEND: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("EOD_RESEND");
...
pub type PMQRECEIVECALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        hrstatus: ::windows_sys::core::HRESULT,
        hsource: isize,
        dwtimeout: u32,
        dwaction: u32,
        pmessageprops: *mut MQMSGPROPS,
        lpoverlapped: *mut super::IO::OVERLAPPED,
        hcursor: super::super::Foundation::HANDLE,
    ) -> (),
>;

...
pub type pCryptSIPCreateIndirectData = ::core::option::Option<
...
pub type pCryptSIPGetCaps = ::core::option::Option<
    unsafe extern "system" fn(
...
pub type pCryptSIPGetSealedDigest = ::core::option::Option<
    unsafe extern "system" fn(
...
pub type pCryptSIPGetSignedDataMsg = ::core::option::Option<
    unsafe extern "system" fn(
        psubjectinfo: *mut SIP_SUBJECTINFO,
...
pub type pCryptSIPPutSignedDataMsg = ::core::option::Option<
    unsafe extern "system" fn(
        psubjectinfo: *mut SIP_SUBJECTINFO,
        dwencodingtype: u32,
        pdwindex: *mut u32,
...
pub type pCryptSIPRemoveSignedDataMsg = ::core::option::Option<
    unsafe extern "system" fn(
        psubjectinfo: *mut SIP_SUBJECTINFO,
        dwindex: u32,
    ) -> super::super::super::Foundation::BOOL,
...
pub type pCryptSIPVerifyIndirectData = ::core::option::Option<
    unsafe extern "system" fn(
        psubjectinfo: *mut SIP_SUBJECTINFO,
        pindirectdata: *mut SIP_INDIRECT_DATA,
    ) -> super::super::super::Foundation::BOOL,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type pfnIsFileSupported = ::core::option::Option<
    unsafe extern "system" fn(
        hfile: super::super::super::Foundation::HANDLE,
        pgsubject: *mut ::windows_sys::core::GUID,
    ) -> super::super::super::Foundation::BOOL,
>;
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type pfnIsFileSupportedName = ::core::option::Option<
    unsafe extern "system" fn(

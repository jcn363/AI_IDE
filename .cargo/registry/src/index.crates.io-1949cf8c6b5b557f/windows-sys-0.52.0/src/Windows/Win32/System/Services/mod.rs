...
pub const CUSTOM_SYSTEM_STATE_CHANGE_EVENT_GUID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x2d7a2816_0c5e_45fc_9ce7_570e5ecde9c9);
pub const DOMAIN_JOIN_GUID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x1ce20aba_9851_4421_9430_1ddeb766e809);
pub const DOMAIN_LEAVE_GUID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xddaf516e_58c2_4866_9574_c3b615d42ea1);
pub const FIREWALL_PORT_CLOSE_GUID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xa144ed38_8e12_4de4_9d96_e64740b1a524);
pub const FIREWALL_PORT_OPEN_GUID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xb7569e07_8421_4ee0_ad10_86915afdad09);
pub const MACHINE_POLICY_PRESENT_GUID: ::windows_sys::core::GUID =
...
pub const NAMED_PIPE_EVENT_GUID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x1f81d131_3fac_4537_9e0c_7e7b0c2f4b55);
pub const NETWORK_MANAGER_FIRST_IP_ADDRESS_ARRIVAL_GUID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x4f27f2de_14e2_430b_a549_7cd48cbc8245);
pub const NETWORK_MANAGER_LAST_IP_ADDRESS_REMOVAL_GUID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xcc4ba62a_162e_4648_847a_b6bdf993e335);
pub const RPC_INTERFACE_EVENT_GUID: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xbc90d167_9470_4139_a9ba_be0bbbf5b74d);
...
pub const SC_AGGREGATE_STORAGE_KEY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("System\\CurrentControlSet\\Control\\ServiceAggregatedEvents");
...
pub const SERVICES_ACTIVE_DATABASE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ServicesActive");
pub const SERVICES_ACTIVE_DATABASEA: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("ServicesActive");
pub const SERVICES_ACTIVE_DATABASEW: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ServicesActive");
pub const SERVICES_FAILED_DATABASE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ServicesFailed");
pub const SERVICES_FAILED_DATABASEA: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("ServicesFailed");
pub const SERVICES_FAILED_DATABASEW: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ServicesFailed");
...
pub const SERVICE_TRIGGER_STARTED_ARGUMENT: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("TriggerStarted");
...
pub const USER_POLICY_PRESENT_GUID: ::windows_sys::core::GUID =
...
pub type HANDLER_FUNCTION_EX = ::core::option::Option<
...
pub type LPHANDLER_FUNCTION =
    ::core::option::Option<unsafe extern "system" fn(dwcontrol: u32) -> ()>;
...
pub type LPSERVICE_MAIN_FUNCTIONA = ::core::option::Option<
    unsafe extern "system" fn(
        ...
        lpserviceargvectors: *mut ::windows_sys::core::PSTR,
    ) -> (),
>;
pub type LPSERVICE_MAIN_FUNCTIONW = ::core::option::Option<
    unsafe extern "system" fn(
        dwnumservicesargs: u32,
        lpserviceargvectors: *mut ::windows_sys::core::PWSTR,
    ) -> (),
>;
pub type PFN_SC_NOTIFY_CALLBACK =
    ::core::option::Option<unsafe extern "system" fn(pparameter: *const ::core::ffi::c_void) -> ()>;
pub type PSC_NOTIFICATION_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(dwnotify: u32, pcallbackcontext: *const ::core::ffi::c_void) -> (),
>;
pub type SERVICE_MAIN_FUNCTIONA = ::core::option::Option<
    unsafe extern "system" fn(dwnumservicesargs: u32, lpserviceargvectors: *mut *mut i8) -> (),
>;
pub type SERVICE_MAIN_FUNCTIONW = ::core::option::Option<
    unsafe extern "system" fn(
        dwnumservicesargs: u32,
        lpserviceargvectors: *mut ::windows_sys::core::PWSTR,
    ) -> (),

...
pub const GUID_HUPR_ADAPTIVE_DIM_TIMEOUT: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0xcf8c6097_12b8_4279_bbdd_44601ee5209d);
pub const GUID_HUPR_ADAPTIVE_DISPLAY_TIMEOUT: ::windows_sys::core::GUID =
...
pub const GUID_PROCESSOR_CORE_PARKING_OVER_UTILIZATION_HISTORY_THRESHOLD:
    ::windows_sys::core::GUID =
...
pub const IMAGE_POLICY_SECTION_NAME: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!(".tPolicy");
...
>;
pub type PIMAGE_TLS_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
pub type POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type PUMS_SCHEDULER_ENTRY_POINT = ::core::option::Option<
    unsafe extern "system" fn(

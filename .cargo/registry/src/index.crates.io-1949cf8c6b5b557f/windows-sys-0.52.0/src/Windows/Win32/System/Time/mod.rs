...
pub const wszW32TimeRegKeyPolicyTimeProviders: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Software\\Policies\\Microsoft\\W32Time\\TimeProviders");
pub const wszW32TimeRegKeyTimeProviders: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("System\\CurrentControlSet\\Services\\W32Time\\TimeProviders");
pub const wszW32TimeRegValueDllName: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("DllName");
pub const wszW32TimeRegValueEnabled: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("Enabled");
pub const wszW32TimeRegValueInputProvider: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("InputProvider");
pub const wszW32TimeRegValueMetaDataProvider: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("MetaDataProvider");
#[repr(C)]

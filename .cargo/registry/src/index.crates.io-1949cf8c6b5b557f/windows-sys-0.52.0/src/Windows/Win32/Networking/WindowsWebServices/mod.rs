...
pub const WS_DEFAULT_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE:
    WS_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE = 2i32;
...
pub const WS_EXCLUSIVE_WITH_COMMENTS_XML_CANONICALIZATION_ALGORITHM:
    WS_XML_CANONICALIZATION_ALGORITHM = 1i32;
...
pub const WS_HTTP_HEADER_AUTH_SECURITY_BINDING_CONSTRAINT_TYPE:
    WS_SECURITY_BINDING_CONSTRAINT_TYPE = 3i32;
...
pub const WS_HTTP_SSL_KERBEROS_APREQ_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE:
    WS_BINDING_TEMPLATE_TYPE = 11i32;
...
pub const WS_INCLUSIVE_WITH_COMMENTS_XML_CANONICALIZATION_ALGORITHM:
    WS_XML_CANONICALIZATION_ALGORITHM = 3i32;
...
pub const WS_ISSUED_TOKEN_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE:
    WS_SECURITY_BINDING_CONSTRAINT_TYPE = 6i32;
pub const WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE:
    WS_SECURITY_BINDING_CONSTRAINT_TYPE = 5i32;
...
pub const WS_OPAQUE_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE:
    WS_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE = 3i32;
...
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_BEARER_KEY_TYPE_VERSION:
    WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID = 13i32;
...
pub const WS_REQUEST_SECURITY_TOKEN_PROPERTY_SERVICE_REQUEST_PARAMETERS:
    WS_REQUEST_SECURITY_TOKEN_PROPERTY_ID = 11i32;
...
pub const WS_SECURITY_BINDING_PROPERTY_CERTIFICATE_VALIDATION_CALLBACK_CONTEXT:
    WS_SECURITY_BINDING_PROPERTY_ID = 23i32;
...
pub const WS_SECURITY_BINDING_PROPERTY_SECURE_CONVERSATION_VERSION:
    WS_SECURITY_BINDING_PROPERTY_ID = 16i32;
pub const WS_SECURITY_BINDING_PROPERTY_SECURITY_CONTEXT_KEY_ENTROPY_MODE:
    WS_SECURITY_BINDING_PROPERTY_ID = 12i32;
...
pub const WS_SECURITY_CONTEXT_PROPERTY_MESSAGE_SECURITY_WINDOWS_TOKEN:
    WS_SECURITY_CONTEXT_PROPERTY_ID = 3i32;
...
pub const WS_STRING_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE:
    WS_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE = 1i32;
...
pub const WS_TCP_SSPI_KERBEROS_APREQ_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE:
    WS_BINDING_TEMPLATE_TYPE = 13i32;
pub const WS_TCP_SSPI_TRANSPORT_SECURITY_BINDING_CONSTRAINT_TYPE:
    WS_SECURITY_BINDING_CONSTRAINT_TYPE = 2i32;
...
pub const WS_USERNAME_MESSAGE_SECURITY_BINDING_CONSTRAINT_TYPE:
    WS_SECURITY_BINDING_CONSTRAINT_TYPE = 4i32;
...
pub type WS_ABANDON_MESSAGE_CALLBACK = ::core::option::Option<
...
>;
pub type WS_ABORT_CHANNEL_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        channelinstance: *const ::core::ffi::c_void,
        error: *const WS_ERROR,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type WS_ABORT_LISTENER_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        listenerinstance: *const ::core::ffi::c_void,
        error: *const WS_ERROR,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type WS_ACCEPT_CHANNEL_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        listenerinstance: *const ::core::ffi::c_void,
        channelinstance: *const ::core::ffi::c_void,
...
>;
pub type WS_ASYNC_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        errorcode: ::windows_sys::core::HRESULT,
        callbackmodel: WS_CALLBACK_MODEL,
        callbackstate: *const ::core::ffi::c_void,
    ) -> (),
>;
pub type WS_ASYNC_FUNCTION = ::core::option::Option<
    unsafe extern "system" fn(
...
#[doc = "Required features: `\"Win32_Foundation\"`, `\"Win32_Security_Cryptography\"`"]
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security_Cryptography"))]
pub type WS_CERTIFICATE_VALIDATION_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
pub type WS_CLOSE_CHANNEL_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        channelinstance: *const ::core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
>;
pub type WS_CLOSE_LISTENER_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        listenerinstance: *const ::core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
>;
pub type WS_CREATE_CHANNEL_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type WS_CREATE_CHANNEL_FOR_LISTENER_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        listenerinstance: *const ::core::ffi::c_void,
        channelparameters: *const ::core::ffi::c_void,
        channelparameterssize: u32,
...
>;
pub type WS_CREATE_DECODER_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type WS_CREATE_ENCODER_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        createcontext: *const ::core::ffi::c_void,
...
>;
pub type WS_CREATE_LISTENER_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        channeltype: WS_CHANNEL_TYPE,
...
>;
pub type WS_DECODER_DECODE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type WS_DECODER_END_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        encodercontext: *const ::core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
>;
pub type WS_DECODER_GET_CONTENT_TYPE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type WS_DECODER_START_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        encodercontext: *const ::core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type WS_DURATION_COMPARISON_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type WS_DYNAMIC_STRING_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        callbackstate: *const ::core::ffi::c_void,
...
>;
pub type WS_ENCODER_ENCODE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        encodercontext: *const ::core::ffi::c_void,
...
>;
pub type WS_ENCODER_END_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        encodercontext: *const ::core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
>;
pub type WS_ENCODER_GET_CONTENT_TYPE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        encodercontext: *const ::core::ffi::c_void,
        contenttype: *const WS_STRING,
        newcontenttype: *mut WS_STRING,
...
>;
pub type WS_ENCODER_START_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        encodercontext: *const ::core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
>;
pub type WS_FREE_CHANNEL_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(channelinstance: *const ::core::ffi::c_void) -> (),
>;
pub type WS_FREE_DECODER_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(decodercontext: *const ::core::ffi::c_void) -> (),
>;
pub type WS_FREE_ENCODER_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(encodercontext: *const ::core::ffi::c_void) -> (),
>;
pub type WS_FREE_LISTENER_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(listenerinstance: *const ::core::ffi::c_void) -> (),
>;
#[doc = "Required features: `\"Win32_Foundation\"`, `\"Win32_Security_Cryptography\"`"]
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security_Cryptography"))]
pub type WS_GET_CERT_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type WS_GET_CHANNEL_PROPERTY_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        channelinstance: *const ::core::ffi::c_void,
...
>;
pub type WS_GET_LISTENER_PROPERTY_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        listenerinstance: *const ::core::ffi::c_void,
...
>;
pub type WS_HTTP_REDIRECT_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        state: *const ::core::ffi::c_void,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type WS_IS_DEFAULT_VALUE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type WS_MESSAGE_DONE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(donecallbackstate: *const ::core::ffi::c_void) -> (),
>;
pub type WS_OPEN_CHANNEL_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        channelinstance: *const ::core::ffi::c_void,
...
>;
pub type WS_OPEN_LISTENER_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        listenerinstance: *const ::core::ffi::c_void,
        url: *const WS_STRING,
        asynccontext: *const WS_ASYNC_CONTEXT,
...
>;
pub type WS_OPERATION_CANCEL_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
pub type WS_OPERATION_FREE_STATE_CALLBACK =
    ::core::option::Option<unsafe extern "system" fn(state: *const ::core::ffi::c_void) -> ()>;
pub type WS_PROXY_MESSAGE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        message: *const WS_MESSAGE,
        heap: *const WS_HEAP,
        state: *const ::core::ffi::c_void,
...
>;
pub type WS_PULL_BYTES_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        callbackstate: *const ::core::ffi::c_void,
...
>;
pub type WS_PUSH_BYTES_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        callbackstate: *const ::core::ffi::c_void,
        writecallback: WS_WRITE_CALLBACK,
...
>;
pub type WS_READ_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        callbackstate: *const ::core::ffi::c_void,
        bytes: *mut ::core::ffi::c_void,
        maxsize: u32,
...
>;
pub type WS_READ_MESSAGE_END_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        channelinstance: *const ::core::ffi::c_void,
        message: *const WS_MESSAGE,
        asynccontext: *const WS_ASYNC_CONTEXT,
...
>;
pub type WS_READ_MESSAGE_START_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        channelinstance: *const ::core::ffi::c_void,
        message: *const WS_MESSAGE,
        asynccontext: *const WS_ASYNC_CONTEXT,
...
>;
pub type WS_READ_TYPE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type WS_RESET_CHANNEL_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        channelinstance: *const ::core::ffi::c_void,
        error: *const WS_ERROR,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type WS_RESET_LISTENER_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        listenerinstance: *const ::core::ffi::c_void,
        error: *const WS_ERROR,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type WS_SERVICE_ACCEPT_CHANNEL_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type WS_SERVICE_CLOSE_CHANNEL_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const WS_OPERATION_CONTEXT,
        asynccontext: *const WS_ASYNC_CONTEXT,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type WS_SERVICE_MESSAGE_RECEIVE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const WS_OPERATION_CONTEXT,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type WS_SERVICE_SECURITY_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const WS_OPERATION_CONTEXT,
...
>;
pub type WS_SERVICE_STUB_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        context: *const WS_OPERATION_CONTEXT,
...
>;
pub type WS_SET_CHANNEL_PROPERTY_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        channelinstance: *const ::core::ffi::c_void,
        id: WS_CHANNEL_PROPERTY_ID,
        value: *const ::core::ffi::c_void,
...
>;
pub type WS_SET_LISTENER_PROPERTY_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        listenerinstance: *const ::core::ffi::c_void,
        id: WS_LISTENER_PROPERTY_ID,
        value: *const ::core::ffi::c_void,
...
>;
pub type WS_SHUTDOWN_SESSION_CHANNEL_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        channelinstance: *const ::core::ffi::c_void,
        asynccontext: *const WS_ASYNC_CONTEXT,
        error: *const WS_ERROR,
...
>;
pub type WS_VALIDATE_PASSWORD_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type WS_VALIDATE_SAML_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type WS_WRITE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        callbackstate: *const ::core::ffi::c_void,
        buffers: *const WS_BYTES,
        count: u32,
...
>;
pub type WS_WRITE_MESSAGE_END_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        channelinstance: *const ::core::ffi::c_void,
        message: *const WS_MESSAGE,
        asynccontext: *const WS_ASYNC_CONTEXT,
...
>;
pub type WS_WRITE_MESSAGE_START_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
        channelinstance: *const ::core::ffi::c_void,
        message: *const WS_MESSAGE,
        asynccontext: *const WS_ASYNC_CONTEXT,
...
>;
pub type WS_WRITE_TYPE_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(

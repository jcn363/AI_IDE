...
>;
pub type GLUtessEdgeFlagDataProc = ::core::option::Option<
    unsafe extern "system" fn(param0: u8, param1: *mut ::core::ffi::c_void) -> (),
>;
...
pub type GLUtessVertexProc =
    ::core::option::Option<unsafe extern "system" fn(param0: *mut ::core::ffi::c_void) -> ()>;
pub type PFNGLADDSWAPHINTRECTWINPROC = ::core::option::Option<
...
>;
pub type PFNGLGETCOLORTABLEPARAMETERIVEXTPROC = ::core::option::Option<

...
pub type CounterPathCallBack =
    ::core::option::Option<unsafe extern "system" fn(param0: usize) -> i32>;
pub type PERFLIBREQUEST = ::core::option::Option<
...
>;
pub type PERF_MEM_ALLOC = ::core::option::Option<
    unsafe extern "system" fn(
        allocsize: usize,
        pcontext: *mut ::core::ffi::c_void,
    ) -> *mut ::core::ffi::c_void,
>;
pub type PERF_MEM_FREE = ::core::option::Option<
    unsafe extern "system" fn(
        pbuffer: *mut ::core::ffi::c_void,
        pcontext: *mut ::core::ffi::c_void,
    ) -> (),
>;
pub type PLA_CABEXTRACT_CALLBACK = ::core::option::Option<
    unsafe extern "system" fn(
...
pub type PM_COLLECT_PROC = ::core::option::Option<
    unsafe extern "system" fn(
...
pub type PM_OPEN_PROC =
    ::core::option::Option<unsafe extern "system" fn(pcontext: ::windows_sys::core::PCWSTR) -> u32>;

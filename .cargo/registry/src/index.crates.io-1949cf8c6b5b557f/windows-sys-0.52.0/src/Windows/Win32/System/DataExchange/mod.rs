...
pub const SZDDESYS_ITEM_RTNMSG: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("ReturnMessage");
...
pub const SZDDE_ITEM_ITEMLIST: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("TopicItemList");
...
pub type PFNCALLBACK = ::core::option::Option<

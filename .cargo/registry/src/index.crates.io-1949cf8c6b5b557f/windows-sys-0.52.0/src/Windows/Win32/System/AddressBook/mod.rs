...
pub const E_IMAPI_RAW_IMAGE_TRACK_INDEX_OFFSET_ZERO_CANNOT_BE_CLEARED:
    ::windows_sys::core::HRESULT = -2136339959i32;
...
pub const OPENSTREAMONFILE: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("OpenStreamOnFile");
...
pub type CALLERRELEASE = ::core::option::Option<
    unsafe extern "system" fn(ulcallerdata: u32, lptbldata: ITableData, lpvue: IMAPITable) -> (),
>;
pub type LPALLOCATEBUFFER = ::core::option::Option<
    unsafe extern "system" fn(cbsize: u32, lppbuffer: *mut *mut ::core::ffi::c_void) -> i32,
>;
...
pub type LPDISPATCHNOTIFICATIONS =
    ::core::option::Option<unsafe extern "system" fn(ulflags: u32) -> ::windows_sys::core::HRESULT>;
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
...
pub type LPFNDISMISS = ::core::option::Option<
    unsafe extern "system" fn(uluiparam: usize, lpvcontext: *mut ::core::ffi::c_void) -> (),
>;
pub type LPFREEBUFFER =
    ::core::option::Option<unsafe extern "system" fn(lpbuffer: *mut ::core::ffi::c_void) -> u32>;
#[doc = "Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`"]
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
...
pub type LPOPENSTREAMONFILE = ::core::option::Option<
    unsafe extern "system" fn(
        ...
        lpszprefix: *const i8,
        lppstream: *mut super::Com::IStream,
    ) -> ::windows_sys::core::HRESULT,
>;
pub type LPWABALLOCATEBUFFER = ::core::option::Option<
    unsafe extern "system" fn(
...
>;
pub type LPWABALLOCATEMORE = ::core::option::Option<
    unsafe extern "system" fn(
        lpwabobject: IWABObject,
        cbsize: u32,
        lpobject: *mut ::core::ffi::c_void,
...
>;
pub type LPWABFREEBUFFER = ::core::option::Option<
    unsafe extern "system" fn(lpwabobject: IWABObject, lpbuffer: *mut ::core::ffi::c_void) -> u32,
>;
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type LPWABOPEN = ::core::option::Option<
    unsafe extern "system" fn(
        lppadrbook: *mut IAddrBook,
        lppwabobject: *mut IWABObject,
        lpwp: *mut WAB_PARAM,
        reserved2: u32,
    ) -> ::windows_sys::core::HRESULT,
>;
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type LPWABOPENEX = ::core::option::Option<
    unsafe extern "system" fn(
        lppadrbook: *mut IAddrBook,
        lppwabobject: *mut IWABObject,
        lpwp: *mut WAB_PARAM,

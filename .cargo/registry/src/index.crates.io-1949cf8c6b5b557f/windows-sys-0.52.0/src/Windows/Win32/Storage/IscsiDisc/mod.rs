...
pub const DD_SCSI_DEVICE_NAME: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("\\Device\\ScsiPort");
...
pub const IOCTL_MINIPORT_SIGNATURE_DSM_GENERAL: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("MPDSMGEN");
pub const IOCTL_MINIPORT_SIGNATURE_DSM_NOTIFICATION: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("MPDSM   ");
pub const IOCTL_MINIPORT_SIGNATURE_ENDURANCE_INFO: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("ENDURINF");
pub const IOCTL_MINIPORT_SIGNATURE_FIRMWARE: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("FIRMWARE");
pub const IOCTL_MINIPORT_SIGNATURE_HYBRDISK: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("HYBRDISK");
pub const IOCTL_MINIPORT_SIGNATURE_QUERY_PHYSICAL_TOPOLOGY: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("TOPOLOGY");
pub const IOCTL_MINIPORT_SIGNATURE_QUERY_PROTOCOL: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("PROTOCOL");
pub const IOCTL_MINIPORT_SIGNATURE_QUERY_TEMPERATURE: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("TEMPERAT");
pub const IOCTL_MINIPORT_SIGNATURE_SCSIDISK: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("SCSIDISK");
pub const IOCTL_MINIPORT_SIGNATURE_SET_PROTOCOL: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("SETPROTO");
pub const IOCTL_MINIPORT_SIGNATURE_SET_TEMPERATURE_THRESHOLD: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("SETTEMPT");
...
pub const ISCSI_LOGIN_OPTIONS_AUTH_TYPE: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000080");
pub const ISCSI_LOGIN_OPTIONS_DATA_DIGEST: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000002");
pub const ISCSI_LOGIN_OPTIONS_DEFAULT_TIME_2_RETAIN: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000010");
pub const ISCSI_LOGIN_OPTIONS_DEFAULT_TIME_2_WAIT: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000008");
pub const ISCSI_LOGIN_OPTIONS_HEADER_DIGEST: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000001");
pub const ISCSI_LOGIN_OPTIONS_MAXIMUM_CONNECTIONS: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000004");
pub const ISCSI_LOGIN_OPTIONS_PASSWORD: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000040");
pub const ISCSI_LOGIN_OPTIONS_USERNAME: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000020");
...
pub const ISCSI_SECURITY_FLAG_AGGRESSIVE_MODE_ENABLED: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000008");
pub const ISCSI_SECURITY_FLAG_IKE_IPSEC_ENABLED: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000002");
pub const ISCSI_SECURITY_FLAG_MAIN_MODE_ENABLED: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000004");
pub const ISCSI_SECURITY_FLAG_PFS_ENABLED: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000010");
pub const ISCSI_SECURITY_FLAG_TRANSPORT_MODE_PREFERRED: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000020");
pub const ISCSI_SECURITY_FLAG_TUNNEL_MODE_PREFERRED: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000040");
pub const ISCSI_SECURITY_FLAG_VALID: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("0x00000001");
...
pub const ScsiRawInterfaceGuid: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x53f56309_b6bf_11d0_94f2_00a0c91efb8b);
pub const TargetAlias: TARGET_INFORMATION_CLASS = 1i32;
pub const TargetFlags: TARGET_INFORMATION_CLASS = 6i32;
pub const WmiScsiAddressGuid: ::windows_sys::core::GUID =
    ::windows_sys::core::GUID::from_u128(0x53f5630f_b6bf_11d0_94f2_00a0c91efb8b);
...
pub type PDUMP_DEVICE_POWERON_ROUTINE =
    ::core::option::Option<unsafe extern "system" fn(context: *const ::core::ffi::c_void) -> i32>;

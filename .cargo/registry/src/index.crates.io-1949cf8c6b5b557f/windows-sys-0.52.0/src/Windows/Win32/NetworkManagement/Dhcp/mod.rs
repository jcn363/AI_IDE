...
pub const DHCP_CALLOUT_ENTRY_POINT: ::windows_sys::core::PCSTR =
    ::windows_sys::core::s!("DhcpServerCalloutEntry");
pub const DHCP_CALLOUT_LIST_KEY: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("System\\CurrentControlSet\\Services\\DHCPServer\\Parameters");
pub const DHCP_CALLOUT_LIST_VALUE: ::windows_sys::core::PCWSTR =
    ::windows_sys::core::w!("CalloutDlls");
...
pub type LPDHCP_CONTROL = ::core::option::Option<
    unsafe extern "system" fn(dwcontrolcode: u32, lpreserved: *mut ::core::ffi::c_void) -> u32,
>;
pub type LPDHCP_DELETE_CLIENT = ::core::option::Option<
...
>;
pub type LPDHCP_DROP_SEND = ::core::option::Option<
    unsafe extern "system" fn(
        packet: *mut *mut u8,
        packetsize: *mut u32,
        controlcode: u32,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type LPDHCP_ENTRY_POINT_FUNC = ::core::option::Option<
    unsafe extern "system" fn(
        chaindlls: ::windows_sys::core::PCWSTR,
        calloutversion: u32,
        callouttbl: *mut DHCP_CALLOUT_TABLE,
    ) -> u32,
>;
pub type LPDHCP_GIVE_ADDRESS = ::core::option::Option<
    unsafe extern "system" fn(
        packet: *mut u8,
        packetsize: u32,
        controlcode: u32,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type LPDHCP_HANDLE_OPTIONS = ::core::option::Option<
    unsafe extern "system" fn(
        packet: *mut u8,
        packetsize: u32,
        reserved: *mut ::core::ffi::c_void,
...
#[doc = "Required features: `\"Win32_Foundation\"`"]
#[cfg(feature = "Win32_Foundation")]
pub type LPDHCP_NEWPKT = ::core::option::Option<
    unsafe extern "system" fn(
        packet: *mut *mut u8,
        packetsize: *mut u32,
        ipaddress: u32,
        ...
        processit: *mut super::super::Foundation::BOOL,
    ) -> u32,
>;
pub type LPDHCP_PROB = ::core::option::Option<
    unsafe extern "system" fn(
        packet: *mut u8,
        packetsize: u32,
        controlcode: u32,

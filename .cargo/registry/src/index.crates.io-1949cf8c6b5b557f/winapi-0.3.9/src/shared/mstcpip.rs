...
extern "system" {
    pub fn RtlIpv4AddressToStringA(Addr: *const IN_ADDR, S: PSTR) -> PSTR;
    ...
    pub fn RtlIpv4AddressToStringW(Addr: *const IN_ADDR, S: PWSTR) -> PWSTR;
    ...
    pub fn RtlIpv6AddressToStringA(Addr: *const IN6_ADDR, S: PSTR) -> PSTR;
    ...
    pub fn RtlIpv6AddressToStringW(Addr: *const IN6_ADDR, S: PWSTR) -> PWSTR;
    ...
    pub fn RtlIpv6StringToAddressA(S: PCSTR, Terminator: *mut PCSTR, Addr: *mut IN6_ADDR) -> LONG;
    ...
    pub fn RtlIpv6StringToAddressW(S: PCWSTR, Terminator: *mut PCWSTR, Addr: *mut IN6_ADDR)
        -> LONG;
...
extern "system" {
    pub fn RtlEthernetAddressToStringA(Addr: *const DL_EUI48, S: PSTR) -> PSTR;
    pub fn RtlEthernetAddressToStringW(Addr: *const DL_EUI48, S: PWSTR) -> PWSTR;

...
pub const OID_DOT11_STATISTICS: u32 = NWF_DEFINE_OID!(131, NWF_STATISTICS_OID, NWF_MANDATORY_OID);
...
pub const OID_DOT11_IBSS_PARAMS: u32 = NWF_DEFINE_OID!(155, NWF_OPERATIONAL_OID, NWF_MANDATORY_OID);
...
pub const DOT11_CONNECTION_STATUS_PHY_POWER_DOWN: DOT11_ASSOC_STATUS = DOT11_ASSOC_STATUS_RADIO_OFF;
...
pub const OID_DOT11_START_AP_REQUEST: u32 = NWF_DEFINE_OID!(0x02, NWF_EXTAP_OID, NWF_MANDATORY_OID);

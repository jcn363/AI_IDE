...
extern "system" {
    ...
    pub fn NetServerGetInfo(servername: LMSTR, level: DWORD, bufptr: *mut LPBYTE)
        -> NET_API_STATUS;
    ...
    pub fn NetServerComputerNameDel(ServerName: LMSTR, EmulatedServerName: LMSTR)
        -> NET_API_STATUS;
    pub fn NetServerTransportAdd(servername: LMSTR, level: DWORD, bufptr: LPBYTE)
        -> NET_API_STATUS;
    ...
    pub fn NetServerTransportDel(servername: LMSTR, level: DWORD, bufptr: LPBYTE)
        -> NET_API_STATUS;
...
pub const SV_MAXNONPAGEDMEMORYUSAGE_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_MAXNONPAGEDMEMORYUSAGE_PARMNUM;
pub const SV_MAXPAGEDMEMORYUSAGE_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_MAXPAGEDMEMORYUSAGE_PARMNUM;
pub const SV_ENABLESOFTCOMPAT_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_ENABLESOFTCOMPAT_PARMNUM;
pub const SV_ENABLEFORCEDLOGOFF_INFOLEVEL: DWORD =
...
pub const SV_MAXCOPYWRITELEN_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + SV_MAXCOPYWRITELEN_PARMNUM;
...
pub const SV_MINKEEPCOMPLSEARCH_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_MINKEEPCOMPLSEARCH_PARMNUM;
pub const SV_MAXKEEPCOMPLSEARCH_INFOLEVEL: DWORD =
...
pub const SV_MINFREEWORKITEMS_INFOLEVEL: DWORD =
...
pub const SV_OPLOCKBREAKWAIT_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + SV_OPLOCKBREAKWAIT_PARMNUM;
pub const SV_OPLOCKBREAKRESPONSEWAIT_INFOLEVEL: DWORD =
...
pub const SV_ENABLEOPLOCKFORCECLOSE_INFOLEVEL: DWORD =
...
pub const SV_ENABLESHAREDNETDRIVES_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_ENABLESHAREDNETDRIVES_PARMNUM;
pub const SV_MINFREECONNECTIONS_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_MINFREECONNECTIONS_PARMNUM;
pub const SV_MAXFREECONNECTIONS_INFOLEVEL: DWORD =
...
pub const SV_INITSEARCHTABLE_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + SV_INITSEARCHTABLE_PARMNUM;
...
pub const SV_NETWORKERRORTHRESHOLD_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_NETWORKERRORTHRESHOLD_PARMNUM;
pub const SV_DISKSPACETHRESHOLD_INFOLEVEL: DWORD =
...
pub const SV_MINLINKTHROUGHPUT_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_MINLINKTHROUGHPUT_PARMNUM;
pub const SV_LINKINFOVALIDTIME_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_LINKINFOVALIDTIME_PARMNUM;
pub const SV_SCAVQOSINFOUPDATETIME_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_SCAVQOSINFOUPDATETIME_PARMNUM;
pub const SV_MAXWORKITEMIDLETIME_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_MAXWORKITEMIDLETIME_PARMNUM;
pub const SV_MAXRAWWORKITEMS_INFOLOEVEL: DWORD =
...
pub const SV_MAXFREEPAGEDPOOLCHUNKS_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_MAXFREEPAGEDPOOLCHUNKS_PARMNUM;
pub const SV_MINPAGEDPOOLCHUNKSIZE_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_MINPAGEDPOOLCHUNKSIZE_PARMNUM;
pub const SV_MAXPAGEDPOOLCHUNKSIZE_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_MAXPAGEDPOOLCHUNKSIZE_PARMNUM;
pub const SV_SENDSFROMPREFERREDPROCESSOR_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_SENDSFROMPREFERREDPROCESSOR_PARMNUM;
pub const SV_MAXTHREADSPERQUEUE_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_MAXTHREADSPERQUEUE_PARMNUM;
pub const SV_CACHEDDIRECTORYLIMIT_INFOLEVEL: DWORD =
...
pub const SV_ENABLECOMPRESSION_INFOLEVEL: DWORD =
...
pub const SV_AUTOSHARESERVER_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + SV_AUTOSHARESERVER_PARMNUM;
pub const SV_ENABLESECURITYSIGNATURE_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_ENABLESECURITYSIGNATURE_PARMNUM;
pub const SV_REQUIRESECURITYSIGNATURE_INFOLEVEL: DWORD =
...
pub const SV_CONNECTIONNOSESSIONSTIMEOUT_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_CONNECTIONNOSESSIONSTIMEOUT_PARMNUM;
pub const SV_IDLETHREADTIMEOUT_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_IDLETHREADTIMEOUT_PARMNUM;
pub const SV_ENABLEW9XSECURITYSIGNATURE_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_ENABLEW9XSECURITYSIGNATURE_PARMNUM;
pub const SV_ENFORCEKERBEROSREAUTHENTICATION_INFOLEVEL: DWORD =
...
pub const SV_LOWDISKSPACEMINIMUM_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_LOWDISKSPACEMINIMUM_PARMNUM;
pub const SV_DISABLESTRICTNAMECHECKING_INFOLEVEL: DWORD =
    PARMNUM_BASE_INFOLEVEL + SV_DISABLESTRICTNAMECHECKING_PARMNUM;
pub const SV_ENABLEAUTHENTICATEUSERSHARING_INFOLEVEL: DWORD =
...
pub const SVTI2_VALID_FLAGS: DWORD = SVTI2_REMAP_PIPE_NAMES
    | SVTI2_SCOPED_NAME
    | SVTI2_CLUSTER_NAME

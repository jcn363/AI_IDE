...
pub const WLAN_REASON_CODE_AC_CONNECT_BASE: WLAN_REASON_CODE =
    WLAN_REASON_CODE_AC_BASE + WLAN_REASON_CODE_RANGE_SIZE / 2;
pub const WLAN_REASON_CODE_AC_END: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_PROFILE_CONNECT_BASE: WLAN_REASON_CODE =
    WLAN_REASON_CODE_PROFILE_BASE + WLAN_REASON_CODE_RANGE_SIZE / 2;
pub const WLAN_REASON_CODE_PROFILE_END: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_MSM_CONNECT_BASE: WLAN_REASON_CODE =
    WLAN_REASON_CODE_MSM_BASE + WLAN_REASON_CODE_RANGE_SIZE / 2;
pub const WLAN_REASON_CODE_MSM_END: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_MSMSEC_CONNECT_BASE: WLAN_REASON_CODE =
    WLAN_REASON_CODE_MSMSEC_BASE + WLAN_REASON_CODE_RANGE_SIZE / 2;
pub const WLAN_REASON_CODE_MSMSEC_END: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_NO_AUTO_CONNECTION: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_IN_BLOCKED_LIST: WLAN_REASON_CODE = WLAN_REASON_CODE_AC_CONNECT_BASE + 7;
pub const WLAN_REASON_CODE_SSID_LIST_TOO_LONG: WLAN_REASON_CODE =
    WLAN_REASON_CODE_AC_CONNECT_BASE + 8;
pub const WLAN_REASON_CODE_CONNECT_CALL_FAIL: WLAN_REASON_CODE =
    WLAN_REASON_CODE_AC_CONNECT_BASE + 9;
pub const WLAN_REASON_CODE_SCAN_CALL_FAIL: WLAN_REASON_CODE = WLAN_REASON_CODE_AC_CONNECT_BASE + 10;
...
pub const WLAN_REASON_CODE_USER_NOT_RESPOND: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_INVALID_PROFILE_SCHEMA: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_INVALID_PROFILE_NAME: WLAN_REASON_CODE =
    WLAN_REASON_CODE_PROFILE_BASE + 3;
pub const WLAN_REASON_CODE_INVALID_PROFILE_TYPE: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_MSM_SECURITY_MISSING: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_IHV_SETTINGS_MISSING: WLAN_REASON_CODE =
    WLAN_REASON_CODE_PROFILE_BASE + 10;
pub const WLAN_REASON_CODE_CONFLICT_SECURITY: WLAN_REASON_CODE = WLAN_REASON_CODE_PROFILE_BASE + 11;
...
pub const WLAN_REASON_CODE_PROFILE_SSID_INVALID: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_UNSUPPORTED_SECURITY_SET: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_USER_CANCELLED: WLAN_REASON_CODE = WLAN_REASON_CODE_MSM_CONNECT_BASE + 1;
...
pub const WLAN_REASON_CODE_SECURITY_FAILURE: WLAN_REASON_CODE =
    WLAN_REASON_CODE_MSM_CONNECT_BASE + 6;
pub const WLAN_REASON_CODE_SECURITY_TIMEOUT: WLAN_REASON_CODE =
    WLAN_REASON_CODE_MSM_CONNECT_BASE + 7;
pub const WLAN_REASON_CODE_ROAMING_FAILURE: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_IHV_NOT_AVAILABLE: WLAN_REASON_CODE =
    WLAN_REASON_CODE_MSM_CONNECT_BASE + 13;
pub const WLAN_REASON_CODE_IHV_NOT_RESPONDING: WLAN_REASON_CODE =
    WLAN_REASON_CODE_MSM_CONNECT_BASE + 14;
pub const WLAN_REASON_CODE_DISCONNECT_TIMEOUT: WLAN_REASON_CODE =
    WLAN_REASON_CODE_MSM_CONNECT_BASE + 15;
pub const WLAN_REASON_CODE_INTERNAL_FAILURE: WLAN_REASON_CODE =
    WLAN_REASON_CODE_MSM_CONNECT_BASE + 16;
pub const WLAN_REASON_CODE_UI_REQUEST_TIMEOUT: WLAN_REASON_CODE =
...
pub const WLAN_REASON_CODE_MSMSEC_CAPABILITY_NIC: WLAN_REASON_CODE =
...
pub const WLAN_WRITE_ACCESS: DWORD = WLAN_READ_ACCESS
    | WLAN_EXECUTE_ACCESS
    | STANDARD_RIGHTS_WRITE
    | FILE_WRITE_DATA
    | DELETE
...
extern "system" {
    ...
    pub fn WlanCloseHandle(hClientHandle: HANDLE, pReserved: PVOID) -> DWORD;
    ...
    pub fn WlanAllocateMemory(dwMemorySize: DWORD) -> PVOID;
    pub fn WlanFreeMemory(pMemory: PVOID);
...
extern "system" {
    ...
    pub fn WFDCloseHandle(hClientHandle: HANDLE) -> DWORD;
}
...
extern "system" {
    ...
    pub fn WFDCancelOpenSession(hSessionHandle: HANDLE) -> DWORD;
    ...
    pub fn WFDCloseSession(hSessionHandle: HANDLE) -> DWORD;
    pub fn WFDUpdateDeviceVisibility(pDeviceAddress: PDOT11_MAC_ADDRESS) -> DWORD;
}

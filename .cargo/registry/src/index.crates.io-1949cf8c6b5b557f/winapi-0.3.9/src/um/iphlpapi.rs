...
extern "system" {
    ...
    pub fn GetIpNetTable(IpNetTable: PMIB_IPNETTABLE, SizePointer: PULONG, Order: BOOL) -> ULONG;
    pub fn GetIpForwardTable(
        pIpForwardTable: PMIB_IPFORWARDTABLE,
        pdwSize: PULONG,
        bOrder: BOOL,
    ) -> DWORD;
    pub fn GetTcpTable(TcpTable: PMIB_TCPTABLE, SizePointer: PULONG, Order: BOOL) -> ULONG;
    ...
    pub fn GetUdpTable(UdpTable: PMIB_UDPTABLE, SizePointer: PULONG, Order: BOOL) -> ULONG;
    ...
    pub fn GetTcpTable2(TcpTable: PMIB_TCPTABLE2, SizePointer: PULONG, Order: BOOL) -> ULONG;
    ...
    pub fn GetTcp6Table(TcpTable: PMIB_TCP6TABLE, SizePointer: PULONG, Order: BOOL) -> ULONG;
    pub fn GetTcp6Table2(TcpTable: PMIB_TCP6TABLE2, SizePointer: PULONG, Order: BOOL) -> ULONG;
    ...
    pub fn GetUdp6Table(Udp6Table: PMIB_UDP6TABLE, SizePointer: PULONG, Order: BOOL) -> ULONG;
    ...
    pub fn GetIpStatistics(Statistics: PMIB_IPSTATS) -> ULONG;
    pub fn GetIcmpStatistics(Statistics: PMIB_ICMP) -> ULONG;
    pub fn GetTcpStatistics(Statistics: PMIB_TCPSTATS) -> ULONG;
    pub fn GetUdpStatistics(Stats: PMIB_UDPSTATS) -> ULONG;
    pub fn SetIpStatisticsEx(Statistics: PMIB_IPSTATS, Family: ULONG) -> ULONG;
    pub fn GetIpStatisticsEx(Statistics: PMIB_IPSTATS, Family: ULONG) -> ULONG;
    pub fn GetIcmpStatisticsEx(Statistics: PMIB_ICMP_EX, Family: ULONG) -> ULONG;
    pub fn GetTcpStatisticsEx(Statistics: PMIB_TCPSTATS, Family: ULONG) -> ULONG;
    pub fn GetUdpStatisticsEx(Statistics: PMIB_UDPSTATS, Family: ULONG) -> ULONG;
    pub fn GetTcpStatisticsEx2(Statistics: PMIB_TCPSTATS2, Family: ULONG) -> ULONG;
    pub fn GetUdpStatisticsEx2(Statistics: PMIB_UDPSTATS2, Family: ULONG) -> ULONG;
    ...
    pub fn SetIpTTL(nTTL: UINT) -> DWORD;
    pub fn CreateIpNetEntry(pArpEntry: PMIB_IPNETROW) -> DWORD;
    pub fn SetIpNetEntry(pArpEntry: PMIB_IPNETROW) -> DWORD;
    pub fn DeleteIpNetEntry(pArpEntry: PMIB_IPNETROW) -> DWORD;
    pub fn FlushIpNetTable(dwIfIndex: DWORD) -> DWORD;
    pub fn CreateProxyArpEntry(dwAddress: DWORD, dwMask: DWORD, dwIfIndex: DWORD) -> DWORD;
    pub fn DeleteProxyArpEntry(dwAddress: DWORD, dwMask: DWORD, dwIfIndex: DWORD) -> DWORD;
    ...
    pub fn GetBestInterfaceEx(pDestAddr: PSOCKADDR, pdwBestIfIndex: PDWORD) -> DWORD;
    pub fn GetBestRoute(
        dwDestAddr: DWORD,
        dwSourceAddr: DWORD,
        pBestRoute: PMIB_IPFORWARDROW,
    ) -> DWORD;
    pub fn NotifyAddrChange(Handle: PHANDLE, overlapped: LPOVERLAPPED) -> DWORD;
    pub fn NotifyRouteChange(Handle: PHANDLE, overlapped: LPOVERLAPPED) -> DWORD;
    pub fn CancelIPChangeNotify(notifyOverlapped: LPOVERLAPPED) -> BOOL;
    ...
    pub fn GetNetworkParams(pFixedInfo: PFIXED_INFO, pOutBufLen: PULONG) -> DWORD;
...
pub type PINTERFACE_TIMESTAMP_CONFIG_CHANGE_CALLBACK =
    *mut INTERFACE_TIMESTAMP_CONFIG_CHANGE_CALLBACK;
extern "system" {
    ...
    pub fn CancelIfTimestampConfigChange(NotificationHandle: HIFTIMESTAMPCHANGE);
    ...
    pub fn DisableMediaSense(pHandle: *mut HANDLE, pOverLapped: *mut OVERLAPPED) -> DWORD;
    pub fn RestoreMediaSense(pOverlapped: *mut OVERLAPPED, lpdwEnableCount: LPDWORD) -> DWORD;
    pub fn GetIpErrorString(ErrorCode: IP_STATUS, Buffer: PWSTR, Size: PDWORD) -> DWORD;
    ...
    pub fn DeletePersistentTcpPortReservation(StartPort: USHORT, NumberOfPorts: USHORT) -> ULONG;
    pub fn DeletePersistentUdpPortReservation(StartPort: USHORT, NumberOfPorts: USHORT) -> ULONG;

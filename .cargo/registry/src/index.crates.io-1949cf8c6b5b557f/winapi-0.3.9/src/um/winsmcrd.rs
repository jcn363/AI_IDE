...
pub const IOCTL_SMARTCARD_POWER: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 1, METHOD_BUFFERED, FILE_ANY_ACCESS);
pub const IOCTL_SMARTCARD_GET_ATTRIBUTE: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 2, METHOD_BUFFERED, FILE_ANY_ACCESS);
pub const IOCTL_SMARTCARD_SET_ATTRIBUTE: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 3, METHOD_BUFFERED, FILE_ANY_ACCESS);
pub const IOCTL_SMARTCARD_CONFISCATE: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 4, METHOD_BUFFERED, FILE_ANY_ACCESS);
pub const IOCTL_SMARTCARD_TRANSMIT: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 5, METHOD_BUFFERED, FILE_ANY_ACCESS);
pub const IOCTL_SMARTCARD_EJECT: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 6, METHOD_BUFFERED, FILE_ANY_ACCESS);
pub const IOCTL_SMARTCARD_SWALLOW: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 7, METHOD_BUFFERED, FILE_ANY_ACCESS);
pub const IOCTL_SMARTCARD_IS_PRESENT: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 10, METHOD_BUFFERED, FILE_ANY_ACCESS);
pub const IOCTL_SMARTCARD_IS_ABSENT: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 11, METHOD_BUFFERED, FILE_ANY_ACCESS);
pub const IOCTL_SMARTCARD_SET_PROTOCOL: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 12, METHOD_BUFFERED, FILE_ANY_ACCESS);
pub const IOCTL_SMARTCARD_GET_STATE: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 14, METHOD_BUFFERED, FILE_ANY_ACCESS);
pub const IOCTL_SMARTCARD_GET_LAST_ERROR: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 15, METHOD_BUFFERED, FILE_ANY_ACCESS);
pub const IOCTL_SMARTCARD_GET_PERF_CNTR: DWORD =
    CTL_CODE!(FILE_DEVICE_SMARTCARD, 16, METHOD_BUFFERED, FILE_ANY_ACCESS);

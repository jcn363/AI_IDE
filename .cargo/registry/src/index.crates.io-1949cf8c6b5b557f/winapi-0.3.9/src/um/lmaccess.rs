...
pub const UF_MACHINE_ACCOUNT_MASK: DWORD =
    UF_INTERDOMAIN_TRUST_ACCOUNT | UF_WORKSTATION_TRUST_ACCOUNT | UF_SERVER_TRUST_ACCOUNT;
pub const UF_ACCOUNT_TYPE_MASK: DWORD = UF_TEMP_DUPLICATE_ACCOUNT
    | UF_NORMAL_ACCOUNT
...
pub const UF_SETTABLE_BITS: DWORD = UF_SCRIPT
    | UF_ACCOUNTDISABLE
    | UF_LOCKOUT
    | UF_HOMEDIR_REQUIRED
    | UF_PASSWD_NOTREQD
...
pub const USER_PASSWORD_AGE_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_PASSWORD_AGE_PARMNUM;
...
pub const USER_SCRIPT_PATH_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_SCRIPT_PATH_PARMNUM;
...
pub const USER_USR_COMMENT_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_USR_COMMENT_PARMNUM;
pub const USER_PARMS_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_PARMS_PARMNUM;
pub const USER_WORKSTATIONS_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_WORKSTATIONS_PARMNUM;
pub const USER_LAST_LOGON_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_LAST_LOGON_PARMNUM;
pub const USER_LAST_LOGOFF_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_LAST_LOGOFF_PARMNUM;
pub const USER_ACCT_EXPIRES_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_ACCT_EXPIRES_PARMNUM;
...
pub const USER_LOGON_HOURS_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_LOGON_HOURS_PARMNUM;
pub const USER_PAD_PW_COUNT_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_PAD_PW_COUNT_PARMNUM;
pub const USER_NUM_LOGONS_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_NUM_LOGONS_PARMNUM;
pub const USER_LOGON_SERVER_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_LOGON_SERVER_PARMNUM;
pub const USER_COUNTRY_CODE_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_COUNTRY_CODE_PARMNUM;
pub const USER_CODE_PAGE_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_CODE_PAGE_PARMNUM;
pub const USER_PRIMARY_GROUP_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + USER_PRIMARY_GROUP_PARMNUM;
...
pub const MODALS_DOMAIN_NAME_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + MODALS_DOMAIN_NAME_PARMNUM;
...
pub const ACCESS_ALL: DWORD = ACCESS_READ
    | ACCESS_WRITE
    | ACCESS_CREATE
    | ACCESS_EXEC
    | ACCESS_DELETE
...
pub const ACCESS_ACCESS_LIST_INFOLEVEL: DWORD = PARMNUM_BASE_INFOLEVEL + ACCESS_ACCESS_LIST_PARMNUM;
...
extern "system" {
    pub fn NetEnumerateTrustedDomains(ServerName: LPWSTR, DomainNames: *mut LPWSTR) -> NTSTATUS;
}

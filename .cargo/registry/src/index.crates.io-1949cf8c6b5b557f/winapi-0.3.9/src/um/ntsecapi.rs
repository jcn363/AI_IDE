...
pub const POLICY_ALL_ACCESS: ACCESS_MASK = STANDARD_RIGHTS_REQUIRED
    ...
    | POLICY_SERVER_ADMIN
    | POLICY_LOOKUP_NAMES;
pub const POLICY_READ: ACCESS_MASK =
    STANDARD_RIGHTS_READ | POLICY_VIEW_AUDIT_INFORMATION | POLICY_GET_PRIVATE_INFORMATION;
pub const POLICY_WRITE: ACCESS_MASK = STANDARD_RIGHTS_WRITE
    | POLICY_TRUST_ADMIN
    | POLICY_CREATE_ACCOUNT
    | POLICY_CREATE_SECRET
    | POLICY_CREATE_PRIVILEGE
    ...
    | POLICY_AUDIT_LOG_ADMIN
    | POLICY_SERVER_ADMIN;
pub const POLICY_EXECUTE: ACCESS_MASK =
...
pub use self::{
    SystemFunction036 as RtlGenRandom,
    SystemFunction040 as RtlEncryptMemory,
    SystemFunction041 as RtlDecryptMemory,
};
extern "system" {
...
extern "system" {
    pub fn SystemFunction040(Memory: PVOID, MemorySize: ULONG, OptionFlags: ULONG) -> NTSTATUS;
    pub fn SystemFunction041(Memory: PVOID, MemorySize: ULONG, OptionFlags: ULONG) -> NTSTATUS;
}
...
pub const AUDIT_GENERIC_ALL: ULONG = STANDARD_RIGHTS_REQUIRED
...
pub const AUDIT_GENERIC_READ: ULONG = STANDARD_RIGHTS_READ
    ...
    | AUDIT_ENUMERATE_USERS
    | AUDIT_QUERY_MISC_POLICY;
pub const AUDIT_GENERIC_WRITE: ULONG =
    STANDARD_RIGHTS_WRITE | AUDIT_SET_USER_POLICY | AUDIT_SET_MISC_POLICY | AUDIT_SET_SYSTEM_POLICY;
...
extern "system" {
    ...
    pub fn AuditEnumeratePerUserPolicy(ppAuditSidArray: *mut PPOLICY_AUDIT_SID_ARRAY) -> BOOLEAN;
    ...
    pub fn AuditSetGlobalSaclW(ObjectTypeName: PCWSTR, Acl: PACL) -> BOOLEAN;
    pub fn AuditSetGlobalSaclA(ObjectTypeName: PCSTR, Acl: PACL) -> BOOLEAN;
    pub fn AuditQueryGlobalSaclW(ObjectTypeName: PCWSTR, Acl: *mut PACL) -> BOOLEAN;
    pub fn AuditQueryGlobalSaclA(ObjectTypeName: PCSTR, Acl: *mut PACL) -> BOOLEAN;

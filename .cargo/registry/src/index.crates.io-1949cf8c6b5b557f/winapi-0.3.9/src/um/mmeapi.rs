...
extern "system" {
    ...
    pub fn midiStreamOut(hMidiStream: HMIDISTRM, lpMidiHdr: LPMIDIHDR, cbMidiHdr: UINT)
        -> MMRESULT;
    ...
    pub fn midiOutLongMsg(hmo: HMIDIOUT, lpMidiOutHdr: LPMIDIHDR, cbMidiOutHdr: UINT) -> MMRESULT;
    ...
    pub fn midiInAddBuffer(hMidiIn: HMIDIIN, lpMidiInHdr: LPMIDIHDR, cbMidiInHdr: UINT)
        -> MMRESULT;

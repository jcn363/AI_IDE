...
#[inline]
pub fn LSAP_SE_ADT_PARAMETER_ARRAY_TRUE_SIZE(AuditParameters: SE_ADT_PARAMETER_ARRAY) -> SIZE_T {
...
pub const POLICY_AUDIT_EVENT_MASK: ULONG = POLICY_AUDIT_EVENT_SUCCESS
...
extern "system" {
    ...
    pub fn LsaConnectUntrusted(LsaHandle: PHANDLE) -> NTSTATUS;
}
extern "C" {
    pub fn LsaInsertProtectedProcessAddress(BufferAddress: PVOID, BufferSize: ULONG) -> NTSTATUS;
    pub fn LsaRemoveProtectedProcessAddress(BufferAddress: PVOID, BufferSize: ULONG) -> NTSTATUS;
}
...
pub const POLICY_ALL_ACCESS: ULONG = STANDARD_RIGHTS_REQUIRED
    ...
    | POLICY_SERVER_ADMIN
    | POLICY_LOOKUP_NAMES;
pub const POLICY_READ: ULONG =
    STANDARD_RIGHTS_READ | POLICY_VIEW_AUDIT_INFORMATION | POLICY_GET_PRIVATE_INFORMATION;
pub const POLICY_WRITE: ULONG = STANDARD_RIGHTS_WRITE
    | POLICY_TRUST_ADMIN
    | POLICY_CREATE_ACCOUNT
    | POLICY_CREATE_SECRET
    | POLICY_CREATE_PRIVILEGE
    ...
    | POLICY_AUDIT_LOG_ADMIN
    | POLICY_SERVER_ADMIN;
pub const POLICY_EXECUTE: ULONG =
...
pub const POLICY_MODE_ALL: ULONG = POLICY_MODE_INTERACTIVE
    | POLICY_MODE_NETWORK
    | POLICY_MODE_BATCH
    | POLICY_MODE_SERVICE
    | POLICY_MODE_PROXY
...
pub const POLICY_MODE_ALL_NT4: ULONG =
    POLICY_MODE_INTERACTIVE | POLICY_MODE_NETWORK | POLICY_MODE_BATCH | POLICY_MODE_SERVICE;
...
pub const ACCOUNT_ALL_ACCESS: ULONG = STANDARD_RIGHTS_REQUIRED
    | ACCOUNT_VIEW
    | ACCOUNT_ADJUST_PRIVILEGES
    | ACCOUNT_ADJUST_QUOTAS
    | ACCOUNT_ADJUST_SYSTEM_ACCESS;
pub const ACCOUNT_READ: ULONG = STANDARD_RIGHTS_READ | ACCOUNT_VIEW;
pub const ACCOUNT_WRITE: ULONG = STANDARD_RIGHTS_WRITE
    | ACCOUNT_ADJUST_PRIVILEGES
    | ACCOUNT_ADJUST_QUOTAS
    | ACCOUNT_ADJUST_SYSTEM_ACCESS;
...
pub const TRUSTED_ALL_ACCESS: ULONG = STANDARD_RIGHTS_REQUIRED
...
pub const TRUSTED_WRITE: ULONG =
    STANDARD_RIGHTS_WRITE | TRUSTED_SET_CONTROLLERS | TRUSTED_SET_POSIX | TRUSTED_SET_AUTH;
pub const TRUSTED_EXECUTE: ULONG =
    STANDARD_RIGHTS_EXECUTE | TRUSTED_QUERY_CONTROLLERS | TRUSTED_QUERY_POSIX;
...
pub const SECRET_ALL_ACCESS: ULONG =
    STANDARD_RIGHTS_REQUIRED | SECRET_SET_VALUE | SECRET_QUERY_VALUE;
...
extern "system" {
    pub fn LsaFreeMemory(Buffer: PVOID) -> NTSTATUS;
    pub fn LsaClose(ObjectHandle: LSA_HANDLE) -> NTSTATUS;
    pub fn LsaDelete(ObjectHandle: LSA_HANDLE) -> NTSTATUS;
...
extern "system" {
    pub fn LsaSetCAPs(CAPDNs: PLSA_UNICODE_STRING, CAPDNCount: ULONG, Flags: ULONG) -> NTSTATUS;
    ...
    pub fn LsaClearAuditLog(PolicyHandle: LSA_HANDLE) -> NTSTATUS;
    ...
    pub fn LsaGetSystemAccessAccount(AccountHandle: LSA_HANDLE, SystemAccess: PULONG) -> NTSTATUS;
    pub fn LsaSetSystemAccessAccount(AccountHandle: LSA_HANDLE, SystemAccess: ULONG) -> NTSTATUS;
...
extern "system" {
    ...
    pub fn LsaDeleteTrustedDomain(PolicyHandle: LSA_HANDLE, TrustedDomainSid: PSID) -> NTSTATUS;
    ...
    pub fn LsaNtStatusToWinError(Status: NTSTATUS) -> ULONG;
}
...
extern "system" {
    pub fn LsaSetPolicyReplicationHandle(PolicyHandle: PLSA_HANDLE) -> NTSTATUS;
}
...
extern "system" {
    pub fn LsaGetDeviceRegistrationInfo(RegistrationInfo: *mut PLSA_REGISTRATION_INFO) -> NTSTATUS;
}
...
extern "C" {
    pub fn SeciIsProtectedUser(ProtectedUser: PBOOLEAN) -> NTSTATUS;
}

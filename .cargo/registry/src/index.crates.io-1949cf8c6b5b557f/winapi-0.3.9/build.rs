...
const DATA: &'static [(
    ...
    (
        "d3dkmthk",
        &["basetsd", "d3dukmdt", "minwindef", "ntdef", "windef"],
        &[],
    ),
    // mmos
    // shared
    ...
    (
        "bthioctl",
        &["bthdef", "bthsdpdef", "minwindef", "ntdef", "winioctl"],
        &[],
    ),
    ("bthsdpdef", &["guiddef", "minwindef", "ntdef"], &[]),
    ("bugcodes", &["ntdef"], &[]),
    ...
    (
        "d3d9caps",
        &["d3d9types", "guiddef", "minwindef", "winnt"],
        &[],
    ),
    (
        "d3d9types",
        &["basetsd", "guiddef", "minwindef", "windef", "winnt"],
        &[],
    ),
    ("d3dkmdt", &["basetsd", "minwindef", "ntdef"], &[]),
    (
        "d3dukmdt",
        &["basetsd", "guiddef", "minwindef", "ntdef"],
        &[],
    ),
    ...
    (
        "enclaveapi",
        &["basetsd", "minwinbase", "minwindef", "ntdef", "winnt"],
        &["kernel32"],
    ),
    (
        "evntprov",
        &["basetsd", "guiddef", "minwindef", "winnt"],
        &["advapi32"],
    ),
    (
        "evntrace",
    ...
    (
        "hidclass",
        &["guiddef", "minwindef", "winioctl", "winnt"],
        &[],
    ),
    (
        "hidpi",
        &["hidusage", "minwindef", "ntdef", "ntstatus", "winnt"],
        &["hid"],
    ),
    (
        "hidsdi",
        &["guiddef", "hidpi", "minwindef", "winnt"],
        &["hid"],
    ),
    ("hidusage", &["minwindef"], &[]),
    ...
    (
        "ipmib",
        &["ifdef", "ifmib", "minwindef", "nldef", "ntdef"],
        &[],
    ),
    ...
    (
        "ntddscsi",
        &["basetsd", "minwindef", "ntdef", "winioctl", "winnt"],
        &[],
    ),
    ("ntddser", &["devpropdef"], &[]),
    ...
    (
        "windot11",
        &["basetsd", "minwindef", "ntddndis", "winnt", "wlantypes"],
        &[],
    ),
    ("windowsx", &["minwindef"], &[]),
    ...
    (
        "ws2ipdef",
        &["in6addr", "inaddr", "minwindef", "ws2def"],
        &[],
    ),
    (
        "wtypes",
    ...
    (
        "accctrl",
        &["guiddef", "minwindef", "winbase", "winnt"],
        &[],
    ),
    (
        "aclapi",
        &["accctrl", "guiddef", "minwindef", "winnt"],
        &["advapi32"],
    ),
    (
        "adhoc",
        &["guiddef", "minwindef", "unknwnbase", "winnt"],
        &[],
    ),
    ...
    (
        "bits",
        &["basetsd", "guiddef", "minwindef", "unknwnbase", "winnt"],
        &[],
    ),
    (
        "bits10_1",
    ...
    (
        "bits2_0",
        &["basetsd", "bits", "bits1_5", "minwindef", "winnt"],
        &[],
    ),
    (
        "bits2_5",
        &["minwindef", "rpcndr", "unknwnbase", "winnt"],
        &[],
    ),
    (
        "bits3_0",
    ...
    (
        "bits4_0",
        &["basetsd", "bits3_0", "minwindef", "unknwnbase", "winnt"],
        &[],
    ),
    (
        "bits5_0",
    ...
    (
        "bitscfg",
        &["guiddef", "oaidl", "unknwnbase", "winnt", "wtypes"],
        &["oleaut32"],
    ),
    ("bitsmsg", &["minwindef"], &[]),
    (
    ...
    (
        "bluetoothleapis",
        &["bthledef", "minwindef", "winerror", "winnt"],
        &["bluetoothapis"],
    ),
    (
        "bthledef",
    ...
    (
        "commapi",
        &["minwinbase", "minwindef", "winbase", "winnt"],
        &["kernel32"],
    ),
    (
        "commctrl",
    ...
    (
        "consoleapi",
        &["minwindef", "wincon", "wincontypes", "winnt"],
        &["kernel32"],
    ),
    (
        "corsym",
        &["basetsd", "objidlbase", "unknwnbase", "winnt"],
        &[],
    ),
    (
        "d2d1",
    ...
    (
        "d2d1_2",
        &["d2d1", "d2d1_1", "dxgi", "minwindef", "winnt"],
        &["d2d1"],
    ),
    (
        "d2d1_3",
    ...
    (
        "d3d10shader",
        &["d3d10", "d3dcommon", "minwindef", "unknwnbase", "winnt"],
        &[],
    ),
    (
        "d3d11",
    ...
    (
        "d3d11shader",
        &["basetsd", "d3dcommon", "minwindef", "unknwnbase", "winnt"],
        &[],
    ),
    ...
    (
        "d3d12sdklayers",
        &["basetsd", "d3d12", "minwindef", "unknwnbase", "winnt"],
        &[],
    ),
    (
        "d3d12shader",
    ...
    (
        "d3dcommon",
        &["basetsd", "minwindef", "unknwnbase", "winnt"],
        &[],
    ),
    (
        "d3dcompiler",
    ...
    (
        "datetimeapi",
        &["minwinbase", "minwindef", "winnt"],
        &["kernel32"],
    ),
    ("davclnt", &["minwindef", "winnt"], &["netapi32"]),
    (
        "dbghelp",
        &["basetsd", "guiddef", "minwindef", "vcruntime", "winnt"],
        &["dbghelp"],
    ),
    (
        "dbt",
        &["basetsd", "guiddef", "minwindef", "winnt", "winuser"],
        &[],
    ),
    (
        "dcommon",
        &["basetsd", "dxgiformat", "minwindef", "windef"],
        &[],
    ),
    (
        "dcomp",
    ...
    (
        "docobj",
        &["guiddef", "minwindef", "oaidl", "unknwnbase", "winnt"],
        &[],
    ),
    (
        "documenttarget",
        &["basetsd", "guiddef", "ntdef", "unknwnbase"],
        &[],
    ),
    (
        "dot1x",
        &["eaptypes", "guiddef", "l2cmn", "minwindef", "winnt"],
        &[],
    ),
    ("dpa_dsa", &["basetsd", "minwindef", "winnt"], &["comctl32"]),
    (
        "dpapi",
        &["minwindef", "wincrypt", "windef", "winnt"],
        &["crypt32"],
    ),
    (
        "dsgetdc",
        &["guiddef", "minwindef", "ntsecapi", "winnt", "ws2def"],
        &["netapi32"],
    ),
    (
        "dsound",
    ...
    (
        "dwmapi",
        &["basetsd", "minwindef", "uxtheme", "windef", "winnt"],
        &["dwmapi"],
    ),
    (
        "dwrite",
    ...
    (
        "dwrite_1",
        &["basetsd", "dcommon", "dwrite", "minwindef", "winnt"],
        &[],
    ),
    (
        "dwrite_2",
    ...
    (
        "exdisp",
        &["basetsd", "docobj", "oaidl", "ocidl", "winnt", "wtypes"],
        &[],
    ),
    ...
    (
        "heapapi",
        &["basetsd", "minwinbase", "minwindef", "winnt"],
        &["kernel32"],
    ),
    (
        "highlevelmonitorconfigurationapi",
        &["minwindef", "physicalmonitorenumerationapi", "winnt"],
        &["dxva2"],
    ),
    (
        "http",
    ...
    (
        "ktmw32",
        &["guiddef", "minwinbase", "minwindef", "winnt"],
        &["ktmw32"],
    ),
    ...
    (
        "lmaccess",
        &["basetsd", "lmcons", "minwindef", "winnt"],
        &["netapi32"],
    ),
    ...
    (
        "lmdfs",
        &["guiddef", "lmcons", "minwindef", "winnt"],
        &["netapi32"],
    ),
    ("lmerrlog", &["minwindef", "winnt"], &[]),
    (
        "lmjoin",
        &["lmcons", "minwindef", "wincrypt", "winnt"],
        &["netapi32"],
    ),
    ...
    (
        "lmserver",
        &["guiddef", "lmcons", "minwindef", "winnt", "winsvc"],
        &["advapi32", "netapi32"],
    ),
    (
        "lmshare",
        &["basetsd", "guiddef", "lmcons", "minwindef", "winnt"],
        &["netapi32"],
    ),
    ...
    (
        "minschannel",
        &["guiddef", "minwindef", "wincrypt", "winnt"],
        &[],
    ),
    (
        "minwinbase",
        &["basetsd", "minwindef", "ntstatus", "winnt"],
        &[],
    ),
    (
        "mmdeviceapi",
    ...
    (
        "mmeapi",
        &["basetsd", "imm", "minwindef", "mmsystem", "winnt"],
        &["winmm"],
    ),
    ...
    (
        "mscat",
        &["guiddef", "minwindef", "mssip", "wincrypt", "winnt"],
        &[],
    ),
    ("mschapp", &["basetsd", "minwindef", "winnt"], &["advapi32"]),
    (
        "mssip",
        &["guiddef", "minwindef", "mscat", "wincrypt", "winnt"],
        &["crypt32"],
    ),
    (
        "mswsock",
    ...
    (
        "namespaceapi",
        &["minwinbase", "minwindef", "ntdef", "winnt"],
        &["kernel32"],
    ),
    ("nb30", &["minwindef", "winnt"], &["netapi32"]),
    (
        "ncrypt",
        &["basetsd", "bcrypt", "minwindef", "winnt"],
        &["ncrypt"],
    ),
    (
        "ntlsa",
    ...
    (
        "oleidl",
        &["minwindef", "ntdef", "objidl", "unknwnbase", "windef"],
        &[],
    ),
    (
        "opmapi",
    ...
    (
        "perflib",
        &["basetsd", "guiddef", "minwinbase", "minwindef", "winnt"],
        &["advapi32"],
    ),
    (
        "physicalmonitorenumerationapi",
        &["d3d9", "minwindef", "windef", "winnt"],
        &["dxva2"],
    ),
    ...
    (
        "powerbase",
        &["minwindef", "winnt", "winuser"],
        &["powrprof"],
    ),
    (
        "powersetting",
        &["guiddef", "minwindef", "winnt", "winuser"],
        &["powrprof"],
    ),
    (
        "powrprof",
        &["guiddef", "minwindef", "winnt", "winreg"],
        &["powrprof"],
    ),
    ...
    (
        "prsht",
        &["basetsd", "minwindef", "windef", "winnt", "winuser"],
        &["comctl32"],
    ),
    (
        "psapi",
    ...
    (
        "sapi",
        &["guiddef", "minwindef", "sapi53", "unknwnbase", "winnt"],
        &[],
    ),
    (
        "sapi51",
    ...
    (
        "schannel",
        &["guiddef", "minwindef", "wincrypt", "windef", "winnt"],
        &[],
    ),
    (
    ...
    (
        "spellcheck",
        &["minwindef", "ntdef", "objidlbase", "unknwnbase", "winerror"],
        &[],
    ),
    ...
    (
        "uxtheme",
        &["commctrl", "minwindef", "windef", "wingdi", "winnt"],
        &["uxtheme"],
    ),
    (
        "vsbackup",
    ...
    (
        "vswriter",
        &["minwindef", "unknwnbase", "vss", "winnt", "wtypes"],
        &[],
    ),
    ...
    (
        "wbemdisp",
        &["oaidl", "unknwnbase", "winerror", "wtypes"],
        &[],
    ),
    (
        "wbemprov",
    ...
    (
        ...
        &["advapi32", "crypt32", "cryptnet"],
    ),
    ("windowsceip", &["minwindef"], &["kernel32"]),
    (
        "winefs",
        &["basetsd", "minwinbase", "minwindef", "wincrypt", "winnt"],
        &["advapi32"],
    ),
    (
        "winevt",
    ...
    (
        "wingdi",
        &["basetsd", "minwindef", "windef", "winnt"],
        &["gdi32", "msimg32", "opengl32", "winspool"],
    ),
    (
        "winhttp",
        &["basetsd", "minwinbase", "minwindef", "winnt"],
    ...
    (
        "winioctl",
        &["basetsd", "devpropdef", "guiddef", "minwindef", "winnt"],
        &[],
    ),
    (
        "winnetwk",
        &["basetsd", "minwindef", "windef", "winerror", "winnt"],
        &["mpr"],
    ),
    (
        "winnls",
    ...
    (
        "winreg",
        &["basetsd", "minwinbase", "minwindef", "reason", "winnt"],
        &["advapi32"],
    ),
    (
        "winsafer",
    ...
    (
        "wintrust",
        &["guiddef", "minwindef", "ntdef", "wincrypt", "windef"],
        &["wintrust"],
    ),
    (
        "winusb",
    ...
    (
        "wlanihvtypes",
        &["eaptypes", "guiddef", "minwindef", "winnt", "wlantypes"],
        &[],
    ),
    (
        "wlclient",
        &["guiddef", "minwindef", "windot11", "winnt"],
        &[],
    ),
    ...
    (
        "inspectable",
        &["guiddef", "hstring", "minwindef", "unknwnbase", "winnt"],
        &[],
    ),
    (
        "roapi",
    ...
    (
        "winstring",
        &["basetsd", "hstring", "minwindef", "winnt"],
        &["runtimeobject"],
    ),
];
struct Header {

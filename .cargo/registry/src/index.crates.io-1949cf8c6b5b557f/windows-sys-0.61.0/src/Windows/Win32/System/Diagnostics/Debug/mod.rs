...
pub const IMAGE_DLLCHARACTERISTICS_EX_CET_SET_CONTEXT_IP_VALIDATION_RELAXED_MODE:
    IMAGE_DLL_CHARACTERISTICS = 4u16;
...
pub type PCOGETACTIVATIONSTATE = Option<
    unsafe extern "system" fn(
        param0: windows_sys::core::GUID,
        param1: u32,
        param2: *mut u32,
    ) -> windows_sys::core::HRESULT,
>;
pub type PCOGETCALLSTATE =
    Option<unsafe extern "system" fn(param0: i32, param1: *mut u32) -> windows_sys::core::HRESULT>;
...
pub type PENUMDIRTREE_CALLBACK = Option<
    unsafe extern "system" fn(
        filepath: windows_sys::core::PCSTR,
...
pub type PENUMLOADED_MODULES_CALLBACK = Option<
    unsafe extern "system" fn(
        modulename: windows_sys::core::PCSTR,
        modulebase: u32,
        modulesize: u32,
...
pub type PENUMLOADED_MODULES_CALLBACKW64 = Option<
    unsafe extern "system" fn(
        modulename: windows_sys::core::PCWSTR,
        modulebase: u64,
        modulesize: u32,
        usercontext: *const core::ffi::c_void,
    ) -> windows_sys::core::BOOL,
...
pub type PIMAGEHLP_STATUS_ROUTINE = Option<
    unsafe extern "system" fn(
        ...
        imagename: windows_sys::core::PCSTR,
        dllname: windows_sys::core::PCSTR,
        va: usize,
        parameter: usize,
    ) -> windows_sys::core::BOOL,
>;
...
>;
pub type PSYMBOLSERVERCALLBACKPROC = Option<
    unsafe extern "system" fn(action: usize, data: u64, context: u64) -> windows_sys::core::BOOL,
>;
...
pub type PSYMBOLSERVERDELTANAMEW = Option<
    unsafe extern "system" fn(
        ...
        param5: u32,
        param6: u32,
        param7: windows_sys::core::PCWSTR,
        param8: usize,
    ) -> windows_sys::core::BOOL,
>;
...
pub type PSYMBOLSERVERGETOPTIONDATAPROC =
    Option<unsafe extern "system" fn(param0: usize, param1: *mut u64) -> windows_sys::core::BOOL>;
...
pub type PSYMBOLSERVERGETVERSION =
    Option<unsafe extern "system" fn(param0: *mut API_VERSION) -> windows_sys::core::BOOL>;
...
pub type PSYMBOLSERVERMESSAGEPROC = Option<
    unsafe extern "system" fn(action: usize, data: u64, context: u64) -> windows_sys::core::BOOL,
>;
...
>;
pub type PSYMBOLSERVERSETHTTPAUTHHEADER = Option<
    unsafe extern "system" fn(pszauthheader: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL,
>;
pub type PSYMBOLSERVERSETOPTIONSPROC =
    Option<unsafe extern "system" fn(param0: usize, param1: u64) -> windows_sys::core::BOOL>;
...
pub type PSYM_ENUMSYMBOLS_CALLBACK64W = Option<
    unsafe extern "system" fn(
        symbolname: windows_sys::core::PCWSTR,
        symboladdress: u64,
        symbolsize: u32,
        usercontext: *const core::ffi::c_void,
    ) -> windows_sys::core::BOOL,
...
pub type PWAITCHAINCALLBACK = Option<
    unsafe extern "system" fn(
        ...
        iscycle: *mut windows_sys::core::BOOL,
    ),
>;
...
pub const RESTORE_LAST_ERROR_NAME: windows_sys::core::PCWSTR =
    windows_sys::core::w!("RestoreLastError");
pub const RESTORE_LAST_ERROR_NAME_A: windows_sys::core::PCSTR =
    windows_sys::core::s!("RestoreLastError");
pub const RESTORE_LAST_ERROR_NAME_W: windows_sys::core::PCWSTR =
    windows_sys::core::w!("RestoreLastError");

...
pub const EVT_WDSMCS_E_CP_DLL_LOAD_FAILED_CRITICAL: windows_sys::core::HRESULT =
    0xC121025B_u32 as _;
pub const EVT_WDSMCS_E_CP_INCOMPATIBLE_SERVER_VERSION: windows_sys::core::HRESULT =
    0xC1210253_u32 as _;
...
pub const EVT_WDSMCS_E_NON_WDS_DUPLICATE_MULTICAST_ADDR: windows_sys::core::HRESULT =
    0xC1210203_u32 as _;
pub const EVT_WDSMCS_E_NSREG_CONTENT_PROVIDER_NOT_REG: windows_sys::core::HRESULT =
    0xC1210301_u32 as _;
...
pub const EVT_WDSMCS_W_CP_DLL_LOAD_FAILED_NOT_CRITICAL: windows_sys::core::HRESULT =
    0x8121025A_u32 as _;
...
pub type PFN_WdsCliTraceFunction =
    Option<unsafe extern "system" fn(pwszformat: windows_sys::core::PCWSTR, params: *const i8)>;
...
pub const WDSMCS_E_CLIENT_DOESNOT_SUPPORT_SECURITY_MODE: windows_sys::core::HRESULT =
    0xC1210110_u32 as _;
...
pub const WDSTPTC_E_WIM_APPLY_REQUIRES_REFERENCE_IMAGE: windows_sys::core::HRESULT =
    0xC122030D_u32 as _;
pub const WDSTPTMGMT_CATEGORY: windows_sys::core::HRESULT = 0x1_u32 as _;
pub const WDSTPTMGMT_E_CANNOT_REFRESH_DIRTY_OBJECT: windows_sys::core::HRESULT =
    0xC110010F_u32 as _;
pub const WDSTPTMGMT_E_CANNOT_REINITIALIZE_OBJECT: windows_sys::core::HRESULT = 0xC1100109_u32 as _;
pub const WDSTPTMGMT_E_CONTENT_PROVIDER_ALREADY_REGISTERED: windows_sys::core::HRESULT =
    0xC1100103_u32 as _;
pub const WDSTPTMGMT_E_CONTENT_PROVIDER_NOT_REGISTERED: windows_sys::core::HRESULT =
    0xC1100104_u32 as _;
pub const WDSTPTMGMT_E_INVALID_AUTO_DISCONNECT_THRESHOLD: windows_sys::core::HRESULT =
    0xC110011C_u32 as _;
pub const WDSTPTMGMT_E_INVALID_CLASS: windows_sys::core::HRESULT = 0xC1100102_u32 as _;
pub const WDSTPTMGMT_E_INVALID_CONTENT_PROVIDER_NAME: windows_sys::core::HRESULT =
    0xC1100105_u32 as _;
pub const WDSTPTMGMT_E_INVALID_DIAGNOSTICS_COMPONENTS: windows_sys::core::HRESULT =
    0xC110010E_u32 as _;
pub const WDSTPTMGMT_E_INVALID_IPV4_MULTICAST_ADDRESS: windows_sys::core::HRESULT =
    0xC1100117_u32 as _;
pub const WDSTPTMGMT_E_INVALID_IPV6_MULTICAST_ADDRESS: windows_sys::core::HRESULT =
    0xC1100118_u32 as _;
pub const WDSTPTMGMT_E_INVALID_IPV6_MULTICAST_ADDRESS_SOURCE: windows_sys::core::HRESULT =
    0xC110011A_u32 as _;
pub const WDSTPTMGMT_E_INVALID_IP_ADDRESS: windows_sys::core::HRESULT = 0xC1100116_u32 as _;
pub const WDSTPTMGMT_E_INVALID_MULTISTREAM_STREAM_COUNT: windows_sys::core::HRESULT =
    0xC110011B_u32 as _;
...
pub const WDSTPTMGMT_E_INVALID_NAMESPACE_START_PARAMETERS: windows_sys::core::HRESULT =
    0xC1100112_u32 as _;
pub const WDSTPTMGMT_E_INVALID_NAMESPACE_START_TIME: windows_sys::core::HRESULT =
    0xC110010D_u32 as _;
...
pub const WDSTPTMGMT_E_INVALID_SERVICE_IP_ADDRESS_RANGE: windows_sys::core::HRESULT =
    0xC1100110_u32 as _;
pub const WDSTPTMGMT_E_INVALID_SERVICE_PORT_RANGE: windows_sys::core::HRESULT = 0xC1100111_u32 as _;
pub const WDSTPTMGMT_E_INVALID_SLOW_CLIENT_HANDLING_TYPE: windows_sys::core::HRESULT =
    0xC110011E_u32 as _;
...
pub const WDSTPTMGMT_E_MULTICAST_SESSION_POLICY_NOT_SUPPORTED: windows_sys::core::HRESULT =
    0xC110011D_u32 as _;
pub const WDSTPTMGMT_E_NAMESPACE_ALREADY_REGISTERED: windows_sys::core::HRESULT =
    0xC1100107_u32 as _;
...
pub const WDSTPTMGMT_E_NAMESPACE_REMOVED_FROM_SERVER: windows_sys::core::HRESULT =
    0xC1100115_u32 as _;
pub const WDSTPTMGMT_E_NETWORK_PROFILES_NOT_SUPPORTED: windows_sys::core::HRESULT =
    0xC110011F_u32 as _;
pub const WDSTPTMGMT_E_TFTP_MAX_BLOCKSIZE_NOT_SUPPORTED: windows_sys::core::HRESULT =
    0xC1100121_u32 as _;
pub const WDSTPTMGMT_E_TFTP_VAR_WINDOW_NOT_SUPPORTED: windows_sys::core::HRESULT =
    0xC1100122_u32 as _;
pub const WDSTPTMGMT_E_TRANSPORT_SERVER_ROLE_NOT_CONFIGURED: windows_sys::core::HRESULT =
    0xC1100106_u32 as _;
pub const WDSTPTMGMT_E_TRANSPORT_SERVER_UNAVAILABLE: windows_sys::core::HRESULT =
    0xC1100113_u32 as _;
pub const WDSTPTMGMT_E_UDP_PORT_POLICY_NOT_SUPPORTED: windows_sys::core::HRESULT =
    0xC1100120_u32 as _;
...
pub const WdsTransportCacheable: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x70590b16_f146_46bd_bd9d_4aaa90084bf5);
pub const WdsTransportClient: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x66d2c5e9_0ff6_49ec_9733_dafb1e01df1c);
pub const WdsTransportCollection: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xc7f18b09_391e_436e_b10b_c3ef46f2c34f);
pub const WdsTransportConfigurationManager: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x8743f674_904c_47ca_8512_35fe98f6b0ac);
pub const WdsTransportContent: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x0a891fe7_4a3f_4c65_b6f2_1467619679ea);
pub const WdsTransportContentProvider: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xe0be741f_5a75_4eb9_8a2d_5e189b45f327);
pub const WdsTransportDiagnosticsPolicy: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xeb3333e1_a7ad_46f5_80d6_6b740204e509);
pub const WdsTransportManager: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xf21523f6_837c_4a58_af99_8a7e27f8ff59);
pub const WdsTransportMulticastSessionPolicy: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x3c6bc3f4_6418_472a_b6f1_52d457195437);
pub const WdsTransportNamespace: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xd8385768_0732_4ec1_95ea_16da581908a1);
pub const WdsTransportNamespaceAutoCast: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xb091f5a8_6a99_478d_b23b_09e8fee04574);
pub const WdsTransportNamespaceManager: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xf08cdb63_85de_4a28_a1a9_5ca3e7efda73);
pub const WdsTransportNamespaceScheduledCast: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xbadc1897_7025_44eb_9108_fb61c4055792);
pub const WdsTransportNamespaceScheduledCastAutoStart: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xa1107052_122c_4b81_9b7c_386e6855383f);
pub const WdsTransportNamespaceScheduledCastManualStart: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xd3e1a2aa_caac_460e_b98a_47f9f318a1fa);
pub const WdsTransportServer: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xea19b643_4adf_4413_942c_14f379118760);
pub const WdsTransportServicePolicy: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x65aceadc_2f0b_4f43_9f4d_811865d8cead);
pub const WdsTransportSession: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x749ac4e0_67bc_4743_bfe5_cacb1f26f57f);
pub const WdsTransportSetupManager: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xc7beeaad_9f04_4923_9f0c_fbf52bc7590f);
pub const WdsTransportTftpClient: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x50343925_7c5c_4c8c_96c4_ad9fa5005fba);
pub const WdsTransportTftpManager: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xc8e9dca2_3241_4e4d_b806_bc74019dfeda);

...
pub const CLSID_DebugFailureAnalysisBasic: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xb74eed7f_1c7d_4c1b_959f_b96dd9175aa4);
pub const CLSID_DebugFailureAnalysisKernel: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xee433078_64af_4c33_ab2f_ecad7f2a002d);
pub const CLSID_DebugFailureAnalysisTarget: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xba9bfb05_ef75_4bbd_a745_a6b5529458b8);
pub const CLSID_DebugFailureAnalysisUser: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xe60b0c93_cf49_4a32_8147_0362202dc56b);
pub const CLSID_DebugFailureAnalysisWinCE: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x67d5e86f_f5e2_462a_9233_1bd616fcc7e8);
pub const CLSID_DebugFailureAnalysisXBox360: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x901625bb_95f1_4318_ac80_9d733cee8c8b);
#[repr(C)]
#[derive(Clone, Copy)]
pub struct CPU_INFO {
    pub Type: u32,
...
pub const DEBUG_FLR_WERCOLLECTION_PROCESSHEAPDUMP_REQUEST_FAILURE: DEBUG_FLR_PARAM_TYPE =
    -268435440i32;
...
pub const DEBUG_OUTPUT_OFFSET_END_WIDE: windows_sys::core::PCWSTR =
    windows_sys::core::w!("**OFF**");
...
pub const DEBUG_OUTPUT_VALUE_END_WIDE: windows_sys::core::PCWSTR =
...
pub type ENTRY_CALLBACK = Option<
...
pub type EXTDLL_ITERATERTLBALANCEDNODES = Option<
    unsafe extern "system" fn(
        rootnode: u64,
        entryoffset: u32,
...
>;
pub type EXTDLL_QUERYDATABYTAG = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        dwdatatag: u32,
        pqueryinfo: *const core::ffi::c_void,
        pdata: *mut u8,
        cbdata: u32,
    ) -> windows_sys::core::HRESULT,
>;
pub type EXTDLL_QUERYDATABYTAGEX = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        dwdatatag: u32,
        pqueryinfo: *const core::ffi::c_void,
...
pub type EXTS_JOB_PROCESS_CALLBACK = Option<
    unsafe extern "system" fn(job: u64, process: u64, context: *mut core::ffi::c_void) -> bool,
>;
pub type EXTS_TABLE_ENTRY_CALLBACK =
    Option<unsafe extern "system" fn(entry: u64, context: *mut core::ffi::c_void) -> bool>;
pub type EXT_ANALYSIS_PLUGIN = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        callphase: FA_EXTENSION_PLUGIN_PHASE,
        panalysis: *mut core::ffi::c_void,
    ) -> windows_sys::core::HRESULT,
>;
pub type EXT_ANALYZER = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        bucketsuffix: windows_sys::core::PSTR,
        cbbucketsuffix: u32,
        debugtext: windows_sys::core::PSTR,
        cbdebugtext: u32,
        flags: *const u32,
        panalysis: *mut core::ffi::c_void,
    ) -> windows_sys::core::HRESULT,
...
pub type EXT_DECODE_ERROR =
    Option<unsafe extern "system" fn(pdecodeerror: *mut DEBUG_DECODE_ERROR)>;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub type EXT_GET_DEBUG_FAILURE_ANALYSIS = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        flags: u32,
        classid: windows_sys::core::GUID,
        ppanalysis: *mut *mut core::ffi::c_void,
    ) -> windows_sys::core::HRESULT,
>;
pub type EXT_GET_ENVIRONMENT_VARIABLE = Option<
    unsafe extern "system" fn(
        peb: u64,
        variable: windows_sys::core::PCSTR,
        buffer: windows_sys::core::PCSTR,
        buffersize: u32,
    ) -> windows_sys::core::HRESULT,
>;
pub type EXT_GET_FAILURE_ANALYSIS = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        flags: u32,
        ppanalysis: *mut *mut core::ffi::c_void,
...
>;
pub type EXT_GET_FA_ENTRIES_DATA = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        count: *mut u32,
        entries: *mut *mut FA_ENTRY,
    ) -> windows_sys::core::HRESULT,
>;
pub type EXT_GET_HANDLE_TRACE = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        tracetype: u32,
        startindex: u32,
        handlevalue: *mut u64,
        stackfunctions: *mut u64,
        stacktracesize: u32,
    ) -> windows_sys::core::HRESULT,
>;
#[repr(C)]
...
pub type EXT_RELOAD_TRIAGER =
    Option<unsafe extern "system" fn(client: *mut core::ffi::c_void) -> windows_sys::core::HRESULT>;
pub type EXT_TARGET_INFO = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        ptargetinfo: *mut TARGET_DEBUG_INFO,
    ) -> windows_sys::core::HRESULT,
>;
...
pub type EXT_TRIAGE_FOLLOWUP = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        symbolname: windows_sys::core::PCSTR,
        ownerinfo: *mut DEBUG_TRIAGE_FOLLOWUP_INFO,
    ) -> u32,
>;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub type EXT_XML_DATA = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        pxmpdata: *mut EXT_CAB_XML_DATA,
    ) -> windows_sys::core::HRESULT,
>;
...
pub type KDEXTS_LOCK_CALLBACKROUTINE = Option<
    unsafe extern "system" fn(
        plock: *mut KDEXTS_LOCK_INFO,
        context: *mut core::ffi::c_void,
    ) -> windows_sys::core::HRESULT,
>;
...
pub type KDEXT_DUMP_HANDLE_CALLBACK = Option<
    unsafe extern "system" fn(
        handleinfo: *const KDEXT_HANDLE_INFORMATION,
        flags: u32,
        context: *mut core::ffi::c_void,
    ) -> bool,
>;
...
pub type PDEBUG_EXTENSION_CALL = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        args: windows_sys::core::PCSTR,
    ) -> windows_sys::core::HRESULT,
>;
pub type PDEBUG_EXTENSION_CANUNLOAD =
    Option<unsafe extern "system" fn() -> windows_sys::core::HRESULT>;
pub type PDEBUG_EXTENSION_INITIALIZE = Option<
    unsafe extern "system" fn(version: *mut u32, flags: *mut u32) -> windows_sys::core::HRESULT,
>;
pub type PDEBUG_EXTENSION_KNOWN_STRUCT = Option<
    unsafe extern "system" fn(
        flags: u32,
        offset: u64,
        typename: windows_sys::core::PCSTR,
        buffer: windows_sys::core::PSTR,
        bufferchars: *mut u32,
    ) -> windows_sys::core::HRESULT,
>;
pub type PDEBUG_EXTENSION_KNOWN_STRUCT_EX = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        flags: u32,
        offset: u64,
...
pub type PDEBUG_EXTENSION_PROVIDE_VALUE = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        flags: u32,
...
>;
pub type PDEBUG_EXTENSION_QUERY_VALUE_NAMES = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        flags: u32,
...
pub type PDEBUG_STACK_PROVIDER_BEGINTHREADSTACKRECONSTRUCTION = Option<
    unsafe extern "system" fn(
        streamtype: u32,
...
pub type PDEBUG_STACK_PROVIDER_ENDTHREADSTACKRECONSTRUCTION =
    Option<unsafe extern "system" fn() -> windows_sys::core::HRESULT>;
pub type PDEBUG_STACK_PROVIDER_FREESTACKSYMFRAMES = Option<
    unsafe extern "system" fn(
        stacksymframes: *const STACK_SYM_FRAME_INFO,
    ) -> windows_sys::core::HRESULT,
>;
pub type PDEBUG_STACK_PROVIDER_RECONSTRUCTSTACK = Option<
    unsafe extern "system" fn(
        systemthreadid: u32,
...
>;
pub type PENUMERATE_HANDLES = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        process: u64,
        handletodump: u64,
...
>;
pub type PENUMERATE_HASH_TABLE = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        hashtable: u64,
...
>;
pub type PENUMERATE_JOB_PROCESSES = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        job: u64,
...
>;
pub type PENUMERATE_SYSTEM_LOCKS = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        flags: u32,
...
>;
pub type PFIND_FILELOCK_OWNERINFO = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        pfilelockowner: *mut KDEXT_FILELOCK_OWNER,
    ) -> windows_sys::core::HRESULT,
>;
pub type PFIND_MATCHING_PROCESS = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        processinfo: *const KDEXT_PROCESS_FIND_PARAMS,
        process: *mut u64,
    ) -> windows_sys::core::HRESULT,
>;
pub type PFIND_MATCHING_THREAD = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        threadinfo: *mut KDEXT_THREAD_FIND_PARAMS,
    ) -> windows_sys::core::HRESULT,
>;
pub type PGET_CPU_MICROCODE_VERSION = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        pcpumicrocodeversion: *mut DEBUG_CPU_MICROCODE_VERSION,
    ) -> windows_sys::core::HRESULT,
>;
pub type PGET_CPU_PSPEED_INFO = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        pcpuspeedinfo: *mut DEBUG_CPU_SPEED_INFO,
    ) -> windows_sys::core::HRESULT,
>;
pub type PGET_DEVICE_OBJECT_INFO = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        deviceobject: u64,
        pdevobjinfo: *mut DEBUG_DEVICE_OBJECT_INFO,
    ) -> windows_sys::core::HRESULT,
>;
pub type PGET_DRIVER_OBJECT_INFO = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        driverobject: u64,
        pdrvobjinfo: *mut DEBUG_DRIVER_OBJECT_INFO,
    ) -> windows_sys::core::HRESULT,
>;
pub type PGET_FULL_IMAGE_NAME = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        process: u64,
        fullimagename: *mut windows_sys::core::PSTR,
    ) -> windows_sys::core::HRESULT,
>;
pub type PGET_IRP_INFO = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        irp: u64,
        irpinfo: *mut DEBUG_IRP_INFO,
    ) -> windows_sys::core::HRESULT,
>;
pub type PGET_PNP_TRIAGE_INFO = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        ppnptriageinfo: *mut DEBUG_PNP_TRIAGE_INFO,
    ) -> windows_sys::core::HRESULT,
>;
pub type PGET_POOL_DATA = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        pool: u64,
        pooldata: *mut DEBUG_POOL_DATA,
    ) -> windows_sys::core::HRESULT,
>;
pub type PGET_POOL_REGION = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        pool: u64,
        poolregion: *mut DEBUG_POOL_REGION,
    ) -> windows_sys::core::HRESULT,
>;
pub type PGET_POOL_TAG_DESCRIPTION = Option<
    unsafe extern "system" fn(
        pooltag: u32,
        pdescription: *mut DEBUG_POOLTAG_DESCRIPTION,
    ) -> windows_sys::core::HRESULT,
>;
pub type PGET_PROCESS_COMMIT = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        totalcommitcharge: *mut u64,
        numberofprocesses: *mut u32,
        commitdata: *mut *mut PROCESS_COMMIT_USAGE,
    ) -> windows_sys::core::HRESULT,
>;
pub type PGET_SMBIOS_INFO = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        psmbiosinfo: *mut DEBUG_SMBIOS_INFO,
    ) -> windows_sys::core::HRESULT,
>;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub type PKDEXTS_GET_PTE_INFO = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        r#virtual: u64,
        pteinfo: *mut KDEXTS_PTE_INFO,
    ) -> windows_sys::core::HRESULT,
>;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub type PSYM_DUMP_FIELD_CALLBACK = Option<
    unsafe extern "system" fn(pfield: *mut FIELD_INFO, usercontext: *mut core::ffi::c_void) -> u32,
>;
...
pub type PWINDBG_DISASM = Option<
    unsafe extern "system" fn(
        lpoffset: *mut usize,
        lpbuffer: windows_sys::core::PCSTR,
        fshoweffectiveaddress: u32,
    ) -> u32,
>;
pub type PWINDBG_DISASM32 = Option<
    unsafe extern "system" fn(
        lpoffset: *mut u32,
        lpbuffer: windows_sys::core::PCSTR,
        fshoweffectiveaddress: u32,
...
>;
pub type PWINDBG_DISASM64 = Option<
    unsafe extern "system" fn(
        lpoffset: *mut u64,
        lpbuffer: windows_sys::core::PCSTR,
        fshoweffectiveaddress: u32,
...
pub type PWINDBG_EXTENSION_API_VERSION =
    Option<unsafe extern "system" fn() -> *mut EXT_API_VERSION>;
#[cfg(feature = "Win32_System_Kernel")]
pub type PWINDBG_EXTENSION_DLL_INIT = Option<
    unsafe extern "system" fn(
...
>;
#[cfg(feature = "Win32_System_Kernel")]
pub type PWINDBG_EXTENSION_DLL_INIT32 = Option<
    unsafe extern "system" fn(
...
>;
#[cfg(feature = "Win32_System_Kernel")]
pub type PWINDBG_EXTENSION_DLL_INIT64 = Option<
    unsafe extern "system" fn(
...
>;
pub type PWINDBG_EXTENSION_ROUTINE = Option<
    unsafe extern "system" fn(
        hcurrentprocess: super::super::super::super::Foundation::HANDLE,
        hcurrentthread: super::super::super::super::Foundation::HANDLE,
        dwcurrentpc: u32,
        dwprocessor: u32,
        lpargumentstring: windows_sys::core::PCSTR,
    ),
>;
pub type PWINDBG_EXTENSION_ROUTINE32 = Option<
    unsafe extern "system" fn(
        hcurrentprocess: super::super::super::super::Foundation::HANDLE,
        hcurrentthread: super::super::super::super::Foundation::HANDLE,
        dwcurrentpc: u32,
...
>;
pub type PWINDBG_EXTENSION_ROUTINE64 = Option<
    unsafe extern "system" fn(
        hcurrentprocess: super::super::super::super::Foundation::HANDLE,
        hcurrentthread: super::super::super::super::Foundation::HANDLE,
        dwcurrentpc: u64,
...
pub type PWINDBG_GET_EXPRESSION =
    Option<unsafe extern "system" fn(lpexpression: windows_sys::core::PCSTR) -> usize>;
pub type PWINDBG_GET_EXPRESSION32 =
    Option<unsafe extern "system" fn(lpexpression: windows_sys::core::PCSTR) -> u32>;
pub type PWINDBG_GET_EXPRESSION64 =
    Option<unsafe extern "system" fn(lpexpression: windows_sys::core::PCSTR) -> u64>;
pub type PWINDBG_GET_SYMBOL = Option<
    unsafe extern "system" fn(
        offset: *mut core::ffi::c_void,
        pchbuffer: windows_sys::core::PCSTR,
        pdisplacement: *mut usize,
    ),
>;
pub type PWINDBG_GET_SYMBOL32 = Option<
    unsafe extern "system" fn(
        offset: u32,
        pchbuffer: windows_sys::core::PCSTR,
...
>;
pub type PWINDBG_GET_SYMBOL64 = Option<
    unsafe extern "system" fn(
        offset: u64,
        pchbuffer: windows_sys::core::PCSTR,
...
>;
#[cfg(feature = "Win32_System_Kernel")]
pub type PWINDBG_GET_THREAD_CONTEXT_ROUTINE = Option<
    unsafe extern "system" fn(
        processor: u32,
        lpcontext: *mut super::CONTEXT,
        cbsizeofcontext: u32,
    ) -> u32,
>;
pub type PWINDBG_IOCTL_ROUTINE = Option<
    unsafe extern "system" fn(ioctltype: u16, lpvdata: *mut core::ffi::c_void, cbsize: u32) -> u32,
>;
pub type PWINDBG_OLDKD_EXTENSION_ROUTINE = Option<
    unsafe extern "system" fn(
        dwcurrentpc: u32,
...
>;
pub type PWINDBG_OLDKD_READ_PHYSICAL_MEMORY = Option<
    unsafe extern "system" fn(
        address: u64,
...
>;
pub type PWINDBG_OLDKD_WRITE_PHYSICAL_MEMORY = Option<
    unsafe extern "system" fn(
        address: u64,
        buffer: *mut core::ffi::c_void,
        length: u32,
...
>;
#[cfg(feature = "Win32_System_Kernel")]
pub type PWINDBG_OLD_EXTENSION_ROUTINE = Option<
    unsafe extern "system" fn(
        dwcurrentpc: u32,
        lpextensionapis: *mut WINDBG_EXTENSION_APIS,
        lpargumentstring: windows_sys::core::PCSTR,
...
pub type PWINDBG_OUTPUT_ROUTINE =
    Option<unsafe extern "system" fn(lpformat: windows_sys::core::PCSTR)>;
pub type PWINDBG_READ_PROCESS_MEMORY_ROUTINE = Option<
    unsafe extern "system" fn(
        offset: usize,
...
>;
pub type PWINDBG_READ_PROCESS_MEMORY_ROUTINE32 = Option<
    unsafe extern "system" fn(
        offset: u32,
        lpbuffer: *mut core::ffi::c_void,
        cb: u32,
...
>;
pub type PWINDBG_READ_PROCESS_MEMORY_ROUTINE64 = Option<
    unsafe extern "system" fn(
        offset: u64,
        lpbuffer: *mut core::ffi::c_void,
        cb: u32,
...
>;
#[cfg(feature = "Win32_System_Kernel")]
pub type PWINDBG_SET_THREAD_CONTEXT_ROUTINE = Option<
    unsafe extern "system" fn(
        processor: u32,
        lpcontext: *mut super::CONTEXT,
        cbsizeofcontext: u32,
...
>;
pub type PWINDBG_STACKTRACE_ROUTINE = Option<
    unsafe extern "system" fn(
        framepointer: u32,
        stackpointer: u32,
        programcounter: u32,
...
>;
pub type PWINDBG_STACKTRACE_ROUTINE32 = Option<
    unsafe extern "system" fn(
        framepointer: u32,
        stackpointer: u32,
        programcounter: u32,
...
>;
pub type PWINDBG_STACKTRACE_ROUTINE64 = Option<
    unsafe extern "system" fn(
        framepointer: u64,
        stackpointer: u64,
        programcounter: u64,
...
>;
pub type PWINDBG_WRITE_PROCESS_MEMORY_ROUTINE = Option<
    unsafe extern "system" fn(
        offset: usize,
...
>;
pub type PWINDBG_WRITE_PROCESS_MEMORY_ROUTINE32 = Option<
    unsafe extern "system" fn(
        offset: u32,
        lpbuffer: *const core::ffi::c_void,
        cb: u32,
...
>;
pub type PWINDBG_WRITE_PROCESS_MEMORY_ROUTINE64 = Option<
    unsafe extern "system" fn(
        offset: u64,
        lpbuffer: *const core::ffi::c_void,
        cb: u32,
...
pub type fnDebugFailureAnalysisCreateInstance = Option<
    unsafe extern "system" fn(
        client: *mut core::ffi::c_void,
        args: windows_sys::core::PCWSTR,
        flags: u32,

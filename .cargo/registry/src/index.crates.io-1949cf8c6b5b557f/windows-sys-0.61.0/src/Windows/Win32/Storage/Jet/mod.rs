...
pub const JET_wszConfigStoreReadControl: windows_sys::core::PCWSTR =
    windows_sys::core::w!("CsReadControl");
pub const JET_wszConfigStoreRelPathSysParamDefault: windows_sys::core::PCWSTR =
    windows_sys::core::w!("SysParamDefault");
pub const JET_wszConfigStoreRelPathSysParamOverride: windows_sys::core::PCWSTR =
    windows_sys::core::w!("SysParamOverride");

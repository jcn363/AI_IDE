windows_link::link!("wintrust.dll" "system" fn OpenPersonalTrustDBDialog(hwndparent : super::super::Foundation:: HWND) -> windows_sys::core::BOOL);
windows_link::link!("wintrust.dll" "system" fn OpenPersonalTrustDBDialogEx(hwndparent : super::super::Foundation:: HWND, dwflags : u32, pvreserved : *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(all(
...
windows_link::link!("wintrust.dll" "system" fn WTHelperCertIsSelfSigned(dwencoding : u32, pcert : *mut super::Cryptography:: CERT_INFO) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Security_Cryptography")]
...
pub type PFN_ALLOCANDFILLDEFUSAGE = Option<
...
pub type PFN_FREEDEFUSAGE = Option<
    unsafe extern "system" fn(
        pszusageoid: windows_sys::core::PCSTR,
        psdefusage: *const CRYPT_PROVIDER_DEFUSAGE,
    ) -> windows_sys::core::BOOL,
...
pub type PFN_PROVIDER_CERTCHKPOLICY_CALL = Option<
    unsafe extern "system" fn(
        pprovdata: *const CRYPT_PROVIDER_DATA,
        idxsigner: u32,
        fcountersignerchain: windows_sys::core::BOOL,
        idxcountersigner: u32,
    ) -> windows_sys::core::BOOL,
>;
#[cfg(all(
...
pub type PFN_PROVIDER_CERTTRUST_CALL = Option<
...
pub type PFN_PROVIDER_CLEANUP_CALL = Option<
    unsafe extern "system" fn(pprovdata: *mut CRYPT_PROVIDER_DATA) -> windows_sys::core::HRESULT,
>;
#[cfg(all(
    feature = "Win32_Security_Cryptography_Catalog",
...
pub type PFN_PROVIDER_FINALPOLICY_CALL = Option<
    unsafe extern "system" fn(pprovdata: *mut CRYPT_PROVIDER_DATA) -> windows_sys::core::HRESULT,
>;
#[cfg(all(
    feature = "Win32_Security_Cryptography_Catalog",
...
pub type PFN_PROVIDER_INIT_CALL = Option<
    unsafe extern "system" fn(pprovdata: *mut CRYPT_PROVIDER_DATA) -> windows_sys::core::HRESULT,
>;
#[cfg(all(
    feature = "Win32_Security_Cryptography_Catalog",
...
pub type PFN_PROVIDER_OBJTRUST_CALL = Option<
    unsafe extern "system" fn(pprovdata: *mut CRYPT_PROVIDER_DATA) -> windows_sys::core::HRESULT,
>;
#[cfg(all(
    feature = "Win32_Security_Cryptography_Catalog",
...
pub type PFN_PROVIDER_SIGTRUST_CALL = Option<
    unsafe extern "system" fn(pprovdata: *mut CRYPT_PROVIDER_DATA) -> windows_sys::core::HRESULT,
>;
#[cfg(all(
    feature = "Win32_Security_Cryptography_Catalog",
...
pub type PFN_PROVIDER_TESTFINALPOLICY_CALL = Option<
    unsafe extern "system" fn(pprovdata: *mut CRYPT_PROVIDER_DATA) -> windows_sys::core::HRESULT,
>;
#[cfg(all(
    feature = "Win32_Security_Cryptography_Catalog",
...
pub type PFN_WTD_GENERIC_CHAIN_POLICY_CALLBACK = Option<
    unsafe extern "system" fn(

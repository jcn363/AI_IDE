...
windows_link::link!("bluetoothapis.dll" "system" fn BluetoothFindRadioClose(hfind : HBLUETOOTH_RADIO_FIND) -> windows_sys::core::BOOL);
windows_link::link!("bluetoothapis.dll" "system" fn BluetoothGATTAbortReliableWrite(hdevice : super::super::Foundation:: HANDLE, reliablewritecontext : u64, flags : u32) -> windows_sys::core::HRESULT);
...
pub const BLUETOOTH_MITM_ProtectionNotRequiredGeneralBonding:
    BLUETOOTH_AUTHENTICATION_REQUIREMENTS = 4i32;
...
pub const BTH_LE_ATT_BLUETOOTH_BASE_GUID: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x00000000_0000_1000_8000_00805f9b34fb);
...
pub const Bluetooth_Base_UUID: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x00000000_0000_1000_8000_00805f9b34fb);
...
pub const GUID_BLUETOOTHLE_DEVICE_INTERFACE: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x781aee18_7733_4ce4_add0_91f41c67b592);
pub const GUID_BLUETOOTH_AUTHENTICATION_REQUEST: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x5dc9136d_996c_46db_84f5_32c0a3f47352);
pub const GUID_BLUETOOTH_GATT_SERVICE_DEVICE_INTERFACE: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x6e3bb679_4372_40c8_9eaa_4509df260cd8);
pub const GUID_BLUETOOTH_HCI_EVENT: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xfc240062_1541_49be_b463_84c4dcd7bf7f);
pub const GUID_BLUETOOTH_HCI_VENDOR_EVENT: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x547247e6_45bb_4c33_af8c_c00efe15a71d);
pub const GUID_BLUETOOTH_KEYPRESS_EVENT: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xd668dfcd_0f4e_4efc_bfe0_392eeec5109c);
pub const GUID_BLUETOOTH_L2CAP_EVENT: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x7eae4030_b709_4aa8_ac55_e953829c9daa);
pub const GUID_BLUETOOTH_RADIO_IN_RANGE: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xea3b5b82_26ee_450e_b0d8_d26fe30a3869);
pub const GUID_BLUETOOTH_RADIO_OUT_OF_RANGE: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xe28867c9_c2aa_4ced_b969_4570866037c4);
pub const GUID_BTHPORT_DEVICE_INTERFACE: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x0850302a_b344_4fda_9be9_90576b8d46f0);
pub const GUID_BTH_RFCOMM_SERVICE_DEVICE_INTERFACE: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xb142fc3e_fa4e_460b_8abc_072b628b3c70);
...
pub const STR_ADDR_FMT: windows_sys::core::PCWSTR =
    windows_sys::core::w!("(%02x:%02x:%02x:%02x:%02x:%02x)");
pub const STR_ADDR_FMTA: windows_sys::core::PCSTR =
    windows_sys::core::s!("(%02x:%02x:%02x:%02x:%02x:%02x)");
pub const STR_ADDR_FMTW: windows_sys::core::PCWSTR =
    windows_sys::core::w!("(%02x:%02x:%02x:%02x:%02x:%02x)");
...
pub const STR_USBHCI_CLASS_HARDWAREID: windows_sys::core::PCWSTR =
    windows_sys::core::w!("USB\\Class_E0&SubClass_01&Prot_01");
pub const STR_USBHCI_CLASS_HARDWAREIDA: windows_sys::core::PCSTR =
    windows_sys::core::s!("USB\\Class_E0&SubClass_01&Prot_01");
pub const STR_USBHCI_CLASS_HARDWAREIDW: windows_sys::core::PCWSTR =
    windows_sys::core::w!("USB\\Class_E0&SubClass_01&Prot_01");
pub const SVCID_BTH_PROVIDER: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x06aa63e0_7d60_41ff_afb2_3ee6d2d9392d);

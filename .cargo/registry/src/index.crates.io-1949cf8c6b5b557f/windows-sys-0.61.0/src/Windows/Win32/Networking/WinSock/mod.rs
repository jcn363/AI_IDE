...
pub type LPBLOCKINGCALLBACK =
    Option<unsafe extern "system" fn(dwcontext: usize) -> windows_sys::core::BOOL>;
...
pub type LPFN_RIORESIZECOMPLETIONQUEUE =
    Option<unsafe extern "system" fn(cq: RIO_CQ, queuesize: u32) -> windows_sys::core::BOOL>;
...
pub type LPNSPCLEANUP =
    Option<unsafe extern "system" fn(lpproviderid: *const windows_sys::core::GUID) -> i32>;
...
>;
pub type LPWPUCLOSEEVENT = Option<
    unsafe extern "system" fn(hevent: WSAEVENT, lperrno: *mut i32) -> windows_sys::core::BOOL,
>;
...
>;
pub type LPWPURESETEVENT = Option<
    unsafe extern "system" fn(hevent: WSAEVENT, lperrno: *mut i32) -> windows_sys::core::BOOL,
>;
pub type LPWPUSETEVENT = Option<
    unsafe extern "system" fn(hevent: WSAEVENT, lperrno: *mut i32) -> windows_sys::core::BOOL,
>;
#[cfg(feature = "Win32_System_IO")]
...
pub const WSAID_MULTIPLE_RIO: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0x8509e081_96dd_4005_b165_9e2ee8c79e3f);
...
pub const WSAID_WSASENDMSG: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xa441e712_754f_43ca_84a7_0dee44cf606d);
#[repr(C)]
#[derive(Clone, Copy)]
pub struct WSAMSG {

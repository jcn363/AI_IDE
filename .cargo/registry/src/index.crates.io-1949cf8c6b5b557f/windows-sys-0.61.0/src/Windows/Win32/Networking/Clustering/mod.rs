...
pub const CLUSREG_NAME_GROUPSET_AVAILABILITY_SET_INDEX_TO_NODE_MAPPING: windows_sys::core::PCWSTR =
    windows_sys::core::w!("NodeDomainInfo");
...
pub type LPGROUP_CALLBACK_EX = Option<
...
>;
pub type LPNODE_CALLBACK = Option<
    unsafe extern "system" fn(
        param0: HCLUSTER,
        param1: HNODE,
...
>;
pub type LPRESOURCE_CALLBACK = Option<
    unsafe extern "system" fn(
        param0: HRESOURCE,
        param1: HRESOURCE,
...
>;
pub type LPRESOURCE_CALLBACK_EX = Option<
    unsafe extern "system" fn(
        param0: HCLUSTER,
        param1: HRESOURCE,
        param2: HRESOURCE,
...
pub type PARBITRATE_ROUTINE = Option<
    unsafe extern "system" fn(
        resource: *mut core::ffi::c_void,
        lostquorumresource: PQUORUM_RESOURCE_LOST,
    ) -> u32,
>;
pub type PARM_WPR_WATCHDOG_FOR_CURRENT_RESOURCE_CALL_ROUTINE =
    Option<unsafe extern "system" fn(resourcehandle: isize, timeoutinms: u64) -> u32>;
pub type PBEGIN_RESCALL_AS_USER_ROUTINE = Option<
    unsafe extern "system" fn(
        resource: *mut core::ffi::c_void,
        ...
        context: i64,
        returnedasynchronously: *mut windows_sys::core::BOOL,
    ) -> u32,
>;
pub type PBEGIN_RESCALL_ROUTINE = Option<
    unsafe extern "system" fn(
        resource: *mut core::ffi::c_void,
        controlcode: u32,
        inbuffer: *mut core::ffi::c_void,
...
>;
pub type PBEGIN_RESTYPECALL_AS_USER_ROUTINE = Option<
    unsafe extern "system" fn(
...
>;
pub type PBEGIN_RESTYPECALL_ROUTINE = Option<
    unsafe extern "system" fn(
        resourcetypename: windows_sys::core::PCWSTR,
        controlcode: u32,
        inbuffer: *mut core::ffi::c_void,
...
>;
pub type PCANCEL_ROUTINE = Option<
    unsafe extern "system" fn(resource: *mut core::ffi::c_void, cancelflags_reserved: u32) -> u32,
>;
pub type PCHANGE_RESOURCE_PROCESS_FOR_DUMPS = Option<
    unsafe extern "system" fn(
        resource: isize,
        processname: windows_sys::core::PCWSTR,
        processid: u32,
        isadd: windows_sys::core::BOOL,
    ) -> u32,
>;
pub type PCHANGE_RES_TYPE_PROCESS_FOR_DUMPS = Option<
    unsafe extern "system" fn(
        resourcetypename: windows_sys::core::PCWSTR,
        processname: windows_sys::core::PCWSTR,
        processid: u32,
...
pub type PCLOSE_CLUSTER_CRYPT_PROVIDER =
    Option<unsafe extern "system" fn(hcluscryptprovider: HCLUSCRYPTPROVIDER) -> u32>;
...
pub type PCLUSAPIClusWorkerCheckTerminate =
    Option<unsafe extern "system" fn(lpworker: *mut CLUS_WORKER) -> windows_sys::core::BOOL>;
pub type PCLUSAPI_ADD_CLUSTER_GROUP_DEPENDENCY =
    Option<unsafe extern "system" fn(hdependentgroup: HGROUP, hprovidergroup: HGROUP) -> u32>;
pub type PCLUSAPI_ADD_CLUSTER_GROUP_DEPENDENCY_EX = Option<
    unsafe extern "system" fn(
...
>;
pub type PCLUSAPI_ADD_CLUSTER_GROUP_GROUPSET_DEPENDENCY = Option<
    unsafe extern "system" fn(hdependentgroupset: HGROUPSET, hprovidergroupset: HGROUPSET) -> u32,
>;
pub type PCLUSAPI_ADD_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EX = Option<
    unsafe extern "system" fn(
...
pub type PCLUSAPI_ADD_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY =
    Option<unsafe extern "system" fn(hdependentgroup: HGROUP, hprovidergroupset: HGROUPSET) -> u32>;
pub type PCLUSAPI_ADD_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY_EX = Option<
    unsafe extern "system" fn(
        hdependentgroup: HGROUP,
        hprovidergroupset: HGROUPSET,
        lpszreason: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_ADD_CLUSTER_NODE = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
...
>;
pub type PCLUSAPI_ADD_CLUSTER_NODE_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpsznodename: windows_sys::core::PCWSTR,
        dwflags: u32,
...
pub type PCLUSAPI_ADD_CLUSTER_RESOURCE_DEPENDENCY =
    Option<unsafe extern "system" fn(hresource: HRESOURCE, hdependson: HRESOURCE) -> u32>;
pub type PCLUSAPI_ADD_CLUSTER_RESOURCE_DEPENDENCY_EX = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
...
pub type PCLUSAPI_ADD_CLUSTER_RESOURCE_NODE =
    Option<unsafe extern "system" fn(hresource: HRESOURCE, hnode: HNODE) -> u32>;
pub type PCLUSAPI_ADD_CLUSTER_RESOURCE_NODE_EX = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        hnode: HNODE,
        lpszreason: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_ADD_CROSS_CLUSTER_GROUPSET_DEPENDENCY = Option<
    unsafe extern "system" fn(
        hdependentgroupset: HGROUPSET,
...
pub type PCLUSAPI_ADD_RESOURCE_TO_CLUSTER_SHARED_VOLUMES =
    Option<unsafe extern "system" fn(hresource: HRESOURCE) -> u32>;
pub type PCLUSAPI_BACKUP_CLUSTER_DATABASE = Option<
    unsafe extern "system" fn(hcluster: HCLUSTER, lpszpathname: windows_sys::core::PCWSTR) -> u32,
>;
pub type PCLUSAPI_CAN_RESOURCE_BE_DEPENDENT = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
...
pub type PCLUSAPI_CHANGE_CLUSTER_RESOURCE_GROUP =
    Option<unsafe extern "system" fn(hresource: HRESOURCE, hgroup: HGROUP) -> u32>;
pub type PCLUSAPI_CHANGE_CLUSTER_RESOURCE_GROUP_EX =
    Option<unsafe extern "system" fn(hresource: HRESOURCE, hgroup: HGROUP, flags: u64) -> u32>;
pub type PCLUSAPI_CHANGE_CLUSTER_RESOURCE_GROUP_EX2 = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        hgroup: HGROUP,
        flags: u64,
...
pub type PCLUSAPI_CLOSE_CLUSTER =
    Option<unsafe extern "system" fn(hcluster: HCLUSTER) -> windows_sys::core::BOOL>;
pub type PCLUSAPI_CLOSE_CLUSTER_GROUP =
    Option<unsafe extern "system" fn(hgroup: HGROUP) -> windows_sys::core::BOOL>;
pub type PCLUSAPI_CLOSE_CLUSTER_GROUP_GROUPSET =
    Option<unsafe extern "system" fn(hgroupset: HGROUPSET) -> windows_sys::core::BOOL>;
pub type PCLUSAPI_CLOSE_CLUSTER_NETWORK =
    Option<unsafe extern "system" fn(hnetwork: HNETWORK) -> windows_sys::core::BOOL>;
pub type PCLUSAPI_CLOSE_CLUSTER_NET_INTERFACE =
    Option<unsafe extern "system" fn(hnetinterface: HNETINTERFACE) -> windows_sys::core::BOOL>;
pub type PCLUSAPI_CLOSE_CLUSTER_NODE =
    Option<unsafe extern "system" fn(hnode: HNODE) -> windows_sys::core::BOOL>;
pub type PCLUSAPI_CLOSE_CLUSTER_NOTIFY_PORT =
    Option<unsafe extern "system" fn(hchange: HCHANGE) -> windows_sys::core::BOOL>;
pub type PCLUSAPI_CLOSE_CLUSTER_RESOURCE =
    Option<unsafe extern "system" fn(hresource: HRESOURCE) -> windows_sys::core::BOOL>;
...
>;
pub type PCLUSAPI_CLUSTER_ADD_GROUP_TO_GROUPSET_WITH_DOMAINS_EX = Option<
    unsafe extern "system" fn(
        hgroupset: HGROUPSET,
        hgroup: HGROUP,
        faultdomain: u32,
...
pub type PCLUSAPI_CLUSTER_ADD_GROUP_TO_GROUP_GROUPSET =
    Option<unsafe extern "system" fn(hgroupset: HGROUPSET, hgroup: HGROUP) -> u32>;
pub type PCLUSAPI_CLUSTER_AFFINITY_RULE_CONTROL = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
...
pub type PCLUSAPI_CLUSTER_CLOSE_ENUM_EX =
    Option<unsafe extern "system" fn(hclusterenum: HCLUSENUMEX) -> u32>;
pub type PCLUSAPI_CLUSTER_CONTROL = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
>;
pub type PCLUSAPI_CLUSTER_CONTROL_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
>;
pub type PCLUSAPI_CLUSTER_CREATE_AFFINITY_RULE = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        rulename: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_CLUSTER_ENUM = Option<
    unsafe extern "system" fn(
        henum: HCLUSENUM,
        dwindex: u32,
        lpdwtype: *mut u32,
...
>;
pub type PCLUSAPI_CLUSTER_ENUM_EX = Option<
    unsafe extern "system" fn(
...
pub type PCLUSAPI_CLUSTER_GET_ENUM_COUNT =
    Option<unsafe extern "system" fn(henum: HCLUSENUM) -> u32>;
pub type PCLUSAPI_CLUSTER_GET_ENUM_COUNT_EX =
    Option<unsafe extern "system" fn(hclusterenum: HCLUSENUMEX) -> u32>;
pub type PCLUSAPI_CLUSTER_GROUP_CLOSE_ENUM =
    Option<unsafe extern "system" fn(hgroupenum: HGROUPENUM) -> u32>;
pub type PCLUSAPI_CLUSTER_GROUP_CLOSE_ENUM_EX =
    Option<unsafe extern "system" fn(hgroupenumex: HGROUPENUMEX) -> u32>;
pub type PCLUSAPI_CLUSTER_GROUP_CONTROL = Option<
    unsafe extern "system" fn(
        hgroup: HGROUP,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
>;
pub type PCLUSAPI_CLUSTER_GROUP_CONTROL_EX = Option<
    unsafe extern "system" fn(
        hgroup: HGROUP,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
>;
pub type PCLUSAPI_CLUSTER_GROUP_ENUM = Option<
    unsafe extern "system" fn(
...
>;
pub type PCLUSAPI_CLUSTER_GROUP_ENUM_EX = Option<
    unsafe extern "system" fn(
...
pub type PCLUSAPI_CLUSTER_GROUP_GET_ENUM_COUNT_EX =
    Option<unsafe extern "system" fn(hgroupenumex: HGROUPENUMEX) -> u32>;
pub type PCLUSAPI_CLUSTER_GROUP_GROUPSET_CONTROL = Option<
    unsafe extern "system" fn(
        hgroupset: HGROUPSET,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
>;
pub type PCLUSAPI_CLUSTER_GROUP_GROUPSET_CONTROL_EX = Option<
    unsafe extern "system" fn(
        hgroupset: HGROUPSET,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
pub type PCLUSAPI_CLUSTER_GROUP_OPEN_ENUM =
    Option<unsafe extern "system" fn(hgroup: HGROUP, dwtype: u32) -> HGROUPENUM>;
pub type PCLUSAPI_CLUSTER_GROUP_OPEN_ENUM_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
...
pub type PCLUSAPI_CLUSTER_NETWORK_CLOSE_ENUM =
    Option<unsafe extern "system" fn(hnetworkenum: HNETWORKENUM) -> u32>;
pub type PCLUSAPI_CLUSTER_NETWORK_CONTROL = Option<
    unsafe extern "system" fn(
        hnetwork: HNETWORK,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
>;
pub type PCLUSAPI_CLUSTER_NETWORK_CONTROL_EX = Option<
    unsafe extern "system" fn(
        hnetwork: HNETWORK,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
>;
pub type PCLUSAPI_CLUSTER_NETWORK_ENUM = Option<
    unsafe extern "system" fn(
...
pub type PCLUSAPI_CLUSTER_NETWORK_OPEN_ENUM =
    Option<unsafe extern "system" fn(hnetwork: HNETWORK, dwtype: u32) -> HNETWORKENUM>;
pub type PCLUSAPI_CLUSTER_NET_INTERFACE_CONTROL = Option<
    unsafe extern "system" fn(
...
>;
pub type PCLUSAPI_CLUSTER_NET_INTERFACE_CONTROL_EX = Option<
    unsafe extern "system" fn(
        hnetinterface: HNETINTERFACE,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
pub type PCLUSAPI_CLUSTER_NODE_CLOSE_ENUM =
    Option<unsafe extern "system" fn(hnodeenum: HNODEENUM) -> u32>;
pub type PCLUSAPI_CLUSTER_NODE_CLOSE_ENUM_EX =
    Option<unsafe extern "system" fn(hnodeenum: HNODEENUMEX) -> u32>;
pub type PCLUSAPI_CLUSTER_NODE_CONTROL = Option<
    unsafe extern "system" fn(
        hnode: HNODE,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
>;
pub type PCLUSAPI_CLUSTER_NODE_CONTROL_EX = Option<
    unsafe extern "system" fn(
        hnode: HNODE,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
>;
pub type PCLUSAPI_CLUSTER_NODE_ENUM = Option<
    unsafe extern "system" fn(
        hnodeenum: HNODEENUM,
        dwindex: u32,
        lpdwtype: *mut u32,
...
>;
pub type PCLUSAPI_CLUSTER_NODE_ENUM_EX = Option<
    unsafe extern "system" fn(
...
pub type PCLUSAPI_CLUSTER_NODE_OPEN_ENUM =
    Option<unsafe extern "system" fn(hnode: HNODE, dwtype: u32) -> HNODEENUM>;
pub type PCLUSAPI_CLUSTER_NODE_OPEN_ENUM_EX = Option<
    unsafe extern "system" fn(
        hnode: HNODE,
        dwtype: u32,
...
pub type PCLUSAPI_CLUSTER_OPEN_ENUM =
    Option<unsafe extern "system" fn(hcluster: HCLUSTER, dwtype: u32) -> HCLUSENUM>;
pub type PCLUSAPI_CLUSTER_OPEN_ENUM_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        dwtype: u32,
        poptions: *const core::ffi::c_void,
...
pub type PCLUSAPI_CLUSTER_REG_CLOSE_KEY =
    Option<unsafe extern "system" fn(hkey: super::super::System::Registry::HKEY) -> i32>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_CLUSTER_REG_CREATE_BATCH = Option<
    unsafe extern "system" fn(
...
>;
#[cfg(all(feature = "Win32_Security", feature = "Win32_System_Registry"))]
pub type PCLUSAPI_CLUSTER_REG_CREATE_KEY = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
...
>;
#[cfg(all(feature = "Win32_Security", feature = "Win32_System_Registry"))]
pub type PCLUSAPI_CLUSTER_REG_CREATE_KEY_EX = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
        lpszsubkey: windows_sys::core::PCWSTR,
        dwoptions: u32,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_CLUSTER_REG_DELETE_KEY = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
        lpszsubkey: windows_sys::core::PCWSTR,
    ) -> i32,
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_CLUSTER_REG_DELETE_KEY_EX = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_CLUSTER_REG_DELETE_VALUE = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_CLUSTER_REG_DELETE_VALUE_EX = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
        lpszvaluename: windows_sys::core::PCWSTR,
        lpszreason: windows_sys::core::PCWSTR,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_CLUSTER_REG_ENUM_KEY = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
        dwindex: u32,
        lpszname: windows_sys::core::PWSTR,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_CLUSTER_REG_ENUM_VALUE = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
        dwindex: u32,
...
>;
#[cfg(all(feature = "Win32_Security", feature = "Win32_System_Registry"))]
pub type PCLUSAPI_CLUSTER_REG_GET_KEY_SECURITY = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_CLUSTER_REG_OPEN_KEY = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
        lpszsubkey: windows_sys::core::PCWSTR,
        samdesired: u32,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_CLUSTER_REG_QUERY_INFO_KEY = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
        lpcsubkeys: *mut u32,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_CLUSTER_REG_QUERY_VALUE = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
        lpszvaluename: windows_sys::core::PCWSTR,
...
>;
#[cfg(all(feature = "Win32_Security", feature = "Win32_System_Registry"))]
pub type PCLUSAPI_CLUSTER_REG_SET_KEY_SECURITY = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
...
>;
#[cfg(all(feature = "Win32_Security", feature = "Win32_System_Registry"))]
pub type PCLUSAPI_CLUSTER_REG_SET_KEY_SECURITY_EX = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
        securityinformation: u32,
        psecuritydescriptor: super::super::Security::PSECURITY_DESCRIPTOR,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_CLUSTER_REG_SET_VALUE = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
        lpszvaluename: windows_sys::core::PCWSTR,
        dwtype: u32,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_CLUSTER_REG_SET_VALUE_EX = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
        lpszvaluename: windows_sys::core::PCWSTR,
        dwtype: u32,
...
pub type PCLUSAPI_CLUSTER_REG_SYNC_DATABASE =
    Option<unsafe extern "system" fn(hcluster: HCLUSTER, flags: u32) -> i32>;
pub type PCLUSAPI_CLUSTER_REMOVE_AFFINITY_RULE = Option<
    unsafe extern "system" fn(hcluster: HCLUSTER, rulename: windows_sys::core::PCWSTR) -> u32,
>;
pub type PCLUSAPI_CLUSTER_REMOVE_GROUP_FROM_AFFINITY_RULE = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        rulename: windows_sys::core::PCWSTR,
        hgroup: HGROUP,
...
pub type PCLUSAPI_CLUSTER_REMOVE_GROUP_FROM_GROUPSET =
    Option<unsafe extern "system" fn(hgroupset: HGROUPSET) -> u32>;
pub type PCLUSAPI_CLUSTER_REMOVE_GROUP_FROM_GROUPSET_EX = Option<
...
pub type PCLUSAPI_CLUSTER_RESOURCE_CLOSE_ENUM =
    Option<unsafe extern "system" fn(hresenum: HRESENUM) -> u32>;
pub type PCLUSAPI_CLUSTER_RESOURCE_CLOSE_ENUM_EX =
    Option<unsafe extern "system" fn(hresourceenumex: HRESENUMEX) -> u32>;
pub type PCLUSAPI_CLUSTER_RESOURCE_CONTROL = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
>;
pub type PCLUSAPI_CLUSTER_RESOURCE_CONTROL_AS_USER_EX = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
>;
pub type PCLUSAPI_CLUSTER_RESOURCE_CONTROL_EX = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        hhostnode: HNODE,
        dwcontrolcode: u32,
...
>;
pub type PCLUSAPI_CLUSTER_RESOURCE_ENUM = Option<
    unsafe extern "system" fn(
        hresenum: HRESENUM,
        dwindex: u32,
        lpdwtype: *mut u32,
...
>;
pub type PCLUSAPI_CLUSTER_RESOURCE_ENUM_EX = Option<
    unsafe extern "system" fn(
...
pub type PCLUSAPI_CLUSTER_RESOURCE_OPEN_ENUM =
    Option<unsafe extern "system" fn(hresource: HRESOURCE, dwtype: u32) -> HRESENUM>;
pub type PCLUSAPI_CLUSTER_RESOURCE_OPEN_ENUM_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszproperties: windows_sys::core::PCWSTR,
        cbproperties: u32,
...
pub type PCLUSAPI_CLUSTER_RESOURCE_TYPE_CLOSE_ENUM =
    Option<unsafe extern "system" fn(hrestypeenum: HRESTYPEENUM) -> u32>;
pub type PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
...
>;
pub type PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL_AS_USER_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszresourcetypename: windows_sys::core::PCWSTR,
        hhostnode: HNODE,
...
>;
pub type PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszresourcetypename: windows_sys::core::PCWSTR,
        hhostnode: HNODE,
...
>;
pub type PCLUSAPI_CLUSTER_RESOURCE_TYPE_ENUM = Option<
    unsafe extern "system" fn(
...
pub type PCLUSAPI_CLUSTER_RESOURCE_TYPE_GET_ENUM_COUNT =
    Option<unsafe extern "system" fn(hrestypeenum: HRESTYPEENUM) -> u32>;
pub type PCLUSAPI_CLUSTER_RESOURCE_TYPE_OPEN_ENUM = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszresourcetypename: windows_sys::core::PCWSTR,
        dwtype: u32,
...
>;
pub type PCLUSAPI_CLUSTER_UPGRADE = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        perform: windows_sys::core::BOOL,
        pfnprogresscallback: PCLUSTER_UPGRADE_PROGRESS_CALLBACK,
        pvcallbackarg: *const core::ffi::c_void,
    ) -> u32,
>;
pub type PCLUSAPI_CLUS_WORKER_CREATE = Option<
    unsafe extern "system" fn(
...
pub type PCLUSAPI_CLUS_WORKER_TERMINATE =
    Option<unsafe extern "system" fn(lpworker: *const CLUS_WORKER)>;
pub type PCLUSAPI_CREATE_CLUSTER = Option<
    unsafe extern "system" fn(
...
>;
pub type PCLUSAPI_CREATE_CLUSTER_AVAILABILITY_SET = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
...
>;
pub type PCLUSAPI_CREATE_CLUSTER_CNOLESS = Option<
    unsafe extern "system" fn(
        pconfig: *const CREATE_CLUSTER_CONFIG,
        pfnprogresscallback: PCLUSTER_SETUP_PROGRESS_CALLBACK,
        pvcallbackarg: *const core::ffi::c_void,
...
>;
pub type PCLUSAPI_CREATE_CLUSTER_GROUP = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszgroupname: windows_sys::core::PCWSTR,
    ) -> HGROUP,
>;
pub type PCLUSAPI_CREATE_CLUSTER_GROUPEX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszgroupname: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_CREATE_CLUSTER_GROUP_GROUPSET = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszgroupsetname: windows_sys::core::PCWSTR,
    ) -> HGROUPSET,
>;
pub type PCLUSAPI_CREATE_CLUSTER_NAME_ACCOUNT = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
...
>;
pub type PCLUSAPI_CREATE_CLUSTER_NOTIFY_PORT = Option<
    unsafe extern "system" fn(
        hchange: HCHANGE,
        hcluster: HCLUSTER,
        dwfilter: u32,
...
>;
pub type PCLUSAPI_CREATE_CLUSTER_NOTIFY_PORT_V2 = Option<
    unsafe extern "system" fn(
        hchange: HCHANGE,
        hcluster: HCLUSTER,
...
>;
pub type PCLUSAPI_CREATE_CLUSTER_RESOURCE = Option<
    unsafe extern "system" fn(
        hgroup: HGROUP,
...
>;
pub type PCLUSAPI_CREATE_CLUSTER_RESOURCE_EX = Option<
    unsafe extern "system" fn(
        hgroup: HGROUP,
        lpszresourcename: windows_sys::core::PCWSTR,
        lpszresourcetype: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_CREATE_CLUSTER_RESOURCE_TYPE = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszresourcetypename: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_CREATE_CLUSTER_RESOURCE_TYPE_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszresourcetypename: windows_sys::core::PCWSTR,
        lpszdisplayname: windows_sys::core::PCWSTR,
...
pub type PCLUSAPI_DELETE_CLUSTER_GROUP_EX =
    Option<unsafe extern "system" fn(hgroup: HGROUP, lpszreason: windows_sys::core::PCWSTR) -> u32>;
pub type PCLUSAPI_DELETE_CLUSTER_GROUP_GROUPSET =
    Option<unsafe extern "system" fn(hgroupset: HGROUPSET) -> u32>;
pub type PCLUSAPI_DELETE_CLUSTER_GROUP_GROUPSET_EX = Option<
    unsafe extern "system" fn(hgroupset: HGROUPSET, lpszreason: windows_sys::core::PCWSTR) -> u32,
>;
pub type PCLUSAPI_DELETE_CLUSTER_RESOURCE =
    Option<unsafe extern "system" fn(hresource: HRESOURCE) -> u32>;
pub type PCLUSAPI_DELETE_CLUSTER_RESOURCE_EX = Option<
    unsafe extern "system" fn(hresource: HRESOURCE, lpszreason: windows_sys::core::PCWSTR) -> u32,
>;
pub type PCLUSAPI_DELETE_CLUSTER_RESOURCE_TYPE = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszresourcetypename: windows_sys::core::PCWSTR,
    ) -> u32,
>;
pub type PCLUSAPI_DELETE_CLUSTER_RESOURCE_TYPE_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
...
>;
pub type PCLUSAPI_DESTROY_CLUSTER = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        pfnprogresscallback: PCLUSTER_SETUP_PROGRESS_CALLBACK,
        pvcallbackarg: *const core::ffi::c_void,
        fdeletevirtualcomputerobjects: windows_sys::core::BOOL,
    ) -> u32,
>;
pub type PCLUSAPI_DESTROY_CLUSTER_GROUP = Option<unsafe extern "system" fn(hgroup: HGROUP) -> u32>;
pub type PCLUSAPI_DESTROY_CLUSTER_GROUP_EX =
    Option<unsafe extern "system" fn(hgroup: HGROUP, lpszreason: windows_sys::core::PCWSTR) -> u32>;
pub type PCLUSAPI_EVICT_CLUSTER_NODE = Option<unsafe extern "system" fn(hnode: HNODE) -> u32>;
pub type PCLUSAPI_EVICT_CLUSTER_NODE_EX = Option<
    unsafe extern "system" fn(
        hnode: HNODE,
        dwtimeout: u32,
...
>;
pub type PCLUSAPI_EVICT_CLUSTER_NODE_EX2 = Option<
    unsafe extern "system" fn(
        hnode: HNODE,
        dwtimeout: u32,
        phrcleanupstatus: *mut windows_sys::core::HRESULT,
...
pub type PCLUSAPI_FAIL_CLUSTER_RESOURCE =
    Option<unsafe extern "system" fn(hresource: HRESOURCE) -> u32>;
pub type PCLUSAPI_FAIL_CLUSTER_RESOURCE_EX = Option<
    unsafe extern "system" fn(hresource: HRESOURCE, lpszreason: windows_sys::core::PCWSTR) -> u32,
>;
pub type PCLUSAPI_GET_CLUSTER_FROM_GROUP =
    Option<unsafe extern "system" fn(hgroup: HGROUP) -> HCLUSTER>;
pub type PCLUSAPI_GET_CLUSTER_FROM_GROUP_GROUPSET =
    Option<unsafe extern "system" fn(hgroupset: HGROUPSET) -> HCLUSTER>;
pub type PCLUSAPI_GET_CLUSTER_FROM_NETWORK =
    Option<unsafe extern "system" fn(hnetwork: HNETWORK) -> HCLUSTER>;
pub type PCLUSAPI_GET_CLUSTER_FROM_NET_INTERFACE =
    Option<unsafe extern "system" fn(hnetinterface: HNETINTERFACE) -> HCLUSTER>;
pub type PCLUSAPI_GET_CLUSTER_FROM_NODE =
    Option<unsafe extern "system" fn(hnode: HNODE) -> HCLUSTER>;
pub type PCLUSAPI_GET_CLUSTER_FROM_RESOURCE =
    Option<unsafe extern "system" fn(hresource: HRESOURCE) -> HCLUSTER>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_GET_CLUSTER_GROUP_KEY = Option<
    unsafe extern "system" fn(
        hgroup: HGROUP,
        samdesired: u32,
    ) -> super::super::System::Registry::HKEY,
>;
pub type PCLUSAPI_GET_CLUSTER_GROUP_STATE = Option<
    unsafe extern "system" fn(
        hgroup: HGROUP,
...
>;
pub type PCLUSAPI_GET_CLUSTER_INFORMATION = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_GET_CLUSTER_KEY = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        samdesired: u32,
    ) -> super::super::System::Registry::HKEY,
>;
pub type PCLUSAPI_GET_CLUSTER_NETWORK_ID = Option<
    unsafe extern "system" fn(
        hnetwork: HNETWORK,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_GET_CLUSTER_NETWORK_KEY = Option<
    unsafe extern "system" fn(
        hnetwork: HNETWORK,
        samdesired: u32,
    ) -> super::super::System::Registry::HKEY,
...
pub type PCLUSAPI_GET_CLUSTER_NETWORK_STATE =
    Option<unsafe extern "system" fn(hnetwork: HNETWORK) -> CLUSTER_NETWORK_STATE>;
pub type PCLUSAPI_GET_CLUSTER_NET_INTERFACE = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpsznodename: windows_sys::core::PCWSTR,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_GET_CLUSTER_NET_INTERFACE_KEY = Option<
    unsafe extern "system" fn(
        hnetinterface: HNETINTERFACE,
        samdesired: u32,
    ) -> super::super::System::Registry::HKEY,
...
pub type PCLUSAPI_GET_CLUSTER_NET_INTERFACE_STATE =
    Option<unsafe extern "system" fn(hnetinterface: HNETINTERFACE) -> CLUSTER_NETINTERFACE_STATE>;
pub type PCLUSAPI_GET_CLUSTER_NODE_ID = Option<
    unsafe extern "system" fn(
        hnode: HNODE,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_GET_CLUSTER_NODE_KEY = Option<
    unsafe extern "system" fn(
        hnode: HNODE,
        samdesired: u32,
    ) -> super::super::System::Registry::HKEY,
...
pub type PCLUSAPI_GET_CLUSTER_NODE_STATE =
    Option<unsafe extern "system" fn(hnode: HNODE) -> CLUSTER_NODE_STATE>;
pub type PCLUSAPI_GET_CLUSTER_NOTIFY = Option<
    unsafe extern "system" fn(
        hchange: HCHANGE,
...
>;
pub type PCLUSAPI_GET_CLUSTER_NOTIFY_V2 = Option<
    unsafe extern "system" fn(
        hchange: HCHANGE,
        lpdwnotifykey: *mut usize,
...
>;
pub type PCLUSAPI_GET_CLUSTER_QUORUM_RESOURCE = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszresourcename: windows_sys::core::PWSTR,
...
>;
pub type PCLUSAPI_GET_CLUSTER_RESOURCE_DEPENDENCY_EXPRESSION = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_GET_CLUSTER_RESOURCE_KEY = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        samdesired: u32,
    ) -> super::super::System::Registry::HKEY,
>;
pub type PCLUSAPI_GET_CLUSTER_RESOURCE_NETWORK_NAME = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
...
>;
pub type PCLUSAPI_GET_CLUSTER_RESOURCE_STATE = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        lpsznodename: windows_sys::core::PWSTR,
        lpcchnodename: *mut u32,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSAPI_GET_CLUSTER_RESOURCE_TYPE_KEY = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpsztypename: windows_sys::core::PCWSTR,
        samdesired: u32,
...
>;
pub type PCLUSAPI_GET_NODE_CLUSTER_STATE = Option<
    unsafe extern "system" fn(
        lpsznodename: windows_sys::core::PCWSTR,
        pdwclusterstate: *mut u32,
    ) -> u32,
>;
pub type PCLUSAPI_GET_NOTIFY_EVENT_HANDLE_V2 = Option<
    unsafe extern "system" fn(
        hchange: HCHANGE,
        lphtargetevent: *mut super::super::Foundation::HANDLE,
    ) -> u32,
>;
pub type PCLUSAPI_IS_FILE_ON_CLUSTER_SHARED_VOLUME = Option<
    unsafe extern "system" fn(
        lpszpathname: windows_sys::core::PCWSTR,
        pbfileisonsharedvolume: *mut windows_sys::core::BOOL,
    ) -> u32,
>;
pub type PCLUSAPI_MOVE_CLUSTER_GROUP =
    Option<unsafe extern "system" fn(hgroup: HGROUP, hdestinationnode: HNODE) -> u32>;
...
pub type PCLUSAPI_OPEN_CLUSTER =
    Option<unsafe extern "system" fn(lpszclustername: windows_sys::core::PCWSTR) -> HCLUSTER>;
pub type PCLUSAPI_OPEN_CLUSTER_EX = Option<
    unsafe extern "system" fn(
...
>;
pub type PCLUSAPI_OPEN_CLUSTER_GROUP = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszgroupname: windows_sys::core::PCWSTR,
    ) -> HGROUP,
>;
pub type PCLUSAPI_OPEN_CLUSTER_GROUP_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszgroupname: windows_sys::core::PCWSTR,
        dwdesiredaccess: u32,
...
>;
pub type PCLUSAPI_OPEN_CLUSTER_GROUP_GROUPSET = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszgroupsetname: windows_sys::core::PCWSTR,
    ) -> HGROUPSET,
>;
pub type PCLUSAPI_OPEN_CLUSTER_NETINTERFACE_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
...
>;
pub type PCLUSAPI_OPEN_CLUSTER_NETWORK = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpsznetworkname: windows_sys::core::PCWSTR,
    ) -> HNETWORK,
>;
pub type PCLUSAPI_OPEN_CLUSTER_NETWORK_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpsznetworkname: windows_sys::core::PCWSTR,
        dwdesiredaccess: u32,
...
>;
pub type PCLUSAPI_OPEN_CLUSTER_NET_INTERFACE = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszinterfacename: windows_sys::core::PCWSTR,
    ) -> HNETINTERFACE,
>;
pub type PCLUSAPI_OPEN_CLUSTER_NODE = Option<
    unsafe extern "system" fn(hcluster: HCLUSTER, lpsznodename: windows_sys::core::PCWSTR) -> HNODE,
>;
pub type PCLUSAPI_OPEN_CLUSTER_NODE_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpsznodename: windows_sys::core::PCWSTR,
        dwdesiredaccess: u32,
...
>;
pub type PCLUSAPI_OPEN_CLUSTER_RESOURCE = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszresourcename: windows_sys::core::PCWSTR,
    ) -> HRESOURCE,
>;
pub type PCLUSAPI_OPEN_CLUSTER_RESOURCE_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpszresourcename: windows_sys::core::PCWSTR,
        dwdesiredaccess: u32,
...
pub type PCLUSAPI_OPEN_NODE_BY_ID =
    Option<unsafe extern "system" fn(hcluster: HCLUSTER, nodeid: u32) -> HNODE>;
pub type PCLUSAPI_PAUSE_CLUSTER_NODE = Option<unsafe extern "system" fn(hnode: HNODE) -> u32>;
pub type PCLUSAPI_PAUSE_CLUSTER_NODE_EX = Option<
    unsafe extern "system" fn(
        hnode: HNODE,
        bdrainnode: windows_sys::core::BOOL,
        dwpauseflags: u32,
        hnodedraintarget: HNODE,
    ) -> u32,
>;
pub type PCLUSAPI_PAUSE_CLUSTER_NODE_EX2 = Option<
    unsafe extern "system" fn(
        hnode: HNODE,
        bdrainnode: windows_sys::core::BOOL,
        dwpauseflags: u32,
...
>;
pub type PCLUSAPI_PFN_REASON_HANDLER = Option<
    unsafe extern "system" fn(
...
>;
pub type PCLUSAPI_REGISTER_CLUSTER_NOTIFY = Option<
    unsafe extern "system" fn(
        hchange: HCHANGE,
        dwfiltertype: u32,
...
>;
pub type PCLUSAPI_REGISTER_CLUSTER_NOTIFY_V2 = Option<
    unsafe extern "system" fn(
        hchange: HCHANGE,
...
pub type PCLUSAPI_REMOVE_CLUSTER_GROUP_DEPENDENCY =
    Option<unsafe extern "system" fn(hgroup: HGROUP, hdependson: HGROUP) -> u32>;
pub type PCLUSAPI_REMOVE_CLUSTER_GROUP_DEPENDENCY_EX = Option<
    unsafe extern "system" fn(
        hgroup: HGROUP,
        hdependson: HGROUP,
        lpszreason: windows_sys::core::PCWSTR,
...
pub type PCLUSAPI_REMOVE_CLUSTER_GROUP_GROUPSET_DEPENDENCY =
    Option<unsafe extern "system" fn(hgroupset: HGROUPSET, hdependson: HGROUPSET) -> u32>;
pub type PCLUSAPI_REMOVE_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EX = Option<
    unsafe extern "system" fn(
        hgroupset: HGROUPSET,
...
pub type PCLUSAPI_REMOVE_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY =
    Option<unsafe extern "system" fn(hgroup: HGROUP, hdependson: HGROUPSET) -> u32>;
pub type PCLUSAPI_REMOVE_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY_EX = Option<
    unsafe extern "system" fn(
        hgroup: HGROUP,
        hdependson: HGROUPSET,
        lpszreason: windows_sys::core::PCWSTR,
...
pub type PCLUSAPI_REMOVE_CLUSTER_NAME_ACCOUNT =
    Option<unsafe extern "system" fn(hcluster: HCLUSTER) -> u32>;
pub type PCLUSAPI_REMOVE_CLUSTER_RESOURCE_DEPENDENCY =
    Option<unsafe extern "system" fn(hresource: HRESOURCE, hdependson: HRESOURCE) -> u32>;
pub type PCLUSAPI_REMOVE_CLUSTER_RESOURCE_DEPENDENCY_EX = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        hdependson: HRESOURCE,
        lpszreason: windows_sys::core::PCWSTR,
...
pub type PCLUSAPI_REMOVE_CLUSTER_RESOURCE_NODE =
    Option<unsafe extern "system" fn(hresource: HRESOURCE, hnode: HNODE) -> u32>;
pub type PCLUSAPI_REMOVE_CLUSTER_RESOURCE_NODE_EX = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        hnode: HNODE,
        lpszreason: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_REMOVE_CROSS_CLUSTER_GROUPSET_DEPENDENCY = Option<
    unsafe extern "system" fn(
        hdependentgroupset: HGROUPSET,
        lpremoteclustername: windows_sys::core::PCWSTR,
        lpremotegroupsetname: windows_sys::core::PCWSTR,
...
pub type PCLUSAPI_RESTART_CLUSTER_RESOURCE =
    Option<unsafe extern "system" fn(hresource: HRESOURCE, dwflags: u32) -> u32>;
pub type PCLUSAPI_RESTART_CLUSTER_RESOURCE_EX =
    Option<unsafe extern "system" fn(hresource: HRESOURCE, dwflags: u32) -> u32>;
pub type PCLUSAPI_RESTORE_CLUSTER_DATABASE = Option<
    unsafe extern "system" fn(
        lpszpathname: windows_sys::core::PCWSTR,
        bforce: windows_sys::core::BOOL,
...
pub type PCLUSAPI_RESUME_CLUSTER_NODE_EX = Option<
    unsafe extern "system" fn(
        hnode: HNODE,
...
>;
pub type PCLUSAPI_RESUME_CLUSTER_NODE_EX2 = Option<
    unsafe extern "system" fn(
        hnode: HNODE,
        eresumefailbacktype: CLUSTER_NODE_RESUME_FAILBACK_TYPE,
        dwresumeflagsreserved: u32,
...
>;
pub type PCLUSAPI_SET_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EXPRESSION = Option<
    unsafe extern "system" fn(
        hgroupset: HGROUPSET,
        lpszdependencyexpression: windows_sys::core::PCWSTR,
    ) -> u32,
>;
pub type PCLUSAPI_SET_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EXPRESSION_EX = Option<
    unsafe extern "system" fn(
        hgroupset: HGROUPSET,
        lpszdependencyexpression: windows_sys::core::PCWSTR,
        lpszreason: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_SET_CLUSTER_GROUP_NAME = Option<
    unsafe extern "system" fn(hgroup: HGROUP, lpszgroupname: windows_sys::core::PCWSTR) -> u32,
>;
pub type PCLUSAPI_SET_CLUSTER_GROUP_NAME_EX = Option<
    unsafe extern "system" fn(
        hgroup: HGROUP,
        lpszgroupname: windows_sys::core::PCWSTR,
        lpszreason: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_SET_CLUSTER_GROUP_NODE_LIST = Option<
    unsafe extern "system" fn(hgroup: HGROUP, nodecount: u32, nodelist: *const HNODE) -> u32,
>;
pub type PCLUSAPI_SET_CLUSTER_GROUP_NODE_LIST_EX = Option<
    unsafe extern "system" fn(
        hgroup: HGROUP,
        nodecount: u32,
...
>;
pub type PCLUSAPI_SET_CLUSTER_NAME_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
...
>;
pub type PCLUSAPI_SET_CLUSTER_NETWORK_NAME = Option<
    unsafe extern "system" fn(hnetwork: HNETWORK, lpszname: windows_sys::core::PCWSTR) -> u32,
>;
pub type PCLUSAPI_SET_CLUSTER_NETWORK_NAME_EX = Option<
    unsafe extern "system" fn(
        hnetwork: HNETWORK,
...
>;
pub type PCLUSAPI_SET_CLUSTER_NETWORK_PRIORITY_ORDER = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        networkcount: u32,
...
>;
pub type PCLUSAPI_SET_CLUSTER_QUORUM_RESOURCE = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
...
>;
pub type PCLUSAPI_SET_CLUSTER_QUORUM_RESOURCE_EX = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        lpszdevicename: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_SET_CLUSTER_RESOURCE_DEPENDENCY_EXPRESSION = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        lpszdependencyexpression: windows_sys::core::PCWSTR,
    ) -> u32,
>;
pub type PCLUSAPI_SET_CLUSTER_RESOURCE_NAME = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        lpszresourcename: windows_sys::core::PCWSTR,
    ) -> u32,
>;
pub type PCLUSAPI_SET_CLUSTER_RESOURCE_NAME_EX = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
        lpszresourcename: windows_sys::core::PCWSTR,
        lpszreason: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_SET_CLUSTER_SERVICE_ACCOUNT_PASSWORD = Option<
    unsafe extern "system" fn(
        lpszclustername: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION = Option<
    unsafe extern "system" fn(
        hgroupset: HGROUP,
        lpszdependencyexpression: windows_sys::core::PCWSTR,
    ) -> u32,
>;
pub type PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION_EX = Option<
    unsafe extern "system" fn(
        hgroup: HGROUP,
        lpszdependencyexpression: windows_sys::core::PCWSTR,
        lpszreason: windows_sys::core::PCWSTR,
...
>;
pub type PCLUSAPI_SET_REASON_HANDLER = Option<
    unsafe extern "system" fn(
        lphandler: *const CLUSAPI_REASON_HANDLER,
    ) -> *mut CLUSAPI_REASON_HANDLER,
>;
pub type PCLUSAPI_SHARED_VOLUME_SET_SNAPSHOT_STATE = Option<
    unsafe extern "system" fn(
...
>;
pub type PCLUSAPI_SetClusterName = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        lpsznewclustername: windows_sys::core::PCWSTR,
    ) -> u32,
...
pub type PCLUSTER_CLEAR_BACKUP_STATE_FOR_SHARED_VOLUME =
    Option<unsafe extern "system" fn(lpszvolumepathname: windows_sys::core::PCWSTR) -> u32>;
pub type PCLUSTER_DECRYPT = Option<
    unsafe extern "system" fn(
...
>;
pub type PCLUSTER_ENCRYPT = Option<
    unsafe extern "system" fn(
        hcluscryptprovider: HCLUSCRYPTPROVIDER,
        pdata: *const u8,
        cbdata: u32,
...
>;
pub type PCLUSTER_GET_VOLUME_NAME_FOR_VOLUME_MOUNT_POINT = Option<
    unsafe extern "system" fn(
...
>;
pub type PCLUSTER_GET_VOLUME_PATH_NAME = Option<
    unsafe extern "system" fn(
...
>;
pub type PCLUSTER_IS_PATH_ON_SHARED_VOLUME = Option<
    unsafe extern "system" fn(lpszpathname: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL,
>;
pub type PCLUSTER_PREPARE_SHARED_VOLUME_FOR_BACKUP = Option<
    unsafe extern "system" fn(
        lpszfilename: windows_sys::core::PCWSTR,
        lpszvolumepathname: windows_sys::core::PWSTR,
...
>;
pub type PCLUSTER_REG_BATCH_ADD_COMMAND = Option<
    unsafe extern "system" fn(
        hregbatch: HREGBATCH,
...
pub type PCLUSTER_REG_BATCH_CLOSE_NOTIFICATION =
    Option<unsafe extern "system" fn(hbatchnotification: HREGBATCHNOTIFICATION) -> i32>;
pub type PCLUSTER_REG_BATCH_READ_COMMAND = Option<
    unsafe extern "system" fn(
        hbatchnotification: HREGBATCHNOTIFICATION,
        pbatchcommand: *mut CLUSTER_BATCH_COMMAND,
    ) -> i32,
>;
pub type PCLUSTER_REG_CLOSE_BATCH = Option<
    unsafe extern "system" fn(
        hregbatch: HREGBATCH,
        bcommit: windows_sys::core::BOOL,
        failedcommandnumber: *mut i32,
    ) -> i32,
>;
pub type PCLUSTER_REG_CLOSE_BATCH_NOTIFY_PORT =
    Option<unsafe extern "system" fn(hbatchnotifyport: HREGBATCHPORT) -> i32>;
pub type PCLUSTER_REG_CLOSE_READ_BATCH = Option<
    unsafe extern "system" fn(
        hregreadbatch: HREGREADBATCH,
        phregreadbatchreply: *mut HREGREADBATCHREPLY,
    ) -> i32,
>;
pub type PCLUSTER_REG_CLOSE_READ_BATCH_EX = Option<
    unsafe extern "system" fn(
        hregreadbatch: HREGREADBATCH,
        flags: u32,
        phregreadbatchreply: *mut HREGREADBATCHREPLY,
...
pub type PCLUSTER_REG_CLOSE_READ_BATCH_REPLY =
    Option<unsafe extern "system" fn(hregreadbatchreply: HREGREADBATCHREPLY) -> i32>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSTER_REG_CREATE_BATCH_NOTIFY_PORT = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PCLUSTER_REG_CREATE_READ_BATCH = Option<
    unsafe extern "system" fn(
        hkey: super::super::System::Registry::HKEY,
        phregreadbatch: *mut HREGREADBATCH,
    ) -> i32,
>;
pub type PCLUSTER_REG_GET_BATCH_NOTIFICATION = Option<
    unsafe extern "system" fn(
        hbatchnotify: HREGBATCHPORT,
        phbatchnotification: *mut HREGBATCHNOTIFICATION,
    ) -> i32,
>;
pub type PCLUSTER_REG_READ_BATCH_ADD_COMMAND = Option<
    unsafe extern "system" fn(
        hregreadbatch: HREGREADBATCH,
...
>;
pub type PCLUSTER_REG_READ_BATCH_REPLY_NEXT_COMMAND = Option<
    unsafe extern "system" fn(
        hregreadbatchreply: HREGREADBATCHREPLY,
        pbatchcommand: *mut CLUSTER_READ_BATCH_COMMAND,
    ) -> i32,
>;
pub type PCLUSTER_SETUP_PROGRESS_CALLBACK = Option<
    unsafe extern "system" fn(
...
>;
pub type PCLUSTER_SET_ACCOUNT_ACCESS = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
...
>;
pub type PCLUSTER_UPGRADE_PROGRESS_CALLBACK = Option<
    unsafe extern "system" fn(
        pvcallbackarg: *mut core::ffi::c_void,
...
pub type PEND_TYPE_CONTROL_CALL =
    Option<unsafe extern "system" fn(context: i64, status: u32) -> u32>;
pub type PEXTEND_RES_CONTROL_CALL =
    Option<unsafe extern "system" fn(context: i64, newtimeoutinms: u32) -> u32>;
pub type PEXTEND_RES_TYPE_CONTROL_CALL =
    Option<unsafe extern "system" fn(context: i64, newtimeoutinms: u32) -> u32>;
pub type PFREE_CLUSTER_CRYPT =
    Option<unsafe extern "system" fn(pcryptinfo: *const core::ffi::c_void) -> u32>;
pub type PIS_ALIVE_ROUTINE =
    Option<unsafe extern "system" fn(resource: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
...
pub type PLOG_EVENT_ROUTINE = Option<
    unsafe extern "system" fn(
...
pub type POFFLINE_ROUTINE =
    Option<unsafe extern "system" fn(resource: *mut core::ffi::c_void) -> u32>;
pub type POFFLINE_V2_ROUTINE = Option<
    unsafe extern "system" fn(
...
>;
pub type PONLINE_ROUTINE = Option<
    unsafe extern "system" fn(
        resource: *mut core::ffi::c_void,
        eventhandle: *mut super::super::Foundation::HANDLE,
    ) -> u32,
>;
pub type PONLINE_V2_ROUTINE = Option<
    unsafe extern "system" fn(
        resource: *const core::ffi::c_void,
        eventhandle: *mut super::super::Foundation::HANDLE,
        onlineflags: u32,
...
>;
pub type POPEN_CLUSTER_CRYPT_PROVIDER = Option<
    unsafe extern "system" fn(
...
>;
pub type POPEN_CLUSTER_CRYPT_PROVIDEREX = Option<
    unsafe extern "system" fn(
        lpszresource: windows_sys::core::PCWSTR,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type POPEN_V2_ROUTINE = Option<
    unsafe extern "system" fn(
        resourcename: windows_sys::core::PCWSTR,
        resourcekey: super::super::System::Registry::HKEY,
        resourcehandle: isize,
...
pub type PQUERY_APPINSTANCE_VERSION = Option<
    unsafe extern "system" fn(
...
pub type PRAISE_RES_TYPE_NOTIFICATION = Option<
    unsafe extern "system" fn(
...
>;
pub type PREGISTER_APPINSTANCE = Option<
    unsafe extern "system" fn(
        processhandle: super::super::Foundation::HANDLE,
        appinstanceid: *const windows_sys::core::GUID,
        childreninheritappinstance: windows_sys::core::BOOL,
    ) -> u32,
>;
pub type PREGISTER_APPINSTANCE_VERSION = Option<
    unsafe extern "system" fn(
        appinstanceid: *const windows_sys::core::GUID,
...
pub type PRELEASE_ROUTINE =
    Option<unsafe extern "system" fn(resource: *mut core::ffi::c_void) -> u32>;
pub type PREQUEST_DUMP_ROUTINE = Option<
    unsafe extern "system" fn(
        resourcehandle: isize,
        dumpduetocallinprogress: windows_sys::core::BOOL,
        dumpdelayinms: u32,
    ) -> u32,
>;
pub type PRESET_ALL_APPINSTANCE_VERSIONS = Option<unsafe extern "system" fn() -> u32>;
pub type PRESOURCE_CONTROL_ROUTINE = Option<
    unsafe extern "system" fn(
        resource: *mut core::ffi::c_void,
        controlcode: u32,
        inbuffer: *mut core::ffi::c_void,
...
>;
pub type PRESOURCE_TYPE_CONTROL_ROUTINE = Option<
    unsafe extern "system" fn(
        resourcetypename: windows_sys::core::PCWSTR,
        controlcode: u32,
        inbuffer: *mut core::ffi::c_void,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_ADD_UNKNOWN_PROPERTIES = Option<
    unsafe extern "system" fn(
...
pub type PRESUTIL_CREATE_DIRECTORY_TREE =
    Option<unsafe extern "system" fn(pszpath: windows_sys::core::PCWSTR) -> u32>;
pub type PRESUTIL_DUP_PARAMETER_BLOCK = Option<
    unsafe extern "system" fn(
        poutparams: *mut u8,
        pinparams: *const u8,
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
...
>;
pub type PRESUTIL_DUP_STRING = Option<
    unsafe extern "system" fn(pszinstring: windows_sys::core::PCWSTR) -> windows_sys::core::PWSTR,
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_ENUM_PRIVATE_PROPERTIES = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
...
>;
pub type PRESUTIL_ENUM_PROPERTIES = Option<
    unsafe extern "system" fn(
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
        pszoutproperties: windows_sys::core::PWSTR,
        cboutpropertiessize: u32,
...
>;
pub type PRESUTIL_ENUM_RESOURCES = Option<
    unsafe extern "system" fn(
        hself: HRESOURCE,
...
>;
pub type PRESUTIL_ENUM_RESOURCES_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        hself: HRESOURCE,
        lpszrestypename: windows_sys::core::PCWSTR,
...
>;
pub type PRESUTIL_ENUM_RESOURCES_EX2 = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        hself: HRESOURCE,
        lpszrestypename: windows_sys::core::PCWSTR,
...
>;
pub type PRESUTIL_EXPAND_ENVIRONMENT_STRINGS = Option<
    unsafe extern "system" fn(pszsrc: windows_sys::core::PCWSTR) -> windows_sys::core::PWSTR,
>;
pub type PRESUTIL_FIND_BINARY_PROPERTY = Option<
    unsafe extern "system" fn(
...
>;
pub type PRESUTIL_FIND_DEPENDENT_DISK_RESOURCE_DRIVE_LETTER = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        hresource: HRESOURCE,
...
>;
pub type PRESUTIL_FIND_DWORD_PROPERTY = Option<
    unsafe extern "system" fn(
        ppropertylist: *const core::ffi::c_void,
        cbpropertylistsize: u32,
        pszpropertyname: windows_sys::core::PCWSTR,
...
>;
pub type PRESUTIL_FIND_EXPANDED_SZ_PROPERTY = Option<
    unsafe extern "system" fn(
        ppropertylist: *const core::ffi::c_void,
        cbpropertylistsize: u32,
        pszpropertyname: windows_sys::core::PCWSTR,
...
>;
pub type PRESUTIL_FIND_EXPAND_SZ_PROPERTY = Option<
    unsafe extern "system" fn(
        ppropertylist: *const core::ffi::c_void,
        cbpropertylistsize: u32,
        pszpropertyname: windows_sys::core::PCWSTR,
...
>;
pub type PRESUTIL_FIND_FILETIME_PROPERTY = Option<
    unsafe extern "system" fn(
        ppropertylist: *const core::ffi::c_void,
        cbpropertylistsize: u32,
        pszpropertyname: windows_sys::core::PCWSTR,
...
>;
pub type PRESUTIL_FIND_LONG_PROPERTY = Option<
    unsafe extern "system" fn(
        ppropertylist: *const core::ffi::c_void,
        cbpropertylistsize: u32,
        pszpropertyname: windows_sys::core::PCWSTR,
...
>;
pub type PRESUTIL_FIND_MULTI_SZ_PROPERTY = Option<
    unsafe extern "system" fn(
        ppropertylist: *const core::ffi::c_void,
        cbpropertylistsize: u32,
        pszpropertyname: windows_sys::core::PCWSTR,
...
>;
pub type PRESUTIL_FIND_SZ_PROPERTY = Option<
    unsafe extern "system" fn(
        ppropertylist: *const core::ffi::c_void,
        cbpropertylistsize: u32,
        pszpropertyname: windows_sys::core::PCWSTR,
...
>;
pub type PRESUTIL_FIND_ULARGEINTEGER_PROPERTY = Option<
    unsafe extern "system" fn(
        ppropertylist: *const core::ffi::c_void,
        cbpropertylistsize: u32,
        pszpropertyname: windows_sys::core::PCWSTR,
...
pub type PRESUTIL_FREE_ENVIRONMENT =
    Option<unsafe extern "system" fn(lpenvironment: *mut core::ffi::c_void) -> u32>;
pub type PRESUTIL_FREE_PARAMETER_BLOCK = Option<
    unsafe extern "system" fn(
        poutparams: *mut u8,
        pinparams: *const u8,
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_GET_ALL_PROPERTIES = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
        poutpropertylist: *mut core::ffi::c_void,
...
>;
pub type PRESUTIL_GET_BINARY_PROPERTY = Option<
    unsafe extern "system" fn(
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_GET_BINARY_VALUE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
...
>;
pub type PRESUTIL_GET_CORE_CLUSTER_RESOURCES = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
...
>;
pub type PRESUTIL_GET_CORE_CLUSTER_RESOURCES_EX = Option<
    unsafe extern "system" fn(
        hclusterin: HCLUSTER,
...
>;
pub type PRESUTIL_GET_DWORD_PROPERTY = Option<
    unsafe extern "system" fn(
        pdwoutvalue: *mut u32,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_GET_DWORD_VALUE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        pszvaluename: windows_sys::core::PCWSTR,
        pdwoutvalue: *mut u32,
...
pub type PRESUTIL_GET_ENVIRONMENT_WITH_NET_NAME =
    Option<unsafe extern "system" fn(hresource: HRESOURCE) -> *mut core::ffi::c_void>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_GET_EXPAND_SZ_VALUE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        pszvaluename: windows_sys::core::PCWSTR,
        bexpand: windows_sys::core::BOOL,
    ) -> windows_sys::core::PWSTR,
>;
pub type PRESUTIL_GET_FILETIME_PROPERTY = Option<
    unsafe extern "system" fn(
...
>;
pub type PRESUTIL_GET_LONG_PROPERTY = Option<
    unsafe extern "system" fn(
        ploutvalue: *mut i32,
...
>;
pub type PRESUTIL_GET_MULTI_SZ_PROPERTY = Option<
    unsafe extern "system" fn(
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_GET_PRIVATE_PROPERTIES = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        poutpropertylist: *mut core::ffi::c_void,
        cboutpropertylistsize: u32,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_GET_PROPERTIES = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
        poutpropertylist: *mut core::ffi::c_void,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_GET_PROPERTIES_TO_PARAMETER_BLOCK = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
        poutparams: *mut u8,
        bcheckforrequiredproperties: windows_sys::core::BOOL,
        psznameofpropinerror: *mut windows_sys::core::PWSTR,
    ) -> u32,
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_GET_PROPERTY = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
...
>;
pub type PRESUTIL_GET_PROPERTY_FORMATS = Option<
    unsafe extern "system" fn(
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_GET_PROPERTY_SIZE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        ppropertytableitem: *const RESUTIL_PROPERTY_ITEM,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_GET_QWORD_VALUE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        pszvaluename: windows_sys::core::PCWSTR,
        pqwoutvalue: *mut u64,
...
>;
pub type PRESUTIL_GET_RESOURCE_DEPENDENCY = Option<
    unsafe extern "system" fn(
        hself: super::super::Foundation::HANDLE,
        lpszresourcetype: windows_sys::core::PCWSTR,
    ) -> HRESOURCE,
>;
pub type PRESUTIL_GET_RESOURCE_DEPENDENCY_BY_CLASS = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        hself: super::super::Foundation::HANDLE,
        prci: *mut CLUS_RESOURCE_CLASS_INFO,
        brecurse: windows_sys::core::BOOL,
    ) -> HRESOURCE,
>;
pub type PRESUTIL_GET_RESOURCE_DEPENDENCY_BY_CLASS_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        hself: super::super::Foundation::HANDLE,
        prci: *mut CLUS_RESOURCE_CLASS_INFO,
...
>;
pub type PRESUTIL_GET_RESOURCE_DEPENDENCY_BY_NAME = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        hself: super::super::Foundation::HANDLE,
        lpszresourcetype: windows_sys::core::PCWSTR,
...
>;
pub type PRESUTIL_GET_RESOURCE_DEPENDENCY_BY_NAME_EX = Option<
    unsafe extern "system" fn(
        hcluster: HCLUSTER,
        hself: super::super::Foundation::HANDLE,
        lpszresourcetype: windows_sys::core::PCWSTR,
...
>;
pub type PRESUTIL_GET_RESOURCE_DEPENDENCY_EX = Option<
    unsafe extern "system" fn(
        hself: super::super::Foundation::HANDLE,
        lpszresourcetype: windows_sys::core::PCWSTR,
        dwdesiredaccess: u32,
...
>;
pub type PRESUTIL_GET_RESOURCE_DEPENDENTIP_ADDRESS_PROPS = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
...
>;
pub type PRESUTIL_GET_RESOURCE_NAME = Option<
    unsafe extern "system" fn(
        hresource: HRESOURCE,
...
>;
pub type PRESUTIL_GET_RESOURCE_NAME_DEPENDENCY = Option<
    unsafe extern "system" fn(
        lpszresourcename: windows_sys::core::PCWSTR,
        lpszresourcetype: windows_sys::core::PCWSTR,
    ) -> HRESOURCE,
>;
pub type PRESUTIL_GET_RESOURCE_NAME_DEPENDENCY_EX = Option<
    unsafe extern "system" fn(
        lpszresourcename: windows_sys::core::PCWSTR,
        lpszresourcetype: windows_sys::core::PCWSTR,
        dwdesiredaccess: u32,
...
>;
pub type PRESUTIL_GET_SZ_PROPERTY = Option<
    unsafe extern "system" fn(
        ppszoutvalue: *mut windows_sys::core::PWSTR,
        pvaluestruct: *const CLUSPROP_SZ,
        pszoldvalue: windows_sys::core::PCWSTR,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_GET_SZ_VALUE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        pszvaluename: windows_sys::core::PCWSTR,
    ) -> windows_sys::core::PWSTR,
>;
pub type PRESUTIL_IS_PATH_VALID = Option<
    unsafe extern "system" fn(pszpath: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL,
>;
...
>;
pub type PRESUTIL_PROPERTY_LIST_FROM_PARAMETER_BLOCK = Option<
    unsafe extern "system" fn(
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
        poutpropertylist: *mut core::ffi::c_void,
        pcboutpropertylistsize: *mut u32,
...
>;
pub type PRESUTIL_REMOVE_RESOURCE_SERVICE_ENVIRONMENT = Option<
    unsafe extern "system" fn(
...
>;
pub type PRESUTIL_RESOURCES_EQUAL = Option<
    unsafe extern "system" fn(hself: HRESOURCE, hresource: HRESOURCE) -> windows_sys::core::BOOL,
>;
pub type PRESUTIL_RESOURCE_TYPES_EQUAL = Option<
    unsafe extern "system" fn(
        lpszresourcetypename: windows_sys::core::PCWSTR,
        hresource: HRESOURCE,
    ) -> windows_sys::core::BOOL,
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_SET_BINARY_VALUE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        pszvaluename: windows_sys::core::PCWSTR,
        pbnewvalue: *const u8,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_SET_DWORD_VALUE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        pszvaluename: windows_sys::core::PCWSTR,
        dwnewvalue: u32,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_SET_EXPAND_SZ_VALUE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        pszvaluename: windows_sys::core::PCWSTR,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_SET_MULTI_SZ_VALUE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        pszvaluename: windows_sys::core::PCWSTR,
        psznewvalue: windows_sys::core::PCWSTR,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_SET_PRIVATE_PROPERTY_LIST = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_SET_PROPERTY_PARAMETER_BLOCK = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_SET_PROPERTY_PARAMETER_BLOCK_EX = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
        reserved: *mut core::ffi::c_void,
        ...
        pinpropertylist: *const core::ffi::c_void,
        cbinpropertylistsize: u32,
        bforcewrite: windows_sys::core::BOOL,
        poutparams: *mut u8,
    ) -> u32,
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_SET_PROPERTY_TABLE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
        reserved: *const core::ffi::c_void,
        ballowunknownproperties: windows_sys::core::BOOL,
        pinpropertylist: *const core::ffi::c_void,
        cbinpropertylistsize: u32,
        poutparams: *mut u8,
    ) -> u32,
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_SET_PROPERTY_TABLE_EX = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
        reserved: *mut core::ffi::c_void,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_SET_QWORD_VALUE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        pszvaluename: windows_sys::core::PCWSTR,
        qwnewvalue: u64,
...
>;
pub type PRESUTIL_SET_RESOURCE_SERVICE_ENVIRONMENT = Option<
    unsafe extern "system" fn(
        pszservicename: windows_sys::core::PCWSTR,
        hresource: HRESOURCE,
        pfnlogevent: PLOG_EVENT_ROUTINE,
...
>;
#[cfg(feature = "Win32_System_Services")]
pub type PRESUTIL_SET_RESOURCE_SERVICE_START_PARAMETERS = Option<
    unsafe extern "system" fn(
        pszservicename: windows_sys::core::PCWSTR,
        schscmhandle: super::super::System::Services::SC_HANDLE,
        phservice: *mut super::super::System::Services::SC_HANDLE,
        pfnlogevent: PLOG_EVENT_ROUTINE,
        hresourcehandle: isize,
    ) -> u32,
>;
#[cfg(feature = "Win32_System_Services")]
pub type PRESUTIL_SET_RESOURCE_SERVICE_START_PARAMETERS_EX = Option<
    unsafe extern "system" fn(
        pszservicename: windows_sys::core::PCWSTR,
        schscmhandle: super::super::System::Services::SC_HANDLE,
        phservice: *mut super::super::System::Services::SC_HANDLE,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_SET_SZ_VALUE = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        pszvaluename: windows_sys::core::PCWSTR,
        psznewvalue: windows_sys::core::PCWSTR,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PRESUTIL_SET_UNKNOWN_PROPERTIES = Option<
    unsafe extern "system" fn(
        hkeyclusterkey: super::super::System::Registry::HKEY,
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
        pinpropertylist: *const core::ffi::c_void,
...
>;
#[cfg(feature = "Win32_System_Services")]
pub type PRESUTIL_START_RESOURCE_SERVICE = Option<
    unsafe extern "system" fn(
        pszservicename: windows_sys::core::PCWSTR,
        phservicehandle: *mut super::super::System::Services::SC_HANDLE,
    ) -> u32,
>;
pub type PRESUTIL_STOP_RESOURCE_SERVICE =
    Option<unsafe extern "system" fn(pszservicename: windows_sys::core::PCWSTR) -> u32>;
#[cfg(feature = "Win32_System_Services")]
pub type PRESUTIL_STOP_SERVICE = Option<
    unsafe extern "system" fn(hservicehandle: super::super::System::Services::SC_HANDLE) -> u32,
>;
pub type PRESUTIL_TERMINATE_SERVICE_PROCESS_FROM_RES_DLL = Option<
    unsafe extern "system" fn(
        dwservicepid: u32,
        boffline: windows_sys::core::BOOL,
        pdwresourcestate: *mut u32,
        pfnlogevent: PLOG_EVENT_ROUTINE,
        hresourcehandle: isize,
    ) -> u32,
>;
pub type PRESUTIL_VERIFY_PRIVATE_PROPERTY_LIST = Option<
    unsafe extern "system" fn(
        pinpropertylist: *const core::ffi::c_void,
        cbinpropertylistsize: u32,
    ) -> u32,
>;
pub type PRESUTIL_VERIFY_PROPERTY_TABLE = Option<
    unsafe extern "system" fn(
        ppropertytable: *const RESUTIL_PROPERTY_ITEM,
        reserved: *const core::ffi::c_void,
        ballowunknownproperties: windows_sys::core::BOOL,
...
pub type PRESUTIL_VERIFY_RESOURCE_SERVICE =
    Option<unsafe extern "system" fn(pszservicename: windows_sys::core::PCWSTR) -> u32>;
#[cfg(feature = "Win32_System_Services")]
pub type PRESUTIL_VERIFY_SERVICE = Option<
    unsafe extern "system" fn(hservicehandle: super::super::System::Services::SC_HANDLE) -> u32,
>;
pub type PRES_UTIL_VERIFY_SHUTDOWN_SAFE =
    Option<unsafe extern "system" fn(flags: u32, reason: u32, presult: *mut u32) -> u32>;
pub type PSET_INTERNAL_STATE = Option<
    unsafe extern "system" fn(
        param0: isize,
        statetype: CLUSTER_RESOURCE_APPLICATION_STATE,
        active: windows_sys::core::BOOL,
    ) -> u32,
>;
pub type PSET_RESOURCE_INMEMORY_NODELOCAL_PROPERTIES_ROUTINE = Option<
    unsafe extern "system" fn(
        resourcehandle: isize,
...
>;
pub type PSET_RESOURCE_LOCKED_MODE_EX_ROUTINE = Option<
    unsafe extern "system" fn(
        resourcehandle: isize,
        lockedmodeenabled: windows_sys::core::BOOL,
        lockedmodereason: u32,
        lockedmodeflags: u32,
    ) -> u32,
>;
pub type PSET_RESOURCE_LOCKED_MODE_ROUTINE = Option<
    unsafe extern "system" fn(
        resourcehandle: isize,
        lockedmodeenabled: windows_sys::core::BOOL,
        lockedmodereason: u32,
...
>;
pub type PSET_RESOURCE_STATUS_ROUTINE = Option<
    unsafe extern "system" fn(resourcehandle: isize, resourcestatus: *mut RESOURCE_STATUS) -> u32,
>;
pub type PSET_RESOURCE_STATUS_ROUTINE_EX = Option<
    unsafe extern "system" fn(
        resourcehandle: isize,
        resourcestatus: *mut RESOURCE_STATUS_EX,
    ) -> u32,
>;
pub type PSET_RESOURCE_WPR_POLICY_ROUTINE =
    Option<unsafe extern "system" fn(resourcehandle: isize, wprpolicyflags: u32) -> u32>;
pub type PSIGNAL_FAILURE_ROUTINE = Option<
    unsafe extern "system" fn(
        resourcehandle: isize,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PSTARTUP_EX_ROUTINE = Option<
    unsafe extern "system" fn(
        resourcetype: windows_sys::core::PCWSTR,
...
>;
#[cfg(feature = "Win32_System_Registry")]
pub type PSTARTUP_ROUTINE = Option<
    unsafe extern "system" fn(
        resourcetype: windows_sys::core::PCWSTR,
        minversionsupported: u32,
        maxversionsupported: u32,
...
pub type PWORKER_START_ROUTINE = Option<
    unsafe extern "system" fn(
...
pub type SET_APP_INSTANCE_CSV_FLAGS = Option<
    unsafe extern "system" fn(
        processhandle: super::super::Foundation::HANDLE,
        mask: u32,
        flags: u32,

...
pub type FREEOBJPROC =
    Option<unsafe extern "system" fn(pdriverobj: *mut DRIVEROBJ) -> windows_sys::core::BOOL>;
#[repr(C)]
#[cfg(feature = "Win32_System_Console")]
#[derive(Clone, Copy, Default)]
...
pub type PFN_DrvEndDoc =
    Option<unsafe extern "system" fn(pso: *mut SURFOBJ, fl: u32) -> windows_sys::core::BOOL>;
...
pub type PFN_DrvResetPDEV = Option<
    unsafe extern "system" fn(dhpdevold: DHPDEV, dhpdevnew: DHPDEV) -> windows_sys::core::BOOL,
>;
...
pub type PFN_DrvSendPage =
    Option<unsafe extern "system" fn(param0: *mut SURFOBJ) -> windows_sys::core::BOOL>;
...
pub type PFN_DrvStartPage =
    Option<unsafe extern "system" fn(pso: *mut SURFOBJ) -> windows_sys::core::BOOL>;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type PFN_DrvSwapBuffers = Option<
    unsafe extern "system" fn(param0: *mut SURFOBJ, param1: *mut WNDOBJ) -> windows_sys::core::BOOL,
>;
...
pub type PFN_DrvUnloadFontFile =
    Option<unsafe extern "system" fn(param0: usize) -> windows_sys::core::BOOL>;

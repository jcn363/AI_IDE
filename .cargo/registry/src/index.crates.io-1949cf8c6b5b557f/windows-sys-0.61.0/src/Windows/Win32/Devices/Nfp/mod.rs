pub const DEVPKEY_NFP_Capabilities: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_sys::core::GUID::from_u128(0xfb3842cd_9e2a_4f83_8fcc_4b0761139ae9),
        pid: 2,
    };
pub const GUID_DEVINTERFACE_NFP: windows_sys::core::GUID =
    windows_sys::core::GUID::from_u128(0xfb3842cd_9e2a_4f83_8fcc_4b0761139ae9);

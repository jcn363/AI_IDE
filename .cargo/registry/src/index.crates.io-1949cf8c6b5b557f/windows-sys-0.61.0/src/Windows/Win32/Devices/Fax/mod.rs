...
pub const DEVPKEY_WIA_USDClassId: super::super::Foundation::DEVPROPKEY =
    super::super::Foundation::DEVPROPKEY {
        fmtid: windows_sys::core::GUID::from_u128(0x6bdd1fc6_810f_11d0_bec7_08002be2092f),
        pid: 3,
    };
...
pub type PFAXABORT = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        jobid: u32,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXACCESSCHECK = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        accessmask: u32,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXCLOSE = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXCOMPLETEJOBPARAMSA = Option<
    unsafe extern "system" fn(
...
>;
pub type PFAXCONNECTFAXSERVERA = Option<
    unsafe extern "system" fn(
        machinename: windows_sys::core::PCSTR,
        faxhandle: *mut super::super::Foundation::HANDLE,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXCONNECTFAXSERVERW = Option<
    unsafe extern "system" fn(
        machinename: windows_sys::core::PCWSTR,
        faxhandle: *mut super::super::Foundation::HANDLE,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXDEVABORTOPERATION = Option<
    unsafe extern "system" fn(param0: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL,
>;
#[cfg(feature = "Win32_UI_Controls")]
pub type PFAXDEVCONFIGURE = Option<
    unsafe extern "system" fn(
        param0: *mut super::super::UI::Controls::HPROPSHEETPAGE,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXDEVENDJOB = Option<
    unsafe extern "system" fn(param0: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL,
>;
pub type PFAXDEVINITIALIZE = Option<
    unsafe extern "system" fn(
        param0: u32,
...
>;
pub type PFAXDEVRECEIVE = Option<
    unsafe extern "system" fn(
...
pub type PFAXDEVSTARTJOB = Option<
    unsafe extern "system" fn(
        param0: u32,
        param1: u32,
...
>;
pub type PFAXDEVVIRTUALDEVICECREATION = Option<
    unsafe extern "system" fn(
        devicecount: *mut u32,
...
>;
pub type PFAXENABLEROUTINGMETHODA = Option<
    unsafe extern "system" fn(
...
>;
pub type PFAXENABLEROUTINGMETHODW = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
...
>;
pub type PFAXENUMGLOBALROUTINGINFOA = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
...
>;
pub type PFAXENUMGLOBALROUTINGINFOW = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
...
>;
pub type PFAXENUMPORTSA = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
...
>;
pub type PFAXENUMPORTSW = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
...
>;
pub type PFAXENUMROUTINGMETHODSA = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
...
>;
pub type PFAXENUMROUTINGMETHODSW = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
...
pub type PFAXGETCONFIGURATIONA = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        faxconfig: *mut *mut FAX_CONFIGURATIONA,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXGETCONFIGURATIONW = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        faxconfig: *mut *mut FAX_CONFIGURATIONW,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXGETDEVICESTATUSA = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
        devicestatus: *mut *mut FAX_DEVICE_STATUSA,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXGETDEVICESTATUSW = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
        devicestatus: *mut *mut FAX_DEVICE_STATUSW,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXGETJOBA = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        jobid: u32,
        jobentry: *mut *mut FAX_JOB_ENTRYA,
...
>;
pub type PFAXGETLOGGINGCATEGORIESA = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
...
>;
pub type PFAXGETLOGGINGCATEGORIESW = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
...
>;
pub type PFAXGETPAGEDATA = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        jobid: u32,
        buffer: *mut *mut u8,
...
>;
pub type PFAXGETPORTA = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
        portinfo: *mut *mut FAX_PORT_INFOA,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXGETPORTW = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
        portinfo: *mut *mut FAX_PORT_INFOW,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXGETROUTINGINFOA = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
        routingguid: windows_sys::core::PCSTR,
...
>;
pub type PFAXGETROUTINGINFOW = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
        routingguid: windows_sys::core::PCWSTR,
        routinginfobuffer: *mut *mut u8,
...
>;
pub type PFAXINITIALIZEEVENTQUEUE = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        completionport: super::super::Foundation::HANDLE,
        completionkey: usize,
...
>;
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type PFAXPRINTCOVERPAGEA = Option<
    unsafe extern "system" fn(
...
>;
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type PFAXPRINTCOVERPAGEW = Option<
    unsafe extern "system" fn(
        faxcontextinfo: *const FAX_CONTEXT_INFOW,
        coverpageinfo: *const FAX_COVERPAGE_INFOW,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXREGISTERROUTINGEXTENSIONW = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
...
>;
pub type PFAXREGISTERSERVICEPROVIDERW = Option<
    unsafe extern "system" fn(
...
>;
pub type PFAXROUTEADDFILE = Option<
    unsafe extern "system" fn(
        jobid: u32,
...
>;
pub type PFAXROUTEDELETEFILE =
    Option<unsafe extern "system" fn(jobid: u32, filename: windows_sys::core::PCWSTR) -> i32>;
pub type PFAXROUTEDEVICECHANGENOTIFICATION = Option<
    unsafe extern "system" fn(
        param0: u32,
        param1: windows_sys::core::BOOL,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXROUTEDEVICEENABLE = Option<
    unsafe extern "system" fn(
...
>;
pub type PFAXROUTEENUMFILE = Option<
    unsafe extern "system" fn(
        jobid: u32,
...
>;
pub type PFAXROUTEENUMFILES = Option<
    unsafe extern "system" fn(
        jobid: u32,
        guid: *mut windows_sys::core::GUID,
...
>;
pub type PFAXROUTEGETFILE = Option<
    unsafe extern "system" fn(
        jobid: u32,
        index: u32,
...
>;
pub type PFAXROUTEGETROUTINGINFO = Option<
    unsafe extern "system" fn(
        param0: windows_sys::core::PCWSTR,
        param1: u32,
        param2: *mut u8,
...
>;
pub type PFAXROUTEINITIALIZE = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HANDLE,
        param1: *mut FAX_ROUTE_CALLBACKROUTINES,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXROUTEMETHOD = Option<
    unsafe extern "system" fn(
...
>;
pub type PFAXROUTEMODIFYROUTINGDATA = Option<
    unsafe extern "system" fn(
        jobid: u32,
        routingguid: windows_sys::core::PCWSTR,
        routingdata: *mut u8,
...
>;
pub type PFAXROUTESETROUTINGINFO = Option<
    unsafe extern "system" fn(
        param0: windows_sys::core::PCWSTR,
        param1: u32,
        param2: *const u8,
...
>;
pub type PFAXSENDDOCUMENTA = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        filename: windows_sys::core::PCSTR,
        jobparams: *const FAX_JOB_PARAMA,
        coverpageinfo: *const FAX_COVERPAGE_INFOA,
        faxjobid: *mut u32,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXSENDDOCUMENTFORBROADCASTA = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        filename: windows_sys::core::PCSTR,
        faxjobid: *mut u32,
...
>;
pub type PFAXSENDDOCUMENTFORBROADCASTW = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        filename: windows_sys::core::PCWSTR,
        faxjobid: *mut u32,
...
>;
pub type PFAXSENDDOCUMENTW = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        filename: windows_sys::core::PCWSTR,
...
>;
pub type PFAXSETCONFIGURATIONA = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        faxconfig: *const FAX_CONFIGURATIONA,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXSETCONFIGURATIONW = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        faxconfig: *const FAX_CONFIGURATIONW,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXSETGLOBALROUTINGINFOA = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
        routinginfo: *const FAX_GLOBAL_ROUTING_INFOA,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXSETGLOBALROUTINGINFOW = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
        routinginfo: *const FAX_GLOBAL_ROUTING_INFOW,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXSETJOBA = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        jobid: u32,
        command: u32,
...
>;
pub type PFAXSETLOGGINGCATEGORIESA = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
...
>;
pub type PFAXSETLOGGINGCATEGORIESW = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
...
>;
pub type PFAXSETPORTA = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
        portinfo: *const FAX_PORT_INFOA,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXSETPORTW = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
        portinfo: *const FAX_PORT_INFOW,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAXSETROUTINGINFOA = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
        routingguid: windows_sys::core::PCSTR,
...
>;
pub type PFAXSETROUTINGINFOW = Option<
    unsafe extern "system" fn(
        faxporthandle: super::super::Foundation::HANDLE,
        routingguid: windows_sys::core::PCWSTR,
        routinginfobuffer: *const u8,
...
>;
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type PFAXSTARTPRINTJOBW = Option<
    unsafe extern "system" fn(
...
>;
pub type PFAXUNREGISTERSERVICEPROVIDERW = Option<
    unsafe extern "system" fn(deviceprovider: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL,
>;
pub type PFAX_EXT_CONFIG_CHANGE = Option<
    unsafe extern "system" fn(
        param0: u32,
...
pub type PFAX_EXT_GET_DATA = Option<
    unsafe extern "system" fn(
        param0: u32,
...
>;
pub type PFAX_EXT_INITIALIZE_CONFIG = Option<
    unsafe extern "system" fn(
...
>;
pub type PFAX_EXT_REGISTER_FOR_EVENTS = Option<
    unsafe extern "system" fn(
...
>;
pub type PFAX_EXT_SET_DATA = Option<
    unsafe extern "system" fn(
        param0: super::super::Foundation::HINSTANCE,
        param1: u32,
        param2: FAX_ENUM_DEVICE_ID_SOURCE,
...
>;
pub type PFAX_EXT_UNREGISTER_FOR_EVENTS =
    Option<unsafe extern "system" fn(param0: super::super::Foundation::HANDLE) -> u32>;
pub type PFAX_LINECALLBACK = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        hdevice: u32,
        dwmessage: u32,
...
>;
pub type PFAX_RECIPIENT_CALLBACKA = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        recipientnumber: u32,
        context: *const core::ffi::c_void,
...
>;
pub type PFAX_RECIPIENT_CALLBACKW = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        recipientnumber: u32,
        context: *const core::ffi::c_void,
...
>;
pub type PFAX_ROUTING_INSTALLATION_CALLBACKW = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        context: *const core::ffi::c_void,
        methodname: windows_sys::core::PWSTR,
        friendlyname: windows_sys::core::PWSTR,
        functionname: windows_sys::core::PWSTR,
        guid: windows_sys::core::PWSTR,
    ) -> windows_sys::core::BOOL,
>;
pub type PFAX_SEND_CALLBACK = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        callhandle: u32,
        reserved1: u32,
...
>;
pub type PFAX_SERVICE_CALLBACK = Option<
    unsafe extern "system" fn(
        faxhandle: super::super::Foundation::HANDLE,
        deviceid: u32,
        param1: usize,

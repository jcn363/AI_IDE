...
>(DecompressorWriterCustomIo<io::Error, IntoIoWriter<W>, BufferType, AllocU8, AllocU32, AllocHC>);


#[cfg(feature = "std")]
impl<W: Write, BufferType: SliceWrapperMut<u8>, AllocU8, AllocU32, AllocHC>
...
impl<
        ...
        AllocU32: Allocator<u32>,
        AllocHC: Allocator<HuffmanCode>,
    > Write for DecompressorWriterCustomAlloc<W, BufferType, AllocU8, AllocU32, AllocHC>
{
...
impl<W: Write> DecompressorWriter<W> {
    ...
    pub fn new_with_custom_dictionary(
        ...
        DecompressorWriter::<W>(DecompressorWriterCustomAlloc::<
            W,
            <StandardAlloc as Allocator<u8>>::AllocatedMemory,
            StandardAlloc,
            StandardAlloc,
...
impl<W: Write> DecompressorWriter<W> {
    ...
    pub fn new_with_custom_dictionary(
        ...
        DecompressorWriter::<W>(DecompressorWriterCustomAlloc::<
            ...
            HeapAlloc<HuffmanCode>,
        >::new_with_custom_dictionary(
            w, buffer, alloc_u8, alloc_u32, alloc_hc, dict
        ))
    }
...
pub struct DecompressorWriterCustomIo<
    ErrType,

...
>(DecompressorCustomIo<io::Error, IntoIoReader<R>, BufferType, AllocU8, AllocU32, AllocHC>);


#[cfg(feature = "std")]
impl<R: Read, BufferType: SliceWrapperMut<u8>, AllocU8, AllocU32, AllocHC>
...
impl<
        ...
        AllocU32: Allocator<u32>,
        AllocHC: Allocator<HuffmanCode>,
    > Read for DecompressorCustomAlloc<R, BufferType, AllocU8, AllocU32, AllocHC>
{
...
impl<R: Read> Decompressor<R> {
    ...
    pub fn new_with_custom_dict(
        ...
        Decompressor::<R>(DecompressorCustomAlloc::<
            R,
            <StandardAlloc as Allocator<u8>>::AllocatedMemory,
            StandardAlloc,
            StandardAlloc,
            StandardAlloc,
        >::new_with_custom_dictionary(
            r,
            buffer,
            alloc,
...
impl<R: Read> Decompressor<R> {
    ...
    pub fn new_with_custom_dictionary(
        ...
        let alloc_hc = HeapAlloc::<HuffmanCode>::new(HuffmanCode { bits: 0, value: 0 });
        Decompressor::<R>(DecompressorCustomAlloc::<
            R,
            <HeapAlloc<u8> as Allocator<u8>>::AllocatedMemory,
            HeapAlloc<u8>,
            ...
            HeapAlloc<HuffmanCode>,
        >::new_with_custom_dictionary(
            r, buffer, alloc_u8, alloc_u32, alloc_hc, dict
        ))
    }
...
pub struct DecompressorCustomIo<
    ErrType,
...
impl<
        ...
        AllocHC: Allocator<HuffmanCode>,
    > CustomRead<ErrType>
    for DecompressorCustomIo<ErrType, R, BufferType, AllocU8, AllocU32, AllocHC>
{
...
fn test_no_vanishing_bytes() {
    ...
    let compressed_with_extra =
        b"\x8f\x02\x80\x68\x65\x6c\x6c\x6f\x0a\x03\x67\x6f\x6f\x64\x62\x79\x65\x0a";

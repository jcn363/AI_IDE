...
pub fn decompress_internal<InputType, OutputType>(
    r: &mut InputType,
...
fn test_streaming_leftover_buffer() {
    reader_helper(
        include_bytes!("../../testdata/reducetostream.map.compressed"),
        include_bytes!("../../testdata/reducetostream.map"),
        8192,
    )
}
...
fn test_reader_uni() {
    reader_helper(
        include_bytes!("../../testdata/random_then_unicode.compressed"),
...
fn test_writer_mapsdatazrh() {
    writer_helper(
        include_bytes!("../../testdata/mapsdatazrh.compressed"),
...
fn assert_huge_file_input_matches_output(
    input_slice: &[u8],
    output_prefix: &[u8],
    output_postfix: &[u8],
    size: usize,
    ...
    assert_eq!(
        output
            .data
            .split_at(output.data.len() - output_postfix.len())
            .1,
        output_postfix
    );
    assert_eq!(
        output
            .data
            .split_at(output_prefix.len() + rep_gap)
            .1
            .split_at(output_prefix.len())
            .0,
        output_prefix
    );
    ...
    for item in output_prefix
        .iter()
        .chain(output_prefix.iter().chain(output_postfix.iter()))
    {
        if *item == 0 {
            nulls_in_input += 1;
        }
    ...
    assert_eq!(
        zero_count - nulls_in_input,
        size - output_prefix.len() * 2 - output_postfix.len()
    );
}
...
fn test_random1024() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/random1024.br"),
...
fn lcet10() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/lcet10.txt.compressed"),
...
fn test_monkey() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/monkey.compressed"),
...
fn test_plrabn12() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/plrabn12.txt.compressed"),
...
fn test_ukkonooa() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/ukkonooa.compressed"),
...
fn test_x() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/x.compressed"),
...
fn test_x_0() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/x.compressed.00"),
        include_bytes!("../../testdata/x"),
        65536,
        65536,
    );
...
fn test_x_1() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/x.compressed.01"),
        include_bytes!("../../testdata/x"),
        65536,
        65536,
    );
...
fn test_x_2() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/x.compressed.02"),
        include_bytes!("../../testdata/x"),
        65536,
        65536,
    );
...
fn test_x_3() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/x.compressed.03"),
        include_bytes!("../../testdata/x"),
        65536,
        65536,
    );
...
fn test_xyzzy() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/xyzzy.compressed"),
...
fn test_zeros() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/zeros.compressed"),
...
fn test_metablock_reset() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/metablock_reset.compressed"),
...
fn test_metablock_section_4_distance_symbol_0() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/fuzz502.compressed"),
...
fn test_intact_distance_ring_buffer0() {
    ...
    assert_decompressed_input_matches_output(BR, OUT, 65536, 65536);
}
...
fn test_broken_file() {
    assert_decompressed_input_matches_output(
        include_bytes!("../../testdata/borked.compressed"),
        include_bytes!("../../testdata/empty"),
        65536,
        65536,
    );
...
fn test_large_window() {
    assert_huge_file_input_matches_output(
        include_bytes!("../../testdata/rnd_chunk.br"),

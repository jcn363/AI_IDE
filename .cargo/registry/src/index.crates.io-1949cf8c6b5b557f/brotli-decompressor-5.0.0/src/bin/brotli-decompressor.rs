...
impl<'a, OutputType: Write> brotli_decompressor::CustomWrite<io::Error>
...
impl<'a, InputType: Read> brotli_decompressor::CustomRead<io::Error>
    for IoReaderWrapper<'a, InputType>
{
    ...
    OutputType: Write,
{
    ...
    brotli_decompressor::BrotliDecompressCustomIoCustomDict(
    ...
    OutputType: Write,
{
    ...
    match brotli_decompressor::BrotliDecompressCustomIo(
        &mut IoReaderWrapper::<InputType>(r),
        &mut IoWriterWrapper::<OutputType>(w),
...
pub struct BrotliDecompressor<R: Read>(
    brotli_decompressor::DecompressorCustomIo<
        io::Error,
        IntoIoReader<R>,
        Rebox<u8>,
        HeapAllocator<u8>,
...
impl<R: Read> BrotliDecompressor<R> {
    pub fn new(r: R, buffer_size: usize) -> Self {
        ...
        let alloc_hc = HeapAllocator::<HuffmanCode> {
            default_value: HuffmanCode::default(),
        };
        BrotliDecompressor::<R>(brotli_decompressor::DecompressorCustomIo::<
            Error,
            IntoIoReader<R>,
            Rebox<u8>,
            HeapAllocator<u8>,

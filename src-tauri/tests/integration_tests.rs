...
#[cfg(test)]
mod tests {
    use rust_ai_ide_common::test_utils::{generators::*, setup::*};
    ...
    async fn test_protocol_error_serialization() {
        ...
        let processing_deserialized: ProtocolError =
            serde_json::from_str(&processing_serialized).unwrap();
    ...
    async fn test_project_lifecycle_integration() {
        ...
        let valid_project =
            rust_ai_ide_common::validation::validate_project_path(&project_path.to_string_lossy());

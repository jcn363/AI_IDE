    ...
    fn create_security_rules_vec() -> Result<Vec<SecurityRule>, Box<dyn std::error::Error>> {
        let rules = vec![
            ...
            Self::create_security_rule(
                ...
                "Avoid using format strings with user-controlled input. Use format strings with explicit arguments or \
                 the Display trait."
                    .to_string(),
                Some(134),
            )?,
            ...
            Self::create_security_rule(
                ...
                "Use parameterized queries or prepared statements instead of string formatting for SQL queries"
                    .to_string(),
                Some(89),
            )?,
            ...
            Self::create_security_rule(
                ...
                "Validate and sanitize all deserialized data. Use strongly-typed structs and avoid deserializing to \
                 generic types like Value."
                    .to_string(),
                Some(502),
            )?,
            ...
            Self::create_security_rule(
                ...
                "Avoid using std::mem::transmute. Use safer alternatives like std::mem::transmute_copy or proper type \
                 conversion methods"
                    .to_string(),
                Some(704),
            )?,
            ...
            Self::create_security_rule(
                ...
                "Use cryptographically secure random number generators like rand::rngs::OsRng or rand_core::OsRng"
                    .to_string(),
                Some(338),
            )?,
            ...
            Self::create_security_rule(
                ...
                "Use proper output encoding and avoid inserting untrusted data into HTML, JavaScript, or other \
            ...
            Self::create_security_rule(
                ...
                SecuritySeverity::High,
                "Potential insecure deserialization of untrusted data".to_string(),
                "Validate and sanitize all deserialized data. Consider using a safe deserialization library or \
            ...
            Self::create_security_rule(
                ...
                "Validate and sanitize all file paths. Use std::path::Path::components() to normalize paths and check \
